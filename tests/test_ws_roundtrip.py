...
async def test_every_allowlisted_setting_round_trips(hass: HomeAssistant, global_entry: MockConfigEntry) -> None:
    ...
    flat: dict[str, Any] = {
        ...
        **{
        ...
        "weekly_digest_enabled": settings["actions"]["weekly_digest_enabled"],
        "install_assist_sentences": settings["general"]["install_assist_sentences"],
        "warranty_reminder_enabled": settings["actions"]["warranty_reminder_enabled"],
        "warranty_reminder_days": settings["actions"]["warranty_reminder_days"],
