...
const NL: Translations = {
  ...
  // --- i18n parity (45 keys mirrored from EN; flat t() lookup) ---
...
const ZH: Translations = {
  ...
  month_jan: "一月", month_feb: "二月", month_mar: "三月", month_apr: "四月",
  month_may: "五月", month_jun: "六月", month_jul: "七月", month_aug: "八月",
  month_sep: "九月", month_oct: "十月", month_nov: "十一月", month_dec: "十二月",
  // Sensor prediction (Phase 3)
  ...
  settings_panel_access_desc: "管理员始终可以看到完整面板。在此选择也应拥有完整访问权限的普通用户 — 其他普通用户将仅能看到“完成”和“跳过”按钮。",
...
/** All UI-language string tables, keyed by 2-letter language code. Exported for
 *  the i18n key-parity guard test (every block must mirror EN's key set). */
export const TRANSLATIONS: Record<string, Translations> = { de: DE, en: EN, nl: NL, fr: FR, it: IT, es: ES, pt: PT, ru: RU, uk: UK, pl: PL, cs: CS, sv: SV, zh: ZH };
