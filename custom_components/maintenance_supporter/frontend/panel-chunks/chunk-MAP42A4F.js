...
import{b as ct,c as dt}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-7W4OJQNM.js";import{a as L}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-7RJVIO7L.js";import{A as at,C as it,H as G,I as rt,J as ot,L as lt,a as m,b as H,c as o,d as j,f as u,h as O,l as R,m as g,n as B,q as i,s as E,t as tt,u as et,v as nt,w as x,y as st,z}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-2ZXPE27K.js";var A=class extends O{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null;this._partOptions=null;this._partQty={};this._partQtyOriginal=""}get _lang(){return E(this.hass)}openEdit(t){this._draft={...t},this._originalSnapshot={...t},this._error="",this._open=!0,this._partOptions=null,this._partQty={},this._partQtyOriginal="",this._loadPartOptions()}async _loadPartOptions(){let t=this._draft;if(t)try{let n=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"}),a=[];for(let l of n.parts||[]){let d=l.entry_id===t.entry_id,p=l.consumers.some(c=>c.entry_id===t.entry_id&&c.task_id===t.task_id);!d&&!p||a.push({part_id:l.part_id,name:l.name,entry_id:l.entry_id,foreign:!d,object_name:l.object_name})}for(let l of t.used_parts||[]){let d=l.entry_id||t.entry_id;a.some(p=>p.part_id===l.part_id&&p.entry_id===d)||a.push({part_id:l.part_id,name:l.name||l.part_id,entry_id:d,foreign:d!==t.entry_id,object_name:null})}let r={};for(let l of t.used_parts||[])r[`${l.entry_id||t.entry_id}:${l.part_id}`]=l.quantity??1;this._partOptions=a,this._partQty=r,this._partQtyOriginal=this._partSelectionKey()}catch{this._partOptions=[]}}_partSelectionKey(){return JSON.stringify(Object.entries(this._partQty).filter(([,t])=>t>0).sort(([t],[n])=>t.localeCompare(n)))}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null}_set(t,n){this._draft&&(this._draft={...this._draft,[t]:n})}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{let t={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(t.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(t.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(t.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(t.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(t.completed_by=this._draft.completed_by),this._partOptions!==null&&this._partSelectionKey()!==this._partQtyOriginal&&(t.used_parts=(this._partOptions||[]).filter(a=>(this._partQty[`${a.entry_id}:${a.part_id}`]||0)>0).map(a=>({part_id:a.part_id,quantity:this._partQty[`${a.entry_id}:${a.part_id}`],...a.foreign?{entry_id:a.entry_id}:{}}))),Object.keys(t).filter(a=>!["type","entry_id","task_id","original_timestamp"].includes(a)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(t),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=L(t,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return u;let t=this._lang,n=this._draft;return o`
    ...
    .part-qty { width: 76px; }
  `,m([R({attribute:!1})],A.prototype,"hass",2),m([g()],A.prototype,"_open",2),m([g()],A.prototype,"_saving",2),m([g()],A.prototype,"_error",2),m([g()],A.prototype,"_draft",2),m([g()],A.prototype,"_partOptions",2),m([g()],A.prototype,"_partQty",2);customElements.get("maintenance-history-edit-dialog")||customElements.define("maintenance-history-edit-dialog",A);var Pt={days:1,weeks:7,months:30.4368,years:365.25};function Y(e,s){return!e||e<=0?0:e*(Pt[s||"days"]??1)}function ne(e,s,t){let n=Y(e,t);if(n<=0||s==null)return{pct:0,overflow:!1};let a=(n-s)/n*100;return{pct:Math.max(0,Math.min(100,a)),overflow:a>100}}var pt=5;function q(e){let s=e.getFullYear(),t=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${s}-${t}-${n}`}function Ct(e,s){let t=[];for(let n=0;n<s;n++){let a=new Date(e);a.setDate(a.getDate()+n),a.setHours(0,0,0,0),t.push(q(a))}return t}function U(e,s){let[t,n,a]=e.split("-").map(Number),r=new Date(t,n-1,a);return r.setDate(r.getDate()+s),q(r)}function It(e){if(!e||e.length===0)return null;let s=e.map(t=>t.cost).filter(t=>typeof t=="number");return s.length===0?null:s.reduce((t,n)=>t+n,0)/s.length}function Et(e){let{windowStart:s,windowEnd:t,task:n,entryId:a,objectName:r}=e,l=[],d=(_,v)=>({date:_,entry_id:a,task_id:n.id,task_name:n.name,object_name:r,status:v&&(n.status==="overdue"||n.status==="triggered")?"ok":n.status,days_until_due:v?null:n.days_until_due??null,projected:v,schedule_type:n.schedule_type,interval_days:n.interval_days??null,interval_unit:n.interval_unit??null,responsible_user_id:n.responsible_user_id??null,avg_cost:It(n.history),adaptive_enabled:!!n.adaptive_config?.enabled,prediction_confidence:n.threshold_prediction_confidence??null}),p=Math.max(1,Math.round(Y(n.interval_days,n.interval_unit)));if(n.status==="overdue"||n.status==="triggered"){if(l.push(d(s,!1)),n.schedule_type==="time_based"&&n.interval_days&&n.interval_days>0){let _=U(s,p),v=1;for(;_<=t&&v<pt;)l.push(d(_,!0)),v++,_=U(_,p)}return l}let c=n.next_due;if(typeof c!="string"||!c)return l;let h=c.slice(0,10);if(h>=s&&h<=t)l.push(d(h,!1));else if(h>t)return l;if(n.schedule_type==="time_based"&&n.interval_days&&n.interval_days>0){let _=U(h,p),v=l.length;for(;_<=t&&v<pt;)_>=s&&(l.push(d(_,!0)),v++),_=U(_,p)}return l}var ut={overdue:0,triggered:1,due_soon:2,ok:3};function ie(e,s,t,n=null){let a=Ct(s,t),r=a[0],l=a[a.length-1],d=[];for(let c of e){let h=c.object?.name||"",_=c.entry_id,v=c.tasks||[];for(let f of v){if(n&&f.responsible_user_id!==n||f.enabled===!1)continue;let $=Et({windowStart:r,windowEnd:l,task:f,entryId:_,objectName:h});d.push(...$)}}let p=new Map;for(let c of a)p.set(c,[]);for(let c of d){let h=p.get(c.date);h&&h.push(c)}for(let[,c]of p)c.sort((h,_)=>{let v=ut[h.status]??99,f=ut[_.status]??99;if(v!==f)return v-f;if(h.projected!==_.projected)return h.projected?1:-1;let $=h.object_name.localeCompare(_.object_name);return $!==0?$:h.task_name.localeCompare(_.task_name)});return a.map(c=>({date:c,events:p.get(c)??[]}))}var St={completed:"ok",reset:"ok",skipped:"due_soon",missed:"overdue",triggered:"triggered",trigger_replaced:"triggered",trigger_removed:"ok"};function Ht(e,s){let t=[];for(let n=s-1;n>=0;n--){let a=new Date(e);a.setDate(a.getDate()-n),a.setHours(0,0,0,0),t.push(q(a))}return t}function re(e,s,t,n=null){let a=Ht(s,t),r=a[0],l=a[a.length-1],d=new Map;for(let c of a)d.set(c,[]);for(let c of e){let h=c.object?.name||"",_=c.entry_id,v=c.tasks||[];for(let f of v){if(n&&f.responsible_user_id!==n)continue;let $=f.history||[];for(let b of $){if(typeof b?.timestamp!="string")continue;let T=b.timestamp.slice(0,10);if(T<r||T>l)continue;let S=d.get(T);if(!S)continue;let P=b.type??"completed";S.push({date:T,entry_id:_,task_id:f.id,task_name:f.name,object_name:h,status:St[P]??"ok",days_until_due:null,projected:!1,schedule_type:f.schedule_type,interval_days:f.interval_days??null,responsible_user_id:f.responsible_user_id??null,avg_cost:typeof b.cost=="number"?b.cost:null,adaptive_enabled:!!f.adaptive_config?.enabled,prediction_confidence:null,history_timestamp:b.timestamp,history_type:P,history_cost:typeof b.cost=="number"?b.cost:null,history_notes:typeof b.notes=="string"?b.notes:null,history_duration:typeof b.duration=="number"?b.duration:null})}}}let p={completed:0,reset:1,skipped:2,triggered:3,trigger_replaced:4};for(let[,c]of d)c.sort((h,_)=>{let v=p[h.history_type??""]??99,f=p[_.history_type??""]??99;if(v!==f)return v-f;let $=h.object_name.localeCompare(_.object_name);return $!==0?$:h.task_name.localeCompare(_.task_name)});return a.map(c=>({date:c,events:d.get(c)??[]}))}function jt(e,s){if(s<=0)return 0;let t=typeof e=="number"&&Number.isFinite(e)?Math.trunc(e):0;return t<0?0:t%s}function Ot(e){return!!(e?.phases&&e.phase_sequence&&e.phase_sequence.length>0)}function Z(e){if(!e||!Ot(e))return null;let s=e.phase_sequence,t=jt(e.phase_cursor,s.length),n=s[t],a=e.phases?.[n];return a?{id:n,name:a.name,index:t,count:s.length,notes:a.notes,checklist:a.checklist!==void 0?a.checklist:e.checklist??[],consumesParts:a.consumes_parts!==void 0?a.consumes_parts:e.consumes_parts??[],requiredFields:a.required_completion_fields!==void 0?a.required_completion_fields:e.required_completion_fields??[]}:null}function N(e){let s=Z(e);return s?`${s.index+1}/${s.count} \xB7 ${s.name}`:""}function ht(e){let s=e.task??null,t=s?Z(s):null,n=t?t.consumesParts:s?.consumes_parts||[],a=!!s?.part_ref,r=e.objects.find(p=>p.entry_id===e.entryId)?.parts||[],l=a?r.find(p=>p.id===s.part_ref.part_id):void 0,d=e.checklistsEnabled??!0;return{entry_id:e.entryId,task_id:e.taskId,task_name:e.taskName,checklist:t?d?t.checklist:[]:e.checklist??[],adaptive_enabled:!!e.adaptiveEnabled,required_completion_fields:t?t.requiredFields:s?.required_completion_fields||[],task_type:s?.type||"",reading_unit:s?.reading_unit||"",parts:a?[]:dt({consumes_parts:n},e.entryId,e.objects,e.lang),consumes_parts:a?[]:n,phase_label:t?N(s):"",require_tag_scan:!!s?.require_tag_scan,restock_default:a?l?.restock_quantity??1:null,restock_unit_cost:a?l?.cost??null:null,currency_symbol:e.currencySymbol??"",consumes_info:n.map(p=>ct(p,e.entryId,e.objects,e.lang)),checklist_prefill:s?.checklist_progress||{},via_tag_scan:!!e.viaTagScan}}function _t(e,s,t){e.entryId=s.entry_id,e.taskId=s.task_id,e.taskName=s.task_name,e.lang=t,e.checklist=s.checklist??[],e.adaptiveEnabled=!!s.adaptive_enabled,e.requiredFields=s.required_completion_fields??[],e.taskType=s.task_type??"",e.readingUnit=s.reading_unit??"",e.parts=s.parts??[],e.consumesParts=s.consumes_parts??[],e.phaseLabel=s.phase_label??"",e.requireTagScan=!!s.require_tag_scan,e.restockDefault=s.restock_default??null,e.restockUnitCost=s.restock_unit_cost??null,e.currencySymbol=s.currency_symbol??"",e.consumesInfo=s.consumes_info??[],e.checklistPrefill=s.checklist_prefill??{},e.viaTagScan=!!s.via_tag_scan,e.open({viaTagScan:!!s.via_tag_scan})}function y(e){return e.toFixed(1)}function he(e,s,t=4){if(!isFinite(e)||!isFinite(s))return{ticks:[],niceMin:0,niceMax:1};if(e===s){let c=Math.abs(e)*.1||1;e-=c,s+=c}let n=s-e,a=Math.pow(10,Math.floor(Math.log10(n/Math.max(1,t)))),r=a;for(let c of[1,2,5,10])if(r=a*c,n/r<=t+.5)break;let l=Math.floor(e/r)*r,d=Math.ceil(s/r)*r,p=[];for(let c=l;c<=d+r*1e-6;c+=r)p.push(Math.abs(c)<r*1e-9?0:c);return{ticks:p,niceMin:l,niceMax:d}}function _e(e,s){let t=Math.abs(e),n=a=>({maximumFractionDigits:a});return t>=1e6?x(e/1e6,s,n(t>=1e7?0:1))+"M":t>=1e4?x(e/1e3,s,n(0))+"k":t>=1e3?x(e/1e3,s,n(1))+"k":t>=100?x(e,s,n(0)):t>=1?x(e,s,n(1)):t===0?"0":x(e,s,n(2))}function me(e,s,t){let n=x(e,t,{maximumFractionDigits:Math.abs(e)>=100?0:1});return s?`${n} ${s}`:n}function fe(e,s,t){return G(new Date(e),s,t)}function ye(e,s){let t=new Date(e);return`${G(t,s)}, ${st(t,s)}`}function ge(e,s){return new Date(e).getFullYear()!==new Date(s).getFullYear()}function ve(e,s,t){if(t<2||s<=e)return[e,s];let n=[];for(let a=0;a<t;a++)n.push(e+(s-e)*a/(t-1));return n}function mt(e,s){let t=e.interval_analysis,n=t?.weibull_beta,a=t?.weibull_eta;if(n==null||a==null||a<=0)return u;let r=e.interval_days??0,l=e.suggested_interval??r;return o`
      ...
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_weibull",a)}">
        ...
        ${t>0?j`
          ...
          <text x="${y(P+4)}" y="${y(F-6)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${At}%</text>
        `:u}

        ${n>0&&n!==t?j`
          <line x1="${y(X)}" y1="${8}" x2="${y(X)}" y2="${y(136)}"
  ...
  `}function Nt(e,s,t){let n=e.confidence_interval_low,a=e.confidence_interval_high,r=s.suggested_interval??s.interval_days??0,l=s.interval_days??0,d=Math.max(0,n-5),c=a+5-d,h=(n-d)/c*100,_=(a-n)/c*100,v=(r-d)/c*100,f=l>0?(l-d)/c*100:-1;return o`
      ...
      <div class="prediction-grid">
        ...
        ${r&&t.environmental?o`
          <div class="prediction-item">
            ...
            ${e.environmental_entity?o`<span class="prediction-entity entity-link" @click=${d=>ot(d,e.environmental_entity)}>${e.environmental_entity}</span>`:u}
          </div>
        `:u}
      </div>
    </div>
  `}function yt(e,s,t,n){let a=Math.max(e||1,s);return o`
  ...
  `}function bt(e,s){return Vt(e,s)}function Vt(e,s){let t=e.seasonal_factors??e.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return u;let n=e.interval_analysis?.seasonal_reason,a=new Date().getMonth(),r=300,l=100,d=8,c=l-d-4,h=Math.max(...t,1.5),_=r/12,v=_*.65,f=d+c-1/h*c;return o`
  ...
  `}var k=class extends O{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return E(this.hass)}async openFor(t,n){this._entryId=t,this._taskId=n,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=q(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._currencySymbol=t?.budget?.currency_symbol||"",this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let n=(t.tasks||[]).find(a=>a.id===this._taskId);this._task=n??null}catch(t){this._error=L(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(n){return this._error=L(n,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("/maintenance_supporter_panelfiles/panel-chunks/dialog-mount-SKYFZXLR.js").then(async({openCompleteDialog:t})=>{let n=this._task,a=[];try{a=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}t(ht({entryId:this._entryId,taskId:this._taskId,taskName:n.name,task:n,objects:a,lang:this._lang,checklist:n.checklist||[],adaptiveEnabled:!!n.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("/maintenance_supporter_panelfiles/panel-chunks/dialog-mount-SKYFZXLR.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("/maintenance_supporter_panelfiles/panel-chunks/dialog-mount-SKYFZXLR.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=i("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=i("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${i("reanalyze_result",this._lang)||"Recomputed"}: ${it(t.recommended_interval,"days",this._lang)} (${t.data_points} pts)`:i("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=L(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("/maintenance_supporter_panelfiles/panel-chunks/dialog-mount-SKYFZXLR.js").then(({openHistoryEditDialog:n})=>{n({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null,used_parts:t.used_parts??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return u;let n=this._lang;return o`
    ...
    `}_renderAdaptive(t){let n=this._lang,a=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,r=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,l=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,d=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!a&&!r&&!l&&!d?o`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${r?ft(t,n,this._features):u}
        ${l?mt(t,n):u}
        ${d?o`
          ${vt(t,n,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?bt(t,n):u}
        `:u}
      </div>
                ...
                ${[...a].reverse().slice(0,20).map(p=>{let c=["completed","reset","skipped"].includes(p.type);return o`
                    <div class="history-entry">
                      <div class="history-line">
                        ...
                        <span class="history-date">${at(p.timestamp,n)}</span>
    ...
    `}render(){if(!this._open)return u;let t=this._lang,n=this._task,a=this.hass?.user?.is_admin??!0;return o`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${n?o`
              <div class="header">
                <div class="title">
                  <span class="status-dot" style="background: ${B[n.status]||"#ccc"}"></span>
                  <span class="task-name">${n.name}</span>
                </div>
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("/maintenance_supporter_panelfiles/panel-chunks/dialog-mount-SKYFZXLR.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ...
                  ${n.schedule?.kind&&!["manual","one_time"].includes(n.schedule.kind)||n.interval_days!=null?o`<span><strong>${i("interval",t)||"Interval"}:</strong> ${rt(n,t)}</span>`:u}
        ...
        ${n&&a?o`
              ...
              ${a.notes?o`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${kt(a.notes)}</div>
                    </div>
                  `:u}
      ...
      <div class="meta">
        ${a.map(([r,l])=>o`
            <div class="meta-item">
              ...
              <span class="meta-value">${xt(l)?o`<a href="${l}" target="_blank" rel="noopener noreferrer">${l}</a>`:l}</span>
            </div>
          `)}
      </div>
    `}};M.styles=H`
  ...
  `,m([R({attribute:!1})],M.prototype,"hass",2),m([g()],M.prototype,"_open",2),m([g()],M.prototype,"_entryId",2),m([g()],M.prototype,"_data",2),m([g()],M.prototype,"_busy",2),m([g()],M.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",M);var $t="maintenance-object-dialog",wt="maintenance-task-dialog",Wt="maintenance-history-edit-dialog",Ft="maintenance-complete-dialog",Bt="maintenance-qr-dialog",Ut="maintenance-task-quick-actions-dialog",Kt="maintenance-object-quick-actions-dialog";function K(){return document.querySelector("home-assistant")?.hass}function Gt(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function C(e){let s=Gt(),t=s.querySelector(e)??document.body.querySelector(e);return t?t.parentNode!==s&&s.appendChild(t):(t=document.createElement(e),s.appendChild(t)),t}function I(e){let s=K();if(!s)return!1;e.hass=s;let t=E(s);return tt(t)||et(t).then(()=>{e.requestUpdate?.()}),nt(s.locale,s.config?.country),!0}var Q={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"};function fn(e){return J(e).then(s=>s.rowActionStyle)}function yn(){V=null}var V=null;function J(e){return V||(V=e.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(s=>({features:s.features??Q.features,defaultWarningDays:s.general?.default_warning_days??7,rowActionStyle:s.general?.row_action_style??Q.rowActionStyle})).catch(()=>Q),V)}function gn(){let e=C($t);return I(e)?(e.openCreate(),!0):!1}function vn(e,s){let t=C($t);return I(t)?(t.openEdit(e,s),!0):!1}function bn(e="",s){let t=C(wt);if(!I(t))return!1;let n=K();return n?((async()=>{let a=await J(n),r=t;r.checklistsEnabled=a.features.checklists,r.scheduleTimeEnabled=a.features.schedule_time,r.completionActionsEnabled=a.features.completion_actions,r.defaultWarningDays=a.defaultWarningDays,r.openCreate(e,s)})(),!0):!1}function xn(e,s){let t=C(wt);if(!I(t))return!1;let n=K();return n?((async()=>{try{let[a,r]=await Promise.all([n.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:e}),J(n)]),l=(a.tasks||[]).find(p=>p.id===s);if(!l){console.warn(`openEditTaskDialog: task ${s} not found in entry ${e}`);return}let d=t;d.checklistsEnabled=r.features.checklists,d.scheduleTimeEnabled=r.features.schedule_time,d.completionActionsEnabled=r.features.completion_actions,d.defaultWarningDays=r.defaultWarningDays,await d.openEdit(e,l)}catch(a){console.warn("openEditTaskDialog: failed to load task/features",a)}})(),!0):!1}function kn(e){let s=C(Wt);return I(s)?(s.openEdit(e),!0):!1}function $n(e){let s=C(Ft);return I(s)?(_t(s,e,K()?.language||"en"),!0):!1}function wn(e){let s=C(Bt);return I(s)?(s.openForTask(e.entry_id,e.task_id,e.object_name,e.task_name),!0):!1}function An(e,s){let t=C(Ut);return I(t)?(t.openFor(e,s),!0):!1}function Dn(e){let s=C(Kt);return I(s)?(s.openFor(e),!0):!1}export{xt as a,ne as b,kt as c,jt as d,Ot as e,Z as f,ht as g,_t as h,y as i,he as j,_e as k,me as l,fe as m,ye as n,ge as o,ve as p,q,ie as r,re as s,mt as t,ft as u,yt as v,vt as w,bt as x,fn as y,yn as z,gn as A,vn as B,bn as C,xn as D,kn as E,$n as F,wn as G,An as H,Dn as I};
