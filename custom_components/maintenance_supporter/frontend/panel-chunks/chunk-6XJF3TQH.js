...
`),partId:I?.part_id||"",partQty:I?.quantity!=null?String(I.quantity):"",reqOverride:m.required_completion_fields!==void 0,reqFields:[...m.required_completion_fields||[]],extraParts:w.filter((E,G)=>G!==S).map(E=>({...E})),carry:Y}}),this._phaseSeq=[...i.phase_sequence||[]],this._requiredCompletion=[...i.required_completion_fields||[]],this._scheduleTime=i.schedule_time||"";let c=i.on_complete_action;if(c&&c.service){this._actionService=c.service;let l=c.target?.entity_id;this._actionTargetEntity=Array.isArray(l)?l[0]||"":l||"",this._actionData=c.data&&typeof c.data=="object"?{...c.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let _=i.quick_complete_defaults;this._qcNotes=_?.notes||"",this._qcCost=_?.cost!=null?String(_.cost):"",this._qcDuration=_?.duration!=null?String(_.duration):"",this._qcFeedback=_?.feedback||"";let h=i.adaptive_config||{};if(this._environmentalEntity=h.environmental_entity||"",this._environmentalAttribute=h.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,this._adaptiveEnabled=!!h.enabled,this._adaptiveAlpha=h.ewa_alpha?.toString()??b.alpha,this._adaptiveMin=h.min_interval_days?.toString()??b.min,this._adaptiveMax=h.max_interval_days?.toString()??b.max,this._adaptiveSeasonal=h.seasonal_enabled!==!1,this._adaptivePrediction=h.sensor_prediction_enabled!==!1,this._adaptiveInitial=this._adaptiveSnapshot(),i.trigger_config){let l=i.trigger_config;this._triggerEntityId=l.entity_id||l.entity_ids&&l.entity_ids[0]||"",this._triggerEntityIds=l.entity_ids||(l.entity_id?[l.entity_id]:[]),this._triggerEntityLogic=l.entity_logic||"any",this._triggerAttribute=l.attribute||"",this._triggerType=l.type||"threshold",this._triggerAbove=l.trigger_above?.toString()||"",this._triggerBelow=l.trigger_below?.toString()||"",this._triggerEquals=l.trigger_equals?.toString()||"",this._triggerNotEquals=l.trigger_not_equals?.toString()||"",this._triggerForMinutes=l.trigger_for_minutes?.toString()||"0",this._triggerCombinator=l.trigger_combinator==="all"?"all":"any",this._triggerTargetValue=l.trigger_target_value?.toString()||"",this._triggerDeltaMode=l.trigger_delta_mode||!1,this._triggerBaselineValue=l.trigger_baseline_value?.toString()||"",this._liveBaselineValue=i.trigger_baseline_value??null,this._autoCompleteOnRecovery=l.auto_complete_on_recovery||!1,this._triggerFromState=l.trigger_from_state||"",this._triggerToState=l.trigger_to_state||"",this._triggerTargetChanges=l.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=l.trigger_runtime_hours?.toString()||"",this._triggerRuntimeMaxSession=l.trigger_runtime_max_session_seconds?.toString()||"",this._triggerOnStates=(l.trigger_on_states||[]).join(", "),l.type==="compound"?(this._compoundLogic=l.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(l.conditions||[]).map(se)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._requireTagScan=!1,this._allowSkip=!0,this._readingUnit="",this._readings=[],this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._phaseDefs=[],this._phaseSeq=[],this._requiredCompletion=[],this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._adaptiveEnabled=!1,this._adaptiveAlpha=b.alpha,this._adaptiveMin=b.min,this._adaptiveMax=b.max,this._adaptiveSeasonal=!0,this._adaptivePrediction=!0,this._adaptiveInitial=this._adaptiveSnapshot(),this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerEquals="",this._triggerNotEquals="",this._triggerForMinutes="0",this._triggerCombinator="any",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerRuntimeMaxSession="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new z(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}_toggleAssignee(e){this._assigneePool=this._assigneePool.includes(e)?this._assigneePool.filter(i=>i!==e):[...this._assigneePool,e]}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[i,t]=e.split(".");if(!this.hass?.services?.[i]?.[t]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let r=this._actionTargetEntity.trim();if(r){let c=r.split(".")[0];if(c!==i&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(i)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${i}.* entities; entity "${r}" is in ${c}.* \u2014 pick a service that matches the entity domain (e.g. ${c}.${t})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[r]){this._actionTestResult="error",this._actionTestError=`Target entity "${r}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[i,t]=e.split("."),r=this.hass?.services?.[i]?.[t]?.fields;return!r||Object.keys(r).length===0?null:Object.entries(r).map(([c,_])=>({name:c,required:!!_.required,selector:_.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return p;let i=this._serviceSchema();return o`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${t=>{this._actionService=t.detail.value||"";let r=this._serviceSchema();if(r){let c=new Set(r.map(_=>_.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([_])=>c.has(_)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
    ...
    `}async _loadParts(){if(this.parts=[],!!this._entryId)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this.parts=e.parts||[],this._partsLoadFailed=!1}catch{this.parts=[],this._partsLoadFailed=!0}}async _loadForeignPools(){if(this._foreignOwners=[],!!this._entryId)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._foreignOwners=(e.objects||[]).filter(i=>i.entry_id!==this._entryId&&(i.parts||[]).length>0).map(i=>({entry_id:i.entry_id,name:i.object?.name||i.entry_id,parts:i.parts||[]})).sort((i,t)=>i.name.localeCompare(t.name))}catch{this._foreignOwners=[]}}async _loadTags(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tags/list"});this._availableTags=e.tags||[]}catch{this._availableTags=[]}}_fetchConditionAttributes(e){!e||!this.hass||this._conditionAttrOptions[e]||this._conditionAttrPending.has(e)||(this._conditionAttrPending.add(e),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/entity/attributes",entity_id:e}).then(i=>{let t=i;this._conditionAttrOptions={...this._conditionAttrOptions,[e]:{suggested:t.suggested_attributes||[],available:t.available_attributes||[]}}}).catch(()=>{this._conditionAttrOptions={...this._conditionAttrOptions,[e]:{suggested:[],available:[]}}}))}async _fetchEntityAttributes(e){if(!e||!this.hass){this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="";return}try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/entity/attributes",entity_id:e});this._entityDomain=i.domain||"",this._suggestedAttributes=i.suggested_attributes||[],this._availableAttributes=i.available_attributes||[]}catch{this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain=""}}get _hasForeignPick(){return Object.values(this._consumesParts).some(e=>!!e.entry_id)}_renderConsumesRow(e,i){let t=k({part_id:e.id,entry_id:i}),r=this._consumesParts[t],c=i?{part_id:e.id,quantity:1,entry_id:i}:{part_id:e.id,quantity:1};return o`
      <div class="consumes-row">
        ...
        ${r!==void 0?o`<input
              ...
              @input=${_=>{let h=parseFloat(_.target.value);this._consumesParts={...this._consumesParts,[t]:{...c,quantity:Number.isFinite(h)&&h>=.01?h:1}}}}
            />`:p}
      </div>
    `}_toggleRequired(e,i){let t=new Set(this._requiredCompletion);i?t.add(e):t.delete(e),this._requiredCompletion=[...t]}_patchReading(e,i){this._readings=this._readings.map(t=>t.id===e?{...t,...i}:t)}_renderReadingsEditor(e){let i=D(this._readings);return o`
      <div class="readings-editor">
        ...
        ${this._readings.map(t=>o`
          ${i.has(t.id)?o`<div class="field-help reading-dup">${s("reading_duplicate_name",e)}</div>`:p}
        ...
        ${this._readings.length<20?o`
          <ha-button appearance="plain" class="reading-add"
            @click=${()=>this._readings=[...this._readings,{id:U(),name:"",unit:this._readings.length?this._readings[this._readings.length-1].unit:this._readingUnit}]}>
              ...
              ${C.map(r=>o`
                <label class="req-option">
                  <input
                    ...
                    @change=${c=>{let _=c.target.checked,h=new Set(t.reqFields);_?h.add(r):h.delete(r),this._patchPhaseDef(t.id,{reqFields:[...h]})}}
                  />
                  <span>${s(q[r],e)}</span>
                </label>
              `)}
        ...
        <div class="phase-seq">
          ${this._phaseSeq.map((t,r)=>o`
            <span class="phase-chip">
              ${r+1}. ${i(t)}
              <button class="phase-chip-x" @click=${()=>{this._phaseSeq=this._phaseSeq.filter((c,_)=>_!==r)}}>✕</button>
            </span>
          `)}
          <select
            class="phase-seq-add"
...
`).map(h=>h.trim()).filter(Boolean).slice(0,100);e.checklist=_.length?_:null}if(this.completionActionsEnabled){let _=this._actionService.trim();if(_&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(_)){let f={service:_},v=this._actionTargetEntity.trim();v&&(f.target={entity_id:v});let g=this._buildActionData();Object.keys(g).length>0&&(f.data=g),e.on_complete_action=f}else e.on_complete_action=null;let h={};this._qcNotes.trim()&&(h.notes=this._qcNotes.trim());let l=parseFloat(this._qcCost);!isNaN(l)&&l>=0&&(h.cost=l);let m=parseInt(this._qcDuration,10);!isNaN(m)&&m>=0&&(h.duration=m),this._qcFeedback&&(h.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(h).length?h:null}let t=await this.hass.connection.sendMessagePromise(e),r=this._taskId||t?.task_id,c=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(r&&this._scheduleType==="sensor_based"&&c)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:r,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(r&&this._adaptiveSnapshot()!==this._adaptiveInitial){let _=parseFloat(this._adaptiveAlpha),h=parseInt(this._adaptiveMin,10),l=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:r,enabled:this._adaptiveEnabled,..._>=.1&&_<=.9?{ewa_alpha:_}:{},...!isNaN(h)&&h>=1?{min_interval_days:h}:{},...!isNaN(l)&&l>=1?{max_interval_days:l}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=B(e,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return p;let e=this._lang,i=this._triggerType==="compound";return o`
      ...
      <div class="select-row">
        ...
        >
          ${ee.map(t=>o`<option value=${t} ?selected=${t===this._triggerType}>${s(t,e)}</option>`)}
        </select>
      </div>
      ${i?this._renderCompoundEditor():o`
        ${this._entityPickerFallback?o`
          <ms-textfield
            ...
            @input=${t=>{let c=t.target.value.split(",").map(_=>_.trim()).filter(Boolean);this._triggerEntityId=c[0]||"",this._triggerEntityIds=c,c[0]&&this._fetchEntityAttributes(c[0])}}
          ></ms-textfield>
        `:o`
        <ha-form
          class="entity-picker-form"
          .hass=${this.hass}
          .schema=${[{name:"trigger_entities",selector:{entity:{multiple:!0,domain:A}}}]}
      ...
      ${this._intervalDays?o`
          ...
          `:p}
    `}_patchCondition(e,i){this._compoundConditions=this._compoundConditions.map((t,r)=>r===e?{...t,...i}:t)}_addCondition(){this._compoundConditions=[...this._compoundConditions,te()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((i,t)=>t!==e)}_renderCompoundEditor(){let e=this._lang;return o`
      <div class="select-row">
    ...
    `}_renderCondition(e,i){let t=this._lang,r=i+1;return o`
      <div class="compound-condition">
        ...
        <ha-form
          class="entity-picker-form"
          .hass=${this.hass}
          .schema=${[{name:"condition_entities",selector:{entity:{multiple:!0,domain:A}}}]}
          .data=${{condition_entities:e.entityIds.split(",").map(c=>c.trim()).filter(Boolean)}}
          .computeLabel=${()=>s("entity_id",t)}
          @value-changed=${c=>{let _=(c.detail.value.condition_entities||[]).filter(Boolean);this._patchCondition(i,{entityIds:_.join(", ")})}}
        ></ha-form>`}
        ...
        <div class="select-row">
          ...
          >
            ${K.map(c=>o`<option value=${c} ?selected=${c===e.type}>${s(c,t)}</option>`)}
          </select>
        </div>
    ...
    `}_renderCalendarFields(){let e=this._lang,i=ae(e);if(this._scheduleType==="weekdays")return o`
        ...
        <div class="select-row">
          ...
          <select .value=${this._nth} @change=${r=>this._nth=r.target.value}>
            ${t.map(([r,c])=>o`<option value=${r} ?selected=${r===this._nth}>${c}</option>`)}
          </select>
        </div>
        <div class="select-row">
          <label>${s("recurrence_weekday",e)}</label>
          <select .value=${this._nthWeekday} @change=${r=>this._nthWeekday=r.target.value}>
            ${i.map((r,c)=>o`<option value=${String(c)} ?selected=${String(c)===this._nthWeekday}>${r}</option>`)}
          </select>
        </div>
      ...
      ></ms-textfield>`}_thresholdLimitsOverlap(){let e=parseFloat(this._triggerAbove),i=parseFloat(this._triggerBelow);return!isNaN(e)&&!isNaN(i)&&i>e}_renderTriggerLiveHint(){if(this._triggerType==="compound")return p;let e=this._triggerType==="threshold"&&this._thresholdLimitsOverlap()?o`<div class="trigger-live-hint warn">${s("trigger_hint_overlap",this._lang)}</div>`:p,i=this._triggerEntityId||this._triggerEntityIds[0];if(!i||!this.hass?.states)return e;let t=this.hass.states[i];if(!t)return e;let r=this._lang,c=t.attributes?.unit_of_measurement,_=typeof c=="string"&&c?` ${c}`:"",h=this._triggerAttribute?t.attributes?.[this._triggerAttribute]:t.state,l=typeof h=="number"?h:parseFloat(String(h)),m=h!=="unknown"&&h!=="unavailable"&&h!=null&&!isNaN(l),f=g=>F(g,r,{maximumFractionDigits:1}),v=[];if(this._triggerType==="threshold"){let g=parseFloat(this._triggerAbove),$=parseFloat(this._triggerBelow);if(isNaN(g)&&isNaN($))return p;m&&v.push(s("trigger_hint_now",r).replace("{value}",f(l)+_)),isNaN(g)||v.push(s("trigger_hint_above",r).replace("{target}",f(g)+_)),isNaN($)||v.push(s("trigger_hint_below",r).replace("{target}",f($)+_))}else if(this._triggerType==="counter"){let g=parseFloat(this._triggerTargetValue);if(isNaN(g))return p;this._triggerDeltaMode?this._taskId?v.push(s("trigger_hint_counter_delta_edit",r).replace("{target}",f(g)+_)):m?v.push(s("trigger_hint_counter_delta",r).replace("{value}",f(l)+_).replace("{due}",f(l+g)+_).replace("{target}",f(g)+_)):v.push(s("trigger_hint_counter_delta_edit",r).replace("{target}",f(g)+_)):(m&&v.push(s("trigger_hint_now",r).replace("{value}",f(l)+_)),v.push(s("trigger_hint_counter_abs",r).replace("{target}",f(g)+_)))}else if(this._triggerType==="runtime"){let g=parseFloat(this._triggerRuntimeHours);if(isNaN(g))return p;v.push(s("trigger_hint_runtime",r).replace("{hours}",f(g))),v.push(s("trigger_hint_state_now",r).replace("{value}",String(t.state)))}else if(this._triggerType==="state_change"){let g=parseInt(this._triggerTargetChanges,10)||1,$=this._triggerToState.trim();v.push(($?s("trigger_hint_state_change_to",r).replace("{state}",$):s("trigger_hint_state_change",r)).replace("{count}",String(g))),v.push(s("trigger_hint_state_now",r).replace("{value}",String(t.state)))}return v.length?o`<div class="trigger-live-hint">${v.join(" ")}</div>${e}`:e}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?o`
        <ms-textfield
      ...
      `:this._triggerType==="state_change"?o`
        ...
        ${(this._triggerTargetChanges||"1")==="1"&&(this._triggerFromState||this._triggerToState)?o`<div class="field-help">${s("state_latch_help",e)}</div>`:p}
        <ms-textfield
          label="${s("for_at_least_minutes",e)}"
          type="number"
          min="0"
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Q.map(t=>o`<option value=${t} ?selected=${t===this._type}>${s(t,e)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${X.map(t=>o`<option value=${t} ?selected=${t===this._priority}>${s("priority_"+t,e)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${Z.map(t=>o`<option value=${t} ?selected=${t===this._scheduleType}>${s(t,e)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="sensor_based"?o`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:V,device_class:W}}}]}
    ...
    `}};a._PREVIEW_RELEVANT=new Set(["_open","_scheduleType","_intervalDays","_intervalUnit","_intervalAnchor","_dueDate","_weekdays","_nth","_nthWeekday","_domDay","_domLastDay","_domBusiness","_calOffset","_seasonMonths","_endsMode","_endsCount","_endsUntil","_lastPerformed"]),a.styles=N`
    .dialog-title {
      font-size: 18px;
      font-weight: 500;
      padding-bottom: 12px;
  ...
  `,n([x({attribute:!1})],a.prototype,"hass",2),n([x({type:Boolean,attribute:"checklists-enabled"})],a.prototype,"checklistsEnabled",2),n([x({type:Boolean,attribute:"schedule-time-enabled"})],a.prototype,"scheduleTimeEnabled",2),n([x({type:Boolean,attribute:"completion-actions-enabled"})],a.prototype,"completionActionsEnabled",2),n([x({type:Number,attribute:"default-warning-days"})],a.prototype,"defaultWarningDays",2),n([d()],a.prototype,"parts",2),n([d()],a.prototype,"_foreignOwners",2),n([d()],a.prototype,"_open",2),n([d()],a.prototype,"_entityPickerFallback",2),n([d()],a.prototype,"_loading",2),n([d()],a.prototype,"_error",2),n([d()],a.prototype,"_entryId",2),n([d()],a.prototype,"_taskId",2),n([d()],a.prototype,"_objectChoices",2),n([d()],a.prototype,"_name",2),n([d()],a.prototype,"_type",2),n([d()],a.prototype,"_scheduleType",2),n([d()],a.prototype,"_intervalDays",2),n([d()],a.prototype,"_intervalUnit",2),n([d()],a.prototype,"_dueDate",2),n([d()],a.prototype,"_warningDays",2),n([d()],a.prototype,"_earliestCompletionDays",2),n([d()],a.prototype,"_intervalAnchor",2),n([d()],a.prototype,"_weekdays",2),n([d()],a.prototype,"_nth",2),n([d()],a.prototype,"_nthWeekday",2),n([d()],a.prototype,"_domDay",2),n([d()],a.prototype,"_domLastDay",2),n([d()],a.prototype,"_domBusiness",2),n([d()],a.prototype,"_calOffset",2),n([d()],a.prototype,"_seasonMonths",2),n([d()],a.prototype,"_endsMode",2),n([d()],a.prototype,"_endsCount",2),n([d()],a.prototype,"_endsUntil",2),n([d()],a.prototype,"_schedulePreview",2),n([d()],a.prototype,"_schedulePreviewEnded",2),n([d()],a.prototype,"_notes",2),n([d()],a.prototype,"_documentationUrl",2),n([d()],a.prototype,"_customIcon",2),n([d()],a.prototype,"_priority",2),n([d()],a.prototype,"_labels",2),n([d()],a.prototype,"_enabled",2),n([d()],a.prototype,"_triggerEntityId",2),n([d()],a.prototype,"_triggerEntityIds",2),n([d()],a.prototype,"_triggerEntityLogic",2),n([d()],a.prototype,"_triggerAttribute",2),n([d()],a.prototype,"_triggerType",2),n([d()],a.prototype,"_triggerAbove",2),n([d()],a.prototype,"_triggerBelow",2),n([d()],a.prototype,"_triggerEquals",2),n([d()],a.prototype,"_triggerNotEquals",2),n([d()],a.prototype,"_triggerForMinutes",2),n([d()],a.prototype,"_triggerCombinator",2),n([d()],a.prototype,"_triggerTargetValue",2),n([d()],a.prototype,"_triggerDeltaMode",2),n([d()],a.prototype,"_triggerBaselineValue",2),n([d()],a.prototype,"_liveBaselineValue",2),n([d()],a.prototype,"_autoCompleteOnRecovery",2),n([d()],a.prototype,"_triggerFromState",2),n([d()],a.prototype,"_triggerToState",2),n([d()],a.prototype,"_triggerTargetChanges",2),n([d()],a.prototype,"_triggerRuntimeHours",2),n([d()],a.prototype,"_triggerRuntimeMaxSession",2),n([d()],a.prototype,"_triggerOnStates",2),n([d()],a.prototype,"_compoundLogic",2),n([d()],a.prototype,"_compoundConditions",2),n([d()],a.prototype,"_suggestedAttributes",2),n([d()],a.prototype,"_availableAttributes",2),n([d()],a.prototype,"_entityDomain",2),n([d()],a.prototype,"_lastPerformed",2),n([d()],a.prototype,"_nfcTagId",2),n([d()],a.prototype,"_requireTagScan",2),n([d()],a.prototype,"_allowSkip",2),n([d()],a.prototype,"_readingUnit",2),n([d()],a.prototype,"_readings",2),n([d()],a.prototype,"_consumesParts",2),n([d()],a.prototype,"_partsLoadFailed",2),n([d()],a.prototype,"_availableTags",2),n([d()],a.prototype,"_responsibleUserId",2),n([d()],a.prototype,"_assigneePool",2),n([d()],a.prototype,"_rotationStrategy",2),n([d()],a.prototype,"_availableUsers",2),n([d()],a.prototype,"_checklistText",2),n([d()],a.prototype,"_phaseDefs",2),n([d()],a.prototype,"_phaseSeq",2),n([d()],a.prototype,"_requiredCompletion",2),n([d()],a.prototype,"_scheduleTime",2),n([d()],a.prototype,"_actionService",2),n([d()],a.prototype,"_actionTargetEntity",2),n([d()],a.prototype,"_actionData",2),n([d()],a.prototype,"_actionDataJsonFallback",2),n([d()],a.prototype,"_actionTesting",2),n([d()],a.prototype,"_actionTestResult",2),n([d()],a.prototype,"_actionTestError",2),n([d()],a.prototype,"_qcNotes",2),n([d()],a.prototype,"_qcCost",2),n([d()],a.prototype,"_qcDuration",2),n([d()],a.prototype,"_qcFeedback",2),n([d()],a.prototype,"_environmentalEntity",2),n([d()],a.prototype,"_environmentalAttribute",2),n([d()],a.prototype,"_adaptiveEnabled",2),n([d()],a.prototype,"_adaptiveAlpha",2),n([d()],a.prototype,"_adaptiveMin",2),n([d()],a.prototype,"_adaptiveMax",2),n([d()],a.prototype,"_adaptiveSeasonal",2),n([d()],a.prototype,"_adaptivePrediction",2),n([d()],a.prototype,"_conditionAttrOptions",2);var L=a;customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",L);export{L as a};
