      ...
      <div class="consumes-row">
        <label class="consumes-check">
          <input
            type="checkbox"
            .checked=${r!==void 0}
            @change=${c=>{let h={...this._consumesParts};c.target.checked?h[e]=h[e]||d:delete h[e],this._consumesParts=h}}
          />
    ...
    `}_renderCondition(t,i){let e=this._lang,r=i+1;return l`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${R.map(d=>l`<option value=${d} ?selected=${d===t.type}>${s(d,e)}</option>`)}
          </select>
        </div>
