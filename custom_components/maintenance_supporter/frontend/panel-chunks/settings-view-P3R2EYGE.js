      ...
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <input type="checkbox" .checked=${!!t.event_only}
            @change=${i=>this._updateSetting("notify_event_only",i.target.checked)} />
        </label>
