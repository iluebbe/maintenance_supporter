...
import{b as ut,f as B,g as yt}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-IM7WAAUD.js";import{a as Q,b as gt,c as X}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-IMKW4YQM.js";import{b as ht,c as _t,e as J,f as mt,h as ft}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-PDIZPNKS.js";import{a as T}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-HJIGWQVC.js";import{A as ot,C as lt,H as Z,I as dt,J as ct,M as pt,a as h,b as C,c as l,d as z,f as u,h as H,l as P,m,n as U,q as a,s as j,t as it,u as st,v as at,w as x,y as rt,z as N}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-XKOUOEDD.js";var R=class extends H{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{this._url=await ut(this.hass,this.docId)}catch{this._failed=!0}}render(){return this._failed||!this.docId?u:this._url?l`
  ...
  `,h([P({attribute:!1})],w.prototype,"hass",2),h([m()],w.prototype,"_open",2),h([m()],w.prototype,"_saving",2),h([m()],w.prototype,"_error",2),h([m()],w.prototype,"_draft",2),h([m()],w.prototype,"_partOptions",2),h([m()],w.prototype,"_partQty",2),h([m()],w.prototype,"_photos",2),h([m()],w.prototype,"_readingRows",2),h([m()],w.prototype,"_readingText",2),h([m()],w.prototype,"_photoUploading",2);customElements.get("maintenance-history-edit-dialog")||customElements.define("maintenance-history-edit-dialog",w);var Ot={days:1,weeks:7,months:30.4368,years:365.25};function tt(e,i){return!e||e<=0?0:e*(Ot[i||"days"]??1)}function ye(e,i,t){let n=tt(e,t);if(n<=0||i==null)return{pct:0,overflow:!1};let s=(n-i)/n*100;return{pct:Math.max(0,Math.min(100,s)),overflow:s>100}}var vt=5;function q(e){let i=e.getFullYear(),t=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${i}-${t}-${n}`}function zt(e,i){let t=[];for(let n=0;n<i;n++){let s=new Date(e);s.setDate(s.getDate()+n),s.setHours(0,0,0,0),t.push(q(s))}return t}function G(e,i){let[t,n,s]=e.split("-").map(Number),r=new Date(t,n-1,s);return r.setDate(r.getDate()+i),q(r)}function Nt(e){if(!e||e.length===0)return null;let i=e.map(t=>t.cost).filter(t=>typeof t=="number");return i.length===0?null:i.reduce((t,n)=>t+n,0)/i.length}function qt(e){let{windowStart:i,windowEnd:t,task:n,entryId:s,objectName:r}=e,o=[],d=(f,v)=>({date:f,entry_id:s,task_id:n.id,task_name:n.name,object_name:r,status:v&&(n.status==="overdue"||n.status==="triggered")?"ok":n.status,days_until_due:v?null:n.days_until_due??null,projected:v,schedule_type:n.schedule_type,interval_days:n.interval_days??null,interval_unit:n.interval_unit??null,responsible_user_id:n.responsible_user_id??null,avg_cost:Nt(n.history),adaptive_enabled:!!n.adaptive_config?.enabled,prediction_confidence:n.threshold_prediction_confidence??null}),c=Math.max(1,Math.round(tt(n.interval_days,n.interval_unit)));if(n.status==="overdue"||n.status==="triggered"){if(o.push(d(i,!1)),n.schedule_type==="time_based"&&n.interval_days&&n.interval_days>0){let f=G(i,c),v=1;for(;f<=t&&v<vt;)o.push(d(f,!0)),v++,f=G(f,c)}return o}let p=n.next_due;if(typeof p!="string"||!p)return o;let _=p.slice(0,10);if(_>=i&&_<=t)o.push(d(_,!1));else if(_>t)return o;if(n.schedule_type==="time_based"&&n.interval_days&&n.interval_days>0){let f=G(_,c),v=o.length;for(;f<=t&&v<vt;)f>=i&&(o.push(d(f,!0)),v++),f=G(f,c)}return o}var bt={overdue:0,triggered:1,due_soon:2,ok:3};function xe(e,i,t,n=null){let s=zt(i,t),r=s[0],o=s[s.length-1],d=[];for(let p of e){let _=p.object?.name||"",f=p.entry_id,v=p.tasks||[];for(let g of v){if(n&&g.responsible_user_id!==n||g.enabled===!1)continue;let k=qt({windowStart:r,windowEnd:o,task:g,entryId:f,objectName:_});d.push(...k)}}let c=new Map;for(let p of s)c.set(p,[]);for(let p of d){let _=c.get(p.date);_&&_.push(p)}for(let[,p]of c)p.sort((_,f)=>{let v=bt[_.status]??99,g=bt[f.status]??99;if(v!==g)return v-g;if(_.projected!==f.projected)return _.projected?1:-1;let k=_.object_name.localeCompare(f.object_name);return k!==0?k:_.task_name.localeCompare(f.task_name)});return s.map(p=>({date:p,events:c.get(p)??[]}))}var Vt={completed:"ok",reset:"ok",skipped:"due_soon",missed:"overdue",triggered:"triggered",trigger_replaced:"triggered",trigger_removed:"ok"};function Ft(e,i){let t=[];for(let n=i-1;n>=0;n--){let s=new Date(e);s.setDate(s.getDate()-n),s.setHours(0,0,0,0),t.push(q(s))}return t}function $e(e,i,t,n=null){let s=Ft(i,t),r=s[0],o=s[s.length-1],d=new Map;for(let p of s)d.set(p,[]);for(let p of e){let _=p.object?.name||"",f=p.entry_id,v=p.tasks||[];for(let g of v){if(n&&g.responsible_user_id!==n)continue;let k=g.history||[];for(let b of k){if(typeof b?.timestamp!="string")continue;let D=b.timestamp.slice(0,10);if(D<r||D>o)continue;let O=d.get(D);if(!O)continue;let M=b.type??"completed";O.push({date:D,entry_id:f,task_id:g.id,task_name:g.name,object_name:_,status:Vt[M]??"ok",days_until_due:null,projected:!1,schedule_type:g.schedule_type,interval_days:g.interval_days??null,responsible_user_id:g.responsible_user_id??null,avg_cost:typeof b.cost=="number"?b.cost:null,adaptive_enabled:!!g.adaptive_config?.enabled,prediction_confidence:null,history_timestamp:b.timestamp,history_type:M,history_cost:typeof b.cost=="number"?b.cost:null,history_notes:typeof b.notes=="string"?b.notes:null,history_duration:typeof b.duration=="number"?b.duration:null})}}}let c={completed:0,reset:1,skipped:2,triggered:3,trigger_replaced:4};for(let[,p]of d)p.sort((_,f)=>{let v=c[_.history_type??""]??99,g=c[f.history_type??""]??99;if(v!==g)return v-g;let k=_.object_name.localeCompare(f.object_name);return k!==0?k:_.task_name.localeCompare(f.task_name)});return s.map(p=>({date:p,events:d.get(p)??[]}))}function Wt(e,i){if(i<=0)return 0;let t=typeof e=="number"&&Number.isFinite(e)?Math.trunc(e):0;return t<0?0:t%i}function Ut(e){return!!(e?.phases&&e.phase_sequence&&e.phase_sequence.length>0)}function et(e){if(!e||!Ut(e))return null;let i=e.phase_sequence,t=Wt(e.phase_cursor,i.length),n=i[t],s=e.phases?.[n];return s?{id:n,name:s.name,index:t,count:i.length,notes:s.notes,checklist:s.checklist!==void 0?s.checklist:e.checklist??[],consumesParts:s.consumes_parts!==void 0?s.consumes_parts:e.consumes_parts??[],requiredFields:s.required_completion_fields!==void 0?s.required_completion_fields:e.required_completion_fields??[]}:null}function V(e){let i=et(e);return i?`${i.index+1}/${i.count} \xB7 ${i.name}`:""}function xt(e){let i=e.task??null,t=i?et(i):null,n=t?t.consumesParts:i?.consumes_parts||[],s=!!i?.part_ref,r=e.objects.find(c=>c.entry_id===e.entryId)?.parts||[],o=s?r.find(c=>c.id===i.part_ref.part_id):void 0,d=e.checklistsEnabled??!0;return{entry_id:e.entryId,task_id:e.taskId,task_name:e.taskName,checklist:t?d?t.checklist:[]:e.checklist??[],adaptive_enabled:!!e.adaptiveEnabled,required_completion_fields:t?t.requiredFields:i?.required_completion_fields||[],task_type:i?.type||"",reading_unit:i?.reading_unit||"",readings:i?.readings||[],reading_history:mt(i?.history),parts:s?[]:_t({consumes_parts:n},e.entryId,e.objects,e.lang),consumes_parts:s?[]:n,phase_label:t?V(i):"",require_tag_scan:!!i?.require_tag_scan,restock_default:s?o?.restock_quantity??1:null,restock_unit_cost:s?o?.cost??null:null,currency_symbol:e.currencySymbol??"",consumes_info:n.map(c=>ht(c,e.entryId,e.objects,e.lang)),checklist_prefill:i?.checklist_progress||{},via_tag_scan:!!e.viaTagScan}}function $t(e,i,t){e.entryId=i.entry_id,e.taskId=i.task_id,e.taskName=i.task_name,e.lang=t,e.checklist=i.checklist??[],e.adaptiveEnabled=!!i.adaptive_enabled,e.requiredFields=i.required_completion_fields??[],e.taskType=i.task_type??"",e.readingUnit=i.reading_unit??"",e.readings=i.readings??[],e.readingHistory=i.reading_history??[],e.parts=i.parts??[],e.consumesParts=i.consumes_parts??[],e.phaseLabel=i.phase_label??"",e.requireTagScan=!!i.require_tag_scan,e.restockDefault=i.restock_default??null,e.restockUnitCost=i.restock_unit_cost??null,e.currencySymbol=i.currency_symbol??"",e.consumesInfo=i.consumes_info??[],e.checklistPrefill=i.checklist_prefill??{},e.viaTagScan=!!i.via_tag_scan,e.open({viaTagScan:!!i.via_tag_scan})}function y(e){return e.toFixed(1)}function Me(e,i,t=4){if(!isFinite(e)||!isFinite(i))return{ticks:[],niceMin:0,niceMax:1};if(e===i){let p=Math.abs(e)*.1||1;e-=p,i+=p}let n=i-e,s=Math.pow(10,Math.floor(Math.log10(n/Math.max(1,t)))),r=s;for(let p of[1,2,5,10])if(r=s*p,n/r<=t+.5)break;let o=Math.floor(e/r)*r,d=Math.ceil(i/r)*r,c=[];for(let p=o;p<=d+r*1e-6;p+=r)c.push(Math.abs(p)<r*1e-9?0:p);return{ticks:c,niceMin:o,niceMax:d}}function Pe(e,i){let t=Math.abs(e),n=s=>({maximumFractionDigits:s});return t>=1e6?x(e/1e6,i,n(t>=1e7?0:1))+"M":t>=1e4?x(e/1e3,i,n(0))+"k":t>=1e3?x(e/1e3,i,n(1))+"k":t>=100?x(e,i,n(0)):t>=1?x(e,i,n(1)):t===0?"0":x(e,i,n(2))}function Ee(e,i,t){let n=x(e,t,{maximumFractionDigits:Math.abs(e)>=100?0:1});return i?`${n} ${i}`:n}function Se(e,i,t){return Z(new Date(e),i,t)}function Ce(e,i){let t=new Date(e);return`${Z(t,i)}, ${rt(t,i)}`}function He(e,i){return new Date(e).getFullYear()!==new Date(i).getFullYear()}function je(e,i,t){if(t<2||i<=e)return[e,i];let n=[];for(let s=0;s<t;s++)n.push(e+(i-e)*s/(t-1));return n}function kt(e,i){let t=e.interval_analysis,n=t?.weibull_beta,s=t?.weibull_eta;if(n==null||s==null||s<=0)return u;let r=e.interval_days??0,o=e.suggested_interval??r;return l`
  ...
  `}function Yt(e,i,t){let n=e.confidence_interval_low,s=e.confidence_interval_high,r=i.suggested_interval??i.interval_days??0,o=i.interval_days??0,d=Math.max(0,n-5),p=s+5-d,_=(n-d)/p*100,f=(s-n)/p*100,v=(r-d)/p*100,g=o>0?(o-d)/p*100:-1;return l`
      ...
      <div class="prediction-grid">
        ...
        ${r&&t.environmental?l`
          <div class="prediction-item">
            ...
            ${e.environmental_entity?l`<span class="prediction-entity entity-link" @click=${d=>ct(d,e.environmental_entity)}>${e.environmental_entity}</span>`:u}
          </div>
        `:u}
      </div>
    </div>
  `}function At(e,i,t,n){let s=Math.max(e||1,i);return l`
  ...
  `}function Lt(e,i){return Zt(e,i)}function Zt(e,i){let t=e.seasonal_factors??e.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return u;let n=e.interval_analysis?.seasonal_reason,s=new Date().getMonth(),r=300,o=100,d=8,p=o-d-4,_=Math.max(...t,1.5),f=r/12,v=f*.65,g=d+p-1/_*p;return l`
  ...
  `}var $=class extends H{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return j(this.hass)}async openFor(t,n){this._entryId=t,this._taskId=n,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=q(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._currencySymbol=t?.budget?.currency_symbol||"",this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let n=(t.tasks||[]).find(s=>s.id===this._taskId);this._task=n??null}catch(t){this._error=T(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(n){return this._error=T(n,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("/maintenance_supporter_panelfiles/panel-chunks/dialog-mount-IY4K4GWO.js").then(async({openCompleteDialog:t})=>{let n=this._task,s=[];try{s=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}t(xt({entryId:this._entryId,taskId:this._taskId,taskName:n.name,task:n,objects:s,lang:this._lang,checklist:n.checklist||[],adaptiveEnabled:!!n.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("/maintenance_supporter_panelfiles/panel-chunks/dialog-mount-IY4K4GWO.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("/maintenance_supporter_panelfiles/panel-chunks/dialog-mount-IY4K4GWO.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=a("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=a("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${a("reanalyze_result",this._lang)||"Recomputed"}: ${lt(t.recommended_interval,"days",this._lang)} (${t.data_points} pts)`:a("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=T(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("/maintenance_supporter_panelfiles/panel-chunks/dialog-mount-IY4K4GWO.js").then(({openHistoryEditDialog:n})=>{n({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null,used_parts:t.used_parts??null,photo_doc_ids:Q(t),reading_value:t.reading_value??null,reading_values:J(t),readings:this._task?.readings??[],task_type:this._task?.type??null,reading_unit:this._task?.reading_unit??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return u;let n=this._lang;return l`
    ...
    `}_renderAdaptive(t){let n=this._lang,s=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,r=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,o=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,d=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!s&&!r&&!o&&!d?l`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${r?wt(t,n,this._features):u}
        ${o?kt(t,n):u}
        ${d?l`
          ${Tt(t,n,this._features)}
    ...
    `}_renderHistoryReadings(t,n,s){let r=J(t),o=d=>x(d,s,{maximumFractionDigits:3});if(r.length>0)return l`<div class="history-readings">
        ${r.map(d=>{let c=ft(n,t,d.id);return l`<span class="history-reading"><span class="history-reading-name">${d.name}</span>
                ...
                ${[...s].reverse().slice(0,20).map(c=>{let p=["completed","reset","skipped"].includes(c.type);return l`
                    <div class="history-entry">
                      <div class="history-line">
                        ...
                        <span class="history-date">${ot(c.timestamp,n)}</span>
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${n?l`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("/maintenance_supporter_panelfiles/panel-chunks/dialog-mount-IY4K4GWO.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ...
                  ${n.schedule?.kind&&!["manual","one_time"].includes(n.schedule.kind)||n.interval_days!=null?l`<span><strong>${a("interval",t)||"Interval"}:</strong> ${dt(n,t)}</span>`:u}
        ...
        ${n&&s?l`
              ...
              ${s.notes?l`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${Mt(s.notes)}</div>
                    </div>
                  `:u}
      ...
      <div class="meta">
        ${s.map(([r,o])=>l`
            <div class="meta-item">
              ...
              <span class="meta-value">${Dt(o)?l`<a href="${o}" target="_blank" rel="noopener noreferrer">${o}</a>`:o}</span>
            </div>
          `)}
      </div>
    `}};L.styles=C`
  ...
  `,h([P({attribute:!1})],L.prototype,"hass",2),h([m()],L.prototype,"_open",2),h([m()],L.prototype,"_entryId",2),h([m()],L.prototype,"_data",2),h([m()],L.prototype,"_busy",2),h([m()],L.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",L);var Pt="maintenance-object-dialog",Et="maintenance-task-dialog",Jt="maintenance-history-edit-dialog",Qt="maintenance-complete-dialog",Xt="maintenance-qr-dialog",te="maintenance-task-quick-actions-dialog",ee="maintenance-object-quick-actions-dialog";function Y(){return document.querySelector("home-assistant")?.hass}function ne(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function E(e){let i=ne(),t=i.querySelector(e)??document.body.querySelector(e);return t?t.parentNode!==i&&i.appendChild(t):(t=document.createElement(e),i.appendChild(t)),t}function S(e){let i=Y();if(!i)return!1;e.hass=i;let t=j(i);return it(t)||st(t).then(()=>{e.requestUpdate?.()}),at(i.locale,i.config?.country),!0}function Rn(e){return B(e).then(i=>i.rowActionStyle)}function On(){yt()}function zn(){let e=E(Pt);return S(e)?(e.openCreate(),!0):!1}function Nn(e,i){let t=E(Pt);return S(t)?(t.openEdit(e,i),!0):!1}function qn(e="",i){let t=E(Et);if(!S(t))return!1;let n=Y();return n?((async()=>{let s=await B(n),r=t;r.checklistsEnabled=s.features.checklists,r.scheduleTimeEnabled=s.features.schedule_time,r.completionActionsEnabled=s.features.completion_actions,r.defaultWarningDays=s.defaultWarningDays,r.openCreate(e,i)})(),!0):!1}function Vn(e,i){let t=E(Et);if(!S(t))return!1;let n=Y();return n?((async()=>{try{let[s,r]=await Promise.all([n.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:e}),B(n)]),o=(s.tasks||[]).find(c=>c.id===i);if(!o){console.warn(`openEditTaskDialog: task ${i} not found in entry ${e}`);return}let d=t;d.checklistsEnabled=r.features.checklists,d.scheduleTimeEnabled=r.features.schedule_time,d.completionActionsEnabled=r.features.completion_actions,d.defaultWarningDays=r.defaultWarningDays,await d.openEdit(e,o)}catch(s){console.warn("openEditTaskDialog: failed to load task/features",s)}})(),!0):!1}function Fn(e){let i=E(Jt);return S(i)?(i.openEdit(e),!0):!1}function Wn(e){let i=E(Qt);return S(i)?($t(i,e,Y()?.language||"en"),!0):!1}function Un(e){let i=E(Xt);return S(i)?(i.openForTask(e.entry_id,e.task_id,e.object_name,e.task_name),!0):!1}function Bn(e,i){let t=E(te);return S(t)?(t.openFor(e,i),!0):!1}function Kn(e){let i=E(ee);return S(i)?(i.openFor(e),!0):!1}export{Dt as a,ye as b,Mt as c,Wt as d,Ut as e,et as f,xt as g,$t as h,y as i,Me as j,Pe as k,Ee as l,Se as m,Ce as n,He as o,je as p,q,xe as r,$e as s,kt as t,wt as u,At as v,Tt as w,Lt as x,Rn as y,On as z,zn as A,Nn as B,qn as C,Vn as D,Fn as E,Wn as F,Un as G,Bn as H,Kn as I};
