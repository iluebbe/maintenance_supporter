      ...
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select .value=${$(n.currency)} @change=${a=>this._updateSetting("budget_currency",a.target.value)}>
            ${ae.map(a=>r`<option value=${a} ?selected=${n.currency===a}>${a}</option>`)}
          </select>
        </label>
        <label class="setting-row">
          ...
          <select class="currency-decimals" .value=${$(String(n.currency_decimals??0))}
            ...
            ${ne.map(a=>r`<option value=${String(a)} ?selected=${(n.currency_decimals??0)===a}>${a}</option>`)}
          </select>
        </label>
