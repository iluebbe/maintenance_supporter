...
import{a as j,c as P}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-VNYLIDZN.js";import{a as N,g as Q}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-YUCXSTBQ.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-OTZ56AC4.js";import{a as O,b as B}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-TVK2JN4G.js";import{a as U,b as D,c as F,e as K}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-X6Q4ETH4.js";import{M as R,a as d,b as I,c as r,e as $,f as l,g as z,h as C,l as q,m as p,q as t,s as M,v as A}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-H6BM4UNQ.js";var y={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},S=h=>(..._)=>({_$litDirective$:h,values:_}),w=class{constructor(_){}get _$AU(){return this._$AM._$AU}_$AT(_,e,s){this._$Ct=_,this._$AM=e,this._$Ci=s}_$AS(_,e){return this.update(_,e)}update(_,e){return this.render(...e)}};var k=class extends w{constructor(_){if(super(_),this.it=l,_.type!==y.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(_){if(_===l||_==null)return this._t=void 0,this.it=_;if(_===$)return _;if(typeof _!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(_===this.it)return this._t;this.it=_;let e=[_];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};k.directiveName="unsafeHTML",k.resultType=1;var G=S(k);var{I:ne}=z;var Y=h=>h.strings===void 0;var J={},W=(h,_=J)=>h._$AH=_;var x=S(class extends w{constructor(h){if(super(h),h.type!==y.PROPERTY&&h.type!==y.ATTRIBUTE&&h.type!==y.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Y(h))throw Error("`live` bindings can only contain a single expression")}render(h){return h}update(h,[_]){if(_===$||_===l)return _;let e=h.element,s=h.name;if(h.type===y.PROPERTY){if(_===e[s])return $}else if(h.type===y.BOOLEAN_ATTRIBUTE){if(!!_===e.hasAttribute(s))return $}else if(h.type===y.ATTRIBUTE&&e.getAttribute(s)===_+"")return $;return W(h),_}});var X=["EUR","USD","GBP","JPY","CHF","CAD","AUD","NZD","CNY","INR","BRL","CZK","PLN","RUB","SEK","NOK","DKK","UAH"],c=class extends C{constructor(){super(...arguments);this.budget=null;this._settings=null;this._loading=!0;this._importCsv="";this._importLoading=!1;this._includeHistory=!0;this._toast="";this._testingNotification=!1;this._personTargets=[];this._testingUser="";this._users=[];this._savedViews=[];this._vacEnabled=!1;this._vacStart="";this._vacEnd="";this._vacBuffer=3;this._vacExempt=new Set;this._vacIsActive=!1;this._vacWindowEnd=null;this._vacAllTasks=[];this._vacPreview=[];this._vacPreviewLoading=!1;this._vacSaving=!1;this._qrObjects=[];this._qrSelectedEntries=new Set;this._qrActions=new Set(["view"]);this._qrUrlMode="companion";this._qrBatchLoading=!1;this._qrBatchResults=[];this._qrObjectsLoaded=!1;this._exportObjects=[];this._exportSelectedEntries=new Set;this._exportObjectsLoaded=!1;this._docArchiveLoading=!1;this._loaded=!1;this._userService=null;this._sendTestNotification=async e=>{e?this._testingUser=e:this._testingNotification=!0;try{let s=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/test_notification",...e?{user_id:e}:{}}),i=s.message||(s.success?t("test_notification_success",this._lang):t("test_notification_failed",this._lang));this._showToast(i)}catch{this._showToast(t("test_notification_failed",this._lang))}finally{e?this._testingUser="":this._testingNotification=!1}};this._allTemplates=[];this._templateCategories={};this._tplOpenGroups=new Set;this._templatesRequested=!1}get _lang(){return M(this.hass)}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded?(this._loaded=!0,this._userService=new K(this.hass),this._loadSettings(),this._loadUsers()):e.has("hass")&&this.hass&&this._userService&&this._userService.updateHass(this.hass)}async _loadUsers(){if(this._userService){try{this._users=await this._userService.getUsers()}catch{this._users=[]}this._loadNotifyTargets()}}async _loadNotifyTargets(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/notify/user_targets"});this._personTargets=e.targets||[]}catch{this._personTargets=[]}}async _loadSettings(){this._loading=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});this._settings=e,A(this._settings.budget),this._hydrateVacationFromSettings()}catch{}try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"});this._savedViews=e.views||[]}catch{}this._loading=!1}_hydrateVacationFromSettings(){let e=this._settings?.vacation;e&&(this._vacEnabled=e.enabled,this._vacStart=e.start||"",this._vacEnd=e.end||"",this._vacBuffer=e.buffer_days,this._vacExempt=new Set(e.exempt_task_ids||[]),this._vacIsActive=e.is_active,this._vacWindowEnd=e.window_end)}_renderBatteryLifetimes(e){let s=this._settings?.general?.battery_lifetimes;if(!s||!s.length)return l;let i=this._settings?.general?.battery_lifetime_months??{},a=u=>t("lifetime_source_"+u.source,e),n=t("settings_battery_lifetime_months",e),o=u=>u.learned_models.length?r`<div class="bl-learned">${t("settings_battery_lifetime_learned_models",e).replace("{list}",u.learned_models.map(f=>`${f.model} ${f.months} ${n} (${f.samples})`).join(" \xB7 "))}</div>`:l,g=(u,f,H)=>{let T=Number.parseInt(f.value,10);if(!Number.isFinite(T)||T<1||T>240){f.value=String(H);return}this._updateSetting("battery_lifetime_months",{...i,[u]:T}).then(V=>{V||(f.value=String(H))})},b=u=>{let f={...i};delete f[u],this._updateSetting("battery_lifetime_months",f)},v=s.filter(u=>u.in_fleet),m=s.filter(u=>!u.in_fleet),E=u=>r`
      <div class="bl-row ${u.source==="override"?"bl-override":""}">
        ...
        <input class="bl-months" type="number" min="1" max="240" .value=${String(u.months)}
          @change=${f=>g(u.type,f.target,u.months)} />
        <span class="bl-unit">${t("settings_battery_lifetime_months",e)}</span>
        <span class="bl-source">${a(u)}</span>
        ${u.source==="override"?r`<button type="button" class="bl-reset" @click=${()=>b(u.type)}>${t("settings_battery_lifetime_reset",e)}</button>`:l}
        ${o(u)}
      </div>`;return r`
    ...
    `}_renderBatteryNotesHint(e){let s=this._settings?.general?.battery_notes;if(!s||!s.devices)return l;let i=this._settings?.general?.battery_low_percent??20,a=s.default>i,n=t("bn_summary",e).replace("{name}","Battery Notes").replace("{pct}",String(s.default)).replace("{n}",String(s.devices)),o=(a?t("bn_above_floor",e).replace("{name}","Battery Notes"):t("bn_floor_decides",e)).replace("{floor}",String(i)),g=n.search(/[:：]/),b=g<0?n:n.slice(0,g),v=g<0?"":n.slice(g);return r`
      ...
      <div class="settings-section member-avatars" data-section="member_avatars">
        ...
        ${this._users.map(i=>{let a=D(i),n=s[i.id]||{};return r`
      ...
      </div>`}async _setMemberAvatar(e,s){let i={...this._settings?.member_display||{}};if(s===null)delete i[e];else{let a={...i[e]||{},...s};"initials"in s&&!(s.initials||"").trim()&&delete a.initials,Object.keys(a).length?i[e]=a:delete i[e]}await this._updateSetting("member_display",i);try{this._users=await this._userService?.getUsers(!0)??this._users}catch{}}async _updateSetting(e,s){try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:{[e]:s}});return this._settings=i,A(this._settings.budget),Q(),this._showToast(t("settings_saved",this._lang)),this.dispatchEvent(new CustomEvent("settings-changed")),!0}catch{return this._showToast(t("action_error",this._lang)),this.requestUpdate(),!1}}_showToast(e){this._toast=e,setTimeout(()=>{this._toast=""},3e3)}_onBoundedIntChange(e,s,i,a,n){let o=e.target,g=parseInt(o.value,10);if(Number.isInteger(g)&&g>=i&&g<=a){this._updateSetting(s,g).then(b=>{b||(o.value=String(n))});return}this._showToast(t("settings_value_out_of_range",this._lang).replace("{min}",String(i)).replace("{max}",String(a))),o.value=String(n)}_downloadFile(e,s,i){O(e,s,i)}render(){let e=this._lang;return this._loading||!this._settings?r`<div class="settings-loading">Loading…</div>`:r`
    ...
    `}async _loadTemplates(){if(!this._templatesRequested){this._templatesRequested=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/templates",language:this._lang});this._allTemplates=e.templates||[],this._templateCategories=e.categories||{}}catch{}}}_renderTemplateToggles(e){this._loadTemplates();let s=new Set(this._settings.disabled_template_ids||[]),i=new Map;for(let n of Object.keys(this._templateCategories))i.set(n,[]);for(let n of this._allTemplates)i.has(n.category)||i.set(n.category,[]),i.get(n.category).push(n);let a=n=>this._templateCategories[n]?.["name_"+e]||this._templateCategories[n]?.name_en||n;return r`
      <div class="settings-section" data-section="templates">
        ...
        ${[...i.entries()].filter(([,n])=>n.length>0).map(([n,o])=>{let g=o.filter(v=>!s.has(v.id)).length,b=this._tplOpenGroups.has(n);return r`
            <div class="tpl-group">
              <div
      ...
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select .value=${x(a.currency)} @change=${n=>this._updateSetting("budget_currency",n.target.value)}>
            ${X.map(n=>r`<option value=${n} ?selected=${a.currency===n}>${n}</option>`)}
          </select>
        </label>
        <label class="setting-row">
