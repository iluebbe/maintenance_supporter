    ...
    `}_renderCondition(e,i){let t=this._lang,r=i+1;return a`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${J.map(_=>a`<option value=${_} ?selected=${_===e.type}>${s(_,t)}</option>`)}
          </select>
        </div>
