...
`).map(h=>h.trim()).filter(Boolean).slice(0,100);e.checklist=_.length?_:null}if(this.completionActionsEnabled){let _=this._actionService.trim();if(_&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(_)){let f={service:_},v=this._actionTargetEntity.trim();v&&(f.target={entity_id:v});let g=this._buildActionData();Object.keys(g).length>0&&(f.data=g),e.on_complete_action=f}else e.on_complete_action=null;let h={};this._qcNotes.trim()&&(h.notes=this._qcNotes.trim());let d=parseFloat(this._qcCost);!isNaN(d)&&d>=0&&(h.cost=d);let m=parseInt(this._qcDuration,10);!isNaN(m)&&m>=0&&(h.duration=m),this._qcFeedback&&(h.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(h).length?h:null}let t=await this.hass.connection.sendMessagePromise(e),r=this._taskId||t?.task_id,c=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(r&&this._scheduleType==="sensor_based"&&c)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:r,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(r&&this._adaptiveSnapshot()!==this._adaptiveInitial){let _=parseFloat(this._adaptiveAlpha),h=parseInt(this._adaptiveMin,10),d=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:r,enabled:this._adaptiveEnabled,..._>=.1&&_<=.9?{ewa_alpha:_}:{},...!isNaN(h)&&h>=1?{min_interval_days:h}:{},...!isNaN(d)&&d>=1?{max_interval_days:d}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=M(e,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return p;let e=this._lang,i=this._triggerType==="compound";return o`
      ...
      <div class="select-row">
        ...
        >
          ${Y.map(t=>o`<option value=${t} ?selected=${t===this._triggerType}>${s(t,e)}</option>`)}
        </select>
      </div>
      ...
      ${this._intervalDays?o`
          ...
          `:p}
    `}_patchCondition(e,i){this._compoundConditions=this._compoundConditions.map((t,r)=>r===e?{...t,...i}:t)}_addCondition(){this._compoundConditions=[...this._compoundConditions,J()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((i,t)=>t!==e)}_renderCompoundEditor(){let e=this._lang;return o`
      <div class="select-row">
    ...
    `}_renderCondition(e,i){let t=this._lang,r=i+1;return o`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${j.map(c=>o`<option value=${c} ?selected=${c===e.type}>${s(c,t)}</option>`)}
          </select>
        </div>
    ...
    `}_buildSchedule(){let e=t=>{let r=parseInt(this._calOffset,10)||0;return r&&(t.offset=Math.max(-15,Math.min(r,15))),t};if(this._scheduleType==="weekdays")return e({kind:"weekdays",weekdays:[...this._weekdays].sort((t,r)=>t-r)});if(this._scheduleType==="nth_weekday")return e({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let i={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(i.business=!0),e(i)}_recurrenceExtras(){let e={};if(this._seasonMonths.length&&(e.season_months=[...this._seasonMonths].sort((i,t)=>i-t)),this._endsMode==="count"){let i=parseInt(this._endsCount,10);i>=1&&(e.ends={count:i})}else this._endsMode==="until"&&this._endsUntil&&(e.ends={until:this._endsUntil});return e}_toggleSeasonMonth(e){this._seasonMonths=this._seasonMonths.includes(e)?this._seasonMonths.filter(i=>i!==e):[...this._seasonMonths,e]}_renderRecurrenceExtras(){let e=this._lang;if(!(this._scheduleType==="time_based"||P.includes(this._scheduleType)))return p;let t=ee(e);return o`
      ...
      ${this._endsMode==="until"?o`
        ...
        ></ms-date-field>`:p}
    `}_renderCalendarFields(){let e=this._lang,i=Z(e);if(this._scheduleType==="weekdays")return o`
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${V.map(t=>o`<option value=${t} ?selected=${t===this._type}>${s(t,e)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${W.map(t=>o`<option value=${t} ?selected=${t===this._priority}>${s("priority_"+t,e)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${K.map(t=>o`<option value=${t} ?selected=${t===this._scheduleType}>${s(t,e)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="sensor_based"?o`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:U,device_class:D}}}]}
  ...
  `,n([E({attribute:!1})],a.prototype,"hass",2),n([E({type:Boolean,attribute:"checklists-enabled"})],a.prototype,"checklistsEnabled",2),n([E({type:Boolean,attribute:"schedule-time-enabled"})],a.prototype,"scheduleTimeEnabled",2),n([E({type:Boolean,attribute:"completion-actions-enabled"})],a.prototype,"completionActionsEnabled",2),n([E({type:Number,attribute:"default-warning-days"})],a.prototype,"defaultWarningDays",2),n([l()],a.prototype,"parts",2),n([l()],a.prototype,"_foreignOwners",2),n([l()],a.prototype,"_open",2),n([l()],a.prototype,"_entityPickerFallback",2),n([l()],a.prototype,"_loading",2),n([l()],a.prototype,"_error",2),n([l()],a.prototype,"_entryId",2),n([l()],a.prototype,"_taskId",2),n([l()],a.prototype,"_objectChoices",2),n([l()],a.prototype,"_name",2),n([l()],a.prototype,"_type",2),n([l()],a.prototype,"_scheduleType",2),n([l()],a.prototype,"_intervalDays",2),n([l()],a.prototype,"_intervalUnit",2),n([l()],a.prototype,"_dueDate",2),n([l()],a.prototype,"_warningDays",2),n([l()],a.prototype,"_earliestCompletionDays",2),n([l()],a.prototype,"_intervalAnchor",2),n([l()],a.prototype,"_weekdays",2),n([l()],a.prototype,"_nth",2),n([l()],a.prototype,"_nthWeekday",2),n([l()],a.prototype,"_domDay",2),n([l()],a.prototype,"_domLastDay",2),n([l()],a.prototype,"_domBusiness",2),n([l()],a.prototype,"_calOffset",2),n([l()],a.prototype,"_seasonMonths",2),n([l()],a.prototype,"_endsMode",2),n([l()],a.prototype,"_endsCount",2),n([l()],a.prototype,"_endsUntil",2),n([l()],a.prototype,"_schedulePreview",2),n([l()],a.prototype,"_schedulePreviewEnded",2),n([l()],a.prototype,"_notes",2),n([l()],a.prototype,"_documentationUrl",2),n([l()],a.prototype,"_customIcon",2),n([l()],a.prototype,"_priority",2),n([l()],a.prototype,"_labels",2),n([l()],a.prototype,"_enabled",2),n([l()],a.prototype,"_triggerEntityId",2),n([l()],a.prototype,"_triggerEntityIds",2),n([l()],a.prototype,"_triggerEntityLogic",2),n([l()],a.prototype,"_triggerAttribute",2),n([l()],a.prototype,"_triggerType",2),n([l()],a.prototype,"_triggerAbove",2),n([l()],a.prototype,"_triggerBelow",2),n([l()],a.prototype,"_triggerEquals",2),n([l()],a.prototype,"_triggerNotEquals",2),n([l()],a.prototype,"_triggerForMinutes",2),n([l()],a.prototype,"_triggerCombinator",2),n([l()],a.prototype,"_triggerTargetValue",2),n([l()],a.prototype,"_triggerDeltaMode",2),n([l()],a.prototype,"_triggerBaselineValue",2),n([l()],a.prototype,"_liveBaselineValue",2),n([l()],a.prototype,"_autoCompleteOnRecovery",2),n([l()],a.prototype,"_triggerFromState",2),n([l()],a.prototype,"_triggerToState",2),n([l()],a.prototype,"_triggerTargetChanges",2),n([l()],a.prototype,"_triggerRuntimeHours",2),n([l()],a.prototype,"_triggerRuntimeMaxSession",2),n([l()],a.prototype,"_triggerOnStates",2),n([l()],a.prototype,"_compoundLogic",2),n([l()],a.prototype,"_compoundConditions",2),n([l()],a.prototype,"_suggestedAttributes",2),n([l()],a.prototype,"_availableAttributes",2),n([l()],a.prototype,"_entityDomain",2),n([l()],a.prototype,"_lastPerformed",2),n([l()],a.prototype,"_nfcTagId",2),n([l()],a.prototype,"_requireTagScan",2),n([l()],a.prototype,"_allowSkip",2),n([l()],a.prototype,"_readingUnit",2),n([l()],a.prototype,"_consumesParts",2),n([l()],a.prototype,"_partsLoadFailed",2),n([l()],a.prototype,"_availableTags",2),n([l()],a.prototype,"_responsibleUserId",2),n([l()],a.prototype,"_assigneePool",2),n([l()],a.prototype,"_rotationStrategy",2),n([l()],a.prototype,"_availableUsers",2),n([l()],a.prototype,"_checklistText",2),n([l()],a.prototype,"_phaseDefs",2),n([l()],a.prototype,"_phaseSeq",2),n([l()],a.prototype,"_requiredCompletion",2),n([l()],a.prototype,"_scheduleTime",2),n([l()],a.prototype,"_actionService",2),n([l()],a.prototype,"_actionTargetEntity",2),n([l()],a.prototype,"_actionData",2),n([l()],a.prototype,"_actionDataJsonFallback",2),n([l()],a.prototype,"_actionTesting",2),n([l()],a.prototype,"_actionTestResult",2),n([l()],a.prototype,"_actionTestError",2),n([l()],a.prototype,"_qcNotes",2),n([l()],a.prototype,"_qcCost",2),n([l()],a.prototype,"_qcDuration",2),n([l()],a.prototype,"_qcFeedback",2),n([l()],a.prototype,"_environmentalEntity",2),n([l()],a.prototype,"_environmentalAttribute",2),n([l()],a.prototype,"_adaptiveEnabled",2),n([l()],a.prototype,"_adaptiveAlpha",2),n([l()],a.prototype,"_adaptiveMin",2),n([l()],a.prototype,"_adaptiveMax",2),n([l()],a.prototype,"_adaptiveSeasonal",2),n([l()],a.prototype,"_adaptivePrediction",2),n([l()],a.prototype,"_conditionAttrOptions",2);var L=a;customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",L);export{L as a};
