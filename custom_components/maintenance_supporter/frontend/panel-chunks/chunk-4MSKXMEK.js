...
`),partId:k?.part_id||"",partQty:k?.quantity!=null?String(k.quantity):"",reqOverride:m.required_completion_fields!==void 0,reqFields:[...m.required_completion_fields||[]],extraParts:S.filter((x,J)=>J!==I).map(x=>({...x})),carry:Y}}),this._phaseSeq=[...i.phase_sequence||[]],this._requiredCompletion=[...i.required_completion_fields||[]],this._scheduleTime=i.schedule_time||"";let _=i.on_complete_action;if(_&&_.service){this._actionService=_.service;let l=_.target?.entity_id;this._actionTargetEntity=Array.isArray(l)?l[0]||"":l||"",this._actionData=_.data&&typeof _.data=="object"?{..._.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let c=i.quick_complete_defaults;this._qcNotes=c?.notes||"",this._qcCost=c?.cost!=null?String(c.cost):"",this._qcDuration=c?.duration!=null?String(c.duration):"",this._qcFeedback=c?.feedback||"";let h=i.adaptive_config||{};if(this._environmentalEntity=h.environmental_entity||"",this._environmentalAttribute=h.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,this._adaptiveEnabled=!!h.enabled,this._adaptiveAlpha=h.ewa_alpha?.toString()??b.alpha,this._adaptiveMin=h.min_interval_days?.toString()??b.min,this._adaptiveMax=h.max_interval_days?.toString()??b.max,this._adaptiveSeasonal=h.seasonal_enabled!==!1,this._adaptivePrediction=h.sensor_prediction_enabled!==!1,this._adaptiveInitial=this._adaptiveSnapshot(),i.trigger_config){let l=i.trigger_config;this._triggerEntityId=l.entity_id||l.entity_ids&&l.entity_ids[0]||"",this._triggerEntityIds=l.entity_ids||(l.entity_id?[l.entity_id]:[]),this._triggerEntityLogic=l.entity_logic||"any",this._triggerAttribute=l.attribute||"",this._triggerType=l.type||"threshold",this._triggerAbove=l.trigger_above?.toString()||"",this._triggerBelow=l.trigger_below?.toString()||"",this._triggerEquals=l.trigger_equals?.toString()||"",this._triggerNotEquals=l.trigger_not_equals?.toString()||"",this._triggerForMinutes=l.trigger_for_minutes?.toString()||"0",this._triggerCombinator=l.trigger_combinator==="all"?"all":"any",this._triggerTargetValue=l.trigger_target_value?.toString()||"",this._triggerDeltaMode=l.trigger_delta_mode||!1,this._triggerBaselineValue=l.trigger_baseline_value?.toString()||"",this._liveBaselineValue=i.trigger_baseline_value??null,this._autoCompleteOnRecovery=l.auto_complete_on_recovery||!1,this._triggerFromState=l.trigger_from_state||"",this._triggerToState=l.trigger_to_state||"",this._triggerTargetChanges=l.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=l.trigger_runtime_hours?.toString()||"",this._triggerRuntimeMaxSession=l.trigger_runtime_max_session_seconds?.toString()||"",this._triggerOnStates=(l.trigger_on_states||[]).join(", "),l.type==="compound"?(this._compoundLogic=l.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(l.conditions||[]).map(re)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._requireTagScan=!1,this._allowSkip=!0,this._readingUnit="",this._readings=[],this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._phaseDefs=[],this._phaseSeq=[],this._requiredCompletion=[],this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._adaptiveEnabled=!1,this._adaptiveAlpha=b.alpha,this._adaptiveMin=b.min,this._adaptiveMax=b.max,this._adaptiveSeasonal=!0,this._adaptivePrediction=!0,this._adaptiveInitial=this._adaptiveSnapshot(),this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerEquals="",this._triggerNotEquals="",this._triggerForMinutes="0",this._triggerCombinator="any",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerRuntimeMaxSession="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new j(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}_toggleAssignee(e){this._assigneePool=this._assigneePool.includes(e)?this._assigneePool.filter(i=>i!==e):[...this._assigneePool,e]}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[i,t]=e.split(".");if(!this.hass?.services?.[i]?.[t]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let r=this._actionTargetEntity.trim();if(r){let _=r.split(".")[0];if(_!==i&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(i)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${i}.* entities; entity "${r}" is in ${_}.* \u2014 pick a service that matches the entity domain (e.g. ${_}.${t})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[r]){this._actionTestResult="error",this._actionTestError=`Target entity "${r}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[i,t]=e.split("."),r=this.hass?.services?.[i]?.[t]?.fields;return!r||Object.keys(r).length===0?null:Object.entries(r).map(([_,c])=>({name:_,required:!!c.required,selector:c.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return u;let i=this._serviceSchema();return o`
    ...
    `}_toggleRequired(e,i){let t=new Set(this._requiredCompletion);i?t.add(e):t.delete(e),this._requiredCompletion=[...t]}_patchReading(e,i){this._readings=this._readings.map(t=>t.id===e?{...t,...i}:t)}_renderReadingsEditor(e){return o`
      <div class="readings-editor">
        ...
        ${this._readings.map(i=>o`
          <div class="reading-row">
            <ms-textfield
              ...
              .value=${i.name}
              @input=${t=>this._patchReading(i.id,{name:t.target.value})}
            ></ms-textfield>
            <ms-textfield
              class="reading-unit"
              label="${s("reading_unit_short",e)}"
              .value=${i.unit||""}
              @input=${t=>this._patchReading(i.id,{unit:t.target.value})}
            ></ms-textfield>
            <mwc-icon-button class="phase-remove reading-remove" @click=${()=>this._readings=this._readings.filter(t=>t.id!==i.id)}>
        ...
        ${this._readings.length<20?o`
          <ha-button appearance="plain" class="reading-add"
            @click=${()=>this._readings=[...this._readings,{id:V(),name:"",unit:this._readings.length?this._readings[this._readings.length-1].unit:this._readingUnit}]}>
              ...
              ${q.map(r=>o`
                <label class="req-option">
                  <input
                    ...
                    @change=${_=>{let c=_.target.checked,h=new Set(t.reqFields);c?h.add(r):h.delete(r),this._patchPhaseDef(t.id,{reqFields:[...h]})}}
                  />
                  <span>${s(A[r],e)}</span>
                </label>
              `)}
        ...
        <div class="phase-seq">
          ${this._phaseSeq.map((t,r)=>o`
            <span class="phase-chip">
              ${r+1}. ${i(t)}
              <button class="phase-chip-x" @click=${()=>{this._phaseSeq=this._phaseSeq.filter((_,c)=>c!==r)}}>✕</button>
            </span>
          `)}
          <select
            class="phase-seq-add"
...
`).map(h=>h.trim()).filter(Boolean).slice(0,100);e.checklist=c.length?c:null}if(this.completionActionsEnabled){let c=this._actionService.trim();if(c&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(c)){let y={service:c},f=this._actionTargetEntity.trim();f&&(y.target={entity_id:f});let g=this._buildActionData();Object.keys(g).length>0&&(y.data=g),e.on_complete_action=y}else e.on_complete_action=null;let h={};this._qcNotes.trim()&&(h.notes=this._qcNotes.trim());let l=parseFloat(this._qcCost);!isNaN(l)&&l>=0&&(h.cost=l);let m=parseInt(this._qcDuration,10);!isNaN(m)&&m>=0&&(h.duration=m),this._qcFeedback&&(h.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(h).length?h:null}let t=await this.hass.connection.sendMessagePromise(e),r=this._taskId||t?.task_id,_=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(r&&this._scheduleType==="sensor_based"&&_)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:r,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(r&&this._adaptiveSnapshot()!==this._adaptiveInitial){let c=parseFloat(this._adaptiveAlpha),h=parseInt(this._adaptiveMin,10),l=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:r,enabled:this._adaptiveEnabled,...c>=.1&&c<=.9?{ewa_alpha:c}:{},...!isNaN(h)&&h>=1?{min_interval_days:h}:{},...!isNaN(l)&&l>=1?{max_interval_days:l}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=D(e,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return u;let e=this._lang,i=this._triggerType==="compound";return o`
      ...
      <div class="select-row">
        ...
        >
          ${te.map(t=>o`<option value=${t} ?selected=${t===this._triggerType}>${s(t,e)}</option>`)}
        </select>
      </div>
      ${i?this._renderCompoundEditor():o`
        ...
        <ha-form
          ...
          .hass=${this.hass}
          .schema=${[{name:"trigger_entities",selector:{entity:{multiple:!0,domain:P}}}]}
      ...
      ${this._intervalDays?o`
          ...
          `:u}
    `}_patchCondition(e,i){this._compoundConditions=this._compoundConditions.map((t,r)=>r===e?{...t,...i}:t)}_addCondition(){this._compoundConditions=[...this._compoundConditions,ie()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((i,t)=>t!==e)}_renderCompoundEditor(){let e=this._lang;return o`
      <div class="select-row">
    ...
    `}_renderCondition(e,i){let t=this._lang,r=i+1;return o`
      <div class="compound-condition">
        ...
        <ha-form
          class="entity-picker-form"
          .hass=${this.hass}
          .schema=${[{name:"condition_entities",selector:{entity:{multiple:!0,domain:P}}}]}
          .data=${{condition_entities:e.entityIds.split(",").map(_=>_.trim()).filter(Boolean)}}
          .computeLabel=${()=>s("entity_id",t)}
          @value-changed=${_=>{let c=(_.detail.value.condition_entities||[]).filter(Boolean);this._patchCondition(i,{entityIds:c.join(", ")})}}
        ></ha-form>`}
        ...
        <div class="select-row">
          ...
          >
            ${G.map(_=>o`<option value=${_} ?selected=${_===e.type}>${s(_,t)}</option>`)}
          </select>
        </div>
    ...
    `}_buildSchedule(){let e=t=>{let r=parseInt(this._calOffset,10)||0;return r&&(t.offset=Math.max(-15,Math.min(r,15))),t};if(this._scheduleType==="weekdays")return e({kind:"weekdays",weekdays:[...this._weekdays].sort((t,r)=>t-r)});if(this._scheduleType==="nth_weekday")return e({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let i={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(i.business=!0),e(i)}_recurrenceExtras(){let e={};if(this._seasonMonths.length&&(e.season_months=[...this._seasonMonths].sort((i,t)=>i-t)),this._endsMode==="count"){let i=parseInt(this._endsCount,10);i>=1&&(e.ends={count:i})}else this._endsMode==="until"&&this._endsUntil&&(e.ends={until:this._endsUntil});return e}_toggleSeasonMonth(e){this._seasonMonths=this._seasonMonths.includes(e)?this._seasonMonths.filter(i=>i!==e):[...this._seasonMonths,e]}_renderRecurrenceExtras(){let e=this._lang;if(!(this._scheduleType==="time_based"||L.includes(this._scheduleType)))return u;let t=oe(e);return o`
      ...
      ${this._endsMode==="until"?o`
        ...
        ></ms-date-field>`:u}
    `}_renderCalendarFields(){let e=this._lang,i=ae(e);if(this._scheduleType==="weekdays")return o`
        ...
        <div class="select-row">
          ...
          <select .value=${this._nth} @change=${r=>this._nth=r.target.value}>
            ${t.map(([r,_])=>o`<option value=${r} ?selected=${r===this._nth}>${_}</option>`)}
          </select>
        </div>
        <div class="select-row">
          <label>${s("recurrence_weekday",e)}</label>
          <select .value=${this._nthWeekday} @change=${r=>this._nthWeekday=r.target.value}>
            ${i.map((r,_)=>o`<option value=${String(_)} ?selected=${String(_)===this._nthWeekday}>${r}</option>`)}
          </select>
        </div>
      ...
      ></ms-textfield>`}_thresholdLimitsOverlap(){let e=parseFloat(this._triggerAbove),i=parseFloat(this._triggerBelow);return!isNaN(e)&&!isNaN(i)&&i>e}_renderTriggerLiveHint(){if(this._triggerType==="compound")return u;let e=this._triggerType==="threshold"&&this._thresholdLimitsOverlap()?o`<div class="trigger-live-hint warn">${s("trigger_hint_overlap",this._lang)}</div>`:u,i=this._triggerEntityId||this._triggerEntityIds[0];if(!i||!this.hass?.states)return e;let t=this.hass.states[i];if(!t)return e;let r=this._lang,_=t.attributes?.unit_of_measurement,c=typeof _=="string"&&_?` ${_}`:"",h=this._triggerAttribute?t.attributes?.[this._triggerAttribute]:t.state,l=typeof h=="number"?h:parseFloat(String(h)),m=h!=="unknown"&&h!=="unavailable"&&h!=null&&!isNaN(l),y=g=>M(g,r,{maximumFractionDigits:1}),f=[];if(this._triggerType==="threshold"){let g=parseFloat(this._triggerAbove),$=parseFloat(this._triggerBelow);if(isNaN(g)&&isNaN($))return u;m&&f.push(s("trigger_hint_now",r).replace("{value}",y(l)+c)),isNaN(g)||f.push(s("trigger_hint_above",r).replace("{target}",y(g)+c)),isNaN($)||f.push(s("trigger_hint_below",r).replace("{target}",y($)+c))}else if(this._triggerType==="counter"){let g=parseFloat(this._triggerTargetValue);if(isNaN(g))return u;this._triggerDeltaMode?this._taskId?f.push(s("trigger_hint_counter_delta_edit",r).replace("{target}",y(g)+c)):m?f.push(s("trigger_hint_counter_delta",r).replace("{value}",y(l)+c).replace("{due}",y(l+g)+c).replace("{target}",y(g)+c)):f.push(s("trigger_hint_counter_delta_edit",r).replace("{target}",y(g)+c)):(m&&f.push(s("trigger_hint_now",r).replace("{value}",y(l)+c)),f.push(s("trigger_hint_counter_abs",r).replace("{target}",y(g)+c)))}else if(this._triggerType==="runtime"){let g=parseFloat(this._triggerRuntimeHours);if(isNaN(g))return u;f.push(s("trigger_hint_runtime",r).replace("{hours}",y(g))),f.push(s("trigger_hint_state_now",r).replace("{value}",String(t.state)))}else if(this._triggerType==="state_change"){let g=parseInt(this._triggerTargetChanges,10)||1,$=this._triggerToState.trim();f.push(($?s("trigger_hint_state_change_to",r).replace("{state}",$):s("trigger_hint_state_change",r)).replace("{count}",String(g))),f.push(s("trigger_hint_state_now",r).replace("{value}",String(t.state)))}return f.length?o`<div class="trigger-live-hint">${f.join(" ")}</div>${e}`:e}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?o`
        <ms-textfield
      ...
      `:u}render(){if(!this._open)return o``;let e=this._lang,i=this._taskId?s("edit_task",e):s("new_task",e);return o`
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${X.map(t=>o`<option value=${t} ?selected=${t===this._type}>${s(t,e)}</option>`)}
            </select>
          </div>
          ${this._type==="reading"?o`
              ...
              `:u}
          ${this._partsLoadFailed?o`<div class="field-help parts-load-failed">${s("parts_load_failed",e)}</div>`:u}
          ...
          <div class="select-row">
            ...
            >
              ${Z.map(t=>o`<option value=${t} ?selected=${t===this._priority}>${s("priority_"+t,e)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${ee.map(t=>o`<option value=${t} ?selected=${t===this._scheduleType}>${s(t,e)}</option>`)}
            </select>
          </div>
          ...
          ${this._requireTagScan?o`<div class="field-help">${s("require_tag_scan_help",e)}</div>`:u}
          <label class="req-option">
            <input
              type="checkbox"
          ...
          ${this._allowSkip?u:o`<div class="field-help">${s("disallow_skip_help",e)}</div>`}
    ...
    `}};n._PREVIEW_RELEVANT=new Set(["_open","_scheduleType","_intervalDays","_intervalUnit","_intervalAnchor","_dueDate","_weekdays","_nth","_nthWeekday","_domDay","_domLastDay","_domBusiness","_calOffset","_seasonMonths","_endsMode","_endsCount","_endsUntil","_lastPerformed"]),n.styles=R`
    .dialog-title {
      font-size: 18px;
      font-weight: 500;
      padding-bottom: 12px;
  ...
  `,a([E({attribute:!1})],n.prototype,"hass",2),a([E({type:Boolean,attribute:"checklists-enabled"})],n.prototype,"checklistsEnabled",2),a([E({type:Boolean,attribute:"schedule-time-enabled"})],n.prototype,"scheduleTimeEnabled",2),a([E({type:Boolean,attribute:"completion-actions-enabled"})],n.prototype,"completionActionsEnabled",2),a([E({type:Number,attribute:"default-warning-days"})],n.prototype,"defaultWarningDays",2),a([d()],n.prototype,"parts",2),a([d()],n.prototype,"_foreignOwners",2),a([d()],n.prototype,"_open",2),a([d()],n.prototype,"_entityPickerFallback",2),a([d()],n.prototype,"_loading",2),a([d()],n.prototype,"_error",2),a([d()],n.prototype,"_entryId",2),a([d()],n.prototype,"_taskId",2),a([d()],n.prototype,"_objectChoices",2),a([d()],n.prototype,"_name",2),a([d()],n.prototype,"_type",2),a([d()],n.prototype,"_scheduleType",2),a([d()],n.prototype,"_intervalDays",2),a([d()],n.prototype,"_intervalUnit",2),a([d()],n.prototype,"_dueDate",2),a([d()],n.prototype,"_warningDays",2),a([d()],n.prototype,"_earliestCompletionDays",2),a([d()],n.prototype,"_intervalAnchor",2),a([d()],n.prototype,"_weekdays",2),a([d()],n.prototype,"_nth",2),a([d()],n.prototype,"_nthWeekday",2),a([d()],n.prototype,"_domDay",2),a([d()],n.prototype,"_domLastDay",2),a([d()],n.prototype,"_domBusiness",2),a([d()],n.prototype,"_calOffset",2),a([d()],n.prototype,"_seasonMonths",2),a([d()],n.prototype,"_endsMode",2),a([d()],n.prototype,"_endsCount",2),a([d()],n.prototype,"_endsUntil",2),a([d()],n.prototype,"_schedulePreview",2),a([d()],n.prototype,"_schedulePreviewEnded",2),a([d()],n.prototype,"_notes",2),a([d()],n.prototype,"_documentationUrl",2),a([d()],n.prototype,"_customIcon",2),a([d()],n.prototype,"_priority",2),a([d()],n.prototype,"_labels",2),a([d()],n.prototype,"_enabled",2),a([d()],n.prototype,"_triggerEntityId",2),a([d()],n.prototype,"_triggerEntityIds",2),a([d()],n.prototype,"_triggerEntityLogic",2),a([d()],n.prototype,"_triggerAttribute",2),a([d()],n.prototype,"_triggerType",2),a([d()],n.prototype,"_triggerAbove",2),a([d()],n.prototype,"_triggerBelow",2),a([d()],n.prototype,"_triggerEquals",2),a([d()],n.prototype,"_triggerNotEquals",2),a([d()],n.prototype,"_triggerForMinutes",2),a([d()],n.prototype,"_triggerCombinator",2),a([d()],n.prototype,"_triggerTargetValue",2),a([d()],n.prototype,"_triggerDeltaMode",2),a([d()],n.prototype,"_triggerBaselineValue",2),a([d()],n.prototype,"_liveBaselineValue",2),a([d()],n.prototype,"_autoCompleteOnRecovery",2),a([d()],n.prototype,"_triggerFromState",2),a([d()],n.prototype,"_triggerToState",2),a([d()],n.prototype,"_triggerTargetChanges",2),a([d()],n.prototype,"_triggerRuntimeHours",2),a([d()],n.prototype,"_triggerRuntimeMaxSession",2),a([d()],n.prototype,"_triggerOnStates",2),a([d()],n.prototype,"_compoundLogic",2),a([d()],n.prototype,"_compoundConditions",2),a([d()],n.prototype,"_suggestedAttributes",2),a([d()],n.prototype,"_availableAttributes",2),a([d()],n.prototype,"_entityDomain",2),a([d()],n.prototype,"_lastPerformed",2),a([d()],n.prototype,"_nfcTagId",2),a([d()],n.prototype,"_requireTagScan",2),a([d()],n.prototype,"_allowSkip",2),a([d()],n.prototype,"_readingUnit",2),a([d()],n.prototype,"_readings",2),a([d()],n.prototype,"_consumesParts",2),a([d()],n.prototype,"_partsLoadFailed",2),a([d()],n.prototype,"_availableTags",2),a([d()],n.prototype,"_responsibleUserId",2),a([d()],n.prototype,"_assigneePool",2),a([d()],n.prototype,"_rotationStrategy",2),a([d()],n.prototype,"_availableUsers",2),a([d()],n.prototype,"_checklistText",2),a([d()],n.prototype,"_phaseDefs",2),a([d()],n.prototype,"_phaseSeq",2),a([d()],n.prototype,"_requiredCompletion",2),a([d()],n.prototype,"_scheduleTime",2),a([d()],n.prototype,"_actionService",2),a([d()],n.prototype,"_actionTargetEntity",2),a([d()],n.prototype,"_actionData",2),a([d()],n.prototype,"_actionDataJsonFallback",2),a([d()],n.prototype,"_actionTesting",2),a([d()],n.prototype,"_actionTestResult",2),a([d()],n.prototype,"_actionTestError",2),a([d()],n.prototype,"_qcNotes",2),a([d()],n.prototype,"_qcCost",2),a([d()],n.prototype,"_qcDuration",2),a([d()],n.prototype,"_qcFeedback",2),a([d()],n.prototype,"_environmentalEntity",2),a([d()],n.prototype,"_environmentalAttribute",2),a([d()],n.prototype,"_adaptiveEnabled",2),a([d()],n.prototype,"_adaptiveAlpha",2),a([d()],n.prototype,"_adaptiveMin",2),a([d()],n.prototype,"_adaptiveMax",2),a([d()],n.prototype,"_adaptiveSeasonal",2),a([d()],n.prototype,"_adaptivePrediction",2),a([d()],n.prototype,"_conditionAttrOptions",2);var N=n;customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",N);export{w as a,le as b,de as c,N as d};
