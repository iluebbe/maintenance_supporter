...
import{a as P,c as R,d as G,e as K,f as Q}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-224AQOXH.js";import{a as F,g as k,n as L,o as ee}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-7ZHTO7IF.js";import{a as Z}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-K7MNT3ES.js";import{b as X}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-RPKRRGNH.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-NIKVLIPP.js";import{a as U,b as D}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-X7QLZGHR.js";import{a as Y,b as W,c as V,e as J}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-N5DHUE6B.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-PJQDDU52.js";import{N as M,a as d,b as I,c as r,e as x,f as l,g as N,h as B,l as S,m as p,q as s,s as O,v as H}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-LTBDMOCY.js";var y={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},A=h=>(..._)=>({_$litDirective$:h,values:_}),w=class{constructor(_){}get _$AU(){return this._$AM._$AU}_$AT(_,e,t){this._$Ct=_,this._$AM=e,this._$Ci=t}_$AS(_,e){return this.update(_,e)}update(_,e){return this.render(...e)}};var E=class extends w{constructor(_){if(super(_),this.it=l,_.type!==y.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(_){if(_===l||_==null)return this._t=void 0,this.it=_;if(_===x)return _;if(typeof _!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(_===this.it)return this._t;this.it=_;let e=[_];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};E.directiveName="unsafeHTML",E.resultType=1;var te=A(E);var{I:ve}=N;var se=h=>h.strings===void 0;var re={},ie=(h,_=re)=>h._$AH=_;var $=A(class extends w{constructor(h){if(super(h),h.type!==y.PROPERTY&&h.type!==y.ATTRIBUTE&&h.type!==y.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!se(h))throw Error("`live` bindings can only contain a single expression")}render(h){return h}update(h,[_]){if(_===x||_===l)return _;let e=h.element,t=h.name;if(h.type===y.PROPERTY){if(_===e[t])return x}else if(h.type===y.BOOLEAN_ATTRIBUTE){if(!!_===e.hasAttribute(t))return x}else if(h.type===y.ATTRIBUTE&&e.getAttribute(t)===_+"")return x;return ie(h),_}});var z={default_warning_days:[0,365],default_consumable_threshold:[1,90],battery_low_percent:[1,90],battery_recovered_percent:[20,100],archive_oneoff_days:[0,3650],delete_archived_oneoff_days:[0,3650],notify_due_soon_interval_hours:[0,720],notify_overdue_interval_hours:[0,720],notify_triggered_interval_hours:[0,720],max_notifications_per_day:[0,1e3],notification_bundle_threshold:[2,20],snooze_duration_hours:[1,168],warranty_reminder_days:[1,365],budget_alert_threshold:[10,100],currency_decimals:[0,3]};function ae(h){let _=z[h];if(!_)throw new Error(`not an int-ranged setting: ${h}`);return _}var j=[0,14];var oe=["EUR","USD","GBP","JPY","CHF","CAD","AUD","NZD","CNY","INR","BRL","CZK","PLN","RUB","SEK","NOK","DKK","UAH"],le=(([h,_])=>Array.from({length:_-h+1},(e,t)=>h+t))(z.currency_decimals),c=class extends B{constructor(){super(...arguments);this.budget=null;this._settings=null;this._loading=!0;this._importCsv="";this._importLoading=!1;this._includeHistory=!0;this._toast="";this._testingNotification=!1;this._personTargets=[];this._testingUser="";this._users=[];this._savedViews=[];this._vacEnabled=!1;this._vacStart="";this._vacEnd="";this._vacBuffer=3;this._vacExempt=new Set;this._vacIsActive=!1;this._vacWindowEnd=null;this._vacAllTasks=[];this._vacPreview=[];this._vacPreviewLoading=!1;this._previewBusy=!1;this._vacSaving=!1;this._qrObjects=[];this._qrSelectedEntries=new Set;this._qrActions=new Set(["view"]);this._qrUrlMode="companion";this._qrBatchLoading=!1;this._qrBatchResults=[];this._qrObjectsLoaded=!1;this._exportObjects=[];this._exportSelectedEntries=new Set;this._exportObjectsLoaded=!1;this._docArchiveLoading=!1;this._loaded=!1;this._userService=null;this._sendTestNotification=async e=>{e?this._testingUser=e:this._testingNotification=!0;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/test_notification",...e?{user_id:e}:{}}),i=t.message||(t.success?s("test_notification_success",this._lang):s("test_notification_failed",this._lang));this._showToast(i)}catch{this._showToast(s("test_notification_failed",this._lang))}finally{e?this._testingUser="":this._testingNotification=!1}};this._toastTimer=new ee;this._compacting=!1;this._allTemplates=[];this._templateCategories={};this._homeProfile=null;this._tplOpenGroups=new Set;this._templatesRequested=!1}get _lang(){return O(this.hass)}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded?(this._loaded=!0,this._userService=new J(this.hass),this._loadSettings(),this._loadUsers()):e.has("hass")&&this.hass&&this._userService&&this._userService.updateHass(this.hass)}async _loadUsers(){if(this._userService){try{this._users=await this._userService.getUsers()}catch{this._users=[]}this._loadNotifyTargets()}}async _loadNotifyTargets(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/notify/user_targets"});this._personTargets=e.targets||[]}catch{this._personTargets=[]}}async _loadSettings(){this._loading=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});this._settings=e,H(this._settings.budget),this._hydrateVacationFromSettings()}catch{}try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"});this._savedViews=e.views||[]}catch{}this._loading=!1}_hydrateVacationFromSettings(){let e=this._settings?.vacation;e&&(this._vacEnabled=e.enabled,this._vacStart=e.start||"",this._vacEnd=e.end||"",this._vacBuffer=e.buffer_days,this._vacExempt=new Set(e.exempt_task_ids||[]),this._vacIsActive=e.is_active,this._vacWindowEnd=e.window_end)}_renderBatteryLifetimes(e){let t=this._settings?.general?.battery_lifetimes;if(!t||!t.length)return l;let i=this._settings?.general?.battery_lifetime_months??{},n=u=>s("lifetime_source_"+u.source,e),a=s("settings_battery_lifetime_months",e),o=u=>u.learned_models.length?r`<div class="bl-learned">${s("settings_battery_lifetime_learned_models",e).replace("{list}",u.learned_models.map(f=>`${f.model} ${f.months} ${a} (${f.samples})`).join(" \xB7 "))}</div>`:l,g=(u,f,C)=>{let q=Number.parseInt(f.value,10);if(!Number.isFinite(q)||q<1||q>240){f.value=String(C);return}this._updateSetting("battery_lifetime_months",{...i,[u]:q}).then(ne=>{ne||(f.value=String(C))})},b=u=>{let f={...i};delete f[u],this._updateSetting("battery_lifetime_months",f)},v=t.filter(u=>u.in_fleet),m=t.filter(u=>!u.in_fleet),T=u=>r`
      <div class="bl-row ${u.source==="override"?"bl-override":""}">
        <span class="bl-type">${u.type}${u.in_fleet?r` <span class="bl-fleet">${s("settings_battery_lifetime_in_fleet",e)}</span>`:l}</span>
        ...
        ${u.source==="override"?r`<button type="button" class="bl-reset" @click=${()=>b(u.type)}>${s("settings_battery_lifetime_reset",e)}</button>`:l}
        ${o(u)}
      </div>`;return r`
      ...
      <div class="bl-table">
        ${v.map(T)}
        ${m.length?r`<details class="bl-more"><summary>${m.length} ×</summary>${m.map(T)}</details>`:l}
      </div>
    `}_renderBatteryNotesHint(e){let t=this._settings?.general?.battery_notes;if(!t||!t.devices)return l;let i=this._settings?.general?.battery_low_percent??20,n=t.default>i,a=s("bn_summary",e).replace("{name}","Battery Notes").replace("{pct}",String(t.default)).replace("{n}",String(t.devices)),o=(n?s("bn_above_floor",e).replace("{name}","Battery Notes"):s("bn_floor_decides",e)).replace("{floor}",String(i)),g=a.search(/[:：]/),b=g<0?a:a.slice(0,g),v=g<0?"":a.slice(g);return r`
      <div class="bn-note${n?" warn":""}">
        ...
        <span>
          ...
          ${t.overrides.length?r` · ${s("bn_overrides",e).replace("{n}",String(t.overrides.length+t.more))}
                ...
                ${t.more?r` <span class="bn-more">${s("bn_more",e).replace("{n}",String(t.more))}</span>`:l}`:l}
          <span class="bn-sub">${o}</span>
        </span>
      </div>`}_renderMemberAvatars(e){if(!this._users.length)return l;let t=this._settings?.member_display||{};return r`
      <div class="settings-section member-avatars" data-section="member_avatars">
        ...
        ${this._users.map(i=>{let n=W(i),a=t[i.id]||{};return r`
            <div class="member-avatar-row">
              ...
              ${a.initials||a.color?r`<button class="ha-button secondary member-reset" @click=${()=>this._setMemberAvatar(i.id,null)}>${s("member_avatar_reset",e)}</button>`:l}
            </div>`})}
      </div>`}async _setMemberAvatar(e,t){let i={...this._settings?.member_display||{}};if(t===null)delete i[e];else{let n={...i[e]||{},...t};"initials"in t&&!(t.initials||"").trim()&&delete n.initials,Object.keys(n).length?i[e]=n:delete i[e]}await this._updateSetting("member_display",i);try{this._users=await this._userService?.getUsers(!0)??this._users}catch{}}async _updateSetting(e,t){let i=await this._ws({type:"maintenance_supporter/global/update",settings:{[e]:t}});return i?(this._settings=i,H(this._settings.budget),L(),this._showToast(s("settings_saved",this._lang)),this.dispatchEvent(new CustomEvent("settings-changed")),!0):(this.requestUpdate(),!1)}_showToast(e){this._toast=e,this._toastTimer.schedule(()=>{this._toast=""})}disconnectedCallback(){super.disconnectedCallback(),this._toastTimer.clear(),this._toast=""}_ws(e,t,i){return Z(this,e,{fallbackKey:t,busy:i,onError:n=>this._showToast(n)})}async _compactReferenceNumbers(){let e=this._lang;if(this._compacting||!window.confirm(s("settings_compact_refs_confirm",e)))return;let t=await this._ws({type:"maintenance_supporter/reference_numbers/compact"},"action_error",i=>{this._compacting=i});t&&this._showToast(s("settings_compact_refs_done",e).replace("{objects}",String(t.objects)).replace("{tasks}",String(t.tasks)).replace("{completions}",String(t.completions)))}_onBoundedIntChange(e,t,i,n,a){let o=e.target,g=parseInt(o.value,10);if(Number.isInteger(g)&&g>=i&&g<=n){this._updateSetting(t,g).then(b=>{b||(o.value=String(a))});return}this._showToast(s("settings_value_out_of_range",this._lang).replace("{min}",String(i)).replace("{max}",String(n))),o.value=String(a)}_intSetting(e,t){let[i,n]=ae(e);return r`<input type="number" min=${i} max=${n} .value=${String(t)}
      @change=${a=>this._onBoundedIntChange(a,e,i,n,t)} />`}_downloadFile(e,t,i){U(e,t,i)}render(){let e=this._lang;return this._loading||!this._settings?r`<div class="settings-loading">Loading…</div>`:r`
      ...
      ${this._renderHomeProfile(e)}
      ${this._renderTemplateToggles(e)}
      ${this._toast?r`<div class="settings-toast">${this._toast}</div>`:l}
    `}scrollToSection(e){requestAnimationFrame(()=>{let t=this.shadowRoot;if(!t)return;let i=t.querySelector(`[data-section="${e}"]`)??t.querySelector(`[data-section-alt="${e}"]`);i&&i.scrollIntoView({behavior:"smooth",block:"start"})})}_renderPanelAccess(e){let t=new Set(this._settings.admin_panel_user_ids||[]),i=this._users.filter(o=>!o.is_admin),n=this._settings.operator_write_enabled??!1,a=(o,g)=>{let b=new Set(t);g?b.add(o):b.delete(o),this._updateSetting("admin_panel_user_ids",[...b])};return r`
      <div class="settings-section">
        <h3>${s("settings_panel_access",e)} ${n&&t.size>0?r`<span class="section-badge">${t.size}</span>`:l}</h3>
        ...
        ${n?i.length===0?r`<div class="setting-row hint">${s("no_non_admin_users",e)}</div>`:i.map(o=>r`
              <label class="setting-row">
                ...
                <input type="checkbox"
                  .checked=${t.has(o.id)}
                  @change=${g=>a(o.id,g.target.checked)} />
              </label>
            `):l}
      </div>
    ...
    `}async _loadTemplates(){if(!this._templatesRequested){this._templatesRequested=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/templates",language:this._lang});this._allTemplates=e.templates||[],this._templateCategories=e.categories||{},this._homeProfile=e.profile??null}catch{}}}_renderHomeProfile(e){this._loadTemplates();let t=this._homeProfile,i=this._settings.home_type||"auto",n=t?.climate,a=n&&n.koppen?s("home_climate_value",e).replace("{koppen}",n.koppen).replace("{cold}",String(n.coldest_c??"\u2013")).replace("{warm}",String(n.warmest_c??"\u2013")):s("home_climate_unknown",e),o=K(t?.country,e);return r`
      <div class="settings-section" data-section="home_profile">
        <h3>${s("home_profile_title",e)}</h3>
        <p class="section-desc">${s("home_profile_hint",e)}</p>
        <label class="setting-row">
          <span class="setting-label">${s("home_type_label",e)}</span>
          <select class="home-type" .value=${$(i)}
            @change=${g=>{this._setHomeType(g.target.value)}}>
            <option value="auto" ?selected=${i==="auto"}>
              ${s("home_type_auto",e).replace("{detected}",G(t?.dwelling_detected??"unknown",e))}
            </option>
            <option value="house" ?selected=${i==="house"}>${s("home_dwelling_house",e)}</option>
            <option value="apartment" ?selected=${i==="apartment"}>${s("home_dwelling_apartment",e)}</option>
          </select>
        </label>
        ${t&&t.dwelling_reasons.length?r`<div class="setting-hint home-detected">
              ${s("home_detected_from",e).replace("{reasons}",Q(t.dwelling_reasons,e))}
            </div>`:l}
        <div class="setting-row home-climate">
          <span class="setting-label">${s("home_climate_label",e)}</span>
          <span class="home-climate-value">${o?`${o} \xB7 `:""}${a}</span>
        </div>
        ${t?.hemisphere==="south"?r`<div class="setting-hint">${s("home_hemisphere_south",e)}</div>`:l}
        ${t&&t.traits.length?r`<div class="home-traits">
              ${t.traits.map(g=>r`<span class="home-trait">${s(`home_trait_${g}`,e)}</span>`)}
            </div>`:l}
      </div>
    `}async _setHomeType(e){await this._updateSetting("home_type",e)&&(this._templatesRequested=!1,await this._loadTemplates())}_renderTemplateToggles(e){this._loadTemplates();let t=new Set(this._settings.disabled_template_ids||[]),i=new Map;for(let a of Object.keys(this._templateCategories))i.set(a,[]);for(let a of this._allTemplates)i.has(a.category)||i.set(a.category,[]),i.get(a.category).push(a);let n=a=>this._templateCategories[a]?.["name_"+e]||this._templateCategories[a]?.name_en||a;return r`
      <div class="settings-section" data-section="templates">
        ...
        ${[...i.entries()].filter(([,a])=>a.length>0).map(([a,o])=>{let g=o.filter(v=>!t.has(v.id)).length,b=this._tplOpenGroups.has(a);return r`
            <div class="tpl-group">
              <div
    ...
    `}_toggleColumn(e,t){let i=new Set(R(this._settings.objects_table_columns));t?i.add(e):i.delete(e);let n=P.filter(a=>a.required||i.has(a.key)).map(a=>a.key);this._updateSetting("objects_table_columns",n)}_renderGeneral(e){let t=this._settings.general,i=t.notify_targets??[],n=this._settings.budget;return r`
      <div class="settings-section">
        ...
        <label class="setting-row">
          <span class="setting-label">${s("settings_battery_auto_record",e)}</span>
          <input type="checkbox" class="auto-record-recovery"
            .checked=${t.battery_auto_record_recovery===!0}
            @change=${a=>this._updateSetting("battery_auto_record_recovery",a.target.checked)} />
        </label>
        <div class="setting-hint">${s("settings_battery_auto_record_hint",e)}</div>
        ...
        ${this.hass?.user?.is_admin?r`<div class="setting-row">
              <span class="setting-label">${s("settings_compact_refs",e)}</span>
              <button class="btn compact-refs" ?disabled=${this._compacting} @click=${this._compactReferenceNumbers}>
                <ha-icon icon="mdi:sort-numeric-ascending"></ha-icon> ${s("settings_compact_refs",e)}
              </button>
            </div>
            <div class="setting-hint">${s("settings_compact_refs_hint",e)}</div>`:l}
        <label class="setting-row">
          <span class="setting-label">${s("settings_currency",e)}</span>
          <select .value=${$(n.currency)} @change=${a=>this._updateSetting("budget_currency",a.target.value)}>
            ${oe.map(a=>r`<option value=${a} ?selected=${n.currency===a}>${a}</option>`)}
          </select>
        </label>
        <label class="setting-row">
          <span class="setting-label">${s("settings_currency_decimals",e)}</span>
          <select class="currency-decimals" .value=${$(String(n.currency_decimals??0))}
            @change=${a=>this._updateSetting("currency_decimals",Number(a.target.value))}>
            ${le.map(a=>r`<option value=${String(a)} ?selected=${(n.currency_decimals??0)===a}>${a}</option>`)}
          </select>
        </label>
    ...
    `}_todoEntities(e){let t=Object.keys(this.hass?.states||{}).filter(i=>i.startsWith("todo.")).sort();return e&&!t.includes(e)&&t.unshift(e),t}_renderNotifications(e){let t=this._settings.notifications,i=this._settings.actions;return r`
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select class="notify-completed" .value=${$(t.completed||"off")}
    ...
    `}_renderVacation(e){let t=this._vacEnabled&&!this._vacIsActive&&this._vacWindowEnd&&new Date(this._vacWindowEnd)<new Date,i=this._vacExempt.size;return r`
      <div class="settings-section vacation-section" data-section="vacation">
        <h3>
          ${s("vacation_title",e)}
          ${this._vacIsActive?r`<span class="vac-badge active">${s("vacation_active",e)}</span>`:l}
          ${t?r`<span class="vac-badge stale">${s("vacation_ended",e)}</span>`:l}
        </h3>
        ...
        <div class="vac-grid">
          ...
          <label class="vac-field">
            ...
            <input type="number" min=${j[0]} max=${j[1]} .value=${String(this._vacBuffer)}
              @change=${n=>this._setVacationBuffer(n)} />
          </label>
        </div>
        ...
        ${this._vacStart&&this._vacEnd?r`
          <div class="vac-preview-toolbar">
            ...
            ${this._vacPreview.length>0?r`<span class="vac-preview-count">${this._vacPreview.length} ${s("vacation_preview_affected",e)}</span>`:l}
          </div>
    ...
    `}_renderVacationTaskList(e){let t=new Map;for(let n of this._vacAllTasks){let a=t.get(n.object_name)||[];a.push(n),t.set(n.object_name,a)}return[...t.entries()].sort(([n],[a])=>n.localeCompare(a)).map(([n,a])=>r`
      <div class="vac-task-group">
        ...
        ${a.sort((o,g)=>o.task_name.localeCompare(g.task_name)).map(o=>r`
            ...
            <div class="vac-preview-row ${n?"exempt":""}">
              <div class="vac-preview-info">
                <div class="vac-preview-name">
                  ...
                  ${t.kind==="sensor_based"?r`<span class="vac-preview-kind">${s("vacation_sensor_based",e)}</span>`:l}
                </div>
              ...
              <div class="vac-preview-actions">
                ...
                ${t.kind==="time_based"&&t.allow_skip!==!1?r`<button .disabled=${this._previewBusy} @click=${()=>this._previewActionSkip(t)}>${s("qr_action_skip",e)}</button>`:l}
