...
import{b as ut,f as B,g as yt}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-6PQYSM4X.js";import{a as Q,b as gt,c as X}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-C6POIDO3.js";import{b as ht,c as _t,e as J,f as mt,h as ft}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-UICMCBMR.js";import{a as T}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-6SXTGGF3.js";import{A as ot,C as lt,H as Z,I as dt,J as ct,M as pt,a as h,b as C,c as l,d as z,f as u,h as H,l as P,m,n as U,q as a,s as j,t as it,u as st,v as at,w as x,y as rt,z as N}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-NP3P545L.js";var R=class extends H{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{this._url=await ut(this.hass,this.docId)}catch{this._failed=!0}}render(){return this._failed||!this.docId?u:this._url?l`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${n?l`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("/maintenance_supporter_panelfiles/panel-chunks/dialog-mount-KDQZOR3E.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
