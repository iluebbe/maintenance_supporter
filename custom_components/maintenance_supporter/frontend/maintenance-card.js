...
`;var T=class extends y{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"}}get _lang(){return this.hass?.language||"en"}setConfig(t){this._config={...t}}_valueChanged(t,a){let i={...this._config,[t]:a};this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}render(){let t=this._lang;return g`
      <div class="editor">
        <ha-textfield
          label="${p("card_title",t)}"
          .value=${this._config.title||""}
          @input=${a=>this._valueChanged("title",a.target.value)}
        ></ha-textfield>

        <ha-formfield label="${p("card_show_header",t)}">
          <ha-switch
        ...
        <ha-formfield label="${p("card_show_actions",t)}">
          <ha-switch
        ...
        <ha-formfield label="${p("card_compact",t)}">
          <ha-switch
  ...
  `,u([v({attribute:!1})],T.prototype,"hass",2),u([b()],T.prototype,"_config",2),T=u([G("maintenance-supporter-card-editor")],T);var m=class extends y{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="de";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._checklistState={};this._feedback="needed"}open(){this._open=!0,this._notes="",this._cost="",this._duration="",this._checklistState={},this._feedback="needed"}_toggleCheck(t){let a=String(t);this._checklistState={...this._checklistState,[a]:!this._checklistState[a]}}_setFeedback(t){this._feedback=t}async _complete(){this._loading=!0;try{let t={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};this._notes&&(t.notes=this._notes),this._cost&&(t.cost=parseFloat(this._cost)),this._duration&&(t.duration=parseInt(this._duration,10)),this.checklist.length>0&&(t.checklist_state=this._checklistState),this.adaptiveEnabled&&(t.feedback=this._feedback),await this.hass.connection.sendMessagePromise(t),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return g``;let t=this.lang||this.hass?.language||"de";return g`
      ...
      >
        <div class="content">
          ...
          `:d}
          <ha-textfield
            label="${p("notes_optional",t)}"
            .value=${this._notes}
            @input=${a=>this._notes=a.target.value}
          ></ha-textfield>
          <ha-textfield
            label="${p("cost_optional",t)}"
            type="number"
            step="0.01"
            .value=${this._cost}
          ...
          ></ha-textfield>
          <ha-textfield
            label="${p("duration_minutes",t)}"
            type="number"
            .value=${this._duration}
            @input=${a=>this._duration=a.target.value}
          ></ha-textfield>
          ${this.adaptiveEnabled?g`
            <div class="feedback-section">
              <label class="feedback-label">${p("was_maintenance_needed",t)}</label>
              <div class="feedback-buttons">
                <button
                  class="feedback-btn ${this._feedback==="needed"?"selected":""}"
                  @click=${()=>this._setFeedback("needed")}
                >${p("feedback_needed",t)}</button>
                <button
                  class="feedback-btn ${this._feedback==="not_needed"?"selected":""}"
                  @click=${()=>this._setFeedback("not_needed")}
                >${p("feedback_not_needed",t)}</button>
                <button
                  class="feedback-btn ${this._feedback==="not_sure"?"selected":""}"
                  @click=${()=>this._setFeedback("not_sure")}
                >${p("feedback_not_sure",t)}</button>
              </div>
            </div>
          `:d}
        </div>
        ...
        >
          ${this._loading?p("completing",t):p("complete",t)}
        </ha-button>
      </ha-dialog>
    `}};m.styles=k`
    .content {
  ...
  `,u([v({attribute:!1})],m.prototype,"hass",2),u([v()],m.prototype,"entryId",2),u([v()],m.prototype,"taskId",2),u([v()],m.prototype,"taskName",2),u([v()],m.prototype,"lang",2),u([v({type:Array})],m.prototype,"checklist",2),u([v({type:Boolean})],m.prototype,"adaptiveEnabled",2),u([b()],m.prototype,"_open",2),u([b()],m.prototype,"_notes",2),u([b()],m.prototype,"_cost",2),u([b()],m.prototype,"_duration",2),u([b()],m.prototype,"_loading",2),u([b()],m.prototype,"_checklistState",2),u([b()],m.prototype,"_feedback",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",m);var x=class extends y{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._stats=null;this._unsub=null;this._dataLoaded=!1;this._lastConnection=null;this._onCompleted=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"de"}static getConfigElement(){return document.createElement("maintenance-supporter-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-card",show_header:!0,show_actions:!0}}setConfig(t){this._config=t}getCardSize(){return 3}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null}updated(t){if(super.updated(t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,a]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=a}catch{}}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(t=>{let a=t;this._objects=a.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _flatTasks(){let t=[],{filter_status:a,filter_objects:i,max_items:o}=this._config;for(let l of this._objects)if(!(i?.length&&!i.includes(l.object.name)))for(let s of l.tasks)a?.length&&!a.includes(s.status)||t.push({entry_id:l.entry_id,object_name:l.object.name,task:s});let r={overdue:0,triggered:1,due_soon:2,ok:3};return t.sort((l,s)=>(r[l.task.status]??9)-(r[s.task.status]??9)),o&&o>0?t.slice(0,o):t}render(){let t=this._lang,a=this._config.title||p("maintenance",t),i=this._config.show_header!==!1,o=this._config.show_actions!==!1,r=this._config.compact||!1,l=this._flatTasks,s=this._stats;return g`
    ...
    `],u([v({attribute:!1})],x.prototype,"hass",2),u([b()],x.prototype,"_config",2),u([b()],x.prototype,"_objects",2),u([b()],x.prototype,"_stats",2),u([b()],x.prototype,"_unsub",2),x=u([G("maintenance-supporter-card")],x);window.customCards=window.customCards||[];window.customCards.push({type:"maintenance-supporter-card",name:"Maintenance Supporter",description:"Overview of your maintenance tasks with quick actions.",preview:!0});export{x as MaintenanceSupporterCard};
