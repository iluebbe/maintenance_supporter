      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="dialog-actions">
          ...
          <ha-button
            ...
            title=${this._missingRequired.length?this._missingRequired.map(t=>n("err_required",e).replace("{field}",n(We[t]??t,e))).join(" \xB7 "):""}
          >
                    ...
                    <div class="task-item clickable"
                      ...
                      ${l&&a?o`
                            <ha-button
                              ...
                              title="${n("complete",e)}"
                              @click=${y=>{y.stopPropagation();let m=this.shadowRoot.querySelector("maintenance-complete-dialog");Ve(m,Be({entryId:f,taskId:v.id,taskName:v.name,task:v,objects:this._objects,lang:e,checklist:v.checklist||[],adaptiveEnabled:!!v.adaptive_config?.enabled,currencySymbol:this._stats?.budget?.currency_symbol||""}),e)}}
                            >
