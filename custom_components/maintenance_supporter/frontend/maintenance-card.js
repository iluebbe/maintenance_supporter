...
`;var D=class extends y{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"}}get _lang(){return this.hass?.language||"de"}setConfig(t){this._config={...t}}_valueChanged(t,a){let i={...this._config,[t]:a};this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}render(){let t=this._lang;return _`
      <div class="editor">
        <ha-textfield
