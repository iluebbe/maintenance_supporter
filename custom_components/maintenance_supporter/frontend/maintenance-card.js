                ...
                ${l.map(({entry_id:g,object_name:h,task:d})=>p`
                    <div class="task-item">
                      ...
                      <div class="task-info">
                        ...
                        ${s?c:p`<div class="task-meta">${h} · ${_(d.type,t)}</div>`}
                      </div>
                      <div class="task-due">
