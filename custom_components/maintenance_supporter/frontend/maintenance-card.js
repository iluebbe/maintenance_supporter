    ...
    `}_renderCondition(e,t){let i=this._lang,n=t+1;return o`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${Bi.map(c=>o`<option value=${c} ?selected=${c===e.type}>${a(c,i)}</option>`)}
          </select>
        </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${or.map(i=>o`<option value=${i} ?selected=${i===this._type}>${a(i,e)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${lr.map(i=>o`<option value=${i} ?selected=${i===this._priority}>${a("priority_"+i,e)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${cr.map(i=>o`<option value=${i} ?selected=${i===this._scheduleType}>${a(i,e)}</option>`)}
            </select>
          </div>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,l([y({attribute:!1})],B.prototype,"hass",2),l([y()],B.prototype,"lang",2),l([u()],B.prototype,"_open",2),l([u()],B.prototype,"_loading",2),l([u()],B.prototype,"_error",2),l([u()],B.prototype,"_viewResult",2),l([u()],B.prototype,"_completeResult",2),l([u()],B.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",B)});var Gi=w(()=>{"use strict"});function Qi(r){let s=r.getFullYear(),e=String(r.getMonth()+1).padStart(2,"0"),t=String(r.getDate()).padStart(2,"0");return`${s}-${e}-${t}`}var Ji=w(()=>{"use strict";Gi()});function Zi(r,s){let e=r.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return p;let n=r.interval_days??0,c=r.suggested_interval??n;return o`
    <div class="weibull-section">
      ...
      ${br(t,i,n,c,s)}
      ${yr(e,s)}
      ${e?.confidence_interval_low!=null?xr(e,r,s):p}
    </div>
  ...
  `}function br(r,s,e,t,i){let b=Math.max(e,t,s,1)*1.3,m=50,$=[];for(let V=0;V<=m;V++){let Y=V/m*b,bs=1-Math.exp(-Math.pow(Y/s,r)),ys=32+Y/b*260,xs=136-bs*128;$.push([ys,xs])}let D=$.map(([V,Y])=>`${E(V)},${E(Y)}`).join(" "),I="M32,136 "+$.map(([V,Y])=>`L${E(V)},${E(Y)}`).join(" ")+` L${E($[m][0])},136 Z`,S=32+e/b*260,L=1-Math.exp(-Math.pow(e/s,r)),_e=136-L*128,fs=H((1-L)*100,i,0),Ft=32+t/b*260,vs=[0,.25,.5,.75,1];return o`
    ...
    <div class="weibull-info-row">
      ...
      ${r.weibull_r_squared!=null?o`
        <div class="weibull-info-item">
          ...
          <span class="weibull-info-value">${H(r.weibull_r_squared,s,3)}</span>
        </div>
      `:p}
    </div>
  `}function xr(r,s,e){let t=r.confidence_interval_low,i=r.confidence_interval_high,n=s.suggested_interval??s.interval_days??0,c=s.interval_days??0,d=Math.max(0,t-5),_=i+5-d,f=(t-d)/_*100,x=(i-t)/_*100,v=(n-d)/_*100,b=c>0?(c-d)/_*100:-1;return o`
      ...
      <div class="prediction-grid">
        ${t?o`
          <div class="prediction-item">
            ...
            ${r.degradation_rate!=null?o`<span class="prediction-rate">${r.degradation_rate>0?"+":""}${H(r.degradation_rate,s,Math.abs(r.degradation_rate)>=10?0:1)} ${r.trigger_entity_info?.unit_of_measurement||""}/${a("day_short",s)}</span>`:p}
          </div>
        `:p}
        ${i?o`
          <div class="prediction-item">
        ...
        ${n&&e.environmental?o`
          <div class="prediction-item">
            ...
            <span class="prediction-value">${H(r.environmental_factor,s,2)}x</span>
            ${r.environmental_entity?o`<span class="prediction-entity entity-link" @click=${d=>Pi(d,r.environmental_entity)}>${r.environmental_entity}</span>`:p}
          </div>
        `:p}
      </div>
    </div>
  `}var ts=w(()=>{"use strict";R();q()});function is(r,s,e,t){let i=Math.max(r||1,s);return o`
  ...
  `}function ns(r,s){return wr(r,s)}function wr(r,s){let e=r.seasonal_factors??r.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return p;let t=r.interval_analysis?.seasonal_reason,i=new Date().getMonth(),n=300,c=100,d=8,_=c-d-4,f=Math.max(...e,1.5),x=n/12,v=x*.65,b=d+_-1/f*_;return o`
        ...
        ${t?o`
              <div class="header">
                ...
                <div class="quick-info">
                  ...
                  ${t.schedule?.kind&&!["manual","one_time"].includes(t.schedule.kind)||t.interval_days!=null?o`<span><strong>${a("interval",e)||"Interval"}:</strong> ${Ii(t,e)}</span>`:p}
  ...
  `,l([y({attribute:!1})],Z.prototype,"hass",2),l([u()],Z.prototype,"_open",2),l([u()],Z.prototype,"_entryId",2),l([u()],Z.prototype,"_data",2),l([u()],Z.prototype,"_busy",2),l([u()],Z.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",Z)});function hs(){let r=window;return r.__msSettingsCache??={promise:null}}function st(r){let s=hs();if(s.promise)return s.promise;let e=r.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(t=>({features:t.features??Ht.features,defaultWarningDays:t.general?.default_warning_days??7,rowActionStyle:t.general?.row_action_style??Ht.rowActionStyle})).catch(()=>(s.promise===e&&(s.promise=null),Ht));return s.promise=e,e}function us(){hs().promise=null}var Ht,_s=w(()=>{"use strict";Ht={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"}});var ie={};$s(ie,{__resetSettingsCacheForTests:()=>Cr,getRowActionStyle:()=>Ot,openCompleteDialog:()=>Rr,openCreateObjectDialog:()=>Dt,openCreateTaskDialog:()=>Mt,openEditObjectDialog:()=>Ir,openEditTaskDialog:()=>Pr,openHistoryEditDialog:()=>Lr,openObjectQuickActions:()=>jr,openQrDialog:()=>qr,openTaskQuickActions:()=>zt});function rt(){return document.querySelector("home-assistant")?.hass}function Tr(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function se(r){let s=Tr(),e=s.querySelector(r)??document.body.querySelector(r);return e?e.parentNode!==s&&s.appendChild(e):(e=document.createElement(r),s.appendChild(e)),e}function re(r){let s=rt();if(!s)return!1;r.hass=s;let e=N(s);return xt(e)||He(e).then(()=>{r.requestUpdate?.()}),wt(s.locale,s.config?.country),!0}function Ot(r){return st(r).then(s=>s.rowActionStyle)}function Cr(){us()}function Dt(){let r=se(gs);return re(r)?(r.openCreate(),!0):!1}function Ir(r,s){let e=se(gs);return re(e)?(e.openEdit(r,s),!0):!1}function Mt(r="",s){let e=se(ms);if(!re(e))return!1;let t=rt();return t?((async()=>{let i=await st(t),n=e;n.checklistsEnabled=i.features.checklists,n.scheduleTimeEnabled=i.features.schedule_time,n.completionActionsEnabled=i.features.completion_actions,n.defaultWarningDays=i.defaultWarningDays,n.openCreate(r,s)})(),!0):!1}function Pr(r,s){let e=se(ms);if(!re(e))return!1;let t=rt();return t?((async()=>{try{let[i,n]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:r}),st(t)]),c=(i.tasks||[]).find(h=>h.id===s);if(!c){console.warn(`openEditTaskDialog: task ${s} not found in entry ${r}`);return}let d=e;d.checklistsEnabled=n.features.checklists,d.scheduleTimeEnabled=n.features.schedule_time,d.completionActionsEnabled=n.features.completion_actions,d.defaultWarningDays=n.defaultWarningDays,await d.openEdit(r,c)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function Lr(r){let s=se($r);return re(s)?(s.openEdit(r),!0):!1}function Rr(r){let s=se(kr);return re(s)?(De(s,r,rt()?.language||"en"),!0):!1}function qr(r){let s=se(Er);return re(s)?(s.openForTask(r.entry_id,r.task_id,r.object_name,r.task_name),!0):!1}function zt(r,s){let e=se(Sr);return re(e)?(e.openFor(r,s),!0):!1}function jr(r){let s=se(Ar);return re(s)?(s.openFor(r),!0):!1}var gs,ms,$r,kr,Er,Sr,Ar,J=w(()=>{"use strict";Mi();Vi();It();Wi();Yi();ls();ps();q();tt();_s();gs="maintenance-object-dialog",ms="maintenance-task-dialog",$r="maintenance-history-edit-dialog",kr="maintenance-complete-dialog",Er="maintenance-qr-dialog",Sr="maintenance-task-quick-actions-dialog",Ar="maintenance-object-quick-actions-dialog"});R();var Hs=["assignee_pool","required_completion_fields","checklist","labels","history"],Os=["checklist_progress"],Ds=["tasks","parts"],Ms=["manual_docs","battery_fleet_excluded"];function vt(r,s,e=[]){for(let t of s)r[t]===void 0&&(r[t]=[]);for(let t of e)r[t]===void 0&&(r[t]={})}function zs(r){let s=r;vt(s,Ds),s.object&&typeof s.object=="object"&&vt(s.object,Ms);for(let e of s.tasks)vt(e,Hs,Os);return r}function Re(r){for(let s of r)zs(s);return r}function Fs(r,s){if(s.objects)return s.objects;let e=s.delta||[],t=s.removed||[];if(!e.length&&!t.length)return null;let i=new Map(r.map(n=>[n.entry_id,n]));for(let n of e)i.set(n.entry_id,n);for(let n of t)i.delete(n);return[...i.values()]}function ci(r,s){return s.objects&&Re(s.objects),s.delta&&Re(s.delta),Fs(r,s)}M();q();kt();async function Js(r,s,e=300){return(await r.connection.sendMessagePromise({type:"auth/sign_path",path:s,expires:e})).path}async function Zs(r,s,e=300){return Js(r,`/api/maintenance_supporter/document/${s}`,e)}async function qi(r,s,e=""){let t=window.open("about:blank","_blank");try{let i=await Zs(r,s);t&&(t.location.href=new URL(i+e,window.location.origin).href)}catch(i){throw t&&t.close(),i}}Et();function Ze(r){let s=window;s.customCards=s.customCards||[],s.customCards.some(e=>e.type===r.type)||s.customCards.push(r)}St();Xe();tt();R();M();q();var tr=["overdue","triggered","due_soon","ok"],Q=class extends A{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._loadingObjects=!0;this._loadError=!1;this._views=[];this._objectsLoaded=!1;this._onEntitiesChanged=e=>{this._valueChanged("entity_ids",e.detail.value||[])}}get _lang(){return N(this.hass)}setConfig(e){this._config={...e}}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._objectsLoaded&&(this._objectsLoaded=!0,this._loadObjects())}async _loadObjects(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._objects=e.objects||[],this._loadError=!1}catch{this._objects=[],this._loadError=!0}this._loadingObjects=!1;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"});this._views=e.views||[]}catch{this._views=[]}}_valueChanged(e,t){let i={...this._config,[e]:t};(Array.isArray(t)&&t.length===0||t==="")&&delete i[e],this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}_toggleStatus(e,t){let i=new Set(this._config.filter_status||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_status",[...i])}_toggleObject(e,t){let i=new Set(this._config.filter_objects||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_objects",[...i])}_toggleLabel(e,t){let i=new Set(this._config.filter_labels||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_labels",[...i])}_toggleArea(e,t){let i=new Set(this._config.filter_areas||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_areas",[...i])}_togglePriority(e,t){let i=new Set(this._config.filter_priority||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_priority",[...i])}render(){let e=this._lang,t=new Set(this._config.filter_status||[]),i=new Set(this._config.filter_objects||[]),n=[...this._objects].map(m=>m.object.name).sort((m,$)=>m.localeCompare($)),c=new Set(this._config.filter_areas||[]),d=[...new Set(this._objects.map(m=>m.object.area_id).filter(m=>!!m).concat([...c]))],h=m=>this.hass?.areas?.[m]?.name||m,_=d.map(m=>({id:m,name:h(m)})).sort((m,$)=>m.name.localeCompare($.name)),f=new Set(this._config.filter_labels||[]),x=new Set(this._config.filter_priority||[]),v=[...new Set(this._objects.flatMap(m=>m.tasks.flatMap($=>$.labels||[])))].sort((m,$)=>m.localeCompare($)),b=[];for(let m of this._objects)for(let $ of m.tasks)$.sensor_entity_id&&b.push($.sensor_entity_id),$.binary_sensor_entity_id&&b.push($.binary_sensor_entity_id);return o`
      <div class="editor">
        <ha-textfield
