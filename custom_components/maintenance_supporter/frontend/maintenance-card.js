...
`;var D=class extends y{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"}}get _lang(){return this.hass?.language||"de"}setConfig(t){this._config={...t}}_valueChanged(t,n){let i={...this._config,[t]:n};this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}render(){let t=this._lang;return p`
      <div class="editor">
        <ha-textfield
                ...
                ${l.map(({entry_id:g,object_name:m,task:d})=>p`
                    <div class="task-item">
                      ...
                      <div class="task-info">
                        ...
                        ${s?c:p`<div class="task-meta">${m} · ${_(d.type,t)}</div>`}
                      </div>
                      <div class="task-due">
