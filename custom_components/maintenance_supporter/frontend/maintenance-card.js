...
`});function Ri(a,s,e){let t=new Blob([a],{type:e}),i=URL.createObjectURL(t),n=document.createElement("a");n.href=i,n.download=s,n.target="_blank",n.rel="noopener",n.style.display="none",document.body.appendChild(n),n.dispatchEvent(new MouseEvent("click")),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(i),6e4)}var kt=w(()=>{"use strict"});function Je(a){return!!a&&/^https?:\/\//i.test(a)}var Et=w(()=>{"use strict"});var ye,St=w(()=>{"use strict";ye=class{constructor(s){this.usersCache=null;this.cacheTimestamp=0;this.CACHE_TTL_MS=6e4;this.hass=s}updateHass(s){this.hass=s}async getUsers(s=!1){let e=Date.now();if(!s&&this.usersCache&&e-this.cacheTimestamp<this.CACHE_TTL_MS)return this.usersCache;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/users/list"});return this.usersCache=t.users,this.cacheTimestamp=e,this.usersCache}catch(t){return console.error("Failed to fetch users:",t),this.usersCache||[]}}async assignUser(s,e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/assign_user",entry_id:s,task_id:e,user_id:t})}async getTasksByUser(s){return(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tasks/by_user",user_id:s})).tasks}getUserName(s){return!s||!this.usersCache?null:this.usersCache.find(t=>t.id===s)?.name||null}getUser(s){return!s||!this.usersCache?null:this.usersCache.find(e=>e.id===s)||null}getCurrentUserId(){return this.hass.user?.id||null}isCurrentUser(s){return s?s===this.getCurrentUserId():!1}clearCache(){this.usersCache=null,this.cacheTimestamp=0}}});function Xs(a,s){if(s<=0)return 0;let e=typeof a=="number"&&Number.isFinite(a)?Math.trunc(a):0;return e<0?0:e%s}function er(a){return!!(a?.phases&&a.phase_sequence&&a.phase_sequence.length>0)}function At(a){if(!a||!er(a))return null;let s=a.phase_sequence,e=Xs(a.phase_cursor,s.length),t=s[e],i=a.phases?.[t];return i?{id:t,name:i.name,index:e,count:s.length,notes:i.notes,checklist:i.checklist!==void 0?i.checklist:a.checklist??[],consumesParts:i.consumes_parts!==void 0?i.consumes_parts:a.consumes_parts??[],requiredFields:i.required_completion_fields!==void 0?i.required_completion_fields:a.required_completion_fields??[]}:null}function ne(a){let s=At(a);return s?`${s.index+1}/${s.count} \xB7 ${s.name}`:""}var Xe=w(()=>{"use strict"});function G(a){return`${a.entry_id??""}\0${a.part_id}`}function ji(a,s,e,t){let i=!!a.entry_id&&a.entry_id!==s,n=i?a.entry_id:s,c=e.find(f=>f.entry_id===n),d=(c?.parts||[]).find(f=>f.id===a.part_id)||null,h=i&&c?.object?.name||"",_=d?.name||r("shared_part_unknown",t);return{part:d,foreign:i,ownerName:h,label:h?`${_} (${h})`:_}}function Ni(a,s,e,t){let{part:i,label:n}=ji(a,s,e,t),c=i&&i.stock!==null&&i.stock!==void 0?` (${i.stock}${i.unit?" "+i.unit:""})`:"",d=i?.storage_location?` \u2014 ${i.storage_location}`:"";return`${a.quantity}\xD7 ${n}${c}${d}`}function Hi(a,s,e,t){let n=(e.find(d=>d.entry_id===s)?.parts||[]).map(d=>({...d})),c=new Set(n.map(d=>G({part_id:d.id})));for(let d of a?.consumes_parts||[]){if(!d.entry_id||d.entry_id===s)continue;let h=G(d);if(c.has(h))continue;c.add(h);let{part:_,ownerName:f}=ji(d,s,e,t);n.push({id:d.part_id,name:_?.name||r("shared_part_unknown",t),unit:_?.unit,stock:_?.stock??null,storage_location:_?.storage_location,entry_id:d.entry_id,owner_name:f})}return n}var et=w(()=>{"use strict";q()});function Oe(a){let s=a.task??null,e=s?At(s):null,t=e?e.consumesParts:s?.consumes_parts||[],i=!!s?.part_ref,n=a.objects.find(h=>h.entry_id===a.entryId)?.parts||[],c=i?n.find(h=>h.id===s.part_ref.part_id):void 0,d=a.checklistsEnabled??!0;return{entry_id:a.entryId,task_id:a.taskId,task_name:a.taskName,checklist:e?d?e.checklist:[]:a.checklist??[],adaptive_enabled:!!a.adaptiveEnabled,required_completion_fields:e?e.requiredFields:s?.required_completion_fields||[],task_type:s?.type||"",reading_unit:s?.reading_unit||"",parts:i?[]:Hi({consumes_parts:t},a.entryId,a.objects,a.lang),consumes_parts:i?[]:t,phase_label:e?ne(s):"",require_tag_scan:!!s?.require_tag_scan,restock_default:i?c?.restock_quantity??1:null,restock_unit_cost:i?c?.cost??null:null,currency_symbol:a.currencySymbol??"",consumes_info:t.map(h=>Ni(h,a.entryId,a.objects,a.lang)),checklist_prefill:s?.checklist_progress||{},via_tag_scan:!!a.viaTagScan}}function De(a,s,e){a.entryId=s.entry_id,a.taskId=s.task_id,a.taskName=s.task_name,a.lang=e,a.checklist=s.checklist??[],a.adaptiveEnabled=!!s.adaptive_enabled,a.requiredFields=s.required_completion_fields??[],a.taskType=s.task_type??"",a.readingUnit=s.reading_unit??"",a.parts=s.parts??[],a.consumesParts=s.consumes_parts??[],a.phaseLabel=s.phase_label??"",a.requireTagScan=!!s.require_tag_scan,a.restockDefault=s.restock_default??null,a.restockUnitCost=s.restock_unit_cost??null,a.currencySymbol=s.currency_symbol??"",a.consumesInfo=s.consumes_info??[],a.checklistPrefill=s.checklist_prefill??{},a.viaTagScan=!!s.via_tag_scan,a.open({viaTagScan:!!s.via_tag_scan})}var tt=w(()=>{"use strict";et();Xe()});function sr(a,s){let e=ir[a];if(!e)return a;let t=r(e,s);return t&&t!==e?t:a}function rr(a){let e=a.match(/data\['([^']+)'\]/)?.[1],t;return(t=a.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=a.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=a.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=a.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(a)?{field:e,rule:"required"}:(t=a.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(a)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(a)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function C(a,s,e){if(e=e??r("action_error",s),typeof a=="string")return a;if(typeof a!="object"||a===null)return e;let t=a,i=t.message||t.error?.message||"";if(!i)return e;let n=rr(i),c=n.field?sr(n.field,s):"",d=h=>r(h,s).replace("{field}",c).replace("{n}",n.param??"");switch(n.rule){case"too_long":return d("err_too_long");case"too_short":return d("err_too_short");case"value_too_high":return d("err_value_too_high");case"value_too_low":return d("err_value_too_low");case"required":return d("err_required");case"wrong_type":return d("err_wrong_type").replace("{type}",n.param??"");case"invalid_choice":return d("err_invalid_choice");case"invalid_value":return d("err_invalid_value");default:return i||e}}var ir,oe=w(()=>{"use strict";q();ir={entry_id:"object",name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",warranty_expiry:"warranty_expiry_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_equals:"trigger_equals",trigger_not_equals:"trigger_not_equals",trigger_for_minutes:"trigger_for_minutes"}});var Tt,Me,Ct=w(()=>{"use strict";Tt=["notes","cost","duration","photo","user"],Me={notes:"notes_label",cost:"cost",duration:"duration",photo:"photo_label",user:"user_label"}});function ar(a,s){if(s)switch(a){case"date":return s.split("T")[0];case"time":return s.length===5?`${s}:00`:s;case"datetime":{let[e,t="00:00:00"]=s.split("T");return`${e} ${t.length===5?`${t}:00`:t}`}}}function nr(a,s){if(typeof s!="string"||!s)return"";switch(a){case"date":return s.slice(0,10);case"time":return s.slice(0,5);case"datetime":{let[e,t="00:00:00"]=s.split(" ");return`${e}T${t.length===5?`${t}:00`:t}`}}}var F,xe=w(()=>{"use strict";R();M();q();F=class extends A{constructor(){super(...arguments);this.kind="date";this.label="";this.value="";this.clearable=!1;this.disabled=!1;this.required=!1;this.lang="en"}_selector(){switch(this.kind){case"date":return{date:{}};case"time":return{time:{no_second:!0}};case"datetime":return{datetime:{}}}}_onSelectorChange(e){e.stopPropagation(),this._emit(nr(this.kind,e.detail?.value))}_clear(){this._emit("")}_emit(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{bubbles:!0,composed:!0,detail:{value:e}})))}render(){return o`
      <div class="field">
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="dialog-actions">
          ...
          <ha-button
            ...
            title=${this._missingRequired.length?this._missingRequired.map(t=>r("err_required",e).replace("{field}",r(Me[t]??t,e))).join(" \xB7 "):""}
          >
...
`).map(h=>h.trim()).filter(Boolean).slice(0,100);e.checklist=d.length?d:null}if(this.completionActionsEnabled){let d=this._actionService.trim();if(d&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(d)){let x={service:d},v=this._actionTargetEntity.trim();v&&(x.target={entity_id:v});let b=this._buildActionData();Object.keys(b).length>0&&(x.data=b),e.on_complete_action=x}else e.on_complete_action=null;let h={};this._qcNotes.trim()&&(h.notes=this._qcNotes.trim());let _=parseFloat(this._qcCost);!isNaN(_)&&_>=0&&(h.cost=_);let f=parseInt(this._qcDuration,10);!isNaN(f)&&f>=0&&(h.duration=f),this._qcFeedback&&(h.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(h).length?h:null}let i=await this.hass.connection.sendMessagePromise(e),n=this._taskId||i?.task_id,c=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(n&&this._scheduleType==="sensor_based"&&c)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(n&&this._adaptiveSnapshot()!==this._adaptiveInitial){let d=parseFloat(this._adaptiveAlpha),h=parseInt(this._adaptiveMin,10),_=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:n,enabled:this._adaptiveEnabled,...d>=.1&&d<=.9?{ewa_alpha:d}:{},...!isNaN(h)&&h>=1?{min_interval_days:h}:{},...!isNaN(_)&&_>=1?{max_interval_days:_}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=C(e,this._lang,r("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return p;let e=this._lang,t=this._triggerType==="compound";return o`
      ...
      <div class="select-row">
        ...
        >
          ${dr.map(i=>o`<option value=${i} ?selected=${i===this._triggerType}>${r(i,e)}</option>`)}
        </select>
      </div>
      ...
      ${this._intervalDays?o`
          ...
          `:p}
    `}_patchCondition(e,t){this._compoundConditions=this._compoundConditions.map((i,n)=>n===e?{...i,...t}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,pr()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((t,i)=>i!==e)}_renderCompoundEditor(){let e=this._lang;return o`
      <div class="select-row">
    ...
    `}_renderCondition(e,t){let i=this._lang,n=t+1;return o`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${Bi.map(c=>o`<option value=${c} ?selected=${c===e.type}>${r(c,i)}</option>`)}
          </select>
        </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${or.map(i=>o`<option value=${i} ?selected=${i===this._type}>${r(i,e)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${lr.map(i=>o`<option value=${i} ?selected=${i===this._priority}>${r("priority_"+i,e)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${cr.map(i=>o`<option value=${i} ?selected=${i===this._scheduleType}>${r(i,e)}</option>`)}
            </select>
          </div>
...
<script>setTimeout(()=>window.print(),300)<\/script>
      ...
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${r("chart_weibull",i)}">
        ${vs.map(V=>{let Y=136-V*128;return fe`
            ...
            <text x="${28}" y="${E(Y+3)}" fill="var(--secondary-text-color)"
              font-size="8" text-anchor="end">${H(V*100,i,0)}%</text>
          `})}
        ...
        ${e>0?fe`
          ...
          <text x="${E(S+4)}" y="${E(_e-6)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${fs}%</text>
        `:p}

        ${t>0&&t!==e?fe`
          <line x1="${E(Ft)}" y1="${8}" x2="${E(Ft)}" y2="${E(136)}"
    ...
    <div class="weibull-info-row">
      ...
      ${a.weibull_r_squared!=null?o`
        <div class="weibull-info-item">
          ...
          <span class="weibull-info-value">${H(a.weibull_r_squared,s,3)}</span>
        </div>
      `:p}
    </div>
  `}function xr(a,s,e){let t=a.confidence_interval_low,i=a.confidence_interval_high,n=s.suggested_interval??s.interval_days??0,c=s.interval_days??0,d=Math.max(0,t-5),_=i+5-d,f=(t-d)/_*100,x=(i-t)/_*100,v=(n-d)/_*100,b=c>0?(c-d)/_*100:-1;return o`
      ...
      <div class="prediction-grid">
        ${t?o`
          <div class="prediction-item">
            ...
            ${a.degradation_rate!=null?o`<span class="prediction-rate">${a.degradation_rate>0?"+":""}${H(a.degradation_rate,s,Math.abs(a.degradation_rate)>=10?0:1)} ${a.trigger_entity_info?.unit_of_measurement||""}/${r("day_short",s)}</span>`:p}
          </div>
        `:p}
        ${i?o`
          <div class="prediction-item">
            ...
            ${a.threshold_prediction_date?o`<span class="prediction-date">${W(a.threshold_prediction_date,s)}</span>`:p}
        ...
        ${n&&e.environmental?o`
          <div class="prediction-item">
            ...
            <span class="prediction-value">${H(a.environmental_factor,s,2)}x</span>
            ${a.environmental_entity?o`<span class="prediction-entity entity-link" @click=${d=>Pi(d,a.environmental_entity)}>${a.environmental_entity}</span>`:p}
          </div>
        `:p}
      </div>
    </div>
  `}var ts=w(()=>{"use strict";R();q()});function is(a,s,e,t){let i=Math.max(a||1,s);return o`
  ...
  `}function ns(a,s){return wr(a,s)}function wr(a,s){let e=a.seasonal_factors??a.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return p;let t=a.interval_analysis?.seasonal_reason,i=new Date().getMonth(),n=300,c=100,d=8,_=c-d-4,f=Math.max(...e,1.5),x=n/12,v=x*.65,b=d+_-1/f*_;return o`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${n} ${c}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${r("chart_seasonal",s)}">
        ...
        ${e.map((m,$)=>{let D=m/f*_,I=$*x+(x-v)/2,S=d+_-D,L=$===i,_e=m<1?"var(--success-color, #4caf50)":m>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return fe`
            <rect x="${E(I)}" y="${E(S)}"
      ...
      <div class="details">
        <div class="stats-grid">
          ...
          <div class="stat">
            ...
            <span class="stat-value">${H(c,t,2)}</span>
          </div>
          <div class="stat">
                ...
                ${[...i].reverse().slice(0,20).map(h=>{let _=["completed","reset","skipped"].includes(h.type);return o`
                    <div class="history-entry">
                      <div class="history-line">
                        ...
                        <span class="history-date">${Ti(h.timestamp,t)}</span>
                      ...
                      ${h.cost!=null||h.duration!=null?o`<div class="history-meta">
                            ${h.cost!=null?o`<span>💰 ${H(h.cost,t,2)}</span>`:p}
        ...
        ${t?o`
              <div class="header">
                ...
                <div class="quick-info">
                  ${t.next_due?o`<span><strong>${r("next_due",e)||"Next due"}:</strong> ${W(t.next_due,e)}</span>`:p}
                  ${t.last_performed?o`<span><strong>${r("last_performed",e)||"Last"}:</strong> ${W(t.last_performed,e)}</span>`:p}
                  ${t.schedule?.kind&&!["manual","one_time"].includes(t.schedule.kind)||t.interval_days!=null?o`<span><strong>${r("interval",e)||"Interval"}:</strong> ${Ii(t,e)}</span>`:p}
                  ${ne(t)?o`<span><strong>${r("phase_current",e)}:</strong> ${ne(t)}</span>`:p}
                </div>
              </div>
        ...
        ${t&&i?o`
              ...
              ${i.notes?o`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${cs(i.notes)}</div>
                    </div>
                  `:p}
      ...
      <div class="meta">
        ${i.map(([n,c])=>o`
            <div class="meta-item">
              ...
              <span class="meta-value">${Je(c)?o`<a href="${c}" target="_blank" rel="noopener noreferrer">${c}</a>`:c}</span>
            </div>
          `)}
      </div>
    `}};Z.styles=T`
  ...
  `,l([y({attribute:!1})],Z.prototype,"hass",2),l([u()],Z.prototype,"_open",2),l([u()],Z.prototype,"_entryId",2),l([u()],Z.prototype,"_data",2),l([u()],Z.prototype,"_busy",2),l([u()],Z.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",Z)});function hs(){let a=window;return a.__msSettingsCache??={promise:null}}function st(a){let s=hs();if(s.promise)return s.promise;let e=a.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(t=>({features:t.features??Ht.features,defaultWarningDays:t.general?.default_warning_days??7,rowActionStyle:t.general?.row_action_style??Ht.rowActionStyle})).catch(()=>(s.promise===e&&(s.promise=null),Ht));return s.promise=e,e}function us(){hs().promise=null}var Ht,_s=w(()=>{"use strict";Ht={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"}});var ie={};$s(ie,{__resetSettingsCacheForTests:()=>Cr,getRowActionStyle:()=>Ot,openCompleteDialog:()=>Rr,openCreateObjectDialog:()=>Dt,openCreateTaskDialog:()=>Mt,openEditObjectDialog:()=>Ir,openEditTaskDialog:()=>Pr,openHistoryEditDialog:()=>Lr,openObjectQuickActions:()=>jr,openQrDialog:()=>qr,openTaskQuickActions:()=>zt});function rt(){return document.querySelector("home-assistant")?.hass}function Tr(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function se(a){let s=Tr(),e=s.querySelector(a)??document.body.querySelector(a);return e?e.parentNode!==s&&s.appendChild(e):(e=document.createElement(a),s.appendChild(e)),e}function re(a){let s=rt();if(!s)return!1;a.hass=s;let e=N(s);return xt(e)||He(e).then(()=>{a.requestUpdate?.()}),wt(s.locale,s.config?.country),!0}function Ot(a){return st(a).then(s=>s.rowActionStyle)}function Cr(){us()}function Dt(){let a=se(gs);return re(a)?(a.openCreate(),!0):!1}function Ir(a,s){let e=se(gs);return re(e)?(e.openEdit(a,s),!0):!1}function Mt(a="",s){let e=se(ms);if(!re(e))return!1;let t=rt();return t?((async()=>{let i=await st(t),n=e;n.checklistsEnabled=i.features.checklists,n.scheduleTimeEnabled=i.features.schedule_time,n.completionActionsEnabled=i.features.completion_actions,n.defaultWarningDays=i.defaultWarningDays,n.openCreate(a,s)})(),!0):!1}function Pr(a,s){let e=se(ms);if(!re(e))return!1;let t=rt();return t?((async()=>{try{let[i,n]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:a}),st(t)]),c=(i.tasks||[]).find(h=>h.id===s);if(!c){console.warn(`openEditTaskDialog: task ${s} not found in entry ${a}`);return}let d=e;d.checklistsEnabled=n.features.checklists,d.scheduleTimeEnabled=n.features.schedule_time,d.completionActionsEnabled=n.features.completion_actions,d.defaultWarningDays=n.defaultWarningDays,await d.openEdit(a,c)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function Lr(a){let s=se($r);return re(s)?(s.openEdit(a),!0):!1}function Rr(a){let s=se(kr);return re(s)?(De(s,a,rt()?.language||"en"),!0):!1}function qr(a){let s=se(Er);return re(s)?(s.openForTask(a.entry_id,a.task_id,a.object_name,a.task_name),!0):!1}function zt(a,s){let e=se(Sr);return re(e)?(e.openFor(a,s),!0):!1}function jr(a){let s=se(Ar);return re(s)?(s.openFor(a),!0):!1}var gs,ms,$r,kr,Er,Sr,Ar,J=w(()=>{"use strict";Mi();Vi();It();Wi();Yi();ls();ps();q();tt();_s();gs="maintenance-object-dialog",ms="maintenance-task-dialog",$r="maintenance-history-edit-dialog",kr="maintenance-complete-dialog",Er="maintenance-qr-dialog",Sr="maintenance-task-quick-actions-dialog",Ar="maintenance-object-quick-actions-dialog"});R();var Hs=["assignee_pool","required_completion_fields","checklist","labels","history"],Os=["checklist_progress"],Ds=["tasks","parts"],Ms=["manual_docs","battery_fleet_excluded"];function vt(a,s,e=[]){for(let t of s)a[t]===void 0&&(a[t]=[]);for(let t of e)a[t]===void 0&&(a[t]={})}function zs(a){let s=a;vt(s,Ds),s.object&&typeof s.object=="object"&&vt(s.object,Ms);for(let e of s.tasks)vt(e,Hs,Os);return a}function Re(a){for(let s of a)zs(s);return a}function Fs(a,s){if(s.objects)return s.objects;let e=s.delta||[],t=s.removed||[];if(!e.length&&!t.length)return null;let i=new Map(a.map(n=>[n.entry_id,n]));for(let n of e)i.set(n.entry_id,n);for(let n of t)i.delete(n);return[...i.values()]}function ci(a,s){return s.objects&&Re(s.objects),s.delta&&Re(s.delta),Fs(a,s)}M();q();kt();async function Js(a,s,e=300){return(await a.connection.sendMessagePromise({type:"auth/sign_path",path:s,expires:e})).path}async function Zs(a,s,e=300){return Js(a,`/api/maintenance_supporter/document/${s}`,e)}async function qi(a,s,e=""){let t=window.open("about:blank","_blank");try{let i=await Zs(a,s);t&&(t.location.href=new URL(i+e,window.location.origin).href)}catch(i){throw t&&t.close(),i}}Et();function Ze(a){let s=window;s.customCards=s.customCards||[],s.customCards.some(e=>e.type===a.type)||s.customCards.push(a)}St();Xe();tt();R();M();q();var tr=["overdue","triggered","due_soon","ok"],Q=class extends A{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._loadingObjects=!0;this._loadError=!1;this._views=[];this._objectsLoaded=!1;this._onEntitiesChanged=e=>{this._valueChanged("entity_ids",e.detail.value||[])}}get _lang(){return N(this.hass)}setConfig(e){this._config={...e}}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._objectsLoaded&&(this._objectsLoaded=!0,this._loadObjects())}async _loadObjects(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._objects=e.objects||[],this._loadError=!1}catch{this._objects=[],this._loadError=!0}this._loadingObjects=!1;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"});this._views=e.views||[]}catch{this._views=[]}}_valueChanged(e,t){let i={...this._config,[e]:t};(Array.isArray(t)&&t.length===0||t==="")&&delete i[e],this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}_toggleStatus(e,t){let i=new Set(this._config.filter_status||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_status",[...i])}_toggleObject(e,t){let i=new Set(this._config.filter_objects||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_objects",[...i])}_toggleLabel(e,t){let i=new Set(this._config.filter_labels||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_labels",[...i])}_toggleArea(e,t){let i=new Set(this._config.filter_areas||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_areas",[...i])}_togglePriority(e,t){let i=new Set(this._config.filter_priority||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_priority",[...i])}render(){let e=this._lang,t=new Set(this._config.filter_status||[]),i=new Set(this._config.filter_objects||[]),n=[...this._objects].map(m=>m.object.name).sort((m,$)=>m.localeCompare($)),c=new Set(this._config.filter_areas||[]),d=[...new Set(this._objects.map(m=>m.object.area_id).filter(m=>!!m).concat([...c]))],h=m=>this.hass?.areas?.[m]?.name||m,_=d.map(m=>({id:m,name:h(m)})).sort((m,$)=>m.name.localeCompare($.name)),f=new Set(this._config.filter_labels||[]),x=new Set(this._config.filter_priority||[]),v=[...new Set(this._objects.flatMap(m=>m.tasks.flatMap($=>$.labels||[])))].sort((m,$)=>m.localeCompare($)),b=[];for(let m of this._objects)for(let $ of m.tasks)$.sensor_entity_id&&b.push($.sensor_entity_id),$.binary_sensor_entity_id&&b.push($.binary_sensor_entity_id);return o`
      <div class="editor">
        <ha-textfield
  ...
  `,l([y({attribute:!1})],Q.prototype,"hass",2),l([u()],Q.prototype,"_config",2),l([u()],Q.prototype,"_objects",2),l([u()],Q.prototype,"_loadingObjects",2),l([u()],Q.prototype,"_loadError",2),l([u()],Q.prototype,"_views",2);customElements.get("maintenance-supporter-card-editor")||customElements.define("maintenance-supporter-card-editor",Q);It();R();M();R();M();q();var Pt={overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view",objectsCache:"msp-objects-cache",gettingStartedDismissed:"msp-gs-dismissed",batteryRosterSort:"ms_bf_roster_sort"};function Oi(a){try{return localStorage.getItem(a)}catch{return null}}function Di(a,s){try{localStorage.setItem(a,s)}catch{}}oe();it();var z=class z extends A{constructor(){super(...arguments);this.flat=!1;this._ov=null;this._loading=!1;this._marking=!1;this._error="";this._history=null;this._rosterSort=z._storedSort();this._typeFilter=null;this._recorded=[];this._historyRequested=!1;this._localeReady=!1;this._markAll=async()=>{await this._mark(void 0)};this._repair=async()=>{if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/setup",language:this._lang}),await this._load()}catch(e){this._error=C(e,this._lang)}finally{this._marking=!1}}};this._loadHistory=async e=>{if(!(!e.target.open||this._historyRequested)){this._historyRequested=!0;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview_history"});this._history=t.series}catch{this._history=null}}}}get _lang(){return N(this.hass)}connectedCallback(){super.connectedCallback(),this.hass&&this._load()}updated(e){Ge(this,e),e.has("hass")&&this.hass&&!this._localeReady&&(this._localeReady=!0,He(this._lang).then(()=>this.requestUpdate()),this._ov===null&&!this._loading&&this._load())}async _load(){this._loading=!0,this._error="";try{this._ov=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview"})}catch(e){this._error=C(e,this._lang)}finally{this._loading=!1}}async _mark(e){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/mark_replaced",...e?{entity_ids:e}:{}}),await this._load()}catch(t){this._error=C(t,this._lang)}finally{this._marking=!1}}}async _setExcluded(e,t){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/set_excluded",entity_id:e,excluded:t}),await this._load()}catch(i){this._error=C(i,this._lang)}finally{this._marking=!1}}}async _addBattery(e){let t=e.detail?.value;if(!(!t||this._marking)){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/set_included",entity_id:t,included:!0}),await this._load()}catch(i){this._error=C(i,this._lang)}finally{this._marking=!1}}}async _setTrackSelf(e){await this._setFleetOption("set_track_self_charging",e.target.checked)}async _setDueWithoutSensor(e){await this._setFleetOption("set_due_without_sensor",e.target.checked)}async _setFleetOption(e,t){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:`maintenance_supporter/battery_fleet/${e}`,enabled:t}),await this._load()}catch(i){this._error=C(i,this._lang)}finally{this._marking=!1}}}_sparkline(e){let t=this._history?.[e.entity_id];if(!t||t.points.length<2)return p;let i=110,n=24,c=2,d=t.points[0][0],h=t.points[t.points.length-1][0],_=Date.now()/1e3,f=e.status!=="low"&&e.predicted_source==="trend"&&e.days_until!=null?_+e.days_until*86400:null,x=Math.max(h,f??h),v=I=>x===d?c:c+(I-d)/(x-d)*(i-2*c),b=I=>c+(1-Math.min(100,Math.max(0,I))/100)*(n-2*c),m=t.points.map(([I,S])=>`${E(v(I))},${E(b(S))}`).join(" "),$=t.points[t.points.length-1][1],D=E(b(t.threshold));return o`<svg
    ...
    >
      ...
      ${f!==null?o`<line
            ...
            y2=${D}
          ></line>`:p}
    </svg>`}static _storedSort(){return Oi(Pt.batteryRosterSort)==="name"?"name":"urgency"}_setSort(e){this._rosterSort=e,Di(Pt.batteryRosterSort,e)}_sortedRoster(e){let t=this._typeFilter===null?e:e.filter(n=>n.battery_type===this._typeFilter);if(this._rosterSort==="name")return t;let i=n=>n.status==="low"?-1e3+(n.level??101)/101:n.days_until??1/0;return[...t].sort((n,c)=>i(n)-i(c)||n.device_name.localeCompare(c.device_name))}_predictedDate(e){return this._fmtDate(Date.now()+e*864e5)}_fmtDate(e){let t=new Date(e),i=n=>String(n).padStart(2,"0");return W(`${t.getFullYear()}-${i(t.getMonth()+1)}-${i(t.getDate())}`,this._lang)}_shoppingLine(e){return Object.entries(e).map(([t,i])=>o`<button
              ...
              <div class="bf-rows">
                ${t.low.map(n=>o`
                    <div class="bf-row">
                      ...
                      ${n.available===!1?o`<span class="bf-offline">${r("battery_fleet_offline",e)}</span>`:n.no_sensor?o`<span class="bf-offline bf-nosensor">${r("battery_fleet_no_sensor",e)}</span>`:p}
                ...
                <div class="bf-rows">
                  ${this._sortedRoster(t.all).map(n=>o`
                      <div class="bf-row">
                        ...
                        >
                        <span class="bf-type">${n.quantity}× ${n.battery_type}</span>
                        ${n.no_sensor?o`<span class="bf-offline bf-nosensor">${r("battery_fleet_no_sensor",e)}</span>`:p}
                        ${n.rechargeable?o`<span class="bf-recharge" title=${r("battery_fleet_rechargeable",e)}
                              ><ha-icon icon="mdi:battery-charging-outline"></ha-icon
                            ></span>`:p}
                        ${this._sparkline(n)}
                    ...
                    <div class="task-item clickable"
                      ...
                      <div class="task-info">
                        ...
                        ${d?this._assigneeName(v)?o`<div class="task-meta compact-assignee" title="${this._assigneeName(v)}">
                              ...
                              ${x} · ${r(v.type,e)}${ne(v)?o` · ${ne(v)}`:p}${this._assigneeName(v)?o` · <span class="assignee"
