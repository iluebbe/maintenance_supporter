...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,l([v({attribute:!1})],R.prototype,"hass",2),l([v()],R.prototype,"lang",2),l([p()],R.prototype,"_open",2),l([p()],R.prototype,"_loading",2),l([p()],R.prototype,"_error",2),l([p()],R.prototype,"_viewResult",2),l([p()],R.prototype,"_completeResult",2),l([p()],R.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",R)});function Qt(a,s){let e=a.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return h;let n=a.interval_days??0,d=a.suggested_interval??n;return o`
    <div class="weibull-section">
      ...
      ${as(t,i,n,d,s)}
      ${ns(e,s)}
      ${e?.confidence_interval_low!=null?os(e,a,s):h}
    </div>
  `}function rs(a,s){let e,t,i;return a<.8?(e="early_failures",t="M13,14H11V10H13M13,18H11V16H13M1,21H23L12,2L1,21Z",i="beta_early_failures"):a<=1.2?(e="random_failures",t="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M13,17H11V15H13V17M13,13H11V7H13V13Z",i="beta_random_failures"):a<=3.5?(e="wear_out",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M12,6A6,6 0 0,1 18,12H12V6Z",i="beta_wear_out"):(e="highly_predictable",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M11,16.5L18,9.5L16.59,8.09L11,13.67L7.91,10.59L6.5,12L11,16.5Z",i="beta_highly_predictable"),o`
    <span class="beta-badge ${e}">
      <ha-svg-icon path="${t}"></ha-svg-icon>
      ${r(i,s)} (\u03B2=${a.toFixed(2)})
    </span>
  `}function as(a,s,e,t,i){let b=Math.max(e,t,s,1)*1.3,E=50,w=[];for(let j=0;j<=E;j++){let z=j/E*b,vi=1-Math.exp(-Math.pow(z/s,a)),bi=32+z/b*260,yi=136-vi*128;w.push([bi,yi])}let P=w.map(([j,z])=>`${j.toFixed(1)},${z.toFixed(1)}`).join(" "),Ne="M32,136 "+w.map(([j,z])=>`L${j.toFixed(1)},${z.toFixed(1)}`).join(" ")+` L${w[E][0].toFixed(1)},136 Z`,ie=32+e/b*260,ve=1-Math.exp(-Math.pow(e/s,a)),be=136-ve*128,mi=((1-ve)*100).toFixed(0),rt=32+t/b*260,fi=[0,.25,.5,.75,1];return o`
  ...
  `}function os(a,s,e){let t=a.confidence_interval_low,i=a.confidence_interval_high,n=s.suggested_interval??s.interval_days??0,d=s.interval_days??0,c=Math.max(0,t-5),u=i+5-c,f=(t-c)/u*100,m=(i-t)/u*100,y=(n-c)/u*100,b=d>0?(d-c)/u*100:-1;return o`
  ...
  `}function ni(a,s){return ls(a,s)}function ls(a,s){let e=a.seasonal_factors??a.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return h;let t=a.interval_analysis?.seasonal_reason,i=new Date().getMonth(),n=300,d=100,c=8,u=d-c-4,f=Math.max(...e,1.5),m=n/12,y=m*.65,b=c+u-1/f*u;return o`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${n} ${d}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${r("chart_seasonal",s)}">
        ...
        ${e.map((E,w)=>{let P=E/f*u,Ne=w*m+(m-y)/2,ie=c+u-P,ve=w===i,be=E<1?"var(--success-color, #4caf50)":E>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return ae`
  ...
  `}var ri,oi=x(()=>{"use strict";C();I();ri=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var T,li=x(()=>{"use strict";C();N();I();te();Xt();ti();si();oi();T=class extends k{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(i=>i.id===this._taskId);this._task=t??null}catch(e){this._error=L(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=L(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(O(),V)).then(({openCompleteDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(O(),V)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(O(),V)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=r("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=r("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${r("reanalyze_result",this._lang)||"Recomputed"}: ${e.recommended_interval}d (${e.data_points} pts)`:r("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=L(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){!this._entryId||!this._taskId||Promise.resolve().then(()=>(O(),V)).then(({openHistoryEditDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null})})}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return h;let t=this._lang;return o`
    ...
    `}_renderDetails(e){let t=this._lang,i=e.history||[],n=i.filter(_=>_.type==="completed"),d=n.reduce((_,u)=>_+(typeof u.cost=="number"?u.cost:0),0),c=(()=>{let _=n.map(u=>typeof u.duration=="number"?u.duration:null).filter(u=>u!=null);return _.length?Math.round(_.reduce((u,f)=>u+f,0)/_.length):null})();return o`
      <div class="details">
        ...
        ${i.length===0?o`<div class="history-empty">${r("history_empty",t)||"No history yet."}</div>`:o`
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(_=>{let u=["completed","reset","skipped"].includes(_.type);return o`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${_.type}">${r(_.type,t)}</span>
                        <span class="history-date">${qt(_.timestamp,t)}</span>
                      ...
                      ${_.notes?o`<div class="history-notes">${_.notes}</div>`:h}
                      ${_.cost!=null||_.duration!=null?o`<div class="history-meta">
                            ${_.cost!=null?o`<span>💰 ${_.cost.toFixed(2)}</span>`:h}
                            ${_.duration!=null?o`<span>⏱️ ${_.duration}m</span>`:h}
                          </div>`:h}
                    </div>
                  `})}
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?o`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&Promise.resolve().then(()=>(O(),V)).then(({openObjectQuickActions:n})=>{n(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
  ...
  `,l([v({attribute:!1})],q.prototype,"hass",2),l([p()],q.prototype,"_open",2),l([p()],q.prototype,"_entryId",2),l([p()],q.prototype,"_data",2),l([p()],q.prototype,"_busy",2),l([p()],q.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",q)});var V={};$i(V,{openCompleteDialog:()=>fs,openCreateObjectDialog:()=>tt,openCreateTaskDialog:()=>it,openEditObjectDialog:()=>us,openEditTaskDialog:()=>gs,openHistoryEditDialog:()=>ms,openObjectQuickActions:()=>bs,openQrDialog:()=>vs,openTaskQuickActions:()=>st});function je(){return document.querySelector("home-assistant")?.hass}function B(a){let s=document.body.querySelector(a);return s||(s=document.createElement(a),document.body.appendChild(s)),s}function W(a){let s=je();if(!s)return!1;a.hass=s;let e=s.language||"en";return Ie(e)||Le(e).then(()=>{a.requestUpdate?.()}),!0}function gi(a){return Re||(Re=a.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(s=>({features:s.features??hi.features,defaultWarningDays:s.general?.default_warning_days??7})).catch(()=>hi),Re)}function tt(){let a=B(_i);return W(a)?(a.openCreate(),!0):!1}function us(a,s){let e=B(_i);return W(e)?(e.openEdit(a,s),!0):!1}function it(){let a=B(ui);if(!W(a))return!1;let s=je();return s?((async()=>{let e=await gi(s),t=a;t.checklistsEnabled=e.features.checklists,t.scheduleTimeEnabled=e.features.schedule_time,t.completionActionsEnabled=e.features.completion_actions,t.defaultWarningDays=e.defaultWarningDays,t.openCreate()})(),!0):!1}function gs(a,s){let e=B(ui);if(!W(e))return!1;let t=je();return t?((async()=>{try{let[i,n]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:a}),gi(t)]),d=(i.tasks||[]).find(_=>_.id===s);if(!d){console.warn(`openEditTaskDialog: task ${s} not found in entry ${a}`);return}let c=e;c.checklistsEnabled=n.features.checklists,c.scheduleTimeEnabled=n.features.schedule_time,c.completionActionsEnabled=n.features.completion_actions,c.defaultWarningDays=n.defaultWarningDays,await c.openEdit(a,d)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function ms(a){let s=B(cs);return W(s)?(s.openEdit(a),!0):!1}function fs(a){let s=B(ds);return W(s)?(s.entryId=a.entry_id,s.taskId=a.task_id,s.taskName=a.task_name,s.checklist=a.checklist??[],s.adaptiveEnabled=!!a.adaptive_enabled,s.lang=je()?.language||"en",s.open(),!0):!1}function vs(a){let s=B(ps);return W(s)?(s.openForTask(a.entry_id,a.task_id,a.object_name,a.task_name),!0):!1}function st(a,s){let e=B(hs);return W(e)?(e.openFor(a,s),!0):!1}function bs(a){let s=B(_s);return W(s)?(s.openFor(a),!0):!1}var _i,ui,cs,ds,ps,hs,_s,hi,Re,O=x(()=>{"use strict";Vt();Yt();Xe();Kt();Zt();li();pi();I();_i="maintenance-object-dialog",ui="maintenance-task-dialog",cs="maintenance-history-edit-dialog",ds="maintenance-complete-dialog",ps="maintenance-qr-dialog",hs="maintenance-task-quick-actions-dialog",_s="maintenance-object-quick-actions-dialog";hi={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},Re=null});C();N();I();C();N();I();var Di=["overdue","triggered","due_soon","ok"],M=class extends k{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._loadingObjects=!0;this._loadError=!1;this._views=[];this._objectsLoaded=!1;this._onEntitiesChanged=e=>{this._valueChanged("entity_ids",e.detail.value||[])}}get _lang(){return this.hass?.language||"en"}setConfig(e){this._config={...e}}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._objectsLoaded&&(this._objectsLoaded=!0,this._loadObjects())}async _loadObjects(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._objects=e.objects||[],this._loadError=!1}catch{this._objects=[],this._loadError=!0}this._loadingObjects=!1;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"});this._views=e.views||[]}catch{this._views=[]}}_valueChanged(e,t){let i={...this._config,[e]:t};(Array.isArray(t)&&t.length===0||t==="")&&delete i[e],this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}_toggleStatus(e,t){let i=new Set(this._config.filter_status||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_status",[...i])}_toggleObject(e,t){let i=new Set(this._config.filter_objects||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_objects",[...i])}render(){let e=this._lang,t=new Set(this._config.filter_status||[]),i=new Set(this._config.filter_objects||[]),n=[...this._objects].map(c=>c.object.name).sort((c,_)=>c.localeCompare(_)),d=[];for(let c of this._objects)for(let _ of c.tasks)_.sensor_entity_id&&d.push(_.sensor_entity_id),_.binary_sensor_entity_id&&d.push(_.binary_sensor_entity_id);return o`
      <div class="editor">
        <ha-textfield
          ...
          <div class="chip-row">
            ${Di.map(c=>o`
              <label class="chip ${t.has(c)?"active":""}">
                <input type="checkbox"
                  .checked=${t.has(c)}
                  @change=${_=>this._toggleStatus(c,_.target.checked)} />
                ${r(c,e)}
              </label>
            `)}
          </div>
                ...
                <div class="object-list">
                  ${n.map(c=>o`
                    <label class="object-row">
                      <input type="checkbox"
                        .checked=${i.has(c)}
                        @change=${_=>this._toggleObject(c,_.target.checked)} />
                      <span>${c}</span>
                    </label>
                  `)}
                </div>
      ...
      <ha-card>
        ...
        ${c.length===0?this._objects.some(u=>u.tasks.length>0)?o`<div class="empty-card">
              ...
              <div class="task-list ${d?"compact":""}">
                ${c.map(({entry_id:u,object_name:f,task:m})=>o`
                    <div class="task-item clickable"
                      ...
                      ${n?o`
                            <mwc-icon-button
                              class="complete-btn"
                              title="${r("complete",e)}"
                              @click=${y=>{y.stopPropagation();let b=this.shadowRoot.querySelector("maintenance-complete-dialog");b.entryId=u,b.taskId=m.id,b.taskName=m.name,b.checklist=m.checklist||[],b.adaptiveEnabled=!!m.adaptive_config?.enabled,b.taskType=m.type||"",b.readingUnit=m.reading_unit||"",b.lang=e;let E=this._objects.find(P=>P.entry_id===u),w=!!m.part_ref;b.parts=w?[]:E?.parts||[],b.consumesParts=w?[]:m.consumes_parts||[],b.open()}}
                            >
                              <ha-icon icon="mdi:check"></ha-icon>
                            </mwc-icon-button>
                          `:h}
