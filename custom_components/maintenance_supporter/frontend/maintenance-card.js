...
`;var N=class extends y{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"}}get _lang(){return this.hass?.language||"de"}setConfig(t){this._config={...t}}_valueChanged(t,n){let i={...this._config,[t]:n};this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}render(){let t=this._lang;return p`
      <div class="editor">
        <ha-textfield
        ...
        <ha-formfield label="${_("card_show_header",t)}">
          <ha-switch
            ...
            @change=${n=>this._valueChanged("show_header",n.target.checked)}
          ></ha-switch>
        </ha-formfield>
        ...
        <ha-formfield label="${_("card_show_actions",t)}">
          <ha-switch
            ...
            @change=${n=>this._valueChanged("show_actions",n.target.checked)}
          ></ha-switch>
        </ha-formfield>
        ...
        <ha-formfield label="${_("card_compact",t)}">
          <ha-switch
            ...
            @change=${n=>this._valueChanged("compact",n.target.checked)}
          ></ha-switch>
        </ha-formfield>
        ...
        <ha-textfield
          ...
          @input=${n=>this._valueChanged("max_items",parseInt(n.target.value,10)||0)}
        ></ha-textfield>
      </div>
    `}};N.styles=k`
    .editor {
  ...
  `,u([v({attribute:!1})],N.prototype,"hass",2),u([b()],N.prototype,"_config",2),N=u([J("maintenance-supporter-card-editor")],N);var h=class extends y{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="de";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed"}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed")}_toggleCheck(t){let n=String(t);this._checklistState={...this._checklistState,[n]:!this._checklistState[n]}}_setFeedback(t){this._feedback=t}async _complete(){this._loading=!0,this._error="";try{let t={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(t.notes=this._notes),this._cost){let n=parseFloat(this._cost);!isNaN(n)&&n>=0&&(t.cost=n)}if(this._duration){let n=parseInt(this._duration,10);!isNaN(n)&&n>=0&&(t.duration=n)}this.checklist.length>0&&(t.checklist_state=this._checklistState),this.adaptiveEnabled&&(t.feedback=this._feedback),await this.hass.connection.sendMessagePromise(t),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch{this._error=_("save_error",this.lang)}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return p``;let t=this.lang||this.hass?.language||"de";return p`
      <ha-dialog
        open
        @closed=${this._close}
        .heading=${_("complete_title",t)+this.taskName}
      >
        <div class="content">
          ...
          <ha-textfield
            ...
            step="0.01"
            .value=${this._cost}
            @input=${n=>this._cost=n.target.value}
          ></ha-textfield>
          <ha-textfield
            label="${_("duration_minutes",t)}"
            type="number"
            .value=${this._duration}
            @input=${n=>this._duration=n.target.value}
          ></ha-textfield>
  ...
  `,u([v({attribute:!1})],h.prototype,"hass",2),u([v()],h.prototype,"entryId",2),u([v()],h.prototype,"taskId",2),u([v()],h.prototype,"taskName",2),u([v()],h.prototype,"lang",2),u([v({type:Array})],h.prototype,"checklist",2),u([v({type:Boolean})],h.prototype,"adaptiveEnabled",2),u([b()],h.prototype,"_open",2),u([b()],h.prototype,"_notes",2),u([b()],h.prototype,"_cost",2),u([b()],h.prototype,"_duration",2),u([b()],h.prototype,"_loading",2),u([b()],h.prototype,"_error",2),u([b()],h.prototype,"_checklistState",2),u([b()],h.prototype,"_feedback",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",h);var x=class extends y{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._stats=null;this._unsub=null;this._dataLoaded=!1;this._lastConnection=null;this._onCompleted=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"de"}static getConfigElement(){return document.createElement("maintenance-supporter-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-card",show_header:!0,show_actions:!0}}setConfig(t){this._config=t}getCardSize(){return 3}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null}updated(t){if(super.updated(t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,n]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=n}catch{}}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(t=>{let n=t;this._objects=n.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _flatTasks(){let t=[],{filter_status:n,filter_objects:i,max_items:o}=this._config;for(let l of this._objects)if(!(i?.length&&!i.includes(l.object.name)))for(let s of l.tasks)n?.length&&!n.includes(s.status)||t.push({entry_id:l.entry_id,object_name:l.object.name,task:s});let r={overdue:0,triggered:1,due_soon:2,ok:3};return t.sort((l,s)=>(r[l.task.status]??9)-(r[s.task.status]??9)),o&&o>0?t.slice(0,o):t}render(){let t=this._lang,n=this._config.title||_("maintenance",t),i=this._config.show_header!==!1,o=this._config.show_actions!==!1,r=this._config.compact||!1,l=this._flatTasks,s=this._stats;return p`
      <ha-card>
