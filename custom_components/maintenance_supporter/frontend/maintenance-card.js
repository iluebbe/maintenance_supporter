...
`});function ji(o,s){let e=Ri[o];if(!e)return o;let t=r(e,s);return t&&t!==e?t:o}function Pi(o){let e=o.match(/data\['([^']+)'\]/)?.[1],t;return(t=o.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=o.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=o.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=o.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(o)?{field:e,rule:"required"}:(t=o.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(o)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(o)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function I(o,s,e){if(e=e??r("action_error",s),typeof o=="string")return o;if(typeof o!="object"||o===null)return e;let t=o,i=t.message||t.error?.message||"";if(!i)return e;let a=Pi(i),d=a.field?ji(a.field,s):"",p=c=>r(c,s).replace("{field}",d).replace("{n}",a.param??"");switch(a.rule){case"too_long":return p("err_too_long");case"too_short":return p("err_too_short");case"value_too_high":return p("err_value_too_high");case"value_too_low":return p("err_value_too_low");case"required":return p("err_required");case"wrong_type":return p("err_wrong_type").replace("{type}",a.param??"");case"invalid_choice":return p("err_invalid_choice");case"invalid_value":return p("err_invalid_value");default:return i||e}}var Ri,Q=y(()=>{"use strict";C();Ri={name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",warranty_expiry:"warranty_expiry_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_for_minutes:"trigger_for_minutes"}});var E,Ze=y(()=>{"use strict";T();j();C();Q();E=class extends ${constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed";this._photoDocId="";this._photoPreview="";this._photoUploading=!1}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed",this._photoDocId="",this._photoPreview="",this._photoUploading=!1)}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _onPhotoInput(e){let t=e.target,i=t.files?.[0];if(t.value="",!!i){this._photoUploading=!0,this._error="";try{let a=new FormData;a.append("entry_id",this.entryId),a.append("tags","photo"),a.append("file",i,i.name);let d=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:a});if(!d.ok){this._error=d.status===413?r("doc_too_large",this.lang):r("doc_upload_failed",this.lang);return}let p=await d.json();p.id&&(this._photoDocId=p.id,this._photoPreview=URL.createObjectURL(i))}catch{this._error=r("doc_upload_failed",this.lang)}finally{this._photoUploading=!1}}}_removePhoto(){this._photoPreview&&URL.revokeObjectURL(this._photoPreview),this._photoDocId="",this._photoPreview=""}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),this._photoDocId&&(e.photo_doc_id=this._photoDocId),await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=I(e,this.lang,r("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return n``;let e=this.lang||this.hass?.language||"en";return n`
  ...
  `,l([v({attribute:!1})],E.prototype,"hass",2),l([v()],E.prototype,"entryId",2),l([v()],E.prototype,"taskId",2),l([v()],E.prototype,"taskName",2),l([v()],E.prototype,"lang",2),l([v({type:Array})],E.prototype,"checklist",2),l([v({type:Boolean})],E.prototype,"adaptiveEnabled",2),l([h()],E.prototype,"_open",2),l([h()],E.prototype,"_notes",2),l([h()],E.prototype,"_cost",2),l([h()],E.prototype,"_duration",2),l([h()],E.prototype,"_loading",2),l([h()],E.prototype,"_error",2),l([h()],E.prototype,"_checklistState",2),l([h()],E.prototype,"_feedback",2),l([h()],E.prototype,"_photoDocId",2),l([h()],E.prototype,"_photoPreview",2),l([h()],E.prototype,"_photoUploading",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",E)});var L,Qe=y(()=>{"use strict";T();j();L=class extends ${constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return n`
      <label class="field">
...
`),this._scheduleTime=t.schedule_time||"";let a=t.on_complete_action;if(a&&a.service){this._actionService=a.service;let c=a.target?.entity_id;this._actionTargetEntity=Array.isArray(c)?c[0]||"":c||"",this._actionData=a.data&&typeof a.data=="object"?{...a.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let d=t.quick_complete_defaults;this._qcNotes=d?.notes||"",this._qcCost=d?.cost!=null?String(d.cost):"",this._qcDuration=d?.duration!=null?String(d.duration):"",this._qcFeedback=d?.feedback||"";let p=t.adaptive_config||{};if(this._environmentalEntity=p.environmental_entity||"",this._environmentalAttribute=p.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,t.trigger_config){let c=t.trigger_config;this._triggerEntityId=c.entity_id||"",this._triggerEntityIds=c.entity_ids||(c.entity_id?[c.entity_id]:[]),this._triggerEntityLogic=c.entity_logic||"any",this._triggerAttribute=c.attribute||"",this._triggerType=c.type||"threshold",this._triggerAbove=c.trigger_above?.toString()||"",this._triggerBelow=c.trigger_below?.toString()||"",this._triggerForMinutes=c.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=c.trigger_target_value?.toString()||"",this._triggerDeltaMode=c.trigger_delta_mode||!1,this._autoCompleteOnRecovery=c.auto_complete_on_recovery||!1,this._triggerFromState=c.trigger_from_state||"",this._triggerToState=c.trigger_to_state||"",this._triggerTargetChanges=c.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=c.trigger_runtime_hours?.toString()||"",c.type==="compound"?(this._compoundLogic=c.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(c.conditions||[]).map(Oi)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new Ie(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}_toggleAssignee(e){this._assigneePool=this._assigneePool.includes(e)?this._assigneePool.filter(t=>t!==e):[...this._assigneePool,e]}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[t,i]=e.split(".");if(!this.hass?.services?.[t]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let a=this._actionTargetEntity.trim();if(a){let d=a.split(".")[0];if(d!==t&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(t)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${t}.* entities; entity "${a}" is in ${d}.* \u2014 pick a service that matches the entity domain (e.g. ${d}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[a]){this._actionTestResult="error",this._actionTestError=`Target entity "${a}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,i]=e.split("."),a=this.hass?.services?.[t]?.[i]?.fields;return!a||Object.keys(a).length===0?null:Object.entries(a).map(([d,p])=>({name:d,required:!!p.required,selector:p.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return _;let t=this._serviceSchema();return n`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${i=>{this._actionService=i.detail.value||"";let a=this._serviceSchema();if(a){let d=new Set(a.map(p=>p.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([p])=>d.has(p)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
...
`).map(c=>c.trim()).filter(Boolean).slice(0,100);e.checklist=p.length?p:null}if(this.completionActionsEnabled){let p=this._actionService.trim();if(p&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(p)){let m={service:p},x=this._actionTargetEntity.trim();x&&(m.target={entity_id:x});let f=this._buildActionData();Object.keys(f).length>0&&(m.data=f),e.on_complete_action=m}else e.on_complete_action=null;let c={};this._qcNotes.trim()&&(c.notes=this._qcNotes.trim());let u=parseFloat(this._qcCost);!isNaN(u)&&u>=0&&(c.cost=u);let b=parseInt(this._qcDuration,10);!isNaN(b)&&b>=0&&(c.duration=b),this._qcFeedback&&(c.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(c).length?c:null}let i=await this.hass.connection.sendMessagePromise(e),a=this._taskId||i?.task_id,d=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(a&&this._scheduleType==="sensor_based"&&d)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=I(e,this._lang,r("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return _;let e=this._lang,t=this._triggerType==="compound";return n`
      ...
      <div class="select-row">
        ...
        >
          ${Di.map(i=>n`<option value=${i} ?selected=${i===this._triggerType}>${r(i,e)}</option>`)}
        </select>
      </div>
    ...
    `}_patchCondition(e,t){this._compoundConditions=this._compoundConditions.map((i,a)=>a===e?{...i,...t}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Ui()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((t,i)=>i!==e)}_renderCompoundEditor(){let e=this._lang;return n`
      <div class="select-row">
    ...
    `}_renderCondition(e,t){let i=this._lang,a=t+1;return n`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${Dt.map(d=>n`<option value=${d} ?selected=${d===e.type}>${r(d,i)}</option>`)}
          </select>
        </div>
      ...
      <div class="select-row">
        ...
        <div class="weekday-chips">
          ${t.map((i,a)=>n`
            ...
            >${i}</button>`)}
        </div>`;if(this._scheduleType==="nth_weekday"){let i=[["1",r("ord_1",e)],["2",r("ord_2",e)],["3",r("ord_3",e)],["4",r("ord_4",e)],["5",r("ord_5",e)],["-1",r("ord_last",e)]];return n`
        <div class="select-row">
          <label>${r("recurrence_occurrence",e)}</label>
          <select .value=${this._nth} @change=${a=>this._nth=a.target.value}>
            ${i.map(([a,d])=>n`<option value=${a} ?selected=${a===this._nth}>${d}</option>`)}
          </select>
        </div>
        <div class="select-row">
          <label>${r("recurrence_weekday",e)}</label>
          <select .value=${this._nthWeekday} @change=${a=>this._nthWeekday=a.target.value}>
            ${t.map((a,d)=>n`<option value=${String(d)} ?selected=${String(d)===this._nthWeekday}>${a}</option>`)}
          </select>
        ...
        ></ms-textfield>`:_}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?n`
        <ms-textfield
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${zi.map(i=>n`<option value=${i} ?selected=${i===this._type}>${r(i,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${Ni.map(i=>n`<option value=${i} ?selected=${i===this._priority}>${r("priority_"+i,e)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${Mi.map(i=>n`<option value=${i} ?selected=${i===this._scheduleType}>${r(i,e)}</option>`)}
            </select>
          </div>
  ...
  `,l([v({attribute:!1})],g.prototype,"hass",2),l([v({type:Boolean,attribute:"checklists-enabled"})],g.prototype,"checklistsEnabled",2),l([v({type:Boolean,attribute:"schedule-time-enabled"})],g.prototype,"scheduleTimeEnabled",2),l([v({type:Boolean,attribute:"completion-actions-enabled"})],g.prototype,"completionActionsEnabled",2),l([v({type:Number,attribute:"default-warning-days"})],g.prototype,"defaultWarningDays",2),l([h()],g.prototype,"_open",2),l([h()],g.prototype,"_loading",2),l([h()],g.prototype,"_error",2),l([h()],g.prototype,"_entryId",2),l([h()],g.prototype,"_taskId",2),l([h()],g.prototype,"_objectChoices",2),l([h()],g.prototype,"_name",2),l([h()],g.prototype,"_type",2),l([h()],g.prototype,"_scheduleType",2),l([h()],g.prototype,"_intervalDays",2),l([h()],g.prototype,"_intervalUnit",2),l([h()],g.prototype,"_dueDate",2),l([h()],g.prototype,"_warningDays",2),l([h()],g.prototype,"_earliestCompletionDays",2),l([h()],g.prototype,"_intervalAnchor",2),l([h()],g.prototype,"_weekdays",2),l([h()],g.prototype,"_nth",2),l([h()],g.prototype,"_nthWeekday",2),l([h()],g.prototype,"_domDay",2),l([h()],g.prototype,"_notes",2),l([h()],g.prototype,"_documentationUrl",2),l([h()],g.prototype,"_customIcon",2),l([h()],g.prototype,"_priority",2),l([h()],g.prototype,"_labels",2),l([h()],g.prototype,"_enabled",2),l([h()],g.prototype,"_triggerEntityId",2),l([h()],g.prototype,"_triggerEntityIds",2),l([h()],g.prototype,"_triggerEntityLogic",2),l([h()],g.prototype,"_triggerAttribute",2),l([h()],g.prototype,"_triggerType",2),l([h()],g.prototype,"_triggerAbove",2),l([h()],g.prototype,"_triggerBelow",2),l([h()],g.prototype,"_triggerForMinutes",2),l([h()],g.prototype,"_triggerTargetValue",2),l([h()],g.prototype,"_triggerDeltaMode",2),l([h()],g.prototype,"_autoCompleteOnRecovery",2),l([h()],g.prototype,"_triggerFromState",2),l([h()],g.prototype,"_triggerToState",2),l([h()],g.prototype,"_triggerTargetChanges",2),l([h()],g.prototype,"_triggerRuntimeHours",2),l([h()],g.prototype,"_compoundLogic",2),l([h()],g.prototype,"_compoundConditions",2),l([h()],g.prototype,"_suggestedAttributes",2),l([h()],g.prototype,"_availableAttributes",2),l([h()],g.prototype,"_entityDomain",2),l([h()],g.prototype,"_lastPerformed",2),l([h()],g.prototype,"_nfcTagId",2),l([h()],g.prototype,"_availableTags",2),l([h()],g.prototype,"_responsibleUserId",2),l([h()],g.prototype,"_assigneePool",2),l([h()],g.prototype,"_rotationStrategy",2),l([h()],g.prototype,"_availableUsers",2),l([h()],g.prototype,"_checklistText",2),l([h()],g.prototype,"_scheduleTime",2),l([h()],g.prototype,"_actionService",2),l([h()],g.prototype,"_actionTargetEntity",2),l([h()],g.prototype,"_actionData",2),l([h()],g.prototype,"_actionDataJsonFallback",2),l([h()],g.prototype,"_actionTesting",2),l([h()],g.prototype,"_actionTestResult",2),l([h()],g.prototype,"_actionTestError",2),l([h()],g.prototype,"_qcNotes",2),l([h()],g.prototype,"_qcCost",2),l([h()],g.prototype,"_qcDuration",2),l([h()],g.prototype,"_qcFeedback",2),l([h()],g.prototype,"_environmentalEntity",2),l([h()],g.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",g)});var U,Ot=y(()=>{"use strict";T();j();C();Q();U=class extends ${constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null}get _lang(){return this.hass?.language||"en"}openEdit(e){this._draft={...e},this._originalSnapshot={...e},this._error="",this._open=!0}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null}_set(e,t){this._draft&&(this._draft={...this._draft,[e]:t})}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{let e={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(e.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(e.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(e.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(e.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(e.completed_by=this._draft.completed_by),Object.keys(e).filter(i=>!["type","entry_id","task_id","original_timestamp"].includes(i)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(e),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=I(e,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return _;let e=this._lang,t=this._draft;return n`
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),a.document.close()}_downloadSvg(e,t){let i=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),a=new Blob([i],{type:"image/svg+xml"}),d=URL.createObjectURL(a),p=document.createElement("a");p.href=d;let c=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;p.download=`qr-${Vi(c)}-${t}.svg`,p.click(),URL.revokeObjectURL(d)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return n``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${r("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${r("qr_code",e)}: ${this._objectName}`,i=!!this._viewResult;return n`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
  ...
  `,l([v({attribute:!1})],H.prototype,"hass",2),l([v()],H.prototype,"lang",2),l([h()],H.prototype,"_open",2),l([h()],H.prototype,"_loading",2),l([h()],H.prototype,"_error",2),l([h()],H.prototype,"_viewResult",2),l([h()],H.prototype,"_completeResult",2),l([h()],H.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",H)});function Vt(o,s){let e=o.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return _;let a=o.interval_days??0,d=o.suggested_interval??a;return n`
    <div class="weibull-section">
      ...
      ${Gi(t,i,a,d,s)}
      ${Ki(e,s)}
      ${e?.confidence_interval_low!=null?Yi(e,o,s):_}
    </div>
  `}function Bi(o,s){let e,t,i;return o<.8?(e="early_failures",t="M13,14H11V10H13M13,18H11V16H13M1,21H23L12,2L1,21Z",i="beta_early_failures"):o<=1.2?(e="random_failures",t="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M13,17H11V15H13V17M13,13H11V7H13V13Z",i="beta_random_failures"):o<=3.5?(e="wear_out",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M12,6A6,6 0 0,1 18,12H12V6Z",i="beta_wear_out"):(e="highly_predictable",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M11,16.5L18,9.5L16.59,8.09L11,13.67L7.91,10.59L6.5,12L11,16.5Z",i="beta_highly_predictable"),n`
    <span class="beta-badge ${e}">
      <ha-svg-icon path="${t}"></ha-svg-icon>
      ${r(i,s)} (\u03B2=${o.toFixed(2)})
    </span>
  `}function Gi(o,s,e,t,i){let f=Math.max(e,t,s,1)*1.3,w=50,M=[];for(let R=0;R<=w;R++){let P=R/w*f,ci=1-Math.exp(-Math.pow(P/s,o)),di=32+P/f*260,pi=136-ci*128;M.push([di,pi])}let me=M.map(([R,P])=>`${R.toFixed(1)},${P.toFixed(1)}`).join(" "),Re="M32,136 "+M.map(([R,P])=>`L${R.toFixed(1)},${P.toFixed(1)}`).join(" ")+` L${M[w][0].toFixed(1)},136 Z`,X=32+e/f*260,fe=1-Math.exp(-Math.pow(e/s,o)),ve=136-fe*128,ni=((1-fe)*100).toFixed(0),it=32+t/f*260,li=[0,.25,.5,.75,1];return n`
  ...
  `}function Ki(o,s){return n`
    <div class="weibull-info-row">
      <div class="weibull-info-item">
        <span>${r("characteristic_life",s)}</span>
        <span class="weibull-info-value">${Math.round(o.weibull_eta)} ${r("days",s)}</span>
      </div>
  ...
  `}function Yi(o,s,e){let t=o.confidence_interval_low,i=o.confidence_interval_high,a=s.suggested_interval??s.interval_days??0,d=s.interval_days??0,p=Math.max(0,t-5),u=i+5-p,b=(t-p)/u*100,m=(i-t)/u*100,x=(a-p)/u*100,f=d>0?(d-p)/u*100:-1;return n`
      ...
      <div class="prediction-grid">
        ${t?n`
          <div class="prediction-item">
            ...
            <span class="prediction-value ${o.degradation_trend}">${r("trend_"+o.degradation_trend,s)}</span>
            ${o.degradation_rate!=null?n`<span class="prediction-rate">${o.degradation_rate>0?"+":""}${Math.abs(o.degradation_rate)>=10?Math.round(o.degradation_rate).toLocaleString():o.degradation_rate.toFixed(1)} ${o.trigger_entity_info?.unit_of_measurement||""}/${r("day_short",s)}</span>`:_}
          </div>
        `:_}
        ${i?n`
          <div class="prediction-item">
            ...
            <span class="prediction-value prediction-days${o.days_until_threshold===0?" exceeded":o.sensor_prediction_urgency?" urgent":""}">${o.days_until_threshold===0?r("threshold_exceeded",s):"~"+Math.round(o.days_until_threshold)+" "+r("days",s)}</span>
            ${o.threshold_prediction_date?n`<span class="prediction-date">${Z(o.threshold_prediction_date,s)}</span>`:_}
            ${o.threshold_prediction_confidence?n`<span class="confidence-dot ${o.threshold_prediction_confidence}"></span>`:_}
          </div>
        `:_}
        ${a&&e.environmental?n`
          <div class="prediction-item">
            ...
            ${o.environmental_entity?n`<span class="prediction-entity entity-link" @click=${p=>Nt(p,o.environmental_entity)}>${o.environmental_entity}</span>`:_}
          </div>
        `:_}
      </div>
    </div>
  `}var Kt=y(()=>{"use strict";T();C()});function Yt(o,s,e,t){let i=Math.max(o||1,s);return n`
    <div class="interval-comparison">
      <div class="interval-bar">
        <div class="interval-label">
          ${r("current",t)}: ${o??"\u2014"} ${o!=null?r("days",t):""}
        </div>
  ...
  `}var Jt=y(()=>{"use strict";T();C()});function Qt(o,s,e){if(!e.seasonal||!o.seasonal_factor||o.seasonal_factor===1)return _;let t=Zt.map(p=>r(p,s)),i=new Date().getMonth(),a=o.seasonal_factors||o.interval_analysis?.seasonal_factors||null,d=a&&a.length===12?a:t.map((p,c)=>{let u=o.seasonal_factor||1,b=Math.sin((c-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,u+b))});return n`
    <div class="seasonal-card-compact">
      <h4>${r("seasonal_awareness",s)}</h4>
      <div class="seasonal-mini-chart">
        ${d.map((p,c)=>{let u=p*40,b=p<.9?"low":p>1.1?"high":"normal";return n`
  ...
  `}function Xt(o,s){return Ji(o,s)}function Ji(o,s){let e=o.seasonal_factors??o.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return _;let t=o.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,d=100,p=8,u=d-p-4,b=Math.max(...e,1.5),m=a/12,x=m*.65,f=p+u-1/b*u;return n`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${a} ${d}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${r("chart_seasonal",s)}">
        <line x1="0" y1="${f.toFixed(1)}" x2="${a}" y2="${f.toFixed(1)}"
          stroke="var(--divider-color)" stroke-width="1" stroke-dasharray="4,3" />
        ${e.map((w,M)=>{let me=w/b*u,Re=M*m+(m-x)/2,X=p+u-me,fe=M===i,ve=w<1?"var(--success-color, #4caf50)":w>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return ie`
  ...
  `}var Zt,ei=y(()=>{"use strict";T();C();Zt=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var A,ti=y(()=>{"use strict";T();j();C();Q();Bt();Kt();Jt();ei();A=class extends ${constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(i=>i.id===this._taskId);this._task=t??null}catch(e){this._error=I(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=I(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(z(),O)).then(({openCompleteDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(z(),O)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(z(),O)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=r("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=r("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${r("reanalyze_result",this._lang)||"Recomputed"}: ${e.recommended_interval}d (${e.data_points} pts)`:r("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=I(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){!this._entryId||!this._taskId||Promise.resolve().then(()=>(z(),O)).then(({openHistoryEditDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null})})}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return _;let t=this._lang;return n`
    ...
    `}_renderAdaptive(e){let t=this._lang,i=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,a=e.degradation_trend!=null&&e.degradation_trend!=="insufficient_data"||e.days_until_threshold!=null||e.environmental_factor!=null&&e.environmental_factor!==1,d=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,p=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1;return!i&&!a&&!d&&!p?n`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${a?Gt(e,t,this._features):_}
        ${d?Vt(e,t):_}
        ${p?n`
          ${Qt(e,t,this._features)}
          ${e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12?Xt(e,t):_}
        `:_}
      </div>
    `}_renderDetails(e){let t=this._lang,i=e.history||[],a=i.filter(c=>c.type==="completed"),d=a.reduce((c,u)=>c+(typeof u.cost=="number"?u.cost:0),0),p=(()=>{let c=a.map(u=>typeof u.duration=="number"?u.duration:null).filter(u=>u!=null);return c.length?Math.round(c.reduce((u,b)=>u+b,0)/c.length):null})();return n`
      <div class="details">
        ...
        ${i.length===0?n`<div class="history-empty">${r("history_empty",t)||"No history yet."}</div>`:n`
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(c=>{let u=["completed","reset","skipped"].includes(c.type);return n`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${c.type}">${r(c.type,t)}</span>
                        <span class="history-date">${Pt(c.timestamp,t)}</span>
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?n`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&Promise.resolve().then(()=>(z(),O)).then(({openObjectQuickActions:a})=>{a(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${t.next_due?n`<span><strong>${r("next_due",e)||"Next due"}:</strong> ${Z(t.next_due,e)}</span>`:_}
                  ${t.last_performed?n`<span><strong>${r("last_performed",e)||"Last"}:</strong> ${Z(t.last_performed,e)}</span>`:_}
                  ${t.schedule?.kind&&!["manual","one_time"].includes(t.schedule.kind)||t.interval_days!=null?n`<span><strong>${r("interval",e)||"Interval"}:</strong> ${zt(t,e)}</span>`:_}
                </div>
              </div>
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${t&&i?n`
              ...
              <div class="tasks-section">
                ...
                ${a.length===0?n`<div class="empty">${r("no_tasks",e)||"No tasks yet."}</div>`:n`
                      <div class="task-list">
                        ${a.map(p=>n`
  ...
  `,l([v({attribute:!1})],N.prototype,"hass",2),l([h()],N.prototype,"_open",2),l([h()],N.prototype,"_entryId",2),l([h()],N.prototype,"_data",2),l([h()],N.prototype,"_busy",2),l([h()],N.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",N)});var O={};_i(O,{openCompleteDialog:()=>os,openCreateObjectDialog:()=>Xe,openCreateTaskDialog:()=>et,openEditObjectDialog:()=>is,openEditTaskDialog:()=>ss,openHistoryEditDialog:()=>rs,openObjectQuickActions:()=>ns,openQrDialog:()=>as,openTaskQuickActions:()=>tt});function He(){return document.querySelector("home-assistant")?.hass}function F(o){let s=document.body.querySelector(o);return s||(s=document.createElement(o),document.body.appendChild(s)),s}function W(o){let s=He();if(!s)return!1;o.hass=s;let e=s.language||"en";return Se(e)||Te(e).then(()=>{o.requestUpdate?.()}),!0}function ai(o){return Le||(Le=o.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(s=>({features:s.features??si.features,defaultWarningDays:s.general?.default_warning_days??7})).catch(()=>si),Le)}function Xe(){let o=F(ri);return W(o)?(o.openCreate(),!0):!1}function is(o,s){let e=F(ri);return W(e)?(e.openEdit(o,s),!0):!1}function et(){let o=F(oi);if(!W(o))return!1;let s=He();return s?((async()=>{let e=await ai(s),t=o;t.checklistsEnabled=e.features.checklists,t.scheduleTimeEnabled=e.features.schedule_time,t.completionActionsEnabled=e.features.completion_actions,t.defaultWarningDays=e.defaultWarningDays,t.openCreate()})(),!0):!1}function ss(o,s){let e=F(oi);if(!W(e))return!1;let t=He();return t?((async()=>{try{let[i,a]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:o}),ai(t)]),d=(i.tasks||[]).find(c=>c.id===s);if(!d){console.warn(`openEditTaskDialog: task ${s} not found in entry ${o}`);return}let p=e;p.checklistsEnabled=a.features.checklists,p.scheduleTimeEnabled=a.features.schedule_time,p.completionActionsEnabled=a.features.completion_actions,p.defaultWarningDays=a.defaultWarningDays,await p.openEdit(o,d)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function rs(o){let s=F(Zi);return W(s)?(s.openEdit(o),!0):!1}function os(o){let s=F(Qi);return W(s)?(s.entryId=o.entry_id,s.taskId=o.task_id,s.taskName=o.task_name,s.checklist=o.checklist??[],s.adaptiveEnabled=!!o.adaptive_enabled,s.lang=He()?.language||"en",s.open(),!0):!1}function as(o){let s=F(Xi);return W(s)?(s.openForTask(o.entry_id,o.task_id,o.object_name,o.task_name),!0):!1}function tt(o,s){let e=F(es);return W(e)?(e.openFor(o,s),!0):!1}function ns(o){let s=F(ts);return W(s)?(s.openFor(o),!0):!1}var ri,oi,Zi,Qi,Xi,es,ts,si,Le,z=y(()=>{"use strict";Mt();Ut();Ze();Ot();Wt();ti();ii();C();ri="maintenance-object-dialog",oi="maintenance-task-dialog",Zi="maintenance-history-edit-dialog",Qi="maintenance-complete-dialog",Xi="maintenance-qr-dialog",es="maintenance-task-quick-actions-dialog",ts="maintenance-object-quick-actions-dialog";si={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},Le=null});T();j();C();T();j();C();var Hi=["overdue","triggered","due_soon","ok"],D=class extends ${constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._loadingObjects=!0;this._loadError=!1;this._objectsLoaded=!1;this._onEntitiesChanged=e=>{this._valueChanged("entity_ids",e.detail.value||[])}}get _lang(){return this.hass?.language||"en"}setConfig(e){this._config={...e}}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._objectsLoaded&&(this._objectsLoaded=!0,this._loadObjects())}async _loadObjects(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._objects=e.objects||[],this._loadError=!1}catch{this._objects=[],this._loadError=!0}this._loadingObjects=!1}_valueChanged(e,t){let i={...this._config,[e]:t};Array.isArray(t)&&t.length===0&&delete i[e],this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}_toggleStatus(e,t){let i=new Set(this._config.filter_status||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_status",[...i])}_toggleObject(e,t){let i=new Set(this._config.filter_objects||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_objects",[...i])}render(){let e=this._lang,t=new Set(this._config.filter_status||[]),i=new Set(this._config.filter_objects||[]),a=[...this._objects].map(p=>p.object.name).sort((p,c)=>p.localeCompare(c)),d=[];for(let p of this._objects)for(let c of p.tasks)c.sensor_entity_id&&d.push(c.sensor_entity_id),c.binary_sensor_entity_id&&d.push(c.binary_sensor_entity_id);return n`
      <div class="editor">
        <ha-textfield
        ...
        <div class="field">
          ...
          ${this._loadingObjects?n`<div class="field-help">${r("card_loading_objects",e)}</div>`:this._loadError?n`<div class="field-help error-text">${r("card_load_error",e)}</div>`:a.length===0?n`<div class="field-help">${r("no_objects",e)}</div>`:n`
      ...
      <ha-card>
        ...
        ${p.length===0?n`<div class="empty-card">
              ...
              <div class="task-list ${d?"compact":""}">
                ${p.map(({entry_id:u,object_name:b,task:m})=>n`
                    <div class="task-item clickable"
                      ...
                      ${a?n`
                            <mwc-icon-button
                              class="complete-btn"
                              title="${r("complete",e)}"
                              @click=${x=>{x.stopPropagation();let f=this.shadowRoot.querySelector("maintenance-complete-dialog");f.entryId=u,f.taskId=m.id,f.taskName=m.name,f.checklist=m.checklist||[],f.adaptiveEnabled=!!m.adaptive_config?.enabled,f.lang=e,f.open()}}
                            >
                              <ha-icon icon="mdi:check"></ha-icon>
                            </mwc-icon-button>
                          `:_}
