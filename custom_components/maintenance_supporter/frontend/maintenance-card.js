                    ...
                    <div class="task-item">
                      ...
                      ${i?m`
                            <mwc-icon-button
                              class="complete-btn"
                              title="${_("complete",t)}"
                              @click=${()=>{let v=this.shadowRoot.querySelector("maintenance-complete-dialog");v.entryId=p,v.taskId=d.id,v.taskName=d.name,v.checklist=d.checklist||[],v.adaptiveEnabled=!!d.adaptive_config?.enabled,v.lang=t,v.open()}}
                            >
