...
`});function Ta(i,a){let e=Na[i];if(!e)return i;let t=o(e,a);return t&&t!==e?t:i}function Ca(i){let e=i.match(/data\['([^']+)'\]/)?.[1],t;return(t=i.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=i.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=i.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=i.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(i)?{field:e,rule:"required"}:(t=i.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(i)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(i)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function q(i,a,e){if(typeof i=="string")return i;if(typeof i!="object"||i===null)return e;let t=i,n=t.message||t.error?.message||"";if(!n)return e;let r=Ca(n),d=r.field?Ta(r.field,a):"",s=_=>o(_,a).replace("{field}",d).replace("{n}",r.param??"");switch(r.rule){case"too_long":return s("err_too_long");case"too_short":return s("err_too_short");case"value_too_high":return s("err_value_too_high");case"value_too_low":return s("err_value_too_low");case"required":return s("err_required");case"wrong_type":return s("err_wrong_type").replace("{type}",r.param??"");case"invalid_choice":return s("err_invalid_choice");case"invalid_value":return s("err_invalid_value");default:return n||e}}var Na,J=y(()=>{"use strict";S();Na={name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_for_minutes:"trigger_for_minutes"}});var A,Ve=y(()=>{"use strict";j();I();S();J();A=class extends x{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed"}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed")}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=q(e,this.lang,o("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return c``;let e=this.lang||this.hass?.language||"en";return c`
  ...
  `,l([v({attribute:!1})],A.prototype,"hass",2),l([v()],A.prototype,"entryId",2),l([v()],A.prototype,"taskId",2),l([v()],A.prototype,"taskName",2),l([v()],A.prototype,"lang",2),l([v({type:Array})],A.prototype,"checklist",2),l([v({type:Boolean})],A.prototype,"adaptiveEnabled",2),l([u()],A.prototype,"_open",2),l([u()],A.prototype,"_notes",2),l([u()],A.prototype,"_cost",2),l([u()],A.prototype,"_duration",2),l([u()],A.prototype,"_loading",2),l([u()],A.prototype,"_error",2),l([u()],A.prototype,"_checklistState",2),l([u()],A.prototype,"_feedback",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",A)});var N,Be=y(()=>{"use strict";j();I();N=class extends x{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return c`
      <label class="field">
        ...
        />
        ${this.helper?c`<span class="helper">${this.helper}</span>`:p}
      </label>
    `}};N.styles=z`
    :host { display: block; }
    .field {
...
`),this._scheduleTime=t.schedule_time||"";let n=t.on_complete_action;if(n&&n.service){this._actionService=n.service;let s=n.target?.entity_id;this._actionTargetEntity=Array.isArray(s)?s[0]||"":s||"",this._actionData=n.data&&typeof n.data=="object"?{...n.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let r=t.quick_complete_defaults;this._qcNotes=r?.notes||"",this._qcCost=r?.cost!=null?String(r.cost):"",this._qcDuration=r?.duration!=null?String(r.duration):"",this._qcFeedback=r?.feedback||"";let d=t.adaptive_config||{};if(this._environmentalEntity=d.environmental_entity||"",this._environmentalAttribute=d.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,t.trigger_config){let s=t.trigger_config;this._triggerEntityId=s.entity_id||"",this._triggerEntityIds=s.entity_ids||(s.entity_id?[s.entity_id]:[]),this._triggerEntityLogic=s.entity_logic||"any",this._triggerAttribute=s.attribute||"",this._triggerType=s.type||"threshold",this._triggerAbove=s.trigger_above?.toString()||"",this._triggerBelow=s.trigger_below?.toString()||"",this._triggerForMinutes=s.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=s.trigger_target_value?.toString()||"",this._triggerDeltaMode=s.trigger_delta_mode||!1,this._triggerFromState=s.trigger_from_state||"",this._triggerToState=s.trigger_to_state||"",this._triggerTargetChanges=s.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=s.trigger_runtime_hours?.toString()||""}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._warningDays=String(this.defaultWarningDays),this._intervalAnchor="completion",this._notes="",this._documentationUrl="",this._customIcon="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._responsibleUserId=null,this._checklistText="",this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours=""}async _loadUsers(){this._userService||(this._userService=new Ae(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[t,n]=e.split(".");if(!this.hass?.services?.[t]?.[n]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let r=this._actionTargetEntity.trim();if(r){let d=r.split(".")[0];if(d!==t&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(t)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${t}.* entities; entity "${r}" is in ${d}.* \u2014 pick a service that matches the entity domain (e.g. ${d}.${n})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[r]){this._actionTestResult="error",this._actionTestError=`Target entity "${r}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,n]=e.split("."),r=this.hass?.services?.[t]?.[n]?.fields;return!r||Object.keys(r).length===0?null:Object.entries(r).map(([d,s])=>({name:d,required:!!s.required,selector:s.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return p;let t=this._serviceSchema();return c`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${n=>{this._actionService=n.detail.value||"";let r=this._serviceSchema();if(r){let d=new Set(r.map(s=>s.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([s])=>d.has(s)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
        ...
        <div class="ca-test-row">
          ...
          ${this._actionTestResult==="error"?c`<div class="ca-test-error-block">
                <span class="ca-test-error">${o("on_complete_action_test_failed",e)}</span>
                ${this._actionTestError?c`<div class="ca-test-error-detail">${this._actionTestError}</div>`:p}
              </div>`:p}
        </div>
      </details>
...
`).map(s=>s.trim()).filter(Boolean).slice(0,100);e.checklist=d.length?d:null}if(this.completionActionsEnabled){let d=this._actionService.trim();if(d&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(d)){let b={service:d},h=this._actionTargetEntity.trim();h&&(b.target={entity_id:h});let k=this._buildActionData();Object.keys(k).length>0&&(b.data=k),e.on_complete_action=b}else e.on_complete_action=null;let s={};this._qcNotes.trim()&&(s.notes=this._qcNotes.trim());let _=parseFloat(this._qcCost);!isNaN(_)&&_>=0&&(s.cost=_);let m=parseInt(this._qcDuration,10);!isNaN(m)&&m>=0&&(s.duration=m),this._qcFeedback&&(s.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(s).length?s:null}let t=await this.hass.connection.sendMessagePromise(e),n=this._taskId||t?.task_id,r=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(n&&this._scheduleType==="sensor_based"&&r)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=q(e,this._lang,o("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return p;let e=this._lang;return c`
      ...
      <div class="select-row">
        ...
        >
          ${Da.map(t=>c`<option value=${t} ?selected=${t===this._triggerType}>${o(t,e)}</option>`)}
        </select>
      </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Ia.map(n=>c`<option value=${n} ?selected=${n===this._type}>${o(n,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${Ra.map(n=>c`<option value=${n} ?selected=${n===this._scheduleType}>${o(n,e)}</option>`)}
            </select>
          </div>
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),r.document.close()}_downloadSvg(e,t){let n=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),r=new Blob([n],{type:"image/svg+xml"}),d=URL.createObjectURL(r),s=document.createElement("a");s.href=d;let _=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;s.download=`qr-${Pa(_)}-${t}.svg`,s.click(),URL.revokeObjectURL(d)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return c``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${o("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${o("qr_code",e)}: ${this._objectName}`,n=!!this._viewResult;return c`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
  ...
  `,l([v({attribute:!1})],T.prototype,"hass",2),l([v()],T.prototype,"lang",2),l([u()],T.prototype,"_open",2),l([u()],T.prototype,"_loading",2),l([u()],T.prototype,"_error",2),l([u()],T.prototype,"_viewResult",2),l([u()],T.prototype,"_completeResult",2),l([u()],T.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",T)});function It(i,a){let e=i.interval_analysis,t=e?.weibull_beta,n=e?.weibull_eta;if(t==null||n==null||n<=0)return p;let r=i.interval_days??0,d=i.suggested_interval??r;return c`
    <div class="weibull-section">
      ...
      ${Ma(t,n,r,d,a)}
      ${Fa(e,a)}
      ${e?.confidence_interval_low!=null?Ha(e,i,a):p}
    </div>
  ...
  `}function Ma(i,a,e,t,n){let f=Math.max(e,t,a,1)*1.3,w=50,L=[];for(let C=0;C<=w;C++){let R=C/w*f,Yt=1-Math.exp(-Math.pow(R/a,i)),Xt=32+R/f*260,ea=136-Yt*128;L.push([Xt,ea])}let me=L.map(([C,R])=>`${C.toFixed(1)},${R.toFixed(1)}`).join(" "),Se="M32,136 "+L.map(([C,R])=>`L${C.toFixed(1)},${R.toFixed(1)}`).join(" ")+` L${L[w][0].toFixed(1)},136 Z`,Y=32+e/f*260,he=1-Math.exp(-Math.pow(e/a,i)),ve=136-he*128,Zt=((1-he)*100).toFixed(0),Qe=32+t/f*260,Jt=[0,.25,.5,.75,1];return c`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${o("chart_weibull",n)}">
        ${Jt.map(C=>{let R=136-C*128;return te`
        ...
        ${e>0?te`
          ...
          <text x="${(Y+4).toFixed(1)}" y="${(ve-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${Zt}%</text>
        `:p}
  ...
  `}function Ha(i,a,e){let t=i.confidence_interval_low,n=i.confidence_interval_high,r=a.suggested_interval??a.interval_days??0,d=a.interval_days??0,s=Math.max(0,t-5),m=n+5-s,b=(t-s)/m*100,h=(n-t)/m*100,k=(r-s)/m*100,f=d>0?(d-s)/m*100:-1;return c`
    <div class="confidence-range">
      ...
      <div class="confidence-bar">
        ...
        ${f>=0?c`<div class="confidence-marker current" style="left:${f.toFixed(1)}%"></div>`:p}
  ...
  `}var Rt=y(()=>{"use strict";j();S()});function Dt(i,a,e){let t=i.degradation_trend!=null&&i.degradation_trend!=="insufficient_data",n=i.days_until_threshold!=null,r=i.environmental_factor!=null&&i.environmental_factor!==1;if(!t&&!n&&!r)return p;let d=i.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":i.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return c`
      ...
      <div class="prediction-grid">
        ...
        ${r&&e.environmental?c`
          <div class="prediction-item">
            ...
            ${i.environmental_entity?c`<span class="prediction-entity entity-link" @click=${s=>Et(s,i.environmental_entity)}>${i.environmental_entity}</span>`:p}
          </div>
        `:p}
      </div>
    </div>
  `}var Pt=y(()=>{"use strict";j();S()});function Lt(i,a,e,t){let n=Math.max(i||1,a);return c`
  ...
  `}var Mt=y(()=>{"use strict";j();S()});function Ht(i,a,e){if(!e.seasonal||!i.seasonal_factor||i.seasonal_factor===1)return p;let t=Ft.map(s=>o(s,a)),n=new Date().getMonth(),r=i.seasonal_factors||i.interval_analysis?.seasonal_factors||null,d=r&&r.length===12?r:t.map((s,_)=>{let m=i.seasonal_factor||1,b=Math.sin((_-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,m+b))});return c`
    <div class="seasonal-card-compact">
      <h4>${o("seasonal_awareness",a)}</h4>
      <div class="seasonal-mini-chart">
        ${d.map((s,_)=>{let m=s*40,b=s<.9?"low":s>1.1?"high":"normal";return c`
  ...
  `}function Ot(i,a){return Oa(i,a)}function Oa(i,a){let e=i.seasonal_factors??i.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return p;let t=i.interval_analysis?.seasonal_reason,n=new Date().getMonth(),r=300,d=100,s=8,m=d-s-4,b=Math.max(...e,1.5),h=r/12,k=h*.65,f=s+m-1/b*m;return c`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${r} ${d}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${o("chart_seasonal",a)}">
        <line x1="0" y1="${f.toFixed(1)}" x2="${r}" y2="${f.toFixed(1)}"
          stroke="var(--divider-color)" stroke-width="1" stroke-dasharray="4,3" />
        ${e.map((w,L)=>{let me=w/b*m,Se=L*h+(h-k)/2,Y=s+m-me,he=L===n,ve=w<1?"var(--success-color, #4caf50)":w>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return te`
  ...
  `}var Ft,Ut=y(()=>{"use strict";j();S();Ft=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var $,Vt=y(()=>{"use strict";j();I();S();J();Rt();Pt();Mt();Ut();$=class extends x{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(n=>n.id===this._taskId);this._task=t??null}catch(e){this._error=q(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=q(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(D(),O)).then(({openCompleteDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(D(),O)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(D(),O)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=o("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=o("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${o("reanalyze_result",this._lang)||"Recomputed"}: ${e.recommended_interval}d (${e.data_points} pts)`:o("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=q(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){!this._entryId||!this._taskId||Promise.resolve().then(()=>(D(),O)).then(({openHistoryEditDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null})})}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return p;let t=this._lang;return c`
    ...
    `}_renderAdaptive(e){let t=this._lang,n=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,r=e.degradation_trend!=null&&e.degradation_trend!=="insufficient_data"||e.days_until_threshold!=null||e.environmental_factor!=null&&e.environmental_factor!==1,d=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,s=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1;return!n&&!r&&!d&&!s?c`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${r?Dt(e,t,this._features):p}
        ${d?It(e,t):p}
        ${s?c`
          ${Ht(e,t,this._features)}
          ${e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12?Ot(e,t):p}
        `:p}
      </div>
    `}_renderDetails(e){let t=this._lang,n=e.history||[],r=n.filter(_=>_.type==="completed"),d=r.reduce((_,m)=>_+(typeof m.cost=="number"?m.cost:0),0),s=(()=>{let _=r.map(m=>typeof m.duration=="number"?m.duration:null).filter(m=>m!=null);return _.length?Math.round(_.reduce((m,b)=>m+b,0)/_.length):null})();return c`
      <div class="details">
        ...
        ${n.length===0?c`<div class="history-empty">${o("history_empty",t)||"No history yet."}</div>`:c`
              <div class="history-list">
                ${[...n].reverse().slice(0,20).map(_=>{let m=["completed","reset","skipped"].includes(_.type);return c`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${_.type}">${o(_.type,t)}</span>
                        <span class="history-date">${At(_.timestamp,t)}</span>
                        ${m?c`<button class="history-edit"
                                   title="${o("history_edit_button",t)||"Edit"}"
                                   @click=${()=>this._onEditHistoryEntry(_)}>
                              <ha-icon icon="mdi:pencil"></ha-icon>
                            </button>`:p}
                      </div>
                      ${_.notes?c`<div class="history-notes">${_.notes}</div>`:p}
                      ${_.cost!=null||_.duration!=null?c`<div class="history-meta">
                            ${_.cost!=null?c`<span>💰 ${_.cost.toFixed(2)}</span>`:p}
                            ${_.duration!=null?c`<span>⏱️ ${_.duration}m</span>`:p}
                          </div>`:p}
                    </div>
                  `})}
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?c`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&Promise.resolve().then(()=>(D(),O)).then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
      ...
      <div class="meta">
        ${n.map(([r,d])=>c`
            <div class="meta-item">
              ...
              <span class="meta-value">${r.toLowerCase().includes("doc")||r.toLowerCase().includes("url")?c`<a href="${d}" target="_blank" rel="noopener">${d}</a>`:d}</span>
            </div>
          `)}
      </div>
    `}};P.styles=z`
  ...
  `,l([v({attribute:!1})],P.prototype,"hass",2),l([u()],P.prototype,"_open",2),l([u()],P.prototype,"_entryId",2),l([u()],P.prototype,"_data",2),l([u()],P.prototype,"_busy",2),l([u()],P.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",P)});var O={};aa(O,{openCompleteDialog:()=>Ja,openCreateObjectDialog:()=>We,openCreateTaskDialog:()=>Ge,openEditObjectDialog:()=>Ka,openEditTaskDialog:()=>Qa,openHistoryEditDialog:()=>Za,openObjectQuickActions:()=>Xa,openQrDialog:()=>Ya,openTaskQuickActions:()=>Ke});function je(){return document.querySelector("home-assistant")?.hass}function U(i){let a=document.body.querySelector(i);return a||(a=document.createElement(i),document.body.appendChild(a)),a}function V(i){let a=je();return a?(i.hass=a,!0):!1}function Qt(i){return Ee||(Ee=i.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(a=>({features:a.features??Wt.features,defaultWarningDays:a.general?.default_warning_days??7})).catch(()=>Wt),Ee)}function We(){let i=U(Gt);return V(i)?(i.openCreate(),!0):!1}function Ka(i,a){let e=U(Gt);return V(e)?(e.openEdit(i,a),!0):!1}function Ge(){let i=U(Kt);if(!V(i))return!1;let a=je();return a?((async()=>{let e=await Qt(a),t=i;t.checklistsEnabled=e.features.checklists,t.scheduleTimeEnabled=e.features.schedule_time,t.completionActionsEnabled=e.features.completion_actions,t.defaultWarningDays=e.defaultWarningDays,t.openCreate()})(),!0):!1}function Qa(i,a){let e=U(Kt);if(!V(e))return!1;let t=je();return t?((async()=>{try{let[n,r]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:i}),Qt(t)]),d=(n.tasks||[]).find(_=>_.id===a);if(!d){console.warn(`openEditTaskDialog: task ${a} not found in entry ${i}`);return}let s=e;s.checklistsEnabled=r.features.checklists,s.scheduleTimeEnabled=r.features.schedule_time,s.completionActionsEnabled=r.features.completion_actions,s.defaultWarningDays=r.defaultWarningDays,await s.openEdit(i,d)}catch(n){console.warn("openEditTaskDialog: failed to load task/features",n)}})(),!0):!1}function Za(i){let a=U(Ua);return V(a)?(a.openEdit(i),!0):!1}function Ja(i){let a=U(Va);return V(a)?(a.entryId=i.entry_id,a.taskId=i.task_id,a.taskName=i.task_name,a.checklist=i.checklist??[],a.adaptiveEnabled=!!i.adaptive_enabled,a.lang=je()?.language||"en",a.open(),!0):!1}function Ya(i){let a=U(Ba);return V(a)?(a.openForTask(i.entry_id,i.task_id,i.object_name,i.task_name),!0):!1}function Ke(i,a){let e=U(Wa);return V(e)?(e.openFor(i,a),!0):!1}function Xa(i){let a=U(Ga);return V(a)?(a.openFor(i),!0):!1}var Gt,Kt,Ua,Va,Ba,Wa,Ga,Wt,Ee,D=y(()=>{"use strict";jt();qt();Ve();Nt();Ct();Vt();Bt();Gt="maintenance-object-dialog",Kt="maintenance-task-dialog",Ua="maintenance-history-edit-dialog",Va="maintenance-complete-dialog",Ba="maintenance-qr-dialog",Wa="maintenance-task-quick-actions-dialog",Ga="maintenance-object-quick-actions-dialog";Wt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},Ee=null});j();I();S();j();I();S();var qa=["overdue","triggered","due_soon","ok"],F=class extends x{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._loadingObjects=!0;this._loadError=!1;this._objectsLoaded=!1;this._onEntitiesChanged=e=>{this._valueChanged("entity_ids",e.detail.value||[])}}get _lang(){return this.hass?.language||"en"}setConfig(e){this._config={...e}}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._objectsLoaded&&(this._objectsLoaded=!0,this._loadObjects())}async _loadObjects(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._objects=e.objects||[],this._loadError=!1}catch{this._objects=[],this._loadError=!0}this._loadingObjects=!1}_valueChanged(e,t){let n={...this._config,[e]:t};Array.isArray(t)&&t.length===0&&delete n[e],this._config=n,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n}}))}_toggleStatus(e,t){let n=new Set(this._config.filter_status||[]);t?n.add(e):n.delete(e),this._valueChanged("filter_status",[...n])}_toggleObject(e,t){let n=new Set(this._config.filter_objects||[]);t?n.add(e):n.delete(e),this._valueChanged("filter_objects",[...n])}render(){let e=this._lang,t=new Set(this._config.filter_status||[]),n=new Set(this._config.filter_objects||[]),r=[...this._objects].map(s=>s.object.name).sort((s,_)=>s.localeCompare(_)),d=[];for(let s of this._objects)for(let _ of s.tasks)_.sensor_entity_id&&d.push(_.sensor_entity_id),_.binary_sensor_entity_id&&d.push(_.binary_sensor_entity_id);return c`
      <div class="editor">
        <ha-textfield
        ...
        <div class="field">
          ...
          ${this._loadingObjects?c`<div class="field-help">${o("card_loading_objects",e)}</div>`:this._loadError?c`<div class="field-help error-text">${o("card_load_error",e)}</div>`:r.length===0?c`<div class="field-help">${o("no_objects",e)}</div>`:c`
  ...
  `,l([v({attribute:!1})],F.prototype,"hass",2),l([u()],F.prototype,"_config",2),l([u()],F.prototype,"_objects",2),l([u()],F.prototype,"_loadingObjects",2),l([u()],F.prototype,"_loadError",2);customElements.get("maintenance-supporter-card-editor")||customElements.define("maintenance-supporter-card-editor",F);Ve();D();var B=class extends x{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._stats=null;this._unsub=null;this._dataLoaded=!1;this._lastConnection=null;this._onCompleted=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"en"}static getConfigElement(){return document.createElement("maintenance-supporter-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-card",show_header:!0,show_actions:!0,filter_status:["overdue","triggered","due_soon"],max_items:10}}setConfig(e){this._config=e}getCardSize(){return 3}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null}updated(e){if(super.updated(e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _flatTasks(){let e=[],{filter_status:t,filter_objects:n,entity_ids:r,filter_due_min_days:d,filter_due_max_days:s,max_items:_}=this._config,m=r?.length?new Set(r):null,b=d!==void 0||s!==void 0;for(let k of this._objects)if(!(n?.length&&!n.includes(k.object.name))){for(let f of k.tasks)if(!(t?.length&&!t.includes(f.status))&&!(m&&!(f.sensor_entity_id&&m.has(f.sensor_entity_id)||f.binary_sensor_entity_id&&m.has(f.binary_sensor_entity_id)))){if(b){let w=f.days_until_due;if(w==null||d!==void 0&&w<d||s!==void 0&&w>s)continue}e.push({entry_id:k.entry_id,object_name:k.object.name,task:f})}}let h={overdue:0,triggered:1,due_soon:2,ok:3};return e.sort((k,f)=>{let w=(h[k.task.status]??9)-(h[f.task.status]??9);return w!==0?w:(k.task.days_until_due??1/0)-(f.task.days_until_due??1/0)}),_&&_>0?e.slice(0,_):e}_openTaskDetail(e,t){Ke(e,t)}render(){let e=this._lang,t=this._config.title||o("maintenance",e),n=this._config.show_header!==!1,r=this._config.show_actions!==!1,d=this._config.compact||!1,s=this._flatTasks,_=this._stats;return c`
      <ha-card>
          ...
          <div class="header-right">
            ${n&&_?c`
                  <div class="header-stats">
                    ${_.overdue>0?c`<span class="badge overdue">${_.overdue}</span>`:p}
                    ${_.due_soon>0?c`<span class="badge due_soon">${_.due_soon}</span>`:p}
                    ${_.triggered>0?c`<span class="badge triggered">${_.triggered}</span>`:p}
                  </div>
                `:p}
            ${r?c`
                  <mwc-icon-button
        ...
        ${s.length===0?c`<div class="empty-card">
              ...
              <div class="task-list ${d?"compact":""}">
                ${s.map(({entry_id:m,object_name:b,task:h})=>c`
                    <div class="task-item clickable"
                      ...
                      <div class="task-info">
                        ...
                        ${d?p:c`<div class="task-meta">${b} · ${o(h.type,e)}</div>`}
                      </div>
                      <div class="task-due">
                        ${h.days_until_due!==null&&h.days_until_due!==void 0?h.days_until_due<0?c`<span class="overdue-text">${Math.abs(h.days_until_due)}${e.startsWith("de")?"T":"d"}</span>`:h.days_until_due===0?o("today",e):`${h.days_until_due}${e.startsWith("de")?"T":"d"}`:h.trigger_active?"\u26A1":"\u2014"}
                      </div>
                      ${r?c`
                            <mwc-icon-button
                              class="complete-btn"
