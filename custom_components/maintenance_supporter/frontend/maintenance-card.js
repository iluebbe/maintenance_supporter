...
`;var D=class extends y{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"}}get _lang(){return this.hass?.language||"de"}setConfig(t){this._config={...t}}_valueChanged(t,a){let n={...this._config,[t]:a};this._config=n,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n}}))}render(){let t=this._lang;return p`
      <div class="editor">
        <ha-textfield
