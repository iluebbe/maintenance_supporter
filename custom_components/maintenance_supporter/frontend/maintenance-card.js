...
`).map(_=>_.trim()).filter(Boolean).slice(0,100);e.checklist=c.length?c:null}if(this.completionActionsEnabled){let c=this._actionService.trim();if(c&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(c)){let m={service:c},y=this._actionTargetEntity.trim();y&&(m.target={entity_id:y});let b=this._buildActionData();Object.keys(b).length>0&&(m.data=b),e.on_complete_action=m}else e.on_complete_action=null;let _={};this._qcNotes.trim()&&(_.notes=this._qcNotes.trim());let u=parseFloat(this._qcCost);!isNaN(u)&&u>=0&&(_.cost=u);let f=parseInt(this._qcDuration,10);!isNaN(f)&&f>=0&&(_.duration=f),this._qcFeedback&&(_.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(_).length?_:null}let i=await this.hass.connection.sendMessagePromise(e),n=this._taskId||i?.task_id,d=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(n&&this._scheduleType==="sensor_based"&&d)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=L(e,this._lang,r("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return h;let e=this._lang,t=this._triggerType==="compound";return o`
      ...
      <div class="select-row">
        ...
        >
          ${Wi.map(i=>o`<option value=${i} ?selected=${i===this._triggerType}>${r(i,e)}</option>`)}
        </select>
      </div>
    ...
    `}_renderCondition(e,t){let i=this._lang,n=t+1;return o`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${Vt.map(d=>o`<option value=${d} ?selected=${d===e.type}>${r(d,i)}</option>`)}
          </select>
        </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Oi.map(i=>o`<option value=${i} ?selected=${i===this._type}>${r(i,e)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${Vi.map(i=>o`<option value=${i} ?selected=${i===this._scheduleType}>${r(i,e)}</option>`)}
            </select>
          </div>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `}function Xi(a,s,e,t,i){let b=Math.max(e,t,s,1)*1.3,A=50,k=[];for(let j=0;j<=A;j++){let z=j/A*b,gi=1-Math.exp(-Math.pow(z/s,a)),mi=32+z/b*260,fi=136-gi*128;k.push([mi,fi])}let R=k.map(([j,z])=>`${j.toFixed(1)},${z.toFixed(1)}`).join(" "),Pe="M32,136 "+k.map(([j,z])=>`L${j.toFixed(1)},${z.toFixed(1)}`).join(" ")+` L${k[A][0].toFixed(1)},136 Z`,ie=32+e/b*260,ve=1-Math.exp(-Math.pow(e/s,a)),be=136-ve*128,_i=((1-ve)*100).toFixed(0),it=32+t/b*260,ui=[0,.25,.5,.75,1];return o`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${r("chart_weibull",i)}">
        ${ui.map(j=>{let z=136-j*128;return ae`
        ...
        <path d="${Pe}" fill="var(--primary-color, #03a9f4)" opacity="0.08" />
  ...
  `}function ts(a,s,e){let t=a.confidence_interval_low,i=a.confidence_interval_high,n=s.suggested_interval??s.interval_days??0,d=s.interval_days??0,c=Math.max(0,t-5),u=i+5-c,f=(t-c)/u*100,m=(i-t)/u*100,y=(n-c)/u*100,b=d>0?(d-c)/u*100:-1;return o`
  ...
  `}var Qt=x(()=>{"use strict";C();I()});function Xt(a,s,e,t){let i=Math.max(a||1,s);return o`
  ...
  `}function si(a,s){return is(a,s)}function is(a,s){let e=a.seasonal_factors??a.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return h;let t=a.interval_analysis?.seasonal_reason,i=new Date().getMonth(),n=300,d=100,c=8,u=d-c-4,f=Math.max(...e,1.5),m=n/12,y=m*.65,b=c+u-1/f*u;return o`
      ...
      <div class="meta">
        ${i.map(([n,d])=>o`
            <div class="meta-item">
              ...
              <span class="meta-value">${ni(d)?o`<a href="${d}" target="_blank" rel="noopener noreferrer">${d}</a>`:d}</span>
            </div>
          `)}
      </div>
    `}};U.styles=E`
  ...
  `,l([v({attribute:!1})],U.prototype,"hass",2),l([p()],U.prototype,"_open",2),l([p()],U.prototype,"_entryId",2),l([p()],U.prototype,"_data",2),l([p()],U.prototype,"_busy",2),l([p()],U.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",U)});var V={};bi(V,{openCompleteDialog:()=>ps,openCreateObjectDialog:()=>Xe,openCreateTaskDialog:()=>et,openEditObjectDialog:()=>ls,openEditTaskDialog:()=>cs,openHistoryEditDialog:()=>ds,openObjectQuickActions:()=>_s,openQrDialog:()=>hs,openTaskQuickActions:()=>tt});function Re(){return document.querySelector("home-assistant")?.hass}function W(a){let s=document.body.querySelector(a);return s||(s=document.createElement(a),document.body.appendChild(s)),s}function B(a){let s=Re();if(!s)return!1;a.hass=s;let e=s.language||"en";return Te(e)||Ce(e).then(()=>{a.requestUpdate?.()}),!0}function hi(a){return He||(He=a.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(s=>({features:s.features??ci.features,defaultWarningDays:s.general?.default_warning_days??7})).catch(()=>ci),He)}function Xe(){let a=W(di);return B(a)?(a.openCreate(),!0):!1}function ls(a,s){let e=W(di);return B(e)?(e.openEdit(a,s),!0):!1}function et(){let a=W(pi);if(!B(a))return!1;let s=Re();return s?((async()=>{let e=await hi(s),t=a;t.checklistsEnabled=e.features.checklists,t.scheduleTimeEnabled=e.features.schedule_time,t.completionActionsEnabled=e.features.completion_actions,t.defaultWarningDays=e.defaultWarningDays,t.openCreate()})(),!0):!1}function cs(a,s){let e=W(pi);if(!B(e))return!1;let t=Re();return t?((async()=>{try{let[i,n]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:a}),hi(t)]),d=(i.tasks||[]).find(_=>_.id===s);if(!d){console.warn(`openEditTaskDialog: task ${s} not found in entry ${a}`);return}let c=e;c.checklistsEnabled=n.features.checklists,c.scheduleTimeEnabled=n.features.schedule_time,c.completionActionsEnabled=n.features.completion_actions,c.defaultWarningDays=n.defaultWarningDays,await c.openEdit(a,d)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function ds(a){let s=W(ss);return B(s)?(s.openEdit(a),!0):!1}function ps(a){let s=W(rs);return B(s)?(s.entryId=a.entry_id,s.taskId=a.task_id,s.taskName=a.task_name,s.checklist=a.checklist??[],s.adaptiveEnabled=!!a.adaptive_enabled,s.lang=Re()?.language||"en",s.open(),!0):!1}function hs(a){let s=W(as);return B(s)?(s.openForTask(a.entry_id,a.task_id,a.object_name,a.task_name),!0):!1}function tt(a,s){let e=W(ns);return B(e)?(e.openFor(a,s),!0):!1}function _s(a){let s=W(os);return B(s)?(s.openFor(a),!0):!1}var di,pi,ss,rs,as,ns,os,ci,He,q=x(()=>{"use strict";Ft();Wt();Ze();Bt();Kt();ai();li();I();di="maintenance-object-dialog",pi="maintenance-task-dialog",ss="maintenance-history-edit-dialog",rs="maintenance-complete-dialog",as="maintenance-qr-dialog",ns="maintenance-task-quick-actions-dialog",os="maintenance-object-quick-actions-dialog";ci={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},He=null});C();N();I();C();N();I();var Mi=["overdue","triggered","due_soon","ok"],M=class extends w{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._loadingObjects=!0;this._loadError=!1;this._views=[];this._objectsLoaded=!1;this._onEntitiesChanged=e=>{this._valueChanged("entity_ids",e.detail.value||[])}}get _lang(){return this.hass?.language||"en"}setConfig(e){this._config={...e}}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._objectsLoaded&&(this._objectsLoaded=!0,this._loadObjects())}async _loadObjects(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._objects=e.objects||[],this._loadError=!1}catch{this._objects=[],this._loadError=!0}this._loadingObjects=!1;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"});this._views=e.views||[]}catch{this._views=[]}}_valueChanged(e,t){let i={...this._config,[e]:t};(Array.isArray(t)&&t.length===0||t==="")&&delete i[e],this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}_toggleStatus(e,t){let i=new Set(this._config.filter_status||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_status",[...i])}_toggleObject(e,t){let i=new Set(this._config.filter_objects||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_objects",[...i])}render(){let e=this._lang,t=new Set(this._config.filter_status||[]),i=new Set(this._config.filter_objects||[]),n=[...this._objects].map(c=>c.object.name).sort((c,_)=>c.localeCompare(_)),d=[];for(let c of this._objects)for(let _ of c.tasks)_.sensor_entity_id&&d.push(_.sensor_entity_id),_.binary_sensor_entity_id&&d.push(_.binary_sensor_entity_id);return o`
      <div class="editor">
        <ha-textfield
