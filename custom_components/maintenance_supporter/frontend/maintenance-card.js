      ...
      <div class="prediction-grid">
        ...
        ${i?o`
          <div class="prediction-item">
            ...
            ${a.threshold_prediction_date?o`<span class="prediction-date">${U(a.threshold_prediction_date,s)}</span>`:h}
        ...
        ${t?o`
              <div class="header">
                ...
                <div class="quick-info">
                  ${t.next_due?o`<span><strong>${r("next_due",e)||"Next due"}:</strong> ${U(t.next_due,e)}</span>`:h}
                  ${t.last_performed?o`<span><strong>${r("last_performed",e)||"Last"}:</strong> ${U(t.last_performed,e)}</span>`:h}
                  ${t.schedule?.kind&&!["manual","one_time"].includes(t.schedule.kind)||t.interval_days!=null?o`<span><strong>${r("interval",e)||"Interval"}:</strong> ${Ut(t,e)}</span>`:h}
                </div>
              </div>
