...
`});function yr(s,r,e){let t=new Blob([s],{type:e}),i=URL.createObjectURL(t),a=document.createElement("a");a.href=i,a.download=r,a.target="_blank",a.rel="noopener",a.style.display="none",document.body.appendChild(a),a.dispatchEvent(new MouseEvent("click")),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(i),6e4)}var Yt=w(()=>{"use strict"});async function un(s,r,e=300){return(await s.connection.sendMessagePromise({type:"auth/sign_path",path:r,expires:e})).path}async function Gt(s,r,e=300){return un(s,`/api/maintenance_supporter/document/${r}`,e)}async function xr(s,r,e=""){let t=window.open("about:blank","_blank");try{let i=await Gt(s,r);t&&(t.location.href=new URL(i+e,window.location.origin).href)}catch(i){throw t&&t.close(),i}}var Qt=w(()=>{"use strict";Yt()});function mt(s){return!!s&&/^https?:\/\//i.test(s)}var Jt=w(()=>{"use strict"});function _n(s){let r=(s||"").split(/\s+/).filter(Boolean);return r.length===0?"?":r.length===1?r[0][0].toUpperCase():(r[0][0]+r[r.length-1][0]).toUpperCase()}function mn(s){let r=0;for(let e of s)r=r*31+e.charCodeAt(0)>>>0;return wr[r%wr.length]}function gt(s){return s?{id:s.id,name:s.name,initials:s.initials||_n(s.name),color:s.color||mn(s.id)}:null}function Zt(s){return s?o`<span class="person-avatar" style="--person-color: ${s.color}" title=${s.name}>${s.initials}</span>`:d}var wr,Xt=w(()=>{"use strict";I();wr=["#c62828","#ad1457","#6a1b9a","#4527a0","#283593","#1565c0","#00838f","#2e7d32","#558b2f","#ef6c00","#6d4c41","#546e7a"]});var Ie,ei=w(()=>{"use strict";Xt();Ie=class{constructor(r){this.usersCache=null;this.cacheTimestamp=0;this.CACHE_TTL_MS=6e4;this.hass=r}updateHass(r){this.hass=r}async getUsers(r=!1){let e=Date.now();if(!r&&this.usersCache&&e-this.cacheTimestamp<this.CACHE_TTL_MS)return this.usersCache;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/users/list"});return this.usersCache=t.users,this.cacheTimestamp=e,this.usersCache}catch(t){return console.error("Failed to fetch users:",t),this.usersCache||[]}}async assignUser(r,e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/assign_user",entry_id:r,task_id:e,user_id:t})}async getTasksByUser(r){return(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tasks/by_user",user_id:r})).tasks}getUserName(r){return!r||!this.usersCache?null:this.usersCache.find(t=>t.id===r)?.name||null}getPerson(r){return gt(this.getUser(r))}getUser(r){return!r||!this.usersCache?null:this.usersCache.find(e=>e.id===r)||null}getCurrentUserId(){return this.hass.user?.id||null}isCurrentUser(r){return r?r===this.getCurrentUserId():!1}clearCache(){this.usersCache=null,this.cacheTimestamp=0}}});function gn(s,r){if(r<=0)return 0;let e=typeof s=="number"&&Number.isFinite(s)?Math.trunc(s):0;return e<0?0:e%r}function fn(s){return!!(s?.phases&&s.phase_sequence&&s.phase_sequence.length>0)}function ti(s){if(!s||!fn(s))return null;let r=s.phase_sequence,e=gn(s.phase_cursor,r.length),t=r[e],i=s.phases?.[t];return i?{id:t,name:i.name,index:e,count:r.length,notes:i.notes,checklist:i.checklist!==void 0?i.checklist:s.checklist??[],consumesParts:i.consumes_parts!==void 0?i.consumes_parts:s.consumes_parts??[],requiredFields:i.required_completion_fields!==void 0?i.required_completion_fields:s.required_completion_fields??[]}:null}function de(s){let r=ti(s);return r?`${r.index+1}/${r.count} \xB7 ${r.name}`:""}var ft=w(()=>{"use strict"});function $r(){let s=new Uint8Array(4);return(globalThis.crypto??{getRandomValues:r=>r.map(()=>Math.floor(Math.random()*256))}).getRandomValues(s),Array.from(s,r=>r.toString(16).padStart(2,"0")).join("")}function pe(s){let r=s?.reading_values;if(!Array.isArray(r))return[];let e=[],t=new Set;for(let i of r){if(!i||typeof i!="object")continue;let a=i;typeof a.id!="string"||!a.id||t.has(a.id)||typeof a.value!="number"||!Number.isFinite(a.value)||(t.add(a.id),e.push({id:a.id,name:typeof a.name=="string"?a.name:a.id,unit:typeof a.unit=="string"?a.unit:null,value:a.value}))}return e}function kr(s){return s.filter(r=>r.type==="completed"&&(r.reading_value!=null||pe(r).length>0)).sort((r,e)=>r.timestamp.localeCompare(e.timestamp))}function Er(s){return kr(s??[]).map(r=>({timestamp:r.timestamp,values:pe(r)})).filter(r=>r.values.length>0)}function Sr(s,r,e){let t;for(let i of s){if(e!==void 0){let l=new Date(i.timestamp).getTime();if(!isNaN(l)&&l>=e)break}let a=i.values.find(l=>l.id===r);a&&(t=a)}return t}function Tr(s,r,e){let t=pe(r).find(a=>a.id===e);if(!t)return null;let i=null;for(let a of kr(s)){if(a.timestamp>=r.timestamp)break;let l=pe(a).find(u=>u.id===e);l&&(i=l.value)}return i==null?null:t.value-i}function Ar(s){let r=new Set,e=new Set;for(let t of s){let i=(t.name||"").trim().toLowerCase();i&&(r.has(i)?e.add(t.id):r.add(i))}return e}function Cr(s){let r=[],e=new Set,t=new Set;for(let i of s){let a=(i.name||"").trim();if(!(!a||e.has(i.id)||t.has(a.toLowerCase()))&&(e.add(i.id),t.add(a.toLowerCase()),r.push({id:i.id,name:a,unit:(i.unit||"").trim()||null}),r.length>=20))break}return r}var ye=w(()=>{"use strict"});function Q(s){return`${s.entry_id??""}\0${s.part_id}`}function Ir(s,r,e,t){let i=!!s.entry_id&&s.entry_id!==r,a=i?s.entry_id:r,l=e.find(m=>m.entry_id===a),u=(l?.parts||[]).find(m=>m.id===s.part_id)||null,h=i&&l?.object?.name||"",_=u?.name||n("shared_part_unknown",t);return{part:u,foreign:i,ownerName:h,label:h?`${_} (${h})`:_}}function Rr(s,r,e,t){let{part:i,label:a}=Ir(s,r,e,t),l=i&&i.stock!==null&&i.stock!==void 0?` (${i.stock}${i.unit?" "+i.unit:""})`:"",u=i?.storage_location?` \u2014 ${i.storage_location}`:"";return`${s.quantity}\xD7 ${a}${l}${u}`}function Pr(s,r,e,t){let a=(e.find(u=>u.entry_id===r)?.parts||[]).map(u=>({...u})),l=new Set(a.map(u=>Q({part_id:u.id})));for(let u of s?.consumes_parts||[]){if(!u.entry_id||u.entry_id===r)continue;let h=Q(u);if(l.has(h))continue;l.add(h);let{part:_,ownerName:m}=Ir(u,r,e,t);a.push({id:u.part_id,name:_?.name||n("shared_part_unknown",t),unit:_?.unit,stock:_?.stock??null,storage_location:_?.storage_location,entry_id:u.entry_id,owner_name:m})}return a}var vt=w(()=>{"use strict";C()});function Ze(s){let r=s.task??null,e=r?ti(r):null,t=e?e.consumesParts:r?.consumes_parts||[],i=!!r?.part_ref,a=s.objects.find(h=>h.entry_id===s.entryId)?.parts||[],l=i?a.find(h=>h.id===r.part_ref.part_id):void 0,u=s.checklistsEnabled??!0;return{entry_id:s.entryId,task_id:s.taskId,task_name:s.taskName,checklist:e?u?e.checklist:[]:s.checklist??[],adaptive_enabled:!!s.adaptiveEnabled,required_completion_fields:e?e.requiredFields:r?.required_completion_fields||[],task_type:r?.type||"",reading_unit:r?.reading_unit||"",readings:r?.readings||[],reading_history:Er(r?.history),parts:i?[]:Pr({consumes_parts:t},s.entryId,s.objects,s.lang),consumes_parts:i?[]:t,phase_label:e?de(r):"",require_tag_scan:!!r?.require_tag_scan,restock_default:i?l?.restock_quantity??1:null,restock_unit_cost:i?l?.cost??null:null,currency_symbol:ce({currency_symbol:s.currencySymbol}),consumes_info:t.map(h=>Rr(h,s.entryId,s.objects,s.lang)),checklist_prefill:r?.checklist_progress||{},via_tag_scan:!!s.viaTagScan}}function Xe(s,r,e){s.entryId=r.entry_id,s.taskId=r.task_id,s.taskName=r.task_name,s.lang=e,s.checklist=r.checklist??[],s.adaptiveEnabled=!!r.adaptive_enabled,s.requiredFields=r.required_completion_fields??[],s.taskType=r.task_type??"",s.readingUnit=r.reading_unit??"",s.readings=r.readings??[],s.readingHistory=r.reading_history??[],s.parts=r.parts??[],s.consumesParts=r.consumes_parts??[],s.phaseLabel=r.phase_label??"",s.requireTagScan=!!r.require_tag_scan,s.restockDefault=r.restock_default??null,s.restockUnitCost=r.restock_unit_cost??null,s.currencySymbol=ce(r),s.consumesInfo=r.consumes_info??[],s.checklistPrefill=r.checklist_prefill??{},s.viaTagScan=!!r.via_tag_scan,s.open({viaTagScan:!!r.via_tag_scan})}var bt=w(()=>{"use strict";ye();vt();ft();C()});function xn(s){let r=s.replace(/_ids?$/,"").split("_").filter(Boolean);if(r.length===0)return s;let e=r.join(" ");return e.charAt(0).toUpperCase()+e.slice(1)}function wn(s,r){let e=yn[s];if(e){let t=n(e,r);if(t&&t!==e)return t}return xn(s)}function $n(s){let r=[...s.matchAll(/\['([^']+)'\]/g)].map(i=>i[1]),e=r.length?r[r.length-1]:void 0,t;return(t=s.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=s.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=s.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=s.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(s)?{field:e,rule:"required"}:(t=s.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(s)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(s)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function kn(s,r){let e=new Set(Lr(r));return Lr(s).every(t=>e.has(t))}function R(s,r,e){if(e=e??n("action_error",r),typeof s=="string")return s;if(typeof s!="object"||s===null)return e;let t=s,i=t.message||t.error?.message||"",a=t.code||t.error?.code||"",l=a?bn[a]:void 0;if(!i&&!l)return e;let u=$n(i),h=u.field?wn(u.field,r):"",_=m=>n(m,r).replace("{field}",h).replace("{n}",u.param??"");switch(u.rule){case"too_long":return _("err_too_long");case"too_short":return _("err_too_short");case"value_too_high":return _("err_value_too_high");case"value_too_low":return _("err_value_too_low");case"required":return _("err_required");case"wrong_type":return _("err_wrong_type").replace("{type}",u.param??"");case"invalid_choice":return _("err_invalid_choice");case"invalid_value":return _("err_invalid_value");default:if(l){let m=n(l,r);return i&&!kn(i,a)?`${m} (${i})`:m}return i||e}}var bn,yn,Lr,re=w(()=>{"use strict";C();bn={already_archived:"ws_err_already_archived",already_paused:"ws_err_already_paused",archived:"ws_err_archived",create_failed:"ws_err_create_failed",duplicate_failed:"ws_err_duplicate_failed",empty:"ws_err_empty",empty_csv:"ws_err_empty_csv",invalid_cursor:"ws_err_invalid_cursor",invalid_date:"ws_err_invalid_date",invalid_device:"ws_err_invalid_device",invalid_entity_slug:"ws_err_invalid_entity_slug",invalid_format:"ws_err_invalid_format",invalid_input:"ws_err_invalid_input",invalid_mirror_todo:"ws_err_invalid_mirror_todo",invalid_parent:"ws_err_invalid_parent",invalid_icon:"ws_err_invalid_icon",invalid_range:"ws_err_invalid_range",invalid_search_template:"ws_err_invalid_search_template",invalid_target:"ws_err_invalid_target",invalid_trigger_config:"ws_err_invalid_trigger_config",invalid_url:"ws_err_invalid_url",invalid_user:"ws_err_invalid_user",invalid_view:"ws_err_invalid_view",limit_reached:"ws_err_limit_reached",no_defaults:"ws_err_no_defaults",no_phases:"ws_err_no_phases",no_url:"ws_err_no_url",not_archived:"ws_err_not_archived",not_available:"ws_err_not_available",not_configured:"ws_err_not_configured",not_found:"ws_err_not_found",not_loaded:"ws_err_not_loaded",not_paused:"ws_err_not_paused",replace_failed:"ws_err_replace_failed",self_link_device:"ws_err_self_link_device",storage_unavailable:"ws_err_storage_unavailable",too_early:"ws_err_too_early",too_large:"ws_err_too_large",too_many:"ws_err_too_many",too_many_views:"ws_err_too_many_views",unauthorized:"ws_err_unauthorized",unavailable:"ws_err_unavailable"},yn={entry_id:"object",name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",warranty_expiry:"warranty_expiry_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_equals:"trigger_equals",trigger_not_equals:"trigger_not_equals",trigger_for_minutes:"trigger_for_minutes"};Lr=s=>s.toLowerCase().split(/[^a-z0-9]+/).filter(r=>r.length>1)});var ii,et,ri=w(()=>{"use strict";ii=["notes","cost","duration","photo","user"],et={notes:"notes_label",cost:"cost",duration:"duration",photo:"photo_label",user:"user_label"}});function yt(s){if(!s)return[];let r=[],e=s.photo_doc_id;typeof e=="string"&&r.push(e);let t=s.photo_doc_ids;Array.isArray(t)&&r.push(...t);let i=[];for(let a of r){if(typeof a!="string")continue;let l=a.trim();if(!(!l||i.includes(l))&&(i.push(l),i.length>=10))break}return i}var xt=w(()=>{"use strict"});async function En(s,r,e,t){let i=new FormData;i.append("entry_id",r);for(let u of t)i.append("tags",u);i.append("file",e,e.name);let a=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${s.auth?.data?.access_token??""}`},body:i});if(a.status===413)throw new Error("doc_too_large");if(!a.ok)throw new Error("doc_upload_failed");let l=await a.json();if(!l.id)throw new Error("doc_upload_failed");return{id:l.id,deduped:!!l.deduped,duplicate_in_object:l.duplicate_in_object??null}}async function Nr(s,r,e){return(await En(s,r,e,["photo"])).id}async function si(s,r){await Promise.all(r.map(e=>s.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:e}).catch(()=>{})))}var Hr=w(()=>{"use strict";xt()});var Re,ni=w(()=>{"use strict";C();Hr();Re=class{constructor(r,e){this.host=r;this.opts=e;this.photos=[];this.uploadedIds=[];this.uploading=!1;this.errorKey="";this.max=e.max??10,r.addController(this)}hostConnected(){}get ids(){return this.photos.map(r=>r.id)}get remaining(){return Math.max(this.max-this.photos.length,0)}get full(){return this.remaining===0}errorText(r){return this.errorKey?n(this.errorKey,r).replace("{max}",String(this.max)):""}clearError(){this.errorKey=""}reset(r=[]){this._revokeAll(),this.photos=r.map(e=>({id:e,preview:""})),this.uploadedIds=[],this.uploading=!1,this.errorKey="",this.host.requestUpdate()}async addFiles(r){if(r.length===0)return;let e=r.slice(0,this.remaining);this.uploading=!0,this.errorKey="",this.host.requestUpdate();try{for(let t of e){let i=await Nr(this.opts.hass(),this.opts.entryId(),t);this.uploadedIds=[...this.uploadedIds,i],this.photos=[...this.photos,{id:i,preview:URL.createObjectURL(t)}],this.host.requestUpdate()}r.length>e.length&&(this.errorKey="photos_limit")}catch(t){this.errorKey=t instanceof Error&&t.message==="doc_too_large"?"doc_too_large":"doc_upload_failed"}finally{this.uploading=!1,this.host.requestUpdate()}}remove(r){let e=this.photos.find(t=>t.id===r);e?.preview&&URL.revokeObjectURL(e.preview),this.photos=this.photos.filter(t=>t.id!==r),this.uploadedIds.includes(r)&&(this.uploadedIds=this.uploadedIds.filter(t=>t!==r),si(this.opts.hass(),[r])),this.host.requestUpdate()}discardOrphans(){if(this.uploadedIds.length===0)return;let r=this.uploadedIds;this.uploadedIds=[],si(this.opts.hass(),r)}markAttached(){this.uploadedIds=[]}_revokeAll(){for(let r of this.photos)r.preview&&URL.revokeObjectURL(r.preview)}}});function Sn(s){let e=F("2001-02-03",s).match(/\d+/g)||[],t=u=>e.findIndex(h=>Number(h)===u),i=t(2001),a=t(2),l=t(3);return i===0?"YMD":a>=0&&l>=0&&a<l?"MDY":"DMY"}function Pe(s,r,e){if(s<1e3||s>9999||r<1||r>12||e<1||e>31)return null;let t=new Date(s,r-1,e);return t.getFullYear()!==s||t.getMonth()!==r-1||t.getDate()!==e?null:`${s}-${String(r).padStart(2,"0")}-${String(e).padStart(2,"0")}`}function Or(s,r){let e=s.trim(),t;if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})$/))return Pe(+t[1],+t[2],+t[3]);if(t=e.match(/^(\d{4})$/))return Pe(+t[1],1,1);if(t=e.match(/^(\d{1,2})[./](\d{4})$/))return Pe(+t[2],+t[1],1);if(t=e.match(/^(\d{1,2})\.(\d{1,2})\.(\d{4})$/))return Pe(+t[3],+t[2],+t[1]);if(t=e.match(/^(\d{1,2})[/-](\d{1,2})[/-](\d{4})$/)){let i=+t[1],a=+t[2],l=+t[3];return Sn(r)==="MDY"?Pe(l,i,a):Pe(l,a,i)}return null}var qr=w(()=>{"use strict";C()});function Tn(s,r){if(r)switch(s){case"date":return r.split("T")[0];case"time":return r.length===5?`${r}:00`:r;case"datetime":{let[e,t="00:00:00"]=r.split("T");return`${e} ${t.length===5?`${t}:00`:t}`}}}function An(s,r){if(typeof r!="string"||!r)return"";switch(s){case"date":return r.slice(0,10);case"time":return r.slice(0,5);case"datetime":{let[e,t="00:00:00"]=r.split(" ");return`${e}T${t.length===5?`${t}:00`:t}`}}}var M,Le=w(()=>{"use strict";I();q();C();qr();M=class extends E{constructor(){super(...arguments);this.kind="date";this.label="";this.value="";this.clearable=!1;this.disabled=!1;this.required=!1;this.lang="en";this._typing=!1;this._typed="";this._typedInvalid=!1}_startTyping(){this._typed=this.value,this._typedInvalid=!1,this._typing=!0,this.updateComplete.then(()=>this.shadowRoot?.querySelector("input.typed")?.focus())}_commitTyped(){if(!this._typed.trim()){this._typing=!1;return}let e=Or(this._typed,this.lang);if(!e){this._typedInvalid=!0;return}this._typing=!1,this._typedInvalid=!1,this._emit(e)}_onTypedKey(e){e.key==="Enter"?(e.preventDefault(),this._commitTyped()):e.key==="Escape"&&(e.preventDefault(),this._typing=!1,this._typedInvalid=!1)}_selector(){switch(this.kind){case"date":return{date:{}};case"time":return{time:{no_second:!0}};case"datetime":return{datetime:{}}}}_onSelectorChange(e){e.stopPropagation(),this._emit(An(this.kind,e.detail?.value))}_clear(){this._emit("")}_emit(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{bubbles:!0,composed:!0,detail:{value:e}})))}render(){return o`
      <div class="field">
        ...
        ${this._typedInvalid?o`<span class="helper invalid">${n("date_type_invalid",this.lang)}</span>`:this.helper?o`<span class="helper">${this.helper}</span>`:d}
      </div>
    `}};M.styles=k`
    :host { display: block; }
    .field {
  ...
  `,c([v({attribute:!1})],M.prototype,"hass",2),c([v()],M.prototype,"kind",2),c([v()],M.prototype,"label",2),c([v()],M.prototype,"value",2),c([v()],M.prototype,"helper",2),c([v({type:Boolean})],M.prototype,"clearable",2),c([v({type:Boolean})],M.prototype,"disabled",2),c([v({type:Boolean})],M.prototype,"required",2),c([v()],M.prototype,"lang",2),c([p()],M.prototype,"_typing",2),c([p()],M.prototype,"_typed",2),c([p()],M.prototype,"_typedInvalid",2);customElements.get("ms-date-field")||customElements.define("ms-date-field",M)});function wt(){if(window.externalApp!==void 0)return!0;let r=typeof navigator<"u"&&navigator.userAgent||"";return/Home Assistant\//.test(r)&&/Android/.test(r)}var ai=w(()=>{"use strict"});function tt(s){try{return localStorage.getItem(s)}catch{return null}}function it(s,r){try{localStorage.setItem(s,r)}catch{}}var he,oi=w(()=>{"use strict";he={objectSections:"msp-object-sections",printOptions:"msp-print-options",batteryRosterOpen:"msp-bf-roster-open",docSort:"msp-doc-sort",cameraDevice:"msp-camera-device",overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view",objectsCache:"msp-objects-cache",gettingStartedDismissed:"msp-gs-dismissed",batteryRosterSort:"ms_bf_roster_sort"}});function Dr(){if(!wt())return!1;let s=typeof navigator<"u"?navigator.mediaDevices:void 0;return!!s&&typeof s.getUserMedia=="function"}var Cn,In,Z,li=w(()=>{"use strict";I();q();C();ai();oi();Cn=1920,In=.88,Z=class extends E{constructor(){super(...arguments);this.lang="en";this._open=!1;this._busy=!1;this._devices=[];this._deviceIndex=-1;this._switchFailed=!1;this._facing="environment";this._stream=null}async open(){if(this._open)return;let e=typeof navigator<"u"?navigator.mediaDevices:void 0;if(!e||typeof e.getUserMedia!="function"){this._unavailable("no_media_devices");return}let t=tt(he.cameraDevice),i=!1;if(t)try{this._stream=await e.getUserMedia({video:{deviceId:{exact:t}},audio:!1}),i=!0}catch{}if(!i){try{this._stream=await e.getUserMedia({video:{facingMode:{ideal:"environment"},zoom:1,advanced:[{zoom:1}]},audio:!1})}catch(l){this._unavailable(l instanceof Error?l.name||l.message:String(l));return}await this._preferMainBackCamera(e)}await this._applyZoomOne(),await this._listDevices(e),this._deviceIndex=this._indexOfCurrent(t&&i?t:null),this._switchFailed=!1,this._facing=this._stream?.getVideoTracks()[0]?.getSettings().facingMode??"environment",this._open=!0,await this.updateComplete;let a=this._video;if(a&&this._stream){a.srcObject=this._stream;try{await a.play()}catch{}}}async _preferMainBackCamera(e){if(typeof e.enumerateDevices!="function")return;let t=[];try{t=await e.enumerateDevices()}catch{return}let i=h=>{let _=/camera2?\s*(\d+)/i.exec(h.label);return _?Number(_[1]):Number.MAX_SAFE_INTEGER},a=t.filter(h=>h.kind==="videoinput"&&h.deviceId&&/back|rear|environment|rück|hinten/i.test(h.label)).sort((h,_)=>i(h)-i(_)),u=this._stream?.getVideoTracks()[0]?.getSettings().deviceId;if(a.length>1&&a[0].deviceId!==u)try{let h=await e.getUserMedia({video:{deviceId:{exact:a[0].deviceId}},audio:!1});for(let _ of this._stream?.getTracks()??[])_.stop();this._stream=h}catch{}}async _applyZoomOne(){let e=this._stream?.getVideoTracks()[0],t=e&&typeof e.getCapabilities=="function"?e.getCapabilities():void 0;if(!(!t?.zoom||typeof t.zoom.min!="number"||t.zoom.min>=1||(t.zoom.max??1)<1))for(let i of[{zoom:1},{advanced:[{zoom:1}]}])try{await e.applyConstraints(i);return}catch{}}_indexOfCurrent(e){let t=this._devices.map(a=>a.deviceId),i=this._currentDeviceId;for(let a of[e,i])if(a){let l=t.indexOf(a);if(l>=0)return l}return-1}async _listDevices(e){if(typeof e.enumerateDevices=="function")try{this._devices=(await e.enumerateDevices()).filter(t=>t.kind==="videoinput"&&!!t.deviceId)}catch{this._devices=[]}}get _currentDeviceId(){return this._stream?.getVideoTracks()[0]?.getSettings().deviceId}async _switchCamera(){let e=typeof navigator<"u"?navigator.mediaDevices:void 0;if(!e||this._devices.length<2||this._busy)return;let t=this._devices.map(i=>i.deviceId);this._busy=!0;try{for(let a=1;a<t.length;a++){let l=(this._deviceIndex+a)%t.length,u=t[l];if(!(u===this._currentDeviceId&&this._deviceIndex<0))try{let h=await e.getUserMedia({video:{deviceId:{exact:u}},audio:!1});for(let m of this._stream?.getTracks()??[])m.stop();this._stream=h,this._deviceIndex=l,this._switchFailed=!1,await this._applyZoomOne(),it(he.cameraDevice,u);let _=this._video;if(_){_.srcObject=h;try{await _.play()}catch{}}return}catch{}}let i=this._facing==="user"?"environment":"user";for(let a of[{exact:i},{ideal:i}])try{let l=await e.getUserMedia({video:{facingMode:a},audio:!1});for(let h of this._stream?.getTracks()??[])h.stop();this._stream=l,this._facing=i,this._deviceIndex=this._indexOfCurrent(null),this._switchFailed=!1,await this._applyZoomOne();let u=this._video;if(u){u.srcObject=l;try{await u.play()}catch{}}return}catch{}this._switchFailed=!0}finally{this._busy=!1}}close(){this._stopStream(),this._open=!1,this._busy=!1}disconnectedCallback(){super.disconnectedCallback(),this._stopStream()}get _video(){return this.shadowRoot?.querySelector("video")??null}_stopStream(){for(let t of this._stream?.getTracks()??[])t.stop();this._stream=null;let e=this._video;e&&(e.srcObject=null)}_unavailable(e){this._stopStream(),this._open=!1,this.dispatchEvent(new CustomEvent("capture-unavailable",{detail:{reason:e},bubbles:!0,composed:!0}))}async _shoot(){let e=this._video;if(!(!e||this._busy)){this._busy=!0;try{let t=e.videoWidth||640,i=e.videoHeight||480,a=Math.min(1,Cn/Math.max(t,i)),l=document.createElement("canvas");l.width=Math.round(t*a),l.height=Math.round(i*a);let u=l.getContext("2d");if(!u)throw new Error("no_canvas");u.drawImage(e,0,0,l.width,l.height);let h=await new Promise(b=>l.toBlob(b,"image/jpeg",In));if(!h)throw new Error("no_blob");let _=new Date().toISOString().replace(/[-:]/g,"").slice(0,15),m=new File([h],`photo-${_}.jpg`,{type:"image/jpeg"});this.close(),this.dispatchEvent(new CustomEvent("photo-captured",{detail:{file:m},bubbles:!0,composed:!0}))}catch(t){this._unavailable(t instanceof Error?t.message:String(t))}finally{this._busy=!1}}}render(){if(!this._open)return d;let e=this.lang;return o`
      <div class="overlay" role="dialog" aria-modal="true" aria-label=${n("doc_camera",e)}>
        <video autoplay playsinline muted></video>
        ${this._switchFailed?o`<div class="switch-note" role="status">${n("camera_switch_failed",e)}</div>`:d}
        <div class="bar">
  ...
  `,c([v({type:String})],Z.prototype,"lang",2),c([p()],Z.prototype,"_open",2),c([p()],Z.prototype,"_busy",2),c([p()],Z.prototype,"_devices",2),c([p()],Z.prototype,"_deviceIndex",2),c([p()],Z.prototype,"_switchFailed",2);customElements.get("ms-camera-capture")||customElements.define("ms-camera-capture",Z)});var $t,W,rt=w(()=>{"use strict";I();q();C();ai();li();li();$t=k`
...
`,W=class extends E{constructor(){super(...arguments);this.lang="en";this.disabled=!1;this.busy=!1;this.accept="image/*";this.showCamera=!0;this.showGallery=!0;this.compact=!1;this.remaining=1/0;this._singlePick=wt();this._inAppCamera=Dr()}createRenderRoot(){return this}get _locked(){return this.disabled||this.busy}_emit(e){e.length!==0&&this.dispatchEvent(new CustomEvent("files-picked",{detail:{files:e},bubbles:!0,composed:!0}))}_onInput(e){let t=e.target,i=Array.from(t.files??[]);t.value="",this._emit(i)}_onCameraClick(e){!this._inAppCamera||this._locked||(e.preventDefault(),this.querySelector("ms-camera-capture")?.open())}_onCameraUnavailable(){this._inAppCamera=!1,this.querySelector(".photo-pick-camera input")?.click()}_onKeydown(e){e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),!this._locked&&e.currentTarget.click())}render(){if(this.remaining<=0||!this.showCamera&&!this.showGallery)return d;let e=this.lang,t=this._locked?"disabled":"",i=this.busy?n("uploading",e):n("doc_camera",e),a=n(this._singlePick?"choose_photo":"choose_photos",e);return o`
      <div class="photo-pickers">
        ${this.showCamera?o`<label class="photo-pick photo-pick-camera ${t}" role="button" tabindex="0"
              aria-label=${i} title=${this.compact?i:d}
              @click=${this._onCameraClick} @keydown=${this._onKeydown}>
              <ha-icon icon="mdi:camera"></ha-icon>
              ${this.compact?d:o`<span>${i}</span>`}
    ...
    >${n("cost_from_parts",e).replace("{amount}",i)}</button>`}_close(){this._open=!1,this._photos.discardOrphans()}_pickCompletedAt(){let e=new Date,t=i=>String(i).padStart(2,"0");this._completedAt=`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}T${t(e.getHours())}:${t(e.getMinutes())}:00`}render(){if(!this._open)return o``;let e=this.lang||this.hass?.language||"en",t=this._error||this._photos.errorText(e);return o`
      <ha-dialog open @closed=${this._close}>
        ...
        ${this.phaseLabel?o`<div class="phase-line">${n("phase_current",e)}: ${this.phaseLabel}</div>`:d}
        ${this.requireTagScan&&!this.viaTagScan?o`<div class="scan-required-note">${n("require_tag_scan_hint",e)}</div>`:d}
        <div class="content">
          ${t?o`<div class="error">${t}</div>`:d}
                ...
                ${this.parts.map(i=>{let a=Q({part_id:i.id,entry_id:i.entry_id}),l=this._usedParts[a],u=l!==void 0,h=i.entry_id?{part_id:i.id,quantity:1,entry_id:i.entry_id}:{part_id:i.id,quantity:1};return o`<div class="used-part-row">
                    <label class="used-part-check">
                      <input type="checkbox" .checked=${u}
                        @change=${_=>{let m={...this._usedParts};_.target.checked?m[a]=m[a]||h:delete m[a],this._usedParts=m}} />
                      <span
                        >${i.name}${i.owner_name?o`<span class="used-part-owner"> (${i.owner_name})</span>`:d}${i.stock!==null&&i.stock!==void 0?` (${i.stock}${i.unit?" "+i.unit:""})`:""}</span
                      >
                    </label>
                    ${u?o`<input class="used-part-qty" type="number" min="0.01" max="999" step="0.01"
                          .value=${String(l.quantity)}
                          @input=${_=>{let m=parseFloat(_.target.value);this._usedParts={...this._usedParts,[a]:{...h,quantity:Number.isFinite(m)&&m>=.01?m:1}}}} />`:d}
                  </div>`})}
  ...
  `],c([v({attribute:!1})],S.prototype,"hass",2),c([v()],S.prototype,"entryId",2),c([v()],S.prototype,"taskId",2),c([v()],S.prototype,"taskName",2),c([v()],S.prototype,"lang",2),c([v({type:Array})],S.prototype,"checklist",2),c([v({type:Boolean})],S.prototype,"adaptiveEnabled",2),c([v()],S.prototype,"taskType",2),c([v()],S.prototype,"readingUnit",2),c([v({attribute:!1})],S.prototype,"readings",2),c([v({attribute:!1})],S.prototype,"readingHistory",2),c([v({attribute:!1})],S.prototype,"restockDefault",2),c([v({attribute:!1})],S.prototype,"restockUnitCost",2),c([v()],S.prototype,"currencySymbol",2),c([v({attribute:!1})],S.prototype,"parts",2),c([v({attribute:!1})],S.prototype,"consumesParts",2),c([v({type:Array})],S.prototype,"consumesInfo",2),c([v({type:Array})],S.prototype,"requiredFields",2),c([v()],S.prototype,"phaseLabel",2),c([v({type:Boolean})],S.prototype,"requireTagScan",2),c([v({type:Boolean})],S.prototype,"viaTagScan",2),c([p()],S.prototype,"_open",2),c([p()],S.prototype,"_notes",2),c([p()],S.prototype,"_cost",2),c([p()],S.prototype,"_duration",2),c([p()],S.prototype,"_loading",2),c([p()],S.prototype,"_error",2),c([p()],S.prototype,"_checklistState",2),c([p()],S.prototype,"_feedback",2),c([p()],S.prototype,"_readingValue",2),c([p()],S.prototype,"_readingValues",2),c([p()],S.prototype,"_restockQty",2),c([p()],S.prototype,"_completedAt",2),c([p()],S.prototype,"_usedParts",2),c([v({attribute:!1})],S.prototype,"checklistPrefill",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",S)});function T(s){return s.toFixed(1)}var kt=w(()=>{"use strict";C()});var D,pi=w(()=>{"use strict";I();q();D=class extends E{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return o`
      <label class="field">
        ${this.label?o`<span class="label">${this.label}${this.required?o`<span class="req">*</span>`:d}</span>`:d}
        ${this.multiline?o`
        <textarea
...
`),partId:A?.part_id||"",partQty:A?.quantity!=null?String(A.quantity):"",reqOverride:m.required_completion_fields!==void 0,reqFields:[...m.required_completion_fields||[]],extraParts:z.filter((H,we)=>we!==L).map(H=>({...H})),carry:$}}),this._phaseSeq=[...t.phase_sequence||[]],this._requiredCompletion=[...t.required_completion_fields||[]],this._scheduleTime=t.schedule_time||"",this._scheduleTimeOn=!!t.schedule_time;let l=t.on_complete_action;if(l&&l.service){this._actionService=l.service;let _=l.target?.entity_id;this._actionTargetEntity=Array.isArray(_)?_[0]||"":_||"",this._actionData=l.data&&typeof l.data=="object"?{...l.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let u=t.quick_complete_defaults;this._qcNotes=u?.notes||"",this._qcCost=u?.cost!=null?String(u.cost):"",this._qcDuration=u?.duration!=null?String(u.duration):"",this._qcFeedback=u?.feedback||"";let h=t.adaptive_config||{};if(this._environmentalEntity=h.environmental_entity||"",this._environmentalAttribute=h.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,this._adaptiveEnabled=!!h.enabled,this._adaptiveAlpha=h.ewa_alpha?.toString()??se.alpha,this._adaptiveMin=h.min_interval_days?.toString()??se.min,this._adaptiveMax=h.max_interval_days?.toString()??se.max,this._adaptiveSeasonal=h.seasonal_enabled!==!1,this._adaptivePrediction=h.sensor_prediction_enabled!==!1,this._adaptiveInitial=this._adaptiveSnapshot(),t.trigger_config){let _=t.trigger_config;this._triggerEntityId=_.entity_id||_.entity_ids&&_.entity_ids[0]||"",this._triggerEntityIds=_.entity_ids||(_.entity_id?[_.entity_id]:[]),this._triggerEntityLogic=_.entity_logic||"any",this._triggerAttribute=_.attribute||"",this._triggerType=_.type||"threshold",this._triggerAbove=_.trigger_above?.toString()||"",this._triggerBelow=_.trigger_below?.toString()||"",this._triggerEquals=_.trigger_equals?.toString()||"",this._triggerNotEquals=_.trigger_not_equals?.toString()||"",this._triggerForMinutes=_.trigger_for_minutes?.toString()||"0",this._triggerCombinator=_.trigger_combinator==="all"?"all":"any",this._triggerTargetValue=_.trigger_target_value?.toString()||"",this._triggerDeltaMode=_.trigger_delta_mode||!1,this._triggerBaselineValue=_.trigger_baseline_value?.toString()||"",this._liveBaselineValue=t.trigger_baseline_value??null,this._autoCompleteOnRecovery=_.auto_complete_on_recovery||!1,this._triggerFromState=_.trigger_from_state||"",this._triggerToState=_.trigger_to_state||"",this._triggerTargetChanges=_.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=_.trigger_runtime_hours?.toString()||"",this._triggerRuntimeMaxSession=_.trigger_runtime_max_session_seconds?.toString()||"",this._triggerOnStates=(_.trigger_on_states||[]).join(", "),_.type==="compound"?(this._compoundLogic=_.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(_.conditions||[]).map(Mn)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._notifyIcon="",this._priority="normal",this._labels="",this._mirrorTodoEntities=[],this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._requireTagScan=!1,this._allowSkip=!0,this._readingUnit="",this._readings=[],this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._phaseDefs=[],this._phaseSeq=[],this._requiredCompletion=[],this._scheduleTime="",this._scheduleTimeOn=!1,this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._adaptiveEnabled=!1,this._adaptiveAlpha=se.alpha,this._adaptiveMin=se.min,this._adaptiveMax=se.max,this._adaptiveSeasonal=!0,this._adaptivePrediction=!0,this._adaptiveInitial=this._adaptiveSnapshot(),this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerEquals="",this._triggerNotEquals="",this._triggerForMinutes="0",this._triggerCombinator="any",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerRuntimeMaxSession="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new Ie(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}_toggleAssignee(e){this._assigneePool=this._assigneePool.includes(e)?this._assigneePool.filter(t=>t!==e):[...this._assigneePool,e]}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[t,i]=e.split(".");if(!this.hass?.services?.[t]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let a=this._actionTargetEntity.trim();if(a){let l=a.split(".")[0];if(l!==t&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(t)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${t}.* entities; entity "${a}" is in ${l}.* \u2014 pick a service that matches the entity domain (e.g. ${l}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[a]){this._actionTestResult="error",this._actionTestError=`Target entity "${a}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,i]=e.split("."),a=this.hass?.services?.[t]?.[i]?.fields;return!a||Object.keys(a).length===0?null:Object.entries(a).map(([l,u])=>({name:l,required:!!u.required,selector:u.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return d;let t=this._serviceSchema();return o`
      <details class="ca-section">
        ...
        <div class="ca-test-row">
          ...
          ${this._actionTestResult==="ok"?o`<span class="ca-test-ok">${n("on_complete_action_test_success",e)}</span>`:d}
    ...
    `}_toggleRequired(e,t){let i=new Set(this._requiredCompletion);t?i.add(e):i.delete(e),this._requiredCompletion=[...i]}_patchReading(e,t){this._readings=this._readings.map(i=>i.id===e?{...i,...t}:i)}_renderReadingsEditor(e){let t=Ar(this._readings);return o`
      <div class="readings-editor">
        ...
        ${this._readings.map(i=>o`
          ${t.has(i.id)?o`<div class="field-help reading-dup">${n("reading_duplicate_name",e)}</div>`:d}
        ...
        ${this._readings.length<20?o`
          <ha-button appearance="plain" class="reading-add"
            @click=${()=>this._readings=[...this._readings,{id:$r(),name:"",unit:this._readings.length?this._readings[this._readings.length-1].unit:this._readingUnit}]}>
...
`).map(_=>_.trim()).filter(Boolean).slice(0,100);e.checklist=h.length?h:null}if(this.completionActionsEnabled){let h=this._actionService.trim();if(h&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(h)){let y={service:h},x=this._actionTargetEntity.trim();x&&(y.target={entity_id:x});let g=this._buildActionData();Object.keys(g).length>0&&(y.data=g),e.on_complete_action=y}else e.on_complete_action=null;let _={};this._qcNotes.trim()&&(_.notes=this._qcNotes.trim());let m=parseFloat(this._qcCost);!isNaN(m)&&m>=0&&(_.cost=m);let b=parseInt(this._qcDuration,10);!isNaN(b)&&b>=0&&(_.duration=b),this._qcFeedback&&(_.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(_).length?_:null}let i=await this.hass.connection.sendMessagePromise(e),a=this._taskId||i?.task_id,l=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;this._warning="";let u=h=>{this._warning=n("subsave_warning",this._lang).replace("{detail}",h)};if(a&&this._scheduleType==="sensor_based"&&l&&await ui(this,{type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null},{onError:u})!==void 0&&(this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute),a&&this._adaptiveSnapshot()!==this._adaptiveInitial){let h=parseFloat(this._adaptiveAlpha),_=parseInt(this._adaptiveMin,10),m=parseInt(this._adaptiveMax,10);await ui(this,{type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:a,enabled:this._adaptiveEnabled,...h>=.1&&h<=.9?{ewa_alpha:h}:{},...!isNaN(_)&&_>=1?{min_interval_days:_}:{},...!isNaN(m)&&m>=1?{max_interval_days:m}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction},{onError:u})!==void 0&&(this._adaptiveInitial=this._adaptiveSnapshot())}this._warning?a&&(this._taskId=a):this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=R(e,this._lang,n("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._warning="",this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return d;let e=this._lang,t=this._triggerType==="compound";return o`
      ...
      ${this._intervalDays?o`
          ...
          `:d}
    `}_patchCondition(e,t){this._compoundConditions=this._compoundConditions.map((i,a)=>a===e?{...i,...t}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,qn()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((t,i)=>i!==e)}_renderCompoundEditor(){let e=this._lang;return o`
      <div class="select-row">
    ...
    `}_renderCondition(e,t){let i=this._lang,a=t+1;return o`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${Kr.map(l=>o`<option value=${l} ?selected=${l===e.type}>${n(l,i)}</option>`)}
          </select>
        </div>
    ...
    `}_renderOnStatesField(e){let t=this._lang;return this._entityPickerFallback||!e.entityId?o`
      ...
      ></ha-form>
    `}_renderAdaptiveSection(e){return this._scheduleType==="one_time"||this._scheduleType==="manual"?d:o`
    ...
    `}_renderEnvironmentalAttribute(e){this._fetchConditionAttributes(this._environmentalEntity);let t=this._conditionAttrOptions[this._environmentalEntity];return this._renderAttributeSelect({label:n("environmental_attribute_optional",e),value:this._environmentalAttribute,suggested:t?.suggested??[],available:t?.available??[],onSelect:i=>this._environmentalAttribute=i})}_renderConditionAttribute(e,t){let i=e.entityIds.split(",")[0]?.trim()||"";i&&this._fetchConditionAttributes(i);let a=i?this._conditionAttrOptions[i]:void 0;return this._renderAttributeSelect({label:n("attribute_optional",this._lang),value:e.attribute,suggested:a?.suggested??[],available:a?.available??[],onSelect:l=>this._patchCondition(t,{attribute:l})})}_renderConditionTypeFields(e,t){let i=this._lang;if(e.type==="threshold")return o`
      ...
      `}return d}_renderUnitSelect(){let e=this._lang;return o`
      <div class="select-row">
    ...
    `}_buildSchedule(){let e=i=>{let a=parseInt(this._calOffset,10)||0;return a&&(i.offset=Math.max(-15,Math.min(a,15))),i};if(this._scheduleType==="weekdays")return e({kind:"weekdays",weekdays:[...this._weekdays].sort((i,a)=>i-a)});if(this._scheduleType==="nth_weekday")return e({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});if(this._scheduleType==="calendar")return e({kind:"calendar",entity_id:this._calendarEntity.trim()});let t={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(t.business=!0),e(t)}_recurrenceExtras(){let e={};if(this._seasonMonths.length&&(e.season_months=[...this._seasonMonths].sort((t,i)=>t-i)),this._endsMode==="count"){let t=parseInt(this._endsCount,10);t>=1&&(e.ends={count:t})}else this._endsMode==="until"&&this._endsUntil&&(e.ends={until:this._endsUntil});return e}_toggleSeasonMonth(e){this._seasonMonths=this._seasonMonths.includes(e)?this._seasonMonths.filter(t=>t!==e):[...this._seasonMonths,e]}_renderRecurrenceExtras(){let e=this._lang;if(!(this._scheduleType==="time_based"||Et.includes(this._scheduleType)))return d;let i=Un(e);return o`
      ...
      ${this._endsMode==="until"?o`
        ...
        ></ms-date-field>`:d}
    `}_renderCalendarFields(){let e=this._lang,t=Fn(e);if(this._scheduleType==="weekdays")return o`
        ...
        ${this._renderCalOffsetField()}`:d}_renderCalOffsetField(){let e=this._lang;return o`
      <ms-textfield
      ...
      ></ms-textfield>`}_thresholdLimitsOverlap(){let e=parseFloat(this._triggerAbove),t=parseFloat(this._triggerBelow);return!isNaN(e)&&!isNaN(t)&&t>e}_renderTriggerLiveHint(){if(this._triggerType==="compound")return d;let e=this._triggerType==="threshold"&&this._thresholdLimitsOverlap()?o`<div class="trigger-live-hint warn">${n("trigger_hint_overlap",this._lang)}</div>`:d,t=this._triggerEntityId||this._triggerEntityIds[0];if(!t||!this.hass?.states)return e;let i=this.hass.states[t];if(!i)return e;let a=this._lang,l=i.attributes?.unit_of_measurement,u=typeof l=="string"&&l?` ${l}`:"",h=this._triggerAttribute?i.attributes?.[this._triggerAttribute]:i.state,_=typeof h=="number"?h:parseFloat(String(h)),m=h!=="unknown"&&h!=="unavailable"&&h!=null&&!isNaN(_),b=x=>O(x,a,{maximumFractionDigits:1}),y=[];if(this._triggerType==="threshold"){let x=parseFloat(this._triggerAbove),g=parseFloat(this._triggerBelow);if(isNaN(x)&&isNaN(g))return d;m&&y.push(n("trigger_hint_now",a).replace("{value}",b(_)+u)),isNaN(x)||y.push(n("trigger_hint_above",a).replace("{target}",b(x)+u)),isNaN(g)||y.push(n("trigger_hint_below",a).replace("{target}",b(g)+u))}else if(this._triggerType==="counter"){let x=parseFloat(this._triggerTargetValue);if(isNaN(x))return d;this._triggerDeltaMode?this._taskId?y.push(n("trigger_hint_counter_delta_edit",a).replace("{target}",b(x)+u)):m?y.push(n("trigger_hint_counter_delta",a).replace("{value}",b(_)+u).replace("{due}",b(_+x)+u).replace("{target}",b(x)+u)):y.push(n("trigger_hint_counter_delta_edit",a).replace("{target}",b(x)+u)):(m&&y.push(n("trigger_hint_now",a).replace("{value}",b(_)+u)),y.push(n("trigger_hint_counter_abs",a).replace("{target}",b(x)+u)))}else if(this._triggerType==="runtime"){let x=parseFloat(this._triggerRuntimeHours);if(isNaN(x))return d;y.push(n("trigger_hint_runtime",a).replace("{hours}",b(x))),y.push(n("trigger_hint_state_now",a).replace("{value}",String(i.state)))}else if(this._triggerType==="state_change"){let x=parseInt(this._triggerTargetChanges,10)||1,g=this._triggerToState.trim();y.push((g?n("trigger_hint_state_change_to",a).replace("{state}",g):n("trigger_hint_state_change",a)).replace("{count}",String(x))),y.push(n("trigger_hint_state_now",a).replace("{value}",String(i.state)))}return y.length?o`<div class="trigger-live-hint">${y.join(" ")}</div>${e}`:e}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?o`
        <ms-textfield
      ...
      `:this._triggerType==="state_change"?o`
        ...
        ${(this._triggerTargetChanges||"1")==="1"&&(this._triggerFromState||this._triggerToState)?o`<div class="field-help">${n("state_latch_help",e)}</div>`:d}
        <ms-textfield
          label="${n("for_at_least_minutes",e)}"
          type="number"
          min="0"
      ...
      `:d}render(){if(!this._open)return o``;let e=this._lang,t=this._taskId?n("edit_task",e):n("new_task",e);return o`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._error?o`<div class="error">${this._error}</div>`:d}
          ${this._warning?o`<div class="error warning">${this._warning}</div>`:d}
          ...
          <div class="select-row">
            ...
            >
              ${jn.map(i=>o`<option value=${i} ?selected=${i===this._type}>${n(i,e)}</option>`)}
            </select>
          </div>
          ${this._type==="reading"?o`
              ...
              `:d}
          ${this._partsLoadFailed?o`<div class="field-help parts-load-failed">${n("parts_load_failed",e)}</div>`:d}
          ...
          <div class="select-row">
            ...
            >
              ${Hn.map(i=>o`<option value=${i} ?selected=${i===this._scheduleType}>${n(i,e)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="one_time"?o`
                ...
                ></ms-date-field>
              `:d}
          ${this.scheduleTimeEnabled&&Wr.includes(this._scheduleType)?o`
          ...
          ${this._scheduleType==="sensor_based"?o`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:zr,device_class:Fr}}}]}
            ...
            ></ha-form>`}
            ${this._environmentalEntity?this._renderEnvironmentalAttribute(e):d}
          `:d}
          ...
          ${this._requireTagScan?o`<div class="field-help">${n("require_tag_scan_help",e)}</div>`:d}
          <label class="req-option">
            <input
              type="checkbox"
          ...
          ${this._allowSkip?d:o`<div class="field-help">${n("disallow_skip_help",e)}</div>`}
          <label class="req-option">
            <input
              type="checkbox"
          ...
          ${this._notifyEnabled?d:o`<div class="field-help">${n("no_notifications_help",e)}</div>`}
  ...
  `,c([v({attribute:!1})],f.prototype,"hass",2),c([v({type:Boolean,attribute:"checklists-enabled"})],f.prototype,"checklistsEnabled",2),c([v({type:Boolean,attribute:"schedule-time-enabled"})],f.prototype,"scheduleTimeEnabled",2),c([v({type:Boolean,attribute:"completion-actions-enabled"})],f.prototype,"completionActionsEnabled",2),c([v({type:Number,attribute:"default-warning-days"})],f.prototype,"defaultWarningDays",2),c([p()],f.prototype,"parts",2),c([p()],f.prototype,"_foreignOwners",2),c([p()],f.prototype,"_open",2),c([p()],f.prototype,"_entityPickerFallback",2),c([p()],f.prototype,"_loading",2),c([p()],f.prototype,"_error",2),c([p()],f.prototype,"_warning",2),c([p()],f.prototype,"_entryId",2),c([p()],f.prototype,"_taskId",2),c([p()],f.prototype,"_isFleetTask",2),c([p()],f.prototype,"_objectChoices",2),c([p()],f.prototype,"_name",2),c([p()],f.prototype,"_type",2),c([p()],f.prototype,"_scheduleType",2),c([p()],f.prototype,"_intervalDays",2),c([p()],f.prototype,"_intervalUnit",2),c([p()],f.prototype,"_dueDate",2),c([p()],f.prototype,"_warningDays",2),c([p()],f.prototype,"_earliestCompletionDays",2),c([p()],f.prototype,"_intervalAnchor",2),c([p()],f.prototype,"_weekdays",2),c([p()],f.prototype,"_nth",2),c([p()],f.prototype,"_nthWeekday",2),c([p()],f.prototype,"_domDay",2),c([p()],f.prototype,"_domLastDay",2),c([p()],f.prototype,"_domBusiness",2),c([p()],f.prototype,"_calOffset",2),c([p()],f.prototype,"_calendarEntity",2),c([p()],f.prototype,"_seasonMonths",2),c([p()],f.prototype,"_endsMode",2),c([p()],f.prototype,"_endsCount",2),c([p()],f.prototype,"_endsUntil",2),c([p()],f.prototype,"_schedulePreview",2),c([p()],f.prototype,"_schedulePreviewEnded",2),c([p()],f.prototype,"_notes",2),c([p()],f.prototype,"_documentationUrl",2),c([p()],f.prototype,"_customIcon",2),c([p()],f.prototype,"_notifyIcon",2),c([p()],f.prototype,"_priority",2),c([p()],f.prototype,"_labels",2),c([p()],f.prototype,"_mirrorTodoEntities",2),c([p()],f.prototype,"_enabled",2),c([p()],f.prototype,"_triggerEntityId",2),c([p()],f.prototype,"_triggerEntityIds",2),c([p()],f.prototype,"_triggerEntityLogic",2),c([p()],f.prototype,"_triggerAttribute",2),c([p()],f.prototype,"_triggerType",2),c([p()],f.prototype,"_triggerAbove",2),c([p()],f.prototype,"_triggerBelow",2),c([p()],f.prototype,"_triggerEquals",2),c([p()],f.prototype,"_triggerNotEquals",2),c([p()],f.prototype,"_triggerForMinutes",2),c([p()],f.prototype,"_triggerCombinator",2),c([p()],f.prototype,"_triggerTargetValue",2),c([p()],f.prototype,"_triggerDeltaMode",2),c([p()],f.prototype,"_triggerBaselineValue",2),c([p()],f.prototype,"_liveBaselineValue",2),c([p()],f.prototype,"_autoCompleteOnRecovery",2),c([p()],f.prototype,"_triggerFromState",2),c([p()],f.prototype,"_triggerToState",2),c([p()],f.prototype,"_triggerTargetChanges",2),c([p()],f.prototype,"_triggerRuntimeHours",2),c([p()],f.prototype,"_triggerRuntimeMaxSession",2),c([p()],f.prototype,"_triggerOnStates",2),c([p()],f.prototype,"_compoundLogic",2),c([p()],f.prototype,"_compoundConditions",2),c([p()],f.prototype,"_suggestedAttributes",2),c([p()],f.prototype,"_availableAttributes",2),c([p()],f.prototype,"_entityDomain",2),c([p()],f.prototype,"_lastPerformed",2),c([p()],f.prototype,"_nfcTagId",2),c([p()],f.prototype,"_requireTagScan",2),c([p()],f.prototype,"_allowSkip",2),c([p()],f.prototype,"_notifyEnabled",2),c([p()],f.prototype,"_readingUnit",2),c([p()],f.prototype,"_readings",2),c([p()],f.prototype,"_consumesParts",2),c([p()],f.prototype,"_partsLoadFailed",2),c([p()],f.prototype,"_availableTags",2),c([p()],f.prototype,"_responsibleUserId",2),c([p()],f.prototype,"_assigneePool",2),c([p()],f.prototype,"_rotationStrategy",2),c([p()],f.prototype,"_availableUsers",2),c([p()],f.prototype,"_checklistText",2),c([p()],f.prototype,"_phaseDefs",2),c([p()],f.prototype,"_phaseSeq",2),c([p()],f.prototype,"_requiredCompletion",2),c([p()],f.prototype,"_scheduleTime",2),c([p()],f.prototype,"_scheduleTimeOn",2),c([p()],f.prototype,"_actionService",2),c([p()],f.prototype,"_actionTargetEntity",2),c([p()],f.prototype,"_actionData",2),c([p()],f.prototype,"_actionDataJsonFallback",2),c([p()],f.prototype,"_actionTesting",2),c([p()],f.prototype,"_actionTestResult",2),c([p()],f.prototype,"_actionTestError",2),c([p()],f.prototype,"_qcNotes",2),c([p()],f.prototype,"_qcCost",2),c([p()],f.prototype,"_qcDuration",2),c([p()],f.prototype,"_qcFeedback",2),c([p()],f.prototype,"_environmentalEntity",2),c([p()],f.prototype,"_environmentalAttribute",2),c([p()],f.prototype,"_adaptiveEnabled",2),c([p()],f.prototype,"_adaptiveAlpha",2),c([p()],f.prototype,"_adaptiveMin",2),c([p()],f.prototype,"_adaptiveMax",2),c([p()],f.prototype,"_adaptiveSeasonal",2),c([p()],f.prototype,"_adaptivePrediction",2),c([p()],f.prototype,"_conditionAttrOptions",2);mi=f;customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",mi)});var ue,gi=w(()=>{"use strict";I();q();Qt();ue=class extends E{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{this._url=await Gt(this.hass,this.docId)}catch{this._failed=!0}}render(){return this._failed||!this.docId?d:this._url?o`
  ...
  `,c([v({attribute:!1})],ue.prototype,"hass",2),c([v()],ue.prototype,"docId",2),c([p()],ue.prototype,"_url",2),c([p()],ue.prototype,"_failed",2);customElements.get("maintenance-history-photo")||customElements.define("maintenance-history-photo",ue)});var B,Gr=w(()=>{"use strict";I();q();C();re();ni();Le();gi();rt();rt();B=class extends E{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null;this._partOptions=null;this._partQty={};this._partQtyOriginal="";this._photos=new Re(this,{entryId:()=>this._draft?.entry_id??"",hass:()=>this.hass});this._photosOriginal="";this._readingRows=[];this._readingText={};this._readingsOriginal=""}get _lang(){return P(this.hass)}openEdit(e){this._draft={...e},this._originalSnapshot={...e},this._error="",this._open=!0,this._partOptions=null,this._partQty={},this._partQtyOriginal="",this._photos.reset(e.photo_doc_ids??[]),this._photosOriginal=JSON.stringify(this._photos.ids),this._seedReadings(e),this._loadPartOptions()}_seedReadings(e){let t=[],i=new Set;for(let l of e.readings??[])i.has(l.id)||(i.add(l.id),t.push({id:l.id,name:l.name,unit:l.unit??null}));for(let l of e.reading_values??[])i.has(l.id)||(i.add(l.id),t.push({id:l.id,name:l.name,unit:l.unit??null}));this._readingRows=t;let a={};for(let l of e.reading_values??[])a[l.id]=String(l.value);this._readingText=a,this._readingsOriginal=JSON.stringify(this._readingNumbers())}_readingNumbers(){let e={};for(let t of this._readingRows){let i=(this._readingText[t.id]??"").trim();if(i==="")continue;let a=parseFloat(i.replace(",","."));isNaN(a)||(e[t.id]=a)}return e}async _loadPartOptions(){let e=this._draft;if(e)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"}),i=[];for(let l of t.parts||[]){let u=l.entry_id===e.entry_id,h=l.consumers.some(_=>_.entry_id===e.entry_id&&_.task_id===e.task_id);!u&&!h||i.push({part_id:l.part_id,name:l.name,entry_id:l.entry_id,foreign:!u,object_name:l.object_name})}for(let l of e.used_parts||[]){let u=l.entry_id||e.entry_id;i.some(h=>h.part_id===l.part_id&&h.entry_id===u)||i.push({part_id:l.part_id,name:l.name||l.part_id,entry_id:u,foreign:u!==e.entry_id,object_name:null})}let a={};for(let l of e.used_parts||[])a[`${l.entry_id||e.entry_id}:${l.part_id}`]=l.quantity??1;this._partOptions=i,this._partQty=a,this._partQtyOriginal=this._partSelectionKey()}catch{this._partOptions=[]}}_partSelectionKey(){return JSON.stringify(Object.entries(this._partQty).filter(([,e])=>e>0).sort(([e],[t])=>e.localeCompare(t)))}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null,this._photos.discardOrphans()}_set(e,t){this._draft&&(this._draft={...this._draft,[e]:t})}async _delete(){if(!this._draft||!this._originalSnapshot)return;let e=this._lang;if(window.confirm(n("history_delete_confirm",e))){this._saving=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/history/delete",entry_id:this._draft.entry_id,task_id:this._draft.task_id,timestamp:this._originalSnapshot.original_timestamp}),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,deleted:!0},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=R(t,e)}finally{this._saving=!1}}}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="",this._photos.clearError();try{let e={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(e.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(e.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(e.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(e.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(e.completed_by=this._draft.completed_by),this._partOptions!==null&&this._partSelectionKey()!==this._partQtyOriginal&&(e.used_parts=(this._partOptions||[]).filter(i=>(this._partQty[`${i.entry_id}:${i.part_id}`]||0)>0).map(i=>({part_id:i.part_id,quantity:this._partQty[`${i.entry_id}:${i.part_id}`],...i.foreign?{entry_id:i.entry_id}:{}}))),this._draft.reading_value!==this._originalSnapshot.reading_value&&(e.reading_value=this._draft.reading_value??null),this._readingRows.length>0&&JSON.stringify(this._readingNumbers())!==this._readingsOriginal){let i=this._readingNumbers(),a={};for(let l of this._readingRows)a[l.id]=i[l.id]??null;e.reading_values=a}if(JSON.stringify(this._photos.ids)!==this._photosOriginal&&(e.photo_doc_ids=this._photos.ids),Object.keys(e).filter(i=>!["type","entry_id","task_id","original_timestamp"].includes(i)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(e),this._photos.markAttached(),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=R(e,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return d;let e=this._lang,t=this._draft,i=this._error||this._photos.errorText(e);return o`
    ...
    `}_renderReadings(e,t){return this._readingRows.length>0?o`
        <div class="readings-block">
          ...
          `)}
        </div>`:e.reading_value==null&&e.task_type!=="reading"?d:o`
      <label>
...
<div class="qr-row">
  <div class="qr-col">
    <img src="${Qr(this._viewResult.svg_data_uri)}" alt="QR Info" />
    <div class="qr-label">${m}</div>
  </div>
  ${_?`<div class="qr-col">
    <img src="${Qr(this._completeResult.svg_data_uri)}" alt="QR Complete" />
    <div class="qr-label">${b}</div>
  </div>`:""}
</div>
<div class="url">${Ne(this._viewResult.url)}</div>
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),a.document.close()}_downloadSvg(e,t){let i=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),a=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;yr(i,`qr-${Bn(a)}-${t}.svg`,"image/svg+xml")}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return o``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${n("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${n("qr_code",e)}: ${this._objectName}`,i=!!this._viewResult;return o`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
  ...
  `,c([v({attribute:!1})],K.prototype,"hass",2),c([v()],K.prototype,"lang",2),c([p()],K.prototype,"_open",2),c([p()],K.prototype,"_loading",2),c([p()],K.prototype,"_error",2),c([p()],K.prototype,"_viewResult",2),c([p()],K.prototype,"_completeResult",2),c([p()],K.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",K)});var Zr=w(()=>{"use strict"});function Xr(s){let r=s.getFullYear(),e=String(s.getMonth()+1).padStart(2,"0"),t=String(s.getDate()).padStart(2,"0");return`${r}-${e}-${t}`}var es=w(()=>{"use strict";Zr()});function ts(s,r,e,t){let i=e,a=h=>typeof h=="string"?h:null,l=h=>typeof h=="number"?h:null,u=a(i.timestamp)??"";return{entry_id:s,task_id:r,original_timestamp:u,type:a(i.type)||"completed",timestamp:u,notes:a(i.notes),cost:l(i.cost),duration:l(i.duration),completed_by:a(i.completed_by),used_parts:Array.isArray(i.used_parts)?i.used_parts:null,photo_doc_ids:yt(i),reading_value:l(i.reading_value),reading_values:pe(i),readings:t?.readings??[],task_type:t?.type??null,reading_unit:t?.reading_unit??null}}var is=w(()=>{"use strict";xt();ye()});function Vn(s){return s&&rs(s.ref_no)?String(s.ref_no):null}function ss(s,r){let e=Vn(s);return e&&r&&rs(r.ref_no)?`${e}.${r.ref_no}`:null}function ns(s,r){return s?o`<span class="ref-chip" title=${r??""}>#${s}</span>`:d}var rs,fi=w(()=>{"use strict";I();rs=s=>typeof s=="number"&&Number.isInteger(s)&&s>0});var as=w(()=>{"use strict"});function Kn(s,r){return s.taskRef&&r.ref_no?`${s.taskRef}-${r.ref_no}`:null}function Yn(s,r){let e=yt(r);return e.length>0?o`<div class="history-photos">
        ${e.map(t=>o`<maintenance-history-photo .hass=${s} .docId=${t}></maintenance-history-photo>`)}
      </div>`:d}function Gn(s,r){let e=r.lang,t=l=>O(l,e,{maximumFractionDigits:3}),i=l=>l==null?"":` (${l>=0?"+":""}${t(l)})`,a=pe(s);return a.length>0?o`<div class="history-readings">
    ...
    </span></div>`:d}function os(s,r,e={}){let t=r.lang,{compact:i=!1,showRef:a=!0,showBadges:l=!0,showEdit:u=!0}=e,h=u&&Wn.includes(s.type);return o`
    <div class="history-entry${i?" compact":""}">
      ${i?d:o`<div class="history-icon ${s.type}">
            <ha-icon .icon=${Ut[s.type]||"mdi:circle"}></ha-icon>
          </div>`}
      <div class="history-content">
        <div class="history-row">
          <strong>${n(s.type,t)}</strong>
          ${a?ns(Kn(r,s),n("ref_number",t)):d}
          ${l&&s.phase_id?o`<span class="history-phase-badge">${r.phaseNames?.[s.phase_id]||s.phase_id}</span>`:d}
          ${l&&s.auto?o`<span class="history-auto-badge">${n("history_auto",t)}</span>`:d}
        ...
        ${s.notes?o`<div>${s.notes}</div>`:d}
        ${Yn(r.hass,s)}
        ${Gn(s,r)}
        ${s.cost!=null||s.duration!=null||s.trigger_value!=null?o`<div class="history-details">
              ${s.cost!=null?o`<span>${n("cost",t)}: ${Ae(s.cost,r.currencySymbol,t)}</span>`:d}
              ${s.duration!=null?o`<span>${n("duration",t)}: ${ut(s.duration,t)}</span>`:d}
              ${s.trigger_value!=null?o`<span>${n("trigger_val",t)}: ${s.trigger_value}</span>`:d}
            </div>`:d}
      </div>
    </div>
  `}var Wn,ls=w(()=>{"use strict";I();C();gi();xt();fi();ye();as();Wn=["completed","reset","skipped"]});function cs(s,r){let e=s.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return d;let a=s.interval_days??0,l=s.suggested_interval??a;return o`
  ...
  `}function Jn(s,r,e,t,i){let x=Math.max(e,t,r,1)*1.3,g=50,$=[];for(let Y=0;Y<=g;Y++){let G=Y/g*x,Is=1-Math.exp(-Math.pow(G/r,s)),Rs=32+G/x*260,Ps=136-Is*128;$.push([Rs,Ps])}let z=$.map(([Y,G])=>`${T(Y)},${T(G)}`).join(" "),L="M32,136 "+$.map(([Y,G])=>`L${T(Y)},${T(G)}`).join(" ")+` L${T($[g][0])},136 Z`,A=32+e/x*260,H=1-Math.exp(-Math.pow(e/r,s)),we=136-H*128,As=O((1-H)*100,i,0),Ai=32+t/x*260,Cs=[0,.25,.5,.75,1];return o`
      ...
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_weibull",i)}">
        ...
        ${e>0?Ee`
          ...
          <text x="${T(A+4)}" y="${T(we-6)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${As}%</text>
        `:d}
    ...
    <div class="chart-legend">
      ...
      ${e>0?o`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4); opacity:0.5"></span> ${n("current_interval_marker",i)}</span>`:d}
      ${t>0&&t!==e?o`<span class="legend-item"><span class="legend-swatch" style="background:var(--success-color, #4caf50)"></span> ${n("recommended_marker",i)}</span>`:d}
    </div>
  `}function Zn(s,r){return o`
  ...
  `}function Xn(s,r,e){let t=s.confidence_interval_low,i=s.confidence_interval_high,a=r.suggested_interval??r.interval_days??0,l=r.interval_days??0,u=Math.max(0,t-5),_=i+5-u,m=(t-u)/_*100,b=(i-t)/_*100,y=(a-u)/_*100,x=l>0?(l-u)/_*100:-1;return o`
    <div class="confidence-range">
      ...
      <div class="confidence-bar">
        ...
        ${x>=0?o`<div class="confidence-marker current" style="left:${T(x)}%"></div>`:d}
      ...
      <div class="prediction-grid">
        ${t?o`
          <div class="prediction-item">
            ...
            ${s.degradation_rate!=null?o`<span class="prediction-rate">${s.degradation_rate>0?"+":""}${O(s.degradation_rate,r,Math.abs(s.degradation_rate)>=10?0:1)} ${s.trigger_entity_info?.unit_of_measurement||""}/${n("day_short",r)}</span>`:d}
          </div>
        `:d}
        ${i?o`
          <div class="prediction-item">
            ...
            ${s.threshold_prediction_date?o`<span class="prediction-date">${F(s.threshold_prediction_date,r)}</span>`:d}
            ${s.threshold_prediction_confidence?o`<span class="confidence-dot ${s.threshold_prediction_confidence}"></span>`:d}
            ${(s.prediction_cycles??0)>0?o`<span class="prediction-cycles">${n("prediction_cycles",r)}: ${s.prediction_cycles}</span>`:d}
          </div>
        `:d}
        ${a&&e.environmental?o`
          <div class="prediction-item">
            ...
            ${s.environmental_entity?o`<span class="prediction-entity entity-link" @click=${u=>vr(u,s.environmental_entity)}>${s.environmental_entity}</span>`:d}
          </div>
        `:d}
      </div>
    </div>
  `}var hs=w(()=>{"use strict";I();C()});function us(s,r,e,t){let i=Math.max(s||1,r);return o`
  ...
  `}var _s=w(()=>{"use strict";I();C()});function gs(s,r,e){if(!e.seasonal||!s.seasonal_factor||s.seasonal_factor===1)return d;let t=ms.map(u=>n(u,r)),i=new Date().getMonth(),a=s.seasonal_factors||s.interval_analysis?.seasonal_factors||null,l=a&&a.length===12?a:t.map((u,h)=>{let _=s.seasonal_factor||1,m=Math.sin((h-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,_+m))});return o`
    <div class="seasonal-card-compact">
      <h4>${n("seasonal_awareness",r)}</h4>
      <div class="seasonal-mini-chart">
        ${l.map((u,h)=>{let _=u*40,m=u<.9?"low":u>1.1?"high":"normal";return o`
  ...
  `}function fs(s,r){return ea(s,r)}function ea(s,r){let e=s.seasonal_factors??s.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return d;let t=s.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,l=100,u=8,_=l-u-4,m=Math.max(...e,1.5),b=a/12,y=b*.65,x=u+_-1/m*_;return o`
    <div class="seasonal-chart">
      <div class="seasonal-chart-title">
        ...
        ${t?o`<span class="source-tag">${t==="learned"?n("seasonal_learned",r):n("seasonal_manual",r)}</span>`:d}
      </div>
      <svg viewBox="0 0 ${a} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_seasonal",r)}">
        ...
        ${e.map((g,$)=>{let z=g/m*_,L=$*b+(b-y)/2,A=u+_-z,H=$===i,we=g<1?"var(--success-color, #4caf50)":g>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return Ee`
            <rect x="${T(L)}" y="${T(A)}"
  ...
  `}var ms,vs=w(()=>{"use strict";I();C();kt();ms=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var N,bs=w(()=>{"use strict";I();q();C();re();es();bt();ft();is();ye();fi();ls();ds();hs();_s();Le();vs();N=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._taskRef=null;this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return P(this.hass)}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=Xr(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._currencySymbol=ce(e?.budget),ht(e?.budget),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(i=>i.id===this._taskId);this._task=t??null,this._taskRef=ss(e.object,t)}catch(e){this._error=R(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=R(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(X(),ne)).then(async({openCompleteDialog:e})=>{let t=this._task,i=[];try{i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}e(Ze({entryId:this._entryId,taskId:this._taskId,taskName:t.name,task:t,objects:i,lang:this._lang,checklist:t.checklist||[],adaptiveEnabled:!!t.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(X(),ne)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(X(),ne)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=n("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=n("suggestion_applied",this._lang),this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${n("reanalyze_result",this._lang)}: ${Ye(e.recommended_interval,"days",this._lang)} (${e.data_points} pts)`:n("reanalyze_insufficient_data",this._lang),await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=R(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){if(!this._entryId||!this._taskId)return;let t=ts(this._entryId,this._taskId,e,this._task);Promise.resolve().then(()=>(X(),ne)).then(({openHistoryEditDialog:i})=>i(t))}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return d;let t=this._lang;return o`
    ...
    `}_renderAdaptive(e){let t=this._lang,i=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,a=e.degradation_trend!=null&&e.degradation_trend!=="insufficient_data"||e.days_until_threshold!=null||e.environmental_factor!=null&&e.environmental_factor!==1,l=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,u=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1;return!i&&!a&&!l&&!u?o`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${i?this._renderRecommendation(e):d}
        ${a?ps(e,t,this._features):d}
        ${l?cs(e,t):d}
        ${u?o`
          ${gs(e,t,this._features)}
          ${e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12?fs(e,t):d}
        `:d}
      </div>
    `}_renderDetails(e){let t=this._lang,i=e.history||[],a=i.filter(h=>h.type==="completed"),l=a.reduce((h,_)=>h+(typeof _.cost=="number"?_.cost:0),0),u=(()=>{let h=a.map(_=>typeof _.duration=="number"?_.duration:null).filter(_=>_!=null);return h.length?Math.round(h.reduce((_,m)=>_+m,0)/h.length):null})();return o`
      <div class="details">
        <div class="stats-grid">
          ...
          <div class="stat">
            ...
            <span class="stat-value">${ut(u,t)}</span>
          </div>
        </div>
        ...
        ${i.length===0?o`<div class="history-empty">${n("history_empty",t)}</div>`:o`
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(h=>os(h,{lang:t,hass:this.hass,currencySymbol:this._currencySymbol,openEdit:_=>this._onEditHistoryEntry(_),readingUnit:e.reading_unit,readingSlotDelta:(_,m)=>Tr(i,_,m),taskRef:this._taskRef},{compact:!0}))}
                ${i.length>20?o`<div class="history-more">… +${i.length-20} ${n("older_entries",t)}</div>`:d}
              </div>
            `}
      </div>
    `}render(){if(!this._open)return d;let e=this._lang,t=this._task,i=this.hass?.user?.is_admin??!0;return o`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?o`
              <div class="header">
                ...
                <div class="quick-info">
                  ${t.next_due?o`<span><strong>${n("next_due",e)}:</strong> ${F(t.next_due,e)}</span>`:d}
                  ${t.last_performed?o`<span><strong>${n("last_performed",e)}:</strong> ${F(t.last_performed,e)}</span>`:d}
                  ${t.schedule?.kind&&!["manual","one_time"].includes(t.schedule.kind)||t.interval_days!=null?o`<span><strong>${n("interval",e)}:</strong> ${fr(t,e)}</span>`:d}
                  ${de(t)?o`<span><strong>${n("phase_current",e)}:</strong> ${de(t)}</span>`:d}
                </div>
              </div>
              ...
              ${this._showSkip?o`
                  ...
                  `:o`
                    ...
                    ${this._showDetails?this._renderDetails(t):d}
                    ${this._showAdaptive?this._renderAdaptive(t):d}
                    <div class="footer">
        ...
        ${t&&i?o`
                      ...
                      <div class="task-list">
                        ${a.map(u=>o`
                          <div class="task-row" @click=${()=>this._onTaskClick(u.id)}>
                            <span class="status-dot" style="background: ${ve[u.status]||"#ccc"}"></span>
              ...
              ${i.notes?o`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${ys(i.notes)}</div>
                    </div>
                  `:d}
  ...
  `,c([v({attribute:!1})],ee.prototype,"hass",2),c([p()],ee.prototype,"_open",2),c([p()],ee.prototype,"_entryId",2),c([p()],ee.prototype,"_data",2),c([p()],ee.prototype,"_busy",2),c([p()],ee.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",ee)});function $s(){let s=window;return s.__msSettingsCache??={promise:null}}function St(s){let r=$s();if(r.promise)return r.promise;let e=s.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(t=>({features:t.features??vi.features,defaultWarningDays:t.general?.default_warning_days??7,rowActionStyle:t.general?.row_action_style??vi.rowActionStyle})).catch(()=>(r.promise===e&&(r.promise=null),vi));return r.promise=e,e}function ks(){$s().promise=null}var vi,Es=w(()=>{"use strict";vi={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"}});var ne={};js(ne,{__resetSettingsCacheForTests:()=>oa,getRowActionStyle:()=>bi,openCompleteDialog:()=>pa,openCreateObjectDialog:()=>yi,openCreateTaskDialog:()=>xi,openEditObjectDialog:()=>la,openEditTaskDialog:()=>ca,openHistoryEditDialog:()=>da,openObjectQuickActions:()=>ua,openQrDialog:()=>ha,openTaskQuickActions:()=>wi});function Tt(){return document.querySelector("home-assistant")?.hass}function aa(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function ae(s){let r=aa(),e=r.querySelector(s)??document.body.querySelector(s);return e?e.parentNode!==r&&r.appendChild(e):(e=document.createElement(s),r.appendChild(e)),e}function oe(s){let r=Tt();if(!r)return!1;s.hass=r;let e=P(r);return Vt(e)||Je(e).then(()=>{s.requestUpdate?.()}),Wt(r.locale,r.config?.country),!0}function bi(s){return St(s).then(r=>r.rowActionStyle)}function oa(){ks()}function yi(){let s=ae(Ss);return oe(s)?(s.openCreate(),!0):!1}function la(s,r){let e=ae(Ss);return oe(e)?(e.openEdit(s,r),!0):!1}function xi(s="",r){let e=ae(Ts);if(!oe(e))return!1;let t=Tt();return t?((async()=>{let i=await St(t),a=e;a.checklistsEnabled=i.features.checklists,a.scheduleTimeEnabled=i.features.schedule_time,a.completionActionsEnabled=i.features.completion_actions,a.defaultWarningDays=i.defaultWarningDays,a.openCreate(s,r)})(),!0):!1}function ca(s,r){let e=ae(Ts);if(!oe(e))return!1;let t=Tt();return t?((async()=>{try{let[i,a]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:s}),St(t)]),l=(i.tasks||[]).find(h=>h.id===r);if(!l){console.warn(`openEditTaskDialog: task ${r} not found in entry ${s}`);return}let u=e;u.checklistsEnabled=a.features.checklists,u.scheduleTimeEnabled=a.features.schedule_time,u.completionActionsEnabled=a.features.completion_actions,u.defaultWarningDays=a.defaultWarningDays,await u.openEdit(s,l)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function da(s){let r=ae(ta);return oe(r)?(r.openEdit(s),!0):!1}function pa(s){let r=ae(ia);return oe(r)?(Xe(r,s,P(Tt())),!0):!1}function ha(s){let r=ae(ra);return oe(r)?(r.openForTask(s.entry_id,s.task_id,s.object_name,s.task_name),!0):!1}function wi(s,r){let e=ae(sa);return oe(e)?(e.openFor(s,r),!0):!1}function ua(s){let r=ae(na);return oe(r)?(r.openFor(s),!0):!1}var Ss,Ts,ta,ia,ra,sa,na,X=w(()=>{"use strict";Mr();Yr();ci();Gr();Jr();bs();ws();C();bt();Es();Ss="maintenance-object-dialog",Ts="maintenance-task-dialog",ta="maintenance-history-edit-dialog",ia="maintenance-complete-dialog",ra="maintenance-qr-dialog",sa="maintenance-task-quick-actions-dialog",na="maintenance-object-quick-actions-dialog"});I();var Ys=["assignee_pool","required_completion_fields","checklist","labels","mirror_todo_entities","history","readings"],Gs=["checklist_progress"],Qs=["tasks","parts"],Js=["manual_docs","battery_fleet_excluded"];function zt(s,r,e=[]){for(let t of r)s[t]===void 0&&(s[t]=[]);for(let t of e)s[t]===void 0&&(s[t]={})}function Zs(s){let r=s;zt(r,Qs),r.object&&typeof r.object=="object"&&zt(r.object,Js);for(let e of r.tasks)zt(e,Ys,Gs);return s}function We(s){for(let r of s)Zs(r);return s}function Xs(s,r){if(r.objects)return r.objects;let e=r.delta||[],t=r.removed||[];if(!e.length&&!t.length)return null;let i=new Map(s.map(a=>[a.entry_id,a]));for(let a of e)i.set(a.entry_id,a);for(let a of t)i.delete(a);return[...i.values()]}function Gi(s,r){return r.objects&&We(r.objects),r.delta&&We(r.delta),Xs(s,r)}q();C();Qt();Jt();function Ce(s){let r=window;r.customCards=r.customCards||[],r.customCards.some(e=>e.type===s.type)||r.customCards.push(s)}ei();Xt();ft();bt();I();q();C();var vn=["overdue","triggered","due_soon","ok"],J=class extends E{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._loadingObjects=!0;this._loadError=!1;this._views=[];this._objectsLoaded=!1;this._onEntitiesChanged=e=>{this._valueChanged("entity_ids",e.detail.value||[])}}get _lang(){return P(this.hass)}setConfig(e){this._config={...e}}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._objectsLoaded&&(this._objectsLoaded=!0,this._loadObjects())}async _loadObjects(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._objects=e.objects||[],this._loadError=!1}catch{this._objects=[],this._loadError=!0}this._loadingObjects=!1;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"});this._views=e.views||[]}catch{this._views=[]}}_valueChanged(e,t){let i={...this._config,[e]:t};(Array.isArray(t)&&t.length===0||t==="")&&delete i[e],this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}_toggleStatus(e,t){let i=new Set(this._config.filter_status||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_status",[...i])}_toggleObject(e,t){let i=new Set(this._config.filter_objects||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_objects",[...i])}_toggleLabel(e,t){let i=new Set(this._config.filter_labels||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_labels",[...i])}_toggleArea(e,t){let i=new Set(this._config.filter_areas||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_areas",[...i])}_togglePriority(e,t){let i=new Set(this._config.filter_priority||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_priority",[...i])}render(){let e=this._lang,t=new Set(this._config.filter_status||[]),i=new Set(this._config.filter_objects||[]),a=[...this._objects].map(g=>g.object.name).sort((g,$)=>g.localeCompare($)),l=new Set(this._config.filter_areas||[]),u=[...new Set(this._objects.map(g=>g.object.area_id).filter(g=>!!g).concat([...l]))],h=g=>this.hass?.areas?.[g]?.name||g,_=u.map(g=>({id:g,name:h(g)})).sort((g,$)=>g.name.localeCompare($.name)),m=new Set(this._config.filter_labels||[]),b=new Set(this._config.filter_priority||[]),y=[...new Set(this._objects.flatMap(g=>g.tasks.flatMap($=>$.labels||[])))].sort((g,$)=>g.localeCompare($)),x=[];for(let g of this._objects)for(let $ of g.tasks)$.sensor_entity_id&&x.push($.sensor_entity_id),$.binary_sensor_entity_id&&x.push($.binary_sensor_entity_id);return o`
      <div class="editor">
        <ha-textfield
  ...
  `,c([v({attribute:!1})],J.prototype,"hass",2),c([p()],J.prototype,"_config",2),c([p()],J.prototype,"_objects",2),c([p()],J.prototype,"_loadingObjects",2),c([p()],J.prototype,"_loadError",2),c([p()],J.prototype,"_views",2);customElements.get("maintenance-supporter-card-editor")||customElements.define("maintenance-supporter-card-editor",J);ci();I();q();I();q();C();oi();re();kt();var U=class U extends E{constructor(){super(...arguments);this.flat=!1;this._ov=null;this._loading=!1;this._marking=!1;this._error="";this._history=null;this._rosterSort=U._storedSort();this._typeFilter=null;this._recorded=[];this._historyRequested=!1;this._localeReady=!1;this._markAll=async()=>{await this._mark(void 0)};this._repair=async()=>{if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/setup",language:this._lang}),await this._load()}catch(e){this._error=R(e,this._lang)}finally{this._marking=!1}}};this._loadHistory=async e=>{let t=e.target.open;if(it(he.batteryRosterOpen,t?"1":"0"),!(!t||this._historyRequested)){this._historyRequested=!0;try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview_history"});this._history=i.series}catch{this._history=null}}}}get _lang(){return P(this.hass)}connectedCallback(){super.connectedCallback(),this.hass&&this._load()}updated(e){pt(this,e),e.has("hass")&&this.hass&&!this._localeReady&&(this._localeReady=!0,Je(this._lang).then(()=>this.requestUpdate()),this._ov===null&&!this._loading&&this._load())}async _load(){this._loading=!0,this._error="";try{this._ov=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview"})}catch(e){this._error=R(e,this._lang)}finally{this._loading=!1}}async _mark(e){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/mark_replaced",...e?{entity_ids:e}:{}}),await this._load()}catch(t){this._error=R(t,this._lang)}finally{this._marking=!1}}}async _setExcluded(e,t){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/set_excluded",entity_id:e,excluded:t}),await this._load()}catch(i){this._error=R(i,this._lang)}finally{this._marking=!1}}}async _addBattery(e){let t=e.detail?.value;if(!(!t||this._marking)){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/set_included",entity_id:t,included:!0}),await this._load()}catch(i){this._error=R(i,this._lang)}finally{this._marking=!1}}}async _setTrackSelf(e){await this._setFleetOption("set_track_self_charging",e.target.checked)}async _setDueWithoutSensor(e){await this._setFleetOption("set_due_without_sensor",e.target.checked)}async _setFleetOption(e,t){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:`maintenance_supporter/battery_fleet/${e}`,enabled:t}),await this._load()}catch(i){this._error=R(i,this._lang)}finally{this._marking=!1}}}_rosterOpen(){return tt(he.batteryRosterOpen)!=="0"}_predictedTitle(e,t){if(e.forecast_overdue)return n("battery_fleet_forecast_overdue",t);let i=this._predictedDate(e.days_until??0);if(e.predicted_source==="trend")return n("battery_fleet_predicted_trend",t).replace("{date}",i).replace("{confidence}",n("cal_confidence_"+(e.prediction_confidence||"medium"),t));if(e.lifetime_months!=null&&e.lifetime_source){let a=n("lifetime_source_"+e.lifetime_source,t).replace("{n}",String(e.lifetime_samples??0));return n("battery_fleet_predicted_typical",t).replace("{date}",i).replace("{months}",String(e.lifetime_months)).replace("{type}",e.battery_type).replace("{source}",a)}return n("battery_fleet_predicted_on",t).replace("{date}",i)}_sparkline(e){let t=this._history?.[e.entity_id];if(!t||t.points.length<2)return d;let i=110,a=24,l=2,u=t.points[0][0],h=t.points[t.points.length-1][0],_=Date.now()/1e3,m=e.status!=="low"&&e.predicted_source==="trend"&&e.days_until!=null?_+e.days_until*86400:null,b=Math.max(h,m??h),y=L=>b===u?l:l+(L-u)/(b-u)*(i-2*l),x=L=>l+(1-Math.min(100,Math.max(0,L))/100)*(a-2*l),g=t.points.map(([L,A])=>`${T(y(L))},${T(x(A))}`).join(" "),$=t.points[t.points.length-1][1],z=T(x(t.threshold));return o`<svg
    ...
    </button>`}_renderRow(e,t,i){let a=e.available===!1?o`<span class="bf-offline">${n("battery_fleet_offline",t)}</span>`:e.no_sensor?o`<span class="bf-offline bf-nosensor">${n("battery_fleet_no_sensor",t)}</span>`:d,l=o`<span class="bf-type">${e.quantity}× ${e.battery_type}</span>`,u=i.mark==="always"||e.no_sensor||e.can_mark_replaced;return o`
      <div class="bf-row">
        ...
        ${i.recharge&&e.rechargeable?o`<span class="bf-recharge" title=${n("battery_fleet_rechargeable",t)}
            ...
            ></span>`:d}
        ${i.sparkline?this._sparkline(e):d}
        ${this._levelBar(e)}
        ${e.level!=null?o`<span class="bf-level">${e.level}%</span>`:d}
        ${u?o`<button
        ...
        ${i.predicted&&e.days_until!=null?o`<span
              ...
              >${e.forecast_overdue?o`<ha-icon icon="mdi:calendar-alert"></ha-icon>`:d}~${this._predictedDate(e.days_until)}</span
            >`:d}
        ${i.exclude?o`<button
    ...
    `}render(){let e=this._lang;if(this._loading&&this._ov===null)return o`<div class="bf-card"><div class="bf-loading">…</div></div>`;let t=this._ov;if(!t)return this._error?o`<div class="bf-card"><div class="bf-error">${this._error}</div></div>`:d;let i=t.low.length;return o`
      <div class="bf-card">
        <div class="bf-head">
  ...
  `,c([v({attribute:!1})],U.prototype,"hass",2),c([v({type:Boolean})],U.prototype,"flat",2),c([p()],U.prototype,"_ov",2),c([p()],U.prototype,"_loading",2),c([p()],U.prototype,"_marking",2),c([p()],U.prototype,"_error",2),c([p()],U.prototype,"_history",2),c([p()],U.prototype,"_rosterSort",2),c([p()],U.prototype,"_typeFilter",2),c([p()],U.prototype,"_recorded",2);var di=U;customElements.get("maintenance-battery-fleet-section")||customElements.define("maintenance-battery-fleet-section",di);var je=class extends E{constructor(){super(...arguments);this._config={type:"custom:maintenance-battery-fleet-card"}}static getStubConfig(){return{type:"custom:maintenance-battery-fleet-card"}}setConfig(e){this._config=e}getCardSize(){return 6}render(){return this.hass?o`
  ...
  `,c([v({attribute:!1})],je.prototype,"hass",2),c([p()],je.prototype,"_config",2);customElements.get("maintenance-battery-fleet-card")||customElements.define("maintenance-battery-fleet-card",je);Ce({type:"maintenance-battery-fleet-card",name:"Battery Fleet",description:"All tracked batteries: what is low now, what runs out soon, and what to buy.",preview:!1});X();I();q();var $i=["today","dashboard","calendar","settings"];C();var He="maintenance-supporter-panel-card",ki="maintenance-supporter-panel",Si="maintenance-supporter",Ei=870,_a=320,ma=480;function ga(s){let e=s?.panels?.[Si]?.config?._panel_custom?.module_url;return typeof e=="string"&&e.startsWith("/")?e:null}function fa(s){if(s==null||s===""||s==="fill")return null;if(typeof s=="number")return s>0?`${Math.round(s)}px`:null;let r=String(s).trim();return/^\d+(\.\d+)?$/.test(r)?`${r}px`:r||null}var Ti=class extends HTMLElement{constructor(){super();this._config={type:`custom:${He}`};this._panel=null;this._loading=null;this._observer=null;this._lastWidth=-1;this._preview=!1;this._onResize=()=>this._layout(!0);let e=this.attachShadow({mode:"open"}),t=document.createElement("style");t.textContent=`
    ...
    `,e.appendChild(t),this._status=document.createElement("div"),this._status.className="status",this._status.hidden=!0,e.appendChild(this._status)}static getConfigElement(){return document.createElement("maintenance-supporter-panel-card-editor")}static getStubConfig(){return{type:`custom:${He}`}}set preview(e){this._preview=!!e,this._layout(!0)}get preview(){return this._preview}_inEditorPreview(){if(this._preview)return!0;let e=this;for(let t=0;e&&t<40;t++){let i=e;if(i.tagName==="HUI-CARD-PREVIEW"||i.tagName==="HUI-DIALOG-EDIT-CARD")return!0;e=i.parentElement??i.getRootNode().host??null}return!1}setConfig(e){this._config={...e},this._panel&&(this._panel.presets=this._presets()),this._layout(!0)}getCardSize(){return 12}getGridOptions(){return{columns:"full",rows:"auto"}}set hass(e){this._hass=e,this._panel?this._panel.hass=e:this._mount()}get hass(){return this._hass}connectedCallback(){typeof ResizeObserver<"u"&&!this._observer&&(this._observer=new ResizeObserver(()=>this._layout(!1)),this._observer.observe(this)),window.addEventListener("resize",this._onResize),this._layout(!0),this._hass&&this._mount()}disconnectedCallback(){this._observer?.disconnect(),this._observer=null,window.removeEventListener("resize",this._onResize)}_presets(){let e={};return $i.includes(this._config.tab??"")&&(e.tab=this._config.tab),typeof this._config.view=="string"&&this._config.view.trim()&&(e.view=this._config.view.trim()),e}_setStatus(e){this._status.textContent=e,this._status.hidden=!1}async _mount(){if(this._panel||this._loading||!this._hass||!this.isConnected)return;let e=P(this._hass);if(!customElements.get(ki)){let i=ga(this._hass);if(!i){this._setStatus(n("panel_card_not_registered",e));return}this._loading=import(i).then(()=>{},()=>{throw this._setStatus(n("panel_card_load_failed",e)),new Error("panel bundle failed to load")});try{await this._loading}catch{return}finally{this._loading=null}if(this._panel||!this._hass||!this.isConnected)return}let t=document.createElement(ki);t.embedded=!0,t.panel=this._hass.panels?.[Si]??{url_path:Si},t.presets=this._presets(),t.narrow=this._narrow(),t.hass=this._hass,this._status.hidden=!0,this.shadowRoot.appendChild(t),this._panel=t,this._layout(!0)}_narrow(){let e=this.getBoundingClientRect().width;return e>0?e<Ei:window.innerWidth<Ei}_layout(e){let t=this.getBoundingClientRect(),i=Math.round(t.width)!==this._lastWidth;if(!e&&!i)return;this._lastWidth=Math.round(t.width),this._panel&&t.width>0&&(this._panel.narrow=t.width<Ei);let a=fa(this._config.height);if(a){this.style.height=a;return}if(!this.isConnected)return;if(this._inEditorPreview()){this.style.height=`${ma}px`;return}let l=Math.max(0,this._unscrolledTop(t)),u=Math.max(_a,Math.floor(window.innerHeight-l));this.style.height=`${u}px`}_unscrolledTop(e){let t=e.top+window.scrollY,i=this.ownerDocument,a=this.parentElement??this.getRootNode().host??null;for(let l=0;a&&l<100;l++){let u=a;u!==i.documentElement&&u!==i.body&&typeof u.scrollTop=="number"&&u.scrollTop>0&&(t+=u.scrollTop),a=u.parentElement??u.getRootNode().host??null}return t}},xe=class extends E{constructor(){super(...arguments);this._config={type:`custom:${He}`};this._views=[];this._viewsLoaded=!1}setConfig(e){this._config={...e}}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._viewsLoaded&&(this._viewsLoaded=!0,this._loadViews())}async _loadViews(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"});this._views=e?.views||[]}catch{this._views=[]}}_set(e,t){let i={...this._config};t===""||t===void 0?delete i[e]:i[e]=t,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let e=P(this.hass),t=i=>n(i==="today"?"tab_today":i==="calendar"?"tab_calendar":i,e);return o`
      <div class="editor">
        <div class="field">
  ...
  `,c([v({attribute:!1})],xe.prototype,"hass",2),c([p()],xe.prototype,"_config",2),c([p()],xe.prototype,"_views",2);customElements.get(He)||customElements.define(He,Ti);customElements.get("maintenance-supporter-panel-card-editor")||customElements.define("maintenance-supporter-panel-card-editor",xe);Ce({type:He,name:"Maintenance Supporter \u2014 Panel",description:"The complete Maintenance Supporter panel as a card \u2014 for a panel view / dashboard subview without the sidebar entry.",preview:!1});var V=class extends E{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._globalRowStyle="buttons_compact";this._objects=[];this._stats=null;this._unsub=null;this._viewFilters=null;this._userNames={};this._userPersons={};this._userService=null;this._userNamesLoaded=!1;this._taskDocs={};this._docsLoadedFor=new Set;this._dataLoaded=!1;this._lastConnection=null;this._onCompleted=async()=>{await this._loadData()}}get _lang(){return P(this.hass)}static getConfigElement(){return document.createElement("maintenance-supporter-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-card",show_header:!0,show_actions:!0,filter_status:["overdue","triggered","due_soon"],max_items:10}}setConfig(e){let t=e.view_id!==this._config.view_id;this._config=e,t&&this._dataLoaded&&this.hass&&this._loadViewFilters()}getCardSize(){return 3}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null}updated(e){if(super.updated(e),pt(this,e),this.hass&&!this._userNamesLoaded&&this._config.show_assignee!==!1&&this._objects.some(t=>t.tasks.some(i=>i.responsible_user_id))&&this._loadUserNames(),this.hass&&this._config.show_documents!==!1)for(let t of this._objects)this._docsLoadedFor.has(t.entry_id)||t.tasks.some(i=>(i.document_count??0)>0)&&this._loadDocuments(t.entry_id);if(e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){bi(this.hass).then(e=>{this._globalRowStyle=e}).catch(()=>{});try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=We(e.objects),this._stats=t,ht(this._stats.budget)}catch{}await this._loadViewFilters()}_assigneeName(e){if(this._config.show_assignee===!1)return"";let t=e.responsible_user_id;return t&&this._userNames[t]||""}async _loadUserNames(){this._userNamesLoaded=!0,this._userService?this._userService.updateHass(this.hass):this._userService=new Ie(this.hass);try{let e=await this._userService.getUsers();this._userPersons=Object.fromEntries(e.map(t=>[t.id,gt(t)])),this._userNames=Object.fromEntries(e.map(t=>[t.id,t.name]))}catch{}}async _loadDocuments(e){this._docsLoadedFor.add(e);try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:e}),i={};for(let a of t.documents||[])for(let l of a.task_ids||[])(i[l]||=[]).push({id:a.id,title:a.title,kind:a.kind,url:a.url});this._taskDocs={...this._taskDocs,[e]:i}}catch{}}_docsFor(e,t){if(this._config.show_documents===!1)return[];let a=[...this._taskDocs[e]?.[t.id]||[]];return t.documentation_url&&a.push({id:`url:${t.id}`,title:n("documentation_label",this._lang),kind:"weblink",url:t.documentation_url}),a}async _openDoc(e){if(e.kind==="weblink"&&e.url){mt(e.url)&&window.open(e.url,"_blank","noopener");return}try{await xr(this.hass,e.id)}catch{}}async _loadViewFilters(){if(!this._config.view_id){this._viewFilters=null;return}try{let t=((await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"})).views||[]).find(i=>i.id===this._config.view_id);this._viewFilters=t?t.filters:null}catch{this._viewFilters=null}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=Gi(this._objects,t);i!==null&&(this._objects=i)},{type:"maintenance_supporter/subscribe",deltas:!0,compact:!0});if(!this.isConnected){e();return}this._unsub=e}catch{}}get _flatTasks(){let e=[],{filter_status:t,filter_objects:i,entity_ids:a,filter_due_min_days:l,filter_due_max_days:u,filter_labels:h,filter_priority:_,filter_areas:m,max_items:b}=this._config,y=a?.length?new Set(a):null,x=l!==void 0||u!==void 0,g=this._viewFilters,$=g?.user_id==="current_user"?this.hass.user?.id??null:g?.user_id??null;for(let L of this._objects)if(!(i?.length&&!i.includes(L.object.name))){if(m?.length){let A=L.object.area_id;if(!A||!m.includes(A))continue}for(let A of L.tasks)if(!A.is_done&&!(A.archived||L.object.archived)&&!(t?.length&&!t.includes(A.status))&&!(h?.length&&!(A.labels||[]).some(H=>h.includes(H)))&&!(_?.length&&!_.includes(A.priority||"normal"))&&!(y&&!(A.sensor_entity_id&&y.has(A.sensor_entity_id)||A.binary_sensor_entity_id&&y.has(A.binary_sensor_entity_id)))){if(x){let H=A.days_until_due;if(H==null||l!==void 0&&H<l||u!==void 0&&H>u)continue}g&&(g.status&&A.status!==g.status||g.label&&!(A.labels||[]).includes(g.label)||g.priority&&(A.priority||"normal")!==g.priority||$&&A.responsible_user_id!==$)||e.push({entry_id:L.entry_id,object_name:L.object.name,task:A})}}let z={overdue:0,triggered:1,due_soon:2,ok:3};return e.sort((L,A)=>{let H=(z[L.task.status]??9)-(z[A.task.status]??9);return H!==0?H:(L.task.days_until_due??1/0)-(A.task.days_until_due??1/0)}),b&&b>0?e.slice(0,b):e}_openTaskDetail(e,t){wi(e,t)}render(){let e=this._lang,t=this._config.title||n("maintenance",e),i=this._config.show_header!==!1,a=(this._config.action_style??(this._globalRowStyle==="icons"?"icons":"buttons"))==="buttons",l=this._config.show_actions!==!1,u=this._config.compact||!1,h=this._flatTasks,_=this._stats;return o`
      <ha-card>
          ...
          <div class="header-right">
            ${i&&_?o`
                  <div class="header-stats">
                    ${_.overdue>0?o`<span class="badge overdue">${_.overdue}</span>`:d}
                    ${_.due_soon>0?o`<span class="badge due_soon">${_.due_soon}</span>`:d}
                    ${_.triggered>0?o`<span class="badge triggered">${_.triggered}</span>`:d}
                  </div>
                `:d}
            ${l?o`
                  <mwc-icon-button
        ...
        ${h.length===0?this._objects.some(m=>m.tasks.length>0)?o`<div class="empty-card">
              ...
              <div class="task-list ${u?"compact":""}">
                ${h.map(({entry_id:m,object_name:b,task:y})=>o`
                    <div class="task-item clickable"
                         @click=${()=>this._openTaskDetail(m,y.id)}
                         title="${n("open_task",e)}">
                      <div class="status-dot" style="background: ${ve[y.status]||"#ccc"}"></div>
                      <div class="task-info">
                        <div class="task-name">
                          ${y.name}
                        ...
                        ${u?this._assigneeName(y)?o`<div class="task-meta compact-assignee" title="${this._assigneeName(y)}">
                                ${Zt(this._userPersons[y.responsible_user_id])}${this._assigneeName(y)}
                              </div>`:d:o`<div class="task-meta">
                              ${b} · ${n(y.type,e)}${de(y)?o` · ${de(y)}`:d}${this._assigneeName(y)?o` · <span class="assignee"
                                    >${Zt(this._userPersons[y.responsible_user_id])}${this._assigneeName(y)}</span
                                  >`:d}
                            </div>`}
                      </div>
                      ${this._docsFor(m,y).length?o`<div class="doc-chips">
                            ${this._docsFor(m,y).map(x=>o`
                              <button
                                type="button"
                                class="doc-chip"
                                title="${x.title}"
                      ...
                      <div class="task-due">
                        ${y.days_until_due!==null&&y.days_until_due!==void 0?y.days_until_due<0?o`<span class="overdue-text">${Kt(y.days_until_due,e)}</span>`:Kt(y.days_until_due,e):y.trigger_active?"\u26A1":"\u2014"}
                      </div>
                      ${l&&a?o`
                            <ha-button
                              size="small"
                              ...
                              title="${n("complete",e)}"
                              @click=${x=>{x.stopPropagation();let g=this.shadowRoot.querySelector("maintenance-complete-dialog");Xe(g,Ze({entryId:m,taskId:y.id,taskName:y.name,task:y,objects:this._objects,lang:e,checklist:y.checklist||[],adaptiveEnabled:!!y.adaptive_config?.enabled,currencySymbol:ce(this._stats?.budget)}),e)}}
                            >
    ...
    `],c([v({attribute:!1})],V.prototype,"hass",2),c([p()],V.prototype,"_config",2),c([p()],V.prototype,"_globalRowStyle",2),c([p()],V.prototype,"_objects",2),c([p()],V.prototype,"_stats",2),c([p()],V.prototype,"_unsub",2),c([p()],V.prototype,"_viewFilters",2),c([p()],V.prototype,"_userNames",2),c([p()],V.prototype,"_taskDocs",2);customElements.get("maintenance-supporter-card")||customElements.define("maintenance-supporter-card",V);Ce({type:"maintenance-supporter-card",name:"Maintenance Supporter",description:"Overview of your maintenance tasks with quick actions.",preview:!0});export{V as MaintenanceSupporterCard};
