        ...
        <div class="content">
          ...
          ${this._scheduleType==="sensor_based"?o`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:ds,device_class:ps}}}]}
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `}function Yr(r,s,e){let t=r.confidence_interval_low,i=r.confidence_interval_high,n=s.suggested_interval??s.interval_days??0,l=s.interval_days??0,d=Math.max(0,t-5),_=i+5-d,f=(t-d)/_*100,x=(i-t)/_*100,v=(n-d)/_*100,y=l>0?(l-d)/_*100:-1;return o`
  ...
  `}function Is(r,s){return Gr(r,s)}function Gr(r,s){let e=r.seasonal_factors??r.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return h;let t=r.interval_analysis?.seasonal_reason,i=new Date().getMonth(),n=300,l=100,d=8,_=l-d-4,f=Math.max(...e,1.5),x=n/12,v=x*.65,y=d+_-1/f*_;return o`
