                ...
                ${this.parts.map(t=>{let i=this._usedParts[t.id],n=i!==void 0;return o`<div class="used-part-row">
                    <label class="used-part-check">
                      <input type="checkbox" .checked=${n}
                        @change=${c=>{let h={...this._usedParts};c.target.checked?h[t.id]=h[t.id]||1:delete h[t.id],this._usedParts=h}} />
                    ...
                    ${n?o`<input class="used-part-qty" type="number" min="0.01" max="999" step="0.01"
                          .value=${String(i)}
                          @input=${c=>{let h=parseFloat(c.target.value);this._usedParts={...this._usedParts,[t.id]:Number.isFinite(h)&&h>=.01?h:1}}} />`:u}
                  </div>`})}
...
`),this._requiredCompletion=[...t.required_completion_fields||[]],this._scheduleTime=t.schedule_time||"";let c=t.on_complete_action;if(c&&c.service){this._actionService=c.service;let d=c.target?.entity_id;this._actionTargetEntity=Array.isArray(d)?d[0]||"":d||"",this._actionData=c.data&&typeof c.data=="object"?{...c.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let h=t.quick_complete_defaults;this._qcNotes=h?.notes||"",this._qcCost=h?.cost!=null?String(h.cost):"",this._qcDuration=h?.duration!=null?String(h.duration):"",this._qcFeedback=h?.feedback||"";let _=t.adaptive_config||{};if(this._environmentalEntity=_.environmental_entity||"",this._environmentalAttribute=_.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,t.trigger_config){let d=t.trigger_config;this._triggerEntityId=d.entity_id||d.entity_ids&&d.entity_ids[0]||"",this._triggerEntityIds=d.entity_ids||(d.entity_id?[d.entity_id]:[]),this._triggerEntityLogic=d.entity_logic||"any",this._triggerAttribute=d.attribute||"",this._triggerType=d.type||"threshold",this._triggerAbove=d.trigger_above?.toString()||"",this._triggerBelow=d.trigger_below?.toString()||"",this._triggerForMinutes=d.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=d.trigger_target_value?.toString()||"",this._triggerDeltaMode=d.trigger_delta_mode||!1,this._triggerBaselineValue=d.trigger_baseline_value?.toString()||"",this._liveBaselineValue=t.trigger_baseline_value??null,this._autoCompleteOnRecovery=d.auto_complete_on_recovery||!1,this._triggerFromState=d.trigger_from_state||"",this._triggerToState=d.trigger_to_state||"",this._triggerTargetChanges=d.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=d.trigger_runtime_hours?.toString()||"",this._triggerOnStates=(d.trigger_on_states||[]).join(", "),d.type==="compound"?(this._compoundLogic=d.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(d.conditions||[]).map(rs)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._readingUnit="",this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._requiredCompletion=[],this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new le(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}_toggleAssignee(e){this._assigneePool=this._assigneePool.includes(e)?this._assigneePool.filter(t=>t!==e):[...this._assigneePool,e]}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[t,i]=e.split(".");if(!this.hass?.services?.[t]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let n=this._actionTargetEntity.trim();if(n){let c=n.split(".")[0];if(c!==t&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(t)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${t}.* entities; entity "${n}" is in ${c}.* \u2014 pick a service that matches the entity domain (e.g. ${c}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[n]){this._actionTestResult="error",this._actionTestError=`Target entity "${n}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,i]=e.split("."),n=this.hass?.services?.[t]?.[i]?.fields;return!n||Object.keys(n).length===0?null:Object.entries(n).map(([c,h])=>({name:c,required:!!h.required,selector:h.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return u;let t=this._serviceSchema();return o`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${i=>{this._actionService=i.detail.value||"";let n=this._serviceSchema();if(n){let c=new Set(n.map(h=>h.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([h])=>c.has(h)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
...
`).map(_=>_.trim()).filter(Boolean).slice(0,100);e.checklist=h.length?h:null}if(this.completionActionsEnabled){let h=this._actionService.trim();if(h&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(h)){let m={service:h},v=this._actionTargetEntity.trim();v&&(m.target={entity_id:v});let y=this._buildActionData();Object.keys(y).length>0&&(m.data=y),e.on_complete_action=m}else e.on_complete_action=null;let _={};this._qcNotes.trim()&&(_.notes=this._qcNotes.trim());let d=parseFloat(this._qcCost);!isNaN(d)&&d>=0&&(_.cost=d);let f=parseInt(this._qcDuration,10);!isNaN(f)&&f>=0&&(_.duration=f),this._qcFeedback&&(_.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(_).length?_:null}let i=await this.hass.connection.sendMessagePromise(e),n=this._taskId||i?.task_id,c=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(n&&this._scheduleType==="sensor_based"&&c)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=P(e,this._lang,r("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return u;let e=this._lang,t=this._triggerType==="compound";return o`
      ...
      ${t?this._renderCompoundEditor():o`
        <ms-textfield
          ...
          @input=${i=>{let c=i.target.value.split(",").map(h=>h.trim()).filter(Boolean);this._triggerEntityId=c[0]||"",this._triggerEntityIds=c,c[0]&&this._fetchEntityAttributes(c[0])}}
        ></ms-textfield>
    ...
    `}_renderCalendarFields(){let e=this._lang,t=ns(e);if(this._scheduleType==="weekdays")return o`
      ...
      ></ms-textfield>`}_renderTriggerLiveHint(){if(this._triggerType==="compound")return u;let e=this._triggerEntityId||this._triggerEntityIds[0];if(!e||!this.hass?.states)return u;let t=this.hass.states[e];if(!t)return u;let i=this._lang,n=t.attributes?.unit_of_measurement,c=typeof n=="string"&&n?` ${n}`:"",h=this._triggerAttribute?t.attributes?.[this._triggerAttribute]:t.state,_=typeof h=="number"?h:parseFloat(String(h)),d=h!=="unknown"&&h!=="unavailable"&&h!=null&&!isNaN(_),f=v=>Number.isInteger(v)?String(v):String(Math.round(v*10)/10),m=[];if(this._triggerType==="threshold"){let v=parseFloat(this._triggerAbove),y=parseFloat(this._triggerBelow);if(isNaN(v)&&isNaN(y))return u;d&&m.push(r("trigger_hint_now",i).replace("{value}",f(_)+c)),isNaN(v)||m.push(r("trigger_hint_above",i).replace("{target}",f(v)+c)),isNaN(y)||m.push(r("trigger_hint_below",i).replace("{target}",f(y)+c))}else if(this._triggerType==="counter"){let v=parseFloat(this._triggerTargetValue);if(isNaN(v))return u;this._triggerDeltaMode?this._taskId?m.push(r("trigger_hint_counter_delta_edit",i).replace("{target}",f(v)+c)):d?m.push(r("trigger_hint_counter_delta",i).replace("{value}",f(_)+c).replace("{due}",f(_+v)+c).replace("{target}",f(v)+c)):m.push(r("trigger_hint_counter_delta_edit",i).replace("{target}",f(v)+c)):(d&&m.push(r("trigger_hint_now",i).replace("{value}",f(_)+c)),m.push(r("trigger_hint_counter_abs",i).replace("{target}",f(v)+c)))}else if(this._triggerType==="runtime"){let v=parseFloat(this._triggerRuntimeHours);if(isNaN(v))return u;m.push(r("trigger_hint_runtime",i).replace("{hours}",f(v))),m.push(r("trigger_hint_state_now",i).replace("{value}",String(t.state)))}else if(this._triggerType==="state_change"){let v=parseInt(this._triggerTargetChanges,10)||1,y=this._triggerToState.trim();m.push((y?r("trigger_hint_state_change_to",i).replace("{state}",y):r("trigger_hint_state_change",i)).replace("{count}",String(v))),m.push(r("trigger_hint_state_now",i).replace("{value}",String(t.state)))}return m.length?o`<div class="trigger-live-hint">${m.join(" ")}</div>`:u}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?o`
        <ms-textfield
                      ...
                      <div class="consumes-row">
                        <label class="consumes-check">
                          <input
                            type="checkbox"
                            .checked=${n!==void 0}
                            @change=${c=>{let h={...this._consumesParts};c.target.checked?h[i.id]=h[i.id]||1:delete h[i.id],this._consumesParts=h}}
                          />
                        ...
                        ${n!==void 0?o`<input
                              ...
                              step="0.01"
                              .value=${String(n)}
                              @input=${c=>{let h=parseFloat(c.target.value);this._consumesParts={...this._consumesParts,[i.id]:Number.isFinite(h)&&h>=.01?h:1}}}
                            />`:u}
                      </div>
                    `})}
                </div>
    ...
    `}};g._PREVIEW_RELEVANT=new Set(["_open","_scheduleType","_intervalDays","_intervalUnit","_intervalAnchor","_dueDate","_weekdays","_nth","_nthWeekday","_domDay","_domLastDay","_domBusiness","_calOffset","_seasonMonths","_endsMode","_endsCount","_endsUntil","_lastPerformed"]),g.styles=k`
    .dialog-title {
      font-size: 18px;
      font-weight: 500;
      padding-bottom: 12px;
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),n.document.close()}_downloadSvg(e,t){let i=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),n=new Blob([i],{type:"image/svg+xml"}),c=URL.createObjectURL(n),h=document.createElement("a");h.href=c;let _=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;h.download=`qr-${ls(_)}-${t}.svg`,h.click(),URL.revokeObjectURL(c)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return o``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${r("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${r("qr_code",e)}: ${this._objectName}`,i=!!this._viewResult;return o`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
  ...
  `,l([b({attribute:!1})],j.prototype,"hass",2),l([b()],j.prototype,"lang",2),l([p()],j.prototype,"_open",2),l([p()],j.prototype,"_loading",2),l([p()],j.prototype,"_error",2),l([p()],j.prototype,"_viewResult",2),l([p()],j.prototype,"_completeResult",2),l([p()],j.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",j)});function si(a,s){let e=a.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return u;let n=a.interval_days??0,c=a.suggested_interval??n;return o`
    <div class="weibull-section">
      ...
      ${ds(t,i,n,c,s)}
      ${ps(e,s)}
      ${e?.confidence_interval_low!=null?hs(e,a,s):u}
    </div>
  ...
  `}function ds(a,s,e,t,i){let y=Math.max(e,t,s,1)*1.3,C=50,S=[];for(let z=0;z<=C;z++){let q=z/C*y,wi=1-Math.exp(-Math.pow(q/s,a)),ki=32+q/y*260,Ei=136-wi*128;S.push([ki,Ei])}let E=S.map(([z,q])=>`${z.toFixed(1)},${q.toFixed(1)}`).join(" "),H="M32,136 "+S.map(([z,q])=>`L${z.toFixed(1)},${q.toFixed(1)}`).join(" ")+` L${S[C][0].toFixed(1)},136 Z`,se=32+e/y*260,$e=1-Math.exp(-Math.pow(e/s,a)),we=136-$e*128,xi=((1-$e)*100).toFixed(0),pt=32+t/y*260,$i=[0,.25,.5,.75,1];return o`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${r("chart_weibull",i)}">
        ${$i.map(z=>{let q=136-z*128;return ne`
            <line x1="${32}" y1="${q.toFixed(1)}" x2="${292}" y2="${q.toFixed(1)}"
              stroke="var(--divider-color)" stroke-width="0.5" stroke-dasharray="${z===.5?"4,3":u}" />
        ...
        ${e>0?ne`
          <line x1="${se.toFixed(1)}" y1="${8}" x2="${se.toFixed(1)}" y2="${136 .toFixed(1)}"
            stroke="var(--primary-color, #03a9f4)" stroke-width="1.5" stroke-dasharray="4,3" />
          <circle cx="${se.toFixed(1)}" cy="${we.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(se+4).toFixed(1)}" y="${(we-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
  ...
  `}function hs(a,s,e){let t=a.confidence_interval_low,i=a.confidence_interval_high,n=s.suggested_interval??s.interval_days??0,c=s.interval_days??0,h=Math.max(0,t-5),d=i+5-h,f=(t-h)/d*100,m=(i-t)/d*100,v=(n-h)/d*100,y=c>0?(c-h)/d*100:-1;return o`
      ...
      <div class="prediction-grid">
        ...
        ${i?o`
          <div class="prediction-item">
            ...
            ${a.threshold_prediction_date?o`<span class="prediction-date">${V(a.threshold_prediction_date,s)}</span>`:u}
        ...
        ${n&&e.environmental?o`
          <div class="prediction-item">
            ...
            ${a.environmental_entity?o`<span class="prediction-entity entity-link" @click=${h=>Kt(h,a.environmental_entity)}>${a.environmental_entity}</span>`:u}
          </div>
        `:u}
      </div>
    </div>
  `}var ni=x(()=>{"use strict";I();L()});function oi(a,s,e,t){let i=Math.max(a||1,s);return o`
  ...
  `}var li=x(()=>{"use strict";I();L()});function di(a,s,e){if(!e.seasonal||!a.seasonal_factor||a.seasonal_factor===1)return u;let t=ci.map(h=>r(h,s)),i=new Date().getMonth(),n=a.seasonal_factors||a.interval_analysis?.seasonal_factors||null,c=n&&n.length===12?n:t.map((h,_)=>{let d=a.seasonal_factor||1,f=Math.sin((_-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,d+f))});return o`
    <div class="seasonal-card-compact">
      <h4>${r("seasonal_awareness",s)}</h4>
      <div class="seasonal-mini-chart">
        ${c.map((h,_)=>{let d=h*40,f=h<.9?"low":h>1.1?"high":"normal";return o`
            <div class="seasonal-bar ${f} ${_===i?"current":""}"
                 style="height: ${d}px"
                 title="${t[_]}: ${h.toFixed(2)}x">
            </div>
          `})}
      </div>
  ...
  `}function pi(a,s){return us(a,s)}function us(a,s){let e=a.seasonal_factors??a.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return u;let t=a.interval_analysis?.seasonal_reason,i=new Date().getMonth(),n=300,c=100,h=8,d=c-h-4,f=Math.max(...e,1.5),m=n/12,v=m*.65,y=h+d-1/f*d;return o`
  ...
  `}var ci,hi=x(()=>{"use strict";I();L();ci=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var T,ui=x(()=>{"use strict";I();M();L();ie();ri();ni();li();hi();T=class extends w{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(i=>i.id===this._taskId);this._task=t??null}catch(e){this._error=P(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=P(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(O(),W)).then(({openCompleteDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(O(),W)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(O(),W)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=r("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=r("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${r("reanalyze_result",this._lang)||"Recomputed"}: ${Pe(e.recommended_interval,"days",this._lang)} (${e.data_points} pts)`:r("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=P(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){!this._entryId||!this._taskId||Promise.resolve().then(()=>(O(),W)).then(({openHistoryEditDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null})})}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return u;let t=this._lang;return o`
    ...
    `}_renderAdaptive(e){let t=this._lang,i=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,n=e.degradation_trend!=null&&e.degradation_trend!=="insufficient_data"||e.days_until_threshold!=null||e.environmental_factor!=null&&e.environmental_factor!==1,c=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,h=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1;return!i&&!n&&!c&&!h?o`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${n?ai(e,t,this._features):u}
        ${c?si(e,t):u}
        ${h?o`
          ${di(e,t,this._features)}
          ${e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12?pi(e,t):u}
        `:u}
      </div>
    `}_renderDetails(e){let t=this._lang,i=e.history||[],n=i.filter(_=>_.type==="completed"),c=n.reduce((_,d)=>_+(typeof d.cost=="number"?d.cost:0),0),h=(()=>{let _=n.map(d=>typeof d.duration=="number"?d.duration:null).filter(d=>d!=null);return _.length?Math.round(_.reduce((d,f)=>d+f,0)/_.length):null})();return o`
      <div class="details">
        ...
        ${i.length===0?o`<div class="history-empty">${r("history_empty",t)||"No history yet."}</div>`:o`
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(_=>{let d=["completed","reset","skipped"].includes(_.type);return o`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${_.type}">${r(_.type,t)}</span>
                        <span class="history-date">${Wt(_.timestamp,t)}</span>
                        ${d?o`<button class="history-edit"
                                   title="${r("history_edit_button",t)||"Edit"}"
                                   @click=${()=>this._onEditHistoryEntry(_)}>
                              <ha-icon icon="mdi:pencil"></ha-icon>
                            </button>`:u}
                      </div>
                      ${_.notes?o`<div class="history-notes">${_.notes}</div>`:u}
                      ${_.cost!=null||_.duration!=null?o`<div class="history-meta">
                            ${_.cost!=null?o`<span>💰 ${_.cost.toFixed(2)}</span>`:u}
                            ${_.duration!=null?o`<span>⏱️ ${_.duration}m</span>`:u}
                          </div>`:u}
                    </div>
                  `})}
    ...
    `}render(){if(!this._open)return u;let e=this._lang,t=this._task,i=this.hass?.user?.is_admin??!0;return o`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?o`
              <div class="header">
                <div class="title">
                  <span class="status-dot" style="background: ${ee[t.status]||"#ccc"}"></span>
                  <span class="task-name">${t.name}</span>
                </div>
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&Promise.resolve().then(()=>(O(),W)).then(({openObjectQuickActions:n})=>{n(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${t.next_due?o`<span><strong>${r("next_due",e)||"Next due"}:</strong> ${V(t.next_due,e)}</span>`:u}
                  ${t.last_performed?o`<span><strong>${r("last_performed",e)||"Last"}:</strong> ${V(t.last_performed,e)}</span>`:u}
                  ${t.schedule?.kind&&!["manual","one_time"].includes(t.schedule.kind)||t.interval_days!=null?o`<span><strong>${r("interval",e)||"Interval"}:</strong> ${Gt(t,e)}</span>`:u}
                </div>
              </div>
                      ...
                      <div class="task-list">
                        ${n.map(h=>o`
                          <div class="task-row" @click=${()=>this._onTaskClick(h.id)}>
                            <span class="status-dot" style="background: ${ee[h.status]||"#ccc"}"></span>
                            <span class="task-name">${h.name}</span>
                            <span class="task-status">${r(h.status||"ok",e)}</span>
                          </div>
                        `)}
                      </div>
                    `}
  ...
  `,l([b({attribute:!1})],U.prototype,"hass",2),l([p()],U.prototype,"_open",2),l([p()],U.prototype,"_entryId",2),l([p()],U.prototype,"_data",2),l([p()],U.prototype,"_busy",2),l([p()],U.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",U)});var W={};Ai(W,{openCompleteDialog:()=>$s,openCreateObjectDialog:()=>lt,openCreateTaskDialog:()=>ct,openEditObjectDialog:()=>bs,openEditTaskDialog:()=>ys,openHistoryEditDialog:()=>xs,openObjectQuickActions:()=>ks,openQrDialog:()=>ws,openTaskQuickActions:()=>dt});function qe(){return document.querySelector("home-assistant")?.hass}function G(a){let s=document.body.querySelector(a);return s||(s=document.createElement(a),document.body.appendChild(s)),s}function K(a){let s=qe();if(!s)return!1;a.hass=s;let e=s.language||"en";return He(e)||je(e).then(()=>{a.requestUpdate?.()}),!0}function yi(a){return Me||(Me=a.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(s=>({features:s.features??fi.features,defaultWarningDays:s.general?.default_warning_days??7})).catch(()=>fi),Me)}function lt(){let a=G(vi);return K(a)?(a.openCreate(),!0):!1}function bs(a,s){let e=G(vi);return K(e)?(e.openEdit(a,s),!0):!1}function ct(){let a=G(bi);if(!K(a))return!1;let s=qe();return s?((async()=>{let e=await yi(s),t=a;t.checklistsEnabled=e.features.checklists,t.scheduleTimeEnabled=e.features.schedule_time,t.completionActionsEnabled=e.features.completion_actions,t.defaultWarningDays=e.defaultWarningDays,t.openCreate()})(),!0):!1}function ys(a,s){let e=G(bi);if(!K(e))return!1;let t=qe();return t?((async()=>{try{let[i,n]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:a}),yi(t)]),c=(i.tasks||[]).find(_=>_.id===s);if(!c){console.warn(`openEditTaskDialog: task ${s} not found in entry ${a}`);return}let h=e;h.checklistsEnabled=n.features.checklists,h.scheduleTimeEnabled=n.features.schedule_time,h.completionActionsEnabled=n.features.completion_actions,h.defaultWarningDays=n.defaultWarningDays,await h.openEdit(a,c)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function xs(a){let s=G(_s);return K(s)?(s.openEdit(a),!0):!1}function $s(a){let s=G(gs);return K(s)?(s.entryId=a.entry_id,s.taskId=a.task_id,s.taskName=a.task_name,s.checklist=a.checklist??[],s.adaptiveEnabled=!!a.adaptive_enabled,s.requiredFields=a.required_completion_fields??[],s.lang=qe()?.language||"en",s.open(),!0):!1}function ws(a){let s=G(ms);return K(s)?(s.openForTask(a.entry_id,a.task_id,a.object_name,a.task_name),!0):!1}function dt(a,s){let e=G(fs);return K(e)?(e.openFor(a,s),!0):!1}function ks(a){let s=G(vs);return K(s)?(s.openFor(a),!0):!1}var vi,bi,_s,gs,ms,fs,vs,fi,Me,O=x(()=>{"use strict";Zt();Xt();rt();ei();ii();ui();mi();L();vi="maintenance-object-dialog",bi="maintenance-task-dialog",_s="maintenance-history-edit-dialog",gs="maintenance-complete-dialog",ms="maintenance-qr-dialog",fs="maintenance-task-quick-actions-dialog",vs="maintenance-object-quick-actions-dialog";fi={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},Me=null});I();M();L();it();I();M();L();var Ki=["overdue","triggered","due_soon","ok"],D=class extends w{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._loadingObjects=!0;this._loadError=!1;this._views=[];this._objectsLoaded=!1;this._onEntitiesChanged=e=>{this._valueChanged("entity_ids",e.detail.value||[])}}get _lang(){return this.hass?.language||"en"}setConfig(e){this._config={...e}}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._objectsLoaded&&(this._objectsLoaded=!0,this._loadObjects())}async _loadObjects(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._objects=e.objects||[],this._loadError=!1}catch{this._objects=[],this._loadError=!0}this._loadingObjects=!1;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"});this._views=e.views||[]}catch{this._views=[]}}_valueChanged(e,t){let i={...this._config,[e]:t};(Array.isArray(t)&&t.length===0||t==="")&&delete i[e],this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}_toggleStatus(e,t){let i=new Set(this._config.filter_status||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_status",[...i])}_toggleObject(e,t){let i=new Set(this._config.filter_objects||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_objects",[...i])}_toggleLabel(e,t){let i=new Set(this._config.filter_labels||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_labels",[...i])}render(){let e=this._lang,t=new Set(this._config.filter_status||[]),i=new Set(this._config.filter_objects||[]),n=[...this._objects].map(d=>d.object.name).sort((d,f)=>d.localeCompare(f)),c=new Set(this._config.filter_labels||[]),h=[...new Set(this._objects.flatMap(d=>d.tasks.flatMap(f=>f.labels||[])))].sort((d,f)=>d.localeCompare(f)),_=[];for(let d of this._objects)for(let f of d.tasks)f.sensor_entity_id&&_.push(f.sensor_entity_id),f.binary_sensor_entity_id&&_.push(f.binary_sensor_entity_id);return o`
      <div class="editor">
        <ha-textfield
          ...
          <div class="chip-row">
            ${Ki.map(d=>o`
              <label class="chip ${t.has(d)?"active":""}">
                <input type="checkbox"
                  .checked=${t.has(d)}
                  @change=${f=>this._toggleStatus(d,f.target.checked)} />
                ${r(d,e)}
              </label>
            `)}
          </div>
                ...
                <div class="object-list">
                  ${n.map(d=>o`
                    <label class="object-row">
                      <input type="checkbox"
                        .checked=${i.has(d)}
                        @change=${f=>this._toggleObject(d,f.target.checked)} />
                      <span>${d}</span>
                    </label>
                  `)}
                </div>
          ...
          <div class="object-list">
            ${h.map(d=>o`
              <label class="object-row">
                <input type="checkbox"
                  .checked=${c.has(d)}
                  @change=${f=>this._toggleLabel(d,f.target.checked)} />
                <span>${d}</span>
              </label>
            `)}
          </div>
        ...
        ${this._views.length>0?o`
              <div class="field">
                ...
                <select
                  ...
                  @change=${d=>this._valueChanged("view_id",d.target.value)}
                >
                  <option value="" ?selected=${!this._config.view_id}>
                    ${r("card_saved_view_none",e)}
                  </option>
                  ${this._views.map(d=>o`<option value=${d.id} ?selected=${this._config.view_id===d.id}>
                      ${d.name}
                    </option>`)}
                </select>
        ...
        <ha-formfield label="${r("responsible_user",e)}">
          <ha-switch
            ...
            @change=${d=>this._valueChanged("show_assignee",d.target.checked)}
          ></ha-switch>
        </ha-formfield>
        ...
        <ha-formfield label="${r("documents",e)}">
          <ha-switch
            ...
            @change=${d=>this._valueChanged("show_documents",d.target.checked)}
          ></ha-switch>
        </ha-formfield>
  ...
  `,l([b({attribute:!1})],D.prototype,"hass",2),l([p()],D.prototype,"_config",2),l([p()],D.prototype,"_objects",2),l([p()],D.prototype,"_loadingObjects",2),l([p()],D.prototype,"_loadError",2),l([p()],D.prototype,"_views",2);customElements.get("maintenance-supporter-card-editor")||customElements.define("maintenance-supporter-card-editor",D);rt();O();var N=class extends w{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._stats=null;this._unsub=null;this._viewFilters=null;this._userNames={};this._userService=null;this._userNamesLoaded=!1;this._taskDocs={};this._docsLoadedFor=new Set;this._dataLoaded=!1;this._lastConnection=null;this._onCompleted=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"en"}static getConfigElement(){return document.createElement("maintenance-supporter-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-card",show_header:!0,show_actions:!0,filter_status:["overdue","triggered","due_soon"],max_items:10}}setConfig(e){let t=e.view_id!==this._config.view_id;this._config=e,t&&this._dataLoaded&&this.hass&&this._loadViewFilters()}getCardSize(){return 3}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null}updated(e){super.updated(e),e.has("hass")&&Vt(this.hass?.locale);let t=this.hass?.language;if(t&&!He(t)&&je(t).then(()=>this.requestUpdate()),this.hass&&!this._userNamesLoaded&&this._config.show_assignee!==!1&&this._objects.some(i=>i.tasks.some(n=>n.responsible_user_id))&&this._loadUserNames(),this.hass&&this._config.show_documents!==!1)for(let i of this._objects)this._docsLoadedFor.has(i.entry_id)||i.tasks.some(n=>(n.document_count??0)>0)&&this._loadDocuments(i.entry_id);if(e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}await this._loadViewFilters()}_assigneeName(e){if(this._config.show_assignee===!1)return"";let t=e.responsible_user_id;return t&&this._userNames[t]||""}async _loadUserNames(){this._userNamesLoaded=!0,this._userService?this._userService.updateHass(this.hass):this._userService=new le(this.hass);try{let e=await this._userService.getUsers();this._userNames=Object.fromEntries(e.map(t=>[t.id,t.name]))}catch{}}async _loadDocuments(e){this._docsLoadedFor.add(e);try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:e}),i={};for(let n of t.documents||[])for(let c of n.task_ids||[])(i[c]||=[]).push({id:n.id,title:n.title,kind:n.kind,url:n.url});this._taskDocs={...this._taskDocs,[e]:i}}catch{}}_docsFor(e,t){if(this._config.show_documents===!1)return[];let n=[...this._taskDocs[e]?.[t.id]||[]];return t.documentation_url&&n.push({id:`url:${t.id}`,title:r("documentation_label",this._lang),kind:"weblink",url:t.documentation_url}),n}async _openDoc(e){if(e.kind==="weblink"&&e.url){window.open(e.url,"_blank","noopener");return}let t=window.open("about:blank","_blank");try{let i=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:300});t&&(t.location.href=new URL(i.path,window.location.origin).href)}catch{t&&t.close()}}async _loadViewFilters(){if(!this._config.view_id){this._viewFilters=null;return}try{let t=((await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"})).views||[]).find(i=>i.id===this._config.view_id);this._viewFilters=t?t.filters:null}catch{this._viewFilters=null}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}get _flatTasks(){let e=[],{filter_status:t,filter_objects:i,entity_ids:n,filter_due_min_days:c,filter_due_max_days:h,filter_labels:_,max_items:d}=this._config,f=n?.length?new Set(n):null,m=c!==void 0||h!==void 0,v=this._viewFilters,y=v?.user_id==="current_user"?this.hass.user?.id??null:v?.user_id??null;for(let S of this._objects)if(!(i?.length&&!i.includes(S.object.name))){for(let E of S.tasks)if(!E.is_done&&!(E.archived||S.object.archived)&&!(t?.length&&!t.includes(E.status))&&!(_?.length&&!(E.labels||[]).some(H=>_.includes(H)))&&!(f&&!(E.sensor_entity_id&&f.has(E.sensor_entity_id)||E.binary_sensor_entity_id&&f.has(E.binary_sensor_entity_id)))){if(m){let H=E.days_until_due;if(H==null||c!==void 0&&H<c||h!==void 0&&H>h)continue}v&&(v.status&&E.status!==v.status||v.label&&!(E.labels||[]).includes(v.label)||y&&E.responsible_user_id!==y)||e.push({entry_id:S.entry_id,object_name:S.object.name,task:E})}}let C={overdue:0,triggered:1,due_soon:2,ok:3};return e.sort((S,E)=>{let H=(C[S.task.status]??9)-(C[E.task.status]??9);return H!==0?H:(S.task.days_until_due??1/0)-(E.task.days_until_due??1/0)}),d&&d>0?e.slice(0,d):e}_openTaskDetail(e,t){dt(e,t)}render(){let e=this._lang,t=this._config.title||r("maintenance",e),i=this._config.show_header!==!1,n=this._config.show_actions!==!1,c=this._config.compact||!1,h=this._flatTasks,_=this._stats;return o`
      <ha-card>
          ...
          <div class="header-right">
            ${i&&_?o`
                  <div class="header-stats">
                    ${_.overdue>0?o`<span class="badge overdue">${_.overdue}</span>`:u}
                    ${_.due_soon>0?o`<span class="badge due_soon">${_.due_soon}</span>`:u}
                    ${_.triggered>0?o`<span class="badge triggered">${_.triggered}</span>`:u}
                  </div>
                `:u}
            ${n?o`
                  <mwc-icon-button
        ...
        ${h.length===0?this._objects.some(d=>d.tasks.length>0)?o`<div class="empty-card">
              ...
              <div class="task-list ${c?"compact":""}">
                ${h.map(({entry_id:d,object_name:f,task:m})=>o`
                    <div class="task-item clickable"
                         @click=${()=>this._openTaskDetail(d,m.id)}
                         title="${r("open_task",e)||"Open task"}">
                      <div class="status-dot" style="background: ${ee[m.status]||"#ccc"}"></div>
                      <div class="task-info">
                        <div class="task-name">
                          ${m.name}
                        ...
                        ${c?this._assigneeName(m)?o`<div class="task-meta compact-assignee" title="${this._assigneeName(m)}">
                                <ha-icon icon="mdi:account"></ha-icon>${this._assigneeName(m)}
                              </div>`:u:o`<div class="task-meta">
                              ${f} · ${r(m.type,e)}${this._assigneeName(m)?o` · <span class="assignee"
                                    ><ha-icon icon="mdi:account"></ha-icon>${this._assigneeName(m)}</span
                                  >`:u}
                            </div>`}
                      </div>
                      ${this._docsFor(d,m).length?o`<div class="doc-chips">
                            ${this._docsFor(d,m).map(v=>o`
                              <button
                                type="button"
                                class="doc-chip"
                                title="${v.title}"
                                @click=${y=>{y.stopPropagation(),this._openDoc(v)}}
                              >
                                <ha-icon icon=${v.kind==="weblink"?"mdi:link-variant":"mdi:file-document-outline"}></ha-icon>
                                <span>${v.title}</span>
                              </button>
                            `)}
                          </div>`:u}
                      <div class="task-due">
                        ${m.days_until_due!==null&&m.days_until_due!==void 0?m.days_until_due<0?o`<span class="overdue-text">${tt(m.days_until_due,e)}</span>`:tt(m.days_until_due,e):m.trigger_active?"\u26A1":"\u2014"}
                      </div>
                      ${n?o`
                            <mwc-icon-button
                              class="complete-btn"
                              title="${r("complete",e)}"
                              @click=${v=>{v.stopPropagation();let y=this.shadowRoot.querySelector("maintenance-complete-dialog");y.entryId=d,y.taskId=m.id,y.taskName=m.name,y.checklist=m.checklist||[],y.adaptiveEnabled=!!m.adaptive_config?.enabled,y.taskType=m.type||"",y.readingUnit=m.reading_unit||"",y.requiredFields=m.required_completion_fields||[],y.lang=e;let C=this._objects.find(E=>E.entry_id===d),S=!!m.part_ref;y.parts=S?[]:C?.parts||[],y.consumesParts=S?[]:m.consumes_parts||[],y.open()}}
                            >
                              <ha-icon icon="mdi:check"></ha-icon>
                            </mwc-icon-button>
                          `:u}
    ...
    `],l([b({attribute:!1})],N.prototype,"hass",2),l([p()],N.prototype,"_config",2),l([p()],N.prototype,"_objects",2),l([p()],N.prototype,"_stats",2),l([p()],N.prototype,"_unsub",2),l([p()],N.prototype,"_viewFilters",2),l([p()],N.prototype,"_userNames",2),l([p()],N.prototype,"_taskDocs",2);customElements.get("maintenance-supporter-card")||customElements.define("maintenance-supporter-card",N);window.customCards=window.customCards||[];window.customCards.push({type:"maintenance-supporter-card",name:"Maintenance Supporter",description:"Overview of your maintenance tasks with quick actions.",preview:!0});export{N as MaintenanceSupporterCard};
