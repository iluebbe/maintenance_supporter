...
`),this._scheduleTime=t.schedule_time||"";let n=t.on_complete_action;if(n&&n.service){this._actionService=n.service;let p=n.target?.entity_id;this._actionTargetEntity=Array.isArray(p)?p[0]||"":p||"",this._actionData=n.data&&typeof n.data=="object"?{...n.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let l=t.quick_complete_defaults;this._qcNotes=l?.notes||"",this._qcCost=l?.cost!=null?String(l.cost):"",this._qcDuration=l?.duration!=null?String(l.duration):"",this._qcFeedback=l?.feedback||"";let d=t.adaptive_config||{};if(this._environmentalEntity=d.environmental_entity||"",this._environmentalAttribute=d.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,t.trigger_config){let p=t.trigger_config;this._triggerEntityId=p.entity_id||"",this._triggerEntityIds=p.entity_ids||(p.entity_id?[p.entity_id]:[]),this._triggerEntityLogic=p.entity_logic||"any",this._triggerAttribute=p.attribute||"",this._triggerType=p.type||"threshold",this._triggerAbove=p.trigger_above?.toString()||"",this._triggerBelow=p.trigger_below?.toString()||"",this._triggerForMinutes=p.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=p.trigger_target_value?.toString()||"",this._triggerDeltaMode=p.trigger_delta_mode||!1,this._autoCompleteOnRecovery=p.auto_complete_on_recovery||!1,this._triggerFromState=p.trigger_from_state||"",this._triggerToState=p.trigger_to_state||"",this._triggerTargetChanges=p.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=p.trigger_runtime_hours?.toString()||"",p.type==="compound"?(this._compoundLogic=p.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(p.conditions||[]).map(Fi)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._notes="",this._documentationUrl="",this._customIcon="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._responsibleUserId=null,this._checklistText="",this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new Te(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[t,s]=e.split(".");if(!this.hass?.services?.[t]?.[s]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let n=this._actionTargetEntity.trim();if(n){let l=n.split(".")[0];if(l!==t&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(t)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${t}.* entities; entity "${n}" is in ${l}.* \u2014 pick a service that matches the entity domain (e.g. ${l}.${s})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[n]){this._actionTestResult="error",this._actionTestError=`Target entity "${n}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,s]=e.split("."),n=this.hass?.services?.[t]?.[s]?.fields;return!n||Object.keys(n).length===0?null:Object.entries(n).map(([l,d])=>({name:l,required:!!d.required,selector:d.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return u;let t=this._serviceSchema();return o`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${s=>{this._actionService=s.detail.value||"";let n=this._serviceSchema();if(n){let l=new Set(n.map(d=>d.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([d])=>l.has(d)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
...
`).map(d=>d.trim()).filter(Boolean).slice(0,100);e.checklist=l.length?l:null}if(this.completionActionsEnabled){let l=this._actionService.trim();if(l&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(l)){let b={service:l},m=this._actionTargetEntity.trim();m&&(b.target={entity_id:m});let x=this._buildActionData();Object.keys(x).length>0&&(b.data=x),e.on_complete_action=b}else e.on_complete_action=null;let d={};this._qcNotes.trim()&&(d.notes=this._qcNotes.trim());let p=parseFloat(this._qcCost);!isNaN(p)&&p>=0&&(d.cost=p);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(d.duration=g),this._qcFeedback&&(d.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(d).length?d:null}let t=await this.hass.connection.sendMessagePromise(e),s=this._taskId||t?.task_id,n=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(s&&this._scheduleType==="sensor_based"&&n)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:s,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=C(e,this._lang,a("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return u;let e=this._lang,t=this._triggerType==="compound";return o`
      ...
      ${t?this._renderCompoundEditor():o`
        <ms-textfield
          ...
          @input=${s=>{let l=s.target.value.split(",").map(d=>d.trim()).filter(Boolean);this._triggerEntityId=l[0]||"",this._triggerEntityIds=l,l[0]&&this._fetchEntityAttributes(l[0])}}
        ></ms-textfield>
        ${this._triggerEntityIds.length>1?o`
          <div class="select-row">
            ...
            <select
              ...
              @change=${s=>this._triggerEntityLogic=s.target.value}
            >
        ...
        ${this._availableAttributes.length>0?o`
            <div class="select-row">
              ...
              <select
                ...
                @change=${s=>this._triggerAttribute=s.target.value}
              >
                <option value="" ?selected=${!this._triggerAttribute}>${a("use_entity_state",e)}</option>
                ${this._suggestedAttributes.map(s=>o`<option value=${s} ?selected=${s===this._triggerAttribute}>${s} ★</option>`)}
                ${this._availableAttributes.filter(s=>!this._suggestedAttributes.includes(s.name)).map(s=>o`<option value=${s.name} ?selected=${s.name===this._triggerAttribute}>${s.name}${s.numeric?"":" (non-numeric)"}</option>`)}
              </select>
            </div>
          `:o`
            <ms-textfield
              ...
              .value=${this._triggerAttribute}
              @input=${s=>this._triggerAttribute=s.target.value}
            ></ms-textfield>
          `}
      ...
      <label>
        <input
          ...
          @change=${s=>this._autoCompleteOnRecovery=s.target.checked}
        />
    ...
    `}_patchCondition(e,t){this._compoundConditions=this._compoundConditions.map((s,n)=>n===e?{...s,...t}:s)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Di()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((t,s)=>s!==e)}_renderCompoundEditor(){let e=this._lang;return o`
      <div class="select-row">
      ...
      ${this._compoundConditions.length===0?o`<div class="field-help">${a("compound_no_conditions",e)}</div>`:this._compoundConditions.map((t,s)=>this._renderCondition(t,s))}
      <button type="button" class="secondary-btn" @click=${()=>this._addCondition()}>
        + ${a("compound_add_condition",e)}
      </button>
    `}_renderCondition(e,t){let s=this._lang,n=t+1;return o`
      <div class="compound-condition">
        <div class="compound-condition-head">
          <span class="compound-condition-title">${a("compound_condition",s)} ${n}</span>
          <button
            type="button"
            class="icon-btn"
            title="${a("compound_remove_condition",s)}"
            @click=${()=>this._removeCondition(t)}
          >✕</button>
        </div>
        <ms-textfield
          label="${a("entity_id",s)} (${a("comma_separated",s)})"
          .value=${e.entityIds}
          @input=${l=>this._patchCondition(t,{entityIds:l.target.value})}
        ></ms-textfield>
        <div class="select-row">
          <label>${a("trigger_type",s)}</label>
          <select
            .value=${e.type}
            @change=${l=>this._patchCondition(t,{type:l.target.value})}
          >
            ${Dt.map(l=>o`<option value=${l} ?selected=${l===e.type}>${a(l,s)}</option>`)}
          </select>
        </div>
        ${this._renderConditionTypeFields(e,t)}
      </div>
    `}_renderConditionTypeFields(e,t){let s=this._lang;return e.type==="threshold"?o`
        <ms-textfield label="${a("trigger_above",s)}" type="number" .value=${e.above}
          @input=${n=>this._patchCondition(t,{above:n.target.value})}></ms-textfield>
        <ms-textfield label="${a("trigger_below",s)}" type="number" .value=${e.below}
          @input=${n=>this._patchCondition(t,{below:n.target.value})}></ms-textfield>
        <ms-textfield label="${a("for_minutes",s)}" type="number" .value=${e.forMinutes}
          @input=${n=>this._patchCondition(t,{forMinutes:n.target.value})}></ms-textfield>
      `:e.type==="counter"?o`
        <ms-textfield label="${a("target_value",s)}" type="number" .value=${e.targetValue}
      ...
      `:e.type==="state_change"?o`
        <ms-textfield label="${a("from_state_optional",s)}" .value=${e.fromState}
          @input=${n=>this._patchCondition(t,{fromState:n.target.value})}></ms-textfield>
        <ms-textfield label="${a("to_state_optional",s)}" .value=${e.toState}
          @input=${n=>this._patchCondition(t,{toState:n.target.value})}></ms-textfield>
        <ms-textfield label="${a("target_changes",s)}" type="number" .value=${e.targetChanges}
          @input=${n=>this._patchCondition(t,{targetChanges:n.target.value})}></ms-textfield>
      `:e.type==="runtime"?o`
        <ms-textfield label="${a("runtime_hours",s)}" type="number" .value=${e.runtimeHours}
      ...
      <div class="select-row">
        ...
        <div class="weekday-chips">
          ${t.map((s,n)=>o`
            ...
            >${s}</button>`)}
        </div>`;if(this._scheduleType==="nth_weekday"){let s=[["1",a("ord_1",e)],["2",a("ord_2",e)],["3",a("ord_3",e)],["4",a("ord_4",e)],["5",a("ord_5",e)],["-1",a("ord_last",e)]];return o`
        <div class="select-row">
          <label>${a("recurrence_occurrence",e)}</label>
          <select .value=${this._nth} @change=${n=>this._nth=n.target.value}>
            ${s.map(([n,l])=>o`<option value=${n} ?selected=${n===this._nth}>${l}</option>`)}
          </select>
        </div>
        <div class="select-row">
        ...
        <div class="content">
          ...
          ${this._objectChoices.length>0?o`
            <div class="select-row">
              ...
              >
                ${this._objectChoices.map(s=>o`<option value=${s.entry_id} ?selected=${s.entry_id===this._entryId}>${s.name}</option>`)}
              </select>
            </div>
          `:u}
          <ms-textfield
          ...
          <div class="select-row">
            ...
            >
              ${Pi.map(s=>o`<option value=${s} ?selected=${s===this._type}>${a(s,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${Ni.map(s=>o`<option value=${s} ?selected=${s===this._scheduleType}>${a(s,e)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ...
              ${this._availableUsers.map(s=>o`<option value=${s.id} ?selected=${s.id===this._responsibleUserId}>${s.name}</option>`)}
            </select>
          </div>
          ...
          ${this._availableTags.length>0?o`
              <div class="select-row">
                ...
                >
                  ...
                  ${this._availableTags.map(s=>o`<option value=${s.id} ?selected=${s.id===this._nfcTagId}>${s.name}</option>`)}
                </select>
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),n.document.close()}_downloadSvg(e,t){let s=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),n=new Blob([s],{type:"image/svg+xml"}),l=URL.createObjectURL(n),d=document.createElement("a");d.href=l;let p=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;d.download=`qr-${Wi(p)}-${t}.svg`,d.click(),URL.revokeObjectURL(l)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return o``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${a("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${a("qr_code",e)}: ${this._objectName}`,s=!!this._viewResult;return o`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._loading?o`<div class="loading">${a("qr_generating",e)}</div>`:this._error?o`<div class="error">${this._error}</div>`:s?o`
                    <div class="qr-pair">
                      <div class="qr-item">
                        <img
  ...
  `,c([f({attribute:!1})],H.prototype,"hass",2),c([f()],H.prototype,"lang",2),c([h()],H.prototype,"_open",2),c([h()],H.prototype,"_loading",2),c([h()],H.prototype,"_error",2),c([h()],H.prototype,"_viewResult",2),c([h()],H.prototype,"_completeResult",2),c([h()],H.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",H)});function Vt(r,i){let e=r.interval_analysis,t=e?.weibull_beta,s=e?.weibull_eta;if(t==null||s==null||s<=0)return u;let n=r.interval_days??0,l=r.suggested_interval??n;return o`
    <div class="weibull-section">
      ...
      ${Bi(t,s,n,l,i)}
      ${Gi(e,i)}
      ${e?.confidence_interval_low!=null?Ki(e,r,i):u}
    </div>
  `}function Vi(r,i){let e,t,s;return r<.8?(e="early_failures",t="M13,14H11V10H13M13,18H11V16H13M1,21H23L12,2L1,21Z",s="beta_early_failures"):r<=1.2?(e="random_failures",t="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M13,17H11V15H13V17M13,13H11V7H13V13Z",s="beta_random_failures"):r<=3.5?(e="wear_out",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M12,6A6,6 0 0,1 18,12H12V6Z",s="beta_wear_out"):(e="highly_predictable",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M11,16.5L18,9.5L16.59,8.09L11,13.67L7.91,10.59L6.5,12L11,16.5Z",s="beta_highly_predictable"),o`
    <span class="beta-badge ${e}">
      <ha-svg-icon path="${t}"></ha-svg-icon>
      ${a(s,i)} (\u03B2=${r.toFixed(2)})
    </span>
  `}function Bi(r,i,e,t,s){let v=Math.max(e,t,i,1)*1.3,k=50,M=[];for(let R=0;R<=k;R++){let z=R/k*v,ci=1-Math.exp(-Math.pow(z/i,r)),di=32+z/v*260,pi=136-ci*128;M.push([di,pi])}let me=M.map(([R,z])=>`${R.toFixed(1)},${z.toFixed(1)}`).join(" "),Le="M32,136 "+M.map(([R,z])=>`L${R.toFixed(1)},${z.toFixed(1)}`).join(" ")+` L${M[k][0].toFixed(1)},136 Z`,X=32+e/v*260,fe=1-Math.exp(-Math.pow(e/i,r)),ve=136-fe*128,oi=((1-fe)*100).toFixed(0),et=32+t/v*260,li=[0,.25,.5,.75,1];return o`
    ...
    <div class="chart-legend">
      ...
      ${e>0?o`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4); opacity:0.5"></span> ${a("current_interval_marker",s)}</span>`:u}
      ${t>0&&t!==e?o`<span class="legend-item"><span class="legend-swatch" style="background:var(--success-color, #4caf50)"></span> ${a("recommended_marker",s)}</span>`:u}
    </div>
  `}function Gi(r,i){return o`
    <div class="weibull-info-row">
      <div class="weibull-info-item">
        <span>${a("characteristic_life",i)}</span>
        <span class="weibull-info-value">${Math.round(r.weibull_eta)} ${a("days",i)}</span>
      </div>
  ...
  `}function Ki(r,i,e){let t=r.confidence_interval_low,s=r.confidence_interval_high,n=i.suggested_interval??i.interval_days??0,l=i.interval_days??0,d=Math.max(0,t-5),g=s+5-d,b=(t-d)/g*100,m=(s-t)/g*100,x=(n-d)/g*100,v=l>0?(l-d)/g*100:-1;return o`
    <div class="confidence-range">
      <div class="confidence-range-title">
        ${a("confidence_interval",e)}: ${n} ${a("days",e)} (${t}\u2013${s})
      </div>
      ...
      <div class="confidence-labels">
        ...
        <span class="confidence-text high">${a("confidence_aggressive",e)} (${s}${a("days",e).charAt(0)})</span>
      </div>
    </div>
  `}var Bt=y(()=>{"use strict";T();I()});function Gt(r,i,e){let t=r.degradation_trend!=null&&r.degradation_trend!=="insufficient_data",s=r.days_until_threshold!=null,n=r.environmental_factor!=null&&r.environmental_factor!==1;if(!t&&!s&&!n)return u;let l=r.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":r.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return o`
    <div class="prediction-section">
      ${r.sensor_prediction_urgency?o`
        <div class="prediction-urgency-banner">
          <ha-svg-icon path="M1,21H23L12,2L1,21M12,18A1,1 0 0,1 11,17A1,1 0 0,1 12,16A1,1 0 0,1 13,17A1,1 0 0,1 12,18M13,15H11V10H13V15Z"></ha-svg-icon>
          ${a("sensor_prediction_urgency",i).replace("{days}",String(Math.round(r.days_until_threshold||0)))}
        </div>
      `:u}
      ...
      <div class="prediction-grid">
        ${t?o`
          <div class="prediction-item">
            ...
            <span class="prediction-value ${r.degradation_trend}">${a("trend_"+r.degradation_trend,i)}</span>
            ${r.degradation_rate!=null?o`<span class="prediction-rate">${r.degradation_rate>0?"+":""}${Math.abs(r.degradation_rate)>=10?Math.round(r.degradation_rate).toLocaleString():r.degradation_rate.toFixed(1)} ${r.trigger_entity_info?.unit_of_measurement||""}/${a("day_short",i)}</span>`:u}
          </div>
        `:u}
        ${s?o`
          <div class="prediction-item">
            ...
            <span class="prediction-value prediction-days${r.days_until_threshold===0?" exceeded":r.sensor_prediction_urgency?" urgent":""}">${r.days_until_threshold===0?a("threshold_exceeded",i):"~"+Math.round(r.days_until_threshold)+" "+a("days",i)}</span>
            ${r.threshold_prediction_date?o`<span class="prediction-date">${Z(r.threshold_prediction_date,i)}</span>`:u}
            ${r.threshold_prediction_confidence?o`<span class="confidence-dot ${r.threshold_prediction_confidence}"></span>`:u}
          </div>
        `:u}
        ${n&&e.environmental?o`
          <div class="prediction-item">
            ...
            ${r.environmental_entity?o`<span class="prediction-entity entity-link" @click=${d=>Nt(d,r.environmental_entity)}>${r.environmental_entity}</span>`:u}
          </div>
        `:u}
      </div>
    </div>
  `}var Kt=y(()=>{"use strict";T();I()});function Yt(r,i,e,t){let s=Math.max(r||1,i);return o`
    <div class="interval-comparison">
      <div class="interval-bar">
        ...
        <div class="interval-visual current"
          style="width: ${r!=null?Math.min(r/s*100,100):0}%"></div>
      </div>
      <div class="interval-bar">
        <div class="interval-label">
  ...
  `}var Jt=y(()=>{"use strict";T();I()});function Qt(r,i,e){if(!e.seasonal||!r.seasonal_factor||r.seasonal_factor===1)return u;let t=Zt.map(d=>a(d,i)),s=new Date().getMonth(),n=r.seasonal_factors||r.interval_analysis?.seasonal_factors||null,l=n&&n.length===12?n:t.map((d,p)=>{let g=r.seasonal_factor||1,b=Math.sin((p-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,g+b))});return o`
  ...
  `}function Xt(r,i){return Yi(r,i)}function Yi(r,i){let e=r.seasonal_factors??r.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return u;let t=r.interval_analysis?.seasonal_reason,s=new Date().getMonth(),n=300,l=100,d=8,g=l-d-4,b=Math.max(...e,1.5),m=n/12,x=m*.65,v=d+g-1/b*g;return o`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${n} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${a("chart_seasonal",i)}">
        ...
        ${e.map((k,M)=>{let me=k/b*g,Le=M*m+(m-x)/2,X=d+g-me,fe=M===s,ve=k<1?"var(--success-color, #4caf50)":k>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return ie`
  ...
  `}var Zt,ei=y(()=>{"use strict";T();I();Zt=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var E,ti=y(()=>{"use strict";T();j();I();Q();Bt();Kt();Jt();ei();E=class extends ${constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(s=>s.id===this._taskId);this._task=t??null}catch(e){this._error=C(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=C(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(P(),O)).then(({openCompleteDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(P(),O)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(P(),O)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=a("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=a("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${a("reanalyze_result",this._lang)||"Recomputed"}: ${e.recommended_interval}d (${e.data_points} pts)`:a("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=C(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){!this._entryId||!this._taskId||Promise.resolve().then(()=>(P(),O)).then(({openHistoryEditDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null})})}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return u;let t=this._lang;return o`
    ...
    `}_renderDetails(e){let t=this._lang,s=e.history||[],n=s.filter(p=>p.type==="completed"),l=n.reduce((p,g)=>p+(typeof g.cost=="number"?g.cost:0),0),d=(()=>{let p=n.map(g=>typeof g.duration=="number"?g.duration:null).filter(g=>g!=null);return p.length?Math.round(p.reduce((g,b)=>g+b,0)/p.length):null})();return o`
      <div class="details">
        ...
        ${s.length===0?o`<div class="history-empty">${a("history_empty",t)||"No history yet."}</div>`:o`
              <div class="history-list">
                ${[...s].reverse().slice(0,20).map(p=>{let g=["completed","reset","skipped"].includes(p.type);return o`
                  ...
                  `})}
                ${s.length>20?o`<div class="history-more">… +${s.length-20} ${a("older_entries",t)||"older"}</div>`:u}
              </div>
            `}
      </div>
    `}render(){if(!this._open)return u;let e=this._lang,t=this._task,s=this.hass?.user?.is_admin??!0;return o`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?o`
              <div class="header">
  ...
  `],c([f({attribute:!1})],E.prototype,"hass",2),c([h()],E.prototype,"_open",2),c([h()],E.prototype,"_entryId",2),c([h()],E.prototype,"_taskId",2),c([h()],E.prototype,"_task",2),c([h()],E.prototype,"_objectName",2),c([h()],E.prototype,"_busy",2),c([h()],E.prototype,"_error",2),c([h()],E.prototype,"_showSkip",2),c([h()],E.prototype,"_showReset",2),c([h()],E.prototype,"_showDetails",2),c([h()],E.prototype,"_showAdaptive",2),c([h()],E.prototype,"_skipReason",2),c([h()],E.prototype,"_resetDate",2),c([h()],E.prototype,"_features",2),c([h()],E.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",E)});var N,ii=y(()=>{"use strict";T();j();I();Q();N=class extends ${constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return this.hass?.language||"en"}async openFor(e){this._entryId=e,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=e}catch(e){this._error=C(e,this._lang)}}_onEditObject(){!this._entryId||!this._data||Promise.resolve().then(()=>(P(),O)).then(({openEditObjectDialog:e})=>{e(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&Promise.resolve().then(()=>(P(),O)).then(({openCreateTaskDialog:e})=>{e(),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let e=a("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(e)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=C(t,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let e=!!this._data.object.archived;if(!e){let t=a("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(t))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:e?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=C(t,this._lang)}finally{this._busy=!1}}_onTaskClick(e){this._entryId&&Promise.resolve().then(()=>(P(),O)).then(({openTaskQuickActions:t})=>{t(this._entryId,e)})}render(){if(!this._open)return u;let e=this._lang,t=this._data,s=t?.object,n=t?.tasks||[],l=this.hass?.user?.is_admin??!0;return o`
              ...
              ${l?o`
                    <div class="actions">
                      ...
                      <button class="btn" @click=${this._onArchiveObject} ?disabled=${this._busy}>
                        ...
                        ${s.archived?a("unarchive_object",e)||"Unarchive object":a("archive_object",e)||"Archive object"}
                      </button>
    ...
    `}_renderMetaRow(e){let t=this._lang,s=[];return e.area_id&&s.push([a("area",t),e.area_id]),e.manufacturer&&s.push([a("manufacturer",t),e.manufacturer]),e.model&&s.push([a("model",t),e.model]),e.serial_number&&s.push([a("serial_number_label",t),e.serial_number]),e.installation_date&&s.push([a("installed",t),e.installation_date]),e.warranty_expiry&&s.push([a("warranty",t),e.warranty_expiry]),e.documentation_url&&s.push([a("documentation_url_label",t),e.documentation_url]),s.length===0?u:o`
      <div class="meta">
        ${s.map(([n,l])=>o`
            <div class="meta-item">
  ...
  `,c([f({attribute:!1})],N.prototype,"hass",2),c([h()],N.prototype,"_open",2),c([h()],N.prototype,"_entryId",2),c([h()],N.prototype,"_data",2),c([h()],N.prototype,"_busy",2),c([h()],N.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",N)});var O={};ui(O,{openCompleteDialog:()=>rs,openCreateObjectDialog:()=>Ze,openCreateTaskDialog:()=>Qe,openEditObjectDialog:()=>ts,openEditTaskDialog:()=>is,openHistoryEditDialog:()=>ss,openObjectQuickActions:()=>ns,openQrDialog:()=>as,openTaskQuickActions:()=>Xe});function Ie(){return document.querySelector("home-assistant")?.hass}function U(r){let i=document.body.querySelector(r);return i||(i=document.createElement(r),document.body.appendChild(i)),i}function W(r){let i=Ie();return i?(r.hass=i,!0):!1}function ni(r){return Ce||(Ce=r.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(i=>({features:i.features??si.features,defaultWarningDays:i.general?.default_warning_days??7})).catch(()=>si),Ce)}function Ze(){let r=U(ri);return W(r)?(r.openCreate(),!0):!1}function ts(r,i){let e=U(ri);return W(e)?(e.openEdit(r,i),!0):!1}function Qe(){let r=U(ai);if(!W(r))return!1;let i=Ie();return i?((async()=>{let e=await ni(i),t=r;t.checklistsEnabled=e.features.checklists,t.scheduleTimeEnabled=e.features.schedule_time,t.completionActionsEnabled=e.features.completion_actions,t.defaultWarningDays=e.defaultWarningDays,t.openCreate()})(),!0):!1}function is(r,i){let e=U(ai);if(!W(e))return!1;let t=Ie();return t?((async()=>{try{let[s,n]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:r}),ni(t)]),l=(s.tasks||[]).find(p=>p.id===i);if(!l){console.warn(`openEditTaskDialog: task ${i} not found in entry ${r}`);return}let d=e;d.checklistsEnabled=n.features.checklists,d.scheduleTimeEnabled=n.features.schedule_time,d.completionActionsEnabled=n.features.completion_actions,d.defaultWarningDays=n.defaultWarningDays,await d.openEdit(r,l)}catch(s){console.warn("openEditTaskDialog: failed to load task/features",s)}})(),!0):!1}function ss(r){let i=U(Ji);return W(i)?(i.openEdit(r),!0):!1}function rs(r){let i=U(Zi);return W(i)?(i.entryId=r.entry_id,i.taskId=r.task_id,i.taskName=r.task_name,i.checklist=r.checklist??[],i.adaptiveEnabled=!!r.adaptive_enabled,i.lang=Ie()?.language||"en",i.open(),!0):!1}function as(r){let i=U(Qi);return W(i)?(i.openForTask(r.entry_id,r.task_id,r.object_name,r.task_name),!0):!1}function Xe(r,i){let e=U(Xi);return W(e)?(e.openFor(r,i),!0):!1}function ns(r){let i=U(es);return W(i)?(i.openFor(r),!0):!1}var ri,ai,Ji,Zi,Qi,Xi,es,si,Ce,P=y(()=>{"use strict";Mt();Ft();Ye();Ot();Wt();ti();ii();ri="maintenance-object-dialog",ai="maintenance-task-dialog",Ji="maintenance-history-edit-dialog",Zi="maintenance-complete-dialog",Qi="maintenance-qr-dialog",Xi="maintenance-task-quick-actions-dialog",es="maintenance-object-quick-actions-dialog";si={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},Ce=null});T();j();I();T();j();I();var Hi=["overdue","triggered","due_soon","ok"],D=class extends ${constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._loadingObjects=!0;this._loadError=!1;this._objectsLoaded=!1;this._onEntitiesChanged=e=>{this._valueChanged("entity_ids",e.detail.value||[])}}get _lang(){return this.hass?.language||"en"}setConfig(e){this._config={...e}}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._objectsLoaded&&(this._objectsLoaded=!0,this._loadObjects())}async _loadObjects(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._objects=e.objects||[],this._loadError=!1}catch{this._objects=[],this._loadError=!0}this._loadingObjects=!1}_valueChanged(e,t){let s={...this._config,[e]:t};Array.isArray(t)&&t.length===0&&delete s[e],this._config=s,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:s}}))}_toggleStatus(e,t){let s=new Set(this._config.filter_status||[]);t?s.add(e):s.delete(e),this._valueChanged("filter_status",[...s])}_toggleObject(e,t){let s=new Set(this._config.filter_objects||[]);t?s.add(e):s.delete(e),this._valueChanged("filter_objects",[...s])}render(){let e=this._lang,t=new Set(this._config.filter_status||[]),s=new Set(this._config.filter_objects||[]),n=[...this._objects].map(d=>d.object.name).sort((d,p)=>d.localeCompare(p)),l=[];for(let d of this._objects)for(let p of d.tasks)p.sensor_entity_id&&l.push(p.sensor_entity_id),p.binary_sensor_entity_id&&l.push(p.binary_sensor_entity_id);return o`
      <div class="editor">
        <ha-textfield
  ...
  `,c([f({attribute:!1})],D.prototype,"hass",2),c([h()],D.prototype,"_config",2),c([h()],D.prototype,"_objects",2),c([h()],D.prototype,"_loadingObjects",2),c([h()],D.prototype,"_loadError",2);customElements.get("maintenance-supporter-card-editor")||customElements.define("maintenance-supporter-card-editor",D);Ye();P();var V=class extends ${constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._stats=null;this._unsub=null;this._dataLoaded=!1;this._lastConnection=null;this._onCompleted=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"en"}static getConfigElement(){return document.createElement("maintenance-supporter-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-card",show_header:!0,show_actions:!0,filter_status:["overdue","triggered","due_soon"],max_items:10}}setConfig(e){this._config=e}getCardSize(){return 3}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null}updated(e){super.updated(e);let t=this.hass?.language;if(t&&!Ht(t)&&Rt(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _flatTasks(){let e=[],{filter_status:t,filter_objects:s,entity_ids:n,filter_due_min_days:l,filter_due_max_days:d,max_items:p}=this._config,g=n?.length?new Set(n):null,b=l!==void 0||d!==void 0;for(let x of this._objects)if(!(s?.length&&!s.includes(x.object.name))){for(let v of x.tasks)if(!v.is_done&&!(v.archived||x.object.archived)&&!(t?.length&&!t.includes(v.status))&&!(g&&!(v.sensor_entity_id&&g.has(v.sensor_entity_id)||v.binary_sensor_entity_id&&g.has(v.binary_sensor_entity_id)))){if(b){let k=v.days_until_due;if(k==null||l!==void 0&&k<l||d!==void 0&&k>d)continue}e.push({entry_id:x.entry_id,object_name:x.object.name,task:v})}}let m={overdue:0,triggered:1,due_soon:2,ok:3};return e.sort((x,v)=>{let k=(m[x.task.status]??9)-(m[v.task.status]??9);return k!==0?k:(x.task.days_until_due??1/0)-(v.task.days_until_due??1/0)}),p&&p>0?e.slice(0,p):e}_openTaskDetail(e,t){Xe(e,t)}render(){let e=this._lang,t=this._config.title||a("maintenance",e),s=this._config.show_header!==!1,n=this._config.show_actions!==!1,l=this._config.compact||!1,d=this._flatTasks,p=this._stats;return o`
      <ha-card>
