...
`});function ji(a,i){let e=Ri[a];if(!e)return a;let t=s(e,i);return t&&t!==e?t:a}function Pi(a){let e=a.match(/data\['([^']+)'\]/)?.[1],t;return(t=a.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=a.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=a.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=a.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(a)?{field:e,rule:"required"}:(t=a.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(a)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(a)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function I(a,i,e){if(e=e??s("action_error",i),typeof a=="string")return a;if(typeof a!="object"||a===null)return e;let t=a,r=t.message||t.error?.message||"";if(!r)return e;let o=Pi(r),l=o.field?ji(o.field,i):"",d=p=>s(p,i).replace("{field}",l).replace("{n}",o.param??"");switch(o.rule){case"too_long":return d("err_too_long");case"too_short":return d("err_too_short");case"value_too_high":return d("err_value_too_high");case"value_too_low":return d("err_value_too_low");case"required":return d("err_required");case"wrong_type":return d("err_wrong_type").replace("{type}",o.param??"");case"invalid_choice":return d("err_invalid_choice");case"invalid_value":return d("err_invalid_value");default:return r||e}}var Ri,Q=y(()=>{"use strict";C();Ri={name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",warranty_expiry:"warranty_expiry_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_for_minutes:"trigger_for_minutes"}});var E,Ze=y(()=>{"use strict";T();j();C();Q();E=class extends ${constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed";this._photoDocId="";this._photoPreview="";this._photoUploading=!1}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed",this._photoDocId="",this._photoPreview="",this._photoUploading=!1)}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _onPhotoInput(e){let t=e.target,r=t.files?.[0];if(t.value="",!!r){this._photoUploading=!0,this._error="";try{let o=new FormData;o.append("entry_id",this.entryId),o.append("tags","photo"),o.append("file",r,r.name);let l=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:o});if(!l.ok){this._error=l.status===413?s("doc_too_large",this.lang):s("doc_upload_failed",this.lang);return}let d=await l.json();d.id&&(this._photoDocId=d.id,this._photoPreview=URL.createObjectURL(r))}catch{this._error=s("doc_upload_failed",this.lang)}finally{this._photoUploading=!1}}}_removePhoto(){this._photoPreview&&URL.revokeObjectURL(this._photoPreview),this._photoDocId="",this._photoPreview=""}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),this._photoDocId&&(e.photo_doc_id=this._photoDocId),await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=I(e,this.lang,s("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return n``;let e=this.lang||this.hass?.language||"en";return n`
  ...
  `,c([f({attribute:!1})],E.prototype,"hass",2),c([f()],E.prototype,"entryId",2),c([f()],E.prototype,"taskId",2),c([f()],E.prototype,"taskName",2),c([f()],E.prototype,"lang",2),c([f({type:Array})],E.prototype,"checklist",2),c([f({type:Boolean})],E.prototype,"adaptiveEnabled",2),c([h()],E.prototype,"_open",2),c([h()],E.prototype,"_notes",2),c([h()],E.prototype,"_cost",2),c([h()],E.prototype,"_duration",2),c([h()],E.prototype,"_loading",2),c([h()],E.prototype,"_error",2),c([h()],E.prototype,"_checklistState",2),c([h()],E.prototype,"_feedback",2),c([h()],E.prototype,"_photoDocId",2),c([h()],E.prototype,"_photoPreview",2),c([h()],E.prototype,"_photoUploading",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",E)});var L,Qe=y(()=>{"use strict";T();j();L=class extends ${constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return n`
      <label class="field">
        ${this.label?n`<span class="label">${this.label}${this.required?n`<span class="req">*</span>`:u}</span>`:u}
        <input
          .value=${this.value??""}
          .type=${this.type}
        ...
        />
        ${this.helper?n`<span class="helper">${this.helper}</span>`:u}
      </label>
    `}};L.styles=k`
    :host { display: block; }
    .field {
...
`),this._scheduleTime=t.schedule_time||"";let o=t.on_complete_action;if(o&&o.service){this._actionService=o.service;let p=o.target?.entity_id;this._actionTargetEntity=Array.isArray(p)?p[0]||"":p||"",this._actionData=o.data&&typeof o.data=="object"?{...o.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let l=t.quick_complete_defaults;this._qcNotes=l?.notes||"",this._qcCost=l?.cost!=null?String(l.cost):"",this._qcDuration=l?.duration!=null?String(l.duration):"",this._qcFeedback=l?.feedback||"";let d=t.adaptive_config||{};if(this._environmentalEntity=d.environmental_entity||"",this._environmentalAttribute=d.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,t.trigger_config){let p=t.trigger_config;this._triggerEntityId=p.entity_id||"",this._triggerEntityIds=p.entity_ids||(p.entity_id?[p.entity_id]:[]),this._triggerEntityLogic=p.entity_logic||"any",this._triggerAttribute=p.attribute||"",this._triggerType=p.type||"threshold",this._triggerAbove=p.trigger_above?.toString()||"",this._triggerBelow=p.trigger_below?.toString()||"",this._triggerForMinutes=p.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=p.trigger_target_value?.toString()||"",this._triggerDeltaMode=p.trigger_delta_mode||!1,this._autoCompleteOnRecovery=p.auto_complete_on_recovery||!1,this._triggerFromState=p.trigger_from_state||"",this._triggerToState=p.trigger_to_state||"",this._triggerTargetChanges=p.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=p.trigger_runtime_hours?.toString()||"",p.type==="compound"?(this._compoundLogic=p.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(p.conditions||[]).map(Oi)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._responsibleUserId=null,this._checklistText="",this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new Ie(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[t,r]=e.split(".");if(!this.hass?.services?.[t]?.[r]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let o=this._actionTargetEntity.trim();if(o){let l=o.split(".")[0];if(l!==t&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(t)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${t}.* entities; entity "${o}" is in ${l}.* \u2014 pick a service that matches the entity domain (e.g. ${l}.${r})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[o]){this._actionTestResult="error",this._actionTestError=`Target entity "${o}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,r]=e.split("."),o=this.hass?.services?.[t]?.[r]?.fields;return!o||Object.keys(o).length===0?null:Object.entries(o).map(([l,d])=>({name:l,required:!!d.required,selector:d.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return u;let t=this._serviceSchema();return n`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${r=>{this._actionService=r.detail.value||"";let o=this._serviceSchema();if(o){let l=new Set(o.map(d=>d.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([d])=>l.has(d)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
          ...
          @value-changed=${r=>{let o=r.detail.value;this._actionTargetEntity=o.target_entity||""}}
        ></ha-form>
        ...
        <div class="ca-test-row">
          ...
          ${this._actionTestResult==="ok"?n`<span class="ca-test-ok">${s("on_complete_action_test_success",e)}</span>`:u}
          ${this._actionTestResult==="error"?n`<div class="ca-test-error-block">
                ...
                ${this._actionTestError?n`<div class="ca-test-error-detail">${this._actionTestError}</div>`:u}
              </div>`:u}
        </div>
      </details>
...
`).map(d=>d.trim()).filter(Boolean).slice(0,100);e.checklist=l.length?l:null}if(this.completionActionsEnabled){let l=this._actionService.trim();if(l&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(l)){let b={service:l},m=this._actionTargetEntity.trim();m&&(b.target={entity_id:m});let x=this._buildActionData();Object.keys(x).length>0&&(b.data=x),e.on_complete_action=b}else e.on_complete_action=null;let d={};this._qcNotes.trim()&&(d.notes=this._qcNotes.trim());let p=parseFloat(this._qcCost);!isNaN(p)&&p>=0&&(d.cost=p);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(d.duration=g),this._qcFeedback&&(d.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(d).length?d:null}let t=await this.hass.connection.sendMessagePromise(e),r=this._taskId||t?.task_id,o=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(r&&this._scheduleType==="sensor_based"&&o)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:r,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=I(e,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return u;let e=this._lang,t=this._triggerType==="compound";return n`
      ...
      <div class="select-row">
        ...
        >
          ${Di.map(r=>n`<option value=${r} ?selected=${r===this._triggerType}>${s(r,e)}</option>`)}
        </select>
      </div>
        ...
        ${this._availableAttributes.length>0?n`
            <div class="select-row">
              ...
              >
                ...
                ${this._suggestedAttributes.map(r=>n`<option value=${r} ?selected=${r===this._triggerAttribute}>${r} ★</option>`)}
                ${this._availableAttributes.filter(r=>!this._suggestedAttributes.includes(r.name)).map(r=>n`<option value=${r.name} ?selected=${r.name===this._triggerAttribute}>${r.name}${r.numeric?"":" (non-numeric)"}</option>`)}
              </select>
            </div>
          `:n`
            <ms-textfield
    ...
    `}_patchCondition(e,t){this._compoundConditions=this._compoundConditions.map((r,o)=>o===e?{...r,...t}:r)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Ui()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((t,r)=>r!==e)}_renderCompoundEditor(){let e=this._lang;return n`
      <div class="select-row">
      ...
      ${this._compoundConditions.length===0?n`<div class="field-help">${s("compound_no_conditions",e)}</div>`:this._compoundConditions.map((t,r)=>this._renderCondition(t,r))}
      <button type="button" class="secondary-btn" @click=${()=>this._addCondition()}>
        + ${s("compound_add_condition",e)}
      </button>
    `}_renderCondition(e,t){let r=this._lang,o=t+1;return n`
      <div class="compound-condition">
        <div class="compound-condition-head">
          <span class="compound-condition-title">${s("compound_condition",r)} ${o}</span>
          <button
            type="button"
            class="icon-btn"
            title="${s("compound_remove_condition",r)}"
            @click=${()=>this._removeCondition(t)}
          >✕</button>
        </div>
        <ms-textfield
          label="${s("entity_id",r)} (${s("comma_separated",r)})"
          .value=${e.entityIds}
          @input=${l=>this._patchCondition(t,{entityIds:l.target.value})}
        ></ms-textfield>
        <div class="select-row">
          <label>${s("trigger_type",r)}</label>
          <select
            .value=${e.type}
            @change=${l=>this._patchCondition(t,{type:l.target.value})}
          >
            ${Dt.map(l=>n`<option value=${l} ?selected=${l===e.type}>${s(l,r)}</option>`)}
          </select>
        </div>
        ${this._renderConditionTypeFields(e,t)}
      </div>
    `}_renderConditionTypeFields(e,t){let r=this._lang;return e.type==="threshold"?n`
        <ms-textfield label="${s("trigger_above",r)}" type="number" .value=${e.above}
          @input=${o=>this._patchCondition(t,{above:o.target.value})}></ms-textfield>
        <ms-textfield label="${s("trigger_below",r)}" type="number" .value=${e.below}
          @input=${o=>this._patchCondition(t,{below:o.target.value})}></ms-textfield>
        <ms-textfield label="${s("for_minutes",r)}" type="number" .value=${e.forMinutes}
          @input=${o=>this._patchCondition(t,{forMinutes:o.target.value})}></ms-textfield>
      `:e.type==="counter"?n`
        <ms-textfield label="${s("target_value",r)}" type="number" .value=${e.targetValue}
      ...
      `:e.type==="state_change"?n`
        <ms-textfield label="${s("from_state_optional",r)}" .value=${e.fromState}
          @input=${o=>this._patchCondition(t,{fromState:o.target.value})}></ms-textfield>
        <ms-textfield label="${s("to_state_optional",r)}" .value=${e.toState}
          @input=${o=>this._patchCondition(t,{toState:o.target.value})}></ms-textfield>
        <ms-textfield label="${s("target_changes",r)}" type="number" .value=${e.targetChanges}
          @input=${o=>this._patchCondition(t,{targetChanges:o.target.value})}></ms-textfield>
      `:e.type==="runtime"?n`
        <ms-textfield label="${s("runtime_hours",r)}" type="number" .value=${e.runtimeHours}
          @input=${o=>this._patchCondition(t,{runtimeHours:o.target.value})}></ms-textfield>
      `:u}_renderUnitSelect(){let e=this._lang;return n`
      <div class="select-row">
        ...
        <div class="weekday-chips">
          ${t.map((r,o)=>n`
            ...
            >${r}</button>`)}
        </div>`;if(this._scheduleType==="nth_weekday"){let r=[["1",s("ord_1",e)],["2",s("ord_2",e)],["3",s("ord_3",e)],["4",s("ord_4",e)],["5",s("ord_5",e)],["-1",s("ord_last",e)]];return n`
        <div class="select-row">
          <label>${s("recurrence_occurrence",e)}</label>
          <select .value=${this._nth} @change=${o=>this._nth=o.target.value}>
            ${r.map(([o,l])=>n`<option value=${o} ?selected=${o===this._nth}>${l}</option>`)}
          </select>
        </div>
        <div class="select-row">
          <label>${s("recurrence_weekday",e)}</label>
          <select .value=${this._nthWeekday} @change=${o=>this._nthWeekday=o.target.value}>
            ${t.map((o,l)=>n`<option value=${String(l)} ?selected=${String(l)===this._nthWeekday}>${o}</option>`)}
          </select>
        ...
        ></ms-textfield>`:u}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?n`
        <ms-textfield
      ...
      `:this._triggerType==="runtime"?n`
        ...
        ></ms-textfield>
      `:u}render(){if(!this._open)return n``;let e=this._lang,t=this._taskId?s("edit_task",e):s("new_task",e);return n`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._error?n`<div class="error">${this._error}</div>`:u}
          ${this._objectChoices.length>0?n`
            <div class="select-row">
              ...
              >
                ${this._objectChoices.map(r=>n`<option value=${r.entry_id} ?selected=${r.entry_id===this._entryId}>${r.name}</option>`)}
              </select>
            </div>
          `:u}
          <ms-textfield
          ...
          <div class="select-row">
            ...
            >
              ${zi.map(r=>n`<option value=${r} ?selected=${r===this._type}>${s(r,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${Ni.map(r=>n`<option value=${r} ?selected=${r===this._priority}>${s("priority_"+r,e)}</option>`)}
            </select>
          </div>
          <div class="field">
            ...
            <input
              ...
              @input=${r=>this._labels=r.target.value}
            />
          ...
          <div class="select-row">
            ...
            >
              ${Mi.map(r=>n`<option value=${r} ?selected=${r===this._scheduleType}>${s(r,e)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            <select
              ...
              @change=${r=>{let o=r.target.value;this._responsibleUserId=o||null}}
            >
              <option value="" ?selected=${!this._responsibleUserId}>${s("no_user_assigned",e)}</option>
              ${this._availableUsers.map(r=>n`<option value=${r.id} ?selected=${r.id===this._responsibleUserId}>${r.name}</option>`)}
            </select>
          </div>
          ...
          ${this._availableTags.length>0?n`
              <div class="select-row">
                ...
                >
                  ...
                  ${this._availableTags.map(r=>n`<option value=${r.id} ?selected=${r.id===this._nfcTagId}>${r.name}</option>`)}
                </select>
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ...
        <label>
          ...
          <input type="datetime-local"
            ...
            @change=${r=>{let o=r.target.value;this._set("timestamp",o.length===16?`${o}:00`:o)}} />
        </label>
        <label>
        ...
        <div class="row">
          ...
          <label>
            ...
            <input type="number" min="0"
              ...
              @input=${r=>{let o=r.target.value;this._set("duration",o?Number(o):null)}} />
          </label>
        </div>
        ${this._error?n`<div class="error">${this._error}</div>`:u}
        <div class="actions">
  ...
  `,c([f({attribute:!1})],U.prototype,"hass",2),c([h()],U.prototype,"_open",2),c([h()],U.prototype,"_saving",2),c([h()],U.prototype,"_error",2),c([h()],U.prototype,"_draft",2);customElements.get("maintenance-history-edit-dialog")||customElements.define("maintenance-history-edit-dialog",U)});function ae(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Ft(a){return!a.startsWith("data:image/svg+xml,")&&!a.startsWith("data:image/png;base64,")?"":ae(a)}function Vi(a){return a.replace(/[/\\:*?"<>|#%]+/g,"").replace(/\s+/g,"-").toLowerCase().substring(0,100)}var H,Wt=y(()=>{"use strict";T();j();C();H=class extends ${constructor(){super(...arguments);this.lang="en";this._open=!1;this._loading=!1;this._error="";this._viewResult=null;this._completeResult=null;this._urlMode="companion";this._entryId="";this._taskId=null;this._objectName="";this._taskName="";this._generateSeq=0}openForObject(e,t){this._entryId=e,this._taskId=null,this._objectName=t,this._taskName="",this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}openForTask(e,t,r,o){this._entryId=e,this._taskId=t,this._objectName=r,this._taskName=o,this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}async _generate(){let e=++this._generateSeq;this._loading=!0,this._error="",this._viewResult=null,this._completeResult=null;try{let t={type:"maintenance_supporter/qr/generate",entry_id:this._entryId,url_mode:this._urlMode};this._taskId&&(t.task_id=this._taskId);let r=[this.hass.connection.sendMessagePromise({...t,action:"view"})];this._taskId&&r.push(this.hass.connection.sendMessagePromise({...t,action:"complete"}));let o=await Promise.all(r);if(e!==this._generateSeq)return;this._viewResult=o[0],o.length>1&&(this._completeResult=o[1])}catch(t){if(e!==this._generateSeq)return;let r=t?.code,o=t?.message;this._error=r==="no_url"||typeof o=="string"&&o.includes("No Home Assistant URL")?s("qr_error_no_url",this.lang):s("qr_error",this.lang)}finally{e===this._generateSeq&&(this._loading=!1)}}_setUrlMode(e){this._urlMode!==e&&(this._urlMode=e,this._generate())}_print(){if(!this._viewResult)return;let e=this._viewResult,t=e.label.task_name?`${e.label.object_name} \u2014 ${e.label.task_name}`:e.label.object_name,r=[e.label.manufacturer,e.label.model].filter(Boolean).join(" "),o=window.open("","_blank","width=600,height=500");if(!o)return;let l=this.lang||"en",d=ae(t),p=ae(r),g=!!this._completeResult,b=ae(s("qr_action_view",l)),m=ae(s("qr_action_complete",l));o.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8">
<title>${d}</title>
<style>
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),o.document.close()}_downloadSvg(e,t){let r=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),o=new Blob([r],{type:"image/svg+xml"}),l=URL.createObjectURL(o),d=document.createElement("a");d.href=l;let p=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;d.download=`qr-${Vi(p)}-${t}.svg`,d.click(),URL.revokeObjectURL(l)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return n``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${s("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${s("qr_code",e)}: ${this._objectName}`,r=!!this._viewResult;return n`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._loading?n`<div class="loading">${s("qr_generating",e)}</div>`:this._error?n`<div class="error">${this._error}</div>`:r?n`
                    <div class="qr-pair">
                      <div class="qr-item">
                        <img
  ...
  `,c([f({attribute:!1})],H.prototype,"hass",2),c([f()],H.prototype,"lang",2),c([h()],H.prototype,"_open",2),c([h()],H.prototype,"_loading",2),c([h()],H.prototype,"_error",2),c([h()],H.prototype,"_viewResult",2),c([h()],H.prototype,"_completeResult",2),c([h()],H.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",H)});function Vt(a,i){let e=a.interval_analysis,t=e?.weibull_beta,r=e?.weibull_eta;if(t==null||r==null||r<=0)return u;let o=a.interval_days??0,l=a.suggested_interval??o;return n`
    <div class="weibull-section">
      ...
      ${Gi(t,r,o,l,i)}
      ${Ki(e,i)}
      ${e?.confidence_interval_low!=null?Yi(e,a,i):u}
    </div>
  `}function Bi(a,i){let e,t,r;return a<.8?(e="early_failures",t="M13,14H11V10H13M13,18H11V16H13M1,21H23L12,2L1,21Z",r="beta_early_failures"):a<=1.2?(e="random_failures",t="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M13,17H11V15H13V17M13,13H11V7H13V13Z",r="beta_random_failures"):a<=3.5?(e="wear_out",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M12,6A6,6 0 0,1 18,12H12V6Z",r="beta_wear_out"):(e="highly_predictable",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M11,16.5L18,9.5L16.59,8.09L11,13.67L7.91,10.59L6.5,12L11,16.5Z",r="beta_highly_predictable"),n`
    <span class="beta-badge ${e}">
      <ha-svg-icon path="${t}"></ha-svg-icon>
      ${s(r,i)} (\u03B2=${a.toFixed(2)})
    </span>
  `}function Gi(a,i,e,t,r){let v=Math.max(e,t,i,1)*1.3,w=50,M=[];for(let R=0;R<=w;R++){let P=R/w*v,ci=1-Math.exp(-Math.pow(P/i,a)),di=32+P/v*260,pi=136-ci*128;M.push([di,pi])}let me=M.map(([R,P])=>`${R.toFixed(1)},${P.toFixed(1)}`).join(" "),Re="M32,136 "+M.map(([R,P])=>`L${R.toFixed(1)},${P.toFixed(1)}`).join(" ")+` L${M[w][0].toFixed(1)},136 Z`,X=32+e/v*260,fe=1-Math.exp(-Math.pow(e/i,a)),ve=136-fe*128,ni=((1-fe)*100).toFixed(0),it=32+t/v*260,li=[0,.25,.5,.75,1];return n`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",r)}">
        ${li.map(R=>{let P=136-R*128;return ie`
    ...
    <div class="chart-legend">
      ...
      ${e>0?n`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4); opacity:0.5"></span> ${s("current_interval_marker",r)}</span>`:u}
      ${t>0&&t!==e?n`<span class="legend-item"><span class="legend-swatch" style="background:var(--success-color, #4caf50)"></span> ${s("recommended_marker",r)}</span>`:u}
    </div>
  `}function Ki(a,i){return n`
    <div class="weibull-info-row">
      <div class="weibull-info-item">
        <span>${s("characteristic_life",i)}</span>
        <span class="weibull-info-value">${Math.round(a.weibull_eta)} ${s("days",i)}</span>
      </div>
  ...
  `}function Yi(a,i,e){let t=a.confidence_interval_low,r=a.confidence_interval_high,o=i.suggested_interval??i.interval_days??0,l=i.interval_days??0,d=Math.max(0,t-5),g=r+5-d,b=(t-d)/g*100,m=(r-t)/g*100,x=(o-d)/g*100,v=l>0?(l-d)/g*100:-1;return n`
    <div class="confidence-range">
      <div class="confidence-range-title">
        ${s("confidence_interval",e)}: ${o} ${s("days",e)} (${t}\u2013${r})
      </div>
      <div class="confidence-bar">
        <div class="confidence-fill" style="left:${b.toFixed(1)}%;width:${m.toFixed(1)}%"></div>
        ${v>=0?n`<div class="confidence-marker current" style="left:${v.toFixed(1)}%"></div>`:u}
      ...
      <div class="confidence-labels">
        ...
        <span class="confidence-text high">${s("confidence_aggressive",e)} (${r}${s("days",e).charAt(0)})</span>
      </div>
    </div>
  `}var Bt=y(()=>{"use strict";T();C()});function Gt(a,i,e){let t=a.degradation_trend!=null&&a.degradation_trend!=="insufficient_data",r=a.days_until_threshold!=null,o=a.environmental_factor!=null&&a.environmental_factor!==1;if(!t&&!r&&!o)return u;let l=a.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":a.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return n`
    <div class="prediction-section">
      ${a.sensor_prediction_urgency?n`
        <div class="prediction-urgency-banner">
          <ha-svg-icon path="M1,21H23L12,2L1,21M12,18A1,1 0 0,1 11,17A1,1 0 0,1 12,16A1,1 0 0,1 13,17A1,1 0 0,1 12,18M13,15H11V10H13V15Z"></ha-svg-icon>
          ${s("sensor_prediction_urgency",i).replace("{days}",String(Math.round(a.days_until_threshold||0)))}
        </div>
      `:u}
      ...
      <div class="prediction-grid">
        ${t?n`
          <div class="prediction-item">
            ...
            <span class="prediction-value ${a.degradation_trend}">${s("trend_"+a.degradation_trend,i)}</span>
            ${a.degradation_rate!=null?n`<span class="prediction-rate">${a.degradation_rate>0?"+":""}${Math.abs(a.degradation_rate)>=10?Math.round(a.degradation_rate).toLocaleString():a.degradation_rate.toFixed(1)} ${a.trigger_entity_info?.unit_of_measurement||""}/${s("day_short",i)}</span>`:u}
          </div>
        `:u}
        ${r?n`
          <div class="prediction-item">
            ...
            <span class="prediction-value prediction-days${a.days_until_threshold===0?" exceeded":a.sensor_prediction_urgency?" urgent":""}">${a.days_until_threshold===0?s("threshold_exceeded",i):"~"+Math.round(a.days_until_threshold)+" "+s("days",i)}</span>
            ${a.threshold_prediction_date?n`<span class="prediction-date">${Z(a.threshold_prediction_date,i)}</span>`:u}
            ${a.threshold_prediction_confidence?n`<span class="confidence-dot ${a.threshold_prediction_confidence}"></span>`:u}
          </div>
        `:u}
        ${o&&e.environmental?n`
          <div class="prediction-item">
            ...
            ${a.environmental_entity?n`<span class="prediction-entity entity-link" @click=${d=>Nt(d,a.environmental_entity)}>${a.environmental_entity}</span>`:u}
          </div>
        `:u}
      </div>
    </div>
  `}var Kt=y(()=>{"use strict";T();C()});function Yt(a,i,e,t){let r=Math.max(a||1,i);return n`
    <div class="interval-comparison">
      <div class="interval-bar">
        ...
        <div class="interval-visual current"
          style="width: ${a!=null?Math.min(a/r*100,100):0}%"></div>
      </div>
      <div class="interval-bar">
        <div class="interval-label">
          ${s("recommended",t)}: ${i} ${s("days",t)}
  ...
  `}var Jt=y(()=>{"use strict";T();C()});function Qt(a,i,e){if(!e.seasonal||!a.seasonal_factor||a.seasonal_factor===1)return u;let t=Zt.map(d=>s(d,i)),r=new Date().getMonth(),o=a.seasonal_factors||a.interval_analysis?.seasonal_factors||null,l=o&&o.length===12?o:t.map((d,p)=>{let g=a.seasonal_factor||1,b=Math.sin((p-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,g+b))});return n`
    <div class="seasonal-card-compact">
      <h4>${s("seasonal_awareness",i)}</h4>
      <div class="seasonal-mini-chart">
        ${l.map((d,p)=>{let g=d*40,b=d<.9?"low":d>1.1?"high":"normal";return n`
  ...
  `}function Xt(a,i){return Ji(a,i)}function Ji(a,i){let e=a.seasonal_factors??a.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return u;let t=a.interval_analysis?.seasonal_reason,r=new Date().getMonth(),o=300,l=100,d=8,g=l-d-4,b=Math.max(...e,1.5),m=o/12,x=m*.65,v=d+g-1/b*g;return n`
    <div class="seasonal-chart">
      <div class="seasonal-chart-title">
        ...
        ${t?n`<span class="source-tag">${t==="learned"?s("seasonal_learned",i):s("seasonal_manual",i)}</span>`:u}
      </div>
      <svg viewBox="0 0 ${o} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",i)}">
  ...
  `}var Zt,ei=y(()=>{"use strict";T();C();Zt=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var A,ti=y(()=>{"use strict";T();j();C();Q();Bt();Kt();Jt();ei();A=class extends ${constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(r=>r.id===this._taskId);this._task=t??null}catch(e){this._error=I(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=I(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(z(),O)).then(({openCompleteDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(z(),O)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(z(),O)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=s("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=s("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${s("reanalyze_result",this._lang)||"Recomputed"}: ${e.recommended_interval}d (${e.data_points} pts)`:s("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=I(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){!this._entryId||!this._taskId||Promise.resolve().then(()=>(z(),O)).then(({openHistoryEditDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null})})}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return u;let t=this._lang;return n`
    ...
    `}_renderDetails(e){let t=this._lang,r=e.history||[],o=r.filter(p=>p.type==="completed"),l=o.reduce((p,g)=>p+(typeof g.cost=="number"?g.cost:0),0),d=(()=>{let p=o.map(g=>typeof g.duration=="number"?g.duration:null).filter(g=>g!=null);return p.length?Math.round(p.reduce((g,b)=>g+b,0)/p.length):null})();return n`
      <div class="details">
        ...
        ${r.length===0?n`<div class="history-empty">${s("history_empty",t)||"No history yet."}</div>`:n`
              <div class="history-list">
                ${[...r].reverse().slice(0,20).map(p=>{let g=["completed","reset","skipped"].includes(p.type);return n`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${p.type}">${s(p.type,t)}</span>
                        <span class="history-date">${Pt(p.timestamp,t)}</span>
                      ...
                      ${p.notes?n`<div class="history-notes">${p.notes}</div>`:u}
                      ${p.cost!=null||p.duration!=null?n`<div class="history-meta">
                            ${p.cost!=null?n`<span>💰 ${p.cost.toFixed(2)}</span>`:u}
                            ${p.duration!=null?n`<span>⏱️ ${p.duration}m</span>`:u}
                          </div>`:u}
                    </div>
                  `})}
                ${r.length>20?n`<div class="history-more">… +${r.length-20} ${s("older_entries",t)||"older"}</div>`:u}
              </div>
            `}
      </div>
    `}render(){if(!this._open)return u;let e=this._lang,t=this._task,r=this.hass?.user?.is_admin??!0;return n`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?n`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&Promise.resolve().then(()=>(z(),O)).then(({openObjectQuickActions:o})=>{o(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${t.next_due?n`<span><strong>${s("next_due",e)||"Next due"}:</strong> ${Z(t.next_due,e)}</span>`:u}
                  ${t.last_performed?n`<span><strong>${s("last_performed",e)||"Last"}:</strong> ${Z(t.last_performed,e)}</span>`:u}
                  ${t.schedule?.kind&&!["manual","one_time"].includes(t.schedule.kind)||t.interval_days!=null?n`<span><strong>${s("interval",e)||"Interval"}:</strong> ${zt(t,e)}</span>`:u}
                </div>
              </div>
              ...
              ${this._showSkip?n`
                  ...
                  `}
            `:n`<div class="loading">${s("loading",e)||"Loading\u2026"}</div>`}
      </div>
    `}};A.styles=[Ce,k`
    :host { display: contents; }
    .backdrop {
  ...
  `],c([f({attribute:!1})],A.prototype,"hass",2),c([h()],A.prototype,"_open",2),c([h()],A.prototype,"_entryId",2),c([h()],A.prototype,"_taskId",2),c([h()],A.prototype,"_task",2),c([h()],A.prototype,"_objectName",2),c([h()],A.prototype,"_busy",2),c([h()],A.prototype,"_error",2),c([h()],A.prototype,"_showSkip",2),c([h()],A.prototype,"_showReset",2),c([h()],A.prototype,"_showDetails",2),c([h()],A.prototype,"_showAdaptive",2),c([h()],A.prototype,"_skipReason",2),c([h()],A.prototype,"_resetDate",2),c([h()],A.prototype,"_features",2),c([h()],A.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",A)});var N,ii=y(()=>{"use strict";T();j();C();Q();N=class extends ${constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return this.hass?.language||"en"}async openFor(e){this._entryId=e,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=e}catch(e){this._error=I(e,this._lang)}}_onEditObject(){!this._entryId||!this._data||Promise.resolve().then(()=>(z(),O)).then(({openEditObjectDialog:e})=>{e(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&Promise.resolve().then(()=>(z(),O)).then(({openCreateTaskDialog:e})=>{e(),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let e=s("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(e)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=I(t,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let e=!!this._data.object.archived;if(!e){let t=s("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(t))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:e?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=I(t,this._lang)}finally{this._busy=!1}}_onTaskClick(e){this._entryId&&Promise.resolve().then(()=>(z(),O)).then(({openTaskQuickActions:t})=>{t(this._entryId,e)})}render(){if(!this._open)return u;let e=this._lang,t=this._data,r=t?.object,o=t?.tasks||[],l=this.hass?.user?.is_admin??!0;return n`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${t&&r?n`
              ...
              <div class="tasks-section">
                ...
                ${o.length===0?n`<div class="empty">${s("no_tasks",e)||"No tasks yet."}</div>`:n`
                      <div class="task-list">
                        ${o.map(d=>n`
                          <div class="task-row" @click=${()=>this._onTaskClick(d.id)}>
                            ...
                            <span class="task-status">${s(d.status||"ok",e)}</span>
                          </div>
                        `)}
                      </div>
                    `}
              ...
              ${l?n`
                    <div class="actions">
                      ...
                      <button class="btn" @click=${this._onArchiveObject} ?disabled=${this._busy}>
                        ...
                        ${r.archived?s("unarchive_object",e)||"Unarchive object":s("archive_object",e)||"Archive object"}
                      </button>
    ...
    `}_renderMetaRow(e){let t=this._lang,r=[];return e.area_id&&r.push([s("area",t),e.area_id]),e.manufacturer&&r.push([s("manufacturer",t),e.manufacturer]),e.model&&r.push([s("model",t),e.model]),e.serial_number&&r.push([s("serial_number_label",t),e.serial_number]),e.installation_date&&r.push([s("installed",t),e.installation_date]),e.warranty_expiry&&r.push([s("warranty",t),e.warranty_expiry]),e.documentation_url&&r.push([s("documentation_url_label",t),e.documentation_url]),r.length===0?u:n`
      <div class="meta">
        ${r.map(([o,l])=>n`
            <div class="meta-item">
              <span class="meta-label">${o}</span>
              <span class="meta-value">${/^https?:\/\//i.test(l)?n`<a href="${l}" target="_blank" rel="noopener noreferrer">${l}</a>`:l}</span>
            </div>
          `)}
      </div>
    `}};N.styles=k`
  ...
  `,c([f({attribute:!1})],N.prototype,"hass",2),c([h()],N.prototype,"_open",2),c([h()],N.prototype,"_entryId",2),c([h()],N.prototype,"_data",2),c([h()],N.prototype,"_busy",2),c([h()],N.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",N)});var O={};ui(O,{openCompleteDialog:()=>ar,openCreateObjectDialog:()=>Xe,openCreateTaskDialog:()=>et,openEditObjectDialog:()=>ir,openEditTaskDialog:()=>rr,openHistoryEditDialog:()=>sr,openObjectQuickActions:()=>nr,openQrDialog:()=>or,openTaskQuickActions:()=>tt});function He(){return document.querySelector("home-assistant")?.hass}function F(a){let i=document.body.querySelector(a);return i||(i=document.createElement(a),document.body.appendChild(i)),i}function W(a){let i=He();if(!i)return!1;a.hass=i;let e=i.language||"en";return Se(e)||Te(e).then(()=>{a.requestUpdate?.()}),!0}function oi(a){return Le||(Le=a.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(i=>({features:i.features??ri.features,defaultWarningDays:i.general?.default_warning_days??7})).catch(()=>ri),Le)}function Xe(){let a=F(si);return W(a)?(a.openCreate(),!0):!1}function ir(a,i){let e=F(si);return W(e)?(e.openEdit(a,i),!0):!1}function et(){let a=F(ai);if(!W(a))return!1;let i=He();return i?((async()=>{let e=await oi(i),t=a;t.checklistsEnabled=e.features.checklists,t.scheduleTimeEnabled=e.features.schedule_time,t.completionActionsEnabled=e.features.completion_actions,t.defaultWarningDays=e.defaultWarningDays,t.openCreate()})(),!0):!1}function rr(a,i){let e=F(ai);if(!W(e))return!1;let t=He();return t?((async()=>{try{let[r,o]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:a}),oi(t)]),l=(r.tasks||[]).find(p=>p.id===i);if(!l){console.warn(`openEditTaskDialog: task ${i} not found in entry ${a}`);return}let d=e;d.checklistsEnabled=o.features.checklists,d.scheduleTimeEnabled=o.features.schedule_time,d.completionActionsEnabled=o.features.completion_actions,d.defaultWarningDays=o.defaultWarningDays,await d.openEdit(a,l)}catch(r){console.warn("openEditTaskDialog: failed to load task/features",r)}})(),!0):!1}function sr(a){let i=F(Zi);return W(i)?(i.openEdit(a),!0):!1}function ar(a){let i=F(Qi);return W(i)?(i.entryId=a.entry_id,i.taskId=a.task_id,i.taskName=a.task_name,i.checklist=a.checklist??[],i.adaptiveEnabled=!!a.adaptive_enabled,i.lang=He()?.language||"en",i.open(),!0):!1}function or(a){let i=F(Xi);return W(i)?(i.openForTask(a.entry_id,a.task_id,a.object_name,a.task_name),!0):!1}function tt(a,i){let e=F(er);return W(e)?(e.openFor(a,i),!0):!1}function nr(a){let i=F(tr);return W(i)?(i.openFor(a),!0):!1}var si,ai,Zi,Qi,Xi,er,tr,ri,Le,z=y(()=>{"use strict";Mt();Ut();Ze();Ot();Wt();ti();ii();C();si="maintenance-object-dialog",ai="maintenance-task-dialog",Zi="maintenance-history-edit-dialog",Qi="maintenance-complete-dialog",Xi="maintenance-qr-dialog",er="maintenance-task-quick-actions-dialog",tr="maintenance-object-quick-actions-dialog";ri={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},Le=null});T();j();C();T();j();C();var Hi=["overdue","triggered","due_soon","ok"],D=class extends ${constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._loadingObjects=!0;this._loadError=!1;this._objectsLoaded=!1;this._onEntitiesChanged=e=>{this._valueChanged("entity_ids",e.detail.value||[])}}get _lang(){return this.hass?.language||"en"}setConfig(e){this._config={...e}}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._objectsLoaded&&(this._objectsLoaded=!0,this._loadObjects())}async _loadObjects(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._objects=e.objects||[],this._loadError=!1}catch{this._objects=[],this._loadError=!0}this._loadingObjects=!1}_valueChanged(e,t){let r={...this._config,[e]:t};Array.isArray(t)&&t.length===0&&delete r[e],this._config=r,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:r}}))}_toggleStatus(e,t){let r=new Set(this._config.filter_status||[]);t?r.add(e):r.delete(e),this._valueChanged("filter_status",[...r])}_toggleObject(e,t){let r=new Set(this._config.filter_objects||[]);t?r.add(e):r.delete(e),this._valueChanged("filter_objects",[...r])}render(){let e=this._lang,t=new Set(this._config.filter_status||[]),r=new Set(this._config.filter_objects||[]),o=[...this._objects].map(d=>d.object.name).sort((d,p)=>d.localeCompare(p)),l=[];for(let d of this._objects)for(let p of d.tasks)p.sensor_entity_id&&l.push(p.sensor_entity_id),p.binary_sensor_entity_id&&l.push(p.binary_sensor_entity_id);return n`
      <div class="editor">
        <ha-textfield
          label="${s("card_title",e)}"
        ...
        <div class="field">
          <div class="field-label">${s("card_filter_status",e)}</div>
          <div class="chip-row">
            ${Hi.map(d=>n`
          ...
          <div class="field-help">${s("card_filter_status_help",e)}</div>
        </div>

        <!-- Object filter (multi-checkbox) -->
        <div class="field">
          <div class="field-label">${s("card_filter_objects",e)}</div>
          ${this._loadingObjects?n`<div class="field-help">${s("card_loading_objects",e)}</div>`:this._loadError?n`<div class="field-help error-text">${s("card_load_error",e)}</div>`:o.length===0?n`<div class="field-help">${s("no_objects",e)}</div>`:n`
                ...
                <div class="field-help">${s("card_filter_objects_help",e)}</div>
              `}
        </div>
        ...
        <div class="field">
          <div class="field-label">${s("card_filter_entities",e)}</div>
          <ha-entities-picker
            .hass=${this.hass}
          ...
          ></ha-entities-picker>
          <div class="field-help">${s("card_filter_entities_help",e)}</div>
        </div>

        <ha-formfield label="${s("card_show_header",e)}">
          <ha-switch
        ...
        <ha-formfield label="${s("card_show_actions",e)}">
          <ha-switch
        ...
        <ha-formfield label="${s("card_compact",e)}">
          <ha-switch
  ...
  `,c([f({attribute:!1})],D.prototype,"hass",2),c([h()],D.prototype,"_config",2),c([h()],D.prototype,"_objects",2),c([h()],D.prototype,"_loadingObjects",2),c([h()],D.prototype,"_loadError",2);customElements.get("maintenance-supporter-card-editor")||customElements.define("maintenance-supporter-card-editor",D);Ze();z();var V=class extends ${constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._stats=null;this._unsub=null;this._dataLoaded=!1;this._lastConnection=null;this._onCompleted=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"en"}static getConfigElement(){return document.createElement("maintenance-supporter-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-card",show_header:!0,show_actions:!0,filter_status:["overdue","triggered","due_soon"],max_items:10}}setConfig(e){this._config=e}getCardSize(){return 3}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null}updated(e){super.updated(e);let t=this.hass?.language;if(t&&!Se(t)&&Te(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let r=t;this._objects=r.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}get _flatTasks(){let e=[],{filter_status:t,filter_objects:r,entity_ids:o,filter_due_min_days:l,filter_due_max_days:d,max_items:p}=this._config,g=o?.length?new Set(o):null,b=l!==void 0||d!==void 0;for(let x of this._objects)if(!(r?.length&&!r.includes(x.object.name))){for(let v of x.tasks)if(!v.is_done&&!(v.archived||x.object.archived)&&!(t?.length&&!t.includes(v.status))&&!(g&&!(v.sensor_entity_id&&g.has(v.sensor_entity_id)||v.binary_sensor_entity_id&&g.has(v.binary_sensor_entity_id)))){if(b){let w=v.days_until_due;if(w==null||l!==void 0&&w<l||d!==void 0&&w>d)continue}e.push({entry_id:x.entry_id,object_name:x.object.name,task:v})}}let m={overdue:0,triggered:1,due_soon:2,ok:3};return e.sort((x,v)=>{let w=(m[x.task.status]??9)-(m[v.task.status]??9);return w!==0?w:(x.task.days_until_due??1/0)-(v.task.days_until_due??1/0)}),p&&p>0?e.slice(0,p):e}_openTaskDetail(e,t){tt(e,t)}render(){let e=this._lang,t=this._config.title||s("maintenance",e),r=this._config.show_header!==!1,o=this._config.show_actions!==!1,l=this._config.compact||!1,d=this._flatTasks,p=this._stats;return n`
      <ha-card>
          ...
          <div class="header-right">
            ${r&&p?n`
                  <div class="header-stats">
                    ${p.overdue>0?n`<span class="badge overdue">${p.overdue}</span>`:u}
                    ${p.due_soon>0?n`<span class="badge due_soon">${p.due_soon}</span>`:u}
                    ${p.triggered>0?n`<span class="badge triggered">${p.triggered}</span>`:u}
                  </div>
                `:u}
            ${o?n`
                  <mwc-icon-button
                    class="hdr-add"
                    title="${s("new_object",e)}"
                    @click=${()=>Xe()}
                  >
        ...
        ${d.length===0?n`<div class="empty-card">
              <div>${s("card_no_tasks_title",e)}</div>
              <a class="empty-link" href="/maintenance-supporter">${s("card_no_tasks_cta",e)}</a>
            </div>`:n`
              <div class="task-list ${l?"compact":""}">
                ${d.map(({entry_id:g,object_name:b,task:m})=>n`
                    <div class="task-item clickable"
                         @click=${()=>this._openTaskDetail(g,m.id)}
                         title="${s("open_task",e)||"Open task"}">
                      <div class="status-dot" style="background: ${se[m.status]||"#ccc"}"></div>
                      <div class="task-info">
                        <div class="task-name">${m.name}</div>
                        ${l?u:n`<div class="task-meta">${b} · ${s(m.type,e)}</div>`}
                      </div>
                      <div class="task-due">
                        ${m.days_until_due!==null&&m.days_until_due!==void 0?m.days_until_due<0?n`<span class="overdue-text">${Math.abs(m.days_until_due)}${e.startsWith("de")?"T":"d"}</span>`:m.days_until_due===0?s("today",e):`${m.days_until_due}${e.startsWith("de")?"T":"d"}`:m.trigger_active?"\u26A1":"\u2014"}
                      </div>
                      ${o?n`
                            <mwc-icon-button
                              class="complete-btn"
