      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?o`<div class="used-parts">
                ...
                ${this.parts.map(t=>{let i=D({part_id:t.id,entry_id:t.entry_id}),a=this._usedParts[i],c=a!==void 0,d=t.entry_id?{part_id:t.id,quantity:1,entry_id:t.entry_id}:{part_id:t.id,quantity:1};return o`<div class="used-part-row">
                    ...
                    ${c?o`<input class="used-part-qty" type="number" min="0.01" max="999" step="0.01"
                          ...
                          @input=${h=>{let _=parseFloat(h.target.value);this._usedParts={...this._usedParts,[i]:{...d,quantity:Number.isFinite(_)&&_>=.01?_:1}}}} />`:u}
                  </div>`})}
...
`),this._requiredCompletion=[...t.required_completion_fields||[]],this._scheduleTime=t.schedule_time||"";let c=t.on_complete_action;if(c&&c.service){this._actionService=c.service;let _=c.target?.entity_id;this._actionTargetEntity=Array.isArray(_)?_[0]||"":_||"",this._actionData=c.data&&typeof c.data=="object"?{...c.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let d=t.quick_complete_defaults;this._qcNotes=d?.notes||"",this._qcCost=d?.cost!=null?String(d.cost):"",this._qcDuration=d?.duration!=null?String(d.duration):"",this._qcFeedback=d?.feedback||"";let h=t.adaptive_config||{};if(this._environmentalEntity=h.environmental_entity||"",this._environmentalAttribute=h.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,t.trigger_config){let _=t.trigger_config;this._triggerEntityId=_.entity_id||_.entity_ids&&_.entity_ids[0]||"",this._triggerEntityIds=_.entity_ids||(_.entity_id?[_.entity_id]:[]),this._triggerEntityLogic=_.entity_logic||"any",this._triggerAttribute=_.attribute||"",this._triggerType=_.type||"threshold",this._triggerAbove=_.trigger_above?.toString()||"",this._triggerBelow=_.trigger_below?.toString()||"",this._triggerForMinutes=_.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=_.trigger_target_value?.toString()||"",this._triggerDeltaMode=_.trigger_delta_mode||!1,this._triggerBaselineValue=_.trigger_baseline_value?.toString()||"",this._liveBaselineValue=t.trigger_baseline_value??null,this._autoCompleteOnRecovery=_.auto_complete_on_recovery||!1,this._triggerFromState=_.trigger_from_state||"",this._triggerToState=_.trigger_to_state||"",this._triggerTargetChanges=_.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=_.trigger_runtime_hours?.toString()||"",this._triggerOnStates=(_.trigger_on_states||[]).join(", "),_.type==="compound"?(this._compoundLogic=_.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(_.conditions||[]).map(xs)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._readingUnit="",this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._requiredCompletion=[],this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new ce(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}_toggleAssignee(e){this._assigneePool=this._assigneePool.includes(e)?this._assigneePool.filter(t=>t!==e):[...this._assigneePool,e]}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[t,i]=e.split(".");if(!this.hass?.services?.[t]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let a=this._actionTargetEntity.trim();if(a){let c=a.split(".")[0];if(c!==t&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(t)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${t}.* entities; entity "${a}" is in ${c}.* \u2014 pick a service that matches the entity domain (e.g. ${c}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[a]){this._actionTestResult="error",this._actionTestError=`Target entity "${a}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,i]=e.split("."),a=this.hass?.services?.[t]?.[i]?.fields;return!a||Object.keys(a).length===0?null:Object.entries(a).map(([c,d])=>({name:c,required:!!d.required,selector:d.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return u;let t=this._serviceSchema();return o`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${i=>{this._actionService=i.detail.value||"";let a=this._serviceSchema();if(a){let c=new Set(a.map(d=>d.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([d])=>c.has(d)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
...
`).map(h=>h.trim()).filter(Boolean).slice(0,100);e.checklist=d.length?d:null}if(this.completionActionsEnabled){let d=this._actionService.trim();if(d&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(d)){let f={service:d},y=this._actionTargetEntity.trim();y&&(f.target={entity_id:y});let g=this._buildActionData();Object.keys(g).length>0&&(f.data=g),e.on_complete_action=f}else e.on_complete_action=null;let h={};this._qcNotes.trim()&&(h.notes=this._qcNotes.trim());let _=parseFloat(this._qcCost);!isNaN(_)&&_>=0&&(h.cost=_);let v=parseInt(this._qcDuration,10);!isNaN(v)&&v>=0&&(h.duration=v),this._qcFeedback&&(h.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(h).length?h:null}let i=await this.hass.connection.sendMessagePromise(e),a=this._taskId||i?.task_id,c=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(a&&this._scheduleType==="sensor_based"&&c)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=P(e,this._lang,r("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return u;let e=this._lang,t=this._triggerType==="compound";return o`
    ...
    `}_renderCondition(e,t){let i=this._lang,a=t+1;return o`
      <div class="compound-condition">
        <div class="compound-condition-head">
          <span class="compound-condition-title">${r("compound_condition",i)} ${a}</span>
          <button
            type="button"
            class="icon-btn"
        ...
        <div class="select-row">
          ...
          >
            ${li.map(c=>o`<option value=${c} ?selected=${c===e.type}>${r(c,i)}</option>`)}
          </select>
        </div>
    ...
    `}_buildSchedule(){let e=i=>{let a=parseInt(this._calOffset,10)||0;return a&&(i.offset=Math.max(-15,Math.min(a,15))),i};if(this._scheduleType==="weekdays")return e({kind:"weekdays",weekdays:[...this._weekdays].sort((i,a)=>i-a)});if(this._scheduleType==="nth_weekday")return e({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let t={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(t.business=!0),e(t)}_recurrenceExtras(){let e={};if(this._seasonMonths.length&&(e.season_months=[...this._seasonMonths].sort((t,i)=>t-i)),this._endsMode==="count"){let t=parseInt(this._endsCount,10);t>=1&&(e.ends={count:t})}else this._endsMode==="until"&&this._endsUntil&&(e.ends={until:this._endsUntil});return e}_toggleSeasonMonth(e){this._seasonMonths=this._seasonMonths.includes(e)?this._seasonMonths.filter(t=>t!==e):[...this._seasonMonths,e]}_renderRecurrenceExtras(){let e=this._lang;if(!(this._scheduleType==="time_based"||pt.includes(this._scheduleType)))return u;let i=ks(e);return o`
      ...
      ${this._endsMode==="until"?o`
        ...
        ></ms-textfield>`:u}
    `}_renderCalendarFields(){let e=this._lang,t=$s(e);if(this._scheduleType==="weekdays")return o`
        ...
        <div class="select-row">
          ...
          <select .value=${this._nth} @change=${a=>this._nth=a.target.value}>
            ${i.map(([a,c])=>o`<option value=${a} ?selected=${a===this._nth}>${c}</option>`)}
          </select>
        </div>
        <div class="select-row">
          <label>${r("recurrence_weekday",e)}</label>
          <select .value=${this._nthWeekday} @change=${a=>this._nthWeekday=a.target.value}>
            ${t.map((a,c)=>o`<option value=${String(c)} ?selected=${String(c)===this._nthWeekday}>${a}</option>`)}
          </select>
        </div>
        ...
        <div class="content">
          ...
          ${this._scheduleType==="sensor_based"?o`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:ni,device_class:ai}}}]}
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),a.document.close()}_downloadSvg(e,t){let i=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),a=new Blob([i],{type:"image/svg+xml"}),c=URL.createObjectURL(a),d=document.createElement("a");d.href=c;let h=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;d.download=`qr-${Es(h)}-${t}.svg`,d.click(),URL.revokeObjectURL(c)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return o``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${r("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${r("qr_code",e)}: ${this._objectName}`,i=!!this._viewResult;return o`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
  ...
  `,l([b({attribute:!1})],H.prototype,"hass",2),l([b()],H.prototype,"lang",2),l([p()],H.prototype,"_open",2),l([p()],H.prototype,"_loading",2),l([p()],H.prototype,"_error",2),l([p()],H.prototype,"_viewResult",2),l([p()],H.prototype,"_completeResult",2),l([p()],H.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",H)});function ui(n,s){let e=n.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return u;let a=n.interval_days??0,c=n.suggested_interval??a;return o`
    ...
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${r("chart_weibull",i)}">
        ...
        ${e>0?oe`
          ...
          <circle cx="${C.toFixed(1)}" cy="${Ee.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(C+4).toFixed(1)}" y="${(Ee-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
  ...
  `}function Ts(n,s){return o`
    <div class="weibull-info-row">
      <div class="weibull-info-item">
        <span>${r("characteristic_life",s)}</span>
        <span class="weibull-info-value">${Math.round(n.weibull_eta)} ${r("days",s)}</span>
      </div>
  ...
  `}function Cs(n,s,e){let t=n.confidence_interval_low,i=n.confidence_interval_high,a=s.suggested_interval??s.interval_days??0,c=s.interval_days??0,d=Math.max(0,t-5),_=i+5-d,v=(t-d)/_*100,f=(i-t)/_*100,y=(a-d)/_*100,g=c>0?(c-d)/_*100:-1;return o`
    <div class="confidence-range">
      <div class="confidence-range-title">
        ${r("confidence_interval",e)}: ${a} ${r("days",e)} (${t}\u2013${i})
      </div>
      <div class="confidence-bar">
        <div class="confidence-fill" style="left:${v.toFixed(1)}%;width:${f.toFixed(1)}%"></div>
        ${g>=0?o`<div class="confidence-marker current" style="left:${g.toFixed(1)}%"></div>`:u}
  ...
  `}var _i=w(()=>{"use strict";I();L()});function gi(n,s,e){let t=n.degradation_trend!=null&&n.degradation_trend!=="insufficient_data",i=n.days_until_threshold!=null,a=n.environmental_factor!=null&&n.environmental_factor!==1;if(!t&&!i&&!a)return u;let c=n.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":n.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return o`
    <div class="prediction-section">
      ${n.sensor_prediction_urgency?o`
        <div class="prediction-urgency-banner">
          <ha-svg-icon path="M1,21H23L12,2L1,21M12,18A1,1 0 0,1 11,17A1,1 0 0,1 12,16A1,1 0 0,1 13,17A1,1 0 0,1 12,18M13,15H11V10H13V15Z"></ha-svg-icon>
          ${r("sensor_prediction_urgency",s).replace("{days}",String(Math.round(n.days_until_threshold||0)))}
        </div>
      `:u}
      ...
      <div class="prediction-grid">
        ${t?o`
          <div class="prediction-item">
            ...
            <span class="prediction-value ${n.degradation_trend}">${r("trend_"+n.degradation_trend,s)}</span>
            ${n.degradation_rate!=null?o`<span class="prediction-rate">${n.degradation_rate>0?"+":""}${Math.abs(n.degradation_rate)>=10?Math.round(n.degradation_rate).toLocaleString():n.degradation_rate.toFixed(1)} ${n.trigger_entity_info?.unit_of_measurement||""}/${r("day_short",s)}</span>`:u}
          </div>
        `:u}
        ${i?o`
          <div class="prediction-item">
            ...
            <span class="prediction-value prediction-days${n.days_until_threshold===0?" exceeded":n.sensor_prediction_urgency?" urgent":""}">${n.days_until_threshold===0?r("threshold_exceeded",s):"~"+Math.round(n.days_until_threshold)+" "+r("days",s)}</span>
            ${n.threshold_prediction_date?o`<span class="prediction-date">${W(n.threshold_prediction_date,s)}</span>`:u}
        ...
        ${a&&e.environmental?o`
          <div class="prediction-item">
            ...
            ${n.environmental_entity?o`<span class="prediction-entity entity-link" @click=${d=>ei(d,n.environmental_entity)}>${n.environmental_entity}</span>`:u}
          </div>
        `:u}
      </div>
    </div>
  `}var mi=w(()=>{"use strict";I();L()});function fi(n,s,e,t){let i=Math.max(n||1,s);return o`
    <div class="interval-comparison">
      <div class="interval-bar">
        <div class="interval-label">
          ${r("current",t)}: ${n??"\u2014"} ${n!=null?r("days",t):""}
        </div>
  ...
  `}var vi=w(()=>{"use strict";I();L()});function yi(n,s,e){if(!e.seasonal||!n.seasonal_factor||n.seasonal_factor===1)return u;let t=bi.map(d=>r(d,s)),i=new Date().getMonth(),a=n.seasonal_factors||n.interval_analysis?.seasonal_factors||null,c=a&&a.length===12?a:t.map((d,h)=>{let _=n.seasonal_factor||1,v=Math.sin((h-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,_+v))});return o`
    <div class="seasonal-card-compact">
      <h4>${r("seasonal_awareness",s)}</h4>
      <div class="seasonal-mini-chart">
        ${c.map((d,h)=>{let _=d*40,v=d<.9?"low":d>1.1?"high":"normal";return o`
  ...
  `}function xi(n,s){return Ls(n,s)}function Ls(n,s){let e=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return u;let t=n.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,c=100,d=8,_=c-d-4,v=Math.max(...e,1.5),f=a/12,y=f*.65,g=d+_-1/v*_;return o`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${a} ${c}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${r("chart_seasonal",s)}">
        <line x1="0" y1="${g.toFixed(1)}" x2="${a}" y2="${g.toFixed(1)}"
          stroke="var(--divider-color)" stroke-width="1" stroke-dasharray="4,3" />
        ${e.map((x,N)=>{let j=x/v*_,S=N*f+(f-y)/2,C=d+_-j,ke=N===i,Ee=x<1?"var(--success-color, #4caf50)":x>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return oe`
  ...
  `}var bi,wi=w(()=>{"use strict";I();L();bi=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var T,$i=w(()=>{"use strict";I();z();L();re();_i();mi();vi();wi();T=class extends k{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(i=>i.id===this._taskId);this._task=t??null}catch(e){this._error=P(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=P(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(U(),G)).then(({openCompleteDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(U(),G)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(U(),G)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=r("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=r("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${r("reanalyze_result",this._lang)||"Recomputed"}: ${je(e.recommended_interval,"days",this._lang)} (${e.data_points} pts)`:r("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=P(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){!this._entryId||!this._taskId||Promise.resolve().then(()=>(U(),G)).then(({openHistoryEditDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null})})}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return u;let t=this._lang;return o`
    ...
    `}_renderAdaptive(e){let t=this._lang,i=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,a=e.degradation_trend!=null&&e.degradation_trend!=="insufficient_data"||e.days_until_threshold!=null||e.environmental_factor!=null&&e.environmental_factor!==1,c=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,d=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1;return!i&&!a&&!c&&!d?o`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${a?gi(e,t,this._features):u}
        ${c?ui(e,t):u}
        ${d?o`
          ${yi(e,t,this._features)}
          ${e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12?xi(e,t):u}
        `:u}
      </div>
    `}_renderDetails(e){let t=this._lang,i=e.history||[],a=i.filter(h=>h.type==="completed"),c=a.reduce((h,_)=>h+(typeof _.cost=="number"?_.cost:0),0),d=(()=>{let h=a.map(_=>typeof _.duration=="number"?_.duration:null).filter(_=>_!=null);return h.length?Math.round(h.reduce((_,v)=>_+v,0)/h.length):null})();return o`
      <div class="details">
                ...
                ${[...i].reverse().slice(0,20).map(h=>{let _=["completed","reset","skipped"].includes(h.type);return o`
                    <div class="history-entry">
                      <div class="history-line">
                        ...
                        <span class="history-date">${Zt(h.timestamp,t)}</span>
                      ...
                      ${h.notes?o`<div class="history-notes">${h.notes}</div>`:u}
                      ${h.cost!=null||h.duration!=null?o`<div class="history-meta">
                            ${h.cost!=null?o`<span>💰 ${h.cost.toFixed(2)}</span>`:u}
                            ${h.duration!=null?o`<span>⏱️ ${h.duration}m</span>`:u}
                          </div>`:u}
                    </div>
                  `})}
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?o`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&Promise.resolve().then(()=>(U(),G)).then(({openObjectQuickActions:a})=>{a(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${t.next_due?o`<span><strong>${r("next_due",e)||"Next due"}:</strong> ${W(t.next_due,e)}</span>`:u}
                  ${t.last_performed?o`<span><strong>${r("last_performed",e)||"Last"}:</strong> ${W(t.last_performed,e)}</span>`:u}
                  ${t.schedule?.kind&&!["manual","one_time"].includes(t.schedule.kind)||t.interval_days!=null?o`<span><strong>${r("interval",e)||"Interval"}:</strong> ${Xt(t,e)}</span>`:u}
                </div>
              </div>
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${t&&i?o`
              ...
              <div class="tasks-section">
                ...
                ${a.length===0?o`<div class="empty">${r("no_tasks",e)||"No tasks yet."}</div>`:o`
                      <div class="task-list">
                        ${a.map(d=>o`
      ...
      <div class="meta">
        ${i.map(([a,c])=>o`
            <div class="meta-item">
              ...
              <span class="meta-value">${ki(c)?o`<a href="${c}" target="_blank" rel="noopener noreferrer">${c}</a>`:c}</span>
            </div>
          `)}
      </div>
    `}};V.styles=E`
  ...
  `,l([b({attribute:!1})],V.prototype,"hass",2),l([p()],V.prototype,"_open",2),l([p()],V.prototype,"_entryId",2),l([p()],V.prototype,"_data",2),l([p()],V.prototype,"_busy",2),l([p()],V.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",V)});var G={};qi(G,{openCompleteDialog:()=>Os,openCreateObjectDialog:()=>ut,openCreateTaskDialog:()=>_t,openEditObjectDialog:()=>qs,openEditTaskDialog:()=>Ms,openHistoryEditDialog:()=>zs,openObjectQuickActions:()=>Fs,openQrDialog:()=>Ds,openTaskQuickActions:()=>gt});function Fe(){return document.querySelector("home-assistant")?.hass}function Hs(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function Y(n){let s=Hs(),e=s.querySelector(n)??document.body.querySelector(n);return e?e.parentNode!==s&&s.appendChild(e):(e=document.createElement(n),s.appendChild(e)),e}function J(n){let s=Fe();if(!s)return!1;n.hass=s;let e=s.language||"en";return He(e)||qe(e).then(()=>{n.requestUpdate?.()}),!0}function Li(n){return De||(De=n.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(s=>({features:s.features??Ai.features,defaultWarningDays:s.general?.default_warning_days??7})).catch(()=>Ai),De)}function ut(){let n=Y(Ti);return J(n)?(n.openCreate(),!0):!1}function qs(n,s){let e=Y(Ti);return J(e)?(e.openEdit(n,s),!0):!1}function _t(){let n=Y(Ci);if(!J(n))return!1;let s=Fe();return s?((async()=>{let e=await Li(s),t=n;t.checklistsEnabled=e.features.checklists,t.scheduleTimeEnabled=e.features.schedule_time,t.completionActionsEnabled=e.features.completion_actions,t.defaultWarningDays=e.defaultWarningDays,t.openCreate()})(),!0):!1}function Ms(n,s){let e=Y(Ci);if(!J(e))return!1;let t=Fe();return t?((async()=>{try{let[i,a]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:n}),Li(t)]),c=(i.tasks||[]).find(h=>h.id===s);if(!c){console.warn(`openEditTaskDialog: task ${s} not found in entry ${n}`);return}let d=e;d.checklistsEnabled=a.features.checklists,d.scheduleTimeEnabled=a.features.schedule_time,d.completionActionsEnabled=a.features.completion_actions,d.defaultWarningDays=a.defaultWarningDays,await d.openEdit(n,c)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function zs(n){let s=Y(Is);return J(s)?(s.openEdit(n),!0):!1}function Os(n){let s=Y(Ps);return J(s)?(s.entryId=n.entry_id,s.taskId=n.task_id,s.taskName=n.task_name,s.checklist=n.checklist??[],s.adaptiveEnabled=!!n.adaptive_enabled,s.requiredFields=n.required_completion_fields??[],s.lang=Fe()?.language||"en",s.open(),!0):!1}function Ds(n){let s=Y(Rs);return J(s)?(s.openForTask(n.entry_id,n.task_id,n.object_name,n.task_name),!0):!1}function gt(n,s){let e=Y(js);return J(e)?(e.openFor(n,s),!0):!1}function Fs(n){let s=Y(Ns);return J(s)?(s.openFor(n),!0):!1}var Ti,Ci,Is,Ps,Rs,js,Ns,Ai,De,U=w(()=>{"use strict";ri();ci();lt();di();hi();$i();Si();L();Ti="maintenance-object-dialog",Ci="maintenance-task-dialog",Is="maintenance-history-edit-dialog",Ps="maintenance-complete-dialog",Rs="maintenance-qr-dialog",js="maintenance-task-quick-actions-dialog",Ns="maintenance-object-quick-actions-dialog";Ai={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},De=null});I();var Qi=["assignee_pool","required_completion_fields","checklist","labels","history"],Zi=["checklist_progress"],Xi=["tasks","parts"],es=["manual_docs","battery_fleet_excluded"];function it(n,s,e=[]){for(let t of s)n[t]===void 0&&(n[t]=[]);for(let t of e)n[t]===void 0&&(n[t]={})}function ts(n){let s=n;it(s,Xi),s.object&&typeof s.object=="object"&&it(s.object,es);for(let e of s.tasks)it(e,Qi,Zi);return n}function ye(n){for(let s of n)ts(s);return n}function is(n,s){if(s.objects)return s.objects;let e=s.delta||[],t=s.removed||[];if(!e.length&&!t.length)return null;let i=new Map(n.map(a=>[a.entry_id,a]));for(let a of e)i.set(a.entry_id,a);for(let a of t)i.delete(a);return[...i.values()]}function qt(n,s){return s.objects&&ye(s.objects),s.delta&&ye(s.delta),is(n,s)}z();L();at();ze();I();z();L();var ps=["overdue","triggered","due_soon","ok"],F=class extends k{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._loadingObjects=!0;this._loadError=!1;this._views=[];this._objectsLoaded=!1;this._onEntitiesChanged=e=>{this._valueChanged("entity_ids",e.detail.value||[])}}get _lang(){return this.hass?.language||"en"}setConfig(e){this._config={...e}}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._objectsLoaded&&(this._objectsLoaded=!0,this._loadObjects())}async _loadObjects(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._objects=e.objects||[],this._loadError=!1}catch{this._objects=[],this._loadError=!0}this._loadingObjects=!1;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"});this._views=e.views||[]}catch{this._views=[]}}_valueChanged(e,t){let i={...this._config,[e]:t};(Array.isArray(t)&&t.length===0||t==="")&&delete i[e],this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i}}))}_toggleStatus(e,t){let i=new Set(this._config.filter_status||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_status",[...i])}_toggleObject(e,t){let i=new Set(this._config.filter_objects||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_objects",[...i])}_toggleLabel(e,t){let i=new Set(this._config.filter_labels||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_labels",[...i])}_toggleArea(e,t){let i=new Set(this._config.filter_areas||[]);t?i.add(e):i.delete(e),this._valueChanged("filter_areas",[...i])}render(){let e=this._lang,t=new Set(this._config.filter_status||[]),i=new Set(this._config.filter_objects||[]),a=[...this._objects].map(g=>g.object.name).sort((g,x)=>g.localeCompare(x)),c=new Set(this._config.filter_areas||[]),d=[...new Set(this._objects.map(g=>g.object.area_id).filter(g=>!!g).concat([...c]))],h=g=>this.hass?.areas?.[g]?.name||g,_=d.map(g=>({id:g,name:h(g)})).sort((g,x)=>g.name.localeCompare(x.name)),v=new Set(this._config.filter_labels||[]),f=[...new Set(this._objects.flatMap(g=>g.tasks.flatMap(x=>x.labels||[])))].sort((g,x)=>g.localeCompare(x)),y=[];for(let g of this._objects)for(let x of g.tasks)x.sensor_entity_id&&y.push(x.sensor_entity_id),x.binary_sensor_entity_id&&y.push(x.binary_sensor_entity_id);return o`
      <div class="editor">
        <ha-textfield
        ...
        <div class="field">
          ...
          ${this._loadingObjects?o`<div class="field-help">${r("card_loading_objects",e)}</div>`:this._loadError?o`<div class="field-help error-text">${r("card_load_error",e)}</div>`:a.length===0?o`<div class="field-help">${r("no_objects",e)}</div>`:o`
  ...
  `,l([b({attribute:!1})],F.prototype,"hass",2),l([p()],F.prototype,"_config",2),l([p()],F.prototype,"_objects",2),l([p()],F.prototype,"_loadingObjects",2),l([p()],F.prototype,"_loadError",2),l([p()],F.prototype,"_views",2);customElements.get("maintenance-supporter-card-editor")||customElements.define("maintenance-supporter-card-editor",F);lt();U();var q=class extends k{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-card"};this._objects=[];this._stats=null;this._unsub=null;this._viewFilters=null;this._userNames={};this._userService=null;this._userNamesLoaded=!1;this._taskDocs={};this._docsLoadedFor=new Set;this._dataLoaded=!1;this._lastConnection=null;this._onCompleted=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"en"}static getConfigElement(){return document.createElement("maintenance-supporter-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-card",show_header:!0,show_actions:!0,filter_status:["overdue","triggered","due_soon"],max_items:10}}setConfig(e){let t=e.view_id!==this._config.view_id;this._config=e,t&&this._dataLoaded&&this.hass&&this._loadViewFilters()}getCardSize(){return 3}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null}updated(e){super.updated(e),e.has("hass")&&Jt(this.hass?.locale);let t=this.hass?.language;if(t&&!He(t)&&qe(t).then(()=>this.requestUpdate()),this.hass&&!this._userNamesLoaded&&this._config.show_assignee!==!1&&this._objects.some(i=>i.tasks.some(a=>a.responsible_user_id))&&this._loadUserNames(),this.hass&&this._config.show_documents!==!1)for(let i of this._objects)this._docsLoadedFor.has(i.entry_id)||i.tasks.some(a=>(a.document_count??0)>0)&&this._loadDocuments(i.entry_id);if(e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=ye(e.objects),this._stats=t}catch{}await this._loadViewFilters()}_assigneeName(e){if(this._config.show_assignee===!1)return"";let t=e.responsible_user_id;return t&&this._userNames[t]||""}async _loadUserNames(){this._userNamesLoaded=!0,this._userService?this._userService.updateHass(this.hass):this._userService=new ce(this.hass);try{let e=await this._userService.getUsers();this._userNames=Object.fromEntries(e.map(t=>[t.id,t.name]))}catch{}}async _loadDocuments(e){this._docsLoadedFor.add(e);try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:e}),i={};for(let a of t.documents||[])for(let c of a.task_ids||[])(i[c]||=[]).push({id:a.id,title:a.title,kind:a.kind,url:a.url});this._taskDocs={...this._taskDocs,[e]:i}}catch{}}_docsFor(e,t){if(this._config.show_documents===!1)return[];let a=[...this._taskDocs[e]?.[t.id]||[]];return t.documentation_url&&a.push({id:`url:${t.id}`,title:r("documentation_label",this._lang),kind:"weblink",url:t.documentation_url}),a}async _openDoc(e){if(e.kind==="weblink"&&e.url){window.open(e.url,"_blank","noopener");return}let t=window.open("about:blank","_blank");try{let i=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:300});t&&(t.location.href=new URL(i.path,window.location.origin).href)}catch{t&&t.close()}}async _loadViewFilters(){if(!this._config.view_id){this._viewFilters=null;return}try{let t=((await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"})).views||[]).find(i=>i.id===this._config.view_id);this._viewFilters=t?t.filters:null}catch{this._viewFilters=null}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=qt(this._objects,t);i!==null&&(this._objects=i)},{type:"maintenance_supporter/subscribe",deltas:!0,compact:!0});if(!this.isConnected){e();return}this._unsub=e}catch{}}get _flatTasks(){let e=[],{filter_status:t,filter_objects:i,entity_ids:a,filter_due_min_days:c,filter_due_max_days:d,filter_labels:h,filter_areas:_,max_items:v}=this._config,f=a?.length?new Set(a):null,y=c!==void 0||d!==void 0,g=this._viewFilters,x=g?.user_id==="current_user"?this.hass.user?.id??null:g?.user_id??null;for(let j of this._objects)if(!(i?.length&&!i.includes(j.object.name))){if(_?.length){let S=j.object.area_id;if(!S||!_.includes(S))continue}for(let S of j.tasks)if(!S.is_done&&!(S.archived||j.object.archived)&&!(t?.length&&!t.includes(S.status))&&!(h?.length&&!(S.labels||[]).some(C=>h.includes(C)))&&!(f&&!(S.sensor_entity_id&&f.has(S.sensor_entity_id)||S.binary_sensor_entity_id&&f.has(S.binary_sensor_entity_id)))){if(y){let C=S.days_until_due;if(C==null||c!==void 0&&C<c||d!==void 0&&C>d)continue}g&&(g.status&&S.status!==g.status||g.label&&!(S.labels||[]).includes(g.label)||x&&S.responsible_user_id!==x)||e.push({entry_id:j.entry_id,object_name:j.object.name,task:S})}}let N={overdue:0,triggered:1,due_soon:2,ok:3};return e.sort((j,S)=>{let C=(N[j.task.status]??9)-(N[S.task.status]??9);return C!==0?C:(j.task.days_until_due??1/0)-(S.task.days_until_due??1/0)}),v&&v>0?e.slice(0,v):e}_openTaskDetail(e,t){gt(e,t)}render(){let e=this._lang,t=this._config.title||r("maintenance",e),i=this._config.show_header!==!1,a=this._config.show_actions!==!1,c=this._config.compact||!1,d=this._flatTasks,h=this._stats;return o`
      <ha-card>
          ...
          <div class="header-right">
            ${i&&h?o`
                  <div class="header-stats">
                    ${h.overdue>0?o`<span class="badge overdue">${h.overdue}</span>`:u}
                    ${h.due_soon>0?o`<span class="badge due_soon">${h.due_soon}</span>`:u}
                    ${h.triggered>0?o`<span class="badge triggered">${h.triggered}</span>`:u}
                  </div>
                `:u}
            ${a?o`
                  <mwc-icon-button
        ...
        ${d.length===0?this._objects.some(_=>_.tasks.length>0)?o`<div class="empty-card">
              ...
              <div class="task-list ${c?"compact":""}">
                ${d.map(({entry_id:_,object_name:v,task:f})=>o`
                    <div class="task-item clickable"
                      ...
                      <div class="task-due">
                        ${f.days_until_due!==null&&f.days_until_due!==void 0?f.days_until_due<0?o`<span class="overdue-text">${nt(f.days_until_due,e)}</span>`:nt(f.days_until_due,e):f.trigger_active?"\u26A1":"\u2014"}
                      </div>
                      ${a?o`
                            <mwc-icon-button
                              class="complete-btn"
                              title="${r("complete",e)}"
                              @click=${y=>{y.stopPropagation();let g=this.shadowRoot.querySelector("maintenance-complete-dialog");g.entryId=_,g.taskId=f.id,g.taskName=f.name,g.checklist=f.checklist||[],g.adaptiveEnabled=!!f.adaptive_config?.enabled,g.taskType=f.type||"",g.readingUnit=f.reading_unit||"",g.requiredFields=f.required_completion_fields||[],g.lang=e;let x=!!f.part_ref;g.parts=x?[]:ii(f,_,this._objects,e),g.consumesParts=x?[]:f.consumes_parts||[],g.open()}}
                            >
                              <ha-icon icon="mdi:check"></ha-icon>
                            </mwc-icon-button>
                          `:u}
