...
import"/maintenance_supporter_panelfiles/panel-chunks/chunk-6CM3ZIHM.js";import{b as Nt,c as oe}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-3FYWLAW5.js";import{a as E}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-MEKM6THN.js";import{a as se,b as ae,c as ne,d as re,e as Ct}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-JBZVB6GP.js";import{a as le}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-URNT5464.js";import{a as _,b as D,c as r,d as P,f as d,g as L,h as ee,i as T,j as m,k as jt,l as Mt,m as ut,n as s,o as St,p as q,q as Et,r as Y,s as Dt,t as _t,v as xt,w as mt,x as ie,y as Lt}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-4MVSRJ3Y.js";function it(n){return!!n&&/^https?:\/\//i.test(n)}function ce(n,o){if(o.objects)return o.objects;let t=o.delta||[],e=o.removed||[];if(!t.length&&!e.length)return null;let i=new Map(n.map(a=>[a.entry_id,a]));for(let a of t)i.set(a.entry_id,a);for(let a of e)i.delete(a);return[...i.values()]}var At="2.53.0";function de(n,o=At){return!n||!o||o==="dev"?!1:n!==o}var F={overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view",objectsCache:"msp-objects-cache"};var He=168*3600*1e3;function pe(){try{let n=localStorage.getItem(F.objectsCache);if(!n)return null;let o=JSON.parse(n);return o.v!==At||!Number.isFinite(o.at)||Date.now()-o.at>He||!Array.isArray(o.objects)||o.objects.length===0?null:{objects:o.objects,stats:o.stats??null}}catch{return null}}function Wt(n,o){if(!(!Array.isArray(n)||n.length===0))try{let t={v:At,at:Date.now(),objects:n,stats:o};localStorage.setItem(F.objectsCache,JSON.stringify(t))}catch{}}var Fe=["assignee_pool","required_completion_fields","checklist","labels","history"],Be=["checklist_progress"],Ve=["tasks","parts"],Ue=["manual_docs","battery_fleet_excluded"];function qt(n,o,t=[]){for(let e of o)n[e]===void 0&&(n[e]=[]);for(let e of t)n[e]===void 0&&(n[e]={})}function Ne(n){let o=n;qt(o,Ve),o.object&&typeof o.object=="object"&&qt(o.object,Ue);for(let t of o.tasks)qt(t,Fe,Be);return n}function Rt(n){for(let o of n)Ne(o);return n}var We={days:1,weeks:7,months:30.4368,years:365.25};function Yt(n,o){return!n||n<=0?0:n*(We[o||"days"]??1)}function Ot(n,o,t){let e=Yt(n,t);if(e<=0||o==null)return{pct:0,overflow:!1};let i=(e-o)/e*100;return{pct:Math.max(0,Math.min(100,i)),overflow:i>100}}function A(n){return String(n??"").replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o])}function he(n,o,t,e,i,a){let l=[[t.manufacturer,n.manufacturer],[t.model,n.model],[t.serial,n.serial_number],[t.installed,n.installation_date?e(n.installation_date):null],[t.warranty,n.warranty_expiry?e(n.warranty_expiry):null]].filter(([,p])=>!!p),h=o.map(p=>{let u=t.scheduleLabel(p);return`<tr>
      <td>${A(p.name)}</td>
    ...
    </tr>`}).join(""),c=o.reduce((p,u)=>p+(u.total_cost??0),0);return`<!DOCTYPE html><html><head><meta charset="utf-8">
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  <h2>${A(t.tasksHeading)} (${o.length})</h2>
  <table>
    <thead><tr>
...
${A(n.notes)}</div>`:""}
</body></html>`}function Kt(n,o=new Date){if(!n)return{kind:"none",days:null,date:null};let t=new Date(`${n}T00:00:00`);if(isNaN(t.getTime()))return{kind:"none",days:null,date:null};let e=Date.UTC(o.getFullYear(),o.getMonth(),o.getDate()),i=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),a=Math.round((i-e)/864e5);return a<0?{kind:"expired",days:a,date:n}:a<=60?{kind:"expiring",days:a,date:n}:{kind:"valid",days:a,date:n}}var z=n=>String(n??"").replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o]);function ue(n,o,t,e,i,a,l,h,c,p=[]){let u=[[t.object,z(o)],[t.type,z(t.typeLabel(n.type))],[t.interval,z(i(n))],[t.nextDue,n.next_due?z(e(n.next_due)):"\u2014"],[t.lastDone,n.last_performed?z(e(n.last_performed)):z(t.never)]];n.priority&&n.priority!=="normal"&&u.push([t.priority,z(n.priority)]);let g=(n.checklist||[]).map(b=>`<li><span class="box"></span>${z(b)}</li>`).join(""),v=(b,x)=>b?`<figure class="qr"><img src="${b}" alt="" /><figcaption>${z(x)}</figcaption></figure>`:"";return`<!DOCTYPE html>
...
<body>
  ...
  ${g?`<h2>${z(t.checklist)}</h2><ul class="check">${g}</ul>`:""}
...
`;var Pt=class{constructor(o){this._cache=new Map;this._pending=new Map;this._hass=o}updateHass(o){this._hass=o}async getDetailStats(o,t,e=30){return this._getStats(o,e<=35?"hour":"day",e,t)}async getMiniStats(o,t){return this._getStats(o,"day",14,t)}async getBatchMiniStats(o){let t=new Map,e=[];for(let c of o){let p=`${c.entityId}:day:14`,u=this._cache.get(p);u&&Date.now()-u.fetchedAt<3e5?t.set(c.entityId,u.points):e.push(c)}if(e.length===0)return t;let i=e.filter(c=>c.isCounter).map(c=>c.entityId),a=e.filter(c=>!c.isCounter).map(c=>c.entityId),l=new Date(Date.now()-336*60*60*1e3).toISOString(),h=[];return i.length>0&&h.push(this._fetchBatch(i,"day",l,["state","sum","change"],!0,t)),a.length>0&&h.push(this._fetchBatch(a,"day",l,["mean","min","max"],!1,t)),await Promise.all(h),t}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(o,t,e,i){let a=`${o}:${t}:${e}`,l=this._cache.get(a);if(l&&Date.now()-l.fetchedAt<3e5)return l.points;if(this._pending.has(a))return this._pending.get(a);let h=this._fetchAndNormalize(o,t,e,i,a);this._pending.set(a,h);try{return await h}finally{this._pending.delete(a)}}async _fetchAndNormalize(o,t,e,i,a){let l=new Date(Date.now()-e*24*60*60*1e3).toISOString(),h=i?["state","sum","change"]:["mean","min","max"];try{let p=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:l,statistic_ids:[o],period:t,types:h}))[o]||[],u=this._normalizeRows(p,i);return this._cache.set(a,{entityId:o,fetchedAt:Date.now(),period:t,points:u}),u}catch(c){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${o}:`,c),[]}}async _fetchBatch(o,t,e,i,a,l){try{let h=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:e,statistic_ids:o,period:t,types:i});for(let c of o){let p=h[c]||[],u=this._normalizeRows(p,a);l.set(c,u),this._cache.set(`${c}:${t}:14`,{entityId:c,fetchedAt:Date.now(),period:t,points:u})}}catch(h){console.warn("[maintenance-supporter] Batch statistics fetch failed:",h)}}_normalizeRows(o,t){let e=[];for(let i of o){let a=null;if(t?a=i.state??null:a=i.mean??null,a===null)continue;let l={ts:i.start,val:a};t||(i.min!=null&&(l.min=i.min),i.max!=null&&(l.max=i.max)),e.push(l)}return e.sort((i,a)=>i.ts-a.ts),e}};function ot(n){let o=n??0;return o<1024?`${o} B`:o<1024*1024?`${(o/1024).toFixed(1)} KB`:`${(o/(1024*1024)).toFixed(1)} MB`}var zt=["manual","warranty","invoice","spare_parts","photo","other"],qe={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"},B=class extends L{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._hint="";this._addingLink=!1;this._linkUrl="";this._linkTitle="";this._category="manual";this._thumbs={};this._lightboxUrl="";this._editingId="";this._editTitle="";this._editCategory="manual";this._dragOver=!1;this._loadedFor=null;this._localeReady=!1}_isImage(t){return t.kind==="file"&&(t.mime||"").startsWith("image/")}async _sign(t){return(await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${t.id}`,expires:300})).path}get _lang(){return this.hass?.language||"en"}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,q(this._lang).then(()=>this.requestUpdate())),this.hass&&this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error="",this._thumbs={},this._loadThumbs()}catch(t){this._error=E(t,this._lang),this._loaded=!0}}async _loadThumbs(){await Promise.all(this._docs.filter(t=>this._isImage(t)).map(async t=>{try{let e=await this._sign(t);this._thumbs={...this._thumbs,[t.id]:e}}catch{}}))}_category_of(t){return(t.tags||[]).find(i=>zt.includes(i))||"other"}_labelKeydown(t){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),t.currentTarget.querySelector("input")?.click())}_onFileInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i),e.value=""}_onCameraInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i,"photo"),e.value=""}_onDrop(t){if(t.preventDefault(),this._dragOver=!1,!this.canWrite||this._busy)return;let e=Array.from(t.dataTransfer?.files??[]);e.length&&this._uploadFiles(e)}_onDragOver(t){this.canWrite&&(t.preventDefault(),this._dragOver=!0)}_onDragLeave(t){let e=t.relatedTarget;(!e||!t.currentTarget.contains(e))&&(this._dragOver=!1)}async _uploadFiles(t,e){let i=e??this._category;this._busy=!0,this._error="",this._hint="";let a=0,l=0;try{for(let h of t){let c=new FormData;c.append("entry_id",this.entryId),c.append("tags",i),c.append("file",h,h.name);let p=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:c});if(!p.ok){this._error=p.status===413?s("doc_too_large",this._lang):s("doc_upload_failed",this._lang);continue}let u=await p.json();u.duplicate_in_object?l++:u.deduped&&a++}l?this._hint=s("doc_dup_in_object",this._lang):a&&(this._hint=s("doc_deduped",this._lang)),await this._load()}catch{this._error=s("doc_upload_failed",this._lang)}finally{this._busy=!1}}async _download(t){try{let e=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${t.id}`,expires:30});Ct(e.path,t.filename||t.title||"document")}catch(e){this._error=E(e,this._lang)}}async _preview(t){if(this._isImage(t)){this._lightboxUrl=this._thumbs[t.id]||await this._sign(t);return}let e=window.open("about:blank","_blank");try{let i=await this._sign(t);e&&(e.location.href=new URL(i,window.location.origin).href)}catch(i){e&&e.close(),this._error=E(i,this._lang)}}_openDoc(t){t.kind==="file"?this._preview(t):it(t.url)&&window.open(t.url,"_blank","noopener")}_startEdit(t){this._editingId=t.id,this._editTitle=t.title||"",this._editCategory=this._category_of(t),this._addingLink=!1,this._error=""}_cancelEdit(){this._editingId=""}async _saveEdit(t){let e=(t.tags||[]).filter(a=>!zt.includes(a)),i=t.kind==="file"?[this._editCategory,...e]:t.tags??[];this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,title:this._editTitle.trim()||t.filename||t.url||"",tags:i}),this._editingId="",await this._load()}catch(a){this._error=E(a,this._lang)}finally{this._busy=!1}}async _delete(t){let e=t.title||t.filename||t.url||"";if(window.confirm(s("doc_delete_confirm",this._lang).replace("{name}",e))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:t.id}),await this._load()}catch(i){this._error=E(i,this._lang)}finally{this._busy=!1}}}async _addLink(){let t=this._linkUrl.trim();if(t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/add_link",entry_id:this.entryId,url:t,title:this._linkTitle.trim()||null}),this._linkUrl="",this._linkTitle="",this._addingLink=!1,await this._load()}catch(e){this._error=E(e,this._lang,s("doc_link_invalid",this._lang))}finally{this._busy=!1}}}render(){let t=this._lang;return r`
    ...
    `}_renderDoc(t,e){if(this._editingId===t.id)return this._renderEdit(t,e);let i=t.kind==="file",a=this._category_of(t),l=i?`${s(`doc_cat_${a}`,e)} \xB7 ${ot(t.size)}`:s("doc_link_badge",e),h=this._thumbs[t.id];return r`
      <div class="doc-row">
        ${i&&h?r`<img
              class="doc-thumb"
              src=${h}
  ...
  `,_([T({attribute:!1})],B.prototype,"hass",2),_([T({attribute:!1})],B.prototype,"entryId",2),_([T({type:Boolean})],B.prototype,"canWrite",2),_([m()],B.prototype,"_docs",2),_([m()],B.prototype,"_loaded",2),_([m()],B.prototype,"_busy",2),_([m()],B.prototype,"_error",2),_([m()],B.prototype,"_hint",2),_([m()],B.prototype,"_addingLink",2),_([m()],B.prototype,"_linkUrl",2),_([m()],B.prototype,"_linkTitle",2),_([m()],B.prototype,"_category",2),_([m()],B.prototype,"_thumbs",2),_([m()],B.prototype,"_lightboxUrl",2),_([m()],B.prototype,"_editingId",2),_([m()],B.prototype,"_editTitle",2),_([m()],B.prototype,"_editCategory",2),_([m()],B.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",B);var Ye=["manual","warranty","invoice","spare_parts","photo","other"],Ke={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"},Q=class extends L{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._loadedKey="";this._localeReady=!1}get _lang(){return this.hass?.language||"en"}get _refId(){return this.partId||this.taskId||""}get _linkField(){return this.partId?"part_ids":"task_ids"}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,q(this._lang).then(()=>this.requestUpdate()));let e=`${this.entryId}|${this._refId}`;this.hass&&this.entryId&&this._refId&&this._loadedKey!==e&&(this._loadedKey=e,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error=""}catch(t){this._error=E(t,this._lang),this._loaded=!0}}_links(t){return t[this._linkField]||[]}_linked(){return this._docs.filter(t=>this._links(t).includes(this._refId))}_available(){return this._docs.filter(t=>!this._links(t).includes(this._refId))}async _setLinks(t,e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,[this._linkField]:e}),await this._load()}catch(i){this._error=E(i,this._lang)}finally{this._busy=!1}}_link(){let t=this._docs.find(e=>e.id===this._attachId);t&&(this._attachId="",this._setLinks(t,[...this._links(t),this._refId]))}_unlink(t){this._setLinks(t,this._links(t).filter(e=>e!==this._refId))}_isPdf(t){return t.mime==="application/pdf"||(t.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(t){return this._isPdf(t)&&this.taskId?t.task_pages?.[this.taskId]:void 0}async _open(t){if(t.kind==="weblink"){window.open(t.url,"_blank","noopener");return}let e=this._pageFor(t),i=e?`#page=${e}`:"",a=window.open("about:blank","_blank");try{let l=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${t.id}`,expires:300});a&&(a.location.href=new URL(l.path+i,window.location.origin).href)}catch(l){a&&a.close(),this._error=E(l,this._lang)}}async _setPage(t,e){if(this.taskId){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,task_pages:{[this.taskId]:e}}),await this._load()}catch(i){this._error=E(i,this._lang)}finally{this._busy=!1}}}async _download(t){try{let e=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${t.id}`,expires:30});Ct(e.path,t.filename||t.title||"document")}catch(e){this._error=E(e,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return d;let t=this._lang,e=this._linked(),i=this._available();return r`
    ...
    `}_renderRow(t,e){let i=t.kind==="file",a=this._isPdf(t),l=this._pageFor(t),h=(t.tags||[]).find(p=>Ye.includes(p))||"other",c=i?ot(t.size):s("doc_link_badge",e);return r`
      <div class="tdoc-row">
        <ha-icon class="tdoc-icon" icon=${i?Ke[h]:"mdi:link-variant"}></ha-icon>
        <div
          class="tdoc-info"
          role="button"
          tabindex="0"
  ...
  `,_([T({attribute:!1})],G.prototype,"hass",2),_([m()],G.prototype,"_ov",2),_([m()],G.prototype,"_loading",2),_([m()],G.prototype,"_marking",2),_([m()],G.prototype,"_error",2),_([m()],G.prototype,"_history",2),_([m()],G.prototype,"_rosterSort",2),_([m()],G.prototype,"_typeFilter",2),_([m()],G.prototype,"_recorded",2);var Gt=G;customElements.get("maintenance-battery-fleet-section")||customElements.define("maintenance-battery-fleet-section",Gt);var ge=5;function $t(n){let o=n.getFullYear(),t=String(n.getMonth()+1).padStart(2,"0"),e=String(n.getDate()).padStart(2,"0");return`${o}-${t}-${e}`}function Ze(n,o){let t=[];for(let e=0;e<o;e++){let i=new Date(n);i.setDate(i.getDate()+e),i.setHours(0,0,0,0),t.push($t(i))}return t}function It(n,o){let[t,e,i]=n.split("-").map(Number),a=new Date(t,e-1,i);return a.setDate(a.getDate()+o),$t(a)}function Qe(n){if(!n||n.length===0)return null;let o=n.map(t=>t.cost).filter(t=>typeof t=="number");return o.length===0?null:o.reduce((t,e)=>t+e,0)/o.length}function Xe(n){let{windowStart:o,windowEnd:t,task:e,entryId:i,objectName:a}=n,l=[],h=(g,v)=>({date:g,entry_id:i,task_id:e.id,task_name:e.name,object_name:a,status:v&&(e.status==="overdue"||e.status==="triggered")?"ok":e.status,days_until_due:v?null:e.days_until_due??null,projected:v,schedule_type:e.schedule_type,interval_days:e.interval_days??null,interval_unit:e.interval_unit??null,responsible_user_id:e.responsible_user_id??null,avg_cost:Qe(e.history),adaptive_enabled:!!e.adaptive_config?.enabled,prediction_confidence:e.threshold_prediction_confidence??null}),c=Math.max(1,Math.round(Yt(e.interval_days,e.interval_unit)));if(e.status==="overdue"||e.status==="triggered"){if(l.push(h(o,!1)),e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0){let g=It(o,c),v=1;for(;g<=t&&v<ge;)l.push(h(g,!0)),v++,g=It(g,c)}return l}let p=e.next_due;if(typeof p!="string"||!p)return l;let u=p.slice(0,10);if(u>=o&&u<=t)l.push(h(u,!1));else if(u>t)return l;if(e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0){let g=It(u,c),v=l.length;for(;g<=t&&v<ge;)g>=o&&(l.push(h(g,!0)),v++),g=It(g,c)}return l}var me={overdue:0,triggered:1,due_soon:2,ok:3};function ve(n,o,t,e=null){let i=Ze(o,t),a=i[0],l=i[i.length-1],h=[];for(let p of n){let u=p.object?.name||"",g=p.entry_id,v=p.tasks||[];for(let b of v){if(e&&b.responsible_user_id!==e||b.enabled===!1)continue;let x=Xe({windowStart:a,windowEnd:l,task:b,entryId:g,objectName:u});h.push(...x)}}let c=new Map;for(let p of i)c.set(p,[]);for(let p of h){let u=c.get(p.date);u&&u.push(p)}for(let[,p]of c)p.sort((u,g)=>{let v=me[u.status]??99,b=me[g.status]??99;if(v!==b)return v-b;if(u.projected!==g.projected)return u.projected?1:-1;let x=u.object_name.localeCompare(g.object_name);return x!==0?x:u.task_name.localeCompare(g.task_name)});return i.map(p=>({date:p,events:c.get(p)??[]}))}var Je={completed:"ok",reset:"ok",skipped:"due_soon",triggered:"triggered",trigger_replaced:"triggered",trigger_removed:"ok"};function ti(n,o){let t=[];for(let e=o-1;e>=0;e--){let i=new Date(n);i.setDate(i.getDate()-e),i.setHours(0,0,0,0),t.push($t(i))}return t}function be(n,o,t,e=null){let i=ti(o,t),a=i[0],l=i[i.length-1],h=new Map;for(let p of i)h.set(p,[]);for(let p of n){let u=p.object?.name||"",g=p.entry_id,v=p.tasks||[];for(let b of v){if(e&&b.responsible_user_id!==e)continue;let x=b.history||[];for(let f of x){if(typeof f?.timestamp!="string")continue;let M=f.timestamp.slice(0,10);if(M<a||M>l)continue;let S=h.get(M);if(!S)continue;let I=f.type??"completed";S.push({date:M,entry_id:g,task_id:b.id,task_name:b.name,object_name:u,status:Je[I]??"ok",days_until_due:null,projected:!1,schedule_type:b.schedule_type,interval_days:b.interval_days??null,responsible_user_id:b.responsible_user_id??null,avg_cost:typeof f.cost=="number"?f.cost:null,adaptive_enabled:!!b.adaptive_config?.enabled,prediction_confidence:null,history_timestamp:f.timestamp,history_type:I,history_cost:typeof f.cost=="number"?f.cost:null,history_notes:typeof f.notes=="string"?f.notes:null,history_duration:typeof f.duration=="number"?f.duration:null})}}}let c={completed:0,reset:1,skipped:2,triggered:3,trigger_replaced:4};for(let[,p]of h)p.sort((u,g)=>{let v=c[u.history_type??""]??99,b=c[g.history_type??""]??99;if(v!==b)return v-b;let x=u.object_name.localeCompare(g.object_name);return x!==0?x:u.task_name.localeCompare(g.task_name)});return i.map(p=>({date:p,events:h.get(p)??[]}))}var fe=D`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;var X=class extends L{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(t){if(this._config={...t},t.past_days&&[30,90].includes(t.past_days)?this._pastDays=t.past_days:t.window_days&&[7,14,30,365].includes(t.window_days)&&(this._windowDays=t.window_days,this._pastDays=0),typeof t.user_filter=="string"&&(this._userFilter=t.user_filter),typeof t.object_filter=="string")this._objectFilter=t.object_filter,this._configuredObjects=[];else if(Array.isArray(t.object_filter)){let e=t.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=e.length===1?e[0]:"",this._configuredObjects=e.length>1?e:[]}}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(t){super.updated(t),t.has("hass")&&Et(this.hass?.locale);let e=this.hass?.language;if(e&&!St(e)&&q(e).then(()=>this.requestUpdate()),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=e}catch{}}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){t();return}this._unsub=t}catch{}}_onEventClick(t){if(t.history_timestamp){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:t.entry_id,task_id:t.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return d;let t=this._lang,e=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,l=null;this._userFilter&&(l=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let h=y=>{let N=y.toLowerCase();return this._objects.find(H=>H.entry_id===y||H.object.name.toLowerCase()===N)?.entry_id??null},c=new Set(this._configuredObjects.map(h).filter(y=>y!==null)),p=c.size?this._objects.filter(y=>c.has(y.entry_id)):this._objects,u=this._config.show_object_filter!==!1&&p.length>1,g=this._objectFilter?h(this._objectFilter):null,v=g&&p.some(y=>y.entry_id===g)?p.filter(y=>y.entry_id===g):p,b=new Date;b.setHours(0,0,0,0);let x=this._pastDays>0,f=x?be(v,b,this._pastDays,l):ve(v,b,this._windowDays,l),M=$t(b),S=this._windowDays===365||x,I=S?f.filter(y=>y.events.length>0):f,R=y=>{let N=`cal-status-${y.status}`,W=y.projected?"cal-event-projected":"",H=y.status==="overdue"&&y.days_until_due!=null?` (${_t(y.days_until_due,t)})`:"",O=y.projected&&y.interval_days?r`<span class="cal-event-recur">${y.interval_unit&&y.interval_unit!=="days"?`${y.interval_days} ${s("unit_"+y.interval_unit,t)}`:s("cal_every_n_days",t).replace("{n}",String(y.interval_days))}</span>`:d,Z=y.schedule_type==="sensor_based",st=Z?r`<ha-icon class="cal-event-icon cal-source-sensor"
                ...
                icon="${y.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,rt=Z&&y.prediction_confidence&&y.status!=="triggered"&&!y.projected?r`<span class="cal-event-prediction cal-conf-${y.prediction_confidence}">
            ${s("cal_predicted",t)} · ${s(`cal_confidence_${y.prediction_confidence}`,t)}
          </span>`:d,U=this._stats?.budget?.currency_symbol||ut,w=y.history_type?s(y.history_type,t):s(y.status,t);return r`
        <div class="cal-event ${W}"
          @click=${()=>this._onEventClick(y)}>
          ${st}
          <span class="cal-status-pill ${N}">${w}</span>
          <div class="cal-event-body">
            <div class="cal-event-title">${y.object_name} · ${y.task_name}${H}</div>
            ${rt}
            ${O}
          </div>
          ${y.avg_cost!=null&&y.avg_cost>0?r`<span class="cal-event-cost">${y.avg_cost.toFixed(0)} ${U}</span>`:d}
        </div>
      `},j=y=>{let[N,W,H]=y.date.split("-").map(Number),O=new Date(N,W-1,H),Z=y.date===M,st=O.toLocaleDateString(t,{weekday:"short"}),rt=O.toLocaleDateString(t,{month:"long"});return r`
        <div class="cal-day-row">
          ...
          <div class="cal-day-content">
            <div class="cal-day-header">
              <span class="cal-day-month">${rt}</span>
              ${Z?r`<span class="cal-day-today-badge">${s("today",t)}</span>`:d}
            </div>
              ...
              <div class="cal-controls">
                ...
                ${u?r`
                      <select class="cal-user-filter"
                        ...
                        ${[...p].sort((y,N)=>y.object.name.localeCompare(N.object.name)).map(y=>r`<option value=${y.entry_id} ?selected=${y.entry_id===g}>${y.object.name}</option>`)}
                      </select>
                    `:d}
              </div>
            `:d}
        <div class="cal-rolling">
          ${I.length===0&&S?r`<div class="cal-empty">${s("cal_no_events",t)}</div>`:I.map(j)}
        </div>
      </ha-card>
    `}};X.styles=[Lt,fe,D`
      :host { display: block; }
      ha-card { padding: 0; overflow: hidden; }
    `],_([T({attribute:!1})],X.prototype,"hass",2),_([m()],X.prototype,"_config",2),_([m()],X.prototype,"_objects",2),_([m()],X.prototype,"_stats",2),_([m()],X.prototype,"_windowDays",2),_([m()],X.prototype,"_pastDays",2),_([m()],X.prototype,"_userFilter",2),_([m()],X.prototype,"_objectFilter",2),_([m()],X.prototype,"_unsub",2);var ei=[{value:7,label:"Week (7 days)"},{value:14,label:"Fortnight (14 days)"},{value:30,label:"Month (30 days, default)"},{value:365,label:"Year (365 days, empty days collapsed)"}],bt=class extends L{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}setConfig(t){this._config={...t}}_valueChanged(t,e){let i={...this._config,[t]:e};t==="show_window_chips"&&e===!0&&delete i.show_window_chips,t==="show_user_filter"&&e===!0&&delete i.show_user_filter,t==="show_object_filter"&&e===!0&&delete i.show_object_filter,t==="title"&&(!e||typeof e=="string"&&e.trim()==="")&&delete i.title,t==="user_filter"&&e===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let t=this._config.window_days??30,e=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.user_filter??"",l=this._config.title??"";return r`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${ei.map(h=>r`<option value="${h.value}" ?selected=${h.value===t}>${h.label}</option>`)}
          </select>
        </div>
  ...
  `],_([T({attribute:!1})],J.prototype,"hass",2),_([m()],J.prototype,"_open",2),_([m()],J.prototype,"_title",2),_([m()],J.prototype,"_message",2),_([m()],J.prototype,"_confirmText",2),_([m()],J.prototype,"_danger",2),_([m()],J.prototype,"_inputLabel",2),_([m()],J.prototype,"_inputType",2),_([m()],J.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",J);var tt=class extends L{constructor(){super(...arguments);this.objects=[];this._summary=null;this._loaded=!1;this._busy=!1;this._error="";this._query="";this._results=[];this._expanded=!1;this._initiallyLoaded=!1;this._searchTimer=0}get _lang(){return this.hass?.language||"en"}updated(t){super.updated(t),t.has("hass")&&this.hass&&!this._initiallyLoaded&&(this._initiallyLoaded=!0,this._load(),q(this._lang).then(()=>this.requestUpdate()))}async _load(){this._busy=!0;try{this._summary=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/storage"}),this._error=""}catch(t){this._error=E(t,this._lang)}finally{this._loaded=!0,this._busy=!1}}_nameFor(t){return this.objects.find(i=>i.object?.id===t)?.object?.name||t.slice(0,8)}_entryFor(t){return this.objects.find(e=>e.object?.id===t)?.entry_id}_toggle(){this._expanded=!this._expanded}_openObject(t){this.dispatchEvent(new CustomEvent("open-object",{detail:{entry_id:t},bubbles:!0,composed:!0}))}_onSearch(t){this._query=t.target.value,clearTimeout(this._searchTimer),this._searchTimer=window.setTimeout(()=>{this._doSearch()},250)}async _doSearch(){let t=this._query.trim();if(!t){this._results=[];return}try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/search",query:t});this._results=e.results||[]}catch(e){this._error=E(e,this._lang),this._results=[]}}async _openResult(t){if(t.kind==="weblink"){window.open(t.url,"_blank","noopener");return}let e=window.open("about:blank","_blank");try{let i=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${t.id}`,expires:300});e&&(e.location.href=new URL(i.path,window.location.origin).href)}catch(i){e&&e.close(),this._error=E(i,this._lang)}}_renderResult(t,e){return r`
        ...
        <div class="card-content">
          <div class="header">
            ...
            >
              ...
              <span class="header-summary">
                ${ot(t.total_bytes)}
                ${t.dedup_savings_bytes>0?r`<span class="saved">−${ot(t.dedup_savings_bytes)}</span>`:d}
              </span>
            </button>
            <button
              class="icon-btn"
          ...
          ${this._expanded?r`
                <div class="body">
                  <div class="totals">
                    <div class="stat">
                      <div class="stat-value">${ot(t.total_bytes)}</div>
                    ...
                    ${t.dedup_savings_bytes>0?r`<div class="stat">
                          <div class="stat-value saved">−${ot(t.dedup_savings_bytes)}</div>
    ...
    `}_renderObjRow(t,e){let i=t.entry;return r`
      ...
      >
        ...
        <span class="obj-size">${ot(t.bytes)}</span>
              ...
              <div class="objects">
                ${[...this.objects].sort((i,a)=>i.object.name.localeCompare(a.object.name)).map(i=>r`
                  <div class="object-block">
                    ...
                    ${i.tasks.length===0?r`<div class="hint small">${s("no_tasks_short",t)}</div>`:[...i.tasks].sort((a,l)=>a.name.localeCompare(l.name)).map(a=>{let l=`${i.entry_id}:${a.id}`,h=this._selected.has(l);return r`
  ...
  `,_([T({attribute:!1})],lt.prototype,"hass",2),_([m()],lt.prototype,"_open",2),_([m()],lt.prototype,"_busy",2),_([m()],lt.prototype,"_error",2),_([m()],lt.prototype,"_name",2),_([m()],lt.prototype,"_views",2);customElements.get("maintenance-saved-views-dialog")||customElements.define("maintenance-saved-views-dialog",lt);var ai=60,ni=20,xe=30;function Zt(n){let o=n.trigger_config??null;if(!o)return d;let t=o.type||"threshold",e=n.trigger_entity_info?.unit_of_measurement??"",i=0,a="";if(t==="threshold"){let c=n.trigger_current_value??null;if(c==null)return d;let p=o.trigger_above,u=o.trigger_below;if(p!=null){let g=u??0,v=p-g||1;i=Math.min(100,Math.max(0,(c-g)/v*100)),a=`${c.toFixed(1)} / ${p} ${e}`}else if(u!=null){let v=n.trigger_entity_info?.max??(u*2||100),b=v-u||1;i=Math.min(100,Math.max(0,(v-c)/b*100)),a=`${c.toFixed(1)} / ${u} ${e}`}else return d}else if(t==="counter"){let c=o.trigger_target_value||1,p;if(o.trigger_delta_mode?(p=n.trigger_current_delta??null,p==null&&n.trigger_baseline_value!=null&&n.trigger_current_value!=null&&(p=n.trigger_current_value-n.trigger_baseline_value)):p=n.trigger_current_value??null,p==null)return d;i=Math.min(100,Math.max(0,p/c*100)),a=`${p.toFixed(1)} / ${c} ${e}`}else if(t==="state_change"){let c=o.trigger_target_changes||1,p=n.trigger_current_value??null;if(p==null)return d;i=Math.min(100,Math.max(0,p/c*100)),a=`${Math.round(p)} / ${c}`}else if(t==="runtime"){let c=o.trigger_runtime_hours||100,p=n.trigger_current_value??null;if(p==null)return d;i=Math.min(100,Math.max(0,p/c*100)),a=`${p.toFixed(1)}h / ${c}h`}else if(t==="compound"){let c=o.compound_logic||o.operator||"AND",p=o.conditions?.length||0;a=`${c} (${p})`,i=n.trigger_active?100:0}else return d;let l=i>=100,h=i>90?"var(--error-color, #f44336)":i>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return r`
  ...
  `}function Qt(n,o,t){if(!n.trigger_config?.entity_id)return d;let e=n.trigger_config.entity_id,i=o.get(e)||[],a=[];if(i.length>=2)a=i.map(j=>({ts:j.ts,val:j.val}));else{if(!n.history)return d;for(let j of n.history)j.trigger_value!=null&&a.push({ts:new Date(j.timestamp).getTime(),val:j.trigger_value})}if(n.trigger_current_value!=null&&a.push({ts:Date.now(),val:n.trigger_current_value}),a.length<2)return d;a.sort((j,y)=>j.ts-y.ts);let l=ai,h=ni,c=a.map(j=>j.val),p=Math.min(...c),u=Math.max(...c),g=u-p||1;p-=g*.1,u+=g*.1;let v=a[0].ts,x=a[a.length-1].ts-v||1,f=j=>(j-v)/x*l,M=j=>2+(1-(j-p)/(u-p))*(h-4),S=a;if(S.length>xe){let j=Math.ceil(S.length/xe);S=S.filter((y,N)=>N%j===0||N===S.length-1)}let I=S.map(j=>`${f(j.ts).toFixed(1)},${M(j.val).toFixed(1)}`).join(" "),R=n.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return r`
  ...
  `}function wt(n,o,t=4){if(!isFinite(n)||!isFinite(o))return{ticks:[],niceMin:0,niceMax:1};if(n===o){let p=Math.abs(n)*.1||1;n-=p,o+=p}let e=o-n,i=Math.pow(10,Math.floor(Math.log10(e/Math.max(1,t)))),a=i;for(let p of[1,2,5,10])if(a=i*p,e/a<=t+.5)break;let l=Math.floor(n/a)*a,h=Math.ceil(o/a)*a,c=[];for(let p=l;p<=h+a*1e-6;p+=a)c.push(Math.abs(p)<a*1e-9?0:p);return{ticks:c,niceMin:l,niceMax:h}}function ct(n){let o=Math.abs(n);return o>=1e6?ft((n/1e6).toFixed(o>=1e7?0:1))+"M":o>=1e4?ft((n/1e3).toFixed(0))+"k":o>=1e3?ft((n/1e3).toFixed(1))+"k":o>=100?n.toFixed(0):o>=10||o>=1?ft(n.toFixed(1)):o===0?"0":ft(n.toFixed(2))}function ft(n){return n.replace(/\.0+$/,"").replace(/(\.\d*[1-9])0+$/,"$1")}function vt(n,o,t){let e=n.toLocaleString(t,{maximumFractionDigits:Math.abs(n)>=100?0:1});return o?`${e} ${o}`:e}function yt(n,o,t){let e=new Date(n),i=t?{month:"short",day:"numeric",year:"2-digit"}:{month:"short",day:"numeric"};return e.toLocaleDateString(o,i)}function Xt(n,o){return new Date(n).toLocaleDateString(o,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}function Ft(n,o){return new Date(n).getFullYear()!==new Date(o).getFullYear()}function Bt(n,o,t){if(t<2||o<=n)return[n,o];let e=[];for(let i=0;i<t;i++)e.push(n+(o-n)*i/(t-1));return e}var Vt=210,nt=46,pt=14,ht=12,we=14,ri=20+we,oi=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],V=class extends L{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(t=>{let e=Math.floor(t[0]?.contentRect?.width||0);e&&Math.abs(e-this._width)>2&&(this._width=e)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(t){t!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:t},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let t=this._width||320,e=[...this.points].sort((a,l)=>a.ts-l.ts),i=this.lang;return r`
    ...
    `}_renderSvg(t,e){let i=this.lang,a=t-nt-pt,l=Vt-ri,h=l-ht,c=1/0,p=-1/0;for(let w of e)c=Math.min(c,w.min??w.val),p=Math.max(p,w.max??w.val);this.thresholdAbove!=null&&(c=Math.min(c,this.thresholdAbove),p=Math.max(p,this.thresholdAbove)),this.thresholdBelow!=null&&(c=Math.min(c,this.thresholdBelow),p=Math.max(p,this.thresholdBelow)),this.targetValue!=null&&(c=Math.min(c,this.targetValue),p=Math.max(p,this.targetValue)),this.forceZero&&(c=Math.min(c,0));let u=(p-c||1)*.06,g=this.forceZero&&c>=0?0:c-u,{ticks:v,niceMin:b,niceMax:x}=wt(g,p+u,4);this.forceZero&&c>=0&&b<0&&(b=0,v=v.filter(w=>w>=0));let f=e[0].ts,M=e[e.length-1].ts,S=M-f||1,I=Ft(f,M),R=w=>nt+(w-f)/S*a,j=w=>ht+(1-(w-b)/(x-b||1))*h,y=e.map(w=>`${R(w.ts).toFixed(1)},${j(w.val).toFixed(1)}`).join(" "),N=`M${R(e[0].ts).toFixed(1)},${l} `+e.map(w=>`L${R(w.ts).toFixed(1)},${j(w.val).toFixed(1)}`).join(" ")+` L${R(e[e.length-1].ts).toFixed(1)},${l} Z`,W="",H=e.filter(w=>w.min!=null&&w.max!=null);if(H.length>=2){let w=H.map(C=>`${R(C.ts).toFixed(1)},${j(C.max).toFixed(1)}`),$=[...H].reverse().map(C=>`${R(C.ts).toFixed(1)},${j(C.min).toFixed(1)}`);W=`M${w[0]} `+w.slice(1).map(C=>`L${C}`).join(" ")+` L${$.join(" L")} Z`}let O=[];if(this.thresholdBelow!=null){let w=j(this.thresholdBelow);O.push({y:w,h:Math.max(0,l-w),lineY:w,label:`\u25BC ${ct(this.thresholdBelow)}`,labelY:Math.min(l-4,w+13)})}if(this.thresholdAbove!=null){let w=j(this.thresholdAbove);O.push({y:ht,h:Math.max(0,w-ht),lineY:w,label:`\u25B2 ${ct(this.thresholdAbove)}`,labelY:Math.max(ht+11,w-5)})}let Z=e[e.length-1],st=(this.events||[]).filter(w=>w.ts>=f&&w.ts<=M),rt=Bt(f,M,Math.max(2,Math.min(5,Math.floor(a/110)+1))),U=this._hover;return r`
      <div class="svg-holder">
        ...
        >
          ...
          <path d="${N}" fill="var(--primary-color)" opacity="0.10" clip-path="url(#plot)" />
          ...
          ${rt.map((w,$)=>{let C=R(w),Ut=$===0?"start":$===rt.length-1?"end":"middle";return P`<text x="${C.toFixed(1)}" y="${Vt-5}" text-anchor="${Ut}" class="tick-label">${yt(w,i,I)}</text>`})}

          <line x1="${nt}" y1="${l}" x2="${t-pt}" y2="${l}" stroke="var(--divider-color)" stroke-width="1" />

          ${st.map(w=>{let $=R(w.ts),C=w.type==="completed"?"var(--success-color, #4caf50)":w.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return P`
          ...
          ${U?P`
                <line x1="${U.x.toFixed(1)}" y1="${ht}" x2="${U.x.toFixed(1)}" y2="${l}"
        ...
        ${U?r`<div
            ...
            >
              <div class="hover-date">${Xt(U.p.ts,i)}</div>
              <div class="hover-val">
                ${vt(U.p.val,this.unit,i)}
                ${U.p.min!=null&&U.p.max!=null?r`<span class="hover-range">(${ct(U.p.min)}–${ct(U.p.max)})</span>`:d}
              </div>
            </div>`:d}
      </div>
    `}_onPointer(t,e,i,a,l){let c=t.currentTarget.getBoundingClientRect(),p=(t.clientX-c.left)/c.width*l;if(p<nt-8||p>l-pt+8){this._hover=null;return}let u=e[0],g=1/0;for(let v of e){let b=Math.abs(i(v.ts)-p);b<g&&(g=b,u=v)}this._hover={x:i(u.ts),y:a(u.val),p:u}}};V.styles=D`
  ...
  `,_([T({attribute:!1})],V.prototype,"points",2),_([T({attribute:!1})],V.prototype,"events",2),_([T()],V.prototype,"unit",2),_([T()],V.prototype,"lang",2),_([T({attribute:!1})],V.prototype,"thresholdAbove",2),_([T({attribute:!1})],V.prototype,"thresholdBelow",2),_([T({attribute:!1})],V.prototype,"targetValue",2),_([T({type:Boolean})],V.prototype,"forceZero",2),_([T({attribute:!1})],V.prototype,"projection",2),_([T({attribute:!1})],V.prototype,"rangeDays",2),_([T({type:Boolean})],V.prototype,"showRange",2),_([T({type:Boolean})],V.prototype,"busy",2),_([T({type:Boolean})],V.prototype,"hideOutliers",2),_([T({type:Boolean})],V.prototype,"showOutlierToggle",2),_([m()],V.prototype,"_width",2),_([m()],V.prototype,"_hover",2);customElements.get("maintenance-trigger-chart")||customElements.define("maintenance-trigger-chart",V);function li(n){if(n.length<4)return n;let o=n.map(p=>p.val).sort((p,u)=>p-u),t=p=>{let u=(o.length-1)*p,g=Math.floor(u),v=Math.ceil(u);return o[g]+(o[v]-o[g])*(u-g)},e=t(.25),i=t(.75),a=i-e;if(a===0)return n;let l=e-1.5*a,h=i+1.5*a,c=n.filter(p=>p.val>=l&&p.val<=h);return c.length>=2?c:n}function ke(n,o){let t=n.trigger_config;if(!t)return d;let e=o.lang,i=n.trigger_entity_info,a=n.trigger_entity_infos,l=i?.friendly_name||t.entity_id||"\u2014",h=t.entity_id||"",c=t.entity_ids||(h?[h]:[]),p=i?.unit_of_measurement||"",u=n.trigger_current_value,g=t.type||"threshold",v=c.length>1,b=ci(n,p,o);return r`
    <h3>${s("trigger",e)}</h3>
      ...
      <div class="trigger-header">
        ...
        <div>
          ${v?r`
            ...
            <div class="trigger-entity-id">${c.map((x,f)=>r`${f>0?", ":""}<span class="entity-link" @click=${M=>mt(M,x)}>${x}</span>`)}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `:r`
            <div class="trigger-entity-name">${l}</div>
            <div class="trigger-entity-id">${h?r`<span class="entity-link" @click=${x=>mt(x,h)}>${h}</span>`:""}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `}
        </div>
      ...
      <div class="trigger-limits">
        ...
        ${g==="compound"?r`
          ...
          ${(t.conditions||[]).map((x,f)=>r`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${f+1}. ${s(x.type||"unknown",e)}: ${x.entity_id?r`<span class="entity-link" @click=${M=>mt(M,x.entity_id)}>${x.entity_id}</span>`:""}</span>
          `)}
        `:d}
      </div>
  ...
  `}function je(n,o){let t=n.trigger_config;if(!t)return[];let e=t.type||"threshold",i=t.entity_id||"",a=e==="runtime"?[]:o.detailStatsData.get(i)||[],l=o.isCounterEntity(t),h=[];if(a.length>=2)for(let c of a){let p={ts:c.ts,val:c.val};!l&&c.min!=null&&c.max!=null&&(p.min=c.min,p.max=c.max),h.push(p)}else for(let c of n.history)c.trigger_value!=null&&h.push({ts:new Date(c.timestamp).getTime(),val:c.trigger_value});return n.trigger_current_value!=null&&h.push({ts:Date.now(),val:n.trigger_current_value}),h.sort((c,p)=>c.ts-p.ts),h}function pi(n,o,t){let e=n.trigger_config;if(!e)return d;let i=e.type||"threshold",a=e.entity_id||"",l=je(n,t);i==="runtime"&&e.trigger_runtime_hours&&n.trigger_current_value!=null&&(l=[{ts:Jt(n)??l[0]?.ts??Date.now()-864e5,val:0},{ts:Date.now(),val:Math.max(0,n.trigger_current_value)}]),t.hideOutliers&&(l=li(l));let h=l.length<2&&!!a&&t.hasStatsService&&!t.detailStatsData.has(a);if(l.length<2&&!h)return d;let c=!!a&&t.detailStatsData.has(a)&&(t.detailStatsData.get(a)?.length??0)<2,p=Date.now()-t.rangeDays*864e5,u=l.filter(f=>f.ts>=p);u.length>=2&&(l=u);let g=null,v=!1;if(i==="counter"&&e.trigger_target_value!=null&&l.length){let f=Te(n,l);if(f){if(f.ts!=null){let M=l.filter(S=>S.ts>=f.ts);M.length>=2&&(l=M)}l=l.map(M=>({...M,val:Math.max(0,M.val-f.value)}))}g=e.trigger_target_value,v=!0}else i==="state_change"&&e.trigger_target_changes?(g=e.trigger_target_changes,v=!0):i==="runtime"&&e.trigger_runtime_hours&&(g=e.trigger_runtime_hours,v=!0);let b=null;if(g==null&&n.degradation_rate!=null&&(n.degradation_trend!=="stable"||n.days_until_threshold!=null)&&n.degradation_trend!=="insufficient_data"&&l.length>=2){let f=l[l.length-1];b=[f,{ts:f.ts+30*864e5,val:f.val+n.degradation_rate*30}]}let x=n.history.filter(f=>["completed","skipped","reset"].includes(f.type)).map(f=>({ts:new Date(f.timestamp).getTime(),type:f.type}));return r`
  ...
  `}function Me(n,o,t){let e=n.degradation_trend!=null&&n.degradation_trend!=="insufficient_data",i=n.days_until_threshold!=null,a=n.environmental_factor!=null&&n.environmental_factor!==1;if(!e&&!i&&!a)return d;let l=n.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":n.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return r`
      ...
      <div class="prediction-grid">
        ...
        ${a&&t.environmental?r`
          <div class="prediction-item">
            ...
            ${n.environmental_entity?r`<span class="prediction-entity entity-link" @click=${h=>mt(h,n.environmental_entity)}>${n.environmental_entity}</span>`:d}
          </div>
        `:d}
      </div>
    </div>
  `}function Se(n,o){let t=n.interval_analysis,e=t?.weibull_beta,i=t?.weibull_eta;if(e==null||i==null||i<=0)return d;let a=n.interval_days??0,l=n.suggested_interval??a;return r`
  ...
  `}function gi(n,o,t){let e=n.confidence_interval_low,i=n.confidence_interval_high,a=o.suggested_interval??o.interval_days??0,l=o.interval_days??0,h=Math.max(0,e-5),p=i+5-h,u=(e-h)/p*100,g=(i-e)/p*100,v=(a-h)/p*100,b=l>0?(l-h)/p*100:-1;return r`
    <div class="confidence-range">
      <div class="confidence-range-title">
        ${s("confidence_interval",t)}: ${a} ${s("days",t)} (${e}\u2013${i})
      </div>
      <div class="confidence-bar">
        <div class="confidence-fill" style="left:${u.toFixed(1)}%;width:${g.toFixed(1)}%"></div>
  ...
  `}var De=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function Le(n,o,t){if(!t.seasonal||!n.seasonal_factor||n.seasonal_factor===1)return d;let e=De.map(h=>s(h,o)),i=new Date().getMonth(),a=n.seasonal_factors||n.interval_analysis?.seasonal_factors||null,l=a&&a.length===12?a:e.map((h,c)=>{let p=n.seasonal_factor||1,u=Math.sin((c-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,p+u))});return r`
    <div class="seasonal-card-compact">
      <h4>${s("seasonal_awareness",o)}</h4>
      <div class="seasonal-mini-chart">
        ${l.map((h,c)=>{let p=h*40,u=h<.9?"low":h>1.1?"high":"normal";return r`
  ...
  `}function Ce(n,o){return mi(n,o)}function mi(n,o){let t=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return d;let e=n.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,l=100,h=8,p=l-h-4,u=Math.max(...t,1.5),g=a/12,v=g*.65,b=h+p-1/u*p;return r`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${a} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",o)}">
        ...
        ${t.map((x,f)=>{let M=x/u*p,S=f*g+(g-v)/2,I=h+p-M,R=f===i,j=x<1?"var(--success-color, #4caf50)":x>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return P`
  ...
  `}var vi=200,kt=10,bi=22;function Ae(n,o,t,e){let i=n.history.filter(h=>h.type==="completed"&&(h.cost!=null||h.duration!=null));if(i.length<2)return d;let a=i.some(h=>(h.cost??0)>0),l=i.some(h=>(h.duration??0)>0);return!a&&!l?d:r`
  ...
  `}function fi(n,o,t){let e=n.history.filter($=>$.type==="completed"&&($.cost!=null||$.duration!=null)).map($=>({ts:new Date($.timestamp).getTime(),cost:$.cost??0,duration:$.duration??0})).sort(($,C)=>$.ts-C.ts);if(e.length<2)return d;let i=e.some($=>$.cost>0),a=e.some($=>$.duration>0);if(!i&&!a)return d;let l=t!=="duration"&&i,h=t!=="cost"&&a,c=l||!h&&i,p=h||!l&&a,u=640,g=vi,v=c?44:12,b=p?44:12,x=u-v-b,f=g-bi,M=f-kt,S=e[0].ts,I=e[e.length-1].ts,R=(I-S||864e5)*.05,j=S-R,y=I+R,N=Ft(S,I),W=$=>v+($-j)/(y-j)*x,H=wt(0,Math.max(...e.map($=>$.cost))||1,3),O=wt(0,Math.max(...e.map($=>$.duration))||1,3),Z=$=>kt+(1-$/(H.niceMax||1))*M,st=$=>kt+(1-$/(O.niceMax||1))*M,rt=e.length>1?Math.min(...e.slice(1).map(($,C)=>W($.ts)-W(e[C].ts))):x,U=Math.max(6,Math.min(22,rt*.55)),w=Bt(S,I,Math.max(2,Math.min(4,e.length)));return r`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${u} ${g}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_history",o)}">
        ${c?H.ticks.map($=>{let C=Z($);return C<kt-1||C>f+1?d:P`
            <line x1="${v}" y1="${C.toFixed(1)}" x2="${u-b}" y2="${C.toFixed(1)}" stroke="var(--divider-color)" stroke-width="1" opacity="0.55" />
            <text x="${v-6}" y="${(C+3.5).toFixed(1)}" text-anchor="end" fill="var(--primary-color)" font-size="10.5">${ct($)}€</text>`}):d}
        ${p?O.ticks.map($=>{let C=st($);return C<kt-1||C>f+1?d:P`<text x="${u-b+6}" y="${(C+3.5).toFixed(1)}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="10.5">${ct($)}m</text>`}):d}
        ...
        ${w.map(($,C)=>{let Ut=C===0?"start":C===w.length-1?"end":"middle";return P`<text x="${W($).toFixed(1)}" y="${g-6}" text-anchor="${Ut}" fill="var(--secondary-text-color)" font-size="10">${yt($,o,N)}</text>`})}
      </svg>
    </div>
    <div class="chart-legend">
      ${c?r`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color);opacity:0.6"></span>${s("cost",o)}</span>`:d}
      ${p?r`<span class="legend-item"><span class="legend-swatch" style="background:var(--accent-color, #ff9800)"></span>${s("duration",o)}</span>`:d}
    </div>
  `}var gt=class extends L{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{let t=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${this.docId}`,expires:300});this._url=t.path}catch{this._failed=!0}}render(){return this._failed||!this.docId?d:this._url?r`
  ...
  `,_([T({attribute:!1})],gt.prototype,"hass",2),_([T()],gt.prototype,"docId",2),_([m()],gt.prototype,"_url",2),_([m()],gt.prototype,"_failed",2);customElements.get("maintenance-history-photo")||customElements.define("maintenance-history-photo",gt);var yi=["completed","skipped","missed","reset","triggered"];function Re(n,o){let t=o.lang;return r`
    <div class="history-filters-new">
      <div class="filter-chips">
        ${yi.map(e=>{let i=n.history.filter(a=>a.type===e).length;return i===0?d:r`
  ...
  `}function xi(n,o){let t=o.lang,e=["completed","reset","skipped"].includes(n.type);return r`
    <div class="history-entry">
      ...
      <div class="history-content">
        ...
        <div class="history-date">${Dt(n.timestamp,t)}</div>
  ...
  `}function te(n,o){if(!n.responsible_user_id)return d;let t=o(n.responsible_user_id);return t?r`
    <span class="user-badge">
      <ha-icon icon="mdi:account"></ha-icon>
      ${t}
    </span>
  `:d}function $i(n,o){let t=o.lang,e=o.isOperator,i=n.archived?"archived":n.is_done?"done":n.status==="due_soon"?"warning":n.status||"ok",a=n.archived?s("archived",t):n.is_done?s("completed",t):s(n.status||"ok",t);return r`
  ...
  `}function wi(n){let o=n.lang;return r`
    <div class="tab-bar">
  ...
  `}function ki(n,o){if(!o.features.checklists)return d;let t=n.checklist||[];if(t.length===0)return d;let e=o.lang,i=n.checklist_progress||{},a=t.filter(l=>i[l]).length;return r`
          ...
          <li class=${i[l]?"checked":""}>
            <label>
              <input
                type="checkbox"
                .checked=${!!i[l]}
                @change=${h=>o.setChecklistItem(l,h.target.checked)}
              />
              <span>${l}</span>
            </label>
          </li>
  ...
  `}function Ti(n,o){let t=it(n.documentation_url)?n.documentation_url:null,e=it(o.objectDocUrl)?o.objectDocUrl:null,i=e?null:(o.objectManualDocs||[])[0];if(!n.notes&&!t&&!e&&!i)return d;let a=o.lang;return r`
  ...
  `}function ji(n,o){let t=o.lang,e=n.times_performed>0?n.total_cost/n.times_performed:0,i=n.days_until_due!==null&&n.days_until_due!==void 0?n.days_until_due<0?"overdue":n.days_until_due<=n.warning_days?"warning":"":"";return r`
    <div class="kpi-bar">
      <div class="kpi-card">
  ...
  `}function Si(n,o){let t=o.lang,e=n.history.slice(-3).reverse();if(e.length===0)return d;let i=a=>{switch(a){case"completed":return"\u2713";case"triggered":return"\u2297";case"skipped":return"\u21B7";case"reset":return"\u21BA";default:return"\xB7"}};return r`
    <div class="recent-activities">
      <h3>${s("recent_activities",t)}</h3>
      ${e.map(a=>r`
        <div class="activity-item">
          <span class="activity-icon">${i(a.type)}</span>
          <span class="activity-date">${Dt(a.timestamp,t)}</span>
  ...
  `}function Ei(n,o){let t=o.lang,e=o.features.adaptive&&n.suggested_interval&&n.suggested_interval!==n.interval_days,i=o.features.seasonal&&n.seasonal_factor&&n.seasonal_factor!==1,a=e||i,l=o.features.adaptive&&n.interval_analysis?.weibull_beta!=null&&n.interval_analysis?.weibull_eta!=null,h=o.features.seasonal&&(n.seasonal_factors?.length===12||n.interval_analysis?.seasonal_factors?.length===12);return r`
    <div class="tab-content overview-tab">
      ...
      <div class="two-column-layout ${a?"":"single-column"}">
        ...
        <div class="right-column">
          ${Ae(n,t,o.costDurationToggle,c=>o.setCostDurationToggle(c))}
        </div>
      </div>
      ${l?Pe("weibull","weibull_reliability_curve",Se(n,t),o):d}
      ${h?Pe("seasonal","seasonal_chart_title",r`
            ${Ce(n,t)}
  ...
  `}function Di(n,o){return r`
    <div class="tab-content history-tab">
      ${Re(n,o.history)}
      ${Oe(n,o.history)}
    </div>
  `}function Li(n,o){switch(o.activeTab){case"overview":return Ei(n,o);case"history":return Di(n,o);default:return d}}function ze(n,o){return r`
  ...
  `}var Tt=class extends L{createRenderRoot(){return this}render(){return!this.task||!this.ctx?d:r`${ze(this.task,this.ctx)}`}};_([T({attribute:!1})],Tt.prototype,"task",2),_([T({attribute:!1})],Tt.prototype,"ctx",2);customElements.get("maintenance-task-detail-view")||customElements.define("maintenance-task-detail-view",Tt);function Ie(n){if(n.total<=0)return{start:0,end:0,padTop:0,padBottom:0};let o=n.overscan??12,t=Math.max(1,n.step??6),e=Math.max(1,n.rowHeight),i=Math.floor((n.scrollTop-n.listTop)/e),a=Math.ceil(n.viewportHeight/e)+1,l=Math.max(0,i-o);l=Math.floor(l/t)*t;let h=Math.min(n.total,Math.max(i,0)+a+o);return h=Math.min(n.total,Math.ceil(h/t)*t),l>=h&&(l=Math.min(l,Math.max(0,n.total-1)),h=Math.min(n.total,l+Math.max(a,1))),{start:l,end:h,padTop:l*e,padBottom:(n.total-h)*e}}var k=class extends L{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._filterLabel=null;this._savedViews=[];this._activeViewId="";this._unsub=null;this._chartRangeDays=(()=>{try{let t=parseInt(localStorage.getItem(F.chartRange)||"",10);return[7,30,90,365].includes(t)?t:30}catch{return 30}})();this._hideOutliers=(()=>{try{return localStorage.getItem(F.chartHideOutliers)==="1"}catch{return!1}})();this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._operatorWriteEnabled=!1;this._defaultWarningDays=7;this._actionLoading=!1;this._moreMenuOpen=!1;this._objMenuOpen=!1;this._toastMessage="";this._toastUndo=null;this._toastActionLabel="";this._filtersOpen=!1;this._actionsMenuOpen=!1;this._batteryFleetSetupAvailable=!1;this._staleBundle=!1;this._staleChecked=!1;this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab=(()=>{try{let t=localStorage.getItem(F.overviewTab);return t==="today"||t==="calendar"?t:"dashboard"}catch{return"dashboard"}})();this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._objectViewMode="cards";this._objectsTableColumns=ae;this._showArchived=!1;this._bulkMode=!1;this._bulkSelected=new Set;this._virtStart=0;this._virtEnd=0;this._virtRowHeight=53;this._virtTotalRows=0;this._virtScrollAttached=!1;this._virtRaf=0;this._collapsedSections=(()=>{try{return new Set(JSON.parse(localStorage.getItem(F.collapsedSections)||"[]"))}catch{return new Set}})();this._paletteOpen=!1;this._paletteQuery="";this._paletteActive=0;this._templateGalleryOpen=!1;this._templates=[];this._templateCategories={};this._templateBusy=!1;this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=t=>this._onPopState(t);this._lazyUi=null;this._onVirtualScroll=()=>{this._virtRaf||(this._virtRaf=requestAnimationFrame(()=>{this._virtRaf=0,this._updateVirtualWindow()}))};this._deepLinkHandled=!1;this._paletteKeydown=t=>{if(t.key==="/"&&!t.ctrlKey&&!t.metaKey&&!t.altKey&&!this._paletteOpen){let i=t.composedPath()[0];if(i instanceof HTMLElement&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.tagName==="SELECT"||i.isContentEditable))return;t.preventDefault(),this._openPalette();return}if(!this._paletteOpen)return;let e=this._paletteResults;if(t.key==="Escape")t.preventDefault(),this._closePalette();else if(t.key==="ArrowDown")t.preventDefault(),this._paletteActive=Math.min(this._paletteActive+1,e.length-1);else if(t.key==="ArrowUp")t.preventDefault(),this._paletteActive=Math.max(this._paletteActive-1,0);else if(t.key==="Enter"){t.preventDefault();let i=e[this._paletteActive];i&&this._selectPaletteResult(i)}};this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=t=>{let e=t.detail;e?.type==="maintenance-supporter:open-task"&&e.entry_id&&e.task_id&&(t.stopPropagation(),this._showTask(e.entry_id,e.task_id))};this._fullHistory=null;this._onHistoryEntrySaved=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"en"}get _isOperator(){let t=this.hass?.user;return t?t.is_admin?!1:!(this._operatorWriteEnabled&&this._adminPanelUserIds.includes(t.id)):!0}_ensureLazyUi(){return this._lazyUi||(this._lazyUi=Promise.all([import("/maintenance_supporter_panelfiles/panel-chunks/object-dialog-IU7V7TDN.js"),import("/maintenance_supporter_panelfiles/panel-chunks/task-dialog-5VUS7JEH.js"),import("/maintenance_supporter_panelfiles/panel-chunks/complete-dialog-KGRPNNX2.js"),import("/maintenance_supporter_panelfiles/panel-chunks/qr-dialog-U2M7KFS3.js"),import("/maintenance_supporter_panelfiles/panel-chunks/adopt-problem-sensors-dialog-EEQGF7EF.js"),import("/maintenance_supporter_panelfiles/panel-chunks/suggested-setups-dialog-VXF7GBII.js"),import("/maintenance_supporter_panelfiles/panel-chunks/settings-view-PUJN7ASF.js")]).then(()=>this.updateComplete)),this._lazyUi}async _ui(t){return await this._ensureLazyUi(),this.shadowRoot?.querySelector(t)??null}connectedCallback(){super.connectedCallback();let t=window.requestIdleCallback,e=()=>this._ensureLazyUi();t?t(e,{timeout:3e3}):window.setTimeout(e,1500),window.addEventListener("popstate",this._popstateHandler),window.addEventListener("keydown",this._paletteKeydown),window.addEventListener("resize",this._onVirtualScroll,{passive:!0});try{let i=localStorage.getItem(F.taskSort);i&&["due_date","object","type","task_name","area","assigned_user","group"].includes(i)&&(this._sortMode=i);let a=localStorage.getItem(F.objectSort);a&&["alphabetical","due_soonest","task_count"].includes(a)&&(this._objectSortMode=a);let l=localStorage.getItem(F.groupBy);l&&["none","area","group","user"].includes(l)&&(this._groupByMode=l);let h=localStorage.getItem(F.objectView);(h==="cards"||h==="table")&&(this._objectViewMode=h)}catch{}if(this._objects.length===0){let i=pe();i&&(this._objects=i.objects,i.stats&&(this._stats=i.stats))}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),window.removeEventListener("keydown",this._paletteKeydown),window.removeEventListener("resize",this._onVirtualScroll),this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onVirtualScroll),this._virtScrollAttached=!1,this._virtRaf&&cancelAnimationFrame(this._virtRaf),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(t){super.updated(t),t.has("hass")&&Et(this.hass?.locale);let e=this.hass?.language;if(e&&!St(e)&&q(e).then(()=>this.requestUpdate()),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Pt(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new le(this.hass),this._userService.getUsers())}let i=this.shadowRoot?.querySelector(".content");i&&!this._virtScrollAttached&&(i.addEventListener("scroll",this._onVirtualScroll,{passive:!0}),this._virtScrollAttached=!0),this._updateVirtualWindow()}_updateVirtualWindow(){let t=this.shadowRoot?.querySelector(".content"),e=this.shadowRoot?.querySelector(".task-table.virtual");if(!t||!e)return;let i=e.querySelector(".task-row:not(.virt-sizer)");i&&i.offsetHeight>20&&(this._virtRowHeight=i.offsetHeight);let a=e.getBoundingClientRect().top-t.getBoundingClientRect().top+t.scrollTop,l=Ie({scrollTop:t.scrollTop,viewportHeight:t.clientHeight,listTop:a,rowHeight:this._virtRowHeight,total:this._virtTotalRows});(l.start!==this._virtStart||l.end!==this._virtEnd)&&(this._virtStart=l.start,this._virtEnd=l.end)}async _loadData(){let[t,e,i,a,l,h]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"}).catch(()=>null)]);if(h&&(this._savedViews=h.views||[]),t&&(this._objects=Rt(t.objects),Wt(this._objects,e??this._stats??null)),this._view==="task"&&this._selectedEntryId&&this._selectedTaskId&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/status"}).then(c=>{this._batteryFleetSetupAvailable=!!c.available&&!c.configured}).catch(()=>{this._batteryFleetSetupAvailable=!1}),this._staleChecked||(this._staleChecked=!0,this.hass.connection.sendMessagePromise({type:"maintenance_supporter/version"}).then(c=>{this._staleBundle=de(c?.version)}).catch(()=>{})),e&&(this._stats=e),i&&(this._budget=i),a&&(this._groups=a.groups||{}),l){let c=l;this._features=c.features,this._adminPanelUserIds=c.admin_panel_user_ids||[],this._operatorWriteEnabled=c.operator_write_enabled??!1;let p=c.general?.default_warning_days;typeof p=="number"&&p>=0&&p<=365&&(this._defaultWarningDays=p),this._objectsTableColumns=ne(c.objects_table_columns)}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let t=new URLSearchParams(window.location.search),e=t.get("ms_action"),i=()=>{let u=window.location.pathname+window.location.hash;history.replaceState(history.state,"",u)};if(e==="add_object"){this._deepLinkHandled=!0,i(),this._ui("maintenance-object-dialog").then(u=>u?.openCreate());return}if(e==="open_vacation"||e==="open_budget"||e==="open_groups"||e==="open_settings"){this._deepLinkHandled=!0,i(),this._overviewTab="settings",this._ensureLazyUi().then(()=>requestAnimationFrame(()=>{let u=this.shadowRoot?.querySelector("maintenance-settings-view"),g=e.replace("open_","");u?.scrollToSection?.(g)}));return}let a=t.get("entry_id");if(!a)return;this._deepLinkHandled=!0;let l=t.get("task_id"),h=t.get("action"),c=window.location.pathname+window.location.hash;history.replaceState(history.state,"",c);let p=this._getObject(a);if(!p){this._showOverview();return}if(l){let u=p.tasks.find(g=>g.id===l);if(!u){this._showObject(a);return}this._showTask(a,l),h==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(a,l,u.name,this._features.checklists?u.checklist:void 0,this._features.adaptive&&!!u.adaptive_config?.enabled)}):h==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(a,l,u)})}else this._showObject(a)}_isCounterEntity(t){if(!t)return!1;let e=t.type||"threshold";return e==="counter"||e==="state_change"}async _fetchDetailStats(t,e){if(!this._statsService)return;let i=await this._statsService.getDetailStats(t,e,this._chartRangeDays),a=new Map(this._detailStatsData);a.set(t,i),this._detailStatsData=a}_setChartRange(t){if(t===this._chartRangeDays)return;this._chartRangeDays=t;try{localStorage.setItem(F.chartRange,String(t))}catch{}let e=this._selectedEntryId&&this._selectedTaskId?this._getTask(this._selectedEntryId,this._selectedTaskId):null,i=e?.trigger_config?.entity_id;if(i){let a=new Map(this._detailStatsData);a.delete(i),this._detailStatsData=a,this._fetchDetailStats(i,this._isCounterEntity(e.trigger_config))}}_setHideOutliers(t){if(t!==this._hideOutliers){this._hideOutliers=t;try{localStorage.setItem(F.chartHideOutliers,t?"1":"0")}catch{}}}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let t=[];for(let i of this._objects)for(let a of i.tasks){let l=a.trigger_config?.entity_id;l&&t.push({entityId:l,isCounter:this._isCounterEntity(a.trigger_config)})}if(t.length===0)return;let e=await this._statsService.getBatchMiniStats(t);this._miniStatsData=new Map([...this._miniStatsData,...e])}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e;i.objects&&Rt(i.objects),i.delta&&Rt(i.delta);let a=ce(this._objects,i);a!==null&&(this._objects=a,e.objects&&Wt(a,this._stats??null))},{type:"maintenance_supporter/subscribe",deltas:!0,compact:!0});if(!this.isConnected){t();return}this._unsub=t}catch{}}get _taskRows(){let t=[];for(let g of this._objects)for(let v of g.tasks){if(!this._showArchived&&v.archived||this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let x=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==x)continue}if(this._filterLabel&&!(v.labels||[]).includes(this._filterLabel))continue;let b=[];for(let x of Object.values(this._groups))x.task_refs?.some(f=>f.entry_id===g.entry_id&&f.task_id===v.id)&&b.push(x.name);t.push({entry_id:g.entry_id,task_id:v.id,object_name:g.object.name,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_unit:v.interval_unit??null,interval_anchor:v.interval_anchor??null,is_done:v.is_done??!1,archived:v.archived??!1,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,priority:v.priority??"normal",labels:v.labels??[],area_id:g.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:b})}let e={overdue:0,triggered:1,due_soon:2,ok:3},i=(g,v)=>(e[g.status]??9)-(e[v.status]??9),a=(g,v)=>(g.days_until_due??99999)-(v.days_until_due??99999),l=(g,v)=>i(g,v)||a(g,v),h=g=>g.area_id&&this.hass?.areas?.[g.area_id]?.name||"",c=g=>g.responsible_user_id&&this._userService?.getUserName(g.responsible_user_id)||"",p=g=>g.group_names[0]||"",u={due_date:l,object:(g,v)=>g.object_name.localeCompare(v.object_name)||l(g,v),type:(g,v)=>g.type.localeCompare(v.type)||l(g,v),task_name:(g,v)=>g.task_name.localeCompare(v.task_name),area:(g,v)=>{let b=h(g),x=h(v);return!b&&x?1:b&&!x?-1:b.localeCompare(x)||l(g,v)},assigned_user:(g,v)=>{let b=c(g),x=c(v);return!b&&x?1:b&&!x?-1:b.localeCompare(x)||l(g,v)},group:(g,v)=>{let b=p(g),x=p(v);return!b&&x?1:b&&!x?-1:b.localeCompare(x)||l(g,v)}};return t.sort(u[this._sortMode]),t}_getObject(t){return this._objects.find(e=>e.entry_id===t)}_getTask(t,e){return this._getObject(t)?.tasks.find(a=>a.id===e)}_pushPanelState(t,e,i){let a={msp_view:t,msp_entry:e||null,msp_task:i||null};history.pushState(a,"")}_onPopState(t){let e=t.state;if(e?.msp_view&&(this._view=e.msp_view,this._selectedEntryId=e.msp_entry||null,this._selectedTaskId=e.msp_task||null,this._moreMenuOpen=!1,e.msp_view==="task"&&e.msp_entry&&e.msp_task)){this._historyFilter=null;let i=this._getTask(e.msp_entry,e.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop()}_filterByStatus(t){this._filterStatus=t,this._activeViewId="",this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),this._scrollContentToTop()}get _allLabels(){let t=new Set;for(let e of this._objects)for(let i of e.tasks)for(let a of i.labels||[])t.add(a);return[...t].sort((e,i)=>e.localeCompare(i))}get _currentFilters(){return{status:this._filterStatus,user_id:this._filterUser,label:this._filterLabel,archived:this._showArchived,sort_mode:this._sortMode,group_by:this._groupByMode}}_applyView(t){if(this._activeViewId=t,!t)return;let e=this._savedViews.find(a=>a.id===t);if(!e)return;let i=e.filters;this._filterStatus=i.status||"",this._filterUser=i.user_id||null,this._filterLabel=i.label||null,this._showArchived=!!i.archived,["due_date","object","type","task_name","area","assigned_user","group"].includes(i.sort_mode)&&(this._sortMode=i.sort_mode),["none","area","group","user"].includes(i.group_by)&&(this._groupByMode=i.group_by);try{localStorage.setItem(F.taskSort,this._sortMode),localStorage.setItem(F.groupBy,this._groupByMode)}catch{}this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard")}_openSavedViewsDialog(){this.shadowRoot.querySelector("maintenance-saved-views-dialog")?.open(this._currentFilters,this._savedViews)}_onSavedViewsChanged(t){this._savedViews=t.detail.views||[],this._activeViewId&&!this._savedViews.some(e=>e.id===this._activeViewId)&&(this._activeViewId="")}_scrollContentToTop(){requestAnimationFrame(()=>{let t=this.shadowRoot?.querySelector(".content");t&&t.scrollTo({top:0,behavior:"smooth"})})}_showObject(t){this._pushPanelState("object",t),this._view="object",this._selectedEntryId=t,this._selectedTaskId=null,this._scrollContentToTop()}_showTask(t,e){this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._scrollContentToTop(),this._fetchFullHistory(t,e);let i=this._getTask(t,e);if(i?.trigger_config?.entity_id){let a=i.trigger_config.entity_id,l=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(a,l)}}_showToast(t){this._toastTimer&&clearTimeout(this._toastTimer),this._toastUndo=null,this._toastActionLabel="",this._toastMessage=t,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}_showActionToast(t,e,i){this._showUndoToast(t,i),this._toastActionLabel=e}_showUndoToast(t,e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastActionLabel="",this._toastMessage=t,this._toastUndo=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastUndo=null,this._toastTimer=null},7e3)}_runToastUndo(){let t=this._toastUndo;this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage="",this._toastUndo=null,this._toastTimer=null,t?.()}_openPalette(){this._paletteQuery="",this._paletteActive=0,this._paletteOpen=!0,this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".palette-input")?.focus()})}_closePalette(){this._paletteOpen=!1,this._paletteQuery=""}get _paletteResults(){let t=this._paletteQuery.trim().toLowerCase(),e=[];for(let i of this._objects){let a=i.object.name||"";(!t||a.toLowerCase().includes(t))&&e.push({kind:"object",entryId:i.entry_id,label:a,sub:s("object",this._lang)});for(let l of i.tasks){if(l.archived)continue;let h=l.name||"",c=(l.labels||[]).some(p=>p.toLowerCase().includes(t));if(!t||h.toLowerCase().includes(t)||a.toLowerCase().includes(t)||c){let p=(l.labels||[]).length?`  #${(l.labels||[]).join(" #")}`:"";e.push({kind:"task",entryId:i.entry_id,taskId:l.id,label:h,sub:a+p})}}if(e.length>60)break}return e.slice(0,40)}_selectPaletteResult(t){this._closePalette(),t.kind==="task"&&t.taskId?this._showTask(t.entryId,t.taskId):this._showObject(t.entryId)}_renderPalette(){if(!this._paletteOpen)return d;let t=this._lang,e=this._paletteResults;return r`
    ...
    `}_statusBadge(t,e,i){let a=this._lang,l=t?"archived":e?"done":i,h=t?"archived":e?"completed":i,c=t?s("archived",a):e?s("completed",a):s(i,a);return r`<span class="status-badge ${l}"><ha-icon icon="${Mt[h]||"mdi:circle-medium"}"></ha-icon>${c}</span>`}_setOverviewTab(t){this._overviewTab=t;try{localStorage.setItem(F.overviewTab,t)}catch{}this._scrollContentToTop()}_renderToday(){let t=this._lang,e=this._taskRows,i=p=>`${p.entry_id}:${p.task_id}`,a=e.filter(p=>p.status==="overdue"||p.trigger_active),l=new Set(a.map(i)),h=e.filter(p=>!l.has(i(p))&&p.days_until_due===0);h.forEach(p=>l.add(i(p)));let c=e.filter(p=>!l.has(i(p))&&p.days_until_due!=null&&p.days_until_due>0&&p.days_until_due<=7);return a.length+h.length+c.length===0?r`
    ...
    `}_renderDashboard(){let t=this._stats,e=this._taskRows,i=this._lang,a=this._isOperator,l=this._objects.reduce((c,p)=>c+p.tasks.filter(u=>u.archived).length,0),h=(this._filterStatus?1:0)+(this._filterUser?1:0)+(this._filterLabel?1:0)+(this._activeViewId?1:0);return r`
      ...
      ${a?d:r`
        ...
        >
          <ha-button
            @click=${()=>this._ui("maintenance-task-dialog").then(c=>c?.openCreate("",this._objects))}
          >
            ${s("new_task",i)}
          </ha-button>
          <ha-button
            @click=${()=>this._ui("maintenance-object-dialog").then(c=>c?.openCreate())}
          >
            ${s("new_object",i)}
          </ha-button>
    ...
    `}_renderTaskTable(t){let e=this._bulkMode?" bulk":"";if(this._virtTotalRows=t.length,this.narrow||t.length<120)return r`
      ...
      `;let i=t.length,a=this._virtRowHeight,l=Math.max(0,Math.min(this._virtStart,i)),h=this._virtEnd>0?Math.min(this._virtEnd,i):Math.min(i,40);h<l&&(l=0,h=Math.min(i,40));let c=l*a,p=(i-h)*a;return r`
    ...
    `}_renderVirtSizerRow(t){let e=this._lang,i="",a=!1,l=!1,h=!1;for(let c of t){let p=c.archived?s("archived",e):c.is_done?s("completed",e):s(c.status,e);p.length>i.length&&(i=p),c.enabled||(a=!0),c.nfc_tag_id&&(l=!0),(c.priority==="high"||c.priority==="low")&&(h=!0)}return r`
    ...
    `}_renderGroupedTasks(t,e){let i=new Map,a=s("unassigned",e);for(let c of t){let p=[];this._groupByMode==="area"?p=[(c.area_id?this.hass?.areas?.[c.area_id]?.name:null)||a]:this._groupByMode==="user"?p=[(c.responsible_user_id?this._userService?.getUserName(c.responsible_user_id):null)||a]:this._groupByMode==="group"&&(p=c.group_names.length>0?c.group_names:[a]);for(let u of p)i.has(u)||i.set(u,[]),i.get(u).push(c)}let l=[...i.entries()].sort(([c],[p])=>c===a&&p!==a?1:p===a&&c!==a?-1:c.localeCompare(p)),h=this._groupByMode==="area"?"mdi:map-marker-outline":this._groupByMode==="group"?"mdi:folder-outline":"mdi:account-outline";return r`
      ...
      `)}
    `}_warrantyLabel(t,e,i){return t.kind==="expired"?s("warranty_expired",i):t.kind==="expiring"?s("warranty_expires_in",i).replace("{days}",String(t.days??0)):s("warranty_valid_until",i).replace("{date}",Y(e,i))}_renderWarrantyMeta(t,e){let i=Kt(t);return r`<p class="meta">${s("warranty",e)}:
      <span class="warranty-chip warranty-${i.kind}">${this._warrantyLabel(i,t,e)}</span></p>`}_renderAllObjects(){let t=this._lang,e=this._isOperator,i=this._objectViewMode==="table"&&!this.narrow,a=this._objects.filter(u=>u.object.archived).length,l=u=>{let g=1/0;for(let v of u.tasks){let b=v.days_until_due;b!=null&&b<g&&(g=b)}return g},h=this._objects.filter(u=>this._showArchived||!u.object.archived);this._objectSortMode==="alphabetical"?h.sort((u,g)=>u.object.name.localeCompare(g.object.name)):this._objectSortMode==="task_count"?h.sort((u,g)=>g.tasks.length-u.tasks.length||u.object.name.localeCompare(g.object.name)):h.sort((u,g)=>l(u)-l(g)||u.object.name.localeCompare(g.object.name));let c=()=>{let u=new Map;for(let g of h){let v=g.object.area_id,b=v?this.hass?.areas?.[v]?.name||s("unassigned",t):s("no_area",t);u.has(b)||u.set(b,[]),u.get(b).push(g)}return new Map([...u.entries()].sort(([g],[v])=>g.localeCompare(v)))},p=u=>{let g=u.tasks.some(v=>v.status==="overdue"||v.status==="triggered");return r`
        <div class="object-card${g?" object-card-overdue":""}" @click=${()=>this._showObject(u.entry_id)}>
          ${g?r`<span class="overdue-dot" title="${s("has_overdue",t)}"></span>`:d}
      ...
      ${i?this._renderObjectsTable(h):this._groupByMode==="area"?r`
          ${[...c().entries()].map(([u,g])=>r`
            <details class="group-section" open>
              ...
              <div class="objects-grid">${g.map(p)}</div>
            </details>
          `)}
    ...
    `}_setObjectViewMode(t){this._objectViewMode=t,localStorage.setItem(F.objectView,t)}async _exportObjectsCsv(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects/csv"}),e=new Date().toISOString().slice(0,10);re(t.csv,`maintenance_objects_${e}.csv`,"text/csv;charset=utf-8")}catch{this._showToast(s("action_error",this._lang))}}_renderObjectsTable(t){let e=this._lang,i=this._objectsTableColumns;return r`
      <div class="objects-table-wrap">
        <table class="objects-table">
          <thead>
            <tr>
              ${i.map(a=>{let l=se.find(c=>c.key===a),h=l&&l.key!=="actions"?s(l.labelKey,e):"";return r`<th class="oc-${a}">${h}</th>`})}
            </tr>
          </thead>
          <tbody>
            ${t.map(a=>r`
    ...
    `}_renderObjectCell(t,e,i){let a=e.object;switch(t){case"name":return r`<td class="oc-name">
          ...
          ${a.document_count?r`<span class="doc-badge" title="${a.document_count} ${s("documents",i)}">
                ...
                @click=${h=>h.stopPropagation()}><ha-icon icon="mdi:file-document-outline"></ha-icon></a>`:l?r`<a href="#" title=${l.title}
      ...
      <div class="groups-section">
        ...
        ${t.length===0?r`<div class="hint">${s("no_groups",e)}</div>`:r`
            <div class="groups-grid">
              ${t.map(([i,a])=>{let l=a.task_refs.map(h=>this._getTask(h.entry_id,h.task_id)?.name).filter(Boolean);return r`
                  <div class="group-card">
                    ...
                    <div class="group-card-tasks">
                      ${l.length>0?l.map(h=>r`<span class="group-task-chip">${h}</span>`):r`<span style="font-size:12px;color:var(--secondary-text-color)">${s("no_tasks_short",e)}</span>`}
                    </div>
                  </div>
                `})}
            </div>
    ...
    `}_openGroupCreate(){this.shadowRoot.querySelector("maintenance-group-dialog")?.openCreate()}_openGroupEdit(t){let e=this._groups[t];e&&this.shadowRoot.querySelector("maintenance-group-dialog")?.openEdit(t,e)}async _deleteGroup(t,e){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(i?await i.confirm({title:s("delete_group",this._lang),message:s("delete_group_confirm",this._lang).replace("{name}",e),confirmText:s("delete",this._lang)}):confirm(`${s("delete_group_confirm",this._lang).replace("{name}",e)}`))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/group/delete",group_id:t}),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}}_renderBudgetBar(){let t=this._budget;if(!t)return d;let e=this._lang,i=t.currency_symbol||ut,a=[];t.monthly_budget>0&&a.push({label:s("budget_monthly",e),spent:t.monthly_spent,budget:t.monthly_budget}),t.yearly_budget>0&&a.push({label:s("budget_yearly",e),spent:t.yearly_spent,budget:t.yearly_budget});let l=[];return t.monthly_budget>0||l.push({label:s("budget_monthly",e),spent:t.monthly_spent||0}),t.yearly_budget>0||l.push({label:s("budget_yearly",e),spent:t.yearly_spent||0}),r`
      <div class="budget-bars">
        ${a.map(h=>{let c=Math.min(100,Math.max(0,h.spent/h.budget*100)),p=c>=100?"var(--error-color, #f44336)":c>=t.alert_threshold_pct?"var(--warning-color, #ff9800)":"var(--success-color, #4caf50)";return r`
            <div class="budget-item">
              <div class="budget-label">
                <span>${h.label}</span>
                <span>${h.spent.toFixed(2)} / ${h.budget.toFixed(2)} ${i}</span>
              </div>
        ...
        ${l.map(h=>r`
            <div class="budget-item budget-spent-only">
              <div class="budget-label">
                <span>${h.label}</span>
                <span>${h.spent.toFixed(2)} ${i}</span>
              </div>
            </div>
          `)}
      </div>
    `}_renderOverviewRow(t){let e=this._lang,i=t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0,a=0,l=jt.ok,h=!1;if(i&&t.days_until_due!==null){let v=Ot(t.interval_days,t.days_until_due,t.interval_unit);a=v.pct,h=v.overflow,t.status==="overdue"?l=jt.overdue:t.status==="due_soon"&&(l=jt.due_soon)}let c=t.area_id?this.hass?.areas?.[t.area_id]?.name:null,p=t.responsible_user_id?this._userService?.getUserName(t.responsible_user_id):null,u=t.group_names.length>0||c||p,g=this._bulkMode&&this._bulkSelected.has(this._bulkKey(t));return r`
      <div class="task-row${t.enabled?"":" task-disabled"}${g?" bulk-selected":""}">
        ${this._bulkMode?r`
        ...
        <span class="due-cell" @click=${()=>this._showTask(t.entry_id,t.task_id)}>
          ...
          ${i?r`<div class="days-bar"><div class="days-bar-fill${h?" overflow":""}" style="width:${a}%;background:${l}"></div></div>`:d}
    ...
    `}_openCompleteDialogForRow(t){let i=this._objects.find(a=>a.entry_id===t.entry_id)?.tasks.find(a=>a.id===t.task_id);this._openCompleteDialog(t.entry_id,t.task_id,t.task_name,this._features.checklists?i?.checklist:void 0,this._features.adaptive&&!!i?.adaptive_config?.enabled)}_renderObjectDetail(){if(!this._selectedEntryId)return d;let t=this._getObject(this._selectedEntryId);if(!t)return r`<p>Object not found.</p>`;let e=t.object,i=this._lang,a=this._isOperator,l=t.tasks.filter(c=>c.archived).length,h=t.tasks.filter(c=>this._showArchived||!c.archived);return r`
      <div class="detail-section">
        ...
        ${t.tasks.length===0?r`<div class="empty-state-centered">
            ...
            </div>`:r`<div class="task-table">${[...h].sort((c,p)=>{let u={overdue:0,triggered:1,due_soon:2,ok:3};return(u[c.status]??9)-(u[p.status]??9)||(c.days_until_due??99999)-(p.days_until_due??99999)}).map(c=>r`
