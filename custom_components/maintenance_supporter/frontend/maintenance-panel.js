      ...
      <div class="filter-bar">
        ...
        <label class="filter-field">
          ...
          <select
            ...
            @change=${c=>{this._sortMode=c.target.value,localStorage.setItem(B.taskSort,this._sortMode),this._activeViewId=""}}
          >
        ...
        <label class="filter-field">
          ...
          <select
            ...
            @change=${c=>{this._groupByMode=c.target.value,localStorage.setItem(B.groupBy,this._groupByMode),this._activeViewId=""}}
          >
    ...
    `}_warrantyLabel(e,t,i){return e.kind==="expired"?s("warranty_expired",i):e.kind==="expiring"?s("warranty_expires_in",i).replace("{days}",String(e.days??0)):s("warranty_valid_until",i).replace("{date}",W(t,i))}_renderWarrantyMeta(e,t){let i=Ft(e);return o`<p class="meta">${s("warranty",t)}:
      ...
      <div class="filter-bar">
        ...
        <label class="filter-field">
          ...
          <select
            .value=${this._groupByMode}
            @change=${g=>{this._groupByMode=g.target.value,localStorage.setItem(B.groupBy,this._groupByMode)}}
          >
