  ...
  `,u([T({attribute:!1})],O.prototype,"hass",2),u([h()],O.prototype,"_open",2),u([h()],O.prototype,"_loading",2),u([h()],O.prototype,"_error",2),u([h()],O.prototype,"_name",2),u([h()],O.prototype,"_manufacturer",2),u([h()],O.prototype,"_model",2),u([h()],O.prototype,"_areaId",2),u([h()],O.prototype,"_installationDate",2),u([h()],O.prototype,"_entryId",2);customElements.get("maintenance-object-dialog")||customElements.define("maintenance-object-dialog",O);var ei=["cleaning","inspection","replacement","calibration","service","custom"],ti=["time_based","sensor_based","manual"],ii=["threshold","counter","state_change","runtime"],$=class extends j{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._error="";this._entryId="";this._taskId=null;this._name="";this._type="custom";this._scheduleType="time_based";this._intervalDays="30";this._warningDays="7";this._intervalAnchor="completion";this._notes="";this._documentationUrl="";this._customIcon="";this._enabled=!0;this._triggerEntityId="";this._triggerEntityIds=[];this._triggerEntityLogic="any";this._triggerAttribute="";this._triggerType="threshold";this._triggerAbove="";this._triggerBelow="";this._triggerForMinutes="0";this._triggerTargetValue="";this._triggerDeltaMode=!1;this._triggerFromState="";this._triggerToState="";this._triggerTargetChanges="";this._triggerRuntimeHours="";this._suggestedAttributes=[];this._availableAttributes=[];this._entityDomain="";this._nfcTagId="";this._availableTags=[];this._responsibleUserId=null;this._availableUsers=[];this._userService=null}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}async openCreate(e){this._entryId=e,this._taskId=null,this._error="",this._resetFields(),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}async openEdit(e,t){if(this._entryId=e,this._taskId=t.id,this._error="",this._name=t.name,this._type=t.type,this._scheduleType=t.schedule_type,this._intervalDays=t.interval_days?.toString()||"30",this._warningDays=t.warning_days.toString(),this._intervalAnchor=t.interval_anchor||"completion",this._notes=t.notes||"",this._documentationUrl=t.documentation_url||"",this._customIcon=t.custom_icon||"",this._enabled=t.enabled!==!1,this._nfcTagId=t.nfc_tag_id||"",this._responsibleUserId=t.responsible_user_id||null,t.trigger_config){let i=t.trigger_config;this._triggerEntityId=i.entity_id||"",this._triggerEntityIds=i.entity_ids||(i.entity_id?[i.entity_id]:[]),this._triggerEntityLogic=i.entity_logic||"any",this._triggerAttribute=i.attribute||"",this._triggerType=i.type||"threshold",this._triggerAbove=i.trigger_above?.toString()||"",this._triggerBelow=i.trigger_below?.toString()||"",this._triggerForMinutes=i.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=i.trigger_target_value?.toString()||"",this._triggerDeltaMode=i.trigger_delta_mode||!1,this._triggerFromState=i.trigger_from_state||"",this._triggerToState=i.trigger_to_state||"",this._triggerTargetChanges=i.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=i.trigger_runtime_hours?.toString()||""}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._warningDays="7",this._intervalAnchor="completion",this._notes="",this._documentationUrl="",this._customIcon="",this._enabled=!0,this._nfcTagId="",this._responsibleUserId=null,this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours=""}async _loadUsers(){this._userService||(this._userService=new ne(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}async _loadTags(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tags/list"});this._availableTags=e.tags||[]}catch{this._availableTags=[]}}async _fetchEntityAttributes(e){if(!e||!this.hass){this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="";return}try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/entity/attributes",entity_id:e});this._entityDomain=t.domain||"",this._suggestedAttributes=t.suggested_attributes||[],this._availableAttributes=t.available_attributes||[]}catch{this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain=""}}async _save(){if(this._name.trim()){this._loading=!0,this._error="";try{let e={type:this._taskId?"maintenance_supporter/task/update":"maintenance_supporter/task/create",entry_id:this._entryId,name:this._name,task_type:this._type,schedule_type:this._scheduleType,warning_days:parseInt(this._warningDays,10)||7};if(this._taskId&&(e.task_id=this._taskId),this._scheduleType!=="manual"&&this._intervalDays?(e.interval_days=parseInt(this._intervalDays,10),e.interval_anchor=this._intervalAnchor):this._taskId&&this._scheduleType==="manual"&&(e.interval_days=null,e.interval_anchor="completion"),e.notes=this._notes||null,e.documentation_url=this._documentationUrl||null,e.custom_icon=this._customIcon||null,e.enabled=this._enabled,e.nfc_tag_id=this._nfcTagId||null,e.responsible_user_id=this._responsibleUserId,this._scheduleType==="sensor_based"&&this._triggerEntityId){let t=this._triggerEntityIds.length>0?this._triggerEntityIds:[this._triggerEntityId],i={entity_id:t[0],entity_ids:t,type:this._triggerType};this._triggerAttribute&&(i.attribute=this._triggerAttribute),t.length>1&&(i.entity_logic=this._triggerEntityLogic),this._triggerType==="threshold"?(this._triggerAbove&&(i.trigger_above=parseFloat(this._triggerAbove)),this._triggerBelow&&(i.trigger_below=parseFloat(this._triggerBelow)),this._triggerForMinutes&&(i.trigger_for_minutes=parseInt(this._triggerForMinutes,10))):this._triggerType==="counter"?(this._triggerTargetValue&&(i.trigger_target_value=parseFloat(this._triggerTargetValue)),i.trigger_delta_mode=this._triggerDeltaMode):this._triggerType==="state_change"?(this._triggerFromState&&(i.trigger_from_state=this._triggerFromState),this._triggerToState&&(i.trigger_to_state=this._triggerToState),this._triggerTargetChanges&&(i.trigger_target_changes=parseInt(this._triggerTargetChanges,10))):this._triggerType==="runtime"&&this._triggerRuntimeHours&&(i.trigger_runtime_hours=parseFloat(this._triggerRuntimeHours)),e.trigger_config=i}else this._taskId&&(e.trigger_config=null);await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch{this._error=r("save_error",this._lang)}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return c;let e=this._lang;return l`
      ...
      ${this._triggerEntityIds.length>1?l`
        <div class="select-row">
          ...
          >
            <option value="any">${r("entity_logic_any",e)}</option>
            <option value="all">${r("entity_logic_all",e)}</option>
          </select>
        </div>
      `:c}
      ${this._availableAttributes.length>0?l`
          <div class="select-row">
            ...
            >
              <option value="">${r("use_entity_state",e)}</option>
      ...
      <div class="select-row">
        ...
        >
          ${ii.map(t=>l`<option value=${t}>${r(t,e)}</option>`)}
        </select>
      </div>
    ...
    `}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?l`
      ...
      `:this._triggerType==="runtime"?l`
        ...
        ></ha-textfield>
      `:c}render(){if(!this._open)return l``;let e=this._lang,t=this._taskId?r("edit_task",e):r("new_task",e);return l`
      <ha-dialog open @closed=${this._close} .heading=${t}>
        <div class="content">
          ${this._error?l`<div class="error">${this._error}</div>`:c}
          <ha-textfield
          ...
          <div class="select-row">
            ...
            >
              ${ei.map(i=>l`<option value=${i}>${r(i,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${ti.map(i=>l`<option value=${i}>${r(i,e)}</option>`)}
            </select>
          </div>
          ${this._scheduleType==="time_based"?l`
                ...
                <div class="select-row">
                  ...
                  >
                    <option value="completion">${r("anchor_completion",e)}</option>
                    <option value="planned">${r("anchor_planned",e)}</option>
                  </select>
                </div>
              `:c}
          <ha-textfield
          ...
          <div class="select-row">
            ...
            >
              <option value="">${r("no_user_assigned",e)}</option>
          ...
          ${this._availableTags.length>0?l`
              <div class="select-row">
                ...
                >
                  <option value="">${r("no_nfc_tag",e)}</option>
        ...
        <ha-button slot="secondaryAction" appearance="plain" @click=${this._close}>${r("cancel",e)}</ha-button>
        <ha-button
          slot="primaryAction"
          @click=${this._save}
          .disabled=${this._loading||!this._name.trim()}
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),n.document.close()}_downloadSvg(e,t){let i=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),n=new Blob([i],{type:"image/svg+xml"}),o=URL.createObjectURL(n),d=document.createElement("a");d.href=o;let p=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;d.download=`qr-${ai(p)}-${t}.svg`,d.click(),URL.revokeObjectURL(o)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return l``;let e=this.lang||this.hass?.language||"de",t=this._taskName?`${r("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${r("qr_code",e)}: ${this._objectName}`,i=!!this._viewResult;return l`
      <ha-dialog open @closed=${this._close} .heading=${t}>
        <div class="content">
          ${this._loading?l`<div class="loading">${r("qr_generating",e)}</div>`:this._error?l`<div class="error">${this._error}</div>`:i?l`
                    <div class="qr-pair">
                      <div class="qr-item">
                        <img
  ...
  `,u([T({attribute:!1})],U.prototype,"hass",2),u([h()],U.prototype,"_open",2),u([h()],U.prototype,"_title",2),u([h()],U.prototype,"_message",2),u([h()],U.prototype,"_confirmText",2),u([h()],U.prototype,"_danger",2),u([h()],U.prototype,"_inputLabel",2),u([h()],U.prototype,"_inputType",2),u([h()],U.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",U);var ni=300,ri=140,He=27;function _t(s,a){let e=s.trigger_config;if(!e)return c;let t=a.lang,i=s.trigger_entity_info,n=s.trigger_entity_infos,o=i?.friendly_name||e.entity_id||"\u2014",d=e.entity_id||"",p=e.entity_ids||(d?[d]:[]),_=i?.unit_of_measurement||"",m=s.trigger_current_value,v=e.type||"threshold",b=p.length>1;return l`
    <h3>${r("trigger",t)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${b?l`
            <div class="trigger-entity-name">${p.length} ${r("entities",t)} (${e.entity_logic||"any"})</div>
        ...
        <span class="status-badge ${s.trigger_active?"triggered":"ok"}" style="margin-left: auto;">
          ${s.trigger_active?r("triggered",t):r("ok",t)}
        </span>
      </div>
      ...
      <div class="trigger-limits">
        ${v==="threshold"?l`
          ${e.trigger_above!=null?l`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${r("threshold_above",t)}: ${e.trigger_above} ${_}</span>`:c}
          ${e.trigger_below!=null?l`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${r("threshold_below",t)}: ${e.trigger_below} ${_}</span>`:c}
          ${e.trigger_for_minutes?l`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${r("for_minutes",t)}: ${e.trigger_for_minutes}</span>`:c}
        `:c}
        ${v==="counter"?l`
          ${e.trigger_target_value!=null?l`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${r("target_value",t)}: ${e.trigger_target_value} ${_}</span>`:c}
        `:c}
        ${v==="state_change"?l`
          ${e.trigger_target_changes!=null?l`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${r("target_changes",t)}: ${e.trigger_target_changes}</span>`:c}
        `:c}
        ${v==="runtime"?l`
          ${e.trigger_runtime_hours!=null?l`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${r("runtime_hours",t)}: ${e.trigger_runtime_hours}h</span>`:c}
        `:c}
        ${v==="compound"?l`
          <span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${r("compound_logic",t)}: ${e.compound_logic||e.operator||"AND"}</span>
          ${(e.conditions||[]).map((f,w)=>l`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${w+1}. ${r(f.type||"unknown",t)}: ${f.entity_id||""}</span>
          `)}
        `:c}
        ${i?.min!=null?l`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${r("min",t)}: ${i.min} ${_}</span>`:c}
        ${i?.max!=null?l`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${r("max",t)}: ${i.max} ${_}</span>`:c}
      </div>
  ...
  `}function si(s,a,e){let t=s.trigger_config;if(!t)return c;let i=t.type||"threshold",n=i==="counter"&&t.trigger_delta_mode,o=e.isCounterEntity(t),d=t.entity_id||"",p=e.detailStatsData.get(d)||[],_=[],m=!1;if(p.length>=2)for(let g of p){let k=g.val;n&&s.trigger_baseline_value!=null&&(k-=s.trigger_baseline_value);let F={ts:g.ts,val:k};!o&&g.min!=null&&g.max!=null&&(F.min=n&&s.trigger_baseline_value!=null?g.min-s.trigger_baseline_value:g.min,F.max=n&&s.trigger_baseline_value!=null?g.max-s.trigger_baseline_value:g.max,m=!0),_.push(F)}else for(let g of s.history)g.trigger_value!=null&&_.push({ts:new Date(g.timestamp).getTime(),val:g.trigger_value});if(s.trigger_current_value!=null){let g=s.trigger_current_value;n&&s.trigger_baseline_value!=null&&(g-=s.trigger_baseline_value),_.push({ts:Date.now(),val:g})}if(_.length<2&&d&&e.hasStatsService&&!e.detailStatsData.has(d))return l`<div class="sparkline-container" aria-live="polite" style="display:flex;align-items:center;justify-content:center;height:140px;color:var(--secondary-text-color);font-size:12px;">
      <ha-icon icon="mdi:chart-line" style="--mdc-icon-size:16px;margin-right:8px;"></ha-icon>
      ${r("loading_chart",e.lang)}
    </div>`;if(_.length<2)return c;_.sort((g,k)=>g.ts-k.ts);let v=ni,b=ri,f=30,w=2,S=8,H=16,M=_.map(g=>g.val),E=Math.min(...M),y=Math.max(...M);if(m)for(let g of _)g.min!=null&&(E=Math.min(E,g.min)),g.max!=null&&(y=Math.max(y,g.max));t.trigger_above!=null&&(y=Math.max(y,t.trigger_above),E=Math.min(E,t.trigger_above)),t.trigger_below!=null&&(E=Math.min(E,t.trigger_below),y=Math.max(y,t.trigger_below));let L=null,q=null;if(i==="counter"&&t.trigger_target_value!=null){if(s.trigger_baseline_value!=null)L=s.trigger_baseline_value;else if(_.length>0){let g=[...s.history].filter(k=>k.type==="completed"||k.type==="reset").sort((k,F)=>new Date(F.timestamp).getTime()-new Date(k.timestamp).getTime())[0];if(g){let k=new Date(g.timestamp).getTime(),F=_[0],P=Math.abs(_[0].ts-k);for(let G of _){let Z=Math.abs(G.ts-k);Z<P&&(F=G,P=Z)}L=F.val}else L=_[0].val}L!=null?(q=L+t.trigger_target_value,y=Math.max(y,q),E=Math.min(E,L)):(y=Math.max(y,t.trigger_target_value),E=Math.min(E,0))}n&&s.trigger_baseline_value!=null&&(E=Math.min(E,0));let W=y-E||1;E-=W*.1,y+=W*.1;let B=_[0].ts,z=_[_.length-1].ts,x=z-B||1,D=g=>f+(g-B)/x*(v-f-w),C=g=>S+(1-(g-E)/(y-E))*(b-S-H),we=_.map(g=>`${D(g.ts).toFixed(1)},${C(g.val).toFixed(1)}`).join(" "),xt=`M${D(_[0].ts).toFixed(1)},${b-H} `+_.map(g=>`L${D(g.ts).toFixed(1)},${C(g.val).toFixed(1)}`).join(" ")+` L${D(_[_.length-1].ts).toFixed(1)},${b-H} Z`,ke="";if(m){let g=_.filter(k=>k.min!=null&&k.max!=null);if(g.length>=2){let k=g.map(P=>`${D(P.ts).toFixed(1)},${C(P.max).toFixed(1)}`),F=[...g].reverse().map(P=>`${D(P.ts).toFixed(1)},${C(P.min).toFixed(1)}`);ke=`M${k[0]} `+k.slice(1).map(P=>`L${P}`).join(" ")+` L${F[0]} `+F.slice(1).map(P=>`L${P}`).join(" ")+" Z"}}let Ne=_[_.length-1],$t=D(Ne.ts),wt=C(Ne.val),qe=g=>Math.abs(g)>=1e4?(g/1e3).toFixed(0)+"k":g>=1e3?(g/1e3).toFixed(1)+"k":g.toFixed(g<10?1:0),kt=qe(y),Et=qe(E),At=s.history.filter(g=>["completed","skipped","reset"].includes(g.type)).map(g=>({ts:new Date(g.timestamp).getTime(),type:g.type})).filter(g=>g.ts>=B&&g.ts<=z),Ee=_;if(_.length>He){let g=(_.length-1)/(He-1);Ee=[];for(let k=0;k<He;k++)Ee.push(_[Math.round(k*g)])}return l`
    <div class="sparkline-container">
      <svg class="sparkline-svg" viewBox="0 0 ${v} ${b}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${r("chart_sparkline",e.lang)}">
        <text x="${f-3}" y="${S+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${kt}</text>
        ...
        ${ke?I`<path d="${ke}" fill="var(--primary-color)" opacity="0.08" />`:c}
        ...
        ${s.degradation_rate!=null&&s.degradation_trend!=="stable"&&s.degradation_trend!=="insufficient_data"&&_.length>=2?(()=>{let g=_[_.length-1],k=30,F=g.ts+k*864e5,P=g.val+s.degradation_rate*k,G=Math.min(F,z+(z-B)*.3),Z=Math.max(E,Math.min(y,P)),Tt=D(g.ts),St=C(g.val),Ct=D(G),Mt=C(Z);return I`<line x1="${Tt.toFixed(1)}" y1="${St.toFixed(1)}" x2="${Ct.toFixed(1)}" y2="${Mt.toFixed(1)}" stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.7" />`})():c}
        ${i==="threshold"&&t.trigger_above!=null?I`<line x1="${f}" y1="${C(t.trigger_above).toFixed(1)}" x2="${v}" y2="${C(t.trigger_above).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${v-2}" y="${C(t.trigger_above)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25B2 ${t.trigger_above}</text>`:c}
        ${i==="threshold"&&t.trigger_below!=null?I`<line x1="${f}" y1="${C(t.trigger_below).toFixed(1)}" x2="${v}" y2="${C(t.trigger_below).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${v-2}" y="${C(t.trigger_below)+11}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25BC ${t.trigger_below}</text>`:c}
        ${i==="counter"&&q!=null?I`<line x1="${f}" y1="${C(q).toFixed(1)}" x2="${v}" y2="${C(q).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${v-2}" y="${C(q)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">${r("target_value",e.lang)}: +${t.trigger_target_value}</text>`:c}
        ${i==="counter"&&L!=null?I`<line x1="${f}" y1="${C(L).toFixed(1)}" x2="${v}" y2="${C(L).toFixed(1)}" stroke="var(--secondary-text-color)" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
                <text x="${f+2}" y="${C(L)+11}" text-anchor="start" fill="var(--secondary-text-color)" font-size="8">${r("baseline",e.lang)}</text>`:c}
        ...
        ${At.map(g=>{let k=D(g.ts),F=g.type==="completed"?"var(--success-color, #4caf50)":g.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return I`
            <line x1="${k.toFixed(1)}" y1="${S}" x2="${k.toFixed(1)}" y2="${b-H}" stroke="${F}" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
            <circle cx="${k.toFixed(1)}" cy="${S+2}" r="5" fill="${F}" opacity="0.8" />
            <text x="${k.toFixed(1)}" y="${S+6}" text-anchor="middle" fill="white" font-size="7" font-weight="bold">${g.type==="completed"?"\u2713":g.type==="skipped"?"\u23ED":"\u21BA"}</text>
          `})}
        ${Ee.map(g=>{let k=D(g.ts),F=C(g.val),P=new Date(g.ts).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),G=`${g.val.toFixed(1)} ${a}`;return m&&g.min!=null&&g.max!=null&&(G+=` (${g.min.toFixed(1)}\u2013${g.max.toFixed(1)})`),I`<circle cx="${k.toFixed(1)}" cy="${F.toFixed(1)}" r="8" fill="transparent" tabindex="0"
            @mouseenter=${Z=>ut(Z,`${P}
${G}`,e.setTooltip)}
            @focus=${Z=>ut(Z,`${P}
${G}`,e.setTooltip)}
...
`).map(g=>l`<div>${g}</div>`)}
  ...
  `}function ut(s,a,e){let t=s.currentTarget,i=t.closest(".sparkline-container");if(!i)return;let n=i.getBoundingClientRect(),o=t.getBoundingClientRect();e({x:o.left-n.left+o.width/2,y:o.top-n.top-8,text:a})}function ht(s,a,e){let t=s.degradation_trend!=null&&s.degradation_trend!=="insufficient_data",i=s.days_until_threshold!=null,n=s.environmental_factor!=null&&s.environmental_factor!==1;if(!t&&!i&&!n)return c;let o=s.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":s.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return l`
    <div class="prediction-section">
      ${s.sensor_prediction_urgency?l`
        <div class="prediction-urgency-banner">
          <ha-svg-icon path="M1,21H23L12,2L1,21M12,18A1,1 0 0,1 11,17A1,1 0 0,1 12,16A1,1 0 0,1 13,17A1,1 0 0,1 12,18M13,15H11V10H13V15Z"></ha-svg-icon>
          ${r("sensor_prediction_urgency",a).replace("{days}",String(Math.round(s.days_until_threshold||0)))}
        </div>
      `:c}
      <div class="prediction-title">
        <ha-svg-icon path="M2,2V4H7V2H2M22,2V4H13V2H22M7,7V9H2V7H7M22,7V9H13V7H22M7,12V14H2V12H7M22,12V14H13V12H22M7,17V19H2V17H7M22,17V19H13V17H22M9,2V19L12,22L15,19V2H9M11,4H13V17.17L12,18.17L11,17.17V4Z"></ha-svg-icon>
        ${r("sensor_prediction",a)}
      </div>
      <div class="prediction-grid">
        ${t?l`
          <div class="prediction-item">
            <ha-svg-icon path="${o}"></ha-svg-icon>
            <span class="prediction-label">${r("degradation_trend",a)}</span>
            <span class="prediction-value ${s.degradation_trend}">${r("trend_"+s.degradation_trend,a)}</span>
            ${s.degradation_rate!=null?l`<span class="prediction-rate">${s.degradation_rate>0?"+":""}${Math.abs(s.degradation_rate)>=10?Math.round(s.degradation_rate).toLocaleString():s.degradation_rate.toFixed(1)} ${s.trigger_entity_info?.unit_of_measurement||""}/${r("day_short",a)}</span>`:c}
          </div>
        `:c}
        ${i?l`
          <div class="prediction-item">
            <ha-svg-icon path="M12,20A7,7 0 0,1 5,13A7,7 0 0,1 12,6A7,7 0 0,1 19,13A7,7 0 0,1 12,20M12,4A9,9 0 0,0 3,13A9,9 0 0,0 12,22A9,9 0 0,0 21,13A9,9 0 0,0 12,4M12.5,8H11V14L15.75,16.85L16.5,15.62L12.5,13.25V8M7.88,3.39L6.6,1.86L2,5.71L3.29,7.24L7.88,3.39M22,5.72L17.4,1.86L16.11,3.39L20.71,7.25L22,5.72Z"></ha-svg-icon>
            <span class="prediction-label">${r("days_until_threshold",a)}</span>
            <span class="prediction-value prediction-days${s.days_until_threshold===0?" exceeded":s.sensor_prediction_urgency?" urgent":""}">${s.days_until_threshold===0?r("threshold_exceeded",a):"~"+Math.round(s.days_until_threshold)+" "+r("days",a)}</span>
            ${s.threshold_prediction_date?l`<span class="prediction-date">${Q(s.threshold_prediction_date,a)}</span>`:c}
        ...
        ${n&&e.environmental?l`
          <div class="prediction-item">
            ...
            <span class="prediction-label">${r("environmental_adjustment",a)}</span>
  ...
  `}function gt(s,a){let e=s.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return c;let n=s.interval_days??0,o=s.suggested_interval??n;return l`
    <div class="weibull-section">
      <div class="weibull-title">
        <ha-svg-icon aria-hidden="true" path="M3,14L3.5,14.07L8.07,9.5C7.89,8.85 8.06,8.11 8.59,7.59C9.37,6.8 10.63,6.8 11.41,7.59C11.94,8.11 12.11,8.85 11.93,9.5L14.5,12.07L15,12C15.18,12 15.35,12 15.5,12.07L19.07,8.5C19,8.35 19,8.18 19,8A2,2 0 0,1 21,6A2,2 0 0,1 23,8A2,2 0 0,1 21,10C20.82,10 20.65,10 20.5,9.93L16.93,13.5C17,13.65 17,13.82 17,14A2,2 0 0,1 15,16A2,2 0 0,1 13,14L13.07,13.5L10.5,10.93C10.18,11 9.82,11 9.5,10.93L4.93,15.5L5,16A2,2 0 0,1 3,18A2,2 0 0,1 1,16A2,2 0 0,1 3,14Z"></ha-svg-icon>
        ${r("weibull_reliability_curve",a)}
        ${oi(t,a)}
      </div>
      ${li(t,i,n,o,a)}
      ${ci(e,a)}
  ...
  `}function li(s,a,e,t,i){let f=Math.max(e,t,a,1)*1.3,w=50,S=[];for(let z=0;z<=w;z++){let x=z/w*f,D=1-Math.exp(-Math.pow(x/a,s)),C=32+x/f*260,we=136-D*128;S.push([C,we])}let H=S.map(([z,x])=>`${z.toFixed(1)},${x.toFixed(1)}`).join(" "),M="M32,136 "+S.map(([z,x])=>`L${z.toFixed(1)},${x.toFixed(1)}`).join(" ")+` L${S[w][0].toFixed(1)},136 Z`,E=32+e/f*260,y=1-Math.exp(-Math.pow(e/a,s)),L=136-y*128,q=((1-y)*100).toFixed(0),W=32+t/f*260,B=[0,.25,.5,.75,1];return l`
    ...
    <div class="chart-legend">
      ...
      ${e>0?l`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4); opacity:0.5"></span> ${r("current_interval_marker",i)}</span>`:c}
      ${t>0&&t!==e?l`<span class="legend-item"><span class="legend-swatch" style="background:var(--success-color, #4caf50)"></span> ${r("recommended_marker",i)}</span>`:c}
    </div>
  `}function ci(s,a){return l`
    <div class="weibull-info-row">
      <div class="weibull-info-item">
        <span>${r("characteristic_life",a)}</span>
        <span class="weibull-info-value">${Math.round(s.weibull_eta)} ${r("days",a)}</span>
      </div>
      ${s.weibull_r_squared!=null?l`
        <div class="weibull-info-item">
          <span>${r("weibull_r_squared",a)}</span>
          <span class="weibull-info-value">${s.weibull_r_squared.toFixed(3)}</span>
        </div>
      `:c}
    </div>
  `}function di(s,a,e){let t=s.confidence_interval_low,i=s.confidence_interval_high,n=a.suggested_interval??a.interval_days??0,o=a.interval_days??0,d=Math.max(0,t-5),_=i+5-d,m=(t-d)/_*100,v=(i-t)/_*100,b=(n-d)/_*100,f=o>0?(o-d)/_*100:-1;return l`
  ...
  `}var mt=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function vt(s,a,e){if(!e.seasonal||!s.seasonal_factor||s.seasonal_factor===1)return c;let t=mt.map(d=>r(d,a)),i=new Date().getMonth(),n=s.seasonal_factors||s.interval_analysis?.seasonal_factors||null,o=n&&n.length===12?n:t.map((d,p)=>{let _=s.seasonal_factor||1,m=Math.sin((p-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,_+m))});return l`
    <div class="seasonal-card-compact">
      ...
      <div class="seasonal-legend">
        <span class="legend-item"><span class="dot low"></span> ${r("shorter",a)||"K\xFCrzer"}</span>
        <span class="legend-item"><span class="dot normal"></span> ${r("normal",a)||"Normal"}</span>
        <span class="legend-item"><span class="dot high"></span> ${r("longer",a)||"L\xE4nger"}</span>
      </div>
    </div>
  `}function ft(s,a){return pi(s,a)}function pi(s,a){let e=s.seasonal_factors??s.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return c;let t=s.interval_analysis?.seasonal_reason,i=new Date().getMonth(),n=300,o=100,d=8,_=o-d-4,m=Math.max(...e,1.5),v=n/12,b=v*.65,f=d+_-1/m*_;return l`
    <div class="seasonal-chart">
      <div class="seasonal-chart-title">
        <ha-svg-icon aria-hidden="true" path="M17.75 4.09L15.22 6.03L16.13 9.09L13.5 7.28L10.87 9.09L11.78 6.03L9.25 4.09L12.44 4L13.5 1L14.56 4L17.75 4.09M21.25 11L19.61 12.25L20.2 14.23L18.5 13.06L16.8 14.23L17.39 12.25L15.75 11L17.81 10.95L18.5 9L19.19 10.95L21.25 11M18.97 15.95C19.8 15.87 20.69 17.05 20.16 17.8C19.84 18.25 19.5 18.67 19.08 19.07C15.17 23 8.84 23 4.94 19.07C1.03 15.17 1.03 8.83 4.94 4.93C5.34 4.53 5.76 4.17 6.21 3.85C6.96 3.32 8.14 4.21 8.06 5.04C7.79 7.9 8.75 10.87 10.95 13.06C13.14 15.26 16.1 16.22 18.97 15.95Z"></ha-svg-icon>
        ${r("seasonal_chart_title",a)}
        ${t?l`<span class="source-tag">${t==="learned"?r("seasonal_learned",a):r("seasonal_manual",a)}</span>`:c}
      </div>
      <svg viewBox="0 0 ${n} ${o}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${r("chart_seasonal",a)}">
        <line x1="0" y1="${f.toFixed(1)}" x2="${n}" y2="${f.toFixed(1)}"
          stroke="var(--divider-color)" stroke-width="1" stroke-dasharray="4,3" />
        ${e.map((w,S)=>{let H=w/m*_,M=S*v+(v-b)/2,E=d+_-H,y=S===i,L=w<1?"var(--success-color, #4caf50)":w>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return I`
            <rect x="${M.toFixed(1)}" y="${E.toFixed(1)}"
              width="${b.toFixed(1)}" height="${H.toFixed(1)}"
              fill="${L}" opacity="${y?1:.5}" rx="2" />
          `})}
      </svg>
      <div class="seasonal-labels">
        ${mt.map((w,S)=>l`<span class="seasonal-label ${S===i?"active-month":""}">${r(w,a)}</span>`)}
      </div>
    </div>
  `}var ui=300,_i=200;function bt(s,a,e,t){let i=s.history.filter(d=>d.type==="completed"&&(d.cost!=null||d.duration!=null));if(i.length<2)return c;let n=i.some(d=>(d.cost??0)>0),o=i.some(d=>(d.duration??0)>0);return!n&&!o?c:l`
    <div class="cost-duration-card">
      <div class="card-header">
        <h3>${r("cost_duration_chart",a)}</h3>
  ...
  `}function hi(s,a,e){let t=s.history.filter(x=>x.type==="completed"&&(x.cost!=null||x.duration!=null)).map(x=>({ts:new Date(x.timestamp).getTime(),cost:x.cost??0,duration:x.duration??0})).sort((x,D)=>x.ts-D.ts);if(t.length<2)return c;let i=t.some(x=>x.cost>0),n=t.some(x=>x.duration>0);if(!i&&!n)return c;let o=e!=="duration"&&i,d=e!=="cost"&&n,p=o||!d&&i,_=d||!o&&n,m=ui,v=_i,b=p?32:8,f=_?32:8,w=8,S=20,H=m-b-f,M=v-w-S,E=Math.max(...t.map(x=>x.cost))||1,y=Math.max(...t.map(x=>x.duration))||1,L=Math.min(20,H/t.length*.6),q=H/t.length,W=x=>b+q*x+q/2,B=x=>w+M-x/E*M,z=x=>w+M-x/y*M;return l`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${m} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${r("chart_history",a)}">
        ${p?t.map((x,D)=>I`
          <rect x="${(W(D)-L/2).toFixed(1)}" y="${B(x.cost).toFixed(1)}" width="${L.toFixed(1)}" height="${(w+M-B(x.cost)).toFixed(1)}"
  ...
  `}var gi=60,mi=20,yt=30,A=class extends j{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._unsub=null;this._sparklineTooltip=null;this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1};this._actionLoading=!1;this._moreMenuOpen=!1;this._toastMessage="";this._toastTimer=null;this._dismissedSuggestions=new Set;this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=e=>this._onPopState(e);this._deepLinkHandled=!1;this._onDialogEvent=async()=>{try{await this._loadData()}catch{}}}get _lang(){return this.hass?.language||"de"}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._popstateHandler)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(e){if(super.updated(e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new $e(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new ne(this.hass),this._userService.getUsers())}}async _loadData(){let[e,t,i,n,o]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null)]);e&&(this._objects=e.objects),t&&(this._stats=t),i&&(this._budget=i),n&&(this._groups=n.groups||{}),o&&(this._features=o.features),this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search),t=e.get("entry_id");if(!t)return;this._deepLinkHandled=!0;let i=e.get("task_id"),n=e.get("action"),o=window.location.pathname+window.location.hash;history.replaceState(history.state,"",o);let d=this._getObject(t);if(!d){this._showOverview();return}if(i){let p=d.tasks.find(_=>_.id===i);if(!p){this._showObject(t);return}this._showTask(t,i),n==="complete"&&requestAnimationFrame(()=>{this._openCompleteDialog(t,i,p.name,this._features.checklists?p.checklist:void 0,this._features.adaptive&&!!p.adaptive_config?.enabled)})}else this._showObject(t)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let i=await this._statsService.getDetailStats(e,t),n=new Map(this._detailStatsData);n.set(e,i),this._detailStatsData=n}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=[];for(let i of this._objects)for(let n of i.tasks){let o=n.trigger_config?.entity_id;o&&e.push({entityId:o,isCounter:this._isCounterEntity(n.trigger_config)})}if(e.length===0)return;let t=await this._statsService.getBatchMiniStats(e);this._miniStatsData=new Map([...this._miniStatsData,...t])}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _taskRows(){let e=[];for(let i of this._objects)for(let n of i.tasks)if(!(this._filterStatus&&n.status!==this._filterStatus)){if(this._filterUser){let o=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(n.responsible_user_id!==o)continue}e.push({entry_id:i.entry_id,task_id:n.id,object_name:i.object.name,task_name:n.name,type:n.type,schedule_type:n.schedule_type,status:n.status,days_until_due:n.days_until_due??null,next_due:n.next_due??null,trigger_active:n.trigger_active,trigger_current_value:n.trigger_current_value??null,trigger_current_delta:n.trigger_current_delta??null,trigger_config:n.trigger_config??null,trigger_entity_info:n.trigger_entity_info??null,times_performed:n.times_performed,total_cost:n.total_cost,interval_days:n.interval_days??null,history:n.history||[],enabled:n.enabled,nfc_tag_id:n.nfc_tag_id??null})}let t={overdue:0,triggered:1,due_soon:2,ok:3};return e.sort((i,n)=>(t[i.status]??9)-(t[n.status]??9)),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(n=>n.id===t)}_pushPanelState(e,t,i){let n={msp_view:e,msp_entry:t||null,msp_task:i||null};history.pushState(n,"")}_onPopState(e){let t=e.state;if(t?.msp_view&&(this._view=t.msp_view,this._selectedEntryId=t.msp_entry||null,this._selectedTaskId=t.msp_task||null,this._moreMenuOpen=!1,t.msp_view==="task"&&t.msp_entry&&t.msp_task)){this._historyFilter=null;let i=this._getTask(t.msp_entry,t.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1}_showObject(e){this._pushPanelState("object",e),this._view="object",this._selectedEntryId=e,this._selectedTaskId=null}_showTask(e,t){this._pushPanelState("task",e,t),this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._activeTab="overview",this._historyFilter=null;let i=this._getTask(e,t);if(i?.trigger_config?.entity_id){let n=i.trigger_config.entity_id,o=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(n,o)}}_showToast(e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}async _deleteObject(e){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:r("delete",this._lang),message:r("confirm_delete_object",this._lang),confirmText:r("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:e}),this._showOverview(),await this._loadData()}catch{this._showToast(r("action_error",this._lang))}}async _deleteTask(e,t){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:r("delete",this._lang),message:r("confirm_delete_task",this._lang),confirmText:r("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/delete",entry_id:e,task_id:t}),this._showObject(e),await this._loadData()}catch{this._showToast(r("action_error",this._lang))}}async _skipTask(e,t,i){this._actionLoading=!0;try{let n={type:"maintenance_supporter/task/skip",entry_id:e,task_id:t};i&&(n.reason=i),await this.hass.connection.sendMessagePromise(n),await this._loadData()}catch{this._showToast(r("action_error",this._lang))}finally{this._actionLoading=!1}}async _resetTask(e,t,i){this._actionLoading=!0;try{let n={type:"maintenance_supporter/task/reset",entry_id:e,task_id:t};i&&(n.reset_date=i),await this.hass.connection.sendMessagePromise(n),await this._loadData()}catch{this._showToast(r("action_error",this._lang))}finally{this._actionLoading=!1}}async _applySuggestion(e,t,i){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/apply_suggestion",entry_id:e,task_id:t,interval:i}),await this._loadData()}catch{this._showToast(r("action_error",this._lang))}}async _promptSkipTask(e,t){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!i)return;let n=await i.prompt({title:r("skip",this._lang),message:r("skip_reason_prompt",this._lang),confirmText:r("skip",this._lang),inputLabel:r("reason_optional",this._lang),inputType:"text"});n.confirmed&&this._skipTask(e,t,n.value||void 0)}async _promptResetTask(e,t){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!i)return;let n=await i.prompt({title:r("reset",this._lang),message:r("reset_date_prompt",this._lang),confirmText:r("reset",this._lang),inputLabel:r("reset_date_optional",this._lang),inputType:"date"});n.confirmed&&this._resetTask(e,t,n.value||void 0)}_dismissSuggestion(e,t){e&&t&&this._dismissedSuggestions.add(`${e}_${t}`),this.requestUpdate()}_openCompleteDialog(e,t,i,n,o){let d=this.shadowRoot.querySelector("maintenance-complete-dialog");d&&(d.entryId=e,d.taskId=t,d.taskName=i,d.lang=this._lang,d.checklist=n||[],d.adaptiveEnabled=!!o,d.open())}_openQrForObject(e,t){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForObject(e,t)}_openQrForTask(e,t,i,n){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForTask(e,t,i,n)}async _exportCsv(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/csv/export"}),t=new Blob([e.csv],{type:"text/csv;charset=utf-8;"}),i=URL.createObjectURL(t),n=document.createElement("a");n.href=i,n.download="maintenance_export.csv",n.click(),URL.revokeObjectURL(i)}catch{this._showToast(r("action_error",this._lang))}}_triggerImportCsv(){let e=this.shadowRoot?.querySelector("input[type=file]");e&&(e.value="",e.click())}async _handleCsvFile(e){let i=e.target.files?.[0];if(i)try{let n=await i.text(),o=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/csv/import",csv_content:n});await this._loadData(),await this.shadowRoot?.querySelector("maintenance-confirm-dialog")?.confirm({title:"Import",message:r("import_result",this._lang).replace("{created}",String(o.created)).replace("{total}",String(o.total)),confirmText:"OK"})}catch{this._showToast(r("action_error",this._lang))}}render(){return l`
    ...
    `}_renderHeader(){let e=[{label:r("maintenance",this._lang),action:()=>this._showOverview()}];if(this._view==="object"&&this._selectedEntryId){let t=this._getObject(this._selectedEntryId);e.push({label:t?.object.name||"Object"})}if(this._view==="task"&&this._selectedEntryId&&this._selectedTaskId){let t=this._getObject(this._selectedEntryId);e.push({label:t?.object.name||"Object",action:()=>this._showObject(this._selectedEntryId)});let i=this._getTask(this._selectedEntryId,this._selectedTaskId);e.push({label:i?.name||"Task"})}return l`
      <div class="header">
    ...
    `}_renderOverview(){let e=this._stats,t=this._taskRows,i=this._lang;return l`
      ...
      <div class="filter-bar">
        ...
        >
          <option value="">${r("all",i)}</option>
          <option value="overdue">${r("overdue",i)}</option>
          <option value="due_soon">${r("due_soon",i)}</option>
          <option value="triggered">${r("triggered",i)}</option>
          <option value="ok">${r("ok",i)}</option>
        </select>
        <select
          .value=${this._filterUser||""}
          @change=${n=>{let o=n.target.value;this._filterUser=o||null}}
        >
          <option value="">${r("all_users",i)}</option>
          <option value="current_user">${r("my_tasks",i)}</option>
        </select>
        <ha-button
        ...
        <ha-button @click=${this._exportCsv}>${r("export_csv",i)}</ha-button>
        <ha-button @click=${this._triggerImportCsv}>${r("import_csv",i)}</ha-button>
          ...
          ${e.map(([i,n])=>{let o=n.task_refs.map(d=>this._getTask(d.entry_id,d.task_id)?.name).filter(Boolean);return l`
              <div class="group-card">
                ...
                <div class="group-card-tasks">
                  ${o.length>0?o.map(d=>l`<span class="group-task-chip">${d}</span>`):l`<span style="font-size:12px;color:var(--secondary-text-color)">${r("no_tasks_short",t)}</span>`}
                </div>
              </div>
            `})}
        </div>
      </div>
    `}_renderBudgetBar(){let e=this._budget;if(!e)return c;let t=this._lang,i=[];return e.monthly_budget>0&&i.push({label:r("budget_monthly",t),spent:e.monthly_spent,budget:e.monthly_budget}),e.yearly_budget>0&&i.push({label:r("budget_yearly",t),spent:e.yearly_spent,budget:e.yearly_budget}),i.length===0?c:l`
      <div class="budget-bars">
        ${i.map(n=>{let o=Math.min(100,Math.max(0,n.spent/n.budget*100)),d=o>=100?"var(--error-color, #f44336)":o>=e.alert_threshold_pct?"var(--warning-color, #ff9800)":"var(--success-color, #4caf50)";return l`
            <div class="budget-item">
              <div class="budget-label">
                <span>${n.label}</span>
                <span>${n.spent.toFixed(2)} / ${n.budget.toFixed(2)}</span>
              </div>
    ...
    `}_renderOverviewRow(e){let t=this._lang,i=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,n=0,o=ye.ok,d=!1;if(i&&e.days_until_due!==null){let p=(e.interval_days-e.days_until_due)/e.interval_days*100;n=Math.max(0,Math.min(100,p)),d=p>100,e.status==="overdue"?o=ye.overdue:e.status==="due_soon"&&(o=ye.due_soon)}return l`
      <div class="task-row${e.enabled?"":" task-disabled"}">
        <span class="status-badge ${e.status}">${r(e.status,t)}</span>
        ${e.enabled?c:l`<span class="badge-disabled">${r("disabled",t)}</span>`}
        ${e.nfc_tag_id?l`<span class="nfc-badge" title="${r("nfc_linked",t)}"><ha-icon icon="mdi:nfc-variant"></ha-icon></span>`:c}
        ...
        <span class="cell type">${r(e.type,t)}</span>
    ...
    `}_renderMiniSparkline(e){if(!e.trigger_config?.entity_id)return c;let t=e.trigger_config.entity_id,i=this._miniStatsData.get(t)||[],n=[];if(i.length>=2)n=i.map(y=>({ts:y.ts,val:y.val}));else{if(!e.history)return c;for(let y of e.history)y.trigger_value!=null&&n.push({ts:new Date(y.timestamp).getTime(),val:y.trigger_value})}if(e.trigger_current_value!=null&&n.push({ts:Date.now(),val:e.trigger_current_value}),n.length<2)return c;n.sort((y,L)=>y.ts-L.ts);let o=gi,d=mi,p=n.map(y=>y.val),_=Math.min(...p),m=Math.max(...p),v=m-_||1;_-=v*.1,m+=v*.1;let b=n[0].ts,w=n[n.length-1].ts-b||1,S=y=>(y-b)/w*o,H=y=>2+(1-(y-_)/(m-_))*(d-4),M=n;if(M.length>yt){let y=Math.ceil(M.length/yt);M=M.filter((L,q)=>q%y===0||q===M.length-1)}let E=M.map(y=>`${S(y.ts).toFixed(1)},${H(y.val).toFixed(1)}`).join(" ");return l`
      <svg class="mini-sparkline" viewBox="0 0 ${o} ${d}" preserveAspectRatio="none" role="img" aria-label="${r("chart_mini_sparkline",this._lang)}">
    ...
    `}_renderDaysProgress(e){let t=this._lang;if(e.days_until_due==null||!e.interval_days||e.interval_days<=0)return c;let n=(e.interval_days-e.days_until_due)/e.interval_days*100,o=Math.max(0,Math.min(100,n)),d=n>100,p="var(--success-color, #4caf50)";return e.status==="overdue"?p="var(--error-color, #f44336)":e.status==="due_soon"&&(p="var(--warning-color, #ff9800)"),l`
      <div class="days-progress">
        <div class="days-progress-labels">
          <span>${e.last_performed?`${r("last_performed",t)}: ${Q(e.last_performed,t)}`:""}</span>
          <span>${e.next_due?`${r("next_due",t)}: ${Q(e.next_due,t)}`:""}</span>
        </div>
        <div class="days-progress-bar" role="progressbar" aria-valuenow="${Math.round(o)}" aria-valuemin="0" aria-valuemax="100" aria-label="${r("days_progress",t)}">
      ...
      <div class="detail-section">
        <div class="detail-header">
          ...
          <div class="action-buttons">
            <ha-button appearance="plain" @click=${()=>{this.shadowRoot.querySelector("maintenance-object-dialog")?.openEdit(e.entry_id,t)}}>${r("edit",i)}</ha-button>
            <ha-button appearance="filled" @click=${()=>{this.shadowRoot.querySelector("maintenance-task-dialog")?.openCreate(e.entry_id)}}>${r("add_task",i)}</ha-button>
            <ha-button variant="danger" appearance="plain" @click=${()=>this._deleteObject(e.entry_id)}>${r("delete",i)}</ha-button>
            <ha-button appearance="plain" @click=${()=>this._openQrForObject(e.entry_id,t.name)}><ha-icon icon="mdi:qrcode"></ha-icon> ${r("qr_code",i)}</ha-button>
          </div>
        </div>
        ${t.manufacturer||t.model?l`<p class="meta">${[t.manufacturer,t.model].filter(Boolean).join(" ")}</p>`:c}
        ${t.installation_date?l`<p class="meta">${r("installed",i)}: ${Q(t.installation_date,i)}</p>`:c}

        <h3>${r("tasks",i)} (${e.tasks.length})</h3>
        ${e.tasks.length===0?l`<p class="empty">${r("no_tasks_short",i)}</p>`:e.tasks.map(n=>l`
              <div class="task-row${n.enabled?"":" task-disabled"}">
                <span class="status-badge ${n.status}">${r(n.status,i)}</span>
                ${n.enabled?c:l`<span class="badge-disabled">${r("disabled",i)}</span>`}
                ${n.nfc_tag_id?l`<span class="nfc-badge" title="${r("nfc_linked",i)}"><ha-icon icon="mdi:nfc-variant"></ha-icon></span>`:c}
                <span class="cell task-name" @click=${()=>this._showTask(e.entry_id,n.id)}>${n.name}</span>
                ${this._renderUserBadge(n)}
                <span class="cell type">${r(n.type,i)}</span>
                <span class="due-cell" @click=${()=>this._showTask(e.entry_id,n.id)}>
                  <span class="due-text">${xe(n.days_until_due,i)}</span>
                  ${n.trigger_config?this._renderTriggerProgress(n):c}
                  ${this._renderMiniSparkline(n)}
                </span>
                <span class="row-actions">
                  <mwc-icon-button class="btn-complete" title="${r("complete",i)}" @click=${o=>{o.stopPropagation(),this._openCompleteDialog(e.entry_id,n.id,n.name,this._features.checklists?n.checklist:void 0,this._features.adaptive&&!!n.adaptive_config?.enabled)}}>
                    <ha-icon icon="mdi:check"></ha-icon>
                  </mwc-icon-button>
                  <mwc-icon-button class="btn-skip" title="${r("skip",i)}" .disabled=${this._actionLoading} @click=${o=>{o.stopPropagation(),this._promptSkipTask(e.entry_id,n.id)}}>
                    <ha-icon icon="mdi:skip-next"></ha-icon>
                  </mwc-icon-button>
                </span>
              </div>
    ...
    `}_renderTaskHeader(e){let t=this._lang,n=this._getObject(this._selectedEntryId)?.object.name||"",o=e.status==="due_soon"?"warning":e.status||"ok",d=r(e.status||"ok",t);return l`
      <div class="task-header">
        <div class="task-header-title">
          ...
          ${e.nfc_tag_id?l`<span class="nfc-badge" title="${r("nfc_tag_id",t)}: ${e.nfc_tag_id}"><ha-icon icon="mdi:nfc-variant"></ha-icon> NFC</span>`:l`<span class="nfc-badge unlinked" title="${r("nfc_link_hint",t)}"
        ...
        <div class="task-header-actions">
          <ha-button appearance="filled" @click=${()=>this._openCompleteDialog(this._selectedEntryId,this._selectedTaskId,e.name,this._features.checklists?e.checklist:void 0,this._features.adaptive&&!!e.adaptive_config?.enabled)}>${r("complete",t)}</ha-button>
          <ha-button appearance="plain" .disabled=${this._actionLoading} @click=${()=>this._promptSkipTask(this._selectedEntryId,this._selectedTaskId)}>${r("skip",t)}</ha-button>
          <div class="more-menu-wrapper">
            ...
            ${this._moreMenuOpen?l`
              <div class="popup-menu" @click=${p=>p.stopPropagation()}>
                <div class="popup-menu-item" @click=${()=>{this._closeMoreMenu(),this.shadowRoot.querySelector("maintenance-task-dialog")?.openEdit(this._selectedEntryId,e)}}>${r("edit",t)}</div>
                <div class="popup-menu-item" @click=${()=>{this._closeMoreMenu(),this._promptResetTask(this._selectedEntryId,this._selectedTaskId)}}>${r("reset",t)}</div>
                <div class="popup-menu-item" @click=${()=>{this._closeMoreMenu();let p=this._getObject(this._selectedEntryId)?.object;this._openQrForTask(this._selectedEntryId,this._selectedTaskId,p?.name||"",e.name)}}><ha-icon icon="mdi:qrcode"></ha-icon> ${r("qr_code",t)}</div>
                <div class="popup-menu-divider"></div>
                <div class="popup-menu-item danger" @click=${()=>{this._closeMoreMenu(),this._deleteTask(this._selectedEntryId,this._selectedTaskId)}}>${r("delete",t)}</div>
              </div>
            `:c}
          </div>
        </div>
      ...
      <div class="task-meta-card">
        ...
        ${t?l`
          <div class="task-meta-row task-meta-link">
            ...
            <a href="${t}" target="_blank" rel="noopener noreferrer">${r("documentation_label",i)}</a>
          </div>
        `:c}
      </div>
    `}_renderKPIBar(e){let t=this._lang,i=e.times_performed>0?e.total_cost/e.times_performed:0,n=e.days_until_due!==null&&e.days_until_due!==void 0?e.days_until_due<0?"overdue":e.days_until_due<=e.warning_days?"warning":"":"";return l`
      <div class="kpi-bar">
        <div class="kpi-card">
          <div class="kpi-label">${r("next_due",t)}</div>
          <div class="kpi-value">${e.next_due?Q(e.next_due,t):"\u2014"}</div>
        </div>
        <div class="kpi-card ${n}">
          <div class="kpi-label">${r("days_until_due",t)}</div>
          <div class="kpi-value-large">${e.days_until_due!==null&&e.days_until_due!==void 0?e.days_until_due:"\u2014"}</div>
        </div>
        <div class="kpi-card">
          <div class="kpi-label">${r("interval",t)}</div>
          <div class="kpi-value">${e.interval_days!=null?`${e.interval_days} ${r("days",t)}`:"\u2014"}</div>
          ${this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days?l`
            <div class="kpi-subtext">${r("recommended",t)}: ${e.suggested_interval}${e.interval_analysis?.confidence_interval_low!=null?` (${e.interval_analysis.confidence_interval_low}\u2013${e.interval_analysis.confidence_interval_high})`:""}</div>
          `:c}
        </div>
        <div class="kpi-card">
          <div class="kpi-label">${r("warning",t)}</div>
          <div class="kpi-value">${e.warning_days} ${r("days",t)}</div>
        </div>
        <div class="kpi-card">
          <div class="kpi-label">${r("last_performed",t)}</div>
          <div class="kpi-value">${e.last_performed?Q(e.last_performed,t):"\u2014"}</div>
        </div>
        <div class="kpi-card">
          <div class="kpi-label">${r("avg_cost",t)}</div>
          <div class="kpi-value">${i.toFixed(0)} €</div>
        </div>
        <div class="kpi-card">
          <div class="kpi-label">${r("avg_duration",t)}</div>
      ...
      <div class="recommendation-card">
        ...
        <div class="interval-comparison">
          <div class="interval-bar">
            <div class="interval-label">${r("current",t)||"Aktuell"}: ${i??"\u2014"} ${i!=null?r("days",t):""}</div>
            <div class="interval-visual current" style="width: ${i!=null?Math.min(i/d*100,100):0}%"></div>
          </div>
          <div class="interval-bar">
            <div class="interval-label">${r("recommended",t)}: ${n} ${r("days",t)}
              <span class="confidence-badge ${o}">${r(`confidence_${o}`,t)}</span>
            </div>
    ...
    `}_renderRecentActivities(e){let t=this._lang,i=e.history.slice(0,3);if(i.length===0)return c;let n=o=>{switch(o){case"completed":return"\u2713";case"triggered":return"\u2297";case"skipped":return"\u21B7";case"reset":return"\u21BA";default:return"\xB7"}};return l`
      <div class="recent-activities">
        ...
        <div class="activity-show-all">
          <ha-button appearance="plain" @click=${()=>this._activeTab="history"}>${r("show_all",t)} →</ha-button>
        </div>
      </div>
      ...
      <div class="history-filters-new">
        <div class="filter-chips">
          ${["completed","skipped","reset","triggered"].map(i=>{let n=e.history.filter(o=>o.type===i).length;return n===0?c:l`
            ...
            `})}
          ${this._historyFilter?l`<span class="filter-chip clear" @click=${()=>{this._historyFilter=null}}>${r("show_all",t)}</span>`:c}
        </div>
        <div class="filter-controls">
          <input type="text" class="search-input" placeholder="${r("search_notes",t)}..." .value=${this._historySearch} @input=${i=>this._historySearch=i.target.value} />
        </div>
      </div>
    `}_renderHistoryList(e){let t=this._lang,i=this._historyFilter?e.history.filter(n=>n.type===this._historyFilter):e.history;if(this._historySearch){let n=this._historySearch.toLowerCase();i=i.filter(o=>o.notes?.toLowerCase().includes(n))}return i.length===0?l`<p class="empty">${r("no_history",t)}</p>`:l`
    ...
    `}_renderHistoryEntry(e){let t=this._lang;return l`
      <div class="history-entry">
        ...
        <div class="history-content">
          <div><strong>${r(e.type,t)}</strong></div>
          <div class="history-date">${Pe(e.timestamp,t)}</div>
          ${e.notes?l`<div>${e.notes}</div>`:c}
          <div class="history-details">
            ${e.cost!=null?l`<span>${r("cost",t)}: ${e.cost.toFixed(2)} €</span>`:c}
            ${e.duration!=null?l`<span>${r("duration",t)}: ${e.duration} min</span>`:c}
            ${e.trigger_value!=null?l`<span>${r("trigger_val",t)}: ${e.trigger_value}</span>`:c}
          </div>
        </div>
      </div>
    `}};A.styles=[ct,dt],u([T({attribute:!1})],A.prototype,"hass",2),u([T({type:Boolean,reflect:!0})],A.prototype,"narrow",2),u([T({attribute:!1})],A.prototype,"panel",2),u([h()],A.prototype,"_objects",2),u([h()],A.prototype,"_stats",2),u([h()],A.prototype,"_view",2),u([h()],A.prototype,"_selectedEntryId",2),u([h()],A.prototype,"_selectedTaskId",2),u([h()],A.prototype,"_filterStatus",2),u([h()],A.prototype,"_filterUser",2),u([h()],A.prototype,"_unsub",2),u([h()],A.prototype,"_sparklineTooltip",2),u([h()],A.prototype,"_historyFilter",2),u([h()],A.prototype,"_budget",2),u([h()],A.prototype,"_groups",2),u([h()],A.prototype,"_detailStatsData",2),u([h()],A.prototype,"_miniStatsData",2),u([h()],A.prototype,"_features",2),u([h()],A.prototype,"_actionLoading",2),u([h()],A.prototype,"_moreMenuOpen",2),u([h()],A.prototype,"_toastMessage",2),u([h()],A.prototype,"_activeTab",2),u([h()],A.prototype,"_costDurationToggle",2),u([h()],A.prototype,"_historySearch",2),A=u([rt("maintenance-supporter-panel")],A);export{A as MaintenanceSupporterPanel};
