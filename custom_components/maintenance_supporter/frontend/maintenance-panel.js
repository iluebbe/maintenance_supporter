...
<body>
  ...
  `,p([y({attribute:!1})],mt.prototype,"hass",2),p([y()],mt.prototype,"docId",2),p([_()],mt.prototype,"_url",2),p([_()],mt.prototype,"_failed",2);customElements.get("maintenance-history-photo")||customElements.define("maintenance-history-photo",mt);var Us=["completed","skipped","reset","triggered"];function Mi(n,r){let t=r.lang;return o`
