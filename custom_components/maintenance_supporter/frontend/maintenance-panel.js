...
`).map(c=>c.trim()).filter(Boolean).slice(0,100);e.checklist=o.length?o:null}let t=await this.hass.connection.sendMessagePromise(e),a=this._taskId||t?.task_id,s=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(a&&this._scheduleType==="sensor_based"&&s)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=K(e,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return d;let e=this._lang;return l`
      ...
      <div class="select-row">
        ...
        >
          ${ma.map(t=>l`<option value=${t} ?selected=${t===this._triggerType}>${i(t,e)}</option>`)}
        </select>
      </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${ga.map(a=>l`<option value=${a} ?selected=${a===this._type}>${i(a,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
  ...
  `,u([$({attribute:!1})],k.prototype,"hass",2),u([$({type:Boolean,attribute:"checklists-enabled"})],k.prototype,"checklistsEnabled",2),u([$({type:Boolean,attribute:"schedule-time-enabled"})],k.prototype,"scheduleTimeEnabled",2),u([h()],k.prototype,"_open",2),u([h()],k.prototype,"_loading",2),u([h()],k.prototype,"_error",2),u([h()],k.prototype,"_entryId",2),u([h()],k.prototype,"_taskId",2),u([h()],k.prototype,"_objectChoices",2),u([h()],k.prototype,"_name",2),u([h()],k.prototype,"_type",2),u([h()],k.prototype,"_scheduleType",2),u([h()],k.prototype,"_intervalDays",2),u([h()],k.prototype,"_warningDays",2),u([h()],k.prototype,"_intervalAnchor",2),u([h()],k.prototype,"_notes",2),u([h()],k.prototype,"_documentationUrl",2),u([h()],k.prototype,"_customIcon",2),u([h()],k.prototype,"_enabled",2),u([h()],k.prototype,"_triggerEntityId",2),u([h()],k.prototype,"_triggerEntityIds",2),u([h()],k.prototype,"_triggerEntityLogic",2),u([h()],k.prototype,"_triggerAttribute",2),u([h()],k.prototype,"_triggerType",2),u([h()],k.prototype,"_triggerAbove",2),u([h()],k.prototype,"_triggerBelow",2),u([h()],k.prototype,"_triggerForMinutes",2),u([h()],k.prototype,"_triggerTargetValue",2),u([h()],k.prototype,"_triggerDeltaMode",2),u([h()],k.prototype,"_triggerFromState",2),u([h()],k.prototype,"_triggerToState",2),u([h()],k.prototype,"_triggerTargetChanges",2),u([h()],k.prototype,"_triggerRuntimeHours",2),u([h()],k.prototype,"_suggestedAttributes",2),u([h()],k.prototype,"_availableAttributes",2),u([h()],k.prototype,"_entityDomain",2),u([h()],k.prototype,"_lastPerformed",2),u([h()],k.prototype,"_nfcTagId",2),u([h()],k.prototype,"_availableTags",2),u([h()],k.prototype,"_responsibleUserId",2),u([h()],k.prototype,"_availableUsers",2),u([h()],k.prototype,"_checklistText",2),u([h()],k.prototype,"_scheduleTime",2),u([h()],k.prototype,"_environmentalEntity",2),u([h()],k.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",k);var L=class extends j{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed"}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed")}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=K(e,this.lang,i("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return l``;let e=this.lang||this.hass?.language||"en";return l`
      <ha-dialog open @closed=${this._close}>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,u([$({attribute:!1})],B.prototype,"hass",2),u([h()],B.prototype,"_open",2),u([h()],B.prototype,"_title",2),u([h()],B.prototype,"_message",2),u([h()],B.prototype,"_confirmText",2),u([h()],B.prototype,"_danger",2),u([h()],B.prototype,"_inputLabel",2),u([h()],B.prototype,"_inputType",2),u([h()],B.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",B);var fa=["EUR","USD","GBP","JPY","CHF","CAD","AUD","CNY","INR","BRL"],O=class extends j{constructor(){super(...arguments);this.budget=null;this._settings=null;this._loading=!0;this._importCsv="";this._importLoading=!1;this._includeHistory=!0;this._toast="";this._testingNotification=!1;this._users=[];this._loaded=!1;this._userService=null;this._sendTestNotification=async()=>{this._testingNotification=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/test_notification"}),t=e.message||(e.success?i("test_notification_success",this._lang):i("test_notification_failed",this._lang));this._showToast(t)}catch{this._showToast(i("test_notification_failed",this._lang))}finally{this._testingNotification=!1}}}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded?(this._loaded=!0,this._userService=new ae(this.hass),this._loadSettings(),this._loadUsers()):e.has("hass")&&this.hass&&this._userService&&this._userService.updateHass(this.hass)}async _loadUsers(){if(this._userService)try{this._users=await this._userService.getUsers()}catch{this._users=[]}}async _loadSettings(){this._loading=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});this._settings=e}catch{}this._loading=!1}async _updateSetting(e,t){try{let a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:{[e]:t}});this._settings=a,this._showToast(i("settings_saved",this._lang)),this.dispatchEvent(new CustomEvent("settings-changed"))}catch{this._showToast(i("action_error",this._lang))}}_showToast(e){this._toast=e,setTimeout(()=>{this._toast=""},3e3)}_downloadFile(e,t,a){let s=new Blob([e],{type:a}),o=URL.createObjectURL(s),c=document.createElement("a");c.href=o,c.download=t,c.click(),URL.revokeObjectURL(o)}render(){let e=this._lang;return this._loading||!this._settings?l`<div class="settings-loading">Loading…</div>`:l`
    ...
    `}_renderPanelAccess(e){let t=new Set(this._settings.admin_panel_user_ids||[]),a=this._users.filter(o=>!o.is_admin),s=(o,c)=>{let _=new Set(t);c?_.add(o):_.delete(o),this._updateSetting("admin_panel_user_ids",[..._])};return l`
      ...
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select @change=${a=>this._updateSetting("budget_currency",a.target.value)}>
            ${fa.map(a=>l`<option value=${a} ?selected=${t.currency===a}>${a}</option>`)}
          </select>
        </label>
        <label class="setting-row">
  ...
  `,u([$({attribute:!1})],O.prototype,"hass",2),u([$({attribute:!1})],O.prototype,"features",2),u([$({attribute:!1})],O.prototype,"budget",2),u([h()],O.prototype,"_settings",2),u([h()],O.prototype,"_loading",2),u([h()],O.prototype,"_importCsv",2),u([h()],O.prototype,"_importLoading",2),u([h()],O.prototype,"_includeHistory",2),u([h()],O.prototype,"_toast",2),u([h()],O.prototype,"_testingNotification",2),u([h()],O.prototype,"_users",2);customElements.define("maintenance-settings-view",O);var ba=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"],G=class extends j{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._error="";this._entryId="";this._taskId="";this._values=new Array(12).fill("");this._save=async()=>{let e=this._buildOverrides();if(e!==null){this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:e}),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(t){this._error=K(t,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}};this._clearAll=async()=>{this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:{}}),this._values=new Array(12).fill(""),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(e){this._error=K(e,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}open(e,t,a){if(this._entryId=e,this._taskId=t,this._values=new Array(12).fill(""),a)for(let[s,o]of Object.entries(a)){let c=parseInt(s,10);c>=1&&c<=12&&typeof o=="number"&&(this._values[c-1]=o.toString())}this._error="",this._open=!0}_close(){this._open=!1}_buildOverrides(){let e={};for(let t=0;t<12;t++){let a=this._values[t].trim();if(!a)continue;let s=parseFloat(a);if(Number.isNaN(s))return this._error=`${i("month_"+["jan","feb","mar","apr","may","jun","jul","aug","sep","oct","nov","dec"][t],this._lang)}: ${i("seasonal_override_invalid",this._lang)}`,null;if(s<.1||s>5)return this._error=i("seasonal_override_range",this._lang),null;e[t+1]=s}return e}render(){if(!this._open)return l``;let e=this._lang;return l`
      ...
      <ha-dialog open @closed=${this._close} heading="${t}">
        <div class="content">
          ...
          ${this.objects.length===0?l`<div class="hint">${i("no_objects",e)}</div>`:l`
              <div class="objects">
                ${this.objects.map(a=>l`
                  <div class="object-block">
                    <div class="object-name">${a.object.name}</div>
                    ${a.tasks.length===0?l`<div class="hint small">${i("no_tasks_short",e)}</div>`:a.tasks.map(s=>{let o=`${a.entry_id}:${s.id}`,c=this._selected.has(o);return l`
  ...
  `,u([$({attribute:!1})],V.prototype,"hass",2),u([$({attribute:!1})],V.prototype,"objects",2),u([h()],V.prototype,"_open",2),u([h()],V.prototype,"_loading",2),u([h()],V.prototype,"_error",2),u([h()],V.prototype,"_groupId",2),u([h()],V.prototype,"_name",2),u([h()],V.prototype,"_description",2),u([h()],V.prototype,"_selected",2);customElements.get("maintenance-group-dialog")||customElements.define("maintenance-group-dialog",V);var ya=300,ka=140,Be=27;function ft(r,n){let e=r.trigger_config;if(!e)return d;let t=n.lang,a=r.trigger_entity_info,s=r.trigger_entity_infos,o=a?.friendly_name||e.entity_id||"\u2014",c=e.entity_id||"",_=e.entity_ids||(c?[c]:[]),p=a?.unit_of_measurement||"",m=r.trigger_current_value,g=e.type||"threshold",v=_.length>1;return l`
    <h3>${i("trigger",t)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${v?l`
            ...
            <div class="trigger-entity-id">${_.map((b,y)=>l`${y>0?", ":""}<span class="entity-link" @click=${A=>re(A,b)}>${b}</span>`)}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `:l`
            <div class="trigger-entity-name">${o}</div>
            <div class="trigger-entity-id">${c?l`<span class="entity-link" @click=${b=>re(b,c)}>${c}</span>`:""}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `}
        </div>
      ...
      ${m!=null?l`
            <div class="trigger-value-row">
              ...
              ${p?l`<span class="trigger-unit">${p}</span>`:d}
            </div>
          `:d}

      <div class="trigger-limits">
        ${g==="threshold"?l`
          ${e.trigger_above!=null?l`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("threshold_above",t)}: ${e.trigger_above} ${p}</span>`:d}
          ${e.trigger_below!=null?l`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("threshold_below",t)}: ${e.trigger_below} ${p}</span>`:d}
        ...
        `:d}
        ${g==="counter"?l`
          ${e.trigger_target_value!=null?l`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("target_value",t)}: ${e.trigger_target_value} ${p}</span>`:d}
        `:d}
        ${g==="state_change"?l`
        ...
        ${g==="compound"?l`
          ...
          ${(e.conditions||[]).map((b,y)=>l`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${y+1}. ${i(b.type||"unknown",t)}: ${b.entity_id?l`<span class="entity-link" @click=${A=>re(A,b.entity_id)}>${b.entity_id}</span>`:""}</span>
          `)}
        `:d}
        ${a?.min!=null?l`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${i("min",t)}: ${a.min} ${p}</span>`:d}
        ${a?.max!=null?l`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${i("max",t)}: ${a.max} ${p}</span>`:d}
      </div>

      ${s&&s.length>1?l`
        <div class="trigger-entity-list">
          ${s.map(b=>l`
            <span class="trigger-entity-id">${b.friendly_name} (<span class="entity-link" @click=${y=>re(y,b.entity_id)}>${b.entity_id}</span>)</span>
          `)}
        </div>
      `:d}
  ...
  `}function xa(r,n,e){let t=r.trigger_config;if(!t)return d;let a=t.type||"threshold",s=a==="counter"&&t.trigger_delta_mode,o=e.isCounterEntity(t),c=t.entity_id||"",_=e.detailStatsData.get(c)||[],p=[],m=!1;if(_.length>=2)for(let f of _){let E=f.val;s&&r.trigger_baseline_value!=null&&(E-=r.trigger_baseline_value);let F={ts:f.ts,val:E};!o&&f.min!=null&&f.max!=null&&(F.min=s&&r.trigger_baseline_value!=null?f.min-r.trigger_baseline_value:f.min,F.max=s&&r.trigger_baseline_value!=null?f.max-r.trigger_baseline_value:f.max,m=!0),p.push(F)}else for(let f of r.history)f.trigger_value!=null&&p.push({ts:new Date(f.timestamp).getTime(),val:f.trigger_value});if(r.trigger_current_value!=null){let f=r.trigger_current_value;s&&r.trigger_baseline_value!=null&&(f-=r.trigger_baseline_value),p.push({ts:Date.now(),val:f})}if(p.length<2&&c&&e.hasStatsService&&!e.detailStatsData.has(c))return l`<div class="sparkline-container" aria-live="polite" style="display:flex;align-items:center;justify-content:center;height:140px;color:var(--secondary-text-color);font-size:12px;">
      <ha-icon icon="mdi:chart-line" style="--mdc-icon-size:16px;margin-right:8px;"></ha-icon>
      ${i("loading_chart",e.lang)}
    </div>`;if(p.length<2)return d;p.sort((f,E)=>f.ts-E.ts);let g=ya,v=ka,b=30,y=2,A=8,q=16,M=p.map(f=>f.val),S=Math.min(...M),x=Math.max(...M);if(m)for(let f of p)f.min!=null&&(S=Math.min(S,f.min)),f.max!=null&&(x=Math.max(x,f.max));t.trigger_above!=null&&(x=Math.max(x,t.trigger_above),S=Math.min(S,t.trigger_above)),t.trigger_below!=null&&(S=Math.min(S,t.trigger_below),x=Math.max(x,t.trigger_below));let C=null,U=null;if(a==="counter"&&t.trigger_target_value!=null){if(r.trigger_baseline_value!=null)C=r.trigger_baseline_value;else if(p.length>0){let f=[...r.history].filter(E=>E.type==="completed"||E.type==="reset").sort((E,F)=>new Date(F.timestamp).getTime()-new Date(E.timestamp).getTime())[0];if(f){let E=new Date(f.timestamp).getTime(),F=p[0],R=Math.abs(p[0].ts-E);for(let Y of p){let X=Math.abs(Y.ts-E);X<R&&(F=Y,R=X)}C=F.val}else C=p[0].val}C!=null?(U=C+t.trigger_target_value,x=Math.max(x,U),S=Math.min(S,C)):(x=Math.max(x,t.trigger_target_value),S=Math.min(S,0))}s&&r.trigger_baseline_value!=null&&(S=Math.min(S,0));let J=x-S||1;S-=J*.1,x+=J*.1;let Z=p[0].ts,P=p[p.length-1].ts,w=P-Z||1,I=f=>b+(f-Z)/w*(g-b-y),T=f=>A+(1-(f-S)/(x-S))*(v-A-q),Ae=p.map(f=>`${I(f.ts).toFixed(1)},${T(f.val).toFixed(1)}`).join(" "),Et=`M${I(p[0].ts).toFixed(1)},${v-q} `+p.map(f=>`L${I(f.ts).toFixed(1)},${T(f.val).toFixed(1)}`).join(" ")+` L${I(p[p.length-1].ts).toFixed(1)},${v-q} Z`,je="";if(m){let f=p.filter(E=>E.min!=null&&E.max!=null);if(f.length>=2){let E=f.map(R=>`${I(R.ts).toFixed(1)},${T(R.max).toFixed(1)}`),F=[...f].reverse().map(R=>`${I(R.ts).toFixed(1)},${T(R.min).toFixed(1)}`);je=`M${E[0]} `+E.slice(1).map(R=>`L${R}`).join(" ")+` L${F[0]} `+F.slice(1).map(R=>`L${R}`).join(" ")+" Z"}}let Ve=p[p.length-1],St=I(Ve.ts),At=T(Ve.val),We=f=>Math.abs(f)>=1e4?(f/1e3).toFixed(0)+"k":f>=1e3?(f/1e3).toFixed(1)+"k":f.toFixed(f<10?1:0),jt=We(x),Tt=We(S),Mt=r.history.filter(f=>["completed","skipped","reset"].includes(f.type)).map(f=>({ts:new Date(f.timestamp).getTime(),type:f.type})).filter(f=>f.ts>=Z&&f.ts<=P),Te=p;if(p.length>Be){let f=(p.length-1)/(Be-1);Te=[];for(let E=0;E<Be;E++)Te.push(p[Math.round(E*f)])}return l`
    <div class="sparkline-container">
      <svg class="sparkline-svg" viewBox="0 0 ${g} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_sparkline",e.lang)}">
        <text x="${b-3}" y="${A+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${jt}</text>
        <text x="${b-3}" y="${v-q+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${Tt}</text>
        ...
        <text x="${g-y}" y="${v-1}" text-anchor="end" fill="var(--secondary-text-color)" font-size="7">${new Date(P).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</text>
        ...
        ${r.degradation_rate!=null&&r.degradation_trend!=="stable"&&r.degradation_trend!=="insufficient_data"&&p.length>=2?(()=>{let f=p[p.length-1],E=30,F=f.ts+E*864e5,R=f.val+r.degradation_rate*E,Y=Math.min(F,P+(P-Z)*.3),X=Math.max(S,Math.min(x,R)),Ct=I(f.ts),It=T(f.val),Nt=I(Y),Dt=T(X);return D`<line x1="${Ct.toFixed(1)}" y1="${It.toFixed(1)}" x2="${Nt.toFixed(1)}" y2="${Dt.toFixed(1)}" stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.7" />`})():d}
        ${a==="threshold"&&t.trigger_above!=null?D`<line x1="${b}" y1="${T(t.trigger_above).toFixed(1)}" x2="${g}" y2="${T(t.trigger_above).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${g-2}" y="${T(t.trigger_above)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25B2 ${t.trigger_above}</text>`:d}
        ${a==="threshold"&&t.trigger_below!=null?D`<line x1="${b}" y1="${T(t.trigger_below).toFixed(1)}" x2="${g}" y2="${T(t.trigger_below).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${g-2}" y="${T(t.trigger_below)+11}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25BC ${t.trigger_below}</text>`:d}
        ${a==="counter"&&U!=null?D`<line x1="${b}" y1="${T(U).toFixed(1)}" x2="${g}" y2="${T(U).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${g-2}" y="${T(U)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">${i("target_value",e.lang)}: +${t.trigger_target_value}</text>`:d}
        ${a==="counter"&&C!=null?D`<line x1="${b}" y1="${T(C).toFixed(1)}" x2="${g}" y2="${T(C).toFixed(1)}" stroke="var(--secondary-text-color)" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
                <text x="${b+2}" y="${T(C)+11}" text-anchor="start" fill="var(--secondary-text-color)" font-size="8">${i("baseline",e.lang)}</text>`:d}
        <circle cx="${St.toFixed(1)}" cy="${At.toFixed(1)}" r="3.5" fill="var(--primary-color)" />
        ${Mt.map(f=>{let E=I(f.ts),F=f.type==="completed"?"var(--success-color, #4caf50)":f.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return D`
            <line x1="${E.toFixed(1)}" y1="${A}" x2="${E.toFixed(1)}" y2="${v-q}" stroke="${F}" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
            <circle cx="${E.toFixed(1)}" cy="${A+2}" r="5" fill="${F}" opacity="0.8" />
            <text x="${E.toFixed(1)}" y="${A+6}" text-anchor="middle" fill="white" font-size="7" font-weight="bold">${f.type==="completed"?"\u2713":f.type==="skipped"?"\u23ED":"\u21BA"}</text>
          `})}
        ${Te.map(f=>{let E=I(f.ts),F=T(f.val),R=new Date(f.ts).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),Y=`${f.val.toFixed(1)} ${n}`;return m&&f.min!=null&&f.max!=null&&(Y+=` (${f.min.toFixed(1)}\u2013${f.max.toFixed(1)})`),D`<circle cx="${E.toFixed(1)}" cy="${F.toFixed(1)}" r="8" fill="transparent" tabindex="0"
            @mouseenter=${X=>vt(X,`${R}
${Y}`,e.setTooltip)}
            @focus=${X=>vt(X,`${R}
${Y}`,e.setTooltip)}
...
`).map(f=>l`<div>${f}</div>`)}
  ...
  `}function vt(r,n,e){let t=r.currentTarget,a=t.closest(".sparkline-container");if(!a)return;let s=a.getBoundingClientRect(),o=t.getBoundingClientRect();e({x:o.left-s.left+o.width/2,y:o.top-s.top-8,text:n})}function bt(r,n,e){let t=r.degradation_trend!=null&&r.degradation_trend!=="insufficient_data",a=r.days_until_threshold!=null,s=r.environmental_factor!=null&&r.environmental_factor!==1;if(!t&&!a&&!s)return d;let o=r.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":r.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return l`
      ...
      <div class="prediction-grid">
        ...
        ${a?l`
          <div class="prediction-item">
            ...
            ${r.threshold_prediction_date?l`<span class="prediction-date">${te(r.threshold_prediction_date,n)}</span>`:d}
        ...
        ${s&&e.environmental?l`
          <div class="prediction-item">
            ...
            ${r.environmental_entity?l`<span class="prediction-entity entity-link" @click=${c=>re(c,r.environmental_entity)}>${r.environmental_entity}</span>`:d}
          </div>
        `:d}
      </div>
    </div>
  `}function yt(r,n){let e=r.interval_analysis,t=e?.weibull_beta,a=e?.weibull_eta;if(t==null||a==null||a<=0)return d;let s=r.interval_days??0,o=r.suggested_interval??s;return l`
    ...
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_weibull",a)}">
        ...
        ${e>0?D`
          ...
          <circle cx="${S.toFixed(1)}" cy="${C.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(S+4).toFixed(1)}" y="${(C-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
  ...
  `}function Ea(r,n,e){let t=r.confidence_interval_low,a=r.confidence_interval_high,s=n.suggested_interval??n.interval_days??0,o=n.interval_days??0,c=Math.max(0,t-5),p=a+5-c,m=(t-c)/p*100,g=(a-t)/p*100,v=(s-c)/p*100,b=o>0?(o-c)/p*100:-1;return l`
    <div class="confidence-range">
      ...
      <div class="confidence-bar">
        ...
        ${b>=0?l`<div class="confidence-marker current" style="left:${b.toFixed(1)}%"></div>`:d}
  ...
  `}var kt=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function xt(r,n,e){if(!e.seasonal||!r.seasonal_factor||r.seasonal_factor===1)return d;let t=kt.map(c=>i(c,n)),a=new Date().getMonth(),s=r.seasonal_factors||r.interval_analysis?.seasonal_factors||null,o=s&&s.length===12?s:t.map((c,_)=>{let p=r.seasonal_factor||1,m=Math.sin((_-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,p+m))});return l`
    <div class="seasonal-card-compact">
      <h4>${i("seasonal_awareness",n)}</h4>
      <div class="seasonal-mini-chart">
        ${o.map((c,_)=>{let p=c*40,m=c<.9?"low":c>1.1?"high":"normal";return l`
  ...
  `}function wt(r,n){return Sa(r,n)}function Sa(r,n){let e=r.seasonal_factors??r.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return d;let t=r.interval_analysis?.seasonal_reason,a=new Date().getMonth(),s=300,o=100,c=8,p=o-c-4,m=Math.max(...e,1.5),g=s/12,v=g*.65,b=c+p-1/m*p;return l`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${s} ${o}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_seasonal",n)}">
        ...
        ${e.map((y,A)=>{let q=y/m*p,M=A*g+(g-v)/2,S=c+p-q,x=A===a,C=y<1?"var(--success-color, #4caf50)":y>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return D`
            <rect x="${M.toFixed(1)}" y="${S.toFixed(1)}"
              width="${v.toFixed(1)}" height="${q.toFixed(1)}"
              fill="${C}" opacity="${x?1:.5}" rx="2" />
          `})}
      </svg>
      <div class="seasonal-labels">
        ${kt.map((y,A)=>l`<span class="seasonal-label ${A===a?"active-month":""}">${i(y,n)}</span>`)}
      </div>
    </div>
  `}var Aa=300,ja=200;function $t(r,n,e,t){let a=r.history.filter(c=>c.type==="completed"&&(c.cost!=null||c.duration!=null));if(a.length<2)return d;let s=a.some(c=>(c.cost??0)>0),o=a.some(c=>(c.duration??0)>0);return!s&&!o?d:l`
  ...
  `}function Ta(r,n,e){let t=r.history.filter(w=>w.type==="completed"&&(w.cost!=null||w.duration!=null)).map(w=>({ts:new Date(w.timestamp).getTime(),cost:w.cost??0,duration:w.duration??0})).sort((w,I)=>w.ts-I.ts);if(t.length<2)return d;let a=t.some(w=>w.cost>0),s=t.some(w=>w.duration>0);if(!a&&!s)return d;let o=e!=="duration"&&a,c=e!=="cost"&&s,_=o||!c&&a,p=c||!o&&s,m=Aa,g=ja,v=_?32:8,b=p?32:8,y=8,A=20,q=m-v-b,M=g-y-A,S=Math.max(...t.map(w=>w.cost))||1,x=Math.max(...t.map(w=>w.duration))||1,C=Math.min(20,q/t.length*.6),U=q/t.length,J=w=>v+U*w+U/2,Z=w=>y+M-w/S*M,P=w=>y+M-w/x*M;return l`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${m} ${g}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_history",n)}">
        ${_?t.map((w,I)=>D`
          <rect x="${(J(I)-C/2).toFixed(1)}" y="${Z(w.cost).toFixed(1)}" width="${C.toFixed(1)}" height="${(y+M-Z(w.cost)).toFixed(1)}"
            fill="var(--primary-color)" opacity="0.6" rx="2" />
        `):d}
        ${p?D`
          <polyline points="${t.map((w,I)=>`${J(I).toFixed(1)},${P(w.duration).toFixed(1)}`).join(" ")}"
            fill="none" stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-linejoin="round" />
          ${t.map((w,I)=>D`
            <circle cx="${J(I).toFixed(1)}" cy="${P(w.duration).toFixed(1)}" r="3" fill="var(--accent-color, #ff9800)" />
          `)}
        `:d}
  ...
  `}var Ma=60,Ca=20,zt=30,z=class extends j{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._unsub=null;this._sparklineTooltip=null;this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1};this._adminPanelUserIds=[];this._actionLoading=!1;this._moreMenuOpen=!1;this._toastMessage="";this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab="dashboard";this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=e=>this._onPopState(e);this._deepLinkHandled=!1;this._onDialogEvent=async()=>{try{await this._loadData()}catch{}}}get _lang(){return this.hass?.language||"en"}get _isOperator(){let e=this.hass?.user;return e?e.is_admin?!1:!this._adminPanelUserIds.includes(e.id):!0}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._popstateHandler);let e=localStorage.getItem("maintenance_supporter_sort");e&&["due_date","object","type","task_name","area","assigned_user","group"].includes(e)&&(this._sortMode=e);let t=localStorage.getItem("maintenance_supporter_object_sort");t&&["alphabetical","due_soonest","task_count"].includes(t)&&(this._objectSortMode=t);let a=localStorage.getItem("maintenance_supporter_groupby");a&&["none","area","group","user"].includes(a)&&(this._groupByMode=a)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(e){if(super.updated(e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Se(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new ae(this.hass),this._userService.getUsers())}}async _loadData(){let[e,t,a,s,o]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null)]);if(e&&(this._objects=e.objects),t&&(this._stats=t),a&&(this._budget=a),s&&(this._groups=s.groups||{}),o){let c=o;this._features=c.features,this._adminPanelUserIds=c.admin_panel_user_ids||[]}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search),t=e.get("entry_id");if(!t)return;this._deepLinkHandled=!0;let a=e.get("task_id"),s=e.get("action"),o=window.location.pathname+window.location.hash;history.replaceState(history.state,"",o);let c=this._getObject(t);if(!c){this._showOverview();return}if(a){let _=c.tasks.find(p=>p.id===a);if(!_){this._showObject(t);return}this._showTask(t,a),s==="complete"&&requestAnimationFrame(()=>{this._openCompleteDialog(t,a,_.name,this._features.checklists?_.checklist:void 0,this._features.adaptive&&!!_.adaptive_config?.enabled)})}else this._showObject(t)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let a=await this._statsService.getDetailStats(e,t),s=new Map(this._detailStatsData);s.set(e,a),this._detailStatsData=s}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=[];for(let a of this._objects)for(let s of a.tasks){let o=s.trigger_config?.entity_id;o&&e.push({entityId:o,isCounter:this._isCounterEntity(s.trigger_config)})}if(e.length===0)return;let t=await this._statsService.getBatchMiniStats(e);this._miniStatsData=new Map([...this._miniStatsData,...t])}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _taskRows(){let e=[];for(let g of this._objects)for(let v of g.tasks){if(this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let y=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==y)continue}let b=[];for(let y of Object.values(this._groups))y.task_refs?.some(A=>A.entry_id===g.entry_id&&A.task_id===v.id)&&b.push(y.name);e.push({entry_id:g.entry_id,task_id:v.id,object_name:g.object.name,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_anchor:v.interval_anchor??null,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,area_id:g.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:b})}let t={overdue:0,triggered:1,due_soon:2,ok:3},a=(g,v)=>(t[g.status]??9)-(t[v.status]??9),s=(g,v)=>(g.days_until_due??99999)-(v.days_until_due??99999),o=(g,v)=>a(g,v)||s(g,v),c=g=>g.area_id&&this.hass?.areas?.[g.area_id]?.name||"",_=g=>g.responsible_user_id&&this._userService?.getUserName(g.responsible_user_id)||"",p=g=>g.group_names[0]||"",m={due_date:o,object:(g,v)=>g.object_name.localeCompare(v.object_name)||o(g,v),type:(g,v)=>g.type.localeCompare(v.type)||o(g,v),task_name:(g,v)=>g.task_name.localeCompare(v.task_name),area:(g,v)=>{let b=c(g),y=c(v);return!b&&y?1:b&&!y?-1:b.localeCompare(y)||o(g,v)},assigned_user:(g,v)=>{let b=_(g),y=_(v);return!b&&y?1:b&&!y?-1:b.localeCompare(y)||o(g,v)},group:(g,v)=>{let b=p(g),y=p(v);return!b&&y?1:b&&!y?-1:b.localeCompare(y)||o(g,v)}};return e.sort(m[this._sortMode]),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(s=>s.id===t)}_pushPanelState(e,t,a){let s={msp_view:e,msp_entry:t||null,msp_task:a||null};history.pushState(s,"")}_onPopState(e){let t=e.state;if(t?.msp_view&&(this._view=t.msp_view,this._selectedEntryId=t.msp_entry||null,this._selectedTaskId=t.msp_task||null,this._moreMenuOpen=!1,t.msp_view==="task"&&t.msp_entry&&t.msp_task)){this._historyFilter=null;let a=this._getTask(t.msp_entry,t.msp_task);a?.trigger_config?.entity_id&&this._fetchDetailStats(a.trigger_config.entity_id,this._isCounterEntity(a.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null}_showObject(e){this._pushPanelState("object",e),this._view="object",this._selectedEntryId=e,this._selectedTaskId=null}_showTask(e,t){this._pushPanelState("task",e,t),this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._activeTab="overview",this._historyFilter=null;let a=this._getTask(e,t);if(a?.trigger_config?.entity_id){let s=a.trigger_config.entity_id,o=this._isCounterEntity(a.trigger_config);this._fetchDetailStats(s,o)}}_showToast(e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}async _deleteObject(e){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_object",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:e}),this._showOverview(),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _deleteTask(e,t){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_task",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/delete",entry_id:e,task_id:t}),this._showObject(e),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _skipTask(e,t,a){this._actionLoading=!0;try{let s={type:"maintenance_supporter/task/skip",entry_id:e,task_id:t};a&&(s.reason=a),await this.hass.connection.sendMessagePromise(s),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _resetTask(e,t,a){this._actionLoading=!0;try{let s={type:"maintenance_supporter/task/reset",entry_id:e,task_id:t};a&&(s.date=a),await this.hass.connection.sendMessagePromise(s),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _applySuggestion(e,t,a){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/apply_suggestion",entry_id:e,task_id:t,interval:a}),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}_openSeasonalOverrides(e){let t=this.shadowRoot.querySelector("maintenance-seasonal-overrides-dialog");if(!t||!this._selectedEntryId)return;let a=e.adaptive_config?.seasonal_overrides;t.open(this._selectedEntryId,e.id,a)}async _reanalyzeInterval(e,t){try{let a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:e,task_id:t});a.recommended_interval?this._showToast(`${i("reanalyze_result",this._lang)}: ${a.recommended_interval} ${i("days",this._lang)} (${i(`confidence_${a.confidence}`,this._lang)}, ${a.data_points} ${i("data_points",this._lang)})`):this._showToast(i("reanalyze_insufficient_data",this._lang)),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _promptSkipTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let s=await a.prompt({title:i("skip",this._lang),message:i("skip_reason_prompt",this._lang),confirmText:i("skip",this._lang),inputLabel:i("reason_optional",this._lang),inputType:"text"});s.confirmed&&this._skipTask(e,t,s.value||void 0)}async _promptResetTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let s=await a.prompt({title:i("reset",this._lang),message:i("reset_date_prompt",this._lang),confirmText:i("reset",this._lang),inputLabel:i("reset_date_optional",this._lang),inputType:"date"});s.confirmed&&this._resetTask(e,t,s.value||void 0)}_dismissSuggestion(e,t){e&&t&&this._dismissedSuggestions.add(`${e}_${t}`),this.requestUpdate()}_openCompleteDialog(e,t,a,s,o){let c=this.shadowRoot.querySelector("maintenance-complete-dialog");c&&(c.entryId=e,c.taskId=t,c.taskName=a,c.lang=this._lang,c.checklist=s||[],c.adaptiveEnabled=!!o,c.open())}_openQrForObject(e,t){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForObject(e,t)}_openQrForTask(e,t,a,s){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForTask(e,t,a,s)}render(){return l`
    ...
    `}_renderGroupedTasks(e,t){let a=new Map,s=i("unassigned",t);for(let _ of e){let p=[];this._groupByMode==="area"?p=[(_.area_id?this.hass?.areas?.[_.area_id]?.name:null)||s]:this._groupByMode==="user"?p=[(_.responsible_user_id?this._userService?.getUserName(_.responsible_user_id):null)||s]:this._groupByMode==="group"&&(p=_.group_names.length>0?_.group_names:[s]);for(let m of p)a.has(m)||a.set(m,[]),a.get(m).push(_)}let o=[...a.entries()].sort(([_],[p])=>_===s&&p!==s?1:p===s&&_!==s?-1:_.localeCompare(p)),c=this._groupByMode==="area"?"mdi:map-marker-outline":this._groupByMode==="group"?"mdi:folder-outline":"mdi:account-outline";return l`
      ...
      `)}
    `}_renderAllObjects(){let e=this._lang,t=this._isOperator,a=_=>{let p=1/0;for(let m of _.tasks){let g=m.days_until_due;g!=null&&g<p&&(p=g)}return p},s=[...this._objects];this._objectSortMode==="alphabetical"?s.sort((_,p)=>_.object.name.localeCompare(p.object.name)):this._objectSortMode==="task_count"?s.sort((_,p)=>p.tasks.length-_.tasks.length||_.object.name.localeCompare(p.object.name)):s.sort((_,p)=>a(_)-a(p)||_.object.name.localeCompare(p.object.name));let o=()=>{let _=new Map;for(let p of s){let m=p.object.area_id,g=m?this.hass?.areas?.[m]?.name||i("unassigned",e):i("no_area",e);_.has(g)||_.set(g,[]),_.get(g).push(p)}return new Map([..._.entries()].sort(([p],[m])=>p.localeCompare(m)))},c=_=>{let p=_.tasks.some(m=>m.status==="overdue"||m.status==="triggered");return l`
        <div class="object-card${p?" object-card-overdue":""}" @click=${()=>this._showObject(_.entry_id)}>
          ${p?l`<span class="overdue-dot" title="${i("has_overdue",e)}"></span>`:d}
    ...
    `}_renderOverviewRow(e){let t=this._lang,a=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,s=0,o=ze.ok,c=!1;if(a&&e.days_until_due!==null){let g=(e.interval_days-e.days_until_due)/e.interval_days*100;s=Math.max(0,Math.min(100,g)),c=g>100,e.status==="overdue"?o=ze.overdue:e.status==="due_soon"&&(o=ze.due_soon)}let _=e.area_id?this.hass?.areas?.[e.area_id]?.name:null,p=e.responsible_user_id?this._userService?.getUserName(e.responsible_user_id):null,m=e.group_names.length>0||_||p;return l`
      <div class="task-row${e.enabled?"":" task-disabled"}">
        ...
        <span class="row-actions">
          <mwc-icon-button class="btn-complete" title="${i("complete",t)}" @click=${g=>{g.stopPropagation(),this._openCompleteDialogForRow(e)}}>
            <ha-icon icon="mdi:check"></ha-icon>
          </mwc-icon-button>
          <mwc-icon-button class="btn-skip" title="${i("skip",t)}" .disabled=${this._actionLoading} @click=${g=>{g.stopPropagation(),this._promptSkipTask(e.entry_id,e.task_id)}}>
            <ha-icon icon="mdi:skip-next"></ha-icon>
          </mwc-icon-button>
        </span>
      </div>
    `}_openCompleteDialogForRow(e){let a=this._objects.find(s=>s.entry_id===e.entry_id)?.tasks.find(s=>s.id===e.task_id);this._openCompleteDialog(e.entry_id,e.task_id,e.task_name,this._features.checklists?a?.checklist:void 0,this._features.adaptive&&!!a?.adaptive_config?.enabled)}_renderTriggerProgress(e){let t=e.trigger_config??null;if(!t)return d;let a=t.type||"threshold",s=e.trigger_entity_info?.unit_of_measurement??"",o=0,c="";if(a==="threshold"){let m=e.trigger_current_value??null;if(m==null)return d;let g=t.trigger_above,v=t.trigger_below;if(g!=null){let b=v??0,y=g-b||1;o=Math.min(100,Math.max(0,(m-b)/y*100)),c=`${m.toFixed(1)} / ${g} ${s}`}else if(v!=null){let y=e.trigger_entity_info?.max??(v*2||100),A=y-v||1;o=Math.min(100,Math.max(0,(y-m)/A*100)),c=`${m.toFixed(1)} / ${v} ${s}`}else return d}else if(a==="counter"){let m=t.trigger_target_value||1,v=e.trigger_current_delta??null??e.trigger_current_value??null;if(v==null)return d;o=Math.min(100,Math.max(0,v/m*100)),c=`${v.toFixed(1)} / ${m} ${s}`}else if(a==="state_change"){let m=t.trigger_target_changes||1,g=e.trigger_current_value??null;if(g==null)return d;o=Math.min(100,Math.max(0,g/m*100)),c=`${Math.round(g)} / ${m}`}else if(a==="runtime"){let m=t.trigger_runtime_hours||100,g=e.trigger_current_value??null;if(g==null)return d;o=Math.min(100,Math.max(0,g/m*100)),c=`${g.toFixed(1)}h / ${m}h`}else if(a==="compound"){let m=t.compound_logic||t.operator||"AND",g=t.conditions?.length||0;c=`${m} (${g})`,o=e.trigger_active?100:0}else return d;let _=o>=100,p=o>90?"var(--error-color, #f44336)":o>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return l`
    ...
    `}_renderMiniSparkline(e){if(!e.trigger_config?.entity_id)return d;let t=e.trigger_config.entity_id,a=this._miniStatsData.get(t)||[],s=[];if(a.length>=2)s=a.map(x=>({ts:x.ts,val:x.val}));else{if(!e.history)return d;for(let x of e.history)x.trigger_value!=null&&s.push({ts:new Date(x.timestamp).getTime(),val:x.trigger_value})}if(e.trigger_current_value!=null&&s.push({ts:Date.now(),val:e.trigger_current_value}),s.length<2)return d;s.sort((x,C)=>x.ts-C.ts);let o=Ma,c=Ca,_=s.map(x=>x.val),p=Math.min(..._),m=Math.max(..._),g=m-p||1;p-=g*.1,m+=g*.1;let v=s[0].ts,y=s[s.length-1].ts-v||1,A=x=>(x-v)/y*o,q=x=>2+(1-(x-p)/(m-p))*(c-4),M=s;if(M.length>zt){let x=Math.ceil(M.length/zt);M=M.filter((C,U)=>U%x===0||U===M.length-1)}let S=M.map(x=>`${A(x.ts).toFixed(1)},${q(x.val).toFixed(1)}`).join(" ");return l`
    ...
    `}_renderDaysProgress(e){let t=this._lang;if(e.days_until_due==null||!e.interval_days||e.interval_days<=0)return d;let s=(e.interval_days-e.days_until_due)/e.interval_days*100,o=Math.max(0,Math.min(100,s)),c=s>100,_="var(--success-color, #4caf50)";return e.status==="overdue"?_="var(--error-color, #f44336)":e.status==="due_soon"&&(_="var(--warning-color, #ff9800)"),l`
      <div class="days-progress">
        <div class="days-progress-labels">
          <span>${e.last_performed?`${i("last_performed",t)}: ${te(e.last_performed,t)}`:""}</span>
          <span>${e.next_due?`${i("next_due",t)}: ${te(e.next_due,t)}`:""}</span>
        </div>
    ...
    `}_renderObjectDetail(){if(!this._selectedEntryId)return d;let e=this._getObject(this._selectedEntryId);if(!e)return l`<p>Object not found.</p>`;let t=e.object,a=this._lang,s=this._isOperator;return l`
      <div class="detail-section">
        ...
        ${t.installation_date?l`<p class="meta">${i("installed",a)}: ${te(t.installation_date,a)}</p>`:d}
        ...
        ${e.tasks.length===0?l`<div class="empty-state-centered">
              ...
              <div class="task-row${o.enabled?"":" task-disabled"}">
                ...
                <span class="due-cell" @click=${()=>this._showTask(e.entry_id,o.id)}>
                  <span class="due-text">${Ee(o.days_until_due,a)}</span>
    ...
    `}_renderTaskHeader(e){let t=this._lang,s=this._getObject(this._selectedEntryId)?.object.name||"",o=this._isOperator,c=e.status==="due_soon"?"warning":e.status||"ok",_=i(e.status||"ok",t);return l`
      ...
      <div class="tab-content overview-tab">
        ...
        <div class="two-column-layout ${o?"":"single-column"}">
          ...
          <div class="right-column">
            ${$t(e,t,this._costDurationToggle,p=>{this._costDurationToggle=p})}
          </div>
        </div>
        ${c?yt(e,t):d}
        ${_?l`
      ...
      <div class="recent-activities">
        ...
        ${a.map(o=>l`
          <div class="activity-item">
            ...
            <span class="activity-date">${Ue(o.timestamp,t)}</span>
    ...
    `}_renderHistoryEntry(e){let t=this._lang;return l`
      <div class="history-entry">
        ...
        <div class="history-content">
          ...
          <div class="history-date">${Ue(e.timestamp,t)}</div>
    ...
    `}};z.styles=[gt,ht],u([$({attribute:!1})],z.prototype,"hass",2),u([$({type:Boolean,reflect:!0})],z.prototype,"narrow",2),u([$({attribute:!1})],z.prototype,"panel",2),u([h()],z.prototype,"_objects",2),u([h()],z.prototype,"_stats",2),u([h()],z.prototype,"_view",2),u([h()],z.prototype,"_selectedEntryId",2),u([h()],z.prototype,"_selectedTaskId",2),u([h()],z.prototype,"_filterStatus",2),u([h()],z.prototype,"_filterUser",2),u([h()],z.prototype,"_unsub",2),u([h()],z.prototype,"_sparklineTooltip",2),u([h()],z.prototype,"_historyFilter",2),u([h()],z.prototype,"_budget",2),u([h()],z.prototype,"_groups",2),u([h()],z.prototype,"_detailStatsData",2),u([h()],z.prototype,"_miniStatsData",2),u([h()],z.prototype,"_features",2),u([h()],z.prototype,"_adminPanelUserIds",2),u([h()],z.prototype,"_actionLoading",2),u([h()],z.prototype,"_moreMenuOpen",2),u([h()],z.prototype,"_toastMessage",2),u([h()],z.prototype,"_overviewTab",2),u([h()],z.prototype,"_activeTab",2),u([h()],z.prototype,"_costDurationToggle",2),u([h()],z.prototype,"_historySearch",2),u([h()],z.prototype,"_sortMode",2),u([h()],z.prototype,"_objectSortMode",2),u([h()],z.prototype,"_groupByMode",2),z=u([ct("maintenance-supporter-panel")],z);export{z as MaintenanceSupporterPanel};
