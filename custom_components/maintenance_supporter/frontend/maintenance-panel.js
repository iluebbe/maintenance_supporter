      ...
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select @change=${s=>this._updateSetting("budget_currency",s.target.value)}>
            ${ja.map(s=>r`<option value=${s} ?selected=${a.currency===s}>${s}</option>`)}
          </select>
        </label>
        <label class="setting-row">
...
<body>
  ...
  `,u([z({attribute:!1})],V.prototype,"hass",2),u([z({attribute:!1})],V.prototype,"objects",2),u([g()],V.prototype,"_open",2),u([g()],V.prototype,"_loading",2),u([g()],V.prototype,"_error",2),u([g()],V.prototype,"_groupId",2),u([g()],V.prototype,"_name",2),u([g()],V.prototype,"_description",2),u([g()],V.prototype,"_selected",2);customElements.get("maintenance-group-dialog")||customElements.define("maintenance-group-dialog",V);var Sa=300,qa=140,Ge=27;function zt(l,n){let e=l.trigger_config;if(!e)return d;let t=n.lang,a=l.trigger_entity_info,s=l.trigger_entity_infos,o=a?.friendly_name||e.entity_id||"\u2014",c=e.entity_id||"",_=e.entity_ids||(c?[c]:[]),p=a?.unit_of_measurement||"",m=l.trigger_current_value,h=e.type||"threshold",v=_.length>1;return r`
    <h3>${i("trigger",t)}</h3>
    <div class="trigger-card">
      ...
      <div class="trigger-limits">
        ${h==="threshold"?r`
          ${e.trigger_above!=null?r`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("threshold_above",t)}: ${e.trigger_above} ${p}</span>`:d}
          ${e.trigger_below!=null?r`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("threshold_below",t)}: ${e.trigger_below} ${p}</span>`:d}
        ...
        `:d}
        ${h==="counter"?r`
          ${e.trigger_target_value!=null?r`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("target_value",t)}: ${e.trigger_target_value} ${p}</span>`:d}
        `:d}
        ${h==="state_change"?r`
        ...
        ${h==="compound"?r`
          ...
          `)}
        `:d}
        ${a?.min!=null?r`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${i("min",t)}: ${a.min} ${p}</span>`:d}
        ${a?.max!=null?r`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${i("max",t)}: ${a.max} ${p}</span>`:d}
      </div>
  ...
  `}function Ta(l,n,e){let t=l.trigger_config;if(!t)return d;let a=t.type||"threshold",s=a==="counter"&&t.trigger_delta_mode,o=e.isCounterEntity(t),c=t.entity_id||"",_=e.detailStatsData.get(c)||[],p=[],m=!1;if(_.length>=2)for(let b of _){let A=b.val;s&&l.trigger_baseline_value!=null&&(A-=l.trigger_baseline_value);let L={ts:b.ts,val:A};!o&&b.min!=null&&b.max!=null&&(L.min=s&&l.trigger_baseline_value!=null?b.min-l.trigger_baseline_value:b.min,L.max=s&&l.trigger_baseline_value!=null?b.max-l.trigger_baseline_value:b.max,m=!0),p.push(L)}else for(let b of l.history)b.trigger_value!=null&&p.push({ts:new Date(b.timestamp).getTime(),val:b.trigger_value});if(l.trigger_current_value!=null){let b=l.trigger_current_value;s&&l.trigger_baseline_value!=null&&(b-=l.trigger_baseline_value),p.push({ts:Date.now(),val:b})}if(p.length<2&&c&&e.hasStatsService&&!e.detailStatsData.has(c))return r`<div class="sparkline-container" aria-live="polite" style="display:flex;align-items:center;justify-content:center;height:140px;color:var(--secondary-text-color);font-size:12px;">
      <ha-icon icon="mdi:chart-line" style="--mdc-icon-size:16px;margin-right:8px;"></ha-icon>
      ${i("loading_chart",e.lang)}
    </div>`;if(p.length<2)return d;p.sort((b,A)=>b.ts-A.ts);let h=Sa,v=qa,f=30,y=2,E=8,D=16,C=p.map(b=>b.val),S=Math.min(...C),x=Math.max(...C);if(m)for(let b of p)b.min!=null&&(S=Math.min(S,b.min)),b.max!=null&&(x=Math.max(x,b.max));t.trigger_above!=null&&(x=Math.max(x,t.trigger_above),S=Math.min(S,t.trigger_above)),t.trigger_below!=null&&(S=Math.min(S,t.trigger_below),x=Math.max(x,t.trigger_below));let M=null,U=null;if(a==="counter"&&t.trigger_target_value!=null){if(l.trigger_baseline_value!=null)M=l.trigger_baseline_value;else if(p.length>0){let b=[...l.history].filter(A=>A.type==="completed"||A.type==="reset").sort((A,L)=>new Date(L.timestamp).getTime()-new Date(A.timestamp).getTime())[0];if(b){let A=new Date(b.timestamp).getTime(),L=p[0],H=Math.abs(p[0].ts-A);for(let X of p){let ee=Math.abs(X.ts-A);ee<H&&(L=X,H=ee)}M=L.val}else M=p[0].val}M!=null?(U=M+t.trigger_target_value,x=Math.max(x,U),S=Math.min(S,M)):(x=Math.max(x,t.trigger_target_value),S=Math.min(S,0))}s&&l.trigger_baseline_value!=null&&(S=Math.min(S,0));let Z=x-S||1;S-=Z*.1,x+=Z*.1;let K=p[0].ts,P=p[p.length-1].ts,w=P-K||1,N=b=>f+(b-K)/w*(h-f-y),T=b=>E+(1-(b-S)/(x-S))*(v-E-D),Ce=p.map(b=>`${N(b.ts).toFixed(1)},${T(b.val).toFixed(1)}`).join(" "),Rt=`M${N(p[0].ts).toFixed(1)},${v-D} `+p.map(b=>`L${N(b.ts).toFixed(1)},${T(b.val).toFixed(1)}`).join(" ")+` L${N(p[p.length-1].ts).toFixed(1)},${v-D} Z`,Me="";if(m){let b=p.filter(A=>A.min!=null&&A.max!=null);if(b.length>=2){let A=b.map(H=>`${N(H.ts).toFixed(1)},${T(H.max).toFixed(1)}`),L=[...b].reverse().map(H=>`${N(H.ts).toFixed(1)},${T(H.min).toFixed(1)}`);Me=`M${A[0]} `+A.slice(1).map(H=>`L${H}`).join(" ")+` L${L[0]} `+L.slice(1).map(H=>`L${H}`).join(" ")+" Z"}}let Ke=p[p.length-1],It=N(Ke.ts),Pt=T(Ke.val),Ze=b=>Math.abs(b)>=1e4?(b/1e3).toFixed(0)+"k":b>=1e3?(b/1e3).toFixed(1)+"k":b.toFixed(b<10?1:0),Dt=Ze(x),Ft=Ze(S),Lt=l.history.filter(b=>["completed","skipped","reset"].includes(b.type)).map(b=>({ts:new Date(b.timestamp).getTime(),type:b.type})).filter(b=>b.ts>=K&&b.ts<=P),Ne=p;if(p.length>Ge){let b=(p.length-1)/(Ge-1);Ne=[];for(let A=0;A<Ge;A++)Ne.push(p[Math.round(A*b)])}return r`
    <div class="sparkline-container">
      <svg class="sparkline-svg" viewBox="0 0 ${h} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_sparkline",e.lang)}">
        <text x="${f-3}" y="${E+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${Dt}</text>
        <text x="${f-3}" y="${v-D+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${Ft}</text>
        ...
        <text x="${h-y}" y="${v-1}" text-anchor="end" fill="var(--secondary-text-color)" font-size="7">${new Date(P).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</text>
        ${Me?I`<path d="${Me}" fill="var(--primary-color)" opacity="0.08" />`:d}
        ...
        ${l.degradation_rate!=null&&l.degradation_trend!=="stable"&&l.degradation_trend!=="insufficient_data"&&p.length>=2?(()=>{let b=p[p.length-1],A=30,L=b.ts+A*864e5,H=b.val+l.degradation_rate*A,X=Math.min(L,P+(P-K)*.3),ee=Math.max(S,Math.min(x,H)),Ht=N(b.ts),Ot=T(b.val),Ut=N(X),Bt=T(ee);return I`<line x1="${Ht.toFixed(1)}" y1="${Ot.toFixed(1)}" x2="${Ut.toFixed(1)}" y2="${Bt.toFixed(1)}" stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.7" />`})():d}
        ${a==="threshold"&&t.trigger_above!=null?I`<line x1="${f}" y1="${T(t.trigger_above).toFixed(1)}" x2="${h}" y2="${T(t.trigger_above).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${T(t.trigger_above)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25B2 ${t.trigger_above}</text>`:d}
        ${a==="threshold"&&t.trigger_below!=null?I`<line x1="${f}" y1="${T(t.trigger_below).toFixed(1)}" x2="${h}" y2="${T(t.trigger_below).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${T(t.trigger_below)+11}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25BC ${t.trigger_below}</text>`:d}
        ${a==="counter"&&U!=null?I`<line x1="${f}" y1="${T(U).toFixed(1)}" x2="${h}" y2="${T(U).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
        ...
        ${a==="counter"&&M!=null?I`<line x1="${f}" y1="${T(M).toFixed(1)}" x2="${h}" y2="${T(M).toFixed(1)}" stroke="var(--secondary-text-color)" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
                <text x="${f+2}" y="${T(M)+11}" text-anchor="start" fill="var(--secondary-text-color)" font-size="8">${i("baseline",e.lang)}</text>`:d}
        <circle cx="${It.toFixed(1)}" cy="${Pt.toFixed(1)}" r="3.5" fill="var(--primary-color)" />
        ${Lt.map(b=>{let A=N(b.ts),L=b.type==="completed"?"var(--success-color, #4caf50)":b.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return I`
            <line x1="${A.toFixed(1)}" y1="${E}" x2="${A.toFixed(1)}" y2="${v-D}" stroke="${L}" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
            <circle cx="${A.toFixed(1)}" cy="${E+2}" r="5" fill="${L}" opacity="0.8" />
            <text x="${A.toFixed(1)}" y="${E+6}" text-anchor="middle" fill="white" font-size="7" font-weight="bold">${b.type==="completed"?"\u2713":b.type==="skipped"?"\u23ED":"\u21BA"}</text>
          `})}
        ${Ne.map(b=>{let A=N(b.ts),L=T(b.val),H=new Date(b.ts).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),X=`${b.val.toFixed(1)} ${n}`;return m&&b.min!=null&&b.max!=null&&(X+=` (${b.min.toFixed(1)}\u2013${b.max.toFixed(1)})`),I`<circle cx="${A.toFixed(1)}" cy="${L.toFixed(1)}" r="8" fill="transparent" tabindex="0"
...
`).map(b=>r`<div>${b}</div>`)}
  ...
  `}function $t(l,n,e){let t=l.currentTarget,a=t.closest(".sparkline-container");if(!a)return;let s=a.getBoundingClientRect(),o=t.getBoundingClientRect();e({x:o.left-s.left+o.width/2,y:o.top-s.top-8,text:n})}function Et(l,n,e){let t=l.degradation_trend!=null&&l.degradation_trend!=="insufficient_data",a=l.days_until_threshold!=null,s=l.environmental_factor!=null&&l.environmental_factor!==1;if(!t&&!a&&!s)return d;let o=l.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":l.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return r`
  ...
  `}function jt(l,n){let e=l.interval_analysis,t=e?.weibull_beta,a=e?.weibull_eta;if(t==null||a==null||a<=0)return d;let s=l.interval_days??0,o=l.suggested_interval??s;return r`
    ...
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_weibull",a)}">
        ...
        ${e>0?I`
          ...
          <circle cx="${S.toFixed(1)}" cy="${M.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(S+4).toFixed(1)}" y="${(M-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
  ...
  `}function Ra(l,n,e){let t=l.confidence_interval_low,a=l.confidence_interval_high,s=n.suggested_interval??n.interval_days??0,o=n.interval_days??0,c=Math.max(0,t-5),p=a+5-c,m=(t-c)/p*100,h=(a-t)/p*100,v=(s-c)/p*100,f=o>0?(o-c)/p*100:-1;return r`
  ...
  `}function Te(l){let n=l.getFullYear(),e=String(l.getMonth()+1).padStart(2,"0"),t=String(l.getDate()).padStart(2,"0");return`${n}-${e}-${t}`}function Ia(l,n){let e=[];for(let t=0;t<n;t++){let a=new Date(l);a.setDate(a.getDate()+t),a.setHours(0,0,0,0),e.push(Te(a))}return e}function qe(l,n){let[e,t,a]=l.split("-").map(Number),s=new Date(e,t-1,a);return s.setDate(s.getDate()+n),Te(s)}function Pa(l){if(!l||l.length===0)return null;let n=l.map(e=>e.cost).filter(e=>typeof e=="number");return n.length===0?null:n.reduce((e,t)=>e+t,0)/n.length}function Da(l){let{windowStart:n,windowEnd:e,task:t,entryId:a,objectName:s}=l,o=[],c=(m,h)=>({date:m,entry_id:a,task_id:t.id,task_name:t.name,object_name:s,status:h&&(t.status==="overdue"||t.status==="triggered")?"ok":t.status,days_until_due:h?null:t.days_until_due??null,projected:h,schedule_type:t.schedule_type,interval_days:t.interval_days??null,responsible_user_id:t.responsible_user_id??null,avg_cost:Pa(t.history),adaptive_enabled:!!t.adaptive_config?.enabled,prediction_confidence:t.threshold_prediction_confidence??null});if(t.status==="overdue"||t.status==="triggered"){if(o.push(c(n,!1)),t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let m=qe(n,t.interval_days),h=1;for(;m<=e&&h<5;)o.push(c(m,!0)),h++,m=qe(m,t.interval_days)}return o}let _=t.next_due;if(typeof _!="string"||!_)return o;let p=_.slice(0,10);if(p>=n&&p<=e)o.push(c(p,!1));else if(p>e)return o;if(t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let m=qe(p,t.interval_days),h=o.length;for(;m<=e&&h<5;)m>=n&&(o.push(c(m,!0)),h++),m=qe(m,t.interval_days)}return o}var At={overdue:0,triggered:1,due_soon:2,ok:3};function St(l,n,e,t=null){let a=Ia(n,e),s=a[0],o=a[a.length-1],c=[];for(let p of l){let m=p.object?.name||"",h=p.entry_id,v=p.tasks||[];for(let f of v){if(t&&f.responsible_user_id!==t||f.enabled===!1)continue;let y=Da({windowStart:s,windowEnd:o,task:f,entryId:h,objectName:m});c.push(...y)}}let _=new Map;for(let p of a)_.set(p,[]);for(let p of c){let m=_.get(p.date);m&&m.push(p)}for(let[,p]of _)p.sort((m,h)=>{let v=At[m.status]??99,f=At[h.status]??99;if(v!==f)return v-f;if(m.projected!==h.projected)return m.projected?1:-1;let y=m.object_name.localeCompare(h.object_name);return y!==0?y:m.task_name.localeCompare(h.task_name)});return a.map(p=>({date:p,events:_.get(p)??[]}))}var qt=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function Tt(l,n,e){if(!e.seasonal||!l.seasonal_factor||l.seasonal_factor===1)return d;let t=qt.map(c=>i(c,n)),a=new Date().getMonth(),s=l.seasonal_factors||l.interval_analysis?.seasonal_factors||null,o=s&&s.length===12?s:t.map((c,_)=>{let p=l.seasonal_factor||1,m=Math.sin((_-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,p+m))});return r`
    <div class="seasonal-card-compact">
      <h4>${i("seasonal_awareness",n)}</h4>
      <div class="seasonal-mini-chart">
        ${o.map((c,_)=>{let p=c*40,m=c<.9?"low":c>1.1?"high":"normal";return r`
  ...
  `}function Ct(l,n){return Fa(l,n)}function Fa(l,n){let e=l.seasonal_factors??l.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return d;let t=l.interval_analysis?.seasonal_reason,a=new Date().getMonth(),s=300,o=100,c=8,p=o-c-4,m=Math.max(...e,1.5),h=s/12,v=h*.65,f=c+p-1/m*p;return r`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${s} ${o}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_seasonal",n)}">
        ...
        ${e.map((y,E)=>{let D=y/m*p,C=E*h+(h-v)/2,S=c+p-D,x=E===a,M=y<1?"var(--success-color, #4caf50)":y>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return I`
            <rect x="${C.toFixed(1)}" y="${S.toFixed(1)}"
              width="${v.toFixed(1)}" height="${D.toFixed(1)}"
              fill="${M}" opacity="${x?1:.5}" rx="2" />
          `})}
      </svg>
      <div class="seasonal-labels">
        ${qt.map((y,E)=>r`<span class="seasonal-label ${E===a?"active-month":""}">${i(y,n)}</span>`)}
      </div>
    </div>
  `}var La=300,Ha=200;function Mt(l,n,e,t){let a=l.history.filter(c=>c.type==="completed"&&(c.cost!=null||c.duration!=null));if(a.length<2)return d;let s=a.some(c=>(c.cost??0)>0),o=a.some(c=>(c.duration??0)>0);return!s&&!o?d:r`
  ...
  `}function Oa(l,n,e){let t=l.history.filter(w=>w.type==="completed"&&(w.cost!=null||w.duration!=null)).map(w=>({ts:new Date(w.timestamp).getTime(),cost:w.cost??0,duration:w.duration??0})).sort((w,N)=>w.ts-N.ts);if(t.length<2)return d;let a=t.some(w=>w.cost>0),s=t.some(w=>w.duration>0);if(!a&&!s)return d;let o=e!=="duration"&&a,c=e!=="cost"&&s,_=o||!c&&a,p=c||!o&&s,m=La,h=Ha,v=_?32:8,f=p?32:8,y=8,E=20,D=m-v-f,C=h-y-E,S=Math.max(...t.map(w=>w.cost))||1,x=Math.max(...t.map(w=>w.duration))||1,M=Math.min(20,D/t.length*.6),U=D/t.length,Z=w=>v+U*w+U/2,K=w=>y+C-w/S*C,P=w=>y+C-w/x*C;return r`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${m} ${h}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_history",n)}">
        ${_?t.map((w,N)=>I`
          <rect x="${(Z(N)-M/2).toFixed(1)}" y="${K(w.cost).toFixed(1)}" width="${M.toFixed(1)}" height="${(y+C-K(w.cost)).toFixed(1)}"
  ...
  `}var Ua=60,Ba=20,Nt=30,$=class extends q{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._unsub=null;this._sparklineTooltip=null;this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._defaultWarningDays=7;this._actionLoading=!1;this._moreMenuOpen=!1;this._toastMessage="";this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab="dashboard";this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._calendarWindowDays=30;this._calendarUserFilter="";this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=e=>this._onPopState(e);this._deepLinkHandled=!1;this._onDialogEvent=async()=>{try{await this._loadData()}catch{}}}get _lang(){return this.hass?.language||"en"}get _isOperator(){let e=this.hass?.user;return e?e.is_admin?!1:!this._adminPanelUserIds.includes(e.id):!0}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._popstateHandler);let e=localStorage.getItem("maintenance_supporter_sort");e&&["due_date","object","type","task_name","area","assigned_user","group"].includes(e)&&(this._sortMode=e);let t=localStorage.getItem("maintenance_supporter_object_sort");t&&["alphabetical","due_soonest","task_count"].includes(t)&&(this._objectSortMode=t);let a=localStorage.getItem("maintenance_supporter_groupby");a&&["none","area","group","user"].includes(a)&&(this._groupByMode=a)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(e){if(super.updated(e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Ae(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new ie(this.hass),this._userService.getUsers())}}async _loadData(){let[e,t,a,s,o]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null)]);if(e&&(this._objects=e.objects),t&&(this._stats=t),a&&(this._budget=a),s&&(this._groups=s.groups||{}),o){let c=o;this._features=c.features,this._adminPanelUserIds=c.admin_panel_user_ids||[];let _=c.general?.default_warning_days;typeof _=="number"&&_>=0&&_<=365&&(this._defaultWarningDays=_)}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search),t=e.get("entry_id");if(!t)return;this._deepLinkHandled=!0;let a=e.get("task_id"),s=e.get("action"),o=window.location.pathname+window.location.hash;history.replaceState(history.state,"",o);let c=this._getObject(t);if(!c){this._showOverview();return}if(a){let _=c.tasks.find(p=>p.id===a);if(!_){this._showObject(t);return}this._showTask(t,a),s==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(t,a,_.name,this._features.checklists?_.checklist:void 0,this._features.adaptive&&!!_.adaptive_config?.enabled)}):s==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(t,a,_)})}else this._showObject(t)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let a=await this._statsService.getDetailStats(e,t),s=new Map(this._detailStatsData);s.set(e,a),this._detailStatsData=s}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=[];for(let a of this._objects)for(let s of a.tasks){let o=s.trigger_config?.entity_id;o&&e.push({entityId:o,isCounter:this._isCounterEntity(s.trigger_config)})}if(e.length===0)return;let t=await this._statsService.getBatchMiniStats(e);this._miniStatsData=new Map([...this._miniStatsData,...t])}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _taskRows(){let e=[];for(let h of this._objects)for(let v of h.tasks){if(this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let y=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==y)continue}let f=[];for(let y of Object.values(this._groups))y.task_refs?.some(E=>E.entry_id===h.entry_id&&E.task_id===v.id)&&f.push(y.name);e.push({entry_id:h.entry_id,task_id:v.id,object_name:h.object.name,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_anchor:v.interval_anchor??null,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,area_id:h.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:f})}let t={overdue:0,triggered:1,due_soon:2,ok:3},a=(h,v)=>(t[h.status]??9)-(t[v.status]??9),s=(h,v)=>(h.days_until_due??99999)-(v.days_until_due??99999),o=(h,v)=>a(h,v)||s(h,v),c=h=>h.area_id&&this.hass?.areas?.[h.area_id]?.name||"",_=h=>h.responsible_user_id&&this._userService?.getUserName(h.responsible_user_id)||"",p=h=>h.group_names[0]||"",m={due_date:o,object:(h,v)=>h.object_name.localeCompare(v.object_name)||o(h,v),type:(h,v)=>h.type.localeCompare(v.type)||o(h,v),task_name:(h,v)=>h.task_name.localeCompare(v.task_name),area:(h,v)=>{let f=c(h),y=c(v);return!f&&y?1:f&&!y?-1:f.localeCompare(y)||o(h,v)},assigned_user:(h,v)=>{let f=_(h),y=_(v);return!f&&y?1:f&&!y?-1:f.localeCompare(y)||o(h,v)},group:(h,v)=>{let f=p(h),y=p(v);return!f&&y?1:f&&!y?-1:f.localeCompare(y)||o(h,v)}};return e.sort(m[this._sortMode]),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(s=>s.id===t)}_pushPanelState(e,t,a){let s={msp_view:e,msp_entry:t||null,msp_task:a||null};history.pushState(s,"")}_onPopState(e){let t=e.state;if(t?.msp_view&&(this._view=t.msp_view,this._selectedEntryId=t.msp_entry||null,this._selectedTaskId=t.msp_task||null,this._moreMenuOpen=!1,t.msp_view==="task"&&t.msp_entry&&t.msp_task)){this._historyFilter=null;let a=this._getTask(t.msp_entry,t.msp_task);a?.trigger_config?.entity_id&&this._fetchDetailStats(a.trigger_config.entity_id,this._isCounterEntity(a.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null}_showObject(e){this._pushPanelState("object",e),this._view="object",this._selectedEntryId=e,this._selectedTaskId=null}_showTask(e,t){this._pushPanelState("task",e,t),this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._activeTab="overview",this._historyFilter=null;let a=this._getTask(e,t);if(a?.trigger_config?.entity_id){let s=a.trigger_config.entity_id,o=this._isCounterEntity(a.trigger_config);this._fetchDetailStats(s,o)}}_showToast(e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}async _deleteObject(e){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_object",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:e}),this._showOverview(),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _deleteTask(e,t){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_task",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/delete",entry_id:e,task_id:t}),this._showObject(e),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _skipTask(e,t,a){this._actionLoading=!0;try{let s={type:"maintenance_supporter/task/skip",entry_id:e,task_id:t};a&&(s.reason=a),await this.hass.connection.sendMessagePromise(s),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _resetTask(e,t,a){this._actionLoading=!0;try{let s={type:"maintenance_supporter/task/reset",entry_id:e,task_id:t};a&&(s.date=a),await this.hass.connection.sendMessagePromise(s),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _applySuggestion(e,t,a){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/apply_suggestion",entry_id:e,task_id:t,interval:a}),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}_openSeasonalOverrides(e){let t=this.shadowRoot.querySelector("maintenance-seasonal-overrides-dialog");if(!t||!this._selectedEntryId)return;let a=e.adaptive_config?.seasonal_overrides;t.open(this._selectedEntryId,e.id,a)}async _reanalyzeInterval(e,t){try{let a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:e,task_id:t});a.recommended_interval?this._showToast(`${i("reanalyze_result",this._lang)}: ${a.recommended_interval} ${i("days",this._lang)} (${i(`confidence_${a.confidence}`,this._lang)}, ${a.data_points} ${i("data_points",this._lang)})`):this._showToast(i("reanalyze_insufficient_data",this._lang)),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _promptSkipTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let s=await a.prompt({title:i("skip",this._lang),message:i("skip_reason_prompt",this._lang),confirmText:i("skip",this._lang),inputLabel:i("reason_optional",this._lang),inputType:"text"});s.confirmed&&this._skipTask(e,t,s.value||void 0)}async _promptResetTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let s=await a.prompt({title:i("reset",this._lang),message:i("reset_date_prompt",this._lang),confirmText:i("reset",this._lang),inputLabel:i("reset_date_optional",this._lang),inputType:"date"});s.confirmed&&this._resetTask(e,t,s.value||void 0)}_dismissSuggestion(e,t){e&&t&&this._dismissedSuggestions.add(`${e}_${t}`),this.requestUpdate()}async _handleQuickComplete(e,t,a){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/quick_complete",entry_id:e,task_id:t}),this._showToast(i("quick_complete_success",this._lang))}catch(s){(s?.code||"")==="no_defaults"?this._openCompleteDialog(e,t,a.name,this._features.checklists?a.checklist:void 0,this._features.adaptive&&!!a.adaptive_config?.enabled):this._showToast(i("action_error",this._lang))}}_openCompleteDialog(e,t,a,s,o){let c=this.shadowRoot.querySelector("maintenance-complete-dialog");c&&(c.entryId=e,c.taskId=t,c.taskName=a,c.lang=this._lang,c.checklist=s||[],c.adaptiveEnabled=!!o,c.open())}_openQrForObject(e,t){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForObject(e,t)}_openQrForTask(e,t,a,s){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForTask(e,t,a,s)}render(){return r`
    ...
    `}_renderCalendar(){let e=this._lang,t=null;this._calendarUserFilter&&(t=this._calendarUserFilter==="current_user"?this._userService?.getCurrentUserId()??null:this._calendarUserFilter);let a=new Date;a.setHours(0,0,0,0);let s=St(this._objects,a,this._calendarWindowDays,t),o=Te(a),c=p=>{let m=`cal-status-${p.status}`,h=p.projected?"cal-event-projected":"",v=p.status==="overdue"&&p.days_until_due!=null?` (${Math.abs(p.days_until_due)}d ${i("overdue",e).toLowerCase()})`:"",f=p.projected&&p.interval_days?r`<span class="cal-event-recur">${i("cal_every_n_days",e).replace("{n}",String(p.interval_days))}</span>`:d,y=p.schedule_type==="sensor_based",E=y?r`<ha-icon class="cal-event-icon cal-source-sensor"
                title="${i("cal_source_sensor",e)}" icon="mdi:trending-up"></ha-icon>`:r`<ha-icon class="cal-event-icon cal-source-time"
                title="${p.adaptive_enabled?i("cal_source_time_adaptive",e):i("cal_source_time",e)}"
                icon="${p.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,D=y&&p.prediction_confidence&&p.status!=="triggered"&&!p.projected?r`<span class="cal-event-prediction cal-conf-${p.prediction_confidence}">
            ${i("cal_predicted",e)} · ${i(`cal_confidence_${p.prediction_confidence}`,e)}
          </span>`:d;return r`
        <div class="cal-event ${h}"
          @click=${()=>this._showTask(p.entry_id,p.task_id)}>
          ${E}
          <span class="cal-status-pill ${m}">${i(p.status,e)}</span>
          <div class="cal-event-body">
            <div class="cal-event-title">${p.object_name} · ${p.task_name}${v}</div>
            ${D}
            ${f}
          </div>
          ${p.avg_cost!=null&&p.avg_cost>0?r`<span class="cal-event-cost">${p.avg_cost.toFixed(0)} ${this._budget?.currency_symbol||"\u20AC"}</span>`:d}
        </div>
      `},_=p=>{let[m,h,v]=p.date.split("-").map(Number),f=new Date(m,h-1,v),y=p.date===o,E=f.toLocaleDateString(e,{weekday:"short"}),D=f.toLocaleDateString(e,{month:"long"});return r`
        <div class="cal-day-row">
          ...
          <div class="cal-day-content">
            <div class="cal-day-header">
              <span class="cal-day-month">${D}</span>
              ${y?r`<span class="cal-day-today-badge">${i("today",e)}</span>`:d}
            </div>
            ${p.events.length===0?r`<div class="cal-empty">${i("cal_no_events",e)}</div>`:p.events.map(c)}
          </div>
        </div>
      `};return r`
      <div class="cal-controls">
        <div class="cal-window-chips">
          ${[7,14,30].map(p=>r`
            <button class="cal-window-chip ${this._calendarWindowDays===p?"active":""}"
              @click=${()=>{this._calendarWindowDays=p}}>
              ${i(`cal_window_${p}`,e)}
            </button>
          `)}
        </div>
        <select class="cal-user-filter"
          ...
          @change=${p=>{this._calendarUserFilter=p.target.value}}>
    ...
    `}_renderGroupedTasks(e,t){let a=new Map,s=i("unassigned",t);for(let _ of e){let p=[];this._groupByMode==="area"?p=[(_.area_id?this.hass?.areas?.[_.area_id]?.name:null)||s]:this._groupByMode==="user"?p=[(_.responsible_user_id?this._userService?.getUserName(_.responsible_user_id):null)||s]:this._groupByMode==="group"&&(p=_.group_names.length>0?_.group_names:[s]);for(let m of p)a.has(m)||a.set(m,[]),a.get(m).push(_)}let o=[...a.entries()].sort(([_],[p])=>_===s&&p!==s?1:p===s&&_!==s?-1:_.localeCompare(p)),c=this._groupByMode==="area"?"mdi:map-marker-outline":this._groupByMode==="group"?"mdi:folder-outline":"mdi:account-outline";return r`
      ...
      `)}
    `}_renderAllObjects(){let e=this._lang,t=this._isOperator,a=_=>{let p=1/0;for(let m of _.tasks){let h=m.days_until_due;h!=null&&h<p&&(p=h)}return p},s=[...this._objects];this._objectSortMode==="alphabetical"?s.sort((_,p)=>_.object.name.localeCompare(p.object.name)):this._objectSortMode==="task_count"?s.sort((_,p)=>p.tasks.length-_.tasks.length||_.object.name.localeCompare(p.object.name)):s.sort((_,p)=>a(_)-a(p)||_.object.name.localeCompare(p.object.name));let o=()=>{let _=new Map;for(let p of s){let m=p.object.area_id,h=m?this.hass?.areas?.[m]?.name||i("unassigned",e):i("no_area",e);_.has(h)||_.set(h,[]),_.get(h).push(p)}return new Map([..._.entries()].sort(([p],[m])=>p.localeCompare(m)))},c=_=>{let p=_.tasks.some(m=>m.status==="overdue"||m.status==="triggered");return r`
        <div class="object-card${p?" object-card-overdue":""}" @click=${()=>this._showObject(_.entry_id)}>
          ${p?r`<span class="overdue-dot" title="${i("has_overdue",e)}"></span>`:d}
      ...
      ${this._groupByMode==="area"?r`
          ${[...o().entries()].map(([_,p])=>r`
            <details class="group-section" open>
              ...
              <div class="objects-grid">${p.map(c)}</div>
            </details>
          `)}
    ...
    `}_renderOverviewRow(e){let t=this._lang,a=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,s=0,o=Ee.ok,c=!1;if(a&&e.days_until_due!==null){let h=(e.interval_days-e.days_until_due)/e.interval_days*100;s=Math.max(0,Math.min(100,h)),c=h>100,e.status==="overdue"?o=Ee.overdue:e.status==="due_soon"&&(o=Ee.due_soon)}let _=e.area_id?this.hass?.areas?.[e.area_id]?.name:null,p=e.responsible_user_id?this._userService?.getUserName(e.responsible_user_id):null,m=e.group_names.length>0||_||p;return r`
    ...
    `}_openCompleteDialogForRow(e){let a=this._objects.find(s=>s.entry_id===e.entry_id)?.tasks.find(s=>s.id===e.task_id);this._openCompleteDialog(e.entry_id,e.task_id,e.task_name,this._features.checklists?a?.checklist:void 0,this._features.adaptive&&!!a?.adaptive_config?.enabled)}_renderTriggerProgress(e){let t=e.trigger_config??null;if(!t)return d;let a=t.type||"threshold",s=e.trigger_entity_info?.unit_of_measurement??"",o=0,c="";if(a==="threshold"){let m=e.trigger_current_value??null;if(m==null)return d;let h=t.trigger_above,v=t.trigger_below;if(h!=null){let f=v??0,y=h-f||1;o=Math.min(100,Math.max(0,(m-f)/y*100)),c=`${m.toFixed(1)} / ${h} ${s}`}else if(v!=null){let y=e.trigger_entity_info?.max??(v*2||100),E=y-v||1;o=Math.min(100,Math.max(0,(y-m)/E*100)),c=`${m.toFixed(1)} / ${v} ${s}`}else return d}else if(a==="counter"){let m=t.trigger_target_value||1,v=e.trigger_current_delta??null??e.trigger_current_value??null;if(v==null)return d;o=Math.min(100,Math.max(0,v/m*100)),c=`${v.toFixed(1)} / ${m} ${s}`}else if(a==="state_change"){let m=t.trigger_target_changes||1,h=e.trigger_current_value??null;if(h==null)return d;o=Math.min(100,Math.max(0,h/m*100)),c=`${Math.round(h)} / ${m}`}else if(a==="runtime"){let m=t.trigger_runtime_hours||100,h=e.trigger_current_value??null;if(h==null)return d;o=Math.min(100,Math.max(0,h/m*100)),c=`${h.toFixed(1)}h / ${m}h`}else if(a==="compound"){let m=t.compound_logic||t.operator||"AND",h=t.conditions?.length||0;c=`${m} (${h})`,o=e.trigger_active?100:0}else return d;let _=o>=100,p=o>90?"var(--error-color, #f44336)":o>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return r`
      <div class="trigger-progress">
        <div class="trigger-progress-bar">
          <div class="trigger-progress-fill${_?" overflow":""}" style="width:${o}%;background:${p}"></div>
        </div>
        <span class="trigger-progress-label">${c}</span>
      </div>
    `}_renderMiniSparkline(e){if(!e.trigger_config?.entity_id)return d;let t=e.trigger_config.entity_id,a=this._miniStatsData.get(t)||[],s=[];if(a.length>=2)s=a.map(x=>({ts:x.ts,val:x.val}));else{if(!e.history)return d;for(let x of e.history)x.trigger_value!=null&&s.push({ts:new Date(x.timestamp).getTime(),val:x.trigger_value})}if(e.trigger_current_value!=null&&s.push({ts:Date.now(),val:e.trigger_current_value}),s.length<2)return d;s.sort((x,M)=>x.ts-M.ts);let o=Ua,c=Ba,_=s.map(x=>x.val),p=Math.min(..._),m=Math.max(..._),h=m-p||1;p-=h*.1,m+=h*.1;let v=s[0].ts,y=s[s.length-1].ts-v||1,E=x=>(x-v)/y*o,D=x=>2+(1-(x-p)/(m-p))*(c-4),C=s;if(C.length>Nt){let x=Math.ceil(C.length/Nt);C=C.filter((M,U)=>U%x===0||U===C.length-1)}let S=C.map(x=>`${E(x.ts).toFixed(1)},${D(x.val).toFixed(1)}`).join(" ");return r`
      ...
      <div class="tab-content overview-tab">
        ...
        <div class="two-column-layout ${o?"":"single-column"}">
          ...
          <div class="right-column">
            ${Mt(e,t,this._costDurationToggle,p=>{this._costDurationToggle=p})}
          </div>
        </div>
        ${c?jt(e,t):d}
        ${_?r`
    ...
    `}};$.styles=[ft,bt],u([z({attribute:!1})],$.prototype,"hass",2),u([z({type:Boolean,reflect:!0})],$.prototype,"narrow",2),u([z({attribute:!1})],$.prototype,"panel",2),u([g()],$.prototype,"_objects",2),u([g()],$.prototype,"_stats",2),u([g()],$.prototype,"_view",2),u([g()],$.prototype,"_selectedEntryId",2),u([g()],$.prototype,"_selectedTaskId",2),u([g()],$.prototype,"_filterStatus",2),u([g()],$.prototype,"_filterUser",2),u([g()],$.prototype,"_unsub",2),u([g()],$.prototype,"_sparklineTooltip",2),u([g()],$.prototype,"_historyFilter",2),u([g()],$.prototype,"_budget",2),u([g()],$.prototype,"_groups",2),u([g()],$.prototype,"_detailStatsData",2),u([g()],$.prototype,"_miniStatsData",2),u([g()],$.prototype,"_features",2),u([g()],$.prototype,"_adminPanelUserIds",2),u([g()],$.prototype,"_defaultWarningDays",2),u([g()],$.prototype,"_actionLoading",2),u([g()],$.prototype,"_moreMenuOpen",2),u([g()],$.prototype,"_toastMessage",2),u([g()],$.prototype,"_overviewTab",2),u([g()],$.prototype,"_activeTab",2),u([g()],$.prototype,"_costDurationToggle",2),u([g()],$.prototype,"_historySearch",2),u([g()],$.prototype,"_sortMode",2),u([g()],$.prototype,"_objectSortMode",2),u([g()],$.prototype,"_groupByMode",2),u([g()],$.prototype,"_calendarWindowDays",2),u([g()],$.prototype,"_calendarUserFilter",2),$=u([gt("maintenance-supporter-panel")],$);export{$ as MaintenanceSupporterPanel};
