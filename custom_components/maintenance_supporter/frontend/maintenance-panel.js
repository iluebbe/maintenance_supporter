...
`;var U={overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view",objectsCache:"msp-objects-cache"};var Ps=168*3600*1e3;function Ri(){try{let n=localStorage.getItem(U.objectsCache);if(!n)return null;let r=JSON.parse(n);return r.v!==ut||!Number.isFinite(r.at)||Date.now()-r.at>Ps||!Array.isArray(r.objects)||r.objects.length===0?null:{objects:r.objects,stats:r.stats??null}}catch{return null}}function Gt(n,r){if(!(!Array.isArray(n)||n.length===0))try{let e={v:ut,at:Date.now(),objects:n,stats:r};localStorage.setItem(U.objectsCache,JSON.stringify(e))}catch{}}var Os={days:1,weeks:7,months:30.4368,years:365.25};function Qt(n,r){return!n||n<=0?0:n*(Os[r||"days"]??1)}function wt(n,r,e){let t=Qt(n,e);if(t<=0||r==null)return{pct:0,overflow:!1};let i=(t-r)/t*100;return{pct:Math.max(0,Math.min(100,i)),overflow:i>100}}function O(n){return String(n??"").replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r])}function Mi(n,r,e,t,i,a){let l=[[e.manufacturer,n.manufacturer],[e.model,n.model],[e.serial,n.serial_number],[e.installed,n.installation_date?t(n.installation_date):null],[e.warranty,n.warranty_expiry?t(n.warranty_expiry):null]].filter(([,u])=>!!u),c=r.map(u=>{let g=e.scheduleLabel(u);return`<tr>
      <td>${O(u.name)}</td>
      <td>${O(e.typeLabel(u.type))}</td>
      <td>${O(e.statusLabel(u.status))}</td>
      <td>${O(g)}</td>
      <td>${O(u.last_performed?t(u.last_performed):e.none)}</td>
      <td>${O(u.next_due?t(u.next_due):e.none)}</td>
      <td class="num">${u.times_performed??0}</td>
      <td class="num">${(u.total_cost??0).toFixed(2)} ${O(i)}</td>
    </tr>`}).join(""),d=r.reduce((u,g)=>u+(g.total_cost??0),0);return`<!DOCTYPE html><html><head><meta charset="utf-8">
<meta name="color-scheme" content="light">
<title>${O(e.title)} \u2014 ${O(n.name)}</title>
<style>
  ...
  * { box-sizing: border-box; }
  ...
  <h1>${O(n.name)}</h1>
  <p class="sub">${O(e.title)} \xB7 ${O(e.generated)}: ${O(t(a))}</p>
  ${l.length?`<div class="meta">${l.map(([u,g])=>`<div><div class="k">${O(u)}</div>${O(g)}</div>`).join("")}</div>`:""}
  <h2>${O(e.tasksHeading)} (${r.length})</h2>
  <table>
    <thead><tr>
      <th>${O(e.colTask)}</th><th>${O(e.colType)}</th><th>${O(e.colStatus)}</th>
      <th>${O(e.colSchedule)}</th><th>${O(e.colLastDone)}</th><th>${O(e.colNextDue)}</th>
      <th class="num">${O(e.colTimes)}</th><th class="num">${O(e.colCost)}</th>
    </tr></thead>
    <tbody>${c||`<tr><td colspan="8">${O(e.none)}</td></tr>`}</tbody>
    <tfoot><tr><td colspan="7">${O(e.totalCost)}</td><td class="num">${d.toFixed(2)} ${O(i)}</td></tr></tfoot>
  </table>
  ${n.notes?`<div class="notes"><strong>${O(e.notes)}:</strong>
${O(n.notes)}</div>`:""}
</body></html>`}function Jt(n,r=new Date){if(!n)return{kind:"none",days:null,date:null};let e=new Date(`${n}T00:00:00`);if(isNaN(e.getTime()))return{kind:"none",days:null,date:null};let t=Date.UTC(r.getFullYear(),r.getMonth(),r.getDate()),i=Date.UTC(e.getFullYear(),e.getMonth(),e.getDate()),a=Math.round((i-t)/864e5);return a<0?{kind:"expired",days:a,date:n}:a<=60?{kind:"expiring",days:a,date:n}:{kind:"valid",days:a,date:n}}var ze=[{key:"name",labelKey:"name",required:!0},{key:"manufacturer",labelKey:"manufacturer"},{key:"model",labelKey:"model"},{key:"serial_number",labelKey:"serial_number_label"},{key:"installation_date",labelKey:"installed"},{key:"warranty_expiry",labelKey:"warranty"},{key:"area_id",labelKey:"area"},{key:"documentation_url",labelKey:"documentation_url_label"},{key:"notes",labelKey:"object_notes_label"},{key:"task_count",labelKey:"tasks"},{key:"actions",labelKey:"actions"}],zs=ze.map(n=>n.key),$t=["name","manufacturer","model","serial_number","installation_date","warranty_expiry","area_id","task_count","actions"];function it(n){if(!Array.isArray(n))return[...$t];let r=new Set,e=[];for(let t of n)typeof t=="string"&&zs.includes(t)&&!r.has(t)&&(r.add(t),e.push(t));return e.length?(e.includes("name")||e.unshift("name"),e):[...$t]}function kt(n,r,e){let t=new Blob([n],{type:e}),i=URL.createObjectURL(t),a=document.createElement("a");a.href=i,a.download=r,a.target="_blank",a.rel="noopener",a.style.display="none",document.body.appendChild(a),a.dispatchEvent(new MouseEvent("click")),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(i),6e4)}function Et(n,r){let e=document.createElement("a");e.href=n,e.download=r,e.target="_blank",e.rel="noopener",e.style.display="none",document.body.appendChild(e),e.dispatchEvent(new MouseEvent("click")),document.body.removeChild(e)}var q=n=>String(n??"").replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]);function Li(n,r,e,t,i,a,l,c,d,u=[]){let g=[[e.object,q(r)],[e.type,q(e.typeLabel(n.type))],[e.interval,q(i(n))],[e.nextDue,n.next_due?q(t(n.next_due)):"\u2014"],[e.lastDone,n.last_performed?q(t(n.last_performed)):q(e.never)]];n.priority&&n.priority!=="normal"&&g.push([e.priority,q(n.priority)]);let m=(n.checklist||[]).map(f=>`<li><span class="box"></span>${q(f)}</li>`).join(""),v=(f,w)=>f?`<figure class="qr"><img src="${f}" alt="" /><figcaption>${q(w)}</figcaption></figure>`:"";return`<!DOCTYPE html>
<html><head><meta charset="utf-8"><meta name="color-scheme" content="light">
<title>${q(n.name)} \u2014 ${q(e.title)}</title>
<style>
...
<body>
  ...
  <table class="meta">
    ${g.map(([f,w])=>`<tr><td>${q(f)}</td><td>${w}</td></tr>`).join("")}
  </table>
  ${m?`<h2>${q(e.checklist)}</h2><ul class="check">${m}</ul>`:""}
  ${u.length?`<h2>${q(e.parts)}</h2><ul class="check">${u.map(f=>`<li><span class="box"></span>${q(f)}</li>`).join("")}</ul>`:""}
  ${n.notes?`<h2>${q(e.notes)}</h2><div class="notes">${q(n.notes)}</div>`:""}
  ${c?`<h2>${q(e.manualExcerpt)}</h2>
    <div class="excerpt">${q(c.title)} \u2014 ${q(e.pages)} ${c.startPage}\u2013${c.endPage}:
      <a href="${q(c.url)}" target="_blank" rel="noopener">PDF</a>
    </div>
    ...
    <\/script>`:""}`:""}
  <footer>${q(r)} \xB7 ${q(n.name)} \xB7 ${q(e.printedOn)} ${q(d.slice(0,10))}</footer>
</body></html>`}function Se(n){return`${n.entry_id??""}\0${n.part_id}`}function Ii(n,r,e,t){let i=!!n.entry_id&&n.entry_id!==r,a=i?n.entry_id:r,l=e.find(g=>g.entry_id===a),c=(l?.parts||[]).find(g=>g.id===n.part_id)||null,d=i&&l?.object?.name||"",u=c?.name||s("shared_part_unknown",t);return{part:c,foreign:i,ownerName:d,label:d?`${u} (${d})`:u}}function Zt(n,r,e,t){let{part:i,label:a}=Ii(n,r,e,t),l=i&&i.stock!==null&&i.stock!==void 0?` (${i.stock}${i.unit?" "+i.unit:""})`:"",c=i?.storage_location?` \u2014 ${i.storage_location}`:"";return`${n.quantity}\xD7 ${a}${l}${c}`}function Pi(n,r,e,t){let a=(e.find(c=>c.entry_id===r)?.parts||[]).map(c=>({...c})),l=new Set(a.map(c=>Se({part_id:c.id})));for(let c of n?.consumes_parts||[]){if(!c.entry_id||c.entry_id===r)continue;let d=Se(c);if(l.has(d))continue;l.add(d);let{part:u,ownerName:g}=Ii(c,r,e,t);a.push({id:c.part_id,name:u?.name||s("shared_part_unknown",t),unit:u?.unit,stock:u?.stock??null,storage_location:u?.storage_location,entry_id:c.entry_id,owner_name:g})}return a}var Hs={name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",warranty_expiry:"warranty_expiry_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_for_minutes:"trigger_for_minutes"};function Ds(n,r){let e=Hs[n];if(!e)return n;let t=s(e,r);return t&&t!==e?t:n}function qs(n){let e=n.match(/data\['([^']+)'\]/)?.[1],t;return(t=n.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=n.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=n.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=n.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(n)?{field:e,rule:"required"}:(t=n.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(n)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(n)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function j(n,r,e){if(e=e??s("action_error",r),typeof n=="string")return n;if(typeof n!="object"||n===null)return e;let t=n,i=t.message||t.error?.message||"";if(!i)return e;let a=qs(i),l=a.field?Ds(a.field,r):"",c=d=>s(d,r).replace("{field}",l).replace("{n}",a.param??"");switch(a.rule){case"too_long":return c("err_too_long");case"too_short":return c("err_too_short");case"value_too_high":return c("err_value_too_high");case"value_too_low":return c("err_value_too_low");case"required":return c("err_required");case"wrong_type":return c("err_wrong_type").replace("{type}",a.param??"");case"invalid_choice":return c("err_invalid_choice");case"invalid_value":return c("err_invalid_value");default:return i||e}}var Oi=A`
  :host {
    display: block;
    height: 100%;
...
`;var Tt=class{constructor(r){this._cache=new Map;this._pending=new Map;this._hass=r}updateHass(r){this._hass=r}async getDetailStats(r,e,t=30){return this._getStats(r,t<=35?"hour":"day",t,e)}async getMiniStats(r,e){return this._getStats(r,"day",14,e)}async getBatchMiniStats(r){let e=new Map,t=[];for(let d of r){let u=`${d.entityId}:day:14`,g=this._cache.get(u);g&&Date.now()-g.fetchedAt<3e5?e.set(d.entityId,g.points):t.push(d)}if(t.length===0)return e;let i=t.filter(d=>d.isCounter).map(d=>d.entityId),a=t.filter(d=>!d.isCounter).map(d=>d.entityId),l=new Date(Date.now()-336*60*60*1e3).toISOString(),c=[];return i.length>0&&c.push(this._fetchBatch(i,"day",l,["state","sum","change"],!0,e)),a.length>0&&c.push(this._fetchBatch(a,"day",l,["mean","min","max"],!1,e)),await Promise.all(c),e}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(r,e,t,i){let a=`${r}:${e}:${t}`,l=this._cache.get(a);if(l&&Date.now()-l.fetchedAt<3e5)return l.points;if(this._pending.has(a))return this._pending.get(a);let c=this._fetchAndNormalize(r,e,t,i,a);this._pending.set(a,c);try{return await c}finally{this._pending.delete(a)}}async _fetchAndNormalize(r,e,t,i,a){let l=new Date(Date.now()-t*24*60*60*1e3).toISOString(),c=i?["state","sum","change"]:["mean","min","max"];try{let u=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:l,statistic_ids:[r],period:e,types:c}))[r]||[],g=this._normalizeRows(u,i);return this._cache.set(a,{entityId:r,fetchedAt:Date.now(),period:e,points:g}),g}catch(d){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${r}:`,d),[]}}async _fetchBatch(r,e,t,i,a,l){try{let c=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:t,statistic_ids:r,period:e,types:i});for(let d of r){let u=c[d]||[],g=this._normalizeRows(u,a);l.set(d,g),this._cache.set(`${d}:${e}:14`,{entityId:d,fetchedAt:Date.now(),period:e,points:g})}}catch(c){console.warn("[maintenance-supporter] Batch statistics fetch failed:",c)}}_normalizeRows(r,e){let t=[];for(let i of r){let a=null;if(e?a=i.state??null:a=i.mean??null,a===null)continue;let l={ts:i.start,val:a};e||(i.min!=null&&(l.min=i.min),i.max!=null&&(l.max=i.max)),t.push(l)}return t.sort((i,a)=>i.ts-a.ts),t}};var ge=class{constructor(r){this.usersCache=null;this.cacheTimestamp=0;this.CACHE_TTL_MS=6e4;this.hass=r}updateHass(r){this.hass=r}async getUsers(r=!1){let e=Date.now();if(!r&&this.usersCache&&e-this.cacheTimestamp<this.CACHE_TTL_MS)return this.usersCache;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/users/list"});return this.usersCache=t.users,this.cacheTimestamp=e,this.usersCache}catch(t){return console.error("Failed to fetch users:",t),this.usersCache||[]}}async assignUser(r,e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/assign_user",entry_id:r,task_id:e,user_id:t})}async getTasksByUser(r){return(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tasks/by_user",user_id:r})).tasks}getUserName(r){return!r||!this.usersCache?null:this.usersCache.find(t=>t.id===r)?.name||null}getUser(r){return!r||!this.usersCache?null:this.usersCache.find(e=>e.id===r)||null}getCurrentUserId(){return this.hass.user?.id||null}isCurrentUser(r){return r?r===this.getCurrentUserId():!1}clearCache(){this.usersCache=null,this.cacheTimestamp=0}};var ee=class extends S{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return o`
  ...
  `,p([b({attribute:!1})],V.prototype,"hass",2),p([b({attribute:!1})],V.prototype,"objects",2),p([_()],V.prototype,"_open",2),p([_()],V.prototype,"_loading",2),p([_()],V.prototype,"_error",2),p([_()],V.prototype,"_name",2),p([_()],V.prototype,"_manufacturer",2),p([_()],V.prototype,"_model",2),p([_()],V.prototype,"_serialNumber",2),p([_()],V.prototype,"_areaId",2),p([_()],V.prototype,"_installationDate",2),p([_()],V.prototype,"_warrantyExpiry",2),p([_()],V.prototype,"_documentationUrl",2),p([_()],V.prototype,"_notes",2),p([_()],V.prototype,"_haDeviceId",2),p([_()],V.prototype,"_parentEntryId",2),p([_()],V.prototype,"_entryId",2);customElements.get("maintenance-object-dialog")||customElements.define("maintenance-object-dialog",V);function me(n){let r=n??0;return r<1024?`${r} B`:r<1024*1024?`${(r/1024).toFixed(1)} KB`:`${(r/(1024*1024)).toFixed(1)} MB`}var St=["manual","warranty","invoice","spare_parts","photo","other"],Ns={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"},B=class extends S{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._hint="";this._addingLink=!1;this._linkUrl="";this._linkTitle="";this._category="manual";this._thumbs={};this._lightboxUrl="";this._editingId="";this._editTitle="";this._editCategory="manual";this._dragOver=!1;this._loadedFor=null;this._localeReady=!1}_isImage(e){return e.kind==="file"&&(e.mime||"").startsWith("image/")}async _sign(e){return(await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:300})).path}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),this.hass&&!this._localeReady&&(this._localeReady=!0,K(this._lang).then(()=>this.requestUpdate())),this.hass&&this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=e.documents||[],this._loaded=!0,this._error="",this._thumbs={},this._loadThumbs()}catch(e){this._error=j(e,this._lang),this._loaded=!0}}async _loadThumbs(){await Promise.all(this._docs.filter(e=>this._isImage(e)).map(async e=>{try{let t=await this._sign(e);this._thumbs={...this._thumbs,[e.id]:t}}catch{}}))}_category_of(e){return(e.tags||[]).find(i=>St.includes(i))||"other"}_labelKeydown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),e.currentTarget.querySelector("input")?.click())}_onFileInput(e){let t=e.target,i=Array.from(t.files??[]);i.length&&this._uploadFiles(i),t.value=""}_onCameraInput(e){let t=e.target,i=Array.from(t.files??[]);i.length&&this._uploadFiles(i,"photo"),t.value=""}_onDrop(e){if(e.preventDefault(),this._dragOver=!1,!this.canWrite||this._busy)return;let t=Array.from(e.dataTransfer?.files??[]);t.length&&this._uploadFiles(t)}_onDragOver(e){this.canWrite&&(e.preventDefault(),this._dragOver=!0)}_onDragLeave(e){let t=e.relatedTarget;(!t||!e.currentTarget.contains(t))&&(this._dragOver=!1)}async _uploadFiles(e,t){let i=t??this._category;this._busy=!0,this._error="",this._hint="";let a=0,l=0;try{for(let c of e){let d=new FormData;d.append("entry_id",this.entryId),d.append("tags",i),d.append("file",c,c.name);let u=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:d});if(!u.ok){this._error=u.status===413?s("doc_too_large",this._lang):s("doc_upload_failed",this._lang);continue}let g=await u.json();g.duplicate_in_object?l++:g.deduped&&a++}l?this._hint=s("doc_dup_in_object",this._lang):a&&(this._hint=s("doc_deduped",this._lang)),await this._load()}catch{this._error=s("doc_upload_failed",this._lang)}finally{this._busy=!1}}async _download(e){try{let t=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:30});Et(t.path,e.filename||e.title||"document")}catch(t){this._error=j(t,this._lang)}}async _preview(e){if(this._isImage(e)){this._lightboxUrl=this._thumbs[e.id]||await this._sign(e);return}let t=window.open("about:blank","_blank");try{let i=await this._sign(e);t&&(t.location.href=new URL(i,window.location.origin).href)}catch(i){t&&t.close(),this._error=j(i,this._lang)}}_openDoc(e){e.kind==="file"?this._preview(e):ce(e.url)&&window.open(e.url,"_blank","noopener")}_startEdit(e){this._editingId=e.id,this._editTitle=e.title||"",this._editCategory=this._category_of(e),this._addingLink=!1,this._error=""}_cancelEdit(){this._editingId=""}async _saveEdit(e){let t=(e.tags||[]).filter(a=>!St.includes(a)),i=e.kind==="file"?[this._editCategory,...t]:e.tags??[];this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:e.id,title:this._editTitle.trim()||e.filename||e.url||"",tags:i}),this._editingId="",await this._load()}catch(a){this._error=j(a,this._lang)}finally{this._busy=!1}}async _delete(e){let t=e.title||e.filename||e.url||"";if(window.confirm(s("doc_delete_confirm",this._lang).replace("{name}",t))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:e.id}),await this._load()}catch(i){this._error=j(i,this._lang)}finally{this._busy=!1}}}async _addLink(){let e=this._linkUrl.trim();if(e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/add_link",entry_id:this.entryId,url:e,title:this._linkTitle.trim()||null}),this._linkUrl="",this._linkTitle="",this._addingLink=!1,await this._load()}catch(t){this._error=j(t,this._lang,s("doc_link_invalid",this._lang))}finally{this._busy=!1}}}render(){let e=this._lang;return o`
      <div
      ...
      <div class="doc-header">
        ...
        ${this.canWrite?o`
              <div class="doc-actions">
                ...
                >
                  ${St.map(t=>o`<option value=${t}>${s(`doc_cat_${t}`,e)}</option>`)}
                </select>
                <label
    ...
    `}_renderDoc(e,t){if(this._editingId===e.id)return this._renderEdit(e,t);let i=e.kind==="file",a=this._category_of(e),l=i?`${s(`doc_cat_${a}`,t)} \xB7 ${me(e.size)}`:s("doc_link_badge",t),c=this._thumbs[e.id];return o`
      <div class="doc-row">
        ${i&&c?o`<img
              class="doc-thumb"
              src=${c}
    ...
    `}_renderEdit(e,t){let i=e.kind==="file";return o`
      <div class="doc-row editing">
        ...
        ${i?o`<select
            ...
            >
              ${St.map(a=>o`<option value=${a} ?selected=${a===this._editCategory}>${s(`doc_cat_${a}`,t)}</option>`)}
            </select>`:h}
  ...
  `,p([b({attribute:!1})],B.prototype,"hass",2),p([b({attribute:!1})],B.prototype,"entryId",2),p([b({type:Boolean})],B.prototype,"canWrite",2),p([_()],B.prototype,"_docs",2),p([_()],B.prototype,"_loaded",2),p([_()],B.prototype,"_busy",2),p([_()],B.prototype,"_error",2),p([_()],B.prototype,"_hint",2),p([_()],B.prototype,"_addingLink",2),p([_()],B.prototype,"_linkUrl",2),p([_()],B.prototype,"_linkTitle",2),p([_()],B.prototype,"_category",2),p([_()],B.prototype,"_thumbs",2),p([_()],B.prototype,"_lightboxUrl",2),p([_()],B.prototype,"_editingId",2),p([_()],B.prototype,"_editTitle",2),p([_()],B.prototype,"_editCategory",2),p([_()],B.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",B);var Fs=["manual","warranty","invoice","spare_parts","photo","other"],Us={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"},ie=class extends S{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._loadedKey="";this._localeReady=!1}get _lang(){return this.hass?.language||"en"}get _refId(){return this.partId||this.taskId||""}get _linkField(){return this.partId?"part_ids":"task_ids"}updated(e){super.updated(e),this.hass&&!this._localeReady&&(this._localeReady=!0,K(this._lang).then(()=>this.requestUpdate()));let t=`${this.entryId}|${this._refId}`;this.hass&&this.entryId&&this._refId&&this._loadedKey!==t&&(this._loadedKey=t,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=e.documents||[],this._loaded=!0,this._error=""}catch(e){this._error=j(e,this._lang),this._loaded=!0}}_links(e){return e[this._linkField]||[]}_linked(){return this._docs.filter(e=>this._links(e).includes(this._refId))}_available(){return this._docs.filter(e=>!this._links(e).includes(this._refId))}async _setLinks(e,t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:e.id,[this._linkField]:t}),await this._load()}catch(i){this._error=j(i,this._lang)}finally{this._busy=!1}}_link(){let e=this._docs.find(t=>t.id===this._attachId);e&&(this._attachId="",this._setLinks(e,[...this._links(e),this._refId]))}_unlink(e){this._setLinks(e,this._links(e).filter(t=>t!==this._refId))}_isPdf(e){return e.mime==="application/pdf"||(e.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(e){return this._isPdf(e)&&this.taskId?e.task_pages?.[this.taskId]:void 0}async _open(e){if(e.kind==="weblink"){window.open(e.url,"_blank","noopener");return}let t=this._pageFor(e),i=t?`#page=${t}`:"",a=window.open("about:blank","_blank");try{let l=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:300});a&&(a.location.href=new URL(l.path+i,window.location.origin).href)}catch(l){a&&a.close(),this._error=j(l,this._lang)}}async _setPage(e,t){if(this.taskId){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:e.id,task_pages:{[this.taskId]:t}}),await this._load()}catch(i){this._error=j(i,this._lang)}finally{this._busy=!1}}}async _download(e){try{let t=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:30});Et(t.path,e.filename||e.title||"document")}catch(t){this._error=j(t,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return h;let e=this._lang,t=this._linked(),i=this._available();return o`
      <div class="task-docs">
        <h3><ha-icon icon="mdi:paperclip"></ha-icon> ${s("documents",e)} (${t.length})</h3>
        ${this._error?o`<div class="tdoc-error">${this._error}</div>`:h}
        ${t.length===0?o`<div class="tdoc-empty">${s(this.partId?"doc_part_none":"doc_task_none",e)}</div>`:o`<div class="tdoc-list">${t.map(a=>this._renderRow(a,e))}</div>`}
    ...
    `}_renderRow(e,t){let i=e.kind==="file",a=this._isPdf(e),l=this._pageFor(e),c=(e.tags||[]).find(u=>Fs.includes(u))||"other",d=i?me(e.size):s("doc_link_badge",t);return o`
      <div class="tdoc-row">
        <ha-icon class="tdoc-icon" icon=${i?Us[c]:"mdi:link-variant"}></ha-icon>
        <div
          class="tdoc-info"
          role="button"
          tabindex="0"
        ...
        >
          ...
          <div class="tdoc-meta">
            ${d}${l?o` · <span class="tdoc-pagetag">${s("doc_page",t)} ${l}</span>`:h}
          </div>
        </div>
  ...
  `,p([b({attribute:!1})],ie.prototype,"hass",2),p([b({attribute:!1})],ie.prototype,"entryId",2),p([b({attribute:!1})],ie.prototype,"taskId",2),p([b({attribute:!1})],ie.prototype,"partId",2),p([b({type:Boolean})],ie.prototype,"canWrite",2),p([_()],ie.prototype,"_docs",2),p([_()],ie.prototype,"_loaded",2),p([_()],ie.prototype,"_busy",2),p([_()],ie.prototype,"_error",2),p([_()],ie.prototype,"_attachId",2);customElements.get("maintenance-task-documents")||customElements.define("maintenance-task-documents",ie);var Bs={name:"",vendor:"",mpn:"",gtin:"",storage_location:"",product_url:"",unit:"",cost:"",stock:"",reorder_threshold:"",restock_quantity:"",auto_buy_task:!0,notes:""},Z=class extends S{constructor(){super(...arguments);this.parts=[];this.canWrite=!1;this.currencySymbol="\u20AC";this._editing=null;this._busy=!1;this._error="";this._restockFor=null;this._restockQty="";this._restockInvalid=!1;this._docsFor=null}get _lang(){return this.hass?.locale?.language||this.hass?.language||"en"}connectedCallback(){super.connectedCallback(),K(this._lang).then(()=>this.requestUpdate())}_notifyChanged(){this.dispatchEvent(new CustomEvent("parts-changed",{bubbles:!0,composed:!0}))}async _send(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e)}catch(t){return this._error=j(t,this._lang),null}finally{this._busy=!1}}_openAdd(){this._editing={...Bs}}_openEdit(e){this._editing={id:e.id,name:e.name,vendor:e.vendor||"",mpn:e.mpn||"",gtin:e.gtin||"",storage_location:e.storage_location||"",product_url:e.product_url||"",unit:e.unit||"",cost:e.cost!=null?String(e.cost):"",stock:e.stock!=null?String(e.stock):"",reorder_threshold:e.reorder_threshold!=null?String(e.reorder_threshold):"",restock_quantity:e.restock_quantity!=null?String(e.restock_quantity):"",auto_buy_task:!!e.auto_buy_task,notes:e.notes||""}}_formValue(e){let t=i=>i.trim()===""?null:Number(i);return{entry_id:this.entryId,name:e.name.trim(),vendor:e.vendor.trim()||null,mpn:e.mpn.trim()||null,gtin:e.gtin.trim()||null,storage_location:e.storage_location.trim()||null,product_url:e.product_url.trim()||null,unit:e.unit.trim()||null,cost:t(e.cost),stock:t(e.stock),reorder_threshold:t(e.reorder_threshold),restock_quantity:t(e.restock_quantity),auto_buy_task:e.auto_buy_task,notes:e.notes.trim()||null}}async _save(){let e=this._editing;if(!e||!e.name.trim())return;let t=this._formValue(e),i=e.id?"maintenance_supporter/part/update":"maintenance_supporter/part/create";await this._send(e.id?{type:i,part_id:e.id,...t}:{type:i,...t})!==null&&(this._editing=null,this._notifyChanged())}async _delete(e){if(!window.confirm(s("part_delete_confirm",this._lang).replace("{name}",e.name)))return;await this._send({type:"maintenance_supporter/part/delete",entry_id:this.entryId,part_id:e.id})!==null&&this._notifyChanged()}async _restock(e){let t=parseFloat(this._restockQty);if(!Number.isFinite(t)||t===0){this._restockInvalid=!0;return}this._restockInvalid=!1;let i=await this._send({type:"maintenance_supporter/part/restock",entry_id:this.entryId,part_id:e.id,delta:t});this._restockFor=null,i!==null&&(e.stock=i.stock,this.requestUpdate(),this._notifyChanged())}_identLine(e){return[e.vendor,e.mpn?`MPN: ${e.mpn}`:"",e.gtin?`GTIN: ${e.gtin}`:""].filter(Boolean).join(" \xB7 ")}_renderRow(e){let t=this._lang,i=e.stock!==null&&e.stock!==void 0,a=this._identLine(e),l=this._docsFor===e.id;return o`
      <div class="part-row ${e.is_low?"low":""}">
        ...
        <div class="part-main">
          <div class="part-name">
            ${ce(e.shopping_url)?o`<a href=${e.shopping_url} target="_blank" rel="noopener noreferrer">${e.name}</a>`:e.name}
            ${i?o`<span class="stock-badge ${e.is_low?"low":""}"
                  >${e.stock}${e.unit?` ${e.unit}`:""}${e.reorder_threshold!=null?o`<span class="threshold">/${e.reorder_threshold}</span>`:h}</span
                >`:h}
          </div>
          <div class="part-meta">
            ${a?o`<span>${a}</span>`:h}
        ...
        <ha-icon-button
          title=${s("documents",t)}
          class=${l?"docs-open":""}
          @click=${()=>this._docsFor=l?null:e.id}
        ...
        ${this.canWrite?o`
              ${this._restockFor===e.id?o`
                    <input
                      ...
                      @keydown=${c=>{c.key==="Enter"&&this._restock(e),c.key==="Escape"&&(this._restockFor=null)}}
                    />
    ...
    `}_inventoryValue(){let e=0,t=!1;for(let i of this.parts){let a=typeof i.cost=="number"?i.cost:null,l=typeof i.stock=="number"?i.stock:null;a!==null&&l!==null&&(e+=a*l,t=!0)}return t?e:null}render(){let e=this._lang;return!this.parts.length&&!this.canWrite?h:o`
      <div class="section-head">
        <h3>
          ...
          ${this._inventoryValue()!==null?o`<span class="inventory-value" title=${s("parts_inventory_value",e)}
                ...
                ${this._inventoryValue().toFixed(2)}&nbsp;${this.currencySymbol}</span>`:h}
        </h3>
...
`),this._requiredCompletion=[...t.required_completion_fields||[]],this._scheduleTime=t.schedule_time||"";let l=t.on_complete_action;if(l&&l.service){this._actionService=l.service;let u=l.target?.entity_id;this._actionTargetEntity=Array.isArray(u)?u[0]||"":u||"",this._actionData=l.data&&typeof l.data=="object"?{...l.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let c=t.quick_complete_defaults;this._qcNotes=c?.notes||"",this._qcCost=c?.cost!=null?String(c.cost):"",this._qcDuration=c?.duration!=null?String(c.duration):"",this._qcFeedback=c?.feedback||"";let d=t.adaptive_config||{};if(this._environmentalEntity=d.environmental_entity||"",this._environmentalAttribute=d.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,t.trigger_config){let u=t.trigger_config;this._triggerEntityId=u.entity_id||u.entity_ids&&u.entity_ids[0]||"",this._triggerEntityIds=u.entity_ids||(u.entity_id?[u.entity_id]:[]),this._triggerEntityLogic=u.entity_logic||"any",this._triggerAttribute=u.attribute||"",this._triggerType=u.type||"threshold",this._triggerAbove=u.trigger_above?.toString()||"",this._triggerBelow=u.trigger_below?.toString()||"",this._triggerForMinutes=u.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=u.trigger_target_value?.toString()||"",this._triggerDeltaMode=u.trigger_delta_mode||!1,this._triggerBaselineValue=u.trigger_baseline_value?.toString()||"",this._liveBaselineValue=t.trigger_baseline_value??null,this._autoCompleteOnRecovery=u.auto_complete_on_recovery||!1,this._triggerFromState=u.trigger_from_state||"",this._triggerToState=u.trigger_to_state||"",this._triggerTargetChanges=u.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=u.trigger_runtime_hours?.toString()||"",this._triggerOnStates=(u.trigger_on_states||[]).join(", "),u.type==="compound"?(this._compoundLogic=u.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(u.conditions||[]).map(Js)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._readingUnit="",this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._requiredCompletion=[],this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new ge(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}_toggleAssignee(e){this._assigneePool=this._assigneePool.includes(e)?this._assigneePool.filter(t=>t!==e):[...this._assigneePool,e]}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[t,i]=e.split(".");if(!this.hass?.services?.[t]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let a=this._actionTargetEntity.trim();if(a){let l=a.split(".")[0];if(l!==t&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(t)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${t}.* entities; entity "${a}" is in ${l}.* \u2014 pick a service that matches the entity domain (e.g. ${l}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[a]){this._actionTestResult="error",this._actionTestError=`Target entity "${a}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,i]=e.split("."),a=this.hass?.services?.[t]?.[i]?.fields;return!a||Object.keys(a).length===0?null:Object.entries(a).map(([l,c])=>({name:l,required:!!c.required,selector:c.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return h;let t=this._serviceSchema();return o`
      <details class="ca-section">
        ...
        <div class="ca-test-row">
          ...
          ${this._actionTestResult==="ok"?o`<span class="ca-test-ok">${s("on_complete_action_test_success",e)}</span>`:h}
...
`).map(d=>d.trim()).filter(Boolean).slice(0,100);e.checklist=c.length?c:null}if(this.completionActionsEnabled){let c=this._actionService.trim();if(c&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(c)){let m={service:c},v=this._actionTargetEntity.trim();v&&(m.target={entity_id:v});let f=this._buildActionData();Object.keys(f).length>0&&(m.data=f),e.on_complete_action=m}else e.on_complete_action=null;let d={};this._qcNotes.trim()&&(d.notes=this._qcNotes.trim());let u=parseFloat(this._qcCost);!isNaN(u)&&u>=0&&(d.cost=u);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(d.duration=g),this._qcFeedback&&(d.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(d).length?d:null}let i=await this.hass.connection.sendMessagePromise(e),a=this._taskId||i?.task_id,l=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(a&&this._scheduleType==="sensor_based"&&l)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=j(e,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return h;let e=this._lang,t=this._triggerType==="compound";return o`
      ...
      <div class="select-row">
        ...
        >
          ${Ys.map(i=>o`<option value=${i} ?selected=${i===this._triggerType}>${s(i,e)}</option>`)}
        </select>
      </div>
    ...
    `}_patchCondition(e,t){this._compoundConditions=this._compoundConditions.map((i,a)=>a===e?{...i,...t}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Gs()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((t,i)=>i!==e)}_renderCompoundEditor(){let e=this._lang;return o`
      <div class="select-row">
    ...
    `}_renderCondition(e,t){let i=this._lang,a=t+1;return o`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${Hi.map(l=>o`<option value=${l} ?selected=${l===e.type}>${s(l,i)}</option>`)}
          </select>
        </div>
    ...
    `}_renderConditionTypeFields(e,t){let i=this._lang;return e.type==="threshold"?o`
      ...
      `:e.type==="runtime"?o`
        ...
        <ms-textfield label="${s("runtime_on_states",i)}" placeholder="on" .value=${e.onStates}
          @input=${a=>this._patchCondition(t,{onStates:a.target.value})}></ms-textfield>
      `:h}_renderUnitSelect(){let e=this._lang;return o`
      <div class="select-row">
    ...
    `}_buildSchedule(){let e=i=>{let a=parseInt(this._calOffset,10)||0;return a&&(i.offset=Math.max(-15,Math.min(a,15))),i};if(this._scheduleType==="weekdays")return e({kind:"weekdays",weekdays:[...this._weekdays].sort((i,a)=>i-a)});if(this._scheduleType==="nth_weekday")return e({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let t={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(t.business=!0),e(t)}_recurrenceExtras(){let e={};if(this._seasonMonths.length&&(e.season_months=[...this._seasonMonths].sort((t,i)=>t-i)),this._endsMode==="count"){let t=parseInt(this._endsCount,10);t>=1&&(e.ends={count:t})}else this._endsMode==="until"&&this._endsUntil&&(e.ends={until:this._endsUntil});return e}_toggleSeasonMonth(e){this._seasonMonths=this._seasonMonths.includes(e)?this._seasonMonths.filter(t=>t!==e):[...this._seasonMonths,e]}_renderRecurrenceExtras(){let e=this._lang;if(!(this._scheduleType==="time_based"||Xt.includes(this._scheduleType)))return h;let i=ea(e);return o`
      ...
      ${this._endsMode==="until"?o`
        ...
        ></ms-textfield>`:h}
    `}_renderCalendarFields(){let e=this._lang,t=Xs(e);if(this._scheduleType==="weekdays")return o`
      ...
      ></ms-textfield>`}_renderTriggerLiveHint(){if(this._triggerType==="compound")return h;let e=this._triggerEntityId||this._triggerEntityIds[0];if(!e||!this.hass?.states)return h;let t=this.hass.states[e];if(!t)return h;let i=this._lang,a=t.attributes?.unit_of_measurement,l=typeof a=="string"&&a?` ${a}`:"",c=this._triggerAttribute?t.attributes?.[this._triggerAttribute]:t.state,d=typeof c=="number"?c:parseFloat(String(c)),u=c!=="unknown"&&c!=="unavailable"&&c!=null&&!isNaN(d),g=v=>Number.isInteger(v)?String(v):String(Math.round(v*10)/10),m=[];if(this._triggerType==="threshold"){let v=parseFloat(this._triggerAbove),f=parseFloat(this._triggerBelow);if(isNaN(v)&&isNaN(f))return h;u&&m.push(s("trigger_hint_now",i).replace("{value}",g(d)+l)),isNaN(v)||m.push(s("trigger_hint_above",i).replace("{target}",g(v)+l)),isNaN(f)||m.push(s("trigger_hint_below",i).replace("{target}",g(f)+l))}else if(this._triggerType==="counter"){let v=parseFloat(this._triggerTargetValue);if(isNaN(v))return h;this._triggerDeltaMode?this._taskId?m.push(s("trigger_hint_counter_delta_edit",i).replace("{target}",g(v)+l)):u?m.push(s("trigger_hint_counter_delta",i).replace("{value}",g(d)+l).replace("{due}",g(d+v)+l).replace("{target}",g(v)+l)):m.push(s("trigger_hint_counter_delta_edit",i).replace("{target}",g(v)+l)):(u&&m.push(s("trigger_hint_now",i).replace("{value}",g(d)+l)),m.push(s("trigger_hint_counter_abs",i).replace("{target}",g(v)+l)))}else if(this._triggerType==="runtime"){let v=parseFloat(this._triggerRuntimeHours);if(isNaN(v))return h;m.push(s("trigger_hint_runtime",i).replace("{hours}",g(v))),m.push(s("trigger_hint_state_now",i).replace("{value}",String(t.state)))}else if(this._triggerType==="state_change"){let v=parseInt(this._triggerTargetChanges,10)||1,f=this._triggerToState.trim();m.push((f?s("trigger_hint_state_change_to",i).replace("{state}",f):s("trigger_hint_state_change",i)).replace("{count}",String(v))),m.push(s("trigger_hint_state_now",i).replace("{value}",String(t.state)))}return m.length?o`<div class="trigger-live-hint">${m.join(" ")}</div>`:h}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?o`
        <ms-textfield
      ...
      `:this._triggerType==="runtime"?o`
        ...
        <ms-textfield
          ...
          @input=${t=>this._triggerOnStates=t.target.value}
        ></ms-textfield>
        <div class="field-help">${s("runtime_on_states_help",e)}</div>
      `:h}render(){if(!this._open)return o``;let e=this._lang,t=this._taskId?s("edit_task",e):s("new_task",e);return o`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._error?o`<div class="error">${this._error}</div>`:h}
          ...
          <div class="select-row">
            ...
            >
              ${Vs.map(i=>o`<option value=${i} ?selected=${i===this._type}>${s(i,e)}</option>`)}
            </select>
          </div>
          ${this._type==="reading"?o`
              ...
              `:h}
          ${this._partsLoadFailed?o`<div class="field-help parts-load-failed">${s("parts_load_failed",e)}</div>`:h}
    ...
    `}};y._PREVIEW_RELEVANT=new Set(["_open","_scheduleType","_intervalDays","_intervalUnit","_intervalAnchor","_dueDate","_weekdays","_nth","_nthWeekday","_domDay","_domLastDay","_domBusiness","_calOffset","_seasonMonths","_endsMode","_endsCount","_endsUntil","_lastPerformed"]),y.styles=A`
    .dialog-title {
      font-size: 18px;
      font-weight: 500;
      padding-bottom: 12px;
  ...
  `,p([b({attribute:!1})],y.prototype,"hass",2),p([b({type:Boolean,attribute:"checklists-enabled"})],y.prototype,"checklistsEnabled",2),p([b({type:Boolean,attribute:"schedule-time-enabled"})],y.prototype,"scheduleTimeEnabled",2),p([b({type:Boolean,attribute:"completion-actions-enabled"})],y.prototype,"completionActionsEnabled",2),p([b({type:Number,attribute:"default-warning-days"})],y.prototype,"defaultWarningDays",2),p([_()],y.prototype,"parts",2),p([_()],y.prototype,"_foreignOwners",2),p([_()],y.prototype,"_open",2),p([_()],y.prototype,"_loading",2),p([_()],y.prototype,"_error",2),p([_()],y.prototype,"_entryId",2),p([_()],y.prototype,"_taskId",2),p([_()],y.prototype,"_objectChoices",2),p([_()],y.prototype,"_name",2),p([_()],y.prototype,"_type",2),p([_()],y.prototype,"_scheduleType",2),p([_()],y.prototype,"_intervalDays",2),p([_()],y.prototype,"_intervalUnit",2),p([_()],y.prototype,"_dueDate",2),p([_()],y.prototype,"_warningDays",2),p([_()],y.prototype,"_earliestCompletionDays",2),p([_()],y.prototype,"_intervalAnchor",2),p([_()],y.prototype,"_weekdays",2),p([_()],y.prototype,"_nth",2),p([_()],y.prototype,"_nthWeekday",2),p([_()],y.prototype,"_domDay",2),p([_()],y.prototype,"_domLastDay",2),p([_()],y.prototype,"_domBusiness",2),p([_()],y.prototype,"_calOffset",2),p([_()],y.prototype,"_seasonMonths",2),p([_()],y.prototype,"_endsMode",2),p([_()],y.prototype,"_endsCount",2),p([_()],y.prototype,"_endsUntil",2),p([_()],y.prototype,"_schedulePreview",2),p([_()],y.prototype,"_schedulePreviewEnded",2),p([_()],y.prototype,"_notes",2),p([_()],y.prototype,"_documentationUrl",2),p([_()],y.prototype,"_customIcon",2),p([_()],y.prototype,"_priority",2),p([_()],y.prototype,"_labels",2),p([_()],y.prototype,"_enabled",2),p([_()],y.prototype,"_triggerEntityId",2),p([_()],y.prototype,"_triggerEntityIds",2),p([_()],y.prototype,"_triggerEntityLogic",2),p([_()],y.prototype,"_triggerAttribute",2),p([_()],y.prototype,"_triggerType",2),p([_()],y.prototype,"_triggerAbove",2),p([_()],y.prototype,"_triggerBelow",2),p([_()],y.prototype,"_triggerForMinutes",2),p([_()],y.prototype,"_triggerTargetValue",2),p([_()],y.prototype,"_triggerDeltaMode",2),p([_()],y.prototype,"_triggerBaselineValue",2),p([_()],y.prototype,"_liveBaselineValue",2),p([_()],y.prototype,"_autoCompleteOnRecovery",2),p([_()],y.prototype,"_triggerFromState",2),p([_()],y.prototype,"_triggerToState",2),p([_()],y.prototype,"_triggerTargetChanges",2),p([_()],y.prototype,"_triggerRuntimeHours",2),p([_()],y.prototype,"_triggerOnStates",2),p([_()],y.prototype,"_compoundLogic",2),p([_()],y.prototype,"_compoundConditions",2),p([_()],y.prototype,"_suggestedAttributes",2),p([_()],y.prototype,"_availableAttributes",2),p([_()],y.prototype,"_entityDomain",2),p([_()],y.prototype,"_lastPerformed",2),p([_()],y.prototype,"_nfcTagId",2),p([_()],y.prototype,"_readingUnit",2),p([_()],y.prototype,"_consumesParts",2),p([_()],y.prototype,"_partsLoadFailed",2),p([_()],y.prototype,"_availableTags",2),p([_()],y.prototype,"_responsibleUserId",2),p([_()],y.prototype,"_assigneePool",2),p([_()],y.prototype,"_rotationStrategy",2),p([_()],y.prototype,"_availableUsers",2),p([_()],y.prototype,"_checklistText",2),p([_()],y.prototype,"_requiredCompletion",2),p([_()],y.prototype,"_scheduleTime",2),p([_()],y.prototype,"_actionService",2),p([_()],y.prototype,"_actionTargetEntity",2),p([_()],y.prototype,"_actionData",2),p([_()],y.prototype,"_actionDataJsonFallback",2),p([_()],y.prototype,"_actionTesting",2),p([_()],y.prototype,"_actionTestResult",2),p([_()],y.prototype,"_actionTestError",2),p([_()],y.prototype,"_qcNotes",2),p([_()],y.prototype,"_qcCost",2),p([_()],y.prototype,"_qcDuration",2),p([_()],y.prototype,"_qcFeedback",2),p([_()],y.prototype,"_environmentalEntity",2),p([_()],y.prototype,"_environmentalAttribute",2);var ei=y;customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",ei);var I=class extends S{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this.taskType="";this.readingUnit="";this.restockDefault=null;this.parts=[];this.consumesParts=[];this.consumesInfo=[];this.requiredFields=[];this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed";this._photoDocId="";this._photoPreview="";this._photoUploading=!1;this._readingValue="";this._restockQty="";this._usedParts={};this.checklistPrefill={}}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState=Object.fromEntries(this.checklist.map((e,t)=>[String(t),!!this.checklistPrefill[e]]).filter(([,e])=>e)),this._feedback="needed",this._photoDocId="",this._photoPreview="",this._photoUploading=!1,this._readingValue="",this._restockQty=this.restockDefault!==null?String(this.restockDefault):"",this._usedParts=Object.fromEntries(this.consumesParts.map(e=>[Se(e),{...e}])))}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _onPhotoInput(e){let t=e.target,i=t.files?.[0];if(t.value="",!!i){this._photoUploading=!0,this._error="";try{let a=new FormData;a.append("entry_id",this.entryId),a.append("tags","photo"),a.append("file",i,i.name);let l=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:a});if(!l.ok){this._error=l.status===413?s("doc_too_large",this.lang):s("doc_upload_failed",this.lang);return}let c=await l.json();c.id&&(this._photoDocId=c.id,this._photoPreview=URL.createObjectURL(i))}catch{this._error=s("doc_upload_failed",this.lang)}finally{this._photoUploading=!1}}}_removePhoto(){this._photoPreview&&URL.revokeObjectURL(this._photoPreview),this._photoDocId="",this._photoPreview=""}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}if(this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),this._photoDocId&&(e.photo_doc_id=this._photoDocId),this._readingValue!==""){let t=parseFloat(this._readingValue);isNaN(t)||(e.reading_value=t)}if(this.restockDefault!==null&&this._restockQty!==""){let t=parseFloat(this._restockQty);!isNaN(t)&&t>=1&&(e.restock_quantity=t)}this.parts.length>0&&(e.used_parts=Object.values(this._usedParts).filter(t=>Number.isFinite(t.quantity)&&t.quantity>0).map(t=>t.entry_id?{part_id:t.part_id,quantity:t.quantity,entry_id:t.entry_id}:{part_id:t.part_id,quantity:t.quantity})),await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=j(e,this.lang,s("save_error",this.lang))}finally{this._loading=!1}}get _missingRequired(){let e={notes:this._notes.trim()!=="",cost:this._cost.trim()!=="",duration:this._duration.trim()!=="",photo:this._photoDocId!=="",user:!!this.hass?.user};return this.requiredFields.filter(t=>!e[t])}_req(e){return this.requiredFields.includes(e)?o`<span class="req-mark" aria-hidden="true">*</span>`:h}_close(){this._open=!1}render(){if(!this._open)return o``;let e=this.lang||this.hass?.language||"en";return o`
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?o`<div class="used-parts">
                ...
                ${this.parts.map(t=>{let i=Se({part_id:t.id,entry_id:t.entry_id}),a=this._usedParts[i],l=a!==void 0,c=t.entry_id?{part_id:t.id,quantity:1,entry_id:t.entry_id}:{part_id:t.id,quantity:1};return o`<div class="used-part-row">
                    <label class="used-part-check">
                      <input type="checkbox" .checked=${l}
                        @change=${d=>{let u={...this._usedParts};d.target.checked?u[i]=u[i]||c:delete u[i],this._usedParts=u}} />
                      <span
                    ...
                    ${l?o`<input class="used-part-qty" type="number" min="0.01" max="999" step="0.01"
                          .value=${String(a.quantity)}
                          @input=${d=>{let u=parseFloat(d.target.value);this._usedParts={...this._usedParts,[i]:{...c,quantity:Number.isFinite(u)&&u>=.01?u:1}}}} />`:h}
                  </div>`})}
        ...
        <div class="dialog-actions">
          ...
          <ha-button
            ...
            title=${this._missingRequired.length?this._missingRequired.map(t=>s("err_required",e).replace("{field}",s(jt[t]??t,e))).join(" \xB7 "):""}
          >
  ...
  `],p([b({attribute:!1})],I.prototype,"hass",2),p([b()],I.prototype,"entryId",2),p([b()],I.prototype,"taskId",2),p([b()],I.prototype,"taskName",2),p([b()],I.prototype,"lang",2),p([b({type:Array})],I.prototype,"checklist",2),p([b({type:Boolean})],I.prototype,"adaptiveEnabled",2),p([b()],I.prototype,"taskType",2),p([b()],I.prototype,"readingUnit",2),p([b({attribute:!1})],I.prototype,"restockDefault",2),p([b({attribute:!1})],I.prototype,"parts",2),p([b({attribute:!1})],I.prototype,"consumesParts",2),p([b({type:Array})],I.prototype,"consumesInfo",2),p([b({type:Array})],I.prototype,"requiredFields",2),p([_()],I.prototype,"_open",2),p([_()],I.prototype,"_notes",2),p([_()],I.prototype,"_cost",2),p([_()],I.prototype,"_duration",2),p([_()],I.prototype,"_loading",2),p([_()],I.prototype,"_error",2),p([_()],I.prototype,"_checklistState",2),p([_()],I.prototype,"_feedback",2),p([_()],I.prototype,"_photoDocId",2),p([_()],I.prototype,"_photoPreview",2),p([_()],I.prototype,"_photoUploading",2),p([_()],I.prototype,"_readingValue",2),p([_()],I.prototype,"_restockQty",2),p([_()],I.prototype,"_usedParts",2),p([b({attribute:!1})],I.prototype,"checklistPrefill",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",I);function He(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Di(n){return!n.startsWith("data:image/svg+xml,")&&!n.startsWith("data:image/png;base64,")?"":He(n)}function ta(n){return n.replace(/[/\\:*?"<>|#%]+/g,"").replace(/\s+/g,"-").toLowerCase().substring(0,100)}var de=class extends S{constructor(){super(...arguments);this.lang="en";this._open=!1;this._loading=!1;this._error="";this._viewResult=null;this._completeResult=null;this._urlMode="companion";this._entryId="";this._taskId=null;this._objectName="";this._taskName="";this._generateSeq=0}openForObject(e,t){this._entryId=e,this._taskId=null,this._objectName=t,this._taskName="",this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}openForTask(e,t,i,a){this._entryId=e,this._taskId=t,this._objectName=i,this._taskName=a,this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}async _generate(){let e=++this._generateSeq;this._loading=!0,this._error="",this._viewResult=null,this._completeResult=null;try{let t={type:"maintenance_supporter/qr/generate",entry_id:this._entryId,url_mode:this._urlMode};this._taskId&&(t.task_id=this._taskId);let i=[this.hass.connection.sendMessagePromise({...t,action:"view"})];this._taskId&&i.push(this.hass.connection.sendMessagePromise({...t,action:"complete"}));let a=await Promise.all(i);if(e!==this._generateSeq)return;this._viewResult=a[0],a.length>1&&(this._completeResult=a[1])}catch(t){if(e!==this._generateSeq)return;let i=t?.code,a=t?.message;this._error=i==="no_url"||typeof a=="string"&&a.includes("No Home Assistant URL")?s("qr_error_no_url",this.lang):s("qr_error",this.lang)}finally{e===this._generateSeq&&(this._loading=!1)}}_setUrlMode(e){this._urlMode!==e&&(this._urlMode=e,this._generate())}_print(){if(!this._viewResult)return;let e=this._viewResult,t=e.label.task_name?`${e.label.object_name} \u2014 ${e.label.task_name}`:e.label.object_name,i=[e.label.manufacturer,e.label.model].filter(Boolean).join(" "),a=window.open("","_blank","width=600,height=500");if(!a)return;let l=this.lang||"en",c=He(t),d=He(i),u=!!this._completeResult,g=He(s("qr_action_view",l)),m=He(s("qr_action_complete",l));a.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8">
<meta name="color-scheme" content="light">
<title>${c}</title>
<style>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,p([b({attribute:!1})],de.prototype,"hass",2),p([b()],de.prototype,"lang",2),p([_()],de.prototype,"_open",2),p([_()],de.prototype,"_loading",2),p([_()],de.prototype,"_error",2),p([_()],de.prototype,"_viewResult",2),p([_()],de.prototype,"_completeResult",2),p([_()],de.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",de);var ae=class extends S{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._adopting=!1;this._error="";this._sensors=[];this._selected=new Set;this._users=[];this._responsible="";this._localeReady=!1;this._userService=null;this._toggle=e=>{let t=new Set(this._selected);t.has(e)?t.delete(e):t.add(e),this._selected=t};this._toggleAll=()=>{this._selected.size===this._sensors.length?this._selected=new Set:this._selected=new Set(this._sensors.map(e=>e.entity_id))};this._adopt=async()=>{if(!(this._selected.size===0||this._adopting)){this._adopting=!0,this._error="";try{let e=this._sensors.filter(i=>this._selected.has(i.entity_id)).map(i=>({entity_id:i.entity_id,name:i.name,entry_id:i.suggested_entry_id??void 0,object_name:i.suggested_object_name,device_id:i.device_id??void 0,part_id:i.suggested_part_id??void 0,responsible_user_id:this._responsible||void 0})),t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/problem_sensors/adopt",selections:e});this.dispatchEvent(new CustomEvent("problem-sensors-adopted",{bubbles:!0,composed:!0,detail:t})),this._open=!1}catch(e){this._error=j(e,this._lang)}finally{this._adopting=!1}}}}get _lang(){return this.hass?.language||"en"}updated(e){e.has("hass")&&this.hass&&!this._localeReady&&(this._localeReady=!0,K(this._lang).then(()=>this.requestUpdate()))}async open(){this._open=!0,this._loading=!0,this._error="",this._sensors=[],this._selected=new Set,this._responsible="";try{this._userService?this._userService.updateHass(this.hass):this._userService=new ge(this.hass);let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/problem_sensors/discover"}),this._userService.getUsers().catch(()=>[])]);this._sensors=e.sensors||[],this._selected=new Set(this._sensors.map(i=>i.entity_id)),this._users=t}catch(e){this._error=j(e,this._lang)}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return o``;let e=this._lang,t=this._sensors.length>0&&this._selected.size===this._sensors.length;return o`
      <div class="overlay" @click=${this._close}>
        <div class="card" @click=${i=>i.stopPropagation()}>
                    ...
                    ${this._sensors.map(i=>{let a=this._selected.has(i.entity_id),l=i.state==="on",c=[i.device_name,i.area_name].filter(Boolean).join(" \xB7 ");return o`
                        <label class="row">
                          ...
                          <div class="row-main">
                            ...
                            ${c?o`<div class="row-sub">${c}</div>`:h}
                            <div class="row-target">
                              → ${i.suggested_object_name}${i.suggested_entry_id?h:o` <span class="new-tag">${s("adopt_problem_new_object",e)}</span>`}
                            </div>
                            ${i.suggested_part_name?o`<div class="row-part">
                                  <ha-icon icon="mdi:package-variant-closed"></ha-icon>
                                  ${s("adopt_problem_part",e).replace("{name}",i.suggested_part_name)}
                                </div>`:h}
                          </div>
                        </label>
                      `})}
          ...
          ${!this._loading&&this._sensors.length>0&&this._users.length>0?o`
                <label class="responsible">
                  <span>${s("adopt_problem_responsible",e)}</span>
                  <select
                    .value=${this._responsible}
                    @change=${i=>{this._responsible=i.target.value}}
                  >
                    <option value="" ?selected=${!this._responsible}>${s("no_user_assigned",e)}</option>
                    ${this._users.map(i=>o`<option value=${i.id} ?selected=${i.id===this._responsible}>${i.name}</option>`)}
                  </select>
                </label>
              `:h}
  ...
  `,p([b({attribute:!1})],ae.prototype,"hass",2),p([_()],ae.prototype,"_open",2),p([_()],ae.prototype,"_loading",2),p([_()],ae.prototype,"_adopting",2),p([_()],ae.prototype,"_error",2),p([_()],ae.prototype,"_sensors",2),p([_()],ae.prototype,"_selected",2),p([_()],ae.prototype,"_users",2),p([_()],ae.prototype,"_responsible",2);customElements.get("maintenance-adopt-problem-sensors-dialog")||customElements.define("maintenance-adopt-problem-sensors-dialog",ae);var se=class extends S{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._adopting=!1;this._error="";this._setups=[];this._selected=new Set;this._baselines=new Map;this._targets=new Map;this._objects=[];this._localeReady=!1;this._toggle=e=>{let t=new Set(this._selected);t.has(e)?t.delete(e):t.add(e),this._selected=t};this._adopt=async()=>{if(!(this._selected.size===0||this._adopting)){this._adopting=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/integration_setups/adopt",selections:[...this._selected].map(t=>{let i={device_id:t},a=this._targets.get(t);a&&(i.entry_id=a);let l=this._setups.find(c=>c.device_id===t);for(let c of l?.tasks??[]){let d=this._baselines.get(`${t} ${c.task_name}`),u=d?parseFloat(d):NaN;!isNaN(u)&&u>=0&&((i.baselines??={})[c.task_name]=u)}return i})});this.dispatchEvent(new CustomEvent("integration-setups-adopted",{bubbles:!0,composed:!0,detail:e})),this._open=!1}catch(e){this._error=j(e,this._lang)}finally{this._adopting=!1}}}}get _lang(){return this.hass?.language||"en"}updated(e){e.has("hass")&&this.hass&&!this._localeReady&&(this._localeReady=!0,K(this._lang).then(()=>this.requestUpdate()))}async open(){this._open=!0,this._loading=!0,this._error="",this._setups=[],this._selected=new Set;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/integration_setups/discover"});this._setups=e.setups||[],this._selected=new Set(this._setups.map(t=>t.device_id)),this._baselines=new Map,this._targets=new Map;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._objects=(t.objects||[]).map(i=>({entry_id:i.entry_id,name:i.object?.name||i.entry_id})).sort((i,a)=>i.name.localeCompare(a.name))}catch{this._objects=[]}}catch(e){this._error=j(e,this._lang)}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return o``;let e=this._lang;return o`
      <div class="overlay" @click=${this._close}>
        <div class="card" @click=${t=>t.stopPropagation()}>
          <div class="title">${s("setups_title",e)}</div>
          <div class="hint">${s("setups_hint",e)}</div>
          ${this._error?o`<div class="error">${this._error}</div>`:h}

          ${this._loading?o`<div class="loading">…</div>`:this._setups.length===0?o`<div class="empty">${s("setups_none",e)}</div>`:o`
                  <div class="list">
                    ${this._setups.map(t=>{let i=this._selected.has(t.device_id),a=[t.integration_name,t.area_name].filter(Boolean).join(" \xB7 ");return o`
                        <label class="row">
                          <input
                            type="checkbox"
                            .checked=${i}
                          ...
                          <div class="row-main">
                            ...
                            <div class="row-target" @click=${l=>l.preventDefault()}>
                              →
                              ${i&&this._objects.length>0?o`
                                    <select
                                      class="target-select"
                                      @change=${l=>{let c=new Map(this._targets),d=l.target.value;d?c.set(t.device_id,d):c.delete(t.device_id),this._targets=c}}
                                    >
                                      <option value="" ?selected=${!this._targets.get(t.device_id)}>
                                        ${t.suggested_entry_id?t.suggested_object_name:s("setups_target_new",e).replace("{name}",t.suggested_object_name)}
                                      </option>
                                      ${this._objects.filter(l=>l.entry_id!==t.suggested_entry_id).map(l=>o`<option
                                            value=${l.entry_id}
                                            ?selected=${this._targets.get(t.device_id)===l.entry_id}
                                          >
                                            ${l.name}
                                          </option>`)}
                                    </select>
                                  `:o`${t.suggested_object_name}${t.suggested_entry_id?h:o` <span class="new-tag">${s("adopt_problem_new_object",e)}</span>`}`}
                            </div>
                            <div class="row-tasks">
                            ...
                            ${i?t.tasks.filter(l=>l.direction==="usage_delta").map(l=>{let c=`${t.device_id} ${l.task_name}`;return o`
                                      <div class="baseline-field" @click=${d=>d.preventDefault()}>
                                        <span class="baseline-label"
                                          >${l.task_name_localized||l.task_name} —
                                          ${s("setups_baseline_hint",e)}</span
                                        >
                                        <input
                                          type="number"
                                          step="any"
                                          min="0"
                                          .value=${this._baselines.get(c)??""}
                                          @click=${d=>d.preventDefault()}
                                          @input=${d=>{let u=new Map(this._baselines);u.set(c,d.target.value),this._baselines=u}}
                                        />
                                      </div>
                                    `}):h}
                          </div>
  ...
  `,p([b({attribute:!1})],se.prototype,"hass",2),p([_()],se.prototype,"_open",2),p([_()],se.prototype,"_loading",2),p([_()],se.prototype,"_adopting",2),p([_()],se.prototype,"_error",2),p([_()],se.prototype,"_setups",2),p([_()],se.prototype,"_selected",2),p([_()],se.prototype,"_baselines",2),p([_()],se.prototype,"_targets",2),p([_()],se.prototype,"_objects",2);customElements.get("maintenance-suggested-setups-dialog")||customElements.define("maintenance-suggested-setups-dialog",se);var X=class X extends S{constructor(){super(...arguments);this._ov=null;this._loading=!1;this._marking=!1;this._error="";this._history=null;this._rosterSort=X._storedSort();this._typeFilter=null;this._recorded=[];this._historyRequested=!1;this._localeReady=!1;this._markAll=async()=>{await this._mark(void 0)};this._repair=async()=>{if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/setup",language:this._lang}),await this._load()}catch(e){this._error=j(e,this._lang)}finally{this._marking=!1}}};this._loadHistory=async e=>{if(!(!e.target.open||this._historyRequested)){this._historyRequested=!0;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview_history"});this._history=t.series}catch{this._history=null}}}}get _lang(){return this.hass?.language||"en"}connectedCallback(){super.connectedCallback(),this.hass&&this._load()}updated(e){e.has("hass")&&this.hass&&!this._localeReady&&(this._localeReady=!0,K(this._lang).then(()=>this.requestUpdate()),this._ov===null&&!this._loading&&this._load())}async _load(){this._loading=!0,this._error="";try{this._ov=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview"})}catch(e){this._error=j(e,this._lang)}finally{this._loading=!1}}async _mark(e){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/mark_replaced",...e?{entity_ids:e}:{}}),await this._load()}catch(t){this._error=j(t,this._lang)}finally{this._marking=!1}}}async _setExcluded(e,t){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/set_excluded",entity_id:e,excluded:t}),await this._load()}catch(i){this._error=j(i,this._lang)}finally{this._marking=!1}}}_sparkline(e){let t=this._history?.[e.entity_id];if(!t||t.points.length<2)return h;let i=110,a=24,l=2,c=t.points[0][0],d=t.points[t.points.length-1][0],u=Date.now()/1e3,g=e.status!=="low"&&e.predicted_source==="trend"&&e.days_until!=null?u+e.days_until*86400:null,m=Math.max(d,g??d),v=L=>m===c?l:l+(L-c)/(m-c)*(i-2*l),f=L=>l+(1-Math.min(100,Math.max(0,L))/100)*(a-2*l),w=t.points.map(([L,N])=>`${v(L).toFixed(1)},${f(N).toFixed(1)}`).join(" "),x=t.points[t.points.length-1][1],M=f(t.threshold).toFixed(1);return o`<svg
      class="bf-spark"
      viewBox="0 0 ${i} ${a}"
      role="img"
    ...
    >
      ...
      <polyline class="bf-spark-line" points=${w}></polyline>
      ${g!==null?o`<line
            class="bf-spark-proj"
            x1=${v(d).toFixed(1)}
            y1=${f(x).toFixed(1)}
            ...
            y2=${M}
          ></line>`:h}
    </svg>`}static _storedSort(){try{return localStorage.getItem(X._SORT_KEY)==="name"?"name":"urgency"}catch{return"urgency"}}_setSort(e){this._rosterSort=e;try{localStorage.setItem(X._SORT_KEY,e)}catch{}}_sortedRoster(e){let t=this._typeFilter===null?e:e.filter(a=>a.battery_type===this._typeFilter);if(this._rosterSort==="name")return t;let i=a=>a.status==="low"?-1e3+(a.level??101)/101:a.days_until??1/0;return[...t].sort((a,l)=>i(a)-i(l)||a.device_name.localeCompare(l.device_name))}_predictedDate(e){return this._fmtDate(Date.now()+e*864e5)}_fmtDate(e){return new Intl.DateTimeFormat(this._lang,{day:"numeric",month:"numeric",year:"numeric"}).format(new Date(e))}_shoppingLine(e){return Object.entries(e).map(([t,i])=>o`<button
      ...
      <div class="bf-card">
              ...
              <div class="bf-rows">
                ${t.low.map(a=>o`
                    <div class="bf-row">
                      ...
                      ${a.available===!1?o`<span class="bf-offline">${s("battery_fleet_offline",e)}</span>`:h}
                      ...
                      <button
                        class="bf-mark"
                        title=${a.rechargeable?s("battery_fleet_mark_recharged",e):s("battery_fleet_mark_one",e)}
        ...
        ${t.all?.length?o`
              <details class="bf-roster" @toggle=${this._loadHistory}>
                ...
                <div class="bf-rows">
                  ${this._sortedRoster(t.all).map(a=>o`
                      <div class="bf-row">
                        <span class="bf-dev">${a.device_name}</span>
                        <span class="bf-status bf-${a.status}">${s("battery_fleet_status_"+a.status,e)}</span>
                        <span class="bf-type">${a.quantity}× ${a.battery_type}</span>
                        ${a.rechargeable?o`<span class="bf-recharge" title=${s("battery_fleet_rechargeable",e)}
                              ><ha-icon icon="mdi:battery-charging-outline"></ha-icon
                            ></span>`:h}
                        ...
                        ${(()=>{let l=this._history?.[a.entity_id]?.jump;return!l||this._recorded.includes(a.entity_id)?h:o`<button
                            ...
                            title=${s("battery_fleet_record_replacement",e).replace("{date}",this._fmtDate(l.at*1e3))}
                            .disabled=${this._marking}
                        ...
                        ${a.days_until!=null?o`<span
                              class="bf-predicted ${a.predicted_source==="trend"?"bf-trend":""}"
                              title=${a.predicted_source==="trend"?s("battery_fleet_predicted_trend",e).replace("{date}",this._predictedDate(a.days_until)).replace("{confidence}",s("cal_confidence_"+(a.prediction_confidence||"medium"),e)):s("battery_fleet_predicted_on",e).replace("{date}",this._predictedDate(a.days_until))}
                              >~${this._predictedDate(a.days_until)}</span
                            >`:h}
                        <button
                          class="bf-mark bf-exclude"
                          title=${s("battery_fleet_exclude",e)}
    ...
    `}};X._SORT_KEY="ms_bf_roster_sort",X.styles=A`
    .bf-card {
      background: var(--card-background-color, #fff);
      border: 1px solid var(--divider-color);
      border-radius: 10px;
  ...
  `,p([b({attribute:!1})],X.prototype,"hass",2),p([_()],X.prototype,"_ov",2),p([_()],X.prototype,"_loading",2),p([_()],X.prototype,"_marking",2),p([_()],X.prototype,"_error",2),p([_()],X.prototype,"_history",2),p([_()],X.prototype,"_rosterSort",2),p([_()],X.prototype,"_typeFilter",2),p([_()],X.prototype,"_recorded",2);var ti=X;customElements.get("maintenance-battery-fleet-section")||customElements.define("maintenance-battery-fleet-section",ti);var qi=5;function st(n){let r=n.getFullYear(),e=String(n.getMonth()+1).padStart(2,"0"),t=String(n.getDate()).padStart(2,"0");return`${r}-${e}-${t}`}function ia(n,r){let e=[];for(let t=0;t<r;t++){let i=new Date(n);i.setDate(i.getDate()+t),i.setHours(0,0,0,0),e.push(st(i))}return e}function At(n,r){let[e,t,i]=n.split("-").map(Number),a=new Date(e,t-1,i);return a.setDate(a.getDate()+r),st(a)}function sa(n){if(!n||n.length===0)return null;let r=n.map(e=>e.cost).filter(e=>typeof e=="number");return r.length===0?null:r.reduce((e,t)=>e+t,0)/r.length}function aa(n){let{windowStart:r,windowEnd:e,task:t,entryId:i,objectName:a}=n,l=[],c=(m,v)=>({date:m,entry_id:i,task_id:t.id,task_name:t.name,object_name:a,status:v&&(t.status==="overdue"||t.status==="triggered")?"ok":t.status,days_until_due:v?null:t.days_until_due??null,projected:v,schedule_type:t.schedule_type,interval_days:t.interval_days??null,interval_unit:t.interval_unit??null,responsible_user_id:t.responsible_user_id??null,avg_cost:sa(t.history),adaptive_enabled:!!t.adaptive_config?.enabled,prediction_confidence:t.threshold_prediction_confidence??null}),d=Math.max(1,Math.round(Qt(t.interval_days,t.interval_unit)));if(t.status==="overdue"||t.status==="triggered"){if(l.push(c(r,!1)),t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let m=At(r,d),v=1;for(;m<=e&&v<qi;)l.push(c(m,!0)),v++,m=At(m,d)}return l}let u=t.next_due;if(typeof u!="string"||!u)return l;let g=u.slice(0,10);if(g>=r&&g<=e)l.push(c(g,!1));else if(g>e)return l;if(t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let m=At(g,d),v=l.length;for(;m<=e&&v<qi;)m>=r&&(l.push(c(m,!0)),v++),m=At(m,d)}return l}var Ni={overdue:0,triggered:1,due_soon:2,ok:3};function Fi(n,r,e,t=null){let i=ia(r,e),a=i[0],l=i[i.length-1],c=[];for(let u of n){let g=u.object?.name||"",m=u.entry_id,v=u.tasks||[];for(let f of v){if(t&&f.responsible_user_id!==t||f.enabled===!1)continue;let w=aa({windowStart:a,windowEnd:l,task:f,entryId:m,objectName:g});c.push(...w)}}let d=new Map;for(let u of i)d.set(u,[]);for(let u of c){let g=d.get(u.date);g&&g.push(u)}for(let[,u]of d)u.sort((g,m)=>{let v=Ni[g.status]??99,f=Ni[m.status]??99;if(v!==f)return v-f;if(g.projected!==m.projected)return g.projected?1:-1;let w=g.object_name.localeCompare(m.object_name);return w!==0?w:g.task_name.localeCompare(m.task_name)});return i.map(u=>({date:u,events:d.get(u)??[]}))}var ra={completed:"ok",reset:"ok",skipped:"due_soon",triggered:"triggered",trigger_replaced:"triggered",trigger_removed:"ok"};function na(n,r){let e=[];for(let t=r-1;t>=0;t--){let i=new Date(n);i.setDate(i.getDate()-t),i.setHours(0,0,0,0),e.push(st(i))}return e}function Ui(n,r,e,t=null){let i=na(r,e),a=i[0],l=i[i.length-1],c=new Map;for(let u of i)c.set(u,[]);for(let u of n){let g=u.object?.name||"",m=u.entry_id,v=u.tasks||[];for(let f of v){if(t&&f.responsible_user_id!==t)continue;let w=f.history||[];for(let x of w){if(typeof x?.timestamp!="string")continue;let M=x.timestamp.slice(0,10);if(M<a||M>l)continue;let L=c.get(M);if(!L)continue;let N=x.type??"completed";L.push({date:M,entry_id:m,task_id:f.id,task_name:f.name,object_name:g,status:ra[N]??"ok",days_until_due:null,projected:!1,schedule_type:f.schedule_type,interval_days:f.interval_days??null,responsible_user_id:f.responsible_user_id??null,avg_cost:typeof x.cost=="number"?x.cost:null,adaptive_enabled:!!f.adaptive_config?.enabled,prediction_confidence:null,history_timestamp:x.timestamp,history_type:N,history_cost:typeof x.cost=="number"?x.cost:null,history_notes:typeof x.notes=="string"?x.notes:null,history_duration:typeof x.duration=="number"?x.duration:null})}}}let d={completed:0,reset:1,skipped:2,triggered:3,trigger_replaced:4};for(let[,u]of c)u.sort((g,m)=>{let v=d[g.history_type??""]??99,f=d[m.history_type??""]??99;if(v!==f)return v-f;let w=g.object_name.localeCompare(m.object_name);return w!==0?w:g.task_name.localeCompare(m.task_name)});return i.map(u=>({date:u,events:c.get(u)??[]}))}var Bi=A`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;var re=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){if(this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter),typeof e.object_filter=="string")this._objectFilter=e.object_filter,this._configuredObjects=[];else if(Array.isArray(e.object_filter)){let t=e.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=t.length===1?t[0]:"",this._configuredObjects=t.length>1?t:[]}}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){super.updated(e),e.has("hass")&&ft(this.hass?.locale);let t=this.hass?.language;if(t&&!vt(t)&&K(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}_onEventClick(e){if(e.history_timestamp){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,l=null;this._userFilter&&(l=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let c=$=>{let Q=$.toLowerCase();return this._objects.find(F=>F.entry_id===$||F.object.name.toLowerCase()===Q)?.entry_id??null},d=new Set(this._configuredObjects.map(c).filter($=>$!==null)),u=d.size?this._objects.filter($=>d.has($.entry_id)):this._objects,g=this._config.show_object_filter!==!1&&u.length>1,m=this._objectFilter?c(this._objectFilter):null,v=m&&u.some($=>$.entry_id===m)?u.filter($=>$.entry_id===m):u,f=new Date;f.setHours(0,0,0,0);let w=this._pastDays>0,x=w?Ui(v,f,this._pastDays,l):Fi(v,f,this._windowDays,l),M=st(f),L=this._windowDays===365||w,N=L?x.filter($=>$.events.length>0):x,z=$=>{let Q=`cal-status-${$.status}`,J=$.projected?"cal-event-projected":"",F=$.status==="overdue"&&$.days_until_due!=null?` (${Te($.days_until_due,e)})`:"",H=$.projected&&$.interval_days?o`<span class="cal-event-recur">${$.interval_unit&&$.interval_unit!=="days"?`${$.interval_days} ${s("unit_"+$.interval_unit,e)}`:s("cal_every_n_days",e).replace("{n}",String($.interval_days))}</span>`:h,te=$.schedule_type==="sensor_based",pe=te?o`<ha-icon class="cal-event-icon cal-source-sensor"
                title="${s("cal_source_sensor",e)}" icon="mdi:trending-up"></ha-icon>`:o`<ha-icon class="cal-event-icon cal-source-time"
                title="${$.adaptive_enabled?s("cal_source_time_adaptive",e):s("cal_source_time",e)}"
                icon="${$.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,_e=te&&$.prediction_confidence&&$.status!=="triggered"&&!$.projected?o`<span class="cal-event-prediction cal-conf-${$.prediction_confidence}">
            ${s("cal_predicted",e)} · ${s(`cal_confidence_${$.prediction_confidence}`,e)}
          </span>`:h,G=this._stats?.budget?.currency_symbol||Ee,E=$.history_type?s($.history_type,e):s($.status,e);return o`
        <div class="cal-event ${J}"
          @click=${()=>this._onEventClick($)}>
          ${pe}
          <span class="cal-status-pill ${Q}">${E}</span>
          <div class="cal-event-body">
            <div class="cal-event-title">${$.object_name} · ${$.task_name}${F}</div>
            ${_e}
            ${H}
          </div>
          ${$.avg_cost!=null&&$.avg_cost>0?o`<span class="cal-event-cost">${$.avg_cost.toFixed(0)} ${G}</span>`:h}
        </div>
      `},C=$=>{let[Q,J,F]=$.date.split("-").map(Number),H=new Date(Q,J-1,F),te=$.date===M,pe=H.toLocaleDateString(e,{weekday:"short"}),_e=H.toLocaleDateString(e,{month:"long"});return o`
        <div class="cal-day-row">
          <div class="cal-day-pill ${te?"cal-today":""}">
            <span class="cal-pill-weekday">${pe}</span>
            <span class="cal-pill-day">${H.getDate()}</span>
          </div>
          <div class="cal-day-content">
            <div class="cal-day-header">
              <span class="cal-day-month">${_e}</span>
              ${te?o`<span class="cal-day-today-badge">${s("today",e)}</span>`:h}
            </div>
            ${$.events.length===0?o`<div class="cal-empty">${s("cal_no_events",e)}</div>`:$.events.map(z)}
          </div>
        </div>
      `};return o`
      <ha-card .header=${a}>
              ...
              <div class="cal-controls">
                ${t?o`
                      <div class="cal-window-chips cal-past-chips" title="${s("cal_past_windows",e)||"Past windows"}">
                        ${[30,90].map($=>o`
                          <button class="cal-window-chip cal-past-chip ${this._pastDays===$?"active":""}"
                            @click=${()=>{this._pastDays=$}}>
                            −${$}d
                          </button>
                        `)}
                      </div>
                      ...
                      <div class="cal-window-chips" title="${s("cal_forward_windows",e)||"Forward windows"}">
                        ${[7,14,30,365].map($=>o`
                          <button class="cal-window-chip ${this._pastDays===0&&this._windowDays===$?"active":""}"
                            @click=${()=>{this._windowDays=$,this._pastDays=0}}>
                            ${$===365?"+1y":`+${$}d`}
                          </button>
                        `)}
                      </div>
                ...
                ${i?o`
                      <select class="cal-user-filter"
                        ...
                        @change=${$=>{this._userFilter=$.target.value}}>
                ...
                ${g?o`
                      <select class="cal-user-filter"
                        .value=${m??""}
                        @change=${$=>{this._objectFilter=$.target.value}}>
                        <option value="">${s("all_objects",e)}</option>
                        ${[...u].sort(($,Q)=>$.object.name.localeCompare(Q.object.name)).map($=>o`<option value=${$.entry_id} ?selected=${$.entry_id===m}>${$.object.name}</option>`)}
                      </select>
                    `:h}
              </div>
            `:h}
        <div class="cal-rolling">
          ${N.length===0&&L?o`<div class="cal-empty">${s("cal_no_events",e)}</div>`:N.map(C)}
        </div>
      </ha-card>
    `}};re.styles=[xt,Bi,A`
      :host { display: block; }
      ha-card { padding: 0; overflow: hidden; }
    `],p([b({attribute:!1})],re.prototype,"hass",2),p([_()],re.prototype,"_config",2),p([_()],re.prototype,"_objects",2),p([_()],re.prototype,"_stats",2),p([_()],re.prototype,"_windowDays",2),p([_()],re.prototype,"_pastDays",2),p([_()],re.prototype,"_userFilter",2),p([_()],re.prototype,"_objectFilter",2),p([_()],re.prototype,"_unsub",2);var oa=[{value:7,label:"Week (7 days)"},{value:14,label:"Fortnight (14 days)"},{value:30,label:"Month (30 days, default)"},{value:365,label:"Year (365 days, empty days collapsed)"}],De=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}setConfig(e){this._config={...e}}_valueChanged(e,t){let i={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete i.show_window_chips,e==="show_user_filter"&&t===!0&&delete i.show_user_filter,e==="show_object_filter"&&t===!0&&delete i.show_object_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete i.title,e==="user_filter"&&t===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let e=this._config.window_days??30,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.user_filter??"",l=this._config.title??"";return o`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${oa.map(c=>o`<option value="${c.value}" ?selected=${c.value===e}>${c.label}</option>`)}
          </select>
        </div>
  ...
  `,p([b({attribute:!1})],xe.prototype,"hass",2),p([_()],xe.prototype,"_open",2),p([_()],xe.prototype,"_saving",2),p([_()],xe.prototype,"_error",2),p([_()],xe.prototype,"_draft",2);customElements.get("maintenance-history-edit-dialog")||customElements.define("maintenance-history-edit-dialog",xe);var ne=class extends S{constructor(){super(...arguments);this._open=!1;this._title="";this._message="";this._confirmText="";this._danger=!1;this._inputLabel="";this._inputType="";this._inputValue="";this._resolve=null;this._promptResolve=null}confirm(e){return this._title=e.title,this._message=e.message,this._confirmText=e.confirmText||"OK",this._danger=e.danger||!1,this._inputLabel="",this._inputType="",this._inputValue="",this._open=!0,new Promise(t=>{this._resolve=t,this._promptResolve=null})}prompt(e){return this._title=e.title,this._message=e.message,this._confirmText=e.confirmText||"OK",this._danger=e.danger||!1,this._inputLabel=e.inputLabel||"",this._inputType=e.inputType||"text",this._inputValue=e.inputValue||"",this._open=!0,new Promise(t=>{this._promptResolve=t,this._resolve=null})}_cancel(){this._open=!1,this._promptResolve&&(this._promptResolve({confirmed:!1,value:""}),this._promptResolve=null),this._resolve?.(!1),this._resolve=null}_confirmAction(){this._open=!1,this._promptResolve&&(this._promptResolve({confirmed:!0,value:this._inputValue}),this._promptResolve=null),this._resolve?.(!0),this._resolve=null}render(){if(!this._open)return h;let e=this.hass?.language||"en";return o`
  ...
  `],p([b({attribute:!1})],ne.prototype,"hass",2),p([_()],ne.prototype,"_open",2),p([_()],ne.prototype,"_title",2),p([_()],ne.prototype,"_message",2),p([_()],ne.prototype,"_confirmText",2),p([_()],ne.prototype,"_danger",2),p([_()],ne.prototype,"_inputLabel",2),p([_()],ne.prototype,"_inputType",2),p([_()],ne.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",ne);var Wi={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ki=n=>(...r)=>({_$litDirective$:n,values:r}),Rt=class{constructor(r){}get _$AU(){return this._$AM._$AU}_$AT(r,e,t){this._$Ct=r,this._$AM=e,this._$Ci=t}_$AS(r,e){return this.update(r,e)}update(r,e){return this.render(...e)}};var at=class extends Rt{constructor(r){if(super(r),this.it=h,r.type!==Wi.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(r){if(r===h||r==null)return this._t=void 0,this.it=r;if(r===ye)return r;if(typeof r!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(r===this.it)return this._t;this.it=r;let e=[r];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};at.directiveName="unsafeHTML",at.resultType=1;var Yi=Ki(at);var ca=["EUR","USD","GBP","JPY","CHF","CAD","AUD","NZD","CNY","INR","BRL","CZK","PLN","RUB","SEK","NOK","DKK","UAH"],R=class extends S{constructor(){super(...arguments);this.budget=null;this._settings=null;this._loading=!0;this._importCsv="";this._importLoading=!1;this._includeHistory=!0;this._toast="";this._testingNotification=!1;this._personTargets=[];this._testingUser="";this._users=[];this._savedViews=[];this._vacEnabled=!1;this._vacStart="";this._vacEnd="";this._vacBuffer=3;this._vacExempt=new Set;this._vacIsActive=!1;this._vacWindowEnd=null;this._vacAllTasks=[];this._vacPreview=[];this._vacPreviewLoading=!1;this._vacSaving=!1;this._qrObjects=[];this._qrSelectedEntries=new Set;this._qrActions=new Set(["view"]);this._qrUrlMode="companion";this._qrBatchLoading=!1;this._qrBatchResults=[];this._qrObjectsLoaded=!1;this._exportObjects=[];this._exportSelectedEntries=new Set;this._exportObjectsLoaded=!1;this._docArchiveLoading=!1;this._loaded=!1;this._userService=null;this._sendTestNotification=async e=>{e?this._testingUser=e:this._testingNotification=!0;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/test_notification",...e?{user_id:e}:{}}),i=t.message||(t.success?s("test_notification_success",this._lang):s("test_notification_failed",this._lang));this._showToast(i)}catch{this._showToast(s("test_notification_failed",this._lang))}finally{e?this._testingUser="":this._testingNotification=!1}};this._allTemplates=[];this._templateCategories={};this._tplOpenGroups=new Set;this._templatesRequested=!1}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded?(this._loaded=!0,this._userService=new ge(this.hass),this._loadSettings(),this._loadUsers()):e.has("hass")&&this.hass&&this._userService&&this._userService.updateHass(this.hass)}async _loadUsers(){if(this._userService){try{this._users=await this._userService.getUsers()}catch{this._users=[]}this._loadNotifyTargets()}}async _loadNotifyTargets(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/notify/user_targets"});this._personTargets=e.targets||[]}catch{this._personTargets=[]}}async _loadSettings(){this._loading=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});this._settings=e,this._hydrateVacationFromSettings()}catch{}try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"});this._savedViews=e.views||[]}catch{}this._loading=!1}_hydrateVacationFromSettings(){let e=this._settings?.vacation;e&&(this._vacEnabled=e.enabled,this._vacStart=e.start||"",this._vacEnd=e.end||"",this._vacBuffer=e.buffer_days,this._vacExempt=new Set(e.exempt_task_ids||[]),this._vacIsActive=e.is_active,this._vacWindowEnd=e.window_end)}async _updateSetting(e,t){try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:{[e]:t}});this._settings=i,this._showToast(s("settings_saved",this._lang)),this.dispatchEvent(new CustomEvent("settings-changed"))}catch{this._showToast(s("action_error",this._lang))}}_showToast(e){this._toast=e,setTimeout(()=>{this._toast=""},3e3)}_downloadFile(e,t,i){kt(e,t,i)}render(){let e=this._lang;return this._loading||!this._settings?o`<div class="settings-loading">Loading…</div>`:o`
      ${this._renderFeatures(e)}
      ${this._renderPanelAccess(e)}
      ${this._renderGeneral(e)}
      ${this._renderObjectsColumns(e)}
      ${this._settings.general.notifications_enabled?this._renderNotifications(e):h}
      ${this.features.budget?this._renderBudget(e):h}
    ...
    `}async _loadTemplates(){if(!this._templatesRequested){this._templatesRequested=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/templates",language:this._lang});this._allTemplates=e.templates||[],this._templateCategories=e.categories||{}}catch{}}}_renderTemplateToggles(e){this._loadTemplates();let t=new Set(this._settings.disabled_template_ids||[]),i=new Map;for(let l of Object.keys(this._templateCategories))i.set(l,[]);for(let l of this._allTemplates)i.has(l.category)||i.set(l.category,[]),i.get(l.category).push(l);let a=l=>this._templateCategories[l]?.["name_"+e]||this._templateCategories[l]?.name_en||l;return o`
      <div class="settings-section" data-section="templates">
        ...
        ${[...i.entries()].filter(([,l])=>l.length>0).map(([l,c])=>{let d=c.filter(g=>!t.has(g.id)).length,u=this._tplOpenGroups.has(l);return o`
            <div class="tpl-group">
              <div
                class="tpl-group-head"
                role="button"
                tabindex="0"
                @click=${()=>this._toggleTplGroupOpen(l)}
                @keydown=${g=>{(g.key==="Enter"||g.key===" ")&&(g.preventDefault(),this._toggleTplGroupOpen(l))}}
              >
                <ha-icon class="tpl-chevron" icon=${u?"mdi:chevron-down":"mdi:chevron-right"}></ha-icon>
                <ha-icon icon=${this._templateCategories[l]?.icon||"mdi:folder-outline"}></ha-icon>
                <span class="tpl-group-name">${a(l)}</span>
                <span class="tpl-group-count">${d}/${c.length}</span>
                <input
                  type="checkbox"
                  title=${s("settings_templates_toggle_group",e)}
                  .checked=${d===c.length}
                  @click=${g=>g.stopPropagation()}
                  @change=${g=>this._toggleTemplateGroup(c.map(m=>m.id),g.target.checked)}
                />
              </div>
              ${u?c.map(g=>o`
                    <label class="setting-row tpl-row">
                      ...
                      <input
                        type="checkbox"
                        .checked=${!t.has(g.id)}
                        @change=${m=>this._toggleTemplate(g.id,m.target.checked)}
                      />
                    </label>
                  `):h}
            </div>
    ...
    `}_toggleColumn(e,t){let i=new Set(it(this._settings.objects_table_columns));t?i.add(e):i.delete(e);let a=ze.filter(l=>l.required||i.has(l.key)).map(l=>l.key);this._updateSetting("objects_table_columns",a)}_renderGeneral(e){let t=this._settings.general,i=t.notify_targets??[],a=this._settings.budget;return o`
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select @change=${l=>this._updateSetting("budget_currency",l.target.value)}>
            ${ca.map(l=>o`<option value=${l} ?selected=${a.currency===l}>${l}</option>`)}
          </select>
        </label>
        <label class="setting-row">
        ...
        <label class="setting-row">
          ...
          <input type="checkbox" .checked=${t.install_assist_sentences??!1}
            @change=${l=>this._updateSetting("install_assist_sentences",l.target.checked)} />
        </label>
        ...
        ${t.notifications_enabled?o`
          ...
          ${this._personTargets.length?o`
            <div class="notify-per-person">
              ...
              ${this._personTargets.map(l=>o`
                <div class="notify-person-row">
                  <span class="notify-person-name">${l.name}</span>
                  <span class="notify-person-target ${l.services.length?"":"muted"}">
                    ${l.services.length?l.services.join(", "):s("notify_no_own_device",e)}
                  </span>
                  <button class="ha-button secondary"
                    ?disabled=${!l.services.length||this._testingUser===l.user_id}
                    @click=${()=>this._sendTestNotification(l.user_id)}>
                    ${this._testingUser===l.user_id?s("testing",e):s("send_test",e)}
                  </button>
                </div>
              `)}
            </div>
      ...
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          >
            ...
            ${this._savedViews.map(a=>o`<option value=${a.id} ?selected=${t.scope_view_id===a.id}>${a.name}</option>`)}
          </select>
        </label>
    ...
    `}_renderVacation(e){let t=this._vacEnabled&&!this._vacIsActive&&this._vacWindowEnd&&new Date(this._vacWindowEnd)<new Date,i=this._vacExempt.size;return o`
      <div class="settings-section vacation-section" data-section="vacation">
        <h3>
          ${s("vacation_title",e)}
          ${this._vacIsActive?o`<span class="vac-badge active">${s("vacation_active",e)}</span>`:h}
          ${t?o`<span class="vac-badge stale">${s("vacation_ended",e)}</span>`:h}
        </h3>
        ...
        ${this._vacStart&&this._vacEnd?o`
          <div class="vac-preview-toolbar">
            ...
            ${this._vacPreview.length>0?o`<span class="vac-preview-count">${this._vacPreview.length} ${s("vacation_preview_affected",e)}</span>`:h}
          </div>
          ${this._vacPreview.length>0?this._renderVacationPreview(e):h}
        `:h}
            ...
            <div class="vac-preview-row ${a?"exempt":""}">
              <div class="vac-preview-info">
                <div class="vac-preview-name">
                  ...
                  ${t.kind==="sensor_based"?o`<span class="vac-preview-kind">${s("vacation_sensor_based",e)}</span>`:h}
                </div>
              ...
              <div class="vac-preview-actions">
                ...
                ${t.kind==="time_based"?o`<button @click=${()=>this._previewActionSkip(t)}>${s("qr_action_skip",e)}</button>`:h}
...
<body>
  ...
  `,p([b({attribute:!1})],R.prototype,"hass",2),p([b({attribute:!1})],R.prototype,"features",2),p([b({attribute:!1})],R.prototype,"budget",2),p([_()],R.prototype,"_settings",2),p([_()],R.prototype,"_loading",2),p([_()],R.prototype,"_importCsv",2),p([_()],R.prototype,"_importLoading",2),p([_()],R.prototype,"_includeHistory",2),p([_()],R.prototype,"_toast",2),p([_()],R.prototype,"_testingNotification",2),p([_()],R.prototype,"_personTargets",2),p([_()],R.prototype,"_testingUser",2),p([_()],R.prototype,"_users",2),p([_()],R.prototype,"_savedViews",2),p([_()],R.prototype,"_vacEnabled",2),p([_()],R.prototype,"_vacStart",2),p([_()],R.prototype,"_vacEnd",2),p([_()],R.prototype,"_vacBuffer",2),p([_()],R.prototype,"_vacExempt",2),p([_()],R.prototype,"_vacIsActive",2),p([_()],R.prototype,"_vacWindowEnd",2),p([_()],R.prototype,"_vacAllTasks",2),p([_()],R.prototype,"_vacPreview",2),p([_()],R.prototype,"_vacPreviewLoading",2),p([_()],R.prototype,"_vacSaving",2),p([_()],R.prototype,"_qrObjects",2),p([_()],R.prototype,"_qrSelectedEntries",2),p([_()],R.prototype,"_qrActions",2),p([_()],R.prototype,"_qrUrlMode",2),p([_()],R.prototype,"_qrBatchLoading",2),p([_()],R.prototype,"_qrBatchResults",2),p([_()],R.prototype,"_qrObjectsLoaded",2),p([_()],R.prototype,"_exportObjects",2),p([_()],R.prototype,"_exportSelectedEntries",2),p([_()],R.prototype,"_exportObjectsLoaded",2),p([_()],R.prototype,"_docArchiveLoading",2),p([_()],R.prototype,"_allTemplates",2),p([_()],R.prototype,"_templateCategories",2),p([_()],R.prototype,"_tplOpenGroups",2);customElements.define("maintenance-settings-view",R);var oe=class extends S{constructor(){super(...arguments);this.objects=[];this._summary=null;this._loaded=!1;this._busy=!1;this._error="";this._query="";this._results=[];this._expanded=!1;this._initiallyLoaded=!1;this._searchTimer=0}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._initiallyLoaded&&(this._initiallyLoaded=!0,this._load(),K(this._lang).then(()=>this.requestUpdate()))}async _load(){this._busy=!0;try{this._summary=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/storage"}),this._error=""}catch(e){this._error=j(e,this._lang)}finally{this._loaded=!0,this._busy=!1}}_nameFor(e){return this.objects.find(i=>i.object?.id===e)?.object?.name||e.slice(0,8)}_entryFor(e){return this.objects.find(t=>t.object?.id===e)?.entry_id}_toggle(){this._expanded=!this._expanded}_openObject(e){this.dispatchEvent(new CustomEvent("open-object",{detail:{entry_id:e},bubbles:!0,composed:!0}))}_onSearch(e){this._query=e.target.value,clearTimeout(this._searchTimer),this._searchTimer=window.setTimeout(()=>{this._doSearch()},250)}async _doSearch(){let e=this._query.trim();if(!e){this._results=[];return}try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/search",query:e});this._results=t.results||[]}catch(t){this._error=j(t,this._lang),this._results=[]}}async _openResult(e){if(e.kind==="weblink"){window.open(e.url,"_blank","noopener");return}let t=window.open("about:blank","_blank");try{let i=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:300});t&&(t.location.href=new URL(i.path,window.location.origin).href)}catch(i){t&&t.close(),this._error=j(i,this._lang)}}_renderResult(e,t){return o`
    ...
    `}render(){if(!this._loaded||!this._summary)return h;let e=this._summary;if(e.document_count===0)return h;let t=this._lang,i=Object.entries(e.by_object).filter(([,a])=>a.files>0||a.links>0).map(([a,l])=>({id:a,name:this._nameFor(a),entry:this._entryFor(a),...l})).sort((a,l)=>l.bytes-a.bytes);return o`
      <ha-card>
        <div class="card-content">
          <div class="header">
            ...
            >
              ...
              <span class="header-summary">
                ${me(e.total_bytes)}
                ${e.dedup_savings_bytes>0?o`<span class="saved">−${me(e.dedup_savings_bytes)}</span>`:h}
              </span>
            </button>
            <button
              class="icon-btn"
          ...
          ${this._expanded?o`
                <div class="body">
                  <div class="totals">
                    <div class="stat">
                      <div class="stat-value">${me(e.total_bytes)}</div>
                    ...
                    ${e.dedup_savings_bytes>0?o`<div class="stat">
                          <div class="stat-value saved">−${me(e.dedup_savings_bytes)}</div>
    ...
    `}_renderObjRow(e,t){let i=e.entry;return o`
      ...
      >
        ...
        <span class="obj-size">${me(e.bytes)}</span>
  ...
  `,p([b({attribute:!1})],oe.prototype,"hass",2),p([b({attribute:!1})],oe.prototype,"objects",2),p([_()],oe.prototype,"_summary",2),p([_()],oe.prototype,"_loaded",2),p([_()],oe.prototype,"_busy",2),p([_()],oe.prototype,"_error",2),p([_()],oe.prototype,"_query",2),p([_()],oe.prototype,"_results",2),p([_()],oe.prototype,"_expanded",2);customElements.get("maintenance-storage-section-card")||customElements.define("maintenance-storage-section-card",oe);var da=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"],he=class extends S{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._error="";this._entryId="";this._taskId="";this._values=new Array(12).fill("");this._save=async()=>{let e=this._buildOverrides();if(e!==null){this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:e}),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(t){this._error=j(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}};this._clearAll=async()=>{this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:{}}),this._values=new Array(12).fill(""),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(e){this._error=j(e,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}open(e,t,i){if(this._entryId=e,this._taskId=t,this._values=new Array(12).fill(""),i)for(let[a,l]of Object.entries(i)){let c=parseInt(a,10);c>=1&&c<=12&&typeof l=="number"&&(this._values[c-1]=l.toString())}this._error="",this._open=!0}_close(){this._open=!1}_buildOverrides(){let e={};for(let t=0;t<12;t++){let i=this._values[t].trim();if(!i)continue;let a=parseFloat(i);if(Number.isNaN(a))return this._error=`${s("month_"+["jan","feb","mar","apr","may","jun","jul","aug","sep","oct","nov","dec"][t],this._lang)}: ${s("seasonal_override_invalid",this._lang)}`,null;if(a<.1||a>5)return this._error=s("seasonal_override_range",this._lang),null;e[t+1]=a}return e}render(){if(!this._open)return o``;let e=this._lang;return o`
  ...
  `,p([b({attribute:!1})],le.prototype,"hass",2),p([b({attribute:!1})],le.prototype,"objects",2),p([_()],le.prototype,"_open",2),p([_()],le.prototype,"_loading",2),p([_()],le.prototype,"_error",2),p([_()],le.prototype,"_groupId",2),p([_()],le.prototype,"_name",2),p([_()],le.prototype,"_description",2),p([_()],le.prototype,"_selected",2);customElements.get("maintenance-group-dialog")||customElements.define("maintenance-group-dialog",le);var ve=class extends S{constructor(){super(...arguments);this._open=!1;this._busy=!1;this._error="";this._name="";this._views=[];this._filters=null;this._localeReady=!1;this._save=async()=>{let e=this._name.trim();if(!(!e||this._busy||!this._filters)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/save",name:e,filters:this._filters});this._name="",this._emitChanged(t.views||[])}catch(t){this._error=j(t,this._lang)}finally{this._busy=!1}}};this._delete=async e=>{if(!this._busy){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/delete",view_id:e});this._emitChanged(t.views||[])}catch(t){this._error=j(t,this._lang)}finally{this._busy=!1}}}}get _lang(){return this.hass?.language||"en"}updated(e){e.has("hass")&&this.hass&&!this._localeReady&&(this._localeReady=!0,K(this._lang).then(()=>this.requestUpdate()))}async open(e,t){this._open=!0,this._error="",this._name="",this._filters=e,this._views=t}_close(){this._open=!1}_emitChanged(e){this._views=e,this.dispatchEvent(new CustomEvent("saved-views-changed",{bubbles:!0,composed:!0,detail:{views:e}}))}render(){if(!this._open)return o``;let e=this._lang;return o`
      <div class="overlay" @click=${this._close}>
        <div class="card" @click=${t=>t.stopPropagation()}>
  ...
  `,p([b({attribute:!1})],ve.prototype,"hass",2),p([_()],ve.prototype,"_open",2),p([_()],ve.prototype,"_busy",2),p([_()],ve.prototype,"_error",2),p([_()],ve.prototype,"_name",2),p([_()],ve.prototype,"_views",2);customElements.get("maintenance-saved-views-dialog")||customElements.define("maintenance-saved-views-dialog",ve);var pa=60,ha=20,Gi=30;function ii(n){let r=n.trigger_config??null;if(!r)return h;let e=r.type||"threshold",t=n.trigger_entity_info?.unit_of_measurement??"",i=0,a="";if(e==="threshold"){let d=n.trigger_current_value??null;if(d==null)return h;let u=r.trigger_above,g=r.trigger_below;if(u!=null){let m=g??0,v=u-m||1;i=Math.min(100,Math.max(0,(d-m)/v*100)),a=`${d.toFixed(1)} / ${u} ${t}`}else if(g!=null){let v=n.trigger_entity_info?.max??(g*2||100),f=v-g||1;i=Math.min(100,Math.max(0,(v-d)/f*100)),a=`${d.toFixed(1)} / ${g} ${t}`}else return h}else if(e==="counter"){let d=r.trigger_target_value||1,u;if(r.trigger_delta_mode?(u=n.trigger_current_delta??null,u==null&&n.trigger_baseline_value!=null&&n.trigger_current_value!=null&&(u=n.trigger_current_value-n.trigger_baseline_value)):u=n.trigger_current_value??null,u==null)return h;i=Math.min(100,Math.max(0,u/d*100)),a=`${u.toFixed(1)} / ${d} ${t}`}else if(e==="state_change"){let d=r.trigger_target_changes||1,u=n.trigger_current_value??null;if(u==null)return h;i=Math.min(100,Math.max(0,u/d*100)),a=`${Math.round(u)} / ${d}`}else if(e==="runtime"){let d=r.trigger_runtime_hours||100,u=n.trigger_current_value??null;if(u==null)return h;i=Math.min(100,Math.max(0,u/d*100)),a=`${u.toFixed(1)}h / ${d}h`}else if(e==="compound"){let d=r.compound_logic||r.operator||"AND",u=r.conditions?.length||0;a=`${d} (${u})`,i=n.trigger_active?100:0}else return h;let l=i>=100,c=i>90?"var(--error-color, #f44336)":i>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return o`
  ...
  `}function si(n,r,e){if(!n.trigger_config?.entity_id)return h;let t=n.trigger_config.entity_id,i=r.get(t)||[],a=[];if(i.length>=2)a=i.map(C=>({ts:C.ts,val:C.val}));else{if(!n.history)return h;for(let C of n.history)C.trigger_value!=null&&a.push({ts:new Date(C.timestamp).getTime(),val:C.trigger_value})}if(n.trigger_current_value!=null&&a.push({ts:Date.now(),val:n.trigger_current_value}),a.length<2)return h;a.sort((C,$)=>C.ts-$.ts);let l=pa,c=ha,d=a.map(C=>C.val),u=Math.min(...d),g=Math.max(...d),m=g-u||1;u-=m*.1,g+=m*.1;let v=a[0].ts,w=a[a.length-1].ts-v||1,x=C=>(C-v)/w*l,M=C=>2+(1-(C-u)/(g-u))*(c-4),L=a;if(L.length>Gi){let C=Math.ceil(L.length/Gi);L=L.filter(($,Q)=>Q%C===0||Q===L.length-1)}let N=L.map(C=>`${x(C.ts).toFixed(1)},${M(C.val).toFixed(1)}`).join(" "),z=n.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return o`
    <svg class="mini-sparkline" viewBox="0 0 ${l} ${c}" preserveAspectRatio="none" role="img" aria-label="${s("chart_mini_sparkline",e)}">
      <polyline points="${N}" fill="none" stroke="${z}" stroke-width="1.5" stroke-linejoin="round" />
    </svg>
  `}function Qi(n,r){let e=r;if(n.days_until_due==null||!n.interval_days||n.interval_days<=0)return h;let{pct:t,overflow:i}=wt(n.interval_days,n.days_until_due,n.interval_unit),a="var(--success-color, #4caf50)";return n.status==="overdue"?a="var(--error-color, #f44336)":n.status==="due_soon"&&(a="var(--warning-color, #ff9800)"),o`
    <div class="days-progress">
      <div class="days-progress-labels">
        <span>${n.last_performed?`${s("last_performed",e)}: ${W(n.last_performed,e)}`:""}</span>
        <span>${n.next_due?`${s("next_due",e)}: ${W(n.next_due,e)}`:""}</span>
      </div>
  ...
  `}function rt(n,r,e=4){if(!isFinite(n)||!isFinite(r))return{ticks:[],niceMin:0,niceMax:1};if(n===r){let u=Math.abs(n)*.1||1;n-=u,r+=u}let t=r-n,i=Math.pow(10,Math.floor(Math.log10(t/Math.max(1,e)))),a=i;for(let u of[1,2,5,10])if(a=i*u,t/a<=e+.5)break;let l=Math.floor(n/a)*a,c=Math.ceil(r/a)*a,d=[];for(let u=l;u<=c+a*1e-6;u+=a)d.push(Math.abs(u)<a*1e-9?0:u);return{ticks:d,niceMin:l,niceMax:c}}function fe(n){let r=Math.abs(n);return r>=1e6?qe((n/1e6).toFixed(r>=1e7?0:1))+"M":r>=1e4?qe((n/1e3).toFixed(0))+"k":r>=1e3?qe((n/1e3).toFixed(1))+"k":r>=100?n.toFixed(0):r>=10||r>=1?qe(n.toFixed(1)):r===0?"0":qe(n.toFixed(2))}function qe(n){return n.replace(/\.0+$/,"").replace(/(\.\d*[1-9])0+$/,"$1")}function Ie(n,r,e){let t=n.toLocaleString(e,{maximumFractionDigits:Math.abs(n)>=100?0:1});return r?`${t} ${r}`:t}function Ne(n,r,e){let t=new Date(n),i=e?{month:"short",day:"numeric",year:"2-digit"}:{month:"short",day:"numeric"};return t.toLocaleDateString(r,i)}function ai(n,r){return new Date(n).toLocaleDateString(r,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}function Mt(n,r){return new Date(n).getFullYear()!==new Date(r).getFullYear()}function Lt(n,r,e){if(e<2||r<=n)return[n,r];let t=[];for(let i=0;i<e;i++)t.push(n+(r-n)*i/(e-1));return t}var It=210,ue=46,we=14,$e=12,Ji=14,ua=20+Ji,_a=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],Y=class extends S{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(e=>{let t=Math.floor(e[0]?.contentRect?.width||0);t&&Math.abs(t-this._width)>2&&(this._width=t)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(e){e!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:e},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let e=this._width||320,t=[...this.points].sort((a,l)=>a.ts-l.ts),i=this.lang;return o`
    ...
    `}_renderSvg(e,t){let i=this.lang,a=e-ue-we,l=It-ua,c=l-$e,d=1/0,u=-1/0;for(let E of t)d=Math.min(d,E.min??E.val),u=Math.max(u,E.max??E.val);this.thresholdAbove!=null&&(d=Math.min(d,this.thresholdAbove),u=Math.max(u,this.thresholdAbove)),this.thresholdBelow!=null&&(d=Math.min(d,this.thresholdBelow),u=Math.max(u,this.thresholdBelow)),this.targetValue!=null&&(d=Math.min(d,this.targetValue),u=Math.max(u,this.targetValue)),this.forceZero&&(d=Math.min(d,0));let g=(u-d||1)*.06,m=this.forceZero&&d>=0?0:d-g,{ticks:v,niceMin:f,niceMax:w}=rt(m,u+g,4);this.forceZero&&d>=0&&f<0&&(f=0,v=v.filter(E=>E>=0));let x=t[0].ts,M=t[t.length-1].ts,L=M-x||1,N=Mt(x,M),z=E=>ue+(E-x)/L*a,C=E=>$e+(1-(E-f)/(w-f||1))*c,$=t.map(E=>`${z(E.ts).toFixed(1)},${C(E.val).toFixed(1)}`).join(" "),Q=`M${z(t[0].ts).toFixed(1)},${l} `+t.map(E=>`L${z(E.ts).toFixed(1)},${C(E.val).toFixed(1)}`).join(" ")+` L${z(t[t.length-1].ts).toFixed(1)},${l} Z`,J="",F=t.filter(E=>E.min!=null&&E.max!=null);if(F.length>=2){let E=F.map(P=>`${z(P.ts).toFixed(1)},${C(P.max).toFixed(1)}`),k=[...F].reverse().map(P=>`${z(P.ts).toFixed(1)},${C(P.min).toFixed(1)}`);J=`M${E[0]} `+E.slice(1).map(P=>`L${P}`).join(" ")+` L${k.join(" L")} Z`}let H=[];if(this.thresholdBelow!=null){let E=C(this.thresholdBelow);H.push({y:E,h:Math.max(0,l-E),lineY:E,label:`\u25BC ${fe(this.thresholdBelow)}`,labelY:Math.min(l-4,E+13)})}if(this.thresholdAbove!=null){let E=C(this.thresholdAbove);H.push({y:$e,h:Math.max(0,E-$e),lineY:E,label:`\u25B2 ${fe(this.thresholdAbove)}`,labelY:Math.max($e+11,E-5)})}let te=t[t.length-1],pe=(this.events||[]).filter(E=>E.ts>=x&&E.ts<=M),_e=Lt(x,M,Math.max(2,Math.min(5,Math.floor(a/110)+1))),G=this._hover;return o`
      <div class="svg-holder">
        <svg
          ...
          @pointermove=${E=>this._onPointer(E,t,z,C,e)}
          @pointerdown=${E=>this._onPointer(E,t,z,C,e)}
          @pointerleave=${()=>this._hover=null}
        >
          <defs>
            <clipPath id="plot"><rect x="${ue}" y="${$e}" width="${a}" height="${c}" /></clipPath>
            ${H.length?D`<clipPath id="danger">${H.map(E=>D`<rect x="${ue}" y="${E.y.toFixed(1)}" width="${a}" height="${E.h.toFixed(1)}" />`)}</clipPath>`:h}
          ...
          ${v.map(E=>{let k=C(E);return k<$e-1||k>l+1?h:D`
              <line x1="${ue}" y1="${k.toFixed(1)}" x2="${e-we}" y2="${k.toFixed(1)}"
                stroke="var(--divider-color)" stroke-width="1" opacity="0.6" />
              <text x="${ue-7}" y="${(k+3.5).toFixed(1)}" text-anchor="end" class="tick-label">${fe(E)}</text>`})}

          ${H.map(E=>D`<rect x="${ue}" y="${E.y.toFixed(1)}" width="${a}" height="${E.h.toFixed(1)}"
              fill="url(#dangerHatch)" />`)}

          ${J?D`<path d="${J}" fill="var(--primary-color)" opacity="0.08" clip-path="url(#plot)" />`:h}
          <path d="${Q}" fill="var(--primary-color)" opacity="0.10" clip-path="url(#plot)" />
          <polyline points="${$}" fill="none" stroke="var(--primary-color)" stroke-width="2"
            stroke-linejoin="round" stroke-linecap="round" clip-path="url(#plot)" />
          ${H.length?D`<polyline points="${$}" fill="none" stroke="var(--error-color, #f44336)" stroke-width="2"
                stroke-linejoin="round" stroke-linecap="round" clip-path="url(#danger)" />`:h}

          ${H.map(E=>D`
              <line x1="${ue}" y1="${E.lineY.toFixed(1)}" x2="${e-we}" y2="${E.lineY.toFixed(1)}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${e-we-4}" y="${E.labelY.toFixed(1)}" text-anchor="end" class="zone-label">${E.label}</text>`)}

          ${this.targetValue!=null?D`<line x1="${ue}" y1="${C(this.targetValue).toFixed(1)}" x2="${e-we}" y2="${C(this.targetValue).toFixed(1)}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${e-we-4}" y="${(C(this.targetValue)-5).toFixed(1)}" text-anchor="end" class="zone-label">◆ ${fe(this.targetValue)} ${this.unit}</text>`:h}

          ${this.projection&&this.projection.length===2?D`<line x1="${z(this.projection[0].ts).toFixed(1)}" y1="${C(this.projection[0].val).toFixed(1)}"
                x2="${Math.min(z(this.projection[1].ts),e-we).toFixed(1)}" y2="${C(Math.max(f,Math.min(w,this.projection[1].val))).toFixed(1)}"
                stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.8" />`:h}

          ${_e.map((E,k)=>{let P=z(E),Pt=k===0?"start":k===_e.length-1?"end":"middle";return D`<text x="${P.toFixed(1)}" y="${It-5}" text-anchor="${Pt}" class="tick-label">${Ne(E,i,N)}</text>`})}

          <line x1="${ue}" y1="${l}" x2="${e-we}" y2="${l}" stroke="var(--divider-color)" stroke-width="1" />

          ${pe.map(E=>{let k=z(E.ts),P=E.type==="completed"?"var(--success-color, #4caf50)":E.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return D`
              <line x1="${k.toFixed(1)}" y1="${$e}" x2="${k.toFixed(1)}" y2="${l}" stroke="${P}" stroke-width="1" opacity="0.14" />
              <rect x="${(k-1.5).toFixed(1)}" y="${l+3}" width="3" height="${Ji-6}" rx="1.5" fill="${P}">
                <title>${ai(E.ts,i)}</title>
              </rect>`})}

          ${G?D`
                <line x1="${G.x.toFixed(1)}" y1="${$e}" x2="${G.x.toFixed(1)}" y2="${l}"
                  stroke="var(--secondary-text-color)" stroke-width="1" stroke-dasharray="3,3" opacity="0.7" />
                <circle cx="${G.x.toFixed(1)}" cy="${G.y.toFixed(1)}" r="4.5" fill="var(--primary-color)"
                  stroke="var(--card-background-color, #fff)" stroke-width="2" />`:D`<circle cx="${z(te.ts).toFixed(1)}" cy="${C(te.val).toFixed(1)}" r="4" fill="var(--primary-color)"
                stroke="var(--card-background-color, #fff)" stroke-width="1.5" />`}
        </svg>
        ${G?o`<div
              class="hover-chip"
              style="left:${Math.min(Math.max(G.x,70),e-70)}px"
            >
              <div class="hover-date">${ai(G.p.ts,i)}</div>
              <div class="hover-val">
                ${Ie(G.p.val,this.unit,i)}
                ${G.p.min!=null&&G.p.max!=null?o`<span class="hover-range">(${fe(G.p.min)}–${fe(G.p.max)})</span>`:h}
              </div>
            </div>`:h}
      </div>
    `}_onPointer(e,t,i,a,l){let d=e.currentTarget.getBoundingClientRect(),u=(e.clientX-d.left)/d.width*l;if(u<ue-8||u>l-we+8){this._hover=null;return}let g=t[0],m=1/0;for(let v of t){let f=Math.abs(i(v.ts)-u);f<m&&(m=f,g=v)}this._hover={x:i(g.ts),y:a(g.val),p:g}}};Y.styles=A`
  ...
  `,p([b({attribute:!1})],Y.prototype,"points",2),p([b({attribute:!1})],Y.prototype,"events",2),p([b()],Y.prototype,"unit",2),p([b()],Y.prototype,"lang",2),p([b({attribute:!1})],Y.prototype,"thresholdAbove",2),p([b({attribute:!1})],Y.prototype,"thresholdBelow",2),p([b({attribute:!1})],Y.prototype,"targetValue",2),p([b({type:Boolean})],Y.prototype,"forceZero",2),p([b({attribute:!1})],Y.prototype,"projection",2),p([b({attribute:!1})],Y.prototype,"rangeDays",2),p([b({type:Boolean})],Y.prototype,"showRange",2),p([b({type:Boolean})],Y.prototype,"busy",2),p([b({type:Boolean})],Y.prototype,"hideOutliers",2),p([b({type:Boolean})],Y.prototype,"showOutlierToggle",2),p([_()],Y.prototype,"_width",2),p([_()],Y.prototype,"_hover",2);customElements.get("maintenance-trigger-chart")||customElements.define("maintenance-trigger-chart",Y);function ga(n){if(n.length<4)return n;let r=n.map(u=>u.val).sort((u,g)=>u-g),e=u=>{let g=(r.length-1)*u,m=Math.floor(g),v=Math.ceil(g);return r[m]+(r[v]-r[m])*(g-m)},t=e(.25),i=e(.75),a=i-t;if(a===0)return n;let l=t-1.5*a,c=i+1.5*a,d=n.filter(u=>u.val>=l&&u.val<=c);return d.length>=2?d:n}function Zi(n,r){let e=n.trigger_config;if(!e)return h;let t=r.lang,i=n.trigger_entity_info,a=n.trigger_entity_infos,l=i?.friendly_name||e.entity_id||"\u2014",c=e.entity_id||"",d=e.entity_ids||(c?[c]:[]),u=i?.unit_of_measurement||"",g=n.trigger_current_value,m=e.type||"threshold",v=d.length>1,f=ma(n,u,r);return o`
    <h3>${s("trigger",t)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${v?o`
            ...
            <div class="trigger-entity-id">${d.map((w,x)=>o`${x>0?", ":""}<span class="entity-link" @click=${M=>Le(M,w)}>${w}</span>`)}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `:o`
            <div class="trigger-entity-name">${l}</div>
            <div class="trigger-entity-id">${c?o`<span class="entity-link" @click=${w=>Le(w,c)}>${c}</span>`:""}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `}
        </div>
      ...
      ${f?va(f,t):g!=null?o`
              <div class="trigger-value-row">
                <span class="trigger-current ${n.trigger_active?"active":""}">${typeof g=="number"?Ie(g,"",t):g}</span>
      ...
      <div class="trigger-limits">
        ...
        ${m==="compound"?o`
          ...
          ${(e.conditions||[]).map((w,x)=>o`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${x+1}. ${s(w.type||"unknown",t)}: ${w.entity_id?o`<span class="entity-link" @click=${M=>Le(M,w.entity_id)}>${w.entity_id}</span>`:""}</span>
          `)}
        `:h}
      </div>
      ...
      ${a&&a.length>1?o`
        <div class="trigger-entity-list">
          ${a.map(w=>o`
            <span class="trigger-entity-id">${w.friendly_name} (<span class="entity-link" @click=${x=>Le(x,w.entity_id)}>${w.entity_id}</span>)</span>
          `)}
        </div>
      `:h}
  ...
  `}function ma(n,r,e){let t=n.trigger_config,i=n.trigger_current_value;if(!t||i==null)return null;switch(t.type||"threshold"){case"counter":{let a=t.trigger_target_value;if(a==null||a<=0)return null;let l=Xi(n,es(n,e));return{progress:Math.max(0,i-(l?.value??i)),target:a,unit:r,meter:i}}case"state_change":{let a=t.trigger_target_changes;return a==null||a<=0?null:{progress:Math.max(0,i),target:a,unit:"",meter:null}}case"runtime":{let a=t.trigger_runtime_hours;return a==null||a<=0?null:{progress:Math.max(0,i),target:a,unit:"h",meter:null}}}return null}function Xi(n,r){if(n.trigger_baseline_value!=null)return{value:n.trigger_baseline_value,ts:ri(n)};if(!r.length)return null;let e=ri(n);if(e==null)return{value:r[0].val,ts:null};let t=r[0],i=Math.abs(r[0].ts-e);for(let a of r){let l=Math.abs(a.ts-e);l<i&&(t=a,i=l)}return{value:t.val,ts:e}}function ri(n){let r=[...n.history].filter(e=>e.type==="completed"||e.type==="reset").sort((e,t)=>new Date(t.timestamp).getTime()-new Date(e.timestamp).getTime())[0];return r?new Date(r.timestamp).getTime():null}function va(n,r){let e=Math.min(999,Math.round(n.progress/n.target*100)),t=e>=100?"over":e>=75?"near":"ok";return o`
    <div class="counter-progress">
      <div class="counter-progress-nums">
        <span class="counter-progress-main">${Ie(n.progress,"",r)}<span class="counter-progress-target"> / ${Ie(n.target,n.unit,r)}</span></span>
      ...
      <div class="counter-progress-caption">
        ${s("chart_since_service",r)}${n.meter!=null?o` · ${s("current",r)}: ${Ie(n.meter,n.unit,r)}`:h}
      </div>
    </div>
  `}function es(n,r){let e=n.trigger_config;if(!e)return[];let t=e.type||"threshold",i=e.entity_id||"",a=t==="runtime"?[]:r.detailStatsData.get(i)||[],l=r.isCounterEntity(e),c=[];if(a.length>=2)for(let d of a){let u={ts:d.ts,val:d.val};!l&&d.min!=null&&d.max!=null&&(u.min=d.min,u.max=d.max),c.push(u)}else for(let d of n.history)d.trigger_value!=null&&c.push({ts:new Date(d.timestamp).getTime(),val:d.trigger_value});return n.trigger_current_value!=null&&c.push({ts:Date.now(),val:n.trigger_current_value}),c.sort((d,u)=>d.ts-u.ts),c}function fa(n,r,e){let t=n.trigger_config;if(!t)return h;let i=t.type||"threshold",a=t.entity_id||"",l=es(n,e);i==="runtime"&&t.trigger_runtime_hours&&n.trigger_current_value!=null&&(l=[{ts:ri(n)??l[0]?.ts??Date.now()-864e5,val:0},{ts:Date.now(),val:Math.max(0,n.trigger_current_value)}]),e.hideOutliers&&(l=ga(l));let c=l.length<2&&!!a&&e.hasStatsService&&!e.detailStatsData.has(a);if(l.length<2&&!c)return h;let d=!!a&&e.detailStatsData.has(a)&&(e.detailStatsData.get(a)?.length??0)<2,u=Date.now()-e.rangeDays*864e5,g=l.filter(x=>x.ts>=u);g.length>=2&&(l=g);let m=null,v=!1;if(i==="counter"&&t.trigger_target_value!=null&&l.length){let x=Xi(n,l);if(x){if(x.ts!=null){let M=l.filter(L=>L.ts>=x.ts);M.length>=2&&(l=M)}l=l.map(M=>({...M,val:Math.max(0,M.val-x.value)}))}m=t.trigger_target_value,v=!0}else i==="state_change"&&t.trigger_target_changes?(m=t.trigger_target_changes,v=!0):i==="runtime"&&t.trigger_runtime_hours&&(m=t.trigger_runtime_hours,v=!0);let f=null;if(m==null&&n.degradation_rate!=null&&(n.degradation_trend!=="stable"||n.days_until_threshold!=null)&&n.degradation_trend!=="insufficient_data"&&l.length>=2){let x=l[l.length-1];f=[x,{ts:x.ts+30*864e5,val:x.val+n.degradation_rate*30}]}let w=n.history.filter(x=>["completed","skipped","reset"].includes(x.type)).map(x=>({ts:new Date(x.timestamp).getTime(),type:x.type}));return o`
  ...
  `}function ts(n,r,e){let t=n.degradation_trend!=null&&n.degradation_trend!=="insufficient_data",i=n.days_until_threshold!=null,a=n.environmental_factor!=null&&n.environmental_factor!==1;if(!t&&!i&&!a)return h;let l=n.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":n.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return o`
      ...
      <div class="prediction-grid">
        ...
        ${i?o`
          <div class="prediction-item">
            ...
            ${n.threshold_prediction_date?o`<span class="prediction-date">${W(n.threshold_prediction_date,r)}</span>`:h}
        ...
        ${a&&e.environmental?o`
          <div class="prediction-item">
            ...
            ${n.environmental_entity?o`<span class="prediction-entity entity-link" @click=${c=>Le(c,n.environmental_entity)}>${n.environmental_entity}</span>`:h}
          </div>
        `:h}
      </div>
    </div>
  `}function is(n,r){let e=n.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return h;let a=n.interval_days??0,l=n.suggested_interval??a;return o`
  ...
  `}function ya(n,r,e,t,i){let f=Math.max(e,t,r,1)*1.3,w=50,x=[];for(let F=0;F<=w;F++){let H=F/w*f,te=1-Math.exp(-Math.pow(H/r,n)),pe=32+H/f*260,_e=136-te*128;x.push([pe,_e])}let M=x.map(([F,H])=>`${F.toFixed(1)},${H.toFixed(1)}`).join(" "),L="M32,136 "+x.map(([F,H])=>`L${F.toFixed(1)},${H.toFixed(1)}`).join(" ")+` L${x[w][0].toFixed(1)},136 Z`,N=32+e/f*260,z=1-Math.exp(-Math.pow(e/r,n)),C=136-z*128,$=((1-z)*100).toFixed(0),Q=32+t/f*260,J=[0,.25,.5,.75,1];return o`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",i)}">
        ...
        ${e>0?D`
          ...
          <circle cx="${N.toFixed(1)}" cy="${C.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(N+4).toFixed(1)}" y="${(C-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${$}%</text>
        `:h}
    ...
    <div class="chart-legend">
      ...
      ${e>0?o`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4); opacity:0.5"></span> ${s("current_interval_marker",i)}</span>`:h}
      ${t>0&&t!==e?o`<span class="legend-item"><span class="legend-swatch" style="background:var(--success-color, #4caf50)"></span> ${s("recommended_marker",i)}</span>`:h}
    </div>
  `}function xa(n,r){return o`
  ...
  `}function wa(n,r,e){let t=n.confidence_interval_low,i=n.confidence_interval_high,a=r.suggested_interval??r.interval_days??0,l=r.interval_days??0,c=Math.max(0,t-5),u=i+5-c,g=(t-c)/u*100,m=(i-t)/u*100,v=(a-c)/u*100,f=l>0?(l-c)/u*100:-1;return o`
  ...
  `}function ss(n,r,e,t){let i=Math.max(n||1,r);return o`
  ...
  `}var as=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function rs(n,r,e){if(!e.seasonal||!n.seasonal_factor||n.seasonal_factor===1)return h;let t=as.map(c=>s(c,r)),i=new Date().getMonth(),a=n.seasonal_factors||n.interval_analysis?.seasonal_factors||null,l=a&&a.length===12?a:t.map((c,d)=>{let u=n.seasonal_factor||1,g=Math.sin((d-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,u+g))});return o`
  ...
  `}function ns(n,r){return $a(n,r)}function $a(n,r){let e=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return h;let t=n.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,l=100,c=8,u=l-c-4,g=Math.max(...e,1.5),m=a/12,v=m*.65,f=c+u-1/g*u;return o`
    <div class="seasonal-chart">
      <div class="seasonal-chart-title">
        ...
        ${t?o`<span class="source-tag">${t==="learned"?s("seasonal_learned",r):s("seasonal_manual",r)}</span>`:h}
      </div>
      <svg viewBox="0 0 ${a} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",r)}">
        ...
        ${e.map((w,x)=>{let M=w/g*u,L=x*m+(m-v)/2,N=c+u-M,z=x===i,C=w<1?"var(--success-color, #4caf50)":w>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return D`
            <rect x="${L.toFixed(1)}" y="${N.toFixed(1)}"
              width="${v.toFixed(1)}" height="${M.toFixed(1)}"
              fill="${C}" opacity="${z?1:.5}" rx="2" />
          `})}
      </svg>
      <div class="seasonal-labels">
        ${as.map((w,x)=>o`<span class="seasonal-label ${x===i?"active-month":""}">${s(w,r)}</span>`)}
      </div>
    </div>
  `}var ka=200,nt=10,Ea=22;function os(n,r,e,t){let i=n.history.filter(c=>c.type==="completed"&&(c.cost!=null||c.duration!=null));if(i.length<2)return h;let a=i.some(c=>(c.cost??0)>0),l=i.some(c=>(c.duration??0)>0);return!a&&!l?h:o`
  ...
  `}function Ta(n,r,e){let t=n.history.filter(k=>k.type==="completed"&&(k.cost!=null||k.duration!=null)).map(k=>({ts:new Date(k.timestamp).getTime(),cost:k.cost??0,duration:k.duration??0})).sort((k,P)=>k.ts-P.ts);if(t.length<2)return h;let i=t.some(k=>k.cost>0),a=t.some(k=>k.duration>0);if(!i&&!a)return h;let l=e!=="duration"&&i,c=e!=="cost"&&a,d=l||!c&&i,u=c||!l&&a,g=640,m=ka,v=d?44:12,f=u?44:12,w=g-v-f,x=m-Ea,M=x-nt,L=t[0].ts,N=t[t.length-1].ts,z=(N-L||864e5)*.05,C=L-z,$=N+z,Q=Mt(L,N),J=k=>v+(k-C)/($-C)*w,F=rt(0,Math.max(...t.map(k=>k.cost))||1,3),H=rt(0,Math.max(...t.map(k=>k.duration))||1,3),te=k=>nt+(1-k/(F.niceMax||1))*M,pe=k=>nt+(1-k/(H.niceMax||1))*M,_e=t.length>1?Math.min(...t.slice(1).map((k,P)=>J(k.ts)-J(t[P].ts))):w,G=Math.max(6,Math.min(22,_e*.55)),E=Lt(L,N,Math.max(2,Math.min(4,t.length)));return o`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${g} ${m}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_history",r)}">
        ${d?F.ticks.map(k=>{let P=te(k);return P<nt-1||P>x+1?h:D`
            <line x1="${v}" y1="${P.toFixed(1)}" x2="${g-f}" y2="${P.toFixed(1)}" stroke="var(--divider-color)" stroke-width="1" opacity="0.55" />
            <text x="${v-6}" y="${(P+3.5).toFixed(1)}" text-anchor="end" fill="var(--primary-color)" font-size="10.5">${fe(k)}€</text>`}):h}
        ${u?H.ticks.map(k=>{let P=pe(k);return P<nt-1||P>x+1?h:D`<text x="${g-f+6}" y="${(P+3.5).toFixed(1)}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="10.5">${fe(k)}m</text>`}):h}

        ${d?t.filter(k=>k.cost>0).map(k=>D`
          <rect x="${(J(k.ts)-G/2).toFixed(1)}" y="${te(k.cost).toFixed(1)}" width="${G.toFixed(1)}" height="${(x-te(k.cost)).toFixed(1)}"
            fill="var(--primary-color)" opacity="0.6" rx="2">
            <title>${Ne(k.ts,r,!0)}: ${k.cost.toLocaleString(r)}€${k.duration?` \xB7 ${k.duration}m`:""}</title>
          </rect>
        `):h}
        ${u?D`
          <polyline points="${t.map(k=>`${J(k.ts).toFixed(1)},${pe(k.duration).toFixed(1)}`).join(" ")}"
            fill="none" stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-linejoin="round" />
          ${t.map(k=>D`
            <circle cx="${J(k.ts).toFixed(1)}" cy="${pe(k.duration).toFixed(1)}" r="3.5" fill="var(--accent-color, #ff9800)">
              <title>${Ne(k.ts,r,!0)}: ${k.duration}m${k.cost?` \xB7 ${k.cost.toLocaleString(r)}\u20AC`:""}</title>
            </circle>
          `)}
        `:h}

        <line x1="${v}" y1="${x}" x2="${g-f}" y2="${x}" stroke="var(--divider-color)" stroke-width="1" />
        ${E.map((k,P)=>{let Pt=P===0?"start":P===E.length-1?"end":"middle";return D`<text x="${J(k).toFixed(1)}" y="${m-6}" text-anchor="${Pt}" fill="var(--secondary-text-color)" font-size="10">${Ne(k,r,Q)}</text>`})}
      </svg>
    </div>
    <div class="chart-legend">
  ...
  `}var je=class extends S{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{let e=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${this.docId}`,expires:300});this._url=e.path}catch{this._failed=!0}}render(){return this._failed||!this.docId?h:this._url?o`
      <a href=${this._url} target="_blank" rel="noopener" class="wrap">
        <img src=${this._url} alt="" loading="lazy"
          @error=${()=>this._failed=!0} />
      </a>`:o`<div class="ph"></div>`}};je.styles=A`
  ...
  `,p([b({attribute:!1})],je.prototype,"hass",2),p([b()],je.prototype,"docId",2),p([_()],je.prototype,"_url",2),p([_()],je.prototype,"_failed",2);customElements.get("maintenance-history-photo")||customElements.define("maintenance-history-photo",je);var Sa=["completed","skipped","missed","reset","triggered"];function ls(n,r){let e=r.lang;return o`
    <div class="history-filters-new">
      <div class="filter-chips">
        ${Sa.map(t=>{let i=n.history.filter(a=>a.type===t).length;return i===0?h:o`
            <span class="filter-chip ${r.filter===t?"active":""}"
              @click=${()=>r.setFilter(r.filter===t?null:t)}>
              ${s(t,e)} (${i})
            </span>
          `})}
        ${r.filter?o`<span class="filter-chip clear" @click=${()=>r.setFilter(null)}>${s("show_all",e)}</span>`:h}
      </div>
      <div class="filter-controls">
        <input type="text" class="search-input" placeholder="${s("search_notes",e)}..." .value=${r.search} @input=${t=>r.setSearch(t.target.value)} />
      </div>
    </div>
  `}function cs(n,r){let e=r.lang,t=r.filter?n.history.filter(i=>i.type===r.filter):n.history;if(r.search){let i=r.search.toLowerCase();t=t.filter(a=>a.notes?.toLowerCase().includes(i))}return t.length===0?o`<p class="empty">${s("no_history",e)}</p>`:o`
    <div class="history-timeline">
      ${[...t].reverse().map(i=>ja(i,r))}
    </div>
  `}function ja(n,r){let e=r.lang,t=["completed","reset","skipped"].includes(n.type);return o`
    <div class="history-entry">
      <div class="history-icon ${n.type}">
        <ha-icon .icon=${Je[n.type]||"mdi:circle"}></ha-icon>
      </div>
      <div class="history-content">
        <div class="history-row">
          <strong>${s(n.type,e)}</strong>
          ${n.auto?o`<span class="history-auto-badge">${s("history_auto",e)}</span>`:h}
        ...
        <div class="history-date">${bt(n.timestamp,e)}</div>
        ...
        <div class="history-details">
          ${n.cost!=null?o`<span>${s("cost",e)}: ${n.cost.toFixed(2)} ${r.currencySymbol}</span>`:h}
          ${n.duration!=null?o`<span>${s("duration",e)}: ${n.duration} min</span>`:h}
          ${n.trigger_value!=null?o`<span>${s("trigger_val",e)}: ${n.trigger_value}</span>`:h}
          ${n.reading_value!=null?o`<span>${s("reading_label",e)}: ${n.reading_value}${r.readingUnit?` ${r.readingUnit}`:""}${(()=>{let i=r.readingDelta?.(n);return i==null?"":` (${i>=0?"+":""}${Number(i.toFixed(3))})`})()}</span>`:h}
        </div>
      </div>
    </div>
  `}function ni(n,r){if(!n.responsible_user_id)return h;let e=r(n.responsible_user_id);return e?o`
    <span class="user-badge">
      <ha-icon icon="mdi:account"></ha-icon>
      ${e}
    </span>
  `:h}function Aa(n,r){let e=r.lang,t=r.isOperator,i=n.archived?"archived":n.is_done?"done":n.status==="due_soon"?"warning":n.status||"ok",a=n.archived?s("archived",e):n.is_done?s("completed",e):s(n.status||"ok",e);return o`
    <div class="task-header">
      <div class="task-header-title">
        ...
        ${n.due_override?o`<span class="postponed-badge" title="${s("postponed_to",e)}">
          <ha-icon icon="mdi:calendar-arrow-right"></ha-icon>${W(n.due_override,e)}
        </span>`:h}
        ${ni(n,r.getUserName)}
        ${n.nfc_tag_id?o`<span class="nfc-badge" title="${s("nfc_tag_id",e)}: ${n.nfc_tag_id}"><ha-icon icon="mdi:nfc-variant"></ha-icon> NFC</span>`:t?h:o`<span class="nfc-badge unlinked" title="${s("nfc_link_hint",e)}"
              @click=${()=>r.openEdit(n)}>
              <ha-icon icon="mdi:nfc-variant"></ha-icon>
            </span>`}
      </div>
      <div class="task-header-actions">
        <ha-button appearance="filled" @click=${()=>r.openComplete(n)}>${s("complete",e)}</ha-button>
        <ha-button appearance="plain" .disabled=${r.actionLoading} @click=${()=>r.promptSkip()}>${s("skip",e)}</ha-button>
        <div class="more-menu-wrapper">
          ...
          ${r.moreMenuOpen?o`
            <div class="popup-menu" @click=${l=>l.stopPropagation()}>
              ${t?h:o`
                <div class="popup-menu-item" @click=${()=>{r.closeMoreMenu(),r.openEdit(n)}}>${s("edit",e)}</div>
              `}
              <div class="popup-menu-item" @click=${()=>{r.closeMoreMenu(),r.openQr(n.name)}}>${s("qr_code",e)}</div>
              <div class="popup-menu-item" @click=${()=>{r.closeMoreMenu(),r.printWorksheet()}}>${s("worksheet",e)}</div>
              ${t?h:o`
                <div class="popup-menu-item" @click=${()=>r.duplicateTask()}>${s("duplicate",e)}</div>
                <div class="popup-menu-item" @click=${()=>{r.closeMoreMenu(),r.promptReset()}}>${s("reset",e)}</div>
                <div class="popup-menu-item" @click=${()=>{r.closeMoreMenu(),r.promptPostpone()}}>${s("postpone",e)}…</div>
                <div class="popup-menu-item" @click=${()=>{r.closeMoreMenu(),r.snoozeTask()}}>${s("snooze",e)}</div>
                <div class="popup-menu-item" @click=${()=>{r.closeMoreMenu(),r.toggleArchive(!!n.archived)}}>${n.archived?s("unarchive",e):s("archive",e)}</div>
                <div class="popup-menu-divider"></div>
                <div class="popup-menu-item danger" @click=${()=>{r.closeMoreMenu(),r.deleteTask()}}>${s("delete",e)}</div>
              `}
            </div>
          `:h}
        </div>
  ...
  `}function Ca(n){let r=n.lang;return o`
    <div class="tab-bar">
  ...
  `}function ds(n,r,e,t){let i=t.collapsedSections.has(n);return o`
    <div class="collapsible ${i?"collapsed":""}">
      <button class="collapsible-head" @click=${()=>t.toggleSection(n)}
        ...
        <span>${s(r,t.lang)}</span>
      </button>
      ${i?h:o`<div class="collapsible-body">${e}</div>`}
    </div>
  `}function Ra(n,r){if(!r.features.checklists)return h;let e=n.checklist||[];if(e.length===0)return h;let t=r.lang,i=n.checklist_progress||{},a=e.filter(l=>i[l]).length;return o`
          ...
          <li class=${i[l]?"checked":""}>
            <label>
              <input
                type="checkbox"
                .checked=${!!i[l]}
                @change=${c=>r.setChecklistItem(l,c.target.checked)}
              />
              <span>${l}</span>
            </label>
          </li>
  ...
  `}function Ma(n,r){let e=ce(n.documentation_url)?n.documentation_url:null,t=ce(r.objectDocUrl)?r.objectDocUrl:null,i=t?null:(r.objectManualDocs||[])[0];if(!n.notes&&!e&&!t&&!i)return h;let a=r.lang;return o`
    <div class="task-meta-card">
      ...
      ${t?o`
        <div class="task-meta-row task-meta-link">
          ...
          <a href="${t}" target="_blank" rel="noopener noreferrer">${s("documentation_url_label",a)} (${r.objectName})</a>
        </div>
      `:i?o`
        <div class="task-meta-row task-meta-link">
          <ha-icon icon="mdi:book-open-variant"></ha-icon>
  ...
  `}function La(n,r){let e=r.lang,t=n.times_performed>0?n.total_cost/n.times_performed:0,i=n.days_until_due!==null&&n.days_until_due!==void 0?n.days_until_due<0?"overdue":n.days_until_due<=n.warning_days?"warning":"":"";return o`
    <div class="kpi-bar">
      <div class="kpi-card">
        <div class="kpi-label">${s("next_due",e)}</div>
        <div class="kpi-value">${n.next_due?W(n.next_due,e):"\u2014"}</div>
        ${r.features.schedule_time&&n.schedule_time?o`<div class="kpi-subtext">${s("at_time",e)} ${n.schedule_time}</div>`:h}
      </div>
      ...
      <div class="kpi-card">
        ...
        <div class="kpi-value">${tt(n,e)}</div>
      ...
      <div class="kpi-card">
        ...
        <div class="kpi-value">${n.last_performed?W(n.last_performed,e):"\u2014"}</div>
      </div>
      <div class="kpi-card">
        <div class="kpi-label">${s("avg_cost",e)}</div>
        <div class="kpi-value">${t.toFixed(0)} ${r.currencySymbol}</div>
      </div>
      <div class="kpi-card">
  ...
  `}function Ia(n,r){let e=r.lang;if(!r.features.adaptive||!n.suggested_interval||n.suggested_interval===n.interval_days)return h;if(r.suggestionDismissed)return h;let t=n.suggested_interval;return o`
    <div class="recommendation-card">
      <h4>${s("suggested_interval",e)}</h4>
      ${ss(n.interval_days,t,n.interval_confidence||"medium",e)}
      <div class="recommendation-actions">
        <ha-button appearance="filled"
          @click=${()=>r.applySuggestion(t)}>
  ...
  `}function Pa(n,r){let e=r.lang,t=n.history.slice(-3).reverse();if(t.length===0)return h;let i=a=>{switch(a){case"completed":return"\u2713";case"triggered":return"\u2297";case"skipped":return"\u21B7";case"reset":return"\u21BA";default:return"\xB7"}};return o`
    <div class="recent-activities">
      <h3>${s("recent_activities",e)}</h3>
      ${t.map(a=>o`
        <div class="activity-item">
          <span class="activity-icon">${i(a.type)}</span>
          <span class="activity-date">${bt(a.timestamp,e)}</span>
          <span class="activity-note">${a.notes||"\u2014"}</span>
          ${a.cost?o`<span class="activity-badge">${a.cost.toFixed(0)}${r.currencySymbol}</span>`:h}
          ${a.duration?o`<span class="activity-badge">${a.duration}min</span>`:h}
        </div>
      `)}
      <div class="activity-show-all">
        <ha-button appearance="plain" @click=${()=>r.setActiveTab("history")}>${s("show_all",e)} →</ha-button>
      </div>
    </div>
  `}function Oa(n,r){let e=r.lang,t=r.features.adaptive&&n.suggested_interval&&n.suggested_interval!==n.interval_days,i=r.features.seasonal&&n.seasonal_factor&&n.seasonal_factor!==1,a=t||i,l=r.features.adaptive&&n.interval_analysis?.weibull_beta!=null&&n.interval_analysis?.weibull_eta!=null,c=r.features.seasonal&&(n.seasonal_factors?.length===12||n.interval_analysis?.seasonal_factors?.length===12);return o`
    <div class="tab-content overview-tab">
      ${n.battery_fleet_task?o`<maintenance-battery-fleet-section .hass=${r.hass}></maintenance-battery-fleet-section>`:h}
      ${La(n,r)}
      ${Ma(n,r)}
      ${n.battery_fleet_task?h:o`
            ${Qi(n,r.lang)}
            ${Zi(n,r.sparkline)}
            ${ts(n,e,r.features)}
          `}
      <div class="two-column-layout ${a?"":"single-column"}">
        ...
        <div class="right-column">
          ${os(n,e,r.costDurationToggle,d=>r.setCostDurationToggle(d))}
        </div>
      </div>
      ${l?ds("weibull","weibull_reliability_curve",is(n,e),r):h}
      ${c?ds("seasonal","seasonal_chart_title",o`
            ${ns(n,e)}
  ...
  `}function za(n,r){return o`
    <div class="tab-content history-tab">
      ${ls(n,r.history)}
      ${cs(n,r.history)}
    </div>
  `}function Ha(n,r){switch(r.activeTab){case"overview":return Oa(n,r);case"history":return za(n,r);default:return h}}function ps(n,r){return o`
  ...
  `}var ot=class extends S{createRenderRoot(){return this}render(){return!this.task||!this.ctx?h:o`${ps(this.task,this.ctx)}`}};p([b({attribute:!1})],ot.prototype,"task",2),p([b({attribute:!1})],ot.prototype,"ctx",2);customElements.get("maintenance-task-detail-view")||customElements.define("maintenance-task-detail-view",ot);function hs(n){if(n.total<=0)return{start:0,end:0,padTop:0,padBottom:0};let r=n.overscan??12,e=Math.max(1,n.step??6),t=Math.max(1,n.rowHeight),i=Math.floor((n.scrollTop-n.listTop)/t),a=Math.ceil(n.viewportHeight/t)+1,l=Math.max(0,i-r);l=Math.floor(l/e)*e;let c=Math.min(n.total,Math.max(i,0)+a+r);return c=Math.min(n.total,Math.ceil(c/e)*e),l>=c&&(l=Math.min(l,Math.max(0,n.total-1)),c=Math.min(n.total,l+Math.max(a,1))),{start:l,end:c,padTop:l*t,padBottom:(n.total-c)*t}}var T=class extends S{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._filterLabel=null;this._savedViews=[];this._activeViewId="";this._unsub=null;this._chartRangeDays=(()=>{try{let e=parseInt(localStorage.getItem(U.chartRange)||"",10);return[7,30,90,365].includes(e)?e:30}catch{return 30}})();this._hideOutliers=(()=>{try{return localStorage.getItem(U.chartHideOutliers)==="1"}catch{return!1}})();this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._operatorWriteEnabled=!1;this._defaultWarningDays=7;this._actionLoading=!1;this._moreMenuOpen=!1;this._objMenuOpen=!1;this._toastMessage="";this._toastUndo=null;this._toastActionLabel="";this._filtersOpen=!1;this._actionsMenuOpen=!1;this._batteryFleetSetupAvailable=!1;this._staleBundle=!1;this._staleChecked=!1;this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab=(()=>{try{let e=localStorage.getItem(U.overviewTab);return e==="today"||e==="calendar"?e:"dashboard"}catch{return"dashboard"}})();this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._objectViewMode="cards";this._objectsTableColumns=$t;this._showArchived=!1;this._bulkMode=!1;this._bulkSelected=new Set;this._virtStart=0;this._virtEnd=0;this._virtRowHeight=53;this._virtTotalRows=0;this._virtScrollAttached=!1;this._virtRaf=0;this._collapsedSections=(()=>{try{return new Set(JSON.parse(localStorage.getItem(U.collapsedSections)||"[]"))}catch{return new Set}})();this._paletteOpen=!1;this._paletteQuery="";this._paletteActive=0;this._templateGalleryOpen=!1;this._templates=[];this._templateCategories={};this._templateBusy=!1;this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=e=>this._onPopState(e);this._onVirtualScroll=()=>{this._virtRaf||(this._virtRaf=requestAnimationFrame(()=>{this._virtRaf=0,this._updateVirtualWindow()}))};this._deepLinkHandled=!1;this._paletteKeydown=e=>{if(e.key==="/"&&!e.ctrlKey&&!e.metaKey&&!e.altKey&&!this._paletteOpen){let i=e.composedPath()[0];if(i instanceof HTMLElement&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.tagName==="SELECT"||i.isContentEditable))return;e.preventDefault(),this._openPalette();return}if(!this._paletteOpen)return;let t=this._paletteResults;if(e.key==="Escape")e.preventDefault(),this._closePalette();else if(e.key==="ArrowDown")e.preventDefault(),this._paletteActive=Math.min(this._paletteActive+1,t.length-1);else if(e.key==="ArrowUp")e.preventDefault(),this._paletteActive=Math.max(this._paletteActive-1,0);else if(e.key==="Enter"){e.preventDefault();let i=t[this._paletteActive];i&&this._selectPaletteResult(i)}};this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=e=>{let t=e.detail;t?.type==="maintenance-supporter:open-task"&&t.entry_id&&t.task_id&&(e.stopPropagation(),this._showTask(t.entry_id,t.task_id))};this._fullHistory=null;this._onHistoryEntrySaved=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"en"}get _isOperator(){let e=this.hass?.user;return e?e.is_admin?!1:!(this._operatorWriteEnabled&&this._adminPanelUserIds.includes(e.id)):!0}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._popstateHandler),window.addEventListener("keydown",this._paletteKeydown),window.addEventListener("resize",this._onVirtualScroll,{passive:!0});try{let e=localStorage.getItem(U.taskSort);e&&["due_date","object","type","task_name","area","assigned_user","group"].includes(e)&&(this._sortMode=e);let t=localStorage.getItem(U.objectSort);t&&["alphabetical","due_soonest","task_count"].includes(t)&&(this._objectSortMode=t);let i=localStorage.getItem(U.groupBy);i&&["none","area","group","user"].includes(i)&&(this._groupByMode=i);let a=localStorage.getItem(U.objectView);(a==="cards"||a==="table")&&(this._objectViewMode=a)}catch{}if(this._objects.length===0){let e=Ri();e&&(this._objects=e.objects,e.stats&&(this._stats=e.stats))}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),window.removeEventListener("keydown",this._paletteKeydown),window.removeEventListener("resize",this._onVirtualScroll),this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onVirtualScroll),this._virtScrollAttached=!1,this._virtRaf&&cancelAnimationFrame(this._virtRaf),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(e){super.updated(e),e.has("hass")&&ft(this.hass?.locale);let t=this.hass?.language;if(t&&!vt(t)&&K(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Tt(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new ge(this.hass),this._userService.getUsers())}let i=this.shadowRoot?.querySelector(".content");i&&!this._virtScrollAttached&&(i.addEventListener("scroll",this._onVirtualScroll,{passive:!0}),this._virtScrollAttached=!0),this._updateVirtualWindow()}_updateVirtualWindow(){let e=this.shadowRoot?.querySelector(".content"),t=this.shadowRoot?.querySelector(".task-table.virtual");if(!e||!t)return;let i=t.querySelector(".task-row:not(.virt-sizer)");i&&i.offsetHeight>20&&(this._virtRowHeight=i.offsetHeight);let a=t.getBoundingClientRect().top-e.getBoundingClientRect().top+e.scrollTop,l=hs({scrollTop:e.scrollTop,viewportHeight:e.clientHeight,listTop:a,rowHeight:this._virtRowHeight,total:this._virtTotalRows});(l.start!==this._virtStart||l.end!==this._virtEnd)&&(this._virtStart=l.start,this._virtEnd=l.end)}async _loadData(){let[e,t,i,a,l,c]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"}).catch(()=>null)]);if(c&&(this._savedViews=c.views||[]),e&&(this._objects=e.objects,Gt(this._objects,t??this._stats??null)),this._view==="task"&&this._selectedEntryId&&this._selectedTaskId&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/status"}).then(d=>{this._batteryFleetSetupAvailable=!!d.available&&!d.configured}).catch(()=>{this._batteryFleetSetupAvailable=!1}),this._staleChecked||(this._staleChecked=!0,this.hass.connection.sendMessagePromise({type:"maintenance_supporter/version"}).then(d=>{this._staleBundle=Ei(d?.version)}).catch(()=>{})),t&&(this._stats=t),i&&(this._budget=i),a&&(this._groups=a.groups||{}),l){let d=l;this._features=d.features,this._adminPanelUserIds=d.admin_panel_user_ids||[],this._operatorWriteEnabled=d.operator_write_enabled??!1;let u=d.general?.default_warning_days;typeof u=="number"&&u>=0&&u<=365&&(this._defaultWarningDays=u),this._objectsTableColumns=it(d.objects_table_columns)}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search),t=e.get("ms_action"),i=()=>{let g=window.location.pathname+window.location.hash;history.replaceState(history.state,"",g)};if(t==="add_object"){this._deepLinkHandled=!0,i(),requestAnimationFrame(()=>{this.shadowRoot?.querySelector("maintenance-object-dialog")?.openCreate()});return}if(t==="open_vacation"||t==="open_budget"||t==="open_groups"||t==="open_settings"){this._deepLinkHandled=!0,i(),this._overviewTab="settings",requestAnimationFrame(()=>{let g=this.shadowRoot?.querySelector("maintenance-settings-view"),m=t.replace("open_","");g?.scrollToSection?.(m)});return}let a=e.get("entry_id");if(!a)return;this._deepLinkHandled=!0;let l=e.get("task_id"),c=e.get("action"),d=window.location.pathname+window.location.hash;history.replaceState(history.state,"",d);let u=this._getObject(a);if(!u){this._showOverview();return}if(l){let g=u.tasks.find(m=>m.id===l);if(!g){this._showObject(a);return}this._showTask(a,l),c==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(a,l,g.name,this._features.checklists?g.checklist:void 0,this._features.adaptive&&!!g.adaptive_config?.enabled)}):c==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(a,l,g)})}else this._showObject(a)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let i=await this._statsService.getDetailStats(e,t,this._chartRangeDays),a=new Map(this._detailStatsData);a.set(e,i),this._detailStatsData=a}_setChartRange(e){if(e===this._chartRangeDays)return;this._chartRangeDays=e;try{localStorage.setItem(U.chartRange,String(e))}catch{}let t=this._selectedEntryId&&this._selectedTaskId?this._getTask(this._selectedEntryId,this._selectedTaskId):null,i=t?.trigger_config?.entity_id;if(i){let a=new Map(this._detailStatsData);a.delete(i),this._detailStatsData=a,this._fetchDetailStats(i,this._isCounterEntity(t.trigger_config))}}_setHideOutliers(e){if(e!==this._hideOutliers){this._hideOutliers=e;try{localStorage.setItem(U.chartHideOutliers,e?"1":"0")}catch{}}}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=[];for(let i of this._objects)for(let a of i.tasks){let l=a.trigger_config?.entity_id;l&&e.push({entityId:l,isCounter:this._isCounterEntity(a.trigger_config)})}if(e.length===0)return;let t=await this._statsService.getBatchMiniStats(e);this._miniStatsData=new Map([...this._miniStatsData,...t])}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=ki(this._objects,t);i!==null&&(this._objects=i,t.objects&&Gt(i,this._stats??null))},{type:"maintenance_supporter/subscribe",deltas:!0});if(!this.isConnected){e();return}this._unsub=e}catch{}}get _taskRows(){let e=[];for(let m of this._objects)for(let v of m.tasks){if(!this._showArchived&&v.archived||this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let w=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==w)continue}if(this._filterLabel&&!(v.labels||[]).includes(this._filterLabel))continue;let f=[];for(let w of Object.values(this._groups))w.task_refs?.some(x=>x.entry_id===m.entry_id&&x.task_id===v.id)&&f.push(w.name);e.push({entry_id:m.entry_id,task_id:v.id,object_name:m.object.name,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_unit:v.interval_unit??null,interval_anchor:v.interval_anchor??null,is_done:v.is_done??!1,archived:v.archived??!1,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,priority:v.priority??"normal",labels:v.labels??[],area_id:m.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:f})}let t={overdue:0,triggered:1,due_soon:2,ok:3},i=(m,v)=>(t[m.status]??9)-(t[v.status]??9),a=(m,v)=>(m.days_until_due??99999)-(v.days_until_due??99999),l=(m,v)=>i(m,v)||a(m,v),c=m=>m.area_id&&this.hass?.areas?.[m.area_id]?.name||"",d=m=>m.responsible_user_id&&this._userService?.getUserName(m.responsible_user_id)||"",u=m=>m.group_names[0]||"",g={due_date:l,object:(m,v)=>m.object_name.localeCompare(v.object_name)||l(m,v),type:(m,v)=>m.type.localeCompare(v.type)||l(m,v),task_name:(m,v)=>m.task_name.localeCompare(v.task_name),area:(m,v)=>{let f=c(m),w=c(v);return!f&&w?1:f&&!w?-1:f.localeCompare(w)||l(m,v)},assigned_user:(m,v)=>{let f=d(m),w=d(v);return!f&&w?1:f&&!w?-1:f.localeCompare(w)||l(m,v)},group:(m,v)=>{let f=u(m),w=u(v);return!f&&w?1:f&&!w?-1:f.localeCompare(w)||l(m,v)}};return e.sort(g[this._sortMode]),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(a=>a.id===t)}_pushPanelState(e,t,i){let a={msp_view:e,msp_entry:t||null,msp_task:i||null};history.pushState(a,"")}_onPopState(e){let t=e.state;if(t?.msp_view&&(this._view=t.msp_view,this._selectedEntryId=t.msp_entry||null,this._selectedTaskId=t.msp_task||null,this._moreMenuOpen=!1,t.msp_view==="task"&&t.msp_entry&&t.msp_task)){this._historyFilter=null;let i=this._getTask(t.msp_entry,t.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop()}_filterByStatus(e){this._filterStatus=e,this._activeViewId="",this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),this._scrollContentToTop()}get _allLabels(){let e=new Set;for(let t of this._objects)for(let i of t.tasks)for(let a of i.labels||[])e.add(a);return[...e].sort((t,i)=>t.localeCompare(i))}get _currentFilters(){return{status:this._filterStatus,user_id:this._filterUser,label:this._filterLabel,archived:this._showArchived,sort_mode:this._sortMode,group_by:this._groupByMode}}_applyView(e){if(this._activeViewId=e,!e)return;let t=this._savedViews.find(a=>a.id===e);if(!t)return;let i=t.filters;this._filterStatus=i.status||"",this._filterUser=i.user_id||null,this._filterLabel=i.label||null,this._showArchived=!!i.archived,["due_date","object","type","task_name","area","assigned_user","group"].includes(i.sort_mode)&&(this._sortMode=i.sort_mode),["none","area","group","user"].includes(i.group_by)&&(this._groupByMode=i.group_by);try{localStorage.setItem(U.taskSort,this._sortMode),localStorage.setItem(U.groupBy,this._groupByMode)}catch{}this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard")}_openSavedViewsDialog(){this.shadowRoot.querySelector("maintenance-saved-views-dialog")?.open(this._currentFilters,this._savedViews)}_onSavedViewsChanged(e){this._savedViews=e.detail.views||[],this._activeViewId&&!this._savedViews.some(t=>t.id===this._activeViewId)&&(this._activeViewId="")}_scrollContentToTop(){requestAnimationFrame(()=>{let e=this.shadowRoot?.querySelector(".content");e&&e.scrollTo({top:0,behavior:"smooth"})})}_showObject(e){this._pushPanelState("object",e),this._view="object",this._selectedEntryId=e,this._selectedTaskId=null,this._scrollContentToTop()}_showTask(e,t){this._pushPanelState("task",e,t),this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._activeTab="overview",this._historyFilter=null,this._scrollContentToTop(),this._fetchFullHistory(e,t);let i=this._getTask(e,t);if(i?.trigger_config?.entity_id){let a=i.trigger_config.entity_id,l=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(a,l)}}_showToast(e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastUndo=null,this._toastActionLabel="",this._toastMessage=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}_showActionToast(e,t,i){this._showUndoToast(e,i),this._toastActionLabel=t}_showUndoToast(e,t){this._toastTimer&&clearTimeout(this._toastTimer),this._toastActionLabel="",this._toastMessage=e,this._toastUndo=t,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastUndo=null,this._toastTimer=null},7e3)}_runToastUndo(){let e=this._toastUndo;this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage="",this._toastUndo=null,this._toastTimer=null,e?.()}_openPalette(){this._paletteQuery="",this._paletteActive=0,this._paletteOpen=!0,this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".palette-input")?.focus()})}_closePalette(){this._paletteOpen=!1,this._paletteQuery=""}get _paletteResults(){let e=this._paletteQuery.trim().toLowerCase(),t=[];for(let i of this._objects){let a=i.object.name||"";(!e||a.toLowerCase().includes(e))&&t.push({kind:"object",entryId:i.entry_id,label:a,sub:s("object",this._lang)});for(let l of i.tasks){if(l.archived)continue;let c=l.name||"",d=(l.labels||[]).some(u=>u.toLowerCase().includes(e));if(!e||c.toLowerCase().includes(e)||a.toLowerCase().includes(e)||d){let u=(l.labels||[]).length?`  #${(l.labels||[]).join(" #")}`:"";t.push({kind:"task",entryId:i.entry_id,taskId:l.id,label:c,sub:a+u})}}if(t.length>60)break}return t.slice(0,40)}_selectPaletteResult(e){this._closePalette(),e.kind==="task"&&e.taskId?this._showTask(e.entryId,e.taskId):this._showObject(e.entryId)}_renderPalette(){if(!this._paletteOpen)return h;let e=this._lang,t=this._paletteResults;return o`
    ...
    `}_statusBadge(e,t,i){let a=this._lang,l=e?"archived":t?"done":i,c=e?"archived":t?"completed":i,d=e?s("archived",a):t?s("completed",a):s(i,a);return o`<span class="status-badge ${l}"><ha-icon icon="${Je[c]||"mdi:circle-medium"}"></ha-icon>${d}</span>`}_setOverviewTab(e){this._overviewTab=e;try{localStorage.setItem(U.overviewTab,e)}catch{}this._scrollContentToTop()}_renderToday(){let e=this._lang,t=this._taskRows,i=u=>`${u.entry_id}:${u.task_id}`,a=t.filter(u=>u.status==="overdue"||u.trigger_active),l=new Set(a.map(i)),c=t.filter(u=>!l.has(i(u))&&u.days_until_due===0);c.forEach(u=>l.add(i(u)));let d=t.filter(u=>!l.has(i(u))&&u.days_until_due!=null&&u.days_until_due>0&&u.days_until_due<=7);return a.length+c.length+d.length===0?o`
    ...
    `}_renderTodaySection(e,t,i){if(t.length===0)return h;let a=this._lang;return o`
        ...
        ${t.map(l=>o`
          <div class="today-row" @click=${()=>this._showTask(l.entry_id,l.task_id)}>
            ...
            <div class="today-main">
              ...
              <div class="today-object">${l.object_name} · ${Te(l.days_until_due,a)}</div>
            </div>
    ...
    `}_renderDashboard(){let e=this._stats,t=this._taskRows,i=this._lang,a=this._isOperator,l=this._objects.reduce((d,u)=>d+u.tasks.filter(g=>g.archived).length,0),c=(this._filterStatus?1:0)+(this._filterUser?1:0)+(this._filterLabel?1:0)+(this._activeViewId?1:0);return o`
      ...
      <div class="filter-bar ${this.narrow&&!this._filtersOpen?"collapsed":""}">
        ...
        <label class="filter-field">
          ...
          <select
            ...
            @change=${d=>{let u=d.target.value;this._filterUser=u||null,this._activeViewId=""}}
          >
        ...
        ${this._allLabels.length>0?o`
          <label class="filter-field">
            ...
            <select
              ...
              @change=${d=>{let u=d.target.value;this._filterLabel=u||null,this._activeViewId=""}}
            >
        ...
        <label class="filter-field">
          ...
          <select
            ...
            @change=${d=>{this._sortMode=d.target.value,this._activeViewId="";try{localStorage.setItem(U.taskSort,this._sortMode)}catch{}}}
          >
        ...
        <label class="filter-field">
          ...
          <select
            ...
            @change=${d=>{this._groupByMode=d.target.value,this._activeViewId="";try{localStorage.setItem(U.groupBy,this._groupByMode)}catch{}}}
          >
      ...
      ${a?h:o`
        <div
          ...
          @click=${()=>{this.narrow&&(this._actionsMenuOpen=!1)}}
        >
          <ha-button
          ...
          <ha-button @click=${()=>this._openSuggestedSetups()}>
            <ha-icon icon="mdi:auto-fix"></ha-icon> ${s("setups_button",i)}
          </ha-button>
          ${this._batteryFleetSetupAvailable?o`
            <ha-button @click=${()=>this._setupBatteryFleet()}>
              <ha-icon icon="mdi:battery-sync"></ha-icon> ${s("battery_fleet_setup_button",i)}
            </ha-button>
          `:h}
        </div>
      `}
      ...
      ${a?h:o`<maintenance-storage-section-card
            .hass=${this.hass}
            .objects=${this._objects}
            @open-object=${d=>{let u=d.detail?.entry_id;u&&this._showObject(u)}}
    ...
    `}_renderTaskTable(e){let t=this._bulkMode?" bulk":"";if(this._virtTotalRows=e.length,this.narrow||e.length<120)return o`
      ...
      `;let i=e.length,a=this._virtRowHeight,l=Math.max(0,Math.min(this._virtStart,i)),c=this._virtEnd>0?Math.min(this._virtEnd,i):Math.min(i,40);c<l&&(l=0,c=Math.min(i,40));let d=l*a,u=(i-c)*a;return o`
      <div class="task-table${t} virtual">
        ${this._renderVirtSizerRow(e)}
        ${d>0?o`<div class="virt-spacer" style="height:${d}px"></div>`:h}
        ${e.slice(l,c).map(g=>this._renderOverviewRow(g))}
        ${u>0?o`<div class="virt-spacer" style="height:${u}px"></div>`:h}
      </div>
    `}_renderVirtSizerRow(e){let t=this._lang,i="",a=!1,l=!1,c=!1;for(let d of e){let u=d.archived?s("archived",t):d.is_done?s("completed",t):s(d.status,t);u.length>i.length&&(i=u),d.enabled||(a=!0),d.nfc_tag_id&&(l=!0),(d.priority==="high"||d.priority==="low")&&(c=!0)}return o`
      <div class="task-row virt-sizer" aria-hidden="true">
        ...
        <span class="cell-badges">
          ...
          ${l?o`<span class="nfc-badge"><ha-icon icon="mdi:nfc-variant"></ha-icon></span>`:h}
    ...
    `}_renderGroupedTasks(e,t){let i=new Map,a=s("unassigned",t);for(let d of e){let u=[];this._groupByMode==="area"?u=[(d.area_id?this.hass?.areas?.[d.area_id]?.name:null)||a]:this._groupByMode==="user"?u=[(d.responsible_user_id?this._userService?.getUserName(d.responsible_user_id):null)||a]:this._groupByMode==="group"&&(u=d.group_names.length>0?d.group_names:[a]);for(let g of u)i.has(g)||i.set(g,[]),i.get(g).push(d)}let l=[...i.entries()].sort(([d],[u])=>d===a&&u!==a?1:u===a&&d!==a?-1:d.localeCompare(u)),c=this._groupByMode==="area"?"mdi:map-marker-outline":this._groupByMode==="group"?"mdi:folder-outline":"mdi:account-outline";return o`
      ...
      `)}
    `}_warrantyLabel(e,t,i){return e.kind==="expired"?s("warranty_expired",i):e.kind==="expiring"?s("warranty_expires_in",i).replace("{days}",String(e.days??0)):s("warranty_valid_until",i).replace("{date}",W(t,i))}_renderWarrantyMeta(e,t){let i=Jt(e);return o`<p class="meta">${s("warranty",t)}:
      <span class="warranty-chip warranty-${i.kind}">${this._warrantyLabel(i,e,t)}</span></p>`}_renderAllObjects(){let e=this._lang,t=this._isOperator,i=this._objectViewMode==="table"&&!this.narrow,a=this._objects.filter(g=>g.object.archived).length,l=g=>{let m=1/0;for(let v of g.tasks){let f=v.days_until_due;f!=null&&f<m&&(m=f)}return m},c=this._objects.filter(g=>this._showArchived||!g.object.archived);this._objectSortMode==="alphabetical"?c.sort((g,m)=>g.object.name.localeCompare(m.object.name)):this._objectSortMode==="task_count"?c.sort((g,m)=>m.tasks.length-g.tasks.length||g.object.name.localeCompare(m.object.name)):c.sort((g,m)=>l(g)-l(m)||g.object.name.localeCompare(m.object.name));let d=()=>{let g=new Map;for(let m of c){let v=m.object.area_id,f=v?this.hass?.areas?.[v]?.name||s("unassigned",e):s("no_area",e);g.has(f)||g.set(f,[]),g.get(f).push(m)}return new Map([...g.entries()].sort(([m],[v])=>m.localeCompare(v)))},u=g=>{let m=g.tasks.some(v=>v.status==="overdue"||v.status==="triggered");return o`
        <div class="object-card${m?" object-card-overdue":""}" @click=${()=>this._showObject(g.entry_id)}>
          ${m?o`<span class="overdue-dot" title="${s("has_overdue",e)}"></span>`:h}
          ...
          ${g.tasks.length===0?o`<div class="object-card-empty">${s("no_tasks_yet",e)}</div>`:h}
        </div>
      `};return o`
      ...
      <div class="filter-bar">
        <label class="filter-field">
          ...
          <select
            ...
            @change=${g=>{this._objectSortMode=g.target.value,localStorage.setItem(U.objectSort,this._objectSortMode)}}
          >
        ...
        <label class="filter-field">
          ...
          <select
            .value=${this._groupByMode}
            @change=${g=>{this._groupByMode=g.target.value;try{localStorage.setItem(U.groupBy,this._groupByMode)}catch{}}}
          >
    ...
    `}_setObjectViewMode(e){this._objectViewMode=e,localStorage.setItem(U.objectView,e)}async _exportObjectsCsv(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects/csv"}),t=new Date().toISOString().slice(0,10);kt(e.csv,`maintenance_objects_${t}.csv`,"text/csv;charset=utf-8")}catch{this._showToast(s("action_error",this._lang))}}_renderObjectsTable(e){let t=this._lang,i=this._objectsTableColumns;return o`
      <div class="objects-table-wrap">
        <table class="objects-table">
          <thead>
            <tr>
              ${i.map(a=>{let l=ze.find(d=>d.key===a),c=l&&l.key!=="actions"?s(l.labelKey,t):"";return o`<th class="oc-${a}">${c}</th>`})}
            </tr>
          </thead>
          <tbody>
            ${e.map(a=>o`
    ...
    `}_openGroupCreate(){this.shadowRoot.querySelector("maintenance-group-dialog")?.openCreate()}_openGroupEdit(e){let t=this._groups[e];t&&this.shadowRoot.querySelector("maintenance-group-dialog")?.openEdit(e,t)}async _deleteGroup(e,t){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(i?await i.confirm({title:s("delete_group",this._lang),message:s("delete_group_confirm",this._lang).replace("{name}",t),confirmText:s("delete",this._lang)}):confirm(`${s("delete_group_confirm",this._lang).replace("{name}",t)}`))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/group/delete",group_id:e}),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}}_renderBudgetBar(){let e=this._budget;if(!e)return h;let t=this._lang,i=e.currency_symbol||Ee,a=[];e.monthly_budget>0&&a.push({label:s("budget_monthly",t),spent:e.monthly_spent,budget:e.monthly_budget}),e.yearly_budget>0&&a.push({label:s("budget_yearly",t),spent:e.yearly_spent,budget:e.yearly_budget});let l=[];return e.monthly_budget>0||l.push({label:s("budget_monthly",t),spent:e.monthly_spent||0}),e.yearly_budget>0||l.push({label:s("budget_yearly",t),spent:e.yearly_spent||0}),o`
      <div class="budget-bars">
        ${a.map(c=>{let d=Math.min(100,Math.max(0,c.spent/c.budget*100)),u=d>=100?"var(--error-color, #f44336)":d>=e.alert_threshold_pct?"var(--warning-color, #ff9800)":"var(--success-color, #4caf50)";return o`
            <div class="budget-item">
              ...
              <div class="budget-bar">
                <div class="budget-bar-fill" style="width:${d}%; background:${u}"></div>
              </div>
            </div>
          `})}
        ${l.map(c=>o`
    ...
    `}_renderOverviewRow(e){let t=this._lang,i=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,a=0,l=Qe.ok,c=!1;if(i&&e.days_until_due!==null){let v=wt(e.interval_days,e.days_until_due,e.interval_unit);a=v.pct,c=v.overflow,e.status==="overdue"?l=Qe.overdue:e.status==="due_soon"&&(l=Qe.due_soon)}let d=e.area_id?this.hass?.areas?.[e.area_id]?.name:null,u=e.responsible_user_id?this._userService?.getUserName(e.responsible_user_id):null,g=e.group_names.length>0||d||u,m=this._bulkMode&&this._bulkSelected.has(this._bulkKey(e));return o`
      <div class="task-row${e.enabled?"":" task-disabled"}${m?" bulk-selected":""}">
        ...
        <span class="due-cell" @click=${()=>this._showTask(e.entry_id,e.task_id)}>
          ...
          ${e.trigger_config?ii(e):!i&&e.trigger_active?o`<span style="color:var(--maint-triggered-color);font-weight:600">⚡</span>`:h}
          ${si(e,this._miniStatsData,this._lang)}
        </span>
    ...
    `}_openCompleteDialogForRow(e){let i=this._objects.find(a=>a.entry_id===e.entry_id)?.tasks.find(a=>a.id===e.task_id);this._openCompleteDialog(e.entry_id,e.task_id,e.task_name,this._features.checklists?i?.checklist:void 0,this._features.adaptive&&!!i?.adaptive_config?.enabled)}_renderObjectDetail(){if(!this._selectedEntryId)return h;let e=this._getObject(this._selectedEntryId);if(!e)return o`<p>Object not found.</p>`;let t=e.object,i=this._lang,a=this._isOperator,l=e.tasks.filter(d=>d.archived).length,c=e.tasks.filter(d=>this._showArchived||!d.archived);return o`
      <div class="detail-section">
        <div class="detail-header">
          ...
          <div class="action-buttons">
            ...
            <div class="more-menu-wrapper">
              ...
              ${this._objMenuOpen?o`
                <div class="popup-menu" @click=${d=>d.stopPropagation()}>
                  ...
                  ${a?h:o`
                    ...
                    ${t.archived?h:o`
                      ...
                      <div class="popup-menu-item" @click=${()=>{this._closeObjMenu(),this._replaceObject(e.entry_id,t.name)}}>${s("replace_object",i)}</div>
                    `}
        ...
        ${t.paused?o`<p class="meta paused-meta">
              <ha-icon icon="mdi:pause-circle-outline"></ha-icon>
              ${s("object_paused_badge",i)}${t.paused_until?o` — ${s("paused_until_label",i)} ${W(t.paused_until,i)}`:h}
            </p>`:h}
        ...
        ${ce(t.documentation_url)?o`<p class="meta">${s("documentation_url_label",i)}:
              <a href=${t.documentation_url} target="_blank" rel="noopener noreferrer">${t.documentation_url}</a>
                ...
                ${t.manual_docs.slice(0,3).map((d,u)=>o`${u>0?" \xB7 ":""}<a href="#"
                    @click=${g=>{g.preventDefault(),this._openManualDoc(d)}}>${d.title}</a>`)}${t.manual_docs.length>3?o` … +${t.manual_docs.length-3}`:h}
              </p>`:h}
        ${t.installation_date?o`<p class="meta">${s("installed",i)}: ${W(t.installation_date,i)}</p>`:h}
        ...
        ${e.tasks.length===0?o`<div class="empty-state-centered">
              ...
              <div class="task-row${d.enabled?"":" task-disabled"}">
                <span class="cell-badges">
                  ...
                  ${d.document_count?o`<span class="doc-badge" title="${d.document_count} ${s("documents",i)}"><ha-icon icon="mdi:paperclip"></ha-icon>${d.document_count}</span>`:h}
                </span>
                <span class="cell task-name" @click=${()=>this._showTask(e.entry_id,d.id)}>${d.name}</span>
                <span class="task-sub${d.responsible_user_id?"":" task-sub-empty"}">${ni(d,u=>this._userService?.getUserName(u)??null)}</span>
                ...
                <span class="due-cell" @click=${()=>this._showTask(e.entry_id,d.id)}>
                  ...
                  ${d.trigger_config?ii(d):h}
                  ${si(d,this._miniStatsData,this._lang)}
                </span>
                <span class="row-actions">
                  <mwc-icon-button class="btn-complete" title="${s("complete",i)}" @click=${u=>{u.stopPropagation(),this._openCompleteDialog(e.entry_id,d.id,d.name,this._features.checklists?d.checklist:void 0,this._features.adaptive&&!!d.adaptive_config?.enabled)}}>
                    <ha-icon icon="mdi:check"></ha-icon>
                  </mwc-icon-button>
                  <mwc-icon-button class="btn-skip" title="${s("skip",i)}" .disabled=${this._actionLoading} @click=${u=>{u.stopPropagation(),this._promptSkipTask(e.entry_id,d.id)}}>
                    <ha-icon icon="mdi:skip-next"></ha-icon>
                  </mwc-icon-button>
                </span>
              </div>
        ...
        <maintenance-parts-section
          ...
          .parts=${e.parts||[]}
          .canWrite=${!a}
          .currencySymbol=${this._budget?.currency_symbol||Ee}
          @parts-changed=${()=>this._loadData()}
        ></maintenance-parts-section>
      </div>
    `}_toggleObjMenu(){this._objMenuOpen=!this._objMenuOpen,this._objMenuOpen&&setTimeout(()=>{let e=()=>{this._objMenuOpen=!1,document.removeEventListener("click",e)};document.addEventListener("click",e)},0)}_closeObjMenu(){this._objMenuOpen=!1}_toggleMoreMenu(){if(this._moreMenuOpen=!this._moreMenuOpen,this._moreMenuOpen){let e=()=>{this._moreMenuOpen=!1,document.removeEventListener("click",e)};setTimeout(()=>document.addEventListener("click",e,{once:!0}),0)}}_closeMoreMenu(){this._moreMenuOpen=!1}get _sparklineCtx(){return{lang:this._lang,detailStatsData:this._detailStatsData,hasStatsService:!!this._statsService,isCounterEntity:e=>this._isCounterEntity(e),rangeDays:this._chartRangeDays,setRangeDays:e=>this._setChartRange(e),hideOutliers:this._hideOutliers,setHideOutliers:e=>this._setHideOutliers(e)}}_toggleSection(e){let t=new Set(this._collapsedSections);t.has(e)?t.delete(e):t.add(e),this._collapsedSections=t;try{localStorage.setItem(U.collapsedSections,JSON.stringify([...t]))}catch{}}_historyCtx(){let e=this._selectedEntryId&&this._selectedTaskId?this._getObject(this._selectedEntryId)?.tasks.find(l=>l.id===this._selectedTaskId):void 0,t=this._fullHistory,a=(t&&t.entryId===this._selectedEntryId&&t.taskId===this._selectedTaskId&&t.entries.length>(e?.history||[]).length?t.entries:e?.history||[]).filter(l=>l.reading_value!=null).sort((l,c)=>l.timestamp.localeCompare(c.timestamp));return{lang:this._lang,hass:this.hass,filter:this._historyFilter,search:this._historySearch,currencySymbol:this._budget?.currency_symbol||Ee,setFilter:l=>{this._historyFilter=l},setSearch:l=>{this._historySearch=l},openEdit:l=>this._openHistoryEdit(l),readingUnit:e?.reading_unit??null,readingDelta:l=>{let c=a.findIndex(d=>d.timestamp===l.timestamp);return c<=0?null:l.reading_value-a[c-1].reading_value}}}_taskDetailCtx(){let e=this._selectedEntryId,t=this._selectedTaskId,i=this._getObject(e);return{lang:this._lang,hass:this.hass,entryId:e,taskId:t,objectName:i?.object.name||"",objectDocUrl:i?.object?.documentation_url??null,objectManualDocs:i?.object?.manual_docs??[],openManualDoc:a=>this._openManualDoc(a),setChecklistItem:(a,l)=>this._setChecklistItem(e,t,a,l),isOperator:this._isOperator,actionLoading:this._actionLoading,moreMenuOpen:this._moreMenuOpen,activeTab:this._activeTab,features:this._features,currencySymbol:this._budget?.currency_symbol||Ee,collapsedSections:this._collapsedSections,costDurationToggle:this._costDurationToggle,suggestionDismissed:this._dismissedSuggestions.has(`${e}_${t}`),sparkline:this._sparklineCtx,history:this._historyCtx(),getUserName:a=>this._userService?.getUserName(a)??null,setActiveTab:a=>{this._activeTab=a},toggleSection:a=>this._toggleSection(a),setCostDurationToggle:a=>{this._costDurationToggle=a},showTaskView:()=>{this._view="task"},showObject:()=>this._showObject(e),toggleMoreMenu:()=>this._toggleMoreMenu(),closeMoreMenu:()=>this._closeMoreMenu(),openEdit:a=>{this.shadowRoot.querySelector("maintenance-task-dialog")?.openEdit(e,a)},openComplete:a=>this._openCompleteDialog(e,t,a.name,this._features.checklists?a.checklist:void 0,this._features.adaptive&&!!a.adaptive_config?.enabled),promptSkip:()=>this._promptSkipTask(e,t),toggleArchive:a=>this._toggleArchiveTask(e,t,a),openQr:a=>this._openQrForTask(e,t,i?.object.name||"",a),duplicateTask:()=>this._duplicateTask(e,t),promptReset:()=>this._promptResetTask(e,t),promptPostpone:()=>this._promptPostponeTask(e,t),snoozeTask:()=>this._snoozeTask(e,t),printWorksheet:()=>this._printTaskWorksheet(e,t),deleteTask:()=>this._deleteTask(e,t),applySuggestion:a=>this._applySuggestion(e,t,a),reanalyze:()=>this._reanalyzeInterval(e,t),dismissSuggestion:()=>this._dismissSuggestion(e,t),openSeasonalOverrides:a=>this._openSeasonalOverrides(a)}}async _fetchFullHistory(e,t){try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/history",entry_id:e,task_id:t});this._selectedEntryId===e&&this._selectedTaskId===t&&(this._fullHistory={entryId:e,taskId:t,entries:i.history||[]})}catch{this._fullHistory=null}}_renderTaskDetail(){if(!this._selectedEntryId||!this._selectedTaskId)return h;let e=this._getTask(this._selectedEntryId,this._selectedTaskId);if(!e)return o`<p>Task not found.</p>`;let t=this._fullHistory,i=t&&t.entryId===this._selectedEntryId&&t.taskId===this._selectedTaskId&&t.entries.length>(e.history||[]).length?{...e,history:t.entries}:e;return o`<maintenance-task-detail-view
      .task=${i}
      .ctx=${this._taskDetailCtx()}
    ></maintenance-task-detail-view>`}_openHistoryEdit(e){if(!this._selectedEntryId||!this._selectedTaskId)return;let t={entry_id:this._selectedEntryId,task_id:this._selectedTaskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null};this.shadowRoot?.querySelector("maintenance-history-edit-dialog")?.openEdit(t)}};T.styles=[xt,Oi],p([b({attribute:!1})],T.prototype,"hass",2),p([b({type:Boolean,reflect:!0})],T.prototype,"narrow",2),p([b({attribute:!1})],T.prototype,"panel",2),p([_()],T.prototype,"_objects",2),p([_()],T.prototype,"_stats",2),p([_()],T.prototype,"_view",2),p([_()],T.prototype,"_selectedEntryId",2),p([_()],T.prototype,"_selectedTaskId",2),p([_()],T.prototype,"_filterStatus",2),p([_()],T.prototype,"_filterUser",2),p([_()],T.prototype,"_filterLabel",2),p([_()],T.prototype,"_savedViews",2),p([_()],T.prototype,"_activeViewId",2),p([_()],T.prototype,"_unsub",2),p([_()],T.prototype,"_chartRangeDays",2),p([_()],T.prototype,"_hideOutliers",2),p([_()],T.prototype,"_historyFilter",2),p([_()],T.prototype,"_budget",2),p([_()],T.prototype,"_groups",2),p([_()],T.prototype,"_detailStatsData",2),p([_()],T.prototype,"_miniStatsData",2),p([_()],T.prototype,"_features",2),p([_()],T.prototype,"_adminPanelUserIds",2),p([_()],T.prototype,"_operatorWriteEnabled",2),p([_()],T.prototype,"_defaultWarningDays",2),p([_()],T.prototype,"_actionLoading",2),p([_()],T.prototype,"_moreMenuOpen",2),p([_()],T.prototype,"_objMenuOpen",2),p([_()],T.prototype,"_toastMessage",2),p([_()],T.prototype,"_toastUndo",2),p([_()],T.prototype,"_toastActionLabel",2),p([_()],T.prototype,"_filtersOpen",2),p([_()],T.prototype,"_actionsMenuOpen",2),p([_()],T.prototype,"_batteryFleetSetupAvailable",2),p([_()],T.prototype,"_staleBundle",2),p([_()],T.prototype,"_overviewTab",2),p([_()],T.prototype,"_activeTab",2),p([_()],T.prototype,"_costDurationToggle",2),p([_()],T.prototype,"_historySearch",2),p([_()],T.prototype,"_sortMode",2),p([_()],T.prototype,"_objectSortMode",2),p([_()],T.prototype,"_groupByMode",2),p([_()],T.prototype,"_objectViewMode",2),p([_()],T.prototype,"_objectsTableColumns",2),p([_()],T.prototype,"_showArchived",2),p([_()],T.prototype,"_bulkMode",2),p([_()],T.prototype,"_bulkSelected",2),p([_()],T.prototype,"_virtStart",2),p([_()],T.prototype,"_virtEnd",2),p([_()],T.prototype,"_collapsedSections",2),p([_()],T.prototype,"_paletteOpen",2),p([_()],T.prototype,"_paletteQuery",2),p([_()],T.prototype,"_paletteActive",2),p([_()],T.prototype,"_templateGalleryOpen",2),p([_()],T.prototype,"_templates",2),p([_()],T.prototype,"_templateCategories",2),p([_()],T.prototype,"_templateBusy",2),p([_()],T.prototype,"_fullHistory",2),T=p([Ti("maintenance-supporter-panel")],T);export{T as MaintenanceSupporterPanel};
