...
`;var Et=class{constructor(r){this._cache=new Map;this._pending=new Map;this._hass=r}updateHass(r){this._hass=r}async getDetailStats(r,e,t=30){return this._getStats(r,t<=35?"hour":"day",t,e)}async getMiniStats(r,e){return this._getStats(r,"day",14,e)}async getBatchMiniStats(r){let e=new Map,t=[];for(let d of r){let u=`${d.entityId}:day:14`,g=this._cache.get(u);g&&Date.now()-g.fetchedAt<3e5?e.set(d.entityId,g.points):t.push(d)}if(t.length===0)return e;let i=t.filter(d=>d.isCounter).map(d=>d.entityId),a=t.filter(d=>!d.isCounter).map(d=>d.entityId),l=new Date(Date.now()-336*60*60*1e3).toISOString(),c=[];return i.length>0&&c.push(this._fetchBatch(i,"day",l,["state","sum","change"],!0,e)),a.length>0&&c.push(this._fetchBatch(a,"day",l,["mean","min","max"],!1,e)),await Promise.all(c),e}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(r,e,t,i){let a=`${r}:${e}:${t}`,l=this._cache.get(a);if(l&&Date.now()-l.fetchedAt<3e5)return l.points;if(this._pending.has(a))return this._pending.get(a);let c=this._fetchAndNormalize(r,e,t,i,a);this._pending.set(a,c);try{return await c}finally{this._pending.delete(a)}}async _fetchAndNormalize(r,e,t,i,a){let l=new Date(Date.now()-t*24*60*60*1e3).toISOString(),c=i?["state","sum","change"]:["mean","min","max"];try{let u=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:l,statistic_ids:[r],period:e,types:c}))[r]||[],g=this._normalizeRows(u,i);return this._cache.set(a,{entityId:r,fetchedAt:Date.now(),period:e,points:g}),g}catch(d){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${r}:`,d),[]}}async _fetchBatch(r,e,t,i,a,l){try{let c=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:t,statistic_ids:r,period:e,types:i});for(let d of r){let u=c[d]||[],g=this._normalizeRows(u,a);l.set(d,g),this._cache.set(`${d}:${e}:14`,{entityId:d,fetchedAt:Date.now(),period:e,points:g})}}catch(c){console.warn("[maintenance-supporter] Batch statistics fetch failed:",c)}}_normalizeRows(r,e){let t=[];for(let i of r){let a=null;if(e?a=i.state??null:a=i.mean??null,a===null)continue;let l={ts:i.start,val:a};e||(i.min!=null&&(l.min=i.min),i.max!=null&&(l.max=i.max)),t.push(l)}return t.sort((i,a)=>i.ts-a.ts),t}};var _e=class{constructor(r){this.usersCache=null;this.cacheTimestamp=0;this.CACHE_TTL_MS=6e4;this.hass=r}updateHass(r){this.hass=r}async getUsers(r=!1){let e=Date.now();if(!r&&this.usersCache&&e-this.cacheTimestamp<this.CACHE_TTL_MS)return this.usersCache;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/users/list"});return this.usersCache=t.users,this.cacheTimestamp=e,this.usersCache}catch(t){return console.error("Failed to fetch users:",t),this.usersCache||[]}}async assignUser(r,e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/assign_user",entry_id:r,task_id:e,user_id:t})}async getTasksByUser(r){return(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tasks/by_user",user_id:r})).tasks}getUserName(r){return!r||!this.usersCache?null:this.usersCache.find(t=>t.id===r)?.name||null}getUser(r){return!r||!this.usersCache?null:this.usersCache.find(e=>e.id===r)||null}getCurrentUserId(){return this.hass.user?.id||null}isCurrentUser(r){return r?r===this.getCurrentUserId():!1}clearCache(){this.usersCache=null,this.cacheTimestamp=0}};var X=class extends S{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return o`
  ...
  `,p([b({attribute:!1})],B.prototype,"hass",2),p([b({attribute:!1})],B.prototype,"objects",2),p([_()],B.prototype,"_open",2),p([_()],B.prototype,"_loading",2),p([_()],B.prototype,"_error",2),p([_()],B.prototype,"_name",2),p([_()],B.prototype,"_manufacturer",2),p([_()],B.prototype,"_model",2),p([_()],B.prototype,"_serialNumber",2),p([_()],B.prototype,"_areaId",2),p([_()],B.prototype,"_installationDate",2),p([_()],B.prototype,"_warrantyExpiry",2),p([_()],B.prototype,"_documentationUrl",2),p([_()],B.prototype,"_notes",2),p([_()],B.prototype,"_haDeviceId",2),p([_()],B.prototype,"_parentEntryId",2),p([_()],B.prototype,"_entryId",2);customElements.get("maintenance-object-dialog")||customElements.define("maintenance-object-dialog",B);function ge(n){let r=n??0;return r<1024?`${r} B`:r<1024*1024?`${(r/1024).toFixed(1)} KB`:`${(r/(1024*1024)).toFixed(1)} MB`}var Tt=["manual","warranty","invoice","spare_parts","photo","other"],zs={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"},U=class extends S{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._hint="";this._addingLink=!1;this._linkUrl="";this._linkTitle="";this._category="manual";this._thumbs={};this._lightboxUrl="";this._editingId="";this._editTitle="";this._editCategory="manual";this._dragOver=!1;this._loadedFor=null;this._localeReady=!1}_isImage(e){return e.kind==="file"&&(e.mime||"").startsWith("image/")}async _sign(e){return(await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:300})).path}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),this.hass&&!this._localeReady&&(this._localeReady=!0,W(this._lang).then(()=>this.requestUpdate())),this.hass&&this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=e.documents||[],this._loaded=!0,this._error="",this._thumbs={},this._loadThumbs()}catch(e){this._error=A(e,this._lang),this._loaded=!0}}async _loadThumbs(){await Promise.all(this._docs.filter(e=>this._isImage(e)).map(async e=>{try{let t=await this._sign(e);this._thumbs={...this._thumbs,[e.id]:t}}catch{}}))}_category_of(e){return(e.tags||[]).find(i=>Tt.includes(i))||"other"}_labelKeydown(e){(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),e.currentTarget.querySelector("input")?.click())}_onFileInput(e){let t=e.target,i=Array.from(t.files??[]);i.length&&this._uploadFiles(i),t.value=""}_onCameraInput(e){let t=e.target,i=Array.from(t.files??[]);i.length&&this._uploadFiles(i,"photo"),t.value=""}_onDrop(e){if(e.preventDefault(),this._dragOver=!1,!this.canWrite||this._busy)return;let t=Array.from(e.dataTransfer?.files??[]);t.length&&this._uploadFiles(t)}_onDragOver(e){this.canWrite&&(e.preventDefault(),this._dragOver=!0)}_onDragLeave(e){let t=e.relatedTarget;(!t||!e.currentTarget.contains(t))&&(this._dragOver=!1)}async _uploadFiles(e,t){let i=t??this._category;this._busy=!0,this._error="",this._hint="";let a=0,l=0;try{for(let c of e){let d=new FormData;d.append("entry_id",this.entryId),d.append("tags",i),d.append("file",c,c.name);let u=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:d});if(!u.ok){this._error=u.status===413?s("doc_too_large",this._lang):s("doc_upload_failed",this._lang);continue}let g=await u.json();g.duplicate_in_object?l++:g.deduped&&a++}l?this._hint=s("doc_dup_in_object",this._lang):a&&(this._hint=s("doc_deduped",this._lang)),await this._load()}catch{this._error=s("doc_upload_failed",this._lang)}finally{this._busy=!1}}async _download(e){try{let t=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:30});kt(t.path,e.filename||e.title||"document")}catch(t){this._error=A(t,this._lang)}}async _preview(e){if(this._isImage(e)){this._lightboxUrl=this._thumbs[e.id]||await this._sign(e);return}let t=window.open("about:blank","_blank");try{let i=await this._sign(e);t&&(t.location.href=new URL(i,window.location.origin).href)}catch(i){t&&t.close(),this._error=A(i,this._lang)}}_openDoc(e){e.kind==="file"?this._preview(e):le(e.url)&&window.open(e.url,"_blank","noopener")}_startEdit(e){this._editingId=e.id,this._editTitle=e.title||"",this._editCategory=this._category_of(e),this._addingLink=!1,this._error=""}_cancelEdit(){this._editingId=""}async _saveEdit(e){let t=(e.tags||[]).filter(a=>!Tt.includes(a)),i=e.kind==="file"?[this._editCategory,...t]:e.tags??[];this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:e.id,title:this._editTitle.trim()||e.filename||e.url||"",tags:i}),this._editingId="",await this._load()}catch(a){this._error=A(a,this._lang)}finally{this._busy=!1}}async _delete(e){let t=e.title||e.filename||e.url||"";if(window.confirm(s("doc_delete_confirm",this._lang).replace("{name}",t))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:e.id}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}}async _addLink(){let e=this._linkUrl.trim();if(e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/add_link",entry_id:this.entryId,url:e,title:this._linkTitle.trim()||null}),this._linkUrl="",this._linkTitle="",this._addingLink=!1,await this._load()}catch(t){this._error=A(t,this._lang,s("doc_link_invalid",this._lang))}finally{this._busy=!1}}}render(){let e=this._lang;return o`
    ...
    `}_renderDoc(e,t){if(this._editingId===e.id)return this._renderEdit(e,t);let i=e.kind==="file",a=this._category_of(e),l=i?`${s(`doc_cat_${a}`,t)} \xB7 ${ge(e.size)}`:s("doc_link_badge",t),c=this._thumbs[e.id];return o`
      <div class="doc-row">
        ${i&&c?o`<img
              class="doc-thumb"
              src=${c}
  ...
  `,p([b({attribute:!1})],U.prototype,"hass",2),p([b({attribute:!1})],U.prototype,"entryId",2),p([b({type:Boolean})],U.prototype,"canWrite",2),p([_()],U.prototype,"_docs",2),p([_()],U.prototype,"_loaded",2),p([_()],U.prototype,"_busy",2),p([_()],U.prototype,"_error",2),p([_()],U.prototype,"_hint",2),p([_()],U.prototype,"_addingLink",2),p([_()],U.prototype,"_linkUrl",2),p([_()],U.prototype,"_linkTitle",2),p([_()],U.prototype,"_category",2),p([_()],U.prototype,"_thumbs",2),p([_()],U.prototype,"_lightboxUrl",2),p([_()],U.prototype,"_editingId",2),p([_()],U.prototype,"_editTitle",2),p([_()],U.prototype,"_editCategory",2),p([_()],U.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",U);var Os=["manual","warranty","invoice","spare_parts","photo","other"],Ds={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"},te=class extends S{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._loadedKey="";this._localeReady=!1}get _lang(){return this.hass?.language||"en"}get _refId(){return this.partId||this.taskId||""}get _linkField(){return this.partId?"part_ids":"task_ids"}updated(e){super.updated(e),this.hass&&!this._localeReady&&(this._localeReady=!0,W(this._lang).then(()=>this.requestUpdate()));let t=`${this.entryId}|${this._refId}`;this.hass&&this.entryId&&this._refId&&this._loadedKey!==t&&(this._loadedKey=t,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=e.documents||[],this._loaded=!0,this._error=""}catch(e){this._error=A(e,this._lang),this._loaded=!0}}_links(e){return e[this._linkField]||[]}_linked(){return this._docs.filter(e=>this._links(e).includes(this._refId))}_available(){return this._docs.filter(e=>!this._links(e).includes(this._refId))}async _setLinks(e,t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:e.id,[this._linkField]:t}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}_link(){let e=this._docs.find(t=>t.id===this._attachId);e&&(this._attachId="",this._setLinks(e,[...this._links(e),this._refId]))}_unlink(e){this._setLinks(e,this._links(e).filter(t=>t!==this._refId))}_isPdf(e){return e.mime==="application/pdf"||(e.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(e){return this._isPdf(e)&&this.taskId?e.task_pages?.[this.taskId]:void 0}async _open(e){if(e.kind==="weblink"){window.open(e.url,"_blank","noopener");return}let t=this._pageFor(e),i=t?`#page=${t}`:"",a=window.open("about:blank","_blank");try{let l=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:300});a&&(a.location.href=new URL(l.path+i,window.location.origin).href)}catch(l){a&&a.close(),this._error=A(l,this._lang)}}async _setPage(e,t){if(this.taskId){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:e.id,task_pages:{[this.taskId]:t}}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}}async _download(e){try{let t=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:30});kt(t.path,e.filename||e.title||"document")}catch(t){this._error=A(t,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return h;let e=this._lang,t=this._linked(),i=this._available();return o`
    ...
    `}_renderRow(e,t){let i=e.kind==="file",a=this._isPdf(e),l=this._pageFor(e),c=(e.tags||[]).find(u=>Os.includes(u))||"other",d=i?ge(e.size):s("doc_link_badge",t);return o`
      <div class="tdoc-row">
              ...
              <div class="bf-rows">
                ${t.low.map(a=>o`
                    <div class="bf-row">
                      ...
                      <button
                        class="bf-mark"
                        title=${s("battery_fleet_mark_one",e)}
...
`;var ae=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){if(this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter),typeof e.object_filter=="string")this._objectFilter=e.object_filter,this._configuredObjects=[];else if(Array.isArray(e.object_filter)){let t=e.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=t.length===1?t[0]:"",this._configuredObjects=t.length>1?t:[]}}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){super.updated(e),e.has("hass")&&vt(this.hass?.locale);let t=this.hass?.language;if(t&&!mt(t)&&W(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}_onEventClick(e){if(e.history_timestamp){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,l=null;this._userFilter&&(l=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let c=$=>{let Q=$.toLowerCase();return this._objects.find(N=>N.entry_id===$||N.object.name.toLowerCase()===Q)?.entry_id??null},d=new Set(this._configuredObjects.map(c).filter($=>$!==null)),u=d.size?this._objects.filter($=>d.has($.entry_id)):this._objects,g=this._config.show_object_filter!==!1&&u.length>1,m=this._objectFilter?c(this._objectFilter):null,v=m&&u.some($=>$.entry_id===m)?u.filter($=>$.entry_id===m):u,f=new Date;f.setHours(0,0,0,0);let w=this._pastDays>0,x=w?Di(v,f,this._pastDays,l):Oi(v,f,this._windowDays,l),M=st(f),L=this._windowDays===365||w,F=L?x.filter($=>$.events.length>0):x,O=$=>{let Q=`cal-status-${$.status}`,Z=$.projected?"cal-event-projected":"",N=$.status==="overdue"&&$.days_until_due!=null?` (${Te($.days_until_due,e)})`:"",D=$.projected&&$.interval_days?o`<span class="cal-event-recur">${$.interval_unit&&$.interval_unit!=="days"?`${$.interval_days} ${s("unit_"+$.interval_unit,e)}`:s("cal_every_n_days",e).replace("{n}",String($.interval_days))}</span>`:h,ee=$.schedule_type==="sensor_based",de=ee?o`<ha-icon class="cal-event-icon cal-source-sensor"
                ...
                icon="${$.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,ue=ee&&$.prediction_confidence&&$.status!=="triggered"&&!$.projected?o`<span class="cal-event-prediction cal-conf-${$.prediction_confidence}">
        ...
        <div class="cal-event ${Z}"
          ...
          <div class="cal-event-body">
            <div class="cal-event-title">${$.object_name} · ${$.task_name}${N}</div>
            ${ue}
            ${D}
          </div>
          ${$.avg_cost!=null&&$.avg_cost>0?o`<span class="cal-event-cost">${$.avg_cost.toFixed(0)} ${G}</span>`:h}
        </div>
      `},C=$=>{let[Q,Z,N]=$.date.split("-").map(Number),D=new Date(Q,Z-1,N),ee=$.date===M,de=D.toLocaleDateString(e,{weekday:"short"}),ue=D.toLocaleDateString(e,{month:"long"});return o`
        <div class="cal-day-row">
          ...
          <div class="cal-day-content">
            <div class="cal-day-header">
              <span class="cal-day-month">${ue}</span>
              ${ee?o`<span class="cal-day-today-badge">${s("today",e)}</span>`:h}
            </div>
            ${$.events.length===0?o`<div class="cal-empty">${s("cal_no_events",e)}</div>`:$.events.map(O)}
          </div>
        </div>
      `};return o`
      <ha-card .header=${a}>
        ...
        <div class="cal-rolling">
          ${F.length===0&&L?o`<div class="cal-empty">${s("cal_no_events",e)}</div>`:F.map(C)}
        </div>
      </ha-card>
    `}};ae.styles=[yt,Hi,j`
      :host { display: block; }
...
<body>
  ...
  `,p([b({attribute:!1})],R.prototype,"hass",2),p([b({attribute:!1})],R.prototype,"features",2),p([b({attribute:!1})],R.prototype,"budget",2),p([_()],R.prototype,"_settings",2),p([_()],R.prototype,"_loading",2),p([_()],R.prototype,"_importCsv",2),p([_()],R.prototype,"_importLoading",2),p([_()],R.prototype,"_includeHistory",2),p([_()],R.prototype,"_toast",2),p([_()],R.prototype,"_testingNotification",2),p([_()],R.prototype,"_personTargets",2),p([_()],R.prototype,"_testingUser",2),p([_()],R.prototype,"_users",2),p([_()],R.prototype,"_savedViews",2),p([_()],R.prototype,"_vacEnabled",2),p([_()],R.prototype,"_vacStart",2),p([_()],R.prototype,"_vacEnd",2),p([_()],R.prototype,"_vacBuffer",2),p([_()],R.prototype,"_vacExempt",2),p([_()],R.prototype,"_vacIsActive",2),p([_()],R.prototype,"_vacWindowEnd",2),p([_()],R.prototype,"_vacAllTasks",2),p([_()],R.prototype,"_vacPreview",2),p([_()],R.prototype,"_vacPreviewLoading",2),p([_()],R.prototype,"_vacSaving",2),p([_()],R.prototype,"_qrObjects",2),p([_()],R.prototype,"_qrSelectedEntries",2),p([_()],R.prototype,"_qrActions",2),p([_()],R.prototype,"_qrUrlMode",2),p([_()],R.prototype,"_qrBatchLoading",2),p([_()],R.prototype,"_qrBatchResults",2),p([_()],R.prototype,"_qrObjectsLoaded",2),p([_()],R.prototype,"_exportObjects",2),p([_()],R.prototype,"_exportSelectedEntries",2),p([_()],R.prototype,"_exportObjectsLoaded",2),p([_()],R.prototype,"_docArchiveLoading",2),p([_()],R.prototype,"_allTemplates",2),p([_()],R.prototype,"_templateCategories",2),p([_()],R.prototype,"_tplOpenGroups",2);customElements.define("maintenance-settings-view",R);var ne=class extends S{constructor(){super(...arguments);this.objects=[];this._summary=null;this._loaded=!1;this._busy=!1;this._error="";this._query="";this._results=[];this._expanded=!1;this._initiallyLoaded=!1;this._searchTimer=0}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._initiallyLoaded&&(this._initiallyLoaded=!0,this._load(),W(this._lang).then(()=>this.requestUpdate()))}async _load(){this._busy=!0;try{this._summary=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/storage"}),this._error=""}catch(e){this._error=A(e,this._lang)}finally{this._loaded=!0,this._busy=!1}}_nameFor(e){return this.objects.find(i=>i.object?.id===e)?.object?.name||e.slice(0,8)}_entryFor(e){return this.objects.find(t=>t.object?.id===e)?.entry_id}_toggle(){this._expanded=!this._expanded}_openObject(e){this.dispatchEvent(new CustomEvent("open-object",{detail:{entry_id:e},bubbles:!0,composed:!0}))}_onSearch(e){this._query=e.target.value,clearTimeout(this._searchTimer),this._searchTimer=window.setTimeout(()=>{this._doSearch()},250)}async _doSearch(){let e=this._query.trim();if(!e){this._results=[];return}try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/search",query:e});this._results=t.results||[]}catch(t){this._error=A(t,this._lang),this._results=[]}}async _openResult(e){if(e.kind==="weblink"){window.open(e.url,"_blank","noopener");return}let t=window.open("about:blank","_blank");try{let i=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:300});t&&(t.location.href=new URL(i.path,window.location.origin).href)}catch(i){t&&t.close(),this._error=A(i,this._lang)}}_renderResult(e,t){return o`
        ...
        <div class="card-content">
          <div class="header">
            ...
            >
              ...
              <span class="header-summary">
                ${ge(e.total_bytes)}
                ${e.dedup_savings_bytes>0?o`<span class="saved">−${ge(e.dedup_savings_bytes)}</span>`:h}
              </span>
            </button>
            <button
              class="icon-btn"
          ...
          ${this._expanded?o`
                <div class="body">
                  <div class="totals">
                    <div class="stat">
                      <div class="stat-value">${ge(e.total_bytes)}</div>
                    ...
                    ${e.dedup_savings_bytes>0?o`<div class="stat">
                          <div class="stat-value saved">−${ge(e.dedup_savings_bytes)}</div>
    ...
    `}_renderObjRow(e,t){let i=e.entry;return o`
      ...
      >
        ...
        <span class="obj-size">${ge(e.bytes)}</span>
  ...
  `}function ei(n,r,e){if(!n.trigger_config?.entity_id)return h;let t=n.trigger_config.entity_id,i=r.get(t)||[],a=[];if(i.length>=2)a=i.map(C=>({ts:C.ts,val:C.val}));else{if(!n.history)return h;for(let C of n.history)C.trigger_value!=null&&a.push({ts:new Date(C.timestamp).getTime(),val:C.trigger_value})}if(n.trigger_current_value!=null&&a.push({ts:Date.now(),val:n.trigger_current_value}),a.length<2)return h;a.sort((C,$)=>C.ts-$.ts);let l=na,c=oa,d=a.map(C=>C.val),u=Math.min(...d),g=Math.max(...d),m=g-u||1;u-=m*.1,g+=m*.1;let v=a[0].ts,w=a[a.length-1].ts-v||1,x=C=>(C-v)/w*l,M=C=>2+(1-(C-u)/(g-u))*(c-4),L=a;if(L.length>Bi){let C=Math.ceil(L.length/Bi);L=L.filter(($,Q)=>Q%C===0||Q===L.length-1)}let F=L.map(C=>`${x(C.ts).toFixed(1)},${M(C.val).toFixed(1)}`).join(" "),O=n.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return o`
    <svg class="mini-sparkline" viewBox="0 0 ${l} ${c}" preserveAspectRatio="none" role="img" aria-label="${s("chart_mini_sparkline",e)}">
      <polyline points="${F}" fill="none" stroke="${O}" stroke-width="1.5" stroke-linejoin="round" />
    </svg>
  ...
  `}function rt(n,r,e=4){if(!isFinite(n)||!isFinite(r))return{ticks:[],niceMin:0,niceMax:1};if(n===r){let u=Math.abs(n)*.1||1;n-=u,r+=u}let t=r-n,i=Math.pow(10,Math.floor(Math.log10(t/Math.max(1,e)))),a=i;for(let u of[1,2,5,10])if(a=i*u,t/a<=e+.5)break;let l=Math.floor(n/a)*a,c=Math.ceil(r/a)*a,d=[];for(let u=l;u<=c+a*1e-6;u+=a)d.push(Math.abs(u)<a*1e-9?0:u);return{ticks:d,niceMin:l,niceMax:c}}function ve(n){let r=Math.abs(n);return r>=1e6?qe((n/1e6).toFixed(r>=1e7?0:1))+"M":r>=1e4?qe((n/1e3).toFixed(0))+"k":r>=1e3?qe((n/1e3).toFixed(1))+"k":r>=100?n.toFixed(0):r>=10||r>=1?qe(n.toFixed(1)):r===0?"0":qe(n.toFixed(2))}function qe(n){return n.replace(/\.0+$/,"").replace(/(\.\d*[1-9])0+$/,"$1")}function Pe(n,r,e){let t=n.toLocaleString(e,{maximumFractionDigits:Math.abs(n)>=100?0:1});return r?`${t} ${r}`:t}function Ne(n,r,e){let t=new Date(n),i=e?{month:"short",day:"numeric",year:"2-digit"}:{month:"short",day:"numeric"};return t.toLocaleDateString(r,i)}function ti(n,r){return new Date(n).toLocaleDateString(r,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}function Rt(n,r){return new Date(n).getFullYear()!==new Date(r).getFullYear()}function Mt(n,r,e){if(e<2||r<=n)return[n,r];let t=[];for(let i=0;i<e;i++)t.push(n+(r-n)*i/(e-1));return t}var Lt=210,he=46,$e=14,we=12,Wi=14,la=20+Wi,ca=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],Y=class extends S{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(e=>{let t=Math.floor(e[0]?.contentRect?.width||0);t&&Math.abs(t-this._width)>2&&(this._width=t)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(e){e!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:e},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let e=this._width||320,t=[...this.points].sort((a,l)=>a.ts-l.ts),i=this.lang;return o`
    ...
    `}_renderSvg(e,t){let i=this.lang,a=e-he-$e,l=Lt-la,c=l-we,d=1/0,u=-1/0;for(let E of t)d=Math.min(d,E.min??E.val),u=Math.max(u,E.max??E.val);this.thresholdAbove!=null&&(d=Math.min(d,this.thresholdAbove),u=Math.max(u,this.thresholdAbove)),this.thresholdBelow!=null&&(d=Math.min(d,this.thresholdBelow),u=Math.max(u,this.thresholdBelow)),this.targetValue!=null&&(d=Math.min(d,this.targetValue),u=Math.max(u,this.targetValue)),this.forceZero&&(d=Math.min(d,0));let g=(u-d||1)*.06,m=this.forceZero&&d>=0?0:d-g,{ticks:v,niceMin:f,niceMax:w}=rt(m,u+g,4);this.forceZero&&d>=0&&f<0&&(f=0,v=v.filter(E=>E>=0));let x=t[0].ts,M=t[t.length-1].ts,L=M-x||1,F=Rt(x,M),O=E=>he+(E-x)/L*a,C=E=>we+(1-(E-f)/(w-f||1))*c,$=t.map(E=>`${O(E.ts).toFixed(1)},${C(E.val).toFixed(1)}`).join(" "),Q=`M${O(t[0].ts).toFixed(1)},${l} `+t.map(E=>`L${O(E.ts).toFixed(1)},${C(E.val).toFixed(1)}`).join(" ")+` L${O(t[t.length-1].ts).toFixed(1)},${l} Z`,Z="",N=t.filter(E=>E.min!=null&&E.max!=null);if(N.length>=2){let E=N.map(I=>`${O(I.ts).toFixed(1)},${C(I.max).toFixed(1)}`),k=[...N].reverse().map(I=>`${O(I.ts).toFixed(1)},${C(I.min).toFixed(1)}`);Z=`M${E[0]} `+E.slice(1).map(I=>`L${I}`).join(" ")+` L${k.join(" L")} Z`}let D=[];if(this.thresholdBelow!=null){let E=C(this.thresholdBelow);D.push({y:E,h:Math.max(0,l-E),lineY:E,label:`\u25BC ${ve(this.thresholdBelow)}`,labelY:Math.min(l-4,E+13)})}if(this.thresholdAbove!=null){let E=C(this.thresholdAbove);D.push({y:we,h:Math.max(0,E-we),lineY:E,label:`\u25B2 ${ve(this.thresholdAbove)}`,labelY:Math.max(we+11,E-5)})}let ee=t[t.length-1],de=(this.events||[]).filter(E=>E.ts>=x&&E.ts<=M),ue=Mt(x,M,Math.max(2,Math.min(5,Math.floor(a/110)+1))),G=this._hover;return o`
      <div class="svg-holder">
        ...
        >
          <defs>
            <clipPath id="plot"><rect x="${he}" y="${we}" width="${a}" height="${c}" /></clipPath>
            ${D.length?H`<clipPath id="danger">${D.map(E=>H`<rect x="${he}" y="${E.y.toFixed(1)}" width="${a}" height="${E.h.toFixed(1)}" />`)}</clipPath>`:h}
          ...
          ${v.map(E=>{let k=C(E);return k<we-1||k>l+1?h:H`
              <line x1="${he}" y1="${k.toFixed(1)}" x2="${e-$e}" y2="${k.toFixed(1)}"
                stroke="var(--divider-color)" stroke-width="1" opacity="0.6" />
              <text x="${he-7}" y="${(k+3.5).toFixed(1)}" text-anchor="end" class="tick-label">${ve(E)}</text>`})}

          ${D.map(E=>H`<rect x="${he}" y="${E.y.toFixed(1)}" width="${a}" height="${E.h.toFixed(1)}"
          ...
          ${D.length?H`<polyline points="${$}" fill="none" stroke="var(--error-color, #f44336)" stroke-width="2"
                stroke-linejoin="round" stroke-linecap="round" clip-path="url(#danger)" />`:h}

          ${D.map(E=>H`
              <line x1="${he}" y1="${E.lineY.toFixed(1)}" x2="${e-$e}" y2="${E.lineY.toFixed(1)}"
          ...
          ${this.targetValue!=null?H`<line x1="${he}" y1="${C(this.targetValue).toFixed(1)}" x2="${e-$e}" y2="${C(this.targetValue).toFixed(1)}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${e-$e-4}" y="${(C(this.targetValue)-5).toFixed(1)}" text-anchor="end" class="zone-label">◆ ${ve(this.targetValue)} ${this.unit}</text>`:h}

          ${this.projection&&this.projection.length===2?H`<line x1="${O(this.projection[0].ts).toFixed(1)}" y1="${C(this.projection[0].val).toFixed(1)}"
                x2="${Math.min(O(this.projection[1].ts),e-$e).toFixed(1)}" y2="${C(Math.max(f,Math.min(w,this.projection[1].val))).toFixed(1)}"
                stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.8" />`:h}

          ${ue.map((E,k)=>{let I=O(E),Pt=k===0?"start":k===ue.length-1?"end":"middle";return H`<text x="${I.toFixed(1)}" y="${Lt-5}" text-anchor="${Pt}" class="tick-label">${Ne(E,i,F)}</text>`})}

          <line x1="${he}" y1="${l}" x2="${e-$e}" y2="${l}" stroke="var(--divider-color)" stroke-width="1" />
        ...
        ${G?o`<div
            ...
            >
              ...
              <div class="hover-val">
                ...
                ${G.p.min!=null&&G.p.max!=null?o`<span class="hover-range">(${ve(G.p.min)}–${ve(G.p.max)})</span>`:h}
              </div>
            </div>`:h}
      </div>
    `}_onPointer(e,t,i,a,l){let d=e.currentTarget.getBoundingClientRect(),u=(e.clientX-d.left)/d.width*l;if(u<he-8||u>l-$e+8){this._hover=null;return}let g=t[0],m=1/0;for(let v of t){let f=Math.abs(i(v.ts)-u);f<m&&(m=f,g=v)}this._hover={x:i(g.ts),y:a(g.val),p:g}}};Y.styles=j`
  ...
  `}function ga(n,r,e,t,i){let f=Math.max(e,t,r,1)*1.3,w=50,x=[];for(let N=0;N<=w;N++){let D=N/w*f,ee=1-Math.exp(-Math.pow(D/r,n)),de=32+D/f*260,ue=136-ee*128;x.push([de,ue])}let M=x.map(([N,D])=>`${N.toFixed(1)},${D.toFixed(1)}`).join(" "),L="M32,136 "+x.map(([N,D])=>`L${N.toFixed(1)},${D.toFixed(1)}`).join(" ")+` L${x[w][0].toFixed(1)},136 Z`,F=32+e/f*260,O=1-Math.exp(-Math.pow(e/r,n)),C=136-O*128,$=((1-O)*100).toFixed(0),Q=32+t/f*260,Z=[0,.25,.5,.75,1];return o`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",i)}">
        ${Z.map(N=>{let D=136-N*128;return H`
        ...
        ${e>0?H`
          ...
          <circle cx="${F.toFixed(1)}" cy="${C.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(F+4).toFixed(1)}" y="${(C-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
  ...
  `}function ts(n,r){return fa(n,r)}function fa(n,r){let e=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return h;let t=n.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,l=100,c=8,u=l-c-4,g=Math.max(...e,1.5),m=a/12,v=m*.65,f=c+u-1/g*u;return o`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${a} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",r)}">
        ...
        ${e.map((w,x)=>{let M=w/g*u,L=x*m+(m-v)/2,F=c+u-M,O=x===i,C=w<1?"var(--success-color, #4caf50)":w>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return H`
            <rect x="${L.toFixed(1)}" y="${F.toFixed(1)}"
              width="${v.toFixed(1)}" height="${M.toFixed(1)}"
              fill="${C}" opacity="${O?1:.5}" rx="2" />
          `})}
      </svg>
      <div class="seasonal-labels">
        ${Xi.map((w,x)=>o`<span class="seasonal-label ${x===i?"active-month":""}">${s(w,r)}</span>`)}
      </div>
    </div>
  ...
  `}function xa(n,r,e){let t=n.history.filter(k=>k.type==="completed"&&(k.cost!=null||k.duration!=null)).map(k=>({ts:new Date(k.timestamp).getTime(),cost:k.cost??0,duration:k.duration??0})).sort((k,I)=>k.ts-I.ts);if(t.length<2)return h;let i=t.some(k=>k.cost>0),a=t.some(k=>k.duration>0);if(!i&&!a)return h;let l=e!=="duration"&&i,c=e!=="cost"&&a,d=l||!c&&i,u=c||!l&&a,g=640,m=ba,v=d?44:12,f=u?44:12,w=g-v-f,x=m-ya,M=x-nt,L=t[0].ts,F=t[t.length-1].ts,O=(F-L||864e5)*.05,C=L-O,$=F+O,Q=Rt(L,F),Z=k=>v+(k-C)/($-C)*w,N=rt(0,Math.max(...t.map(k=>k.cost))||1,3),D=rt(0,Math.max(...t.map(k=>k.duration))||1,3),ee=k=>nt+(1-k/(N.niceMax||1))*M,de=k=>nt+(1-k/(D.niceMax||1))*M,ue=t.length>1?Math.min(...t.slice(1).map((k,I)=>Z(k.ts)-Z(t[I].ts))):w,G=Math.max(6,Math.min(22,ue*.55)),E=Mt(L,F,Math.max(2,Math.min(4,t.length)));return o`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${g} ${m}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_history",r)}">
        ${d?N.ticks.map(k=>{let I=ee(k);return I<nt-1||I>x+1?h:H`
            <line x1="${v}" y1="${I.toFixed(1)}" x2="${g-f}" y2="${I.toFixed(1)}" stroke="var(--divider-color)" stroke-width="1" opacity="0.55" />
            <text x="${v-6}" y="${(I+3.5).toFixed(1)}" text-anchor="end" fill="var(--primary-color)" font-size="10.5">${ve(k)}€</text>`}):h}
        ${u?D.ticks.map(k=>{let I=de(k);return I<nt-1||I>x+1?h:H`<text x="${g-f+6}" y="${(I+3.5).toFixed(1)}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="10.5">${ve(k)}m</text>`}):h}
