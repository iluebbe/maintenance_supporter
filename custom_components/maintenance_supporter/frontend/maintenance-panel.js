...
import{a as Be,b as Fe,c as qe}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-OHSAYUYA.js";import{A as ci,B as di,C as pi,D as hi,E as ui,L as mi,O as _i,a as at,b as Wt,c as Ct,d as yt,e as xt,f as Gt,g as Dt,h as te,i as Ue,j as We,k as ee,l as Ye,m as Ke,n as E,o as Bt,p as vt,q as Et,r as It,s as ve,t as ie,u as se,v as ai,w as ri,x as oi,y as ni,z as li}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-X5NUHJD3.js";import{a as Ne,b as Jt,c as wt,d as Xt,e as Nt,f as Zt,g as Ft,h as ii,i as si,k as gi}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-OMI4RPEK.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-GRODOZHK.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-AZKZNFFK.js";import{a as fe}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-A2LPO2HZ.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-AN3A6RAI.js";import{a as D,b as Z,c as G,d as Xe,e as Ze,f as ti,g as ei}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-R7OIT4C5.js";import{b as Ve,h as Ge}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-XXGPRYJO.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-WZP72YIY.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-FS7VLXOK.js";import{a as me}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-NOXOKE42.js";import{c as Qe,d as _e,e as Je}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-KRAXVQN3.js";import{a as A}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-6FKJJO4T.js";import{A as Q,B as ze,C as Tt,E as Lt,H as Pe,I as Le,K as St,L as Ht,M as He,O as Qt,a as g,b as L,c as o,d as J,f as h,h as H,i as ge,j as Ce,k as De,l as S,m,n as Yt,o as Ae,p as Kt,q as s,r as At,s as U,t as Ie,u as rt,v as Pt,x as it,y as K}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-BFRW5MGC.js";var Ui=["assignee_pool","required_completion_fields","checklist","labels","mirror_todo_entities","history","readings"],Wi=["checklist_progress"],Gi=["tasks","parts"],Yi=["manual_docs","battery_fleet_excluded"];function be(l,c,t=[]){for(let e of c)l[e]===void 0&&(l[e]=[]);for(let e of t)l[e]===void 0&&(l[e]={})}function Ki(l){let c=l;be(c,Gi),c.object&&typeof c.object=="object"&&be(c.object,Yi);for(let t of c.tasks)be(t,Ui,Wi);return l}function qt(l){for(let c of l)Ki(c);return l}function Qi(l,c){if(c.objects)return c.objects;let t=c.delta||[],e=c.removed||[];if(!t.length&&!e.length)return null;let i=new Map(l.map(a=>[a.entry_id,a]));for(let a of t)i.set(a.entry_id,a);for(let a of e)i.delete(a);return[...i.values()]}function vi(l,c){return c.objects&&qt(c.objects),c.delta&&qt(c.delta),Qi(l,c)}var ye=["today","dashboard","calendar","settings"];var Ji=168*3600*1e3;function fi(){try{let l=Z(D.objectsCache);if(!l)return null;let c=JSON.parse(l);return c.v!==ge||!Number.isFinite(c.at)||Date.now()-c.at>Ji||!Array.isArray(c.objects)||c.objects.length===0?null:{objects:c.objects,stats:c.stats??null}}catch{return null}}function xe(l,c){if(!(!Array.isArray(l)||l.length===0))try{let t={v:ge,at:Date.now(),objects:l,stats:c};G(D.objectsCache,JSON.stringify(t))}catch{}}function N(l){return String(l??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}function bi(l,c,t,e,i,a){let n=[[t.manufacturer,l.manufacturer],[t.model,l.model],[t.serial,l.serial_number],[t.installed,l.installation_date?e(l.installation_date):null],[t.warranty,l.warranty_expiry?e(l.warranty_expiry):null]].filter(([,p])=>!!p),d=c.map(p=>{let u=t.scheduleLabel(p);return`<tr>
      <td>${N(p.name)}</td>
