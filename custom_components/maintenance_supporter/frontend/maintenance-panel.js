...
`;var xe=class{constructor(r){this._cache=new Map;this._pending=new Map;this._hass=r}updateHass(r){this._hass=r}async getDetailStats(r,e){return this._getStats(r,"hour",30,e)}async getMiniStats(r,e){return this._getStats(r,"day",14,e)}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(r,e,t,i){let s=`${r}:${e}`,a=this._cache.get(s);if(a&&Date.now()-a.fetchedAt<3e5)return a.points;if(this._pending.has(s))return this._pending.get(s);let p=this._fetchAndNormalize(r,e,t,i,s);this._pending.set(s,p);try{return await p}finally{this._pending.delete(s)}}async _fetchAndNormalize(r,e,t,i,s){let a=new Date(Date.now()-t*24*60*60*1e3).toISOString(),p=i?["state","sum","change"]:["mean","min","max"];try{let v=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:a,statistic_ids:[r],period:e,types:p}))[r]||[],h=[];for(let _ of v){let f=null;if(i?f=_.state??null:f=_.mean??null,f===null)continue;let x={ts:_.start,val:f};i||(_.min!=null&&(x.min=_.min),_.max!=null&&(x.max=_.max)),h.push(x)}return h.sort((_,f)=>_.ts-f.ts),this._cache.set(s,{entityId:r,fetchedAt:Date.now(),period:e,points:h}),h}catch(d){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${r}:`,d),[]}}};var se=class{constructor(r){this.usersCache=null;this.cacheTimestamp=0;this.CACHE_TTL_MS=6e4;this.hass=r}async getUsers(r=!1){let e=Date.now();if(!r&&this.usersCache&&e-this.cacheTimestamp<this.CACHE_TTL_MS)return this.usersCache;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/users/list"});return this.usersCache=t.users,this.cacheTimestamp=e,this.usersCache}catch(t){return console.error("Failed to fetch users:",t),this.usersCache||[]}}async assignUser(r,e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/assign_user",entry_id:r,task_id:e,user_id:t})}async getTasksByUser(r){return(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tasks/by_user",user_id:r})).tasks}getUserName(r){return!r||!this.usersCache?null:this.usersCache.find(t=>t.id===r)?.name||null}getUser(r){return!r||!this.usersCache?null:this.usersCache.find(e=>e.id===r)||null}getCurrentUserId(){return this.hass.user?.id||null}isCurrentUser(r){return r?r===this.getCurrentUserId():!1}clearCache(){this.usersCache=null,this.cacheTimestamp=0}};var O=class extends I{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._name="";this._manufacturer="";this._model="";this._entryId=null}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}openCreate(){this._entryId=null,this._name="",this._manufacturer="",this._model="",this._open=!0}openEdit(e,t){this._entryId=e,this._name=t.name||"",this._manufacturer=t.manufacturer||"",this._model=t.model||"",this._open=!0}async _save(){if(this._name.trim()){this._loading=!0;try{this._entryId?await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/update",entry_id:this._entryId,name:this._name,manufacturer:this._manufacturer||null,model:this._model||null}):await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/create",name:this._name,manufacturer:this._manufacturer||null,model:this._model||null}),this._open=!1,this.dispatchEvent(new CustomEvent("object-saved"))}finally{this._loading=!1}}}_close(){this._open=!1}render(){if(!this._open)return l``;let e=this._lang,t=this._entryId?n("edit_object",e):n("new_object",e);return l`
  ...
  `,g([z({attribute:!1})],O.prototype,"hass",2),g([m()],O.prototype,"_open",2),g([m()],O.prototype,"_loading",2),g([m()],O.prototype,"_name",2),g([m()],O.prototype,"_manufacturer",2),g([m()],O.prototype,"_model",2),g([m()],O.prototype,"_entryId",2),O=g([Z("maintenance-object-dialog")],O);var It=["cleaning","inspection","replacement","calibration","service","custom"],Rt=["time_based","sensor_based","manual"],zt=["threshold","counter","state_change"],k=class extends I{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._entryId="";this._taskId=null;this._name="";this._type="custom";this._scheduleType="time_based";this._intervalDays="30";this._warningDays="7";this._notes="";this._documentationUrl="";this._triggerEntityId="";this._triggerAttribute="";this._triggerType="threshold";this._triggerAbove="";this._triggerBelow="";this._triggerForMinutes="0";this._triggerTargetValue="";this._triggerDeltaMode=!1;this._triggerFromState="";this._triggerToState="";this._triggerTargetChanges="";this._responsibleUserId=null;this._availableUsers=[];this._userService=null}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}async openCreate(e){this._entryId=e,this._taskId=null,this._resetFields(),await this._loadUsers(),this._open=!0}async openEdit(e,t){if(this._entryId=e,this._taskId=t.id,this._name=t.name,this._type=t.type,this._scheduleType=t.schedule_type,this._intervalDays=t.interval_days?.toString()||"30",this._warningDays=t.warning_days.toString(),this._notes=t.notes||"",this._documentationUrl=t.documentation_url||"",this._responsibleUserId=t.responsible_user_id||null,t.trigger_config){let i=t.trigger_config;this._triggerEntityId=i.entity_id||"",this._triggerAttribute=i.attribute||"",this._triggerType=i.type||"threshold",this._triggerAbove=i.trigger_above?.toString()||"",this._triggerBelow=i.trigger_below?.toString()||"",this._triggerForMinutes=i.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=i.trigger_target_value?.toString()||"",this._triggerDeltaMode=i.trigger_delta_mode||!1,this._triggerFromState=i.trigger_from_state||"",this._triggerToState=i.trigger_to_state||"",this._triggerTargetChanges=i.trigger_target_changes?.toString()||""}else this._resetTriggerFields();await this._loadUsers(),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._warningDays="7",this._notes="",this._documentationUrl="",this._responsibleUserId=null,this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerAttribute="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges=""}async _loadUsers(){this._userService||(this._userService=new se(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}async _save(){if(this._name.trim()){this._loading=!0;try{let e={type:this._taskId?"maintenance_supporter/task/update":"maintenance_supporter/task/create",entry_id:this._entryId,name:this._name,task_type:this._type,schedule_type:this._scheduleType,warning_days:parseInt(this._warningDays,10)||7};if(this._taskId&&(e.task_id=this._taskId),this._scheduleType!=="manual"&&this._intervalDays&&(e.interval_days=parseInt(this._intervalDays,10)),this._notes&&(e.notes=this._notes),this._documentationUrl&&(e.documentation_url=this._documentationUrl),this._responsibleUserId&&(e.responsible_user_id=this._responsibleUserId),this._scheduleType==="sensor_based"&&this._triggerEntityId){let t={entity_id:this._triggerEntityId,type:this._triggerType};this._triggerAttribute&&(t.attribute=this._triggerAttribute),this._triggerType==="threshold"?(this._triggerAbove&&(t.trigger_above=parseFloat(this._triggerAbove)),this._triggerBelow&&(t.trigger_below=parseFloat(this._triggerBelow)),this._triggerForMinutes&&(t.trigger_for_minutes=parseInt(this._triggerForMinutes,10))):this._triggerType==="counter"?(this._triggerTargetValue&&(t.trigger_target_value=parseFloat(this._triggerTargetValue)),t.trigger_delta_mode=this._triggerDeltaMode):this._triggerType==="state_change"&&(this._triggerFromState&&(t.trigger_from_state=this._triggerFromState),this._triggerToState&&(t.trigger_to_state=this._triggerToState),this._triggerTargetChanges&&(t.trigger_target_changes=parseInt(this._triggerTargetChanges,10))),e.trigger_config=t}await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return c;let e=this._lang;return l`
      ...
      <div class="select-row">
        ...
        >
          ${zt.map(t=>l`<option value=${t}>${n(t,e)}</option>`)}
        </select>
      </div>
      ...
      <ha-dialog open @closed=${this._close} .heading=${t}>
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${It.map(i=>l`<option value=${i}>${n(i,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${Rt.map(i=>l`<option value=${i}>${n(i,e)}</option>`)}
            </select>
          </div>
  ...
  `,g([z({attribute:!1})],N.prototype,"hass",2),g([z()],N.prototype,"lang",2),g([m()],N.prototype,"_open",2),g([m()],N.prototype,"_loading",2),g([m()],N.prototype,"_error",2),g([m()],N.prototype,"_result",2),g([m()],N.prototype,"_action",2),N=g([Z("maintenance-qr-dialog")],N);var Ut=60,Ot=20,Nt=300,Vt=140,qt=300,Bt=200,ot=30,Wt=27,A=class extends I{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._unsub=null;this._sparklineTooltip=null;this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1};this._activeTab="overview";this._costDurationToggle="both";this._historyTimeRange=12;this._historySearch="";this._statsService=null;this._userService=null;this._deepLinkHandled=!1;this._onDialogEvent=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"de"}connectedCallback(){super.connectedCallback(),this._loadData(),this._subscribe()}disconnectedCallback(){super.disconnectedCallback(),this._unsub&&(this._unsub(),this._unsub=null),this._statsService?.clearCache(),this._statsService=null}updated(e){super.updated(e),e.has("hass")&&this.hass&&(this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new xe(this.hass),this._fetchMiniStatsForOverview()),this._userService||(this._userService=new se(this.hass),this._userService.getUsers()))}async _loadData(){let[e,t,i,s,a]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null)]);this._objects=e.objects,this._stats=t,i&&(this._budget=i),s&&(this._groups=s.groups||{}),a&&(this._features=a.features),this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search),t=e.get("entry_id");if(!t)return;this._deepLinkHandled=!0;let i=e.get("task_id"),s=e.get("action"),a=window.location.pathname+window.location.hash;history.replaceState(null,"",a),i?(this._showTask(t,i),s==="complete"&&requestAnimationFrame(()=>{let d=this._getObject(t)?.tasks.find(v=>v.id===i);d&&this._openCompleteDialog(t,i,d.name,this._features.checklists?d.checklist:void 0,this._features.adaptive&&!!d.adaptive_config?.enabled)})):this._showObject(t)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let i=await this._statsService.getDetailStats(e,t),s=new Map(this._detailStatsData);s.set(e,i),this._detailStatsData=s}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=new Map(this._miniStatsData),t=[];for(let i of this._objects)for(let s of i.tasks){let a=s.trigger_config?.entity_id;if(!a)continue;let p=this._isCounterEntity(s.trigger_config);t.push(this._statsService.getMiniStats(a,p).then(d=>{e.set(a,d)}))}t.length>0&&(await Promise.all(t),this._miniStatsData=e)}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _taskRows(){let e=[];for(let i of this._objects)for(let s of i.tasks)if(!(this._filterStatus&&s.status!==this._filterStatus)){if(this._filterUser){let a=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(s.responsible_user_id!==a)continue}e.push({entry_id:i.entry_id,task_id:s.id,object_name:i.object.name,task_name:s.name,type:s.type,schedule_type:s.schedule_type,status:s.status,days_until_due:s.days_until_due??null,next_due:s.next_due??null,trigger_active:s.trigger_active,trigger_current_value:s.trigger_current_value??null,trigger_current_delta:s.trigger_current_delta??null,trigger_config:s.trigger_config??null,trigger_entity_info:s.trigger_entity_info??null,times_performed:s.times_performed,total_cost:s.total_cost,interval_days:s.interval_days??null,history:s.history||[]})}let t={overdue:0,triggered:1,due_soon:2,ok:3};return e.sort((i,s)=>(t[i.status]??9)-(t[s.status]??9)),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(s=>s.id===t)}_showOverview(){this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null}_showObject(e){this._view="object",this._selectedEntryId=e,this._selectedTaskId=null}_showTask(e,t){this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._historyFilter=null;let i=this._getTask(e,t);if(i?.trigger_config?.entity_id){let s=i.trigger_config.entity_id,a=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(s,a)}}async _deleteObject(e){confirm(n("confirm_delete_object",this._lang))&&(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:e}),this._showOverview(),await this._loadData())}async _deleteTask(e,t){confirm(n("confirm_delete_task",this._lang))&&(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/delete",entry_id:e,task_id:t}),this._showObject(e),await this._loadData())}async _skipTask(e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/skip",entry_id:e,task_id:t}),await this._loadData()}async _resetTask(e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/reset",entry_id:e,task_id:t}),await this._loadData()}async _applySuggestion(e,t,i){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/apply_suggestion",entry_id:e,task_id:t,interval:i}),await this._loadData()}_dismissSuggestion(){this._loadData()}_openCompleteDialog(e,t,i,s,a){let p=this.shadowRoot.querySelector("maintenance-complete-dialog");p&&(p.entryId=e,p.taskId=t,p.taskName=i,p.lang=this._lang,p.checklist=s||[],p.adaptiveEnabled=!!a,p.open())}_openQrForObject(e,t){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForObject(e,t)}_openQrForTask(e,t,i,s){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForTask(e,t,i,s)}async _exportCsv(){let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/csv/export"}),t=new Blob([e.csv],{type:"text/csv;charset=utf-8;"}),i=URL.createObjectURL(t),s=document.createElement("a");s.href=i,s.download="maintenance_export.csv",s.click(),URL.revokeObjectURL(i)}_triggerImportCsv(){let e=this.shadowRoot.querySelector("input[type=file]");e&&(e.value="",e.click())}async _handleCsvFile(e){let i=e.target.files?.[0];if(!i)return;let s=await i.text(),a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/csv/import",csv_content:s});await this._loadData(),alert(`Imported ${a.created} of ${a.total} objects.`)}render(){return l`
    ...
    `}_renderOverview(){let e=this._stats,t=this._taskRows,i=this._lang;return l`
      ...
      <div class="filter-bar">
        ...
        <select
          ...
          @change=${s=>{let a=s.target.value;this._filterUser=a||null}}
        >
    ...
    `}_renderGroupsSection(){let e=Object.entries(this._groups);if(e.length===0)return c;let t=this._lang;return l`
      <div class="groups-section">
        ...
        <div class="groups-grid">
          ${e.map(([i,s])=>{let a=s.task_refs.map(p=>this._getTask(p.entry_id,p.task_id)?.name||p.task_id);return l`
              <div class="group-card">
                ...
                <div class="group-card-tasks">
                  ${a.length>0?a.map(p=>l`<span class="group-task-chip">${p}</span>`):l`<span style="font-size:12px;color:var(--secondary-text-color)">${n("no_tasks_short",t)}</span>`}
                </div>
              </div>
            `})}
        </div>
    ...
    `}_renderBudgetBar(){let e=this._budget;if(!e)return c;let t=this._lang,i=[];return e.monthly_budget>0&&i.push({label:n("budget_monthly",t),spent:e.monthly_spent,budget:e.monthly_budget}),e.yearly_budget>0&&i.push({label:n("budget_yearly",t),spent:e.yearly_spent,budget:e.yearly_budget}),i.length===0?c:l`
      <div class="budget-bars">
        ${i.map(s=>{let a=Math.min(100,Math.max(0,s.spent/s.budget*100)),p=a>=100?"var(--error-color, #f44336)":a>=e.alert_threshold_pct?"var(--warning-color, #ff9800)":"var(--success-color, #4caf50)";return l`
    ...
    `}_renderOverviewRow(e){let t=this._lang,i=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,s=0,a=be.ok,p=!1;if(i&&e.days_until_due!==null){let d=(e.interval_days-e.days_until_due)/e.interval_days*100;s=Math.max(0,Math.min(100,d)),p=d>100,e.status==="overdue"?a=be.overdue:e.status==="due_soon"&&(a=be.due_soon)}return l`
      <div class="task-row">
        ...
        <span class="due-cell" @click=${()=>this._showTask(e.entry_id,e.task_id)}>
          ...
          ${i?l`<div class="days-bar"><div class="days-bar-fill${p?" overflow":""}" style="width:${s}%;background:${a}"></div></div>`:c}
    ...
    `}_renderTriggerProgress(e){let t=e.trigger_config??null;if(!t)return c;let i=t.type||"threshold",s=e.trigger_entity_info?.unit_of_measurement??"",a=0,p="";if(i==="threshold"){let h=e.trigger_current_value??null;if(h==null)return c;let _=t.trigger_above,f=t.trigger_below;if(_!=null){let x=f??0,$=_-x||1;a=Math.min(100,Math.max(0,(h-x)/$*100)),p=`${h.toFixed(1)} / ${_} ${s}`}else if(f!=null){let $=e.trigger_entity_info?.max??(h*2||100),M=$-f||1;a=Math.min(100,Math.max(0,($-h)/M*100)),p=`${h.toFixed(1)} / ${f} ${s}`}else return c}else if(i==="counter"){let h=t.trigger_target_value||1,f=e.trigger_current_delta??null??e.trigger_current_value??null;if(f==null)return c;a=Math.min(100,Math.max(0,f/h*100)),p=`${f.toFixed(1)} / ${h} ${s}`}else if(i==="state_change"){let h=t.trigger_target_changes||1,_=e.trigger_current_value??null;if(_==null)return c;a=Math.min(100,Math.max(0,_/h*100)),p=`${Math.round(_)} / ${h}`}else return c;let d=a>=100,v=a>90?"var(--error-color, #f44336)":a>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return l`
      <div class="trigger-progress">
        <div class="trigger-progress-bar">
          <div class="trigger-progress-fill${d?" overflow":""}" style="width:${a}%;background:${v}"></div>
        </div>
        <span class="trigger-progress-label">${p}</span>
      </div>
    `}_renderMiniSparkline(e){if(!e.trigger_config?.entity_id)return c;let t=e.trigger_config.entity_id,i=this._miniStatsData.get(t)||[],s=[];if(i.length>=2)s=i.map(b=>({ts:b.ts,val:b.val}));else{if(!e.history)return c;for(let b of e.history)b.trigger_value!=null&&s.push({ts:new Date(b.timestamp).getTime(),val:b.trigger_value})}if(e.trigger_current_value!=null&&s.push({ts:Date.now(),val:e.trigger_current_value}),s.length<2)return c;s.sort((b,T)=>b.ts-T.ts);let a=Ut,p=Ot,d=s.map(b=>b.val),v=Math.min(...d),h=Math.max(...d),_=h-v||1;v-=_*.1,h+=_*.1;let f=s[0].ts,$=s[s.length-1].ts-f||1,M=b=>(b-f)/$*a,C=b=>2+(1-(b-v)/(h-v))*(p-4),S=s;if(S.length>ot){let b=Math.ceil(S.length/ot);S=S.filter((T,y)=>y%b===0||y===S.length-1)}let F=S.map(b=>`${M(b.ts).toFixed(1)},${C(b.val).toFixed(1)}`).join(" ");return l`
    ...
    `}_renderDaysProgress(e){let t=this._lang;if(e.days_until_due==null||!e.interval_days||e.interval_days<=0)return c;let s=(e.interval_days-e.days_until_due)/e.interval_days*100,a=Math.max(0,Math.min(100,s)),p=s>100,d="var(--success-color, #4caf50)";return e.status==="overdue"?d="var(--error-color, #f44336)":e.status==="due_soon"&&(d="var(--warning-color, #ff9800)"),l`
      <div class="days-progress">
        <div class="days-progress-labels">
          <span>${e.last_performed?`${n("last_performed",t)}: ${te(e.last_performed,t)}`:""}</span>
          <span>${e.next_due?`${n("next_due",t)}: ${te(e.next_due,t)}`:""}</span>
        </div>
    ...
    `}_renderObjectDetail(){if(!this._selectedEntryId)return c;let e=this._getObject(this._selectedEntryId);if(!e)return l`<p>Object not found.</p>`;let t=e.object,i=this._lang;return l`
      <div class="detail-section">
        ...
        ${t.installation_date?l`<p class="meta">${n("installed",i)}: ${te(t.installation_date,i)}</p>`:c}

        <h3>${n("tasks",i)} (${e.tasks.length})</h3>
        ${e.tasks.length===0?l`<p class="empty">${n("no_tasks_short",i)}</p>`:e.tasks.map(s=>l`
              <div class="task-row">
                ...
                <span class="due-cell" @click=${()=>this._showTask(e.entry_id,s.id)}>
                  <span class="due-text">${ye(s.days_until_due,i)}</span>
                </span>
                <span class="row-actions">
    ...
    `}_renderTaskHeader(e){let t=this._lang,s=this._getObject(this._selectedEntryId)?.object.name||"",a="ok",p="OK";return e.days_until_due!==null&&e.days_until_due!==void 0&&(e.days_until_due<0?(a="overdue",p=n("overdue",t)):e.days_until_due<=e.warning_days&&(a="warning",p=n("due_soon",t))),l`
      <div class="task-header">
        <div class="task-header-title">
          ...
          <span class="status-chip ${a}">${p}</span>
    ...
    `}_renderAnalysisTab(e){let t=this._lang;return this._features.adaptive||this._features.seasonal?l`
    ...
    `}_renderRecommendationCard(e){let t=this._lang;if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return c;let i=e.interval_days,s=e.suggested_interval,a=e.interval_confidence||"medium";return l`
      <div class="recommendation-card">
        <h4>${n("suggested_interval",t)}</h4>
        <div class="interval-comparison">
          <div class="interval-bar">
            <div class="interval-label">${n("current",t)||"Aktuell"}: ${i} ${n("days",t)}</div>
            <div class="interval-visual current" style="width: ${Math.min(i/s*100,100)}%"></div>
          </div>
          <div class="interval-bar">
            <div class="interval-label">${n("recommended",t)}: ${s} ${n("days",t)}
              <span class="confidence-badge ${a}">${n(`confidence_${a}`,t)}</span>
            </div>
    ...
    `}_renderSeasonalCardCompact(e){let t=this._lang;if(!this._features.seasonal||!e.seasonal_factor||e.seasonal_factor===1)return c;let i=["Jan","Feb","M\xE4r","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez"],s=new Date().getMonth(),a=i.map((p,d)=>{let v=e.seasonal_factor||1,h=Math.sin((d-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,v+h))});return l`
      <div class="seasonal-card-compact">
        <h4>${n("seasonal_awareness",t)}</h4>
        <div class="seasonal-mini-chart">
          ${a.map((p,d)=>{let v=p*40,h=p<.9?"low":p>1.1?"high":"normal";return l`
              <div class="seasonal-bar ${h} ${d===s?"current":""}"
                   style="height: ${v}px"
    ...
    `}_renderRecentActivities(e){let t=this._lang,i=e.history.slice(0,3);if(i.length===0)return c;let s=a=>{switch(a){case"completed":return"\u2713";case"triggered":return"\u2297";case"skipped":return"\u21B7";case"reset":return"\u21BA";default:return"\xB7"}};return l`
      <div class="recent-activities">
        <h3>${n("recent_activities",t)}</h3>
        ${i.map(a=>l`
          <div class="activity-item">
            <span class="activity-icon">${s(a.type)}</span>
            <span class="activity-date">${Re(a.timestamp,t)}</span>
            <span class="activity-note">${a.notes||"\u2014"}</span>
            ${a.cost?l`<span class="activity-badge">${a.cost.toFixed(0)}€</span>`:c}
            ${a.duration?l`<span class="activity-badge">${a.duration}min</span>`:c}
          </div>
        `)}
    ...
    `}_renderWeibullCardExpanded(e){return this._renderWeibullSection(e)}_renderSeasonalCardExpanded(e){return this._renderSeasonalChart(e)}_renderHistoryFilters(e){let t=this._lang;return l`
      <div class="history-filters-new">
        <div class="filter-chips">
          ${["completed","skipped","reset","triggered"].map(i=>{let s=e.history.filter(a=>a.type===i).length;return s===0?c:l`
    ...
    `}_renderHistoryList(e){let t=this._lang,i=this._historyFilter?e.history.filter(s=>s.type===this._historyFilter):e.history;if(this._historySearch){let s=this._historySearch.toLowerCase();i=i.filter(a=>a.notes?.toLowerCase().includes(s))}return i.length===0?l`<p class="empty">${n("no_history",t)}</p>`:l`
    ...
    `}_renderHistoryChart(e){let t=e.history.filter(y=>y.type==="completed"&&(y.cost!=null||y.duration!=null)).map(y=>({ts:new Date(y.timestamp).getTime(),cost:y.cost??0,duration:y.duration??0})).sort((y,L)=>y.ts-L.ts);if(t.length<2)return c;let i=t.some(y=>y.cost>0),s=t.some(y=>y.duration>0);if(!i&&!s)return c;let a=qt,p=Bt,d=i?32:8,v=s?32:8,h=8,_=20,f=a-d-v,x=p-h-_,$=Math.max(...t.map(y=>y.cost))||1,M=Math.max(...t.map(y=>y.duration))||1,C=Math.min(20,f/t.length*.6),S=f/t.length,F=y=>d+S*y+S/2,b=y=>h+x-y/$*x,T=y=>h+x-y/M*x;return l`
      <div class="sparkline-container">
        <svg class="history-chart" viewBox="0 0 ${a} ${p}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_history",this._lang)}">
          ...
          <text x="${a-v}" y="${p-2}" text-anchor="end" fill="var(--secondary-text-color)" font-size="7">${new Date(t[t.length-1].ts).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</text>
          <!-- Y-axis labels -->
          ${i?H`
          ...
          `:c}
          ${s?H`
            <text x="${a-v+3}" y="${h+4}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="7">${M.toFixed(0)}m</text>
            <text x="${a-v+3}" y="${h+x+3}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="7">0m</text>
          `:c}
        </svg>
      </div>
      <div class="chart-legend">
        ${i?l`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color);opacity:0.6"></span>${n("cost",this._lang)}</span>`:c}
        ${s?l`<span class="legend-item"><span class="legend-swatch" style="background:var(--accent-color, #ff9800)"></span>${n("duration",this._lang)}</span>`:c}
      </div>
    `}_renderSeasonalChart(e){let t=e.seasonal_factors??e.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return c;let i=this._lang,s=e.interval_analysis?.seasonal_reason,a=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"],p=new Date().getMonth(),d=300,v=100,h=8,f=v-h-4,x=Math.max(...t,1.5),$=d/12,M=$*.65,C=h+f-1/x*f;return l`
      <div class="seasonal-chart">
        <div class="seasonal-chart-title">
          ...
          ${s?l`<span class="source-tag">${s==="learned"?n("seasonal_learned",i):n("seasonal_manual",i)}</span>`:c}
        </div>
        <svg viewBox="0 0 ${d} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_seasonal",i)}">
          <!-- Baseline at 1.0 -->
          <line x1="0" y1="${C.toFixed(1)}" x2="${d}" y2="${C.toFixed(1)}"
            stroke="var(--divider-color)" stroke-width="1" stroke-dasharray="4,3" />
          <!-- Bars -->
          ${t.map((S,F)=>{let b=S/x*f,T=F*$+($-M)/2,y=h+f-b,L=F===p,Y=S<1?"var(--success-color, #4caf50)":S>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return H`
              <rect x="${T.toFixed(1)}" y="${y.toFixed(1)}"
                width="${M.toFixed(1)}" height="${b.toFixed(1)}"
                fill="${Y}" opacity="${L?1:.5}" rx="2" />
            `})}
        </svg>
        <div class="seasonal-labels">
          ${a.map((S,F)=>l`<span class="seasonal-label ${F===p?"active-month":""}">${n(S,i)}</span>`)}
        </div>
      </div>
    `}_renderWeibullSection(e){let t=e.interval_analysis,i=t?.weibull_beta,s=t?.weibull_eta;if(i==null||s==null)return c;let a=this._lang,p=t?.weibull_r_squared,d=e.interval_days??0,v=e.suggested_interval??d;return l`
      <div class="weibull-section">
        ...
        ${this._renderWeibullChart(i,s,d,v)}
        ${this._renderWeibullInfo(t,a)}
        ${t?.confidence_interval_low!=null?this._renderConfidenceInterval(t,e,a):c}
      </div>
    ...
    `}_renderWeibullChart(e,t,i,s){let $=Math.max(i,s,t)*1.3,M=50,C=[];for(let P=0;P<=M;P++){let U=P/M*$,R=1-Math.exp(-Math.pow(U/t,e)),E=32+U/$*260,$e=136-R*128;C.push([E,$e])}let S=C.map(([P,U])=>`${P.toFixed(1)},${U.toFixed(1)}`).join(" "),F="M32,136 "+C.map(([P,U])=>`L${P.toFixed(1)},${U.toFixed(1)}`).join(" ")+` L${C[M][0].toFixed(1)},136 Z`,b=32+i/$*260,T=1-Math.exp(-Math.pow(i/t,e)),y=136-T*128,L=((1-T)*100).toFixed(0),Y=32+s/$*260,G=[0,.25,.5,.75,1];return l`
      <div class="weibull-chart">
        <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_weibull",this._lang)}">
          <!-- Grid lines -->
          ${G.map(P=>{let U=136-P*128;return H`
      ...
      <div class="chart-legend">
        ...
        ${i>0?l`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4); opacity:0.5"></span> ${n("current_interval_marker",this._lang)}</span>`:c}
        ${s>0&&s!==i?l`<span class="legend-item"><span class="legend-swatch" style="background:var(--success-color, #4caf50)"></span> ${n("recommended_marker",this._lang)}</span>`:c}
      </div>
    ...
    `}_renderConfidenceInterval(e,t,i){let s=e.confidence_interval_low,a=e.confidence_interval_high,p=t.suggested_interval??t.interval_days??0,d=t.interval_days??0,v=Math.max(0,s-5),_=a+5-v,f=(s-v)/_*100,x=(a-s)/_*100,$=(p-v)/_*100,M=d>0?(d-v)/_*100:-1;return l`
      <div class="confidence-range">
        ...
        <div class="confidence-bar">
          ...
          ${M>=0?l`<div class="confidence-marker current" style="left:${M.toFixed(1)}%"></div>`:c}
        ...
        <div class="prediction-grid">
          ${t?l`
            <div class="prediction-item">
              ...
              ${e.degradation_rate!=null?l`<span class="prediction-rate">${e.degradation_rate>0?"+":""}${Math.abs(e.degradation_rate)>=10?Math.round(e.degradation_rate).toLocaleString():e.degradation_rate.toFixed(1)} ${e.trigger_entity_info?.unit_of_measurement||""}/${n("day_short",a)}</span>`:c}
            </div>
          `:c}
          ${i?l`
            <div class="prediction-item">
              ...
              ${e.threshold_prediction_date?l`<span class="prediction-date">${te(e.threshold_prediction_date,a)}</span>`:c}
              ${e.threshold_prediction_confidence?l`<span class="confidence-dot ${e.threshold_prediction_confidence}"></span>`:c}
            </div>
          `:c}
          ${s&&this._features.environmental?l`
            <div class="prediction-item">
    ...
    `}_renderTriggerSection(e){let t=e.trigger_config;if(!t)return c;let i=this._lang,s=e.trigger_entity_info,a=s?.friendly_name||t.entity_id||"\u2014",p=t.entity_id||"",d=s?.unit_of_measurement||"",v=e.trigger_current_value,h=t.type||"threshold";return l`
      <h3>${n("trigger",i)}</h3>
      <div class="trigger-card">
        ...
        ${v!=null?l`
              <div class="trigger-value-row">
                <span class="trigger-current ${e.trigger_active?"active":""}">${typeof v=="number"?v.toFixed(1):v}</span>
        ...
        <div class="trigger-limits">
          ${h==="threshold"?l`
            ${t.trigger_above!=null?l`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${n("threshold_above",i)}: ${t.trigger_above} ${d}</span>`:c}
            ${t.trigger_below!=null?l`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${n("threshold_below",i)}: ${t.trigger_below} ${d}</span>`:c}
            ${t.trigger_for_minutes?l`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${n("for_minutes",i)}: ${t.trigger_for_minutes}</span>`:c}
          `:c}
          ${h==="counter"?l`
            ${t.trigger_target_value!=null?l`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${n("target_value",i)}: ${t.trigger_target_value} ${d}</span>`:c}
          `:c}
          ${h==="state_change"?l`
            ${t.trigger_target_changes!=null?l`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${n("target_changes",i)}: ${t.trigger_target_changes}</span>`:c}
          `:c}
          ${s?.min!=null?l`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${n("min",i)}: ${s.min} ${d}</span>`:c}
          ${s?.max!=null?l`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${n("max",i)}: ${s.max} ${d}</span>`:c}
        </div>

        ${this._renderSparkline(e,d)}
      </div>
    `}_renderSparkline(e,t){let i=e.trigger_config;if(!i)return c;let s=i.type||"threshold",a=s==="counter"&&i.trigger_delta_mode,p=this._isCounterEntity(i),d=i.entity_id||"",v=this._detailStatsData.get(d)||[],h=[],_=!1;if(v.length>=2)for(let u of v){let w=u.val;a&&e.trigger_baseline_value!=null&&(w-=e.trigger_baseline_value);let D={ts:u.ts,val:w};!p&&u.min!=null&&u.max!=null&&(D.min=a&&e.trigger_baseline_value!=null?u.min-e.trigger_baseline_value:u.min,D.max=a&&e.trigger_baseline_value!=null?u.max-e.trigger_baseline_value:u.max,_=!0),h.push(D)}else for(let u of e.history)u.trigger_value!=null&&h.push({ts:new Date(u.timestamp).getTime(),val:u.trigger_value});if(e.trigger_current_value!=null){let u=e.trigger_current_value;a&&e.trigger_baseline_value!=null&&(u-=e.trigger_baseline_value),h.push({ts:Date.now(),val:u})}if(h.length<2&&d&&this._statsService&&!this._detailStatsData.has(d))return l`<div class="sparkline-container" aria-live="polite" style="display:flex;align-items:center;justify-content:center;height:140px;color:var(--secondary-text-color);font-size:12px;">
        <ha-icon icon="mdi:chart-line" style="--mdc-icon-size:16px;margin-right:8px;"></ha-icon>
        ${n("loading_chart",this._lang)}
      </div>`;if(h.length<2)return c;h.sort((u,w)=>u.ts-w.ts);let f=Nt,x=Vt,$=30,M=2,C=8,S=16,F=h.map(u=>u.val),b=Math.min(...F),T=Math.max(...F);if(_)for(let u of h)u.min!=null&&(b=Math.min(b,u.min)),u.max!=null&&(T=Math.max(T,u.max));i.trigger_above!=null&&(T=Math.max(T,i.trigger_above),b=Math.min(b,i.trigger_above)),i.trigger_below!=null&&(b=Math.min(b,i.trigger_below),T=Math.max(T,i.trigger_below));let y=null,L=null;if(s==="counter"&&i.trigger_target_value!=null){if(e.trigger_baseline_value!=null)y=e.trigger_baseline_value;else if(h.length>0){let u=[...e.history].filter(w=>w.type==="completed"||w.type==="reset").sort((w,D)=>new Date(D.timestamp).getTime()-new Date(w.timestamp).getTime())[0];if(u){let w=new Date(u.timestamp).getTime(),D=h[0],j=Math.abs(h[0].ts-w);for(let B of h){let W=Math.abs(B.ts-w);W<j&&(D=B,j=W)}y=D.val}else y=h[0].val}y!=null?(L=y+i.trigger_target_value,T=Math.max(T,L),b=Math.min(b,y)):(T=Math.max(T,i.trigger_target_value),b=Math.min(b,0))}a&&e.trigger_baseline_value!=null&&(b=Math.min(b,0));let Y=T-b||1;b-=Y*.1,T+=Y*.1;let G=h[0].ts,P=h[h.length-1].ts,U=P-G||1,R=u=>$+(u-G)/U*(f-$-M),E=u=>C+(1-(u-b)/(T-b))*(x-C-S),$e=h.map(u=>`${R(u.ts).toFixed(1)},${E(u.val).toFixed(1)}`).join(" "),lt=`M${R(h[0].ts).toFixed(1)},${x-S} `+h.map(u=>`L${R(u.ts).toFixed(1)},${E(u.val).toFixed(1)}`).join(" ")+` L${R(h[h.length-1].ts).toFixed(1)},${x-S} Z`,we="";if(_){let u=h.filter(w=>w.min!=null&&w.max!=null);if(u.length>=2){let w=u.map(j=>`${R(j.ts).toFixed(1)},${E(j.max).toFixed(1)}`),D=[...u].reverse().map(j=>`${R(j.ts).toFixed(1)},${E(j.min).toFixed(1)}`);we=`M${w[0]} `+w.slice(1).map(j=>`L${j}`).join(" ")+` L${D[0]} `+D.slice(1).map(j=>`L${j}`).join(" ")+" Z"}}let ze=h[h.length-1],ct=R(ze.ts),dt=E(ze.val),Ue=u=>Math.abs(u)>=1e4?(u/1e3).toFixed(0)+"k":u>=1e3?(u/1e3).toFixed(1)+"k":u.toFixed(u<10?1:0),pt=Ue(T),ht=Ue(b),ut=e.history.filter(u=>["completed","skipped","reset"].includes(u.type)).map(u=>({ts:new Date(u.timestamp).getTime(),type:u.type})).filter(u=>u.ts>=G&&u.ts<=P),ke=Wt,Ae=h;if(h.length>ke){let u=(h.length-1)/(ke-1);Ae=[];for(let w=0;w<ke;w++)Ae.push(h[Math.round(w*u)])}return l`
      <div class="sparkline-container">
        <svg class="sparkline-svg" viewBox="0 0 ${f} ${x}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_sparkline",this._lang)}">
          ...
          <!-- X-axis labels -->
          <text x="${$}" y="${x-1}" text-anchor="start" fill="var(--secondary-text-color)" font-size="7">${new Date(G).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</text>
          ...
          ${e.degradation_rate!=null&&e.degradation_trend!=="stable"&&e.degradation_trend!=="insufficient_data"&&h.length>=2?(()=>{let u=h[h.length-1],w=30,D=u.ts+w*864e5,j=u.val+e.degradation_rate*w,B=Math.min(D,P+(P-G)*.3),W=Math.max(b,Math.min(T,j)),gt=R(u.ts),_t=E(u.val),vt=R(B),mt=E(W);return H`<line x1="${gt.toFixed(1)}" y1="${_t.toFixed(1)}" x2="${vt.toFixed(1)}" y2="${mt.toFixed(1)}" stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.7" />`})():c}
          <!-- Threshold lines (for threshold type) -->
          ${s==="threshold"&&i.trigger_above!=null?H`<line x1="${$}" y1="${E(i.trigger_above).toFixed(1)}" x2="${f}" y2="${E(i.trigger_above).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                  <text x="${f-2}" y="${E(i.trigger_above)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">▲ ${i.trigger_above}</text>`:c}
          ${s==="threshold"&&i.trigger_below!=null?H`<line x1="${$}" y1="${E(i.trigger_below).toFixed(1)}" x2="${f}" y2="${E(i.trigger_below).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
          ...
          ${s==="counter"&&L!=null?H`<line x1="${$}" y1="${E(L).toFixed(1)}" x2="${f}" y2="${E(L).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
          ...
          ${s==="counter"&&y!=null?H`<line x1="${$}" y1="${E(y).toFixed(1)}" x2="${f}" y2="${E(y).toFixed(1)}" stroke="var(--secondary-text-color)" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
          ...
          ${Ae.map(u=>{let w=R(u.ts),D=E(u.val),j=new Date(u.ts).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),B=`${u.val.toFixed(1)} ${t}`;return _&&u.min!=null&&u.max!=null&&(B+=` (${u.min.toFixed(1)}\u2013${u.max.toFixed(1)})`),H`<circle cx="${w.toFixed(1)}" cy="${D.toFixed(1)}" r="8" fill="transparent" tabindex="0"
...
`).map(u=>l`<div>${u}</div>`)}
    ...
    `}_showSparklineTooltip(e,t){let i=e.currentTarget,s=i.closest(".sparkline-container");if(!s)return;let a=s.getBoundingClientRect(),p=i.getBoundingClientRect();this._sparklineTooltip={x:p.left-a.left+p.width/2,y:p.top-a.top-8,text:t}}_renderHistoryEntry(e){let t=this._lang;return l`
      <div class="history-entry">
        <div class="history-icon ${e.type}">
          <ha-icon .icon=${at[e.type]||"mdi:circle"}></ha-icon>
        </div>
    ...
    `],g([z({attribute:!1})],A.prototype,"hass",2),g([z({type:Boolean})],A.prototype,"narrow",2),g([z({attribute:!1})],A.prototype,"panel",2),g([m()],A.prototype,"_objects",2),g([m()],A.prototype,"_stats",2),g([m()],A.prototype,"_view",2),g([m()],A.prototype,"_selectedEntryId",2),g([m()],A.prototype,"_selectedTaskId",2),g([m()],A.prototype,"_filterStatus",2),g([m()],A.prototype,"_filterUser",2),g([m()],A.prototype,"_unsub",2),g([m()],A.prototype,"_sparklineTooltip",2),g([m()],A.prototype,"_historyFilter",2),g([m()],A.prototype,"_budget",2),g([m()],A.prototype,"_groups",2),g([m()],A.prototype,"_detailStatsData",2),g([m()],A.prototype,"_miniStatsData",2),g([m()],A.prototype,"_features",2),g([m()],A.prototype,"_activeTab",2),g([m()],A.prototype,"_costDurationToggle",2),g([m()],A.prototype,"_historyTimeRange",2),g([m()],A.prototype,"_historySearch",2),A=g([Z("maintenance-supporter-panel")],A);export{A as MaintenanceSupporterPanel};
