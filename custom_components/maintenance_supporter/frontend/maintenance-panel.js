...
`).map(c=>c.trim()).filter(Boolean).slice(0,100);e.checklist=o.length?o:null}if(this.completionActionsEnabled){let o=this._actionService.trim();if(o&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(o)){let m={service:o},h=this._actionTargetEntity.trim();h&&(m.target={entity_id:h});let v=this._buildActionData();Object.keys(v).length>0&&(m.data=v),e.on_complete_action=m}else e.on_complete_action=null;let c={};this._qcNotes.trim()&&(c.notes=this._qcNotes.trim());let _=parseFloat(this._qcCost);!isNaN(_)&&_>=0&&(c.cost=_);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(c.duration=g),this._qcFeedback&&(c.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(c).length?c:null}let t=await this.hass.connection.sendMessagePromise(e),a=this._taskId||t?.task_id,s=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(a&&this._scheduleType==="sensor_based"&&s)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=Q(e,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return d;let e=this._lang;return r`
      ...
      <div class="select-row">
        ...
        >
          ${ka.map(t=>r`<option value=${t} ?selected=${t===this._triggerType}>${i(t,e)}</option>`)}
        </select>
      </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${ba.map(a=>r`<option value=${a} ?selected=${a===this._type}>${i(a,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${ya.map(a=>r`<option value=${a} ?selected=${a===this._scheduleType}>${i(a,e)}</option>`)}
            </select>
          </div>
  ...
  `,p([$({attribute:!1})],y.prototype,"hass",2),p([$({type:Boolean,attribute:"checklists-enabled"})],y.prototype,"checklistsEnabled",2),p([$({type:Boolean,attribute:"schedule-time-enabled"})],y.prototype,"scheduleTimeEnabled",2),p([$({type:Boolean,attribute:"completion-actions-enabled"})],y.prototype,"completionActionsEnabled",2),p([$({type:Number,attribute:"default-warning-days"})],y.prototype,"defaultWarningDays",2),p([u()],y.prototype,"_open",2),p([u()],y.prototype,"_loading",2),p([u()],y.prototype,"_error",2),p([u()],y.prototype,"_entryId",2),p([u()],y.prototype,"_taskId",2),p([u()],y.prototype,"_objectChoices",2),p([u()],y.prototype,"_name",2),p([u()],y.prototype,"_type",2),p([u()],y.prototype,"_scheduleType",2),p([u()],y.prototype,"_intervalDays",2),p([u()],y.prototype,"_warningDays",2),p([u()],y.prototype,"_intervalAnchor",2),p([u()],y.prototype,"_notes",2),p([u()],y.prototype,"_documentationUrl",2),p([u()],y.prototype,"_customIcon",2),p([u()],y.prototype,"_enabled",2),p([u()],y.prototype,"_triggerEntityId",2),p([u()],y.prototype,"_triggerEntityIds",2),p([u()],y.prototype,"_triggerEntityLogic",2),p([u()],y.prototype,"_triggerAttribute",2),p([u()],y.prototype,"_triggerType",2),p([u()],y.prototype,"_triggerAbove",2),p([u()],y.prototype,"_triggerBelow",2),p([u()],y.prototype,"_triggerForMinutes",2),p([u()],y.prototype,"_triggerTargetValue",2),p([u()],y.prototype,"_triggerDeltaMode",2),p([u()],y.prototype,"_triggerFromState",2),p([u()],y.prototype,"_triggerToState",2),p([u()],y.prototype,"_triggerTargetChanges",2),p([u()],y.prototype,"_triggerRuntimeHours",2),p([u()],y.prototype,"_suggestedAttributes",2),p([u()],y.prototype,"_availableAttributes",2),p([u()],y.prototype,"_entityDomain",2),p([u()],y.prototype,"_lastPerformed",2),p([u()],y.prototype,"_nfcTagId",2),p([u()],y.prototype,"_availableTags",2),p([u()],y.prototype,"_responsibleUserId",2),p([u()],y.prototype,"_availableUsers",2),p([u()],y.prototype,"_checklistText",2),p([u()],y.prototype,"_scheduleTime",2),p([u()],y.prototype,"_actionService",2),p([u()],y.prototype,"_actionTargetEntity",2),p([u()],y.prototype,"_actionData",2),p([u()],y.prototype,"_actionDataJsonFallback",2),p([u()],y.prototype,"_actionTesting",2),p([u()],y.prototype,"_actionTestResult",2),p([u()],y.prototype,"_qcNotes",2),p([u()],y.prototype,"_qcCost",2),p([u()],y.prototype,"_qcDuration",2),p([u()],y.prototype,"_qcFeedback",2),p([u()],y.prototype,"_environmentalEntity",2),p([u()],y.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",y);var D=class extends q{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed"}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed")}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=Q(e,this.lang,i("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return r``;let e=this.lang||this.hass?.language||"en";return r`
      <ha-dialog open @closed=${this._close}>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,p([$({attribute:!1})],B.prototype,"hass",2),p([u()],B.prototype,"_open",2),p([u()],B.prototype,"_title",2),p([u()],B.prototype,"_message",2),p([u()],B.prototype,"_confirmText",2),p([u()],B.prototype,"_danger",2),p([u()],B.prototype,"_inputLabel",2),p([u()],B.prototype,"_inputType",2),p([u()],B.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",B);var bt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},yt=l=>(...n)=>({_$litDirective$:l,values:n}),Se=class{constructor(n){}get _$AU(){return this._$AM._$AU}_$AT(n,e,t){this._$Ct=n,this._$AM=e,this._$Ci=t}_$AS(n,e){return this.update(n,e)}update(n,e){return this.render(...e)}};var be=class extends Se{constructor(n){if(super(n),this.it=d,n.type!==bt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(n){if(n===d||n==null)return this._t=void 0,this.it=n;if(n===Y)return n;if(typeof n!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(n===this.it)return this._t;this.it=n;let e=[n];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};be.directiveName="unsafeHTML",be.resultType=1;var kt=yt(be);var wa=["EUR","USD","GBP","JPY","CHF","CAD","AUD","CNY","INR","BRL","CZK","PLN","RUB","SEK","NOK","DKK","UAH"],E=class extends q{constructor(){super(...arguments);this.budget=null;this._settings=null;this._loading=!0;this._importCsv="";this._importLoading=!1;this._includeHistory=!0;this._toast="";this._testingNotification=!1;this._users=[];this._vacEnabled=!1;this._vacStart="";this._vacEnd="";this._vacBuffer=3;this._vacExempt=new Set;this._vacIsActive=!1;this._vacWindowEnd=null;this._vacAllTasks=[];this._vacPreview=[];this._vacPreviewLoading=!1;this._vacSaving=!1;this._qrObjects=[];this._qrSelectedEntries=new Set;this._qrActions=new Set(["view"]);this._qrUrlMode="companion";this._qrBatchLoading=!1;this._qrBatchResults=[];this._qrObjectsLoaded=!1;this._loaded=!1;this._userService=null;this._sendTestNotification=async()=>{this._testingNotification=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/test_notification"}),t=e.message||(e.success?i("test_notification_success",this._lang):i("test_notification_failed",this._lang));this._showToast(t)}catch{this._showToast(i("test_notification_failed",this._lang))}finally{this._testingNotification=!1}}}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded?(this._loaded=!0,this._userService=new ie(this.hass),this._loadSettings(),this._loadUsers()):e.has("hass")&&this.hass&&this._userService&&this._userService.updateHass(this.hass)}async _loadUsers(){if(this._userService)try{this._users=await this._userService.getUsers()}catch{this._users=[]}}async _loadSettings(){this._loading=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});this._settings=e,this._hydrateVacationFromSettings()}catch{}this._loading=!1}_hydrateVacationFromSettings(){let e=this._settings?.vacation;e&&(this._vacEnabled=e.enabled,this._vacStart=e.start||"",this._vacEnd=e.end||"",this._vacBuffer=e.buffer_days,this._vacExempt=new Set(e.exempt_task_ids||[]),this._vacIsActive=e.is_active,this._vacWindowEnd=e.window_end)}async _updateSetting(e,t){try{let a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:{[e]:t}});this._settings=a,this._showToast(i("settings_saved",this._lang)),this.dispatchEvent(new CustomEvent("settings-changed"))}catch{this._showToast(i("action_error",this._lang))}}_showToast(e){this._toast=e,setTimeout(()=>{this._toast=""},3e3)}_downloadFile(e,t,a){let s=new Blob([e],{type:a}),o=URL.createObjectURL(s),c=document.createElement("a");c.href=o,c.download=t,c.click(),URL.revokeObjectURL(o)}render(){let e=this._lang;return this._loading||!this._settings?r`<div class="settings-loading">Loading…</div>`:r`
    ...
    `}_renderPanelAccess(e){let t=new Set(this._settings.admin_panel_user_ids||[]),a=this._users.filter(o=>!o.is_admin),s=(o,c)=>{let _=new Set(t);c?_.add(o):_.delete(o),this._updateSetting("admin_panel_user_ids",[..._])};return r`
    ...
    `}_renderGeneral(e){let t=this._settings.general;return r`
      <div class="settings-section">
      ...
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select @change=${a=>this._updateSetting("budget_currency",a.target.value)}>
            ${wa.map(a=>r`<option value=${a} ?selected=${t.currency===a}>${a}</option>`)}
          </select>
        </label>
        <label class="setting-row">
    ...
    `}_renderVacationTaskList(e){let t=new Map;for(let s of this._vacAllTasks){let o=t.get(s.object_name)||[];o.push(s),t.set(s.object_name,o)}return[...t.entries()].sort(([s],[o])=>s.localeCompare(o)).map(([s,o])=>r`
    ...
    `)}_renderVacationPreview(e){return r`
      <div class="vac-preview-list">
        ${this._vacPreview.map(t=>{let a=t.events.map(o=>{let c=`vacation_event_${o.status}`;return`${o.date} (${i(c,e)})`}).join(" \xB7 "),s=!t.will_suppress;return r`
...
<body>
  ...
  `,p([$({attribute:!1})],E.prototype,"hass",2),p([$({attribute:!1})],E.prototype,"features",2),p([$({attribute:!1})],E.prototype,"budget",2),p([u()],E.prototype,"_settings",2),p([u()],E.prototype,"_loading",2),p([u()],E.prototype,"_importCsv",2),p([u()],E.prototype,"_importLoading",2),p([u()],E.prototype,"_includeHistory",2),p([u()],E.prototype,"_toast",2),p([u()],E.prototype,"_testingNotification",2),p([u()],E.prototype,"_users",2),p([u()],E.prototype,"_vacEnabled",2),p([u()],E.prototype,"_vacStart",2),p([u()],E.prototype,"_vacEnd",2),p([u()],E.prototype,"_vacBuffer",2),p([u()],E.prototype,"_vacExempt",2),p([u()],E.prototype,"_vacIsActive",2),p([u()],E.prototype,"_vacWindowEnd",2),p([u()],E.prototype,"_vacAllTasks",2),p([u()],E.prototype,"_vacPreview",2),p([u()],E.prototype,"_vacPreviewLoading",2),p([u()],E.prototype,"_vacSaving",2),p([u()],E.prototype,"_qrObjects",2),p([u()],E.prototype,"_qrSelectedEntries",2),p([u()],E.prototype,"_qrActions",2),p([u()],E.prototype,"_qrUrlMode",2),p([u()],E.prototype,"_qrBatchLoading",2),p([u()],E.prototype,"_qrBatchResults",2),p([u()],E.prototype,"_qrObjectsLoaded",2);customElements.define("maintenance-settings-view",E);var $a=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"],G=class extends q{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._error="";this._entryId="";this._taskId="";this._values=new Array(12).fill("");this._save=async()=>{let e=this._buildOverrides();if(e!==null){this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:e}),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(t){this._error=Q(t,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}};this._clearAll=async()=>{this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:{}}),this._values=new Array(12).fill(""),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(e){this._error=Q(e,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}open(e,t,a){if(this._entryId=e,this._taskId=t,this._values=new Array(12).fill(""),a)for(let[s,o]of Object.entries(a)){let c=parseInt(s,10);c>=1&&c<=12&&typeof o=="number"&&(this._values[c-1]=o.toString())}this._error="",this._open=!0}_close(){this._open=!1}_buildOverrides(){let e={};for(let t=0;t<12;t++){let a=this._values[t].trim();if(!a)continue;let s=parseFloat(a);if(Number.isNaN(s))return this._error=`${i("month_"+["jan","feb","mar","apr","may","jun","jul","aug","sep","oct","nov","dec"][t],this._lang)}: ${i("seasonal_override_invalid",this._lang)}`,null;if(s<.1||s>5)return this._error=i("seasonal_override_range",this._lang),null;e[t+1]=s}return e}render(){if(!this._open)return r``;let e=this._lang;return r`
      ...
      <ha-dialog open @closed=${this._close} heading="${t}">
        <div class="content">
          ...
          ${this.objects.length===0?r`<div class="hint">${i("no_objects",e)}</div>`:r`
              <div class="objects">
                ${[...this.objects].sort((a,s)=>a.object.name.localeCompare(s.object.name)).map(a=>r`
                  <div class="object-block">
                    <div class="object-name">${a.object.name}</div>
                    ${a.tasks.length===0?r`<div class="hint small">${i("no_tasks_short",e)}</div>`:[...a.tasks].sort((s,o)=>s.name.localeCompare(o.name)).map(s=>{let o=`${a.entry_id}:${s.id}`,c=this._selected.has(o);return r`
  ...
  `,p([$({attribute:!1})],V.prototype,"hass",2),p([$({attribute:!1})],V.prototype,"objects",2),p([u()],V.prototype,"_open",2),p([u()],V.prototype,"_loading",2),p([u()],V.prototype,"_error",2),p([u()],V.prototype,"_groupId",2),p([u()],V.prototype,"_name",2),p([u()],V.prototype,"_description",2),p([u()],V.prototype,"_selected",2);customElements.get("maintenance-group-dialog")||customElements.define("maintenance-group-dialog",V);var za=300,Ea=140,We=27;function wt(l,n){let e=l.trigger_config;if(!e)return d;let t=n.lang,a=l.trigger_entity_info,s=l.trigger_entity_infos,o=a?.friendly_name||e.entity_id||"\u2014",c=e.entity_id||"",_=e.entity_ids||(c?[c]:[]),g=a?.unit_of_measurement||"",m=l.trigger_current_value,h=e.type||"threshold",v=_.length>1;return r`
    <h3>${i("trigger",t)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${v?r`
            ...
            <div class="trigger-entity-id">${_.map((b,k)=>r`${k>0?", ":""}<span class="entity-link" @click=${S=>re(S,b)}>${b}</span>`)}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `:r`
            <div class="trigger-entity-name">${o}</div>
            <div class="trigger-entity-id">${c?r`<span class="entity-link" @click=${b=>re(b,c)}>${c}</span>`:""}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `}
        </div>
      ...
      <div class="trigger-limits">
        ...
        ${h==="compound"?r`
          ...
          ${(e.conditions||[]).map((b,k)=>r`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${k+1}. ${i(b.type||"unknown",t)}: ${b.entity_id?r`<span class="entity-link" @click=${S=>re(S,b.entity_id)}>${b.entity_id}</span>`:""}</span>
          `)}
        `:d}
      ...
      ${s&&s.length>1?r`
        <div class="trigger-entity-list">
          ${s.map(b=>r`
            <span class="trigger-entity-id">${b.friendly_name} (<span class="entity-link" @click=${k=>re(k,b.entity_id)}>${b.entity_id}</span>)</span>
          `)}
        </div>
      `:d}
  ...
  `}function Aa(l,n,e){let t=l.trigger_config;if(!t)return d;let a=t.type||"threshold",s=a==="counter"&&t.trigger_delta_mode,o=e.isCounterEntity(t),c=t.entity_id||"",_=e.detailStatsData.get(c)||[],g=[],m=!1;if(_.length>=2)for(let f of _){let A=f.val;s&&l.trigger_baseline_value!=null&&(A-=l.trigger_baseline_value);let F={ts:f.ts,val:A};!o&&f.min!=null&&f.max!=null&&(F.min=s&&l.trigger_baseline_value!=null?f.min-l.trigger_baseline_value:f.min,F.max=s&&l.trigger_baseline_value!=null?f.max-l.trigger_baseline_value:f.max,m=!0),g.push(F)}else for(let f of l.history)f.trigger_value!=null&&g.push({ts:new Date(f.timestamp).getTime(),val:f.trigger_value});if(l.trigger_current_value!=null){let f=l.trigger_current_value;s&&l.trigger_baseline_value!=null&&(f-=l.trigger_baseline_value),g.push({ts:Date.now(),val:f})}if(g.length<2&&c&&e.hasStatsService&&!e.detailStatsData.has(c))return r`<div class="sparkline-container" aria-live="polite" style="display:flex;align-items:center;justify-content:center;height:140px;color:var(--secondary-text-color);font-size:12px;">
      <ha-icon icon="mdi:chart-line" style="--mdc-icon-size:16px;margin-right:8px;"></ha-icon>
      ${i("loading_chart",e.lang)}
    </div>`;if(g.length<2)return d;g.sort((f,A)=>f.ts-A.ts);let h=za,v=Ea,b=30,k=2,S=8,O=16,M=g.map(f=>f.val),j=Math.min(...M),x=Math.max(...M);if(m)for(let f of g)f.min!=null&&(j=Math.min(j,f.min)),f.max!=null&&(x=Math.max(x,f.max));t.trigger_above!=null&&(x=Math.max(x,t.trigger_above),j=Math.min(j,t.trigger_above)),t.trigger_below!=null&&(j=Math.min(j,t.trigger_below),x=Math.max(x,t.trigger_below));let C=null,U=null;if(a==="counter"&&t.trigger_target_value!=null){if(l.trigger_baseline_value!=null)C=l.trigger_baseline_value;else if(g.length>0){let f=[...l.history].filter(A=>A.type==="completed"||A.type==="reset").sort((A,F)=>new Date(F.timestamp).getTime()-new Date(A.timestamp).getTime())[0];if(f){let A=new Date(f.timestamp).getTime(),F=g[0],L=Math.abs(g[0].ts-A);for(let X of g){let ee=Math.abs(X.ts-A);ee<L&&(F=X,L=ee)}C=F.val}else C=g[0].val}C!=null?(U=C+t.trigger_target_value,x=Math.max(x,U),j=Math.min(j,C)):(x=Math.max(x,t.trigger_target_value),j=Math.min(j,0))}s&&l.trigger_baseline_value!=null&&(j=Math.min(j,0));let Z=x-j||1;j-=Z*.1,x+=Z*.1;let K=g[0].ts,P=g[g.length-1].ts,w=P-K||1,N=f=>b+(f-K)/w*(h-b-k),T=f=>S+(1-(f-j)/(x-j))*(v-S-O),qe=g.map(f=>`${N(f.ts).toFixed(1)},${T(f.val).toFixed(1)}`).join(" "),Tt=`M${N(g[0].ts).toFixed(1)},${v-O} `+g.map(f=>`L${N(f.ts).toFixed(1)},${T(f.val).toFixed(1)}`).join(" ")+` L${N(g[g.length-1].ts).toFixed(1)},${v-O} Z`,Te="";if(m){let f=g.filter(A=>A.min!=null&&A.max!=null);if(f.length>=2){let A=f.map(L=>`${N(L.ts).toFixed(1)},${T(L.max).toFixed(1)}`),F=[...f].reverse().map(L=>`${N(L.ts).toFixed(1)},${T(L.min).toFixed(1)}`);Te=`M${A[0]} `+A.slice(1).map(L=>`L${L}`).join(" ")+` L${F[0]} `+F.slice(1).map(L=>`L${L}`).join(" ")+" Z"}}let Qe=g[g.length-1],Mt=N(Qe.ts),Ct=T(Qe.val),Ge=f=>Math.abs(f)>=1e4?(f/1e3).toFixed(0)+"k":f>=1e3?(f/1e3).toFixed(1)+"k":f.toFixed(f<10?1:0),Nt=Ge(x),It=Ge(j),Rt=l.history.filter(f=>["completed","skipped","reset"].includes(f.type)).map(f=>({ts:new Date(f.timestamp).getTime(),type:f.type})).filter(f=>f.ts>=K&&f.ts<=P),Me=g;if(g.length>We){let f=(g.length-1)/(We-1);Me=[];for(let A=0;A<We;A++)Me.push(g[Math.round(A*f)])}return r`
    <div class="sparkline-container">
      <svg class="sparkline-svg" viewBox="0 0 ${h} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_sparkline",e.lang)}">
        <text x="${b-3}" y="${S+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${Nt}</text>
        <text x="${b-3}" y="${v-O+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${It}</text>
        <text x="${b}" y="${v-1}" text-anchor="start" fill="var(--secondary-text-color)" font-size="7">${new Date(K).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</text>
        ...
        ${Te?R`<path d="${Te}" fill="var(--primary-color)" opacity="0.08" />`:d}
        <path d="${Tt}" fill="var(--primary-color)" opacity="0.15" />
        <polyline points="${qe}" fill="none" stroke="var(--primary-color)" stroke-width="2" stroke-linejoin="round" />
        ${l.degradation_rate!=null&&l.degradation_trend!=="stable"&&l.degradation_trend!=="insufficient_data"&&g.length>=2?(()=>{let f=g[g.length-1],A=30,F=f.ts+A*864e5,L=f.val+l.degradation_rate*A,X=Math.min(F,P+(P-K)*.3),ee=Math.max(j,Math.min(x,L)),Pt=N(f.ts),Dt=T(f.val),Ft=N(X),Lt=T(ee);return R`<line x1="${Pt.toFixed(1)}" y1="${Dt.toFixed(1)}" x2="${Ft.toFixed(1)}" y2="${Lt.toFixed(1)}" stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.7" />`})():d}
        ${a==="threshold"&&t.trigger_above!=null?R`<line x1="${b}" y1="${T(t.trigger_above).toFixed(1)}" x2="${h}" y2="${T(t.trigger_above).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${T(t.trigger_above)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25B2 ${t.trigger_above}</text>`:d}
        ${a==="threshold"&&t.trigger_below!=null?R`<line x1="${b}" y1="${T(t.trigger_below).toFixed(1)}" x2="${h}" y2="${T(t.trigger_below).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${T(t.trigger_below)+11}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25BC ${t.trigger_below}</text>`:d}
        ${a==="counter"&&U!=null?R`<line x1="${b}" y1="${T(U).toFixed(1)}" x2="${h}" y2="${T(U).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${T(U)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">${i("target_value",e.lang)}: +${t.trigger_target_value}</text>`:d}
        ${a==="counter"&&C!=null?R`<line x1="${b}" y1="${T(C).toFixed(1)}" x2="${h}" y2="${T(C).toFixed(1)}" stroke="var(--secondary-text-color)" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
                <text x="${b+2}" y="${T(C)+11}" text-anchor="start" fill="var(--secondary-text-color)" font-size="8">${i("baseline",e.lang)}</text>`:d}
        <circle cx="${Mt.toFixed(1)}" cy="${Ct.toFixed(1)}" r="3.5" fill="var(--primary-color)" />
        ${Rt.map(f=>{let A=N(f.ts),F=f.type==="completed"?"var(--success-color, #4caf50)":f.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return R`
            <line x1="${A.toFixed(1)}" y1="${S}" x2="${A.toFixed(1)}" y2="${v-O}" stroke="${F}" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
            <circle cx="${A.toFixed(1)}" cy="${S+2}" r="5" fill="${F}" opacity="0.8" />
            <text x="${A.toFixed(1)}" y="${S+6}" text-anchor="middle" fill="white" font-size="7" font-weight="bold">${f.type==="completed"?"\u2713":f.type==="skipped"?"\u23ED":"\u21BA"}</text>
          `})}
        ${Me.map(f=>{let A=N(f.ts),F=T(f.val),L=new Date(f.ts).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),X=`${f.val.toFixed(1)} ${n}`;return m&&f.min!=null&&f.max!=null&&(X+=` (${f.min.toFixed(1)}\u2013${f.max.toFixed(1)})`),R`<circle cx="${A.toFixed(1)}" cy="${F.toFixed(1)}" r="8" fill="transparent" tabindex="0"
...
`).map(f=>r`<div>${f}</div>`)}
  ...
  `}function xt(l,n,e){let t=l.currentTarget,a=t.closest(".sparkline-container");if(!a)return;let s=a.getBoundingClientRect(),o=t.getBoundingClientRect();e({x:o.left-s.left+o.width/2,y:o.top-s.top-8,text:n})}function $t(l,n,e){let t=l.degradation_trend!=null&&l.degradation_trend!=="insufficient_data",a=l.days_until_threshold!=null,s=l.environmental_factor!=null&&l.environmental_factor!==1;if(!t&&!a&&!s)return d;let o=l.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":l.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return r`
    <div class="prediction-section">
      ${l.sensor_prediction_urgency?r`
        <div class="prediction-urgency-banner">
          <ha-svg-icon path="M1,21H23L12,2L1,21M12,18A1,1 0 0,1 11,17A1,1 0 0,1 12,16A1,1 0 0,1 13,17A1,1 0 0,1 12,18M13,15H11V10H13V15Z"></ha-svg-icon>
          ${i("sensor_prediction_urgency",n).replace("{days}",String(Math.round(l.days_until_threshold||0)))}
        </div>
      `:d}
      ...
      <div class="prediction-grid">
        ${t?r`
          <div class="prediction-item">
            ...
            <span class="prediction-value ${l.degradation_trend}">${i("trend_"+l.degradation_trend,n)}</span>
            ${l.degradation_rate!=null?r`<span class="prediction-rate">${l.degradation_rate>0?"+":""}${Math.abs(l.degradation_rate)>=10?Math.round(l.degradation_rate).toLocaleString():l.degradation_rate.toFixed(1)} ${l.trigger_entity_info?.unit_of_measurement||""}/${i("day_short",n)}</span>`:d}
          </div>
        `:d}
        ${a?r`
          <div class="prediction-item">
            ...
            <span class="prediction-value prediction-days${l.days_until_threshold===0?" exceeded":l.sensor_prediction_urgency?" urgent":""}">${l.days_until_threshold===0?i("threshold_exceeded",n):"~"+Math.round(l.days_until_threshold)+" "+i("days",n)}</span>
            ${l.threshold_prediction_date?r`<span class="prediction-date">${ae(l.threshold_prediction_date,n)}</span>`:d}
  ...
  `}function zt(l,n){let e=l.interval_analysis,t=e?.weibull_beta,a=e?.weibull_eta;if(t==null||a==null||a<=0)return d;let s=l.interval_days??0,o=l.suggested_interval??s;return r`
  ...
  `}function qa(l,n){return r`
    <div class="weibull-info-row">
      <div class="weibull-info-item">
        <span>${i("characteristic_life",n)}</span>
        <span class="weibull-info-value">${Math.round(l.weibull_eta)} ${i("days",n)}</span>
      </div>
  ...
  `}function Ta(l,n,e){let t=l.confidence_interval_low,a=l.confidence_interval_high,s=n.suggested_interval??n.interval_days??0,o=n.interval_days??0,c=Math.max(0,t-5),g=a+5-c,m=(t-c)/g*100,h=(a-t)/g*100,v=(s-c)/g*100,b=o>0?(o-c)/g*100:-1;return r`
  ...
  `}var Et=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function At(l,n,e){if(!e.seasonal||!l.seasonal_factor||l.seasonal_factor===1)return d;let t=Et.map(c=>i(c,n)),a=new Date().getMonth(),s=l.seasonal_factors||l.interval_analysis?.seasonal_factors||null,o=s&&s.length===12?s:t.map((c,_)=>{let g=l.seasonal_factor||1,m=Math.sin((_-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,g+m))});return r`
  ...
  `}function jt(l,n){return Ma(l,n)}function Ma(l,n){let e=l.seasonal_factors??l.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return d;let t=l.interval_analysis?.seasonal_reason,a=new Date().getMonth(),s=300,o=100,c=8,g=o-c-4,m=Math.max(...e,1.5),h=s/12,v=h*.65,b=c+g-1/m*g;return r`
    <div class="seasonal-chart">
      <div class="seasonal-chart-title">
        ...
        ${t?r`<span class="source-tag">${t==="learned"?i("seasonal_learned",n):i("seasonal_manual",n)}</span>`:d}
      </div>
      <svg viewBox="0 0 ${s} ${o}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_seasonal",n)}">
        ...
        ${e.map((k,S)=>{let O=k/m*g,M=S*h+(h-v)/2,j=c+g-O,x=S===a,C=k<1?"var(--success-color, #4caf50)":k>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return R`
      ...
      <div class="seasonal-labels">
        ${Et.map((k,S)=>r`<span class="seasonal-label ${S===a?"active-month":""}">${i(k,n)}</span>`)}
      </div>
    </div>
  `}var Ca=300,Na=200;function St(l,n,e,t){let a=l.history.filter(c=>c.type==="completed"&&(c.cost!=null||c.duration!=null));if(a.length<2)return d;let s=a.some(c=>(c.cost??0)>0),o=a.some(c=>(c.duration??0)>0);return!s&&!o?d:r`
  ...
  `}function Ia(l,n,e){let t=l.history.filter(w=>w.type==="completed"&&(w.cost!=null||w.duration!=null)).map(w=>({ts:new Date(w.timestamp).getTime(),cost:w.cost??0,duration:w.duration??0})).sort((w,N)=>w.ts-N.ts);if(t.length<2)return d;let a=t.some(w=>w.cost>0),s=t.some(w=>w.duration>0);if(!a&&!s)return d;let o=e!=="duration"&&a,c=e!=="cost"&&s,_=o||!c&&a,g=c||!o&&s,m=Ca,h=Na,v=_?32:8,b=g?32:8,k=8,S=20,O=m-v-b,M=h-k-S,j=Math.max(...t.map(w=>w.cost))||1,x=Math.max(...t.map(w=>w.duration))||1,C=Math.min(20,O/t.length*.6),U=O/t.length,Z=w=>v+U*w+U/2,K=w=>k+M-w/j*M,P=w=>k+M-w/x*M;return r`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${m} ${h}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_history",n)}">
        ${_?t.map((w,N)=>R`
          <rect x="${(Z(N)-C/2).toFixed(1)}" y="${K(w.cost).toFixed(1)}" width="${C.toFixed(1)}" height="${(k+M-K(w.cost)).toFixed(1)}"
            fill="var(--primary-color)" opacity="0.6" rx="2" />
        `):d}
        ${g?R`
          <polyline points="${t.map((w,N)=>`${Z(N).toFixed(1)},${P(w.duration).toFixed(1)}`).join(" ")}"
            fill="none" stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-linejoin="round" />
          ${t.map((w,N)=>R`
            <circle cx="${Z(N).toFixed(1)}" cy="${P(w.duration).toFixed(1)}" r="3" fill="var(--accent-color, #ff9800)" />
          `)}
        `:d}
  ...
  `}var Ra=60,Pa=20,qt=30,z=class extends q{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._unsub=null;this._sparklineTooltip=null;this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._defaultWarningDays=7;this._actionLoading=!1;this._moreMenuOpen=!1;this._toastMessage="";this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab="dashboard";this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=e=>this._onPopState(e);this._deepLinkHandled=!1;this._onDialogEvent=async()=>{try{await this._loadData()}catch{}}}get _lang(){return this.hass?.language||"en"}get _isOperator(){let e=this.hass?.user;return e?e.is_admin?!1:!this._adminPanelUserIds.includes(e.id):!0}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._popstateHandler);let e=localStorage.getItem("maintenance_supporter_sort");e&&["due_date","object","type","task_name","area","assigned_user","group"].includes(e)&&(this._sortMode=e);let t=localStorage.getItem("maintenance_supporter_object_sort");t&&["alphabetical","due_soonest","task_count"].includes(t)&&(this._objectSortMode=t);let a=localStorage.getItem("maintenance_supporter_groupby");a&&["none","area","group","user"].includes(a)&&(this._groupByMode=a)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(e){if(super.updated(e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new je(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new ie(this.hass),this._userService.getUsers())}}async _loadData(){let[e,t,a,s,o]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null)]);if(e&&(this._objects=e.objects),t&&(this._stats=t),a&&(this._budget=a),s&&(this._groups=s.groups||{}),o){let c=o;this._features=c.features,this._adminPanelUserIds=c.admin_panel_user_ids||[];let _=c.general?.default_warning_days;typeof _=="number"&&_>=0&&_<=365&&(this._defaultWarningDays=_)}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search),t=e.get("entry_id");if(!t)return;this._deepLinkHandled=!0;let a=e.get("task_id"),s=e.get("action"),o=window.location.pathname+window.location.hash;history.replaceState(history.state,"",o);let c=this._getObject(t);if(!c){this._showOverview();return}if(a){let _=c.tasks.find(g=>g.id===a);if(!_){this._showObject(t);return}this._showTask(t,a),s==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(t,a,_.name,this._features.checklists?_.checklist:void 0,this._features.adaptive&&!!_.adaptive_config?.enabled)}):s==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(t,a,_)})}else this._showObject(t)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let a=await this._statsService.getDetailStats(e,t),s=new Map(this._detailStatsData);s.set(e,a),this._detailStatsData=s}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=[];for(let a of this._objects)for(let s of a.tasks){let o=s.trigger_config?.entity_id;o&&e.push({entityId:o,isCounter:this._isCounterEntity(s.trigger_config)})}if(e.length===0)return;let t=await this._statsService.getBatchMiniStats(e);this._miniStatsData=new Map([...this._miniStatsData,...t])}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _taskRows(){let e=[];for(let h of this._objects)for(let v of h.tasks){if(this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let k=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==k)continue}let b=[];for(let k of Object.values(this._groups))k.task_refs?.some(S=>S.entry_id===h.entry_id&&S.task_id===v.id)&&b.push(k.name);e.push({entry_id:h.entry_id,task_id:v.id,object_name:h.object.name,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_anchor:v.interval_anchor??null,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,area_id:h.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:b})}let t={overdue:0,triggered:1,due_soon:2,ok:3},a=(h,v)=>(t[h.status]??9)-(t[v.status]??9),s=(h,v)=>(h.days_until_due??99999)-(v.days_until_due??99999),o=(h,v)=>a(h,v)||s(h,v),c=h=>h.area_id&&this.hass?.areas?.[h.area_id]?.name||"",_=h=>h.responsible_user_id&&this._userService?.getUserName(h.responsible_user_id)||"",g=h=>h.group_names[0]||"",m={due_date:o,object:(h,v)=>h.object_name.localeCompare(v.object_name)||o(h,v),type:(h,v)=>h.type.localeCompare(v.type)||o(h,v),task_name:(h,v)=>h.task_name.localeCompare(v.task_name),area:(h,v)=>{let b=c(h),k=c(v);return!b&&k?1:b&&!k?-1:b.localeCompare(k)||o(h,v)},assigned_user:(h,v)=>{let b=_(h),k=_(v);return!b&&k?1:b&&!k?-1:b.localeCompare(k)||o(h,v)},group:(h,v)=>{let b=g(h),k=g(v);return!b&&k?1:b&&!k?-1:b.localeCompare(k)||o(h,v)}};return e.sort(m[this._sortMode]),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(s=>s.id===t)}_pushPanelState(e,t,a){let s={msp_view:e,msp_entry:t||null,msp_task:a||null};history.pushState(s,"")}_onPopState(e){let t=e.state;if(t?.msp_view&&(this._view=t.msp_view,this._selectedEntryId=t.msp_entry||null,this._selectedTaskId=t.msp_task||null,this._moreMenuOpen=!1,t.msp_view==="task"&&t.msp_entry&&t.msp_task)){this._historyFilter=null;let a=this._getTask(t.msp_entry,t.msp_task);a?.trigger_config?.entity_id&&this._fetchDetailStats(a.trigger_config.entity_id,this._isCounterEntity(a.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null}_showObject(e){this._pushPanelState("object",e),this._view="object",this._selectedEntryId=e,this._selectedTaskId=null}_showTask(e,t){this._pushPanelState("task",e,t),this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._activeTab="overview",this._historyFilter=null;let a=this._getTask(e,t);if(a?.trigger_config?.entity_id){let s=a.trigger_config.entity_id,o=this._isCounterEntity(a.trigger_config);this._fetchDetailStats(s,o)}}_showToast(e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}async _deleteObject(e){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_object",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:e}),this._showOverview(),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _deleteTask(e,t){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_task",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/delete",entry_id:e,task_id:t}),this._showObject(e),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _skipTask(e,t,a){this._actionLoading=!0;try{let s={type:"maintenance_supporter/task/skip",entry_id:e,task_id:t};a&&(s.reason=a),await this.hass.connection.sendMessagePromise(s),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _resetTask(e,t,a){this._actionLoading=!0;try{let s={type:"maintenance_supporter/task/reset",entry_id:e,task_id:t};a&&(s.date=a),await this.hass.connection.sendMessagePromise(s),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _applySuggestion(e,t,a){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/apply_suggestion",entry_id:e,task_id:t,interval:a}),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}_openSeasonalOverrides(e){let t=this.shadowRoot.querySelector("maintenance-seasonal-overrides-dialog");if(!t||!this._selectedEntryId)return;let a=e.adaptive_config?.seasonal_overrides;t.open(this._selectedEntryId,e.id,a)}async _reanalyzeInterval(e,t){try{let a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:e,task_id:t});a.recommended_interval?this._showToast(`${i("reanalyze_result",this._lang)}: ${a.recommended_interval} ${i("days",this._lang)} (${i(`confidence_${a.confidence}`,this._lang)}, ${a.data_points} ${i("data_points",this._lang)})`):this._showToast(i("reanalyze_insufficient_data",this._lang)),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _promptSkipTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let s=await a.prompt({title:i("skip",this._lang),message:i("skip_reason_prompt",this._lang),confirmText:i("skip",this._lang),inputLabel:i("reason_optional",this._lang),inputType:"text"});s.confirmed&&this._skipTask(e,t,s.value||void 0)}async _promptResetTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let s=await a.prompt({title:i("reset",this._lang),message:i("reset_date_prompt",this._lang),confirmText:i("reset",this._lang),inputLabel:i("reset_date_optional",this._lang),inputType:"date"});s.confirmed&&this._resetTask(e,t,s.value||void 0)}_dismissSuggestion(e,t){e&&t&&this._dismissedSuggestions.add(`${e}_${t}`),this.requestUpdate()}async _handleQuickComplete(e,t,a){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/quick_complete",entry_id:e,task_id:t}),this._showToast(i("quick_complete_success",this._lang))}catch(s){(s?.code||"")==="no_defaults"?this._openCompleteDialog(e,t,a.name,this._features.checklists?a.checklist:void 0,this._features.adaptive&&!!a.adaptive_config?.enabled):this._showToast(i("action_error",this._lang))}}_openCompleteDialog(e,t,a,s,o){let c=this.shadowRoot.querySelector("maintenance-complete-dialog");c&&(c.entryId=e,c.taskId=t,c.taskName=a,c.lang=this._lang,c.checklist=s||[],c.adaptiveEnabled=!!o,c.open())}_openQrForObject(e,t){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForObject(e,t)}_openQrForTask(e,t,a,s){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForTask(e,t,a,s)}render(){return r`
    ...
    `}_renderOverview(){let e=this._lang,t=this._isOperator;return t&&this._overviewTab==="settings"&&(this._overviewTab="dashboard"),r`
      ...
      `}
      ${this._overviewTab==="dashboard"?this._renderDashboard():r`<maintenance-settings-view
            .hass=${this.hass}
            .features=${this._features}
            .budget=${this._budget}
            @settings-changed=${this._onSettingsChanged}
          ></maintenance-settings-view>`}
    `}_renderDashboard(){let e=this._stats,t=this._taskRows,a=this._lang,s=this._isOperator;return r`
      ${e?r`
            <div class="stats-bar">
    ...
    `}_renderGroupedTasks(e,t){let a=new Map,s=i("unassigned",t);for(let _ of e){let g=[];this._groupByMode==="area"?g=[(_.area_id?this.hass?.areas?.[_.area_id]?.name:null)||s]:this._groupByMode==="user"?g=[(_.responsible_user_id?this._userService?.getUserName(_.responsible_user_id):null)||s]:this._groupByMode==="group"&&(g=_.group_names.length>0?_.group_names:[s]);for(let m of g)a.has(m)||a.set(m,[]),a.get(m).push(_)}let o=[...a.entries()].sort(([_],[g])=>_===s&&g!==s?1:g===s&&_!==s?-1:_.localeCompare(g)),c=this._groupByMode==="area"?"mdi:map-marker-outline":this._groupByMode==="group"?"mdi:folder-outline":"mdi:account-outline";return r`
      ${o.map(([_,g])=>r`
      ...
      `)}
    `}_renderAllObjects(){let e=this._lang,t=this._isOperator,a=_=>{let g=1/0;for(let m of _.tasks){let h=m.days_until_due;h!=null&&h<g&&(g=h)}return g},s=[...this._objects];this._objectSortMode==="alphabetical"?s.sort((_,g)=>_.object.name.localeCompare(g.object.name)):this._objectSortMode==="task_count"?s.sort((_,g)=>g.tasks.length-_.tasks.length||_.object.name.localeCompare(g.object.name)):s.sort((_,g)=>a(_)-a(g)||_.object.name.localeCompare(g.object.name));let o=()=>{let _=new Map;for(let g of s){let m=g.object.area_id,h=m?this.hass?.areas?.[m]?.name||i("unassigned",e):i("no_area",e);_.has(h)||_.set(h,[]),_.get(h).push(g)}return new Map([..._.entries()].sort(([g],[m])=>g.localeCompare(m)))},c=_=>{let g=_.tasks.some(m=>m.status==="overdue"||m.status==="triggered");return r`
      ...
      ${this._groupByMode==="area"?r`
          ...
          `)}
        `:r`<div class="objects-grid">${s.map(c)}</div>`}
      ...
      <div class="groups-section">
        ...
        ${e.length===0?r`<div class="hint">${i("no_groups",t)}</div>`:r`
            <div class="groups-grid">
              ${e.map(([a,s])=>{let o=s.task_refs.map(c=>this._getTask(c.entry_id,c.task_id)?.name).filter(Boolean);return r`
    ...
    `}_renderOverviewRow(e){let t=this._lang,a=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,s=0,o=Ee.ok,c=!1;if(a&&e.days_until_due!==null){let h=(e.interval_days-e.days_until_due)/e.interval_days*100;s=Math.max(0,Math.min(100,h)),c=h>100,e.status==="overdue"?o=Ee.overdue:e.status==="due_soon"&&(o=Ee.due_soon)}let _=e.area_id?this.hass?.areas?.[e.area_id]?.name:null,g=e.responsible_user_id?this._userService?.getUserName(e.responsible_user_id):null,m=e.group_names.length>0||_||g;return r`
      <div class="task-row${e.enabled?"":" task-disabled"}">
        ...
        <span class="due-cell" @click=${()=>this._showTask(e.entry_id,e.task_id)}>
          ...
          ${a?r`<div class="days-bar"><div class="days-bar-fill${c?" overflow":""}" style="width:${s}%;background:${o}"></div></div>`:d}
    ...
    `}_openCompleteDialogForRow(e){let a=this._objects.find(s=>s.entry_id===e.entry_id)?.tasks.find(s=>s.id===e.task_id);this._openCompleteDialog(e.entry_id,e.task_id,e.task_name,this._features.checklists?a?.checklist:void 0,this._features.adaptive&&!!a?.adaptive_config?.enabled)}_renderTriggerProgress(e){let t=e.trigger_config??null;if(!t)return d;let a=t.type||"threshold",s=e.trigger_entity_info?.unit_of_measurement??"",o=0,c="";if(a==="threshold"){let m=e.trigger_current_value??null;if(m==null)return d;let h=t.trigger_above,v=t.trigger_below;if(h!=null){let b=v??0,k=h-b||1;o=Math.min(100,Math.max(0,(m-b)/k*100)),c=`${m.toFixed(1)} / ${h} ${s}`}else if(v!=null){let k=e.trigger_entity_info?.max??(v*2||100),S=k-v||1;o=Math.min(100,Math.max(0,(k-m)/S*100)),c=`${m.toFixed(1)} / ${v} ${s}`}else return d}else if(a==="counter"){let m=t.trigger_target_value||1,v=e.trigger_current_delta??null??e.trigger_current_value??null;if(v==null)return d;o=Math.min(100,Math.max(0,v/m*100)),c=`${v.toFixed(1)} / ${m} ${s}`}else if(a==="state_change"){let m=t.trigger_target_changes||1,h=e.trigger_current_value??null;if(h==null)return d;o=Math.min(100,Math.max(0,h/m*100)),c=`${Math.round(h)} / ${m}`}else if(a==="runtime"){let m=t.trigger_runtime_hours||100,h=e.trigger_current_value??null;if(h==null)return d;o=Math.min(100,Math.max(0,h/m*100)),c=`${h.toFixed(1)}h / ${m}h`}else if(a==="compound"){let m=t.compound_logic||t.operator||"AND",h=t.conditions?.length||0;c=`${m} (${h})`,o=e.trigger_active?100:0}else return d;let _=o>=100,g=o>90?"var(--error-color, #f44336)":o>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return r`
    ...
    `}_renderMiniSparkline(e){if(!e.trigger_config?.entity_id)return d;let t=e.trigger_config.entity_id,a=this._miniStatsData.get(t)||[],s=[];if(a.length>=2)s=a.map(x=>({ts:x.ts,val:x.val}));else{if(!e.history)return d;for(let x of e.history)x.trigger_value!=null&&s.push({ts:new Date(x.timestamp).getTime(),val:x.trigger_value})}if(e.trigger_current_value!=null&&s.push({ts:Date.now(),val:e.trigger_current_value}),s.length<2)return d;s.sort((x,C)=>x.ts-C.ts);let o=Ra,c=Pa,_=s.map(x=>x.val),g=Math.min(..._),m=Math.max(..._),h=m-g||1;g-=h*.1,m+=h*.1;let v=s[0].ts,k=s[s.length-1].ts-v||1,S=x=>(x-v)/k*o,O=x=>2+(1-(x-g)/(m-g))*(c-4),M=s;if(M.length>qt){let x=Math.ceil(M.length/qt);M=M.filter((C,U)=>U%x===0||U===M.length-1)}let j=M.map(x=>`${S(x.ts).toFixed(1)},${O(x.val).toFixed(1)}`).join(" ");return r`
    ...
    `}_renderDaysProgress(e){let t=this._lang;if(e.days_until_due==null||!e.interval_days||e.interval_days<=0)return d;let s=(e.interval_days-e.days_until_due)/e.interval_days*100,o=Math.max(0,Math.min(100,s)),c=s>100,_="var(--success-color, #4caf50)";return e.status==="overdue"?_="var(--error-color, #f44336)":e.status==="due_soon"&&(_="var(--warning-color, #ff9800)"),r`
      <div class="days-progress">
        ...
        <div class="days-progress-text">${Ae(e.days_until_due,t)}</div>
      </div>
    `}_renderObjectDetail(){if(!this._selectedEntryId)return d;let e=this._getObject(this._selectedEntryId);if(!e)return r`<p>Object not found.</p>`;let t=e.object,a=this._lang,s=this._isOperator;return r`
        ...
        ${e.tasks.length===0?r`<div class="empty-state-centered">
              ...
              <div class="task-row${o.enabled?"":" task-disabled"}">
                ...
                <span class="due-cell" @click=${()=>this._showTask(e.entry_id,o.id)}>
                  <span class="due-text">${Ae(o.days_until_due,a)}</span>
    ...
    `}_renderTaskHeader(e){let t=this._lang,s=this._getObject(this._selectedEntryId)?.object.name||"",o=this._isOperator,c=e.status==="due_soon"?"warning":e.status||"ok",_=i(e.status||"ok",t);return r`
        ...
        <div class="two-column-layout ${o?"":"single-column"}">
          ${o?r`
            <div class="left-column">
              ...
              ${At(e,t,this._features)}
            </div>
          `:d}
          <div class="right-column">
            ${St(e,t,this._costDurationToggle,g=>{this._costDurationToggle=g})}
          </div>
        </div>
        ${c?zt(e,t):d}
        ${_?r`
    ...
    `}_renderKPIBar(e){let t=this._lang,a=e.times_performed>0?e.total_cost/e.times_performed:0,s=e.days_until_due!==null&&e.days_until_due!==void 0?e.days_until_due<0?"overdue":e.days_until_due<=e.warning_days?"warning":"":"";return r`
      <div class="kpi-bar">
        <div class="kpi-card">
    ...
    `}_renderRecommendationCard(e){let t=this._lang;if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return d;if(this._selectedEntryId&&this._selectedTaskId&&this._dismissedSuggestions.has(`${this._selectedEntryId}_${this._selectedTaskId}`))return d;let a=e.interval_days,s=e.suggested_interval,o=e.interval_confidence||"medium",c=Math.max(a||1,s);return r`
    ...
    `}_renderRecentActivities(e){let t=this._lang,a=e.history.slice(-3).reverse();if(a.length===0)return d;let s=o=>{switch(o){case"completed":return"\u2713";case"triggered":return"\u2297";case"skipped":return"\u21B7";case"reset":return"\u21BA";default:return"\xB7"}};return r`
      <div class="recent-activities">
        <h3>${i("recent_activities",t)}</h3>
        ${a.map(o=>r`
          <div class="activity-item">
            <span class="activity-icon">${s(o.type)}</span>
            <span class="activity-date">${Ve(o.timestamp,t)}</span>
    ...
    `}_renderHistoryFilters(e){let t=this._lang;return r`
      <div class="history-filters-new">
        <div class="filter-chips">
          ${["completed","skipped","reset","triggered"].map(a=>{let s=e.history.filter(o=>o.type===a).length;return s===0?d:r`
    ...
    `}_renderHistoryList(e){let t=this._lang,a=this._historyFilter?e.history.filter(s=>s.type===this._historyFilter):e.history;if(this._historySearch){let s=this._historySearch.toLowerCase();a=a.filter(o=>o.notes?.toLowerCase().includes(s))}return a.length===0?r`<p class="empty">${i("no_history",t)}</p>`:r`
    ...
    `}};z.styles=[mt,vt],p([$({attribute:!1})],z.prototype,"hass",2),p([$({type:Boolean,reflect:!0})],z.prototype,"narrow",2),p([$({attribute:!1})],z.prototype,"panel",2),p([u()],z.prototype,"_objects",2),p([u()],z.prototype,"_stats",2),p([u()],z.prototype,"_view",2),p([u()],z.prototype,"_selectedEntryId",2),p([u()],z.prototype,"_selectedTaskId",2),p([u()],z.prototype,"_filterStatus",2),p([u()],z.prototype,"_filterUser",2),p([u()],z.prototype,"_unsub",2),p([u()],z.prototype,"_sparklineTooltip",2),p([u()],z.prototype,"_historyFilter",2),p([u()],z.prototype,"_budget",2),p([u()],z.prototype,"_groups",2),p([u()],z.prototype,"_detailStatsData",2),p([u()],z.prototype,"_miniStatsData",2),p([u()],z.prototype,"_features",2),p([u()],z.prototype,"_adminPanelUserIds",2),p([u()],z.prototype,"_defaultWarningDays",2),p([u()],z.prototype,"_actionLoading",2),p([u()],z.prototype,"_moreMenuOpen",2),p([u()],z.prototype,"_toastMessage",2),p([u()],z.prototype,"_overviewTab",2),p([u()],z.prototype,"_activeTab",2),p([u()],z.prototype,"_costDurationToggle",2),p([u()],z.prototype,"_historySearch",2),p([u()],z.prototype,"_sortMode",2),p([u()],z.prototype,"_objectSortMode",2),p([u()],z.prototype,"_groupByMode",2),z=p([pt("maintenance-supporter-panel")],z);export{z as MaintenanceSupporterPanel};
