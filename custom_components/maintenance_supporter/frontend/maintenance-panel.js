/*! maintenance_supporter frontend 2.72.0 */
import{a as ge,b as Ft,c as vt,d as Nt,e as Ct,f as me,g as _e,h as ve}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-P5QMUJLK.js";import{a as W,b as Bt,c as Ut,d as fe,e as ye,f as Vt,g as xe,h as we,i as $e,j as Te,k as je,l as Se,m as Ee,n as Me,o as Ce,p as Re,w as Oe,z as De}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-7IZWI6HU.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-BZEZWNG5.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-CORR7WUH.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-3VKLH3MH.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-WZSDHV7C.js";import{b as be}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-4LY7ELWC.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-HS7C2TIL.js";import{a as te}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-ZJ7YBHUG.js";import{a as ke}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-TZOFYUHW.js";import{a as S}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-ELMQUP53.js";import{A as Et,B as Mt,C as ue,D as Ht,a as g,b as R,c as o,d as F,f as p,h as O,i as Jt,j as de,k as pe,l as w,m,n as zt,o as It,p as Pt,q as a,r as Lt,s as L,t as he,u as Y,v as U,w as $t,x as _t}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-T5HK7XTU.js";var ni=["assignee_pool","required_completion_fields","checklist","labels","history"],li=["checklist_progress"],ci=["tasks","parts"],di=["manual_docs","battery_fleet_excluded"];function ee(r,l,t=[]){for(let e of l)r[e]===void 0&&(r[e]=[]);for(let e of t)r[e]===void 0&&(r[e]={})}function pi(r){let l=r;ee(l,ci),l.object&&typeof l.object=="object"&&ee(l.object,di);for(let t of l.tasks)ee(t,ni,li);return r}function Rt(r){for(let l of r)pi(l);return r}function hi(r,l){if(l.objects)return l.objects;let t=l.delta||[],e=l.removed||[];if(!t.length&&!e.length)return null;let i=new Map(r.map(s=>[s.entry_id,s]));for(let s of t)i.set(s.entry_id,s);for(let s of e)i.delete(s);return[...i.values()]}function Ae(r,l){return l.objects&&Rt(l.objects),l.delta&&Rt(l.delta),hi(r,l)}var A={overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view",objectsCache:"msp-objects-cache",gettingStartedDismissed:"msp-gs-dismissed",batteryRosterSort:"ms_bf_roster_sort"};function Z(r){try{return localStorage.getItem(r)}catch{return null}}function q(r,l){try{localStorage.setItem(r,l)}catch{}}var ui=168*3600*1e3;function ze(){try{let r=Z(A.objectsCache);if(!r)return null;let l=JSON.parse(r);return l.v!==Jt||!Number.isFinite(l.at)||Date.now()-l.at>ui||!Array.isArray(l.objects)||l.objects.length===0?null:{objects:l.objects,stats:l.stats??null}}catch{return null}}function ie(r,l){if(!(!Array.isArray(r)||r.length===0))try{let t={v:Jt,at:Date.now(),objects:r,stats:l};q(A.objectsCache,JSON.stringify(t))}catch{}}function D(r){return String(r??"").replace(/[&<>"']/g,l=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[l])}function Ie(r,l,t,e,i,s){let n=[[t.manufacturer,r.manufacturer],[t.model,r.model],[t.serial,r.serial_number],[t.installed,r.installation_date?e(r.installation_date):null],[t.warranty,r.warranty_expiry?e(r.warranty_expiry):null]].filter(([,h])=>!!h),d=l.map(h=>{let u=t.scheduleLabel(h);return`<tr>
      <td>${D(h.name)}</td>
