...
`;var W={overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view"};var Es={days:1,weeks:7,months:30.4368,years:365.25};function Wt(n,r){return!n||n<=0?0:n*(Es[r||"days"]??1)}function yt(n,r,e){let t=Wt(n,e);if(t<=0||r==null)return{pct:0,overflow:!1};let i=(t-r)/t*100;return{pct:Math.max(0,Math.min(100,i)),overflow:i>100}}function H(n){return String(n??"").replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r])}function ki(n,r,e,t,i,a){let l=[[e.manufacturer,n.manufacturer],[e.model,n.model],[e.serial,n.serial_number],[e.installed,n.installation_date?t(n.installation_date):null],[e.warranty,n.warranty_expiry?t(n.warranty_expiry):null]].filter(([,u])=>!!u),c=r.map(u=>{let g=e.scheduleLabel(u);return`<tr>
      <td>${H(u.name)}</td>
      <td>${H(e.typeLabel(u.type))}</td>
      <td>${H(e.statusLabel(u.status))}</td>
      <td>${H(g)}</td>
      <td>${H(u.last_performed?t(u.last_performed):e.none)}</td>
      <td>${H(u.next_due?t(u.next_due):e.none)}</td>
      <td class="num">${u.times_performed??0}</td>
      <td class="num">${(u.total_cost??0).toFixed(2)} ${H(i)}</td>
    </tr>`}).join(""),p=r.reduce((u,g)=>u+(g.total_cost??0),0);return`<!DOCTYPE html><html><head><meta charset="utf-8">
<title>${H(e.title)} \u2014 ${H(n.name)}</title>
<style>
  * { box-sizing: border-box; }
  ...
  <h1>${H(n.name)}</h1>
  <p class="sub">${H(e.title)} \xB7 ${H(e.generated)}: ${H(t(a))}</p>
  ${l.length?`<div class="meta">${l.map(([u,g])=>`<div><div class="k">${H(u)}</div>${H(g)}</div>`).join("")}</div>`:""}
  <h2>${H(e.tasksHeading)} (${r.length})</h2>
  <table>
    <thead><tr>
      <th>${H(e.colTask)}</th><th>${H(e.colType)}</th><th>${H(e.colStatus)}</th>
      <th>${H(e.colSchedule)}</th><th>${H(e.colLastDone)}</th><th>${H(e.colNextDue)}</th>
      <th class="num">${H(e.colTimes)}</th><th class="num">${H(e.colCost)}</th>
    </tr></thead>
    <tbody>${c||`<tr><td colspan="8">${H(e.none)}</td></tr>`}</tbody>
    <tfoot><tr><td colspan="7">${H(e.totalCost)}</td><td class="num">${p.toFixed(2)} ${H(i)}</td></tr></tfoot>
  </table>
  ${n.notes?`<div class="notes"><strong>${H(e.notes)}:</strong>
${H(n.notes)}</div>`:""}
</body></html>`}function Kt(n,r=new Date){if(!n)return{kind:"none",days:null,date:null};let e=new Date(`${n}T00:00:00`);if(isNaN(e.getTime()))return{kind:"none",days:null,date:null};let t=Date.UTC(r.getFullYear(),r.getMonth(),r.getDate()),i=Date.UTC(e.getFullYear(),e.getMonth(),e.getDate()),a=Math.round((i-t)/864e5);return a<0?{kind:"expired",days:a,date:n}:a<=60?{kind:"expiring",days:a,date:n}:{kind:"valid",days:a,date:n}}var ze=[{key:"name",labelKey:"name",required:!0},{key:"manufacturer",labelKey:"manufacturer"},{key:"model",labelKey:"model"},{key:"serial_number",labelKey:"serial_number_label"},{key:"installation_date",labelKey:"installed"},{key:"warranty_expiry",labelKey:"warranty"},{key:"area_id",labelKey:"area"},{key:"documentation_url",labelKey:"documentation_url_label"},{key:"notes",labelKey:"object_notes_label"},{key:"task_count",labelKey:"tasks"},{key:"actions",labelKey:"actions"}],Ts=ze.map(n=>n.key),xt=["name","manufacturer","model","serial_number","installation_date","warranty_expiry","area_id","task_count","actions"];function tt(n){if(!Array.isArray(n))return[...xt];let r=new Set,e=[];for(let t of n)typeof t=="string"&&Ts.includes(t)&&!r.has(t)&&(r.add(t),e.push(t));return e.length?(e.includes("name")||e.unshift("name"),e):[...xt]}function $t(n,r,e){let t=new Blob([n],{type:e}),i=URL.createObjectURL(t),a=document.createElement("a");a.href=i,a.download=r,a.target="_blank",a.rel="noopener",a.style.display="none",document.body.appendChild(a),a.dispatchEvent(new MouseEvent("click")),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(i),6e4)}function wt(n,r){let e=document.createElement("a");e.href=n,e.download=r,e.target="_blank",e.rel="noopener",e.style.display="none",document.body.appendChild(e),e.dispatchEvent(new MouseEvent("click")),document.body.removeChild(e)}var D=n=>String(n??"").replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]);function Ei(n,r,e,t,i,a,l,c,p,u=[]){let g=[[e.object,D(r)],[e.type,D(e.typeLabel(n.type))],[e.interval,D(i(n))],[e.nextDue,n.next_due?D(t(n.next_due)):"\u2014"],[e.lastDone,n.last_performed?D(t(n.last_performed)):D(e.never)]];n.priority&&n.priority!=="normal"&&g.push([e.priority,D(n.priority)]);let m=(n.checklist||[]).map(b=>`<li><span class="box"></span>${D(b)}</li>`).join(""),v=(b,$)=>b?`<figure class="qr"><img src="${b}" alt="" /><figcaption>${D($)}</figcaption></figure>`:"";return`<!DOCTYPE html>
...
<body>
  ...
  <table class="meta">
    ${g.map(([b,$])=>`<tr><td>${D(b)}</td><td>${$}</td></tr>`).join("")}
  </table>
  ${m?`<h2>${D(e.checklist)}</h2><ul class="check">${m}</ul>`:""}
  ${u.length?`<h2>${D(e.parts)}</h2><ul class="check">${u.map(b=>`<li><span class="box"></span>${D(b)}</li>`).join("")}</ul>`:""}
...
`;var kt=class{constructor(r){this._cache=new Map;this._pending=new Map;this._hass=r}updateHass(r){this._hass=r}async getDetailStats(r,e,t=30){return this._getStats(r,t<=35?"hour":"day",t,e)}async getMiniStats(r,e){return this._getStats(r,"day",14,e)}async getBatchMiniStats(r){let e=new Map,t=[];for(let p of r){let u=`${p.entityId}:day:14`,g=this._cache.get(u);g&&Date.now()-g.fetchedAt<3e5?e.set(p.entityId,g.points):t.push(p)}if(t.length===0)return e;let i=t.filter(p=>p.isCounter).map(p=>p.entityId),a=t.filter(p=>!p.isCounter).map(p=>p.entityId),l=new Date(Date.now()-336*60*60*1e3).toISOString(),c=[];return i.length>0&&c.push(this._fetchBatch(i,"day",l,["state","sum","change"],!0,e)),a.length>0&&c.push(this._fetchBatch(a,"day",l,["mean","min","max"],!1,e)),await Promise.all(c),e}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(r,e,t,i){let a=`${r}:${e}:${t}`,l=this._cache.get(a);if(l&&Date.now()-l.fetchedAt<3e5)return l.points;if(this._pending.has(a))return this._pending.get(a);let c=this._fetchAndNormalize(r,e,t,i,a);this._pending.set(a,c);try{return await c}finally{this._pending.delete(a)}}async _fetchAndNormalize(r,e,t,i,a){let l=new Date(Date.now()-t*24*60*60*1e3).toISOString(),c=i?["state","sum","change"]:["mean","min","max"];try{let u=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:l,statistic_ids:[r],period:e,types:c}))[r]||[],g=this._normalizeRows(u,i);return this._cache.set(a,{entityId:r,fetchedAt:Date.now(),period:e,points:g}),g}catch(p){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${r}:`,p),[]}}async _fetchBatch(r,e,t,i,a,l){try{let c=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:t,statistic_ids:r,period:e,types:i});for(let p of r){let u=c[p]||[],g=this._normalizeRows(u,a);l.set(p,g),this._cache.set(`${p}:${e}:14`,{entityId:p,fetchedAt:Date.now(),period:e,points:g})}}catch(c){console.warn("[maintenance-supporter] Batch statistics fetch failed:",c)}}_normalizeRows(r,e){let t=[];for(let i of r){let a=null;if(e?a=i.state??null:a=i.mean??null,a===null)continue;let l={ts:i.start,val:a};e||(i.min!=null&&(l.min=i.min),i.max!=null&&(l.max=i.max)),t.push(l)}return t.sort((i,a)=>i.ts-a.ts),t}};var he=class{constructor(r){this.usersCache=null;this.cacheTimestamp=0;this.CACHE_TTL_MS=6e4;this.hass=r}updateHass(r){this.hass=r}async getUsers(r=!1){let e=Date.now();if(!r&&this.usersCache&&e-this.cacheTimestamp<this.CACHE_TTL_MS)return this.usersCache;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/users/list"});return this.usersCache=t.users,this.cacheTimestamp=e,this.usersCache}catch(t){return console.error("Failed to fetch users:",t),this.usersCache||[]}}async assignUser(r,e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/assign_user",entry_id:r,task_id:e,user_id:t})}async getTasksByUser(r){return(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tasks/by_user",user_id:r})).tasks}getUserName(r){return!r||!this.usersCache?null:this.usersCache.find(t=>t.id===r)?.name||null}getUser(r){return!r||!this.usersCache?null:this.usersCache.find(e=>e.id===r)||null}getCurrentUserId(){return this.hass.user?.id||null}isCurrentUser(r){return r?r===this.getCurrentUserId():!1}clearCache(){this.usersCache=null,this.cacheTimestamp=0}};var Z=class extends A{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return o`
  ...
  `,d([f({attribute:!1})],F.prototype,"hass",2),d([f({attribute:!1})],F.prototype,"entryId",2),d([f({type:Boolean})],F.prototype,"canWrite",2),d([_()],F.prototype,"_docs",2),d([_()],F.prototype,"_loaded",2),d([_()],F.prototype,"_busy",2),d([_()],F.prototype,"_error",2),d([_()],F.prototype,"_hint",2),d([_()],F.prototype,"_addingLink",2),d([_()],F.prototype,"_linkUrl",2),d([_()],F.prototype,"_linkTitle",2),d([_()],F.prototype,"_category",2),d([_()],F.prototype,"_thumbs",2),d([_()],F.prototype,"_lightboxUrl",2),d([_()],F.prototype,"_editingId",2),d([_()],F.prototype,"_editTitle",2),d([_()],F.prototype,"_editCategory",2),d([_()],F.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",F);var Ms=["manual","warranty","invoice","spare_parts","photo","other"],Rs={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"},X=class extends A{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._loadedKey="";this._localeReady=!1}get _lang(){return this.hass?.language||"en"}get _refId(){return this.partId||this.taskId||""}get _linkField(){return this.partId?"part_ids":"task_ids"}updated(e){super.updated(e),this.hass&&!this._localeReady&&(this._localeReady=!0,V(this._lang).then(()=>this.requestUpdate()));let t=`${this.entryId}|${this._refId}`;this.hass&&this.entryId&&this._refId&&this._loadedKey!==t&&(this._loadedKey=t,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=e.documents||[],this._loaded=!0,this._error=""}catch(e){this._error=C(e,this._lang),this._loaded=!0}}_links(e){return e[this._linkField]||[]}_linked(){return this._docs.filter(e=>this._links(e).includes(this._refId))}_available(){return this._docs.filter(e=>!this._links(e).includes(this._refId))}async _setLinks(e,t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:e.id,[this._linkField]:t}),await this._load()}catch(i){this._error=C(i,this._lang)}finally{this._busy=!1}}_link(){let e=this._docs.find(t=>t.id===this._attachId);e&&(this._attachId="",this._setLinks(e,[...this._links(e),this._refId]))}_unlink(e){this._setLinks(e,this._links(e).filter(t=>t!==this._refId))}_isPdf(e){return e.mime==="application/pdf"||(e.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(e){return this._isPdf(e)&&this.taskId?e.task_pages?.[this.taskId]:void 0}async _open(e){if(e.kind==="weblink"){window.open(e.url,"_blank","noopener");return}let t=this._pageFor(e),i=t?`#page=${t}`:"",a=window.open("about:blank","_blank");try{let l=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:300});a&&(a.location.href=new URL(l.path+i,window.location.origin).href)}catch(l){a&&a.close(),this._error=C(l,this._lang)}}async _setPage(e,t){if(this.taskId){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:e.id,task_pages:{[this.taskId]:t}}),await this._load()}catch(i){this._error=C(i,this._lang)}finally{this._busy=!1}}}async _download(e){try{let t=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:30});wt(t.path,e.filename||e.title||"document")}catch(t){this._error=C(t,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return h;let e=this._lang,t=this._linked(),i=this._available();return o`
    ...
    `}_renderRow(e,t){let i=e.kind==="file",a=this._isPdf(e),l=this._pageFor(e),c=(e.tags||[]).find(u=>Ms.includes(u))||"other",p=i?ue(e.size):s("doc_link_badge",t);return o`
      <div class="tdoc-row">
        <ha-icon class="tdoc-icon" icon=${i?Rs[c]:"mdi:link-variant"}></ha-icon>
        <div
          class="tdoc-info"
          role="button"
          tabindex="0"
...
`).map(p=>p.trim()).filter(Boolean).slice(0,100);e.checklist=c.length?c:null}if(this.completionActionsEnabled){let c=this._actionService.trim();if(c&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(c)){let m={service:c},v=this._actionTargetEntity.trim();v&&(m.target={entity_id:v});let b=this._buildActionData();Object.keys(b).length>0&&(m.data=b),e.on_complete_action=m}else e.on_complete_action=null;let p={};this._qcNotes.trim()&&(p.notes=this._qcNotes.trim());let u=parseFloat(this._qcCost);!isNaN(u)&&u>=0&&(p.cost=u);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(p.duration=g),this._qcFeedback&&(p.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(p).length?p:null}let i=await this.hass.connection.sendMessagePromise(e),a=this._taskId||i?.task_id,l=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(a&&this._scheduleType==="sensor_based"&&l)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=C(e,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return h;let e=this._lang,t=this._triggerType==="compound";return o`
      ...
      <div class="select-row">
        ...
        >
          ${Hs.map(i=>o`<option value=${i} ?selected=${i===this._triggerType}>${s(i,e)}</option>`)}
        </select>
      </div>
    ...
    `}_patchCondition(e,t){this._compoundConditions=this._compoundConditions.map((i,a)=>a===e?{...i,...t}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Os()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((t,i)=>i!==e)}_renderCompoundEditor(){let e=this._lang;return o`
      <div class="select-row">
    ...
    `}_buildSchedule(){let e=i=>{let a=parseInt(this._calOffset,10)||0;return a&&(i.offset=Math.max(-15,Math.min(a,15))),i};if(this._scheduleType==="weekdays")return e({kind:"weekdays",weekdays:[...this._weekdays].sort((i,a)=>i-a)});if(this._scheduleType==="nth_weekday")return e({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let t={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(t.business=!0),e(t)}_recurrenceExtras(){let e={};if(this._seasonMonths.length&&(e.season_months=[...this._seasonMonths].sort((t,i)=>t-i)),this._endsMode==="count"){let t=parseInt(this._endsCount,10);t>=1&&(e.ends={count:t})}else this._endsMode==="until"&&this._endsUntil&&(e.ends={until:this._endsUntil});return e}_toggleSeasonMonth(e){this._seasonMonths=this._seasonMonths.includes(e)?this._seasonMonths.filter(t=>t!==e):[...this._seasonMonths,e]}_renderRecurrenceExtras(){let e=this._lang;if(!(this._scheduleType==="time_based"||Yt.includes(this._scheduleType)))return h;let i=Us(e);return o`
      ...
      ${this._endsMode==="until"?o`
        ...
        ></ms-textfield>`:h}
    `}_renderCalendarFields(){let e=this._lang,t=Fs(e);if(this._scheduleType==="weekdays")return o`
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Ls.map(i=>o`<option value=${i} ?selected=${i===this._type}>${s(i,e)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${Ps.map(i=>o`<option value=${i} ?selected=${i===this._priority}>${s("priority_"+i,e)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${zs.map(i=>o`<option value=${i} ?selected=${i===this._scheduleType}>${s(i,e)}</option>`)}
            </select>
          </div>
          ...
          <div class="required-completion">
            ${["notes","cost","duration","photo","user"].map(i=>o`
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="dialog-actions">
          ...
          <ha-button
            ...
            title=${this._missingRequired.length?this._missingRequired.map(t=>s("err_required",e).replace("{field}",s(t,e))).join(" \xB7 "):""}
          >
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,d([f({attribute:!1})],fe.prototype,"hass",2),d([_()],fe.prototype,"_ov",2),d([_()],fe.prototype,"_loading",2),d([_()],fe.prototype,"_marking",2),d([_()],fe.prototype,"_error",2);customElements.get("maintenance-battery-fleet-section")||customElements.define("maintenance-battery-fleet-section",fe);var ji=5;function it(n){let r=n.getFullYear(),e=String(n.getMonth()+1).padStart(2,"0"),t=String(n.getDate()).padStart(2,"0");return`${r}-${e}-${t}`}function Vs(n,r){let e=[];for(let t=0;t<r;t++){let i=new Date(n);i.setDate(i.getDate()+t),i.setHours(0,0,0,0),e.push(it(i))}return e}function Tt(n,r){let[e,t,i]=n.split("-").map(Number),a=new Date(e,t-1,i);return a.setDate(a.getDate()+r),it(a)}function Ws(n){if(!n||n.length===0)return null;let r=n.map(e=>e.cost).filter(e=>typeof e=="number");return r.length===0?null:r.reduce((e,t)=>e+t,0)/r.length}function Ks(n){let{windowStart:r,windowEnd:e,task:t,entryId:i,objectName:a}=n,l=[],c=(m,v)=>({date:m,entry_id:i,task_id:t.id,task_name:t.name,object_name:a,status:v&&(t.status==="overdue"||t.status==="triggered")?"ok":t.status,days_until_due:v?null:t.days_until_due??null,projected:v,schedule_type:t.schedule_type,interval_days:t.interval_days??null,interval_unit:t.interval_unit??null,responsible_user_id:t.responsible_user_id??null,avg_cost:Ws(t.history),adaptive_enabled:!!t.adaptive_config?.enabled,prediction_confidence:t.threshold_prediction_confidence??null}),p=Math.max(1,Math.round(Wt(t.interval_days,t.interval_unit)));if(t.status==="overdue"||t.status==="triggered"){if(l.push(c(r,!1)),t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let m=Tt(r,p),v=1;for(;m<=e&&v<ji;)l.push(c(m,!0)),v++,m=Tt(m,p)}return l}let u=t.next_due;if(typeof u!="string"||!u)return l;let g=u.slice(0,10);if(g>=r&&g<=e)l.push(c(g,!1));else if(g>e)return l;if(t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let m=Tt(g,p),v=l.length;for(;m<=e&&v<ji;)m>=r&&(l.push(c(m,!0)),v++),m=Tt(m,p)}return l}var Ci={overdue:0,triggered:1,due_soon:2,ok:3};function Mi(n,r,e,t=null){let i=Vs(r,e),a=i[0],l=i[i.length-1],c=[];for(let u of n){let g=u.object?.name||"",m=u.entry_id,v=u.tasks||[];for(let b of v){if(t&&b.responsible_user_id!==t||b.enabled===!1)continue;let $=Ks({windowStart:a,windowEnd:l,task:b,entryId:m,objectName:g});c.push(...$)}}let p=new Map;for(let u of i)p.set(u,[]);for(let u of c){let g=p.get(u.date);g&&g.push(u)}for(let[,u]of p)u.sort((g,m)=>{let v=Ci[g.status]??99,b=Ci[m.status]??99;if(v!==b)return v-b;if(g.projected!==m.projected)return g.projected?1:-1;let $=g.object_name.localeCompare(m.object_name);return $!==0?$:g.task_name.localeCompare(m.task_name)});return i.map(u=>({date:u,events:p.get(u)??[]}))}var Ys={completed:"ok",reset:"ok",skipped:"due_soon",triggered:"triggered",trigger_replaced:"triggered",trigger_removed:"ok"};function Gs(n,r){let e=[];for(let t=r-1;t>=0;t--){let i=new Date(n);i.setDate(i.getDate()-t),i.setHours(0,0,0,0),e.push(it(i))}return e}function Ri(n,r,e,t=null){let i=Gs(r,e),a=i[0],l=i[i.length-1],c=new Map;for(let u of i)c.set(u,[]);for(let u of n){let g=u.object?.name||"",m=u.entry_id,v=u.tasks||[];for(let b of v){if(t&&b.responsible_user_id!==t)continue;let $=b.history||[];for(let w of $){if(typeof w?.timestamp!="string")continue;let M=w.timestamp.slice(0,10);if(M<a||M>l)continue;let I=c.get(M);if(!I)continue;let x=w.type??"completed";I.push({date:M,entry_id:m,task_id:b.id,task_name:b.name,object_name:g,status:Ys[x]??"ok",days_until_due:null,projected:!1,schedule_type:b.schedule_type,interval_days:b.interval_days??null,responsible_user_id:b.responsible_user_id??null,avg_cost:typeof w.cost=="number"?w.cost:null,adaptive_enabled:!!b.adaptive_config?.enabled,prediction_confidence:null,history_timestamp:w.timestamp,history_type:x,history_cost:typeof w.cost=="number"?w.cost:null,history_notes:typeof w.notes=="string"?w.notes:null,history_duration:typeof w.duration=="number"?w.duration:null})}}}let p={completed:0,reset:1,skipped:2,triggered:3,trigger_replaced:4};for(let[,u]of c)u.sort((g,m)=>{let v=p[g.history_type??""]??99,b=p[m.history_type??""]??99;if(v!==b)return v-b;let $=g.object_name.localeCompare(m.object_name);return $!==0?$:g.task_name.localeCompare(m.task_name)});return i.map(u=>({date:u,events:c.get(u)??[]}))}var Ii=j`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;var se=class extends A{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter),typeof e.object_filter=="string"&&(this._objectFilter=e.object_filter)}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){super.updated(e),e.has("hass")&&mt(this.hass?.locale);let t=this.hass?.language;if(t&&!gt(t)&&V(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}_onEventClick(e){if(e.history_timestamp){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,l=null;this._userFilter&&(l=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let c=this._config.show_object_filter!==!1&&this._objects.length>1,p=null;if(this._objectFilter){let x=this._objectFilter.toLowerCase();p=this._objects.find(S=>S.entry_id===this._objectFilter||S.object.name.toLowerCase()===x)?.entry_id??null}let u=p?this._objects.filter(x=>x.entry_id===p):this._objects,g=new Date;g.setHours(0,0,0,0);let m=this._pastDays>0,v=m?Ri(u,g,this._pastDays,l):Mi(u,g,this._windowDays,l),b=it(g),$=this._windowDays===365||m,w=$?v.filter(x=>x.events.length>0):v,M=x=>{let L=`cal-status-${x.status}`,S=x.projected?"cal-event-projected":"",te=x.status==="overdue"&&x.days_until_due!=null?` (${Math.abs(x.days_until_due)}d ${s("overdue",e).toLowerCase()})`:"",Q=x.projected&&x.interval_days?o`<span class="cal-event-recur">${x.interval_unit&&x.interval_unit!=="days"?`${x.interval_days} ${s("unit_"+x.interval_unit,e)}`:s("cal_every_n_days",e).replace("{n}",String(x.interval_days))}</span>`:h,Y=x.schedule_type==="sensor_based",N=Y?o`<ha-icon class="cal-event-icon cal-source-sensor"
          ...
          </span>`:h,pe=this._stats?.budget?.currency_symbol||je,me=x.history_type?s(x.history_type,e):s(x.status,e);return o`
      ...
      `},I=x=>{let[L,S,te]=x.date.split("-").map(Number),Q=new Date(L,S-1,te),Y=x.date===b,N=Q.toLocaleDateString(e,{weekday:"short"}),q=Q.toLocaleDateString(e,{month:"long"});return o`
        <div class="cal-day-row">
          ...
          <div class="cal-day-content">
            ...
            ${x.events.length===0?o`<div class="cal-empty">${s("cal_no_events",e)}</div>`:x.events.map(M)}
          </div>
        </div>
      `};return o`
      <ha-card .header=${a}>
    ...
    `],d([f({attribute:!1})],se.prototype,"hass",2),d([_()],se.prototype,"_config",2),d([_()],se.prototype,"_objects",2),d([_()],se.prototype,"_stats",2),d([_()],se.prototype,"_windowDays",2),d([_()],se.prototype,"_pastDays",2),d([_()],se.prototype,"_userFilter",2),d([_()],se.prototype,"_objectFilter",2),d([_()],se.prototype,"_unsub",2);var Qs=[{value:7,label:"Week (7 days)"},{value:14,label:"Fortnight (14 days)"},{value:30,label:"Month (30 days, default)"},{value:365,label:"Year (365 days, empty days collapsed)"}],Oe=class extends A{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}setConfig(e){this._config={...e}}_valueChanged(e,t){let i={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete i.show_window_chips,e==="show_user_filter"&&t===!0&&delete i.show_user_filter,e==="show_object_filter"&&t===!0&&delete i.show_object_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete i.title,e==="user_filter"&&t===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let e=this._config.window_days??30,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.user_filter??"",l=this._config.title??"";return o`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${Qs.map(c=>o`<option value="${c.value}" ?selected=${c.value===e}>${c.label}</option>`)}
          </select>
        </div>
  ...
  `],d([f({attribute:!1})],ae.prototype,"hass",2),d([_()],ae.prototype,"_open",2),d([_()],ae.prototype,"_title",2),d([_()],ae.prototype,"_message",2),d([_()],ae.prototype,"_confirmText",2),d([_()],ae.prototype,"_danger",2),d([_()],ae.prototype,"_inputLabel",2),d([_()],ae.prototype,"_inputType",2),d([_()],ae.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",ae);var Pi={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},zi=n=>(...r)=>({_$litDirective$:n,values:r}),At=class{constructor(r){}get _$AU(){return this._$AM._$AU}_$AT(r,e,t){this._$Ct=r,this._$AM=e,this._$Ci=t}_$AS(r,e){return this.update(r,e)}update(r,e){return this.render(...e)}};var st=class extends At{constructor(r){if(super(r),this.it=h,r.type!==Pi.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(r){if(r===h||r==null)return this._t=void 0,this.it=r;if(r===be)return r;if(typeof r!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(r===this.it)return this._t;this.it=r;let e=[r];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};st.directiveName="unsafeHTML",st.resultType=1;var Hi=zi(st);var Js=["EUR","USD","GBP","JPY","CHF","CAD","AUD","NZD","CNY","INR","BRL","CZK","PLN","RUB","SEK","NOK","DKK","UAH"],R=class extends A{constructor(){super(...arguments);this.budget=null;this._settings=null;this._loading=!0;this._importCsv="";this._importLoading=!1;this._includeHistory=!0;this._toast="";this._testingNotification=!1;this._users=[];this._savedViews=[];this._vacEnabled=!1;this._vacStart="";this._vacEnd="";this._vacBuffer=3;this._vacExempt=new Set;this._vacIsActive=!1;this._vacWindowEnd=null;this._vacAllTasks=[];this._vacPreview=[];this._vacPreviewLoading=!1;this._vacSaving=!1;this._qrObjects=[];this._qrSelectedEntries=new Set;this._qrActions=new Set(["view"]);this._qrUrlMode="companion";this._qrBatchLoading=!1;this._qrBatchResults=[];this._qrObjectsLoaded=!1;this._exportObjects=[];this._exportSelectedEntries=new Set;this._exportObjectsLoaded=!1;this._docArchiveLoading=!1;this._loaded=!1;this._userService=null;this._sendTestNotification=async()=>{this._testingNotification=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/test_notification"}),t=e.message||(e.success?s("test_notification_success",this._lang):s("test_notification_failed",this._lang));this._showToast(t)}catch{this._showToast(s("test_notification_failed",this._lang))}finally{this._testingNotification=!1}};this._allTemplates=[];this._templateCategories={};this._tplOpenGroups=new Set;this._templatesRequested=!1}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded?(this._loaded=!0,this._userService=new he(this.hass),this._loadSettings(),this._loadUsers()):e.has("hass")&&this.hass&&this._userService&&this._userService.updateHass(this.hass)}async _loadUsers(){if(this._userService)try{this._users=await this._userService.getUsers()}catch{this._users=[]}}async _loadSettings(){this._loading=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});this._settings=e,this._hydrateVacationFromSettings()}catch{}try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"});this._savedViews=e.views||[]}catch{}this._loading=!1}_hydrateVacationFromSettings(){let e=this._settings?.vacation;e&&(this._vacEnabled=e.enabled,this._vacStart=e.start||"",this._vacEnd=e.end||"",this._vacBuffer=e.buffer_days,this._vacExempt=new Set(e.exempt_task_ids||[]),this._vacIsActive=e.is_active,this._vacWindowEnd=e.window_end)}async _updateSetting(e,t){try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:{[e]:t}});this._settings=i,this._showToast(s("settings_saved",this._lang)),this.dispatchEvent(new CustomEvent("settings-changed"))}catch{this._showToast(s("action_error",this._lang))}}_showToast(e){this._toast=e,setTimeout(()=>{this._toast=""},3e3)}_downloadFile(e,t,i){$t(e,t,i)}render(){let e=this._lang;return this._loading||!this._settings?o`<div class="settings-loading">Loading…</div>`:o`
      ...
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select @change=${l=>this._updateSetting("budget_currency",l.target.value)}>
            ${Js.map(l=>o`<option value=${l} ?selected=${a.currency===l}>${l}</option>`)}
          </select>
        </label>
        <label class="setting-row">
...
<body>
  ...
  `}function Zt(n,r,e){if(!n.trigger_config?.entity_id)return h;let t=n.trigger_config.entity_id,i=r.get(t)||[],a=[];if(i.length>=2)a=i.map(S=>({ts:S.ts,val:S.val}));else{if(!n.history)return h;for(let S of n.history)S.trigger_value!=null&&a.push({ts:new Date(S.timestamp).getTime(),val:S.trigger_value})}if(n.trigger_current_value!=null&&a.push({ts:Date.now(),val:n.trigger_current_value}),a.length<2)return h;a.sort((S,te)=>S.ts-te.ts);let l=ea,c=ta,p=a.map(S=>S.val),u=Math.min(...p),g=Math.max(...p),m=g-u||1;u-=m*.1,g+=m*.1;let v=a[0].ts,$=a[a.length-1].ts-v||1,w=S=>(S-v)/$*l,M=S=>2+(1-(S-u)/(g-u))*(c-4),I=a;if(I.length>Oi){let S=Math.ceil(I.length/Oi);I=I.filter((te,Q)=>Q%S===0||Q===I.length-1)}let x=I.map(S=>`${w(S.ts).toFixed(1)},${M(S.val).toFixed(1)}`).join(" "),L=n.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return o`
  ...
  `}function Di(n,r){let e=r;if(n.days_until_due==null||!n.interval_days||n.interval_days<=0)return h;let{pct:t,overflow:i}=yt(n.interval_days,n.days_until_due,n.interval_unit),a="var(--success-color, #4caf50)";return n.status==="overdue"?a="var(--error-color, #f44336)":n.status==="due_soon"&&(a="var(--warning-color, #ff9800)"),o`
  ...
  `}function at(n,r,e=4){if(!isFinite(n)||!isFinite(r))return{ticks:[],niceMin:0,niceMax:1};if(n===r){let u=Math.abs(n)*.1||1;n-=u,r+=u}let t=r-n,i=Math.pow(10,Math.floor(Math.log10(t/Math.max(1,e)))),a=i;for(let u of[1,2,5,10])if(a=i*u,t/a<=e+.5)break;let l=Math.floor(n/a)*a,c=Math.ceil(r/a)*a,p=[];for(let u=l;u<=c+a*1e-6;u+=a)p.push(Math.abs(u)<a*1e-9?0:u);return{ticks:p,niceMin:l,niceMax:c}}function ge(n){let r=Math.abs(n);return r>=1e6?De((n/1e6).toFixed(r>=1e7?0:1))+"M":r>=1e4?De((n/1e3).toFixed(0))+"k":r>=1e3?De((n/1e3).toFixed(1))+"k":r>=100?n.toFixed(0):r>=10||r>=1?De(n.toFixed(1)):r===0?"0":De(n.toFixed(2))}function De(n){return n.replace(/\.0+$/,"").replace(/(\.\d*[1-9])0+$/,"$1")}function Me(n,r,e){let t=n.toLocaleString(e,{maximumFractionDigits:Math.abs(n)>=100?0:1});return r?`${t} ${r}`:t}function qe(n,r,e){let t=new Date(n),i=e?{month:"short",day:"numeric",year:"2-digit"}:{month:"short",day:"numeric"};return t.toLocaleDateString(r,i)}function Jt(n,r){return new Date(n).toLocaleDateString(r,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}function jt(n,r){return new Date(n).getFullYear()!==new Date(r).getFullYear()}function Ct(n,r,e){if(e<2||r<=n)return[n,r];let t=[];for(let i=0;i<e;i++)t.push(n+(r-n)*i/(e-1));return t}var Mt=210,de=46,xe=14,$e=12,qi=14,ia=20+qi,sa=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],K=class extends A{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(e=>{let t=Math.floor(e[0]?.contentRect?.width||0);t&&Math.abs(t-this._width)>2&&(this._width=t)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(e){e!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:e},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let e=this._width||320,t=[...this.points].sort((a,l)=>a.ts-l.ts),i=this.lang;return o`
    ...
    `}_renderSvg(e,t){let i=this.lang,a=e-de-xe,l=Mt-ia,c=l-$e,p=1/0,u=-1/0;for(let E of t)p=Math.min(p,E.min??E.val),u=Math.max(u,E.max??E.val);this.thresholdAbove!=null&&(p=Math.min(p,this.thresholdAbove),u=Math.max(u,this.thresholdAbove)),this.thresholdBelow!=null&&(p=Math.min(p,this.thresholdBelow),u=Math.max(u,this.thresholdBelow)),this.targetValue!=null&&(p=Math.min(p,this.targetValue),u=Math.max(u,this.targetValue)),this.forceZero&&(p=Math.min(p,0));let g=(u-p||1)*.06,m=this.forceZero&&p>=0?0:p-g,{ticks:v,niceMin:b,niceMax:$}=at(m,u+g,4);this.forceZero&&p>=0&&b<0&&(b=0,v=v.filter(E=>E>=0));let w=t[0].ts,M=t[t.length-1].ts,I=M-w||1,x=jt(w,M),L=E=>de+(E-w)/I*a,S=E=>$e+(1-(E-b)/($-b||1))*c,te=t.map(E=>`${L(E.ts).toFixed(1)},${S(E.val).toFixed(1)}`).join(" "),Q=`M${L(t[0].ts).toFixed(1)},${l} `+t.map(E=>`L${L(E.ts).toFixed(1)},${S(E.val).toFixed(1)}`).join(" ")+` L${L(t[t.length-1].ts).toFixed(1)},${l} Z`,Y="",N=t.filter(E=>E.min!=null&&E.max!=null);if(N.length>=2){let E=N.map(z=>`${L(z.ts).toFixed(1)},${S(z.max).toFixed(1)}`),k=[...N].reverse().map(z=>`${L(z.ts).toFixed(1)},${S(z.min).toFixed(1)}`);Y=`M${E[0]} `+E.slice(1).map(z=>`L${z}`).join(" ")+` L${k.join(" L")} Z`}let q=[];if(this.thresholdBelow!=null){let E=S(this.thresholdBelow);q.push({y:E,h:Math.max(0,l-E),lineY:E,label:`\u25BC ${ge(this.thresholdBelow)}`,labelY:Math.min(l-4,E+13)})}if(this.thresholdAbove!=null){let E=S(this.thresholdAbove);q.push({y:$e,h:Math.max(0,E-$e),lineY:E,label:`\u25B2 ${ge(this.thresholdAbove)}`,labelY:Math.max($e+11,E-5)})}let pe=t[t.length-1],me=(this.events||[]).filter(E=>E.ts>=w&&E.ts<=M),Re=Ct(w,M,Math.max(2,Math.min(5,Math.floor(a/110)+1))),G=this._hover;return o`
      <div class="svg-holder">
        ...
        >
          <defs>
            ...
            ${q.length?O`<clipPath id="danger">${q.map(E=>O`<rect x="${de}" y="${E.y.toFixed(1)}" width="${a}" height="${E.h.toFixed(1)}" />`)}</clipPath>`:h}
          ...
          ${v.map(E=>{let k=S(E);return k<$e-1||k>l+1?h:O`
          ...
          ${q.map(E=>O`<rect x="${de}" y="${E.y.toFixed(1)}" width="${a}" height="${E.h.toFixed(1)}"
              fill="url(#dangerHatch)" />`)}

          ${Y?O`<path d="${Y}" fill="var(--primary-color)" opacity="0.08" clip-path="url(#plot)" />`:h}
          ...
          ${q.length?O`<polyline points="${te}" fill="none" stroke="var(--error-color, #f44336)" stroke-width="2"
          ...
          ${this.targetValue!=null?O`<line x1="${de}" y1="${S(this.targetValue).toFixed(1)}" x2="${e-xe}" y2="${S(this.targetValue).toFixed(1)}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${e-xe-4}" y="${(S(this.targetValue)-5).toFixed(1)}" text-anchor="end" class="zone-label">◆ ${ge(this.targetValue)} ${this.unit}</text>`:h}

          ${this.projection&&this.projection.length===2?O`<line x1="${L(this.projection[0].ts).toFixed(1)}" y1="${S(this.projection[0].val).toFixed(1)}"
                x2="${Math.min(L(this.projection[1].ts),e-xe).toFixed(1)}" y2="${S(Math.max(b,Math.min($,this.projection[1].val))).toFixed(1)}"
                stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.8" />`:h}

          ${Re.map((E,k)=>{let z=L(E),Rt=k===0?"start":k===Re.length-1?"end":"middle";return O`<text x="${z.toFixed(1)}" y="${Mt-5}" text-anchor="${Rt}" class="tick-label">${qe(E,i,x)}</text>`})}

          <line x1="${de}" y1="${l}" x2="${e-xe}" y2="${l}" stroke="var(--divider-color)" stroke-width="1" />

          ${me.map(E=>{let k=L(E.ts),z=E.type==="completed"?"var(--success-color, #4caf50)":E.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return O`
              <line x1="${k.toFixed(1)}" y1="${$e}" x2="${k.toFixed(1)}" y2="${l}" stroke="${z}" stroke-width="1" opacity="0.14" />
              <rect x="${(k-1.5).toFixed(1)}" y="${l+3}" width="3" height="${qi-6}" rx="1.5" fill="${z}">
                <title>${Jt(E.ts,i)}</title>
              </rect>`})}
          ...
          ${G?O`
                ...
                <circle cx="${G.x.toFixed(1)}" cy="${G.y.toFixed(1)}" r="4.5" fill="var(--primary-color)"
                  stroke="var(--card-background-color, #fff)" stroke-width="2" />`:O`<circle cx="${L(pe.ts).toFixed(1)}" cy="${S(pe.val).toFixed(1)}" r="4" fill="var(--primary-color)"
        ...
        ${G?o`<div
            ...
            >
              <div class="hover-date">${Jt(G.p.ts,i)}</div>
              <div class="hover-val">
    ...
    `}_onPointer(e,t,i,a,l){let p=e.currentTarget.getBoundingClientRect(),u=(e.clientX-p.left)/p.width*l;if(u<de-8||u>l-xe+8){this._hover=null;return}let g=t[0],m=1/0;for(let v of t){let b=Math.abs(i(v.ts)-u);b<m&&(m=b,g=v)}this._hover={x:i(g.ts),y:a(g.val),p:g}}};K.styles=j`
  ...
  `,d([f({attribute:!1})],K.prototype,"points",2),d([f({attribute:!1})],K.prototype,"events",2),d([f()],K.prototype,"unit",2),d([f()],K.prototype,"lang",2),d([f({attribute:!1})],K.prototype,"thresholdAbove",2),d([f({attribute:!1})],K.prototype,"thresholdBelow",2),d([f({attribute:!1})],K.prototype,"targetValue",2),d([f({type:Boolean})],K.prototype,"forceZero",2),d([f({attribute:!1})],K.prototype,"projection",2),d([f({attribute:!1})],K.prototype,"rangeDays",2),d([f({type:Boolean})],K.prototype,"showRange",2),d([f({type:Boolean})],K.prototype,"busy",2),d([f({type:Boolean})],K.prototype,"hideOutliers",2),d([f({type:Boolean})],K.prototype,"showOutlierToggle",2),d([_()],K.prototype,"_width",2),d([_()],K.prototype,"_hover",2);customElements.get("maintenance-trigger-chart")||customElements.define("maintenance-trigger-chart",K);function aa(n){if(n.length<4)return n;let r=n.map(u=>u.val).sort((u,g)=>u-g),e=u=>{let g=(r.length-1)*u,m=Math.floor(g),v=Math.ceil(g);return r[m]+(r[v]-r[m])*(g-m)},t=e(.25),i=e(.75),a=i-t;if(a===0)return n;let l=t-1.5*a,c=i+1.5*a,p=n.filter(u=>u.val>=l&&u.val<=c);return p.length>=2?p:n}function Ni(n,r){let e=n.trigger_config;if(!e)return h;let t=r.lang,i=n.trigger_entity_info,a=n.trigger_entity_infos,l=i?.friendly_name||e.entity_id||"\u2014",c=e.entity_id||"",p=e.entity_ids||(c?[c]:[]),u=i?.unit_of_measurement||"",g=n.trigger_current_value,m=e.type||"threshold",v=p.length>1,b=ra(n,u,r);return o`
    <h3>${s("trigger",t)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${v?o`
            ...
            <div class="trigger-entity-id">${p.map(($,w)=>o`${w>0?", ":""}<span class="entity-link" @click=${M=>Ce(M,$)}>${$}</span>`)}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `:o`
            <div class="trigger-entity-name">${l}</div>
            <div class="trigger-entity-id">${c?o`<span class="entity-link" @click=${$=>Ce($,c)}>${c}</span>`:""}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `}
        </div>
      ...
      <div class="trigger-limits">
        ...
        ${m==="compound"?o`
          ...
          ${(e.conditions||[]).map(($,w)=>o`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${w+1}. ${s($.type||"unknown",t)}: ${$.entity_id?o`<span class="entity-link" @click=${M=>Ce(M,$.entity_id)}>${$.entity_id}</span>`:""}</span>
          `)}
        `:h}
      </div>
      ...
      ${a&&a.length>1?o`
        <div class="trigger-entity-list">
          ${a.map($=>o`
            <span class="trigger-entity-id">${$.friendly_name} (<span class="entity-link" @click=${w=>Ce(w,$.entity_id)}>${$.entity_id}</span>)</span>
          `)}
        </div>
      `:h}
  ...
  `}function ra(n,r,e){let t=n.trigger_config,i=n.trigger_current_value;if(!t||i==null)return null;switch(t.type||"threshold"){case"counter":{let a=t.trigger_target_value;if(a==null||a<=0)return null;let l=Fi(n,Ui(n,e));return{progress:Math.max(0,i-(l?.value??i)),target:a,unit:r,meter:i}}case"state_change":{let a=t.trigger_target_changes;return a==null||a<=0?null:{progress:Math.max(0,i),target:a,unit:"",meter:null}}case"runtime":{let a=t.trigger_runtime_hours;return a==null||a<=0?null:{progress:Math.max(0,i),target:a,unit:"h",meter:null}}}return null}function Fi(n,r){if(n.trigger_baseline_value!=null)return{value:n.trigger_baseline_value,ts:Xt(n)};if(!r.length)return null;let e=Xt(n);if(e==null)return{value:r[0].val,ts:null};let t=r[0],i=Math.abs(r[0].ts-e);for(let a of r){let l=Math.abs(a.ts-e);l<i&&(t=a,i=l)}return{value:t.val,ts:e}}function Xt(n){let r=[...n.history].filter(e=>e.type==="completed"||e.type==="reset").sort((e,t)=>new Date(t.timestamp).getTime()-new Date(e.timestamp).getTime())[0];return r?new Date(r.timestamp).getTime():null}function na(n,r){let e=Math.min(999,Math.round(n.progress/n.target*100)),t=e>=100?"over":e>=75?"near":"ok";return o`
  ...
  `}function Ui(n,r){let e=n.trigger_config;if(!e)return[];let t=e.type||"threshold",i=e.entity_id||"",a=t==="runtime"?[]:r.detailStatsData.get(i)||[],l=r.isCounterEntity(e),c=[];if(a.length>=2)for(let p of a){let u={ts:p.ts,val:p.val};!l&&p.min!=null&&p.max!=null&&(u.min=p.min,u.max=p.max),c.push(u)}else for(let p of n.history)p.trigger_value!=null&&c.push({ts:new Date(p.timestamp).getTime(),val:p.trigger_value});return n.trigger_current_value!=null&&c.push({ts:Date.now(),val:n.trigger_current_value}),c.sort((p,u)=>p.ts-u.ts),c}function oa(n,r,e){let t=n.trigger_config;if(!t)return h;let i=t.type||"threshold",a=t.entity_id||"",l=Ui(n,e);i==="runtime"&&t.trigger_runtime_hours&&n.trigger_current_value!=null&&(l=[{ts:Xt(n)??l[0]?.ts??Date.now()-864e5,val:0},{ts:Date.now(),val:Math.max(0,n.trigger_current_value)}]),e.hideOutliers&&(l=aa(l));let c=l.length<2&&!!a&&e.hasStatsService&&!e.detailStatsData.has(a);if(l.length<2&&!c)return h;let p=!!a&&e.detailStatsData.has(a)&&(e.detailStatsData.get(a)?.length??0)<2,u=Date.now()-e.rangeDays*864e5,g=l.filter(w=>w.ts>=u);g.length>=2&&(l=g);let m=null,v=!1;if(i==="counter"&&t.trigger_target_value!=null&&l.length){let w=Fi(n,l);if(w){if(w.ts!=null){let M=l.filter(I=>I.ts>=w.ts);M.length>=2&&(l=M)}l=l.map(M=>({...M,val:Math.max(0,M.val-w.value)}))}m=t.trigger_target_value,v=!0}else i==="state_change"&&t.trigger_target_changes?(m=t.trigger_target_changes,v=!0):i==="runtime"&&t.trigger_runtime_hours&&(m=t.trigger_runtime_hours,v=!0);let b=null;if(m==null&&n.degradation_rate!=null&&(n.degradation_trend!=="stable"||n.days_until_threshold!=null)&&n.degradation_trend!=="insufficient_data"&&l.length>=2){let w=l[l.length-1];b=[w,{ts:w.ts+30*864e5,val:w.val+n.degradation_rate*30}]}let $=n.history.filter(w=>["completed","skipped","reset"].includes(w.type)).map(w=>({ts:new Date(w.timestamp).getTime(),type:w.type}));return o`
  ...
  `}function Bi(n,r,e){let t=n.degradation_trend!=null&&n.degradation_trend!=="insufficient_data",i=n.days_until_threshold!=null,a=n.environmental_factor!=null&&n.environmental_factor!==1;if(!t&&!i&&!a)return h;let l=n.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":n.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return o`
      ...
      <div class="prediction-grid">
        ...
        ${a&&e.environmental?o`
          <div class="prediction-item">
            ...
            ${n.environmental_entity?o`<span class="prediction-entity entity-link" @click=${c=>Ce(c,n.environmental_entity)}>${n.environmental_entity}</span>`:h}
          </div>
        `:h}
      </div>
    </div>
  `}function Vi(n,r){let e=n.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return h;let a=n.interval_days??0,l=n.suggested_interval??a;return o`
  ...
  `}function pa(n,r,e){let t=n.confidence_interval_low,i=n.confidence_interval_high,a=r.suggested_interval??r.interval_days??0,l=r.interval_days??0,c=Math.max(0,t-5),u=i+5-c,g=(t-c)/u*100,m=(i-t)/u*100,v=(a-c)/u*100,b=l>0?(l-c)/u*100:-1;return o`
    <div class="confidence-range">
      ...
      <div class="confidence-bar">
        ...
        ${b>=0?o`<div class="confidence-marker current" style="left:${b.toFixed(1)}%"></div>`:h}
  ...
  `}function Wi(n,r,e,t){let i=Math.max(n||1,r);return o`
  ...
  `}var Ki=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function Yi(n,r,e){if(!e.seasonal||!n.seasonal_factor||n.seasonal_factor===1)return h;let t=Ki.map(c=>s(c,r)),i=new Date().getMonth(),a=n.seasonal_factors||n.interval_analysis?.seasonal_factors||null,l=a&&a.length===12?a:t.map((c,p)=>{let u=n.seasonal_factor||1,g=Math.sin((p-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,u+g))});return o`
  ...
  `}function Gi(n,r){return ha(n,r)}function ha(n,r){let e=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return h;let t=n.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,l=100,c=8,u=l-c-4,g=Math.max(...e,1.5),m=a/12,v=m*.65,b=c+u-1/g*u;return o`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${a} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",r)}">
        ...
        ${e.map(($,w)=>{let M=$/g*u,I=w*m+(m-v)/2,x=c+u-M,L=w===i,S=$<1?"var(--success-color, #4caf50)":$>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return O`
      ...
      <div class="seasonal-labels">
        ${Ki.map(($,w)=>o`<span class="seasonal-label ${w===i?"active-month":""}">${s($,r)}</span>`)}
      </div>
    </div>
  `}var ua=200,rt=10,_a=22;function Qi(n,r,e,t){let i=n.history.filter(c=>c.type==="completed"&&(c.cost!=null||c.duration!=null));if(i.length<2)return h;let a=i.some(c=>(c.cost??0)>0),l=i.some(c=>(c.duration??0)>0);return!a&&!l?h:o`
  ...
  `}function ga(n,r,e){let t=n.history.filter(k=>k.type==="completed"&&(k.cost!=null||k.duration!=null)).map(k=>({ts:new Date(k.timestamp).getTime(),cost:k.cost??0,duration:k.duration??0})).sort((k,z)=>k.ts-z.ts);if(t.length<2)return h;let i=t.some(k=>k.cost>0),a=t.some(k=>k.duration>0);if(!i&&!a)return h;let l=e!=="duration"&&i,c=e!=="cost"&&a,p=l||!c&&i,u=c||!l&&a,g=640,m=ua,v=p?44:12,b=u?44:12,$=g-v-b,w=m-_a,M=w-rt,I=t[0].ts,x=t[t.length-1].ts,L=(x-I||864e5)*.05,S=I-L,te=x+L,Q=jt(I,x),Y=k=>v+(k-S)/(te-S)*$,N=at(0,Math.max(...t.map(k=>k.cost))||1,3),q=at(0,Math.max(...t.map(k=>k.duration))||1,3),pe=k=>rt+(1-k/(N.niceMax||1))*M,me=k=>rt+(1-k/(q.niceMax||1))*M,Re=t.length>1?Math.min(...t.slice(1).map((k,z)=>Y(k.ts)-Y(t[z].ts))):$,G=Math.max(6,Math.min(22,Re*.55)),E=Ct(I,x,Math.max(2,Math.min(4,t.length)));return o`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${g} ${m}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_history",r)}">
        ${p?N.ticks.map(k=>{let z=pe(k);return z<rt-1||z>w+1?h:O`
            <line x1="${v}" y1="${z.toFixed(1)}" x2="${g-b}" y2="${z.toFixed(1)}" stroke="var(--divider-color)" stroke-width="1" opacity="0.55" />
            <text x="${v-6}" y="${(z+3.5).toFixed(1)}" text-anchor="end" fill="var(--primary-color)" font-size="10.5">${ge(k)}€</text>`}):h}
        ${u?q.ticks.map(k=>{let z=me(k);return z<rt-1||z>w+1?h:O`<text x="${g-b+6}" y="${(z+3.5).toFixed(1)}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="10.5">${ge(k)}m</text>`}):h}

        ${p?t.filter(k=>k.cost>0).map(k=>O`
        ...
        <line x1="${v}" y1="${w}" x2="${g-b}" y2="${w}" stroke="var(--divider-color)" stroke-width="1" />
        ${E.map((k,z)=>{let Rt=z===0?"start":z===E.length-1?"end":"middle";return O`<text x="${Y(k).toFixed(1)}" y="${m-6}" text-anchor="${Rt}" fill="var(--secondary-text-color)" font-size="10">${qe(k,r,Q)}</text>`})}
      </svg>
    </div>
    <div class="chart-legend">
  ...
  `,d([f({attribute:!1})],ke.prototype,"hass",2),d([f()],ke.prototype,"docId",2),d([_()],ke.prototype,"_url",2),d([_()],ke.prototype,"_failed",2);customElements.get("maintenance-history-photo")||customElements.define("maintenance-history-photo",ke);var ma=["completed","skipped","missed","reset","triggered"];function Zi(n,r){let e=r.lang;return o`
    <div class="history-filters-new">
      <div class="filter-chips">
        ${ma.map(t=>{let i=n.history.filter(a=>a.type===t).length;return i===0?h:o`
  ...
  `}function Ji(n,r){let e=r.lang,t=r.filter?n.history.filter(i=>i.type===r.filter):n.history;if(r.search){let i=r.search.toLowerCase();t=t.filter(a=>a.notes?.toLowerCase().includes(i))}return t.length===0?o`<p class="empty">${s("no_history",e)}</p>`:o`
    <div class="history-timeline">
      ${[...t].reverse().map(i=>va(i,r))}
    </div>
  `}function va(n,r){let e=r.lang,t=["completed","reset","skipped"].includes(n.type);return o`
  ...
  `}function ei(n,r){if(!n.responsible_user_id)return h;let e=r(n.responsible_user_id);return e?o`
    <span class="user-badge">
      <ha-icon icon="mdi:account"></ha-icon>
      ${e}
    </span>
  `:h}function ba(n,r){let e=r.lang,t=r.isOperator,i=n.archived?"archived":n.is_done?"done":n.status==="due_soon"?"warning":n.status||"ok",a=n.archived?s("archived",e):n.is_done?s("completed",e):s(n.status||"ok",e);return o`
  ...
  `}function fa(n){let r=n.lang;return o`
    <div class="tab-bar">
  ...
  `}function Xi(n,r,e,t){let i=t.collapsedSections.has(n);return o`
  ...
  `}function ya(n,r){if(!r.features.checklists)return h;let e=n.checklist||[];if(e.length===0)return h;let t=r.lang;return o`
  ...
  `}function xa(n,r){let e=le(n.documentation_url)?n.documentation_url:null,t=le(r.objectDocUrl)?r.objectDocUrl:null;if(!n.notes&&!e&&!t)return h;let i=r.lang;return o`
  ...
  `}function $a(n,r){let e=r.lang,t=n.times_performed>0?n.total_cost/n.times_performed:0,i=n.days_until_due!==null&&n.days_until_due!==void 0?n.days_until_due<0?"overdue":n.days_until_due<=n.warning_days?"warning":"":"";return o`
    <div class="kpi-bar">
      <div class="kpi-card">
  ...
  `}function wa(n,r){let e=r.lang;if(!r.features.adaptive||!n.suggested_interval||n.suggested_interval===n.interval_days)return h;if(r.suggestionDismissed)return h;let t=n.suggested_interval;return o`
    <div class="recommendation-card">
      <h4>${s("suggested_interval",e)}</h4>
      ${Wi(n.interval_days,t,n.interval_confidence||"medium",e)}
  ...
  `}function ka(n,r){let e=r.lang,t=n.history.slice(-3).reverse();if(t.length===0)return h;let i=a=>{switch(a){case"completed":return"\u2713";case"triggered":return"\u2297";case"skipped":return"\u21B7";case"reset":return"\u21BA";default:return"\xB7"}};return o`
  ...
  `}function Ea(n,r){let e=r.lang,t=r.features.adaptive&&n.suggested_interval&&n.suggested_interval!==n.interval_days,i=r.features.seasonal&&n.seasonal_factor&&n.seasonal_factor!==1,a=t||i,l=r.features.adaptive&&n.interval_analysis?.weibull_beta!=null&&n.interval_analysis?.weibull_eta!=null,c=r.features.seasonal&&(n.seasonal_factors?.length===12||n.interval_analysis?.seasonal_factors?.length===12);return o`
    <div class="tab-content overview-tab">
      ...
      <div class="two-column-layout ${a?"":"single-column"}">
        ...
        <div class="right-column">
          ${Qi(n,e,r.costDurationToggle,p=>r.setCostDurationToggle(p))}
        </div>
      </div>
      ${l?Xi("weibull","weibull_reliability_curve",Vi(n,e),r):h}
      ${c?Xi("seasonal","seasonal_chart_title",o`
            ${Gi(n,e)}
  ...
  `}function Ta(n,r){return o`
    <div class="tab-content history-tab">
      ${Zi(n,r.history)}
      ${Ji(n,r.history)}
    </div>
  `}function Sa(n,r){switch(r.activeTab){case"overview":return Ea(n,r);case"history":return Ta(n,r);default:return h}}function es(n,r){return o`
        ...
        ${t.map(l=>o`
          <div class="today-row" @click=${()=>this._showTask(l.entry_id,l.task_id)}>
            ...
            <div class="today-main">
              ...
              <div class="today-object">${l.object_name} · ${Pe(l.days_until_due,a)}</div>
            </div>
    ...
    `}_renderOverviewRow(e){let t=this._lang,i=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,a=0,l=Ge.ok,c=!1;if(i&&e.days_until_due!==null){let v=yt(e.interval_days,e.days_until_due,e.interval_unit);a=v.pct,c=v.overflow,e.status==="overdue"?l=Ge.overdue:e.status==="due_soon"&&(l=Ge.due_soon)}let p=e.area_id?this.hass?.areas?.[e.area_id]?.name:null,u=e.responsible_user_id?this._userService?.getUserName(e.responsible_user_id):null,g=e.group_names.length>0||p||u,m=this._bulkMode&&this._bulkSelected.has(this._bulkKey(e));return o`
      <div class="task-row${e.enabled?"":" task-disabled"}${m?" bulk-selected":""}">
        ...
        <span class="due-cell" @click=${()=>this._showTask(e.entry_id,e.task_id)}>
          <span class="due-text">${Pe(e.days_until_due,t)}</span>
          ${i?o`<div class="days-bar"><div class="days-bar-fill${c?" overflow":""}" style="width:${a}%;background:${l}"></div></div>`:h}
          ${e.trigger_config?Qt(e):!i&&e.trigger_active?o`<span style="color:var(--maint-triggered-color);font-weight:600">⚡</span>`:h}
      ...
      <div class="detail-section">
        ...
        ${e.tasks.length===0?o`<div class="empty-state-centered">
              ...
              <div class="task-row${p.enabled?"":" task-disabled"}">
                ...
                <span class="task-sub${p.responsible_user_id?"":" task-sub-empty"}">${ei(p,u=>this._userService?.getUserName(u)??null)}</span>
                <span class="cell type">${s(p.type,i)}</span>
                <span class="due-cell" @click=${()=>this._showTask(e.entry_id,p.id)}>
                  <span class="due-text">${Pe(p.days_until_due,i)}</span>
                  ${p.trigger_config?Qt(p):h}
                  ${Zt(p,this._miniStatsData,this._lang)}
                </span>
                <span class="row-actions">
