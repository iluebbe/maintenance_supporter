...
`;var Ha={days:1,weeks:7,months:30.4368,years:365.25};function st(l,s){return!l||l<=0?0:l*(Ha[s||"days"]??1)}function ot(l,s,e){let t=st(l,e);if(t<=0||s==null)return{pct:0,overflow:!1};let a=(t-s)/t*100;return{pct:Math.max(0,Math.min(100,a)),overflow:a>100}}function rt(l,s=new Date){if(!l)return{kind:"none",days:null,date:null};let e=new Date(`${l}T00:00:00`);if(isNaN(e.getTime()))return{kind:"none",days:null,date:null};let t=Date.UTC(s.getFullYear(),s.getMonth(),s.getDate()),a=Date.UTC(e.getFullYear(),e.getMonth(),e.getDate()),n=Math.round((a-t)/864e5);return n<0?{kind:"expired",days:n,date:l}:n<=60?{kind:"expiring",days:n,date:l}:{kind:"valid",days:n,date:l}}var ue=[{key:"name",labelKey:"name",required:!0},{key:"manufacturer",labelKey:"manufacturer"},{key:"model",labelKey:"model"},{key:"serial_number",labelKey:"serial_number_label"},{key:"installation_date",labelKey:"installed"},{key:"warranty_expiry",labelKey:"warranty"},{key:"area_id",labelKey:"area"},{key:"documentation_url",labelKey:"documentation_url_label"},{key:"notes",labelKey:"object_notes_label"},{key:"task_count",labelKey:"tasks"},{key:"actions",labelKey:"actions"}],Oa=ue.map(l=>l.key),Ie=["name","manufacturer","model","serial_number","installation_date","warranty_expiry","area_id","task_count","actions"];function $e(l){if(!Array.isArray(l))return[...Ie];let s=new Set,e=[];for(let t of l)typeof t=="string"&&Oa.includes(t)&&!s.has(t)&&(s.add(t),e.push(t));return e.length?(e.includes("name")||e.unshift("name"),e):[...Ie]}function Pe(l,s,e){let t=new Blob([l],{type:e}),a=URL.createObjectURL(t),n=document.createElement("a");n.href=a,n.download=s,n.target="_blank",n.rel="noopener",n.style.display="none",document.body.appendChild(n),n.dispatchEvent(new MouseEvent("click")),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(a),6e4)}var Nt=q`
  :host {
    display: block;
    height: 100%;
...
`),this._scheduleTime=t.schedule_time||"";let n=t.on_complete_action;if(n&&n.service){this._actionService=n.service;let p=n.target?.entity_id;this._actionTargetEntity=Array.isArray(p)?p[0]||"":p||"",this._actionData=n.data&&typeof n.data=="object"?{...n.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let o=t.quick_complete_defaults;this._qcNotes=o?.notes||"",this._qcCost=o?.cost!=null?String(o.cost):"",this._qcDuration=o?.duration!=null?String(o.duration):"",this._qcFeedback=o?.feedback||"";let c=t.adaptive_config||{};if(this._environmentalEntity=c.environmental_entity||"",this._environmentalAttribute=c.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,t.trigger_config){let p=t.trigger_config;this._triggerEntityId=p.entity_id||"",this._triggerEntityIds=p.entity_ids||(p.entity_id?[p.entity_id]:[]),this._triggerEntityLogic=p.entity_logic||"any",this._triggerAttribute=p.attribute||"",this._triggerType=p.type||"threshold",this._triggerAbove=p.trigger_above?.toString()||"",this._triggerBelow=p.trigger_below?.toString()||"",this._triggerForMinutes=p.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=p.trigger_target_value?.toString()||"",this._triggerDeltaMode=p.trigger_delta_mode||!1,this._triggerFromState=p.trigger_from_state||"",this._triggerToState=p.trigger_to_state||"",this._triggerTargetChanges=p.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=p.trigger_runtime_hours?.toString()||""}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._notes="",this._documentationUrl="",this._customIcon="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._responsibleUserId=null,this._checklistText="",this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours=""}async _loadUsers(){this._userService||(this._userService=new oe(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[t,a]=e.split(".");if(!this.hass?.services?.[t]?.[a]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let n=this._actionTargetEntity.trim();if(n){let o=n.split(".")[0];if(o!==t&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(t)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${t}.* entities; entity "${n}" is in ${o}.* \u2014 pick a service that matches the entity domain (e.g. ${o}.${a})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[n]){this._actionTestResult="error",this._actionTestError=`Target entity "${n}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,a]=e.split("."),n=this.hass?.services?.[t]?.[a]?.fields;return!n||Object.keys(n).length===0?null:Object.entries(n).map(([o,c])=>({name:o,required:!!c.required,selector:c.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return d;let t=this._serviceSchema();return r`
      <details class="ca-section">
        ...
        <ha-form
          ...
          @value-changed=${a=>{let n=a.detail.value;this._actionTargetEntity=n.target_entity||""}}
        ></ha-form>
...
`).map(c=>c.trim()).filter(Boolean).slice(0,100);e.checklist=o.length?o:null}if(this.completionActionsEnabled){let o=this._actionService.trim();if(o&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(o)){let h={service:o},m=this._actionTargetEntity.trim();m&&(h.target={entity_id:m});let v=this._buildActionData();Object.keys(v).length>0&&(h.data=v),e.on_complete_action=h}else e.on_complete_action=null;let c={};this._qcNotes.trim()&&(c.notes=this._qcNotes.trim());let p=parseFloat(this._qcCost);!isNaN(p)&&p>=0&&(c.cost=p);let u=parseInt(this._qcDuration,10);!isNaN(u)&&u>=0&&(c.duration=u),this._qcFeedback&&(c.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(c).length?c:null}let t=await this.hass.connection.sendMessagePromise(e),a=this._taskId||t?.task_id,n=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(a&&this._scheduleType==="sensor_based"&&n)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=W(e,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return d;let e=this._lang;return r`
      ...
      <div class="select-row">
        ...
        >
          ${Qa.map(t=>r`<option value=${t} ?selected=${t===this._triggerType}>${i(t,e)}</option>`)}
        </select>
      </div>
      ...
      <div class="select-row">
        ...
        <div class="weekday-chips">
          ${t.map((a,n)=>r`
            ...
            >${a}</button>`)}
        </div>`;if(this._scheduleType==="nth_weekday"){let a=[["1",i("ord_1",e)],["2",i("ord_2",e)],["3",i("ord_3",e)],["4",i("ord_4",e)],["5",i("ord_5",e)],["-1",i("ord_last",e)]];return r`
        <div class="select-row">
          <label>${i("recurrence_occurrence",e)}</label>
          <select .value=${this._nth} @change=${n=>this._nth=n.target.value}>
            ${a.map(([n,o])=>r`<option value=${n} ?selected=${n===this._nth}>${o}</option>`)}
          </select>
        </div>
        <div class="select-row">
          <label>${i("recurrence_weekday",e)}</label>
          <select .value=${this._nthWeekday} @change=${n=>this._nthWeekday=n.target.value}>
            ${t.map((n,o)=>r`<option value=${String(o)} ?selected=${String(o)===this._nthWeekday}>${n}</option>`)}
          </select>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Ga.map(a=>r`<option value=${a} ?selected=${a===this._scheduleType}>${i(a,e)}</option>`)}
            </select>
          </div>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,_([x({attribute:!1})],J.prototype,"hass",2),_([x()],J.prototype,"lang",2),_([g()],J.prototype,"_open",2),_([g()],J.prototype,"_loading",2),_([g()],J.prototype,"_error",2),_([g()],J.prototype,"_viewResult",2),_([g()],J.prototype,"_completeResult",2),_([g()],J.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",J);var Rt=5;function ze(l){let s=l.getFullYear(),e=String(l.getMonth()+1).padStart(2,"0"),t=String(l.getDate()).padStart(2,"0");return`${s}-${e}-${t}`}function Ya(l,s){let e=[];for(let t=0;t<s;t++){let a=new Date(l);a.setDate(a.getDate()+t),a.setHours(0,0,0,0),e.push(ze(a))}return e}function Le(l,s){let[e,t,a]=l.split("-").map(Number),n=new Date(e,t-1,a);return n.setDate(n.getDate()+s),ze(n)}function Xa(l){if(!l||l.length===0)return null;let s=l.map(e=>e.cost).filter(e=>typeof e=="number");return s.length===0?null:s.reduce((e,t)=>e+t,0)/s.length}function ei(l){let{windowStart:s,windowEnd:e,task:t,entryId:a,objectName:n}=l,o=[],c=(m,v)=>({date:m,entry_id:a,task_id:t.id,task_name:t.name,object_name:n,status:v&&(t.status==="overdue"||t.status==="triggered")?"ok":t.status,days_until_due:v?null:t.days_until_due??null,projected:v,schedule_type:t.schedule_type,interval_days:t.interval_days??null,interval_unit:t.interval_unit??null,responsible_user_id:t.responsible_user_id??null,avg_cost:Xa(t.history),adaptive_enabled:!!t.adaptive_config?.enabled,prediction_confidence:t.threshold_prediction_confidence??null}),p=Math.max(1,Math.round(st(t.interval_days,t.interval_unit)));if(t.status==="overdue"||t.status==="triggered"){if(o.push(c(s,!1)),t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let m=Le(s,p),v=1;for(;m<=e&&v<Rt;)o.push(c(m,!0)),v++,m=Le(m,p)}return o}let u=t.next_due;if(typeof u!="string"||!u)return o;let h=u.slice(0,10);if(h>=s&&h<=e)o.push(c(h,!1));else if(h>e)return o;if(t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let m=Le(h,p),v=o.length;for(;m<=e&&v<Rt;)m>=s&&(o.push(c(m,!0)),v++),m=Le(m,p)}return o}var It={overdue:0,triggered:1,due_soon:2,ok:3};function Pt(l,s,e,t=null){let a=Ya(s,e),n=a[0],o=a[a.length-1],c=[];for(let u of l){let h=u.object?.name||"",m=u.entry_id,v=u.tasks||[];for(let f of v){if(t&&f.responsible_user_id!==t||f.enabled===!1)continue;let k=ei({windowStart:n,windowEnd:o,task:f,entryId:m,objectName:h});c.push(...k)}}let p=new Map;for(let u of a)p.set(u,[]);for(let u of c){let h=p.get(u.date);h&&h.push(u)}for(let[,u]of p)u.sort((h,m)=>{let v=It[h.status]??99,f=It[m.status]??99;if(v!==f)return v-f;if(h.projected!==m.projected)return h.projected?1:-1;let k=h.object_name.localeCompare(m.object_name);return k!==0?k:h.task_name.localeCompare(m.task_name)});return a.map(u=>({date:u,events:p.get(u)??[]}))}var ti={completed:"ok",reset:"ok",skipped:"due_soon",triggered:"triggered",trigger_replaced:"triggered"};function ai(l,s){let e=[];for(let t=s-1;t>=0;t--){let a=new Date(l);a.setDate(a.getDate()-t),a.setHours(0,0,0,0),e.push(ze(a))}return e}function Ft(l,s,e,t=null){let a=ai(s,e),n=a[0],o=a[a.length-1],c=new Map;for(let u of a)c.set(u,[]);for(let u of l){let h=u.object?.name||"",m=u.entry_id,v=u.tasks||[];for(let f of v){if(t&&f.responsible_user_id!==t)continue;let k=f.history||[];for(let b of k){if(typeof b?.timestamp!="string")continue;let N=b.timestamp.slice(0,10);if(N<n||N>o)continue;let C=c.get(N);if(!C)continue;let E=b.type??"completed";C.push({date:N,entry_id:m,task_id:f.id,task_name:f.name,object_name:h,status:ti[E]??"ok",days_until_due:null,projected:!1,schedule_type:f.schedule_type,interval_days:f.interval_days??null,responsible_user_id:f.responsible_user_id??null,avg_cost:typeof b.cost=="number"?b.cost:null,adaptive_enabled:!!f.adaptive_config?.enabled,prediction_confidence:null,history_timestamp:b.timestamp,history_type:E,history_cost:typeof b.cost=="number"?b.cost:null,history_notes:typeof b.notes=="string"?b.notes:null,history_duration:typeof b.duration=="number"?b.duration:null})}}}let p={completed:0,reset:1,skipped:2,triggered:3,trigger_replaced:4};for(let[,u]of c)u.sort((h,m)=>{let v=p[h.history_type??""]??99,f=p[m.history_type??""]??99;if(v!==f)return v-f;let k=h.object_name.localeCompare(m.object_name);return k!==0?k:h.task_name.localeCompare(m.task_name)});return a.map(u=>({date:u,events:c.get(u)??[]}))}var Lt=q`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;var Y=class extends T{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter)}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){if(super.updated(e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}_onEventClick(e){if(e.history_timestamp){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return d;let e=this._lang,t=this._config.show_window_chips!==!1,a=this._config.show_user_filter!==!1,n=this._config.title,o=null;this._userFilter&&(o=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let c=new Date;c.setHours(0,0,0,0);let p=this._pastDays>0,u=p?Ft(this._objects,c,this._pastDays,o):Pt(this._objects,c,this._windowDays,o),h=ze(c),m=this._windowDays===365||p,v=m?u.filter(b=>b.events.length>0):u,f=b=>{let N=`cal-status-${b.status}`,C=b.projected?"cal-event-projected":"",E=b.status==="overdue"&&b.days_until_due!=null?` (${Math.abs(b.days_until_due)}d ${i("overdue",e).toLowerCase()})`:"",$=b.projected&&b.interval_days?r`<span class="cal-event-recur">${b.interval_unit&&b.interval_unit!=="days"?`${b.interval_days} ${i("unit_"+b.interval_unit,e)}`:i("cal_every_n_days",e).replace("{n}",String(b.interval_days))}</span>`:d,M=b.schedule_type==="sensor_based",L=M?r`<ha-icon class="cal-event-icon cal-source-sensor"
            ...
            ${i("cal_predicted",e)} · ${i(`cal_confidence_${b.prediction_confidence}`,e)}
          </span>`:d,Q=this._stats?.budget?.currency_symbol||"\u20AC",D=b.history_type?i(b.history_type,e):i(b.status,e);return r`
      ...
      `},k=b=>{let[N,C,E]=b.date.split("-").map(Number),$=new Date(N,C-1,E),M=b.date===h,L=$.toLocaleDateString(e,{weekday:"short"}),B=$.toLocaleDateString(e,{month:"long"});return r`
        <div class="cal-day-row">
          ...
          <div class="cal-day-content">
            ...
            ${b.events.length===0?r`<div class="cal-empty">${i("cal_no_events",e)}</div>`:b.events.map(f)}
          </div>
        </div>
      `};return r`
      <ha-card .header=${n}>
        ...
        <div class="cal-rolling">
          ${v.length===0&&m?r`<div class="cal-empty">${i("cal_no_events",e)}</div>`:v.map(k)}
        </div>
      </ha-card>
    `}};Y.styles=[Re,Lt,q`
      :host { display: block; }
      ha-card { padding: 0; overflow: hidden; }
    `],_([x({attribute:!1})],Y.prototype,"hass",2),_([g()],Y.prototype,"_config",2),_([g()],Y.prototype,"_objects",2),_([g()],Y.prototype,"_stats",2),_([g()],Y.prototype,"_windowDays",2),_([g()],Y.prototype,"_pastDays",2),_([g()],Y.prototype,"_userFilter",2),_([g()],Y.prototype,"_unsub",2);var ii=[{value:7,label:"Week (7 days)"},{value:14,label:"Fortnight (14 days)"},{value:30,label:"Month (30 days, default)"},{value:365,label:"Year (365 days, empty days collapsed)"}],me=class extends T{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}setConfig(e){this._config={...e}}_valueChanged(e,t){let a={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete a.show_window_chips,e==="show_user_filter"&&t===!0&&delete a.show_user_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete a.title,e==="user_filter"&&t===""&&delete a.user_filter,this._config=a,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:a},bubbles:!0,composed:!0}))}render(){let e=this._config.window_days??30,t=this._config.show_window_chips!==!1,a=this._config.show_user_filter!==!1,n=this._config.user_filter??"",o=this._config.title??"";return r`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${ii.map(c=>r`<option value="${c.value}" ?selected=${c.value===e}>${c.label}</option>`)}
          </select>
        </div>
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ...
        <label>
          ...
          <input type="datetime-local"
            ...
            @change=${a=>{let n=a.target.value;this._set("timestamp",n.length===16?`${n}:00`:n)}} />
        </label>
        <label>
          <span>${i("notes_label",e)}</span>
          <textarea
            rows="3"
            @input=${a=>{let n=a.target.value;this._set("notes",n||null)}}
        ...
        <div class="row">
          <label>
            ...
            <input type="number" min="0" step="0.01"
              ...
              @input=${a=>{let n=a.target.value;this._set("cost",n?Number(n):null)}} />
          </label>
          <label>
            <span>${i("duration",e)||"Duration (min)"}</span>
            <input type="number" min="0"
              .value=${t.duration!=null?String(t.duration):""}
              @input=${a=>{let n=a.target.value;this._set("duration",n?Number(n):null)}} />
          </label>
        </div>
        ${this._error?r`<div class="error">${this._error}</div>`:d}
        <div class="actions">
  ...
  `,_([x({attribute:!1})],G.prototype,"hass",2),_([g()],G.prototype,"_open",2),_([g()],G.prototype,"_title",2),_([g()],G.prototype,"_message",2),_([g()],G.prototype,"_confirmText",2),_([g()],G.prototype,"_danger",2),_([g()],G.prototype,"_inputLabel",2),_([g()],G.prototype,"_inputType",2),_([g()],G.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",G);var Ot={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ut=l=>(...s)=>({_$litDirective$:l,values:s}),Oe=class{constructor(s){}get _$AU(){return this._$AM._$AU}_$AT(s,e,t){this._$Ct=s,this._$AM=e,this._$Ci=t}_$AS(s,e){return this.update(s,e)}update(s,e){return this.render(...e)}};var je=class extends Oe{constructor(s){if(super(s),this.it=d,s.type!==Ot.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(s){if(s===d||s==null)return this._t=void 0,this.it=s;if(s===te)return s;if(typeof s!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(s===this.it)return this._t;this.it=s;let e=[s];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};je.directiveName="unsafeHTML",je.resultType=1;var Vt=Ut(je);var si=["EUR","USD","GBP","JPY","CHF","CAD","AUD","CNY","INR","BRL","CZK","PLN","RUB","SEK","NOK","DKK","UAH"],A=class extends T{constructor(){super(...arguments);this.budget=null;this._settings=null;this._loading=!0;this._importCsv="";this._importLoading=!1;this._includeHistory=!0;this._toast="";this._testingNotification=!1;this._users=[];this._vacEnabled=!1;this._vacStart="";this._vacEnd="";this._vacBuffer=3;this._vacExempt=new Set;this._vacIsActive=!1;this._vacWindowEnd=null;this._vacAllTasks=[];this._vacPreview=[];this._vacPreviewLoading=!1;this._vacSaving=!1;this._qrObjects=[];this._qrSelectedEntries=new Set;this._qrActions=new Set(["view"]);this._qrUrlMode="companion";this._qrBatchLoading=!1;this._qrBatchResults=[];this._qrObjectsLoaded=!1;this._loaded=!1;this._userService=null;this._sendTestNotification=async()=>{this._testingNotification=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/test_notification"}),t=e.message||(e.success?i("test_notification_success",this._lang):i("test_notification_failed",this._lang));this._showToast(t)}catch{this._showToast(i("test_notification_failed",this._lang))}finally{this._testingNotification=!1}}}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded?(this._loaded=!0,this._userService=new oe(this.hass),this._loadSettings(),this._loadUsers()):e.has("hass")&&this.hass&&this._userService&&this._userService.updateHass(this.hass)}async _loadUsers(){if(this._userService)try{this._users=await this._userService.getUsers()}catch{this._users=[]}}async _loadSettings(){this._loading=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});this._settings=e,this._hydrateVacationFromSettings()}catch{}this._loading=!1}_hydrateVacationFromSettings(){let e=this._settings?.vacation;e&&(this._vacEnabled=e.enabled,this._vacStart=e.start||"",this._vacEnd=e.end||"",this._vacBuffer=e.buffer_days,this._vacExempt=new Set(e.exempt_task_ids||[]),this._vacIsActive=e.is_active,this._vacWindowEnd=e.window_end)}async _updateSetting(e,t){try{let a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:{[e]:t}});this._settings=a,this._showToast(i("settings_saved",this._lang)),this.dispatchEvent(new CustomEvent("settings-changed"))}catch{this._showToast(i("action_error",this._lang))}}_showToast(e){this._toast=e,setTimeout(()=>{this._toast=""},3e3)}_downloadFile(e,t,a){Pe(e,t,a)}render(){let e=this._lang;return this._loading||!this._settings?r`<div class="settings-loading">Loading…</div>`:r`
    ...
    `}scrollToSection(e){requestAnimationFrame(()=>{let t=this.shadowRoot;if(!t)return;let a=t.querySelector(`[data-section="${e}"]`)??t.querySelector(`[data-section-alt="${e}"]`);a&&a.scrollIntoView({behavior:"smooth",block:"start"})})}_renderPanelAccess(e){let t=new Set(this._settings.admin_panel_user_ids||[]),a=this._users.filter(c=>!c.is_admin),n=this._settings.operator_write_enabled??!1,o=(c,p)=>{let u=new Set(t);p?u.add(c):u.delete(c),this._updateSetting("admin_panel_user_ids",[...u])};return r`
      <div class="settings-section">
        <h3>${i("settings_panel_access",e)} ${n&&t.size>0?r`<span class="section-badge">${t.size}</span>`:d}</h3>
        <p class="section-desc">${i("settings_panel_access_desc",e)}</p>
        <label class="setting-row">
          <span>
            <span class="setting-label">${i("settings_operator_write",e)}</span>
            <span class="setting-desc">${i("settings_operator_write_desc",e)}</span>
          </span>
          <input type="checkbox"
            .checked=${n}
            @change=${c=>this._updateSetting("operator_write_enabled",c.target.checked)} />
        </label>
        ${n?a.length===0?r`<div class="setting-row hint">${i("no_non_admin_users",e)}</div>`:a.map(c=>r`
              <label class="setting-row">
                <span>
                  <span class="setting-label">${c.name||c.id.slice(0,8)}</span>
                  <span class="setting-desc">${c.is_owner?i("owner_label",e):""}</span>
                </span>
                <input type="checkbox"
                  .checked=${t.has(c.id)}
                  @change=${p=>o(c.id,p.target.checked)} />
              </label>
            `):d}
      </div>
    ...
    `}_renderObjectsColumns(e){let t=$e(this._settings.objects_table_columns);return r`
      <div class="settings-section" data-section="objects_table_columns">
        <h3>${i("objects_table_columns_label",e)}</h3>
        <p class="section-desc">${i("objects_table_columns_hint",e)}</p>
        ${ue.map(a=>r`
          <label class="setting-row">
            <span class="setting-label">${i(a.labelKey,e)}</span>
            <input
              type="checkbox"
              .checked=${t.includes(a.key)}
              ?disabled=${!!a.required}
              @change=${n=>this._toggleColumn(a.key,n.target.checked)}
            />
          </label>
        `)}
      </div>
    `}_toggleColumn(e,t){let a=new Set($e(this._settings.objects_table_columns));t?a.add(e):a.delete(e);let n=ue.filter(o=>o.required||a.has(o.key)).map(o=>o.key);this._updateSetting("objects_table_columns",n)}_renderGeneral(e){let t=this._settings.general,a=this._settings.budget;return r`
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select @change=${n=>this._updateSetting("budget_currency",n.target.value)}>
            ${si.map(n=>r`<option value=${n} ?selected=${a.currency===n}>${n}</option>`)}
          </select>
        </label>
        <label class="setting-row">
        ...
        ${t.panel_enabled?r`
          <label class="setting-row">
            <span class="setting-label">${i("settings_panel_title",e)}</span>
    ...
    `}_renderVacationTaskList(e){let t=new Map;for(let n of this._vacAllTasks){let o=t.get(n.object_name)||[];o.push(n),t.set(n.object_name,o)}return[...t.entries()].sort(([n],[o])=>n.localeCompare(o)).map(([n,o])=>r`
      <div class="vac-task-group">
        ...
        ${o.sort((c,p)=>c.task_name.localeCompare(p.task_name)).map(c=>r`
...
<body>
  ...
  <script>window.addEventListener("load", function () { setTimeout(function () { window.print(); }, 250); });<\/script>
      ...
      <div class="settings-section">
        ...
        <div class="settings-actions">
          ...
          <button @click=${this._exportYaml}>${i("settings_export_yaml",e)}</button>
    ...
    `}async _exportJson(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/export",format:"json",include_history:this._includeHistory}),t=new Date().toISOString().slice(0,10);this._downloadFile(e.data,`maintenance_export_${t}.json`,"application/json"),this._showToast(i("settings_export_success",this._lang))}catch{this._showToast(i("action_error",this._lang))}}async _exportYaml(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/export",format:"yaml",include_history:this._includeHistory}),t=new Date().toISOString().slice(0,10);this._downloadFile(e.data,`maintenance_export_${t}.yaml`,"application/yaml"),this._showToast(i("settings_export_success",this._lang))}catch{this._showToast(i("action_error",this._lang))}}async _exportCsv(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/csv/export"}),t=new Date().toISOString().slice(0,10);this._downloadFile(e.csv,`maintenance_export_${t}.csv`,"text/csv"),this._showToast(i("settings_export_success",this._lang))}catch{this._showToast(i("action_error",this._lang))}}async _importCsvAction(){let e=this._importCsv.trim();if(e){this._importLoading=!0;try{let t=e.startsWith("object_name"),n=(await this.hass.connection.sendMessagePromise(t?{type:"maintenance_supporter/csv/import",csv_content:e}:{type:"maintenance_supporter/json/import",json_content:e})).created??0;this._showToast(i("settings_import_success",this._lang).replace("{count}",String(n))),this._importCsv="",this.dispatchEvent(new CustomEvent("settings-changed"))}catch{this._showToast(i("action_error",this._lang))}this._importLoading=!1}}};A.styles=q`
    :host { display: block; }
  ...
  `,_([x({attribute:!1})],K.prototype,"hass",2),_([x({attribute:!1})],K.prototype,"objects",2),_([g()],K.prototype,"_open",2),_([g()],K.prototype,"_loading",2),_([g()],K.prototype,"_error",2),_([g()],K.prototype,"_groupId",2),_([g()],K.prototype,"_name",2),_([g()],K.prototype,"_description",2),_([g()],K.prototype,"_selected",2);customElements.get("maintenance-group-dialog")||customElements.define("maintenance-group-dialog",K);var ri=300,li=140,lt=27;function Wt(l,s){let e=l.trigger_config;if(!e)return d;let t=s.lang,a=l.trigger_entity_info,n=l.trigger_entity_infos,o=a?.friendly_name||e.entity_id||"\u2014",c=e.entity_id||"",p=e.entity_ids||(c?[c]:[]),u=a?.unit_of_measurement||"",h=l.trigger_current_value,m=e.type||"threshold",v=p.length>1;return r`
    <h3>${i("trigger",t)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${v?r`
            <div class="trigger-entity-name">${p.length} ${i("entities",t)} (${e.entity_logic||"any"})</div>
            <div class="trigger-entity-id">${p.map((f,k)=>r`${k>0?", ":""}<span class="entity-link" @click=${b=>de(b,f)}>${f}</span>`)}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `:r`
      ...
      ${h!=null?r`
            <div class="trigger-value-row">
              ...
              ${u?r`<span class="trigger-unit">${u}</span>`:d}
            </div>
          `:d}

      <div class="trigger-limits">
        ${m==="threshold"?r`
          ${e.trigger_above!=null?r`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("threshold_above",t)}: ${e.trigger_above} ${u}</span>`:d}
          ${e.trigger_below!=null?r`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("threshold_below",t)}: ${e.trigger_below} ${u}</span>`:d}
        ...
        `:d}
        ${m==="counter"?r`
          ${e.trigger_target_value!=null?r`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("target_value",t)}: ${e.trigger_target_value} ${u}</span>`:d}
        `:d}
        ${m==="state_change"?r`
        ...
        ${m==="compound"?r`
          ...
          ${(e.conditions||[]).map((f,k)=>r`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${k+1}. ${i(f.type||"unknown",t)}: ${f.entity_id?r`<span class="entity-link" @click=${b=>de(b,f.entity_id)}>${f.entity_id}</span>`:""}</span>
          `)}
        `:d}
        ${a?.min!=null?r`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${i("min",t)}: ${a.min} ${u}</span>`:d}
        ${a?.max!=null?r`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${i("max",t)}: ${a.max} ${u}</span>`:d}
      </div>
  ...
  `}function ci(l,s,e){let t=l.trigger_config;if(!t)return d;let a=t.type||"threshold",n=a==="counter"&&t.trigger_delta_mode,o=e.isCounterEntity(t),c=t.entity_id||"",p=e.detailStatsData.get(c)||[],u=[],h=!1;if(p.length>=2)for(let y of p){let S=y.val;n&&l.trigger_baseline_value!=null&&(S-=l.trigger_baseline_value);let H={ts:y.ts,val:S};!o&&y.min!=null&&y.max!=null&&(H.min=n&&l.trigger_baseline_value!=null?y.min-l.trigger_baseline_value:y.min,H.max=n&&l.trigger_baseline_value!=null?y.max-l.trigger_baseline_value:y.max,h=!0),u.push(H)}else for(let y of l.history)y.trigger_value!=null&&u.push({ts:new Date(y.timestamp).getTime(),val:y.trigger_value});if(l.trigger_current_value!=null){let y=l.trigger_current_value;n&&l.trigger_baseline_value!=null&&(y-=l.trigger_baseline_value),u.push({ts:Date.now(),val:y})}if(u.length<2&&c&&e.hasStatsService&&!e.detailStatsData.has(c))return r`<div class="sparkline-container" aria-live="polite" style="display:flex;align-items:center;justify-content:center;height:140px;color:var(--secondary-text-color);font-size:12px;">
      <ha-icon icon="mdi:chart-line" style="--mdc-icon-size:16px;margin-right:8px;"></ha-icon>
      ${i("loading_chart",e.lang)}
    </div>`;if(u.length<2)return d;u.sort((y,S)=>y.ts-S.ts);let m=ri,v=li,f=30,k=2,b=8,N=16,C=u.map(y=>y.val),E=Math.min(...C),$=Math.max(...C);if(h)for(let y of u)y.min!=null&&(E=Math.min(E,y.min)),y.max!=null&&($=Math.max($,y.max));t.trigger_above!=null&&($=Math.max($,t.trigger_above),E=Math.min(E,t.trigger_above)),t.trigger_below!=null&&(E=Math.min(E,t.trigger_below),$=Math.max($,t.trigger_below));let M=null,L=null;if(a==="counter"&&t.trigger_target_value!=null){if(l.trigger_baseline_value!=null)M=l.trigger_baseline_value;else if(u.length>0){let y=[...l.history].filter(S=>S.type==="completed"||S.type==="reset").sort((S,H)=>new Date(H.timestamp).getTime()-new Date(S.timestamp).getTime())[0];if(y){let S=new Date(y.timestamp).getTime(),H=u[0],U=Math.abs(u[0].ts-S);for(let ie of u){let ne=Math.abs(ie.ts-S);ne<U&&(H=ie,U=ne)}M=H.val}else M=u[0].val}M!=null?(L=M+t.trigger_target_value,$=Math.max($,L),E=Math.min(E,M)):($=Math.max($,t.trigger_target_value),E=Math.min(E,0))}n&&l.trigger_baseline_value!=null&&(E=Math.min(E,0));let B=$-E||1;E-=B*.1,$+=B*.1;let Q=u[0].ts,D=u[u.length-1].ts,z=D-Q||1,I=y=>f+(y-Q)/z*(m-f-k),R=y=>b+(1-(y-E)/($-E))*(v-b-N),Ue=u.map(y=>`${I(y.ts).toFixed(1)},${R(y.val).toFixed(1)}`).join(" "),ta=`M${I(u[0].ts).toFixed(1)},${v-N} `+u.map(y=>`L${I(y.ts).toFixed(1)},${R(y.val).toFixed(1)}`).join(" ")+` L${I(u[u.length-1].ts).toFixed(1)},${v-N} Z`,Ve="";if(h){let y=u.filter(S=>S.min!=null&&S.max!=null);if(y.length>=2){let S=y.map(U=>`${I(U.ts).toFixed(1)},${R(U.max).toFixed(1)}`),H=[...y].reverse().map(U=>`${I(U.ts).toFixed(1)},${R(U.min).toFixed(1)}`);Ve=`M${S[0]} `+S.slice(1).map(U=>`L${U}`).join(" ")+` L${H[0]} `+H.slice(1).map(U=>`L${U}`).join(" ")+" Z"}}let ct=u[u.length-1],aa=I(ct.ts),ia=R(ct.val),dt=y=>Math.abs(y)>=1e4?(y/1e3).toFixed(0)+"k":y>=1e3?(y/1e3).toFixed(1)+"k":y.toFixed(y<10?1:0),na=dt($),sa=dt(E),oa=l.history.filter(y=>["completed","skipped","reset"].includes(y.type)).map(y=>({ts:new Date(y.timestamp).getTime(),type:y.type})).filter(y=>y.ts>=Q&&y.ts<=D),Be=u;if(u.length>lt){let y=(u.length-1)/(lt-1);Be=[];for(let S=0;S<lt;S++)Be.push(u[Math.round(S*y)])}return r`
    <div class="sparkline-container">
      <svg class="sparkline-svg" viewBox="0 0 ${m} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_sparkline",e.lang)}">
        <text x="${f-3}" y="${b+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${na}</text>
        <text x="${f-3}" y="${v-N+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${sa}</text>
        ...
        ${Ve?P`<path d="${Ve}" fill="var(--primary-color)" opacity="0.08" />`:d}
        <path d="${ta}" fill="var(--primary-color)" opacity="0.15" />
        <polyline points="${Ue}" fill="none" stroke="var(--primary-color)" stroke-width="2" stroke-linejoin="round" />
        ${l.degradation_rate!=null&&l.degradation_trend!=="stable"&&l.degradation_trend!=="insufficient_data"&&u.length>=2?(()=>{let y=u[u.length-1],S=30,H=y.ts+S*864e5,U=y.val+l.degradation_rate*S,ie=Math.min(H,D+(D-Q)*.3),ne=Math.max(E,Math.min($,U)),ra=I(y.ts),la=R(y.val),ca=I(ie),da=R(ne);return P`<line x1="${ra.toFixed(1)}" y1="${la.toFixed(1)}" x2="${ca.toFixed(1)}" y2="${da.toFixed(1)}" stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.7" />`})():d}
        ...
        ${a==="counter"&&L!=null?P`<line x1="${f}" y1="${R(L).toFixed(1)}" x2="${m}" y2="${R(L).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${m-2}" y="${R(L)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">${i("target_value",e.lang)}: +${t.trigger_target_value}</text>`:d}
        ${a==="counter"&&M!=null?P`<line x1="${f}" y1="${R(M).toFixed(1)}" x2="${m}" y2="${R(M).toFixed(1)}" stroke="var(--secondary-text-color)" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
                <text x="${f+2}" y="${R(M)+11}" text-anchor="start" fill="var(--secondary-text-color)" font-size="8">${i("baseline",e.lang)}</text>`:d}
        <circle cx="${aa.toFixed(1)}" cy="${ia.toFixed(1)}" r="3.5" fill="var(--primary-color)" />
        ${oa.map(y=>{let S=I(y.ts),H=y.type==="completed"?"var(--success-color, #4caf50)":y.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return P`
          ...
          `})}
        ${Be.map(y=>{let S=I(y.ts),H=R(y.val),U=new Date(y.ts).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),ie=`${y.val.toFixed(1)} ${s}`;return h&&y.min!=null&&y.max!=null&&(ie+=` (${y.min.toFixed(1)}\u2013${y.max.toFixed(1)})`),P`<circle cx="${S.toFixed(1)}" cy="${H.toFixed(1)}" r="8" fill="transparent" tabindex="0"
            @mouseenter=${ne=>Bt(ne,`${U}
${ie}`,e.setTooltip)}
            @focus=${ne=>Bt(ne,`${U}
${ie}`,e.setTooltip)}
...
`).map(y=>r`<div>${y}</div>`)}
  ...
  `}function Bt(l,s,e){let t=l.currentTarget,a=t.closest(".sparkline-container");if(!a)return;let n=a.getBoundingClientRect(),o=t.getBoundingClientRect();e({x:o.left-n.left+o.width/2,y:o.top-n.top-8,text:s})}function Gt(l,s,e){let t=l.degradation_trend!=null&&l.degradation_trend!=="insufficient_data",a=l.days_until_threshold!=null,n=l.environmental_factor!=null&&l.environmental_factor!==1;if(!t&&!a&&!n)return d;let o=l.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":l.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return r`
  ...
  `}function Kt(l,s){let e=l.interval_analysis,t=e?.weibull_beta,a=e?.weibull_eta;if(t==null||a==null||a<=0)return d;let n=l.interval_days??0,o=l.suggested_interval??n;return r`
  ...
  `}function ui(l,s,e){let t=l.confidence_interval_low,a=l.confidence_interval_high,n=s.suggested_interval??s.interval_days??0,o=s.interval_days??0,c=Math.max(0,t-5),u=a+5-c,h=(t-c)/u*100,m=(a-t)/u*100,v=(n-c)/u*100,f=o>0?(o-c)/u*100:-1;return r`
  ...
  `}function Qt(l,s,e,t){let a=Math.max(l||1,s);return r`
    <div class="interval-comparison">
      <div class="interval-bar">
        <div class="interval-label">
          ${i("current",t)}: ${l??"\u2014"} ${l!=null?i("days",t):""}
        </div>
  ...
  `}function Yt(l,s){return gi(l,s)}function gi(l,s){let e=l.seasonal_factors??l.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return d;let t=l.interval_analysis?.seasonal_reason,a=new Date().getMonth(),n=300,o=100,c=8,u=o-c-4,h=Math.max(...e,1.5),m=n/12,v=m*.65,f=c+u-1/h*u;return r`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${n} ${o}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_seasonal",s)}">
        ...
        ${e.map((k,b)=>{let N=k/h*u,C=b*m+(m-v)/2,E=c+u-N,$=b===a,M=k<1?"var(--success-color, #4caf50)":k>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return P`
      ...
      <div class="seasonal-labels">
        ${Zt.map((k,b)=>r`<span class="seasonal-label ${b===a?"active-month":""}">${i(k,s)}</span>`)}
      </div>
    </div>
  `}var mi=300,hi=200;function Xt(l,s,e,t){let a=l.history.filter(c=>c.type==="completed"&&(c.cost!=null||c.duration!=null));if(a.length<2)return d;let n=a.some(c=>(c.cost??0)>0),o=a.some(c=>(c.duration??0)>0);return!n&&!o?d:r`
  ...
  `}function vi(l,s,e){let t=l.history.filter(z=>z.type==="completed"&&(z.cost!=null||z.duration!=null)).map(z=>({ts:new Date(z.timestamp).getTime(),cost:z.cost??0,duration:z.duration??0})).sort((z,I)=>z.ts-I.ts);if(t.length<2)return d;let a=t.some(z=>z.cost>0),n=t.some(z=>z.duration>0);if(!a&&!n)return d;let o=e!=="duration"&&a,c=e!=="cost"&&n,p=o||!c&&a,u=c||!o&&n,h=mi,m=hi,v=p?32:8,f=u?32:8,k=8,b=20,N=h-v-f,C=m-k-b,E=Math.max(...t.map(z=>z.cost))||1,$=Math.max(...t.map(z=>z.duration))||1,M=Math.min(20,N/t.length*.6),L=N/t.length,B=z=>v+L*z+L/2,Q=z=>k+C-z/E*C,D=z=>k+C-z/$*C;return r`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${h} ${m}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_history",s)}">
        ${p?t.map((z,I)=>P`
  ...
  `}var fi=60,bi=20,ea=30,j=class extends T{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._unsub=null;this._sparklineTooltip=null;this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._operatorWriteEnabled=!1;this._defaultWarningDays=7;this._actionLoading=!1;this._moreMenuOpen=!1;this._toastMessage="";this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab="dashboard";this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._objectViewMode="cards";this._objectsTableColumns=Ie;this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=e=>this._onPopState(e);this._deepLinkHandled=!1;this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=e=>{let t=e.detail;t?.type==="maintenance-supporter:open-task"&&t.entry_id&&t.task_id&&(e.stopPropagation(),this._showTask(t.entry_id,t.task_id))};this._onHistoryEntrySaved=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"en"}get _isOperator(){let e=this.hass?.user;return e?e.is_admin?!1:!(this._operatorWriteEnabled&&this._adminPanelUserIds.includes(e.id)):!0}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._popstateHandler);let e=localStorage.getItem("maintenance_supporter_sort");e&&["due_date","object","type","task_name","area","assigned_user","group"].includes(e)&&(this._sortMode=e);let t=localStorage.getItem("maintenance_supporter_object_sort");t&&["alphabetical","due_soonest","task_count"].includes(t)&&(this._objectSortMode=t);let a=localStorage.getItem("maintenance_supporter_groupby");a&&["none","area","group","user"].includes(a)&&(this._groupByMode=a);let n=localStorage.getItem("maintenance_supporter_object_view");(n==="cards"||n==="table")&&(this._objectViewMode=n)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(e){if(super.updated(e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Fe(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new oe(this.hass),this._userService.getUsers())}}async _loadData(){let[e,t,a,n,o]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null)]);if(e&&(this._objects=e.objects),t&&(this._stats=t),a&&(this._budget=a),n&&(this._groups=n.groups||{}),o){let c=o;this._features=c.features,this._adminPanelUserIds=c.admin_panel_user_ids||[],this._operatorWriteEnabled=c.operator_write_enabled??!1;let p=c.general?.default_warning_days;typeof p=="number"&&p>=0&&p<=365&&(this._defaultWarningDays=p),this._objectsTableColumns=$e(c.objects_table_columns)}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search),t=e.get("ms_action"),a=()=>{let h=window.location.pathname+window.location.hash;history.replaceState(history.state,"",h)};if(t==="add_object"){this._deepLinkHandled=!0,a(),requestAnimationFrame(()=>{this.shadowRoot?.querySelector("maintenance-object-dialog")?.openCreate()});return}if(t==="open_vacation"||t==="open_budget"||t==="open_groups"||t==="open_settings"){this._deepLinkHandled=!0,a(),this._overviewTab="settings",requestAnimationFrame(()=>{let h=this.shadowRoot?.querySelector("maintenance-settings-view"),m=t.replace("open_","");h?.scrollToSection?.(m)});return}let n=e.get("entry_id");if(!n)return;this._deepLinkHandled=!0;let o=e.get("task_id"),c=e.get("action"),p=window.location.pathname+window.location.hash;history.replaceState(history.state,"",p);let u=this._getObject(n);if(!u){this._showOverview();return}if(o){let h=u.tasks.find(m=>m.id===o);if(!h){this._showObject(n);return}this._showTask(n,o),c==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(n,o,h.name,this._features.checklists?h.checklist:void 0,this._features.adaptive&&!!h.adaptive_config?.enabled)}):c==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(n,o,h)})}else this._showObject(n)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let a=await this._statsService.getDetailStats(e,t),n=new Map(this._detailStatsData);n.set(e,a),this._detailStatsData=n}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=[];for(let a of this._objects)for(let n of a.tasks){let o=n.trigger_config?.entity_id;o&&e.push({entityId:o,isCounter:this._isCounterEntity(n.trigger_config)})}if(e.length===0)return;let t=await this._statsService.getBatchMiniStats(e);this._miniStatsData=new Map([...this._miniStatsData,...t])}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _taskRows(){let e=[];for(let m of this._objects)for(let v of m.tasks){if(this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let k=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==k)continue}let f=[];for(let k of Object.values(this._groups))k.task_refs?.some(b=>b.entry_id===m.entry_id&&b.task_id===v.id)&&f.push(k.name);e.push({entry_id:m.entry_id,task_id:v.id,object_name:m.object.name,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_unit:v.interval_unit??null,interval_anchor:v.interval_anchor??null,is_done:v.is_done??!1,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,area_id:m.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:f})}let t={overdue:0,triggered:1,due_soon:2,ok:3},a=(m,v)=>(t[m.status]??9)-(t[v.status]??9),n=(m,v)=>(m.days_until_due??99999)-(v.days_until_due??99999),o=(m,v)=>a(m,v)||n(m,v),c=m=>m.area_id&&this.hass?.areas?.[m.area_id]?.name||"",p=m=>m.responsible_user_id&&this._userService?.getUserName(m.responsible_user_id)||"",u=m=>m.group_names[0]||"",h={due_date:o,object:(m,v)=>m.object_name.localeCompare(v.object_name)||o(m,v),type:(m,v)=>m.type.localeCompare(v.type)||o(m,v),task_name:(m,v)=>m.task_name.localeCompare(v.task_name),area:(m,v)=>{let f=c(m),k=c(v);return!f&&k?1:f&&!k?-1:f.localeCompare(k)||o(m,v)},assigned_user:(m,v)=>{let f=p(m),k=p(v);return!f&&k?1:f&&!k?-1:f.localeCompare(k)||o(m,v)},group:(m,v)=>{let f=u(m),k=u(v);return!f&&k?1:f&&!k?-1:f.localeCompare(k)||o(m,v)}};return e.sort(h[this._sortMode]),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(n=>n.id===t)}_pushPanelState(e,t,a){let n={msp_view:e,msp_entry:t||null,msp_task:a||null};history.pushState(n,"")}_onPopState(e){let t=e.state;if(t?.msp_view&&(this._view=t.msp_view,this._selectedEntryId=t.msp_entry||null,this._selectedTaskId=t.msp_task||null,this._moreMenuOpen=!1,t.msp_view==="task"&&t.msp_entry&&t.msp_task)){this._historyFilter=null;let a=this._getTask(t.msp_entry,t.msp_task);a?.trigger_config?.entity_id&&this._fetchDetailStats(a.trigger_config.entity_id,this._isCounterEntity(a.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop()}_filterByStatus(e){this._filterStatus=e,this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),this._scrollContentToTop()}_scrollContentToTop(){requestAnimationFrame(()=>{let e=this.shadowRoot?.querySelector(".content");e&&e.scrollTo({top:0,behavior:"smooth"})})}_showObject(e){this._pushPanelState("object",e),this._view="object",this._selectedEntryId=e,this._selectedTaskId=null,this._scrollContentToTop()}_showTask(e,t){this._pushPanelState("task",e,t),this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._activeTab="overview",this._historyFilter=null,this._scrollContentToTop();let a=this._getTask(e,t);if(a?.trigger_config?.entity_id){let n=a.trigger_config.entity_id,o=this._isCounterEntity(a.trigger_config);this._fetchDetailStats(n,o)}}_showToast(e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}async _deleteObject(e){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_object",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:e}),this._showOverview(),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _deleteTask(e,t){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_task",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/delete",entry_id:e,task_id:t}),this._showObject(e),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _skipTask(e,t,a){this._actionLoading=!0;try{let n={type:"maintenance_supporter/task/skip",entry_id:e,task_id:t};a&&(n.reason=a),await this.hass.connection.sendMessagePromise(n),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _resetTask(e,t,a){this._actionLoading=!0;try{let n={type:"maintenance_supporter/task/reset",entry_id:e,task_id:t};a&&(n.date=a),await this.hass.connection.sendMessagePromise(n),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _applySuggestion(e,t,a){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/apply_suggestion",entry_id:e,task_id:t,interval:a}),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}_openSeasonalOverrides(e){let t=this.shadowRoot.querySelector("maintenance-seasonal-overrides-dialog");if(!t||!this._selectedEntryId)return;let a=e.adaptive_config?.seasonal_overrides;t.open(this._selectedEntryId,e.id,a)}async _reanalyzeInterval(e,t){try{let a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:e,task_id:t});a.recommended_interval?this._showToast(`${i("reanalyze_result",this._lang)}: ${a.recommended_interval} ${i("days",this._lang)} (${i(`confidence_${a.confidence}`,this._lang)}, ${a.data_points} ${i("data_points",this._lang)})`):this._showToast(i("reanalyze_insufficient_data",this._lang)),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _promptSkipTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let n=await a.prompt({title:i("skip",this._lang),message:i("skip_reason_prompt",this._lang),confirmText:i("skip",this._lang),inputLabel:i("reason_optional",this._lang),inputType:"text"});n.confirmed&&this._skipTask(e,t,n.value||void 0)}async _promptResetTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let n=await a.prompt({title:i("reset",this._lang),message:i("reset_date_prompt",this._lang),confirmText:i("reset",this._lang),inputLabel:i("reset_date_optional",this._lang),inputType:"date"});n.confirmed&&this._resetTask(e,t,n.value||void 0)}_dismissSuggestion(e,t){e&&t&&this._dismissedSuggestions.add(`${e}_${t}`),this.requestUpdate()}async _handleQuickComplete(e,t,a){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/quick_complete",entry_id:e,task_id:t}),this._showToast(i("quick_complete_success",this._lang))}catch(n){(n?.code||"")==="no_defaults"?this._openCompleteDialog(e,t,a.name,this._features.checklists?a.checklist:void 0,this._features.adaptive&&!!a.adaptive_config?.enabled):this._showToast(i("action_error",this._lang))}}_openCompleteDialog(e,t,a,n,o){let c=this.shadowRoot.querySelector("maintenance-complete-dialog");c&&(c.entryId=e,c.taskId=t,c.taskName=a,c.lang=this._lang,c.checklist=n||[],c.adaptiveEnabled=!!o,c.open())}_openQrForObject(e,t){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForObject(e,t)}_openQrForTask(e,t,a,n){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForTask(e,t,a,n)}render(){return r`
    ...
    `}_renderGroupedTasks(e,t){let a=new Map,n=i("unassigned",t);for(let p of e){let u=[];this._groupByMode==="area"?u=[(p.area_id?this.hass?.areas?.[p.area_id]?.name:null)||n]:this._groupByMode==="user"?u=[(p.responsible_user_id?this._userService?.getUserName(p.responsible_user_id):null)||n]:this._groupByMode==="group"&&(u=p.group_names.length>0?p.group_names:[n]);for(let h of u)a.has(h)||a.set(h,[]),a.get(h).push(p)}let o=[...a.entries()].sort(([p],[u])=>p===n&&u!==n?1:u===n&&p!==n?-1:p.localeCompare(u)),c=this._groupByMode==="area"?"mdi:map-marker-outline":this._groupByMode==="group"?"mdi:folder-outline":"mdi:account-outline";return r`
      ${o.map(([p,u])=>r`
        <details class="group-section" open>
          ...
          <div class="task-table">
            ${u.map(h=>this._renderOverviewRow(h))}
          </div>
        </details>
      `)}
    `}_warrantyLabel(e,t,a){return e.kind==="expired"?i("warranty_expired",a):e.kind==="expiring"?i("warranty_expires_in",a).replace("{days}",String(e.days??0)):i("warranty_valid_until",a).replace("{date}",Z(t,a))}_renderWarrantyMeta(e,t){let a=rt(e);return r`<p class="meta">${i("warranty",t)}:
      <span class="warranty-chip warranty-${a.kind}">${this._warrantyLabel(a,e,t)}</span></p>`}_renderAllObjects(){let e=this._lang,t=this._isOperator,a=this._objectViewMode==="table"&&!this.narrow,n=u=>{let h=1/0;for(let m of u.tasks){let v=m.days_until_due;v!=null&&v<h&&(h=v)}return h},o=[...this._objects];this._objectSortMode==="alphabetical"?o.sort((u,h)=>u.object.name.localeCompare(h.object.name)):this._objectSortMode==="task_count"?o.sort((u,h)=>h.tasks.length-u.tasks.length||u.object.name.localeCompare(h.object.name)):o.sort((u,h)=>n(u)-n(h)||u.object.name.localeCompare(h.object.name));let c=()=>{let u=new Map;for(let h of o){let m=h.object.area_id,v=m?this.hass?.areas?.[m]?.name||i("unassigned",e):i("no_area",e);u.has(v)||u.set(v,[]),u.get(v).push(h)}return new Map([...u.entries()].sort(([h],[m])=>h.localeCompare(m)))},p=u=>{let h=u.tasks.some(m=>m.status==="overdue"||m.status==="triggered");return r`
        <div class="object-card${h?" object-card-overdue":""}" @click=${()=>this._showObject(u.entry_id)}>
          ${h?r`<span class="overdue-dot" title="${i("has_overdue",e)}"></span>`:d}
          <div class="object-card-header">
            <span class="object-card-name">${u.object.name}</span>
            <span class="object-card-count">${u.tasks.length} ${i("tasks_lower",e)}</span>
          </div>
          ...
          ${u.tasks.length===0?r`<div class="object-card-empty">${i("no_tasks_yet",e)}</div>`:d}
        </div>
      `};return r`
      ...
      <div class="filter-bar">
        <label class="filter-field">
          ...
          <select
            ...
            @change=${u=>{this._objectSortMode=u.target.value,localStorage.setItem("maintenance_supporter_object_sort",this._objectSortMode)}}
          >
        ...
        <label class="filter-field">
          ...
          <select
            .value=${this._groupByMode}
            @change=${u=>{this._groupByMode=u.target.value,localStorage.setItem("maintenance_supporter_groupby",this._groupByMode)}}
          >
        ...
        <ha-button appearance="plain" @click=${()=>this._exportObjectsCsv()}>
          <ha-icon icon="mdi:file-delimited-outline"></ha-icon> ${i("settings_export_csv",e)}
        </ha-button>
      </div>
      ${a?this._renderObjectsTable(o):this._groupByMode==="area"?r`
          ${[...c().entries()].map(([u,h])=>r`
            <details class="group-section" open>
              ...
              <div class="objects-grid">${h.map(p)}</div>
            </details>
          `)}
        `:r`<div class="objects-grid">${o.map(p)}</div>`}
    `}_setObjectViewMode(e){this._objectViewMode=e,localStorage.setItem("maintenance_supporter_object_view",e)}async _exportObjectsCsv(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects/csv"}),t=new Date().toISOString().slice(0,10);Pe(e.csv,`maintenance_objects_${t}.csv`,"text/csv;charset=utf-8")}catch{this._showToast(i("action_error",this._lang))}}_renderObjectsTable(e){let t=this._lang,a=this._objectsTableColumns;return r`
      <div class="objects-table-wrap">
        <table class="objects-table">
          <thead>
            <tr>
              ${a.map(n=>{let o=ue.find(p=>p.key===n),c=o&&o.key!=="actions"?i(o.labelKey,t):"";return r`<th class="oc-${n}">${c}</th>`})}
            </tr>
          </thead>
          <tbody>
            ${e.map(n=>r`
              <tr class="objects-table-row" @click=${()=>this._showObject(n.entry_id)}>
                ${a.map(o=>this._renderObjectCell(o,n,t))}
              </tr>
            `)}
          </tbody>
        </table>
      </div>
    `}_renderObjectCell(e,t,a){let n=t.object;switch(e){case"name":return r`<td class="oc-name"><span class="objects-table-name">${n.name}</span></td>`;case"manufacturer":return r`<td class="oc-manufacturer">${n.manufacturer||"\u2014"}</td>`;case"model":return r`<td class="oc-model">${n.model||"\u2014"}</td>`;case"serial_number":return r`<td class="oc-serial_number">${n.serial_number||"\u2014"}</td>`;case"installation_date":return r`<td class="oc-installation_date">${n.installation_date?Z(n.installation_date,a):"\u2014"}</td>`;case"warranty_expiry":return r`<td class="oc-warranty_expiry">${this._renderWarrantyCell(n.warranty_expiry,a)}</td>`;case"area_id":{let o=n.area_id?this.hass?.areas?.[n.area_id]?.name||n.area_id:"\u2014";return r`<td class="oc-area_id">${o}</td>`}case"documentation_url":return r`<td class="oc-documentation_url">${n.documentation_url&&/^https?:\/\//i.test(n.documentation_url)?r`<a href=${n.documentation_url} target="_blank" rel="noopener noreferrer"
                @click=${o=>o.stopPropagation()}><ha-icon icon="mdi:file-document-outline"></ha-icon></a>`:"\u2014"}</td>`;case"notes":return r`<td class="oc-notes" title=${n.notes||""}>${n.notes||"\u2014"}</td>`;case"task_count":return r`<td class="oc-task_count">${t.tasks.length}</td>`;case"actions":return r`<td class="oc-actions">
          <mwc-icon-button title="${i("qr_code",a)}" @click=${o=>{o.stopPropagation(),this._openQrForObject(t.entry_id,n.name)}}>
            <ha-icon icon="mdi:qrcode"></ha-icon>
          </mwc-icon-button>
        </td>`;default:return r`<td></td>`}}_renderWarrantyCell(e,t){let a=rt(e);return a.kind==="none"?r`<span class="warranty-none">—</span>`:r`<span class="warranty-chip warranty-${a.kind}">${this._warrantyLabel(a,e,t)}</span>`}async _onSettingsChanged(){await this._loadData()}_renderGroupsSection(){if(!this._features.groups)return d;let e=Object.entries(this._groups),t=this._lang;return r`
    ...
    `}_openGroupCreate(){this.shadowRoot.querySelector("maintenance-group-dialog")?.openCreate()}_openGroupEdit(e){let t=this._groups[e];t&&this.shadowRoot.querySelector("maintenance-group-dialog")?.openEdit(e,t)}async _deleteGroup(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(a?await a.confirm({title:i("delete_group",this._lang),message:i("delete_group_confirm",this._lang).replace("{name}",t),confirmText:i("delete",this._lang)}):confirm(`${i("delete_group_confirm",this._lang).replace("{name}",t)}`))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/group/delete",group_id:e}),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}_renderBudgetBar(){let e=this._budget;if(!e)return d;let t=this._lang,a=e.currency_symbol||"\u20AC",n=[];return e.monthly_budget>0&&n.push({label:i("budget_monthly",t),spent:e.monthly_spent,budget:e.monthly_budget}),e.yearly_budget>0&&n.push({label:i("budget_yearly",t),spent:e.yearly_spent,budget:e.yearly_budget}),n.length===0?d:r`
      <div class="budget-bars">
        ${n.map(o=>{let c=Math.min(100,Math.max(0,o.spent/o.budget*100)),p=c>=100?"var(--error-color, #f44336)":c>=e.alert_threshold_pct?"var(--warning-color, #ff9800)":"var(--success-color, #4caf50)";return r`
            <div class="budget-item">
              ...
              <div class="budget-bar">
                <div class="budget-bar-fill" style="width:${c}%; background:${p}"></div>
              </div>
            </div>
          `})}
      </div>
    `}_renderOverviewRow(e){let t=this._lang,a=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,n=0,o=Ne.ok,c=!1;if(a&&e.days_until_due!==null){let m=ot(e.interval_days,e.days_until_due,e.interval_unit);n=m.pct,c=m.overflow,e.status==="overdue"?o=Ne.overdue:e.status==="due_soon"&&(o=Ne.due_soon)}let p=e.area_id?this.hass?.areas?.[e.area_id]?.name:null,u=e.responsible_user_id?this._userService?.getUserName(e.responsible_user_id):null,h=e.group_names.length>0||p||u;return r`
      <div class="task-row${e.enabled?"":" task-disabled"}">
        <span class="cell-badges">
          <span class="status-badge ${e.is_done?"done":e.status}">${e.is_done?i("completed",t):i(e.status,t)}</span>
        ...
        <span class="row-actions">
          <mwc-icon-button class="btn-complete" title="${i("complete",t)}" @click=${m=>{m.stopPropagation(),this._openCompleteDialogForRow(e)}}>
            <ha-icon icon="mdi:check"></ha-icon>
          </mwc-icon-button>
          <mwc-icon-button class="btn-skip" title="${i("skip",t)}" .disabled=${this._actionLoading} @click=${m=>{m.stopPropagation(),this._promptSkipTask(e.entry_id,e.task_id)}}>
            <ha-icon icon="mdi:skip-next"></ha-icon>
          </mwc-icon-button>
        </span>
      </div>
    `}_openCompleteDialogForRow(e){let a=this._objects.find(n=>n.entry_id===e.entry_id)?.tasks.find(n=>n.id===e.task_id);this._openCompleteDialog(e.entry_id,e.task_id,e.task_name,this._features.checklists?a?.checklist:void 0,this._features.adaptive&&!!a?.adaptive_config?.enabled)}_renderTriggerProgress(e){let t=e.trigger_config??null;if(!t)return d;let a=t.type||"threshold",n=e.trigger_entity_info?.unit_of_measurement??"",o=0,c="";if(a==="threshold"){let h=e.trigger_current_value??null;if(h==null)return d;let m=t.trigger_above,v=t.trigger_below;if(m!=null){let f=v??0,k=m-f||1;o=Math.min(100,Math.max(0,(h-f)/k*100)),c=`${h.toFixed(1)} / ${m} ${n}`}else if(v!=null){let k=e.trigger_entity_info?.max??(v*2||100),b=k-v||1;o=Math.min(100,Math.max(0,(k-h)/b*100)),c=`${h.toFixed(1)} / ${v} ${n}`}else return d}else if(a==="counter"){let h=t.trigger_target_value||1,v=e.trigger_current_delta??null??e.trigger_current_value??null;if(v==null)return d;o=Math.min(100,Math.max(0,v/h*100)),c=`${v.toFixed(1)} / ${h} ${n}`}else if(a==="state_change"){let h=t.trigger_target_changes||1,m=e.trigger_current_value??null;if(m==null)return d;o=Math.min(100,Math.max(0,m/h*100)),c=`${Math.round(m)} / ${h}`}else if(a==="runtime"){let h=t.trigger_runtime_hours||100,m=e.trigger_current_value??null;if(m==null)return d;o=Math.min(100,Math.max(0,m/h*100)),c=`${m.toFixed(1)}h / ${h}h`}else if(a==="compound"){let h=t.compound_logic||t.operator||"AND",m=t.conditions?.length||0;c=`${h} (${m})`,o=e.trigger_active?100:0}else return d;let p=o>=100,u=o>90?"var(--error-color, #f44336)":o>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return r`
      <div class="trigger-progress">
        <div class="trigger-progress-bar">
          <div class="trigger-progress-fill${p?" overflow":""}" style="width:${o}%;background:${u}"></div>
        </div>
        <span class="trigger-progress-label">${c}</span>
      </div>
    `}_renderMiniSparkline(e){if(!e.trigger_config?.entity_id)return d;let t=e.trigger_config.entity_id,a=this._miniStatsData.get(t)||[],n=[];if(a.length>=2)n=a.map($=>({ts:$.ts,val:$.val}));else{if(!e.history)return d;for(let $ of e.history)$.trigger_value!=null&&n.push({ts:new Date($.timestamp).getTime(),val:$.trigger_value})}if(e.trigger_current_value!=null&&n.push({ts:Date.now(),val:e.trigger_current_value}),n.length<2)return d;n.sort(($,M)=>$.ts-M.ts);let o=fi,c=bi,p=n.map($=>$.val),u=Math.min(...p),h=Math.max(...p),m=h-u||1;u-=m*.1,h+=m*.1;let v=n[0].ts,k=n[n.length-1].ts-v||1,b=$=>($-v)/k*o,N=$=>2+(1-($-u)/(h-u))*(c-4),C=n;if(C.length>ea){let $=Math.ceil(C.length/ea);C=C.filter((M,L)=>L%$===0||L===C.length-1)}let E=C.map($=>`${b($.ts).toFixed(1)},${N($.val).toFixed(1)}`).join(" ");return r`
    ...
    `}_renderDaysProgress(e){let t=this._lang;if(e.days_until_due==null||!e.interval_days||e.interval_days<=0)return d;let{pct:a,overflow:n}=ot(e.interval_days,e.days_until_due,e.interval_unit),o="var(--success-color, #4caf50)";return e.status==="overdue"?o="var(--error-color, #f44336)":e.status==="due_soon"&&(o="var(--warning-color, #ff9800)"),r`
      <div class="days-progress">
        <div class="days-progress-labels">
          <span>${e.last_performed?`${i("last_performed",t)}: ${Z(e.last_performed,t)}`:""}</span>
          <span>${e.next_due?`${i("next_due",t)}: ${Z(e.next_due,t)}`:""}</span>
        </div>
        <div class="days-progress-bar" role="progressbar" aria-valuenow="${Math.round(a)}" aria-valuemin="0" aria-valuemax="100" aria-label="${i("days_progress",t)}">
          <div class="days-progress-fill${n?" overflow":""}" style="width:${a}%;background:${o}"></div>
        </div>
    ...
    `}_renderObjectDetail(){if(!this._selectedEntryId)return d;let e=this._getObject(this._selectedEntryId);if(!e)return r`<p>Object not found.</p>`;let t=e.object,a=this._lang,n=this._isOperator;return r`
      <div class="detail-section">
        ...
        ${t.installation_date?r`<p class="meta">${i("installed",a)}: ${Z(t.installation_date,a)}</p>`:d}
        ...
        ${e.tasks.length===0?r`<div class="empty-state-centered">
            ...
            </div>`:r`<div class="task-table">${[...e.tasks].sort((o,c)=>{let p={overdue:0,triggered:1,due_soon:2,ok:3};return(p[o.status]??9)-(p[c.status]??9)||(o.days_until_due??99999)-(c.days_until_due??99999)}).map(o=>r`
    ...
    `}_renderTaskHeader(e){let t=this._lang,n=this._getObject(this._selectedEntryId)?.object.name||"",o=this._isOperator,c=e.is_done?"done":e.status==="due_soon"?"warning":e.status||"ok",p=e.is_done?i("completed",t):i(e.status||"ok",t);return r`
      <div class="task-header">
        <div class="task-header-title">
          ...
          <span class="status-chip ${c}">${p}</span>
        ...
        <div class="task-header-actions">
          ...
          <ha-button appearance="plain" @click=${()=>{let u=this._getObject(this._selectedEntryId)?.object;this._openQrForTask(this._selectedEntryId,this._selectedTaskId,u?.name||"",e.name)}}><ha-icon icon="mdi:qrcode"></ha-icon> ${i("qr_code",t)}</ha-button>
          ${o?d:r`
      ...
      <div class="tab-content overview-tab">
        ...
        <div class="two-column-layout ${o?"":"single-column"}">
          ...
          <div class="right-column">
            ${Xt(e,t,this._costDurationToggle,u=>{this._costDurationToggle=u})}
          </div>
        </div>
        ${c?Kt(e,t):d}
        ${p?r`
    ...
    `}_renderKPIBar(e){let t=this._lang,a=e.times_performed>0?e.total_cost/e.times_performed:0,n=e.days_until_due!==null&&e.days_until_due!==void 0?e.days_until_due<0?"overdue":e.days_until_due<=e.warning_days?"warning":"":"";return r`
      <div class="kpi-bar">
        ...
        <div class="kpi-card">
          ...
          <div class="kpi-value">${Mt(e,t)}</div>
    ...
    `}_renderRecommendationCard(e){let t=this._lang;if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return d;if(this._selectedEntryId&&this._selectedTaskId&&this._dismissedSuggestions.has(`${this._selectedEntryId}_${this._selectedTaskId}`))return d;let a=e.suggested_interval;return r`
      <div class="recommendation-card">
        ...
        ${Qt(e.interval_days,a,e.interval_confidence||"medium",t)}
    ...
    `}_renderHistoryEntry(e){let t=this._lang,a=["completed","reset","skipped"].includes(e.type);return r`
      <div class="history-entry">
        <div class="history-icon ${e.type}">
          <ha-icon .icon=${qt[e.type]||"mdi:circle"}></ha-icon>
        </div>
        <div class="history-content">
          <div class="history-row">
            <strong>${i(e.type,t)}</strong>
            ${a?r`<button class="history-edit-btn"
                       title=${i("history_edit_button",t)||"Edit entry"}
