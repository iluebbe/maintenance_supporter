/*! maintenance_supporter frontend 2.90.0 */
import{a as Ne,b as Fe,c as qe}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-ENPF2LDM.js";import{A as ci,B as di,C as pi,D as hi,E as ui,L as mi,O as _i,a as at,b as Wt,c as Ct,d as yt,e as xt,f as Gt,g as Dt,h as te,i as Ue,j as We,k as ee,l as Ye,m as Ke,n as E,o as Nt,p as bt,q as Et,r as It,s as be,t as ie,u as se,v as ai,w as oi,x as ri,y as ni,z as li}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-ZMV2VB57.js";import{a as Be,b as Jt,c as wt,d as Xt,e as Bt,f as Zt,g as Ft,h as ii,i as si,k as gi}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-C7OGYVZI.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-2IGVBRZV.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-ZJPHP3YU.js";import{a as ve}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-QOKIQTSS.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-EH52ZZY4.js";import{a as D,b as Z,c as G,d as Xe,e as Ze,f as ti,g as ei}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-PDDZINC4.js";import{b as Ve,h as Ge}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-5XRT3AM7.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-2PKU3QXM.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-FLCA3VKG.js";import{a as me}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-XB4BHMUS.js";import{c as Qe,d as _e,e as Je}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-73EHFI76.js";import{a as A}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-WQXORDNI.js";import{A as Q,B as Pe,C as jt,E as Lt,H as ze,I as Le,K as St,L as Ht,M as He,O as Qt,a as g,b as L,c as r,d as J,f as h,h as H,i as ge,j as Ce,k as De,l as S,m,n as Yt,o as Ae,p as Kt,q as s,r as At,s as U,t as Ie,u as ot,v as zt,x as it,y as K}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-RAW6RFRE.js";var Ui=["assignee_pool","required_completion_fields","checklist","labels","mirror_todo_entities","history","readings"],Wi=["checklist_progress"],Gi=["tasks","parts"],Yi=["manual_docs","battery_fleet_excluded"];function fe(l,c,t=[]){for(let e of c)l[e]===void 0&&(l[e]=[]);for(let e of t)l[e]===void 0&&(l[e]={})}function Ki(l){let c=l;fe(c,Gi),c.object&&typeof c.object=="object"&&fe(c.object,Yi);for(let t of c.tasks)fe(t,Ui,Wi);return l}function qt(l){for(let c of l)Ki(c);return l}function Qi(l,c){if(c.objects)return c.objects;let t=c.delta||[],e=c.removed||[];if(!t.length&&!e.length)return null;let i=new Map(l.map(a=>[a.entry_id,a]));for(let a of t)i.set(a.entry_id,a);for(let a of e)i.delete(a);return[...i.values()]}function bi(l,c){return c.objects&&qt(c.objects),c.delta&&qt(c.delta),Qi(l,c)}var ye=["today","dashboard","calendar","settings"];var Ji=168*3600*1e3;function vi(){try{let l=Z(D.objectsCache);if(!l)return null;let c=JSON.parse(l);return c.v!==ge||!Number.isFinite(c.at)||Date.now()-c.at>Ji||!Array.isArray(c.objects)||c.objects.length===0?null:{objects:c.objects,stats:c.stats??null}}catch{return null}}function xe(l,c){if(!(!Array.isArray(l)||l.length===0))try{let t={v:ge,at:Date.now(),objects:l,stats:c};G(D.objectsCache,JSON.stringify(t))}catch{}}function B(l){return String(l??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}function fi(l,c,t,e,i,a){let n=[[t.manufacturer,l.manufacturer],[t.model,l.model],[t.serial,l.serial_number],[t.installed,l.installation_date?e(l.installation_date):null],[t.warranty,l.warranty_expiry?e(l.warranty_expiry):null]].filter(([,p])=>!!p),d=c.map(p=>{let u=t.scheduleLabel(p);return`<tr>
      <td>${B(p.name)}</td>
      <td>${B(t.typeLabel(p.type))}</td>
      <td>${B(t.statusLabel(p.status))}</td>
      <td>${B(u)}</td>
      <td>${B(p.last_performed?e(p.last_performed):t.none)}</td>
      <td>${B(p.next_due?e(p.next_due):t.none)}</td>
      <td class="num">${p.times_performed??0}</td>
      <td class="num">${B(i(p.total_cost??0))}</td>
    </tr>`}).join(""),o=c.reduce((p,u)=>p+(u.total_cost??0),0);return`<!DOCTYPE html><html><head><meta charset="utf-8">
<meta name="color-scheme" content="light">
<title>${B(t.title)} \u2014 ${B(l.name)}</title>
<style>
  ...
  * { box-sizing: border-box; }
  ...
  <h1>${B(l.name)}</h1>
  <p class="sub">${B(t.title)} \xB7 ${B(t.generated)}: ${B(e(a))}</p>
  ${n.length?`<div class="meta">${n.map(([p,u])=>`<div><div class="k">${B(p)}</div>${B(u)}</div>`).join("")}</div>`:""}
  <h2>${B(t.tasksHeading)} (${c.length})</h2>
  <table>
    <thead><tr>
      <th>${B(t.colTask)}</th><th>${B(t.colType)}</th><th>${B(t.colStatus)}</th>
      <th>${B(t.colSchedule)}</th><th>${B(t.colLastDone)}</th><th>${B(t.colNextDue)}</th>
      <th class="num">${B(t.colTimes)}</th><th class="num">${B(t.colCost)}</th>
    </tr></thead>
    <tbody>${d||`<tr><td colspan="8">${B(t.none)}</td></tr>`}</tbody>
    <tfoot><tr><td colspan="7">${B(t.totalCost)}</td><td class="num">${B(i(o))}</td></tr></tfoot>
  </table>
  ${l.notes?`<div class="notes"><strong>${B(t.notes)}:</strong>
${B(l.notes)}</div>`:""}
</body></html>`}function we(l,c=new Date){if(!l)return{kind:"none",days:null,date:null};let t=new Date(`${l}T00:00:00`);if(isNaN(t.getTime()))return{kind:"none",days:null,date:null};let e=Date.UTC(c.getFullYear(),c.getMonth(),c.getDate()),i=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),a=Math.round((i-e)/864e5);return a<0?{kind:"expired",days:a,date:l}:a<=60?{kind:"expiring",days:a,date:l}:{kind:"valid",days:a,date:l}}var q=l=>String(l??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c]);function yi(l,c,t,e,i,a,n,d,o,p=[],u=null){let b=[[t.object,q(c)],[t.type,q(t.typeLabel(l.type))],[t.interval,q(i(l))],[t.nextDue,l.next_due?q(e(l.next_due)):"\u2014"],[t.lastDone,l.last_performed?q(e(l.last_performed)):q(t.never)]];l.priority&&l.priority!=="normal"&&b.push([t.priority,q(l.priority)]);let _=(l.checklist||[]).map(f=>`<li><span class="box"></span>${q(f)}</li>`).join(""),v=(f,R)=>f?`<figure class="qr"><img src="${f}" alt="" /><figcaption>${q(R)}</figcaption></figure>`:"";return`<!DOCTYPE html>
...
<body>
  ...
  <table class="meta">
    ${b.map(([f,R])=>`<tr><td>${q(f)}</td><td>${R}</td></tr>`).join("")}
  </table>
  ${_?`<h2>${q(t.checklist)}</h2><ul class="check">${_}</ul>`:""}
  ${p.length?`<h2>${q(t.parts)}</h2><ul class="check">${p.map(f=>`<li><span class="box"></span>${q(f)}</li>`).join("")}</ul>`:""}
  ...
  ${d?`<h2>${q(t.manualExcerpt)}</h2>
    ...
    <\/script>`:""}`:""}
  <footer>${q(c)} \xB7 ${q(l.name)} \xB7 ${q(t.printedOn)} ${q(o.slice(0,10))}</footer>
</body></html>`}var xi=L`
...
`;var ae=class{constructor(c){this._cache=new Map;this._pending=new Map;this.historyFallbackIds=new Set;this._hass=c}updateHass(c){this._hass=c}async getDetailStats(c,t,e=30){return this._getStats(c,e<=35?"hour":"day",e,t)}async getMiniStats(c,t){return this._getStats(c,"day",14,t)}async getBatchMiniStats(c){let t=new Map,e=[];for(let o of c){let p=`${o.entityId}:day:14`,u=this._cache.get(p);u&&Date.now()-u.fetchedAt<3e5?t.set(o.entityId,u.points):e.push(o)}if(e.length===0)return t;let i=e.filter(o=>o.isCounter).map(o=>o.entityId),a=e.filter(o=>!o.isCounter).map(o=>o.entityId),n=new Date(Date.now()-336*60*60*1e3).toISOString(),d=[];return i.length>0&&d.push(this._fetchBatch(i,"day",n,["state","sum","change"],!0,t)),a.length>0&&d.push(this._fetchBatch(a,"day",n,["mean","min","max"],!1,t)),await Promise.all(d),t}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(c,t,e,i){let a=`${c}:${t}:${e}`,n=this._cache.get(a);if(n&&Date.now()-n.fetchedAt<3e5)return n.points;if(this._pending.has(a))return this._pending.get(a);let d=this._fetchAndNormalize(c,t,e,i,a);this._pending.set(a,d);try{return await d}finally{this._pending.delete(a)}}async _fetchAndNormalize(c,t,e,i,a){let n=new Date(Date.now()-e*24*60*60*1e3).toISOString(),d=i?["state","sum","change"]:["mean","min","max"];try{let p=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:n,statistic_ids:[c],period:t,types:d}))[c]||[],u=this._normalizeRows(p,i);if(u.length<2){let b=await this._fetchHistoryFallback(c,n);b.length>=2?(u=b,this.historyFallbackIds.add(c)):this.historyFallbackIds.delete(c)}else this.historyFallbackIds.delete(c);return this._cache.set(a,{entityId:c,fetchedAt:Date.now(),period:t,points:u}),u}catch(o){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${c}:`,o),[]}}async _fetchHistoryFallback(c,t){try{let i=(await this._hass.connection.sendMessagePromise({type:"history/history_during_period",start_time:t,end_time:new Date().toISOString(),entity_ids:[c],minimal_response:!0,no_attributes:!0}))?.[c]||[];if(i.length>1e3){let d=Math.ceil(i.length/500);i=i.filter((o,p)=>p%d===0||p===i.length-1)}let a=[],n=null;for(let d of i){let o=d.s??d.state;if(o==null||o==="unknown"||o==="unavailable")continue;let p;if(o==="on"||o==="open"||o==="true")p=1;else if(o==="off"||o==="closed"||o==="false")p=0;else if(p=parseFloat(o),!Number.isFinite(p))continue;let u=d.lu??d.last_updated??d.last_changed,b=typeof u=="number"?u*1e3:u!=null?Date.parse(u):NaN;Number.isFinite(b)&&(n!=null&&n!==p&&a.push({ts:b,val:n}),a.push({ts:b,val:p}),n=p)}return a.sort((d,o)=>d.ts-o.ts),a.length&&n!=null&&a.push({ts:Date.now(),val:n}),a}catch(e){return console.warn(`[maintenance-supporter] History fallback failed for ${c}:`,e),[]}}async _fetchBatch(c,t,e,i,a,n){try{let d=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:e,statistic_ids:c,period:t,types:i});for(let o of c){let p=d[o]||[],u=this._normalizeRows(p,a);n.set(o,u),this._cache.set(`${o}:${t}:14`,{entityId:o,fetchedAt:Date.now(),period:t,points:u})}}catch(d){console.warn("[maintenance-supporter] Batch statistics fetch failed:",d)}}_normalizeRows(c,t){let e=[];for(let i of c){let a=null;if(t?a=i.state??null:a=i.mean??null,a===null)continue;let n={ts:i.start,val:a};t||(i.min!=null&&(n.min=i.min),i.max!=null&&(n.max=i.max)),e.push(n)}return e.sort((i,a)=>i.ts-a.ts),e}};function vt(l,c){let t=l??0;return t<1024?`${t} B`:t<1024*1024?`${it(t/1024,c,1)} KB`:`${it(t/(1024*1024),c,1)} MB`}var Rt=["manual","warranty","invoice","spare_parts","photo","other"],oe={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"};function Tt(l){return l.title||l.filename||l.url||""}var re=8,$e=["newest","oldest","title","category"];function je(l){return $e.includes(l??"")?l:"newest"}var ke=["manual","warranty","invoice","spare_parts","photo","other"];function wi(l,c){let t=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"}),e=d=>(d.title||d.filename||d.url||"").trim(),i=(d,o)=>t.compare(e(d),e(o)),a=d=>{if(d.kind==="weblink")return ke.length+1;let o=(d.tags||[]).find(p=>ke.includes(p))||"other";return ke.indexOf(o)},n=[...l];switch(c){case"oldest":return n.sort((d,o)=>(d.added_at||"").localeCompare(o.added_at||""));case"title":return n.sort(i);case"category":return n.sort((d,o)=>a(d)-a(o)||i(d,o));default:return n.sort((d,o)=>(o.added_at||"").localeCompare(d.added_at||""))}}function ne(l,c){let t=Wt(c);if(!t.length)return l;let e=[];for(let i of l){let a=Ct(t,[{text:i.title,weight:3},{text:i.filename,weight:2},{text:(i.tags||[]).join(" "),weight:2},{text:i.description,weight:2},{text:i.url,weight:1}]);a>0&&e.push({doc:i,score:a})}return e.sort((i,a)=>a.score-i.score).map(i=>i.doc)}var V=class extends H{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._filter="";this._loaded=!1;this._busy=!1;this._error="";this._hint="";this._addingLink=!1;this._linkUrl="";this._linkTitle="";this._category="manual";this._thumbs={};this._lightboxUrl="";this._editingId="";this._editTitle="";this._editCategory="manual";this._editDescription="";this._linkDescription="";this._sort=je(Z(D.docSort));this._dragOver=!1;this._loadedFor=null;this._localeReady=!1;this._singlePick=Xe()}_isImage(t){return t.kind==="file"&&(t.mime||"").startsWith("image/")}async _sign(t){return Jt(this.hass,t.id)}get _lang(){return U(this.hass)}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,ot(this._lang).then(()=>this.requestUpdate())),this.hass&&this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error="",this._thumbs={},this._loadThumbs()}catch(t){this._error=A(t,this._lang),this._loaded=!0}}async _loadThumbs(){await Promise.all(this._docs.filter(t=>this._isImage(t)).map(async t=>{try{let e=await this._sign(t);this._thumbs={...this._thumbs,[t.id]:e}}catch{}}))}_category_of(t){return(t.tags||[]).find(i=>Rt.includes(i))||"other"}_labelKeydown(t){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),t.currentTarget.querySelector("input")?.click())}_onFileInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i),e.value=""}_onDrop(t){if(t.preventDefault(),this._dragOver=!1,!this.canWrite||this._busy)return;let e=Array.from(t.dataTransfer?.files??[]);e.length&&this._uploadFiles(e)}_onDragOver(t){this.canWrite&&(t.preventDefault(),this._dragOver=!0)}_onDragLeave(t){let e=t.relatedTarget;(!e||!t.currentTarget.contains(e))&&(this._dragOver=!1)}async _uploadFiles(t,e){let i=e??this._category;this._busy=!0,this._error="",this._hint="";let a=0,n=0;try{for(let d of t){let o;try{o=await ti(this.hass,this.entryId,d,[i])}catch(p){let u=p instanceof Error?p.message:"";if(u!=="doc_too_large"&&u!=="doc_upload_failed")throw p;this._error=s(u,this._lang);continue}o.duplicate_in_object?n++:o.deduped&&a++}n?this._hint=s("doc_dup_in_object",this._lang):a&&(this._hint=s("doc_deduped",this._lang)),await this._load()}catch{this._error=s("doc_upload_failed",this._lang)}finally{this._busy=!1}}async _download(t){try{await Xt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=A(e,this._lang)}}async _preview(t){if(this._isImage(t)){this._lightboxUrl=this._thumbs[t.id]||await this._sign(t);return}try{await wt(this.hass,t.id)}catch(e){this._error=A(e,this._lang)}}_openDoc(t){t.kind==="file"?this._preview(t):at(t.url)&&window.open(t.url,"_blank","noopener")}_startEdit(t){this._editingId=t.id,this._editTitle=t.title||"",this._editCategory=this._category_of(t),this._editDescription=t.description||"",this._addingLink=!1,this._error=""}_cancelEdit(){this._editingId=""}_setSort(t){this._sort=je(t),G(D.docSort,this._sort)}async _saveEdit(t){let e=(t.tags||[]).filter(a=>!Rt.includes(a)),i=t.kind==="file"?[this._editCategory,...e]:t.tags??[];this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,title:this._editTitle.trim()||t.filename||t.url||"",tags:i,description:this._editDescription.trim()}),this._editingId="",await this._load()}catch(a){this._error=A(a,this._lang)}finally{this._busy=!1}}async _delete(t){let e=Tt(t);if(window.confirm(s("doc_delete_confirm",this._lang).replace("{name}",e))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:t.id}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}}async _addLink(){let t=this._linkUrl.trim();if(t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/add_link",entry_id:this.entryId,url:t,title:this._linkTitle.trim()||null,description:this._linkDescription.trim()||null}),this._linkUrl="",this._linkTitle="",this._linkDescription="",this._addingLink=!1,await this._load()}catch(e){this._error=A(e,this._lang,s("doc_link_invalid",this._lang))}finally{this._busy=!1}}}render(){let t=this._lang;return r`
      <div
      ...
      <div class="doc-header">
        ...
        ${this.canWrite?r`
              <div class="doc-actions">
                ...
                >
                  ${Rt.map(e=>r`<option value=${e}>${s(`doc_cat_${e}`,t)}</option>`)}
                </select>
                <label
      ...
      ${this._loaded&&this._docs.length>=2?r`<div class="doc-tools">
            ...
            <select class="sort-select" aria-label=${s("doc_sort",t)} .value=${this._sort}
              ...
              ${$e.map(e=>r`<option value=${e} ?selected=${e===this._sort}>${s(`doc_sort_${e}`,t)}</option>`)}
            </select>
          </div>`:h}
      ${this._loaded&&this._docs.length>=re?r`<div class="doc-filter">
      ...
      ${this._loaded?this._docs.length===0?r`<div class="doc-empty">${s("documents_empty",t)}</div>`:(()=>{let e=this._filter.trim()?ne(this._docs,this._filter):wi(this._docs,this._sort);return e.length===0?r`<div class="doc-empty">${s("doc_search_none",t)}</div>`:r`<div class="doc-list">${e.map(i=>this._renderDoc(i,t))}</div>`})():r`<div class="doc-empty">${s("loading",t)}</div>`}
    ...
    `}_renderDoc(t,e){if(this._editingId===t.id)return this._renderEdit(t,e);let i=t.kind==="file",a=this._category_of(t),n=i?`${s(`doc_cat_${a}`,e)} \xB7 ${vt(t.size,e)}`:s("doc_link_badge",e),d=this._thumbs[t.id];return r`
      <div class="doc-row">
        ${i&&d?r`<img
              class="doc-thumb"
              src=${d}
    ...
    `}_renderEdit(t,e){let i=t.kind==="file";return r`
      <div class="doc-row editing">
        ...
        ${i?r`<select
            ...
            >
              ${Rt.map(a=>r`<option value=${a} ?selected=${a===this._editCategory}>${s(`doc_cat_${a}`,e)}</option>`)}
            </select>`:h}
        <input
          class="edit-desc"
          type="text"
  ...
  `],g([S({attribute:!1})],V.prototype,"hass",2),g([S({attribute:!1})],V.prototype,"entryId",2),g([S({type:Boolean})],V.prototype,"canWrite",2),g([m()],V.prototype,"_docs",2),g([m()],V.prototype,"_filter",2),g([m()],V.prototype,"_loaded",2),g([m()],V.prototype,"_busy",2),g([m()],V.prototype,"_error",2),g([m()],V.prototype,"_hint",2),g([m()],V.prototype,"_addingLink",2),g([m()],V.prototype,"_linkUrl",2),g([m()],V.prototype,"_linkTitle",2),g([m()],V.prototype,"_category",2),g([m()],V.prototype,"_thumbs",2),g([m()],V.prototype,"_lightboxUrl",2),g([m()],V.prototype,"_editingId",2),g([m()],V.prototype,"_editTitle",2),g([m()],V.prototype,"_editCategory",2),g([m()],V.prototype,"_editDescription",2),g([m()],V.prototype,"_linkDescription",2),g([m()],V.prototype,"_sort",2),g([m()],V.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",V);var nt=class extends H{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._filter="";this._loadedKey="";this._localeReady=!1}get _lang(){return U(this.hass)}get _refId(){return this.partId||this.taskId||""}get _linkField(){return this.partId?"part_ids":"task_ids"}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,ot(this._lang).then(()=>this.requestUpdate()));let e=`${this.entryId}|${this._refId}`;this.hass&&this.entryId&&this._refId&&this._loadedKey!==e&&(this._loadedKey=e,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error=""}catch(t){this._error=A(t,this._lang),this._loaded=!0}}_links(t){return t[this._linkField]||[]}_linked(){return this._docs.filter(t=>this._links(t).includes(this._refId))}_available(){return this._docs.filter(t=>!this._links(t).includes(this._refId))}async _setLinks(t,e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,[this._linkField]:e}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}_link(){let t=this._docs.find(e=>e.id===this._attachId);t&&(this._attachId="",this._setLinks(t,[...this._links(t),this._refId]))}_unlink(t){this._setLinks(t,this._links(t).filter(e=>e!==this._refId))}_isPdf(t){return t.mime==="application/pdf"||(t.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(t){return this._isPdf(t)&&this.taskId?t.task_pages?.[this.taskId]:void 0}async _open(t){if(t.kind==="weblink"){at(t.url)&&window.open(t.url,"_blank","noopener");return}let e=this._pageFor(t);try{await wt(this.hass,t.id,e?`#page=${e}`:"")}catch(i){this._error=A(i,this._lang)}}async _setPage(t,e){if(this.taskId){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,task_pages:{[this.taskId]:e}}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}}async _download(t){try{await Xt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=A(e,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return h;let t=this._lang,e=this._linked(),i=this._available();return r`
      <div class="task-docs">
        ...
        ${this.canWrite&&i.length?r`<div class="tdoc-attach">
              ...
              >
                ...
                ${i.map(a=>r`<option value=${a.id} ?selected=${a.id===this._attachId}>${Tt(a)}</option>`)}
              </select>
    ...
    `}_renderRow(t,e){let i=t.kind==="file",a=this._isPdf(t),n=this._pageFor(t),d=(t.tags||[]).find(p=>Rt.includes(p))||"other",o=i?vt(t.size,e):s("doc_link_badge",e);return r`
      <div class="tdoc-row">
        <ha-icon class="tdoc-icon" icon=${i?oe[d]:"mdi:link-variant"}></ha-icon>
        <div
          class="tdoc-info"
          role="button"
          tabindex="0"
        ...
        >
          <div class="tdoc-title">${Tt(t)}</div>
          ${t.description?r`<div class="tdoc-desc">${t.description}</div>`:h}
          <div class="tdoc-meta">
            ${o}${n?r` · <span class="tdoc-pagetag">${s("doc_page",e)} ${n}</span>`:h}
          </div>
        </div>
  ...
  `,g([S({attribute:!1})],nt.prototype,"hass",2),g([S({attribute:!1})],nt.prototype,"entryId",2),g([S({attribute:!1})],nt.prototype,"taskId",2),g([S({attribute:!1})],nt.prototype,"partId",2),g([S({type:Boolean})],nt.prototype,"canWrite",2),g([m()],nt.prototype,"_docs",2),g([m()],nt.prototype,"_loaded",2),g([m()],nt.prototype,"_busy",2),g([m()],nt.prototype,"_error",2),g([m()],nt.prototype,"_attachId",2),g([m()],nt.prototype,"_filter",2);customElements.get("maintenance-task-documents")||customElements.define("maintenance-task-documents",nt);var Xi={name:"",vendor:"",mpn:"",gtin:"",storage_location:"",product_url:"",unit:"",cost:"",stock:"",reorder_threshold:"",restock_quantity:"",auto_buy_task:!0,notes:""},rt=class extends H{constructor(){super(...arguments);this.parts=[];this.canWrite=!1;this.currencySymbol="\u20AC";this._editing=null;this._busy=!1;this._error="";this._restockFor=null;this._restockQty="";this._restockInvalid=!1;this._docsFor=null}get _lang(){return U(this.hass)}connectedCallback(){super.connectedCallback(),ot(this._lang).then(()=>this.requestUpdate())}_notifyChanged(){this.dispatchEvent(new CustomEvent("parts-changed",{bubbles:!0,composed:!0}))}async _send(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t)}catch(e){return this._error=A(e,this._lang),null}finally{this._busy=!1}}_openAdd(){this._editing={...Xi}}_openEdit(t){this._editing={id:t.id,name:t.name,vendor:t.vendor||"",mpn:t.mpn||"",gtin:t.gtin||"",storage_location:t.storage_location||"",product_url:t.product_url||"",unit:t.unit||"",cost:t.cost!=null?String(t.cost):"",stock:t.stock!=null?String(t.stock):"",reorder_threshold:t.reorder_threshold!=null?String(t.reorder_threshold):"",restock_quantity:t.restock_quantity!=null?String(t.restock_quantity):"",auto_buy_task:!!t.auto_buy_task,notes:t.notes||""}}_formValue(t){let e=i=>i.trim()===""?null:Number(i);return{entry_id:this.entryId,name:t.name.trim(),vendor:t.vendor.trim()||null,mpn:t.mpn.trim()||null,gtin:t.gtin.trim()||null,storage_location:t.storage_location.trim()||null,product_url:t.product_url.trim()||null,unit:t.unit.trim()||null,cost:e(t.cost),stock:e(t.stock),reorder_threshold:e(t.reorder_threshold),restock_quantity:e(t.restock_quantity),auto_buy_task:t.auto_buy_task,notes:t.notes.trim()||null}}async _save(){let t=this._editing;if(!t||!t.name.trim())return;let e=this._formValue(t),i=t.id?"maintenance_supporter/part/update":"maintenance_supporter/part/create";await this._send(t.id?{type:i,part_id:t.id,...e}:{type:i,...e})!==null&&(this._editing=null,this._notifyChanged())}async _delete(t){if(!window.confirm(s("part_delete_confirm",this._lang).replace("{name}",t.name)))return;await this._send({type:"maintenance_supporter/part/delete",entry_id:this.entryId,part_id:t.id})!==null&&this._notifyChanged()}async _restock(t){let e=parseFloat(this._restockQty);if(!Number.isFinite(e)||e===0){this._restockInvalid=!0;return}this._restockInvalid=!1;let i=await this._send({type:"maintenance_supporter/part/restock",entry_id:this.entryId,part_id:t.id,delta:e});this._restockFor=null,i!==null&&(t.stock=i.stock,this.requestUpdate(),this._notifyChanged())}_identLine(t){return[t.vendor,t.mpn?`MPN: ${t.mpn}`:"",t.gtin?`GTIN: ${t.gtin}`:""].filter(Boolean).join(" \xB7 ")}_renderRow(t){let e=this._lang,i=t.stock!==null&&t.stock!==void 0,a=this._identLine(t),n=this._docsFor===t.id;return r`
      <div class="part-row ${t.is_low?"low":""}">
        ...
        <div class="part-main">
          <div class="part-name">
            ${at(t.shopping_url)?r`<a href=${t.shopping_url} target="_blank" rel="noopener noreferrer">${t.name}</a>`:t.name}
            ${i?r`<span class="stock-badge ${t.is_low?"low":""}"
                  >${t.stock}${t.unit?` ${t.unit}`:""}${t.reorder_threshold!=null?r`<span class="threshold">/${t.reorder_threshold}</span>`:h}</span
                >`:h}
          </div>
          <div class="part-meta">
            ${a?r`<span>${a}</span>`:h}
    ...
    `}_inventoryValue(){let t=0,e=!1;for(let i of this.parts){let a=typeof i.cost=="number"?i.cost:null,n=typeof i.stock=="number"?i.stock:null;a!==null&&n!==null&&(t+=a*n,e=!0)}return e?t:null}render(){let t=this._lang;return!this.parts.length&&!this.canWrite?h:r`
  ...
  `,g([S({attribute:!1})],rt.prototype,"hass",2),g([S({attribute:!1})],rt.prototype,"entryId",2),g([S({attribute:!1})],rt.prototype,"parts",2),g([S({type:Boolean})],rt.prototype,"canWrite",2),g([S({attribute:!1})],rt.prototype,"currencySymbol",2),g([m()],rt.prototype,"_editing",2),g([m()],rt.prototype,"_busy",2),g([m()],rt.prototype,"_error",2),g([m()],rt.prototype,"_restockFor",2),g([m()],rt.prototype,"_restockQty",2),g([m()],rt.prototype,"_restockInvalid",2),g([m()],rt.prototype,"_docsFor",2);customElements.get("maintenance-parts-section")||customElements.define("maintenance-parts-section",rt);var Zi=new Set(["completed","skipped","reset","missed"]);function ts(l,c){let t=l.reading_values||[];return t.length?t.filter(e=>typeof e.value=="number").map(e=>({id:e.id,name:e.name||"",value:e.value,unit:e.unit||""})):typeof l.reading_value=="number"?[{id:"",name:"",value:l.reading_value,unit:c||""}]:[]}function ki(l){let c=[];for(let t of l){let e=[...t.history??[]].map(a=>({h:a,ts:new Date(a.timestamp).getTime()})).filter(a=>Number.isFinite(a.ts)).sort((a,n)=>a.ts-n.ts),i=new Map;for(let{h:a,ts:n}of e){let d=ts(a,t.reading_unit).map(p=>{let u=i.get(p.id);return i.set(p.id,p.value),{name:p.name,value:p.value,unit:p.unit,delta:u==null?null:p.value-u}});if(!Zi.has(a.type))continue;let o=a.checklist_state&&typeof a.checklist_state=="object"?Object.values(a.checklist_state):null;c.push({ts:n,timestamp:a.timestamp,taskId:t.id,taskName:t.name,type:a.type,cost:typeof a.cost=="number"?a.cost:null,duration:typeof a.duration=="number"?a.duration:null,notes:a.notes??null,completedBy:a.completed_by??null,phaseName:a.phase_id&&t.phases?.[a.phase_id]?.name||null,refNo:typeof a.ref_no=="number"?a.ref_no:null,taskRefNo:typeof t.ref_no=="number"?t.ref_no:null,readings:d,parts:(a.used_parts||[]).filter(p=>p&&(p.name||p.part_id)).map(p=>({name:p.name||p.part_id,quantity:typeof p.quantity=="number"?p.quantity:1})),photoIds:Ze(a),checklist:o&&o.length?{done:o.filter(Boolean).length,total:o.length}:null})}}return c.sort((t,e)=>e.ts-t.ts||t.taskName.localeCompare(e.taskName)),c}function $i(l,c){let t=c.from?new Date(`${c.from}T00:00:00`).getTime():null,e=c.to?new Date(`${c.to}T00:00:00`).getTime()+864e5:null;return l.filter(i=>!(c.taskId&&i.taskId!==c.taskId||t!=null&&i.ts<t||e!=null&&i.ts>=e))}function le(l){let c=0,t=0;for(let e of l)e.type==="completed"&&(c++,e.cost!=null&&(t+=e.cost));return{completed:c,totalCost:t}}var ce={readings:!0,parts:!0,photos:!0,documents:!0,checklist:!0,notes:!0,costs:!0,person:!0,refs:!0,qr:!1,bare:!0,docDescriptions:!0};function es(l){return!!(l.notes&&l.notes.trim()||l.cost!=null||l.duration!=null||l.readings.length||l.parts.length||l.photoIds.length||l.checklist)}function C(l){return String(l??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}var is=6;function ji(l,c,t,e,i,a,n,d={}){let o=d.options??{layout:"chronological",include:ce},p=o.include,u=d.data??{objectRef:null,tasks:[],photos:{},fmtNumber:$=>String($)},b=c.filter($=>$.type==="completed"&&(p.bare!==!1||es($))),{totalCost:_}=le(b),v=$=>p.refs&&u.objectRef&&$.taskRefNo!=null&&$.refNo!=null?`${u.objectRef}.${$.taskRefNo}-${$.refNo}`:null,f=$=>p.refs&&u.objectRef&&$.taskRefNo!=null?`${u.objectRef}.${$.taskRefNo}`:null,R=[[t.refNumber,p.refs&&u.objectRef?`#${u.objectRef}`:null],[t.manufacturer,l.manufacturer],[t.model,l.model],[t.serial,l.serial_number],[t.installed,l.installation_date?e(l.installation_date):null]].filter(([,$])=>$).map(([$,N])=>`<div class="meta-row"><span>${C($)}</span><strong>${C(N)}</strong></div>`).join(""),x=$=>{let N=[];if(p.readings&&$.readings.length){let F=$.readings.map(P=>{let Y=`${u.fmtNumber(P.value)}${P.unit?` ${C(P.unit)}`:""}`,X=P.delta!=null?` <span class="delta">(${P.delta>=0?"+":"\u2212"}${u.fmtNumber(Math.abs(P.delta))})</span>`:"";return`${P.name?`${C(P.name)}: `:""}${Y}${X}`});N.push(`<div class="fact"><span class="k">${C(t.readings)}</span>${F.join(" \xB7 ")}</div>`)}if(p.parts&&$.parts.length&&N.push(`<div class="fact"><span class="k">${C(t.parts)}</span>${$.parts.map(F=>`${C(F.name)} \xD7 ${u.fmtNumber(F.quantity)}`).join(", ")}</div>`),p.checklist&&$.checklist&&N.push(`<div class="fact"><span class="k">${C(t.checklist)}</span>${$.checklist.done}/${$.checklist.total}</div>`),p.photos&&$.photoIds.length){let F=$.photoIds.slice(0,is),P=F.map(X=>{let W=u.photos[X],T=W?.name||X.slice(0,8);return W?.url?`<figure class="photo"><img src="${C(W.url)}" alt="" /><figcaption>${C(T)}</figcaption></figure>`:`<figure class="photo"><figcaption>${C(T)}</figcaption></figure>`}),Y=$.photoIds.length>F.length?`<span class="more">+${$.photoIds.length-F.length}</span>`:"";N.push(`<div class="fact"><span class="k">${C(t.photos)}</span><div class="photos">${P.join("")}${Y}</div></div>`)}return N.length?`<div class="details">${N.join("")}</div>`:""},M=$=>[p.notes?$.notes:null,p.person&&$.completedBy?`${t.completedBy}: ${$.completedBy}`:null].filter(Boolean).join(" \xB7 "),k=$=>p.costs?`<td class="num">${$.cost!=null?C(a($.cost)):C(t.none)}</td>
    ...
    <th>${C(t.colNotes)}</th>
  </tr></thead>`,st=($,N)=>{let F=M($),P=x($),Y=C(N?$.phaseName?`${$.taskName} \xB7 ${$.phaseName}`:$.taskName:$.phaseName||"");return`<tr class="entry">
        <td class="nowrap">${C(e($.timestamp))}${I(v($))}</td>
        <td>${N?`${Y} ${I(f($))}`:Y}</td>
        ${k($)}
        <td class="notes">${C(F)||(P?"":C(t.none))}</td>
      </tr>${P?`<tr class="entry-details"><td colspan="${O}" class="details-cell">${P}</td></tr>`:""}`},ut;if(o.layout==="by_task"){let $=new Map(u.tasks.map(P=>[P.id,P])),N=[...u.tasks.map(P=>P.id)];for(let P of b)N.includes(P.taskId)||N.push(P.taskId);ut=`${N.map(P=>{let Y=b.filter(gt=>gt.taskId===P);if(!Y.length)return"";let X=$.get(P),W=X?.name||Y[0].taskName,T=p.refs?X?.ref??f(Y[0]):null,j=p.documents&&X?.documents.length?`<div class="fact"><span class="k">${C(t.documents)}</span>${X.documents.map(gt=>`${C(gt.title)}${gt.page?` (${C(t.page(gt.page))})`:""}${p.docDescriptions!==!1&&gt.description?` \u2014 <span class="doc-desc">${C(gt.description)}</span>`:""}`).join(", ")}</div>`:"",z=p.qr&&X?.qrDataUri?`<figure class="qr"><img src="${C(X.qrDataUri)}" alt="" /><figcaption>${C(t.scanHint)}</figcaption></figure>`:"",Mt=Y.reduce((gt,Vi)=>gt+(Vi.cost??0),0);return`<section class="task">
  <div class="task-head">
    <div class="task-title">
      <h2>${C(W)} ${I(T)}</h2>
      ${X?.schedule?`<div class="schedule">${C(X.schedule)}</div>`:""}
      ${j}
      <div class="task-count">${C(t.entriesLabel(Y.length))}${p.costs&&Mt>0?` \xB7 ${C(a(Mt))}`:""}</div>
    </div>
    ${z}
  </div>
  <table>
...
`)}
  ...
  <tfoot><tr>
    ...
    ${p.costs?`<td class="num">${C(a(_))}</td><td colspan="2"></td>`:"<td></td>"}
  </tr></tfoot>
...
<p class="sub">${C(t.generated)} ${C(e(n))} \xB7 ${C(t.entriesLabel(b.length))}</p>
${R?`<div class="meta">${R}</div>`:""}
${ut}
${d.capped?`<p class="cap-note">${C(t.capNote)}</p>`:""}
</body>
</html>`}var ss=500,as=60,tt=class extends H{constructor(){super(...arguments);this.entryId="";this.object=null;this.tasks=[];this.currencySymbol="\u20AC";this.userName=()=>null;this._full={};this._loading=!1;this._filterTask="";this._from="";this._to="";this._expanded=!1;this._printOpen=!1;this._printLayout="chronological";this._printInclude={...ce};this._printing=!1;this._loadedFor=null;this._localeReady=!1}connectedCallback(){super.connectedCallback();try{let t=JSON.parse(Z(D.printOptions)||"null");(t?.layout==="by_task"||t?.layout==="chronological")&&(this._printLayout=t.layout),t?.include&&typeof t.include=="object"&&(this._printInclude={...ce,...t.include})}catch{}}_savePrintOptions(){G(D.printOptions,JSON.stringify({layout:this._printLayout,include:this._printInclude}))}_toggleInclude(t,e){this._printInclude={...this._printInclude,[t]:e},this._savePrintOptions()}get _lang(){return U(this.hass)}updated(t){super.updated(t),!this._localeReady&&this.hass&&(this._localeReady=!0,ot(this._lang).then(()=>this.requestUpdate())),this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._full={},this._filterTask="",this._from="",this._to="",this._loadFullHistories())}async _loadFullHistories(){let t=this.entryId,e=this.tasks;if(!e.length)return;this._loading=!0;let i=await Promise.all(e.map(async a=>{try{let n=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/history",entry_id:t,task_id:a.id});return[a.id,n.history??[]]}catch{return[a.id,a.history??[]]}}));this.entryId===t&&(this._full=Object.fromEntries(i),this._loading=!1)}get _entries(){return ki(this.tasks.map(t=>({id:t.id,name:t.name,history:this._full[t.id]??t.history??[],ref_no:t.ref_no,reading_unit:t.reading_unit})))}get _capped(){return Object.values(this._full).some(t=>t.length>=ss)}_openTask(t){this.dispatchEvent(new CustomEvent("open-task",{detail:{taskId:t},bubbles:!0,composed:!0}))}async _bookletData(t){let e=this._printInclude,i=this._lang,a=[];if(e.documents||e.photos)try{a=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId})).documents||[]}catch{a=[]}let n=new Map;e.qr&&this._printLayout==="by_task"&&await Promise.all(this.tasks.map(async p=>{try{let u=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/qr/generate",entry_id:this.entryId,task_id:p.id,url_mode:"server",action:"view"});u.svg_data_uri&&n.set(p.id,u.svg_data_uri)}catch{}}));let d=this.tasks.map(p=>({id:p.id,name:p.name,ref:xt(this.object,p),schedule:St(p,i)||null,documents:a.filter(u=>(u.task_ids||[]).includes(p.id)&&!(u.tags||[]).includes("photo")).map(u=>({title:u.title||u.filename||"",page:u.task_pages?.[p.id]??null,description:u.description||null})),qrDataUri:n.get(p.id)??null})),o={};if(e.photos){let p=[...new Set(t.filter(b=>b.type==="completed").flatMap(b=>b.photoIds))].slice(0,as),u=new Map(a.map(b=>[b.id,b]));await Promise.all(p.map(async b=>{let _=u.get(b),v=_?.title||_?.filename||b.slice(0,8);try{o[b]={name:v,url:new URL(await Jt(this.hass,b),window.location.origin).href}}catch{o[b]={name:v,url:null}}}))}return{tasks:d,photos:o}}async _print(t){let e=this._lang,i=this.object;if(!i||this._printing)return;this._printing=!0;let a;try{a=await this._bookletData(t)}finally{this._printing=!1}this._printOpen=!1;let n={title:s("service_record_title",e),generated:s("report_generated",e),manufacturer:s("manufacturer",e),model:s("model",e),serial:s("serial_number_label",e),installed:s("installed",e),colDate:s("date",e),colTask:s("task_name",e),colCost:s("cost",e),colDuration:s("duration",e),colNotes:s("notes_label",e),completedBy:s("completed_by",e),totalLabel:s("report_total_cost",e),entriesLabel:p=>`${p} ${s("service_record_entries",e)}`,capNote:s("object_history_cap_note",e),none:"\u2014",readings:s("print_inc_readings",e),parts:s("print_inc_parts",e),photos:s("print_inc_photos",e),documents:s("print_inc_documents",e),checklist:s("print_inc_checklist",e),refNumber:s("ref_number",e),scanHint:s("report_scan_hint",e),page:p=>s("search_page",e).replace("{page}",String(p))},d=t.map(p=>({...p,completedBy:p.completedBy?this.userName(p.completedBy):null})),o=ji(i,d,n,p=>p?Q(p,e):"",p=>Lt(p,e),p=>K(p,this.currencySymbol,e),new Date().toISOString(),{capped:this._capped,options:{layout:this._printLayout,include:this._printInclude},data:{objectRef:yt(i),tasks:a.tasks,photos:a.photos,fmtNumber:p=>it(p,e)}});Bt(o)}_renderPrintOptions(t){let e=this._lang,i=this._printInclude,a=(d,o,p=!1)=>r`
      ...
      <div class="print-options" role="dialog" aria-label=${s("print_options_title",e)}>
        ...
        <div class="po-group">
          ...
          ${a("documents","print_inc_documents",!n)}
          ${a("docDescriptions","print_inc_doc_desc",!n)}
          ${a("qr","print_inc_qr",!n)}
        </div>
      ...
      </div>`}render(){let t=this._lang,e=this._entries;if(!e.length&&!this._loading)return h;let i=$i(e,{taskId:this._filterTask||null,from:this._from||null,to:this._to||null}),{completed:a,totalCost:n}=le(i),d=this._expanded?i:i.slice(0,15);return r`
      <div class="section">
        <h3>
          ${s("object_history_section",t)}
          <span class="count">${i.length}</span>
          ${this._loading?r`<span class="loading-hint">${s("loading",t)}</span>`:h}
        ...
        ${i.length===0?r`<p class="empty">${s("object_history_empty",t)}</p>`:r`
              <div class="rows">
                ${d.map(o=>r`
                  <div class="row">
                    <span class="date" title=${Pe(o.timestamp,t)}>${Q(o.timestamp,t)}</span>
                    <span class="type type-${o.type}">${s(o.type,t)}</span>
                    <button class="task-link" @click=${()=>this._openTask(o.taskId)}>${o.taskName}${o.phaseName?` \xB7 ${o.phaseName}`:""}</button>
                    <span class="facts">
                      ${o.cost!=null?r`<span>${K(o.cost,this.currencySymbol,t)}</span>`:h}
                      ${o.duration!=null?r`<span>${Lt(o.duration,t)}</span>`:h}
                    </span>
                    ${o.notes?r`<span class="notes" title=${o.notes}>${o.notes}</span>`:h}
                  </div>
                `)}
              </div>
              ...
              ${this._capped?r`<p class="cap-note">${s("object_history_cap_note",t)}</p>`:h}
            `}
      </div>
    `}};tt.styles=L`
  ...
  `,g([S({attribute:!1})],tt.prototype,"hass",2),g([S()],tt.prototype,"entryId",2),g([S({attribute:!1})],tt.prototype,"object",2),g([S({attribute:!1})],tt.prototype,"tasks",2),g([S()],tt.prototype,"currencySymbol",2),g([S({attribute:!1})],tt.prototype,"userName",2),g([m()],tt.prototype,"_full",2),g([m()],tt.prototype,"_loading",2),g([m()],tt.prototype,"_filterTask",2),g([m()],tt.prototype,"_from",2),g([m()],tt.prototype,"_to",2),g([m()],tt.prototype,"_expanded",2),g([m()],tt.prototype,"_printOpen",2),g([m()],tt.prototype,"_printLayout",2),g([m()],tt.prototype,"_printInclude",2),g([m()],tt.prototype,"_printing",2);customElements.get("maintenance-object-history-section")||customElements.define("maintenance-object-history-section",tt);var lt=class lt extends H{constructor(){super(...arguments);this.flat=!1;this._ov=null;this._loading=!1;this._marking=!1;this._error="";this._history=null;this._rosterSort=lt._storedSort();this._typeFilter=null;this._recorded=[];this._historyRequested=!1;this._localeReady=!1;this._markAll=async()=>{await this._mark(void 0)};this._repair=async()=>{if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/setup",language:this._lang}),await this._load()}catch(t){this._error=A(t,this._lang)}finally{this._marking=!1}}};this._loadHistory=async t=>{let e=t.target.open;if(G(D.batteryRosterOpen,e?"1":"0"),!(!e||this._historyRequested)){this._historyRequested=!0;try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview_history"});this._history=i.series}catch{this._history=null}}}}get _lang(){return U(this.hass)}connectedCallback(){super.connectedCallback(),this.hass&&this._load()}updated(t){At(this,t),t.has("hass")&&this.hass&&!this._localeReady&&(this._localeReady=!0,ot(this._lang).then(()=>this.requestUpdate()),this._ov===null&&!this._loading&&this._load())}async _load(){this._loading=!0,this._error="";try{this._ov=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview"})}catch(t){this._error=A(t,this._lang)}finally{this._loading=!1}}async _mark(t){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/mark_replaced",...t?{entity_ids:t}:{}}),await this._load()}catch(e){this._error=A(e,this._lang)}finally{this._marking=!1}}}async _setExcluded(t,e){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/set_excluded",entity_id:t,excluded:e}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._marking=!1}}}async _addBattery(t){let e=t.detail?.value;if(!(!e||this._marking)){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/set_included",entity_id:e,included:!0}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._marking=!1}}}async _setTrackSelf(t){await this._setFleetOption("set_track_self_charging",t.target.checked)}async _setDueWithoutSensor(t){await this._setFleetOption("set_due_without_sensor",t.target.checked)}async _setFleetOption(t,e){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:`maintenance_supporter/battery_fleet/${t}`,enabled:e}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._marking=!1}}}_rosterOpen(){return Z(D.batteryRosterOpen)!=="0"}_predictedTitle(t,e){if(t.forecast_overdue)return s("battery_fleet_forecast_overdue",e);let i=this._predictedDate(t.days_until??0);if(t.predicted_source==="trend")return s("battery_fleet_predicted_trend",e).replace("{date}",i).replace("{confidence}",s("cal_confidence_"+(t.prediction_confidence||"medium"),e));if(t.lifetime_months!=null&&t.lifetime_source){let a=s("lifetime_source_"+t.lifetime_source,e).replace("{n}",String(t.lifetime_samples??0));return s("battery_fleet_predicted_typical",e).replace("{date}",i).replace("{months}",String(t.lifetime_months)).replace("{type}",t.battery_type).replace("{source}",a)}return s("battery_fleet_predicted_on",e).replace("{date}",i)}_sparkline(t){let e=this._history?.[t.entity_id];if(!e||e.points.length<2)return h;let i=110,a=24,n=2,d=e.points[0][0],o=e.points[e.points.length-1][0],p=Date.now()/1e3,u=t.status!=="low"&&t.predicted_source==="trend"&&t.days_until!=null?p+t.days_until*86400:null,b=Math.max(o,u??o),_=M=>b===d?n:n+(M-d)/(b-d)*(i-2*n),v=M=>n+(1-Math.min(100,Math.max(0,M))/100)*(a-2*n),f=e.points.map(([M,k])=>`${E(_(M))},${E(v(k))}`).join(" "),R=e.points[e.points.length-1][1],x=E(v(e.threshold));return r`<svg
      class="bf-spark"
      viewBox="0 0 ${i} ${a}"
      role="img"
    ...
    >
      ...
      ${u!==null?r`<line
            ...
            y2=${x}
          ></line>`:h}
    </svg>`}static _storedSort(){return Z(D.batteryRosterSort)==="name"?"name":"urgency"}_setSort(t){this._rosterSort=t,G(D.batteryRosterSort,t)}_sortedRoster(t){let e=this._typeFilter===null?t:t.filter(a=>a.battery_type===this._typeFilter);if(this._rosterSort==="name")return e;let i=a=>a.status==="low"?-1e3+(a.level??101)/101:a.days_until??1/0;return[...e].sort((a,n)=>i(a)-i(n)||a.device_name.localeCompare(n.device_name))}_predictedDate(t){return this._fmtDate(Date.now()+t*864e5)}_fmtDate(t){let e=new Date(t),i=a=>String(a).padStart(2,"0");return Q(`${e.getFullYear()}-${i(e.getMonth()+1)}-${i(e.getDate())}`,this._lang)}_shoppingLine(t){return Object.entries(t).map(([e,i])=>r`<button
    ...
    </button>`}_renderRow(t,e,i){let a=t.available===!1?r`<span class="bf-offline">${s("battery_fleet_offline",e)}</span>`:t.no_sensor?r`<span class="bf-offline bf-nosensor">${s("battery_fleet_no_sensor",e)}</span>`:h,n=r`<span class="bf-type">${t.quantity}× ${t.battery_type}</span>`,d=i.mark==="always"||t.no_sensor||t.can_mark_replaced;return r`
      <div class="bf-row">
        ...
        ${i.status?r`<span class="bf-status bf-${t.status}"
              ...
              >${n}${a}`:r`${a}${n}`}
        ${i.recharge&&t.rechargeable?r`<span class="bf-recharge" title=${s("battery_fleet_rechargeable",e)}
  ...
  `,g([S({attribute:!1})],lt.prototype,"hass",2),g([S({type:Boolean})],lt.prototype,"flat",2),g([m()],lt.prototype,"_ov",2),g([m()],lt.prototype,"_loading",2),g([m()],lt.prototype,"_marking",2),g([m()],lt.prototype,"_error",2),g([m()],lt.prototype,"_history",2),g([m()],lt.prototype,"_rosterSort",2),g([m()],lt.prototype,"_typeFilter",2),g([m()],lt.prototype,"_recorded",2);var Te=lt;customElements.get("maintenance-battery-fleet-section")||customElements.define("maintenance-battery-fleet-section",Te);var Ti=L`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;function Si(l){let c=window;c.customCards=c.customCards||[],c.customCards.some(t=>t.type===l.type)||c.customCards.push(l)}var dt=class extends H{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(t){if(this._config={...t},t.past_days&&[30,90].includes(t.past_days)?this._pastDays=t.past_days:t.window_days&&[7,14,30,365].includes(t.window_days)&&(this._windowDays=t.window_days,this._pastDays=0),typeof t.user_filter=="string"&&(this._userFilter=t.user_filter),typeof t.object_filter=="string")this._objectFilter=t.object_filter,this._configuredObjects=[];else if(Array.isArray(t.object_filter)){let e=t.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=e.length===1?e[0]:"",this._configuredObjects=e.length>1?e:[]}}getCardSize(){return 6}get _lang(){return U(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(t){if(super.updated(t),At(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=e,zt(this._stats.budget)}catch{}}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){t();return}this._unsub=t}catch{}}_onEventClick(t){if(t.history_timestamp){this._openHistoryEntry(t);return}_i(t.entry_id,t.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:t.entry_id,task_id:t.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(t){try{let e=await oi(this.hass,t.entry_id,t.task_id,t.history_timestamp);if(!e||mi(e))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h;let t=this._lang,e=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,n=null;this._userFilter&&(n=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let d=y=>{let st=y.toLowerCase();return this._objects.find($=>$.entry_id===y||$.object.name.toLowerCase()===st)?.entry_id??null},o=new Set(this._configuredObjects.map(d).filter(y=>y!==null)),p=o.size?this._objects.filter(y=>o.has(y.entry_id)):this._objects,u=this._config.show_object_filter!==!1&&p.length>1,b=this._objectFilter?d(this._objectFilter):null,_=b&&p.some(y=>y.entry_id===b)?p.filter(y=>y.entry_id===b):p,v=new Date;v.setHours(0,0,0,0);let f=this._pastDays>0,R=f?si(_,v,this._pastDays,n):ii(_,v,this._windowDays,n),x=Ft(v),M=this._windowDays===365||f,k=M?R.filter(y=>y.events.length>0):R,I=y=>{let st=`cal-status-${y.status}`,ut=y.projected?"cal-event-projected":"",$=y.status==="overdue"&&y.days_until_due!=null?` (${jt(y.days_until_due,t)})`:"",N=y.projected&&y.interval_days?r`<span class="cal-event-recur">${y.interval_unit&&y.interval_unit!=="days"?`${y.interval_days} ${s("unit_"+y.interval_unit,t)}`:s("cal_every_n_days",t).replace("{n}",String(y.interval_days))}</span>`:h,F=y.schedule_type==="sensor_based",P=F?r`<ha-icon class="cal-event-icon cal-source-sensor"
                ...
                icon="${y.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,Y=F&&y.prediction_confidence&&y.status!=="triggered"&&!y.projected?r`<span class="cal-event-prediction cal-conf-${y.prediction_confidence}">
            ${s("cal_predicted",t)} · ${s(`cal_confidence_${y.prediction_confidence}`,t)}
          </span>`:h,X=Kt(this._stats?.budget),W=y.history_type?s(y.history_type,t):s(y.status,t);return r`
        <div class="cal-event ${ut}"
          ...
          ${y.avg_cost!=null&&y.avg_cost>0?r`<span class="cal-event-cost">${K(y.avg_cost,X,t)}</span>`:h}
        </div>
      `},O=y=>{let[st,ut,$]=y.date.split("-").map(Number),N=new Date(st,ut-1,$),F=y.date===x,P=ze(N,t,"short"),Y=Le(N,t,"long");return r`
        <div class="cal-day-row">
          <div class="cal-day-pill ${F?"cal-today":""}">
            <span class="cal-pill-weekday">${P}</span>
            <span class="cal-pill-day">${N.getDate()}</span>
          </div>
          <div class="cal-day-content">
            <div class="cal-day-header">
              <span class="cal-day-month">${Y}</span>
              ${F?r`<span class="cal-day-today-badge">${s("today",t)}</span>`:h}
            </div>
            ${y.events.length===0?r`<div class="cal-empty">${s("cal_no_events",t)}</div>`:y.events.map(I)}
          </div>
        </div>
      `};return r`
      <ha-card .header=${a}>
              ...
              <div class="cal-controls">
                ...
                ${u?r`
                      <select class="cal-user-filter"
                        ...
                        ${[...p].sort((y,st)=>y.object.name.localeCompare(st.object.name)).map(y=>r`<option value=${y.entry_id} ?selected=${y.entry_id===b}>${y.object.name}</option>`)}
                      </select>
                    `:h}
              </div>
            `:h}
        <div class="cal-rolling">
          ${k.length===0&&M?r`<div class="cal-empty">${s("cal_no_events",t)}</div>`:k.map(O)}
        </div>
      </ha-card>
    `}};dt.styles=[Qt,Ti,L`
      :host { display: block; }
      ha-card { padding: 0; overflow: hidden; }
    `],g([S({attribute:!1})],dt.prototype,"hass",2),g([m()],dt.prototype,"_config",2),g([m()],dt.prototype,"_objects",2),g([m()],dt.prototype,"_stats",2),g([m()],dt.prototype,"_windowDays",2),g([m()],dt.prototype,"_pastDays",2),g([m()],dt.prototype,"_userFilter",2),g([m()],dt.prototype,"_objectFilter",2),g([m()],dt.prototype,"_unsub",2);var os=[{value:7,key:"cal_editor_window_week"},{value:14,key:"cal_editor_window_fortnight"},{value:30,key:"cal_editor_window_month"},{value:365,key:"cal_editor_window_year"}],Pt=class extends H{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}get _lang(){return U(this.hass)}setConfig(t){this._config={...t}}updated(){let t=this._lang;t&&!Ie(t)&&ot(t).then(()=>this.requestUpdate())}_valueChanged(t,e){let i={...this._config,[t]:e};t==="show_window_chips"&&e===!0&&delete i.show_window_chips,t==="show_user_filter"&&e===!0&&delete i.show_user_filter,t==="show_object_filter"&&e===!0&&delete i.show_object_filter,t==="title"&&(!e||typeof e=="string"&&e.trim()==="")&&delete i.title,t==="user_filter"&&e===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let t=this._lang,e=this._config.window_days??30,i=this._config.show_window_chips!==!1,a=this._config.show_user_filter!==!1,n=this._config.user_filter??"",d=this._config.title??"";return r`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${os.map(o=>r`<option value="${o.value}" ?selected=${o.value===e}>${s(o.key,t)}</option>`)}
          </select>
        </div>
        ...
        <div class="content">
          ...
          ${this._inputLabel?r`
            ...
            <label class="field">
              ...
              ${this._options?r`<select class="field-input field-select"
                    @change=${e=>this._inputValue=e.target.value}>
                    ${this._options.map(e=>r`<option value=${e.value} ?selected=${e.value===this._inputValue}>${e.label}</option>`)}
                  </select>`:r`<input class="field-input"
  ...
  `],g([S({attribute:!1})],ct.prototype,"hass",2),g([m()],ct.prototype,"_open",2),g([m()],ct.prototype,"_title",2),g([m()],ct.prototype,"_message",2),g([m()],ct.prototype,"_confirmText",2),g([m()],ct.prototype,"_danger",2),g([m()],ct.prototype,"_inputLabel",2),g([m()],ct.prototype,"_inputType",2),g([m()],ct.prototype,"_options",2),g([m()],ct.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",ct);var pt=class extends H{constructor(){super(...arguments);this.objects=[];this._summary=null;this._loaded=!1;this._busy=!1;this._error="";this._query="";this._results=[];this._expanded=!1;this._initiallyLoaded=!1;this._searchTimer=0}get _lang(){return U(this.hass)}updated(t){super.updated(t),t.has("hass")&&this.hass&&!this._initiallyLoaded&&(this._initiallyLoaded=!0,this._load(),ot(this._lang).then(()=>this.requestUpdate()))}async _load(){this._busy=!0;try{this._summary=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/storage"}),this._error=""}catch(t){this._error=A(t,this._lang)}finally{this._loaded=!0,this._busy=!1}}_nameFor(t){return this.objects.find(i=>i.object?.id===t)?.object?.name||t.slice(0,8)}_entryFor(t){return this.objects.find(e=>e.object?.id===t)?.entry_id}_toggle(){this._expanded=!this._expanded}_openObject(t){this.dispatchEvent(new CustomEvent("open-object",{detail:{entry_id:t},bubbles:!0,composed:!0}))}_onSearch(t){this._query=t.target.value,clearTimeout(this._searchTimer),this._searchTimer=window.setTimeout(()=>{this._doSearch()},250)}async _doSearch(){let t=this._query.trim();if(!t){this._results=[];return}try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/search",query:t});this._results=e.results||[]}catch(e){this._error=A(e,this._lang),this._results=[]}}async _openResult(t){if(t.kind==="weblink"){at(t.url)&&window.open(t.url,"_blank","noopener");return}try{await wt(this.hass,t.id)}catch(e){this._error=A(e,this._lang)}}_renderResult(t,e){return r`
      <div class="obj-row result-row" title=${s("doc_open",e)} @click=${()=>this._openResult(t)}>
        ...
        <div class="result-info">
          <div class="result-title">${Tt(t)}</div>
    ...
    `}render(){if(!this._loaded||!this._summary)return h;let t=this._summary;if(!t.document_count)return h;let e=this._lang,i=Object.entries(t.by_object??{}).filter(([,a])=>a.files>0||a.links>0).map(([a,n])=>({id:a,name:this._nameFor(a),entry:this._entryFor(a),...n})).sort((a,n)=>n.bytes-a.bytes);return r`
      <ha-card>
        <div class="card-content">
          ...
          ${this._expanded?r`
                <div class="body">
                  ...
                  ${this._query.trim()?this._results.length?r`<div class="obj-list">${this._results.map(a=>this._renderResult(a,e))}</div>`:r`<div class="search-empty">${s("doc_search_none",e)}</div>`:i.length?r`<div class="obj-list">${i.map(a=>this._renderObjRow(a,e))}</div>`:h}
                </div>
              `:h}
        </div>
      </ha-card>
  ...
  `,g([S({attribute:!1})],pt.prototype,"hass",2),g([S({attribute:!1})],pt.prototype,"objects",2),g([m()],pt.prototype,"_summary",2),g([m()],pt.prototype,"_loaded",2),g([m()],pt.prototype,"_busy",2),g([m()],pt.prototype,"_error",2),g([m()],pt.prototype,"_query",2),g([m()],pt.prototype,"_results",2),g([m()],pt.prototype,"_expanded",2);customElements.get("maintenance-storage-section-card")||customElements.define("maintenance-storage-section-card",pt);var rs=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"],mt=class extends H{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._error="";this._entryId="";this._taskId="";this._values=new Array(12).fill("");this._save=async()=>{let t=this._buildOverrides();if(t!==null){this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:t}),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(e){this._error=A(e,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}};this._clearAll=async()=>{this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:{}}),this._values=new Array(12).fill(""),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(t){this._error=A(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}get _lang(){return U(this.hass)}open(t,e,i){if(this._entryId=t,this._taskId=e,this._values=new Array(12).fill(""),i)for(let[a,n]of Object.entries(i)){let d=parseInt(a,10);d>=1&&d<=12&&typeof n=="number"&&(this._values[d-1]=n.toString())}this._error="",this._open=!0}_close(){this._open=!1}_buildOverrides(){let t={};for(let e=0;e<12;e++){let i=this._values[e].trim();if(!i)continue;let a=parseFloat(i);if(Number.isNaN(a))return this._error=`${s("month_"+["jan","feb","mar","apr","may","jun","jul","aug","sep","oct","nov","dec"][e],this._lang)}: ${s("seasonal_override_invalid",this._lang)}`,null;if(a<.1||a>5)return this._error=s("seasonal_override_range",this._lang),null;t[e+1]=a}return t}render(){if(!this._open)return r``;let t=this._lang;return r`
              ...
              <div class="objects">
                ${[...this.objects].sort((i,a)=>i.object.name.localeCompare(a.object.name)).map(i=>r`
                  <div class="object-block">
                    ...
                    ${i.tasks.length===0?r`<div class="hint small">${s("no_tasks_short",t)}</div>`:[...i.tasks].sort((a,n)=>a.name.localeCompare(n.name)).map(a=>{let n=`${i.entry_id}:${a.id}`,d=this._selected.has(n);return r`
  ...
  `,g([S({attribute:!1})],ft.prototype,"hass",2),g([m()],ft.prototype,"_open",2),g([m()],ft.prototype,"_busy",2),g([m()],ft.prototype,"_error",2),g([m()],ft.prototype,"_name",2),g([m()],ft.prototype,"_views",2);customElements.get("maintenance-saved-views-dialog")||customElements.define("maintenance-saved-views-dialog",ft);var ns=60,ls=20,Ei=30,cs={approaching:"\u2197",stable:"\u2192",easing:"\u2198"};function Se(l,c){let t=l.trigger_config;if(!t?.entity_id)return null;let e,i=t.type||"threshold";if(i==="threshold")if(t.trigger_above!=null)e=1;else if(t.trigger_below!=null)e=-1;else return null;else if(i==="counter"||i==="runtime"||i==="state_change")e=1;else return null;let a=c.get(t.entity_id)||[],n=i==="runtime"||i==="state_change",d=a.length>=2?a.map(f=>({ts:f.ts,val:f.val})):n?[]:(l.history||[]).filter(f=>f.trigger_value!=null).map(f=>({ts:new Date(f.timestamp).getTime(),val:f.trigger_value}));if(l.trigger_current_value!=null&&(d=[...d,{ts:Date.now(),val:l.trigger_current_value}]),d.length<2)return null;d.sort((f,R)=>f.ts-R.ts);let o=d.map(f=>f.val),p=Math.max(...o)-Math.min(...o),u=o[o.length-1]-o[0],b=t.trigger_delta_mode&&l.trigger_baseline_value!=null&&t.trigger_target_value!=null?l.trigger_baseline_value+t.trigger_target_value:t.trigger_target_value,_=i==="threshold"?t.trigger_above??t.trigger_below:i==="counter"?b:i==="runtime"?t.trigger_runtime_hours:t.trigger_target_changes,v=typeof _=="number"?Math.max(Math.abs(_-o[0]),p):p;return v===0||Math.abs(u)<v*(typeof _=="number"?.05:.15)?"stable":Math.sign(u)===e?"approaching":"easing"}function Ee(l,c){let t=l.trigger_config??null;if(!t)return h;let e=t.type||"threshold",i=l.trigger_entity_info?.unit_of_measurement??"",a=0,n="";if(e==="threshold"){let p=l.trigger_current_value??null;if(p==null)return h;let u=t.trigger_above,b=t.trigger_below;if(u!=null&&b!=null){let _=(u+b)/2,v=Math.abs(u-b)/2||1;a=Math.min(100,Math.max(0,Math.abs(p-_)/v*100));let f=Math.abs(p-u)<=Math.abs(p-b)?u:b;n=`${it(p,c?.lang,1)} / ${it(f,c?.lang)} ${i}`}else if(u!=null){let _=l.trigger_entity_info?.min,v=u>0?0:_!=null&&_<u?_:u<0?2*u:-100,f=u-v||1;a=Math.min(100,Math.max(0,(p-v)/f*100)),n=`${it(p,c?.lang,1)} / ${it(u,c?.lang)} ${i}`}else if(b!=null){let _=l.trigger_entity_info?.max,v=_!=null&&_>b?_:b>0?b*2:b<0?0:100,f=v-b||1;a=Math.min(100,Math.max(0,(v-p)/f*100)),n=`${it(p,c?.lang,1)} / ${it(b,c?.lang)} ${i}`}else if(t.trigger_equals!=null||t.trigger_not_equals!=null){let _=t.trigger_equals!=null?`= ${t.trigger_equals}`:`\u2260 ${t.trigger_not_equals}`;n=`${it(p,c?.lang,1)} (${_}${i?` ${i}`:""})`,a=l.trigger_active?100:0}else return h}else if(e==="counter"){let p=t.trigger_target_value||1,u;if(t.trigger_delta_mode?(u=l.trigger_current_delta??null,u==null&&l.trigger_baseline_value!=null&&l.trigger_current_value!=null&&(u=l.trigger_current_value-l.trigger_baseline_value)):u=l.trigger_current_value??null,u==null)return h;a=Math.min(100,Math.max(0,u/p*100)),n=`${it(u,c?.lang,1)} / ${it(p,c?.lang)} ${i}`}else if(e==="state_change"){let p=t.trigger_target_changes||1,u=l.trigger_current_value??null;if(u==null)return h;a=Math.min(100,Math.max(0,u/p*100)),n=`${it(u,c?.lang,0)} / ${it(p,c?.lang,0)}`}else if(e==="runtime"){let p=t.trigger_runtime_hours||100,u=l.trigger_current_value??null;if(u==null)return h;a=Math.min(100,Math.max(0,u/p*100)),n=`${it(u,c?.lang,1)}h / ${it(p,c?.lang)}h`}else if(e==="compound"){let p=t.compound_logic||t.operator||"AND",u=t.conditions?.length||0;n=`${p} (${u})`,a=l.trigger_active?100:0}else return h;let d=a>=100,o=a>90?"var(--error-color, #f44336)":a>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return r`
    <div class="trigger-progress">
      <div class="trigger-progress-bar">
        <div class="trigger-progress-fill${d?" overflow":""}" style="width:${a}%;background:${o}"></div>
      </div>
      <span class="trigger-progress-label">${n}${c?.trend?r` <i class="trend-arrow trend-${c.trend}" title="${s(`trend_${c.trend}`,c.lang??"en")}" aria-label="${s(`trend_${c.trend}`,c.lang??"en")}">${cs[c.trend]}</i>`:h}</span>
    </div>
  `}function Re(l,c,t){if(!l.trigger_config?.entity_id)return h;let e=l.trigger_config.entity_id,i=c.get(e)||[],a=[];if(i.length>=2)a=i.map(O=>({ts:O.ts,val:O.val}));else{if(!l.history)return h;for(let O of l.history)O.trigger_value!=null&&a.push({ts:new Date(O.timestamp).getTime(),val:O.trigger_value})}if(l.trigger_current_value!=null&&a.push({ts:Date.now(),val:l.trigger_current_value}),a.length<2)return h;a.sort((O,y)=>O.ts-y.ts);let n=ns,d=ls,o=a.map(O=>O.val),p=Math.min(...o),u=Math.max(...o),b=u-p||1;p-=b*.1,u+=b*.1;let _=a[0].ts,f=a[a.length-1].ts-_||1,R=O=>(O-_)/f*n,x=O=>2+(1-(O-p)/(u-p))*(d-4),M=a;if(M.length>Ei){let O=Math.ceil(M.length/Ei);M=M.filter((y,st)=>st%O===0||st===M.length-1)}let k=M.map(O=>`${E(R(O.ts))},${E(x(O.val))}`).join(" "),I=l.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return r`
    <svg class="mini-sparkline" viewBox="0 0 ${n} ${d}" preserveAspectRatio="none" role="img" aria-label="${s("chart_mini_sparkline",t)}">
      <polyline points="${k}" fill="none" stroke="${I}" stroke-width="1.5" stroke-linejoin="round" />
    </svg>
  `}function Ri(l,c){let t=c;if(l.days_until_due==null||!l.interval_days||l.interval_days<=0)return h;let{pct:e,overflow:i}=Zt(l.interval_days,l.days_until_due,l.interval_unit),a="var(--success-color, #4caf50)";return l.status==="overdue"?a="var(--error-color, #f44336)":l.status==="due_soon"&&(a="var(--warning-color, #ff9800)"),r`
    <div class="days-progress">
      <div class="days-progress-labels">
        <span>${l.last_performed?`${s("last_performed",t)}: ${Q(l.last_performed,t)}`:""}</span>
        <span>${l.next_due?`${s("next_due",t)}: ${Q(l.next_due,t)}`:""}</span>
      </div>
  ...
  `}var de=210,_t=46,kt=14,$t=12,Oi=14,ds=20+Oi,ps=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],et=class extends H{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(t=>{let e=Math.floor(t[0]?.contentRect?.width||0);e&&Math.abs(e-this._width)>2&&(this._width=e)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(t){t!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:t},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let t=this._width||320,e=[...this.points].sort((a,n)=>a.ts-n.ts),i=this.lang;return r`
    ...
    `}_renderSvg(t,e){let i=this.lang,a=t-_t-kt,n=de-ds,d=n-$t,o=1/0,p=-1/0;for(let T of e)o=Math.min(o,T.min??T.val),p=Math.max(p,T.max??T.val);this.thresholdAbove!=null&&(o=Math.min(o,this.thresholdAbove),p=Math.max(p,this.thresholdAbove)),this.thresholdBelow!=null&&(o=Math.min(o,this.thresholdBelow),p=Math.max(p,this.thresholdBelow)),this.targetValue!=null&&(o=Math.min(o,this.targetValue),p=Math.max(p,this.targetValue)),this.forceZero&&(o=Math.min(o,0));let u=(p-o||1)*.06,b=this.forceZero&&o>=0?0:o-u,{ticks:_,niceMin:v,niceMax:f}=Nt(b,p+u,4);this.forceZero&&o>=0&&v<0&&(v=0,_=_.filter(T=>T>=0));let R=e[0].ts,x=this.projection&&this.projection.length===2?this.projection[1].ts:null,M=x!=null?Math.max(e[e.length-1].ts,x):e[e.length-1].ts,k=M-R||1,I=ie(R,M),O=T=>_t+(T-R)/k*a,y=T=>$t+(1-(T-v)/(f-v||1))*d,st=e.map(T=>`${E(O(T.ts))},${E(y(T.val))}`).join(" "),ut=`M${E(O(e[0].ts))},${n} `+e.map(T=>`L${E(O(T.ts))},${E(y(T.val))}`).join(" ")+` L${E(O(e[e.length-1].ts))},${n} Z`,$="",N=e.filter(T=>T.min!=null&&T.max!=null);if(N.length>=2){let T=N.map(z=>`${E(O(z.ts))},${E(y(z.max))}`),j=[...N].reverse().map(z=>`${E(O(z.ts))},${E(y(z.min))}`);$=`M${T[0]} `+T.slice(1).map(z=>`L${z}`).join(" ")+` L${j.join(" L")} Z`}let F=[];if(this.thresholdBelow!=null){let T=y(this.thresholdBelow);F.push({y:T,h:Math.max(0,n-T),lineY:T,label:`\u25BC ${bt(this.thresholdBelow,i)}`,labelY:Math.min(n-4,T+13)})}if(this.thresholdAbove!=null){let T=y(this.thresholdAbove);F.push({y:$t,h:Math.max(0,T-$t),lineY:T,label:`\u25B2 ${bt(this.thresholdAbove,i)}`,labelY:Math.max($t+11,T-5)})}let P=e[e.length-1],Y=(this.events||[]).filter(T=>T.ts>=R&&T.ts<=M),X=se(R,M,Math.max(2,Math.min(5,Math.floor(a/110)+1))),W=this._hover;return r`
      <div class="svg-holder">
        <svg
          ...
          @pointermove=${T=>this._onPointer(T,e,O,y,t)}
          @pointerdown=${T=>this._onPointer(T,e,O,y,t)}
          @pointerleave=${()=>this._hover=null}
        >
          <defs>
            <clipPath id="plot"><rect x="${_t}" y="${$t}" width="${a}" height="${d}" /></clipPath>
            ${F.length?J`<clipPath id="danger">${F.map(T=>J`<rect x="${_t}" y="${E(T.y)}" width="${a}" height="${E(T.h)}" />`)}</clipPath>`:h}
          ...
          ${_.map(T=>{let j=y(T);return j<$t-1||j>n+1?h:J`
              <line x1="${_t}" y1="${E(j)}" x2="${t-kt}" y2="${E(j)}"
                stroke="var(--divider-color)" stroke-width="1" opacity="0.6" />
              <text x="${_t-7}" y="${E(j+3.5)}" text-anchor="end" class="tick-label">${bt(T,i)}</text>`})}

          ${F.map(T=>J`<rect x="${_t}" y="${E(T.y)}" width="${a}" height="${E(T.h)}"
          ...
          ${F.length?J`<polyline points="${st}" fill="none" stroke="var(--error-color, #f44336)" stroke-width="2"
                stroke-linejoin="round" stroke-linecap="round" clip-path="url(#danger)" />`:h}

          ${F.map(T=>J`
              <line x1="${_t}" y1="${E(T.lineY)}" x2="${t-kt}" y2="${E(T.lineY)}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${t-kt-4}" y="${E(T.labelY)}" text-anchor="end" class="zone-label">${T.label}</text>`)}

          ${this.targetValue!=null?J`<line x1="${_t}" y1="${E(y(this.targetValue))}" x2="${t-kt}" y2="${E(y(this.targetValue))}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${t-kt-4}" y="${E(y(this.targetValue)-5)}" text-anchor="end" class="zone-label">◆ ${bt(this.targetValue,i)} ${this.unit}</text>`:h}

          ${this.projection&&this.projection.length===2?J`<line x1="${E(O(this.projection[0].ts))}" y1="${E(y(this.projection[0].val))}"
                x2="${E(Math.min(O(this.projection[1].ts),t-kt))}" y2="${E(y(Math.max(v,Math.min(f,this.projection[1].val))))}"
                stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.8" />`:h}

          ${X.map((T,j)=>{let z=O(T),Mt=j===0?"start":j===X.length-1?"end":"middle";return J`<text x="${E(z)}" y="${de-5}" text-anchor="${Mt}" class="tick-label">${It(T,i,I)}</text>`})}

          <line x1="${_t}" y1="${n}" x2="${t-kt}" y2="${n}" stroke="var(--divider-color)" stroke-width="1" />

          ${Y.map(T=>{let j=O(T.ts),z=T.type==="completed"?"var(--success-color, #4caf50)":T.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return J`
              <line x1="${E(j)}" y1="${$t}" x2="${E(j)}" y2="${n}" stroke="${z}" stroke-width="1" opacity="0.14" />
              <rect x="${E(j-1.5)}" y="${n+3}" width="3" height="${Oi-6}" rx="1.5" fill="${z}">
                <title>${be(T.ts,i)}</title>
              </rect>`})}

          ${W?J`
                <line x1="${E(W.x)}" y1="${$t}" x2="${E(W.x)}" y2="${n}"
                  stroke="var(--secondary-text-color)" stroke-width="1" stroke-dasharray="3,3" opacity="0.7" />
                <circle cx="${E(W.x)}" cy="${E(W.y)}" r="4.5" fill="var(--primary-color)"
        ...
        ${W?r`<div
            ...
            >
              ...
              <div class="hover-val">
                ...
                ${W.p.min!=null&&W.p.max!=null?r`<span class="hover-range">(${bt(W.p.min,i)}–${bt(W.p.max,i)})</span>`:h}
              </div>
            </div>`:h}
      </div>
    `}_onPointer(t,e,i,a,n){let o=t.currentTarget.getBoundingClientRect(),p=(t.clientX-o.left)/o.width*n;if(p<_t-8||p>n-kt+8){this._hover=null;return}let u=e[0],b=1/0;for(let _ of e){let v=Math.abs(i(_.ts)-p);v<b&&(b=v,u=_)}this._hover={x:i(u.ts),y:a(u.val),p:u}}};et.styles=L`
  ...
  `,g([S({attribute:!1})],et.prototype,"points",2),g([S({attribute:!1})],et.prototype,"events",2),g([S()],et.prototype,"unit",2),g([S()],et.prototype,"lang",2),g([S({attribute:!1})],et.prototype,"thresholdAbove",2),g([S({attribute:!1})],et.prototype,"thresholdBelow",2),g([S({attribute:!1})],et.prototype,"targetValue",2),g([S({type:Boolean})],et.prototype,"forceZero",2),g([S({attribute:!1})],et.prototype,"projection",2),g([S({attribute:!1})],et.prototype,"rangeDays",2),g([S({type:Boolean})],et.prototype,"showRange",2),g([S({type:Boolean})],et.prototype,"busy",2),g([S({type:Boolean})],et.prototype,"hideOutliers",2),g([S({type:Boolean})],et.prototype,"showOutlierToggle",2),g([m()],et.prototype,"_width",2),g([m()],et.prototype,"_hover",2);customElements.get("maintenance-trigger-chart")||customElements.define("maintenance-trigger-chart",et);function Mi(l){let c=(l??"").trim().toLowerCase();return c==="on"||c==="open"||c==="true"?1:c==="off"||c==="closed"||c==="false"?0:null}function hs(l,c,t){if(l.length<2)return null;let e=t.now??Date.now(),i=Math.max(0,c.trigger_for_minutes??0)*6e4,a=c.trigger_from_state?Mi(c.trigger_from_state):null,n=c.trigger_to_state?Mi(c.trigger_to_state):null;if(c.trigger_from_state&&a===null||c.trigger_to_state&&n===null)return null;let d=[...l].sort((k,I)=>k.ts-I.ts),o=[];for(let k of d){let I=o[o.length-1];(!I||I.level!==k.val)&&o.push({start:k.ts,level:k.val})}let p=k=>(k+1<o.length?o[k+1].start:e)-o[k].start>=i,u=(k,I,O)=>{let y=k[k.length-1];y&&y.val!==O&&k.push({ts:I,val:y.val}),k.push({ts:I,val:O})};if((c.trigger_target_changes??1)===1&&n!==null){let k=[];o.forEach((O,y)=>u(k,O.start,O.level===n&&p(y)?1:0));let I=k[k.length-1]?.val??0;return k.push({ts:e,val:I}),{points:k,mode:"alarm"}}let _=t.since??o[0].start,v=0,f=[];for(let k=1;k<o.length;k++){let I=o[k-1],O=o[k];a!==null&&I.level!==a||n!==null&&O.level!==n||!p(k)||O.start<_||(v+=1,f.push(O.start))}let R=Math.max(0,(t.current??v)-v),x=[{ts:Math.max(_,o[0].start),val:R}],M=R;for(let k of f)M+=1,u(x,k,M);return x.push({ts:e,val:M}),{points:x,mode:"count"}}function us(l){if(l.length<4)return l;let c=l.map(p=>p.val).sort((p,u)=>p-u),t=p=>{let u=(c.length-1)*p,b=Math.floor(u),_=Math.ceil(u);return c[b]+(c[_]-c[b])*(u-b)},e=t(.25),i=t(.75),a=i-e;if(a===0)return l;let n=e-1.5*a,d=i+1.5*a,o=l.filter(p=>p.val>=n&&p.val<=d);return o.length>=2?o:l}function Ci(l,c){let t=l.trigger_config;if(!t)return h;let e=c.lang,i=l.trigger_entity_info,a=l.trigger_entity_infos,n=i?.friendly_name||t.entity_id||"\u2014",d=t.entity_id||"",o=t.entity_ids||(d?[d]:[]),p=i?.unit_of_measurement||"",u=l.trigger_current_value,b=t.type||"threshold",_=o.length>1,v=gs(l,p,c);return r`
    <h3>${s("trigger",e)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${_?r`
            <div class="trigger-entity-name">${o.length} ${s("entities",e)} (${t.entity_logic||"any"})</div>
            <div class="trigger-entity-id">${o.map((f,R)=>r`${R>0?", ":""}<span class="entity-link" @click=${x=>Ht(x,f)}>${f}</span>`)}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `:r`
            <div class="trigger-entity-name">${n}</div>
            <div class="trigger-entity-id">${d?r`<span class="entity-link" @click=${f=>Ht(f,d)}>${d}</span>`:""}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `}
        </div>
      ...
      ${v?ms(v,e):u!=null?r`
              <div class="trigger-value-row">
                ...
                ${p?r`<span class="trigger-unit">${p}</span>`:h}
              </div>
            `:h}

      <div class="trigger-limits">
        ${b==="threshold"?r`
          ${t.trigger_above!=null?r`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${s("threshold_above",e)}: ${t.trigger_above} ${p}</span>`:h}
          ${t.trigger_below!=null?r`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${s("threshold_below",e)}: ${t.trigger_below} ${p}</span>`:h}
          ${t.trigger_equals!=null?r`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> = ${t.trigger_equals} ${p}</span>`:h}
          ${t.trigger_not_equals!=null?r`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ≠ ${t.trigger_not_equals} ${p}</span>`:h}
          ${t.trigger_for_minutes?r`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${s("for_minutes",e)}: ${t.trigger_for_minutes}</span>`:h}
        `:h}
        ${b==="state_change"?r`
          ${t.trigger_target_changes!=null?r`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${s("target_changes",e)}: ${t.trigger_target_changes}</span>`:h}
        `:h}
        ${b==="runtime"?r`
          ${t.trigger_runtime_hours!=null?r`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${s("runtime_hours",e)}: ${t.trigger_runtime_hours}h</span>`:h}
        `:h}
        ${b==="compound"?r`
          ...
          ${(t.conditions||[]).map((f,R)=>r`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${R+1}. ${s(f.type||"unknown",e)}: ${f.entity_id?r`<span class="entity-link" @click=${x=>Ht(x,f.entity_id)}>${f.entity_id}</span>`:""}</span>
          `)}
        `:h}
      </div>
      ...
      ${a&&a.length>1?r`
        <div class="trigger-entity-list">
          ${a.map(f=>r`
            <span class="trigger-entity-id">${f.friendly_name} (<span class="entity-link" @click=${R=>Ht(R,f.entity_id)}>${f.entity_id}</span>)</span>
          `)}
        </div>
      `:h}
  ...
  `}function gs(l,c,t){let e=l.trigger_config,i=l.trigger_current_value;if(!e||i==null)return null;switch(e.type||"threshold"){case"counter":{let a=e.trigger_target_value;if(a==null||a<=0)return null;if(!e.trigger_delta_mode)return{progress:Math.max(0,i),target:a,unit:c,meter:null};let n=Di(l,Ai(l,t));return{progress:Math.max(0,i-(n?.value??i)),target:a,unit:c,meter:i}}case"state_change":{let a=e.trigger_target_changes;return a==null||a<=0?null:{progress:Math.max(0,i),target:a,unit:"",meter:null}}case"runtime":{let a=e.trigger_runtime_hours;return a==null||a<=0?null:{progress:Math.max(0,i),target:a,unit:"h",meter:null}}}return null}function Di(l,c){if(l.trigger_baseline_value!=null)return{value:l.trigger_baseline_value,ts:pe(l)};if(!c.length)return null;let t=pe(l);if(t==null)return{value:c[0].val,ts:null};let e=c[0],i=Math.abs(c[0].ts-t);for(let a of c){let n=Math.abs(a.ts-t);n<i&&(e=a,i=n)}return{value:e.val,ts:t}}function pe(l){let c=[...l.history].filter(t=>t.type==="completed"||t.type==="reset").sort((t,e)=>new Date(e.timestamp).getTime()-new Date(t.timestamp).getTime())[0];return c?new Date(c.timestamp).getTime():null}function ms(l,c){let t=Math.min(999,Math.round(l.progress/l.target*100)),e=t>=100?"over":t>=75?"near":"ok";return r`
    <div class="counter-progress">
      ...
      <div class="counter-progress-caption">
        ${s("chart_since_service",c)}${l.meter!=null?r` · ${s("current",c)}: ${Et(l.meter,l.unit,c)}`:h}
      </div>
    </div>
  `}function Ai(l,c){let t=l.trigger_config;if(!t)return[];let e=t.type||"threshold",i=t.entity_id||"",a=e==="runtime"?[]:c.detailStatsData.get(i)||[],n=c.isCounterEntity(t),d=[];if(a.length>=2)for(let p of a){let u={ts:p.ts,val:p.val};!n&&p.min!=null&&p.max!=null&&(u.min=p.min,u.max=p.max),d.push(u)}else for(let p of l.history)p.trigger_value!=null&&d.push({ts:new Date(p.timestamp).getTime(),val:p.trigger_value});let o=!!i&&!!c.historyFallbackIds?.has(i)&&a.length>=2;return l.trigger_current_value!=null&&!o&&d.push({ts:Date.now(),val:l.trigger_current_value}),d.sort((p,u)=>p.ts-u.ts),d}function _s(l,c,t){let e=l.trigger_config;if(!e)return h;let i=e.type||"threshold",a=e.entity_id||"",n=Ai(l,t),d=null;i==="state_change"&&a&&t.historyFallbackIds?.has(a)&&(d=hs(n,e,{since:pe(l),current:l.trigger_current_value??null}),d&&(n=d.points)),i==="runtime"&&e.trigger_runtime_hours&&l.trigger_current_value!=null&&(n=[{ts:pe(l)??n[0]?.ts??Date.now()-864e5,val:0},{ts:Date.now(),val:Math.max(0,l.trigger_current_value)}]),t.hideOutliers&&(n=us(n));let o=n.length<2&&!!a&&t.hasStatsService&&!t.detailStatsData.has(a);if(n.length<2&&!o)return h;let p=!!a&&t.detailStatsData.has(a)&&(t.detailStatsData.get(a)?.length??0)<2,u=Date.now()-t.rangeDays*864e5,b=n.filter(k=>k.ts>=u);b.length>=2&&(n=b);let _=null,v=!1;if(i==="counter"&&e.trigger_target_value!=null&&n.length){if(e.trigger_delta_mode){let k=Di(l,n);if(k){if(k.ts!=null){let I=n.filter(O=>O.ts>=k.ts);I.length>=2&&(n=I)}n=n.map(I=>({...I,val:Math.max(0,I.val-k.value)}))}}_=e.trigger_target_value,v=!0}else i==="state_change"&&e.trigger_target_changes&&d?.mode!=="alarm"?(_=e.trigger_target_changes,v=!0):i==="runtime"&&e.trigger_runtime_hours&&(_=e.trigger_runtime_hours,v=!0);let f=null,R=l.degradation_rate,x=R!=null&&(e.trigger_below!=null&&e.trigger_above==null&&R>0||e.trigger_above!=null&&e.trigger_below==null&&R<0);if(_==null&&R!=null&&!x&&(l.degradation_trend!=="stable"||l.days_until_threshold!=null)&&l.degradation_trend!=="insufficient_data"&&n.length>=2){let k=n[n.length-1];f=[k,{ts:k.ts+30*864e5,val:k.val+R*30}]}let M=l.history.filter(k=>["completed","skipped","reset"].includes(k.type)).map(k=>({ts:new Date(k.timestamp).getTime(),type:k.type}));return r`
    ...
    ></maintenance-trigger-chart>
    ${o?h:a&&t.historyFallbackIds?.has(a)&&!p?r`<div class="chart-note">
          <ha-icon icon="mdi:information-outline"></ha-icon>
          ${s(d?.mode==="alarm"?"chart_history_alarm":d?.mode==="count"?"chart_history_count":"chart_history_fallback",t.lang)}
        </div>`:p?r`<div class="chart-note">
          <ha-icon icon="mdi:information-outline"></ha-icon>
          ${s("chart_no_stats",t.lang)}
        </div>`:h}
  `}var bs=200,Vt=10,vs=22;function Ii(l,c,t,e,i){let a=l.history.filter(o=>o.type==="completed"&&(o.cost!=null||o.duration!=null));if(a.length<2)return h;let n=a.some(o=>(o.cost??0)>0),d=a.some(o=>(o.duration??0)>0);return!n&&!d?h:r`
  ...
  `}function fs(l,c,t,e){let i=l.history.filter(j=>j.type==="completed"&&(j.cost!=null||j.duration!=null)).map(j=>({ts:new Date(j.timestamp).getTime(),cost:j.cost??0,duration:j.duration??0})).sort((j,z)=>j.ts-z.ts);if(i.length<2)return h;let a=i.some(j=>j.cost>0),n=i.some(j=>j.duration>0);if(!a&&!n)return h;let d=t!=="duration"&&a,o=t!=="cost"&&n,p=d||!o&&a,u=o||!d&&n,b=640,_=bs,v=p?44:12,f=u?44:12,R=b-v-f,x=_-vs,M=x-Vt,k=i[0].ts,I=i[i.length-1].ts,O=(I-k||864e5)*.05,y=k-O,st=I+O,ut=ie(k,I),$=j=>v+(j-y)/(st-y)*R,N=Nt(0,Math.max(...i.map(j=>j.cost))||1,3),F=Nt(0,Math.max(...i.map(j=>j.duration))||1,3),P=j=>Vt+(1-j/(N.niceMax||1))*M,Y=j=>Vt+(1-j/(F.niceMax||1))*M,X=i.length>1?Math.min(...i.slice(1).map((j,z)=>$(j.ts)-$(i[z].ts))):R,W=Math.max(6,Math.min(22,X*.55)),T=se(k,I,Math.max(2,Math.min(4,i.length)));return r`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${b} ${_}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_history",c)}">
        ${p?N.ticks.map(j=>{let z=P(j);return z<Vt-1||z>x+1?h:J`
            <line x1="${v}" y1="${E(z)}" x2="${b-f}" y2="${E(z)}" stroke="var(--divider-color)" stroke-width="1" opacity="0.55" />
            <text x="${v-6}" y="${E(z+3.5)}" text-anchor="end" fill="var(--primary-color)" font-size="10.5">${bt(j,c)}${e}</text>`}):h}
        ${u?F.ticks.map(j=>{let z=Y(j);return z<Vt-1||z>x+1?h:J`<text x="${b-f+6}" y="${E(z+3.5)}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="10.5">${bt(j,c)}m</text>`}):h}

        ${p?i.filter(j=>j.cost>0).map(j=>J`
          <rect x="${E($(j.ts)-W/2)}" y="${E(P(j.cost))}" width="${E(W)}" height="${E(x-P(j.cost))}"
            fill="var(--primary-color)" opacity="0.6" rx="2">
            <title>${It(j.ts,c,!0)}: ${K(j.cost,e,c)}${j.duration?` \xB7 ${j.duration}m`:""}</title>
          </rect>
        `):h}
        ${u?J`
          <polyline points="${i.map(j=>`${E($(j.ts))},${E(Y(j.duration))}`).join(" ")}"
            fill="none" stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-linejoin="round" />
          ${i.map(j=>J`
            <circle cx="${E($(j.ts))}" cy="${E(Y(j.duration))}" r="3.5" fill="var(--accent-color, #ff9800)">
              <title>${It(j.ts,c,!0)}: ${j.duration}m${j.cost?` \xB7 ${K(j.cost,e,c)}`:""}</title>
            </circle>
          `)}
        `:h}

        <line x1="${v}" y1="${x}" x2="${b-f}" y2="${x}" stroke="var(--divider-color)" stroke-width="1" />
        ${T.map((j,z)=>{let Mt=z===0?"start":z===T.length-1?"end":"middle";return J`<text x="${E($(j))}" y="${_-6}" text-anchor="${Mt}" fill="var(--secondary-text-color)" font-size="10">${It(j,c,ut)}</text>`})}
      </svg>
    </div>
    <div class="chart-legend">
      ${p?r`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color);opacity:0.6"></span>${s("cost",c)}</span>`:h}
      ${u?r`<span class="legend-item"><span class="legend-swatch" style="background:var(--accent-color, #ff9800)"></span>${s("duration",c)}</span>`:h}
    </div>
  `}function Oe(l,c,t){if(!l.responsible_user_id)return h;let e=t?.(l.responsible_user_id)??null;if(e)return r`<span class="user-badge">${Qe(e)}${e.name}</span>`;let i=c(l.responsible_user_id);return i?r`
    <span class="user-badge">
      <ha-icon icon="mdi:account"></ha-icon>
      ${i}
    </span>
  `:h}function ys(l,c){let t=c.lang,e=c.isOperator,i=l.archived?"archived":l.is_done?"done":l.status==="due_soon"?"warning":l.status||"ok",a=l.archived?s("archived",t):l.is_done?s("completed",t):s(l.status||"ok",t);return r`
    <div class="task-header">
      <div class="task-header-title">
        <span class="task-name-breadcrumb" @click=${()=>c.showTaskView()}>${l.name}</span>
        ${Dt(c.taskRef??null,s("ref_number",t))}
        <span class="breadcrumb-separator">·</span>
        <span class="object-name-breadcrumb" @click=${()=>c.showObject()}>${c.objectName}</span>
        <span class="status-chip ${i}">${a}</span>
        ${l.due_override?r`<span class="postponed-badge" title="${s("postponed_to",t)}">
          <ha-icon icon="mdi:calendar-arrow-right"></ha-icon>${Q(l.due_override,t)}
        </span>`:h}
        ${Oe(l,c.getUserName,c.getPerson)}
        ${l.notify_enabled===!1?r`<span class="nfc-badge muted-badge" title="${s("no_notifications",t)}"><ha-icon icon="mdi:bell-off-outline"></ha-icon></span>`:h}
        ${l.mirror_todo_entities?.length?r`<span class="nfc-badge mirror-badge" title="${s("task_mirror_todo",t)}: ${l.mirror_todo_entities.map(n=>String(c.hass?.states?.[n]?.attributes?.friendly_name??n)).join(", ")}"><ha-icon icon="mdi:clipboard-list-outline"></ha-icon></span>`:h}
        ${l.nfc_tag_id?r`<span class="nfc-badge" title="${s("nfc_tag_id",t)}: ${l.nfc_tag_id}"><ha-icon icon="mdi:nfc-variant"></ha-icon> NFC</span>`:e?h:r`<span class="nfc-badge unlinked" title="${s("nfc_link_hint",t)}"
              @click=${()=>c.openEdit(l)}>
              <ha-icon icon="mdi:nfc-variant"></ha-icon>
            </span>`}
      </div>
      <div class="task-header-actions">
        <ha-button appearance="accent" variant="success" @click=${()=>c.openComplete(l)}>${s("complete",t)}</ha-button>
        ${l.allow_skip!==!1?r`<ha-button appearance="outlined" variant="warning" .disabled=${c.actionLoading} @click=${()=>c.promptSkip()}>${s("skip",t)}</ha-button>`:h}
        <div class="more-menu-wrapper">
          ...
          ${c.moreMenuOpen?r`
            <div class="popup-menu" @click=${n=>n.stopPropagation()}>
              ${e?h:r`
                <div class="popup-menu-item" @click=${()=>{c.closeMoreMenu(),c.openEdit(l)}}>${s("edit",t)}</div>
              `}
              <div class="popup-menu-item" @click=${()=>{c.closeMoreMenu(),c.openQr(l.name)}}>${s("qr_code",t)}</div>
              ...
              ${e?h:r`
                ...
                <div class="popup-menu-item" @click=${()=>c.moveTask()}>${s("move_task",t)}</div>
                ...
                <div class="popup-menu-item" @click=${()=>{c.closeMoreMenu(),c.toggleArchive(!!l.archived)}}>${l.archived?s("unarchive",t):s("archive",t)}</div>
  ...
  `}function xs(l){let c=l.lang;return r`
    <div class="tab-bar">
  ...
  `}function Pi(l,c,t,e){let i=e.collapsedSections.has(l);return r`
  ...
  `}function ws(l,c){if(!We(l))return h;let t=c.lang,e=l.phase_sequence,i=Ue(l.phase_cursor,e.length),a=new Map;for(let n=l.history.length-1;n>=0;n--){let d=l.history[n];d.phase_id&&d.type==="completed"&&!a.has(d.phase_id)&&a.set(d.phase_id,d.timestamp)}return r`
    <div class="phases-card">
      ...
      <div class="phases-strip">
        ${e.map((n,d)=>{let o=l.phases?.[n]?.name||n,p=a.get(n);return r`
            <div class="phase-step ${d===i?"current":""}"
              title=${d===i?s("phase_current",t):s("phase_set",t)}
              @click=${()=>{d!==i&&c.setPhaseCursor(d)}}>
              <span class="phase-step-name">${d+1}. ${o}</span>
              ${p?r`<span class="phase-step-last">${Q(p,t)}</span>`:h}
            </div>
          `})}
      </div>
    </div>
  `}function ks(l,c){if(!c.features.checklists)return h;let t=ee(l)?.checklist??(l.checklist||[]);if(t.length===0)return h;let e=c.lang,i=l.checklist_progress||{},a=t.filter(n=>i[n]).length;return r`
  ...
  `}function $s(l,c){let t=at(l.documentation_url)?l.documentation_url:null,e=at(c.objectDocUrl)?c.objectDocUrl:null,i=e?null:(c.objectManualDocs||[])[0];if(!l.notes&&!t&&!e&&!i)return h;let a=c.lang;return r`
  ...
  `}function js(l,c){let t=c.lang,e=l.times_performed>0?l.total_cost/l.times_performed:0,i=l.days_until_due!==null&&l.days_until_due!==void 0?l.days_until_due<0?"overdue":l.days_until_due<=l.warning_days?"warning":"":"";return r`
    <div class="kpi-bar">
      <div class="kpi-card">
        <div class="kpi-label">${s("next_due",t)}</div>
        <div class="kpi-value">${l.next_due?Q(l.next_due,t):"\u2014"}</div>
        ${c.features.schedule_time&&l.schedule_time?r`<div class="kpi-subtext">${s("at_time",t)} ${l.schedule_time}</div>`:h}
      </div>
      ...
      <div class="kpi-card">
        ...
        ${c.features.adaptive&&l.suggested_interval&&l.suggested_interval!==l.interval_days?r`
  ...
  `}function Ts(l,c){let t=c.lang;if(!c.features.adaptive||!l.suggested_interval||l.suggested_interval===l.interval_days)return h;if(c.suggestionDismissed)return h;let e=l.suggested_interval;return r`
  ...
  `}function Ss(l,c){let t=c.lang,e=l.history.slice(-3).reverse();return e.length===0?h:r`
  ...
  `}function Es(l,c){let t=c.lang,e=c.features.adaptive&&l.suggested_interval&&l.suggested_interval!==l.interval_days,i=c.features.seasonal&&l.seasonal_factor&&l.seasonal_factor!==1,a=e||i,n=c.features.adaptive&&l.interval_analysis?.weibull_beta!=null&&l.interval_analysis?.weibull_eta!=null,d=c.features.seasonal&&(l.seasonal_factors?.length===12||l.interval_analysis?.seasonal_factors?.length===12);return r`
    <div class="tab-content overview-tab">
      ${l.battery_fleet_task?r`<maintenance-battery-fleet-section .hass=${c.hass}></maintenance-battery-fleet-section>`:h}
      ${js(l,c)}
      ${$s(l,c)}
      ...
      <div class="two-column-layout ${a?"":"single-column"}">
        ...
        <div class="right-column">
          ${Ii(l,t,c.costDurationToggle,o=>c.setCostDurationToggle(o),c.currencySymbol)}
        </div>
      </div>
      ${n?Pi("weibull","weibull_reliability_curve",ci(l,t),c):h}
      ${d?Pi("seasonal","seasonal_chart_title",r`
            ${ui(l,t)}
  ...
  `}function Os(l,c){switch(c.activeTab){case"overview":return Es(l,c);case"history":return Rs(l,c);default:return h}}function zi(l,c){return r`
  ...
  `}var Ut=class extends H{createRenderRoot(){return this}render(){return!this.task||!this.ctx?h:r`${zi(this.task,this.ctx)}`}};g([S({attribute:!1})],Ut.prototype,"task",2),g([S({attribute:!1})],Ut.prototype,"ctx",2);customElements.get("maintenance-task-detail-view")||customElements.define("maintenance-task-detail-view",Ut);function Li(l){if(l.total<=0)return{start:0,end:0,padTop:0,padBottom:0};let c=l.overscan??12,t=Math.max(1,l.step??6),e=Math.max(1,l.rowHeight),i=Math.floor((l.scrollTop-l.listTop)/e),a=Math.ceil(l.viewportHeight/e)+1,n=Math.max(0,i-c);n=Math.floor(n/t)*t;let d=Math.min(l.total,Math.max(i,0)+a+c);return d=Math.min(l.total,Math.ceil(d/t)*t),n>=d&&(n=Math.min(n,Math.max(0,l.total-1)),d=Math.min(l.total,n+Math.max(a,1))),{start:n,end:d,padTop:n*e,padBottom:(l.total-d)*e}}var he={mode:"top",marginTop:0,lastScrollTop:0};function Hi(l,c){return l==="top"?8:c.viewH-c.paneH-8}function Bi(l){let c=l.scrollTop+8-l.layoutTop,t=Math.max(0,l.listH-l.paneH);return{mode:"top",marginTop:c>t?Math.max(0,c):0,lastScrollTop:l.scrollTop}}function Ni(l,c){let t=c.scrollTop,e=c.scrollTop>l.lastScrollTop?"down":c.scrollTop<l.lastScrollTop?"up":"none",i=Math.max(0,c.listH-c.paneH),a=c.paneH+16<=c.viewH||c.listH<=c.paneH,{mode:n,marginTop:d}=l;if(a&&(n="top"),n==="top"&&d>0&&e==="up")d=Math.max(0,Math.min(d,c.scrollTop+8-c.layoutTop)),d<=i&&(d=0);else if(!a&&e==="down"&&n==="top"){let o=c.renderedTop-c.layoutTop;o<=i&&(n="bottom",d=Math.max(0,o))}else!a&&e==="up"&&n==="bottom"&&(d=Math.min(Math.max(0,c.renderedTop-c.layoutTop),i),c.scrollTop+8<=c.layoutTop+d&&(n="top",d=0));return{mode:n,marginTop:d,lastScrollTop:t}}var ue=2,Cs=250,Ot={objects:6,tasks:10,parts:6,documents:8,history:6},Ds="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Me=["due_date","object","type","task_name","area","assigned_user","group"],Fi=["none","area","group","user","object"],As=["overdue","due_soon","triggered","ok"],qi=["tasks","documents","parts","history"],w=class extends H{constructor(){super(...arguments);this.narrow=!1;this.tight=!1;this.split=!1;this._tightObserver=null;this.panel={};this.embedded=!1;this.presets={};this._presetsApplied=!1;this._mountPath=null;this._objects=[];this._stats=null;this._view="overview";this._allParts=null;this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._filterLabel=null;this._filterPriority="";this._savedViews=[];this._activeViewId="";this._unsub=null;this._chartRangeDays=(()=>{try{let t=parseInt(Z(D.chartRange)||"",10);return[7,30,90,365].includes(t)?t:30}catch{return 30}})();this._hideOutliers=(()=>{try{return Z(D.chartHideOutliers)==="1"}catch{return!1}})();this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._operatorWriteEnabled=!1;this._defaultWarningDays=7;this._rowActionStyle="buttons_compact";this._refsInLists=!1;this._rowActionNotice=!1;this._actionLoading=!1;this._moreMenuOpen=!1;this._objMenuOpen=!1;this._toastMessage="";this._toastUndo=null;this._toastActionLabel="";this._filtersOpen=!1;this._newMenuOpen=!1;this._gsSetupsCount=0;this._gsAdoptCount=0;this._gsLoaded=!1;this._batteryFleetSetupAvailable=!1;this._staleBundle=!1;this._staleChecked=!1;this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab=(()=>{try{let t=Z(D.overviewTab);return t==="today"||t==="calendar"?t:"dashboard"}catch{return"dashboard"}})();this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._objectViewMode="cards";this._objectsTableColumns=Fe;this._showArchived=!1;this._bulkMode=!1;this._bulkSelected=new Set;this._objBulkMode=!1;this._objBulkSelected=new Set;this._bulkMenuOpen=!1;this._virtStart=0;this._virtEnd=0;this._virtRowHeight=53;this._virtTotalRows=0;this._virtScrollAttached=!1;this._virtRaf=0;this._stickyState=he;this._stickySelectPending=!1;this._stickyRaf=0;this._stickyAttached=!1;this._stickyObserver=null;this._collapsedGroups=new Set;this._collapsedSections=(()=>{try{return new Set(JSON.parse(Z(D.collapsedSections)||"[]"))}catch{return new Set}})();this._objectSectionsCollapsed=(()=>{try{let t=JSON.parse(Z(D.objectSections)||"[]");return new Set((Array.isArray(t)?t:[]).filter(e=>qi.includes(e)))}catch{return new Set}})();this._objectSectionOverride=null;this._paletteOpen=!1;this._paletteQuery="";this._paletteActive=0;this._searchRemote=null;this._searchTimer=null;this._searchSeq=0;this._templateGalleryOpen=!1;this._templates=[];this._templateCategories={};this._templateBusy=!1;this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=t=>this._onPopState(t);this._locationChangedHandler=()=>this._onLocationChanged();this._lazyUi=null;this._onStickyScroll=()=>{this._stickyRaf||(this._stickyRaf=requestAnimationFrame(()=>{this._stickyRaf=0,this._updateStickyPane()}))};this._onVirtualScroll=()=>{this._virtRaf||(this._virtRaf=requestAnimationFrame(()=>{this._virtRaf=0,this._updateVirtualWindow()}))};this._deepLinkHandled=!1;this._deepLinkInPlace=!1;this._initialLoadDone=!1;this._kpiRefreshInFlight=!1;this._kpiRefreshPending=!1;this._paletteKeydown=t=>{if(t.key==="/"&&!t.ctrlKey&&!t.metaKey&&!t.altKey&&!this._paletteOpen){let i=t.composedPath()[0];if(i instanceof HTMLElement&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.tagName==="SELECT"||i.isContentEditable))return;t.preventDefault(),this._openPalette();return}if(!this._paletteOpen)return;let e=this._paletteResults;if(t.key==="Escape")t.preventDefault(),this._closePalette();else if(t.key==="ArrowDown")t.preventDefault(),this._paletteActive=Math.min(this._paletteActive+1,e.length-1);else if(t.key==="ArrowUp")t.preventDefault(),this._paletteActive=Math.max(this._paletteActive-1,0);else if(t.key==="Enter"){t.preventDefault();let i=e[this._paletteActive];i&&this._selectPaletteResult(i)}};this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=t=>{let e=t.detail;e?.type==="maintenance-supporter:open-task"&&e.entry_id&&e.task_id&&(t.stopPropagation(),this._showTask(e.entry_id,e.task_id))};this._fullHistory=null;this._onHistoryEntrySaved=async()=>{await this._loadData()}}get _currencySymbol(){return Kt(this._budget)}get _lang(){return U(this.hass)}get _isOperator(){let t=this.hass?.user;return t?t.is_admin?!1:!(this._operatorWriteEnabled&&this._adminPanelUserIds.includes(t.id)):!0}_ensureLazyUi(){return this._lazyUi||(this._lazyUi=Promise.all([import("/maintenance_supporter_panelfiles/panel-chunks/object-dialog-GD4U5DIY.js"),import("/maintenance_supporter_panelfiles/panel-chunks/task-dialog-AOPRQNRI.js"),import("/maintenance_supporter_panelfiles/panel-chunks/complete-dialog-4RUZZVM3.js"),import("/maintenance_supporter_panelfiles/panel-chunks/qr-dialog-ZQG2O72E.js"),import("/maintenance_supporter_panelfiles/panel-chunks/adopt-problem-sensors-dialog-YOSPIPSF.js"),import("/maintenance_supporter_panelfiles/panel-chunks/suggested-setups-dialog-JCV6DSEW.js"),import("/maintenance_supporter_panelfiles/panel-chunks/settings-view-PU2VMIUH.js")]).then(()=>this.updateComplete)),this._lazyUi}async _ui(t){return await this._ensureLazyUi(),this.shadowRoot?.querySelector(t)??null}connectedCallback(){super.connectedCallback(),this._mountPath=window.location.pathname;let t=window.requestIdleCallback,e=()=>this._ensureLazyUi();t?t(e,{timeout:3e3}):window.setTimeout(e,1500),window.addEventListener("popstate",this._popstateHandler),window.addEventListener("location-changed",this._locationChangedHandler),window.addEventListener("keydown",this._paletteKeydown),typeof ResizeObserver<"u"&&(this._tightObserver=new ResizeObserver(i=>{let a=i[0]?.contentRect.width??0;a>0&&(this.tight=a<1e3),a>0&&(this.split=a>=1500)}),this._tightObserver.observe(this)),window.addEventListener("resize",this._onVirtualScroll,{passive:!0});try{let i=Z(D.taskSort);i&&Me.includes(i)&&(this._sortMode=i);let a=Z(D.objectSort);a&&["alphabetical","due_soonest","task_count"].includes(a)&&(this._objectSortMode=a);let n=Z(D.groupBy);n&&Fi.includes(n)&&(this._groupByMode=n);let d=Z(D.objectView);(d==="cards"||d==="table")&&(this._objectViewMode=d)}catch{}if(this._objects.length===0){let i=vi();i&&(this._objects=i.objects,i.stats&&(this._stats=i.stats))}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),window.removeEventListener("location-changed",this._locationChangedHandler),window.removeEventListener("keydown",this._paletteKeydown),this._tightObserver?.disconnect(),this._tightObserver=null,window.removeEventListener("resize",this._onVirtualScroll),this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onVirtualScroll),this._virtScrollAttached=!1,this._virtRaf&&cancelAnimationFrame(this._virtRaf),this._detachStickyPane(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._initialLoadDone=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=null),this._toastTimer&&(clearTimeout(this._toastTimer),this._toastTimer=null),this._toastMessage="",this._toastUndo=null,this._toastActionLabel="",this._statsService?.clearCache(),this._statsService=null}willUpdate(t){super.willUpdate(t),t.has("_groupByMode")&&this._collapsedGroups.size>0&&(this._collapsedGroups=new Set)}updated(t){if(super.updated(t),At(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new ae(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new Je(this.hass),this._userService.getUsers())}let e=this.shadowRoot?.querySelector(".content");e&&!this._virtScrollAttached&&(e.addEventListener("scroll",this._onVirtualScroll,{passive:!0}),this._virtScrollAttached=!0),this._updateVirtualWindow(),this._syncStickyPane(e)}_syncStickyPane(t){let e=this.shadowRoot?.querySelector(".split-pane");if(!e||!t){this._stickyAttached&&this._detachStickyPane();return}this._stickyAttached||(t.addEventListener("scroll",this._onStickyScroll,{passive:!0}),window.addEventListener("resize",this._onStickyScroll),typeof ResizeObserver<"u"&&(this._stickyObserver=new ResizeObserver(this._onStickyScroll)),this._stickyAttached=!0),this._stickyObserver?.observe(e),this._updateStickyPane()}_detachStickyPane(){this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onStickyScroll),window.removeEventListener("resize",this._onStickyScroll),this._stickyObserver?.disconnect(),this._stickyObserver=null,this._stickyRaf&&cancelAnimationFrame(this._stickyRaf),this._stickyRaf=0,this._stickyAttached=!1,this._stickyState=he,this._stickySelectPending=!1}_updateStickyPane(){let t=this.shadowRoot,e=t?.querySelector(".content"),i=t?.querySelector(".split-pane"),a=t?.querySelector(".split-layout"),n=t?.querySelector(".split-list");if(!e||!i||!a||!n)return;let d=e.getBoundingClientRect().top-e.scrollTop,o={scrollTop:e.scrollTop,viewH:e.clientHeight,paneH:i.offsetHeight,listH:n.offsetHeight,layoutTop:a.getBoundingClientRect().top-d,renderedTop:i.getBoundingClientRect().top-d};this._stickySelectPending&&o.scrollTop===this._stickyState.lastScrollTop?this._stickyState=Bi(o):(this._stickySelectPending=!1,this._stickyState=Ni(this._stickyState,o));let p=this._stickyState;i.style.top=`${Hi(p.mode,o)}px`,i.style.marginTop=p.marginTop>0?`${p.marginTop}px`:""}_resetStickyPane(){let t=this.shadowRoot?.querySelector(".content");this._stickyState={...he,lastScrollTop:t?.scrollTop??0},this._stickySelectPending=!0}_updateVirtualWindow(){let t=this.shadowRoot?.querySelector(".content"),e=this.shadowRoot?.querySelector(".task-table.virtual");if(!t||!e)return;let i=e.querySelector(".task-row:not(.virt-sizer)");i&&i.offsetHeight>20&&(this._virtRowHeight=i.offsetHeight);let a=e.getBoundingClientRect().top-t.getBoundingClientRect().top+t.scrollTop,n=Li({scrollTop:t.scrollTop,viewportHeight:t.clientHeight,listTop:a,rowHeight:this._virtRowHeight,total:this._virtTotalRows});(n.start!==this._virtStart||n.end!==this._virtEnd)&&(this._virtStart=n.start,this._virtEnd=n.end)}async _loadData(){let[t,e,i,a,n,d]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"}).catch(()=>null)]);if(d&&(this._savedViews=d.views||[]),t&&(this._objects=qt(t.objects),xe(this._objects,e??this._stats??null),this._maybeLoadGettingStarted()),this._detailOpen()&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/status"}).then(o=>{this._batteryFleetSetupAvailable=!!o.available&&!o.configured}).catch(()=>{this._batteryFleetSetupAvailable=!1}),this._staleChecked||(this._staleChecked=!0,this.hass.connection.sendMessagePromise({type:"maintenance_supporter/version"}).then(o=>{this._staleBundle=Ce(o?.version)}).catch(()=>{})),e&&(this._stats=e),i&&(this._budget=i,zt(this._budget)),a&&(this._groups=a.groups||{}),n){let o=n;this._features=o.features,this._adminPanelUserIds=o.admin_panel_user_ids||[],this._operatorWriteEnabled=o.operator_write_enabled??!1;let p=o.general?.default_warning_days;typeof p=="number"&&p>=0&&p<=365&&(this._defaultWarningDays=p);let u=o.general?.row_action_style;this._rowActionStyle=u==="icons"||u==="buttons"?u:"buttons_compact",this._rowActionNotice=o.general?.row_action_notice_pending===!0,this._refsInLists=o.general?.ref_numbers_in_lists===!0,this._objectsTableColumns=qe(o.objects_table_columns)}this._fetchMiniStatsForOverview(),this._initialLoadDone=!0,this._handleDeepLink()}_onLocationChanged(){if(!this._initialLoadDone||!window.location.search||this.embedded&&this._mountPath!==null&&window.location.pathname!==this._mountPath)return;if(!this.embedded){let e=`/${typeof this.panel?.url_path=="string"?this.panel.url_path:"maintenance-supporter"}`,i=window.location.pathname;if(i!==e&&!i.startsWith(`${e}/`))return}this._deepLinkHandled=!1,this._deepLinkInPlace=!0;try{this._handleDeepLink()}finally{this._deepLinkInPlace=!1}history.state?.msp_view||history.replaceState({msp_view:this._view,msp_entry:this._selectedEntryId,msp_task:this._selectedTaskId},"")}_handleDeepLink(){if(this._deepLinkHandled)return;let t=new URLSearchParams(window.location.search),e=t.get("ms_action"),i=()=>{let x=window.location.pathname+window.location.hash;history.replaceState(history.state,"",x)};if(e==="add_object"){this._deepLinkHandled=!0,i(),this._ui("maintenance-object-dialog").then(x=>x?.openCreate());return}if(e==="open_vacation"||e==="open_budget"||e==="open_groups"||e==="open_settings"){if(this._deepLinkHandled=!0,i(),!this.hass?.user?.is_admin)return;this._overviewTab="settings",this._ensureLazyUi().then(()=>requestAnimationFrame(()=>{let x=this.shadowRoot?.querySelector("maintenance-settings-view"),M=e.replace("open_","");x?.scrollToSection?.(M)}));return}if(this.embedded&&!this._presetsApplied){this._presetsApplied=!0;let x=this.presets?.tab??"",M=(this.presets?.view??"").trim();if(!t.has("tab")&&ye.includes(x)&&(x!=="settings"||this.hass?.user?.is_admin)&&(this._overviewTab=x),!t.has("view")&&M){let k=M.toLowerCase(),I=this._savedViews.find(O=>O.id===M)??this._savedViews.find(O=>O.name.trim().toLowerCase()===k);I&&(this._overviewTab="dashboard",this._applyView(I.id))}}let a=t.get("tab"),n=t.get("view"),d=t.get("sort"),o=t.get("status");if(a!==null||n!==null||d!==null||o!==null){if(i(),this._view!=="overview"&&(this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()),ye.includes(a??"")&&(a!=="settings"||this.hass?.user?.is_admin)&&this._setOverviewTab(a),n!==null){let x=n.trim().toLowerCase(),M=this._savedViews.find(k=>k.id===n)??this._savedViews.find(k=>k.name.trim().toLowerCase()===x);M&&(this._overviewTab!=="dashboard"&&this._setOverviewTab("dashboard"),this._applyView(M.id))}Me.includes(d??"")&&(this._sortMode=d,this._activeViewId="",G(D.taskSort,this._sortMode)),As.includes(o??"")&&(this._overviewTab!=="dashboard"&&this._setOverviewTab("dashboard"),this._filterByStatus(o))}let p=t.get("entry_id");if(!p)return;this._deepLinkHandled=!0;let u=t.get("task_id"),b=t.get("action"),_=t.get("section"),v=qi.includes(_??"")?_:null,f=window.location.pathname+window.location.hash;history.replaceState(history.state,"",f);let R=this._getObject(p);if(!R){this._showOverview();return}if(u){let x=R.tasks.find(M=>M.id===u);if(!x){this._showObject(p,v);return}this._showTask(p,u),b==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(p,u,x.name,this._features.checklists?x.checklist:void 0,this._features.adaptive&&!!x.adaptive_config?.enabled)}):b==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(p,u,x)})}else this._showObject(p,v)}_isCounterEntity(t){if(!t)return!1;let e=t.type||"threshold";return e==="counter"||e==="state_change"}async _fetchDetailStats(t,e){if(!this._statsService)return;let i=await this._statsService.getDetailStats(t,e,this._chartRangeDays),a=new Map(this._detailStatsData);a.set(t,i),this._detailStatsData=a}_setChartRange(t){if(t===this._chartRangeDays)return;this._chartRangeDays=t;try{G(D.chartRange,String(t))}catch{}let e=this._selectedEntryId&&this._selectedTaskId?this._getTask(this._selectedEntryId,this._selectedTaskId):null,i=e?.trigger_config?.entity_id;if(i){let a=new Map(this._detailStatsData);a.delete(i),this._detailStatsData=a,this._fetchDetailStats(i,this._isCounterEntity(e.trigger_config))}}_setHideOutliers(t){if(t!==this._hideOutliers){this._hideOutliers=t;try{G(D.chartHideOutliers,t?"1":"0")}catch{}}}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let t=[];for(let i of this._objects)for(let a of i.tasks){let n=a.trigger_config?.entity_id;n&&t.push({entityId:n,isCounter:this._isCounterEntity(a.trigger_config)})}if(t.length===0)return;let e=await this._statsService.getBatchMiniStats(t);this._miniStatsData=new Map([...this._miniStatsData,...e])}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e,a=bi(this._objects,i);a!==null&&(this._objects=a,e.objects&&xe(a,this._stats??null),this._refreshKpis(),this._detailOpen()&&(i.objects||(i.delta||[]).some(n=>n.entry_id===this._selectedEntryId))&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId))},{type:"maintenance_supporter/subscribe",deltas:!0,compact:!0});if(!this.isConnected){t();return}this._unsub=t}catch{}}async _refreshKpis(){if(this._kpiRefreshInFlight){this._kpiRefreshPending=!0;return}this._kpiRefreshInFlight=!0;try{do{this._kpiRefreshPending=!1;let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null)]);if(!this.isConnected)return;t&&(this._stats=t),e&&(this._budget=e,zt(this._budget))}while(this._kpiRefreshPending)}finally{this._kpiRefreshInFlight=!1}}get _taskRows(){let t=[];for(let b of this._objects)for(let _ of b.tasks){if(!this._showArchived&&_.archived||this._filterStatus&&_.status!==this._filterStatus)continue;if(this._filterUser){let f=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(_.responsible_user_id!==f)continue}if(this._filterLabel&&!(_.labels||[]).includes(this._filterLabel)||this._filterPriority&&(_.priority||"normal")!==this._filterPriority)continue;let v=[];for(let f of Object.values(this._groups))f.task_refs?.some(R=>R.entry_id===b.entry_id&&R.task_id===_.id)&&v.push(f.name);t.push({entry_id:b.entry_id,task_id:_.id,object_name:b.object.name,allow_skip:_.allow_skip!==!1,notify_enabled:_.notify_enabled!==!1,task_name:_.name,type:_.type,schedule_type:_.schedule_type,status:_.status,days_until_due:_.days_until_due??null,next_due:_.next_due??null,trigger_active:_.trigger_active,trigger_current_value:_.trigger_current_value??null,trigger_current_delta:_.trigger_current_delta??null,trigger_config:_.trigger_config??null,trigger_entity_info:_.trigger_entity_info??null,times_performed:_.times_performed,total_cost:_.total_cost,interval_days:_.interval_days??null,interval_unit:_.interval_unit??null,interval_anchor:_.interval_anchor??null,is_done:_.is_done??!1,archived:_.archived??!1,history:_.history||[],enabled:_.enabled,nfc_tag_id:_.nfc_tag_id??null,priority:_.priority??"normal",labels:_.labels??[],area_id:b.object.area_id??null,responsible_user_id:_.responsible_user_id??null,group_names:v})}let e={overdue:0,triggered:1,due_soon:2,ok:3},i=(b,_)=>(e[b.status]??9)-(e[_.status]??9),a=(b,_)=>(b.days_until_due??99999)-(_.days_until_due??99999),n=(b,_)=>i(b,_)||a(b,_),d=b=>b.area_id&&this.hass?.areas?.[b.area_id]?.name||"",o=b=>b.responsible_user_id&&this._userService?.getUserName(b.responsible_user_id)||"",p=b=>b.group_names[0]||"",u={due_date:n,object:(b,_)=>b.object_name.localeCompare(_.object_name)||n(b,_),type:(b,_)=>b.type.localeCompare(_.type)||n(b,_),task_name:(b,_)=>b.task_name.localeCompare(_.task_name),area:(b,_)=>{let v=d(b),f=d(_);return!v&&f?1:v&&!f?-1:v.localeCompare(f)||n(b,_)},assigned_user:(b,_)=>{let v=o(b),f=o(_);return!v&&f?1:v&&!f?-1:v.localeCompare(f)||n(b,_)},group:(b,_)=>{let v=p(b),f=p(_);return!v&&f?1:v&&!f?-1:v.localeCompare(f)||n(b,_)}};return t.sort(u[this._sortMode]),t}_getObject(t){return this._objects.find(e=>e.entry_id===t)}_getTask(t,e){return this._getObject(t)?.tasks.find(a=>a.id===e)}_listRef(t,e){if(!this._refsInLists)return h;let i=this._getObject(t);return Dt(xt(i?.object,i?.tasks.find(a=>a.id===e)))}_objRef(t){return this._refsInLists?Dt(yt(t)):h}_pushPanelState(t,e,i){let a={msp_view:t,msp_entry:e||null,msp_task:i||null};this._deepLinkInPlace?history.replaceState(a,""):history.pushState(a,"")}_onPopState(t){let e=t.state;if(e?.msp_view&&(this._view=e.msp_view,this._selectedEntryId=e.msp_entry||null,this._selectedTaskId=e.msp_task||null,this._moreMenuOpen=!1,this._objectSectionOverride=null,e.msp_view==="all_parts"&&this._loadAllParts(),e.msp_view==="task"&&e.msp_entry&&e.msp_task)){this._historyFilter=null;let i=this._getTask(e.msp_entry,e.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._objBulkMode=!1,this._objBulkSelected=new Set,this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop()}_showAllParts(){this._pushPanelState("all_parts"),this._view="all_parts",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop(),this._loadAllParts()}async _loadAllParts(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"});this._allParts=t.parts||[]}catch{this._allParts=[]}}_filterByStatus(t){this._filterStatus=t,this._activeViewId="",this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),this._scrollContentToTop()}get _allLabels(){let t=new Set;for(let e of this._objects)for(let i of e.tasks)for(let a of i.labels||[])t.add(a);return[...t].sort((e,i)=>e.localeCompare(i))}get _currentFilters(){return{status:this._filterStatus,user_id:this._filterUser,label:this._filterLabel,priority:this._filterPriority,archived:this._showArchived,sort_mode:this._sortMode,group_by:this._groupByMode}}_applyView(t){if(this._activeViewId=t,!t)return;let e=this._savedViews.find(a=>a.id===t);if(!e)return;let i=e.filters;this._filterStatus=i.status||"",this._filterUser=i.user_id||null,this._filterLabel=i.label||null,this._filterPriority=i.priority||"",this._showArchived=!!i.archived,Me.includes(i.sort_mode)&&(this._sortMode=i.sort_mode),Fi.includes(i.group_by)&&(this._groupByMode=i.group_by);try{G(D.taskSort,this._sortMode),G(D.groupBy,this._groupByMode)}catch{}this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard")}_openSavedViewsDialog(){this.shadowRoot.querySelector("maintenance-saved-views-dialog")?.open(this._currentFilters,this._savedViews)}_onSavedViewsChanged(t){this._savedViews=t.detail.views||[],this._activeViewId&&!this._savedViews.some(e=>e.id===this._activeViewId)&&(this._activeViewId="")}_scrollContentToTop(){requestAnimationFrame(()=>{let t=this.shadowRoot?.querySelector(".content");t&&t.scrollTo({top:0,behavior:"smooth"})})}_showObject(t,e=null){this._pushPanelState("object",t),this._view="object",this._selectedEntryId=t,this._selectedTaskId=null,this._objectSectionOverride=e,e?this._scrollToObjectSection(e):this._scrollContentToTop()}_scrollToObjectSection(t){this.updateComplete.then(()=>requestAnimationFrame(()=>{let e=this.shadowRoot?.querySelector(`.obj-section[data-section="${t}"]`);e?e.scrollIntoView({block:"start",behavior:"smooth"}):this._scrollContentToTop()}))}_toggleObjectSection(t){let e=new Set(this._objectSectionsCollapsed);this._objectSectionOverride===t||!e.has(t)?e.add(t):e.delete(t),this._objectSectionOverride===t&&(this._objectSectionOverride=null),this._objectSectionsCollapsed=e,G(D.objectSections,JSON.stringify([...e]))}_splitActive(){return this.split&&!this.narrow&&!this.tight&&this._view==="overview"&&this._overviewTab==="dashboard"&&!this._bulkMode}_detailOpen(){return(this._view==="task"||this._splitActive())&&!!this._selectedEntryId&&!!this._selectedTaskId}_showFullTaskPage(t,e){this._view!=="task"&&(this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._scrollContentToTop())}_showTask(t,e){if(this._splitActive()){this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._historySearch="",this._resetStickyPane(),this._fetchFullHistory(t,e);let a=this._getTask(t,e);a?.trigger_config?.entity_id&&this._fetchDetailStats(a.trigger_config.entity_id,this._isCounterEntity(a.trigger_config));return}this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._historySearch="",this._scrollContentToTop(),this._fetchFullHistory(t,e);let i=this._getTask(t,e);if(i?.trigger_config?.entity_id){let a=i.trigger_config.entity_id,n=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(a,n)}}_showToast(t){this._toastTimer&&clearTimeout(this._toastTimer),this._toastUndo=null,this._toastActionLabel="",this._toastMessage=t,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}_showActionToast(t,e,i){this._showUndoToast(t,i),this._toastActionLabel=e}_showUndoToast(t,e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastActionLabel="",this._toastMessage=t,this._toastUndo=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastUndo=null,this._toastTimer=null},7e3)}_runToastUndo(){let t=this._toastUndo;this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage="",this._toastUndo=null,this._toastTimer=null,t?.()}_openPalette(){this._paletteQuery="",this._paletteActive=0,this._paletteOpen=!0,this._searchRemote=null,this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".palette-input")?.focus()})}_closePalette(){this._paletteOpen=!1,this._paletteQuery="",this._searchRemote=null,this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=null)}_onPaletteInput(t){this._paletteQuery=t,this._paletteActive=0,this._searchTimer&&clearTimeout(this._searchTimer);let e=t.trim();if(e.length<ue){this._searchRemote=null;return}this._searchTimer=setTimeout(()=>{this._searchTimer=null;let i=++this._searchSeq;this.hass.connection.sendMessagePromise({type:"maintenance_supporter/search",query:e,limit:Ot.documents}).then(a=>{i!==this._searchSeq||!this._paletteOpen||(this._searchRemote={query:e,documents:a.documents||[],history:a.history||[]})}).catch(()=>{i!==this._searchSeq||!this._paletteOpen||(this._searchRemote={query:e,documents:[],history:[]})})},Cs)}get _paletteResults(){let t=this._lang,e=this._paletteQuery.trim();if(e.length<ue&&!Gt(e))return[];let i=Wt(e);if(!i.length)return[];let a=[],n=[],d=[],o=Gt(e);if(o){for(let _ of this._objects){let v=_.object;if(v.ref_no!==o.object)continue;let f=yt(v),R=(x,M)=>x?[M,s("archived",t)].filter(Boolean).join(" \xB7 "):M;o.task==null&&a.push({kind:"object",entryId:_.entry_id,label:v.name||"",sub:R(v.archived,s("object",t)),score:1e3,icon:"mdi:package-variant-closed",ref:f});for(let x of _.tasks)o.task!=null&&x.ref_no!==o.task||n.push({kind:"task",entryId:_.entry_id,taskId:x.id,label:x.name||"",sub:R(x.archived||v.archived,v.name||""),score:o.task==null?900:1e3,icon:"mdi:clipboard-check-outline",ref:xt(v,x)})}if(a.length||n.length){let _=this._searchRemote&&this._searchRemote.query===e?this._searchRemote:null,v=[...a,...n.slice(0,Ot.tasks)];for(let f of _?.history.slice(0,1)??[])v.push({kind:"history",entryId:f.entry_id,taskId:f.task_id,label:f.task_name||"",sub:[f.object_name,f.timestamp?Q(f.timestamp,t):""].filter(Boolean).join(" \xB7 "),snippet:f.snippet||"",score:f.score,icon:"mdi:note-text-outline",ref:f.ref??null});return v}}for(let _ of this._objects){let v=_.object;if(v.archived)continue;let f=v.name||"",R=Ct(i,[{text:f,weight:3},{text:v.manufacturer,weight:2},{text:v.model,weight:2},{text:v.serial_number,weight:2},{text:v.notes,weight:1}]);if(R>0){let x=[v.manufacturer,v.model].filter(Boolean).join(" ");a.push({kind:"object",entryId:_.entry_id,label:f,sub:x||s("object",t),score:R,icon:"mdi:package-variant-closed",ref:yt(v)})}for(let x of _.tasks){if(x.archived)continue;let M=(x.labels||[]).join(" "),k=Ct(i,[{text:x.name,weight:3},{text:f,weight:2},{text:M,weight:2},{text:x.notes,weight:1}]);if(k>0){let I=(x.labels||[]).length?`  #${(x.labels||[]).join(" #")}`:"";n.push({kind:"task",entryId:_.entry_id,taskId:x.id,label:x.name||"",sub:f+I,score:k,icon:"mdi:clipboard-check-outline",ref:xt(v,x)})}}for(let x of _.parts||[]){let M=Ct(i,[{text:x.name,weight:3},{text:x.mpn,weight:2},{text:x.vendor,weight:1},{text:x.storage_location,weight:1},{text:x.notes,weight:1}]);M>0&&d.push({kind:"part",entryId:_.entry_id,label:x.name||"",sub:[f,x.mpn].filter(Boolean).join(" \xB7 "),score:M,icon:"mdi:cog-outline"})}}let p=(_,v)=>v.score-_.score||_.label.localeCompare(v.label),u=[...a.sort(p).slice(0,Ot.objects),...n.sort(p).slice(0,Ot.tasks),...d.sort(p).slice(0,Ot.parts)],b=this._searchRemote&&this._searchRemote.query===e?this._searchRemote:null;if(b){let _=b.documents.slice(0,Ot.documents);for(let v of[..._.filter(f=>f.match!=="content"),..._.filter(f=>f.match==="content")])u.push({kind:v.match==="content"?"content":"document",entryId:v.entry_id,docId:v.id,docKind:v.kind,url:v.url,page:v.page??null,label:v.title||v.filename||v.url||"",sub:v.object_name||"",snippet:v.snippet||"",score:v.score,icon:v.kind==="weblink"?"mdi:link-variant":"mdi:file-document-outline"});for(let v of b.history.slice(0,Ot.history))u.push({kind:"history",entryId:v.entry_id,taskId:v.task_id,label:v.task_name||"",ref:v.ref??null,sub:[v.object_name,v.timestamp?Q(v.timestamp,t):""].filter(Boolean).join(" \xB7 "),snippet:v.snippet||"",score:v.score,icon:v.type==="skipped"?"mdi:skip-next-circle-outline":"mdi:note-text-outline"})}return u}_selectPaletteResult(t){let e=this._paletteQuery.trim();switch(this._closePalette(),t.kind){case"task":t.taskId&&this._showTask(t.entryId,t.taskId);return;case"history":if(!t.taskId)return;this._showTask(t.entryId,t.taskId),this._activeTab="history",this._historySearch=e;return;case"document":case"content":t.docKind==="weblink"?at(t.url)&&window.open(t.url,"_blank","noopener"):t.docId&&wt(this.hass,t.docId,t.page?`#page=${t.page}`:"").catch(()=>{}),this._showObject(t.entryId,"documents");return;case"part":this._showObject(t.entryId,"parts");return;default:this._showObject(t.entryId)}}_renderPalette(){if(!this._paletteOpen)return h;let t=this._lang,e=this._paletteResults,i=this._paletteQuery.trim(),a={object:s("objects",t),task:s("tasks",t),part:s("search_group_parts",t),document:s("documents",t),content:s("search_group_content",t),history:s("search_group_history",t)},n=i.length>=ue&&(!this._searchRemote||this._searchRemote.query!==i),d=null;return r`
      <div class="palette-backdrop" @click=${()=>this._closePalette()}>
        <div class="palette" role="dialog" aria-label=${s("search_open",t)} @click=${o=>o.stopPropagation()}>
          <input
            class="palette-input"
            type="text"
          ...
          <div class="palette-results">
            ${i.length<ue&&!Gt(i)?r`<div class="palette-empty">${s("search_empty_hint",t)}</div>`:e.length===0?r`<div class="palette-empty">${n?s("search_searching",t):s("palette_no_results",t)}</div>`:e.map((o,p)=>{let u=o.kind!==d?r`<div class="palette-group">${a[o.kind]}</div>`:h;return d=o.kind,r`
                      ${u}
                      <div class="palette-item ${p===this._paletteActive?"active":""} ${o.snippet?"has-snippet":""}"
    ...
    `}_bulkKey(t){return`${t.entry_id}:${t.task_id}`}_toggleBulkMode(){this._bulkMode=!this._bulkMode,this._bulkMenuOpen=!1,this._bulkMode||(this._bulkSelected=new Set)}_toggleBulkRow(t){let e=this._bulkKey(t),i=new Set(this._bulkSelected);i.has(e)?i.delete(e):i.add(e),this._bulkSelected=i}_bulkSelectAll(t){let e=t.map(a=>this._bulkKey(a)),i=e.every(a=>this._bulkSelected.has(a));this._bulkSelected=i?new Set:new Set(e)}async _runBulk(t,e,i,a){let n=t.filter(o=>this._bulkSelected.has(this._bulkKey(o)));if(n.length===0)return;this._actionLoading=!0;let d=0;for(let o of n)try{await this.hass.connection.sendMessagePromise(e(o)),d++}catch{}this._actionLoading=!1,this._bulkSelected=new Set,this._bulkMode=!1,await this._loadData(),a&&d>0?this._showUndoToast(i(d),a):this._showToast(i(d))}async _bulkMove(t){let e=this._objects.filter(d=>!d.object.archived_at).sort((d,o)=>(d.object.name||"").localeCompare(o.object.name||""));if(!e.length||this._bulkSelected.size===0)return;let a=await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.prompt({title:s("move_task_title",this._lang),message:s("bulk_move_message",this._lang),confirmText:s("move_task_title",this._lang),inputLabel:s("move_task_target",this._lang),inputValue:e[0].entry_id,options:e.map(d=>({value:d.entry_id,label:d.object.name||d.entry_id}))});if(!a?.confirmed||!a.value)return;let n=a.value;await this._runBulk(t.filter(d=>d.entry_id!==n),d=>({type:"maintenance_supporter/task/move",entry_id:d.entry_id,task_id:d.task_id,target_entry_id:n}),d=>s("bulk_moved",this._lang).replace("{n}",String(d)))}_toggleObjBulkMode(){this._objBulkMode=!this._objBulkMode,this._objBulkMode||(this._objBulkSelected=new Set)}_toggleObjBulk(t){let e=new Set(this._objBulkSelected);e.has(t)?e.delete(t):e.add(t),this._objBulkSelected=e}_objBulkSelectAll(t){let e=t.map(a=>a.entry_id),i=e.length>0&&e.every(a=>this._objBulkSelected.has(a));this._objBulkSelected=i?new Set:new Set(e)}async _runObjBulk(t,e,i){let a=[...this._objBulkSelected];if(a.length===0)return;this._actionLoading=!0;let n=[];for(let d of a)try{await this.hass.connection.sendMessagePromise({type:t,entry_id:d}),n.push(d)}catch{}this._actionLoading=!1,this._objBulkSelected=new Set,this._objBulkMode=!1,await this._loadData(),i&&n.length>0?this._showUndoToast(e(n.length),()=>{i(n)}):this._showToast(e(n.length))}async _objBulkDelete(){let t=this._objBulkSelected.size;t===0||!await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:s("delete",this._lang),message:s("bulk_delete_objects_confirm",this._lang).replace("{n}",String(t)),confirmText:s("delete",this._lang),danger:!0})||await this._runObjBulk("maintenance_supporter/object/delete",a=>s("bulk_objects_deleted",this._lang).replace("{n}",String(a)))}_objBulkArchive(){this._runObjBulk("maintenance_supporter/object/archive",t=>s("bulk_objects_archived",this._lang).replace("{n}",String(t)),async t=>{for(let e of t)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/unarchive",entry_id:e})}catch{}await this._loadData()})}_renderObjBulkBar(t,e){let i=this._objBulkSelected.size,a=t.length>0&&t.every(n=>this._objBulkSelected.has(n.entry_id));return r`
    ...
    `}_bulkComplete(t){this._runBulk(t,e=>({type:"maintenance_supporter/task/complete",entry_id:e.entry_id,task_id:e.task_id}),e=>s("bulk_completed",this._lang).replace("{n}",String(e)))}_bulkArchive(t){let e=t.filter(i=>this._bulkSelected.has(this._bulkKey(i))).map(i=>({entry_id:i.entry_id,task_id:i.task_id}));this._runBulk(t,i=>({type:"maintenance_supporter/task/archive",entry_id:i.entry_id,task_id:i.task_id}),i=>s("bulk_archived",this._lang).replace("{n}",String(i)),async()=>{for(let i of e)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/unarchive",entry_id:i.entry_id,task_id:i.task_id})}catch{}await this._loadData()})}async _runAction(t,e){this._actionLoading=!0;try{let i=await this.hass.connection.sendMessagePromise(t);return await this._loadData(),e?.successToast&&this._showToast(e.successToast),i??{}}catch(i){return this._showToast(A(i,this._lang)),null}finally{this._actionLoading=!1}}async _deleteObject(t){if(!await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:s("delete",this._lang),message:s("confirm_delete_object",this._lang),confirmText:s("delete",this._lang),danger:!0}))return;await this._runAction({type:"maintenance_supporter/object/delete",entry_id:t})&&this._showOverview()}_printObjectReport(t){let e=this._getObject(t);if(!e)return;let i=this._lang,a={title:s("report_title",i),generated:s("report_generated",i),manufacturer:s("manufacturer",i),model:s("model",i),serial:s("serial_number_label",i),installed:s("installed",i),warranty:s("warranty",i),area:s("area",i),notes:s("report_notes",i),tasksHeading:s("tasks",i),colTask:s("task_name",i),colType:s("report_col_type",i),colStatus:s("report_col_status",i),colSchedule:s("report_col_schedule",i),colLastDone:s("last_performed",i),colNextDue:s("next_due",i),colCost:s("cost",i),colTimes:s("report_times_done",i),totalCost:s("report_total_cost",i),scheduleLabel:d=>St(d,i),none:"\u2014",statusLabel:d=>s(d,i),typeLabel:d=>s(d,i)},n=fi(e.object,e.tasks,a,d=>d?Q(d,i):"",d=>K(d,this._currencySymbol,i),new Date().toISOString());Bt(n)}async _duplicateObject(t){let e=await this._runAction({type:"maintenance_supporter/object/duplicate",entry_id:t},{successToast:s("object_duplicated",this._lang)});e?.entry_id&&this._showObject(e.entry_id)}async _deleteTask(t,e){if(!await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:s("delete",this._lang),message:s("confirm_delete_task",this._lang),confirmText:s("delete",this._lang),danger:!0}))return;await this._runAction({type:"maintenance_supporter/task/delete",entry_id:t,task_id:e})&&this._showObject(t)}async _duplicateTask(t,e){this._moreMenuOpen=!1;let i=await this._runAction({type:"maintenance_supporter/task/duplicate",entry_id:t,task_id:e},{successToast:s("task_duplicated",this._lang)});i?.task_id&&this._showTask(t,i.task_id)}async _moveTask(t,e){this._moreMenuOpen=!1;let i=this._objects.filter(o=>o.entry_id!==t&&!o.object.archived_at).sort((o,p)=>(o.object.name||"").localeCompare(p.object.name||""));if(!i.length)return;let n=await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.prompt({title:s("move_task_title",this._lang),message:s("move_task_message",this._lang),confirmText:s("move_task_title",this._lang),inputLabel:s("move_task_target",this._lang),inputValue:i[0].entry_id,options:i.map(o=>({value:o.entry_id,label:o.object.name||o.entry_id}))});if(!n?.confirmed||!n.value)return;let d=await this._runAction({type:"maintenance_supporter/task/move",entry_id:t,task_id:e,target_entry_id:n.value},{successToast:s("task_moved",this._lang)});d?.entry_id&&d.task_id&&this._showTask(d.entry_id,d.task_id)}async _toggleArchiveTask(t,e,i){await this._runAction({type:i?"maintenance_supporter/task/unarchive":"maintenance_supporter/task/archive",entry_id:t,task_id:e})&&!i&&this._showUndoToast(s("task_archived",this._lang),()=>this._toggleArchiveTask(t,e,!0))}async _toggleArchiveObject(t,e){await this._runAction({type:e?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:t})&&!e&&this._showUndoToast(s("object_archived",this._lang),()=>this._toggleArchiveObject(t,!0))}async _togglePauseObject(t,e){if(!e){let a=await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.prompt({title:s("pause_object",this._lang),message:s("pause_until_prompt",this._lang),confirmText:s("pause_object",this._lang),inputLabel:s("pause_until_label",this._lang),inputType:"date"});if(!a?.confirmed)return;let n={type:"maintenance_supporter/object/pause",entry_id:t};a.value&&(n.until=a.value),await this._runAction(n)&&this._showUndoToast(s("object_paused",this._lang),()=>this._togglePauseObject(t,!0));return}await this._runAction({type:"maintenance_supporter/object/resume",entry_id:t},{successToast:s("object_resumed",this._lang)})}async _replaceObject(t,e){let a=await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.prompt({title:s("replace_object",this._lang),message:s("replace_object_prompt",this._lang),confirmText:s("replace_object",this._lang),inputLabel:s("replace_name_label",this._lang),inputType:"text",inputValue:e});if(!a?.confirmed)return;let n=await this._runAction({type:"maintenance_supporter/object/replace",entry_id:t,name:a.value||e},{successToast:s("object_replaced",this._lang)});n?.entry_id&&this._showObject(n.entry_id)}async _skipTask(t,e,i){let a={type:"maintenance_supporter/task/skip",entry_id:t,task_id:e};i&&(a.reason=i),await this._runAction(a)}async _resetTask(t,e,i){let a={type:"maintenance_supporter/task/reset",entry_id:t,task_id:e};i&&(a.date=i),await this._runAction(a)}async _applySuggestion(t,e,i){await this._runAction({type:"maintenance_supporter/task/apply_suggestion",entry_id:t,task_id:e,interval:i})}_openSeasonalOverrides(t){let e=this.shadowRoot.querySelector("maintenance-seasonal-overrides-dialog");if(!e||!this._selectedEntryId)return;let i=t.adaptive_config?.seasonal_overrides;e.open(this._selectedEntryId,t.id,i)}async _reanalyzeInterval(t,e){let i=await this._runAction({type:"maintenance_supporter/task/analyze_interval",entry_id:t,task_id:e});i&&(i.recommended_interval?this._showToast(`${s("reanalyze_result",this._lang)}: ${i.recommended_interval} ${s("days",this._lang)} (${s(`confidence_${i.confidence}`,this._lang)}, ${i.data_points} ${s("data_points",this._lang)})`):this._showToast(s("reanalyze_insufficient_data",this._lang)))}async _promptSkipTask(t,e){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!i)return;let a=await i.prompt({title:s("skip",this._lang),message:s("skip_reason_prompt",this._lang),confirmText:s("skip",this._lang),inputLabel:s("reason_optional",this._lang),inputType:"text"});a.confirmed&&this._skipTask(t,e,a.value||void 0)}async _promptResetTask(t,e){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!i)return;let a=await i.prompt({title:s("reset",this._lang),message:s("reset_date_prompt",this._lang),confirmText:s("reset",this._lang),inputLabel:s("reset_date_optional",this._lang),inputType:"date"});a.confirmed&&this._resetTask(t,e,a.value||void 0)}async _postponeTask(t,e,i){await this._runAction({type:"maintenance_supporter/task/postpone",entry_id:t,task_id:e,until:i},{successToast:s("postponed",this._lang)})}async _promptPostponeTask(t,e){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!i)return;let a=await i.prompt({title:s("postpone",this._lang),message:s("postpone_date_prompt",this._lang),confirmText:s("postpone",this._lang),inputLabel:s("postpone_date_label",this._lang),inputType:"date"});!a.confirmed||!a.value||this._postponeTask(t,e,a.value)}async _snoozeTask(t,e){await this._runAction({type:"maintenance_supporter/task/snooze",entry_id:t,task_id:e},{successToast:s("snoozed",this._lang)})}_dismissSuggestion(t,e){t&&e&&this._dismissedSuggestions.add(`${t}_${e}`),this.requestUpdate()}async _handleQuickComplete(t,e,i){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/quick_complete",entry_id:t,task_id:e}),this._showToast(s("quick_complete_success",this._lang))}catch(a){let n=a?.code||"";n==="no_defaults"||n==="completion_details_required"?this._openCompleteDialog(t,e,i.name,this._features.checklists?i.checklist:void 0,this._features.adaptive&&!!i.adaptive_config?.enabled,{viaTagScan:!0}):this._showToast(A(a,this._lang,s("action_error",this._lang)));return}try{await this._loadData()}catch{}}async _printTaskWorksheet(t,e){let i=this._getObject(t),a=i?.tasks.find(n=>n.id===e);if(!(!i||!a)){this._actionLoading=!0;try{let n={type:"maintenance_supporter/qr/generate",entry_id:t,task_id:e,url_mode:"server"},[d,o]=await Promise.all([this.hass.connection.sendMessagePromise({...n,action:"view"}).catch(()=>null),this.hass.connection.sendMessagePromise({...n,action:"complete"}).catch(()=>null)]),p=null;try{let R=((await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:t})).documents||[]).find(x=>x.kind==="file"&&x.mime==="application/pdf"&&(x.task_ids||[]).includes(e)&&x.task_pages?.[e]);if(R){let x=R.task_pages[e],M=4,k={path:await Be(this.hass,`/api/maintenance_supporter/document/${R.id}/excerpt?start=${x}&count=${M}`,3600)};p={title:R.title||R.filename||"Manual",startPage:x,endPage:x+M-1,url:new URL(k.path,window.location.origin).toString(),vendorBase:new URL("/maintenance_supporter_vendor",window.location.origin).toString()}}}catch{}let u=this._lang,b={title:s("worksheet",u),object:s("object",u),type:s("maintenance_type",u),interval:s("interval",u),nextDue:s("next_due",u),lastDone:s("last_performed",u),priority:s("priority",u),checklist:s("checklist",u),notes:s("notes_label",u),scanView:s("worksheet_scan_view",u),scanComplete:s("worksheet_scan_complete",u),manualExcerpt:s("worksheet_manual_excerpt",u),pages:s("worksheet_pages",u),printedOn:s("worksheet_printed",u),never:s("worksheet_never",u),typeLabel:f=>s(f,u),statusLabel:f=>s(f,u),parts:s("consumes_parts_label",u)},_=(a.consumes_parts||[]).map(f=>Ve(f,i.entry_id,this._objects,u)),v=yi(a,i.object.name,b,f=>Q(f,u),f=>St(f,u),d?.svg_data_uri||null,o?.svg_data_uri||null,p,new Date().toISOString(),_,xt(i.object,a));Bt(v)}finally{this._actionLoading=!1}}}_openManualDoc(t){if(t.kind!=="file"){at(t.url)&&window.open(t.url,"_blank","noopener");return}wt(this.hass,t.id).catch(()=>{})}async _setChecklistItem(t,e,i,a){let d=this._getObject(t)?.tasks.find(u=>u.id===e);if(!d)return;let o={},p=ee(d)?.checklist??(d.checklist||[]);for(let u of p){let b=d.checklist_progress?.[u]??!1;o[u]=u===i?a:b}await this._runAction({type:"maintenance_supporter/task/checklist_progress",entry_id:t,task_id:e,checklist_state:o})}_openCompleteDialog(t,e,i,a,n,d){this._ui("maintenance-complete-dialog").then(o=>o&&this._fillAndOpenCompleteDialog(o,t,e,i,a,n,d))}_fillAndOpenCompleteDialog(t,e,i,a,n,d,o){Ke(t,Ye({entryId:e,taskId:i,taskName:a,task:this._getTask(e,i),objects:this._objects,lang:this._lang,checklist:n,checklistsEnabled:this._features.checklists,adaptiveEnabled:d,currencySymbol:this._currencySymbol,viaTagScan:o?.viaTagScan}),this._lang)}_openQrForObject(t,e){this._ui("maintenance-qr-dialog").then(i=>i?.openForObject(t,e))}_openQrForTask(t,e,i,a){this._ui("maintenance-qr-dialog").then(n=>n?.openForTask(t,e,i,a))}render(){return r`
      ...
      ${this._toastMessage?r`<div class="toast">
        ...
        ${this._toastUndo?r`<button class="toast-undo" @click=${()=>this._runToastUndo()}>${this._toastActionLabel||s("undo",this._lang)}</button>`:h}
      </div>`:h}
      ${this._renderPalette()}
    ...
    `}_statusBadge(t,e,i){let a=this._lang,n=t?"archived":e?"done":i,d=t?"archived":e?"completed":i,o=t?s("archived",a):e?s("completed",a):s(i,a);return r`<span class="status-badge ${n}" role="img" title="${o}" aria-label="${o}"><ha-icon icon="${Ae[d]||"mdi:circle-medium"}"></ha-icon><span class="status-label">${o}</span></span>`}_setOverviewTab(t){this._overviewTab=t;try{G(D.overviewTab,t)}catch{}this._scrollContentToTop()}_renderToday(){let t=this._lang,e=this._taskRows,i=p=>`${p.entry_id}:${p.task_id}`,a=e.filter(p=>p.status==="overdue"||p.trigger_active),n=new Set(a.map(i)),d=e.filter(p=>!n.has(i(p))&&p.days_until_due===0);d.forEach(p=>n.add(i(p)));let o=e.filter(p=>!n.has(i(p))&&p.days_until_due!=null&&p.days_until_due>0&&p.days_until_due<=7);return a.length+d.length+o.length===0?r`
    ...
    `}_renderTodaySection(t,e,i){if(e.length===0)return h;let a=this._lang,n=d=>this._filterUser||!d.responsible_user_id?null:this._userService?.getPerson(d.responsible_user_id)??null;return r`
          ...
          <div class="today-row" @click=${()=>this._showTask(d.entry_id,d.task_id)}>
            ...
            <div class="today-main">
              ...
              <div class="today-object">
                <span class="today-object-text">${d.object_name} · ${jt(d.days_until_due,a)}</span>
                ${_e(n(d),"today-person")}
              </div>
            </div>
            ${this._renderRowActions(a,()=>this._openCompleteDialogForRow(d),void 0,!1)}
          </div>
        `)}
      </div>
    `}_renderDashboard(){let t=this._stats,e=this._taskRows,i=this._lang,a=this._isOperator,n=this._objects.reduce((o,p)=>o+p.tasks.filter(u=>u.archived).length,0),d=(this._filterStatus?1:0)+(this._filterUser?1:0)+(this._filterLabel?1:0)+(this._filterPriority?1:0)+(this._activeViewId?1:0);return r`
      ...
      <div class="filter-bar ${this.narrow&&!this._filtersOpen?"collapsed":""}">
        ...
        <label class="filter-field">
          ...
          <select
            ...
            @change=${o=>{let p=o.target.value;this._filterUser=p||null,this._activeViewId=""}}
          >
        ...
        ${this._allLabels.length>0?r`
          <label class="filter-field">
            ...
            <select
              ...
              @change=${o=>{let p=o.target.value;this._filterLabel=p||null,this._activeViewId=""}}
            >
        ...
        <label class="filter-field">
          ...
          >
            ...
            ${["high","normal","low"].map(o=>r`<option value=${o} ?selected=${this._filterPriority===o}>${s(`priority_${o}`,i)}</option>`)}
          </select>
        </label>
        <label class="filter-field">
          ...
          <select
            ...
            @change=${o=>{this._sortMode=o.target.value,this._activeViewId="";try{G(D.taskSort,this._sortMode)}catch{}}}
          >
        ...
        <label class="filter-field">
          ...
          <select
            ...
            @change=${o=>{this._groupByMode=o.target.value,this._activeViewId="";try{G(D.groupBy,this._groupByMode)}catch{}}}
          >
            ...
            ${this._features.groups?r`<option value="group" ?selected=${this._groupByMode==="group"}>${s("groupby_group",i)}</option>`:h}
      ...
      ${a?h:r`<maintenance-storage-section-card
            .hass=${this.hass}
            .objects=${this._objects}
            @open-object=${o=>{let p=o.detail?.entry_id;p&&this._showObject(p)}}
    ...
    `}_renderTaskTable(t){let e=this._bulkMode?" bulk":"";if(this._virtTotalRows=t.length,this.narrow||t.length<120)return r`
      ...
      `;let i=t.length,a=this._virtRowHeight,n=Math.max(0,Math.min(this._virtStart,i)),d=this._virtEnd>0?Math.min(this._virtEnd,i):Math.min(i,40);d<n&&(n=0,d=Math.min(i,40));let o=n*a,p=(i-d)*a;return r`
      <div class="task-table${e} virtual">
        ${this._renderVirtSizerRow(t)}
        ${o>0?r`<div class="virt-spacer" style="height:${o}px"></div>`:h}
        ${t.slice(n,d).map(u=>this._renderOverviewRow(u))}
        ${p>0?r`<div class="virt-spacer" style="height:${p}px"></div>`:h}
      </div>
    `}_renderVirtSizerRow(t){let e=this._lang,i="",a=!1,n=!1,d=!1;for(let o of t){let p=o.archived?s("archived",e):o.is_done?s("completed",e):s(o.status,e);p.length>i.length&&(i=p),o.enabled||(a=!0),o.nfc_tag_id&&(n=!0),(o.priority==="high"||o.priority==="low")&&(d=!0)}return r`
      <div class="task-row virt-sizer" aria-hidden="true">
        ...
        <span class="cell-badges">
          ...
          ${a?r`<span class="badge-disabled">${s("disabled",e)}</span>`:h}
          ${n?r`<span class="nfc-badge"><ha-icon icon="mdi:nfc-variant"></ha-icon></span>`:h}
          ${d?r`<span class="priority-badge"><ha-icon icon="mdi:chevron-double-up"></ha-icon></span>`:h}
        </span>
    ...
    `}_renderGroupedTasks(t,e){let i=new Map,a=s("unassigned",e);for(let o of t){let p=[];this._groupByMode==="area"?p=[(o.area_id?this.hass?.areas?.[o.area_id]?.name:null)||a]:this._groupByMode==="user"?p=[(o.responsible_user_id?this._userService?.getUserName(o.responsible_user_id):null)||a]:this._groupByMode==="group"?p=o.group_names.length>0?o.group_names:[a]:this._groupByMode==="object"&&(p=[o.object_name]);for(let u of p)i.has(u)||i.set(u,[]),i.get(u).push(o)}let n=[...i.entries()].sort(([o],[p])=>o===a&&p!==a?1:p===a&&o!==a?-1:o.localeCompare(p)),d=this._groupByMode==="area"?"mdi:map-marker-outline":this._groupByMode==="group"?"mdi:folder-outline":this._groupByMode==="object"?"mdi:cube-outline":"mdi:account-outline";return r`
      <div class="task-table grouped${this._bulkMode?" bulk":""}">
        ${n.map(([o,p])=>{let u=!this._collapsedGroups.has(o);return r`
            <div class="group-section" ?open=${u}>
              <div
                ...
                @keydown=${b=>{(b.key==="Enter"||b.key===" ")&&(b.preventDefault(),this._toggleGroup(o))}}
              >
                <ha-icon icon="${d}"></ha-icon>
                <span>${o}</span>
                <span class="group-section-count">(${p.length})</span>
              </div>
              ${u?r`<div class="group-rows">${p.map(b=>this._renderOverviewRow(b))}</div>`:h}
            </div>
          `})}
      </div>
    `}_toggleGroup(t){let e=new Set(this._collapsedGroups);e.has(t)?e.delete(t):e.add(t),this._collapsedGroups=e}_warrantyLabel(t,e,i){return t.kind==="expired"?s("warranty_expired",i):t.kind==="expiring"?s("warranty_expires_in",i).replace("{days}",String(t.days??0)):s("warranty_valid_until",i).replace("{date}",Q(e,i))}_renderWarrantyMeta(t,e){let i=we(t);return r`<p class="meta">${s("warranty",e)}:
      <span class="warranty-chip warranty-${i.kind}">${this._warrantyLabel(i,t,e)}</span></p>`}_renderAllObjects(){let t=this._lang,e=this._isOperator,i=this._objectViewMode==="table"&&!this.narrow,a=this._objects.filter(u=>u.object.archived).length,n=u=>{let b=1/0;for(let _ of u.tasks){let v=_.days_until_due;v!=null&&v<b&&(b=v)}return b},d=this._objects.filter(u=>this._showArchived||!u.object.archived);this._objectSortMode==="alphabetical"?d.sort((u,b)=>u.object.name.localeCompare(b.object.name)):this._objectSortMode==="task_count"?d.sort((u,b)=>b.tasks.length-u.tasks.length||u.object.name.localeCompare(b.object.name)):d.sort((u,b)=>n(u)-n(b)||u.object.name.localeCompare(b.object.name));let o=()=>{let u=new Map;for(let b of d){let _=b.object.area_id,v=_?this.hass?.areas?.[_]?.name||s("unassigned",t):s("no_area",t);u.has(v)||u.set(v,[]),u.get(v).push(b)}return new Map([...u.entries()].sort(([b],[_])=>b.localeCompare(_)))},p=u=>{let b=u.tasks.some(_=>_.status==="overdue"||_.status==="triggered");return r`
        <div class="object-card${b?" object-card-overdue":""}${this._objBulkMode?" selectable":""}${this._objBulkMode&&this._objBulkSelected.has(u.entry_id)?" bulk-selected":""}"
          ...
          ${this._objBulkMode?r`<label class="obj-bulk-check bulk-check" @click=${_=>_.stopPropagation()}>
                <input type="checkbox" .checked=${this._objBulkSelected.has(u.entry_id)} @change=${()=>this._toggleObjBulk(u.entry_id)} />
              </label>`:h}
          ${b?r`<span class="overdue-dot" title="${s("has_overdue",t)}"></span>`:h}
          ...
          ${u.object.manufacturer||u.object.model?r`<div class="object-card-meta">${[u.object.manufacturer,u.object.model].filter(Boolean).join(" ")}</div>`:h}
          ${u.tasks.length===0?r`<div class="object-card-empty">${s("no_tasks_yet",t)}</div>`:h}
        </div>
      `};return r`
      ...
      <div class="filter-bar">
        <label class="filter-field">
          ...
          <select
            ...
            @change=${u=>{this._objectSortMode=u.target.value;try{G(D.objectSort,this._objectSortMode)}catch{}}}
          >
        ...
        <label class="filter-field">
          ...
          <select
            .value=${this._groupByMode}
            @change=${u=>{this._groupByMode=u.target.value;try{G(D.groupBy,this._groupByMode)}catch{}}}
          >
      ...
      ${this._objBulkMode?this._renderObjBulkBar(d,t):h}
      ${i?this._renderObjectsTable(d):this._groupByMode==="area"?r`
          ...
          `)}
        `:r`<div class="objects-grid">${d.map(p)}</div>`}
    `}_setObjectViewMode(t){this._objectViewMode=t;try{G(D.objectView,t)}catch{}}_renderAllParts(){let t=this._lang,e=this._allParts,i=this._currencySymbol;return r`
      <div class="breadcrumb">
      ...
      ${e===null?r`<div class="empty-state">…</div>`:e.length===0?r`<div class="empty-state">${s("parts_section",t)}: 0</div>`:r`
              ...
              <tbody>
                ${e.map(a=>r`
                  <tr class="objects-table-row" @click=${()=>this._showObject(a.entry_id)}>
                    ...
                    <td>${a.cost!=null?K(a.cost,i,t):"\u2014"}</td>
        ...
        `}
    `}_exportPartsCsv(){let t=this._allParts||[],e=d=>{let o=d==null?"":String(d);return/[",\n;]/.test(o)?`"${o.replace(/"/g,'""')}"`:o},a=[["name","object","stock","unit","reorder_threshold","unit_cost","storage_location","vendor","used_by"].join(",")];for(let d of t)a.push([e(d.name),e(d.object_name),e(d.stock),e(d.unit),e(d.reorder_threshold),e(d.cost),e(d.storage_location),e(d.vendor),e(d.consumers.map(o=>`${o.object_name??""}/${o.task_name??o.task_id}\xD7${o.quantity}`).join(" | "))].join(","));let n=Ft(new Date);me(a.join(`
`),`maintenance_parts_${n}.csv`,"text/csv;charset=utf-8")}async _exportObjectsCsv(){let t=await ve(this,{type:"maintenance_supporter/objects/csv"},{onError:i=>this._showToast(i)});if(!t)return;let e=Ft(new Date);me(t.csv,`maintenance_objects_${e}.csv`,"text/csv;charset=utf-8")}_renderObjectsTable(t){let e=this._lang,i=this._objectsTableColumns;return r`
      <div class="objects-table-wrap">
        <table class="objects-table">
          <thead>
            <tr>
              ${this._objBulkMode?r`<th class="oc-bulk"></th>`:h}
              ${i.map(a=>{let n=Ne.find(o=>o.key===a),d=n&&n.key!=="actions"?s(n.labelKey,e):"";return r`<th class="oc-${a}">${d}</th>`})}
            </tr>
          </thead>
          <tbody>
            ${t.map(a=>r`
              <tr class="objects-table-row${this._objBulkMode&&this._objBulkSelected.has(a.entry_id)?" bulk-selected":""}"
                ...
                ${this._objBulkMode?r`<td class="oc-bulk"><input type="checkbox" .checked=${this._objBulkSelected.has(a.entry_id)}
                      @click=${n=>n.stopPropagation()} @change=${()=>this._toggleObjBulk(a.entry_id)} /></td>`:h}
    ...
    `}_renderObjectCell(t,e,i){let a=e.object;switch(t){case"name":return r`<td class="oc-name">
          ...
          ${a.document_count?r`<span class="doc-badge" title="${a.document_count} ${s("documents",i)}">
                ...
                @click=${d=>d.stopPropagation()}><ha-icon icon="mdi:file-document-outline"></ha-icon></a>`:n?r`<a href="#" title=${n.title}
                  ...
                  ><ha-icon icon="mdi:file-document-outline"></ha-icon></a>`:"\u2014"}</td>`}case"notes":return r`<td class="oc-notes" title=${a.notes||""}>${a.notes||"\u2014"}</td>`;case"task_count":return r`<td class="oc-task_count">${e.tasks.length}</td>`;case"ref_no":return r`<td class="oc-ref_no">${yt(a)?`#${yt(a)}`:"\u2014"}</td>`;case"actions":return r`<td class="oc-actions">
          <mwc-icon-button title="${s("qr_code",i)}" @click=${n=>{n.stopPropagation(),this._openQrForObject(e.entry_id,a.name)}}>
            <ha-icon icon="mdi:qrcode"></ha-icon>
          </mwc-icon-button>
        </td>`;default:return r`<td></td>`}}_renderWarrantyCell(t,e){let i=we(t);return i.kind==="none"?r`<span class="warranty-none">—</span>`:r`<span class="warranty-chip warranty-${i.kind}">${this._warrantyLabel(i,t,e)}</span>`}async _onSettingsChanged(){await this._loadData()}_renderGroupsSection(){if(!this._features.groups)return h;let t=Object.entries(this._groups),e=this._lang;return r`
      <div class="groups-section">
        ...
        ${t.length===0?r`<div class="hint">${s("no_groups",e)}</div>`:r`
            <div class="groups-grid">
              ${t.map(([i,a])=>{let n=a.task_refs.map(d=>this._getTask(d.entry_id,d.task_id)?.name).filter(Boolean);return r`
                  <div class="group-card">
                    ...
                    ${a.description?r`<div class="group-card-desc">${a.description}</div>`:h}
                    <div class="group-card-tasks">
                      ${n.length>0?n.map(d=>r`<span class="group-task-chip">${d}</span>`):r`<span style="font-size:12px;color:var(--secondary-text-color)">${s("no_tasks_short",e)}</span>`}
                    </div>
                  </div>
                `})}
            </div>
    ...
    `}_renderOverviewRow(t){let e=this._lang,i=t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0,a=0,n=Yt.ok,d=!1;if(i&&t.days_until_due!==null){let _=Zt(t.interval_days,t.days_until_due,t.interval_unit);a=_.pct,d=_.overflow,t.status==="overdue"?n=Yt.overdue:t.status==="due_soon"&&(n=Yt.due_soon)}let o=t.area_id?this.hass?.areas?.[t.area_id]?.name:null,p=t.responsible_user_id?this._userService?.getUserName(t.responsible_user_id):null,u=t.group_names.length>0||o||p,b=this._bulkMode&&this._bulkSelected.has(this._bulkKey(t));return r`
      <div class="task-row${t.enabled?"":" task-disabled"}${b?" bulk-selected":""}${this._splitActive()&&t.entry_id===this._selectedEntryId&&t.task_id===this._selectedTaskId?" selected":""}">
        ...
        <span class="cell-badges">
          ...
          ${t.enabled?h:r`<span class="badge-disabled">${s("disabled",e)}</span>`}
          ${t.nfc_tag_id?r`<span class="nfc-badge" title="${s("nfc_linked",e)}"><ha-icon icon="mdi:nfc-variant"></ha-icon></span>`:h}
          ${t.priority==="high"?r`<span class="priority-badge priority-high" title="${s("priority_high",e)}"><ha-icon icon="mdi:chevron-double-up"></ha-icon></span>`:h}
          ${t.priority==="low"?r`<span class="priority-badge priority-low" title="${s("priority_low",e)}"><ha-icon icon="mdi:chevron-double-down"></ha-icon></span>`:h}
        </span>
        <span class="row-head">
        ...
        <span class="due-cell" @click=${()=>this._showTask(t.entry_id,t.task_id)}>
          ...
          ${i?r`<div class="days-bar"><div class="days-bar-fill${d?" overflow":""}" style="width:${a}%;background:${n}"></div></div>`:h}
          ${t.trigger_config?Ee(t,{trend:Se(t,this._miniStatsData),lang:e}):!i&&t.trigger_active?r`<span style="color:var(--maint-triggered-color);font-weight:600">⚡</span>`:h}
    ...
    `}_actionStyle(){return this._rowActionStyle}async _dismissRowActionNotice(t){let e={row_action_notice_pending:!1};t&&(e.row_action_style="icons"),await ve(this,{type:"maintenance_supporter/global/update",settings:e},{onError:a=>this._showToast(a)})!==void 0&&(this._rowActionNotice=!1,t&&(this._rowActionStyle="icons"),gi())}_renderRowActions(t,e,i,a=!0){let n=this._actionStyle();return n==="buttons"||n==="buttons_compact"?n==="buttons_compact"&&(this.narrow||this.tight)?r`
          <span class="row-actions as-buttons compact">
            <ha-button size="small" appearance="accent" variant="success" title="${s("complete",t)}" aria-label="${s("complete",t)}" @click=${o=>{o.stopPropagation(),e()}}>
              <ha-icon icon="mdi:check"></ha-icon>
            </ha-button>
            ${a?r`
              <ha-button size="small" appearance="outlined" variant="warning" title="${s("skip",t)}" aria-label="${s("skip",t)}" ?disabled=${this._actionLoading} @click=${o=>{o.stopPropagation(),i?.()}}>
                <ha-icon icon="mdi:skip-next"></ha-icon>
              </ha-button>`:h}
          </span>`:r`
        <span class="row-actions as-buttons">
          <ha-button size="small" appearance="accent" variant="success" title="${s("complete",t)}" @click=${o=>{o.stopPropagation(),e()}}>
            <ha-icon slot="start" icon="mdi:check"></ha-icon>${s("complete",t)}
          </ha-button>
          ${a?r`
            <ha-button size="small" appearance="outlined" variant="warning" title="${s("skip",t)}" ?disabled=${this._actionLoading} @click=${o=>{o.stopPropagation(),i?.()}}>
              <ha-icon slot="start" icon="mdi:skip-next"></ha-icon>${s("skip",t)}
            </ha-button>`:h}
        </span>`:r`
      <span class="row-actions">
        <mwc-icon-button class="btn-complete" title="${s("complete",t)}" @click=${d=>{d.stopPropagation(),e()}}>
          <ha-icon icon="mdi:check"></ha-icon>
        </mwc-icon-button>
        ${a?r`
          <mwc-icon-button class="btn-skip" title="${s("skip",t)}" .disabled=${this._actionLoading} @click=${d=>{d.stopPropagation(),i?.()}}>
            <ha-icon icon="mdi:skip-next"></ha-icon>
          </mwc-icon-button>`:h}
      </span>`}_openCompleteDialogForRow(t){let i=this._objects.find(a=>a.entry_id===t.entry_id)?.tasks.find(a=>a.id===t.task_id);this._openCompleteDialog(t.entry_id,t.task_id,t.task_name,this._features.checklists?i?.checklist:void 0,this._features.adaptive&&!!i?.adaptive_config?.enabled)}_renderObjectDetail(){if(!this._selectedEntryId)return h;let t=this._getObject(this._selectedEntryId);if(!t)return r`<p>Object not found.</p>`;let e=t.object,i=this._lang,a=this._isOperator,n=t.tasks.filter(o=>o.archived).length,d=t.tasks.filter(o=>this._showArchived||!o.archived);return r`
      <div class="detail-section">
        <div class="detail-header">
          <h2>${e.name} ${Dt(yt(e),s("ref_number",i))}</h2>
          <div class="action-buttons">
            ${a?h:r`
              <ha-button appearance="filled" @click=${()=>{this._ui("maintenance-task-dialog").then(o=>o?.openCreate(t.entry_id))}}>${s("add_task",i)}</ha-button>
              <ha-button appearance="plain" @click=${()=>{this._ui("maintenance-object-dialog").then(o=>o?.openEdit(t.entry_id,e))}}>${s("edit",i)}</ha-button>
            `}
            <div class="more-menu-wrapper">
        ...
        ${e.paused?r`<p class="meta paused-meta">
              <ha-icon icon="mdi:pause-circle-outline"></ha-icon>
              ${s("object_paused_badge",i)}${e.paused_until?r` — ${s("paused_until_label",i)} ${Q(e.paused_until,i)}`:h}
            </p>`:h}
        ${e.manufacturer||e.model?r`<p class="meta">${[e.manufacturer,e.model].filter(Boolean).join(" ")}</p>`:h}
        ${e.serial_number?r`<p class="meta">${s("serial_number_label",i)}: ${e.serial_number}</p>`:h}
        ${at(e.documentation_url)?r`<p class="meta">${s("documentation_url_label",i)}:
              <a href=${e.documentation_url} target="_blank" rel="noopener noreferrer">${e.documentation_url}</a>
                ...
                ${e.manual_docs.slice(0,3).map((o,p)=>r`${p>0?" \xB7 ":""}<a href="#"
                    @click=${u=>{u.preventDefault(),this._openManualDoc(o)}}>${o.title}</a>`)}${e.manual_docs.length>3?r` … +${e.manual_docs.length-3}`:h}
              </p>`:h}
        ${e.installation_date?r`<p class="meta">${s("installed",i)}: ${Q(e.installation_date,i)}</p>`:h}
        ...
        ${this._renderObjectSection("tasks",s("tasks",i),d.length,()=>r`
        <h3>${s("tasks",i)} (${d.length})${n>0?r`
          <ha-button
            class="archived-toggle ${this._showArchived?"active":""}"
            appearance="plain"
            @click=${()=>{this._showArchived=!this._showArchived}}
        ...
        ${t.tasks.length===0?r`<div class="empty-state-centered">
              ...
              <ha-button appearance="filled" @click=${()=>{this._ui("maintenance-task-dialog").then(o=>o?.openCreate(t.entry_id))}}>${s("add_first_task",i)}</ha-button>
            </div>`:r`<div class="task-table object-tasks">${[...d].sort((o,p)=>{let u={overdue:0,triggered:1,due_soon:2,ok:3};return(u[o.status]??9)-(u[p.status]??9)||(o.days_until_due??99999)-(p.days_until_due??99999)}).map(o=>r`
              <div class="task-row${o.enabled?"":" task-disabled"}">
                <span class="cell-badges">
                  ${this._statusBadge(!!o.archived,!!o.is_done,o.status)}
                  ${o.enabled?h:r`<span class="badge-disabled">${s("disabled",i)}</span>`}
                  ${o.nfc_tag_id?r`<span class="nfc-badge" title="${s("nfc_linked",i)}"><ha-icon icon="mdi:nfc-variant"></ha-icon></span>`:h}
                  ${o.document_count?r`<span class="doc-badge" title="${o.document_count} ${s("documents",i)}"><ha-icon icon="mdi:paperclip"></ha-icon>${o.document_count}</span>`:h}
                </span>
                <span class="cell task-name" @click=${()=>this._showTask(t.entry_id,o.id)}>${this._listRef(t.entry_id,o.id)}${o.name}</span>
                <span class="task-sub${o.responsible_user_id?"":" task-sub-empty"}">${Oe(o,p=>this._userService?.getUserName(p)??null,p=>this._userService?.getPerson(p)??null)}</span>
                <span class="cell type">${s(o.type,i)}</span>
                <span class="due-cell" @click=${()=>this._showTask(t.entry_id,o.id)}>
                  <span class="due-text">${jt(o.days_until_due,i)}</span>
                  ${o.trigger_config?Ee(o,{trend:Se(o,this._miniStatsData),lang:i}):h}
                  ${Re(o,this._miniStatsData,this._lang)}
                </span>
        ...
        ${this._renderObjectSection("documents",s("documents",i),typeof e.document_count=="number"?e.document_count:null,()=>r`
        ...
        ${(t.parts||[]).length||!a?this._renderObjectSection("parts",s("parts_section",i),(t.parts||[]).length,()=>r`
        ...
        ${t.tasks.some(o=>(o.times_performed||0)>0||(o.history||[]).length>0)?this._renderObjectSection("history",s("object_history_section",i),null,()=>r`
    ...
    `}_renderObjectSection(t,e,i,a){let n=this._lang,d=this._objectSectionOverride===t||!this._objectSectionsCollapsed.has(t),o=d?s("section_collapse",n):s("section_expand",n);return r`
      <div class="obj-section ${t} ${d?"open":"collapsed"}" data-section=${t}>
        ...
        ${d?r`<div class="obj-section-body">${a()}</div>`:r`<h3 class="obj-section-title" @click=${()=>this._toggleObjectSection(t)}>
