...
import{a as ye,b as Bt,c as xt,d as Vt,e as Dt,f as xe,g as we,h as ke}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-EMQQ7OLP.js";import{E as He,H as Ne,a as X,b as Ut,c as qt,d as Te,e as je,f as Wt,g as Se,h as Ee,i as j,j as At,k as ut,l as $t,m as Mt,n as ae,o as Gt,p as Yt,q as Ce,r as Re,s as Oe,t as De,u as Ae,v as ze,w as Pe,x as Ie}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-JJOEGJ24.js";import{b as Le}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-4G6WCOA7.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-ZQTC74KA.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-PUBM4BJZ.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-IV6SSGUX.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-HFAK6BJQ.js";import{b as $e}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-BQNPEMSM.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-RGFCMVIO.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-YC2U7NWZ.js";import{a as se}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-EOLJHFO4.js";import{a as Me}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-S2VAROHZ.js";import{a as C}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-HQIWEBBJ.js";import{A as Et,B as yt,F as ve,G as be,I as Rt,J as Ot,K as fe,L as Ft,a as g,b as O,c as r,d as U,f as d,h as D,i as ie,j as ge,k as me,l as k,m,n as Lt,o as Ht,p as Nt,q as a,r as St,s as H,t as _e,u as J,w as F,x as B,z as q}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-KDZNZ7QG.js";var gi=["assignee_pool","required_completion_fields","checklist","labels","history"],mi=["checklist_progress"],_i=["tasks","parts"],vi=["manual_docs","battery_fleet_excluded"];function re(o,c,t=[]){for(let e of c)o[e]===void 0&&(o[e]=[]);for(let e of t)o[e]===void 0&&(o[e]={})}function bi(o){let c=o;re(c,_i),c.object&&typeof c.object=="object"&&re(c.object,vi);for(let t of c.tasks)re(t,gi,mi);return o}function zt(o){for(let c of o)bi(c);return o}function fi(o,c){if(c.objects)return c.objects;let t=c.delta||[],e=c.removed||[];if(!t.length&&!e.length)return null;let i=new Map(o.map(s=>[s.entry_id,s]));for(let s of t)i.set(s.entry_id,s);for(let s of e)i.delete(s);return[...i.values()]}function Fe(o,c){return c.objects&&zt(c.objects),c.delta&&zt(c.delta),fi(o,c)}var P={overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view",objectsCache:"msp-objects-cache",gettingStartedDismissed:"msp-gs-dismissed",batteryRosterSort:"ms_bf_roster_sort"};function it(o){try{return localStorage.getItem(o)}catch{return null}}function Y(o,c){try{localStorage.setItem(o,c)}catch{}}var yi=168*3600*1e3;function Be(){try{let o=it(P.objectsCache);if(!o)return null;let c=JSON.parse(o);return c.v!==ie||!Number.isFinite(c.at)||Date.now()-c.at>yi||!Array.isArray(c.objects)||c.objects.length===0?null:{objects:c.objects,stats:c.stats??null}}catch{return null}}function oe(o,c){if(!(!Array.isArray(o)||o.length===0))try{let t={v:ie,at:Date.now(),objects:o,stats:c};Y(P.objectsCache,JSON.stringify(t))}catch{}}function I(o){return String(o??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}function Ve(o,c,t,e,i,s){let n=[[t.manufacturer,o.manufacturer],[t.model,o.model],[t.serial,o.serial_number],[t.installed,o.installation_date?e(o.installation_date):null],[t.warranty,o.warranty_expiry?e(o.warranty_expiry):null]].filter(([,h])=>!!h),p=c.map(h=>{let u=t.scheduleLabel(h);return`<tr>
      <td>${I(h.name)}</td>
...
${I(o.notes)}</div>`:""}
</body></html>`}function ne(o,c=new Date){if(!o)return{kind:"none",days:null,date:null};let t=new Date(`${o}T00:00:00`);if(isNaN(t.getTime()))return{kind:"none",days:null,date:null};let e=Date.UTC(c.getFullYear(),c.getMonth(),c.getDate()),i=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),s=Math.round((i-e)/864e5);return s<0?{kind:"expired",days:s,date:o}:s<=60?{kind:"expiring",days:s,date:o}:{kind:"valid",days:s,date:o}}var L=o=>String(o??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c]);function Ue(o,c,t,e,i,s,n,p,l,h=[]){let u=[[t.object,L(c)],[t.type,L(t.typeLabel(o.type))],[t.interval,L(i(o))],[t.nextDue,o.next_due?L(e(o.next_due)):"\u2014"],[t.lastDone,o.last_performed?L(e(o.last_performed)):L(t.never)]];o.priority&&o.priority!=="normal"&&u.push([t.priority,L(o.priority)]);let v=(o.checklist||[]).map(y=>`<li><span class="box"></span>${L(y)}</li>`).join(""),_=(y,b)=>y?`<figure class="qr"><img src="${y}" alt="" /><figcaption>${L(b)}</figcaption></figure>`:"";return`<!DOCTYPE html>
...
`;var Kt=class{constructor(c){this._cache=new Map;this._pending=new Map;this.historyFallbackIds=new Set;this._hass=c}updateHass(c){this._hass=c}async getDetailStats(c,t,e=30){return this._getStats(c,e<=35?"hour":"day",e,t)}async getMiniStats(c,t){return this._getStats(c,"day",14,t)}async getBatchMiniStats(c){let t=new Map,e=[];for(let l of c){let h=`${l.entityId}:day:14`,u=this._cache.get(h);u&&Date.now()-u.fetchedAt<3e5?t.set(l.entityId,u.points):e.push(l)}if(e.length===0)return t;let i=e.filter(l=>l.isCounter).map(l=>l.entityId),s=e.filter(l=>!l.isCounter).map(l=>l.entityId),n=new Date(Date.now()-336*60*60*1e3).toISOString(),p=[];return i.length>0&&p.push(this._fetchBatch(i,"day",n,["state","sum","change"],!0,t)),s.length>0&&p.push(this._fetchBatch(s,"day",n,["mean","min","max"],!1,t)),await Promise.all(p),t}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(c,t,e,i){let s=`${c}:${t}:${e}`,n=this._cache.get(s);if(n&&Date.now()-n.fetchedAt<3e5)return n.points;if(this._pending.has(s))return this._pending.get(s);let p=this._fetchAndNormalize(c,t,e,i,s);this._pending.set(s,p);try{return await p}finally{this._pending.delete(s)}}async _fetchAndNormalize(c,t,e,i,s){let n=new Date(Date.now()-e*24*60*60*1e3).toISOString(),p=i?["state","sum","change"]:["mean","min","max"];try{let h=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:n,statistic_ids:[c],period:t,types:p}))[c]||[],u=this._normalizeRows(h,i);if(u.length<2){let v=await this._fetchHistoryFallback(c,n);v.length>=2?(u=v,this.historyFallbackIds.add(c)):this.historyFallbackIds.delete(c)}else this.historyFallbackIds.delete(c);return this._cache.set(s,{entityId:c,fetchedAt:Date.now(),period:t,points:u}),u}catch(l){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${c}:`,l),[]}}async _fetchHistoryFallback(c,t){try{let i=(await this._hass.connection.sendMessagePromise({type:"history/history_during_period",start_time:t,end_time:new Date().toISOString(),entity_ids:[c],minimal_response:!0,no_attributes:!0}))?.[c]||[];if(i.length>1e3){let p=Math.ceil(i.length/500);i=i.filter((l,h)=>h%p===0||h===i.length-1)}let s=[],n=null;for(let p of i){let l=p.s??p.state;if(l==null||l==="unknown"||l==="unavailable")continue;let h;if(l==="on"||l==="open"||l==="true")h=1;else if(l==="off"||l==="closed"||l==="false")h=0;else if(h=parseFloat(l),!Number.isFinite(h))continue;let u=p.lu??p.last_updated??p.last_changed,v=typeof u=="number"?u*1e3:u!=null?Date.parse(u):NaN;Number.isFinite(v)&&(n!=null&&n!==h&&s.push({ts:v,val:n}),s.push({ts:v,val:h}),n=h)}return s.sort((p,l)=>p.ts-l.ts),s.length&&n!=null&&s.push({ts:Date.now(),val:n}),s}catch(e){return console.warn(`[maintenance-supporter] History fallback failed for ${c}:`,e),[]}}async _fetchBatch(c,t,e,i,s,n){try{let p=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:e,statistic_ids:c,period:t,types:i});for(let l of c){let h=p[l]||[],u=this._normalizeRows(h,s);n.set(l,u),this._cache.set(`${l}:${t}:14`,{entityId:l,fetchedAt:Date.now(),period:t,points:u})}}catch(p){console.warn("[maintenance-supporter] Batch statistics fetch failed:",p)}}_normalizeRows(c,t){let e=[];for(let i of c){let s=null;if(t?s=i.state??null:s=i.mean??null,s===null)continue;let n={ts:i.start,val:s};t||(i.min!=null&&(n.min=i.min),i.max!=null&&(n.max=i.max)),e.push(n)}return e.sort((i,s)=>i.ts-s.ts),e}};function gt(o,c){let t=o??0;return t<1024?`${t} B`:t<1024*1024?`${F(t/1024,c,1)} KB`:`${F(t/(1024*1024),c,1)} MB`}var Tt=["manual","warranty","invoice","spare_parts","photo","other"],Qt={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"};function wt(o){return o.title||o.filename||o.url||""}var V=class extends D{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._hint="";this._addingLink=!1;this._linkUrl="";this._linkTitle="";this._category="manual";this._thumbs={};this._lightboxUrl="";this._editingId="";this._editTitle="";this._editCategory="manual";this._dragOver=!1;this._loadedFor=null;this._localeReady=!1}_isImage(t){return t.kind==="file"&&(t.mime||"").startsWith("image/")}async _sign(t){return Bt(this.hass,t.id)}get _lang(){return H(this.hass)}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,J(this._lang).then(()=>this.requestUpdate())),this.hass&&this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error="",this._thumbs={},this._loadThumbs()}catch(t){this._error=C(t,this._lang),this._loaded=!0}}async _loadThumbs(){await Promise.all(this._docs.filter(t=>this._isImage(t)).map(async t=>{try{let e=await this._sign(t);this._thumbs={...this._thumbs,[t.id]:e}}catch{}}))}_category_of(t){return(t.tags||[]).find(i=>Tt.includes(i))||"other"}_labelKeydown(t){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),t.currentTarget.querySelector("input")?.click())}_onFileInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i),e.value=""}_onCameraInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i,"photo"),e.value=""}_onDrop(t){if(t.preventDefault(),this._dragOver=!1,!this.canWrite||this._busy)return;let e=Array.from(t.dataTransfer?.files??[]);e.length&&this._uploadFiles(e)}_onDragOver(t){this.canWrite&&(t.preventDefault(),this._dragOver=!0)}_onDragLeave(t){let e=t.relatedTarget;(!e||!t.currentTarget.contains(e))&&(this._dragOver=!1)}async _uploadFiles(t,e){let i=e??this._category;this._busy=!0,this._error="",this._hint="";let s=0,n=0;try{for(let p of t){let l=new FormData;l.append("entry_id",this.entryId),l.append("tags",i),l.append("file",p,p.name);let h=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:l});if(!h.ok){this._error=h.status===413?a("doc_too_large",this._lang):a("doc_upload_failed",this._lang);continue}let u=await h.json();u.duplicate_in_object?n++:u.deduped&&s++}n?this._hint=a("doc_dup_in_object",this._lang):s&&(this._hint=a("doc_deduped",this._lang)),await this._load()}catch{this._error=a("doc_upload_failed",this._lang)}finally{this._busy=!1}}async _download(t){try{await Vt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=C(e,this._lang)}}async _preview(t){if(this._isImage(t)){this._lightboxUrl=this._thumbs[t.id]||await this._sign(t);return}try{await xt(this.hass,t.id)}catch(e){this._error=C(e,this._lang)}}_openDoc(t){t.kind==="file"?this._preview(t):X(t.url)&&window.open(t.url,"_blank","noopener")}_startEdit(t){this._editingId=t.id,this._editTitle=t.title||"",this._editCategory=this._category_of(t),this._addingLink=!1,this._error=""}_cancelEdit(){this._editingId=""}async _saveEdit(t){let e=(t.tags||[]).filter(s=>!Tt.includes(s)),i=t.kind==="file"?[this._editCategory,...e]:t.tags??[];this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,title:this._editTitle.trim()||t.filename||t.url||"",tags:i}),this._editingId="",await this._load()}catch(s){this._error=C(s,this._lang)}finally{this._busy=!1}}async _delete(t){let e=wt(t);if(window.confirm(a("doc_delete_confirm",this._lang).replace("{name}",e))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:t.id}),await this._load()}catch(i){this._error=C(i,this._lang)}finally{this._busy=!1}}}async _addLink(){let t=this._linkUrl.trim();if(t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/add_link",entry_id:this.entryId,url:t,title:this._linkTitle.trim()||null}),this._linkUrl="",this._linkTitle="",this._addingLink=!1,await this._load()}catch(e){this._error=C(e,this._lang,a("doc_link_invalid",this._lang))}finally{this._busy=!1}}}render(){let t=this._lang;return r`
    ...
    `}_renderDoc(t,e){if(this._editingId===t.id)return this._renderEdit(t,e);let i=t.kind==="file",s=this._category_of(t),n=i?`${a(`doc_cat_${s}`,e)} \xB7 ${gt(t.size,e)}`:a("doc_link_badge",e),p=this._thumbs[t.id];return r`
      <div class="doc-row">
        ${i&&p?r`<img
              class="doc-thumb"
              src=${p}
  ...
  `,g([k({attribute:!1})],V.prototype,"hass",2),g([k({attribute:!1})],V.prototype,"entryId",2),g([k({type:Boolean})],V.prototype,"canWrite",2),g([m()],V.prototype,"_docs",2),g([m()],V.prototype,"_loaded",2),g([m()],V.prototype,"_busy",2),g([m()],V.prototype,"_error",2),g([m()],V.prototype,"_hint",2),g([m()],V.prototype,"_addingLink",2),g([m()],V.prototype,"_linkUrl",2),g([m()],V.prototype,"_linkTitle",2),g([m()],V.prototype,"_category",2),g([m()],V.prototype,"_thumbs",2),g([m()],V.prototype,"_lightboxUrl",2),g([m()],V.prototype,"_editingId",2),g([m()],V.prototype,"_editTitle",2),g([m()],V.prototype,"_editCategory",2),g([m()],V.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",V);var st=class extends D{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._loadedKey="";this._localeReady=!1}get _lang(){return H(this.hass)}get _refId(){return this.partId||this.taskId||""}get _linkField(){return this.partId?"part_ids":"task_ids"}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,J(this._lang).then(()=>this.requestUpdate()));let e=`${this.entryId}|${this._refId}`;this.hass&&this.entryId&&this._refId&&this._loadedKey!==e&&(this._loadedKey=e,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error=""}catch(t){this._error=C(t,this._lang),this._loaded=!0}}_links(t){return t[this._linkField]||[]}_linked(){return this._docs.filter(t=>this._links(t).includes(this._refId))}_available(){return this._docs.filter(t=>!this._links(t).includes(this._refId))}async _setLinks(t,e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,[this._linkField]:e}),await this._load()}catch(i){this._error=C(i,this._lang)}finally{this._busy=!1}}_link(){let t=this._docs.find(e=>e.id===this._attachId);t&&(this._attachId="",this._setLinks(t,[...this._links(t),this._refId]))}_unlink(t){this._setLinks(t,this._links(t).filter(e=>e!==this._refId))}_isPdf(t){return t.mime==="application/pdf"||(t.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(t){return this._isPdf(t)&&this.taskId?t.task_pages?.[this.taskId]:void 0}async _open(t){if(t.kind==="weblink"){X(t.url)&&window.open(t.url,"_blank","noopener");return}let e=this._pageFor(t);try{await xt(this.hass,t.id,e?`#page=${e}`:"")}catch(i){this._error=C(i,this._lang)}}async _setPage(t,e){if(this.taskId){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,task_pages:{[this.taskId]:e}}),await this._load()}catch(i){this._error=C(i,this._lang)}finally{this._busy=!1}}}async _download(t){try{await Vt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=C(e,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return d;let t=this._lang,e=this._linked(),i=this._available();return r`
    ...
    `}_renderRow(t,e){let i=t.kind==="file",s=this._isPdf(t),n=this._pageFor(t),p=(t.tags||[]).find(h=>Tt.includes(h))||"other",l=i?gt(t.size,e):a("doc_link_badge",e);return r`
      <div class="tdoc-row">
        ...
        >
          ...
          <div class="tdoc-meta">
            ${l}${n?r` · <span class="tdoc-pagetag">${a("doc_page",e)} ${n}</span>`:d}
          </div>
        </div>
  ...
  `,g([k({attribute:!1})],Z.prototype,"hass",2),g([k({attribute:!1})],Z.prototype,"entryId",2),g([k({attribute:!1})],Z.prototype,"parts",2),g([k({type:Boolean})],Z.prototype,"canWrite",2),g([k({attribute:!1})],Z.prototype,"currencySymbol",2),g([m()],Z.prototype,"_editing",2),g([m()],Z.prototype,"_busy",2),g([m()],Z.prototype,"_error",2),g([m()],Z.prototype,"_restockFor",2),g([m()],Z.prototype,"_restockQty",2),g([m()],Z.prototype,"_restockInvalid",2),g([m()],Z.prototype,"_docsFor",2);customElements.define("maintenance-parts-section",Z);var wi=new Set(["completed","skipped","reset","missed"]);function We(o){let c=[];for(let t of o)for(let e of t.history??[]){if(!wi.has(e.type))continue;let i=new Date(e.timestamp).getTime();Number.isFinite(i)&&c.push({ts:i,timestamp:e.timestamp,taskId:t.id,taskName:t.name,type:e.type,cost:typeof e.cost=="number"?e.cost:null,duration:typeof e.duration=="number"?e.duration:null,notes:e.notes??null,completedBy:e.completed_by??null,phaseName:e.phase_id&&t.phases?.[e.phase_id]?.name||null})}return c.sort((t,e)=>e.ts-t.ts||t.taskName.localeCompare(e.taskName)),c}function Ge(o,c){let t=c.from?new Date(`${c.from}T00:00:00`).getTime():null,e=c.to?new Date(`${c.to}T00:00:00`).getTime()+864e5:null;return o.filter(i=>!(c.taskId&&i.taskId!==c.taskId||t!=null&&i.ts<t||e!=null&&i.ts>=e))}function Xt(o){let c=0,t=0;for(let e of o)e.type==="completed"&&(c++,e.cost!=null&&(t+=e.cost));return{completed:c,totalCost:t}}function N(o){return String(o??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}function Ye(o,c,t,e,i,s,n,p={}){let l=c.filter(_=>_.type==="completed"),{totalCost:h}=Xt(l),u=[[t.manufacturer,o.manufacturer],[t.model,o.model],[t.serial,o.serial_number],[t.installed,o.installation_date?e(o.installation_date):null]].filter(([,_])=>_).map(([_,y])=>`<div class="meta-row"><span>${N(_)}</span><strong>${N(y)}</strong></div>`).join(""),v=l.map(_=>{let y=[_.notes,_.completedBy?`${t.completedBy}: ${_.completedBy}`:null].filter(Boolean).join(" \xB7 ");return`<tr>
        ...
        <td class="notes">${N(y)||N(t.none)}</td>
      </tr>`}).join(`
`);return`<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<meta name="color-scheme" content="light">
<title>${N(t.title)} \u2014 ${N(o.name)}</title>
<style>
...
<body>
<h1>${N(t.title)} \u2014 ${N(o.name)}</h1>
<p class="sub">${N(t.generated)} ${N(e(n))} \xB7 ${N(t.entriesLabel(l.length))}</p>
...
</html>`}var ki=500,tt=class extends D{constructor(){super(...arguments);this.entryId="";this.object=null;this.tasks=[];this.currencySymbol="\u20AC";this.userName=()=>null;this._full={};this._loading=!1;this._filterTask="";this._from="";this._to="";this._expanded=!1;this._loadedFor=null;this._localeReady=!1}get _lang(){return H(this.hass)}updated(t){super.updated(t),!this._localeReady&&this.hass&&(this._localeReady=!0,J(this._lang).then(()=>this.requestUpdate())),this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._full={},this._filterTask="",this._from="",this._to="",this._loadFullHistories())}async _loadFullHistories(){let t=this.entryId,e=this.tasks;if(!e.length)return;this._loading=!0;let i=await Promise.all(e.map(async s=>{try{let n=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/history",entry_id:t,task_id:s.id});return[s.id,n.history??[]]}catch{return[s.id,s.history??[]]}}));this.entryId===t&&(this._full=Object.fromEntries(i),this._loading=!1)}get _entries(){return We(this.tasks.map(t=>({id:t.id,name:t.name,history:this._full[t.id]??t.history??[]})))}get _capped(){return Object.values(this._full).some(t=>t.length>=ki)}_openTask(t){this.dispatchEvent(new CustomEvent("open-task",{detail:{taskId:t},bubbles:!0,composed:!0}))}_print(t){let e=this._lang,i=this.object;if(!i)return;let s={title:a("service_record_title",e),generated:a("report_generated",e),manufacturer:a("manufacturer",e),model:a("model",e),serial:a("serial_number_label",e),installed:a("installed",e),colDate:a("date",e),colTask:a("task_name",e),colCost:a("cost",e),colDuration:a("duration",e),colNotes:a("notes_label",e),completedBy:a("completed_by",e),totalLabel:a("report_total_cost",e),entriesLabel:l=>`${l} ${a("service_record_entries",e)}`,capNote:a("object_history_cap_note",e),none:"\u2014"},n=t.map(l=>({...l,completedBy:l.completedBy?this.userName(l.completedBy):null})),p=Ye(i,n,s,l=>l?q(l,e):"",l=>`${l} min`,l=>B(l,this.currencySymbol,e),new Date().toISOString(),{capped:this._capped});Dt(p)}render(){let t=this._lang,e=this._entries;if(!e.length&&!this._loading)return d;let i=Ge(e,{taskId:this._filterTask||null,from:this._from||null,to:this._to||null}),{completed:s,totalCost:n}=Xt(i),p=this._expanded?i:i.slice(0,15);return r`
      <div class="section">
        <h3>
              ...
              <div class="bf-rows">
                ${e.low.map(s=>r`
                    <div class="bf-row">
                      ...
                      ${s.available===!1?r`<span class="bf-offline">${a("battery_fleet_offline",t)}</span>`:s.no_sensor?r`<span class="bf-offline bf-nosensor">${a("battery_fleet_no_sensor",t)}</span>`:d}
                ...
                <div class="bf-rows">
                  ${this._sortedRoster(e.all).map(s=>r`
                      <div class="bf-row">
                        ...
                        >
                        <span class="bf-type">${s.quantity}× ${s.battery_type}</span>
                        ${s.no_sensor?r`<span class="bf-offline bf-nosensor">${a("battery_fleet_no_sensor",t)}</span>`:d}
                        ${s.rechargeable?r`<span class="bf-recharge" title=${a("battery_fleet_rechargeable",t)}
                              ><ha-icon icon="mdi:battery-charging-outline"></ha-icon
                            ></span>`:d}
                        ${this._sparkline(s)}
...
`;function Qe(o){let c=window;c.customCards=c.customCards||[],c.customCards.some(t=>t.type===o.type)||c.customCards.push(o)}var rt=class extends D{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(t){if(this._config={...t},t.past_days&&[30,90].includes(t.past_days)?this._pastDays=t.past_days:t.window_days&&[7,14,30,365].includes(t.window_days)&&(this._windowDays=t.window_days,this._pastDays=0),typeof t.user_filter=="string"&&(this._userFilter=t.user_filter),typeof t.object_filter=="string")this._objectFilter=t.object_filter,this._configuredObjects=[];else if(Array.isArray(t.object_filter)){let e=t.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=e.length===1?e[0]:"",this._configuredObjects=e.length>1?e:[]}}getCardSize(){return 6}get _lang(){return H(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(t){if(super.updated(t),St(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=e}catch{}}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){t();return}this._unsub=t}catch{}}_onEventClick(t){if(t.history_timestamp){this._openHistoryEntry(t);return}Ne(t.entry_id,t.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:t.entry_id,task_id:t.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(t){try{let i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:t.entry_id})).tasks?.find(n=>n.id===t.task_id)?.history?.find(n=>n.timestamp===t.history_timestamp);if(!i||He({entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp,type:i.type||"completed",timestamp:i.timestamp||t.history_timestamp,notes:i.notes??null,cost:i.cost??null,duration:i.duration??null,completed_by:i.completed_by??null,used_parts:i.used_parts??null}))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return d;let t=this._lang,e=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,s=this._config.title,n=null;this._userFilter&&(n=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let p=f=>{let et=f.toLowerCase();return this._objects.find(K=>K.entry_id===f||K.object.name.toLowerCase()===et)?.entry_id??null},l=new Set(this._configuredObjects.map(p).filter(f=>f!==null)),h=l.size?this._objects.filter(f=>l.has(f.entry_id)):this._objects,u=this._config.show_object_filter!==!1&&h.length>1,v=this._objectFilter?p(this._objectFilter):null,_=v&&h.some(f=>f.entry_id===v)?h.filter(f=>f.entry_id===v):h,y=new Date;y.setHours(0,0,0,0);let b=this._pastDays>0,E=b?Oe(_,y,this._pastDays,n):Re(_,y,this._windowDays,n),M=Ce(y),R=this._windowDays===365||b,$=R?E.filter(f=>f.events.length>0):E,A=f=>{let et=`cal-status-${f.status}`,ft=f.projected?"cal-event-projected":"",K=f.status==="overdue"&&f.days_until_due!=null?` (${yt(f.days_until_due,t)})`:"",ct=f.projected&&f.interval_days?r`<span class="cal-event-recur">${f.interval_unit&&f.interval_unit!=="days"?`${f.interval_days} ${a("unit_"+f.interval_unit,t)}`:a("cal_every_n_days",t).replace("{n}",String(f.interval_days))}</span>`:d,Q=f.schedule_type==="sensor_based",ht=Q?r`<ha-icon class="cal-event-icon cal-source-sensor"
          ...
          </span>`:d,jt=this._stats?.budget?.currency_symbol||Nt,G=f.history_type?a(f.history_type,t):a(f.status,t);return r`
        <div class="cal-event ${ft}"
          ...
          ${f.avg_cost!=null&&f.avg_cost>0?r`<span class="cal-event-cost">${B(f.avg_cost,jt,t,0)}</span>`:d}
        </div>
      `},S=f=>{let[et,ft,K]=f.date.split("-").map(Number),ct=new Date(et,ft-1,K),Q=f.date===M,ht=ve(ct,t,"short"),_t=be(ct,t,"long");return r`
        <div class="cal-day-row">
          ...
          <div class="cal-day-content">
            ...
            ${f.events.length===0?r`<div class="cal-empty">${a("cal_no_events",t)}</div>`:f.events.map(A)}
          </div>
        </div>
      `};return r`
      <ha-card .header=${s}>
    ...
    `],g([k({attribute:!1})],rt.prototype,"hass",2),g([m()],rt.prototype,"_config",2),g([m()],rt.prototype,"_objects",2),g([m()],rt.prototype,"_stats",2),g([m()],rt.prototype,"_windowDays",2),g([m()],rt.prototype,"_pastDays",2),g([m()],rt.prototype,"_userFilter",2),g([m()],rt.prototype,"_objectFilter",2),g([m()],rt.prototype,"_unsub",2);var $i=[{value:7,key:"cal_editor_window_week"},{value:14,key:"cal_editor_window_fortnight"},{value:30,key:"cal_editor_window_month"},{value:365,key:"cal_editor_window_year"}],Ct=class extends D{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}get _lang(){return H(this.hass)}setConfig(t){this._config={...t}}updated(){let t=this._lang;t&&!_e(t)&&J(t).then(()=>this.requestUpdate())}_valueChanged(t,e){let i={...this._config,[t]:e};t==="show_window_chips"&&e===!0&&delete i.show_window_chips,t==="show_user_filter"&&e===!0&&delete i.show_user_filter,t==="show_object_filter"&&e===!0&&delete i.show_object_filter,t==="title"&&(!e||typeof e=="string"&&e.trim()==="")&&delete i.title,t==="user_filter"&&e===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let t=this._lang,e=this._config.window_days??30,i=this._config.show_window_chips!==!1,s=this._config.show_user_filter!==!1,n=this._config.user_filter??"",p=this._config.title??"";return r`
      <div class="editor">
        ...
        <div class="row">
          ...
          >
            ${$i.map(l=>r`<option value="${l.value}" ?selected=${l.value===e}>${a(l.key,t)}</option>`)}
          </select>
        </div>
  ...
  `],g([k({attribute:!1})],ot.prototype,"hass",2),g([m()],ot.prototype,"_open",2),g([m()],ot.prototype,"_title",2),g([m()],ot.prototype,"_message",2),g([m()],ot.prototype,"_confirmText",2),g([m()],ot.prototype,"_danger",2),g([m()],ot.prototype,"_inputLabel",2),g([m()],ot.prototype,"_inputType",2),g([m()],ot.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",ot);var nt=class extends D{constructor(){super(...arguments);this.objects=[];this._summary=null;this._loaded=!1;this._busy=!1;this._error="";this._query="";this._results=[];this._expanded=!1;this._initiallyLoaded=!1;this._searchTimer=0}get _lang(){return H(this.hass)}updated(t){super.updated(t),t.has("hass")&&this.hass&&!this._initiallyLoaded&&(this._initiallyLoaded=!0,this._load(),J(this._lang).then(()=>this.requestUpdate()))}async _load(){this._busy=!0;try{this._summary=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/storage"}),this._error=""}catch(t){this._error=C(t,this._lang)}finally{this._loaded=!0,this._busy=!1}}_nameFor(t){return this.objects.find(i=>i.object?.id===t)?.object?.name||t.slice(0,8)}_entryFor(t){return this.objects.find(e=>e.object?.id===t)?.entry_id}_toggle(){this._expanded=!this._expanded}_openObject(t){this.dispatchEvent(new CustomEvent("open-object",{detail:{entry_id:t},bubbles:!0,composed:!0}))}_onSearch(t){this._query=t.target.value,clearTimeout(this._searchTimer),this._searchTimer=window.setTimeout(()=>{this._doSearch()},250)}async _doSearch(){let t=this._query.trim();if(!t){this._results=[];return}try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/search",query:t});this._results=e.results||[]}catch(e){this._error=C(e,this._lang),this._results=[]}}async _openResult(t){if(t.kind==="weblink"){X(t.url)&&window.open(t.url,"_blank","noopener");return}try{await xt(this.hass,t.id)}catch(e){this._error=C(e,this._lang)}}_renderResult(t,e){return r`
    ...
    `}render(){if(!this._loaded||!this._summary)return d;let t=this._summary;if(!t.document_count)return d;let e=this._lang,i=Object.entries(t.by_object??{}).filter(([,s])=>s.files>0||s.links>0).map(([s,n])=>({id:s,name:this._nameFor(s),entry:this._entryFor(s),...n})).sort((s,n)=>n.bytes-s.bytes);return r`
      <ha-card>
  ...
  `,g([k({attribute:!1})],mt.prototype,"hass",2),g([m()],mt.prototype,"_open",2),g([m()],mt.prototype,"_busy",2),g([m()],mt.prototype,"_error",2),g([m()],mt.prototype,"_name",2),g([m()],mt.prototype,"_views",2);customElements.get("maintenance-saved-views-dialog")||customElements.define("maintenance-saved-views-dialog",mt);var ji=60,Si=20,Xe=30,Ei={approaching:"\u2197",stable:"\u2192",easing:"\u2198"};function ce(o,c){let t=o.trigger_config;if(!t?.entity_id)return null;let e,i=t.type||"threshold";if(i==="threshold")if(t.trigger_above!=null)e=1;else if(t.trigger_below!=null)e=-1;else return null;else if(i==="counter"||i==="runtime"||i==="state_change")e=1;else return null;let s=c.get(t.entity_id)||[],n=i==="runtime"||i==="state_change",p=s.length>=2?s.map(b=>({ts:b.ts,val:b.val})):n?[]:(o.history||[]).filter(b=>b.trigger_value!=null).map(b=>({ts:new Date(b.timestamp).getTime(),val:b.trigger_value}));if(o.trigger_current_value!=null&&(p=[...p,{ts:Date.now(),val:o.trigger_current_value}]),p.length<2)return null;p.sort((b,E)=>b.ts-E.ts);let l=p.map(b=>b.val),h=Math.max(...l)-Math.min(...l),u=l[l.length-1]-l[0],v=t.trigger_delta_mode&&o.trigger_baseline_value!=null&&t.trigger_target_value!=null?o.trigger_baseline_value+t.trigger_target_value:t.trigger_target_value,_=i==="threshold"?t.trigger_above??t.trigger_below:i==="counter"?v:i==="runtime"?t.trigger_runtime_hours:t.trigger_target_changes,y=typeof _=="number"?Math.max(Math.abs(_-l[0]),h):h;return y===0||Math.abs(u)<y*(typeof _=="number"?.05:.15)?"stable":Math.sign(u)===e?"approaching":"easing"}function de(o,c){let t=o.trigger_config??null;if(!t)return d;let e=t.type||"threshold",i=o.trigger_entity_info?.unit_of_measurement??"",s=0,n="";if(e==="threshold"){let h=o.trigger_current_value??null;if(h==null)return d;let u=t.trigger_above,v=t.trigger_below;if(u!=null&&v!=null){let _=(u+v)/2,y=Math.abs(u-v)/2||1;s=Math.min(100,Math.max(0,Math.abs(h-_)/y*100));let b=Math.abs(h-u)<=Math.abs(h-v)?u:v;n=`${F(h,c?.lang,1)} / ${F(b,c?.lang)} ${i}`}else if(u!=null){let _=o.trigger_entity_info?.min,y=u>0?0:_!=null&&_<u?_:u<0?2*u:-100,b=u-y||1;s=Math.min(100,Math.max(0,(h-y)/b*100)),n=`${F(h,c?.lang,1)} / ${F(u,c?.lang)} ${i}`}else if(v!=null){let _=o.trigger_entity_info?.max,y=_!=null&&_>v?_:v>0?v*2:v<0?0:100,b=y-v||1;s=Math.min(100,Math.max(0,(y-h)/b*100)),n=`${F(h,c?.lang,1)} / ${F(v,c?.lang)} ${i}`}else if(t.trigger_equals!=null||t.trigger_not_equals!=null){let _=t.trigger_equals!=null?`= ${t.trigger_equals}`:`\u2260 ${t.trigger_not_equals}`;n=`${F(h,c?.lang,1)} (${_}${i?` ${i}`:""})`,s=o.trigger_active?100:0}else return d}else if(e==="counter"){let h=t.trigger_target_value||1,u;if(t.trigger_delta_mode?(u=o.trigger_current_delta??null,u==null&&o.trigger_baseline_value!=null&&o.trigger_current_value!=null&&(u=o.trigger_current_value-o.trigger_baseline_value)):u=o.trigger_current_value??null,u==null)return d;s=Math.min(100,Math.max(0,u/h*100)),n=`${F(u,c?.lang,1)} / ${F(h,c?.lang)} ${i}`}else if(e==="state_change"){let h=t.trigger_target_changes||1,u=o.trigger_current_value??null;if(u==null)return d;s=Math.min(100,Math.max(0,u/h*100)),n=`${F(u,c?.lang,0)} / ${F(h,c?.lang,0)}`}else if(e==="runtime"){let h=t.trigger_runtime_hours||100,u=o.trigger_current_value??null;if(u==null)return d;s=Math.min(100,Math.max(0,u/h*100)),n=`${F(u,c?.lang,1)}h / ${F(h,c?.lang)}h`}else if(e==="compound"){let h=t.compound_logic||t.operator||"AND",u=t.conditions?.length||0;n=`${h} (${u})`,s=o.trigger_active?100:0}else return d;let p=s>=100,l=s>90?"var(--error-color, #f44336)":s>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return r`
    <div class="trigger-progress">
      ...
      <span class="trigger-progress-label">${n}${c?.trend?r` <i class="trend-arrow trend-${c.trend}" title="${a(`trend_${c.trend}`,c.lang??"en")}" aria-label="${a(`trend_${c.trend}`,c.lang??"en")}">${Ei[c.trend]}</i>`:d}</span>
    </div>
  `}function pe(o,c,t){if(!o.trigger_config?.entity_id)return d;let e=o.trigger_config.entity_id,i=c.get(e)||[],s=[];if(i.length>=2)s=i.map(S=>({ts:S.ts,val:S.val}));else{if(!o.history)return d;for(let S of o.history)S.trigger_value!=null&&s.push({ts:new Date(S.timestamp).getTime(),val:S.trigger_value})}if(o.trigger_current_value!=null&&s.push({ts:Date.now(),val:o.trigger_current_value}),s.length<2)return d;s.sort((S,f)=>S.ts-f.ts);let n=ji,p=Si,l=s.map(S=>S.val),h=Math.min(...l),u=Math.max(...l),v=u-h||1;h-=v*.1,u+=v*.1;let _=s[0].ts,b=s[s.length-1].ts-_||1,E=S=>(S-_)/b*n,M=S=>2+(1-(S-h)/(u-h))*(p-4),R=s;if(R.length>Xe){let S=Math.ceil(R.length/Xe);R=R.filter((f,et)=>et%S===0||et===R.length-1)}let $=R.map(S=>`${j(E(S.ts))},${j(M(S.val))}`).join(" "),A=o.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return r`
  ...
  `}function Je(o,c){let t=c;if(o.days_until_due==null||!o.interval_days||o.interval_days<=0)return d;let{pct:e,overflow:i}=Ut(o.interval_days,o.days_until_due,o.interval_unit),s="var(--success-color, #4caf50)";return o.status==="overdue"?s="var(--error-color, #f44336)":o.status==="due_soon"&&(s="var(--warning-color, #ff9800)"),r`
  ...
  `}var Jt=210,pt=46,vt=14,bt=12,Ze=14,Mi=20+Ze,Ci=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],W=class extends D{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(t=>{let e=Math.floor(t[0]?.contentRect?.width||0);e&&Math.abs(e-this._width)>2&&(this._width=e)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(t){t!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:t},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let t=this._width||320,e=[...this.points].sort((s,n)=>s.ts-n.ts),i=this.lang;return r`
    ...
    `}_renderSvg(t,e){let i=this.lang,s=t-pt-vt,n=Jt-Mi,p=n-bt,l=1/0,h=-1/0;for(let T of e)l=Math.min(l,T.min??T.val),h=Math.max(h,T.max??T.val);this.thresholdAbove!=null&&(l=Math.min(l,this.thresholdAbove),h=Math.max(h,this.thresholdAbove)),this.thresholdBelow!=null&&(l=Math.min(l,this.thresholdBelow),h=Math.max(h,this.thresholdBelow)),this.targetValue!=null&&(l=Math.min(l,this.targetValue),h=Math.max(h,this.targetValue)),this.forceZero&&(l=Math.min(l,0));let u=(h-l||1)*.06,v=this.forceZero&&l>=0?0:l-u,{ticks:_,niceMin:y,niceMax:b}=At(v,h+u,4);this.forceZero&&l>=0&&y<0&&(y=0,_=_.filter(T=>T>=0));let E=e[0].ts,M=this.projection&&this.projection.length===2?this.projection[1].ts:null,R=M!=null?Math.max(e[e.length-1].ts,M):e[e.length-1].ts,$=R-E||1,A=Gt(E,R),S=T=>pt+(T-E)/$*s,f=T=>bt+(1-(T-y)/(b-y||1))*p,et=e.map(T=>`${j(S(T.ts))},${j(f(T.val))}`).join(" "),ft=`M${j(S(e[0].ts))},${n} `+e.map(T=>`L${j(S(T.ts))},${j(f(T.val))}`).join(" ")+` L${j(S(e[e.length-1].ts))},${n} Z`,K="",ct=e.filter(T=>T.min!=null&&T.max!=null);if(ct.length>=2){let T=ct.map(z=>`${j(S(z.ts))},${j(f(z.max))}`),w=[...ct].reverse().map(z=>`${j(S(z.ts))},${j(f(z.min))}`);K=`M${T[0]} `+T.slice(1).map(z=>`L${z}`).join(" ")+` L${w.join(" L")} Z`}let Q=[];if(this.thresholdBelow!=null){let T=f(this.thresholdBelow);Q.push({y:T,h:Math.max(0,n-T),lineY:T,label:`\u25BC ${ut(this.thresholdBelow,i)}`,labelY:Math.min(n-4,T+13)})}if(this.thresholdAbove!=null){let T=f(this.thresholdAbove);Q.push({y:bt,h:Math.max(0,T-bt),lineY:T,label:`\u25B2 ${ut(this.thresholdAbove,i)}`,labelY:Math.max(bt+11,T-5)})}let ht=e[e.length-1],_t=(this.events||[]).filter(T=>T.ts>=E&&T.ts<=R),jt=Yt(E,R,Math.max(2,Math.min(5,Math.floor(s/110)+1))),G=this._hover;return r`
      <div class="svg-holder">
        ...
        >
          ...
          ${_.map(T=>{let w=f(T);return w<bt-1||w>n+1?d:U`
          ...
          ${K?U`<path d="${K}" fill="var(--primary-color)" opacity="0.08" clip-path="url(#plot)" />`:d}
          ...
          ${this.targetValue!=null?U`<line x1="${pt}" y1="${j(f(this.targetValue))}" x2="${t-vt}" y2="${j(f(this.targetValue))}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${t-vt-4}" y="${j(f(this.targetValue)-5)}" text-anchor="end" class="zone-label">◆ ${ut(this.targetValue,i)} ${this.unit}</text>`:d}
          ...
          ${jt.map((T,w)=>{let z=S(T),ee=w===0?"start":w===jt.length-1?"end":"middle";return U`<text x="${j(z)}" y="${Jt-5}" text-anchor="${ee}" class="tick-label">${Mt(T,i,A)}</text>`})}

          <line x1="${pt}" y1="${n}" x2="${t-vt}" y2="${n}" stroke="var(--divider-color)" stroke-width="1" />

          ${_t.map(T=>{let w=S(T.ts),z=T.type==="completed"?"var(--success-color, #4caf50)":T.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return U`
              <line x1="${j(w)}" y1="${bt}" x2="${j(w)}" y2="${n}" stroke="${z}" stroke-width="1" opacity="0.14" />
              <rect x="${j(w-1.5)}" y="${n+3}" width="3" height="${Ze-6}" rx="1.5" fill="${z}">
    ...
    `}_onPointer(t,e,i,s,n){let l=t.currentTarget.getBoundingClientRect(),h=(t.clientX-l.left)/l.width*n;if(h<pt-8||h>n-vt+8){this._hover=null;return}let u=e[0],v=1/0;for(let _ of e){let y=Math.abs(i(_.ts)-h);y<v&&(v=y,u=_)}this._hover={x:i(u.ts),y:s(u.val),p:u}}};W.styles=O`
  ...
  `,g([k({attribute:!1})],W.prototype,"points",2),g([k({attribute:!1})],W.prototype,"events",2),g([k()],W.prototype,"unit",2),g([k()],W.prototype,"lang",2),g([k({attribute:!1})],W.prototype,"thresholdAbove",2),g([k({attribute:!1})],W.prototype,"thresholdBelow",2),g([k({attribute:!1})],W.prototype,"targetValue",2),g([k({type:Boolean})],W.prototype,"forceZero",2),g([k({attribute:!1})],W.prototype,"projection",2),g([k({attribute:!1})],W.prototype,"rangeDays",2),g([k({type:Boolean})],W.prototype,"showRange",2),g([k({type:Boolean})],W.prototype,"busy",2),g([k({type:Boolean})],W.prototype,"hideOutliers",2),g([k({type:Boolean})],W.prototype,"showOutlierToggle",2),g([m()],W.prototype,"_width",2),g([m()],W.prototype,"_hover",2);customElements.get("maintenance-trigger-chart")||customElements.define("maintenance-trigger-chart",W);function ti(o){let c=(o??"").trim().toLowerCase();return c==="on"||c==="open"||c==="true"?1:c==="off"||c==="closed"||c==="false"?0:null}function Ri(o,c,t){if(o.length<2)return null;let e=t.now??Date.now(),i=Math.max(0,c.trigger_for_minutes??0)*6e4,s=c.trigger_from_state?ti(c.trigger_from_state):null,n=c.trigger_to_state?ti(c.trigger_to_state):null;if(c.trigger_from_state&&s===null||c.trigger_to_state&&n===null)return null;let p=[...o].sort(($,A)=>$.ts-A.ts),l=[];for(let $ of p){let A=l[l.length-1];(!A||A.level!==$.val)&&l.push({start:$.ts,level:$.val})}let h=$=>($+1<l.length?l[$+1].start:e)-l[$].start>=i,u=($,A,S)=>{let f=$[$.length-1];f&&f.val!==S&&$.push({ts:A,val:f.val}),$.push({ts:A,val:S})};if((c.trigger_target_changes??1)===1&&n!==null){let $=[];l.forEach((S,f)=>u($,S.start,S.level===n&&h(f)?1:0));let A=$[$.length-1]?.val??0;return $.push({ts:e,val:A}),{points:$,mode:"alarm"}}let _=t.since??l[0].start,y=0,b=[];for(let $=1;$<l.length;$++){let A=l[$-1],S=l[$];s!==null&&A.level!==s||n!==null&&S.level!==n||!h($)||S.start<_||(y+=1,b.push(S.start))}let E=Math.max(0,(t.current??y)-y),M=[{ts:Math.max(_,l[0].start),val:E}],R=E;for(let $ of b)R+=1,u(M,$,R);return M.push({ts:e,val:R}),{points:M,mode:"count"}}function Oi(o){if(o.length<4)return o;let c=o.map(h=>h.val).sort((h,u)=>h-u),t=h=>{let u=(c.length-1)*h,v=Math.floor(u),_=Math.ceil(u);return c[v]+(c[_]-c[v])*(u-v)},e=t(.25),i=t(.75),s=i-e;if(s===0)return o;let n=e-1.5*s,p=i+1.5*s,l=o.filter(h=>h.val>=n&&h.val<=p);return l.length>=2?l:o}function ei(o,c){let t=o.trigger_config;if(!t)return d;let e=c.lang,i=o.trigger_entity_info,s=o.trigger_entity_infos,n=i?.friendly_name||t.entity_id||"\u2014",p=t.entity_id||"",l=t.entity_ids||(p?[p]:[]),h=i?.unit_of_measurement||"",u=o.trigger_current_value,v=t.type||"threshold",_=l.length>1,y=Di(o,h,c);return r`
    <h3>${a("trigger",e)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${_?r`
            ...
            <div class="trigger-entity-id">${l.map((b,E)=>r`${E>0?", ":""}<span class="entity-link" @click=${M=>Ot(M,b)}>${b}</span>`)}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `:r`
            <div class="trigger-entity-name">${n}</div>
            <div class="trigger-entity-id">${p?r`<span class="entity-link" @click=${b=>Ot(b,p)}>${p}</span>`:""}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `}
        </div>
      ...
      <div class="trigger-limits">
        ...
        ${v==="compound"?r`
          ...
          ${(t.conditions||[]).map((b,E)=>r`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${E+1}. ${a(b.type||"unknown",e)}: ${b.entity_id?r`<span class="entity-link" @click=${M=>Ot(M,b.entity_id)}>${b.entity_id}</span>`:""}</span>
          `)}
        `:d}
      </div>
      ...
      ${s&&s.length>1?r`
        <div class="trigger-entity-list">
          ${s.map(b=>r`
            <span class="trigger-entity-id">${b.friendly_name} (<span class="entity-link" @click=${E=>Ot(E,b.entity_id)}>${b.entity_id}</span>)</span>
          `)}
        </div>
      `:d}
  ...
  `}function Di(o,c,t){let e=o.trigger_config,i=o.trigger_current_value;if(!e||i==null)return null;switch(e.type||"threshold"){case"counter":{let s=e.trigger_target_value;if(s==null||s<=0)return null;if(!e.trigger_delta_mode)return{progress:Math.max(0,i),target:s,unit:c,meter:null};let n=ii(o,si(o,t));return{progress:Math.max(0,i-(n?.value??i)),target:s,unit:c,meter:i}}case"state_change":{let s=e.trigger_target_changes;return s==null||s<=0?null:{progress:Math.max(0,i),target:s,unit:"",meter:null}}case"runtime":{let s=e.trigger_runtime_hours;return s==null||s<=0?null:{progress:Math.max(0,i),target:s,unit:"h",meter:null}}}return null}function ii(o,c){if(o.trigger_baseline_value!=null)return{value:o.trigger_baseline_value,ts:Zt(o)};if(!c.length)return null;let t=Zt(o);if(t==null)return{value:c[0].val,ts:null};let e=c[0],i=Math.abs(c[0].ts-t);for(let s of c){let n=Math.abs(s.ts-t);n<i&&(e=s,i=n)}return{value:e.val,ts:t}}function Zt(o){let c=[...o.history].filter(t=>t.type==="completed"||t.type==="reset").sort((t,e)=>new Date(e.timestamp).getTime()-new Date(t.timestamp).getTime())[0];return c?new Date(c.timestamp).getTime():null}function Ai(o,c){let t=Math.min(999,Math.round(o.progress/o.target*100)),e=t>=100?"over":t>=75?"near":"ok";return r`
    <div class="counter-progress">
      <div class="counter-progress-nums">
        <span class="counter-progress-main">${$t(o.progress,"",c)}<span class="counter-progress-target"> / ${$t(o.target,o.unit,c)}</span></span>
      ...
      <div class="counter-progress-caption">
        ${a("chart_since_service",c)}${o.meter!=null?r` · ${a("current",c)}: ${$t(o.meter,o.unit,c)}`:d}
      </div>
    </div>
  `}function si(o,c){let t=o.trigger_config;if(!t)return[];let e=t.type||"threshold",i=t.entity_id||"",s=e==="runtime"?[]:c.detailStatsData.get(i)||[],n=c.isCounterEntity(t),p=[];if(s.length>=2)for(let h of s){let u={ts:h.ts,val:h.val};!n&&h.min!=null&&h.max!=null&&(u.min=h.min,u.max=h.max),p.push(u)}else for(let h of o.history)h.trigger_value!=null&&p.push({ts:new Date(h.timestamp).getTime(),val:h.trigger_value});let l=!!i&&!!c.historyFallbackIds?.has(i)&&s.length>=2;return o.trigger_current_value!=null&&!l&&p.push({ts:Date.now(),val:o.trigger_current_value}),p.sort((h,u)=>h.ts-u.ts),p}function zi(o,c,t){let e=o.trigger_config;if(!e)return d;let i=e.type||"threshold",s=e.entity_id||"",n=si(o,t),p=null;i==="state_change"&&s&&t.historyFallbackIds?.has(s)&&(p=Ri(n,e,{since:Zt(o),current:o.trigger_current_value??null}),p&&(n=p.points)),i==="runtime"&&e.trigger_runtime_hours&&o.trigger_current_value!=null&&(n=[{ts:Zt(o)??n[0]?.ts??Date.now()-864e5,val:0},{ts:Date.now(),val:Math.max(0,o.trigger_current_value)}]),t.hideOutliers&&(n=Oi(n));let l=n.length<2&&!!s&&t.hasStatsService&&!t.detailStatsData.has(s);if(n.length<2&&!l)return d;let h=!!s&&t.detailStatsData.has(s)&&(t.detailStatsData.get(s)?.length??0)<2,u=Date.now()-t.rangeDays*864e5,v=n.filter($=>$.ts>=u);v.length>=2&&(n=v);let _=null,y=!1;if(i==="counter"&&e.trigger_target_value!=null&&n.length){if(e.trigger_delta_mode){let $=ii(o,n);if($){if($.ts!=null){let A=n.filter(S=>S.ts>=$.ts);A.length>=2&&(n=A)}n=n.map(A=>({...A,val:Math.max(0,A.val-$.value)}))}}_=e.trigger_target_value,y=!0}else i==="state_change"&&e.trigger_target_changes&&p?.mode!=="alarm"?(_=e.trigger_target_changes,y=!0):i==="runtime"&&e.trigger_runtime_hours&&(_=e.trigger_runtime_hours,y=!0);let b=null,E=o.degradation_rate,M=E!=null&&(e.trigger_below!=null&&e.trigger_above==null&&E>0||e.trigger_above!=null&&e.trigger_below==null&&E<0);if(_==null&&E!=null&&!M&&(o.degradation_trend!=="stable"||o.days_until_threshold!=null)&&o.degradation_trend!=="insufficient_data"&&n.length>=2){let $=n[n.length-1];b=[$,{ts:$.ts+30*864e5,val:$.val+E*30}]}let R=o.history.filter($=>["completed","skipped","reset"].includes($.type)).map($=>({ts:new Date($.timestamp).getTime(),type:$.type}));return r`
  ...
  `}var Pi=200,Pt=10,Ii=22;function ai(o,c,t,e,i){let s=o.history.filter(l=>l.type==="completed"&&(l.cost!=null||l.duration!=null));if(s.length<2)return d;let n=s.some(l=>(l.cost??0)>0),p=s.some(l=>(l.duration??0)>0);return!n&&!p?d:r`
  ...
  `}function Li(o,c,t,e){let i=o.history.filter(w=>w.type==="completed"&&(w.cost!=null||w.duration!=null)).map(w=>({ts:new Date(w.timestamp).getTime(),cost:w.cost??0,duration:w.duration??0})).sort((w,z)=>w.ts-z.ts);if(i.length<2)return d;let s=i.some(w=>w.cost>0),n=i.some(w=>w.duration>0);if(!s&&!n)return d;let p=t!=="duration"&&s,l=t!=="cost"&&n,h=p||!l&&s,u=l||!p&&n,v=640,_=Pi,y=h?44:12,b=u?44:12,E=v-y-b,M=_-Ii,R=M-Pt,$=i[0].ts,A=i[i.length-1].ts,S=(A-$||864e5)*.05,f=$-S,et=A+S,ft=Gt($,A),K=w=>y+(w-f)/(et-f)*E,ct=At(0,Math.max(...i.map(w=>w.cost))||1,3),Q=At(0,Math.max(...i.map(w=>w.duration))||1,3),ht=w=>Pt+(1-w/(ct.niceMax||1))*R,_t=w=>Pt+(1-w/(Q.niceMax||1))*R,jt=i.length>1?Math.min(...i.slice(1).map((w,z)=>K(w.ts)-K(i[z].ts))):E,G=Math.max(6,Math.min(22,jt*.55)),T=Yt($,A,Math.max(2,Math.min(4,i.length)));return r`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${v} ${_}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${a("chart_history",c)}">
        ${h?ct.ticks.map(w=>{let z=ht(w);return z<Pt-1||z>M+1?d:U`
            <line x1="${y}" y1="${j(z)}" x2="${v-b}" y2="${j(z)}" stroke="var(--divider-color)" stroke-width="1" opacity="0.55" />
            <text x="${y-6}" y="${j(z+3.5)}" text-anchor="end" fill="var(--primary-color)" font-size="10.5">${ut(w,c)}${e}</text>`}):d}
        ${u?Q.ticks.map(w=>{let z=_t(w);return z<Pt-1||z>M+1?d:U`<text x="${v-b+6}" y="${j(z+3.5)}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="10.5">${ut(w,c)}m</text>`}):d}
        ...
        ${T.map((w,z)=>{let ee=z===0?"start":z===T.length-1?"end":"middle";return U`<text x="${j(K(w))}" y="${_-6}" text-anchor="${ee}" fill="var(--secondary-text-color)" font-size="10">${Mt(w,c,ft)}</text>`})}
      </svg>
    </div>
  ...
  `}var kt=class extends D{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{this._url=await Bt(this.hass,this.docId)}catch{this._failed=!0}}render(){return this._failed||!this.docId?d:this._url?r`
  ...
  `,g([k({attribute:!1})],kt.prototype,"hass",2),g([k()],kt.prototype,"docId",2),g([m()],kt.prototype,"_url",2),g([m()],kt.prototype,"_failed",2);customElements.get("maintenance-history-photo")||customElements.define("maintenance-history-photo",kt);var Hi=["completed","skipped","missed","reset","triggered","trigger_replaced","trigger_removed"];function ri(o,c){let t=c.lang;return r`
    <div class="history-filters-new">
      <div class="filter-chips">
        ${Hi.map(e=>{let i=o.history.filter(s=>s.type===e).length;return i===0?d:r`
  ...
  `}function oi(o,c){let t=c.lang,e=c.filter?o.history.filter(i=>i.type===c.filter):o.history;if(c.search){let i=c.search.toLowerCase();e=e.filter(s=>s.notes?.toLowerCase().includes(i))}return e.length===0?r`<p class="empty">${a("no_history",t)}</p>`:r`
    <div class="history-timeline">
      ${[...e].reverse().map(i=>Ni(i,c))}
    </div>
  `}function Ni(o,c){let t=c.lang,e=["completed","reset","skipped"].includes(o.type);return r`
    <div class="history-entry">
      <div class="history-icon ${o.type}">
        <ha-icon .icon=${Ht[o.type]||"mdi:circle"}></ha-icon>
      </div>
      <div class="history-content">
        ...
        <div class="history-date">${Et(o.timestamp,t)}</div>
        ...
        <div class="history-details">
          ${o.cost!=null?r`<span>${a("cost",t)}: ${B(o.cost,c.currencySymbol,t)}</span>`:d}
          ...
          ${o.reading_value!=null?r`<span>${a("reading_label",t)}: ${o.reading_value}${c.readingUnit?` ${c.readingUnit}`:""}${(()=>{let i=c.readingDelta?.(o);return i==null?"":` (${i>=0?"+":""}${F(i,t,{maximumFractionDigits:3})})`})()}</span>`:d}
        </div>
      </div>
    </div>
  `}function he(o,c){if(!o.responsible_user_id)return d;let t=c(o.responsible_user_id);return t?r`
    <span class="user-badge">
      <ha-icon icon="mdi:account"></ha-icon>
      ${t}
    </span>
  `:d}function Fi(o,c){let t=c.lang,e=c.isOperator,i=o.archived?"archived":o.is_done?"done":o.status==="due_soon"?"warning":o.status||"ok",s=o.archived?a("archived",t):o.is_done?a("completed",t):a(o.status||"ok",t);return r`
    <div class="task-header">
      ...
      <div class="task-header-actions">
        ...
        ${o.allow_skip!==!1?r`<ha-button appearance="outlined" variant="warning" .disabled=${c.actionLoading} @click=${()=>c.promptSkip()}>${a("skip",t)}</ha-button>`:d}
  ...
  `}function Bi(o){let c=o.lang;return r`
    <div class="tab-bar">
  ...
  `}function ni(o,c,t,e){let i=e.collapsedSections.has(o);return r`
  ...
  `}function Vi(o,c){if(!je(o))return d;let t=c.lang,e=o.phase_sequence,i=Te(o.phase_cursor,e.length),s=new Map;for(let n=o.history.length-1;n>=0;n--){let p=o.history[n];p.phase_id&&p.type==="completed"&&!s.has(p.phase_id)&&s.set(p.phase_id,p.timestamp)}return r`
    <div class="phases-card">
      ...
      <div class="phases-strip">
        ${e.map((n,p)=>{let l=o.phases?.[n]?.name||n,h=s.get(n);return r`
  ...
  `}function Ui(o,c){if(!c.features.checklists)return d;let t=Wt(o)?.checklist??(o.checklist||[]);if(t.length===0)return d;let e=c.lang,i=o.checklist_progress||{},s=t.filter(n=>i[n]).length;return r`
          ...
          <li class=${i[n]?"checked":""}>
            <label>
              <input
                type="checkbox"
                .checked=${!!i[n]}
                @change=${p=>c.setChecklistItem(n,p.target.checked)}
              />
              <span>${n}</span>
            </label>
          </li>
  ...
  `}function qi(o,c){let t=X(o.documentation_url)?o.documentation_url:null,e=X(c.objectDocUrl)?c.objectDocUrl:null,i=e?null:(c.objectManualDocs||[])[0];if(!o.notes&&!t&&!e&&!i)return d;let s=c.lang;return r`
  ...
  `}function Wi(o,c){let t=c.lang,e=o.times_performed>0?o.total_cost/o.times_performed:0,i=o.days_until_due!==null&&o.days_until_due!==void 0?o.days_until_due<0?"overdue":o.days_until_due<=o.warning_days?"warning":"":"";return r`
    <div class="kpi-bar">
      <div class="kpi-card">
        <div class="kpi-label">${a("next_due",t)}</div>
        <div class="kpi-value">${o.next_due?q(o.next_due,t):"\u2014"}</div>
        ${c.features.schedule_time&&o.schedule_time?r`<div class="kpi-subtext">${a("at_time",t)} ${o.schedule_time}</div>`:d}
      </div>
      ...
      <div class="kpi-card">
        ...
        <div class="kpi-value">${Rt(o,t)}</div>
      ...
      <div class="kpi-card">
        ...
        <div class="kpi-value">${o.average_duration?F(o.average_duration,t,0):"\u2014"} min</div>
      </div>
    </div>
  `}function Gi(o,c){let t=c.lang;if(!c.features.adaptive||!o.suggested_interval||o.suggested_interval===o.interval_days)return d;if(c.suggestionDismissed)return d;let e=o.suggested_interval;return r`
    <div class="recommendation-card">
      <h4>${a("suggested_interval",t)}</h4>
      ${ze(o.interval_days,e,o.interval_confidence||"medium",t)}
  ...
  `}function Yi(o,c){let t=c.lang,e=o.history.slice(-3).reverse();if(e.length===0)return d;let i=s=>{switch(s){case"completed":return"\u2713";case"triggered":return"\u2297";case"skipped":return"\u21B7";case"reset":return"\u21BA";default:return"\xB7"}};return r`
    <div class="recent-activities">
      ...
      ${e.map(s=>r`
        <div class="activity-item">
          ...
          ${s.cost?r`<span class="activity-badge">${B(s.cost,c.currencySymbol,t,0)}</span>`:d}
  ...
  `}function Ki(o,c){let t=c.lang,e=c.features.adaptive&&o.suggested_interval&&o.suggested_interval!==o.interval_days,i=c.features.seasonal&&o.seasonal_factor&&o.seasonal_factor!==1,s=e||i,n=c.features.adaptive&&o.interval_analysis?.weibull_beta!=null&&o.interval_analysis?.weibull_eta!=null,p=c.features.seasonal&&(o.seasonal_factors?.length===12||o.interval_analysis?.seasonal_factors?.length===12);return r`
    <div class="tab-content overview-tab">
      ...
      <div class="two-column-layout ${s?"":"single-column"}">
        ...
        <div class="right-column">
          ${ai(o,t,c.costDurationToggle,l=>c.setCostDurationToggle(l),c.currencySymbol)}
        </div>
      </div>
      ${n?ni("weibull","weibull_reliability_curve",De(o,t),c):d}
      ${p?ni("seasonal","seasonal_chart_title",r`
            ${Ie(o,t)}
  ...
  `}function Xi(o,c){switch(c.activeTab){case"overview":return Ki(o,c);case"history":return Qi(o,c);default:return d}}function li(o,c){return r`
  ...
  `}var It=class extends D{createRenderRoot(){return this}render(){return!this.task||!this.ctx?d:r`${li(this.task,this.ctx)}`}};g([k({attribute:!1})],It.prototype,"task",2),g([k({attribute:!1})],It.prototype,"ctx",2);customElements.get("maintenance-task-detail-view")||customElements.define("maintenance-task-detail-view",It);function ci(o){if(o.total<=0)return{start:0,end:0,padTop:0,padBottom:0};let c=o.overscan??12,t=Math.max(1,o.step??6),e=Math.max(1,o.rowHeight),i=Math.floor((o.scrollTop-o.listTop)/e),s=Math.ceil(o.viewportHeight/e)+1,n=Math.max(0,i-c);n=Math.floor(n/t)*t;let p=Math.min(o.total,Math.max(i,0)+s+c);return p=Math.min(o.total,Math.ceil(p/t)*t),n>=p&&(n=Math.min(n,Math.max(0,o.total-1)),p=Math.min(o.total,n+Math.max(s,1))),{start:n,end:p,padTop:n*e,padBottom:(o.total-p)*e}}var te={mode:"top",marginTop:0,lastScrollTop:0};function di(o,c){return o==="top"?8:c.viewH-c.paneH-8}function pi(o){let c=o.scrollTop+8-o.layoutTop,t=Math.max(0,o.listH-o.paneH);return{mode:"top",marginTop:c>t?Math.max(0,c):0,lastScrollTop:o.scrollTop}}function hi(o,c){let t=c.scrollTop,e=c.scrollTop>o.lastScrollTop?"down":c.scrollTop<o.lastScrollTop?"up":"none",i=Math.max(0,c.listH-c.paneH),s=c.paneH+16<=c.viewH||c.listH<=c.paneH,{mode:n,marginTop:p}=o;if(s&&(n="top"),n==="top"&&p>0&&e==="up")p=Math.max(0,Math.min(p,c.scrollTop+8-c.layoutTop)),p<=i&&(p=0);else if(!s&&e==="down"&&n==="top"){let l=c.renderedTop-c.layoutTop;l<=i&&(n="bottom",p=Math.max(0,l))}else!s&&e==="up"&&n==="bottom"&&(p=Math.min(Math.max(0,c.renderedTop-c.layoutTop),i),c.scrollTop+8<=c.layoutTop+p&&(n="top",p=0));return{mode:n,marginTop:p,lastScrollTop:t}}var ue=["due_date","object","type","task_name","area","assigned_user","group"],ui=["none","area","group","user","object"],Zi=["today","dashboard","calendar","settings"],ts=["overdue","due_soon","triggered","ok"],x=class extends D{constructor(){super(...arguments);this.narrow=!1;this.tight=!1;this.split=!1;this._tightObserver=null;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._allParts=null;this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._filterLabel=null;this._filterPriority="";this._savedViews=[];this._activeViewId="";this._unsub=null;this._chartRangeDays=(()=>{try{let t=parseInt(it(P.chartRange)||"",10);return[7,30,90,365].includes(t)?t:30}catch{return 30}})();this._hideOutliers=(()=>{try{return it(P.chartHideOutliers)==="1"}catch{return!1}})();this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._operatorWriteEnabled=!1;this._defaultWarningDays=7;this._rowActionStyle="buttons_compact";this._rowActionNotice=!1;this._actionLoading=!1;this._moreMenuOpen=!1;this._objMenuOpen=!1;this._toastMessage="";this._toastUndo=null;this._toastActionLabel="";this._filtersOpen=!1;this._newMenuOpen=!1;this._gsSetupsCount=0;this._gsAdoptCount=0;this._gsLoaded=!1;this._batteryFleetSetupAvailable=!1;this._staleBundle=!1;this._staleChecked=!1;this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab=(()=>{try{let t=it(P.overviewTab);return t==="today"||t==="calendar"?t:"dashboard"}catch{return"dashboard"}})();this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._objectViewMode="cards";this._objectsTableColumns=we;this._showArchived=!1;this._bulkMode=!1;this._bulkSelected=new Set;this._virtStart=0;this._virtEnd=0;this._virtRowHeight=53;this._virtTotalRows=0;this._virtScrollAttached=!1;this._virtRaf=0;this._stickyState=te;this._stickySelectPending=!1;this._stickyRaf=0;this._stickyAttached=!1;this._stickyObserver=null;this._collapsedGroups=new Set;this._collapsedSections=(()=>{try{return new Set(JSON.parse(it(P.collapsedSections)||"[]"))}catch{return new Set}})();this._paletteOpen=!1;this._paletteQuery="";this._paletteActive=0;this._templateGalleryOpen=!1;this._templates=[];this._templateCategories={};this._templateBusy=!1;this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=t=>this._onPopState(t);this._locationChangedHandler=()=>this._onLocationChanged();this._lazyUi=null;this._onStickyScroll=()=>{this._stickyRaf||(this._stickyRaf=requestAnimationFrame(()=>{this._stickyRaf=0,this._updateStickyPane()}))};this._onVirtualScroll=()=>{this._virtRaf||(this._virtRaf=requestAnimationFrame(()=>{this._virtRaf=0,this._updateVirtualWindow()}))};this._deepLinkHandled=!1;this._deepLinkInPlace=!1;this._initialLoadDone=!1;this._kpiRefreshInFlight=!1;this._kpiRefreshPending=!1;this._paletteKeydown=t=>{if(t.key==="/"&&!t.ctrlKey&&!t.metaKey&&!t.altKey&&!this._paletteOpen){let i=t.composedPath()[0];if(i instanceof HTMLElement&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.tagName==="SELECT"||i.isContentEditable))return;t.preventDefault(),this._openPalette();return}if(!this._paletteOpen)return;let e=this._paletteResults;if(t.key==="Escape")t.preventDefault(),this._closePalette();else if(t.key==="ArrowDown")t.preventDefault(),this._paletteActive=Math.min(this._paletteActive+1,e.length-1);else if(t.key==="ArrowUp")t.preventDefault(),this._paletteActive=Math.max(this._paletteActive-1,0);else if(t.key==="Enter"){t.preventDefault();let i=e[this._paletteActive];i&&this._selectPaletteResult(i)}};this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=t=>{let e=t.detail;e?.type==="maintenance-supporter:open-task"&&e.entry_id&&e.task_id&&(t.stopPropagation(),this._showTask(e.entry_id,e.task_id))};this._fullHistory=null;this._onHistoryEntrySaved=async()=>{await this._loadData()}}get _currencySymbol(){return this._budget?.currency_symbol||Nt}get _lang(){return H(this.hass)}get _isOperator(){let t=this.hass?.user;return t?t.is_admin?!1:!(this._operatorWriteEnabled&&this._adminPanelUserIds.includes(t.id)):!0}_ensureLazyUi(){return this._lazyUi||(this._lazyUi=Promise.all([import("/maintenance_supporter_panelfiles/panel-chunks/object-dialog-BHLRGQD6.js"),import("/maintenance_supporter_panelfiles/panel-chunks/task-dialog-TLUUE3TB.js"),import("/maintenance_supporter_panelfiles/panel-chunks/complete-dialog-BJFIKNQJ.js"),import("/maintenance_supporter_panelfiles/panel-chunks/qr-dialog-QY6S5TS2.js"),import("/maintenance_supporter_panelfiles/panel-chunks/adopt-problem-sensors-dialog-4OMKYXZV.js"),import("/maintenance_supporter_panelfiles/panel-chunks/suggested-setups-dialog-FTACNCNH.js"),import("/maintenance_supporter_panelfiles/panel-chunks/settings-view-CKS5NTVT.js")]).then(()=>this.updateComplete)),this._lazyUi}async _ui(t){return await this._ensureLazyUi(),this.shadowRoot?.querySelector(t)??null}connectedCallback(){super.connectedCallback();let t=window.requestIdleCallback,e=()=>this._ensureLazyUi();t?t(e,{timeout:3e3}):window.setTimeout(e,1500),window.addEventListener("popstate",this._popstateHandler),window.addEventListener("location-changed",this._locationChangedHandler),window.addEventListener("keydown",this._paletteKeydown),typeof ResizeObserver<"u"&&(this._tightObserver=new ResizeObserver(i=>{let s=i[0]?.contentRect.width??0;s>0&&(this.tight=s<1e3),s>0&&(this.split=s>=1500)}),this._tightObserver.observe(this)),window.addEventListener("resize",this._onVirtualScroll,{passive:!0});try{let i=it(P.taskSort);i&&ue.includes(i)&&(this._sortMode=i);let s=it(P.objectSort);s&&["alphabetical","due_soonest","task_count"].includes(s)&&(this._objectSortMode=s);let n=it(P.groupBy);n&&ui.includes(n)&&(this._groupByMode=n);let p=it(P.objectView);(p==="cards"||p==="table")&&(this._objectViewMode=p)}catch{}if(this._objects.length===0){let i=Be();i&&(this._objects=i.objects,i.stats&&(this._stats=i.stats))}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),window.removeEventListener("location-changed",this._locationChangedHandler),window.removeEventListener("keydown",this._paletteKeydown),this._tightObserver?.disconnect(),this._tightObserver=null,window.removeEventListener("resize",this._onVirtualScroll),this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onVirtualScroll),this._virtScrollAttached=!1,this._virtRaf&&cancelAnimationFrame(this._virtRaf),this._detachStickyPane(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._initialLoadDone=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}willUpdate(t){super.willUpdate(t),t.has("_groupByMode")&&this._collapsedGroups.size>0&&(this._collapsedGroups=new Set)}updated(t){if(super.updated(t),St(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Kt(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new Me(this.hass),this._userService.getUsers())}let e=this.shadowRoot?.querySelector(".content");e&&!this._virtScrollAttached&&(e.addEventListener("scroll",this._onVirtualScroll,{passive:!0}),this._virtScrollAttached=!0),this._updateVirtualWindow(),this._syncStickyPane(e)}_syncStickyPane(t){let e=this.shadowRoot?.querySelector(".split-pane");if(!e||!t){this._stickyAttached&&this._detachStickyPane();return}this._stickyAttached||(t.addEventListener("scroll",this._onStickyScroll,{passive:!0}),window.addEventListener("resize",this._onStickyScroll),typeof ResizeObserver<"u"&&(this._stickyObserver=new ResizeObserver(this._onStickyScroll)),this._stickyAttached=!0),this._stickyObserver?.observe(e),this._updateStickyPane()}_detachStickyPane(){this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onStickyScroll),window.removeEventListener("resize",this._onStickyScroll),this._stickyObserver?.disconnect(),this._stickyObserver=null,this._stickyRaf&&cancelAnimationFrame(this._stickyRaf),this._stickyRaf=0,this._stickyAttached=!1,this._stickyState=te,this._stickySelectPending=!1}_updateStickyPane(){let t=this.shadowRoot,e=t?.querySelector(".content"),i=t?.querySelector(".split-pane"),s=t?.querySelector(".split-layout"),n=t?.querySelector(".split-list");if(!e||!i||!s||!n)return;let p=e.getBoundingClientRect().top-e.scrollTop,l={scrollTop:e.scrollTop,viewH:e.clientHeight,paneH:i.offsetHeight,listH:n.offsetHeight,layoutTop:s.getBoundingClientRect().top-p,renderedTop:i.getBoundingClientRect().top-p};this._stickySelectPending&&l.scrollTop===this._stickyState.lastScrollTop?this._stickyState=pi(l):(this._stickySelectPending=!1,this._stickyState=hi(this._stickyState,l));let h=this._stickyState;i.style.top=`${di(h.mode,l)}px`,i.style.marginTop=h.marginTop>0?`${h.marginTop}px`:""}_resetStickyPane(){let t=this.shadowRoot?.querySelector(".content");this._stickyState={...te,lastScrollTop:t?.scrollTop??0},this._stickySelectPending=!0}_updateVirtualWindow(){let t=this.shadowRoot?.querySelector(".content"),e=this.shadowRoot?.querySelector(".task-table.virtual");if(!t||!e)return;let i=e.querySelector(".task-row:not(.virt-sizer)");i&&i.offsetHeight>20&&(this._virtRowHeight=i.offsetHeight);let s=e.getBoundingClientRect().top-t.getBoundingClientRect().top+t.scrollTop,n=ci({scrollTop:t.scrollTop,viewportHeight:t.clientHeight,listTop:s,rowHeight:this._virtRowHeight,total:this._virtTotalRows});(n.start!==this._virtStart||n.end!==this._virtEnd)&&(this._virtStart=n.start,this._virtEnd=n.end)}async _loadData(){let[t,e,i,s,n,p]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"}).catch(()=>null)]);if(p&&(this._savedViews=p.views||[]),t&&(this._objects=zt(t.objects),oe(this._objects,e??this._stats??null),this._maybeLoadGettingStarted()),this._detailOpen()&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/status"}).then(l=>{this._batteryFleetSetupAvailable=!!l.available&&!l.configured}).catch(()=>{this._batteryFleetSetupAvailable=!1}),this._staleChecked||(this._staleChecked=!0,this.hass.connection.sendMessagePromise({type:"maintenance_supporter/version"}).then(l=>{this._staleBundle=ge(l?.version)}).catch(()=>{})),e&&(this._stats=e),i&&(this._budget=i),s&&(this._groups=s.groups||{}),n){let l=n;this._features=l.features,this._adminPanelUserIds=l.admin_panel_user_ids||[],this._operatorWriteEnabled=l.operator_write_enabled??!1;let h=l.general?.default_warning_days;typeof h=="number"&&h>=0&&h<=365&&(this._defaultWarningDays=h);let u=l.general?.row_action_style;this._rowActionStyle=u==="icons"||u==="buttons"?u:"buttons_compact",this._rowActionNotice=l.general?.row_action_notice_pending===!0,this._objectsTableColumns=ke(l.objects_table_columns)}this._fetchMiniStatsForOverview(),this._initialLoadDone=!0,this._handleDeepLink()}_onLocationChanged(){if(!this._initialLoadDone||!window.location.search)return;let t=`/${typeof this.panel?.url_path=="string"?this.panel.url_path:"maintenance-supporter"}`,e=window.location.pathname;if(e!==t&&!e.startsWith(`${t}/`))return;this._deepLinkHandled=!1,this._deepLinkInPlace=!0;try{this._handleDeepLink()}finally{this._deepLinkInPlace=!1}history.state?.msp_view||history.replaceState({msp_view:this._view,msp_entry:this._selectedEntryId,msp_task:this._selectedTaskId},"")}_handleDeepLink(){if(this._deepLinkHandled)return;let t=new URLSearchParams(window.location.search),e=t.get("ms_action"),i=()=>{let b=window.location.pathname+window.location.hash;history.replaceState(history.state,"",b)};if(e==="add_object"){this._deepLinkHandled=!0,i(),this._ui("maintenance-object-dialog").then(b=>b?.openCreate());return}if(e==="open_vacation"||e==="open_budget"||e==="open_groups"||e==="open_settings"){if(this._deepLinkHandled=!0,i(),!this.hass?.user?.is_admin)return;this._overviewTab="settings",this._ensureLazyUi().then(()=>requestAnimationFrame(()=>{let b=this.shadowRoot?.querySelector("maintenance-settings-view"),E=e.replace("open_","");b?.scrollToSection?.(E)}));return}let s=t.get("tab"),n=t.get("view"),p=t.get("sort"),l=t.get("status");if(s!==null||n!==null||p!==null||l!==null){if(i(),this._view!=="overview"&&(this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()),Zi.includes(s??"")&&(s!=="settings"||this.hass?.user?.is_admin)&&this._setOverviewTab(s),n!==null){let b=n.trim().toLowerCase(),E=this._savedViews.find(M=>M.id===n)??this._savedViews.find(M=>M.name.trim().toLowerCase()===b);E&&(this._overviewTab!=="dashboard"&&this._setOverviewTab("dashboard"),this._applyView(E.id))}ue.includes(p??"")&&(this._sortMode=p,this._activeViewId="",Y(P.taskSort,this._sortMode)),ts.includes(l??"")&&(this._overviewTab!=="dashboard"&&this._setOverviewTab("dashboard"),this._filterByStatus(l))}let h=t.get("entry_id");if(!h)return;this._deepLinkHandled=!0;let u=t.get("task_id"),v=t.get("action"),_=window.location.pathname+window.location.hash;history.replaceState(history.state,"",_);let y=this._getObject(h);if(!y){this._showOverview();return}if(u){let b=y.tasks.find(E=>E.id===u);if(!b){this._showObject(h);return}this._showTask(h,u),v==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(h,u,b.name,this._features.checklists?b.checklist:void 0,this._features.adaptive&&!!b.adaptive_config?.enabled)}):v==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(h,u,b)})}else this._showObject(h)}_isCounterEntity(t){if(!t)return!1;let e=t.type||"threshold";return e==="counter"||e==="state_change"}async _fetchDetailStats(t,e){if(!this._statsService)return;let i=await this._statsService.getDetailStats(t,e,this._chartRangeDays),s=new Map(this._detailStatsData);s.set(t,i),this._detailStatsData=s}_setChartRange(t){if(t===this._chartRangeDays)return;this._chartRangeDays=t;try{Y(P.chartRange,String(t))}catch{}let e=this._selectedEntryId&&this._selectedTaskId?this._getTask(this._selectedEntryId,this._selectedTaskId):null,i=e?.trigger_config?.entity_id;if(i){let s=new Map(this._detailStatsData);s.delete(i),this._detailStatsData=s,this._fetchDetailStats(i,this._isCounterEntity(e.trigger_config))}}_setHideOutliers(t){if(t!==this._hideOutliers){this._hideOutliers=t;try{Y(P.chartHideOutliers,t?"1":"0")}catch{}}}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let t=[];for(let i of this._objects)for(let s of i.tasks){let n=s.trigger_config?.entity_id;n&&t.push({entityId:n,isCounter:this._isCounterEntity(s.trigger_config)})}if(t.length===0)return;let e=await this._statsService.getBatchMiniStats(t);this._miniStatsData=new Map([...this._miniStatsData,...e])}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e,s=Fe(this._objects,i);s!==null&&(this._objects=s,e.objects&&oe(s,this._stats??null),this._refreshKpis(),this._detailOpen()&&(i.objects||(i.delta||[]).some(n=>n.entry_id===this._selectedEntryId))&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId))},{type:"maintenance_supporter/subscribe",deltas:!0,compact:!0});if(!this.isConnected){t();return}this._unsub=t}catch{}}async _refreshKpis(){if(this._kpiRefreshInFlight){this._kpiRefreshPending=!0;return}this._kpiRefreshInFlight=!0;try{do{this._kpiRefreshPending=!1;let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null)]);if(!this.isConnected)return;t&&(this._stats=t),e&&(this._budget=e)}while(this._kpiRefreshPending)}finally{this._kpiRefreshInFlight=!1}}get _taskRows(){let t=[];for(let v of this._objects)for(let _ of v.tasks){if(!this._showArchived&&_.archived||this._filterStatus&&_.status!==this._filterStatus)continue;if(this._filterUser){let b=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(_.responsible_user_id!==b)continue}if(this._filterLabel&&!(_.labels||[]).includes(this._filterLabel)||this._filterPriority&&(_.priority||"normal")!==this._filterPriority)continue;let y=[];for(let b of Object.values(this._groups))b.task_refs?.some(E=>E.entry_id===v.entry_id&&E.task_id===_.id)&&y.push(b.name);t.push({entry_id:v.entry_id,task_id:_.id,object_name:v.object.name,allow_skip:_.allow_skip!==!1,task_name:_.name,type:_.type,schedule_type:_.schedule_type,status:_.status,days_until_due:_.days_until_due??null,next_due:_.next_due??null,trigger_active:_.trigger_active,trigger_current_value:_.trigger_current_value??null,trigger_current_delta:_.trigger_current_delta??null,trigger_config:_.trigger_config??null,trigger_entity_info:_.trigger_entity_info??null,times_performed:_.times_performed,total_cost:_.total_cost,interval_days:_.interval_days??null,interval_unit:_.interval_unit??null,interval_anchor:_.interval_anchor??null,is_done:_.is_done??!1,archived:_.archived??!1,history:_.history||[],enabled:_.enabled,nfc_tag_id:_.nfc_tag_id??null,priority:_.priority??"normal",labels:_.labels??[],area_id:v.object.area_id??null,responsible_user_id:_.responsible_user_id??null,group_names:y})}let e={overdue:0,triggered:1,due_soon:2,ok:3},i=(v,_)=>(e[v.status]??9)-(e[_.status]??9),s=(v,_)=>(v.days_until_due??99999)-(_.days_until_due??99999),n=(v,_)=>i(v,_)||s(v,_),p=v=>v.area_id&&this.hass?.areas?.[v.area_id]?.name||"",l=v=>v.responsible_user_id&&this._userService?.getUserName(v.responsible_user_id)||"",h=v=>v.group_names[0]||"",u={due_date:n,object:(v,_)=>v.object_name.localeCompare(_.object_name)||n(v,_),type:(v,_)=>v.type.localeCompare(_.type)||n(v,_),task_name:(v,_)=>v.task_name.localeCompare(_.task_name),area:(v,_)=>{let y=p(v),b=p(_);return!y&&b?1:y&&!b?-1:y.localeCompare(b)||n(v,_)},assigned_user:(v,_)=>{let y=l(v),b=l(_);return!y&&b?1:y&&!b?-1:y.localeCompare(b)||n(v,_)},group:(v,_)=>{let y=h(v),b=h(_);return!y&&b?1:y&&!b?-1:y.localeCompare(b)||n(v,_)}};return t.sort(u[this._sortMode]),t}_getObject(t){return this._objects.find(e=>e.entry_id===t)}_getTask(t,e){return this._getObject(t)?.tasks.find(s=>s.id===e)}_pushPanelState(t,e,i){let s={msp_view:t,msp_entry:e||null,msp_task:i||null};this._deepLinkInPlace?history.replaceState(s,""):history.pushState(s,"")}_onPopState(t){let e=t.state;if(e?.msp_view&&(this._view=e.msp_view,this._selectedEntryId=e.msp_entry||null,this._selectedTaskId=e.msp_task||null,this._moreMenuOpen=!1,e.msp_view==="all_parts"&&this._loadAllParts(),e.msp_view==="task"&&e.msp_entry&&e.msp_task)){this._historyFilter=null;let i=this._getTask(e.msp_entry,e.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop()}_showAllParts(){this._pushPanelState("all_parts"),this._view="all_parts",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop(),this._loadAllParts()}async _loadAllParts(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"});this._allParts=t.parts||[]}catch{this._allParts=[]}}_filterByStatus(t){this._filterStatus=t,this._activeViewId="",this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),this._scrollContentToTop()}get _allLabels(){let t=new Set;for(let e of this._objects)for(let i of e.tasks)for(let s of i.labels||[])t.add(s);return[...t].sort((e,i)=>e.localeCompare(i))}get _currentFilters(){return{status:this._filterStatus,user_id:this._filterUser,label:this._filterLabel,priority:this._filterPriority,archived:this._showArchived,sort_mode:this._sortMode,group_by:this._groupByMode}}_applyView(t){if(this._activeViewId=t,!t)return;let e=this._savedViews.find(s=>s.id===t);if(!e)return;let i=e.filters;this._filterStatus=i.status||"",this._filterUser=i.user_id||null,this._filterLabel=i.label||null,this._filterPriority=i.priority||"",this._showArchived=!!i.archived,ue.includes(i.sort_mode)&&(this._sortMode=i.sort_mode),ui.includes(i.group_by)&&(this._groupByMode=i.group_by);try{Y(P.taskSort,this._sortMode),Y(P.groupBy,this._groupByMode)}catch{}this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard")}_openSavedViewsDialog(){this.shadowRoot.querySelector("maintenance-saved-views-dialog")?.open(this._currentFilters,this._savedViews)}_onSavedViewsChanged(t){this._savedViews=t.detail.views||[],this._activeViewId&&!this._savedViews.some(e=>e.id===this._activeViewId)&&(this._activeViewId="")}_scrollContentToTop(){requestAnimationFrame(()=>{let t=this.shadowRoot?.querySelector(".content");t&&t.scrollTo({top:0,behavior:"smooth"})})}_showObject(t){this._pushPanelState("object",t),this._view="object",this._selectedEntryId=t,this._selectedTaskId=null,this._scrollContentToTop()}_splitActive(){return this.split&&!this.narrow&&!this.tight&&this._view==="overview"&&this._overviewTab==="dashboard"&&!this._bulkMode}_detailOpen(){return(this._view==="task"||this._splitActive())&&!!this._selectedEntryId&&!!this._selectedTaskId}_showFullTaskPage(t,e){this._view!=="task"&&(this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._scrollContentToTop())}_showTask(t,e){if(this._splitActive()){this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._resetStickyPane(),this._fetchFullHistory(t,e);let s=this._getTask(t,e);s?.trigger_config?.entity_id&&this._fetchDetailStats(s.trigger_config.entity_id,this._isCounterEntity(s.trigger_config));return}this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._scrollContentToTop(),this._fetchFullHistory(t,e);let i=this._getTask(t,e);if(i?.trigger_config?.entity_id){let s=i.trigger_config.entity_id,n=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(s,n)}}_showToast(t){this._toastTimer&&clearTimeout(this._toastTimer),this._toastUndo=null,this._toastActionLabel="",this._toastMessage=t,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}_showActionToast(t,e,i){this._showUndoToast(t,i),this._toastActionLabel=e}_showUndoToast(t,e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastActionLabel="",this._toastMessage=t,this._toastUndo=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastUndo=null,this._toastTimer=null},7e3)}_runToastUndo(){let t=this._toastUndo;this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage="",this._toastUndo=null,this._toastTimer=null,t?.()}_openPalette(){this._paletteQuery="",this._paletteActive=0,this._paletteOpen=!0,this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".palette-input")?.focus()})}_closePalette(){this._paletteOpen=!1,this._paletteQuery=""}get _paletteResults(){let t=this._paletteQuery.trim().toLowerCase(),e=[];for(let i of this._objects){let s=i.object.name||"";(!t||s.toLowerCase().includes(t))&&e.push({kind:"object",entryId:i.entry_id,label:s,sub:a("object",this._lang)});for(let n of i.tasks){if(n.archived)continue;let p=n.name||"",l=(n.labels||[]).some(h=>h.toLowerCase().includes(t));if(!t||p.toLowerCase().includes(t)||s.toLowerCase().includes(t)||l){let h=(n.labels||[]).length?`  #${(n.labels||[]).join(" #")}`:"";e.push({kind:"task",entryId:i.entry_id,taskId:n.id,label:p,sub:s+h})}}if(e.length>60)break}return e.slice(0,40)}_selectPaletteResult(t){this._closePalette(),t.kind==="task"&&t.taskId?this._showTask(t.entryId,t.taskId):this._showObject(t.entryId)}_renderPalette(){if(!this._paletteOpen)return d;let t=this._lang,e=this._paletteResults;return r`
    ...
    `}_statusBadge(t,e,i){let s=this._lang,n=t?"archived":e?"done":i,p=t?"archived":e?"completed":i,l=t?a("archived",s):e?a("completed",s):a(i,s);return r`<span class="status-badge ${n}" role="img" title="${l}" aria-label="${l}"><ha-icon icon="${Ht[p]||"mdi:circle-medium"}"></ha-icon><span class="status-label">${l}</span></span>`}_setOverviewTab(t){this._overviewTab=t;try{Y(P.overviewTab,t)}catch{}this._scrollContentToTop()}_renderToday(){let t=this._lang,e=this._taskRows,i=h=>`${h.entry_id}:${h.task_id}`,s=e.filter(h=>h.status==="overdue"||h.trigger_active),n=new Set(s.map(i)),p=e.filter(h=>!n.has(i(h))&&h.days_until_due===0);p.forEach(h=>n.add(i(h)));let l=e.filter(h=>!n.has(i(h))&&h.days_until_due!=null&&h.days_until_due>0&&h.days_until_due<=7);return s.length+p.length+l.length===0?r`
    ...
    `}_renderDashboard(){let t=this._stats,e=this._taskRows,i=this._lang,s=this._isOperator,n=this._objects.reduce((l,h)=>l+h.tasks.filter(u=>u.archived).length,0),p=(this._filterStatus?1:0)+(this._filterUser?1:0)+(this._filterLabel?1:0)+(this._filterPriority?1:0)+(this._activeViewId?1:0);return r`
    ...
    `}_renderTaskTable(t){let e=this._bulkMode?" bulk":"";if(this._virtTotalRows=t.length,this.narrow||t.length<120)return r`
      ...
      `;let i=t.length,s=this._virtRowHeight,n=Math.max(0,Math.min(this._virtStart,i)),p=this._virtEnd>0?Math.min(this._virtEnd,i):Math.min(i,40);p<n&&(n=0,p=Math.min(i,40));let l=n*s,h=(i-p)*s;return r`
    ...
    `}_renderVirtSizerRow(t){let e=this._lang,i="",s=!1,n=!1,p=!1;for(let l of t){let h=l.archived?a("archived",e):l.is_done?a("completed",e):a(l.status,e);h.length>i.length&&(i=h),l.enabled||(s=!0),l.nfc_tag_id&&(n=!0),(l.priority==="high"||l.priority==="low")&&(p=!0)}return r`
    ...
    `}_renderGroupedTasks(t,e){let i=new Map,s=a("unassigned",e);for(let l of t){let h=[];this._groupByMode==="area"?h=[(l.area_id?this.hass?.areas?.[l.area_id]?.name:null)||s]:this._groupByMode==="user"?h=[(l.responsible_user_id?this._userService?.getUserName(l.responsible_user_id):null)||s]:this._groupByMode==="group"?h=l.group_names.length>0?l.group_names:[s]:this._groupByMode==="object"&&(h=[l.object_name]);for(let u of h)i.has(u)||i.set(u,[]),i.get(u).push(l)}let n=[...i.entries()].sort(([l],[h])=>l===s&&h!==s?1:h===s&&l!==s?-1:l.localeCompare(h)),p=this._groupByMode==="area"?"mdi:map-marker-outline":this._groupByMode==="group"?"mdi:folder-outline":this._groupByMode==="object"?"mdi:cube-outline":"mdi:account-outline";return r`
...
`),`maintenance_parts_${n}.csv`,"text/csv;charset=utf-8")}async _exportObjectsCsv(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects/csv"}),e=new Date().toISOString().slice(0,10);se(t.csv,`maintenance_objects_${e}.csv`,"text/csv;charset=utf-8")}catch{this._showToast(a("action_error",this._lang))}}_renderObjectsTable(t){let e=this._lang,i=this._objectsTableColumns;return r`
      <div class="objects-table-wrap">
        <table class="objects-table">
          <thead>
            <tr>
              ${i.map(s=>{let n=xe.find(l=>l.key===s),p=n&&n.key!=="actions"?a(n.labelKey,e):"";return r`<th class="oc-${s}">${p}</th>`})}
            </tr>
          </thead>
          <tbody>
            ${t.map(s=>r`
    ...
    `}_openGroupCreate(){this.shadowRoot.querySelector("maintenance-group-dialog")?.openCreate()}_openGroupEdit(t){let e=this._groups[t];e&&this.shadowRoot.querySelector("maintenance-group-dialog")?.openEdit(t,e)}async _deleteGroup(t,e){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");(i?await i.confirm({title:a("delete_group",this._lang),message:a("delete_group_confirm",this._lang).replace("{name}",e),confirmText:a("delete",this._lang)}):confirm(`${a("delete_group_confirm",this._lang).replace("{name}",e)}`))&&await this._runAction({type:"maintenance_supporter/group/delete",group_id:t})}_renderBudgetTiles(){let t=this._budget;if(!t)return d;let e=this._lang,i=this._currencySymbol,s=(n,p,l)=>{if(l!==null){let h=Math.min(100,Math.max(0,p/l*100)),u=h>=100?"var(--error-color, #f44336)":h>=t.alert_threshold_pct?"var(--warning-color, #ff9800)":"var(--success-color, #4caf50)";return r`
        ...
        `}return r`
        <div class="stat-item budget-tile" title="${n}: ${B(p,i,e)}">
          <span class="stat-value budget-tile-value">${B(p,i,e)}</span>
          <span class="stat-label">${n}</span>
        </div>
      `};return r`
    ...
    `}_renderOverviewRow(t){let e=this._lang,i=t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0,s=0,n=Lt.ok,p=!1;if(i&&t.days_until_due!==null){let _=Ut(t.interval_days,t.days_until_due,t.interval_unit);s=_.pct,p=_.overflow,t.status==="overdue"?n=Lt.overdue:t.status==="due_soon"&&(n=Lt.due_soon)}let l=t.area_id?this.hass?.areas?.[t.area_id]?.name:null,h=t.responsible_user_id?this._userService?.getUserName(t.responsible_user_id):null,u=t.group_names.length>0||l||h,v=this._bulkMode&&this._bulkSelected.has(this._bulkKey(t));return r`
