...
`;var wt=class{constructor(r){this._cache=new Map;this._pending=new Map;this._hass=r}updateHass(r){this._hass=r}async getDetailStats(r,e,t=30){return this._getStats(r,t<=35?"hour":"day",t,e)}async getMiniStats(r,e){return this._getStats(r,"day",14,e)}async getBatchMiniStats(r){let e=new Map,t=[];for(let p of r){let u=`${p.entityId}:day:14`,g=this._cache.get(u);g&&Date.now()-g.fetchedAt<3e5?e.set(p.entityId,g.points):t.push(p)}if(t.length===0)return e;let i=t.filter(p=>p.isCounter).map(p=>p.entityId),a=t.filter(p=>!p.isCounter).map(p=>p.entityId),l=new Date(Date.now()-336*60*60*1e3).toISOString(),c=[];return i.length>0&&c.push(this._fetchBatch(i,"day",l,["state","sum","change"],!0,e)),a.length>0&&c.push(this._fetchBatch(a,"day",l,["mean","min","max"],!1,e)),await Promise.all(c),e}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(r,e,t,i){let a=`${r}:${e}:${t}`,l=this._cache.get(a);if(l&&Date.now()-l.fetchedAt<3e5)return l.points;if(this._pending.has(a))return this._pending.get(a);let c=this._fetchAndNormalize(r,e,t,i,a);this._pending.set(a,c);try{return await c}finally{this._pending.delete(a)}}async _fetchAndNormalize(r,e,t,i,a){let l=new Date(Date.now()-t*24*60*60*1e3).toISOString(),c=i?["state","sum","change"]:["mean","min","max"];try{let u=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:l,statistic_ids:[r],period:e,types:c}))[r]||[],g=this._normalizeRows(u,i);return this._cache.set(a,{entityId:r,fetchedAt:Date.now(),period:e,points:g}),g}catch(p){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${r}:`,p),[]}}async _fetchBatch(r,e,t,i,a,l){try{let c=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:t,statistic_ids:r,period:e,types:i});for(let p of r){let u=c[p]||[],g=this._normalizeRows(u,a);l.set(p,g),this._cache.set(`${p}:${e}:14`,{entityId:p,fetchedAt:Date.now(),period:e,points:g})}}catch(c){console.warn("[maintenance-supporter] Batch statistics fetch failed:",c)}}_normalizeRows(r,e){let t=[];for(let i of r){let a=null;if(e?a=i.state??null:a=i.mean??null,a===null)continue;let l={ts:i.start,val:a};e||(i.min!=null&&(l.min=i.min),i.max!=null&&(l.max=i.max)),t.push(l)}return t.sort((i,a)=>i.ts-a.ts),t}};var pe=class{constructor(r){this.usersCache=null;this.cacheTimestamp=0;this.CACHE_TTL_MS=6e4;this.hass=r}updateHass(r){this.hass=r}async getUsers(r=!1){let e=Date.now();if(!r&&this.usersCache&&e-this.cacheTimestamp<this.CACHE_TTL_MS)return this.usersCache;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/users/list"});return this.usersCache=t.users,this.cacheTimestamp=e,this.usersCache}catch(t){return console.error("Failed to fetch users:",t),this.usersCache||[]}}async assignUser(r,e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/assign_user",entry_id:r,task_id:e,user_id:t})}async getTasksByUser(r){return(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tasks/by_user",user_id:r})).tasks}getUserName(r){return!r||!this.usersCache?null:this.usersCache.find(t=>t.id===r)?.name||null}getUser(r){return!r||!this.usersCache?null:this.usersCache.find(e=>e.id===r)||null}getCurrentUserId(){return this.hass.user?.id||null}isCurrentUser(r){return r?r===this.getCurrentUserId():!1}clearCache(){this.usersCache=null,this.cacheTimestamp=0}};var G=class extends S{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return o`
  ...
  `,d([y({attribute:!1})],q.prototype,"hass",2),d([y({attribute:!1})],q.prototype,"entryId",2),d([y({type:Boolean})],q.prototype,"canWrite",2),d([_()],q.prototype,"_docs",2),d([_()],q.prototype,"_loaded",2),d([_()],q.prototype,"_busy",2),d([_()],q.prototype,"_error",2),d([_()],q.prototype,"_hint",2),d([_()],q.prototype,"_addingLink",2),d([_()],q.prototype,"_linkUrl",2),d([_()],q.prototype,"_linkTitle",2),d([_()],q.prototype,"_category",2),d([_()],q.prototype,"_thumbs",2),d([_()],q.prototype,"_lightboxUrl",2),d([_()],q.prototype,"_editingId",2),d([_()],q.prototype,"_editTitle",2),d([_()],q.prototype,"_editCategory",2),d([_()],q.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",q);var js=["manual","warranty","invoice","spare_parts","photo","other"],Cs={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"},J=class extends S{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._loadedKey="";this._localeReady=!1}get _lang(){return this.hass?.language||"en"}get _refId(){return this.partId||this.taskId||""}get _linkField(){return this.partId?"part_ids":"task_ids"}updated(e){super.updated(e),this.hass&&!this._localeReady&&(this._localeReady=!0,V(this._lang).then(()=>this.requestUpdate()));let t=`${this.entryId}|${this._refId}`;this.hass&&this.entryId&&this._refId&&this._loadedKey!==t&&(this._loadedKey=t,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=e.documents||[],this._loaded=!0,this._error=""}catch(e){this._error=j(e,this._lang),this._loaded=!0}}_links(e){return e[this._linkField]||[]}_linked(){return this._docs.filter(e=>this._links(e).includes(this._refId))}_available(){return this._docs.filter(e=>!this._links(e).includes(this._refId))}async _setLinks(e,t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:e.id,[this._linkField]:t}),await this._load()}catch(i){this._error=j(i,this._lang)}finally{this._busy=!1}}_link(){let e=this._docs.find(t=>t.id===this._attachId);e&&(this._attachId="",this._setLinks(e,[...this._links(e),this._refId]))}_unlink(e){this._setLinks(e,this._links(e).filter(t=>t!==this._refId))}_isPdf(e){return e.mime==="application/pdf"||(e.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(e){return this._isPdf(e)&&this.taskId?e.task_pages?.[this.taskId]:void 0}async _open(e){if(e.kind==="weblink"){window.open(e.url,"_blank","noopener");return}let t=this._pageFor(e),i=t?`#page=${t}`:"",a=window.open("about:blank","_blank");try{let l=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:300});a&&(a.location.href=new URL(l.path+i,window.location.origin).href)}catch(l){a&&a.close(),this._error=j(l,this._lang)}}async _setPage(e,t){if(this.taskId){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:e.id,task_pages:{[this.taskId]:t}}),await this._load()}catch(i){this._error=j(i,this._lang)}finally{this._busy=!1}}}async _download(e){try{let t=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:30});$t(t.path,e.filename||e.title||"document")}catch(t){this._error=j(t,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return h;let e=this._lang,t=this._linked(),i=this._available();return o`
    ...
    `}_renderRow(e,t){let i=e.kind==="file",a=this._isPdf(e),l=this._pageFor(e),c=(e.tags||[]).find(u=>js.includes(u))||"other",p=i?he(e.size):s("doc_link_badge",t);return o`
      <div class="tdoc-row">
...
`;var oe=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter)}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){super.updated(e),e.has("hass")&&gt(this.hass?.locale);let t=this.hass?.language;if(t&&!_t(t)&&V(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}_onEventClick(e){if(e.history_timestamp){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,l=null;this._userFilter&&(l=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let c=new Date;c.setHours(0,0,0,0);let p=this._pastDays>0,u=p?Mi(this._objects,c,this._pastDays,l):Ci(this._objects,c,this._windowDays,l),g=tt(c),m=this._windowDays===365||p,v=m?u.filter(f=>f.events.length>0):u,b=f=>{let C=`cal-status-${f.status}`,M=f.projected?"cal-event-projected":"",L=f.status==="overdue"&&f.days_until_due!=null?` (${Math.abs(f.days_until_due)}d ${s("overdue",e).toLowerCase()})`:"",I=f.projected&&f.interval_days?o`<span class="cal-event-recur">${f.interval_unit&&f.interval_unit!=="days"?`${f.interval_days} ${s("unit_"+f.interval_unit,e)}`:s("cal_every_n_days",e).replace("{n}",String(f.interval_days))}</span>`:h,T=f.schedule_type==="sensor_based",ee=T?o`<ha-icon class="cal-event-icon cal-source-sensor"
          ...
          </span>`:h,Z=this._stats?.budget?.currency_symbol||je,U=f.history_type?s(f.history_type,e):s(f.status,e);return o`
        <div class="cal-event ${M}"
          @click=${()=>this._onEventClick(f)}>
          ${ee}
          <span class="cal-status-pill ${C}">${U}</span>
      ...
      `},$=f=>{let[C,M,L]=f.date.split("-").map(Number),I=new Date(C,M-1,L),T=f.date===g,ee=I.toLocaleDateString(e,{weekday:"short"}),te=I.toLocaleDateString(e,{month:"long"});return o`
    ...
    `],d([y({attribute:!1})],oe.prototype,"hass",2),d([_()],oe.prototype,"_config",2),d([_()],oe.prototype,"_objects",2),d([_()],oe.prototype,"_stats",2),d([_()],oe.prototype,"_windowDays",2),d([_()],oe.prototype,"_pastDays",2),d([_()],oe.prototype,"_userFilter",2),d([_()],oe.prototype,"_unsub",2);var Ys=[{value:7,label:"Week (7 days)"},{value:14,label:"Fortnight (14 days)"},{value:30,label:"Month (30 days, default)"},{value:365,label:"Year (365 days, empty days collapsed)"}],Oe=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}setConfig(e){this._config={...e}}_valueChanged(e,t){let i={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete i.show_window_chips,e==="show_user_filter"&&t===!0&&delete i.show_user_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete i.title,e==="user_filter"&&t===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let e=this._config.window_days??30,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.user_filter??"",l=this._config.title??"";return o`
      <div class="editor">
        <div class="row">
...
<body>
  ...
  `}function st(n,r,e=4){if(!isFinite(n)||!isFinite(r))return{ticks:[],niceMin:0,niceMax:1};if(n===r){let u=Math.abs(n)*.1||1;n-=u,r+=u}let t=r-n,i=Math.pow(10,Math.floor(Math.log10(t/Math.max(1,e)))),a=i;for(let u of[1,2,5,10])if(a=i*u,t/a<=e+.5)break;let l=Math.floor(n/a)*a,c=Math.ceil(r/a)*a,p=[];for(let u=l;u<=c+a*1e-6;u+=a)p.push(Math.abs(u)<a*1e-9?0:u);return{ticks:p,niceMin:l,niceMax:c}}function _e(n){let r=Math.abs(n);return r>=1e6?De((n/1e6).toFixed(r>=1e7?0:1))+"M":r>=1e4?De((n/1e3).toFixed(0))+"k":r>=1e3?De((n/1e3).toFixed(1))+"k":r>=100?n.toFixed(0):r>=10||r>=1?De(n.toFixed(1)):r===0?"0":De(n.toFixed(2))}function De(n){return n.replace(/\.0+$/,"").replace(/(\.\d*[1-9])0+$/,"$1")}function Me(n,r,e){let t=n.toLocaleString(e,{maximumFractionDigits:Math.abs(n)>=100?0:1});return r?`${t} ${r}`:t}function qe(n,r,e){let t=new Date(n),i=e?{month:"short",day:"numeric",year:"2-digit"}:{month:"short",day:"numeric"};return t.toLocaleDateString(r,i)}function Jt(n,r){return new Date(n).toLocaleDateString(r,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}function At(n,r){return new Date(n).getFullYear()!==new Date(r).getFullYear()}function jt(n,r,e){if(e<2||r<=n)return[n,r];let t=[];for(let i=0;i<e;i++)t.push(n+(r-n)*i/(e-1));return t}var Ct=210,de=46,fe=14,ye=12,Di=14,ea=20+Di,ta=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],K=class extends S{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(e=>{let t=Math.floor(e[0]?.contentRect?.width||0);t&&Math.abs(t-this._width)>2&&(this._width=t)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(e){e!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:e},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let e=this._width||320,t=[...this.points].sort((a,l)=>a.ts-l.ts),i=this.lang;return o`
    ...
    `}_renderSvg(e,t){let i=this.lang,a=e-de-fe,l=Ct-ea,c=l-ye,p=1/0,u=-1/0;for(let k of t)p=Math.min(p,k.min??k.val),u=Math.max(u,k.max??k.val);this.thresholdAbove!=null&&(p=Math.min(p,this.thresholdAbove),u=Math.max(u,this.thresholdAbove)),this.thresholdBelow!=null&&(p=Math.min(p,this.thresholdBelow),u=Math.max(u,this.thresholdBelow)),this.targetValue!=null&&(p=Math.min(p,this.targetValue),u=Math.max(u,this.targetValue)),this.forceZero&&(p=Math.min(p,0));let g=(u-p||1)*.06,m=this.forceZero&&p>=0?0:p-g,{ticks:v,niceMin:b,niceMax:$}=st(m,u+g,4);this.forceZero&&p>=0&&b<0&&(b=0,v=v.filter(k=>k>=0));let f=t[0].ts,C=t[t.length-1].ts,M=C-f||1,L=At(f,C),I=k=>de+(k-f)/M*a,T=k=>ye+(1-(k-b)/($-b||1))*c,ee=t.map(k=>`${I(k.ts).toFixed(1)},${T(k.val).toFixed(1)}`).join(" "),te=`M${I(t[0].ts).toFixed(1)},${l} `+t.map(k=>`L${I(k.ts).toFixed(1)},${T(k.val).toFixed(1)}`).join(" ")+` L${I(t[t.length-1].ts).toFixed(1)},${l} Z`,Z="",U=t.filter(k=>k.min!=null&&k.max!=null);if(U.length>=2){let k=U.map(z=>`${I(z.ts).toFixed(1)},${T(z.max).toFixed(1)}`),w=[...U].reverse().map(z=>`${I(z.ts).toFixed(1)},${T(z.min).toFixed(1)}`);Z=`M${k[0]} `+k.slice(1).map(z=>`L${z}`).join(" ")+` L${w.join(" L")} Z`}let N=[];if(this.thresholdBelow!=null){let k=T(this.thresholdBelow);N.push({y:k,h:Math.max(0,l-k),lineY:k,label:`\u25BC ${_e(this.thresholdBelow)}`,labelY:Math.min(l-4,k+13)})}if(this.thresholdAbove!=null){let k=T(this.thresholdAbove);N.push({y:ye,h:Math.max(0,k-ye),lineY:k,label:`\u25B2 ${_e(this.thresholdAbove)}`,labelY:Math.max(ye+11,k-5)})}let xe=t[t.length-1],ke=(this.events||[]).filter(k=>k.ts>=f&&k.ts<=C),Re=jt(f,C,Math.max(2,Math.min(5,Math.floor(a/110)+1))),Y=this._hover;return o`
      <div class="svg-holder">
        ...
        >
          <defs>
            <clipPath id="plot"><rect x="${de}" y="${ye}" width="${a}" height="${c}" /></clipPath>
            ${N.length?O`<clipPath id="danger">${N.map(k=>O`<rect x="${de}" y="${k.y.toFixed(1)}" width="${a}" height="${k.h.toFixed(1)}" />`)}</clipPath>`:h}
          ...
          ${v.map(k=>{let w=T(k);return w<ye-1||w>l+1?h:O`
              <line x1="${de}" y1="${w.toFixed(1)}" x2="${e-fe}" y2="${w.toFixed(1)}"
          ...
          ${N.map(k=>O`<rect x="${de}" y="${k.y.toFixed(1)}" width="${a}" height="${k.h.toFixed(1)}"
              fill="url(#dangerHatch)" />`)}

          ${Z?O`<path d="${Z}" fill="var(--primary-color)" opacity="0.08" clip-path="url(#plot)" />`:h}
          ...
          ${N.length?O`<polyline points="${ee}" fill="none" stroke="var(--error-color, #f44336)" stroke-width="2"
                stroke-linejoin="round" stroke-linecap="round" clip-path="url(#danger)" />`:h}

          ${N.map(k=>O`
              <line x1="${de}" y1="${k.lineY.toFixed(1)}" x2="${e-fe}" y2="${k.lineY.toFixed(1)}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${e-fe-4}" y="${k.labelY.toFixed(1)}" text-anchor="end" class="zone-label">${k.label}</text>`)}

          ${this.targetValue!=null?O`<line x1="${de}" y1="${T(this.targetValue).toFixed(1)}" x2="${e-fe}" y2="${T(this.targetValue).toFixed(1)}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${e-fe-4}" y="${(T(this.targetValue)-5).toFixed(1)}" text-anchor="end" class="zone-label">◆ ${_e(this.targetValue)} ${this.unit}</text>`:h}

          ${this.projection&&this.projection.length===2?O`<line x1="${I(this.projection[0].ts).toFixed(1)}" y1="${T(this.projection[0].val).toFixed(1)}"
                x2="${Math.min(I(this.projection[1].ts),e-fe).toFixed(1)}" y2="${T(Math.max(b,Math.min($,this.projection[1].val))).toFixed(1)}"
                stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.8" />`:h}

          ${Re.map((k,w)=>{let z=I(k),Mt=w===0?"start":w===Re.length-1?"end":"middle";return O`<text x="${z.toFixed(1)}" y="${Ct-5}" text-anchor="${Mt}" class="tick-label">${qe(k,i,L)}</text>`})}

          <line x1="${de}" y1="${l}" x2="${e-fe}" y2="${l}" stroke="var(--divider-color)" stroke-width="1" />

          ${ke.map(k=>{let w=I(k.ts),z=k.type==="completed"?"var(--success-color, #4caf50)":k.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return O`
              <line x1="${w.toFixed(1)}" y1="${ye}" x2="${w.toFixed(1)}" y2="${l}" stroke="${z}" stroke-width="1" opacity="0.14" />
              <rect x="${(w-1.5).toFixed(1)}" y="${l+3}" width="3" height="${Di-6}" rx="1.5" fill="${z}">
                <title>${Jt(k.ts,i)}</title>
              </rect>`})}

          ${Y?O`
                <line x1="${Y.x.toFixed(1)}" y1="${ye}" x2="${Y.x.toFixed(1)}" y2="${l}"
                ...
                <circle cx="${Y.x.toFixed(1)}" cy="${Y.y.toFixed(1)}" r="4.5" fill="var(--primary-color)"
                  stroke="var(--card-background-color, #fff)" stroke-width="2" />`:O`<circle cx="${I(xe.ts).toFixed(1)}" cy="${T(xe.val).toFixed(1)}" r="4" fill="var(--primary-color)"
        ...
        ${Y?o`<div
            ...
            >
              <div class="hover-date">${Jt(Y.p.ts,i)}</div>
              <div class="hover-val">
                ${Me(Y.p.val,this.unit,i)}
                ${Y.p.min!=null&&Y.p.max!=null?o`<span class="hover-range">(${_e(Y.p.min)}–${_e(Y.p.max)})</span>`:h}
              </div>
            </div>`:h}
      </div>
    `}_onPointer(e,t,i,a,l){let p=e.currentTarget.getBoundingClientRect(),u=(e.clientX-p.left)/p.width*l;if(u<de-8||u>l-fe+8){this._hover=null;return}let g=t[0],m=1/0;for(let v of t){let b=Math.abs(i(v.ts)-u);b<m&&(m=b,g=v)}this._hover={x:i(g.ts),y:a(g.val),p:g}}};K.styles=A`
  ...
  `,d([y({attribute:!1})],K.prototype,"points",2),d([y({attribute:!1})],K.prototype,"events",2),d([y()],K.prototype,"unit",2),d([y()],K.prototype,"lang",2),d([y({attribute:!1})],K.prototype,"thresholdAbove",2),d([y({attribute:!1})],K.prototype,"thresholdBelow",2),d([y({attribute:!1})],K.prototype,"targetValue",2),d([y({type:Boolean})],K.prototype,"forceZero",2),d([y({attribute:!1})],K.prototype,"projection",2),d([y({attribute:!1})],K.prototype,"rangeDays",2),d([y({type:Boolean})],K.prototype,"showRange",2),d([y({type:Boolean})],K.prototype,"busy",2),d([y({type:Boolean})],K.prototype,"hideOutliers",2),d([y({type:Boolean})],K.prototype,"showOutlierToggle",2),d([_()],K.prototype,"_width",2),d([_()],K.prototype,"_hover",2);customElements.get("maintenance-trigger-chart")||customElements.define("maintenance-trigger-chart",K);function ia(n){if(n.length<4)return n;let r=n.map(u=>u.val).sort((u,g)=>u-g),e=u=>{let g=(r.length-1)*u,m=Math.floor(g),v=Math.ceil(g);return r[m]+(r[v]-r[m])*(g-m)},t=e(.25),i=e(.75),a=i-t;if(a===0)return n;let l=t-1.5*a,c=i+1.5*a,p=n.filter(u=>u.val>=l&&u.val<=c);return p.length>=2?p:n}function qi(n,r){let e=n.trigger_config;if(!e)return h;let t=r.lang,i=n.trigger_entity_info,a=n.trigger_entity_infos,l=i?.friendly_name||e.entity_id||"\u2014",c=e.entity_id||"",p=e.entity_ids||(c?[c]:[]),u=i?.unit_of_measurement||"",g=n.trigger_current_value,m=e.type||"threshold",v=p.length>1,b=sa(n,u,r);return o`
    <h3>${s("trigger",t)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${v?o`
            ...
            <div class="trigger-entity-id">${p.map(($,f)=>o`${f>0?", ":""}<span class="entity-link" @click=${C=>Ce(C,$)}>${$}</span>`)}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `:o`
      ...
      <div class="trigger-limits">
        ...
        ${m==="compound"?o`
          ...
          ${(e.conditions||[]).map(($,f)=>o`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${f+1}. ${s($.type||"unknown",t)}: ${$.entity_id?o`<span class="entity-link" @click=${C=>Ce(C,$.entity_id)}>${$.entity_id}</span>`:""}</span>
          `)}
        `:h}
      </div>
      ...
      ${a&&a.length>1?o`
        <div class="trigger-entity-list">
          ${a.map($=>o`
            <span class="trigger-entity-id">${$.friendly_name} (<span class="entity-link" @click=${f=>Ce(f,$.entity_id)}>${$.entity_id}</span>)</span>
          `)}
        </div>
      `:h}
  ...
  `}function Yi(n,r){return da(n,r)}function da(n,r){let e=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return h;let t=n.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,l=100,c=8,u=l-c-4,g=Math.max(...e,1.5),m=a/12,v=m*.65,b=c+u-1/g*u;return o`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${a} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",r)}">
        ...
        ${e.map(($,f)=>{let C=$/g*u,M=f*m+(m-v)/2,L=c+u-C,I=f===i,T=$<1?"var(--success-color, #4caf50)":$>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return O`
      ...
      <div class="seasonal-labels">
        ${Wi.map(($,f)=>o`<span class="seasonal-label ${f===i?"active-month":""}">${s($,r)}</span>`)}
      </div>
    </div>
  ...
  `}function ua(n,r,e){let t=n.history.filter(w=>w.type==="completed"&&(w.cost!=null||w.duration!=null)).map(w=>({ts:new Date(w.timestamp).getTime(),cost:w.cost??0,duration:w.duration??0})).sort((w,z)=>w.ts-z.ts);if(t.length<2)return h;let i=t.some(w=>w.cost>0),a=t.some(w=>w.duration>0);if(!i&&!a)return h;let l=e!=="duration"&&i,c=e!=="cost"&&a,p=l||!c&&i,u=c||!l&&a,g=640,m=pa,v=p?44:12,b=u?44:12,$=g-v-b,f=m-ha,C=f-at,M=t[0].ts,L=t[t.length-1].ts,I=(L-M||864e5)*.05,T=M-I,ee=L+I,te=At(M,L),Z=w=>v+(w-T)/(ee-T)*$,U=st(0,Math.max(...t.map(w=>w.cost))||1,3),N=st(0,Math.max(...t.map(w=>w.duration))||1,3),xe=w=>at+(1-w/(U.niceMax||1))*C,ke=w=>at+(1-w/(N.niceMax||1))*C,Re=t.length>1?Math.min(...t.slice(1).map((w,z)=>Z(w.ts)-Z(t[z].ts))):$,Y=Math.max(6,Math.min(22,Re*.55)),k=jt(M,L,Math.max(2,Math.min(4,t.length)));return o`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${g} ${m}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_history",r)}">
        ...
        ${u?N.ticks.map(w=>{let z=ke(w);return z<at-1||z>f+1?h:O`<text x="${g-b+6}" y="${(z+3.5).toFixed(1)}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="10.5">${_e(w)}m</text>`}):h}

        ${p?t.filter(w=>w.cost>0).map(w=>O`
          <rect x="${(Z(w.ts)-Y/2).toFixed(1)}" y="${xe(w.cost).toFixed(1)}" width="${Y.toFixed(1)}" height="${(f-xe(w.cost)).toFixed(1)}"
            fill="var(--primary-color)" opacity="0.6" rx="2">
            <title>${qe(w.ts,r,!0)}: ${w.cost.toLocaleString(r)}€${w.duration?` \xB7 ${w.duration}m`:""}</title>
          </rect>
        `):h}
        ${u?O`
          <polyline points="${t.map(w=>`${Z(w.ts).toFixed(1)},${ke(w.duration).toFixed(1)}`).join(" ")}"
            fill="none" stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-linejoin="round" />
          ${t.map(w=>O`
            <circle cx="${Z(w.ts).toFixed(1)}" cy="${ke(w.duration).toFixed(1)}" r="3.5" fill="var(--accent-color, #ff9800)">
              <title>${qe(w.ts,r,!0)}: ${w.duration}m${w.cost?` \xB7 ${w.cost.toLocaleString(r)}\u20AC`:""}</title>
            </circle>
          `)}
        `:h}

        <line x1="${v}" y1="${f}" x2="${g-b}" y2="${f}" stroke="var(--divider-color)" stroke-width="1" />
        ${k.map((w,z)=>{let Mt=z===0?"start":z===k.length-1?"end":"middle";return O`<text x="${Z(w).toFixed(1)}" y="${m-6}" text-anchor="${Mt}" fill="var(--secondary-text-color)" font-size="10">${qe(w,r,te)}</text>`})}
      </svg>
    </div>
    <div class="chart-legend">
  ...
  `,d([y({attribute:!1})],we.prototype,"hass",2),d([y()],we.prototype,"docId",2),d([_()],we.prototype,"_url",2),d([_()],we.prototype,"_failed",2);customElements.get("maintenance-history-photo")||customElements.define("maintenance-history-photo",we);var _a=["completed","skipped","missed","reset","triggered"];function Qi(n,r){let e=r.lang;return o`
