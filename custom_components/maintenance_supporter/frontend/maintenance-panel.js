...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,d([y({attribute:!1})],le.prototype,"hass",2),d([_()],le.prototype,"_open",2),d([_()],le.prototype,"_loading",2),d([_()],le.prototype,"_adopting",2),d([_()],le.prototype,"_error",2),d([_()],le.prototype,"_sensors",2),d([_()],le.prototype,"_selected",2);customElements.get("maintenance-adopt-problem-sensors-dialog")||customElements.define("maintenance-adopt-problem-sensors-dialog",le);var re=class extends S{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._adopting=!1;this._error="";this._setups=[];this._selected=new Set;this._baselines=new Map;this._localeReady=!1;this._toggle=e=>{let t=new Set(this._selected);t.has(e)?t.delete(e):t.add(e),this._selected=t};this._adopt=async()=>{if(!(this._selected.size===0||this._adopting)){this._adopting=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/integration_setups/adopt",selections:[...this._selected].map(t=>{let i={device_id:t},a=this._setups.find(l=>l.device_id===t);for(let l of a?.tasks??[]){let c=this._baselines.get(`${t} ${l.task_name}`),h=c?parseFloat(c):NaN;!isNaN(h)&&h>=0&&((i.baselines??={})[l.task_name]=h)}return i})});this.dispatchEvent(new CustomEvent("integration-setups-adopted",{bubbles:!0,composed:!0,detail:e})),this._open=!1}catch(e){this._error=C(e,this._lang)}finally{this._adopting=!1}}}}get _lang(){return this.hass?.language||"en"}updated(e){e.has("hass")&&this.hass&&!this._localeReady&&(this._localeReady=!0,K(this._lang).then(()=>this.requestUpdate()))}async open(){this._open=!0,this._loading=!0,this._error="",this._setups=[],this._selected=new Set;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/integration_setups/discover"});this._setups=e.setups||[],this._selected=new Set(this._setups.map(t=>t.device_id)),this._baselines=new Map}catch(e){this._error=C(e,this._lang)}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return o``;let e=this._lang;return o`
      <div class="overlay" @click=${this._close}>
                    ...
                    ${this._setups.map(t=>{let i=this._selected.has(t.device_id),a=[t.integration_name,t.area_name].filter(Boolean).join(" \xB7 ");return o`
                        <label class="row">
                          ...
                          <div class="row-main">
                            ...
                            <div class="row-target">
                              → ${t.suggested_object_name}${t.suggested_entry_id?p:o` <span class="new-tag">${s("adopt_problem_new_object",e)}</span>`}
                            </div>
                            <div class="row-tasks">
...
`;var ne=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter)}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){super.updated(e),e.has("hass")&&_t(this.hass?.locale);let t=this.hass?.language;if(t&&!ut(t)&&K(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}_onEventClick(e){if(e.history_timestamp){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return p;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,l=null;this._userFilter&&(l=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let c=new Date;c.setHours(0,0,0,0);let h=this._pastDays>0,u=h?ji(this._objects,c,this._pastDays,l):Ai(this._objects,c,this._windowDays,l),g=Xe(c),m=this._windowDays===365||h,v=m?u.filter(f=>f.events.length>0):u,b=f=>{let j=`cal-status-${f.status}`,I=f.projected?"cal-event-projected":"",L=f.status==="overdue"&&f.days_until_due!=null?` (${Math.abs(f.days_until_due)}d ${s("overdue",e).toLowerCase()})`:"",R=f.projected&&f.interval_days?o`<span class="cal-event-recur">${f.interval_unit&&f.interval_unit!=="days"?`${f.interval_days} ${s("unit_"+f.interval_unit,e)}`:s("cal_every_n_days",e).replace("{n}",String(f.interval_days))}</span>`:p,T=f.schedule_type==="sensor_based",X=T?o`<ha-icon class="cal-event-icon cal-source-sensor"
                ...
                icon="${f.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,ee=T&&f.prediction_confidence&&f.status!=="triggered"&&!f.projected?o`<span class="cal-event-prediction cal-conf-${f.prediction_confidence}">
      ...
      `},$=f=>{let[j,I,L]=f.date.split("-").map(Number),R=new Date(j,I-1,L),T=f.date===g,X=R.toLocaleDateString(e,{weekday:"short"}),ee=R.toLocaleDateString(e,{month:"long"});return o`
        <div class="cal-day-row">
          <div class="cal-day-pill ${T?"cal-today":""}">
            <span class="cal-pill-weekday">${X}</span>
            <span class="cal-pill-day">${R.getDate()}</span>
          </div>
          <div class="cal-day-content">
            <div class="cal-day-header">
              <span class="cal-day-month">${ee}</span>
...
<body>
  ...
  `}function Yt(n,r,e){if(!n.trigger_config?.entity_id)return p;let t=n.trigger_config.entity_id,i=r.get(t)||[],a=[];if(i.length>=2)a=i.map(T=>({ts:T.ts,val:T.val}));else{if(!n.history)return p;for(let T of n.history)T.trigger_value!=null&&a.push({ts:new Date(T.timestamp).getTime(),val:T.trigger_value})}if(n.trigger_current_value!=null&&a.push({ts:Date.now(),val:n.trigger_current_value}),a.length<2)return p;a.sort((T,X)=>T.ts-X.ts);let l=Qs,c=Zs,h=a.map(T=>T.val),u=Math.min(...h),g=Math.max(...h),m=g-u||1;u-=m*.1,g+=m*.1;let v=a[0].ts,$=a[a.length-1].ts-v||1,f=T=>(T-v)/$*l,j=T=>2+(1-(T-u)/(g-u))*(c-4),I=a;if(I.length>Pi){let T=Math.ceil(I.length/Pi);I=I.filter((X,ee)=>ee%T===0||ee===I.length-1)}let L=I.map(T=>`${f(T.ts).toFixed(1)},${j(T.val).toFixed(1)}`).join(" "),R=n.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return o`
    ...
    `}_renderSvg(e,t){let i=this.lang,a=e-de-ve,l=jt-Js,c=l-be,h=1/0,u=-1/0;for(let k of t)h=Math.min(h,k.min??k.val),u=Math.max(u,k.max??k.val);this.thresholdAbove!=null&&(h=Math.min(h,this.thresholdAbove),u=Math.max(u,this.thresholdAbove)),this.thresholdBelow!=null&&(h=Math.min(h,this.thresholdBelow),u=Math.max(u,this.thresholdBelow)),this.targetValue!=null&&(h=Math.min(h,this.targetValue),u=Math.max(u,this.targetValue)),this.forceZero&&(h=Math.min(h,0));let g=(u-h||1)*.06,m=this.forceZero&&h>=0?0:h-g,{ticks:v,niceMin:b,niceMax:$}=tt(m,u+g,4);this.forceZero&&h>=0&&b<0&&(b=0,v=v.filter(k=>k>=0));let f=t[0].ts,j=t[t.length-1].ts,I=j-f||1,L=St(f,j),R=k=>de+(k-f)/I*a,T=k=>be+(1-(k-b)/($-b||1))*c,X=t.map(k=>`${R(k.ts).toFixed(1)},${T(k.val).toFixed(1)}`).join(" "),ee=`M${R(t[0].ts).toFixed(1)},${l} `+t.map(k=>`L${R(k.ts).toFixed(1)},${T(k.val).toFixed(1)}`).join(" ")+` L${R(t[t.length-1].ts).toFixed(1)},${l} Z`,Z="",U=t.filter(k=>k.min!=null&&k.max!=null);if(U.length>=2){let k=U.map(z=>`${R(z.ts).toFixed(1)},${T(z.max).toFixed(1)}`),w=[...U].reverse().map(z=>`${R(z.ts).toFixed(1)},${T(z.min).toFixed(1)}`);Z=`M${k[0]} `+k.slice(1).map(z=>`L${z}`).join(" ")+` L${w.join(" L")} Z`}let N=[];if(this.thresholdBelow!=null){let k=T(this.thresholdBelow);N.push({y:k,h:Math.max(0,l-k),lineY:k,label:`\u25BC ${ue(this.thresholdBelow)}`,labelY:Math.min(l-4,k+13)})}if(this.thresholdAbove!=null){let k=T(this.thresholdAbove);N.push({y:be,h:Math.max(0,k-be),lineY:k,label:`\u25B2 ${ue(this.thresholdAbove)}`,labelY:Math.max(be+11,k-5)})}let fe=t[t.length-1],we=(this.events||[]).filter(k=>k.ts>=f&&k.ts<=j),Ie=At(f,j,Math.max(2,Math.min(5,Math.floor(a/110)+1))),Y=this._hover;return o`
      <div class="svg-holder">
        ...
        >
          ...
          <path d="${ee}" fill="var(--primary-color)" opacity="0.10" clip-path="url(#plot)" />
          <polyline points="${X}" fill="none" stroke="var(--primary-color)" stroke-width="2"
            stroke-linejoin="round" stroke-linecap="round" clip-path="url(#plot)" />
          ${N.length?D`<polyline points="${X}" fill="none" stroke="var(--error-color, #f44336)" stroke-width="2"
          ...
          ${Ie.map((k,w)=>{let z=R(k),Ct=w===0?"start":w===Ie.length-1?"end":"middle";return D`<text x="${z.toFixed(1)}" y="${jt-5}" text-anchor="${Ct}" class="tick-label">${Oe(k,i,L)}</text>`})}
  ...
  `}function ra(n,r,e,t,i){let b=Math.max(e,t,r,1)*1.3,$=50,f=[];for(let U=0;U<=$;U++){let N=U/$*b,fe=1-Math.exp(-Math.pow(N/r,n)),we=32+N/b*260,Ie=136-fe*128;f.push([we,Ie])}let j=f.map(([U,N])=>`${U.toFixed(1)},${N.toFixed(1)}`).join(" "),I="M32,136 "+f.map(([U,N])=>`L${U.toFixed(1)},${N.toFixed(1)}`).join(" ")+` L${f[$][0].toFixed(1)},136 Z`,L=32+e/b*260,R=1-Math.exp(-Math.pow(e/r,n)),T=136-R*128,X=((1-R)*100).toFixed(0),ee=32+t/b*260,Z=[0,.25,.5,.75,1];return o`
      ...
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",i)}">
        ...
        ${e>0?D`
          ...
          <text x="${(L+4).toFixed(1)}" y="${(T-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${X}%</text>
        `:p}
  ...
  `}function Wi(n,r){return la(n,r)}function la(n,r){let e=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return p;let t=n.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,l=100,c=8,u=l-c-4,g=Math.max(...e,1.5),m=a/12,v=m*.65,b=c+u-1/g*u;return o`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${a} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",r)}">
        ...
        ${e.map(($,f)=>{let j=$/g*u,I=f*m+(m-v)/2,L=c+u-j,R=f===i,T=$<1?"var(--success-color, #4caf50)":$>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return D`
  ...
  `}function pa(n,r,e){let t=n.history.filter(w=>w.type==="completed"&&(w.cost!=null||w.duration!=null)).map(w=>({ts:new Date(w.timestamp).getTime(),cost:w.cost??0,duration:w.duration??0})).sort((w,z)=>w.ts-z.ts);if(t.length<2)return p;let i=t.some(w=>w.cost>0),a=t.some(w=>w.duration>0);if(!i&&!a)return p;let l=e!=="duration"&&i,c=e!=="cost"&&a,h=l||!c&&i,u=c||!l&&a,g=640,m=ca,v=h?44:12,b=u?44:12,$=g-v-b,f=m-da,j=f-it,I=t[0].ts,L=t[t.length-1].ts,R=(L-I||864e5)*.05,T=I-R,X=L+R,ee=St(I,L),Z=w=>v+(w-T)/(X-T)*$,U=tt(0,Math.max(...t.map(w=>w.cost))||1,3),N=tt(0,Math.max(...t.map(w=>w.duration))||1,3),fe=w=>it+(1-w/(U.niceMax||1))*j,we=w=>it+(1-w/(N.niceMax||1))*j,Ie=t.length>1?Math.min(...t.slice(1).map((w,z)=>Z(w.ts)-Z(t[z].ts))):$,Y=Math.max(6,Math.min(22,Ie*.55)),k=At(I,L,Math.max(2,Math.min(4,t.length)));return o`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${g} ${m}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_history",r)}">
        ...
        ${k.map((w,z)=>{let Ct=z===0?"start":z===k.length-1?"end":"middle";return D`<text x="${Z(w).toFixed(1)}" y="${m-6}" text-anchor="${Ct}" fill="var(--secondary-text-color)" font-size="10">${Oe(w,r,ee)}</text>`})}
      </svg>
    </div>
    <div class="chart-legend">
