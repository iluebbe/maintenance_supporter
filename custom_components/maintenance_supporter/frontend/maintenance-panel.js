...
`).map(c=>c.trim()).filter(Boolean).slice(0,100);e.checklist=r.length?r:null}let t=await this.hass.connection.sendMessagePromise(e),a=this._taskId||t?.task_id,s=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(a&&this._scheduleType==="sensor_based"&&s)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=G(e,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return d;let e=this._lang;return o`
      ...
      <div class="select-row">
        ...
        >
          ${ka.map(t=>o`<option value=${t} ?selected=${t===this._triggerType}>${i(t,e)}</option>`)}
        </select>
      </div>
    ...
    `}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?o`
      ...
      `:this._triggerType==="runtime"?o`
        ...
        ></ha-textfield>
      `:d}render(){if(!this._open)return o``;let e=this._lang,t=this._taskId?i("edit_task",e):i("new_task",e);return o`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._error?o`<div class="error">${this._error}</div>`:d}
          ${this._objectChoices.length>0?o`
            <div class="select-row">
              ...
              >
                ${this._objectChoices.map(a=>o`<option value=${a.entry_id} ?selected=${a.entry_id===this._entryId}>${a.name}</option>`)}
              </select>
            </div>
          `:d}
          <ha-textfield
          ...
          <div class="select-row">
            ...
            >
              ${ba.map(a=>o`<option value=${a} ?selected=${a===this._type}>${i(a,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${ya.map(a=>o`<option value=${a} ?selected=${a===this._scheduleType}>${i(a,e)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ...
              ${this._availableUsers.map(a=>o`<option value=${a.id} ?selected=${a.id===this._responsibleUserId}>${a.name}</option>`)}
            </select>
          </div>
          ...
          ${this._availableTags.length>0?o`
              <div class="select-row">
                ...
                >
                  ...
                  ${this._availableTags.map(a=>o`<option value=${a.id} ?selected=${a.id===this._nfcTagId}>${a.name}</option>`)}
                </select>
              </div>
            `:o`
              <ha-textfield
  ...
  `,p([$({attribute:!1})],k.prototype,"hass",2),p([$({type:Boolean,attribute:"checklists-enabled"})],k.prototype,"checklistsEnabled",2),p([$({type:Boolean,attribute:"schedule-time-enabled"})],k.prototype,"scheduleTimeEnabled",2),p([$({type:Number,attribute:"default-warning-days"})],k.prototype,"defaultWarningDays",2),p([u()],k.prototype,"_open",2),p([u()],k.prototype,"_loading",2),p([u()],k.prototype,"_error",2),p([u()],k.prototype,"_entryId",2),p([u()],k.prototype,"_taskId",2),p([u()],k.prototype,"_objectChoices",2),p([u()],k.prototype,"_name",2),p([u()],k.prototype,"_type",2),p([u()],k.prototype,"_scheduleType",2),p([u()],k.prototype,"_intervalDays",2),p([u()],k.prototype,"_warningDays",2),p([u()],k.prototype,"_intervalAnchor",2),p([u()],k.prototype,"_notes",2),p([u()],k.prototype,"_documentationUrl",2),p([u()],k.prototype,"_customIcon",2),p([u()],k.prototype,"_enabled",2),p([u()],k.prototype,"_triggerEntityId",2),p([u()],k.prototype,"_triggerEntityIds",2),p([u()],k.prototype,"_triggerEntityLogic",2),p([u()],k.prototype,"_triggerAttribute",2),p([u()],k.prototype,"_triggerType",2),p([u()],k.prototype,"_triggerAbove",2),p([u()],k.prototype,"_triggerBelow",2),p([u()],k.prototype,"_triggerForMinutes",2),p([u()],k.prototype,"_triggerTargetValue",2),p([u()],k.prototype,"_triggerDeltaMode",2),p([u()],k.prototype,"_triggerFromState",2),p([u()],k.prototype,"_triggerToState",2),p([u()],k.prototype,"_triggerTargetChanges",2),p([u()],k.prototype,"_triggerRuntimeHours",2),p([u()],k.prototype,"_suggestedAttributes",2),p([u()],k.prototype,"_availableAttributes",2),p([u()],k.prototype,"_entityDomain",2),p([u()],k.prototype,"_lastPerformed",2),p([u()],k.prototype,"_nfcTagId",2),p([u()],k.prototype,"_availableTags",2),p([u()],k.prototype,"_responsibleUserId",2),p([u()],k.prototype,"_availableUsers",2),p([u()],k.prototype,"_checklistText",2),p([u()],k.prototype,"_scheduleTime",2),p([u()],k.prototype,"_environmentalEntity",2),p([u()],k.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",k);var D=class extends T{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed"}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed")}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=G(e,this.lang,i("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return o``;let e=this.lang||this.hass?.language||"en";return o`
      <ha-dialog open @closed=${this._close}>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,p([$({attribute:!1})],B.prototype,"hass",2),p([u()],B.prototype,"_open",2),p([u()],B.prototype,"_title",2),p([u()],B.prototype,"_message",2),p([u()],B.prototype,"_confirmText",2),p([u()],B.prototype,"_danger",2),p([u()],B.prototype,"_inputLabel",2),p([u()],B.prototype,"_inputType",2),p([u()],B.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",B);var bt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},yt=l=>(...n)=>({_$litDirective$:l,values:n}),Se=class{constructor(n){}get _$AU(){return this._$AM._$AU}_$AT(n,e,t){this._$Ct=n,this._$AM=e,this._$Ci=t}_$AS(n,e){return this.update(n,e)}update(n,e){return this.render(...e)}};var be=class extends Se{constructor(n){if(super(n),this.it=d,n.type!==bt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(n){if(n===d||n==null)return this._t=void 0,this.it=n;if(n===Y)return n;if(typeof n!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(n===this.it)return this._t;this.it=n;let e=[n];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};be.directiveName="unsafeHTML",be.resultType=1;var kt=yt(be);var wa=["EUR","USD","GBP","JPY","CHF","CAD","AUD","CNY","INR","BRL"],E=class extends T{constructor(){super(...arguments);this.budget=null;this._settings=null;this._loading=!0;this._importCsv="";this._importLoading=!1;this._includeHistory=!0;this._toast="";this._testingNotification=!1;this._users=[];this._vacEnabled=!1;this._vacStart="";this._vacEnd="";this._vacBuffer=3;this._vacExempt=new Set;this._vacIsActive=!1;this._vacWindowEnd=null;this._vacAllTasks=[];this._vacPreview=[];this._vacPreviewLoading=!1;this._vacSaving=!1;this._qrObjects=[];this._qrSelectedEntries=new Set;this._qrActions=new Set(["view"]);this._qrUrlMode="companion";this._qrBatchLoading=!1;this._qrBatchResults=[];this._qrObjectsLoaded=!1;this._loaded=!1;this._userService=null;this._sendTestNotification=async()=>{this._testingNotification=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/test_notification"}),t=e.message||(e.success?i("test_notification_success",this._lang):i("test_notification_failed",this._lang));this._showToast(t)}catch{this._showToast(i("test_notification_failed",this._lang))}finally{this._testingNotification=!1}}}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded?(this._loaded=!0,this._userService=new ie(this.hass),this._loadSettings(),this._loadUsers()):e.has("hass")&&this.hass&&this._userService&&this._userService.updateHass(this.hass)}async _loadUsers(){if(this._userService)try{this._users=await this._userService.getUsers()}catch{this._users=[]}}async _loadSettings(){this._loading=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});this._settings=e,this._hydrateVacationFromSettings()}catch{}this._loading=!1}_hydrateVacationFromSettings(){let e=this._settings?.vacation;e&&(this._vacEnabled=e.enabled,this._vacStart=e.start||"",this._vacEnd=e.end||"",this._vacBuffer=e.buffer_days,this._vacExempt=new Set(e.exempt_task_ids||[]),this._vacIsActive=e.is_active,this._vacWindowEnd=e.window_end)}async _updateSetting(e,t){try{let a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:{[e]:t}});this._settings=a,this._showToast(i("settings_saved",this._lang)),this.dispatchEvent(new CustomEvent("settings-changed"))}catch{this._showToast(i("action_error",this._lang))}}_showToast(e){this._toast=e,setTimeout(()=>{this._toast=""},3e3)}_downloadFile(e,t,a){let s=new Blob([e],{type:a}),r=URL.createObjectURL(s),c=document.createElement("a");c.href=r,c.download=t,c.click(),URL.revokeObjectURL(r)}render(){let e=this._lang;return this._loading||!this._settings?o`<div class="settings-loading">Loading…</div>`:o`
    ...
    `}_renderPanelAccess(e){let t=new Set(this._settings.admin_panel_user_ids||[]),a=this._users.filter(r=>!r.is_admin),s=(r,c)=>{let _=new Set(t);c?_.add(r):_.delete(r),this._updateSetting("admin_panel_user_ids",[..._])};return o`
      <div class="settings-section">
        <h3>${i("settings_panel_access",e)} ${t.size>0?o`<span class="section-badge">${t.size}</span>`:d}</h3>
        <p class="section-desc">${i("settings_panel_access_desc",e)}</p>
        ${a.length===0?o`<div class="setting-row hint">${i("no_non_admin_users",e)}</div>`:a.map(r=>o`
    ...
    `}_renderNotifications(e){let t=this._settings.notifications,a=this._settings.actions;return o`
      <div class="settings-section">
      ...
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select @change=${a=>this._updateSetting("budget_currency",a.target.value)}>
            ${wa.map(a=>o`<option value=${a} ?selected=${t.currency===a}>${a}</option>`)}
          </select>
        </label>
        <label class="setting-row">
    ...
    `}_renderVacation(e){let t=this._vacEnabled&&!this._vacIsActive&&this._vacWindowEnd&&new Date(this._vacWindowEnd)<new Date,a=this._vacExempt.size;return o`
      <div class="settings-section vacation-section">
        <h3>
          ${i("vacation_title",e)}
          ${this._vacIsActive?o`<span class="vac-badge active">${i("vacation_active",e)}</span>`:d}
          ${t?o`<span class="vac-badge stale">${i("vacation_ended",e)}</span>`:d}
        </h3>
        ...
        <details class="vac-exempt-panel">
          <summary>
            ...
            ${a>0?o`<span class="section-badge">${a}</span>`:d}
          </summary>
          <p class="section-desc">${i("vacation_exempt_desc",e)}</p>
          ${this._vacAllTasks.length===0?o`<button @click=${this._loadAllTasksForVacation}>${i("vacation_load_tasks",e)}</button>`:o`
        ...
        ${this._vacStart&&this._vacEnd?o`
          <div class="vac-preview-toolbar">
            ...
            ${this._vacPreview.length>0?o`<span class="vac-preview-count">${this._vacPreview.length} ${i("vacation_preview_affected",e)}</span>`:d}
          </div>
    ...
    `}_renderVacationTaskList(e){let t=new Map;for(let s of this._vacAllTasks){let r=t.get(s.object_name)||[];r.push(s),t.set(s.object_name,r)}return[...t.entries()].sort(([s],[r])=>s.localeCompare(r)).map(([s,r])=>o`
      <div class="vac-task-group">
        <div class="vac-task-group-name">${s||i("no_objects",e)}</div>
        ${r.sort((c,_)=>c.task_name.localeCompare(_.task_name)).map(c=>o`
    ...
    `)}_renderVacationPreview(e){return o`
      <div class="vac-preview-list">
        ${this._vacPreview.map(t=>{let a=t.events.map(r=>{let c=`vacation_event_${r.status}`;return`${r.date} (${i(c,e)})`}).join(" \xB7 "),s=!t.will_suppress;return o`
            <div class="vac-preview-row ${s?"exempt":""}">
              <div class="vac-preview-info">
                <div class="vac-preview-name">
                  ...
                  ${t.kind==="sensor_based"?o`<span class="vac-preview-kind">${i("vacation_sensor_based",e)}</span>`:d}
                </div>
              ...
              <div class="vac-preview-actions">
                ...
                ${t.kind==="time_based"?o`<button @click=${()=>this._previewActionSkip(t)}>${i("qr_action_skip",e)}</button>`:d}
            ...
            <details open class="qr-filter-panel">
              ...
              <div class="qr-filter-group">
                ...
                <div class="qr-object-list">
                  ${this._qrObjects.length===0?o`<div class="hint">${i("no_objects",e)}</div>`:this._qrObjects.map(c=>o`
  ...
  `,p([$({attribute:!1})],K.prototype,"hass",2),p([u()],K.prototype,"_open",2),p([u()],K.prototype,"_loading",2),p([u()],K.prototype,"_error",2),p([u()],K.prototype,"_entryId",2),p([u()],K.prototype,"_taskId",2),p([u()],K.prototype,"_values",2);customElements.get("maintenance-seasonal-overrides-dialog")||customElements.define("maintenance-seasonal-overrides-dialog",K);var V=class extends T{constructor(){super(...arguments);this.objects=[];this._open=!1;this._loading=!1;this._error="";this._groupId=null;this._name="";this._description="";this._selected=new Set;this._toggleTask=(e,t)=>{let a=`${e}:${t}`,s=new Set(this._selected);s.has(a)?s.delete(a):s.add(a),this._selected=s};this._save=async()=>{let e=this._name.trim();if(!e){this._error=i("group_name_required",this._lang);return}this._loading=!0,this._error="";try{let t=this._buildTaskRefs();this._groupId?await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/group/update",group_id:this._groupId,name:e,description:this._description,task_refs:t}):await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/group/create",name:e,description:this._description,task_refs:t}),this._open=!1,this.dispatchEvent(new CustomEvent("group-saved"))}catch(t){this._error=G(t,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}openCreate(){this._reset(),this._open=!0}openEdit(e,t){this._reset(),this._groupId=e,this._name=t.name,this._description=t.description||"",this._selected=new Set(t.task_refs.map(a=>`${a.entry_id}:${a.task_id}`)),this._open=!0}_reset(){this._groupId=null,this._name="",this._description="",this._selected=new Set,this._error=""}_close(){this._open=!1}_buildTaskRefs(){return[...this._selected].map(e=>{let[t,a]=e.split(":",2);return{entry_id:t,task_id:a}})}render(){if(!this._open)return o``;let e=this._lang,t=this._groupId?i("edit_group",e):i("new_group",e);return o`
      <ha-dialog open @closed=${this._close} heading="${t}">
        <div class="content">
          ...
          ${this.objects.length===0?o`<div class="hint">${i("no_objects",e)}</div>`:o`
              <div class="objects">
                ${[...this.objects].sort((a,s)=>a.object.name.localeCompare(s.object.name)).map(a=>o`
                  <div class="object-block">
                    <div class="object-name">${a.object.name}</div>
                    ${a.tasks.length===0?o`<div class="hint small">${i("no_tasks_short",e)}</div>`:[...a.tasks].sort((s,r)=>s.name.localeCompare(r.name)).map(s=>{let r=`${a.entry_id}:${s.id}`,c=this._selected.has(r);return o`
    ...
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${v?o`
            ...
            <div class="trigger-entity-id">${_.map((b,y)=>o`${y>0?", ":""}<span class="entity-link" @click=${S=>oe(S,b)}>${b}</span>`)}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `:o`
            <div class="trigger-entity-name">${r}</div>
            <div class="trigger-entity-id">${c?o`<span class="entity-link" @click=${b=>oe(b,c)}>${c}</span>`:""}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `}
        </div>
      ...
      ${m!=null?o`
            <div class="trigger-value-row">
              ...
              ${g?o`<span class="trigger-unit">${g}</span>`:d}
            </div>
          `:d}

      <div class="trigger-limits">
        ${h==="threshold"?o`
          ${e.trigger_above!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("threshold_above",t)}: ${e.trigger_above} ${g}</span>`:d}
          ${e.trigger_below!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("threshold_below",t)}: ${e.trigger_below} ${g}</span>`:d}
          ${e.trigger_for_minutes?o`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${i("for_minutes",t)}: ${e.trigger_for_minutes}</span>`:d}
        `:d}
        ${h==="counter"?o`
          ${e.trigger_target_value!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("target_value",t)}: ${e.trigger_target_value} ${g}</span>`:d}
        `:d}
        ${h==="state_change"?o`
          ${e.trigger_target_changes!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("target_changes",t)}: ${e.trigger_target_changes}</span>`:d}
        `:d}
        ${h==="runtime"?o`
          ${e.trigger_runtime_hours!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${i("runtime_hours",t)}: ${e.trigger_runtime_hours}h</span>`:d}
        `:d}
        ${h==="compound"?o`
          ...
          ${(e.conditions||[]).map((b,y)=>o`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${y+1}. ${i(b.type||"unknown",t)}: ${b.entity_id?o`<span class="entity-link" @click=${S=>oe(S,b.entity_id)}>${b.entity_id}</span>`:""}</span>
          `)}
        `:d}
        ${a?.min!=null?o`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${i("min",t)}: ${a.min} ${g}</span>`:d}
        ${a?.max!=null?o`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${i("max",t)}: ${a.max} ${g}</span>`:d}
      </div>
  ...
  `}function ja(l,n,e){let t=l.trigger_config;if(!t)return d;let a=t.type||"threshold",s=a==="counter"&&t.trigger_delta_mode,r=e.isCounterEntity(t),c=t.entity_id||"",_=e.detailStatsData.get(c)||[],g=[],m=!1;if(_.length>=2)for(let f of _){let j=f.val;s&&l.trigger_baseline_value!=null&&(j-=l.trigger_baseline_value);let F={ts:f.ts,val:j};!r&&f.min!=null&&f.max!=null&&(F.min=s&&l.trigger_baseline_value!=null?f.min-l.trigger_baseline_value:f.min,F.max=s&&l.trigger_baseline_value!=null?f.max-l.trigger_baseline_value:f.max,m=!0),g.push(F)}else for(let f of l.history)f.trigger_value!=null&&g.push({ts:new Date(f.timestamp).getTime(),val:f.trigger_value});if(l.trigger_current_value!=null){let f=l.trigger_current_value;s&&l.trigger_baseline_value!=null&&(f-=l.trigger_baseline_value),g.push({ts:Date.now(),val:f})}if(g.length<2&&c&&e.hasStatsService&&!e.detailStatsData.has(c))return o`<div class="sparkline-container" aria-live="polite" style="display:flex;align-items:center;justify-content:center;height:140px;color:var(--secondary-text-color);font-size:12px;">
      <ha-icon icon="mdi:chart-line" style="--mdc-icon-size:16px;margin-right:8px;"></ha-icon>
      ${i("loading_chart",e.lang)}
    </div>`;if(g.length<2)return d;g.sort((f,j)=>f.ts-j.ts);let h=za,v=Ea,b=30,y=2,S=8,H=16,M=g.map(f=>f.val),A=Math.min(...M),x=Math.max(...M);if(m)for(let f of g)f.min!=null&&(A=Math.min(A,f.min)),f.max!=null&&(x=Math.max(x,f.max));t.trigger_above!=null&&(x=Math.max(x,t.trigger_above),A=Math.min(A,t.trigger_above)),t.trigger_below!=null&&(A=Math.min(A,t.trigger_below),x=Math.max(x,t.trigger_below));let C=null,U=null;if(a==="counter"&&t.trigger_target_value!=null){if(l.trigger_baseline_value!=null)C=l.trigger_baseline_value;else if(g.length>0){let f=[...l.history].filter(j=>j.type==="completed"||j.type==="reset").sort((j,F)=>new Date(F.timestamp).getTime()-new Date(j.timestamp).getTime())[0];if(f){let j=new Date(f.timestamp).getTime(),F=g[0],L=Math.abs(g[0].ts-j);for(let X of g){let ee=Math.abs(X.ts-j);ee<L&&(F=X,L=ee)}C=F.val}else C=g[0].val}C!=null?(U=C+t.trigger_target_value,x=Math.max(x,U),A=Math.min(A,C)):(x=Math.max(x,t.trigger_target_value),A=Math.min(A,0))}s&&l.trigger_baseline_value!=null&&(A=Math.min(A,0));let Z=x-A||1;A-=Z*.1,x+=Z*.1;let Q=g[0].ts,R=g[g.length-1].ts,w=R-Q||1,I=f=>b+(f-Q)/w*(h-b-y),q=f=>S+(1-(f-A)/(x-A))*(v-S-H),Te=g.map(f=>`${I(f.ts).toFixed(1)},${q(f.val).toFixed(1)}`).join(" "),qt=`M${I(g[0].ts).toFixed(1)},${v-H} `+g.map(f=>`L${I(f.ts).toFixed(1)},${q(f.val).toFixed(1)}`).join(" ")+` L${I(g[g.length-1].ts).toFixed(1)},${v-H} Z`,qe="";if(m){let f=g.filter(j=>j.min!=null&&j.max!=null);if(f.length>=2){let j=f.map(L=>`${I(L.ts).toFixed(1)},${q(L.max).toFixed(1)}`),F=[...f].reverse().map(L=>`${I(L.ts).toFixed(1)},${q(L.min).toFixed(1)}`);qe=`M${j[0]} `+j.slice(1).map(L=>`L${L}`).join(" ")+` L${F[0]} `+F.slice(1).map(L=>`L${L}`).join(" ")+" Z"}}let Ge=g[g.length-1],Mt=I(Ge.ts),Ct=q(Ge.val),Ke=f=>Math.abs(f)>=1e4?(f/1e3).toFixed(0)+"k":f>=1e3?(f/1e3).toFixed(1)+"k":f.toFixed(f<10?1:0),It=Ke(x),Nt=Ke(A),Pt=l.history.filter(f=>["completed","skipped","reset"].includes(f.type)).map(f=>({ts:new Date(f.timestamp).getTime(),type:f.type})).filter(f=>f.ts>=Q&&f.ts<=R),Me=g;if(g.length>We){let f=(g.length-1)/(We-1);Me=[];for(let j=0;j<We;j++)Me.push(g[Math.round(j*f)])}return o`
    <div class="sparkline-container">
      <svg class="sparkline-svg" viewBox="0 0 ${h} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_sparkline",e.lang)}">
        ...
        ${qe?P`<path d="${qe}" fill="var(--primary-color)" opacity="0.08" />`:d}
        ...
        ${l.degradation_rate!=null&&l.degradation_trend!=="stable"&&l.degradation_trend!=="insufficient_data"&&g.length>=2?(()=>{let f=g[g.length-1],j=30,F=f.ts+j*864e5,L=f.val+l.degradation_rate*j,X=Math.min(F,R+(R-Q)*.3),ee=Math.max(A,Math.min(x,L)),Rt=I(f.ts),Dt=q(f.val),Ft=I(X),Lt=q(ee);return P`<line x1="${Rt.toFixed(1)}" y1="${Dt.toFixed(1)}" x2="${Ft.toFixed(1)}" y2="${Lt.toFixed(1)}" stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.7" />`})():d}
        ${a==="threshold"&&t.trigger_above!=null?P`<line x1="${b}" y1="${q(t.trigger_above).toFixed(1)}" x2="${h}" y2="${q(t.trigger_above).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${q(t.trigger_above)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25B2 ${t.trigger_above}</text>`:d}
        ${a==="threshold"&&t.trigger_below!=null?P`<line x1="${b}" y1="${q(t.trigger_below).toFixed(1)}" x2="${h}" y2="${q(t.trigger_below).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${q(t.trigger_below)+11}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25BC ${t.trigger_below}</text>`:d}
        ${a==="counter"&&U!=null?P`<line x1="${b}" y1="${q(U).toFixed(1)}" x2="${h}" y2="${q(U).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${q(U)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">${i("target_value",e.lang)}: +${t.trigger_target_value}</text>`:d}
        ${a==="counter"&&C!=null?P`<line x1="${b}" y1="${q(C).toFixed(1)}" x2="${h}" y2="${q(C).toFixed(1)}" stroke="var(--secondary-text-color)" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
                <text x="${b+2}" y="${q(C)+11}" text-anchor="start" fill="var(--secondary-text-color)" font-size="8">${i("baseline",e.lang)}</text>`:d}
        <circle cx="${Mt.toFixed(1)}" cy="${Ct.toFixed(1)}" r="3.5" fill="var(--primary-color)" />
        ${Pt.map(f=>{let j=I(f.ts),F=f.type==="completed"?"var(--success-color, #4caf50)":f.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return P`
            <line x1="${j.toFixed(1)}" y1="${S}" x2="${j.toFixed(1)}" y2="${v-H}" stroke="${F}" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
            <circle cx="${j.toFixed(1)}" cy="${S+2}" r="5" fill="${F}" opacity="0.8" />
            <text x="${j.toFixed(1)}" y="${S+6}" text-anchor="middle" fill="white" font-size="7" font-weight="bold">${f.type==="completed"?"\u2713":f.type==="skipped"?"\u23ED":"\u21BA"}</text>
          `})}
        ${Me.map(f=>{let j=I(f.ts),F=q(f.val),L=new Date(f.ts).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),X=`${f.val.toFixed(1)} ${n}`;return m&&f.min!=null&&f.max!=null&&(X+=` (${f.min.toFixed(1)}\u2013${f.max.toFixed(1)})`),P`<circle cx="${j.toFixed(1)}" cy="${F.toFixed(1)}" r="8" fill="transparent" tabindex="0"
...
`).map(f=>o`<div>${f}</div>`)}
  ...
  `}function xt(l,n,e){let t=l.currentTarget,a=t.closest(".sparkline-container");if(!a)return;let s=a.getBoundingClientRect(),r=t.getBoundingClientRect();e({x:r.left-s.left+r.width/2,y:r.top-s.top-8,text:n})}function $t(l,n,e){let t=l.degradation_trend!=null&&l.degradation_trend!=="insufficient_data",a=l.days_until_threshold!=null,s=l.environmental_factor!=null&&l.environmental_factor!==1;if(!t&&!a&&!s)return d;let r=l.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":l.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return o`
      ...
      <div class="prediction-grid">
        ${t?o`
          <div class="prediction-item">
            ...
            ${l.degradation_rate!=null?o`<span class="prediction-rate">${l.degradation_rate>0?"+":""}${Math.abs(l.degradation_rate)>=10?Math.round(l.degradation_rate).toLocaleString():l.degradation_rate.toFixed(1)} ${l.trigger_entity_info?.unit_of_measurement||""}/${i("day_short",n)}</span>`:d}
          </div>
        `:d}
        ${a?o`
          <div class="prediction-item">
            ...
            ${l.threshold_prediction_date?o`<span class="prediction-date">${ae(l.threshold_prediction_date,n)}</span>`:d}
        ...
        ${s&&e.environmental?o`
          <div class="prediction-item">
            ...
            ${l.environmental_entity?o`<span class="prediction-entity entity-link" @click=${c=>oe(c,l.environmental_entity)}>${l.environmental_entity}</span>`:d}
          </div>
        `:d}
      </div>
    </div>
  `}function zt(l,n){let e=l.interval_analysis,t=e?.weibull_beta,a=e?.weibull_eta;if(t==null||a==null||a<=0)return d;let s=l.interval_days??0,r=l.suggested_interval??s;return o`
  ...
  `}function Sa(l,n,e,t,a){let b=Math.max(e,t,n,1)*1.3,y=50,S=[];for(let R=0;R<=y;R++){let w=R/y*b,I=1-Math.exp(-Math.pow(w/n,l)),q=32+w/b*260,Te=136-I*128;S.push([q,Te])}let H=S.map(([R,w])=>`${R.toFixed(1)},${w.toFixed(1)}`).join(" "),M="M32,136 "+S.map(([R,w])=>`L${R.toFixed(1)},${w.toFixed(1)}`).join(" ")+` L${S[y][0].toFixed(1)},136 Z`,A=32+e/b*260,x=1-Math.exp(-Math.pow(e/n,l)),C=136-x*128,U=((1-x)*100).toFixed(0),Z=32+t/b*260,Q=[0,.25,.5,.75,1];return o`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_weibull",a)}">
        ...
        ${e>0?P`
          ...
          <circle cx="${A.toFixed(1)}" cy="${C.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(A+4).toFixed(1)}" y="${(C-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
    ...
    <div class="chart-legend">
      ...
      ${e>0?o`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4); opacity:0.5"></span> ${i("current_interval_marker",a)}</span>`:d}
      ${t>0&&t!==e?o`<span class="legend-item"><span class="legend-swatch" style="background:var(--success-color, #4caf50)"></span> ${i("recommended_marker",a)}</span>`:d}
    </div>
  `}function Ta(l,n){return o`
  ...
  `}function qa(l,n,e){let t=l.confidence_interval_low,a=l.confidence_interval_high,s=n.suggested_interval??n.interval_days??0,r=n.interval_days??0,c=Math.max(0,t-5),g=a+5-c,m=(t-c)/g*100,h=(a-t)/g*100,v=(s-c)/g*100,b=r>0?(r-c)/g*100:-1;return o`
  ...
  `}var Et=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function jt(l,n,e){if(!e.seasonal||!l.seasonal_factor||l.seasonal_factor===1)return d;let t=Et.map(c=>i(c,n)),a=new Date().getMonth(),s=l.seasonal_factors||l.interval_analysis?.seasonal_factors||null,r=s&&s.length===12?s:t.map((c,_)=>{let g=l.seasonal_factor||1,m=Math.sin((_-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,g+m))});return o`
    <div class="seasonal-card-compact">
      <h4>${i("seasonal_awareness",n)}</h4>
      <div class="seasonal-mini-chart">
        ${r.map((c,_)=>{let g=c*40,m=c<.9?"low":c>1.1?"high":"normal";return o`
  ...
  `}function At(l,n){return Ma(l,n)}function Ma(l,n){let e=l.seasonal_factors??l.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return d;let t=l.interval_analysis?.seasonal_reason,a=new Date().getMonth(),s=300,r=100,c=8,g=r-c-4,m=Math.max(...e,1.5),h=s/12,v=h*.65,b=c+g-1/m*g;return o`
    <div class="seasonal-chart">
      <div class="seasonal-chart-title">
        ...
        ${t?o`<span class="source-tag">${t==="learned"?i("seasonal_learned",n):i("seasonal_manual",n)}</span>`:d}
      </div>
      <svg viewBox="0 0 ${s} ${r}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_seasonal",n)}">
        ...
        ${e.map((y,S)=>{let H=y/m*g,M=S*h+(h-v)/2,A=c+g-H,x=S===a,C=y<1?"var(--success-color, #4caf50)":y>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return P`
            <rect x="${M.toFixed(1)}" y="${A.toFixed(1)}"
              width="${v.toFixed(1)}" height="${H.toFixed(1)}"
              fill="${C}" opacity="${x?1:.5}" rx="2" />
          `})}
      </svg>
      <div class="seasonal-labels">
        ${Et.map((y,S)=>o`<span class="seasonal-label ${S===a?"active-month":""}">${i(y,n)}</span>`)}
      </div>
    </div>
  `}var Ca=300,Ia=200;function St(l,n,e,t){let a=l.history.filter(c=>c.type==="completed"&&(c.cost!=null||c.duration!=null));if(a.length<2)return d;let s=a.some(c=>(c.cost??0)>0),r=a.some(c=>(c.duration??0)>0);return!s&&!r?d:o`
  ...
  `}function Na(l,n,e){let t=l.history.filter(w=>w.type==="completed"&&(w.cost!=null||w.duration!=null)).map(w=>({ts:new Date(w.timestamp).getTime(),cost:w.cost??0,duration:w.duration??0})).sort((w,I)=>w.ts-I.ts);if(t.length<2)return d;let a=t.some(w=>w.cost>0),s=t.some(w=>w.duration>0);if(!a&&!s)return d;let r=e!=="duration"&&a,c=e!=="cost"&&s,_=r||!c&&a,g=c||!r&&s,m=Ca,h=Ia,v=_?32:8,b=g?32:8,y=8,S=20,H=m-v-b,M=h-y-S,A=Math.max(...t.map(w=>w.cost))||1,x=Math.max(...t.map(w=>w.duration))||1,C=Math.min(20,H/t.length*.6),U=H/t.length,Z=w=>v+U*w+U/2,Q=w=>y+M-w/A*M,R=w=>y+M-w/x*M;return o`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${m} ${h}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_history",n)}">
        ...
        ${_?P`
          <text x="${v-3}" y="${y+4}" text-anchor="end" fill="var(--primary-color)" font-size="7">${A.toFixed(0)}\u20AC</text>
  ...
  `}var Pa=60,Ra=20,Tt=30,z=class extends T{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._unsub=null;this._sparklineTooltip=null;this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1};this._adminPanelUserIds=[];this._defaultWarningDays=7;this._actionLoading=!1;this._moreMenuOpen=!1;this._toastMessage="";this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab="dashboard";this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=e=>this._onPopState(e);this._deepLinkHandled=!1;this._onDialogEvent=async()=>{try{await this._loadData()}catch{}}}get _lang(){return this.hass?.language||"en"}get _isOperator(){let e=this.hass?.user;return e?e.is_admin?!1:!this._adminPanelUserIds.includes(e.id):!0}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._popstateHandler);let e=localStorage.getItem("maintenance_supporter_sort");e&&["due_date","object","type","task_name","area","assigned_user","group"].includes(e)&&(this._sortMode=e);let t=localStorage.getItem("maintenance_supporter_object_sort");t&&["alphabetical","due_soonest","task_count"].includes(t)&&(this._objectSortMode=t);let a=localStorage.getItem("maintenance_supporter_groupby");a&&["none","area","group","user"].includes(a)&&(this._groupByMode=a)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(e){if(super.updated(e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Ae(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new ie(this.hass),this._userService.getUsers())}}async _loadData(){let[e,t,a,s,r]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null)]);if(e&&(this._objects=e.objects),t&&(this._stats=t),a&&(this._budget=a),s&&(this._groups=s.groups||{}),r){let c=r;this._features=c.features,this._adminPanelUserIds=c.admin_panel_user_ids||[];let _=c.general?.default_warning_days;typeof _=="number"&&_>=0&&_<=365&&(this._defaultWarningDays=_)}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search),t=e.get("entry_id");if(!t)return;this._deepLinkHandled=!0;let a=e.get("task_id"),s=e.get("action"),r=window.location.pathname+window.location.hash;history.replaceState(history.state,"",r);let c=this._getObject(t);if(!c){this._showOverview();return}if(a){let _=c.tasks.find(g=>g.id===a);if(!_){this._showObject(t);return}this._showTask(t,a),s==="complete"&&requestAnimationFrame(()=>{this._openCompleteDialog(t,a,_.name,this._features.checklists?_.checklist:void 0,this._features.adaptive&&!!_.adaptive_config?.enabled)})}else this._showObject(t)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let a=await this._statsService.getDetailStats(e,t),s=new Map(this._detailStatsData);s.set(e,a),this._detailStatsData=s}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=[];for(let a of this._objects)for(let s of a.tasks){let r=s.trigger_config?.entity_id;r&&e.push({entityId:r,isCounter:this._isCounterEntity(s.trigger_config)})}if(e.length===0)return;let t=await this._statsService.getBatchMiniStats(e);this._miniStatsData=new Map([...this._miniStatsData,...t])}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _taskRows(){let e=[];for(let h of this._objects)for(let v of h.tasks){if(this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let y=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==y)continue}let b=[];for(let y of Object.values(this._groups))y.task_refs?.some(S=>S.entry_id===h.entry_id&&S.task_id===v.id)&&b.push(y.name);e.push({entry_id:h.entry_id,task_id:v.id,object_name:h.object.name,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_anchor:v.interval_anchor??null,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,area_id:h.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:b})}let t={overdue:0,triggered:1,due_soon:2,ok:3},a=(h,v)=>(t[h.status]??9)-(t[v.status]??9),s=(h,v)=>(h.days_until_due??99999)-(v.days_until_due??99999),r=(h,v)=>a(h,v)||s(h,v),c=h=>h.area_id&&this.hass?.areas?.[h.area_id]?.name||"",_=h=>h.responsible_user_id&&this._userService?.getUserName(h.responsible_user_id)||"",g=h=>h.group_names[0]||"",m={due_date:r,object:(h,v)=>h.object_name.localeCompare(v.object_name)||r(h,v),type:(h,v)=>h.type.localeCompare(v.type)||r(h,v),task_name:(h,v)=>h.task_name.localeCompare(v.task_name),area:(h,v)=>{let b=c(h),y=c(v);return!b&&y?1:b&&!y?-1:b.localeCompare(y)||r(h,v)},assigned_user:(h,v)=>{let b=_(h),y=_(v);return!b&&y?1:b&&!y?-1:b.localeCompare(y)||r(h,v)},group:(h,v)=>{let b=g(h),y=g(v);return!b&&y?1:b&&!y?-1:b.localeCompare(y)||r(h,v)}};return e.sort(m[this._sortMode]),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(s=>s.id===t)}_pushPanelState(e,t,a){let s={msp_view:e,msp_entry:t||null,msp_task:a||null};history.pushState(s,"")}_onPopState(e){let t=e.state;if(t?.msp_view&&(this._view=t.msp_view,this._selectedEntryId=t.msp_entry||null,this._selectedTaskId=t.msp_task||null,this._moreMenuOpen=!1,t.msp_view==="task"&&t.msp_entry&&t.msp_task)){this._historyFilter=null;let a=this._getTask(t.msp_entry,t.msp_task);a?.trigger_config?.entity_id&&this._fetchDetailStats(a.trigger_config.entity_id,this._isCounterEntity(a.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null}_showObject(e){this._pushPanelState("object",e),this._view="object",this._selectedEntryId=e,this._selectedTaskId=null}_showTask(e,t){this._pushPanelState("task",e,t),this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._activeTab="overview",this._historyFilter=null;let a=this._getTask(e,t);if(a?.trigger_config?.entity_id){let s=a.trigger_config.entity_id,r=this._isCounterEntity(a.trigger_config);this._fetchDetailStats(s,r)}}_showToast(e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}async _deleteObject(e){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_object",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:e}),this._showOverview(),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _deleteTask(e,t){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_task",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/delete",entry_id:e,task_id:t}),this._showObject(e),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _skipTask(e,t,a){this._actionLoading=!0;try{let s={type:"maintenance_supporter/task/skip",entry_id:e,task_id:t};a&&(s.reason=a),await this.hass.connection.sendMessagePromise(s),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _resetTask(e,t,a){this._actionLoading=!0;try{let s={type:"maintenance_supporter/task/reset",entry_id:e,task_id:t};a&&(s.date=a),await this.hass.connection.sendMessagePromise(s),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _applySuggestion(e,t,a){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/apply_suggestion",entry_id:e,task_id:t,interval:a}),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}_openSeasonalOverrides(e){let t=this.shadowRoot.querySelector("maintenance-seasonal-overrides-dialog");if(!t||!this._selectedEntryId)return;let a=e.adaptive_config?.seasonal_overrides;t.open(this._selectedEntryId,e.id,a)}async _reanalyzeInterval(e,t){try{let a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:e,task_id:t});a.recommended_interval?this._showToast(`${i("reanalyze_result",this._lang)}: ${a.recommended_interval} ${i("days",this._lang)} (${i(`confidence_${a.confidence}`,this._lang)}, ${a.data_points} ${i("data_points",this._lang)})`):this._showToast(i("reanalyze_insufficient_data",this._lang)),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _promptSkipTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let s=await a.prompt({title:i("skip",this._lang),message:i("skip_reason_prompt",this._lang),confirmText:i("skip",this._lang),inputLabel:i("reason_optional",this._lang),inputType:"text"});s.confirmed&&this._skipTask(e,t,s.value||void 0)}async _promptResetTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let s=await a.prompt({title:i("reset",this._lang),message:i("reset_date_prompt",this._lang),confirmText:i("reset",this._lang),inputLabel:i("reset_date_optional",this._lang),inputType:"date"});s.confirmed&&this._resetTask(e,t,s.value||void 0)}_dismissSuggestion(e,t){e&&t&&this._dismissedSuggestions.add(`${e}_${t}`),this.requestUpdate()}_openCompleteDialog(e,t,a,s,r){let c=this.shadowRoot.querySelector("maintenance-complete-dialog");c&&(c.entryId=e,c.taskId=t,c.taskName=a,c.lang=this._lang,c.checklist=s||[],c.adaptiveEnabled=!!r,c.open())}_openQrForObject(e,t){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForObject(e,t)}_openQrForTask(e,t,a,s){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForTask(e,t,a,s)}render(){return o`
    ...
    `}_renderHeader(){let e=[{label:i("maintenance",this._lang),action:()=>this._showOverview()}];if(this._view==="object"&&this._selectedEntryId){let t=this._getObject(this._selectedEntryId);e.push({label:t?.object.name||"Object"})}if(this._view==="task"&&this._selectedEntryId&&this._selectedTaskId){let t=this._getObject(this._selectedEntryId);e.push({label:t?.object.name||"Object",action:()=>this._showObject(this._selectedEntryId)});let a=this._getTask(this._selectedEntryId,this._selectedTaskId);e.push({label:a?.name||"Task"})}return o`
      <div class="header">
        ...
        <div class="breadcrumbs">
          ${e.map((t,a)=>o`
              ${a>0?o`<span class="sep">/</span>`:d}
              ${t.action?o`<a @click=${t.action}>${t.label}</a>`:o`<span class="current">${t.label}</span>`}
            `)}
        </div>
      </div>
    `}_renderOverview(){let e=this._lang,t=this._isOperator;return t&&this._overviewTab==="settings"&&(this._overviewTab="dashboard"),o`
      ${t?d:o`
        <div class="tab-bar">
    ...
    `}_renderDashboard(){let e=this._stats,t=this._taskRows,a=this._lang,s=this._isOperator;return o`
      ${e?o`
            <div class="stats-bar">
      ...
      <div class="filter-bar">
        ...
        <label class="filter-field">
          ...
          >
            ...
            ${this._features.groups?o`<option value="group" ?selected=${this._groupByMode==="group"}>${i("groupby_group",a)}</option>`:d}
    ...
    `}_renderAllObjects(){let e=this._lang,t=this._isOperator,a=_=>{let g=1/0;for(let m of _.tasks){let h=m.days_until_due;h!=null&&h<g&&(g=h)}return g},s=[...this._objects];this._objectSortMode==="alphabetical"?s.sort((_,g)=>_.object.name.localeCompare(g.object.name)):this._objectSortMode==="task_count"?s.sort((_,g)=>g.tasks.length-_.tasks.length||_.object.name.localeCompare(g.object.name)):s.sort((_,g)=>a(_)-a(g)||_.object.name.localeCompare(g.object.name));let r=()=>{let _=new Map;for(let g of s){let m=g.object.area_id,h=m?this.hass?.areas?.[m]?.name||i("unassigned",e):i("no_area",e);_.has(h)||_.set(h,[]),_.get(h).push(g)}return new Map([..._.entries()].sort(([g],[m])=>g.localeCompare(m)))},c=_=>{let g=_.tasks.some(m=>m.status==="overdue"||m.status==="triggered");return o`
        <div class="object-card${g?" object-card-overdue":""}" @click=${()=>this._showObject(_.entry_id)}>
          ...
          ${_.tasks.length===0?o`<div class="object-card-empty">${i("no_tasks_yet",e)}</div>`:d}
        </div>
      `};return o`
      ...
      ${this._groupByMode==="area"?o`
          ...
          `)}
        `:o`<div class="objects-grid">${s.map(c)}</div>`}
    `}async _onSettingsChanged(){await this._loadData()}_renderGroupsSection(){if(!this._features.groups)return d;let e=Object.entries(this._groups),t=this._lang;return o`
      <div class="groups-section">
        ...
        ${e.length===0?o`<div class="hint">${i("no_groups",t)}</div>`:o`
            <div class="groups-grid">
              ${e.map(([a,s])=>{let r=s.task_refs.map(c=>this._getTask(c.entry_id,c.task_id)?.name).filter(Boolean);return o`
                  <div class="group-card">
                    ...
                    ${s.description?o`<div class="group-card-desc">${s.description}</div>`:d}
                    <div class="group-card-tasks">
                      ${r.length>0?r.map(c=>o`<span class="group-task-chip">${c}</span>`):o`<span style="font-size:12px;color:var(--secondary-text-color)">${i("no_tasks_short",t)}</span>`}
                    </div>
                  </div>
                `})}
            </div>
    ...
    `}_renderOverviewRow(e){let t=this._lang,a=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,s=0,r=Ee.ok,c=!1;if(a&&e.days_until_due!==null){let h=(e.interval_days-e.days_until_due)/e.interval_days*100;s=Math.max(0,Math.min(100,h)),c=h>100,e.status==="overdue"?r=Ee.overdue:e.status==="due_soon"&&(r=Ee.due_soon)}let _=e.area_id?this.hass?.areas?.[e.area_id]?.name:null,g=e.responsible_user_id?this._userService?.getUserName(e.responsible_user_id):null,m=e.group_names.length>0||_||g;return o`
      <div class="task-row${e.enabled?"":" task-disabled"}">
        <span class="cell-badges">
          <span class="status-badge ${e.status}">${i(e.status,t)}</span>
          ${e.enabled?d:o`<span class="badge-disabled">${i("disabled",t)}</span>`}
          ${e.nfc_tag_id?o`<span class="nfc-badge" title="${i("nfc_linked",t)}"><ha-icon icon="mdi:nfc-variant"></ha-icon></span>`:d}
        </span>
        ...
        <span class="due-cell" @click=${()=>this._showTask(e.entry_id,e.task_id)}>
          ...
          ${a?o`<div class="days-bar"><div class="days-bar-fill${c?" overflow":""}" style="width:${s}%;background:${r}"></div></div>`:d}
          ${e.trigger_config?this._renderTriggerProgress(e):!a&&e.trigger_active?o`<span style="color:var(--maint-triggered-color);font-weight:600">⚡</span>`:d}
    ...
    `}_openCompleteDialogForRow(e){let a=this._objects.find(s=>s.entry_id===e.entry_id)?.tasks.find(s=>s.id===e.task_id);this._openCompleteDialog(e.entry_id,e.task_id,e.task_name,this._features.checklists?a?.checklist:void 0,this._features.adaptive&&!!a?.adaptive_config?.enabled)}_renderTriggerProgress(e){let t=e.trigger_config??null;if(!t)return d;let a=t.type||"threshold",s=e.trigger_entity_info?.unit_of_measurement??"",r=0,c="";if(a==="threshold"){let m=e.trigger_current_value??null;if(m==null)return d;let h=t.trigger_above,v=t.trigger_below;if(h!=null){let b=v??0,y=h-b||1;r=Math.min(100,Math.max(0,(m-b)/y*100)),c=`${m.toFixed(1)} / ${h} ${s}`}else if(v!=null){let y=e.trigger_entity_info?.max??(v*2||100),S=y-v||1;r=Math.min(100,Math.max(0,(y-m)/S*100)),c=`${m.toFixed(1)} / ${v} ${s}`}else return d}else if(a==="counter"){let m=t.trigger_target_value||1,v=e.trigger_current_delta??null??e.trigger_current_value??null;if(v==null)return d;r=Math.min(100,Math.max(0,v/m*100)),c=`${v.toFixed(1)} / ${m} ${s}`}else if(a==="state_change"){let m=t.trigger_target_changes||1,h=e.trigger_current_value??null;if(h==null)return d;r=Math.min(100,Math.max(0,h/m*100)),c=`${Math.round(h)} / ${m}`}else if(a==="runtime"){let m=t.trigger_runtime_hours||100,h=e.trigger_current_value??null;if(h==null)return d;r=Math.min(100,Math.max(0,h/m*100)),c=`${h.toFixed(1)}h / ${m}h`}else if(a==="compound"){let m=t.compound_logic||t.operator||"AND",h=t.conditions?.length||0;c=`${m} (${h})`,r=e.trigger_active?100:0}else return d;let _=r>=100,g=r>90?"var(--error-color, #f44336)":r>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return o`
      <div class="trigger-progress">
        <div class="trigger-progress-bar">
          <div class="trigger-progress-fill${_?" overflow":""}" style="width:${r}%;background:${g}"></div>
        </div>
        <span class="trigger-progress-label">${c}</span>
      </div>
    `}_renderMiniSparkline(e){if(!e.trigger_config?.entity_id)return d;let t=e.trigger_config.entity_id,a=this._miniStatsData.get(t)||[],s=[];if(a.length>=2)s=a.map(x=>({ts:x.ts,val:x.val}));else{if(!e.history)return d;for(let x of e.history)x.trigger_value!=null&&s.push({ts:new Date(x.timestamp).getTime(),val:x.trigger_value})}if(e.trigger_current_value!=null&&s.push({ts:Date.now(),val:e.trigger_current_value}),s.length<2)return d;s.sort((x,C)=>x.ts-C.ts);let r=Pa,c=Ra,_=s.map(x=>x.val),g=Math.min(..._),m=Math.max(..._),h=m-g||1;g-=h*.1,m+=h*.1;let v=s[0].ts,y=s[s.length-1].ts-v||1,S=x=>(x-v)/y*r,H=x=>2+(1-(x-g)/(m-g))*(c-4),M=s;if(M.length>Tt){let x=Math.ceil(M.length/Tt);M=M.filter((C,U)=>U%x===0||U===M.length-1)}let A=M.map(x=>`${S(x.ts).toFixed(1)},${H(x.val).toFixed(1)}`).join(" ");return o`
    ...
    `}_renderDaysProgress(e){let t=this._lang;if(e.days_until_due==null||!e.interval_days||e.interval_days<=0)return d;let s=(e.interval_days-e.days_until_due)/e.interval_days*100,r=Math.max(0,Math.min(100,s)),c=s>100,_="var(--success-color, #4caf50)";return e.status==="overdue"?_="var(--error-color, #f44336)":e.status==="due_soon"&&(_="var(--warning-color, #ff9800)"),o`
    ...
    `}_renderObjectDetail(){if(!this._selectedEntryId)return d;let e=this._getObject(this._selectedEntryId);if(!e)return o`<p>Object not found.</p>`;let t=e.object,a=this._lang,s=this._isOperator;return o`
      <div class="detail-section">
        ...
        ${t.serial_number?o`<p class="meta">${i("serial_number_label",a)}: ${t.serial_number}</p>`:d}
        ${t.installation_date?o`<p class="meta">${i("installed",a)}: ${ae(t.installation_date,a)}</p>`:d}
        ...
        ${e.tasks.length===0?o`<div class="empty-state-centered">
            ...
            </div>`:[...e.tasks].sort((r,c)=>{let _={overdue:0,triggered:1,due_soon:2,ok:3};return(_[r.status]??9)-(_[c.status]??9)||(r.days_until_due??99999)-(c.days_until_due??99999)}).map(r=>o`
              <div class="task-row${r.enabled?"":" task-disabled"}">
                <span class="status-badge ${r.status}">${i(r.status,a)}</span>
                ${r.enabled?d:o`<span class="badge-disabled">${i("disabled",a)}</span>`}
                ${r.nfc_tag_id?o`<span class="nfc-badge" title="${i("nfc_linked",a)}"><ha-icon icon="mdi:nfc-variant"></ha-icon></span>`:d}
    ...
    `}_renderTaskHeader(e){let t=this._lang,s=this._getObject(this._selectedEntryId)?.object.name||"",r=this._isOperator,c=e.status==="due_soon"?"warning":e.status||"ok",_=i(e.status||"ok",t);return o`
      <div class="task-header">
        <div class="task-header-title">
          ...
          ${e.nfc_tag_id?o`<span class="nfc-badge" title="${i("nfc_tag_id",t)}: ${e.nfc_tag_id}"><ha-icon icon="mdi:nfc-variant"></ha-icon> NFC</span>`:r?d:o`<span class="nfc-badge unlinked" title="${i("nfc_link_hint",t)}"
    ...
    `}_renderChecklistCard(e){if(!this._features.checklists)return d;let t=e.checklist||[];if(t.length===0)return d;let a=this._lang;return o`
    ...
    `}_renderTaskMeta(e){let t=e.documentation_url&&/^https?:\/\//i.test(e.documentation_url)?e.documentation_url:null;if(!e.notes&&!t)return d;let a=this._lang;return o`
    ...
    `}_renderKPIBar(e){let t=this._lang,a=e.times_performed>0?e.total_cost/e.times_performed:0,s=e.days_until_due!==null&&e.days_until_due!==void 0?e.days_until_due<0?"overdue":e.days_until_due<=e.warning_days?"warning":"":"";return o`
      <div class="kpi-bar">
        <div class="kpi-card">
          <div class="kpi-label">${i("next_due",t)}</div>
          <div class="kpi-value">${e.next_due?ae(e.next_due,t):"\u2014"}</div>
          ${this._features.schedule_time&&e.schedule_time?o`<div class="kpi-subtext">${i("at_time",t)} ${e.schedule_time}</div>`:d}
        </div>
    ...
    `}_renderRecommendationCard(e){let t=this._lang;if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return d;if(this._selectedEntryId&&this._selectedTaskId&&this._dismissedSuggestions.has(`${this._selectedEntryId}_${this._selectedTaskId}`))return d;let a=e.interval_days,s=e.suggested_interval,r=e.interval_confidence||"medium",c=Math.max(a||1,s);return o`
    ...
    `}_renderRecentActivities(e){let t=this._lang,a=e.history.slice(-3).reverse();if(a.length===0)return d;let s=r=>{switch(r){case"completed":return"\u2713";case"triggered":return"\u2297";case"skipped":return"\u21B7";case"reset":return"\u21BA";default:return"\xB7"}};return o`
      <div class="recent-activities">
        ...
        ${a.map(r=>o`
          <div class="activity-item">
            ...
            ${r.cost?o`<span class="activity-badge">${r.cost.toFixed(0)}${this._budget?.currency_symbol||"\u20AC"}</span>`:d}
            ${r.duration?o`<span class="activity-badge">${r.duration}min</span>`:d}
          </div>
        `)}
    ...
    `}_renderHistoryFilters(e){let t=this._lang;return o`
      <div class="history-filters-new">
        <div class="filter-chips">
          ${["completed","skipped","reset","triggered"].map(a=>{let s=e.history.filter(r=>r.type===a).length;return s===0?d:o`
              <span class="filter-chip ${this._historyFilter===a?"active":""}"
                @click=${()=>{this._historyFilter=this._historyFilter===a?null:a}}>
                ${i(a,t)} (${s})
              </span>
            `})}
          ${this._historyFilter?o`<span class="filter-chip clear" @click=${()=>{this._historyFilter=null}}>${i("show_all",t)}</span>`:d}
        </div>
    ...
    `}_renderHistoryList(e){let t=this._lang,a=this._historyFilter?e.history.filter(s=>s.type===this._historyFilter):e.history;if(this._historySearch){let s=this._historySearch.toLowerCase();a=a.filter(r=>r.notes?.toLowerCase().includes(s))}return a.length===0?o`<p class="empty">${i("no_history",t)}</p>`:o`
      ...
      <div class="history-entry">
        ...
        <div class="history-content">
          ...
          <div class="history-details">
            ${e.cost!=null?o`<span>${i("cost",t)}: ${e.cost.toFixed(2)} ${this._budget?.currency_symbol||"\u20AC"}</span>`:d}
            ${e.duration!=null?o`<span>${i("duration",t)}: ${e.duration} min</span>`:d}
            ${e.trigger_value!=null?o`<span>${i("trigger_val",t)}: ${e.trigger_value}</span>`:d}
          </div>
        </div>
      </div>
