...
`;var Fi={days:1,weeks:7,months:30.4368,years:365.25};function ut(o,r){return!o||o<=0?0:o*(Fi[r||"days"]??1)}function ht(o,r,e){let t=ut(o,e);if(t<=0||r==null)return{pct:0,overflow:!1};let i=(t-r)/t*100;return{pct:Math.max(0,Math.min(100,i)),overflow:i>100}}function _t(o,r=new Date){if(!o)return{kind:"none",days:null,date:null};let e=new Date(`${o}T00:00:00`);if(isNaN(e.getTime()))return{kind:"none",days:null,date:null};let t=Date.UTC(r.getFullYear(),r.getMonth(),r.getDate()),i=Date.UTC(e.getFullYear(),e.getMonth(),e.getDate()),a=Math.round((i-t)/864e5);return a<0?{kind:"expired",days:a,date:o}:a<=60?{kind:"expiring",days:a,date:o}:{kind:"valid",days:a,date:o}}var _e=[{key:"name",labelKey:"name",required:!0},{key:"manufacturer",labelKey:"manufacturer"},{key:"model",labelKey:"model"},{key:"serial_number",labelKey:"serial_number_label"},{key:"installation_date",labelKey:"installed"},{key:"warranty_expiry",labelKey:"warranty"},{key:"area_id",labelKey:"area"},{key:"documentation_url",labelKey:"documentation_url_label"},{key:"notes",labelKey:"object_notes_label"},{key:"task_count",labelKey:"tasks"},{key:"actions",labelKey:"actions"}],Oi=_e.map(o=>o.key),Oe=["name","manufacturer","model","serial_number","installation_date","warranty_expiry","area_id","task_count","actions"];function Te(o){if(!Array.isArray(o))return[...Oe];let r=new Set,e=[];for(let t of o)typeof t=="string"&&Oi.includes(t)&&!r.has(t)&&(r.add(t),e.push(t));return e.length?(e.includes("name")||e.unshift("name"),e):[...Oe]}function Ne(o,r,e){let t=new Blob([o],{type:e}),i=URL.createObjectURL(t),a=document.createElement("a");a.href=i,a.download=r,a.target="_blank",a.rel="noopener",a.style.display="none",document.body.appendChild(a),a.dispatchEvent(new MouseEvent("click")),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(i),6e4)}function Ot(o,r){let e=document.createElement("a");e.href=o,e.download=r,e.target="_blank",e.rel="noopener",e.style.display="none",document.body.appendChild(e),e.dispatchEvent(new MouseEvent("click")),document.body.removeChild(e)}var Nt=M`
  :host {
    display: block;
    height: 100%;
...
`;var Ue=class{constructor(r){this._cache=new Map;this._pending=new Map;this._hass=r}updateHass(r){this._hass=r}async getDetailStats(r,e){return this._getStats(r,"hour",30,e)}async getMiniStats(r,e){return this._getStats(r,"day",14,e)}async getBatchMiniStats(r){let e=new Map,t=[];for(let p of r){let g=`${p.entityId}:day`,m=this._cache.get(g);m&&Date.now()-m.fetchedAt<3e5?e.set(p.entityId,m.points):t.push(p)}if(t.length===0)return e;let i=t.filter(p=>p.isCounter).map(p=>p.entityId),a=t.filter(p=>!p.isCounter).map(p=>p.entityId),l=new Date(Date.now()-336*60*60*1e3).toISOString(),c=[];return i.length>0&&c.push(this._fetchBatch(i,"day",l,["state","sum","change"],!0,e)),a.length>0&&c.push(this._fetchBatch(a,"day",l,["mean","min","max"],!1,e)),await Promise.all(c),e}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(r,e,t,i){let a=`${r}:${e}`,l=this._cache.get(a);if(l&&Date.now()-l.fetchedAt<3e5)return l.points;if(this._pending.has(a))return this._pending.get(a);let c=this._fetchAndNormalize(r,e,t,i,a);this._pending.set(a,c);try{return await c}finally{this._pending.delete(a)}}async _fetchAndNormalize(r,e,t,i,a){let l=new Date(Date.now()-t*24*60*60*1e3).toISOString(),c=i?["state","sum","change"]:["mean","min","max"];try{let g=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:l,statistic_ids:[r],period:e,types:c}))[r]||[],m=this._normalizeRows(g,i);return this._cache.set(a,{entityId:r,fetchedAt:Date.now(),period:e,points:m}),m}catch(p){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${r}:`,p),[]}}async _fetchBatch(r,e,t,i,a,l){try{let c=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:t,statistic_ids:r,period:e,types:i});for(let p of r){let g=c[p]||[],m=this._normalizeRows(g,a);l.set(p,m),this._cache.set(`${p}:${e}`,{entityId:p,fetchedAt:Date.now(),period:e,points:m})}}catch(c){console.warn("[maintenance-supporter] Batch statistics fetch failed:",c)}}_normalizeRows(r,e){let t=[];for(let i of r){let a=null;if(e?a=i.state??null:a=i.mean??null,a===null)continue;let l={ts:i.start,val:a};e||(i.min!=null&&(l.min=i.min),i.max!=null&&(l.max=i.max)),t.push(l)}return t.sort((i,a)=>i.ts-a.ts),t}};var oe=class{constructor(r){this.usersCache=null;this.cacheTimestamp=0;this.CACHE_TTL_MS=6e4;this.hass=r}updateHass(r){this.hass=r}async getUsers(r=!1){let e=Date.now();if(!r&&this.usersCache&&e-this.cacheTimestamp<this.CACHE_TTL_MS)return this.usersCache;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/users/list"});return this.usersCache=t.users,this.cacheTimestamp=e,this.usersCache}catch(t){return console.error("Failed to fetch users:",t),this.usersCache||[]}}async assignUser(r,e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/assign_user",entry_id:r,task_id:e,user_id:t})}async getTasksByUser(r){return(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tasks/by_user",user_id:r})).tasks}getUserName(r){return!r||!this.usersCache?null:this.usersCache.find(t=>t.id===r)?.name||null}getUser(r){return!r||!this.usersCache?null:this.usersCache.find(e=>e.id===r)||null}getCurrentUserId(){return this.hass.user?.id||null}isCurrentUser(r){return r?r===this.getCurrentUserId():!1}clearCache(){this.usersCache=null,this.cacheTimestamp=0}};var Ni={name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",warranty_expiry:"warranty_expiry_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_for_minutes:"trigger_for_minutes"};function Ui(o,r){let e=Ni[o];if(!e)return o;let t=s(e,r);return t&&t!==e?t:o}function Bi(o){let e=o.match(/data\['([^']+)'\]/)?.[1],t;return(t=o.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=o.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=o.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=o.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(o)?{field:e,rule:"required"}:(t=o.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(o)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(o)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function N(o,r,e){if(typeof o=="string")return o;if(typeof o!="object"||o===null)return e;let t=o,i=t.message||t.error?.message||"";if(!i)return e;let a=Bi(i),l=a.field?Ui(a.field,r):"",c=p=>s(p,r).replace("{field}",l).replace("{n}",a.param??"");switch(a.rule){case"too_long":return c("err_too_long");case"too_short":return c("err_too_short");case"value_too_high":return c("err_value_too_high");case"value_too_low":return c("err_value_too_low");case"required":return c("err_required");case"wrong_type":return c("err_wrong_type").replace("{type}",a.param??"");case"invalid_choice":return c("err_invalid_choice");case"invalid_value":return c("err_invalid_value");default:return i||e}}var V=class extends A{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return n`
  ...
  `,u([w({attribute:!1})],U.prototype,"hass",2),u([h()],U.prototype,"_open",2),u([h()],U.prototype,"_loading",2),u([h()],U.prototype,"_error",2),u([h()],U.prototype,"_name",2),u([h()],U.prototype,"_manufacturer",2),u([h()],U.prototype,"_model",2),u([h()],U.prototype,"_serialNumber",2),u([h()],U.prototype,"_areaId",2),u([h()],U.prototype,"_installationDate",2),u([h()],U.prototype,"_warrantyExpiry",2),u([h()],U.prototype,"_documentationUrl",2),u([h()],U.prototype,"_notes",2),u([h()],U.prototype,"_entryId",2);customElements.get("maintenance-object-dialog")||customElements.define("maintenance-object-dialog",U);var Ut=["manual","warranty","invoice","spare_parts","photo","other"],Wi={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"};function Vi(o){let r=o??0;return r<1024?`${r} B`:r<1024*1024?`${(r/1024).toFixed(1)} KB`:`${(r/(1024*1024)).toFixed(1)} MB`}var W=class extends A{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._hint="";this._addingLink=!1;this._linkUrl="";this._linkTitle="";this._category="manual";this._loadedFor=null}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),this.hass&&this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=e.documents||[],this._loaded=!0,this._error=""}catch(e){this._error=N(e,this._lang),this._loaded=!0}}_category_of(e){return(e.tags||[]).find(i=>Ut.includes(i))||"other"}_onFileInput(e){let t=e.target,i=t.files?.[0];i&&this._upload(i),t.value=""}async _upload(e){this._busy=!0,this._error="",this._hint="";try{let t=new FormData;t.append("entry_id",this.entryId),t.append("tags",this._category),t.append("file",e,e.name);let i=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:t});if(!i.ok){this._error=i.status===413?s("doc_too_large",this._lang):s("doc_upload_failed",this._lang);return}let a=await i.json();a.duplicate_in_object?this._hint=s("doc_dup_in_object",this._lang):a.deduped&&(this._hint=s("doc_deduped",this._lang)),await this._load()}catch{this._error=s("doc_upload_failed",this._lang)}finally{this._busy=!1}}async _download(e){try{let t=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:30});Ot(t.path,e.filename||e.title||"document")}catch(t){this._error=N(t,this._lang)}}async _delete(e){let t=e.title||e.filename||e.url||"";if(window.confirm(s("doc_delete_confirm",this._lang).replace("{name}",t))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:e.id}),await this._load()}catch(i){this._error=N(i,this._lang)}finally{this._busy=!1}}}async _addLink(){let e=this._linkUrl.trim();if(e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/add_link",entry_id:this.entryId,url:e,title:this._linkTitle.trim()||null}),this._linkUrl="",this._linkTitle="",this._addingLink=!1,await this._load()}catch(t){this._error=N(t,this._lang,s("doc_link_invalid",this._lang))}finally{this._busy=!1}}}render(){let e=this._lang;return n`
      <div class="doc-header">
        ...
        ${this.canWrite?n`
              <div class="doc-actions">
                ...
                >
                  ${Ut.map(t=>n`<option value=${t}>${s(`doc_cat_${t}`,e)}</option>`)}
                </select>
    ...
    `}_renderDoc(e,t){let i=e.kind==="file",a=this._category_of(e),l=i?`${s(`doc_cat_${a}`,t)} \xB7 ${Vi(e.size)}`:s("doc_link_badge",t);return n`
      <div class="doc-row">
        <ha-icon class="doc-icon" icon=${i?Wi[a]:"mdi:link-variant"}></ha-icon>
        <div class="doc-info">
          <div class="doc-title">${e.title||e.filename||e.url}</div>
          <div class="doc-meta">${l}</div>
        </div>
        <div class="doc-row-actions">
          ${i?n`<button class="icon-btn" title=${s("doc_open",t)} @click=${()=>this._download(e)}>
...
`).map(c=>c.trim()).filter(Boolean).slice(0,100);e.checklist=l.length?l:null}if(this.completionActionsEnabled){let l=this._actionService.trim();if(l&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(l)){let m={service:l},_=this._actionTargetEntity.trim();_&&(m.target={entity_id:_});let v=this._buildActionData();Object.keys(v).length>0&&(m.data=v),e.on_complete_action=m}else e.on_complete_action=null;let c={};this._qcNotes.trim()&&(c.notes=this._qcNotes.trim());let p=parseFloat(this._qcCost);!isNaN(p)&&p>=0&&(c.cost=p);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(c.duration=g),this._qcFeedback&&(c.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(c).length?c:null}let t=await this.hass.connection.sendMessagePromise(e),i=this._taskId||t?.task_id,a=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(i&&this._scheduleType==="sensor_based"&&a)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:i,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=N(e,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return d;let e=this._lang;return n`
      ...
      <div class="select-row">
        ...
        >
          ${Qi.map(t=>n`<option value=${t} ?selected=${t===this._triggerType}>${s(t,e)}</option>`)}
        </select>
      </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Ki.map(i=>n`<option value=${i} ?selected=${i===this._type}>${s(i,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${Yi.map(i=>n`<option value=${i} ?selected=${i===this._scheduleType}>${s(i,e)}</option>`)}
            </select>
          </div>
  ...
  `,u([w({attribute:!1})],$.prototype,"hass",2),u([w({type:Boolean,attribute:"checklists-enabled"})],$.prototype,"checklistsEnabled",2),u([w({type:Boolean,attribute:"schedule-time-enabled"})],$.prototype,"scheduleTimeEnabled",2),u([w({type:Boolean,attribute:"completion-actions-enabled"})],$.prototype,"completionActionsEnabled",2),u([w({type:Number,attribute:"default-warning-days"})],$.prototype,"defaultWarningDays",2),u([h()],$.prototype,"_open",2),u([h()],$.prototype,"_loading",2),u([h()],$.prototype,"_error",2),u([h()],$.prototype,"_entryId",2),u([h()],$.prototype,"_taskId",2),u([h()],$.prototype,"_objectChoices",2),u([h()],$.prototype,"_name",2),u([h()],$.prototype,"_type",2),u([h()],$.prototype,"_scheduleType",2),u([h()],$.prototype,"_intervalDays",2),u([h()],$.prototype,"_intervalUnit",2),u([h()],$.prototype,"_dueDate",2),u([h()],$.prototype,"_warningDays",2),u([h()],$.prototype,"_intervalAnchor",2),u([h()],$.prototype,"_weekdays",2),u([h()],$.prototype,"_nth",2),u([h()],$.prototype,"_nthWeekday",2),u([h()],$.prototype,"_domDay",2),u([h()],$.prototype,"_notes",2),u([h()],$.prototype,"_documentationUrl",2),u([h()],$.prototype,"_customIcon",2),u([h()],$.prototype,"_enabled",2),u([h()],$.prototype,"_triggerEntityId",2),u([h()],$.prototype,"_triggerEntityIds",2),u([h()],$.prototype,"_triggerEntityLogic",2),u([h()],$.prototype,"_triggerAttribute",2),u([h()],$.prototype,"_triggerType",2),u([h()],$.prototype,"_triggerAbove",2),u([h()],$.prototype,"_triggerBelow",2),u([h()],$.prototype,"_triggerForMinutes",2),u([h()],$.prototype,"_triggerTargetValue",2),u([h()],$.prototype,"_triggerDeltaMode",2),u([h()],$.prototype,"_triggerFromState",2),u([h()],$.prototype,"_triggerToState",2),u([h()],$.prototype,"_triggerTargetChanges",2),u([h()],$.prototype,"_triggerRuntimeHours",2),u([h()],$.prototype,"_suggestedAttributes",2),u([h()],$.prototype,"_availableAttributes",2),u([h()],$.prototype,"_entityDomain",2),u([h()],$.prototype,"_lastPerformed",2),u([h()],$.prototype,"_nfcTagId",2),u([h()],$.prototype,"_availableTags",2),u([h()],$.prototype,"_responsibleUserId",2),u([h()],$.prototype,"_availableUsers",2),u([h()],$.prototype,"_checklistText",2),u([h()],$.prototype,"_scheduleTime",2),u([h()],$.prototype,"_actionService",2),u([h()],$.prototype,"_actionTargetEntity",2),u([h()],$.prototype,"_actionData",2),u([h()],$.prototype,"_actionDataJsonFallback",2),u([h()],$.prototype,"_actionTesting",2),u([h()],$.prototype,"_actionTestResult",2),u([h()],$.prototype,"_actionTestError",2),u([h()],$.prototype,"_qcNotes",2),u([h()],$.prototype,"_qcCost",2),u([h()],$.prototype,"_qcDuration",2),u([h()],$.prototype,"_qcFeedback",2),u([h()],$.prototype,"_environmentalEntity",2),u([h()],$.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",$);var D=class extends A{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed"}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed")}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=N(e,this.lang,s("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return n``;let e=this.lang||this.hass?.language||"en";return n`
      <ha-dialog open @closed=${this._close}>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,u([w({attribute:!1})],Z.prototype,"hass",2),u([w()],Z.prototype,"lang",2),u([h()],Z.prototype,"_open",2),u([h()],Z.prototype,"_loading",2),u([h()],Z.prototype,"_error",2),u([h()],Z.prototype,"_viewResult",2),u([h()],Z.prototype,"_completeResult",2),u([h()],Z.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",Z);var Wt=5;function Se(o){let r=o.getFullYear(),e=String(o.getMonth()+1).padStart(2,"0"),t=String(o.getDate()).padStart(2,"0");return`${r}-${e}-${t}`}function Xi(o,r){let e=[];for(let t=0;t<r;t++){let i=new Date(o);i.setDate(i.getDate()+t),i.setHours(0,0,0,0),e.push(Se(i))}return e}function Be(o,r){let[e,t,i]=o.split("-").map(Number),a=new Date(e,t-1,i);return a.setDate(a.getDate()+r),Se(a)}function es(o){if(!o||o.length===0)return null;let r=o.map(e=>e.cost).filter(e=>typeof e=="number");return r.length===0?null:r.reduce((e,t)=>e+t,0)/r.length}function ts(o){let{windowStart:r,windowEnd:e,task:t,entryId:i,objectName:a}=o,l=[],c=(_,v)=>({date:_,entry_id:i,task_id:t.id,task_name:t.name,object_name:a,status:v&&(t.status==="overdue"||t.status==="triggered")?"ok":t.status,days_until_due:v?null:t.days_until_due??null,projected:v,schedule_type:t.schedule_type,interval_days:t.interval_days??null,interval_unit:t.interval_unit??null,responsible_user_id:t.responsible_user_id??null,avg_cost:es(t.history),adaptive_enabled:!!t.adaptive_config?.enabled,prediction_confidence:t.threshold_prediction_confidence??null}),p=Math.max(1,Math.round(ut(t.interval_days,t.interval_unit)));if(t.status==="overdue"||t.status==="triggered"){if(l.push(c(r,!1)),t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let _=Be(r,p),v=1;for(;_<=e&&v<Wt;)l.push(c(_,!0)),v++,_=Be(_,p)}return l}let g=t.next_due;if(typeof g!="string"||!g)return l;let m=g.slice(0,10);if(m>=r&&m<=e)l.push(c(m,!1));else if(m>e)return l;if(t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let _=Be(m,p),v=l.length;for(;_<=e&&v<Wt;)_>=r&&(l.push(c(_,!0)),v++),_=Be(_,p)}return l}var Vt={overdue:0,triggered:1,due_soon:2,ok:3};function Kt(o,r,e,t=null){let i=Xi(r,e),a=i[0],l=i[i.length-1],c=[];for(let g of o){let m=g.object?.name||"",_=g.entry_id,v=g.tasks||[];for(let f of v){if(t&&f.responsible_user_id!==t||f.enabled===!1)continue;let x=ts({windowStart:a,windowEnd:l,task:f,entryId:_,objectName:m});c.push(...x)}}let p=new Map;for(let g of i)p.set(g,[]);for(let g of c){let m=p.get(g.date);m&&m.push(g)}for(let[,g]of p)g.sort((m,_)=>{let v=Vt[m.status]??99,f=Vt[_.status]??99;if(v!==f)return v-f;if(m.projected!==_.projected)return m.projected?1:-1;let x=m.object_name.localeCompare(_.object_name);return x!==0?x:m.task_name.localeCompare(_.task_name)});return i.map(g=>({date:g,events:p.get(g)??[]}))}var is={completed:"ok",reset:"ok",skipped:"due_soon",triggered:"triggered",trigger_replaced:"triggered"};function ss(o,r){let e=[];for(let t=r-1;t>=0;t--){let i=new Date(o);i.setDate(i.getDate()-t),i.setHours(0,0,0,0),e.push(Se(i))}return e}function Yt(o,r,e,t=null){let i=ss(r,e),a=i[0],l=i[i.length-1],c=new Map;for(let g of i)c.set(g,[]);for(let g of o){let m=g.object?.name||"",_=g.entry_id,v=g.tasks||[];for(let f of v){if(t&&f.responsible_user_id!==t)continue;let x=f.history||[];for(let b of x){if(typeof b?.timestamp!="string")continue;let L=b.timestamp.slice(0,10);if(L<a||L>l)continue;let I=c.get(L);if(!I)continue;let S=b.type??"completed";I.push({date:L,entry_id:_,task_id:f.id,task_name:f.name,object_name:m,status:is[S]??"ok",days_until_due:null,projected:!1,schedule_type:f.schedule_type,interval_days:f.interval_days??null,responsible_user_id:f.responsible_user_id??null,avg_cost:typeof b.cost=="number"?b.cost:null,adaptive_enabled:!!f.adaptive_config?.enabled,prediction_confidence:null,history_timestamp:b.timestamp,history_type:S,history_cost:typeof b.cost=="number"?b.cost:null,history_notes:typeof b.notes=="string"?b.notes:null,history_duration:typeof b.duration=="number"?b.duration:null})}}}let p={completed:0,reset:1,skipped:2,triggered:3,trigger_replaced:4};for(let[,g]of c)g.sort((m,_)=>{let v=p[m.history_type??""]??99,f=p[_.history_type??""]??99;if(v!==f)return v-f;let x=m.object_name.localeCompare(_.object_name);return x!==0?x:m.task_name.localeCompare(_.task_name)});return i.map(g=>({date:g,events:c.get(g)??[]}))}var Gt=M`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;var X=class extends A{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter)}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){super.updated(e);let t=this.hass?.language;if(t&&!Pe(t)&&ze(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}_onEventClick(e){if(e.history_timestamp){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return d;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,l=null;this._userFilter&&(l=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let c=new Date;c.setHours(0,0,0,0);let p=this._pastDays>0,g=p?Yt(this._objects,c,this._pastDays,l):Kt(this._objects,c,this._windowDays,l),m=Se(c),_=this._windowDays===365||p,v=_?g.filter(b=>b.events.length>0):g,f=b=>{let L=`cal-status-${b.status}`,I=b.projected?"cal-event-projected":"",S=b.status==="overdue"&&b.days_until_due!=null?` (${Math.abs(b.days_until_due)}d ${s("overdue",e).toLowerCase()})`:"",k=b.projected&&b.interval_days?n`<span class="cal-event-recur">${b.interval_unit&&b.interval_unit!=="days"?`${b.interval_days} ${s("unit_"+b.interval_unit,e)}`:s("cal_every_n_days",e).replace("{n}",String(b.interval_days))}</span>`:d,R=b.schedule_type==="sensor_based",F=R?n`<ha-icon class="cal-event-icon cal-source-sensor"
                ...
                icon="${b.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,K=R&&b.prediction_confidence&&b.status!=="triggered"&&!b.projected?n`<span class="cal-event-prediction cal-conf-${b.prediction_confidence}">
            ${s("cal_predicted",e)} · ${s(`cal_confidence_${b.prediction_confidence}`,e)}
          </span>`:d,Q=this._stats?.budget?.currency_symbol||"\u20AC",H=b.history_type?s(b.history_type,e):s(b.status,e);return n`
        <div class="cal-event ${I}"
          ...
          ${b.avg_cost!=null&&b.avg_cost>0?n`<span class="cal-event-cost">${b.avg_cost.toFixed(0)} ${Q}</span>`:d}
        </div>
      `},x=b=>{let[L,I,S]=b.date.split("-").map(Number),k=new Date(L,I-1,S),R=b.date===m,F=k.toLocaleDateString(e,{weekday:"short"}),K=k.toLocaleDateString(e,{month:"long"});return n`
    ...
    `],u([w({attribute:!1})],X.prototype,"hass",2),u([h()],X.prototype,"_config",2),u([h()],X.prototype,"_objects",2),u([h()],X.prototype,"_stats",2),u([h()],X.prototype,"_windowDays",2),u([h()],X.prototype,"_pastDays",2),u([h()],X.prototype,"_userFilter",2),u([h()],X.prototype,"_unsub",2);var as=[{value:7,label:"Week (7 days)"},{value:14,label:"Fortnight (14 days)"},{value:30,label:"Month (30 days, default)"},{value:365,label:"Year (365 days, empty days collapsed)"}],me=class extends A{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}setConfig(e){this._config={...e}}_valueChanged(e,t){let i={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete i.show_window_chips,e==="show_user_filter"&&t===!0&&delete i.show_user_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete i.title,e==="user_filter"&&t===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let e=this._config.window_days??30,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.user_filter??"",l=this._config.title??"";return n`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${as.map(c=>n`<option value="${c.value}" ?selected=${c.value===e}>${c.label}</option>`)}
          </select>
        </div>
  ...
  `,u([w({attribute:!1})],Y.prototype,"hass",2),u([h()],Y.prototype,"_open",2),u([h()],Y.prototype,"_title",2),u([h()],Y.prototype,"_message",2),u([h()],Y.prototype,"_confirmText",2),u([h()],Y.prototype,"_danger",2),u([h()],Y.prototype,"_inputLabel",2),u([h()],Y.prototype,"_inputType",2),u([h()],Y.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",Y);var Jt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Zt=o=>(...r)=>({_$litDirective$:o,values:r}),Ve=class{constructor(r){}get _$AU(){return this._$AM._$AU}_$AT(r,e,t){this._$Ct=r,this._$AM=e,this._$Ci=t}_$AS(r,e){return this.update(r,e)}update(r,e){return this.render(...e)}};var Ae=class extends Ve{constructor(r){if(super(r),this.it=d,r.type!==Jt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(r){if(r===d||r==null)return this._t=void 0,this.it=r;if(r===ie)return r;if(typeof r!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(r===this.it)return this._t;this.it=r;let e=[r];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};Ae.directiveName="unsafeHTML",Ae.resultType=1;var Xt=Zt(Ae);var ns=["EUR","USD","GBP","JPY","CHF","CAD","AUD","CNY","INR","BRL","CZK","PLN","RUB","SEK","NOK","DKK","UAH"],j=class extends A{constructor(){super(...arguments);this.budget=null;this._settings=null;this._loading=!0;this._importCsv="";this._importLoading=!1;this._includeHistory=!0;this._toast="";this._testingNotification=!1;this._users=[];this._vacEnabled=!1;this._vacStart="";this._vacEnd="";this._vacBuffer=3;this._vacExempt=new Set;this._vacIsActive=!1;this._vacWindowEnd=null;this._vacAllTasks=[];this._vacPreview=[];this._vacPreviewLoading=!1;this._vacSaving=!1;this._qrObjects=[];this._qrSelectedEntries=new Set;this._qrActions=new Set(["view"]);this._qrUrlMode="companion";this._qrBatchLoading=!1;this._qrBatchResults=[];this._qrObjectsLoaded=!1;this._loaded=!1;this._userService=null;this._sendTestNotification=async()=>{this._testingNotification=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/test_notification"}),t=e.message||(e.success?s("test_notification_success",this._lang):s("test_notification_failed",this._lang));this._showToast(t)}catch{this._showToast(s("test_notification_failed",this._lang))}finally{this._testingNotification=!1}}}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded?(this._loaded=!0,this._userService=new oe(this.hass),this._loadSettings(),this._loadUsers()):e.has("hass")&&this.hass&&this._userService&&this._userService.updateHass(this.hass)}async _loadUsers(){if(this._userService)try{this._users=await this._userService.getUsers()}catch{this._users=[]}}async _loadSettings(){this._loading=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});this._settings=e,this._hydrateVacationFromSettings()}catch{}this._loading=!1}_hydrateVacationFromSettings(){let e=this._settings?.vacation;e&&(this._vacEnabled=e.enabled,this._vacStart=e.start||"",this._vacEnd=e.end||"",this._vacBuffer=e.buffer_days,this._vacExempt=new Set(e.exempt_task_ids||[]),this._vacIsActive=e.is_active,this._vacWindowEnd=e.window_end)}async _updateSetting(e,t){try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:{[e]:t}});this._settings=i,this._showToast(s("settings_saved",this._lang)),this.dispatchEvent(new CustomEvent("settings-changed"))}catch{this._showToast(s("action_error",this._lang))}}_showToast(e){this._toast=e,setTimeout(()=>{this._toast=""},3e3)}_downloadFile(e,t,i){Ne(e,t,i)}render(){let e=this._lang;return this._loading||!this._settings?n`<div class="settings-loading">Loading…</div>`:n`
    ...
    `}_renderObjectsColumns(e){let t=Te(this._settings.objects_table_columns);return n`
      ...
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select @change=${c=>this._updateSetting("budget_currency",c.target.value)}>
            ${ns.map(c=>n`<option value=${c} ?selected=${l.currency===c}>${c}</option>`)}
          </select>
        </label>
        <label class="setting-row">
...
<body>
  ...
  `,u([w({attribute:!1})],j.prototype,"hass",2),u([w({attribute:!1})],j.prototype,"features",2),u([w({attribute:!1})],j.prototype,"budget",2),u([h()],j.prototype,"_settings",2),u([h()],j.prototype,"_loading",2),u([h()],j.prototype,"_importCsv",2),u([h()],j.prototype,"_importLoading",2),u([h()],j.prototype,"_includeHistory",2),u([h()],j.prototype,"_toast",2),u([h()],j.prototype,"_testingNotification",2),u([h()],j.prototype,"_users",2),u([h()],j.prototype,"_vacEnabled",2),u([h()],j.prototype,"_vacStart",2),u([h()],j.prototype,"_vacEnd",2),u([h()],j.prototype,"_vacBuffer",2),u([h()],j.prototype,"_vacExempt",2),u([h()],j.prototype,"_vacIsActive",2),u([h()],j.prototype,"_vacWindowEnd",2),u([h()],j.prototype,"_vacAllTasks",2),u([h()],j.prototype,"_vacPreview",2),u([h()],j.prototype,"_vacPreviewLoading",2),u([h()],j.prototype,"_vacSaving",2),u([h()],j.prototype,"_qrObjects",2),u([h()],j.prototype,"_qrSelectedEntries",2),u([h()],j.prototype,"_qrActions",2),u([h()],j.prototype,"_qrUrlMode",2),u([h()],j.prototype,"_qrBatchLoading",2),u([h()],j.prototype,"_qrBatchResults",2),u([h()],j.prototype,"_qrObjectsLoaded",2);customElements.define("maintenance-settings-view",j);var os=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"],ee=class extends A{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._error="";this._entryId="";this._taskId="";this._values=new Array(12).fill("");this._save=async()=>{let e=this._buildOverrides();if(e!==null){this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:e}),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(t){this._error=N(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}};this._clearAll=async()=>{this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:{}}),this._values=new Array(12).fill(""),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(e){this._error=N(e,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}open(e,t,i){if(this._entryId=e,this._taskId=t,this._values=new Array(12).fill(""),i)for(let[a,l]of Object.entries(i)){let c=parseInt(a,10);c>=1&&c<=12&&typeof l=="number"&&(this._values[c-1]=l.toString())}this._error="",this._open=!0}_close(){this._open=!1}_buildOverrides(){let e={};for(let t=0;t<12;t++){let i=this._values[t].trim();if(!i)continue;let a=parseFloat(i);if(Number.isNaN(a))return this._error=`${s("month_"+["jan","feb","mar","apr","may","jun","jul","aug","sep","oct","nov","dec"][t],this._lang)}: ${s("seasonal_override_invalid",this._lang)}`,null;if(a<.1||a>5)return this._error=s("seasonal_override_range",this._lang),null;e[t+1]=a}return e}render(){if(!this._open)return n``;let e=this._lang;return n`
  ...
  `,u([w({attribute:!1})],G.prototype,"hass",2),u([w({attribute:!1})],G.prototype,"objects",2),u([h()],G.prototype,"_open",2),u([h()],G.prototype,"_loading",2),u([h()],G.prototype,"_error",2),u([h()],G.prototype,"_groupId",2),u([h()],G.prototype,"_name",2),u([h()],G.prototype,"_description",2),u([h()],G.prototype,"_selected",2);customElements.get("maintenance-group-dialog")||customElements.define("maintenance-group-dialog",G);var ls=300,cs=140,gt=27;function ti(o,r){let e=o.trigger_config;if(!e)return d;let t=r.lang,i=o.trigger_entity_info,a=o.trigger_entity_infos,l=i?.friendly_name||e.entity_id||"\u2014",c=e.entity_id||"",p=e.entity_ids||(c?[c]:[]),g=i?.unit_of_measurement||"",m=o.trigger_current_value,_=e.type||"threshold",v=p.length>1;return n`
    <h3>${s("trigger",t)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${v?n`
            ...
            <div class="trigger-entity-id">${p.map((f,x)=>n`${x>0?", ":""}<span class="entity-link" @click=${b=>pe(b,f)}>${f}</span>`)}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `:n`
            <div class="trigger-entity-name">${l}</div>
            <div class="trigger-entity-id">${c?n`<span class="entity-link" @click=${f=>pe(f,c)}>${c}</span>`:""}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `}
        </div>
      ...
      <div class="trigger-limits">
        ...
        ${_==="compound"?n`
          ...
          ${(e.conditions||[]).map((f,x)=>n`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${x+1}. ${s(f.type||"unknown",t)}: ${f.entity_id?n`<span class="entity-link" @click=${b=>pe(b,f.entity_id)}>${f.entity_id}</span>`:""}</span>
          `)}
        `:d}
      ...
      ${a&&a.length>1?n`
        <div class="trigger-entity-list">
          ${a.map(f=>n`
            <span class="trigger-entity-id">${f.friendly_name} (<span class="entity-link" @click=${x=>pe(x,f.entity_id)}>${f.entity_id}</span>)</span>
          `)}
        </div>
      `:d}
  ...
  `}function ds(o,r,e){let t=o.trigger_config;if(!t)return d;let i=t.type||"threshold",a=i==="counter"&&t.trigger_delta_mode,l=e.isCounterEntity(t),c=t.entity_id||"",p=e.detailStatsData.get(c)||[],g=[],m=!1;if(p.length>=2)for(let y of p){let C=y.val;a&&o.trigger_baseline_value!=null&&(C-=o.trigger_baseline_value);let O={ts:y.ts,val:C};!l&&y.min!=null&&y.max!=null&&(O.min=a&&o.trigger_baseline_value!=null?y.min-o.trigger_baseline_value:y.min,O.max=a&&o.trigger_baseline_value!=null?y.max-o.trigger_baseline_value:y.max,m=!0),g.push(O)}else for(let y of o.history)y.trigger_value!=null&&g.push({ts:new Date(y.timestamp).getTime(),val:y.trigger_value});if(o.trigger_current_value!=null){let y=o.trigger_current_value;a&&o.trigger_baseline_value!=null&&(y-=o.trigger_baseline_value),g.push({ts:Date.now(),val:y})}if(g.length<2&&c&&e.hasStatsService&&!e.detailStatsData.has(c))return n`<div class="sparkline-container" aria-live="polite" style="display:flex;align-items:center;justify-content:center;height:140px;color:var(--secondary-text-color);font-size:12px;">
      <ha-icon icon="mdi:chart-line" style="--mdc-icon-size:16px;margin-right:8px;"></ha-icon>
      ${s("loading_chart",e.lang)}
    </div>`;if(g.length<2)return d;g.sort((y,C)=>y.ts-C.ts);let _=ls,v=cs,f=30,x=2,b=8,L=16,I=g.map(y=>y.val),S=Math.min(...I),k=Math.max(...I);if(m)for(let y of g)y.min!=null&&(S=Math.min(S,y.min)),y.max!=null&&(k=Math.max(k,y.max));t.trigger_above!=null&&(k=Math.max(k,t.trigger_above),S=Math.min(S,t.trigger_above)),t.trigger_below!=null&&(S=Math.min(S,t.trigger_below),k=Math.max(k,t.trigger_below));let R=null,F=null;if(i==="counter"&&t.trigger_target_value!=null){if(o.trigger_baseline_value!=null)R=o.trigger_baseline_value;else if(g.length>0){let y=[...o.history].filter(C=>C.type==="completed"||C.type==="reset").sort((C,O)=>new Date(O.timestamp).getTime()-new Date(C.timestamp).getTime())[0];if(y){let C=new Date(y.timestamp).getTime(),O=g[0],B=Math.abs(g[0].ts-C);for(let ae of g){let re=Math.abs(ae.ts-C);re<B&&(O=ae,B=re)}R=O.val}else R=g[0].val}R!=null?(F=R+t.trigger_target_value,k=Math.max(k,F),S=Math.min(S,R)):(k=Math.max(k,t.trigger_target_value),S=Math.min(S,0))}a&&o.trigger_baseline_value!=null&&(S=Math.min(S,0));let K=k-S||1;S-=K*.1,k+=K*.1;let Q=g[0].ts,H=g[g.length-1].ts,E=H-Q||1,P=y=>f+(y-Q)/E*(_-f-x),q=y=>b+(1-(y-S)/(k-S))*(v-b-L),Ke=g.map(y=>`${P(y.ts).toFixed(1)},${q(y.val).toFixed(1)}`).join(" "),di=`M${P(g[0].ts).toFixed(1)},${v-L} `+g.map(y=>`L${P(y.ts).toFixed(1)},${q(y.val).toFixed(1)}`).join(" ")+` L${P(g[g.length-1].ts).toFixed(1)},${v-L} Z`,Ye="";if(m){let y=g.filter(C=>C.min!=null&&C.max!=null);if(y.length>=2){let C=y.map(B=>`${P(B.ts).toFixed(1)},${q(B.max).toFixed(1)}`),O=[...y].reverse().map(B=>`${P(B.ts).toFixed(1)},${q(B.min).toFixed(1)}`);Ye=`M${C[0]} `+C.slice(1).map(B=>`L${B}`).join(" ")+` L${O[0]} `+O.slice(1).map(B=>`L${B}`).join(" ")+" Z"}}let mt=g[g.length-1],pi=P(mt.ts),ui=q(mt.val),vt=y=>Math.abs(y)>=1e4?(y/1e3).toFixed(0)+"k":y>=1e3?(y/1e3).toFixed(1)+"k":y.toFixed(y<10?1:0),hi=vt(k),_i=vt(S),gi=o.history.filter(y=>["completed","skipped","reset"].includes(y.type)).map(y=>({ts:new Date(y.timestamp).getTime(),type:y.type})).filter(y=>y.ts>=Q&&y.ts<=H),Ge=g;if(g.length>gt){let y=(g.length-1)/(gt-1);Ge=[];for(let C=0;C<gt;C++)Ge.push(g[Math.round(C*y)])}return n`
    <div class="sparkline-container">
      <svg class="sparkline-svg" viewBox="0 0 ${_} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_sparkline",e.lang)}">
        <text x="${f-3}" y="${b+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${hi}</text>
        <text x="${f-3}" y="${v-L+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${_i}</text>
        ...
        ${Ye?z`<path d="${Ye}" fill="var(--primary-color)" opacity="0.08" />`:d}
        <path d="${di}" fill="var(--primary-color)" opacity="0.15" />
        <polyline points="${Ke}" fill="none" stroke="var(--primary-color)" stroke-width="2" stroke-linejoin="round" />
        ${o.degradation_rate!=null&&o.degradation_trend!=="stable"&&o.degradation_trend!=="insufficient_data"&&g.length>=2?(()=>{let y=g[g.length-1],C=30,O=y.ts+C*864e5,B=y.val+o.degradation_rate*C,ae=Math.min(O,H+(H-Q)*.3),re=Math.max(S,Math.min(k,B)),mi=P(y.ts),vi=q(y.val),fi=P(ae),bi=q(re);return z`<line x1="${mi.toFixed(1)}" y1="${vi.toFixed(1)}" x2="${fi.toFixed(1)}" y2="${bi.toFixed(1)}" stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.7" />`})():d}
        ${i==="threshold"&&t.trigger_above!=null?z`<line x1="${f}" y1="${q(t.trigger_above).toFixed(1)}" x2="${_}" y2="${q(t.trigger_above).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${_-2}" y="${q(t.trigger_above)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25B2 ${t.trigger_above}</text>`:d}
        ${i==="threshold"&&t.trigger_below!=null?z`<line x1="${f}" y1="${q(t.trigger_below).toFixed(1)}" x2="${_}" y2="${q(t.trigger_below).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${_-2}" y="${q(t.trigger_below)+11}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25BC ${t.trigger_below}</text>`:d}
        ${i==="counter"&&F!=null?z`<line x1="${f}" y1="${q(F).toFixed(1)}" x2="${_}" y2="${q(F).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${_-2}" y="${q(F)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">${s("target_value",e.lang)}: +${t.trigger_target_value}</text>`:d}
        ${i==="counter"&&R!=null?z`<line x1="${f}" y1="${q(R).toFixed(1)}" x2="${_}" y2="${q(R).toFixed(1)}" stroke="var(--secondary-text-color)" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
                <text x="${f+2}" y="${q(R)+11}" text-anchor="start" fill="var(--secondary-text-color)" font-size="8">${s("baseline",e.lang)}</text>`:d}
        <circle cx="${pi.toFixed(1)}" cy="${ui.toFixed(1)}" r="3.5" fill="var(--primary-color)" />
        ${gi.map(y=>{let C=P(y.ts),O=y.type==="completed"?"var(--success-color, #4caf50)":y.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return z`
            <line x1="${C.toFixed(1)}" y1="${b}" x2="${C.toFixed(1)}" y2="${v-L}" stroke="${O}" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
            <circle cx="${C.toFixed(1)}" cy="${b+2}" r="5" fill="${O}" opacity="0.8" />
            <text x="${C.toFixed(1)}" y="${b+6}" text-anchor="middle" fill="white" font-size="7" font-weight="bold">${y.type==="completed"?"\u2713":y.type==="skipped"?"\u23ED":"\u21BA"}</text>
          `})}
        ${Ge.map(y=>{let C=P(y.ts),O=q(y.val),B=new Date(y.ts).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),ae=`${y.val.toFixed(1)} ${r}`;return m&&y.min!=null&&y.max!=null&&(ae+=` (${y.min.toFixed(1)}\u2013${y.max.toFixed(1)})`),z`<circle cx="${C.toFixed(1)}" cy="${O.toFixed(1)}" r="8" fill="transparent" tabindex="0"
            @mouseenter=${re=>ei(re,`${B}
${ae}`,e.setTooltip)}
            @focus=${re=>ei(re,`${B}
${ae}`,e.setTooltip)}
...
`).map(y=>n`<div>${y}</div>`)}
      ...
      <div class="prediction-grid">
        ...
        ${a&&e.environmental?n`
          <div class="prediction-item">
            ...
            ${o.environmental_entity?n`<span class="prediction-entity entity-link" @click=${c=>pe(c,o.environmental_entity)}>${o.environmental_entity}</span>`:d}
          </div>
        `:d}
      </div>
    </div>
  `}function si(o,r){let e=o.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return d;let a=o.interval_days??0,l=o.suggested_interval??a;return n`
  ...
  `}function _s(o,r,e){let t=o.confidence_interval_low,i=o.confidence_interval_high,a=r.suggested_interval??r.interval_days??0,l=r.interval_days??0,c=Math.max(0,t-5),g=i+5-c,m=(t-c)/g*100,_=(i-t)/g*100,v=(a-c)/g*100,f=l>0?(l-c)/g*100:-1;return n`
  ...
  `}function ai(o,r,e,t){let i=Math.max(o||1,r);return n`
  ...
  `}var ri=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function ni(o,r,e){if(!e.seasonal||!o.seasonal_factor||o.seasonal_factor===1)return d;let t=ri.map(c=>s(c,r)),i=new Date().getMonth(),a=o.seasonal_factors||o.interval_analysis?.seasonal_factors||null,l=a&&a.length===12?a:t.map((c,p)=>{let g=o.seasonal_factor||1,m=Math.sin((p-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,g+m))});return n`
    <div class="seasonal-card-compact">
      <h4>${s("seasonal_awareness",r)}</h4>
      <div class="seasonal-mini-chart">
        ${l.map((c,p)=>{let g=c*40,m=c<.9?"low":c>1.1?"high":"normal";return n`
  ...
  `}function oi(o,r){return gs(o,r)}function gs(o,r){let e=o.seasonal_factors??o.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return d;let t=o.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,l=100,c=8,g=l-c-4,m=Math.max(...e,1.5),_=a/12,v=_*.65,f=c+g-1/m*g;return n`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${a} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",r)}">
        ...
        ${e.map((x,b)=>{let L=x/m*g,I=b*_+(_-v)/2,S=c+g-L,k=b===i,R=x<1?"var(--success-color, #4caf50)":x>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return z`
      ...
      <div class="seasonal-labels">
        ${ri.map((x,b)=>n`<span class="seasonal-label ${b===i?"active-month":""}">${s(x,r)}</span>`)}
      </div>
    </div>
  `}var ms=300,vs=200;function li(o,r,e,t){let i=o.history.filter(c=>c.type==="completed"&&(c.cost!=null||c.duration!=null));if(i.length<2)return d;let a=i.some(c=>(c.cost??0)>0),l=i.some(c=>(c.duration??0)>0);return!a&&!l?d:n`
  ...
  `}function fs(o,r,e){let t=o.history.filter(E=>E.type==="completed"&&(E.cost!=null||E.duration!=null)).map(E=>({ts:new Date(E.timestamp).getTime(),cost:E.cost??0,duration:E.duration??0})).sort((E,P)=>E.ts-P.ts);if(t.length<2)return d;let i=t.some(E=>E.cost>0),a=t.some(E=>E.duration>0);if(!i&&!a)return d;let l=e!=="duration"&&i,c=e!=="cost"&&a,p=l||!c&&i,g=c||!l&&a,m=ms,_=vs,v=p?32:8,f=g?32:8,x=8,b=20,L=m-v-f,I=_-x-b,S=Math.max(...t.map(E=>E.cost))||1,k=Math.max(...t.map(E=>E.duration))||1,R=Math.min(20,L/t.length*.6),F=L/t.length,K=E=>v+F*E+F/2,Q=E=>x+I-E/S*I,H=E=>x+I-E/k*I;return n`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${m} ${_}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_history",r)}">
        ...
        <text x="${m-f}" y="${_-2}" text-anchor="end" fill="var(--secondary-text-color)" font-size="7">${new Date(t[t.length-1].ts).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</text>
        ${p?z`
  ...
  `}var bs=60,ys=20,ci=30,T=class extends A{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._unsub=null;this._sparklineTooltip=null;this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._operatorWriteEnabled=!1;this._defaultWarningDays=7;this._actionLoading=!1;this._moreMenuOpen=!1;this._toastMessage="";this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab="dashboard";this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._objectViewMode="cards";this._objectsTableColumns=Oe;this._showArchived=!1;this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=e=>this._onPopState(e);this._deepLinkHandled=!1;this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=e=>{let t=e.detail;t?.type==="maintenance-supporter:open-task"&&t.entry_id&&t.task_id&&(e.stopPropagation(),this._showTask(t.entry_id,t.task_id))};this._onHistoryEntrySaved=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"en"}get _isOperator(){let e=this.hass?.user;return e?e.is_admin?!1:!(this._operatorWriteEnabled&&this._adminPanelUserIds.includes(e.id)):!0}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._popstateHandler);let e=localStorage.getItem("maintenance_supporter_sort");e&&["due_date","object","type","task_name","area","assigned_user","group"].includes(e)&&(this._sortMode=e);let t=localStorage.getItem("maintenance_supporter_object_sort");t&&["alphabetical","due_soonest","task_count"].includes(t)&&(this._objectSortMode=t);let i=localStorage.getItem("maintenance_supporter_groupby");i&&["none","area","group","user"].includes(i)&&(this._groupByMode=i);let a=localStorage.getItem("maintenance_supporter_object_view");(a==="cards"||a==="table")&&(this._objectViewMode=a)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(e){super.updated(e);let t=this.hass?.language;if(t&&!Pe(t)&&ze(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Ue(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new oe(this.hass),this._userService.getUsers())}}async _loadData(){let[e,t,i,a,l]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null)]);if(e&&(this._objects=e.objects),t&&(this._stats=t),i&&(this._budget=i),a&&(this._groups=a.groups||{}),l){let c=l;this._features=c.features,this._adminPanelUserIds=c.admin_panel_user_ids||[],this._operatorWriteEnabled=c.operator_write_enabled??!1;let p=c.general?.default_warning_days;typeof p=="number"&&p>=0&&p<=365&&(this._defaultWarningDays=p),this._objectsTableColumns=Te(c.objects_table_columns)}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search),t=e.get("ms_action"),i=()=>{let m=window.location.pathname+window.location.hash;history.replaceState(history.state,"",m)};if(t==="add_object"){this._deepLinkHandled=!0,i(),requestAnimationFrame(()=>{this.shadowRoot?.querySelector("maintenance-object-dialog")?.openCreate()});return}if(t==="open_vacation"||t==="open_budget"||t==="open_groups"||t==="open_settings"){this._deepLinkHandled=!0,i(),this._overviewTab="settings",requestAnimationFrame(()=>{let m=this.shadowRoot?.querySelector("maintenance-settings-view"),_=t.replace("open_","");m?.scrollToSection?.(_)});return}let a=e.get("entry_id");if(!a)return;this._deepLinkHandled=!0;let l=e.get("task_id"),c=e.get("action"),p=window.location.pathname+window.location.hash;history.replaceState(history.state,"",p);let g=this._getObject(a);if(!g){this._showOverview();return}if(l){let m=g.tasks.find(_=>_.id===l);if(!m){this._showObject(a);return}this._showTask(a,l),c==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(a,l,m.name,this._features.checklists?m.checklist:void 0,this._features.adaptive&&!!m.adaptive_config?.enabled)}):c==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(a,l,m)})}else this._showObject(a)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let i=await this._statsService.getDetailStats(e,t),a=new Map(this._detailStatsData);a.set(e,i),this._detailStatsData=a}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=[];for(let i of this._objects)for(let a of i.tasks){let l=a.trigger_config?.entity_id;l&&e.push({entityId:l,isCounter:this._isCounterEntity(a.trigger_config)})}if(e.length===0)return;let t=await this._statsService.getBatchMiniStats(e);this._miniStatsData=new Map([...this._miniStatsData,...t])}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _taskRows(){let e=[];for(let _ of this._objects)for(let v of _.tasks){if(!this._showArchived&&v.archived||this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let x=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==x)continue}let f=[];for(let x of Object.values(this._groups))x.task_refs?.some(b=>b.entry_id===_.entry_id&&b.task_id===v.id)&&f.push(x.name);e.push({entry_id:_.entry_id,task_id:v.id,object_name:_.object.name,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_unit:v.interval_unit??null,interval_anchor:v.interval_anchor??null,is_done:v.is_done??!1,archived:v.archived??!1,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,area_id:_.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:f})}let t={overdue:0,triggered:1,due_soon:2,ok:3},i=(_,v)=>(t[_.status]??9)-(t[v.status]??9),a=(_,v)=>(_.days_until_due??99999)-(v.days_until_due??99999),l=(_,v)=>i(_,v)||a(_,v),c=_=>_.area_id&&this.hass?.areas?.[_.area_id]?.name||"",p=_=>_.responsible_user_id&&this._userService?.getUserName(_.responsible_user_id)||"",g=_=>_.group_names[0]||"",m={due_date:l,object:(_,v)=>_.object_name.localeCompare(v.object_name)||l(_,v),type:(_,v)=>_.type.localeCompare(v.type)||l(_,v),task_name:(_,v)=>_.task_name.localeCompare(v.task_name),area:(_,v)=>{let f=c(_),x=c(v);return!f&&x?1:f&&!x?-1:f.localeCompare(x)||l(_,v)},assigned_user:(_,v)=>{let f=p(_),x=p(v);return!f&&x?1:f&&!x?-1:f.localeCompare(x)||l(_,v)},group:(_,v)=>{let f=g(_),x=g(v);return!f&&x?1:f&&!x?-1:f.localeCompare(x)||l(_,v)}};return e.sort(m[this._sortMode]),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(a=>a.id===t)}_pushPanelState(e,t,i){let a={msp_view:e,msp_entry:t||null,msp_task:i||null};history.pushState(a,"")}_onPopState(e){let t=e.state;if(t?.msp_view&&(this._view=t.msp_view,this._selectedEntryId=t.msp_entry||null,this._selectedTaskId=t.msp_task||null,this._moreMenuOpen=!1,t.msp_view==="task"&&t.msp_entry&&t.msp_task)){this._historyFilter=null;let i=this._getTask(t.msp_entry,t.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop()}_filterByStatus(e){this._filterStatus=e,this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),this._scrollContentToTop()}_scrollContentToTop(){requestAnimationFrame(()=>{let e=this.shadowRoot?.querySelector(".content");e&&e.scrollTo({top:0,behavior:"smooth"})})}_showObject(e){this._pushPanelState("object",e),this._view="object",this._selectedEntryId=e,this._selectedTaskId=null,this._scrollContentToTop()}_showTask(e,t){this._pushPanelState("task",e,t),this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._activeTab="overview",this._historyFilter=null,this._scrollContentToTop();let i=this._getTask(e,t);if(i?.trigger_config?.entity_id){let a=i.trigger_config.entity_id,l=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(a,l)}}_showToast(e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}async _deleteObject(e){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:s("delete",this._lang),message:s("confirm_delete_object",this._lang),confirmText:s("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:e}),this._showOverview(),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}}async _deleteTask(e,t){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:s("delete",this._lang),message:s("confirm_delete_task",this._lang),confirmText:s("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/delete",entry_id:e,task_id:t}),this._showObject(e),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}}async _toggleArchiveTask(e,t,i){this._actionLoading=!0;try{await this.hass.connection.sendMessagePromise({type:i?"maintenance_supporter/task/unarchive":"maintenance_supporter/task/archive",entry_id:e,task_id:t}),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}finally{this._actionLoading=!1}}async _toggleArchiveObject(e,t){if(!(!t&&!await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:s("archive_object",this._lang),message:s("confirm_archive_object",this._lang),confirmText:s("archive_object",this._lang)})))try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:e}),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}}async _skipTask(e,t,i){this._actionLoading=!0;try{let a={type:"maintenance_supporter/task/skip",entry_id:e,task_id:t};i&&(a.reason=i),await this.hass.connection.sendMessagePromise(a),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}finally{this._actionLoading=!1}}async _resetTask(e,t,i){this._actionLoading=!0;try{let a={type:"maintenance_supporter/task/reset",entry_id:e,task_id:t};i&&(a.date=i),await this.hass.connection.sendMessagePromise(a),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}finally{this._actionLoading=!1}}async _applySuggestion(e,t,i){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/apply_suggestion",entry_id:e,task_id:t,interval:i}),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}}_openSeasonalOverrides(e){let t=this.shadowRoot.querySelector("maintenance-seasonal-overrides-dialog");if(!t||!this._selectedEntryId)return;let i=e.adaptive_config?.seasonal_overrides;t.open(this._selectedEntryId,e.id,i)}async _reanalyzeInterval(e,t){try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:e,task_id:t});i.recommended_interval?this._showToast(`${s("reanalyze_result",this._lang)}: ${i.recommended_interval} ${s("days",this._lang)} (${s(`confidence_${i.confidence}`,this._lang)}, ${i.data_points} ${s("data_points",this._lang)})`):this._showToast(s("reanalyze_insufficient_data",this._lang)),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}}async _promptSkipTask(e,t){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!i)return;let a=await i.prompt({title:s("skip",this._lang),message:s("skip_reason_prompt",this._lang),confirmText:s("skip",this._lang),inputLabel:s("reason_optional",this._lang),inputType:"text"});a.confirmed&&this._skipTask(e,t,a.value||void 0)}async _promptResetTask(e,t){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!i)return;let a=await i.prompt({title:s("reset",this._lang),message:s("reset_date_prompt",this._lang),confirmText:s("reset",this._lang),inputLabel:s("reset_date_optional",this._lang),inputType:"date"});a.confirmed&&this._resetTask(e,t,a.value||void 0)}_dismissSuggestion(e,t){e&&t&&this._dismissedSuggestions.add(`${e}_${t}`),this.requestUpdate()}async _handleQuickComplete(e,t,i){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/quick_complete",entry_id:e,task_id:t}),this._showToast(s("quick_complete_success",this._lang))}catch(a){(a?.code||"")==="no_defaults"?this._openCompleteDialog(e,t,i.name,this._features.checklists?i.checklist:void 0,this._features.adaptive&&!!i.adaptive_config?.enabled):this._showToast(s("action_error",this._lang))}}_openCompleteDialog(e,t,i,a,l){let c=this.shadowRoot.querySelector("maintenance-complete-dialog");c&&(c.entryId=e,c.taskId=t,c.taskName=i,c.lang=this._lang,c.checklist=a||[],c.adaptiveEnabled=!!l,c.open())}_openQrForObject(e,t){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForObject(e,t)}_openQrForTask(e,t,i,a){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForTask(e,t,i,a)}render(){return n`
    ...
    `}_renderGroupedTasks(e,t){let i=new Map,a=s("unassigned",t);for(let p of e){let g=[];this._groupByMode==="area"?g=[(p.area_id?this.hass?.areas?.[p.area_id]?.name:null)||a]:this._groupByMode==="user"?g=[(p.responsible_user_id?this._userService?.getUserName(p.responsible_user_id):null)||a]:this._groupByMode==="group"&&(g=p.group_names.length>0?p.group_names:[a]);for(let m of g)i.has(m)||i.set(m,[]),i.get(m).push(p)}let l=[...i.entries()].sort(([p],[g])=>p===a&&g!==a?1:g===a&&p!==a?-1:p.localeCompare(g)),c=this._groupByMode==="area"?"mdi:map-marker-outline":this._groupByMode==="group"?"mdi:folder-outline":"mdi:account-outline";return n`
      ${l.map(([p,g])=>n`
      ...
      `)}
    `}_warrantyLabel(e,t,i){return e.kind==="expired"?s("warranty_expired",i):e.kind==="expiring"?s("warranty_expires_in",i).replace("{days}",String(e.days??0)):s("warranty_valid_until",i).replace("{date}",J(t,i))}_renderWarrantyMeta(e,t){let i=_t(e);return n`<p class="meta">${s("warranty",t)}:
      <span class="warranty-chip warranty-${i.kind}">${this._warrantyLabel(i,e,t)}</span></p>`}_renderAllObjects(){let e=this._lang,t=this._isOperator,i=this._objectViewMode==="table"&&!this.narrow,a=this._objects.filter(m=>m.object.archived).length,l=m=>{let _=1/0;for(let v of m.tasks){let f=v.days_until_due;f!=null&&f<_&&(_=f)}return _},c=this._objects.filter(m=>this._showArchived||!m.object.archived);this._objectSortMode==="alphabetical"?c.sort((m,_)=>m.object.name.localeCompare(_.object.name)):this._objectSortMode==="task_count"?c.sort((m,_)=>_.tasks.length-m.tasks.length||m.object.name.localeCompare(_.object.name)):c.sort((m,_)=>l(m)-l(_)||m.object.name.localeCompare(_.object.name));let p=()=>{let m=new Map;for(let _ of c){let v=_.object.area_id,f=v?this.hass?.areas?.[v]?.name||s("unassigned",e):s("no_area",e);m.has(f)||m.set(f,[]),m.get(f).push(_)}return new Map([...m.entries()].sort(([_],[v])=>_.localeCompare(v)))},g=m=>{let _=m.tasks.some(v=>v.status==="overdue"||v.status==="triggered");return n`
    ...
    `}_renderOverviewRow(e){let t=this._lang,i=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,a=0,l=qe.ok,c=!1;if(i&&e.days_until_due!==null){let _=ht(e.interval_days,e.days_until_due,e.interval_unit);a=_.pct,c=_.overflow,e.status==="overdue"?l=qe.overdue:e.status==="due_soon"&&(l=qe.due_soon)}let p=e.area_id?this.hass?.areas?.[e.area_id]?.name:null,g=e.responsible_user_id?this._userService?.getUserName(e.responsible_user_id):null,m=e.group_names.length>0||p||g;return n`
    ...
    `}_openCompleteDialogForRow(e){let i=this._objects.find(a=>a.entry_id===e.entry_id)?.tasks.find(a=>a.id===e.task_id);this._openCompleteDialog(e.entry_id,e.task_id,e.task_name,this._features.checklists?i?.checklist:void 0,this._features.adaptive&&!!i?.adaptive_config?.enabled)}_renderTriggerProgress(e){let t=e.trigger_config??null;if(!t)return d;let i=t.type||"threshold",a=e.trigger_entity_info?.unit_of_measurement??"",l=0,c="";if(i==="threshold"){let m=e.trigger_current_value??null;if(m==null)return d;let _=t.trigger_above,v=t.trigger_below;if(_!=null){let f=v??0,x=_-f||1;l=Math.min(100,Math.max(0,(m-f)/x*100)),c=`${m.toFixed(1)} / ${_} ${a}`}else if(v!=null){let x=e.trigger_entity_info?.max??(v*2||100),b=x-v||1;l=Math.min(100,Math.max(0,(x-m)/b*100)),c=`${m.toFixed(1)} / ${v} ${a}`}else return d}else if(i==="counter"){let m=t.trigger_target_value||1,v=e.trigger_current_delta??null??e.trigger_current_value??null;if(v==null)return d;l=Math.min(100,Math.max(0,v/m*100)),c=`${v.toFixed(1)} / ${m} ${a}`}else if(i==="state_change"){let m=t.trigger_target_changes||1,_=e.trigger_current_value??null;if(_==null)return d;l=Math.min(100,Math.max(0,_/m*100)),c=`${Math.round(_)} / ${m}`}else if(i==="runtime"){let m=t.trigger_runtime_hours||100,_=e.trigger_current_value??null;if(_==null)return d;l=Math.min(100,Math.max(0,_/m*100)),c=`${_.toFixed(1)}h / ${m}h`}else if(i==="compound"){let m=t.compound_logic||t.operator||"AND",_=t.conditions?.length||0;c=`${m} (${_})`,l=e.trigger_active?100:0}else return d;let p=l>=100,g=l>90?"var(--error-color, #f44336)":l>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return n`
    ...
    `}_renderMiniSparkline(e){if(!e.trigger_config?.entity_id)return d;let t=e.trigger_config.entity_id,i=this._miniStatsData.get(t)||[],a=[];if(i.length>=2)a=i.map(k=>({ts:k.ts,val:k.val}));else{if(!e.history)return d;for(let k of e.history)k.trigger_value!=null&&a.push({ts:new Date(k.timestamp).getTime(),val:k.trigger_value})}if(e.trigger_current_value!=null&&a.push({ts:Date.now(),val:e.trigger_current_value}),a.length<2)return d;a.sort((k,R)=>k.ts-R.ts);let l=bs,c=ys,p=a.map(k=>k.val),g=Math.min(...p),m=Math.max(...p),_=m-g||1;g-=_*.1,m+=_*.1;let v=a[0].ts,x=a[a.length-1].ts-v||1,b=k=>(k-v)/x*l,L=k=>2+(1-(k-g)/(m-g))*(c-4),I=a;if(I.length>ci){let k=Math.ceil(I.length/ci);I=I.filter((R,F)=>F%k===0||F===I.length-1)}let S=I.map(k=>`${b(k.ts).toFixed(1)},${L(k.val).toFixed(1)}`).join(" ");return n`
    ...
    `}_renderDaysProgress(e){let t=this._lang;if(e.days_until_due==null||!e.interval_days||e.interval_days<=0)return d;let{pct:i,overflow:a}=ht(e.interval_days,e.days_until_due,e.interval_unit),l="var(--success-color, #4caf50)";return e.status==="overdue"?l="var(--error-color, #f44336)":e.status==="due_soon"&&(l="var(--warning-color, #ff9800)"),n`
    ...
    `}_renderObjectDetail(){if(!this._selectedEntryId)return d;let e=this._getObject(this._selectedEntryId);if(!e)return n`<p>Object not found.</p>`;let t=e.object,i=this._lang,a=this._isOperator,l=e.tasks.filter(p=>p.archived).length,c=e.tasks.filter(p=>this._showArchived||!p.archived);return n`
      <div class="detail-section">
        ...
        ${e.tasks.length===0?n`<div class="empty-state-centered">
            ...
            </div>`:n`<div class="task-table">${[...c].sort((p,g)=>{let m={overdue:0,triggered:1,due_soon:2,ok:3};return(m[p.status]??9)-(m[g.status]??9)||(p.days_until_due??99999)-(g.days_until_due??99999)}).map(p=>n`
              <div class="task-row${p.enabled?"":" task-disabled"}">
                ...
                <span class="due-cell" @click=${()=>this._showTask(e.entry_id,p.id)}>
                  <span class="due-text">${De(p.days_until_due,i)}</span>
    ...
    `}_renderTabContent(e){switch(this._activeTab){case"overview":return this._renderOverviewTab(e);case"history":return this._renderHistoryTab(e);default:return d}}get _sparklineCtx(){return{lang:this._lang,detailStatsData:this._detailStatsData,hasStatsService:!!this._statsService,isCounterEntity:e=>this._isCounterEntity(e),tooltip:this._sparklineTooltip,setTooltip:e=>{this._sparklineTooltip=e}}}_renderOverviewTab(e){let t=this._lang,i=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,a=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1,l=i||a,c=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,p=this._features.seasonal&&(e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12);return n`
      <div class="tab-content overview-tab">
        ...
        ${ti(e,this._sparklineCtx)}
        ${ii(e,t,this._features)}
        <div class="two-column-layout ${l?"":"single-column"}">
          ${l?n`
            <div class="left-column">
              ${this._renderRecommendationCard(e)}
              ${ni(e,t,this._features)}
            </div>
          `:d}
          <div class="right-column">
            ${li(e,t,this._costDurationToggle,g=>{this._costDurationToggle=g})}
          </div>
        </div>
        ${c?si(e,t):d}
        ${p?n`
    ...
    `}_renderKPIBar(e){let t=this._lang,i=e.times_performed>0?e.total_cost/e.times_performed:0,a=e.days_until_due!==null&&e.days_until_due!==void 0?e.days_until_due<0?"overdue":e.days_until_due<=e.warning_days?"warning":"":"";return n`
      <div class="kpi-bar">
        ...
        <div class="kpi-card">
          ...
          <div class="kpi-value">${Ft(e,t)}</div>
    ...
    `}_renderRecommendationCard(e){let t=this._lang;if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return d;if(this._selectedEntryId&&this._selectedTaskId&&this._dismissedSuggestions.has(`${this._selectedEntryId}_${this._selectedTaskId}`))return d;let i=e.suggested_interval;return n`
      <div class="recommendation-card">
        ...
        ${ai(e.interval_days,i,e.interval_confidence||"medium",t)}
      ...
      <div class="recent-activities">
        ...
        ${i.map(l=>n`
          <div class="activity-item">
            ...
            <span class="activity-date">${pt(l.timestamp,t)}</span>
    ...
    `}_renderHistoryEntry(e){let t=this._lang,i=["completed","reset","skipped"].includes(e.type);return n`
      <div class="history-entry">
        ...
        <div class="history-content">
          ...
          <div class="history-date">${pt(e.timestamp,t)}</div>
    ...
    `}_openHistoryEdit(e){if(!this._selectedEntryId||!this._selectedTaskId)return;let t={entry_id:this._selectedEntryId,task_id:this._selectedTaskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null};this.shadowRoot?.querySelector("maintenance-history-edit-dialog")?.openEdit(t)}};T.styles=[Fe,Nt],u([w({attribute:!1})],T.prototype,"hass",2),u([w({type:Boolean,reflect:!0})],T.prototype,"narrow",2),u([w({attribute:!1})],T.prototype,"panel",2),u([h()],T.prototype,"_objects",2),u([h()],T.prototype,"_stats",2),u([h()],T.prototype,"_view",2),u([h()],T.prototype,"_selectedEntryId",2),u([h()],T.prototype,"_selectedTaskId",2),u([h()],T.prototype,"_filterStatus",2),u([h()],T.prototype,"_filterUser",2),u([h()],T.prototype,"_unsub",2),u([h()],T.prototype,"_sparklineTooltip",2),u([h()],T.prototype,"_historyFilter",2),u([h()],T.prototype,"_budget",2),u([h()],T.prototype,"_groups",2),u([h()],T.prototype,"_detailStatsData",2),u([h()],T.prototype,"_miniStatsData",2),u([h()],T.prototype,"_features",2),u([h()],T.prototype,"_adminPanelUserIds",2),u([h()],T.prototype,"_operatorWriteEnabled",2),u([h()],T.prototype,"_defaultWarningDays",2),u([h()],T.prototype,"_actionLoading",2),u([h()],T.prototype,"_moreMenuOpen",2),u([h()],T.prototype,"_toastMessage",2),u([h()],T.prototype,"_overviewTab",2),u([h()],T.prototype,"_activeTab",2),u([h()],T.prototype,"_costDurationToggle",2),u([h()],T.prototype,"_historySearch",2),u([h()],T.prototype,"_sortMode",2),u([h()],T.prototype,"_objectSortMode",2),u([h()],T.prototype,"_groupByMode",2),u([h()],T.prototype,"_objectViewMode",2),u([h()],T.prototype,"_objectsTableColumns",2),u([h()],T.prototype,"_showArchived",2),T=u([Ht("maintenance-supporter-panel")],T);export{T as MaintenanceSupporterPanel};
