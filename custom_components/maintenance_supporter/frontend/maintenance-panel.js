...
import{a as le,b as Lt,c as mt,d as It,e as Yt,f as ce,g as de,h as pe}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-FU3XFEHD.js";import{a as V,b as Pt,c as ge,d as _e,e as me,f as ve,g as be,h as fe,i as ye,j as xe,o as $e,r as we}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-CFHAXUOF.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-QX3FTKCJ.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-PZVKPJX6.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-NOHIK75N.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-A3UPO26O.js";import{b as Gt,c as he}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-VIX7PNOY.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-VWJA3YLV.js";import{a as Wt}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-IMKP65C5.js";import{a as ue}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-BBM5E3UT.js";import{a as S}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-X3LG2NIG.js";import{A as jt,B as ne,C as zt,a as u,b as C,c as r,d as P,f as d,g as D,h as qt,i as ae,j as re,k,l as _,m as Ct,n as Dt,o as Ot,p as s,q as Rt,r as L,s as oe,t as K,u as Q,v as At,w as _t,z as kt}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-FS5TZIDQ.js";var Ue=["assignee_pool","required_completion_fields","checklist","labels","history"],Ve=["checklist_progress"],qe=["tasks","parts"],We=["manual_docs","battery_fleet_excluded"];function Kt(o,l,t=[]){for(let e of l)o[e]===void 0&&(o[e]=[]);for(let e of t)o[e]===void 0&&(o[e]={})}function Ye(o){let l=o;Kt(l,qe),l.object&&typeof l.object=="object"&&Kt(l.object,We);for(let t of l.tasks)Kt(t,Ue,Ve);return o}function Tt(o){for(let l of o)Ye(l);return o}function Ge(o,l){if(l.objects)return l.objects;let t=l.delta||[],e=l.removed||[];if(!t.length&&!e.length)return null;let i=new Map(o.map(a=>[a.entry_id,a]));for(let a of t)i.set(a.entry_id,a);for(let a of e)i.delete(a);return[...i.values()]}function ke(o,l){return l.objects&&Tt(l.objects),l.delta&&Tt(l.delta),Ge(o,l)}var R={overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view",objectsCache:"msp-objects-cache",gettingStartedDismissed:"msp-gs-dismissed",batteryRosterSort:"ms_bf_roster_sort"};function Z(o){try{return localStorage.getItem(o)}catch{return null}}function N(o,l){try{localStorage.setItem(o,l)}catch{}}var Ke=168*3600*1e3;function je(){try{let o=Z(R.objectsCache);if(!o)return null;let l=JSON.parse(o);return l.v!==qt||!Number.isFinite(l.at)||Date.now()-l.at>Ke||!Array.isArray(l.objects)||l.objects.length===0?null:{objects:l.objects,stats:l.stats??null}}catch{return null}}function Qt(o,l){if(!(!Array.isArray(o)||o.length===0))try{let t={v:qt,at:Date.now(),objects:o,stats:l};N(R.objectsCache,JSON.stringify(t))}catch{}}function O(o){return String(o??"").replace(/[&<>"']/g,l=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[l])}function Te(o,l,t,e,i,a){let n=[[t.manufacturer,o.manufacturer],[t.model,o.model],[t.serial,o.serial_number],[t.installed,o.installation_date?e(o.installation_date):null],[t.warranty,o.warranty_expiry?e(o.warranty_expiry):null]].filter(([,p])=>!!p),h=l.map(p=>{let g=t.scheduleLabel(p);return`<tr>
      <td>${O(p.name)}</td>
...
${O(o.notes)}</div>`:""}
</body></html>`}function Zt(o,l=new Date){if(!o)return{kind:"none",days:null,date:null};let t=new Date(`${o}T00:00:00`);if(isNaN(t.getTime()))return{kind:"none",days:null,date:null};let e=Date.UTC(l.getFullYear(),l.getMonth(),l.getDate()),i=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),a=Math.round((i-e)/864e5);return a<0?{kind:"expired",days:a,date:o}:a<=60?{kind:"expiring",days:a,date:o}:{kind:"valid",days:a,date:o}}var z=o=>String(o??"").replace(/[&<>"']/g,l=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[l]);function Se(o,l,t,e,i,a,n,h,c,p=[]){let g=[[t.object,z(l)],[t.type,z(t.typeLabel(o.type))],[t.interval,z(i(o))],[t.nextDue,o.next_due?z(e(o.next_due)):"\u2014"],[t.lastDone,o.last_performed?z(e(o.last_performed)):z(t.never)]];o.priority&&o.priority!=="normal"&&g.push([t.priority,z(o.priority)]);let m=(o.checklist||[]).map(x=>`<li><span class="box"></span>${z(x)}</li>`).join(""),v=(x,w)=>x?`<figure class="qr"><img src="${x}" alt="" /><figcaption>${z(w)}</figcaption></figure>`:"";return`<!DOCTYPE html>
<html><head><meta charset="utf-8"><meta name="color-scheme" content="light">
<title>${z(o.name)} \u2014 ${z(t.title)}</title>
<style>
...
<body>
  ...
  <table class="meta">
    ${g.map(([x,w])=>`<tr><td>${z(x)}</td><td>${w}</td></tr>`).join("")}
  </table>
  ${m?`<h2>${z(t.checklist)}</h2><ul class="check">${m}</ul>`:""}
  ${p.length?`<h2>${z(t.parts)}</h2><ul class="check">${p.map(x=>`<li><span class="box"></span>${z(x)}</li>`).join("")}</ul>`:""}
  ${o.notes?`<h2>${z(t.notes)}</h2><div class="notes">${z(o.notes)}</div>`:""}
  ${h?`<h2>${z(t.manualExcerpt)}</h2>
    ...
    <\/script>`:""}`:""}
  <footer>${z(l)} \xB7 ${z(o.name)} \xB7 ${z(t.printedOn)} ${z(c.slice(0,10))}</footer>
</body></html>`}var Ee=C`
  :host {
    display: block;
    height: 100%;
...
`;var Ft=class{constructor(l){this._cache=new Map;this._pending=new Map;this._hass=l}updateHass(l){this._hass=l}async getDetailStats(l,t,e=30){return this._getStats(l,e<=35?"hour":"day",e,t)}async getMiniStats(l,t){return this._getStats(l,"day",14,t)}async getBatchMiniStats(l){let t=new Map,e=[];for(let c of l){let p=`${c.entityId}:day:14`,g=this._cache.get(p);g&&Date.now()-g.fetchedAt<3e5?t.set(c.entityId,g.points):e.push(c)}if(e.length===0)return t;let i=e.filter(c=>c.isCounter).map(c=>c.entityId),a=e.filter(c=>!c.isCounter).map(c=>c.entityId),n=new Date(Date.now()-336*60*60*1e3).toISOString(),h=[];return i.length>0&&h.push(this._fetchBatch(i,"day",n,["state","sum","change"],!0,t)),a.length>0&&h.push(this._fetchBatch(a,"day",n,["mean","min","max"],!1,t)),await Promise.all(h),t}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(l,t,e,i){let a=`${l}:${t}:${e}`,n=this._cache.get(a);if(n&&Date.now()-n.fetchedAt<3e5)return n.points;if(this._pending.has(a))return this._pending.get(a);let h=this._fetchAndNormalize(l,t,e,i,a);this._pending.set(a,h);try{return await h}finally{this._pending.delete(a)}}async _fetchAndNormalize(l,t,e,i,a){let n=new Date(Date.now()-e*24*60*60*1e3).toISOString(),h=i?["state","sum","change"]:["mean","min","max"];try{let p=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:n,statistic_ids:[l],period:t,types:h}))[l]||[],g=this._normalizeRows(p,i);return this._cache.set(a,{entityId:l,fetchedAt:Date.now(),period:t,points:g}),g}catch(c){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${l}:`,c),[]}}async _fetchBatch(l,t,e,i,a,n){try{let h=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:e,statistic_ids:l,period:t,types:i});for(let c of l){let p=h[c]||[],g=this._normalizeRows(p,a);n.set(c,g),this._cache.set(`${c}:${t}:14`,{entityId:c,fetchedAt:Date.now(),period:t,points:g})}}catch(h){console.warn("[maintenance-supporter] Batch statistics fetch failed:",h)}}_normalizeRows(l,t){let e=[];for(let i of l){let a=null;if(t?a=i.state??null:a=i.mean??null,a===null)continue;let n={ts:i.start,val:a};t||(i.min!=null&&(n.min=i.min),i.max!=null&&(n.max=i.max)),e.push(n)}return e.sort((i,a)=>i.ts-a.ts),e}};function lt(o){let l=o??0;return l<1024?`${l} B`:l<1024*1024?`${(l/1024).toFixed(1)} KB`:`${(l/(1024*1024)).toFixed(1)} MB`}var ft=["manual","warranty","invoice","spare_parts","photo","other"],Ht={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"};function vt(o){return o.title||o.filename||o.url||""}var I=class extends D{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._hint="";this._addingLink=!1;this._linkUrl="";this._linkTitle="";this._category="manual";this._thumbs={};this._lightboxUrl="";this._editingId="";this._editTitle="";this._editCategory="manual";this._dragOver=!1;this._loadedFor=null;this._localeReady=!1}_isImage(t){return t.kind==="file"&&(t.mime||"").startsWith("image/")}async _sign(t){return Lt(this.hass,t.id)}get _lang(){return L(this.hass)}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,K(this._lang).then(()=>this.requestUpdate())),this.hass&&this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error="",this._thumbs={},this._loadThumbs()}catch(t){this._error=S(t,this._lang),this._loaded=!0}}async _loadThumbs(){await Promise.all(this._docs.filter(t=>this._isImage(t)).map(async t=>{try{let e=await this._sign(t);this._thumbs={...this._thumbs,[t.id]:e}}catch{}}))}_category_of(t){return(t.tags||[]).find(i=>ft.includes(i))||"other"}_labelKeydown(t){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),t.currentTarget.querySelector("input")?.click())}_onFileInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i),e.value=""}_onCameraInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i,"photo"),e.value=""}_onDrop(t){if(t.preventDefault(),this._dragOver=!1,!this.canWrite||this._busy)return;let e=Array.from(t.dataTransfer?.files??[]);e.length&&this._uploadFiles(e)}_onDragOver(t){this.canWrite&&(t.preventDefault(),this._dragOver=!0)}_onDragLeave(t){let e=t.relatedTarget;(!e||!t.currentTarget.contains(e))&&(this._dragOver=!1)}async _uploadFiles(t,e){let i=e??this._category;this._busy=!0,this._error="",this._hint="";let a=0,n=0;try{for(let h of t){let c=new FormData;c.append("entry_id",this.entryId),c.append("tags",i),c.append("file",h,h.name);let p=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:c});if(!p.ok){this._error=p.status===413?s("doc_too_large",this._lang):s("doc_upload_failed",this._lang);continue}let g=await p.json();g.duplicate_in_object?n++:g.deduped&&a++}n?this._hint=s("doc_dup_in_object",this._lang):a&&(this._hint=s("doc_deduped",this._lang)),await this._load()}catch{this._error=s("doc_upload_failed",this._lang)}finally{this._busy=!1}}async _download(t){try{await It(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=S(e,this._lang)}}async _preview(t){if(this._isImage(t)){this._lightboxUrl=this._thumbs[t.id]||await this._sign(t);return}try{await mt(this.hass,t.id)}catch(e){this._error=S(e,this._lang)}}_openDoc(t){t.kind==="file"?this._preview(t):V(t.url)&&window.open(t.url,"_blank","noopener")}_startEdit(t){this._editingId=t.id,this._editTitle=t.title||"",this._editCategory=this._category_of(t),this._addingLink=!1,this._error=""}_cancelEdit(){this._editingId=""}async _saveEdit(t){let e=(t.tags||[]).filter(a=>!ft.includes(a)),i=t.kind==="file"?[this._editCategory,...e]:t.tags??[];this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,title:this._editTitle.trim()||t.filename||t.url||"",tags:i}),this._editingId="",await this._load()}catch(a){this._error=S(a,this._lang)}finally{this._busy=!1}}async _delete(t){let e=vt(t);if(window.confirm(s("doc_delete_confirm",this._lang).replace("{name}",e))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:t.id}),await this._load()}catch(i){this._error=S(i,this._lang)}finally{this._busy=!1}}}async _addLink(){let t=this._linkUrl.trim();if(t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/add_link",entry_id:this.entryId,url:t,title:this._linkTitle.trim()||null}),this._linkUrl="",this._linkTitle="",this._addingLink=!1,await this._load()}catch(e){this._error=S(e,this._lang,s("doc_link_invalid",this._lang))}finally{this._busy=!1}}}render(){let t=this._lang;return r`
  ...
  `,u([k({attribute:!1})],I.prototype,"hass",2),u([k({attribute:!1})],I.prototype,"entryId",2),u([k({type:Boolean})],I.prototype,"canWrite",2),u([_()],I.prototype,"_docs",2),u([_()],I.prototype,"_loaded",2),u([_()],I.prototype,"_busy",2),u([_()],I.prototype,"_error",2),u([_()],I.prototype,"_hint",2),u([_()],I.prototype,"_addingLink",2),u([_()],I.prototype,"_linkUrl",2),u([_()],I.prototype,"_linkTitle",2),u([_()],I.prototype,"_category",2),u([_()],I.prototype,"_thumbs",2),u([_()],I.prototype,"_lightboxUrl",2),u([_()],I.prototype,"_editingId",2),u([_()],I.prototype,"_editTitle",2),u([_()],I.prototype,"_editCategory",2),u([_()],I.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",I);var J=class extends D{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._loadedKey="";this._localeReady=!1}get _lang(){return L(this.hass)}get _refId(){return this.partId||this.taskId||""}get _linkField(){return this.partId?"part_ids":"task_ids"}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,K(this._lang).then(()=>this.requestUpdate()));let e=`${this.entryId}|${this._refId}`;this.hass&&this.entryId&&this._refId&&this._loadedKey!==e&&(this._loadedKey=e,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error=""}catch(t){this._error=S(t,this._lang),this._loaded=!0}}_links(t){return t[this._linkField]||[]}_linked(){return this._docs.filter(t=>this._links(t).includes(this._refId))}_available(){return this._docs.filter(t=>!this._links(t).includes(this._refId))}async _setLinks(t,e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,[this._linkField]:e}),await this._load()}catch(i){this._error=S(i,this._lang)}finally{this._busy=!1}}_link(){let t=this._docs.find(e=>e.id===this._attachId);t&&(this._attachId="",this._setLinks(t,[...this._links(t),this._refId]))}_unlink(t){this._setLinks(t,this._links(t).filter(e=>e!==this._refId))}_isPdf(t){return t.mime==="application/pdf"||(t.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(t){return this._isPdf(t)&&this.taskId?t.task_pages?.[this.taskId]:void 0}async _open(t){if(t.kind==="weblink"){V(t.url)&&window.open(t.url,"_blank","noopener");return}let e=this._pageFor(t);try{await mt(this.hass,t.id,e?`#page=${e}`:"")}catch(i){this._error=S(i,this._lang)}}async _setPage(t,e){if(this.taskId){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,task_pages:{[this.taskId]:e}}),await this._load()}catch(i){this._error=S(i,this._lang)}finally{this._busy=!1}}}async _download(t){try{await It(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=S(e,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return d;let t=this._lang,e=this._linked(),i=this._available();return r`
      <div class="task-docs">
        ...
        ${this.canWrite&&i.length?r`<div class="tdoc-attach">
              ...
              >
                ...
                ${i.map(a=>r`<option value=${a.id} ?selected=${a.id===this._attachId}>${vt(a)}</option>`)}
              </select>
    ...
    `}_renderRow(t,e){let i=t.kind==="file",a=this._isPdf(t),n=this._pageFor(t),h=(t.tags||[]).find(p=>ft.includes(p))||"other",c=i?lt(t.size):s("doc_link_badge",e);return r`
      <div class="tdoc-row">
        <ha-icon class="tdoc-icon" icon=${i?Ht[h]:"mdi:link-variant"}></ha-icon>
        <div
          class="tdoc-info"
          role="button"
          tabindex="0"
  ...
  `,u([k({attribute:!1})],X.prototype,"hass",2),u([k({type:Boolean})],X.prototype,"flat",2),u([_()],X.prototype,"_ov",2),u([_()],X.prototype,"_loading",2),u([_()],X.prototype,"_marking",2),u([_()],X.prototype,"_error",2),u([_()],X.prototype,"_history",2),u([_()],X.prototype,"_rosterSort",2),u([_()],X.prototype,"_typeFilter",2),u([_()],X.prototype,"_recorded",2);var Jt=X;customElements.get("maintenance-battery-fleet-section")||customElements.define("maintenance-battery-fleet-section",Jt);var Me=C`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;function Ce(o){let l=window;l.customCards=l.customCards||[],l.customCards.some(t=>t.type===o.type)||l.customCards.push(o)}var et=class extends D{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(t){if(this._config={...t},t.past_days&&[30,90].includes(t.past_days)?this._pastDays=t.past_days:t.window_days&&[7,14,30,365].includes(t.window_days)&&(this._windowDays=t.window_days,this._pastDays=0),typeof t.user_filter=="string"&&(this._userFilter=t.user_filter),typeof t.object_filter=="string")this._objectFilter=t.object_filter,this._configuredObjects=[];else if(Array.isArray(t.object_filter)){let e=t.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=e.length===1?e[0]:"",this._configuredObjects=e.length>1?e:[]}}getCardSize(){return 6}get _lang(){return L(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(t){if(super.updated(t),Rt(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=e}catch{}}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){t();return}this._unsub=t}catch{}}_onEventClick(t){if(t.history_timestamp){this._openHistoryEntry(t);return}we(t.entry_id,t.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:t.entry_id,task_id:t.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(t){try{let i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:t.entry_id})).tasks?.find(n=>n.id===t.task_id)?.history?.find(n=>n.timestamp===t.history_timestamp);if(!i||$e({entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp,type:i.type||"completed",timestamp:i.timestamp||t.history_timestamp,notes:i.notes??null,cost:i.cost??null,duration:i.duration??null,completed_by:i.completed_by??null,used_parts:i.used_parts??null}))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return d;let t=this._lang,e=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,n=null;this._userFilter&&(n=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let h=b=>{let G=b.toLowerCase();return this._objects.find(tt=>tt.entry_id===b||tt.object.name.toLowerCase()===G)?.entry_id??null},c=new Set(this._configuredObjects.map(h).filter(b=>b!==null)),p=c.size?this._objects.filter(b=>c.has(b.entry_id)):this._objects,g=this._config.show_object_filter!==!1&&p.length>1,m=this._objectFilter?h(this._objectFilter):null,v=m&&p.some(b=>b.entry_id===m)?p.filter(b=>b.entry_id===m):p,x=new Date;x.setHours(0,0,0,0);let w=this._pastDays>0,j=w?me(v,x,this._pastDays,n):_e(v,x,this._windowDays,n),E=ge(x),A=this._windowDays===365||w,W=A?j.filter(b=>b.events.length>0):j,F=b=>{let G=`cal-status-${b.status}`,Y=b.projected?"cal-event-projected":"",tt=b.status==="overdue"&&b.days_until_due!=null?` (${_t(b.days_until_due,t)})`:"",U=b.projected&&b.interval_days?r`<span class="cal-event-recur">${b.interval_unit&&b.interval_unit!=="days"?`${b.interval_days} ${s("unit_"+b.interval_unit,t)}`:s("cal_every_n_days",t).replace("{n}",String(b.interval_days))}</span>`:d,rt=b.schedule_type==="sensor_based",pt=rt?r`<ha-icon class="cal-event-icon cal-source-sensor"
                ...
                icon="${b.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,gt=rt&&b.prediction_confidence&&b.status!=="triggered"&&!b.projected?r`<span class="cal-event-prediction cal-conf-${b.prediction_confidence}">
            ${s("cal_predicted",t)} · ${s(`cal_confidence_${b.prediction_confidence}`,t)}
          </span>`:d,B=this._stats?.budget?.currency_symbol||Ot,$=b.history_type?s(b.history_type,t):s(b.status,t);return r`
        <div class="cal-event ${Y}"
          @click=${()=>this._onEventClick(b)}>
          ${pt}
          <span class="cal-status-pill ${G}">${$}</span>
          <div class="cal-event-body">
            <div class="cal-event-title">${b.object_name} · ${b.task_name}${tt}</div>
            ${gt}
            ${U}
          </div>
          ${b.avg_cost!=null&&b.avg_cost>0?r`<span class="cal-event-cost">${b.avg_cost.toFixed(0)} ${B}</span>`:d}
        </div>
      `},T=b=>{let[G,Y,tt]=b.date.split("-").map(Number),U=new Date(G,Y-1,tt),rt=b.date===E,pt=U.toLocaleDateString(t,{weekday:"short"}),gt=U.toLocaleDateString(t,{month:"long"});return r`
        <div class="cal-day-row">
          <div class="cal-day-pill ${rt?"cal-today":""}">
            <span class="cal-pill-weekday">${pt}</span>
            <span class="cal-pill-day">${U.getDate()}</span>
          </div>
          <div class="cal-day-content">
            <div class="cal-day-header">
              <span class="cal-day-month">${gt}</span>
              ${rt?r`<span class="cal-day-today-badge">${s("today",t)}</span>`:d}
            </div>
            ${b.events.length===0?r`<div class="cal-empty">${s("cal_no_events",t)}</div>`:b.events.map(F)}
          </div>
        </div>
      `};return r`
      <ha-card .header=${a}>
              ...
              <div class="cal-controls">
                ...
                ${g?r`
                      <select class="cal-user-filter"
                        ...
                        ${[...p].sort((b,G)=>b.object.name.localeCompare(G.object.name)).map(b=>r`<option value=${b.entry_id} ?selected=${b.entry_id===m}>${b.object.name}</option>`)}
                      </select>
                    `:d}
              </div>
            `:d}
        <div class="cal-rolling">
          ${W.length===0&&A?r`<div class="cal-empty">${s("cal_no_events",t)}</div>`:W.map(T)}
        </div>
      </ha-card>
    `}};et.styles=[zt,Me,C`
      :host { display: block; }
      ha-card { padding: 0; overflow: hidden; }
    `],u([k({attribute:!1})],et.prototype,"hass",2),u([_()],et.prototype,"_config",2),u([_()],et.prototype,"_objects",2),u([_()],et.prototype,"_stats",2),u([_()],et.prototype,"_windowDays",2),u([_()],et.prototype,"_pastDays",2),u([_()],et.prototype,"_userFilter",2),u([_()],et.prototype,"_objectFilter",2),u([_()],et.prototype,"_unsub",2);var Ze=[{value:7,key:"cal_editor_window_week"},{value:14,key:"cal_editor_window_fortnight"},{value:30,key:"cal_editor_window_month"},{value:365,key:"cal_editor_window_year"}],xt=class extends D{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}get _lang(){return L(this.hass)}setConfig(t){this._config={...t}}updated(){let t=this._lang;t&&!oe(t)&&K(t).then(()=>this.requestUpdate())}_valueChanged(t,e){let i={...this._config,[t]:e};t==="show_window_chips"&&e===!0&&delete i.show_window_chips,t==="show_user_filter"&&e===!0&&delete i.show_user_filter,t==="show_object_filter"&&e===!0&&delete i.show_object_filter,t==="title"&&(!e||typeof e=="string"&&e.trim()==="")&&delete i.title,t==="user_filter"&&e===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let t=this._lang,e=this._config.window_days??30,i=this._config.show_window_chips!==!1,a=this._config.show_user_filter!==!1,n=this._config.user_filter??"",h=this._config.title??"";return r`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${Ze.map(c=>r`<option value="${c.value}" ?selected=${c.value===e}>${s(c.key,t)}</option>`)}
          </select>
        </div>
  ...
  `,u([k({attribute:!1})],at.prototype,"hass",2),u([k({attribute:!1})],at.prototype,"objects",2),u([_()],at.prototype,"_open",2),u([_()],at.prototype,"_loading",2),u([_()],at.prototype,"_error",2),u([_()],at.prototype,"_groupId",2),u([_()],at.prototype,"_name",2),u([_()],at.prototype,"_description",2),u([_()],at.prototype,"_selected",2);customElements.get("maintenance-group-dialog")||customElements.define("maintenance-group-dialog",at);var ct=class extends D{constructor(){super(...arguments);this._open=!1;this._busy=!1;this._error="";this._name="";this._views=[];this._filters=null;this._localeReady=!1;this._save=async()=>{let t=this._name.trim();if(!(!t||this._busy||!this._filters)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/save",name:t,filters:this._filters});this._name="",this._emitChanged(e.views||[])}catch(e){this._error=S(e,this._lang)}finally{this._busy=!1}}};this._delete=async t=>{if(!this._busy){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/delete",view_id:t});this._emitChanged(e.views||[])}catch(e){this._error=S(e,this._lang)}finally{this._busy=!1}}}}get _lang(){return L(this.hass)}updated(t){t.has("hass")&&this.hass&&!this._localeReady&&(this._localeReady=!0,K(this._lang).then(()=>this.requestUpdate()))}async open(t,e){this._open=!0,this._error="",this._name="",this._filters=t,this._views=e}_close(){this._open=!1}_emitChanged(t){this._views=t,this.dispatchEvent(new CustomEvent("saved-views-changed",{bubbles:!0,composed:!0,detail:{views:t}}))}render(){if(!this._open)return r``;let t=this._lang;return r`
  ...
  `}function te(o,l,t){if(!o.trigger_config?.entity_id)return d;let e=o.trigger_config.entity_id,i=l.get(e)||[],a=[];if(i.length>=2)a=i.map(T=>({ts:T.ts,val:T.val}));else{if(!o.history)return d;for(let T of o.history)T.trigger_value!=null&&a.push({ts:new Date(T.timestamp).getTime(),val:T.trigger_value})}if(o.trigger_current_value!=null&&a.push({ts:Date.now(),val:o.trigger_current_value}),a.length<2)return d;a.sort((T,b)=>T.ts-b.ts);let n=Xe,h=ti,c=a.map(T=>T.val),p=Math.min(...c),g=Math.max(...c),m=g-p||1;p-=m*.1,g+=m*.1;let v=a[0].ts,w=a[a.length-1].ts-v||1,j=T=>(T-v)/w*n,E=T=>2+(1-(T-p)/(g-p))*(h-4),A=a;if(A.length>De){let T=Math.ceil(A.length/De);A=A.filter((b,G)=>G%T===0||G===A.length-1)}let W=A.map(T=>`${j(T.ts).toFixed(1)},${E(T.val).toFixed(1)}`).join(" "),F=o.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return r`
    <svg class="mini-sparkline" viewBox="0 0 ${n} ${h}" preserveAspectRatio="none" role="img" aria-label="${s("chart_mini_sparkline",t)}">
      <polyline points="${W}" fill="none" stroke="${F}" stroke-width="1.5" stroke-linejoin="round" />
    </svg>
  `}function Oe(o,l){let t=l;if(o.days_until_due==null||!o.interval_days||o.interval_days<=0)return d;let{pct:e,overflow:i}=Pt(o.interval_days,o.days_until_due,o.interval_unit),a="var(--success-color, #4caf50)";return o.status==="overdue"?a="var(--error-color, #f44336)":o.status==="due_soon"&&(a="var(--warning-color, #ff9800)"),r`
    <div class="days-progress">
      <div class="days-progress-labels">
        <span>${o.last_performed?`${s("last_performed",t)}: ${Q(o.last_performed,t)}`:""}</span>
        <span>${o.next_due?`${s("next_due",t)}: ${Q(o.next_due,t)}`:""}</span>
      </div>
  ...
  `}function St(o,l,t=4){if(!isFinite(o)||!isFinite(l))return{ticks:[],niceMin:0,niceMax:1};if(o===l){let p=Math.abs(o)*.1||1;o-=p,l+=p}let e=l-o,i=Math.pow(10,Math.floor(Math.log10(e/Math.max(1,t)))),a=i;for(let p of[1,2,5,10])if(a=i*p,e/a<=t+.5)break;let n=Math.floor(o/a)*a,h=Math.ceil(l/a)*a,c=[];for(let p=n;p<=h+a*1e-6;p+=a)c.push(Math.abs(p)<a*1e-9?0:p);return{ticks:c,niceMin:n,niceMax:h}}function dt(o){let l=Math.abs(o);return l>=1e6?$t((o/1e6).toFixed(l>=1e7?0:1))+"M":l>=1e4?$t((o/1e3).toFixed(0))+"k":l>=1e3?$t((o/1e3).toFixed(1))+"k":l>=100?o.toFixed(0):l>=10||l>=1?$t(o.toFixed(1)):l===0?"0":$t(o.toFixed(2))}function $t(o){return o.replace(/\.0+$/,"").replace(/(\.\d*[1-9])0+$/,"$1")}function yt(o,l,t){let e=o.toLocaleString(t,{maximumFractionDigits:Math.abs(o)>=100?0:1});return l?`${e} ${l}`:e}function wt(o,l,t){let e=new Date(o),i=t?{month:"short",day:"numeric",year:"2-digit"}:{month:"short",day:"numeric"};return e.toLocaleDateString(l,i)}function ee(o,l){return new Date(o).toLocaleDateString(l,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}function Bt(o,l){return new Date(o).getFullYear()!==new Date(l).getFullYear()}function Nt(o,l,t){if(t<2||l<=o)return[o,l];let e=[];for(let i=0;i<t;i++)e.push(o+(l-o)*i/(t-1));return e}var Ut=210,nt=46,ht=14,ut=12,Re=14,ei=20+Re,ii=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],H=class extends D{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(t=>{let e=Math.floor(t[0]?.contentRect?.width||0);e&&Math.abs(e-this._width)>2&&(this._width=e)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(t){t!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:t},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let t=this._width||320,e=[...this.points].sort((a,n)=>a.ts-n.ts),i=this.lang;return r`
    ...
    `}_renderSvg(t,e){let i=this.lang,a=t-nt-ht,n=Ut-ei,h=n-ut,c=1/0,p=-1/0;for(let $ of e)c=Math.min(c,$.min??$.val),p=Math.max(p,$.max??$.val);this.thresholdAbove!=null&&(c=Math.min(c,this.thresholdAbove),p=Math.max(p,this.thresholdAbove)),this.thresholdBelow!=null&&(c=Math.min(c,this.thresholdBelow),p=Math.max(p,this.thresholdBelow)),this.targetValue!=null&&(c=Math.min(c,this.targetValue),p=Math.max(p,this.targetValue)),this.forceZero&&(c=Math.min(c,0));let g=(p-c||1)*.06,m=this.forceZero&&c>=0?0:c-g,{ticks:v,niceMin:x,niceMax:w}=St(m,p+g,4);this.forceZero&&c>=0&&x<0&&(x=0,v=v.filter($=>$>=0));let j=e[0].ts,E=e[e.length-1].ts,A=E-j||1,W=Bt(j,E),F=$=>nt+($-j)/A*a,T=$=>ut+(1-($-x)/(w-x||1))*h,b=e.map($=>`${F($.ts).toFixed(1)},${T($.val).toFixed(1)}`).join(" "),G=`M${F(e[0].ts).toFixed(1)},${n} `+e.map($=>`L${F($.ts).toFixed(1)},${T($.val).toFixed(1)}`).join(" ")+` L${F(e[e.length-1].ts).toFixed(1)},${n} Z`,Y="",tt=e.filter($=>$.min!=null&&$.max!=null);if(tt.length>=2){let $=tt.map(M=>`${F(M.ts).toFixed(1)},${T(M.max).toFixed(1)}`),f=[...tt].reverse().map(M=>`${F(M.ts).toFixed(1)},${T(M.min).toFixed(1)}`);Y=`M${$[0]} `+$.slice(1).map(M=>`L${M}`).join(" ")+` L${f.join(" L")} Z`}let U=[];if(this.thresholdBelow!=null){let $=T(this.thresholdBelow);U.push({y:$,h:Math.max(0,n-$),lineY:$,label:`\u25BC ${dt(this.thresholdBelow)}`,labelY:Math.min(n-4,$+13)})}if(this.thresholdAbove!=null){let $=T(this.thresholdAbove);U.push({y:ut,h:Math.max(0,$-ut),lineY:$,label:`\u25B2 ${dt(this.thresholdAbove)}`,labelY:Math.max(ut+11,$-5)})}let rt=e[e.length-1],pt=(this.events||[]).filter($=>$.ts>=j&&$.ts<=E),gt=Nt(j,E,Math.max(2,Math.min(5,Math.floor(a/110)+1))),B=this._hover;return r`
      <div class="svg-holder">
        <svg
          ...
          @pointermove=${$=>this._onPointer($,e,F,T,t)}
          @pointerdown=${$=>this._onPointer($,e,F,T,t)}
          @pointerleave=${()=>this._hover=null}
        >
          <defs>
            <clipPath id="plot"><rect x="${nt}" y="${ut}" width="${a}" height="${h}" /></clipPath>
            ${U.length?P`<clipPath id="danger">${U.map($=>P`<rect x="${nt}" y="${$.y.toFixed(1)}" width="${a}" height="${$.h.toFixed(1)}" />`)}</clipPath>`:d}
          ...
          ${v.map($=>{let f=T($);return f<ut-1||f>n+1?d:P`
              <line x1="${nt}" y1="${f.toFixed(1)}" x2="${t-ht}" y2="${f.toFixed(1)}"
                stroke="var(--divider-color)" stroke-width="1" opacity="0.6" />
              <text x="${nt-7}" y="${(f+3.5).toFixed(1)}" text-anchor="end" class="tick-label">${dt($)}</text>`})}

          ${U.map($=>P`<rect x="${nt}" y="${$.y.toFixed(1)}" width="${a}" height="${$.h.toFixed(1)}"
          ...
          <polyline points="${b}" fill="none" stroke="var(--primary-color)" stroke-width="2"
            stroke-linejoin="round" stroke-linecap="round" clip-path="url(#plot)" />
          ${U.length?P`<polyline points="${b}" fill="none" stroke="var(--error-color, #f44336)" stroke-width="2"
                stroke-linejoin="round" stroke-linecap="round" clip-path="url(#danger)" />`:d}

          ${U.map($=>P`
              <line x1="${nt}" y1="${$.lineY.toFixed(1)}" x2="${t-ht}" y2="${$.lineY.toFixed(1)}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${t-ht-4}" y="${$.labelY.toFixed(1)}" text-anchor="end" class="zone-label">${$.label}</text>`)}

          ${this.targetValue!=null?P`<line x1="${nt}" y1="${T(this.targetValue).toFixed(1)}" x2="${t-ht}" y2="${T(this.targetValue).toFixed(1)}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${t-ht-4}" y="${(T(this.targetValue)-5).toFixed(1)}" text-anchor="end" class="zone-label">◆ ${dt(this.targetValue)} ${this.unit}</text>`:d}

          ${this.projection&&this.projection.length===2?P`<line x1="${F(this.projection[0].ts).toFixed(1)}" y1="${T(this.projection[0].val).toFixed(1)}"
                x2="${Math.min(F(this.projection[1].ts),t-ht).toFixed(1)}" y2="${T(Math.max(x,Math.min(w,this.projection[1].val))).toFixed(1)}"
                stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.8" />`:d}

          ${gt.map(($,f)=>{let M=F($),Vt=f===0?"start":f===gt.length-1?"end":"middle";return P`<text x="${M.toFixed(1)}" y="${Ut-5}" text-anchor="${Vt}" class="tick-label">${wt($,i,W)}</text>`})}

          <line x1="${nt}" y1="${n}" x2="${t-ht}" y2="${n}" stroke="var(--divider-color)" stroke-width="1" />

          ${pt.map($=>{let f=F($.ts),M=$.type==="completed"?"var(--success-color, #4caf50)":$.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return P`
              <line x1="${f.toFixed(1)}" y1="${ut}" x2="${f.toFixed(1)}" y2="${n}" stroke="${M}" stroke-width="1" opacity="0.14" />
              <rect x="${(f-1.5).toFixed(1)}" y="${n+3}" width="3" height="${Re-6}" rx="1.5" fill="${M}">
                <title>${ee($.ts,i)}</title>
              </rect>`})}

          ${B?P`
                <line x1="${B.x.toFixed(1)}" y1="${ut}" x2="${B.x.toFixed(1)}" y2="${n}"
        ...
        ${B?r`<div
            ...
            >
              <div class="hover-date">${ee(B.p.ts,i)}</div>
              <div class="hover-val">
                ${yt(B.p.val,this.unit,i)}
                ${B.p.min!=null&&B.p.max!=null?r`<span class="hover-range">(${dt(B.p.min)}–${dt(B.p.max)})</span>`:d}
              </div>
            </div>`:d}
      </div>
    `}_onPointer(t,e,i,a,n){let c=t.currentTarget.getBoundingClientRect(),p=(t.clientX-c.left)/c.width*n;if(p<nt-8||p>n-ht+8){this._hover=null;return}let g=e[0],m=1/0;for(let v of e){let x=Math.abs(i(v.ts)-p);x<m&&(m=x,g=v)}this._hover={x:i(g.ts),y:a(g.val),p:g}}};H.styles=C`
  ...
  `,u([k({attribute:!1})],H.prototype,"points",2),u([k({attribute:!1})],H.prototype,"events",2),u([k()],H.prototype,"unit",2),u([k()],H.prototype,"lang",2),u([k({attribute:!1})],H.prototype,"thresholdAbove",2),u([k({attribute:!1})],H.prototype,"thresholdBelow",2),u([k({attribute:!1})],H.prototype,"targetValue",2),u([k({type:Boolean})],H.prototype,"forceZero",2),u([k({attribute:!1})],H.prototype,"projection",2),u([k({attribute:!1})],H.prototype,"rangeDays",2),u([k({type:Boolean})],H.prototype,"showRange",2),u([k({type:Boolean})],H.prototype,"busy",2),u([k({type:Boolean})],H.prototype,"hideOutliers",2),u([k({type:Boolean})],H.prototype,"showOutlierToggle",2),u([_()],H.prototype,"_width",2),u([_()],H.prototype,"_hover",2);customElements.get("maintenance-trigger-chart")||customElements.define("maintenance-trigger-chart",H);function si(o){if(o.length<4)return o;let l=o.map(p=>p.val).sort((p,g)=>p-g),t=p=>{let g=(l.length-1)*p,m=Math.floor(g),v=Math.ceil(g);return l[m]+(l[v]-l[m])*(g-m)},e=t(.25),i=t(.75),a=i-e;if(a===0)return o;let n=e-1.5*a,h=i+1.5*a,c=o.filter(p=>p.val>=n&&p.val<=h);return c.length>=2?c:o}function Ae(o,l){let t=o.trigger_config;if(!t)return d;let e=l.lang,i=o.trigger_entity_info,a=o.trigger_entity_infos,n=i?.friendly_name||t.entity_id||"\u2014",h=t.entity_id||"",c=t.entity_ids||(h?[h]:[]),p=i?.unit_of_measurement||"",g=o.trigger_current_value,m=t.type||"threshold",v=c.length>1,x=ai(o,p,l);return r`
    <h3>${s("trigger",e)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${v?r`
            ...
            <div class="trigger-entity-id">${c.map((w,j)=>r`${j>0?", ":""}<span class="entity-link" @click=${E=>jt(E,w)}>${w}</span>`)}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `:r`
            <div class="trigger-entity-name">${n}</div>
            <div class="trigger-entity-id">${h?r`<span class="entity-link" @click=${w=>jt(w,h)}>${h}</span>`:""}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `}
        </div>
      ...
      ${x?ri(x,e):g!=null?r`
              <div class="trigger-value-row">
                <span class="trigger-current ${o.trigger_active?"active":""}">${typeof g=="number"?yt(g,"",e):g}</span>
      ...
      <div class="trigger-limits">
        ...
        ${m==="compound"?r`
          ...
          ${(t.conditions||[]).map((w,j)=>r`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${j+1}. ${s(w.type||"unknown",e)}: ${w.entity_id?r`<span class="entity-link" @click=${E=>jt(E,w.entity_id)}>${w.entity_id}</span>`:""}</span>
          `)}
        `:d}
      </div>
      ...
      ${a&&a.length>1?r`
        <div class="trigger-entity-list">
          ${a.map(w=>r`
            <span class="trigger-entity-id">${w.friendly_name} (<span class="entity-link" @click=${j=>jt(j,w.entity_id)}>${w.entity_id}</span>)</span>
          `)}
        </div>
      `:d}
  ...
  `}function ai(o,l,t){let e=o.trigger_config,i=o.trigger_current_value;if(!e||i==null)return null;switch(e.type||"threshold"){case"counter":{let a=e.trigger_target_value;if(a==null||a<=0)return null;if(!e.trigger_delta_mode)return{progress:Math.max(0,i),target:a,unit:l,meter:null};let n=ze(o,Le(o,t));return{progress:Math.max(0,i-(n?.value??i)),target:a,unit:l,meter:i}}case"state_change":{let a=e.trigger_target_changes;return a==null||a<=0?null:{progress:Math.max(0,i),target:a,unit:"",meter:null}}case"runtime":{let a=e.trigger_runtime_hours;return a==null||a<=0?null:{progress:Math.max(0,i),target:a,unit:"h",meter:null}}}return null}function ze(o,l){if(o.trigger_baseline_value!=null)return{value:o.trigger_baseline_value,ts:ie(o)};if(!l.length)return null;let t=ie(o);if(t==null)return{value:l[0].val,ts:null};let e=l[0],i=Math.abs(l[0].ts-t);for(let a of l){let n=Math.abs(a.ts-t);n<i&&(e=a,i=n)}return{value:e.val,ts:t}}function ie(o){let l=[...o.history].filter(t=>t.type==="completed"||t.type==="reset").sort((t,e)=>new Date(e.timestamp).getTime()-new Date(t.timestamp).getTime())[0];return l?new Date(l.timestamp).getTime():null}function ri(o,l){let t=Math.min(999,Math.round(o.progress/o.target*100)),e=t>=100?"over":t>=75?"near":"ok";return r`
    <div class="counter-progress">
      ...
      <div class="counter-progress-caption">
        ${s("chart_since_service",l)}${o.meter!=null?r` · ${s("current",l)}: ${yt(o.meter,o.unit,l)}`:d}
      </div>
    </div>
  `}function Le(o,l){let t=o.trigger_config;if(!t)return[];let e=t.type||"threshold",i=t.entity_id||"",a=e==="runtime"?[]:l.detailStatsData.get(i)||[],n=l.isCounterEntity(t),h=[];if(a.length>=2)for(let c of a){let p={ts:c.ts,val:c.val};!n&&c.min!=null&&c.max!=null&&(p.min=c.min,p.max=c.max),h.push(p)}else for(let c of o.history)c.trigger_value!=null&&h.push({ts:new Date(c.timestamp).getTime(),val:c.trigger_value});return o.trigger_current_value!=null&&h.push({ts:Date.now(),val:o.trigger_current_value}),h.sort((c,p)=>c.ts-p.ts),h}function oi(o,l,t){let e=o.trigger_config;if(!e)return d;let i=e.type||"threshold",a=e.entity_id||"",n=Le(o,t);i==="runtime"&&e.trigger_runtime_hours&&o.trigger_current_value!=null&&(n=[{ts:ie(o)??n[0]?.ts??Date.now()-864e5,val:0},{ts:Date.now(),val:Math.max(0,o.trigger_current_value)}]),t.hideOutliers&&(n=si(n));let h=n.length<2&&!!a&&t.hasStatsService&&!t.detailStatsData.has(a);if(n.length<2&&!h)return d;let c=!!a&&t.detailStatsData.has(a)&&(t.detailStatsData.get(a)?.length??0)<2,p=Date.now()-t.rangeDays*864e5,g=n.filter(j=>j.ts>=p);g.length>=2&&(n=g);let m=null,v=!1;if(i==="counter"&&e.trigger_target_value!=null&&n.length){if(e.trigger_delta_mode){let j=ze(o,n);if(j){if(j.ts!=null){let E=n.filter(A=>A.ts>=j.ts);E.length>=2&&(n=E)}n=n.map(E=>({...E,val:Math.max(0,E.val-j.value)}))}}m=e.trigger_target_value,v=!0}else i==="state_change"&&e.trigger_target_changes?(m=e.trigger_target_changes,v=!0):i==="runtime"&&e.trigger_runtime_hours&&(m=e.trigger_runtime_hours,v=!0);let x=null;if(m==null&&o.degradation_rate!=null&&(o.degradation_trend!=="stable"||o.days_until_threshold!=null)&&o.degradation_trend!=="insufficient_data"&&n.length>=2){let j=n[n.length-1];x=[j,{ts:j.ts+30*864e5,val:j.val+o.degradation_rate*30}]}let w=o.history.filter(j=>["completed","skipped","reset"].includes(j.type)).map(j=>({ts:new Date(j.timestamp).getTime(),type:j.type}));return r`
    <maintenance-trigger-chart
      ...
      .busy=${h}
      @range-change=${j=>t.setRangeDays(j.detail.days)}
      @outlier-toggle=${j=>t.setHideOutliers(j.detail.hide)}
    ></maintenance-trigger-chart>
    ${c&&!h?r`<div class="chart-note">
          <ha-icon icon="mdi:information-outline"></ha-icon>
          ${s("chart_no_stats",t.lang)}
        </div>`:d}
  `}var ni=200,Et=10,li=22;function Ie(o,l,t,e){let i=o.history.filter(h=>h.type==="completed"&&(h.cost!=null||h.duration!=null));if(i.length<2)return d;let a=i.some(h=>(h.cost??0)>0),n=i.some(h=>(h.duration??0)>0);return!a&&!n?d:r`
  ...
  `}function ci(o,l,t){let e=o.history.filter(f=>f.type==="completed"&&(f.cost!=null||f.duration!=null)).map(f=>({ts:new Date(f.timestamp).getTime(),cost:f.cost??0,duration:f.duration??0})).sort((f,M)=>f.ts-M.ts);if(e.length<2)return d;let i=e.some(f=>f.cost>0),a=e.some(f=>f.duration>0);if(!i&&!a)return d;let n=t!=="duration"&&i,h=t!=="cost"&&a,c=n||!h&&i,p=h||!n&&a,g=640,m=ni,v=c?44:12,x=p?44:12,w=g-v-x,j=m-li,E=j-Et,A=e[0].ts,W=e[e.length-1].ts,F=(W-A||864e5)*.05,T=A-F,b=W+F,G=Bt(A,W),Y=f=>v+(f-T)/(b-T)*w,tt=St(0,Math.max(...e.map(f=>f.cost))||1,3),U=St(0,Math.max(...e.map(f=>f.duration))||1,3),rt=f=>Et+(1-f/(tt.niceMax||1))*E,pt=f=>Et+(1-f/(U.niceMax||1))*E,gt=e.length>1?Math.min(...e.slice(1).map((f,M)=>Y(f.ts)-Y(e[M].ts))):w,B=Math.max(6,Math.min(22,gt*.55)),$=Nt(A,W,Math.max(2,Math.min(4,e.length)));return r`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${g} ${m}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_history",l)}">
        ${c?tt.ticks.map(f=>{let M=rt(f);return M<Et-1||M>j+1?d:P`
            <line x1="${v}" y1="${M.toFixed(1)}" x2="${g-x}" y2="${M.toFixed(1)}" stroke="var(--divider-color)" stroke-width="1" opacity="0.55" />
            <text x="${v-6}" y="${(M+3.5).toFixed(1)}" text-anchor="end" fill="var(--primary-color)" font-size="10.5">${dt(f)}€</text>`}):d}
        ${p?U.ticks.map(f=>{let M=pt(f);return M<Et-1||M>j+1?d:P`<text x="${g-x+6}" y="${(M+3.5).toFixed(1)}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="10.5">${dt(f)}m</text>`}):d}

        ${c?e.filter(f=>f.cost>0).map(f=>P`
          <rect x="${(Y(f.ts)-B/2).toFixed(1)}" y="${rt(f.cost).toFixed(1)}" width="${B.toFixed(1)}" height="${(j-rt(f.cost)).toFixed(1)}"
            fill="var(--primary-color)" opacity="0.6" rx="2">
            <title>${wt(f.ts,l,!0)}: ${f.cost.toLocaleString(l)}€${f.duration?` \xB7 ${f.duration}m`:""}</title>
          </rect>
        `):d}
        ${p?P`
          <polyline points="${e.map(f=>`${Y(f.ts).toFixed(1)},${pt(f.duration).toFixed(1)}`).join(" ")}"
            fill="none" stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-linejoin="round" />
          ${e.map(f=>P`
            <circle cx="${Y(f.ts).toFixed(1)}" cy="${pt(f.duration).toFixed(1)}" r="3.5" fill="var(--accent-color, #ff9800)">
              <title>${wt(f.ts,l,!0)}: ${f.duration}m${f.cost?` \xB7 ${f.cost.toLocaleString(l)}\u20AC`:""}</title>
            </circle>
          `)}
        `:d}

        <line x1="${v}" y1="${j}" x2="${g-x}" y2="${j}" stroke="var(--divider-color)" stroke-width="1" />
        ${$.map((f,M)=>{let Vt=M===0?"start":M===$.length-1?"end":"middle";return P`<text x="${Y(f).toFixed(1)}" y="${m-6}" text-anchor="${Vt}" fill="var(--secondary-text-color)" font-size="10">${wt(f,l,G)}</text>`})}
      </svg>
    </div>
  ...
  `}var bt=class extends D{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{this._url=await Lt(this.hass,this.docId)}catch{this._failed=!0}}render(){return this._failed||!this.docId?d:this._url?r`
      <a href=${this._url} target="_blank" rel="noopener" class="wrap">
        <img src=${this._url} alt="" loading="lazy"
          @error=${()=>this._failed=!0} />
      </a>`:r`<div class="ph"></div>`}};bt.styles=C`
  ...
  `,u([k({attribute:!1})],bt.prototype,"hass",2),u([k()],bt.prototype,"docId",2),u([_()],bt.prototype,"_url",2),u([_()],bt.prototype,"_failed",2);customElements.get("maintenance-history-photo")||customElements.define("maintenance-history-photo",bt);var di=["completed","skipped","missed","reset","triggered","trigger_replaced","trigger_removed"];function Pe(o,l){let t=l.lang;return r`
    <div class="history-filters-new">
      <div class="filter-chips">
        ${di.map(e=>{let i=o.history.filter(a=>a.type===e).length;return i===0?d:r`
  ...
  `}function Fe(o,l){let t=l.lang,e=l.filter?o.history.filter(i=>i.type===l.filter):o.history;if(l.search){let i=l.search.toLowerCase();e=e.filter(a=>a.notes?.toLowerCase().includes(i))}return e.length===0?r`<p class="empty">${s("no_history",t)}</p>`:r`
    <div class="history-timeline">
      ${[...e].reverse().map(i=>pi(i,l))}
    </div>
  `}function pi(o,l){let t=l.lang,e=["completed","reset","skipped"].includes(o.type);return r`
    <div class="history-entry">
      <div class="history-icon ${o.type}">
        <ha-icon .icon=${Dt[o.type]||"mdi:circle"}></ha-icon>
      </div>
      <div class="history-content">
        ...
        <div class="history-date">${At(o.timestamp,t)}</div>
  ...
  `:d}function hi(o,l){let t=l.lang,e=l.isOperator,i=o.archived?"archived":o.is_done?"done":o.status==="due_soon"?"warning":o.status||"ok",a=o.archived?s("archived",t):o.is_done?s("completed",t):s(o.status||"ok",t);return r`
  ...
  `}function ui(o){let l=o.lang;return r`
    <div class="tab-bar">
  ...
  `}function gi(o,l){if(!l.features.checklists)return d;let t=o.checklist||[];if(t.length===0)return d;let e=l.lang,i=o.checklist_progress||{},a=t.filter(n=>i[n]).length;return r`
  ...
  `}function _i(o,l){let t=V(o.documentation_url)?o.documentation_url:null,e=V(l.objectDocUrl)?l.objectDocUrl:null,i=e?null:(l.objectManualDocs||[])[0];if(!o.notes&&!t&&!e&&!i)return d;let a=l.lang;return r`
  ...
  `}function mi(o,l){let t=l.lang,e=o.times_performed>0?o.total_cost/o.times_performed:0,i=o.days_until_due!==null&&o.days_until_due!==void 0?o.days_until_due<0?"overdue":o.days_until_due<=o.warning_days?"warning":"":"";return r`
    <div class="kpi-bar">
      <div class="kpi-card">
      ...
      <div class="kpi-card">
        ...
        <div class="kpi-value">${kt(o,t)}</div>
  ...
  `}function vi(o,l){let t=l.lang;if(!l.features.adaptive||!o.suggested_interval||o.suggested_interval===o.interval_days)return d;if(l.suggestionDismissed)return d;let e=o.suggested_interval;return r`
  ...
  `}function bi(o,l){let t=l.lang,e=o.history.slice(-3).reverse();if(e.length===0)return d;let i=a=>{switch(a){case"completed":return"\u2713";case"triggered":return"\u2297";case"skipped":return"\u21B7";case"reset":return"\u21BA";default:return"\xB7"}};return r`
  ...
  `}function yi(o,l){return r`
    <div class="tab-content history-tab">
      ${Pe(o,l.history)}
      ${Fe(o,l.history)}
    </div>
  `}function xi(o,l){switch(l.activeTab){case"overview":return fi(o,l);case"history":return yi(o,l);default:return d}}function Be(o,l){return r`
  ...
  `}var Mt=class extends D{createRenderRoot(){return this}render(){return!this.task||!this.ctx?d:r`${Be(this.task,this.ctx)}`}};u([k({attribute:!1})],Mt.prototype,"task",2),u([k({attribute:!1})],Mt.prototype,"ctx",2);customElements.get("maintenance-task-detail-view")||customElements.define("maintenance-task-detail-view",Mt);function Ne(o){if(o.total<=0)return{start:0,end:0,padTop:0,padBottom:0};let l=o.overscan??12,t=Math.max(1,o.step??6),e=Math.max(1,o.rowHeight),i=Math.floor((o.scrollTop-o.listTop)/e),a=Math.ceil(o.viewportHeight/e)+1,n=Math.max(0,i-l);n=Math.floor(n/t)*t;let h=Math.min(o.total,Math.max(i,0)+a+l);return h=Math.min(o.total,Math.ceil(h/t)*t),n>=h&&(n=Math.min(n,Math.max(0,o.total-1)),h=Math.min(o.total,n+Math.max(a,1))),{start:n,end:h,padTop:n*e,padBottom:(o.total-h)*e}}var y=class extends D{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._allParts=null;this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._filterLabel=null;this._filterPriority="";this._savedViews=[];this._activeViewId="";this._unsub=null;this._chartRangeDays=(()=>{try{let t=parseInt(Z(R.chartRange)||"",10);return[7,30,90,365].includes(t)?t:30}catch{return 30}})();this._hideOutliers=(()=>{try{return Z(R.chartHideOutliers)==="1"}catch{return!1}})();this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._operatorWriteEnabled=!1;this._defaultWarningDays=7;this._actionLoading=!1;this._moreMenuOpen=!1;this._objMenuOpen=!1;this._toastMessage="";this._toastUndo=null;this._toastActionLabel="";this._filtersOpen=!1;this._newMenuOpen=!1;this._gsSetupsCount=0;this._gsAdoptCount=0;this._gsLoaded=!1;this._batteryFleetSetupAvailable=!1;this._staleBundle=!1;this._staleChecked=!1;this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab=(()=>{try{let t=Z(R.overviewTab);return t==="today"||t==="calendar"?t:"dashboard"}catch{return"dashboard"}})();this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._objectViewMode="cards";this._objectsTableColumns=de;this._showArchived=!1;this._bulkMode=!1;this._bulkSelected=new Set;this._virtStart=0;this._virtEnd=0;this._virtRowHeight=53;this._virtTotalRows=0;this._virtScrollAttached=!1;this._virtRaf=0;this._collapsedSections=(()=>{try{return new Set(JSON.parse(Z(R.collapsedSections)||"[]"))}catch{return new Set}})();this._paletteOpen=!1;this._paletteQuery="";this._paletteActive=0;this._templateGalleryOpen=!1;this._templates=[];this._templateCategories={};this._templateBusy=!1;this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=t=>this._onPopState(t);this._lazyUi=null;this._onVirtualScroll=()=>{this._virtRaf||(this._virtRaf=requestAnimationFrame(()=>{this._virtRaf=0,this._updateVirtualWindow()}))};this._deepLinkHandled=!1;this._paletteKeydown=t=>{if(t.key==="/"&&!t.ctrlKey&&!t.metaKey&&!t.altKey&&!this._paletteOpen){let i=t.composedPath()[0];if(i instanceof HTMLElement&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.tagName==="SELECT"||i.isContentEditable))return;t.preventDefault(),this._openPalette();return}if(!this._paletteOpen)return;let e=this._paletteResults;if(t.key==="Escape")t.preventDefault(),this._closePalette();else if(t.key==="ArrowDown")t.preventDefault(),this._paletteActive=Math.min(this._paletteActive+1,e.length-1);else if(t.key==="ArrowUp")t.preventDefault(),this._paletteActive=Math.max(this._paletteActive-1,0);else if(t.key==="Enter"){t.preventDefault();let i=e[this._paletteActive];i&&this._selectPaletteResult(i)}};this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=t=>{let e=t.detail;e?.type==="maintenance-supporter:open-task"&&e.entry_id&&e.task_id&&(t.stopPropagation(),this._showTask(e.entry_id,e.task_id))};this._fullHistory=null;this._onHistoryEntrySaved=async()=>{await this._loadData()}}get _currencySymbol(){return this._budget?.currency_symbol||Ot}get _lang(){return L(this.hass)}get _isOperator(){let t=this.hass?.user;return t?t.is_admin?!1:!(this._operatorWriteEnabled&&this._adminPanelUserIds.includes(t.id)):!0}_ensureLazyUi(){return this._lazyUi||(this._lazyUi=Promise.all([import("/maintenance_supporter_panelfiles/panel-chunks/object-dialog-VANUKIH3.js"),import("/maintenance_supporter_panelfiles/panel-chunks/task-dialog-5LXZCS25.js"),import("/maintenance_supporter_panelfiles/panel-chunks/complete-dialog-DOOQU42K.js"),import("/maintenance_supporter_panelfiles/panel-chunks/qr-dialog-BJHV7TQJ.js"),import("/maintenance_supporter_panelfiles/panel-chunks/adopt-problem-sensors-dialog-3JFUVB3G.js"),import("/maintenance_supporter_panelfiles/panel-chunks/suggested-setups-dialog-PAERPQT2.js"),import("/maintenance_supporter_panelfiles/panel-chunks/settings-view-7UT7SSHN.js")]).then(()=>this.updateComplete)),this._lazyUi}async _ui(t){return await this._ensureLazyUi(),this.shadowRoot?.querySelector(t)??null}connectedCallback(){super.connectedCallback();let t=window.requestIdleCallback,e=()=>this._ensureLazyUi();t?t(e,{timeout:3e3}):window.setTimeout(e,1500),window.addEventListener("popstate",this._popstateHandler),window.addEventListener("keydown",this._paletteKeydown),window.addEventListener("resize",this._onVirtualScroll,{passive:!0});try{let i=Z(R.taskSort);i&&["due_date","object","type","task_name","area","assigned_user","group"].includes(i)&&(this._sortMode=i);let a=Z(R.objectSort);a&&["alphabetical","due_soonest","task_count"].includes(a)&&(this._objectSortMode=a);let n=Z(R.groupBy);n&&["none","area","group","user"].includes(n)&&(this._groupByMode=n);let h=Z(R.objectView);(h==="cards"||h==="table")&&(this._objectViewMode=h)}catch{}if(this._objects.length===0){let i=je();i&&(this._objects=i.objects,i.stats&&(this._stats=i.stats))}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),window.removeEventListener("keydown",this._paletteKeydown),window.removeEventListener("resize",this._onVirtualScroll),this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onVirtualScroll),this._virtScrollAttached=!1,this._virtRaf&&cancelAnimationFrame(this._virtRaf),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(t){if(super.updated(t),Rt(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Ft(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new ue(this.hass),this._userService.getUsers())}let e=this.shadowRoot?.querySelector(".content");e&&!this._virtScrollAttached&&(e.addEventListener("scroll",this._onVirtualScroll,{passive:!0}),this._virtScrollAttached=!0),this._updateVirtualWindow()}_updateVirtualWindow(){let t=this.shadowRoot?.querySelector(".content"),e=this.shadowRoot?.querySelector(".task-table.virtual");if(!t||!e)return;let i=e.querySelector(".task-row:not(.virt-sizer)");i&&i.offsetHeight>20&&(this._virtRowHeight=i.offsetHeight);let a=e.getBoundingClientRect().top-t.getBoundingClientRect().top+t.scrollTop,n=Ne({scrollTop:t.scrollTop,viewportHeight:t.clientHeight,listTop:a,rowHeight:this._virtRowHeight,total:this._virtTotalRows});(n.start!==this._virtStart||n.end!==this._virtEnd)&&(this._virtStart=n.start,this._virtEnd=n.end)}async _loadData(){let[t,e,i,a,n,h]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"}).catch(()=>null)]);if(h&&(this._savedViews=h.views||[]),t&&(this._objects=Tt(t.objects),Qt(this._objects,e??this._stats??null),this._maybeLoadGettingStarted()),this._view==="task"&&this._selectedEntryId&&this._selectedTaskId&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/status"}).then(c=>{this._batteryFleetSetupAvailable=!!c.available&&!c.configured}).catch(()=>{this._batteryFleetSetupAvailable=!1}),this._staleChecked||(this._staleChecked=!0,this.hass.connection.sendMessagePromise({type:"maintenance_supporter/version"}).then(c=>{this._staleBundle=ae(c?.version)}).catch(()=>{})),e&&(this._stats=e),i&&(this._budget=i),a&&(this._groups=a.groups||{}),n){let c=n;this._features=c.features,this._adminPanelUserIds=c.admin_panel_user_ids||[],this._operatorWriteEnabled=c.operator_write_enabled??!1;let p=c.general?.default_warning_days;typeof p=="number"&&p>=0&&p<=365&&(this._defaultWarningDays=p),this._objectsTableColumns=pe(c.objects_table_columns)}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let t=new URLSearchParams(window.location.search),e=t.get("ms_action"),i=()=>{let g=window.location.pathname+window.location.hash;history.replaceState(history.state,"",g)};if(e==="add_object"){this._deepLinkHandled=!0,i(),this._ui("maintenance-object-dialog").then(g=>g?.openCreate());return}if(e==="open_vacation"||e==="open_budget"||e==="open_groups"||e==="open_settings"){this._deepLinkHandled=!0,i(),this._overviewTab="settings",this._ensureLazyUi().then(()=>requestAnimationFrame(()=>{let g=this.shadowRoot?.querySelector("maintenance-settings-view"),m=e.replace("open_","");g?.scrollToSection?.(m)}));return}let a=t.get("entry_id");if(!a)return;this._deepLinkHandled=!0;let n=t.get("task_id"),h=t.get("action"),c=window.location.pathname+window.location.hash;history.replaceState(history.state,"",c);let p=this._getObject(a);if(!p){this._showOverview();return}if(n){let g=p.tasks.find(m=>m.id===n);if(!g){this._showObject(a);return}this._showTask(a,n),h==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(a,n,g.name,this._features.checklists?g.checklist:void 0,this._features.adaptive&&!!g.adaptive_config?.enabled)}):h==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(a,n,g)})}else this._showObject(a)}_isCounterEntity(t){if(!t)return!1;let e=t.type||"threshold";return e==="counter"||e==="state_change"}async _fetchDetailStats(t,e){if(!this._statsService)return;let i=await this._statsService.getDetailStats(t,e,this._chartRangeDays),a=new Map(this._detailStatsData);a.set(t,i),this._detailStatsData=a}_setChartRange(t){if(t===this._chartRangeDays)return;this._chartRangeDays=t;try{N(R.chartRange,String(t))}catch{}let e=this._selectedEntryId&&this._selectedTaskId?this._getTask(this._selectedEntryId,this._selectedTaskId):null,i=e?.trigger_config?.entity_id;if(i){let a=new Map(this._detailStatsData);a.delete(i),this._detailStatsData=a,this._fetchDetailStats(i,this._isCounterEntity(e.trigger_config))}}_setHideOutliers(t){if(t!==this._hideOutliers){this._hideOutliers=t;try{N(R.chartHideOutliers,t?"1":"0")}catch{}}}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let t=[];for(let i of this._objects)for(let a of i.tasks){let n=a.trigger_config?.entity_id;n&&t.push({entityId:n,isCounter:this._isCounterEntity(a.trigger_config)})}if(t.length===0)return;let e=await this._statsService.getBatchMiniStats(t);this._miniStatsData=new Map([...this._miniStatsData,...e])}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e,a=ke(this._objects,i);a!==null&&(this._objects=a,e.objects&&Qt(a,this._stats??null))},{type:"maintenance_supporter/subscribe",deltas:!0,compact:!0});if(!this.isConnected){t();return}this._unsub=t}catch{}}get _taskRows(){let t=[];for(let m of this._objects)for(let v of m.tasks){if(!this._showArchived&&v.archived||this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let w=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==w)continue}if(this._filterLabel&&!(v.labels||[]).includes(this._filterLabel)||this._filterPriority&&(v.priority||"normal")!==this._filterPriority)continue;let x=[];for(let w of Object.values(this._groups))w.task_refs?.some(j=>j.entry_id===m.entry_id&&j.task_id===v.id)&&x.push(w.name);t.push({entry_id:m.entry_id,task_id:v.id,object_name:m.object.name,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_unit:v.interval_unit??null,interval_anchor:v.interval_anchor??null,is_done:v.is_done??!1,archived:v.archived??!1,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,priority:v.priority??"normal",labels:v.labels??[],area_id:m.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:x})}let e={overdue:0,triggered:1,due_soon:2,ok:3},i=(m,v)=>(e[m.status]??9)-(e[v.status]??9),a=(m,v)=>(m.days_until_due??99999)-(v.days_until_due??99999),n=(m,v)=>i(m,v)||a(m,v),h=m=>m.area_id&&this.hass?.areas?.[m.area_id]?.name||"",c=m=>m.responsible_user_id&&this._userService?.getUserName(m.responsible_user_id)||"",p=m=>m.group_names[0]||"",g={due_date:n,object:(m,v)=>m.object_name.localeCompare(v.object_name)||n(m,v),type:(m,v)=>m.type.localeCompare(v.type)||n(m,v),task_name:(m,v)=>m.task_name.localeCompare(v.task_name),area:(m,v)=>{let x=h(m),w=h(v);return!x&&w?1:x&&!w?-1:x.localeCompare(w)||n(m,v)},assigned_user:(m,v)=>{let x=c(m),w=c(v);return!x&&w?1:x&&!w?-1:x.localeCompare(w)||n(m,v)},group:(m,v)=>{let x=p(m),w=p(v);return!x&&w?1:x&&!w?-1:x.localeCompare(w)||n(m,v)}};return t.sort(g[this._sortMode]),t}_getObject(t){return this._objects.find(e=>e.entry_id===t)}_getTask(t,e){return this._getObject(t)?.tasks.find(a=>a.id===e)}_pushPanelState(t,e,i){let a={msp_view:t,msp_entry:e||null,msp_task:i||null};history.pushState(a,"")}_onPopState(t){let e=t.state;if(e?.msp_view&&(this._view=e.msp_view,this._selectedEntryId=e.msp_entry||null,this._selectedTaskId=e.msp_task||null,this._moreMenuOpen=!1,e.msp_view==="all_parts"&&this._loadAllParts(),e.msp_view==="task"&&e.msp_entry&&e.msp_task)){this._historyFilter=null;let i=this._getTask(e.msp_entry,e.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop()}_showAllParts(){this._pushPanelState("all_parts"),this._view="all_parts",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop(),this._loadAllParts()}async _loadAllParts(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"});this._allParts=t.parts||[]}catch{this._allParts=[]}}_filterByStatus(t){this._filterStatus=t,this._activeViewId="",this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),this._scrollContentToTop()}get _allLabels(){let t=new Set;for(let e of this._objects)for(let i of e.tasks)for(let a of i.labels||[])t.add(a);return[...t].sort((e,i)=>e.localeCompare(i))}get _currentFilters(){return{status:this._filterStatus,user_id:this._filterUser,label:this._filterLabel,priority:this._filterPriority,archived:this._showArchived,sort_mode:this._sortMode,group_by:this._groupByMode}}_applyView(t){if(this._activeViewId=t,!t)return;let e=this._savedViews.find(a=>a.id===t);if(!e)return;let i=e.filters;this._filterStatus=i.status||"",this._filterUser=i.user_id||null,this._filterLabel=i.label||null,this._filterPriority=i.priority||"",this._showArchived=!!i.archived,["due_date","object","type","task_name","area","assigned_user","group"].includes(i.sort_mode)&&(this._sortMode=i.sort_mode),["none","area","group","user"].includes(i.group_by)&&(this._groupByMode=i.group_by);try{N(R.taskSort,this._sortMode),N(R.groupBy,this._groupByMode)}catch{}this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard")}_openSavedViewsDialog(){this.shadowRoot.querySelector("maintenance-saved-views-dialog")?.open(this._currentFilters,this._savedViews)}_onSavedViewsChanged(t){this._savedViews=t.detail.views||[],this._activeViewId&&!this._savedViews.some(e=>e.id===this._activeViewId)&&(this._activeViewId="")}_scrollContentToTop(){requestAnimationFrame(()=>{let t=this.shadowRoot?.querySelector(".content");t&&t.scrollTo({top:0,behavior:"smooth"})})}_showObject(t){this._pushPanelState("object",t),this._view="object",this._selectedEntryId=t,this._selectedTaskId=null,this._scrollContentToTop()}_showTask(t,e){this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._scrollContentToTop(),this._fetchFullHistory(t,e);let i=this._getTask(t,e);if(i?.trigger_config?.entity_id){let a=i.trigger_config.entity_id,n=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(a,n)}}_showToast(t){this._toastTimer&&clearTimeout(this._toastTimer),this._toastUndo=null,this._toastActionLabel="",this._toastMessage=t,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}_showActionToast(t,e,i){this._showUndoToast(t,i),this._toastActionLabel=e}_showUndoToast(t,e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastActionLabel="",this._toastMessage=t,this._toastUndo=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastUndo=null,this._toastTimer=null},7e3)}_runToastUndo(){let t=this._toastUndo;this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage="",this._toastUndo=null,this._toastTimer=null,t?.()}_openPalette(){this._paletteQuery="",this._paletteActive=0,this._paletteOpen=!0,this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".palette-input")?.focus()})}_closePalette(){this._paletteOpen=!1,this._paletteQuery=""}get _paletteResults(){let t=this._paletteQuery.trim().toLowerCase(),e=[];for(let i of this._objects){let a=i.object.name||"";(!t||a.toLowerCase().includes(t))&&e.push({kind:"object",entryId:i.entry_id,label:a,sub:s("object",this._lang)});for(let n of i.tasks){if(n.archived)continue;let h=n.name||"",c=(n.labels||[]).some(p=>p.toLowerCase().includes(t));if(!t||h.toLowerCase().includes(t)||a.toLowerCase().includes(t)||c){let p=(n.labels||[]).length?`  #${(n.labels||[]).join(" #")}`:"";e.push({kind:"task",entryId:i.entry_id,taskId:n.id,label:h,sub:a+p})}}if(e.length>60)break}return e.slice(0,40)}_selectPaletteResult(t){this._closePalette(),t.kind==="task"&&t.taskId?this._showTask(t.entryId,t.taskId):this._showObject(t.entryId)}_renderPalette(){if(!this._paletteOpen)return d;let t=this._lang,e=this._paletteResults;return r`
    ...
    `}_statusBadge(t,e,i){let a=this._lang,n=t?"archived":e?"done":i,h=t?"archived":e?"completed":i,c=t?s("archived",a):e?s("completed",a):s(i,a);return r`<span class="status-badge ${n}"><ha-icon icon="${Dt[h]||"mdi:circle-medium"}"></ha-icon>${c}</span>`}_setOverviewTab(t){this._overviewTab=t;try{N(R.overviewTab,t)}catch{}this._scrollContentToTop()}_renderToday(){let t=this._lang,e=this._taskRows,i=p=>`${p.entry_id}:${p.task_id}`,a=e.filter(p=>p.status==="overdue"||p.trigger_active),n=new Set(a.map(i)),h=e.filter(p=>!n.has(i(p))&&p.days_until_due===0);h.forEach(p=>n.add(i(p)));let c=e.filter(p=>!n.has(i(p))&&p.days_until_due!=null&&p.days_until_due>0&&p.days_until_due<=7);return a.length+h.length+c.length===0?r`
      ...
      <div class="filter-bar ${this.narrow&&!this._filtersOpen?"collapsed":""}">
        ...
        <label class="filter-field">
          ...
          <select
            ...
            @change=${c=>{this._sortMode=c.target.value,this._activeViewId="";try{N(R.taskSort,this._sortMode)}catch{}}}
          >
        ...
        <label class="filter-field">
          ...
          <select
            ...
            @change=${c=>{this._groupByMode=c.target.value,this._activeViewId="";try{N(R.groupBy,this._groupByMode)}catch{}}}
          >
    ...
    `}_renderGroupedTasks(t,e){let i=new Map,a=s("unassigned",e);for(let c of t){let p=[];this._groupByMode==="area"?p=[(c.area_id?this.hass?.areas?.[c.area_id]?.name:null)||a]:this._groupByMode==="user"?p=[(c.responsible_user_id?this._userService?.getUserName(c.responsible_user_id):null)||a]:this._groupByMode==="group"&&(p=c.group_names.length>0?c.group_names:[a]);for(let g of p)i.has(g)||i.set(g,[]),i.get(g).push(c)}let n=[...i.entries()].sort(([c],[p])=>c===a&&p!==a?1:p===a&&c!==a?-1:c.localeCompare(p)),h=this._groupByMode==="area"?"mdi:map-marker-outline":this._groupByMode==="group"?"mdi:folder-outline":"mdi:account-outline";return r`
      ...
      `)}
    `}_warrantyLabel(t,e,i){return t.kind==="expired"?s("warranty_expired",i):t.kind==="expiring"?s("warranty_expires_in",i).replace("{days}",String(t.days??0)):s("warranty_valid_until",i).replace("{date}",Q(e,i))}_renderWarrantyMeta(t,e){let i=Zt(t);return r`<p class="meta">${s("warranty",e)}:
      ...
      <div class="filter-bar">
        <label class="filter-field">
          ...
          <select
            ...
            @change=${g=>{this._objectSortMode=g.target.value;try{N(R.objectSort,this._objectSortMode)}catch{}}}
          >
        ...
        <label class="filter-field">
          ...
          <select
            .value=${this._groupByMode}
            @change=${g=>{this._groupByMode=g.target.value;try{N(R.groupBy,this._groupByMode)}catch{}}}
          >
    ...
    `}_setObjectViewMode(t){this._objectViewMode=t;try{N(R.objectView,t)}catch{}}_renderAllParts(){let t=this._lang,e=this._allParts,i=this._currencySymbol;return r`
      <div class="breadcrumb">
...
`),`maintenance_parts_${n}.csv`,"text/csv;charset=utf-8")}async _exportObjectsCsv(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects/csv"}),e=new Date().toISOString().slice(0,10);Wt(t.csv,`maintenance_objects_${e}.csv`,"text/csv;charset=utf-8")}catch{this._showToast(s("action_error",this._lang))}}_renderObjectsTable(t){let e=this._lang,i=this._objectsTableColumns;return r`
    ...
    `}_renderOverviewRow(t){let e=this._lang,i=t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0,a=0,n=Ct.ok,h=!1;if(i&&t.days_until_due!==null){let v=Pt(t.interval_days,t.days_until_due,t.interval_unit);a=v.pct,h=v.overflow,t.status==="overdue"?n=Ct.overdue:t.status==="due_soon"&&(n=Ct.due_soon)}let c=t.area_id?this.hass?.areas?.[t.area_id]?.name:null,p=t.responsible_user_id?this._userService?.getUserName(t.responsible_user_id):null,g=t.group_names.length>0||c||p,m=this._bulkMode&&this._bulkSelected.has(this._bulkKey(t));return r`
