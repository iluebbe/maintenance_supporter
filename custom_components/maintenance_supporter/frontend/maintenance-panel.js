...
import{a as he,b as Nt,c as vt,d as Bt,e as Ct,f as ue,g as ge,h as me}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-G3IOA65Z.js";import{a as q,b as Ut,c as ve,d as be,e as Dt,f as fe,g as xe,h as $e,i as we,j as ke,k as Te,l as je,m as Se,n as Ee,s as Me,v as Ce}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-7X32JIVP.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-4FXO2MGD.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-BRYZT6JF.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-LYSJP377.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-YY3UETJ7.js";import{b as Jt,c as _e}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-ZOKK2IOO.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-ZPT7U745.js";import{a as Zt}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-GSH25Q5Z.js";import{a as ye}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-IAYX7ZWS.js";import{a as j}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-WNNUMPJH.js";import{A as Mt,B as pe,C as Ht,a as u,b as M,c as r,d as F,f as d,g as C,h as Qt,i as le,j as ce,k as $,l as m,m as Lt,n as It,o as Pt,p as s,q as Ft,r as L,s as de,t as W,u as B,v as kt,w as _t,z as Et}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-ESSAAT5R.js";var ti=["assignee_pool","required_completion_fields","checklist","labels","history"],ei=["checklist_progress"],ii=["tasks","parts"],si=["manual_docs","battery_fleet_excluded"];function Xt(o,l,t=[]){for(let e of l)o[e]===void 0&&(o[e]=[]);for(let e of t)o[e]===void 0&&(o[e]={})}function ai(o){let l=o;Xt(l,ii),l.object&&typeof l.object=="object"&&Xt(l.object,si);for(let t of l.tasks)Xt(t,ti,ei);return o}function Ot(o){for(let l of o)ai(l);return o}function ri(o,l){if(l.objects)return l.objects;let t=l.delta||[],e=l.removed||[];if(!t.length&&!e.length)return null;let i=new Map(o.map(a=>[a.entry_id,a]));for(let a of t)i.set(a.entry_id,a);for(let a of e)i.delete(a);return[...i.values()]}function De(o,l){return l.objects&&Ot(l.objects),l.delta&&Ot(l.delta),ri(o,l)}var R={overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view",objectsCache:"msp-objects-cache",gettingStartedDismissed:"msp-gs-dismissed",batteryRosterSort:"ms_bf_roster_sort"};function Z(o){try{return localStorage.getItem(o)}catch{return null}}function V(o,l){try{localStorage.setItem(o,l)}catch{}}var oi=168*3600*1e3;function Oe(){try{let o=Z(R.objectsCache);if(!o)return null;let l=JSON.parse(o);return l.v!==Qt||!Number.isFinite(l.at)||Date.now()-l.at>oi||!Array.isArray(l.objects)||l.objects.length===0?null:{objects:l.objects,stats:l.stats??null}}catch{return null}}function te(o,l){if(!(!Array.isArray(o)||o.length===0))try{let t={v:Qt,at:Date.now(),objects:o,stats:l};V(R.objectsCache,JSON.stringify(t))}catch{}}function D(o){return String(o??"").replace(/[&<>"']/g,l=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[l])}function Re(o,l,t,e,i,a){let n=[[t.manufacturer,o.manufacturer],[t.model,o.model],[t.serial,o.serial_number],[t.installed,o.installation_date?e(o.installation_date):null],[t.warranty,o.warranty_expiry?e(o.warranty_expiry):null]].filter(([,h])=>!!h),p=l.map(h=>{let g=t.scheduleLabel(h);return`<tr>
      <td>${D(h.name)}</td>
    ...
    </tr>`}).join(""),c=l.reduce((h,g)=>h+(g.total_cost??0),0);return`<!DOCTYPE html><html><head><meta charset="utf-8">
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  <h1>${D(o.name)}</h1>
  <p class="sub">${D(t.title)} \xB7 ${D(t.generated)}: ${D(e(a))}</p>
  ${n.length?`<div class="meta">${n.map(([h,g])=>`<div><div class="k">${D(h)}</div>${D(g)}</div>`).join("")}</div>`:""}
  ...
  <table>
    ...
    <tbody>${p||`<tr><td colspan="8">${D(t.none)}</td></tr>`}</tbody>
...
${D(o.notes)}</div>`:""}
</body></html>`}function ee(o,l=new Date){if(!o)return{kind:"none",days:null,date:null};let t=new Date(`${o}T00:00:00`);if(isNaN(t.getTime()))return{kind:"none",days:null,date:null};let e=Date.UTC(l.getFullYear(),l.getMonth(),l.getDate()),i=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),a=Math.round((i-e)/864e5);return a<0?{kind:"expired",days:a,date:o}:a<=60?{kind:"expiring",days:a,date:o}:{kind:"valid",days:a,date:o}}var A=o=>String(o??"").replace(/[&<>"']/g,l=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[l]);function Ae(o,l,t,e,i,a,n,p,c,h=[]){let g=[[t.object,A(l)],[t.type,A(t.typeLabel(o.type))],[t.interval,A(i(o))],[t.nextDue,o.next_due?A(e(o.next_due)):"\u2014"],[t.lastDone,o.last_performed?A(e(o.last_performed)):A(t.never)]];o.priority&&o.priority!=="normal"&&g.push([t.priority,A(o.priority)]);let v=(o.checklist||[]).map(y=>`<li><span class="box"></span>${A(y)}</li>`).join(""),_=(y,w)=>y?`<figure class="qr"><img src="${y}" alt="" /><figcaption>${A(w)}</figcaption></figure>`:"";return`<!DOCTYPE html>
...
`;var Vt=class{constructor(l){this._cache=new Map;this._pending=new Map;this.historyFallbackIds=new Set;this._hass=l}updateHass(l){this._hass=l}async getDetailStats(l,t,e=30){return this._getStats(l,e<=35?"hour":"day",e,t)}async getMiniStats(l,t){return this._getStats(l,"day",14,t)}async getBatchMiniStats(l){let t=new Map,e=[];for(let c of l){let h=`${c.entityId}:day:14`,g=this._cache.get(h);g&&Date.now()-g.fetchedAt<3e5?t.set(c.entityId,g.points):e.push(c)}if(e.length===0)return t;let i=e.filter(c=>c.isCounter).map(c=>c.entityId),a=e.filter(c=>!c.isCounter).map(c=>c.entityId),n=new Date(Date.now()-336*60*60*1e3).toISOString(),p=[];return i.length>0&&p.push(this._fetchBatch(i,"day",n,["state","sum","change"],!0,t)),a.length>0&&p.push(this._fetchBatch(a,"day",n,["mean","min","max"],!1,t)),await Promise.all(p),t}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(l,t,e,i){let a=`${l}:${t}:${e}`,n=this._cache.get(a);if(n&&Date.now()-n.fetchedAt<3e5)return n.points;if(this._pending.has(a))return this._pending.get(a);let p=this._fetchAndNormalize(l,t,e,i,a);this._pending.set(a,p);try{return await p}finally{this._pending.delete(a)}}async _fetchAndNormalize(l,t,e,i,a){let n=new Date(Date.now()-e*24*60*60*1e3).toISOString(),p=i?["state","sum","change"]:["mean","min","max"];try{let h=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:n,statistic_ids:[l],period:t,types:p}))[l]||[],g=this._normalizeRows(h,i);if(g.length<2){let v=await this._fetchHistoryFallback(l,n);v.length>=2?(g=v,this.historyFallbackIds.add(l)):this.historyFallbackIds.delete(l)}else this.historyFallbackIds.delete(l);return this._cache.set(a,{entityId:l,fetchedAt:Date.now(),period:t,points:g}),g}catch(c){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${l}:`,c),[]}}async _fetchHistoryFallback(l,t){try{let i=(await this._hass.connection.sendMessagePromise({type:"history/history_during_period",start_time:t,end_time:new Date().toISOString(),entity_ids:[l],minimal_response:!0,no_attributes:!0}))?.[l]||[];if(i.length>1e3){let p=Math.ceil(i.length/500);i=i.filter((c,h)=>h%p===0||h===i.length-1)}let a=[],n=null;for(let p of i){let c=p.s??p.state;if(c==null||c==="unknown"||c==="unavailable")continue;let h;if(c==="on"||c==="open"||c==="true")h=1;else if(c==="off"||c==="closed"||c==="false")h=0;else if(h=parseFloat(c),!Number.isFinite(h))continue;let g=p.lu??p.last_updated??p.last_changed,v=typeof g=="number"?g*1e3:g!=null?Date.parse(g):NaN;Number.isFinite(v)&&(n!=null&&n!==h&&a.push({ts:v,val:n}),a.push({ts:v,val:h}),n=h)}return a.sort((p,c)=>p.ts-c.ts),a.length&&n!=null&&a.push({ts:Date.now(),val:n}),a}catch(e){return console.warn(`[maintenance-supporter] History fallback failed for ${l}:`,e),[]}}async _fetchBatch(l,t,e,i,a,n){try{let p=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:e,statistic_ids:l,period:t,types:i});for(let c of l){let h=p[c]||[],g=this._normalizeRows(h,a);n.set(c,g),this._cache.set(`${c}:${t}:14`,{entityId:c,fetchedAt:Date.now(),period:t,points:g})}}catch(p){console.warn("[maintenance-supporter] Batch statistics fetch failed:",p)}}_normalizeRows(l,t){let e=[];for(let i of l){let a=null;if(t?a=i.state??null:a=i.mean??null,a===null)continue;let n={ts:i.start,val:a};t||(i.min!=null&&(n.min=i.min),i.max!=null&&(n.max=i.max)),e.push(n)}return e.sort((i,a)=>i.ts-a.ts),e}};function pt(o){let l=o??0;return l<1024?`${l} B`:l<1024*1024?`${(l/1024).toFixed(1)} KB`:`${(l/(1024*1024)).toFixed(1)} MB`}var $t=["manual","warranty","invoice","spare_parts","photo","other"],qt={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"};function bt(o){return o.title||o.filename||o.url||""}var I=class extends C{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._hint="";this._addingLink=!1;this._linkUrl="";this._linkTitle="";this._category="manual";this._thumbs={};this._lightboxUrl="";this._editingId="";this._editTitle="";this._editCategory="manual";this._dragOver=!1;this._loadedFor=null;this._localeReady=!1}_isImage(t){return t.kind==="file"&&(t.mime||"").startsWith("image/")}async _sign(t){return Nt(this.hass,t.id)}get _lang(){return L(this.hass)}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,W(this._lang).then(()=>this.requestUpdate())),this.hass&&this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error="",this._thumbs={},this._loadThumbs()}catch(t){this._error=j(t,this._lang),this._loaded=!0}}async _loadThumbs(){await Promise.all(this._docs.filter(t=>this._isImage(t)).map(async t=>{try{let e=await this._sign(t);this._thumbs={...this._thumbs,[t.id]:e}}catch{}}))}_category_of(t){return(t.tags||[]).find(i=>$t.includes(i))||"other"}_labelKeydown(t){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),t.currentTarget.querySelector("input")?.click())}_onFileInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i),e.value=""}_onCameraInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i,"photo"),e.value=""}_onDrop(t){if(t.preventDefault(),this._dragOver=!1,!this.canWrite||this._busy)return;let e=Array.from(t.dataTransfer?.files??[]);e.length&&this._uploadFiles(e)}_onDragOver(t){this.canWrite&&(t.preventDefault(),this._dragOver=!0)}_onDragLeave(t){let e=t.relatedTarget;(!e||!t.currentTarget.contains(e))&&(this._dragOver=!1)}async _uploadFiles(t,e){let i=e??this._category;this._busy=!0,this._error="",this._hint="";let a=0,n=0;try{for(let p of t){let c=new FormData;c.append("entry_id",this.entryId),c.append("tags",i),c.append("file",p,p.name);let h=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:c});if(!h.ok){this._error=h.status===413?s("doc_too_large",this._lang):s("doc_upload_failed",this._lang);continue}let g=await h.json();g.duplicate_in_object?n++:g.deduped&&a++}n?this._hint=s("doc_dup_in_object",this._lang):a&&(this._hint=s("doc_deduped",this._lang)),await this._load()}catch{this._error=s("doc_upload_failed",this._lang)}finally{this._busy=!1}}async _download(t){try{await Bt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=j(e,this._lang)}}async _preview(t){if(this._isImage(t)){this._lightboxUrl=this._thumbs[t.id]||await this._sign(t);return}try{await vt(this.hass,t.id)}catch(e){this._error=j(e,this._lang)}}_openDoc(t){t.kind==="file"?this._preview(t):q(t.url)&&window.open(t.url,"_blank","noopener")}_startEdit(t){this._editingId=t.id,this._editTitle=t.title||"",this._editCategory=this._category_of(t),this._addingLink=!1,this._error=""}_cancelEdit(){this._editingId=""}async _saveEdit(t){let e=(t.tags||[]).filter(a=>!$t.includes(a)),i=t.kind==="file"?[this._editCategory,...e]:t.tags??[];this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,title:this._editTitle.trim()||t.filename||t.url||"",tags:i}),this._editingId="",await this._load()}catch(a){this._error=j(a,this._lang)}finally{this._busy=!1}}async _delete(t){let e=bt(t);if(window.confirm(s("doc_delete_confirm",this._lang).replace("{name}",e))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:t.id}),await this._load()}catch(i){this._error=j(i,this._lang)}finally{this._busy=!1}}}async _addLink(){let t=this._linkUrl.trim();if(t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/add_link",entry_id:this.entryId,url:t,title:this._linkTitle.trim()||null}),this._linkUrl="",this._linkTitle="",this._addingLink=!1,await this._load()}catch(e){this._error=j(e,this._lang,s("doc_link_invalid",this._lang))}finally{this._busy=!1}}}render(){let t=this._lang;return r`
    ...
    `}_renderDoc(t,e){if(this._editingId===t.id)return this._renderEdit(t,e);let i=t.kind==="file",a=this._category_of(t),n=i?`${s(`doc_cat_${a}`,e)} \xB7 ${pt(t.size)}`:s("doc_link_badge",e),p=this._thumbs[t.id];return r`
      <div class="doc-row">
        ${i&&p?r`<img
              class="doc-thumb"
              src=${p}
  ...
  `,u([$({attribute:!1})],I.prototype,"hass",2),u([$({attribute:!1})],I.prototype,"entryId",2),u([$({type:Boolean})],I.prototype,"canWrite",2),u([m()],I.prototype,"_docs",2),u([m()],I.prototype,"_loaded",2),u([m()],I.prototype,"_busy",2),u([m()],I.prototype,"_error",2),u([m()],I.prototype,"_hint",2),u([m()],I.prototype,"_addingLink",2),u([m()],I.prototype,"_linkUrl",2),u([m()],I.prototype,"_linkTitle",2),u([m()],I.prototype,"_category",2),u([m()],I.prototype,"_thumbs",2),u([m()],I.prototype,"_lightboxUrl",2),u([m()],I.prototype,"_editingId",2),u([m()],I.prototype,"_editTitle",2),u([m()],I.prototype,"_editCategory",2),u([m()],I.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",I);var J=class extends C{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._loadedKey="";this._localeReady=!1}get _lang(){return L(this.hass)}get _refId(){return this.partId||this.taskId||""}get _linkField(){return this.partId?"part_ids":"task_ids"}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,W(this._lang).then(()=>this.requestUpdate()));let e=`${this.entryId}|${this._refId}`;this.hass&&this.entryId&&this._refId&&this._loadedKey!==e&&(this._loadedKey=e,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error=""}catch(t){this._error=j(t,this._lang),this._loaded=!0}}_links(t){return t[this._linkField]||[]}_linked(){return this._docs.filter(t=>this._links(t).includes(this._refId))}_available(){return this._docs.filter(t=>!this._links(t).includes(this._refId))}async _setLinks(t,e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,[this._linkField]:e}),await this._load()}catch(i){this._error=j(i,this._lang)}finally{this._busy=!1}}_link(){let t=this._docs.find(e=>e.id===this._attachId);t&&(this._attachId="",this._setLinks(t,[...this._links(t),this._refId]))}_unlink(t){this._setLinks(t,this._links(t).filter(e=>e!==this._refId))}_isPdf(t){return t.mime==="application/pdf"||(t.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(t){return this._isPdf(t)&&this.taskId?t.task_pages?.[this.taskId]:void 0}async _open(t){if(t.kind==="weblink"){q(t.url)&&window.open(t.url,"_blank","noopener");return}let e=this._pageFor(t);try{await vt(this.hass,t.id,e?`#page=${e}`:"")}catch(i){this._error=j(i,this._lang)}}async _setPage(t,e){if(this.taskId){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,task_pages:{[this.taskId]:e}}),await this._load()}catch(i){this._error=j(i,this._lang)}finally{this._busy=!1}}}async _download(t){try{await Bt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=j(e,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return d;let t=this._lang,e=this._linked(),i=this._available();return r`
    ...
    `}_renderRow(t,e){let i=t.kind==="file",a=this._isPdf(t),n=this._pageFor(t),p=(t.tags||[]).find(h=>$t.includes(h))||"other",c=i?pt(t.size):s("doc_link_badge",e);return r`
      <div class="tdoc-row">
  ...
  `,u([$({attribute:!1})],Y.prototype,"hass",2),u([$({attribute:!1})],Y.prototype,"entryId",2),u([$({attribute:!1})],Y.prototype,"parts",2),u([$({type:Boolean})],Y.prototype,"canWrite",2),u([$({attribute:!1})],Y.prototype,"currencySymbol",2),u([m()],Y.prototype,"_editing",2),u([m()],Y.prototype,"_busy",2),u([m()],Y.prototype,"_error",2),u([m()],Y.prototype,"_restockFor",2),u([m()],Y.prototype,"_restockQty",2),u([m()],Y.prototype,"_restockInvalid",2),u([m()],Y.prototype,"_docsFor",2);customElements.define("maintenance-parts-section",Y);var li=new Set(["completed","skipped","reset","missed"]);function Le(o){let l=[];for(let t of o)for(let e of t.history??[]){if(!li.has(e.type))continue;let i=new Date(e.timestamp).getTime();Number.isFinite(i)&&l.push({ts:i,timestamp:e.timestamp,taskId:t.id,taskName:t.name,type:e.type,cost:typeof e.cost=="number"?e.cost:null,duration:typeof e.duration=="number"?e.duration:null,notes:e.notes??null,completedBy:e.completed_by??null,phaseName:e.phase_id&&t.phases?.[e.phase_id]?.name||null})}return l.sort((t,e)=>e.ts-t.ts||t.taskName.localeCompare(e.taskName)),l}function Ie(o,l){let t=l.from?new Date(`${l.from}T00:00:00`).getTime():null,e=l.to?new Date(`${l.to}T00:00:00`).getTime()+864e5:null;return o.filter(i=>!(l.taskId&&i.taskId!==l.taskId||t!=null&&i.ts<t||e!=null&&i.ts>=e))}function Wt(o){let l=0,t=0;for(let e of o)e.type==="completed"&&(l++,e.cost!=null&&(t+=e.cost));return{completed:l,totalCost:t}}function z(o){return String(o??"").replace(/[&<>"']/g,l=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[l])}function Pe(o,l,t,e,i,a,n,p={}){let c=l.filter(_=>_.type==="completed"),{totalCost:h}=Wt(c),g=[[t.manufacturer,o.manufacturer],[t.model,o.model],[t.serial,o.serial_number],[t.installed,o.installation_date?e(o.installation_date):null]].filter(([,_])=>_).map(([_,y])=>`<div class="meta-row"><span>${z(_)}</span><strong>${z(y)}</strong></div>`).join(""),v=c.map(_=>{let y=[_.notes,_.completedBy?`${t.completedBy}: ${_.completedBy}`:null].filter(Boolean).join(" \xB7 ");return`<tr>
...
<p class="sub">${z(t.generated)} ${z(e(n))} \xB7 ${z(t.entriesLabel(c.length))}</p>
      ...
      <div class="section">
        ...
        ${i.length===0?r`<p class="empty">${s("object_history_empty",t)}</p>`:r`
              <div class="rows">
                ${p.map(c=>r`
                  <div class="row">
                    <span class="date" title=${kt(c.timestamp,t)}>${B(c.timestamp,t)}</span>
...
`;function He(o){let l=window;l.customCards=l.customCards||[],l.customCards.some(t=>t.type===o.type)||l.customCards.push(o)}var it=class extends C{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(t){if(this._config={...t},t.past_days&&[30,90].includes(t.past_days)?this._pastDays=t.past_days:t.window_days&&[7,14,30,365].includes(t.window_days)&&(this._windowDays=t.window_days,this._pastDays=0),typeof t.user_filter=="string"&&(this._userFilter=t.user_filter),typeof t.object_filter=="string")this._objectFilter=t.object_filter,this._configuredObjects=[];else if(Array.isArray(t.object_filter)){let e=t.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=e.length===1?e[0]:"",this._configuredObjects=e.length>1?e:[]}}getCardSize(){return 6}get _lang(){return L(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(t){if(super.updated(t),Ft(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=e}catch{}}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){t();return}this._unsub=t}catch{}}_onEventClick(t){if(t.history_timestamp){this._openHistoryEntry(t);return}Ce(t.entry_id,t.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:t.entry_id,task_id:t.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(t){try{let i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:t.entry_id})).tasks?.find(n=>n.id===t.task_id)?.history?.find(n=>n.timestamp===t.history_timestamp);if(!i||Me({entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp,type:i.type||"completed",timestamp:i.timestamp||t.history_timestamp,notes:i.notes??null,cost:i.cost??null,duration:i.duration??null,completed_by:i.completed_by??null,used_parts:i.used_parts??null}))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return d;let t=this._lang,e=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,n=null;this._userFilter&&(n=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let p=f=>{let K=f.toLowerCase();return this._objects.find(et=>et.entry_id===f||et.object.name.toLowerCase()===K)?.entry_id??null},c=new Set(this._configuredObjects.map(p).filter(f=>f!==null)),h=c.size?this._objects.filter(f=>c.has(f.entry_id)):this._objects,g=this._config.show_object_filter!==!1&&h.length>1,v=this._objectFilter?p(this._objectFilter):null,_=v&&h.some(f=>f.entry_id===v)?h.filter(f=>f.entry_id===v):h,y=new Date;y.setHours(0,0,0,0);let w=this._pastDays>0,S=w?we(_,y,this._pastDays,n):$e(_,y,this._windowDays,n),O=xe(y),k=this._windowDays===365||w,P=k?S.filter(f=>f.events.length>0):S,ct=f=>{let K=`cal-status-${f.status}`,tt=f.projected?"cal-event-projected":"",et=f.status==="overdue"&&f.days_until_due!=null?` (${_t(f.days_until_due,t)})`:"",ot=f.projected&&f.interval_days?r`<span class="cal-event-recur">${f.interval_unit&&f.interval_unit!=="days"?`${f.interval_days} ${s("unit_"+f.interval_unit,t)}`:s("cal_every_n_days",t).replace("{n}",String(f.interval_days))}</span>`:d,U=f.schedule_type==="sensor_based",dt=U?r`<ha-icon class="cal-event-icon cal-source-sensor"
          ...
          </span>`:d,xt=this._stats?.budget?.currency_symbol||Pt,N=f.history_type?s(f.history_type,t):s(f.status,t);return r`
        <div class="cal-event ${tt}"
          @click=${()=>this._onEventClick(f)}>
          ${dt}
          <span class="cal-status-pill ${K}">${N}</span>
      ...
      `},T=f=>{let[K,tt,et]=f.date.split("-").map(Number),ot=new Date(K,tt-1,et),U=f.date===O,dt=ot.toLocaleDateString(t,{weekday:"short"}),yt=ot.toLocaleDateString(t,{month:"long"});return r`
        <div class="cal-day-row">
          ...
          <div class="cal-day-content">
            <div class="cal-day-header">
              ...
              ${U?r`<span class="cal-day-today-badge">${s("today",t)}</span>`:d}
            </div>
            ${f.events.length===0?r`<div class="cal-empty">${s("cal_no_events",t)}</div>`:f.events.map(ct)}
          </div>
        </div>
      `};return r`
      <ha-card .header=${a}>
        ...
        <div class="cal-rolling">
          ${P.length===0&&k?r`<div class="cal-empty">${s("cal_no_events",t)}</div>`:P.map(T)}
        </div>
      </ha-card>
    `}};it.styles=[Ht,Fe,M`
      :host { display: block; }
      ha-card { padding: 0; overflow: hidden; }
    `],u([$({attribute:!1})],it.prototype,"hass",2),u([m()],it.prototype,"_config",2),u([m()],it.prototype,"_objects",2),u([m()],it.prototype,"_stats",2),u([m()],it.prototype,"_windowDays",2),u([m()],it.prototype,"_pastDays",2),u([m()],it.prototype,"_userFilter",2),u([m()],it.prototype,"_objectFilter",2),u([m()],it.prototype,"_unsub",2);var di=[{value:7,key:"cal_editor_window_week"},{value:14,key:"cal_editor_window_fortnight"},{value:30,key:"cal_editor_window_month"},{value:365,key:"cal_editor_window_year"}],Tt=class extends C{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}get _lang(){return L(this.hass)}setConfig(t){this._config={...t}}updated(){let t=this._lang;t&&!de(t)&&W(t).then(()=>this.requestUpdate())}_valueChanged(t,e){let i={...this._config,[t]:e};t==="show_window_chips"&&e===!0&&delete i.show_window_chips,t==="show_user_filter"&&e===!0&&delete i.show_user_filter,t==="show_object_filter"&&e===!0&&delete i.show_object_filter,t==="title"&&(!e||typeof e=="string"&&e.trim()==="")&&delete i.title,t==="user_filter"&&e===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let t=this._lang,e=this._config.window_days??30,i=this._config.show_window_chips!==!1,a=this._config.show_user_filter!==!1,n=this._config.user_filter??"",p=this._config.title??"";return r`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${di.map(c=>r`<option value="${c.value}" ?selected=${c.value===e}>${s(c.key,t)}</option>`)}
          </select>
        </div>
              ...
              <div class="objects">
                ${[...this.objects].sort((i,a)=>i.object.name.localeCompare(a.object.name)).map(i=>r`
                  <div class="object-block">
                    ...
                    ${i.tasks.length===0?r`<div class="hint small">${s("no_tasks_short",t)}</div>`:[...i.tasks].sort((a,n)=>a.name.localeCompare(n.name)).map(a=>{let n=`${i.entry_id}:${a.id}`,p=this._selected.has(n);return r`
  ...
  `,u([$({attribute:!1})],ht.prototype,"hass",2),u([m()],ht.prototype,"_open",2),u([m()],ht.prototype,"_busy",2),u([m()],ht.prototype,"_error",2),u([m()],ht.prototype,"_name",2),u([m()],ht.prototype,"_views",2);customElements.get("maintenance-saved-views-dialog")||customElements.define("maintenance-saved-views-dialog",ht);var hi=60,ui=20,Ne=30;function se(o){let l=o.trigger_config??null;if(!l)return d;let t=l.type||"threshold",e=o.trigger_entity_info?.unit_of_measurement??"",i=0,a="";if(t==="threshold"){let c=o.trigger_current_value??null;if(c==null)return d;let h=l.trigger_above,g=l.trigger_below;if(h!=null){let v=g??0,_=h-v||1;i=Math.min(100,Math.max(0,(c-v)/_*100)),a=`${c.toFixed(1)} / ${h} ${e}`}else if(g!=null){let _=o.trigger_entity_info?.max??(g*2||100),y=_-g||1;i=Math.min(100,Math.max(0,(_-c)/y*100)),a=`${c.toFixed(1)} / ${g} ${e}`}else if(l.trigger_equals!=null||l.trigger_not_equals!=null){let v=l.trigger_equals!=null?`= ${l.trigger_equals}`:`\u2260 ${l.trigger_not_equals}`;a=`${c.toFixed(1)} (${v}${e?` ${e}`:""})`,i=o.trigger_active?100:0}else return d}else if(t==="counter"){let c=l.trigger_target_value||1,h;if(l.trigger_delta_mode?(h=o.trigger_current_delta??null,h==null&&o.trigger_baseline_value!=null&&o.trigger_current_value!=null&&(h=o.trigger_current_value-o.trigger_baseline_value)):h=o.trigger_current_value??null,h==null)return d;i=Math.min(100,Math.max(0,h/c*100)),a=`${h.toFixed(1)} / ${c} ${e}`}else if(t==="state_change"){let c=l.trigger_target_changes||1,h=o.trigger_current_value??null;if(h==null)return d;i=Math.min(100,Math.max(0,h/c*100)),a=`${Math.round(h)} / ${c}`}else if(t==="runtime"){let c=l.trigger_runtime_hours||100,h=o.trigger_current_value??null;if(h==null)return d;i=Math.min(100,Math.max(0,h/c*100)),a=`${h.toFixed(1)}h / ${c}h`}else if(t==="compound"){let c=l.compound_logic||l.operator||"AND",h=l.conditions?.length||0;a=`${c} (${h})`,i=o.trigger_active?100:0}else return d;let n=i>=100,p=i>90?"var(--error-color, #f44336)":i>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return r`
    <div class="trigger-progress">
      <div class="trigger-progress-bar">
        <div class="trigger-progress-fill${n?" overflow":""}" style="width:${i}%;background:${p}"></div>
      </div>
      <span class="trigger-progress-label">${a}</span>
    </div>
  `}function ae(o,l,t){if(!o.trigger_config?.entity_id)return d;let e=o.trigger_config.entity_id,i=l.get(e)||[],a=[];if(i.length>=2)a=i.map(T=>({ts:T.ts,val:T.val}));else{if(!o.history)return d;for(let T of o.history)T.trigger_value!=null&&a.push({ts:new Date(T.timestamp).getTime(),val:T.trigger_value})}if(o.trigger_current_value!=null&&a.push({ts:Date.now(),val:o.trigger_current_value}),a.length<2)return d;a.sort((T,f)=>T.ts-f.ts);let n=hi,p=ui,c=a.map(T=>T.val),h=Math.min(...c),g=Math.max(...c),v=g-h||1;h-=v*.1,g+=v*.1;let _=a[0].ts,w=a[a.length-1].ts-_||1,S=T=>(T-_)/w*n,O=T=>2+(1-(T-h)/(g-h))*(p-4),k=a;if(k.length>Ne){let T=Math.ceil(k.length/Ne);k=k.filter((f,K)=>K%T===0||K===k.length-1)}let P=k.map(T=>`${S(T.ts).toFixed(1)},${O(T.val).toFixed(1)}`).join(" "),ct=o.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return r`
    <svg class="mini-sparkline" viewBox="0 0 ${n} ${p}" preserveAspectRatio="none" role="img" aria-label="${s("chart_mini_sparkline",t)}">
      <polyline points="${P}" fill="none" stroke="${ct}" stroke-width="1.5" stroke-linejoin="round" />
    </svg>
  `}function Be(o,l){let t=l;if(o.days_until_due==null||!o.interval_days||o.interval_days<=0)return d;let{pct:e,overflow:i}=Ut(o.interval_days,o.days_until_due,o.interval_unit),a="var(--success-color, #4caf50)";return o.status==="overdue"?a="var(--error-color, #f44336)":o.status==="due_soon"&&(a="var(--warning-color, #ff9800)"),r`
    <div class="days-progress">
      <div class="days-progress-labels">
        <span>${o.last_performed?`${s("last_performed",t)}: ${B(o.last_performed,t)}`:""}</span>
        <span>${o.next_due?`${s("next_due",t)}: ${B(o.next_due,t)}`:""}</span>
      </div>
  ...
  `}function Rt(o,l,t=4){if(!isFinite(o)||!isFinite(l))return{ticks:[],niceMin:0,niceMax:1};if(o===l){let h=Math.abs(o)*.1||1;o-=h,l+=h}let e=l-o,i=Math.pow(10,Math.floor(Math.log10(e/Math.max(1,t)))),a=i;for(let h of[1,2,5,10])if(a=i*h,e/a<=t+.5)break;let n=Math.floor(o/a)*a,p=Math.ceil(l/a)*a,c=[];for(let h=n;h<=p+a*1e-6;h+=a)c.push(Math.abs(h)<a*1e-9?0:h);return{ticks:c,niceMin:n,niceMax:p}}function ut(o){let l=Math.abs(o);return l>=1e6?jt((o/1e6).toFixed(l>=1e7?0:1))+"M":l>=1e4?jt((o/1e3).toFixed(0))+"k":l>=1e3?jt((o/1e3).toFixed(1))+"k":l>=100?o.toFixed(0):l>=10||l>=1?jt(o.toFixed(1)):l===0?"0":jt(o.toFixed(2))}function jt(o){return o.replace(/\.0+$/,"").replace(/(\.\d*[1-9])0+$/,"$1")}function wt(o,l,t){let e=o.toLocaleString(t,{maximumFractionDigits:Math.abs(o)>=100?0:1});return l?`${e} ${l}`:e}function St(o,l,t){let e=new Date(o),i=t?{month:"short",day:"numeric",year:"2-digit"}:{month:"short",day:"numeric"};return e.toLocaleDateString(l,i)}function re(o,l){return new Date(o).toLocaleDateString(l,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}function Yt(o,l){return new Date(o).getFullYear()!==new Date(l).getFullYear()}function Gt(o,l,t){if(t<2||l<=o)return[o,l];let e=[];for(let i=0;i<t;i++)e.push(o+(l-o)*i/(t-1));return e}var Kt=210,lt=46,gt=14,mt=12,Ue=14,gi=20+Ue,mi=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],H=class extends C{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(t=>{let e=Math.floor(t[0]?.contentRect?.width||0);e&&Math.abs(e-this._width)>2&&(this._width=e)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(t){t!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:t},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let t=this._width||320,e=[...this.points].sort((a,n)=>a.ts-n.ts),i=this.lang;return r`
    ...
    `}_renderSvg(t,e){let i=this.lang,a=t-lt-gt,n=Kt-gi,p=n-mt,c=1/0,h=-1/0;for(let b of e)c=Math.min(c,b.min??b.val),h=Math.max(h,b.max??b.val);this.thresholdAbove!=null&&(c=Math.min(c,this.thresholdAbove),h=Math.max(h,this.thresholdAbove)),this.thresholdBelow!=null&&(c=Math.min(c,this.thresholdBelow),h=Math.max(h,this.thresholdBelow)),this.targetValue!=null&&(c=Math.min(c,this.targetValue),h=Math.max(h,this.targetValue)),this.forceZero&&(c=Math.min(c,0));let g=(h-c||1)*.06,v=this.forceZero&&c>=0?0:c-g,{ticks:_,niceMin:y,niceMax:w}=Rt(v,h+g,4);this.forceZero&&c>=0&&y<0&&(y=0,_=_.filter(b=>b>=0));let S=e[0].ts,O=this.projection&&this.projection.length===2?this.projection[1].ts:null,k=O!=null?Math.max(e[e.length-1].ts,O):e[e.length-1].ts,P=k-S||1,ct=Yt(S,k),T=b=>lt+(b-S)/P*a,f=b=>mt+(1-(b-y)/(w-y||1))*p,K=e.map(b=>`${T(b.ts).toFixed(1)},${f(b.val).toFixed(1)}`).join(" "),tt=`M${T(e[0].ts).toFixed(1)},${n} `+e.map(b=>`L${T(b.ts).toFixed(1)},${f(b.val).toFixed(1)}`).join(" ")+` L${T(e[e.length-1].ts).toFixed(1)},${n} Z`,et="",ot=e.filter(b=>b.min!=null&&b.max!=null);if(ot.length>=2){let b=ot.map(Q=>`${T(Q.ts).toFixed(1)},${f(Q.max).toFixed(1)}`),E=[...ot].reverse().map(Q=>`${T(Q.ts).toFixed(1)},${f(Q.min).toFixed(1)}`);et=`M${b[0]} `+b.slice(1).map(Q=>`L${Q}`).join(" ")+` L${E.join(" L")} Z`}let U=[];if(this.thresholdBelow!=null){let b=f(this.thresholdBelow);U.push({y:b,h:Math.max(0,n-b),lineY:b,label:`\u25BC ${ut(this.thresholdBelow)}`,labelY:Math.min(n-4,b+13)})}if(this.thresholdAbove!=null){let b=f(this.thresholdAbove);U.push({y:mt,h:Math.max(0,b-mt),lineY:b,label:`\u25B2 ${ut(this.thresholdAbove)}`,labelY:Math.max(mt+11,b-5)})}let dt=e[e.length-1],yt=(this.events||[]).filter(b=>b.ts>=S&&b.ts<=k),xt=Gt(S,k,Math.max(2,Math.min(5,Math.floor(a/110)+1))),N=this._hover;return r`
      <div class="svg-holder">
        ...
        >
          <defs>
            <clipPath id="plot"><rect x="${lt}" y="${mt}" width="${a}" height="${p}" /></clipPath>
            ${U.length?F`<clipPath id="danger">${U.map(b=>F`<rect x="${lt}" y="${b.y.toFixed(1)}" width="${a}" height="${b.h.toFixed(1)}" />`)}</clipPath>`:d}
          ...
          ${_.map(b=>{let E=f(b);return E<mt-1||E>n+1?d:F`
              <line x1="${lt}" y1="${E.toFixed(1)}" x2="${t-gt}" y2="${E.toFixed(1)}"
                stroke="var(--divider-color)" stroke-width="1" opacity="0.6" />
              <text x="${lt-7}" y="${(E+3.5).toFixed(1)}" text-anchor="end" class="tick-label">${ut(b)}</text>`})}

          ${U.map(b=>F`<rect x="${lt}" y="${b.y.toFixed(1)}" width="${a}" height="${b.h.toFixed(1)}"
              fill="url(#dangerHatch)" />`)}

          ${et?F`<path d="${et}" fill="var(--primary-color)" opacity="0.08" clip-path="url(#plot)" />`:d}
          ...
          ${U.length?F`<polyline points="${K}" fill="none" stroke="var(--error-color, #f44336)" stroke-width="2"
                stroke-linejoin="round" stroke-linecap="round" clip-path="url(#danger)" />`:d}

          ${U.map(b=>F`
              <line x1="${lt}" y1="${b.lineY.toFixed(1)}" x2="${t-gt}" y2="${b.lineY.toFixed(1)}"
          ...
          ${this.targetValue!=null?F`<line x1="${lt}" y1="${f(this.targetValue).toFixed(1)}" x2="${t-gt}" y2="${f(this.targetValue).toFixed(1)}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
          ...
          ${this.projection&&this.projection.length===2?F`<line x1="${T(this.projection[0].ts).toFixed(1)}" y1="${f(this.projection[0].val).toFixed(1)}"
                x2="${Math.min(T(this.projection[1].ts),t-gt).toFixed(1)}" y2="${f(Math.max(y,Math.min(w,this.projection[1].val))).toFixed(1)}"
                stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.8" />`:d}

          ${xt.map((b,E)=>{let Q=T(b),Xe=E===0?"start":E===xt.length-1?"end":"middle";return F`<text x="${Q.toFixed(1)}" y="${Kt-5}" text-anchor="${Xe}" class="tick-label">${St(b,i,ct)}</text>`})}

          <line x1="${lt}" y1="${n}" x2="${t-gt}" y2="${n}" stroke="var(--divider-color)" stroke-width="1" />

          ${yt.map(b=>{let E=T(b.ts),Q=b.type==="completed"?"var(--success-color, #4caf50)":b.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return F`
              <line x1="${E.toFixed(1)}" y1="${mt}" x2="${E.toFixed(1)}" y2="${n}" stroke="${Q}" stroke-width="1" opacity="0.14" />
              <rect x="${(E-1.5).toFixed(1)}" y="${n+3}" width="3" height="${Ue-6}" rx="1.5" fill="${Q}">
                <title>${re(b.ts,i)}</title>
              </rect>`})}

          ${N?F`
                <line x1="${N.x.toFixed(1)}" y1="${mt}" x2="${N.x.toFixed(1)}" y2="${n}"
        ...
        ${N?r`<div
            ...
            >
              <div class="hover-date">${re(N.p.ts,i)}</div>
              <div class="hover-val">
                ${wt(N.p.val,this.unit,i)}
                ${N.p.min!=null&&N.p.max!=null?r`<span class="hover-range">(${ut(N.p.min)}–${ut(N.p.max)})</span>`:d}
              </div>
            </div>`:d}
      </div>
    `}_onPointer(t,e,i,a,n){let c=t.currentTarget.getBoundingClientRect(),h=(t.clientX-c.left)/c.width*n;if(h<lt-8||h>n-gt+8){this._hover=null;return}let g=e[0],v=1/0;for(let _ of e){let y=Math.abs(i(_.ts)-h);y<v&&(v=y,g=_)}this._hover={x:i(g.ts),y:a(g.val),p:g}}};H.styles=M`
  ...
  `,u([$({attribute:!1})],H.prototype,"points",2),u([$({attribute:!1})],H.prototype,"events",2),u([$()],H.prototype,"unit",2),u([$()],H.prototype,"lang",2),u([$({attribute:!1})],H.prototype,"thresholdAbove",2),u([$({attribute:!1})],H.prototype,"thresholdBelow",2),u([$({attribute:!1})],H.prototype,"targetValue",2),u([$({type:Boolean})],H.prototype,"forceZero",2),u([$({attribute:!1})],H.prototype,"projection",2),u([$({attribute:!1})],H.prototype,"rangeDays",2),u([$({type:Boolean})],H.prototype,"showRange",2),u([$({type:Boolean})],H.prototype,"busy",2),u([$({type:Boolean})],H.prototype,"hideOutliers",2),u([$({type:Boolean})],H.prototype,"showOutlierToggle",2),u([m()],H.prototype,"_width",2),u([m()],H.prototype,"_hover",2);customElements.get("maintenance-trigger-chart")||customElements.define("maintenance-trigger-chart",H);function _i(o){if(o.length<4)return o;let l=o.map(h=>h.val).sort((h,g)=>h-g),t=h=>{let g=(l.length-1)*h,v=Math.floor(g),_=Math.ceil(g);return l[v]+(l[_]-l[v])*(g-v)},e=t(.25),i=t(.75),a=i-e;if(a===0)return o;let n=e-1.5*a,p=i+1.5*a,c=o.filter(h=>h.val>=n&&h.val<=p);return c.length>=2?c:o}function Ve(o,l){let t=o.trigger_config;if(!t)return d;let e=l.lang,i=o.trigger_entity_info,a=o.trigger_entity_infos,n=i?.friendly_name||t.entity_id||"\u2014",p=t.entity_id||"",c=t.entity_ids||(p?[p]:[]),h=i?.unit_of_measurement||"",g=o.trigger_current_value,v=t.type||"threshold",_=c.length>1,y=vi(o,h,l);return r`
    <h3>${s("trigger",e)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${_?r`
            ...
            <div class="trigger-entity-id">${c.map((w,S)=>r`${S>0?", ":""}<span class="entity-link" @click=${O=>Mt(O,w)}>${w}</span>`)}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `:r`
      ...
      <div class="trigger-limits">
        ...
        ${v==="compound"?r`
          ...
          ${(t.conditions||[]).map((w,S)=>r`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${S+1}. ${s(w.type||"unknown",e)}: ${w.entity_id?r`<span class="entity-link" @click=${O=>Mt(O,w.entity_id)}>${w.entity_id}</span>`:""}</span>
          `)}
        `:d}
      </div>
      ...
      ${a&&a.length>1?r`
        <div class="trigger-entity-list">
          ${a.map(w=>r`
            <span class="trigger-entity-id">${w.friendly_name} (<span class="entity-link" @click=${S=>Mt(S,w.entity_id)}>${w.entity_id}</span>)</span>
          `)}
        </div>
      `:d}
  ...
  `}function vi(o,l,t){let e=o.trigger_config,i=o.trigger_current_value;if(!e||i==null)return null;switch(e.type||"threshold"){case"counter":{let a=e.trigger_target_value;if(a==null||a<=0)return null;if(!e.trigger_delta_mode)return{progress:Math.max(0,i),target:a,unit:l,meter:null};let n=qe(o,We(o,t));return{progress:Math.max(0,i-(n?.value??i)),target:a,unit:l,meter:i}}case"state_change":{let a=e.trigger_target_changes;return a==null||a<=0?null:{progress:Math.max(0,i),target:a,unit:"",meter:null}}case"runtime":{let a=e.trigger_runtime_hours;return a==null||a<=0?null:{progress:Math.max(0,i),target:a,unit:"h",meter:null}}}return null}function qe(o,l){if(o.trigger_baseline_value!=null)return{value:o.trigger_baseline_value,ts:oe(o)};if(!l.length)return null;let t=oe(o);if(t==null)return{value:l[0].val,ts:null};let e=l[0],i=Math.abs(l[0].ts-t);for(let a of l){let n=Math.abs(a.ts-t);n<i&&(e=a,i=n)}return{value:e.val,ts:t}}function oe(o){let l=[...o.history].filter(t=>t.type==="completed"||t.type==="reset").sort((t,e)=>new Date(e.timestamp).getTime()-new Date(t.timestamp).getTime())[0];return l?new Date(l.timestamp).getTime():null}function bi(o,l){let t=Math.min(999,Math.round(o.progress/o.target*100)),e=t>=100?"over":t>=75?"near":"ok";return r`
  ...
  `}function We(o,l){let t=o.trigger_config;if(!t)return[];let e=t.type||"threshold",i=t.entity_id||"",a=e==="runtime"?[]:l.detailStatsData.get(i)||[],n=l.isCounterEntity(t),p=[];if(a.length>=2)for(let h of a){let g={ts:h.ts,val:h.val};!n&&h.min!=null&&h.max!=null&&(g.min=h.min,g.max=h.max),p.push(g)}else for(let h of o.history)h.trigger_value!=null&&p.push({ts:new Date(h.timestamp).getTime(),val:h.trigger_value});let c=!!i&&!!l.historyFallbackIds?.has(i)&&a.length>=2;return o.trigger_current_value!=null&&!c&&p.push({ts:Date.now(),val:o.trigger_current_value}),p.sort((h,g)=>h.ts-g.ts),p}function fi(o,l,t){let e=o.trigger_config;if(!e)return d;let i=e.type||"threshold",a=e.entity_id||"",n=We(o,t);i==="runtime"&&e.trigger_runtime_hours&&o.trigger_current_value!=null&&(n=[{ts:oe(o)??n[0]?.ts??Date.now()-864e5,val:0},{ts:Date.now(),val:Math.max(0,o.trigger_current_value)}]),t.hideOutliers&&(n=_i(n));let p=n.length<2&&!!a&&t.hasStatsService&&!t.detailStatsData.has(a);if(n.length<2&&!p)return d;let c=!!a&&t.detailStatsData.has(a)&&(t.detailStatsData.get(a)?.length??0)<2,h=Date.now()-t.rangeDays*864e5,g=n.filter(k=>k.ts>=h);g.length>=2&&(n=g);let v=null,_=!1;if(i==="counter"&&e.trigger_target_value!=null&&n.length){if(e.trigger_delta_mode){let k=qe(o,n);if(k){if(k.ts!=null){let P=n.filter(ct=>ct.ts>=k.ts);P.length>=2&&(n=P)}n=n.map(P=>({...P,val:Math.max(0,P.val-k.value)}))}}v=e.trigger_target_value,_=!0}else i==="state_change"&&e.trigger_target_changes?(v=e.trigger_target_changes,_=!0):i==="runtime"&&e.trigger_runtime_hours&&(v=e.trigger_runtime_hours,_=!0);let y=null,w=o.degradation_rate,S=w!=null&&(e.trigger_below!=null&&e.trigger_above==null&&w>0||e.trigger_above!=null&&e.trigger_below==null&&w<0);if(v==null&&w!=null&&!S&&(o.degradation_trend!=="stable"||o.days_until_threshold!=null)&&o.degradation_trend!=="insufficient_data"&&n.length>=2){let k=n[n.length-1];y=[k,{ts:k.ts+30*864e5,val:k.val+w*30}]}let O=o.history.filter(k=>["completed","skipped","reset"].includes(k.type)).map(k=>({ts:new Date(k.timestamp).getTime(),type:k.type}));return r`
    ...
    ></maintenance-trigger-chart>
    ${p?d:a&&t.historyFallbackIds?.has(a)&&!c?r`<div class="chart-note">
          <ha-icon icon="mdi:information-outline"></ha-icon>
          ${s("chart_history_fallback",t.lang)}
        </div>`:c?r`<div class="chart-note">
          <ha-icon icon="mdi:information-outline"></ha-icon>
          ${s("chart_no_stats",t.lang)}
        </div>`:d}
  `}var yi=200,At=10,xi=22;function Ye(o,l,t,e){let i=o.history.filter(p=>p.type==="completed"&&(p.cost!=null||p.duration!=null));if(i.length<2)return d;let a=i.some(p=>(p.cost??0)>0),n=i.some(p=>(p.duration??0)>0);return!a&&!n?d:r`
  ...
  `}function $i(o,l,t){let e=o.history.filter(b=>b.type==="completed"&&(b.cost!=null||b.duration!=null)).map(b=>({ts:new Date(b.timestamp).getTime(),cost:b.cost??0,duration:b.duration??0})).sort((b,E)=>b.ts-E.ts);if(e.length<2)return d;let i=e.some(b=>b.cost>0),a=e.some(b=>b.duration>0);if(!i&&!a)return d;let n=t!=="duration"&&i,p=t!=="cost"&&a,c=n||!p&&i,h=p||!n&&a,g=640,v=yi,_=c?44:12,y=h?44:12,w=g-_-y,S=v-xi,O=S-At,k=e[0].ts,P=e[e.length-1].ts,ct=(P-k||864e5)*.05,T=k-ct,f=P+ct,K=Yt(k,P),tt=b=>_+(b-T)/(f-T)*w,et=Rt(0,Math.max(...e.map(b=>b.cost))||1,3),ot=Rt(0,Math.max(...e.map(b=>b.duration))||1,3),U=b=>At+(1-b/(et.niceMax||1))*O,dt=b=>At+(1-b/(ot.niceMax||1))*O,yt=e.length>1?Math.min(...e.slice(1).map((b,E)=>tt(b.ts)-tt(e[E].ts))):w,xt=Math.max(6,Math.min(22,yt*.55)),N=Gt(k,P,Math.max(2,Math.min(4,e.length)));return r`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${g} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_history",l)}">
        ${c?et.ticks.map(b=>{let E=U(b);return E<At-1||E>S+1?d:F`
            <line x1="${_}" y1="${E.toFixed(1)}" x2="${g-y}" y2="${E.toFixed(1)}" stroke="var(--divider-color)" stroke-width="1" opacity="0.55" />
            <text x="${_-6}" y="${(E+3.5).toFixed(1)}" text-anchor="end" fill="var(--primary-color)" font-size="10.5">${ut(b)}€</text>`}):d}
        ${h?ot.ticks.map(b=>{let E=dt(b);return E<At-1||E>S+1?d:F`<text x="${g-y+6}" y="${(E+3.5).toFixed(1)}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="10.5">${ut(b)}m</text>`}):d}

        ${c?e.filter(b=>b.cost>0).map(b=>F`
          <rect x="${(tt(b.ts)-xt/2).toFixed(1)}" y="${U(b.cost).toFixed(1)}" width="${xt.toFixed(1)}" height="${(S-U(b.cost)).toFixed(1)}"
            fill="var(--primary-color)" opacity="0.6" rx="2">
            <title>${St(b.ts,l,!0)}: ${b.cost.toLocaleString(l)}€${b.duration?` \xB7 ${b.duration}m`:""}</title>
          </rect>
        `):d}
        ${h?F`
          <polyline points="${e.map(b=>`${tt(b.ts).toFixed(1)},${dt(b.duration).toFixed(1)}`).join(" ")}"
            fill="none" stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-linejoin="round" />
          ${e.map(b=>F`
            <circle cx="${tt(b.ts).toFixed(1)}" cy="${dt(b.duration).toFixed(1)}" r="3.5" fill="var(--accent-color, #ff9800)">
              <title>${St(b.ts,l,!0)}: ${b.duration}m${b.cost?` \xB7 ${b.cost.toLocaleString(l)}\u20AC`:""}</title>
            </circle>
          `)}
        `:d}

        <line x1="${_}" y1="${S}" x2="${g-y}" y2="${S}" stroke="var(--divider-color)" stroke-width="1" />
        ${N.map((b,E)=>{let Q=E===0?"start":E===N.length-1?"end":"middle";return F`<text x="${tt(b).toFixed(1)}" y="${v-6}" text-anchor="${Q}" fill="var(--secondary-text-color)" font-size="10">${St(b,l,K)}</text>`})}
      </svg>
    </div>
  ...
  `,u([$({attribute:!1})],ft.prototype,"hass",2),u([$()],ft.prototype,"docId",2),u([m()],ft.prototype,"_url",2),u([m()],ft.prototype,"_failed",2);customElements.get("maintenance-history-photo")||customElements.define("maintenance-history-photo",ft);var wi=["completed","skipped","missed","reset","triggered","trigger_replaced","trigger_removed"];function Ge(o,l){let t=l.lang;return r`
  ...
  `}function Ke(o,l){let t=l.lang,e=l.filter?o.history.filter(i=>i.type===l.filter):o.history;if(l.search){let i=l.search.toLowerCase();e=e.filter(a=>a.notes?.toLowerCase().includes(i))}return e.length===0?r`<p class="empty">${s("no_history",t)}</p>`:r`
    <div class="history-timeline">
      ${[...e].reverse().map(i=>ki(i,l))}
    </div>
  `}function ki(o,l){let t=l.lang,e=["completed","reset","skipped"].includes(o.type);return r`
  ...
  `}function ne(o,l){if(!o.responsible_user_id)return d;let t=l(o.responsible_user_id);return t?r`
    <span class="user-badge">
      <ha-icon icon="mdi:account"></ha-icon>
      ${t}
    </span>
  `:d}function Ti(o,l){let t=l.lang,e=l.isOperator,i=o.archived?"archived":o.is_done?"done":o.status==="due_soon"?"warning":o.status||"ok",a=o.archived?s("archived",t):o.is_done?s("completed",t):s(o.status||"ok",t);return r`
    <div class="task-header">
      <div class="task-header-title">
        ...
        ${o.due_override?r`<span class="postponed-badge" title="${s("postponed_to",t)}">
          <ha-icon icon="mdi:calendar-arrow-right"></ha-icon>${B(o.due_override,t)}
        </span>`:d}
        ${ne(o,l.getUserName)}
  ...
  `}function ji(o){let l=o.lang;return r`
    <div class="tab-bar">
  ...
  `}function Qe(o,l,t,e){let i=e.collapsedSections.has(o);return r`
  ...
  `}function Si(o,l){if(!be(o))return d;let t=l.lang,e=o.phase_sequence,i=ve(o.phase_cursor,e.length),a=new Map;for(let n=o.history.length-1;n>=0;n--){let p=o.history[n];p.phase_id&&p.type==="completed"&&!a.has(p.phase_id)&&a.set(p.phase_id,p.timestamp)}return r`
    <div class="phases-card">
      ...
      <div class="phases-strip">
        ${e.map((n,p)=>{let c=o.phases?.[n]?.name||n,h=a.get(n);return r`
            <div class="phase-step ${p===i?"current":""}"
              ...
              ${h?r`<span class="phase-step-last">${B(h,t)}</span>`:d}
            </div>
          `})}
      </div>
    </div>
  `}function Ei(o,l){if(!l.features.checklists)return d;let t=Dt(o)?.checklist??(o.checklist||[]);if(t.length===0)return d;let e=l.lang,i=o.checklist_progress||{},a=t.filter(n=>i[n]).length;return r`
  ...
  `}function Mi(o,l){let t=q(o.documentation_url)?o.documentation_url:null,e=q(l.objectDocUrl)?l.objectDocUrl:null,i=e?null:(l.objectManualDocs||[])[0];if(!o.notes&&!t&&!e&&!i)return d;let a=l.lang;return r`
  ...
  `}function Ci(o,l){let t=l.lang,e=o.times_performed>0?o.total_cost/o.times_performed:0,i=o.days_until_due!==null&&o.days_until_due!==void 0?o.days_until_due<0?"overdue":o.days_until_due<=o.warning_days?"warning":"":"";return r`
    <div class="kpi-bar">
      <div class="kpi-card">
        <div class="kpi-label">${s("next_due",t)}</div>
        <div class="kpi-value">${o.next_due?B(o.next_due,t):"\u2014"}</div>
      ...
      <div class="kpi-card">
        ...
        <div class="kpi-value">${o.last_performed?B(o.last_performed,t):"\u2014"}</div>
      </div>
      <div class="kpi-card">
  ...
  `}function Di(o,l){let t=l.lang;if(!l.features.adaptive||!o.suggested_interval||o.suggested_interval===o.interval_days)return d;if(l.suggestionDismissed)return d;let e=o.suggested_interval;return r`
  ...
  `}function Oi(o,l){let t=l.lang,e=o.history.slice(-3).reverse();if(e.length===0)return d;let i=a=>{switch(a){case"completed":return"\u2713";case"triggered":return"\u2297";case"skipped":return"\u21B7";case"reset":return"\u21BA";default:return"\xB7"}};return r`
  ...
  `}function Ri(o,l){let t=l.lang,e=l.features.adaptive&&o.suggested_interval&&o.suggested_interval!==o.interval_days,i=l.features.seasonal&&o.seasonal_factor&&o.seasonal_factor!==1,a=e||i,n=l.features.adaptive&&o.interval_analysis?.weibull_beta!=null&&o.interval_analysis?.weibull_eta!=null,p=l.features.seasonal&&(o.seasonal_factors?.length===12||o.interval_analysis?.seasonal_factors?.length===12);return r`
    <div class="tab-content overview-tab">
      ...
      <div class="two-column-layout ${a?"":"single-column"}">
        ...
        <div class="right-column">
          ${Ye(o,t,l.costDurationToggle,c=>l.setCostDurationToggle(c))}
        </div>
      </div>
      ${n?Qe("weibull","weibull_reliability_curve",ke(o,t),l):d}
  ...
  `}function Ai(o,l){return r`
    <div class="tab-content history-tab">
      ${Ge(o,l.history)}
      ${Ke(o,l.history)}
    </div>
  `}function zi(o,l){switch(l.activeTab){case"overview":return Ri(o,l);case"history":return Ai(o,l);default:return d}}function Ze(o,l){return r`
  ...
  `}var zt=class extends C{createRenderRoot(){return this}render(){return!this.task||!this.ctx?d:r`${Ze(this.task,this.ctx)}`}};u([$({attribute:!1})],zt.prototype,"task",2),u([$({attribute:!1})],zt.prototype,"ctx",2);customElements.get("maintenance-task-detail-view")||customElements.define("maintenance-task-detail-view",zt);function Je(o){if(o.total<=0)return{start:0,end:0,padTop:0,padBottom:0};let l=o.overscan??12,t=Math.max(1,o.step??6),e=Math.max(1,o.rowHeight),i=Math.floor((o.scrollTop-o.listTop)/e),a=Math.ceil(o.viewportHeight/e)+1,n=Math.max(0,i-l);n=Math.floor(n/t)*t;let p=Math.min(o.total,Math.max(i,0)+a+l);return p=Math.min(o.total,Math.ceil(p/t)*t),n>=p&&(n=Math.min(n,Math.max(0,o.total-1)),p=Math.min(o.total,n+Math.max(a,1))),{start:n,end:p,padTop:n*e,padBottom:(o.total-p)*e}}var x=class extends C{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._allParts=null;this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._filterLabel=null;this._filterPriority="";this._savedViews=[];this._activeViewId="";this._unsub=null;this._chartRangeDays=(()=>{try{let t=parseInt(Z(R.chartRange)||"",10);return[7,30,90,365].includes(t)?t:30}catch{return 30}})();this._hideOutliers=(()=>{try{return Z(R.chartHideOutliers)==="1"}catch{return!1}})();this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._operatorWriteEnabled=!1;this._defaultWarningDays=7;this._actionLoading=!1;this._moreMenuOpen=!1;this._objMenuOpen=!1;this._toastMessage="";this._toastUndo=null;this._toastActionLabel="";this._filtersOpen=!1;this._newMenuOpen=!1;this._gsSetupsCount=0;this._gsAdoptCount=0;this._gsLoaded=!1;this._batteryFleetSetupAvailable=!1;this._staleBundle=!1;this._staleChecked=!1;this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab=(()=>{try{let t=Z(R.overviewTab);return t==="today"||t==="calendar"?t:"dashboard"}catch{return"dashboard"}})();this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._objectViewMode="cards";this._objectsTableColumns=ge;this._showArchived=!1;this._bulkMode=!1;this._bulkSelected=new Set;this._virtStart=0;this._virtEnd=0;this._virtRowHeight=53;this._virtTotalRows=0;this._virtScrollAttached=!1;this._virtRaf=0;this._collapsedSections=(()=>{try{return new Set(JSON.parse(Z(R.collapsedSections)||"[]"))}catch{return new Set}})();this._paletteOpen=!1;this._paletteQuery="";this._paletteActive=0;this._templateGalleryOpen=!1;this._templates=[];this._templateCategories={};this._templateBusy=!1;this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=t=>this._onPopState(t);this._lazyUi=null;this._onVirtualScroll=()=>{this._virtRaf||(this._virtRaf=requestAnimationFrame(()=>{this._virtRaf=0,this._updateVirtualWindow()}))};this._deepLinkHandled=!1;this._paletteKeydown=t=>{if(t.key==="/"&&!t.ctrlKey&&!t.metaKey&&!t.altKey&&!this._paletteOpen){let i=t.composedPath()[0];if(i instanceof HTMLElement&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.tagName==="SELECT"||i.isContentEditable))return;t.preventDefault(),this._openPalette();return}if(!this._paletteOpen)return;let e=this._paletteResults;if(t.key==="Escape")t.preventDefault(),this._closePalette();else if(t.key==="ArrowDown")t.preventDefault(),this._paletteActive=Math.min(this._paletteActive+1,e.length-1);else if(t.key==="ArrowUp")t.preventDefault(),this._paletteActive=Math.max(this._paletteActive-1,0);else if(t.key==="Enter"){t.preventDefault();let i=e[this._paletteActive];i&&this._selectPaletteResult(i)}};this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=t=>{let e=t.detail;e?.type==="maintenance-supporter:open-task"&&e.entry_id&&e.task_id&&(t.stopPropagation(),this._showTask(e.entry_id,e.task_id))};this._fullHistory=null;this._onHistoryEntrySaved=async()=>{await this._loadData()}}get _currencySymbol(){return this._budget?.currency_symbol||Pt}get _lang(){return L(this.hass)}get _isOperator(){let t=this.hass?.user;return t?t.is_admin?!1:!(this._operatorWriteEnabled&&this._adminPanelUserIds.includes(t.id)):!0}_ensureLazyUi(){return this._lazyUi||(this._lazyUi=Promise.all([import("/maintenance_supporter_panelfiles/panel-chunks/object-dialog-ORJIHG67.js"),import("/maintenance_supporter_panelfiles/panel-chunks/task-dialog-2OMDACBU.js"),import("/maintenance_supporter_panelfiles/panel-chunks/complete-dialog-P4OXXKCQ.js"),import("/maintenance_supporter_panelfiles/panel-chunks/qr-dialog-XFC2MRML.js"),import("/maintenance_supporter_panelfiles/panel-chunks/adopt-problem-sensors-dialog-NVVB4KGW.js"),import("/maintenance_supporter_panelfiles/panel-chunks/suggested-setups-dialog-O52MLH5U.js"),import("/maintenance_supporter_panelfiles/panel-chunks/settings-view-L6UJZGTZ.js")]).then(()=>this.updateComplete)),this._lazyUi}async _ui(t){return await this._ensureLazyUi(),this.shadowRoot?.querySelector(t)??null}connectedCallback(){super.connectedCallback();let t=window.requestIdleCallback,e=()=>this._ensureLazyUi();t?t(e,{timeout:3e3}):window.setTimeout(e,1500),window.addEventListener("popstate",this._popstateHandler),window.addEventListener("keydown",this._paletteKeydown),window.addEventListener("resize",this._onVirtualScroll,{passive:!0});try{let i=Z(R.taskSort);i&&["due_date","object","type","task_name","area","assigned_user","group"].includes(i)&&(this._sortMode=i);let a=Z(R.objectSort);a&&["alphabetical","due_soonest","task_count"].includes(a)&&(this._objectSortMode=a);let n=Z(R.groupBy);n&&["none","area","group","user"].includes(n)&&(this._groupByMode=n);let p=Z(R.objectView);(p==="cards"||p==="table")&&(this._objectViewMode=p)}catch{}if(this._objects.length===0){let i=Oe();i&&(this._objects=i.objects,i.stats&&(this._stats=i.stats))}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),window.removeEventListener("keydown",this._paletteKeydown),window.removeEventListener("resize",this._onVirtualScroll),this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onVirtualScroll),this._virtScrollAttached=!1,this._virtRaf&&cancelAnimationFrame(this._virtRaf),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(t){if(super.updated(t),Ft(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Vt(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new ye(this.hass),this._userService.getUsers())}let e=this.shadowRoot?.querySelector(".content");e&&!this._virtScrollAttached&&(e.addEventListener("scroll",this._onVirtualScroll,{passive:!0}),this._virtScrollAttached=!0),this._updateVirtualWindow()}_updateVirtualWindow(){let t=this.shadowRoot?.querySelector(".content"),e=this.shadowRoot?.querySelector(".task-table.virtual");if(!t||!e)return;let i=e.querySelector(".task-row:not(.virt-sizer)");i&&i.offsetHeight>20&&(this._virtRowHeight=i.offsetHeight);let a=e.getBoundingClientRect().top-t.getBoundingClientRect().top+t.scrollTop,n=Je({scrollTop:t.scrollTop,viewportHeight:t.clientHeight,listTop:a,rowHeight:this._virtRowHeight,total:this._virtTotalRows});(n.start!==this._virtStart||n.end!==this._virtEnd)&&(this._virtStart=n.start,this._virtEnd=n.end)}async _loadData(){let[t,e,i,a,n,p]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"}).catch(()=>null)]);if(p&&(this._savedViews=p.views||[]),t&&(this._objects=Ot(t.objects),te(this._objects,e??this._stats??null),this._maybeLoadGettingStarted()),this._view==="task"&&this._selectedEntryId&&this._selectedTaskId&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/status"}).then(c=>{this._batteryFleetSetupAvailable=!!c.available&&!c.configured}).catch(()=>{this._batteryFleetSetupAvailable=!1}),this._staleChecked||(this._staleChecked=!0,this.hass.connection.sendMessagePromise({type:"maintenance_supporter/version"}).then(c=>{this._staleBundle=le(c?.version)}).catch(()=>{})),e&&(this._stats=e),i&&(this._budget=i),a&&(this._groups=a.groups||{}),n){let c=n;this._features=c.features,this._adminPanelUserIds=c.admin_panel_user_ids||[],this._operatorWriteEnabled=c.operator_write_enabled??!1;let h=c.general?.default_warning_days;typeof h=="number"&&h>=0&&h<=365&&(this._defaultWarningDays=h),this._objectsTableColumns=me(c.objects_table_columns)}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let t=new URLSearchParams(window.location.search),e=t.get("ms_action"),i=()=>{let g=window.location.pathname+window.location.hash;history.replaceState(history.state,"",g)};if(e==="add_object"){this._deepLinkHandled=!0,i(),this._ui("maintenance-object-dialog").then(g=>g?.openCreate());return}if(e==="open_vacation"||e==="open_budget"||e==="open_groups"||e==="open_settings"){this._deepLinkHandled=!0,i(),this._overviewTab="settings",this._ensureLazyUi().then(()=>requestAnimationFrame(()=>{let g=this.shadowRoot?.querySelector("maintenance-settings-view"),v=e.replace("open_","");g?.scrollToSection?.(v)}));return}let a=t.get("entry_id");if(!a)return;this._deepLinkHandled=!0;let n=t.get("task_id"),p=t.get("action"),c=window.location.pathname+window.location.hash;history.replaceState(history.state,"",c);let h=this._getObject(a);if(!h){this._showOverview();return}if(n){let g=h.tasks.find(v=>v.id===n);if(!g){this._showObject(a);return}this._showTask(a,n),p==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(a,n,g.name,this._features.checklists?g.checklist:void 0,this._features.adaptive&&!!g.adaptive_config?.enabled)}):p==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(a,n,g)})}else this._showObject(a)}_isCounterEntity(t){if(!t)return!1;let e=t.type||"threshold";return e==="counter"||e==="state_change"}async _fetchDetailStats(t,e){if(!this._statsService)return;let i=await this._statsService.getDetailStats(t,e,this._chartRangeDays),a=new Map(this._detailStatsData);a.set(t,i),this._detailStatsData=a}_setChartRange(t){if(t===this._chartRangeDays)return;this._chartRangeDays=t;try{V(R.chartRange,String(t))}catch{}let e=this._selectedEntryId&&this._selectedTaskId?this._getTask(this._selectedEntryId,this._selectedTaskId):null,i=e?.trigger_config?.entity_id;if(i){let a=new Map(this._detailStatsData);a.delete(i),this._detailStatsData=a,this._fetchDetailStats(i,this._isCounterEntity(e.trigger_config))}}_setHideOutliers(t){if(t!==this._hideOutliers){this._hideOutliers=t;try{V(R.chartHideOutliers,t?"1":"0")}catch{}}}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let t=[];for(let i of this._objects)for(let a of i.tasks){let n=a.trigger_config?.entity_id;n&&t.push({entityId:n,isCounter:this._isCounterEntity(a.trigger_config)})}if(t.length===0)return;let e=await this._statsService.getBatchMiniStats(t);this._miniStatsData=new Map([...this._miniStatsData,...e])}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e,a=De(this._objects,i);a!==null&&(this._objects=a,e.objects&&te(a,this._stats??null))},{type:"maintenance_supporter/subscribe",deltas:!0,compact:!0});if(!this.isConnected){t();return}this._unsub=t}catch{}}get _taskRows(){let t=[];for(let v of this._objects)for(let _ of v.tasks){if(!this._showArchived&&_.archived||this._filterStatus&&_.status!==this._filterStatus)continue;if(this._filterUser){let w=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(_.responsible_user_id!==w)continue}if(this._filterLabel&&!(_.labels||[]).includes(this._filterLabel)||this._filterPriority&&(_.priority||"normal")!==this._filterPriority)continue;let y=[];for(let w of Object.values(this._groups))w.task_refs?.some(S=>S.entry_id===v.entry_id&&S.task_id===_.id)&&y.push(w.name);t.push({entry_id:v.entry_id,task_id:_.id,object_name:v.object.name,task_name:_.name,type:_.type,schedule_type:_.schedule_type,status:_.status,days_until_due:_.days_until_due??null,next_due:_.next_due??null,trigger_active:_.trigger_active,trigger_current_value:_.trigger_current_value??null,trigger_current_delta:_.trigger_current_delta??null,trigger_config:_.trigger_config??null,trigger_entity_info:_.trigger_entity_info??null,times_performed:_.times_performed,total_cost:_.total_cost,interval_days:_.interval_days??null,interval_unit:_.interval_unit??null,interval_anchor:_.interval_anchor??null,is_done:_.is_done??!1,archived:_.archived??!1,history:_.history||[],enabled:_.enabled,nfc_tag_id:_.nfc_tag_id??null,priority:_.priority??"normal",labels:_.labels??[],area_id:v.object.area_id??null,responsible_user_id:_.responsible_user_id??null,group_names:y})}let e={overdue:0,triggered:1,due_soon:2,ok:3},i=(v,_)=>(e[v.status]??9)-(e[_.status]??9),a=(v,_)=>(v.days_until_due??99999)-(_.days_until_due??99999),n=(v,_)=>i(v,_)||a(v,_),p=v=>v.area_id&&this.hass?.areas?.[v.area_id]?.name||"",c=v=>v.responsible_user_id&&this._userService?.getUserName(v.responsible_user_id)||"",h=v=>v.group_names[0]||"",g={due_date:n,object:(v,_)=>v.object_name.localeCompare(_.object_name)||n(v,_),type:(v,_)=>v.type.localeCompare(_.type)||n(v,_),task_name:(v,_)=>v.task_name.localeCompare(_.task_name),area:(v,_)=>{let y=p(v),w=p(_);return!y&&w?1:y&&!w?-1:y.localeCompare(w)||n(v,_)},assigned_user:(v,_)=>{let y=c(v),w=c(_);return!y&&w?1:y&&!w?-1:y.localeCompare(w)||n(v,_)},group:(v,_)=>{let y=h(v),w=h(_);return!y&&w?1:y&&!w?-1:y.localeCompare(w)||n(v,_)}};return t.sort(g[this._sortMode]),t}_getObject(t){return this._objects.find(e=>e.entry_id===t)}_getTask(t,e){return this._getObject(t)?.tasks.find(a=>a.id===e)}_pushPanelState(t,e,i){let a={msp_view:t,msp_entry:e||null,msp_task:i||null};history.pushState(a,"")}_onPopState(t){let e=t.state;if(e?.msp_view&&(this._view=e.msp_view,this._selectedEntryId=e.msp_entry||null,this._selectedTaskId=e.msp_task||null,this._moreMenuOpen=!1,e.msp_view==="all_parts"&&this._loadAllParts(),e.msp_view==="task"&&e.msp_entry&&e.msp_task)){this._historyFilter=null;let i=this._getTask(e.msp_entry,e.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop()}_showAllParts(){this._pushPanelState("all_parts"),this._view="all_parts",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop(),this._loadAllParts()}async _loadAllParts(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"});this._allParts=t.parts||[]}catch{this._allParts=[]}}_filterByStatus(t){this._filterStatus=t,this._activeViewId="",this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),this._scrollContentToTop()}get _allLabels(){let t=new Set;for(let e of this._objects)for(let i of e.tasks)for(let a of i.labels||[])t.add(a);return[...t].sort((e,i)=>e.localeCompare(i))}get _currentFilters(){return{status:this._filterStatus,user_id:this._filterUser,label:this._filterLabel,priority:this._filterPriority,archived:this._showArchived,sort_mode:this._sortMode,group_by:this._groupByMode}}_applyView(t){if(this._activeViewId=t,!t)return;let e=this._savedViews.find(a=>a.id===t);if(!e)return;let i=e.filters;this._filterStatus=i.status||"",this._filterUser=i.user_id||null,this._filterLabel=i.label||null,this._filterPriority=i.priority||"",this._showArchived=!!i.archived,["due_date","object","type","task_name","area","assigned_user","group"].includes(i.sort_mode)&&(this._sortMode=i.sort_mode),["none","area","group","user"].includes(i.group_by)&&(this._groupByMode=i.group_by);try{V(R.taskSort,this._sortMode),V(R.groupBy,this._groupByMode)}catch{}this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard")}_openSavedViewsDialog(){this.shadowRoot.querySelector("maintenance-saved-views-dialog")?.open(this._currentFilters,this._savedViews)}_onSavedViewsChanged(t){this._savedViews=t.detail.views||[],this._activeViewId&&!this._savedViews.some(e=>e.id===this._activeViewId)&&(this._activeViewId="")}_scrollContentToTop(){requestAnimationFrame(()=>{let t=this.shadowRoot?.querySelector(".content");t&&t.scrollTo({top:0,behavior:"smooth"})})}_showObject(t){this._pushPanelState("object",t),this._view="object",this._selectedEntryId=t,this._selectedTaskId=null,this._scrollContentToTop()}_showTask(t,e){this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._scrollContentToTop(),this._fetchFullHistory(t,e);let i=this._getTask(t,e);if(i?.trigger_config?.entity_id){let a=i.trigger_config.entity_id,n=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(a,n)}}_showToast(t){this._toastTimer&&clearTimeout(this._toastTimer),this._toastUndo=null,this._toastActionLabel="",this._toastMessage=t,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}_showActionToast(t,e,i){this._showUndoToast(t,i),this._toastActionLabel=e}_showUndoToast(t,e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastActionLabel="",this._toastMessage=t,this._toastUndo=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastUndo=null,this._toastTimer=null},7e3)}_runToastUndo(){let t=this._toastUndo;this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage="",this._toastUndo=null,this._toastTimer=null,t?.()}_openPalette(){this._paletteQuery="",this._paletteActive=0,this._paletteOpen=!0,this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".palette-input")?.focus()})}_closePalette(){this._paletteOpen=!1,this._paletteQuery=""}get _paletteResults(){let t=this._paletteQuery.trim().toLowerCase(),e=[];for(let i of this._objects){let a=i.object.name||"";(!t||a.toLowerCase().includes(t))&&e.push({kind:"object",entryId:i.entry_id,label:a,sub:s("object",this._lang)});for(let n of i.tasks){if(n.archived)continue;let p=n.name||"",c=(n.labels||[]).some(h=>h.toLowerCase().includes(t));if(!t||p.toLowerCase().includes(t)||a.toLowerCase().includes(t)||c){let h=(n.labels||[]).length?`  #${(n.labels||[]).join(" #")}`:"";e.push({kind:"task",entryId:i.entry_id,taskId:n.id,label:p,sub:a+h})}}if(e.length>60)break}return e.slice(0,40)}_selectPaletteResult(t){this._closePalette(),t.kind==="task"&&t.taskId?this._showTask(t.entryId,t.taskId):this._showObject(t.entryId)}_renderPalette(){if(!this._paletteOpen)return d;let t=this._lang,e=this._paletteResults;return r`
    ...
    `}_statusBadge(t,e,i){let a=this._lang,n=t?"archived":e?"done":i,p=t?"archived":e?"completed":i,c=t?s("archived",a):e?s("completed",a):s(i,a);return r`<span class="status-badge ${n}"><ha-icon icon="${It[p]||"mdi:circle-medium"}"></ha-icon>${c}</span>`}_setOverviewTab(t){this._overviewTab=t;try{V(R.overviewTab,t)}catch{}this._scrollContentToTop()}_renderToday(){let t=this._lang,e=this._taskRows,i=h=>`${h.entry_id}:${h.task_id}`,a=e.filter(h=>h.status==="overdue"||h.trigger_active),n=new Set(a.map(i)),p=e.filter(h=>!n.has(i(h))&&h.days_until_due===0);p.forEach(h=>n.add(i(h)));let c=e.filter(h=>!n.has(i(h))&&h.days_until_due!=null&&h.days_until_due>0&&h.days_until_due<=7);return a.length+p.length+c.length===0?r`
        ...
        ${e.map(n=>r`
          <div class="today-row" @click=${()=>this._showTask(n.entry_id,n.task_id)}>
            ...
            <div class="today-main">
              ...
              <div class="today-object">${n.object_name} · ${_t(n.days_until_due,a)}</div>
            </div>
    ...
    `}_renderDashboard(){let t=this._stats,e=this._taskRows,i=this._lang,a=this._isOperator,n=this._objects.reduce((c,h)=>c+h.tasks.filter(g=>g.archived).length,0),p=(this._filterStatus?1:0)+(this._filterUser?1:0)+(this._filterLabel?1:0)+(this._filterPriority?1:0)+(this._activeViewId?1:0);return r`
      ...
      <div class="filter-bar ${this.narrow&&!this._filtersOpen?"collapsed":""}">
        ...
        <label class="filter-field">
          ...
          <select
            ...
            @change=${c=>{this._sortMode=c.target.value,this._activeViewId="";try{V(R.taskSort,this._sortMode)}catch{}}}
          >
        ...
        <label class="filter-field">
          ...
          <select
            ...
            @change=${c=>{this._groupByMode=c.target.value,this._activeViewId="";try{V(R.groupBy,this._groupByMode)}catch{}}}
          >
    ...
    `}_renderTaskTable(t){let e=this._bulkMode?" bulk":"";if(this._virtTotalRows=t.length,this.narrow||t.length<120)return r`
      ...
      `;let i=t.length,a=this._virtRowHeight,n=Math.max(0,Math.min(this._virtStart,i)),p=this._virtEnd>0?Math.min(this._virtEnd,i):Math.min(i,40);p<n&&(n=0,p=Math.min(i,40));let c=n*a,h=(i-p)*a;return r`
      <div class="task-table${e} virtual">
        ${this._renderVirtSizerRow(t)}
        ${c>0?r`<div class="virt-spacer" style="height:${c}px"></div>`:d}
        ${t.slice(n,p).map(g=>this._renderOverviewRow(g))}
        ${h>0?r`<div class="virt-spacer" style="height:${h}px"></div>`:d}
      </div>
    `}_renderVirtSizerRow(t){let e=this._lang,i="",a=!1,n=!1,p=!1;for(let c of t){let h=c.archived?s("archived",e):c.is_done?s("completed",e):s(c.status,e);h.length>i.length&&(i=h),c.enabled||(a=!0),c.nfc_tag_id&&(n=!0),(c.priority==="high"||c.priority==="low")&&(p=!0)}return r`
      ...
      <div class="filter-bar">
        <label class="filter-field">
          ...
          <select
            ...
            @change=${g=>{this._objectSortMode=g.target.value;try{V(R.objectSort,this._objectSortMode)}catch{}}}
          >
        ...
        <label class="filter-field">
          ...
          <select
            .value=${this._groupByMode}
            @change=${g=>{this._groupByMode=g.target.value;try{V(R.groupBy,this._groupByMode)}catch{}}}
          >
    ...
    `}_setObjectViewMode(t){this._objectViewMode=t;try{V(R.objectView,t)}catch{}}_renderAllParts(){let t=this._lang,e=this._allParts,i=this._currencySymbol;return r`
      <div class="breadcrumb">
      ...
      ${e===null?r`<div class="empty-state">…</div>`:e.length===0?r`<div class="empty-state">${s("parts_section",t)}: 0</div>`:r`
        ...
        `}
    `}_exportPartsCsv(){let t=this._allParts||[],e=p=>{let c=p==null?"":String(p);return/[",\n;]/.test(c)?`"${c.replace(/"/g,'""')}"`:c},a=[["name","object","stock","unit","reorder_threshold","unit_cost","storage_location","vendor","used_by"].join(",")];for(let p of t)a.push([e(p.name),e(p.object_name),e(p.stock),e(p.unit),e(p.reorder_threshold),e(p.cost),e(p.storage_location),e(p.vendor),e(p.consumers.map(c=>`${c.object_name??""}/${c.task_name??c.task_id}\xD7${c.quantity}`).join(" | "))].join(","));let n=new Date().toISOString().slice(0,10);Zt(a.join(`
`),`maintenance_parts_${n}.csv`,"text/csv;charset=utf-8")}async _exportObjectsCsv(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects/csv"}),e=new Date().toISOString().slice(0,10);Zt(t.csv,`maintenance_objects_${e}.csv`,"text/csv;charset=utf-8")}catch{this._showToast(s("action_error",this._lang))}}_renderObjectsTable(t){let e=this._lang,i=this._objectsTableColumns;return r`
      <div class="objects-table-wrap">
        <table class="objects-table">
          <thead>
            <tr>
              ${i.map(a=>{let n=ue.find(c=>c.key===a),p=n&&n.key!=="actions"?s(n.labelKey,e):"";return r`<th class="oc-${a}">${p}</th>`})}
            </tr>
          </thead>
          <tbody>
            ${t.map(a=>r`
      ...
      <div class="groups-section">
        ...
        ${t.length===0?r`<div class="hint">${s("no_groups",e)}</div>`:r`
            <div class="groups-grid">
              ${t.map(([i,a])=>{let n=a.task_refs.map(p=>this._getTask(p.entry_id,p.task_id)?.name).filter(Boolean);return r`
                  <div class="group-card">
                    ...
                    <div class="group-card-tasks">
                      ${n.length>0?n.map(p=>r`<span class="group-task-chip">${p}</span>`):r`<span style="font-size:12px;color:var(--secondary-text-color)">${s("no_tasks_short",e)}</span>`}
                    </div>
                  </div>
                `})}
            </div>
    ...
    `}_renderOverviewRow(t){let e=this._lang,i=t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0,a=0,n=Lt.ok,p=!1;if(i&&t.days_until_due!==null){let _=Ut(t.interval_days,t.days_until_due,t.interval_unit);a=_.pct,p=_.overflow,t.status==="overdue"?n=Lt.overdue:t.status==="due_soon"&&(n=Lt.due_soon)}let c=t.area_id?this.hass?.areas?.[t.area_id]?.name:null,h=t.responsible_user_id?this._userService?.getUserName(t.responsible_user_id):null,g=t.group_names.length>0||c||h,v=this._bulkMode&&this._bulkSelected.has(this._bulkKey(t));return r`
      <div class="task-row${t.enabled?"":" task-disabled"}${v?" bulk-selected":""}">
        ...
        <span class="due-cell" @click=${()=>this._showTask(t.entry_id,t.task_id)}>
          ...
          ${i?r`<div class="days-bar"><div class="days-bar-fill${p?" overflow":""}" style="width:${a}%;background:${n}"></div></div>`:d}
    ...
    `}_openCompleteDialogForRow(t){let i=this._objects.find(a=>a.entry_id===t.entry_id)?.tasks.find(a=>a.id===t.task_id);this._openCompleteDialog(t.entry_id,t.task_id,t.task_name,this._features.checklists?i?.checklist:void 0,this._features.adaptive&&!!i?.adaptive_config?.enabled)}_renderObjectDetail(){if(!this._selectedEntryId)return d;let t=this._getObject(this._selectedEntryId);if(!t)return r`<p>Object not found.</p>`;let e=t.object,i=this._lang,a=this._isOperator,n=t.tasks.filter(c=>c.archived).length,p=t.tasks.filter(c=>this._showArchived||!c.archived);return r`
      <div class="detail-section">
        ...
        ${e.paused?r`<p class="meta paused-meta">
              <ha-icon icon="mdi:pause-circle-outline"></ha-icon>
              ${s("object_paused_badge",i)}${e.paused_until?r` — ${s("paused_until_label",i)} ${B(e.paused_until,i)}`:d}
            </p>`:d}
        ...
        ${q(e.documentation_url)?r`<p class="meta">${s("documentation_url_label",i)}:
        ...
        ${e.installation_date?r`<p class="meta">${s("installed",i)}: ${B(e.installation_date,i)}</p>`:d}
        ...
        ${t.tasks.length===0?r`<div class="empty-state-centered">
            ...
            </div>`:r`<div class="task-table">${[...p].sort((c,h)=>{let g={overdue:0,triggered:1,due_soon:2,ok:3};return(g[c.status]??9)-(g[h.status]??9)||(c.days_until_due??99999)-(h.days_until_due??99999)}).map(c=>r`
              <div class="task-row${c.enabled?"":" task-disabled"}">
                ...
                <span class="due-cell" @click=${()=>this._showTask(t.entry_id,c.id)}>
                  ...
                  ${c.trigger_config?se(c):d}
                  ${ae(c,this._miniStatsData,this._lang)}
                </span>
                <span class="row-actions">
