...
`;var Vi={days:1,weeks:7,months:30.4368,years:365.25};function St(n,r){return!n||n<=0?0:n*(Vi[r||"days"]??1)}function At(n,r,e){let t=St(n,e);if(t<=0||r==null)return{pct:0,overflow:!1};let i=(t-r)/t*100;return{pct:Math.max(0,Math.min(100,i)),overflow:i>100}}function jt(n,r=new Date){if(!n)return{kind:"none",days:null,date:null};let e=new Date(`${n}T00:00:00`);if(isNaN(e.getTime()))return{kind:"none",days:null,date:null};let t=Date.UTC(r.getFullYear(),r.getMonth(),r.getDate()),i=Date.UTC(e.getFullYear(),e.getMonth(),e.getDate()),a=Math.round((i-t)/864e5);return a<0?{kind:"expired",days:a,date:n}:a<=60?{kind:"expiring",days:a,date:n}:{kind:"valid",days:a,date:n}}var we=[{key:"name",labelKey:"name",required:!0},{key:"manufacturer",labelKey:"manufacturer"},{key:"model",labelKey:"model"},{key:"serial_number",labelKey:"serial_number_label"},{key:"installation_date",labelKey:"installed"},{key:"warranty_expiry",labelKey:"warranty"},{key:"area_id",labelKey:"area"},{key:"documentation_url",labelKey:"documentation_url_label"},{key:"notes",labelKey:"object_notes_label"},{key:"task_count",labelKey:"tasks"},{key:"actions",labelKey:"actions"}],Wi=we.map(n=>n.key),Xe=["name","manufacturer","model","serial_number","installation_date","warranty_expiry","area_id","task_count","actions"];function ze(n){if(!Array.isArray(n))return[...Xe];let r=new Set,e=[];for(let t of n)typeof t=="string"&&Wi.includes(t)&&!r.has(t)&&(r.add(t),e.push(t));return e.length?(e.includes("name")||e.unshift("name"),e):[...Xe]}function et(n,r,e){let t=new Blob([n],{type:e}),i=URL.createObjectURL(t),a=document.createElement("a");a.href=i,a.download=r,a.target="_blank",a.rel="noopener",a.style.display="none",document.body.appendChild(a),a.dispatchEvent(new MouseEvent("click")),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(i),6e4)}function tt(n,r){let e=document.createElement("a");e.href=n,e.download=r,e.target="_blank",e.rel="noopener",e.style.display="none",document.body.appendChild(e),e.dispatchEvent(new MouseEvent("click")),document.body.removeChild(e)}var ei=A`
  :host {
    display: block;
    height: 100%;
...
`;var it=class{constructor(r){this._cache=new Map;this._pending=new Map;this._hass=r}updateHass(r){this._hass=r}async getDetailStats(r,e,t=30){return this._getStats(r,t<=35?"hour":"day",t,e)}async getMiniStats(r,e){return this._getStats(r,"day",14,e)}async getBatchMiniStats(r){let e=new Map,t=[];for(let d of r){let g=`${d.entityId}:day:14`,_=this._cache.get(g);_&&Date.now()-_.fetchedAt<3e5?e.set(d.entityId,_.points):t.push(d)}if(t.length===0)return e;let i=t.filter(d=>d.isCounter).map(d=>d.entityId),a=t.filter(d=>!d.isCounter).map(d=>d.entityId),l=new Date(Date.now()-336*60*60*1e3).toISOString(),c=[];return i.length>0&&c.push(this._fetchBatch(i,"day",l,["state","sum","change"],!0,e)),a.length>0&&c.push(this._fetchBatch(a,"day",l,["mean","min","max"],!1,e)),await Promise.all(c),e}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(r,e,t,i){let a=`${r}:${e}:${t}`,l=this._cache.get(a);if(l&&Date.now()-l.fetchedAt<3e5)return l.points;if(this._pending.has(a))return this._pending.get(a);let c=this._fetchAndNormalize(r,e,t,i,a);this._pending.set(a,c);try{return await c}finally{this._pending.delete(a)}}async _fetchAndNormalize(r,e,t,i,a){let l=new Date(Date.now()-t*24*60*60*1e3).toISOString(),c=i?["state","sum","change"]:["mean","min","max"];try{let g=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:l,statistic_ids:[r],period:e,types:c}))[r]||[],_=this._normalizeRows(g,i);return this._cache.set(a,{entityId:r,fetchedAt:Date.now(),period:e,points:_}),_}catch(d){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${r}:`,d),[]}}async _fetchBatch(r,e,t,i,a,l){try{let c=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:t,statistic_ids:r,period:e,types:i});for(let d of r){let g=c[d]||[],_=this._normalizeRows(g,a);l.set(d,_),this._cache.set(`${d}:${e}:14`,{entityId:d,fetchedAt:Date.now(),period:e,points:_})}}catch(c){console.warn("[maintenance-supporter] Batch statistics fetch failed:",c)}}_normalizeRows(r,e){let t=[];for(let i of r){let a=null;if(e?a=i.state??null:a=i.mean??null,a===null)continue;let l={ts:i.start,val:a};e||(i.min!=null&&(l.min=i.min),i.max!=null&&(l.max=i.max)),t.push(l)}return t.sort((i,a)=>i.ts-a.ts),t}};var he=class{constructor(r){this.usersCache=null;this.cacheTimestamp=0;this.CACHE_TTL_MS=6e4;this.hass=r}updateHass(r){this.hass=r}async getUsers(r=!1){let e=Date.now();if(!r&&this.usersCache&&e-this.cacheTimestamp<this.CACHE_TTL_MS)return this.usersCache;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/users/list"});return this.usersCache=t.users,this.cacheTimestamp=e,this.usersCache}catch(t){return console.error("Failed to fetch users:",t),this.usersCache||[]}}async assignUser(r,e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/assign_user",entry_id:r,task_id:e,user_id:t})}async getTasksByUser(r){return(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tasks/by_user",user_id:r})).tasks}getUserName(r){return!r||!this.usersCache?null:this.usersCache.find(t=>t.id===r)?.name||null}getUser(r){return!r||!this.usersCache?null:this.usersCache.find(e=>e.id===r)||null}getCurrentUserId(){return this.hass.user?.id||null}isCurrentUser(r){return r?r===this.getCurrentUserId():!1}clearCache(){this.usersCache=null,this.cacheTimestamp=0}};var Ki={name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",warranty_expiry:"warranty_expiry_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_for_minutes:"trigger_for_minutes"};function Yi(n,r){let e=Ki[n];if(!e)return n;let t=s(e,r);return t&&t!==e?t:n}function Gi(n){let e=n.match(/data\['([^']+)'\]/)?.[1],t;return(t=n.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=n.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=n.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=n.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(n)?{field:e,rule:"required"}:(t=n.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(n)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(n)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function I(n,r,e){if(e=e??s("action_error",r),typeof n=="string")return n;if(typeof n!="object"||n===null)return e;let t=n,i=t.message||t.error?.message||"";if(!i)return e;let a=Gi(i),l=a.field?Yi(a.field,r):"",c=d=>s(d,r).replace("{field}",l).replace("{n}",a.param??"");switch(a.rule){case"too_long":return c("err_too_long");case"too_short":return c("err_too_short");case"value_too_high":return c("err_value_too_high");case"value_too_low":return c("err_value_too_low");case"required":return c("err_required");case"wrong_type":return c("err_wrong_type").replace("{type}",a.param??"");case"invalid_choice":return c("err_invalid_choice");case"invalid_value":return c("err_invalid_value");default:return i||e}}var B=class extends T{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return o`
  ...
  `,u([y({attribute:!1})],z.prototype,"hass",2),u([y({attribute:!1})],z.prototype,"entryId",2),u([y({type:Boolean})],z.prototype,"canWrite",2),u([h()],z.prototype,"_docs",2),u([h()],z.prototype,"_loaded",2),u([h()],z.prototype,"_busy",2),u([h()],z.prototype,"_error",2),u([h()],z.prototype,"_hint",2),u([h()],z.prototype,"_addingLink",2),u([h()],z.prototype,"_linkUrl",2),u([h()],z.prototype,"_linkTitle",2),u([h()],z.prototype,"_category",2),u([h()],z.prototype,"_thumbs",2),u([h()],z.prototype,"_lightboxUrl",2),u([h()],z.prototype,"_editingId",2),u([h()],z.prototype,"_editTitle",2),u([h()],z.prototype,"_editCategory",2),u([h()],z.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",z);var Zi=["manual","warranty","invoice","spare_parts","photo","other"],Ji={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"},Y=class extends T{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._loadedKey="";this._localeReady=!1}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),this.hass&&!this._localeReady&&(this._localeReady=!0,se(this._lang).then(()=>this.requestUpdate()));let t=`${this.entryId}|${this.taskId}`;this.hass&&this.entryId&&this.taskId&&this._loadedKey!==t&&(this._loadedKey=t,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=e.documents||[],this._loaded=!0,this._error=""}catch(e){this._error=I(e,this._lang),this._loaded=!0}}_linked(){return this._docs.filter(e=>(e.task_ids||[]).includes(this.taskId))}_available(){return this._docs.filter(e=>!(e.task_ids||[]).includes(this.taskId))}async _setTaskIds(e,t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:e.id,task_ids:t}),await this._load()}catch(i){this._error=I(i,this._lang)}finally{this._busy=!1}}_link(){let e=this._docs.find(t=>t.id===this._attachId);e&&(this._attachId="",this._setTaskIds(e,[...e.task_ids||[],this.taskId]))}_unlink(e){this._setTaskIds(e,(e.task_ids||[]).filter(t=>t!==this.taskId))}_isPdf(e){return e.mime==="application/pdf"||(e.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(e){return this._isPdf(e)?e.task_pages?.[this.taskId]:void 0}async _open(e){if(e.kind==="weblink"){window.open(e.url,"_blank","noopener");return}let t=this._pageFor(e),i=t?`#page=${t}`:"",a=window.open("about:blank","_blank");try{let l=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:300});a&&(a.location.href=new URL(l.path+i,window.location.origin).href)}catch(l){a&&a.close(),this._error=I(l,this._lang)}}async _setPage(e,t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:e.id,task_pages:{[this.taskId]:t}}),await this._load()}catch(i){this._error=I(i,this._lang)}finally{this._busy=!1}}async _download(e){try{let t=await this.hass.connection.sendMessagePromise({type:"auth/sign_path",path:`/api/maintenance_supporter/document/${e.id}`,expires:30});tt(t.path,e.filename||e.title||"document")}catch(t){this._error=I(t,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return p;let e=this._lang,t=this._linked(),i=this._available();return o`
    ...
    `}_renderRow(e,t){let i=e.kind==="file",a=this._isPdf(e),l=e.task_pages?.[this.taskId],c=(e.tags||[]).find(g=>Zi.includes(g))||"other",d=i?ae(e.size):s("doc_link_badge",t);return o`
      <div class="tdoc-row">
        <ha-icon class="tdoc-icon" icon=${i?Ji[c]:"mdi:link-variant"}></ha-icon>
        <div
          class="tdoc-info"
          role="button"
          tabindex="0"
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Xi.map(i=>o`<option value=${i} ?selected=${i===this._type}>${s(i,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,u([y({attribute:!1})],X.prototype,"hass",2),u([y()],X.prototype,"lang",2),u([h()],X.prototype,"_open",2),u([h()],X.prototype,"_loading",2),u([h()],X.prototype,"_error",2),u([h()],X.prototype,"_viewResult",2),u([h()],X.prototype,"_completeResult",2),u([h()],X.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",X);var si=5;function De(n){let r=n.getFullYear(),e=String(n.getMonth()+1).padStart(2,"0"),t=String(n.getDate()).padStart(2,"0");return`${r}-${e}-${t}`}function ls(n,r){let e=[];for(let t=0;t<r;t++){let i=new Date(n);i.setDate(i.getDate()+t),i.setHours(0,0,0,0),e.push(De(i))}return e}function at(n,r){let[e,t,i]=n.split("-").map(Number),a=new Date(e,t-1,i);return a.setDate(a.getDate()+r),De(a)}function cs(n){if(!n||n.length===0)return null;let r=n.map(e=>e.cost).filter(e=>typeof e=="number");return r.length===0?null:r.reduce((e,t)=>e+t,0)/r.length}function ds(n){let{windowStart:r,windowEnd:e,task:t,entryId:i,objectName:a}=n,l=[],c=(m,v)=>({date:m,entry_id:i,task_id:t.id,task_name:t.name,object_name:a,status:v&&(t.status==="overdue"||t.status==="triggered")?"ok":t.status,days_until_due:v?null:t.days_until_due??null,projected:v,schedule_type:t.schedule_type,interval_days:t.interval_days??null,interval_unit:t.interval_unit??null,responsible_user_id:t.responsible_user_id??null,avg_cost:cs(t.history),adaptive_enabled:!!t.adaptive_config?.enabled,prediction_confidence:t.threshold_prediction_confidence??null}),d=Math.max(1,Math.round(St(t.interval_days,t.interval_unit)));if(t.status==="overdue"||t.status==="triggered"){if(l.push(c(r,!1)),t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let m=at(r,d),v=1;for(;m<=e&&v<si;)l.push(c(m,!0)),v++,m=at(m,d)}return l}let g=t.next_due;if(typeof g!="string"||!g)return l;let _=g.slice(0,10);if(_>=r&&_<=e)l.push(c(_,!1));else if(_>e)return l;if(t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let m=at(_,d),v=l.length;for(;m<=e&&v<si;)m>=r&&(l.push(c(m,!0)),v++),m=at(m,d)}return l}var ai={overdue:0,triggered:1,due_soon:2,ok:3};function ri(n,r,e,t=null){let i=ls(r,e),a=i[0],l=i[i.length-1],c=[];for(let g of n){let _=g.object?.name||"",m=g.entry_id,v=g.tasks||[];for(let b of v){if(t&&b.responsible_user_id!==t||b.enabled===!1)continue;let x=ds({windowStart:a,windowEnd:l,task:b,entryId:m,objectName:_});c.push(...x)}}let d=new Map;for(let g of i)d.set(g,[]);for(let g of c){let _=d.get(g.date);_&&_.push(g)}for(let[,g]of d)g.sort((_,m)=>{let v=ai[_.status]??99,b=ai[m.status]??99;if(v!==b)return v-b;if(_.projected!==m.projected)return _.projected?1:-1;let x=_.object_name.localeCompare(m.object_name);return x!==0?x:_.task_name.localeCompare(m.task_name)});return i.map(g=>({date:g,events:d.get(g)??[]}))}var ps={completed:"ok",reset:"ok",skipped:"due_soon",triggered:"triggered",trigger_replaced:"triggered"};function us(n,r){let e=[];for(let t=r-1;t>=0;t--){let i=new Date(n);i.setDate(i.getDate()-t),i.setHours(0,0,0,0),e.push(De(i))}return e}function ni(n,r,e,t=null){let i=us(r,e),a=i[0],l=i[i.length-1],c=new Map;for(let g of i)c.set(g,[]);for(let g of n){let _=g.object?.name||"",m=g.entry_id,v=g.tasks||[];for(let b of v){if(t&&b.responsible_user_id!==t)continue;let x=b.history||[];for(let f of x){if(typeof f?.timestamp!="string")continue;let j=f.timestamp.slice(0,10);if(j<a||j>l)continue;let L=c.get(j);if(!L)continue;let H=f.type??"completed";L.push({date:j,entry_id:m,task_id:b.id,task_name:b.name,object_name:_,status:ps[H]??"ok",days_until_due:null,projected:!1,schedule_type:b.schedule_type,interval_days:b.interval_days??null,responsible_user_id:b.responsible_user_id??null,avg_cost:typeof f.cost=="number"?f.cost:null,adaptive_enabled:!!b.adaptive_config?.enabled,prediction_confidence:null,history_timestamp:f.timestamp,history_type:H,history_cost:typeof f.cost=="number"?f.cost:null,history_notes:typeof f.notes=="string"?f.notes:null,history_duration:typeof f.duration=="number"?f.duration:null})}}}let d={completed:0,reset:1,skipped:2,triggered:3,trigger_replaced:4};for(let[,g]of c)g.sort((_,m)=>{let v=d[_.history_type??""]??99,b=d[m.history_type??""]??99;if(v!==b)return v-b;let x=_.object_name.localeCompare(m.object_name);return x!==0?x:_.task_name.localeCompare(m.task_name)});return i.map(g=>({date:g,events:c.get(g)??[]}))}var oi=A`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;var ee=class extends T{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter)}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){super.updated(e);let t=this.hass?.language;if(t&&!Qe(t)&&se(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}_onEventClick(e){if(e.history_timestamp){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return p;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,l=null;this._userFilter&&(l=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let c=new Date;c.setHours(0,0,0,0);let d=this._pastDays>0,g=d?ni(this._objects,c,this._pastDays,l):ri(this._objects,c,this._windowDays,l),_=De(c),m=this._windowDays===365||d,v=m?g.filter(f=>f.events.length>0):g,b=f=>{let j=`cal-status-${f.status}`,L=f.projected?"cal-event-projected":"",H=f.status==="overdue"&&f.days_until_due!=null?` (${Math.abs(f.days_until_due)}d ${s("overdue",e).toLowerCase()})`:"",M=f.projected&&f.interval_days?o`<span class="cal-event-recur">${f.interval_unit&&f.interval_unit!=="days"?`${f.interval_days} ${s("unit_"+f.interval_unit,e)}`:s("cal_every_n_days",e).replace("{n}",String(f.interval_days))}</span>`:p,E=f.schedule_type==="sensor_based",W=E?o`<ha-icon class="cal-event-icon cal-source-sensor"
      ...
      `},x=f=>{let[j,L,H]=f.date.split("-").map(Number),M=new Date(j,L-1,H),E=f.date===_,W=M.toLocaleDateString(e,{weekday:"short"}),K=M.toLocaleDateString(e,{month:"long"});return o`
      ...
      <ha-card .header=${a}>
        ...
        <div class="cal-rolling">
          ${v.length===0&&m?o`<div class="cal-empty">${s("cal_no_events",e)}</div>`:v.map(x)}
        </div>
      </ha-card>
    `}};ee.styles=[Je,oi,A`
      :host { display: block; }
      ha-card { padding: 0; overflow: hidden; }
    `],u([y({attribute:!1})],ee.prototype,"hass",2),u([h()],ee.prototype,"_config",2),u([h()],ee.prototype,"_objects",2),u([h()],ee.prototype,"_stats",2),u([h()],ee.prototype,"_windowDays",2),u([h()],ee.prototype,"_pastDays",2),u([h()],ee.prototype,"_userFilter",2),u([h()],ee.prototype,"_unsub",2);var hs=[{value:7,label:"Week (7 days)"},{value:14,label:"Fortnight (14 days)"},{value:30,label:"Month (30 days, default)"},{value:365,label:"Year (365 days, empty days collapsed)"}],Ee=class extends T{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}setConfig(e){this._config={...e}}_valueChanged(e,t){let i={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete i.show_window_chips,e==="show_user_filter"&&t===!0&&delete i.show_user_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete i.title,e==="user_filter"&&t===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let e=this._config.window_days??30,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.user_filter??"",l=this._config.title??"";return o`
      <div class="editor">
        <div class="row">
  ...
  `,u([y({attribute:!1})],G.prototype,"hass",2),u([h()],G.prototype,"_open",2),u([h()],G.prototype,"_title",2),u([h()],G.prototype,"_message",2),u([h()],G.prototype,"_confirmText",2),u([h()],G.prototype,"_danger",2),u([h()],G.prototype,"_inputLabel",2),u([h()],G.prototype,"_inputType",2),u([h()],G.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",G);var ci={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},di=n=>(...r)=>({_$litDirective$:n,values:r}),nt=class{constructor(r){}get _$AU(){return this._$AM._$AU}_$AT(r,e,t){this._$Ct=r,this._$AM=e,this._$Ci=t}_$AS(r,e){return this.update(r,e)}update(r,e){return this.render(...e)}};var qe=class extends nt{constructor(r){if(super(r),this.it=p,r.type!==ci.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(r){if(r===p||r==null)return this._t=void 0,this.it=r;if(r===oe)return r;if(typeof r!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(r===this.it)return this._t;this.it=r;let e=[r];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};qe.directiveName="unsafeHTML",qe.resultType=1;var pi=di(qe);var gs=["EUR","USD","GBP","JPY","CHF","CAD","AUD","CNY","INR","BRL","CZK","PLN","RUB","SEK","NOK","DKK","UAH"],C=class extends T{constructor(){super(...arguments);this.budget=null;this._settings=null;this._loading=!0;this._importCsv="";this._importLoading=!1;this._includeHistory=!0;this._toast="";this._testingNotification=!1;this._users=[];this._vacEnabled=!1;this._vacStart="";this._vacEnd="";this._vacBuffer=3;this._vacExempt=new Set;this._vacIsActive=!1;this._vacWindowEnd=null;this._vacAllTasks=[];this._vacPreview=[];this._vacPreviewLoading=!1;this._vacSaving=!1;this._qrObjects=[];this._qrSelectedEntries=new Set;this._qrActions=new Set(["view"]);this._qrUrlMode="companion";this._qrBatchLoading=!1;this._qrBatchResults=[];this._qrObjectsLoaded=!1;this._loaded=!1;this._userService=null;this._sendTestNotification=async()=>{this._testingNotification=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/test_notification"}),t=e.message||(e.success?s("test_notification_success",this._lang):s("test_notification_failed",this._lang));this._showToast(t)}catch{this._showToast(s("test_notification_failed",this._lang))}finally{this._testingNotification=!1}}}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded?(this._loaded=!0,this._userService=new he(this.hass),this._loadSettings(),this._loadUsers()):e.has("hass")&&this.hass&&this._userService&&this._userService.updateHass(this.hass)}async _loadUsers(){if(this._userService)try{this._users=await this._userService.getUsers()}catch{this._users=[]}}async _loadSettings(){this._loading=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});this._settings=e,this._hydrateVacationFromSettings()}catch{}this._loading=!1}_hydrateVacationFromSettings(){let e=this._settings?.vacation;e&&(this._vacEnabled=e.enabled,this._vacStart=e.start||"",this._vacEnd=e.end||"",this._vacBuffer=e.buffer_days,this._vacExempt=new Set(e.exempt_task_ids||[]),this._vacIsActive=e.is_active,this._vacWindowEnd=e.window_end)}async _updateSetting(e,t){try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:{[e]:t}});this._settings=i,this._showToast(s("settings_saved",this._lang)),this.dispatchEvent(new CustomEvent("settings-changed"))}catch{this._showToast(s("action_error",this._lang))}}_showToast(e){this._toast=e,setTimeout(()=>{this._toast=""},3e3)}_downloadFile(e,t,i){et(e,t,i)}render(){let e=this._lang;return this._loading||!this._settings?o`<div class="settings-loading">Loading…</div>`:o`
    ...
    `}_renderObjectsColumns(e){let t=ze(this._settings.objects_table_columns);return o`
      ...
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select @change=${c=>this._updateSetting("budget_currency",c.target.value)}>
            ${gs.map(c=>o`<option value=${c} ?selected=${l.currency===c}>${c}</option>`)}
          </select>
        </label>
        <label class="setting-row">
...
<body>
  ...
  `,u([y({attribute:!1})],Z.prototype,"hass",2),u([y({attribute:!1})],Z.prototype,"objects",2),u([h()],Z.prototype,"_open",2),u([h()],Z.prototype,"_loading",2),u([h()],Z.prototype,"_error",2),u([h()],Z.prototype,"_groupId",2),u([h()],Z.prototype,"_name",2),u([h()],Z.prototype,"_description",2),u([h()],Z.prototype,"_selected",2);customElements.get("maintenance-group-dialog")||customElements.define("maintenance-group-dialog",Z);function Oe(n,r,e=4){if(!isFinite(n)||!isFinite(r))return{ticks:[],niceMin:0,niceMax:1};if(n===r){let g=Math.abs(n)*.1||1;n-=g,r+=g}let t=r-n,i=Math.pow(10,Math.floor(Math.log10(t/Math.max(1,e)))),a=i;for(let g of[1,2,5,10])if(a=i*g,t/a<=e+.5)break;let l=Math.floor(n/a)*a,c=Math.ceil(r/a)*a,d=[];for(let g=l;g<=c+a*1e-6;g+=a)d.push(Math.abs(g)<a*1e-9?0:g);return{ticks:d,niceMin:l,niceMax:c}}function re(n){let r=Math.abs(n);return r>=1e6?Te((n/1e6).toFixed(r>=1e7?0:1))+"M":r>=1e4?Te((n/1e3).toFixed(0))+"k":r>=1e3?Te((n/1e3).toFixed(1))+"k":r>=100?n.toFixed(0):r>=10||r>=1?Te(n.toFixed(1)):r===0?"0":Te(n.toFixed(2))}function Te(n){return n.replace(/\.0+$/,"").replace(/(\.\d*[1-9])0+$/,"$1")}function be(n,r,e){let t=n.toLocaleString(e,{maximumFractionDigits:Math.abs(n)>=100?0:1});return r?`${t} ${r}`:t}function Se(n,r,e){let t=new Date(n),i=e?{month:"short",day:"numeric",year:"2-digit"}:{month:"short",day:"numeric"};return t.toLocaleDateString(r,i)}function Ct(n,r){return new Date(n).toLocaleDateString(r,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}function ot(n,r){return new Date(n).getFullYear()!==new Date(r).getFullYear()}function lt(n,r,e){if(e<2||r<=n)return[n,r];let t=[];for(let i=0;i<e;i++)t.push(n+(r-n)*i/(e-1));return t}var ct=210,ie=46,ce=14,de=12,ui=14,vs=20+ui,fs=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],N=class extends T{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(e=>{let t=Math.floor(e[0]?.contentRect?.width||0);t&&Math.abs(t-this._width)>2&&(this._width=t)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(e){e!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:e},bubbles:!0,composed:!0}))}render(){let e=this._width||320,t=[...this.points].sort((a,l)=>a.ts-l.ts),i=this.lang;return o`
    ...
    `}_renderSvg(e,t){let i=this.lang,a=e-ie-ce,l=ct-vs,c=l-de,d=1/0,g=-1/0;for(let k of t)d=Math.min(d,k.min??k.val),g=Math.max(g,k.max??k.val);this.thresholdAbove!=null&&(d=Math.min(d,this.thresholdAbove),g=Math.max(g,this.thresholdAbove)),this.thresholdBelow!=null&&(d=Math.min(d,this.thresholdBelow),g=Math.max(g,this.thresholdBelow)),this.targetValue!=null&&(d=Math.min(d,this.targetValue),g=Math.max(g,this.targetValue)),this.forceZero&&(d=Math.min(d,0));let _=(g-d||1)*.06,m=this.forceZero&&d>=0?0:d-_,{ticks:v,niceMin:b,niceMax:x}=Oe(m,g+_,4);this.forceZero&&d>=0&&b<0&&(b=0,v=v.filter(k=>k>=0));let f=t[0].ts,j=t[t.length-1].ts,L=j-f||1,H=ot(f,j),M=k=>ie+(k-f)/L*a,E=k=>de+(1-(k-b)/(x-b||1))*c,W=t.map(k=>`${M(k.ts).toFixed(1)},${E(k.val).toFixed(1)}`).join(" "),K=`M${M(t[0].ts).toFixed(1)},${l} `+t.map(k=>`L${M(k.ts).toFixed(1)},${E(k.val).toFixed(1)}`).join(" ")+` L${M(t[t.length-1].ts).toFixed(1)},${l} Z`,V="",q=t.filter(k=>k.min!=null&&k.max!=null);if(q.length>=2){let k=q.map(R=>`${M(R.ts).toFixed(1)},${E(R.max).toFixed(1)}`),w=[...q].reverse().map(R=>`${M(R.ts).toFixed(1)},${E(R.min).toFixed(1)}`);V=`M${k[0]} `+k.slice(1).map(R=>`L${R}`).join(" ")+` L${w.join(" L")} Z`}let D=[];if(this.thresholdBelow!=null){let k=E(this.thresholdBelow);D.push({y:k,h:Math.max(0,l-k),lineY:k,label:`\u25BC ${re(this.thresholdBelow)}`,labelY:Math.min(l-4,k+13)})}if(this.thresholdAbove!=null){let k=E(this.thresholdAbove);D.push({y:de,h:Math.max(0,k-de),lineY:k,label:`\u25B2 ${re(this.thresholdAbove)}`,labelY:Math.max(de+11,k-5)})}let pe=t[t.length-1],_e=(this.events||[]).filter(k=>k.ts>=f&&k.ts<=j),ye=lt(f,j,Math.max(2,Math.min(5,Math.floor(a/110)+1))),U=this._hover;return o`
      <div class="svg-holder">
        ...
        >
          ...
          ${v.map(k=>{let w=E(k);return w<de-1||w>l+1?p:P`
              <line x1="${ie}" y1="${w.toFixed(1)}" x2="${e-ce}" y2="${w.toFixed(1)}"
                stroke="var(--divider-color)" stroke-width="1" opacity="0.6" />
              <text x="${ie-7}" y="${(w+3.5).toFixed(1)}" text-anchor="end" class="tick-label">${re(k)}</text>`})}
          ...
          ${this.projection&&this.projection.length===2?P`<line x1="${M(this.projection[0].ts).toFixed(1)}" y1="${E(this.projection[0].val).toFixed(1)}"
                x2="${Math.min(M(this.projection[1].ts),e-ce).toFixed(1)}" y2="${E(Math.max(b,Math.min(x,this.projection[1].val))).toFixed(1)}"
                stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.8" />`:p}

          ${ye.map((k,w)=>{let R=M(k),dt=w===0?"start":w===ye.length-1?"end":"middle";return P`<text x="${R.toFixed(1)}" y="${ct-5}" text-anchor="${dt}" class="tick-label">${Se(k,i,H)}</text>`})}

          <line x1="${ie}" y1="${l}" x2="${e-ce}" y2="${l}" stroke="var(--divider-color)" stroke-width="1" />

          ${_e.map(k=>{let w=M(k.ts),R=k.type==="completed"?"var(--success-color, #4caf50)":k.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return P`
              <line x1="${w.toFixed(1)}" y1="${de}" x2="${w.toFixed(1)}" y2="${l}" stroke="${R}" stroke-width="1" opacity="0.14" />
              <rect x="${(w-1.5).toFixed(1)}" y="${l+3}" width="3" height="${ui-6}" rx="1.5" fill="${R}">
    ...
    `}_onPointer(e,t,i,a,l){let d=e.currentTarget.getBoundingClientRect(),g=(e.clientX-d.left)/d.width*l;if(g<ie-8||g>l-ce+8){this._hover=null;return}let _=t[0],m=1/0;for(let v of t){let b=Math.abs(i(v.ts)-g);b<m&&(m=b,_=v)}this._hover={x:i(_.ts),y:a(_.val),p:_}}};N.styles=A`
    ...
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${v?o`
            ...
            <div class="trigger-entity-id">${d.map((x,f)=>o`${f>0?", ":""}<span class="entity-link" @click=${j=>fe(j,x)}>${x}</span>`)}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `:o`
            <div class="trigger-entity-name">${l}</div>
            <div class="trigger-entity-id">${c?o`<span class="entity-link" @click=${x=>fe(x,c)}>${c}</span>`:""}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `}
        </div>
      ...
      ${b?ys(b,t):_!=null?o`
              <div class="trigger-value-row">
                <span class="trigger-current ${n.trigger_active?"active":""}">${typeof _=="number"?be(_,"",t):_}</span>
                ${g?o`<span class="trigger-unit">${g}</span>`:p}
              </div>
            `:p}

      <div class="trigger-limits">
        ${m==="threshold"?o`
          ${e.trigger_above!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${s("threshold_above",t)}: ${e.trigger_above} ${g}</span>`:p}
          ${e.trigger_below!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${s("threshold_below",t)}: ${e.trigger_below} ${g}</span>`:p}
        ...
        ${m==="compound"?o`
          ...
          ${(e.conditions||[]).map((x,f)=>o`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${f+1}. ${s(x.type||"unknown",t)}: ${x.entity_id?o`<span class="entity-link" @click=${j=>fe(j,x.entity_id)}>${x.entity_id}</span>`:""}</span>
          `)}
        `:p}
      </div>
      ...
      ${a&&a.length>1?o`
        <div class="trigger-entity-list">
          ${a.map(x=>o`
            <span class="trigger-entity-id">${x.friendly_name} (<span class="entity-link" @click=${f=>fe(f,x.entity_id)}>${x.entity_id}</span>)</span>
          `)}
        </div>
      `:p}
  ...
  `}function bs(n,r,e){let t=n.trigger_config,i=n.trigger_current_value;if(!t||i==null)return null;switch(t.type||"threshold"){case"counter":{let a=t.trigger_target_value;if(a==null||a<=0)return null;let l=gi(n,mi(n,e));return{progress:Math.max(0,i-(l?.value??i)),target:a,unit:r,meter:i}}case"state_change":{let a=t.trigger_target_changes;return a==null||a<=0?null:{progress:Math.max(0,i),target:a,unit:"",meter:null}}case"runtime":{let a=t.trigger_runtime_hours;return a==null||a<=0?null:{progress:Math.max(0,i),target:a,unit:"h",meter:null}}}return null}function gi(n,r){if(n.trigger_baseline_value!=null)return{value:n.trigger_baseline_value,ts:hi(n)};if(!r.length)return null;let e=hi(n);if(e==null)return{value:r[0].val,ts:null};let t=r[0],i=Math.abs(r[0].ts-e);for(let a of r){let l=Math.abs(a.ts-e);l<i&&(t=a,i=l)}return{value:t.val,ts:e}}function hi(n){let r=[...n.history].filter(e=>e.type==="completed"||e.type==="reset").sort((e,t)=>new Date(t.timestamp).getTime()-new Date(e.timestamp).getTime())[0];return r?new Date(r.timestamp).getTime():null}function ys(n,r){let e=Math.min(999,Math.round(n.progress/n.target*100)),t=e>=100?"over":e>=75?"near":"ok";return o`
  ...
  `}function mi(n,r){let e=n.trigger_config;if(!e)return[];let t=e.entity_id||"",i=r.detailStatsData.get(t)||[],a=r.isCounterEntity(e),l=[];if(i.length>=2)for(let c of i){let d={ts:c.ts,val:c.val};!a&&c.min!=null&&c.max!=null&&(d.min=c.min,d.max=c.max),l.push(d)}else for(let c of n.history)c.trigger_value!=null&&l.push({ts:new Date(c.timestamp).getTime(),val:c.trigger_value});return n.trigger_current_value!=null&&l.push({ts:Date.now(),val:n.trigger_current_value}),l.sort((c,d)=>c.ts-d.ts),l}function xs(n,r,e){let t=n.trigger_config;if(!t)return p;let i=t.type||"threshold",a=t.entity_id||"",l=mi(n,e),c=l.length<2&&!!a&&e.hasStatsService&&!e.detailStatsData.has(a);if(l.length<2&&!c)return p;let d=!!a&&e.detailStatsData.has(a)&&(e.detailStatsData.get(a)?.length??0)<2,g=Date.now()-e.rangeDays*864e5,_=l.filter(f=>f.ts>=g);_.length>=2&&(l=_);let m=null,v=!1;if(i==="counter"&&t.trigger_target_value!=null&&l.length){let f=gi(n,l);if(f){if(f.ts!=null){let j=l.filter(L=>L.ts>=f.ts);j.length>=2&&(l=j)}l=l.map(j=>({...j,val:Math.max(0,j.val-f.value)}))}m=t.trigger_target_value,v=!0}else i==="state_change"&&t.trigger_target_changes?(m=t.trigger_target_changes,v=!0):i==="runtime"&&t.trigger_runtime_hours&&(m=t.trigger_runtime_hours,v=!0);let b=null;if(m==null&&n.degradation_rate!=null&&(n.degradation_trend!=="stable"||n.days_until_threshold!=null)&&n.degradation_trend!=="insufficient_data"&&l.length>=2){let f=l[l.length-1];b=[f,{ts:f.ts+30*864e5,val:f.val+n.degradation_rate*30}]}let x=n.history.filter(f=>["completed","skipped","reset"].includes(f.type)).map(f=>({ts:new Date(f.timestamp).getTime(),type:f.type}));return o`
  ...
  `}function vi(n,r,e){let t=n.degradation_trend!=null&&n.degradation_trend!=="insufficient_data",i=n.days_until_threshold!=null,a=n.environmental_factor!=null&&n.environmental_factor!==1;if(!t&&!i&&!a)return p;let l=n.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":n.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return o`
      ...
      <div class="prediction-grid">
        ...
        ${i?o`
          <div class="prediction-item">
            ...
            ${n.threshold_prediction_date?o`<span class="prediction-date">${J(n.threshold_prediction_date,r)}</span>`:p}
  ...
  `}function Es(n,r,e){let t=n.confidence_interval_low,i=n.confidence_interval_high,a=r.suggested_interval??r.interval_days??0,l=r.interval_days??0,c=Math.max(0,t-5),g=i+5-c,_=(t-c)/g*100,m=(i-t)/g*100,v=(a-c)/g*100,b=l>0?(l-c)/g*100:-1;return o`
  ...
  `}var yi=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function xi(n,r,e){if(!e.seasonal||!n.seasonal_factor||n.seasonal_factor===1)return p;let t=yi.map(c=>s(c,r)),i=new Date().getMonth(),a=n.seasonal_factors||n.interval_analysis?.seasonal_factors||null,l=a&&a.length===12?a:t.map((c,d)=>{let g=n.seasonal_factor||1,_=Math.sin((d-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,g+_))});return o`
    <div class="seasonal-card-compact">
      <h4>${s("seasonal_awareness",r)}</h4>
      <div class="seasonal-mini-chart">
        ${l.map((c,d)=>{let g=c*40,_=c<.9?"low":c>1.1?"high":"normal";return o`
  ...
  `}function $i(n,r){return Ts(n,r)}function Ts(n,r){let e=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return p;let t=n.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,l=100,c=8,g=l-c-4,_=Math.max(...e,1.5),m=a/12,v=m*.65,b=c+g-1/_*g;return o`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${a} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",r)}">
        ...
        ${e.map((x,f)=>{let j=x/_*g,L=f*m+(m-v)/2,H=c+g-j,M=f===i,E=x<1?"var(--success-color, #4caf50)":x>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return P`
      ...
      <div class="seasonal-labels">
        ${yi.map((x,f)=>o`<span class="seasonal-label ${f===i?"active-month":""}">${s(x,r)}</span>`)}
      </div>
    </div>
  `}var Ss=200,Fe=10,As=22;function wi(n,r,e,t){let i=n.history.filter(c=>c.type==="completed"&&(c.cost!=null||c.duration!=null));if(i.length<2)return p;let a=i.some(c=>(c.cost??0)>0),l=i.some(c=>(c.duration??0)>0);return!a&&!l?p:o`
  ...
  `}var Cs=60,Is=20,ki=30,S=class extends T{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._unsub=null;this._chartRangeDays=(()=>{try{let e=parseInt(localStorage.getItem("msp-chart-range")||"",10);return[7,30,90,365].includes(e)?e:30}catch{return 30}})();this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._operatorWriteEnabled=!1;this._defaultWarningDays=7;this._actionLoading=!1;this._moreMenuOpen=!1;this._toastMessage="";this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab="dashboard";this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._objectViewMode="cards";this._objectsTableColumns=Xe;this._showArchived=!1;this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=e=>this._onPopState(e);this._deepLinkHandled=!1;this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=e=>{let t=e.detail;t?.type==="maintenance-supporter:open-task"&&t.entry_id&&t.task_id&&(e.stopPropagation(),this._showTask(t.entry_id,t.task_id))};this._onHistoryEntrySaved=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"en"}get _isOperator(){let e=this.hass?.user;return e?e.is_admin?!1:!(this._operatorWriteEnabled&&this._adminPanelUserIds.includes(e.id)):!0}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._popstateHandler);let e=localStorage.getItem("maintenance_supporter_sort");e&&["due_date","object","type","task_name","area","assigned_user","group"].includes(e)&&(this._sortMode=e);let t=localStorage.getItem("maintenance_supporter_object_sort");t&&["alphabetical","due_soonest","task_count"].includes(t)&&(this._objectSortMode=t);let i=localStorage.getItem("maintenance_supporter_groupby");i&&["none","area","group","user"].includes(i)&&(this._groupByMode=i);let a=localStorage.getItem("maintenance_supporter_object_view");(a==="cards"||a==="table")&&(this._objectViewMode=a)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(e){super.updated(e);let t=this.hass?.language;if(t&&!Qe(t)&&se(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new it(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new he(this.hass),this._userService.getUsers())}}async _loadData(){let[e,t,i,a,l]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null)]);if(e&&(this._objects=e.objects),t&&(this._stats=t),i&&(this._budget=i),a&&(this._groups=a.groups||{}),l){let c=l;this._features=c.features,this._adminPanelUserIds=c.admin_panel_user_ids||[],this._operatorWriteEnabled=c.operator_write_enabled??!1;let d=c.general?.default_warning_days;typeof d=="number"&&d>=0&&d<=365&&(this._defaultWarningDays=d),this._objectsTableColumns=ze(c.objects_table_columns)}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search),t=e.get("ms_action"),i=()=>{let _=window.location.pathname+window.location.hash;history.replaceState(history.state,"",_)};if(t==="add_object"){this._deepLinkHandled=!0,i(),requestAnimationFrame(()=>{this.shadowRoot?.querySelector("maintenance-object-dialog")?.openCreate()});return}if(t==="open_vacation"||t==="open_budget"||t==="open_groups"||t==="open_settings"){this._deepLinkHandled=!0,i(),this._overviewTab="settings",requestAnimationFrame(()=>{let _=this.shadowRoot?.querySelector("maintenance-settings-view"),m=t.replace("open_","");_?.scrollToSection?.(m)});return}let a=e.get("entry_id");if(!a)return;this._deepLinkHandled=!0;let l=e.get("task_id"),c=e.get("action"),d=window.location.pathname+window.location.hash;history.replaceState(history.state,"",d);let g=this._getObject(a);if(!g){this._showOverview();return}if(l){let _=g.tasks.find(m=>m.id===l);if(!_){this._showObject(a);return}this._showTask(a,l),c==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(a,l,_.name,this._features.checklists?_.checklist:void 0,this._features.adaptive&&!!_.adaptive_config?.enabled)}):c==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(a,l,_)})}else this._showObject(a)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let i=await this._statsService.getDetailStats(e,t,this._chartRangeDays),a=new Map(this._detailStatsData);a.set(e,i),this._detailStatsData=a}_setChartRange(e){if(e===this._chartRangeDays)return;this._chartRangeDays=e;try{localStorage.setItem("msp-chart-range",String(e))}catch{}let t=this._selectedEntryId&&this._selectedTaskId?this._getTask(this._selectedEntryId,this._selectedTaskId):null,i=t?.trigger_config?.entity_id;if(i){let a=new Map(this._detailStatsData);a.delete(i),this._detailStatsData=a,this._fetchDetailStats(i,this._isCounterEntity(t.trigger_config))}}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=[];for(let i of this._objects)for(let a of i.tasks){let l=a.trigger_config?.entity_id;l&&e.push({entityId:l,isCounter:this._isCounterEntity(a.trigger_config)})}if(e.length===0)return;let t=await this._statsService.getBatchMiniStats(e);this._miniStatsData=new Map([...this._miniStatsData,...t])}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _taskRows(){let e=[];for(let m of this._objects)for(let v of m.tasks){if(!this._showArchived&&v.archived||this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let x=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==x)continue}let b=[];for(let x of Object.values(this._groups))x.task_refs?.some(f=>f.entry_id===m.entry_id&&f.task_id===v.id)&&b.push(x.name);e.push({entry_id:m.entry_id,task_id:v.id,object_name:m.object.name,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_unit:v.interval_unit??null,interval_anchor:v.interval_anchor??null,is_done:v.is_done??!1,archived:v.archived??!1,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,area_id:m.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:b})}let t={overdue:0,triggered:1,due_soon:2,ok:3},i=(m,v)=>(t[m.status]??9)-(t[v.status]??9),a=(m,v)=>(m.days_until_due??99999)-(v.days_until_due??99999),l=(m,v)=>i(m,v)||a(m,v),c=m=>m.area_id&&this.hass?.areas?.[m.area_id]?.name||"",d=m=>m.responsible_user_id&&this._userService?.getUserName(m.responsible_user_id)||"",g=m=>m.group_names[0]||"",_={due_date:l,object:(m,v)=>m.object_name.localeCompare(v.object_name)||l(m,v),type:(m,v)=>m.type.localeCompare(v.type)||l(m,v),task_name:(m,v)=>m.task_name.localeCompare(v.task_name),area:(m,v)=>{let b=c(m),x=c(v);return!b&&x?1:b&&!x?-1:b.localeCompare(x)||l(m,v)},assigned_user:(m,v)=>{let b=d(m),x=d(v);return!b&&x?1:b&&!x?-1:b.localeCompare(x)||l(m,v)},group:(m,v)=>{let b=g(m),x=g(v);return!b&&x?1:b&&!x?-1:b.localeCompare(x)||l(m,v)}};return e.sort(_[this._sortMode]),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(a=>a.id===t)}_pushPanelState(e,t,i){let a={msp_view:e,msp_entry:t||null,msp_task:i||null};history.pushState(a,"")}_onPopState(e){let t=e.state;if(t?.msp_view&&(this._view=t.msp_view,this._selectedEntryId=t.msp_entry||null,this._selectedTaskId=t.msp_task||null,this._moreMenuOpen=!1,t.msp_view==="task"&&t.msp_entry&&t.msp_task)){this._historyFilter=null;let i=this._getTask(t.msp_entry,t.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop()}_filterByStatus(e){this._filterStatus=e,this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),this._scrollContentToTop()}_scrollContentToTop(){requestAnimationFrame(()=>{let e=this.shadowRoot?.querySelector(".content");e&&e.scrollTo({top:0,behavior:"smooth"})})}_showObject(e){this._pushPanelState("object",e),this._view="object",this._selectedEntryId=e,this._selectedTaskId=null,this._scrollContentToTop()}_showTask(e,t){this._pushPanelState("task",e,t),this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._activeTab="overview",this._historyFilter=null,this._scrollContentToTop();let i=this._getTask(e,t);if(i?.trigger_config?.entity_id){let a=i.trigger_config.entity_id,l=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(a,l)}}_showToast(e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}async _deleteObject(e){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:s("delete",this._lang),message:s("confirm_delete_object",this._lang),confirmText:s("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:e}),this._showOverview(),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}}async _deleteTask(e,t){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:s("delete",this._lang),message:s("confirm_delete_task",this._lang),confirmText:s("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/delete",entry_id:e,task_id:t}),this._showObject(e),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}}async _toggleArchiveTask(e,t,i){this._actionLoading=!0;try{await this.hass.connection.sendMessagePromise({type:i?"maintenance_supporter/task/unarchive":"maintenance_supporter/task/archive",entry_id:e,task_id:t}),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}finally{this._actionLoading=!1}}async _toggleArchiveObject(e,t){if(!(!t&&!await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:s("archive_object",this._lang),message:s("confirm_archive_object",this._lang),confirmText:s("archive_object",this._lang)})))try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:e}),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}}async _skipTask(e,t,i){this._actionLoading=!0;try{let a={type:"maintenance_supporter/task/skip",entry_id:e,task_id:t};i&&(a.reason=i),await this.hass.connection.sendMessagePromise(a),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}finally{this._actionLoading=!1}}async _resetTask(e,t,i){this._actionLoading=!0;try{let a={type:"maintenance_supporter/task/reset",entry_id:e,task_id:t};i&&(a.date=i),await this.hass.connection.sendMessagePromise(a),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}finally{this._actionLoading=!1}}async _applySuggestion(e,t,i){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/apply_suggestion",entry_id:e,task_id:t,interval:i}),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}}_openSeasonalOverrides(e){let t=this.shadowRoot.querySelector("maintenance-seasonal-overrides-dialog");if(!t||!this._selectedEntryId)return;let i=e.adaptive_config?.seasonal_overrides;t.open(this._selectedEntryId,e.id,i)}async _reanalyzeInterval(e,t){try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:e,task_id:t});i.recommended_interval?this._showToast(`${s("reanalyze_result",this._lang)}: ${i.recommended_interval} ${s("days",this._lang)} (${s(`confidence_${i.confidence}`,this._lang)}, ${i.data_points} ${s("data_points",this._lang)})`):this._showToast(s("reanalyze_insufficient_data",this._lang)),await this._loadData()}catch{this._showToast(s("action_error",this._lang))}}async _promptSkipTask(e,t){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!i)return;let a=await i.prompt({title:s("skip",this._lang),message:s("skip_reason_prompt",this._lang),confirmText:s("skip",this._lang),inputLabel:s("reason_optional",this._lang),inputType:"text"});a.confirmed&&this._skipTask(e,t,a.value||void 0)}async _promptResetTask(e,t){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!i)return;let a=await i.prompt({title:s("reset",this._lang),message:s("reset_date_prompt",this._lang),confirmText:s("reset",this._lang),inputLabel:s("reset_date_optional",this._lang),inputType:"date"});a.confirmed&&this._resetTask(e,t,a.value||void 0)}_dismissSuggestion(e,t){e&&t&&this._dismissedSuggestions.add(`${e}_${t}`),this.requestUpdate()}async _handleQuickComplete(e,t,i){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/quick_complete",entry_id:e,task_id:t}),this._showToast(s("quick_complete_success",this._lang))}catch(a){(a?.code||"")==="no_defaults"?this._openCompleteDialog(e,t,i.name,this._features.checklists?i.checklist:void 0,this._features.adaptive&&!!i.adaptive_config?.enabled):this._showToast(s("action_error",this._lang))}}_openCompleteDialog(e,t,i,a,l){let c=this.shadowRoot.querySelector("maintenance-complete-dialog");c&&(c.entryId=e,c.taskId=t,c.taskName=i,c.lang=this._lang,c.checklist=a||[],c.adaptiveEnabled=!!l,c.open())}_openQrForObject(e,t){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForObject(e,t)}_openQrForTask(e,t,i,a){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForTask(e,t,i,a)}render(){return o`
    ...
    `}_renderDashboard(){let e=this._stats,t=this._taskRows,i=this._lang,a=this._isOperator,l=this._objects.reduce((c,d)=>c+d.tasks.filter(g=>g.archived).length,0);return o`
    ...
    `}_renderGroupedTasks(e,t){let i=new Map,a=s("unassigned",t);for(let d of e){let g=[];this._groupByMode==="area"?g=[(d.area_id?this.hass?.areas?.[d.area_id]?.name:null)||a]:this._groupByMode==="user"?g=[(d.responsible_user_id?this._userService?.getUserName(d.responsible_user_id):null)||a]:this._groupByMode==="group"&&(g=d.group_names.length>0?d.group_names:[a]);for(let _ of g)i.has(_)||i.set(_,[]),i.get(_).push(d)}let l=[...i.entries()].sort(([d],[g])=>d===a&&g!==a?1:g===a&&d!==a?-1:d.localeCompare(g)),c=this._groupByMode==="area"?"mdi:map-marker-outline":this._groupByMode==="group"?"mdi:folder-outline":"mdi:account-outline";return o`
      ${l.map(([d,g])=>o`
      ...
      `)}
    `}_warrantyLabel(e,t,i){return e.kind==="expired"?s("warranty_expired",i):e.kind==="expiring"?s("warranty_expires_in",i).replace("{days}",String(e.days??0)):s("warranty_valid_until",i).replace("{date}",J(t,i))}_renderWarrantyMeta(e,t){let i=jt(e);return o`<p class="meta">${s("warranty",t)}:
      <span class="warranty-chip warranty-${i.kind}">${this._warrantyLabel(i,e,t)}</span></p>`}_renderAllObjects(){let e=this._lang,t=this._isOperator,i=this._objectViewMode==="table"&&!this.narrow,a=this._objects.filter(_=>_.object.archived).length,l=_=>{let m=1/0;for(let v of _.tasks){let b=v.days_until_due;b!=null&&b<m&&(m=b)}return m},c=this._objects.filter(_=>this._showArchived||!_.object.archived);this._objectSortMode==="alphabetical"?c.sort((_,m)=>_.object.name.localeCompare(m.object.name)):this._objectSortMode==="task_count"?c.sort((_,m)=>m.tasks.length-_.tasks.length||_.object.name.localeCompare(m.object.name)):c.sort((_,m)=>l(_)-l(m)||_.object.name.localeCompare(m.object.name));let d=()=>{let _=new Map;for(let m of c){let v=m.object.area_id,b=v?this.hass?.areas?.[v]?.name||s("unassigned",e):s("no_area",e);_.has(b)||_.set(b,[]),_.get(b).push(m)}return new Map([..._.entries()].sort(([m],[v])=>m.localeCompare(v)))},g=_=>{let m=_.tasks.some(v=>v.status==="overdue"||v.status==="triggered");return o`
        <div class="object-card${m?" object-card-overdue":""}" @click=${()=>this._showObject(_.entry_id)}>
          ...
          <div class="object-card-header">
            ...
            ${_.object.document_count?o`<span class="doc-badge" title="${_.object.document_count} ${s("documents",e)}">
          ...
          ${_.object.manufacturer||_.object.model?o`<div class="object-card-meta">${[_.object.manufacturer,_.object.model].filter(Boolean).join(" ")}</div>`:p}
          ${_.tasks.length===0?o`<div class="object-card-empty">${s("no_tasks_yet",e)}</div>`:p}
        </div>
      `};return o`
      ...
      ${i?this._renderObjectsTable(c):this._groupByMode==="area"?o`
          ...
          `)}
        `:o`<div class="objects-grid">${c.map(g)}</div>`}
    ...
    `}_renderOverviewRow(e){let t=this._lang,i=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,a=0,l=Ge.ok,c=!1;if(i&&e.days_until_due!==null){let m=At(e.interval_days,e.days_until_due,e.interval_unit);a=m.pct,c=m.overflow,e.status==="overdue"?l=Ge.overdue:e.status==="due_soon"&&(l=Ge.due_soon)}let d=e.area_id?this.hass?.areas?.[e.area_id]?.name:null,g=e.responsible_user_id?this._userService?.getUserName(e.responsible_user_id):null,_=e.group_names.length>0||d||g;return o`
      <div class="task-row${e.enabled?"":" task-disabled"}">
        ...
        <span class="due-cell" @click=${()=>this._showTask(e.entry_id,e.task_id)}>
          ...
          ${e.trigger_config?this._renderTriggerProgress(e):!i&&e.trigger_active?o`<span style="color:var(--maint-triggered-color);font-weight:600">⚡</span>`:p}
    ...
    `}_openCompleteDialogForRow(e){let i=this._objects.find(a=>a.entry_id===e.entry_id)?.tasks.find(a=>a.id===e.task_id);this._openCompleteDialog(e.entry_id,e.task_id,e.task_name,this._features.checklists?i?.checklist:void 0,this._features.adaptive&&!!i?.adaptive_config?.enabled)}_renderTriggerProgress(e){let t=e.trigger_config??null;if(!t)return p;let i=t.type||"threshold",a=e.trigger_entity_info?.unit_of_measurement??"",l=0,c="";if(i==="threshold"){let _=e.trigger_current_value??null;if(_==null)return p;let m=t.trigger_above,v=t.trigger_below;if(m!=null){let b=v??0,x=m-b||1;l=Math.min(100,Math.max(0,(_-b)/x*100)),c=`${_.toFixed(1)} / ${m} ${a}`}else if(v!=null){let x=e.trigger_entity_info?.max??(v*2||100),f=x-v||1;l=Math.min(100,Math.max(0,(x-_)/f*100)),c=`${_.toFixed(1)} / ${v} ${a}`}else return p}else if(i==="counter"){let _=t.trigger_target_value||1,v=e.trigger_current_delta??null??e.trigger_current_value??null;if(v==null)return p;l=Math.min(100,Math.max(0,v/_*100)),c=`${v.toFixed(1)} / ${_} ${a}`}else if(i==="state_change"){let _=t.trigger_target_changes||1,m=e.trigger_current_value??null;if(m==null)return p;l=Math.min(100,Math.max(0,m/_*100)),c=`${Math.round(m)} / ${_}`}else if(i==="runtime"){let _=t.trigger_runtime_hours||100,m=e.trigger_current_value??null;if(m==null)return p;l=Math.min(100,Math.max(0,m/_*100)),c=`${m.toFixed(1)}h / ${_}h`}else if(i==="compound"){let _=t.compound_logic||t.operator||"AND",m=t.conditions?.length||0;c=`${_} (${m})`,l=e.trigger_active?100:0}else return p;let d=l>=100,g=l>90?"var(--error-color, #f44336)":l>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return o`
    ...
    `}_renderMiniSparkline(e){if(!e.trigger_config?.entity_id)return p;let t=e.trigger_config.entity_id,i=this._miniStatsData.get(t)||[],a=[];if(i.length>=2)a=i.map(E=>({ts:E.ts,val:E.val}));else{if(!e.history)return p;for(let E of e.history)E.trigger_value!=null&&a.push({ts:new Date(E.timestamp).getTime(),val:E.trigger_value})}if(e.trigger_current_value!=null&&a.push({ts:Date.now(),val:e.trigger_current_value}),a.length<2)return p;a.sort((E,W)=>E.ts-W.ts);let l=Cs,c=Is,d=a.map(E=>E.val),g=Math.min(...d),_=Math.max(...d),m=_-g||1;g-=m*.1,_+=m*.1;let v=a[0].ts,x=a[a.length-1].ts-v||1,f=E=>(E-v)/x*l,j=E=>2+(1-(E-g)/(_-g))*(c-4),L=a;if(L.length>ki){let E=Math.ceil(L.length/ki);L=L.filter((W,K)=>K%E===0||K===L.length-1)}let H=L.map(E=>`${f(E.ts).toFixed(1)},${j(E.val).toFixed(1)}`).join(" "),M=e.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return o`
    ...
    `}_renderObjectDetail(){if(!this._selectedEntryId)return p;let e=this._getObject(this._selectedEntryId);if(!e)return o`<p>Object not found.</p>`;let t=e.object,i=this._lang,a=this._isOperator,l=e.tasks.filter(d=>d.archived).length,c=e.tasks.filter(d=>this._showArchived||!d.archived);return o`
      <div class="detail-section">
        ...
        ${t.installation_date?o`<p class="meta">${s("installed",i)}: ${J(t.installation_date,i)}</p>`:p}
        ...
        ${e.tasks.length===0?o`<div class="empty-state-centered">
            ...
            </div>`:o`<div class="task-table">${[...c].sort((d,g)=>{let _={overdue:0,triggered:1,due_soon:2,ok:3};return(_[d.status]??9)-(_[g.status]??9)||(d.days_until_due??99999)-(g.days_until_due??99999)}).map(d=>o`
    ...
    `}_renderTabContent(e){switch(this._activeTab){case"overview":return this._renderOverviewTab(e);case"history":return this._renderHistoryTab(e);default:return p}}get _sparklineCtx(){return{lang:this._lang,detailStatsData:this._detailStatsData,hasStatsService:!!this._statsService,isCounterEntity:e=>this._isCounterEntity(e),rangeDays:this._chartRangeDays,setRangeDays:e=>this._setChartRange(e)}}_renderOverviewTab(e){let t=this._lang,i=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,a=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1,l=i||a,c=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,d=this._features.seasonal&&(e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12);return o`
      <div class="tab-content overview-tab">
        ...
        ${_i(e,this._sparklineCtx)}
        ${vi(e,t,this._features)}
        <div class="two-column-layout ${l?"":"single-column"}">
          ${l?o`
            <div class="left-column">
              ${this._renderRecommendationCard(e)}
              ${xi(e,t,this._features)}
            </div>
          `:p}
          <div class="right-column">
            ${wi(e,t,this._costDurationToggle,g=>{this._costDurationToggle=g})}
          </div>
        </div>
        ${c?fi(e,t):p}
        ${d?o`
    ...
    `}_renderHistoryFilters(e){let t=this._lang;return o`
      <div class="history-filters-new">
        <div class="filter-chips">
          ${["completed","skipped","reset","triggered"].map(i=>{let a=e.history.filter(l=>l.type===i).length;return a===0?p:o`
              <span class="filter-chip ${this._historyFilter===i?"active":""}"
                @click=${()=>{this._historyFilter=this._historyFilter===i?null:i}}>
                ${s(i,t)} (${a})
              </span>
            `})}
          ${this._historyFilter?o`<span class="filter-chip clear" @click=${()=>{this._historyFilter=null}}>${s("show_all",t)}</span>`:p}
        </div>
    ...
    `}_renderHistoryList(e){let t=this._lang,i=this._historyFilter?e.history.filter(a=>a.type===this._historyFilter):e.history;if(this._historySearch){let a=this._historySearch.toLowerCase();i=i.filter(l=>l.notes?.toLowerCase().includes(a))}return i.length===0?o`<p class="empty">${s("no_history",t)}</p>`:o`
    ...
    `}_renderHistoryEntry(e){let t=this._lang,i=["completed","reset","skipped"].includes(e.type);return o`
      <div class="history-entry">
        ...
        <div class="history-content">
          ...
          ${e.notes?o`<div>${e.notes}</div>`:p}
          <div class="history-details">
            ${e.cost!=null?o`<span>${s("cost",t)}: ${e.cost.toFixed(2)} ${this._budget?.currency_symbol||"\u20AC"}</span>`:p}
            ${e.duration!=null?o`<span>${s("duration",t)}: ${e.duration} min</span>`:p}
            ${e.trigger_value!=null?o`<span>${s("trigger_val",t)}: ${e.trigger_value}</span>`:p}
          </div>
        </div>
      </div>
    `}_openHistoryEdit(e){if(!this._selectedEntryId||!this._selectedTaskId)return;let t={entry_id:this._selectedEntryId,task_id:this._selectedTaskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null};this.shadowRoot?.querySelector("maintenance-history-edit-dialog")?.openEdit(t)}};S.styles=[Je,ei],u([y({attribute:!1})],S.prototype,"hass",2),u([y({type:Boolean,reflect:!0})],S.prototype,"narrow",2),u([y({attribute:!1})],S.prototype,"panel",2),u([h()],S.prototype,"_objects",2),u([h()],S.prototype,"_stats",2),u([h()],S.prototype,"_view",2),u([h()],S.prototype,"_selectedEntryId",2),u([h()],S.prototype,"_selectedTaskId",2),u([h()],S.prototype,"_filterStatus",2),u([h()],S.prototype,"_filterUser",2),u([h()],S.prototype,"_unsub",2),u([h()],S.prototype,"_chartRangeDays",2),u([h()],S.prototype,"_historyFilter",2),u([h()],S.prototype,"_budget",2),u([h()],S.prototype,"_groups",2),u([h()],S.prototype,"_detailStatsData",2),u([h()],S.prototype,"_miniStatsData",2),u([h()],S.prototype,"_features",2),u([h()],S.prototype,"_adminPanelUserIds",2),u([h()],S.prototype,"_operatorWriteEnabled",2),u([h()],S.prototype,"_defaultWarningDays",2),u([h()],S.prototype,"_actionLoading",2),u([h()],S.prototype,"_moreMenuOpen",2),u([h()],S.prototype,"_toastMessage",2),u([h()],S.prototype,"_overviewTab",2),u([h()],S.prototype,"_activeTab",2),u([h()],S.prototype,"_costDurationToggle",2),u([h()],S.prototype,"_historySearch",2),u([h()],S.prototype,"_sortMode",2),u([h()],S.prototype,"_objectSortMode",2),u([h()],S.prototype,"_groupByMode",2),u([h()],S.prototype,"_objectViewMode",2),u([h()],S.prototype,"_objectsTableColumns",2),u([h()],S.prototype,"_showArchived",2),S=u([Yt("maintenance-supporter-panel")],S);export{S as MaintenanceSupporterPanel};
