...
import{a as pe,b as It,c as mt,d as Pt,e as Gt,f as ue,g as he,h as ge}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-VX3YRPXQ.js";import{a as q,b as ve,c as be,d as fe,e as ye,f as xe,k as we,n as $e}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-6QREGF5E.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-IRBDXJHM.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-I45X4NWB.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-EKS6767F.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-I74MVKCC.js";import{b as Qt,c as _e}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-6THFHOTC.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-7RVKLMKK.js";import{a as Kt}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-GFIEOIQ2.js";import{a as me}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-UTGLHITF.js";import{a as E}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-6FH75SNN.js";import{A as jt,B as de,C as Lt,a as g,b as D,c as n,d as P,f as d,g as O,h as Yt,i as oe,j as le,k as j,l as _,m as Dt,n as Ot,o as Rt,p as a,q as At,r as L,s as ce,t as G,u as Q,v as zt,w as _t,z as kt}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-EUAUXBAN.js";var Ye=["assignee_pool","required_completion_fields","checklist","labels","history"],Ke=["checklist_progress"],Ge=["tasks","parts"],Qe=["manual_docs","battery_fleet_excluded"];function Xt(r,o,t=[]){for(let e of o)r[e]===void 0&&(r[e]=[]);for(let e of t)r[e]===void 0&&(r[e]={})}function Xe(r){let o=r;Xt(o,Ge),o.object&&typeof o.object=="object"&&Xt(o.object,Qe);for(let t of o.tasks)Xt(t,Ye,Ke);return r}function Tt(r){for(let o of r)Xe(o);return r}function Ze(r,o){if(o.objects)return o.objects;let t=o.delta||[],e=o.removed||[];if(!t.length&&!e.length)return null;let i=new Map(r.map(s=>[s.entry_id,s]));for(let s of t)i.set(s.entry_id,s);for(let s of e)i.delete(s);return[...i.values()]}function ke(r,o){return o.objects&&Tt(o.objects),o.delta&&Tt(o.delta),Ze(r,o)}var A={overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view",objectsCache:"msp-objects-cache",gettingStartedDismissed:"msp-gs-dismissed",batteryRosterSort:"ms_bf_roster_sort"};function X(r){try{return localStorage.getItem(r)}catch{return null}}function U(r,o){try{localStorage.setItem(r,o)}catch{}}var Je=168*3600*1e3;function je(){try{let r=X(A.objectsCache);if(!r)return null;let o=JSON.parse(r);return o.v!==Yt||!Number.isFinite(o.at)||Date.now()-o.at>Je||!Array.isArray(o.objects)||o.objects.length===0?null:{objects:o.objects,stats:o.stats??null}}catch{return null}}function Zt(r,o){if(!(!Array.isArray(r)||r.length===0))try{let t={v:Yt,at:Date.now(),objects:r,stats:o};U(A.objectsCache,JSON.stringify(t))}catch{}}var ti={days:1,weeks:7,months:30.4368,years:365.25};function Jt(r,o){return!r||r<=0?0:r*(ti[o||"days"]??1)}function Ft(r,o,t){let e=Jt(r,t);if(e<=0||o==null)return{pct:0,overflow:!1};let i=(e-o)/e*100;return{pct:Math.max(0,Math.min(100,i)),overflow:i>100}}function R(r){return String(r??"").replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o])}function Te(r,o,t,e,i,s){let l=[[t.manufacturer,r.manufacturer],[t.model,r.model],[t.serial,r.serial_number],[t.installed,r.installation_date?e(r.installation_date):null],[t.warranty,r.warranty_expiry?e(r.warranty_expiry):null]].filter(([,p])=>!!p),u=o.map(p=>{let h=t.scheduleLabel(p);return`<tr>
      <td>${R(p.name)}</td>
      <td>${R(t.typeLabel(p.type))}</td>
      <td>${R(t.statusLabel(p.status))}</td>
      <td>${R(h)}</td>
      <td>${R(p.last_performed?e(p.last_performed):t.none)}</td>
      <td>${R(p.next_due?e(p.next_due):t.none)}</td>
      <td class="num">${p.times_performed??0}</td>
      <td class="num">${(p.total_cost??0).toFixed(2)} ${R(i)}</td>
    </tr>`}).join(""),c=o.reduce((p,h)=>p+(h.total_cost??0),0);return`<!DOCTYPE html><html><head><meta charset="utf-8">
<meta name="color-scheme" content="light">
<title>${R(t.title)} \u2014 ${R(r.name)}</title>
<style>
  ...
  * { box-sizing: border-box; }
  ...
  <h1>${R(r.name)}</h1>
  <p class="sub">${R(t.title)} \xB7 ${R(t.generated)}: ${R(e(s))}</p>
  ${l.length?`<div class="meta">${l.map(([p,h])=>`<div><div class="k">${R(p)}</div>${R(h)}</div>`).join("")}</div>`:""}
  <h2>${R(t.tasksHeading)} (${o.length})</h2>
  <table>
    <thead><tr>
      <th>${R(t.colTask)}</th><th>${R(t.colType)}</th><th>${R(t.colStatus)}</th>
      <th>${R(t.colSchedule)}</th><th>${R(t.colLastDone)}</th><th>${R(t.colNextDue)}</th>
      <th class="num">${R(t.colTimes)}</th><th class="num">${R(t.colCost)}</th>
    </tr></thead>
    <tbody>${u||`<tr><td colspan="8">${R(t.none)}</td></tr>`}</tbody>
    <tfoot><tr><td colspan="7">${R(t.totalCost)}</td><td class="num">${c.toFixed(2)} ${R(i)}</td></tr></tfoot>
  </table>
  ${r.notes?`<div class="notes"><strong>${R(t.notes)}:</strong>
${R(r.notes)}</div>`:""}
</body></html>`}function te(r,o=new Date){if(!r)return{kind:"none",days:null,date:null};let t=new Date(`${r}T00:00:00`);if(isNaN(t.getTime()))return{kind:"none",days:null,date:null};let e=Date.UTC(o.getFullYear(),o.getMonth(),o.getDate()),i=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),s=Math.round((i-e)/864e5);return s<0?{kind:"expired",days:s,date:r}:s<=60?{kind:"expiring",days:s,date:r}:{kind:"valid",days:s,date:r}}var z=r=>String(r??"").replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o]);function Se(r,o,t,e,i,s,l,u,c,p=[]){let h=[[t.object,z(o)],[t.type,z(t.typeLabel(r.type))],[t.interval,z(i(r))],[t.nextDue,r.next_due?z(e(r.next_due)):"\u2014"],[t.lastDone,r.last_performed?z(e(r.last_performed)):z(t.never)]];r.priority&&r.priority!=="normal"&&h.push([t.priority,z(r.priority)]);let m=(r.checklist||[]).map(b=>`<li><span class="box"></span>${z(b)}</li>`).join(""),v=(b,y)=>b?`<figure class="qr"><img src="${b}" alt="" /><figcaption>${z(y)}</figcaption></figure>`:"";return`<!DOCTYPE html>
...
<body>
  ...
  <table class="meta">
    ${h.map(([b,y])=>`<tr><td>${z(b)}</td><td>${y}</td></tr>`).join("")}
  </table>
...
`;var Ht=class{constructor(o){this._cache=new Map;this._pending=new Map;this._hass=o}updateHass(o){this._hass=o}async getDetailStats(o,t,e=30){return this._getStats(o,e<=35?"hour":"day",e,t)}async getMiniStats(o,t){return this._getStats(o,"day",14,t)}async getBatchMiniStats(o){let t=new Map,e=[];for(let c of o){let p=`${c.entityId}:day:14`,h=this._cache.get(p);h&&Date.now()-h.fetchedAt<3e5?t.set(c.entityId,h.points):e.push(c)}if(e.length===0)return t;let i=e.filter(c=>c.isCounter).map(c=>c.entityId),s=e.filter(c=>!c.isCounter).map(c=>c.entityId),l=new Date(Date.now()-336*60*60*1e3).toISOString(),u=[];return i.length>0&&u.push(this._fetchBatch(i,"day",l,["state","sum","change"],!0,t)),s.length>0&&u.push(this._fetchBatch(s,"day",l,["mean","min","max"],!1,t)),await Promise.all(u),t}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(o,t,e,i){let s=`${o}:${t}:${e}`,l=this._cache.get(s);if(l&&Date.now()-l.fetchedAt<3e5)return l.points;if(this._pending.has(s))return this._pending.get(s);let u=this._fetchAndNormalize(o,t,e,i,s);this._pending.set(s,u);try{return await u}finally{this._pending.delete(s)}}async _fetchAndNormalize(o,t,e,i,s){let l=new Date(Date.now()-e*24*60*60*1e3).toISOString(),u=i?["state","sum","change"]:["mean","min","max"];try{let p=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:l,statistic_ids:[o],period:t,types:u}))[o]||[],h=this._normalizeRows(p,i);return this._cache.set(s,{entityId:o,fetchedAt:Date.now(),period:t,points:h}),h}catch(c){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${o}:`,c),[]}}async _fetchBatch(o,t,e,i,s,l){try{let u=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:e,statistic_ids:o,period:t,types:i});for(let c of o){let p=u[c]||[],h=this._normalizeRows(p,s);l.set(c,h),this._cache.set(`${c}:${t}:14`,{entityId:c,fetchedAt:Date.now(),period:t,points:h})}}catch(u){console.warn("[maintenance-supporter] Batch statistics fetch failed:",u)}}_normalizeRows(o,t){let e=[];for(let i of o){let s=null;if(t?s=i.state??null:s=i.mean??null,s===null)continue;let l={ts:i.start,val:s};t||(i.min!=null&&(l.min=i.min),i.max!=null&&(l.max=i.max)),e.push(l)}return e.sort((i,s)=>i.ts-s.ts),e}};function lt(r){let o=r??0;return o<1024?`${o} B`:o<1024*1024?`${(o/1024).toFixed(1)} KB`:`${(o/(1024*1024)).toFixed(1)} MB`}var ft=["manual","warranty","invoice","spare_parts","photo","other"],Bt={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"};function vt(r){return r.title||r.filename||r.url||""}var I=class extends O{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._hint="";this._addingLink=!1;this._linkUrl="";this._linkTitle="";this._category="manual";this._thumbs={};this._lightboxUrl="";this._editingId="";this._editTitle="";this._editCategory="manual";this._dragOver=!1;this._loadedFor=null;this._localeReady=!1}_isImage(t){return t.kind==="file"&&(t.mime||"").startsWith("image/")}async _sign(t){return It(this.hass,t.id)}get _lang(){return L(this.hass)}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,G(this._lang).then(()=>this.requestUpdate())),this.hass&&this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error="",this._thumbs={},this._loadThumbs()}catch(t){this._error=E(t,this._lang),this._loaded=!0}}async _loadThumbs(){await Promise.all(this._docs.filter(t=>this._isImage(t)).map(async t=>{try{let e=await this._sign(t);this._thumbs={...this._thumbs,[t.id]:e}}catch{}}))}_category_of(t){return(t.tags||[]).find(i=>ft.includes(i))||"other"}_labelKeydown(t){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),t.currentTarget.querySelector("input")?.click())}_onFileInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i),e.value=""}_onCameraInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i,"photo"),e.value=""}_onDrop(t){if(t.preventDefault(),this._dragOver=!1,!this.canWrite||this._busy)return;let e=Array.from(t.dataTransfer?.files??[]);e.length&&this._uploadFiles(e)}_onDragOver(t){this.canWrite&&(t.preventDefault(),this._dragOver=!0)}_onDragLeave(t){let e=t.relatedTarget;(!e||!t.currentTarget.contains(e))&&(this._dragOver=!1)}async _uploadFiles(t,e){let i=e??this._category;this._busy=!0,this._error="",this._hint="";let s=0,l=0;try{for(let u of t){let c=new FormData;c.append("entry_id",this.entryId),c.append("tags",i),c.append("file",u,u.name);let p=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:c});if(!p.ok){this._error=p.status===413?a("doc_too_large",this._lang):a("doc_upload_failed",this._lang);continue}let h=await p.json();h.duplicate_in_object?l++:h.deduped&&s++}l?this._hint=a("doc_dup_in_object",this._lang):s&&(this._hint=a("doc_deduped",this._lang)),await this._load()}catch{this._error=a("doc_upload_failed",this._lang)}finally{this._busy=!1}}async _download(t){try{await Pt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=E(e,this._lang)}}async _preview(t){if(this._isImage(t)){this._lightboxUrl=this._thumbs[t.id]||await this._sign(t);return}try{await mt(this.hass,t.id)}catch(e){this._error=E(e,this._lang)}}_openDoc(t){t.kind==="file"?this._preview(t):q(t.url)&&window.open(t.url,"_blank","noopener")}_startEdit(t){this._editingId=t.id,this._editTitle=t.title||"",this._editCategory=this._category_of(t),this._addingLink=!1,this._error=""}_cancelEdit(){this._editingId=""}async _saveEdit(t){let e=(t.tags||[]).filter(s=>!ft.includes(s)),i=t.kind==="file"?[this._editCategory,...e]:t.tags??[];this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,title:this._editTitle.trim()||t.filename||t.url||"",tags:i}),this._editingId="",await this._load()}catch(s){this._error=E(s,this._lang)}finally{this._busy=!1}}async _delete(t){let e=vt(t);if(window.confirm(a("doc_delete_confirm",this._lang).replace("{name}",e))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:t.id}),await this._load()}catch(i){this._error=E(i,this._lang)}finally{this._busy=!1}}}async _addLink(){let t=this._linkUrl.trim();if(t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/add_link",entry_id:this.entryId,url:t,title:this._linkTitle.trim()||null}),this._linkUrl="",this._linkTitle="",this._addingLink=!1,await this._load()}catch(e){this._error=E(e,this._lang,a("doc_link_invalid",this._lang))}finally{this._busy=!1}}}render(){let t=this._lang;return n`
      ...
      <div class="doc-header">
        ...
        ${this.canWrite?n`
              <div class="doc-actions">
                ...
                >
                  ${ft.map(e=>n`<option value=${e}>${a(`doc_cat_${e}`,t)}</option>`)}
                </select>
                <label
    ...
    `}_renderEdit(t,e){let i=t.kind==="file";return n`
      <div class="doc-row editing">
        ...
        ${i?n`<select
            ...
            >
              ${ft.map(s=>n`<option value=${s} ?selected=${s===this._editCategory}>${a(`doc_cat_${s}`,e)}</option>`)}
            </select>`:d}
  ...
  `,g([j({attribute:!1})],I.prototype,"hass",2),g([j({attribute:!1})],I.prototype,"entryId",2),g([j({type:Boolean})],I.prototype,"canWrite",2),g([_()],I.prototype,"_docs",2),g([_()],I.prototype,"_loaded",2),g([_()],I.prototype,"_busy",2),g([_()],I.prototype,"_error",2),g([_()],I.prototype,"_hint",2),g([_()],I.prototype,"_addingLink",2),g([_()],I.prototype,"_linkUrl",2),g([_()],I.prototype,"_linkTitle",2),g([_()],I.prototype,"_category",2),g([_()],I.prototype,"_thumbs",2),g([_()],I.prototype,"_lightboxUrl",2),g([_()],I.prototype,"_editingId",2),g([_()],I.prototype,"_editTitle",2),g([_()],I.prototype,"_editCategory",2),g([_()],I.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",I);var Z=class extends O{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._loadedKey="";this._localeReady=!1}get _lang(){return L(this.hass)}get _refId(){return this.partId||this.taskId||""}get _linkField(){return this.partId?"part_ids":"task_ids"}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,G(this._lang).then(()=>this.requestUpdate()));let e=`${this.entryId}|${this._refId}`;this.hass&&this.entryId&&this._refId&&this._loadedKey!==e&&(this._loadedKey=e,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error=""}catch(t){this._error=E(t,this._lang),this._loaded=!0}}_links(t){return t[this._linkField]||[]}_linked(){return this._docs.filter(t=>this._links(t).includes(this._refId))}_available(){return this._docs.filter(t=>!this._links(t).includes(this._refId))}async _setLinks(t,e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,[this._linkField]:e}),await this._load()}catch(i){this._error=E(i,this._lang)}finally{this._busy=!1}}_link(){let t=this._docs.find(e=>e.id===this._attachId);t&&(this._attachId="",this._setLinks(t,[...this._links(t),this._refId]))}_unlink(t){this._setLinks(t,this._links(t).filter(e=>e!==this._refId))}_isPdf(t){return t.mime==="application/pdf"||(t.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(t){return this._isPdf(t)&&this.taskId?t.task_pages?.[this.taskId]:void 0}async _open(t){if(t.kind==="weblink"){q(t.url)&&window.open(t.url,"_blank","noopener");return}let e=this._pageFor(t);try{await mt(this.hass,t.id,e?`#page=${e}`:"")}catch(i){this._error=E(i,this._lang)}}async _setPage(t,e){if(this.taskId){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,task_pages:{[this.taskId]:e}}),await this._load()}catch(i){this._error=E(i,this._lang)}finally{this._busy=!1}}}async _download(t){try{await Pt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=E(e,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return d;let t=this._lang,e=this._linked(),i=this._available();return n`
      <div class="task-docs">
        ...
        ${this.canWrite&&i.length?n`<div class="tdoc-attach">
              ...
              >
                ...
                ${i.map(s=>n`<option value=${s.id} ?selected=${s.id===this._attachId}>${vt(s)}</option>`)}
              </select>
    ...
    `}_renderRow(t,e){let i=t.kind==="file",s=this._isPdf(t),l=this._pageFor(t),u=(t.tags||[]).find(p=>ft.includes(p))||"other",c=i?lt(t.size):a("doc_link_badge",e);return n`
      <div class="tdoc-row">
        <ha-icon class="tdoc-icon" icon=${i?Bt[u]:"mdi:link-variant"}></ha-icon>
        <div
          class="tdoc-info"
          role="button"
          tabindex="0"
  ...
  `,g([j({attribute:!1})],Z.prototype,"hass",2),g([j({attribute:!1})],Z.prototype,"entryId",2),g([j({attribute:!1})],Z.prototype,"taskId",2),g([j({attribute:!1})],Z.prototype,"partId",2),g([j({type:Boolean})],Z.prototype,"canWrite",2),g([_()],Z.prototype,"_docs",2),g([_()],Z.prototype,"_loaded",2),g([_()],Z.prototype,"_busy",2),g([_()],Z.prototype,"_error",2),g([_()],Z.prototype,"_attachId",2);customElements.get("maintenance-task-documents")||customElements.define("maintenance-task-documents",Z);var ei={name:"",vendor:"",mpn:"",gtin:"",storage_location:"",product_url:"",unit:"",cost:"",stock:"",reorder_threshold:"",restock_quantity:"",auto_buy_task:!0,notes:""},W=class extends O{constructor(){super(...arguments);this.parts=[];this.canWrite=!1;this.currencySymbol="\u20AC";this._editing=null;this._busy=!1;this._error="";this._restockFor=null;this._restockQty="";this._restockInvalid=!1;this._docsFor=null}get _lang(){return L(this.hass)}connectedCallback(){super.connectedCallback(),G(this._lang).then(()=>this.requestUpdate())}_notifyChanged(){this.dispatchEvent(new CustomEvent("parts-changed",{bubbles:!0,composed:!0}))}async _send(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t)}catch(e){return this._error=E(e,this._lang),null}finally{this._busy=!1}}_openAdd(){this._editing={...ei}}_openEdit(t){this._editing={id:t.id,name:t.name,vendor:t.vendor||"",mpn:t.mpn||"",gtin:t.gtin||"",storage_location:t.storage_location||"",product_url:t.product_url||"",unit:t.unit||"",cost:t.cost!=null?String(t.cost):"",stock:t.stock!=null?String(t.stock):"",reorder_threshold:t.reorder_threshold!=null?String(t.reorder_threshold):"",restock_quantity:t.restock_quantity!=null?String(t.restock_quantity):"",auto_buy_task:!!t.auto_buy_task,notes:t.notes||""}}_formValue(t){let e=i=>i.trim()===""?null:Number(i);return{entry_id:this.entryId,name:t.name.trim(),vendor:t.vendor.trim()||null,mpn:t.mpn.trim()||null,gtin:t.gtin.trim()||null,storage_location:t.storage_location.trim()||null,product_url:t.product_url.trim()||null,unit:t.unit.trim()||null,cost:e(t.cost),stock:e(t.stock),reorder_threshold:e(t.reorder_threshold),restock_quantity:e(t.restock_quantity),auto_buy_task:t.auto_buy_task,notes:t.notes.trim()||null}}async _save(){let t=this._editing;if(!t||!t.name.trim())return;let e=this._formValue(t),i=t.id?"maintenance_supporter/part/update":"maintenance_supporter/part/create";await this._send(t.id?{type:i,part_id:t.id,...e}:{type:i,...e})!==null&&(this._editing=null,this._notifyChanged())}async _delete(t){if(!window.confirm(a("part_delete_confirm",this._lang).replace("{name}",t.name)))return;await this._send({type:"maintenance_supporter/part/delete",entry_id:this.entryId,part_id:t.id})!==null&&this._notifyChanged()}async _restock(t){let e=parseFloat(this._restockQty);if(!Number.isFinite(e)||e===0){this._restockInvalid=!0;return}this._restockInvalid=!1;let i=await this._send({type:"maintenance_supporter/part/restock",entry_id:this.entryId,part_id:t.id,delta:e});this._restockFor=null,i!==null&&(t.stock=i.stock,this.requestUpdate(),this._notifyChanged())}_identLine(t){return[t.vendor,t.mpn?`MPN: ${t.mpn}`:"",t.gtin?`GTIN: ${t.gtin}`:""].filter(Boolean).join(" \xB7 ")}_renderRow(t){let e=this._lang,i=t.stock!==null&&t.stock!==void 0,s=this._identLine(t),l=this._docsFor===t.id;return n`
      <div class="part-row ${t.is_low?"low":""}">
        ...
        <div class="part-main">
          <div class="part-name">
            ${q(t.shopping_url)?n`<a href=${t.shopping_url} target="_blank" rel="noopener noreferrer">${t.name}</a>`:t.name}
  ...
  `,g([j({attribute:!1})],W.prototype,"hass",2),g([j({attribute:!1})],W.prototype,"entryId",2),g([j({attribute:!1})],W.prototype,"parts",2),g([j({type:Boolean})],W.prototype,"canWrite",2),g([j({attribute:!1})],W.prototype,"currencySymbol",2),g([_()],W.prototype,"_editing",2),g([_()],W.prototype,"_busy",2),g([_()],W.prototype,"_error",2),g([_()],W.prototype,"_restockFor",2),g([_()],W.prototype,"_restockQty",2),g([_()],W.prototype,"_restockInvalid",2),g([_()],W.prototype,"_docsFor",2);customElements.define("maintenance-parts-section",W);var J=class J extends O{constructor(){super(...arguments);this.flat=!1;this._ov=null;this._loading=!1;this._marking=!1;this._error="";this._history=null;this._rosterSort=J._storedSort();this._typeFilter=null;this._recorded=[];this._historyRequested=!1;this._localeReady=!1;this._markAll=async()=>{await this._mark(void 0)};this._repair=async()=>{if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/setup",language:this._lang}),await this._load()}catch(t){this._error=E(t,this._lang)}finally{this._marking=!1}}};this._loadHistory=async t=>{if(!(!t.target.open||this._historyRequested)){this._historyRequested=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview_history"});this._history=e.series}catch{this._history=null}}}}get _lang(){return L(this.hass)}connectedCallback(){super.connectedCallback(),this.hass&&this._load()}updated(t){t.has("hass")&&this.hass&&!this._localeReady&&(this._localeReady=!0,G(this._lang).then(()=>this.requestUpdate()),this._ov===null&&!this._loading&&this._load())}async _load(){this._loading=!0,this._error="";try{this._ov=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview"})}catch(t){this._error=E(t,this._lang)}finally{this._loading=!1}}async _mark(t){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/mark_replaced",...t?{entity_ids:t}:{}}),await this._load()}catch(e){this._error=E(e,this._lang)}finally{this._marking=!1}}}async _setExcluded(t,e){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/set_excluded",entity_id:t,excluded:e}),await this._load()}catch(i){this._error=E(i,this._lang)}finally{this._marking=!1}}}async _addBattery(t){let e=t.detail?.value;if(!(!e||this._marking)){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/set_included",entity_id:e,included:!0}),await this._load()}catch(i){this._error=E(i,this._lang)}finally{this._marking=!1}}}async _setTrackSelf(t){let e=t.target.checked;if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/set_track_self_charging",enabled:e}),await this._load()}catch(i){this._error=E(i,this._lang)}finally{this._marking=!1}}}_sparkline(t){let e=this._history?.[t.entity_id];if(!e||e.points.length<2)return d;let i=110,s=24,l=2,u=e.points[0][0],c=e.points[e.points.length-1][0],p=Date.now()/1e3,h=t.status!=="low"&&t.predicted_source==="trend"&&t.days_until!=null?p+t.days_until*86400:null,m=Math.max(c,h??c),v=M=>m===u?l:l+(M-u)/(m-u)*(i-2*l),b=M=>l+(1-Math.min(100,Math.max(0,M))/100)*(s-2*l),y=e.points.map(([M,B])=>`${v(M).toFixed(1)},${b(B).toFixed(1)}`).join(" "),w=e.points[e.points.length-1][1],S=b(e.threshold).toFixed(1);return n`<svg
    ...
    >
      ...
      ${h!==null?n`<line
            ...
            y2=${S}
          ></line>`:d}
    </svg>`}static _storedSort(){return X(A.batteryRosterSort)==="name"?"name":"urgency"}_setSort(t){this._rosterSort=t,U(A.batteryRosterSort,t)}_sortedRoster(t){let e=this._typeFilter===null?t:t.filter(s=>s.battery_type===this._typeFilter);if(this._rosterSort==="name")return e;let i=s=>s.status==="low"?-1e3+(s.level??101)/101:s.days_until??1/0;return[...e].sort((s,l)=>i(s)-i(l)||s.device_name.localeCompare(l.device_name))}_predictedDate(t){return this._fmtDate(Date.now()+t*864e5)}_fmtDate(t){return new Intl.DateTimeFormat(this._lang,{day:"numeric",month:"numeric",year:"numeric"}).format(new Date(t))}_shoppingLine(t){return Object.entries(t).map(([e,i])=>n`<button
  ...
  `,g([j({attribute:!1})],J.prototype,"hass",2),g([j({type:Boolean})],J.prototype,"flat",2),g([_()],J.prototype,"_ov",2),g([_()],J.prototype,"_loading",2),g([_()],J.prototype,"_marking",2),g([_()],J.prototype,"_error",2),g([_()],J.prototype,"_history",2),g([_()],J.prototype,"_rosterSort",2),g([_()],J.prototype,"_typeFilter",2),g([_()],J.prototype,"_recorded",2);var ee=J;customElements.get("maintenance-battery-fleet-section")||customElements.define("maintenance-battery-fleet-section",ee);var Me=5;function St(r){let o=r.getFullYear(),t=String(r.getMonth()+1).padStart(2,"0"),e=String(r.getDate()).padStart(2,"0");return`${o}-${t}-${e}`}function ii(r,o){let t=[];for(let e=0;e<o;e++){let i=new Date(r);i.setDate(i.getDate()+e),i.setHours(0,0,0,0),t.push(St(i))}return t}function Nt(r,o){let[t,e,i]=r.split("-").map(Number),s=new Date(t,e-1,i);return s.setDate(s.getDate()+o),St(s)}function si(r){if(!r||r.length===0)return null;let o=r.map(t=>t.cost).filter(t=>typeof t=="number");return o.length===0?null:o.reduce((t,e)=>t+e,0)/o.length}function ai(r){let{windowStart:o,windowEnd:t,task:e,entryId:i,objectName:s}=r,l=[],u=(m,v)=>({date:m,entry_id:i,task_id:e.id,task_name:e.name,object_name:s,status:v&&(e.status==="overdue"||e.status==="triggered")?"ok":e.status,days_until_due:v?null:e.days_until_due??null,projected:v,schedule_type:e.schedule_type,interval_days:e.interval_days??null,interval_unit:e.interval_unit??null,responsible_user_id:e.responsible_user_id??null,avg_cost:si(e.history),adaptive_enabled:!!e.adaptive_config?.enabled,prediction_confidence:e.threshold_prediction_confidence??null}),c=Math.max(1,Math.round(Jt(e.interval_days,e.interval_unit)));if(e.status==="overdue"||e.status==="triggered"){if(l.push(u(o,!1)),e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0){let m=Nt(o,c),v=1;for(;m<=t&&v<Me;)l.push(u(m,!0)),v++,m=Nt(m,c)}return l}let p=e.next_due;if(typeof p!="string"||!p)return l;let h=p.slice(0,10);if(h>=o&&h<=t)l.push(u(h,!1));else if(h>t)return l;if(e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0){let m=Nt(h,c),v=l.length;for(;m<=t&&v<Me;)m>=o&&(l.push(u(m,!0)),v++),m=Nt(m,c)}return l}var Ce={overdue:0,triggered:1,due_soon:2,ok:3};function De(r,o,t,e=null){let i=ii(o,t),s=i[0],l=i[i.length-1],u=[];for(let p of r){let h=p.object?.name||"",m=p.entry_id,v=p.tasks||[];for(let b of v){if(e&&b.responsible_user_id!==e||b.enabled===!1)continue;let y=ai({windowStart:s,windowEnd:l,task:b,entryId:m,objectName:h});u.push(...y)}}let c=new Map;for(let p of i)c.set(p,[]);for(let p of u){let h=c.get(p.date);h&&h.push(p)}for(let[,p]of c)p.sort((h,m)=>{let v=Ce[h.status]??99,b=Ce[m.status]??99;if(v!==b)return v-b;if(h.projected!==m.projected)return h.projected?1:-1;let y=h.object_name.localeCompare(m.object_name);return y!==0?y:h.task_name.localeCompare(m.task_name)});return i.map(p=>({date:p,events:c.get(p)??[]}))}var ri={completed:"ok",reset:"ok",skipped:"due_soon",missed:"overdue",triggered:"triggered",trigger_replaced:"triggered",trigger_removed:"ok"};function ni(r,o){let t=[];for(let e=o-1;e>=0;e--){let i=new Date(r);i.setDate(i.getDate()-e),i.setHours(0,0,0,0),t.push(St(i))}return t}function Oe(r,o,t,e=null){let i=ni(o,t),s=i[0],l=i[i.length-1],u=new Map;for(let p of i)u.set(p,[]);for(let p of r){let h=p.object?.name||"",m=p.entry_id,v=p.tasks||[];for(let b of v){if(e&&b.responsible_user_id!==e)continue;let y=b.history||[];for(let w of y){if(typeof w?.timestamp!="string")continue;let S=w.timestamp.slice(0,10);if(S<s||S>l)continue;let M=u.get(S);if(!M)continue;let B=w.type??"completed";M.push({date:S,entry_id:m,task_id:b.id,task_name:b.name,object_name:h,status:ri[B]??"ok",days_until_due:null,projected:!1,schedule_type:b.schedule_type,interval_days:b.interval_days??null,responsible_user_id:b.responsible_user_id??null,avg_cost:typeof w.cost=="number"?w.cost:null,adaptive_enabled:!!b.adaptive_config?.enabled,prediction_confidence:null,history_timestamp:w.timestamp,history_type:B,history_cost:typeof w.cost=="number"?w.cost:null,history_notes:typeof w.notes=="string"?w.notes:null,history_duration:typeof w.duration=="number"?w.duration:null})}}}let c={completed:0,reset:1,skipped:2,triggered:3,trigger_replaced:4};for(let[,p]of u)p.sort((h,m)=>{let v=c[h.history_type??""]??99,b=c[m.history_type??""]??99;if(v!==b)return v-b;let y=h.object_name.localeCompare(m.object_name);return y!==0?y:h.task_name.localeCompare(m.task_name)});return i.map(p=>({date:p,events:u.get(p)??[]}))}var Re=D`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;function Ae(r){let o=window;o.customCards=o.customCards||[],o.customCards.some(t=>t.type===r.type)||o.customCards.push(r)}var et=class extends O{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(t){if(this._config={...t},t.past_days&&[30,90].includes(t.past_days)?this._pastDays=t.past_days:t.window_days&&[7,14,30,365].includes(t.window_days)&&(this._windowDays=t.window_days,this._pastDays=0),typeof t.user_filter=="string"&&(this._userFilter=t.user_filter),typeof t.object_filter=="string")this._objectFilter=t.object_filter,this._configuredObjects=[];else if(Array.isArray(t.object_filter)){let e=t.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=e.length===1?e[0]:"",this._configuredObjects=e.length>1?e:[]}}getCardSize(){return 6}get _lang(){return L(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(t){if(super.updated(t),At(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=e}catch{}}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){t();return}this._unsub=t}catch{}}_onEventClick(t){if(t.history_timestamp){this._openHistoryEntry(t);return}$e(t.entry_id,t.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:t.entry_id,task_id:t.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(t){try{let i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:t.entry_id})).tasks?.find(l=>l.id===t.task_id)?.history?.find(l=>l.timestamp===t.history_timestamp);if(!i||we({entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp,type:i.type||"completed",timestamp:i.timestamp||t.history_timestamp,notes:i.notes??null,cost:i.cost??null,duration:i.duration??null,completed_by:i.completed_by??null,used_parts:i.used_parts??null}))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return d;let t=this._lang,e=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,s=this._config.title,l=null;this._userFilter&&(l=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let u=f=>{let K=f.toLowerCase();return this._objects.find(tt=>tt.entry_id===f||tt.object.name.toLowerCase()===K)?.entry_id??null},c=new Set(this._configuredObjects.map(u).filter(f=>f!==null)),p=c.size?this._objects.filter(f=>c.has(f.entry_id)):this._objects,h=this._config.show_object_filter!==!1&&p.length>1,m=this._objectFilter?u(this._objectFilter):null,v=m&&p.some(f=>f.entry_id===m)?p.filter(f=>f.entry_id===m):p,b=new Date;b.setHours(0,0,0,0);let y=this._pastDays>0,w=y?Oe(v,b,this._pastDays,l):De(v,b,this._windowDays,l),S=St(b),M=this._windowDays===365||y,B=M?w.filter(f=>f.events.length>0):w,F=f=>{let K=`cal-status-${f.status}`,Y=f.projected?"cal-event-projected":"",tt=f.status==="overdue"&&f.days_until_due!=null?` (${_t(f.days_until_due,t)})`:"",V=f.projected&&f.interval_days?n`<span class="cal-event-recur">${f.interval_unit&&f.interval_unit!=="days"?`${f.interval_days} ${a("unit_"+f.interval_unit,t)}`:a("cal_every_n_days",t).replace("{n}",String(f.interval_days))}</span>`:d,rt=f.schedule_type==="sensor_based",pt=rt?n`<ha-icon class="cal-event-icon cal-source-sensor"
                ...
                icon="${f.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,gt=rt&&f.prediction_confidence&&f.status!=="triggered"&&!f.projected?n`<span class="cal-event-prediction cal-conf-${f.prediction_confidence}">
            ${a("cal_predicted",t)} · ${a(`cal_confidence_${f.prediction_confidence}`,t)}
          </span>`:d,N=this._stats?.budget?.currency_symbol||Rt,k=f.history_type?a(f.history_type,t):a(f.status,t);return n`
        <div class="cal-event ${Y}"
          @click=${()=>this._onEventClick(f)}>
          ${pt}
          <span class="cal-status-pill ${K}">${k}</span>
          <div class="cal-event-body">
            <div class="cal-event-title">${f.object_name} · ${f.task_name}${tt}</div>
            ${gt}
            ${V}
          </div>
          ${f.avg_cost!=null&&f.avg_cost>0?n`<span class="cal-event-cost">${f.avg_cost.toFixed(0)} ${N}</span>`:d}
        </div>
      `},T=f=>{let[K,Y,tt]=f.date.split("-").map(Number),V=new Date(K,Y-1,tt),rt=f.date===S,pt=V.toLocaleDateString(t,{weekday:"short"}),gt=V.toLocaleDateString(t,{month:"long"});return n`
        <div class="cal-day-row">
          <div class="cal-day-pill ${rt?"cal-today":""}">
            <span class="cal-pill-weekday">${pt}</span>
            <span class="cal-pill-day">${V.getDate()}</span>
          </div>
          <div class="cal-day-content">
            <div class="cal-day-header">
              <span class="cal-day-month">${gt}</span>
              ${rt?n`<span class="cal-day-today-badge">${a("today",t)}</span>`:d}
            </div>
            ${f.events.length===0?n`<div class="cal-empty">${a("cal_no_events",t)}</div>`:f.events.map(F)}
          </div>
        </div>
      `};return n`
      <ha-card .header=${s}>
    ...
    `],g([j({attribute:!1})],et.prototype,"hass",2),g([_()],et.prototype,"_config",2),g([_()],et.prototype,"_objects",2),g([_()],et.prototype,"_stats",2),g([_()],et.prototype,"_windowDays",2),g([_()],et.prototype,"_pastDays",2),g([_()],et.prototype,"_userFilter",2),g([_()],et.prototype,"_objectFilter",2),g([_()],et.prototype,"_unsub",2);var oi=[{value:7,key:"cal_editor_window_week"},{value:14,key:"cal_editor_window_fortnight"},{value:30,key:"cal_editor_window_month"},{value:365,key:"cal_editor_window_year"}],xt=class extends O{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}get _lang(){return L(this.hass)}setConfig(t){this._config={...t}}updated(){let t=this._lang;t&&!ce(t)&&G(t).then(()=>this.requestUpdate())}_valueChanged(t,e){let i={...this._config,[t]:e};t==="show_window_chips"&&e===!0&&delete i.show_window_chips,t==="show_user_filter"&&e===!0&&delete i.show_user_filter,t==="show_object_filter"&&e===!0&&delete i.show_object_filter,t==="title"&&(!e||typeof e=="string"&&e.trim()==="")&&delete i.title,t==="user_filter"&&e===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let t=this._lang,e=this._config.window_days??30,i=this._config.show_window_chips!==!1,s=this._config.show_user_filter!==!1,l=this._config.user_filter??"",u=this._config.title??"";return n`
      <div class="editor">
        ...
        <div class="row">
          ...
          >
            ${oi.map(c=>n`<option value="${c.value}" ?selected=${c.value===e}>${a(c.key,t)}</option>`)}
          </select>
        </div>
  ...
  `,g([j({attribute:!1})],xt.prototype,"hass",2),g([_()],xt.prototype,"_config",2);customElements.get("maintenance-supporter-calendar-card")||customElements.define("maintenance-supporter-calendar-card",et);customElements.get("maintenance-supporter-calendar-card-editor")||customElements.define("maintenance-supporter-calendar-card-editor",xt);Ae({type:"maintenance-supporter-calendar-card",name:"Maintenance Supporter \u2014 Calendar",description:"Rolling calendar of maintenance tasks with 7/14/30/365 day windows, source icons, and prediction-confidence pills.",preview:!0});var it=class extends O{constructor(){super(...arguments);this._open=!1;this._title="";this._message="";this._confirmText="";this._danger=!1;this._inputLabel="";this._inputType="";this._inputValue="";this._resolve=null;this._promptResolve=null}confirm(t){return this._title=t.title,this._message=t.message,this._confirmText=t.confirmText||"OK",this._danger=t.danger||!1,this._inputLabel="",this._inputType="",this._inputValue="",this._open=!0,new Promise(e=>{this._resolve=e,this._promptResolve=null})}prompt(t){return this._title=t.title,this._message=t.message,this._confirmText=t.confirmText||"OK",this._danger=t.danger||!1,this._inputLabel=t.inputLabel||"",this._inputType=t.inputType||"text",this._inputValue=t.inputValue||"",this._open=!0,new Promise(e=>{this._promptResolve=e,this._resolve=null})}_cancel(){this._open=!1,this._promptResolve&&(this._promptResolve({confirmed:!1,value:""}),this._promptResolve=null),this._resolve?.(!1),this._resolve=null}_confirmAction(){this._open=!1,this._promptResolve&&(this._promptResolve({confirmed:!0,value:this._inputValue}),this._promptResolve=null),this._resolve?.(!0),this._resolve=null}render(){if(!this._open)return d;let t=L(this.hass);return n`
  ...
  `],g([j({attribute:!1})],it.prototype,"hass",2),g([_()],it.prototype,"_open",2),g([_()],it.prototype,"_title",2),g([_()],it.prototype,"_message",2),g([_()],it.prototype,"_confirmText",2),g([_()],it.prototype,"_danger",2),g([_()],it.prototype,"_inputLabel",2),g([_()],it.prototype,"_inputType",2),g([_()],it.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",it);var st=class extends O{constructor(){super(...arguments);this.objects=[];this._summary=null;this._loaded=!1;this._busy=!1;this._error="";this._query="";this._results=[];this._expanded=!1;this._initiallyLoaded=!1;this._searchTimer=0}get _lang(){return L(this.hass)}updated(t){super.updated(t),t.has("hass")&&this.hass&&!this._initiallyLoaded&&(this._initiallyLoaded=!0,this._load(),G(this._lang).then(()=>this.requestUpdate()))}async _load(){this._busy=!0;try{this._summary=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/storage"}),this._error=""}catch(t){this._error=E(t,this._lang)}finally{this._loaded=!0,this._busy=!1}}_nameFor(t){return this.objects.find(i=>i.object?.id===t)?.object?.name||t.slice(0,8)}_entryFor(t){return this.objects.find(e=>e.object?.id===t)?.entry_id}_toggle(){this._expanded=!this._expanded}_openObject(t){this.dispatchEvent(new CustomEvent("open-object",{detail:{entry_id:t},bubbles:!0,composed:!0}))}_onSearch(t){this._query=t.target.value,clearTimeout(this._searchTimer),this._searchTimer=window.setTimeout(()=>{this._doSearch()},250)}async _doSearch(){let t=this._query.trim();if(!t){this._results=[];return}try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/search",query:t});this._results=e.results||[]}catch(e){this._error=E(e,this._lang),this._results=[]}}async _openResult(t){if(t.kind==="weblink"){q(t.url)&&window.open(t.url,"_blank","noopener");return}try{await mt(this.hass,t.id)}catch(e){this._error=E(e,this._lang)}}_renderResult(t,e){return n`
      <div class="obj-row result-row" title=${a("doc_open",e)} @click=${()=>this._openResult(t)}>
        ...
        <div class="result-info">
          <div class="result-title">${vt(t)}</div>
  ...
  `,g([j({attribute:!1})],st.prototype,"hass",2),g([j({attribute:!1})],st.prototype,"objects",2),g([_()],st.prototype,"_summary",2),g([_()],st.prototype,"_loaded",2),g([_()],st.prototype,"_busy",2),g([_()],st.prototype,"_error",2),g([_()],st.prototype,"_query",2),g([_()],st.prototype,"_results",2),g([_()],st.prototype,"_expanded",2);customElements.get("maintenance-storage-section-card")||customElements.define("maintenance-storage-section-card",st);var li=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"],nt=class extends O{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._error="";this._entryId="";this._taskId="";this._values=new Array(12).fill("");this._save=async()=>{let t=this._buildOverrides();if(t!==null){this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:t}),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(e){this._error=E(e,this._lang,a("save_error",this._lang))}finally{this._loading=!1}}};this._clearAll=async()=>{this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:{}}),this._values=new Array(12).fill(""),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(t){this._error=E(t,this._lang,a("save_error",this._lang))}finally{this._loading=!1}}}get _lang(){return L(this.hass)}open(t,e,i){if(this._entryId=t,this._taskId=e,this._values=new Array(12).fill(""),i)for(let[s,l]of Object.entries(i)){let u=parseInt(s,10);u>=1&&u<=12&&typeof l=="number"&&(this._values[u-1]=l.toString())}this._error="",this._open=!0}_close(){this._open=!1}_buildOverrides(){let t={};for(let e=0;e<12;e++){let i=this._values[e].trim();if(!i)continue;let s=parseFloat(i);if(Number.isNaN(s))return this._error=`${a("month_"+["jan","feb","mar","apr","may","jun","jul","aug","sep","oct","nov","dec"][e],this._lang)}: ${a("seasonal_override_invalid",this._lang)}`,null;if(s<.1||s>5)return this._error=a("seasonal_override_range",this._lang),null;t[e+1]=s}return t}render(){if(!this._open)return n``;let t=this._lang;return n`
  ...
  `,g([j({attribute:!1})],at.prototype,"hass",2),g([j({attribute:!1})],at.prototype,"objects",2),g([_()],at.prototype,"_open",2),g([_()],at.prototype,"_loading",2),g([_()],at.prototype,"_error",2),g([_()],at.prototype,"_groupId",2),g([_()],at.prototype,"_name",2),g([_()],at.prototype,"_description",2),g([_()],at.prototype,"_selected",2);customElements.get("maintenance-group-dialog")||customElements.define("maintenance-group-dialog",at);var ct=class extends O{constructor(){super(...arguments);this._open=!1;this._busy=!1;this._error="";this._name="";this._views=[];this._filters=null;this._localeReady=!1;this._save=async()=>{let t=this._name.trim();if(!(!t||this._busy||!this._filters)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/save",name:t,filters:this._filters});this._name="",this._emitChanged(e.views||[])}catch(e){this._error=E(e,this._lang)}finally{this._busy=!1}}};this._delete=async t=>{if(!this._busy){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/delete",view_id:t});this._emitChanged(e.views||[])}catch(e){this._error=E(e,this._lang)}finally{this._busy=!1}}}}get _lang(){return L(this.hass)}updated(t){t.has("hass")&&this.hass&&!this._localeReady&&(this._localeReady=!0,G(this._lang).then(()=>this.requestUpdate()))}async open(t,e){this._open=!0,this._error="",this._name="",this._filters=t,this._views=e}_close(){this._open=!1}_emitChanged(t){this._views=t,this.dispatchEvent(new CustomEvent("saved-views-changed",{bubbles:!0,composed:!0,detail:{views:t}}))}render(){if(!this._open)return n``;let t=this._lang;return n`
  ...
  `}function se(r,o,t){if(!r.trigger_config?.entity_id)return d;let e=r.trigger_config.entity_id,i=o.get(e)||[],s=[];if(i.length>=2)s=i.map(T=>({ts:T.ts,val:T.val}));else{if(!r.history)return d;for(let T of r.history)T.trigger_value!=null&&s.push({ts:new Date(T.timestamp).getTime(),val:T.trigger_value})}if(r.trigger_current_value!=null&&s.push({ts:Date.now(),val:r.trigger_current_value}),s.length<2)return d;s.sort((T,f)=>T.ts-f.ts);let l=ci,u=di,c=s.map(T=>T.val),p=Math.min(...c),h=Math.max(...c),m=h-p||1;p-=m*.1,h+=m*.1;let v=s[0].ts,y=s[s.length-1].ts-v||1,w=T=>(T-v)/y*l,S=T=>2+(1-(T-p)/(h-p))*(u-4),M=s;if(M.length>ze){let T=Math.ceil(M.length/ze);M=M.filter((f,K)=>K%T===0||K===M.length-1)}let B=M.map(T=>`${w(T.ts).toFixed(1)},${S(T.val).toFixed(1)}`).join(" "),F=r.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return n`
    <svg class="mini-sparkline" viewBox="0 0 ${l} ${u}" preserveAspectRatio="none" role="img" aria-label="${a("chart_mini_sparkline",t)}">
      <polyline points="${B}" fill="none" stroke="${F}" stroke-width="1.5" stroke-linejoin="round" />
    </svg>
  `}function Le(r,o){let t=o;if(r.days_until_due==null||!r.interval_days||r.interval_days<=0)return d;let{pct:e,overflow:i}=Ft(r.interval_days,r.days_until_due,r.interval_unit),s="var(--success-color, #4caf50)";return r.status==="overdue"?s="var(--error-color, #f44336)":r.status==="due_soon"&&(s="var(--warning-color, #ff9800)"),n`
  ...
  `}function Et(r,o,t=4){if(!isFinite(r)||!isFinite(o))return{ticks:[],niceMin:0,niceMax:1};if(r===o){let p=Math.abs(r)*.1||1;r-=p,o+=p}let e=o-r,i=Math.pow(10,Math.floor(Math.log10(e/Math.max(1,t)))),s=i;for(let p of[1,2,5,10])if(s=i*p,e/s<=t+.5)break;let l=Math.floor(r/s)*s,u=Math.ceil(o/s)*s,c=[];for(let p=l;p<=u+s*1e-6;p+=s)c.push(Math.abs(p)<s*1e-9?0:p);return{ticks:c,niceMin:l,niceMax:u}}function dt(r){let o=Math.abs(r);return o>=1e6?wt((r/1e6).toFixed(o>=1e7?0:1))+"M":o>=1e4?wt((r/1e3).toFixed(0))+"k":o>=1e3?wt((r/1e3).toFixed(1))+"k":o>=100?r.toFixed(0):o>=10||o>=1?wt(r.toFixed(1)):o===0?"0":wt(r.toFixed(2))}function wt(r){return r.replace(/\.0+$/,"").replace(/(\.\d*[1-9])0+$/,"$1")}function yt(r,o,t){let e=r.toLocaleString(t,{maximumFractionDigits:Math.abs(r)>=100?0:1});return o?`${e} ${o}`:e}function $t(r,o,t){let e=new Date(r),i=t?{month:"short",day:"numeric",year:"2-digit"}:{month:"short",day:"numeric"};return e.toLocaleDateString(o,i)}function ae(r,o){return new Date(r).toLocaleDateString(o,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}function Ut(r,o){return new Date(r).getFullYear()!==new Date(o).getFullYear()}function Vt(r,o,t){if(t<2||o<=r)return[r,o];let e=[];for(let i=0;i<t;i++)e.push(r+(o-r)*i/(t-1));return e}var qt=210,ot=46,ut=14,ht=12,Ie=14,pi=20+Ie,ui=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],H=class extends O{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(t=>{let e=Math.floor(t[0]?.contentRect?.width||0);e&&Math.abs(e-this._width)>2&&(this._width=e)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(t){t!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:t},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let t=this._width||320,e=[...this.points].sort((s,l)=>s.ts-l.ts),i=this.lang;return n`
    ...
    `}_renderSvg(t,e){let i=this.lang,s=t-ot-ut,l=qt-pi,u=l-ht,c=1/0,p=-1/0;for(let k of e)c=Math.min(c,k.min??k.val),p=Math.max(p,k.max??k.val);this.thresholdAbove!=null&&(c=Math.min(c,this.thresholdAbove),p=Math.max(p,this.thresholdAbove)),this.thresholdBelow!=null&&(c=Math.min(c,this.thresholdBelow),p=Math.max(p,this.thresholdBelow)),this.targetValue!=null&&(c=Math.min(c,this.targetValue),p=Math.max(p,this.targetValue)),this.forceZero&&(c=Math.min(c,0));let h=(p-c||1)*.06,m=this.forceZero&&c>=0?0:c-h,{ticks:v,niceMin:b,niceMax:y}=Et(m,p+h,4);this.forceZero&&c>=0&&b<0&&(b=0,v=v.filter(k=>k>=0));let w=e[0].ts,S=e[e.length-1].ts,M=S-w||1,B=Ut(w,S),F=k=>ot+(k-w)/M*s,T=k=>ht+(1-(k-b)/(y-b||1))*u,f=e.map(k=>`${F(k.ts).toFixed(1)},${T(k.val).toFixed(1)}`).join(" "),K=`M${F(e[0].ts).toFixed(1)},${l} `+e.map(k=>`L${F(k.ts).toFixed(1)},${T(k.val).toFixed(1)}`).join(" ")+` L${F(e[e.length-1].ts).toFixed(1)},${l} Z`,Y="",tt=e.filter(k=>k.min!=null&&k.max!=null);if(tt.length>=2){let k=tt.map(C=>`${F(C.ts).toFixed(1)},${T(C.max).toFixed(1)}`),x=[...tt].reverse().map(C=>`${F(C.ts).toFixed(1)},${T(C.min).toFixed(1)}`);Y=`M${k[0]} `+k.slice(1).map(C=>`L${C}`).join(" ")+` L${x.join(" L")} Z`}let V=[];if(this.thresholdBelow!=null){let k=T(this.thresholdBelow);V.push({y:k,h:Math.max(0,l-k),lineY:k,label:`\u25BC ${dt(this.thresholdBelow)}`,labelY:Math.min(l-4,k+13)})}if(this.thresholdAbove!=null){let k=T(this.thresholdAbove);V.push({y:ht,h:Math.max(0,k-ht),lineY:k,label:`\u25B2 ${dt(this.thresholdAbove)}`,labelY:Math.max(ht+11,k-5)})}let rt=e[e.length-1],pt=(this.events||[]).filter(k=>k.ts>=w&&k.ts<=S),gt=Vt(w,S,Math.max(2,Math.min(5,Math.floor(s/110)+1))),N=this._hover;return n`
      <div class="svg-holder">
        <svg
          ...
          @pointermove=${k=>this._onPointer(k,e,F,T,t)}
          @pointerdown=${k=>this._onPointer(k,e,F,T,t)}
          @pointerleave=${()=>this._hover=null}
        >
          <defs>
            <clipPath id="plot"><rect x="${ot}" y="${ht}" width="${s}" height="${u}" /></clipPath>
            ${V.length?P`<clipPath id="danger">${V.map(k=>P`<rect x="${ot}" y="${k.y.toFixed(1)}" width="${s}" height="${k.h.toFixed(1)}" />`)}</clipPath>`:d}
          ...
          ${v.map(k=>{let x=T(k);return x<ht-1||x>l+1?d:P`
              <line x1="${ot}" y1="${x.toFixed(1)}" x2="${t-ut}" y2="${x.toFixed(1)}"
                stroke="var(--divider-color)" stroke-width="1" opacity="0.6" />
              <text x="${ot-7}" y="${(x+3.5).toFixed(1)}" text-anchor="end" class="tick-label">${dt(k)}</text>`})}

          ${V.map(k=>P`<rect x="${ot}" y="${k.y.toFixed(1)}" width="${s}" height="${k.h.toFixed(1)}"
          ...
          ${V.length?P`<polyline points="${f}" fill="none" stroke="var(--error-color, #f44336)" stroke-width="2"
                stroke-linejoin="round" stroke-linecap="round" clip-path="url(#danger)" />`:d}

          ${V.map(k=>P`
              <line x1="${ot}" y1="${k.lineY.toFixed(1)}" x2="${t-ut}" y2="${k.lineY.toFixed(1)}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${t-ut-4}" y="${k.labelY.toFixed(1)}" text-anchor="end" class="zone-label">${k.label}</text>`)}
          ...
          ${this.projection&&this.projection.length===2?P`<line x1="${F(this.projection[0].ts).toFixed(1)}" y1="${T(this.projection[0].val).toFixed(1)}"
                x2="${Math.min(F(this.projection[1].ts),t-ut).toFixed(1)}" y2="${T(Math.max(b,Math.min(y,this.projection[1].val))).toFixed(1)}"
                stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.8" />`:d}

          ${gt.map((k,x)=>{let C=F(k),Wt=x===0?"start":x===gt.length-1?"end":"middle";return P`<text x="${C.toFixed(1)}" y="${qt-5}" text-anchor="${Wt}" class="tick-label">${$t(k,i,B)}</text>`})}

          <line x1="${ot}" y1="${l}" x2="${t-ut}" y2="${l}" stroke="var(--divider-color)" stroke-width="1" />

          ${pt.map(k=>{let x=F(k.ts),C=k.type==="completed"?"var(--success-color, #4caf50)":k.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return P`
              <line x1="${x.toFixed(1)}" y1="${ht}" x2="${x.toFixed(1)}" y2="${l}" stroke="${C}" stroke-width="1" opacity="0.14" />
              <rect x="${(x-1.5).toFixed(1)}" y="${l+3}" width="3" height="${Ie-6}" rx="1.5" fill="${C}">
          ...
          ${N?P`
                ...
                <circle cx="${N.x.toFixed(1)}" cy="${N.y.toFixed(1)}" r="4.5" fill="var(--primary-color)"
                  stroke="var(--card-background-color, #fff)" stroke-width="2" />`:P`<circle cx="${F(rt.ts).toFixed(1)}" cy="${T(rt.val).toFixed(1)}" r="4" fill="var(--primary-color)"
        ...
        ${N?n`<div
            ...
            >
              <div class="hover-date">${ae(N.p.ts,i)}</div>
              <div class="hover-val">
                ${yt(N.p.val,this.unit,i)}
    ...
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${v?n`
            ...
            <div class="trigger-entity-id">${c.map((y,w)=>n`${w>0?", ":""}<span class="entity-link" @click=${S=>jt(S,y)}>${y}</span>`)}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `:n`
            <div class="trigger-entity-name">${l}</div>
            <div class="trigger-entity-id">${u?n`<span class="entity-link" @click=${y=>jt(y,u)}>${u}</span>`:""}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `}
        </div>
      ...
      ${b?_i(b,e):h!=null?n`
              <div class="trigger-value-row">
                <span class="trigger-current ${r.trigger_active?"active":""}">${typeof h=="number"?yt(h,"",e):h}</span>
      ...
      <div class="trigger-limits">
        ...
        ${m==="compound"?n`
          ...
          ${(t.conditions||[]).map((y,w)=>n`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${w+1}. ${a(y.type||"unknown",e)}: ${y.entity_id?n`<span class="entity-link" @click=${S=>jt(S,y.entity_id)}>${y.entity_id}</span>`:""}</span>
          `)}
        `:d}
      </div>
      ...
      ${s&&s.length>1?n`
        <div class="trigger-entity-list">
          ${s.map(y=>n`
            <span class="trigger-entity-id">${y.friendly_name} (<span class="entity-link" @click=${w=>jt(w,y.entity_id)}>${y.entity_id}</span>)</span>
          `)}
        </div>
      `:d}
  ...
  `}function gi(r,o,t){let e=r.trigger_config,i=r.trigger_current_value;if(!e||i==null)return null;switch(e.type||"threshold"){case"counter":{let s=e.trigger_target_value;if(s==null||s<=0)return null;let l=Fe(r,He(r,t));return{progress:Math.max(0,i-(l?.value??i)),target:s,unit:o,meter:i}}case"state_change":{let s=e.trigger_target_changes;return s==null||s<=0?null:{progress:Math.max(0,i),target:s,unit:"",meter:null}}case"runtime":{let s=e.trigger_runtime_hours;return s==null||s<=0?null:{progress:Math.max(0,i),target:s,unit:"h",meter:null}}}return null}function Fe(r,o){if(r.trigger_baseline_value!=null)return{value:r.trigger_baseline_value,ts:re(r)};if(!o.length)return null;let t=re(r);if(t==null)return{value:o[0].val,ts:null};let e=o[0],i=Math.abs(o[0].ts-t);for(let s of o){let l=Math.abs(s.ts-t);l<i&&(e=s,i=l)}return{value:e.val,ts:t}}function re(r){let o=[...r.history].filter(t=>t.type==="completed"||t.type==="reset").sort((t,e)=>new Date(e.timestamp).getTime()-new Date(t.timestamp).getTime())[0];return o?new Date(o.timestamp).getTime():null}function _i(r,o){let t=Math.min(999,Math.round(r.progress/r.target*100)),e=t>=100?"over":t>=75?"near":"ok";return n`
    <div class="counter-progress">
      <div class="counter-progress-nums">
        <span class="counter-progress-main">${yt(r.progress,"",o)}<span class="counter-progress-target"> / ${yt(r.target,r.unit,o)}</span></span>
      ...
      <div class="counter-progress-caption">
        ${a("chart_since_service",o)}${r.meter!=null?n` · ${a("current",o)}: ${yt(r.meter,r.unit,o)}`:d}
      </div>
    </div>
  `}function He(r,o){let t=r.trigger_config;if(!t)return[];let e=t.type||"threshold",i=t.entity_id||"",s=e==="runtime"?[]:o.detailStatsData.get(i)||[],l=o.isCounterEntity(t),u=[];if(s.length>=2)for(let c of s){let p={ts:c.ts,val:c.val};!l&&c.min!=null&&c.max!=null&&(p.min=c.min,p.max=c.max),u.push(p)}else for(let c of r.history)c.trigger_value!=null&&u.push({ts:new Date(c.timestamp).getTime(),val:c.trigger_value});return r.trigger_current_value!=null&&u.push({ts:Date.now(),val:r.trigger_current_value}),u.sort((c,p)=>c.ts-p.ts),u}function mi(r,o,t){let e=r.trigger_config;if(!e)return d;let i=e.type||"threshold",s=e.entity_id||"",l=He(r,t);i==="runtime"&&e.trigger_runtime_hours&&r.trigger_current_value!=null&&(l=[{ts:re(r)??l[0]?.ts??Date.now()-864e5,val:0},{ts:Date.now(),val:Math.max(0,r.trigger_current_value)}]),t.hideOutliers&&(l=hi(l));let u=l.length<2&&!!s&&t.hasStatsService&&!t.detailStatsData.has(s);if(l.length<2&&!u)return d;let c=!!s&&t.detailStatsData.has(s)&&(t.detailStatsData.get(s)?.length??0)<2,p=Date.now()-t.rangeDays*864e5,h=l.filter(w=>w.ts>=p);h.length>=2&&(l=h);let m=null,v=!1;if(i==="counter"&&e.trigger_target_value!=null&&l.length){let w=Fe(r,l);if(w){if(w.ts!=null){let S=l.filter(M=>M.ts>=w.ts);S.length>=2&&(l=S)}l=l.map(S=>({...S,val:Math.max(0,S.val-w.value)}))}m=e.trigger_target_value,v=!0}else i==="state_change"&&e.trigger_target_changes?(m=e.trigger_target_changes,v=!0):i==="runtime"&&e.trigger_runtime_hours&&(m=e.trigger_runtime_hours,v=!0);let b=null;if(m==null&&r.degradation_rate!=null&&(r.degradation_trend!=="stable"||r.days_until_threshold!=null)&&r.degradation_trend!=="insufficient_data"&&l.length>=2){let w=l[l.length-1];b=[w,{ts:w.ts+30*864e5,val:w.val+r.degradation_rate*30}]}let y=r.history.filter(w=>["completed","skipped","reset"].includes(w.type)).map(w=>({ts:new Date(w.timestamp).getTime(),type:w.type}));return n`
  ...
  `}var vi=200,Mt=10,bi=22;function Be(r,o,t,e){let i=r.history.filter(u=>u.type==="completed"&&(u.cost!=null||u.duration!=null));if(i.length<2)return d;let s=i.some(u=>(u.cost??0)>0),l=i.some(u=>(u.duration??0)>0);return!s&&!l?d:n`
  ...
  `}function fi(r,o,t){let e=r.history.filter(x=>x.type==="completed"&&(x.cost!=null||x.duration!=null)).map(x=>({ts:new Date(x.timestamp).getTime(),cost:x.cost??0,duration:x.duration??0})).sort((x,C)=>x.ts-C.ts);if(e.length<2)return d;let i=e.some(x=>x.cost>0),s=e.some(x=>x.duration>0);if(!i&&!s)return d;let l=t!=="duration"&&i,u=t!=="cost"&&s,c=l||!u&&i,p=u||!l&&s,h=640,m=vi,v=c?44:12,b=p?44:12,y=h-v-b,w=m-bi,S=w-Mt,M=e[0].ts,B=e[e.length-1].ts,F=(B-M||864e5)*.05,T=M-F,f=B+F,K=Ut(M,B),Y=x=>v+(x-T)/(f-T)*y,tt=Et(0,Math.max(...e.map(x=>x.cost))||1,3),V=Et(0,Math.max(...e.map(x=>x.duration))||1,3),rt=x=>Mt+(1-x/(tt.niceMax||1))*S,pt=x=>Mt+(1-x/(V.niceMax||1))*S,gt=e.length>1?Math.min(...e.slice(1).map((x,C)=>Y(x.ts)-Y(e[C].ts))):y,N=Math.max(6,Math.min(22,gt*.55)),k=Vt(M,B,Math.max(2,Math.min(4,e.length)));return n`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${h} ${m}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${a("chart_history",o)}">
        ${c?tt.ticks.map(x=>{let C=rt(x);return C<Mt-1||C>w+1?d:P`
        ...
        ${p?V.ticks.map(x=>{let C=pt(x);return C<Mt-1||C>w+1?d:P`<text x="${h-b+6}" y="${(C+3.5).toFixed(1)}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="10.5">${dt(x)}m</text>`}):d}

        ${c?e.filter(x=>x.cost>0).map(x=>P`
          <rect x="${(Y(x.ts)-N/2).toFixed(1)}" y="${rt(x.cost).toFixed(1)}" width="${N.toFixed(1)}" height="${(w-rt(x.cost)).toFixed(1)}"
            fill="var(--primary-color)" opacity="0.6" rx="2">
            <title>${$t(x.ts,o,!0)}: ${x.cost.toLocaleString(o)}€${x.duration?` \xB7 ${x.duration}m`:""}</title>
          </rect>
        `):d}
        ${p?P`
          ...
          ${e.map(x=>P`
            <circle cx="${Y(x.ts).toFixed(1)}" cy="${pt(x.duration).toFixed(1)}" r="3.5" fill="var(--accent-color, #ff9800)">
              <title>${$t(x.ts,o,!0)}: ${x.duration}m${x.cost?` \xB7 ${x.cost.toLocaleString(o)}\u20AC`:""}</title>
            </circle>
          `)}
        `:d}

        <line x1="${v}" y1="${w}" x2="${h-b}" y2="${w}" stroke="var(--divider-color)" stroke-width="1" />
        ${k.map((x,C)=>{let Wt=C===0?"start":C===k.length-1?"end":"middle";return P`<text x="${Y(x).toFixed(1)}" y="${m-6}" text-anchor="${Wt}" fill="var(--secondary-text-color)" font-size="10">${$t(x,o,K)}</text>`})}
      </svg>
    </div>
  ...
  `}var bt=class extends O{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{this._url=await It(this.hass,this.docId)}catch{this._failed=!0}}render(){return this._failed||!this.docId?d:this._url?n`
      <a href=${this._url} target="_blank" rel="noopener" class="wrap">
        <img src=${this._url} alt="" loading="lazy"
          @error=${()=>this._failed=!0} />
      </a>`:n`<div class="ph"></div>`}};bt.styles=D`
  ...
  `,g([j({attribute:!1})],bt.prototype,"hass",2),g([j()],bt.prototype,"docId",2),g([_()],bt.prototype,"_url",2),g([_()],bt.prototype,"_failed",2);customElements.get("maintenance-history-photo")||customElements.define("maintenance-history-photo",bt);var yi=["completed","skipped","missed","reset","triggered","trigger_replaced","trigger_removed"];function Ne(r,o){let t=o.lang;return n`
    <div class="history-filters-new">
      <div class="filter-chips">
        ${yi.map(e=>{let i=r.history.filter(s=>s.type===e).length;return i===0?d:n`
  ...
  `}function Ue(r,o){let t=o.lang,e=o.filter?r.history.filter(i=>i.type===o.filter):r.history;if(o.search){let i=o.search.toLowerCase();e=e.filter(s=>s.notes?.toLowerCase().includes(i))}return e.length===0?n`<p class="empty">${a("no_history",t)}</p>`:n`
  ...
  `}function xi(r,o){let t=o.lang,e=["completed","reset","skipped"].includes(r.type);return n`
    <div class="history-entry">
      <div class="history-icon ${r.type}">
        <ha-icon .icon=${Ot[r.type]||"mdi:circle"}></ha-icon>
      </div>
  ...
  `:d}function wi(r,o){let t=o.lang,e=o.isOperator,i=r.archived?"archived":r.is_done?"done":r.status==="due_soon"?"warning":r.status||"ok",s=r.archived?a("archived",t):r.is_done?a("completed",t):a(r.status||"ok",t);return n`
  ...
  `}function $i(r){let o=r.lang;return n`
    <div class="tab-bar">
  ...
  `}function ki(r,o){if(!o.features.checklists)return d;let t=r.checklist||[];if(t.length===0)return d;let e=o.lang,i=r.checklist_progress||{},s=t.filter(l=>i[l]).length;return n`
  ...
  `}function ji(r,o){let t=q(r.documentation_url)?r.documentation_url:null,e=q(o.objectDocUrl)?o.objectDocUrl:null,i=e?null:(o.objectManualDocs||[])[0];if(!r.notes&&!t&&!e&&!i)return d;let s=o.lang;return n`
  ...
  `}function Ti(r,o){let t=o.lang,e=r.times_performed>0?r.total_cost/r.times_performed:0,i=r.days_until_due!==null&&r.days_until_due!==void 0?r.days_until_due<0?"overdue":r.days_until_due<=r.warning_days?"warning":"":"";return n`
    <div class="kpi-bar">
      <div class="kpi-card">
  ...
  `}function Si(r,o){let t=o.lang;if(!o.features.adaptive||!r.suggested_interval||r.suggested_interval===r.interval_days)return d;if(o.suggestionDismissed)return d;let e=r.suggested_interval;return n`
    <div class="recommendation-card">
      ...
      ${fe(r.interval_days,e,r.interval_confidence||"medium",t)}
  ...
  `}function Ei(r,o){let t=o.lang,e=r.history.slice(-3).reverse();if(e.length===0)return d;let i=s=>{switch(s){case"completed":return"\u2713";case"triggered":return"\u2297";case"skipped":return"\u21B7";case"reset":return"\u21BA";default:return"\xB7"}};return n`
  ...
  `}function Mi(r,o){let t=o.lang,e=o.features.adaptive&&r.suggested_interval&&r.suggested_interval!==r.interval_days,i=o.features.seasonal&&r.seasonal_factor&&r.seasonal_factor!==1,s=e||i,l=o.features.adaptive&&r.interval_analysis?.weibull_beta!=null&&r.interval_analysis?.weibull_eta!=null,u=o.features.seasonal&&(r.seasonal_factors?.length===12||r.interval_analysis?.seasonal_factors?.length===12);return n`
    <div class="tab-content overview-tab">
      ...
      <div class="two-column-layout ${s?"":"single-column"}">
        ...
        <div class="right-column">
          ${Be(r,t,o.costDurationToggle,c=>o.setCostDurationToggle(c))}
        </div>
      </div>
      ${l?Ve("weibull","weibull_reliability_curve",ve(r,t),o):d}
      ${u?Ve("seasonal","seasonal_chart_title",n`
            ${xe(r,t)}
  ...
  `}function Ci(r,o){return n`
    <div class="tab-content history-tab">
      ${Ne(r,o.history)}
      ${Ue(r,o.history)}
    </div>
  `}function Di(r,o){switch(o.activeTab){case"overview":return Mi(r,o);case"history":return Ci(r,o);default:return d}}function qe(r,o){return n`
  ...
  `}var Ct=class extends O{createRenderRoot(){return this}render(){return!this.task||!this.ctx?d:n`${qe(this.task,this.ctx)}`}};g([j({attribute:!1})],Ct.prototype,"task",2),g([j({attribute:!1})],Ct.prototype,"ctx",2);customElements.get("maintenance-task-detail-view")||customElements.define("maintenance-task-detail-view",Ct);function We(r){if(r.total<=0)return{start:0,end:0,padTop:0,padBottom:0};let o=r.overscan??12,t=Math.max(1,r.step??6),e=Math.max(1,r.rowHeight),i=Math.floor((r.scrollTop-r.listTop)/e),s=Math.ceil(r.viewportHeight/e)+1,l=Math.max(0,i-o);l=Math.floor(l/t)*t;let u=Math.min(r.total,Math.max(i,0)+s+o);return u=Math.min(r.total,Math.ceil(u/t)*t),l>=u&&(l=Math.min(l,Math.max(0,r.total-1)),u=Math.min(r.total,l+Math.max(s,1))),{start:l,end:u,padTop:l*e,padBottom:(r.total-u)*e}}var $=class extends O{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._allParts=null;this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._filterLabel=null;this._filterPriority="";this._savedViews=[];this._activeViewId="";this._unsub=null;this._chartRangeDays=(()=>{try{let t=parseInt(X(A.chartRange)||"",10);return[7,30,90,365].includes(t)?t:30}catch{return 30}})();this._hideOutliers=(()=>{try{return X(A.chartHideOutliers)==="1"}catch{return!1}})();this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._operatorWriteEnabled=!1;this._defaultWarningDays=7;this._actionLoading=!1;this._moreMenuOpen=!1;this._objMenuOpen=!1;this._toastMessage="";this._toastUndo=null;this._toastActionLabel="";this._filtersOpen=!1;this._newMenuOpen=!1;this._gsSetupsCount=0;this._gsAdoptCount=0;this._gsLoaded=!1;this._batteryFleetSetupAvailable=!1;this._staleBundle=!1;this._staleChecked=!1;this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab=(()=>{try{let t=X(A.overviewTab);return t==="today"||t==="calendar"?t:"dashboard"}catch{return"dashboard"}})();this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._objectViewMode="cards";this._objectsTableColumns=he;this._showArchived=!1;this._bulkMode=!1;this._bulkSelected=new Set;this._virtStart=0;this._virtEnd=0;this._virtRowHeight=53;this._virtTotalRows=0;this._virtScrollAttached=!1;this._virtRaf=0;this._collapsedSections=(()=>{try{return new Set(JSON.parse(X(A.collapsedSections)||"[]"))}catch{return new Set}})();this._paletteOpen=!1;this._paletteQuery="";this._paletteActive=0;this._templateGalleryOpen=!1;this._templates=[];this._templateCategories={};this._templateBusy=!1;this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=t=>this._onPopState(t);this._lazyUi=null;this._onVirtualScroll=()=>{this._virtRaf||(this._virtRaf=requestAnimationFrame(()=>{this._virtRaf=0,this._updateVirtualWindow()}))};this._deepLinkHandled=!1;this._paletteKeydown=t=>{if(t.key==="/"&&!t.ctrlKey&&!t.metaKey&&!t.altKey&&!this._paletteOpen){let i=t.composedPath()[0];if(i instanceof HTMLElement&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.tagName==="SELECT"||i.isContentEditable))return;t.preventDefault(),this._openPalette();return}if(!this._paletteOpen)return;let e=this._paletteResults;if(t.key==="Escape")t.preventDefault(),this._closePalette();else if(t.key==="ArrowDown")t.preventDefault(),this._paletteActive=Math.min(this._paletteActive+1,e.length-1);else if(t.key==="ArrowUp")t.preventDefault(),this._paletteActive=Math.max(this._paletteActive-1,0);else if(t.key==="Enter"){t.preventDefault();let i=e[this._paletteActive];i&&this._selectPaletteResult(i)}};this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=t=>{let e=t.detail;e?.type==="maintenance-supporter:open-task"&&e.entry_id&&e.task_id&&(t.stopPropagation(),this._showTask(e.entry_id,e.task_id))};this._fullHistory=null;this._onHistoryEntrySaved=async()=>{await this._loadData()}}get _currencySymbol(){return this._budget?.currency_symbol||Rt}get _lang(){return L(this.hass)}get _isOperator(){let t=this.hass?.user;return t?t.is_admin?!1:!(this._operatorWriteEnabled&&this._adminPanelUserIds.includes(t.id)):!0}_ensureLazyUi(){return this._lazyUi||(this._lazyUi=Promise.all([import("/maintenance_supporter_panelfiles/panel-chunks/object-dialog-YQGPVVEC.js"),import("/maintenance_supporter_panelfiles/panel-chunks/task-dialog-S3HOFJJG.js"),import("/maintenance_supporter_panelfiles/panel-chunks/complete-dialog-ZDVU6YG3.js"),import("/maintenance_supporter_panelfiles/panel-chunks/qr-dialog-MX2SXITR.js"),import("/maintenance_supporter_panelfiles/panel-chunks/adopt-problem-sensors-dialog-VQEDJN3B.js"),import("/maintenance_supporter_panelfiles/panel-chunks/suggested-setups-dialog-NAWTA2U5.js"),import("/maintenance_supporter_panelfiles/panel-chunks/settings-view-RPWJXOE2.js")]).then(()=>this.updateComplete)),this._lazyUi}async _ui(t){return await this._ensureLazyUi(),this.shadowRoot?.querySelector(t)??null}connectedCallback(){super.connectedCallback();let t=window.requestIdleCallback,e=()=>this._ensureLazyUi();t?t(e,{timeout:3e3}):window.setTimeout(e,1500),window.addEventListener("popstate",this._popstateHandler),window.addEventListener("keydown",this._paletteKeydown),window.addEventListener("resize",this._onVirtualScroll,{passive:!0});try{let i=X(A.taskSort);i&&["due_date","object","type","task_name","area","assigned_user","group"].includes(i)&&(this._sortMode=i);let s=X(A.objectSort);s&&["alphabetical","due_soonest","task_count"].includes(s)&&(this._objectSortMode=s);let l=X(A.groupBy);l&&["none","area","group","user"].includes(l)&&(this._groupByMode=l);let u=X(A.objectView);(u==="cards"||u==="table")&&(this._objectViewMode=u)}catch{}if(this._objects.length===0){let i=je();i&&(this._objects=i.objects,i.stats&&(this._stats=i.stats))}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),window.removeEventListener("keydown",this._paletteKeydown),window.removeEventListener("resize",this._onVirtualScroll),this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onVirtualScroll),this._virtScrollAttached=!1,this._virtRaf&&cancelAnimationFrame(this._virtRaf),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(t){if(super.updated(t),At(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Ht(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new me(this.hass),this._userService.getUsers())}let e=this.shadowRoot?.querySelector(".content");e&&!this._virtScrollAttached&&(e.addEventListener("scroll",this._onVirtualScroll,{passive:!0}),this._virtScrollAttached=!0),this._updateVirtualWindow()}_updateVirtualWindow(){let t=this.shadowRoot?.querySelector(".content"),e=this.shadowRoot?.querySelector(".task-table.virtual");if(!t||!e)return;let i=e.querySelector(".task-row:not(.virt-sizer)");i&&i.offsetHeight>20&&(this._virtRowHeight=i.offsetHeight);let s=e.getBoundingClientRect().top-t.getBoundingClientRect().top+t.scrollTop,l=We({scrollTop:t.scrollTop,viewportHeight:t.clientHeight,listTop:s,rowHeight:this._virtRowHeight,total:this._virtTotalRows});(l.start!==this._virtStart||l.end!==this._virtEnd)&&(this._virtStart=l.start,this._virtEnd=l.end)}async _loadData(){let[t,e,i,s,l,u]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"}).catch(()=>null)]);if(u&&(this._savedViews=u.views||[]),t&&(this._objects=Tt(t.objects),Zt(this._objects,e??this._stats??null),this._maybeLoadGettingStarted()),this._view==="task"&&this._selectedEntryId&&this._selectedTaskId&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/status"}).then(c=>{this._batteryFleetSetupAvailable=!!c.available&&!c.configured}).catch(()=>{this._batteryFleetSetupAvailable=!1}),this._staleChecked||(this._staleChecked=!0,this.hass.connection.sendMessagePromise({type:"maintenance_supporter/version"}).then(c=>{this._staleBundle=oe(c?.version)}).catch(()=>{})),e&&(this._stats=e),i&&(this._budget=i),s&&(this._groups=s.groups||{}),l){let c=l;this._features=c.features,this._adminPanelUserIds=c.admin_panel_user_ids||[],this._operatorWriteEnabled=c.operator_write_enabled??!1;let p=c.general?.default_warning_days;typeof p=="number"&&p>=0&&p<=365&&(this._defaultWarningDays=p),this._objectsTableColumns=ge(c.objects_table_columns)}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let t=new URLSearchParams(window.location.search),e=t.get("ms_action"),i=()=>{let h=window.location.pathname+window.location.hash;history.replaceState(history.state,"",h)};if(e==="add_object"){this._deepLinkHandled=!0,i(),this._ui("maintenance-object-dialog").then(h=>h?.openCreate());return}if(e==="open_vacation"||e==="open_budget"||e==="open_groups"||e==="open_settings"){this._deepLinkHandled=!0,i(),this._overviewTab="settings",this._ensureLazyUi().then(()=>requestAnimationFrame(()=>{let h=this.shadowRoot?.querySelector("maintenance-settings-view"),m=e.replace("open_","");h?.scrollToSection?.(m)}));return}let s=t.get("entry_id");if(!s)return;this._deepLinkHandled=!0;let l=t.get("task_id"),u=t.get("action"),c=window.location.pathname+window.location.hash;history.replaceState(history.state,"",c);let p=this._getObject(s);if(!p){this._showOverview();return}if(l){let h=p.tasks.find(m=>m.id===l);if(!h){this._showObject(s);return}this._showTask(s,l),u==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(s,l,h.name,this._features.checklists?h.checklist:void 0,this._features.adaptive&&!!h.adaptive_config?.enabled)}):u==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(s,l,h)})}else this._showObject(s)}_isCounterEntity(t){if(!t)return!1;let e=t.type||"threshold";return e==="counter"||e==="state_change"}async _fetchDetailStats(t,e){if(!this._statsService)return;let i=await this._statsService.getDetailStats(t,e,this._chartRangeDays),s=new Map(this._detailStatsData);s.set(t,i),this._detailStatsData=s}_setChartRange(t){if(t===this._chartRangeDays)return;this._chartRangeDays=t;try{U(A.chartRange,String(t))}catch{}let e=this._selectedEntryId&&this._selectedTaskId?this._getTask(this._selectedEntryId,this._selectedTaskId):null,i=e?.trigger_config?.entity_id;if(i){let s=new Map(this._detailStatsData);s.delete(i),this._detailStatsData=s,this._fetchDetailStats(i,this._isCounterEntity(e.trigger_config))}}_setHideOutliers(t){if(t!==this._hideOutliers){this._hideOutliers=t;try{U(A.chartHideOutliers,t?"1":"0")}catch{}}}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let t=[];for(let i of this._objects)for(let s of i.tasks){let l=s.trigger_config?.entity_id;l&&t.push({entityId:l,isCounter:this._isCounterEntity(s.trigger_config)})}if(t.length===0)return;let e=await this._statsService.getBatchMiniStats(t);this._miniStatsData=new Map([...this._miniStatsData,...e])}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e,s=ke(this._objects,i);s!==null&&(this._objects=s,e.objects&&Zt(s,this._stats??null))},{type:"maintenance_supporter/subscribe",deltas:!0,compact:!0});if(!this.isConnected){t();return}this._unsub=t}catch{}}get _taskRows(){let t=[];for(let m of this._objects)for(let v of m.tasks){if(!this._showArchived&&v.archived||this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let y=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==y)continue}if(this._filterLabel&&!(v.labels||[]).includes(this._filterLabel)||this._filterPriority&&(v.priority||"normal")!==this._filterPriority)continue;let b=[];for(let y of Object.values(this._groups))y.task_refs?.some(w=>w.entry_id===m.entry_id&&w.task_id===v.id)&&b.push(y.name);t.push({entry_id:m.entry_id,task_id:v.id,object_name:m.object.name,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_unit:v.interval_unit??null,interval_anchor:v.interval_anchor??null,is_done:v.is_done??!1,archived:v.archived??!1,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,priority:v.priority??"normal",labels:v.labels??[],area_id:m.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:b})}let e={overdue:0,triggered:1,due_soon:2,ok:3},i=(m,v)=>(e[m.status]??9)-(e[v.status]??9),s=(m,v)=>(m.days_until_due??99999)-(v.days_until_due??99999),l=(m,v)=>i(m,v)||s(m,v),u=m=>m.area_id&&this.hass?.areas?.[m.area_id]?.name||"",c=m=>m.responsible_user_id&&this._userService?.getUserName(m.responsible_user_id)||"",p=m=>m.group_names[0]||"",h={due_date:l,object:(m,v)=>m.object_name.localeCompare(v.object_name)||l(m,v),type:(m,v)=>m.type.localeCompare(v.type)||l(m,v),task_name:(m,v)=>m.task_name.localeCompare(v.task_name),area:(m,v)=>{let b=u(m),y=u(v);return!b&&y?1:b&&!y?-1:b.localeCompare(y)||l(m,v)},assigned_user:(m,v)=>{let b=c(m),y=c(v);return!b&&y?1:b&&!y?-1:b.localeCompare(y)||l(m,v)},group:(m,v)=>{let b=p(m),y=p(v);return!b&&y?1:b&&!y?-1:b.localeCompare(y)||l(m,v)}};return t.sort(h[this._sortMode]),t}_getObject(t){return this._objects.find(e=>e.entry_id===t)}_getTask(t,e){return this._getObject(t)?.tasks.find(s=>s.id===e)}_pushPanelState(t,e,i){let s={msp_view:t,msp_entry:e||null,msp_task:i||null};history.pushState(s,"")}_onPopState(t){let e=t.state;if(e?.msp_view&&(this._view=e.msp_view,this._selectedEntryId=e.msp_entry||null,this._selectedTaskId=e.msp_task||null,this._moreMenuOpen=!1,e.msp_view==="all_parts"&&this._loadAllParts(),e.msp_view==="task"&&e.msp_entry&&e.msp_task)){this._historyFilter=null;let i=this._getTask(e.msp_entry,e.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop()}_showAllParts(){this._pushPanelState("all_parts"),this._view="all_parts",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop(),this._loadAllParts()}async _loadAllParts(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"});this._allParts=t.parts||[]}catch{this._allParts=[]}}_filterByStatus(t){this._filterStatus=t,this._activeViewId="",this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),this._scrollContentToTop()}get _allLabels(){let t=new Set;for(let e of this._objects)for(let i of e.tasks)for(let s of i.labels||[])t.add(s);return[...t].sort((e,i)=>e.localeCompare(i))}get _currentFilters(){return{status:this._filterStatus,user_id:this._filterUser,label:this._filterLabel,priority:this._filterPriority,archived:this._showArchived,sort_mode:this._sortMode,group_by:this._groupByMode}}_applyView(t){if(this._activeViewId=t,!t)return;let e=this._savedViews.find(s=>s.id===t);if(!e)return;let i=e.filters;this._filterStatus=i.status||"",this._filterUser=i.user_id||null,this._filterLabel=i.label||null,this._filterPriority=i.priority||"",this._showArchived=!!i.archived,["due_date","object","type","task_name","area","assigned_user","group"].includes(i.sort_mode)&&(this._sortMode=i.sort_mode),["none","area","group","user"].includes(i.group_by)&&(this._groupByMode=i.group_by);try{U(A.taskSort,this._sortMode),U(A.groupBy,this._groupByMode)}catch{}this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard")}_openSavedViewsDialog(){this.shadowRoot.querySelector("maintenance-saved-views-dialog")?.open(this._currentFilters,this._savedViews)}_onSavedViewsChanged(t){this._savedViews=t.detail.views||[],this._activeViewId&&!this._savedViews.some(e=>e.id===this._activeViewId)&&(this._activeViewId="")}_scrollContentToTop(){requestAnimationFrame(()=>{let t=this.shadowRoot?.querySelector(".content");t&&t.scrollTo({top:0,behavior:"smooth"})})}_showObject(t){this._pushPanelState("object",t),this._view="object",this._selectedEntryId=t,this._selectedTaskId=null,this._scrollContentToTop()}_showTask(t,e){this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._scrollContentToTop(),this._fetchFullHistory(t,e);let i=this._getTask(t,e);if(i?.trigger_config?.entity_id){let s=i.trigger_config.entity_id,l=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(s,l)}}_showToast(t){this._toastTimer&&clearTimeout(this._toastTimer),this._toastUndo=null,this._toastActionLabel="",this._toastMessage=t,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}_showActionToast(t,e,i){this._showUndoToast(t,i),this._toastActionLabel=e}_showUndoToast(t,e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastActionLabel="",this._toastMessage=t,this._toastUndo=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastUndo=null,this._toastTimer=null},7e3)}_runToastUndo(){let t=this._toastUndo;this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage="",this._toastUndo=null,this._toastTimer=null,t?.()}_openPalette(){this._paletteQuery="",this._paletteActive=0,this._paletteOpen=!0,this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".palette-input")?.focus()})}_closePalette(){this._paletteOpen=!1,this._paletteQuery=""}get _paletteResults(){let t=this._paletteQuery.trim().toLowerCase(),e=[];for(let i of this._objects){let s=i.object.name||"";(!t||s.toLowerCase().includes(t))&&e.push({kind:"object",entryId:i.entry_id,label:s,sub:a("object",this._lang)});for(let l of i.tasks){if(l.archived)continue;let u=l.name||"",c=(l.labels||[]).some(p=>p.toLowerCase().includes(t));if(!t||u.toLowerCase().includes(t)||s.toLowerCase().includes(t)||c){let p=(l.labels||[]).length?`  #${(l.labels||[]).join(" #")}`:"";e.push({kind:"task",entryId:i.entry_id,taskId:l.id,label:u,sub:s+p})}}if(e.length>60)break}return e.slice(0,40)}_selectPaletteResult(t){this._closePalette(),t.kind==="task"&&t.taskId?this._showTask(t.entryId,t.taskId):this._showObject(t.entryId)}_renderPalette(){if(!this._paletteOpen)return d;let t=this._lang,e=this._paletteResults;return n`
    ...
    `}_statusBadge(t,e,i){let s=this._lang,l=t?"archived":e?"done":i,u=t?"archived":e?"completed":i,c=t?a("archived",s):e?a("completed",s):a(i,s);return n`<span class="status-badge ${l}"><ha-icon icon="${Ot[u]||"mdi:circle-medium"}"></ha-icon>${c}</span>`}_setOverviewTab(t){this._overviewTab=t;try{U(A.overviewTab,t)}catch{}this._scrollContentToTop()}_renderToday(){let t=this._lang,e=this._taskRows,i=p=>`${p.entry_id}:${p.task_id}`,s=e.filter(p=>p.status==="overdue"||p.trigger_active),l=new Set(s.map(i)),u=e.filter(p=>!l.has(i(p))&&p.days_until_due===0);u.forEach(p=>l.add(i(p)));let c=e.filter(p=>!l.has(i(p))&&p.days_until_due!=null&&p.days_until_due>0&&p.days_until_due<=7);return s.length+u.length+c.length===0?n`
      ...
      <div class="filter-bar ${this.narrow&&!this._filtersOpen?"collapsed":""}">
        ...
        <label class="filter-field">
          ...
          <select
            ...
            @change=${c=>{this._sortMode=c.target.value,this._activeViewId="";try{U(A.taskSort,this._sortMode)}catch{}}}
          >
        ...
        <label class="filter-field">
          ...
          <select
            ...
            @change=${c=>{this._groupByMode=c.target.value,this._activeViewId="";try{U(A.groupBy,this._groupByMode)}catch{}}}
          >
    ...
    `}_renderGroupedTasks(t,e){let i=new Map,s=a("unassigned",e);for(let c of t){let p=[];this._groupByMode==="area"?p=[(c.area_id?this.hass?.areas?.[c.area_id]?.name:null)||s]:this._groupByMode==="user"?p=[(c.responsible_user_id?this._userService?.getUserName(c.responsible_user_id):null)||s]:this._groupByMode==="group"&&(p=c.group_names.length>0?c.group_names:[s]);for(let h of p)i.has(h)||i.set(h,[]),i.get(h).push(c)}let l=[...i.entries()].sort(([c],[p])=>c===s&&p!==s?1:p===s&&c!==s?-1:c.localeCompare(p)),u=this._groupByMode==="area"?"mdi:map-marker-outline":this._groupByMode==="group"?"mdi:folder-outline":"mdi:account-outline";return n`
      ...
      `)}
    `}_warrantyLabel(t,e,i){return t.kind==="expired"?a("warranty_expired",i):t.kind==="expiring"?a("warranty_expires_in",i).replace("{days}",String(t.days??0)):a("warranty_valid_until",i).replace("{date}",Q(e,i))}_renderWarrantyMeta(t,e){let i=te(t);return n`<p class="meta">${a("warranty",e)}:
      ...
      <div class="filter-bar">
        <label class="filter-field">
          ...
          <select
            ...
            @change=${h=>{this._objectSortMode=h.target.value;try{U(A.objectSort,this._objectSortMode)}catch{}}}
          >
        ...
        <label class="filter-field">
          ...
          <select
            .value=${this._groupByMode}
            @change=${h=>{this._groupByMode=h.target.value;try{U(A.groupBy,this._groupByMode)}catch{}}}
          >
    ...
    `}_setObjectViewMode(t){this._objectViewMode=t;try{U(A.objectView,t)}catch{}}_renderAllParts(){let t=this._lang,e=this._allParts,i=this._currencySymbol;return n`
      <div class="breadcrumb">
...
`),`maintenance_parts_${l}.csv`,"text/csv;charset=utf-8")}async _exportObjectsCsv(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects/csv"}),e=new Date().toISOString().slice(0,10);Kt(t.csv,`maintenance_objects_${e}.csv`,"text/csv;charset=utf-8")}catch{this._showToast(a("action_error",this._lang))}}_renderObjectsTable(t){let e=this._lang,i=this._objectsTableColumns;return n`
      <div class="objects-table-wrap">
        <table class="objects-table">
          <thead>
            <tr>
              ${i.map(s=>{let l=ue.find(c=>c.key===s),u=l&&l.key!=="actions"?a(l.labelKey,e):"";return n`<th class="oc-${s}">${u}</th>`})}
            </tr>
          </thead>
          <tbody>
            ${t.map(s=>n`
    ...
    `}_openCompleteDialogForRow(t){let i=this._objects.find(s=>s.entry_id===t.entry_id)?.tasks.find(s=>s.id===t.task_id);this._openCompleteDialog(t.entry_id,t.task_id,t.task_name,this._features.checklists?i?.checklist:void 0,this._features.adaptive&&!!i?.adaptive_config?.enabled)}_renderObjectDetail(){if(!this._selectedEntryId)return d;let t=this._getObject(this._selectedEntryId);if(!t)return n`<p>Object not found.</p>`;let e=t.object,i=this._lang,s=this._isOperator,l=t.tasks.filter(c=>c.archived).length,u=t.tasks.filter(c=>this._showArchived||!c.archived);return n`
      <div class="detail-section">
        ...
        ${e.paused?n`<p class="meta paused-meta">
              <ha-icon icon="mdi:pause-circle-outline"></ha-icon>
              ${a("object_paused_badge",i)}${e.paused_until?n` — ${a("paused_until_label",i)} ${Q(e.paused_until,i)}`:d}
            </p>`:d}
        ...
        ${q(e.documentation_url)?n`<p class="meta">${a("documentation_url_label",i)}:
        ...
        ${e.installation_date?n`<p class="meta">${a("installed",i)}: ${Q(e.installation_date,i)}</p>`:d}
        ...
        ${t.tasks.length===0?n`<div class="empty-state-centered">
              ...
              <div class="task-row${c.enabled?"":" task-disabled"}">
                ...
                <span class="task-sub${c.responsible_user_id?"":" task-sub-empty"}">${ne(c,p=>this._userService?.getUserName(p)??null)}</span>
