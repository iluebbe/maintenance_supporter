...
`).map(c=>c.trim()).filter(Boolean).slice(0,100);e.checklist=o.length?o:null}if(this.completionActionsEnabled){let o=this._actionService.trim();if(o&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(o)){let m={service:o},h=this._actionTargetEntity.trim();h&&(m.target={entity_id:h});let v=this._buildActionData();Object.keys(v).length>0&&(m.data=v),e.on_complete_action=m}else e.on_complete_action=null;let c={};this._qcNotes.trim()&&(c.notes=this._qcNotes.trim());let _=parseFloat(this._qcCost);!isNaN(_)&&_>=0&&(c.cost=_);let u=parseInt(this._qcDuration,10);!isNaN(u)&&u>=0&&(c.duration=u),this._qcFeedback&&(c.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(c).length?c:null}let t=await this.hass.connection.sendMessagePromise(e),a=this._taskId||t?.task_id,n=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(a&&this._scheduleType==="sensor_based"&&n)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=G(e,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return d;let e=this._lang;return r`
      ...
      <div class="select-row">
        ...
        >
          ${Sa.map(t=>r`<option value=${t} ?selected=${t===this._triggerType}>${i(t,e)}</option>`)}
        </select>
      </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${ja.map(a=>r`<option value=${a} ?selected=${a===this._type}>${i(a,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${Aa.map(a=>r`<option value=${a} ?selected=${a===this._scheduleType}>${i(a,e)}</option>`)}
            </select>
          </div>
  ...
  `,p([$({attribute:!1})],k.prototype,"hass",2),p([$({type:Boolean,attribute:"checklists-enabled"})],k.prototype,"checklistsEnabled",2),p([$({type:Boolean,attribute:"schedule-time-enabled"})],k.prototype,"scheduleTimeEnabled",2),p([$({type:Boolean,attribute:"completion-actions-enabled"})],k.prototype,"completionActionsEnabled",2),p([$({type:Number,attribute:"default-warning-days"})],k.prototype,"defaultWarningDays",2),p([g()],k.prototype,"_open",2),p([g()],k.prototype,"_loading",2),p([g()],k.prototype,"_error",2),p([g()],k.prototype,"_entryId",2),p([g()],k.prototype,"_taskId",2),p([g()],k.prototype,"_objectChoices",2),p([g()],k.prototype,"_name",2),p([g()],k.prototype,"_type",2),p([g()],k.prototype,"_scheduleType",2),p([g()],k.prototype,"_intervalDays",2),p([g()],k.prototype,"_warningDays",2),p([g()],k.prototype,"_intervalAnchor",2),p([g()],k.prototype,"_notes",2),p([g()],k.prototype,"_documentationUrl",2),p([g()],k.prototype,"_customIcon",2),p([g()],k.prototype,"_enabled",2),p([g()],k.prototype,"_triggerEntityId",2),p([g()],k.prototype,"_triggerEntityIds",2),p([g()],k.prototype,"_triggerEntityLogic",2),p([g()],k.prototype,"_triggerAttribute",2),p([g()],k.prototype,"_triggerType",2),p([g()],k.prototype,"_triggerAbove",2),p([g()],k.prototype,"_triggerBelow",2),p([g()],k.prototype,"_triggerForMinutes",2),p([g()],k.prototype,"_triggerTargetValue",2),p([g()],k.prototype,"_triggerDeltaMode",2),p([g()],k.prototype,"_triggerFromState",2),p([g()],k.prototype,"_triggerToState",2),p([g()],k.prototype,"_triggerTargetChanges",2),p([g()],k.prototype,"_triggerRuntimeHours",2),p([g()],k.prototype,"_suggestedAttributes",2),p([g()],k.prototype,"_availableAttributes",2),p([g()],k.prototype,"_entityDomain",2),p([g()],k.prototype,"_lastPerformed",2),p([g()],k.prototype,"_nfcTagId",2),p([g()],k.prototype,"_availableTags",2),p([g()],k.prototype,"_responsibleUserId",2),p([g()],k.prototype,"_availableUsers",2),p([g()],k.prototype,"_checklistText",2),p([g()],k.prototype,"_scheduleTime",2),p([g()],k.prototype,"_actionService",2),p([g()],k.prototype,"_actionTargetEntity",2),p([g()],k.prototype,"_actionData",2),p([g()],k.prototype,"_actionDataJsonFallback",2),p([g()],k.prototype,"_actionTesting",2),p([g()],k.prototype,"_actionTestResult",2),p([g()],k.prototype,"_qcNotes",2),p([g()],k.prototype,"_qcCost",2),p([g()],k.prototype,"_qcDuration",2),p([g()],k.prototype,"_qcFeedback",2),p([g()],k.prototype,"_environmentalEntity",2),p([g()],k.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",k);var F=class extends q{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed"}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed")}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=G(e,this.lang,i("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return r``;let e=this.lang||this.hass?.language||"en";return r`
      <ha-dialog open @closed=${this._close}>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,p([$({attribute:!1})],W.prototype,"hass",2),p([$()],W.prototype,"lang",2),p([g()],W.prototype,"_open",2),p([g()],W.prototype,"_loading",2),p([g()],W.prototype,"_error",2),p([g()],W.prototype,"_viewResult",2),p([g()],W.prototype,"_completeResult",2),p([g()],W.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",W);function Me(l){let s=l.getFullYear(),e=String(l.getMonth()+1).padStart(2,"0"),t=String(l.getDate()).padStart(2,"0");return`${s}-${e}-${t}`}function Ta(l,s){let e=[];for(let t=0;t<s;t++){let a=new Date(l);a.setDate(a.getDate()+t),a.setHours(0,0,0,0),e.push(Me(a))}return e}function Ce(l,s){let[e,t,a]=l.split("-").map(Number),n=new Date(e,t-1,a);return n.setDate(n.getDate()+s),Me(n)}function Ca(l){if(!l||l.length===0)return null;let s=l.map(e=>e.cost).filter(e=>typeof e=="number");return s.length===0?null:s.reduce((e,t)=>e+t,0)/s.length}function Ma(l){let{windowStart:s,windowEnd:e,task:t,entryId:a,objectName:n}=l,o=[],c=(m,h)=>({date:m,entry_id:a,task_id:t.id,task_name:t.name,object_name:n,status:h&&(t.status==="overdue"||t.status==="triggered")?"ok":t.status,days_until_due:h?null:t.days_until_due??null,projected:h,schedule_type:t.schedule_type,interval_days:t.interval_days??null,responsible_user_id:t.responsible_user_id??null,avg_cost:Ca(t.history),adaptive_enabled:!!t.adaptive_config?.enabled,prediction_confidence:t.threshold_prediction_confidence??null});if(t.status==="overdue"||t.status==="triggered"){if(o.push(c(s,!1)),t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let m=Ce(s,t.interval_days),h=1;for(;m<=e&&h<5;)o.push(c(m,!0)),h++,m=Ce(m,t.interval_days)}return o}let _=t.next_due;if(typeof _!="string"||!_)return o;let u=_.slice(0,10);if(u>=s&&u<=e)o.push(c(u,!1));else if(u>e)return o;if(t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0){let m=Ce(u,t.interval_days),h=o.length;for(;m<=e&&h<5;)m>=s&&(o.push(c(m,!0)),h++),m=Ce(m,t.interval_days)}return o}var $t={overdue:0,triggered:1,due_soon:2,ok:3};function zt(l,s,e,t=null){let a=Ta(s,e),n=a[0],o=a[a.length-1],c=[];for(let u of l){let m=u.object?.name||"",h=u.entry_id,v=u.tasks||[];for(let b of v){if(t&&b.responsible_user_id!==t||b.enabled===!1)continue;let f=Ma({windowStart:n,windowEnd:o,task:b,entryId:h,objectName:m});c.push(...f)}}let _=new Map;for(let u of a)_.set(u,[]);for(let u of c){let m=_.get(u.date);m&&m.push(u)}for(let[,u]of _)u.sort((m,h)=>{let v=$t[m.status]??99,b=$t[h.status]??99;if(v!==b)return v-b;if(m.projected!==h.projected)return m.projected?1:-1;let f=m.object_name.localeCompare(h.object_name);return f!==0?f:m.task_name.localeCompare(h.task_name)});return a.map(u=>({date:u,events:_.get(u)??[]}))}var Et=T`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;var K=class extends q{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar"};this._objects=[];this._stats=null;this._windowDays=30;this._userFilter="";this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){this._config={...e},e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter)}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){if(super.updated(e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}_onEventClick(e){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return d;let e=this._lang,t=this._config.show_window_chips!==!1,a=this._config.show_user_filter!==!1,n=this._config.title,o=null;this._userFilter&&(o=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let c=new Date;c.setHours(0,0,0,0);let _=zt(this._objects,c,this._windowDays,o),u=Me(c),m=this._windowDays===365,h=m?_.filter(f=>f.events.length>0):_,v=f=>{let j=`cal-status-${f.status}`,P=f.projected?"cal-event-projected":"",C=f.status==="overdue"&&f.days_until_due!=null?` (${Math.abs(f.days_until_due)}d ${i("overdue",e).toLowerCase()})`:"",z=f.projected&&f.interval_days?r`<span class="cal-event-recur">${i("cal_every_n_days",e).replace("{n}",String(f.interval_days))}</span>`:d,x=f.schedule_type==="sensor_based",M=x?r`<ha-icon class="cal-event-icon cal-source-sensor"
                title="${i("cal_source_sensor",e)}" icon="mdi:trending-up"></ha-icon>`:r`<ha-icon class="cal-event-icon cal-source-time"
                title="${f.adaptive_enabled?i("cal_source_time_adaptive",e):i("cal_source_time",e)}"
                icon="${f.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,L=x&&f.prediction_confidence&&f.status!=="triggered"&&!f.projected?r`<span class="cal-event-prediction cal-conf-${f.prediction_confidence}">
            ${i("cal_predicted",e)} · ${i(`cal_confidence_${f.prediction_confidence}`,e)}
          </span>`:d,Q=this._stats?.budget?.currency_symbol||"\u20AC";return r`
        <div class="cal-event ${P}"
          @click=${()=>this._onEventClick(f)}>
          ${M}
          <span class="cal-status-pill ${j}">${i(f.status,e)}</span>
          <div class="cal-event-body">
            <div class="cal-event-title">${f.object_name} · ${f.task_name}${C}</div>
            ${L}
            ${z}
          </div>
          ${f.avg_cost!=null&&f.avg_cost>0?r`<span class="cal-event-cost">${f.avg_cost.toFixed(0)} ${Q}</span>`:d}
        </div>
      `},b=f=>{let[j,P,C]=f.date.split("-").map(Number),z=new Date(j,P-1,C),x=f.date===u,M=z.toLocaleDateString(e,{weekday:"short"}),L=z.toLocaleDateString(e,{month:"long"});return r`
        <div class="cal-day-row">
          <div class="cal-day-pill ${x?"cal-today":""}">
            <span class="cal-pill-weekday">${M}</span>
            <span class="cal-pill-day">${z.getDate()}</span>
          </div>
          <div class="cal-day-content">
            <div class="cal-day-header">
              <span class="cal-day-month">${L}</span>
              ${x?r`<span class="cal-day-today-badge">${i("today",e)}</span>`:d}
            </div>
            ${f.events.length===0?r`<div class="cal-empty">${i("cal_no_events",e)}</div>`:f.events.map(v)}
          </div>
        </div>
      `};return r`
      <ha-card .header=${n}>
              ...
              <div class="cal-controls">
                ${t?r`
                      <div class="cal-window-chips">
                        ${[7,14,30,365].map(f=>r`
                          <button class="cal-window-chip ${this._windowDays===f?"active":""}"
                            @click=${()=>{this._windowDays=f}}>
                            ${i(`cal_window_${f}`,e)}
                          </button>
                        `)}
                      </div>
        ...
        <div class="cal-rolling">
          ${h.length===0&&m?r`<div class="cal-empty">${i("cal_no_events",e)}</div>`:h.map(b)}
        </div>
      </ha-card>
    `}};K.styles=[qe,Et,T`
      :host { display: block; }
      ha-card { padding: 0; overflow: hidden; }
    `],p([$({attribute:!1})],K.prototype,"hass",2),p([g()],K.prototype,"_config",2),p([g()],K.prototype,"_objects",2),p([g()],K.prototype,"_stats",2),p([g()],K.prototype,"_windowDays",2),p([g()],K.prototype,"_userFilter",2),p([g()],K.prototype,"_unsub",2);var Na=[{value:7,label:"Week (7 days)"},{value:14,label:"Fortnight (14 days)"},{value:30,label:"Month (30 days, default)"},{value:365,label:"Year (365 days, empty days collapsed)"}],pe=class extends q{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar"}}setConfig(e){this._config={...e}}_valueChanged(e,t){let a={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete a.show_window_chips,e==="show_user_filter"&&t===!0&&delete a.show_user_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete a.title,e==="user_filter"&&t===""&&delete a.user_filter,this._config=a,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:a},bubbles:!0,composed:!0}))}render(){let e=this._config.window_days??30,t=this._config.show_window_chips!==!1,a=this._config.show_user_filter!==!1,n=this._config.user_filter??"",o=this._config.title??"";return r`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${Na.map(c=>r`<option value="${c.value}" ?selected=${c.value===e}>${c.label}</option>`)}
          </select>
        </div>
  ...
  `,p([$({attribute:!1})],B.prototype,"hass",2),p([g()],B.prototype,"_open",2),p([g()],B.prototype,"_title",2),p([g()],B.prototype,"_message",2),p([g()],B.prototype,"_confirmText",2),p([g()],B.prototype,"_danger",2),p([g()],B.prototype,"_inputLabel",2),p([g()],B.prototype,"_inputType",2),p([g()],B.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",B);var jt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},At=l=>(...s)=>({_$litDirective$:l,values:s}),Re=class{constructor(s){}get _$AU(){return this._$AM._$AU}_$AT(s,e,t){this._$Ct=s,this._$AM=e,this._$Ci=t}_$AS(s,e){return this.update(s,e)}update(s,e){return this.render(...e)}};var ke=class extends Re{constructor(s){if(super(s),this.it=d,s.type!==jt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(s){if(s===d||s==null)return this._t=void 0,this.it=s;if(s===X)return s;if(typeof s!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(s===this.it)return this._t;this.it=s;let e=[s];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}};ke.directiveName="unsafeHTML",ke.resultType=1;var St=At(ke);var Ia=["EUR","USD","GBP","JPY","CHF","CAD","AUD","CNY","INR","BRL","CZK","PLN","RUB","SEK","NOK","DKK","UAH"],A=class extends q{constructor(){super(...arguments);this.budget=null;this._settings=null;this._loading=!0;this._importCsv="";this._importLoading=!1;this._includeHistory=!0;this._toast="";this._testingNotification=!1;this._users=[];this._vacEnabled=!1;this._vacStart="";this._vacEnd="";this._vacBuffer=3;this._vacExempt=new Set;this._vacIsActive=!1;this._vacWindowEnd=null;this._vacAllTasks=[];this._vacPreview=[];this._vacPreviewLoading=!1;this._vacSaving=!1;this._qrObjects=[];this._qrSelectedEntries=new Set;this._qrActions=new Set(["view"]);this._qrUrlMode="companion";this._qrBatchLoading=!1;this._qrBatchResults=[];this._qrObjectsLoaded=!1;this._loaded=!1;this._userService=null;this._sendTestNotification=async()=>{this._testingNotification=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/test_notification"}),t=e.message||(e.success?i("test_notification_success",this._lang):i("test_notification_failed",this._lang));this._showToast(t)}catch{this._showToast(i("test_notification_failed",this._lang))}finally{this._testingNotification=!1}}}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded?(this._loaded=!0,this._userService=new ne(this.hass),this._loadSettings(),this._loadUsers()):e.has("hass")&&this.hass&&this._userService&&this._userService.updateHass(this.hass)}async _loadUsers(){if(this._userService)try{this._users=await this._userService.getUsers()}catch{this._users=[]}}async _loadSettings(){this._loading=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});this._settings=e,this._hydrateVacationFromSettings()}catch{}this._loading=!1}_hydrateVacationFromSettings(){let e=this._settings?.vacation;e&&(this._vacEnabled=e.enabled,this._vacStart=e.start||"",this._vacEnd=e.end||"",this._vacBuffer=e.buffer_days,this._vacExempt=new Set(e.exempt_task_ids||[]),this._vacIsActive=e.is_active,this._vacWindowEnd=e.window_end)}async _updateSetting(e,t){try{let a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:{[e]:t}});this._settings=a,this._showToast(i("settings_saved",this._lang)),this.dispatchEvent(new CustomEvent("settings-changed"))}catch{this._showToast(i("action_error",this._lang))}}_showToast(e){this._toast=e,setTimeout(()=>{this._toast=""},3e3)}_downloadFile(e,t,a){let n=new Blob([e],{type:a}),o=URL.createObjectURL(n),c=document.createElement("a");c.href=o,c.download=t,c.click(),URL.revokeObjectURL(o)}render(){let e=this._lang;return this._loading||!this._settings?r`<div class="settings-loading">Loading…</div>`:r`
      ...
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select @change=${n=>this._updateSetting("budget_currency",n.target.value)}>
            ${Ia.map(n=>r`<option value=${n} ?selected=${a.currency===n}>${n}</option>`)}
          </select>
        </label>
        <label class="setting-row">
...
<body>
  ...
  `,p([$({attribute:!1})],V.prototype,"hass",2),p([$({attribute:!1})],V.prototype,"objects",2),p([g()],V.prototype,"_open",2),p([g()],V.prototype,"_loading",2),p([g()],V.prototype,"_error",2),p([g()],V.prototype,"_groupId",2),p([g()],V.prototype,"_name",2),p([g()],V.prototype,"_description",2),p([g()],V.prototype,"_selected",2);customElements.get("maintenance-group-dialog")||customElements.define("maintenance-group-dialog",V);var Pa=300,Fa=140,Ye=27;function Tt(l,s){let e=l.trigger_config;if(!e)return d;let t=s.lang,a=l.trigger_entity_info,n=l.trigger_entity_infos,o=a?.friendly_name||e.entity_id||"\u2014",c=e.entity_id||"",_=e.entity_ids||(c?[c]:[]),u=a?.unit_of_measurement||"",m=l.trigger_current_value,h=e.type||"threshold",v=_.length>1;return r`
    <h3>${i("trigger",t)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${v?r`
            ...
            <div class="trigger-entity-id">${_.map((b,f)=>r`${f>0?", ":""}<span class="entity-link" @click=${j=>le(j,b)}>${b}</span>`)}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `:r`
            <div class="trigger-entity-name">${o}</div>
            <div class="trigger-entity-id">${c?r`<span class="entity-link" @click=${b=>le(b,c)}>${c}</span>`:""}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `}
        </div>
      ...
      <div class="trigger-limits">
        ...
        ${h==="compound"?r`
          ...
          ${(e.conditions||[]).map((b,f)=>r`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${f+1}. ${i(b.type||"unknown",t)}: ${b.entity_id?r`<span class="entity-link" @click=${j=>le(j,b.entity_id)}>${b.entity_id}</span>`:""}</span>
          `)}
        `:d}
      ...
      ${n&&n.length>1?r`
        <div class="trigger-entity-list">
          ${n.map(b=>r`
            <span class="trigger-entity-id">${b.friendly_name} (<span class="entity-link" @click=${f=>le(f,b.entity_id)}>${b.entity_id}</span>)</span>
          `)}
        </div>
      `:d}
  ...
  `}function La(l,s,e){let t=l.trigger_config;if(!t)return d;let a=t.type||"threshold",n=a==="counter"&&t.trigger_delta_mode,o=e.isCounterEntity(t),c=t.entity_id||"",_=e.detailStatsData.get(c)||[],u=[],m=!1;if(_.length>=2)for(let y of _){let S=y.val;n&&l.trigger_baseline_value!=null&&(S-=l.trigger_baseline_value);let H={ts:y.ts,val:S};!o&&y.min!=null&&y.max!=null&&(H.min=n&&l.trigger_baseline_value!=null?y.min-l.trigger_baseline_value:y.min,H.max=n&&l.trigger_baseline_value!=null?y.max-l.trigger_baseline_value:y.max,m=!0),u.push(H)}else for(let y of l.history)y.trigger_value!=null&&u.push({ts:new Date(y.timestamp).getTime(),val:y.trigger_value});if(l.trigger_current_value!=null){let y=l.trigger_current_value;n&&l.trigger_baseline_value!=null&&(y-=l.trigger_baseline_value),u.push({ts:Date.now(),val:y})}if(u.length<2&&c&&e.hasStatsService&&!e.detailStatsData.has(c))return r`<div class="sparkline-container" aria-live="polite" style="display:flex;align-items:center;justify-content:center;height:140px;color:var(--secondary-text-color);font-size:12px;">
      <ha-icon icon="mdi:chart-line" style="--mdc-icon-size:16px;margin-right:8px;"></ha-icon>
      ${i("loading_chart",e.lang)}
    </div>`;if(u.length<2)return d;u.sort((y,S)=>y.ts-S.ts);let h=Pa,v=Fa,b=30,f=2,j=8,P=16,C=u.map(y=>y.val),z=Math.min(...C),x=Math.max(...C);if(m)for(let y of u)y.min!=null&&(z=Math.min(z,y.min)),y.max!=null&&(x=Math.max(x,y.max));t.trigger_above!=null&&(x=Math.max(x,t.trigger_above),z=Math.min(z,t.trigger_above)),t.trigger_below!=null&&(z=Math.min(z,t.trigger_below),x=Math.max(x,t.trigger_below));let M=null,L=null;if(a==="counter"&&t.trigger_target_value!=null){if(l.trigger_baseline_value!=null)M=l.trigger_baseline_value;else if(u.length>0){let y=[...l.history].filter(S=>S.type==="completed"||S.type==="reset").sort((S,H)=>new Date(H.timestamp).getTime()-new Date(S.timestamp).getTime())[0];if(y){let S=new Date(y.timestamp).getTime(),H=u[0],O=Math.abs(u[0].ts-S);for(let ee of u){let te=Math.abs(ee.ts-S);te<O&&(H=ee,O=te)}M=H.val}else M=u[0].val}M!=null?(L=M+t.trigger_target_value,x=Math.max(x,L),z=Math.min(z,M)):(x=Math.max(x,t.trigger_target_value),z=Math.min(z,0))}n&&l.trigger_baseline_value!=null&&(z=Math.min(z,0));let Q=x-z||1;z-=Q*.1,x+=Q*.1;let J=u[0].ts,D=u[u.length-1].ts,w=D-J||1,R=y=>b+(y-J)/w*(h-b-f),N=y=>j+(1-(y-z)/(x-z))*(v-j-P),Ie=u.map(y=>`${R(y.ts).toFixed(1)},${N(y.val).toFixed(1)}`).join(" "),Ft=`M${R(u[0].ts).toFixed(1)},${v-P} `+u.map(y=>`L${R(y.ts).toFixed(1)},${N(y.val).toFixed(1)}`).join(" ")+` L${R(u[u.length-1].ts).toFixed(1)},${v-P} Z`,De="";if(m){let y=u.filter(S=>S.min!=null&&S.max!=null);if(y.length>=2){let S=y.map(O=>`${R(O.ts).toFixed(1)},${N(O.max).toFixed(1)}`),H=[...y].reverse().map(O=>`${R(O.ts).toFixed(1)},${N(O.min).toFixed(1)}`);De=`M${S[0]} `+S.slice(1).map(O=>`L${O}`).join(" ")+` L${H[0]} `+H.slice(1).map(O=>`L${O}`).join(" ")+" Z"}}let Xe=u[u.length-1],Lt=R(Xe.ts),Ht=N(Xe.val),et=y=>Math.abs(y)>=1e4?(y/1e3).toFixed(0)+"k":y>=1e3?(y/1e3).toFixed(1)+"k":y.toFixed(y<10?1:0),Ot=et(x),Ut=et(z),Bt=l.history.filter(y=>["completed","skipped","reset"].includes(y.type)).map(y=>({ts:new Date(y.timestamp).getTime(),type:y.type})).filter(y=>y.ts>=J&&y.ts<=D),Pe=u;if(u.length>Ye){let y=(u.length-1)/(Ye-1);Pe=[];for(let S=0;S<Ye;S++)Pe.push(u[Math.round(S*y)])}return r`
    <div class="sparkline-container">
      <svg class="sparkline-svg" viewBox="0 0 ${h} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_sparkline",e.lang)}">
        <text x="${b-3}" y="${j+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${Ot}</text>
        <text x="${b-3}" y="${v-P+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${Ut}</text>
        ...
        <text x="${h-f}" y="${v-1}" text-anchor="end" fill="var(--secondary-text-color)" font-size="7">${new Date(D).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</text>
        ${De?I`<path d="${De}" fill="var(--primary-color)" opacity="0.08" />`:d}
        <path d="${Ft}" fill="var(--primary-color)" opacity="0.15" />
        <polyline points="${Ie}" fill="none" stroke="var(--primary-color)" stroke-width="2" stroke-linejoin="round" />
        ${l.degradation_rate!=null&&l.degradation_trend!=="stable"&&l.degradation_trend!=="insufficient_data"&&u.length>=2?(()=>{let y=u[u.length-1],S=30,H=y.ts+S*864e5,O=y.val+l.degradation_rate*S,ee=Math.min(H,D+(D-J)*.3),te=Math.max(z,Math.min(x,O)),Vt=R(y.ts),Wt=N(y.val),Qt=R(ee),Gt=N(te);return I`<line x1="${Vt.toFixed(1)}" y1="${Wt.toFixed(1)}" x2="${Qt.toFixed(1)}" y2="${Gt.toFixed(1)}" stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.7" />`})():d}
        ${a==="threshold"&&t.trigger_above!=null?I`<line x1="${b}" y1="${N(t.trigger_above).toFixed(1)}" x2="${h}" y2="${N(t.trigger_above).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${N(t.trigger_above)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25B2 ${t.trigger_above}</text>`:d}
        ${a==="threshold"&&t.trigger_below!=null?I`<line x1="${b}" y1="${N(t.trigger_below).toFixed(1)}" x2="${h}" y2="${N(t.trigger_below).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${N(t.trigger_below)+11}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25BC ${t.trigger_below}</text>`:d}
        ${a==="counter"&&L!=null?I`<line x1="${b}" y1="${N(L).toFixed(1)}" x2="${h}" y2="${N(L).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${N(L)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">${i("target_value",e.lang)}: +${t.trigger_target_value}</text>`:d}
        ${a==="counter"&&M!=null?I`<line x1="${b}" y1="${N(M).toFixed(1)}" x2="${h}" y2="${N(M).toFixed(1)}" stroke="var(--secondary-text-color)" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
                <text x="${b+2}" y="${N(M)+11}" text-anchor="start" fill="var(--secondary-text-color)" font-size="8">${i("baseline",e.lang)}</text>`:d}
        <circle cx="${Lt.toFixed(1)}" cy="${Ht.toFixed(1)}" r="3.5" fill="var(--primary-color)" />
        ${Bt.map(y=>{let S=R(y.ts),H=y.type==="completed"?"var(--success-color, #4caf50)":y.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return I`
            <line x1="${S.toFixed(1)}" y1="${j}" x2="${S.toFixed(1)}" y2="${v-P}" stroke="${H}" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
            <circle cx="${S.toFixed(1)}" cy="${j+2}" r="5" fill="${H}" opacity="0.8" />
            <text x="${S.toFixed(1)}" y="${j+6}" text-anchor="middle" fill="white" font-size="7" font-weight="bold">${y.type==="completed"?"\u2713":y.type==="skipped"?"\u23ED":"\u21BA"}</text>
          `})}
        ${Pe.map(y=>{let S=R(y.ts),H=N(y.val),O=new Date(y.ts).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),ee=`${y.val.toFixed(1)} ${s}`;return m&&y.min!=null&&y.max!=null&&(ee+=` (${y.min.toFixed(1)}\u2013${y.max.toFixed(1)})`),I`<circle cx="${S.toFixed(1)}" cy="${H.toFixed(1)}" r="8" fill="transparent" tabindex="0"
            @mouseenter=${te=>qt(te,`${O}
${ee}`,e.setTooltip)}
            @focus=${te=>qt(te,`${O}
${ee}`,e.setTooltip)}
...
`).map(y=>r`<div>${y}</div>`)}
  ...
  `}function qt(l,s,e){let t=l.currentTarget,a=t.closest(".sparkline-container");if(!a)return;let n=a.getBoundingClientRect(),o=t.getBoundingClientRect();e({x:o.left-n.left+o.width/2,y:o.top-n.top-8,text:s})}function Ct(l,s,e){let t=l.degradation_trend!=null&&l.degradation_trend!=="insufficient_data",a=l.days_until_threshold!=null,n=l.environmental_factor!=null&&l.environmental_factor!==1;if(!t&&!a&&!n)return d;let o=l.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":l.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return r`
      ...
      <div class="prediction-grid">
        ...
        ${a?r`
          <div class="prediction-item">
            ...
            ${l.threshold_prediction_date?r`<span class="prediction-date">${ie(l.threshold_prediction_date,s)}</span>`:d}
        ...
        ${n&&e.environmental?r`
          <div class="prediction-item">
            ...
            ${l.environmental_entity?r`<span class="prediction-entity entity-link" @click=${c=>le(c,l.environmental_entity)}>${l.environmental_entity}</span>`:d}
          </div>
        `:d}
      </div>
    </div>
  `}function Mt(l,s){let e=l.interval_analysis,t=e?.weibull_beta,a=e?.weibull_eta;if(t==null||a==null||a<=0)return d;let n=l.interval_days??0,o=l.suggested_interval??n;return r`
    ...
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_weibull",a)}">
        ...
        ${e>0?I`
          ...
          <circle cx="${z.toFixed(1)}" cy="${M.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(z+4).toFixed(1)}" y="${(M-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
  ...
  `}function Ba(l,s,e){let t=l.confidence_interval_low,a=l.confidence_interval_high,n=s.suggested_interval??s.interval_days??0,o=s.interval_days??0,c=Math.max(0,t-5),u=a+5-c,m=(t-c)/u*100,h=(a-t)/u*100,v=(n-c)/u*100,b=o>0?(o-c)/u*100:-1;return r`
  ...
  `}function It(l,s){return Va(l,s)}function Va(l,s){let e=l.seasonal_factors??l.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return d;let t=l.interval_analysis?.seasonal_reason,a=new Date().getMonth(),n=300,o=100,c=8,u=o-c-4,m=Math.max(...e,1.5),h=n/12,v=h*.65,b=c+u-1/m*u;return r`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${n} ${o}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_seasonal",s)}">
        ...
        ${e.map((f,j)=>{let P=f/m*u,C=j*h+(h-v)/2,z=c+u-P,x=j===a,M=f<1?"var(--success-color, #4caf50)":f>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return I`
            <rect x="${C.toFixed(1)}" y="${z.toFixed(1)}"
              width="${v.toFixed(1)}" height="${P.toFixed(1)}"
              fill="${M}" opacity="${x?1:.5}" rx="2" />
          `})}
      </svg>
      <div class="seasonal-labels">
        ${Nt.map((f,j)=>r`<span class="seasonal-label ${j===a?"active-month":""}">${i(f,s)}</span>`)}
      </div>
    </div>
  `}var Wa=300,Qa=200;function Dt(l,s,e,t){let a=l.history.filter(c=>c.type==="completed"&&(c.cost!=null||c.duration!=null));if(a.length<2)return d;let n=a.some(c=>(c.cost??0)>0),o=a.some(c=>(c.duration??0)>0);return!n&&!o?d:r`
  ...
  `}function Ga(l,s,e){let t=l.history.filter(w=>w.type==="completed"&&(w.cost!=null||w.duration!=null)).map(w=>({ts:new Date(w.timestamp).getTime(),cost:w.cost??0,duration:w.duration??0})).sort((w,R)=>w.ts-R.ts);if(t.length<2)return d;let a=t.some(w=>w.cost>0),n=t.some(w=>w.duration>0);if(!a&&!n)return d;let o=e!=="duration"&&a,c=e!=="cost"&&n,_=o||!c&&a,u=c||!o&&n,m=Wa,h=Qa,v=_?32:8,b=u?32:8,f=8,j=20,P=m-v-b,C=h-f-j,z=Math.max(...t.map(w=>w.cost))||1,x=Math.max(...t.map(w=>w.duration))||1,M=Math.min(20,P/t.length*.6),L=P/t.length,Q=w=>v+L*w+L/2,J=w=>f+C-w/z*C,D=w=>f+C-w/x*C;return r`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${m} ${h}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_history",s)}">
        ${_?t.map((w,R)=>I`
          <rect x="${(Q(R)-M/2).toFixed(1)}" y="${J(w.cost).toFixed(1)}" width="${M.toFixed(1)}" height="${(f+C-J(w.cost)).toFixed(1)}"
            fill="var(--primary-color)" opacity="0.6" rx="2" />
        `):d}
        ${u?I`
          <polyline points="${t.map((w,R)=>`${Q(R).toFixed(1)},${D(w.duration).toFixed(1)}`).join(" ")}"
            fill="none" stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-linejoin="round" />
          ${t.map((w,R)=>I`
            <circle cx="${Q(R).toFixed(1)}" cy="${D(w.duration).toFixed(1)}" r="3" fill="var(--accent-color, #ff9800)" />
          `)}
        `:d}
        ...
        ${_?I`
          <text x="${v-3}" y="${f+4}" text-anchor="end" fill="var(--primary-color)" font-size="7">${z.toFixed(0)}\u20AC</text>
          <text x="${v-3}" y="${f+C+3}" text-anchor="end" fill="var(--primary-color)" font-size="7">0\u20AC</text>
        `:d}
        ${u?I`
          <text x="${m-b+3}" y="${f+4}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="7">${x.toFixed(0)}m</text>
          <text x="${m-b+3}" y="${f+C+3}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="7">0m</text>
        `:d}
      </svg>
    </div>
    <div class="chart-legend">
  ...
  `}var Ka=60,Za=20,Pt=30,E=class extends q{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._unsub=null;this._sparklineTooltip=null;this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._defaultWarningDays=7;this._actionLoading=!1;this._moreMenuOpen=!1;this._toastMessage="";this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab="dashboard";this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=e=>this._onPopState(e);this._deepLinkHandled=!1;this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=e=>{let t=e.detail;t?.type==="maintenance-supporter:open-task"&&t.entry_id&&t.task_id&&(e.stopPropagation(),this._showTask(t.entry_id,t.task_id))}}get _lang(){return this.hass?.language||"en"}get _isOperator(){let e=this.hass?.user;return e?e.is_admin?!1:!this._adminPanelUserIds.includes(e.id):!0}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._popstateHandler);let e=localStorage.getItem("maintenance_supporter_sort");e&&["due_date","object","type","task_name","area","assigned_user","group"].includes(e)&&(this._sortMode=e);let t=localStorage.getItem("maintenance_supporter_object_sort");t&&["alphabetical","due_soonest","task_count"].includes(t)&&(this._objectSortMode=t);let a=localStorage.getItem("maintenance_supporter_groupby");a&&["none","area","group","user"].includes(a)&&(this._groupByMode=a)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(e){if(super.updated(e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Te(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new ne(this.hass),this._userService.getUsers())}}async _loadData(){let[e,t,a,n,o]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null)]);if(e&&(this._objects=e.objects),t&&(this._stats=t),a&&(this._budget=a),n&&(this._groups=n.groups||{}),o){let c=o;this._features=c.features,this._adminPanelUserIds=c.admin_panel_user_ids||[];let _=c.general?.default_warning_days;typeof _=="number"&&_>=0&&_<=365&&(this._defaultWarningDays=_)}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search);if(e.get("ms_action")==="add_object"){this._deepLinkHandled=!0;let u=window.location.pathname+window.location.hash;history.replaceState(history.state,"",u),requestAnimationFrame(()=>{this.shadowRoot?.querySelector("maintenance-object-dialog")?.openCreate()});return}let a=e.get("entry_id");if(!a)return;this._deepLinkHandled=!0;let n=e.get("task_id"),o=e.get("action"),c=window.location.pathname+window.location.hash;history.replaceState(history.state,"",c);let _=this._getObject(a);if(!_){this._showOverview();return}if(n){let u=_.tasks.find(m=>m.id===n);if(!u){this._showObject(a);return}this._showTask(a,n),o==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(a,n,u.name,this._features.checklists?u.checklist:void 0,this._features.adaptive&&!!u.adaptive_config?.enabled)}):o==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(a,n,u)})}else this._showObject(a)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let a=await this._statsService.getDetailStats(e,t),n=new Map(this._detailStatsData);n.set(e,a),this._detailStatsData=n}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=[];for(let a of this._objects)for(let n of a.tasks){let o=n.trigger_config?.entity_id;o&&e.push({entityId:o,isCounter:this._isCounterEntity(n.trigger_config)})}if(e.length===0)return;let t=await this._statsService.getBatchMiniStats(e);this._miniStatsData=new Map([...this._miniStatsData,...t])}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _taskRows(){let e=[];for(let h of this._objects)for(let v of h.tasks){if(this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let f=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==f)continue}let b=[];for(let f of Object.values(this._groups))f.task_refs?.some(j=>j.entry_id===h.entry_id&&j.task_id===v.id)&&b.push(f.name);e.push({entry_id:h.entry_id,task_id:v.id,object_name:h.object.name,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_anchor:v.interval_anchor??null,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,area_id:h.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:b})}let t={overdue:0,triggered:1,due_soon:2,ok:3},a=(h,v)=>(t[h.status]??9)-(t[v.status]??9),n=(h,v)=>(h.days_until_due??99999)-(v.days_until_due??99999),o=(h,v)=>a(h,v)||n(h,v),c=h=>h.area_id&&this.hass?.areas?.[h.area_id]?.name||"",_=h=>h.responsible_user_id&&this._userService?.getUserName(h.responsible_user_id)||"",u=h=>h.group_names[0]||"",m={due_date:o,object:(h,v)=>h.object_name.localeCompare(v.object_name)||o(h,v),type:(h,v)=>h.type.localeCompare(v.type)||o(h,v),task_name:(h,v)=>h.task_name.localeCompare(v.task_name),area:(h,v)=>{let b=c(h),f=c(v);return!b&&f?1:b&&!f?-1:b.localeCompare(f)||o(h,v)},assigned_user:(h,v)=>{let b=_(h),f=_(v);return!b&&f?1:b&&!f?-1:b.localeCompare(f)||o(h,v)},group:(h,v)=>{let b=u(h),f=u(v);return!b&&f?1:b&&!f?-1:b.localeCompare(f)||o(h,v)}};return e.sort(m[this._sortMode]),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(n=>n.id===t)}_pushPanelState(e,t,a){let n={msp_view:e,msp_entry:t||null,msp_task:a||null};history.pushState(n,"")}_onPopState(e){let t=e.state;if(t?.msp_view&&(this._view=t.msp_view,this._selectedEntryId=t.msp_entry||null,this._selectedTaskId=t.msp_task||null,this._moreMenuOpen=!1,t.msp_view==="task"&&t.msp_entry&&t.msp_task)){this._historyFilter=null;let a=this._getTask(t.msp_entry,t.msp_task);a?.trigger_config?.entity_id&&this._fetchDetailStats(a.trigger_config.entity_id,this._isCounterEntity(a.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null}_filterByStatus(e){this._filterStatus=e,this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),requestAnimationFrame(()=>{this.shadowRoot?.querySelector(".filter-bar")?.scrollIntoView({behavior:"smooth",block:"start"})})}_showObject(e){this._pushPanelState("object",e),this._view="object",this._selectedEntryId=e,this._selectedTaskId=null}_showTask(e,t){this._pushPanelState("task",e,t),this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._activeTab="overview",this._historyFilter=null;let a=this._getTask(e,t);if(a?.trigger_config?.entity_id){let n=a.trigger_config.entity_id,o=this._isCounterEntity(a.trigger_config);this._fetchDetailStats(n,o)}}_showToast(e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}async _deleteObject(e){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_object",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:e}),this._showOverview(),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _deleteTask(e,t){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_task",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/delete",entry_id:e,task_id:t}),this._showObject(e),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _skipTask(e,t,a){this._actionLoading=!0;try{let n={type:"maintenance_supporter/task/skip",entry_id:e,task_id:t};a&&(n.reason=a),await this.hass.connection.sendMessagePromise(n),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _resetTask(e,t,a){this._actionLoading=!0;try{let n={type:"maintenance_supporter/task/reset",entry_id:e,task_id:t};a&&(n.date=a),await this.hass.connection.sendMessagePromise(n),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _applySuggestion(e,t,a){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/apply_suggestion",entry_id:e,task_id:t,interval:a}),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}_openSeasonalOverrides(e){let t=this.shadowRoot.querySelector("maintenance-seasonal-overrides-dialog");if(!t||!this._selectedEntryId)return;let a=e.adaptive_config?.seasonal_overrides;t.open(this._selectedEntryId,e.id,a)}async _reanalyzeInterval(e,t){try{let a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:e,task_id:t});a.recommended_interval?this._showToast(`${i("reanalyze_result",this._lang)}: ${a.recommended_interval} ${i("days",this._lang)} (${i(`confidence_${a.confidence}`,this._lang)}, ${a.data_points} ${i("data_points",this._lang)})`):this._showToast(i("reanalyze_insufficient_data",this._lang)),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _promptSkipTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let n=await a.prompt({title:i("skip",this._lang),message:i("skip_reason_prompt",this._lang),confirmText:i("skip",this._lang),inputLabel:i("reason_optional",this._lang),inputType:"text"});n.confirmed&&this._skipTask(e,t,n.value||void 0)}async _promptResetTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let n=await a.prompt({title:i("reset",this._lang),message:i("reset_date_prompt",this._lang),confirmText:i("reset",this._lang),inputLabel:i("reset_date_optional",this._lang),inputType:"date"});n.confirmed&&this._resetTask(e,t,n.value||void 0)}_dismissSuggestion(e,t){e&&t&&this._dismissedSuggestions.add(`${e}_${t}`),this.requestUpdate()}async _handleQuickComplete(e,t,a){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/quick_complete",entry_id:e,task_id:t}),this._showToast(i("quick_complete_success",this._lang))}catch(n){(n?.code||"")==="no_defaults"?this._openCompleteDialog(e,t,a.name,this._features.checklists?a.checklist:void 0,this._features.adaptive&&!!a.adaptive_config?.enabled):this._showToast(i("action_error",this._lang))}}_openCompleteDialog(e,t,a,n,o){let c=this.shadowRoot.querySelector("maintenance-complete-dialog");c&&(c.entryId=e,c.taskId=t,c.taskName=a,c.lang=this._lang,c.checklist=n||[],c.adaptiveEnabled=!!o,c.open())}_openQrForObject(e,t){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForObject(e,t)}_openQrForTask(e,t,a,n){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForTask(e,t,a,n)}render(){return r`
    ...
    `}_renderOverviewRow(e){let t=this._lang,a=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,n=0,o=Ae.ok,c=!1;if(a&&e.days_until_due!==null){let h=(e.interval_days-e.days_until_due)/e.interval_days*100;n=Math.max(0,Math.min(100,h)),c=h>100,e.status==="overdue"?o=Ae.overdue:e.status==="due_soon"&&(o=Ae.due_soon)}let _=e.area_id?this.hass?.areas?.[e.area_id]?.name:null,u=e.responsible_user_id?this._userService?.getUserName(e.responsible_user_id):null,m=e.group_names.length>0||_||u;return r`
    ...
    `}_renderMiniSparkline(e){if(!e.trigger_config?.entity_id)return d;let t=e.trigger_config.entity_id,a=this._miniStatsData.get(t)||[],n=[];if(a.length>=2)n=a.map(x=>({ts:x.ts,val:x.val}));else{if(!e.history)return d;for(let x of e.history)x.trigger_value!=null&&n.push({ts:new Date(x.timestamp).getTime(),val:x.trigger_value})}if(e.trigger_current_value!=null&&n.push({ts:Date.now(),val:e.trigger_current_value}),n.length<2)return d;n.sort((x,M)=>x.ts-M.ts);let o=Ka,c=Za,_=n.map(x=>x.val),u=Math.min(..._),m=Math.max(..._),h=m-u||1;u-=h*.1,m+=h*.1;let v=n[0].ts,f=n[n.length-1].ts-v||1,j=x=>(x-v)/f*o,P=x=>2+(1-(x-u)/(m-u))*(c-4),C=n;if(C.length>Pt){let x=Math.ceil(C.length/Pt);C=C.filter((M,L)=>L%x===0||L===C.length-1)}let z=C.map(x=>`${j(x.ts).toFixed(1)},${P(x.val).toFixed(1)}`).join(" ");return r`
    ...
    `}_renderDaysProgress(e){let t=this._lang;if(e.days_until_due==null||!e.interval_days||e.interval_days<=0)return d;let n=(e.interval_days-e.days_until_due)/e.interval_days*100,o=Math.max(0,Math.min(100,n)),c=n>100,_="var(--success-color, #4caf50)";return e.status==="overdue"?_="var(--error-color, #f44336)":e.status==="due_soon"&&(_="var(--warning-color, #ff9800)"),r`
      <div class="days-progress">
        <div class="days-progress-labels">
          <span>${e.last_performed?`${i("last_performed",t)}: ${ie(e.last_performed,t)}`:""}</span>
          <span>${e.next_due?`${i("next_due",t)}: ${ie(e.next_due,t)}`:""}</span>
        </div>
        ...
        <div class="days-progress-text">${Se(e.days_until_due,t)}</div>
      </div>
    `}_renderObjectDetail(){if(!this._selectedEntryId)return d;let e=this._getObject(this._selectedEntryId);if(!e)return r`<p>Object not found.</p>`;let t=e.object,a=this._lang,n=this._isOperator;return r`
      <div class="detail-section">
        ...
        ${t.installation_date?r`<p class="meta">${i("installed",a)}: ${ie(t.installation_date,a)}</p>`:d}
        ...
        ${e.tasks.length===0?r`<div class="empty-state-centered">
              ...
              <div class="task-row${o.enabled?"":" task-disabled"}">
                ...
                <span class="due-cell" @click=${()=>this._showTask(e.entry_id,o.id)}>
                  <span class="due-text">${Se(o.days_until_due,a)}</span>
    ...
    `}_renderTabContent(e){switch(this._activeTab){case"overview":return this._renderOverviewTab(e);case"history":return this._renderHistoryTab(e);default:return d}}get _sparklineCtx(){return{lang:this._lang,detailStatsData:this._detailStatsData,hasStatsService:!!this._statsService,isCounterEntity:e=>this._isCounterEntity(e),tooltip:this._sparklineTooltip,setTooltip:e=>{this._sparklineTooltip=e}}}_renderOverviewTab(e){let t=this._lang,a=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,n=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1,o=a||n,c=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,_=this._features.seasonal&&(e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12);return r`
      <div class="tab-content overview-tab">
        ...
        ${Tt(e,this._sparklineCtx)}
        ${Ct(e,t,this._features)}
        <div class="two-column-layout ${o?"":"single-column"}">
          ...
          <div class="right-column">
            ${Dt(e,t,this._costDurationToggle,u=>{this._costDurationToggle=u})}
          </div>
        </div>
        ${c?Mt(e,t):d}
        ${_?r`
    ...
    `}_renderKPIBar(e){let t=this._lang,a=e.times_performed>0?e.total_cost/e.times_performed:0,n=e.days_until_due!==null&&e.days_until_due!==void 0?e.days_until_due<0?"overdue":e.days_until_due<=e.warning_days?"warning":"":"";return r`
      <div class="kpi-bar">
        <div class="kpi-card">
          ...
          <div class="kpi-value">${e.next_due?ie(e.next_due,t):"\u2014"}</div>
        ...
        <div class="kpi-card">
          ...
          <div class="kpi-value">${e.last_performed?ie(e.last_performed,t):"\u2014"}</div>
        </div>
        <div class="kpi-card">
      ...
      <div class="recent-activities">
        ...
        ${a.map(o=>r`
          <div class="activity-item">
            ...
            <span class="activity-date">${Je(o.timestamp,t)}</span>
    ...
    `}_renderHistoryEntry(e){let t=this._lang;return r`
      <div class="history-entry">
        <div class="history-icon ${e.type}">
          <ha-icon .icon=${yt[e.type]||"mdi:circle"}></ha-icon>
        </div>
        <div class="history-content">
          <div><strong>${i(e.type,t)}</strong></div>
          <div class="history-date">${Je(e.timestamp,t)}</div>
    ...
    `}};E.styles=[qe,xt],p([$({attribute:!1})],E.prototype,"hass",2),p([$({type:Boolean,reflect:!0})],E.prototype,"narrow",2),p([$({attribute:!1})],E.prototype,"panel",2),p([g()],E.prototype,"_objects",2),p([g()],E.prototype,"_stats",2),p([g()],E.prototype,"_view",2),p([g()],E.prototype,"_selectedEntryId",2),p([g()],E.prototype,"_selectedTaskId",2),p([g()],E.prototype,"_filterStatus",2),p([g()],E.prototype,"_filterUser",2),p([g()],E.prototype,"_unsub",2),p([g()],E.prototype,"_sparklineTooltip",2),p([g()],E.prototype,"_historyFilter",2),p([g()],E.prototype,"_budget",2),p([g()],E.prototype,"_groups",2),p([g()],E.prototype,"_detailStatsData",2),p([g()],E.prototype,"_miniStatsData",2),p([g()],E.prototype,"_features",2),p([g()],E.prototype,"_adminPanelUserIds",2),p([g()],E.prototype,"_defaultWarningDays",2),p([g()],E.prototype,"_actionLoading",2),p([g()],E.prototype,"_moreMenuOpen",2),p([g()],E.prototype,"_toastMessage",2),p([g()],E.prototype,"_overviewTab",2),p([g()],E.prototype,"_activeTab",2),p([g()],E.prototype,"_costDurationToggle",2),p([g()],E.prototype,"_historySearch",2),p([g()],E.prototype,"_sortMode",2),p([g()],E.prototype,"_objectSortMode",2),p([g()],E.prototype,"_groupByMode",2),E=p([ft("maintenance-supporter-panel")],E);export{E as MaintenanceSupporterPanel};
