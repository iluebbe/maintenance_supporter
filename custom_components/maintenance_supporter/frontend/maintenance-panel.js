/*! maintenance_supporter frontend 2.87.0 */
import{a as Be,b as Fe,c as qe}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-OHSAYUYA.js";import{A as ci,B as di,C as pi,D as hi,E as ui,L as mi,O as _i,a as at,b as Wt,c as Ct,d as yt,e as xt,f as Gt,g as Dt,h as te,i as Ue,j as We,k as ee,l as Ye,m as Ke,n as E,o as Bt,p as vt,q as Et,r as It,s as ve,t as ie,u as se,v as ai,w as ri,x as oi,y as ni,z as li}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-TR2SWQXZ.js";import{a as Ne,b as Jt,c as wt,d as Xt,e as Nt,f as Zt,g as Ft,h as ii,i as si,k as gi}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-OMI4RPEK.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-ZHZGBNLQ.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-QX5M2DYS.js";import{a as fe}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-DTGI5OUX.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-WTFCWMEZ.js";import{a as D,b as Z,c as G,d as Xe,e as Ze,f as ti,g as ei}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-7WIIDXKG.js";import{b as Ve,h as Ge}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-GWJPJ26Q.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-U33ZVKRR.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-DK462FER.js";import{a as me}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-NOXOKE42.js";import{c as Qe,d as _e,e as Je}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-FZVWHD7D.js";import{a as A}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-7LHNM5ES.js";import{A as Q,B as ze,C as Tt,E as Lt,H as Pe,I as Le,K as St,L as Ht,M as He,O as Qt,a as g,b as L,c as o,d as J,f as h,h as H,i as ge,j as Ce,k as De,l as S,m,n as Yt,o as Ae,p as Kt,q as s,r as At,s as U,t as Ie,u as rt,v as Pt,x as it,y as K}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-4WH4ZBF3.js";var Ui=["assignee_pool","required_completion_fields","checklist","labels","mirror_todo_entities","history","readings"],Wi=["checklist_progress"],Gi=["tasks","parts"],Yi=["manual_docs","battery_fleet_excluded"];function be(l,c,t=[]){for(let e of c)l[e]===void 0&&(l[e]=[]);for(let e of t)l[e]===void 0&&(l[e]={})}function Ki(l){let c=l;be(c,Gi),c.object&&typeof c.object=="object"&&be(c.object,Yi);for(let t of c.tasks)be(t,Ui,Wi);return l}function qt(l){for(let c of l)Ki(c);return l}function Qi(l,c){if(c.objects)return c.objects;let t=c.delta||[],e=c.removed||[];if(!t.length&&!e.length)return null;let i=new Map(l.map(a=>[a.entry_id,a]));for(let a of t)i.set(a.entry_id,a);for(let a of e)i.delete(a);return[...i.values()]}function vi(l,c){return c.objects&&qt(c.objects),c.delta&&qt(c.delta),Qi(l,c)}var ye=["today","dashboard","calendar","settings"];var Ji=168*3600*1e3;function fi(){try{let l=Z(D.objectsCache);if(!l)return null;let c=JSON.parse(l);return c.v!==ge||!Number.isFinite(c.at)||Date.now()-c.at>Ji||!Array.isArray(c.objects)||c.objects.length===0?null:{objects:c.objects,stats:c.stats??null}}catch{return null}}function xe(l,c){if(!(!Array.isArray(l)||l.length===0))try{let t={v:ge,at:Date.now(),objects:l,stats:c};G(D.objectsCache,JSON.stringify(t))}catch{}}function N(l){return String(l??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}function bi(l,c,t,e,i,a){let n=[[t.manufacturer,l.manufacturer],[t.model,l.model],[t.serial,l.serial_number],[t.installed,l.installation_date?e(l.installation_date):null],[t.warranty,l.warranty_expiry?e(l.warranty_expiry):null]].filter(([,p])=>!!p),d=c.map(p=>{let u=t.scheduleLabel(p);return`<tr>
      <td>${N(p.name)}</td>
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  <h1>${N(l.name)}</h1>
  <p class="sub">${N(t.title)} \xB7 ${N(t.generated)}: ${N(e(a))}</p>
...
${N(l.notes)}</div>`:""}
</body></html>`}function we(l,c=new Date){if(!l)return{kind:"none",days:null,date:null};let t=new Date(`${l}T00:00:00`);if(isNaN(t.getTime()))return{kind:"none",days:null,date:null};let e=Date.UTC(c.getFullYear(),c.getMonth(),c.getDate()),i=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),a=Math.round((i-e)/864e5);return a<0?{kind:"expired",days:a,date:l}:a<=60?{kind:"expiring",days:a,date:l}:{kind:"valid",days:a,date:l}}var q=l=>String(l??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c]);function yi(l,c,t,e,i,a,n,d,r,p=[],u=null){let _=[[t.object,q(c)],[t.type,q(t.typeLabel(l.type))],[t.interval,q(i(l))],[t.nextDue,l.next_due?q(e(l.next_due)):"\u2014"],[t.lastDone,l.last_performed?q(e(l.last_performed)):q(t.never)]];l.priority&&l.priority!=="normal"&&_.push([t.priority,q(l.priority)]);let v=(l.checklist||[]).map(b=>`<li><span class="box"></span>${q(b)}</li>`).join(""),f=(b,R)=>b?`<figure class="qr"><img src="${b}" alt="" /><figcaption>${q(R)}</figcaption></figure>`:"";return`<!DOCTYPE html>
...
<body>
  ...
  <table class="meta">
    ${_.map(([b,R])=>`<tr><td>${q(b)}</td><td>${R}</td></tr>`).join("")}
  </table>
...
`;var ae=class{constructor(c){this._cache=new Map;this._pending=new Map;this.historyFallbackIds=new Set;this._hass=c}updateHass(c){this._hass=c}async getDetailStats(c,t,e=30){return this._getStats(c,e<=35?"hour":"day",e,t)}async getMiniStats(c,t){return this._getStats(c,"day",14,t)}async getBatchMiniStats(c){let t=new Map,e=[];for(let r of c){let p=`${r.entityId}:day:14`,u=this._cache.get(p);u&&Date.now()-u.fetchedAt<3e5?t.set(r.entityId,u.points):e.push(r)}if(e.length===0)return t;let i=e.filter(r=>r.isCounter).map(r=>r.entityId),a=e.filter(r=>!r.isCounter).map(r=>r.entityId),n=new Date(Date.now()-336*60*60*1e3).toISOString(),d=[];return i.length>0&&d.push(this._fetchBatch(i,"day",n,["state","sum","change"],!0,t)),a.length>0&&d.push(this._fetchBatch(a,"day",n,["mean","min","max"],!1,t)),await Promise.all(d),t}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(c,t,e,i){let a=`${c}:${t}:${e}`,n=this._cache.get(a);if(n&&Date.now()-n.fetchedAt<3e5)return n.points;if(this._pending.has(a))return this._pending.get(a);let d=this._fetchAndNormalize(c,t,e,i,a);this._pending.set(a,d);try{return await d}finally{this._pending.delete(a)}}async _fetchAndNormalize(c,t,e,i,a){let n=new Date(Date.now()-e*24*60*60*1e3).toISOString(),d=i?["state","sum","change"]:["mean","min","max"];try{let p=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:n,statistic_ids:[c],period:t,types:d}))[c]||[],u=this._normalizeRows(p,i);if(u.length<2){let _=await this._fetchHistoryFallback(c,n);_.length>=2?(u=_,this.historyFallbackIds.add(c)):this.historyFallbackIds.delete(c)}else this.historyFallbackIds.delete(c);return this._cache.set(a,{entityId:c,fetchedAt:Date.now(),period:t,points:u}),u}catch(r){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${c}:`,r),[]}}async _fetchHistoryFallback(c,t){try{let i=(await this._hass.connection.sendMessagePromise({type:"history/history_during_period",start_time:t,end_time:new Date().toISOString(),entity_ids:[c],minimal_response:!0,no_attributes:!0}))?.[c]||[];if(i.length>1e3){let d=Math.ceil(i.length/500);i=i.filter((r,p)=>p%d===0||p===i.length-1)}let a=[],n=null;for(let d of i){let r=d.s??d.state;if(r==null||r==="unknown"||r==="unavailable")continue;let p;if(r==="on"||r==="open"||r==="true")p=1;else if(r==="off"||r==="closed"||r==="false")p=0;else if(p=parseFloat(r),!Number.isFinite(p))continue;let u=d.lu??d.last_updated??d.last_changed,_=typeof u=="number"?u*1e3:u!=null?Date.parse(u):NaN;Number.isFinite(_)&&(n!=null&&n!==p&&a.push({ts:_,val:n}),a.push({ts:_,val:p}),n=p)}return a.sort((d,r)=>d.ts-r.ts),a.length&&n!=null&&a.push({ts:Date.now(),val:n}),a}catch(e){return console.warn(`[maintenance-supporter] History fallback failed for ${c}:`,e),[]}}async _fetchBatch(c,t,e,i,a,n){try{let d=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:e,statistic_ids:c,period:t,types:i});for(let r of c){let p=d[r]||[],u=this._normalizeRows(p,a);n.set(r,u),this._cache.set(`${r}:${t}:14`,{entityId:r,fetchedAt:Date.now(),period:t,points:u})}}catch(d){console.warn("[maintenance-supporter] Batch statistics fetch failed:",d)}}_normalizeRows(c,t){let e=[];for(let i of c){let a=null;if(t?a=i.state??null:a=i.mean??null,a===null)continue;let n={ts:i.start,val:a};t||(i.min!=null&&(n.min=i.min),i.max!=null&&(n.max=i.max)),e.push(n)}return e.sort((i,a)=>i.ts-a.ts),e}};function ft(l,c){let t=l??0;return t<1024?`${t} B`:t<1024*1024?`${it(t/1024,c,1)} KB`:`${it(t/(1024*1024),c,1)} MB`}var Rt=["manual","warranty","invoice","spare_parts","photo","other"],re={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"};function jt(l){return l.title||l.filename||l.url||""}var oe=8,$e=["newest","oldest","title","category"];function Te(l){return $e.includes(l??"")?l:"newest"}var ke=["manual","warranty","invoice","spare_parts","photo","other"];function wi(l,c){let t=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"}),e=d=>(d.title||d.filename||d.url||"").trim(),i=(d,r)=>t.compare(e(d),e(r)),a=d=>{if(d.kind==="weblink")return ke.length+1;let r=(d.tags||[]).find(p=>ke.includes(p))||"other";return ke.indexOf(r)},n=[...l];switch(c){case"oldest":return n.sort((d,r)=>(d.added_at||"").localeCompare(r.added_at||""));case"title":return n.sort(i);case"category":return n.sort((d,r)=>a(d)-a(r)||i(d,r));default:return n.sort((d,r)=>(r.added_at||"").localeCompare(d.added_at||""))}}function ne(l,c){let t=Wt(c);if(!t.length)return l;let e=[];for(let i of l){let a=Ct(t,[{text:i.title,weight:3},{text:i.filename,weight:2},{text:(i.tags||[]).join(" "),weight:2},{text:i.description,weight:2},{text:i.url,weight:1}]);a>0&&e.push({doc:i,score:a})}return e.sort((i,a)=>a.score-i.score).map(i=>i.doc)}var V=class extends H{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._filter="";this._loaded=!1;this._busy=!1;this._error="";this._hint="";this._addingLink=!1;this._linkUrl="";this._linkTitle="";this._category="manual";this._thumbs={};this._lightboxUrl="";this._editingId="";this._editTitle="";this._editCategory="manual";this._editDescription="";this._linkDescription="";this._sort=Te(Z(D.docSort));this._dragOver=!1;this._loadedFor=null;this._localeReady=!1;this._singlePick=Xe()}_isImage(t){return t.kind==="file"&&(t.mime||"").startsWith("image/")}async _sign(t){return Jt(this.hass,t.id)}get _lang(){return U(this.hass)}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,rt(this._lang).then(()=>this.requestUpdate())),this.hass&&this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error="",this._thumbs={},this._loadThumbs()}catch(t){this._error=A(t,this._lang),this._loaded=!0}}async _loadThumbs(){await Promise.all(this._docs.filter(t=>this._isImage(t)).map(async t=>{try{let e=await this._sign(t);this._thumbs={...this._thumbs,[t.id]:e}}catch{}}))}_category_of(t){return(t.tags||[]).find(i=>Rt.includes(i))||"other"}_labelKeydown(t){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),t.currentTarget.querySelector("input")?.click())}_onFileInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i),e.value=""}_onDrop(t){if(t.preventDefault(),this._dragOver=!1,!this.canWrite||this._busy)return;let e=Array.from(t.dataTransfer?.files??[]);e.length&&this._uploadFiles(e)}_onDragOver(t){this.canWrite&&(t.preventDefault(),this._dragOver=!0)}_onDragLeave(t){let e=t.relatedTarget;(!e||!t.currentTarget.contains(e))&&(this._dragOver=!1)}async _uploadFiles(t,e){let i=e??this._category;this._busy=!0,this._error="",this._hint="";let a=0,n=0;try{for(let d of t){let r;try{r=await ti(this.hass,this.entryId,d,[i])}catch(p){let u=p instanceof Error?p.message:"";if(u!=="doc_too_large"&&u!=="doc_upload_failed")throw p;this._error=s(u,this._lang);continue}r.duplicate_in_object?n++:r.deduped&&a++}n?this._hint=s("doc_dup_in_object",this._lang):a&&(this._hint=s("doc_deduped",this._lang)),await this._load()}catch{this._error=s("doc_upload_failed",this._lang)}finally{this._busy=!1}}async _download(t){try{await Xt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=A(e,this._lang)}}async _preview(t){if(this._isImage(t)){this._lightboxUrl=this._thumbs[t.id]||await this._sign(t);return}try{await wt(this.hass,t.id)}catch(e){this._error=A(e,this._lang)}}_openDoc(t){t.kind==="file"?this._preview(t):at(t.url)&&window.open(t.url,"_blank","noopener")}_startEdit(t){this._editingId=t.id,this._editTitle=t.title||"",this._editCategory=this._category_of(t),this._editDescription=t.description||"",this._addingLink=!1,this._error=""}_cancelEdit(){this._editingId=""}_setSort(t){this._sort=Te(t),G(D.docSort,this._sort)}async _saveEdit(t){let e=(t.tags||[]).filter(a=>!Rt.includes(a)),i=t.kind==="file"?[this._editCategory,...e]:t.tags??[];this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,title:this._editTitle.trim()||t.filename||t.url||"",tags:i,description:this._editDescription.trim()}),this._editingId="",await this._load()}catch(a){this._error=A(a,this._lang)}finally{this._busy=!1}}async _delete(t){let e=jt(t);if(window.confirm(s("doc_delete_confirm",this._lang).replace("{name}",e))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:t.id}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}}async _addLink(){let t=this._linkUrl.trim();if(t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/add_link",entry_id:this.entryId,url:t,title:this._linkTitle.trim()||null,description:this._linkDescription.trim()||null}),this._linkUrl="",this._linkTitle="",this._linkDescription="",this._addingLink=!1,await this._load()}catch(e){this._error=A(e,this._lang,s("doc_link_invalid",this._lang))}finally{this._busy=!1}}}render(){let t=this._lang;return o`
      ...
      ${this._loaded&&this._docs.length>=2?o`<div class="doc-tools">
            ...
            <select class="sort-select" aria-label=${s("doc_sort",t)} .value=${this._sort}
              ...
              ${$e.map(e=>o`<option value=${e} ?selected=${e===this._sort}>${s(`doc_sort_${e}`,t)}</option>`)}
            </select>
          </div>`:h}
      ...
      ${this._loaded?this._docs.length===0?o`<div class="doc-empty">${s("documents_empty",t)}</div>`:(()=>{let e=this._filter.trim()?ne(this._docs,this._filter):wi(this._docs,this._sort);return e.length===0?o`<div class="doc-empty">${s("doc_search_none",t)}</div>`:o`<div class="doc-list">${e.map(i=>this._renderDoc(i,t))}</div>`})():o`<div class="doc-empty">${s("loading",t)}</div>`}
    ...
    `}_renderDoc(t,e){if(this._editingId===t.id)return this._renderEdit(t,e);let i=t.kind==="file",a=this._category_of(t),n=i?`${s(`doc_cat_${a}`,e)} \xB7 ${ft(t.size,e)}`:s("doc_link_badge",e),d=this._thumbs[t.id];return o`
      <div class="doc-row">
        ${i&&d?o`<img
              class="doc-thumb"
              src=${d}
  ...
  `],g([S({attribute:!1})],V.prototype,"hass",2),g([S({attribute:!1})],V.prototype,"entryId",2),g([S({type:Boolean})],V.prototype,"canWrite",2),g([m()],V.prototype,"_docs",2),g([m()],V.prototype,"_filter",2),g([m()],V.prototype,"_loaded",2),g([m()],V.prototype,"_busy",2),g([m()],V.prototype,"_error",2),g([m()],V.prototype,"_hint",2),g([m()],V.prototype,"_addingLink",2),g([m()],V.prototype,"_linkUrl",2),g([m()],V.prototype,"_linkTitle",2),g([m()],V.prototype,"_category",2),g([m()],V.prototype,"_thumbs",2),g([m()],V.prototype,"_lightboxUrl",2),g([m()],V.prototype,"_editingId",2),g([m()],V.prototype,"_editTitle",2),g([m()],V.prototype,"_editCategory",2),g([m()],V.prototype,"_editDescription",2),g([m()],V.prototype,"_linkDescription",2),g([m()],V.prototype,"_sort",2),g([m()],V.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",V);var nt=class extends H{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._filter="";this._loadedKey="";this._localeReady=!1}get _lang(){return U(this.hass)}get _refId(){return this.partId||this.taskId||""}get _linkField(){return this.partId?"part_ids":"task_ids"}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,rt(this._lang).then(()=>this.requestUpdate()));let e=`${this.entryId}|${this._refId}`;this.hass&&this.entryId&&this._refId&&this._loadedKey!==e&&(this._loadedKey=e,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error=""}catch(t){this._error=A(t,this._lang),this._loaded=!0}}_links(t){return t[this._linkField]||[]}_linked(){return this._docs.filter(t=>this._links(t).includes(this._refId))}_available(){return this._docs.filter(t=>!this._links(t).includes(this._refId))}async _setLinks(t,e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,[this._linkField]:e}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}_link(){let t=this._docs.find(e=>e.id===this._attachId);t&&(this._attachId="",this._setLinks(t,[...this._links(t),this._refId]))}_unlink(t){this._setLinks(t,this._links(t).filter(e=>e!==this._refId))}_isPdf(t){return t.mime==="application/pdf"||(t.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(t){return this._isPdf(t)&&this.taskId?t.task_pages?.[this.taskId]:void 0}async _open(t){if(t.kind==="weblink"){at(t.url)&&window.open(t.url,"_blank","noopener");return}let e=this._pageFor(t);try{await wt(this.hass,t.id,e?`#page=${e}`:"")}catch(i){this._error=A(i,this._lang)}}async _setPage(t,e){if(this.taskId){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,task_pages:{[this.taskId]:e}}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}}async _download(t){try{await Xt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=A(e,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return h;let t=this._lang,e=this._linked(),i=this._available();return o`
      <div class="task-docs">
        ...
        ${e.length===0?o`<div class="tdoc-empty">${s(this.partId?"doc_part_none":"doc_task_none",t)}</div>`:(()=>{let a=ne(e,this._filter);return a.length===0?o`<div class="tdoc-empty">${s("doc_search_none",t)}</div>`:o`<div class="tdoc-list">${a.map(n=>this._renderRow(n,t))}</div>`})()}
        ${this.canWrite&&i.length?o`<div class="tdoc-attach">
              ...
              >
                ...
                ${i.map(a=>o`<option value=${a.id} ?selected=${a.id===this._attachId}>${jt(a)}</option>`)}
              </select>
    ...
    `}_renderRow(t,e){let i=t.kind==="file",a=this._isPdf(t),n=this._pageFor(t),d=(t.tags||[]).find(p=>Rt.includes(p))||"other",r=i?ft(t.size,e):s("doc_link_badge",e);return o`
      <div class="tdoc-row">
  ...
  `,g([S({attribute:!1})],ot.prototype,"hass",2),g([S({attribute:!1})],ot.prototype,"entryId",2),g([S({attribute:!1})],ot.prototype,"parts",2),g([S({type:Boolean})],ot.prototype,"canWrite",2),g([S({attribute:!1})],ot.prototype,"currencySymbol",2),g([m()],ot.prototype,"_editing",2),g([m()],ot.prototype,"_busy",2),g([m()],ot.prototype,"_error",2),g([m()],ot.prototype,"_restockFor",2),g([m()],ot.prototype,"_restockQty",2),g([m()],ot.prototype,"_restockInvalid",2),g([m()],ot.prototype,"_docsFor",2);customElements.get("maintenance-parts-section")||customElements.define("maintenance-parts-section",ot);var Zi=new Set(["completed","skipped","reset","missed"]);function ts(l,c){let t=l.reading_values||[];return t.length?t.filter(e=>typeof e.value=="number").map(e=>({id:e.id,name:e.name||"",value:e.value,unit:e.unit||""})):typeof l.reading_value=="number"?[{id:"",name:"",value:l.reading_value,unit:c||""}]:[]}function ki(l){let c=[];for(let t of l){let e=[...t.history??[]].map(a=>({h:a,ts:new Date(a.timestamp).getTime()})).filter(a=>Number.isFinite(a.ts)).sort((a,n)=>a.ts-n.ts),i=new Map;for(let{h:a,ts:n}of e){let d=ts(a,t.reading_unit).map(p=>{let u=i.get(p.id);return i.set(p.id,p.value),{name:p.name,value:p.value,unit:p.unit,delta:u==null?null:p.value-u}});if(!Zi.has(a.type))continue;let r=a.checklist_state&&typeof a.checklist_state=="object"?Object.values(a.checklist_state):null;c.push({ts:n,timestamp:a.timestamp,taskId:t.id,taskName:t.name,type:a.type,cost:typeof a.cost=="number"?a.cost:null,duration:typeof a.duration=="number"?a.duration:null,notes:a.notes??null,completedBy:a.completed_by??null,phaseName:a.phase_id&&t.phases?.[a.phase_id]?.name||null,refNo:typeof a.ref_no=="number"?a.ref_no:null,taskRefNo:typeof t.ref_no=="number"?t.ref_no:null,readings:d,parts:(a.used_parts||[]).filter(p=>p&&(p.name||p.part_id)).map(p=>({name:p.name||p.part_id,quantity:typeof p.quantity=="number"?p.quantity:1})),photoIds:Ze(a),checklist:r&&r.length?{done:r.filter(Boolean).length,total:r.length}:null})}}return c.sort((t,e)=>e.ts-t.ts||t.taskName.localeCompare(e.taskName)),c}function $i(l,c){let t=c.from?new Date(`${c.from}T00:00:00`).getTime():null,e=c.to?new Date(`${c.to}T00:00:00`).getTime()+864e5:null;return l.filter(i=>!(c.taskId&&i.taskId!==c.taskId||t!=null&&i.ts<t||e!=null&&i.ts>=e))}function le(l){let c=0,t=0;for(let e of l)e.type==="completed"&&(c++,e.cost!=null&&(t+=e.cost));return{completed:c,totalCost:t}}var ce={readings:!0,parts:!0,photos:!0,documents:!0,checklist:!0,notes:!0,costs:!0,person:!0,refs:!0,qr:!1,bare:!0,docDescriptions:!0};function es(l){return!!(l.notes&&l.notes.trim()||l.cost!=null||l.duration!=null||l.readings.length||l.parts.length||l.photoIds.length||l.checklist)}function C(l){return String(l??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}var is=6;function Ti(l,c,t,e,i,a,n,d={}){let r=d.options??{layout:"chronological",include:ce},p=r.include,u=d.data??{objectRef:null,tasks:[],photos:{},fmtNumber:$=>String($)},_=c.filter($=>$.type==="completed"&&(p.bare!==!1||es($))),{totalCost:v}=le(_),f=$=>p.refs&&u.objectRef&&$.taskRefNo!=null&&$.refNo!=null?`${u.objectRef}.${$.taskRefNo}-${$.refNo}`:null,b=$=>p.refs&&u.objectRef&&$.taskRefNo!=null?`${u.objectRef}.${$.taskRefNo}`:null,R=[[t.refNumber,p.refs&&u.objectRef?`#${u.objectRef}`:null],[t.manufacturer,l.manufacturer],[t.model,l.model],[t.serial,l.serial_number],[t.installed,l.installation_date?e(l.installation_date):null]].filter(([,$])=>$).map(([$,B])=>`<div class="meta-row"><span>${C($)}</span><strong>${C(B)}</strong></div>`).join(""),x=$=>{let B=[];if(p.readings&&$.readings.length){let F=$.readings.map(z=>{let Y=`${u.fmtNumber(z.value)}${z.unit?` ${C(z.unit)}`:""}`,X=z.delta!=null?` <span class="delta">(${z.delta>=0?"+":"\u2212"}${u.fmtNumber(Math.abs(z.delta))})</span>`:"";return`${z.name?`${C(z.name)}: `:""}${Y}${X}`});B.push(`<div class="fact"><span class="k">${C(t.readings)}</span>${F.join(" \xB7 ")}</div>`)}if(p.parts&&$.parts.length&&B.push(`<div class="fact"><span class="k">${C(t.parts)}</span>${$.parts.map(F=>`${C(F.name)} \xD7 ${u.fmtNumber(F.quantity)}`).join(", ")}</div>`),p.checklist&&$.checklist&&B.push(`<div class="fact"><span class="k">${C(t.checklist)}</span>${$.checklist.done}/${$.checklist.total}</div>`),p.photos&&$.photoIds.length){let F=$.photoIds.slice(0,is),z=F.map(X=>{let W=u.photos[X],j=W?.name||X.slice(0,8);return W?.url?`<figure class="photo"><img src="${C(W.url)}" alt="" /><figcaption>${C(j)}</figcaption></figure>`:`<figure class="photo"><figcaption>${C(j)}</figcaption></figure>`}),Y=$.photoIds.length>F.length?`<span class="more">+${$.photoIds.length-F.length}</span>`:"";B.push(`<div class="fact"><span class="k">${C(t.photos)}</span><div class="photos">${z.join("")}${Y}</div></div>`)}return B.length?`<div class="details">${B.join("")}</div>`:""},M=$=>[p.notes?$.notes:null,p.person&&$.completedBy?`${t.completedBy}: ${$.completedBy}`:null].filter(Boolean).join(" \xB7 "),k=$=>p.costs?`<td class="num">${$.cost!=null?C(a($.cost)):C(t.none)}</td>
    ...
    <th>${C(t.colNotes)}</th>
  </tr></thead>`,st=($,B)=>{let F=M($),z=x($),Y=C(B?$.phaseName?`${$.taskName} \xB7 ${$.phaseName}`:$.taskName:$.phaseName||"");return`<tr class="entry">
        <td class="nowrap">${C(e($.timestamp))}${I(f($))}</td>
        <td>${B?`${Y} ${I(b($))}`:Y}</td>
        ${k($)}
        <td class="notes">${C(F)||(z?"":C(t.none))}</td>
      </tr>${z?`<tr class="entry-details"><td colspan="${O}" class="details-cell">${z}</td></tr>`:""}`},ut;if(r.layout==="by_task"){let $=new Map(u.tasks.map(z=>[z.id,z])),B=[...u.tasks.map(z=>z.id)];for(let z of _)B.includes(z.taskId)||B.push(z.taskId);ut=`${B.map(z=>{let Y=_.filter(gt=>gt.taskId===z);if(!Y.length)return"";let X=$.get(z),W=X?.name||Y[0].taskName,j=p.refs?X?.ref??b(Y[0]):null,T=p.documents&&X?.documents.length?`<div class="fact"><span class="k">${C(t.documents)}</span>${X.documents.map(gt=>`${C(gt.title)}${gt.page?` (${C(t.page(gt.page))})`:""}${p.docDescriptions!==!1&&gt.description?` \u2014 <span class="doc-desc">${C(gt.description)}</span>`:""}`).join(", ")}</div>`:"",P=p.qr&&X?.qrDataUri?`<figure class="qr"><img src="${C(X.qrDataUri)}" alt="" /><figcaption>${C(t.scanHint)}</figcaption></figure>`:"",Mt=Y.reduce((gt,Vi)=>gt+(Vi.cost??0),0);return`<section class="task">
  <div class="task-head">
...
`)}
  ...
  <tfoot><tr>
    ...
    ${p.costs?`<td class="num">${C(a(v))}</td><td colspan="2"></td>`:"<td></td>"}
  </tr></tfoot>
...
${d.capped?`<p class="cap-note">${C(t.capNote)}</p>`:""}
      ...
      </div>`}render(){let t=this._lang,e=this._entries;if(!e.length&&!this._loading)return h;let i=$i(e,{taskId:this._filterTask||null,from:this._from||null,to:this._to||null}),{completed:a,totalCost:n}=le(i),d=this._expanded?i:i.slice(0,15);return o`
      <div class="section">
        <h3>
...
`;function Si(l){let c=window;c.customCards=c.customCards||[],c.customCards.some(t=>t.type===l.type)||c.customCards.push(l)}var dt=class extends H{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(t){if(this._config={...t},t.past_days&&[30,90].includes(t.past_days)?this._pastDays=t.past_days:t.window_days&&[7,14,30,365].includes(t.window_days)&&(this._windowDays=t.window_days,this._pastDays=0),typeof t.user_filter=="string"&&(this._userFilter=t.user_filter),typeof t.object_filter=="string")this._objectFilter=t.object_filter,this._configuredObjects=[];else if(Array.isArray(t.object_filter)){let e=t.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=e.length===1?e[0]:"",this._configuredObjects=e.length>1?e:[]}}getCardSize(){return 6}get _lang(){return U(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(t){if(super.updated(t),At(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=e,Pt(this._stats.budget)}catch{}}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){t();return}this._unsub=t}catch{}}_onEventClick(t){if(t.history_timestamp){this._openHistoryEntry(t);return}_i(t.entry_id,t.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:t.entry_id,task_id:t.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(t){try{let e=await ri(this.hass,t.entry_id,t.task_id,t.history_timestamp);if(!e||mi(e))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h;let t=this._lang,e=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,n=null;this._userFilter&&(n=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let d=y=>{let st=y.toLowerCase();return this._objects.find($=>$.entry_id===y||$.object.name.toLowerCase()===st)?.entry_id??null},r=new Set(this._configuredObjects.map(d).filter(y=>y!==null)),p=r.size?this._objects.filter(y=>r.has(y.entry_id)):this._objects,u=this._config.show_object_filter!==!1&&p.length>1,_=this._objectFilter?d(this._objectFilter):null,v=_&&p.some(y=>y.entry_id===_)?p.filter(y=>y.entry_id===_):p,f=new Date;f.setHours(0,0,0,0);let b=this._pastDays>0,R=b?si(v,f,this._pastDays,n):ii(v,f,this._windowDays,n),x=Ft(f),M=this._windowDays===365||b,k=M?R.filter(y=>y.events.length>0):R,I=y=>{let st=`cal-status-${y.status}`,ut=y.projected?"cal-event-projected":"",$=y.status==="overdue"&&y.days_until_due!=null?` (${Tt(y.days_until_due,t)})`:"",B=y.projected&&y.interval_days?o`<span class="cal-event-recur">${y.interval_unit&&y.interval_unit!=="days"?`${y.interval_days} ${s("unit_"+y.interval_unit,t)}`:s("cal_every_n_days",t).replace("{n}",String(y.interval_days))}</span>`:h,F=y.schedule_type==="sensor_based",z=F?o`<ha-icon class="cal-event-icon cal-source-sensor"
          ...
          </span>`:h,X=Kt(this._stats?.budget),W=y.history_type?s(y.history_type,t):s(y.status,t);return o`
      ...
      `},O=y=>{let[st,ut,$]=y.date.split("-").map(Number),B=new Date(st,ut-1,$),F=y.date===x,z=Pe(B,t,"short"),Y=Le(B,t,"long");return o`
          ...
          <div class="header">
            ...
            >
              ...
              <span class="header-summary">
                ${ft(t.total_bytes,e)}
                ${t.dedup_savings_bytes>0?o`<span class="saved">−${ft(t.dedup_savings_bytes,e)}</span>`:h}
              </span>
            </button>
            <button
              class="icon-btn"
  ...
  `,g([S({attribute:!1})],bt.prototype,"hass",2),g([m()],bt.prototype,"_open",2),g([m()],bt.prototype,"_busy",2),g([m()],bt.prototype,"_error",2),g([m()],bt.prototype,"_name",2),g([m()],bt.prototype,"_views",2);customElements.get("maintenance-saved-views-dialog")||customElements.define("maintenance-saved-views-dialog",bt);var ns=60,ls=20,Ei=30,cs={approaching:"\u2197",stable:"\u2192",easing:"\u2198"};function Se(l,c){let t=l.trigger_config;if(!t?.entity_id)return null;let e,i=t.type||"threshold";if(i==="threshold")if(t.trigger_above!=null)e=1;else if(t.trigger_below!=null)e=-1;else return null;else if(i==="counter"||i==="runtime"||i==="state_change")e=1;else return null;let a=c.get(t.entity_id)||[],n=i==="runtime"||i==="state_change",d=a.length>=2?a.map(b=>({ts:b.ts,val:b.val})):n?[]:(l.history||[]).filter(b=>b.trigger_value!=null).map(b=>({ts:new Date(b.timestamp).getTime(),val:b.trigger_value}));if(l.trigger_current_value!=null&&(d=[...d,{ts:Date.now(),val:l.trigger_current_value}]),d.length<2)return null;d.sort((b,R)=>b.ts-R.ts);let r=d.map(b=>b.val),p=Math.max(...r)-Math.min(...r),u=r[r.length-1]-r[0],_=t.trigger_delta_mode&&l.trigger_baseline_value!=null&&t.trigger_target_value!=null?l.trigger_baseline_value+t.trigger_target_value:t.trigger_target_value,v=i==="threshold"?t.trigger_above??t.trigger_below:i==="counter"?_:i==="runtime"?t.trigger_runtime_hours:t.trigger_target_changes,f=typeof v=="number"?Math.max(Math.abs(v-r[0]),p):p;return f===0||Math.abs(u)<f*(typeof v=="number"?.05:.15)?"stable":Math.sign(u)===e?"approaching":"easing"}function Ee(l,c){let t=l.trigger_config??null;if(!t)return h;let e=t.type||"threshold",i=l.trigger_entity_info?.unit_of_measurement??"",a=0,n="";if(e==="threshold"){let p=l.trigger_current_value??null;if(p==null)return h;let u=t.trigger_above,_=t.trigger_below;if(u!=null&&_!=null){let v=(u+_)/2,f=Math.abs(u-_)/2||1;a=Math.min(100,Math.max(0,Math.abs(p-v)/f*100));let b=Math.abs(p-u)<=Math.abs(p-_)?u:_;n=`${it(p,c?.lang,1)} / ${it(b,c?.lang)} ${i}`}else if(u!=null){let v=l.trigger_entity_info?.min,f=u>0?0:v!=null&&v<u?v:u<0?2*u:-100,b=u-f||1;a=Math.min(100,Math.max(0,(p-f)/b*100)),n=`${it(p,c?.lang,1)} / ${it(u,c?.lang)} ${i}`}else if(_!=null){let v=l.trigger_entity_info?.max,f=v!=null&&v>_?v:_>0?_*2:_<0?0:100,b=f-_||1;a=Math.min(100,Math.max(0,(f-p)/b*100)),n=`${it(p,c?.lang,1)} / ${it(_,c?.lang)} ${i}`}else if(t.trigger_equals!=null||t.trigger_not_equals!=null){let v=t.trigger_equals!=null?`= ${t.trigger_equals}`:`\u2260 ${t.trigger_not_equals}`;n=`${it(p,c?.lang,1)} (${v}${i?` ${i}`:""})`,a=l.trigger_active?100:0}else return h}else if(e==="counter"){let p=t.trigger_target_value||1,u;if(t.trigger_delta_mode?(u=l.trigger_current_delta??null,u==null&&l.trigger_baseline_value!=null&&l.trigger_current_value!=null&&(u=l.trigger_current_value-l.trigger_baseline_value)):u=l.trigger_current_value??null,u==null)return h;a=Math.min(100,Math.max(0,u/p*100)),n=`${it(u,c?.lang,1)} / ${it(p,c?.lang)} ${i}`}else if(e==="state_change"){let p=t.trigger_target_changes||1,u=l.trigger_current_value??null;if(u==null)return h;a=Math.min(100,Math.max(0,u/p*100)),n=`${it(u,c?.lang,0)} / ${it(p,c?.lang,0)}`}else if(e==="runtime"){let p=t.trigger_runtime_hours||100,u=l.trigger_current_value??null;if(u==null)return h;a=Math.min(100,Math.max(0,u/p*100)),n=`${it(u,c?.lang,1)}h / ${it(p,c?.lang)}h`}else if(e==="compound"){let p=t.compound_logic||t.operator||"AND",u=t.conditions?.length||0;n=`${p} (${u})`,a=l.trigger_active?100:0}else return h;let d=a>=100,r=a>90?"var(--error-color, #f44336)":a>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return o`
    <div class="trigger-progress">
      ...
      <span class="trigger-progress-label">${n}${c?.trend?o` <i class="trend-arrow trend-${c.trend}" title="${s(`trend_${c.trend}`,c.lang??"en")}" aria-label="${s(`trend_${c.trend}`,c.lang??"en")}">${cs[c.trend]}</i>`:h}</span>
    </div>
  `}function Re(l,c,t){if(!l.trigger_config?.entity_id)return h;let e=l.trigger_config.entity_id,i=c.get(e)||[],a=[];if(i.length>=2)a=i.map(O=>({ts:O.ts,val:O.val}));else{if(!l.history)return h;for(let O of l.history)O.trigger_value!=null&&a.push({ts:new Date(O.timestamp).getTime(),val:O.trigger_value})}if(l.trigger_current_value!=null&&a.push({ts:Date.now(),val:l.trigger_current_value}),a.length<2)return h;a.sort((O,y)=>O.ts-y.ts);let n=ns,d=ls,r=a.map(O=>O.val),p=Math.min(...r),u=Math.max(...r),_=u-p||1;p-=_*.1,u+=_*.1;let v=a[0].ts,b=a[a.length-1].ts-v||1,R=O=>(O-v)/b*n,x=O=>2+(1-(O-p)/(u-p))*(d-4),M=a;if(M.length>Ei){let O=Math.ceil(M.length/Ei);M=M.filter((y,st)=>st%O===0||st===M.length-1)}let k=M.map(O=>`${E(R(O.ts))},${E(x(O.val))}`).join(" "),I=l.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return o`
  ...
  `}function Ri(l,c){let t=c;if(l.days_until_due==null||!l.interval_days||l.interval_days<=0)return h;let{pct:e,overflow:i}=Zt(l.interval_days,l.days_until_due,l.interval_unit),a="var(--success-color, #4caf50)";return l.status==="overdue"?a="var(--error-color, #f44336)":l.status==="due_soon"&&(a="var(--warning-color, #ff9800)"),o`
  ...
  `}var de=210,_t=46,kt=14,$t=12,Oi=14,ds=20+Oi,ps=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],et=class extends H{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(t=>{let e=Math.floor(t[0]?.contentRect?.width||0);e&&Math.abs(e-this._width)>2&&(this._width=e)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(t){t!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:t},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let t=this._width||320,e=[...this.points].sort((a,n)=>a.ts-n.ts),i=this.lang;return o`
    ...
    `}_renderSvg(t,e){let i=this.lang,a=t-_t-kt,n=de-ds,d=n-$t,r=1/0,p=-1/0;for(let j of e)r=Math.min(r,j.min??j.val),p=Math.max(p,j.max??j.val);this.thresholdAbove!=null&&(r=Math.min(r,this.thresholdAbove),p=Math.max(p,this.thresholdAbove)),this.thresholdBelow!=null&&(r=Math.min(r,this.thresholdBelow),p=Math.max(p,this.thresholdBelow)),this.targetValue!=null&&(r=Math.min(r,this.targetValue),p=Math.max(p,this.targetValue)),this.forceZero&&(r=Math.min(r,0));let u=(p-r||1)*.06,_=this.forceZero&&r>=0?0:r-u,{ticks:v,niceMin:f,niceMax:b}=Bt(_,p+u,4);this.forceZero&&r>=0&&f<0&&(f=0,v=v.filter(j=>j>=0));let R=e[0].ts,x=this.projection&&this.projection.length===2?this.projection[1].ts:null,M=x!=null?Math.max(e[e.length-1].ts,x):e[e.length-1].ts,k=M-R||1,I=ie(R,M),O=j=>_t+(j-R)/k*a,y=j=>$t+(1-(j-f)/(b-f||1))*d,st=e.map(j=>`${E(O(j.ts))},${E(y(j.val))}`).join(" "),ut=`M${E(O(e[0].ts))},${n} `+e.map(j=>`L${E(O(j.ts))},${E(y(j.val))}`).join(" ")+` L${E(O(e[e.length-1].ts))},${n} Z`,$="",B=e.filter(j=>j.min!=null&&j.max!=null);if(B.length>=2){let j=B.map(P=>`${E(O(P.ts))},${E(y(P.max))}`),T=[...B].reverse().map(P=>`${E(O(P.ts))},${E(y(P.min))}`);$=`M${j[0]} `+j.slice(1).map(P=>`L${P}`).join(" ")+` L${T.join(" L")} Z`}let F=[];if(this.thresholdBelow!=null){let j=y(this.thresholdBelow);F.push({y:j,h:Math.max(0,n-j),lineY:j,label:`\u25BC ${vt(this.thresholdBelow,i)}`,labelY:Math.min(n-4,j+13)})}if(this.thresholdAbove!=null){let j=y(this.thresholdAbove);F.push({y:$t,h:Math.max(0,j-$t),lineY:j,label:`\u25B2 ${vt(this.thresholdAbove,i)}`,labelY:Math.max($t+11,j-5)})}let z=e[e.length-1],Y=(this.events||[]).filter(j=>j.ts>=R&&j.ts<=M),X=se(R,M,Math.max(2,Math.min(5,Math.floor(a/110)+1))),W=this._hover;return o`
      <div class="svg-holder">
        <svg
          ...
          @pointermove=${j=>this._onPointer(j,e,O,y,t)}
          @pointerdown=${j=>this._onPointer(j,e,O,y,t)}
          @pointerleave=${()=>this._hover=null}
        >
          <defs>
            <clipPath id="plot"><rect x="${_t}" y="${$t}" width="${a}" height="${d}" /></clipPath>
            ${F.length?J`<clipPath id="danger">${F.map(j=>J`<rect x="${_t}" y="${E(j.y)}" width="${a}" height="${E(j.h)}" />`)}</clipPath>`:h}
          ...
          ${v.map(j=>{let T=y(j);return T<$t-1||T>n+1?h:J`
              <line x1="${_t}" y1="${E(T)}" x2="${t-kt}" y2="${E(T)}"
                stroke="var(--divider-color)" stroke-width="1" opacity="0.6" />
              <text x="${_t-7}" y="${E(T+3.5)}" text-anchor="end" class="tick-label">${vt(j,i)}</text>`})}

          ${F.map(j=>J`<rect x="${_t}" y="${E(j.y)}" width="${a}" height="${E(j.h)}"
          ...
          ${F.map(j=>J`
              <line x1="${_t}" y1="${E(j.lineY)}" x2="${t-kt}" y2="${E(j.lineY)}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${t-kt-4}" y="${E(j.labelY)}" text-anchor="end" class="zone-label">${j.label}</text>`)}
          ...
          ${this.projection&&this.projection.length===2?J`<line x1="${E(O(this.projection[0].ts))}" y1="${E(y(this.projection[0].val))}"
                x2="${E(Math.min(O(this.projection[1].ts),t-kt))}" y2="${E(y(Math.max(f,Math.min(b,this.projection[1].val))))}"
                stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.8" />`:h}

          ${X.map((j,T)=>{let P=O(j),Mt=T===0?"start":T===X.length-1?"end":"middle";return J`<text x="${E(P)}" y="${de-5}" text-anchor="${Mt}" class="tick-label">${It(j,i,I)}</text>`})}

          <line x1="${_t}" y1="${n}" x2="${t-kt}" y2="${n}" stroke="var(--divider-color)" stroke-width="1" />

          ${Y.map(j=>{let T=O(j.ts),P=j.type==="completed"?"var(--success-color, #4caf50)":j.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return J`
              <line x1="${E(T)}" y1="${$t}" x2="${E(T)}" y2="${n}" stroke="${P}" stroke-width="1" opacity="0.14" />
              <rect x="${E(T-1.5)}" y="${n+3}" width="3" height="${Oi-6}" rx="1.5" fill="${P}">
          ...
          ${W?J`
                ...
                <circle cx="${E(W.x)}" cy="${E(W.y)}" r="4.5" fill="var(--primary-color)"
                  stroke="var(--card-background-color, #fff)" stroke-width="2" />`:J`<circle cx="${E(O(z.ts))}" cy="${E(y(z.val))}" r="4" fill="var(--primary-color)"
    ...
    `}_onPointer(t,e,i,a,n){let r=t.currentTarget.getBoundingClientRect(),p=(t.clientX-r.left)/r.width*n;if(p<_t-8||p>n-kt+8){this._hover=null;return}let u=e[0],_=1/0;for(let v of e){let f=Math.abs(i(v.ts)-p);f<_&&(_=f,u=v)}this._hover={x:i(u.ts),y:a(u.val),p:u}}};et.styles=L`
    ...
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${v?o`
            ...
            <div class="trigger-entity-id">${r.map((b,R)=>o`${R>0?", ":""}<span class="entity-link" @click=${x=>Ht(x,b)}>${b}</span>`)}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `:o`
      ...
      <div class="trigger-limits">
        ...
        ${_==="compound"?o`
          ...
          ${(t.conditions||[]).map((b,R)=>o`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${R+1}. ${s(b.type||"unknown",e)}: ${b.entity_id?o`<span class="entity-link" @click=${x=>Ht(x,b.entity_id)}>${b.entity_id}</span>`:""}</span>
          `)}
        `:h}
      </div>
      ...
      ${a&&a.length>1?o`
        <div class="trigger-entity-list">
          ${a.map(b=>o`
            <span class="trigger-entity-id">${b.friendly_name} (<span class="entity-link" @click=${R=>Ht(R,b.entity_id)}>${b.entity_id}</span>)</span>
          `)}
        </div>
      `:h}
  ...
  `}var vs=200,Vt=10,fs=22;function Ii(l,c,t,e,i){let a=l.history.filter(r=>r.type==="completed"&&(r.cost!=null||r.duration!=null));if(a.length<2)return h;let n=a.some(r=>(r.cost??0)>0),d=a.some(r=>(r.duration??0)>0);return!n&&!d?h:o`
  ...
  `}function bs(l,c,t,e){let i=l.history.filter(T=>T.type==="completed"&&(T.cost!=null||T.duration!=null)).map(T=>({ts:new Date(T.timestamp).getTime(),cost:T.cost??0,duration:T.duration??0})).sort((T,P)=>T.ts-P.ts);if(i.length<2)return h;let a=i.some(T=>T.cost>0),n=i.some(T=>T.duration>0);if(!a&&!n)return h;let d=t!=="duration"&&a,r=t!=="cost"&&n,p=d||!r&&a,u=r||!d&&n,_=640,v=vs,f=p?44:12,b=u?44:12,R=_-f-b,x=v-fs,M=x-Vt,k=i[0].ts,I=i[i.length-1].ts,O=(I-k||864e5)*.05,y=k-O,st=I+O,ut=ie(k,I),$=T=>f+(T-y)/(st-y)*R,B=Bt(0,Math.max(...i.map(T=>T.cost))||1,3),F=Bt(0,Math.max(...i.map(T=>T.duration))||1,3),z=T=>Vt+(1-T/(B.niceMax||1))*M,Y=T=>Vt+(1-T/(F.niceMax||1))*M,X=i.length>1?Math.min(...i.slice(1).map((T,P)=>$(T.ts)-$(i[P].ts))):R,W=Math.max(6,Math.min(22,X*.55)),j=se(k,I,Math.max(2,Math.min(4,i.length)));return o`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${_} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_history",c)}">
        ${p?B.ticks.map(T=>{let P=z(T);return P<Vt-1||P>x+1?h:J`
            <line x1="${f}" y1="${E(P)}" x2="${_-b}" y2="${E(P)}" stroke="var(--divider-color)" stroke-width="1" opacity="0.55" />
            <text x="${f-6}" y="${E(P+3.5)}" text-anchor="end" fill="var(--primary-color)" font-size="10.5">${vt(T,c)}${e}</text>`}):h}
        ${u?F.ticks.map(T=>{let P=Y(T);return P<Vt-1||P>x+1?h:J`<text x="${_-b+6}" y="${E(P+3.5)}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="10.5">${vt(T,c)}m</text>`}):h}

        ${p?i.filter(T=>T.cost>0).map(T=>J`
          <rect x="${E($(T.ts)-W/2)}" y="${E(z(T.cost))}" width="${E(W)}" height="${E(x-z(T.cost))}"
            fill="var(--primary-color)" opacity="0.6" rx="2">
            <title>${It(T.ts,c,!0)}: ${K(T.cost,e,c)}${T.duration?` \xB7 ${T.duration}m`:""}</title>
          </rect>
        `):h}
        ${u?J`
          <polyline points="${i.map(T=>`${E($(T.ts))},${E(Y(T.duration))}`).join(" ")}"
            fill="none" stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-linejoin="round" />
          ${i.map(T=>J`
            <circle cx="${E($(T.ts))}" cy="${E(Y(T.duration))}" r="3.5" fill="var(--accent-color, #ff9800)">
              <title>${It(T.ts,c,!0)}: ${T.duration}m${T.cost?` \xB7 ${K(T.cost,e,c)}`:""}</title>
            </circle>
          `)}
        `:h}

        <line x1="${f}" y1="${x}" x2="${_-b}" y2="${x}" stroke="var(--divider-color)" stroke-width="1" />
        ${j.map((T,P)=>{let Mt=P===0?"start":P===j.length-1?"end":"middle";return J`<text x="${E($(T))}" y="${v-6}" text-anchor="${Mt}" fill="var(--secondary-text-color)" font-size="10">${It(T,c,ut)}</text>`})}
      </svg>
    </div>
  ...
  `}function Oe(l,c,t){if(!l.responsible_user_id)return h;let e=t?.(l.responsible_user_id)??null;if(e)return o`<span class="user-badge">${Qe(e)}${e.name}</span>`;let i=c(l.responsible_user_id);return i?o`
    <span class="user-badge">
      <ha-icon icon="mdi:account"></ha-icon>
      ${i}
    </span>
  `:h}function ys(l,c){let t=c.lang,e=c.isOperator,i=l.archived?"archived":l.is_done?"done":l.status==="due_soon"?"warning":l.status||"ok",a=l.archived?s("archived",t):l.is_done?s("completed",t):s(l.status||"ok",t);return o`
  ...
  `}function xs(l){let c=l.lang;return o`
    <div class="tab-bar">
  ...
  `}function ws(l,c){if(!We(l))return h;let t=c.lang,e=l.phase_sequence,i=Ue(l.phase_cursor,e.length),a=new Map;for(let n=l.history.length-1;n>=0;n--){let d=l.history[n];d.phase_id&&d.type==="completed"&&!a.has(d.phase_id)&&a.set(d.phase_id,d.timestamp)}return o`
  ...
  `}function ks(l,c){if(!c.features.checklists)return h;let t=ee(l)?.checklist??(l.checklist||[]);if(t.length===0)return h;let e=c.lang,i=l.checklist_progress||{},a=t.filter(n=>i[n]).length;return o`
  ...
  `}function $s(l,c){let t=at(l.documentation_url)?l.documentation_url:null,e=at(c.objectDocUrl)?c.objectDocUrl:null,i=e?null:(c.objectManualDocs||[])[0];if(!l.notes&&!t&&!e&&!i)return h;let a=c.lang;return o`
  ...
  `}function js(l,c){let t=c.lang;if(!c.features.adaptive||!l.suggested_interval||l.suggested_interval===l.interval_days)return h;if(c.suggestionDismissed)return h;let e=l.suggested_interval;return o`
  ...
  `}function Ss(l,c){let t=c.lang,e=l.history.slice(-3).reverse();return e.length===0?h:o`
    ...
    <div class="tab-content overview-tab">
      ...
      <div class="two-column-layout ${a?"":"single-column"}">
        ...
        <div class="right-column">
          ${Ii(l,t,c.costDurationToggle,r=>c.setCostDurationToggle(r),c.currencySymbol)}
        </div>
      </div>
      ${n?zi("weibull","weibull_reliability_curve",ci(l,t),c):h}
  ...
  `}function Os(l,c){switch(c.activeTab){case"overview":return Es(l,c);case"history":return Rs(l,c);default:return h}}function Pi(l,c){return o`
  ...
  `}var Ut=class extends H{createRenderRoot(){return this}render(){return!this.task||!this.ctx?h:o`${Pi(this.task,this.ctx)}`}};g([S({attribute:!1})],Ut.prototype,"task",2),g([S({attribute:!1})],Ut.prototype,"ctx",2);customElements.get("maintenance-task-detail-view")||customElements.define("maintenance-task-detail-view",Ut);function Li(l){if(l.total<=0)return{start:0,end:0,padTop:0,padBottom:0};let c=l.overscan??12,t=Math.max(1,l.step??6),e=Math.max(1,l.rowHeight),i=Math.floor((l.scrollTop-l.listTop)/e),a=Math.ceil(l.viewportHeight/e)+1,n=Math.max(0,i-c);n=Math.floor(n/t)*t;let d=Math.min(l.total,Math.max(i,0)+a+c);return d=Math.min(l.total,Math.ceil(d/t)*t),n>=d&&(n=Math.min(n,Math.max(0,l.total-1)),d=Math.min(l.total,n+Math.max(a,1))),{start:n,end:d,padTop:n*e,padBottom:(l.total-d)*e}}var he={mode:"top",marginTop:0,lastScrollTop:0};function Hi(l,c){return l==="top"?8:c.viewH-c.paneH-8}function Ni(l){let c=l.scrollTop+8-l.layoutTop,t=Math.max(0,l.listH-l.paneH);return{mode:"top",marginTop:c>t?Math.max(0,c):0,lastScrollTop:l.scrollTop}}function Bi(l,c){let t=c.scrollTop,e=c.scrollTop>l.lastScrollTop?"down":c.scrollTop<l.lastScrollTop?"up":"none",i=Math.max(0,c.listH-c.paneH),a=c.paneH+16<=c.viewH||c.listH<=c.paneH,{mode:n,marginTop:d}=l;if(a&&(n="top"),n==="top"&&d>0&&e==="up")d=Math.max(0,Math.min(d,c.scrollTop+8-c.layoutTop)),d<=i&&(d=0);else if(!a&&e==="down"&&n==="top"){let r=c.renderedTop-c.layoutTop;r<=i&&(n="bottom",d=Math.max(0,r))}else!a&&e==="up"&&n==="bottom"&&(d=Math.min(Math.max(0,c.renderedTop-c.layoutTop),i),c.scrollTop+8<=c.layoutTop+d&&(n="top",d=0));return{mode:n,marginTop:d,lastScrollTop:t}}var ue=2,Cs=250,Ot={objects:6,tasks:10,parts:6,documents:8,history:6},Ds="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Me=["due_date","object","type","task_name","area","assigned_user","group"],Fi=["none","area","group","user","object"],As=["overdue","due_soon","triggered","ok"],qi=["tasks","documents","parts","history"],w=class extends H{constructor(){super(...arguments);this.narrow=!1;this.tight=!1;this.split=!1;this._tightObserver=null;this.panel={};this.embedded=!1;this.presets={};this._presetsApplied=!1;this._mountPath=null;this._objects=[];this._stats=null;this._view="overview";this._allParts=null;this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._filterLabel=null;this._filterPriority="";this._savedViews=[];this._activeViewId="";this._unsub=null;this._chartRangeDays=(()=>{try{let t=parseInt(Z(D.chartRange)||"",10);return[7,30,90,365].includes(t)?t:30}catch{return 30}})();this._hideOutliers=(()=>{try{return Z(D.chartHideOutliers)==="1"}catch{return!1}})();this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._operatorWriteEnabled=!1;this._defaultWarningDays=7;this._rowActionStyle="buttons_compact";this._refsInLists=!1;this._rowActionNotice=!1;this._actionLoading=!1;this._moreMenuOpen=!1;this._objMenuOpen=!1;this._toastMessage="";this._toastUndo=null;this._toastActionLabel="";this._filtersOpen=!1;this._newMenuOpen=!1;this._gsSetupsCount=0;this._gsAdoptCount=0;this._gsLoaded=!1;this._batteryFleetSetupAvailable=!1;this._staleBundle=!1;this._staleChecked=!1;this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab=(()=>{try{let t=Z(D.overviewTab);return t==="today"||t==="calendar"?t:"dashboard"}catch{return"dashboard"}})();this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._objectViewMode="cards";this._objectsTableColumns=Fe;this._showArchived=!1;this._bulkMode=!1;this._bulkSelected=new Set;this._virtStart=0;this._virtEnd=0;this._virtRowHeight=53;this._virtTotalRows=0;this._virtScrollAttached=!1;this._virtRaf=0;this._stickyState=he;this._stickySelectPending=!1;this._stickyRaf=0;this._stickyAttached=!1;this._stickyObserver=null;this._collapsedGroups=new Set;this._collapsedSections=(()=>{try{return new Set(JSON.parse(Z(D.collapsedSections)||"[]"))}catch{return new Set}})();this._objectSectionsCollapsed=(()=>{try{let t=JSON.parse(Z(D.objectSections)||"[]");return new Set((Array.isArray(t)?t:[]).filter(e=>qi.includes(e)))}catch{return new Set}})();this._objectSectionOverride=null;this._paletteOpen=!1;this._paletteQuery="";this._paletteActive=0;this._searchRemote=null;this._searchTimer=null;this._searchSeq=0;this._templateGalleryOpen=!1;this._templates=[];this._templateCategories={};this._templateBusy=!1;this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=t=>this._onPopState(t);this._locationChangedHandler=()=>this._onLocationChanged();this._lazyUi=null;this._onStickyScroll=()=>{this._stickyRaf||(this._stickyRaf=requestAnimationFrame(()=>{this._stickyRaf=0,this._updateStickyPane()}))};this._onVirtualScroll=()=>{this._virtRaf||(this._virtRaf=requestAnimationFrame(()=>{this._virtRaf=0,this._updateVirtualWindow()}))};this._deepLinkHandled=!1;this._deepLinkInPlace=!1;this._initialLoadDone=!1;this._kpiRefreshInFlight=!1;this._kpiRefreshPending=!1;this._paletteKeydown=t=>{if(t.key==="/"&&!t.ctrlKey&&!t.metaKey&&!t.altKey&&!this._paletteOpen){let i=t.composedPath()[0];if(i instanceof HTMLElement&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.tagName==="SELECT"||i.isContentEditable))return;t.preventDefault(),this._openPalette();return}if(!this._paletteOpen)return;let e=this._paletteResults;if(t.key==="Escape")t.preventDefault(),this._closePalette();else if(t.key==="ArrowDown")t.preventDefault(),this._paletteActive=Math.min(this._paletteActive+1,e.length-1);else if(t.key==="ArrowUp")t.preventDefault(),this._paletteActive=Math.max(this._paletteActive-1,0);else if(t.key==="Enter"){t.preventDefault();let i=e[this._paletteActive];i&&this._selectPaletteResult(i)}};this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=t=>{let e=t.detail;e?.type==="maintenance-supporter:open-task"&&e.entry_id&&e.task_id&&(t.stopPropagation(),this._showTask(e.entry_id,e.task_id))};this._fullHistory=null;this._onHistoryEntrySaved=async()=>{await this._loadData()}}get _currencySymbol(){return Kt(this._budget)}get _lang(){return U(this.hass)}get _isOperator(){let t=this.hass?.user;return t?t.is_admin?!1:!(this._operatorWriteEnabled&&this._adminPanelUserIds.includes(t.id)):!0}_ensureLazyUi(){return this._lazyUi||(this._lazyUi=Promise.all([import("/maintenance_supporter_panelfiles/panel-chunks/object-dialog-2KLDQAMO.js"),import("/maintenance_supporter_panelfiles/panel-chunks/task-dialog-Y7J63QL3.js"),import("/maintenance_supporter_panelfiles/panel-chunks/complete-dialog-3VO7O7ID.js"),import("/maintenance_supporter_panelfiles/panel-chunks/qr-dialog-XVMHIJYN.js"),import("/maintenance_supporter_panelfiles/panel-chunks/adopt-problem-sensors-dialog-PUHS7S4B.js"),import("/maintenance_supporter_panelfiles/panel-chunks/suggested-setups-dialog-SR2XGE2D.js"),import("/maintenance_supporter_panelfiles/panel-chunks/settings-view-PE57AA5Z.js")]).then(()=>this.updateComplete)),this._lazyUi}async _ui(t){return await this._ensureLazyUi(),this.shadowRoot?.querySelector(t)??null}connectedCallback(){super.connectedCallback(),this._mountPath=window.location.pathname;let t=window.requestIdleCallback,e=()=>this._ensureLazyUi();t?t(e,{timeout:3e3}):window.setTimeout(e,1500),window.addEventListener("popstate",this._popstateHandler),window.addEventListener("location-changed",this._locationChangedHandler),window.addEventListener("keydown",this._paletteKeydown),typeof ResizeObserver<"u"&&(this._tightObserver=new ResizeObserver(i=>{let a=i[0]?.contentRect.width??0;a>0&&(this.tight=a<1e3),a>0&&(this.split=a>=1500)}),this._tightObserver.observe(this)),window.addEventListener("resize",this._onVirtualScroll,{passive:!0});try{let i=Z(D.taskSort);i&&Me.includes(i)&&(this._sortMode=i);let a=Z(D.objectSort);a&&["alphabetical","due_soonest","task_count"].includes(a)&&(this._objectSortMode=a);let n=Z(D.groupBy);n&&Fi.includes(n)&&(this._groupByMode=n);let d=Z(D.objectView);(d==="cards"||d==="table")&&(this._objectViewMode=d)}catch{}if(this._objects.length===0){let i=fi();i&&(this._objects=i.objects,i.stats&&(this._stats=i.stats))}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),window.removeEventListener("location-changed",this._locationChangedHandler),window.removeEventListener("keydown",this._paletteKeydown),this._tightObserver?.disconnect(),this._tightObserver=null,window.removeEventListener("resize",this._onVirtualScroll),this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onVirtualScroll),this._virtScrollAttached=!1,this._virtRaf&&cancelAnimationFrame(this._virtRaf),this._detachStickyPane(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._initialLoadDone=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=null),this._toastTimer&&(clearTimeout(this._toastTimer),this._toastTimer=null),this._toastMessage="",this._toastUndo=null,this._toastActionLabel="",this._statsService?.clearCache(),this._statsService=null}willUpdate(t){super.willUpdate(t),t.has("_groupByMode")&&this._collapsedGroups.size>0&&(this._collapsedGroups=new Set)}updated(t){if(super.updated(t),At(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new ae(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new Je(this.hass),this._userService.getUsers())}let e=this.shadowRoot?.querySelector(".content");e&&!this._virtScrollAttached&&(e.addEventListener("scroll",this._onVirtualScroll,{passive:!0}),this._virtScrollAttached=!0),this._updateVirtualWindow(),this._syncStickyPane(e)}_syncStickyPane(t){let e=this.shadowRoot?.querySelector(".split-pane");if(!e||!t){this._stickyAttached&&this._detachStickyPane();return}this._stickyAttached||(t.addEventListener("scroll",this._onStickyScroll,{passive:!0}),window.addEventListener("resize",this._onStickyScroll),typeof ResizeObserver<"u"&&(this._stickyObserver=new ResizeObserver(this._onStickyScroll)),this._stickyAttached=!0),this._stickyObserver?.observe(e),this._updateStickyPane()}_detachStickyPane(){this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onStickyScroll),window.removeEventListener("resize",this._onStickyScroll),this._stickyObserver?.disconnect(),this._stickyObserver=null,this._stickyRaf&&cancelAnimationFrame(this._stickyRaf),this._stickyRaf=0,this._stickyAttached=!1,this._stickyState=he,this._stickySelectPending=!1}_updateStickyPane(){let t=this.shadowRoot,e=t?.querySelector(".content"),i=t?.querySelector(".split-pane"),a=t?.querySelector(".split-layout"),n=t?.querySelector(".split-list");if(!e||!i||!a||!n)return;let d=e.getBoundingClientRect().top-e.scrollTop,r={scrollTop:e.scrollTop,viewH:e.clientHeight,paneH:i.offsetHeight,listH:n.offsetHeight,layoutTop:a.getBoundingClientRect().top-d,renderedTop:i.getBoundingClientRect().top-d};this._stickySelectPending&&r.scrollTop===this._stickyState.lastScrollTop?this._stickyState=Ni(r):(this._stickySelectPending=!1,this._stickyState=Bi(this._stickyState,r));let p=this._stickyState;i.style.top=`${Hi(p.mode,r)}px`,i.style.marginTop=p.marginTop>0?`${p.marginTop}px`:""}_resetStickyPane(){let t=this.shadowRoot?.querySelector(".content");this._stickyState={...he,lastScrollTop:t?.scrollTop??0},this._stickySelectPending=!0}_updateVirtualWindow(){let t=this.shadowRoot?.querySelector(".content"),e=this.shadowRoot?.querySelector(".task-table.virtual");if(!t||!e)return;let i=e.querySelector(".task-row:not(.virt-sizer)");i&&i.offsetHeight>20&&(this._virtRowHeight=i.offsetHeight);let a=e.getBoundingClientRect().top-t.getBoundingClientRect().top+t.scrollTop,n=Li({scrollTop:t.scrollTop,viewportHeight:t.clientHeight,listTop:a,rowHeight:this._virtRowHeight,total:this._virtTotalRows});(n.start!==this._virtStart||n.end!==this._virtEnd)&&(this._virtStart=n.start,this._virtEnd=n.end)}async _loadData(){let[t,e,i,a,n,d]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"}).catch(()=>null)]);if(d&&(this._savedViews=d.views||[]),t&&(this._objects=qt(t.objects),xe(this._objects,e??this._stats??null),this._maybeLoadGettingStarted()),this._detailOpen()&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/status"}).then(r=>{this._batteryFleetSetupAvailable=!!r.available&&!r.configured}).catch(()=>{this._batteryFleetSetupAvailable=!1}),this._staleChecked||(this._staleChecked=!0,this.hass.connection.sendMessagePromise({type:"maintenance_supporter/version"}).then(r=>{this._staleBundle=Ce(r?.version)}).catch(()=>{})),e&&(this._stats=e),i&&(this._budget=i,Pt(this._budget)),a&&(this._groups=a.groups||{}),n){let r=n;this._features=r.features,this._adminPanelUserIds=r.admin_panel_user_ids||[],this._operatorWriteEnabled=r.operator_write_enabled??!1;let p=r.general?.default_warning_days;typeof p=="number"&&p>=0&&p<=365&&(this._defaultWarningDays=p);let u=r.general?.row_action_style;this._rowActionStyle=u==="icons"||u==="buttons"?u:"buttons_compact",this._rowActionNotice=r.general?.row_action_notice_pending===!0,this._refsInLists=r.general?.ref_numbers_in_lists===!0,this._objectsTableColumns=qe(r.objects_table_columns)}this._fetchMiniStatsForOverview(),this._initialLoadDone=!0,this._handleDeepLink()}_onLocationChanged(){if(!this._initialLoadDone||!window.location.search||this.embedded&&this._mountPath!==null&&window.location.pathname!==this._mountPath)return;if(!this.embedded){let e=`/${typeof this.panel?.url_path=="string"?this.panel.url_path:"maintenance-supporter"}`,i=window.location.pathname;if(i!==e&&!i.startsWith(`${e}/`))return}this._deepLinkHandled=!1,this._deepLinkInPlace=!0;try{this._handleDeepLink()}finally{this._deepLinkInPlace=!1}history.state?.msp_view||history.replaceState({msp_view:this._view,msp_entry:this._selectedEntryId,msp_task:this._selectedTaskId},"")}_handleDeepLink(){if(this._deepLinkHandled)return;let t=new URLSearchParams(window.location.search),e=t.get("ms_action"),i=()=>{let x=window.location.pathname+window.location.hash;history.replaceState(history.state,"",x)};if(e==="add_object"){this._deepLinkHandled=!0,i(),this._ui("maintenance-object-dialog").then(x=>x?.openCreate());return}if(e==="open_vacation"||e==="open_budget"||e==="open_groups"||e==="open_settings"){if(this._deepLinkHandled=!0,i(),!this.hass?.user?.is_admin)return;this._overviewTab="settings",this._ensureLazyUi().then(()=>requestAnimationFrame(()=>{let x=this.shadowRoot?.querySelector("maintenance-settings-view"),M=e.replace("open_","");x?.scrollToSection?.(M)}));return}if(this.embedded&&!this._presetsApplied){this._presetsApplied=!0;let x=this.presets?.tab??"",M=(this.presets?.view??"").trim();if(!t.has("tab")&&ye.includes(x)&&(x!=="settings"||this.hass?.user?.is_admin)&&(this._overviewTab=x),!t.has("view")&&M){let k=M.toLowerCase(),I=this._savedViews.find(O=>O.id===M)??this._savedViews.find(O=>O.name.trim().toLowerCase()===k);I&&(this._overviewTab="dashboard",this._applyView(I.id))}}let a=t.get("tab"),n=t.get("view"),d=t.get("sort"),r=t.get("status");if(a!==null||n!==null||d!==null||r!==null){if(i(),this._view!=="overview"&&(this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()),ye.includes(a??"")&&(a!=="settings"||this.hass?.user?.is_admin)&&this._setOverviewTab(a),n!==null){let x=n.trim().toLowerCase(),M=this._savedViews.find(k=>k.id===n)??this._savedViews.find(k=>k.name.trim().toLowerCase()===x);M&&(this._overviewTab!=="dashboard"&&this._setOverviewTab("dashboard"),this._applyView(M.id))}Me.includes(d??"")&&(this._sortMode=d,this._activeViewId="",G(D.taskSort,this._sortMode)),As.includes(r??"")&&(this._overviewTab!=="dashboard"&&this._setOverviewTab("dashboard"),this._filterByStatus(r))}let p=t.get("entry_id");if(!p)return;this._deepLinkHandled=!0;let u=t.get("task_id"),_=t.get("action"),v=t.get("section"),f=qi.includes(v??"")?v:null,b=window.location.pathname+window.location.hash;history.replaceState(history.state,"",b);let R=this._getObject(p);if(!R){this._showOverview();return}if(u){let x=R.tasks.find(M=>M.id===u);if(!x){this._showObject(p,f);return}this._showTask(p,u),_==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(p,u,x.name,this._features.checklists?x.checklist:void 0,this._features.adaptive&&!!x.adaptive_config?.enabled)}):_==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(p,u,x)})}else this._showObject(p,f)}_isCounterEntity(t){if(!t)return!1;let e=t.type||"threshold";return e==="counter"||e==="state_change"}async _fetchDetailStats(t,e){if(!this._statsService)return;let i=await this._statsService.getDetailStats(t,e,this._chartRangeDays),a=new Map(this._detailStatsData);a.set(t,i),this._detailStatsData=a}_setChartRange(t){if(t===this._chartRangeDays)return;this._chartRangeDays=t;try{G(D.chartRange,String(t))}catch{}let e=this._selectedEntryId&&this._selectedTaskId?this._getTask(this._selectedEntryId,this._selectedTaskId):null,i=e?.trigger_config?.entity_id;if(i){let a=new Map(this._detailStatsData);a.delete(i),this._detailStatsData=a,this._fetchDetailStats(i,this._isCounterEntity(e.trigger_config))}}_setHideOutliers(t){if(t!==this._hideOutliers){this._hideOutliers=t;try{G(D.chartHideOutliers,t?"1":"0")}catch{}}}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let t=[];for(let i of this._objects)for(let a of i.tasks){let n=a.trigger_config?.entity_id;n&&t.push({entityId:n,isCounter:this._isCounterEntity(a.trigger_config)})}if(t.length===0)return;let e=await this._statsService.getBatchMiniStats(t);this._miniStatsData=new Map([...this._miniStatsData,...e])}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e,a=vi(this._objects,i);a!==null&&(this._objects=a,e.objects&&xe(a,this._stats??null),this._refreshKpis(),this._detailOpen()&&(i.objects||(i.delta||[]).some(n=>n.entry_id===this._selectedEntryId))&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId))},{type:"maintenance_supporter/subscribe",deltas:!0,compact:!0});if(!this.isConnected){t();return}this._unsub=t}catch{}}async _refreshKpis(){if(this._kpiRefreshInFlight){this._kpiRefreshPending=!0;return}this._kpiRefreshInFlight=!0;try{do{this._kpiRefreshPending=!1;let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null)]);if(!this.isConnected)return;t&&(this._stats=t),e&&(this._budget=e,Pt(this._budget))}while(this._kpiRefreshPending)}finally{this._kpiRefreshInFlight=!1}}get _taskRows(){let t=[];for(let _ of this._objects)for(let v of _.tasks){if(!this._showArchived&&v.archived||this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let b=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==b)continue}if(this._filterLabel&&!(v.labels||[]).includes(this._filterLabel)||this._filterPriority&&(v.priority||"normal")!==this._filterPriority)continue;let f=[];for(let b of Object.values(this._groups))b.task_refs?.some(R=>R.entry_id===_.entry_id&&R.task_id===v.id)&&f.push(b.name);t.push({entry_id:_.entry_id,task_id:v.id,object_name:_.object.name,allow_skip:v.allow_skip!==!1,notify_enabled:v.notify_enabled!==!1,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_unit:v.interval_unit??null,interval_anchor:v.interval_anchor??null,is_done:v.is_done??!1,archived:v.archived??!1,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,priority:v.priority??"normal",labels:v.labels??[],area_id:_.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:f})}let e={overdue:0,triggered:1,due_soon:2,ok:3},i=(_,v)=>(e[_.status]??9)-(e[v.status]??9),a=(_,v)=>(_.days_until_due??99999)-(v.days_until_due??99999),n=(_,v)=>i(_,v)||a(_,v),d=_=>_.area_id&&this.hass?.areas?.[_.area_id]?.name||"",r=_=>_.responsible_user_id&&this._userService?.getUserName(_.responsible_user_id)||"",p=_=>_.group_names[0]||"",u={due_date:n,object:(_,v)=>_.object_name.localeCompare(v.object_name)||n(_,v),type:(_,v)=>_.type.localeCompare(v.type)||n(_,v),task_name:(_,v)=>_.task_name.localeCompare(v.task_name),area:(_,v)=>{let f=d(_),b=d(v);return!f&&b?1:f&&!b?-1:f.localeCompare(b)||n(_,v)},assigned_user:(_,v)=>{let f=r(_),b=r(v);return!f&&b?1:f&&!b?-1:f.localeCompare(b)||n(_,v)},group:(_,v)=>{let f=p(_),b=p(v);return!f&&b?1:f&&!b?-1:f.localeCompare(b)||n(_,v)}};return t.sort(u[this._sortMode]),t}_getObject(t){return this._objects.find(e=>e.entry_id===t)}_getTask(t,e){return this._getObject(t)?.tasks.find(a=>a.id===e)}_listRef(t,e){if(!this._refsInLists)return h;let i=this._getObject(t);return Dt(xt(i?.object,i?.tasks.find(a=>a.id===e)))}_objRef(t){return this._refsInLists?Dt(yt(t)):h}_pushPanelState(t,e,i){let a={msp_view:t,msp_entry:e||null,msp_task:i||null};this._deepLinkInPlace?history.replaceState(a,""):history.pushState(a,"")}_onPopState(t){let e=t.state;if(e?.msp_view&&(this._view=e.msp_view,this._selectedEntryId=e.msp_entry||null,this._selectedTaskId=e.msp_task||null,this._moreMenuOpen=!1,this._objectSectionOverride=null,e.msp_view==="all_parts"&&this._loadAllParts(),e.msp_view==="task"&&e.msp_entry&&e.msp_task)){this._historyFilter=null;let i=this._getTask(e.msp_entry,e.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop()}_showAllParts(){this._pushPanelState("all_parts"),this._view="all_parts",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop(),this._loadAllParts()}async _loadAllParts(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"});this._allParts=t.parts||[]}catch{this._allParts=[]}}_filterByStatus(t){this._filterStatus=t,this._activeViewId="",this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),this._scrollContentToTop()}get _allLabels(){let t=new Set;for(let e of this._objects)for(let i of e.tasks)for(let a of i.labels||[])t.add(a);return[...t].sort((e,i)=>e.localeCompare(i))}get _currentFilters(){return{status:this._filterStatus,user_id:this._filterUser,label:this._filterLabel,priority:this._filterPriority,archived:this._showArchived,sort_mode:this._sortMode,group_by:this._groupByMode}}_applyView(t){if(this._activeViewId=t,!t)return;let e=this._savedViews.find(a=>a.id===t);if(!e)return;let i=e.filters;this._filterStatus=i.status||"",this._filterUser=i.user_id||null,this._filterLabel=i.label||null,this._filterPriority=i.priority||"",this._showArchived=!!i.archived,Me.includes(i.sort_mode)&&(this._sortMode=i.sort_mode),Fi.includes(i.group_by)&&(this._groupByMode=i.group_by);try{G(D.taskSort,this._sortMode),G(D.groupBy,this._groupByMode)}catch{}this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard")}_openSavedViewsDialog(){this.shadowRoot.querySelector("maintenance-saved-views-dialog")?.open(this._currentFilters,this._savedViews)}_onSavedViewsChanged(t){this._savedViews=t.detail.views||[],this._activeViewId&&!this._savedViews.some(e=>e.id===this._activeViewId)&&(this._activeViewId="")}_scrollContentToTop(){requestAnimationFrame(()=>{let t=this.shadowRoot?.querySelector(".content");t&&t.scrollTo({top:0,behavior:"smooth"})})}_showObject(t,e=null){this._pushPanelState("object",t),this._view="object",this._selectedEntryId=t,this._selectedTaskId=null,this._objectSectionOverride=e,e?this._scrollToObjectSection(e):this._scrollContentToTop()}_scrollToObjectSection(t){this.updateComplete.then(()=>requestAnimationFrame(()=>{let e=this.shadowRoot?.querySelector(`.obj-section[data-section="${t}"]`);e?e.scrollIntoView({block:"start",behavior:"smooth"}):this._scrollContentToTop()}))}_toggleObjectSection(t){let e=new Set(this._objectSectionsCollapsed);this._objectSectionOverride===t||!e.has(t)?e.add(t):e.delete(t),this._objectSectionOverride===t&&(this._objectSectionOverride=null),this._objectSectionsCollapsed=e,G(D.objectSections,JSON.stringify([...e]))}_splitActive(){return this.split&&!this.narrow&&!this.tight&&this._view==="overview"&&this._overviewTab==="dashboard"&&!this._bulkMode}_detailOpen(){return(this._view==="task"||this._splitActive())&&!!this._selectedEntryId&&!!this._selectedTaskId}_showFullTaskPage(t,e){this._view!=="task"&&(this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._scrollContentToTop())}_showTask(t,e){if(this._splitActive()){this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._historySearch="",this._resetStickyPane(),this._fetchFullHistory(t,e);let a=this._getTask(t,e);a?.trigger_config?.entity_id&&this._fetchDetailStats(a.trigger_config.entity_id,this._isCounterEntity(a.trigger_config));return}this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._historySearch="",this._scrollContentToTop(),this._fetchFullHistory(t,e);let i=this._getTask(t,e);if(i?.trigger_config?.entity_id){let a=i.trigger_config.entity_id,n=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(a,n)}}_showToast(t){this._toastTimer&&clearTimeout(this._toastTimer),this._toastUndo=null,this._toastActionLabel="",this._toastMessage=t,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}_showActionToast(t,e,i){this._showUndoToast(t,i),this._toastActionLabel=e}_showUndoToast(t,e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastActionLabel="",this._toastMessage=t,this._toastUndo=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastUndo=null,this._toastTimer=null},7e3)}_runToastUndo(){let t=this._toastUndo;this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage="",this._toastUndo=null,this._toastTimer=null,t?.()}_openPalette(){this._paletteQuery="",this._paletteActive=0,this._paletteOpen=!0,this._searchRemote=null,this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".palette-input")?.focus()})}_closePalette(){this._paletteOpen=!1,this._paletteQuery="",this._searchRemote=null,this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=null)}_onPaletteInput(t){this._paletteQuery=t,this._paletteActive=0,this._searchTimer&&clearTimeout(this._searchTimer);let e=t.trim();if(e.length<ue){this._searchRemote=null;return}this._searchTimer=setTimeout(()=>{this._searchTimer=null;let i=++this._searchSeq;this.hass.connection.sendMessagePromise({type:"maintenance_supporter/search",query:e,limit:Ot.documents}).then(a=>{i!==this._searchSeq||!this._paletteOpen||(this._searchRemote={query:e,documents:a.documents||[],history:a.history||[]})}).catch(()=>{i!==this._searchSeq||!this._paletteOpen||(this._searchRemote={query:e,documents:[],history:[]})})},Cs)}get _paletteResults(){let t=this._lang,e=this._paletteQuery.trim();if(e.length<ue&&!Gt(e))return[];let i=Wt(e);if(!i.length)return[];let a=[],n=[],d=[],r=Gt(e);if(r){for(let v of this._objects){let f=v.object;if(f.ref_no!==r.object)continue;let b=yt(f),R=(x,M)=>x?[M,s("archived",t)].filter(Boolean).join(" \xB7 "):M;r.task==null&&a.push({kind:"object",entryId:v.entry_id,label:f.name||"",sub:R(f.archived,s("object",t)),score:1e3,icon:"mdi:package-variant-closed",ref:b});for(let x of v.tasks)r.task!=null&&x.ref_no!==r.task||n.push({kind:"task",entryId:v.entry_id,taskId:x.id,label:x.name||"",sub:R(x.archived||f.archived,f.name||""),score:r.task==null?900:1e3,icon:"mdi:clipboard-check-outline",ref:xt(f,x)})}if(a.length||n.length){let v=this._searchRemote&&this._searchRemote.query===e?this._searchRemote:null,f=[...a,...n.slice(0,Ot.tasks)];for(let b of v?.history.slice(0,1)??[])f.push({kind:"history",entryId:b.entry_id,taskId:b.task_id,label:b.task_name||"",sub:[b.object_name,b.timestamp?Q(b.timestamp,t):""].filter(Boolean).join(" \xB7 "),snippet:b.snippet||"",score:b.score,icon:"mdi:note-text-outline",ref:b.ref??null});return f}}for(let v of this._objects){let f=v.object;if(f.archived)continue;let b=f.name||"",R=Ct(i,[{text:b,weight:3},{text:f.manufacturer,weight:2},{text:f.model,weight:2},{text:f.serial_number,weight:2},{text:f.notes,weight:1}]);if(R>0){let x=[f.manufacturer,f.model].filter(Boolean).join(" ");a.push({kind:"object",entryId:v.entry_id,label:b,sub:x||s("object",t),score:R,icon:"mdi:package-variant-closed",ref:yt(f)})}for(let x of v.tasks){if(x.archived)continue;let M=(x.labels||[]).join(" "),k=Ct(i,[{text:x.name,weight:3},{text:b,weight:2},{text:M,weight:2},{text:x.notes,weight:1}]);if(k>0){let I=(x.labels||[]).length?`  #${(x.labels||[]).join(" #")}`:"";n.push({kind:"task",entryId:v.entry_id,taskId:x.id,label:x.name||"",sub:b+I,score:k,icon:"mdi:clipboard-check-outline",ref:xt(f,x)})}}for(let x of v.parts||[]){let M=Ct(i,[{text:x.name,weight:3},{text:x.mpn,weight:2},{text:x.vendor,weight:1},{text:x.storage_location,weight:1},{text:x.notes,weight:1}]);M>0&&d.push({kind:"part",entryId:v.entry_id,label:x.name||"",sub:[b,x.mpn].filter(Boolean).join(" \xB7 "),score:M,icon:"mdi:cog-outline"})}}let p=(v,f)=>f.score-v.score||v.label.localeCompare(f.label),u=[...a.sort(p).slice(0,Ot.objects),...n.sort(p).slice(0,Ot.tasks),...d.sort(p).slice(0,Ot.parts)],_=this._searchRemote&&this._searchRemote.query===e?this._searchRemote:null;if(_){let v=_.documents.slice(0,Ot.documents);for(let f of[...v.filter(b=>b.match!=="content"),...v.filter(b=>b.match==="content")])u.push({kind:f.match==="content"?"content":"document",entryId:f.entry_id,docId:f.id,docKind:f.kind,url:f.url,page:f.page??null,label:f.title||f.filename||f.url||"",sub:f.object_name||"",snippet:f.snippet||"",score:f.score,icon:f.kind==="weblink"?"mdi:link-variant":"mdi:file-document-outline"});for(let f of _.history.slice(0,Ot.history))u.push({kind:"history",entryId:f.entry_id,taskId:f.task_id,label:f.task_name||"",ref:f.ref??null,sub:[f.object_name,f.timestamp?Q(f.timestamp,t):""].filter(Boolean).join(" \xB7 "),snippet:f.snippet||"",score:f.score,icon:f.type==="skipped"?"mdi:skip-next-circle-outline":"mdi:note-text-outline"})}return u}_selectPaletteResult(t){let e=this._paletteQuery.trim();switch(this._closePalette(),t.kind){case"task":t.taskId&&this._showTask(t.entryId,t.taskId);return;case"history":if(!t.taskId)return;this._showTask(t.entryId,t.taskId),this._activeTab="history",this._historySearch=e;return;case"document":case"content":t.docKind==="weblink"?at(t.url)&&window.open(t.url,"_blank","noopener"):t.docId&&wt(this.hass,t.docId,t.page?`#page=${t.page}`:"").catch(()=>{}),this._showObject(t.entryId,"documents");return;case"part":this._showObject(t.entryId,"parts");return;default:this._showObject(t.entryId)}}_renderPalette(){if(!this._paletteOpen)return h;let t=this._lang,e=this._paletteResults,i=this._paletteQuery.trim(),a={object:s("objects",t),task:s("tasks",t),part:s("search_group_parts",t),document:s("documents",t),content:s("search_group_content",t),history:s("search_group_history",t)},n=i.length>=ue&&(!this._searchRemote||this._searchRemote.query!==i),d=null;return o`
      <div class="palette-backdrop" @click=${()=>this._closePalette()}>
        <div class="palette" role="dialog" aria-label=${s("search_open",t)} @click=${r=>r.stopPropagation()}>
          ...
          <div class="palette-results">
            ${i.length<ue&&!Gt(i)?o`<div class="palette-empty">${s("search_empty_hint",t)}</div>`:e.length===0?o`<div class="palette-empty">${n?s("search_searching",t):s("palette_no_results",t)}</div>`:e.map((r,p)=>{let u=r.kind!==d?o`<div class="palette-group">${a[r.kind]}</div>`:h;return d=r.kind,o`
                      ${u}
          ...
          <div class="today-row" @click=${()=>this._showTask(d.entry_id,d.task_id)}>
            ...
            <div class="today-main">
              ...
              <div class="today-object">
                <span class="today-object-text">${d.object_name} · ${Tt(d.days_until_due,a)}</span>
                ${_e(n(d),"today-person")}
              </div>
            </div>
    ...
    `}_setObjectViewMode(t){this._objectViewMode=t;try{G(D.objectView,t)}catch{}}_renderAllParts(){let t=this._lang,e=this._allParts,i=this._currencySymbol;return o`
      ...
      ${e===null?o`<div class="empty-state">…</div>`:e.length===0?o`<div class="empty-state">${s("parts_section",t)}: 0</div>`:o`
        ...
        `}
    `}_exportPartsCsv(){let t=this._allParts||[],e=d=>{let r=d==null?"":String(d);return/[",\n;]/.test(r)?`"${r.replace(/"/g,'""')}"`:r},a=[["name","object","stock","unit","reorder_threshold","unit_cost","storage_location","vendor","used_by"].join(",")];for(let d of t)a.push([e(d.name),e(d.object_name),e(d.stock),e(d.unit),e(d.reorder_threshold),e(d.cost),e(d.storage_location),e(d.vendor),e(d.consumers.map(r=>`${r.object_name??""}/${r.task_name??r.task_id}\xD7${r.quantity}`).join(" | "))].join(","));let n=Ft(new Date);me(a.join(`
`),`maintenance_parts_${n}.csv`,"text/csv;charset=utf-8")}async _exportObjectsCsv(){let t=await fe(this,{type:"maintenance_supporter/objects/csv"},{onError:i=>this._showToast(i)});if(!t)return;let e=Ft(new Date);me(t.csv,`maintenance_objects_${e}.csv`,"text/csv;charset=utf-8")}_renderObjectsTable(t){let e=this._lang,i=this._objectsTableColumns;return o`
      <div class="objects-table-wrap">
        <table class="objects-table">
          <thead>
            <tr>
              ${i.map(a=>{let n=Be.find(r=>r.key===a),d=n&&n.key!=="actions"?s(n.labelKey,e):"";return o`<th class="oc-${a}">${d}</th>`})}
            </tr>
          </thead>
          <tbody>
            ${t.map(a=>o`
    ...
    `}_renderOverviewRow(t){let e=this._lang,i=t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0,a=0,n=Yt.ok,d=!1;if(i&&t.days_until_due!==null){let v=Zt(t.interval_days,t.days_until_due,t.interval_unit);a=v.pct,d=v.overflow,t.status==="overdue"?n=Yt.overdue:t.status==="due_soon"&&(n=Yt.due_soon)}let r=t.area_id?this.hass?.areas?.[t.area_id]?.name:null,p=t.responsible_user_id?this._userService?.getUserName(t.responsible_user_id):null,u=t.group_names.length>0||r||p,_=this._bulkMode&&this._bulkSelected.has(this._bulkKey(t));return o`
    ...
    `}_actionStyle(){return this._rowActionStyle}async _dismissRowActionNotice(t){let e={row_action_notice_pending:!1};t&&(e.row_action_style="icons"),await fe(this,{type:"maintenance_supporter/global/update",settings:e},{onError:a=>this._showToast(a)})!==void 0&&(this._rowActionNotice=!1,t&&(this._rowActionStyle="icons"),gi())}_renderRowActions(t,e,i,a=!0){let n=this._actionStyle();return n==="buttons"||n==="buttons_compact"?n==="buttons_compact"&&(this.narrow||this.tight)?o`
      ...
      <div class="detail-section">
        ...
        ${t.tasks.length===0?o`<div class="empty-state-centered">
              ...
              <div class="task-row${r.enabled?"":" task-disabled"}">
                ...
                <span class="task-sub${r.responsible_user_id?"":" task-sub-empty"}">${Oe(r,p=>this._userService?.getUserName(p)??null,p=>this._userService?.getPerson(p)??null)}</span>
