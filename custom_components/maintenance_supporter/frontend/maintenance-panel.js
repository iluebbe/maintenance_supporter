...
import{a as Le,b as He,c as Ne}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-VNYLIDZN.js";import{E as ai,H as ni,a as st,b as te,c as ee,d as Be,e as qe,f as ie,g as Ve,h as We,i as R,j as qt,k as _t,l as Rt,m as zt,n as ye,o as se,p as ae,q as Ke,r as Qe,s as Xe,t as Ze,u as Je,v as ti,w as ei,x as ii}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-NIC47UZN.js";import{a as ze,b as Zt,c as yt,d as Jt,e as Bt,g as si}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-YUCXSTBQ.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-O2EDE3TV.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-M7AOXMNC.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-FEOAV35W.js";import{a as Tt}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-B4VI735T.js";import{b as Fe,e as Pt,h as Ue}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-KYGGYWB7.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-3ZJQHHD2.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-F7OVJ3MD.js";import{a as ve}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-TVK2JN4G.js";import{c as Ge,d as be,e as Ye}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-MFFLSNBV.js";import{a as D}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-R44Z6OZW.js";import{A as Q,B as At,C as $t,G as Ie,H as Ae,J as Et,K as Ft,L as Pe,N as Xt,a as g,b as L,c as r,d as X,f as h,h as H,i as fe,j as Ce,k as Oe,l as j,m,n as Yt,o as Kt,p as Qt,q as a,r as It,s as V,t as De,u as nt,v as Nt,x as U,y as Y}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-UJZBNTL4.js";var qi={\u00DF:"s","\u1E9E":"s",\u00E6:"a",\u0153:"o",\u00F8:"o",\u0111:"d",\u00F0:"d",\u00FE:"t",\u0142:"l",\u0131:"i"},li=10,Ui=7,xe=4,ri=2,Vi=5,ci=3,Wi=/[a-z0-9]+/g;function ne(n){let o="";for(let t of n.toLowerCase()){if(t.charCodeAt(0)<128&&t.length===1){o+=t;continue}let e=qi[t];if(e){o+=e;continue}let i=t.normalize("NFKD")[0]||t;o+=i.charCodeAt(0)<128?i:t}return o}function di(n){return ne(n).match(Wi)||[]}function Gi(n){return ne(n).replace(/[^a-z0-9]+/g,"")}function Yi(n){return n.replace(/ue/g,"u").replace(/oe/g,"o").replace(/ae/g,"a").replace(/ss/g,"s")}function Ut(n){let o=[];for(let t of di(n)){let e=[t],i=Yi(t);i&&i!==t&&e.push(i),o.push(e)}return o}function oi(n,o){if(n===o)return!0;let t=n.length,e=o.length;if(Math.abs(t-e)>1)return!1;if(t===e){let d=[];for(let u=0;u<t;u++)n[u]!==o[u]&&d.push(u);if(d.length===1)return!0;if(d.length===2&&d[1]===d[0]+1){let u=d[0];return n[u]===o[u+1]&&n[u+1]===o[u]}return!1}let[i,s]=t>e?[n,o]:[o,n],c=0,p=0,l=!1;for(;c<i.length&&p<s.length;)if(i[c]===s[p])c++,p++;else{if(l)return!1;l=!0,c++}return!0}function Ki(n,o){let t=0;for(let e of n)if(e){if(o===e)return li;if(o.startsWith(e)){t=Math.max(t,Ui);continue}if(e.length>=ci&&o.includes(e)){t=Math.max(t,xe);continue}e.length>=Vi&&t<ri&&(oi(e,o)||o.length>e.length&&oi(e,o.slice(0,e.length)))&&(t=ri)}return t}function Qi(n,o){let t=0;for(let e of di(o))if(t=Math.max(t,Ki(n,e)),t===li)return t;if(t<xe){let e=Gi(o);for(let i of n)if(i.length>=ci&&e.includes(i))return xe}return t}function pi(n,o){if(!n)return!1;let t=Ut(o);if(!t.length){let e=ne(o.trim());return e.length>0&&ne(n).includes(e)}return Mt(t,[{text:n,weight:1}])>0}function Mt(n,o){if(!n.length)return 0;let t=o.filter(i=>i.text),e=0;for(let i of n){let s=0;for(let c of t){let p=Qi(i,c.text)*c.weight;p>s&&(s=p)}if(s===0)return 0;e+=s}return e}var hi=n=>typeof n=="number"&&Number.isInteger(n)&&n>0;function xt(n){return n&&hi(n.ref_no)?String(n.ref_no):null}function St(n,o){let t=xt(n);return t&&o&&hi(o.ref_no)?`${t}.${o.ref_no}`:null}function re(n){let o=/^(\d+)(?:\.(\d+)(?:-(\d+))?)?$/.exec(n.trim());return o?{object:Number(o[1]),task:o[2]?Number(o[2]):null,entry:o[3]?Number(o[3]):null}:null}function Lt(n,o){return n?r`<span class="ref-chip" title=${o??""}>#${n}</span>`:h}var Xi=["assignee_pool","required_completion_fields","checklist","labels","history","readings"],Zi=["checklist_progress"],Ji=["tasks","parts"],ts=["manual_docs","battery_fleet_excluded"];function we(n,o,t=[]){for(let e of o)n[e]===void 0&&(n[e]=[]);for(let e of t)n[e]===void 0&&(n[e]={})}function es(n){let o=n;we(o,Ji),o.object&&typeof o.object=="object"&&we(o.object,ts);for(let t of o.tasks)we(t,Xi,Zi);return n}function Vt(n){for(let o of n)es(o);return n}function is(n,o){if(o.objects)return o.objects;let t=o.delta||[],e=o.removed||[];if(!t.length&&!e.length)return null;let i=new Map(n.map(s=>[s.entry_id,s]));for(let s of t)i.set(s.entry_id,s);for(let s of e)i.delete(s);return[...i.values()]}function ui(n,o){return o.objects&&Vt(o.objects),o.delta&&Vt(o.delta),is(n,o)}var P={printOptions:"msp-print-options",batteryRosterOpen:"msp-bf-roster-open",overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view",objectsCache:"msp-objects-cache",gettingStartedDismissed:"msp-gs-dismissed",batteryRosterSort:"ms_bf_roster_sort"};function at(n){try{return localStorage.getItem(n)}catch{return null}}function Z(n,o){try{localStorage.setItem(n,o)}catch{}}var ss=168*3600*1e3;function gi(){try{let n=at(P.objectsCache);if(!n)return null;let o=JSON.parse(n);return o.v!==fe||!Number.isFinite(o.at)||Date.now()-o.at>ss||!Array.isArray(o.objects)||o.objects.length===0?null:{objects:o.objects,stats:o.stats??null}}catch{return null}}function ke(n,o){if(!(!Array.isArray(n)||n.length===0))try{let t={v:fe,at:Date.now(),objects:n,stats:o};Z(P.objectsCache,JSON.stringify(t))}catch{}}function N(n){return String(n??"").replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o])}function mi(n,o,t,e,i,s){let c=[[t.manufacturer,n.manufacturer],[t.model,n.model],[t.serial,n.serial_number],[t.installed,n.installation_date?e(n.installation_date):null],[t.warranty,n.warranty_expiry?e(n.warranty_expiry):null]].filter(([,d])=>!!d),p=o.map(d=>{let u=t.scheduleLabel(d);return`<tr>
      <td>${N(d.name)}</td>
...
${N(n.notes)}</div>`:""}
</body></html>`}function $e(n,o=new Date){if(!n)return{kind:"none",days:null,date:null};let t=new Date(`${n}T00:00:00`);if(isNaN(t.getTime()))return{kind:"none",days:null,date:null};let e=Date.UTC(o.getFullYear(),o.getMonth(),o.getDate()),i=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),s=Math.round((i-e)/864e5);return s<0?{kind:"expired",days:s,date:n}:s<=60?{kind:"expiring",days:s,date:n}:{kind:"valid",days:s,date:n}}var q=n=>String(n??"").replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o]);function _i(n,o,t,e,i,s,c,p,l,d=[],u=null){let _=[[t.object,q(o)],[t.type,q(t.typeLabel(n.type))],[t.interval,q(i(n))],[t.nextDue,n.next_due?q(e(n.next_due)):"\u2014"],[t.lastDone,n.last_performed?q(e(n.last_performed)):q(t.never)]];n.priority&&n.priority!=="normal"&&_.push([t.priority,q(n.priority)]);let f=(n.checklist||[]).map(b=>`<li><span class="box"></span>${q(b)}</li>`).join(""),v=(b,T)=>b?`<figure class="qr"><img src="${b}" alt="" /><figcaption>${q(T)}</figcaption></figure>`:"";return`<!DOCTYPE html>
...
`;var oe=class{constructor(o){this._cache=new Map;this._pending=new Map;this.historyFallbackIds=new Set;this._hass=o}updateHass(o){this._hass=o}async getDetailStats(o,t,e=30){return this._getStats(o,e<=35?"hour":"day",e,t)}async getMiniStats(o,t){return this._getStats(o,"day",14,t)}async getBatchMiniStats(o){let t=new Map,e=[];for(let l of o){let d=`${l.entityId}:day:14`,u=this._cache.get(d);u&&Date.now()-u.fetchedAt<3e5?t.set(l.entityId,u.points):e.push(l)}if(e.length===0)return t;let i=e.filter(l=>l.isCounter).map(l=>l.entityId),s=e.filter(l=>!l.isCounter).map(l=>l.entityId),c=new Date(Date.now()-336*60*60*1e3).toISOString(),p=[];return i.length>0&&p.push(this._fetchBatch(i,"day",c,["state","sum","change"],!0,t)),s.length>0&&p.push(this._fetchBatch(s,"day",c,["mean","min","max"],!1,t)),await Promise.all(p),t}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(o,t,e,i){let s=`${o}:${t}:${e}`,c=this._cache.get(s);if(c&&Date.now()-c.fetchedAt<3e5)return c.points;if(this._pending.has(s))return this._pending.get(s);let p=this._fetchAndNormalize(o,t,e,i,s);this._pending.set(s,p);try{return await p}finally{this._pending.delete(s)}}async _fetchAndNormalize(o,t,e,i,s){let c=new Date(Date.now()-e*24*60*60*1e3).toISOString(),p=i?["state","sum","change"]:["mean","min","max"];try{let d=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:c,statistic_ids:[o],period:t,types:p}))[o]||[],u=this._normalizeRows(d,i);if(u.length<2){let _=await this._fetchHistoryFallback(o,c);_.length>=2?(u=_,this.historyFallbackIds.add(o)):this.historyFallbackIds.delete(o)}else this.historyFallbackIds.delete(o);return this._cache.set(s,{entityId:o,fetchedAt:Date.now(),period:t,points:u}),u}catch(l){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${o}:`,l),[]}}async _fetchHistoryFallback(o,t){try{let i=(await this._hass.connection.sendMessagePromise({type:"history/history_during_period",start_time:t,end_time:new Date().toISOString(),entity_ids:[o],minimal_response:!0,no_attributes:!0}))?.[o]||[];if(i.length>1e3){let p=Math.ceil(i.length/500);i=i.filter((l,d)=>d%p===0||d===i.length-1)}let s=[],c=null;for(let p of i){let l=p.s??p.state;if(l==null||l==="unknown"||l==="unavailable")continue;let d;if(l==="on"||l==="open"||l==="true")d=1;else if(l==="off"||l==="closed"||l==="false")d=0;else if(d=parseFloat(l),!Number.isFinite(d))continue;let u=p.lu??p.last_updated??p.last_changed,_=typeof u=="number"?u*1e3:u!=null?Date.parse(u):NaN;Number.isFinite(_)&&(c!=null&&c!==d&&s.push({ts:_,val:c}),s.push({ts:_,val:d}),c=d)}return s.sort((p,l)=>p.ts-l.ts),s.length&&c!=null&&s.push({ts:Date.now(),val:c}),s}catch(e){return console.warn(`[maintenance-supporter] History fallback failed for ${o}:`,e),[]}}async _fetchBatch(o,t,e,i,s,c){try{let p=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:e,statistic_ids:o,period:t,types:i});for(let l of o){let d=p[l]||[],u=this._normalizeRows(d,s);c.set(l,u),this._cache.set(`${l}:${t}:14`,{entityId:l,fetchedAt:Date.now(),period:t,points:u})}}catch(p){console.warn("[maintenance-supporter] Batch statistics fetch failed:",p)}}_normalizeRows(o,t){let e=[];for(let i of o){let s=null;if(t?s=i.state??null:s=i.mean??null,s===null)continue;let c={ts:i.start,val:s};t||(i.min!=null&&(c.min=i.min),i.max!=null&&(c.max=i.max)),e.push(c)}return e.sort((i,s)=>i.ts-s.ts),e}};function ft(n,o){let t=n??0;return t<1024?`${t} B`:t<1024*1024?`${U(t/1024,o,1)} KB`:`${U(t/(1024*1024),o,1)} MB`}var Ct=["manual","warranty","invoice","spare_parts","photo","other"],le={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"};function jt(n){return n.title||n.filename||n.url||""}var ce=8;function de(n,o){let t=Ut(o);if(!t.length)return n;let e=[];for(let i of n){let s=Mt(t,[{text:i.title,weight:3},{text:i.filename,weight:2},{text:(i.tags||[]).join(" "),weight:2},{text:i.url,weight:1}]);s>0&&e.push({doc:i,score:s})}return e.sort((i,s)=>s.score-i.score).map(i=>i.doc)}var K=class extends H{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._filter="";this._loaded=!1;this._busy=!1;this._error="";this._hint="";this._addingLink=!1;this._linkUrl="";this._linkTitle="";this._category="manual";this._thumbs={};this._lightboxUrl="";this._editingId="";this._editTitle="";this._editCategory="manual";this._dragOver=!1;this._loadedFor=null;this._localeReady=!1}_isImage(t){return t.kind==="file"&&(t.mime||"").startsWith("image/")}async _sign(t){return Zt(this.hass,t.id)}get _lang(){return V(this.hass)}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,nt(this._lang).then(()=>this.requestUpdate())),this.hass&&this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error="",this._thumbs={},this._loadThumbs()}catch(t){this._error=D(t,this._lang),this._loaded=!0}}async _loadThumbs(){await Promise.all(this._docs.filter(t=>this._isImage(t)).map(async t=>{try{let e=await this._sign(t);this._thumbs={...this._thumbs,[t.id]:e}}catch{}}))}_category_of(t){return(t.tags||[]).find(i=>Ct.includes(i))||"other"}_labelKeydown(t){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),t.currentTarget.querySelector("input")?.click())}_onFileInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i),e.value=""}_onCameraInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i,"photo"),e.value=""}_onDrop(t){if(t.preventDefault(),this._dragOver=!1,!this.canWrite||this._busy)return;let e=Array.from(t.dataTransfer?.files??[]);e.length&&this._uploadFiles(e)}_onDragOver(t){this.canWrite&&(t.preventDefault(),this._dragOver=!0)}_onDragLeave(t){let e=t.relatedTarget;(!e||!t.currentTarget.contains(e))&&(this._dragOver=!1)}async _uploadFiles(t,e){let i=e??this._category;this._busy=!0,this._error="",this._hint="";let s=0,c=0;try{for(let p of t){let l=new FormData;l.append("entry_id",this.entryId),l.append("tags",i),l.append("file",p,p.name);let d=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:l});if(!d.ok){this._error=d.status===413?a("doc_too_large",this._lang):a("doc_upload_failed",this._lang);continue}let u=await d.json();u.duplicate_in_object?c++:u.deduped&&s++}c?this._hint=a("doc_dup_in_object",this._lang):s&&(this._hint=a("doc_deduped",this._lang)),await this._load()}catch{this._error=a("doc_upload_failed",this._lang)}finally{this._busy=!1}}async _download(t){try{await Jt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=D(e,this._lang)}}async _preview(t){if(this._isImage(t)){this._lightboxUrl=this._thumbs[t.id]||await this._sign(t);return}try{await yt(this.hass,t.id)}catch(e){this._error=D(e,this._lang)}}_openDoc(t){t.kind==="file"?this._preview(t):st(t.url)&&window.open(t.url,"_blank","noopener")}_startEdit(t){this._editingId=t.id,this._editTitle=t.title||"",this._editCategory=this._category_of(t),this._addingLink=!1,this._error=""}_cancelEdit(){this._editingId=""}async _saveEdit(t){let e=(t.tags||[]).filter(s=>!Ct.includes(s)),i=t.kind==="file"?[this._editCategory,...e]:t.tags??[];this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,title:this._editTitle.trim()||t.filename||t.url||"",tags:i}),this._editingId="",await this._load()}catch(s){this._error=D(s,this._lang)}finally{this._busy=!1}}async _delete(t){let e=jt(t);if(window.confirm(a("doc_delete_confirm",this._lang).replace("{name}",e))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:t.id}),await this._load()}catch(i){this._error=D(i,this._lang)}finally{this._busy=!1}}}async _addLink(){let t=this._linkUrl.trim();if(t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/add_link",entry_id:this.entryId,url:t,title:this._linkTitle.trim()||null}),this._linkUrl="",this._linkTitle="",this._addingLink=!1,await this._load()}catch(e){this._error=D(e,this._lang,a("doc_link_invalid",this._lang))}finally{this._busy=!1}}}render(){let t=this._lang;return r`
      ...
      <div class="doc-header">
        ...
        ${this.canWrite?r`
              <div class="doc-actions">
                ...
                >
                  ${Ct.map(e=>r`<option value=${e}>${a(`doc_cat_${e}`,t)}</option>`)}
                </select>
                <label
      ...
      ${this._loaded&&this._docs.length>=ce?r`<div class="doc-filter">
      ...
      ${this._loaded?this._docs.length===0?r`<div class="doc-empty">${a("documents_empty",t)}</div>`:(()=>{let e=de(this._docs,this._filter);return e.length===0?r`<div class="doc-empty">${a("doc_search_none",t)}</div>`:r`<div class="doc-list">${e.map(i=>this._renderDoc(i,t))}</div>`})():r`<div class="doc-empty">${a("loading",t)}</div>`}
    ...
    `}_renderEdit(t,e){let i=t.kind==="file";return r`
      <div class="doc-row editing">
        ...
        ${i?r`<select
            ...
            >
              ${Ct.map(s=>r`<option value=${s} ?selected=${s===this._editCategory}>${a(`doc_cat_${s}`,e)}</option>`)}
            </select>`:h}
  ...
  `,g([j({attribute:!1})],K.prototype,"hass",2),g([j({attribute:!1})],K.prototype,"entryId",2),g([j({type:Boolean})],K.prototype,"canWrite",2),g([m()],K.prototype,"_docs",2),g([m()],K.prototype,"_filter",2),g([m()],K.prototype,"_loaded",2),g([m()],K.prototype,"_busy",2),g([m()],K.prototype,"_error",2),g([m()],K.prototype,"_hint",2),g([m()],K.prototype,"_addingLink",2),g([m()],K.prototype,"_linkUrl",2),g([m()],K.prototype,"_linkTitle",2),g([m()],K.prototype,"_category",2),g([m()],K.prototype,"_thumbs",2),g([m()],K.prototype,"_lightboxUrl",2),g([m()],K.prototype,"_editingId",2),g([m()],K.prototype,"_editTitle",2),g([m()],K.prototype,"_editCategory",2),g([m()],K.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",K);var ot=class extends H{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._filter="";this._loadedKey="";this._localeReady=!1}get _lang(){return V(this.hass)}get _refId(){return this.partId||this.taskId||""}get _linkField(){return this.partId?"part_ids":"task_ids"}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,nt(this._lang).then(()=>this.requestUpdate()));let e=`${this.entryId}|${this._refId}`;this.hass&&this.entryId&&this._refId&&this._loadedKey!==e&&(this._loadedKey=e,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error=""}catch(t){this._error=D(t,this._lang),this._loaded=!0}}_links(t){return t[this._linkField]||[]}_linked(){return this._docs.filter(t=>this._links(t).includes(this._refId))}_available(){return this._docs.filter(t=>!this._links(t).includes(this._refId))}async _setLinks(t,e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,[this._linkField]:e}),await this._load()}catch(i){this._error=D(i,this._lang)}finally{this._busy=!1}}_link(){let t=this._docs.find(e=>e.id===this._attachId);t&&(this._attachId="",this._setLinks(t,[...this._links(t),this._refId]))}_unlink(t){this._setLinks(t,this._links(t).filter(e=>e!==this._refId))}_isPdf(t){return t.mime==="application/pdf"||(t.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(t){return this._isPdf(t)&&this.taskId?t.task_pages?.[this.taskId]:void 0}async _open(t){if(t.kind==="weblink"){st(t.url)&&window.open(t.url,"_blank","noopener");return}let e=this._pageFor(t);try{await yt(this.hass,t.id,e?`#page=${e}`:"")}catch(i){this._error=D(i,this._lang)}}async _setPage(t,e){if(this.taskId){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,task_pages:{[this.taskId]:e}}),await this._load()}catch(i){this._error=D(i,this._lang)}finally{this._busy=!1}}}async _download(t){try{await Jt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=D(e,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return h;let t=this._lang,e=this._linked(),i=this._available();return r`
      <div class="task-docs">
        ...
        ${e.length>=ce?r`<div class="doc-filter">
              <ha-icon icon="mdi:magnify"></ha-icon>
              <input type="search" aria-label=${a("doc_search",t)} placeholder=${a("doc_search",t)}
                .value=${this._filter} @input=${s=>this._filter=s.target.value} />
            </div>`:h}
        ${e.length===0?r`<div class="tdoc-empty">${a(this.partId?"doc_part_none":"doc_task_none",t)}</div>`:(()=>{let s=de(e,this._filter);return s.length===0?r`<div class="tdoc-empty">${a("doc_search_none",t)}</div>`:r`<div class="tdoc-list">${s.map(c=>this._renderRow(c,t))}</div>`})()}
    ...
    `}_renderRow(t,e){let i=t.kind==="file",s=this._isPdf(t),c=this._pageFor(t),p=(t.tags||[]).find(d=>Ct.includes(d))||"other",l=i?ft(t.size,e):a("doc_link_badge",e);return r`
      <div class="tdoc-row">
        <ha-icon class="tdoc-icon" icon=${i?le[p]:"mdi:link-variant"}></ha-icon>
        <div
          class="tdoc-info"
          role="button"
          tabindex="0"
...
${p.capped?`<p class="cap-note">${C(t.capNote)}</p>`:""}
      ...
      </div>`}render(){let t=this._lang,e=this._entries;if(!e.length&&!this._loading)return h;let i=bi(e,{taskId:this._filterTask||null,from:this._from||null,to:this._to||null}),{completed:s,totalCost:c}=pe(i),p=this._expanded?i:i.slice(0,15);return r`
      <div class="section">
        <h3>
        ...
        ${i.length===0?r`<p class="empty">${a("object_history_empty",t)}</p>`:r`
              <div class="rows">
                ${p.map(l=>r`
                  <div class="row">
                    <span class="date" title=${At(l.timestamp,t)}>${Q(l.timestamp,t)}</span>
              ...
              <div class="bf-rows bf-soon-rows">
                ${e.soon.map(s=>r`
                    <div class="bf-row">
                      ...
                      ${this._levelBar(s)}
                      ${s.level!=null?r`<span class="bf-level">${s.level}%</span>`:h}
                      ${s.no_sensor||s.can_mark_replaced?r`<button class="bf-mark bf-replaced" title=${a("battery_fleet_mark_one",t)} .disabled=${this._marking} @click=${()=>this._mark([s.entity_id])}>
                            <ha-icon icon="mdi:battery-sync"></ha-icon>
                          </button>`:h}
                      ${s.days_until!=null?r`<span class="bf-predicted ${s.predicted_source==="trend"?"bf-trend":""} ${s.forecast_overdue?"bf-overdue":""}"
                            title=${this._predictedTitle(s,t)}
                            >${s.forecast_overdue?r`<ha-icon icon="mdi:calendar-alert"></ha-icon>`:h}~${this._predictedDate(s.days_until)}</span>`:h}
                    </div>
                  `)}
              </div>
            `:h}
  ...
  `,g([j({attribute:!1})],lt.prototype,"hass",2),g([j({type:Boolean})],lt.prototype,"flat",2),g([m()],lt.prototype,"_ov",2),g([m()],lt.prototype,"_loading",2),g([m()],lt.prototype,"_marking",2),g([m()],lt.prototype,"_error",2),g([m()],lt.prototype,"_history",2),g([m()],lt.prototype,"_rosterSort",2),g([m()],lt.prototype,"_typeFilter",2),g([m()],lt.prototype,"_recorded",2);var Te=lt;customElements.get("maintenance-battery-fleet-section")||customElements.define("maintenance-battery-fleet-section",Te);var xi=L`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;function wi(n){let o=window;o.customCards=o.customCards||[],o.customCards.some(t=>t.type===n.type)||o.customCards.push(n)}var dt=class extends H{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(t){if(this._config={...t},t.past_days&&[30,90].includes(t.past_days)?this._pastDays=t.past_days:t.window_days&&[7,14,30,365].includes(t.window_days)&&(this._windowDays=t.window_days,this._pastDays=0),typeof t.user_filter=="string"&&(this._userFilter=t.user_filter),typeof t.object_filter=="string")this._objectFilter=t.object_filter,this._configuredObjects=[];else if(Array.isArray(t.object_filter)){let e=t.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=e.length===1?e[0]:"",this._configuredObjects=e.length>1?e:[]}}getCardSize(){return 6}get _lang(){return V(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(t){if(super.updated(t),It(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=e,Nt(this._stats.budget)}catch{}}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){t();return}this._unsub=t}catch{}}_onEventClick(t){if(t.history_timestamp){this._openHistoryEntry(t);return}ni(t.entry_id,t.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:t.entry_id,task_id:t.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(t){try{let i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:t.entry_id})).tasks?.find(p=>p.id===t.task_id),s=i?.history?.find(p=>p.timestamp===t.history_timestamp);if(!s||ai({entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp,type:s.type||"completed",timestamp:s.timestamp||t.history_timestamp,notes:s.notes??null,cost:s.cost??null,duration:s.duration??null,completed_by:s.completed_by??null,used_parts:s.used_parts??null,photo_doc_ids:Tt(s),reading_value:s.reading_value??null,reading_values:Pt(s),readings:i?.readings??[],task_type:i?.type??null,reading_unit:i?.reading_unit??null}))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h;let t=this._lang,e=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,s=this._config.title,c=null;this._userFilter&&(c=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let p=y=>{let it=y.toLowerCase();return this._objects.find(x=>x.entry_id===y||x.object.name.toLowerCase()===it)?.entry_id??null},l=new Set(this._configuredObjects.map(p).filter(y=>y!==null)),d=l.size?this._objects.filter(y=>l.has(y.entry_id)):this._objects,u=this._config.show_object_filter!==!1&&d.length>1,_=this._objectFilter?p(this._objectFilter):null,f=_&&d.some(y=>y.entry_id===_)?d.filter(y=>y.entry_id===_):d,v=new Date;v.setHours(0,0,0,0);let b=this._pastDays>0,T=b?Xe(f,v,this._pastDays,c):Qe(f,v,this._windowDays,c),E=Ke(v),O=this._windowDays===365||b,k=O?T.filter(y=>y.events.length>0):T,A=y=>{let it=`cal-status-${y.status}`,ut=y.projected?"cal-event-projected":"",x=y.status==="overdue"&&y.days_until_due!=null?` (${$t(y.days_until_due,t)})`:"",F=y.projected&&y.interval_days?r`<span class="cal-event-recur">${y.interval_unit&&y.interval_unit!=="days"?`${y.interval_days} ${a("unit_"+y.interval_unit,t)}`:a("cal_every_n_days",t).replace("{n}",String(y.interval_days))}</span>`:h,B=y.schedule_type==="sensor_based",I=B?r`<ha-icon class="cal-event-icon cal-source-sensor"
          ...
          </span>`:h,J=this._stats?.budget?.currency_symbol||Qt,W=y.history_type?a(y.history_type,t):a(y.status,t);return r`
        <div class="cal-event ${ut}"
          ...
          ${y.avg_cost!=null&&y.avg_cost>0?r`<span class="cal-event-cost">${Y(y.avg_cost,J,t)}</span>`:h}
        </div>
      `},M=y=>{let[it,ut,x]=y.date.split("-").map(Number),F=new Date(it,ut-1,x),B=y.date===E,I=Ie(F,t,"short"),G=Ae(F,t,"long");return r`
    ...
    `],g([j({attribute:!1})],dt.prototype,"hass",2),g([m()],dt.prototype,"_config",2),g([m()],dt.prototype,"_objects",2),g([m()],dt.prototype,"_stats",2),g([m()],dt.prototype,"_windowDays",2),g([m()],dt.prototype,"_pastDays",2),g([m()],dt.prototype,"_userFilter",2),g([m()],dt.prototype,"_objectFilter",2),g([m()],dt.prototype,"_unsub",2);var ds=[{value:7,key:"cal_editor_window_week"},{value:14,key:"cal_editor_window_fortnight"},{value:30,key:"cal_editor_window_month"},{value:365,key:"cal_editor_window_year"}],Ht=class extends H{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}get _lang(){return V(this.hass)}setConfig(t){this._config={...t}}updated(){let t=this._lang;t&&!De(t)&&nt(t).then(()=>this.requestUpdate())}_valueChanged(t,e){let i={...this._config,[t]:e};t==="show_window_chips"&&e===!0&&delete i.show_window_chips,t==="show_user_filter"&&e===!0&&delete i.show_user_filter,t==="show_object_filter"&&e===!0&&delete i.show_object_filter,t==="title"&&(!e||typeof e=="string"&&e.trim()==="")&&delete i.title,t==="user_filter"&&e===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let t=this._lang,e=this._config.window_days??30,i=this._config.show_window_chips!==!1,s=this._config.show_user_filter!==!1,c=this._config.user_filter??"",p=this._config.title??"";return r`
      <div class="editor">
        ...
        <div class="row">
          ...
          >
            ${ds.map(l=>r`<option value="${l.value}" ?selected=${l.value===e}>${a(l.key,t)}</option>`)}
          </select>
        </div>
  ...
  `,g([j({attribute:!1})],vt.prototype,"hass",2),g([m()],vt.prototype,"_open",2),g([m()],vt.prototype,"_busy",2),g([m()],vt.prototype,"_error",2),g([m()],vt.prototype,"_name",2),g([m()],vt.prototype,"_views",2);customElements.get("maintenance-saved-views-dialog")||customElements.define("maintenance-saved-views-dialog",vt);var hs=60,us=20,ki=30,gs={approaching:"\u2197",stable:"\u2192",easing:"\u2198"};function Se(n,o){let t=n.trigger_config;if(!t?.entity_id)return null;let e,i=t.type||"threshold";if(i==="threshold")if(t.trigger_above!=null)e=1;else if(t.trigger_below!=null)e=-1;else return null;else if(i==="counter"||i==="runtime"||i==="state_change")e=1;else return null;let s=o.get(t.entity_id)||[],c=i==="runtime"||i==="state_change",p=s.length>=2?s.map(b=>({ts:b.ts,val:b.val})):c?[]:(n.history||[]).filter(b=>b.trigger_value!=null).map(b=>({ts:new Date(b.timestamp).getTime(),val:b.trigger_value}));if(n.trigger_current_value!=null&&(p=[...p,{ts:Date.now(),val:n.trigger_current_value}]),p.length<2)return null;p.sort((b,T)=>b.ts-T.ts);let l=p.map(b=>b.val),d=Math.max(...l)-Math.min(...l),u=l[l.length-1]-l[0],_=t.trigger_delta_mode&&n.trigger_baseline_value!=null&&t.trigger_target_value!=null?n.trigger_baseline_value+t.trigger_target_value:t.trigger_target_value,f=i==="threshold"?t.trigger_above??t.trigger_below:i==="counter"?_:i==="runtime"?t.trigger_runtime_hours:t.trigger_target_changes,v=typeof f=="number"?Math.max(Math.abs(f-l[0]),d):d;return v===0||Math.abs(u)<v*(typeof f=="number"?.05:.15)?"stable":Math.sign(u)===e?"approaching":"easing"}function je(n,o){let t=n.trigger_config??null;if(!t)return h;let e=t.type||"threshold",i=n.trigger_entity_info?.unit_of_measurement??"",s=0,c="";if(e==="threshold"){let d=n.trigger_current_value??null;if(d==null)return h;let u=t.trigger_above,_=t.trigger_below;if(u!=null&&_!=null){let f=(u+_)/2,v=Math.abs(u-_)/2||1;s=Math.min(100,Math.max(0,Math.abs(d-f)/v*100));let b=Math.abs(d-u)<=Math.abs(d-_)?u:_;c=`${U(d,o?.lang,1)} / ${U(b,o?.lang)} ${i}`}else if(u!=null){let f=n.trigger_entity_info?.min,v=u>0?0:f!=null&&f<u?f:u<0?2*u:-100,b=u-v||1;s=Math.min(100,Math.max(0,(d-v)/b*100)),c=`${U(d,o?.lang,1)} / ${U(u,o?.lang)} ${i}`}else if(_!=null){let f=n.trigger_entity_info?.max,v=f!=null&&f>_?f:_>0?_*2:_<0?0:100,b=v-_||1;s=Math.min(100,Math.max(0,(v-d)/b*100)),c=`${U(d,o?.lang,1)} / ${U(_,o?.lang)} ${i}`}else if(t.trigger_equals!=null||t.trigger_not_equals!=null){let f=t.trigger_equals!=null?`= ${t.trigger_equals}`:`\u2260 ${t.trigger_not_equals}`;c=`${U(d,o?.lang,1)} (${f}${i?` ${i}`:""})`,s=n.trigger_active?100:0}else return h}else if(e==="counter"){let d=t.trigger_target_value||1,u;if(t.trigger_delta_mode?(u=n.trigger_current_delta??null,u==null&&n.trigger_baseline_value!=null&&n.trigger_current_value!=null&&(u=n.trigger_current_value-n.trigger_baseline_value)):u=n.trigger_current_value??null,u==null)return h;s=Math.min(100,Math.max(0,u/d*100)),c=`${U(u,o?.lang,1)} / ${U(d,o?.lang)} ${i}`}else if(e==="state_change"){let d=t.trigger_target_changes||1,u=n.trigger_current_value??null;if(u==null)return h;s=Math.min(100,Math.max(0,u/d*100)),c=`${U(u,o?.lang,0)} / ${U(d,o?.lang,0)}`}else if(e==="runtime"){let d=t.trigger_runtime_hours||100,u=n.trigger_current_value??null;if(u==null)return h;s=Math.min(100,Math.max(0,u/d*100)),c=`${U(u,o?.lang,1)}h / ${U(d,o?.lang)}h`}else if(e==="compound"){let d=t.compound_logic||t.operator||"AND",u=t.conditions?.length||0;c=`${d} (${u})`,s=n.trigger_active?100:0}else return h;let p=s>=100,l=s>90?"var(--error-color, #f44336)":s>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return r`
    <div class="trigger-progress">
      ...
      <span class="trigger-progress-label">${c}${o?.trend?r` <i class="trend-arrow trend-${o.trend}" title="${a(`trend_${o.trend}`,o.lang??"en")}" aria-label="${a(`trend_${o.trend}`,o.lang??"en")}">${gs[o.trend]}</i>`:h}</span>
    </div>
  `}function Ee(n,o,t){if(!n.trigger_config?.entity_id)return h;let e=n.trigger_config.entity_id,i=o.get(e)||[],s=[];if(i.length>=2)s=i.map(M=>({ts:M.ts,val:M.val}));else{if(!n.history)return h;for(let M of n.history)M.trigger_value!=null&&s.push({ts:new Date(M.timestamp).getTime(),val:M.trigger_value})}if(n.trigger_current_value!=null&&s.push({ts:Date.now(),val:n.trigger_current_value}),s.length<2)return h;s.sort((M,y)=>M.ts-y.ts);let c=hs,p=us,l=s.map(M=>M.val),d=Math.min(...l),u=Math.max(...l),_=u-d||1;d-=_*.1,u+=_*.1;let f=s[0].ts,b=s[s.length-1].ts-f||1,T=M=>(M-f)/b*c,E=M=>2+(1-(M-d)/(u-d))*(p-4),O=s;if(O.length>ki){let M=Math.ceil(O.length/ki);O=O.filter((y,it)=>it%M===0||it===O.length-1)}let k=O.map(M=>`${R(T(M.ts))},${R(E(M.val))}`).join(" "),A=n.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return r`
  ...
  `}function $i(n,o){let t=o;if(n.days_until_due==null||!n.interval_days||n.interval_days<=0)return h;let{pct:e,overflow:i}=te(n.interval_days,n.days_until_due,n.interval_unit),s="var(--success-color, #4caf50)";return n.status==="overdue"?s="var(--error-color, #f44336)":n.status==="due_soon"&&(s="var(--warning-color, #ff9800)"),r`
  ...
  `}var ue=210,mt=46,wt=14,kt=12,Ti=14,ms=20+Ti,_s=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],et=class extends H{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(t=>{let e=Math.floor(t[0]?.contentRect?.width||0);e&&Math.abs(e-this._width)>2&&(this._width=e)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(t){t!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:t},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let t=this._width||320,e=[...this.points].sort((s,c)=>s.ts-c.ts),i=this.lang;return r`
    ...
    `}_renderSvg(t,e){let i=this.lang,s=t-mt-wt,c=ue-ms,p=c-kt,l=1/0,d=-1/0;for(let S of e)l=Math.min(l,S.min??S.val),d=Math.max(d,S.max??S.val);this.thresholdAbove!=null&&(l=Math.min(l,this.thresholdAbove),d=Math.max(d,this.thresholdAbove)),this.thresholdBelow!=null&&(l=Math.min(l,this.thresholdBelow),d=Math.max(d,this.thresholdBelow)),this.targetValue!=null&&(l=Math.min(l,this.targetValue),d=Math.max(d,this.targetValue)),this.forceZero&&(l=Math.min(l,0));let u=(d-l||1)*.06,_=this.forceZero&&l>=0?0:l-u,{ticks:f,niceMin:v,niceMax:b}=qt(_,d+u,4);this.forceZero&&l>=0&&v<0&&(v=0,f=f.filter(S=>S>=0));let T=e[0].ts,E=this.projection&&this.projection.length===2?this.projection[1].ts:null,O=E!=null?Math.max(e[e.length-1].ts,E):e[e.length-1].ts,k=O-T||1,A=se(T,O),M=S=>mt+(S-T)/k*s,y=S=>kt+(1-(S-v)/(b-v||1))*p,it=e.map(S=>`${R(M(S.ts))},${R(y(S.val))}`).join(" "),ut=`M${R(M(e[0].ts))},${c} `+e.map(S=>`L${R(M(S.ts))},${R(y(S.val))}`).join(" ")+` L${R(M(e[e.length-1].ts))},${c} Z`,x="",F=e.filter(S=>S.min!=null&&S.max!=null);if(F.length>=2){let S=F.map(z=>`${R(M(z.ts))},${R(y(z.max))}`),$=[...F].reverse().map(z=>`${R(M(z.ts))},${R(y(z.min))}`);x=`M${S[0]} `+S.slice(1).map(z=>`L${z}`).join(" ")+` L${$.join(" L")} Z`}let B=[];if(this.thresholdBelow!=null){let S=y(this.thresholdBelow);B.push({y:S,h:Math.max(0,c-S),lineY:S,label:`\u25BC ${_t(this.thresholdBelow,i)}`,labelY:Math.min(c-4,S+13)})}if(this.thresholdAbove!=null){let S=y(this.thresholdAbove);B.push({y:kt,h:Math.max(0,S-kt),lineY:S,label:`\u25B2 ${_t(this.thresholdAbove,i)}`,labelY:Math.max(kt+11,S-5)})}let I=e[e.length-1],G=(this.events||[]).filter(S=>S.ts>=T&&S.ts<=O),J=ae(T,O,Math.max(2,Math.min(5,Math.floor(s/110)+1))),W=this._hover;return r`
      <div class="svg-holder">
        ...
        >
          ...
          ${J.map((S,$)=>{let z=M(S),Dt=$===0?"start":$===J.length-1?"end":"middle";return X`<text x="${R(z)}" y="${ue-5}" text-anchor="${Dt}" class="tick-label">${zt(S,i,A)}</text>`})}
          ...
          ${G.map(S=>{let $=M(S.ts),z=S.type==="completed"?"var(--success-color, #4caf50)":S.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return X`
              ...
              <rect x="${R($-1.5)}" y="${c+3}" width="3" height="${Ti-6}" rx="1.5" fill="${z}">
        ...
        ${W?r`<div
            ...
            >
              <div class="hover-date">${ye(W.p.ts,i)}</div>
              <div class="hover-val">
  ...
  `,g([j({attribute:!1})],et.prototype,"points",2),g([j({attribute:!1})],et.prototype,"events",2),g([j()],et.prototype,"unit",2),g([j()],et.prototype,"lang",2),g([j({attribute:!1})],et.prototype,"thresholdAbove",2),g([j({attribute:!1})],et.prototype,"thresholdBelow",2),g([j({attribute:!1})],et.prototype,"targetValue",2),g([j({type:Boolean})],et.prototype,"forceZero",2),g([j({attribute:!1})],et.prototype,"projection",2),g([j({attribute:!1})],et.prototype,"rangeDays",2),g([j({type:Boolean})],et.prototype,"showRange",2),g([j({type:Boolean})],et.prototype,"busy",2),g([j({type:Boolean})],et.prototype,"hideOutliers",2),g([j({type:Boolean})],et.prototype,"showOutlierToggle",2),g([m()],et.prototype,"_width",2),g([m()],et.prototype,"_hover",2);customElements.get("maintenance-trigger-chart")||customElements.define("maintenance-trigger-chart",et);function Si(n){let o=(n??"").trim().toLowerCase();return o==="on"||o==="open"||o==="true"?1:o==="off"||o==="closed"||o==="false"?0:null}function fs(n,o,t){if(n.length<2)return null;let e=t.now??Date.now(),i=Math.max(0,o.trigger_for_minutes??0)*6e4,s=o.trigger_from_state?Si(o.trigger_from_state):null,c=o.trigger_to_state?Si(o.trigger_to_state):null;if(o.trigger_from_state&&s===null||o.trigger_to_state&&c===null)return null;let p=[...n].sort((k,A)=>k.ts-A.ts),l=[];for(let k of p){let A=l[l.length-1];(!A||A.level!==k.val)&&l.push({start:k.ts,level:k.val})}let d=k=>(k+1<l.length?l[k+1].start:e)-l[k].start>=i,u=(k,A,M)=>{let y=k[k.length-1];y&&y.val!==M&&k.push({ts:A,val:y.val}),k.push({ts:A,val:M})};if((o.trigger_target_changes??1)===1&&c!==null){let k=[];l.forEach((M,y)=>u(k,M.start,M.level===c&&d(y)?1:0));let A=k[k.length-1]?.val??0;return k.push({ts:e,val:A}),{points:k,mode:"alarm"}}let f=t.since??l[0].start,v=0,b=[];for(let k=1;k<l.length;k++){let A=l[k-1],M=l[k];s!==null&&A.level!==s||c!==null&&M.level!==c||!d(k)||M.start<f||(v+=1,b.push(M.start))}let T=Math.max(0,(t.current??v)-v),E=[{ts:Math.max(f,l[0].start),val:T}],O=T;for(let k of b)O+=1,u(E,k,O);return E.push({ts:e,val:O}),{points:E,mode:"count"}}function vs(n){if(n.length<4)return n;let o=n.map(d=>d.val).sort((d,u)=>d-u),t=d=>{let u=(o.length-1)*d,_=Math.floor(u),f=Math.ceil(u);return o[_]+(o[f]-o[_])*(u-_)},e=t(.25),i=t(.75),s=i-e;if(s===0)return n;let c=e-1.5*s,p=i+1.5*s,l=n.filter(d=>d.val>=c&&d.val<=p);return l.length>=2?l:n}function ji(n,o){let t=n.trigger_config;if(!t)return h;let e=o.lang,i=n.trigger_entity_info,s=n.trigger_entity_infos,c=i?.friendly_name||t.entity_id||"\u2014",p=t.entity_id||"",l=t.entity_ids||(p?[p]:[]),d=i?.unit_of_measurement||"",u=n.trigger_current_value,_=t.type||"threshold",f=l.length>1,v=bs(n,d,o);return r`
    <h3>${a("trigger",e)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${f?r`
            ...
            <div class="trigger-entity-id">${l.map((b,T)=>r`${T>0?", ":""}<span class="entity-link" @click=${E=>Ft(E,b)}>${b}</span>`)}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `:r`
            <div class="trigger-entity-name">${c}</div>
            <div class="trigger-entity-id">${p?r`<span class="entity-link" @click=${b=>Ft(b,p)}>${p}</span>`:""}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `}
        </div>
      ...
      <div class="trigger-limits">
        ...
        ${_==="compound"?r`
          ...
          ${(t.conditions||[]).map((b,T)=>r`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${T+1}. ${a(b.type||"unknown",e)}: ${b.entity_id?r`<span class="entity-link" @click=${E=>Ft(E,b.entity_id)}>${b.entity_id}</span>`:""}</span>
          `)}
        `:h}
      </div>
  ...
  `}function bs(n,o,t){let e=n.trigger_config,i=n.trigger_current_value;if(!e||i==null)return null;switch(e.type||"threshold"){case"counter":{let s=e.trigger_target_value;if(s==null||s<=0)return null;if(!e.trigger_delta_mode)return{progress:Math.max(0,i),target:s,unit:o,meter:null};let c=Ei(n,Ri(n,t));return{progress:Math.max(0,i-(c?.value??i)),target:s,unit:o,meter:i}}case"state_change":{let s=e.trigger_target_changes;return s==null||s<=0?null:{progress:Math.max(0,i),target:s,unit:"",meter:null}}case"runtime":{let s=e.trigger_runtime_hours;return s==null||s<=0?null:{progress:Math.max(0,i),target:s,unit:"h",meter:null}}}return null}function Ei(n,o){if(n.trigger_baseline_value!=null)return{value:n.trigger_baseline_value,ts:ge(n)};if(!o.length)return null;let t=ge(n);if(t==null)return{value:o[0].val,ts:null};let e=o[0],i=Math.abs(o[0].ts-t);for(let s of o){let c=Math.abs(s.ts-t);c<i&&(e=s,i=c)}return{value:e.val,ts:t}}function ge(n){let o=[...n.history].filter(t=>t.type==="completed"||t.type==="reset").sort((t,e)=>new Date(e.timestamp).getTime()-new Date(t.timestamp).getTime())[0];return o?new Date(o.timestamp).getTime():null}function ys(n,o){let t=Math.min(999,Math.round(n.progress/n.target*100)),e=t>=100?"over":t>=75?"near":"ok";return r`
  ...
  `}function Ri(n,o){let t=n.trigger_config;if(!t)return[];let e=t.type||"threshold",i=t.entity_id||"",s=e==="runtime"?[]:o.detailStatsData.get(i)||[],c=o.isCounterEntity(t),p=[];if(s.length>=2)for(let d of s){let u={ts:d.ts,val:d.val};!c&&d.min!=null&&d.max!=null&&(u.min=d.min,u.max=d.max),p.push(u)}else for(let d of n.history)d.trigger_value!=null&&p.push({ts:new Date(d.timestamp).getTime(),val:d.trigger_value});let l=!!i&&!!o.historyFallbackIds?.has(i)&&s.length>=2;return n.trigger_current_value!=null&&!l&&p.push({ts:Date.now(),val:n.trigger_current_value}),p.sort((d,u)=>d.ts-u.ts),p}function xs(n,o,t){let e=n.trigger_config;if(!e)return h;let i=e.type||"threshold",s=e.entity_id||"",c=Ri(n,t),p=null;i==="state_change"&&s&&t.historyFallbackIds?.has(s)&&(p=fs(c,e,{since:ge(n),current:n.trigger_current_value??null}),p&&(c=p.points)),i==="runtime"&&e.trigger_runtime_hours&&n.trigger_current_value!=null&&(c=[{ts:ge(n)??c[0]?.ts??Date.now()-864e5,val:0},{ts:Date.now(),val:Math.max(0,n.trigger_current_value)}]),t.hideOutliers&&(c=vs(c));let l=c.length<2&&!!s&&t.hasStatsService&&!t.detailStatsData.has(s);if(c.length<2&&!l)return h;let d=!!s&&t.detailStatsData.has(s)&&(t.detailStatsData.get(s)?.length??0)<2,u=Date.now()-t.rangeDays*864e5,_=c.filter(k=>k.ts>=u);_.length>=2&&(c=_);let f=null,v=!1;if(i==="counter"&&e.trigger_target_value!=null&&c.length){if(e.trigger_delta_mode){let k=Ei(n,c);if(k){if(k.ts!=null){let A=c.filter(M=>M.ts>=k.ts);A.length>=2&&(c=A)}c=c.map(A=>({...A,val:Math.max(0,A.val-k.value)}))}}f=e.trigger_target_value,v=!0}else i==="state_change"&&e.trigger_target_changes&&p?.mode!=="alarm"?(f=e.trigger_target_changes,v=!0):i==="runtime"&&e.trigger_runtime_hours&&(f=e.trigger_runtime_hours,v=!0);let b=null,T=n.degradation_rate,E=T!=null&&(e.trigger_below!=null&&e.trigger_above==null&&T>0||e.trigger_above!=null&&e.trigger_below==null&&T<0);if(f==null&&T!=null&&!E&&(n.degradation_trend!=="stable"||n.days_until_threshold!=null)&&n.degradation_trend!=="insufficient_data"&&c.length>=2){let k=c[c.length-1];b=[k,{ts:k.ts+30*864e5,val:k.val+T*30}]}let O=n.history.filter(k=>["completed","skipped","reset"].includes(k.type)).map(k=>({ts:new Date(k.timestamp).getTime(),type:k.type}));return r`
  ...
  `}var ws=200,Wt=10,ks=22;function Mi(n,o,t,e,i){let s=n.history.filter(l=>l.type==="completed"&&(l.cost!=null||l.duration!=null));if(s.length<2)return h;let c=s.some(l=>(l.cost??0)>0),p=s.some(l=>(l.duration??0)>0);return!c&&!p?h:r`
  ...
  `}function $s(n,o,t,e){let i=n.history.filter($=>$.type==="completed"&&($.cost!=null||$.duration!=null)).map($=>({ts:new Date($.timestamp).getTime(),cost:$.cost??0,duration:$.duration??0})).sort(($,z)=>$.ts-z.ts);if(i.length<2)return h;let s=i.some($=>$.cost>0),c=i.some($=>$.duration>0);if(!s&&!c)return h;let p=t!=="duration"&&s,l=t!=="cost"&&c,d=p||!l&&s,u=l||!p&&c,_=640,f=ws,v=d?44:12,b=u?44:12,T=_-v-b,E=f-ks,O=E-Wt,k=i[0].ts,A=i[i.length-1].ts,M=(A-k||864e5)*.05,y=k-M,it=A+M,ut=se(k,A),x=$=>v+($-y)/(it-y)*T,F=qt(0,Math.max(...i.map($=>$.cost))||1,3),B=qt(0,Math.max(...i.map($=>$.duration))||1,3),I=$=>Wt+(1-$/(F.niceMax||1))*O,G=$=>Wt+(1-$/(B.niceMax||1))*O,J=i.length>1?Math.min(...i.slice(1).map(($,z)=>x($.ts)-x(i[z].ts))):T,W=Math.max(6,Math.min(22,J*.55)),S=ae(k,A,Math.max(2,Math.min(4,i.length)));return r`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${_} ${f}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${a("chart_history",o)}">
        ${d?F.ticks.map($=>{let z=I($);return z<Wt-1||z>E+1?h:X`
        ...
        ${u?B.ticks.map($=>{let z=G($);return z<Wt-1||z>E+1?h:X`<text x="${_-b+6}" y="${R(z+3.5)}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="10.5">${_t($,o)}m</text>`}):h}

        ${d?i.filter($=>$.cost>0).map($=>X`
          <rect x="${R(x($.ts)-W/2)}" y="${R(I($.cost))}" width="${R(W)}" height="${R(E-I($.cost))}"
            fill="var(--primary-color)" opacity="0.6" rx="2">
            <title>${zt($.ts,o,!0)}: ${Y($.cost,e,o)}${$.duration?` \xB7 ${$.duration}m`:""}</title>
          </rect>
        `):h}
        ${u?X`
          ...
          ${i.map($=>X`
            <circle cx="${R(x($.ts))}" cy="${R(G($.duration))}" r="3.5" fill="var(--accent-color, #ff9800)">
              <title>${zt($.ts,o,!0)}: ${$.duration}m${$.cost?` \xB7 ${Y($.cost,e,o)}`:""}</title>
            </circle>
          `)}
        `:h}

        <line x1="${v}" y1="${E}" x2="${_-b}" y2="${E}" stroke="var(--divider-color)" stroke-width="1" />
        ${S.map(($,z)=>{let Dt=z===0?"start":z===S.length-1?"end":"middle";return X`<text x="${R(x($))}" y="${f-6}" text-anchor="${Dt}" fill="var(--secondary-text-color)" font-size="10">${zt($,o,ut)}</text>`})}
      </svg>
    </div>
  ...
  `}var Ts=["completed","skipped","missed","reset","triggered","trigger_replaced","trigger_removed"];function Ci(n,o){let t=o.lang;return r`
    <div class="history-filters-new">
      <div class="filter-chips">
        ${Ts.map(e=>{let i=n.history.filter(s=>s.type===e).length;return i===0?h:r`
  ...
  `}function Oi(n,o){let t=o.lang,e=o.filter?n.history.filter(i=>i.type===o.filter):n.history;if(o.search){let i=o.search.toLowerCase();e=e.filter(s=>pi(s.notes,o.search)||(Di(o,s)??"").toLowerCase().endsWith(i))}return e.length===0?r`<p class="empty">${a("no_history",t)}</p>`:r`
    <div class="history-timeline">
      ${[...e].reverse().map(i=>Ss(i,o))}
    </div>
  `}function Di(n,o){return n.taskRef&&o.ref_no?`${n.taskRef}-${o.ref_no}`:null}function Ss(n,o){let t=o.lang,e=["completed","reset","skipped"].includes(n.type);return r`
    <div class="history-entry">
      <div class="history-icon ${n.type}">
        <ha-icon .icon=${Kt[n.type]||"mdi:circle"}></ha-icon>
      </div>
      <div class="history-content">
        <div class="history-row">
          <strong>${a(n.type,t)}</strong>
          ${Lt(Di(o,n),a("ref_number",t))}
        ...
        ${(()=>{let i=Pt(n);return i.length===0?h:r`<div class="history-readings">
  ...
  `}function Re(n,o,t){if(!n.responsible_user_id)return h;let e=t?.(n.responsible_user_id)??null;if(e)return r`<span class="user-badge">${Ge(e)}${e.name}</span>`;let i=o(n.responsible_user_id);return i?r`
    <span class="user-badge">
      <ha-icon icon="mdi:account"></ha-icon>
      ${i}
    </span>
  `:h}function js(n,o){let t=o.lang,e=o.isOperator,i=n.archived?"archived":n.is_done?"done":n.status==="due_soon"?"warning":n.status||"ok",s=n.archived?a("archived",t):n.is_done?a("completed",t):a(n.status||"ok",t);return r`
    <div class="task-header">
      <div class="task-header-title">
        ...
        ${Re(n,o.getUserName,o.getPerson)}
  ...
  `}function Es(n){let o=n.lang;return r`
    <div class="tab-bar">
  ...
  `}function Ii(n,o,t,e){let i=e.collapsedSections.has(n);return r`
  ...
  `}function Rs(n,o){if(!qe(n))return h;let t=o.lang,e=n.phase_sequence,i=Be(n.phase_cursor,e.length),s=new Map;for(let c=n.history.length-1;c>=0;c--){let p=n.history[c];p.phase_id&&p.type==="completed"&&!s.has(p.phase_id)&&s.set(p.phase_id,p.timestamp)}return r`
  ...
  `}function Ms(n,o){if(!o.features.checklists)return h;let t=ie(n)?.checklist??(n.checklist||[]);if(t.length===0)return h;let e=o.lang,i=n.checklist_progress||{},s=t.filter(c=>i[c]).length;return r`
  ...
  `}function Cs(n,o){let t=st(n.documentation_url)?n.documentation_url:null,e=st(o.objectDocUrl)?o.objectDocUrl:null,i=e?null:(o.objectManualDocs||[])[0];if(!n.notes&&!t&&!e&&!i)return h;let s=o.lang;return r`
    <div class="task-meta-card">
      ${n.notes?r`
        <div class="task-meta-row">
          <ha-icon icon="mdi:note-text-outline"></ha-icon>
          <span class="task-meta-notes">${ee(n.notes)}</span>
        </div>
      `:h}
      ${t?r`
  ...
  `}function Os(n,o){let t=o.lang,e=n.times_performed>0?n.total_cost/n.times_performed:0,i=n.days_until_due!==null&&n.days_until_due!==void 0?n.days_until_due<0?"overdue":n.days_until_due<=n.warning_days?"warning":"":"";return r`
    <div class="kpi-bar">
      <div class="kpi-card">
  ...
  `}function Ds(n,o){let t=o.lang;if(!o.features.adaptive||!n.suggested_interval||n.suggested_interval===n.interval_days)return h;if(o.suggestionDismissed)return h;let e=n.suggested_interval;return r`
    <div class="recommendation-card">
      <h4>${a("suggested_interval",t)}</h4>
      ${ti(n.interval_days,e,n.interval_confidence||"medium",t)}
  ...
  `}function Is(n,o){let t=o.lang,e=n.history.slice(-3).reverse();if(e.length===0)return h;let i=s=>{switch(s){case"completed":return"\u2713";case"triggered":return"\u2297";case"skipped":return"\u21B7";case"reset":return"\u21BA";default:return"\xB7"}};return r`
    <div class="recent-activities">
      ...
      ${e.map(s=>r`
        <div class="activity-item">
          ...
          ${s.cost?r`<span class="activity-badge">${Y(s.cost,o.currencySymbol,t)}</span>`:h}
  ...
  `}function As(n,o){let t=o.lang,e=o.features.adaptive&&n.suggested_interval&&n.suggested_interval!==n.interval_days,i=o.features.seasonal&&n.seasonal_factor&&n.seasonal_factor!==1,s=e||i,c=o.features.adaptive&&n.interval_analysis?.weibull_beta!=null&&n.interval_analysis?.weibull_eta!=null,p=o.features.seasonal&&(n.seasonal_factors?.length===12||n.interval_analysis?.seasonal_factors?.length===12);return r`
    <div class="tab-content overview-tab">
      ...
      <div class="two-column-layout ${s?"":"single-column"}">
        ...
        <div class="right-column">
          ${Mi(n,t,o.costDurationToggle,l=>o.setCostDurationToggle(l),o.currencySymbol)}
        </div>
      </div>
      ${c?Ii("weibull","weibull_reliability_curve",Ze(n,t),o):h}
      ${p?Ii("seasonal","seasonal_chart_title",r`
            ${ii(n,t)}
  ...
  `}function zs(n,o){switch(o.activeTab){case"overview":return As(n,o);case"history":return Ps(n,o);default:return h}}function Ai(n,o){return r`
  ...
  `}var Gt=class extends H{createRenderRoot(){return this}render(){return!this.task||!this.ctx?h:r`${Ai(this.task,this.ctx)}`}};g([j({attribute:!1})],Gt.prototype,"task",2),g([j({attribute:!1})],Gt.prototype,"ctx",2);customElements.get("maintenance-task-detail-view")||customElements.define("maintenance-task-detail-view",Gt);function Pi(n){if(n.total<=0)return{start:0,end:0,padTop:0,padBottom:0};let o=n.overscan??12,t=Math.max(1,n.step??6),e=Math.max(1,n.rowHeight),i=Math.floor((n.scrollTop-n.listTop)/e),s=Math.ceil(n.viewportHeight/e)+1,c=Math.max(0,i-o);c=Math.floor(c/t)*t;let p=Math.min(n.total,Math.max(i,0)+s+o);return p=Math.min(n.total,Math.ceil(p/t)*t),c>=p&&(c=Math.min(c,Math.max(0,n.total-1)),p=Math.min(n.total,c+Math.max(s,1))),{start:c,end:p,padTop:c*e,padBottom:(n.total-p)*e}}var me={mode:"top",marginTop:0,lastScrollTop:0};function zi(n,o){return n==="top"?8:o.viewH-o.paneH-8}function Li(n){let o=n.scrollTop+8-n.layoutTop,t=Math.max(0,n.listH-n.paneH);return{mode:"top",marginTop:o>t?Math.max(0,o):0,lastScrollTop:n.scrollTop}}function Hi(n,o){let t=o.scrollTop,e=o.scrollTop>n.lastScrollTop?"down":o.scrollTop<n.lastScrollTop?"up":"none",i=Math.max(0,o.listH-o.paneH),s=o.paneH+16<=o.viewH||o.listH<=o.paneH,{mode:c,marginTop:p}=n;if(s&&(c="top"),c==="top"&&p>0&&e==="up")p=Math.max(0,Math.min(p,o.scrollTop+8-o.layoutTop)),p<=i&&(p=0);else if(!s&&e==="down"&&c==="top"){let l=o.renderedTop-o.layoutTop;l<=i&&(c="bottom",p=Math.max(0,l))}else!s&&e==="up"&&c==="bottom"&&(p=Math.min(Math.max(0,o.renderedTop-o.layoutTop),i),o.scrollTop+8<=o.layoutTop+p&&(c="top",p=0));return{mode:c,marginTop:p,lastScrollTop:t}}var _e=2,Hs=250,Ot={objects:6,tasks:10,parts:6,documents:8,history:6},Ns="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Me=["due_date","object","type","task_name","area","assigned_user","group"],Ni=["none","area","group","user","object"],Fi=["today","dashboard","calendar","settings"],Fs=["overdue","due_soon","triggered","ok"],w=class extends H{constructor(){super(...arguments);this.narrow=!1;this.tight=!1;this.split=!1;this._tightObserver=null;this.panel={};this.embedded=!1;this.presets={};this._presetsApplied=!1;this._mountPath=null;this._objects=[];this._stats=null;this._view="overview";this._allParts=null;this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._filterLabel=null;this._filterPriority="";this._savedViews=[];this._activeViewId="";this._unsub=null;this._chartRangeDays=(()=>{try{let t=parseInt(at(P.chartRange)||"",10);return[7,30,90,365].includes(t)?t:30}catch{return 30}})();this._hideOutliers=(()=>{try{return at(P.chartHideOutliers)==="1"}catch{return!1}})();this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._operatorWriteEnabled=!1;this._defaultWarningDays=7;this._rowActionStyle="buttons_compact";this._rowActionNotice=!1;this._actionLoading=!1;this._moreMenuOpen=!1;this._objMenuOpen=!1;this._toastMessage="";this._toastUndo=null;this._toastActionLabel="";this._filtersOpen=!1;this._newMenuOpen=!1;this._gsSetupsCount=0;this._gsAdoptCount=0;this._gsLoaded=!1;this._batteryFleetSetupAvailable=!1;this._staleBundle=!1;this._staleChecked=!1;this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab=(()=>{try{let t=at(P.overviewTab);return t==="today"||t==="calendar"?t:"dashboard"}catch{return"dashboard"}})();this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._objectViewMode="cards";this._objectsTableColumns=He;this._showArchived=!1;this._bulkMode=!1;this._bulkSelected=new Set;this._virtStart=0;this._virtEnd=0;this._virtRowHeight=53;this._virtTotalRows=0;this._virtScrollAttached=!1;this._virtRaf=0;this._stickyState=me;this._stickySelectPending=!1;this._stickyRaf=0;this._stickyAttached=!1;this._stickyObserver=null;this._collapsedGroups=new Set;this._collapsedSections=(()=>{try{return new Set(JSON.parse(at(P.collapsedSections)||"[]"))}catch{return new Set}})();this._paletteOpen=!1;this._paletteQuery="";this._paletteActive=0;this._searchRemote=null;this._searchTimer=null;this._searchSeq=0;this._templateGalleryOpen=!1;this._templates=[];this._templateCategories={};this._templateBusy=!1;this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=t=>this._onPopState(t);this._locationChangedHandler=()=>this._onLocationChanged();this._lazyUi=null;this._onStickyScroll=()=>{this._stickyRaf||(this._stickyRaf=requestAnimationFrame(()=>{this._stickyRaf=0,this._updateStickyPane()}))};this._onVirtualScroll=()=>{this._virtRaf||(this._virtRaf=requestAnimationFrame(()=>{this._virtRaf=0,this._updateVirtualWindow()}))};this._deepLinkHandled=!1;this._deepLinkInPlace=!1;this._initialLoadDone=!1;this._kpiRefreshInFlight=!1;this._kpiRefreshPending=!1;this._paletteKeydown=t=>{if(t.key==="/"&&!t.ctrlKey&&!t.metaKey&&!t.altKey&&!this._paletteOpen){let i=t.composedPath()[0];if(i instanceof HTMLElement&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.tagName==="SELECT"||i.isContentEditable))return;t.preventDefault(),this._openPalette();return}if(!this._paletteOpen)return;let e=this._paletteResults;if(t.key==="Escape")t.preventDefault(),this._closePalette();else if(t.key==="ArrowDown")t.preventDefault(),this._paletteActive=Math.min(this._paletteActive+1,e.length-1);else if(t.key==="ArrowUp")t.preventDefault(),this._paletteActive=Math.max(this._paletteActive-1,0);else if(t.key==="Enter"){t.preventDefault();let i=e[this._paletteActive];i&&this._selectPaletteResult(i)}};this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=t=>{let e=t.detail;e?.type==="maintenance-supporter:open-task"&&e.entry_id&&e.task_id&&(t.stopPropagation(),this._showTask(e.entry_id,e.task_id))};this._fullHistory=null;this._onHistoryEntrySaved=async()=>{await this._loadData()}}get _currencySymbol(){return this._budget?.currency_symbol||Qt}get _lang(){return V(this.hass)}get _isOperator(){let t=this.hass?.user;return t?t.is_admin?!1:!(this._operatorWriteEnabled&&this._adminPanelUserIds.includes(t.id)):!0}_ensureLazyUi(){return this._lazyUi||(this._lazyUi=Promise.all([import("/maintenance_supporter_panelfiles/panel-chunks/object-dialog-4YL64MAY.js"),import("/maintenance_supporter_panelfiles/panel-chunks/task-dialog-FE7333I3.js"),import("/maintenance_supporter_panelfiles/panel-chunks/complete-dialog-RDPM3MMR.js"),import("/maintenance_supporter_panelfiles/panel-chunks/qr-dialog-UHYHOP5H.js"),import("/maintenance_supporter_panelfiles/panel-chunks/adopt-problem-sensors-dialog-ZWVXUYZ5.js"),import("/maintenance_supporter_panelfiles/panel-chunks/suggested-setups-dialog-E5YV7F2E.js"),import("/maintenance_supporter_panelfiles/panel-chunks/settings-view-SDKDRKP5.js")]).then(()=>this.updateComplete)),this._lazyUi}async _ui(t){return await this._ensureLazyUi(),this.shadowRoot?.querySelector(t)??null}connectedCallback(){super.connectedCallback(),this._mountPath=window.location.pathname;let t=window.requestIdleCallback,e=()=>this._ensureLazyUi();t?t(e,{timeout:3e3}):window.setTimeout(e,1500),window.addEventListener("popstate",this._popstateHandler),window.addEventListener("location-changed",this._locationChangedHandler),window.addEventListener("keydown",this._paletteKeydown),typeof ResizeObserver<"u"&&(this._tightObserver=new ResizeObserver(i=>{let s=i[0]?.contentRect.width??0;s>0&&(this.tight=s<1e3),s>0&&(this.split=s>=1500)}),this._tightObserver.observe(this)),window.addEventListener("resize",this._onVirtualScroll,{passive:!0});try{let i=at(P.taskSort);i&&Me.includes(i)&&(this._sortMode=i);let s=at(P.objectSort);s&&["alphabetical","due_soonest","task_count"].includes(s)&&(this._objectSortMode=s);let c=at(P.groupBy);c&&Ni.includes(c)&&(this._groupByMode=c);let p=at(P.objectView);(p==="cards"||p==="table")&&(this._objectViewMode=p)}catch{}if(this._objects.length===0){let i=gi();i&&(this._objects=i.objects,i.stats&&(this._stats=i.stats))}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),window.removeEventListener("location-changed",this._locationChangedHandler),window.removeEventListener("keydown",this._paletteKeydown),this._tightObserver?.disconnect(),this._tightObserver=null,window.removeEventListener("resize",this._onVirtualScroll),this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onVirtualScroll),this._virtScrollAttached=!1,this._virtRaf&&cancelAnimationFrame(this._virtRaf),this._detachStickyPane(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._initialLoadDone=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=null),this._toastTimer&&(clearTimeout(this._toastTimer),this._toastTimer=null),this._toastMessage="",this._toastUndo=null,this._toastActionLabel="",this._statsService?.clearCache(),this._statsService=null}willUpdate(t){super.willUpdate(t),t.has("_groupByMode")&&this._collapsedGroups.size>0&&(this._collapsedGroups=new Set)}updated(t){if(super.updated(t),It(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new oe(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new Ye(this.hass),this._userService.getUsers())}let e=this.shadowRoot?.querySelector(".content");e&&!this._virtScrollAttached&&(e.addEventListener("scroll",this._onVirtualScroll,{passive:!0}),this._virtScrollAttached=!0),this._updateVirtualWindow(),this._syncStickyPane(e)}_syncStickyPane(t){let e=this.shadowRoot?.querySelector(".split-pane");if(!e||!t){this._stickyAttached&&this._detachStickyPane();return}this._stickyAttached||(t.addEventListener("scroll",this._onStickyScroll,{passive:!0}),window.addEventListener("resize",this._onStickyScroll),typeof ResizeObserver<"u"&&(this._stickyObserver=new ResizeObserver(this._onStickyScroll)),this._stickyAttached=!0),this._stickyObserver?.observe(e),this._updateStickyPane()}_detachStickyPane(){this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onStickyScroll),window.removeEventListener("resize",this._onStickyScroll),this._stickyObserver?.disconnect(),this._stickyObserver=null,this._stickyRaf&&cancelAnimationFrame(this._stickyRaf),this._stickyRaf=0,this._stickyAttached=!1,this._stickyState=me,this._stickySelectPending=!1}_updateStickyPane(){let t=this.shadowRoot,e=t?.querySelector(".content"),i=t?.querySelector(".split-pane"),s=t?.querySelector(".split-layout"),c=t?.querySelector(".split-list");if(!e||!i||!s||!c)return;let p=e.getBoundingClientRect().top-e.scrollTop,l={scrollTop:e.scrollTop,viewH:e.clientHeight,paneH:i.offsetHeight,listH:c.offsetHeight,layoutTop:s.getBoundingClientRect().top-p,renderedTop:i.getBoundingClientRect().top-p};this._stickySelectPending&&l.scrollTop===this._stickyState.lastScrollTop?this._stickyState=Li(l):(this._stickySelectPending=!1,this._stickyState=Hi(this._stickyState,l));let d=this._stickyState;i.style.top=`${zi(d.mode,l)}px`,i.style.marginTop=d.marginTop>0?`${d.marginTop}px`:""}_resetStickyPane(){let t=this.shadowRoot?.querySelector(".content");this._stickyState={...me,lastScrollTop:t?.scrollTop??0},this._stickySelectPending=!0}_updateVirtualWindow(){let t=this.shadowRoot?.querySelector(".content"),e=this.shadowRoot?.querySelector(".task-table.virtual");if(!t||!e)return;let i=e.querySelector(".task-row:not(.virt-sizer)");i&&i.offsetHeight>20&&(this._virtRowHeight=i.offsetHeight);let s=e.getBoundingClientRect().top-t.getBoundingClientRect().top+t.scrollTop,c=Pi({scrollTop:t.scrollTop,viewportHeight:t.clientHeight,listTop:s,rowHeight:this._virtRowHeight,total:this._virtTotalRows});(c.start!==this._virtStart||c.end!==this._virtEnd)&&(this._virtStart=c.start,this._virtEnd=c.end)}async _loadData(){let[t,e,i,s,c,p]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"}).catch(()=>null)]);if(p&&(this._savedViews=p.views||[]),t&&(this._objects=Vt(t.objects),ke(this._objects,e??this._stats??null),this._maybeLoadGettingStarted()),this._detailOpen()&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/status"}).then(l=>{this._batteryFleetSetupAvailable=!!l.available&&!l.configured}).catch(()=>{this._batteryFleetSetupAvailable=!1}),this._staleChecked||(this._staleChecked=!0,this.hass.connection.sendMessagePromise({type:"maintenance_supporter/version"}).then(l=>{this._staleBundle=Ce(l?.version)}).catch(()=>{})),e&&(this._stats=e),i&&(this._budget=i,Nt(this._budget)),s&&(this._groups=s.groups||{}),c){let l=c;this._features=l.features,this._adminPanelUserIds=l.admin_panel_user_ids||[],this._operatorWriteEnabled=l.operator_write_enabled??!1;let d=l.general?.default_warning_days;typeof d=="number"&&d>=0&&d<=365&&(this._defaultWarningDays=d);let u=l.general?.row_action_style;this._rowActionStyle=u==="icons"||u==="buttons"?u:"buttons_compact",this._rowActionNotice=l.general?.row_action_notice_pending===!0,this._objectsTableColumns=Ne(l.objects_table_columns)}this._fetchMiniStatsForOverview(),this._initialLoadDone=!0,this._handleDeepLink()}_onLocationChanged(){if(!this._initialLoadDone||!window.location.search||this.embedded&&this._mountPath!==null&&window.location.pathname!==this._mountPath)return;if(!this.embedded){let e=`/${typeof this.panel?.url_path=="string"?this.panel.url_path:"maintenance-supporter"}`,i=window.location.pathname;if(i!==e&&!i.startsWith(`${e}/`))return}this._deepLinkHandled=!1,this._deepLinkInPlace=!0;try{this._handleDeepLink()}finally{this._deepLinkInPlace=!1}history.state?.msp_view||history.replaceState({msp_view:this._view,msp_entry:this._selectedEntryId,msp_task:this._selectedTaskId},"")}_handleDeepLink(){if(this._deepLinkHandled)return;let t=new URLSearchParams(window.location.search),e=t.get("ms_action"),i=()=>{let b=window.location.pathname+window.location.hash;history.replaceState(history.state,"",b)};if(e==="add_object"){this._deepLinkHandled=!0,i(),this._ui("maintenance-object-dialog").then(b=>b?.openCreate());return}if(e==="open_vacation"||e==="open_budget"||e==="open_groups"||e==="open_settings"){if(this._deepLinkHandled=!0,i(),!this.hass?.user?.is_admin)return;this._overviewTab="settings",this._ensureLazyUi().then(()=>requestAnimationFrame(()=>{let b=this.shadowRoot?.querySelector("maintenance-settings-view"),T=e.replace("open_","");b?.scrollToSection?.(T)}));return}if(this.embedded&&!this._presetsApplied){this._presetsApplied=!0;let b=this.presets?.tab??"",T=(this.presets?.view??"").trim();if(!t.has("tab")&&Fi.includes(b)&&(b!=="settings"||this.hass?.user?.is_admin)&&(this._overviewTab=b),!t.has("view")&&T){let E=T.toLowerCase(),O=this._savedViews.find(k=>k.id===T)??this._savedViews.find(k=>k.name.trim().toLowerCase()===E);O&&(this._overviewTab="dashboard",this._applyView(O.id))}}let s=t.get("tab"),c=t.get("view"),p=t.get("sort"),l=t.get("status");if(s!==null||c!==null||p!==null||l!==null){if(i(),this._view!=="overview"&&(this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()),Fi.includes(s??"")&&(s!=="settings"||this.hass?.user?.is_admin)&&this._setOverviewTab(s),c!==null){let b=c.trim().toLowerCase(),T=this._savedViews.find(E=>E.id===c)??this._savedViews.find(E=>E.name.trim().toLowerCase()===b);T&&(this._overviewTab!=="dashboard"&&this._setOverviewTab("dashboard"),this._applyView(T.id))}Me.includes(p??"")&&(this._sortMode=p,this._activeViewId="",Z(P.taskSort,this._sortMode)),Fs.includes(l??"")&&(this._overviewTab!=="dashboard"&&this._setOverviewTab("dashboard"),this._filterByStatus(l))}let d=t.get("entry_id");if(!d)return;this._deepLinkHandled=!0;let u=t.get("task_id"),_=t.get("action"),f=window.location.pathname+window.location.hash;history.replaceState(history.state,"",f);let v=this._getObject(d);if(!v){this._showOverview();return}if(u){let b=v.tasks.find(T=>T.id===u);if(!b){this._showObject(d);return}this._showTask(d,u),_==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(d,u,b.name,this._features.checklists?b.checklist:void 0,this._features.adaptive&&!!b.adaptive_config?.enabled)}):_==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(d,u,b)})}else this._showObject(d)}_isCounterEntity(t){if(!t)return!1;let e=t.type||"threshold";return e==="counter"||e==="state_change"}async _fetchDetailStats(t,e){if(!this._statsService)return;let i=await this._statsService.getDetailStats(t,e,this._chartRangeDays),s=new Map(this._detailStatsData);s.set(t,i),this._detailStatsData=s}_setChartRange(t){if(t===this._chartRangeDays)return;this._chartRangeDays=t;try{Z(P.chartRange,String(t))}catch{}let e=this._selectedEntryId&&this._selectedTaskId?this._getTask(this._selectedEntryId,this._selectedTaskId):null,i=e?.trigger_config?.entity_id;if(i){let s=new Map(this._detailStatsData);s.delete(i),this._detailStatsData=s,this._fetchDetailStats(i,this._isCounterEntity(e.trigger_config))}}_setHideOutliers(t){if(t!==this._hideOutliers){this._hideOutliers=t;try{Z(P.chartHideOutliers,t?"1":"0")}catch{}}}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let t=[];for(let i of this._objects)for(let s of i.tasks){let c=s.trigger_config?.entity_id;c&&t.push({entityId:c,isCounter:this._isCounterEntity(s.trigger_config)})}if(t.length===0)return;let e=await this._statsService.getBatchMiniStats(t);this._miniStatsData=new Map([...this._miniStatsData,...e])}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e,s=ui(this._objects,i);s!==null&&(this._objects=s,e.objects&&ke(s,this._stats??null),this._refreshKpis(),this._detailOpen()&&(i.objects||(i.delta||[]).some(c=>c.entry_id===this._selectedEntryId))&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId))},{type:"maintenance_supporter/subscribe",deltas:!0,compact:!0});if(!this.isConnected){t();return}this._unsub=t}catch{}}async _refreshKpis(){if(this._kpiRefreshInFlight){this._kpiRefreshPending=!0;return}this._kpiRefreshInFlight=!0;try{do{this._kpiRefreshPending=!1;let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null)]);if(!this.isConnected)return;t&&(this._stats=t),e&&(this._budget=e,Nt(this._budget))}while(this._kpiRefreshPending)}finally{this._kpiRefreshInFlight=!1}}get _taskRows(){let t=[];for(let _ of this._objects)for(let f of _.tasks){if(!this._showArchived&&f.archived||this._filterStatus&&f.status!==this._filterStatus)continue;if(this._filterUser){let b=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(f.responsible_user_id!==b)continue}if(this._filterLabel&&!(f.labels||[]).includes(this._filterLabel)||this._filterPriority&&(f.priority||"normal")!==this._filterPriority)continue;let v=[];for(let b of Object.values(this._groups))b.task_refs?.some(T=>T.entry_id===_.entry_id&&T.task_id===f.id)&&v.push(b.name);t.push({entry_id:_.entry_id,task_id:f.id,object_name:_.object.name,allow_skip:f.allow_skip!==!1,notify_enabled:f.notify_enabled!==!1,task_name:f.name,type:f.type,schedule_type:f.schedule_type,status:f.status,days_until_due:f.days_until_due??null,next_due:f.next_due??null,trigger_active:f.trigger_active,trigger_current_value:f.trigger_current_value??null,trigger_current_delta:f.trigger_current_delta??null,trigger_config:f.trigger_config??null,trigger_entity_info:f.trigger_entity_info??null,times_performed:f.times_performed,total_cost:f.total_cost,interval_days:f.interval_days??null,interval_unit:f.interval_unit??null,interval_anchor:f.interval_anchor??null,is_done:f.is_done??!1,archived:f.archived??!1,history:f.history||[],enabled:f.enabled,nfc_tag_id:f.nfc_tag_id??null,priority:f.priority??"normal",labels:f.labels??[],area_id:_.object.area_id??null,responsible_user_id:f.responsible_user_id??null,group_names:v})}let e={overdue:0,triggered:1,due_soon:2,ok:3},i=(_,f)=>(e[_.status]??9)-(e[f.status]??9),s=(_,f)=>(_.days_until_due??99999)-(f.days_until_due??99999),c=(_,f)=>i(_,f)||s(_,f),p=_=>_.area_id&&this.hass?.areas?.[_.area_id]?.name||"",l=_=>_.responsible_user_id&&this._userService?.getUserName(_.responsible_user_id)||"",d=_=>_.group_names[0]||"",u={due_date:c,object:(_,f)=>_.object_name.localeCompare(f.object_name)||c(_,f),type:(_,f)=>_.type.localeCompare(f.type)||c(_,f),task_name:(_,f)=>_.task_name.localeCompare(f.task_name),area:(_,f)=>{let v=p(_),b=p(f);return!v&&b?1:v&&!b?-1:v.localeCompare(b)||c(_,f)},assigned_user:(_,f)=>{let v=l(_),b=l(f);return!v&&b?1:v&&!b?-1:v.localeCompare(b)||c(_,f)},group:(_,f)=>{let v=d(_),b=d(f);return!v&&b?1:v&&!b?-1:v.localeCompare(b)||c(_,f)}};return t.sort(u[this._sortMode]),t}_getObject(t){return this._objects.find(e=>e.entry_id===t)}_getTask(t,e){return this._getObject(t)?.tasks.find(s=>s.id===e)}_pushPanelState(t,e,i){let s={msp_view:t,msp_entry:e||null,msp_task:i||null};this._deepLinkInPlace?history.replaceState(s,""):history.pushState(s,"")}_onPopState(t){let e=t.state;if(e?.msp_view&&(this._view=e.msp_view,this._selectedEntryId=e.msp_entry||null,this._selectedTaskId=e.msp_task||null,this._moreMenuOpen=!1,e.msp_view==="all_parts"&&this._loadAllParts(),e.msp_view==="task"&&e.msp_entry&&e.msp_task)){this._historyFilter=null;let i=this._getTask(e.msp_entry,e.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop()}_showAllParts(){this._pushPanelState("all_parts"),this._view="all_parts",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop(),this._loadAllParts()}async _loadAllParts(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"});this._allParts=t.parts||[]}catch{this._allParts=[]}}_filterByStatus(t){this._filterStatus=t,this._activeViewId="",this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),this._scrollContentToTop()}get _allLabels(){let t=new Set;for(let e of this._objects)for(let i of e.tasks)for(let s of i.labels||[])t.add(s);return[...t].sort((e,i)=>e.localeCompare(i))}get _currentFilters(){return{status:this._filterStatus,user_id:this._filterUser,label:this._filterLabel,priority:this._filterPriority,archived:this._showArchived,sort_mode:this._sortMode,group_by:this._groupByMode}}_applyView(t){if(this._activeViewId=t,!t)return;let e=this._savedViews.find(s=>s.id===t);if(!e)return;let i=e.filters;this._filterStatus=i.status||"",this._filterUser=i.user_id||null,this._filterLabel=i.label||null,this._filterPriority=i.priority||"",this._showArchived=!!i.archived,Me.includes(i.sort_mode)&&(this._sortMode=i.sort_mode),Ni.includes(i.group_by)&&(this._groupByMode=i.group_by);try{Z(P.taskSort,this._sortMode),Z(P.groupBy,this._groupByMode)}catch{}this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard")}_openSavedViewsDialog(){this.shadowRoot.querySelector("maintenance-saved-views-dialog")?.open(this._currentFilters,this._savedViews)}_onSavedViewsChanged(t){this._savedViews=t.detail.views||[],this._activeViewId&&!this._savedViews.some(e=>e.id===this._activeViewId)&&(this._activeViewId="")}_scrollContentToTop(){requestAnimationFrame(()=>{let t=this.shadowRoot?.querySelector(".content");t&&t.scrollTo({top:0,behavior:"smooth"})})}_showObject(t){this._pushPanelState("object",t),this._view="object",this._selectedEntryId=t,this._selectedTaskId=null,this._scrollContentToTop()}_splitActive(){return this.split&&!this.narrow&&!this.tight&&this._view==="overview"&&this._overviewTab==="dashboard"&&!this._bulkMode}_detailOpen(){return(this._view==="task"||this._splitActive())&&!!this._selectedEntryId&&!!this._selectedTaskId}_showFullTaskPage(t,e){this._view!=="task"&&(this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._scrollContentToTop())}_showTask(t,e){if(this._splitActive()){this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._historySearch="",this._resetStickyPane(),this._fetchFullHistory(t,e);let s=this._getTask(t,e);s?.trigger_config?.entity_id&&this._fetchDetailStats(s.trigger_config.entity_id,this._isCounterEntity(s.trigger_config));return}this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._historySearch="",this._scrollContentToTop(),this._fetchFullHistory(t,e);let i=this._getTask(t,e);if(i?.trigger_config?.entity_id){let s=i.trigger_config.entity_id,c=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(s,c)}}_showToast(t){this._toastTimer&&clearTimeout(this._toastTimer),this._toastUndo=null,this._toastActionLabel="",this._toastMessage=t,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}_showActionToast(t,e,i){this._showUndoToast(t,i),this._toastActionLabel=e}_showUndoToast(t,e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastActionLabel="",this._toastMessage=t,this._toastUndo=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastUndo=null,this._toastTimer=null},7e3)}_runToastUndo(){let t=this._toastUndo;this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage="",this._toastUndo=null,this._toastTimer=null,t?.()}_openPalette(){this._paletteQuery="",this._paletteActive=0,this._paletteOpen=!0,this._searchRemote=null,this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".palette-input")?.focus()})}_closePalette(){this._paletteOpen=!1,this._paletteQuery="",this._searchRemote=null,this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=null)}_onPaletteInput(t){this._paletteQuery=t,this._paletteActive=0,this._searchTimer&&clearTimeout(this._searchTimer);let e=t.trim();if(e.length<_e){this._searchRemote=null;return}this._searchTimer=setTimeout(()=>{this._searchTimer=null;let i=++this._searchSeq;this.hass.connection.sendMessagePromise({type:"maintenance_supporter/search",query:e,limit:Ot.documents}).then(s=>{i!==this._searchSeq||!this._paletteOpen||(this._searchRemote={query:e,documents:s.documents||[],history:s.history||[]})}).catch(()=>{i!==this._searchSeq||!this._paletteOpen||(this._searchRemote={query:e,documents:[],history:[]})})},Hs)}get _paletteResults(){let t=this._lang,e=this._paletteQuery.trim();if(e.length<_e&&!re(e))return[];let i=Ut(e);if(!i.length)return[];let s=[],c=[],p=[],l=re(e);if(l){for(let f of this._objects){let v=f.object;if(v.ref_no!==l.object)continue;let b=xt(v);l.task==null&&s.push({kind:"object",entryId:f.entry_id,label:v.name||"",sub:a("object",t),score:1e3,icon:"mdi:package-variant-closed",ref:b});for(let T of f.tasks)T.archived||l.task!=null&&T.ref_no!==l.task||c.push({kind:"task",entryId:f.entry_id,taskId:T.id,label:T.name||"",sub:v.name||"",score:l.task==null?900:1e3,icon:"mdi:clipboard-check-outline",ref:St(v,T)})}if(s.length||c.length){let f=this._searchRemote&&this._searchRemote.query===e?this._searchRemote:null,v=[...s,...c.slice(0,Ot.tasks)];for(let b of f?.history.slice(0,1)??[])v.push({kind:"history",entryId:b.entry_id,taskId:b.task_id,label:b.task_name||"",sub:[b.object_name,b.timestamp?Q(b.timestamp,t):""].filter(Boolean).join(" \xB7 "),snippet:b.snippet||"",score:b.score,icon:"mdi:note-text-outline",ref:b.ref??null});return v}}for(let f of this._objects){let v=f.object;if(v.archived)continue;let b=v.name||"",T=Mt(i,[{text:b,weight:3},{text:v.manufacturer,weight:2},{text:v.model,weight:2},{text:v.serial_number,weight:2},{text:v.notes,weight:1}]);if(T>0){let E=[v.manufacturer,v.model].filter(Boolean).join(" ");s.push({kind:"object",entryId:f.entry_id,label:b,sub:E||a("object",t),score:T,icon:"mdi:package-variant-closed",ref:xt(v)})}for(let E of f.tasks){if(E.archived)continue;let O=(E.labels||[]).join(" "),k=Mt(i,[{text:E.name,weight:3},{text:b,weight:2},{text:O,weight:2},{text:E.notes,weight:1}]);if(k>0){let A=(E.labels||[]).length?`  #${(E.labels||[]).join(" #")}`:"";c.push({kind:"task",entryId:f.entry_id,taskId:E.id,label:E.name||"",sub:b+A,score:k,icon:"mdi:clipboard-check-outline",ref:St(v,E)})}}for(let E of f.parts||[]){let O=Mt(i,[{text:E.name,weight:3},{text:E.mpn,weight:2},{text:E.vendor,weight:1},{text:E.storage_location,weight:1},{text:E.notes,weight:1}]);O>0&&p.push({kind:"part",entryId:f.entry_id,label:E.name||"",sub:[b,E.mpn].filter(Boolean).join(" \xB7 "),score:O,icon:"mdi:cog-outline"})}}let d=(f,v)=>v.score-f.score||f.label.localeCompare(v.label),u=[...s.sort(d).slice(0,Ot.objects),...c.sort(d).slice(0,Ot.tasks),...p.sort(d).slice(0,Ot.parts)],_=this._searchRemote&&this._searchRemote.query===e?this._searchRemote:null;if(_){let f=_.documents.slice(0,Ot.documents);for(let v of[...f.filter(b=>b.match!=="content"),...f.filter(b=>b.match==="content")])u.push({kind:v.match==="content"?"content":"document",entryId:v.entry_id,docId:v.id,docKind:v.kind,url:v.url,page:v.page??null,label:v.title||v.filename||v.url||"",sub:v.object_name||"",snippet:v.snippet||"",score:v.score,icon:v.kind==="weblink"?"mdi:link-variant":"mdi:file-document-outline"});for(let v of _.history.slice(0,Ot.history))u.push({kind:"history",entryId:v.entry_id,taskId:v.task_id,label:v.task_name||"",ref:v.ref??null,sub:[v.object_name,v.timestamp?Q(v.timestamp,t):""].filter(Boolean).join(" \xB7 "),snippet:v.snippet||"",score:v.score,icon:v.type==="skipped"?"mdi:skip-next-circle-outline":"mdi:note-text-outline"})}return u}_selectPaletteResult(t){let e=this._paletteQuery.trim();switch(this._closePalette(),t.kind){case"task":t.taskId&&this._showTask(t.entryId,t.taskId);return;case"history":if(!t.taskId)return;this._showTask(t.entryId,t.taskId),this._activeTab="history",this._historySearch=e;return;case"document":case"content":t.docKind==="weblink"?st(t.url)&&window.open(t.url,"_blank","noopener"):t.docId&&yt(this.hass,t.docId,t.page?`#page=${t.page}`:"").catch(()=>{});return;default:this._showObject(t.entryId)}}_renderPalette(){if(!this._paletteOpen)return h;let t=this._lang,e=this._paletteResults,i=this._paletteQuery.trim(),s={object:a("objects",t),task:a("tasks",t),part:a("search_group_parts",t),document:a("documents",t),content:a("search_group_content",t),history:a("search_group_history",t)},c=i.length>=_e&&(!this._searchRemote||this._searchRemote.query!==i),p=null;return r`
      <div class="palette-backdrop" @click=${()=>this._closePalette()}>
        <div class="palette" role="dialog" aria-label=${a("search_open",t)} @click=${l=>l.stopPropagation()}>
          ...
          <div class="palette-results">
            ${i.length<_e&&!re(i)?r`<div class="palette-empty">${a("search_empty_hint",t)}</div>`:e.length===0?r`<div class="palette-empty">${c?a("search_searching",t):a("palette_no_results",t)}</div>`:e.map((l,d)=>{let u=l.kind!==p?r`<div class="palette-group">${s[l.kind]}</div>`:h;return p=l.kind,r`
                      ${u}
    ...
    `}_statusBadge(t,e,i){let s=this._lang,c=t?"archived":e?"done":i,p=t?"archived":e?"completed":i,l=t?a("archived",s):e?a("completed",s):a(i,s);return r`<span class="status-badge ${c}" role="img" title="${l}" aria-label="${l}"><ha-icon icon="${Kt[p]||"mdi:circle-medium"}"></ha-icon><span class="status-label">${l}</span></span>`}_setOverviewTab(t){this._overviewTab=t;try{Z(P.overviewTab,t)}catch{}this._scrollContentToTop()}_renderToday(){let t=this._lang,e=this._taskRows,i=d=>`${d.entry_id}:${d.task_id}`,s=e.filter(d=>d.status==="overdue"||d.trigger_active),c=new Set(s.map(i)),p=e.filter(d=>!c.has(i(d))&&d.days_until_due===0);p.forEach(d=>c.add(i(d)));let l=e.filter(d=>!c.has(i(d))&&d.days_until_due!=null&&d.days_until_due>0&&d.days_until_due<=7);return s.length+p.length+l.length===0?r`
    ...
    `}_setObjectViewMode(t){this._objectViewMode=t;try{Z(P.objectView,t)}catch{}}_renderAllParts(){let t=this._lang,e=this._allParts,i=this._currencySymbol;return r`
      <div class="breadcrumb">
...
`),`maintenance_parts_${c}.csv`,"text/csv;charset=utf-8")}async _exportObjectsCsv(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects/csv"}),e=new Date().toISOString().slice(0,10);ve(t.csv,`maintenance_objects_${e}.csv`,"text/csv;charset=utf-8")}catch{this._showToast(a("action_error",this._lang))}}_renderObjectsTable(t){let e=this._lang,i=this._objectsTableColumns;return r`
      <div class="objects-table-wrap">
        <table class="objects-table">
          <thead>
            <tr>
              ${i.map(s=>{let c=Le.find(l=>l.key===s),p=c&&c.key!=="actions"?a(c.labelKey,e):"";return r`<th class="oc-${s}">${p}</th>`})}
            </tr>
          </thead>
          <tbody>
            ${t.map(s=>r`
    ...
    `}_renderOverviewRow(t){let e=this._lang,i=t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0,s=0,c=Yt.ok,p=!1;if(i&&t.days_until_due!==null){let f=te(t.interval_days,t.days_until_due,t.interval_unit);s=f.pct,p=f.overflow,t.status==="overdue"?c=Yt.overdue:t.status==="due_soon"&&(c=Yt.due_soon)}let l=t.area_id?this.hass?.areas?.[t.area_id]?.name:null,d=t.responsible_user_id?this._userService?.getUserName(t.responsible_user_id):null,u=t.group_names.length>0||l||d,_=this._bulkMode&&this._bulkSelected.has(this._bulkKey(t));return r`
      <div class="task-row${t.enabled?"":" task-disabled"}${_?" bulk-selected":""}${this._splitActive()&&t.entry_id===this._selectedEntryId&&t.task_id===this._selectedTaskId?" selected":""}">
        ...
        <span class="task-sub${u?"":" task-sub-empty"}">
          ...
          ${d?be(this._userService?.getPerson(t.responsible_user_id)??null,"sub-chip"):h}
          ${(t.labels||[]).map(f=>r`
      ...
      <div class="detail-section">
        ...
        ${t.tasks.length===0?r`<div class="empty-state-centered">
              ...
              <div class="task-row${l.enabled?"":" task-disabled"}">
                ...
                <span class="task-sub${l.responsible_user_id?"":" task-sub-empty"}">${Re(l,d=>this._userService?.getUserName(d)??null,d=>this._userService?.getPerson(d)??null)}</span>
                ...
                <span class="due-cell" @click=${()=>this._showTask(t.entry_id,l.id)}>
                  ...
                  ${l.trigger_config?je(l,{trend:Se(l,this._miniStatsData),lang:i}):h}
                  ${Ee(l,this._miniStatsData,this._lang)}
                </span>
