  ...
  `,p([b({attribute:!1})],ie.prototype,"hass",2),p([_()],ie.prototype,"_open",2),p([_()],ie.prototype,"_loading",2),p([_()],ie.prototype,"_adopting",2),p([_()],ie.prototype,"_error",2),p([_()],ie.prototype,"_setups",2),p([_()],ie.prototype,"_selected",2),p([_()],ie.prototype,"_baselines",2),p([_()],ie.prototype,"_targets",2),p([_()],ie.prototype,"_objects",2);customElements.get("maintenance-suggested-setups-dialog")||customElements.define("maintenance-suggested-setups-dialog",ie);var ae=class extends S{constructor(){super(...arguments);this._ov=null;this._loading=!1;this._marking=!1;this._error="";this._history=null;this._rosterSort="name";this._typeFilter=null;this._recorded=[];this._historyRequested=!1;this._localeReady=!1;this._markAll=async()=>{await this._mark(void 0)};this._repair=async()=>{if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/setup",language:this._lang}),await this._load()}catch(e){this._error=j(e,this._lang)}finally{this._marking=!1}}};this._loadHistory=async e=>{if(!(!e.target.open||this._historyRequested)){this._historyRequested=!0;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview_history"});this._history=t.series}catch{this._history=null}}}}get _lang(){return this.hass?.language||"en"}connectedCallback(){super.connectedCallback(),this.hass&&this._load()}updated(e){e.has("hass")&&this.hass&&!this._localeReady&&(this._localeReady=!0,W(this._lang).then(()=>this.requestUpdate()),this._ov===null&&!this._loading&&this._load())}async _load(){this._loading=!0,this._error="";try{this._ov=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview"})}catch(e){this._error=j(e,this._lang)}finally{this._loading=!1}}async _mark(e){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/mark_replaced",...e?{entity_ids:e}:{}}),await this._load()}catch(t){this._error=j(t,this._lang)}finally{this._marking=!1}}}async _setExcluded(e,t){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/set_excluded",entity_id:e,excluded:t}),await this._load()}catch(i){this._error=j(i,this._lang)}finally{this._marking=!1}}}_sparkline(e){let t=this._history?.[e.entity_id];if(!t||t.points.length<2)return h;let i=110,a=24,l=2,c=t.points[0][0],d=t.points[t.points.length-1][0],u=Date.now()/1e3,g=e.status!=="low"&&e.predicted_source==="trend"&&e.days_until!=null?u+e.days_until*86400:null,m=Math.max(d,g??d),v=L=>m===c?l:l+(L-c)/(m-c)*(i-2*l),f=L=>l+(1-Math.min(100,Math.max(0,L))/100)*(a-2*l),$=t.points.map(([L,N])=>`${v(L).toFixed(1)},${f(N).toFixed(1)}`).join(" "),x=t.points[t.points.length-1][1],M=f(t.threshold).toFixed(1);return o`<svg
    ...
    >
      ...
      ${g!==null?o`<line
            ...
            y2=${M}
          ></line>`:h}
    </svg>`}_sortedRoster(e){let t=this._typeFilter===null?e:e.filter(a=>a.battery_type===this._typeFilter);if(this._rosterSort==="name")return t;let i=a=>a.status==="low"?-1:a.days_until??1/0;return[...t].sort((a,l)=>i(a)-i(l)||a.device_name.localeCompare(l.device_name))}_predictedDate(e){return this._fmtDate(Date.now()+e*864e5)}_fmtDate(e){return new Intl.DateTimeFormat(this._lang,{day:"numeric",month:"numeric",year:"numeric"}).format(new Date(e))}_shoppingLine(e){return Object.entries(e).map(([t,i])=>o`<button
...
`;var re=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){if(this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter),typeof e.object_filter=="string")this._objectFilter=e.object_filter,this._configuredObjects=[];else if(Array.isArray(e.object_filter)){let t=e.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=t.length===1?t[0]:"",this._configuredObjects=t.length>1?t:[]}}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){super.updated(e),e.has("hass")&&vt(this.hass?.locale);let t=this.hass?.language;if(t&&!mt(t)&&W(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}_onEventClick(e){if(e.history_timestamp){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,l=null;this._userFilter&&(l=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let c=w=>{let Q=w.toLowerCase();return this._objects.find(F=>F.entry_id===w||F.object.name.toLowerCase()===Q)?.entry_id??null},d=new Set(this._configuredObjects.map(c).filter(w=>w!==null)),u=d.size?this._objects.filter(w=>d.has(w.entry_id)):this._objects,g=this._config.show_object_filter!==!1&&u.length>1,m=this._objectFilter?c(this._objectFilter):null,v=m&&u.some(w=>w.entry_id===m)?u.filter(w=>w.entry_id===m):u,f=new Date;f.setHours(0,0,0,0);let $=this._pastDays>0,x=$?Di(v,f,this._pastDays,l):Oi(v,f,this._windowDays,l),M=st(f),L=this._windowDays===365||$,N=L?x.filter(w=>w.events.length>0):x,O=w=>{let Q=`cal-status-${w.status}`,Z=w.projected?"cal-event-projected":"",F=w.status==="overdue"&&w.days_until_due!=null?` (${Te(w.days_until_due,e)})`:"",D=w.projected&&w.interval_days?o`<span class="cal-event-recur">${w.interval_unit&&w.interval_unit!=="days"?`${w.interval_days} ${s("unit_"+w.interval_unit,e)}`:s("cal_every_n_days",e).replace("{n}",String(w.interval_days))}</span>`:h,ee=w.schedule_type==="sensor_based",pe=ee?o`<ha-icon class="cal-event-icon cal-source-sensor"
      ...
      `},C=w=>{let[Q,Z,F]=w.date.split("-").map(Number),D=new Date(Q,Z-1,F),ee=w.date===M,pe=D.toLocaleDateString(e,{weekday:"short"}),_e=D.toLocaleDateString(e,{month:"long"});return o`
    ...
    `],p([b({attribute:!1})],re.prototype,"hass",2),p([_()],re.prototype,"_config",2),p([_()],re.prototype,"_objects",2),p([_()],re.prototype,"_stats",2),p([_()],re.prototype,"_windowDays",2),p([_()],re.prototype,"_pastDays",2),p([_()],re.prototype,"_userFilter",2),p([_()],re.prototype,"_objectFilter",2),p([_()],re.prototype,"_unsub",2);var ia=[{value:7,label:"Week (7 days)"},{value:14,label:"Fortnight (14 days)"},{value:30,label:"Month (30 days, default)"},{value:365,label:"Year (365 days, empty days collapsed)"}],He=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}setConfig(e){this._config={...e}}_valueChanged(e,t){let i={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete i.show_window_chips,e==="show_user_filter"&&t===!0&&delete i.show_user_filter,e==="show_object_filter"&&t===!0&&delete i.show_object_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete i.title,e==="user_filter"&&t===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let e=this._config.window_days??30,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.user_filter??"",l=this._config.title??"";return o`
      <div class="editor">
        <div class="row">
...
<body>
  ...
  `}function ga(n,r,e,t,i){let f=Math.max(e,t,r,1)*1.3,$=50,x=[];for(let F=0;F<=$;F++){let D=F/$*f,ee=1-Math.exp(-Math.pow(D/r,n)),pe=32+D/f*260,_e=136-ee*128;x.push([pe,_e])}let M=x.map(([F,D])=>`${F.toFixed(1)},${D.toFixed(1)}`).join(" "),L="M32,136 "+x.map(([F,D])=>`L${F.toFixed(1)},${D.toFixed(1)}`).join(" ")+` L${x[$][0].toFixed(1)},136 Z`,N=32+e/f*260,O=1-Math.exp(-Math.pow(e/r,n)),C=136-O*128,w=((1-O)*100).toFixed(0),Q=32+t/f*260,Z=[0,.25,.5,.75,1];return o`
  ...
  `}function Sa(n,r){let e=ce(n.documentation_url)?n.documentation_url:null,t=ce(r.objectDocUrl)?r.objectDocUrl:null,i=t?null:(r.objectManualDocs||[])[0];if(!n.notes&&!e&&!t&&!i)return h;let a=r.lang;return o`
