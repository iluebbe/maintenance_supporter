...
`;var Et=class{constructor(r){this._cache=new Map;this._pending=new Map;this._hass=r}updateHass(r){this._hass=r}async getDetailStats(r,e,t=30){return this._getStats(r,t<=35?"hour":"day",t,e)}async getMiniStats(r,e){return this._getStats(r,"day",14,e)}async getBatchMiniStats(r){let e=new Map,t=[];for(let d of r){let u=`${d.entityId}:day:14`,g=this._cache.get(u);g&&Date.now()-g.fetchedAt<3e5?e.set(d.entityId,g.points):t.push(d)}if(t.length===0)return e;let i=t.filter(d=>d.isCounter).map(d=>d.entityId),a=t.filter(d=>!d.isCounter).map(d=>d.entityId),l=new Date(Date.now()-336*60*60*1e3).toISOString(),c=[];return i.length>0&&c.push(this._fetchBatch(i,"day",l,["state","sum","change"],!0,e)),a.length>0&&c.push(this._fetchBatch(a,"day",l,["mean","min","max"],!1,e)),await Promise.all(c),e}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(r,e,t,i){let a=`${r}:${e}:${t}`,l=this._cache.get(a);if(l&&Date.now()-l.fetchedAt<3e5)return l.points;if(this._pending.has(a))return this._pending.get(a);let c=this._fetchAndNormalize(r,e,t,i,a);this._pending.set(a,c);try{return await c}finally{this._pending.delete(a)}}async _fetchAndNormalize(r,e,t,i,a){let l=new Date(Date.now()-t*24*60*60*1e3).toISOString(),c=i?["state","sum","change"]:["mean","min","max"];try{let u=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:l,statistic_ids:[r],period:e,types:c}))[r]||[],g=this._normalizeRows(u,i);return this._cache.set(a,{entityId:r,fetchedAt:Date.now(),period:e,points:g}),g}catch(d){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${r}:`,d),[]}}async _fetchBatch(r,e,t,i,a,l){try{let c=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:t,statistic_ids:r,period:e,types:i});for(let d of r){let u=c[d]||[],g=this._normalizeRows(u,a);l.set(d,g),this._cache.set(`${d}:${e}:14`,{entityId:d,fetchedAt:Date.now(),period:e,points:g})}}catch(c){console.warn("[maintenance-supporter] Batch statistics fetch failed:",c)}}_normalizeRows(r,e){let t=[];for(let i of r){let a=null;if(e?a=i.state??null:a=i.mean??null,a===null)continue;let l={ts:i.start,val:a};e||(i.min!=null&&(l.min=i.min),i.max!=null&&(l.max=i.max)),t.push(l)}return t.sort((i,a)=>i.ts-a.ts),t}};var _e=class{constructor(r){this.usersCache=null;this.cacheTimestamp=0;this.CACHE_TTL_MS=6e4;this.hass=r}updateHass(r){this.hass=r}async getUsers(r=!1){let e=Date.now();if(!r&&this.usersCache&&e-this.cacheTimestamp<this.CACHE_TTL_MS)return this.usersCache;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/users/list"});return this.usersCache=t.users,this.cacheTimestamp=e,this.usersCache}catch(t){return console.error("Failed to fetch users:",t),this.usersCache||[]}}async assignUser(r,e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/assign_user",entry_id:r,task_id:e,user_id:t})}async getTasksByUser(r){return(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tasks/by_user",user_id:r})).tasks}getUserName(r){return!r||!this.usersCache?null:this.usersCache.find(t=>t.id===r)?.name||null}getUser(r){return!r||!this.usersCache?null:this.usersCache.find(e=>e.id===r)||null}getCurrentUserId(){return this.hass.user?.id||null}isCurrentUser(r){return r?r===this.getCurrentUserId():!1}clearCache(){this.usersCache=null,this.cacheTimestamp=0}};var J=class extends S{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return o`
  ...
  `,p([b({attribute:!1})],te.prototype,"hass",2),p([b({attribute:!1})],te.prototype,"entryId",2),p([b({attribute:!1})],te.prototype,"taskId",2),p([b({attribute:!1})],te.prototype,"partId",2),p([b({type:Boolean})],te.prototype,"canWrite",2),p([_()],te.prototype,"_docs",2),p([_()],te.prototype,"_loaded",2),p([_()],te.prototype,"_busy",2),p([_()],te.prototype,"_error",2),p([_()],te.prototype,"_attachId",2);customElements.get("maintenance-task-documents")||customElements.define("maintenance-task-documents",te);var Hs={name:"",vendor:"",mpn:"",gtin:"",storage_location:"",product_url:"",unit:"",cost:"",stock:"",reorder_threshold:"",restock_quantity:"",auto_buy_task:!0,notes:""},X=class extends S{constructor(){super(...arguments);this.parts=[];this.canWrite=!1;this._editing=null;this._busy=!1;this._error="";this._restockFor=null;this._restockQty="";this._restockInvalid=!1;this._docsFor=null}get _lang(){return this.hass?.locale?.language||this.hass?.language||"en"}connectedCallback(){super.connectedCallback(),W(this._lang).then(()=>this.requestUpdate())}_notifyChanged(){this.dispatchEvent(new CustomEvent("parts-changed",{bubbles:!0,composed:!0}))}async _send(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e)}catch(t){return this._error=A(t,this._lang),null}finally{this._busy=!1}}_openAdd(){this._editing={...Hs}}_openEdit(e){this._editing={id:e.id,name:e.name,vendor:e.vendor||"",mpn:e.mpn||"",gtin:e.gtin||"",storage_location:e.storage_location||"",product_url:e.product_url||"",unit:e.unit||"",cost:e.cost!=null?String(e.cost):"",stock:e.stock!=null?String(e.stock):"",reorder_threshold:e.reorder_threshold!=null?String(e.reorder_threshold):"",restock_quantity:e.restock_quantity!=null?String(e.restock_quantity):"",auto_buy_task:!!e.auto_buy_task,notes:e.notes||""}}_formValue(e){let t=i=>i.trim()===""?null:Number(i);return{entry_id:this.entryId,name:e.name.trim(),vendor:e.vendor.trim()||null,mpn:e.mpn.trim()||null,gtin:e.gtin.trim()||null,storage_location:e.storage_location.trim()||null,product_url:e.product_url.trim()||null,unit:e.unit.trim()||null,cost:t(e.cost),stock:t(e.stock),reorder_threshold:t(e.reorder_threshold),restock_quantity:t(e.restock_quantity),auto_buy_task:e.auto_buy_task,notes:e.notes.trim()||null}}async _save(){let e=this._editing;if(!e||!e.name.trim())return;let t=this._formValue(e),i=e.id?"maintenance_supporter/part/update":"maintenance_supporter/part/create";await this._send(e.id?{type:i,part_id:e.id,...t}:{type:i,...t})!==null&&(this._editing=null,this._notifyChanged())}async _delete(e){if(!window.confirm(s("part_delete_confirm",this._lang).replace("{name}",e.name)))return;await this._send({type:"maintenance_supporter/part/delete",entry_id:this.entryId,part_id:e.id})!==null&&this._notifyChanged()}async _restock(e){let t=parseFloat(this._restockQty);if(!Number.isFinite(t)||t===0){this._restockInvalid=!0;return}this._restockInvalid=!1;let i=await this._send({type:"maintenance_supporter/part/restock",entry_id:this.entryId,part_id:e.id,delta:t});this._restockFor=null,i!==null&&(e.stock=i.stock,this.requestUpdate(),this._notifyChanged())}_identLine(e){return[e.vendor,e.mpn?`MPN: ${e.mpn}`:"",e.gtin?`GTIN: ${e.gtin}`:""].filter(Boolean).join(" \xB7 ")}_renderRow(e){let t=this._lang,i=e.stock!==null&&e.stock!==void 0,a=this._identLine(e),l=this._docsFor===e.id;return o`
    ...
    `}render(){let e=this._lang;return!this.parts.length&&!this.canWrite?h:o`
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?o`<div class="used-parts">
                ...
                ${this.parts.map(t=>{let i=Te({part_id:t.id,entry_id:t.entry_id}),a=this._usedParts[i],l=a!==void 0,c=t.entry_id?{part_id:t.id,quantity:1,entry_id:t.entry_id}:{part_id:t.id,quantity:1};return o`<div class="used-part-row">
...
`;var ae=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){if(this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter),typeof e.object_filter=="string")this._objectFilter=e.object_filter,this._configuredObjects=[];else if(Array.isArray(e.object_filter)){let t=e.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=t.length===1?t[0]:"",this._configuredObjects=t.length>1?t:[]}}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){super.updated(e),e.has("hass")&&vt(this.hass?.locale);let t=this.hass?.language;if(t&&!mt(t)&&W(t).then(()=>this.requestUpdate()),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}_onEventClick(e){if(e.history_timestamp){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,l=null;this._userFilter&&(l=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let c=w=>{let Q=w.toLowerCase();return this._objects.find(N=>N.entry_id===w||N.object.name.toLowerCase()===Q)?.entry_id??null},d=new Set(this._configuredObjects.map(c).filter(w=>w!==null)),u=d.size?this._objects.filter(w=>d.has(w.entry_id)):this._objects,g=this._config.show_object_filter!==!1&&u.length>1,m=this._objectFilter?c(this._objectFilter):null,v=m&&u.some(w=>w.entry_id===m)?u.filter(w=>w.entry_id===m):u,f=new Date;f.setHours(0,0,0,0);let $=this._pastDays>0,x=$?Di(v,f,this._pastDays,l):Oi(v,f,this._windowDays,l),M=st(f),L=this._windowDays===365||$,F=L?x.filter(w=>w.events.length>0):x,O=w=>{let Q=`cal-status-${w.status}`,Z=w.projected?"cal-event-projected":"",N=w.status==="overdue"&&w.days_until_due!=null?` (${Ee(w.days_until_due,e)})`:"",D=w.projected&&w.interval_days?o`<span class="cal-event-recur">${w.interval_unit&&w.interval_unit!=="days"?`${w.interval_days} ${s("unit_"+w.interval_unit,e)}`:s("cal_every_n_days",e).replace("{n}",String(w.interval_days))}</span>`:h,ee=w.schedule_type==="sensor_based",de=ee?o`<ha-icon class="cal-event-icon cal-source-sensor"
                ...
                icon="${w.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,ue=ee&&w.prediction_confidence&&w.status!=="triggered"&&!w.projected?o`<span class="cal-event-prediction cal-conf-${w.prediction_confidence}">
            ${s("cal_predicted",e)} · ${s(`cal_confidence_${w.prediction_confidence}`,e)}
          </span>`:h,G=this._stats?.budget?.currency_symbol||Me,E=w.history_type?s(w.history_type,e):s(w.status,e);return o`
        <div class="cal-event ${Z}"
          @click=${()=>this._onEventClick(w)}>
          ${de}
          <span class="cal-status-pill ${Q}">${E}</span>
          <div class="cal-event-body">
            <div class="cal-event-title">${w.object_name} · ${w.task_name}${N}</div>
            ${ue}
            ${D}
          </div>
          ${w.avg_cost!=null&&w.avg_cost>0?o`<span class="cal-event-cost">${w.avg_cost.toFixed(0)} ${G}</span>`:h}
        </div>
      `},C=w=>{let[Q,Z,N]=w.date.split("-").map(Number),D=new Date(Q,Z-1,N),ee=w.date===M,de=D.toLocaleDateString(e,{weekday:"short"}),ue=D.toLocaleDateString(e,{month:"long"});return o`
...
<body>
  ...
  `}function rt(n,r,e=4){if(!isFinite(n)||!isFinite(r))return{ticks:[],niceMin:0,niceMax:1};if(n===r){let u=Math.abs(n)*.1||1;n-=u,r+=u}let t=r-n,i=Math.pow(10,Math.floor(Math.log10(t/Math.max(1,e)))),a=i;for(let u of[1,2,5,10])if(a=i*u,t/a<=e+.5)break;let l=Math.floor(n/a)*a,c=Math.ceil(r/a)*a,d=[];for(let u=l;u<=c+a*1e-6;u+=a)d.push(Math.abs(u)<a*1e-9?0:u);return{ticks:d,niceMin:l,niceMax:c}}function ve(n){let r=Math.abs(n);return r>=1e6?qe((n/1e6).toFixed(r>=1e7?0:1))+"M":r>=1e4?qe((n/1e3).toFixed(0))+"k":r>=1e3?qe((n/1e3).toFixed(1))+"k":r>=100?n.toFixed(0):r>=10||r>=1?qe(n.toFixed(1)):r===0?"0":qe(n.toFixed(2))}function qe(n){return n.replace(/\.0+$/,"").replace(/(\.\d*[1-9])0+$/,"$1")}function Pe(n,r,e){let t=n.toLocaleString(e,{maximumFractionDigits:Math.abs(n)>=100?0:1});return r?`${t} ${r}`:t}function Ne(n,r,e){let t=new Date(n),i=e?{month:"short",day:"numeric",year:"2-digit"}:{month:"short",day:"numeric"};return t.toLocaleDateString(r,i)}function ti(n,r){return new Date(n).toLocaleDateString(r,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}function Rt(n,r){return new Date(n).getFullYear()!==new Date(r).getFullYear()}function Mt(n,r,e){if(e<2||r<=n)return[n,r];let t=[];for(let i=0;i<e;i++)t.push(n+(r-n)*i/(e-1));return t}var Lt=210,he=46,we=14,$e=12,Wi=14,la=20+Wi,ca=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],Y=class extends S{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(e=>{let t=Math.floor(e[0]?.contentRect?.width||0);t&&Math.abs(t-this._width)>2&&(this._width=t)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(e){e!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:e},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let e=this._width||320,t=[...this.points].sort((a,l)=>a.ts-l.ts),i=this.lang;return o`
    ...
    `}_renderSvg(e,t){let i=this.lang,a=e-he-we,l=Lt-la,c=l-$e,d=1/0,u=-1/0;for(let E of t)d=Math.min(d,E.min??E.val),u=Math.max(u,E.max??E.val);this.thresholdAbove!=null&&(d=Math.min(d,this.thresholdAbove),u=Math.max(u,this.thresholdAbove)),this.thresholdBelow!=null&&(d=Math.min(d,this.thresholdBelow),u=Math.max(u,this.thresholdBelow)),this.targetValue!=null&&(d=Math.min(d,this.targetValue),u=Math.max(u,this.targetValue)),this.forceZero&&(d=Math.min(d,0));let g=(u-d||1)*.06,m=this.forceZero&&d>=0?0:d-g,{ticks:v,niceMin:f,niceMax:$}=rt(m,u+g,4);this.forceZero&&d>=0&&f<0&&(f=0,v=v.filter(E=>E>=0));let x=t[0].ts,M=t[t.length-1].ts,L=M-x||1,F=Rt(x,M),O=E=>he+(E-x)/L*a,C=E=>$e+(1-(E-f)/($-f||1))*c,w=t.map(E=>`${O(E.ts).toFixed(1)},${C(E.val).toFixed(1)}`).join(" "),Q=`M${O(t[0].ts).toFixed(1)},${l} `+t.map(E=>`L${O(E.ts).toFixed(1)},${C(E.val).toFixed(1)}`).join(" ")+` L${O(t[t.length-1].ts).toFixed(1)},${l} Z`,Z="",N=t.filter(E=>E.min!=null&&E.max!=null);if(N.length>=2){let E=N.map(I=>`${O(I.ts).toFixed(1)},${C(I.max).toFixed(1)}`),k=[...N].reverse().map(I=>`${O(I.ts).toFixed(1)},${C(I.min).toFixed(1)}`);Z=`M${E[0]} `+E.slice(1).map(I=>`L${I}`).join(" ")+` L${k.join(" L")} Z`}let D=[];if(this.thresholdBelow!=null){let E=C(this.thresholdBelow);D.push({y:E,h:Math.max(0,l-E),lineY:E,label:`\u25BC ${ve(this.thresholdBelow)}`,labelY:Math.min(l-4,E+13)})}if(this.thresholdAbove!=null){let E=C(this.thresholdAbove);D.push({y:$e,h:Math.max(0,E-$e),lineY:E,label:`\u25B2 ${ve(this.thresholdAbove)}`,labelY:Math.max($e+11,E-5)})}let ee=t[t.length-1],de=(this.events||[]).filter(E=>E.ts>=x&&E.ts<=M),ue=Mt(x,M,Math.max(2,Math.min(5,Math.floor(a/110)+1))),G=this._hover;return o`
      <div class="svg-holder">
        ...
        >
          <defs>
            <clipPath id="plot"><rect x="${he}" y="${$e}" width="${a}" height="${c}" /></clipPath>
          ...
          ${v.map(E=>{let k=C(E);return k<$e-1||k>l+1?h:H`
              <line x1="${he}" y1="${k.toFixed(1)}" x2="${e-we}" y2="${k.toFixed(1)}"
          ...
          ${D.map(E=>H`
              <line x1="${he}" y1="${E.lineY.toFixed(1)}" x2="${e-we}" y2="${E.lineY.toFixed(1)}"
          ...
          ${this.targetValue!=null?H`<line x1="${he}" y1="${C(this.targetValue).toFixed(1)}" x2="${e-we}" y2="${C(this.targetValue).toFixed(1)}"
                stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="6,4" />
              <text x="${e-we-4}" y="${(C(this.targetValue)-5).toFixed(1)}" text-anchor="end" class="zone-label">◆ ${ve(this.targetValue)} ${this.unit}</text>`:h}

          ${this.projection&&this.projection.length===2?H`<line x1="${O(this.projection[0].ts).toFixed(1)}" y1="${C(this.projection[0].val).toFixed(1)}"
                x2="${Math.min(O(this.projection[1].ts),e-we).toFixed(1)}" y2="${C(Math.max(f,Math.min($,this.projection[1].val))).toFixed(1)}"
          ...
          <line x1="${he}" y1="${l}" x2="${e-we}" y2="${l}" stroke="var(--divider-color)" stroke-width="1" />
          ...
          ${de.map(E=>{let k=O(E.ts),I=E.type==="completed"?"var(--success-color, #4caf50)":E.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return H`
              <line x1="${k.toFixed(1)}" y1="${$e}" x2="${k.toFixed(1)}" y2="${l}" stroke="${I}" stroke-width="1" opacity="0.14" />
    ...
    `}_onPointer(e,t,i,a,l){let d=e.currentTarget.getBoundingClientRect(),u=(e.clientX-d.left)/d.width*l;if(u<he-8||u>l-we+8){this._hover=null;return}let g=t[0],m=1/0;for(let v of t){let f=Math.abs(i(v.ts)-u);f<m&&(m=f,g=v)}this._hover={x:i(g.ts),y:a(g.val),p:g}}};Y.styles=j`
  ...
  `}function ga(n,r,e,t,i){let f=Math.max(e,t,r,1)*1.3,$=50,x=[];for(let N=0;N<=$;N++){let D=N/$*f,ee=1-Math.exp(-Math.pow(D/r,n)),de=32+D/f*260,ue=136-ee*128;x.push([de,ue])}let M=x.map(([N,D])=>`${N.toFixed(1)},${D.toFixed(1)}`).join(" "),L="M32,136 "+x.map(([N,D])=>`L${N.toFixed(1)},${D.toFixed(1)}`).join(" ")+` L${x[$][0].toFixed(1)},136 Z`,F=32+e/f*260,O=1-Math.exp(-Math.pow(e/r,n)),C=136-O*128,w=((1-O)*100).toFixed(0),Q=32+t/f*260,Z=[0,.25,.5,.75,1];return o`
  ...
  `}function ts(n,r){return fa(n,r)}function fa(n,r){let e=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return h;let t=n.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,l=100,c=8,u=l-c-4,g=Math.max(...e,1.5),m=a/12,v=m*.65,f=c+u-1/g*u;return o`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${a} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",r)}">
        ...
        ${e.map(($,x)=>{let M=$/g*u,L=x*m+(m-v)/2,F=c+u-M,O=x===i,C=$<1?"var(--success-color, #4caf50)":$>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return H`
  ...
  `}function xa(n,r,e){let t=n.history.filter(k=>k.type==="completed"&&(k.cost!=null||k.duration!=null)).map(k=>({ts:new Date(k.timestamp).getTime(),cost:k.cost??0,duration:k.duration??0})).sort((k,I)=>k.ts-I.ts);if(t.length<2)return h;let i=t.some(k=>k.cost>0),a=t.some(k=>k.duration>0);if(!i&&!a)return h;let l=e!=="duration"&&i,c=e!=="cost"&&a,d=l||!c&&i,u=c||!l&&a,g=640,m=ba,v=d?44:12,f=u?44:12,$=g-v-f,x=m-ya,M=x-nt,L=t[0].ts,F=t[t.length-1].ts,O=(F-L||864e5)*.05,C=L-O,w=F+O,Q=Rt(L,F),Z=k=>v+(k-C)/(w-C)*$,N=rt(0,Math.max(...t.map(k=>k.cost))||1,3),D=rt(0,Math.max(...t.map(k=>k.duration))||1,3),ee=k=>nt+(1-k/(N.niceMax||1))*M,de=k=>nt+(1-k/(D.niceMax||1))*M,ue=t.length>1?Math.min(...t.slice(1).map((k,I)=>Z(k.ts)-Z(t[I].ts))):$,G=Math.max(6,Math.min(22,ue*.55)),E=Mt(L,F,Math.max(2,Math.min(4,t.length)));return o`
  ...
  `,p([b({attribute:!1})],Se.prototype,"hass",2),p([b()],Se.prototype,"docId",2),p([_()],Se.prototype,"_url",2),p([_()],Se.prototype,"_failed",2);customElements.get("maintenance-history-photo")||customElements.define("maintenance-history-photo",Se);var wa=["completed","skipped","missed","reset","triggered"];function ss(n,r){let e=r.lang;return o`
  ...
  `}function as(n,r){let e=r.lang,t=r.filter?n.history.filter(i=>i.type===r.filter):n.history;if(r.search){let i=r.search.toLowerCase();t=t.filter(a=>a.notes?.toLowerCase().includes(i))}return t.length===0?o`<p class="empty">${s("no_history",e)}</p>`:o`
    <div class="history-timeline">
      ${[...t].reverse().map(i=>$a(i,r))}
    </div>
  `}function $a(n,r){let e=r.lang,t=["completed","reset","skipped"].includes(n.type);return o`
  ...
  `}function Ta(n,r){if(!r.features.checklists)return h;let e=n.checklist||[];if(e.length===0)return h;let t=r.lang;return o`
        ...
        ${t.map(l=>o`
          <div class="today-row" @click=${()=>this._showTask(l.entry_id,l.task_id)}>
            ...
            <div class="today-main">
              ...
              <div class="today-object">${l.object_name} · ${Ee(l.days_until_due,a)}</div>
            </div>
        ...
        ${e.tasks.length===0?o`<div class="empty-state-centered">
              ...
              <div class="task-row${d.enabled?"":" task-disabled"}">
                ...
                <span class="due-cell" @click=${()=>this._showTask(e.entry_id,d.id)}>
                  <span class="due-text">${Ee(d.days_until_due,i)}</span>
