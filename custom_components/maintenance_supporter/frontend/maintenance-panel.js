...
import{a as Fe,b as qe,c as Ve,g as Ye}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-TDVOIIK7.js";import{A as pi,B as hi,C as ui,D as gi,E as mi,L as vi,O as bi,a as at,b as Gt,c as Ct,d as yt,e as xt,f as Yt,g as Dt,h as ee,i as We,j as Ge,k as ie,l as Qe,m as Je,n as E,o as Ft,p as vt,q as Et,r as Pt,s as be,t as se,u as ae,v as ri,w as ni,x as li,y as ci,z as di}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-HV4JFQPJ.js";import{a as Ne,b as Xt,c as wt,d as Zt,e as Nt,f as te,g as qt,h as ai,i as oi,k as _i}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-FDOKI5FN.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-ERENYWWQ.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-SH7WJANN.js";import{a as fe}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-VI42MUHE.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-QB3AP3PO.js";import{a as D,b as Z,c as G,d as ti,e as ei,f as ii,g as si}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-O5Q52ID5.js";import{b as Ue,h as Ke}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-OARKRON5.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-2VZFJ6FV.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-MLBPUQ4T.js";import{a as _e}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-X7QLZGHR.js";import{c as Xe,d as ve,e as Ze}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-BWGRIMYL.js";import{a as A}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-PYT5YCWU.js";import{A as Q,B as ze,C as jt,E as Ht,H as Le,I as He,K as St,L as Bt,M as Be,O as Jt,a as g,b as L,c as o,d as J,f as h,h as H,i as me,j as De,k as Ae,l as S,m,n as Kt,o as Pe,p as Qt,q as a,r as At,s as U,t as Ie,u as ot,v as Lt,x as it,y as K}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-F5VN7KSV.js";var Gi=["assignee_pool","required_completion_fields","checklist","labels","mirror_todo_entities","next_event_titles","history","readings"],Yi=["checklist_progress"],Ki=["tasks","parts"],Qi=["manual_docs","battery_fleet_excluded"];function ye(l,c,t=[]){for(let e of c)l[e]===void 0&&(l[e]=[]);for(let e of t)l[e]===void 0&&(l[e]={})}function Ji(l){let c=l;ye(c,Ki),c.object&&typeof c.object=="object"&&ye(c.object,Qi);for(let t of c.tasks)ye(t,Gi,Yi);return l}function Vt(l){for(let c of l)Ji(c);return l}function Xi(l,c){if(c.objects)return c.objects;let t=c.delta||[],e=c.removed||[];if(!t.length&&!e.length)return null;let i=new Map(l.map(s=>[s.entry_id,s]));for(let s of t)i.set(s.entry_id,s);for(let s of e)i.delete(s);return[...i.values()]}function fi(l,c){return c.objects&&Vt(c.objects),c.delta&&Vt(c.delta),Xi(l,c)}var xe=["today","dashboard","calendar","settings"];var Zi=168*3600*1e3;function yi(){try{let l=Z(D.objectsCache);if(!l)return null;let c=JSON.parse(l);return c.v!==me||!Number.isFinite(c.at)||Date.now()-c.at>Zi||!Array.isArray(c.objects)||c.objects.length===0?null:{objects:c.objects,stats:c.stats??null}}catch{return null}}function we(l,c){if(!(!Array.isArray(l)||l.length===0))try{let t={v:me,at:Date.now(),objects:l,stats:c};G(D.objectsCache,JSON.stringify(t))}catch{}}function B(l){return String(l??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}function xi(l,c,t,e,i,s){let n=[[t.manufacturer,l.manufacturer],[t.model,l.model],[t.serial,l.serial_number],[t.installed,l.installation_date?e(l.installation_date):null],[t.warranty,l.warranty_expiry?e(l.warranty_expiry):null]].filter(([,p])=>!!p),d=c.map(p=>{let u=t.scheduleLabel(p);return`<tr>
      <td>${B(p.name)}</td>
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  <h1>${B(l.name)}</h1>
  <p class="sub">${B(t.title)} \xB7 ${B(t.generated)}: ${B(e(s))}</p>
...
${B(l.notes)}</div>`:""}
</body></html>`}function ke(l,c=new Date){if(!l)return{kind:"none",days:null,date:null};let t=new Date(`${l}T00:00:00`);if(isNaN(t.getTime()))return{kind:"none",days:null,date:null};let e=Date.UTC(c.getFullYear(),c.getMonth(),c.getDate()),i=Date.UTC(t.getFullYear(),t.getMonth(),t.getDate()),s=Math.round((i-e)/864e5);return s<0?{kind:"expired",days:s,date:l}:s<=60?{kind:"expiring",days:s,date:l}:{kind:"valid",days:s,date:l}}var q=l=>String(l??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c]);function wi(l,c,t,e,i,s,n,d,r,p=[],u=null){let v=[[t.object,q(c)],[t.type,q(t.typeLabel(l.type))],[t.interval,q(i(l))],[t.nextDue,l.next_due?q(e(l.next_due)):"\u2014"],[t.lastDone,l.last_performed?q(e(l.last_performed)):q(t.never)]];l.priority&&l.priority!=="normal"&&v.push([t.priority,q(l.priority)]);let _=(l.checklist||[]).map(f=>`<li><span class="box"></span>${q(f)}</li>`).join(""),b=(f,R)=>f?`<figure class="qr"><img src="${f}" alt="" /><figcaption>${q(R)}</figcaption></figure>`:"";return`<!DOCTYPE html>
...
</body></html>`}function It(l){let c=(l??[]).filter(t=>!!t);return c.length?o`<span class="event-titles"> · ${c.join(", ")}</span>`:h}var ki=L`
...
`;var oe=class{constructor(c){this._cache=new Map;this._pending=new Map;this.historyFallbackIds=new Set;this._hass=c}updateHass(c){this._hass=c}async getDetailStats(c,t,e=30){return this._getStats(c,e<=35?"hour":"day",e,t)}async getMiniStats(c,t){return this._getStats(c,"day",14,t)}async getBatchMiniStats(c){let t=new Map,e=[];for(let r of c){let p=`${r.entityId}:day:14`,u=this._cache.get(p);u&&Date.now()-u.fetchedAt<3e5?t.set(r.entityId,u.points):e.push(r)}if(e.length===0)return t;let i=e.filter(r=>r.isCounter).map(r=>r.entityId),s=e.filter(r=>!r.isCounter).map(r=>r.entityId),n=new Date(Date.now()-336*60*60*1e3).toISOString(),d=[];return i.length>0&&d.push(this._fetchBatch(i,"day",n,["state","sum","change"],!0,t)),s.length>0&&d.push(this._fetchBatch(s,"day",n,["mean","min","max"],!1,t)),await Promise.all(d),t}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(c,t,e,i){let s=`${c}:${t}:${e}`,n=this._cache.get(s);if(n&&Date.now()-n.fetchedAt<3e5)return n.points;if(this._pending.has(s))return this._pending.get(s);let d=this._fetchAndNormalize(c,t,e,i,s);this._pending.set(s,d);try{return await d}finally{this._pending.delete(s)}}async _fetchAndNormalize(c,t,e,i,s){let n=new Date(Date.now()-e*24*60*60*1e3).toISOString(),d=i?["state","sum","change"]:["mean","min","max"];try{let p=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:n,statistic_ids:[c],period:t,types:d}))[c]||[],u=this._normalizeRows(p,i);if(u.length<2){let v=await this._fetchHistoryFallback(c,n);v.length>=2?(u=v,this.historyFallbackIds.add(c)):this.historyFallbackIds.delete(c)}else this.historyFallbackIds.delete(c);return this._cache.set(s,{entityId:c,fetchedAt:Date.now(),period:t,points:u}),u}catch(r){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${c}:`,r),[]}}async _fetchHistoryFallback(c,t){try{let i=(await this._hass.connection.sendMessagePromise({type:"history/history_during_period",start_time:t,end_time:new Date().toISOString(),entity_ids:[c],minimal_response:!0,no_attributes:!0}))?.[c]||[];if(i.length>1e3){let d=Math.ceil(i.length/500);i=i.filter((r,p)=>p%d===0||p===i.length-1)}let s=[],n=null;for(let d of i){let r=d.s??d.state;if(r==null||r==="unknown"||r==="unavailable")continue;let p;if(r==="on"||r==="open"||r==="true")p=1;else if(r==="off"||r==="closed"||r==="false")p=0;else if(p=parseFloat(r),!Number.isFinite(p))continue;let u=d.lu??d.last_updated??d.last_changed,v=typeof u=="number"?u*1e3:u!=null?Date.parse(u):NaN;Number.isFinite(v)&&(n!=null&&n!==p&&s.push({ts:v,val:n}),s.push({ts:v,val:p}),n=p)}return s.sort((d,r)=>d.ts-r.ts),s.length&&n!=null&&s.push({ts:Date.now(),val:n}),s}catch(e){return console.warn(`[maintenance-supporter] History fallback failed for ${c}:`,e),[]}}async _fetchBatch(c,t,e,i,s,n){try{let d=await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:e,statistic_ids:c,period:t,types:i});for(let r of c){let p=d[r]||[],u=this._normalizeRows(p,s);n.set(r,u),this._cache.set(`${r}:${t}:14`,{entityId:r,fetchedAt:Date.now(),period:t,points:u})}}catch(d){console.warn("[maintenance-supporter] Batch statistics fetch failed:",d)}}_normalizeRows(c,t){let e=[];for(let i of c){let s=null;if(t?s=i.state??null:s=i.mean??null,s===null)continue;let n={ts:i.start,val:s};t||(i.min!=null&&(n.min=i.min),i.max!=null&&(n.max=i.max)),e.push(n)}return e.sort((i,s)=>i.ts-s.ts),e}};function bt(l,c){let t=l??0;return t<1024?`${t} B`:t<1024*1024?`${it(t/1024,c,1)} KB`:`${it(t/(1024*1024),c,1)} MB`}var Rt=["manual","warranty","invoice","spare_parts","photo","other"],re={manual:"mdi:book-open-variant",warranty:"mdi:shield-check",invoice:"mdi:receipt-text-outline",spare_parts:"mdi:cog-outline",photo:"mdi:image-outline",other:"mdi:file-document-outline"};function Tt(l){return l.title||l.filename||l.url||""}var ne=8,je=["newest","oldest","title","category"];function Te(l){return je.includes(l??"")?l:"newest"}var $e=["manual","warranty","invoice","spare_parts","photo","other"];function $i(l,c){let t=new Intl.Collator(void 0,{numeric:!0,sensitivity:"base"}),e=d=>(d.title||d.filename||d.url||"").trim(),i=(d,r)=>t.compare(e(d),e(r)),s=d=>{if(d.kind==="weblink")return $e.length+1;let r=(d.tags||[]).find(p=>$e.includes(p))||"other";return $e.indexOf(r)},n=[...l];switch(c){case"oldest":return n.sort((d,r)=>(d.added_at||"").localeCompare(r.added_at||""));case"title":return n.sort(i);case"category":return n.sort((d,r)=>s(d)-s(r)||i(d,r));default:return n.sort((d,r)=>(r.added_at||"").localeCompare(d.added_at||""))}}function le(l,c){let t=Gt(c);if(!t.length)return l;let e=[];for(let i of l){let s=Ct(t,[{text:i.title,weight:3},{text:i.filename,weight:2},{text:(i.tags||[]).join(" "),weight:2},{text:i.description,weight:2},{text:i.url,weight:1}]);s>0&&e.push({doc:i,score:s})}return e.sort((i,s)=>s.score-i.score).map(i=>i.doc)}var V=class extends H{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._filter="";this._loaded=!1;this._busy=!1;this._error="";this._hint="";this._addingLink=!1;this._linkUrl="";this._linkTitle="";this._category="manual";this._thumbs={};this._lightboxUrl="";this._editingId="";this._editTitle="";this._editCategory="manual";this._editDescription="";this._linkDescription="";this._sort=Te(Z(D.docSort));this._dragOver=!1;this._loadedFor=null;this._localeReady=!1;this._singlePick=ti()}_isImage(t){return t.kind==="file"&&(t.mime||"").startsWith("image/")}async _sign(t){return Xt(this.hass,t.id)}get _lang(){return U(this.hass)}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,ot(this._lang).then(()=>this.requestUpdate())),this.hass&&this.entryId&&this._loadedFor!==this.entryId&&(this._loadedFor=this.entryId,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error="",this._thumbs={},this._loadThumbs()}catch(t){this._error=A(t,this._lang),this._loaded=!0}}async _loadThumbs(){await Promise.all(this._docs.filter(t=>this._isImage(t)).map(async t=>{try{let e=await this._sign(t);this._thumbs={...this._thumbs,[t.id]:e}}catch{}}))}_category_of(t){return(t.tags||[]).find(i=>Rt.includes(i))||"other"}_labelKeydown(t){(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),t.currentTarget.querySelector("input")?.click())}_onFileInput(t){let e=t.target,i=Array.from(e.files??[]);i.length&&this._uploadFiles(i),e.value=""}_onDrop(t){if(t.preventDefault(),this._dragOver=!1,!this.canWrite||this._busy)return;let e=Array.from(t.dataTransfer?.files??[]);e.length&&this._uploadFiles(e)}_onDragOver(t){this.canWrite&&(t.preventDefault(),this._dragOver=!0)}_onDragLeave(t){let e=t.relatedTarget;(!e||!t.currentTarget.contains(e))&&(this._dragOver=!1)}async _uploadFiles(t,e){let i=e??this._category;this._busy=!0,this._error="",this._hint="";let s=0,n=0;try{for(let d of t){let r;try{r=await ii(this.hass,this.entryId,d,[i])}catch(p){let u=p instanceof Error?p.message:"";if(u!=="doc_too_large"&&u!=="doc_upload_failed")throw p;this._error=a(u,this._lang);continue}r.duplicate_in_object?n++:r.deduped&&s++}n?this._hint=a("doc_dup_in_object",this._lang):s&&(this._hint=a("doc_deduped",this._lang)),await this._load()}catch{this._error=a("doc_upload_failed",this._lang)}finally{this._busy=!1}}async _download(t){try{await Zt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=A(e,this._lang)}}async _preview(t){if(this._isImage(t)){this._lightboxUrl=this._thumbs[t.id]||await this._sign(t);return}try{await wt(this.hass,t.id)}catch(e){this._error=A(e,this._lang)}}_openDoc(t){t.kind==="file"?this._preview(t):at(t.url)&&window.open(t.url,"_blank","noopener")}_startEdit(t){this._editingId=t.id,this._editTitle=t.title||"",this._editCategory=this._category_of(t),this._editDescription=t.description||"",this._addingLink=!1,this._error=""}_cancelEdit(){this._editingId=""}_setSort(t){this._sort=Te(t),G(D.docSort,this._sort)}async _saveEdit(t){let e=(t.tags||[]).filter(s=>!Rt.includes(s)),i=t.kind==="file"?[this._editCategory,...e]:t.tags??[];this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,title:this._editTitle.trim()||t.filename||t.url||"",tags:i,description:this._editDescription.trim()}),this._editingId="",await this._load()}catch(s){this._error=A(s,this._lang)}finally{this._busy=!1}}async _delete(t){let e=Tt(t);if(window.confirm(a("doc_delete_confirm",this._lang).replace("{name}",e))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:t.id}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}}async _addLink(){let t=this._linkUrl.trim();if(t){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/add_link",entry_id:this.entryId,url:t,title:this._linkTitle.trim()||null,description:this._linkDescription.trim()||null}),this._linkUrl="",this._linkTitle="",this._linkDescription="",this._addingLink=!1,await this._load()}catch(e){this._error=A(e,this._lang,a("doc_link_invalid",this._lang))}finally{this._busy=!1}}}render(){let t=this._lang;return o`
      ...
      ${this._loaded&&this._docs.length>=2?o`<div class="doc-tools">
            ...
            <select class="sort-select" aria-label=${a("doc_sort",t)} .value=${this._sort}
              ...
              ${je.map(e=>o`<option value=${e} ?selected=${e===this._sort}>${a(`doc_sort_${e}`,t)}</option>`)}
            </select>
          </div>`:h}
      ...
      ${this._loaded?this._docs.length===0?o`<div class="doc-empty">${a("documents_empty",t)}</div>`:(()=>{let e=this._filter.trim()?le(this._docs,this._filter):$i(this._docs,this._sort);return e.length===0?o`<div class="doc-empty">${a("doc_search_none",t)}</div>`:o`<div class="doc-list">${e.map(i=>this._renderDoc(i,t))}</div>`})():o`<div class="doc-empty">${a("loading",t)}</div>`}
    ...
    `}_renderDoc(t,e){if(this._editingId===t.id)return this._renderEdit(t,e);let i=t.kind==="file",s=this._category_of(t),n=i?`${a(`doc_cat_${s}`,e)} \xB7 ${bt(t.size,e)}`:a("doc_link_badge",e),d=this._thumbs[t.id];return o`
      <div class="doc-row">
        ${i&&d?o`<img
              class="doc-thumb"
              src=${d}
  ...
  `],g([S({attribute:!1})],V.prototype,"hass",2),g([S({attribute:!1})],V.prototype,"entryId",2),g([S({type:Boolean})],V.prototype,"canWrite",2),g([m()],V.prototype,"_docs",2),g([m()],V.prototype,"_filter",2),g([m()],V.prototype,"_loaded",2),g([m()],V.prototype,"_busy",2),g([m()],V.prototype,"_error",2),g([m()],V.prototype,"_hint",2),g([m()],V.prototype,"_addingLink",2),g([m()],V.prototype,"_linkUrl",2),g([m()],V.prototype,"_linkTitle",2),g([m()],V.prototype,"_category",2),g([m()],V.prototype,"_thumbs",2),g([m()],V.prototype,"_lightboxUrl",2),g([m()],V.prototype,"_editingId",2),g([m()],V.prototype,"_editTitle",2),g([m()],V.prototype,"_editCategory",2),g([m()],V.prototype,"_editDescription",2),g([m()],V.prototype,"_linkDescription",2),g([m()],V.prototype,"_sort",2),g([m()],V.prototype,"_dragOver",2);customElements.get("maintenance-documents-section")||customElements.define("maintenance-documents-section",V);var nt=class extends H{constructor(){super(...arguments);this.canWrite=!1;this._docs=[];this._loaded=!1;this._busy=!1;this._error="";this._attachId="";this._filter="";this._loadedKey="";this._localeReady=!1}get _lang(){return U(this.hass)}get _refId(){return this.partId||this.taskId||""}get _linkField(){return this.partId?"part_ids":"task_ids"}updated(t){super.updated(t),this.hass&&!this._localeReady&&(this._localeReady=!0,ot(this._lang).then(()=>this.requestUpdate()));let e=`${this.entryId}|${this._refId}`;this.hass&&this.entryId&&this._refId&&this._loadedKey!==e&&(this._loadedKey=e,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/list",entry_id:this.entryId});this._docs=t.documents||[],this._loaded=!0,this._error=""}catch(t){this._error=A(t,this._lang),this._loaded=!0}}_links(t){return t[this._linkField]||[]}_linked(){return this._docs.filter(t=>this._links(t).includes(this._refId))}_available(){return this._docs.filter(t=>!this._links(t).includes(this._refId))}async _setLinks(t,e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,[this._linkField]:e}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}_link(){let t=this._docs.find(e=>e.id===this._attachId);t&&(this._attachId="",this._setLinks(t,[...this._links(t),this._refId]))}_unlink(t){this._setLinks(t,this._links(t).filter(e=>e!==this._refId))}_isPdf(t){return t.mime==="application/pdf"||(t.filename||"").toLowerCase().endsWith(".pdf")}_pageFor(t){return this._isPdf(t)&&this.taskId?t.task_pages?.[this.taskId]:void 0}async _open(t){if(t.kind==="weblink"){at(t.url)&&window.open(t.url,"_blank","noopener");return}let e=this._pageFor(t);try{await wt(this.hass,t.id,e?`#page=${e}`:"")}catch(i){this._error=A(i,this._lang)}}async _setPage(t,e){if(this.taskId){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/update",doc_id:t.id,task_pages:{[this.taskId]:e}}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}}async _download(t){try{await Zt(this.hass,t.id,t.filename||t.title||"document")}catch(e){this._error=A(e,this._lang)}}render(){if(!this._loaded||this._docs.length===0)return h;let t=this._lang,e=this._linked(),i=this._available();return o`
      <div class="task-docs">
        ...
        ${e.length===0?o`<div class="tdoc-empty">${a(this.partId?"doc_part_none":"doc_task_none",t)}</div>`:(()=>{let s=le(e,this._filter);return s.length===0?o`<div class="tdoc-empty">${a("doc_search_none",t)}</div>`:o`<div class="tdoc-list">${s.map(n=>this._renderRow(n,t))}</div>`})()}
        ${this.canWrite&&i.length?o`<div class="tdoc-attach">
              ...
              >
                ...
                ${i.map(s=>o`<option value=${s.id} ?selected=${s.id===this._attachId}>${Tt(s)}</option>`)}
              </select>
    ...
    `}_renderRow(t,e){let i=t.kind==="file",s=this._isPdf(t),n=this._pageFor(t),d=(t.tags||[]).find(p=>Rt.includes(p))||"other",r=i?bt(t.size,e):a("doc_link_badge",e);return o`
      <div class="tdoc-row">
  ...
  `,g([S({attribute:!1})],rt.prototype,"hass",2),g([S({attribute:!1})],rt.prototype,"entryId",2),g([S({attribute:!1})],rt.prototype,"parts",2),g([S({type:Boolean})],rt.prototype,"canWrite",2),g([S({attribute:!1})],rt.prototype,"currencySymbol",2),g([m()],rt.prototype,"_editing",2),g([m()],rt.prototype,"_busy",2),g([m()],rt.prototype,"_error",2),g([m()],rt.prototype,"_restockFor",2),g([m()],rt.prototype,"_restockQty",2),g([m()],rt.prototype,"_restockInvalid",2),g([m()],rt.prototype,"_docsFor",2);customElements.get("maintenance-parts-section")||customElements.define("maintenance-parts-section",rt);var es=new Set(["completed","skipped","reset","missed"]);function is(l,c){let t=l.reading_values||[];return t.length?t.filter(e=>typeof e.value=="number").map(e=>({id:e.id,name:e.name||"",value:e.value,unit:e.unit||""})):typeof l.reading_value=="number"?[{id:"",name:"",value:l.reading_value,unit:c||""}]:[]}function ji(l){let c=[];for(let t of l){let e=[...t.history??[]].map(s=>({h:s,ts:new Date(s.timestamp).getTime()})).filter(s=>Number.isFinite(s.ts)).sort((s,n)=>s.ts-n.ts),i=new Map;for(let{h:s,ts:n}of e){let d=is(s,t.reading_unit).map(p=>{let u=i.get(p.id);return i.set(p.id,p.value),{name:p.name,value:p.value,unit:p.unit,delta:u==null?null:p.value-u}});if(!es.has(s.type))continue;let r=s.checklist_state&&typeof s.checklist_state=="object"?Object.values(s.checklist_state):null;c.push({ts:n,timestamp:s.timestamp,taskId:t.id,taskName:t.name,type:s.type,cost:typeof s.cost=="number"?s.cost:null,duration:typeof s.duration=="number"?s.duration:null,notes:s.notes??null,completedBy:s.completed_by??null,phaseName:s.phase_id&&t.phases?.[s.phase_id]?.name||null,refNo:typeof s.ref_no=="number"?s.ref_no:null,taskRefNo:typeof t.ref_no=="number"?t.ref_no:null,readings:d,parts:(s.used_parts||[]).filter(p=>p&&(p.name||p.part_id)).map(p=>({name:p.name||p.part_id,quantity:typeof p.quantity=="number"?p.quantity:1})),photoIds:ei(s),checklist:r&&r.length?{done:r.filter(Boolean).length,total:r.length}:null})}}return c.sort((t,e)=>e.ts-t.ts||t.taskName.localeCompare(e.taskName)),c}function Ti(l,c){let t=c.from?new Date(`${c.from}T00:00:00`).getTime():null,e=c.to?new Date(`${c.to}T00:00:00`).getTime()+864e5:null;return l.filter(i=>!(c.taskId&&i.taskId!==c.taskId||t!=null&&i.ts<t||e!=null&&i.ts>=e))}function ce(l){let c=0,t=0;for(let e of l)e.type==="completed"&&(c++,e.cost!=null&&(t+=e.cost));return{completed:c,totalCost:t}}var de={readings:!0,parts:!0,photos:!0,documents:!0,checklist:!0,notes:!0,costs:!0,person:!0,refs:!0,qr:!1,bare:!0,docDescriptions:!0};function ss(l){return!!(l.notes&&l.notes.trim()||l.cost!=null||l.duration!=null||l.readings.length||l.parts.length||l.photoIds.length||l.checklist)}function C(l){return String(l??"").replace(/[&<>"']/g,c=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[c])}var as=6;function Si(l,c,t,e,i,s,n,d={}){let r=d.options??{layout:"chronological",include:de},p=r.include,u=d.data??{objectRef:null,tasks:[],photos:{},fmtNumber:$=>String($)},v=c.filter($=>$.type==="completed"&&(p.bare!==!1||ss($))),{totalCost:_}=ce(v),b=$=>p.refs&&u.objectRef&&$.taskRefNo!=null&&$.refNo!=null?`${u.objectRef}.${$.taskRefNo}-${$.refNo}`:null,f=$=>p.refs&&u.objectRef&&$.taskRefNo!=null?`${u.objectRef}.${$.taskRefNo}`:null,R=[[t.refNumber,p.refs&&u.objectRef?`#${u.objectRef}`:null],[t.manufacturer,l.manufacturer],[t.model,l.model],[t.serial,l.serial_number],[t.installed,l.installation_date?e(l.installation_date):null]].filter(([,$])=>$).map(([$,N])=>`<div class="meta-row"><span>${C($)}</span><strong>${C(N)}</strong></div>`).join(""),x=$=>{let N=[];if(p.readings&&$.readings.length){let F=$.readings.map(I=>{let Y=`${u.fmtNumber(I.value)}${I.unit?` ${C(I.unit)}`:""}`,X=I.delta!=null?` <span class="delta">(${I.delta>=0?"+":"\u2212"}${u.fmtNumber(Math.abs(I.delta))})</span>`:"";return`${I.name?`${C(I.name)}: `:""}${Y}${X}`});N.push(`<div class="fact"><span class="k">${C(t.readings)}</span>${F.join(" \xB7 ")}</div>`)}if(p.parts&&$.parts.length&&N.push(`<div class="fact"><span class="k">${C(t.parts)}</span>${$.parts.map(F=>`${C(F.name)} \xD7 ${u.fmtNumber(F.quantity)}`).join(", ")}</div>`),p.checklist&&$.checklist&&N.push(`<div class="fact"><span class="k">${C(t.checklist)}</span>${$.checklist.done}/${$.checklist.total}</div>`),p.photos&&$.photoIds.length){let F=$.photoIds.slice(0,as),I=F.map(X=>{let W=u.photos[X],T=W?.name||X.slice(0,8);return W?.url?`<figure class="photo"><img src="${C(W.url)}" alt="" /><figcaption>${C(T)}</figcaption></figure>`:`<figure class="photo"><figcaption>${C(T)}</figcaption></figure>`}),Y=$.photoIds.length>F.length?`<span class="more">+${$.photoIds.length-F.length}</span>`:"";N.push(`<div class="fact"><span class="k">${C(t.photos)}</span><div class="photos">${I.join("")}${Y}</div></div>`)}return N.length?`<div class="details">${N.join("")}</div>`:""},M=$=>[p.notes?$.notes:null,p.person&&$.completedBy?`${t.completedBy}: ${$.completedBy}`:null].filter(Boolean).join(" \xB7 "),k=$=>p.costs?`<td class="num">${$.cost!=null?C(s($.cost)):C(t.none)}</td>
        <td class="num">${$.duration!=null?C(i($.duration)):C(t.none)}</td>`:"",P=$=>$?`<span class="ref">#${C($)}</span>`:"",O=p.costs?5:3,y=$=>`<thead><tr>
    <th>${C(t.colDate)}</th>
    ${$?`<th>${C(t.colTask)}</th>`:"<th></th>"}
    ${p.costs?`<th class="num">${C(t.colCost)}</th><th class="num">${C(t.colDuration)}</th>`:""}
    <th>${C(t.colNotes)}</th>
  </tr></thead>`,st=($,N)=>{let F=M($),I=x($),Y=C(N?$.phaseName?`${$.taskName} \xB7 ${$.phaseName}`:$.taskName:$.phaseName||"");return`<tr class="entry">
        <td class="nowrap">${C(e($.timestamp))}${P(b($))}</td>
        <td>${N?`${Y} ${P(f($))}`:Y}</td>
        ${k($)}
        <td class="notes">${C(F)||(I?"":C(t.none))}</td>
      </tr>${I?`<tr class="entry-details"><td colspan="${O}" class="details-cell">${I}</td></tr>`:""}`},ut;if(r.layout==="by_task"){let $=new Map(u.tasks.map(I=>[I.id,I])),N=[...u.tasks.map(I=>I.id)];for(let I of v)N.includes(I.taskId)||N.push(I.taskId);ut=`${N.map(I=>{let Y=v.filter(gt=>gt.taskId===I);if(!Y.length)return"";let X=$.get(I),W=X?.name||Y[0].taskName,T=p.refs?X?.ref??f(Y[0]):null,j=p.documents&&X?.documents.length?`<div class="fact"><span class="k">${C(t.documents)}</span>${X.documents.map(gt=>`${C(gt.title)}${gt.page?` (${C(t.page(gt.page))})`:""}${p.docDescriptions!==!1&&gt.description?` \u2014 <span class="doc-desc">${C(gt.description)}</span>`:""}`).join(", ")}</div>`:"",z=p.qr&&X?.qrDataUri?`<figure class="qr"><img src="${C(X.qrDataUri)}" alt="" /><figcaption>${C(t.scanHint)}</figcaption></figure>`:"",Mt=Y.reduce((gt,Wi)=>gt+(Wi.cost??0),0);return`<section class="task">
  <div class="task-head">
    <div class="task-title">
      <h2>${C(W)} ${P(T)}</h2>
      ${X?.schedule?`<div class="schedule">${C(X.schedule)}</div>`:""}
      ${j}
      <div class="task-count">${C(t.entriesLabel(Y.length))}${p.costs&&Mt>0?` \xB7 ${C(s(Mt))}`:""}</div>
    </div>
    ${z}
  </div>
  <table>
...
`)}
  ...
  <tfoot><tr>
    ...
    ${p.costs?`<td class="num">${C(s(_))}</td><td colspan="2"></td>`:"<td></td>"}
  </tr></tfoot>
...
${d.capped?`<p class="cap-note">${C(t.capNote)}</p>`:""}
      ...
      <div class="print-options" role="dialog" aria-label=${a("print_options_title",e)}>
        ...
        <div class="po-group">
          ...
          ${s("docDescriptions","print_inc_doc_desc",!n)}
          ${s("qr","print_inc_qr",!n)}
        </div>
      ...
      </div>`}render(){let t=this._lang,e=this._entries;if(!e.length&&!this._loading)return h;let i=Ti(e,{taskId:this._filterTask||null,from:this._from||null,to:this._to||null}),{completed:s,totalCost:n}=ce(i),d=this._expanded?i:i.slice(0,15);return o`
      <div class="section">
        <h3>
  ...
  `,g([S({attribute:!1})],tt.prototype,"hass",2),g([S()],tt.prototype,"entryId",2),g([S({attribute:!1})],tt.prototype,"object",2),g([S({attribute:!1})],tt.prototype,"tasks",2),g([S()],tt.prototype,"currencySymbol",2),g([S({attribute:!1})],tt.prototype,"userName",2),g([m()],tt.prototype,"_full",2),g([m()],tt.prototype,"_loading",2),g([m()],tt.prototype,"_filterTask",2),g([m()],tt.prototype,"_from",2),g([m()],tt.prototype,"_to",2),g([m()],tt.prototype,"_expanded",2),g([m()],tt.prototype,"_printOpen",2),g([m()],tt.prototype,"_printLayout",2),g([m()],tt.prototype,"_printInclude",2),g([m()],tt.prototype,"_printing",2);customElements.get("maintenance-object-history-section")||customElements.define("maintenance-object-history-section",tt);var lt=class lt extends H{constructor(){super(...arguments);this.flat=!1;this._ov=null;this._loading=!1;this._marking=!1;this._error="";this._history=null;this._rosterSort=lt._storedSort();this._typeFilter=null;this._recorded=[];this._historyRequested=!1;this._localeReady=!1;this._markAll=async()=>{await this._mark(void 0)};this._repair=async()=>{if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/setup",language:this._lang}),await this._load()}catch(t){this._error=A(t,this._lang)}finally{this._marking=!1}}};this._loadHistory=async t=>{let e=t.target.open;if(G(D.batteryRosterOpen,e?"1":"0"),!(!e||this._historyRequested)){this._historyRequested=!0;try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview_history"});this._history=i.series}catch{this._history=null}}}}get _lang(){return U(this.hass)}connectedCallback(){super.connectedCallback(),this.hass&&this._load()}updated(t){At(this,t),t.has("hass")&&this.hass&&!this._localeReady&&(this._localeReady=!0,ot(this._lang).then(()=>this.requestUpdate()),this._ov===null&&!this._loading&&this._load())}async _load(){this._loading=!0,this._error="";try{this._ov=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/overview"})}catch(t){this._error=A(t,this._lang)}finally{this._loading=!1}}async _mark(t){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/mark_replaced",...t?{entity_ids:t}:{}}),await this._load()}catch(e){this._error=A(e,this._lang)}finally{this._marking=!1}}}async _setExcluded(t,e){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/set_excluded",entity_id:t,excluded:e}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._marking=!1}}}async _addBattery(t){let e=t.detail?.value;if(!(!e||this._marking)){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/set_included",entity_id:e,included:!0}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._marking=!1}}}async _setTrackSelf(t){await this._setFleetOption("set_track_self_charging",t.target.checked)}async _setDueWithoutSensor(t){await this._setFleetOption("set_due_without_sensor",t.target.checked)}async _setFleetOption(t,e){if(!this._marking){this._marking=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:`maintenance_supporter/battery_fleet/${t}`,enabled:e}),await this._load()}catch(i){this._error=A(i,this._lang)}finally{this._marking=!1}}}_rosterOpen(){return Z(D.batteryRosterOpen)!=="0"}_predictedTitle(t,e){if(t.forecast_overdue)return a("battery_fleet_forecast_overdue",e);let i=this._predictedDate(t.days_until??0);if(t.predicted_source==="trend")return a("battery_fleet_predicted_trend",e).replace("{date}",i).replace("{confidence}",a("cal_confidence_"+(t.prediction_confidence||"medium"),e));if(t.lifetime_months!=null&&t.lifetime_source){let s=a("lifetime_source_"+t.lifetime_source,e).replace("{n}",String(t.lifetime_samples??0));return a("battery_fleet_predicted_typical",e).replace("{date}",i).replace("{months}",String(t.lifetime_months)).replace("{type}",t.battery_type).replace("{source}",s)}return a("battery_fleet_predicted_on",e).replace("{date}",i)}_sparkline(t){let e=this._history?.[t.entity_id];if(!e||e.points.length<2)return h;let i=110,s=24,n=2,d=e.points[0][0],r=e.points[e.points.length-1][0],p=Date.now()/1e3,u=t.status!=="low"&&t.predicted_source==="trend"&&t.days_until!=null?p+t.days_until*86400:null,v=Math.max(r,u??r),_=M=>v===d?n:n+(M-d)/(v-d)*(i-2*n),b=M=>n+(1-Math.min(100,Math.max(0,M))/100)*(s-2*n),f=e.points.map(([M,k])=>`${E(_(M))},${E(b(k))}`).join(" "),R=e.points[e.points.length-1][1],x=E(b(e.threshold));return o`<svg
    ...
    >
      ...
      ${u!==null?o`<line
            ...
            y2=${x}
          ></line>`:h}
    </svg>`}static _storedSort(){return Z(D.batteryRosterSort)==="name"?"name":"urgency"}_setSort(t){this._rosterSort=t,G(D.batteryRosterSort,t)}_sortedRoster(t){let e=this._typeFilter===null?t:t.filter(s=>s.battery_type===this._typeFilter);if(this._rosterSort==="name")return e;let i=s=>s.status==="low"?-1e3+(s.level??101)/101:s.days_until??1/0;return[...e].sort((s,n)=>i(s)-i(n)||s.device_name.localeCompare(n.device_name))}_predictedDate(t){return this._fmtDate(Date.now()+t*864e5)}_fmtDate(t){let e=new Date(t),i=s=>String(s).padStart(2,"0");return Q(`${e.getFullYear()}-${i(e.getMonth()+1)}-${i(e.getDate())}`,this._lang)}_shoppingLine(t){return Object.entries(t).map(([e,i])=>o`<button
  ...
  `,g([S({attribute:!1})],lt.prototype,"hass",2),g([S({type:Boolean})],lt.prototype,"flat",2),g([m()],lt.prototype,"_ov",2),g([m()],lt.prototype,"_loading",2),g([m()],lt.prototype,"_marking",2),g([m()],lt.prototype,"_error",2),g([m()],lt.prototype,"_history",2),g([m()],lt.prototype,"_rosterSort",2),g([m()],lt.prototype,"_typeFilter",2),g([m()],lt.prototype,"_recorded",2);var Se=lt;customElements.get("maintenance-battery-fleet-section")||customElements.define("maintenance-battery-fleet-section",Se);var Ei=L`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;function Ri(l){let c=window;c.customCards=c.customCards||[],c.customCards.some(t=>t.type===l.type)||c.customCards.push(l)}var dt=class extends H{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(t){if(this._config={...t},t.past_days&&[30,90].includes(t.past_days)?this._pastDays=t.past_days:t.window_days&&[7,14,30,365].includes(t.window_days)&&(this._windowDays=t.window_days,this._pastDays=0),typeof t.user_filter=="string"&&(this._userFilter=t.user_filter),typeof t.object_filter=="string")this._objectFilter=t.object_filter,this._configuredObjects=[];else if(Array.isArray(t.object_filter)){let e=t.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=e.length===1?e[0]:"",this._configuredObjects=e.length>1?e:[]}}getCardSize(){return 6}get _lang(){return U(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(t){if(super.updated(t),At(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=e,Lt(this._stats.budget)}catch{}}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){t();return}this._unsub=t}catch{}}_onEventClick(t){if(t.history_timestamp){this._openHistoryEntry(t);return}bi(t.entry_id,t.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:t.entry_id,task_id:t.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(t){try{let e=await ni(this.hass,t.entry_id,t.task_id,t.history_timestamp);if(!e||vi(e))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h;let t=this._lang,e=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,s=this._config.title,n=null;this._userFilter&&(n=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let d=y=>{let st=y.toLowerCase();return this._objects.find($=>$.entry_id===y||$.object.name.toLowerCase()===st)?.entry_id??null},r=new Set(this._configuredObjects.map(d).filter(y=>y!==null)),p=r.size?this._objects.filter(y=>r.has(y.entry_id)):this._objects,u=this._config.show_object_filter!==!1&&p.length>1,v=this._objectFilter?d(this._objectFilter):null,_=v&&p.some(y=>y.entry_id===v)?p.filter(y=>y.entry_id===v):p,b=new Date;b.setHours(0,0,0,0);let f=this._pastDays>0,R=f?oi(_,b,this._pastDays,n):ai(_,b,this._windowDays,n),x=qt(b),M=this._windowDays===365||f,k=M?R.filter(y=>y.events.length>0):R,P=y=>{let st=`cal-status-${y.status}`,ut=y.projected?"cal-event-projected":"",$=y.status==="overdue"&&y.days_until_due!=null?` (${jt(y.days_until_due,t)})`:"",N=y.projected&&y.interval_days?o`<span class="cal-event-recur">${y.interval_unit&&y.interval_unit!=="days"?`${y.interval_days} ${a("unit_"+y.interval_unit,t)}`:a("cal_every_n_days",t).replace("{n}",String(y.interval_days))}</span>`:h,F=y.schedule_type==="sensor_based",I=F?o`<ha-icon class="cal-event-icon cal-source-sensor"
          ...
          </span>`:h,X=Qt(this._stats?.budget),W=y.history_type?a(y.history_type,t):a(y.status,t);return o`
      ...
      `},O=y=>{let[st,ut,$]=y.date.split("-").map(Number),N=new Date(st,ut-1,$),F=y.date===x,I=Le(N,t,"short"),Y=He(N,t,"long");return o`
    ...
    `],g([S({attribute:!1})],dt.prototype,"hass",2),g([m()],dt.prototype,"_config",2),g([m()],dt.prototype,"_objects",2),g([m()],dt.prototype,"_stats",2),g([m()],dt.prototype,"_windowDays",2),g([m()],dt.prototype,"_pastDays",2),g([m()],dt.prototype,"_userFilter",2),g([m()],dt.prototype,"_objectFilter",2),g([m()],dt.prototype,"_unsub",2);var ns=[{value:7,key:"cal_editor_window_week"},{value:14,key:"cal_editor_window_fortnight"},{value:30,key:"cal_editor_window_month"},{value:365,key:"cal_editor_window_year"}],zt=class extends H{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}get _lang(){return U(this.hass)}setConfig(t){this._config={...t}}updated(){let t=this._lang;t&&!Ie(t)&&ot(t).then(()=>this.requestUpdate())}_valueChanged(t,e){let i={...this._config,[t]:e};t==="show_window_chips"&&e===!0&&delete i.show_window_chips,t==="show_user_filter"&&e===!0&&delete i.show_user_filter,t==="show_object_filter"&&e===!0&&delete i.show_object_filter,t==="title"&&(!e||typeof e=="string"&&e.trim()==="")&&delete i.title,t==="user_filter"&&e===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let t=this._lang,e=this._config.window_days??30,i=this._config.show_window_chips!==!1,s=this._config.show_user_filter!==!1,n=this._config.user_filter??"",d=this._config.title??"";return o`
      <div class="editor">
        ...
        <div class="row">
          ...
          >
            ${ns.map(r=>o`<option value="${r.value}" ?selected=${r.value===e}>${a(r.key,t)}</option>`)}
          </select>
        </div>
  ...
  `,g([S({attribute:!1})],pt.prototype,"hass",2),g([S({attribute:!1})],pt.prototype,"objects",2),g([m()],pt.prototype,"_summary",2),g([m()],pt.prototype,"_loaded",2),g([m()],pt.prototype,"_busy",2),g([m()],pt.prototype,"_error",2),g([m()],pt.prototype,"_query",2),g([m()],pt.prototype,"_results",2),g([m()],pt.prototype,"_expanded",2);customElements.get("maintenance-storage-section-card")||customElements.define("maintenance-storage-section-card",pt);var ls=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"],mt=class extends H{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._error="";this._entryId="";this._taskId="";this._values=new Array(12).fill("");this._save=async()=>{let t=this._buildOverrides();if(t!==null){this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:t}),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(e){this._error=A(e,this._lang,a("save_error",this._lang))}finally{this._loading=!1}}};this._clearAll=async()=>{this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:{}}),this._values=new Array(12).fill(""),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(t){this._error=A(t,this._lang,a("save_error",this._lang))}finally{this._loading=!1}}}get _lang(){return U(this.hass)}open(t,e,i){if(this._entryId=t,this._taskId=e,this._values=new Array(12).fill(""),i)for(let[s,n]of Object.entries(i)){let d=parseInt(s,10);d>=1&&d<=12&&typeof n=="number"&&(this._values[d-1]=n.toString())}this._error="",this._open=!0}_close(){this._open=!1}_buildOverrides(){let t={};for(let e=0;e<12;e++){let i=this._values[e].trim();if(!i)continue;let s=parseFloat(i);if(Number.isNaN(s))return this._error=`${a("month_"+["jan","feb","mar","apr","may","jun","jul","aug","sep","oct","nov","dec"][e],this._lang)}: ${a("seasonal_override_invalid",this._lang)}`,null;if(s<.1||s>5)return this._error=a("seasonal_override_range",this._lang),null;t[e+1]=s}return t}render(){if(!this._open)return o``;let t=this._lang;return o`
  ...
  `,g([S({attribute:!1})],ft.prototype,"hass",2),g([m()],ft.prototype,"_open",2),g([m()],ft.prototype,"_busy",2),g([m()],ft.prototype,"_error",2),g([m()],ft.prototype,"_name",2),g([m()],ft.prototype,"_views",2);customElements.get("maintenance-saved-views-dialog")||customElements.define("maintenance-saved-views-dialog",ft);var cs=60,ds=20,Oi=30,ps={approaching:"\u2197",stable:"\u2192",easing:"\u2198"};function Ee(l,c){let t=l.trigger_config;if(!t?.entity_id)return null;let e,i=t.type||"threshold";if(i==="threshold")if(t.trigger_above!=null)e=1;else if(t.trigger_below!=null)e=-1;else return null;else if(i==="counter"||i==="runtime"||i==="state_change")e=1;else return null;let s=c.get(t.entity_id)||[],n=i==="runtime"||i==="state_change",d=s.length>=2?s.map(f=>({ts:f.ts,val:f.val})):n?[]:(l.history||[]).filter(f=>f.trigger_value!=null).map(f=>({ts:new Date(f.timestamp).getTime(),val:f.trigger_value}));if(l.trigger_current_value!=null&&(d=[...d,{ts:Date.now(),val:l.trigger_current_value}]),d.length<2)return null;d.sort((f,R)=>f.ts-R.ts);let r=d.map(f=>f.val),p=Math.max(...r)-Math.min(...r),u=r[r.length-1]-r[0],v=t.trigger_delta_mode&&l.trigger_baseline_value!=null&&t.trigger_target_value!=null?l.trigger_baseline_value+t.trigger_target_value:t.trigger_target_value,_=i==="threshold"?t.trigger_above??t.trigger_below:i==="counter"?v:i==="runtime"?t.trigger_runtime_hours:t.trigger_target_changes,b=typeof _=="number"?Math.max(Math.abs(_-r[0]),p):p;return b===0||Math.abs(u)<b*(typeof _=="number"?.05:.15)?"stable":Math.sign(u)===e?"approaching":"easing"}function Re(l,c){let t=l.trigger_config??null;if(!t)return h;let e=t.type||"threshold",i=l.trigger_entity_info?.unit_of_measurement??"",s=0,n="";if(e==="threshold"){let p=l.trigger_current_value??null;if(p==null)return h;let u=t.trigger_above,v=t.trigger_below;if(u!=null&&v!=null){let _=(u+v)/2,b=Math.abs(u-v)/2||1;s=Math.min(100,Math.max(0,Math.abs(p-_)/b*100));let f=Math.abs(p-u)<=Math.abs(p-v)?u:v;n=`${it(p,c?.lang,1)} / ${it(f,c?.lang)} ${i}`}else if(u!=null){let _=l.trigger_entity_info?.min,b=u>0?0:_!=null&&_<u?_:u<0?2*u:-100,f=u-b||1;s=Math.min(100,Math.max(0,(p-b)/f*100)),n=`${it(p,c?.lang,1)} / ${it(u,c?.lang)} ${i}`}else if(v!=null){let _=l.trigger_entity_info?.max,b=_!=null&&_>v?_:v>0?v*2:v<0?0:100,f=b-v||1;s=Math.min(100,Math.max(0,(b-p)/f*100)),n=`${it(p,c?.lang,1)} / ${it(v,c?.lang)} ${i}`}else if(t.trigger_equals!=null||t.trigger_not_equals!=null){let _=t.trigger_equals!=null?`= ${t.trigger_equals}`:`\u2260 ${t.trigger_not_equals}`;n=`${it(p,c?.lang,1)} (${_}${i?` ${i}`:""})`,s=l.trigger_active?100:0}else return h}else if(e==="counter"){let p=t.trigger_target_value||1,u;if(t.trigger_delta_mode?(u=l.trigger_current_delta??null,u==null&&l.trigger_baseline_value!=null&&l.trigger_current_value!=null&&(u=l.trigger_current_value-l.trigger_baseline_value)):u=l.trigger_current_value??null,u==null)return h;s=Math.min(100,Math.max(0,u/p*100)),n=`${it(u,c?.lang,1)} / ${it(p,c?.lang)} ${i}`}else if(e==="state_change"){let p=t.trigger_target_changes||1,u=l.trigger_current_value??null;if(u==null)return h;s=Math.min(100,Math.max(0,u/p*100)),n=`${it(u,c?.lang,0)} / ${it(p,c?.lang,0)}`}else if(e==="runtime"){let p=t.trigger_runtime_hours||100,u=l.trigger_current_value??null;if(u==null)return h;s=Math.min(100,Math.max(0,u/p*100)),n=`${it(u,c?.lang,1)}h / ${it(p,c?.lang)}h`}else if(e==="compound"){let p=t.compound_logic||t.operator||"AND",u=t.conditions?.length||0;n=`${p} (${u})`,s=l.trigger_active?100:0}else return h;let d=s>=100,r=s>90?"var(--error-color, #f44336)":s>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return o`
    <div class="trigger-progress">
      ...
      <span class="trigger-progress-label">${n}${c?.trend?o` <i class="trend-arrow trend-${c.trend}" title="${a(`trend_${c.trend}`,c.lang??"en")}" aria-label="${a(`trend_${c.trend}`,c.lang??"en")}">${ps[c.trend]}</i>`:h}</span>
    </div>
  `}function Oe(l,c,t){if(!l.trigger_config?.entity_id)return h;let e=l.trigger_config.entity_id,i=c.get(e)||[],s=[];if(i.length>=2)s=i.map(O=>({ts:O.ts,val:O.val}));else{if(!l.history)return h;for(let O of l.history)O.trigger_value!=null&&s.push({ts:new Date(O.timestamp).getTime(),val:O.trigger_value})}if(l.trigger_current_value!=null&&s.push({ts:Date.now(),val:l.trigger_current_value}),s.length<2)return h;s.sort((O,y)=>O.ts-y.ts);let n=cs,d=ds,r=s.map(O=>O.val),p=Math.min(...r),u=Math.max(...r),v=u-p||1;p-=v*.1,u+=v*.1;let _=s[0].ts,f=s[s.length-1].ts-_||1,R=O=>(O-_)/f*n,x=O=>2+(1-(O-p)/(u-p))*(d-4),M=s;if(M.length>Oi){let O=Math.ceil(M.length/Oi);M=M.filter((y,st)=>st%O===0||st===M.length-1)}let k=M.map(O=>`${E(R(O.ts))},${E(x(O.val))}`).join(" "),P=l.trigger_active?"var(--error-color, #f44336)":"var(--primary-color)";return o`
  ...
  `}function Mi(l,c){let t=c;if(l.days_until_due==null||!l.interval_days||l.interval_days<=0)return h;let{pct:e,overflow:i}=te(l.interval_days,l.days_until_due,l.interval_unit),s="var(--success-color, #4caf50)";return l.status==="overdue"?s="var(--error-color, #f44336)":l.status==="due_soon"&&(s="var(--warning-color, #ff9800)"),o`
  ...
  `}var pe=210,_t=46,kt=14,$t=12,Ci=14,hs=20+Ci,us=[{days:7,key:"chart_range_7d"},{days:30,key:"chart_range_30d"},{days:90,key:"chart_range_90d"},{days:365,key:"chart_range_1y"}],et=class extends H{constructor(){super(...arguments);this.points=[];this.events=[];this.unit="";this.lang="en";this.thresholdAbove=null;this.thresholdBelow=null;this.targetValue=null;this.forceZero=!1;this.projection=null;this.rangeDays=30;this.showRange=!0;this.busy=!1;this.hideOutliers=!1;this.showOutlierToggle=!0;this._width=0;this._hover=null;this._ro=null}connectedCallback(){super.connectedCallback(),this._ro=new ResizeObserver(t=>{let e=Math.floor(t[0]?.contentRect?.width||0);e&&Math.abs(e-this._width)>2&&(this._width=e)}),this._ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this._ro?.disconnect(),this._ro=null}_emitRange(t){t!==this.rangeDays&&this.dispatchEvent(new CustomEvent("range-change",{detail:{days:t},bubbles:!0,composed:!0}))}_toggleOutliers(){this.dispatchEvent(new CustomEvent("outlier-toggle",{detail:{hide:!this.hideOutliers},bubbles:!0,composed:!0}))}render(){let t=this._width||320,e=[...this.points].sort((s,n)=>s.ts-n.ts),i=this.lang;return o`
    ...
    `}_renderSvg(t,e){let i=this.lang,s=t-_t-kt,n=pe-hs,d=n-$t,r=1/0,p=-1/0;for(let T of e)r=Math.min(r,T.min??T.val),p=Math.max(p,T.max??T.val);this.thresholdAbove!=null&&(r=Math.min(r,this.thresholdAbove),p=Math.max(p,this.thresholdAbove)),this.thresholdBelow!=null&&(r=Math.min(r,this.thresholdBelow),p=Math.max(p,this.thresholdBelow)),this.targetValue!=null&&(r=Math.min(r,this.targetValue),p=Math.max(p,this.targetValue)),this.forceZero&&(r=Math.min(r,0));let u=(p-r||1)*.06,v=this.forceZero&&r>=0?0:r-u,{ticks:_,niceMin:b,niceMax:f}=Ft(v,p+u,4);this.forceZero&&r>=0&&b<0&&(b=0,_=_.filter(T=>T>=0));let R=e[0].ts,x=this.projection&&this.projection.length===2?this.projection[1].ts:null,M=x!=null?Math.max(e[e.length-1].ts,x):e[e.length-1].ts,k=M-R||1,P=se(R,M),O=T=>_t+(T-R)/k*s,y=T=>$t+(1-(T-b)/(f-b||1))*d,st=e.map(T=>`${E(O(T.ts))},${E(y(T.val))}`).join(" "),ut=`M${E(O(e[0].ts))},${n} `+e.map(T=>`L${E(O(T.ts))},${E(y(T.val))}`).join(" ")+` L${E(O(e[e.length-1].ts))},${n} Z`,$="",N=e.filter(T=>T.min!=null&&T.max!=null);if(N.length>=2){let T=N.map(z=>`${E(O(z.ts))},${E(y(z.max))}`),j=[...N].reverse().map(z=>`${E(O(z.ts))},${E(y(z.min))}`);$=`M${T[0]} `+T.slice(1).map(z=>`L${z}`).join(" ")+` L${j.join(" L")} Z`}let F=[];if(this.thresholdBelow!=null){let T=y(this.thresholdBelow);F.push({y:T,h:Math.max(0,n-T),lineY:T,label:`\u25BC ${vt(this.thresholdBelow,i)}`,labelY:Math.min(n-4,T+13)})}if(this.thresholdAbove!=null){let T=y(this.thresholdAbove);F.push({y:$t,h:Math.max(0,T-$t),lineY:T,label:`\u25B2 ${vt(this.thresholdAbove,i)}`,labelY:Math.max($t+11,T-5)})}let I=e[e.length-1],Y=(this.events||[]).filter(T=>T.ts>=R&&T.ts<=M),X=ae(R,M,Math.max(2,Math.min(5,Math.floor(s/110)+1))),W=this._hover;return o`
      <div class="svg-holder">
        ...
        >
          <defs>
            <clipPath id="plot"><rect x="${_t}" y="${$t}" width="${s}" height="${d}" /></clipPath>
            ${F.length?J`<clipPath id="danger">${F.map(T=>J`<rect x="${_t}" y="${E(T.y)}" width="${s}" height="${E(T.h)}" />`)}</clipPath>`:h}
          ...
          ${F.map(T=>J`<rect x="${_t}" y="${E(T.y)}" width="${s}" height="${E(T.h)}"
          ...
          ${X.map((T,j)=>{let z=O(T),Mt=j===0?"start":j===X.length-1?"end":"middle";return J`<text x="${E(z)}" y="${pe-5}" text-anchor="${Mt}" class="tick-label">${Pt(T,i,P)}</text>`})}
          ...
          ${Y.map(T=>{let j=O(T.ts),z=T.type==="completed"?"var(--success-color, #4caf50)":T.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return J`
              ...
              <rect x="${E(j-1.5)}" y="${n+3}" width="3" height="${Ci-6}" rx="1.5" fill="${z}">
          ...
          ${W?J`
                ...
                <circle cx="${E(W.x)}" cy="${E(W.y)}" r="4.5" fill="var(--primary-color)"
                  stroke="var(--card-background-color, #fff)" stroke-width="2" />`:J`<circle cx="${E(O(I.ts))}" cy="${E(y(I.val))}" r="4" fill="var(--primary-color)"
    ...
    `}_onPointer(t,e,i,s,n){let r=t.currentTarget.getBoundingClientRect(),p=(t.clientX-r.left)/r.width*n;if(p<_t-8||p>n-kt+8){this._hover=null;return}let u=e[0],v=1/0;for(let _ of e){let b=Math.abs(i(_.ts)-p);b<v&&(v=b,u=_)}this._hover={x:i(u.ts),y:s(u.val),p:u}}};et.styles=L`
  ...
  `,g([S({attribute:!1})],et.prototype,"points",2),g([S({attribute:!1})],et.prototype,"events",2),g([S()],et.prototype,"unit",2),g([S()],et.prototype,"lang",2),g([S({attribute:!1})],et.prototype,"thresholdAbove",2),g([S({attribute:!1})],et.prototype,"thresholdBelow",2),g([S({attribute:!1})],et.prototype,"targetValue",2),g([S({type:Boolean})],et.prototype,"forceZero",2),g([S({attribute:!1})],et.prototype,"projection",2),g([S({attribute:!1})],et.prototype,"rangeDays",2),g([S({type:Boolean})],et.prototype,"showRange",2),g([S({type:Boolean})],et.prototype,"busy",2),g([S({type:Boolean})],et.prototype,"hideOutliers",2),g([S({type:Boolean})],et.prototype,"showOutlierToggle",2),g([m()],et.prototype,"_width",2),g([m()],et.prototype,"_hover",2);customElements.get("maintenance-trigger-chart")||customElements.define("maintenance-trigger-chart",et);function Di(l){let c=(l??"").trim().toLowerCase();return c==="on"||c==="open"||c==="true"?1:c==="off"||c==="closed"||c==="false"?0:null}function gs(l,c,t){if(l.length<2)return null;let e=t.now??Date.now(),i=Math.max(0,c.trigger_for_minutes??0)*6e4,s=c.trigger_from_state?Di(c.trigger_from_state):null,n=c.trigger_to_state?Di(c.trigger_to_state):null;if(c.trigger_from_state&&s===null||c.trigger_to_state&&n===null)return null;let d=[...l].sort((k,P)=>k.ts-P.ts),r=[];for(let k of d){let P=r[r.length-1];(!P||P.level!==k.val)&&r.push({start:k.ts,level:k.val})}let p=k=>(k+1<r.length?r[k+1].start:e)-r[k].start>=i,u=(k,P,O)=>{let y=k[k.length-1];y&&y.val!==O&&k.push({ts:P,val:y.val}),k.push({ts:P,val:O})};if((c.trigger_target_changes??1)===1&&n!==null){let k=[];r.forEach((O,y)=>u(k,O.start,O.level===n&&p(y)?1:0));let P=k[k.length-1]?.val??0;return k.push({ts:e,val:P}),{points:k,mode:"alarm"}}let _=t.since??r[0].start,b=0,f=[];for(let k=1;k<r.length;k++){let P=r[k-1],O=r[k];s!==null&&P.level!==s||n!==null&&O.level!==n||!p(k)||O.start<_||(b+=1,f.push(O.start))}let R=Math.max(0,(t.current??b)-b),x=[{ts:Math.max(_,r[0].start),val:R}],M=R;for(let k of f)M+=1,u(x,k,M);return x.push({ts:e,val:M}),{points:x,mode:"count"}}function ms(l){if(l.length<4)return l;let c=l.map(p=>p.val).sort((p,u)=>p-u),t=p=>{let u=(c.length-1)*p,v=Math.floor(u),_=Math.ceil(u);return c[v]+(c[_]-c[v])*(u-v)},e=t(.25),i=t(.75),s=i-e;if(s===0)return l;let n=e-1.5*s,d=i+1.5*s,r=l.filter(p=>p.val>=n&&p.val<=d);return r.length>=2?r:l}function Ai(l,c){let t=l.trigger_config;if(!t)return h;let e=c.lang,i=l.trigger_entity_info,s=l.trigger_entity_infos,n=i?.friendly_name||t.entity_id||"\u2014",d=t.entity_id||"",r=t.entity_ids||(d?[d]:[]),p=i?.unit_of_measurement||"",u=l.trigger_current_value,v=t.type||"threshold",_=r.length>1,b=_s(l,p,c);return o`
    <h3>${a("trigger",e)}</h3>
      ...
      <div class="trigger-limits">
        ...
        ${v==="compound"?o`
          ...
          ${(t.conditions||[]).map((f,R)=>o`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${R+1}. ${a(f.type||"unknown",e)}: ${f.entity_id?o`<span class="entity-link" @click=${x=>Bt(x,f.entity_id)}>${f.entity_id}</span>`:""}</span>
          `)}
        `:h}
      </div>
  ...
  `}function _s(l,c,t){let e=l.trigger_config,i=l.trigger_current_value;if(!e||i==null)return null;switch(e.type||"threshold"){case"counter":{let s=e.trigger_target_value;if(s==null||s<=0)return null;if(!e.trigger_delta_mode)return{progress:Math.max(0,i),target:s,unit:c,meter:null};let n=Pi(l,Ii(l,t));return{progress:Math.max(0,i-(n?.value??i)),target:s,unit:c,meter:i}}case"state_change":{let s=e.trigger_target_changes;return s==null||s<=0?null:{progress:Math.max(0,i),target:s,unit:"",meter:null}}case"runtime":{let s=e.trigger_runtime_hours;return s==null||s<=0?null:{progress:Math.max(0,i),target:s,unit:"h",meter:null}}}return null}function Pi(l,c){if(l.trigger_baseline_value!=null)return{value:l.trigger_baseline_value,ts:he(l)};if(!c.length)return null;let t=he(l);if(t==null)return{value:c[0].val,ts:null};let e=c[0],i=Math.abs(c[0].ts-t);for(let s of c){let n=Math.abs(s.ts-t);n<i&&(e=s,i=n)}return{value:e.val,ts:t}}function he(l){let c=[...l.history].filter(t=>t.type==="completed"||t.type==="reset").sort((t,e)=>new Date(e.timestamp).getTime()-new Date(t.timestamp).getTime())[0];return c?new Date(c.timestamp).getTime():null}function vs(l,c){let t=Math.min(999,Math.round(l.progress/l.target*100)),e=t>=100?"over":t>=75?"near":"ok";return o`
  ...
  `}var fs=200,Ut=10,ys=22;function zi(l,c,t,e,i){let s=l.history.filter(r=>r.type==="completed"&&(r.cost!=null||r.duration!=null));if(s.length<2)return h;let n=s.some(r=>(r.cost??0)>0),d=s.some(r=>(r.duration??0)>0);return!n&&!d?h:o`
  ...
  `}function xs(l,c,t,e){let i=l.history.filter(j=>j.type==="completed"&&(j.cost!=null||j.duration!=null)).map(j=>({ts:new Date(j.timestamp).getTime(),cost:j.cost??0,duration:j.duration??0})).sort((j,z)=>j.ts-z.ts);if(i.length<2)return h;let s=i.some(j=>j.cost>0),n=i.some(j=>j.duration>0);if(!s&&!n)return h;let d=t!=="duration"&&s,r=t!=="cost"&&n,p=d||!r&&s,u=r||!d&&n,v=640,_=fs,b=p?44:12,f=u?44:12,R=v-b-f,x=_-ys,M=x-Ut,k=i[0].ts,P=i[i.length-1].ts,O=(P-k||864e5)*.05,y=k-O,st=P+O,ut=se(k,P),$=j=>b+(j-y)/(st-y)*R,N=Ft(0,Math.max(...i.map(j=>j.cost))||1,3),F=Ft(0,Math.max(...i.map(j=>j.duration))||1,3),I=j=>Ut+(1-j/(N.niceMax||1))*M,Y=j=>Ut+(1-j/(F.niceMax||1))*M,X=i.length>1?Math.min(...i.slice(1).map((j,z)=>$(j.ts)-$(i[z].ts))):R,W=Math.max(6,Math.min(22,X*.55)),T=ae(k,P,Math.max(2,Math.min(4,i.length)));return o`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${v} ${_}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${a("chart_history",c)}">
        ${p?N.ticks.map(j=>{let z=I(j);return z<Ut-1||z>x+1?h:J`
        ...
        ${p?i.filter(j=>j.cost>0).map(j=>J`
          <rect x="${E($(j.ts)-W/2)}" y="${E(I(j.cost))}" width="${E(W)}" height="${E(x-I(j.cost))}"
            fill="var(--primary-color)" opacity="0.6" rx="2">
            <title>${Pt(j.ts,c,!0)}: ${K(j.cost,e,c)}${j.duration?` \xB7 ${j.duration}m`:""}</title>
          </rect>
        `):h}
        ${u?J`
          ...
          ${i.map(j=>J`
            <circle cx="${E($(j.ts))}" cy="${E(Y(j.duration))}" r="3.5" fill="var(--accent-color, #ff9800)">
              <title>${Pt(j.ts,c,!0)}: ${j.duration}m${j.cost?` \xB7 ${K(j.cost,e,c)}`:""}</title>
            </circle>
          `)}
        `:h}

        <line x1="${b}" y1="${x}" x2="${v-f}" y2="${x}" stroke="var(--divider-color)" stroke-width="1" />
        ${T.map((j,z)=>{let Mt=z===0?"start":z===T.length-1?"end":"middle";return J`<text x="${E($(j))}" y="${_-6}" text-anchor="${Mt}" fill="var(--secondary-text-color)" font-size="10">${Pt(j,c,ut)}</text>`})}
      </svg>
    </div>
  ...
  `}function Me(l,c,t){if(!l.responsible_user_id)return h;let e=t?.(l.responsible_user_id)??null;if(e)return o`<span class="user-badge">${Xe(e)}${e.name}</span>`;let i=c(l.responsible_user_id);return i?o`
    <span class="user-badge">
      <ha-icon icon="mdi:account"></ha-icon>
      ${i}
    </span>
  `:h}function ws(l,c){let t=c.lang,e=c.isOperator,i=l.archived?"archived":l.is_done?"done":l.status==="due_soon"?"warning":l.status||"ok",s=l.archived?a("archived",t):l.is_done?a("completed",t):a(l.status||"ok",t);return o`
    <div class="task-header">
      <div class="task-header-title">
        <span class="task-name-breadcrumb" @click=${()=>c.showTaskView()}>${l.name}${It(l.next_event_titles)}</span>
        ...
        ${l.mirror_todo_entities?.length?o`<span class="nfc-badge mirror-badge" title="${a("task_mirror_todo",t)}: ${l.mirror_todo_entities.map(n=>String(c.hass?.states?.[n]?.attributes?.friendly_name??n)).join(", ")}"><ha-icon icon="mdi:clipboard-list-outline"></ha-icon></span>`:h}
  ...
  `}function ks(l){let c=l.lang;return o`
    <div class="tab-bar">
  ...
  `}function Li(l,c,t,e){let i=e.collapsedSections.has(l);return o`
  ...
  `}function $s(l,c){if(!Ge(l))return h;let t=c.lang,e=l.phase_sequence,i=We(l.phase_cursor,e.length),s=new Map;for(let n=l.history.length-1;n>=0;n--){let d=l.history[n];d.phase_id&&d.type==="completed"&&!s.has(d.phase_id)&&s.set(d.phase_id,d.timestamp)}return o`
  ...
  `}function js(l,c){if(!c.features.checklists)return h;let t=ie(l)?.checklist??(l.checklist||[]);if(t.length===0)return h;let e=c.lang,i=l.checklist_progress||{},s=t.filter(n=>i[n]).length;return o`
  ...
  `}function Ts(l,c){let t=at(l.documentation_url)?l.documentation_url:null,e=at(c.objectDocUrl)?c.objectDocUrl:null,i=e?null:(c.objectManualDocs||[])[0];if(!l.notes&&!t&&!e&&!i)return h;let s=c.lang;return o`
  ...
  `}function Ss(l,c){let t=c.lang,e=l.times_performed>0?l.total_cost/l.times_performed:0,i=l.days_until_due!==null&&l.days_until_due!==void 0?l.days_until_due<0?"overdue":l.days_until_due<=l.warning_days?"warning":"":"";return o`
    <div class="kpi-bar">
      <div class="kpi-card">
  ...
  `}function Es(l,c){let t=c.lang;if(!c.features.adaptive||!l.suggested_interval||l.suggested_interval===l.interval_days)return h;if(c.suggestionDismissed)return h;let e=l.suggested_interval;return o`
    <div class="recommendation-card">
      <h4>${a("suggested_interval",t)}</h4>
      ${ui(l.interval_days,e,l.interval_confidence||"medium",t)}
    ...
    <div class="tab-content overview-tab">
      ...
      <div class="two-column-layout ${s?"":"single-column"}">
        ...
        <div class="right-column">
          ${zi(l,t,c.costDurationToggle,r=>c.setCostDurationToggle(r),c.currencySymbol)}
        </div>
      </div>
      ${n?Li("weibull","weibull_reliability_curve",pi(l,t),c):h}
      ${d?Li("seasonal","seasonal_chart_title",o`
            ${mi(l,t)}
  ...
  `}function Cs(l,c){switch(c.activeTab){case"overview":return Os(l,c);case"history":return Ms(l,c);default:return h}}function Hi(l,c){return o`
  ...
  `}var Wt=class extends H{createRenderRoot(){return this}render(){return!this.task||!this.ctx?h:o`${Hi(this.task,this.ctx)}`}};g([S({attribute:!1})],Wt.prototype,"task",2),g([S({attribute:!1})],Wt.prototype,"ctx",2);customElements.get("maintenance-task-detail-view")||customElements.define("maintenance-task-detail-view",Wt);function Bi(l){if(l.total<=0)return{start:0,end:0,padTop:0,padBottom:0};let c=l.overscan??12,t=Math.max(1,l.step??6),e=Math.max(1,l.rowHeight),i=Math.floor((l.scrollTop-l.listTop)/e),s=Math.ceil(l.viewportHeight/e)+1,n=Math.max(0,i-c);n=Math.floor(n/t)*t;let d=Math.min(l.total,Math.max(i,0)+s+c);return d=Math.min(l.total,Math.ceil(d/t)*t),n>=d&&(n=Math.min(n,Math.max(0,l.total-1)),d=Math.min(l.total,n+Math.max(s,1))),{start:n,end:d,padTop:n*e,padBottom:(l.total-d)*e}}var ue={mode:"top",marginTop:0,lastScrollTop:0};function Ni(l,c){return l==="top"?8:c.viewH-c.paneH-8}function Fi(l){let c=l.scrollTop+8-l.layoutTop,t=Math.max(0,l.listH-l.paneH);return{mode:"top",marginTop:c>t?Math.max(0,c):0,lastScrollTop:l.scrollTop}}function qi(l,c){let t=c.scrollTop,e=c.scrollTop>l.lastScrollTop?"down":c.scrollTop<l.lastScrollTop?"up":"none",i=Math.max(0,c.listH-c.paneH),s=c.paneH+16<=c.viewH||c.listH<=c.paneH,{mode:n,marginTop:d}=l;if(s&&(n="top"),n==="top"&&d>0&&e==="up")d=Math.max(0,Math.min(d,c.scrollTop+8-c.layoutTop)),d<=i&&(d=0);else if(!s&&e==="down"&&n==="top"){let r=c.renderedTop-c.layoutTop;r<=i&&(n="bottom",d=Math.max(0,r))}else!s&&e==="up"&&n==="bottom"&&(d=Math.min(Math.max(0,c.renderedTop-c.layoutTop),i),c.scrollTop+8<=c.layoutTop+d&&(n="top",d=0));return{mode:n,marginTop:d,lastScrollTop:t}}var ge=2,As=250,Ot={objects:6,tasks:10,parts:6,documents:8,history:6},Ps="M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z",Ce=["due_date","object","type","task_name","area","assigned_user","group"],Vi=["none","area","group","user","object"],Is=["overdue","due_soon","triggered","ok"],Ui=["tasks","documents","parts","history"],w=class extends H{constructor(){super(...arguments);this.narrow=!1;this.tight=!1;this.split=!1;this._tightObserver=null;this.panel={};this.embedded=!1;this.presets={};this._presetsApplied=!1;this._mountPath=null;this._objects=[];this._stats=null;this._view="overview";this._allParts=null;this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._filterLabel=null;this._filterPriority="";this._savedViews=[];this._activeViewId="";this._unsub=null;this._chartRangeDays=(()=>{try{let t=parseInt(Z(D.chartRange)||"",10);return[7,30,90,365].includes(t)?t:30}catch{return 30}})();this._hideOutliers=(()=>{try{return Z(D.chartHideOutliers)==="1"}catch{return!1}})();this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._adminPanelUserIds=[];this._operatorWriteEnabled=!1;this._defaultWarningDays=7;this._rowActionStyle="buttons_compact";this._refsInLists=!1;this._rowActionNotice=!1;this._actionLoading=!1;this._moreMenuOpen=!1;this._objMenuOpen=!1;this._toastMessage="";this._toastUndo=null;this._toastActionLabel="";this._filtersOpen=!1;this._newMenuOpen=!1;this._gsSetupsCount=0;this._gsAdoptCount=0;this._gsLoaded=!1;this._batteryFleetSetupAvailable=!1;this._staleBundle=!1;this._staleChecked=!1;this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab=(()=>{try{let t=Z(D.overviewTab);return t==="today"||t==="calendar"?t:"dashboard"}catch{return"dashboard"}})();this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._objectViewMode="cards";this._objectsTableColumns=qe;this._showArchived=!1;this._bulkMode=!1;this._bulkSelected=new Set;this._objBulkMode=!1;this._objBulkSelected=new Set;this._bulkMenuOpen=!1;this._virtStart=0;this._virtEnd=0;this._virtRowHeight=53;this._virtTotalRows=0;this._virtScrollAttached=!1;this._virtRaf=0;this._stickyState=ue;this._stickySelectPending=!1;this._stickyRaf=0;this._stickyAttached=!1;this._stickyObserver=null;this._collapsedGroups=new Set;this._collapsedSections=(()=>{try{return new Set(JSON.parse(Z(D.collapsedSections)||"[]"))}catch{return new Set}})();this._objectSectionsCollapsed=(()=>{try{let t=JSON.parse(Z(D.objectSections)||"[]");return new Set((Array.isArray(t)?t:[]).filter(e=>Ui.includes(e)))}catch{return new Set}})();this._objectSectionOverride=null;this._paletteOpen=!1;this._paletteQuery="";this._paletteActive=0;this._searchRemote=null;this._searchTimer=null;this._searchSeq=0;this._templateGalleryOpen=!1;this._templates=[];this._homeProfile=null;this._templateCategories={};this._templateBusy=!1;this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=t=>this._onPopState(t);this._locationChangedHandler=()=>this._onLocationChanged();this._lazyUi=null;this._onStickyScroll=()=>{this._stickyRaf||(this._stickyRaf=requestAnimationFrame(()=>{this._stickyRaf=0,this._updateStickyPane()}))};this._onVirtualScroll=()=>{this._virtRaf||(this._virtRaf=requestAnimationFrame(()=>{this._virtRaf=0,this._updateVirtualWindow()}))};this._deepLinkHandled=!1;this._deepLinkInPlace=!1;this._initialLoadDone=!1;this._kpiRefreshInFlight=!1;this._kpiRefreshPending=!1;this._paletteKeydown=t=>{if(t.key==="/"&&!t.ctrlKey&&!t.metaKey&&!t.altKey&&!this._paletteOpen){let i=t.composedPath()[0];if(i instanceof HTMLElement&&(i.tagName==="INPUT"||i.tagName==="TEXTAREA"||i.tagName==="SELECT"||i.isContentEditable))return;t.preventDefault(),this._openPalette();return}if(!this._paletteOpen)return;let e=this._paletteResults;if(t.key==="Escape")t.preventDefault(),this._closePalette();else if(t.key==="ArrowDown")t.preventDefault(),this._paletteActive=Math.min(this._paletteActive+1,e.length-1);else if(t.key==="ArrowUp")t.preventDefault(),this._paletteActive=Math.max(this._paletteActive-1,0);else if(t.key==="Enter"){t.preventDefault();let i=e[this._paletteActive];i&&this._selectPaletteResult(i)}};this._onDialogEvent=async()=>{try{await this._loadData()}catch{}};this._onCalendarLlCustom=t=>{let e=t.detail;e?.type==="maintenance-supporter:open-task"&&e.entry_id&&e.task_id&&(t.stopPropagation(),this._showTask(e.entry_id,e.task_id))};this._fullHistory=null;this._onHistoryEntrySaved=async()=>{await this._loadData()}}get _currencySymbol(){return Qt(this._budget)}get _lang(){return U(this.hass)}get _isOperator(){let t=this.hass?.user;return t?t.is_admin?!1:!(this._operatorWriteEnabled&&this._adminPanelUserIds.includes(t.id)):!0}_ensureLazyUi(){return this._lazyUi||(this._lazyUi=Promise.all([import("/maintenance_supporter_panelfiles/panel-chunks/object-dialog-EELO4ZSS.js"),import("/maintenance_supporter_panelfiles/panel-chunks/task-dialog-BWRNPZXT.js"),import("/maintenance_supporter_panelfiles/panel-chunks/complete-dialog-GB2JILFS.js"),import("/maintenance_supporter_panelfiles/panel-chunks/qr-dialog-JK3EDVLN.js"),import("/maintenance_supporter_panelfiles/panel-chunks/adopt-problem-sensors-dialog-T2IGQVOY.js"),import("/maintenance_supporter_panelfiles/panel-chunks/suggested-setups-dialog-UJATT3UH.js"),import("/maintenance_supporter_panelfiles/panel-chunks/settings-view-7RBAD66D.js")]).then(()=>this.updateComplete)),this._lazyUi}async _ui(t){return await this._ensureLazyUi(),this.shadowRoot?.querySelector(t)??null}connectedCallback(){super.connectedCallback(),this._mountPath=window.location.pathname;let t=window.requestIdleCallback,e=()=>this._ensureLazyUi();t?t(e,{timeout:3e3}):window.setTimeout(e,1500),window.addEventListener("popstate",this._popstateHandler),window.addEventListener("location-changed",this._locationChangedHandler),window.addEventListener("keydown",this._paletteKeydown),typeof ResizeObserver<"u"&&(this._tightObserver=new ResizeObserver(i=>{let s=i[0]?.contentRect.width??0;s>0&&(this.tight=s<1e3),s>0&&(this.split=s>=1500)}),this._tightObserver.observe(this)),window.addEventListener("resize",this._onVirtualScroll,{passive:!0});try{let i=Z(D.taskSort);i&&Ce.includes(i)&&(this._sortMode=i);let s=Z(D.objectSort);s&&["alphabetical","due_soonest","task_count"].includes(s)&&(this._objectSortMode=s);let n=Z(D.groupBy);n&&Vi.includes(n)&&(this._groupByMode=n);let d=Z(D.objectView);(d==="cards"||d==="table")&&(this._objectViewMode=d)}catch{}if(this._objects.length===0){let i=yi();i&&(this._objects=i.objects,i.stats&&(this._stats=i.stats))}}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),window.removeEventListener("location-changed",this._locationChangedHandler),window.removeEventListener("keydown",this._paletteKeydown),this._tightObserver?.disconnect(),this._tightObserver=null,window.removeEventListener("resize",this._onVirtualScroll),this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onVirtualScroll),this._virtScrollAttached=!1,this._virtRaf&&cancelAnimationFrame(this._virtRaf),this._detachStickyPane(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._initialLoadDone=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=null),this._toastTimer&&(clearTimeout(this._toastTimer),this._toastTimer=null),this._toastMessage="",this._toastUndo=null,this._toastActionLabel="",this._statsService?.clearCache(),this._statsService=null}willUpdate(t){super.willUpdate(t),t.has("_groupByMode")&&this._collapsedGroups.size>0&&(this._collapsedGroups=new Set)}updated(t){if(super.updated(t),At(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new oe(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new Ze(this.hass),this._userService.getUsers())}let e=this.shadowRoot?.querySelector(".content");e&&!this._virtScrollAttached&&(e.addEventListener("scroll",this._onVirtualScroll,{passive:!0}),this._virtScrollAttached=!0),this._updateVirtualWindow(),this._syncStickyPane(e)}_syncStickyPane(t){let e=this.shadowRoot?.querySelector(".split-pane");if(!e||!t){this._stickyAttached&&this._detachStickyPane();return}this._stickyAttached||(t.addEventListener("scroll",this._onStickyScroll,{passive:!0}),window.addEventListener("resize",this._onStickyScroll),typeof ResizeObserver<"u"&&(this._stickyObserver=new ResizeObserver(this._onStickyScroll)),this._stickyAttached=!0),this._stickyObserver?.observe(e),this._updateStickyPane()}_detachStickyPane(){this.shadowRoot?.querySelector(".content")?.removeEventListener("scroll",this._onStickyScroll),window.removeEventListener("resize",this._onStickyScroll),this._stickyObserver?.disconnect(),this._stickyObserver=null,this._stickyRaf&&cancelAnimationFrame(this._stickyRaf),this._stickyRaf=0,this._stickyAttached=!1,this._stickyState=ue,this._stickySelectPending=!1}_updateStickyPane(){let t=this.shadowRoot,e=t?.querySelector(".content"),i=t?.querySelector(".split-pane"),s=t?.querySelector(".split-layout"),n=t?.querySelector(".split-list");if(!e||!i||!s||!n)return;let d=e.getBoundingClientRect().top-e.scrollTop,r={scrollTop:e.scrollTop,viewH:e.clientHeight,paneH:i.offsetHeight,listH:n.offsetHeight,layoutTop:s.getBoundingClientRect().top-d,renderedTop:i.getBoundingClientRect().top-d};this._stickySelectPending&&r.scrollTop===this._stickyState.lastScrollTop?this._stickyState=Fi(r):(this._stickySelectPending=!1,this._stickyState=qi(this._stickyState,r));let p=this._stickyState;i.style.top=`${Ni(p.mode,r)}px`,i.style.marginTop=p.marginTop>0?`${p.marginTop}px`:""}_resetStickyPane(){let t=this.shadowRoot?.querySelector(".content");this._stickyState={...ue,lastScrollTop:t?.scrollTop??0},this._stickySelectPending=!0}_updateVirtualWindow(){let t=this.shadowRoot?.querySelector(".content"),e=this.shadowRoot?.querySelector(".task-table.virtual");if(!t||!e)return;let i=e.querySelector(".task-row:not(.virt-sizer)");i&&i.offsetHeight>20&&(this._virtRowHeight=i.offsetHeight);let s=e.getBoundingClientRect().top-t.getBoundingClientRect().top+t.scrollTop,n=Bi({scrollTop:t.scrollTop,viewportHeight:t.clientHeight,listTop:s,rowHeight:this._virtRowHeight,total:this._virtTotalRows});(n.start!==this._virtStart||n.end!==this._virtEnd)&&(this._virtStart=n.start,this._virtEnd=n.end)}async _loadData(){let[t,e,i,s,n,d]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/views/list"}).catch(()=>null)]);if(d&&(this._savedViews=d.views||[]),t&&(this._objects=Vt(t.objects),we(this._objects,e??this._stats??null),this._maybeLoadGettingStarted()),this._detailOpen()&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/status"}).then(r=>{this._batteryFleetSetupAvailable=!!r.available&&!r.configured}).catch(()=>{this._batteryFleetSetupAvailable=!1}),this._staleChecked||(this._staleChecked=!0,this.hass.connection.sendMessagePromise({type:"maintenance_supporter/version"}).then(r=>{this._staleBundle=De(r?.version)}).catch(()=>{})),e&&(this._stats=e),i&&(this._budget=i,Lt(this._budget)),s&&(this._groups=s.groups||{}),n){let r=n;this._features=r.features,this._adminPanelUserIds=r.admin_panel_user_ids||[],this._operatorWriteEnabled=r.operator_write_enabled??!1;let p=r.general?.default_warning_days;typeof p=="number"&&p>=0&&p<=365&&(this._defaultWarningDays=p);let u=r.general?.row_action_style;this._rowActionStyle=u==="icons"||u==="buttons"?u:"buttons_compact",this._rowActionNotice=r.general?.row_action_notice_pending===!0,this._refsInLists=r.general?.ref_numbers_in_lists===!0,this._objectsTableColumns=Ve(r.objects_table_columns)}this._fetchMiniStatsForOverview(),this._initialLoadDone=!0,this._handleDeepLink()}_onLocationChanged(){if(!this._initialLoadDone||!window.location.search||this.embedded&&this._mountPath!==null&&window.location.pathname!==this._mountPath)return;if(!this.embedded){let e=`/${typeof this.panel?.url_path=="string"?this.panel.url_path:"maintenance-supporter"}`,i=window.location.pathname;if(i!==e&&!i.startsWith(`${e}/`))return}this._deepLinkHandled=!1,this._deepLinkInPlace=!0;try{this._handleDeepLink()}finally{this._deepLinkInPlace=!1}history.state?.msp_view||history.replaceState({msp_view:this._view,msp_entry:this._selectedEntryId,msp_task:this._selectedTaskId},"")}_handleDeepLink(){if(this._deepLinkHandled)return;let t=new URLSearchParams(window.location.search),e=t.get("ms_action"),i=()=>{let x=window.location.pathname+window.location.hash;history.replaceState(history.state,"",x)};if(e==="add_object"){this._deepLinkHandled=!0,i(),this._ui("maintenance-object-dialog").then(x=>x?.openCreate());return}if(e==="open_vacation"||e==="open_budget"||e==="open_groups"||e==="open_settings"){if(this._deepLinkHandled=!0,i(),!this.hass?.user?.is_admin)return;this._overviewTab="settings",this._ensureLazyUi().then(()=>requestAnimationFrame(()=>{let x=this.shadowRoot?.querySelector("maintenance-settings-view"),M=e.replace("open_","");x?.scrollToSection?.(M)}));return}if(this.embedded&&!this._presetsApplied){this._presetsApplied=!0;let x=this.presets?.tab??"",M=(this.presets?.view??"").trim();if(!t.has("tab")&&xe.includes(x)&&(x!=="settings"||this.hass?.user?.is_admin)&&(this._overviewTab=x),!t.has("view")&&M){let k=M.toLowerCase(),P=this._savedViews.find(O=>O.id===M)??this._savedViews.find(O=>O.name.trim().toLowerCase()===k);P&&(this._overviewTab="dashboard",this._applyView(P.id))}}let s=t.get("tab"),n=t.get("view"),d=t.get("sort"),r=t.get("status");if(s!==null||n!==null||d!==null||r!==null){if(i(),this._view!=="overview"&&(this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()),xe.includes(s??"")&&(s!=="settings"||this.hass?.user?.is_admin)&&this._setOverviewTab(s),n!==null){let x=n.trim().toLowerCase(),M=this._savedViews.find(k=>k.id===n)??this._savedViews.find(k=>k.name.trim().toLowerCase()===x);M&&(this._overviewTab!=="dashboard"&&this._setOverviewTab("dashboard"),this._applyView(M.id))}Ce.includes(d??"")&&(this._sortMode=d,this._activeViewId="",G(D.taskSort,this._sortMode)),Is.includes(r??"")&&(this._overviewTab!=="dashboard"&&this._setOverviewTab("dashboard"),this._filterByStatus(r))}let p=t.get("entry_id");if(!p)return;this._deepLinkHandled=!0;let u=t.get("task_id"),v=t.get("action"),_=t.get("section"),b=Ui.includes(_??"")?_:null,f=window.location.pathname+window.location.hash;history.replaceState(history.state,"",f);let R=this._getObject(p);if(!R){this._showOverview();return}if(u){let x=R.tasks.find(M=>M.id===u);if(!x){this._showObject(p,b);return}this._showTask(p,u),v==="complete"?requestAnimationFrame(()=>{this._openCompleteDialog(p,u,x.name,this._features.checklists?x.checklist:void 0,this._features.adaptive&&!!x.adaptive_config?.enabled)}):v==="quick_complete"&&requestAnimationFrame(()=>{this._handleQuickComplete(p,u,x)})}else this._showObject(p,b)}_isCounterEntity(t){if(!t)return!1;let e=t.type||"threshold";return e==="counter"||e==="state_change"}async _fetchDetailStats(t,e){if(!this._statsService)return;let i=await this._statsService.getDetailStats(t,e,this._chartRangeDays),s=new Map(this._detailStatsData);s.set(t,i),this._detailStatsData=s}_setChartRange(t){if(t===this._chartRangeDays)return;this._chartRangeDays=t;try{G(D.chartRange,String(t))}catch{}let e=this._selectedEntryId&&this._selectedTaskId?this._getTask(this._selectedEntryId,this._selectedTaskId):null,i=e?.trigger_config?.entity_id;if(i){let s=new Map(this._detailStatsData);s.delete(i),this._detailStatsData=s,this._fetchDetailStats(i,this._isCounterEntity(e.trigger_config))}}_setHideOutliers(t){if(t!==this._hideOutliers){this._hideOutliers=t;try{G(D.chartHideOutliers,t?"1":"0")}catch{}}}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let t=[];for(let i of this._objects)for(let s of i.tasks){let n=s.trigger_config?.entity_id;n&&t.push({entityId:n,isCounter:this._isCounterEntity(s.trigger_config)})}if(t.length===0)return;let e=await this._statsService.getBatchMiniStats(t);this._miniStatsData=new Map([...this._miniStatsData,...e])}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e,s=fi(this._objects,i);s!==null&&(this._objects=s,e.objects&&we(s,this._stats??null),this._refreshKpis(),this._detailOpen()&&(i.objects||(i.delta||[]).some(n=>n.entry_id===this._selectedEntryId))&&this._fetchFullHistory(this._selectedEntryId,this._selectedTaskId))},{type:"maintenance_supporter/subscribe",deltas:!0,compact:!0});if(!this.isConnected){t();return}this._unsub=t}catch{}}async _refreshKpis(){if(this._kpiRefreshInFlight){this._kpiRefreshPending=!0;return}this._kpiRefreshInFlight=!0;try{do{this._kpiRefreshPending=!1;let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null)]);if(!this.isConnected)return;t&&(this._stats=t),e&&(this._budget=e,Lt(this._budget))}while(this._kpiRefreshPending)}finally{this._kpiRefreshInFlight=!1}}get _taskRows(){let t=[];for(let v of this._objects)for(let _ of v.tasks){if(!this._showArchived&&_.archived||this._filterStatus&&_.status!==this._filterStatus)continue;if(this._filterUser){let f=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(_.responsible_user_id!==f)continue}if(this._filterLabel&&!(_.labels||[]).includes(this._filterLabel)||this._filterPriority&&(_.priority||"normal")!==this._filterPriority)continue;let b=[];for(let f of Object.values(this._groups))f.task_refs?.some(R=>R.entry_id===v.entry_id&&R.task_id===_.id)&&b.push(f.name);t.push({entry_id:v.entry_id,task_id:_.id,object_name:v.object.name,allow_skip:_.allow_skip!==!1,notify_enabled:_.notify_enabled!==!1,task_name:_.name,type:_.type,schedule_type:_.schedule_type,status:_.status,days_until_due:_.days_until_due??null,next_due:_.next_due??null,next_event_titles:_.next_event_titles??[],trigger_active:_.trigger_active,trigger_current_value:_.trigger_current_value??null,trigger_current_delta:_.trigger_current_delta??null,trigger_config:_.trigger_config??null,trigger_entity_info:_.trigger_entity_info??null,times_performed:_.times_performed,total_cost:_.total_cost,interval_days:_.interval_days??null,interval_unit:_.interval_unit??null,interval_anchor:_.interval_anchor??null,is_done:_.is_done??!1,archived:_.archived??!1,history:_.history||[],enabled:_.enabled,nfc_tag_id:_.nfc_tag_id??null,priority:_.priority??"normal",labels:_.labels??[],area_id:v.object.area_id??null,responsible_user_id:_.responsible_user_id??null,group_names:b})}let e={overdue:0,triggered:1,due_soon:2,ok:3},i=(v,_)=>(e[v.status]??9)-(e[_.status]??9),s=(v,_)=>(v.days_until_due??99999)-(_.days_until_due??99999),n=(v,_)=>i(v,_)||s(v,_),d=v=>v.area_id&&this.hass?.areas?.[v.area_id]?.name||"",r=v=>v.responsible_user_id&&this._userService?.getUserName(v.responsible_user_id)||"",p=v=>v.group_names[0]||"",u={due_date:n,object:(v,_)=>v.object_name.localeCompare(_.object_name)||n(v,_),type:(v,_)=>v.type.localeCompare(_.type)||n(v,_),task_name:(v,_)=>v.task_name.localeCompare(_.task_name),area:(v,_)=>{let b=d(v),f=d(_);return!b&&f?1:b&&!f?-1:b.localeCompare(f)||n(v,_)},assigned_user:(v,_)=>{let b=r(v),f=r(_);return!b&&f?1:b&&!f?-1:b.localeCompare(f)||n(v,_)},group:(v,_)=>{let b=p(v),f=p(_);return!b&&f?1:b&&!f?-1:b.localeCompare(f)||n(v,_)}};return t.sort(u[this._sortMode]),t}_getObject(t){return this._objects.find(e=>e.entry_id===t)}_getTask(t,e){return this._getObject(t)?.tasks.find(s=>s.id===e)}_listRef(t,e){if(!this._refsInLists)return h;let i=this._getObject(t);return Dt(xt(i?.object,i?.tasks.find(s=>s.id===e)))}_objRef(t){return this._refsInLists?Dt(yt(t)):h}_pushPanelState(t,e,i){let s={msp_view:t,msp_entry:e||null,msp_task:i||null};this._deepLinkInPlace?history.replaceState(s,""):history.pushState(s,"")}_onPopState(t){let e=t.state;if(e?.msp_view&&(this._view=e.msp_view,this._selectedEntryId=e.msp_entry||null,this._selectedTaskId=e.msp_task||null,this._moreMenuOpen=!1,this._objectSectionOverride=null,e.msp_view==="all_parts"&&this._loadAllParts(),e.msp_view==="task"&&e.msp_entry&&e.msp_task)){this._historyFilter=null;let i=this._getTask(e.msp_entry,e.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1,this._scrollContentToTop()}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._objBulkMode=!1,this._objBulkSelected=new Set,this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop()}_showAllParts(){this._pushPanelState("all_parts"),this._view="all_parts",this._selectedEntryId=null,this._selectedTaskId=null,this._scrollContentToTop(),this._loadAllParts()}async _loadAllParts(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"});this._allParts=t.parts||[]}catch{this._allParts=[]}}_filterByStatus(t){this._filterStatus=t,this._activeViewId="",this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard"),this._scrollContentToTop()}get _allLabels(){let t=new Set;for(let e of this._objects)for(let i of e.tasks)for(let s of i.labels||[])t.add(s);return[...t].sort((e,i)=>e.localeCompare(i))}get _currentFilters(){return{status:this._filterStatus,user_id:this._filterUser,label:this._filterLabel,priority:this._filterPriority,archived:this._showArchived,sort_mode:this._sortMode,group_by:this._groupByMode}}_applyView(t){if(this._activeViewId=t,!t)return;let e=this._savedViews.find(s=>s.id===t);if(!e)return;let i=e.filters;this._filterStatus=i.status||"",this._filterUser=i.user_id||null,this._filterLabel=i.label||null,this._filterPriority=i.priority||"",this._showArchived=!!i.archived,Ce.includes(i.sort_mode)&&(this._sortMode=i.sort_mode),Vi.includes(i.group_by)&&(this._groupByMode=i.group_by);try{G(D.taskSort,this._sortMode),G(D.groupBy,this._groupByMode)}catch{}this._overviewTab!=="dashboard"&&(this._overviewTab="dashboard")}_openSavedViewsDialog(){this.shadowRoot.querySelector("maintenance-saved-views-dialog")?.open(this._currentFilters,this._savedViews)}_onSavedViewsChanged(t){this._savedViews=t.detail.views||[],this._activeViewId&&!this._savedViews.some(e=>e.id===this._activeViewId)&&(this._activeViewId="")}_scrollContentToTop(){requestAnimationFrame(()=>{let t=this.shadowRoot?.querySelector(".content");t&&t.scrollTo({top:0,behavior:"smooth"})})}_showObject(t,e=null){this._pushPanelState("object",t),this._view="object",this._selectedEntryId=t,this._selectedTaskId=null,this._objectSectionOverride=e,e?this._scrollToObjectSection(e):this._scrollContentToTop()}_scrollToObjectSection(t){this.updateComplete.then(()=>requestAnimationFrame(()=>{let e=this.shadowRoot?.querySelector(`.obj-section[data-section="${t}"]`);e?e.scrollIntoView({block:"start",behavior:"smooth"}):this._scrollContentToTop()}))}_toggleObjectSection(t){let e=new Set(this._objectSectionsCollapsed);this._objectSectionOverride===t||!e.has(t)?e.add(t):e.delete(t),this._objectSectionOverride===t&&(this._objectSectionOverride=null),this._objectSectionsCollapsed=e,G(D.objectSections,JSON.stringify([...e]))}_splitActive(){return this.split&&!this.narrow&&!this.tight&&this._view==="overview"&&this._overviewTab==="dashboard"&&!this._bulkMode}_detailOpen(){return(this._view==="task"||this._splitActive())&&!!this._selectedEntryId&&!!this._selectedTaskId}_showFullTaskPage(t,e){this._view!=="task"&&(this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._scrollContentToTop())}_showTask(t,e){if(this._splitActive()){this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._historySearch="",this._resetStickyPane(),this._fetchFullHistory(t,e);let s=this._getTask(t,e);s?.trigger_config?.entity_id&&this._fetchDetailStats(s.trigger_config.entity_id,this._isCounterEntity(s.trigger_config));return}this._pushPanelState("task",t,e),this._view="task",this._selectedEntryId=t,this._selectedTaskId=e,this._activeTab="overview",this._historyFilter=null,this._historySearch="",this._scrollContentToTop(),this._fetchFullHistory(t,e);let i=this._getTask(t,e);if(i?.trigger_config?.entity_id){let s=i.trigger_config.entity_id,n=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(s,n)}}_showToast(t){this._toastTimer&&clearTimeout(this._toastTimer),this._toastUndo=null,this._toastActionLabel="",this._toastMessage=t,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}_showActionToast(t,e,i){this._showUndoToast(t,i),this._toastActionLabel=e}_showUndoToast(t,e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastActionLabel="",this._toastMessage=t,this._toastUndo=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastUndo=null,this._toastTimer=null},7e3)}_runToastUndo(){let t=this._toastUndo;this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage="",this._toastUndo=null,this._toastTimer=null,t?.()}_openPalette(){this._paletteQuery="",this._paletteActive=0,this._paletteOpen=!0,this._searchRemote=null,this.updateComplete.then(()=>{this.shadowRoot?.querySelector(".palette-input")?.focus()})}_closePalette(){this._paletteOpen=!1,this._paletteQuery="",this._searchRemote=null,this._searchTimer&&(clearTimeout(this._searchTimer),this._searchTimer=null)}_onPaletteInput(t){this._paletteQuery=t,this._paletteActive=0,this._searchTimer&&clearTimeout(this._searchTimer);let e=t.trim();if(e.length<ge){this._searchRemote=null;return}this._searchTimer=setTimeout(()=>{this._searchTimer=null;let i=++this._searchSeq;this.hass.connection.sendMessagePromise({type:"maintenance_supporter/search",query:e,limit:Ot.documents}).then(s=>{i!==this._searchSeq||!this._paletteOpen||(this._searchRemote={query:e,documents:s.documents||[],history:s.history||[]})}).catch(()=>{i!==this._searchSeq||!this._paletteOpen||(this._searchRemote={query:e,documents:[],history:[]})})},As)}get _paletteResults(){let t=this._lang,e=this._paletteQuery.trim();if(e.length<ge&&!Yt(e))return[];let i=Gt(e);if(!i.length)return[];let s=[],n=[],d=[],r=Yt(e);if(r){for(let _ of this._objects){let b=_.object;if(b.ref_no!==r.object)continue;let f=yt(b),R=(x,M)=>x?[M,a("archived",t)].filter(Boolean).join(" \xB7 "):M;r.task==null&&s.push({kind:"object",entryId:_.entry_id,label:b.name||"",sub:R(b.archived,a("object",t)),score:1e3,icon:"mdi:package-variant-closed",ref:f});for(let x of _.tasks)r.task!=null&&x.ref_no!==r.task||n.push({kind:"task",entryId:_.entry_id,taskId:x.id,label:x.name||"",sub:R(x.archived||b.archived,b.name||""),score:r.task==null?900:1e3,icon:"mdi:clipboard-check-outline",ref:xt(b,x)})}if(s.length||n.length){let _=this._searchRemote&&this._searchRemote.query===e?this._searchRemote:null,b=[...s,...n.slice(0,Ot.tasks)];for(let f of _?.history.slice(0,1)??[])b.push({kind:"history",entryId:f.entry_id,taskId:f.task_id,label:f.task_name||"",sub:[f.object_name,f.timestamp?Q(f.timestamp,t):""].filter(Boolean).join(" \xB7 "),snippet:f.snippet||"",score:f.score,icon:"mdi:note-text-outline",ref:f.ref??null});return b}}for(let _ of this._objects){let b=_.object;if(b.archived)continue;let f=b.name||"",R=Ct(i,[{text:f,weight:3},{text:b.manufacturer,weight:2},{text:b.model,weight:2},{text:b.serial_number,weight:2},{text:b.notes,weight:1}]);if(R>0){let x=[b.manufacturer,b.model].filter(Boolean).join(" ");s.push({kind:"object",entryId:_.entry_id,label:f,sub:x||a("object",t),score:R,icon:"mdi:package-variant-closed",ref:yt(b)})}for(let x of _.tasks){if(x.archived)continue;let M=(x.labels||[]).join(" "),k=Ct(i,[{text:x.name,weight:3},{text:f,weight:2},{text:M,weight:2},{text:x.notes,weight:1}]);if(k>0){let P=(x.labels||[]).length?`  #${(x.labels||[]).join(" #")}`:"";n.push({kind:"task",entryId:_.entry_id,taskId:x.id,label:x.name||"",sub:f+P,score:k,icon:"mdi:clipboard-check-outline",ref:xt(b,x)})}}for(let x of _.parts||[]){let M=Ct(i,[{text:x.name,weight:3},{text:x.mpn,weight:2},{text:x.vendor,weight:1},{text:x.storage_location,weight:1},{text:x.notes,weight:1}]);M>0&&d.push({kind:"part",entryId:_.entry_id,label:x.name||"",sub:[f,x.mpn].filter(Boolean).join(" \xB7 "),score:M,icon:"mdi:cog-outline"})}}let p=(_,b)=>b.score-_.score||_.label.localeCompare(b.label),u=[...s.sort(p).slice(0,Ot.objects),...n.sort(p).slice(0,Ot.tasks),...d.sort(p).slice(0,Ot.parts)],v=this._searchRemote&&this._searchRemote.query===e?this._searchRemote:null;if(v){let _=v.documents.slice(0,Ot.documents);for(let b of[..._.filter(f=>f.match!=="content"),..._.filter(f=>f.match==="content")])u.push({kind:b.match==="content"?"content":"document",entryId:b.entry_id,docId:b.id,docKind:b.kind,url:b.url,page:b.page??null,label:b.title||b.filename||b.url||"",sub:b.object_name||"",snippet:b.snippet||"",score:b.score,icon:b.kind==="weblink"?"mdi:link-variant":"mdi:file-document-outline"});for(let b of v.history.slice(0,Ot.history))u.push({kind:"history",entryId:b.entry_id,taskId:b.task_id,label:b.task_name||"",ref:b.ref??null,sub:[b.object_name,b.timestamp?Q(b.timestamp,t):""].filter(Boolean).join(" \xB7 "),snippet:b.snippet||"",score:b.score,icon:b.type==="skipped"?"mdi:skip-next-circle-outline":"mdi:note-text-outline"})}return u}_selectPaletteResult(t){let e=this._paletteQuery.trim();switch(this._closePalette(),t.kind){case"task":t.taskId&&this._showTask(t.entryId,t.taskId);return;case"history":if(!t.taskId)return;this._showTask(t.entryId,t.taskId),this._activeTab="history",this._historySearch=e;return;case"document":case"content":t.docKind==="weblink"?at(t.url)&&window.open(t.url,"_blank","noopener"):t.docId&&wt(this.hass,t.docId,t.page?`#page=${t.page}`:"").catch(()=>{}),this._showObject(t.entryId,"documents");return;case"part":this._showObject(t.entryId,"parts");return;default:this._showObject(t.entryId)}}_renderPalette(){if(!this._paletteOpen)return h;let t=this._lang,e=this._paletteResults,i=this._paletteQuery.trim(),s={object:a("objects",t),task:a("tasks",t),part:a("search_group_parts",t),document:a("documents",t),content:a("search_group_content",t),history:a("search_group_history",t)},n=i.length>=ge&&(!this._searchRemote||this._searchRemote.query!==i),d=null;return o`
      <div class="palette-backdrop" @click=${()=>this._closePalette()}>
        <div class="palette" role="dialog" aria-label=${a("search_open",t)} @click=${r=>r.stopPropagation()}>
          ...
          <div class="palette-results">
            ${i.length<ge&&!Yt(i)?o`<div class="palette-empty">${a("search_empty_hint",t)}</div>`:e.length===0?o`<div class="palette-empty">${n?a("search_searching",t):a("palette_no_results",t)}</div>`:e.map((r,p)=>{let u=r.kind!==d?o`<div class="palette-group">${s[r.kind]}</div>`:h;return d=r.kind,o`
                      ${u}
    ...
    `}_openAdoptProblemSensors(){this._ui("maintenance-adopt-problem-sensors-dialog").then(t=>t?.open())}async _onProblemSensorsAdopted(t){let e=t.detail?.tasks_created??0,i=t.detail?.created??[];await this._loadData();let s=a("adopt_problem_done",this._lang).replace("{tasks}",String(e));i.length>0?this._showActionToast(s,a("adopt_problem_configure",this._lang),()=>{let n=i[0],d=this._objects.find(p=>p.entry_id===n.entry_id),r=d?.tasks.find(p=>p.id===n.task_id);d&&r&&this._ui("maintenance-task-dialog").then(p=>p?.openEdit(n.entry_id,r))}):this._showToast(s)}async _setupBatteryFleet(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/battery_fleet/setup",language:this.hass.language||"en"});this._batteryFleetSetupAvailable=!1,await this._loadData();let e=this._objects.find(s=>s.entry_id===t.entry_id),i=e?.tasks.find(s=>s.id===t.task_id)||e?.tasks[0];e&&i&&this._showTask(e.entry_id,i.id),this._showToast(a("battery_fleet_setup_done",this._lang))}catch(t){this._showToast(A(t,this._lang))}}_openSuggestedSetups(){this._ui("maintenance-suggested-setups-dialog").then(t=>t?.open())}_onSetupsAdopted(t){let e=t.detail?.tasks_created??0;this._showToast(a("setups_done",this._lang).replace("{tasks}",String(e))),this._loadData()}async _openTemplateGallery(){this._templateGalleryOpen=!0;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/templates",language:this._lang});this._templateCategories=t.categories||{},this._templates=(t.templates||[]).filter(e=>!e.disabled),this._homeProfile=t.profile??null}catch{this._showToast(a("action_error",this._lang))}}async _createFromTemplate(t){this._templateBusy=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/from_template",language:this._lang,template_id:t});this._templateGalleryOpen=!1,await this._loadData(),this._showToast(a("template_created",this._lang)),e?.entry_id&&this._showObject(e.entry_id)}catch{this._showToast(a("action_error",this._lang))}finally{this._templateBusy=!1}}_categoryName(t){let e=this._templateCategories[t];return e&&(e[`name_${this._lang}`]||e.name_en)||t}_renderTemplateCard(t,e=!1){let i=this._lang,s=this._homeProfile?.country??null;return o`
      <button class="template-card ${t.dwelling_mismatch?"not-typical":""}" .disabled=${this._templateBusy}
        ...
        <span class="template-card-count">${a("templates_task_count",i).replace("{n}",String(t.tasks.length))}</span>
        ${e&&t.reasons?.length?o`<span class="template-card-reasons">
              ${t.reasons.map(n=>o`<span class="template-card-reason">${Ye(n,i,s)}</span>`)}
            </span>`:h}
      </button>
    `}_renderTemplateGallery(){if(!this._templateGalleryOpen)return h;let t=this._lang,e=new Map;for(let s of this._templates)e.has(s.category)||e.set(s.category,[]),e.get(s.category).push(s);for(let s of e.values())s.sort((n,d)=>+!!n.dwelling_mismatch-+!!d.dwelling_mismatch);let i=this._templates.filter(s=>s.recommended);return o`
          ...
          <div class="template-gallery-body">
            ...
            ${this._templates.length===0?o`<div class="palette-empty">${a("loading",t)}…</div>`:[...e.entries()].map(([s,n])=>o`
                  <div class="template-cat">
                    ...
                    <div class="template-grid">${n.map(d=>this._renderTemplateCard(d))}</div>
                  </div>
                `)}
          </div>
        </div>
      </div>
    `}_bulkKey(t){return`${t.entry_id}:${t.task_id}`}_toggleBulkMode(){this._bulkMode=!this._bulkMode,this._bulkMenuOpen=!1,this._bulkMode||(this._bulkSelected=new Set)}_toggleBulkRow(t){let e=this._bulkKey(t),i=new Set(this._bulkSelected);i.has(e)?i.delete(e):i.add(e),this._bulkSelected=i}_bulkSelectAll(t){let e=t.map(s=>this._bulkKey(s)),i=e.every(s=>this._bulkSelected.has(s));this._bulkSelected=i?new Set:new Set(e)}async _runBulk(t,e,i,s){let n=t.filter(r=>this._bulkSelected.has(this._bulkKey(r)));if(n.length===0)return;this._actionLoading=!0;let d=0;for(let r of n)try{await this.hass.connection.sendMessagePromise(e(r)),d++}catch{}this._actionLoading=!1,this._bulkSelected=new Set,this._bulkMode=!1,await this._loadData(),s&&d>0?this._showUndoToast(i(d),s):this._showToast(i(d))}async _bulkMove(t){let e=this._objects.filter(d=>!d.object.archived_at).sort((d,r)=>(d.object.name||"").localeCompare(r.object.name||""));if(!e.length||this._bulkSelected.size===0)return;let s=await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.prompt({title:a("move_task_title",this._lang),message:a("bulk_move_message",this._lang),confirmText:a("move_task_title",this._lang),inputLabel:a("move_task_target",this._lang),inputValue:e[0].entry_id,options:e.map(d=>({value:d.entry_id,label:d.object.name||d.entry_id}))});if(!s?.confirmed||!s.value)return;let n=s.value;await this._runBulk(t.filter(d=>d.entry_id!==n),d=>({type:"maintenance_supporter/task/move",entry_id:d.entry_id,task_id:d.task_id,target_entry_id:n}),d=>a("bulk_moved",this._lang).replace("{n}",String(d)))}_toggleObjBulkMode(){this._objBulkMode=!this._objBulkMode,this._objBulkMode||(this._objBulkSelected=new Set)}_toggleObjBulk(t){let e=new Set(this._objBulkSelected);e.has(t)?e.delete(t):e.add(t),this._objBulkSelected=e}_objBulkSelectAll(t){let e=t.map(s=>s.entry_id),i=e.length>0&&e.every(s=>this._objBulkSelected.has(s));this._objBulkSelected=i?new Set:new Set(e)}async _runObjBulk(t,e,i){let s=[...this._objBulkSelected];if(s.length===0)return;this._actionLoading=!0;let n=[];for(let d of s)try{await this.hass.connection.sendMessagePromise({type:t,entry_id:d}),n.push(d)}catch{}this._actionLoading=!1,this._objBulkSelected=new Set,this._objBulkMode=!1,await this._loadData(),i&&n.length>0?this._showUndoToast(e(n.length),()=>{i(n)}):this._showToast(e(n.length))}async _objBulkDelete(){let t=this._objBulkSelected.size;t===0||!await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:a("delete",this._lang),message:a("bulk_delete_objects_confirm",this._lang).replace("{n}",String(t)),confirmText:a("delete",this._lang),danger:!0})||await this._runObjBulk("maintenance_supporter/object/delete",s=>a("bulk_objects_deleted",this._lang).replace("{n}",String(s)))}_objBulkArchive(){this._runObjBulk("maintenance_supporter/object/archive",t=>a("bulk_objects_archived",this._lang).replace("{n}",String(t)),async t=>{for(let e of t)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/unarchive",entry_id:e})}catch{}await this._loadData()})}_renderObjBulkBar(t,e){let i=this._objBulkSelected.size,s=t.length>0&&t.every(n=>this._objBulkSelected.has(n.entry_id));return o`
    ...
    `}_statusBadge(t,e,i){let s=this._lang,n=t?"archived":e?"done":i,d=t?"archived":e?"completed":i,r=t?a("archived",s):e?a("completed",s):a(i,s);return o`<span class="status-badge ${n}" role="img" title="${r}" aria-label="${r}"><ha-icon icon="${Pe[d]||"mdi:circle-medium"}"></ha-icon><span class="status-label">${r}</span></span>`}_setOverviewTab(t){this._overviewTab=t;try{G(D.overviewTab,t)}catch{}this._scrollContentToTop()}_renderToday(){let t=this._lang,e=this._taskRows,i=p=>`${p.entry_id}:${p.task_id}`,s=e.filter(p=>p.status==="overdue"||p.trigger_active),n=new Set(s.map(i)),d=e.filter(p=>!n.has(i(p))&&p.days_until_due===0);d.forEach(p=>n.add(i(p)));let r=e.filter(p=>!n.has(i(p))&&p.days_until_due!=null&&p.days_until_due>0&&p.days_until_due<=7);return s.length+d.length+r.length===0?o`
        ...
        ${e.map(d=>o`
          <div class="today-row" @click=${()=>this._showTask(d.entry_id,d.task_id)}>
            ...
            <div class="today-main">
              <div class="today-task">${this._listRef(d.entry_id,d.task_id)}${d.task_name}${It(d.next_event_titles)}</div>
              <div class="today-object">
                <span class="today-object-text">${d.object_name} · ${jt(d.days_until_due,s)}</span>
                ${ve(n(d),"today-person")}
              </div>
            </div>
    ...
    `}_toggleGroup(t){let e=new Set(this._collapsedGroups);e.has(t)?e.delete(t):e.add(t),this._collapsedGroups=e}_warrantyLabel(t,e,i){return t.kind==="expired"?a("warranty_expired",i):t.kind==="expiring"?a("warranty_expires_in",i).replace("{days}",String(t.days??0)):a("warranty_valid_until",i).replace("{date}",Q(e,i))}_renderWarrantyMeta(t,e){let i=ke(t);return o`<p class="meta">${a("warranty",e)}:
      <span class="warranty-chip warranty-${i.kind}">${this._warrantyLabel(i,t,e)}</span></p>`}_renderAllObjects(){let t=this._lang,e=this._isOperator,i=this._objectViewMode==="table"&&!this.narrow,s=this._objects.filter(u=>u.object.archived).length,n=u=>{let v=1/0;for(let _ of u.tasks){let b=_.days_until_due;b!=null&&b<v&&(v=b)}return v},d=this._objects.filter(u=>this._showArchived||!u.object.archived);this._objectSortMode==="alphabetical"?d.sort((u,v)=>u.object.name.localeCompare(v.object.name)):this._objectSortMode==="task_count"?d.sort((u,v)=>v.tasks.length-u.tasks.length||u.object.name.localeCompare(v.object.name)):d.sort((u,v)=>n(u)-n(v)||u.object.name.localeCompare(v.object.name));let r=()=>{let u=new Map;for(let v of d){let _=v.object.area_id,b=_?this.hass?.areas?.[_]?.name||a("unassigned",t):a("no_area",t);u.has(b)||u.set(b,[]),u.get(b).push(v)}return new Map([...u.entries()].sort(([v],[_])=>v.localeCompare(_)))},p=u=>{let v=u.tasks.some(_=>_.status==="overdue"||_.status==="triggered");return o`
        <div class="object-card${v?" object-card-overdue":""}${this._objBulkMode?" selectable":""}${this._objBulkMode&&this._objBulkSelected.has(u.entry_id)?" bulk-selected":""}"
          ...
          ${v?o`<span class="overdue-dot" title="${a("has_overdue",t)}"></span>`:h}
    ...
    `}_setObjectViewMode(t){this._objectViewMode=t;try{G(D.objectView,t)}catch{}}_renderAllParts(){let t=this._lang,e=this._allParts,i=this._currencySymbol;return o`
      ...
      ${e===null?o`<div class="empty-state">…</div>`:e.length===0?o`<div class="empty-state">${a("parts_section",t)}: 0</div>`:o`
        ...
        `}
    `}_exportPartsCsv(){let t=this._allParts||[],e=d=>{let r=d==null?"":String(d);return/[",\n;]/.test(r)?`"${r.replace(/"/g,'""')}"`:r},s=[["name","object","stock","unit","reorder_threshold","unit_cost","storage_location","vendor","used_by"].join(",")];for(let d of t)s.push([e(d.name),e(d.object_name),e(d.stock),e(d.unit),e(d.reorder_threshold),e(d.cost),e(d.storage_location),e(d.vendor),e(d.consumers.map(r=>`${r.object_name??""}/${r.task_name??r.task_id}\xD7${r.quantity}`).join(" | "))].join(","));let n=qt(new Date);_e(s.join(`
`),`maintenance_parts_${n}.csv`,"text/csv;charset=utf-8")}async _exportObjectsCsv(){let t=await fe(this,{type:"maintenance_supporter/objects/csv"},{onError:i=>this._showToast(i)});if(!t)return;let e=qt(new Date);_e(t.csv,`maintenance_objects_${e}.csv`,"text/csv;charset=utf-8")}_renderObjectsTable(t){let e=this._lang,i=this._objectsTableColumns;return o`
        ...
        <table class="objects-table">
          <thead>
            <tr>
              ...
              ${i.map(s=>{let n=Fe.find(r=>r.key===s),d=n&&n.key!=="actions"?a(n.labelKey,e):"";return o`<th class="oc-${s}">${d}</th>`})}
            </tr>
          </thead>
          <tbody>
            ${t.map(s=>o`
              <tr class="objects-table-row${this._objBulkMode&&this._objBulkSelected.has(s.entry_id)?" bulk-selected":""}"
                ...
                ${this._objBulkMode?o`<td class="oc-bulk"><input type="checkbox" .checked=${this._objBulkSelected.has(s.entry_id)}
                      @click=${n=>n.stopPropagation()} @change=${()=>this._toggleObjBulk(s.entry_id)} /></td>`:h}
    ...
    `}_actionStyle(){return this._rowActionStyle}async _dismissRowActionNotice(t){let e={row_action_notice_pending:!1};t&&(e.row_action_style="icons"),await fe(this,{type:"maintenance_supporter/global/update",settings:e},{onError:s=>this._showToast(s)})!==void 0&&(this._rowActionNotice=!1,t&&(this._rowActionStyle="icons"),_i())}_renderRowActions(t,e,i,s=!0){let n=this._actionStyle();return n==="buttons"||n==="buttons_compact"?n==="buttons_compact"&&(this.narrow||this.tight)?o`
      ...
      <div class="detail-section">
        ...
        ${this._renderObjectSection("tasks",a("tasks",i),d.length,()=>o`
        ...
        ${t.tasks.length===0?o`<div class="empty-state-centered">
              ...
              <div class="task-row${r.enabled?"":" task-disabled"}">
                ...
                <span class="cell task-name" @click=${()=>this._showTask(t.entry_id,r.id)}>${this._listRef(t.entry_id,r.id)}${r.name}${It(r.next_event_titles)}</span>
    ...
    `}_renderObjectSection(t,e,i,s){let n=this._lang,d=this._objectSectionOverride===t||!this._objectSectionsCollapsed.has(t),r=d?a("section_collapse",n):a("section_expand",n);return o`
      <div class="obj-section ${t} ${d?"open":"collapsed"}" data-section=${t}>
        ...
        ${d?o`<div class="obj-section-body">${s()}</div>`:o`<h3 class="obj-section-title" @click=${()=>this._toggleObjectSection(t)}>
