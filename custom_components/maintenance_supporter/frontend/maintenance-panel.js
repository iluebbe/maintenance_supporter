/*! maintenance_supporter frontend 2.71.0 */
import{a as ge,b as Ft,c as vt,d as Nt,e as Ct,f as me,g as _e,h as ve}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-KW56PUC2.js";import{a as W,b as Bt,c as Ut,d as fe,e as ye,f as Vt,g as xe,h as we,i as $e,j as Te,k as je,l as Se,m as Ee,n as Me,o as Ce,p as Re,w as Oe,z as De}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-URVYTDYA.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-WRWSJ7UC.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-QY4FRR7I.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-7LDVTUFN.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-MWOPP4FC.js";import{b as be}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-VEXWU2UX.js";import"/maintenance_supporter_panelfiles/panel-chunks/chunk-PWDZAPHJ.js";import{a as te}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-BQCLT4RW.js";import{a as ke}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-JSPW4Q6Q.js";import{a as S}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-TR26N2BJ.js";import{A as Et,B as Mt,C as ue,D as Ht,a as g,b as R,c as o,d as F,f as p,h as O,i as Jt,j as de,k as pe,l as w,m,n as zt,o as It,p as Pt,q as a,r as Lt,s as L,t as he,u as Y,v as U,w as $t,x as _t}from"/maintenance_supporter_panelfiles/panel-chunks/chunk-AASUTC7C.js";var ni=["assignee_pool","required_completion_fields","checklist","labels","history"],li=["checklist_progress"],ci=["tasks","parts"],di=["manual_docs","battery_fleet_excluded"];function ee(r,l,t=[]){for(let e of l)r[e]===void 0&&(r[e]=[]);for(let e of t)r[e]===void 0&&(r[e]={})}function pi(r){let l=r;ee(l,ci),l.object&&typeof l.object=="object"&&ee(l.object,di);for(let t of l.tasks)ee(t,ni,li);return r}function Rt(r){for(let l of r)pi(l);return r}function hi(r,l){if(l.objects)return l.objects;let t=l.delta||[],e=l.removed||[];if(!t.length&&!e.length)return null;let i=new Map(r.map(s=>[s.entry_id,s]));for(let s of t)i.set(s.entry_id,s);for(let s of e)i.delete(s);return[...i.values()]}function Ae(r,l){return l.objects&&Rt(l.objects),l.delta&&Rt(l.delta),hi(r,l)}var A={overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view",objectsCache:"msp-objects-cache",gettingStartedDismissed:"msp-gs-dismissed",batteryRosterSort:"ms_bf_roster_sort"};function Z(r){try{return localStorage.getItem(r)}catch{return null}}function q(r,l){try{localStorage.setItem(r,l)}catch{}}var ui=168*3600*1e3;function ze(){try{let r=Z(A.objectsCache);if(!r)return null;let l=JSON.parse(r);return l.v!==Jt||!Number.isFinite(l.at)||Date.now()-l.at>ui||!Array.isArray(l.objects)||l.objects.length===0?null:{objects:l.objects,stats:l.stats??null}}catch{return null}}function ie(r,l){if(!(!Array.isArray(r)||r.length===0))try{let t={v:Jt,at:Date.now(),objects:r,stats:l};q(A.objectsCache,JSON.stringify(t))}catch{}}function D(r){return String(r??"").replace(/[&<>"']/g,l=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[l])}function Ie(r,l,t,e,i,s){let n=[[t.manufacturer,r.manufacturer],[t.model,r.model],[t.serial,r.serial_number],[t.installed,r.installation_date?e(r.installation_date):null],[t.warranty,r.warranty_expiry?e(r.warranty_expiry):null]].filter(([,h])=>!!h),d=l.map(h=>{let u=t.scheduleLabel(h);return`<tr>
      <td>${D(h.name)}</td>
...
<body>
  ...
  <table class="meta">
    ${u.map(([y,k])=>`<tr><td>${I(y)}</td><td>${k}</td></tr>`).join("")}
  </table>
  ...
  ${d?`<h2>${I(t.manualExcerpt)}</h2>
    <div class="excerpt">${I(d.title)} \u2014 ${I(t.pages)} ${d.startPage}\u2013${d.endPage}:
      <a href="${I(d.url)}" target="_blank" rel="noopener">PDF</a>
    </div>
    ...
    <\/script>`:""}`:""}
  <footer>${I(l)} \xB7 ${I(r.name)} \xB7 ${I(t.printedOn)} ${I(c.slice(0,10))}</footer>
</body></html>`}var Le=R`
  :host {
    display: block;
    height: 100%;
...
<meta charset="utf-8">
<meta name="color-scheme" content="light">
<title>${P(t.title)} \u2014 ${P(r.name)}</title>
<style>
...
<body>
<h1>${P(t.title)} \u2014 ${P(r.name)}</h1>
<p class="sub">${P(t.generated)} ${P(e(n))} \xB7 ${P(t.entriesLabel(c.length))}</p>
${u?`<div class="meta">${u}</div>`:""}
<table>
  <thead><tr>
    <th>${P(t.colDate)}</th>
    <th>${P(t.colTask)}</th>
    <th class="num">${P(t.colCost)}</th>
    <th class="num">${P(t.colDuration)}</th>
    <th>${P(t.colNotes)}</th>
  </tr></thead>
  <tbody>
${v}
      ...
      <div class="section">
        ...
        ${i.length===0?o`<p class="empty">${a("object_history_empty",t)}</p>`:o`
              <div class="rows">
                ${d.map(c=>o`
                  <div class="row">
                    <span class="date" title=${$t(c.timestamp,t)}>${U(c.timestamp,t)}</span>
...
`;function Ue(r){let l=window;l.customCards=l.customCards||[],l.customCards.some(t=>t.type===r.type)||l.customCards.push(r)}var st=class extends O{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(t){if(this._config={...t},t.past_days&&[30,90].includes(t.past_days)?this._pastDays=t.past_days:t.window_days&&[7,14,30,365].includes(t.window_days)&&(this._windowDays=t.window_days,this._pastDays=0),typeof t.user_filter=="string"&&(this._userFilter=t.user_filter),typeof t.object_filter=="string")this._objectFilter=t.object_filter,this._configuredObjects=[];else if(Array.isArray(t.object_filter)){let e=t.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=e.length===1?e[0]:"",this._configuredObjects=e.length>1?e:[]}}getCardSize(){return 6}get _lang(){return L(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(t){if(super.updated(t),Lt(this,t),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=e}catch{}}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){t();return}this._unsub=t}catch{}}_onEventClick(t){if(t.history_timestamp){this._openHistoryEntry(t);return}De(t.entry_id,t.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:t.entry_id,task_id:t.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(t){try{let i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:t.entry_id})).tasks?.find(n=>n.id===t.task_id)?.history?.find(n=>n.timestamp===t.history_timestamp);if(!i||Oe({entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp,type:i.type||"completed",timestamp:i.timestamp||t.history_timestamp,notes:i.notes??null,cost:i.cost??null,duration:i.duration??null,completed_by:i.completed_by??null,used_parts:i.used_parts??null}))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return p;let t=this._lang,e=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,s=this._config.title,n=null;this._userFilter&&(n=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let d=f=>{let Q=f.toLowerCase();return this._objects.find(it=>it.entry_id===f||it.object.name.toLowerCase()===Q)?.entry_id??null},c=new Set(this._configuredObjects.map(d).filter(f=>f!==null)),h=c.size?this._objects.filter(f=>c.has(f.entry_id)):this._objects,u=this._config.show_object_filter!==!1&&h.length>1,v=this._objectFilter?d(this._objectFilter):null,_=v&&h.some(f=>f.entry_id===v)?h.filter(f=>f.entry_id===v):h,y=new Date;y.setHours(0,0,0,0);let k=this._pastDays>0,j=k?je(_,y,this._pastDays,n):Te(_,y,this._windowDays,n),M=$e(y),E=this._windowDays===365||k,$=E?j.filter(f=>f.events.length>0):j,z=f=>{let Q=`cal-status-${f.status}`,et=f.projected?"cal-event-projected":"",it=f.status==="overdue"&&f.days_until_due!=null?` (${_t(f.days_until_due,t)})`:"",nt=f.projected&&f.interval_days?o`<span class="cal-event-recur">${f.interval_unit&&f.interval_unit!=="days"?`${f.interval_days} ${a("unit_"+f.interval_unit,t)}`:a("cal_every_n_days",t).replace("{n}",String(f.interval_days))}</span>`:p,V=f.schedule_type==="sensor_based",dt=V?o`<ha-icon class="cal-event-icon cal-source-sensor"
          ...
          </span>`:p,xt=this._stats?.budget?.currency_symbol||Pt,B=f.history_type?a(f.history_type,t):a(f.status,t);return o`
  ...
  `],g([w({attribute:!1})],at.prototype,"hass",2),g([m()],at.prototype,"_open",2),g([m()],at.prototype,"_title",2),g([m()],at.prototype,"_message",2),g([m()],at.prototype,"_confirmText",2),g([m()],at.prototype,"_danger",2),g([m()],at.prototype,"_inputLabel",2),g([m()],at.prototype,"_inputType",2),g([m()],at.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",at);var rt=class extends O{constructor(){super(...arguments);this.objects=[];this._summary=null;this._loaded=!1;this._busy=!1;this._error="";this._query="";this._results=[];this._expanded=!1;this._initiallyLoaded=!1;this._searchTimer=0}get _lang(){return L(this.hass)}updated(t){super.updated(t),t.has("hass")&&this.hass&&!this._initiallyLoaded&&(this._initiallyLoaded=!0,this._load(),Y(this._lang).then(()=>this.requestUpdate()))}async _load(){this._busy=!0;try{this._summary=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/storage"}),this._error=""}catch(t){this._error=S(t,this._lang)}finally{this._loaded=!0,this._busy=!1}}_nameFor(t){return this.objects.find(i=>i.object?.id===t)?.object?.name||t.slice(0,8)}_entryFor(t){return this.objects.find(e=>e.object?.id===t)?.entry_id}_toggle(){this._expanded=!this._expanded}_openObject(t){this.dispatchEvent(new CustomEvent("open-object",{detail:{entry_id:t},bubbles:!0,composed:!0}))}_onSearch(t){this._query=t.target.value,clearTimeout(this._searchTimer),this._searchTimer=window.setTimeout(()=>{this._doSearch()},250)}async _doSearch(){let t=this._query.trim();if(!t){this._results=[];return}try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/documents/search",query:t});this._results=e.results||[]}catch(e){this._error=S(e,this._lang),this._results=[]}}async _openResult(t){if(t.kind==="weblink"){W(t.url)&&window.open(t.url,"_blank","noopener");return}try{await vt(this.hass,t.id)}catch(e){this._error=S(e,this._lang)}}_renderResult(t,e){return o`
    ...
    `}render(){if(!this._loaded||!this._summary)return p;let t=this._summary;if(t.document_count===0)return p;let e=this._lang,i=Object.entries(t.by_object).filter(([,s])=>s.files>0||s.links>0).map(([s,n])=>({id:s,name:this._nameFor(s),entry:this._entryFor(s),...n})).sort((s,n)=>n.bytes-s.bytes);return o`
      <ha-card>
  ...
  `}function qe(r,l){let t=l;if(r.days_until_due==null||!r.interval_days||r.interval_days<=0)return p;let{pct:e,overflow:i}=Bt(r.interval_days,r.days_until_due,r.interval_unit),s="var(--success-color, #4caf50)";return r.status==="overdue"?s="var(--error-color, #f44336)":r.status==="due_soon"&&(s="var(--warning-color, #ff9800)"),o`
    <div class="days-progress">
      <div class="days-progress-labels">
        <span>${r.last_performed?`${a("last_performed",t)}: ${U(r.last_performed,t)}`:""}</span>
        <span>${r.next_due?`${a("next_due",t)}: ${U(r.next_due,t)}`:""}</span>
      </div>
    ...
    `}_renderSvg(t,e){let i=this.lang,s=t-ct-gt,n=Qt-wi,d=n-mt,c=1/0,h=-1/0;for(let b of e)c=Math.min(c,b.min??b.val),h=Math.max(h,b.max??b.val);this.thresholdAbove!=null&&(c=Math.min(c,this.thresholdAbove),h=Math.max(h,this.thresholdAbove)),this.thresholdBelow!=null&&(c=Math.min(c,this.thresholdBelow),h=Math.max(h,this.thresholdBelow)),this.targetValue!=null&&(c=Math.min(c,this.targetValue),h=Math.max(h,this.targetValue)),this.forceZero&&(c=Math.min(c,0));let u=(h-c||1)*.06,v=this.forceZero&&c>=0?0:c-u,{ticks:_,niceMin:y,niceMax:k}=Ot(v,h+u,4);this.forceZero&&c>=0&&y<0&&(y=0,_=_.filter(b=>b>=0));let j=e[0].ts,M=this.projection&&this.projection.length===2?this.projection[1].ts:null,E=M!=null?Math.max(e[e.length-1].ts,M):e[e.length-1].ts,$=E-j||1,z=Gt(j,E),T=b=>ct+(b-j)/$*s,f=b=>mt+(1-(b-y)/(k-y||1))*d,Q=e.map(b=>`${T(b.ts).toFixed(1)},${f(b.val).toFixed(1)}`).join(" "),et=`M${T(e[0].ts).toFixed(1)},${n} `+e.map(b=>`L${T(b.ts).toFixed(1)},${f(b.val).toFixed(1)}`).join(" ")+` L${T(e[e.length-1].ts).toFixed(1)},${n} Z`,it="",nt=e.filter(b=>b.min!=null&&b.max!=null);if(nt.length>=2){let b=nt.map(X=>`${T(X.ts).toFixed(1)},${f(X.max).toFixed(1)}`),C=[...nt].reverse().map(X=>`${T(X.ts).toFixed(1)},${f(X.min).toFixed(1)}`);it=`M${b[0]} `+b.slice(1).map(X=>`L${X}`).join(" ")+` L${C.join(" L")} Z`}let V=[];if(this.thresholdBelow!=null){let b=f(this.thresholdBelow);V.push({y:b,h:Math.max(0,n-b),lineY:b,label:`\u25BC ${ut(this.thresholdBelow)}`,labelY:Math.min(n-4,b+13)})}if(this.thresholdAbove!=null){let b=f(this.thresholdAbove);V.push({y:mt,h:Math.max(0,b-mt),lineY:b,label:`\u25B2 ${ut(this.thresholdAbove)}`,labelY:Math.max(mt+11,b-5)})}let dt=e[e.length-1],yt=(this.events||[]).filter(b=>b.ts>=j&&b.ts<=E),xt=Kt(j,E,Math.max(2,Math.min(5,Math.floor(s/110)+1))),B=this._hover;return o`
      <div class="svg-holder">
        ...
        >
          ...
          ${xt.map((b,C)=>{let X=T(b),oi=C===0?"start":C===xt.length-1?"end":"middle";return F`<text x="${X.toFixed(1)}" y="${Qt-5}" text-anchor="${oi}" class="tick-label">${St(b,i,z)}</text>`})}
          ...
          ${B?F`
                <line x1="${B.x.toFixed(1)}" y1="${mt}" x2="${B.x.toFixed(1)}" y2="${n}"
        ...
        ${B?o`<div
            ...
            >
              <div class="hover-date">${le(B.p.ts,i)}</div>
              <div class="hover-val">
                ${kt(B.p.val,this.unit,i)}
                ${B.p.min!=null&&B.p.max!=null?o`<span class="hover-range">(${ut(B.p.min)}–${ut(B.p.max)})</span>`:p}
              </div>
            </div>`:p}
      </div>
    `}_onPointer(t,e,i,s,n){let c=t.currentTarget.getBoundingClientRect(),h=(t.clientX-c.left)/c.width*n;if(h<ct-8||h>n-gt+8){this._hover=null;return}let u=e[0],v=1/0;for(let _ of e){let y=Math.abs(i(_.ts)-h);y<v&&(v=y,u=_)}this._hover={x:i(u.ts),y:s(u.val),p:u}}};N.styles=R`
      ...
      <div class="trigger-header">
        ...
        <div>
          ...
          `:o`
            ...
            <div class="trigger-entity-id">${d?o`<span class="entity-link" @click=${k=>Mt(k,d)}>${d}</span>`:""}${t.attribute?` \u2192 ${t.attribute}`:""}</div>
          `}
        </div>
      ...
      <div class="trigger-limits">
        ...
        ${v==="compound"?o`
          ...
          ${(t.conditions||[]).map((k,j)=>o`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${j+1}. ${a(k.type||"unknown",e)}: ${k.entity_id?o`<span class="entity-link" @click=${M=>Mt(M,k.entity_id)}>${k.entity_id}</span>`:""}</span>
          `)}
        `:p}
      </div>
  ...
  `}var Mi=200,Dt=10,Ci=22;function Xe(r,l,t,e){let i=r.history.filter(d=>d.type==="completed"&&(d.cost!=null||d.duration!=null));if(i.length<2)return p;let s=i.some(d=>(d.cost??0)>0),n=i.some(d=>(d.duration??0)>0);return!s&&!n?p:o`
  ...
  `}function Ri(r,l,t){let e=r.history.filter(b=>b.type==="completed"&&(b.cost!=null||b.duration!=null)).map(b=>({ts:new Date(b.timestamp).getTime(),cost:b.cost??0,duration:b.duration??0})).sort((b,C)=>b.ts-C.ts);if(e.length<2)return p;let i=e.some(b=>b.cost>0),s=e.some(b=>b.duration>0);if(!i&&!s)return p;let n=t!=="duration"&&i,d=t!=="cost"&&s,c=n||!d&&i,h=d||!n&&s,u=640,v=Mi,_=c?44:12,y=h?44:12,k=u-_-y,j=v-Ci,M=j-Dt,E=e[0].ts,$=e[e.length-1].ts,z=($-E||864e5)*.05,T=E-z,f=$+z,Q=Gt(E,$),et=b=>_+(b-T)/(f-T)*k,it=Ot(0,Math.max(...e.map(b=>b.cost))||1,3),nt=Ot(0,Math.max(...e.map(b=>b.duration))||1,3),V=b=>Dt+(1-b/(it.niceMax||1))*M,dt=b=>Dt+(1-b/(nt.niceMax||1))*M,yt=e.length>1?Math.min(...e.slice(1).map((b,C)=>et(b.ts)-et(e[C].ts))):k,xt=Math.max(6,Math.min(22,yt*.55)),B=Kt(E,$,Math.max(2,Math.min(4,e.length)));return o`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${u} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${a("chart_history",l)}">
        ${c?it.ticks.map(b=>{let C=V(b);return C<Dt-1||C>j+1?p:F`
        ...
        ${h?nt.ticks.map(b=>{let C=dt(b);return C<Dt-1||C>j+1?p:F`<text x="${u-y+6}" y="${(C+3.5).toFixed(1)}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="10.5">${ut(b)}m</text>`}):p}
        ...
        ${B.map((b,C)=>{let X=C===0?"start":C===B.length-1?"end":"middle";return F`<text x="${et(b).toFixed(1)}" y="${v-6}" text-anchor="${X}" fill="var(--secondary-text-color)" font-size="10">${St(b,l,Q)}</text>`})}
      </svg>
    </div>
  ...
  `}function Di(r,l){let t=l.lang,e=["completed","reset","skipped"].includes(r.type);return o`
    <div class="history-entry">
      ...
      <div class="history-content">
        ...
        <div class="history-date">${$t(r.timestamp,t)}</div>
    ...
    <div class="task-header">
      <div class="task-header-title">
        ...
        ${r.due_override?o`<span class="postponed-badge" title="${a("postponed_to",t)}">
          <ha-icon icon="mdi:calendar-arrow-right"></ha-icon>${U(r.due_override,t)}
        </span>`:p}
        ${ce(r,l.getUserName)}
      ...
      <div class="task-header-actions">
        ...
        ${r.allow_skip!==!1?o`<ha-button appearance="outlined" .disabled=${l.actionLoading} @click=${()=>l.promptSkip()}>${a("skip",t)}</ha-button>`:p}
  ...
  `}function Ii(r,l){if(!ye(r))return p;let t=l.lang,e=r.phase_sequence,i=fe(r.phase_cursor,e.length),s=new Map;for(let n=r.history.length-1;n>=0;n--){let d=r.history[n];d.phase_id&&d.type==="completed"&&!s.has(d.phase_id)&&s.set(d.phase_id,d.timestamp)}return o`
      ...
      <div class="phases-strip">
        ${e.map((n,d)=>{let c=r.phases?.[n]?.name||n,h=s.get(n);return o`
            <div class="phase-step ${d===i?"current":""}"
              ...
              ${h?o`<span class="phase-step-last">${U(h,t)}</span>`:p}
            </div>
          `})}
      </div>
    </div>
  `}function Pi(r,l){if(!l.features.checklists)return p;let t=Vt(r)?.checklist??(r.checklist||[]);if(t.length===0)return p;let e=l.lang,i=r.checklist_progress||{},s=t.filter(n=>i[n]).length;return o`
  ...
  `}function Hi(r,l){let t=l.lang,e=r.times_performed>0?r.total_cost/r.times_performed:0,i=r.days_until_due!==null&&r.days_until_due!==void 0?r.days_until_due<0?"overdue":r.days_until_due<=r.warning_days?"warning":"":"";return o`
    <div class="kpi-bar">
      <div class="kpi-card">
        ...
        <div class="kpi-value">${r.next_due?U(r.next_due,t):"\u2014"}</div>
      ...
      <div class="kpi-card">
        ...
        <div class="kpi-value">${r.last_performed?U(r.last_performed,t):"\u2014"}</div>
      </div>
      <div class="kpi-card">
    ...
    <div class="recent-activities">
      ...
      ${e.map(s=>o`
        <div class="activity-item">
          ...
          <span class="activity-date">${$t(s.timestamp,t)}</span>
...
`),`maintenance_parts_${n}.csv`,"text/csv;charset=utf-8")}async _exportObjectsCsv(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects/csv"}),e=new Date().toISOString().slice(0,10);te(t.csv,`maintenance_objects_${e}.csv`,"text/csv;charset=utf-8")}catch{this._showToast(a("action_error",this._lang))}}_renderObjectsTable(t){let e=this._lang,i=this._objectsTableColumns;return o`
    ...
    `}_renderOverviewRow(t){let e=this._lang,i=t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0,s=0,n=zt.ok,d=!1;if(i&&t.days_until_due!==null){let _=Bt(t.interval_days,t.days_until_due,t.interval_unit);s=_.pct,d=_.overflow,t.status==="overdue"?n=zt.overdue:t.status==="due_soon"&&(n=zt.due_soon)}let c=t.area_id?this.hass?.areas?.[t.area_id]?.name:null,h=t.responsible_user_id?this._userService?.getUserName(t.responsible_user_id):null,u=t.group_names.length>0||c||h,v=this._bulkMode&&this._bulkSelected.has(this._bulkKey(t));return o`
    ...
    `}_actionStyle(){return this._rowActionStyle}async _dismissRowActionNotice(t){let e={row_action_notice_pending:!1};t&&(e.row_action_style="icons");try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:e}),this._rowActionNotice=!1,t&&(this._rowActionStyle="icons")}catch(i){console.warn("[maintenance-supporter] row-action notice update failed",i)}}_renderRowActions(t,e,i,s=!0){let n=this._actionStyle();return n==="buttons"||n==="buttons_compact"?n==="buttons_compact"&&(this.narrow||this.tight)?o`
        ...
        <span class="row-actions as-buttons">
          ...
          ${s?o`
            <ha-button size="small" appearance="outlined" variant="neutral" title="${a("skip",t)}" ?disabled=${this._actionLoading} @click=${c=>{c.stopPropagation(),i()}}>
      ...
      <div class="detail-section">
        ...
        ${e.paused?o`<p class="meta paused-meta">
              <ha-icon icon="mdi:pause-circle-outline"></ha-icon>
              ${a("object_paused_badge",i)}${e.paused_until?o` — ${a("paused_until_label",i)} ${U(e.paused_until,i)}`:p}
            </p>`:p}
        ...
        ${e.installation_date?o`<p class="meta">${a("installed",i)}: ${U(e.installation_date,i)}</p>`:p}
