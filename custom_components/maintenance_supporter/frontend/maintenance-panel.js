...
`;var xe=class{constructor(a){this._cache=new Map;this._pending=new Map;this._hass=a}updateHass(a){this._hass=a}async getDetailStats(a,e){return this._getStats(a,"hour",30,e)}async getMiniStats(a,e){return this._getStats(a,"day",14,e)}clearCache(){this._cache.clear(),this._pending.clear()}async _getStats(a,e,t,i){let r=`${a}:${e}`,s=this._cache.get(r);if(s&&Date.now()-s.fetchedAt<3e5)return s.points;if(this._pending.has(r))return this._pending.get(r);let d=this._fetchAndNormalize(a,e,t,i,r);this._pending.set(r,d);try{return await d}finally{this._pending.delete(r)}}async _fetchAndNormalize(a,e,t,i,r){let s=new Date(Date.now()-t*24*60*60*1e3).toISOString(),d=i?["state","sum","change"]:["mean","min","max"];try{let v=(await this._hass.connection.sendMessagePromise({type:"recorder/statistics_during_period",start_time:s,statistic_ids:[a],period:e,types:d}))[a]||[],u=[];for(let _ of v){let m=null;if(i?m=_.state??null:m=_.mean??null,m===null)continue;let $={ts:_.start,val:m};i||(_.min!=null&&($.min=_.min),_.max!=null&&($.max=_.max)),u.push($)}return u.sort((_,m)=>_.ts-m.ts),this._cache.set(r,{entityId:a,fetchedAt:Date.now(),period:e,points:u}),u}catch(p){return console.warn(`[maintenance-supporter] Failed to fetch statistics for ${a}:`,p),[]}}};var re=class{constructor(a){this.usersCache=null;this.cacheTimestamp=0;this.CACHE_TTL_MS=6e4;this.hass=a}async getUsers(a=!1){let e=Date.now();if(!a&&this.usersCache&&e-this.cacheTimestamp<this.CACHE_TTL_MS)return this.usersCache;try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/users/list"});return this.usersCache=t.users,this.cacheTimestamp=e,this.usersCache}catch(t){return console.error("Failed to fetch users:",t),this.usersCache||[]}}async assignUser(a,e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/assign_user",entry_id:a,task_id:e,user_id:t})}async getTasksByUser(a){return(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tasks/by_user",user_id:a})).tasks}getUserName(a){return!a||!this.usersCache?null:this.usersCache.find(t=>t.id===a)?.name||null}getUser(a){return!a||!this.usersCache?null:this.usersCache.find(e=>e.id===a)||null}getCurrentUserId(){return this.hass.user?.id||null}isCurrentUser(a){return a?a===this.getCurrentUserId():!1}clearCache(){this.usersCache=null,this.cacheTimestamp=0}};var O=class extends H{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._name="";this._manufacturer="";this._model="";this._entryId=null}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}openCreate(){this._entryId=null,this._name="",this._manufacturer="",this._model="",this._open=!0}openEdit(e,t){this._entryId=e,this._name=t.name||"",this._manufacturer=t.manufacturer||"",this._model=t.model||"",this._open=!0}async _save(){if(this._name.trim()){this._loading=!0;try{this._entryId?await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/update",entry_id:this._entryId,name:this._name,manufacturer:this._manufacturer||null,model:this._model||null}):await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/create",name:this._name,manufacturer:this._manufacturer||null,model:this._model||null}),this._open=!1,this.dispatchEvent(new CustomEvent("object-saved"))}finally{this._loading=!1}}}_close(){this._open=!1}render(){if(!this._open)return o``;let e=this._lang,t=this._entryId?n("edit_object",e):n("new_object",e);return o`
  ...
  `,h([N({attribute:!1})],O.prototype,"hass",2),h([f()],O.prototype,"_open",2),h([f()],O.prototype,"_loading",2),h([f()],O.prototype,"_name",2),h([f()],O.prototype,"_manufacturer",2),h([f()],O.prototype,"_model",2),h([f()],O.prototype,"_entryId",2),O=h([ae("maintenance-object-dialog")],O);var Ut=["cleaning","inspection","replacement","calibration","service","custom"],qt=["time_based","sensor_based","manual"],Vt=["threshold","counter","state_change","runtime"],w=class extends H{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._entryId="";this._taskId=null;this._name="";this._type="custom";this._scheduleType="time_based";this._intervalDays="30";this._warningDays="7";this._notes="";this._documentationUrl="";this._triggerEntityId="";this._triggerEntityIds=[];this._triggerEntityLogic="any";this._triggerAttribute="";this._triggerType="threshold";this._triggerAbove="";this._triggerBelow="";this._triggerForMinutes="0";this._triggerTargetValue="";this._triggerDeltaMode=!1;this._triggerFromState="";this._triggerToState="";this._triggerTargetChanges="";this._triggerRuntimeHours="";this._responsibleUserId=null;this._availableUsers=[];this._userService=null}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}async openCreate(e){this._entryId=e,this._taskId=null,this._resetFields(),await this._loadUsers(),this._open=!0}async openEdit(e,t){if(this._entryId=e,this._taskId=t.id,this._name=t.name,this._type=t.type,this._scheduleType=t.schedule_type,this._intervalDays=t.interval_days?.toString()||"30",this._warningDays=t.warning_days.toString(),this._notes=t.notes||"",this._documentationUrl=t.documentation_url||"",this._responsibleUserId=t.responsible_user_id||null,t.trigger_config){let i=t.trigger_config;this._triggerEntityId=i.entity_id||"",this._triggerEntityIds=i.entity_ids||(i.entity_id?[i.entity_id]:[]),this._triggerEntityLogic=i.entity_logic||"any",this._triggerAttribute=i.attribute||"",this._triggerType=i.type||"threshold",this._triggerAbove=i.trigger_above?.toString()||"",this._triggerBelow=i.trigger_below?.toString()||"",this._triggerForMinutes=i.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=i.trigger_target_value?.toString()||"",this._triggerDeltaMode=i.trigger_delta_mode||!1,this._triggerFromState=i.trigger_from_state||"",this._triggerToState=i.trigger_to_state||"",this._triggerTargetChanges=i.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=i.trigger_runtime_hours?.toString()||""}else this._resetTriggerFields();await this._loadUsers(),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._warningDays="7",this._notes="",this._documentationUrl="",this._responsibleUserId=null,this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours=""}async _loadUsers(){this._userService||(this._userService=new re(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}async _save(){if(this._name.trim()){this._loading=!0;try{let e={type:this._taskId?"maintenance_supporter/task/update":"maintenance_supporter/task/create",entry_id:this._entryId,name:this._name,task_type:this._type,schedule_type:this._scheduleType,warning_days:parseInt(this._warningDays,10)||7};if(this._taskId&&(e.task_id=this._taskId),this._scheduleType!=="manual"&&this._intervalDays&&(e.interval_days=parseInt(this._intervalDays,10)),this._notes&&(e.notes=this._notes),this._documentationUrl&&(e.documentation_url=this._documentationUrl),this._responsibleUserId&&(e.responsible_user_id=this._responsibleUserId),this._scheduleType==="sensor_based"&&this._triggerEntityId){let t=this._triggerEntityIds.length>0?this._triggerEntityIds:[this._triggerEntityId],i={entity_id:t[0],entity_ids:t,type:this._triggerType};this._triggerAttribute&&(i.attribute=this._triggerAttribute),t.length>1&&(i.entity_logic=this._triggerEntityLogic),this._triggerType==="threshold"?(this._triggerAbove&&(i.trigger_above=parseFloat(this._triggerAbove)),this._triggerBelow&&(i.trigger_below=parseFloat(this._triggerBelow)),this._triggerForMinutes&&(i.trigger_for_minutes=parseInt(this._triggerForMinutes,10))):this._triggerType==="counter"?(this._triggerTargetValue&&(i.trigger_target_value=parseFloat(this._triggerTargetValue)),i.trigger_delta_mode=this._triggerDeltaMode):this._triggerType==="state_change"?(this._triggerFromState&&(i.trigger_from_state=this._triggerFromState),this._triggerToState&&(i.trigger_to_state=this._triggerToState),this._triggerTargetChanges&&(i.trigger_target_changes=parseInt(this._triggerTargetChanges,10))):this._triggerType==="runtime"&&this._triggerRuntimeHours&&(i.trigger_runtime_hours=parseFloat(this._triggerRuntimeHours)),e.trigger_config=i}await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return l;let e=this._lang;return o`
      ...
      <div class="select-row">
        ...
        >
          ${Vt.map(t=>o`<option value=${t}>${n(t,e)}</option>`)}
        </select>
      </div>
  ...
  `,h([N({attribute:!1})],q.prototype,"hass",2),h([N()],q.prototype,"lang",2),h([f()],q.prototype,"_open",2),h([f()],q.prototype,"_loading",2),h([f()],q.prototype,"_error",2),h([f()],q.prototype,"_result",2),h([f()],q.prototype,"_action",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",q);var Bt=60,Wt=20,Gt=300,Kt=140,Zt=300,Yt=200,lt=30,Qt=27,T=class extends H{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._unsub=null;this._sparklineTooltip=null;this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1};this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._deepLinkHandled=!1;this._onDialogEvent=async()=>{await this._loadData()}}get _lang(){return this.hass?.language||"de"}connectedCallback(){super.connectedCallback()}disconnectedCallback(){super.disconnectedCallback(),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(e){if(super.updated(e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new xe(this.hass),this._fetchMiniStatsForOverview()),this._userService||(this._userService=new re(this.hass),this._userService.getUsers())}}async _loadData(){let[e,t,i,r,s]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null)]);e&&(this._objects=e.objects),t&&(this._stats=t),i&&(this._budget=i),r&&(this._groups=r.groups||{}),s&&(this._features=s.features),this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search),t=e.get("entry_id");if(!t)return;this._deepLinkHandled=!0;let i=e.get("task_id"),r=e.get("action");i?(this._showTask(t,i),r==="complete"&&(history.replaceState(null,"",window.location.pathname+window.location.hash),requestAnimationFrame(()=>{let d=this._getObject(t)?.tasks.find(p=>p.id===i);d&&this._openCompleteDialog(t,i,d.name,this._features.checklists?d.checklist:void 0,this._features.adaptive&&!!d.adaptive_config?.enabled)}))):this._showObject(t)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let i=await this._statsService.getDetailStats(e,t),r=new Map(this._detailStatsData);r.set(e,i),this._detailStatsData=r}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=new Map(this._miniStatsData),t=[];for(let i of this._objects)for(let r of i.tasks){let s=r.trigger_config?.entity_id;if(!s)continue;let d=this._isCounterEntity(r.trigger_config);t.push(this._statsService.getMiniStats(s,d).then(p=>{e.set(s,p)}))}t.length>0&&(await Promise.all(t),this._miniStatsData=e)}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _taskRows(){let e=[];for(let i of this._objects)for(let r of i.tasks)if(!(this._filterStatus&&r.status!==this._filterStatus)){if(this._filterUser){let s=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(r.responsible_user_id!==s)continue}e.push({entry_id:i.entry_id,task_id:r.id,object_name:i.object.name,task_name:r.name,type:r.type,schedule_type:r.schedule_type,status:r.status,days_until_due:r.days_until_due??null,next_due:r.next_due??null,trigger_active:r.trigger_active,trigger_current_value:r.trigger_current_value??null,trigger_current_delta:r.trigger_current_delta??null,trigger_config:r.trigger_config??null,trigger_entity_info:r.trigger_entity_info??null,times_performed:r.times_performed,total_cost:r.total_cost,interval_days:r.interval_days??null,history:r.history||[],enabled:r.enabled})}let t={overdue:0,triggered:1,due_soon:2,ok:3};return e.sort((i,r)=>(t[i.status]??9)-(t[r.status]??9)),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(r=>r.id===t)}_showOverview(){this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null}_showObject(e){this._view="object",this._selectedEntryId=e,this._selectedTaskId=null}_showTask(e,t){this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._historyFilter=null;let i=this._getTask(e,t);if(i?.trigger_config?.entity_id){let r=i.trigger_config.entity_id,s=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(r,s)}}async _deleteObject(e){confirm(n("confirm_delete_object",this._lang))&&(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:e}),this._showOverview(),await this._loadData())}async _deleteTask(e,t){confirm(n("confirm_delete_task",this._lang))&&(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/delete",entry_id:e,task_id:t}),this._showObject(e),await this._loadData())}async _skipTask(e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/skip",entry_id:e,task_id:t}),await this._loadData()}async _resetTask(e,t){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/reset",entry_id:e,task_id:t}),await this._loadData()}async _applySuggestion(e,t,i){await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/apply_suggestion",entry_id:e,task_id:t,interval:i}),await this._loadData()}_dismissSuggestion(){this._loadData()}_openCompleteDialog(e,t,i,r,s){let d=this.shadowRoot.querySelector("maintenance-complete-dialog");d&&(d.entryId=e,d.taskId=t,d.taskName=i,d.lang=this._lang,d.checklist=r||[],d.adaptiveEnabled=!!s,d.open())}_openQrForObject(e,t){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForObject(e,t)}_openQrForTask(e,t,i,r){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForTask(e,t,i,r)}async _exportCsv(){let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/csv/export"}),t=new Blob([e.csv],{type:"text/csv;charset=utf-8;"}),i=URL.createObjectURL(t),r=document.createElement("a");r.href=i,r.download="maintenance_export.csv",r.click(),URL.revokeObjectURL(i)}_triggerImportCsv(){let e=this.shadowRoot.querySelector("input[type=file]");e&&(e.value="",e.click())}async _handleCsvFile(e){let i=e.target.files?.[0];if(!i)return;let r=await i.text(),s=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/csv/import",csv_content:r});await this._loadData(),alert(`Imported ${s.created} of ${s.total} objects.`)}render(){return o`
    ...
    `}_renderGroupsSection(){let e=Object.entries(this._groups);if(e.length===0)return l;let t=this._lang;return o`
      <div class="groups-section">
        ...
        <div class="groups-grid">
          ${e.map(([i,r])=>{let s=r.task_refs.map(d=>this._getTask(d.entry_id,d.task_id)?.name||d.task_id);return o`
              <div class="group-card">
                ...
                <div class="group-card-tasks">
                  ${s.length>0?s.map(d=>o`<span class="group-task-chip">${d}</span>`):o`<span style="font-size:12px;color:var(--secondary-text-color)">${n("no_tasks_short",t)}</span>`}
                </div>
              </div>
            `})}
        </div>
    ...
    `}_renderBudgetBar(){let e=this._budget;if(!e)return l;let t=this._lang,i=[];return e.monthly_budget>0&&i.push({label:n("budget_monthly",t),spent:e.monthly_spent,budget:e.monthly_budget}),e.yearly_budget>0&&i.push({label:n("budget_yearly",t),spent:e.yearly_spent,budget:e.yearly_budget}),i.length===0?l:o`
      <div class="budget-bars">
        ${i.map(r=>{let s=Math.min(100,Math.max(0,r.spent/r.budget*100)),d=s>=100?"var(--error-color, #f44336)":s>=e.alert_threshold_pct?"var(--warning-color, #ff9800)":"var(--success-color, #4caf50)";return o`
            <div class="budget-item">
              ...
              <div class="budget-bar">
                <div class="budget-bar-fill" style="width:${s}%; background:${d}"></div>
              </div>
            </div>
          `})}
      </div>
    `}_renderOverviewRow(e){let t=this._lang,i=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,r=0,s=be.ok,d=!1;if(i&&e.days_until_due!==null){let p=(e.interval_days-e.days_until_due)/e.interval_days*100;r=Math.max(0,Math.min(100,p)),d=p>100,e.status==="overdue"?s=be.overdue:e.status==="due_soon"&&(s=be.due_soon)}return o`
      <div class="task-row${e.enabled?"":" task-disabled"}">
        ...
        <span class="due-cell" @click=${()=>this._showTask(e.entry_id,e.task_id)}>
          ...
          ${i?o`<div class="days-bar"><div class="days-bar-fill${d?" overflow":""}" style="width:${r}%;background:${s}"></div></div>`:l}
    ...
    `}_openCompleteDialogForRow(e){let i=this._objects.find(r=>r.entry_id===e.entry_id)?.tasks.find(r=>r.id===e.task_id);this._openCompleteDialog(e.entry_id,e.task_id,e.task_name,this._features.checklists?i?.checklist:void 0,this._features.adaptive&&!!i?.adaptive_config?.enabled)}_renderTriggerProgress(e){let t=e.trigger_config??null;if(!t)return l;let i=t.type||"threshold",r=e.trigger_entity_info?.unit_of_measurement??"",s=0,d="";if(i==="threshold"){let u=e.trigger_current_value??null;if(u==null)return l;let _=t.trigger_above,m=t.trigger_below;if(_!=null){let $=m??0,b=_-$||1;s=Math.min(100,Math.max(0,(u-$)/b*100)),d=`${u.toFixed(1)} / ${_} ${r}`}else if(m!=null){let b=e.trigger_entity_info?.max??(u*2||100),M=b-m||1;s=Math.min(100,Math.max(0,(b-u)/M*100)),d=`${u.toFixed(1)} / ${m} ${r}`}else return l}else if(i==="counter"){let u=t.trigger_target_value||1,m=e.trigger_current_delta??null??e.trigger_current_value??null;if(m==null)return l;s=Math.min(100,Math.max(0,m/u*100)),d=`${m.toFixed(1)} / ${u} ${r}`}else if(i==="state_change"){let u=t.trigger_target_changes||1,_=e.trigger_current_value??null;if(_==null)return l;s=Math.min(100,Math.max(0,_/u*100)),d=`${Math.round(_)} / ${u}`}else if(i==="runtime"){let u=t.trigger_runtime_hours||100,_=e.trigger_current_value??null;if(_==null)return l;s=Math.min(100,Math.max(0,_/u*100)),d=`${_.toFixed(1)}h / ${u}h`}else if(i==="compound"){let u=t.compound_logic||t.operator||"AND",_=t.conditions?.length||0;d=`${u} (${_})`,s=e.trigger_active?100:0}else return l;let p=s>=100,v=s>90?"var(--error-color, #f44336)":s>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return o`
      <div class="trigger-progress">
        <div class="trigger-progress-bar">
          <div class="trigger-progress-fill${p?" overflow":""}" style="width:${s}%;background:${v}"></div>
        </div>
        <span class="trigger-progress-label">${d}</span>
      </div>
    `}_renderMiniSparkline(e){if(!e.trigger_config?.entity_id)return l;let t=e.trigger_config.entity_id,i=this._miniStatsData.get(t)||[],r=[];if(i.length>=2)r=i.map(y=>({ts:y.ts,val:y.val}));else{if(!e.history)return l;for(let y of e.history)y.trigger_value!=null&&r.push({ts:new Date(y.timestamp).getTime(),val:y.trigger_value})}if(e.trigger_current_value!=null&&r.push({ts:Date.now(),val:e.trigger_current_value}),r.length<2)return l;r.sort((y,A)=>y.ts-A.ts);let s=Bt,d=Wt,p=r.map(y=>y.val),v=Math.min(...p),u=Math.max(...p),_=u-v||1;v-=_*.1,u+=_*.1;let m=r[0].ts,b=r[r.length-1].ts-m||1,M=y=>(y-m)/b*s,L=y=>2+(1-(y-v)/(u-v))*(d-4),E=r;if(E.length>lt){let y=Math.ceil(E.length/lt);E=E.filter((A,C)=>C%y===0||C===E.length-1)}let I=E.map(y=>`${M(y.ts).toFixed(1)},${L(y.val).toFixed(1)}`).join(" ");return o`
      <svg class="mini-sparkline" viewBox="0 0 ${s} ${d}" preserveAspectRatio="none" role="img" aria-label="${n("chart_mini_sparkline",this._lang)}">
        <polyline points="${I}" fill="none" stroke="var(--primary-color)" stroke-width="1.5" stroke-linejoin="round" />
      </svg>
    `}_renderDaysProgress(e){let t=this._lang;if(e.days_until_due==null||!e.interval_days||e.interval_days<=0)return l;let r=(e.interval_days-e.days_until_due)/e.interval_days*100,s=Math.max(0,Math.min(100,r)),d=r>100,p="var(--success-color, #4caf50)";return e.status==="overdue"?p="var(--error-color, #f44336)":e.status==="due_soon"&&(p="var(--warning-color, #ff9800)"),o`
      <div class="days-progress">
        ...
        <div class="days-progress-bar" role="progressbar" aria-valuenow="${Math.round(s)}" aria-valuemin="0" aria-valuemax="100" aria-label="${n("days_progress",t)}">
          <div class="days-progress-fill${d?" overflow":""}" style="width:${s}%;background:${p}"></div>
        </div>
    ...
    `}_renderTaskHeader(e){let t=this._lang,r=this._getObject(this._selectedEntryId)?.object.name||"",s=e.status==="due_soon"?"warning":e.status||"ok",d=n(e.status||"ok",t);return o`
      <div class="task-header">
        <div class="task-header-title">
          ...
          <span class="status-chip ${s}">${d}</span>
    ...
    `}_renderAnalysisTab(e){let t=this._lang;if(!(this._features.adaptive||this._features.seasonal))return o`
      ...
      `;let r=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,s=this._features.seasonal&&(e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12);if(!(r||s)){let p=e.schedule_type==="manual",v=e.interval_analysis?.data_points??0,u=Math.min(100,Math.max(0,v/5*100));return o`
        <div class="tab-content analysis-tab">
          ${this._renderTriggerSection(e)}
          ${this._renderPredictionSection(e)}
          <div class="analysis-empty-state">
            ...
            ${!p&&v>0?o`
              <div class="analysis-progress">
                <div class="analysis-progress-bar" style="width:${u}%"></div>
              </div>
              <p class="empty-hint">${v} / 5 ${n("completions",t)}</p>
            `:l}
          </div>
        </div>
      `}return o`
    ...
    `}_renderSeasonalCardCompact(e){let t=this._lang;if(!this._features.seasonal||!e.seasonal_factor||e.seasonal_factor===1)return l;let r=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"].map(v=>n(v,t)),s=new Date().getMonth(),d=e.seasonal_factors||e.interval_analysis?.seasonal_factors||null,p=d&&d.length===12?d:r.map((v,u)=>{let _=e.seasonal_factor||1,m=Math.sin((u-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,_+m))});return o`
      <div class="seasonal-card-compact">
        <h4>${n("seasonal_awareness",t)}</h4>
        <div class="seasonal-mini-chart">
          ${p.map((v,u)=>{let _=v*40,m=v<.9?"low":v>1.1?"high":"normal";return o`
              <div class="seasonal-bar ${m} ${u===s?"current":""}"
                   style="height: ${_}px"
                   title="${r[u]}: ${v.toFixed(2)}x">
              </div>
            `})}
        </div>
    ...
    `}_renderCostDurationCard(e){let t=this._lang,i=e.history.filter(d=>d.type==="completed"&&(d.cost!=null||d.duration!=null));if(i.length<2)return l;let r=i.some(d=>(d.cost??0)>0),s=i.some(d=>(d.duration??0)>0);return!r&&!s?l:o`
    ...
    `}_renderHistoryChart(e){let t=e.history.filter(x=>x.type==="completed"&&(x.cost!=null||x.duration!=null)).map(x=>({ts:new Date(x.timestamp).getTime(),cost:x.cost??0,duration:x.duration??0})).sort((x,D)=>x.ts-D.ts);if(t.length<2)return l;let i=t.some(x=>x.cost>0),r=t.some(x=>x.duration>0);if(!i&&!r)return l;let s=this._costDurationToggle!=="duration"&&i,d=this._costDurationToggle!=="cost"&&r,p=s||!d&&i,v=d||!s&&r,u=Zt,_=Yt,m=p?32:8,$=v?32:8,b=8,M=20,L=u-m-$,E=_-b-M,I=Math.max(...t.map(x=>x.cost))||1,y=Math.max(...t.map(x=>x.duration))||1,A=Math.min(20,L/t.length*.6),C=L/t.length,P=x=>m+C*x+C/2,V=x=>b+E-x/I*E,B=x=>b+E-x/y*E;return o`
      <div class="sparkline-container">
        <svg class="history-chart" viewBox="0 0 ${u} ${_}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_history",this._lang)}">
          <!-- Cost bars -->
          ${p?t.map((x,D)=>F`
            <rect x="${(P(D)-A/2).toFixed(1)}" y="${V(x.cost).toFixed(1)}" width="${A.toFixed(1)}" height="${(b+E-V(x.cost)).toFixed(1)}"
              fill="var(--primary-color)" opacity="0.6" rx="2" />
          `):l}
          <!-- Duration line -->
          ${v?F`
            <polyline points="${t.map((x,D)=>`${P(D).toFixed(1)},${B(x.duration).toFixed(1)}`).join(" ")}"
              fill="none" stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-linejoin="round" />
            ${t.map((x,D)=>F`
              <circle cx="${P(D).toFixed(1)}" cy="${B(x.duration).toFixed(1)}" r="3" fill="var(--accent-color, #ff9800)" />
            `)}
          `:l}
          <!-- X-axis labels -->
          <text x="${m}" y="${_-2}" text-anchor="start" fill="var(--secondary-text-color)" font-size="7">${new Date(t[0].ts).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</text>
          <text x="${u-$}" y="${_-2}" text-anchor="end" fill="var(--secondary-text-color)" font-size="7">${new Date(t[t.length-1].ts).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</text>
          <!-- Y-axis labels -->
          ${p?F`
            <text x="${m-3}" y="${b+4}" text-anchor="end" fill="var(--primary-color)" font-size="7">${I.toFixed(0)}\u20AC</text>
            <text x="${m-3}" y="${b+E+3}" text-anchor="end" fill="var(--primary-color)" font-size="7">0\u20AC</text>
          `:l}
          ${v?F`
            <text x="${u-$+3}" y="${b+4}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="7">${y.toFixed(0)}m</text>
            <text x="${u-$+3}" y="${b+E+3}" text-anchor="start" fill="var(--accent-color, #ff9800)" font-size="7">0m</text>
          `:l}
        </svg>
      </div>
      <div class="chart-legend">
        ${p?o`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color);opacity:0.6"></span>${n("cost",this._lang)}</span>`:l}
        ${v?o`<span class="legend-item"><span class="legend-swatch" style="background:var(--accent-color, #ff9800)"></span>${n("duration",this._lang)}</span>`:l}
      </div>
    `}_renderSeasonalChart(e){let t=e.seasonal_factors??e.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return l;let i=this._lang,r=e.interval_analysis?.seasonal_reason,s=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"],d=new Date().getMonth(),p=300,v=100,u=8,m=v-u-4,$=Math.max(...t,1.5),b=p/12,M=b*.65,L=u+m-1/$*m;return o`
      <div class="seasonal-chart">
        ...
        <svg viewBox="0 0 ${p} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_seasonal",i)}">
          <!-- Baseline at 1.0 -->
          <line x1="0" y1="${L.toFixed(1)}" x2="${p}" y2="${L.toFixed(1)}"
            stroke="var(--divider-color)" stroke-width="1" stroke-dasharray="4,3" />
          <!-- Bars -->
          ${t.map((E,I)=>{let y=E/$*m,A=I*b+(b-M)/2,C=u+m-y,P=I===d,V=E<1?"var(--success-color, #4caf50)":E>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return F`
              <rect x="${A.toFixed(1)}" y="${C.toFixed(1)}"
                width="${M.toFixed(1)}" height="${y.toFixed(1)}"
                fill="${V}" opacity="${P?1:.5}" rx="2" />
            `})}
        </svg>
        <div class="seasonal-labels">
          ${s.map((E,I)=>o`<span class="seasonal-label ${I===d?"active-month":""}">${n(E,i)}</span>`)}
        </div>
      </div>
    `}_renderWeibullSection(e){let t=e.interval_analysis,i=t?.weibull_beta,r=t?.weibull_eta;if(i==null||r==null)return l;let s=this._lang,d=t?.weibull_r_squared,p=e.interval_days??0,v=e.suggested_interval??p;return o`
      <div class="weibull-section">
        ...
        ${this._renderWeibullChart(i,r,p,v)}
    ...
    `}_renderWeibullChart(e,t,i,r){let b=Math.max(i,r,t,1)*1.3,M=50,L=[];for(let x=0;x<=M;x++){let D=x/M*b,R=1-Math.exp(-Math.pow(D/t,e)),S=32+D/b*260,$e=136-R*128;L.push([S,$e])}let E=L.map(([x,D])=>`${x.toFixed(1)},${D.toFixed(1)}`).join(" "),I="M32,136 "+L.map(([x,D])=>`L${x.toFixed(1)},${D.toFixed(1)}`).join(" ")+` L${L[M][0].toFixed(1)},136 Z`,y=32+i/b*260,A=1-Math.exp(-Math.pow(i/t,e)),C=136-A*128,P=((1-A)*100).toFixed(0),V=32+r/b*260,B=[0,.25,.5,.75,1];return o`
        ...
        <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_weibull",this._lang)}">
          ...
          ${i>0?F`
            ...
            <text x="${(y+4).toFixed(1)}" y="${(C-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
              font-size="9" font-weight="600">R=${P}%</text>
          `:l}
    ...
    `}_renderConfidenceInterval(e,t,i){let r=e.confidence_interval_low,s=e.confidence_interval_high,d=t.suggested_interval??t.interval_days??0,p=t.interval_days??0,v=Math.max(0,r-5),_=s+5-v,m=(r-v)/_*100,$=(s-r)/_*100,b=(d-v)/_*100,M=p>0?(p-v)/_*100:-1;return o`
      <div class="confidence-range">
        <div class="confidence-range-title">
          ${n("confidence_interval",i)}: ${d} ${n("days",i)} (${r}–${s})
        </div>
        <div class="confidence-bar">
          <div class="confidence-fill" style="left:${m.toFixed(1)}%;width:${$.toFixed(1)}%"></div>
    ...
    `}_renderTriggerSection(e){let t=e.trigger_config;if(!t)return l;let i=this._lang,r=e.trigger_entity_info,s=e.trigger_entity_infos,d=r?.friendly_name||t.entity_id||"\u2014",p=t.entity_id||"",v=t.entity_ids||(p?[p]:[]),u=r?.unit_of_measurement||"",_=e.trigger_current_value,m=t.type||"threshold",$=v.length>1;return o`
      <h3>${n("trigger",i)}</h3>
      <div class="trigger-card">
        <div class="trigger-header">
          ...
          <div>
            ${$?o`
              <div class="trigger-entity-name">${v.length} ${n("entities",i)} (${t.entity_logic||"any"})</div>
        ...
        ${_!=null?o`
              <div class="trigger-value-row">
                ...
                ${u?o`<span class="trigger-unit">${u}</span>`:l}
              </div>
            `:l}

        <div class="trigger-limits">
          ${m==="threshold"?o`
            ${t.trigger_above!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${n("threshold_above",i)}: ${t.trigger_above} ${u}</span>`:l}
            ${t.trigger_below!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${n("threshold_below",i)}: ${t.trigger_below} ${u}</span>`:l}
          ...
          `:l}
          ${m==="counter"?o`
            ${t.trigger_target_value!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${n("target_value",i)}: ${t.trigger_target_value} ${u}</span>`:l}
          `:l}
          ${m==="state_change"?o`
          ...
          ${m==="compound"?o`
            ...
            ${(t.conditions||[]).map((b,M)=>o`
              <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${M+1}. ${n(b.trigger_config?.type||"unknown",i)}: ${b.trigger_config?.entity_id||""}</span>
            `)}
          `:l}
          ${r?.min!=null?o`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${n("min",i)}: ${r.min} ${u}</span>`:l}
          ${r?.max!=null?o`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${n("max",i)}: ${r.max} ${u}</span>`:l}
        </div>
        ...
        ${this._renderSparkline(e,u)}
      </div>
    `}_renderSparkline(e,t){let i=e.trigger_config;if(!i)return l;let r=i.type||"threshold",s=r==="counter"&&i.trigger_delta_mode,d=this._isCounterEntity(i),p=i.entity_id||"",v=this._detailStatsData.get(p)||[],u=[],_=!1;if(v.length>=2)for(let g of v){let k=g.val;s&&e.trigger_baseline_value!=null&&(k-=e.trigger_baseline_value);let j={ts:g.ts,val:k};!d&&g.min!=null&&g.max!=null&&(j.min=s&&e.trigger_baseline_value!=null?g.min-e.trigger_baseline_value:g.min,j.max=s&&e.trigger_baseline_value!=null?g.max-e.trigger_baseline_value:g.max,_=!0),u.push(j)}else for(let g of e.history)g.trigger_value!=null&&u.push({ts:new Date(g.timestamp).getTime(),val:g.trigger_value});if(e.trigger_current_value!=null){let g=e.trigger_current_value;s&&e.trigger_baseline_value!=null&&(g-=e.trigger_baseline_value),u.push({ts:Date.now(),val:g})}if(u.length<2&&p&&this._statsService&&!this._detailStatsData.has(p))return o`<div class="sparkline-container" aria-live="polite" style="display:flex;align-items:center;justify-content:center;height:140px;color:var(--secondary-text-color);font-size:12px;">
        <ha-icon icon="mdi:chart-line" style="--mdc-icon-size:16px;margin-right:8px;"></ha-icon>
        ${n("loading_chart",this._lang)}
      </div>`;if(u.length<2)return l;u.sort((g,k)=>g.ts-k.ts);let m=Gt,$=Kt,b=30,M=2,L=8,E=16,I=u.map(g=>g.val),y=Math.min(...I),A=Math.max(...I);if(_)for(let g of u)g.min!=null&&(y=Math.min(y,g.min)),g.max!=null&&(A=Math.max(A,g.max));i.trigger_above!=null&&(A=Math.max(A,i.trigger_above),y=Math.min(y,i.trigger_above)),i.trigger_below!=null&&(y=Math.min(y,i.trigger_below),A=Math.max(A,i.trigger_below));let C=null,P=null;if(r==="counter"&&i.trigger_target_value!=null){if(e.trigger_baseline_value!=null)C=e.trigger_baseline_value;else if(u.length>0){let g=[...e.history].filter(k=>k.type==="completed"||k.type==="reset").sort((k,j)=>new Date(j.timestamp).getTime()-new Date(k.timestamp).getTime())[0];if(g){let k=new Date(g.timestamp).getTime(),j=u[0],z=Math.abs(u[0].ts-k);for(let G of u){let K=Math.abs(G.ts-k);K<z&&(j=G,z=K)}C=j.val}else C=u[0].val}C!=null?(P=C+i.trigger_target_value,A=Math.max(A,P),y=Math.min(y,C)):(A=Math.max(A,i.trigger_target_value),y=Math.min(y,0))}s&&e.trigger_baseline_value!=null&&(y=Math.min(y,0));let V=A-y||1;y-=V*.1,A+=V*.1;let B=u[0].ts,x=u[u.length-1].ts,D=x-B||1,R=g=>b+(g-B)/D*(m-b-M),S=g=>L+(1-(g-y)/(A-y))*($-L-E),$e=u.map(g=>`${R(g.ts).toFixed(1)},${S(g.val).toFixed(1)}`).join(" "),ct=`M${R(u[0].ts).toFixed(1)},${$-E} `+u.map(g=>`L${R(g.ts).toFixed(1)},${S(g.val).toFixed(1)}`).join(" ")+` L${R(u[u.length-1].ts).toFixed(1)},${$-E} Z`,we="";if(_){let g=u.filter(k=>k.min!=null&&k.max!=null);if(g.length>=2){let k=g.map(z=>`${R(z.ts).toFixed(1)},${S(z.max).toFixed(1)}`),j=[...g].reverse().map(z=>`${R(z.ts).toFixed(1)},${S(z.min).toFixed(1)}`);we=`M${k[0]} `+k.slice(1).map(z=>`L${z}`).join(" ")+` L${j[0]} `+j.slice(1).map(z=>`L${z}`).join(" ")+" Z"}}let Re=u[u.length-1],dt=R(Re.ts),ut=S(Re.val),Ne=g=>Math.abs(g)>=1e4?(g/1e3).toFixed(0)+"k":g>=1e3?(g/1e3).toFixed(1)+"k":g.toFixed(g<10?1:0),pt=Ne(A),gt=Ne(y),_t=e.history.filter(g=>["completed","skipped","reset"].includes(g.type)).map(g=>({ts:new Date(g.timestamp).getTime(),type:g.type})).filter(g=>g.ts>=B&&g.ts<=x),ke=Qt,Ee=u;if(u.length>ke){let g=(u.length-1)/(ke-1);Ee=[];for(let k=0;k<ke;k++)Ee.push(u[Math.round(k*g)])}return o`
      <div class="sparkline-container">
        <svg class="sparkline-svg" viewBox="0 0 ${m} ${$}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_sparkline",this._lang)}">
          <!-- Y-axis labels -->
          <text x="${b-3}" y="${L+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${pt}</text>
          <text x="${b-3}" y="${$-E+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${gt}</text>
          <!-- X-axis labels -->
          ...
          <text x="${m-M}" y="${$-1}" text-anchor="end" fill="var(--secondary-text-color)" font-size="7">${new Date(x).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</text>
          <!-- Min/max band (mean-type entities) -->
          ${we?F`<path d="${we}" fill="var(--primary-color)" opacity="0.08" />`:l}
          <!-- Area fill -->
          ...
          ${e.degradation_rate!=null&&e.degradation_trend!=="stable"&&e.degradation_trend!=="insufficient_data"&&u.length>=2?(()=>{let g=u[u.length-1],k=30,j=g.ts+k*864e5,z=g.val+e.degradation_rate*k,G=Math.min(j,x+(x-B)*.3),K=Math.max(y,Math.min(A,z)),ht=R(g.ts),mt=S(g.val),vt=R(G),ft=S(K);return F`<line x1="${ht.toFixed(1)}" y1="${mt.toFixed(1)}" x2="${vt.toFixed(1)}" y2="${ft.toFixed(1)}" stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.7" />`})():l}
          <!-- Threshold lines (for threshold type) -->
          ${r==="threshold"&&i.trigger_above!=null?F`<line x1="${b}" y1="${S(i.trigger_above).toFixed(1)}" x2="${m}" y2="${S(i.trigger_above).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                  <text x="${m-2}" y="${S(i.trigger_above)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">▲ ${i.trigger_above}</text>`:l}
          ${r==="threshold"&&i.trigger_below!=null?F`<line x1="${b}" y1="${S(i.trigger_below).toFixed(1)}" x2="${m}" y2="${S(i.trigger_below).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                  <text x="${m-2}" y="${S(i.trigger_below)+11}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">▼ ${i.trigger_below}</text>`:l}
          <!-- Target line (for counter type) -->
          ${r==="counter"&&P!=null?F`<line x1="${b}" y1="${S(P).toFixed(1)}" x2="${m}" y2="${S(P).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                  <text x="${m-2}" y="${S(P)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">${n("target_value",this._lang)}: +${i.trigger_target_value}</text>`:l}
          <!-- Baseline line (for counter — value at last maintenance) -->
          ${r==="counter"&&C!=null?F`<line x1="${b}" y1="${S(C).toFixed(1)}" x2="${m}" y2="${S(C).toFixed(1)}" stroke="var(--secondary-text-color)" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
                  <text x="${b+2}" y="${S(C)+11}" text-anchor="start" fill="var(--secondary-text-color)" font-size="8">${n("baseline",this._lang)}</text>`:l}
          <!-- Current dot -->
          <circle cx="${dt.toFixed(1)}" cy="${ut.toFixed(1)}" r="3.5" fill="var(--primary-color)" />
          <!-- Event markers -->
          ${_t.map(g=>{let k=R(g.ts),j=g.type==="completed"?"var(--success-color, #4caf50)":g.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return F`
              <line x1="${k.toFixed(1)}" y1="${L}" x2="${k.toFixed(1)}" y2="${$-E}" stroke="${j}" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
          ...
          ${Ee.map(g=>{let k=R(g.ts),j=S(g.val),z=new Date(g.ts).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),G=`${g.val.toFixed(1)} ${t}`;return _&&g.min!=null&&g.max!=null&&(G+=` (${g.min.toFixed(1)}\u2013${g.max.toFixed(1)})`),F`<circle cx="${k.toFixed(1)}" cy="${j.toFixed(1)}" r="8" fill="transparent" tabindex="0"
              @mouseenter=${K=>this._showSparklineTooltip(K,`${z}
${G}`)}
              @focus=${K=>this._showSparklineTooltip(K,`${z}
${G}`)}
...
`).map(g=>o`<div>${g}</div>`)}
    ...
    `}_showSparklineTooltip(e,t){let i=e.currentTarget,r=i.closest(".sparkline-container");if(!r)return;let s=r.getBoundingClientRect(),d=i.getBoundingClientRect();this._sparklineTooltip={x:d.left-s.left+d.width/2,y:d.top-s.top-8,text:t}}_renderHistoryEntry(e){let t=this._lang;return o`
    ...
    `],h([N({attribute:!1})],T.prototype,"hass",2),h([N({type:Boolean})],T.prototype,"narrow",2),h([N({attribute:!1})],T.prototype,"panel",2),h([f()],T.prototype,"_objects",2),h([f()],T.prototype,"_stats",2),h([f()],T.prototype,"_view",2),h([f()],T.prototype,"_selectedEntryId",2),h([f()],T.prototype,"_selectedTaskId",2),h([f()],T.prototype,"_filterStatus",2),h([f()],T.prototype,"_filterUser",2),h([f()],T.prototype,"_unsub",2),h([f()],T.prototype,"_sparklineTooltip",2),h([f()],T.prototype,"_historyFilter",2),h([f()],T.prototype,"_budget",2),h([f()],T.prototype,"_groups",2),h([f()],T.prototype,"_detailStatsData",2),h([f()],T.prototype,"_miniStatsData",2),h([f()],T.prototype,"_features",2),h([f()],T.prototype,"_activeTab",2),h([f()],T.prototype,"_costDurationToggle",2),h([f()],T.prototype,"_historySearch",2),T=h([ae("maintenance-supporter-panel")],T);export{T as MaintenanceSupporterPanel};
