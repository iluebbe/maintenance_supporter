...
`).map(c=>c.trim()).filter(Boolean).slice(0,100);e.checklist=l.length?l:null}let t=await this.hass.connection.sendMessagePromise(e),i=this._taskId||t?.task_id,s=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(i&&this._scheduleType==="sensor_based"&&s)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:i,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=G(e,this._lang,a("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return d;let e=this._lang;return o`
      ...
      <div class="select-row">
        ...
        >
          ${pi.map(t=>o`<option value=${t} ?selected=${t===this._triggerType}>${a(t,e)}</option>`)}
        </select>
      </div>
    ...
    `}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?o`
      ...
      `:this._triggerType==="runtime"?o`
        ...
        ></ha-textfield>
      `:d}render(){if(!this._open)return o``;let e=this._lang,t=this._taskId?a("edit_task",e):a("new_task",e);return o`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._error?o`<div class="error">${this._error}</div>`:d}
          ...
          <div class="select-row">
            ...
            >
              ${_i.map(i=>o`<option value=${i} ?selected=${i===this._type}>${a(i,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${ui.map(i=>o`<option value=${i} ?selected=${i===this._scheduleType}>${a(i,e)}</option>`)}
            </select>
          </div>
...
<script>setTimeout(()=>window.print(),300)<\/script>
      ...
      <div class="settings-section">
        ...
        <label class="setting-row">
          ...
          <select @change=${i=>this._updateSetting("budget_currency",i.target.value)}>
            ${hi.map(i=>o`<option value=${i} ?selected=${t.currency===i}>${i}</option>`)}
          </select>
        </label>
        <label class="setting-row">
  ...
  `,u([w({attribute:!1})],U.prototype,"hass",2),u([w({attribute:!1})],U.prototype,"features",2),u([w({attribute:!1})],U.prototype,"budget",2),u([g()],U.prototype,"_settings",2),u([g()],U.prototype,"_loading",2),u([g()],U.prototype,"_importCsv",2),u([g()],U.prototype,"_importLoading",2),u([g()],U.prototype,"_includeHistory",2),u([g()],U.prototype,"_toast",2),u([g()],U.prototype,"_testingNotification",2);customElements.define("maintenance-settings-view",U);var mi=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"],K=class extends M{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._error="";this._entryId="";this._taskId="";this._values=new Array(12).fill("");this._save=async()=>{let e=this._buildOverrides();if(e!==null){this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:e}),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(t){this._error=G(t,this._lang,a("save_error",this._lang))}finally{this._loading=!1}}};this._clearAll=async()=>{this._loading=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/seasonal_overrides",entry_id:this._entryId,task_id:this._taskId,overrides:{}}),this._values=new Array(12).fill(""),this._open=!1,this.dispatchEvent(new CustomEvent("overrides-saved"))}catch(e){this._error=G(e,this._lang,a("save_error",this._lang))}finally{this._loading=!1}}}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}open(e,t,i){if(this._entryId=e,this._taskId=t,this._values=new Array(12).fill(""),i)for(let[s,l]of Object.entries(i)){let c=parseInt(s,10);c>=1&&c<=12&&typeof l=="number"&&(this._values[c-1]=l.toString())}this._error="",this._open=!0}_close(){this._open=!1}_buildOverrides(){let e={};for(let t=0;t<12;t++){let i=this._values[t].trim();if(!i)continue;let s=parseFloat(i);if(Number.isNaN(s))return this._error=`${a("month_"+["jan","feb","mar","apr","may","jun","jul","aug","sep","oct","nov","dec"][t],this._lang)}: ${a("seasonal_override_invalid",this._lang)}`,null;if(s<.1||s>5)return this._error=a("seasonal_override_range",this._lang),null;e[t+1]=s}return e}render(){if(!this._open)return o``;let e=this._lang;return o`
              ...
              <div class="objects">
                ${this.objects.map(i=>o`
                  <div class="object-block">
                    ...
                    ${i.tasks.length===0?o`<div class="hint small">${a("no_tasks_short",e)}</div>`:i.tasks.map(s=>{let l=`${i.entry_id}:${s.id}`,c=this._selected.has(l);return o`
  ...
  `,u([w({attribute:!1})],V.prototype,"hass",2),u([w({attribute:!1})],V.prototype,"objects",2),u([g()],V.prototype,"_open",2),u([g()],V.prototype,"_loading",2),u([g()],V.prototype,"_error",2),u([g()],V.prototype,"_groupId",2),u([g()],V.prototype,"_name",2),u([g()],V.prototype,"_description",2),u([g()],V.prototype,"_selected",2);customElements.get("maintenance-group-dialog")||customElements.define("maintenance-group-dialog",V);var vi=300,fi=140,Be=27;function ft(r,n){let e=r.trigger_config;if(!e)return d;let t=n.lang,i=r.trigger_entity_info,s=r.trigger_entity_infos,l=i?.friendly_name||e.entity_id||"\u2014",c=e.entity_id||"",_=e.entity_ids||(c?[c]:[]),p=i?.unit_of_measurement||"",m=r.trigger_current_value,h=e.type||"threshold",b=_.length>1;return o`
    <h3>${a("trigger",t)}</h3>
    <div class="trigger-card">
      <div class="trigger-header">
        ...
        <div>
          ${b?o`
            ...
            <div class="trigger-entity-id">${_.map((f,k)=>o`${k>0?", ":""}<span class="entity-link" @click=${T=>re(T,f)}>${f}</span>`)}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `:o`
            <div class="trigger-entity-name">${l}</div>
            <div class="trigger-entity-id">${c?o`<span class="entity-link" @click=${f=>re(f,c)}>${c}</span>`:""}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `}
        </div>
      ...
      <div class="trigger-limits">
        ${h==="threshold"?o`
          ${e.trigger_above!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${a("threshold_above",t)}: ${e.trigger_above} ${p}</span>`:d}
          ${e.trigger_below!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${a("threshold_below",t)}: ${e.trigger_below} ${p}</span>`:d}
          ${e.trigger_for_minutes?o`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${a("for_minutes",t)}: ${e.trigger_for_minutes}</span>`:d}
        `:d}
        ${h==="counter"?o`
          ${e.trigger_target_value!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${a("target_value",t)}: ${e.trigger_target_value} ${p}</span>`:d}
        `:d}
        ${h==="state_change"?o`
          ${e.trigger_target_changes!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${a("target_changes",t)}: ${e.trigger_target_changes}</span>`:d}
        `:d}
        ${h==="runtime"?o`
          ${e.trigger_runtime_hours!=null?o`<span class="trigger-limit-item"><span class="dot warn" aria-hidden="true"></span> ${a("runtime_hours",t)}: ${e.trigger_runtime_hours}h</span>`:d}
        `:d}
        ${h==="compound"?o`
          ...
          ${(e.conditions||[]).map((f,k)=>o`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${k+1}. ${a(f.type||"unknown",t)}: ${f.entity_id?o`<span class="entity-link" @click=${T=>re(T,f.entity_id)}>${f.entity_id}</span>`:""}</span>
          `)}
        `:d}
        ${i?.min!=null?o`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${a("min",t)}: ${i.min} ${p}</span>`:d}
        ${i?.max!=null?o`<span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${a("max",t)}: ${i.max} ${p}</span>`:d}
      </div>

      ${s&&s.length>1?o`
        <div class="trigger-entity-list">
          ${s.map(f=>o`
            <span class="trigger-entity-id">${f.friendly_name} (<span class="entity-link" @click=${k=>re(k,f.entity_id)}>${f.entity_id}</span>)</span>
          `)}
        </div>
      `:d}
  ...
  `}function bi(r,n,e){let t=r.trigger_config;if(!t)return d;let i=t.type||"threshold",s=i==="counter"&&t.trigger_delta_mode,l=e.isCounterEntity(t),c=t.entity_id||"",_=e.detailStatsData.get(c)||[],p=[],m=!1;if(_.length>=2)for(let v of _){let E=v.val;s&&r.trigger_baseline_value!=null&&(E-=r.trigger_baseline_value);let R={ts:v.ts,val:E};!l&&v.min!=null&&v.max!=null&&(R.min=s&&r.trigger_baseline_value!=null?v.min-r.trigger_baseline_value:v.min,R.max=s&&r.trigger_baseline_value!=null?v.max-r.trigger_baseline_value:v.max,m=!0),p.push(R)}else for(let v of r.history)v.trigger_value!=null&&p.push({ts:new Date(v.timestamp).getTime(),val:v.trigger_value});if(r.trigger_current_value!=null){let v=r.trigger_current_value;s&&r.trigger_baseline_value!=null&&(v-=r.trigger_baseline_value),p.push({ts:Date.now(),val:v})}if(p.length<2&&c&&e.hasStatsService&&!e.detailStatsData.has(c))return o`<div class="sparkline-container" aria-live="polite" style="display:flex;align-items:center;justify-content:center;height:140px;color:var(--secondary-text-color);font-size:12px;">
      <ha-icon icon="mdi:chart-line" style="--mdc-icon-size:16px;margin-right:8px;"></ha-icon>
      ${a("loading_chart",e.lang)}
    </div>`;if(p.length<2)return d;p.sort((v,E)=>v.ts-E.ts);let h=vi,b=fi,f=30,k=2,T=8,q=16,C=p.map(v=>v.val),S=Math.min(...C),x=Math.max(...C);if(m)for(let v of p)v.min!=null&&(S=Math.min(S,v.min)),v.max!=null&&(x=Math.max(x,v.max));t.trigger_above!=null&&(x=Math.max(x,t.trigger_above),S=Math.min(S,t.trigger_above)),t.trigger_below!=null&&(S=Math.min(S,t.trigger_below),x=Math.max(x,t.trigger_below));let I=null,O=null;if(i==="counter"&&t.trigger_target_value!=null){if(r.trigger_baseline_value!=null)I=r.trigger_baseline_value;else if(p.length>0){let v=[...r.history].filter(E=>E.type==="completed"||E.type==="reset").sort((E,R)=>new Date(R.timestamp).getTime()-new Date(E.timestamp).getTime())[0];if(v){let E=new Date(v.timestamp).getTime(),R=p[0],P=Math.abs(p[0].ts-E);for(let Y of p){let X=Math.abs(Y.ts-E);X<P&&(R=Y,P=X)}I=R.val}else I=p[0].val}I!=null?(O=I+t.trigger_target_value,x=Math.max(x,O),S=Math.min(S,I)):(x=Math.max(x,t.trigger_target_value),S=Math.min(S,0))}s&&r.trigger_baseline_value!=null&&(S=Math.min(S,0));let Z=x-S||1;S-=Z*.1,x+=Z*.1;let J=p[0].ts,N=p[p.length-1].ts,$=N-J||1,j=v=>f+(v-J)/$*(h-f-k),z=v=>T+(1-(v-S)/(x-S))*(b-T-q),Te=p.map(v=>`${j(v.ts).toFixed(1)},${z(v.val).toFixed(1)}`).join(" "),At=`M${j(p[0].ts).toFixed(1)},${b-q} `+p.map(v=>`L${j(v.ts).toFixed(1)},${z(v.val).toFixed(1)}`).join(" ")+` L${j(p[p.length-1].ts).toFixed(1)},${b-q} Z`,Me="";if(m){let v=p.filter(E=>E.min!=null&&E.max!=null);if(v.length>=2){let E=v.map(P=>`${j(P.ts).toFixed(1)},${z(P.max).toFixed(1)}`),R=[...v].reverse().map(P=>`${j(P.ts).toFixed(1)},${z(P.min).toFixed(1)}`);Me=`M${E[0]} `+E.slice(1).map(P=>`L${P}`).join(" ")+` L${R[0]} `+R.slice(1).map(P=>`L${P}`).join(" ")+" Z"}}let Ve=p[p.length-1],St=j(Ve.ts),Tt=z(Ve.val),We=v=>Math.abs(v)>=1e4?(v/1e3).toFixed(0)+"k":v>=1e3?(v/1e3).toFixed(1)+"k":v.toFixed(v<10?1:0),Mt=We(x),zt=We(S),Ct=r.history.filter(v=>["completed","skipped","reset"].includes(v.type)).map(v=>({ts:new Date(v.timestamp).getTime(),type:v.type})).filter(v=>v.ts>=J&&v.ts<=N),ze=p;if(p.length>Be){let v=(p.length-1)/(Be-1);ze=[];for(let E=0;E<Be;E++)ze.push(p[Math.round(E*v)])}return o`
    <div class="sparkline-container">
      <svg class="sparkline-svg" viewBox="0 0 ${h} ${b}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${a("chart_sparkline",e.lang)}">
        <text x="${f-3}" y="${T+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${Mt}</text>
        <text x="${f-3}" y="${b-q+3}" text-anchor="end" fill="var(--secondary-text-color)" font-size="8">${zt}</text>
        <text x="${f}" y="${b-1}" text-anchor="start" fill="var(--secondary-text-color)" font-size="7">${new Date(J).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</text>
        <text x="${h-k}" y="${b-1}" text-anchor="end" fill="var(--secondary-text-color)" font-size="7">${new Date(N).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</text>
        ...
        ${r.degradation_rate!=null&&r.degradation_trend!=="stable"&&r.degradation_trend!=="insufficient_data"&&p.length>=2?(()=>{let v=p[p.length-1],E=30,R=v.ts+E*864e5,P=v.val+r.degradation_rate*E,Y=Math.min(R,N+(N-J)*.3),X=Math.max(S,Math.min(x,P)),It=j(v.ts),jt=z(v.val),Lt=j(Y),Dt=z(X);return D`<line x1="${It.toFixed(1)}" y1="${jt.toFixed(1)}" x2="${Lt.toFixed(1)}" y2="${Dt.toFixed(1)}" stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.7" />`})():d}
        ${i==="threshold"&&t.trigger_above!=null?D`<line x1="${f}" y1="${z(t.trigger_above).toFixed(1)}" x2="${h}" y2="${z(t.trigger_above).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${z(t.trigger_above)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25B2 ${t.trigger_above}</text>`:d}
        ${i==="threshold"&&t.trigger_below!=null?D`<line x1="${f}" y1="${z(t.trigger_below).toFixed(1)}" x2="${h}" y2="${z(t.trigger_below).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${z(t.trigger_below)+11}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">\u25BC ${t.trigger_below}</text>`:d}
        ${i==="counter"&&O!=null?D`<line x1="${f}" y1="${z(O).toFixed(1)}" x2="${h}" y2="${z(O).toFixed(1)}" stroke="var(--error-color, #f44336)" stroke-width="1.5" stroke-dasharray="5,3" />
                <text x="${h-2}" y="${z(O)-3}" text-anchor="end" fill="var(--error-color, #f44336)" font-size="9">${a("target_value",e.lang)}: +${t.trigger_target_value}</text>`:d}
        ${i==="counter"&&I!=null?D`<line x1="${f}" y1="${z(I).toFixed(1)}" x2="${h}" y2="${z(I).toFixed(1)}" stroke="var(--secondary-text-color)" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
                <text x="${f+2}" y="${z(I)+11}" text-anchor="start" fill="var(--secondary-text-color)" font-size="8">${a("baseline",e.lang)}</text>`:d}
        <circle cx="${St.toFixed(1)}" cy="${Tt.toFixed(1)}" r="3.5" fill="var(--primary-color)" />
        ${Ct.map(v=>{let E=j(v.ts),R=v.type==="completed"?"var(--success-color, #4caf50)":v.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return D`
            <line x1="${E.toFixed(1)}" y1="${T}" x2="${E.toFixed(1)}" y2="${b-q}" stroke="${R}" stroke-width="1" stroke-dasharray="3,3" opacity="0.5" />
            <circle cx="${E.toFixed(1)}" cy="${T+2}" r="5" fill="${R}" opacity="0.8" />
            <text x="${E.toFixed(1)}" y="${T+6}" text-anchor="middle" fill="white" font-size="7" font-weight="bold">${v.type==="completed"?"\u2713":v.type==="skipped"?"\u23ED":"\u21BA"}</text>
          `})}
        ${ze.map(v=>{let E=j(v.ts),R=z(v.val),P=new Date(v.ts).toLocaleDateString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),Y=`${v.val.toFixed(1)} ${n}`;return m&&v.min!=null&&v.max!=null&&(Y+=` (${v.min.toFixed(1)}\u2013${v.max.toFixed(1)})`),D`<circle cx="${E.toFixed(1)}" cy="${R.toFixed(1)}" r="8" fill="transparent" tabindex="0"
            @mouseenter=${X=>vt(X,`${P}
${Y}`,e.setTooltip)}
            @focus=${X=>vt(X,`${P}
${Y}`,e.setTooltip)}
...
`).map(v=>o`<div>${v}</div>`)}
  ...
  `}function vt(r,n,e){let t=r.currentTarget,i=t.closest(".sparkline-container");if(!i)return;let s=i.getBoundingClientRect(),l=t.getBoundingClientRect();e({x:l.left-s.left+l.width/2,y:l.top-s.top-8,text:n})}function bt(r,n,e){let t=r.degradation_trend!=null&&r.degradation_trend!=="insufficient_data",i=r.days_until_threshold!=null,s=r.environmental_factor!=null&&r.environmental_factor!==1;if(!t&&!i&&!s)return d;let l=r.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":r.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return o`
      ...
      <div class="prediction-grid">
        ${t?o`
          <div class="prediction-item">
            ...
            ${r.degradation_rate!=null?o`<span class="prediction-rate">${r.degradation_rate>0?"+":""}${Math.abs(r.degradation_rate)>=10?Math.round(r.degradation_rate).toLocaleString():r.degradation_rate.toFixed(1)} ${r.trigger_entity_info?.unit_of_measurement||""}/${a("day_short",n)}</span>`:d}
          </div>
        `:d}
        ${i?o`
          <div class="prediction-item">
            ...
            ${r.threshold_prediction_date?o`<span class="prediction-date">${te(r.threshold_prediction_date,n)}</span>`:d}
            ${r.threshold_prediction_confidence?o`<span class="confidence-dot ${r.threshold_prediction_confidence}"></span>`:d}
          </div>
        `:d}
        ${s&&e.environmental?o`
          <div class="prediction-item">
            ...
            ${r.environmental_entity?o`<span class="prediction-entity entity-link" @click=${c=>re(c,r.environmental_entity)}>${r.environmental_entity}</span>`:d}
          </div>
        `:d}
      </div>
    </div>
  `}function yt(r,n){let e=r.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return d;let s=r.interval_days??0,l=r.suggested_interval??s;return o`
  ...
  `}function xi(r,n,e,t,i){let f=Math.max(e,t,n,1)*1.3,k=50,T=[];for(let N=0;N<=k;N++){let $=N/k*f,j=1-Math.exp(-Math.pow($/n,r)),z=32+$/f*260,Te=136-j*128;T.push([z,Te])}let q=T.map(([N,$])=>`${N.toFixed(1)},${$.toFixed(1)}`).join(" "),C="M32,136 "+T.map(([N,$])=>`L${N.toFixed(1)},${$.toFixed(1)}`).join(" ")+` L${T[k][0].toFixed(1)},136 Z`,S=32+e/f*260,x=1-Math.exp(-Math.pow(e/n,r)),I=136-x*128,O=((1-x)*100).toFixed(0),Z=32+t/f*260,J=[0,.25,.5,.75,1];return o`
    ...
    <div class="chart-legend">
      ...
      ${e>0?o`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4); opacity:0.5"></span> ${a("current_interval_marker",i)}</span>`:d}
      ${t>0&&t!==e?o`<span class="legend-item"><span class="legend-swatch" style="background:var(--success-color, #4caf50)"></span> ${a("recommended_marker",i)}</span>`:d}
    </div>
  `}function $i(r,n){return o`
  ...
  `}function ki(r,n,e){let t=r.confidence_interval_low,i=r.confidence_interval_high,s=n.suggested_interval??n.interval_days??0,l=n.interval_days??0,c=Math.max(0,t-5),p=i+5-c,m=(t-c)/p*100,h=(i-t)/p*100,b=(s-c)/p*100,f=l>0?(l-c)/p*100:-1;return o`
  ...
  `}var xt=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function $t(r,n,e){if(!e.seasonal||!r.seasonal_factor||r.seasonal_factor===1)return d;let t=xt.map(c=>a(c,n)),i=new Date().getMonth(),s=r.seasonal_factors||r.interval_analysis?.seasonal_factors||null,l=s&&s.length===12?s:t.map((c,_)=>{let p=r.seasonal_factor||1,m=Math.sin((_-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,p+m))});return o`
    <div class="seasonal-card-compact">
      <h4>${a("seasonal_awareness",n)}</h4>
      <div class="seasonal-mini-chart">
        ${l.map((c,_)=>{let p=c*40,m=c<.9?"low":c>1.1?"high":"normal";return o`
  ...
  `}function kt(r,n){return wi(r,n)}function wi(r,n){let e=r.seasonal_factors??r.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return d;let t=r.interval_analysis?.seasonal_reason,i=new Date().getMonth(),s=300,l=100,c=8,p=l-c-4,m=Math.max(...e,1.5),h=s/12,b=h*.65,f=c+p-1/m*p;return o`
    <div class="seasonal-chart">
      <div class="seasonal-chart-title">
        ...
        ${t?o`<span class="source-tag">${t==="learned"?a("seasonal_learned",n):a("seasonal_manual",n)}</span>`:d}
      </div>
      <svg viewBox="0 0 ${s} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${a("chart_seasonal",n)}">
        ...
        ${e.map((k,T)=>{let q=k/m*p,C=T*h+(h-b)/2,S=c+p-q,x=T===i,I=k<1?"var(--success-color, #4caf50)":k>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return D`
      ...
      <div class="seasonal-labels">
        ${xt.map((k,T)=>o`<span class="seasonal-label ${T===i?"active-month":""}">${a(k,n)}</span>`)}
      </div>
    </div>
  `}var Ei=300,Ai=200;function wt(r,n,e,t){let i=r.history.filter(c=>c.type==="completed"&&(c.cost!=null||c.duration!=null));if(i.length<2)return d;let s=i.some(c=>(c.cost??0)>0),l=i.some(c=>(c.duration??0)>0);return!s&&!l?d:o`
  ...
  `}function Si(r,n,e){let t=r.history.filter($=>$.type==="completed"&&($.cost!=null||$.duration!=null)).map($=>({ts:new Date($.timestamp).getTime(),cost:$.cost??0,duration:$.duration??0})).sort(($,j)=>$.ts-j.ts);if(t.length<2)return d;let i=t.some($=>$.cost>0),s=t.some($=>$.duration>0);if(!i&&!s)return d;let l=e!=="duration"&&i,c=e!=="cost"&&s,_=l||!c&&i,p=c||!l&&s,m=Ei,h=Ai,b=_?32:8,f=p?32:8,k=8,T=20,q=m-b-f,C=h-k-T,S=Math.max(...t.map($=>$.cost))||1,x=Math.max(...t.map($=>$.duration))||1,I=Math.min(20,q/t.length*.6),O=q/t.length,Z=$=>b+O*$+O/2,J=$=>k+C-$/S*C,N=$=>k+C-$/x*C;return o`
    <div class="sparkline-container">
      <svg class="history-chart" viewBox="0 0 ${m} ${h}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${a("chart_history",n)}">
        ${_?t.map(($,j)=>D`
          <rect x="${(Z(j)-I/2).toFixed(1)}" y="${J($.cost).toFixed(1)}" width="${I.toFixed(1)}" height="${(k+C-J($.cost)).toFixed(1)}"
            fill="var(--primary-color)" opacity="0.6" rx="2" />
        `):d}
        ${p?D`
          <polyline points="${t.map(($,j)=>`${Z(j).toFixed(1)},${N($.duration).toFixed(1)}`).join(" ")}"
            fill="none" stroke="var(--accent-color, #ff9800)" stroke-width="2" stroke-linejoin="round" />
          ${t.map(($,j)=>D`
            <circle cx="${Z(j).toFixed(1)}" cy="${N($.duration).toFixed(1)}" r="3" fill="var(--accent-color, #ff9800)" />
          `)}
        `:d}
        <text x="${b}" y="${h-2}" text-anchor="start" fill="var(--secondary-text-color)" font-size="7">${new Date(t[0].ts).toLocaleDateString(void 0,{month:"short",day:"numeric"})}</text>
        ...
        ${_?D`
          <text x="${b-3}" y="${k+4}" text-anchor="end" fill="var(--primary-color)" font-size="7">${S.toFixed(0)}\u20AC</text>
  ...
  `}var Ti=60,Mi=20,Et=30,A=class extends M{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._unsub=null;this._sparklineTooltip=null;this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1};this._actionLoading=!1;this._moreMenuOpen=!1;this._toastMessage="";this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab="dashboard";this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=e=>this._onPopState(e);this._deepLinkHandled=!1;this._onDialogEvent=async()=>{try{await this._loadData()}catch{}}}get _lang(){return this.hass?.language||"en"}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._popstateHandler);let e=localStorage.getItem("maintenance_supporter_sort");e&&["due_date","object","type","task_name"].includes(e)&&(this._sortMode=e)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(e){if(super.updated(e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Se(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new de(this.hass),this._userService.getUsers())}}async _loadData(){let[e,t,i,s,l]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null)]);e&&(this._objects=e.objects),t&&(this._stats=t),i&&(this._budget=i),s&&(this._groups=s.groups||{}),l&&(this._features=l.features),this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search),t=e.get("entry_id");if(!t)return;this._deepLinkHandled=!0;let i=e.get("task_id"),s=e.get("action"),l=window.location.pathname+window.location.hash;history.replaceState(history.state,"",l);let c=this._getObject(t);if(!c){this._showOverview();return}if(i){let _=c.tasks.find(p=>p.id===i);if(!_){this._showObject(t);return}this._showTask(t,i),s==="complete"&&requestAnimationFrame(()=>{this._openCompleteDialog(t,i,_.name,this._features.checklists?_.checklist:void 0,this._features.adaptive&&!!_.adaptive_config?.enabled)})}else this._showObject(t)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let i=await this._statsService.getDetailStats(e,t),s=new Map(this._detailStatsData);s.set(e,i),this._detailStatsData=s}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=[];for(let i of this._objects)for(let s of i.tasks){let l=s.trigger_config?.entity_id;l&&e.push({entityId:l,isCounter:this._isCounterEntity(s.trigger_config)})}if(e.length===0)return;let t=await this._statsService.getBatchMiniStats(e);this._miniStatsData=new Map([...this._miniStatsData,...t])}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _taskRows(){let e=[];for(let _ of this._objects)for(let p of _.tasks){if(this._filterStatus&&p.status!==this._filterStatus)continue;if(this._filterUser){let h=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(p.responsible_user_id!==h)continue}let m=[];for(let h of Object.values(this._groups))h.task_refs?.some(b=>b.entry_id===_.entry_id&&b.task_id===p.id)&&m.push(h.name);e.push({entry_id:_.entry_id,task_id:p.id,object_name:_.object.name,task_name:p.name,type:p.type,schedule_type:p.schedule_type,status:p.status,days_until_due:p.days_until_due??null,next_due:p.next_due??null,trigger_active:p.trigger_active,trigger_current_value:p.trigger_current_value??null,trigger_current_delta:p.trigger_current_delta??null,trigger_config:p.trigger_config??null,trigger_entity_info:p.trigger_entity_info??null,times_performed:p.times_performed,total_cost:p.total_cost,interval_days:p.interval_days??null,interval_anchor:p.interval_anchor??null,history:p.history||[],enabled:p.enabled,nfc_tag_id:p.nfc_tag_id??null,area_id:_.object.area_id??null,responsible_user_id:p.responsible_user_id??null,group_names:m})}let t={overdue:0,triggered:1,due_soon:2,ok:3},i=(_,p)=>(t[_.status]??9)-(t[p.status]??9),s=(_,p)=>(_.days_until_due??99999)-(p.days_until_due??99999),l=(_,p)=>i(_,p)||s(_,p),c={due_date:l,object:(_,p)=>_.object_name.localeCompare(p.object_name)||l(_,p),type:(_,p)=>_.type.localeCompare(p.type)||l(_,p),task_name:(_,p)=>_.task_name.localeCompare(p.task_name)};return e.sort(c[this._sortMode]),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(s=>s.id===t)}_pushPanelState(e,t,i){let s={msp_view:e,msp_entry:t||null,msp_task:i||null};history.pushState(s,"")}_onPopState(e){let t=e.state;if(t?.msp_view&&(this._view=t.msp_view,this._selectedEntryId=t.msp_entry||null,this._selectedTaskId=t.msp_task||null,this._moreMenuOpen=!1,t.msp_view==="task"&&t.msp_entry&&t.msp_task)){this._historyFilter=null;let i=this._getTask(t.msp_entry,t.msp_task);i?.trigger_config?.entity_id&&this._fetchDetailStats(i.trigger_config.entity_id,this._isCounterEntity(i.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null}_showObject(e){this._pushPanelState("object",e),this._view="object",this._selectedEntryId=e,this._selectedTaskId=null}_showTask(e,t){this._pushPanelState("task",e,t),this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._activeTab="overview",this._historyFilter=null;let i=this._getTask(e,t);if(i?.trigger_config?.entity_id){let s=i.trigger_config.entity_id,l=this._isCounterEntity(i.trigger_config);this._fetchDetailStats(s,l)}}_showToast(e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}async _deleteObject(e){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:a("delete",this._lang),message:a("confirm_delete_object",this._lang),confirmText:a("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:e}),this._showOverview(),await this._loadData()}catch{this._showToast(a("action_error",this._lang))}}async _deleteTask(e,t){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:a("delete",this._lang),message:a("confirm_delete_task",this._lang),confirmText:a("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/delete",entry_id:e,task_id:t}),this._showObject(e),await this._loadData()}catch{this._showToast(a("action_error",this._lang))}}async _skipTask(e,t,i){this._actionLoading=!0;try{let s={type:"maintenance_supporter/task/skip",entry_id:e,task_id:t};i&&(s.reason=i),await this.hass.connection.sendMessagePromise(s),await this._loadData()}catch{this._showToast(a("action_error",this._lang))}finally{this._actionLoading=!1}}async _resetTask(e,t,i){this._actionLoading=!0;try{let s={type:"maintenance_supporter/task/reset",entry_id:e,task_id:t};i&&(s.date=i),await this.hass.connection.sendMessagePromise(s),await this._loadData()}catch{this._showToast(a("action_error",this._lang))}finally{this._actionLoading=!1}}async _applySuggestion(e,t,i){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/apply_suggestion",entry_id:e,task_id:t,interval:i}),await this._loadData()}catch{this._showToast(a("action_error",this._lang))}}_openSeasonalOverrides(e){let t=this.shadowRoot.querySelector("maintenance-seasonal-overrides-dialog");if(!t||!this._selectedEntryId)return;let i=e.adaptive_config?.seasonal_overrides;t.open(this._selectedEntryId,e.id,i)}async _reanalyzeInterval(e,t){try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:e,task_id:t});i.recommended_interval?this._showToast(`${a("reanalyze_result",this._lang)}: ${i.recommended_interval} ${a("days",this._lang)} (${a(`confidence_${i.confidence}`,this._lang)}, ${i.data_points} ${a("data_points",this._lang)})`):this._showToast(a("reanalyze_insufficient_data",this._lang)),await this._loadData()}catch{this._showToast(a("action_error",this._lang))}}async _promptSkipTask(e,t){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!i)return;let s=await i.prompt({title:a("skip",this._lang),message:a("skip_reason_prompt",this._lang),confirmText:a("skip",this._lang),inputLabel:a("reason_optional",this._lang),inputType:"text"});s.confirmed&&this._skipTask(e,t,s.value||void 0)}async _promptResetTask(e,t){let i=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!i)return;let s=await i.prompt({title:a("reset",this._lang),message:a("reset_date_prompt",this._lang),confirmText:a("reset",this._lang),inputLabel:a("reset_date_optional",this._lang),inputType:"date"});s.confirmed&&this._resetTask(e,t,s.value||void 0)}_dismissSuggestion(e,t){e&&t&&this._dismissedSuggestions.add(`${e}_${t}`),this.requestUpdate()}_openCompleteDialog(e,t,i,s,l){let c=this.shadowRoot.querySelector("maintenance-complete-dialog");c&&(c.entryId=e,c.taskId=t,c.taskName=i,c.lang=this._lang,c.checklist=s||[],c.adaptiveEnabled=!!l,c.open())}_openQrForObject(e,t){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForObject(e,t)}_openQrForTask(e,t,i,s){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForTask(e,t,i,s)}render(){return o`
      ...
      <div class="objects-grid">
        ${this._objects.map(t=>o`
          <div class="object-card" @click=${()=>this._showObject(t.entry_id)}>
            ...
            ${t.object.manufacturer||t.object.model?o`<div class="object-card-meta">${[t.object.manufacturer,t.object.model].filter(Boolean).join(" ")}</div>`:d}
            ${t.tasks.length===0?o`<div class="object-card-empty">${a("no_tasks_yet",e)}</div>`:d}
          </div>
        `)}
      </div>
      ...
      <div class="groups-section">
        ...
        ${e.length===0?o`<div class="hint">${a("no_groups",t)}</div>`:o`
            <div class="groups-grid">
              ${e.map(([i,s])=>{let l=s.task_refs.map(c=>this._getTask(c.entry_id,c.task_id)?.name).filter(Boolean);return o`
                  <div class="group-card">
                    ...
                    <div class="group-card-tasks">
                      ${l.length>0?l.map(c=>o`<span class="group-task-chip">${c}</span>`):o`<span style="font-size:12px;color:var(--secondary-text-color)">${a("no_tasks_short",t)}</span>`}
                    </div>
                  </div>
                `})}
            </div>
    ...
    `}_renderOverviewRow(e){let t=this._lang,i=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,s=0,l=Ee.ok,c=!1;if(i&&e.days_until_due!==null){let h=(e.interval_days-e.days_until_due)/e.interval_days*100;s=Math.max(0,Math.min(100,h)),c=h>100,e.status==="overdue"?l=Ee.overdue:e.status==="due_soon"&&(l=Ee.due_soon)}let _=e.area_id?this.hass?.areas?.[e.area_id]?.name:null,p=e.responsible_user_id?this._userService?.getUserName(e.responsible_user_id):null,m=e.group_names.length>0||_||p;return o`
      <div class="task-row${e.enabled?"":" task-disabled"}">
        ...
        <span class="due-cell" @click=${()=>this._showTask(e.entry_id,e.task_id)}>
          ...
          ${i?o`<div class="days-bar"><div class="days-bar-fill${c?" overflow":""}" style="width:${s}%;background:${l}"></div></div>`:d}
        ...
        <span class="row-actions">
          <mwc-icon-button class="btn-complete" title="${a("complete",t)}" @click=${h=>{h.stopPropagation(),this._openCompleteDialogForRow(e)}}>
            <ha-icon icon="mdi:check"></ha-icon>
          </mwc-icon-button>
          <mwc-icon-button class="btn-skip" title="${a("skip",t)}" .disabled=${this._actionLoading} @click=${h=>{h.stopPropagation(),this._promptSkipTask(e.entry_id,e.task_id)}}>
            <ha-icon icon="mdi:skip-next"></ha-icon>
          </mwc-icon-button>
        </span>
      </div>
    `}_openCompleteDialogForRow(e){let i=this._objects.find(s=>s.entry_id===e.entry_id)?.tasks.find(s=>s.id===e.task_id);this._openCompleteDialog(e.entry_id,e.task_id,e.task_name,this._features.checklists?i?.checklist:void 0,this._features.adaptive&&!!i?.adaptive_config?.enabled)}_renderTriggerProgress(e){let t=e.trigger_config??null;if(!t)return d;let i=t.type||"threshold",s=e.trigger_entity_info?.unit_of_measurement??"",l=0,c="";if(i==="threshold"){let m=e.trigger_current_value??null;if(m==null)return d;let h=t.trigger_above,b=t.trigger_below;if(h!=null){let f=b??0,k=h-f||1;l=Math.min(100,Math.max(0,(m-f)/k*100)),c=`${m.toFixed(1)} / ${h} ${s}`}else if(b!=null){let k=e.trigger_entity_info?.max??(b*2||100),T=k-b||1;l=Math.min(100,Math.max(0,(k-m)/T*100)),c=`${m.toFixed(1)} / ${b} ${s}`}else return d}else if(i==="counter"){let m=t.trigger_target_value||1,b=e.trigger_current_delta??null??e.trigger_current_value??null;if(b==null)return d;l=Math.min(100,Math.max(0,b/m*100)),c=`${b.toFixed(1)} / ${m} ${s}`}else if(i==="state_change"){let m=t.trigger_target_changes||1,h=e.trigger_current_value??null;if(h==null)return d;l=Math.min(100,Math.max(0,h/m*100)),c=`${Math.round(h)} / ${m}`}else if(i==="runtime"){let m=t.trigger_runtime_hours||100,h=e.trigger_current_value??null;if(h==null)return d;l=Math.min(100,Math.max(0,h/m*100)),c=`${h.toFixed(1)}h / ${m}h`}else if(i==="compound"){let m=t.compound_logic||t.operator||"AND",h=t.conditions?.length||0;c=`${m} (${h})`,l=e.trigger_active?100:0}else return d;let _=l>=100,p=l>90?"var(--error-color, #f44336)":l>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return o`
    ...
    `}_renderMiniSparkline(e){if(!e.trigger_config?.entity_id)return d;let t=e.trigger_config.entity_id,i=this._miniStatsData.get(t)||[],s=[];if(i.length>=2)s=i.map(x=>({ts:x.ts,val:x.val}));else{if(!e.history)return d;for(let x of e.history)x.trigger_value!=null&&s.push({ts:new Date(x.timestamp).getTime(),val:x.trigger_value})}if(e.trigger_current_value!=null&&s.push({ts:Date.now(),val:e.trigger_current_value}),s.length<2)return d;s.sort((x,I)=>x.ts-I.ts);let l=Ti,c=Mi,_=s.map(x=>x.val),p=Math.min(..._),m=Math.max(..._),h=m-p||1;p-=h*.1,m+=h*.1;let b=s[0].ts,k=s[s.length-1].ts-b||1,T=x=>(x-b)/k*l,q=x=>2+(1-(x-p)/(m-p))*(c-4),C=s;if(C.length>Et){let x=Math.ceil(C.length/Et);C=C.filter((I,O)=>O%x===0||O===C.length-1)}let S=C.map(x=>`${T(x.ts).toFixed(1)},${q(x.val).toFixed(1)}`).join(" ");return o`
      <svg class="mini-sparkline" viewBox="0 0 ${l} ${c}" preserveAspectRatio="none" role="img" aria-label="${a("chart_mini_sparkline",this._lang)}">
        <polyline points="${S}" fill="none" stroke="var(--primary-color)" stroke-width="1.5" stroke-linejoin="round" />
      </svg>
    `}_renderDaysProgress(e){let t=this._lang;if(e.days_until_due==null||!e.interval_days||e.interval_days<=0)return d;let s=(e.interval_days-e.days_until_due)/e.interval_days*100,l=Math.max(0,Math.min(100,s)),c=s>100,_="var(--success-color, #4caf50)";return e.status==="overdue"?_="var(--error-color, #f44336)":e.status==="due_soon"&&(_="var(--warning-color, #ff9800)"),o`
      <div class="days-progress">
        <div class="days-progress-labels">
          <span>${e.last_performed?`${a("last_performed",t)}: ${te(e.last_performed,t)}`:""}</span>
          <span>${e.next_due?`${a("next_due",t)}: ${te(e.next_due,t)}`:""}</span>
        </div>
        <div class="days-progress-bar" role="progressbar" aria-valuenow="${Math.round(l)}" aria-valuemin="0" aria-valuemax="100" aria-label="${a("days_progress",t)}">
          <div class="days-progress-fill${c?" overflow":""}" style="width:${l}%;background:${_}"></div>
        </div>
        <div class="days-progress-text">${Ae(e.days_until_due,t)}</div>
      </div>
    `}_renderObjectDetail(){if(!this._selectedEntryId)return d;let e=this._getObject(this._selectedEntryId);if(!e)return o`<p>Object not found.</p>`;let t=e.object,i=this._lang;return o`
      <div class="detail-section">
        ...
        ${t.serial_number?o`<p class="meta">${a("serial_number_label",i)}: ${t.serial_number}</p>`:d}
        ${t.installation_date?o`<p class="meta">${a("installed",i)}: ${te(t.installation_date,i)}</p>`:d}
        ...
        ${e.tasks.length===0?o`<div class="empty-state-centered">
            ...
            </div>`:[...e.tasks].sort((s,l)=>{let c={overdue:0,triggered:1,due_soon:2,ok:3};return(c[s.status]??9)-(c[l.status]??9)||(s.days_until_due??99999)-(l.days_until_due??99999)}).map(s=>o`
              <div class="task-row${s.enabled?"":" task-disabled"}">
                <span class="status-badge ${s.status}">${a(s.status,i)}</span>
                ${s.enabled?d:o`<span class="badge-disabled">${a("disabled",i)}</span>`}
                ${s.nfc_tag_id?o`<span class="nfc-badge" title="${a("nfc_linked",i)}"><ha-icon icon="mdi:nfc-variant"></ha-icon></span>`:d}
                ...
                <span class="due-cell" @click=${()=>this._showTask(e.entry_id,s.id)}>
                  <span class="due-text">${Ae(s.days_until_due,i)}</span>
    ...
    `}_renderTaskHeader(e){let t=this._lang,s=this._getObject(this._selectedEntryId)?.object.name||"",l=e.status==="due_soon"?"warning":e.status||"ok",c=a(e.status||"ok",t);return o`
      <div class="task-header">
        <div class="task-header-title">
          ...
          <span class="status-chip ${l}">${c}</span>
      ...
      <div class="tab-content overview-tab">
        ...
        <div class="two-column-layout ${l?"":"single-column"}">
          ...
          <div class="right-column">
            ${wt(e,t,this._costDurationToggle,p=>{this._costDurationToggle=p})}
          </div>
        </div>
        ${c?yt(e,t):d}
        ${_?o`
    ...
    `}_renderChecklistCard(e){if(!this._features.checklists)return d;let t=e.checklist||[];if(t.length===0)return d;let i=this._lang;return o`
      <div class="checklist-preview-card">
        <div class="checklist-preview-header">
          ...
          <span>${a("checklist",i)} (${t.length})</span>
        </div>
    ...
    `}_renderTaskMeta(e){let t=e.documentation_url&&/^https?:\/\//i.test(e.documentation_url)?e.documentation_url:null;if(!e.notes&&!t)return d;let i=this._lang;return o`
    ...
    `}_renderKPIBar(e){let t=this._lang,i=e.times_performed>0?e.total_cost/e.times_performed:0,s=e.days_until_due!==null&&e.days_until_due!==void 0?e.days_until_due<0?"overdue":e.days_until_due<=e.warning_days?"warning":"":"";return o`
      <div class="kpi-bar">
        <div class="kpi-card">
          ...
          ${this._features.schedule_time&&e.schedule_time?o`<div class="kpi-subtext">${a("at_time",t)} ${e.schedule_time}</div>`:d}
        </div>
    ...
    `}_renderRecommendationCard(e){let t=this._lang;if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return d;if(this._selectedEntryId&&this._selectedTaskId&&this._dismissedSuggestions.has(`${this._selectedEntryId}_${this._selectedTaskId}`))return d;let i=e.interval_days,s=e.suggested_interval,l=e.interval_confidence||"medium",c=Math.max(i||1,s);return o`
      ...
      <div class="recent-activities">
        ...
        ${i.map(l=>o`
          <div class="activity-item">
            ...
            <span class="activity-date">${Ue(l.timestamp,t)}</span>
            <span class="activity-note">${l.notes||"\u2014"}</span>
            ${l.cost?o`<span class="activity-badge">${l.cost.toFixed(0)}${this._budget?.currency_symbol||"\u20AC"}</span>`:d}
            ${l.duration?o`<span class="activity-badge">${l.duration}min</span>`:d}
          </div>
        `)}
    ...
    `}_renderHistoryFilters(e){let t=this._lang;return o`
      <div class="history-filters-new">
        <div class="filter-chips">
          ${["completed","skipped","reset","triggered"].map(i=>{let s=e.history.filter(l=>l.type===i).length;return s===0?d:o`
              <span class="filter-chip ${this._historyFilter===i?"active":""}"
                @click=${()=>{this._historyFilter=this._historyFilter===i?null:i}}>
                ${a(i,t)} (${s})
              </span>
            `})}
          ${this._historyFilter?o`<span class="filter-chip clear" @click=${()=>{this._historyFilter=null}}>${a("show_all",t)}</span>`:d}
        </div>
      ...
      <div class="history-entry">
        ...
        <div class="history-content">
          ...
          <div class="history-details">
            ${e.cost!=null?o`<span>${a("cost",t)}: ${e.cost.toFixed(2)} ${this._budget?.currency_symbol||"\u20AC"}</span>`:d}
            ${e.duration!=null?o`<span>${a("duration",t)}: ${e.duration} min</span>`:d}
            ${e.trigger_value!=null?o`<span>${a("trigger_val",t)}: ${e.trigger_value}</span>`:d}
          </div>
        </div>
      </div>
    `}};A.styles=[gt,ht],u([w({attribute:!1})],A.prototype,"hass",2),u([w({type:Boolean,reflect:!0})],A.prototype,"narrow",2),u([w({attribute:!1})],A.prototype,"panel",2),u([g()],A.prototype,"_objects",2),u([g()],A.prototype,"_stats",2),u([g()],A.prototype,"_view",2),u([g()],A.prototype,"_selectedEntryId",2),u([g()],A.prototype,"_selectedTaskId",2),u([g()],A.prototype,"_filterStatus",2),u([g()],A.prototype,"_filterUser",2),u([g()],A.prototype,"_unsub",2),u([g()],A.prototype,"_sparklineTooltip",2),u([g()],A.prototype,"_historyFilter",2),u([g()],A.prototype,"_budget",2),u([g()],A.prototype,"_groups",2),u([g()],A.prototype,"_detailStatsData",2),u([g()],A.prototype,"_miniStatsData",2),u([g()],A.prototype,"_features",2),u([g()],A.prototype,"_actionLoading",2),u([g()],A.prototype,"_moreMenuOpen",2),u([g()],A.prototype,"_toastMessage",2),u([g()],A.prototype,"_overviewTab",2),u([g()],A.prototype,"_activeTab",2),u([g()],A.prototype,"_costDurationToggle",2),u([g()],A.prototype,"_historySearch",2),u([g()],A.prototype,"_sortMode",2),A=u([ct("maintenance-supporter-panel")],A);export{A as MaintenanceSupporterPanel};
