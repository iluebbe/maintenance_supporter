              ...
              <div class="objects">
                ${[...this.objects].sort((a,s)=>a.object.name.localeCompare(s.object.name)).map(a=>l`
                  <div class="object-block">
                    ...
                    ${a.tasks.length===0?l`<div class="hint small">${i("no_tasks_short",e)}</div>`:[...a.tasks].sort((s,r)=>s.name.localeCompare(r.name)).map(s=>{let r=`${a.entry_id}:${s.id}`,c=this._selected.has(r);return l`
