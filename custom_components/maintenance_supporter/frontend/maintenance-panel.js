...
`).map(c=>c.trim()).filter(Boolean).slice(0,100);t.checklist=l.length?l:null}if(this.completionActionsEnabled){let l=this._actionService.trim();if(l&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(l)){let g={service:l},m=this._actionTargetEntity.trim();m&&(g.target={entity_id:m});let v=this._buildActionData();Object.keys(v).length>0&&(g.data=v),t.on_complete_action=g}else t.on_complete_action=null;let c={};this._qcNotes.trim()&&(c.notes=this._qcNotes.trim());let d=parseFloat(this._qcCost);!isNaN(d)&&d>=0&&(c.cost=d);let h=parseInt(this._qcDuration,10);!isNaN(h)&&h>=0&&(c.duration=h),this._qcFeedback&&(c.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(c).length?c:null}let e=await this.hass.connection.sendMessagePromise(t),i=this._taskId||e?.task_id,a=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(i&&this._scheduleType==="sensor_based"&&a)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:i,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=I(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return p;let t=this._lang,e=this._triggerType==="compound";return o`
      ...
      <div class="select-row">
        ...
        >
          ${ps.map(i=>o`<option value=${i} ?selected=${i===this._triggerType}>${s(i,t)}</option>`)}
        </select>
      </div>
    ...
    `}_renderCondition(t,e){let i=this._lang,a=e+1;return o`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${oi.map(l=>o`<option value=${l} ?selected=${l===t.type}>${s(l,i)}</option>`)}
          </select>
        </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${ls.map(i=>o`<option value=${i} ?selected=${i===this._priority}>${s("priority_"+i,t)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${cs.map(i=>o`<option value=${i} ?selected=${i===this._scheduleType}>${s(i,t)}</option>`)}
            </select>
          </div>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,u([y({attribute:!1})],tt.prototype,"hass",2),u([y()],tt.prototype,"lang",2),u([_()],tt.prototype,"_open",2),u([_()],tt.prototype,"_loading",2),u([_()],tt.prototype,"_error",2),u([_()],tt.prototype,"_viewResult",2),u([_()],tt.prototype,"_completeResult",2),u([_()],tt.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",tt);var ci=5;function Ft(n){let r=n.getFullYear(),t=String(n.getMonth()+1).padStart(2,"0"),e=String(n.getDate()).padStart(2,"0");return`${r}-${t}-${e}`}function vs(n,r){let t=[];for(let e=0;e<r;e++){let i=new Date(n);i.setDate(i.getDate()+e),i.setHours(0,0,0,0),t.push(Ft(i))}return t}function ce(n,r){let[t,e,i]=n.split("-").map(Number),a=new Date(t,e-1,i);return a.setDate(a.getDate()+r),Ft(a)}function bs(n){if(!n||n.length===0)return null;let r=n.map(t=>t.cost).filter(t=>typeof t=="number");return r.length===0?null:r.reduce((t,e)=>t+e,0)/r.length}function fs(n){let{windowStart:r,windowEnd:t,task:e,entryId:i,objectName:a}=n,l=[],c=(m,v)=>({date:m,entry_id:i,task_id:e.id,task_name:e.name,object_name:a,status:v&&(e.status==="overdue"||e.status==="triggered")?"ok":e.status,days_until_due:v?null:e.days_until_due??null,projected:v,schedule_type:e.schedule_type,interval_days:e.interval_days??null,interval_unit:e.interval_unit??null,responsible_user_id:e.responsible_user_id??null,avg_cost:bs(e.history),adaptive_enabled:!!e.adaptive_config?.enabled,prediction_confidence:e.threshold_prediction_confidence??null}),d=Math.max(1,Math.round(Me(e.interval_days,e.interval_unit)));if(e.status==="overdue"||e.status==="triggered"){if(l.push(c(r,!1)),e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0){let m=ce(r,d),v=1;for(;m<=t&&v<ci;)l.push(c(m,!0)),v++,m=ce(m,d)}return l}let h=e.next_due;if(typeof h!="string"||!h)return l;let g=h.slice(0,10);if(g>=r&&g<=t)l.push(c(g,!1));else if(g>t)return l;if(e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0){let m=ce(g,d),v=l.length;for(;m<=t&&v<ci;)m>=r&&(l.push(c(m,!0)),v++),m=ce(m,d)}return l}var di={overdue:0,triggered:1,due_soon:2,ok:3};function pi(n,r,t,e=null){let i=vs(r,t),a=i[0],l=i[i.length-1],c=[];for(let h of n){let g=h.object?.name||"",m=h.entry_id,v=h.tasks||[];for(let f of v){if(e&&f.responsible_user_id!==e||f.enabled===!1)continue;let w=fs({windowStart:a,windowEnd:l,task:f,entryId:m,objectName:g});c.push(...w)}}let d=new Map;for(let h of i)d.set(h,[]);for(let h of c){let g=d.get(h.date);g&&g.push(h)}for(let[,h]of d)h.sort((g,m)=>{let v=di[g.status]??99,f=di[m.status]??99;if(v!==f)return v-f;if(g.projected!==m.projected)return g.projected?1:-1;let w=g.object_name.localeCompare(m.object_name);return w!==0?w:g.task_name.localeCompare(m.task_name)});return i.map(h=>({date:h,events:d.get(h)??[]}))}var ys={completed:"ok",reset:"ok",skipped:"due_soon",triggered:"triggered",trigger_replaced:"triggered",trigger_removed:"ok"};function xs(n,r){let t=[];for(let e=r-1;e>=0;e--){let i=new Date(n);i.setDate(i.getDate()-e),i.setHours(0,0,0,0),t.push(Ft(i))}return t}function ui(n,r,t,e=null){let i=xs(r,t),a=i[0],l=i[i.length-1],c=new Map;for(let h of i)c.set(h,[]);for(let h of n){let g=h.object?.name||"",m=h.entry_id,v=h.tasks||[];for(let f of v){if(e&&f.responsible_user_id!==e)continue;let w=f.history||[];for(let b of w){if(typeof b?.timestamp!="string")continue;let j=b.timestamp.slice(0,10);if(j<a||j>l)continue;let z=c.get(j);if(!z)continue;let H=b.type??"completed";z.push({date:j,entry_id:m,task_id:f.id,task_name:f.name,object_name:g,status:ys[H]??"ok",days_until_due:null,projected:!1,schedule_type:f.schedule_type,interval_days:f.interval_days??null,responsible_user_id:f.responsible_user_id??null,avg_cost:typeof b.cost=="number"?b.cost:null,adaptive_enabled:!!f.adaptive_config?.enabled,prediction_confidence:null,history_timestamp:b.timestamp,history_type:H,history_cost:typeof b.cost=="number"?b.cost:null,history_notes:typeof b.notes=="string"?b.notes:null,history_duration:typeof b.duration=="number"?b.duration:null})}}}let d={completed:0,reset:1,skipped:2,triggered:3,trigger_replaced:4};for(let[,h]of c)h.sort((g,m)=>{let v=d[g.history_type??""]??99,f=d[m.history_type??""]??99;if(v!==f)return v-f;let w=g.object_name.localeCompare(m.object_name);return w!==0?w:g.task_name.localeCompare(m.task_name)});return i.map(h=>({date:h,events:c.get(h)??[]}))}var hi=A`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;var et=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(t){this._config={...t},t.past_days&&[30,90].includes(t.past_days)?this._pastDays=t.past_days:t.window_days&&[7,14,30,365].includes(t.window_days)&&(this._windowDays=t.window_days,this._pastDays=0),typeof t.user_filter=="string"&&(this._userFilter=t.user_filter)}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(t){super.updated(t);let e=this.hass?.language;if(e&&!te(e)&&at(e).then(()=>this.requestUpdate()),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,e]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=e}catch{}}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(e=>{let i=e;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){t();return}this._unsub=t}catch{}}_onEventClick(t){if(t.history_timestamp){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:t.entry_id,task_id:t.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return p;let t=this._lang,e=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,l=null;this._userFilter&&(l=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let c=new Date;c.setHours(0,0,0,0);let d=this._pastDays>0,h=d?ui(this._objects,c,this._pastDays,l):pi(this._objects,c,this._windowDays,l),g=Ft(c),m=this._windowDays===365||d,v=m?h.filter(b=>b.events.length>0):h,f=b=>{let j=`cal-status-${b.status}`,z=b.projected?"cal-event-projected":"",H=b.status==="overdue"&&b.days_until_due!=null?` (${Math.abs(b.days_until_due)}d ${s("overdue",t).toLowerCase()})`:"",M=b.projected&&b.interval_days?o`<span class="cal-event-recur">${b.interval_unit&&b.interval_unit!=="days"?`${b.interval_days} ${s("unit_"+b.interval_unit,t)}`:s("cal_every_n_days",t).replace("{n}",String(b.interval_days))}</span>`:p,T=b.schedule_type==="sensor_based",Y=T?o`<ha-icon class="cal-event-icon cal-source-sensor"
    ...
    `],u([y({attribute:!1})],et.prototype,"hass",2),u([_()],et.prototype,"_config",2),u([_()],et.prototype,"_objects",2),u([_()],et.prototype,"_stats",2),u([_()],et.prototype,"_windowDays",2),u([_()],et.prototype,"_pastDays",2),u([_()],et.prototype,"_userFilter",2),u([_()],et.prototype,"_unsub",2);var $s=[{value:7,label:"Week (7 days)"},{value:14,label:"Fortnight (14 days)"},{value:30,label:"Month (30 days, default)"},{value:365,label:"Year (365 days, empty days collapsed)"}],At=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}setConfig(t){this._config={...t}}_valueChanged(t,e){let i={...this._config,[t]:e};t==="show_window_chips"&&e===!0&&delete i.show_window_chips,t==="show_user_filter"&&e===!0&&delete i.show_user_filter,t==="title"&&(!e||typeof e=="string"&&e.trim()==="")&&delete i.title,t==="user_filter"&&e===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let t=this._config.window_days??30,e=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.user_filter??"",l=this._config.title??"";return o`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${$s.map(c=>o`<option value="${c.value}" ?selected=${c.value===t}>${c.label}</option>`)}
          </select>
        </div>
...
<body>
      ...
      <div class="svg-holder">
        ...
        >
          ...
          ${mt.map(k=>{let $=M(k.ts),R=k.type==="completed"?"var(--success-color, #4caf50)":k.type==="skipped"?"var(--warning-color, #ff9800)":"var(--info-color, #2196f3)";return P`
              ...
              <rect x="${($-1.5).toFixed(1)}" y="${l+3}" width="3" height="${bi-6}" rx="1.5" fill="${R}">
  ...
  `}function xi(n,r){let t=n.trigger_config;if(!t)return[];let e=t.type||"threshold",i=t.entity_id||"",a=e==="runtime"?[]:r.detailStatsData.get(i)||[],l=r.isCounterEntity(t),c=[];if(a.length>=2)for(let d of a){let h={ts:d.ts,val:d.val};!l&&d.min!=null&&d.max!=null&&(h.min=d.min,h.max=d.max),c.push(h)}else for(let d of n.history)d.trigger_value!=null&&c.push({ts:new Date(d.timestamp).getTime(),val:d.trigger_value});return n.trigger_current_value!=null&&c.push({ts:Date.now(),val:n.trigger_current_value}),c.sort((d,h)=>d.ts-h.ts),c}function Is(n,r,t){let e=n.trigger_config;if(!e)return p;let i=e.type||"threshold",a=e.entity_id||"",l=xi(n,t);i==="runtime"&&e.trigger_runtime_hours&&n.trigger_current_value!=null&&(l=[{ts:Pe(n)??l[0]?.ts??Date.now()-864e5,val:0},{ts:Date.now(),val:Math.max(0,n.trigger_current_value)}]),t.hideOutliers&&(l=As(l));let c=l.length<2&&!!a&&t.hasStatsService&&!t.detailStatsData.has(a);if(l.length<2&&!c)return p;let d=!!a&&t.detailStatsData.has(a)&&(t.detailStatsData.get(a)?.length??0)<2,h=Date.now()-t.rangeDays*864e5,g=l.filter(b=>b.ts>=h);g.length>=2&&(l=g);let m=null,v=!1;if(i==="counter"&&e.trigger_target_value!=null&&l.length){let b=yi(n,l);if(b){if(b.ts!=null){let j=l.filter(z=>z.ts>=b.ts);j.length>=2&&(l=j)}l=l.map(j=>({...j,val:Math.max(0,j.val-b.value)}))}m=e.trigger_target_value,v=!0}else i==="state_change"&&e.trigger_target_changes?(m=e.trigger_target_changes,v=!0):i==="runtime"&&e.trigger_runtime_hours&&(m=e.trigger_runtime_hours,v=!0);let f=null;if(m==null&&n.degradation_rate!=null&&(n.degradation_trend!=="stable"||n.days_until_threshold!=null)&&n.degradation_trend!=="insufficient_data"&&l.length>=2){let b=l[l.length-1];f=[b,{ts:b.ts+30*864e5,val:b.val+n.degradation_rate*30}]}let w=n.history.filter(b=>["completed","skipped","reset"].includes(b.type)).map(b=>({ts:new Date(b.timestamp).getTime(),type:b.type}));return o`
  ...
  `}function Ps(n,r,t){let e=n.confidence_interval_low,i=n.confidence_interval_high,a=r.suggested_interval??r.interval_days??0,l=r.interval_days??0,c=Math.max(0,e-5),h=i+5-c,g=(e-c)/h*100,m=(i-e)/h*100,v=(a-c)/h*100,f=l>0?(l-c)/h*100:-1;return o`
  ...
  `}function Si(n,r){return zs(n,r)}function zs(n,r){let t=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return p;let e=n.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,l=100,c=8,h=l-c-4,g=Math.max(...t,1.5),m=a/12,v=m*.65,f=c+h-1/g*h;return o`
  ...
  `}var Hs=200,Bt=10,Ds=22;function Ai(n,r,t,e){let i=n.history.filter(c=>c.type==="completed"&&(c.cost!=null||c.duration!=null));if(i.length<2)return p;let a=i.some(c=>(c.cost??0)>0),l=i.some(c=>(c.duration??0)>0);return!a&&!l?p:o`
  ...
  `}function qs(n,r,t){let e=n.history.filter($=>$.type==="completed"&&($.cost!=null||$.duration!=null)).map($=>({ts:new Date($.timestamp).getTime(),cost:$.cost??0,duration:$.duration??0})).sort(($,R)=>$.ts-R.ts);if(e.length<2)return p;let i=e.some($=>$.cost>0),a=e.some($=>$.duration>0);if(!i&&!a)return p;let l=t!=="duration"&&i,c=t!=="cost"&&a,d=l||!c&&i,h=c||!l&&a,g=640,m=Hs,v=d?44:12,f=h?44:12,w=g-v-f,b=m-Ds,j=b-Bt,z=e[0].ts,H=e[e.length-1].ts,M=(H-z||864e5)*.05,T=z-M,Y=H+M,G=ue(z,H),W=$=>v+($-T)/(Y-T)*w,O=Ut(0,Math.max(...e.map($=>$.cost))||1,3),q=Ut(0,Math.max(...e.map($=>$.duration))||1,3),ut=$=>Bt+(1-$/(O.niceMax||1))*j,mt=$=>Bt+(1-$/(q.niceMax||1))*j,$t=e.length>1?Math.min(...e.slice(1).map(($,R)=>W($.ts)-W(e[R].ts))):w,B=Math.max(6,Math.min(22,$t*.55)),k=he(z,H,Math.max(2,Math.min(4,e.length)));return o`
  ...
  `}var Ns=["completed","skipped","reset","triggered"];function Ii(n,r){let t=r.lang;return o`
    <div class="history-filters-new">
      <div class="filter-chips">
        ${Ns.map(e=>{let i=n.history.filter(a=>a.type===e).length;return i===0?p:o`
  ...
  `}function Mi(n,r){let t=r.lang,e=r.filter?n.history.filter(i=>i.type===r.filter):n.history;if(r.search){let i=r.search.toLowerCase();e=e.filter(a=>a.notes?.toLowerCase().includes(i))}return e.length===0?o`<p class="empty">${s("no_history",t)}</p>`:o`
    <div class="history-timeline">
      ${[...e].reverse().map(i=>Us(i,r))}
    </div>
  `}function Us(n,r){let t=r.lang,e=["completed","reset","skipped"].includes(n.type);return o`
    ...
    `}_renderOverviewRow(t){let e=this._lang,i=t.schedule_type==="time_based"&&t.interval_days&&t.interval_days>0,a=0,l=Zt.ok,c=!1;if(i&&t.days_until_due!==null){let v=se(t.interval_days,t.days_until_due,t.interval_unit);a=v.pct,c=v.overflow,t.status==="overdue"?l=Zt.overdue:t.status==="due_soon"&&(l=Zt.due_soon)}let d=t.area_id?this.hass?.areas?.[t.area_id]?.name:null,h=t.responsible_user_id?this._userService?.getUserName(t.responsible_user_id):null,g=t.group_names.length>0||d||h,m=this._bulkMode&&this._bulkSelected.has(this._bulkKey(t));return o`
      <div class="task-row${t.enabled?"":" task-disabled"}${m?" bulk-selected":""}">
        ...
        <span class="cell-badges">
          ...
          ${t.priority==="high"?o`<span class="priority-badge priority-high" title="${s("priority_high",e)}"><ha-icon icon="mdi:chevron-double-up"></ha-icon></span>`:p}
          ${t.priority==="low"?o`<span class="priority-badge priority-low" title="${s("priority_low",e)}"><ha-icon icon="mdi:chevron-double-down"></ha-icon></span>`:p}
        </span>
        ...
        <span class="due-cell" @click=${()=>this._showTask(t.entry_id,t.task_id)}>
          ...
          ${t.trigger_config?ze(t):!i&&t.trigger_active?o`<span style="color:var(--maint-triggered-color);font-weight:600">⚡</span>`:p}
          ${He(t,this._miniStatsData,this._lang)}
        </span>
        ...
        ${t.tasks.length===0?o`<div class="empty-state-centered">
              ...
              <div class="task-row${d.enabled?"":" task-disabled"}">
                ...
                <span class="due-cell" @click=${()=>this._showTask(t.entry_id,d.id)}>
                  ...
                  ${d.trigger_config?ze(d):p}
                  ${He(d,this._miniStatsData,this._lang)}
                </span>
                <span class="row-actions">
