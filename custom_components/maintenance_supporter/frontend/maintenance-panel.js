...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,u([$({attribute:!1})],B.prototype,"hass",2),u([h()],B.prototype,"_open",2),u([h()],B.prototype,"_title",2),u([h()],B.prototype,"_message",2),u([h()],B.prototype,"_confirmText",2),u([h()],B.prototype,"_danger",2),u([h()],B.prototype,"_inputLabel",2),u([h()],B.prototype,"_inputType",2),u([h()],B.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",B);var fa=["EUR","USD","GBP","JPY","CHF","CAD","AUD","CNY","INR","BRL"],O=class extends j{constructor(){super(...arguments);this.budget=null;this._settings=null;this._loading=!0;this._importCsv="";this._importLoading=!1;this._includeHistory=!0;this._toast="";this._testingNotification=!1;this._users=[];this._loaded=!1;this._userService=null;this._sendTestNotification=async()=>{this._testingNotification=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/test_notification"}),t=e.message||(e.success?i("test_notification_success",this._lang):i("test_notification_failed",this._lang));this._showToast(t)}catch{this._showToast(i("test_notification_failed",this._lang))}finally{this._testingNotification=!1}}}get _lang(){return this.hass?.language||"en"}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded?(this._loaded=!0,this._userService=new ae(this.hass),this._loadSettings(),this._loadUsers()):e.has("hass")&&this.hass&&this._userService&&this._userService.updateHass(this.hass)}async _loadUsers(){if(this._userService)try{this._users=await this._userService.getUsers()}catch{this._users=[]}}async _loadSettings(){this._loading=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});this._settings=e}catch{}this._loading=!1}async _updateSetting(e,t){try{let a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:{[e]:t}});this._settings=a,this._showToast(i("settings_saved",this._lang)),this.dispatchEvent(new CustomEvent("settings-changed"))}catch{this._showToast(i("action_error",this._lang))}}_showToast(e){this._toast=e,setTimeout(()=>{this._toast=""},3e3)}_downloadFile(e,t,a){let s=new Blob([e],{type:a}),r=URL.createObjectURL(s),c=document.createElement("a");c.href=r,c.download=t,c.click(),URL.revokeObjectURL(r)}render(){let e=this._lang;return this._loading||!this._settings?l`<div class="settings-loading">Loading…</div>`:l`
    ...
    `}_renderPanelAccess(e){let t=new Set(this._settings.admin_panel_user_ids||[]),a=this._users.filter(r=>!r.is_admin),s=(r,c)=>{let _=new Set(t);c?_.add(r):_.delete(r),this._updateSetting("admin_panel_user_ids",[..._])};return l`
      <div class="settings-section">
        ...
        ${a.length===0?l`<div class="setting-row hint">${i("no_non_admin_users",e)}</div>`:a.map(r=>l`
            <label class="setting-row">
              ...
              <input type="checkbox"
                .checked=${t.has(r.id)}
                @change=${c=>s(r.id,c.target.checked)} />
            </label>
          `)}
      </div>
              ...
              <div class="objects">
                ${this.objects.map(a=>l`
                  <div class="object-block">
                    ...
                    ${a.tasks.length===0?l`<div class="hint small">${i("no_tasks_short",e)}</div>`:a.tasks.map(s=>{let r=`${a.entry_id}:${s.id}`,c=this._selected.has(r);return l`
      ...
      <div class="trigger-header">
        ...
        <div>
          ${v?l`
            ...
            <div class="trigger-entity-id">${_.map((b,y)=>l`${y>0?", ":""}<span class="entity-link" @click=${A=>oe(A,b)}>${b}</span>`)}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `:l`
            <div class="trigger-entity-name">${r}</div>
            <div class="trigger-entity-id">${c?l`<span class="entity-link" @click=${b=>oe(b,c)}>${c}</span>`:""}${e.attribute?` \u2192 ${e.attribute}`:""}</div>
          `}
        </div>
      ...
      <div class="trigger-limits">
        ...
        ${g==="compound"?l`
          ...
          ${(e.conditions||[]).map((b,y)=>l`
            <span class="trigger-limit-item"><span class="dot range" aria-hidden="true"></span> ${y+1}. ${i(b.type||"unknown",t)}: ${b.entity_id?l`<span class="entity-link" @click=${A=>oe(A,b.entity_id)}>${b.entity_id}</span>`:""}</span>
          `)}
        `:d}
  ...
  `}function xa(o,n,e){let t=o.trigger_config;if(!t)return d;let a=t.type||"threshold",s=a==="counter"&&t.trigger_delta_mode,r=e.isCounterEntity(t),c=t.entity_id||"",_=e.detailStatsData.get(c)||[],p=[],m=!1;if(_.length>=2)for(let f of _){let E=f.val;s&&o.trigger_baseline_value!=null&&(E-=o.trigger_baseline_value);let F={ts:f.ts,val:E};!r&&f.min!=null&&f.max!=null&&(F.min=s&&o.trigger_baseline_value!=null?f.min-o.trigger_baseline_value:f.min,F.max=s&&o.trigger_baseline_value!=null?f.max-o.trigger_baseline_value:f.max,m=!0),p.push(F)}else for(let f of o.history)f.trigger_value!=null&&p.push({ts:new Date(f.timestamp).getTime(),val:f.trigger_value});if(o.trigger_current_value!=null){let f=o.trigger_current_value;s&&o.trigger_baseline_value!=null&&(f-=o.trigger_baseline_value),p.push({ts:Date.now(),val:f})}if(p.length<2&&c&&e.hasStatsService&&!e.detailStatsData.has(c))return l`<div class="sparkline-container" aria-live="polite" style="display:flex;align-items:center;justify-content:center;height:140px;color:var(--secondary-text-color);font-size:12px;">
      <ha-icon icon="mdi:chart-line" style="--mdc-icon-size:16px;margin-right:8px;"></ha-icon>
      ${i("loading_chart",e.lang)}
    </div>`;if(p.length<2)return d;p.sort((f,E)=>f.ts-E.ts);let g=ya,v=ka,b=30,y=2,A=8,q=16,M=p.map(f=>f.val),S=Math.min(...M),x=Math.max(...M);if(m)for(let f of p)f.min!=null&&(S=Math.min(S,f.min)),f.max!=null&&(x=Math.max(x,f.max));t.trigger_above!=null&&(x=Math.max(x,t.trigger_above),S=Math.min(S,t.trigger_above)),t.trigger_below!=null&&(S=Math.min(S,t.trigger_below),x=Math.max(x,t.trigger_below));let C=null,U=null;if(a==="counter"&&t.trigger_target_value!=null){if(o.trigger_baseline_value!=null)C=o.trigger_baseline_value;else if(p.length>0){let f=[...o.history].filter(E=>E.type==="completed"||E.type==="reset").sort((E,F)=>new Date(F.timestamp).getTime()-new Date(E.timestamp).getTime())[0];if(f){let E=new Date(f.timestamp).getTime(),F=p[0],R=Math.abs(p[0].ts-E);for(let Y of p){let X=Math.abs(Y.ts-E);X<R&&(F=Y,R=X)}C=F.val}else C=p[0].val}C!=null?(U=C+t.trigger_target_value,x=Math.max(x,U),S=Math.min(S,C)):(x=Math.max(x,t.trigger_target_value),S=Math.min(S,0))}s&&o.trigger_baseline_value!=null&&(S=Math.min(S,0));let J=x-S||1;S-=J*.1,x+=J*.1;let Z=p[0].ts,P=p[p.length-1].ts,w=P-Z||1,I=f=>b+(f-Z)/w*(g-b-y),T=f=>A+(1-(f-S)/(x-S))*(v-A-q),Ae=p.map(f=>`${I(f.ts).toFixed(1)},${T(f.val).toFixed(1)}`).join(" "),Et=`M${I(p[0].ts).toFixed(1)},${v-q} `+p.map(f=>`L${I(f.ts).toFixed(1)},${T(f.val).toFixed(1)}`).join(" ")+` L${I(p[p.length-1].ts).toFixed(1)},${v-q} Z`,je="";if(m){let f=p.filter(E=>E.min!=null&&E.max!=null);if(f.length>=2){let E=f.map(R=>`${I(R.ts).toFixed(1)},${T(R.max).toFixed(1)}`),F=[...f].reverse().map(R=>`${I(R.ts).toFixed(1)},${T(R.min).toFixed(1)}`);je=`M${E[0]} `+E.slice(1).map(R=>`L${R}`).join(" ")+` L${F[0]} `+F.slice(1).map(R=>`L${R}`).join(" ")+" Z"}}let Ve=p[p.length-1],St=I(Ve.ts),At=T(Ve.val),We=f=>Math.abs(f)>=1e4?(f/1e3).toFixed(0)+"k":f>=1e3?(f/1e3).toFixed(1)+"k":f.toFixed(f<10?1:0),jt=We(x),Tt=We(S),Mt=o.history.filter(f=>["completed","skipped","reset"].includes(f.type)).map(f=>({ts:new Date(f.timestamp).getTime(),type:f.type})).filter(f=>f.ts>=Z&&f.ts<=P),Te=p;if(p.length>Be){let f=(p.length-1)/(Be-1);Te=[];for(let E=0;E<Be;E++)Te.push(p[Math.round(E*f)])}return l`
    <div class="sparkline-container">
      <svg class="sparkline-svg" viewBox="0 0 ${g} ${v}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_sparkline",e.lang)}">
        ...
        ${o.degradation_rate!=null&&o.degradation_trend!=="stable"&&o.degradation_trend!=="insufficient_data"&&p.length>=2?(()=>{let f=p[p.length-1],E=30,F=f.ts+E*864e5,R=f.val+o.degradation_rate*E,Y=Math.min(F,P+(P-Z)*.3),X=Math.max(S,Math.min(x,R)),Ct=I(f.ts),It=T(f.val),Nt=I(Y),Dt=T(X);return D`<line x1="${Ct.toFixed(1)}" y1="${It.toFixed(1)}" x2="${Nt.toFixed(1)}" y2="${Dt.toFixed(1)}" stroke="var(--warning-color, #ff9800)" stroke-width="1.5" stroke-dasharray="4,3" opacity="0.7" />`})():d}
...
`).map(f=>l`<div>${f}</div>`)}
  ...
  `}function vt(o,n,e){let t=o.currentTarget,a=t.closest(".sparkline-container");if(!a)return;let s=a.getBoundingClientRect(),r=t.getBoundingClientRect();e({x:r.left-s.left+r.width/2,y:r.top-s.top-8,text:n})}function bt(o,n,e){let t=o.degradation_trend!=null&&o.degradation_trend!=="insufficient_data",a=o.days_until_threshold!=null,s=o.environmental_factor!=null&&o.environmental_factor!==1;if(!t&&!a&&!s)return d;let r=o.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":o.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return l`
      ...
      <div class="prediction-grid">
        ${t?l`
          <div class="prediction-item">
            ...
            ${o.degradation_rate!=null?l`<span class="prediction-rate">${o.degradation_rate>0?"+":""}${Math.abs(o.degradation_rate)>=10?Math.round(o.degradation_rate).toLocaleString():o.degradation_rate.toFixed(1)} ${o.trigger_entity_info?.unit_of_measurement||""}/${i("day_short",n)}</span>`:d}
          </div>
        `:d}
        ${a?l`
          <div class="prediction-item">
            ...
            ${o.threshold_prediction_date?l`<span class="prediction-date">${te(o.threshold_prediction_date,n)}</span>`:d}
            ${o.threshold_prediction_confidence?l`<span class="confidence-dot ${o.threshold_prediction_confidence}"></span>`:d}
          </div>
        `:d}
        ${s&&e.environmental?l`
          <div class="prediction-item">
            ...
            ${o.environmental_entity?l`<span class="prediction-entity entity-link" @click=${c=>oe(c,o.environmental_entity)}>${o.environmental_entity}</span>`:d}
          </div>
        `:d}
      </div>
    </div>
  `}function yt(o,n){let e=o.interval_analysis,t=e?.weibull_beta,a=e?.weibull_eta;if(t==null||a==null||a<=0)return d;let s=o.interval_days??0,r=o.suggested_interval??s;return l`
  ...
  `}function Ea(o,n,e){let t=o.confidence_interval_low,a=o.confidence_interval_high,s=n.suggested_interval??n.interval_days??0,r=n.interval_days??0,c=Math.max(0,t-5),p=a+5-c,m=(t-c)/p*100,g=(a-t)/p*100,v=(s-c)/p*100,b=r>0?(r-c)/p*100:-1;return l`
  ...
  `}var kt=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function xt(o,n,e){if(!e.seasonal||!o.seasonal_factor||o.seasonal_factor===1)return d;let t=kt.map(c=>i(c,n)),a=new Date().getMonth(),s=o.seasonal_factors||o.interval_analysis?.seasonal_factors||null,r=s&&s.length===12?s:t.map((c,_)=>{let p=o.seasonal_factor||1,m=Math.sin((_-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,p+m))});return l`
    <div class="seasonal-card-compact">
      <h4>${i("seasonal_awareness",n)}</h4>
      <div class="seasonal-mini-chart">
        ${r.map((c,_)=>{let p=c*40,m=c<.9?"low":c>1.1?"high":"normal";return l`
  ...
  `}function wt(o,n){return Sa(o,n)}function Sa(o,n){let e=o.seasonal_factors??o.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return d;let t=o.interval_analysis?.seasonal_reason,a=new Date().getMonth(),s=300,r=100,c=8,p=r-c-4,m=Math.max(...e,1.5),g=s/12,v=g*.65,b=c+p-1/m*p;return l`
  ...
  `}var Aa=300,ja=200;function $t(o,n,e,t){let a=o.history.filter(c=>c.type==="completed"&&(c.cost!=null||c.duration!=null));if(a.length<2)return d;let s=a.some(c=>(c.cost??0)>0),r=a.some(c=>(c.duration??0)>0);return!s&&!r?d:l`
  ...
  `}function Ta(o,n,e){let t=o.history.filter(w=>w.type==="completed"&&(w.cost!=null||w.duration!=null)).map(w=>({ts:new Date(w.timestamp).getTime(),cost:w.cost??0,duration:w.duration??0})).sort((w,I)=>w.ts-I.ts);if(t.length<2)return d;let a=t.some(w=>w.cost>0),s=t.some(w=>w.duration>0);if(!a&&!s)return d;let r=e!=="duration"&&a,c=e!=="cost"&&s,_=r||!c&&a,p=c||!r&&s,m=Aa,g=ja,v=_?32:8,b=p?32:8,y=8,A=20,q=m-v-b,M=g-y-A,S=Math.max(...t.map(w=>w.cost))||1,x=Math.max(...t.map(w=>w.duration))||1,C=Math.min(20,q/t.length*.6),U=q/t.length,J=w=>v+U*w+U/2,Z=w=>y+M-w/S*M,P=w=>y+M-w/x*M;return l`
    <div class="sparkline-container">
  ...
  `}var Ma=60,Ca=20,zt=30,z=class extends j{constructor(){super(...arguments);this.narrow=!1;this.panel={};this._objects=[];this._stats=null;this._view="overview";this._selectedEntryId=null;this._selectedTaskId=null;this._filterStatus="";this._filterUser=null;this._unsub=null;this._sparklineTooltip=null;this._historyFilter=null;this._budget=null;this._groups={};this._detailStatsData=new Map;this._miniStatsData=new Map;this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1};this._adminPanelUserIds=[];this._actionLoading=!1;this._moreMenuOpen=!1;this._toastMessage="";this._toastTimer=null;this._dismissedSuggestions=new Set;this._overviewTab="dashboard";this._activeTab="overview";this._costDurationToggle="both";this._historySearch="";this._sortMode="due_date";this._objectSortMode="alphabetical";this._groupByMode="none";this._statsService=null;this._userService=null;this._dataLoaded=!1;this._lastConnection=null;this._popstateHandler=e=>this._onPopState(e);this._deepLinkHandled=!1;this._onDialogEvent=async()=>{try{await this._loadData()}catch{}}}get _lang(){return this.hass?.language||"en"}get _isOperator(){let e=this.hass?.user;return e?e.is_admin?!1:!this._adminPanelUserIds.includes(e.id):!0}connectedCallback(){super.connectedCallback(),window.addEventListener("popstate",this._popstateHandler);let e=localStorage.getItem("maintenance_supporter_sort");e&&["due_date","object","type","task_name","area","assigned_user","group"].includes(e)&&(this._sortMode=e);let t=localStorage.getItem("maintenance_supporter_object_sort");t&&["alphabetical","due_soonest","task_count"].includes(t)&&(this._objectSortMode=t);let a=localStorage.getItem("maintenance_supporter_groupby");a&&["none","area","group","user"].includes(a)&&(this._groupByMode=a)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("popstate",this._popstateHandler),this._unsub&&(this._unsub(),this._unsub=null),this._dataLoaded=!1,this._lastConnection=null,this._deepLinkHandled=!1,this._statsService?.clearCache(),this._statsService=null}updated(e){if(super.updated(e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,history.replaceState({msp_view:"overview",msp_entry:null,msp_task:null},""),this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}this._statsService?this._statsService.updateHass(this.hass):(this._statsService=new Se(this.hass),this._fetchMiniStatsForOverview()),this._userService?this._userService.updateHass(this.hass):(this._userService=new ae(this.hass),this._userService.getUsers())}}async _loadData(){let[e,t,a,s,r]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"}).catch(()=>null),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).catch(()=>null)]);if(e&&(this._objects=e.objects),t&&(this._stats=t),a&&(this._budget=a),s&&(this._groups=s.groups||{}),r){let c=r;this._features=c.features,this._adminPanelUserIds=c.admin_panel_user_ids||[]}this._fetchMiniStatsForOverview(),this._handleDeepLink()}_handleDeepLink(){if(this._deepLinkHandled)return;let e=new URLSearchParams(window.location.search),t=e.get("entry_id");if(!t)return;this._deepLinkHandled=!0;let a=e.get("task_id"),s=e.get("action"),r=window.location.pathname+window.location.hash;history.replaceState(history.state,"",r);let c=this._getObject(t);if(!c){this._showOverview();return}if(a){let _=c.tasks.find(p=>p.id===a);if(!_){this._showObject(t);return}this._showTask(t,a),s==="complete"&&requestAnimationFrame(()=>{this._openCompleteDialog(t,a,_.name,this._features.checklists?_.checklist:void 0,this._features.adaptive&&!!_.adaptive_config?.enabled)})}else this._showObject(t)}_isCounterEntity(e){if(!e)return!1;let t=e.type||"threshold";return t==="counter"||t==="state_change"}async _fetchDetailStats(e,t){if(!this._statsService)return;let a=await this._statsService.getDetailStats(e,t),s=new Map(this._detailStatsData);s.set(e,a),this._detailStatsData=s}async _fetchMiniStatsForOverview(){if(!this._statsService)return;let e=[];for(let a of this._objects)for(let s of a.tasks){let r=s.trigger_config?.entity_id;r&&e.push({entityId:r,isCounter:this._isCounterEntity(s.trigger_config)})}if(e.length===0)return;let t=await this._statsService.getBatchMiniStats(e);this._miniStatsData=new Map([...this._miniStatsData,...t])}async _subscribe(){try{this._unsub=await this.hass.connection.subscribeMessage(e=>{let t=e;this._objects=t.objects},{type:"maintenance_supporter/subscribe"})}catch{}}get _taskRows(){let e=[];for(let g of this._objects)for(let v of g.tasks){if(this._filterStatus&&v.status!==this._filterStatus)continue;if(this._filterUser){let y=this._filterUser==="current_user"?this._userService?.getCurrentUserId():this._filterUser;if(v.responsible_user_id!==y)continue}let b=[];for(let y of Object.values(this._groups))y.task_refs?.some(A=>A.entry_id===g.entry_id&&A.task_id===v.id)&&b.push(y.name);e.push({entry_id:g.entry_id,task_id:v.id,object_name:g.object.name,task_name:v.name,type:v.type,schedule_type:v.schedule_type,status:v.status,days_until_due:v.days_until_due??null,next_due:v.next_due??null,trigger_active:v.trigger_active,trigger_current_value:v.trigger_current_value??null,trigger_current_delta:v.trigger_current_delta??null,trigger_config:v.trigger_config??null,trigger_entity_info:v.trigger_entity_info??null,times_performed:v.times_performed,total_cost:v.total_cost,interval_days:v.interval_days??null,interval_anchor:v.interval_anchor??null,history:v.history||[],enabled:v.enabled,nfc_tag_id:v.nfc_tag_id??null,area_id:g.object.area_id??null,responsible_user_id:v.responsible_user_id??null,group_names:b})}let t={overdue:0,triggered:1,due_soon:2,ok:3},a=(g,v)=>(t[g.status]??9)-(t[v.status]??9),s=(g,v)=>(g.days_until_due??99999)-(v.days_until_due??99999),r=(g,v)=>a(g,v)||s(g,v),c=g=>g.area_id&&this.hass?.areas?.[g.area_id]?.name||"",_=g=>g.responsible_user_id&&this._userService?.getUserName(g.responsible_user_id)||"",p=g=>g.group_names[0]||"",m={due_date:r,object:(g,v)=>g.object_name.localeCompare(v.object_name)||r(g,v),type:(g,v)=>g.type.localeCompare(v.type)||r(g,v),task_name:(g,v)=>g.task_name.localeCompare(v.task_name),area:(g,v)=>{let b=c(g),y=c(v);return!b&&y?1:b&&!y?-1:b.localeCompare(y)||r(g,v)},assigned_user:(g,v)=>{let b=_(g),y=_(v);return!b&&y?1:b&&!y?-1:b.localeCompare(y)||r(g,v)},group:(g,v)=>{let b=p(g),y=p(v);return!b&&y?1:b&&!y?-1:b.localeCompare(y)||r(g,v)}};return e.sort(m[this._sortMode]),e}_getObject(e){return this._objects.find(t=>t.entry_id===e)}_getTask(e,t){return this._getObject(e)?.tasks.find(s=>s.id===t)}_pushPanelState(e,t,a){let s={msp_view:e,msp_entry:t||null,msp_task:a||null};history.pushState(s,"")}_onPopState(e){let t=e.state;if(t?.msp_view&&(this._view=t.msp_view,this._selectedEntryId=t.msp_entry||null,this._selectedTaskId=t.msp_task||null,this._moreMenuOpen=!1,t.msp_view==="task"&&t.msp_entry&&t.msp_task)){this._historyFilter=null;let a=this._getTask(t.msp_entry,t.msp_task);a?.trigger_config?.entity_id&&this._fetchDetailStats(a.trigger_config.entity_id,this._isCounterEntity(a.trigger_config))}}_showOverview(){this._pushPanelState("overview"),this._view="overview",this._selectedEntryId=null,this._selectedTaskId=null,this._moreMenuOpen=!1}_showAllObjects(){this._pushPanelState("all_objects"),this._view="all_objects",this._selectedEntryId=null,this._selectedTaskId=null}_showObject(e){this._pushPanelState("object",e),this._view="object",this._selectedEntryId=e,this._selectedTaskId=null}_showTask(e,t){this._pushPanelState("task",e,t),this._view="task",this._selectedEntryId=e,this._selectedTaskId=t,this._activeTab="overview",this._historyFilter=null;let a=this._getTask(e,t);if(a?.trigger_config?.entity_id){let s=a.trigger_config.entity_id,r=this._isCounterEntity(a.trigger_config);this._fetchDetailStats(s,r)}}_showToast(e){this._toastTimer&&clearTimeout(this._toastTimer),this._toastMessage=e,this._toastTimer=setTimeout(()=>{this._toastMessage="",this._toastTimer=null},4e3)}async _deleteObject(e){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_object",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:e}),this._showOverview(),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _deleteTask(e,t){if(await this.shadowRoot.querySelector("maintenance-confirm-dialog")?.confirm({title:i("delete",this._lang),message:i("confirm_delete_task",this._lang),confirmText:i("delete",this._lang),danger:!0}))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/delete",entry_id:e,task_id:t}),this._showObject(e),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _skipTask(e,t,a){this._actionLoading=!0;try{let s={type:"maintenance_supporter/task/skip",entry_id:e,task_id:t};a&&(s.reason=a),await this.hass.connection.sendMessagePromise(s),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _resetTask(e,t,a){this._actionLoading=!0;try{let s={type:"maintenance_supporter/task/reset",entry_id:e,task_id:t};a&&(s.date=a),await this.hass.connection.sendMessagePromise(s),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}finally{this._actionLoading=!1}}async _applySuggestion(e,t,a){try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/apply_suggestion",entry_id:e,task_id:t,interval:a}),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}_openSeasonalOverrides(e){let t=this.shadowRoot.querySelector("maintenance-seasonal-overrides-dialog");if(!t||!this._selectedEntryId)return;let a=e.adaptive_config?.seasonal_overrides;t.open(this._selectedEntryId,e.id,a)}async _reanalyzeInterval(e,t){try{let a=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:e,task_id:t});a.recommended_interval?this._showToast(`${i("reanalyze_result",this._lang)}: ${a.recommended_interval} ${i("days",this._lang)} (${i(`confidence_${a.confidence}`,this._lang)}, ${a.data_points} ${i("data_points",this._lang)})`):this._showToast(i("reanalyze_insufficient_data",this._lang)),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}async _promptSkipTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let s=await a.prompt({title:i("skip",this._lang),message:i("skip_reason_prompt",this._lang),confirmText:i("skip",this._lang),inputLabel:i("reason_optional",this._lang),inputType:"text"});s.confirmed&&this._skipTask(e,t,s.value||void 0)}async _promptResetTask(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(!a)return;let s=await a.prompt({title:i("reset",this._lang),message:i("reset_date_prompt",this._lang),confirmText:i("reset",this._lang),inputLabel:i("reset_date_optional",this._lang),inputType:"date"});s.confirmed&&this._resetTask(e,t,s.value||void 0)}_dismissSuggestion(e,t){e&&t&&this._dismissedSuggestions.add(`${e}_${t}`),this.requestUpdate()}_openCompleteDialog(e,t,a,s,r){let c=this.shadowRoot.querySelector("maintenance-complete-dialog");c&&(c.entryId=e,c.taskId=t,c.taskName=a,c.lang=this._lang,c.checklist=s||[],c.adaptiveEnabled=!!r,c.open())}_openQrForObject(e,t){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForObject(e,t)}_openQrForTask(e,t,a,s){this.shadowRoot.querySelector("maintenance-qr-dialog")?.openForTask(e,t,a,s)}render(){return l`
    ...
    `}_renderDashboard(){let e=this._stats,t=this._taskRows,a=this._lang,s=this._isOperator;return l`
      ...
      <div class="filter-bar">
        ...
        <select
          ...
          @change=${r=>{let c=r.target.value;this._filterUser=c||null}}
        >
    ...
    `}_renderGroupedTasks(e,t){let a=new Map,s=i("unassigned",t);for(let _ of e){let p=[];this._groupByMode==="area"?p=[(_.area_id?this.hass?.areas?.[_.area_id]?.name:null)||s]:this._groupByMode==="user"?p=[(_.responsible_user_id?this._userService?.getUserName(_.responsible_user_id):null)||s]:this._groupByMode==="group"&&(p=_.group_names.length>0?_.group_names:[s]);for(let m of p)a.has(m)||a.set(m,[]),a.get(m).push(_)}let r=[...a.entries()].sort(([_],[p])=>_===s&&p!==s?1:p===s&&_!==s?-1:_.localeCompare(p)),c=this._groupByMode==="area"?"mdi:map-marker-outline":this._groupByMode==="group"?"mdi:folder-outline":"mdi:account-outline";return l`
      ...
      `)}
    `}_renderAllObjects(){let e=this._lang,t=this._isOperator,a=_=>{let p=1/0;for(let m of _.tasks){let g=m.days_until_due;g!=null&&g<p&&(p=g)}return p},s=[...this._objects];this._objectSortMode==="alphabetical"?s.sort((_,p)=>_.object.name.localeCompare(p.object.name)):this._objectSortMode==="task_count"?s.sort((_,p)=>p.tasks.length-_.tasks.length||_.object.name.localeCompare(p.object.name)):s.sort((_,p)=>a(_)-a(p)||_.object.name.localeCompare(p.object.name));let r=()=>{let _=new Map;for(let p of s){let m=p.object.area_id,g=m?this.hass?.areas?.[m]?.name||i("unassigned",e):i("no_area",e);_.has(g)||_.set(g,[]),_.get(g).push(p)}return new Map([..._.entries()].sort(([p],[m])=>p.localeCompare(m)))},c=_=>{let p=_.tasks.some(m=>m.status==="overdue"||m.status==="triggered");return l`
      ...
      <div class="groups-section">
        ...
        ${e.length===0?l`<div class="hint">${i("no_groups",t)}</div>`:l`
            <div class="groups-grid">
              ${e.map(([a,s])=>{let r=s.task_refs.map(c=>this._getTask(c.entry_id,c.task_id)?.name).filter(Boolean);return l`
                  <div class="group-card">
                    ...
                    <div class="group-card-tasks">
                      ${r.length>0?r.map(c=>l`<span class="group-task-chip">${c}</span>`):l`<span style="font-size:12px;color:var(--secondary-text-color)">${i("no_tasks_short",t)}</span>`}
                    </div>
                  </div>
                `})}
            </div>
    ...
    `}_openGroupCreate(){this.shadowRoot.querySelector("maintenance-group-dialog")?.openCreate()}_openGroupEdit(e){let t=this._groups[e];t&&this.shadowRoot.querySelector("maintenance-group-dialog")?.openEdit(e,t)}async _deleteGroup(e,t){let a=this.shadowRoot.querySelector("maintenance-confirm-dialog");if(a?await a.confirm({title:i("delete_group",this._lang),message:i("delete_group_confirm",this._lang).replace("{name}",t),confirmText:i("delete",this._lang)}):confirm(`${i("delete_group_confirm",this._lang).replace("{name}",t)}`))try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/group/delete",group_id:e}),await this._loadData()}catch{this._showToast(i("action_error",this._lang))}}_renderBudgetBar(){let e=this._budget;if(!e)return d;let t=this._lang,a=e.currency_symbol||"\u20AC",s=[];return e.monthly_budget>0&&s.push({label:i("budget_monthly",t),spent:e.monthly_spent,budget:e.monthly_budget}),e.yearly_budget>0&&s.push({label:i("budget_yearly",t),spent:e.yearly_spent,budget:e.yearly_budget}),s.length===0?d:l`
      <div class="budget-bars">
        ${s.map(r=>{let c=Math.min(100,Math.max(0,r.spent/r.budget*100)),_=c>=100?"var(--error-color, #f44336)":c>=e.alert_threshold_pct?"var(--warning-color, #ff9800)":"var(--success-color, #4caf50)";return l`
    ...
    `}_renderOverviewRow(e){let t=this._lang,a=e.schedule_type==="time_based"&&e.interval_days&&e.interval_days>0,s=0,r=ze.ok,c=!1;if(a&&e.days_until_due!==null){let g=(e.interval_days-e.days_until_due)/e.interval_days*100;s=Math.max(0,Math.min(100,g)),c=g>100,e.status==="overdue"?r=ze.overdue:e.status==="due_soon"&&(r=ze.due_soon)}let _=e.area_id?this.hass?.areas?.[e.area_id]?.name:null,p=e.responsible_user_id?this._userService?.getUserName(e.responsible_user_id):null,m=e.group_names.length>0||_||p;return l`
      <div class="task-row${e.enabled?"":" task-disabled"}">
        ...
        <span class="due-cell" @click=${()=>this._showTask(e.entry_id,e.task_id)}>
          ...
          ${a?l`<div class="days-bar"><div class="days-bar-fill${c?" overflow":""}" style="width:${s}%;background:${r}"></div></div>`:d}
    ...
    `}_openCompleteDialogForRow(e){let a=this._objects.find(s=>s.entry_id===e.entry_id)?.tasks.find(s=>s.id===e.task_id);this._openCompleteDialog(e.entry_id,e.task_id,e.task_name,this._features.checklists?a?.checklist:void 0,this._features.adaptive&&!!a?.adaptive_config?.enabled)}_renderTriggerProgress(e){let t=e.trigger_config??null;if(!t)return d;let a=t.type||"threshold",s=e.trigger_entity_info?.unit_of_measurement??"",r=0,c="";if(a==="threshold"){let m=e.trigger_current_value??null;if(m==null)return d;let g=t.trigger_above,v=t.trigger_below;if(g!=null){let b=v??0,y=g-b||1;r=Math.min(100,Math.max(0,(m-b)/y*100)),c=`${m.toFixed(1)} / ${g} ${s}`}else if(v!=null){let y=e.trigger_entity_info?.max??(v*2||100),A=y-v||1;r=Math.min(100,Math.max(0,(y-m)/A*100)),c=`${m.toFixed(1)} / ${v} ${s}`}else return d}else if(a==="counter"){let m=t.trigger_target_value||1,v=e.trigger_current_delta??null??e.trigger_current_value??null;if(v==null)return d;r=Math.min(100,Math.max(0,v/m*100)),c=`${v.toFixed(1)} / ${m} ${s}`}else if(a==="state_change"){let m=t.trigger_target_changes||1,g=e.trigger_current_value??null;if(g==null)return d;r=Math.min(100,Math.max(0,g/m*100)),c=`${Math.round(g)} / ${m}`}else if(a==="runtime"){let m=t.trigger_runtime_hours||100,g=e.trigger_current_value??null;if(g==null)return d;r=Math.min(100,Math.max(0,g/m*100)),c=`${g.toFixed(1)}h / ${m}h`}else if(a==="compound"){let m=t.compound_logic||t.operator||"AND",g=t.conditions?.length||0;c=`${m} (${g})`,r=e.trigger_active?100:0}else return d;let _=r>=100,p=r>90?"var(--error-color, #f44336)":r>70?"var(--warning-color, #ff9800)":"var(--primary-color)";return l`
    ...
    `}_renderMiniSparkline(e){if(!e.trigger_config?.entity_id)return d;let t=e.trigger_config.entity_id,a=this._miniStatsData.get(t)||[],s=[];if(a.length>=2)s=a.map(x=>({ts:x.ts,val:x.val}));else{if(!e.history)return d;for(let x of e.history)x.trigger_value!=null&&s.push({ts:new Date(x.timestamp).getTime(),val:x.trigger_value})}if(e.trigger_current_value!=null&&s.push({ts:Date.now(),val:e.trigger_current_value}),s.length<2)return d;s.sort((x,C)=>x.ts-C.ts);let r=Ma,c=Ca,_=s.map(x=>x.val),p=Math.min(..._),m=Math.max(..._),g=m-p||1;p-=g*.1,m+=g*.1;let v=s[0].ts,y=s[s.length-1].ts-v||1,A=x=>(x-v)/y*r,q=x=>2+(1-(x-p)/(m-p))*(c-4),M=s;if(M.length>zt){let x=Math.ceil(M.length/zt);M=M.filter((C,U)=>U%x===0||U===M.length-1)}let S=M.map(x=>`${A(x.ts).toFixed(1)},${q(x.val).toFixed(1)}`).join(" ");return l`
      <svg class="mini-sparkline" viewBox="0 0 ${r} ${c}" preserveAspectRatio="none" role="img" aria-label="${i("chart_mini_sparkline",this._lang)}">
        <polyline points="${S}" fill="none" stroke="var(--primary-color)" stroke-width="1.5" stroke-linejoin="round" />
      </svg>
    `}_renderDaysProgress(e){let t=this._lang;if(e.days_until_due==null||!e.interval_days||e.interval_days<=0)return d;let s=(e.interval_days-e.days_until_due)/e.interval_days*100,r=Math.max(0,Math.min(100,s)),c=s>100,_="var(--success-color, #4caf50)";return e.status==="overdue"?_="var(--error-color, #f44336)":e.status==="due_soon"&&(_="var(--warning-color, #ff9800)"),l`
      <div class="days-progress">
        ...
        <div class="days-progress-bar" role="progressbar" aria-valuenow="${Math.round(r)}" aria-valuemin="0" aria-valuemax="100" aria-label="${i("days_progress",t)}">
          <div class="days-progress-fill${c?" overflow":""}" style="width:${r}%;background:${_}"></div>
        </div>
    ...
    `}_renderObjectDetail(){if(!this._selectedEntryId)return d;let e=this._getObject(this._selectedEntryId);if(!e)return l`<p>Object not found.</p>`;let t=e.object,a=this._lang,s=this._isOperator;return l`
      <div class="detail-section">
        ...
        ${e.tasks.length===0?l`<div class="empty-state-centered">
            ...
            </div>`:[...e.tasks].sort((r,c)=>{let _={overdue:0,triggered:1,due_soon:2,ok:3};return(_[r.status]??9)-(_[c.status]??9)||(r.days_until_due??99999)-(c.days_until_due??99999)}).map(r=>l`
              <div class="task-row${r.enabled?"":" task-disabled"}">
                <span class="status-badge ${r.status}">${i(r.status,a)}</span>
                ${r.enabled?d:l`<span class="badge-disabled">${i("disabled",a)}</span>`}
                ${r.nfc_tag_id?l`<span class="nfc-badge" title="${i("nfc_linked",a)}"><ha-icon icon="mdi:nfc-variant"></ha-icon></span>`:d}
                ...
                <span class="due-cell" @click=${()=>this._showTask(e.entry_id,r.id)}>
                  <span class="due-text">${Ee(r.days_until_due,a)}</span>
                  ${r.trigger_config?this._renderTriggerProgress(r):d}
                  ${this._renderMiniSparkline(r)}
                </span>
                <span class="row-actions">
                  <mwc-icon-button class="btn-complete" title="${i("complete",a)}" @click=${c=>{c.stopPropagation(),this._openCompleteDialog(e.entry_id,r.id,r.name,this._features.checklists?r.checklist:void 0,this._features.adaptive&&!!r.adaptive_config?.enabled)}}>
                    <ha-icon icon="mdi:check"></ha-icon>
                  </mwc-icon-button>
                  <mwc-icon-button class="btn-skip" title="${i("skip",a)}" .disabled=${this._actionLoading} @click=${c=>{c.stopPropagation(),this._promptSkipTask(e.entry_id,r.id)}}>
                    <ha-icon icon="mdi:skip-next"></ha-icon>
                  </mwc-icon-button>
                </span>
              </div>
    ...
    `}_renderTaskHeader(e){let t=this._lang,s=this._getObject(this._selectedEntryId)?.object.name||"",r=this._isOperator,c=e.status==="due_soon"?"warning":e.status||"ok",_=i(e.status||"ok",t);return l`
      <div class="task-header">
        <div class="task-header-title">
          ...
          ${e.nfc_tag_id?l`<span class="nfc-badge" title="${i("nfc_tag_id",t)}: ${e.nfc_tag_id}"><ha-icon icon="mdi:nfc-variant"></ha-icon> NFC</span>`:r?d:l`<span class="nfc-badge unlinked" title="${i("nfc_link_hint",t)}"
    ...
    `}_renderRecommendationCard(e){let t=this._lang;if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return d;if(this._selectedEntryId&&this._selectedTaskId&&this._dismissedSuggestions.has(`${this._selectedEntryId}_${this._selectedTaskId}`))return d;let a=e.interval_days,s=e.suggested_interval,r=e.interval_confidence||"medium",c=Math.max(a||1,s);return l`
    ...
    `}_renderRecentActivities(e){let t=this._lang,a=e.history.slice(-3).reverse();if(a.length===0)return d;let s=r=>{switch(r){case"completed":return"\u2713";case"triggered":return"\u2297";case"skipped":return"\u21B7";case"reset":return"\u21BA";default:return"\xB7"}};return l`
      <div class="recent-activities">
        <h3>${i("recent_activities",t)}</h3>
        ${a.map(r=>l`
          <div class="activity-item">
            <span class="activity-icon">${s(r.type)}</span>
            <span class="activity-date">${Ue(r.timestamp,t)}</span>
            <span class="activity-note">${r.notes||"\u2014"}</span>
            ${r.cost?l`<span class="activity-badge">${r.cost.toFixed(0)}${this._budget?.currency_symbol||"\u20AC"}</span>`:d}
            ${r.duration?l`<span class="activity-badge">${r.duration}min</span>`:d}
          </div>
        `)}
    ...
    `}_renderHistoryFilters(e){let t=this._lang;return l`
      <div class="history-filters-new">
        <div class="filter-chips">
          ${["completed","skipped","reset","triggered"].map(a=>{let s=e.history.filter(r=>r.type===a).length;return s===0?d:l`
