...
import{a as wt,b as Et,c as It,d as St,e as Tt,f as At,g as Ct,h as Pt,i as Lt}from"./chunk-FD6NRYHY.js";import"./chunk-3MGZ5AMZ.js";import{A as Ut,B as T,a as w,b as a,c as Z,d as p,e as E,f,g as c,h as et,i as s,k as P,l as Rt,m as qt,n as Ht,o as Nt,p as A,q as J,r as G,s as Mt,t as Ot,u as nt,v as ht,w as Ft,x as Dt,y as jt,z as zt}from"./chunk-ENAVFJ6Y.js";import{a as l,b as rt,c as kt}from"./chunk-X64NVNB7.js";var C=class extends E{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(t){let i=t.target.value;this.value=i,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:i}}))}render(){return a`
      <label class="field">
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${i?a`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-4GZZKAYJ.js").then(({openObjectQuickActions:n})=>{n(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
