...
`),this._scheduleTime=e.schedule_time||"";let o=e.on_complete_action;if(o&&o.service){this._actionService=o.service;let _=o.target?.entity_id;this._actionTargetEntity=Array.isArray(_)?_[0]||"":_||"",this._actionData=o.data&&typeof o.data=="object"?{...o.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let p=e.quick_complete_defaults;this._qcNotes=p?.notes||"",this._qcCost=p?.cost!=null?String(p.cost):"",this._qcDuration=p?.duration!=null?String(p.duration):"",this._qcFeedback=p?.feedback||"";let h=e.adaptive_config||{};if(this._environmentalEntity=h.environmental_entity||"",this._environmentalAttribute=h.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,e.trigger_config){let _=e.trigger_config;this._triggerEntityId=_.entity_id||"",this._triggerEntityIds=_.entity_ids||(_.entity_id?[_.entity_id]:[]),this._triggerEntityLogic=_.entity_logic||"any",this._triggerAttribute=_.attribute||"",this._triggerType=_.type||"threshold",this._triggerAbove=_.trigger_above?.toString()||"",this._triggerBelow=_.trigger_below?.toString()||"",this._triggerForMinutes=_.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=_.trigger_target_value?.toString()||"",this._triggerDeltaMode=_.trigger_delta_mode||!1,this._autoCompleteOnRecovery=_.auto_complete_on_recovery||!1,this._triggerFromState=_.trigger_from_state||"",this._triggerToState=_.trigger_to_state||"",this._triggerTargetChanges=_.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=_.trigger_runtime_hours?.toString()||"",_.type==="compound"?(this._compoundLogic=_.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(_.conditions||[]).map(It)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new V(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(t){console.error("Failed to load users:",t),this._availableUsers=[]}}_toggleAssignee(t){this._assigneePool=this._assigneePool.includes(t)?this._assigneePool.filter(e=>e!==t):[...this._assigneePool,t]}async _testAction(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[e,i]=t.split(".");if(!this.hass?.services?.[e]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${t}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let o=this._actionTargetEntity.trim();if(o){let p=o.split(".")[0];if(p!==e&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(e)){this._actionTestResult="error",this._actionTestError=`Service "${t}" only works on ${e}.* entities; entity "${o}" is in ${p}.* \u2014 pick a service that matches the entity domain (e.g. ${p}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[o]){this._actionTestResult="error",this._actionTestError=`Target entity "${o}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let t=JSON.parse(this._actionDataJsonFallback);if(t&&typeof t=="object"&&!Array.isArray(t))return t}catch{}return{...this._actionData}}_serviceSchema(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t))return null;let[e,i]=t.split("."),o=this.hass?.services?.[e]?.[i]?.fields;return!o||Object.keys(o).length===0?null:Object.entries(o).map(([p,h])=>({name:p,required:!!h.required,selector:h.selector||{text:{}}}))}_renderCompletionActionsSection(t){if(!this.completionActionsEnabled)return c;let e=this._serviceSchema();return n`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${i=>{this._actionService=i.detail.value||"";let o=this._serviceSchema();if(o){let p=new Set(o.map(h=>h.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([h])=>p.has(h)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
...
`).map(h=>h.trim()).filter(Boolean).slice(0,100);t.checklist=p.length?p:null}if(this.completionActionsEnabled){let p=this._actionService.trim();if(p&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(p)){let y={service:p},E=this._actionTargetEntity.trim();E&&(y.target={entity_id:E});let q=this._buildActionData();Object.keys(q).length>0&&(y.data=q),t.on_complete_action=y}else t.on_complete_action=null;let h={};this._qcNotes.trim()&&(h.notes=this._qcNotes.trim());let _=parseFloat(this._qcCost);!isNaN(_)&&_>=0&&(h.cost=_);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(h.duration=g),this._qcFeedback&&(h.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(h).length?h:null}let e=await this.hass.connection.sendMessagePromise(t),i=this._taskId||e?.task_id,o=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(i&&this._scheduleType==="sensor_based"&&o)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:i,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=k(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return c;let t=this._lang,e=this._triggerType==="compound";return n`
      ...
      ${e?this._renderCompoundEditor():n`
        <ms-textfield
          ...
          @input=${i=>{let p=i.target.value.split(",").map(h=>h.trim()).filter(Boolean);this._triggerEntityId=p[0]||"",this._triggerEntityIds=p,p[0]&&this._fetchEntityAttributes(p[0])}}
        ></ms-textfield>
    ...
    `}_patchCondition(t,e){this._compoundConditions=this._compoundConditions.map((i,o)=>o===t?{...i,...e}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Et()]}_removeCondition(t){this._compoundConditions=this._compoundConditions.filter((e,i)=>i!==t)}_renderCompoundEditor(){let t=this._lang;return n`
      <div class="select-row">
    ...
    `}_renderCondition(t,e){let i=this._lang,o=e+1;return n`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${st.map(p=>n`<option value=${p} ?selected=${p===t.type}>${s(p,i)}</option>`)}
          </select>
        </div>
      ...
      <div class="select-row">
        ...
        <div class="weekday-chips">
          ${e.map((i,o)=>n`
            ...
            >${i}</button>`)}
        </div>`;if(this._scheduleType==="nth_weekday"){let i=[["1",s("ord_1",t)],["2",s("ord_2",t)],["3",s("ord_3",t)],["4",s("ord_4",t)],["5",s("ord_5",t)],["-1",s("ord_last",t)]];return n`
        <div class="select-row">
          <label>${s("recurrence_occurrence",t)}</label>
          <select .value=${this._nth} @change=${o=>this._nth=o.target.value}>
            ${i.map(([o,p])=>n`<option value=${o} ?selected=${o===this._nth}>${p}</option>`)}
          </select>
        </div>
        <div class="select-row">
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${yt.map(i=>n`<option value=${i} ?selected=${i===this._type}>${s(i,t)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${xt.map(i=>n`<option value=${i} ?selected=${i===this._priority}>${s("priority_"+i,t)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${$t.map(i=>n`<option value=${i} ?selected=${i===this._scheduleType}>${s(i,t)}</option>`)}
            </select>
          </div>
  ...
  `,a([m({attribute:!1})],u.prototype,"hass",2),a([m({type:Boolean,attribute:"checklists-enabled"})],u.prototype,"checklistsEnabled",2),a([m({type:Boolean,attribute:"schedule-time-enabled"})],u.prototype,"scheduleTimeEnabled",2),a([m({type:Boolean,attribute:"completion-actions-enabled"})],u.prototype,"completionActionsEnabled",2),a([m({type:Number,attribute:"default-warning-days"})],u.prototype,"defaultWarningDays",2),a([l()],u.prototype,"_open",2),a([l()],u.prototype,"_loading",2),a([l()],u.prototype,"_error",2),a([l()],u.prototype,"_entryId",2),a([l()],u.prototype,"_taskId",2),a([l()],u.prototype,"_objectChoices",2),a([l()],u.prototype,"_name",2),a([l()],u.prototype,"_type",2),a([l()],u.prototype,"_scheduleType",2),a([l()],u.prototype,"_intervalDays",2),a([l()],u.prototype,"_intervalUnit",2),a([l()],u.prototype,"_dueDate",2),a([l()],u.prototype,"_warningDays",2),a([l()],u.prototype,"_intervalAnchor",2),a([l()],u.prototype,"_weekdays",2),a([l()],u.prototype,"_nth",2),a([l()],u.prototype,"_nthWeekday",2),a([l()],u.prototype,"_domDay",2),a([l()],u.prototype,"_notes",2),a([l()],u.prototype,"_documentationUrl",2),a([l()],u.prototype,"_customIcon",2),a([l()],u.prototype,"_priority",2),a([l()],u.prototype,"_labels",2),a([l()],u.prototype,"_enabled",2),a([l()],u.prototype,"_triggerEntityId",2),a([l()],u.prototype,"_triggerEntityIds",2),a([l()],u.prototype,"_triggerEntityLogic",2),a([l()],u.prototype,"_triggerAttribute",2),a([l()],u.prototype,"_triggerType",2),a([l()],u.prototype,"_triggerAbove",2),a([l()],u.prototype,"_triggerBelow",2),a([l()],u.prototype,"_triggerForMinutes",2),a([l()],u.prototype,"_triggerTargetValue",2),a([l()],u.prototype,"_triggerDeltaMode",2),a([l()],u.prototype,"_autoCompleteOnRecovery",2),a([l()],u.prototype,"_triggerFromState",2),a([l()],u.prototype,"_triggerToState",2),a([l()],u.prototype,"_triggerTargetChanges",2),a([l()],u.prototype,"_triggerRuntimeHours",2),a([l()],u.prototype,"_compoundLogic",2),a([l()],u.prototype,"_compoundConditions",2),a([l()],u.prototype,"_suggestedAttributes",2),a([l()],u.prototype,"_availableAttributes",2),a([l()],u.prototype,"_entityDomain",2),a([l()],u.prototype,"_lastPerformed",2),a([l()],u.prototype,"_nfcTagId",2),a([l()],u.prototype,"_availableTags",2),a([l()],u.prototype,"_responsibleUserId",2),a([l()],u.prototype,"_assigneePool",2),a([l()],u.prototype,"_rotationStrategy",2),a([l()],u.prototype,"_availableUsers",2),a([l()],u.prototype,"_checklistText",2),a([l()],u.prototype,"_scheduleTime",2),a([l()],u.prototype,"_actionService",2),a([l()],u.prototype,"_actionTargetEntity",2),a([l()],u.prototype,"_actionData",2),a([l()],u.prototype,"_actionDataJsonFallback",2),a([l()],u.prototype,"_actionTesting",2),a([l()],u.prototype,"_actionTestResult",2),a([l()],u.prototype,"_actionTestError",2),a([l()],u.prototype,"_qcNotes",2),a([l()],u.prototype,"_qcCost",2),a([l()],u.prototype,"_qcDuration",2),a([l()],u.prototype,"_qcFeedback",2),a([l()],u.prototype,"_environmentalEntity",2),a([l()],u.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",u);var v=class extends ${constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed";this._photoDocId="";this._photoPreview="";this._photoUploading=!1}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed",this._photoDocId="",this._photoPreview="",this._photoUploading=!1)}_toggleCheck(t){let e=String(t);this._checklistState={...this._checklistState,[e]:!this._checklistState[e]}}_setFeedback(t){this._feedback=t}async _onPhotoInput(t){let e=t.target,i=e.files?.[0];if(e.value="",!!i){this._photoUploading=!0,this._error="";try{let o=new FormData;o.append("entry_id",this.entryId),o.append("tags","photo"),o.append("file",i,i.name);let p=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:o});if(!p.ok){this._error=p.status===413?s("doc_too_large",this.lang):s("doc_upload_failed",this.lang);return}let h=await p.json();h.id&&(this._photoDocId=h.id,this._photoPreview=URL.createObjectURL(i))}catch{this._error=s("doc_upload_failed",this.lang)}finally{this._photoUploading=!1}}}_removePhoto(){this._photoPreview&&URL.revokeObjectURL(this._photoPreview),this._photoDocId="",this._photoPreview=""}async _complete(){this._loading=!0,this._error="";try{let t={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(t.notes=this._notes),this._cost){let e=parseFloat(this._cost);!isNaN(e)&&e>=0&&(t.cost=e)}if(this._duration){let e=parseInt(this._duration,10);!isNaN(e)&&e>=0&&(t.duration=e)}this.checklist.length>0&&(t.checklist_state=this._checklistState),this.adaptiveEnabled&&(t.feedback=this._feedback),this._photoDocId&&(t.photo_doc_id=this._photoDocId),await this.hass.connection.sendMessagePromise(t),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(t){this._error=k(t,this.lang,s("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return n``;let t=this.lang||this.hass?.language||"en";return n`
      <ha-dialog open @closed=${this._close}>
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),o.document.close()}_downloadSvg(t,e){let i=decodeURIComponent(t.svg_data_uri.replace("data:image/svg+xml,","")),o=new Blob([i],{type:"image/svg+xml"}),p=URL.createObjectURL(o),h=document.createElement("a");h.href=p;let _=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;h.download=`qr-${Lt(_)}-${e}.svg`,h.click(),URL.revokeObjectURL(p)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return n``;let t=this.lang||this.hass?.language||"en",e=this._taskName?`${s("qr_code",t)}: ${this._objectName} \u2014 ${this._taskName}`:`${s("qr_code",t)}: ${this._objectName}`,i=!!this._viewResult;return n`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${e}</div>
        <div class="content">
  ...
  `,a([m({attribute:!1})],T.prototype,"hass",2),a([m()],T.prototype,"lang",2),a([l()],T.prototype,"_open",2),a([l()],T.prototype,"_loading",2),a([l()],T.prototype,"_error",2),a([l()],T.prototype,"_viewResult",2),a([l()],T.prototype,"_completeResult",2),a([l()],T.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",T);function rt(r,d){let t=r.interval_analysis,e=t?.weibull_beta,i=t?.weibull_eta;if(e==null||i==null||i<=0)return c;let o=r.interval_days??0,p=r.suggested_interval??o;return n`
  ...
  `}function St(r,d){return n`
    <div class="weibull-info-row">
      <div class="weibull-info-item">
        <span>${s("characteristic_life",d)}</span>
        <span class="weibull-info-value">${Math.round(r.weibull_eta)} ${s("days",d)}</span>
      </div>
  ...
  `}function Rt(r,d,t){let e=r.confidence_interval_low,i=r.confidence_interval_high,o=d.suggested_interval??d.interval_days??0,p=d.interval_days??0,h=Math.max(0,e-5),g=i+5-h,y=(e-h)/g*100,E=(i-e)/g*100,q=(o-h)/g*100,I=p>0?(p-h)/g*100:-1;return n`
  ...
  `}function nt(r,d,t){let e=r.degradation_trend!=null&&r.degradation_trend!=="insufficient_data",i=r.days_until_threshold!=null,o=r.environmental_factor!=null&&r.environmental_factor!==1;if(!e&&!i&&!o)return c;let p=r.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":r.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return n`
    <div class="prediction-section">
      ${r.sensor_prediction_urgency?n`
        <div class="prediction-urgency-banner">
          <ha-svg-icon path="M1,21H23L12,2L1,21M12,18A1,1 0 0,1 11,17A1,1 0 0,1 12,16A1,1 0 0,1 13,17A1,1 0 0,1 12,18M13,15H11V10H13V15Z"></ha-svg-icon>
          ${s("sensor_prediction_urgency",d).replace("{days}",String(Math.round(r.days_until_threshold||0)))}
        </div>
      `:c}
      ...
      <div class="prediction-grid">
        ${e?n`
          <div class="prediction-item">
            ...
            <span class="prediction-value ${r.degradation_trend}">${s("trend_"+r.degradation_trend,d)}</span>
            ${r.degradation_rate!=null?n`<span class="prediction-rate">${r.degradation_rate>0?"+":""}${Math.abs(r.degradation_rate)>=10?Math.round(r.degradation_rate).toLocaleString():r.degradation_rate.toFixed(1)} ${r.trigger_entity_info?.unit_of_measurement||""}/${s("day_short",d)}</span>`:c}
          </div>
        `:c}
        ${i?n`
          <div class="prediction-item">
            ...
            <span class="prediction-value prediction-days${r.days_until_threshold===0?" exceeded":r.sensor_prediction_urgency?" urgent":""}">${r.days_until_threshold===0?s("threshold_exceeded",d):"~"+Math.round(r.days_until_threshold)+" "+s("days",d)}</span>
            ${r.threshold_prediction_date?n`<span class="prediction-date">${U(r.threshold_prediction_date,d)}</span>`:c}
            ${r.threshold_prediction_confidence?n`<span class="confidence-dot ${r.threshold_prediction_confidence}"></span>`:c}
          </div>
        `:c}
        ${o&&t.environmental?n`
          <div class="prediction-item">
            ...
            ${r.environmental_entity?n`<span class="prediction-entity entity-link" @click=${h=>et(h,r.environmental_entity)}>${r.environmental_entity}</span>`:c}
          </div>
        `:c}
      </div>
    </div>
  `}function ot(r,d,t,e){let i=Math.max(r||1,d);return n`
  ...
  `}function ct(r,d){return Pt(r,d)}function Pt(r,d){let t=r.seasonal_factors??r.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return c;let e=r.interval_analysis?.seasonal_reason,i=new Date().getMonth(),o=300,p=100,h=8,g=p-h-4,y=Math.max(...t,1.5),E=o/12,q=E*.65,I=h+g-1/y*g;return n`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${o} ${p}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",d)}">
        <line x1="0" y1="${I.toFixed(1)}" x2="${o}" y2="${I.toFixed(1)}"
          stroke="var(--divider-color)" stroke-width="1" stroke-dasharray="4,3" />
        ${t.map((H,S)=>{let j=H/y*g,K=S*E+(E-q)/2,z=h+g-j,D=S===i,O=H<1?"var(--success-color, #4caf50)":H>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return M`
  ...
  `}var f=class extends ${constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(t,e){this._entryId=t,this._taskId=e,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let e=(t.tasks||[]).find(i=>i.id===this._taskId);this._task=e??null}catch(t){this._error=k(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(e){return this._error=k(e,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-44IRS54J.js").then(({openCompleteDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-44IRS54J.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-44IRS54J.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=s("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=s("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${s("reanalyze_result",this._lang)||"Recomputed"}: ${t.recommended_interval}d (${t.data_points} pts)`:s("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=k(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-44IRS54J.js").then(({openHistoryEditDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return c;let e=this._lang;return n`
    ...
    `}_renderDetails(t){let e=this._lang,i=t.history||[],o=i.filter(_=>_.type==="completed"),p=o.reduce((_,g)=>_+(typeof g.cost=="number"?g.cost:0),0),h=(()=>{let _=o.map(g=>typeof g.duration=="number"?g.duration:null).filter(g=>g!=null);return _.length?Math.round(_.reduce((g,y)=>g+y,0)/_.length):null})();return n`
      <div class="details">
        ...
        ${i.length===0?n`<div class="history-empty">${s("history_empty",e)||"No history yet."}</div>`:n`
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(_=>{let g=["completed","reset","skipped"].includes(_.type);return n`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?n`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-44IRS54J.js").then(({openObjectQuickActions:o})=>{o(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${e.next_due?n`<span><strong>${s("next_due",t)||"Next due"}:</strong> ${U(e.next_due,t)}</span>`:c}
                  ${e.last_performed?n`<span><strong>${s("last_performed",t)||"Last"}:</strong> ${U(e.last_performed,t)}</span>`:c}
                  ${e.schedule?.kind&&!["manual","one_time"].includes(e.schedule.kind)||e.interval_days!=null?n`<span><strong>${s("interval",t)||"Interval"}:</strong> ${tt(e,t)}</span>`:c}
                </div>
              </div>
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e&&i?n`
              ...
              <div class="tasks-section">
                ...
                ${o.length===0?n`<div class="empty">${s("no_tasks",t)||"No tasks yet."}</div>`:n`
                      <div class="task-list">
                        ${o.map(h=>n`
  ...
  `,a([m({attribute:!1})],C.prototype,"hass",2),a([l()],C.prototype,"_open",2),a([l()],C.prototype,"_entryId",2),a([l()],C.prototype,"_data",2),a([l()],C.prototype,"_busy",2),a([l()],C.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",C);var ht="maintenance-object-dialog",_t="maintenance-task-dialog",Ft="maintenance-history-edit-dialog",qt="maintenance-complete-dialog",zt="maintenance-qr-dialog",Mt="maintenance-task-quick-actions-dialog",Nt="maintenance-object-quick-actions-dialog";function G(){return document.querySelector("home-assistant")?.hass}function P(r){let d=document.body.querySelector(r);return d||(d=document.createElement(r),document.body.appendChild(d)),d}function F(r){let d=G();if(!d)return!1;r.hass=d;let t=d.language||"en";return Z(t)||J(t).then(()=>{r.requestUpdate?.()}),!0}var pt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},B=null;function ut(r){return B||(B=r.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(d=>({features:d.features??pt.features,defaultWarningDays:d.general?.default_warning_days??7})).catch(()=>pt),B)}function ri(){let r=P(ht);return F(r)?(r.openCreate(),!0):!1}function ni(r,d){let t=P(ht);return F(t)?(t.openEdit(r,d),!0):!1}function oi(){let r=P(_t);if(!F(r))return!1;let d=G();return d?((async()=>{let t=await ut(d),e=r;e.checklistsEnabled=t.features.checklists,e.scheduleTimeEnabled=t.features.schedule_time,e.completionActionsEnabled=t.features.completion_actions,e.defaultWarningDays=t.defaultWarningDays,e.openCreate()})(),!0):!1}function li(r,d){let t=P(_t);if(!F(t))return!1;let e=G();return e?((async()=>{try{let[i,o]=await Promise.all([e.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:r}),ut(e)]),p=(i.tasks||[]).find(_=>_.id===d);if(!p){console.warn(`openEditTaskDialog: task ${d} not found in entry ${r}`);return}let h=t;h.checklistsEnabled=o.features.checklists,h.scheduleTimeEnabled=o.features.schedule_time,h.completionActionsEnabled=o.features.completion_actions,h.defaultWarningDays=o.defaultWarningDays,await h.openEdit(r,p)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function di(r){let d=P(Ft);return F(d)?(d.openEdit(r),!0):!1}function ci(r){let d=P(qt);return F(d)?(d.entryId=r.entry_id,d.taskId=r.task_id,d.taskName=r.task_name,d.checklist=r.checklist??[],d.adaptiveEnabled=!!r.adaptive_enabled,d.lang=G()?.language||"en",d.open(),!0):!1}function pi(r){let d=P(zt);return F(d)?(d.openForTask(r.entry_id,r.task_id,r.object_name,r.task_name),!0):!1}function hi(r,d){let t=P(Mt);return F(t)?(t.openFor(r,d),!0):!1}function _i(r){let d=P(Nt);return F(d)?(d.openFor(r),!0):!1}export{ci as openCompleteDialog,ri as openCreateObjectDialog,oi as openCreateTaskDialog,ni as openEditObjectDialog,li as openEditTaskDialog,di as openHistoryEditDialog,_i as openObjectQuickActions,pi as openQrDialog,hi as openTaskQuickActions};
