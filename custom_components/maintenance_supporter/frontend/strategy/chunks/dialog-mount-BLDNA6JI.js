...
import"./chunk-KWP6LLK2.js";import{a as S,b as a,c as Y,d as _,e as T,f as g,g as d,i as s,k as L,l as pt,m as ht,n as ut,o as P,p as _t,q as W,r as mt,s as gt,t as it,u as vt,v as ft,w as bt,x as yt,y as $t,z as A}from"./chunk-VJ2K4NTW.js";import{a as o,b as X}from"./chunk-3YPUSKYO.js";var I=class extends T{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(t){let i=t.target.value;this.value=i,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:i}}))}render(){return a`
      <label class="field">
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${i?a`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-BLDNA6JI.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
