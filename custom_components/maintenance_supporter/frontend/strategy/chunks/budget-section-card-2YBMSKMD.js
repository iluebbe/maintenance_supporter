...
import{a as x,b as $}from"./chunk-SYE4Z5RD.js";import{A as c,a as h,b as l,d as y,e as b,f as m,g as o,h as _,i as a,j as g,k as v,n as f,q as d}from"./chunk-7DW45NZ5.js";import{a as n}from"./chunk-LRS2DZQN.js";var E=80,s=class extends b{constructor(){super(...arguments);this._config={type:""};this._status=null;this._busy=!1;this._error="";this._localMonthly="";this._localYearly="";this._dirty=!1;this._loaded=!1}setConfig(t){this._config=t}getCardSize(){return 2}get _lang(){return v(this.hass)}get _isAdmin(){return this.hass?.user?.is_admin??!0}updated(t){super.updated(t),g(this,t),t.has("hass")&&this.hass&&!this._loaded&&(this._loaded=!0,this._load())}async _load(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"});this._status=t,f(t),this._localMonthly=t.monthly_budget?String(t.monthly_budget):"",this._localYearly=t.yearly_budget?String(t.yearly_budget):"",this._dirty=!1}catch(t){this._error=c(t,this._lang)}}async _save(){if(this._isAdmin){this._busy=!0,this._error="";try{let t=this._localMonthly.trim()===""?0:parseFloat(this._localMonthly),r=this._localYearly.trim()===""?0:parseFloat(this._localYearly),i={};!isNaN(t)&&t>=0&&(i.budget_monthly=t),!isNaN(r)&&r>=0&&(i.budget_yearly=r),await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:i}),await this._load()}catch(t){this._error=c(t,this._lang)}finally{this._busy=!1}}}_onDeepLink(){history.pushState(null,"","/maintenance-supporter?ms_action=open_budget"),window.dispatchEvent(new CustomEvent("location-changed"))}render(){let t=this._lang,r=this._status;if(!r)return l`<ha-card><div class="loading">${a("loading",t)||"Loading\u2026"}</div></ha-card>`;let i=r.currency_symbol||_,k=r.alert_threshold_pct??E,w=[{label:a("budget_monthly",t)||"Monthly",spent:r.monthly_spent||0,budget:r.monthly_budget||0},{label:a("budget_yearly",t)||"Yearly",spent:r.yearly_spent||0,budget:r.yearly_budget||0}];return l`
      <ha-card>
        <div class="card-content">
          ...
          ${this._error?l`<div class="error">${this._error}</div>`:y}

          ${w.map(e=>{if(!(e.budget>0))return l`
                <div class="track spent-only">
                  <div class="track-label-row">
                    <label>${e.label}</label>
                    <span class="track-numbers ok">${d(e.spent,i,t)}</span>
                  </div>
                </div>
              `;let p=Math.min(100,Math.max(0,e.spent/e.budget*100)),u=p>=100?"danger":p>=k?"warning":"ok";return l`
              <div class="track">
                <div class="track-label-row">
                  <label>${e.label}</label>
                  <span class="track-numbers ${u}">
                    ${d(e.spent,void 0,t)} / ${d(e.budget,i,t)}
                  </span>
                </div>
                <div class="bar"><div class="bar-fill ${u}" style="width:${p}%"></div></div>
              </div>
            `})}
