...
`).map(p=>p.trim()).filter(Boolean).slice(0,100);t.checklist=h.length?h:null}if(this.completionActionsEnabled){let h=this._actionService.trim();if(h&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(h)){let y={service:h},E=this._actionTargetEntity.trim();E&&(y.target={entity_id:E});let q=this._buildActionData();Object.keys(q).length>0&&(y.data=q),t.on_complete_action=y}else t.on_complete_action=null;let p={};this._qcNotes.trim()&&(p.notes=this._qcNotes.trim());let _=parseFloat(this._qcCost);!isNaN(_)&&_>=0&&(p.cost=_);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(p.duration=g),this._qcFeedback&&(p.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(p).length?p:null}let e=await this.hass.connection.sendMessagePromise(t),s=this._taskId||e?.task_id,o=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(s&&this._scheduleType==="sensor_based"&&o)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:s,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=k(t,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return c;let t=this._lang,e=this._triggerType==="compound";return n`
      ...
      <div class="select-row">
        ...
        >
          ${$t.map(s=>n`<option value=${s} ?selected=${s===this._triggerType}>${i(s,t)}</option>`)}
        </select>
      </div>
    ...
    `}_patchCondition(t,e){this._compoundConditions=this._compoundConditions.map((s,o)=>o===t?{...s,...e}:s)}_addCondition(){this._compoundConditions=[...this._compoundConditions,kt()]}_removeCondition(t){this._compoundConditions=this._compoundConditions.filter((e,s)=>s!==t)}_renderCompoundEditor(){let t=this._lang;return n`
      <div class="select-row">
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${bt.map(s=>n`<option value=${s} ?selected=${s===this._priority}>${i("priority_"+s,t)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${yt.map(s=>n`<option value=${s} ?selected=${s===this._scheduleType}>${i(s,t)}</option>`)}
            </select>
          </div>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `}function Ht(a,d,t){let e=a.confidence_interval_low,s=a.confidence_interval_high,o=d.suggested_interval??d.interval_days??0,h=d.interval_days??0,p=Math.max(0,e-5),g=s+5-p,y=(e-p)/g*100,E=(s-e)/g*100,q=(o-p)/g*100,I=h>0?(h-p)/g*100:-1;return n`
  ...
  `}function at(a,d,t){let e=a.degradation_trend!=null&&a.degradation_trend!=="insufficient_data",s=a.days_until_threshold!=null,o=a.environmental_factor!=null&&a.environmental_factor!==1;if(!e&&!s&&!o)return c;let h=a.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":a.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return n`
      ...
      <div class="prediction-grid">
        ...
        ${s?n`
          <div class="prediction-item">
            ...
            ${a.threshold_prediction_date?n`<span class="prediction-date">${j(a.threshold_prediction_date,d)}</span>`:c}
  ...
  `}function rt(a,d,t,e){let s=Math.max(a||1,d);return n`
  ...
  `}function lt(a,d){return St(a,d)}function St(a,d){let t=a.seasonal_factors??a.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return c;let e=a.interval_analysis?.seasonal_reason,s=new Date().getMonth(),o=300,h=100,p=8,g=h-p-4,y=Math.max(...t,1.5),E=o/12,q=E*.65,I=p+g-1/y*g;return n`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?n`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-HM7KZIQM.js").then(({openObjectQuickActions:o})=>{o(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${e.next_due?n`<span><strong>${i("next_due",t)||"Next due"}:</strong> ${j(e.next_due,t)}</span>`:c}
                  ${e.last_performed?n`<span><strong>${i("last_performed",t)||"Last"}:</strong> ${j(e.last_performed,t)}</span>`:c}
  ...
  `],r([m({attribute:!1})],v.prototype,"hass",2),r([l()],v.prototype,"_open",2),r([l()],v.prototype,"_entryId",2),r([l()],v.prototype,"_taskId",2),r([l()],v.prototype,"_task",2),r([l()],v.prototype,"_objectName",2),r([l()],v.prototype,"_busy",2),r([l()],v.prototype,"_error",2),r([l()],v.prototype,"_showSkip",2),r([l()],v.prototype,"_showReset",2),r([l()],v.prototype,"_showDetails",2),r([l()],v.prototype,"_showAdaptive",2),r([l()],v.prototype,"_skipReason",2),r([l()],v.prototype,"_resetDate",2),r([l()],v.prototype,"_features",2),r([l()],v.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",v);var C=class extends ${constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return this.hass?.language||"en"}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=k(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-HM7KZIQM.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-HM7KZIQM.js").then(({openCreateTaskDialog:t})=>{t(),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=i("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=k(e,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let e=i("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(e))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=k(e,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-HM7KZIQM.js").then(({openTaskQuickActions:e})=>{e(this._entryId,t)})}render(){if(!this._open)return c;let t=this._lang,e=this._data,s=e?.object,o=e?.tasks||[],h=this.hass?.user?.is_admin??!0;return n`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${e&&s?n`
              <div class="header">
  ...
  `,r([m({attribute:!1})],C.prototype,"hass",2),r([l()],C.prototype,"_open",2),r([l()],C.prototype,"_entryId",2),r([l()],C.prototype,"_data",2),r([l()],C.prototype,"_busy",2),r([l()],C.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",C);var ct="maintenance-object-dialog",pt="maintenance-task-dialog",Rt="maintenance-history-edit-dialog",Pt="maintenance-complete-dialog",Ft="maintenance-qr-dialog",qt="maintenance-task-quick-actions-dialog",zt="maintenance-object-quick-actions-dialog";function G(){return document.querySelector("home-assistant")?.hass}function P(a){let d=document.body.querySelector(a);return d||(d=document.createElement(a),document.body.appendChild(d)),d}function F(a){let d=G();return d?(a.hass=d,!0):!1}var dt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},B=null;function ht(a){return B||(B=a.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(d=>({features:d.features??dt.features,defaultWarningDays:d.general?.default_warning_days??7})).catch(()=>dt),B)}function ii(){let a=P(ct);return F(a)?(a.openCreate(),!0):!1}function si(a,d){let t=P(ct);return F(t)?(t.openEdit(a,d),!0):!1}function ai(){let a=P(pt);if(!F(a))return!1;let d=G();return d?((async()=>{let t=await ht(d),e=a;e.checklistsEnabled=t.features.checklists,e.scheduleTimeEnabled=t.features.schedule_time,e.completionActionsEnabled=t.features.completion_actions,e.defaultWarningDays=t.defaultWarningDays,e.openCreate()})(),!0):!1}function ri(a,d){let t=P(pt);if(!F(t))return!1;let e=G();return e?((async()=>{try{let[s,o]=await Promise.all([e.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:a}),ht(e)]),h=(s.tasks||[]).find(_=>_.id===d);if(!h){console.warn(`openEditTaskDialog: task ${d} not found in entry ${a}`);return}let p=t;p.checklistsEnabled=o.features.checklists,p.scheduleTimeEnabled=o.features.schedule_time,p.completionActionsEnabled=o.features.completion_actions,p.defaultWarningDays=o.defaultWarningDays,await p.openEdit(a,h)}catch(s){console.warn("openEditTaskDialog: failed to load task/features",s)}})(),!0):!1}function ni(a){let d=P(Rt);return F(d)?(d.openEdit(a),!0):!1}function oi(a){let d=P(Pt);return F(d)?(d.entryId=a.entry_id,d.taskId=a.task_id,d.taskName=a.task_name,d.checklist=a.checklist??[],d.adaptiveEnabled=!!a.adaptive_enabled,d.lang=G()?.language||"en",d.open(),!0):!1}function li(a){let d=P(Ft);return F(d)?(d.openForTask(a.entry_id,a.task_id,a.object_name,a.task_name),!0):!1}function di(a,d){let t=P(qt);return F(t)?(t.openFor(a,d),!0):!1}function ci(a){let d=P(zt);return F(d)?(d.openFor(a),!0):!1}export{oi as openCompleteDialog,ii as openCreateObjectDialog,ai as openCreateTaskDialog,si as openEditObjectDialog,ri as openEditTaskDialog,ni as openHistoryEditDialog,ci as openObjectQuickActions,li as openQrDialog,di as openTaskQuickActions};
