...
import{a as kt,b as wt,c as Et,d as It,e as St,f as Tt,g as At,h as Ct,i as Pt}from"./chunk-CWHLCD4F.js";import"./chunk-CLMSAJLK.js";import{A as zt,B as T,a as w,b as a,c as Z,d as p,e as E,f as v,g as c,h as et,i as s,k as P,l as Lt,m as Rt,n as qt,o as Ht,p as A,q as J,r as G,s as Nt,t as Mt,u as nt,v as ht,w as Ot,x as Ft,y as Dt,z as jt}from"./chunk-SO6ZYAGS.js";import{a as l,b as rt,c as xt}from"./chunk-APM7GQQR.js";var C=class extends E{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(t){let i=t.target.value;this.value=i,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:i}}))}render(){return a`
      <label class="field">
...
`).map(h=>h.trim()).filter(Boolean).slice(0,100);t.checklist=u.length?u:null}if(this.completionActionsEnabled){let u=this._actionService.trim();if(u&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(u)){let x={service:u},y=this._actionTargetEntity.trim();y&&(x.target={entity_id:y});let $=this._buildActionData();Object.keys($).length>0&&(x.data=$),t.on_complete_action=x}else t.on_complete_action=null;let h={};this._qcNotes.trim()&&(h.notes=this._qcNotes.trim());let g=parseFloat(this._qcCost);!isNaN(g)&&g>=0&&(h.cost=g);let f=parseInt(this._qcDuration,10);!isNaN(f)&&f>=0&&(h.duration=f),this._qcFeedback&&(h.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(h).length?h:null}let e=await this.hass.connection.sendMessagePromise(t),n=this._taskId||e?.task_id,d=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;this._warning="";let _=u=>{this._warning=s("subsave_warning",this._lang).replace("{detail}",u)};if(n&&this._scheduleType==="sensor_based"&&d&&await _t(this,{type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null},{onError:_})!==void 0&&(this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute),n&&this._adaptiveSnapshot()!==this._adaptiveInitial){let u=parseFloat(this._adaptiveAlpha),h=parseInt(this._adaptiveMin,10),g=parseInt(this._adaptiveMax,10);await _t(this,{type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:n,enabled:this._adaptiveEnabled,...u>=.1&&u<=.9?{ewa_alpha:u}:{},...!isNaN(h)&&h>=1?{min_interval_days:h}:{},...!isNaN(g)&&g>=1?{max_interval_days:g}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction},{onError:_})!==void 0&&(this._adaptiveInitial=this._adaptiveSnapshot())}this._warning?n&&(this._taskId=n):this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=T(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._warning="",this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return p;let t=this._lang,i=this._triggerType==="compound";return a`
  ...
  `,l([v({type:String})],U.prototype,"lang",2),l([c()],U.prototype,"_open",2),l([c()],U.prototype,"_busy",2),l([c()],U.prototype,"_devices",2),l([c()],U.prototype,"_deviceIndex",2);customElements.get("ms-camera-capture")||customElements.define("ms-camera-capture",U);var dt=w`
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `}function fe(r,o){return ni(r,o)}function ni(r,o){let t=r.seasonal_factors??r.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return p;let i=r.interval_analysis?.seasonal_reason,e=new Date().getMonth(),n=300,d=100,_=8,h=d-_-4,g=Math.max(...t,1.5),f=n/12,x=f*.65,y=_+h-1/g*h;return a`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${n} ${d}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",o)}">
        ...
        ${t.map(($,H)=>{let W=$/g*h,Y=H*f+(f-x)/2,M=_+h-W,j=H===e,Q=$<1?"var(--success-color, #4caf50)":$>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return Z`
            <rect x="${k(Y)}" y="${k(M)}"
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${i?a`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-OQLNC7BB.js").then(({openObjectQuickActions:n})=>{n(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
  ...
  `],l([v({attribute:!1})],S.prototype,"hass",2),l([c()],S.prototype,"_open",2),l([c()],S.prototype,"_entryId",2),l([c()],S.prototype,"_taskId",2),l([c()],S.prototype,"_task",2),l([c()],S.prototype,"_objectName",2),l([c()],S.prototype,"_taskRef",2),l([c()],S.prototype,"_busy",2),l([c()],S.prototype,"_error",2),l([c()],S.prototype,"_showSkip",2),l([c()],S.prototype,"_showReset",2),l([c()],S.prototype,"_showDetails",2),l([c()],S.prototype,"_showAdaptive",2),l([c()],S.prototype,"_skipReason",2),l([c()],S.prototype,"_resetDate",2),l([c()],S.prototype,"_features",2),l([c()],S.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",S);function ye(r){return!!r&&/^https?:\/\//i.test(r)}function be(r){return r?customElements.get("ha-markdown")?a`<ha-markdown class="notes-md" .content=${r} breaks></ha-markdown>`:a`${r}`:p}var D=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return P(this.hass)}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=T(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-OQLNC7BB.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-OQLNC7BB.js").then(({openCreateTaskDialog:t})=>{t(this._entryId),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=s("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(i){this._error=T(i,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let i=s("confirm_archive_object",this._lang);if(!window.confirm(i))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(i){this._error=T(i,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-OQLNC7BB.js").then(({openTaskQuickActions:i})=>{i(this._entryId,t)})}render(){if(!this._open)return p;let t=this._lang,i=this._data,e=i?.object,n=i?.tasks||[],d=this.hass?.user?.is_admin??!0;return a`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${i&&e?a`
              <div class="header">
