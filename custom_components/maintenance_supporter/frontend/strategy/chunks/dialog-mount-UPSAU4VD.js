...
`).map(u=>u.trim()).filter(Boolean).slice(0,100);t.checklist=c.length?c:null}if(this.completionActionsEnabled){let c=this._actionService.trim();if(c&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(c)){let y={service:c},$=this._actionTargetEntity.trim();$&&(y.target={entity_id:$});let f=this._buildActionData();Object.keys(f).length>0&&(y.data=f),t.on_complete_action=y}else t.on_complete_action=null;let u={};this._qcNotes.trim()&&(u.notes=this._qcNotes.trim());let p=parseFloat(this._qcCost);!isNaN(p)&&p>=0&&(u.cost=p);let v=parseInt(this._qcDuration,10);!isNaN(v)&&v>=0&&(u.duration=v),this._qcFeedback&&(u.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(u).length?u:null}let i=await this.hass.connection.sendMessagePromise(t),r=this._taskId||i?.task_id,h=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(r&&this._scheduleType==="sensor_based"&&h)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:r,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(r&&this._adaptiveSnapshot()!==this._adaptiveInitial){let c=parseFloat(this._adaptiveAlpha),u=parseInt(this._adaptiveMin,10),p=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:r,enabled:this._adaptiveEnabled,...c>=.1&&c<=.9?{ewa_alpha:c}:{},...!isNaN(u)&&u>=1?{min_interval_days:u}:{},...!isNaN(p)&&p>=1?{max_interval_days:p}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=P(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return _;let t=this._lang,e=this._triggerType==="compound";return a`
      ...
      <div class="select-row">
        ...
        >
          ${Jt.map(i=>a`<option value=${i} ?selected=${i===this._triggerType}>${s(i,t)}</option>`)}
        </select>
      </div>
      ...
      ${this._intervalDays?a`
          ...
          `:_}
    `}_patchCondition(t,e){this._compoundConditions=this._compoundConditions.map((i,r)=>r===t?{...i,...e}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Xt()]}_removeCondition(t){this._compoundConditions=this._compoundConditions.filter((e,i)=>i!==t)}_renderCompoundEditor(){let t=this._lang;return a`
      <div class="select-row">
    ...
    `}_renderCondition(t,e){let i=this._lang,r=e+1;return a`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${It.map(h=>a`<option value=${h} ?selected=${h===t.type}>${s(h,i)}</option>`)}
          </select>
        </div>
    ...
    `}_buildSchedule(){let t=i=>{let r=parseInt(this._calOffset,10)||0;return r&&(i.offset=Math.max(-15,Math.min(r,15))),i};if(this._scheduleType==="weekdays")return t({kind:"weekdays",weekdays:[...this._weekdays].sort((i,r)=>i-r)});if(this._scheduleType==="nth_weekday")return t({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let e={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(e.business=!0),t(e)}_recurrenceExtras(){let t={};if(this._seasonMonths.length&&(t.season_months=[...this._seasonMonths].sort((e,i)=>e-i)),this._endsMode==="count"){let e=parseInt(this._endsCount,10);e>=1&&(t.ends={count:e})}else this._endsMode==="until"&&this._endsUntil&&(t.ends={until:this._endsUntil});return t}_toggleSeasonMonth(t){this._seasonMonths=this._seasonMonths.includes(t)?this._seasonMonths.filter(e=>e!==t):[...this._seasonMonths,t]}_renderRecurrenceExtras(){let t=this._lang;if(!(this._scheduleType==="time_based"||nt.includes(this._scheduleType)))return _;let i=re(t);return a`
      ...
      ${this._endsMode==="until"?a`
        ...
        ></ms-date-field>`:_}
    `}_renderCalendarFields(){let t=this._lang,e=se(t);if(this._scheduleType==="weekdays")return a`
        ...
        <div class="select-row">
          ...
          <select .value=${this._nth} @change=${r=>this._nth=r.target.value}>
            ${i.map(([r,h])=>a`<option value=${r} ?selected=${r===this._nth}>${h}</option>`)}
          </select>
        </div>
        <div class="select-row">
          <label>${s("recurrence_weekday",t)}</label>
          <select .value=${this._nthWeekday} @change=${r=>this._nthWeekday=r.target.value}>
            ${e.map((r,h)=>a`<option value=${String(h)} ?selected=${String(h)===this._nthWeekday}>${r}</option>`)}
          </select>
        </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Qt.map(i=>a`<option value=${i} ?selected=${i===this._type}>${s(i,t)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${Gt.map(i=>a`<option value=${i} ?selected=${i===this._priority}>${s("priority_"+i,t)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${Zt.map(i=>a`<option value=${i} ?selected=${i===this._scheduleType}>${s(i,t)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="sensor_based"?a`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:wt,device_class:Et}}}]}
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?a`<div class="used-parts">
                ...
                ${this.parts.map(e=>{let i=O({part_id:e.id,entry_id:e.entry_id}),r=this._usedParts[i],h=r!==void 0,c=e.entry_id?{part_id:e.id,quantity:1,entry_id:e.entry_id}:{part_id:e.id,quantity:1};return a`<div class="used-part-row">
        ...
        <div class="dialog-actions">
          ...
          <ha-button
            ...
            title=${this._missingRequired.length?this._missingRequired.map(e=>s("err_required",t).replace("{field}",s(G[e]??e,t))).join(" \xB7 "):""}
          >
  ...
  `],o([g({attribute:!1})],b.prototype,"hass",2),o([g()],b.prototype,"entryId",2),o([g()],b.prototype,"taskId",2),o([g()],b.prototype,"taskName",2),o([g()],b.prototype,"lang",2),o([g({type:Array})],b.prototype,"checklist",2),o([g({type:Boolean})],b.prototype,"adaptiveEnabled",2),o([g()],b.prototype,"taskType",2),o([g()],b.prototype,"readingUnit",2),o([g({attribute:!1})],b.prototype,"restockDefault",2),o([g({attribute:!1})],b.prototype,"restockUnitCost",2),o([g()],b.prototype,"currencySymbol",2),o([g({attribute:!1})],b.prototype,"parts",2),o([g({attribute:!1})],b.prototype,"consumesParts",2),o([g({type:Array})],b.prototype,"consumesInfo",2),o([g({type:Array})],b.prototype,"requiredFields",2),o([g()],b.prototype,"phaseLabel",2),o([g({type:Boolean})],b.prototype,"requireTagScan",2),o([g({type:Boolean})],b.prototype,"viaTagScan",2),o([d()],b.prototype,"_open",2),o([d()],b.prototype,"_notes",2),o([d()],b.prototype,"_cost",2),o([d()],b.prototype,"_duration",2),o([d()],b.prototype,"_loading",2),o([d()],b.prototype,"_error",2),o([d()],b.prototype,"_checklistState",2),o([d()],b.prototype,"_feedback",2),o([d()],b.prototype,"_photoDocId",2),o([d()],b.prototype,"_photoPreview",2),o([d()],b.prototype,"_photoUploading",2),o([d()],b.prototype,"_readingValue",2),o([d()],b.prototype,"_restockQty",2),o([d()],b.prototype,"_completedAt",2),o([d()],b.prototype,"_usedParts",2),o([g({attribute:!1})],b.prototype,"checklistPrefill",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",b);var R=class extends T{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null;this._partOptions=null;this._partQty={};this._partQtyOriginal=""}get _lang(){return L(this.hass)}openEdit(t){this._draft={...t},this._originalSnapshot={...t},this._error="",this._open=!0,this._partOptions=null,this._partQty={},this._partQtyOriginal="",this._loadPartOptions()}async _loadPartOptions(){let t=this._draft;if(t)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"}),i=[];for(let h of e.parts||[]){let c=h.entry_id===t.entry_id,u=h.consumers.some(p=>p.entry_id===t.entry_id&&p.task_id===t.task_id);!c&&!u||i.push({part_id:h.part_id,name:h.name,entry_id:h.entry_id,foreign:!c,object_name:h.object_name})}for(let h of t.used_parts||[]){let c=h.entry_id||t.entry_id;i.some(u=>u.part_id===h.part_id&&u.entry_id===c)||i.push({part_id:h.part_id,name:h.name||h.part_id,entry_id:c,foreign:c!==t.entry_id,object_name:null})}let r={};for(let h of t.used_parts||[])r[`${h.entry_id||t.entry_id}:${h.part_id}`]=h.quantity??1;this._partOptions=i,this._partQty=r,this._partQtyOriginal=this._partSelectionKey()}catch{this._partOptions=[]}}_partSelectionKey(){return JSON.stringify(Object.entries(this._partQty).filter(([,t])=>t>0).sort(([t],[e])=>t.localeCompare(e)))}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null}_set(t,e){this._draft&&(this._draft={...this._draft,[t]:e})}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{let t={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(t.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(t.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(t.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(t.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(t.completed_by=this._draft.completed_by),this._partOptions!==null&&this._partSelectionKey()!==this._partQtyOriginal&&(t.used_parts=(this._partOptions||[]).filter(i=>(this._partQty[`${i.entry_id}:${i.part_id}`]||0)>0).map(i=>({part_id:i.part_id,quantity:this._partQty[`${i.entry_id}:${i.part_id}`],...i.foreign?{entry_id:i.entry_id}:{}}))),Object.keys(t).filter(i=>!["type","entry_id","task_id","original_timestamp"].includes(i)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(t),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=P(t,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return _;let t=this._lang,e=this._draft;return a`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ...
        ${this._partOptions&&this._partOptions.length>0?a`
          <div class="parts-block">
            ...
            ${this._partOptions.map(i=>{let r=`${i.entry_id}:${i.part_id}`,h=this._partQty[r]||0;return a`
    ...
    .part-qty { width: 76px; }
  `,o([g({attribute:!1})],R.prototype,"hass",2),o([d()],R.prototype,"_open",2),o([d()],R.prototype,"_saving",2),o([d()],R.prototype,"_error",2),o([d()],R.prototype,"_draft",2),o([d()],R.prototype,"_partOptions",2),o([d()],R.prototype,"_partQty",2);customElements.get("maintenance-history-edit-dialog")||customElements.define("maintenance-history-edit-dialog",R);function St(n,l,t){let e=new Blob([n],{type:t}),i=URL.createObjectURL(e),r=document.createElement("a");r.href=i,r.download=l,r.target="_blank",r.rel="noopener",r.style.display="none",document.body.appendChild(r),r.dispatchEvent(new MouseEvent("click")),document.body.removeChild(r),setTimeout(()=>URL.revokeObjectURL(i),6e4)}function Q(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Tt(n){return!n.startsWith("data:image/svg+xml,")&&!n.startsWith("data:image/png;base64,")?"":Q(n)}function ne(n){return n.replace(/[/\\:*?"<>|#%]+/g,"").replace(/\s+/g,"-").toLowerCase().substring(0,100)}var C=class extends T{constructor(){super(...arguments);this.lang="en";this._open=!1;this._loading=!1;this._error="";this._viewResult=null;this._completeResult=null;this._urlMode="companion";this._entryId="";this._taskId=null;this._objectName="";this._taskName="";this._generateSeq=0}openForObject(t,e){this._entryId=t,this._taskId=null,this._objectName=e,this._taskName="",this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}openForTask(t,e,i,r){this._entryId=t,this._taskId=e,this._objectName=i,this._taskName=r,this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}async _generate(){let t=++this._generateSeq;this._loading=!0,this._error="",this._viewResult=null,this._completeResult=null;try{let e={type:"maintenance_supporter/qr/generate",entry_id:this._entryId,url_mode:this._urlMode};this._taskId&&(e.task_id=this._taskId);let i=[this.hass.connection.sendMessagePromise({...e,action:"view"})];this._taskId&&i.push(this.hass.connection.sendMessagePromise({...e,action:"complete"}));let r=await Promise.all(i);if(t!==this._generateSeq)return;this._viewResult=r[0],r.length>1&&(this._completeResult=r[1])}catch(e){if(t!==this._generateSeq)return;let i=e?.code,r=e?.message;this._error=i==="no_url"||typeof r=="string"&&r.includes("No Home Assistant URL")?s("qr_error_no_url",this.lang):s("qr_error",this.lang)}finally{t===this._generateSeq&&(this._loading=!1)}}_setUrlMode(t){this._urlMode!==t&&(this._urlMode=t,this._generate())}_print(){if(!this._viewResult)return;let t=this._viewResult,e=t.label.task_name?`${t.label.object_name} \u2014 ${t.label.task_name}`:t.label.object_name,i=[t.label.manufacturer,t.label.model].filter(Boolean).join(" "),r=window.open("","_blank","width=600,height=500");if(!r)return;let h=this.lang||"en",c=Q(e),u=Q(i),p=!!this._completeResult,v=Q(s("qr_action_view",h)),y=Q(s("qr_action_complete",h));r.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8">
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,o([g({attribute:!1})],C.prototype,"hass",2),o([g()],C.prototype,"lang",2),o([d()],C.prototype,"_open",2),o([d()],C.prototype,"_loading",2),o([d()],C.prototype,"_error",2),o([d()],C.prototype,"_viewResult",2),o([d()],C.prototype,"_completeResult",2),o([d()],C.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",C);function At(n){let l=n.getFullYear(),t=String(n.getMonth()+1).padStart(2,"0"),e=String(n.getDate()).padStart(2,"0");return`${l}-${t}-${e}`}function ae(n,l){if(l<=0)return 0;let t=typeof n=="number"&&Number.isFinite(n)?Math.trunc(n):0;return t<0?0:t%l}function oe(n){return!!(n?.phases&&n.phase_sequence&&n.phase_sequence.length>0)}function ot(n){if(!n||!oe(n))return null;let l=n.phase_sequence,t=ae(n.phase_cursor,l.length),e=l[t],i=n.phases?.[e];return i?{id:e,name:i.name,index:t,count:l.length,notes:i.notes,checklist:i.checklist!==void 0?i.checklist:n.checklist??[],consumesParts:i.consumes_parts!==void 0?i.consumes_parts:n.consumes_parts??[],requiredFields:i.required_completion_fields!==void 0?i.required_completion_fields:n.required_completion_fields??[]}:null}function Z(n){let l=ot(n);return l?`${l.index+1}/${l.count} \xB7 ${l.name}`:""}function Pt(n){let l=n.task??null,t=l?ot(l):null,e=t?t.consumesParts:l?.consumes_parts||[],i=!!l?.part_ref,r=n.objects.find(u=>u.entry_id===n.entryId)?.parts||[],h=i?r.find(u=>u.id===l.part_ref.part_id):void 0,c=n.checklistsEnabled??!0;return{entry_id:n.entryId,task_id:n.taskId,task_name:n.taskName,checklist:t?c?t.checklist:[]:n.checklist??[],adaptive_enabled:!!n.adaptiveEnabled,required_completion_fields:t?t.requiredFields:l?.required_completion_fields||[],task_type:l?.type||"",reading_unit:l?.reading_unit||"",parts:i?[]:kt({consumes_parts:e},n.entryId,n.objects,n.lang),consumes_parts:i?[]:e,phase_label:t?Z(l):"",require_tag_scan:!!l?.require_tag_scan,restock_default:i?h?.restock_quantity??1:null,restock_unit_cost:i?h?.cost??null:null,currency_symbol:n.currencySymbol??"",consumes_info:e.map(u=>xt(u,n.entryId,n.objects,n.lang)),checklist_prefill:l?.checklist_progress||{},via_tag_scan:!!n.viaTagScan}}function Lt(n,l,t){n.entryId=l.entry_id,n.taskId=l.task_id,n.taskName=l.task_name,n.lang=t,n.checklist=l.checklist??[],n.adaptiveEnabled=!!l.adaptive_enabled,n.requiredFields=l.required_completion_fields??[],n.taskType=l.task_type??"",n.readingUnit=l.reading_unit??"",n.parts=l.parts??[],n.consumesParts=l.consumes_parts??[],n.phaseLabel=l.phase_label??"",n.requireTagScan=!!l.require_tag_scan,n.restockDefault=l.restock_default??null,n.restockUnitCost=l.restock_unit_cost??null,n.currencySymbol=l.currency_symbol??"",n.consumesInfo=l.consumes_info??[],n.checklistPrefill=l.checklist_prefill??{},n.viaTagScan=!!l.via_tag_scan,n.open({viaTagScan:!!l.via_tag_scan})}function x(n){return n.toFixed(1)}function Ct(n,l){let t=n.interval_analysis,e=t?.weibull_beta,i=t?.weibull_eta;if(e==null||i==null||i<=0)return _;let r=n.interval_days??0,h=n.suggested_interval??r;return a`
      ...
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",i)}">
        ${Bt.map(H=>{let M=136-H*128;return Y`
            ...
            <text x="${28}" y="${x(M+3)}" fill="var(--secondary-text-color)"
              font-size="8" text-anchor="end">${A(H*100,i,0)}%</text>
          `})}
        ...
        ${t>0?Y`
          ...
          <text x="${x(N+4)}" y="${x(K-6)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${Vt}%</text>
        `:_}

        ${e>0&&e!==t?Y`
          <line x1="${x(dt)}" y1="${8}" x2="${x(dt)}" y2="${x(136)}"
    ...
    <div class="weibull-info-row">
      ...
      ${n.weibull_r_squared!=null?a`
        <div class="weibull-info-item">
          ...
          <span class="weibull-info-value">${A(n.weibull_r_squared,l,3)}</span>
        </div>
      `:_}
    </div>
  `}function pe(n,l,t){let e=n.confidence_interval_low,i=n.confidence_interval_high,r=l.suggested_interval??l.interval_days??0,h=l.interval_days??0,c=Math.max(0,e-5),p=i+5-c,v=(e-c)/p*100,y=(i-e)/p*100,$=(r-c)/p*100,f=h>0?(h-c)/p*100:-1;return a`
      ...
      <div class="prediction-grid">
        ${e?a`
          <div class="prediction-item">
            ...
            ${n.degradation_rate!=null?a`<span class="prediction-rate">${n.degradation_rate>0?"+":""}${A(n.degradation_rate,l,Math.abs(n.degradation_rate)>=10?0:1)} ${n.trigger_entity_info?.unit_of_measurement||""}/${s("day_short",l)}</span>`:_}
          </div>
        `:_}
        ${i?a`
          <div class="prediction-item">
        ...
        ${r&&t.environmental?a`
          <div class="prediction-item">
            ...
            <span class="prediction-value">${A(n.environmental_factor,l,2)}x</span>
            ${n.environmental_entity?a`<span class="prediction-entity entity-link" @click=${c=>ft(c,n.environmental_entity)}>${n.environmental_entity}</span>`:_}
          </div>
        `:_}
      </div>
    </div>
  `}function Ht(n,l,t,e){let i=Math.max(n||1,l);return a`
  ...
  `}function Mt(n,l){return he(n,l)}function he(n,l){let t=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return _;let e=n.interval_analysis?.seasonal_reason,i=new Date().getMonth(),r=300,h=100,c=8,p=h-c-4,v=Math.max(...t,1.5),y=r/12,$=y*.65,f=c+p-1/v*p;return a`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${r} ${h}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",l)}">
        ...
        ${t.map((E,q)=>{let V=E/v*p,B=q*y+(y-$)/2,N=c+p-V,D=q===i,K=E<1?"var(--success-color, #4caf50)":E>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return Y`
            <rect x="${x(B)}" y="${x(N)}"
              width="${x($)}" height="${x(V)}"
  ...
  `}var w=class extends T{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return L(this.hass)}async openFor(t,e){this._entryId=t,this._taskId=e,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=At(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._currencySymbol=t?.budget?.currency_symbol||"",this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let e=(t.tasks||[]).find(i=>i.id===this._taskId);this._task=e??null}catch(t){this._error=P(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(e){return this._error=P(e,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-UPSAU4VD.js").then(async({openCompleteDialog:t})=>{let e=this._task,i=[];try{i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}t(Pt({entryId:this._entryId,taskId:this._taskId,taskName:e.name,task:e,objects:i,lang:this._lang,checklist:e.checklist||[],adaptiveEnabled:!!e.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-UPSAU4VD.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-UPSAU4VD.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=s("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=s("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${s("reanalyze_result",this._lang)||"Recomputed"}: ${mt(t.recommended_interval,"days",this._lang)} (${t.data_points} pts)`:s("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=P(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-UPSAU4VD.js").then(({openHistoryEditDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null,used_parts:t.used_parts??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return _;let e=this._lang;return a`
    ...
    `}_renderAdaptive(t){let e=this._lang,i=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,r=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,h=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,c=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!i&&!r&&!h&&!c?a`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${r?qt(t,e,this._features):_}
        ${h?Ct(t,e):_}
        ${c?a`
          ${Nt(t,e,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?Mt(t,e):_}
        `:_}
      </div>
    `}_renderDetails(t){let e=this._lang,i=t.history||[],r=i.filter(u=>u.type==="completed"),h=r.reduce((u,p)=>u+(typeof p.cost=="number"?p.cost:0),0),c=(()=>{let u=r.map(p=>typeof p.duration=="number"?p.duration:null).filter(p=>p!=null);return u.length?Math.round(u.reduce((p,v)=>p+v,0)/u.length):null})();return a`
      <div class="details">
        <div class="stats-grid">
          ...
          <div class="stat">
            ...
            <span class="stat-value">${A(h,e,2)}</span>
          </div>
          <div class="stat">
        ...
        ${i.length===0?a`<div class="history-empty">${s("history_empty",e)||"No history yet."}</div>`:a`
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(u=>{let p=["completed","reset","skipped"].includes(u.type);return a`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${u.type}">${s(u.type,e)}</span>
                        <span class="history-date">${_t(u.timestamp,e)}</span>
                      ...
                      ${u.cost!=null||u.duration!=null?a`<div class="history-meta">
                            ${u.cost!=null?a`<span>💰 ${A(u.cost,e,2)}</span>`:_}
    ...
    `}render(){if(!this._open)return _;let t=this._lang,e=this._task,i=this.hass?.user?.is_admin??!0;return a`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?a`
              <div class="header">
                <div class="title">
                  <span class="status-dot" style="background: ${J[e.status]||"#ccc"}"></span>
                  <span class="task-name">${e.name}</span>
                </div>
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-UPSAU4VD.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${e.next_due?a`<span><strong>${s("next_due",t)||"Next due"}:</strong> ${W(e.next_due,t)}</span>`:_}
                  ${e.last_performed?a`<span><strong>${s("last_performed",t)||"Last"}:</strong> ${W(e.last_performed,t)}</span>`:_}
                  ${e.schedule?.kind&&!["manual","one_time"].includes(e.schedule.kind)||e.interval_days!=null?a`<span><strong>${s("interval",t)||"Interval"}:</strong> ${vt(e,t)}</span>`:_}
                  ${Z(e)?a`<span><strong>${s("phase_current",t)}:</strong> ${Z(e)}</span>`:_}
                </div>
              </div>
        ...
        ${e&&i?a`
                      ...
                      <div class="task-list">
                        ${r.map(c=>a`
                          <div class="task-row" @click=${()=>this._onTaskClick(c.id)}>
                            <span class="status-dot" style="background: ${J[c.status]||"#ccc"}"></span>
              ...
              ${i.notes?a`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${Ft(i.notes)}</div>
                    </div>
                  `:_}
      ...
      <div class="meta">
        ${i.map(([r,h])=>a`
            <div class="meta-item">
              ...
              <span class="meta-value">${Ot(h)?a`<a href="${h}" target="_blank" rel="noopener noreferrer">${h}</a>`:h}</span>
            </div>
          `)}
      </div>
    `}};F.styles=S`
  ...
  `,o([g({attribute:!1})],F.prototype,"hass",2),o([d()],F.prototype,"_open",2),o([d()],F.prototype,"_entryId",2),o([d()],F.prototype,"_data",2),o([d()],F.prototype,"_busy",2),o([d()],F.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",F);var lt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"};function Dt(){let n=window;return n.__msSettingsCache??={promise:null}}function tt(n){let l=Dt();if(l.promise)return l.promise;let t=n.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(e=>({features:e.features??lt.features,defaultWarningDays:e.general?.default_warning_days??7,rowActionStyle:e.general?.row_action_style??lt.rowActionStyle})).catch(()=>(l.promise===t&&(l.promise=null),lt));return l.promise=t,t}function jt(){Dt().promise=null}var zt="maintenance-object-dialog",Ut="maintenance-task-dialog",ue="maintenance-history-edit-dialog",_e="maintenance-complete-dialog",me="maintenance-qr-dialog",ge="maintenance-task-quick-actions-dialog",ve="maintenance-object-quick-actions-dialog";function et(){return document.querySelector("home-assistant")?.hass}function fe(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function z(n){let l=fe(),t=l.querySelector(n)??document.body.querySelector(n);return t?t.parentNode!==l&&l.appendChild(t):(t=document.createElement(n),l.appendChild(t)),t}function U(n){let l=et();if(!l)return!1;n.hass=l;let t=L(l);return ct(t)||pt(t).then(()=>{n.requestUpdate?.()}),ht(l.locale,l.config?.country),!0}function Es(n){return tt(n).then(l=>l.rowActionStyle)}function Is(){jt()}function Ss(){let n=z(zt);return U(n)?(n.openCreate(),!0):!1}function Ts(n,l){let t=z(zt);return U(t)?(t.openEdit(n,l),!0):!1}function As(n="",l){let t=z(Ut);if(!U(t))return!1;let e=et();return e?((async()=>{let i=await tt(e),r=t;r.checklistsEnabled=i.features.checklists,r.scheduleTimeEnabled=i.features.schedule_time,r.completionActionsEnabled=i.features.completion_actions,r.defaultWarningDays=i.defaultWarningDays,r.openCreate(n,l)})(),!0):!1}function Ps(n,l){let t=z(Ut);if(!U(t))return!1;let e=et();return e?((async()=>{try{let[i,r]=await Promise.all([e.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:n}),tt(e)]),h=(i.tasks||[]).find(u=>u.id===l);if(!h){console.warn(`openEditTaskDialog: task ${l} not found in entry ${n}`);return}let c=t;c.checklistsEnabled=r.features.checklists,c.scheduleTimeEnabled=r.features.schedule_time,c.completionActionsEnabled=r.features.completion_actions,c.defaultWarningDays=r.defaultWarningDays,await c.openEdit(n,h)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function Ls(n){let l=z(ue);return U(l)?(l.openEdit(n),!0):!1}function Cs(n){let l=z(_e);return U(l)?(Lt(l,n,et()?.language||"en"),!0):!1}function qs(n){let l=z(me);return U(l)?(l.openForTask(n.entry_id,n.task_id,n.object_name,n.task_name),!0):!1}function Hs(n,l){let t=z(ge);return U(t)?(t.openFor(n,l),!0):!1}function Rs(n){let l=z(ve);return U(l)?(l.openFor(n),!0):!1}export{Is as __resetSettingsCacheForTests,Es as getRowActionStyle,Cs as openCompleteDialog,Ss as openCreateObjectDialog,As as openCreateTaskDialog,Ts as openEditObjectDialog,Ps as openEditTaskDialog,Ls as openHistoryEditDialog,Rs as openObjectQuickActions,qs as openQrDialog,Hs as openTaskQuickActions};
