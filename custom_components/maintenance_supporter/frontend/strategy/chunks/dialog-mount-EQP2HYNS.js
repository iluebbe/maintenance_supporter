                  ...
                  ${this.parts.map(i=>{let n=this._consumesParts[i.id];return r`
                      <div class="consumes-row">
                        ...
                        ${n!==void 0?r`<input
                              ...
                              step="0.01"
                              .value=${String(n)}
                              @input=${h=>{let p=parseFloat(h.target.value);this._consumesParts={...this._consumesParts,[i.id]:Number.isFinite(p)&&p>=.01?p:1}}}
                            />`:c}
                      </div>
                    `})}
                </div>
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?r`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-EQP2HYNS.js").then(({openObjectQuickActions:n})=>{n(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
