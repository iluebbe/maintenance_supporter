...
import{a as I,b as a,c as W,d as _,e as S,f as g,g as d,i as s,j as A,k as dt,l as ct,m as V,n as pt,o as ht,p as tt,q as ut,r as _t,s as mt,t as gt,u as T}from"./chunk-TX3XY2US.js";import{a as o,b as Z}from"./chunk-DEN57ILL.js";var E=class extends S{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(t){let i=t.target.value;this.value=i,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:i}}))}render(){return a`
      <label class="field">
...
`).map(u=>u.trim()).filter(Boolean).slice(0,100);t.checklist=c.length?c:null}if(this.completionActionsEnabled){let c=this._actionService.trim();if(c&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(c)){let b={service:c},x=this._actionTargetEntity.trim();x&&(b.target={entity_id:x});let f=this._buildActionData();Object.keys(f).length>0&&(b.data=f),t.on_complete_action=b}else t.on_complete_action=null;let u={};this._qcNotes.trim()&&(u.notes=this._qcNotes.trim());let p=parseFloat(this._qcCost);!isNaN(p)&&p>=0&&(u.cost=p);let v=parseInt(this._qcDuration,10);!isNaN(v)&&v>=0&&(u.duration=v),this._qcFeedback&&(u.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(u).length?u:null}let e=await this.hass.connection.sendMessagePromise(t),r=this._taskId||e?.task_id,h=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(r&&this._scheduleType==="sensor_based"&&h)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:r,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(r&&this._adaptiveSnapshot()!==this._adaptiveInitial){let c=parseFloat(this._adaptiveAlpha),u=parseInt(this._adaptiveMin,10),p=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:r,enabled:this._adaptiveEnabled,...c>=.1&&c<=.9?{ewa_alpha:c}:{},...!isNaN(u)&&u>=1?{min_interval_days:u}:{},...!isNaN(p)&&p>=1?{max_interval_days:p}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=T(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return _;let t=this._lang,i=this._triggerType==="compound";return a`
      ...
      ${this._intervalDays?a`
          ...
          `:_}
    `}_patchCondition(t,i){this._compoundConditions=this._compoundConditions.map((e,r)=>r===t?{...e,...i}:e)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Kt()]}_removeCondition(t){this._compoundConditions=this._compoundConditions.filter((i,e)=>e!==t)}_renderCompoundEditor(){let t=this._lang;return a`
      <div class="select-row">
    ...
    `}_renderCondition(t,i){let e=this._lang,r=i+1;return a`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${$t.map(h=>a`<option value=${h} ?selected=${h===t.type}>${s(h,e)}</option>`)}
          </select>
        </div>
    ...
    `}_renderCalendarFields(){let t=this._lang,i=Zt(t);if(this._scheduleType==="weekdays")return a`
        ...
        <div class="select-row">
          ...
          <select .value=${this._nth} @change=${r=>this._nth=r.target.value}>
            ${e.map(([r,h])=>a`<option value=${r} ?selected=${r===this._nth}>${h}</option>`)}
          </select>
        </div>
        <div class="select-row">
          <label>${s("recurrence_weekday",t)}</label>
          <select .value=${this._nthWeekday} @change=${r=>this._nthWeekday=r.target.value}>
            ${i.map((r,h)=>a`<option value=${String(h)} ?selected=${String(h)===this._nthWeekday}>${r}</option>`)}
          </select>
        </div>
      ...
      ></ms-textfield>`}_thresholdLimitsOverlap(){let t=parseFloat(this._triggerAbove),i=parseFloat(this._triggerBelow);return!isNaN(t)&&!isNaN(i)&&i>t}_renderTriggerLiveHint(){if(this._triggerType==="compound")return _;let t=this._triggerType==="threshold"&&this._thresholdLimitsOverlap()?a`<div class="trigger-live-hint warn">${s("trigger_hint_overlap",this._lang)}</div>`:_,i=this._triggerEntityId||this._triggerEntityIds[0];if(!i||!this.hass?.states)return t;let e=this.hass.states[i];if(!e)return t;let r=this._lang,h=e.attributes?.unit_of_measurement,c=typeof h=="string"&&h?` ${h}`:"",u=this._triggerAttribute?e.attributes?.[this._triggerAttribute]:e.state,p=typeof u=="number"?u:parseFloat(String(u)),v=u!=="unknown"&&u!=="unavailable"&&u!=null&&!isNaN(p),b=f=>Number.isInteger(f)?String(f):String(Math.round(f*10)/10),x=[];if(this._triggerType==="threshold"){let f=parseFloat(this._triggerAbove),w=parseFloat(this._triggerBelow);if(isNaN(f)&&isNaN(w))return _;v&&x.push(s("trigger_hint_now",r).replace("{value}",b(p)+c)),isNaN(f)||x.push(s("trigger_hint_above",r).replace("{target}",b(f)+c)),isNaN(w)||x.push(s("trigger_hint_below",r).replace("{target}",b(w)+c))}else if(this._triggerType==="counter"){let f=parseFloat(this._triggerTargetValue);if(isNaN(f))return _;this._triggerDeltaMode?this._taskId?x.push(s("trigger_hint_counter_delta_edit",r).replace("{target}",b(f)+c)):v?x.push(s("trigger_hint_counter_delta",r).replace("{value}",b(p)+c).replace("{due}",b(p+f)+c).replace("{target}",b(f)+c)):x.push(s("trigger_hint_counter_delta_edit",r).replace("{target}",b(f)+c)):(v&&x.push(s("trigger_hint_now",r).replace("{value}",b(p)+c)),x.push(s("trigger_hint_counter_abs",r).replace("{target}",b(f)+c)))}else if(this._triggerType==="runtime"){let f=parseFloat(this._triggerRuntimeHours);if(isNaN(f))return _;x.push(s("trigger_hint_runtime",r).replace("{hours}",b(f))),x.push(s("trigger_hint_state_now",r).replace("{value}",String(e.state)))}else if(this._triggerType==="state_change"){let f=parseInt(this._triggerTargetChanges,10)||1,w=this._triggerToState.trim();x.push((w?s("trigger_hint_state_change_to",r).replace("{state}",w):s("trigger_hint_state_change",r)).replace("{count}",String(f))),x.push(s("trigger_hint_state_now",r).replace("{value}",String(e.state)))}return x.length?a`<div class="trigger-live-hint">${x.join(" ")}</div>${t}`:t}_renderTriggerTypeFields(){let t=this._lang;return this._triggerType==="threshold"?a`
        <ms-textfield
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?a`<div class="used-parts">
                ...
                ${this.parts.map(i=>{let e=N({part_id:i.id,entry_id:i.entry_id}),r=this._usedParts[e],h=r!==void 0,c=i.entry_id?{part_id:i.id,quantity:1,entry_id:i.entry_id}:{part_id:i.id,quantity:1};return a`<div class="used-part-row">
  ...
  `],o([g({attribute:!1})],y.prototype,"hass",2),o([g()],y.prototype,"entryId",2),o([g()],y.prototype,"taskId",2),o([g()],y.prototype,"taskName",2),o([g()],y.prototype,"lang",2),o([g({type:Array})],y.prototype,"checklist",2),o([g({type:Boolean})],y.prototype,"adaptiveEnabled",2),o([g()],y.prototype,"taskType",2),o([g()],y.prototype,"readingUnit",2),o([g({attribute:!1})],y.prototype,"restockDefault",2),o([g({attribute:!1})],y.prototype,"restockUnitCost",2),o([g()],y.prototype,"currencySymbol",2),o([g({attribute:!1})],y.prototype,"parts",2),o([g({attribute:!1})],y.prototype,"consumesParts",2),o([g({type:Array})],y.prototype,"consumesInfo",2),o([g({type:Array})],y.prototype,"requiredFields",2),o([g()],y.prototype,"phaseLabel",2),o([g({type:Boolean})],y.prototype,"requireTagScan",2),o([g({type:Boolean})],y.prototype,"viaTagScan",2),o([d()],y.prototype,"_open",2),o([d()],y.prototype,"_notes",2),o([d()],y.prototype,"_cost",2),o([d()],y.prototype,"_duration",2),o([d()],y.prototype,"_loading",2),o([d()],y.prototype,"_error",2),o([d()],y.prototype,"_checklistState",2),o([d()],y.prototype,"_feedback",2),o([d()],y.prototype,"_photoDocId",2),o([d()],y.prototype,"_photoPreview",2),o([d()],y.prototype,"_photoUploading",2),o([d()],y.prototype,"_readingValue",2),o([d()],y.prototype,"_restockQty",2),o([d()],y.prototype,"_completedAt",2),o([d()],y.prototype,"_usedParts",2),o([g({attribute:!1})],y.prototype,"checklistPrefill",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",y);var C=class extends S{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null;this._partOptions=null;this._partQty={};this._partQtyOriginal=""}get _lang(){return A(this.hass)}openEdit(t){this._draft={...t},this._originalSnapshot={...t},this._error="",this._open=!0,this._partOptions=null,this._partQty={},this._partQtyOriginal="",this._loadPartOptions()}async _loadPartOptions(){let t=this._draft;if(t)try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"}),e=[];for(let h of i.parts||[]){let c=h.entry_id===t.entry_id,u=h.consumers.some(p=>p.entry_id===t.entry_id&&p.task_id===t.task_id);!c&&!u||e.push({part_id:h.part_id,name:h.name,entry_id:h.entry_id,foreign:!c,object_name:h.object_name})}for(let h of t.used_parts||[]){let c=h.entry_id||t.entry_id;e.some(u=>u.part_id===h.part_id&&u.entry_id===c)||e.push({part_id:h.part_id,name:h.name||h.part_id,entry_id:c,foreign:c!==t.entry_id,object_name:null})}let r={};for(let h of t.used_parts||[])r[`${h.entry_id||t.entry_id}:${h.part_id}`]=h.quantity??1;this._partOptions=e,this._partQty=r,this._partQtyOriginal=this._partSelectionKey()}catch{this._partOptions=[]}}_partSelectionKey(){return JSON.stringify(Object.entries(this._partQty).filter(([,t])=>t>0).sort(([t],[i])=>t.localeCompare(i)))}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null}_set(t,i){this._draft&&(this._draft={...this._draft,[t]:i})}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{let t={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(t.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(t.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(t.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(t.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(t.completed_by=this._draft.completed_by),this._partOptions!==null&&this._partSelectionKey()!==this._partQtyOriginal&&(t.used_parts=(this._partOptions||[]).filter(e=>(this._partQty[`${e.entry_id}:${e.part_id}`]||0)>0).map(e=>({part_id:e.part_id,quantity:this._partQty[`${e.entry_id}:${e.part_id}`],...e.foreign?{entry_id:e.entry_id}:{}}))),Object.keys(t).filter(e=>!["type","entry_id","task_id","original_timestamp"].includes(e)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(t),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=T(t,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return _;let t=this._lang,i=this._draft;return a`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ...
        <label>
          ...
          <input type="datetime-local"
            ...
            @change=${e=>{let r=e.target.value;this._set("timestamp",r.length===16?`${r}:00`:r)}} />
        </label>
        <label>
        ...
        ${this._partOptions&&this._partOptions.length>0?a`
          <div class="parts-block">
            ...
            ${this._partOptions.map(e=>{let r=`${e.entry_id}:${e.part_id}`,h=this._partQty[r]||0;return a`
    ...
    .part-qty { width: 76px; }
  `,o([g({attribute:!1})],C.prototype,"hass",2),o([d()],C.prototype,"_open",2),o([d()],C.prototype,"_saving",2),o([d()],C.prototype,"_error",2),o([d()],C.prototype,"_draft",2),o([d()],C.prototype,"_partOptions",2),o([d()],C.prototype,"_partQty",2);customElements.get("maintenance-history-edit-dialog")||customElements.define("maintenance-history-edit-dialog",C);function kt(n,l,t){let i=new Blob([n],{type:t}),e=URL.createObjectURL(i),r=document.createElement("a");r.href=e,r.download=l,r.target="_blank",r.rel="noopener",r.style.display="none",document.body.appendChild(r),r.dispatchEvent(new MouseEvent("click")),document.body.removeChild(r),setTimeout(()=>URL.revokeObjectURL(e),6e4)}function K(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function wt(n){return!n.startsWith("data:image/svg+xml,")&&!n.startsWith("data:image/png;base64,")?"":K(n)}function Xt(n){return n.replace(/[/\\:*?"<>|#%]+/g,"").replace(/\s+/g,"-").toLowerCase().substring(0,100)}var L=class extends S{constructor(){super(...arguments);this.lang="en";this._open=!1;this._loading=!1;this._error="";this._viewResult=null;this._completeResult=null;this._urlMode="companion";this._entryId="";this._taskId=null;this._objectName="";this._taskName="";this._generateSeq=0}openForObject(t,i){this._entryId=t,this._taskId=null,this._objectName=i,this._taskName="",this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}openForTask(t,i,e,r){this._entryId=t,this._taskId=i,this._objectName=e,this._taskName=r,this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}async _generate(){let t=++this._generateSeq;this._loading=!0,this._error="",this._viewResult=null,this._completeResult=null;try{let i={type:"maintenance_supporter/qr/generate",entry_id:this._entryId,url_mode:this._urlMode};this._taskId&&(i.task_id=this._taskId);let e=[this.hass.connection.sendMessagePromise({...i,action:"view"})];this._taskId&&e.push(this.hass.connection.sendMessagePromise({...i,action:"complete"}));let r=await Promise.all(e);if(t!==this._generateSeq)return;this._viewResult=r[0],r.length>1&&(this._completeResult=r[1])}catch(i){if(t!==this._generateSeq)return;let e=i?.code,r=i?.message;this._error=e==="no_url"||typeof r=="string"&&r.includes("No Home Assistant URL")?s("qr_error_no_url",this.lang):s("qr_error",this.lang)}finally{t===this._generateSeq&&(this._loading=!1)}}_setUrlMode(t){this._urlMode!==t&&(this._urlMode=t,this._generate())}_print(){if(!this._viewResult)return;let t=this._viewResult,i=t.label.task_name?`${t.label.object_name} \u2014 ${t.label.task_name}`:t.label.object_name,e=[t.label.manufacturer,t.label.model].filter(Boolean).join(" "),r=window.open("","_blank","width=600,height=500");if(!r)return;let h=this.lang||"en",c=K(i),u=K(e),p=!!this._completeResult,v=K(s("qr_action_view",h)),b=K(s("qr_action_complete",h));r.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8">
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,o([g({attribute:!1})],L.prototype,"hass",2),o([g()],L.prototype,"lang",2),o([d()],L.prototype,"_open",2),o([d()],L.prototype,"_loading",2),o([d()],L.prototype,"_error",2),o([d()],L.prototype,"_viewResult",2),o([d()],L.prototype,"_completeResult",2),o([d()],L.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",L);function Et(n){let l=n.getFullYear(),t=String(n.getMonth()+1).padStart(2,"0"),i=String(n.getDate()).padStart(2,"0");return`${l}-${t}-${i}`}function te(n,l){if(l<=0)return 0;let t=typeof n=="number"&&Number.isFinite(n)?Math.trunc(n):0;return t<0?0:t%l}function ee(n){return!!(n?.phases&&n.phase_sequence&&n.phase_sequence.length>0)}function nt(n){if(!n||!ee(n))return null;let l=n.phase_sequence,t=te(n.phase_cursor,l.length),i=l[t],e=n.phases?.[i];return e?{id:i,name:e.name,index:t,count:l.length,notes:e.notes,checklist:e.checklist!==void 0?e.checklist:n.checklist??[],consumesParts:e.consumes_parts!==void 0?e.consumes_parts:n.consumes_parts??[],requiredFields:e.required_completion_fields!==void 0?e.required_completion_fields:n.required_completion_fields??[]}:null}function Y(n){let l=nt(n);return l?`${l.index+1}/${l.count} \xB7 ${l.name}`:""}function It(n){let l=n.task??null,t=l?nt(l):null,i=t?t.consumesParts:l?.consumes_parts||[],e=!!l?.part_ref,r=n.objects.find(u=>u.entry_id===n.entryId)?.parts||[],h=e?r.find(u=>u.id===l.part_ref.part_id):void 0,c=n.checklistsEnabled??!0;return{entry_id:n.entryId,task_id:n.taskId,task_name:n.taskName,checklist:t?c?t.checklist:[]:n.checklist??[],adaptive_enabled:!!n.adaptiveEnabled,required_completion_fields:t?t.requiredFields:l?.required_completion_fields||[],task_type:l?.type||"",reading_unit:l?.reading_unit||"",parts:e?[]:yt({consumes_parts:i},n.entryId,n.objects,n.lang),consumes_parts:e?[]:i,phase_label:t?Y(l):"",require_tag_scan:!!l?.require_tag_scan,restock_default:e?h?.restock_quantity??1:null,restock_unit_cost:e?h?.cost??null:null,currency_symbol:n.currencySymbol??"",consumes_info:i.map(u=>ft(u,n.entryId,n.objects,n.lang)),checklist_prefill:l?.checklist_progress||{},via_tag_scan:!!n.viaTagScan}}function St(n,l,t){n.entryId=l.entry_id,n.taskId=l.task_id,n.taskName=l.task_name,n.lang=t,n.checklist=l.checklist??[],n.adaptiveEnabled=!!l.adaptive_enabled,n.requiredFields=l.required_completion_fields??[],n.taskType=l.task_type??"",n.readingUnit=l.reading_unit??"",n.parts=l.parts??[],n.consumesParts=l.consumes_parts??[],n.phaseLabel=l.phase_label??"",n.requireTagScan=!!l.require_tag_scan,n.restockDefault=l.restock_default??null,n.restockUnitCost=l.restock_unit_cost??null,n.currencySymbol=l.currency_symbol??"",n.consumesInfo=l.consumes_info??[],n.checklistPrefill=l.checklist_prefill??{},n.viaTagScan=!!l.via_tag_scan,n.open({viaTagScan:!!l.via_tag_scan})}function Tt(n,l){let t=n.interval_analysis,i=t?.weibull_beta,e=t?.weibull_eta;if(i==null||e==null||e<=0)return _;let r=n.interval_days??0,h=n.suggested_interval??r;return a`
  ...
  `}function ne(n,l,t){let i=n.confidence_interval_low,e=n.confidence_interval_high,r=l.suggested_interval??l.interval_days??0,h=l.interval_days??0,c=Math.max(0,i-5),p=e+5-c,v=(i-c)/p*100,b=(e-i)/p*100,x=(r-c)/p*100,f=h>0?(h-c)/p*100:-1;return a`
    <div class="confidence-range">
      ...
      <div class="confidence-bar">
        ...
        ${f>=0?a`<div class="confidence-marker current" style="left:${f.toFixed(1)}%"></div>`:_}
  ...
  `}function At(n,l,t){let i=n.degradation_trend!=null&&n.degradation_trend!=="insufficient_data",e=n.days_until_threshold!=null,r=n.environmental_factor!=null&&n.environmental_factor!==1;if(!i&&!e&&!r)return _;let h=n.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":n.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return a`
      ...
      <div class="prediction-grid">
        ${i?a`
          <div class="prediction-item">
            ...
            ${n.degradation_rate!=null?a`<span class="prediction-rate">${n.degradation_rate>0?"+":""}${Math.abs(n.degradation_rate)>=10?Math.round(n.degradation_rate).toLocaleString():n.degradation_rate.toFixed(1)} ${n.trigger_entity_info?.unit_of_measurement||""}/${s("day_short",l)}</span>`:_}
          </div>
        `:_}
        ${e?a`
          <div class="prediction-item">
            ...
            ${n.threshold_prediction_date?a`<span class="prediction-date">${V(n.threshold_prediction_date,l)}</span>`:_}
        ...
        ${r&&t.environmental?a`
          <div class="prediction-item">
            ...
            ${n.environmental_entity?a`<span class="prediction-entity entity-link" @click=${c=>_t(c,n.environmental_entity)}>${n.environmental_entity}</span>`:_}
          </div>
        `:_}
      </div>
    </div>
  `}function Lt(n,l,t,i){let e=Math.max(n||1,l);return a`
  ...
  `}var Pt=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function qt(n,l,t){if(!t.seasonal||!n.seasonal_factor||n.seasonal_factor===1)return _;let i=Pt.map(c=>s(c,l)),e=new Date().getMonth(),r=n.seasonal_factors||n.interval_analysis?.seasonal_factors||null,h=r&&r.length===12?r:i.map((c,u)=>{let p=n.seasonal_factor||1,v=Math.sin((u-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,p+v))});return a`
    <div class="seasonal-card-compact">
      <h4>${s("seasonal_awareness",l)}</h4>
      <div class="seasonal-mini-chart">
        ${h.map((c,u)=>{let p=c*40,v=c<.9?"low":c>1.1?"high":"normal";return a`
  ...
  `}function Ct(n,l){return ae(n,l)}function ae(n,l){let t=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return _;let i=n.interval_analysis?.seasonal_reason,e=new Date().getMonth(),r=300,h=100,c=8,p=h-c-4,v=Math.max(...t,1.5),b=r/12,x=b*.65,f=c+p-1/v*p;return a`
  ...
  `}var k=class extends S{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return A(this.hass)}async openFor(t,i){this._entryId=t,this._taskId=i,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=Et(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._currencySymbol=t?.budget?.currency_symbol||"",this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let i=(t.tasks||[]).find(e=>e.id===this._taskId);this._task=i??null}catch(t){this._error=T(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(i){return this._error=T(i,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-J3WVTPRK.js").then(async({openCompleteDialog:t})=>{let i=this._task,e=[];try{e=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}t(It({entryId:this._entryId,taskId:this._taskId,taskName:i.name,task:i,objects:e,lang:this._lang,checklist:i.checklist||[],adaptiveEnabled:!!i.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-J3WVTPRK.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-J3WVTPRK.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=s("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=s("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${s("reanalyze_result",this._lang)||"Recomputed"}: ${ht(t.recommended_interval,"days",this._lang)} (${t.data_points} pts)`:s("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=T(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-J3WVTPRK.js").then(({openHistoryEditDialog:i})=>{i({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null,used_parts:t.used_parts??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return _;let i=this._lang;return a`
    ...
    `}_renderDetails(t){let i=this._lang,e=t.history||[],r=e.filter(u=>u.type==="completed"),h=r.reduce((u,p)=>u+(typeof p.cost=="number"?p.cost:0),0),c=(()=>{let u=r.map(p=>typeof p.duration=="number"?p.duration:null).filter(p=>p!=null);return u.length?Math.round(u.reduce((p,v)=>p+v,0)/u.length):null})();return a`
      <div class="details">
        ...
        ${e.length===0?a`<div class="history-empty">${s("history_empty",i)||"No history yet."}</div>`:a`
              <div class="history-list">
                ${[...e].reverse().slice(0,20).map(u=>{let p=["completed","reset","skipped"].includes(u.type);return a`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${u.type}">${s(u.type,i)}</span>
                        <span class="history-date">${pt(u.timestamp,i)}</span>
                        ${p?a`<button class="history-edit"
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${i?a`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-J3WVTPRK.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
  ...
  `],o([g({attribute:!1})],k.prototype,"hass",2),o([d()],k.prototype,"_open",2),o([d()],k.prototype,"_entryId",2),o([d()],k.prototype,"_taskId",2),o([d()],k.prototype,"_task",2),o([d()],k.prototype,"_objectName",2),o([d()],k.prototype,"_busy",2),o([d()],k.prototype,"_error",2),o([d()],k.prototype,"_showSkip",2),o([d()],k.prototype,"_showReset",2),o([d()],k.prototype,"_showDetails",2),o([d()],k.prototype,"_showAdaptive",2),o([d()],k.prototype,"_skipReason",2),o([d()],k.prototype,"_resetDate",2),o([d()],k.prototype,"_features",2),o([d()],k.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",k);function Ht(n){return!!n&&/^https?:\/\//i.test(n)}function Rt(n){return n?customElements.get("ha-markdown")?a`<ha-markdown class="notes-md" .content=${n} breaks></ha-markdown>`:a`${n}`:_}var M=class extends S{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return A(this.hass)}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=T(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-J3WVTPRK.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-J3WVTPRK.js").then(({openCreateTaskDialog:t})=>{t(this._entryId),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=s("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(i){this._error=T(i,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let i=s("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(i))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(i){this._error=T(i,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-J3WVTPRK.js").then(({openTaskQuickActions:i})=>{i(this._entryId,t)})}render(){if(!this._open)return _;let t=this._lang,i=this._data,e=i?.object,r=i?.tasks||[],h=this.hass?.user?.is_admin??!0;return a`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${i&&e?a`
              <div class="header">
      ...
      <div class="meta">
        ${e.map(([r,h])=>a`
            <div class="meta-item">
              ...
              <span class="meta-value">${Ht(h)?a`<a href="${h}" target="_blank" rel="noopener noreferrer">${h}</a>`:h}</span>
            </div>
          `)}
      </div>
    `}};M.styles=I`
  ...
  `,o([g({attribute:!1})],M.prototype,"hass",2),o([d()],M.prototype,"_open",2),o([d()],M.prototype,"_entryId",2),o([d()],M.prototype,"_data",2),o([d()],M.prototype,"_busy",2),o([d()],M.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",M);var Nt="maintenance-object-dialog",Mt="maintenance-task-dialog",oe="maintenance-history-edit-dialog",le="maintenance-complete-dialog",de="maintenance-qr-dialog",ce="maintenance-task-quick-actions-dialog",pe="maintenance-object-quick-actions-dialog";function X(){return document.querySelector("home-assistant")?.hass}function he(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function j(n){let l=he(),t=l.querySelector(n)??document.body.querySelector(n);return t?t.parentNode!==l&&l.appendChild(t):(t=document.createElement(n),l.appendChild(t)),t}function D(n){let l=X();if(!l)return!1;n.hass=l;let t=A(l);return dt(t)||ct(t).then(()=>{n.requestUpdate?.()}),!0}var at={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"};function as(n){return ot(n).then(l=>l.rowActionStyle)}function os(){G=null}var G=null;function ot(n){return G||(G=n.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(l=>({features:l.features??at.features,defaultWarningDays:l.general?.default_warning_days??7,rowActionStyle:l.general?.row_action_style??at.rowActionStyle})).catch(()=>at),G)}function ls(){let n=j(Nt);return D(n)?(n.openCreate(),!0):!1}function ds(n,l){let t=j(Nt);return D(t)?(t.openEdit(n,l),!0):!1}function cs(n="",l){let t=j(Mt);if(!D(t))return!1;let i=X();return i?((async()=>{let e=await ot(i),r=t;r.checklistsEnabled=e.features.checklists,r.scheduleTimeEnabled=e.features.schedule_time,r.completionActionsEnabled=e.features.completion_actions,r.defaultWarningDays=e.defaultWarningDays,r.openCreate(n,l)})(),!0):!1}function ps(n,l){let t=j(Mt);if(!D(t))return!1;let i=X();return i?((async()=>{try{let[e,r]=await Promise.all([i.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:n}),ot(i)]),h=(e.tasks||[]).find(u=>u.id===l);if(!h){console.warn(`openEditTaskDialog: task ${l} not found in entry ${n}`);return}let c=t;c.checklistsEnabled=r.features.checklists,c.scheduleTimeEnabled=r.features.schedule_time,c.completionActionsEnabled=r.features.completion_actions,c.defaultWarningDays=r.defaultWarningDays,await c.openEdit(n,h)}catch(e){console.warn("openEditTaskDialog: failed to load task/features",e)}})(),!0):!1}function hs(n){let l=j(oe);return D(l)?(l.openEdit(n),!0):!1}function us(n){let l=j(le);return D(l)?(St(l,n,X()?.language||"en"),!0):!1}function _s(n){let l=j(de);return D(l)?(l.openForTask(n.entry_id,n.task_id,n.object_name,n.task_name),!0):!1}function ms(n,l){let t=j(ce);return D(t)?(t.openFor(n,l),!0):!1}function gs(n){let l=j(pe);return D(l)?(l.openFor(n),!0):!1}export{os as __resetSettingsCacheForTests,as as getRowActionStyle,us as openCompleteDialog,ls as openCreateObjectDialog,cs as openCreateTaskDialog,ds as openEditObjectDialog,ps as openEditTaskDialog,hs as openHistoryEditDialog,gs as openObjectQuickActions,_s as openQrDialog,ms as openTaskQuickActions};
