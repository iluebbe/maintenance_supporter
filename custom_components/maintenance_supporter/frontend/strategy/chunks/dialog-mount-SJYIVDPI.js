...
import{a as wt,b as Et,c as It,d as St,e as Tt,f as At,g as Ct,h as Pt,i as Lt}from"./chunk-BQGI2CWQ.js";import"./chunk-FNOMAMYM.js";import{A as Ut,B as T,a as w,b as a,c as Z,d as p,e as E,f,g as c,h as et,i as s,k as P,l as Rt,m as qt,n as Ht,o as Nt,p as A,q as J,r as G,s as Ot,t as Mt,u as nt,v as ht,w as Ft,x as Dt,y as jt,z as zt}from"./chunk-W3UJE5Z4.js";import{a as l,b as rt,c as kt}from"./chunk-X3MNTGFX.js";var C=class extends E{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(t){let i=t.target.value;this.value=i,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:i}}))}render(){return a`
      <label class="field">
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Oe.map(e=>a`<option value=${e} ?selected=${e===this._priority}>${s("priority_"+e,t)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${Me.map(e=>a`<option value=${e} ?selected=${e===this._scheduleType}>${s(e,t)}</option>`)}
            </select>
          </div>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,l([f({attribute:!1})],q.prototype,"hass",2),l([f()],q.prototype,"lang",2),l([c()],q.prototype,"_open",2),l([c()],q.prototype,"_loading",2),l([c()],q.prototype,"_error",2),l([c()],q.prototype,"_viewResult",2),l([c()],q.prototype,"_completeResult",2),l([c()],q.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",q);function oe(r){let o=r.getFullYear(),t=String(r.getMonth()+1).padStart(2,"0"),i=String(r.getDate()).padStart(2,"0");return`${o}-${t}-${i}`}function Ze(r,o){if(o<=0)return 0;let t=typeof r=="number"&&Number.isFinite(r)?Math.trunc(r):0;return t<0?0:t%o}function Je(r){return!!(r?.phases&&r.phase_sequence&&r.phase_sequence.length>0)}function bt(r){if(!r||!Je(r))return null;let o=r.phase_sequence,t=Ze(r.phase_cursor,o.length),i=o[t],e=r.phases?.[i];return e?{id:i,name:e.name,index:t,count:o.length,notes:e.notes,checklist:e.checklist!==void 0?e.checklist:r.checklist??[],consumesParts:e.consumes_parts!==void 0?e.consumes_parts:r.consumes_parts??[],requiredFields:e.required_completion_fields!==void 0?e.required_completion_fields:r.required_completion_fields??[]}:null}function st(r){let o=bt(r);return o?`${o.index+1}/${o.count} \xB7 ${o.name}`:""}function le(r){let o=r.task??null,t=o?bt(o):null,i=t?t.consumesParts:o?.consumes_parts||[],e=!!o?.part_ref,n=r.objects.find(u=>u.entry_id===r.entryId)?.parts||[],d=e?n.find(u=>u.id===o.part_ref.part_id):void 0,_=r.checklistsEnabled??!0;return{entry_id:r.entryId,task_id:r.taskId,task_name:r.taskName,checklist:t?_?t.checklist:[]:r.checklist??[],adaptive_enabled:!!r.adaptiveEnabled,required_completion_fields:t?t.requiredFields:o?.required_completion_fields||[],task_type:o?.type||"",reading_unit:o?.reading_unit||"",readings:o?.readings||[],reading_history:St(o?.history),parts:e?[]:Yt({consumes_parts:i},r.entryId,r.objects,r.lang),consumes_parts:e?[]:i,phase_label:t?st(o):"",require_tag_scan:!!o?.require_tag_scan,restock_default:e?d?.restock_quantity??1:null,restock_unit_cost:e?d?.cost??null:null,currency_symbol:et({currency_symbol:r.currencySymbol}),consumes_info:i.map(u=>Kt(u,r.entryId,r.objects,r.lang)),checklist_prefill:o?.checklist_progress||{},via_tag_scan:!!r.viaTagScan}}function de(r,o,t){r.entryId=o.entry_id,r.taskId=o.task_id,r.taskName=o.task_name,r.lang=t,r.checklist=o.checklist??[],r.adaptiveEnabled=!!o.adaptive_enabled,r.requiredFields=o.required_completion_fields??[],r.taskType=o.task_type??"",r.readingUnit=o.reading_unit??"",r.readings=o.readings??[],r.readingHistory=o.reading_history??[],r.parts=o.parts??[],r.consumesParts=o.consumes_parts??[],r.phaseLabel=o.phase_label??"",r.requireTagScan=!!o.require_tag_scan,r.restockDefault=o.restock_default??null,r.restockUnitCost=o.restock_unit_cost??null,r.currencySymbol=et(o),r.consumesInfo=o.consumes_info??[],r.checklistPrefill=o.checklist_prefill??{},r.viaTagScan=!!o.via_tag_scan,r.open({viaTagScan:!!o.via_tag_scan})}var ce=r=>typeof r=="number"&&Number.isInteger(r)&&r>0;function Xe(r){return r&&ce(r.ref_no)?String(r.ref_no):null}function pe(r,o){let t=Xe(r);return t&&o&&ce(o.ref_no)?`${t}.${o.ref_no}`:null}function he(r,o){return r?a`<span class="ref-chip" title=${o??""}>#${r}</span>`:p}var ti=["completed","reset","skipped"];function ei(r,o){return r.taskRef&&o.ref_no?`${r.taskRef}-${o.ref_no}`:null}function ii(r,o){let t=wt(o);return t.length>0?a`<div class="history-photos">
    ...
    <div class="history-entry${e?" compact":""}">
      ...
      <div class="history-content">
        ...
        <div class="history-date">${Ot(r.timestamp,i)}</div>
  ...
  `}function ni(r,o,t,i,e){let y=Math.max(t,i,o,1)*1.3,$=50,H=[];for(let N=0;N<=$;N++){let M=N/$*y,Te=1-Math.exp(-Math.pow(M/o,r)),Ae=32+M/y*260,Ce=136-Te*128;H.push([Ae,Ce])}let W=H.map(([N,M])=>`${k(N)},${k(M)}`).join(" "),Y="M32,136 "+H.map(([N,M])=>`L${k(N)},${k(M)}`).join(" ")+` L${k(H[$][0])},136 Z`,O=32+t/y*260,z=1-Math.exp(-Math.pow(t/o,r)),Q=136-z*128,Ie=A((1-z)*100,e,0),xt=32+i/y*260,Se=[0,.25,.5,.75,1];return a`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",e)}">
        ${Se.map(N=>{let M=136-N*128;return Z`
            <line x1="${32}" y1="${k(M)}" x2="${292}" y2="${k(M)}"
              stroke="var(--divider-color)" stroke-width="0.5" stroke-dasharray="${N===.5?"4,3":p}" />
            <text x="${28}" y="${k(M+3)}" fill="var(--secondary-text-color)"
        ...
        ${t>0?Z`
          ...
          <circle cx="${k(O)}" cy="${k(Q)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${k(O+4)}" y="${k(Q-6)}" fill="var(--primary-color, #03a9f4)"
  ...
  `}function ye(r,o){return li(r,o)}function li(r,o){let t=r.seasonal_factors??r.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return p;let i=r.interval_analysis?.seasonal_reason,e=new Date().getMonth(),n=300,d=100,_=8,h=d-_-4,g=Math.max(...t,1.5),v=n/12,x=v*.65,y=_+h-1/g*h;return a`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${n} ${d}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",o)}">
        ...
        ${t.map(($,H)=>{let W=$/g*h,Y=H*v+(v-x)/2,O=_+h-W,z=H===e,Q=$<1?"var(--success-color, #4caf50)":$>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return Z`
            <rect x="${k(Y)}" y="${k(O)}"
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${i?a`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-SJYIVDPI.js").then(({openObjectQuickActions:n})=>{n(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
