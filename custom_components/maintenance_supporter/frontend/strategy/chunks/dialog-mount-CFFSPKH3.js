import{a,b as x,c as r,d as M,e as d,f as $,g as m,h as l,i as V,j as i,k as U,l as Y,m as J,n as X,o as Q,p as tt,q as k}from"./chunk-RYJMPUAA.js";var w=class extends ${constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1}_onInput(t){let e=t.target.value;this.value=e,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:e}}))}render(){return r`
      <label class="field">
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),o.document.close()}_downloadSvg(t,e){let s=decodeURIComponent(t.svg_data_uri.replace("data:image/svg+xml,","")),o=new Blob([s],{type:"image/svg+xml"}),_=URL.createObjectURL(o),h=document.createElement("a");h.href=_;let p=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;h.download=`qr-${$t(p)}-${e}.svg`,h.click(),URL.revokeObjectURL(_)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return r``;let t=this.lang||this.hass?.language||"en",e=this._taskName?`${i("qr_code",t)}: ${this._objectName} \u2014 ${this._taskName}`:`${i("qr_code",t)}: ${this._objectName}`,s=!!this._viewResult;return r`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${e}</div>
        <div class="content">
  ...
  `}function Et(n,c){return r`
    <div class="weibull-info-row">
      <div class="weibull-info-item">
        <span>${i("characteristic_life",c)}</span>
        <span class="weibull-info-value">${Math.round(n.weibull_eta)} ${i("days",c)}</span>
      </div>
      ${n.weibull_r_squared!=null?r`
        <div class="weibull-info-item">
          <span>${i("weibull_r_squared",c)}</span>
          <span class="weibull-info-value">${n.weibull_r_squared.toFixed(3)}</span>
        </div>
      `:d}
    </div>
  `}function It(n,c,t){let e=n.confidence_interval_low,s=n.confidence_interval_high,o=c.suggested_interval??c.interval_days??0,_=c.interval_days??0,h=Math.max(0,e-5),g=s+5-h,b=(e-h)/g*100,E=(s-e)/g*100,P=(o-h)/g*100,I=_>0?(_-h)/g*100:-1;return r`
  ...
  `}function st(n,c,t){let e=n.degradation_trend!=null&&n.degradation_trend!=="insufficient_data",s=n.days_until_threshold!=null,o=n.environmental_factor!=null&&n.environmental_factor!==1;if(!e&&!s&&!o)return d;let _=n.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":n.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return r`
    <div class="prediction-section">
      ${n.sensor_prediction_urgency?r`
        <div class="prediction-urgency-banner">
          <ha-svg-icon path="M1,21H23L12,2L1,21M12,18A1,1 0 0,1 11,17A1,1 0 0,1 12,16A1,1 0 0,1 13,17A1,1 0 0,1 12,18M13,15H11V10H13V15Z"></ha-svg-icon>
          ${i("sensor_prediction_urgency",c).replace("{days}",String(Math.round(n.days_until_threshold||0)))}
        </div>
      `:d}
      <div class="prediction-title">
        <ha-svg-icon path="M2,2V4H7V2H2M22,2V4H13V2H22M7,7V9H2V7H7M22,7V9H13V7H22M7,12V14H2V12H7M22,12V14H13V12H22M7,17V19H2V17H7M22,17V19H13V17H22M9,2V19L12,22L15,19V2H9M11,4H13V17.17L12,18.17L11,17.17V4Z"></ha-svg-icon>
        ${i("sensor_prediction",c)}
      </div>
      <div class="prediction-grid">
        ${e?r`
          <div class="prediction-item">
            <ha-svg-icon path="${_}"></ha-svg-icon>
            <span class="prediction-label">${i("degradation_trend",c)}</span>
            <span class="prediction-value ${n.degradation_trend}">${i("trend_"+n.degradation_trend,c)}</span>
            ${n.degradation_rate!=null?r`<span class="prediction-rate">${n.degradation_rate>0?"+":""}${Math.abs(n.degradation_rate)>=10?Math.round(n.degradation_rate).toLocaleString():n.degradation_rate.toFixed(1)} ${n.trigger_entity_info?.unit_of_measurement||""}/${i("day_short",c)}</span>`:d}
          </div>
        `:d}
        ${s?r`
          <div class="prediction-item">
            <ha-svg-icon path="M12,20A7,7 0 0,1 5,13A7,7 0 0,1 12,6A7,7 0 0,1 19,13A7,7 0 0,1 12,20M12,4A9,9 0 0,0 3,13A9,9 0 0,0 12,22A9,9 0 0,0 21,13A9,9 0 0,0 12,4M12.5,8H11V14L15.75,16.85L16.5,15.62L12.5,13.25V8M7.88,3.39L6.6,1.86L2,5.71L3.29,7.24L7.88,3.39M22,5.72L17.4,1.86L16.11,3.39L20.71,7.25L22,5.72Z"></ha-svg-icon>
            <span class="prediction-label">${i("days_until_threshold",c)}</span>
            <span class="prediction-value prediction-days${n.days_until_threshold===0?" exceeded":n.sensor_prediction_urgency?" urgent":""}">${n.days_until_threshold===0?i("threshold_exceeded",c):"~"+Math.round(n.days_until_threshold)+" "+i("days",c)}</span>
            ${n.threshold_prediction_date?r`<span class="prediction-date">${U(n.threshold_prediction_date,c)}</span>`:d}
        ...
        ${o&&t.environmental?r`
          <div class="prediction-item">
            ...
            <span class="prediction-label">${i("environmental_adjustment",c)}</span>
  ...
  `}function at(n,c,t,e){let s=Math.max(n||1,c);return r`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?r`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-CFFSPKH3.js").then(({openObjectQuickActions:o})=>{o(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
  ...
  `,a([m({attribute:!1})],H.prototype,"hass",2),a([l()],H.prototype,"_open",2),a([l()],H.prototype,"_entryId",2),a([l()],H.prototype,"_data",2),a([l()],H.prototype,"_busy",2),a([l()],H.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",H);var ct="maintenance-object-dialog",dt="maintenance-task-dialog",Tt="maintenance-history-edit-dialog",Lt="maintenance-complete-dialog",Ht="maintenance-qr-dialog",St="maintenance-task-quick-actions-dialog",Ct="maintenance-object-quick-actions-dialog";function G(){return document.querySelector("home-assistant")?.hass}function q(n){let c=document.body.querySelector(n);return c||(c=document.createElement(n),document.body.appendChild(c)),c}function z(n){let c=G();return c?(n.hass=c,!0):!1}var lt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},B=null;function pt(n){return B||(B=n.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(c=>({features:c.features??lt.features,defaultWarningDays:c.general?.default_warning_days??7})).catch(()=>lt),B)}function Je(){let n=q(ct);return z(n)?(n.openCreate(),!0):!1}function Xe(n,c){let t=q(ct);return z(t)?(t.openEdit(n,c),!0):!1}function Qe(){let n=q(dt);if(!z(n))return!1;let c=G();return c?((async()=>{let t=await pt(c),e=n;e.checklistsEnabled=t.features.checklists,e.scheduleTimeEnabled=t.features.schedule_time,e.completionActionsEnabled=t.features.completion_actions,e.defaultWarningDays=t.defaultWarningDays,e.openCreate()})(),!0):!1}function ti(n,c){let t=q(dt);if(!z(t))return!1;let e=G();return e?((async()=>{try{let[s,o]=await Promise.all([e.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:n}),pt(e)]),_=(s.tasks||[]).find(p=>p.id===c);if(!_){console.warn(`openEditTaskDialog: task ${c} not found in entry ${n}`);return}let h=t;h.checklistsEnabled=o.features.checklists,h.scheduleTimeEnabled=o.features.schedule_time,h.completionActionsEnabled=o.features.completion_actions,h.defaultWarningDays=o.defaultWarningDays,await h.openEdit(n,_)}catch(s){console.warn("openEditTaskDialog: failed to load task/features",s)}})(),!0):!1}function ei(n){let c=q(Tt);return z(c)?(c.openEdit(n),!0):!1}function ii(n){let c=q(Lt);return z(c)?(c.entryId=n.entry_id,c.taskId=n.task_id,c.taskName=n.task_name,c.checklist=n.checklist??[],c.adaptiveEnabled=!!n.adaptive_enabled,c.lang=G()?.language||"en",c.open(),!0):!1}function si(n){let c=q(Ht);return z(c)?(c.openForTask(n.entry_id,n.task_id,n.object_name,n.task_name),!0):!1}function ai(n,c){let t=q(St);return z(t)?(t.openFor(n,c),!0):!1}function ri(n){let c=q(Ct);return z(c)?(c.openFor(n),!0):!1}export{ii as openCompleteDialog,Je as openCreateObjectDialog,Qe as openCreateTaskDialog,Xe as openEditObjectDialog,ti as openEditTaskDialog,ei as openHistoryEditDialog,ri as openObjectQuickActions,si as openQrDialog,ai as openTaskQuickActions};
