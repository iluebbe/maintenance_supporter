...
import{a as kt,b as wt,c as Et,d as It,e as St,f as Tt,g as At,h as Ct,i as Pt}from"./chunk-NKXHANLV.js";import"./chunk-NVGOKD4D.js";import{A as zt,B as T,a as w,b as a,c as Z,d as p,e as E,f as v,g as c,h as et,i as s,k as P,l as Lt,m as Rt,n as qt,o as Ht,p as A,q as J,r as G,s as Nt,t as Mt,u as nt,v as ht,w as Ot,x as Ft,y as Dt,z as jt}from"./chunk-PYDACOG4.js";import{a as l,b as rt,c as xt}from"./chunk-62AO4XFY.js";var C=class extends E{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(t){let i=t.target.value;this.value=i,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:i}}))}render(){return a`
      <label class="field">
...
`),partId:M?.part_id||"",partQty:M?.quantity!=null?String(M.quantity):"",reqOverride:g.required_completion_fields!==void 0,reqFields:[...g.required_completion_fields||[]],extraParts:W.filter((z,Q)=>Q!==Y).map(z=>({...z})),carry:H}}),this._phaseSeq=[...i.phase_sequence||[]],this._requiredCompletion=[...i.required_completion_fields||[]],this._scheduleTime=i.schedule_time||"",this._scheduleTimeOn=!!i.schedule_time;let d=i.on_complete_action;if(d&&d.service){this._actionService=d.service;let h=d.target?.entity_id;this._actionTargetEntity=Array.isArray(h)?h[0]||"":h||"",this._actionData=d.data&&typeof d.data=="object"?{...d.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let _=i.quick_complete_defaults;this._qcNotes=_?.notes||"",this._qcCost=_?.cost!=null?String(_.cost):"",this._qcDuration=_?.duration!=null?String(_.duration):"",this._qcFeedback=_?.feedback||"";let u=i.adaptive_config||{};if(this._environmentalEntity=u.environmental_entity||"",this._environmentalAttribute=u.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,this._adaptiveEnabled=!!u.enabled,this._adaptiveAlpha=u.ewa_alpha?.toString()??U.alpha,this._adaptiveMin=u.min_interval_days?.toString()??U.min,this._adaptiveMax=u.max_interval_days?.toString()??U.max,this._adaptiveSeasonal=u.seasonal_enabled!==!1,this._adaptivePrediction=u.sensor_prediction_enabled!==!1,this._adaptiveInitial=this._adaptiveSnapshot(),i.trigger_config){let h=i.trigger_config;this._triggerEntityId=h.entity_id||h.entity_ids&&h.entity_ids[0]||"",this._triggerEntityIds=h.entity_ids||(h.entity_id?[h.entity_id]:[]),this._triggerEntityLogic=h.entity_logic||"any",this._triggerAttribute=h.attribute||"",this._triggerType=h.type||"threshold",this._triggerAbove=h.trigger_above?.toString()||"",this._triggerBelow=h.trigger_below?.toString()||"",this._triggerEquals=h.trigger_equals?.toString()||"",this._triggerNotEquals=h.trigger_not_equals?.toString()||"",this._triggerForMinutes=h.trigger_for_minutes?.toString()||"0",this._triggerCombinator=h.trigger_combinator==="all"?"all":"any",this._triggerTargetValue=h.trigger_target_value?.toString()||"",this._triggerDeltaMode=h.trigger_delta_mode||!1,this._triggerBaselineValue=h.trigger_baseline_value?.toString()||"",this._liveBaselineValue=i.trigger_baseline_value??null,this._autoCompleteOnRecovery=h.auto_complete_on_recovery||!1,this._triggerFromState=h.trigger_from_state||"",this._triggerToState=h.trigger_to_state||"",this._triggerTargetChanges=h.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=h.trigger_runtime_hours?.toString()||"",this._triggerRuntimeMaxSession=h.trigger_runtime_max_session_seconds?.toString()||"",this._triggerOnStates=(h.trigger_on_states||[]).join(", "),h.type==="compound"?(this._compoundLogic=h.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(h.conditions||[]).map(Fe)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._mirrorTodoEntities=[],this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._requireTagScan=!1,this._allowSkip=!0,this._readingUnit="",this._readings=[],this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._phaseDefs=[],this._phaseSeq=[],this._requiredCompletion=[],this._scheduleTime="",this._scheduleTimeOn=!1,this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._adaptiveEnabled=!1,this._adaptiveAlpha=U.alpha,this._adaptiveMin=U.min,this._adaptiveMax=U.max,this._adaptiveSeasonal=!0,this._adaptivePrediction=!0,this._adaptiveInitial=this._adaptiveSnapshot(),this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerEquals="",this._triggerNotEquals="",this._triggerForMinutes="0",this._triggerCombinator="any",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerRuntimeMaxSession="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new at(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(t){console.error("Failed to load users:",t),this._availableUsers=[]}}_toggleAssignee(t){this._assigneePool=this._assigneePool.includes(t)?this._assigneePool.filter(i=>i!==t):[...this._assigneePool,t]}async _testAction(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[i,e]=t.split(".");if(!this.hass?.services?.[i]?.[e]){this._actionTestResult="error",this._actionTestError=`Service "${t}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let n=this._actionTargetEntity.trim();if(n){let d=n.split(".")[0];if(d!==i&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(i)){this._actionTestResult="error",this._actionTestError=`Service "${t}" only works on ${i}.* entities; entity "${n}" is in ${d}.* \u2014 pick a service that matches the entity domain (e.g. ${d}.${e})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[n]){this._actionTestResult="error",this._actionTestError=`Target entity "${n}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let t=JSON.parse(this._actionDataJsonFallback);if(t&&typeof t=="object"&&!Array.isArray(t))return t}catch{}return{...this._actionData}}_serviceSchema(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t))return null;let[i,e]=t.split("."),n=this.hass?.services?.[i]?.[e]?.fields;return!n||Object.keys(n).length===0?null:Object.entries(n).map(([d,_])=>({name:d,required:!!_.required,selector:_.selector||{text:{}}}))}_renderCompletionActionsSection(t){if(!this.completionActionsEnabled)return p;let i=this._serviceSchema();return a`
    ...
    `}_toggleRequired(t,i){let e=new Set(this._requiredCompletion);i?e.add(t):e.delete(t),this._requiredCompletion=[...e]}_patchReading(t,i){this._readings=this._readings.map(e=>e.id===t?{...e,...i}:e)}_renderReadingsEditor(t){let i=At(this._readings);return a`
...
`).map(h=>h.trim()).filter(Boolean).slice(0,100);t.checklist=u.length?u:null}if(this.completionActionsEnabled){let u=this._actionService.trim();if(u&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(u)){let x={service:u},y=this._actionTargetEntity.trim();y&&(x.target={entity_id:y});let $=this._buildActionData();Object.keys($).length>0&&(x.data=$),t.on_complete_action=x}else t.on_complete_action=null;let h={};this._qcNotes.trim()&&(h.notes=this._qcNotes.trim());let g=parseFloat(this._qcCost);!isNaN(g)&&g>=0&&(h.cost=g);let f=parseInt(this._qcDuration,10);!isNaN(f)&&f>=0&&(h.duration=f),this._qcFeedback&&(h.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(h).length?h:null}let e=await this.hass.connection.sendMessagePromise(t),n=this._taskId||e?.task_id,d=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;this._warning="";let _=u=>{this._warning=s("subsave_warning",this._lang).replace("{detail}",u)};if(n&&this._scheduleType==="sensor_based"&&d&&await _t(this,{type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null},{onError:_})!==void 0&&(this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute),n&&this._adaptiveSnapshot()!==this._adaptiveInitial){let u=parseFloat(this._adaptiveAlpha),h=parseInt(this._adaptiveMin,10),g=parseInt(this._adaptiveMax,10);await _t(this,{type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:n,enabled:this._adaptiveEnabled,...u>=.1&&u<=.9?{ewa_alpha:u}:{},...!isNaN(h)&&h>=1?{min_interval_days:h}:{},...!isNaN(g)&&g>=1?{max_interval_days:g}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction},{onError:_})!==void 0&&(this._adaptiveInitial=this._adaptiveSnapshot())}this._warning?n&&(this._taskId=n):this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=T(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._warning="",this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return p;let t=this._lang,i=this._triggerType==="compound";return a`
      ...
      <div class="select-row">
        ...
        >
          ${Ne.map(e=>a`<option value=${e} ?selected=${e===this._triggerType}>${s(e,t)}</option>`)}
        </select>
      </div>
      ...
      ${this._intervalDays?a`
          ...
          `:p}
    `}_patchCondition(t,i){this._compoundConditions=this._compoundConditions.map((e,n)=>n===t?{...e,...i}:e)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Me()]}_removeCondition(t){this._compoundConditions=this._compoundConditions.filter((i,e)=>e!==t)}_renderCompoundEditor(){let t=this._lang;return a`
      <div class="select-row">
    ...
    `}_buildSchedule(){let t=e=>{let n=parseInt(this._calOffset,10)||0;return n&&(e.offset=Math.max(-15,Math.min(n,15))),e};if(this._scheduleType==="weekdays")return t({kind:"weekdays",weekdays:[...this._weekdays].sort((e,n)=>e-n)});if(this._scheduleType==="nth_weekday")return t({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let i={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(i.business=!0),t(i)}_recurrenceExtras(){let t={};if(this._seasonMonths.length&&(t.season_months=[...this._seasonMonths].sort((i,e)=>i-e)),this._endsMode==="count"){let i=parseInt(this._endsCount,10);i>=1&&(t.ends={count:i})}else this._endsMode==="until"&&this._endsUntil&&(t.ends={until:this._endsUntil});return t}_toggleSeasonMonth(t){this._seasonMonths=this._seasonMonths.includes(t)?this._seasonMonths.filter(i=>i!==t):[...this._seasonMonths,t]}_renderRecurrenceExtras(){let t=this._lang;if(!(this._scheduleType==="time_based"||ot.includes(this._scheduleType)))return p;let e=ze(t);return a`
      ...
      ${this._endsMode==="until"?a`
        ...
        ></ms-date-field>`:p}
    `}_renderCalendarFields(){let t=this._lang,i=je(t);if(this._scheduleType==="weekdays")return a`
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Re.map(e=>a`<option value=${e} ?selected=${e===this._type}>${s(e,t)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${qe.map(e=>a`<option value=${e} ?selected=${e===this._priority}>${s("priority_"+e,t)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${He.map(e=>a`<option value=${e} ?selected=${e===this._scheduleType}>${s(e,t)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="one_time"?a`
                ...
                ></ms-date-field>
              `:p}
          ${this.scheduleTimeEnabled&&Qt.includes(this._scheduleType)?a`
          ...
          ${this._scheduleType==="sensor_based"?a`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:Yt,device_class:Gt}}}]}
  ...
  `,l([v({type:String})],D.prototype,"lang",2),l([c()],D.prototype,"_open",2),l([c()],D.prototype,"_busy",2),l([c()],D.prototype,"_devices",2),l([c()],D.prototype,"_deviceIndex",2),l([c()],D.prototype,"_switchFailed",2);customElements.get("ms-camera-capture")||customElements.define("ms-camera-capture",D);var dt=w`
    ...
    `}};l([v({type:String})],R.prototype,"lang",2),l([v({type:Boolean})],R.prototype,"disabled",2),l([v({type:Boolean})],R.prototype,"busy",2),l([v({type:String})],R.prototype,"accept",2),l([v({type:Boolean})],R.prototype,"showCamera",2),l([v({type:Boolean})],R.prototype,"showGallery",2),l([v({type:Boolean})],R.prototype,"compact",2),l([v({type:Number})],R.prototype,"remaining",2),l([c()],R.prototype,"_inAppCamera",2);customElements.get("ms-photo-picker")||customElements.define("ms-photo-picker",R);var b=class extends E{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this.taskType="";this.readingUnit="";this.readings=[];this.readingHistory=[];this.restockDefault=null;this.restockUnitCost=null;this.currencySymbol="";this.parts=[];this.consumesParts=[];this.consumesInfo=[];this.requiredFields=[];this.phaseLabel="";this.requireTagScan=!1;this.viaTagScan=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed";this._photos=new X(this,{entryId:()=>this.entryId,hass:()=>this.hass});this._readingValue="";this._readingValues={};this._restockQty="";this._completedAt="";this._usedParts={};this.checklistPrefill={}}open(t={}){this._open||(this._open=!0,this.viaTagScan=!!t.viaTagScan,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState=Object.fromEntries(this.checklist.map((i,e)=>[String(e),!!this.checklistPrefill[i]]).filter(([,i])=>i)),this._feedback="needed",this._photos.reset(),this._readingValue="",this._readingValues={},this._restockQty=this.restockDefault!==null?String(this.restockDefault):"",this._completedAt="",this._usedParts=Object.fromEntries(this.consumesParts.map(i=>[F(i),{...i}])))}_toggleCheck(t){let i=String(t);this._checklistState={...this._checklistState,[i]:!this._checklistState[i]}}_setFeedback(t){this._feedback=t}async _complete(){this._loading=!0,this._error="",this._photos.clearError();try{let t={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(t.notes=this._notes),this._cost){let i=parseFloat(this._cost);!isNaN(i)&&i>=0&&(t.cost=i)}if(this._duration){let i=parseInt(this._duration,10);!isNaN(i)&&i>=0&&(t.duration=i)}if(this.checklist.length>0&&(t.checklist_state=this._checklistState),this.adaptiveEnabled&&(t.feedback=this._feedback),this._photos.photos.length>0&&(t.photo_doc_ids=this._photos.ids),this.viaTagScan&&(t.via_tag_scan=!0),this._completedAt){if(new Date(this._completedAt).getTime()>Date.now()){this._error=s("completed_at_future_error",this.lang),this._loading=!1;return}t.completed_at=this._completedAt.length===16?`${this._completedAt}:00`:this._completedAt}if(this.readings.length>0){let i={};for(let e of this.readings){let n=(this._readingValues[e.id]??"").trim();if(n==="")continue;let d=parseFloat(n.replace(",","."));isNaN(d)||(i[e.id]=d)}Object.keys(i).length>0&&(t.reading_values=i)}else if(this._readingValue!==""){let i=parseFloat(this._readingValue);isNaN(i)||(t.reading_value=i)}if(this.restockDefault!==null&&this._restockQty!==""){let i=parseFloat(this._restockQty);!isNaN(i)&&i>=1&&(t.restock_quantity=i)}this.parts.length>0&&(t.used_parts=Object.values(this._usedParts).filter(i=>Number.isFinite(i.quantity)&&i.quantity>0).map(i=>i.entry_id?{part_id:i.part_id,quantity:i.quantity,entry_id:i.entry_id}:{part_id:i.part_id,quantity:i.quantity})),await this.hass.connection.sendMessagePromise(t),this._photos.markAttached(),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(t){this._error=T(t,this.lang,s("save_error",this.lang))}finally{this._loading=!1}}_renderReadingField(t,i){let e=this._completedAt?new Date(this._completedAt).getTime():NaN,n=St(this.readingHistory,t.id,isNaN(e)?void 0:e),d=t.unit||this.readingUnit,_=(this._readingValues[t.id]??"").trim(),u=_===""?NaN:parseFloat(_.replace(",",".")),h=n!==void 0&&!isNaN(u)&&u<n.value,g=n!==void 0?A(n.value,i,{maximumFractionDigits:3}):"";return a`
      <label class="field reading-field">
        ...
        <input type="text" inputmode="decimal" class="field-input"
          ...
          @input=${f=>{this._readingValues={...this._readingValues,[t.id]:f.target.value}}} />
...
<div class="qr-row">
  <div class="qr-col">
    <img src="${ne(this._viewResult.svg_data_uri)}" alt="QR Info" />
    <div class="qr-label">${g}</div>
  </div>
  ${h?`<div class="qr-col">
    <img src="${ne(this._completeResult.svg_data_uri)}" alt="QR Complete" />
    <div class="qr-label">${f}</div>
  </div>`:""}
</div>
<div class="url">${tt(this._viewResult.url)}</div>
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),n.document.close()}_downloadSvg(t,i){let e=decodeURIComponent(t.svg_data_uri.replace("data:image/svg+xml,","")),n=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;se(e,`qr-${Ke(n)}-${i}.svg`,"image/svg+xml")}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return a``;let t=this.lang||this.hass?.language||"en",i=this._taskName?`${s("qr_code",t)}: ${this._objectName} \u2014 ${this._taskName}`:`${s("qr_code",t)}: ${this._objectName}`,e=!!this._viewResult;return a`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${i}</div>
        <div class="content">
  ...
  `,l([v({attribute:!1})],q.prototype,"hass",2),l([v()],q.prototype,"lang",2),l([c()],q.prototype,"_open",2),l([c()],q.prototype,"_loading",2),l([c()],q.prototype,"_error",2),l([c()],q.prototype,"_viewResult",2),l([c()],q.prototype,"_completeResult",2),l([c()],q.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",q);function ae(r){let o=r.getFullYear(),t=String(r.getMonth()+1).padStart(2,"0"),i=String(r.getDate()).padStart(2,"0");return`${o}-${t}-${i}`}function Ye(r,o){if(o<=0)return 0;let t=typeof r=="number"&&Number.isFinite(r)?Math.trunc(r):0;return t<0?0:t%o}function Ge(r){return!!(r?.phases&&r.phase_sequence&&r.phase_sequence.length>0)}function yt(r){if(!r||!Ge(r))return null;let o=r.phase_sequence,t=Ye(r.phase_cursor,o.length),i=o[t],e=r.phases?.[i];return e?{id:i,name:e.name,index:t,count:o.length,notes:e.notes,checklist:e.checklist!==void 0?e.checklist:r.checklist??[],consumesParts:e.consumes_parts!==void 0?e.consumes_parts:r.consumes_parts??[],requiredFields:e.required_completion_fields!==void 0?e.required_completion_fields:r.required_completion_fields??[]}:null}function st(r){let o=yt(r);return o?`${o.index+1}/${o.count} \xB7 ${o.name}`:""}function oe(r){let o=r.task??null,t=o?yt(o):null,i=t?t.consumesParts:o?.consumes_parts||[],e=!!o?.part_ref,n=r.objects.find(u=>u.entry_id===r.entryId)?.parts||[],d=e?n.find(u=>u.id===o.part_ref.part_id):void 0,_=r.checklistsEnabled??!0;return{entry_id:r.entryId,task_id:r.taskId,task_name:r.taskName,checklist:t?_?t.checklist:[]:r.checklist??[],adaptive_enabled:!!r.adaptiveEnabled,required_completion_fields:t?t.requiredFields:o?.required_completion_fields||[],task_type:o?.type||"",reading_unit:o?.reading_unit||"",readings:o?.readings||[],reading_history:It(o?.history),parts:e?[]:Kt({consumes_parts:i},r.entryId,r.objects,r.lang),consumes_parts:e?[]:i,phase_label:t?st(o):"",require_tag_scan:!!o?.require_tag_scan,restock_default:e?d?.restock_quantity??1:null,restock_unit_cost:e?d?.cost??null:null,currency_symbol:et({currency_symbol:r.currencySymbol}),consumes_info:i.map(u=>Wt(u,r.entryId,r.objects,r.lang)),checklist_prefill:o?.checklist_progress||{},via_tag_scan:!!r.viaTagScan}}function le(r,o,t){r.entryId=o.entry_id,r.taskId=o.task_id,r.taskName=o.task_name,r.lang=t,r.checklist=o.checklist??[],r.adaptiveEnabled=!!o.adaptive_enabled,r.requiredFields=o.required_completion_fields??[],r.taskType=o.task_type??"",r.readingUnit=o.reading_unit??"",r.readings=o.readings??[],r.readingHistory=o.reading_history??[],r.parts=o.parts??[],r.consumesParts=o.consumes_parts??[],r.phaseLabel=o.phase_label??"",r.requireTagScan=!!o.require_tag_scan,r.restockDefault=o.restock_default??null,r.restockUnitCost=o.restock_unit_cost??null,r.currencySymbol=et(o),r.consumesInfo=o.consumes_info??[],r.checklistPrefill=o.checklist_prefill??{},r.viaTagScan=!!o.via_tag_scan,r.open({viaTagScan:!!o.via_tag_scan})}var de=r=>typeof r=="number"&&Number.isInteger(r)&&r>0;function Qe(r){return r&&de(r.ref_no)?String(r.ref_no):null}function ce(r,o){let t=Qe(r);return t&&o&&de(o.ref_no)?`${t}.${o.ref_no}`:null}function pe(r,o){return r?a`<span class="ref-chip" title=${o??""}>#${r}</span>`:p}var Ze=["completed","reset","skipped"];function Je(r,o){return r.taskRef&&o.ref_no?`${r.taskRef}-${o.ref_no}`:null}function Xe(r,o){let t=kt(o);return t.length>0?a`<div class="history-photos">
        ${t.map(i=>a`<maintenance-history-photo .hass=${r} .docId=${i}></maintenance-history-photo>`)}
      </div>`:p}function ti(r,o){let t=o.lang,i=d=>A(d,t,{maximumFractionDigits:3}),e=d=>d==null?"":` (${d>=0?"+":""}${i(d)})`,n=Et(r);return n.length>0?a`<div class="history-readings">
    ...
    </span></div>`:p}function he(r,o,t={}){let i=o.lang,{compact:e=!1,showRef:n=!0,showBadges:d=!0,showEdit:_=!0}=t,u=_&&Ze.includes(r.type);return a`
    <div class="history-entry${e?" compact":""}">
      ${e?p:a`<div class="history-icon ${r.type}">
            <ha-icon .icon=${xt[r.type]||"mdi:circle"}></ha-icon>
          </div>`}
      <div class="history-content">
        <div class="history-row">
          <strong>${s(r.type,i)}</strong>
          ${n?pe(Je(o,r),s("ref_number",i)):p}
        ...
        <div class="history-date">${Nt(r.timestamp,i)}</div>
  ...
  `}function k(r){return r.toFixed(1)}function ue(r,o){let t=r.interval_analysis,i=t?.weibull_beta,e=t?.weibull_eta;if(i==null||e==null||e<=0)return p;let n=r.interval_days??0,d=r.suggested_interval??n;return a`
  ...
  `}function ii(r,o,t,i,e){let y=Math.max(t,i,o,1)*1.3,$=50,H=[];for(let N=0;N<=$;N++){let O=N/$*y,Se=1-Math.exp(-Math.pow(O/o,r)),Te=32+O/y*260,Ae=136-Se*128;H.push([Te,Ae])}let W=H.map(([N,O])=>`${k(N)},${k(O)}`).join(" "),Y="M32,136 "+H.map(([N,O])=>`L${k(N)},${k(O)}`).join(" ")+` L${k(H[$][0])},136 Z`,M=32+t/y*260,z=1-Math.exp(-Math.pow(t/o,r)),Q=136-z*128,Ee=A((1-z)*100,e,0),$t=32+i/y*260,Ie=[0,.25,.5,.75,1];return a`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",e)}">
        ...
        ${i>0&&i!==t?Z`
          <line x1="${k($t)}" y1="${8}" x2="${k($t)}" y2="${k(136)}"
  ...
  `}function ri(r,o,t){let i=r.confidence_interval_low,e=r.confidence_interval_high,n=o.suggested_interval??o.interval_days??0,d=o.interval_days??0,_=Math.max(0,i-5),h=e+5-_,g=(i-_)/h*100,f=(e-i)/h*100,x=(n-_)/h*100,y=d>0?(d-_)/h*100:-1;return a`
      ...
      <div class="prediction-grid">
        ...
        ${n&&t.environmental?a`
          <div class="prediction-item">
            ...
            ${r.environmental_entity?a`<span class="prediction-entity entity-link" @click=${_=>Dt(_,r.environmental_entity)}>${r.environmental_entity}</span>`:p}
          </div>
        `:p}
      </div>
    </div>
  `}function me(r,o,t,i){let e=Math.max(r||1,o);return a`
  ...
  `}function fe(r,o){return ni(r,o)}function ni(r,o){let t=r.seasonal_factors??r.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return p;let i=r.interval_analysis?.seasonal_reason,e=new Date().getMonth(),n=300,d=100,_=8,h=d-_-4,g=Math.max(...t,1.5),f=n/12,x=f*.65,y=_+h-1/g*h;return a`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${n} ${d}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",o)}">
        ...
        ${t.map(($,H)=>{let W=$/g*h,Y=H*f+(f-x)/2,M=_+h-W,z=H===e,Q=$<1?"var(--success-color, #4caf50)":$>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return Z`
            <rect x="${k(Y)}" y="${k(M)}"
  ...
  `}var S=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._taskRef=null;this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return P(this.hass)}async openFor(t,i){this._entryId=t,this._taskId=i,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=ae(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._currencySymbol=et(t?.budget),qt(t?.budget),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let i=(t.tasks||[]).find(e=>e.id===this._taskId);this._task=i??null,this._taskRef=ce(t.object,i)}catch(t){this._error=T(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(i){return this._error=T(i,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-6AYXNK3X.js").then(async({openCompleteDialog:t})=>{let i=this._task,e=[];try{e=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}t(oe({entryId:this._entryId,taskId:this._taskId,taskName:i.name,task:i,objects:e,lang:this._lang,checklist:i.checklist||[],adaptiveEnabled:!!i.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-6AYXNK3X.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-6AYXNK3X.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=s("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=s("suggestion_applied",this._lang),this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${s("reanalyze_result",this._lang)}: ${Mt(t.recommended_interval,"days",this._lang)} (${t.data_points} pts)`:s("reanalyze_insufficient_data",this._lang),await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=T(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){if(!this._entryId||!this._taskId)return;let i=Pt(this._entryId,this._taskId,t,this._task);import("./dialog-mount-6AYXNK3X.js").then(({openHistoryEditDialog:e})=>e(i))}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return p;let i=this._lang;return a`
    ...
    `}_renderAdaptive(t){let i=this._lang,e=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,n=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,d=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,_=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!e&&!n&&!d&&!_?a`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${n?_e(t,i,this._features):p}
        ${d?ue(t,i):p}
        ${_?a`
          ${ve(t,i,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?fe(t,i):p}
        `:p}
      </div>
      ...
      <div class="details">
        ...
        ${e.length===0?a`<div class="history-empty">${s("history_empty",i)}</div>`:a`
              <div class="history-list">
                ${[...e].reverse().slice(0,20).map(u=>he(u,{lang:i,hass:this.hass,currencySymbol:this._currencySymbol,openEdit:h=>this._onEditHistoryEntry(h),readingUnit:t.reading_unit,readingSlotDelta:(h,g)=>Tt(e,h,g),taskRef:this._taskRef},{compact:!0}))}
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${i?a`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-6AYXNK3X.js").then(({openObjectQuickActions:n})=>{n(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ...
                  ${i.schedule?.kind&&!["manual","one_time"].includes(i.schedule.kind)||i.interval_days!=null?a`<span><strong>${s("interval",t)}:</strong> ${Ft(i,t)}</span>`:p}
        ...
        ${i&&e?a`
              ...
              ${e.notes?a`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${be(e.notes)}</div>
                    </div>
                  `:p}
      ...
      <div class="meta">
        ${e.map(([n,d])=>a`
            <div class="meta-item">
              ...
              <span class="meta-value">${ye(d)?a`<a href="${d}" target="_blank" rel="noopener noreferrer">${d}</a>`:d}</span>
            </div>
          `)}
      </div>
    `}};j.styles=w`
  ...
  `,l([v({attribute:!1})],j.prototype,"hass",2),l([c()],j.prototype,"_open",2),l([c()],j.prototype,"_entryId",2),l([c()],j.prototype,"_data",2),l([c()],j.prototype,"_busy",2),l([c()],j.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",j);var bt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"};function $e(){let r=window;return r.__msSettingsCache??={promise:null}}function ct(r){let o=$e();if(o.promise)return o.promise;let t=r.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(i=>({features:i.features??bt.features,defaultWarningDays:i.general?.default_warning_days??7,rowActionStyle:i.general?.row_action_style??bt.rowActionStyle})).catch(()=>(o.promise===t&&(o.promise=null),bt));return o.promise=t,t}function xe(){$e().promise=null}var ke="maintenance-object-dialog",we="maintenance-task-dialog",ai="maintenance-history-edit-dialog",oi="maintenance-complete-dialog",li="maintenance-qr-dialog",di="maintenance-task-quick-actions-dialog",ci="maintenance-object-quick-actions-dialog";function pt(){return document.querySelector("home-assistant")?.hass}function pi(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function V(r){let o=pi(),t=o.querySelector(r)??document.body.querySelector(r);return t?t.parentNode!==o&&o.appendChild(t):(t=document.createElement(r),o.appendChild(t)),t}function B(r){let o=pt();if(!o)return!1;r.hass=o;let t=P(o);return Lt(t)||Rt(t).then(()=>{r.requestUpdate?.()}),Ht(o.locale,o.config?.country),!0}function Cn(r){return ct(r).then(o=>o.rowActionStyle)}function Pn(){xe()}function Ln(){let r=V(ke);return B(r)?(r.openCreate(),!0):!1}function Rn(r,o){let t=V(ke);return B(t)?(t.openEdit(r,o),!0):!1}function qn(r="",o){let t=V(we);if(!B(t))return!1;let i=pt();return i?((async()=>{let e=await ct(i),n=t;n.checklistsEnabled=e.features.checklists,n.scheduleTimeEnabled=e.features.schedule_time,n.completionActionsEnabled=e.features.completion_actions,n.defaultWarningDays=e.defaultWarningDays,n.openCreate(r,o)})(),!0):!1}function Hn(r,o){let t=V(we);if(!B(t))return!1;let i=pt();return i?((async()=>{try{let[e,n]=await Promise.all([i.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:r}),ct(i)]),d=(e.tasks||[]).find(u=>u.id===o);if(!d){console.warn(`openEditTaskDialog: task ${o} not found in entry ${r}`);return}let _=t;_.checklistsEnabled=n.features.checklists,_.scheduleTimeEnabled=n.features.schedule_time,_.completionActionsEnabled=n.features.completion_actions,_.defaultWarningDays=n.defaultWarningDays,await _.openEdit(r,d)}catch(e){console.warn("openEditTaskDialog: failed to load task/features",e)}})(),!0):!1}function Nn(r){let o=V(ai);return B(o)?(o.openEdit(r),!0):!1}function Mn(r){let o=V(oi);return B(o)?(le(o,r,P(pt())),!0):!1}function On(r){let o=V(li);return B(o)?(o.openForTask(r.entry_id,r.task_id,r.object_name,r.task_name),!0):!1}function Fn(r,o){let t=V(di);return B(t)?(t.openFor(r,o),!0):!1}function Dn(r){let o=V(ci);return B(o)?(o.openFor(r),!0):!1}export{Pn as __resetSettingsCacheForTests,Cn as getRowActionStyle,Mn as openCompleteDialog,Ln as openCreateObjectDialog,qn as openCreateTaskDialog,Rn as openEditObjectDialog,Hn as openEditTaskDialog,Nn as openHistoryEditDialog,Dn as openObjectQuickActions,On as openQrDialog,Fn as openTaskQuickActions};
