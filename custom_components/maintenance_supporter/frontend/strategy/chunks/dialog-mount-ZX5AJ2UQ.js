...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `}function Xt(a,c,t,e,i){let $=Math.max(t,e,c,1)*1.3,q=50,L=[];for(let P=0;P<=q;P++){let H=P/q*$,Rt=1-Math.exp(-Math.pow(H/c,a)),Mt=32+H/$*260,Nt=136-Rt*128;L.push([Mt,Nt])}let B=L.map(([P,H])=>`${P.toFixed(1)},${H.toFixed(1)}`).join(" "),X="M32,136 "+L.map(([P,H])=>`L${P.toFixed(1)},${H.toFixed(1)}`).join(" ")+` L${L[q][0].toFixed(1)},136 Z`,D=32+t/$*260,W=1-Math.exp(-Math.pow(t/c,a)),K=136-W*128,qt=((1-W)*100).toFixed(0),at=32+e/$*260,Ht=[0,.25,.5,.75,1];return n`
  ...
  `}function ee(a,c,t){let e=a.confidence_interval_low,i=a.confidence_interval_high,r=c.suggested_interval??c.interval_days??0,d=c.interval_days??0,p=Math.max(0,e-5),h=i+5-p,g=(e-p)/h*100,b=(i-e)/h*100,y=(r-p)/h*100,$=d>0?(d-p)/h*100:-1;return n`
  ...
  `}function Tt(a,c){return ie(a,c)}function ie(a,c){let t=a.seasonal_factors??a.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return _;let e=a.interval_analysis?.seasonal_reason,i=new Date().getMonth(),r=300,d=100,p=8,h=d-p-4,g=Math.max(...t,1.5),b=r/12,y=b*.65,$=p+h-1/g*h;return n`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?n`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-ZX5AJ2UQ.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
  ...
  `],o([v({attribute:!1})],k.prototype,"hass",2),o([l()],k.prototype,"_open",2),o([l()],k.prototype,"_entryId",2),o([l()],k.prototype,"_taskId",2),o([l()],k.prototype,"_task",2),o([l()],k.prototype,"_objectName",2),o([l()],k.prototype,"_busy",2),o([l()],k.prototype,"_error",2),o([l()],k.prototype,"_showSkip",2),o([l()],k.prototype,"_showReset",2),o([l()],k.prototype,"_showDetails",2),o([l()],k.prototype,"_showAdaptive",2),o([l()],k.prototype,"_skipReason",2),o([l()],k.prototype,"_resetDate",2),o([l()],k.prototype,"_features",2),o([l()],k.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",k);function St(a){return!!a&&/^https?:\/\//i.test(a)}var M=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return S(this.hass)}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=I(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-ZX5AJ2UQ.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-ZX5AJ2UQ.js").then(({openCreateTaskDialog:t})=>{t(this._entryId),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=s("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=I(e,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let e=s("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(e))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=I(e,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-ZX5AJ2UQ.js").then(({openTaskQuickActions:e})=>{e(this._entryId,t)})}render(){if(!this._open)return _;let t=this._lang,e=this._data,i=e?.object,r=e?.tasks||[],d=this.hass?.user?.is_admin??!0;return n`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${e&&i?n`
              <div class="header">
