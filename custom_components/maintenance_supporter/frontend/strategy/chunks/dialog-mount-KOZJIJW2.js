...
`),this._scheduleTime=e.schedule_time||"";let h=e.on_complete_action;if(h&&h.service){this._actionService=h.service;let u=h.target?.entity_id;this._actionTargetEntity=Array.isArray(u)?u[0]||"":u||"",this._actionData=h.data&&typeof h.data=="object"?{...h.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let p=e.quick_complete_defaults;this._qcNotes=p?.notes||"",this._qcCost=p?.cost!=null?String(p.cost):"",this._qcDuration=p?.duration!=null?String(p.duration):"",this._qcFeedback=p?.feedback||"";let m=e.adaptive_config||{};if(this._environmentalEntity=m.environmental_entity||"",this._environmentalAttribute=m.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,e.trigger_config){let u=e.trigger_config;this._triggerEntityId=u.entity_id||"",this._triggerEntityIds=u.entity_ids||(u.entity_id?[u.entity_id]:[]),this._triggerEntityLogic=u.entity_logic||"any",this._triggerAttribute=u.attribute||"",this._triggerType=u.type||"threshold",this._triggerAbove=u.trigger_above?.toString()||"",this._triggerBelow=u.trigger_below?.toString()||"",this._triggerForMinutes=u.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=u.trigger_target_value?.toString()||"",this._triggerDeltaMode=u.trigger_delta_mode||!1,this._autoCompleteOnRecovery=u.auto_complete_on_recovery||!1,this._triggerFromState=u.trigger_from_state||"",this._triggerToState=u.trigger_to_state||"",this._triggerTargetChanges=u.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=u.trigger_runtime_hours?.toString()||"",u.type==="compound"?(this._compoundLogic=u.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(u.conditions||[]).map(At)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._readingUnit="",this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new W(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(t){console.error("Failed to load users:",t),this._availableUsers=[]}}_toggleAssignee(t){this._assigneePool=this._assigneePool.includes(t)?this._assigneePool.filter(e=>e!==t):[...this._assigneePool,t]}async _testAction(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[e,i]=t.split(".");if(!this.hass?.services?.[e]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${t}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let n=this._actionTargetEntity.trim();if(n){let h=n.split(".")[0];if(h!==e&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(e)){this._actionTestResult="error",this._actionTestError=`Service "${t}" only works on ${e}.* entities; entity "${n}" is in ${h}.* \u2014 pick a service that matches the entity domain (e.g. ${h}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[n]){this._actionTestResult="error",this._actionTestError=`Target entity "${n}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let t=JSON.parse(this._actionDataJsonFallback);if(t&&typeof t=="object"&&!Array.isArray(t))return t}catch{}return{...this._actionData}}_serviceSchema(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t))return null;let[e,i]=t.split("."),n=this.hass?.services?.[e]?.[i]?.fields;return!n||Object.keys(n).length===0?null:Object.entries(n).map(([h,p])=>({name:h,required:!!p.required,selector:p.selector||{text:{}}}))}_renderCompletionActionsSection(t){if(!this.completionActionsEnabled)return c;let e=this._serviceSchema();return r`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${i=>{this._actionService=i.detail.value||"";let n=this._serviceSchema();if(n){let h=new Set(n.map(p=>p.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([p])=>h.has(p)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
...
`).map(m=>m.trim()).filter(Boolean).slice(0,100);t.checklist=p.length?p:null}if(this.completionActionsEnabled){let p=this._actionService.trim();if(p&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(p)){let f={service:p},b=this._actionTargetEntity.trim();b&&(f.target={entity_id:b});let $=this._buildActionData();Object.keys($).length>0&&(f.data=$),t.on_complete_action=f}else t.on_complete_action=null;let m={};this._qcNotes.trim()&&(m.notes=this._qcNotes.trim());let u=parseFloat(this._qcCost);!isNaN(u)&&u>=0&&(m.cost=u);let v=parseInt(this._qcDuration,10);!isNaN(v)&&v>=0&&(m.duration=v),this._qcFeedback&&(m.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(m).length?m:null}let i=await this.hass.connection.sendMessagePromise(t),n=this._taskId||i?.task_id,h=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(n&&this._scheduleType==="sensor_based"&&h)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=I(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return c;let t=this._lang,e=this._triggerType==="compound";return r`
      ...
      <div class="select-row">
        ...
        >
          ${It.map(i=>r`<option value=${i} ?selected=${i===this._triggerType}>${s(i,t)}</option>`)}
        </select>
      </div>
    ...
    `}_patchCondition(t,e){this._compoundConditions=this._compoundConditions.map((i,n)=>n===t?{...i,...e}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Tt()]}_removeCondition(t){this._compoundConditions=this._compoundConditions.filter((e,i)=>i!==t)}_renderCompoundEditor(){let t=this._lang;return r`
      <div class="select-row">
    ...
    `}_renderCondition(t,e){let i=this._lang,n=e+1;return r`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${rt.map(h=>r`<option value=${h} ?selected=${h===t.type}>${s(h,i)}</option>`)}
          </select>
        </div>
    ...
    `}_renderConditionTypeFields(t,e){let i=this._lang;return t.type==="threshold"?r`
      ...
      ${this._endsMode==="until"?r`
        ...
        ></ms-textfield>`:c}
    `}_renderCalendarFields(){let t=this._lang,e=Ct(t);if(this._scheduleType==="weekdays")return r`
        ...
        <div class="select-row">
          ...
          <select .value=${this._nth} @change=${n=>this._nth=n.target.value}>
            ${i.map(([n,h])=>r`<option value=${n} ?selected=${n===this._nth}>${h}</option>`)}
          </select>
        </div>
        <div class="select-row">
          <label>${s("recurrence_weekday",t)}</label>
          <select .value=${this._nthWeekday} @change=${n=>this._nthWeekday=n.target.value}>
            ${e.map((n,h)=>r`<option value=${String(h)} ?selected=${String(h)===this._nthWeekday}>${n}</option>`)}
          </select>
        </div>
      ...
      ></ms-textfield>`}_renderTriggerLiveHint(){if(this._triggerType==="compound")return c;let t=this._triggerEntityId||this._triggerEntityIds[0];if(!t||!this.hass?.states)return c;let e=this.hass.states[t];if(!e)return c;let i=this._lang,n=e.attributes?.unit_of_measurement,h=typeof n=="string"&&n?` ${n}`:"",p=this._triggerAttribute?e.attributes?.[this._triggerAttribute]:e.state,m=typeof p=="number"?p:parseFloat(String(p)),u=p!=="unknown"&&p!=="unavailable"&&p!=null&&!isNaN(m),v=b=>Number.isInteger(b)?String(b):String(Math.round(b*10)/10),f=[];if(this._triggerType==="threshold"){let b=parseFloat(this._triggerAbove),$=parseFloat(this._triggerBelow);if(isNaN(b)&&isNaN($))return c;u&&f.push(s("trigger_hint_now",i).replace("{value}",v(m)+h)),isNaN(b)||f.push(s("trigger_hint_above",i).replace("{target}",v(b)+h)),isNaN($)||f.push(s("trigger_hint_below",i).replace("{target}",v($)+h))}else if(this._triggerType==="counter"){let b=parseFloat(this._triggerTargetValue);if(isNaN(b))return c;this._triggerDeltaMode?this._taskId?f.push(s("trigger_hint_counter_delta_edit",i).replace("{target}",v(b)+h)):u?f.push(s("trigger_hint_counter_delta",i).replace("{value}",v(m)+h).replace("{due}",v(m+b)+h).replace("{target}",v(b)+h)):f.push(s("trigger_hint_counter_delta_edit",i).replace("{target}",v(b)+h)):(u&&f.push(s("trigger_hint_now",i).replace("{value}",v(m)+h)),f.push(s("trigger_hint_counter_abs",i).replace("{target}",v(b)+h)))}else if(this._triggerType==="runtime"){let b=parseFloat(this._triggerRuntimeHours);if(isNaN(b))return c;f.push(s("trigger_hint_runtime",i).replace("{hours}",v(b))),f.push(s("trigger_hint_state_now",i).replace("{value}",String(e.state)))}else if(this._triggerType==="state_change"){let b=parseInt(this._triggerTargetChanges,10)||1,$=this._triggerToState.trim();f.push(($?s("trigger_hint_state_change_to",i).replace("{state}",$):s("trigger_hint_state_change",i)).replace("{count}",String(b))),f.push(s("trigger_hint_state_now",i).replace("{value}",String(e.state)))}return f.length?r`<div class="trigger-live-hint">${f.join(" ")}</div>`:c}_renderTriggerTypeFields(){let t=this._lang;return this._triggerType==="threshold"?r`
        <ms-textfield
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${kt.map(i=>r`<option value=${i} ?selected=${i===this._type}>${s(i,t)}</option>`)}
            </select>
          </div>
          ...
          ${this.parts.length?r`
                <div class="field">
                  ...
                  ${this.parts.map(i=>{let n=this._consumesParts[i.id];return r`
                      <div class="consumes-row">
                        <label class="consumes-check">
                          <input
                            type="checkbox"
                            .checked=${n!==void 0}
                            @change=${h=>{let p={...this._consumesParts};h.target.checked?p[i.id]=p[i.id]||1:delete p[i.id],this._consumesParts=p}}
                          />
                        ...
                        ${n!==void 0?r`<input
                              ...
                              max="999"
                              .value=${String(n)}
                              @input=${h=>{let p=parseInt(h.target.value,10);this._consumesParts={...this._consumesParts,[i.id]:Number.isFinite(p)&&p>=1?p:1}}}
                            />`:c}
                      </div>
                    `})}
                </div>
          ...
          <div class="select-row">
            ...
            >
              ${wt.map(i=>r`<option value=${i} ?selected=${i===this._priority}>${s("priority_"+i,t)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${Et.map(i=>r`<option value=${i} ?selected=${i===this._scheduleType}>${s(i,t)}</option>`)}
            </select>
          </div>
  ...
  `,a([g({attribute:!1})],_.prototype,"hass",2),a([g({type:Boolean,attribute:"checklists-enabled"})],_.prototype,"checklistsEnabled",2),a([g({type:Boolean,attribute:"schedule-time-enabled"})],_.prototype,"scheduleTimeEnabled",2),a([g({type:Boolean,attribute:"completion-actions-enabled"})],_.prototype,"completionActionsEnabled",2),a([g({type:Number,attribute:"default-warning-days"})],_.prototype,"defaultWarningDays",2),a([l()],_.prototype,"parts",2),a([l()],_.prototype,"_open",2),a([l()],_.prototype,"_loading",2),a([l()],_.prototype,"_error",2),a([l()],_.prototype,"_entryId",2),a([l()],_.prototype,"_taskId",2),a([l()],_.prototype,"_objectChoices",2),a([l()],_.prototype,"_name",2),a([l()],_.prototype,"_type",2),a([l()],_.prototype,"_scheduleType",2),a([l()],_.prototype,"_intervalDays",2),a([l()],_.prototype,"_intervalUnit",2),a([l()],_.prototype,"_dueDate",2),a([l()],_.prototype,"_warningDays",2),a([l()],_.prototype,"_earliestCompletionDays",2),a([l()],_.prototype,"_intervalAnchor",2),a([l()],_.prototype,"_weekdays",2),a([l()],_.prototype,"_nth",2),a([l()],_.prototype,"_nthWeekday",2),a([l()],_.prototype,"_domDay",2),a([l()],_.prototype,"_domLastDay",2),a([l()],_.prototype,"_domBusiness",2),a([l()],_.prototype,"_calOffset",2),a([l()],_.prototype,"_seasonMonths",2),a([l()],_.prototype,"_endsMode",2),a([l()],_.prototype,"_endsCount",2),a([l()],_.prototype,"_endsUntil",2),a([l()],_.prototype,"_notes",2),a([l()],_.prototype,"_documentationUrl",2),a([l()],_.prototype,"_customIcon",2),a([l()],_.prototype,"_priority",2),a([l()],_.prototype,"_labels",2),a([l()],_.prototype,"_enabled",2),a([l()],_.prototype,"_triggerEntityId",2),a([l()],_.prototype,"_triggerEntityIds",2),a([l()],_.prototype,"_triggerEntityLogic",2),a([l()],_.prototype,"_triggerAttribute",2),a([l()],_.prototype,"_triggerType",2),a([l()],_.prototype,"_triggerAbove",2),a([l()],_.prototype,"_triggerBelow",2),a([l()],_.prototype,"_triggerForMinutes",2),a([l()],_.prototype,"_triggerTargetValue",2),a([l()],_.prototype,"_triggerDeltaMode",2),a([l()],_.prototype,"_autoCompleteOnRecovery",2),a([l()],_.prototype,"_triggerFromState",2),a([l()],_.prototype,"_triggerToState",2),a([l()],_.prototype,"_triggerTargetChanges",2),a([l()],_.prototype,"_triggerRuntimeHours",2),a([l()],_.prototype,"_compoundLogic",2),a([l()],_.prototype,"_compoundConditions",2),a([l()],_.prototype,"_suggestedAttributes",2),a([l()],_.prototype,"_availableAttributes",2),a([l()],_.prototype,"_entityDomain",2),a([l()],_.prototype,"_lastPerformed",2),a([l()],_.prototype,"_nfcTagId",2),a([l()],_.prototype,"_readingUnit",2),a([l()],_.prototype,"_consumesParts",2),a([l()],_.prototype,"_partsLoadFailed",2),a([l()],_.prototype,"_availableTags",2),a([l()],_.prototype,"_responsibleUserId",2),a([l()],_.prototype,"_assigneePool",2),a([l()],_.prototype,"_rotationStrategy",2),a([l()],_.prototype,"_availableUsers",2),a([l()],_.prototype,"_checklistText",2),a([l()],_.prototype,"_scheduleTime",2),a([l()],_.prototype,"_actionService",2),a([l()],_.prototype,"_actionTargetEntity",2),a([l()],_.prototype,"_actionData",2),a([l()],_.prototype,"_actionDataJsonFallback",2),a([l()],_.prototype,"_actionTesting",2),a([l()],_.prototype,"_actionTestResult",2),a([l()],_.prototype,"_actionTestError",2),a([l()],_.prototype,"_qcNotes",2),a([l()],_.prototype,"_qcCost",2),a([l()],_.prototype,"_qcDuration",2),a([l()],_.prototype,"_qcFeedback",2),a([l()],_.prototype,"_environmentalEntity",2),a([l()],_.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",_);var y=class extends E{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this.taskType="";this.readingUnit="";this.restockDefault=null;this.consumesInfo=[];this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed";this._photoDocId="";this._photoPreview="";this._photoUploading=!1;this._readingValue="";this._restockQty=""}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed",this._photoDocId="",this._photoPreview="",this._photoUploading=!1,this._readingValue="",this._restockQty=this.restockDefault!==null?String(this.restockDefault):"")}_toggleCheck(t){let e=String(t);this._checklistState={...this._checklistState,[e]:!this._checklistState[e]}}_setFeedback(t){this._feedback=t}async _onPhotoInput(t){let e=t.target,i=e.files?.[0];if(e.value="",!!i){this._photoUploading=!0,this._error="";try{let n=new FormData;n.append("entry_id",this.entryId),n.append("tags","photo"),n.append("file",i,i.name);let h=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${this.hass.auth?.data?.access_token??""}`},body:n});if(!h.ok){this._error=h.status===413?s("doc_too_large",this.lang):s("doc_upload_failed",this.lang);return}let p=await h.json();p.id&&(this._photoDocId=p.id,this._photoPreview=URL.createObjectURL(i))}catch{this._error=s("doc_upload_failed",this.lang)}finally{this._photoUploading=!1}}}_removePhoto(){this._photoPreview&&URL.revokeObjectURL(this._photoPreview),this._photoDocId="",this._photoPreview=""}async _complete(){this._loading=!0,this._error="";try{let t={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(t.notes=this._notes),this._cost){let e=parseFloat(this._cost);!isNaN(e)&&e>=0&&(t.cost=e)}if(this._duration){let e=parseInt(this._duration,10);!isNaN(e)&&e>=0&&(t.duration=e)}if(this.checklist.length>0&&(t.checklist_state=this._checklistState),this.adaptiveEnabled&&(t.feedback=this._feedback),this._photoDocId&&(t.photo_doc_id=this._photoDocId),this._readingValue!==""){let e=parseFloat(this._readingValue);isNaN(e)||(t.reading_value=e)}if(this.restockDefault!==null&&this._restockQty!==""){let e=parseInt(this._restockQty,10);!isNaN(e)&&e>=1&&(t.restock_quantity=e)}await this.hass.connection.sendMessagePromise(t),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(t){this._error=I(t,this.lang,s("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return r``;let t=this.lang||this.hass?.language||"en";return r`
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.consumesInfo.length?r`<div class="consumes-hint">
  ...
  `],a([g({attribute:!1})],y.prototype,"hass",2),a([g()],y.prototype,"entryId",2),a([g()],y.prototype,"taskId",2),a([g()],y.prototype,"taskName",2),a([g()],y.prototype,"lang",2),a([g({type:Array})],y.prototype,"checklist",2),a([g({type:Boolean})],y.prototype,"adaptiveEnabled",2),a([g()],y.prototype,"taskType",2),a([g()],y.prototype,"readingUnit",2),a([g({attribute:!1})],y.prototype,"restockDefault",2),a([g({type:Array})],y.prototype,"consumesInfo",2),a([l()],y.prototype,"_open",2),a([l()],y.prototype,"_notes",2),a([l()],y.prototype,"_cost",2),a([l()],y.prototype,"_duration",2),a([l()],y.prototype,"_loading",2),a([l()],y.prototype,"_error",2),a([l()],y.prototype,"_checklistState",2),a([l()],y.prototype,"_feedback",2),a([l()],y.prototype,"_photoDocId",2),a([l()],y.prototype,"_photoPreview",2),a([l()],y.prototype,"_photoUploading",2),a([l()],y.prototype,"_readingValue",2),a([l()],y.prototype,"_restockQty",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",y);var R=class extends E{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null}get _lang(){return this.hass?.language||"en"}openEdit(t){this._draft={...t},this._originalSnapshot={...t},this._error="",this._open=!0}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null}_set(t,e){this._draft&&(this._draft={...this._draft,[t]:e})}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{let t={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(t.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(t.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(t.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(t.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(t.completed_by=this._draft.completed_by),Object.keys(t).filter(i=>!["type","entry_id","task_id","original_timestamp"].includes(i)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(t),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=I(t,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return c;let t=this._lang,e=this._draft;return r`
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,a([g({attribute:!1})],A.prototype,"hass",2),a([g()],A.prototype,"lang",2),a([l()],A.prototype,"_open",2),a([l()],A.prototype,"_loading",2),a([l()],A.prototype,"_error",2),a([l()],A.prototype,"_viewResult",2),a([l()],A.prototype,"_completeResult",2),a([l()],A.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",A);function ot(o,d){let t=o.interval_analysis,e=t?.weibull_beta,i=t?.weibull_eta;if(e==null||i==null||i<=0)return c;let n=o.interval_days??0,h=o.suggested_interval??n;return r`
    <div class="weibull-section">
      ...
      ${Rt(e,i,n,h,d)}
      ${Ft(t,d)}
      ${t?.confidence_interval_low!=null?Mt(t,o,d):c}
    </div>
  ...
  `}function Rt(o,d,t,e,i){let $=Math.max(t,e,d,1)*1.3,S=50,P=[];for(let L=0;L<=S;L++){let C=L/S*$,yt=1-Math.exp(-Math.pow(C/d,o)),$t=32+C/$*260,xt=136-yt*128;P.push([$t,xt])}let j=P.map(([L,C])=>`${L.toFixed(1)},${C.toFixed(1)}`).join(" "),K="M32,136 "+P.map(([L,C])=>`L${L.toFixed(1)},${C.toFixed(1)}`).join(" ")+` L${P[S][0].toFixed(1)},136 Z`,q=32+t/$*260,D=1-Math.exp(-Math.pow(t/d,o)),O=136-D*128,ft=((1-D)*100).toFixed(0),Y=32+e/$*260,bt=[0,.25,.5,.75,1];return r`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",i)}">
        ${bt.map(L=>{let C=136-L*128;return N`
        ...
        ${t>0?N`
          ...
          <circle cx="${q.toFixed(1)}" cy="${O.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(q+4).toFixed(1)}" y="${(O-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
  ...
  `}function Mt(o,d,t){let e=o.confidence_interval_low,i=o.confidence_interval_high,n=d.suggested_interval??d.interval_days??0,h=d.interval_days??0,p=Math.max(0,e-5),u=i+5-p,v=(e-p)/u*100,f=(i-e)/u*100,b=(n-p)/u*100,$=h>0?(h-p)/u*100:-1;return r`
      ...
      <div class="prediction-grid">
        ${e?r`
          <div class="prediction-item">
            ...
            ${o.degradation_rate!=null?r`<span class="prediction-rate">${o.degradation_rate>0?"+":""}${Math.abs(o.degradation_rate)>=10?Math.round(o.degradation_rate).toLocaleString():o.degradation_rate.toFixed(1)} ${o.trigger_entity_info?.unit_of_measurement||""}/${s("day_short",d)}</span>`:c}
          </div>
        `:c}
        ${i?r`
          <div class="prediction-item">
            ...
            ${o.threshold_prediction_date?r`<span class="prediction-date">${U(o.threshold_prediction_date,d)}</span>`:c}
        ...
        ${n&&t.environmental?r`
          <div class="prediction-item">
            ...
            ${o.environmental_entity?r`<span class="prediction-entity entity-link" @click=${p=>et(p,o.environmental_entity)}>${o.environmental_entity}</span>`:c}
          </div>
        `:c}
      </div>
    </div>
  `}function dt(o,d,t,e){let i=Math.max(o||1,d);return r`
  ...
  `}var ct=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function pt(o,d,t){if(!t.seasonal||!o.seasonal_factor||o.seasonal_factor===1)return c;let e=ct.map(p=>s(p,d)),i=new Date().getMonth(),n=o.seasonal_factors||o.interval_analysis?.seasonal_factors||null,h=n&&n.length===12?n:e.map((p,m)=>{let u=o.seasonal_factor||1,v=Math.sin((m-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,u+v))});return r`
    <div class="seasonal-card-compact">
      <h4>${s("seasonal_awareness",d)}</h4>
      <div class="seasonal-mini-chart">
        ${h.map((p,m)=>{let u=p*40,v=p<.9?"low":p>1.1?"high":"normal";return r`
  ...
  `}function ht(o,d){return qt(o,d)}function qt(o,d){let t=o.seasonal_factors??o.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return c;let e=o.interval_analysis?.seasonal_reason,i=new Date().getMonth(),n=300,h=100,p=8,u=h-p-4,v=Math.max(...t,1.5),f=n/12,b=f*.65,$=p+u-1/v*u;return r`
  ...
  `}var k=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(t,e){this._entryId=t,this._taskId=e,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let e=(t.tasks||[]).find(i=>i.id===this._taskId);this._task=e??null}catch(t){this._error=I(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(e){return this._error=I(e,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-KOZJIJW2.js").then(({openCompleteDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-KOZJIJW2.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-KOZJIJW2.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=s("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=s("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${s("reanalyze_result",this._lang)||"Recomputed"}: ${t.recommended_interval}d (${t.data_points} pts)`:s("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=I(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-KOZJIJW2.js").then(({openHistoryEditDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return c;let e=this._lang;return r`
    ...
    `}_renderAdaptive(t){let e=this._lang,i=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,n=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,h=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,p=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!i&&!n&&!h&&!p?r`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${n?lt(t,e,this._features):c}
        ${h?ot(t,e):c}
        ${p?r`
          ${pt(t,e,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?ht(t,e):c}
        `:c}
      </div>
    `}_renderDetails(t){let e=this._lang,i=t.history||[],n=i.filter(m=>m.type==="completed"),h=n.reduce((m,u)=>m+(typeof u.cost=="number"?u.cost:0),0),p=(()=>{let m=n.map(u=>typeof u.duration=="number"?u.duration:null).filter(u=>u!=null);return m.length?Math.round(m.reduce((u,v)=>u+v,0)/m.length):null})();return r`
      <div class="details">
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?r`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-KOZJIJW2.js").then(({openObjectQuickActions:n})=>{n(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${e.next_due?r`<span><strong>${s("next_due",t)||"Next due"}:</strong> ${U(e.next_due,t)}</span>`:c}
                  ${e.last_performed?r`<span><strong>${s("last_performed",t)||"Last"}:</strong> ${U(e.last_performed,t)}</span>`:c}
  ...
  `],a([g({attribute:!1})],k.prototype,"hass",2),a([l()],k.prototype,"_open",2),a([l()],k.prototype,"_entryId",2),a([l()],k.prototype,"_taskId",2),a([l()],k.prototype,"_task",2),a([l()],k.prototype,"_objectName",2),a([l()],k.prototype,"_busy",2),a([l()],k.prototype,"_error",2),a([l()],k.prototype,"_showSkip",2),a([l()],k.prototype,"_showReset",2),a([l()],k.prototype,"_showDetails",2),a([l()],k.prototype,"_showAdaptive",2),a([l()],k.prototype,"_skipReason",2),a([l()],k.prototype,"_resetDate",2),a([l()],k.prototype,"_features",2),a([l()],k.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",k);function _t(o){return!!o&&/^https?:\/\//i.test(o)}var H=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return this.hass?.language||"en"}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=I(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-KOZJIJW2.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-KOZJIJW2.js").then(({openCreateTaskDialog:t})=>{t(),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=s("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=I(e,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let e=s("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(e))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=I(e,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-KOZJIJW2.js").then(({openTaskQuickActions:e})=>{e(this._entryId,t)})}render(){if(!this._open)return c;let t=this._lang,e=this._data,i=e?.object,n=e?.tasks||[],h=this.hass?.user?.is_admin??!0;return r`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${e&&i?r`
              <div class="header">
              ...
              <div class="tasks-section">
                ...
                ${n.length===0?r`<div class="empty">${s("no_tasks",t)||"No tasks yet."}</div>`:r`
                      <div class="task-list">
                        ${n.map(p=>r`
      ...
      <div class="meta">
        ${i.map(([n,h])=>r`
            <div class="meta-item">
              ...
              <span class="meta-value">${_t(h)?r`<a href="${h}" target="_blank" rel="noopener noreferrer">${h}</a>`:h}</span>
            </div>
          `)}
      </div>
    `}};H.styles=w`
  ...
  `,a([g({attribute:!1})],H.prototype,"hass",2),a([l()],H.prototype,"_open",2),a([l()],H.prototype,"_entryId",2),a([l()],H.prototype,"_data",2),a([l()],H.prototype,"_busy",2),a([l()],H.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",H);var mt="maintenance-object-dialog",gt="maintenance-task-dialog",Nt="maintenance-history-edit-dialog",zt="maintenance-complete-dialog",Ut="maintenance-qr-dialog",jt="maintenance-task-quick-actions-dialog",Dt="maintenance-object-quick-actions-dialog";function G(){return document.querySelector("home-assistant")?.hass}function F(o){let d=document.body.querySelector(o);return d||(d=document.createElement(o),document.body.appendChild(d)),d}function M(o){let d=G();if(!d)return!1;o.hass=d;let t=d.language||"en";return Z(t)||J(t).then(()=>{o.requestUpdate?.()}),!0}var ut={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},B=null;function vt(o){return B||(B=o.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(d=>({features:d.features??ut.features,defaultWarningDays:d.general?.default_warning_days??7})).catch(()=>ut),B)}function ci(){let o=F(mt);return M(o)?(o.openCreate(),!0):!1}function pi(o,d){let t=F(mt);return M(t)?(t.openEdit(o,d),!0):!1}function hi(){let o=F(gt);if(!M(o))return!1;let d=G();return d?((async()=>{let t=await vt(d),e=o;e.checklistsEnabled=t.features.checklists,e.scheduleTimeEnabled=t.features.schedule_time,e.completionActionsEnabled=t.features.completion_actions,e.defaultWarningDays=t.defaultWarningDays,e.openCreate()})(),!0):!1}function _i(o,d){let t=F(gt);if(!M(t))return!1;let e=G();return e?((async()=>{try{let[i,n]=await Promise.all([e.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:o}),vt(e)]),h=(i.tasks||[]).find(m=>m.id===d);if(!h){console.warn(`openEditTaskDialog: task ${d} not found in entry ${o}`);return}let p=t;p.checklistsEnabled=n.features.checklists,p.scheduleTimeEnabled=n.features.schedule_time,p.completionActionsEnabled=n.features.completion_actions,p.defaultWarningDays=n.defaultWarningDays,await p.openEdit(o,h)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function ui(o){let d=F(Nt);return M(d)?(d.openEdit(o),!0):!1}function mi(o){let d=F(zt);return M(d)?(d.entryId=o.entry_id,d.taskId=o.task_id,d.taskName=o.task_name,d.checklist=o.checklist??[],d.adaptiveEnabled=!!o.adaptive_enabled,d.lang=G()?.language||"en",d.open(),!0):!1}function gi(o){let d=F(Ut);return M(d)?(d.openForTask(o.entry_id,o.task_id,o.object_name,o.task_name),!0):!1}function vi(o,d){let t=F(jt);return M(t)?(t.openFor(o,d),!0):!1}function fi(o){let d=F(Dt);return M(d)?(d.openFor(o),!0):!1}export{mi as openCompleteDialog,ci as openCreateObjectDialog,hi as openCreateTaskDialog,pi as openEditObjectDialog,_i as openEditTaskDialog,ui as openHistoryEditDialog,fi as openObjectQuickActions,gi as openQrDialog,vi as openTaskQuickActions};
