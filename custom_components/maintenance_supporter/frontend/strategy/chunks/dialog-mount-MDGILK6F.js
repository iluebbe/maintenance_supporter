...
import{a as ot,b as gt,c as lt,d as vt,e as ft,f as bt,g as yt,h as $t}from"./chunk-HYTKA5KV.js";import"./chunk-CWJ56MWO.js";import{a as I,b as a,c as Q,d as _,e as S,f as g,g as c,i as s,k as C,l as xt,m as kt,n as wt,o as E,p as Et,q as Y,r as It,s as St,t as dt,u as Tt,v as At,w as Pt,x as Lt,y as Ct,z as P}from"./chunk-5CEYR4C6.js";import{a as o,b as et}from"./chunk-WJSTGOOD.js";var A=class extends S{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(t){let i=t.target.value;this.value=i,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:i}}))}render(){return a`
      <label class="field">
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${i?a`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-MDGILK6F.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
