...
`).map(m=>m.trim()).filter(Boolean).slice(0,100);t.checklist=p.length?p:null}if(this.completionActionsEnabled){let p=this._actionService.trim();if(p&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(p)){let b={service:p},y=this._actionTargetEntity.trim();y&&(b.target={entity_id:y});let $=this._buildActionData();Object.keys($).length>0&&(b.data=$),t.on_complete_action=b}else t.on_complete_action=null;let m={};this._qcNotes.trim()&&(m.notes=this._qcNotes.trim());let u=parseFloat(this._qcCost);!isNaN(u)&&u>=0&&(m.cost=u);let v=parseInt(this._qcDuration,10);!isNaN(v)&&v>=0&&(m.duration=v),this._qcFeedback&&(m.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(m).length?m:null}let i=await this.hass.connection.sendMessagePromise(t),n=this._taskId||i?.task_id,h=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(n&&this._scheduleType==="sensor_based"&&h)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=I(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return c;let t=this._lang,e=this._triggerType==="compound";return r`
    ...
    `}_renderConditionTypeFields(t,e){let i=this._lang;return t.type==="threshold"?r`
      ...
      ${this._endsMode==="until"?r`
        ...
        ></ms-textfield>`:c}
    `}_renderCalendarFields(){let t=this._lang,e=St(t);if(this._scheduleType==="weekdays")return r`
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,a([g({attribute:!1})],L.prototype,"hass",2),a([g()],L.prototype,"lang",2),a([l()],L.prototype,"_open",2),a([l()],L.prototype,"_loading",2),a([l()],L.prototype,"_error",2),a([l()],L.prototype,"_viewResult",2),a([l()],L.prototype,"_completeResult",2),a([l()],L.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",L);function ot(o,d){let t=o.interval_analysis,e=t?.weibull_beta,i=t?.weibull_eta;if(e==null||i==null||i<=0)return c;let n=o.interval_days??0,h=o.suggested_interval??n;return r`
  ...
  `}function Rt(o,d,t,e,i){let $=Math.max(t,e,d,1)*1.3,C=50,P=[];for(let A=0;A<=C;A++){let S=A/C*$,yt=1-Math.exp(-Math.pow(S/d,o)),$t=32+S/$*260,xt=136-yt*128;P.push([$t,xt])}let j=P.map(([A,S])=>`${A.toFixed(1)},${S.toFixed(1)}`).join(" "),K="M32,136 "+P.map(([A,S])=>`L${A.toFixed(1)},${S.toFixed(1)}`).join(" ")+` L${P[C][0].toFixed(1)},136 Z`,q=32+t/$*260,D=1-Math.exp(-Math.pow(t/d,o)),O=136-D*128,ft=((1-D)*100).toFixed(0),Y=32+e/$*260,bt=[0,.25,.5,.75,1];return r`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",i)}">
        ${bt.map(A=>{let S=136-A*128;return N`
  ...
  `}function Mt(o,d,t){let e=o.confidence_interval_low,i=o.confidence_interval_high,n=d.suggested_interval??d.interval_days??0,h=d.interval_days??0,p=Math.max(0,e-5),u=i+5-p,v=(e-p)/u*100,b=(i-e)/u*100,y=(n-p)/u*100,$=h>0?(h-p)/u*100:-1;return r`
  ...
  `}function ht(o,d){return qt(o,d)}function qt(o,d){let t=o.seasonal_factors??o.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return c;let e=o.interval_analysis?.seasonal_reason,i=new Date().getMonth(),n=300,h=100,p=8,u=h-p-4,v=Math.max(...t,1.5),b=n/12,y=b*.65,$=p+u-1/v*u;return r`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${n} ${h}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",d)}">
        ...
        ${t.map((C,P)=>{let j=C/v*u,K=P*b+(b-y)/2,q=p+u-j,D=P===i,O=C<1?"var(--success-color, #4caf50)":C>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return N`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?r`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-JO73WWQ4.js").then(({openObjectQuickActions:n})=>{n(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
