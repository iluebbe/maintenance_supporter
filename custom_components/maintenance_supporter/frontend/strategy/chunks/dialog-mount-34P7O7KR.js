...
`),this._scheduleTime=e.schedule_time||"";let o=e.on_complete_action;if(o&&o.service){this._actionService=o.service;let p=o.target?.entity_id;this._actionTargetEntity=Array.isArray(p)?p[0]||"":p||"",this._actionData=o.data&&typeof o.data=="object"?{...o.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let _=e.quick_complete_defaults;this._qcNotes=_?.notes||"",this._qcCost=_?.cost!=null?String(_.cost):"",this._qcDuration=_?.duration!=null?String(_.duration):"",this._qcFeedback=_?.feedback||"";let h=e.adaptive_config||{};if(this._environmentalEntity=h.environmental_entity||"",this._environmentalAttribute=h.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,e.trigger_config){let p=e.trigger_config;this._triggerEntityId=p.entity_id||"",this._triggerEntityIds=p.entity_ids||(p.entity_id?[p.entity_id]:[]),this._triggerEntityLogic=p.entity_logic||"any",this._triggerAttribute=p.attribute||"",this._triggerType=p.type||"threshold",this._triggerAbove=p.trigger_above?.toString()||"",this._triggerBelow=p.trigger_below?.toString()||"",this._triggerForMinutes=p.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=p.trigger_target_value?.toString()||"",this._triggerDeltaMode=p.trigger_delta_mode||!1,this._triggerFromState=p.trigger_from_state||"",this._triggerToState=p.trigger_to_state||"",this._triggerTargetChanges=p.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=p.trigger_runtime_hours?.toString()||""}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._notes="",this._documentationUrl="",this._customIcon="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._responsibleUserId=null,this._checklistText="",this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours=""}async _loadUsers(){this._userService||(this._userService=new O(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(t){console.error("Failed to load users:",t),this._availableUsers=[]}}async _testAction(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[e,s]=t.split(".");if(!this.hass?.services?.[e]?.[s]){this._actionTestResult="error",this._actionTestError=`Service "${t}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let o=this._actionTargetEntity.trim();if(o){let _=o.split(".")[0];if(_!==e&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(e)){this._actionTestResult="error",this._actionTestError=`Service "${t}" only works on ${e}.* entities; entity "${o}" is in ${_}.* \u2014 pick a service that matches the entity domain (e.g. ${_}.${s})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[o]){this._actionTestResult="error",this._actionTestError=`Target entity "${o}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let t=JSON.parse(this._actionDataJsonFallback);if(t&&typeof t=="object"&&!Array.isArray(t))return t}catch{}return{...this._actionData}}_serviceSchema(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t))return null;let[e,s]=t.split("."),o=this.hass?.services?.[e]?.[s]?.fields;return!o||Object.keys(o).length===0?null:Object.entries(o).map(([_,h])=>({name:_,required:!!h.required,selector:h.selector||{text:{}}}))}_renderCompletionActionsSection(t){if(!this.completionActionsEnabled)return d;let e=this._serviceSchema();return r`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${s=>{this._actionService=s.detail.value||"";let o=this._serviceSchema();if(o){let _=new Set(o.map(h=>h.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([h])=>_.has(h)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
...
`).map(h=>h.trim()).filter(Boolean).slice(0,100);t.checklist=_.length?_:null}if(this.completionActionsEnabled){let _=this._actionService.trim();if(_&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(_)){let b={service:_},E=this._actionTargetEntity.trim();E&&(b.target={entity_id:E});let P=this._buildActionData();Object.keys(P).length>0&&(b.data=P),t.on_complete_action=b}else t.on_complete_action=null;let h={};this._qcNotes.trim()&&(h.notes=this._qcNotes.trim());let p=parseFloat(this._qcCost);!isNaN(p)&&p>=0&&(h.cost=p);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(h.duration=g),this._qcFeedback&&(h.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(h).length?h:null}let e=await this.hass.connection.sendMessagePromise(t),s=this._taskId||e?.task_id,o=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(s&&this._scheduleType==="sensor_based"&&o)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:s,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=k(t,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return d;let t=this._lang;return r`
      ...
      <ms-textfield
        ...
        @input=${e=>{let o=e.target.value.split(",").map(_=>_.trim()).filter(Boolean);this._triggerEntityId=o[0]||"",this._triggerEntityIds=o,o[0]&&this._fetchEntityAttributes(o[0])}}
      ></ms-textfield>
      ...
      <div class="select-row">
        ...
        >
          ${bt.map(e=>r`<option value=${e} ?selected=${e===this._triggerType}>${i(e,t)}</option>`)}
        </select>
      </div>
      ...
      <div class="select-row">
        ...
        <div class="select-row">
          ...
          <select .value=${this._nth} @change=${o=>this._nth=o.target.value}>
            ${s.map(([o,_])=>r`<option value=${o} ?selected=${o===this._nth}>${_}</option>`)}
          </select>
        </div>
        <div class="select-row">
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${gt.map(s=>r`<option value=${s} ?selected=${s===this._type}>${i(s,t)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${vt.map(s=>r`<option value=${s} ?selected=${s===this._scheduleType}>${i(s,t)}</option>`)}
            </select>
          </div>
  ...
  `,a([m({attribute:!1})],u.prototype,"hass",2),a([m({type:Boolean,attribute:"checklists-enabled"})],u.prototype,"checklistsEnabled",2),a([m({type:Boolean,attribute:"schedule-time-enabled"})],u.prototype,"scheduleTimeEnabled",2),a([m({type:Boolean,attribute:"completion-actions-enabled"})],u.prototype,"completionActionsEnabled",2),a([m({type:Number,attribute:"default-warning-days"})],u.prototype,"defaultWarningDays",2),a([c()],u.prototype,"_open",2),a([c()],u.prototype,"_loading",2),a([c()],u.prototype,"_error",2),a([c()],u.prototype,"_entryId",2),a([c()],u.prototype,"_taskId",2),a([c()],u.prototype,"_objectChoices",2),a([c()],u.prototype,"_name",2),a([c()],u.prototype,"_type",2),a([c()],u.prototype,"_scheduleType",2),a([c()],u.prototype,"_intervalDays",2),a([c()],u.prototype,"_intervalUnit",2),a([c()],u.prototype,"_dueDate",2),a([c()],u.prototype,"_warningDays",2),a([c()],u.prototype,"_intervalAnchor",2),a([c()],u.prototype,"_weekdays",2),a([c()],u.prototype,"_nth",2),a([c()],u.prototype,"_nthWeekday",2),a([c()],u.prototype,"_domDay",2),a([c()],u.prototype,"_notes",2),a([c()],u.prototype,"_documentationUrl",2),a([c()],u.prototype,"_customIcon",2),a([c()],u.prototype,"_enabled",2),a([c()],u.prototype,"_triggerEntityId",2),a([c()],u.prototype,"_triggerEntityIds",2),a([c()],u.prototype,"_triggerEntityLogic",2),a([c()],u.prototype,"_triggerAttribute",2),a([c()],u.prototype,"_triggerType",2),a([c()],u.prototype,"_triggerAbove",2),a([c()],u.prototype,"_triggerBelow",2),a([c()],u.prototype,"_triggerForMinutes",2),a([c()],u.prototype,"_triggerTargetValue",2),a([c()],u.prototype,"_triggerDeltaMode",2),a([c()],u.prototype,"_triggerFromState",2),a([c()],u.prototype,"_triggerToState",2),a([c()],u.prototype,"_triggerTargetChanges",2),a([c()],u.prototype,"_triggerRuntimeHours",2),a([c()],u.prototype,"_suggestedAttributes",2),a([c()],u.prototype,"_availableAttributes",2),a([c()],u.prototype,"_entityDomain",2),a([c()],u.prototype,"_lastPerformed",2),a([c()],u.prototype,"_nfcTagId",2),a([c()],u.prototype,"_availableTags",2),a([c()],u.prototype,"_responsibleUserId",2),a([c()],u.prototype,"_availableUsers",2),a([c()],u.prototype,"_checklistText",2),a([c()],u.prototype,"_scheduleTime",2),a([c()],u.prototype,"_actionService",2),a([c()],u.prototype,"_actionTargetEntity",2),a([c()],u.prototype,"_actionData",2),a([c()],u.prototype,"_actionDataJsonFallback",2),a([c()],u.prototype,"_actionTesting",2),a([c()],u.prototype,"_actionTestResult",2),a([c()],u.prototype,"_actionTestError",2),a([c()],u.prototype,"_qcNotes",2),a([c()],u.prototype,"_qcCost",2),a([c()],u.prototype,"_qcDuration",2),a([c()],u.prototype,"_qcFeedback",2),a([c()],u.prototype,"_environmentalEntity",2),a([c()],u.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",u);var f=class extends ${constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed"}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed")}_toggleCheck(t){let e=String(t);this._checklistState={...this._checklistState,[e]:!this._checklistState[e]}}_setFeedback(t){this._feedback=t}async _complete(){this._loading=!0,this._error="";try{let t={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(t.notes=this._notes),this._cost){let e=parseFloat(this._cost);!isNaN(e)&&e>=0&&(t.cost=e)}if(this._duration){let e=parseInt(this._duration,10);!isNaN(e)&&e>=0&&(t.duration=e)}this.checklist.length>0&&(t.checklist_state=this._checklistState),this.adaptiveEnabled&&(t.feedback=this._feedback),await this.hass.connection.sendMessagePromise(t),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(t){this._error=k(t,this.lang,i("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return r``;let t=this.lang||this.hass?.language||"en";return r`
      <ha-dialog open @closed=${this._close}>
  ...
  `,a([m({attribute:!1})],R.prototype,"hass",2),a([c()],R.prototype,"_open",2),a([c()],R.prototype,"_saving",2),a([c()],R.prototype,"_error",2),a([c()],R.prototype,"_draft",2);customElements.get("maintenance-history-edit-dialog")||customElements.define("maintenance-history-edit-dialog",R);function N(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function tt(n){return!n.startsWith("data:image/svg+xml,")&&!n.startsWith("data:image/png;base64,")?"":N(n)}function xt(n){return n.replace(/[/\\:*?"<>|#%]+/g,"").replace(/\s+/g,"-").toLowerCase().substring(0,100)}var A=class extends ${constructor(){super(...arguments);this.lang="en";this._open=!1;this._loading=!1;this._error="";this._viewResult=null;this._completeResult=null;this._urlMode="companion";this._entryId="";this._taskId=null;this._objectName="";this._taskName="";this._generateSeq=0}openForObject(t,e){this._entryId=t,this._taskId=null,this._objectName=e,this._taskName="",this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}openForTask(t,e,s,o){this._entryId=t,this._taskId=e,this._objectName=s,this._taskName=o,this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}async _generate(){let t=++this._generateSeq;this._loading=!0,this._error="",this._viewResult=null,this._completeResult=null;try{let e={type:"maintenance_supporter/qr/generate",entry_id:this._entryId,url_mode:this._urlMode};this._taskId&&(e.task_id=this._taskId);let s=[this.hass.connection.sendMessagePromise({...e,action:"view"})];this._taskId&&s.push(this.hass.connection.sendMessagePromise({...e,action:"complete"}));let o=await Promise.all(s);if(t!==this._generateSeq)return;this._viewResult=o[0],o.length>1&&(this._completeResult=o[1])}catch(e){if(t!==this._generateSeq)return;let s=e?.code,o=e?.message;this._error=s==="no_url"||typeof o=="string"&&o.includes("No Home Assistant URL")?i("qr_error_no_url",this.lang):i("qr_error",this.lang)}finally{t===this._generateSeq&&(this._loading=!1)}}_setUrlMode(t){this._urlMode!==t&&(this._urlMode=t,this._generate())}_print(){if(!this._viewResult)return;let t=this._viewResult,e=t.label.task_name?`${t.label.object_name} \u2014 ${t.label.task_name}`:t.label.object_name,s=[t.label.manufacturer,t.label.model].filter(Boolean).join(" "),o=window.open("","_blank","width=600,height=500");if(!o)return;let _=this.lang||"en",h=N(e),p=N(s),g=!!this._completeResult,b=N(i("qr_action_view",_)),E=N(i("qr_action_complete",_));o.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8">
<title>${h}</title>
<style>
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),o.document.close()}_downloadSvg(t,e){let s=decodeURIComponent(t.svg_data_uri.replace("data:image/svg+xml,","")),o=new Blob([s],{type:"image/svg+xml"}),_=URL.createObjectURL(o),h=document.createElement("a");h.href=_;let p=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;h.download=`qr-${xt(p)}-${e}.svg`,h.click(),URL.revokeObjectURL(_)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return r``;let t=this.lang||this.hass?.language||"en",e=this._taskName?`${i("qr_code",t)}: ${this._objectName} \u2014 ${this._taskName}`:`${i("qr_code",t)}: ${this._objectName}`,s=!!this._viewResult;return r`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${e}</div>
        <div class="content">
  ...
  `,a([m({attribute:!1})],A.prototype,"hass",2),a([m()],A.prototype,"lang",2),a([c()],A.prototype,"_open",2),a([c()],A.prototype,"_loading",2),a([c()],A.prototype,"_error",2),a([c()],A.prototype,"_viewResult",2),a([c()],A.prototype,"_completeResult",2),a([c()],A.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",A);function et(n,l){let t=n.interval_analysis,e=t?.weibull_beta,s=t?.weibull_eta;if(e==null||s==null||s<=0)return d;let o=n.interval_days??0,_=n.suggested_interval??o;return r`
      ...
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_weibull",s)}">
        ...
        ${t>0?M`
          ...
          <text x="${(F+4).toFixed(1)}" y="${(W-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${pt}%</text>
        `:d}
  ...
  `}function Et(n,l,t){let e=n.confidence_interval_low,s=n.confidence_interval_high,o=l.suggested_interval??l.interval_days??0,_=l.interval_days??0,h=Math.max(0,e-5),g=s+5-h,b=(e-h)/g*100,E=(s-e)/g*100,P=(o-h)/g*100,I=_>0?(_-h)/g*100:-1;return r`
    <div class="confidence-range">
      ...
      <div class="confidence-bar">
        ...
        <div class="confidence-marker recommended" style="left:${P.toFixed(1)}%"></div>
      </div>
  ...
  `}function it(n,l,t){let e=n.degradation_trend!=null&&n.degradation_trend!=="insufficient_data",s=n.days_until_threshold!=null,o=n.environmental_factor!=null&&n.environmental_factor!==1;if(!e&&!s&&!o)return d;let _=n.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":n.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return r`
      ...
      <div class="prediction-grid">
        ...
        ${s?r`
          <div class="prediction-item">
            ...
            ${n.threshold_prediction_date?r`<span class="prediction-date">${U(n.threshold_prediction_date,l)}</span>`:d}
        ...
        ${o&&t.environmental?r`
          <div class="prediction-item">
            ...
            ${n.environmental_entity?r`<span class="prediction-entity entity-link" @click=${h=>X(h,n.environmental_entity)}>${n.environmental_entity}</span>`:d}
          </div>
        `:d}
      </div>
    </div>
  `}function st(n,l,t,e){let s=Math.max(n||1,l);return r`
  ...
  `}var at=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function rt(n,l,t){if(!t.seasonal||!n.seasonal_factor||n.seasonal_factor===1)return d;let e=at.map(h=>i(h,l)),s=new Date().getMonth(),o=n.seasonal_factors||n.interval_analysis?.seasonal_factors||null,_=o&&o.length===12?o:e.map((h,p)=>{let g=n.seasonal_factor||1,b=Math.sin((p-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,g+b))});return r`
    <div class="seasonal-card-compact">
      <h4>${i("seasonal_awareness",l)}</h4>
      <div class="seasonal-mini-chart">
        ${_.map((h,p)=>{let g=h*40,b=h<.9?"low":h>1.1?"high":"normal";return r`
  ...
  `}function nt(n,l){return It(n,l)}function It(n,l){let t=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return d;let e=n.interval_analysis?.seasonal_reason,s=new Date().getMonth(),o=300,_=100,h=8,g=_-h-4,b=Math.max(...t,1.5),E=o/12,P=E*.65,I=h+g-1/b*g;return r`
  ...
  `}var v=class extends ${constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(t,e){this._entryId=t,this._taskId=e,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let e=(t.tasks||[]).find(s=>s.id===this._taskId);this._task=e??null}catch(t){this._error=k(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(e){return this._error=k(e,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-34P7O7KR.js").then(({openCompleteDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-34P7O7KR.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-34P7O7KR.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=i("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=i("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${i("reanalyze_result",this._lang)||"Recomputed"}: ${t.recommended_interval}d (${t.data_points} pts)`:i("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=k(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-34P7O7KR.js").then(({openHistoryEditDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return d;let e=this._lang;return r`
    ...
    `}_renderAdaptive(t){let e=this._lang,s=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,o=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,_=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,h=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!s&&!o&&!_&&!h?r`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${o?it(t,e,this._features):d}
        ${_?et(t,e):d}
        ${h?r`
          ${rt(t,e,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?nt(t,e):d}
        `:d}
      </div>
    `}_renderDetails(t){let e=this._lang,s=t.history||[],o=s.filter(p=>p.type==="completed"),_=o.reduce((p,g)=>p+(typeof g.cost=="number"?g.cost:0),0),h=(()=>{let p=o.map(g=>typeof g.duration=="number"?g.duration:null).filter(g=>g!=null);return p.length?Math.round(p.reduce((g,b)=>g+b,0)/p.length):null})();return r`
      <div class="details">
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?r`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-34P7O7KR.js").then(({openObjectQuickActions:o})=>{o(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${e.next_due?r`<span><strong>${i("next_due",t)||"Next due"}:</strong> ${U(e.next_due,t)}</span>`:d}
                  ${e.last_performed?r`<span><strong>${i("last_performed",t)||"Last"}:</strong> ${U(e.last_performed,t)}</span>`:d}
                  ${e.interval_days!=null?r`<span><strong>${i("interval",t)||"Interval"}:</strong> ${J(e.interval_days,e.interval_unit,t)}</span>`:d}
                </div>
              </div>
  ...
  `],a([m({attribute:!1})],v.prototype,"hass",2),a([c()],v.prototype,"_open",2),a([c()],v.prototype,"_entryId",2),a([c()],v.prototype,"_taskId",2),a([c()],v.prototype,"_task",2),a([c()],v.prototype,"_objectName",2),a([c()],v.prototype,"_busy",2),a([c()],v.prototype,"_error",2),a([c()],v.prototype,"_showSkip",2),a([c()],v.prototype,"_showReset",2),a([c()],v.prototype,"_showDetails",2),a([c()],v.prototype,"_showAdaptive",2),a([c()],v.prototype,"_skipReason",2),a([c()],v.prototype,"_resetDate",2),a([c()],v.prototype,"_features",2),a([c()],v.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",v);var H=class extends ${constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return this.hass?.language||"en"}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=k(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-34P7O7KR.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-34P7O7KR.js").then(({openCreateTaskDialog:t})=>{t(),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=i("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=k(e,this._lang)}finally{this._busy=!1}}}_onTaskClick(t){this._entryId&&import("./dialog-mount-34P7O7KR.js").then(({openTaskQuickActions:e})=>{e(this._entryId,t)})}render(){if(!this._open)return d;let t=this._lang,e=this._data,s=e?.object,o=e?.tasks||[],_=this.hass?.user?.is_admin??!0;return r`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${e&&s?r`
              <div class="header">
  ...
  `,a([m({attribute:!1})],H.prototype,"hass",2),a([c()],H.prototype,"_open",2),a([c()],H.prototype,"_entryId",2),a([c()],H.prototype,"_data",2),a([c()],H.prototype,"_busy",2),a([c()],H.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",H);var lt="maintenance-object-dialog",ct="maintenance-task-dialog",At="maintenance-history-edit-dialog",Tt="maintenance-complete-dialog",Lt="maintenance-qr-dialog",Ht="maintenance-task-quick-actions-dialog",St="maintenance-object-quick-actions-dialog";function G(){return document.querySelector("home-assistant")?.hass}function q(n){let l=document.body.querySelector(n);return l||(l=document.createElement(n),document.body.appendChild(l)),l}function z(n){let l=G();return l?(n.hass=l,!0):!1}var ot={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},B=null;function dt(n){return B||(B=n.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(l=>({features:l.features??ot.features,defaultWarningDays:l.general?.default_warning_days??7})).catch(()=>ot),B)}function Ye(){let n=q(lt);return z(n)?(n.openCreate(),!0):!1}function Je(n,l){let t=q(lt);return z(t)?(t.openEdit(n,l),!0):!1}function Xe(){let n=q(ct);if(!z(n))return!1;let l=G();return l?((async()=>{let t=await dt(l),e=n;e.checklistsEnabled=t.features.checklists,e.scheduleTimeEnabled=t.features.schedule_time,e.completionActionsEnabled=t.features.completion_actions,e.defaultWarningDays=t.defaultWarningDays,e.openCreate()})(),!0):!1}function Qe(n,l){let t=q(ct);if(!z(t))return!1;let e=G();return e?((async()=>{try{let[s,o]=await Promise.all([e.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:n}),dt(e)]),_=(s.tasks||[]).find(p=>p.id===l);if(!_){console.warn(`openEditTaskDialog: task ${l} not found in entry ${n}`);return}let h=t;h.checklistsEnabled=o.features.checklists,h.scheduleTimeEnabled=o.features.schedule_time,h.completionActionsEnabled=o.features.completion_actions,h.defaultWarningDays=o.defaultWarningDays,await h.openEdit(n,_)}catch(s){console.warn("openEditTaskDialog: failed to load task/features",s)}})(),!0):!1}function ti(n){let l=q(At);return z(l)?(l.openEdit(n),!0):!1}function ei(n){let l=q(Tt);return z(l)?(l.entryId=n.entry_id,l.taskId=n.task_id,l.taskName=n.task_name,l.checklist=n.checklist??[],l.adaptiveEnabled=!!n.adaptive_enabled,l.lang=G()?.language||"en",l.open(),!0):!1}function ii(n){let l=q(Lt);return z(l)?(l.openForTask(n.entry_id,n.task_id,n.object_name,n.task_name),!0):!1}function si(n,l){let t=q(Ht);return z(t)?(t.openFor(n,l),!0):!1}function ai(n){let l=q(St);return z(l)?(l.openFor(n),!0):!1}export{ei as openCompleteDialog,Ye as openCreateObjectDialog,Xe as openCreateTaskDialog,Je as openEditObjectDialog,Qe as openEditTaskDialog,ti as openHistoryEditDialog,ai as openObjectQuickActions,ii as openQrDialog,si as openTaskQuickActions};
