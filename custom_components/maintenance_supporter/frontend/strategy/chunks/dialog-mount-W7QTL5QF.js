...
import{a as w,b as r,c as z,d as c,e as E,f as g,g as l,i as s,j as it,k as st,l as N,m as rt,n as nt,o as J,p as at,q as ot,r as lt,s as dt,t as I}from"./chunk-TRW3CRLS.js";import{a as n,b as B}from"./chunk-UHANDS57.js";var T=class extends E{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1}_onInput(t){let e=t.target.value;this.value=e,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:e}}))}render(){return r`
      <label class="field">
...
`),this._requiredCompletion=[...e.required_completion_fields||[]],this._scheduleTime=e.schedule_time||"";let h=e.on_complete_action;if(h&&h.service){this._actionService=h.service;let _=h.target?.entity_id;this._actionTargetEntity=Array.isArray(_)?_[0]||"":_||"",this._actionData=h.data&&typeof h.data=="object"?{...h.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let d=e.quick_complete_defaults;this._qcNotes=d?.notes||"",this._qcCost=d?.cost!=null?String(d.cost):"",this._qcDuration=d?.duration!=null?String(d.duration):"",this._qcFeedback=d?.feedback||"";let u=e.adaptive_config||{};if(this._environmentalEntity=u.environmental_entity||"",this._environmentalAttribute=u.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,this._adaptiveEnabled=!!u.enabled,this._adaptiveAlpha=(u.ewa_alpha??.3).toString(),this._adaptiveMin=(u.min_interval_days??7).toString(),this._adaptiveMax=(u.max_interval_days??365).toString(),this._adaptiveSeasonal=u.seasonal_enabled!==!1,this._adaptivePrediction=u.sensor_prediction_enabled!==!1,this._adaptiveInitial=this._adaptiveSnapshot(),e.trigger_config){let _=e.trigger_config;this._triggerEntityId=_.entity_id||_.entity_ids&&_.entity_ids[0]||"",this._triggerEntityIds=_.entity_ids||(_.entity_id?[_.entity_id]:[]),this._triggerEntityLogic=_.entity_logic||"any",this._triggerAttribute=_.attribute||"",this._triggerType=_.type||"threshold",this._triggerAbove=_.trigger_above?.toString()||"",this._triggerBelow=_.trigger_below?.toString()||"",this._triggerForMinutes=_.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=_.trigger_target_value?.toString()||"",this._triggerDeltaMode=_.trigger_delta_mode||!1,this._triggerBaselineValue=_.trigger_baseline_value?.toString()||"",this._liveBaselineValue=e.trigger_baseline_value??null,this._autoCompleteOnRecovery=_.auto_complete_on_recovery||!1,this._triggerFromState=_.trigger_from_state||"",this._triggerToState=_.trigger_to_state||"",this._triggerTargetChanges=_.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=_.trigger_runtime_hours?.toString()||"",this._triggerOnStates=(_.trigger_on_states||[]).join(", "),_.type==="compound"?(this._compoundLogic=_.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(_.conditions||[]).map(Mt)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._readingUnit="",this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._requiredCompletion=[],this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._adaptiveEnabled=!1,this._adaptiveAlpha="0.3",this._adaptiveMin="7",this._adaptiveMax="365",this._adaptiveSeasonal=!0,this._adaptivePrediction=!0,this._adaptiveInitial=this._adaptiveSnapshot(),this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new W(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(t){console.error("Failed to load users:",t),this._availableUsers=[]}}_toggleAssignee(t){this._assigneePool=this._assigneePool.includes(t)?this._assigneePool.filter(e=>e!==t):[...this._assigneePool,t]}async _testAction(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[e,i]=t.split(".");if(!this.hass?.services?.[e]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${t}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let a=this._actionTargetEntity.trim();if(a){let h=a.split(".")[0];if(h!==e&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(e)){this._actionTestResult="error",this._actionTestError=`Service "${t}" only works on ${e}.* entities; entity "${a}" is in ${h}.* \u2014 pick a service that matches the entity domain (e.g. ${h}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[a]){this._actionTestResult="error",this._actionTestError=`Target entity "${a}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let t=JSON.parse(this._actionDataJsonFallback);if(t&&typeof t=="object"&&!Array.isArray(t))return t}catch{}return{...this._actionData}}_serviceSchema(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t))return null;let[e,i]=t.split("."),a=this.hass?.services?.[e]?.[i]?.fields;return!a||Object.keys(a).length===0?null:Object.entries(a).map(([h,d])=>({name:h,required:!!d.required,selector:d.selector||{text:{}}}))}_renderCompletionActionsSection(t){if(!this.completionActionsEnabled)return c;let e=this._serviceSchema();return r`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${i=>{this._actionService=i.detail.value||"";let a=this._serviceSchema();if(a){let h=new Set(a.map(d=>d.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([d])=>h.has(d)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
...
`).map(u=>u.trim()).filter(Boolean).slice(0,100);t.checklist=d.length?d:null}if(this.completionActionsEnabled){let d=this._actionService.trim();if(d&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(d)){let b={service:d},y=this._actionTargetEntity.trim();y&&(b.target={entity_id:y});let $=this._buildActionData();Object.keys($).length>0&&(b.data=$),t.on_complete_action=b}else t.on_complete_action=null;let u={};this._qcNotes.trim()&&(u.notes=this._qcNotes.trim());let _=parseFloat(this._qcCost);!isNaN(_)&&_>=0&&(u.cost=_);let v=parseInt(this._qcDuration,10);!isNaN(v)&&v>=0&&(u.duration=v),this._qcFeedback&&(u.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(u).length?u:null}let i=await this.hass.connection.sendMessagePromise(t),a=this._taskId||i?.task_id,h=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(a&&this._scheduleType==="sensor_based"&&h)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(a&&this._adaptiveSnapshot()!==this._adaptiveInitial){let d=parseFloat(this._adaptiveAlpha),u=parseInt(this._adaptiveMin,10),_=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:a,enabled:this._adaptiveEnabled,...d>=.1&&d<=.9?{ewa_alpha:d}:{},...!isNaN(u)&&u>=1?{min_interval_days:u}:{},...!isNaN(_)&&_>=1?{max_interval_days:_}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=I(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return c;let t=this._lang,e=this._triggerType==="compound";return r`
      ...
      ${e?this._renderCompoundEditor():r`
        ${this._entityPickerFallback?r`
          <ms-textfield
            ...
            @input=${i=>{let h=i.target.value.split(",").map(d=>d.trim()).filter(Boolean);this._triggerEntityId=h[0]||"",this._triggerEntityIds=h,h[0]&&this._fetchEntityAttributes(h[0])}}
          ></ms-textfield>
        `:r`
        <ha-form
          class="entity-picker-form"
          .hass=${this.hass}
          .schema=${[{name:"trigger_entities",selector:{entity:{multiple:!0,domain:Q}}}]}
    ...
    `}_renderCondition(t,e){let i=this._lang,a=e+1;return r`
      <div class="compound-condition">
        ...
        <ha-form
          class="entity-picker-form"
          .hass=${this.hass}
          .schema=${[{name:"condition_entities",selector:{entity:{multiple:!0,domain:Q}}}]}
          .data=${{condition_entities:t.entityIds.split(",").map(h=>h.trim()).filter(Boolean)}}
          .computeLabel=${()=>s("entity_id",i)}
          @value-changed=${h=>{let d=(h.detail.value.condition_entities||[]).filter(Boolean);this._patchCondition(e,{entityIds:d.join(", ")})}}
        ></ha-form>`}
        ...
        <div class="select-row">
          ...
          >
            ${ut.map(h=>r`<option value=${h} ?selected=${h===t.type}>${s(h,i)}</option>`)}
          </select>
        </div>
    ...
    `}_renderOnStatesField(t){let e=this._lang;return this._entityPickerFallback||!t.entityId?r`
      ...
      ></ha-form>
    `}_renderAdaptiveSection(t){return this._scheduleType==="one_time"||this._scheduleType==="manual"?c:r`
    ...
    `}_renderEnvironmentalAttribute(t){this._fetchConditionAttributes(this._environmentalEntity);let e=this._conditionAttrOptions[this._environmentalEntity];return e&&e.available.length>0?r`
      ...
      ></ms-textfield>
    `}_renderConditionAttribute(t,e){let i=this._lang,a=t.entityIds.split(",")[0]?.trim()||"";a&&this._fetchConditionAttributes(a);let h=a?this._conditionAttrOptions[a]:void 0;return h&&h.available.length>0?r`
        <div class="select-row">
          <label>${s("attribute_optional",i)}</label>
          <select
            .value=${t.attribute}
            @change=${d=>this._patchCondition(e,{attribute:d.target.value})}
          >
            <option value="" ?selected=${!t.attribute}>${s("use_entity_state",i)}</option>
            ${h.suggested.map(d=>r`<option value=${d} ?selected=${d===t.attribute}>${d} ★</option>`)}
            ${h.available.filter(d=>!h.suggested.includes(d.name)).map(d=>r`<option value=${d.name} ?selected=${d.name===t.attribute}>${d.name}${d.numeric?"":" (non-numeric)"}</option>`)}
          </select>
        </div>
      `:r`
      <ms-textfield
        ...
        .value=${t.attribute}
        @input=${d=>this._patchCondition(e,{attribute:d.target.value.trim()})}
      ></ms-textfield>
    `}_renderConditionTypeFields(t,e){let i=this._lang;if(t.type==="threshold")return r`
      ...
      `;if(t.type==="state_change"){let a=t.entityIds.split(",")[0]?.trim()||"";return r`
        ${this._renderStateField({label:s("from_state_optional",i),value:t.fromState,entityId:a,onInput:h=>this._patchCondition(e,{fromState:h})})}
        ${this._renderStateField({label:s("to_state_optional",i),value:t.toState,entityId:a,onInput:h=>this._patchCondition(e,{toState:h})})}
      ...
      `}if(t.type==="runtime"){let a=t.entityIds.split(",")[0]?.trim()||"";return r`
        ...
        ${this._renderOnStatesField({value:t.onStates,entityId:a,onInput:h=>this._patchCondition(e,{onStates:h})})}
      `}return c}_renderUnitSelect(){let t=this._lang;return r`
      <div class="select-row">
    ...
    `}_renderCalendarFields(){let t=this._lang,e=Ot(t);if(this._scheduleType==="weekdays")return r`
        ...
        <div class="select-row">
          ...
          <select .value=${this._nth} @change=${a=>this._nth=a.target.value}>
            ${i.map(([a,h])=>r`<option value=${a} ?selected=${a===this._nth}>${h}</option>`)}
          </select>
        </div>
        <div class="select-row">
          <label>${s("recurrence_weekday",t)}</label>
          <select .value=${this._nthWeekday} @change=${a=>this._nthWeekday=a.target.value}>
            ${e.map((a,h)=>r`<option value=${String(h)} ?selected=${String(h)===this._nthWeekday}>${a}</option>`)}
          </select>
        </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this._type==="reading"?r`
              ...
              `:c}
          ${this._partsLoadFailed?r`<div class="field-help parts-load-failed">${s("parts_load_failed",t)}</div>`:c}
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?r`<div class="used-parts">
                ...
                ${this.parts.map(e=>{let i=M({part_id:e.id,entry_id:e.entry_id}),a=this._usedParts[i],h=a!==void 0,d=e.entry_id?{part_id:e.id,quantity:1,entry_id:e.entry_id}:{part_id:e.id,quantity:1};return r`<div class="used-part-row">
                    <label class="used-part-check">
                      ...
                      <span
                        >${e.name}${e.owner_name?r`<span class="used-part-owner"> (${e.owner_name})</span>`:c}${e.stock!==null&&e.stock!==void 0?` (${e.stock}${e.unit?" "+e.unit:""})`:""}</span
                      >
                    </label>
                    ${h?r`<input class="used-part-qty" type="number" min="0.01" max="999" step="0.01"
                          .value=${String(a.quantity)}
                          @input=${u=>{let _=parseFloat(u.target.value);this._usedParts={...this._usedParts,[i]:{...d,quantity:Number.isFinite(_)&&_>=.01?_:1}}}} />`:c}
                  </div>`})}
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),a.document.close()}_downloadSvg(t,e){let i=decodeURIComponent(t.svg_data_uri.replace("data:image/svg+xml,","")),a=new Blob([i],{type:"image/svg+xml"}),h=URL.createObjectURL(a),d=document.createElement("a");d.href=h;let u=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;d.download=`qr-${Ut(u)}-${e}.svg`,d.click(),URL.revokeObjectURL(h)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return r``;let t=this.lang||this.hass?.language||"en",e=this._taskName?`${s("qr_code",t)}: ${this._objectName} \u2014 ${this._taskName}`:`${s("qr_code",t)}: ${this._objectName}`,i=!!this._viewResult;return r`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${e}</div>
        <div class="content">
  ...
  `}function Bt(o,p,t){let e=o.confidence_interval_low,i=o.confidence_interval_high,a=p.suggested_interval??p.interval_days??0,h=p.interval_days??0,d=Math.max(0,e-5),_=i+5-d,v=(e-d)/_*100,b=(i-e)/_*100,y=(a-d)/_*100,$=h>0?(h-d)/_*100:-1;return r`
    <div class="confidence-range">
      ...
      <div class="confidence-bar">
        ...
        ${$>=0?r`<div class="confidence-marker current" style="left:${$.toFixed(1)}%"></div>`:c}
      ...
      <div class="prediction-grid">
        ${e?r`
          <div class="prediction-item">
            ...
            ${o.degradation_rate!=null?r`<span class="prediction-rate">${o.degradation_rate>0?"+":""}${Math.abs(o.degradation_rate)>=10?Math.round(o.degradation_rate).toLocaleString():o.degradation_rate.toFixed(1)} ${o.trigger_entity_info?.unit_of_measurement||""}/${s("day_short",p)}</span>`:c}
          </div>
        `:c}
        ${i?r`
          <div class="prediction-item">
            ...
            ${o.threshold_prediction_date?r`<span class="prediction-date">${N(o.threshold_prediction_date,p)}</span>`:c}
            ${o.threshold_prediction_confidence?r`<span class="confidence-dot ${o.threshold_prediction_confidence}"></span>`:c}
          </div>
        `:c}
        ${a&&t.environmental?r`
          <div class="prediction-item">
            ...
            ${o.environmental_entity?r`<span class="prediction-entity entity-link" @click=${d=>ot(d,o.environmental_entity)}>${o.environmental_entity}</span>`:c}
          </div>
        `:c}
      </div>
    </div>
  `}function vt(o,p,t,e){let i=Math.max(o||1,p);return r`
  ...
  `}var ft=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function bt(o,p,t){if(!t.seasonal||!o.seasonal_factor||o.seasonal_factor===1)return c;let e=ft.map(d=>s(d,p)),i=new Date().getMonth(),a=o.seasonal_factors||o.interval_analysis?.seasonal_factors||null,h=a&&a.length===12?a:e.map((d,u)=>{let _=o.seasonal_factor||1,v=Math.sin((u-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,_+v))});return r`
    <div class="seasonal-card-compact">
      <h4>${s("seasonal_awareness",p)}</h4>
      <div class="seasonal-mini-chart">
        ${h.map((d,u)=>{let _=d*40,v=d<.9?"low":d>1.1?"high":"normal";return r`
  ...
  `}function yt(o,p){return Wt(o,p)}function Wt(o,p){let t=o.seasonal_factors??o.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return c;let e=o.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,h=100,d=8,_=h-d-4,v=Math.max(...t,1.5),b=a/12,y=b*.65,$=d+_-1/v*_;return r`
  ...
  `}var k=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(t,e){this._entryId=t,this._taskId=e,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let e=(t.tasks||[]).find(i=>i.id===this._taskId);this._task=e??null}catch(t){this._error=I(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(e){return this._error=I(e,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-W7QTL5QF.js").then(({openCompleteDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-W7QTL5QF.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-W7QTL5QF.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=s("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=s("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${s("reanalyze_result",this._lang)||"Recomputed"}: ${nt(t.recommended_interval,"days",this._lang)} (${t.data_points} pts)`:s("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=I(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-W7QTL5QF.js").then(({openHistoryEditDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return c;let e=this._lang;return r`
    ...
    `}_renderAdaptive(t){let e=this._lang,i=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,a=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,h=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,d=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!i&&!a&&!h&&!d?r`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${a?gt(t,e,this._features):c}
        ${h?mt(t,e):c}
        ${d?r`
          ${bt(t,e,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?yt(t,e):c}
        `:c}
      </div>
    `}_renderDetails(t){let e=this._lang,i=t.history||[],a=i.filter(u=>u.type==="completed"),h=a.reduce((u,_)=>u+(typeof _.cost=="number"?_.cost:0),0),d=(()=>{let u=a.map(_=>typeof _.duration=="number"?_.duration:null).filter(_=>_!=null);return u.length?Math.round(u.reduce((_,v)=>_+v,0)/u.length):null})();return r`
      <div class="details">
        ...
        ${i.length===0?r`<div class="history-empty">${s("history_empty",e)||"No history yet."}</div>`:r`
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(u=>{let _=["completed","reset","skipped"].includes(u.type);return r`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${u.type}">${s(u.type,e)}</span>
                        <span class="history-date">${rt(u.timestamp,e)}</span>
                        ${_?r`<button class="history-edit"
                                   title="${s("history_edit_button",e)||"Edit"}"
                                   @click=${()=>this._onEditHistoryEntry(u)}>
                              <ha-icon icon="mdi:pencil"></ha-icon>
                            </button>`:c}
                      </div>
                      ${u.notes?r`<div class="history-notes">${u.notes}</div>`:c}
                      ${u.cost!=null||u.duration!=null?r`<div class="history-meta">
                            ${u.cost!=null?r`<span>💰 ${u.cost.toFixed(2)}</span>`:c}
                            ${u.duration!=null?r`<span>⏱️ ${u.duration}m</span>`:c}
                          </div>`:c}
                    </div>
                  `})}
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?r`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-W7QTL5QF.js").then(({openObjectQuickActions:a})=>{a(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ...
                  ${e.schedule?.kind&&!["manual","one_time"].includes(e.schedule.kind)||e.interval_days!=null?r`<span><strong>${s("interval",t)||"Interval"}:</strong> ${at(e,t)}</span>`:c}
                </div>
              </div>
  ...
  `],n([g({attribute:!1})],k.prototype,"hass",2),n([l()],k.prototype,"_open",2),n([l()],k.prototype,"_entryId",2),n([l()],k.prototype,"_taskId",2),n([l()],k.prototype,"_task",2),n([l()],k.prototype,"_objectName",2),n([l()],k.prototype,"_busy",2),n([l()],k.prototype,"_error",2),n([l()],k.prototype,"_showSkip",2),n([l()],k.prototype,"_showReset",2),n([l()],k.prototype,"_showDetails",2),n([l()],k.prototype,"_showAdaptive",2),n([l()],k.prototype,"_skipReason",2),n([l()],k.prototype,"_resetDate",2),n([l()],k.prototype,"_features",2),n([l()],k.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",k);function $t(o){return!!o&&/^https?:\/\//i.test(o)}var P=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return this.hass?.language||"en"}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=I(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-W7QTL5QF.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-W7QTL5QF.js").then(({openCreateTaskDialog:t})=>{t(),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=s("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=I(e,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let e=s("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(e))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=I(e,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-W7QTL5QF.js").then(({openTaskQuickActions:e})=>{e(this._entryId,t)})}render(){if(!this._open)return c;let t=this._lang,e=this._data,i=e?.object,a=e?.tasks||[],h=this.hass?.user?.is_admin??!0;return r`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${e&&i?r`
              <div class="header">
                      ...
                      <div class="task-list">
                        ${a.map(d=>r`
                          <div class="task-row" @click=${()=>this._onTaskClick(d.id)}>
                            <span class="status-dot" style="background: ${B[d.status]||"#ccc"}"></span>
                            <span class="task-name">${d.name}</span>
                            <span class="task-status">${s(d.status||"ok",t)}</span>
                          </div>
                        `)}
                      </div>
                    `}
      ...
      <div class="meta">
        ${i.map(([a,h])=>r`
            <div class="meta-item">
              ...
              <span class="meta-value">${$t(h)?r`<a href="${h}" target="_blank" rel="noopener noreferrer">${h}</a>`:h}</span>
            </div>
          `)}
      </div>
    `}};P.styles=w`
  ...
  `,n([g({attribute:!1})],P.prototype,"hass",2),n([l()],P.prototype,"_open",2),n([l()],P.prototype,"_entryId",2),n([l()],P.prototype,"_data",2),n([l()],P.prototype,"_busy",2),n([l()],P.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",P);var kt="maintenance-object-dialog",wt="maintenance-task-dialog",Kt="maintenance-history-edit-dialog",Gt="maintenance-complete-dialog",Yt="maintenance-qr-dialog",Zt="maintenance-task-quick-actions-dialog",Jt="maintenance-object-quick-actions-dialog";function Y(){return document.querySelector("home-assistant")?.hass}function Qt(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function q(o){let p=Qt(),t=p.querySelector(o)??document.body.querySelector(o);return t?t.parentNode!==p&&p.appendChild(t):(t=document.createElement(o),p.appendChild(t)),t}function F(o){let p=Y();if(!p)return!1;o.hass=p;let t=p.language||"en";return it(t)||st(t).then(()=>{o.requestUpdate?.()}),!0}var xt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},G=null;function Et(o){return G||(G=o.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(p=>({features:p.features??xt.features,defaultWarningDays:p.general?.default_warning_days??7})).catch(()=>xt),G)}function Li(){let o=q(kt);return F(o)?(o.openCreate(),!0):!1}function Si(o,p){let t=q(kt);return F(t)?(t.openEdit(o,p),!0):!1}function Pi(){let o=q(wt);if(!F(o))return!1;let p=Y();return p?((async()=>{let t=await Et(p),e=o;e.checklistsEnabled=t.features.checklists,e.scheduleTimeEnabled=t.features.schedule_time,e.completionActionsEnabled=t.features.completion_actions,e.defaultWarningDays=t.defaultWarningDays,e.openCreate()})(),!0):!1}function Ci(o,p){let t=q(wt);if(!F(t))return!1;let e=Y();return e?((async()=>{try{let[i,a]=await Promise.all([e.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:o}),Et(e)]),h=(i.tasks||[]).find(u=>u.id===p);if(!h){console.warn(`openEditTaskDialog: task ${p} not found in entry ${o}`);return}let d=t;d.checklistsEnabled=a.features.checklists,d.scheduleTimeEnabled=a.features.schedule_time,d.completionActionsEnabled=a.features.completion_actions,d.defaultWarningDays=a.defaultWarningDays,await d.openEdit(o,h)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function Hi(o){let p=q(Kt);return F(p)?(p.openEdit(o),!0):!1}function Ri(o){let p=q(Gt);return F(p)?(p.entryId=o.entry_id,p.taskId=o.task_id,p.taskName=o.task_name,p.checklist=o.checklist??[],p.adaptiveEnabled=!!o.adaptive_enabled,p.requiredFields=o.required_completion_fields??[],p.lang=Y()?.language||"en",p.open(),!0):!1}function qi(o){let p=q(Yt);return F(p)?(p.openForTask(o.entry_id,o.task_id,o.object_name,o.task_name),!0):!1}function Fi(o,p){let t=q(Zt);return F(t)?(t.openFor(o,p),!0):!1}function Mi(o){let p=q(Jt);return F(p)?(p.openFor(o),!0):!1}export{Ri as openCompleteDialog,Li as openCreateObjectDialog,Pi as openCreateTaskDialog,Si as openEditObjectDialog,Ci as openEditTaskDialog,Hi as openHistoryEditDialog,Mi as openObjectQuickActions,qi as openQrDialog,Fi as openTaskQuickActions};
