...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,a([g({attribute:!1})],T.prototype,"hass",2),a([g()],T.prototype,"lang",2),a([l()],T.prototype,"_open",2),a([l()],T.prototype,"_loading",2),a([l()],T.prototype,"_error",2),a([l()],T.prototype,"_viewResult",2),a([l()],T.prototype,"_completeResult",2),a([l()],T.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",T);function ot(n,d){let t=n.interval_analysis,e=t?.weibull_beta,i=t?.weibull_eta;if(e==null||i==null||i<=0)return c;let o=n.interval_days??0,_=n.suggested_interval??o;return r`
    <div class="weibull-section">
      ...
      ${Pt(e,i,o,_,d)}
      ${Rt(t,d)}
      ${t?.confidence_interval_low!=null?Ft(t,n,d):c}
    </div>
  ...
  `}function Ft(n,d,t){let e=n.confidence_interval_low,i=n.confidence_interval_high,o=d.suggested_interval??d.interval_days??0,_=d.interval_days??0,p=Math.max(0,e-5),u=i+5-p,y=(e-p)/u*100,I=(i-e)/u*100,M=(o-p)/u*100,w=_>0?(_-p)/u*100:-1;return r`
  ...
  `}function ht(n,d){return Mt(n,d)}function Mt(n,d){let t=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return c;let e=n.interval_analysis?.seasonal_reason,i=new Date().getMonth(),o=300,_=100,p=8,u=_-p-4,y=Math.max(...t,1.5),I=o/12,M=I*.65,w=p+u-1/y*u;return r`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?r`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-RPXAKUED.js").then(({openObjectQuickActions:o})=>{o(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
