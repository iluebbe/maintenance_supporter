...
`),partId:H?.part_id||"",partQty:H?.quantity!=null?String(H.quantity):"",reqOverride:v.required_completion_fields!==void 0,reqFields:[...v.required_completion_fields||[]],extraParts:z.filter((M,B)=>B!==U).map(M=>({...M})),carry:L}}),this._phaseSeq=[...e.phase_sequence||[]],this._requiredCompletion=[...e.required_completion_fields||[]],this._scheduleTime=e.schedule_time||"";let h=e.on_complete_action;if(h&&h.service){this._actionService=h.service;let p=h.target?.entity_id;this._actionTargetEntity=Array.isArray(p)?p[0]||"":p||"",this._actionData=h.data&&typeof h.data=="object"?{...h.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let c=e.quick_complete_defaults;this._qcNotes=c?.notes||"",this._qcCost=c?.cost!=null?String(c.cost):"",this._qcDuration=c?.duration!=null?String(c.duration):"",this._qcFeedback=c?.feedback||"";let u=e.adaptive_config||{};if(this._environmentalEntity=u.environmental_entity||"",this._environmentalAttribute=u.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,this._adaptiveEnabled=!!u.enabled,this._adaptiveAlpha=u.ewa_alpha?.toString()??O.alpha,this._adaptiveMin=u.min_interval_days?.toString()??O.min,this._adaptiveMax=u.max_interval_days?.toString()??O.max,this._adaptiveSeasonal=u.seasonal_enabled!==!1,this._adaptivePrediction=u.sensor_prediction_enabled!==!1,this._adaptiveInitial=this._adaptiveSnapshot(),e.trigger_config){let p=e.trigger_config;this._triggerEntityId=p.entity_id||p.entity_ids&&p.entity_ids[0]||"",this._triggerEntityIds=p.entity_ids||(p.entity_id?[p.entity_id]:[]),this._triggerEntityLogic=p.entity_logic||"any",this._triggerAttribute=p.attribute||"",this._triggerType=p.type||"threshold",this._triggerAbove=p.trigger_above?.toString()||"",this._triggerBelow=p.trigger_below?.toString()||"",this._triggerEquals=p.trigger_equals?.toString()||"",this._triggerNotEquals=p.trigger_not_equals?.toString()||"",this._triggerForMinutes=p.trigger_for_minutes?.toString()||"0",this._triggerCombinator=p.trigger_combinator==="all"?"all":"any",this._triggerTargetValue=p.trigger_target_value?.toString()||"",this._triggerDeltaMode=p.trigger_delta_mode||!1,this._triggerBaselineValue=p.trigger_baseline_value?.toString()||"",this._liveBaselineValue=e.trigger_baseline_value??null,this._autoCompleteOnRecovery=p.auto_complete_on_recovery||!1,this._triggerFromState=p.trigger_from_state||"",this._triggerToState=p.trigger_to_state||"",this._triggerTargetChanges=p.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=p.trigger_runtime_hours?.toString()||"",this._triggerRuntimeMaxSession=p.trigger_runtime_max_session_seconds?.toString()||"",this._triggerOnStates=(p.trigger_on_states||[]).join(", "),p.type==="compound"?(this._compoundLogic=p.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(p.conditions||[]).map(Qt)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._requireTagScan=!1,this._allowSkip=!0,this._readingUnit="",this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._phaseDefs=[],this._phaseSeq=[],this._requiredCompletion=[],this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._adaptiveEnabled=!1,this._adaptiveAlpha=O.alpha,this._adaptiveMin=O.min,this._adaptiveMax=O.max,this._adaptiveSeasonal=!0,this._adaptivePrediction=!0,this._adaptiveInitial=this._adaptiveSnapshot(),this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerEquals="",this._triggerNotEquals="",this._triggerForMinutes="0",this._triggerCombinator="any",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerRuntimeMaxSession="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new J(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(t){console.error("Failed to load users:",t),this._availableUsers=[]}}_toggleAssignee(t){this._assigneePool=this._assigneePool.includes(t)?this._assigneePool.filter(e=>e!==t):[...this._assigneePool,t]}async _testAction(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[e,i]=t.split(".");if(!this.hass?.services?.[e]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${t}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let r=this._actionTargetEntity.trim();if(r){let h=r.split(".")[0];if(h!==e&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(e)){this._actionTestResult="error",this._actionTestError=`Service "${t}" only works on ${e}.* entities; entity "${r}" is in ${h}.* \u2014 pick a service that matches the entity domain (e.g. ${h}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[r]){this._actionTestResult="error",this._actionTestError=`Target entity "${r}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let t=JSON.parse(this._actionDataJsonFallback);if(t&&typeof t=="object"&&!Array.isArray(t))return t}catch{}return{...this._actionData}}_serviceSchema(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t))return null;let[e,i]=t.split("."),r=this.hass?.services?.[e]?.[i]?.fields;return!r||Object.keys(r).length===0?null:Object.entries(r).map(([h,c])=>({name:h,required:!!c.required,selector:c.selector||{text:{}}}))}_renderCompletionActionsSection(t){if(!this.completionActionsEnabled)return _;let e=this._serviceSchema();return n`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${i=>{this._actionService=i.detail.value||"";let r=this._serviceSchema();if(r){let h=new Set(r.map(c=>c.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([c])=>h.has(c)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
        ...
        <div class="phase-def">
          <div class="phase-def-head">
            ...
            ${this.parts.length?n`
              ...
              >
                <option value="">—</option>
                ${this.parts.map(r=>n`<option value=${r.id} ?selected=${r.id===i.partId}>${r.name}</option>`)}
              </select>
              ${i.partId?n`
              ...
              ${it.map(r=>n`
                <label class="req-option">
                  <input
                    ...
                    @change=${h=>{let c=h.target.checked,u=new Set(i.reqFields);c?u.add(r):u.delete(r),this._patchPhaseDef(i.id,{reqFields:[...u]})}}
                  />
                  <span>${s(Y[r],t)}</span>
                </label>
              `)}
...
`).map(u=>u.trim()).filter(Boolean).slice(0,100);t.checklist=c.length?c:null}if(this.completionActionsEnabled){let c=this._actionService.trim();if(c&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(c)){let y={service:c},$=this._actionTargetEntity.trim();$&&(y.target={entity_id:$});let f=this._buildActionData();Object.keys(f).length>0&&(y.data=f),t.on_complete_action=y}else t.on_complete_action=null;let u={};this._qcNotes.trim()&&(u.notes=this._qcNotes.trim());let p=parseFloat(this._qcCost);!isNaN(p)&&p>=0&&(u.cost=p);let v=parseInt(this._qcDuration,10);!isNaN(v)&&v>=0&&(u.duration=v),this._qcFeedback&&(u.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(u).length?u:null}let i=await this.hass.connection.sendMessagePromise(t),r=this._taskId||i?.task_id,h=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(r&&this._scheduleType==="sensor_based"&&h)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:r,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(r&&this._adaptiveSnapshot()!==this._adaptiveInitial){let c=parseFloat(this._adaptiveAlpha),u=parseInt(this._adaptiveMin,10),p=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:r,enabled:this._adaptiveEnabled,...c>=.1&&c<=.9?{ewa_alpha:c}:{},...!isNaN(u)&&u>=1?{min_interval_days:u}:{},...!isNaN(p)&&p>=1?{max_interval_days:p}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=T(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return _;let t=this._lang,e=this._triggerType==="compound";return n`
      ...
      <div class="select-row">
        ...
        >
          ${Wt.map(i=>n`<option value=${i} ?selected=${i===this._triggerType}>${s(i,t)}</option>`)}
        </select>
      </div>
      ${e?this._renderCompoundEditor():n`
        ${this._entityPickerFallback?n`
          <ms-textfield
            ...
            @input=${i=>{let h=i.target.value.split(",").map(c=>c.trim()).filter(Boolean);this._triggerEntityId=h[0]||"",this._triggerEntityIds=h,h[0]&&this._fetchEntityAttributes(h[0])}}
          ></ms-textfield>
        `:n`
        <ha-form
      ...
      ${this._intervalDays?n`
          ...
          `:_}
    `}_patchCondition(t,e){this._compoundConditions=this._compoundConditions.map((i,r)=>r===t?{...i,...e}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Kt()]}_removeCondition(t){this._compoundConditions=this._compoundConditions.filter((e,i)=>i!==t)}_renderCompoundEditor(){let t=this._lang;return n`
      <div class="select-row">
    ...
    `}_renderCondition(t,e){let i=this._lang,r=e+1;return n`
      <div class="compound-condition">
        ...
        ${this._entityPickerFallback?n`
          <ms-textfield
            ...
            .value=${t.entityIds}
            @input=${h=>this._patchCondition(e,{entityIds:h.target.value})}
          ></ms-textfield>
        `:n`
        <ha-form
          class="entity-picker-form"
          ...
          @value-changed=${h=>{let c=(h.detail.value.condition_entities||[]).filter(Boolean);this._patchCondition(e,{entityIds:c.join(", ")})}}
        ></ha-form>`}
        ...
        <div class="select-row">
          ...
          <select
            .value=${t.type}
            @change=${h=>this._patchCondition(e,{type:h.target.value})}
          >
            ${xt.map(h=>n`<option value=${h} ?selected=${h===t.type}>${s(h,i)}</option>`)}
          </select>
        </div>
    ...
    `}_renderEnvironmentalAttribute(t){this._fetchConditionAttributes(this._environmentalEntity);let e=this._conditionAttrOptions[this._environmentalEntity];return this._renderAttributeSelect({label:s("environmental_attribute_optional",t),value:this._environmentalAttribute,suggested:e?.suggested??[],available:e?.available??[],onSelect:i=>this._environmentalAttribute=i})}_renderConditionAttribute(t,e){let i=t.entityIds.split(",")[0]?.trim()||"";i&&this._fetchConditionAttributes(i);let r=i?this._conditionAttrOptions[i]:void 0;return this._renderAttributeSelect({label:s("attribute_optional",this._lang),value:t.attribute,suggested:r?.suggested??[],available:r?.available??[],onSelect:h=>this._patchCondition(e,{attribute:h})})}_renderConditionTypeFields(t,e){let i=this._lang;if(t.type==="threshold")return n`
      ...
      `;if(t.type==="state_change"){let r=t.entityIds.split(",")[0]?.trim()||"";return n`
        ${this._renderStateField({label:s("from_state_optional",i),value:t.fromState,entityId:r,onInput:h=>this._patchCondition(e,{fromState:h})})}
        ${this._renderStateField({label:s("to_state_optional",i),value:t.toState,entityId:r,onInput:h=>this._patchCondition(e,{toState:h})})}
        <ms-textfield label="${s("target_changes",i)}" type="number" .value=${t.targetChanges}
          @input=${h=>this._patchCondition(e,{targetChanges:h.target.value})}></ms-textfield>
      `}if(t.type==="runtime"){let r=t.entityIds.split(",")[0]?.trim()||"";return n`
        <ms-textfield label="${s("runtime_hours",i)}" type="number" .value=${t.runtimeHours}
          @input=${h=>this._patchCondition(e,{runtimeHours:h.target.value})}></ms-textfield>
        ${this._renderOnStatesField({value:t.onStates,entityId:r,onInput:h=>this._patchCondition(e,{onStates:h})})}
    ...
    `}_buildSchedule(){let t=i=>{let r=parseInt(this._calOffset,10)||0;return r&&(i.offset=Math.max(-15,Math.min(r,15))),i};if(this._scheduleType==="weekdays")return t({kind:"weekdays",weekdays:[...this._weekdays].sort((i,r)=>i-r)});if(this._scheduleType==="nth_weekday")return t({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let e={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(e.business=!0),t(e)}_recurrenceExtras(){let t={};if(this._seasonMonths.length&&(t.season_months=[...this._seasonMonths].sort((e,i)=>e-i)),this._endsMode==="count"){let e=parseInt(this._endsCount,10);e>=1&&(t.ends={count:e})}else this._endsMode==="until"&&this._endsUntil&&(t.ends={until:this._endsUntil});return t}_toggleSeasonMonth(t){this._seasonMonths=this._seasonMonths.includes(t)?this._seasonMonths.filter(e=>e!==t):[...this._seasonMonths,t]}_renderRecurrenceExtras(){let t=this._lang;if(!(this._scheduleType==="time_based"||st.includes(this._scheduleType)))return _;let i=Jt(t);return n`
      ...
      ${this._endsMode==="until"?n`
        ...
        ></ms-date-field>`:_}
    `}_renderCalendarFields(){let t=this._lang,e=Zt(t);if(this._scheduleType==="weekdays")return n`
        ...
        <div class="select-row">
          ...
          <select .value=${this._nth} @change=${r=>this._nth=r.target.value}>
            ${i.map(([r,h])=>n`<option value=${r} ?selected=${r===this._nth}>${h}</option>`)}
          </select>
        </div>
        <div class="select-row">
          <label>${s("recurrence_weekday",t)}</label>
          <select .value=${this._nthWeekday} @change=${r=>this._nthWeekday=r.target.value}>
            ${e.map((r,h)=>n`<option value=${String(h)} ?selected=${String(h)===this._nthWeekday}>${r}</option>`)}
          </select>
        </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Ut.map(i=>n`<option value=${i} ?selected=${i===this._type}>${s(i,t)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${Vt.map(i=>n`<option value=${i} ?selected=${i===this._priority}>${s("priority_"+i,t)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${Bt.map(i=>n`<option value=${i} ?selected=${i===this._scheduleType}>${s(i,t)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="sensor_based"?n`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:yt,device_class:$t}}}]}
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?n`<div class="used-parts">
                ...
                ${this.parts.map(e=>{let i=N({part_id:e.id,entry_id:e.entry_id}),r=this._usedParts[i],h=r!==void 0,c=e.entry_id?{part_id:e.id,quantity:1,entry_id:e.entry_id}:{part_id:e.id,quantity:1};return n`<div class="used-part-row">
                    <label class="used-part-check">
                      <input type="checkbox" .checked=${h}
                        @change=${u=>{let p={...this._usedParts};u.target.checked?p[i]=p[i]||c:delete p[i],this._usedParts=p}} />
                      <span
                    ...
                    ${h?n`<input class="used-part-qty" type="number" min="0.01" max="999" step="0.01"
                          .value=${String(r.quantity)}
                          @input=${u=>{let p=parseFloat(u.target.value);this._usedParts={...this._usedParts,[i]:{...c,quantity:Number.isFinite(p)&&p>=.01?p:1}}}} />`:_}
                  </div>`})}
  ...
  `],o([g({attribute:!1})],b.prototype,"hass",2),o([g()],b.prototype,"entryId",2),o([g()],b.prototype,"taskId",2),o([g()],b.prototype,"taskName",2),o([g()],b.prototype,"lang",2),o([g({type:Array})],b.prototype,"checklist",2),o([g({type:Boolean})],b.prototype,"adaptiveEnabled",2),o([g()],b.prototype,"taskType",2),o([g()],b.prototype,"readingUnit",2),o([g({attribute:!1})],b.prototype,"restockDefault",2),o([g({attribute:!1})],b.prototype,"restockUnitCost",2),o([g()],b.prototype,"currencySymbol",2),o([g({attribute:!1})],b.prototype,"parts",2),o([g({attribute:!1})],b.prototype,"consumesParts",2),o([g({type:Array})],b.prototype,"consumesInfo",2),o([g({type:Array})],b.prototype,"requiredFields",2),o([g()],b.prototype,"phaseLabel",2),o([g({type:Boolean})],b.prototype,"requireTagScan",2),o([g({type:Boolean})],b.prototype,"viaTagScan",2),o([d()],b.prototype,"_open",2),o([d()],b.prototype,"_notes",2),o([d()],b.prototype,"_cost",2),o([d()],b.prototype,"_duration",2),o([d()],b.prototype,"_loading",2),o([d()],b.prototype,"_error",2),o([d()],b.prototype,"_checklistState",2),o([d()],b.prototype,"_feedback",2),o([d()],b.prototype,"_photoDocId",2),o([d()],b.prototype,"_photoPreview",2),o([d()],b.prototype,"_photoUploading",2),o([d()],b.prototype,"_readingValue",2),o([d()],b.prototype,"_restockQty",2),o([d()],b.prototype,"_completedAt",2),o([d()],b.prototype,"_usedParts",2),o([g({attribute:!1})],b.prototype,"checklistPrefill",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",b);var C=class extends S{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null;this._partOptions=null;this._partQty={};this._partQtyOriginal=""}get _lang(){return A(this.hass)}openEdit(t){this._draft={...t},this._originalSnapshot={...t},this._error="",this._open=!0,this._partOptions=null,this._partQty={},this._partQtyOriginal="",this._loadPartOptions()}async _loadPartOptions(){let t=this._draft;if(t)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"}),i=[];for(let h of e.parts||[]){let c=h.entry_id===t.entry_id,u=h.consumers.some(p=>p.entry_id===t.entry_id&&p.task_id===t.task_id);!c&&!u||i.push({part_id:h.part_id,name:h.name,entry_id:h.entry_id,foreign:!c,object_name:h.object_name})}for(let h of t.used_parts||[]){let c=h.entry_id||t.entry_id;i.some(u=>u.part_id===h.part_id&&u.entry_id===c)||i.push({part_id:h.part_id,name:h.name||h.part_id,entry_id:c,foreign:c!==t.entry_id,object_name:null})}let r={};for(let h of t.used_parts||[])r[`${h.entry_id||t.entry_id}:${h.part_id}`]=h.quantity??1;this._partOptions=i,this._partQty=r,this._partQtyOriginal=this._partSelectionKey()}catch{this._partOptions=[]}}_partSelectionKey(){return JSON.stringify(Object.entries(this._partQty).filter(([,t])=>t>0).sort(([t],[e])=>t.localeCompare(e)))}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null}_set(t,e){this._draft&&(this._draft={...this._draft,[t]:e})}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{let t={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(t.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(t.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(t.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(t.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(t.completed_by=this._draft.completed_by),this._partOptions!==null&&this._partSelectionKey()!==this._partQtyOriginal&&(t.used_parts=(this._partOptions||[]).filter(i=>(this._partQty[`${i.entry_id}:${i.part_id}`]||0)>0).map(i=>({part_id:i.part_id,quantity:this._partQty[`${i.entry_id}:${i.part_id}`],...i.foreign?{entry_id:i.entry_id}:{}}))),Object.keys(t).filter(i=>!["type","entry_id","task_id","original_timestamp"].includes(i)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(t),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=T(t,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return _;let t=this._lang,e=this._draft;return n`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ...
        ${this._partOptions&&this._partOptions.length>0?n`
          <div class="parts-block">
            ...
            ${this._partOptions.map(i=>{let r=`${i.entry_id}:${i.part_id}`,h=this._partQty[r]||0;return n`
    ...
    .part-qty { width: 76px; }
  `,o([g({attribute:!1})],C.prototype,"hass",2),o([d()],C.prototype,"_open",2),o([d()],C.prototype,"_saving",2),o([d()],C.prototype,"_error",2),o([d()],C.prototype,"_draft",2),o([d()],C.prototype,"_partOptions",2),o([d()],C.prototype,"_partQty",2);customElements.get("maintenance-history-edit-dialog")||customElements.define("maintenance-history-edit-dialog",C);function kt(a,l,t){let e=new Blob([a],{type:t}),i=URL.createObjectURL(e),r=document.createElement("a");r.href=i,r.download=l,r.target="_blank",r.rel="noopener",r.style.display="none",document.body.appendChild(r),r.dispatchEvent(new MouseEvent("click")),document.body.removeChild(r),setTimeout(()=>URL.revokeObjectURL(i),6e4)}function K(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function wt(a){return!a.startsWith("data:image/svg+xml,")&&!a.startsWith("data:image/png;base64,")?"":K(a)}function Xt(a){return a.replace(/[/\\:*?"<>|#%]+/g,"").replace(/\s+/g,"-").toLowerCase().substring(0,100)}var P=class extends S{constructor(){super(...arguments);this.lang="en";this._open=!1;this._loading=!1;this._error="";this._viewResult=null;this._completeResult=null;this._urlMode="companion";this._entryId="";this._taskId=null;this._objectName="";this._taskName="";this._generateSeq=0}openForObject(t,e){this._entryId=t,this._taskId=null,this._objectName=e,this._taskName="",this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}openForTask(t,e,i,r){this._entryId=t,this._taskId=e,this._objectName=i,this._taskName=r,this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}async _generate(){let t=++this._generateSeq;this._loading=!0,this._error="",this._viewResult=null,this._completeResult=null;try{let e={type:"maintenance_supporter/qr/generate",entry_id:this._entryId,url_mode:this._urlMode};this._taskId&&(e.task_id=this._taskId);let i=[this.hass.connection.sendMessagePromise({...e,action:"view"})];this._taskId&&i.push(this.hass.connection.sendMessagePromise({...e,action:"complete"}));let r=await Promise.all(i);if(t!==this._generateSeq)return;this._viewResult=r[0],r.length>1&&(this._completeResult=r[1])}catch(e){if(t!==this._generateSeq)return;let i=e?.code,r=e?.message;this._error=i==="no_url"||typeof r=="string"&&r.includes("No Home Assistant URL")?s("qr_error_no_url",this.lang):s("qr_error",this.lang)}finally{t===this._generateSeq&&(this._loading=!1)}}_setUrlMode(t){this._urlMode!==t&&(this._urlMode=t,this._generate())}_print(){if(!this._viewResult)return;let t=this._viewResult,e=t.label.task_name?`${t.label.object_name} \u2014 ${t.label.task_name}`:t.label.object_name,i=[t.label.manufacturer,t.label.model].filter(Boolean).join(" "),r=window.open("","_blank","width=600,height=500");if(!r)return;let h=this.lang||"en",c=K(e),u=K(i),p=!!this._completeResult,v=K(s("qr_action_view",h)),y=K(s("qr_action_complete",h));r.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8">
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,o([g({attribute:!1})],P.prototype,"hass",2),o([g()],P.prototype,"lang",2),o([d()],P.prototype,"_open",2),o([d()],P.prototype,"_loading",2),o([d()],P.prototype,"_error",2),o([d()],P.prototype,"_viewResult",2),o([d()],P.prototype,"_completeResult",2),o([d()],P.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",P);function Et(a){let l=a.getFullYear(),t=String(a.getMonth()+1).padStart(2,"0"),e=String(a.getDate()).padStart(2,"0");return`${l}-${t}-${e}`}function te(a,l){if(l<=0)return 0;let t=typeof a=="number"&&Number.isFinite(a)?Math.trunc(a):0;return t<0?0:t%l}function ee(a){return!!(a?.phases&&a.phase_sequence&&a.phase_sequence.length>0)}function at(a){if(!a||!ee(a))return null;let l=a.phase_sequence,t=te(a.phase_cursor,l.length),e=l[t],i=a.phases?.[e];return i?{id:e,name:i.name,index:t,count:l.length,notes:i.notes,checklist:i.checklist!==void 0?i.checklist:a.checklist??[],consumesParts:i.consumes_parts!==void 0?i.consumes_parts:a.consumes_parts??[],requiredFields:i.required_completion_fields!==void 0?i.required_completion_fields:a.required_completion_fields??[]}:null}function Q(a){let l=at(a);return l?`${l.index+1}/${l.count} \xB7 ${l.name}`:""}function It(a){let l=a.task??null,t=l?at(l):null,e=t?t.consumesParts:l?.consumes_parts||[],i=!!l?.part_ref,r=a.objects.find(u=>u.entry_id===a.entryId)?.parts||[],h=i?r.find(u=>u.id===l.part_ref.part_id):void 0,c=a.checklistsEnabled??!0;return{entry_id:a.entryId,task_id:a.taskId,task_name:a.taskName,checklist:t?c?t.checklist:[]:a.checklist??[],adaptive_enabled:!!a.adaptiveEnabled,required_completion_fields:t?t.requiredFields:l?.required_completion_fields||[],task_type:l?.type||"",reading_unit:l?.reading_unit||"",parts:i?[]:bt({consumes_parts:e},a.entryId,a.objects,a.lang),consumes_parts:i?[]:e,phase_label:t?Q(l):"",require_tag_scan:!!l?.require_tag_scan,restock_default:i?h?.restock_quantity??1:null,restock_unit_cost:i?h?.cost??null:null,currency_symbol:a.currencySymbol??"",consumes_info:e.map(u=>ft(u,a.entryId,a.objects,a.lang)),checklist_prefill:l?.checklist_progress||{},via_tag_scan:!!a.viaTagScan}}function St(a,l,t){a.entryId=l.entry_id,a.taskId=l.task_id,a.taskName=l.task_name,a.lang=t,a.checklist=l.checklist??[],a.adaptiveEnabled=!!l.adaptive_enabled,a.requiredFields=l.required_completion_fields??[],a.taskType=l.task_type??"",a.readingUnit=l.reading_unit??"",a.parts=l.parts??[],a.consumesParts=l.consumes_parts??[],a.phaseLabel=l.phase_label??"",a.requireTagScan=!!l.require_tag_scan,a.restockDefault=l.restock_default??null,a.restockUnitCost=l.restock_unit_cost??null,a.currencySymbol=l.currency_symbol??"",a.consumesInfo=l.consumes_info??[],a.checklistPrefill=l.checklist_prefill??{},a.viaTagScan=!!l.via_tag_scan,a.open({viaTagScan:!!l.via_tag_scan})}function Tt(a,l){let t=a.interval_analysis,e=t?.weibull_beta,i=t?.weibull_eta;if(e==null||i==null||i<=0)return _;let r=a.interval_days??0,h=a.suggested_interval??r;return n`
    <div class="weibull-section">
      ...
      ${se(e,i,r,h,l)}
      ${re(t,l)}
      ${t?.confidence_interval_low!=null?ae(t,a,l):_}
    </div>
  `}function ie(a,l){let t,e,i;return a<.8?(t="early_failures",e="M13,14H11V10H13M13,18H11V16H13M1,21H23L12,2L1,21Z",i="beta_early_failures"):a<=1.2?(t="random_failures",e="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M13,17H11V15H13V17M13,13H11V7H13V13Z",i="beta_random_failures"):a<=3.5?(t="wear_out",e="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M12,6A6,6 0 0,1 18,12H12V6Z",i="beta_wear_out"):(t="highly_predictable",e="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M11,16.5L18,9.5L16.59,8.09L11,13.67L7.91,10.59L6.5,12L11,16.5Z",i="beta_highly_predictable"),n`
    <span class="beta-badge ${t}">
      <ha-svg-icon path="${e}"></ha-svg-icon>
      ${s(i,l)} (\u03B2=${a.toFixed(2)})
    </span>
  `}function se(a,l,t,e,i){let f=Math.max(t,e,l,1)*1.3,w=50,L=[];for(let q=0;q<=w;q++){let R=q/w*f,jt=1-Math.exp(-Math.pow(R/l,a)),Dt=32+R/f*260,zt=136-jt*128;L.push([Dt,zt])}let z=L.map(([q,R])=>`${q.toFixed(1)},${R.toFixed(1)}`).join(" "),U="M32,136 "+L.map(([q,R])=>`L${q.toFixed(1)},${R.toFixed(1)}`).join(" ")+` L${L[w][0].toFixed(1)},136 Z`,H=32+t/f*260,M=1-Math.exp(-Math.pow(t/l,a)),B=136-M*128,Mt=((1-M)*100).toFixed(0),lt=32+e/f*260,Ot=[0,.25,.5,.75,1];return n`
      ...
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",i)}">
        ...
        ${t>0?W`
          ...
          <text x="${(H+4).toFixed(1)}" y="${(B-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${Mt}%</text>
        `:_}
  ...
  `}function ae(a,l,t){let e=a.confidence_interval_low,i=a.confidence_interval_high,r=l.suggested_interval??l.interval_days??0,h=l.interval_days??0,c=Math.max(0,e-5),p=i+5-c,v=(e-c)/p*100,y=(i-e)/p*100,$=(r-c)/p*100,f=h>0?(h-c)/p*100:-1;return n`
      ...
      <div class="prediction-grid">
        ...
        ${r&&t.environmental?n`
          <div class="prediction-item">
            ...
            ${a.environmental_entity?n`<span class="prediction-entity entity-link" @click=${c=>_t(c,a.environmental_entity)}>${a.environmental_entity}</span>`:_}
          </div>
        `:_}
      </div>
    </div>
  `}function Pt(a,l,t,e){let i=Math.max(a||1,l);return n`
    <div class="interval-comparison">
      <div class="interval-bar">
        <div class="interval-label">
          ${s("current",e)}: ${a??"\u2014"} ${a!=null?s("days",e):""}
        </div>
  ...
  `}function Ct(a,l){return ne(a,l)}function ne(a,l){let t=a.seasonal_factors??a.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return _;let e=a.interval_analysis?.seasonal_reason,i=new Date().getMonth(),r=300,h=100,c=8,p=h-c-4,v=Math.max(...t,1.5),y=r/12,$=y*.65,f=c+p-1/v*p;return n`
  ...
  `}var k=class extends S{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return A(this.hass)}async openFor(t,e){this._entryId=t,this._taskId=e,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=Et(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._currencySymbol=t?.budget?.currency_symbol||"",this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let e=(t.tasks||[]).find(i=>i.id===this._taskId);this._task=e??null}catch(t){this._error=T(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(e){return this._error=T(e,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-7KY77CFR.js").then(async({openCompleteDialog:t})=>{let e=this._task,i=[];try{i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}t(It({entryId:this._entryId,taskId:this._taskId,taskName:e.name,task:e,objects:i,lang:this._lang,checklist:e.checklist||[],adaptiveEnabled:!!e.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-7KY77CFR.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-7KY77CFR.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=s("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=s("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${s("reanalyze_result",this._lang)||"Recomputed"}: ${ht(t.recommended_interval,"days",this._lang)} (${t.data_points} pts)`:s("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=T(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-7KY77CFR.js").then(({openHistoryEditDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null,used_parts:t.used_parts??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return _;let e=this._lang;return n`
    ...
    `}_renderAdaptive(t){let e=this._lang,i=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,r=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,h=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,c=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!i&&!r&&!h&&!c?n`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${r?At(t,e,this._features):_}
        ${h?Tt(t,e):_}
        ${c?n`
          ${qt(t,e,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?Ct(t,e):_}
        `:_}
      </div>
    `}_renderDetails(t){let e=this._lang,i=t.history||[],r=i.filter(u=>u.type==="completed"),h=r.reduce((u,p)=>u+(typeof p.cost=="number"?p.cost:0),0),c=(()=>{let u=r.map(p=>typeof p.duration=="number"?p.duration:null).filter(p=>p!=null);return u.length?Math.round(u.reduce((p,v)=>p+v,0)/u.length):null})();return n`
      <div class="details">
        ...
        ${i.length===0?n`<div class="history-empty">${s("history_empty",e)||"No history yet."}</div>`:n`
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(u=>{let p=["completed","reset","skipped"].includes(u.type);return n`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${u.type}">${s(u.type,e)}</span>
                        <span class="history-date">${pt(u.timestamp,e)}</span>
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?n`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-7KY77CFR.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${e.next_due?n`<span><strong>${s("next_due",t)||"Next due"}:</strong> ${V(e.next_due,t)}</span>`:_}
                  ${e.last_performed?n`<span><strong>${s("last_performed",t)||"Last"}:</strong> ${V(e.last_performed,t)}</span>`:_}
                  ${e.schedule?.kind&&!["manual","one_time"].includes(e.schedule.kind)||e.interval_days!=null?n`<span><strong>${s("interval",t)||"Interval"}:</strong> ${ut(e,t)}</span>`:_}
                  ${Q(e)?n`<span><strong>${s("phase_current",t)}:</strong> ${Q(e)}</span>`:_}
                </div>
              </div>
  ...
  `],o([g({attribute:!1})],k.prototype,"hass",2),o([d()],k.prototype,"_open",2),o([d()],k.prototype,"_entryId",2),o([d()],k.prototype,"_taskId",2),o([d()],k.prototype,"_task",2),o([d()],k.prototype,"_objectName",2),o([d()],k.prototype,"_busy",2),o([d()],k.prototype,"_error",2),o([d()],k.prototype,"_showSkip",2),o([d()],k.prototype,"_showReset",2),o([d()],k.prototype,"_showDetails",2),o([d()],k.prototype,"_showAdaptive",2),o([d()],k.prototype,"_skipReason",2),o([d()],k.prototype,"_resetDate",2),o([d()],k.prototype,"_features",2),o([d()],k.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",k);function Ht(a){return!!a&&/^https?:\/\//i.test(a)}function Rt(a){return a?customElements.get("ha-markdown")?n`<ha-markdown class="notes-md" .content=${a} breaks></ha-markdown>`:n`${a}`:_}var F=class extends S{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return A(this.hass)}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=T(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-7KY77CFR.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-7KY77CFR.js").then(({openCreateTaskDialog:t})=>{t(this._entryId),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=s("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=T(e,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let e=s("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(e))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=T(e,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-7KY77CFR.js").then(({openTaskQuickActions:e})=>{e(this._entryId,t)})}render(){if(!this._open)return _;let t=this._lang,e=this._data,i=e?.object,r=e?.tasks||[],h=this.hass?.user?.is_admin??!0;return n`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${e&&i?n`
              <div class="header">
              ...
              ${i.notes?n`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${Rt(i.notes)}</div>
                    </div>
                  `:_}
      ...
      <div class="meta">
        ${i.map(([r,h])=>n`
            <div class="meta-item">
              ...
              <span class="meta-value">${Ht(h)?n`<a href="${h}" target="_blank" rel="noopener noreferrer">${h}</a>`:h}</span>
            </div>
          `)}
      </div>
    `}};F.styles=I`
  ...
  `,o([g({attribute:!1})],F.prototype,"hass",2),o([d()],F.prototype,"_open",2),o([d()],F.prototype,"_entryId",2),o([d()],F.prototype,"_data",2),o([d()],F.prototype,"_busy",2),o([d()],F.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",F);var Nt="maintenance-object-dialog",Ft="maintenance-task-dialog",oe="maintenance-history-edit-dialog",le="maintenance-complete-dialog",de="maintenance-qr-dialog",ce="maintenance-task-quick-actions-dialog",pe="maintenance-object-quick-actions-dialog";function X(){return document.querySelector("home-assistant")?.hass}function he(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function j(a){let l=he(),t=l.querySelector(a)??document.body.querySelector(a);return t?t.parentNode!==l&&l.appendChild(t):(t=document.createElement(a),l.appendChild(t)),t}function D(a){let l=X();if(!l)return!1;a.hass=l;let t=A(l);return dt(t)||ct(t).then(()=>{a.requestUpdate?.()}),!0}var nt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"};function ps(a){return ot(a).then(l=>l.rowActionStyle)}function hs(){G=null}var G=null;function ot(a){return G||(G=a.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(l=>({features:l.features??nt.features,defaultWarningDays:l.general?.default_warning_days??7,rowActionStyle:l.general?.row_action_style??nt.rowActionStyle})).catch(()=>nt),G)}function us(){let a=j(Nt);return D(a)?(a.openCreate(),!0):!1}function _s(a,l){let t=j(Nt);return D(t)?(t.openEdit(a,l),!0):!1}function ms(a="",l){let t=j(Ft);if(!D(t))return!1;let e=X();return e?((async()=>{let i=await ot(e),r=t;r.checklistsEnabled=i.features.checklists,r.scheduleTimeEnabled=i.features.schedule_time,r.completionActionsEnabled=i.features.completion_actions,r.defaultWarningDays=i.defaultWarningDays,r.openCreate(a,l)})(),!0):!1}function gs(a,l){let t=j(Ft);if(!D(t))return!1;let e=X();return e?((async()=>{try{let[i,r]=await Promise.all([e.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:a}),ot(e)]),h=(i.tasks||[]).find(u=>u.id===l);if(!h){console.warn(`openEditTaskDialog: task ${l} not found in entry ${a}`);return}let c=t;c.checklistsEnabled=r.features.checklists,c.scheduleTimeEnabled=r.features.schedule_time,c.completionActionsEnabled=r.features.completion_actions,c.defaultWarningDays=r.defaultWarningDays,await c.openEdit(a,h)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function vs(a){let l=j(oe);return D(l)?(l.openEdit(a),!0):!1}function fs(a){let l=j(le);return D(l)?(St(l,a,X()?.language||"en"),!0):!1}function bs(a){let l=j(de);return D(l)?(l.openForTask(a.entry_id,a.task_id,a.object_name,a.task_name),!0):!1}function ys(a,l){let t=j(ce);return D(t)?(t.openFor(a,l),!0):!1}function $s(a){let l=j(pe);return D(l)?(l.openFor(a),!0):!1}export{hs as __resetSettingsCacheForTests,ps as getRowActionStyle,fs as openCompleteDialog,us as openCreateObjectDialog,ms as openCreateTaskDialog,_s as openEditObjectDialog,gs as openEditTaskDialog,vs as openHistoryEditDialog,$s as openObjectQuickActions,bs as openQrDialog,ys as openTaskQuickActions};
