...
`),this._scheduleTime=e.schedule_time||"";let s=e.on_complete_action;if(s&&s.service){this._actionService=s.service;let d=s.target?.entity_id;this._actionTargetEntity=Array.isArray(d)?d[0]||"":d||"",this._actionData=s.data&&typeof s.data=="object"?{...s.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let c=e.quick_complete_defaults;this._qcNotes=c?.notes||"",this._qcCost=c?.cost!=null?String(c.cost):"",this._qcDuration=c?.duration!=null?String(c.duration):"",this._qcFeedback=c?.feedback||"";let _=e.adaptive_config||{};if(this._environmentalEntity=_.environmental_entity||"",this._environmentalAttribute=_.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,e.trigger_config){let d=e.trigger_config;this._triggerEntityId=d.entity_id||"",this._triggerEntityIds=d.entity_ids||(d.entity_id?[d.entity_id]:[]),this._triggerEntityLogic=d.entity_logic||"any",this._triggerAttribute=d.attribute||"",this._triggerType=d.type||"threshold",this._triggerAbove=d.trigger_above?.toString()||"",this._triggerBelow=d.trigger_below?.toString()||"",this._triggerForMinutes=d.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=d.trigger_target_value?.toString()||"",this._triggerDeltaMode=d.trigger_delta_mode||!1,this._triggerFromState=d.trigger_from_state||"",this._triggerToState=d.trigger_to_state||"",this._triggerTargetChanges=d.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=d.trigger_runtime_hours?.toString()||""}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._intervalAnchor="completion",this._notes="",this._documentationUrl="",this._customIcon="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._responsibleUserId=null,this._checklistText="",this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours=""}async _loadUsers(){this._userService||(this._userService=new O(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(t){console.error("Failed to load users:",t),this._availableUsers=[]}}async _testAction(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[e,s]=t.split(".");if(!this.hass?.services?.[e]?.[s]){this._actionTestResult="error",this._actionTestError=`Service "${t}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let c=this._actionTargetEntity.trim();if(c){let _=c.split(".")[0];if(_!==e&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(e)){this._actionTestResult="error",this._actionTestError=`Service "${t}" only works on ${e}.* entities; entity "${c}" is in ${_}.* \u2014 pick a service that matches the entity domain (e.g. ${_}.${s})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[c]){this._actionTestResult="error",this._actionTestError=`Target entity "${c}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let t=JSON.parse(this._actionDataJsonFallback);if(t&&typeof t=="object"&&!Array.isArray(t))return t}catch{}return{...this._actionData}}_serviceSchema(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t))return null;let[e,s]=t.split("."),c=this.hass?.services?.[e]?.[s]?.fields;return!c||Object.keys(c).length===0?null:Object.entries(c).map(([_,d])=>({name:_,required:!!d.required,selector:d.selector||{text:{}}}))}_renderCompletionActionsSection(t){if(!this.completionActionsEnabled)return p;let e=this._serviceSchema();return r`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${s=>{this._actionService=s.detail.value||"";let c=this._serviceSchema();if(c){let _=new Set(c.map(d=>d.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([d])=>_.has(d)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
...
`).map(d=>d.trim()).filter(Boolean).slice(0,100);t.checklist=_.length?_:null}if(this.completionActionsEnabled){let _=this._actionService.trim();if(_&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(_)){let b={service:_},E=this._actionTargetEntity.trim();E&&(b.target={entity_id:E});let z=this._buildActionData();Object.keys(z).length>0&&(b.data=z),t.on_complete_action=b}else t.on_complete_action=null;let d={};this._qcNotes.trim()&&(d.notes=this._qcNotes.trim());let u=parseFloat(this._qcCost);!isNaN(u)&&u>=0&&(d.cost=u);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(d.duration=g),this._qcFeedback&&(d.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(d).length?d:null}let e=await this.hass.connection.sendMessagePromise(t),s=this._taskId||e?.task_id,c=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(s&&this._scheduleType==="sensor_based"&&c)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:s,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=k(t,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return p;let t=this._lang;return r`
      ...
      <div class="select-row">
        ...
        >
          ${ft.map(e=>r`<option value=${e} ?selected=${e===this._triggerType}>${i(e,t)}</option>`)}
        </select>
      </div>
        ...
        <div class="content">
          ...
          ${this._scheduleType==="time_based"?r`
                ...
                <div class="select-row">
                  ...
                  <select
                    .value=${this._intervalUnit}
                    @change=${s=>this._intervalUnit=s.target.value}
                  >
                    ${["days","weeks","months","years"].map(s=>r`<option value=${s} ?selected=${s===this._intervalUnit}>${i("unit_"+s,t)}</option>`)}
                  </select>
                </div>
                <div class="select-row">
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),c.document.close()}_downloadSvg(t,e){let s=decodeURIComponent(t.svg_data_uri.replace("data:image/svg+xml,","")),c=new Blob([s],{type:"image/svg+xml"}),_=URL.createObjectURL(c),d=document.createElement("a");d.href=_;let u=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;d.download=`qr-${bt(u)}-${e}.svg`,d.click(),URL.revokeObjectURL(_)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return r``;let t=this.lang||this.hass?.language||"en",e=this._taskName?`${i("qr_code",t)}: ${this._objectName} \u2014 ${this._taskName}`:`${i("qr_code",t)}: ${this._objectName}`,s=!!this._viewResult;return r`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${e}</div>
        <div class="content">
  ...
  `}function kt(n,o,t){let e=n.confidence_interval_low,s=n.confidence_interval_high,c=o.suggested_interval??o.interval_days??0,_=o.interval_days??0,d=Math.max(0,e-5),g=s+5-d,b=(e-d)/g*100,E=(s-e)/g*100,z=(c-d)/g*100,I=_>0?(_-d)/g*100:-1;return r`
  ...
  `}function it(n,o,t){let e=n.degradation_trend!=null&&n.degradation_trend!=="insufficient_data",s=n.days_until_threshold!=null,c=n.environmental_factor!=null&&n.environmental_factor!==1;if(!e&&!s&&!c)return p;let _=n.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":n.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return r`
      ...
      <div class="prediction-grid">
        ...
        ${s?r`
          <div class="prediction-item">
            ...
            ${n.threshold_prediction_date?r`<span class="prediction-date">${U(n.threshold_prediction_date,o)}</span>`:p}
        ...
        ${c&&t.environmental?r`
          <div class="prediction-item">
            ...
            ${n.environmental_entity?r`<span class="prediction-entity entity-link" @click=${d=>X(d,n.environmental_entity)}>${n.environmental_entity}</span>`:p}
          </div>
        `:p}
      </div>
    </div>
  `}function st(n,o,t,e){let s=Math.max(n||1,o);return r`
  ...
  `}var at=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function rt(n,o,t){if(!t.seasonal||!n.seasonal_factor||n.seasonal_factor===1)return p;let e=at.map(d=>i(d,o)),s=new Date().getMonth(),c=n.seasonal_factors||n.interval_analysis?.seasonal_factors||null,_=c&&c.length===12?c:e.map((d,u)=>{let g=n.seasonal_factor||1,b=Math.sin((u-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,g+b))});return r`
    <div class="seasonal-card-compact">
      <h4>${i("seasonal_awareness",o)}</h4>
      <div class="seasonal-mini-chart">
        ${_.map((d,u)=>{let g=d*40,b=d<.9?"low":d>1.1?"high":"normal";return r`
            <div class="seasonal-bar ${b} ${u===s?"current":""}"
                 style="height: ${g}px"
  ...
  `}function nt(n,o){return wt(n,o)}function wt(n,o){let t=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return p;let e=n.interval_analysis?.seasonal_reason,s=new Date().getMonth(),c=300,_=100,d=8,g=_-d-4,b=Math.max(...t,1.5),E=c/12,z=E*.65,I=d+g-1/b*g;return r`
  ...
  `}var v=class extends ${constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(t,e){this._entryId=t,this._taskId=e,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let e=(t.tasks||[]).find(s=>s.id===this._taskId);this._task=e??null}catch(t){this._error=k(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(e){return this._error=k(e,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-UVXNG56T.js").then(({openCompleteDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-UVXNG56T.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-UVXNG56T.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=i("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=i("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${i("reanalyze_result",this._lang)||"Recomputed"}: ${t.recommended_interval}d (${t.data_points} pts)`:i("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=k(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-UVXNG56T.js").then(({openHistoryEditDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return p;let e=this._lang;return r`
    ...
    `}_renderAdaptive(t){let e=this._lang,s=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,c=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,_=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,d=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!s&&!c&&!_&&!d?r`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${c?it(t,e,this._features):p}
        ${_?et(t,e):p}
        ${d?r`
          ${rt(t,e,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?nt(t,e):p}
        `:p}
      </div>
    `}_renderDetails(t){let e=this._lang,s=t.history||[],c=s.filter(u=>u.type==="completed"),_=c.reduce((u,g)=>u+(typeof g.cost=="number"?g.cost:0),0),d=(()=>{let u=c.map(g=>typeof g.duration=="number"?g.duration:null).filter(g=>g!=null);return u.length?Math.round(u.reduce((g,b)=>g+b,0)/u.length):null})();return r`
      <div class="details">
        ...
        ${s.length===0?r`<div class="history-empty">${i("history_empty",e)||"No history yet."}</div>`:r`
              <div class="history-list">
                ${[...s].reverse().slice(0,20).map(u=>{let g=["completed","reset","skipped"].includes(u.type);return r`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${u.type}">${i(u.type,e)}</span>
                        <span class="history-date">${Y(u.timestamp,e)}</span>
                      ...
                      ${u.notes?r`<div class="history-notes">${u.notes}</div>`:p}
                      ${u.cost!=null||u.duration!=null?r`<div class="history-meta">
                            ${u.cost!=null?r`<span>💰 ${u.cost.toFixed(2)}</span>`:p}
                            ${u.duration!=null?r`<span>⏱️ ${u.duration}m</span>`:p}
                          </div>`:p}
                    </div>
                  `})}
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?r`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-UVXNG56T.js").then(({openObjectQuickActions:c})=>{c(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${e.next_due?r`<span><strong>${i("next_due",t)||"Next due"}:</strong> ${U(e.next_due,t)}</span>`:p}
                  ${e.last_performed?r`<span><strong>${i("last_performed",t)||"Last"}:</strong> ${U(e.last_performed,t)}</span>`:p}
                  ${e.interval_days!=null?r`<span><strong>${i("interval",t)||"Interval"}:</strong> ${J(e.interval_days,e.interval_unit,t)}</span>`:p}
                </div>
              </div>
      ...
      <div class="meta">
        ${s.map(([c,_])=>r`
            <div class="meta-item">
              ...
              <span class="meta-value">${c.toLowerCase().includes("doc")||c.toLowerCase().includes("url")?r`<a href="${_}" target="_blank" rel="noopener">${_}</a>`:_}</span>
            </div>
          `)}
      </div>
    `}};H.styles=x`
  ...
  `,a([m({attribute:!1})],H.prototype,"hass",2),a([l()],H.prototype,"_open",2),a([l()],H.prototype,"_entryId",2),a([l()],H.prototype,"_data",2),a([l()],H.prototype,"_busy",2),a([l()],H.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",H);var lt="maintenance-object-dialog",ct="maintenance-task-dialog",Et="maintenance-history-edit-dialog",It="maintenance-complete-dialog",At="maintenance-qr-dialog",Tt="maintenance-task-quick-actions-dialog",Lt="maintenance-object-quick-actions-dialog";function G(){return document.querySelector("home-assistant")?.hass}function q(n){let o=document.body.querySelector(n);return o||(o=document.createElement(n),document.body.appendChild(o)),o}function P(n){let o=G();return o?(n.hass=o,!0):!1}var ot={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},B=null;function dt(n){return B||(B=n.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(o=>({features:o.features??ot.features,defaultWarningDays:o.general?.default_warning_days??7})).catch(()=>ot),B)}function Ke(){let n=q(lt);return P(n)?(n.openCreate(),!0):!1}function Ze(n,o){let t=q(lt);return P(t)?(t.openEdit(n,o),!0):!1}function Ye(){let n=q(ct);if(!P(n))return!1;let o=G();return o?((async()=>{let t=await dt(o),e=n;e.checklistsEnabled=t.features.checklists,e.scheduleTimeEnabled=t.features.schedule_time,e.completionActionsEnabled=t.features.completion_actions,e.defaultWarningDays=t.defaultWarningDays,e.openCreate()})(),!0):!1}function Je(n,o){let t=q(ct);if(!P(t))return!1;let e=G();return e?((async()=>{try{let[s,c]=await Promise.all([e.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:n}),dt(e)]),_=(s.tasks||[]).find(u=>u.id===o);if(!_){console.warn(`openEditTaskDialog: task ${o} not found in entry ${n}`);return}let d=t;d.checklistsEnabled=c.features.checklists,d.scheduleTimeEnabled=c.features.schedule_time,d.completionActionsEnabled=c.features.completion_actions,d.defaultWarningDays=c.defaultWarningDays,await d.openEdit(n,_)}catch(s){console.warn("openEditTaskDialog: failed to load task/features",s)}})(),!0):!1}function Xe(n){let o=q(Et);return P(o)?(o.openEdit(n),!0):!1}function Qe(n){let o=q(It);return P(o)?(o.entryId=n.entry_id,o.taskId=n.task_id,o.taskName=n.task_name,o.checklist=n.checklist??[],o.adaptiveEnabled=!!n.adaptive_enabled,o.lang=G()?.language||"en",o.open(),!0):!1}function ti(n){let o=q(At);return P(o)?(o.openForTask(n.entry_id,n.task_id,n.object_name,n.task_name),!0):!1}function ei(n,o){let t=q(Tt);return P(t)?(t.openFor(n,o),!0):!1}function ii(n){let o=q(Lt);return P(o)?(o.openFor(n),!0):!1}export{Qe as openCompleteDialog,Ke as openCreateObjectDialog,Ye as openCreateTaskDialog,Ze as openEditObjectDialog,Je as openEditTaskDialog,Xe as openHistoryEditDialog,ii as openObjectQuickActions,ti as openQrDialog,ei as openTaskQuickActions};
