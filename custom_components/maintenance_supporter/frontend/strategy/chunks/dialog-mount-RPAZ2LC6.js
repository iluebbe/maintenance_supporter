...
import"./chunk-GQKBAEU2.js";import{a as S,b as a,c as Y,d as _,e as T,f as g,g as d,i as s,k as L,l as pt,m as ht,n as ut,o as P,p as _t,q as W,r as mt,s as gt,t as it,u as vt,v as ft,w as bt,x as yt,y as $t,z as A}from"./chunk-YJEJC7WW.js";import{a as o,b as X}from"./chunk-T7MMFTA7.js";var I=class extends T{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(t){let i=t.target.value;this.value=i,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:i}}))}render(){return a`
      <label class="field">
...
`).map(u=>u.trim()).filter(Boolean).slice(0,100);t.checklist=c.length?c:null}if(this.completionActionsEnabled){let c=this._actionService.trim();if(c&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(c)){let y={service:c},$=this._actionTargetEntity.trim();$&&(y.target={entity_id:$});let f=this._buildActionData();Object.keys(f).length>0&&(y.data=f),t.on_complete_action=y}else t.on_complete_action=null;let u={};this._qcNotes.trim()&&(u.notes=this._qcNotes.trim());let p=parseFloat(this._qcCost);!isNaN(p)&&p>=0&&(u.cost=p);let v=parseInt(this._qcDuration,10);!isNaN(v)&&v>=0&&(u.duration=v),this._qcFeedback&&(u.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(u).length?u:null}let e=await this.hass.connection.sendMessagePromise(t),r=this._taskId||e?.task_id,h=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(r&&this._scheduleType==="sensor_based"&&h)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:r,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(r&&this._adaptiveSnapshot()!==this._adaptiveInitial){let c=parseFloat(this._adaptiveAlpha),u=parseInt(this._adaptiveMin,10),p=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:r,enabled:this._adaptiveEnabled,...c>=.1&&c<=.9?{ewa_alpha:c}:{},...!isNaN(u)&&u>=1?{min_interval_days:u}:{},...!isNaN(p)&&p>=1?{max_interval_days:p}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=A(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return _;let t=this._lang,i=this._triggerType==="compound";return a`
      ...
      <div class="select-row">
        ...
        >
          ${Zt.map(e=>a`<option value=${e} ?selected=${e===this._triggerType}>${s(e,t)}</option>`)}
        </select>
      </div>
      ${i?this._renderCompoundEditor():a`
        ...
        <ha-form
          ...
          .hass=${this.hass}
          .schema=${[{name:"trigger_entities",selector:{entity:{multiple:!0,domain:st}}}]}
      ...
      ${this._intervalDays?a`
          ...
          `:_}
    `}_patchCondition(t,i){this._compoundConditions=this._compoundConditions.map((e,r)=>r===t?{...e,...i}:e)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Jt()]}_removeCondition(t){this._compoundConditions=this._compoundConditions.filter((i,e)=>e!==t)}_renderCompoundEditor(){let t=this._lang;return a`
      <div class="select-row">
    ...
    `}_renderCondition(t,i){let e=this._lang,r=i+1;return a`
      <div class="compound-condition">
        ...
        <ha-form
          class="entity-picker-form"
          .hass=${this.hass}
          .schema=${[{name:"condition_entities",selector:{entity:{multiple:!0,domain:st}}}]}
        ...
        <div class="select-row">
          ...
          >
            ${St.map(h=>a`<option value=${h} ?selected=${h===t.type}>${s(h,e)}</option>`)}
          </select>
        </div>
    ...
    `}_buildSchedule(){let t=e=>{let r=parseInt(this._calOffset,10)||0;return r&&(e.offset=Math.max(-15,Math.min(r,15))),e};if(this._scheduleType==="weekdays")return t({kind:"weekdays",weekdays:[...this._weekdays].sort((e,r)=>e-r)});if(this._scheduleType==="nth_weekday")return t({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let i={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(i.business=!0),t(i)}_recurrenceExtras(){let t={};if(this._seasonMonths.length&&(t.season_months=[...this._seasonMonths].sort((i,e)=>i-e)),this._endsMode==="count"){let i=parseInt(this._endsCount,10);i>=1&&(t.ends={count:i})}else this._endsMode==="until"&&this._endsUntil&&(t.ends={until:this._endsUntil});return t}_toggleSeasonMonth(t){this._seasonMonths=this._seasonMonths.includes(t)?this._seasonMonths.filter(i=>i!==t):[...this._seasonMonths,t]}_renderRecurrenceExtras(){let t=this._lang;if(!(this._scheduleType==="time_based"||nt.includes(this._scheduleType)))return _;let e=se(t);return a`
      ...
      ${this._endsMode==="until"?a`
        ...
        ></ms-date-field>`:_}
    `}_renderCalendarFields(){let t=this._lang,i=ie(t);if(this._scheduleType==="weekdays")return a`
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Yt.map(e=>a`<option value=${e} ?selected=${e===this._type}>${s(e,t)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${Qt.map(e=>a`<option value=${e} ?selected=${e===this._priority}>${s("priority_"+e,t)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${Gt.map(e=>a`<option value=${e} ?selected=${e===this._scheduleType}>${s(e,t)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="sensor_based"?a`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:Et,device_class:It}}}]}
    ...
    `}};m._PREVIEW_RELEVANT=new Set(["_open","_scheduleType","_intervalDays","_intervalUnit","_intervalAnchor","_dueDate","_weekdays","_nth","_nthWeekday","_domDay","_domLastDay","_domBusiness","_calOffset","_seasonMonths","_endsMode","_endsCount","_endsUntil","_lastPerformed"]),m.styles=S`
    .dialog-title {
      font-size: 18px;
      font-weight: 500;
      padding-bottom: 12px;
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?a`<div class="used-parts">
                ...
                ${this.parts.map(i=>{let e=O({part_id:i.id,entry_id:i.entry_id}),r=this._usedParts[e],h=r!==void 0,c=i.entry_id?{part_id:i.id,quantity:1,entry_id:i.entry_id}:{part_id:i.id,quantity:1};return a`<div class="used-part-row">
        ...
        <div class="dialog-actions">
          ...
          <ha-button
            ...
            title=${this._missingRequired.length?this._missingRequired.map(i=>s("err_required",t).replace("{field}",s(G[i]??i,t))).join(" \xB7 "):""}
          >
  ...
  `],o([g({attribute:!1})],b.prototype,"hass",2),o([g()],b.prototype,"entryId",2),o([g()],b.prototype,"taskId",2),o([g()],b.prototype,"taskName",2),o([g()],b.prototype,"lang",2),o([g({type:Array})],b.prototype,"checklist",2),o([g({type:Boolean})],b.prototype,"adaptiveEnabled",2),o([g()],b.prototype,"taskType",2),o([g()],b.prototype,"readingUnit",2),o([g({attribute:!1})],b.prototype,"restockDefault",2),o([g({attribute:!1})],b.prototype,"restockUnitCost",2),o([g()],b.prototype,"currencySymbol",2),o([g({attribute:!1})],b.prototype,"parts",2),o([g({attribute:!1})],b.prototype,"consumesParts",2),o([g({type:Array})],b.prototype,"consumesInfo",2),o([g({type:Array})],b.prototype,"requiredFields",2),o([g()],b.prototype,"phaseLabel",2),o([g({type:Boolean})],b.prototype,"requireTagScan",2),o([g({type:Boolean})],b.prototype,"viaTagScan",2),o([d()],b.prototype,"_open",2),o([d()],b.prototype,"_notes",2),o([d()],b.prototype,"_cost",2),o([d()],b.prototype,"_duration",2),o([d()],b.prototype,"_loading",2),o([d()],b.prototype,"_error",2),o([d()],b.prototype,"_checklistState",2),o([d()],b.prototype,"_feedback",2),o([d()],b.prototype,"_photoDocId",2),o([d()],b.prototype,"_photoPreview",2),o([d()],b.prototype,"_photoUploading",2),o([d()],b.prototype,"_readingValue",2),o([d()],b.prototype,"_restockQty",2),o([d()],b.prototype,"_completedAt",2),o([d()],b.prototype,"_usedParts",2),o([g({attribute:!1})],b.prototype,"checklistPrefill",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",b);var R=class extends T{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null;this._partOptions=null;this._partQty={};this._partQtyOriginal=""}get _lang(){return L(this.hass)}openEdit(t){this._draft={...t},this._originalSnapshot={...t},this._error="",this._open=!0,this._partOptions=null,this._partQty={},this._partQtyOriginal="",this._loadPartOptions()}async _loadPartOptions(){let t=this._draft;if(t)try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"}),e=[];for(let h of i.parts||[]){let c=h.entry_id===t.entry_id,u=h.consumers.some(p=>p.entry_id===t.entry_id&&p.task_id===t.task_id);!c&&!u||e.push({part_id:h.part_id,name:h.name,entry_id:h.entry_id,foreign:!c,object_name:h.object_name})}for(let h of t.used_parts||[]){let c=h.entry_id||t.entry_id;e.some(u=>u.part_id===h.part_id&&u.entry_id===c)||e.push({part_id:h.part_id,name:h.name||h.part_id,entry_id:c,foreign:c!==t.entry_id,object_name:null})}let r={};for(let h of t.used_parts||[])r[`${h.entry_id||t.entry_id}:${h.part_id}`]=h.quantity??1;this._partOptions=e,this._partQty=r,this._partQtyOriginal=this._partSelectionKey()}catch{this._partOptions=[]}}_partSelectionKey(){return JSON.stringify(Object.entries(this._partQty).filter(([,t])=>t>0).sort(([t],[i])=>t.localeCompare(i)))}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null}_set(t,i){this._draft&&(this._draft={...this._draft,[t]:i})}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{let t={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(t.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(t.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(t.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(t.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(t.completed_by=this._draft.completed_by),this._partOptions!==null&&this._partSelectionKey()!==this._partQtyOriginal&&(t.used_parts=(this._partOptions||[]).filter(e=>(this._partQty[`${e.entry_id}:${e.part_id}`]||0)>0).map(e=>({part_id:e.part_id,quantity:this._partQty[`${e.entry_id}:${e.part_id}`],...e.foreign?{entry_id:e.entry_id}:{}}))),Object.keys(t).filter(e=>!["type","entry_id","task_id","original_timestamp"].includes(e)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(t),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=A(t,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return _;let t=this._lang,i=this._draft;return a`
    ...
    .part-qty { width: 76px; }
  `,o([g({attribute:!1})],R.prototype,"hass",2),o([d()],R.prototype,"_open",2),o([d()],R.prototype,"_saving",2),o([d()],R.prototype,"_error",2),o([d()],R.prototype,"_draft",2),o([d()],R.prototype,"_partOptions",2),o([d()],R.prototype,"_partQty",2);customElements.get("maintenance-history-edit-dialog")||customElements.define("maintenance-history-edit-dialog",R);function Tt(n,l,t){let i=new Blob([n],{type:t}),e=URL.createObjectURL(i),r=document.createElement("a");r.href=e,r.download=l,r.target="_blank",r.rel="noopener",r.style.display="none",document.body.appendChild(r),r.dispatchEvent(new MouseEvent("click")),document.body.removeChild(r),setTimeout(()=>URL.revokeObjectURL(e),6e4)}function Q(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function At(n){return!n.startsWith("data:image/svg+xml,")&&!n.startsWith("data:image/png;base64,")?"":Q(n)}function re(n){return n.replace(/[/\\:*?"<>|#%]+/g,"").replace(/\s+/g,"-").toLowerCase().substring(0,100)}var q=class extends T{constructor(){super(...arguments);this.lang="en";this._open=!1;this._loading=!1;this._error="";this._viewResult=null;this._completeResult=null;this._urlMode="companion";this._entryId="";this._taskId=null;this._objectName="";this._taskName="";this._generateSeq=0}openForObject(t,i){this._entryId=t,this._taskId=null,this._objectName=i,this._taskName="",this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}openForTask(t,i,e,r){this._entryId=t,this._taskId=i,this._objectName=e,this._taskName=r,this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}async _generate(){let t=++this._generateSeq;this._loading=!0,this._error="",this._viewResult=null,this._completeResult=null;try{let i={type:"maintenance_supporter/qr/generate",entry_id:this._entryId,url_mode:this._urlMode};this._taskId&&(i.task_id=this._taskId);let e=[this.hass.connection.sendMessagePromise({...i,action:"view"})];this._taskId&&e.push(this.hass.connection.sendMessagePromise({...i,action:"complete"}));let r=await Promise.all(e);if(t!==this._generateSeq)return;this._viewResult=r[0],r.length>1&&(this._completeResult=r[1])}catch(i){if(t!==this._generateSeq)return;let e=i?.code,r=i?.message;this._error=e==="no_url"||typeof r=="string"&&r.includes("No Home Assistant URL")?s("qr_error_no_url",this.lang):s("qr_error",this.lang)}finally{t===this._generateSeq&&(this._loading=!1)}}_setUrlMode(t){this._urlMode!==t&&(this._urlMode=t,this._generate())}_print(){if(!this._viewResult)return;let t=this._viewResult,i=t.label.task_name?`${t.label.object_name} \u2014 ${t.label.task_name}`:t.label.object_name,e=[t.label.manufacturer,t.label.model].filter(Boolean).join(" "),r=window.open("","_blank","width=600,height=500");if(!r)return;let h=this.lang||"en",c=Q(i),u=Q(e),p=!!this._completeResult,v=Q(s("qr_action_view",h)),y=Q(s("qr_action_complete",h));r.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8">
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,o([g({attribute:!1})],q.prototype,"hass",2),o([g()],q.prototype,"lang",2),o([d()],q.prototype,"_open",2),o([d()],q.prototype,"_loading",2),o([d()],q.prototype,"_error",2),o([d()],q.prototype,"_viewResult",2),o([d()],q.prototype,"_completeResult",2),o([d()],q.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",q);function Pt(n){let l=n.getFullYear(),t=String(n.getMonth()+1).padStart(2,"0"),i=String(n.getDate()).padStart(2,"0");return`${l}-${t}-${i}`}function ne(n,l){if(l<=0)return 0;let t=typeof n=="number"&&Number.isFinite(n)?Math.trunc(n):0;return t<0?0:t%l}function ae(n){return!!(n?.phases&&n.phase_sequence&&n.phase_sequence.length>0)}function ot(n){if(!n||!ae(n))return null;let l=n.phase_sequence,t=ne(n.phase_cursor,l.length),i=l[t],e=n.phases?.[i];return e?{id:i,name:e.name,index:t,count:l.length,notes:e.notes,checklist:e.checklist!==void 0?e.checklist:n.checklist??[],consumesParts:e.consumes_parts!==void 0?e.consumes_parts:n.consumes_parts??[],requiredFields:e.required_completion_fields!==void 0?e.required_completion_fields:n.required_completion_fields??[]}:null}function Z(n){let l=ot(n);return l?`${l.index+1}/${l.count} \xB7 ${l.name}`:""}function Lt(n){let l=n.task??null,t=l?ot(l):null,i=t?t.consumesParts:l?.consumes_parts||[],e=!!l?.part_ref,r=n.objects.find(u=>u.entry_id===n.entryId)?.parts||[],h=e?r.find(u=>u.id===l.part_ref.part_id):void 0,c=n.checklistsEnabled??!0;return{entry_id:n.entryId,task_id:n.taskId,task_name:n.taskName,checklist:t?c?t.checklist:[]:n.checklist??[],adaptive_enabled:!!n.adaptiveEnabled,required_completion_fields:t?t.requiredFields:l?.required_completion_fields||[],task_type:l?.type||"",reading_unit:l?.reading_unit||"",parts:e?[]:wt({consumes_parts:i},n.entryId,n.objects,n.lang),consumes_parts:e?[]:i,phase_label:t?Z(l):"",require_tag_scan:!!l?.require_tag_scan,restock_default:e?h?.restock_quantity??1:null,restock_unit_cost:e?h?.cost??null:null,currency_symbol:n.currencySymbol??"",consumes_info:i.map(u=>kt(u,n.entryId,n.objects,n.lang)),checklist_prefill:l?.checklist_progress||{},via_tag_scan:!!n.viaTagScan}}function qt(n,l,t){n.entryId=l.entry_id,n.taskId=l.task_id,n.taskName=l.task_name,n.lang=t,n.checklist=l.checklist??[],n.adaptiveEnabled=!!l.adaptive_enabled,n.requiredFields=l.required_completion_fields??[],n.taskType=l.task_type??"",n.readingUnit=l.reading_unit??"",n.parts=l.parts??[],n.consumesParts=l.consumes_parts??[],n.phaseLabel=l.phase_label??"",n.requireTagScan=!!l.require_tag_scan,n.restockDefault=l.restock_default??null,n.restockUnitCost=l.restock_unit_cost??null,n.currencySymbol=l.currency_symbol??"",n.consumesInfo=l.consumes_info??[],n.checklistPrefill=l.checklist_prefill??{},n.viaTagScan=!!l.via_tag_scan,n.open({viaTagScan:!!l.via_tag_scan})}function x(n){return n.toFixed(1)}function Ct(n,l){let t=n.interval_analysis,i=t?.weibull_beta,e=t?.weibull_eta;if(i==null||e==null||e<=0)return _;let r=n.interval_days??0,h=n.suggested_interval??r;return a`
      ...
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",e)}">
        ${Vt.map(H=>{let M=136-H*128;return Y`
            ...
            <text x="${28}" y="${x(M+3)}" fill="var(--secondary-text-color)"
              font-size="8" text-anchor="end">${P(H*100,e,0)}%</text>
          `})}
        ...
        <path d="${B}" fill="var(--primary-color, #03a9f4)" opacity="0.08" />
        ...
        ${t>0?Y`
          ...
          <circle cx="${x(N)}" cy="${x(K)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${x(N+4)}" y="${x(K-6)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${Ut}%</text>
        `:_}

        ${i>0&&i!==t?Y`
          <line x1="${x(ct)}" y1="${8}" x2="${x(ct)}" y2="${x(136)}"
    ...
    <div class="weibull-info-row">
      ...
      ${n.weibull_r_squared!=null?a`
        <div class="weibull-info-item">
          ...
          <span class="weibull-info-value">${P(n.weibull_r_squared,l,3)}</span>
        </div>
      `:_}
    </div>
  `}function ce(n,l,t){let i=n.confidence_interval_low,e=n.confidence_interval_high,r=l.suggested_interval??l.interval_days??0,h=l.interval_days??0,c=Math.max(0,i-5),p=e+5-c,v=(i-c)/p*100,y=(e-i)/p*100,$=(r-c)/p*100,f=h>0?(h-c)/p*100:-1;return a`
      ...
      <div class="prediction-grid">
        ${i?a`
          <div class="prediction-item">
            ...
            ${n.degradation_rate!=null?a`<span class="prediction-rate">${n.degradation_rate>0?"+":""}${P(n.degradation_rate,l,Math.abs(n.degradation_rate)>=10?0:1)} ${n.trigger_entity_info?.unit_of_measurement||""}/${s("day_short",l)}</span>`:_}
          </div>
        `:_}
        ${e?a`
          <div class="prediction-item">
            ...
            ${n.threshold_prediction_date?a`<span class="prediction-date">${W(n.threshold_prediction_date,l)}</span>`:_}
        ...
        ${r&&t.environmental?a`
          <div class="prediction-item">
            ...
            <span class="prediction-value">${P(n.environmental_factor,l,2)}x</span>
            ${n.environmental_entity?a`<span class="prediction-entity entity-link" @click=${c=>bt(c,n.environmental_entity)}>${n.environmental_entity}</span>`:_}
          </div>
        `:_}
      </div>
    </div>
  `}function Rt(n,l,t,i){let e=Math.max(n||1,l);return a`
  ...
  `}function Ot(n,l){return pe(n,l)}function pe(n,l){let t=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return _;let i=n.interval_analysis?.seasonal_reason,e=new Date().getMonth(),r=300,h=100,c=8,p=h-c-4,v=Math.max(...t,1.5),y=r/12,$=y*.65,f=c+p-1/v*p;return a`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${r} ${h}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",l)}">
        ...
        ${t.map((E,C)=>{let V=E/v*p,B=C*y+(y-$)/2,N=c+p-V,D=C===e,K=E<1?"var(--success-color, #4caf50)":E>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return Y`
            <rect x="${x(B)}" y="${x(N)}"
              width="${x($)}" height="${x(V)}"
  ...
  `}var w=class extends T{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return L(this.hass)}async openFor(t,i){this._entryId=t,this._taskId=i,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=Pt(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._currencySymbol=t?.budget?.currency_symbol||"",this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let i=(t.tasks||[]).find(e=>e.id===this._taskId);this._task=i??null}catch(t){this._error=A(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(i){return this._error=A(i,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-RPAZ2LC6.js").then(async({openCompleteDialog:t})=>{let i=this._task,e=[];try{e=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}t(Lt({entryId:this._entryId,taskId:this._taskId,taskName:i.name,task:i,objects:e,lang:this._lang,checklist:i.checklist||[],adaptiveEnabled:!!i.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-RPAZ2LC6.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-RPAZ2LC6.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=s("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=s("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${s("reanalyze_result",this._lang)||"Recomputed"}: ${gt(t.recommended_interval,"days",this._lang)} (${t.data_points} pts)`:s("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=A(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-RPAZ2LC6.js").then(({openHistoryEditDialog:i})=>{i({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null,used_parts:t.used_parts??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return _;let i=this._lang;return a`
    ...
    `}_renderAdaptive(t){let i=this._lang,e=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,r=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,h=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,c=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!e&&!r&&!h&&!c?a`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${r?Ht(t,i,this._features):_}
        ${h?Ct(t,i):_}
        ${c?a`
          ${Mt(t,i,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?Ot(t,i):_}
        `:_}
      </div>
      ...
      <div class="details">
        <div class="stats-grid">
          ...
          <div class="stat">
            ...
            <span class="stat-value">${P(h,i,2)}</span>
          </div>
          <div class="stat">
                ...
                ${[...e].reverse().slice(0,20).map(u=>{let p=["completed","reset","skipped"].includes(u.type);return a`
                    <div class="history-entry">
                      <div class="history-line">
                        ...
                        <span class="history-date">${mt(u.timestamp,i)}</span>
                      ...
                      ${u.cost!=null||u.duration!=null?a`<div class="history-meta">
                            ${u.cost!=null?a`<span>💰 ${P(u.cost,i,2)}</span>`:_}
    ...
    `}render(){if(!this._open)return _;let t=this._lang,i=this._task,e=this.hass?.user?.is_admin??!0;return a`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${i?a`
              <div class="header">
                <div class="title">
                  <span class="status-dot" style="background: ${X[i.status]||"#ccc"}"></span>
                  <span class="task-name">${i.name}</span>
                </div>
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-RPAZ2LC6.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${i.next_due?a`<span><strong>${s("next_due",t)||"Next due"}:</strong> ${W(i.next_due,t)}</span>`:_}
                  ${i.last_performed?a`<span><strong>${s("last_performed",t)||"Last"}:</strong> ${W(i.last_performed,t)}</span>`:_}
                  ${i.schedule?.kind&&!["manual","one_time"].includes(i.schedule.kind)||i.interval_days!=null?a`<span><strong>${s("interval",t)||"Interval"}:</strong> ${ft(i,t)}</span>`:_}
                  ${Z(i)?a`<span><strong>${s("phase_current",t)}:</strong> ${Z(i)}</span>`:_}
                </div>
              </div>
  ...
  `],o([g({attribute:!1})],w.prototype,"hass",2),o([d()],w.prototype,"_open",2),o([d()],w.prototype,"_entryId",2),o([d()],w.prototype,"_taskId",2),o([d()],w.prototype,"_task",2),o([d()],w.prototype,"_objectName",2),o([d()],w.prototype,"_busy",2),o([d()],w.prototype,"_error",2),o([d()],w.prototype,"_showSkip",2),o([d()],w.prototype,"_showReset",2),o([d()],w.prototype,"_showDetails",2),o([d()],w.prototype,"_showAdaptive",2),o([d()],w.prototype,"_skipReason",2),o([d()],w.prototype,"_resetDate",2),o([d()],w.prototype,"_features",2),o([d()],w.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",w);function Ft(n){return!!n&&/^https?:\/\//i.test(n)}function Dt(n){return n?customElements.get("ha-markdown")?a`<ha-markdown class="notes-md" .content=${n} breaks></ha-markdown>`:a`${n}`:_}var F=class extends T{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return L(this.hass)}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=A(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-RPAZ2LC6.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-RPAZ2LC6.js").then(({openCreateTaskDialog:t})=>{t(this._entryId),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=s("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let i=s("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(i))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-RPAZ2LC6.js").then(({openTaskQuickActions:i})=>{i(this._entryId,t)})}render(){if(!this._open)return _;let t=this._lang,i=this._data,e=i?.object,r=i?.tasks||[],h=this.hass?.user?.is_admin??!0;return a`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${i&&e?a`
              <div class="header">
              ...
              ${e.notes?a`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${Dt(e.notes)}</div>
                    </div>
                  `:_}
      ...
      <div class="meta">
        ${e.map(([r,h])=>a`
            <div class="meta-item">
              ...
              <span class="meta-value">${Ft(h)?a`<a href="${h}" target="_blank" rel="noopener noreferrer">${h}</a>`:h}</span>
            </div>
          `)}
      </div>
    `}};F.styles=S`
  ...
  `,o([g({attribute:!1})],F.prototype,"hass",2),o([d()],F.prototype,"_open",2),o([d()],F.prototype,"_entryId",2),o([d()],F.prototype,"_data",2),o([d()],F.prototype,"_busy",2),o([d()],F.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",F);var jt="maintenance-object-dialog",zt="maintenance-task-dialog",he="maintenance-history-edit-dialog",ue="maintenance-complete-dialog",_e="maintenance-qr-dialog",me="maintenance-task-quick-actions-dialog",ge="maintenance-object-quick-actions-dialog";function et(){return document.querySelector("home-assistant")?.hass}function ve(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function z(n){let l=ve(),t=l.querySelector(n)??document.body.querySelector(n);return t?t.parentNode!==l&&l.appendChild(t):(t=document.createElement(n),l.appendChild(t)),t}function U(n){let l=et();if(!l)return!1;n.hass=l;let t=L(l);return pt(t)||ht(t).then(()=>{n.requestUpdate?.()}),ut(l.locale,l.config?.country),!0}var lt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"};function xs(n){return dt(n).then(l=>l.rowActionStyle)}function ks(){J=null}var J=null;function dt(n){return J||(J=n.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(l=>({features:l.features??lt.features,defaultWarningDays:l.general?.default_warning_days??7,rowActionStyle:l.general?.row_action_style??lt.rowActionStyle})).catch(()=>lt),J)}function ws(){let n=z(jt);return U(n)?(n.openCreate(),!0):!1}function Es(n,l){let t=z(jt);return U(t)?(t.openEdit(n,l),!0):!1}function Is(n="",l){let t=z(zt);if(!U(t))return!1;let i=et();return i?((async()=>{let e=await dt(i),r=t;r.checklistsEnabled=e.features.checklists,r.scheduleTimeEnabled=e.features.schedule_time,r.completionActionsEnabled=e.features.completion_actions,r.defaultWarningDays=e.defaultWarningDays,r.openCreate(n,l)})(),!0):!1}function Ss(n,l){let t=z(zt);if(!U(t))return!1;let i=et();return i?((async()=>{try{let[e,r]=await Promise.all([i.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:n}),dt(i)]),h=(e.tasks||[]).find(u=>u.id===l);if(!h){console.warn(`openEditTaskDialog: task ${l} not found in entry ${n}`);return}let c=t;c.checklistsEnabled=r.features.checklists,c.scheduleTimeEnabled=r.features.schedule_time,c.completionActionsEnabled=r.features.completion_actions,c.defaultWarningDays=r.defaultWarningDays,await c.openEdit(n,h)}catch(e){console.warn("openEditTaskDialog: failed to load task/features",e)}})(),!0):!1}function Ts(n){let l=z(he);return U(l)?(l.openEdit(n),!0):!1}function As(n){let l=z(ue);return U(l)?(qt(l,n,et()?.language||"en"),!0):!1}function Ps(n){let l=z(_e);return U(l)?(l.openForTask(n.entry_id,n.task_id,n.object_name,n.task_name),!0):!1}function Ls(n,l){let t=z(me);return U(t)?(t.openFor(n,l),!0):!1}function qs(n){let l=z(ge);return U(l)?(l.openFor(n),!0):!1}export{ks as __resetSettingsCacheForTests,xs as getRowActionStyle,As as openCompleteDialog,ws as openCreateObjectDialog,Is as openCreateTaskDialog,Es as openEditObjectDialog,Ss as openEditTaskDialog,Ts as openHistoryEditDialog,qs as openObjectQuickActions,Ps as openQrDialog,Ls as openTaskQuickActions};
