...
import{a as kt,b as wt,c as Et,d as It,e as St,f as Tt,g as At,h as Ct,i as Pt}from"./chunk-FMRXSKNC.js";import"./chunk-VUOZ6TU4.js";import{A as Ut,B as T,a as w,b as a,c as Z,d as p,e as E,f as v,g as c,h as et,i as s,k as P,l as Lt,m as Rt,n as qt,o as Ht,p as A,q as J,r as G,s as Nt,t as Mt,u as nt,v as ht,w as Ot,x as Ft,y as Dt,z as jt}from"./chunk-IGS6MDB4.js";import{a as l,b as rt,c as xt}from"./chunk-VMGD53HU.js";var C=class extends E{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(t){let i=t.target.value;this.value=i,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:i}}))}render(){return a`
      <label class="field">
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${i?a`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-CUW42EQW.js").then(({openObjectQuickActions:n})=>{n(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
