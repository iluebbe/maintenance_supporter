...
`),this._scheduleTime=e.schedule_time||"";let o=e.on_complete_action;if(o&&o.service){this._actionService=o.service;let _=o.target?.entity_id;this._actionTargetEntity=Array.isArray(_)?_[0]||"":_||"",this._actionData=o.data&&typeof o.data=="object"?{...o.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let h=e.quick_complete_defaults;this._qcNotes=h?.notes||"",this._qcCost=h?.cost!=null?String(h.cost):"",this._qcDuration=h?.duration!=null?String(h.duration):"",this._qcFeedback=h?.feedback||"";let p=e.adaptive_config||{};if(this._environmentalEntity=p.environmental_entity||"",this._environmentalAttribute=p.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,e.trigger_config){let _=e.trigger_config;this._triggerEntityId=_.entity_id||"",this._triggerEntityIds=_.entity_ids||(_.entity_id?[_.entity_id]:[]),this._triggerEntityLogic=_.entity_logic||"any",this._triggerAttribute=_.attribute||"",this._triggerType=_.type||"threshold",this._triggerAbove=_.trigger_above?.toString()||"",this._triggerBelow=_.trigger_below?.toString()||"",this._triggerForMinutes=_.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=_.trigger_target_value?.toString()||"",this._triggerDeltaMode=_.trigger_delta_mode||!1,this._autoCompleteOnRecovery=_.auto_complete_on_recovery||!1,this._triggerFromState=_.trigger_from_state||"",this._triggerToState=_.trigger_to_state||"",this._triggerTargetChanges=_.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=_.trigger_runtime_hours?.toString()||"",_.type==="compound"?(this._compoundLogic=_.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(_.conditions||[]).map(It)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._responsibleUserId=null,this._checklistText="",this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new O(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(t){console.error("Failed to load users:",t),this._availableUsers=[]}}async _testAction(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[e,s]=t.split(".");if(!this.hass?.services?.[e]?.[s]){this._actionTestResult="error",this._actionTestError=`Service "${t}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let o=this._actionTargetEntity.trim();if(o){let h=o.split(".")[0];if(h!==e&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(e)){this._actionTestResult="error",this._actionTestError=`Service "${t}" only works on ${e}.* entities; entity "${o}" is in ${h}.* \u2014 pick a service that matches the entity domain (e.g. ${h}.${s})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[o]){this._actionTestResult="error",this._actionTestError=`Target entity "${o}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let t=JSON.parse(this._actionDataJsonFallback);if(t&&typeof t=="object"&&!Array.isArray(t))return t}catch{}return{...this._actionData}}_serviceSchema(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t))return null;let[e,s]=t.split("."),o=this.hass?.services?.[e]?.[s]?.fields;return!o||Object.keys(o).length===0?null:Object.entries(o).map(([h,p])=>({name:h,required:!!p.required,selector:p.selector||{text:{}}}))}_renderCompletionActionsSection(t){if(!this.completionActionsEnabled)return c;let e=this._serviceSchema();return n`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${s=>{this._actionService=s.detail.value||"";let o=this._serviceSchema();if(o){let h=new Set(o.map(p=>p.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([p])=>h.has(p)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
...
`).map(p=>p.trim()).filter(Boolean).slice(0,100);t.checklist=h.length?h:null}if(this.completionActionsEnabled){let h=this._actionService.trim();if(h&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(h)){let y={service:h},E=this._actionTargetEntity.trim();E&&(y.target={entity_id:E});let F=this._buildActionData();Object.keys(F).length>0&&(y.data=F),t.on_complete_action=y}else t.on_complete_action=null;let p={};this._qcNotes.trim()&&(p.notes=this._qcNotes.trim());let _=parseFloat(this._qcCost);!isNaN(_)&&_>=0&&(p.cost=_);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(p.duration=g),this._qcFeedback&&(p.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(p).length?p:null}let e=await this.hass.connection.sendMessagePromise(t),s=this._taskId||e?.task_id,o=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(s&&this._scheduleType==="sensor_based"&&o)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:s,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=k(t,this._lang,i("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return c;let t=this._lang,e=this._triggerType==="compound";return n`
      ...
      ${e?this._renderCompoundEditor():n`
        <ms-textfield
          ...
          @input=${s=>{let h=s.target.value.split(",").map(p=>p.trim()).filter(Boolean);this._triggerEntityId=h[0]||"",this._triggerEntityIds=h,h[0]&&this._fetchEntityAttributes(h[0])}}
        ></ms-textfield>
    ...
    `}_renderCondition(t,e){let s=this._lang,o=e+1;return n`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${st.map(h=>n`<option value=${h} ?selected=${h===t.type}>${i(h,s)}</option>`)}
          </select>
        </div>
      ...
      <div class="select-row">
        ...
        <div class="select-row">
          ...
          <select .value=${this._nth} @change=${o=>this._nth=o.target.value}>
            ${s.map(([o,h])=>n`<option value=${o} ?selected=${o===this._nth}>${h}</option>`)}
          </select>
        </div>
        <div class="select-row">
          <label>${i("recurrence_weekday",t)}</label>
          <select .value=${this._nthWeekday} @change=${o=>this._nthWeekday=o.target.value}>
            ${e.map((o,h)=>n`<option value=${String(h)} ?selected=${String(h)===this._nthWeekday}>${o}</option>`)}
          </select>
  ...
  `,r([m({attribute:!1})],u.prototype,"hass",2),r([m({type:Boolean,attribute:"checklists-enabled"})],u.prototype,"checklistsEnabled",2),r([m({type:Boolean,attribute:"schedule-time-enabled"})],u.prototype,"scheduleTimeEnabled",2),r([m({type:Boolean,attribute:"completion-actions-enabled"})],u.prototype,"completionActionsEnabled",2),r([m({type:Number,attribute:"default-warning-days"})],u.prototype,"defaultWarningDays",2),r([d()],u.prototype,"_open",2),r([d()],u.prototype,"_loading",2),r([d()],u.prototype,"_error",2),r([d()],u.prototype,"_entryId",2),r([d()],u.prototype,"_taskId",2),r([d()],u.prototype,"_objectChoices",2),r([d()],u.prototype,"_name",2),r([d()],u.prototype,"_type",2),r([d()],u.prototype,"_scheduleType",2),r([d()],u.prototype,"_intervalDays",2),r([d()],u.prototype,"_intervalUnit",2),r([d()],u.prototype,"_dueDate",2),r([d()],u.prototype,"_warningDays",2),r([d()],u.prototype,"_intervalAnchor",2),r([d()],u.prototype,"_weekdays",2),r([d()],u.prototype,"_nth",2),r([d()],u.prototype,"_nthWeekday",2),r([d()],u.prototype,"_domDay",2),r([d()],u.prototype,"_notes",2),r([d()],u.prototype,"_documentationUrl",2),r([d()],u.prototype,"_customIcon",2),r([d()],u.prototype,"_priority",2),r([d()],u.prototype,"_enabled",2),r([d()],u.prototype,"_triggerEntityId",2),r([d()],u.prototype,"_triggerEntityIds",2),r([d()],u.prototype,"_triggerEntityLogic",2),r([d()],u.prototype,"_triggerAttribute",2),r([d()],u.prototype,"_triggerType",2),r([d()],u.prototype,"_triggerAbove",2),r([d()],u.prototype,"_triggerBelow",2),r([d()],u.prototype,"_triggerForMinutes",2),r([d()],u.prototype,"_triggerTargetValue",2),r([d()],u.prototype,"_triggerDeltaMode",2),r([d()],u.prototype,"_autoCompleteOnRecovery",2),r([d()],u.prototype,"_triggerFromState",2),r([d()],u.prototype,"_triggerToState",2),r([d()],u.prototype,"_triggerTargetChanges",2),r([d()],u.prototype,"_triggerRuntimeHours",2),r([d()],u.prototype,"_compoundLogic",2),r([d()],u.prototype,"_compoundConditions",2),r([d()],u.prototype,"_suggestedAttributes",2),r([d()],u.prototype,"_availableAttributes",2),r([d()],u.prototype,"_entityDomain",2),r([d()],u.prototype,"_lastPerformed",2),r([d()],u.prototype,"_nfcTagId",2),r([d()],u.prototype,"_availableTags",2),r([d()],u.prototype,"_responsibleUserId",2),r([d()],u.prototype,"_availableUsers",2),r([d()],u.prototype,"_checklistText",2),r([d()],u.prototype,"_scheduleTime",2),r([d()],u.prototype,"_actionService",2),r([d()],u.prototype,"_actionTargetEntity",2),r([d()],u.prototype,"_actionData",2),r([d()],u.prototype,"_actionDataJsonFallback",2),r([d()],u.prototype,"_actionTesting",2),r([d()],u.prototype,"_actionTestResult",2),r([d()],u.prototype,"_actionTestError",2),r([d()],u.prototype,"_qcNotes",2),r([d()],u.prototype,"_qcCost",2),r([d()],u.prototype,"_qcDuration",2),r([d()],u.prototype,"_qcFeedback",2),r([d()],u.prototype,"_environmentalEntity",2),r([d()],u.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",u);var f=class extends ${constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed"}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed")}_toggleCheck(t){let e=String(t);this._checklistState={...this._checklistState,[e]:!this._checklistState[e]}}_setFeedback(t){this._feedback=t}async _complete(){this._loading=!0,this._error="";try{let t={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(t.notes=this._notes),this._cost){let e=parseFloat(this._cost);!isNaN(e)&&e>=0&&(t.cost=e)}if(this._duration){let e=parseInt(this._duration,10);!isNaN(e)&&e>=0&&(t.duration=e)}this.checklist.length>0&&(t.checklist_state=this._checklistState),this.adaptiveEnabled&&(t.feedback=this._feedback),await this.hass.connection.sendMessagePromise(t),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(t){this._error=k(t,this.lang,i("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return n``;let t=this.lang||this.hass?.language||"en";return n`
      <ha-dialog open @closed=${this._close}>
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),o.document.close()}_downloadSvg(t,e){let s=decodeURIComponent(t.svg_data_uri.replace("data:image/svg+xml,","")),o=new Blob([s],{type:"image/svg+xml"}),h=URL.createObjectURL(o),p=document.createElement("a");p.href=h;let _=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;p.download=`qr-${Lt(_)}-${e}.svg`,p.click(),URL.revokeObjectURL(h)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return n``;let t=this.lang||this.hass?.language||"en",e=this._taskName?`${i("qr_code",t)}: ${this._objectName} \u2014 ${this._taskName}`:`${i("qr_code",t)}: ${this._objectName}`,s=!!this._viewResult;return n`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${e}</div>
        <div class="content">
  ...
  `,r([m({attribute:!1})],T.prototype,"hass",2),r([m()],T.prototype,"lang",2),r([d()],T.prototype,"_open",2),r([d()],T.prototype,"_loading",2),r([d()],T.prototype,"_error",2),r([d()],T.prototype,"_viewResult",2),r([d()],T.prototype,"_completeResult",2),r([d()],T.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",T);function rt(a,l){let t=a.interval_analysis,e=t?.weibull_beta,s=t?.weibull_eta;if(e==null||s==null||s<=0)return c;let o=a.interval_days??0,h=a.suggested_interval??o;return n`
    ...
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${i("chart_weibull",s)}">
        ...
        ${t>0?M`
          ...
          <circle cx="${z.toFixed(1)}" cy="${W.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(z+4).toFixed(1)}" y="${(W-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
  ...
  `}function St(a,l){return n`
    <div class="weibull-info-row">
      <div class="weibull-info-item">
        <span>${i("characteristic_life",l)}</span>
        <span class="weibull-info-value">${Math.round(a.weibull_eta)} ${i("days",l)}</span>
      </div>
  ...
  `}function Rt(a,l,t){let e=a.confidence_interval_low,s=a.confidence_interval_high,o=l.suggested_interval??l.interval_days??0,h=l.interval_days??0,p=Math.max(0,e-5),g=s+5-p,y=(e-p)/g*100,E=(s-e)/g*100,F=(o-p)/g*100,I=h>0?(h-p)/g*100:-1;return n`
  ...
  `}function nt(a,l,t){let e=a.degradation_trend!=null&&a.degradation_trend!=="insufficient_data",s=a.days_until_threshold!=null,o=a.environmental_factor!=null&&a.environmental_factor!==1;if(!e&&!s&&!o)return c;let h=a.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":a.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return n`
    <div class="prediction-section">
      ${a.sensor_prediction_urgency?n`
        <div class="prediction-urgency-banner">
          <ha-svg-icon path="M1,21H23L12,2L1,21M12,18A1,1 0 0,1 11,17A1,1 0 0,1 12,16A1,1 0 0,1 13,17A1,1 0 0,1 12,18M13,15H11V10H13V15Z"></ha-svg-icon>
          ${i("sensor_prediction_urgency",l).replace("{days}",String(Math.round(a.days_until_threshold||0)))}
        </div>
      `:c}
      ...
      <div class="prediction-grid">
        ${e?n`
          <div class="prediction-item">
            ...
            <span class="prediction-value ${a.degradation_trend}">${i("trend_"+a.degradation_trend,l)}</span>
            ${a.degradation_rate!=null?n`<span class="prediction-rate">${a.degradation_rate>0?"+":""}${Math.abs(a.degradation_rate)>=10?Math.round(a.degradation_rate).toLocaleString():a.degradation_rate.toFixed(1)} ${a.trigger_entity_info?.unit_of_measurement||""}/${i("day_short",l)}</span>`:c}
          </div>
        `:c}
        ${s?n`
          <div class="prediction-item">
            ...
            <span class="prediction-value prediction-days${a.days_until_threshold===0?" exceeded":a.sensor_prediction_urgency?" urgent":""}">${a.days_until_threshold===0?i("threshold_exceeded",l):"~"+Math.round(a.days_until_threshold)+" "+i("days",l)}</span>
            ${a.threshold_prediction_date?n`<span class="prediction-date">${U(a.threshold_prediction_date,l)}</span>`:c}
        ...
        ${o&&t.environmental?n`
          <div class="prediction-item">
            ...
            ${a.environmental_entity?n`<span class="prediction-entity entity-link" @click=${p=>et(p,a.environmental_entity)}>${a.environmental_entity}</span>`:c}
          </div>
        `:c}
      </div>
    </div>
  `}function ot(a,l,t,e){let s=Math.max(a||1,l);return n`
  ...
  `}var lt=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function dt(a,l,t){if(!t.seasonal||!a.seasonal_factor||a.seasonal_factor===1)return c;let e=lt.map(p=>i(p,l)),s=new Date().getMonth(),o=a.seasonal_factors||a.interval_analysis?.seasonal_factors||null,h=o&&o.length===12?o:e.map((p,_)=>{let g=a.seasonal_factor||1,y=Math.sin((_-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,g+y))});return n`
    <div class="seasonal-card-compact">
      <h4>${i("seasonal_awareness",l)}</h4>
      <div class="seasonal-mini-chart">
        ${h.map((p,_)=>{let g=p*40,y=p<.9?"low":p>1.1?"high":"normal";return n`
  ...
  `}function ct(a,l){return Pt(a,l)}function Pt(a,l){let t=a.seasonal_factors??a.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return c;let e=a.interval_analysis?.seasonal_reason,s=new Date().getMonth(),o=300,h=100,p=8,g=h-p-4,y=Math.max(...t,1.5),E=o/12,F=E*.65,I=p+g-1/y*g;return n`
  ...
  `}var v=class extends ${constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(t,e){this._entryId=t,this._taskId=e,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let e=(t.tasks||[]).find(s=>s.id===this._taskId);this._task=e??null}catch(t){this._error=k(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(e){return this._error=k(e,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-PZDMONDT.js").then(({openCompleteDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-PZDMONDT.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-PZDMONDT.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=i("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=i("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${i("reanalyze_result",this._lang)||"Recomputed"}: ${t.recommended_interval}d (${t.data_points} pts)`:i("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=k(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-PZDMONDT.js").then(({openHistoryEditDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return c;let e=this._lang;return n`
    ...
    `}_renderAdaptive(t){let e=this._lang,s=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,o=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,h=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,p=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!s&&!o&&!h&&!p?n`<div class="adaptive-empty">
    ...
    `}_renderDetails(t){let e=this._lang,s=t.history||[],o=s.filter(_=>_.type==="completed"),h=o.reduce((_,g)=>_+(typeof g.cost=="number"?g.cost:0),0),p=(()=>{let _=o.map(g=>typeof g.duration=="number"?g.duration:null).filter(g=>g!=null);return _.length?Math.round(_.reduce((g,y)=>g+y,0)/_.length):null})();return n`
      <div class="details">
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?n`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-PZDMONDT.js").then(({openObjectQuickActions:o})=>{o(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
  ...
  `],r([m({attribute:!1})],v.prototype,"hass",2),r([d()],v.prototype,"_open",2),r([d()],v.prototype,"_entryId",2),r([d()],v.prototype,"_taskId",2),r([d()],v.prototype,"_task",2),r([d()],v.prototype,"_objectName",2),r([d()],v.prototype,"_busy",2),r([d()],v.prototype,"_error",2),r([d()],v.prototype,"_showSkip",2),r([d()],v.prototype,"_showReset",2),r([d()],v.prototype,"_showDetails",2),r([d()],v.prototype,"_showAdaptive",2),r([d()],v.prototype,"_skipReason",2),r([d()],v.prototype,"_resetDate",2),r([d()],v.prototype,"_features",2),r([d()],v.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",v);var C=class extends ${constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return this.hass?.language||"en"}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=k(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-PZDMONDT.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-PZDMONDT.js").then(({openCreateTaskDialog:t})=>{t(),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=i("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=k(e,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let e=i("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(e))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=k(e,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-PZDMONDT.js").then(({openTaskQuickActions:e})=>{e(this._entryId,t)})}render(){if(!this._open)return c;let t=this._lang,e=this._data,s=e?.object,o=e?.tasks||[],h=this.hass?.user?.is_admin??!0;return n`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${e&&s?n`
              <div class="header">
                      ...
                      <div class="task-list">
                        ${o.map(p=>n`
                          <div class="task-row" @click=${()=>this._onTaskClick(p.id)}>
                            <span class="status-dot" style="background: ${V[p.status]||"#ccc"}"></span>
                            <span class="task-name">${p.name}</span>
                            <span class="task-status">${i(p.status||"ok",t)}</span>
                          </div>
                        `)}
                      </div>
                    `}
      ...
      <div class="meta">
        ${s.map(([o,h])=>n`
            <div class="meta-item">
              ...
              <span class="meta-value">${/^https?:\/\//i.test(h)?n`<a href="${h}" target="_blank" rel="noopener noreferrer">${h}</a>`:h}</span>
            </div>
          `)}
      </div>
    `}};C.styles=x`
  ...
  `,r([m({attribute:!1})],C.prototype,"hass",2),r([d()],C.prototype,"_open",2),r([d()],C.prototype,"_entryId",2),r([d()],C.prototype,"_data",2),r([d()],C.prototype,"_busy",2),r([d()],C.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",C);var ht="maintenance-object-dialog",_t="maintenance-task-dialog",qt="maintenance-history-edit-dialog",Ft="maintenance-complete-dialog",zt="maintenance-qr-dialog",Mt="maintenance-task-quick-actions-dialog",Nt="maintenance-object-quick-actions-dialog";function G(){return document.querySelector("home-assistant")?.hass}function P(a){let l=document.body.querySelector(a);return l||(l=document.createElement(a),document.body.appendChild(l)),l}function q(a){let l=G();if(!l)return!1;a.hass=l;let t=l.language||"en";return Z(t)||J(t).then(()=>{a.requestUpdate?.()}),!0}var pt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},B=null;function ut(a){return B||(B=a.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(l=>({features:l.features??pt.features,defaultWarningDays:l.general?.default_warning_days??7})).catch(()=>pt),B)}function ri(){let a=P(ht);return q(a)?(a.openCreate(),!0):!1}function ni(a,l){let t=P(ht);return q(t)?(t.openEdit(a,l),!0):!1}function oi(){let a=P(_t);if(!q(a))return!1;let l=G();return l?((async()=>{let t=await ut(l),e=a;e.checklistsEnabled=t.features.checklists,e.scheduleTimeEnabled=t.features.schedule_time,e.completionActionsEnabled=t.features.completion_actions,e.defaultWarningDays=t.defaultWarningDays,e.openCreate()})(),!0):!1}function li(a,l){let t=P(_t);if(!q(t))return!1;let e=G();return e?((async()=>{try{let[s,o]=await Promise.all([e.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:a}),ut(e)]),h=(s.tasks||[]).find(_=>_.id===l);if(!h){console.warn(`openEditTaskDialog: task ${l} not found in entry ${a}`);return}let p=t;p.checklistsEnabled=o.features.checklists,p.scheduleTimeEnabled=o.features.schedule_time,p.completionActionsEnabled=o.features.completion_actions,p.defaultWarningDays=o.defaultWarningDays,await p.openEdit(a,h)}catch(s){console.warn("openEditTaskDialog: failed to load task/features",s)}})(),!0):!1}function di(a){let l=P(qt);return q(l)?(l.openEdit(a),!0):!1}function ci(a){let l=P(Ft);return q(l)?(l.entryId=a.entry_id,l.taskId=a.task_id,l.taskName=a.task_name,l.checklist=a.checklist??[],l.adaptiveEnabled=!!a.adaptive_enabled,l.lang=G()?.language||"en",l.open(),!0):!1}function pi(a){let l=P(zt);return q(l)?(l.openForTask(a.entry_id,a.task_id,a.object_name,a.task_name),!0):!1}function hi(a,l){let t=P(Mt);return q(t)?(t.openFor(a,l),!0):!1}function _i(a){let l=P(Nt);return q(l)?(l.openFor(a),!0):!1}export{ci as openCompleteDialog,ri as openCreateObjectDialog,oi as openCreateTaskDialog,ni as openEditObjectDialog,li as openEditTaskDialog,di as openHistoryEditDialog,_i as openObjectQuickActions,pi as openQrDialog,hi as openTaskQuickActions};
