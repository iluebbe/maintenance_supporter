...
`;var Be={name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",warranty_expiry:"warranty_expiry_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_for_minutes:"trigger_for_minutes"};function We(r,e){let t=Be[r];if(!t)return r;let o=_(t,e);return o&&o!==t?o:r}function Ve(r){let t=r.match(/data\['([^']+)'\]/)?.[1],o;return(o=r.match(/length of value must be at most (\d+)/))?{field:t,rule:"too_long",param:o[1]}:(o=r.match(/length of value must be at least (\d+)/))?{field:t,rule:"too_short",param:o[1]}:(o=r.match(/value must be at most (\S+)/))?{field:t,rule:"value_too_high",param:o[1]}:(o=r.match(/value must be at least (\S+)/))?{field:t,rule:"value_too_low",param:o[1]}:/required key not provided/.test(r)?{field:t,rule:"required"}:(o=r.match(/expected (\w+)/))?{field:t,rule:"wrong_type",param:o[1]}:/value must be one of/.test(r)?{field:t,rule:"invalid_choice"}:/not a valid value/.test(r)?{field:t,rule:"invalid_value"}:{field:t,rule:"unknown"}}function Xt(r,e,t){if(t=t??_("action_error",e),typeof r=="string")return r;if(typeof r!="object"||r===null)return t;let o=r,i=o.message||o.error?.message||"";if(!i)return t;let n=Ve(i),a=n.field?We(n.field,e):"",l=s=>_(s,e).replace("{field}",a).replace("{n}",n.param??"");switch(n.rule){case"too_long":return l("err_too_long");case"too_short":return l("err_too_short");case"value_too_high":return l("err_value_too_high");case"value_too_low":return l("err_value_too_low");case"required":return l("err_required");case"wrong_type":return l("err_wrong_type").replace("{type}",n.param??"");case"invalid_choice":return l("err_invalid_choice");case"invalid_value":return l("err_invalid_value");default:return i||t}}export{I as a,Ye as b,Ze as c,p as d,A as e,ve as f,ht as g,Ft as h,Bt as i,_ as j,Wt as k,Vt as l,we as m,Gt as n,Ae as o,Qt as p,Kt as q,Jt as r,Xt as s};
