...
`).map(m=>m.trim()).filter(Boolean).slice(0,100);t.checklist=p.length?p:null}if(this.completionActionsEnabled){let p=this._actionService.trim();if(p&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(p)){let b={service:p},y=this._actionTargetEntity.trim();y&&(b.target={entity_id:y});let $=this._buildActionData();Object.keys($).length>0&&(b.data=$),t.on_complete_action=b}else t.on_complete_action=null;let m={};this._qcNotes.trim()&&(m.notes=this._qcNotes.trim());let _=parseFloat(this._qcCost);!isNaN(_)&&_>=0&&(m.cost=_);let v=parseInt(this._qcDuration,10);!isNaN(v)&&v>=0&&(m.duration=v),this._qcFeedback&&(m.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(m).length?m:null}let i=await this.hass.connection.sendMessagePromise(t),n=this._taskId||i?.task_id,h=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(n&&this._scheduleType==="sensor_based"&&h)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=I(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return c;let t=this._lang,e=this._triggerType==="compound";return a`
      ...
      <div class="select-row">
        ...
        >
          ${St.map(i=>a`<option value=${i} ?selected=${i===this._triggerType}>${s(i,t)}</option>`)}
        </select>
      </div>
    ...
    `}_patchCondition(t,e){this._compoundConditions=this._compoundConditions.map((i,n)=>n===t?{...i,...e}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Ct()]}_removeCondition(t){this._compoundConditions=this._compoundConditions.filter((e,i)=>i!==t)}_renderCompoundEditor(){let t=this._lang;return a`
      <div class="select-row">
    ...
    `}_renderCondition(t,e){let i=this._lang,n=e+1;return a`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${dt.map(h=>a`<option value=${h} ?selected=${h===t.type}>${s(h,i)}</option>`)}
          </select>
        </div>
    ...
    `}_buildSchedule(){let t=i=>{let n=parseInt(this._calOffset,10)||0;return n&&(i.offset=Math.max(-15,Math.min(n,15))),i};if(this._scheduleType==="weekdays")return t({kind:"weekdays",weekdays:[...this._weekdays].sort((i,n)=>i-n)});if(this._scheduleType==="nth_weekday")return t({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let e={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(e.business=!0),t(e)}_recurrenceExtras(){let t={};if(this._seasonMonths.length&&(t.season_months=[...this._seasonMonths].sort((e,i)=>e-i)),this._endsMode==="count"){let e=parseInt(this._endsCount,10);e>=1&&(t.ends={count:e})}else this._endsMode==="until"&&this._endsUntil&&(t.ends={until:this._endsUntil});return t}_toggleSeasonMonth(t){this._seasonMonths=this._seasonMonths.includes(t)?this._seasonMonths.filter(e=>e!==t):[...this._seasonMonths,t]}_renderRecurrenceExtras(){let t=this._lang;if(!(this._scheduleType==="time_based"||J.includes(this._scheduleType)))return c;let i=Ft(t);return a`
      ...
      ${this._endsMode==="until"?a`
        ...
        ></ms-textfield>`:c}
    `}_renderCalendarFields(){let t=this._lang,e=qt(t);if(this._scheduleType==="weekdays")return a`
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Tt.map(i=>a`<option value=${i} ?selected=${i===this._type}>${s(i,t)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${Lt.map(i=>a`<option value=${i} ?selected=${i===this._priority}>${s("priority_"+i,t)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${At.map(i=>a`<option value=${i} ?selected=${i===this._scheduleType}>${s(i,t)}</option>`)}
            </select>
          </div>
    ...
    `}};u._PREVIEW_RELEVANT=new Set(["_open","_scheduleType","_intervalDays","_intervalUnit","_intervalAnchor","_dueDate","_weekdays","_nth","_nthWeekday","_domDay","_domLastDay","_domBusiness","_calOffset","_seasonMonths","_endsMode","_endsCount","_endsUntil","_lastPerformed"]),u.styles=w`
    .dialog-title {
      font-size: 18px;
      font-weight: 500;
      padding-bottom: 12px;
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="dialog-actions">
          ...
          <ha-button
            ...
            title=${this._missingRequired.length?this._missingRequired.map(e=>s("err_required",t).replace("{field}",s(W[e]??e,t))).join(" \xB7 "):""}
          >
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,r([g({attribute:!1})],L.prototype,"hass",2),r([g()],L.prototype,"lang",2),r([l()],L.prototype,"_open",2),r([l()],L.prototype,"_loading",2),r([l()],L.prototype,"_error",2),r([l()],L.prototype,"_viewResult",2),r([l()],L.prototype,"_completeResult",2),r([l()],L.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",L);function pt(o,d){let t=o.interval_analysis,e=t?.weibull_beta,i=t?.weibull_eta;if(e==null||i==null||i<=0)return c;let n=o.interval_days??0,h=o.suggested_interval??n;return a`
    <div class="weibull-section">
      ...
      ${zt(e,i,n,h,d)}
      ${Ut(t,d)}
      ${t?.confidence_interval_low!=null?Dt(t,o,d):c}
    </div>
  ...
  `}function zt(o,d,t,e,i){let $=Math.max(t,e,d,1)*1.3,H=50,P=[];for(let A=0;A<=H;A++){let S=A/H*$,wt=1-Math.exp(-Math.pow(S/d,o)),Et=32+S/$*260,It=136-wt*128;P.push([Et,It])}let D=P.map(([A,S])=>`${A.toFixed(1)},${S.toFixed(1)}`).join(" "),Y="M32,136 "+P.map(([A,S])=>`L${A.toFixed(1)},${S.toFixed(1)}`).join(" ")+` L${P[H][0].toFixed(1)},136 Z`,M=32+t/$*260,j=1-Math.exp(-Math.pow(t/d,o)),O=136-j*128,xt=((1-j)*100).toFixed(0),X=32+e/$*260,kt=[0,.25,.5,.75,1];return a`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",i)}">
        ${kt.map(A=>{let S=136-A*128;return z`
        ...
        ${t>0?z`
          ...
          <circle cx="${M.toFixed(1)}" cy="${O.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(M+4).toFixed(1)}" y="${(O-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
  ...
  `}function Dt(o,d,t){let e=o.confidence_interval_low,i=o.confidence_interval_high,n=d.suggested_interval??d.interval_days??0,h=d.interval_days??0,p=Math.max(0,e-5),_=i+5-p,v=(e-p)/_*100,b=(i-e)/_*100,y=(n-p)/_*100,$=h>0?(h-p)/_*100:-1;return a`
      ...
      <div class="prediction-grid">
        ...
        ${i?a`
          <div class="prediction-item">
            ...
            ${o.threshold_prediction_date?a`<span class="prediction-date">${N(o.threshold_prediction_date,d)}</span>`:c}
        ...
        ${n&&t.environmental?a`
          <div class="prediction-item">
            ...
            ${o.environmental_entity?a`<span class="prediction-entity entity-link" @click=${p=>at(p,o.environmental_entity)}>${o.environmental_entity}</span>`:c}
          </div>
        `:c}
      </div>
    </div>
  `}function ut(o,d,t,e){let i=Math.max(o||1,d);return a`
  ...
  `}var _t=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function mt(o,d,t){if(!t.seasonal||!o.seasonal_factor||o.seasonal_factor===1)return c;let e=_t.map(p=>s(p,d)),i=new Date().getMonth(),n=o.seasonal_factors||o.interval_analysis?.seasonal_factors||null,h=n&&n.length===12?n:e.map((p,m)=>{let _=o.seasonal_factor||1,v=Math.sin((m-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,_+v))});return a`
    <div class="seasonal-card-compact">
      <h4>${s("seasonal_awareness",d)}</h4>
      <div class="seasonal-mini-chart">
        ${h.map((p,m)=>{let _=p*40,v=p<.9?"low":p>1.1?"high":"normal";return a`
  ...
  `}function gt(o,d){return jt(o,d)}function jt(o,d){let t=o.seasonal_factors??o.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return c;let e=o.interval_analysis?.seasonal_reason,i=new Date().getMonth(),n=300,h=100,p=8,_=h-p-4,v=Math.max(...t,1.5),b=n/12,y=b*.65,$=p+_-1/v*_;return a`
  ...
  `}var k=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(t,e){this._entryId=t,this._taskId=e,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let e=(t.tasks||[]).find(i=>i.id===this._taskId);this._task=e??null}catch(t){this._error=I(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(e){return this._error=I(e,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-GNMCKSNE.js").then(({openCompleteDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-GNMCKSNE.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-GNMCKSNE.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=s("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=s("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${s("reanalyze_result",this._lang)||"Recomputed"}: ${st(t.recommended_interval,"days",this._lang)} (${t.data_points} pts)`:s("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=I(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-GNMCKSNE.js").then(({openHistoryEditDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return c;let e=this._lang;return a`
    ...
    `}_renderAdaptive(t){let e=this._lang,i=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,n=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,h=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,p=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!i&&!n&&!h&&!p?a`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${n?ht(t,e,this._features):c}
        ${h?pt(t,e):c}
        ${p?a`
          ${mt(t,e,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?gt(t,e):c}
        `:c}
      </div>
    `}_renderDetails(t){let e=this._lang,i=t.history||[],n=i.filter(m=>m.type==="completed"),h=n.reduce((m,_)=>m+(typeof _.cost=="number"?_.cost:0),0),p=(()=>{let m=n.map(_=>typeof _.duration=="number"?_.duration:null).filter(_=>_!=null);return m.length?Math.round(m.reduce((_,v)=>_+v,0)/m.length):null})();return a`
      <div class="details">
                ...
                ${[...i].reverse().slice(0,20).map(m=>{let _=["completed","reset","skipped"].includes(m.type);return a`
                    <div class="history-entry">
                      <div class="history-line">
                        ...
                        <span class="history-date">${it(m.timestamp,e)}</span>
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?a`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-GNMCKSNE.js").then(({openObjectQuickActions:n})=>{n(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${e.next_due?a`<span><strong>${s("next_due",t)||"Next due"}:</strong> ${N(e.next_due,t)}</span>`:c}
                  ${e.last_performed?a`<span><strong>${s("last_performed",t)||"Last"}:</strong> ${N(e.last_performed,t)}</span>`:c}
                  ${e.schedule?.kind&&!["manual","one_time"].includes(e.schedule.kind)||e.interval_days!=null?a`<span><strong>${s("interval",t)||"Interval"}:</strong> ${rt(e,t)}</span>`:c}
                </div>
              </div>
  ...
  `],r([g({attribute:!1})],k.prototype,"hass",2),r([l()],k.prototype,"_open",2),r([l()],k.prototype,"_entryId",2),r([l()],k.prototype,"_taskId",2),r([l()],k.prototype,"_task",2),r([l()],k.prototype,"_objectName",2),r([l()],k.prototype,"_busy",2),r([l()],k.prototype,"_error",2),r([l()],k.prototype,"_showSkip",2),r([l()],k.prototype,"_showReset",2),r([l()],k.prototype,"_showDetails",2),r([l()],k.prototype,"_showAdaptive",2),r([l()],k.prototype,"_skipReason",2),r([l()],k.prototype,"_resetDate",2),r([l()],k.prototype,"_features",2),r([l()],k.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",k);function vt(o){return!!o&&/^https?:\/\//i.test(o)}var C=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return this.hass?.language||"en"}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=I(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-GNMCKSNE.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-GNMCKSNE.js").then(({openCreateTaskDialog:t})=>{t(),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=s("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=I(e,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let e=s("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(e))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=I(e,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-GNMCKSNE.js").then(({openTaskQuickActions:e})=>{e(this._entryId,t)})}render(){if(!this._open)return c;let t=this._lang,e=this._data,i=e?.object,n=e?.tasks||[],h=this.hass?.user?.is_admin??!0;return a`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${e&&i?a`
              <div class="header">
      ...
      <div class="meta">
        ${i.map(([n,h])=>a`
            <div class="meta-item">
              ...
              <span class="meta-value">${vt(h)?a`<a href="${h}" target="_blank" rel="noopener noreferrer">${h}</a>`:h}</span>
            </div>
          `)}
      </div>
    `}};C.styles=w`
  ...
  `,r([g({attribute:!1})],C.prototype,"hass",2),r([l()],C.prototype,"_open",2),r([l()],C.prototype,"_entryId",2),r([l()],C.prototype,"_data",2),r([l()],C.prototype,"_busy",2),r([l()],C.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",C);var bt="maintenance-object-dialog",yt="maintenance-task-dialog",Ot="maintenance-history-edit-dialog",Vt="maintenance-complete-dialog",Bt="maintenance-qr-dialog",Wt="maintenance-task-quick-actions-dialog",Kt="maintenance-object-quick-actions-dialog";function G(){return document.querySelector("home-assistant")?.hass}function q(o){let d=document.body.querySelector(o);return d||(d=document.createElement(o),document.body.appendChild(d)),d}function F(o){let d=G();if(!d)return!1;o.hass=d;let t=d.language||"en";return tt(t)||et(t).then(()=>{o.requestUpdate?.()}),!0}var ft={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},K=null;function $t(o){return K||(K=o.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(d=>({features:d.features??ft.features,defaultWarningDays:d.general?.default_warning_days??7})).catch(()=>ft),K)}function fi(){let o=q(bt);return F(o)?(o.openCreate(),!0):!1}function bi(o,d){let t=q(bt);return F(t)?(t.openEdit(o,d),!0):!1}function yi(){let o=q(yt);if(!F(o))return!1;let d=G();return d?((async()=>{let t=await $t(d),e=o;e.checklistsEnabled=t.features.checklists,e.scheduleTimeEnabled=t.features.schedule_time,e.completionActionsEnabled=t.features.completion_actions,e.defaultWarningDays=t.defaultWarningDays,e.openCreate()})(),!0):!1}function $i(o,d){let t=q(yt);if(!F(t))return!1;let e=G();return e?((async()=>{try{let[i,n]=await Promise.all([e.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:o}),$t(e)]),h=(i.tasks||[]).find(m=>m.id===d);if(!h){console.warn(`openEditTaskDialog: task ${d} not found in entry ${o}`);return}let p=t;p.checklistsEnabled=n.features.checklists,p.scheduleTimeEnabled=n.features.schedule_time,p.completionActionsEnabled=n.features.completion_actions,p.defaultWarningDays=n.defaultWarningDays,await p.openEdit(o,h)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function xi(o){let d=q(Ot);return F(d)?(d.openEdit(o),!0):!1}function ki(o){let d=q(Vt);return F(d)?(d.entryId=o.entry_id,d.taskId=o.task_id,d.taskName=o.task_name,d.checklist=o.checklist??[],d.adaptiveEnabled=!!o.adaptive_enabled,d.requiredFields=o.required_completion_fields??[],d.lang=G()?.language||"en",d.open(),!0):!1}function wi(o){let d=q(Bt);return F(d)?(d.openForTask(o.entry_id,o.task_id,o.object_name,o.task_name),!0):!1}function Ei(o,d){let t=q(Wt);return F(t)?(t.openFor(o,d),!0):!1}function Ii(o){let d=q(Kt);return F(d)?(d.openFor(o),!0):!1}export{ki as openCompleteDialog,fi as openCreateObjectDialog,yi as openCreateTaskDialog,bi as openEditObjectDialog,$i as openEditTaskDialog,xi as openHistoryEditDialog,Ii as openObjectQuickActions,wi as openQrDialog,Ei as openTaskQuickActions};
