...
import{a as Rt,b as qt,c as Ht,d as Nt,e as Mt,f as Ot,g as Ft,h as Dt,i as jt}from"./chunk-GUYZG3V2.js";import"./chunk-JTWWYGQJ.js";import{a as ht,b as ut,c as K,d as Xt}from"./chunk-RTXGPOCF.js";import{a as Z}from"./chunk-MD2HGGBH.js";import{A as Jt,B as A,a as w,b as a,c as X,d as p,e as E,f,g as c,h as nt,i as s,k as P,l as Ut,m as zt,n as Vt,o as Bt,p as S,q as tt,r as Q,s as Wt,t as Kt,u as pt,v as $t,w as Yt,x as Gt,y as Qt,z as Zt}from"./chunk-GGBBPELB.js";import{a as l,b as Lt,c as ct}from"./chunk-5WR6EMQC.js";var C=class extends E{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(t){let i=t.target.value;this.value=i,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:i}}))}render(){return a`
      <label class="field">
...
`),partId:O?.part_id||"",partQty:O?.quantity!=null?String(O.quantity):"",reqOverride:g.required_completion_fields!==void 0,reqFields:[...g.required_completion_fields||[]],extraParts:W.filter((U,J)=>J!==G).map(U=>({...U})),carry:H}}),this._phaseSeq=[...i.phase_sequence||[]],this._requiredCompletion=[...i.required_completion_fields||[]],this._scheduleTime=i.schedule_time||"",this._scheduleTimeOn=!!i.schedule_time;let d=i.on_complete_action;if(d&&d.service){this._actionService=d.service;let h=d.target?.entity_id;this._actionTargetEntity=Array.isArray(h)?h[0]||"":h||"",this._actionData=d.data&&typeof d.data=="object"?{...d.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let _=i.quick_complete_defaults;this._qcNotes=_?.notes||"",this._qcCost=_?.cost!=null?String(_.cost):"",this._qcDuration=_?.duration!=null?String(_.duration):"",this._qcFeedback=_?.feedback||"";let u=i.adaptive_config||{};if(this._environmentalEntity=u.environmental_entity||"",this._environmentalAttribute=u.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,this._adaptiveEnabled=!!u.enabled,this._adaptiveAlpha=u.ewa_alpha?.toString()??z.alpha,this._adaptiveMin=u.min_interval_days?.toString()??z.min,this._adaptiveMax=u.max_interval_days?.toString()??z.max,this._adaptiveSeasonal=u.seasonal_enabled!==!1,this._adaptivePrediction=u.sensor_prediction_enabled!==!1,this._adaptiveInitial=this._adaptiveSnapshot(),i.trigger_config){let h=i.trigger_config;this._triggerEntityId=h.entity_id||h.entity_ids&&h.entity_ids[0]||"",this._triggerEntityIds=h.entity_ids||(h.entity_id?[h.entity_id]:[]),this._triggerEntityLogic=h.entity_logic||"any",this._triggerAttribute=h.attribute||"",this._triggerType=h.type||"threshold",this._triggerAbove=h.trigger_above?.toString()||"",this._triggerBelow=h.trigger_below?.toString()||"",this._triggerEquals=h.trigger_equals?.toString()||"",this._triggerNotEquals=h.trigger_not_equals?.toString()||"",this._triggerForMinutes=h.trigger_for_minutes?.toString()||"0",this._triggerCombinator=h.trigger_combinator==="all"?"all":"any",this._triggerTargetValue=h.trigger_target_value?.toString()||"",this._triggerDeltaMode=h.trigger_delta_mode||!1,this._triggerBaselineValue=h.trigger_baseline_value?.toString()||"",this._liveBaselineValue=i.trigger_baseline_value??null,this._autoCompleteOnRecovery=h.auto_complete_on_recovery||!1,this._triggerFromState=h.trigger_from_state||"",this._triggerToState=h.trigger_to_state||"",this._triggerTargetChanges=h.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=h.trigger_runtime_hours?.toString()||"",this._triggerRuntimeMaxSession=h.trigger_runtime_max_session_seconds?.toString()||"",this._triggerOnStates=(h.trigger_on_states||[]).join(", "),h.type==="compound"?(this._compoundLogic=h.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(h.conditions||[]).map(Je)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._notifyIcon="",this._priority="normal",this._labels="",this._mirrorTodoEntities=[],this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._requireTagScan=!1,this._allowSkip=!0,this._readingUnit="",this._readings=[],this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._phaseDefs=[],this._phaseSeq=[],this._requiredCompletion=[],this._scheduleTime="",this._scheduleTimeOn=!1,this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._adaptiveEnabled=!1,this._adaptiveAlpha=z.alpha,this._adaptiveMin=z.min,this._adaptiveMax=z.max,this._adaptiveSeasonal=!0,this._adaptivePrediction=!0,this._adaptiveInitial=this._adaptiveSnapshot(),this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerEquals="",this._triggerNotEquals="",this._triggerForMinutes="0",this._triggerCombinator="any",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerRuntimeMaxSession="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new _t(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(t){console.error("Failed to load users:",t),this._availableUsers=[]}}_toggleAssignee(t){this._assigneePool=this._assigneePool.includes(t)?this._assigneePool.filter(i=>i!==t):[...this._assigneePool,t]}async _testAction(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[i,e]=t.split(".");if(!this.hass?.services?.[i]?.[e]){this._actionTestResult="error",this._actionTestError=`Service "${t}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let n=this._actionTargetEntity.trim();if(n){let d=n.split(".")[0];if(d!==i&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(i)){this._actionTestResult="error",this._actionTestError=`Service "${t}" only works on ${i}.* entities; entity "${n}" is in ${d}.* \u2014 pick a service that matches the entity domain (e.g. ${d}.${e})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[n]){this._actionTestResult="error",this._actionTestError=`Target entity "${n}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let t=JSON.parse(this._actionDataJsonFallback);if(t&&typeof t=="object"&&!Array.isArray(t))return t}catch{}return{...this._actionData}}_serviceSchema(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t))return null;let[i,e]=t.split("."),n=this.hass?.services?.[i]?.[e]?.fields;return!n||Object.keys(n).length===0?null:Object.entries(n).map(([d,_])=>({name:d,required:!!_.required,selector:_.selector||{text:{}}}))}_renderCompletionActionsSection(t){if(!this.completionActionsEnabled)return p;let i=this._serviceSchema();return a`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${e=>{this._actionService=e.detail.value||"";let n=this._serviceSchema();if(n){let d=new Set(n.map(_=>_.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([_])=>d.has(_)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
          ...
          @value-changed=${e=>{let n=e.detail.value;this._actionTargetEntity=n.target_entity||""}}
        ></ha-form>
        ...
        <div class="ca-test-row">
          ...
          ${this._actionTestResult==="ok"?a`<span class="ca-test-ok">${s("on_complete_action_test_success",t)}</span>`:p}
    ...
    `}async _loadParts(){if(this.parts=[],!!this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this.parts=t.parts||[],this._partsLoadFailed=!1}catch{this.parts=[],this._partsLoadFailed=!0}}async _loadForeignPools(){if(this._foreignOwners=[],!!this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._foreignOwners=(t.objects||[]).filter(i=>i.entry_id!==this._entryId&&(i.parts||[]).length>0).map(i=>({entry_id:i.entry_id,name:i.object?.name||i.entry_id,parts:i.parts||[]})).sort((i,e)=>i.name.localeCompare(e.name))}catch{this._foreignOwners=[]}}async _loadTags(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tags/list"});this._availableTags=t.tags||[]}catch{this._availableTags=[]}}_fetchConditionAttributes(t){!t||!this.hass||this._conditionAttrOptions[t]||this._conditionAttrPending.has(t)||(this._conditionAttrPending.add(t),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/entity/attributes",entity_id:t}).then(i=>{let e=i;this._conditionAttrOptions={...this._conditionAttrOptions,[t]:{suggested:e.suggested_attributes||[],available:e.available_attributes||[]}}}).catch(()=>{this._conditionAttrOptions={...this._conditionAttrOptions,[t]:{suggested:[],available:[]}}}))}async _fetchEntityAttributes(t){if(!t||!this.hass){this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="";return}try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/entity/attributes",entity_id:t});this._entityDomain=i.domain||"",this._suggestedAttributes=i.suggested_attributes||[],this._availableAttributes=i.available_attributes||[]}catch{this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain=""}}get _hasForeignPick(){return Object.values(this._consumesParts).some(t=>!!t.entry_id)}_renderConsumesRow(t,i){let e=D({part_id:t.id,entry_id:i}),n=this._consumesParts[e],d=i?{part_id:t.id,quantity:1,entry_id:i}:{part_id:t.id,quantity:1};return a`
      <div class="consumes-row">
        ...
        ${n!==void 0?a`<input
              ...
              @input=${_=>{let u=parseFloat(_.target.value);this._consumesParts={...this._consumesParts,[e]:{...d,quantity:Number.isFinite(u)&&u>=.01?u:1}}}}
            />`:p}
      </div>
    `}_toggleRequired(t,i){let e=new Set(this._requiredCompletion);i?e.add(t):e.delete(t),this._requiredCompletion=[...e]}_patchReading(t,i){this._readings=this._readings.map(e=>e.id===t?{...e,...i}:e)}_renderReadingsEditor(t){let i=Ft(this._readings);return a`
      <div class="readings-editor">
        ...
        ${this._readings.map(e=>a`
          ${i.has(e.id)?a`<div class="field-help reading-dup">${s("reading_duplicate_name",t)}</div>`:p}
          <div class="reading-row">
            <ms-textfield
              class="reading-name"
              label="${s("reading_name_label",t)}"
              .value=${e.name}
              @input=${n=>this._patchReading(e.id,{name:n.target.value})}
            ></ms-textfield>
            <ms-textfield
              class="reading-unit"
              label="${s("reading_unit_short",t)}"
              .value=${e.unit||""}
              @input=${n=>this._patchReading(e.id,{unit:n.target.value})}
            ></ms-textfield>
            <mwc-icon-button class="phase-remove reading-remove" @click=${()=>this._readings=this._readings.filter(n=>n.id!==e.id)}>
        ...
        ${this._readings.length<20?a`
          <ha-button appearance="plain" class="reading-add"
            @click=${()=>this._readings=[...this._readings,{id:qt(),name:"",unit:this._readings.length?this._readings[this._readings.length-1].unit:this._readingUnit}]}>
            <ha-icon icon="mdi:plus"></ha-icon> ${s("reading_add",t)}
          </ha-button>`:p}
      </div>
    `}_phaseSlug(t){let i=t.toLowerCase().replace(/[^a-z0-9_-]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24)||"phase",e=i,n=2;for(;this._phaseDefs.some(d=>d.id===e);)e=`${i}-${n++}`;return e}_addPhaseDef(){let t=this._phaseSlug(`phase-${this._phaseDefs.length+1}`);this._phaseDefs=[...this._phaseDefs,{id:t,name:"",checklistText:"",partId:"",partQty:"",reqOverride:!1,reqFields:[],extraParts:[],carry:{}}]}_removePhaseDef(t){this._phaseDefs=this._phaseDefs.filter(i=>i.id!==t),this._phaseSeq=this._phaseSeq.filter(i=>i!==t)}_patchPhaseDef(t,i){this._phaseDefs=this._phaseDefs.map(e=>e.id===t?{...e,...i}:e)}_renderPhasesEditor(t){let i=e=>this._phaseDefs.find(n=>n.id===e)?.name||e;return a`
        ...
        <div class="phase-def">
          <div class="phase-def-head">
            <ms-textfield
              ...
              .value=${e.name}
              @input=${n=>this._patchPhaseDef(e.id,{name:n.target.value})}
            ></ms-textfield>
            ${this.parts.length?a`
              <select
                class="phase-part"
                .value=${e.partId}
                @change=${n=>this._patchPhaseDef(e.id,{partId:n.target.value})}
              >
                <option value="">—</option>
                ${this.parts.map(n=>a`<option value=${n.id} ?selected=${n.id===e.partId}>${n.name}</option>`)}
              </select>
              ${e.partId?a`
                <input class="phase-qty" type="number" min="0.01" step="0.01" .value=${e.partQty||"1"}
                  @input=${n=>this._patchPhaseDef(e.id,{partQty:n.target.value})} />
              `:p}
            `:p}
          ...
          ${this.checklistsEnabled?a`
            <textarea
              ...
              @input=${n=>this._patchPhaseDef(e.id,{checklistText:n.target.value})}
            ></textarea>
          `:p}
          <label class="req-option phase-req-toggle">
            <input
              ...
              @change=${n=>this._patchPhaseDef(e.id,{reqOverride:n.target.checked})}
            />
            ...
            <div class="required-completion phase-req-fields">
              ${wt.map(n=>a`
                <label class="req-option">
                  <input
                    type="checkbox"
                    .checked=${e.reqFields.includes(n)}
                    @change=${d=>{let _=d.target.checked,u=new Set(e.reqFields);_?u.add(n):u.delete(n),this._patchPhaseDef(e.id,{reqFields:[...u]})}}
                  />
                  <span>${s(at[n],t)}</span>
                </label>
              `)}
      ...
      ${this._phaseDefs.some(e=>e.name.trim())?a`
        ...
        <div class="phase-seq">
          ...
          <select
            class="phase-seq-add"
            .value=${""}
            @change=${e=>{let n=e.target.value;n&&(this._phaseSeq=[...this._phaseSeq,n]),e.target.value=""}}
          >
...
`).map(h=>h.trim()).filter(Boolean).slice(0,100);t.checklist=u.length?u:null}if(this.completionActionsEnabled){let u=this._actionService.trim();if(u&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(u)){let x={service:u},b=this._actionTargetEntity.trim();b&&(x.target={entity_id:b});let $=this._buildActionData();Object.keys($).length>0&&(x.data=$),t.on_complete_action=x}else t.on_complete_action=null;let h={};this._qcNotes.trim()&&(h.notes=this._qcNotes.trim());let g=parseFloat(this._qcCost);!isNaN(g)&&g>=0&&(h.cost=g);let v=et(this._qcDuration);v!==null&&(h.duration=v),this._qcFeedback&&(h.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(h).length?h:null}let e=await this.hass.connection.sendMessagePromise(t),n=this._taskId||e?.task_id,d=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;this._warning="";let _=u=>{this._warning=s("subsave_warning",this._lang).replace("{detail}",u)};if(n&&this._scheduleType==="sensor_based"&&d&&await kt(this,{type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null},{onError:_})!==void 0&&(this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute),n&&this._adaptiveSnapshot()!==this._adaptiveInitial){let u=parseFloat(this._adaptiveAlpha),h=parseInt(this._adaptiveMin,10),g=parseInt(this._adaptiveMax,10);await kt(this,{type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:n,enabled:this._adaptiveEnabled,...u>=.1&&u<=.9?{ewa_alpha:u}:{},...!isNaN(h)&&h>=1?{min_interval_days:h}:{},...!isNaN(g)&&g>=1?{max_interval_days:g}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction},{onError:_})!==void 0&&(this._adaptiveInitial=this._adaptiveSnapshot())}this._warning?n&&(this._taskId=n):this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=A(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._warning="",this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return p;let t=this._lang,i=this._triggerType==="compound";return a`
      ...
      <div class="select-row">
        ...
        >
          ${Ge.map(e=>a`<option value=${e} ?selected=${e===this._triggerType}>${s(e,t)}</option>`)}
        </select>
      </div>
      ${i?this._renderCompoundEditor():a`
        ${this._entityPickerFallback?a`
          <ms-textfield
            ...
            @input=${e=>{let d=e.target.value.split(",").map(_=>_.trim()).filter(Boolean);this._triggerEntityId=d[0]||"",this._triggerEntityIds=d,d[0]&&this._fetchEntityAttributes(d[0])}}
          ></ms-textfield>
        `:a`
        <ha-form
          class="entity-picker-form"
          .hass=${this.hass}
          .schema=${[{name:"trigger_entities",selector:{entity:{multiple:!0,domain:xt}}}]}
          ...
          @value-changed=${e=>{let n=(e.detail.value.trigger_entities||[]).filter(Boolean);this._triggerEntityId=n[0]||"",this._triggerEntityIds=n,n[0]?this._fetchEntityAttributes(n[0]):this._fetchEntityAttributes("")}}
        ></ha-form>`}
      ...
      ${this._intervalDays?a`
          ...
          `:p}
    `}_patchCondition(t,i){this._compoundConditions=this._compoundConditions.map((e,n)=>n===t?{...e,...i}:e)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Qe()]}_removeCondition(t){this._compoundConditions=this._compoundConditions.filter((i,e)=>e!==t)}_renderCompoundEditor(){let t=this._lang;return a`
      <div class="select-row">
    ...
    `}_renderCondition(t,i){let e=this._lang,n=i+1;return a`
      <div class="compound-condition">
        <div class="compound-condition-head">
          <span class="compound-condition-title">${s("compound_condition",e)} ${n}</span>
          <button
            type="button"
            class="icon-btn"
        ...
        <ha-form
          class="entity-picker-form"
          .hass=${this.hass}
          .schema=${[{name:"condition_entities",selector:{entity:{multiple:!0,domain:xt}}}]}
        ...
        <div class="select-row">
          ...
          >
            ${le.map(d=>a`<option value=${d} ?selected=${d===t.type}>${s(d,e)}</option>`)}
          </select>
        </div>
    ...
    `}_renderOnStatesField(t){let i=this._lang;return this._entityPickerFallback||!t.entityId?a`
      ...
      ></ha-form>
    `}_renderAdaptiveSection(t){return this._scheduleType==="one_time"||this._scheduleType==="manual"?p:a`
    ...
    `}_renderEnvironmentalAttribute(t){this._fetchConditionAttributes(this._environmentalEntity);let i=this._conditionAttrOptions[this._environmentalEntity];return this._renderAttributeSelect({label:s("environmental_attribute_optional",t),value:this._environmentalAttribute,suggested:i?.suggested??[],available:i?.available??[],onSelect:e=>this._environmentalAttribute=e})}_renderConditionAttribute(t,i){let e=t.entityIds.split(",")[0]?.trim()||"";e&&this._fetchConditionAttributes(e);let n=e?this._conditionAttrOptions[e]:void 0;return this._renderAttributeSelect({label:s("attribute_optional",this._lang),value:t.attribute,suggested:n?.suggested??[],available:n?.available??[],onSelect:d=>this._patchCondition(i,{attribute:d})})}_renderConditionTypeFields(t,i){let e=this._lang;if(t.type==="threshold")return a`
      ...
      `;if(t.type==="state_change"){let n=t.entityIds.split(",")[0]?.trim()||"";return a`
        ${this._renderStateField({label:s("from_state_optional",e),value:t.fromState,entityId:n,onInput:d=>this._patchCondition(i,{fromState:d})})}
        ${this._renderStateField({label:s("to_state_optional",e),value:t.toState,entityId:n,onInput:d=>this._patchCondition(i,{toState:d})})}
      ...
      `}if(t.type==="runtime"){let n=t.entityIds.split(",")[0]?.trim()||"";return a`
        ...
        ${this._renderOnStatesField({value:t.onStates,entityId:n,onInput:d=>this._patchCondition(i,{onStates:d})})}
      `}return p}_renderUnitSelect(){let t=this._lang;return a`
      <div class="select-row">
    ...
    `}_buildSchedule(){let t=e=>{let n=parseInt(this._calOffset,10)||0;return n&&(e.offset=Math.max(-15,Math.min(n,15))),e};if(this._scheduleType==="weekdays")return t({kind:"weekdays",weekdays:[...this._weekdays].sort((e,n)=>e-n)});if(this._scheduleType==="nth_weekday")return t({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});if(this._scheduleType==="calendar")return t({kind:"calendar",entity_id:this._calendarEntity.trim()});let i={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(i.business=!0),t(i)}_recurrenceExtras(){let t={};if(this._seasonMonths.length&&(t.season_months=[...this._seasonMonths].sort((i,e)=>i-e)),this._endsMode==="count"){let i=parseInt(this._endsCount,10);i>=1&&(t.ends={count:i})}else this._endsMode==="until"&&this._endsUntil&&(t.ends={until:this._endsUntil});return t}_toggleSeasonMonth(t){this._seasonMonths=this._seasonMonths.includes(t)?this._seasonMonths.filter(i=>i!==t):[...this._seasonMonths,t]}_renderRecurrenceExtras(){let t=this._lang;if(!(this._scheduleType==="time_based"||mt.includes(this._scheduleType)))return p;let e=ei(t);return a`
      ...
      ${this._endsMode==="until"?a`
        ...
        ></ms-date-field>`:p}
    `}_renderCalendarFields(){let t=this._lang,i=ti(t);if(this._scheduleType==="weekdays")return a`
        ...
        <div class="select-row">
          ...
          <select .value=${this._nth} @change=${n=>this._nth=n.target.value}>
            ${e.map(([n,d])=>a`<option value=${n} ?selected=${n===this._nth}>${d}</option>`)}
          </select>
        </div>
        <div class="select-row">
        ...
        ${this._renderCalOffsetField()}`}return this._scheduleType==="calendar"?a`
        ${this._entityPickerFallback?a`
          <ms-textfield
        ...
        `:a`
          ...
          ></ha-form>`}
        ${this._renderCalOffsetField()}`:this._scheduleType==="day_of_month"?a`
        ...
        ${this._renderCalOffsetField()}`:p}_renderCalOffsetField(){let t=this._lang;return a`
      <ms-textfield
      ...
      ></ms-textfield>`}_thresholdLimitsOverlap(){let t=parseFloat(this._triggerAbove),i=parseFloat(this._triggerBelow);return!isNaN(t)&&!isNaN(i)&&i>t}_renderTriggerLiveHint(){if(this._triggerType==="compound")return p;let t=this._triggerType==="threshold"&&this._thresholdLimitsOverlap()?a`<div class="trigger-live-hint warn">${s("trigger_hint_overlap",this._lang)}</div>`:p,i=this._triggerEntityId||this._triggerEntityIds[0];if(!i||!this.hass?.states)return t;let e=this.hass.states[i];if(!e)return t;let n=this._lang,d=e.attributes?.unit_of_measurement,_=typeof d=="string"&&d?` ${d}`:"",u=this._triggerAttribute?e.attributes?.[this._triggerAttribute]:e.state,h=typeof u=="number"?u:parseFloat(String(u)),g=u!=="unknown"&&u!=="unavailable"&&u!=null&&!isNaN(h),v=b=>S(b,n,{maximumFractionDigits:1}),x=[];if(this._triggerType==="threshold"){let b=parseFloat(this._triggerAbove),$=parseFloat(this._triggerBelow);if(isNaN(b)&&isNaN($))return p;g&&x.push(s("trigger_hint_now",n).replace("{value}",v(h)+_)),isNaN(b)||x.push(s("trigger_hint_above",n).replace("{target}",v(b)+_)),isNaN($)||x.push(s("trigger_hint_below",n).replace("{target}",v($)+_))}else if(this._triggerType==="counter"){let b=parseFloat(this._triggerTargetValue);if(isNaN(b))return p;this._triggerDeltaMode?this._taskId?x.push(s("trigger_hint_counter_delta_edit",n).replace("{target}",v(b)+_)):g?x.push(s("trigger_hint_counter_delta",n).replace("{value}",v(h)+_).replace("{due}",v(h+b)+_).replace("{target}",v(b)+_)):x.push(s("trigger_hint_counter_delta_edit",n).replace("{target}",v(b)+_)):(g&&x.push(s("trigger_hint_now",n).replace("{value}",v(h)+_)),x.push(s("trigger_hint_counter_abs",n).replace("{target}",v(b)+_)))}else if(this._triggerType==="runtime"){let b=parseFloat(this._triggerRuntimeHours);if(isNaN(b))return p;x.push(s("trigger_hint_runtime",n).replace("{hours}",v(b))),x.push(s("trigger_hint_state_now",n).replace("{value}",String(e.state)))}else if(this._triggerType==="state_change"){let b=parseInt(this._triggerTargetChanges,10)||1,$=this._triggerToState.trim();x.push(($?s("trigger_hint_state_change_to",n).replace("{state}",$):s("trigger_hint_state_change",n)).replace("{count}",String(b))),x.push(s("trigger_hint_state_now",n).replace("{value}",String(e.state)))}return x.length?a`<div class="trigger-live-hint">${x.join(" ")}</div>${t}`:t}_renderTriggerTypeFields(){let t=this._lang;return this._triggerType==="threshold"?a`
        <ms-textfield
      ...
      `:this._triggerType==="state_change"?a`
        ...
        ${(this._triggerTargetChanges||"1")==="1"&&(this._triggerFromState||this._triggerToState)?a`<div class="field-help">${s("state_latch_help",t)}</div>`:p}
        <ms-textfield
          label="${s("for_at_least_minutes",t)}"
          type="number"
          min="0"
      ...
      `:p}render(){if(!this._open)return a``;let t=this._lang,i=this._taskId?s("edit_task",t):s("new_task",t);return a`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${i}</div>
        <div class="content">
          ${this._error?a`<div class="error">${this._error}</div>`:p}
          ...
          <div class="select-row">
            ...
            >
              ${We.map(e=>a`<option value=${e} ?selected=${e===this._type}>${s(e,t)}</option>`)}
            </select>
          </div>
          ${this._type==="reading"?a`
              ...
              `:p}
          ${this._partsLoadFailed?a`<div class="field-help parts-load-failed">${s("parts_load_failed",t)}</div>`:p}
          ${this._isFleetTask?a`<div class="field-help parts-fleet-hint">${s("task_parts_fleet_hint",t)}</div>`:this.parts.length||this._foreignOwners.length?a`
                <div class="field">
                  ...
                  ${this._foreignOwners.length?a`
                        <details class="shared-pools" ?open=${this._hasForeignPick}>
                          ...
                          ${this._foreignOwners.map(e=>a`
                              ...
                              ${e.parts.map(n=>this._renderConsumesRow(n,e.entry_id))}
                            `)}
                        </details>
                      `:p}
                </div>
          ...
          <div class="field mirror-todo-field">
            ${this._entityPickerFallback?a`
              <ms-textfield
                ...
                @input=${e=>{this._mirrorTodoEntities=e.target.value.split(",").map(n=>n.trim()).filter(Boolean)}}
              ></ms-textfield>
            `:a`
              <ha-form
                class="entity-picker-form"
                ...
                @value-changed=${e=>{let n=(e.detail.value.mirror_todo_entities||[]).filter(Boolean);this._mirrorTodoEntities=n}}
              ></ha-form>`}
          ...
          <div class="select-row">
            ...
            >
              ${Ye.map(e=>a`<option value=${e} ?selected=${e===this._scheduleType}>${s(e,t)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="one_time"?a`
                ...
                ></ms-date-field>
              `:p}
          ${this.scheduleTimeEnabled&&oe.includes(this._scheduleType)?a`
            ...
            ${wt.map(e=>a`
              <label class="req-option">
                <input
                  ...
                  @change=${n=>this._toggleRequired(e,n.target.checked)}
                />
                <span>${s(at[e],t)}</span>
              </label>
            `)}
          ...
          <div class="select-row">
            ...
            <select
              ...
              @change=${e=>{let n=e.target.value;this._responsibleUserId=n||null}}
            >
          ...
          ${this._scheduleType==="sensor_based"?a`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:ne,device_class:ae}}}]}
          ...
          <div class="field-help notify-icon-help">
            <ha-icon icon=${this._notifyIcon.trim()||Et(this._type)}></ha-icon>
            ${s("notify_icon_hint",t).replace("{default}",Et(this._type))}
          </div>
          ...
          ${this._requireTagScan?a`<div class="field-help">${s("require_tag_scan_help",t)}</div>`:p}
          <label class="req-option">
            <input
              type="checkbox"
          ...
          ${this._allowSkip?p:a`<div class="field-help">${s("disallow_skip_help",t)}</div>`}
          <label class="req-option">
            <input
              type="checkbox"
          ...
          ${this._notifyEnabled?p:a`<div class="field-help">${s("no_notifications_help",t)}</div>`}
    ...
    `}};m._PREVIEW_RELEVANT=new Set(["_open","_scheduleType","_intervalDays","_intervalUnit","_intervalAnchor","_dueDate","_weekdays","_nth","_nthWeekday","_domDay","_domLastDay","_domBusiness","_calOffset","_calendarEntity","_seasonMonths","_endsMode","_endsCount","_endsUntil","_lastPerformed"]),m.styles=w`
    .dialog-title {
      font-size: 18px;
      font-weight: 500;
      padding-bottom: 12px;
  ...
  `,l([f({attribute:!1})],m.prototype,"hass",2),l([f({type:Boolean,attribute:"checklists-enabled"})],m.prototype,"checklistsEnabled",2),l([f({type:Boolean,attribute:"schedule-time-enabled"})],m.prototype,"scheduleTimeEnabled",2),l([f({type:Boolean,attribute:"completion-actions-enabled"})],m.prototype,"completionActionsEnabled",2),l([f({type:Number,attribute:"default-warning-days"})],m.prototype,"defaultWarningDays",2),l([c()],m.prototype,"parts",2),l([c()],m.prototype,"_foreignOwners",2),l([c()],m.prototype,"_open",2),l([c()],m.prototype,"_entityPickerFallback",2),l([c()],m.prototype,"_loading",2),l([c()],m.prototype,"_error",2),l([c()],m.prototype,"_warning",2),l([c()],m.prototype,"_entryId",2),l([c()],m.prototype,"_taskId",2),l([c()],m.prototype,"_isFleetTask",2),l([c()],m.prototype,"_objectChoices",2),l([c()],m.prototype,"_name",2),l([c()],m.prototype,"_type",2),l([c()],m.prototype,"_scheduleType",2),l([c()],m.prototype,"_intervalDays",2),l([c()],m.prototype,"_intervalUnit",2),l([c()],m.prototype,"_dueDate",2),l([c()],m.prototype,"_warningDays",2),l([c()],m.prototype,"_earliestCompletionDays",2),l([c()],m.prototype,"_intervalAnchor",2),l([c()],m.prototype,"_weekdays",2),l([c()],m.prototype,"_nth",2),l([c()],m.prototype,"_nthWeekday",2),l([c()],m.prototype,"_domDay",2),l([c()],m.prototype,"_domLastDay",2),l([c()],m.prototype,"_domBusiness",2),l([c()],m.prototype,"_calOffset",2),l([c()],m.prototype,"_calendarEntity",2),l([c()],m.prototype,"_seasonMonths",2),l([c()],m.prototype,"_endsMode",2),l([c()],m.prototype,"_endsCount",2),l([c()],m.prototype,"_endsUntil",2),l([c()],m.prototype,"_schedulePreview",2),l([c()],m.prototype,"_schedulePreviewEnded",2),l([c()],m.prototype,"_notes",2),l([c()],m.prototype,"_documentationUrl",2),l([c()],m.prototype,"_customIcon",2),l([c()],m.prototype,"_notifyIcon",2),l([c()],m.prototype,"_priority",2),l([c()],m.prototype,"_labels",2),l([c()],m.prototype,"_mirrorTodoEntities",2),l([c()],m.prototype,"_enabled",2),l([c()],m.prototype,"_triggerEntityId",2),l([c()],m.prototype,"_triggerEntityIds",2),l([c()],m.prototype,"_triggerEntityLogic",2),l([c()],m.prototype,"_triggerAttribute",2),l([c()],m.prototype,"_triggerType",2),l([c()],m.prototype,"_triggerAbove",2),l([c()],m.prototype,"_triggerBelow",2),l([c()],m.prototype,"_triggerEquals",2),l([c()],m.prototype,"_triggerNotEquals",2),l([c()],m.prototype,"_triggerForMinutes",2),l([c()],m.prototype,"_triggerCombinator",2),l([c()],m.prototype,"_triggerTargetValue",2),l([c()],m.prototype,"_triggerDeltaMode",2),l([c()],m.prototype,"_triggerBaselineValue",2),l([c()],m.prototype,"_liveBaselineValue",2),l([c()],m.prototype,"_autoCompleteOnRecovery",2),l([c()],m.prototype,"_triggerFromState",2),l([c()],m.prototype,"_triggerToState",2),l([c()],m.prototype,"_triggerTargetChanges",2),l([c()],m.prototype,"_triggerRuntimeHours",2),l([c()],m.prototype,"_triggerRuntimeMaxSession",2),l([c()],m.prototype,"_triggerOnStates",2),l([c()],m.prototype,"_compoundLogic",2),l([c()],m.prototype,"_compoundConditions",2),l([c()],m.prototype,"_suggestedAttributes",2),l([c()],m.prototype,"_availableAttributes",2),l([c()],m.prototype,"_entityDomain",2),l([c()],m.prototype,"_lastPerformed",2),l([c()],m.prototype,"_nfcTagId",2),l([c()],m.prototype,"_requireTagScan",2),l([c()],m.prototype,"_allowSkip",2),l([c()],m.prototype,"_notifyEnabled",2),l([c()],m.prototype,"_readingUnit",2),l([c()],m.prototype,"_readings",2),l([c()],m.prototype,"_consumesParts",2),l([c()],m.prototype,"_partsLoadFailed",2),l([c()],m.prototype,"_availableTags",2),l([c()],m.prototype,"_responsibleUserId",2),l([c()],m.prototype,"_assigneePool",2),l([c()],m.prototype,"_rotationStrategy",2),l([c()],m.prototype,"_availableUsers",2),l([c()],m.prototype,"_checklistText",2),l([c()],m.prototype,"_phaseDefs",2),l([c()],m.prototype,"_phaseSeq",2),l([c()],m.prototype,"_requiredCompletion",2),l([c()],m.prototype,"_scheduleTime",2),l([c()],m.prototype,"_scheduleTimeOn",2),l([c()],m.prototype,"_actionService",2),l([c()],m.prototype,"_actionTargetEntity",2),l([c()],m.prototype,"_actionData",2),l([c()],m.prototype,"_actionDataJsonFallback",2),l([c()],m.prototype,"_actionTesting",2),l([c()],m.prototype,"_actionTestResult",2),l([c()],m.prototype,"_actionTestError",2),l([c()],m.prototype,"_qcNotes",2),l([c()],m.prototype,"_qcCost",2),l([c()],m.prototype,"_qcDuration",2),l([c()],m.prototype,"_qcFeedback",2),l([c()],m.prototype,"_environmentalEntity",2),l([c()],m.prototype,"_environmentalAttribute",2),l([c()],m.prototype,"_adaptiveEnabled",2),l([c()],m.prototype,"_adaptiveAlpha",2),l([c()],m.prototype,"_adaptiveMin",2),l([c()],m.prototype,"_adaptiveMax",2),l([c()],m.prototype,"_adaptiveSeasonal",2),l([c()],m.prototype,"_adaptivePrediction",2),l([c()],m.prototype,"_conditionAttrOptions",2);var It=m;customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",It);async function ii(r,o,t){let i=r.auth;if(i?.expired&&i.refreshAccessToken)try{await i.refreshAccessToken()}catch{}return fetch(o,{...t,headers:{...t.headers??{},Authorization:`Bearer ${i?.data?.access_token??""}`}})}async function si(r,o,t,i){let e=new FormData;e.append("entry_id",o);for(let _ of i)e.append("tags",_);e.append("file",t,t.name);let n=await ii(r,"/api/maintenance_supporter/document/upload",{method:"POST",body:e});if(n.status===413)throw new Error("doc_too_large");if(!n.ok)throw new Error("doc_upload_failed");let d=await n.json();if(!d.id)throw new Error("doc_upload_failed");return{id:d.id,deduped:!!d.deduped,duplicate_in_object:d.duplicate_in_object??null}}async function ce(r,o,t){return(await si(r,o,t,["photo"])).id}async function Tt(r,o){await Promise.all(o.map(t=>r.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:t}).catch(()=>{})))}var it=class{constructor(o,t){this.host=o;this.opts=t;this.photos=[];this.uploadedIds=[];this.uploading=!1;this.errorKey="";this.max=t.max??10,o.addController(this)}hostConnected(){}get ids(){return this.photos.map(o=>o.id)}get remaining(){return Math.max(this.max-this.photos.length,0)}get full(){return this.remaining===0}errorText(o){return this.errorKey?s(this.errorKey,o).replace("{max}",String(this.max)):""}clearError(){this.errorKey=""}reset(o=[]){this._revokeAll(),this.photos=o.map(t=>({id:t,preview:""})),this.uploadedIds=[],this.uploading=!1,this.errorKey="",this.host.requestUpdate()}async addFiles(o){if(o.length===0)return;let t=o.slice(0,this.remaining);this.uploading=!0,this.errorKey="",this.host.requestUpdate();try{for(let i of t){let e=await ce(this.opts.hass(),this.opts.entryId(),i);this.uploadedIds=[...this.uploadedIds,e],this.photos=[...this.photos,{id:e,preview:URL.createObjectURL(i)}],this.host.requestUpdate()}o.length>t.length&&(this.errorKey="photos_limit")}catch(i){this.errorKey=i instanceof Error&&i.message==="doc_too_large"?"doc_too_large":"doc_upload_failed"}finally{this.uploading=!1,this.host.requestUpdate()}}remove(o){let t=this.photos.find(i=>i.id===o);t?.preview&&URL.revokeObjectURL(t.preview),this.photos=this.photos.filter(i=>i.id!==o),this.uploadedIds.includes(o)&&(this.uploadedIds=this.uploadedIds.filter(i=>i!==o),Tt(this.opts.hass(),[o])),this.host.requestUpdate()}discardOrphans(){if(this.uploadedIds.length===0)return;let o=this.uploadedIds;this.uploadedIds=[],Tt(this.opts.hass(),o)}markAttached(){this.uploadedIds=[]}_revokeAll(){for(let o of this.photos)o.preview&&URL.revokeObjectURL(o.preview)}};function gt(){if(window.externalApp!==void 0)return!0;let o=typeof navigator<"u"&&navigator.userAgent||"";return/Home Assistant\//.test(o)&&/Android/.test(o)}var St={objectSections:"msp-object-sections",printOptions:"msp-print-options",batteryRosterOpen:"msp-bf-roster-open",docSort:"msp-doc-sort",cameraDevice:"msp-camera-device",overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view",objectsCache:"msp-objects-cache",gettingStartedDismissed:"msp-gs-dismissed",batteryRosterSort:"ms_bf_roster_sort"};function pe(r){try{return localStorage.getItem(r)}catch{return null}}function he(r,o){try{localStorage.setItem(r,o)}catch{}}function ue(){if(!gt())return!1;let r=typeof navigator<"u"?navigator.mediaDevices:void 0;return!!r&&typeof r.getUserMedia=="function"}var ri=1920,ni=.88,j=class extends E{constructor(){super(...arguments);this.lang="en";this._open=!1;this._busy=!1;this._devices=[];this._deviceIndex=-1;this._switchFailed=!1;this._facing="environment";this._stream=null;this._opening=!1}async open(){if(!(this._open||this._opening)){this._opening=!0;try{await this._acquireAndShow()}finally{this._opening=!1}}}async _acquireAndShow(){let t=typeof navigator<"u"?navigator.mediaDevices:void 0;if(!t||typeof t.getUserMedia!="function"){this._unavailable("no_media_devices");return}let i=pe(St.cameraDevice),e=!1;if(i)try{this._stream=await t.getUserMedia({video:{deviceId:{exact:i}},audio:!1}),e=!0}catch{}if(!e){try{this._stream=await t.getUserMedia({video:{facingMode:{ideal:"environment"},zoom:1,advanced:[{zoom:1}]},audio:!1})}catch(d){this._unavailable(d instanceof Error?d.name||d.message:String(d));return}if(await this._preferMainBackCamera(t),!this._stream)return}await this._applyZoomOne(),await this._listDevices(t),this._deviceIndex=this._indexOfCurrent(i&&e?i:null),this._switchFailed=!1,this._facing=this._stream?.getVideoTracks()[0]?.getSettings().facingMode??"environment",this._open=!0,await this.updateComplete;let n=this._video;if(n&&this._stream){n.srcObject=this._stream;try{await n.play()}catch{}}}async _preferMainBackCamera(t){if(typeof t.enumerateDevices!="function")return;let i=[];try{i=await t.enumerateDevices()}catch{return}let e=u=>{let h=/camera2?\s*(\d+)/i.exec(u.label);return h?Number(h[1]):Number.MAX_SAFE_INTEGER},n=i.filter(u=>u.kind==="videoinput"&&u.deviceId&&/back|rear|environment|rück|hinten/i.test(u.label)).sort((u,h)=>e(u)-e(h)),_=this._stream?.getVideoTracks()[0]?.getSettings().deviceId;if(n.length>1&&n[0].deviceId!==_){let u=_?[{deviceId:{exact:_}}]:[];u.push({facingMode:{ideal:"environment"}}),await this._swapCamera(t,[{deviceId:{exact:n[0].deviceId}}],u)===null&&this._unavailable("camera_lost")}}async _swapCamera(t,i,e){this._stopTracks();for(let[n,d]of i.entries())try{return this._stream=await t.getUserMedia({video:d,audio:!1}),n}catch{}for(let n of e)try{return this._stream=await t.getUserMedia({video:n,audio:!1}),-1}catch{}return null}async _attach(){let t=this._video;if(!(!t||!this._stream)){t.srcObject=this._stream;try{await t.play()}catch{}}}async _applyZoomOne(){let t=this._stream?.getVideoTracks()[0],i=t&&typeof t.getCapabilities=="function"?t.getCapabilities():void 0;if(!(!i?.zoom||typeof i.zoom.min!="number"||i.zoom.min>=1||(i.zoom.max??1)<1))for(let e of[{zoom:1},{advanced:[{zoom:1}]}])try{await t.applyConstraints(e);return}catch{}}_indexOfCurrent(t){let i=this._devices.map(n=>n.deviceId),e=this._currentDeviceId;for(let n of[t,e])if(n){let d=i.indexOf(n);if(d>=0)return d}return-1}async _listDevices(t){if(typeof t.enumerateDevices=="function")try{this._devices=(await t.enumerateDevices()).filter(i=>i.kind==="videoinput"&&!!i.deviceId)}catch{this._devices=[]}}get _currentDeviceId(){return this._stream?.getVideoTracks()[0]?.getSettings().deviceId}async _switchCamera(){let t=typeof navigator<"u"?navigator.mediaDevices:void 0;if(!t||this._devices.length<2||this._busy)return;let i=this._devices.map(h=>h.deviceId),e=this._currentDeviceId||(this._deviceIndex>=0?i[this._deviceIndex]:void 0),n=this._facing==="user"?"environment":"user",d=[];for(let h=1;h<i.length;h++){let g=(this._deviceIndex+h)%i.length;i[g]===e&&this._deviceIndex<0||d.push(g)}let _=[...d.map(h=>({deviceId:{exact:i[h]}})),{facingMode:{exact:n}},{facingMode:{ideal:n}}],u=e?[{deviceId:{exact:e}}]:[];u.push({facingMode:{ideal:this._facing}}),this._busy=!0;try{let h=await this._swapCamera(t,_,u);if(h===null){this._unavailable("camera_lost");return}h>=0&&h<d.length?(this._deviceIndex=d[h],this._switchFailed=!1,he(St.cameraDevice,i[d[h]])):h>=d.length&&!this._isCamera(e,this._facing)?(this._facing=n,this._deviceIndex=this._indexOfCurrent(null),this._switchFailed=!1):this._switchFailed=!0,await this._applyZoomOne(),await this._attach()}finally{this._busy=!1}}_isCamera(t,i){let e=this._stream?.getVideoTracks()[0]?.getSettings();return t&&e?.deviceId?e.deviceId===t:!!e?.facingMode&&e.facingMode===i}close(){this._stopStream(),this._open=!1,this._busy=!1}disconnectedCallback(){super.disconnectedCallback(),this._stopStream()}get _video(){return this.shadowRoot?.querySelector("video")??null}_stopStream(){this._stopTracks();let t=this._video;t&&(t.srcObject=null)}_stopTracks(){for(let t of this._stream?.getTracks()??[])t.stop();this._stream=null}_unavailable(t){this._stopStream(),this._open=!1,this.dispatchEvent(new CustomEvent("capture-unavailable",{detail:{reason:t},bubbles:!0,composed:!0}))}async _shoot(){let t=this._video;if(!(!t||this._busy)){this._busy=!0;try{let i=t.videoWidth||640,e=t.videoHeight||480,n=Math.min(1,ri/Math.max(i,e)),d=document.createElement("canvas");d.width=Math.round(i*n),d.height=Math.round(e*n);let _=d.getContext("2d");if(!_)throw new Error("no_canvas");_.drawImage(t,0,0,d.width,d.height);let u=await new Promise(v=>d.toBlob(v,"image/jpeg",ni));if(!u)throw new Error("no_blob");let h=new Date().toISOString().replace(/[-:]/g,"").slice(0,15),g=new File([u],`photo-${h}.jpg`,{type:"image/jpeg"});this.close(),this.dispatchEvent(new CustomEvent("photo-captured",{detail:{file:g},bubbles:!0,composed:!0}))}catch(i){this._unavailable(i instanceof Error?i.message:String(i))}finally{this._busy=!1}}}render(){if(!this._open)return p;let t=this.lang;return a`
      <div class="overlay" role="dialog" aria-modal="true" aria-label=${s("doc_camera",t)}>
        <video autoplay playsinline muted></video>
        ${this._switchFailed?a`<div class="switch-note" role="status">${s("camera_switch_failed",t)}</div>`:p}
        <div class="bar">
          <button type="button" class="cancel" @click=${this.close}>${s("cancel",t)}</button>
          ${this._devices.length>1?a`<button type="button" class="switch" ?disabled=${this._busy} title=${s("camera_switch_lens",t)} aria-label=${s("camera_switch_lens",t)} @click=${this._switchCamera}>
  ...
  `,l([f({type:String})],j.prototype,"lang",2),l([c()],j.prototype,"_open",2),l([c()],j.prototype,"_busy",2),l([c()],j.prototype,"_devices",2),l([c()],j.prototype,"_deviceIndex",2),l([c()],j.prototype,"_switchFailed",2);customElements.get("ms-camera-capture")||customElements.define("ms-camera-capture",j);var ft=w`
...
`,R=class extends E{constructor(){super(...arguments);this.lang="en";this.disabled=!1;this.busy=!1;this.accept="image/*";this.showCamera=!0;this.showGallery=!0;this.compact=!1;this.remaining=1/0;this._singlePick=gt();this._inAppCamera=ue()}createRenderRoot(){return this}get _locked(){return this.disabled||this.busy}_emit(t){t.length!==0&&this.dispatchEvent(new CustomEvent("files-picked",{detail:{files:t},bubbles:!0,composed:!0}))}_onInput(t){let i=t.target,e=Array.from(i.files??[]);i.value="",this._emit(e)}_onCameraClick(t){!this._inAppCamera||this._locked||(t.preventDefault(),this.querySelector("ms-camera-capture")?.open())}_onCameraUnavailable(){this._inAppCamera=!1,this.querySelector(".photo-pick-camera input")?.click()}_onKeydown(t){t.key!=="Enter"&&t.key!==" "||(t.preventDefault(),!this._locked&&t.currentTarget.click())}render(){if(this.remaining<=0||!this.showCamera&&!this.showGallery)return p;let t=this.lang,i=this._locked?"disabled":"",e=this.busy?s("uploading",t):s("doc_camera",t),n=s(this._singlePick?"choose_photo":"choose_photos",t);return a`
      <div class="photo-pickers">
        ${this.showCamera?a`<label class="photo-pick photo-pick-camera ${i}" role="button" tabindex="0"
              aria-label=${e} title=${this.compact?e:p}
              @click=${this._onCameraClick} @keydown=${this._onKeydown}>
              <ha-icon icon="mdi:camera"></ha-icon>
              ${this.compact?p:a`<span>${e}</span>`}
      ...
      ${this.showGallery&&this._singlePick?a`<div class="photo-android-hint">${s("photos_android_hint",t)}</div>`:p}
    ...
    `}};l([f({type:String})],R.prototype,"lang",2),l([f({type:Boolean})],R.prototype,"disabled",2),l([f({type:Boolean})],R.prototype,"busy",2),l([f({type:String})],R.prototype,"accept",2),l([f({type:Boolean})],R.prototype,"showCamera",2),l([f({type:Boolean})],R.prototype,"showGallery",2),l([f({type:Boolean})],R.prototype,"compact",2),l([f({type:Number})],R.prototype,"remaining",2),l([c()],R.prototype,"_inAppCamera",2);customElements.get("ms-photo-picker")||customElements.define("ms-photo-picker",R);var st=[.01,999],ot=[.01,9999],y=class extends E{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this.taskType="";this.readingUnit="";this.readings=[];this.readingHistory=[];this.restockDefault=null;this.restockUnitCost=null;this.currencySymbol="";this.parts=[];this.consumesParts=[];this.consumesInfo=[];this.requiredFields=[];this.phaseLabel="";this.requireTagScan=!1;this.viaTagScan=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed";this._photos=new it(this,{entryId:()=>this.entryId,hass:()=>this.hass});this._readingValue="";this._readingValues={};this._restockQty="";this._completedAt="";this._usedParts={};this._usedQtyText={};this.checklistPrefill={}}open(t={}){this._open||(this._open=!0,this.viaTagScan=!!t.viaTagScan,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState=Object.fromEntries(this.checklist.map((i,e)=>[String(e),!!this.checklistPrefill[i]]).filter(([,i])=>i)),this._feedback="needed",this._photos.reset(),this._readingValue="",this._readingValues={},this._restockQty=this.restockDefault!==null?String(this.restockDefault):"",this._completedAt="",this._usedParts=Object.fromEntries(this.consumesParts.map(i=>[D(i),{...i}])),this._usedQtyText={})}_rangeError(t,i){let e=this.lang;return s("settings_value_out_of_range",e).replace("{min}",S(t,e,{maximumFractionDigits:2})).replace("{max}",S(i,e,{maximumFractionDigits:2}))}_toggleCheck(t){let i=String(t);this._checklistState={...this._checklistState,[i]:!this._checklistState[i]}}_setFeedback(t){this._feedback=t}async _complete(){this._loading=!0,this._error="",this._photos.clearError();try{let t={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(t.notes=this._notes),this._cost){let e=parseFloat(this._cost);!isNaN(e)&&e>=0&&(t.cost=e)}let i=et(this._duration);if(i!==null&&(t.duration=i),this.checklist.length>0&&(t.checklist_state=this._checklistState),this.adaptiveEnabled&&(t.feedback=this._feedback),this._photos.photos.length>0&&(t.photo_doc_ids=this._photos.ids),this.viaTagScan&&(t.via_tag_scan=!0),this._completedAt){if(new Date(this._completedAt).getTime()>Date.now()){this._error=s("completed_at_future_error",this.lang),this._loading=!1;return}t.completed_at=this._completedAt.length===16?`${this._completedAt}:00`:this._completedAt}if(this.readings.length>0){let e={};for(let n of this.readings){let d=(this._readingValues[n.id]??"").trim();if(d==="")continue;let _=parseFloat(d.replace(",","."));isNaN(_)||(e[n.id]=_)}Object.keys(e).length>0&&(t.reading_values=e)}else if(this._readingValue!==""){let e=parseFloat(this._readingValue);isNaN(e)||(t.reading_value=e)}if(this.restockDefault!==null&&this._restockQty.trim()!==""){let e=parseFloat(this._restockQty.replace(",","."));if(!Number.isFinite(e)||e<ot[0]||e>ot[1]){this._error=this._rangeError(...ot),this._loading=!1;return}t.restock_quantity=e}if(this.parts.length>0){let e=[];for(let[n,d]of Object.entries(this._usedParts)){let _=this._usedQtyText[n],u=_===void 0?d.quantity:parseFloat(_.replace(",","."));if(!Number.isFinite(u)||u<st[0]||u>st[1]){this._error=this._rangeError(...st),this._loading=!1;return}e.push({...d,quantity:u})}t.used_parts=e.map(n=>n.entry_id?{part_id:n.part_id,quantity:n.quantity,entry_id:n.entry_id}:{part_id:n.part_id,quantity:n.quantity})}await this.hass.connection.sendMessagePromise(t),this._photos.markAttached(),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(t){this._error=A(t,this.lang,s("save_error",this.lang))}finally{this._loading=!1}}_renderReadingField(t,i){let e=this._completedAt?new Date(this._completedAt).getTime():NaN,n=Mt(this.readingHistory,t.id,isNaN(e)?void 0:e),d=t.unit||this.readingUnit,_=(this._readingValues[t.id]??"").trim(),u=_===""?NaN:parseFloat(_.replace(",",".")),h=n!==void 0&&!isNaN(u)&&u<n.value,g=n!==void 0?S(n.value,i,{maximumFractionDigits:3}):"";return a`
      ...
      </label>`}get _missingRequired(){let t={notes:this._notes.trim()!=="",cost:this._cost.trim()!=="",duration:this._duration.trim()!=="",photo:this._photos.photos.length>0,user:!!this.hass?.user};return this.requiredFields.filter(i=>!t[i])}_req(t){return this.requiredFields.includes(t)?a`<span class="req-mark" aria-hidden="true">*</span>`:p}_partsCostSuggestion(){if(this.restockDefault!==null){let e=parseFloat(this._restockQty);return this.restockUnitCost==null||!Number.isFinite(e)||e<=0?null:Math.round(this.restockUnitCost*e*100)/100}if(!this.parts.length)return null;let t=0,i=!1;for(let e of Object.values(this._usedParts)){let n=this.parts.find(d=>D({part_id:d.id,entry_id:d.entry_id})===D(e));n?.cost!=null&&(t+=n.cost*(e.quantity||1),i=!0)}return i?Math.round(t*100)/100:null}_renderCostSuggestion(t){if(this._cost.trim()!=="")return p;let i=this._partsCostSuggestion();if(i==null||i<=0)return p;let e=tt(i,this.currencySymbol,t);return a`<button
      type="button"
    ...
    >${s("cost_from_parts",t).replace("{amount}",e)}</button>`}_close(){this._open=!1,this._photos.discardOrphans()}_pickCompletedAt(){let t=new Date,i=e=>String(e).padStart(2,"0");this._completedAt=`${t.getFullYear()}-${i(t.getMonth()+1)}-${i(t.getDate())}T${i(t.getHours())}:${i(t.getMinutes())}:00`}render(){if(!this._open)return a``;let t=this.lang||this.hass?.language||"en",i=this._error||this._photos.errorText(t);return a`
      <ha-dialog open @closed=${this._close}>
        ...
        ${this.phaseLabel?a`<div class="phase-line">${s("phase_current",t)}: ${this.phaseLabel}</div>`:p}
        ${this.requireTagScan&&!this.viaTagScan?a`<div class="scan-required-note">${s("require_tag_scan_hint",t)}</div>`:p}
        <div class="content">
          ${i?a`<div class="error">${i}</div>`:p}
          ${this.checklist.length>0?a`
            <div class="checklist-section">
              <label class="checklist-label">${s("checklist",t)}</label>
              ${this.checklist.map((e,n)=>a`
          ...
          ${this.parts.length?a`<div class="used-parts">
                ...
                ${this.parts.map(e=>{let n=D({part_id:e.id,entry_id:e.entry_id}),d=this._usedParts[n],_=d!==void 0,u=e.entry_id?{part_id:e.id,quantity:1,entry_id:e.entry_id}:{part_id:e.id,quantity:1};return a`<div class="used-part-row">
                    <label class="used-part-check">
                      <input type="checkbox" .checked=${_}
                        @change=${h=>{let g={...this._usedParts};if(h.target.checked)g[n]=g[n]||u;else{delete g[n];let v={...this._usedQtyText};delete v[n],this._usedQtyText=v}this._usedParts=g}} />
                      <span
                        >${e.name}${e.owner_name?a`<span class="used-part-owner"> (${e.owner_name})</span>`:p}${e.stock!==null&&e.stock!==void 0?` (${e.stock}${e.unit?" "+e.unit:""})`:""}</span
                      >
                    </label>
                    ${_?a`<input class="used-part-qty" type="number" min=${st[0]} max=${st[1]} step="0.01"
                          .value=${this._usedQtyText[n]??String(d.quantity)}
                          @input=${h=>{let g=h.target.value;this._usedQtyText={...this._usedQtyText,[n]:g};let v=parseFloat(g.replace(",","."));Number.isFinite(v)&&v>=st[0]&&(this._usedParts={...this._usedParts,[n]:{...u,quantity:v}})}} />`:p}
                  </div>`})}
          ...
          ${this.restockDefault!==null?a`
              <label class="field">
                ...
                <input type="number" step="0.01" min=${ot[0]} max=${ot[1]} class="field-input"
        ...
        <div class="dialog-actions">
          ...
          <ha-button
            ...
            title=${this._missingRequired.length?this._missingRequired.map(e=>s("err_required",t).replace("{field}",s(at[e]??e,t))).join(" \xB7 "):""}
          >
  ...
  `],l([f({attribute:!1})],y.prototype,"hass",2),l([f()],y.prototype,"entryId",2),l([f()],y.prototype,"taskId",2),l([f()],y.prototype,"taskName",2),l([f()],y.prototype,"lang",2),l([f({type:Array})],y.prototype,"checklist",2),l([f({type:Boolean})],y.prototype,"adaptiveEnabled",2),l([f()],y.prototype,"taskType",2),l([f()],y.prototype,"readingUnit",2),l([f({attribute:!1})],y.prototype,"readings",2),l([f({attribute:!1})],y.prototype,"readingHistory",2),l([f({attribute:!1})],y.prototype,"restockDefault",2),l([f({attribute:!1})],y.prototype,"restockUnitCost",2),l([f()],y.prototype,"currencySymbol",2),l([f({attribute:!1})],y.prototype,"parts",2),l([f({attribute:!1})],y.prototype,"consumesParts",2),l([f({type:Array})],y.prototype,"consumesInfo",2),l([f({type:Array})],y.prototype,"requiredFields",2),l([f()],y.prototype,"phaseLabel",2),l([f({type:Boolean})],y.prototype,"requireTagScan",2),l([f({type:Boolean})],y.prototype,"viaTagScan",2),l([c()],y.prototype,"_open",2),l([c()],y.prototype,"_notes",2),l([c()],y.prototype,"_cost",2),l([c()],y.prototype,"_duration",2),l([c()],y.prototype,"_loading",2),l([c()],y.prototype,"_error",2),l([c()],y.prototype,"_checklistState",2),l([c()],y.prototype,"_feedback",2),l([c()],y.prototype,"_readingValue",2),l([c()],y.prototype,"_readingValues",2),l([c()],y.prototype,"_restockQty",2),l([c()],y.prototype,"_completedAt",2),l([c()],y.prototype,"_usedParts",2),l([c()],y.prototype,"_usedQtyText",2),l([f({attribute:!1})],y.prototype,"checklistPrefill",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",y);function _e(r,o,t){let i=new Blob([r],{type:t}),e=URL.createObjectURL(i),n=document.createElement("a");n.href=e,n.download=o,n.target="_blank",n.rel="noopener",n.style.display="none",document.body.appendChild(n),n.dispatchEvent(new MouseEvent("click")),document.body.removeChild(n),setTimeout(()=>URL.revokeObjectURL(e),6e4)}async function ai(r,o,t=300){return(await r.connection.sendMessagePromise({type:"auth/sign_path",path:o,expires:t})).path}async function me(r,o,t=300){return ai(r,`/api/maintenance_supporter/document/${o}`,t)}var Y=class extends E{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{this._url=await me(this.hass,this.docId)}catch{this._failed=!0}}render(){return this._failed||!this.docId?p:this._url?a`
      <a href=${this._url} target="_blank" rel="noopener" class="wrap">
        <img src=${this._url} alt="" loading="lazy"
          @error=${()=>this._failed=!0} />
      </a>`:a`<div class="ph"></div>`}};Y.styles=w`
  ...
  `,l([f({attribute:!1})],Y.prototype,"hass",2),l([f()],Y.prototype,"docId",2),l([c()],Y.prototype,"_url",2),l([c()],Y.prototype,"_failed",2);customElements.get("maintenance-history-photo")||customElements.define("maintenance-history-photo",Y);var L=class extends E{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null;this._partOptions=null;this._partQty={};this._partQtyOriginal="";this._photos=new it(this,{entryId:()=>this._draft?.entry_id??"",hass:()=>this.hass});this._photosOriginal="";this._readingRows=[];this._readingText={};this._readingsOriginal=""}get _lang(){return P(this.hass)}openEdit(t){this._draft={...t},this._originalSnapshot={...t},this._error="",this._open=!0,this._partOptions=null,this._partQty={},this._partQtyOriginal="",this._photos.reset(t.photo_doc_ids??[]),this._photosOriginal=JSON.stringify(this._photos.ids),this._seedReadings(t),this._loadPartOptions()}_seedReadings(t){let i=[],e=new Set;for(let d of t.readings??[])e.has(d.id)||(e.add(d.id),i.push({id:d.id,name:d.name,unit:d.unit??null}));for(let d of t.reading_values??[])e.has(d.id)||(e.add(d.id),i.push({id:d.id,name:d.name,unit:d.unit??null}));this._readingRows=i;let n={};for(let d of t.reading_values??[])n[d.id]=String(d.value);this._readingText=n,this._readingsOriginal=JSON.stringify(this._readingNumbers())}_readingNumbers(){let t={};for(let i of this._readingRows){let e=(this._readingText[i.id]??"").trim();if(e==="")continue;let n=parseFloat(e.replace(",","."));isNaN(n)||(t[i.id]=n)}return t}async _loadPartOptions(){let t=this._draft;if(t)try{let i=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"});if(this._draft!==t)return;let e=[];for(let d of i.parts||[]){let _=d.entry_id===t.entry_id,u=d.consumers.some(h=>h.entry_id===t.entry_id&&h.task_id===t.task_id);!_&&!u||e.push({part_id:d.part_id,name:d.name,entry_id:d.entry_id,foreign:!_,object_name:d.object_name})}for(let d of t.used_parts||[]){let _=d.entry_id||t.entry_id;e.some(u=>u.part_id===d.part_id&&u.entry_id===_)||e.push({part_id:d.part_id,name:d.name||d.part_id,entry_id:_,foreign:_!==t.entry_id,object_name:null})}let n={};for(let d of t.used_parts||[])n[`${d.entry_id||t.entry_id}:${d.part_id}`]=d.quantity??1;this._partOptions=e,this._partQty=n,this._partQtyOriginal=this._partSelectionKey()}catch{if(this._draft!==t)return;this._partOptions=[]}}_partSelectionKey(){return JSON.stringify(Object.entries(this._partQty).filter(([,t])=>t>0).sort(([t],[i])=>t.localeCompare(i)))}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null,this._photos.discardOrphans()}_set(t,i){this._draft&&(this._draft={...this._draft,[t]:i})}async _delete(){if(!this._draft||!this._originalSnapshot)return;let t=this._lang;if(!(!await Z(this.hass,{title:s("history_delete_entry",t),message:s("history_delete_confirm",t),confirmText:s("delete",t),danger:!0})||!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/history/delete",entry_id:this._draft.entry_id,task_id:this._draft.task_id,timestamp:this._originalSnapshot.original_timestamp}),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,deleted:!0},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=A(e,t)}finally{this._saving=!1}}}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="",this._photos.clearError();try{let t={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(t.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(t.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(t.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(t.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(t.completed_by=this._draft.completed_by),this._partOptions!==null&&this._partSelectionKey()!==this._partQtyOriginal&&(t.used_parts=(this._partOptions||[]).filter(e=>(this._partQty[`${e.entry_id}:${e.part_id}`]||0)>0).map(e=>({part_id:e.part_id,quantity:this._partQty[`${e.entry_id}:${e.part_id}`],...e.foreign?{entry_id:e.entry_id}:{}}))),this._draft.reading_value!==this._originalSnapshot.reading_value&&(t.reading_value=this._draft.reading_value??null),this._readingRows.length>0&&JSON.stringify(this._readingNumbers())!==this._readingsOriginal){let e=this._readingNumbers(),n={};for(let d of this._readingRows)n[d.id]=e[d.id]??null;t.reading_values=n}if(JSON.stringify(this._photos.ids)!==this._photosOriginal&&(t.photo_doc_ids=this._photos.ids),Object.keys(t).filter(e=>!["type","entry_id","task_id","original_timestamp"].includes(e)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(t),this._photos.markAttached(),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=A(t,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return p;let t=this._lang,i=this._draft,e=this._error||this._photos.errorText(t);return a`
        ...
        <div class="row">
          ...
          <label>
            ...
            <input type="number" min="0" step="1" inputmode="numeric"
              ...
              @input=${n=>{this._set("duration",et(n.target.value))}} />
          </label>
        </div>
          ...
          ${this._readingRows.map(e=>a`
            <label class="reading-row-edit">
              ...
              <input type="text" inputmode="decimal" class="reading-row-input"
                ...
                @input=${n=>{this._readingText={...this._readingText,[e.id]:n.target.value}}} />
            </label>
          `)}
        </div>`:t.reading_value==null&&t.task_type!=="reading"?p:a`
      <label>
        <span>${s("reading_value_label",i)}${t.reading_unit?` (${t.reading_unit})`:""}</span>
        <input type="number" step="any"
          .value=${t.reading_value!=null?String(t.reading_value):""}
          @input=${e=>{let n=e.target.value,d=n===""?NaN:Number(n);this._set("reading_value",isNaN(d)?null:d)}} />
      </label>`}};L.styles=[ft,w`
    :host { display: contents; }
    .backdrop {
  ...
  `],l([f({attribute:!1})],L.prototype,"hass",2),l([c()],L.prototype,"_open",2),l([c()],L.prototype,"_saving",2),l([c()],L.prototype,"_error",2),l([c()],L.prototype,"_draft",2),l([c()],L.prototype,"_partOptions",2),l([c()],L.prototype,"_partQty",2),l([c()],L.prototype,"_readingRows",2),l([c()],L.prototype,"_readingText",2);customElements.get("maintenance-history-edit-dialog")||customElements.define("maintenance-history-edit-dialog",L);function rt(r){return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ge(r){return!r.startsWith("data:image/svg+xml,")&&!r.startsWith("data:image/png;base64,")?"":rt(r)}function oi(r){return r.replace(/[/\\:*?"<>|#%]+/g,"").replace(/\s+/g,"-").toLowerCase().substring(0,100)}var q=class extends E{constructor(){super(...arguments);this.lang="en";this._open=!1;this._loading=!1;this._error="";this._viewResult=null;this._completeResult=null;this._urlMode="companion";this._entryId="";this._taskId=null;this._objectName="";this._taskName="";this._generateSeq=0}openForObject(t,i){this._entryId=t,this._taskId=null,this._objectName=i,this._taskName="",this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}openForTask(t,i,e,n){this._entryId=t,this._taskId=i,this._objectName=e,this._taskName=n,this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}async _generate(){let t=++this._generateSeq;this._loading=!0,this._error="",this._viewResult=null,this._completeResult=null;try{let i={type:"maintenance_supporter/qr/generate",entry_id:this._entryId,url_mode:this._urlMode};this._taskId&&(i.task_id=this._taskId);let e=[this.hass.connection.sendMessagePromise({...i,action:"view"})];this._taskId&&e.push(this.hass.connection.sendMessagePromise({...i,action:"complete"}));let n=await Promise.all(e);if(t!==this._generateSeq)return;this._viewResult=n[0],n.length>1&&(this._completeResult=n[1])}catch(i){if(t!==this._generateSeq)return;let e=i?.code,n=i?.message;this._error=e==="no_url"||typeof n=="string"&&n.includes("No Home Assistant URL")?s("qr_error_no_url",this.lang):s("qr_error",this.lang)}finally{t===this._generateSeq&&(this._loading=!1)}}_setUrlMode(t){this._urlMode!==t&&(this._urlMode=t,this._generate())}_print(){if(!this._viewResult)return;let t=this._viewResult,i=t.label.task_name?`${t.label.object_name} \u2014 ${t.label.task_name}`:t.label.object_name,e=[t.label.manufacturer,t.label.model].filter(Boolean).join(" "),n=window.open("","_blank","width=600,height=500");if(!n)return;let d=this.lang||"en",_=rt(i),u=rt(e),h=!!this._completeResult,g=rt(s("qr_action_view",d)),v=rt(s("qr_action_complete",d));n.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8">
...
<div class="qr-row">
  <div class="qr-col">
    <img src="${ge(this._viewResult.svg_data_uri)}" alt="QR Info" />
    <div class="qr-label">${g}</div>
  </div>
  ${h?`<div class="qr-col">
    <img src="${ge(this._completeResult.svg_data_uri)}" alt="QR Complete" />
    <div class="qr-label">${v}</div>
  </div>`:""}
</div>
<div class="url">${rt(this._viewResult.url)}</div>
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),n.document.close()}_downloadSvg(t,i){let e=decodeURIComponent(t.svg_data_uri.replace("data:image/svg+xml,","")),n=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;_e(e,`qr-${oi(n)}-${i}.svg`,"image/svg+xml")}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return a``;let t=this.lang||this.hass?.language||"en",i=this._taskName?`${s("qr_code",t)}: ${this._objectName} \u2014 ${this._taskName}`:`${s("qr_code",t)}: ${this._objectName}`,e=!!this._viewResult;return a`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${i}</div>
        <div class="content">
  ...
  `,l([f({attribute:!1})],q.prototype,"hass",2),l([f()],q.prototype,"lang",2),l([c()],q.prototype,"_open",2),l([c()],q.prototype,"_loading",2),l([c()],q.prototype,"_error",2),l([c()],q.prototype,"_viewResult",2),l([c()],q.prototype,"_completeResult",2),l([c()],q.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",q);function fe(r){let o=r.getFullYear(),t=String(r.getMonth()+1).padStart(2,"0"),i=String(r.getDate()).padStart(2,"0");return`${o}-${t}-${i}`}function li(r,o){if(o<=0)return 0;let t=typeof r=="number"&&Number.isFinite(r)?Math.trunc(r):0;return t<0?0:t%o}function di(r){return!!(r?.phases&&r.phase_sequence&&r.phase_sequence.length>0)}function At(r){if(!r||!di(r))return null;let o=r.phase_sequence,t=li(r.phase_cursor,o.length),i=o[t],e=r.phases?.[i];return e?{id:i,name:e.name,index:t,count:o.length,notes:e.notes,checklist:e.checklist!==void 0?e.checklist:r.checklist??[],consumesParts:e.consumes_parts!==void 0?e.consumes_parts:r.consumes_parts??[],requiredFields:e.required_completion_fields!==void 0?e.required_completion_fields:r.required_completion_fields??[]}:null}function lt(r){let o=At(r);return o?`${o.index+1}/${o.count} \xB7 ${o.name}`:""}function ve(r){let o=r.task??null,t=o?At(o):null,i=t?t.consumesParts:o?.consumes_parts||[],e=!!o?.part_ref,n=r.objects.find(g=>g.entry_id===r.entryId)?.parts||[],d=e?n.find(g=>g.id===o.part_ref.part_id):void 0,_=r.features?r.features.checklists:r.checklistsEnabled??!0,u=r.features?r.features.checklists?r.checklist??o?.checklist??[]:[]:r.checklist??[],h=r.features?r.features.adaptive&&(r.adaptiveEnabled??!!o?.adaptive_config?.enabled):!!r.adaptiveEnabled;return{entry_id:r.entryId,task_id:r.taskId,task_name:r.taskName,checklist:t?_?t.checklist:[]:u,adaptive_enabled:h,required_completion_fields:t?t.requiredFields:o?.required_completion_fields||[],task_type:o?.type||"",reading_unit:o?.reading_unit||"",readings:o?.readings||[],reading_history:Nt(o?.history),parts:e?[]:re({consumes_parts:i},r.entryId,r.objects,r.lang),consumes_parts:e?[]:i,phase_label:t?lt(o):"",require_tag_scan:!!o?.require_tag_scan,restock_default:e?d?.restock_quantity??1:null,restock_unit_cost:e?d?.cost??null:null,currency_symbol:nt({currency_symbol:r.currencySymbol}),consumes_info:i.map(g=>se(g,r.entryId,r.objects,r.lang)),checklist_prefill:o?.checklist_progress||{},via_tag_scan:!!r.viaTagScan}}function ye(r,o,t){r.entryId=o.entry_id,r.taskId=o.task_id,r.taskName=o.task_name,r.lang=t,r.checklist=o.checklist??[],r.adaptiveEnabled=!!o.adaptive_enabled,r.requiredFields=o.required_completion_fields??[],r.taskType=o.task_type??"",r.readingUnit=o.reading_unit??"",r.readings=o.readings??[],r.readingHistory=o.reading_history??[],r.parts=o.parts??[],r.consumesParts=o.consumes_parts??[],r.phaseLabel=o.phase_label??"",r.requireTagScan=!!o.require_tag_scan,r.restockDefault=o.restock_default??null,r.restockUnitCost=o.restock_unit_cost??null,r.currencySymbol=nt(o),r.consumesInfo=o.consumes_info??[],r.checklistPrefill=o.checklist_prefill??{},r.viaTagScan=!!o.via_tag_scan,r.open({viaTagScan:!!o.via_tag_scan})}var be=r=>typeof r=="number"&&Number.isInteger(r)&&r>0;function ci(r){return r&&be(r.ref_no)?String(r.ref_no):null}function $e(r,o){let t=ci(r);return t&&o&&be(o.ref_no)?`${t}.${o.ref_no}`:null}function xe(r,o){return r?a`<span class="ref-chip" title=${o??""}>#${r}</span>`:p}var pi=["completed","reset","skipped"];function ke(r){let o=t=>{let i=t.timestamp??"",e=Date.parse(i.length===10?`${i}T00:00:00`:i);return Number.isNaN(e)?-1/0:e};return(r??[]).map((t,i)=>({entry:t,index:i,at:o(t)})).sort((t,i)=>i.at-t.at||i.index-t.index).map(t=>t.entry)}function hi(r,o){return r.taskRef&&o.ref_no?`${r.taskRef}-${o.ref_no}`:null}function ui(r,o){let t=Rt(o);return t.length>0?a`<div class="history-photos">
        ${t.map(i=>a`<maintenance-history-photo .hass=${r} .docId=${i}></maintenance-history-photo>`)}
      </div>`:p}function _i(r,o){let t=o.lang,i=d=>S(d,t,{maximumFractionDigits:3}),e=d=>d==null?"":` (${d>=0?"+":""}${i(d)})`,n=Ht(r);return n.length>0?a`<div class="history-readings">
      ${n.map(d=>a`<span class="history-reading">
        <span class="history-reading-name">${d.name}</span>
        <span class="history-reading-value">${i(d.value)}${d.unit?` ${d.unit}`:""}${e(o.readingSlotDelta?.(r,d.id))}</span>
      </span>`)}
      ...
      <span class="history-reading-value">${i(r.reading_value)}${o.readingUnit?` ${o.readingUnit}`:""}${e(o.readingDelta?.(r))}</span>
    </span></div>`:p}function we(r,o,t={}){let i=o.lang,{compact:e=!1,showRef:n=!0,showBadges:d=!0,showEdit:_=!0}=t,u=_&&pi.includes(r.type);return a`
    <div class="history-entry${e?" compact":""}">
      ${e?p:a`<div class="history-icon ${r.type}">
            <ha-icon .icon=${ct[r.type]||"mdi:circle"}></ha-icon>
          </div>`}
      <div class="history-content">
        <div class="history-row">
          <strong>${s(r.type,i)}</strong>
          ${n?xe(hi(o,r),s("ref_number",i)):p}
        ...
        <div class="history-date">${Wt(r.timestamp,i)}</div>
        ${r.notes?a`<div>${r.notes}</div>`:p}
        ${ui(o.hass,r)}
        ${_i(r,o)}
        ${r.cost!=null||r.duration!=null||r.trigger_value!=null?a`<div class="history-details">
              ${r.cost!=null?a`<span>${s("cost",i)}: ${tt(r.cost,o.currencySymbol,i)}</span>`:p}
              ${r.duration!=null?a`<span>${s("duration",i)}: ${pt(r.duration,i)}</span>`:p}
              ${r.trigger_value!=null?a`<span>${s("trigger_val",i)}: ${r.trigger_value}</span>`:p}
            </div>`:p}
      </div>
    </div>
  `}var mi="var(--maint-done-color, #78909c)";function dt(r){return r.archived?"archived":r.is_done?"done":r.status||"ok"}function Ct(r,o){return s(r==="done"?"completed":r,o)}function vt(r){let o=dt(r);return o==="done"?mi:Lt[o]||"var(--disabled-color, #9e9e9e)"}function gi(r){return ct[r==="done"?"completed":r]||"mdi:circle-medium"}function Ee(r,o,t="pill"){let i=dt(r),e=Ct(i,o);return t==="chip"?a`<span class="status-chip ${i}">${e}</span>`:a`<span class="status-badge ${i}" role="img" title="${e}" aria-label="${e}"><ha-icon icon="${gi(i)}"></ha-icon><span class="status-label">${e}</span></span>`}var yt=class{constructor(){this._handle=null}schedule(o,t=4e3){this.clear(),this._handle=setTimeout(()=>{this._handle=null,o()},t)}clear(){this._handle!==null&&(clearTimeout(this._handle),this._handle=null)}get pending(){return this._handle!==null}};function k(r){return r.toFixed(1)}function Ie(r,o){let t=r.interval_analysis,i=t?.weibull_beta,e=t?.weibull_eta;if(i==null||e==null||e<=0)return p;let n=r.interval_days??0,d=r.suggested_interval??n;return a`
    <div class="weibull-section">
      ...
      ${vi(i,e,n,d,o)}
      ${yi(t,o)}
      ${t?.confidence_interval_low!=null?bi(t,r,o):p}
    </div>
  `}function fi(r,o){let t,i,e;return r<.8?(t="early_failures",i="M13,14H11V10H13M13,18H11V16H13M1,21H23L12,2L1,21Z",e="beta_early_failures"):r<=1.2?(t="random_failures",i="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M13,17H11V15H13V17M13,13H11V7H13V13Z",e="beta_random_failures"):r<=3.5?(t="wear_out",i="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M12,6A6,6 0 0,1 18,12H12V6Z",e="beta_wear_out"):(t="highly_predictable",i="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M11,16.5L18,9.5L16.59,8.09L11,13.67L7.91,10.59L6.5,12L11,16.5Z",e="beta_highly_predictable"),a`
    <span class="beta-badge ${t}">
      <ha-svg-icon path="${i}"></ha-svg-icon>
      ${s(e,o)} (\u03B2=${S(r,o,2)})
    </span>
  `}function vi(r,o,t,i,e){let b=Math.max(t,i,o,1)*1.3,$=50,H=[];for(let N=0;N<=$;N++){let F=N/$*b,Oe=1-Math.exp(-Math.pow(F/o,r)),Fe=32+F/b*260,De=136-Oe*128;H.push([Fe,De])}let W=H.map(([N,F])=>`${k(N)},${k(F)}`).join(" "),G="M32,136 "+H.map(([N,F])=>`L${k(N)},${k(F)}`).join(" ")+` L${k(H[$][0])},136 Z`,O=32+t/b*260,U=1-Math.exp(-Math.pow(t/o,r)),J=136-U*128,Ne=S((1-U)*100,e,0),Pt=32+i/b*260,Me=[0,.25,.5,.75,1];return a`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",e)}">
        ${Me.map(N=>{let F=136-N*128;return X`
            <line x1="${32}" y1="${k(F)}" x2="${292}" y2="${k(F)}"
              stroke="var(--divider-color)" stroke-width="0.5" stroke-dasharray="${N===.5?"4,3":p}" />
            <text x="${28}" y="${k(F+3)}" fill="var(--secondary-text-color)"
              font-size="8" text-anchor="end">${S(N*100,e,0)}%</text>
          `})}
        ...
        ${t>0?X`
          <line x1="${k(O)}" y1="${8}" x2="${k(O)}" y2="${k(136)}"
            stroke="var(--primary-color, #03a9f4)" stroke-width="1.5" stroke-dasharray="4,3" />
          <circle cx="${k(O)}" cy="${k(J)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${k(O+4)}" y="${k(J-6)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${Ne}%</text>
        `:p}

        ${i>0&&i!==t?X`
          <line x1="${k(Pt)}" y1="${8}" x2="${k(Pt)}" y2="${k(136)}"
    ...
    <div class="chart-legend">
      ...
      ${t>0?a`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4); opacity:0.5"></span> ${s("current_interval_marker",e)}</span>`:p}
      ${i>0&&i!==t?a`<span class="legend-item"><span class="legend-swatch" style="background:var(--success-color, #4caf50)"></span> ${s("recommended_marker",e)}</span>`:p}
    </div>
  `}function yi(r,o){return a`
    <div class="weibull-info-row">
      ...
      ${r.weibull_r_squared!=null?a`
        <div class="weibull-info-item">
          ...
          <span class="weibull-info-value">${S(r.weibull_r_squared,o,3)}</span>
        </div>
      `:p}
    </div>
  `}function bi(r,o,t){let i=r.confidence_interval_low,e=r.confidence_interval_high,n=o.suggested_interval??o.interval_days??0,d=o.interval_days??0,_=Math.max(0,i-5),h=e+5-_,g=(i-_)/h*100,v=(e-i)/h*100,x=(n-_)/h*100,b=d>0?(d-_)/h*100:-1;return a`
    <div class="confidence-range">
      <div class="confidence-range-title">
        ${s("confidence_interval",t)}: ${n} ${s("days",t)} (${i}\u2013${e})
      </div>
      <div class="confidence-bar">
        <div class="confidence-fill" style="left:${k(g)}%;width:${k(v)}%"></div>
        ${b>=0?a`<div class="confidence-marker current" style="left:${k(b)}%"></div>`:p}
      ...
      <div class="prediction-grid">
        ${i?a`
          <div class="prediction-item">
            ...
            ${r.degradation_rate!=null?a`<span class="prediction-rate">${r.degradation_rate>0?"+":""}${S(r.degradation_rate,o,Math.abs(r.degradation_rate)>=10?0:1)} ${r.trigger_entity_info?.unit_of_measurement||""}/${s("day_short",o)}</span>`:p}
          </div>
        `:p}
        ${e?a`
          <div class="prediction-item">
            ...
            ${r.threshold_prediction_date?a`<span class="prediction-date">${Q(r.threshold_prediction_date,o)}</span>`:p}
        ...
        ${n&&t.environmental?a`
          <div class="prediction-item">
            ...
            <span class="prediction-value">${S(r.environmental_factor,o,2)}x</span>
            ${r.environmental_entity?a`<span class="prediction-entity entity-link" @click=${_=>Qt(_,r.environmental_entity)}>${r.environmental_entity}</span>`:p}
          </div>
        `:p}
      </div>
    </div>
  `}function Se(r,o,t,i){let e=Math.max(r||1,o);return a`
    <div class="interval-comparison">
      <div class="interval-bar">
        ...
        <div class="interval-visual current"
          style="width: ${r!=null?Math.min(r/e*100,100):0}%"></div>
      </div>
      <div class="interval-bar">
        <div class="interval-label">
  ...
  `}function Pe(r,o){return $i(r,o)}function $i(r,o){let t=r.seasonal_factors??r.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return p;let i=r.interval_analysis?.seasonal_reason,e=new Date().getMonth(),n=300,d=100,_=8,h=d-_-4,g=Math.max(...t,1.5),v=n/12,x=v*.65,b=_+h-1/g*h;return a`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${n} ${d}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_seasonal",o)}">
        <line x1="0" y1="${k(b)}" x2="${n}" y2="${k(b)}"
          stroke="var(--divider-color)" stroke-width="1" stroke-dasharray="4,3" />
        ${t.map(($,H)=>{let W=$/g*h,G=H*v+(v-x)/2,O=_+h-W,U=H===e,J=$<1?"var(--success-color, #4caf50)":$>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return X`
            <rect x="${k(G)}" y="${k(O)}"
              width="${k(x)}" height="${k(W)}"
              fill="${J}" opacity="${U?1:.5}" rx="2" />
          `})}
      </svg>
      <div class="seasonal-labels">
        ${Ae.map(($,H)=>a`<span class="seasonal-label ${H===e?"active-month":""}">${s($,o)}</span>`)}
      </div>
    </div>
  `}var I=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._taskRef=null;this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._toastTimer=new yt;this._access=ht;this._currencySymbol=""}get _lang(){return P(this.hass)}async openFor(t,i){this._entryId=t,this._taskId=i,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=fe(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){let t=await K(this.hass);this._features={...this._features,...t.features},this._access=t.access,this._currencySymbol=nt(t.budget??void 0),Vt(t.budget??void 0)}close(){this._open=!1,this._task=null,this._error="",this._toastTimer.clear(),this._toast=""}_showToast(t,i){this._toast=t,this._toastTimer.schedule(()=>{this._toast=""},i)}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let i=(t.tasks||[]).find(e=>e.id===this._taskId);this._task=i??null,this._taskRef=$e(t.object,i)}catch(t){this._error=A(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(i){return this._error=A(i,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-VRPUGSMZ.js").then(async({openCompleteDialog:t})=>{let i=this._task,e=[];try{e=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}t(ve({entryId:this._entryId,taskId:this._taskId,taskName:i.name,task:i,objects:e,lang:this._lang,features:this._features,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-VRPUGSMZ.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-VRPUGSMZ.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId||!await Z(this.hass,{title:s("delete",this._lang),message:s("delete_task_confirm",this._lang),confirmText:s("delete",this._lang),danger:!0}))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._showToast(s("suggestion_applied",this._lang)),this._notifyChanged("apply_suggestion"),await this._loadTask())}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._showToast(t.recommended_interval?`${s("reanalyze_result",this._lang)}: ${Kt(t.recommended_interval,"days",this._lang)} (${t.data_points} pts)`:s("reanalyze_insufficient_data",this._lang)),await this._loadTask()}catch(t){this._error=A(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){if(!this._entryId||!this._taskId)return;let i=jt(this._entryId,this._taskId,t,this._task);import("./dialog-mount-VRPUGSMZ.js").then(({openHistoryEditDialog:e})=>e(i))}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return p;let i=this._lang;return a`
      <div class="recommendation-card">
        <h4>${s("suggested_interval",i)}</h4>
        ${Se(t.interval_days,t.suggested_interval,t.interval_confidence||"medium",i)}
    ...
    `}_renderAdaptive(t){let i=this._lang,e=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,n=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,d=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,_=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!e&&!n&&!d&&!_?a`<div class="adaptive-empty">
        ${s("adaptive_no_data",i)}
      </div>`:a`
      <div class="adaptive-stack">
        ${this._toast?a`<div class="toast">${this._toast}</div>`:p}
        ${e?this._renderRecommendation(t):p}
        ${n?Te(t,i,this._features):p}
        ${d?Ie(t,i):p}
        ${_?a`
          ${Ce(t,i,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?Pe(t,i):p}
        `:p}
      </div>
    `}_renderDetails(t){let i=this._lang,e=t.history||[],n=t.history_count??e.length,d=ke(e).slice(0,20);return a`
      <div class="details">
        <div class="stats-grid">
          ...
          <div class="stat">
            ...
            <span class="stat-value">${tt(t.total_cost??0,this._currencySymbol,i)}</span>
          </div>
          <div class="stat">
            <span class="stat-label">${s("avg_duration",i)}</span>
            <span class="stat-value">${pt(t.average_duration!=null?Math.round(t.average_duration):null,i)}</span>
          </div>
        </div>
        ...
        ${e.length===0?a`<div class="history-empty">${s("history_empty",i)}</div>`:a`
              <div class="history-list">
                ${d.map(_=>we(_,{lang:i,hass:this.hass,currencySymbol:this._currencySymbol,openEdit:u=>this._onEditHistoryEntry(u),readingUnit:t.reading_unit,readingSlotDelta:(u,h)=>Ot(e,u,h),taskRef:this._taskRef},{compact:!0}))}
                ${n>d.length?a`<div class="history-more">… +${n-d.length} ${s("older_entries",i)}</div>`:p}
              </div>
            `}
      </div>
    `}render(){if(!this._open)return p;let t=this._lang,i=this._task,e=ut(this.hass?.user,this._access);return a`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${i?a`
              <div class="header">
                <div class="title">
                  <span class="status-dot" style="background: ${vt(i)}"></span>
                  <span class="task-name">${i.name}</span>
                  ${Ee(i,t)}
                </div>
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-VRPUGSMZ.js").then(({openObjectQuickActions:n})=>{n(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${i.next_due?a`<span><strong>${s("next_due",t)}:</strong> ${Q(i.next_due,t)}</span>`:p}
                  ${i.last_performed?a`<span><strong>${s("last_performed",t)}:</strong> ${Q(i.last_performed,t)}</span>`:p}
                  ${i.schedule?.kind&&!["manual","one_time"].includes(i.schedule.kind)||i.interval_days!=null?a`<span><strong>${s("interval",t)}:</strong> ${Gt(i,t)}</span>`:p}
                  ${lt(i)?a`<span><strong>${s("phase_current",t)}:</strong> ${lt(i)}</span>`:p}
                </div>
              </div>
              ...
              ${this._showSkip?a`
                  ...
                  `:a`
                    ...
                    <div class="actions secondary-row">
                      ${e?a`<ha-button size="small" appearance="outlined" variant="neutral" class="qa-edit" @click=${this._onEdit} .disabled=${this._busy}>
                      ...
                      ${e?a`<ha-button size="small" appearance="outlined" variant="neutral" class="qa-archive"
  ...
  `],l([f({attribute:!1})],I.prototype,"hass",2),l([c()],I.prototype,"_open",2),l([c()],I.prototype,"_entryId",2),l([c()],I.prototype,"_taskId",2),l([c()],I.prototype,"_task",2),l([c()],I.prototype,"_objectName",2),l([c()],I.prototype,"_taskRef",2),l([c()],I.prototype,"_busy",2),l([c()],I.prototype,"_error",2),l([c()],I.prototype,"_showSkip",2),l([c()],I.prototype,"_showReset",2),l([c()],I.prototype,"_showDetails",2),l([c()],I.prototype,"_showAdaptive",2),l([c()],I.prototype,"_skipReason",2),l([c()],I.prototype,"_resetDate",2),l([c()],I.prototype,"_features",2),l([c()],I.prototype,"_toast",2),l([c()],I.prototype,"_access",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",I);function Le(r){return!!r&&/^https?:\/\//i.test(r)}function Re(r){return r?customElements.get("ha-markdown")?a`<ha-markdown class="notes-md" .content=${r} breaks></ha-markdown>`:a`${r}`:p}var M=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error="";this._access=ht}get _lang(){return P(this.hass)}async openFor(t){this._entryId=t,this._error="",this._open=!0,await Promise.all([this._load(),K(this.hass).then(i=>{this._access=i.access})])}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=A(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-VRPUGSMZ.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-VRPUGSMZ.js").then(({openCreateTaskDialog:t})=>{t(this._entryId),this.close()})}async _onDelete(){if(!(!this._entryId||!this._data||!await Z(this.hass,{title:s("delete",this._lang),message:s("delete_object_confirm",this._lang),confirmText:s("delete",this._lang),danger:!0}))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!(!t&&!await Z(this.hass,{title:s("archive_object",this._lang),message:s("confirm_archive_object",this._lang),confirmText:s("archive_object",this._lang)}))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(i){this._error=A(i,this._lang)}finally{this._busy=!1}}}_onTaskClick(t){this._entryId&&import("./dialog-mount-VRPUGSMZ.js").then(({openTaskQuickActions:i})=>{i(this._entryId,t)})}render(){if(!this._open)return p;let t=this._lang,i=this._data,e=i?.object,n=i?.tasks||[],d=ut(this.hass?.user,this._access);return a`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${i&&e?a`
              <div class="header">
              ...
              <div class="tasks-section">
                ...
                ${n.length===0?a`<div class="empty">${s("no_tasks",t)}</div>`:a`
                      <div class="task-list">
                        ${n.map(_=>a`
                          <div class="task-row" @click=${()=>this._onTaskClick(_.id)}>
                            <span class="status-dot" style="background: ${vt(_)}"></span>
                            <span class="task-name">${_.name}</span>
                            <span class="task-status ${dt(_)}">${Ct(dt(_),t)}</span>
                          </div>
                        `)}
                      </div>
                    `}
              ...
              ${e.notes?a`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${Re(e.notes)}</div>
                    </div>
                  `:p}
  ...
  `,l([f({attribute:!1})],M.prototype,"hass",2),l([c()],M.prototype,"_open",2),l([c()],M.prototype,"_entryId",2),l([c()],M.prototype,"_data",2),l([c()],M.prototype,"_busy",2),l([c()],M.prototype,"_error",2),l([c()],M.prototype,"_access",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",M);var qe="maintenance-object-dialog",He="maintenance-task-dialog",xi="maintenance-history-edit-dialog",ki="maintenance-complete-dialog",wi="maintenance-qr-dialog",Ei="maintenance-task-quick-actions-dialog",Ii="maintenance-object-quick-actions-dialog";function bt(){return document.querySelector("home-assistant")?.hass}function Ti(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function V(r){let o=Ti(),t=o.querySelector(r)??document.body.querySelector(r);return t?t.parentNode!==o&&o.appendChild(t):(t=document.createElement(r),o.appendChild(t)),t}function B(r){let o=bt();if(!o)return!1;r.hass=o;let t=P(o);return Ut(t)||zt(t).then(()=>{r.requestUpdate?.()}),Bt(o.locale,o.config?.country),!0}function ha(r){return K(r).then(o=>o.rowActionStyle)}function ua(){Xt()}function _a(){let r=V(qe);return B(r)?(r.openCreate(),!0):!1}function ma(r,o){let t=V(qe);return B(t)?(t.openEdit(r,o),!0):!1}function ga(r="",o){let t=V(He);if(!B(t))return!1;let i=bt();return i?((async()=>{let e=await K(i),n=t;n.checklistsEnabled=e.features.checklists,n.scheduleTimeEnabled=e.features.schedule_time,n.completionActionsEnabled=e.features.completion_actions,n.defaultWarningDays=e.defaultWarningDays,n.openCreate(r,o)})(),!0):!1}function fa(r,o){let t=V(He);if(!B(t))return!1;let i=bt();return i?((async()=>{try{let[e,n]=await Promise.all([i.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:r}),K(i)]),d=(e.tasks||[]).find(u=>u.id===o);if(!d){console.warn(`openEditTaskDialog: task ${o} not found in entry ${r}`);return}let _=t;_.checklistsEnabled=n.features.checklists,_.scheduleTimeEnabled=n.features.schedule_time,_.completionActionsEnabled=n.features.completion_actions,_.defaultWarningDays=n.defaultWarningDays,await _.openEdit(r,d)}catch(e){console.warn("openEditTaskDialog: failed to load task/features",e)}})(),!0):!1}function va(r){let o=V(xi);return B(o)?(o.openEdit(r),!0):!1}function ya(r){let o=V(ki);return B(o)?(ye(o,r,P(bt())),!0):!1}function ba(r){let o=V(wi);return B(o)?(o.openForTask(r.entry_id,r.task_id,r.object_name,r.task_name),!0):!1}function $a(r,o){let t=V(Ei);return B(t)?(t.openFor(r,o),!0):!1}function xa(r){let o=V(Ii);return B(o)?(o.openFor(r),!0):!1}export{ua as __resetSettingsCacheForTests,ha as getRowActionStyle,ya as openCompleteDialog,_a as openCreateObjectDialog,ga as openCreateTaskDialog,ma as openEditObjectDialog,fa as openEditTaskDialog,va as openHistoryEditDialog,xa as openObjectQuickActions,ba as openQrDialog,$a as openTaskQuickActions};
