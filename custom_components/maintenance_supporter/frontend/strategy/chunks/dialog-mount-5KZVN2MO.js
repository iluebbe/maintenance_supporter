...
import{a as E,b as n,c as z,d as u,e as I,f as v,g as l,i as s,j as S,k as ot,l as lt,m as j,n as dt,o as ct,p as tt,q as pt,r as ht,s as ut,t as _t,u as T}from"./chunk-O3XU4M75.js";import{a as o,b as Q}from"./chunk-BCPDJQZX.js";var w=class extends I{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(t){let e=t.target.value;this.value=e,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:e}}))}render(){return n`
      <label class="field">
...
`),partId:g.consumes_parts?.[0]?.part_id||"",partQty:g.consumes_parts?.[0]?.quantity!=null?String(g.consumes_parts[0].quantity):"",reqOverride:g.required_completion_fields!==void 0,reqFields:[...g.required_completion_fields||[]],extraParts:(g.consumes_parts||[]).slice(1),carry:L}}),this._phaseSeq=[...e.phase_sequence||[]],this._requiredCompletion=[...e.required_completion_fields||[]],this._scheduleTime=e.schedule_time||"";let d=e.on_complete_action;if(d&&d.service){this._actionService=d.service;let h=d.target?.entity_id;this._actionTargetEntity=Array.isArray(h)?h[0]||"":h||"",this._actionData=d.data&&typeof d.data=="object"?{...d.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let p=e.quick_complete_defaults;this._qcNotes=p?.notes||"",this._qcCost=p?.cost!=null?String(p.cost):"",this._qcDuration=p?.duration!=null?String(p.duration):"",this._qcFeedback=p?.feedback||"";let _=e.adaptive_config||{};if(this._environmentalEntity=_.environmental_entity||"",this._environmentalAttribute=_.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,this._adaptiveEnabled=!!_.enabled,this._adaptiveAlpha=_.ewa_alpha?.toString()??M.alpha,this._adaptiveMin=_.min_interval_days?.toString()??M.min,this._adaptiveMax=_.max_interval_days?.toString()??M.max,this._adaptiveSeasonal=_.seasonal_enabled!==!1,this._adaptivePrediction=_.sensor_prediction_enabled!==!1,this._adaptiveInitial=this._adaptiveSnapshot(),e.trigger_config){let h=e.trigger_config;this._triggerEntityId=h.entity_id||h.entity_ids&&h.entity_ids[0]||"",this._triggerEntityIds=h.entity_ids||(h.entity_id?[h.entity_id]:[]),this._triggerEntityLogic=h.entity_logic||"any",this._triggerAttribute=h.attribute||"",this._triggerType=h.type||"threshold",this._triggerAbove=h.trigger_above?.toString()||"",this._triggerBelow=h.trigger_below?.toString()||"",this._triggerEquals=h.trigger_equals?.toString()||"",this._triggerNotEquals=h.trigger_not_equals?.toString()||"",this._triggerForMinutes=h.trigger_for_minutes?.toString()||"0",this._triggerCombinator=h.trigger_combinator==="all"?"all":"any",this._triggerTargetValue=h.trigger_target_value?.toString()||"",this._triggerDeltaMode=h.trigger_delta_mode||!1,this._triggerBaselineValue=h.trigger_baseline_value?.toString()||"",this._liveBaselineValue=e.trigger_baseline_value??null,this._autoCompleteOnRecovery=h.auto_complete_on_recovery||!1,this._triggerFromState=h.trigger_from_state||"",this._triggerToState=h.trigger_to_state||"",this._triggerTargetChanges=h.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=h.trigger_runtime_hours?.toString()||"",this._triggerOnStates=(h.trigger_on_states||[]).join(", "),h.type==="compound"?(this._compoundLogic=h.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(h.conditions||[]).map(Wt)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._requireTagScan=!1,this._readingUnit="",this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._phaseDefs=[],this._phaseSeq=[],this._requiredCompletion=[],this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._adaptiveEnabled=!1,this._adaptiveAlpha=M.alpha,this._adaptiveMin=M.min,this._adaptiveMax=M.max,this._adaptiveSeasonal=!0,this._adaptivePrediction=!0,this._adaptiveInitial=this._adaptiveSnapshot(),this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerEquals="",this._triggerNotEquals="",this._triggerForMinutes="0",this._triggerCombinator="any",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new Y(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(t){console.error("Failed to load users:",t),this._availableUsers=[]}}_toggleAssignee(t){this._assigneePool=this._assigneePool.includes(t)?this._assigneePool.filter(e=>e!==t):[...this._assigneePool,t]}async _testAction(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[e,i]=t.split(".");if(!this.hass?.services?.[e]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${t}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let r=this._actionTargetEntity.trim();if(r){let d=r.split(".")[0];if(d!==e&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(e)){this._actionTestResult="error",this._actionTestError=`Service "${t}" only works on ${e}.* entities; entity "${r}" is in ${d}.* \u2014 pick a service that matches the entity domain (e.g. ${d}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[r]){this._actionTestResult="error",this._actionTestError=`Target entity "${r}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let t=JSON.parse(this._actionDataJsonFallback);if(t&&typeof t=="object"&&!Array.isArray(t))return t}catch{}return{...this._actionData}}_serviceSchema(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t))return null;let[e,i]=t.split("."),r=this.hass?.services?.[e]?.[i]?.fields;return!r||Object.keys(r).length===0?null:Object.entries(r).map(([d,p])=>({name:d,required:!!p.required,selector:p.selector||{text:{}}}))}_renderCompletionActionsSection(t){if(!this.completionActionsEnabled)return u;let e=this._serviceSchema();return n`
      <details class="ca-section">
        ...
        <div class="ca-test-row">
          ...
          ${this._actionTestResult==="ok"?n`<span class="ca-test-ok">${s("on_complete_action_test_success",t)}</span>`:u}
    ...
    `}async _loadParts(){if(this.parts=[],!!this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this.parts=t.parts||[],this._partsLoadFailed=!1}catch{this.parts=[],this._partsLoadFailed=!0}}async _loadForeignPools(){if(this._foreignOwners=[],!!this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._foreignOwners=(t.objects||[]).filter(e=>e.entry_id!==this._entryId&&(e.parts||[]).length>0).map(e=>({entry_id:e.entry_id,name:e.object?.name||e.entry_id,parts:e.parts||[]})).sort((e,i)=>e.name.localeCompare(i.name))}catch{this._foreignOwners=[]}}async _loadTags(){try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tags/list"});this._availableTags=t.tags||[]}catch{this._availableTags=[]}}_fetchConditionAttributes(t){!t||!this.hass||this._conditionAttrOptions[t]||this._conditionAttrPending.has(t)||(this._conditionAttrPending.add(t),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/entity/attributes",entity_id:t}).then(e=>{let i=e;this._conditionAttrOptions={...this._conditionAttrOptions,[t]:{suggested:i.suggested_attributes||[],available:i.available_attributes||[]}}}).catch(()=>{this._conditionAttrOptions={...this._conditionAttrOptions,[t]:{suggested:[],available:[]}}}))}async _fetchEntityAttributes(t){if(!t||!this.hass){this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="";return}try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/entity/attributes",entity_id:t});this._entityDomain=e.domain||"",this._suggestedAttributes=e.suggested_attributes||[],this._availableAttributes=e.available_attributes||[]}catch{this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain=""}}get _hasForeignPick(){return Object.values(this._consumesParts).some(t=>!!t.entry_id)}_renderConsumesRow(t,e){let i=R({part_id:t.id,entry_id:e}),r=this._consumesParts[i],d=e?{part_id:t.id,quantity:1,entry_id:e}:{part_id:t.id,quantity:1};return n`
      <div class="consumes-row">
        ...
        ${r!==void 0?n`<input
              ...
              @input=${p=>{let _=parseFloat(p.target.value);this._consumesParts={...this._consumesParts,[i]:{...d,quantity:Number.isFinite(_)&&_>=.01?_:1}}}}
            />`:u}
      </div>
              ...
              ${it.map(r=>n`
                <label class="req-option">
                  <input
                    ...
                    @change=${d=>{let p=d.target.checked,_=new Set(i.reqFields);p?_.add(r):_.delete(r),this._patchPhaseDef(i.id,{reqFields:[..._]})}}
                  />
                  <span>${s(V[r],t)}</span>
                </label>
              `)}
...
`).map(_=>_.trim()).filter(Boolean).slice(0,100);t.checklist=p.length?p:null}if(this.completionActionsEnabled){let p=this._actionService.trim();if(p&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(p)){let y={service:p},b=this._actionTargetEntity.trim();b&&(y.target={entity_id:b});let $=this._buildActionData();Object.keys($).length>0&&(y.data=$),t.on_complete_action=y}else t.on_complete_action=null;let _={};this._qcNotes.trim()&&(_.notes=this._qcNotes.trim());let h=parseFloat(this._qcCost);!isNaN(h)&&h>=0&&(_.cost=h);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(_.duration=g),this._qcFeedback&&(_.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(_).length?_:null}let i=await this.hass.connection.sendMessagePromise(t),r=this._taskId||i?.task_id,d=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(r&&this._scheduleType==="sensor_based"&&d)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:r,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(r&&this._adaptiveSnapshot()!==this._adaptiveInitial){let p=parseFloat(this._adaptiveAlpha),_=parseInt(this._adaptiveMin,10),h=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:r,enabled:this._adaptiveEnabled,...p>=.1&&p<=.9?{ewa_alpha:p}:{},...!isNaN(_)&&_>=1?{min_interval_days:_}:{},...!isNaN(h)&&h>=1?{max_interval_days:h}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=T(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return u;let t=this._lang,e=this._triggerType==="compound";return n`
      ...
      <div class="select-row">
        ...
        >
          ${Ut.map(i=>n`<option value=${i} ?selected=${i===this._triggerType}>${s(i,t)}</option>`)}
        </select>
      </div>
      ...
      ${this._intervalDays?n`
          ...
          `:u}
    `}_patchCondition(t,e){this._compoundConditions=this._compoundConditions.map((i,r)=>r===t?{...i,...e}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Vt()]}_removeCondition(t){this._compoundConditions=this._compoundConditions.filter((e,i)=>i!==t)}_renderCompoundEditor(){let t=this._lang;return n`
      <div class="select-row">
    ...
    `}_renderCondition(t,e){let i=this._lang,r=e+1;return n`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${ft.map(d=>n`<option value=${d} ?selected=${d===t.type}>${s(d,i)}</option>`)}
          </select>
        </div>
    ...
    `}_renderOnStatesField(t){let e=this._lang;return this._entityPickerFallback||!t.entityId?n`
      ...
      ></ha-form>
    `}_renderAdaptiveSection(t){return this._scheduleType==="one_time"||this._scheduleType==="manual"?u:n`
    ...
    `}_renderEnvironmentalAttribute(t){this._fetchConditionAttributes(this._environmentalEntity);let e=this._conditionAttrOptions[this._environmentalEntity];return this._renderAttributeSelect({label:s("environmental_attribute_optional",t),value:this._environmentalAttribute,suggested:e?.suggested??[],available:e?.available??[],onSelect:i=>this._environmentalAttribute=i})}_renderConditionAttribute(t,e){let i=t.entityIds.split(",")[0]?.trim()||"";i&&this._fetchConditionAttributes(i);let r=i?this._conditionAttrOptions[i]:void 0;return this._renderAttributeSelect({label:s("attribute_optional",this._lang),value:t.attribute,suggested:r?.suggested??[],available:r?.available??[],onSelect:d=>this._patchCondition(e,{attribute:d})})}_renderConditionTypeFields(t,e){let i=this._lang;if(t.type==="threshold")return n`
      ...
      `}return u}_renderUnitSelect(){let t=this._lang;return n`
      <div class="select-row">
    ...
    `}_buildSchedule(){let t=i=>{let r=parseInt(this._calOffset,10)||0;return r&&(i.offset=Math.max(-15,Math.min(r,15))),i};if(this._scheduleType==="weekdays")return t({kind:"weekdays",weekdays:[...this._weekdays].sort((i,r)=>i-r)});if(this._scheduleType==="nth_weekday")return t({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let e={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(e.business=!0),t(e)}_recurrenceExtras(){let t={};if(this._seasonMonths.length&&(t.season_months=[...this._seasonMonths].sort((e,i)=>e-i)),this._endsMode==="count"){let e=parseInt(this._endsCount,10);e>=1&&(t.ends={count:e})}else this._endsMode==="until"&&this._endsUntil&&(t.ends={until:this._endsUntil});return t}_toggleSeasonMonth(t){this._seasonMonths=this._seasonMonths.includes(t)?this._seasonMonths.filter(e=>e!==t):[...this._seasonMonths,t]}_renderRecurrenceExtras(){let t=this._lang;if(!(this._scheduleType==="time_based"||st.includes(this._scheduleType)))return u;let i=Yt(t);return n`
      ...
      ${this._endsMode==="until"?n`
        ...
        ></ms-textfield>`:u}
    `}_renderCalendarFields(){let t=this._lang,e=Qt(t);if(this._scheduleType==="weekdays")return n`
        ...
        ${this._renderCalOffsetField()}`:u}_renderCalOffsetField(){let t=this._lang;return n`
      <ms-textfield
      ...
      ></ms-textfield>`}_renderTriggerLiveHint(){if(this._triggerType==="compound")return u;let t=this._triggerEntityId||this._triggerEntityIds[0];if(!t||!this.hass?.states)return u;let e=this.hass.states[t];if(!e)return u;let i=this._lang,r=e.attributes?.unit_of_measurement,d=typeof r=="string"&&r?` ${r}`:"",p=this._triggerAttribute?e.attributes?.[this._triggerAttribute]:e.state,_=typeof p=="number"?p:parseFloat(String(p)),h=p!=="unknown"&&p!=="unavailable"&&p!=null&&!isNaN(_),g=b=>Number.isInteger(b)?String(b):String(Math.round(b*10)/10),y=[];if(this._triggerType==="threshold"){let b=parseFloat(this._triggerAbove),$=parseFloat(this._triggerBelow);if(isNaN(b)&&isNaN($))return u;h&&y.push(s("trigger_hint_now",i).replace("{value}",g(_)+d)),isNaN(b)||y.push(s("trigger_hint_above",i).replace("{target}",g(b)+d)),isNaN($)||y.push(s("trigger_hint_below",i).replace("{target}",g($)+d))}else if(this._triggerType==="counter"){let b=parseFloat(this._triggerTargetValue);if(isNaN(b))return u;this._triggerDeltaMode?this._taskId?y.push(s("trigger_hint_counter_delta_edit",i).replace("{target}",g(b)+d)):h?y.push(s("trigger_hint_counter_delta",i).replace("{value}",g(_)+d).replace("{due}",g(_+b)+d).replace("{target}",g(b)+d)):y.push(s("trigger_hint_counter_delta_edit",i).replace("{target}",g(b)+d)):(h&&y.push(s("trigger_hint_now",i).replace("{value}",g(_)+d)),y.push(s("trigger_hint_counter_abs",i).replace("{target}",g(b)+d)))}else if(this._triggerType==="runtime"){let b=parseFloat(this._triggerRuntimeHours);if(isNaN(b))return u;y.push(s("trigger_hint_runtime",i).replace("{hours}",g(b))),y.push(s("trigger_hint_state_now",i).replace("{value}",String(e.state)))}else if(this._triggerType==="state_change"){let b=parseInt(this._triggerTargetChanges,10)||1,$=this._triggerToState.trim();y.push(($?s("trigger_hint_state_change_to",i).replace("{state}",$):s("trigger_hint_state_change",i)).replace("{count}",String(b))),y.push(s("trigger_hint_state_now",i).replace("{value}",String(e.state)))}return y.length?n`<div class="trigger-live-hint">${y.join(" ")}</div>`:u}_renderTriggerTypeFields(){let t=this._lang;return this._triggerType==="threshold"?n`
        <ms-textfield
      ...
      `:u}render(){if(!this._open)return n``;let t=this._lang,e=this._taskId?s("edit_task",t):s("new_task",t);return n`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${e}</div>
        <div class="content">
          ${this._error?n`<div class="error">${this._error}</div>`:u}
          ...
          <div class="select-row">
            ...
            >
              ${jt.map(i=>n`<option value=${i} ?selected=${i===this._type}>${s(i,t)}</option>`)}
            </select>
          </div>
          ${this._type==="reading"?n`
              ...
              `:u}
          ${this._partsLoadFailed?n`<div class="field-help parts-load-failed">${s("parts_load_failed",t)}</div>`:u}
          ...
          <div class="select-row">
            ...
            >
              ${Dt.map(i=>n`<option value=${i} ?selected=${i===this._priority}>${s("priority_"+i,t)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${zt.map(i=>n`<option value=${i} ?selected=${i===this._scheduleType}>${s(i,t)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="sensor_based"?n`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:gt,device_class:vt}}}]}
            ...
            ></ha-form>`}
            ${this._environmentalEntity?this._renderEnvironmentalAttribute(t):u}
          `:u}
          ...
          ${this._requireTagScan?n`<div class="field-help">${s("require_tag_scan_help",t)}</div>`:u}
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?n`<div class="used-parts">
                ...
                ${this.parts.map(e=>{let i=R({part_id:e.id,entry_id:e.entry_id}),r=this._usedParts[i],d=r!==void 0,p=e.entry_id?{part_id:e.id,quantity:1,entry_id:e.entry_id}:{part_id:e.id,quantity:1};return n`<div class="used-part-row">
                    <label class="used-part-check">
                      <input type="checkbox" .checked=${d}
                        @change=${_=>{let h={...this._usedParts};_.target.checked?h[i]=h[i]||p:delete h[i],this._usedParts=h}} />
                      <span
                        >${e.name}${e.owner_name?n`<span class="used-part-owner"> (${e.owner_name})</span>`:u}${e.stock!==null&&e.stock!==void 0?` (${e.stock}${e.unit?" "+e.unit:""})`:""}</span
                      >
                    </label>
                    ${d?n`<input class="used-part-qty" type="number" min="0.01" max="999" step="0.01"
                          .value=${String(r.quantity)}
                          @input=${_=>{let h=parseFloat(_.target.value);this._usedParts={...this._usedParts,[i]:{...p,quantity:Number.isFinite(h)&&h>=.01?h:1}}}} />`:u}
                  </div>`})}
        ...
        <div class="dialog-actions">
          ...
          <ha-button
            ...
            title=${this._missingRequired.length?this._missingRequired.map(e=>s("err_required",t).replace("{field}",s(V[e]??e,t))).join(" \xB7 "):""}
          >
  ...
  `],o([v({attribute:!1})],f.prototype,"hass",2),o([v()],f.prototype,"entryId",2),o([v()],f.prototype,"taskId",2),o([v()],f.prototype,"taskName",2),o([v()],f.prototype,"lang",2),o([v({type:Array})],f.prototype,"checklist",2),o([v({type:Boolean})],f.prototype,"adaptiveEnabled",2),o([v()],f.prototype,"taskType",2),o([v()],f.prototype,"readingUnit",2),o([v({attribute:!1})],f.prototype,"restockDefault",2),o([v({attribute:!1})],f.prototype,"restockUnitCost",2),o([v()],f.prototype,"currencySymbol",2),o([v({attribute:!1})],f.prototype,"parts",2),o([v({attribute:!1})],f.prototype,"consumesParts",2),o([v({type:Array})],f.prototype,"consumesInfo",2),o([v({type:Array})],f.prototype,"requiredFields",2),o([v()],f.prototype,"phaseLabel",2),o([v({type:Boolean})],f.prototype,"requireTagScan",2),o([l()],f.prototype,"_open",2),o([l()],f.prototype,"_notes",2),o([l()],f.prototype,"_cost",2),o([l()],f.prototype,"_duration",2),o([l()],f.prototype,"_loading",2),o([l()],f.prototype,"_error",2),o([l()],f.prototype,"_checklistState",2),o([l()],f.prototype,"_feedback",2),o([l()],f.prototype,"_photoDocId",2),o([l()],f.prototype,"_photoPreview",2),o([l()],f.prototype,"_photoUploading",2),o([l()],f.prototype,"_readingValue",2),o([l()],f.prototype,"_restockQty",2),o([l()],f.prototype,"_completedAt",2),o([l()],f.prototype,"_usedParts",2),o([v({attribute:!1})],f.prototype,"checklistPrefill",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",f);var q=class extends I{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null;this._partOptions=null;this._partQty={};this._partQtyOriginal=""}get _lang(){return S(this.hass)}openEdit(t){this._draft={...t},this._originalSnapshot={...t},this._error="",this._open=!0,this._partOptions=null,this._partQty={},this._partQtyOriginal="",this._loadPartOptions()}async _loadPartOptions(){let t=this._draft;if(t)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"}),i=[];for(let d of e.parts||[]){let p=d.entry_id===t.entry_id,_=d.consumers.some(h=>h.entry_id===t.entry_id&&h.task_id===t.task_id);!p&&!_||i.push({part_id:d.part_id,name:d.name,entry_id:d.entry_id,foreign:!p,object_name:d.object_name})}for(let d of t.used_parts||[]){let p=d.entry_id||t.entry_id;i.some(_=>_.part_id===d.part_id&&_.entry_id===p)||i.push({part_id:d.part_id,name:d.name||d.part_id,entry_id:p,foreign:p!==t.entry_id,object_name:null})}let r={};for(let d of t.used_parts||[])r[`${d.entry_id||t.entry_id}:${d.part_id}`]=d.quantity??1;this._partOptions=i,this._partQty=r,this._partQtyOriginal=this._partSelectionKey()}catch{this._partOptions=[]}}_partSelectionKey(){return JSON.stringify(Object.entries(this._partQty).filter(([,t])=>t>0).sort(([t],[e])=>t.localeCompare(e)))}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null}_set(t,e){this._draft&&(this._draft={...this._draft,[t]:e})}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{let t={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(t.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(t.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(t.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(t.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(t.completed_by=this._draft.completed_by),this._partOptions!==null&&this._partSelectionKey()!==this._partQtyOriginal&&(t.used_parts=(this._partOptions||[]).filter(i=>(this._partQty[`${i.entry_id}:${i.part_id}`]||0)>0).map(i=>({part_id:i.part_id,quantity:this._partQty[`${i.entry_id}:${i.part_id}`],...i.foreign?{entry_id:i.entry_id}:{}}))),Object.keys(t).filter(i=>!["type","entry_id","task_id","original_timestamp"].includes(i)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(t),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=T(t,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return u;let t=this._lang,e=this._draft;return n`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ...
        ${this._partOptions&&this._partOptions.length>0?n`
          <div class="parts-block">
            ...
            ${this._partOptions.map(i=>{let r=`${i.entry_id}:${i.part_id}`,d=this._partQty[r]||0;return n`
                <label class="part-row-edit">
                  <input type="checkbox" .checked=${d>0}
                    @change=${p=>{let _=p.target.checked;this._partQty={...this._partQty,[r]:_?1:0}}} />
                  ...
                  ${d>0?n`
                    <input class="part-qty" type="number" min="0.01" max="999" step="0.01"
                      .value=${String(d)}
                      @input=${p=>{let _=parseFloat(p.target.value);!isNaN(_)&&_>0&&(this._partQty={...this._partQty,[r]:_})}} />
                  `:u}
                </label>
              `})}
          </div>
    ...
    .part-qty { width: 76px; }
  `,o([v({attribute:!1})],q.prototype,"hass",2),o([l()],q.prototype,"_open",2),o([l()],q.prototype,"_saving",2),o([l()],q.prototype,"_error",2),o([l()],q.prototype,"_draft",2),o([l()],q.prototype,"_partOptions",2),o([l()],q.prototype,"_partQty",2);customElements.get("maintenance-history-edit-dialog")||customElements.define("maintenance-history-edit-dialog",q);function bt(a,c,t){let e=new Blob([a],{type:t}),i=URL.createObjectURL(e),r=document.createElement("a");r.href=i,r.download=c,r.target="_blank",r.rel="noopener",r.style.display="none",document.body.appendChild(r),r.dispatchEvent(new MouseEvent("click")),document.body.removeChild(r),setTimeout(()=>URL.revokeObjectURL(i),6e4)}function U(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function yt(a){return!a.startsWith("data:image/svg+xml,")&&!a.startsWith("data:image/png;base64,")?"":U(a)}function Gt(a){return a.replace(/[/\\:*?"<>|#%]+/g,"").replace(/\s+/g,"-").toLowerCase().substring(0,100)}var A=class extends I{constructor(){super(...arguments);this.lang="en";this._open=!1;this._loading=!1;this._error="";this._viewResult=null;this._completeResult=null;this._urlMode="companion";this._entryId="";this._taskId=null;this._objectName="";this._taskName="";this._generateSeq=0}openForObject(t,e){this._entryId=t,this._taskId=null,this._objectName=e,this._taskName="",this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}openForTask(t,e,i,r){this._entryId=t,this._taskId=e,this._objectName=i,this._taskName=r,this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}async _generate(){let t=++this._generateSeq;this._loading=!0,this._error="",this._viewResult=null,this._completeResult=null;try{let e={type:"maintenance_supporter/qr/generate",entry_id:this._entryId,url_mode:this._urlMode};this._taskId&&(e.task_id=this._taskId);let i=[this.hass.connection.sendMessagePromise({...e,action:"view"})];this._taskId&&i.push(this.hass.connection.sendMessagePromise({...e,action:"complete"}));let r=await Promise.all(i);if(t!==this._generateSeq)return;this._viewResult=r[0],r.length>1&&(this._completeResult=r[1])}catch(e){if(t!==this._generateSeq)return;let i=e?.code,r=e?.message;this._error=i==="no_url"||typeof r=="string"&&r.includes("No Home Assistant URL")?s("qr_error_no_url",this.lang):s("qr_error",this.lang)}finally{t===this._generateSeq&&(this._loading=!1)}}_setUrlMode(t){this._urlMode!==t&&(this._urlMode=t,this._generate())}_print(){if(!this._viewResult)return;let t=this._viewResult,e=t.label.task_name?`${t.label.object_name} \u2014 ${t.label.task_name}`:t.label.object_name,i=[t.label.manufacturer,t.label.model].filter(Boolean).join(" "),r=window.open("","_blank","width=600,height=500");if(!r)return;let d=this.lang||"en",p=U(e),_=U(i),h=!!this._completeResult,g=U(s("qr_action_view",d)),y=U(s("qr_action_complete",d));r.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8">
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,o([v({attribute:!1})],A.prototype,"hass",2),o([v()],A.prototype,"lang",2),o([l()],A.prototype,"_open",2),o([l()],A.prototype,"_loading",2),o([l()],A.prototype,"_error",2),o([l()],A.prototype,"_viewResult",2),o([l()],A.prototype,"_completeResult",2),o([l()],A.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",A);function $t(a){let c=a.getFullYear(),t=String(a.getMonth()+1).padStart(2,"0"),e=String(a.getDate()).padStart(2,"0");return`${c}-${t}-${e}`}function Zt(a,c){if(c<=0)return 0;let t=typeof a=="number"&&Number.isFinite(a)?Math.trunc(a):0;return t<0?0:t%c}function Jt(a){return!!(a?.phases&&a.phase_sequence&&a.phase_sequence.length>0)}function nt(a){if(!a||!Jt(a))return null;let c=a.phase_sequence,t=Zt(a.phase_cursor,c.length),e=c[t],i=a.phases?.[e];return i?{id:e,name:i.name,index:t,count:c.length,notes:i.notes,checklist:i.checklist!==void 0?i.checklist:a.checklist??[],consumesParts:i.consumes_parts!==void 0?i.consumes_parts:a.consumes_parts??[],requiredFields:i.required_completion_fields!==void 0?i.required_completion_fields:a.required_completion_fields??[]}:null}function G(a){let c=nt(a);return c?`${c.index+1}/${c.count} \xB7 ${c.name}`:""}function xt(a,c){let t=a.interval_analysis,e=t?.weibull_beta,i=t?.weibull_eta;if(e==null||i==null||i<=0)return u;let r=a.interval_days??0,d=a.suggested_interval??r;return n`
  ...
  `}function te(a,c,t,e,i){let $=Math.max(t,e,c,1)*1.3,C=50,L=[];for(let P=0;P<=C;P++){let H=P/C*$,Nt=1-Math.exp(-Math.pow(H/c,a)),Mt=32+H/$*260,Ft=136-Nt*128;L.push([Mt,Ft])}let B=L.map(([P,H])=>`${P.toFixed(1)},${H.toFixed(1)}`).join(" "),X="M32,136 "+L.map(([P,H])=>`L${P.toFixed(1)},${H.toFixed(1)}`).join(" ")+` L${L[C][0].toFixed(1)},136 Z`,D=32+t/$*260,W=1-Math.exp(-Math.pow(t/c,a)),K=136-W*128,Ht=((1-W)*100).toFixed(0),at=32+e/$*260,Rt=[0,.25,.5,.75,1];return n`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",i)}">
        ...
        ${t>0?z`
          ...
          <circle cx="${D.toFixed(1)}" cy="${K.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(D+4).toFixed(1)}" y="${(K-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
    ...
    <div class="chart-legend">
      ...
      ${t>0?n`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4); opacity:0.5"></span> ${s("current_interval_marker",i)}</span>`:u}
      ${e>0&&e!==t?n`<span class="legend-item"><span class="legend-swatch" style="background:var(--success-color, #4caf50)"></span> ${s("recommended_marker",i)}</span>`:u}
    </div>
  `}function ee(a,c){return n`
    <div class="weibull-info-row">
      <div class="weibull-info-item">
        <span>${s("characteristic_life",c)}</span>
        <span class="weibull-info-value">${Math.round(a.weibull_eta)} ${s("days",c)}</span>
      </div>
  ...
  `}function ie(a,c,t){let e=a.confidence_interval_low,i=a.confidence_interval_high,r=c.suggested_interval??c.interval_days??0,d=c.interval_days??0,p=Math.max(0,e-5),h=i+5-p,g=(e-p)/h*100,y=(i-e)/h*100,b=(r-p)/h*100,$=d>0?(d-p)/h*100:-1;return n`
    <div class="confidence-range">
      <div class="confidence-range-title">
        ${s("confidence_interval",t)}: ${r} ${s("days",t)} (${e}\u2013${i})
      </div>
      <div class="confidence-bar">
        <div class="confidence-fill" style="left:${g.toFixed(1)}%;width:${y.toFixed(1)}%"></div>
        ${$>=0?n`<div class="confidence-marker current" style="left:${$.toFixed(1)}%"></div>`:u}
  ...
  `}function kt(a,c,t){let e=a.degradation_trend!=null&&a.degradation_trend!=="insufficient_data",i=a.days_until_threshold!=null,r=a.environmental_factor!=null&&a.environmental_factor!==1;if(!e&&!i&&!r)return u;let d=a.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":a.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return n`
    <div class="prediction-section">
      ${a.sensor_prediction_urgency?n`
        <div class="prediction-urgency-banner">
          <ha-svg-icon path="M1,21H23L12,2L1,21M12,18A1,1 0 0,1 11,17A1,1 0 0,1 12,16A1,1 0 0,1 13,17A1,1 0 0,1 12,18M13,15H11V10H13V15Z"></ha-svg-icon>
          ${s("sensor_prediction_urgency",c).replace("{days}",String(Math.round(a.days_until_threshold||0)))}
        </div>
      `:u}
      ...
      <div class="prediction-grid">
        ${e?n`
          <div class="prediction-item">
            ...
            <span class="prediction-value ${a.degradation_trend}">${s("trend_"+a.degradation_trend,c)}</span>
            ${a.degradation_rate!=null?n`<span class="prediction-rate">${a.degradation_rate>0?"+":""}${Math.abs(a.degradation_rate)>=10?Math.round(a.degradation_rate).toLocaleString():a.degradation_rate.toFixed(1)} ${a.trigger_entity_info?.unit_of_measurement||""}/${s("day_short",c)}</span>`:u}
          </div>
        `:u}
        ${i?n`
          <div class="prediction-item">
            ...
            <span class="prediction-value prediction-days${a.days_until_threshold===0?" exceeded":a.sensor_prediction_urgency?" urgent":""}">${a.days_until_threshold===0?s("threshold_exceeded",c):"~"+Math.round(a.days_until_threshold)+" "+s("days",c)}</span>
            ${a.threshold_prediction_date?n`<span class="prediction-date">${j(a.threshold_prediction_date,c)}</span>`:u}
            ${a.threshold_prediction_confidence?n`<span class="confidence-dot ${a.threshold_prediction_confidence}"></span>`:u}
            ${(a.prediction_cycles??0)>0?n`<span class="prediction-cycles">${s("prediction_cycles",c)}: ${a.prediction_cycles}</span>`:u}
          </div>
        `:u}
        ${r&&t.environmental?n`
          <div class="prediction-item">
            ...
            ${a.environmental_entity?n`<span class="prediction-entity entity-link" @click=${p=>ht(p,a.environmental_entity)}>${a.environmental_entity}</span>`:u}
          </div>
        `:u}
      </div>
    </div>
  `}function wt(a,c,t,e){let i=Math.max(a||1,c);return n`
  ...
  `}var Et=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function It(a,c,t){if(!t.seasonal||!a.seasonal_factor||a.seasonal_factor===1)return u;let e=Et.map(p=>s(p,c)),i=new Date().getMonth(),r=a.seasonal_factors||a.interval_analysis?.seasonal_factors||null,d=r&&r.length===12?r:e.map((p,_)=>{let h=a.seasonal_factor||1,g=Math.sin((_-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,h+g))});return n`
    <div class="seasonal-card-compact">
      <h4>${s("seasonal_awareness",c)}</h4>
      <div class="seasonal-mini-chart">
        ${d.map((p,_)=>{let h=p*40,g=p<.9?"low":p>1.1?"high":"normal";return n`
            <div class="seasonal-bar ${g} ${_===i?"current":""}"
                 style="height: ${h}px"
                 title="${e[_]}: ${p.toFixed(2)}x">
            </div>
          `})}
      </div>
  ...
  `}function Tt(a,c){return se(a,c)}function se(a,c){let t=a.seasonal_factors??a.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return u;let e=a.interval_analysis?.seasonal_reason,i=new Date().getMonth(),r=300,d=100,p=8,h=d-p-4,g=Math.max(...t,1.5),y=r/12,b=y*.65,$=p+h-1/g*h;return n`
    <div class="seasonal-chart">
      <div class="seasonal-chart-title">
        ...
        ${e?n`<span class="source-tag">${e==="learned"?s("seasonal_learned",c):s("seasonal_manual",c)}</span>`:u}
      </div>
  ...
  `}var k=class extends I{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return S(this.hass)}async openFor(t,e){this._entryId=t,this._taskId=e,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=$t(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let e=(t.tasks||[]).find(i=>i.id===this._taskId);this._task=e??null}catch(t){this._error=T(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(e){return this._error=T(e,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-5KZVN2MO.js").then(async({openCompleteDialog:t})=>{let e=this._task,i=!!e.part_ref,r=nt(e),d=r?r.consumesParts:e.consumes_parts||[],p=[];if(!i)try{let h=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0});p=mt({consumes_parts:d},this._entryId,h.objects||[],this._lang)}catch{}t({entry_id:this._entryId,task_id:this._taskId,task_name:e.name,checklist:r?r.checklist:e.checklist||[],adaptive_enabled:!!e.adaptive_config?.enabled,required_completion_fields:r?r.requiredFields:e.required_completion_fields||[],task_type:e.type||"",reading_unit:e.reading_unit||"",parts:p,consumes_parts:i?[]:d,phase_label:G(e)})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-5KZVN2MO.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-5KZVN2MO.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=s("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=s("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${s("reanalyze_result",this._lang)||"Recomputed"}: ${ct(t.recommended_interval,"days",this._lang)} (${t.data_points} pts)`:s("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=T(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-5KZVN2MO.js").then(({openHistoryEditDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null,used_parts:t.used_parts??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return u;let e=this._lang;return n`
    ...
    `}_renderAdaptive(t){let e=this._lang,i=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,r=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,d=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,p=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!i&&!r&&!d&&!p?n`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${r?kt(t,e,this._features):u}
        ${d?xt(t,e):u}
        ${p?n`
          ${It(t,e,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?Tt(t,e):u}
        `:u}
      </div>
    `}_renderDetails(t){let e=this._lang,i=t.history||[],r=i.filter(_=>_.type==="completed"),d=r.reduce((_,h)=>_+(typeof h.cost=="number"?h.cost:0),0),p=(()=>{let _=r.map(h=>typeof h.duration=="number"?h.duration:null).filter(h=>h!=null);return _.length?Math.round(_.reduce((h,g)=>h+g,0)/_.length):null})();return n`
      <div class="details">
        ...
        ${i.length===0?n`<div class="history-empty">${s("history_empty",e)||"No history yet."}</div>`:n`
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(_=>{let h=["completed","reset","skipped"].includes(_.type);return n`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${_.type}">${s(_.type,e)}</span>
                        <span class="history-date">${dt(_.timestamp,e)}</span>
                      ...
                      ${_.notes?n`<div class="history-notes">${_.notes}</div>`:u}
                      ${_.cost!=null||_.duration!=null?n`<div class="history-meta">
                            ${_.cost!=null?n`<span>💰 ${_.cost.toFixed(2)}</span>`:u}
                            ${_.duration!=null?n`<span>⏱️ ${_.duration}m</span>`:u}
                          </div>`:u}
                    </div>
                  `})}
                ${i.length>20?n`<div class="history-more">… +${i.length-20} ${s("older_entries",e)||"older"}</div>`:u}
              </div>
            `}
      </div>
    `}render(){if(!this._open)return u;let t=this._lang,e=this._task,i=this.hass?.user?.is_admin??!0;return n`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?n`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-5KZVN2MO.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${e.next_due?n`<span><strong>${s("next_due",t)||"Next due"}:</strong> ${j(e.next_due,t)}</span>`:u}
                  ${e.last_performed?n`<span><strong>${s("last_performed",t)||"Last"}:</strong> ${j(e.last_performed,t)}</span>`:u}
                  ${e.schedule?.kind&&!["manual","one_time"].includes(e.schedule.kind)||e.interval_days!=null?n`<span><strong>${s("interval",t)||"Interval"}:</strong> ${pt(e,t)}</span>`:u}
                  ${G(e)?n`<span><strong>${s("phase_current",t)}:</strong> ${G(e)}</span>`:u}
                </div>
              </div>
              ...
              ${this._showSkip?n`
                  ...
                  `:n`
                    ...
                    ${this._showDetails?this._renderDetails(e):u}
                    ${this._showAdaptive?this._renderAdaptive(e):u}
                    <div class="footer">
  ...
  `],o([v({attribute:!1})],k.prototype,"hass",2),o([l()],k.prototype,"_open",2),o([l()],k.prototype,"_entryId",2),o([l()],k.prototype,"_taskId",2),o([l()],k.prototype,"_task",2),o([l()],k.prototype,"_objectName",2),o([l()],k.prototype,"_busy",2),o([l()],k.prototype,"_error",2),o([l()],k.prototype,"_showSkip",2),o([l()],k.prototype,"_showReset",2),o([l()],k.prototype,"_showDetails",2),o([l()],k.prototype,"_showAdaptive",2),o([l()],k.prototype,"_skipReason",2),o([l()],k.prototype,"_resetDate",2),o([l()],k.prototype,"_features",2),o([l()],k.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",k);function St(a){return!!a&&/^https?:\/\//i.test(a)}function At(a){return a?customElements.get("ha-markdown")?n`<ha-markdown class="notes-md" .content=${a} breaks></ha-markdown>`:n`${a}`:u}var N=class extends I{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return S(this.hass)}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=T(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-5KZVN2MO.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-5KZVN2MO.js").then(({openCreateTaskDialog:t})=>{t(this._entryId),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=s("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=T(e,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let e=s("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(e))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=T(e,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-5KZVN2MO.js").then(({openTaskQuickActions:e})=>{e(this._entryId,t)})}render(){if(!this._open)return u;let t=this._lang,e=this._data,i=e?.object,r=e?.tasks||[],d=this.hass?.user?.is_admin??!0;return n`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${e&&i?n`
              <div class="header">
                      ...
                      <div class="task-list">
                        ${r.map(p=>n`
                          <div class="task-row" @click=${()=>this._onTaskClick(p.id)}>
                            <span class="status-dot" style="background: ${Q[p.status]||"#ccc"}"></span>
              ...
              ${i.notes?n`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${At(i.notes)}</div>
                    </div>
                  `:u}
  ...
  `,o([v({attribute:!1})],N.prototype,"hass",2),o([l()],N.prototype,"_open",2),o([l()],N.prototype,"_entryId",2),o([l()],N.prototype,"_data",2),o([l()],N.prototype,"_busy",2),o([l()],N.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",N);var Pt="maintenance-object-dialog",qt="maintenance-task-dialog",re="maintenance-history-edit-dialog",ne="maintenance-complete-dialog",ae="maintenance-qr-dialog",oe="maintenance-task-quick-actions-dialog",le="maintenance-object-quick-actions-dialog";function J(){return document.querySelector("home-assistant")?.hass}function de(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function F(a){let c=de(),t=c.querySelector(a)??document.body.querySelector(a);return t?t.parentNode!==c&&c.appendChild(t):(t=document.createElement(a),c.appendChild(t)),t}function O(a){let c=J();if(!c)return!1;a.hass=c;let t=S(c);return ot(t)||lt(t).then(()=>{a.requestUpdate?.()}),!0}var Lt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},Z=null;function Ct(a){return Z||(Z=a.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(c=>({features:c.features??Lt.features,defaultWarningDays:c.general?.default_warning_days??7})).catch(()=>Lt),Z)}function Xi(){let a=F(Pt);return O(a)?(a.openCreate(),!0):!1}function ts(a,c){let t=F(Pt);return O(t)?(t.openEdit(a,c),!0):!1}function es(a="",c){let t=F(qt);if(!O(t))return!1;let e=J();return e?((async()=>{let i=await Ct(e),r=t;r.checklistsEnabled=i.features.checklists,r.scheduleTimeEnabled=i.features.schedule_time,r.completionActionsEnabled=i.features.completion_actions,r.defaultWarningDays=i.defaultWarningDays,r.openCreate(a,c)})(),!0):!1}function is(a,c){let t=F(qt);if(!O(t))return!1;let e=J();return e?((async()=>{try{let[i,r]=await Promise.all([e.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:a}),Ct(e)]),d=(i.tasks||[]).find(_=>_.id===c);if(!d){console.warn(`openEditTaskDialog: task ${c} not found in entry ${a}`);return}let p=t;p.checklistsEnabled=r.features.checklists,p.scheduleTimeEnabled=r.features.schedule_time,p.completionActionsEnabled=r.features.completion_actions,p.defaultWarningDays=r.defaultWarningDays,await p.openEdit(a,d)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function ss(a){let c=F(re);return O(c)?(c.openEdit(a),!0):!1}function rs(a){let c=F(ne);return O(c)?(c.entryId=a.entry_id,c.taskId=a.task_id,c.taskName=a.task_name,c.checklist=a.checklist??[],c.adaptiveEnabled=!!a.adaptive_enabled,c.requiredFields=a.required_completion_fields??[],c.taskType=a.task_type??"",c.readingUnit=a.reading_unit??"",c.parts=a.parts??[],c.consumesParts=a.consumes_parts??[],c.phaseLabel=a.phase_label??"",c.lang=J()?.language||"en",c.open(),!0):!1}function ns(a){let c=F(ae);return O(c)?(c.openForTask(a.entry_id,a.task_id,a.object_name,a.task_name),!0):!1}function as(a,c){let t=F(oe);return O(t)?(t.openFor(a,c),!0):!1}function os(a){let c=F(le);return O(c)?(c.openFor(a),!0):!1}export{rs as openCompleteDialog,Xi as openCreateObjectDialog,es as openCreateTaskDialog,ts as openEditObjectDialog,is as openEditTaskDialog,ss as openHistoryEditDialog,os as openObjectQuickActions,ns as openQrDialog,as as openTaskQuickActions};
