...
`),partId:H?.part_id||"",partQty:H?.quantity!=null?String(H.quantity):"",reqOverride:g.required_completion_fields!==void 0,reqFields:[...g.required_completion_fields||[]],extraParts:z.filter((F,B)=>B!==U).map(F=>({...F})),carry:P}}),this._phaseSeq=[...i.phase_sequence||[]],this._requiredCompletion=[...i.required_completion_fields||[]],this._scheduleTime=i.schedule_time||"";let c=i.on_complete_action;if(c&&c.service){this._actionService=c.service;let h=c.target?.entity_id;this._actionTargetEntity=Array.isArray(h)?h[0]||"":h||"",this._actionData=c.data&&typeof c.data=="object"?{...c.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let p=i.quick_complete_defaults;this._qcNotes=p?.notes||"",this._qcCost=p?.cost!=null?String(p.cost):"",this._qcDuration=p?.duration!=null?String(p.duration):"",this._qcFeedback=p?.feedback||"";let u=i.adaptive_config||{};if(this._environmentalEntity=u.environmental_entity||"",this._environmentalAttribute=u.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,this._adaptiveEnabled=!!u.enabled,this._adaptiveAlpha=u.ewa_alpha?.toString()??O.alpha,this._adaptiveMin=u.min_interval_days?.toString()??O.min,this._adaptiveMax=u.max_interval_days?.toString()??O.max,this._adaptiveSeasonal=u.seasonal_enabled!==!1,this._adaptivePrediction=u.sensor_prediction_enabled!==!1,this._adaptiveInitial=this._adaptiveSnapshot(),i.trigger_config){let h=i.trigger_config;this._triggerEntityId=h.entity_id||h.entity_ids&&h.entity_ids[0]||"",this._triggerEntityIds=h.entity_ids||(h.entity_id?[h.entity_id]:[]),this._triggerEntityLogic=h.entity_logic||"any",this._triggerAttribute=h.attribute||"",this._triggerType=h.type||"threshold",this._triggerAbove=h.trigger_above?.toString()||"",this._triggerBelow=h.trigger_below?.toString()||"",this._triggerEquals=h.trigger_equals?.toString()||"",this._triggerNotEquals=h.trigger_not_equals?.toString()||"",this._triggerForMinutes=h.trigger_for_minutes?.toString()||"0",this._triggerCombinator=h.trigger_combinator==="all"?"all":"any",this._triggerTargetValue=h.trigger_target_value?.toString()||"",this._triggerDeltaMode=h.trigger_delta_mode||!1,this._triggerBaselineValue=h.trigger_baseline_value?.toString()||"",this._liveBaselineValue=i.trigger_baseline_value??null,this._autoCompleteOnRecovery=h.auto_complete_on_recovery||!1,this._triggerFromState=h.trigger_from_state||"",this._triggerToState=h.trigger_to_state||"",this._triggerTargetChanges=h.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=h.trigger_runtime_hours?.toString()||"",this._triggerOnStates=(h.trigger_on_states||[]).join(", "),h.type==="compound"?(this._compoundLogic=h.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(h.conditions||[]).map(Yt)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._requireTagScan=!1,this._readingUnit="",this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._phaseDefs=[],this._phaseSeq=[],this._requiredCompletion=[],this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._adaptiveEnabled=!1,this._adaptiveAlpha=O.alpha,this._adaptiveMin=O.min,this._adaptiveMax=O.max,this._adaptiveSeasonal=!0,this._adaptivePrediction=!0,this._adaptiveInitial=this._adaptiveSnapshot(),this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerEquals="",this._triggerNotEquals="",this._triggerForMinutes="0",this._triggerCombinator="any",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new Z(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(t){console.error("Failed to load users:",t),this._availableUsers=[]}}_toggleAssignee(t){this._assigneePool=this._assigneePool.includes(t)?this._assigneePool.filter(i=>i!==t):[...this._assigneePool,t]}async _testAction(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[i,e]=t.split(".");if(!this.hass?.services?.[i]?.[e]){this._actionTestResult="error",this._actionTestError=`Service "${t}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let r=this._actionTargetEntity.trim();if(r){let c=r.split(".")[0];if(c!==i&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(i)){this._actionTestResult="error",this._actionTestError=`Service "${t}" only works on ${i}.* entities; entity "${r}" is in ${c}.* \u2014 pick a service that matches the entity domain (e.g. ${c}.${e})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[r]){this._actionTestResult="error",this._actionTestError=`Target entity "${r}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let t=JSON.parse(this._actionDataJsonFallback);if(t&&typeof t=="object"&&!Array.isArray(t))return t}catch{}return{...this._actionData}}_serviceSchema(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t))return null;let[i,e]=t.split("."),r=this.hass?.services?.[i]?.[e]?.fields;return!r||Object.keys(r).length===0?null:Object.entries(r).map(([c,p])=>({name:c,required:!!p.required,selector:p.selector||{text:{}}}))}_renderCompletionActionsSection(t){if(!this.completionActionsEnabled)return _;let i=this._serviceSchema();return a`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${e=>{this._actionService=e.detail.value||"";let r=this._serviceSchema();if(r){let c=new Set(r.map(p=>p.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([p])=>c.has(p)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
              ...
              ${it.map(r=>a`
                <label class="req-option">
                  <input
                    ...
                    @change=${c=>{let p=c.target.checked,u=new Set(e.reqFields);p?u.add(r):u.delete(r),this._patchPhaseDef(e.id,{reqFields:[...u]})}}
                  />
                  <span>${s(Q[r],t)}</span>
                </label>
              `)}
        ...
        <div class="phase-seq">
          ${this._phaseSeq.map((e,r)=>a`
            <span class="phase-chip">
              ${r+1}. ${i(e)}
              <button class="phase-chip-x" @click=${()=>{this._phaseSeq=this._phaseSeq.filter((c,p)=>p!==r)}}>✕</button>
            </span>
          `)}
          <select
            class="phase-seq-add"
...
`).map(u=>u.trim()).filter(Boolean).slice(0,100);t.checklist=p.length?p:null}if(this.completionActionsEnabled){let p=this._actionService.trim();if(p&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(p)){let $={service:p},b=this._actionTargetEntity.trim();b&&($.target={entity_id:b});let y=this._buildActionData();Object.keys(y).length>0&&($.data=y),t.on_complete_action=$}else t.on_complete_action=null;let u={};this._qcNotes.trim()&&(u.notes=this._qcNotes.trim());let h=parseFloat(this._qcCost);!isNaN(h)&&h>=0&&(u.cost=h);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(u.duration=g),this._qcFeedback&&(u.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(u).length?u:null}let e=await this.hass.connection.sendMessagePromise(t),r=this._taskId||e?.task_id,c=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(r&&this._scheduleType==="sensor_based"&&c)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:r,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(r&&this._adaptiveSnapshot()!==this._adaptiveInitial){let p=parseFloat(this._adaptiveAlpha),u=parseInt(this._adaptiveMin,10),h=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:r,enabled:this._adaptiveEnabled,...p>=.1&&p<=.9?{ewa_alpha:p}:{},...!isNaN(u)&&u>=1?{min_interval_days:u}:{},...!isNaN(h)&&h>=1?{max_interval_days:h}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=T(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return _;let t=this._lang,i=this._triggerType==="compound";return a`
    ...
    `}_renderCondition(t,i){let e=this._lang,r=i+1;return a`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${yt.map(c=>a`<option value=${c} ?selected=${c===t.type}>${s(c,e)}</option>`)}
          </select>
        </div>
    ...
    `}_renderEnvironmentalAttribute(t){this._fetchConditionAttributes(this._environmentalEntity);let i=this._conditionAttrOptions[this._environmentalEntity];return this._renderAttributeSelect({label:s("environmental_attribute_optional",t),value:this._environmentalAttribute,suggested:i?.suggested??[],available:i?.available??[],onSelect:e=>this._environmentalAttribute=e})}_renderConditionAttribute(t,i){let e=t.entityIds.split(",")[0]?.trim()||"";e&&this._fetchConditionAttributes(e);let r=e?this._conditionAttrOptions[e]:void 0;return this._renderAttributeSelect({label:s("attribute_optional",this._lang),value:t.attribute,suggested:r?.suggested??[],available:r?.available??[],onSelect:c=>this._patchCondition(i,{attribute:c})})}_renderConditionTypeFields(t,i){let e=this._lang;if(t.type==="threshold")return a`
      ...
      `;if(t.type==="state_change"){let r=t.entityIds.split(",")[0]?.trim()||"";return a`
        ${this._renderStateField({label:s("from_state_optional",e),value:t.fromState,entityId:r,onInput:c=>this._patchCondition(i,{fromState:c})})}
        ${this._renderStateField({label:s("to_state_optional",e),value:t.toState,entityId:r,onInput:c=>this._patchCondition(i,{toState:c})})}
      ...
      `}if(t.type==="runtime"){let r=t.entityIds.split(",")[0]?.trim()||"";return a`
        ...
        ${this._renderOnStatesField({value:t.onStates,entityId:r,onInput:c=>this._patchCondition(i,{onStates:c})})}
    ...
    `}_renderCalendarFields(){let t=this._lang,i=Zt(t);if(this._scheduleType==="weekdays")return a`
        ...
        <div class="select-row">
          ...
          <select .value=${this._nth} @change=${r=>this._nth=r.target.value}>
            ${e.map(([r,c])=>a`<option value=${r} ?selected=${r===this._nth}>${c}</option>`)}
          </select>
        </div>
        <div class="select-row">
          <label>${s("recurrence_weekday",t)}</label>
          <select .value=${this._nthWeekday} @change=${r=>this._nthWeekday=r.target.value}>
            ${i.map((r,c)=>a`<option value=${String(c)} ?selected=${String(c)===this._nthWeekday}>${r}</option>`)}
          </select>
        </div>
      ...
      ></ms-textfield>`}_renderTriggerLiveHint(){if(this._triggerType==="compound")return _;let t=this._triggerEntityId||this._triggerEntityIds[0];if(!t||!this.hass?.states)return _;let i=this.hass.states[t];if(!i)return _;let e=this._lang,r=i.attributes?.unit_of_measurement,c=typeof r=="string"&&r?` ${r}`:"",p=this._triggerAttribute?i.attributes?.[this._triggerAttribute]:i.state,u=typeof p=="number"?p:parseFloat(String(p)),h=p!=="unknown"&&p!=="unavailable"&&p!=null&&!isNaN(u),g=b=>Number.isInteger(b)?String(b):String(Math.round(b*10)/10),$=[];if(this._triggerType==="threshold"){let b=parseFloat(this._triggerAbove),y=parseFloat(this._triggerBelow);if(isNaN(b)&&isNaN(y))return _;h&&$.push(s("trigger_hint_now",e).replace("{value}",g(u)+c)),isNaN(b)||$.push(s("trigger_hint_above",e).replace("{target}",g(b)+c)),isNaN(y)||$.push(s("trigger_hint_below",e).replace("{target}",g(y)+c))}else if(this._triggerType==="counter"){let b=parseFloat(this._triggerTargetValue);if(isNaN(b))return _;this._triggerDeltaMode?this._taskId?$.push(s("trigger_hint_counter_delta_edit",e).replace("{target}",g(b)+c)):h?$.push(s("trigger_hint_counter_delta",e).replace("{value}",g(u)+c).replace("{due}",g(u+b)+c).replace("{target}",g(b)+c)):$.push(s("trigger_hint_counter_delta_edit",e).replace("{target}",g(b)+c)):(h&&$.push(s("trigger_hint_now",e).replace("{value}",g(u)+c)),$.push(s("trigger_hint_counter_abs",e).replace("{target}",g(b)+c)))}else if(this._triggerType==="runtime"){let b=parseFloat(this._triggerRuntimeHours);if(isNaN(b))return _;$.push(s("trigger_hint_runtime",e).replace("{hours}",g(b))),$.push(s("trigger_hint_state_now",e).replace("{value}",String(i.state)))}else if(this._triggerType==="state_change"){let b=parseInt(this._triggerTargetChanges,10)||1,y=this._triggerToState.trim();$.push((y?s("trigger_hint_state_change_to",e).replace("{state}",y):s("trigger_hint_state_change",e)).replace("{count}",String(b))),$.push(s("trigger_hint_state_now",e).replace("{value}",String(i.state)))}return $.length?a`<div class="trigger-live-hint">${$.join(" ")}</div>`:_}_renderTriggerTypeFields(){let t=this._lang;return this._triggerType==="threshold"?a`
        <ms-textfield
        ...
        <div class="content">
          ...
          ${this._scheduleType==="sensor_based"?a`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:ft,device_class:bt}}}]}
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?a`<div class="used-parts">
                ...
                ${this.parts.map(i=>{let e=N({part_id:i.id,entry_id:i.entry_id}),r=this._usedParts[e],c=r!==void 0,p=i.entry_id?{part_id:i.id,quantity:1,entry_id:i.entry_id}:{part_id:i.id,quantity:1};return a`<div class="used-part-row">
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ...
        ${this._partOptions&&this._partOptions.length>0?a`
          <div class="parts-block">
            ...
            ${this._partOptions.map(e=>{let r=`${e.entry_id}:${e.part_id}`,c=this._partQty[r]||0;return a`
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `}function se(n,l,t,i,e){let y=Math.max(t,i,l,1)*1.3,C=50,P=[];for(let L=0;L<=C;L++){let R=L/C*y,Dt=1-Math.exp(-Math.pow(R/l,n)),jt=32+R/y*260,zt=136-Dt*128;P.push([jt,zt])}let z=P.map(([L,R])=>`${L.toFixed(1)},${R.toFixed(1)}`).join(" "),U="M32,136 "+P.map(([L,R])=>`L${L.toFixed(1)},${R.toFixed(1)}`).join(" ")+` L${P[C][0].toFixed(1)},136 Z`,H=32+t/y*260,F=1-Math.exp(-Math.pow(t/l,n)),B=136-F*128,Ft=((1-F)*100).toFixed(0),at=32+i/y*260,Ot=[0,.25,.5,.75,1];return a`
  ...
  `}function ne(n,l,t){let i=n.confidence_interval_low,e=n.confidence_interval_high,r=l.suggested_interval??l.interval_days??0,c=l.interval_days??0,p=Math.max(0,i-5),h=e+5-p,g=(i-p)/h*100,$=(e-i)/h*100,b=(r-p)/h*100,y=c>0?(c-p)/h*100:-1;return a`
    <div class="confidence-range">
      ...
      <div class="confidence-bar">
        ...
        ${y>=0?a`<div class="confidence-marker current" style="left:${y.toFixed(1)}%"></div>`:_}
  ...
  `}function Tt(n,l,t){let i=n.degradation_trend!=null&&n.degradation_trend!=="insufficient_data",e=n.days_until_threshold!=null,r=n.environmental_factor!=null&&n.environmental_factor!==1;if(!i&&!e&&!r)return _;let c=n.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":n.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return a`
      ...
      <div class="prediction-grid">
        ...
        ${r&&t.environmental?a`
          <div class="prediction-item">
            ...
            ${n.environmental_entity?a`<span class="prediction-entity entity-link" @click=${p=>ht(p,n.environmental_entity)}>${n.environmental_entity}</span>`:_}
          </div>
        `:_}
      </div>
    </div>
  `}function St(n,l,t,i){let e=Math.max(n||1,l);return a`
  ...
  `}function Lt(n,l){return ae(n,l)}function ae(n,l){let t=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return _;let i=n.interval_analysis?.seasonal_reason,e=new Date().getMonth(),r=300,c=100,p=8,h=c-p-4,g=Math.max(...t,1.5),$=r/12,b=$*.65,y=p+h-1/g*h;return a`
  ...
  `}var k=class extends I{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return S(this.hass)}async openFor(t,i){this._entryId=t,this._taskId=i,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=kt(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._currencySymbol=t?.budget?.currency_symbol||"",this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let i=(t.tasks||[]).find(e=>e.id===this._taskId);this._task=i??null}catch(t){this._error=T(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(i){return this._error=T(i,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-KRTJC7ON.js").then(async({openCompleteDialog:t})=>{let i=this._task,e=[];try{e=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}t(wt({entryId:this._entryId,taskId:this._taskId,taskName:i.name,task:i,objects:e,lang:this._lang,checklist:i.checklist||[],adaptiveEnabled:!!i.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-KRTJC7ON.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-KRTJC7ON.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=s("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=s("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${s("reanalyze_result",this._lang)||"Recomputed"}: ${ct(t.recommended_interval,"days",this._lang)} (${t.data_points} pts)`:s("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=T(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-KRTJC7ON.js").then(({openHistoryEditDialog:i})=>{i({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null,used_parts:t.used_parts??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return _;let i=this._lang;return a`
    ...
    `}_renderAdaptive(t){let i=this._lang,e=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,r=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,c=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,p=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!e&&!r&&!c&&!p?a`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${r?Tt(t,i,this._features):_}
        ${c?It(t,i):_}
        ${p?a`
          ${Pt(t,i,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?Lt(t,i):_}
        `:_}
      </div>
    `}_renderDetails(t){let i=this._lang,e=t.history||[],r=e.filter(u=>u.type==="completed"),c=r.reduce((u,h)=>u+(typeof h.cost=="number"?h.cost:0),0),p=(()=>{let u=r.map(h=>typeof h.duration=="number"?h.duration:null).filter(h=>h!=null);return u.length?Math.round(u.reduce((h,g)=>h+g,0)/u.length):null})();return a`
      <div class="details">
                ...
                ${[...e].reverse().slice(0,20).map(u=>{let h=["completed","reset","skipped"].includes(u.type);return a`
                    <div class="history-entry">
                      <div class="history-line">
                        ...
                        <span class="history-date">${dt(u.timestamp,i)}</span>
    ...
    `}render(){if(!this._open)return _;let t=this._lang,i=this._task,e=this.hass?.user?.is_admin??!0;return a`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${i?a`
              <div class="header">
                <div class="title">
                  <span class="status-dot" style="background: ${G[i.status]||"#ccc"}"></span>
                  <span class="task-name">${i.name}</span>
                </div>
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-KRTJC7ON.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
  ...
  `],o([v({attribute:!1})],k.prototype,"hass",2),o([d()],k.prototype,"_open",2),o([d()],k.prototype,"_entryId",2),o([d()],k.prototype,"_taskId",2),o([d()],k.prototype,"_task",2),o([d()],k.prototype,"_objectName",2),o([d()],k.prototype,"_busy",2),o([d()],k.prototype,"_error",2),o([d()],k.prototype,"_showSkip",2),o([d()],k.prototype,"_showReset",2),o([d()],k.prototype,"_showDetails",2),o([d()],k.prototype,"_showAdaptive",2),o([d()],k.prototype,"_skipReason",2),o([d()],k.prototype,"_resetDate",2),o([d()],k.prototype,"_features",2),o([d()],k.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",k);function qt(n){return!!n&&/^https?:\/\//i.test(n)}function Ct(n){return n?customElements.get("ha-markdown")?a`<ha-markdown class="notes-md" .content=${n} breaks></ha-markdown>`:a`${n}`:_}var M=class extends I{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return S(this.hass)}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=T(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-KRTJC7ON.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-KRTJC7ON.js").then(({openCreateTaskDialog:t})=>{t(this._entryId),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=s("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(i){this._error=T(i,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let i=s("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(i))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(i){this._error=T(i,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-KRTJC7ON.js").then(({openTaskQuickActions:i})=>{i(this._entryId,t)})}render(){if(!this._open)return _;let t=this._lang,i=this._data,e=i?.object,r=i?.tasks||[],c=this.hass?.user?.is_admin??!0;return a`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${i&&e?a`
              <div class="header">
                      ...
                      <div class="task-list">
                        ${r.map(p=>a`
                          <div class="task-row" @click=${()=>this._onTaskClick(p.id)}>
                            <span class="status-dot" style="background: ${G[p.status]||"#ccc"}"></span>
              ...
              ${e.notes?a`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${Ct(e.notes)}</div>
                    </div>
                  `:_}
      ...
      <div class="meta">
        ${e.map(([r,c])=>a`
            <div class="meta-item">
              ...
              <span class="meta-value">${qt(c)?a`<a href="${c}" target="_blank" rel="noopener noreferrer">${c}</a>`:c}</span>
            </div>
          `)}
      </div>
    `}};M.styles=E`
  ...
  `,o([v({attribute:!1})],M.prototype,"hass",2),o([d()],M.prototype,"_open",2),o([d()],M.prototype,"_entryId",2),o([d()],M.prototype,"_data",2),o([d()],M.prototype,"_busy",2),o([d()],M.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",M);var Rt="maintenance-object-dialog",Nt="maintenance-task-dialog",oe="maintenance-history-edit-dialog",le="maintenance-complete-dialog",de="maintenance-qr-dialog",ce="maintenance-task-quick-actions-dialog",pe="maintenance-object-quick-actions-dialog";function X(){return document.querySelector("home-assistant")?.hass}function he(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function D(n){let l=he(),t=l.querySelector(n)??document.body.querySelector(n);return t?t.parentNode!==l&&l.appendChild(t):(t=document.createElement(n),l.appendChild(t)),t}function j(n){let l=X();if(!l)return!1;n.hass=l;let t=S(l);return ot(t)||lt(t).then(()=>{n.requestUpdate?.()}),!0}var Ht={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},J=null;function Mt(n){return J||(J=n.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(l=>({features:l.features??Ht.features,defaultWarningDays:l.general?.default_warning_days??7})).catch(()=>Ht),J)}function as(){let n=D(Rt);return j(n)?(n.openCreate(),!0):!1}function os(n,l){let t=D(Rt);return j(t)?(t.openEdit(n,l),!0):!1}function ls(n="",l){let t=D(Nt);if(!j(t))return!1;let i=X();return i?((async()=>{let e=await Mt(i),r=t;r.checklistsEnabled=e.features.checklists,r.scheduleTimeEnabled=e.features.schedule_time,r.completionActionsEnabled=e.features.completion_actions,r.defaultWarningDays=e.defaultWarningDays,r.openCreate(n,l)})(),!0):!1}function ds(n,l){let t=D(Nt);if(!j(t))return!1;let i=X();return i?((async()=>{try{let[e,r]=await Promise.all([i.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:n}),Mt(i)]),c=(e.tasks||[]).find(u=>u.id===l);if(!c){console.warn(`openEditTaskDialog: task ${l} not found in entry ${n}`);return}let p=t;p.checklistsEnabled=r.features.checklists,p.scheduleTimeEnabled=r.features.schedule_time,p.completionActionsEnabled=r.features.completion_actions,p.defaultWarningDays=r.defaultWarningDays,await p.openEdit(n,c)}catch(e){console.warn("openEditTaskDialog: failed to load task/features",e)}})(),!0):!1}function cs(n){let l=D(oe);return j(l)?(l.openEdit(n),!0):!1}function ps(n){let l=D(le);return j(l)?(Et(l,n,X()?.language||"en"),!0):!1}function hs(n){let l=D(de);return j(l)?(l.openForTask(n.entry_id,n.task_id,n.object_name,n.task_name),!0):!1}function us(n,l){let t=D(ce);return j(t)?(t.openFor(n,l),!0):!1}function _s(n){let l=D(pe);return j(l)?(l.openFor(n),!0):!1}export{ps as openCompleteDialog,as as openCreateObjectDialog,ls as openCreateTaskDialog,os as openEditObjectDialog,ds as openEditTaskDialog,cs as openHistoryEditDialog,_s as openObjectQuickActions,hs as openQrDialog,us as openTaskQuickActions};
