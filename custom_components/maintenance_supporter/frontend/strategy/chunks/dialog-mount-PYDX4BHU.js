...
`),this._requiredCompletion=[...e.required_completion_fields||[]],this._scheduleTime=e.schedule_time||"";let d=e.on_complete_action;if(d&&d.service){this._actionService=d.service;let u=d.target?.entity_id;this._actionTargetEntity=Array.isArray(u)?u[0]||"":u||"",this._actionData=d.data&&typeof d.data=="object"?{...d.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let c=e.quick_complete_defaults;this._qcNotes=c?.notes||"",this._qcCost=c?.cost!=null?String(c.cost):"",this._qcDuration=c?.duration!=null?String(c.duration):"",this._qcFeedback=c?.feedback||"";let h=e.adaptive_config||{};if(this._environmentalEntity=h.environmental_entity||"",this._environmentalAttribute=h.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,this._adaptiveEnabled=!!h.enabled,this._adaptiveAlpha=h.ewa_alpha?.toString()??M.alpha,this._adaptiveMin=h.min_interval_days?.toString()??M.min,this._adaptiveMax=h.max_interval_days?.toString()??M.max,this._adaptiveSeasonal=h.seasonal_enabled!==!1,this._adaptivePrediction=h.sensor_prediction_enabled!==!1,this._adaptiveInitial=this._adaptiveSnapshot(),e.trigger_config){let u=e.trigger_config;this._triggerEntityId=u.entity_id||u.entity_ids&&u.entity_ids[0]||"",this._triggerEntityIds=u.entity_ids||(u.entity_id?[u.entity_id]:[]),this._triggerEntityLogic=u.entity_logic||"any",this._triggerAttribute=u.attribute||"",this._triggerType=u.type||"threshold",this._triggerAbove=u.trigger_above?.toString()||"",this._triggerBelow=u.trigger_below?.toString()||"",this._triggerEquals=u.trigger_equals?.toString()||"",this._triggerNotEquals=u.trigger_not_equals?.toString()||"",this._triggerForMinutes=u.trigger_for_minutes?.toString()||"0",this._triggerCombinator=u.trigger_combinator==="all"?"all":"any",this._triggerTargetValue=u.trigger_target_value?.toString()||"",this._triggerDeltaMode=u.trigger_delta_mode||!1,this._triggerBaselineValue=u.trigger_baseline_value?.toString()||"",this._liveBaselineValue=e.trigger_baseline_value??null,this._autoCompleteOnRecovery=u.auto_complete_on_recovery||!1,this._triggerFromState=u.trigger_from_state||"",this._triggerToState=u.trigger_to_state||"",this._triggerTargetChanges=u.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=u.trigger_runtime_hours?.toString()||"",this._triggerOnStates=(u.trigger_on_states||[]).join(", "),u.type==="compound"?(this._compoundLogic=u.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(u.conditions||[]).map(Ut)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._readingUnit="",this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._requiredCompletion=[],this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._adaptiveEnabled=!1,this._adaptiveAlpha=M.alpha,this._adaptiveMin=M.min,this._adaptiveMax=M.max,this._adaptiveSeasonal=!0,this._adaptivePrediction=!0,this._adaptiveInitial=this._adaptiveSnapshot(),this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerEquals="",this._triggerNotEquals="",this._triggerForMinutes="0",this._triggerCombinator="any",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new Y(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(t){console.error("Failed to load users:",t),this._availableUsers=[]}}_toggleAssignee(t){this._assigneePool=this._assigneePool.includes(t)?this._assigneePool.filter(e=>e!==t):[...this._assigneePool,t]}async _testAction(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[e,i]=t.split(".");if(!this.hass?.services?.[e]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${t}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let r=this._actionTargetEntity.trim();if(r){let d=r.split(".")[0];if(d!==e&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(e)){this._actionTestResult="error",this._actionTestError=`Service "${t}" only works on ${e}.* entities; entity "${r}" is in ${d}.* \u2014 pick a service that matches the entity domain (e.g. ${d}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[r]){this._actionTestResult="error",this._actionTestError=`Target entity "${r}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let t=JSON.parse(this._actionDataJsonFallback);if(t&&typeof t=="object"&&!Array.isArray(t))return t}catch{}return{...this._actionData}}_serviceSchema(){let t=this._actionService.trim();if(!t||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(t))return null;let[e,i]=t.split("."),r=this.hass?.services?.[e]?.[i]?.fields;return!r||Object.keys(r).length===0?null:Object.entries(r).map(([d,c])=>({name:d,required:!!c.required,selector:c.selector||{text:{}}}))}_renderCompletionActionsSection(t){if(!this.completionActionsEnabled)return _;let e=this._serviceSchema();return a`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${i=>{this._actionService=i.detail.value||"";let r=this._serviceSchema();if(r){let d=new Set(r.map(c=>c.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([c])=>d.has(c)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
      ...
      <div class="consumes-row">
        <label class="consumes-check">
          <input
            type="checkbox"
            .checked=${r!==void 0}
            @change=${c=>{let h={...this._consumesParts};c.target.checked?h[i]=h[i]||d:delete h[i],this._consumesParts=h}}
          />
...
`).map(h=>h.trim()).filter(Boolean).slice(0,100);t.checklist=c.length?c:null}if(this.completionActionsEnabled){let c=this._actionService.trim();if(c&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(c)){let y={service:c},b=this._actionTargetEntity.trim();b&&(y.target={entity_id:b});let $=this._buildActionData();Object.keys($).length>0&&(y.data=$),t.on_complete_action=y}else t.on_complete_action=null;let h={};this._qcNotes.trim()&&(h.notes=this._qcNotes.trim());let u=parseFloat(this._qcCost);!isNaN(u)&&u>=0&&(h.cost=u);let v=parseInt(this._qcDuration,10);!isNaN(v)&&v>=0&&(h.duration=v),this._qcFeedback&&(h.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(h).length?h:null}let i=await this.hass.connection.sendMessagePromise(t),r=this._taskId||i?.task_id,d=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(r&&this._scheduleType==="sensor_based"&&d)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:r,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(r&&this._adaptiveSnapshot()!==this._adaptiveInitial){let c=parseFloat(this._adaptiveAlpha),h=parseInt(this._adaptiveMin,10),u=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:r,enabled:this._adaptiveEnabled,...c>=.1&&c<=.9?{ewa_alpha:c}:{},...!isNaN(h)&&h>=1?{min_interval_days:h}:{},...!isNaN(u)&&u>=1?{max_interval_days:u}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=I(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return _;let t=this._lang,e=this._triggerType==="compound";return a`
      ...
      ${this._intervalDays?a`
          ...
          `:_}
    `}_patchCondition(t,e){this._compoundConditions=this._compoundConditions.map((i,r)=>r===t?{...i,...e}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,zt()]}_removeCondition(t){this._compoundConditions=this._compoundConditions.filter((e,i)=>i!==t)}_renderCompoundEditor(){let t=this._lang;return a`
      <div class="select-row">
    ...
    `}_renderCondition(t,e){let i=this._lang,r=e+1;return a`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${gt.map(d=>a`<option value=${d} ?selected=${d===t.type}>${s(d,i)}</option>`)}
          </select>
        </div>
    ...
    `}_buildSchedule(){let t=i=>{let r=parseInt(this._calOffset,10)||0;return r&&(i.offset=Math.max(-15,Math.min(r,15))),i};if(this._scheduleType==="weekdays")return t({kind:"weekdays",weekdays:[...this._weekdays].sort((i,r)=>i-r)});if(this._scheduleType==="nth_weekday")return t({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let e={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(e.business=!0),t(e)}_recurrenceExtras(){let t={};if(this._seasonMonths.length&&(t.season_months=[...this._seasonMonths].sort((e,i)=>e-i)),this._endsMode==="count"){let e=parseInt(this._endsCount,10);e>=1&&(t.ends={count:e})}else this._endsMode==="until"&&this._endsUntil&&(t.ends={until:this._endsUntil});return t}_toggleSeasonMonth(t){this._seasonMonths=this._seasonMonths.includes(t)?this._seasonMonths.filter(e=>e!==t):[...this._seasonMonths,t]}_renderRecurrenceExtras(){let t=this._lang;if(!(this._scheduleType==="time_based"||et.includes(this._scheduleType)))return _;let i=Wt(t);return a`
      ...
      ${this._endsMode==="until"?a`
        ...
        ></ms-textfield>`:_}
    `}_renderCalendarFields(){let t=this._lang,e=Bt(t);if(this._scheduleType==="weekdays")return a`
      ...
      ></ms-textfield>`}_renderTriggerLiveHint(){if(this._triggerType==="compound")return _;let t=this._triggerEntityId||this._triggerEntityIds[0];if(!t||!this.hass?.states)return _;let e=this.hass.states[t];if(!e)return _;let i=this._lang,r=e.attributes?.unit_of_measurement,d=typeof r=="string"&&r?` ${r}`:"",c=this._triggerAttribute?e.attributes?.[this._triggerAttribute]:e.state,h=typeof c=="number"?c:parseFloat(String(c)),u=c!=="unknown"&&c!=="unavailable"&&c!=null&&!isNaN(h),v=b=>Number.isInteger(b)?String(b):String(Math.round(b*10)/10),y=[];if(this._triggerType==="threshold"){let b=parseFloat(this._triggerAbove),$=parseFloat(this._triggerBelow);if(isNaN(b)&&isNaN($))return _;u&&y.push(s("trigger_hint_now",i).replace("{value}",v(h)+d)),isNaN(b)||y.push(s("trigger_hint_above",i).replace("{target}",v(b)+d)),isNaN($)||y.push(s("trigger_hint_below",i).replace("{target}",v($)+d))}else if(this._triggerType==="counter"){let b=parseFloat(this._triggerTargetValue);if(isNaN(b))return _;this._triggerDeltaMode?this._taskId?y.push(s("trigger_hint_counter_delta_edit",i).replace("{target}",v(b)+d)):u?y.push(s("trigger_hint_counter_delta",i).replace("{value}",v(h)+d).replace("{due}",v(h+b)+d).replace("{target}",v(b)+d)):y.push(s("trigger_hint_counter_delta_edit",i).replace("{target}",v(b)+d)):(u&&y.push(s("trigger_hint_now",i).replace("{value}",v(h)+d)),y.push(s("trigger_hint_counter_abs",i).replace("{target}",v(b)+d)))}else if(this._triggerType==="runtime"){let b=parseFloat(this._triggerRuntimeHours);if(isNaN(b))return _;y.push(s("trigger_hint_runtime",i).replace("{hours}",v(b))),y.push(s("trigger_hint_state_now",i).replace("{value}",String(e.state)))}else if(this._triggerType==="state_change"){let b=parseInt(this._triggerTargetChanges,10)||1,$=this._triggerToState.trim();y.push(($?s("trigger_hint_state_change_to",i).replace("{state}",$):s("trigger_hint_state_change",i)).replace("{count}",String(b))),y.push(s("trigger_hint_state_now",i).replace("{value}",String(e.state)))}return y.length?a`<div class="trigger-live-hint">${y.join(" ")}</div>`:_}_renderTriggerTypeFields(){let t=this._lang;return this._triggerType==="threshold"?a`
        <ms-textfield
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Mt.map(i=>a`<option value=${i} ?selected=${i===this._type}>${s(i,t)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${Ft.map(i=>a`<option value=${i} ?selected=${i===this._priority}>${s("priority_"+i,t)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${Ot.map(i=>a`<option value=${i} ?selected=${i===this._scheduleType}>${s(i,t)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="sensor_based"?a`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:ut,device_class:_t}}}]}
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?a`<div class="used-parts">
                ...
                ${this.parts.map(e=>{let i=H({part_id:e.id,entry_id:e.entry_id}),r=this._usedParts[i],d=r!==void 0,c=e.entry_id?{part_id:e.id,quantity:1,entry_id:e.entry_id}:{part_id:e.id,quantity:1};return a`<div class="used-part-row">
                    <label class="used-part-check">
                      <input type="checkbox" .checked=${d}
                        @change=${h=>{let u={...this._usedParts};h.target.checked?u[i]=u[i]||c:delete u[i],this._usedParts=u}} />
                      <span
                    ...
                    ${d?a`<input class="used-part-qty" type="number" min="0.01" max="999" step="0.01"
                          .value=${String(r.quantity)}
                          @input=${h=>{let u=parseFloat(h.target.value);this._usedParts={...this._usedParts,[i]:{...c,quantity:Number.isFinite(u)&&u>=.01?u:1}}}} />`:_}
                  </div>`})}
            ...
            ${this._partOptions.map(i=>{let r=`${i.entry_id}:${i.part_id}`,d=this._partQty[r]||0;return a`
                <label class="part-row-edit">
                  <input type="checkbox" .checked=${d>0}
                    @change=${c=>{let h=c.target.checked;this._partQty={...this._partQty,[r]:h?1:0}}} />
                  ...
                  ${d>0?a`
                    <input class="part-qty" type="number" min="0.01" max="999" step="0.01"
                      .value=${String(d)}
                      @input=${c=>{let h=parseFloat(c.target.value);!isNaN(h)&&h>0&&(this._partQty={...this._partQty,[r]:h})}} />
                  `:_}
                </label>
              `})}
          </div>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,n([g({attribute:!1})],A.prototype,"hass",2),n([g()],A.prototype,"lang",2),n([l()],A.prototype,"_open",2),n([l()],A.prototype,"_loading",2),n([l()],A.prototype,"_error",2),n([l()],A.prototype,"_viewResult",2),n([l()],A.prototype,"_completeResult",2),n([l()],A.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",A);function yt(o){let p=o.getFullYear(),t=String(o.getMonth()+1).padStart(2,"0"),e=String(o.getDate()).padStart(2,"0");return`${p}-${t}-${e}`}function bt(o,p){let t=o.interval_analysis,e=t?.weibull_beta,i=t?.weibull_eta;if(e==null||i==null||i<=0)return _;let r=o.interval_days??0,d=o.suggested_interval??r;return a`
      ...
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${s("chart_weibull",i)}">
        ...
        ${t>0?D`
          ...
          <text x="${(z+4).toFixed(1)}" y="${(W-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${Ct}%</text>
        `:_}
  ...
  `}function Zt(o,p,t){let e=o.confidence_interval_low,i=o.confidence_interval_high,r=p.suggested_interval??p.interval_days??0,d=p.interval_days??0,c=Math.max(0,e-5),u=i+5-c,v=(e-c)/u*100,y=(i-e)/u*100,b=(r-c)/u*100,$=d>0?(d-c)/u*100:-1;return a`
      ...
      <div class="prediction-grid">
        ${e?a`
          <div class="prediction-item">
            ...
            ${o.degradation_rate!=null?a`<span class="prediction-rate">${o.degradation_rate>0?"+":""}${Math.abs(o.degradation_rate)>=10?Math.round(o.degradation_rate).toLocaleString():o.degradation_rate.toFixed(1)} ${o.trigger_entity_info?.unit_of_measurement||""}/${s("day_short",p)}</span>`:_}
          </div>
        `:_}
        ${i?a`
          <div class="prediction-item">
            ...
            ${o.threshold_prediction_date?a`<span class="prediction-date">${j(o.threshold_prediction_date,p)}</span>`:_}
            ${o.threshold_prediction_confidence?a`<span class="confidence-dot ${o.threshold_prediction_confidence}"></span>`:_}
          </div>
        `:_}
        ${r&&t.environmental?a`
          <div class="prediction-item">
            ...
            ${o.environmental_entity?a`<span class="prediction-entity entity-link" @click=${c=>dt(c,o.environmental_entity)}>${o.environmental_entity}</span>`:_}
          </div>
        `:_}
      </div>
    </div>
  `}function xt(o,p,t,e){let i=Math.max(o||1,p);return a`
  ...
  `}var kt=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"];function wt(o,p,t){if(!t.seasonal||!o.seasonal_factor||o.seasonal_factor===1)return _;let e=kt.map(c=>s(c,p)),i=new Date().getMonth(),r=o.seasonal_factors||o.interval_analysis?.seasonal_factors||null,d=r&&r.length===12?r:e.map((c,h)=>{let u=o.seasonal_factor||1,v=Math.sin((h-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,u+v))});return a`
    <div class="seasonal-card-compact">
      <h4>${s("seasonal_awareness",p)}</h4>
      <div class="seasonal-mini-chart">
        ${d.map((c,h)=>{let u=c*40,v=c<.9?"low":c>1.1?"high":"normal";return a`
            <div class="seasonal-bar ${v} ${h===i?"current":""}"
                 style="height: ${u}px"
                 title="${e[h]}: ${c.toFixed(2)}x">
            </div>
          `})}
      </div>
  ...
  `}function Et(o,p){return Jt(o,p)}function Jt(o,p){let t=o.seasonal_factors??o.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return _;let e=o.interval_analysis?.seasonal_reason,i=new Date().getMonth(),r=300,d=100,c=8,u=d-c-4,v=Math.max(...t,1.5),y=r/12,b=y*.65,$=c+u-1/v*u;return a`
  ...
  `}var k=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return S(this.hass)}async openFor(t,e){this._entryId=t,this._taskId=e,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=yt(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});t?.features&&(this._features={...this._features,...t.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=t.object?.name||"";let e=(t.tasks||[]).find(i=>i.id===this._taskId);this._task=e??null}catch(t){this._error=I(t,this._lang)}}async _runWs(t){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(t),this._busy=!1,!0}catch(e){return this._error=I(e,this._lang),this._busy=!1,!1}}_notifyChanged(t){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:t},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-PYDX4BHU.js").then(async({openCompleteDialog:t})=>{let e=this._task,i=!!e.part_ref,r=[];if(!i)try{let c=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0});r=ht(e,this._entryId,c.objects||[],this._lang)}catch{}t({entry_id:this._entryId,task_id:this._taskId,task_name:e.name,checklist:e.checklist||[],adaptive_enabled:!!e.adaptive_config?.enabled,required_completion_fields:e.required_completion_fields||[],task_type:e.type||"",reading_unit:e.reading_unit||"",parts:r,consumes_parts:i?[]:e.consumes_parts||[]})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||import("./dialog-mount-PYDX4BHU.js").then(({openEditTaskDialog:t})=>{t(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||import("./dialog-mount-PYDX4BHU.js").then(({openQrDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let t=s("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(t))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let t=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",t),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=s("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=t.recommended_interval?`${s("reanalyze_result",this._lang)||"Recomputed"}: ${ot(t.recommended_interval,"days",this._lang)} (${t.data_points} pts)`:s("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(t){this._error=I(t,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(t){!this._entryId||!this._taskId||import("./dialog-mount-PYDX4BHU.js").then(({openHistoryEditDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,original_timestamp:t.timestamp,type:t.type,timestamp:t.timestamp,notes:t.notes??null,cost:t.cost??null,duration:t.duration??null,completed_by:t.completed_by??null,used_parts:t.used_parts??null})})}_renderRecommendation(t){if(!this._features.adaptive||!t.suggested_interval||t.suggested_interval===t.interval_days)return _;let e=this._lang;return a`
    ...
    `}_renderAdaptive(t){let e=this._lang,i=this._features.adaptive&&t.suggested_interval&&t.suggested_interval!==t.interval_days,r=t.degradation_trend!=null&&t.degradation_trend!=="insufficient_data"||t.days_until_threshold!=null||t.environmental_factor!=null&&t.environmental_factor!==1,d=this._features.adaptive&&t.interval_analysis?.weibull_beta!=null&&t.interval_analysis?.weibull_eta!=null,c=this._features.seasonal&&t.seasonal_factor&&t.seasonal_factor!==1;return!i&&!r&&!d&&!c?a`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${r?$t(t,e,this._features):_}
        ${d?bt(t,e):_}
        ${c?a`
          ${wt(t,e,this._features)}
          ${t.seasonal_factors?.length===12||t.interval_analysis?.seasonal_factors?.length===12?Et(t,e):_}
        `:_}
      </div>
    `}_renderDetails(t){let e=this._lang,i=t.history||[],r=i.filter(h=>h.type==="completed"),d=r.reduce((h,u)=>h+(typeof u.cost=="number"?u.cost:0),0),c=(()=>{let h=r.map(u=>typeof u.duration=="number"?u.duration:null).filter(u=>u!=null);return h.length?Math.round(h.reduce((u,v)=>u+v,0)/h.length):null})();return a`
      <div class="details">
                ...
                ${[...i].reverse().slice(0,20).map(h=>{let u=["completed","reset","skipped"].includes(h.type);return a`
                    <div class="history-entry">
                      ...
                      ${h.cost!=null||h.duration!=null?a`<div class="history-meta">
                            ${h.cost!=null?a`<span>💰 ${h.cost.toFixed(2)}</span>`:_}
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${e?a`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-PYDX4BHU.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
  ...
  `],n([g({attribute:!1})],k.prototype,"hass",2),n([l()],k.prototype,"_open",2),n([l()],k.prototype,"_entryId",2),n([l()],k.prototype,"_taskId",2),n([l()],k.prototype,"_task",2),n([l()],k.prototype,"_objectName",2),n([l()],k.prototype,"_busy",2),n([l()],k.prototype,"_error",2),n([l()],k.prototype,"_showSkip",2),n([l()],k.prototype,"_showReset",2),n([l()],k.prototype,"_showDetails",2),n([l()],k.prototype,"_showAdaptive",2),n([l()],k.prototype,"_skipReason",2),n([l()],k.prototype,"_resetDate",2),n([l()],k.prototype,"_features",2),n([l()],k.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",k);function It(o){return!!o&&/^https?:\/\//i.test(o)}var q=class extends E{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return S(this.hass)}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=I(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-PYDX4BHU.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-PYDX4BHU.js").then(({openCreateTaskDialog:t})=>{t(this._entryId),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=s("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=I(e,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let e=s("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(e))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=I(e,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-PYDX4BHU.js").then(({openTaskQuickActions:e})=>{e(this._entryId,t)})}render(){if(!this._open)return _;let t=this._lang,e=this._data,i=e?.object,r=e?.tasks||[],d=this.hass?.user?.is_admin??!0;return a`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${e&&i?a`
              <div class="header">
                      ...
                      <div class="task-list">
                        ${r.map(c=>a`
                          <div class="task-row" @click=${()=>this._onTaskClick(c.id)}>
                            <span class="status-dot" style="background: ${K[c.status]||"#ccc"}"></span>
      ...
      <div class="meta">
        ${i.map(([r,d])=>a`
            <div class="meta-item">
              ...
              <span class="meta-value">${It(d)?a`<a href="${d}" target="_blank" rel="noopener noreferrer">${d}</a>`:d}</span>
            </div>
          `)}
      </div>
    `}};q.styles=w`
  ...
  `,n([g({attribute:!1})],q.prototype,"hass",2),n([l()],q.prototype,"_open",2),n([l()],q.prototype,"_entryId",2),n([l()],q.prototype,"_data",2),n([l()],q.prototype,"_busy",2),n([l()],q.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",q);var St="maintenance-object-dialog",At="maintenance-task-dialog",Xt="maintenance-history-edit-dialog",te="maintenance-complete-dialog",ee="maintenance-qr-dialog",ie="maintenance-task-quick-actions-dialog",se="maintenance-object-quick-actions-dialog";function Z(){return document.querySelector("home-assistant")?.hass}function re(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function F(o){let p=re(),t=p.querySelector(o)??document.body.querySelector(o);return t?t.parentNode!==p&&p.appendChild(t):(t=document.createElement(o),p.appendChild(t)),t}function O(o){let p=Z();if(!p)return!1;o.hass=p;let t=S(p);return rt(t)||nt(t).then(()=>{o.requestUpdate?.()}),!0}var Tt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},Q=null;function Lt(o){return Q||(Q=o.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(p=>({features:p.features??Tt.features,defaultWarningDays:p.general?.default_warning_days??7})).catch(()=>Tt),Q)}function Ui(){let o=F(St);return O(o)?(o.openCreate(),!0):!1}function Vi(o,p){let t=F(St);return O(t)?(t.openEdit(o,p),!0):!1}function Bi(o="",p){let t=F(At);if(!O(t))return!1;let e=Z();return e?((async()=>{let i=await Lt(e),r=t;r.checklistsEnabled=i.features.checklists,r.scheduleTimeEnabled=i.features.schedule_time,r.completionActionsEnabled=i.features.completion_actions,r.defaultWarningDays=i.defaultWarningDays,r.openCreate(o,p)})(),!0):!1}function Wi(o,p){let t=F(At);if(!O(t))return!1;let e=Z();return e?((async()=>{try{let[i,r]=await Promise.all([e.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:o}),Lt(e)]),d=(i.tasks||[]).find(h=>h.id===p);if(!d){console.warn(`openEditTaskDialog: task ${p} not found in entry ${o}`);return}let c=t;c.checklistsEnabled=r.features.checklists,c.scheduleTimeEnabled=r.features.schedule_time,c.completionActionsEnabled=r.features.completion_actions,c.defaultWarningDays=r.defaultWarningDays,await c.openEdit(o,d)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function Ki(o){let p=F(Xt);return O(p)?(p.openEdit(o),!0):!1}function Yi(o){let p=F(te);return O(p)?(p.entryId=o.entry_id,p.taskId=o.task_id,p.taskName=o.task_name,p.checklist=o.checklist??[],p.adaptiveEnabled=!!o.adaptive_enabled,p.requiredFields=o.required_completion_fields??[],p.taskType=o.task_type??"",p.readingUnit=o.reading_unit??"",p.parts=o.parts??[],p.consumesParts=o.consumes_parts??[],p.lang=Z()?.language||"en",p.open(),!0):!1}function Gi(o){let p=F(ee);return O(p)?(p.openForTask(o.entry_id,o.task_id,o.object_name,o.task_name),!0):!1}function Qi(o,p){let t=F(ie);return O(t)?(t.openFor(o,p),!0):!1}function Zi(o){let p=F(se);return O(p)?(p.openFor(o),!0):!1}export{Yi as openCompleteDialog,Ui as openCreateObjectDialog,Bi as openCreateTaskDialog,Vi as openEditObjectDialog,Wi as openEditTaskDialog,Ki as openHistoryEditDialog,Zi as openObjectQuickActions,Gi as openQrDialog,Qi as openTaskQuickActions};
