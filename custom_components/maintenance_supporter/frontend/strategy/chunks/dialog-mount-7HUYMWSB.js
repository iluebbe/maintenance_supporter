...
`).map(h=>h.trim()).filter(Boolean).slice(0,100);t.checklist=p.length?p:null}if(this.completionActionsEnabled){let p=this._actionService.trim();if(p&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(p)){let y={service:p},$=this._actionTargetEntity.trim();$&&(y.target={entity_id:$});let f=this._buildActionData();Object.keys(f).length>0&&(y.data=f),t.on_complete_action=y}else t.on_complete_action=null;let h={};this._qcNotes.trim()&&(h.notes=this._qcNotes.trim());let u=parseFloat(this._qcCost);!isNaN(u)&&u>=0&&(h.cost=u);let v=parseInt(this._qcDuration,10);!isNaN(v)&&v>=0&&(h.duration=v),this._qcFeedback&&(h.feedback=this._qcFeedback),t.quick_complete_defaults=Object.keys(h).length?h:null}let e=await this.hass.connection.sendMessagePromise(t),r=this._taskId||e?.task_id,d=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(r&&this._scheduleType==="sensor_based"&&d)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:r,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(r&&this._adaptiveSnapshot()!==this._adaptiveInitial){let p=parseFloat(this._adaptiveAlpha),h=parseInt(this._adaptiveMin,10),u=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:r,enabled:this._adaptiveEnabled,...p>=.1&&p<=.9?{ewa_alpha:p}:{},...!isNaN(h)&&h>=1?{min_interval_days:h}:{},...!isNaN(u)&&u>=1?{max_interval_days:u}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(t){this._error=P(t,this._lang,s("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return _;let t=this._lang,i=this._triggerType==="compound";return a`
      ...
      <div class="select-row">
        ...
        >
          ${he.map(e=>a`<option value=${e} ?selected=${e===this._triggerType}>${s(e,t)}</option>`)}
        </select>
      </div>
      ...
      ${this._intervalDays?a`
          ...
          `:_}
    `}_patchCondition(t,i){this._compoundConditions=this._compoundConditions.map((e,r)=>r===t?{...e,...i}:e)}_addCondition(){this._compoundConditions=[...this._compoundConditions,ue()]}_removeCondition(t){this._compoundConditions=this._compoundConditions.filter((i,e)=>e!==t)}_renderCompoundEditor(){let t=this._lang;return a`
      <div class="select-row">
    ...
    `}_renderCondition(t,i){let e=this._lang,r=i+1;return a`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${Ot.map(d=>a`<option value=${d} ?selected=${d===t.type}>${s(d,e)}</option>`)}
          </select>
        </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${de.map(e=>a`<option value=${e} ?selected=${e===this._type}>${s(e,t)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${ce.map(e=>a`<option value=${e} ?selected=${e===this._priority}>${s("priority_"+e,t)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${pe.map(e=>a`<option value=${e} ?selected=${e===this._scheduleType}>${s(e,t)}</option>`)}
            </select>
          </div>
...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `,o([g({attribute:!1})],q.prototype,"hass",2),o([g()],q.prototype,"lang",2),o([c()],q.prototype,"_open",2),o([c()],q.prototype,"_loading",2),o([c()],q.prototype,"_error",2),o([c()],q.prototype,"_viewResult",2),o([c()],q.prototype,"_completeResult",2),o([c()],q.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",q);function zt(n){let l=n.getFullYear(),t=String(n.getMonth()+1).padStart(2,"0"),i=String(n.getDate()).padStart(2,"0");return`${l}-${t}-${i}`}function $e(n,l){if(l<=0)return 0;let t=typeof n=="number"&&Number.isFinite(n)?Math.trunc(n):0;return t<0?0:t%l}function xe(n){return!!(n?.phases&&n.phase_sequence&&n.phase_sequence.length>0)}function ut(n){if(!n||!xe(n))return null;let l=n.phase_sequence,t=$e(n.phase_cursor,l.length),i=l[t],e=n.phases?.[i];return e?{id:i,name:e.name,index:t,count:l.length,notes:e.notes,checklist:e.checklist!==void 0?e.checklist:n.checklist??[],consumesParts:e.consumes_parts!==void 0?e.consumes_parts:n.consumes_parts??[],requiredFields:e.required_completion_fields!==void 0?e.required_completion_fields:n.required_completion_fields??[]}:null}function tt(n){let l=ut(n);return l?`${l.index+1}/${l.count} \xB7 ${l.name}`:""}function Ut(n){let l=n.task??null,t=l?ut(l):null,i=t?t.consumesParts:l?.consumes_parts||[],e=!!l?.part_ref,r=n.objects.find(h=>h.entry_id===n.entryId)?.parts||[],d=e?r.find(h=>h.id===l.part_ref.part_id):void 0,p=n.checklistsEnabled??!0;return{entry_id:n.entryId,task_id:n.taskId,task_name:n.taskName,checklist:t?p?t.checklist:[]:n.checklist??[],adaptive_enabled:!!n.adaptiveEnabled,required_completion_fields:t?t.requiredFields:l?.required_completion_fields||[],task_type:l?.type||"",reading_unit:l?.reading_unit||"",readings:l?.readings||[],reading_history:vt(l?.history),parts:e?[]:Ht({consumes_parts:i},n.entryId,n.objects,n.lang),consumes_parts:e?[]:i,phase_label:t?tt(l):"",require_tag_scan:!!l?.require_tag_scan,restock_default:e?d?.restock_quantity??1:null,restock_unit_cost:e?d?.cost??null:null,currency_symbol:n.currencySymbol??"",consumes_info:i.map(h=>Rt(h,n.entryId,n.objects,n.lang)),checklist_prefill:l?.checklist_progress||{},via_tag_scan:!!n.viaTagScan}}function Vt(n,l,t){n.entryId=l.entry_id,n.taskId=l.task_id,n.taskName=l.task_name,n.lang=t,n.checklist=l.checklist??[],n.adaptiveEnabled=!!l.adaptive_enabled,n.requiredFields=l.required_completion_fields??[],n.taskType=l.task_type??"",n.readingUnit=l.reading_unit??"",n.readings=l.readings??[],n.readingHistory=l.reading_history??[],n.parts=l.parts??[],n.consumesParts=l.consumes_parts??[],n.phaseLabel=l.phase_label??"",n.requireTagScan=!!l.require_tag_scan,n.restockDefault=l.restock_default??null,n.restockUnitCost=l.restock_unit_cost??null,n.currencySymbol=l.currency_symbol??"",n.consumesInfo=l.consumes_info??[],n.checklistPrefill=l.checklist_prefill??{},n.viaTagScan=!!l.via_tag_scan,n.open({viaTagScan:!!l.via_tag_scan})}function x(n){return n.toFixed(1)}function Bt(n,l){let t=n.interval_analysis,i=t?.weibull_beta,e=t?.weibull_eta;if(i==null||e==null||e<=0)return _;let r=n.interval_days??0,d=n.suggested_interval??r;return a`
  ...
  `}function Ie(n,l,t){let i=n.confidence_interval_low,e=n.confidence_interval_high,r=l.suggested_interval??l.interval_days??0,d=l.interval_days??0,p=Math.max(0,i-5),u=e+5-p,v=(i-p)/u*100,y=(e-i)/u*100,$=(r-p)/u*100,f=d>0?(d-p)/u*100:-1;return a`
  ...
  `}function Kt(n,l,t,i){let e=Math.max(n||1,l);return a`
  ...
  `}function Qt(n,l){return Se(n,l)}function Se(n,l){let t=n.seasonal_factors??n.interval_analysis?.seasonal_factors;if(!t||t.length!==12)return _;let i=n.interval_analysis?.seasonal_reason,e=new Date().getMonth(),r=300,d=100,p=8,u=d-p-4,v=Math.max(...t,1.5),y=r/12,$=y*.65,f=p+u-1/v*u;return a`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${i?a`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&import("./dialog-mount-7HUYMWSB.js").then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
  ...
  `],o([g({attribute:!1})],w.prototype,"hass",2),o([c()],w.prototype,"_open",2),o([c()],w.prototype,"_entryId",2),o([c()],w.prototype,"_taskId",2),o([c()],w.prototype,"_task",2),o([c()],w.prototype,"_objectName",2),o([c()],w.prototype,"_busy",2),o([c()],w.prototype,"_error",2),o([c()],w.prototype,"_showSkip",2),o([c()],w.prototype,"_showReset",2),o([c()],w.prototype,"_showDetails",2),o([c()],w.prototype,"_showAdaptive",2),o([c()],w.prototype,"_skipReason",2),o([c()],w.prototype,"_resetDate",2),o([c()],w.prototype,"_features",2),o([c()],w.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",w);function Jt(n){return!!n&&/^https?:\/\//i.test(n)}function Zt(n){return n?customElements.get("ha-markdown")?a`<ha-markdown class="notes-md" .content=${n} breaks></ha-markdown>`:a`${n}`:_}var j=class extends S{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return C(this.hass)}async openFor(t){this._entryId=t,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=t}catch(t){this._error=P(t,this._lang)}}_onEditObject(){!this._entryId||!this._data||import("./dialog-mount-7HUYMWSB.js").then(({openEditObjectDialog:t})=>{t(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&import("./dialog-mount-7HUYMWSB.js").then(({openCreateTaskDialog:t})=>{t(this._entryId),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let t=s("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(t)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(i){this._error=P(i,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let t=!!this._data.object.archived;if(!t){let i=s("confirm_archive_object",this._lang)||"Archive this object and its tasks?";if(!window.confirm(i))return}this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:t?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(i){this._error=P(i,this._lang)}finally{this._busy=!1}}_onTaskClick(t){this._entryId&&import("./dialog-mount-7HUYMWSB.js").then(({openTaskQuickActions:i})=>{i(this._entryId,t)})}render(){if(!this._open)return _;let t=this._lang,i=this._data,e=i?.object,r=i?.tasks||[],d=this.hass?.user?.is_admin??!0;return a`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${i&&e?a`
              <div class="header">
      ...
      <div class="meta">
        ${e.map(([r,d])=>a`
            <div class="meta-item">
              ...
              <span class="meta-value">${Jt(d)?a`<a href="${d}" target="_blank" rel="noopener noreferrer">${d}</a>`:d}</span>
            </div>
          `)}
      </div>
    `}};j.styles=I`
