...
`});function Qa(i,a){let e=Ka[i];if(!e)return i;let t=o(e,a);return t&&t!==e?t:i}function Za(i){let e=i.match(/data\['([^']+)'\]/)?.[1],t;return(t=i.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=i.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=i.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=i.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(i)?{field:e,rule:"required"}:(t=i.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(i)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(i)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function y(i,a,e){if(typeof i=="string")return i;if(typeof i!="object"||i===null)return e;let t=i,n=t.message||t.error?.message||"";if(!n)return e;let r=Za(n),l=r.field?Qa(r.field,a):"",s=u=>o(u,a).replace("{field}",l).replace("{n}",r.param??"");switch(r.rule){case"too_long":return s("err_too_long");case"too_short":return s("err_too_short");case"value_too_high":return s("err_value_too_high");case"value_too_low":return s("err_value_too_low");case"required":return s("err_required");case"wrong_type":return s("err_wrong_type").replace("{type}",r.param??"");case"invalid_choice":return s("err_invalid_choice");case"invalid_value":return s("err_invalid_value");default:return n||e}}var Ka,P=b(()=>{"use strict";S();Ka={name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_for_minutes:"trigger_for_minutes"}});var A,Dt=b(()=>{"use strict";j();M();S();P();A=class extends k{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._error="";this._name="";this._manufacturer="";this._model="";this._serialNumber="";this._areaId="";this._installationDate="";this._documentationUrl="";this._notes="";this._entryId=null}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}openCreate(){this._entryId=null,this._name="",this._manufacturer="",this._model="",this._serialNumber="",this._areaId="",this._installationDate="",this._documentationUrl="",this._notes="",this._error="",this._open=!0}openEdit(e,t){this._entryId=e,this._name=t.name||"",this._manufacturer=t.manufacturer||"",this._model=t.model||"",this._serialNumber=t.serial_number||"",this._areaId=t.area_id||"",this._installationDate=t.installation_date||"",this._documentationUrl=t.documentation_url||"",this._notes=t.notes||"",this._error="",this._open=!0}async _save(){if(this._name.trim()){this._loading=!0,this._error="";try{this._entryId?await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/update",entry_id:this._entryId,name:this._name,manufacturer:this._manufacturer||null,model:this._model||null,serial_number:this._serialNumber||null,area_id:this._areaId||null,installation_date:this._installationDate||null,documentation_url:this._documentationUrl.trim()||null,notes:this._notes.trim()||null}):await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/create",name:this._name,manufacturer:this._manufacturer||null,model:this._model||null,serial_number:this._serialNumber||null,area_id:this._areaId||null,installation_date:this._installationDate||null,documentation_url:this._documentationUrl.trim()||null,notes:this._notes.trim()||null}),this._open=!1,this.dispatchEvent(new CustomEvent("object-saved"))}catch(e){this._error=y(e,this._lang,o("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}render(){if(!this._open)return c``;let e=this._lang,t=this._entryId?o("edit_object",e):o("new_object",e);return c`
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ></ha-textfield>
          <ha-textarea
            label="${o("object_notes_optional",e)}"
            autogrow
            rows="3"
            .value=${this._notes}
...
`),this._scheduleTime=t.schedule_time||"";let n=t.on_complete_action;if(n&&n.service){this._actionService=n.service;let s=n.target?.entity_id;this._actionTargetEntity=Array.isArray(s)?s[0]||"":s||"",this._actionData=n.data&&typeof n.data=="object"?{...n.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let r=t.quick_complete_defaults;this._qcNotes=r?.notes||"",this._qcCost=r?.cost!=null?String(r.cost):"",this._qcDuration=r?.duration!=null?String(r.duration):"",this._qcFeedback=r?.feedback||"";let l=t.adaptive_config||{};if(this._environmentalEntity=l.environmental_entity||"",this._environmentalAttribute=l.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,t.trigger_config){let s=t.trigger_config;this._triggerEntityId=s.entity_id||"",this._triggerEntityIds=s.entity_ids||(s.entity_id?[s.entity_id]:[]),this._triggerEntityLogic=s.entity_logic||"any",this._triggerAttribute=s.attribute||"",this._triggerType=s.type||"threshold",this._triggerAbove=s.trigger_above?.toString()||"",this._triggerBelow=s.trigger_below?.toString()||"",this._triggerForMinutes=s.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=s.trigger_target_value?.toString()||"",this._triggerDeltaMode=s.trigger_delta_mode||!1,this._triggerFromState=s.trigger_from_state||"",this._triggerToState=s.trigger_to_state||"",this._triggerTargetChanges=s.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=s.trigger_runtime_hours?.toString()||""}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._warningDays=String(this.defaultWarningDays),this._intervalAnchor="completion",this._notes="",this._documentationUrl="",this._customIcon="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._responsibleUserId=null,this._checklistText="",this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours=""}async _loadUsers(){this._userService||(this._userService=new je(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error";return}let[t,n]=e.split("."),r={...this._buildActionData()},l=this._actionTargetEntity.trim();l&&(r.entity_id=l),this._actionTesting=!0,this._actionTestResult="";try{await this.hass.callService(t,n,r),this._actionTestResult="ok"}catch{this._actionTestResult="error"}finally{this._actionTesting=!1,setTimeout(()=>{this._actionTestResult=""},3e3)}}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,n]=e.split("."),r=this.hass?.services?.[t]?.[n]?.fields;return!r||Object.keys(r).length===0?null:Object.entries(r).map(([l,s])=>({name:l,required:!!s.required,selector:s.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return p;let t=this._serviceSchema();return c`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${n=>{this._actionService=n.detail.value||"";let r=this._serviceSchema();if(r){let l=new Set(r.map(s=>s.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([s])=>l.has(s)))}}}
        ></ha-service-picker>
        <ha-entity-picker
          .hass=${this.hass}
          .value=${this._actionTargetEntity}
          .label=${o("on_complete_action_target",e)}
          @value-changed=${n=>{this._actionTargetEntity=n.detail.value||""}}
        ></ha-entity-picker>
        ${t?c`
              <ha-form
                class="ca-data-form"
        ...
        <div class="ca-test-row">
          ...
          ${this._actionTestResult==="ok"?c`<span class="ca-test-ok">${o("on_complete_action_test_success",e)}</span>`:p}
          ${this._actionTestResult==="error"?c`<span class="ca-test-error">${o("on_complete_action_test_failed",e)}</span>`:p}
        </div>
      </details>
...
`).map(s=>s.trim()).filter(Boolean).slice(0,100);e.checklist=l.length?l:null}if(this.completionActionsEnabled){let l=this._actionService.trim();if(l&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(l)){let v={service:l},h=this._actionTargetEntity.trim();h&&(v.target={entity_id:h});let x=this._buildActionData();Object.keys(x).length>0&&(v.data=x),e.on_complete_action=v}else e.on_complete_action=null;let s={};this._qcNotes.trim()&&(s.notes=this._qcNotes.trim());let u=parseFloat(this._qcCost);!isNaN(u)&&u>=0&&(s.cost=u);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(s.duration=g),this._qcFeedback&&(s.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(s).length?s:null}let t=await this.hass.connection.sendMessagePromise(e),n=this._taskId||t?.task_id,r=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(n&&this._scheduleType==="sensor_based"&&r)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=y(e,this._lang,o("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return p;let e=this._lang;return c`
      ...
      <ha-textfield
        ...
        @input=${t=>{let r=t.target.value.split(",").map(l=>l.trim()).filter(Boolean);this._triggerEntityId=r[0]||"",this._triggerEntityIds=r,r[0]&&this._fetchEntityAttributes(r[0])}}
      ></ha-textfield>
      ${this._triggerEntityIds.length>1?c`
      ...
      `:p}
      ${this._availableAttributes.length>0?c`
          <div class="select-row">
            ...
            >
              ...
              ${this._suggestedAttributes.map(t=>c`<option value=${t} ?selected=${t===this._triggerAttribute}>${t} ★</option>`)}
              ${this._availableAttributes.filter(t=>!this._suggestedAttributes.includes(t.name)).map(t=>c`<option value=${t.name} ?selected=${t.name===this._triggerAttribute}>${t.name}${t.numeric?"":" (non-numeric)"}</option>`)}
            </select>
          </div>
        `:c`
          <ha-textfield
      ...
      <div class="select-row">
        ...
        >
          ${Xa.map(t=>c`<option value=${t} ?selected=${t===this._triggerType}>${o(t,e)}</option>`)}
        </select>
      </div>
      ...
      ></ha-textfield>
    `}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?c`
        <ha-textfield
      ...
      `:this._triggerType==="state_change"?c`
        <ha-textfield
      ...
      `:this._triggerType==="runtime"?c`
        ...
        ></ha-textfield>
      `:p}render(){if(!this._open)return c``;let e=this._lang,t=this._taskId?o("edit_task",e):o("new_task",e);return c`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._error?c`<div class="error">${this._error}</div>`:p}
          ${this._objectChoices.length>0?c`
            <div class="select-row">
              ...
              >
                ${this._objectChoices.map(n=>c`<option value=${n.entry_id} ?selected=${n.entry_id===this._entryId}>${n.name}</option>`)}
              </select>
            </div>
          `:p}
          <ha-textfield
          ...
          <div class="select-row">
            ...
            >
              ${Ja.map(n=>c`<option value=${n} ?selected=${n===this._type}>${o(n,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${Ya.map(n=>c`<option value=${n} ?selected=${n===this._scheduleType}>${o(n,e)}</option>`)}
            </select>
          </div>
          ${this._scheduleType==="time_based"?c`
                <ha-textfield
          ...
          <div class="select-row">
            ...
            >
              ...
              ${this._availableUsers.map(n=>c`<option value=${n.id} ?selected=${n.id===this._responsibleUserId}>${n.name}</option>`)}
            </select>
          </div>
          ${this._renderTriggerFields()}
          ${this._scheduleType==="sensor_based"?c`
            <ha-textfield
          ...
          ></ha-icon-picker>
          ${this._availableTags.length>0?c`
              <div class="select-row">
                ...
                >
                  ...
                  ${this._availableTags.map(n=>c`<option value=${n.id} ?selected=${n.id===this._nfcTagId}>${n.name}</option>`)}
                </select>
  ...
  `,d([f({attribute:!1})],m.prototype,"hass",2),d([f({type:Boolean,attribute:"checklists-enabled"})],m.prototype,"checklistsEnabled",2),d([f({type:Boolean,attribute:"schedule-time-enabled"})],m.prototype,"scheduleTimeEnabled",2),d([f({type:Boolean,attribute:"completion-actions-enabled"})],m.prototype,"completionActionsEnabled",2),d([f({type:Number,attribute:"default-warning-days"})],m.prototype,"defaultWarningDays",2),d([_()],m.prototype,"_open",2),d([_()],m.prototype,"_loading",2),d([_()],m.prototype,"_error",2),d([_()],m.prototype,"_entryId",2),d([_()],m.prototype,"_taskId",2),d([_()],m.prototype,"_objectChoices",2),d([_()],m.prototype,"_name",2),d([_()],m.prototype,"_type",2),d([_()],m.prototype,"_scheduleType",2),d([_()],m.prototype,"_intervalDays",2),d([_()],m.prototype,"_warningDays",2),d([_()],m.prototype,"_intervalAnchor",2),d([_()],m.prototype,"_notes",2),d([_()],m.prototype,"_documentationUrl",2),d([_()],m.prototype,"_customIcon",2),d([_()],m.prototype,"_enabled",2),d([_()],m.prototype,"_triggerEntityId",2),d([_()],m.prototype,"_triggerEntityIds",2),d([_()],m.prototype,"_triggerEntityLogic",2),d([_()],m.prototype,"_triggerAttribute",2),d([_()],m.prototype,"_triggerType",2),d([_()],m.prototype,"_triggerAbove",2),d([_()],m.prototype,"_triggerBelow",2),d([_()],m.prototype,"_triggerForMinutes",2),d([_()],m.prototype,"_triggerTargetValue",2),d([_()],m.prototype,"_triggerDeltaMode",2),d([_()],m.prototype,"_triggerFromState",2),d([_()],m.prototype,"_triggerToState",2),d([_()],m.prototype,"_triggerTargetChanges",2),d([_()],m.prototype,"_triggerRuntimeHours",2),d([_()],m.prototype,"_suggestedAttributes",2),d([_()],m.prototype,"_availableAttributes",2),d([_()],m.prototype,"_entityDomain",2),d([_()],m.prototype,"_lastPerformed",2),d([_()],m.prototype,"_nfcTagId",2),d([_()],m.prototype,"_availableTags",2),d([_()],m.prototype,"_responsibleUserId",2),d([_()],m.prototype,"_availableUsers",2),d([_()],m.prototype,"_checklistText",2),d([_()],m.prototype,"_scheduleTime",2),d([_()],m.prototype,"_actionService",2),d([_()],m.prototype,"_actionTargetEntity",2),d([_()],m.prototype,"_actionData",2),d([_()],m.prototype,"_actionDataJsonFallback",2),d([_()],m.prototype,"_actionTesting",2),d([_()],m.prototype,"_actionTestResult",2),d([_()],m.prototype,"_qcNotes",2),d([_()],m.prototype,"_qcCost",2),d([_()],m.prototype,"_qcDuration",2),d([_()],m.prototype,"_qcFeedback",2),d([_()],m.prototype,"_environmentalEntity",2),d([_()],m.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",m)});var E,Ft=b(()=>{"use strict";j();M();S();P();E=class extends k{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed"}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed")}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=y(e,this.lang,o("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return c``;let e=this.lang||this.hass?.language||"en";return c`
      <ha-dialog open @closed=${this._close}>
  ...
  `,d([f({attribute:!1})],E.prototype,"hass",2),d([f()],E.prototype,"entryId",2),d([f()],E.prototype,"taskId",2),d([f()],E.prototype,"taskName",2),d([f()],E.prototype,"lang",2),d([f({type:Array})],E.prototype,"checklist",2),d([f({type:Boolean})],E.prototype,"adaptiveEnabled",2),d([_()],E.prototype,"_open",2),d([_()],E.prototype,"_notes",2),d([_()],E.prototype,"_cost",2),d([_()],E.prototype,"_duration",2),d([_()],E.prototype,"_loading",2),d([_()],E.prototype,"_error",2),d([_()],E.prototype,"_checklistState",2),d([_()],E.prototype,"_feedback",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",E)});var U,Ht=b(()=>{"use strict";j();M();S();P();U=class extends k{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null}get _lang(){return this.hass?.language||"en"}openEdit(e){this._draft={...e},this._originalSnapshot={...e},this._error="",this._open=!0}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null}_set(e,t){this._draft&&(this._draft={...this._draft,[e]:t})}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{let e={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(e.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(e.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(e.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(e.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(e.completed_by=this._draft.completed_by),Object.keys(e).filter(n=>!["type","entry_id","task_id","original_timestamp"].includes(n)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(e),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=y(e,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return p;let e=this._lang,t=this._draft;return c`
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),r.document.close()}_downloadSvg(e,t){let n=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),r=new Blob([n],{type:"image/svg+xml"}),l=URL.createObjectURL(r),s=document.createElement("a");s.href=l;let u=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;s.download=`qr-${en(u)}-${t}.svg`,s.click(),URL.revokeObjectURL(l)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return c``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${o("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${o("qr_code",e)}: ${this._objectName}`,n=!!this._viewResult;return c`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._loading?c`<div class="loading">${o("qr_generating",e)}</div>`:this._error?c`<div class="error">${this._error}</div>`:n?c`
                    <div class="qr-pair">
                      <div class="qr-item">
                        <img
  ...
  `,d([f({attribute:!1})],I.prototype,"hass",2),d([f()],I.prototype,"lang",2),d([_()],I.prototype,"_open",2),d([_()],I.prototype,"_loading",2),d([_()],I.prototype,"_error",2),d([_()],I.prototype,"_viewResult",2),d([_()],I.prototype,"_completeResult",2),d([_()],I.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",I)});function Vt(i,a){let e=i.interval_analysis,t=e?.weibull_beta,n=e?.weibull_eta;if(t==null||n==null||n<=0)return p;let r=i.interval_days??0,l=i.suggested_interval??r;return c`
  ...
  `}function an(i,a,e,t,n){let z=Math.max(e,t,a,1)*1.3,q=50,H=[];for(let R=0;R<=q;R++){let D=R/q*z,ha=1-Math.exp(-Math.pow(D/a,i)),va=32+D/z*260,fa=136-ha*128;H.push([va,fa])}let ve=H.map(([R,D])=>`${R.toFixed(1)},${D.toFixed(1)}`).join(" "),qe="M32,136 "+H.map(([R,D])=>`L${R.toFixed(1)},${D.toFixed(1)}`).join(" ")+` L${H[q][0].toFixed(1)},136 Z`,X=32+e/z*260,fe=1-Math.exp(-Math.pow(e/a,i)),be=136-fe*128,ga=((1-fe)*100).toFixed(0),nt=32+t/z*260,ma=[0,.25,.5,.75,1];return c`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${o("chart_weibull",n)}">
        ...
        <polyline points="${ve}" fill="none"
          stroke="var(--primary-color, #03a9f4)" stroke-width="2" />

        ${e>0?ae`
          <line x1="${X.toFixed(1)}" y1="${8}" x2="${X.toFixed(1)}" y2="${136 .toFixed(1)}"
            stroke="var(--primary-color, #03a9f4)" stroke-width="1.5" stroke-dasharray="4,3" />
          <circle cx="${X.toFixed(1)}" cy="${be.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(X+4).toFixed(1)}" y="${(be-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${ga}%</text>
        `:p}
    ...
    <div class="chart-legend">
      ...
      ${e>0?c`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4); opacity:0.5"></span> ${o("current_interval_marker",n)}</span>`:p}
      ${t>0&&t!==e?c`<span class="legend-item"><span class="legend-swatch" style="background:var(--success-color, #4caf50)"></span> ${o("recommended_marker",n)}</span>`:p}
    </div>
  `}function nn(i,a){return c`
    <div class="weibull-info-row">
      <div class="weibull-info-item">
        <span>${o("characteristic_life",a)}</span>
        <span class="weibull-info-value">${Math.round(i.weibull_eta)} ${o("days",a)}</span>
      </div>
      ${i.weibull_r_squared!=null?c`
        <div class="weibull-info-item">
  ...
  `}function on(i,a,e){let t=i.confidence_interval_low,n=i.confidence_interval_high,r=a.suggested_interval??a.interval_days??0,l=a.interval_days??0,s=Math.max(0,t-5),g=n+5-s,v=(t-s)/g*100,h=(n-t)/g*100,x=(r-s)/g*100,z=l>0?(l-s)/g*100:-1;return c`
    <div class="confidence-range">
      <div class="confidence-range-title">
        ${o("confidence_interval",e)}: ${r} ${o("days",e)} (${t}\u2013${n})
      </div>
      <div class="confidence-bar">
        <div class="confidence-fill" style="left:${v.toFixed(1)}%;width:${h.toFixed(1)}%"></div>
        ${z>=0?c`<div class="confidence-marker current" style="left:${z.toFixed(1)}%"></div>`:p}
  ...
  `}var Bt=b(()=>{"use strict";j();S()});function Wt(i,a,e){let t=i.degradation_trend!=null&&i.degradation_trend!=="insufficient_data",n=i.days_until_threshold!=null,r=i.environmental_factor!=null&&i.environmental_factor!==1;if(!t&&!n&&!r)return p;let l=i.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":i.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return c`
    <div class="prediction-section">
      ${i.sensor_prediction_urgency?c`
      ...
      <div class="prediction-grid">
        ${t?c`
          <div class="prediction-item">
            ...
            ${i.degradation_rate!=null?c`<span class="prediction-rate">${i.degradation_rate>0?"+":""}${Math.abs(i.degradation_rate)>=10?Math.round(i.degradation_rate).toLocaleString():i.degradation_rate.toFixed(1)} ${i.trigger_entity_info?.unit_of_measurement||""}/${o("day_short",a)}</span>`:p}
          </div>
        `:p}
        ${n?c`
          <div class="prediction-item">
            ...
            ${i.threshold_prediction_date?c`<span class="prediction-date">${ge(i.threshold_prediction_date,a)}</span>`:p}
            ${i.threshold_prediction_confidence?c`<span class="confidence-dot ${i.threshold_prediction_confidence}"></span>`:p}
          </div>
        `:p}
        ${r&&e.environmental?c`
          <div class="prediction-item">
            ...
            ${i.environmental_entity?c`<span class="prediction-entity entity-link" @click=${s=>Rt(s,i.environmental_entity)}>${i.environmental_entity}</span>`:p}
          </div>
        `:p}
      </div>
    </div>
  `}var Gt=b(()=>{"use strict";j();S()});function Kt(i,a,e,t){let n=Math.max(i||1,a);return c`
  ...
  `}var Qt=b(()=>{"use strict";j();S()});function Jt(i,a,e){if(!e.seasonal||!i.seasonal_factor||i.seasonal_factor===1)return p;let t=Zt.map(s=>o(s,a)),n=new Date().getMonth(),r=i.seasonal_factors||i.interval_analysis?.seasonal_factors||null,l=r&&r.length===12?r:t.map((s,u)=>{let g=i.seasonal_factor||1,v=Math.sin((u-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,g+v))});return c`
    <div class="seasonal-card-compact">
      <h4>${o("seasonal_awareness",a)}</h4>
      <div class="seasonal-mini-chart">
        ${l.map((s,u)=>{let g=s*40,v=s<.9?"low":s>1.1?"high":"normal";return c`
  ...
  `}function Yt(i,a){return rn(i,a)}function rn(i,a){let e=i.seasonal_factors??i.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return p;let t=i.interval_analysis?.seasonal_reason,n=new Date().getMonth(),r=300,l=100,s=8,g=l-s-4,v=Math.max(...e,1.5),h=r/12,x=h*.65,z=s+g-1/v*g;return c`
    <div class="seasonal-chart">
      <div class="seasonal-chart-title">
        ...
        ${t?c`<span class="source-tag">${t==="learned"?o("seasonal_learned",a):o("seasonal_manual",a)}</span>`:p}
      </div>
      <svg viewBox="0 0 ${r} ${l}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${o("chart_seasonal",a)}">
        <line x1="0" y1="${z.toFixed(1)}" x2="${r}" y2="${z.toFixed(1)}"
          stroke="var(--divider-color)" stroke-width="1" stroke-dasharray="4,3" />
        ${e.map((q,H)=>{let ve=q/v*g,qe=H*h+(h-x)/2,X=s+g-ve,fe=H===n,be=q<1?"var(--success-color, #4caf50)":q>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return ae`
            <rect x="${qe.toFixed(1)}" y="${X.toFixed(1)}"
              width="${x.toFixed(1)}" height="${ve.toFixed(1)}"
              fill="${be}" opacity="${fe?1:.5}" rx="2" />
          `})}
      </svg>
      <div class="seasonal-labels">
        ${Zt.map((q,H)=>c`<span class="seasonal-label ${H===n?"active-month":""}">${o(q,a)}</span>`)}
      </div>
    </div>
  `}var Zt,Xt=b(()=>{"use strict";j();S();Zt=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var $,ea=b(()=>{"use strict";j();M();S();P();Bt();Gt();Qt();Xt();$=class extends k{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(n=>n.id===this._taskId);this._task=t??null}catch(e){this._error=y(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=y(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(L(),V)).then(({openCompleteDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(L(),V)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(L(),V)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=o("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=o("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${o("reanalyze_result",this._lang)||"Recomputed"}: ${e.recommended_interval}d (${e.data_points} pts)`:o("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=y(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){!this._entryId||!this._taskId||Promise.resolve().then(()=>(L(),V)).then(({openHistoryEditDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null})})}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return p;let t=this._lang;return c`
    ...
    `}_renderAdaptive(e){let t=this._lang,n=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,r=e.degradation_trend!=null&&e.degradation_trend!=="insufficient_data"||e.days_until_threshold!=null||e.environmental_factor!=null&&e.environmental_factor!==1,l=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,s=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1;return!n&&!r&&!l&&!s?c`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${r?Wt(e,t,this._features):p}
        ${l?Vt(e,t):p}
        ${s?c`
          ${Jt(e,t,this._features)}
          ${e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12?Yt(e,t):p}
        `:p}
      </div>
    `}_renderDetails(e){let t=this._lang,n=e.history||[],r=n.filter(u=>u.type==="completed"),l=r.reduce((u,g)=>u+(typeof g.cost=="number"?g.cost:0),0),s=(()=>{let u=r.map(g=>typeof g.duration=="number"?g.duration:null).filter(g=>g!=null);return u.length?Math.round(u.reduce((g,v)=>g+v,0)/u.length):null})();return c`
      <div class="details">
        ...
        ${n.length===0?c`<div class="history-empty">${o("history_empty",t)||"No history yet."}</div>`:c`
              <div class="history-list">
                ${[...n].reverse().slice(0,20).map(u=>{let g=["completed","reset","skipped"].includes(u.type);return c`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${u.type}">${o(u.type,t)}</span>
                        <span class="history-date">${It(u.timestamp,t)}</span>
                        ${g?c`<button class="history-edit"
                                   title="${o("history_edit_button",t)||"Edit"}"
                                   @click=${()=>this._onEditHistoryEntry(u)}>
                              <ha-icon icon="mdi:pencil"></ha-icon>
                            </button>`:p}
                      </div>
                      ${u.notes?c`<div class="history-notes">${u.notes}</div>`:p}
                      ${u.cost!=null||u.duration!=null?c`<div class="history-meta">
                            ${u.cost!=null?c`<span>💰 ${u.cost.toFixed(2)}</span>`:p}
                            ${u.duration!=null?c`<span>⏱️ ${u.duration}m</span>`:p}
                          </div>`:p}
                    </div>
                  `})}
                ${n.length>20?c`<div class="history-more">… +${n.length-20} ${o("older_entries",t)||"older"}</div>`:p}
              </div>
            `}
      </div>
    `}render(){if(!this._open)return p;let e=this._lang,t=this._task,n=this.hass?.user?.is_admin??!0;return c`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?c`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&Promise.resolve().then(()=>(L(),V)).then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${t.next_due?c`<span><strong>${o("next_due",e)||"Next due"}:</strong> ${ge(t.next_due,e)}</span>`:p}
                  ${t.last_performed?c`<span><strong>${o("last_performed",e)||"Last"}:</strong> ${ge(t.last_performed,e)}</span>`:p}
                  ${t.interval_days!=null?c`<span><strong>${o("interval",e)||"Interval"}:</strong> ${t.interval_days}d</span>`:p}
                </div>
              </div>
              ...
              ${this._showSkip?c`
                  ...
                  `:c`
                    ...
                    <div class="details-toggle">
                      ...
                      ${this._features.adaptive||this._features.seasonal||this._features.environmental?c`<button class="link" @click=${()=>{this._showAdaptive=!this._showAdaptive}}>
                  ...
                  `}
            `:c`<div class="loading">${o("loading",e)||"Loading\u2026"}</div>`}
      </div>
    `}};$.styles=[Mt,w`
    :host { display: contents; }
    .backdrop {
  ...
  `],d([f({attribute:!1})],$.prototype,"hass",2),d([_()],$.prototype,"_open",2),d([_()],$.prototype,"_entryId",2),d([_()],$.prototype,"_taskId",2),d([_()],$.prototype,"_task",2),d([_()],$.prototype,"_objectName",2),d([_()],$.prototype,"_busy",2),d([_()],$.prototype,"_error",2),d([_()],$.prototype,"_showSkip",2),d([_()],$.prototype,"_showReset",2),d([_()],$.prototype,"_showDetails",2),d([_()],$.prototype,"_showAdaptive",2),d([_()],$.prototype,"_skipReason",2),d([_()],$.prototype,"_resetDate",2),d([_()],$.prototype,"_features",2),d([_()],$.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",$)});var F,ta=b(()=>{"use strict";j();M();S();P();F=class extends k{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return this.hass?.language||"en"}async openFor(e){this._entryId=e,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=e}catch(e){this._error=y(e,this._lang)}}_onEditObject(){!this._entryId||!this._data||Promise.resolve().then(()=>(L(),V)).then(({openEditObjectDialog:e})=>{e(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&Promise.resolve().then(()=>(L(),V)).then(({openCreateTaskDialog:e})=>{e(),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let e=o("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(e)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=y(t,this._lang)}finally{this._busy=!1}}}_onTaskClick(e){this._entryId&&Promise.resolve().then(()=>(L(),V)).then(({openTaskQuickActions:t})=>{t(this._entryId,e)})}render(){if(!this._open)return p;let e=this._lang,t=this._data,n=t?.object,r=t?.tasks||[],l=this.hass?.user?.is_admin??!0;return c`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${t&&n?c`
              <div class="header">
              ...
              <div class="tasks-section">
                ...
                ${r.length===0?c`<div class="empty">${o("no_tasks",e)||"No tasks yet."}</div>`:c`
                      <div class="task-list">
                        ${r.map(s=>c`
                          <div class="task-row" @click=${()=>this._onTaskClick(s.id)}>
                            <span class="status-dot" style="background: ${Ae[s.status]||"#ccc"}"></span>
    ...
    `}_renderMetaRow(e){let t=this._lang,n=[];return e.area_id&&n.push([o("area",t)||"Area",e.area_id]),e.manufacturer&&n.push([o("manufacturer",t)||"Manufacturer",e.manufacturer]),e.model&&n.push([o("model",t)||"Model",e.model]),e.serial_number&&n.push([o("serial_number",t)||"Serial",e.serial_number]),e.installation_date&&n.push([o("installation_date",t)||"Installed",e.installation_date]),e.documentation_url&&n.push([o("documentation_url",t)||"Docs",e.documentation_url]),n.length===0?p:c`
      <div class="meta">
        ${n.map(([r,l])=>c`
            <div class="meta-item">
              <span class="meta-label">${r}</span>
              <span class="meta-value">${r.toLowerCase().includes("doc")||r.toLowerCase().includes("url")?c`<a href="${l}" target="_blank" rel="noopener">${l}</a>`:l}</span>
            </div>
          `)}
      </div>
    `}};F.styles=w`
  ...
  `,d([f({attribute:!1})],F.prototype,"hass",2),d([_()],F.prototype,"_open",2),d([_()],F.prototype,"_entryId",2),d([_()],F.prototype,"_data",2),d([_()],F.prototype,"_busy",2),d([_()],F.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",F)});var V={};ya(V,{openCompleteDialog:()=>gn,openCreateObjectDialog:()=>Be,openCreateTaskDialog:()=>pn,openEditObjectDialog:()=>un,openEditTaskDialog:()=>We,openHistoryEditDialog:()=>Ge,openObjectQuickActions:()=>Qe,openQrDialog:()=>mn,openTaskQuickActions:()=>Ke});function ia(){return document.querySelector("home-assistant")?.hass}function B(i){let a=document.body.querySelector(i);return a||(a=document.createElement(i),document.body.appendChild(a)),a}function W(i){let a=ia();return a?(i.hass=a,!0):!1}function Be(){let i=B(aa);return W(i)?(i.openCreate(),!0):!1}function un(i,a){let e=B(aa);return W(e)?(e.openEdit(i,a),!0):!1}function pn(){let i=B(na);return W(i)?(i.openCreate(),!0):!1}function We(i,a){let e=B(na);return W(e)?(e.openEdit(i,{id:a}),!0):!1}function Ge(i){let a=B(sn);return W(a)?(a.openEdit(i),!0):!1}function gn(i){let a=B(ln);return W(a)?(a.entryId=i.entry_id,a.taskId=i.task_id,a.taskName=i.task_name,a.checklist=i.checklist??[],a.adaptiveEnabled=!!i.adaptive_enabled,a.lang=ia()?.language||"en",a.open(),!0):!1}function mn(i){let a=B(dn);return W(a)?(a.openForTask(i.entry_id,i.task_id,i.object_name,i.task_name),!0):!1}function Ke(i,a){let e=B(cn);return W(e)?(e.openFor(i,a),!0):!1}function Qe(i){let a=B(_n);return W(a)?(a.openFor(i),!0):!1}var aa,na,sn,ln,dn,cn,_n,L=b(()=>{"use strict";Dt();Lt();Ft();Ht();Ut();ea();ta();aa="maintenance-object-dialog",na="maintenance-task-dialog",sn="maintenance-history-edit-dialog",ln="maintenance-complete-dialog",dn="maintenance-qr-dialog",cn="maintenance-task-quick-actions-dialog",_n="maintenance-object-quick-actions-dialog"});j();M();S();P();var C=class extends k{constructor(){super(...arguments);this._config={type:""};this._state=null;this._busy=!1;this._error="";this._localStart="";this._localEnd="";this._localBuffer=7;this._dirty=!1;this._loaded=!1}setConfig(e){this._config=e}getCardSize(){return 2}get _lang(){return this.hass?.language||"en"}get _isAdmin(){return this.hass?.user?.is_admin??!0}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded&&(this._loaded=!0,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/vacation/state"});this._state=e,this._localStart=e.start||"",this._localEnd=e.end||"",this._localBuffer=e.buffer_days??7,this._dirty=!1}catch(e){this._error=y(e,this._lang)}}async _toggleEnabled(e){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/vacation/update",enabled:e});this._state=t}catch(t){this._error=y(t,this._lang)}finally{this._busy=!1}}async _save(){if(this._isAdmin){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/vacation/update",start:this._localStart||null,end:this._localEnd||null,buffer_days:this._localBuffer});this._state=e,this._dirty=!1}catch(e){this._error=y(e,this._lang)}finally{this._busy=!1}}}async _endNow(){if(this._isAdmin&&window.confirm(o("vacation_end_now_confirm",this._lang)||"End vacation immediately?")){this._busy=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/vacation/end_now"});this._state=e,this._localStart=e.start||"",this._localEnd=e.end||""}catch(e){this._error=y(e,this._lang)}finally{this._busy=!1}}}_onDeepLink(){history.pushState(null,"","/maintenance-supporter?ms_action=open_vacation"),window.dispatchEvent(new CustomEvent("location-changed"))}render(){let e=this._lang,t=this._state;if(!t)return c`<ha-card><div class="loading">${o("loading",e)||"Loading\u2026"}</div></ha-card>`;let n=t.is_active===!0,r=t.enabled===!0,l=t.exempt_task_ids?.length??0,s=n?o("vacation_status_active",e)||"Active now":r?o("vacation_status_scheduled",e)||"Scheduled":o("vacation_status_inactive",e)||"Inactive",u=n?"active":r?"scheduled":"inactive";return c`
      <ha-card>
        <div class="card-content">
          ...
          ${this._isAdmin?c`
                ...
                <div class="actions">
                  ...
                  ${n?c`<button class="btn"
                        @click=${this._endNow}
                        ?disabled=${this._busy}>
                        ${o("vacation_end_now",e)||"End now"}
                      </button>`:p}
                  ${l>0?c`<button class="btn link"
                        @click=${this._onDeepLink}>
                        ${l} ${o("vacation_exempt_count",e)||"exempt"}…
                      </button>`:c`<button class="btn link"
                        @click=${this._onDeepLink}>
              ...
              `:c`
                <div class="readonly">
                  ${r&&t.start&&t.end?c`<div>${t.start} → ${t.end}</div>`:p}
    ...
    .loading { padding: 24px; text-align: center; color: var(--secondary-text-color); }
  `,d([f({attribute:!1})],C.prototype,"hass",2),d([_()],C.prototype,"_config",2),d([_()],C.prototype,"_state",2),d([_()],C.prototype,"_busy",2),d([_()],C.prototype,"_error",2),d([_()],C.prototype,"_localStart",2),d([_()],C.prototype,"_localEnd",2),d([_()],C.prototype,"_localBuffer",2),d([_()],C.prototype,"_dirty",2);customElements.get("maintenance-vacation-section-card")||customElements.define("maintenance-vacation-section-card",C);window.customCards=window.customCards||[];window.customCards.push({type:"maintenance-vacation-section-card",name:"Maintenance Supporter \u2014 Vacation",description:"Inline vacation mode toggle + dates",preview:!1});j();M();S();P();var T=class extends k{constructor(){super(...arguments);this._config={type:""};this._status=null;this._busy=!1;this._error="";this._localMonthly="";this._localYearly="";this._dirty=!1;this._loaded=!1}setConfig(e){this._config=e}getCardSize(){return 2}get _lang(){return this.hass?.language||"en"}get _isAdmin(){return this.hass?.user?.is_admin??!0}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded&&(this._loaded=!0,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"});this._status=e,this._localMonthly=e.monthly_budget?String(e.monthly_budget):"",this._localYearly=e.yearly_budget?String(e.yearly_budget):"",this._dirty=!1}catch(e){this._error=y(e,this._lang)}}async _save(){if(this._isAdmin){this._busy=!0,this._error="";try{let e=parseFloat(this._localMonthly),t=parseFloat(this._localYearly),n={};!isNaN(e)&&e>=0&&(n.budget_monthly=e),!isNaN(t)&&t>=0&&(n.budget_yearly=t),await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:n}),await this._load()}catch(e){this._error=y(e,this._lang)}finally{this._busy=!1}}}_onDeepLink(){history.pushState(null,"","/maintenance-supporter?ms_action=open_budget"),window.dispatchEvent(new CustomEvent("location-changed"))}render(){let e=this._lang,t=this._status;if(!t)return c`<ha-card><div class="loading">${o("loading",e)||"Loading\u2026"}</div></ha-card>`;let n=t.currency_symbol||"\u20AC",r=t.monthly_budget?Math.min(100,(t.monthly_spent||0)/t.monthly_budget*100):0,l=t.yearly_budget?Math.min(100,(t.yearly_spent||0)/t.yearly_budget*100):0,s=r>=100?"danger":r>=80?"warning":"ok",u=l>=100?"danger":l>=80?"warning":"ok";return c`
      <ha-card>
        <div class="card-content">
          <div class="header">
            <div class="title">
    ...
    .loading { padding: 24px; text-align: center; color: var(--secondary-text-color); }
  `,d([f({attribute:!1})],T.prototype,"hass",2),d([_()],T.prototype,"_config",2),d([_()],T.prototype,"_status",2),d([_()],T.prototype,"_busy",2),d([_()],T.prototype,"_error",2),d([_()],T.prototype,"_localMonthly",2),d([_()],T.prototype,"_localYearly",2),d([_()],T.prototype,"_dirty",2);customElements.get("maintenance-budget-section-card")||customElements.define("maintenance-budget-section-card",T);window.customCards=window.customCards||[];window.customCards.push({type:"maintenance-budget-section-card",name:"Maintenance Supporter \u2014 Budget",description:"Inline monthly + yearly budget editor",preview:!1});j();M();S();P();var N=class extends k{constructor(){super(...arguments);this._config={type:""};this._groups={};this._loaded=!1;this._busy=!1;this._error="";this._newName="";this._editingId=null;this._editingName="";this._hasInitiallyLoaded=!1}setConfig(e){this._config=e}getCardSize(){return 2}get _lang(){return this.hass?.language||"en"}get _isAdmin(){return this.hass?.user?.is_admin??!0}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._hasInitiallyLoaded&&(this._hasInitiallyLoaded=!0,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"});this._groups=e.groups||{},this._loaded=!0}catch(e){this._error=y(e,this._lang)}}async _addGroup(){if(!this._isAdmin)return;let e=this._newName.trim();if(e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/group/create",name:e}),this._newName="",await this._load()}catch(t){this._error=y(t,this._lang)}finally{this._busy=!1}}}_startEdit(e){this._editingId=e,this._editingName=this._groups[e]?.name||""}async _saveEdit(){if(!this._isAdmin||!this._editingId)return;let e=this._editingName.trim();if(e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/group/update",group_id:this._editingId,name:e}),this._editingId=null,this._editingName="",await this._load()}catch(t){this._error=y(t,this._lang)}finally{this._busy=!1}}}async _deleteGroup(e,t){if(!this._isAdmin)return;let n=(o("group_delete_confirm",this._lang)||'Delete group "{name}"?').replace("{name}",t);if(window.confirm(n)){this._busy=!0;try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/group/delete",group_id:e}),await this._load()}catch(r){this._error=y(r,this._lang)}finally{this._busy=!1}}}_onDeepLink(){history.pushState(null,"","/maintenance-supporter?ms_action=open_groups"),window.dispatchEvent(new CustomEvent("location-changed"))}_onKeyDown(e,t){e.key==="Enter"?(e.preventDefault(),t()):e.key==="Escape"&&(e.preventDefault(),this._editingId=null,this._editingName="")}render(){let e=this._lang;if(!this._loaded)return c`<ha-card><div class="loading">${o("loading",e)||"Loading\u2026"}</div></ha-card>`;let t=Object.keys(this._groups);return c`
      <ha-card>
        <div class="card-content">
          <div class="header">
            <div class="title">
          ...
          ${t.length===0?c`<div class="empty">${o("groups_empty",e)||"No groups yet."}</div>`:c`
                <div class="group-list">
                  ${t.map(n=>{let r=this._groups[n],l=r.task_refs?.length??0,s=this._editingId===n;return c`
                      <div class="group-row">
                        ${s?c`
    ...
    .loading { padding: 24px; text-align: center; color: var(--secondary-text-color); }
  `,d([f({attribute:!1})],N.prototype,"hass",2),d([_()],N.prototype,"_config",2),d([_()],N.prototype,"_groups",2),d([_()],N.prototype,"_loaded",2),d([_()],N.prototype,"_busy",2),d([_()],N.prototype,"_error",2),d([_()],N.prototype,"_newName",2),d([_()],N.prototype,"_editingId",2),d([_()],N.prototype,"_editingName",2);customElements.get("maintenance-groups-section-card")||customElements.define("maintenance-groups-section-card",N);window.customCards=window.customCards||[];window.customCards.push({type:"maintenance-groups-section-card",name:"Maintenance Supporter \u2014 Groups",description:"Inline group CRUD",preview:!1});L();var ua="maintenance-supporter",oa=`ll-strategy-dashboard-${ua}`,Ze="hui-maintenance-supporter-strategy-editor",hn="NOT_RUNNING",vn=[{status:"overdue",title:"Overdue",icon:"mdi:alert-circle",path:"overdue"},{status:"triggered",title:"Triggered",icon:"mdi:flash",path:"triggered"},{status:"due_soon",title:"Due Soon",icon:"mdi:clock-alert-outline",path:"due-soon"},{status:"ok",title:"OK",icon:"mdi:check-circle-outline",path:"ok"}],ra=[{title:"Overdue",icon:"mdi:alert-circle",path:"overdue",filter:{filter_due_max_days:-1},matches:i=>i<=-1},{title:"Today",icon:"mdi:calendar-today",path:"today",filter:{filter_due_min_days:0,filter_due_max_days:0},matches:i=>i===0},{title:"This Week",icon:"mdi:calendar-week",path:"this-week",filter:{filter_due_min_days:1,filter_due_max_days:7},matches:i=>i>=1&&i<=7},{title:"This Month",icon:"mdi:calendar-month",path:"this-month",filter:{filter_due_min_days:8,filter_due_max_days:30},matches:i=>i>=8&&i<=30},{title:"Later",icon:"mdi:calendar-clock",path:"later",filter:{filter_due_min_days:31},matches:i=>i>=31}];function Y(i){return{type:"grid",cards:[i]}}var fn={condition:"view_columns",min:2};function bn(i){let a={overdue:0,triggered:0,due_soon:0,ok:0,total:0};for(let e of i)for(let t of e.tasks||[])a.total++,t.status==="overdue"?a.overdue++:t.status==="triggered"?a.triggered++:t.status==="due_soon"?a.due_soon++:t.status==="ok"&&a.ok++;return a}function yn(i){let a=[];return i.overdue&&a.push(`\u{1F534} **${i.overdue}** overdue`),i.triggered&&a.push(`\u26A1 **${i.triggered}** triggered`),i.due_soon&&a.push(`\u{1F7E1} **${i.due_soon}** due soon`),a.push(`\u{1F7E2} **${i.ok}** ok`),{type:"markdown",text_only:!0,content:a.join(" \xB7 ")}}function kn(){return{title:"Maintenance",type:"panel",cards:[{type:"empty-state",icon:"mdi:wrench-clock",icon_color:"primary",content_only:!0,title:"No maintenance objects yet",content:"Open the Maintenance panel to add your first object \u2014 pool pump, HVAC filter, vehicle, anything that needs scheduled care.",buttons:[{icon:"mdi:wrench",text:"Open Maintenance panel",appearance:"filled",variant:"brand",tap_action:{action:"navigate",navigation_path:"/maintenance-supporter"}},{icon:"mdi:plus",text:"Add object",appearance:"outlined",variant:"brand",tap_action:{action:"fire-dom-event",ll_custom:{type:"maintenance-supporter:add-object"}}}]}]}}function wn(i){let a=yn(i);return{title:"Overview",icon:"mdi:wrench-clock",path:"overview",type:"sections",header:{layout:"responsive",card:a},sidebar:{sections:[{type:"grid",cards:[{type:"heading",heading:"Status",heading_style:"title"},a]}],visibility:[fn],content_label:"Tasks",sidebar_label:"Status"},sections:[Y({type:"custom:maintenance-supporter-card",show_header:!1,filter_status:["overdue","triggered","due_soon"]})]}}function xn(i,a){let e=new Map;for(let l of i){let s=l.object.area_id||null;e.has(s)||e.set(s,[]),e.get(s).push(l)}let t=Array.from(e.keys()).filter(l=>l!==null);t.sort((l,s)=>{let u=a[l]?.name||l,g=a[s]?.name||s;return u.localeCompare(g)});let n=[];for(let l of t){let s=e.get(l);if(s.length===0)continue;let u=a[l];n.push({title:u?.name||l,icon:u?.icon||"mdi:floor-plan",path:`area-${l}`,type:"sections",sections:[Y({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:s.map(g=>g.object.name)})]})}let r=e.get(null);return r&&r.length>0&&n.push({title:"Unassigned",icon:"mdi:help-circle-outline",path:"unassigned",type:"sections",sections:[Y({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:r.map(l=>l.object.name)})]}),n}function zn(i){let a=new Set;for(let t of i)for(let n of t.tasks||[])n.status&&a.add(n.status);let e=[];for(let t of vn)a.has(t.status)&&e.push({title:t.title,icon:t.icon,path:t.path,type:"sections",sections:[Y({type:"custom:maintenance-supporter-card",show_header:!1,filter_status:[t.status]})]});return e}function $n(i,a,e){let t=new Map;for(let s of i){let u=s.object.area_id,g=u&&a[u]?.floor_id||null;t.has(g)||t.set(g,[]),t.get(g).push(s)}let n=Array.from(t.keys()).filter(s=>s!==null);n.sort((s,u)=>{let g=e[s],v=e[u],h=g?.level??0,x=v?.level??0;return h!==x?h-x:(g?.name||s).localeCompare(v?.name||u)});let r=[];for(let s of n){let u=t.get(s);if(u.length===0)continue;let g=e[s];r.push({title:g?.name||s,icon:g?.icon||"mdi:home-floor-1",path:`floor-${s}`,type:"sections",sections:[Y({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:u.map(v=>v.object.name)})]})}let l=t.get(null);return l&&l.length>0&&r.push({title:"Other",icon:"mdi:help-circle-outline",path:"other",type:"sections",sections:[Y({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:l.map(s=>s.object.name)})]}),r}function En(i){return[{title:"Week",icon:"mdi:calendar-week",path:"cal-7",window_days:7},{title:"Fortnight",icon:"mdi:calendar-week-begin",path:"cal-14",window_days:14},{title:"Month",icon:"mdi:calendar-month",path:"cal-30",window_days:30},{title:"Year",icon:"mdi:calendar-clock",path:"cal-365",window_days:365}].map(e=>({title:e.title,icon:e.icon,path:e.path,type:"panel",cards:[{type:"custom:maintenance-supporter-calendar-card",window_days:e.window_days,show_window_chips:!1,show_user_filter:!0}]}))}function An(i){let a=new Set;for(let t of i)for(let n of t.tasks||[]){let r=n.days_until_due;r!=null&&ra.forEach((l,s)=>{l.matches(r)&&a.add(s)})}let e=[];return ra.forEach((t,n)=>{a.has(n)&&e.push({title:t.title,icon:t.icon,path:t.path,type:"sections",sections:[Y({type:"custom:maintenance-supporter-card",show_header:!1,...t.filter})]})}),e}var Je=class extends HTMLElement{static getCreateSuggestions(a){return{title:"Maintenance Supporter",icon:"mdi:wrench-clock"}}static async getConfigElement(){return document.createElement(Ze)}static async generate(a,e){if(e.config?.state===hn)return{views:[{type:"sections",sections:[{cards:[{type:"starting"}]}]}]};if(e.config?.recovery_mode)return{views:[{type:"sections",sections:[{cards:[{type:"recovery-mode"}]}]}]};let t;try{t=await e.connection.sendMessagePromise({type:"maintenance_supporter/objects"})}catch{return{title:"Maintenance",views:[{title:"Maintenance",cards:[{type:"markdown",content:"**Maintenance Supporter** is not loaded. Install/enable the integration first."}]}]}}let n=t.objects||[];if(n.length===0)return{title:"Maintenance",views:[kn()]};let r=bn(n),l=a?.group_by??"area",s={area:()=>xn(n,e.areas||{}),status:()=>zn(n),floor:()=>$n(n,e.areas||{},e.floors||{}),due_date:()=>An(n),calendar:()=>En(n)};return{title:"Maintenance",views:[wn(r),...(s[l]??s.area)()]}}},jn=[{value:"area",label:"By area (default)"},{value:"status",label:"By status (Overdue / Triggered / Due Soon / OK)"},{value:"floor",label:"By floor (uses HA floors)"},{value:"due_date",label:"By due date (Overdue / Today / Week / Month / Later)"},{value:"calendar",label:"Rolling calendar (Week / Fortnight / Month / Year)"}],Ye=class extends HTMLElement{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter"}}set hass(e){this._hass=e}setConfig(e){this._config=e,this._render()}connectedCallback(){this._render()}_render(){let e=this._config.group_by??"area",t=jn.map(r=>`<option value="${r.value}"${r.value===e?" selected":""}>${r.label}</option>`).join("");this.innerHTML=`
      <style>
    ...
    `;let n=this.querySelector("#group-by");n?.addEventListener("change",()=>{let r={...this._config,group_by:n.value};this._config=r,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:r},bubbles:!0,composed:!0}))})}},pa="maintenance-supporter-section",sa=`ll-strategy-section-${pa}`,Xe=class extends HTMLElement{static async generate(a,e){let t={type:"custom:maintenance-supporter-card",show_header:!1};a?.filter_status?.length&&(t.filter_status=a.filter_status),a?.max_items&&(t.max_items=a.max_items),a?.filter_due_min_days!==void 0&&(t.filter_due_min_days=a.filter_due_min_days),a?.filter_due_max_days!==void 0&&(t.filter_due_max_days=a.filter_due_max_days);let n=a?.filter_objects;if(a?.area_id&&!n)try{n=((await e.connection.sendMessagePromise({type:"maintenance_supporter/objects"})).objects||[]).filter(s=>s.object.area_id===a.area_id).map(s=>s.object.name)}catch{}n&&n.length>0&&(t.filter_objects=n);let r=[];return a?.title&&r.push({type:"heading",heading:a.title,heading_style:"title"}),r.push(t),{type:"grid",cards:r}}};customElements.get(oa)||customElements.define(oa,Je);customElements.get(Ze)||customElements.define(Ze,Ye);customElements.get(sa)||customElements.define(sa,Xe);var et=class extends HTMLElement{static async generate(a,e){return{type:"grid",cards:[{type:"custom:maintenance-vacation-section-card",title:a?.title}]}}},tt=class extends HTMLElement{static async generate(a,e){return{type:"grid",cards:[{type:"custom:maintenance-budget-section-card",title:a?.title}]}}},at=class extends HTMLElement{static async generate(a,e){return{type:"grid",cards:[{type:"custom:maintenance-groups-section-card",title:a?.title}]}}},la="ll-strategy-section-maintenance-supporter-vacation",da="ll-strategy-section-maintenance-supporter-budget",ca="ll-strategy-section-maintenance-supporter-groups";customElements.get(la)||customElements.define(la,et);customElements.get(da)||customElements.define(da,tt);customElements.get(ca)||customElements.define(ca,at);var _a="_msSupporterLlCustomBound";function me(i){history.pushState(null,"",i),window.dispatchEvent(new CustomEvent("location-changed"))}function Sn(){let i=window;i[_a]||(i[_a]=!0,document.addEventListener("ll-custom",a=>{let e=a.detail;if(!e||typeof e.type!="string"||!e.type.startsWith("maintenance-supporter:"))return;let t=e.type.slice(22);if(t==="add-object"){if(Be())return;me("/maintenance-supporter?ms_action=add_object");return}if(t==="open-task"&&typeof e.entry_id=="string"&&typeof e.task_id=="string"){if(Ke(e.entry_id,e.task_id)||We(e.entry_id,e.task_id))return;me(`/maintenance-supporter?entry_id=${encodeURIComponent(e.entry_id)}&task_id=${encodeURIComponent(e.task_id)}`);return}if(t==="open-object"&&typeof e.entry_id=="string"){if(Qe(e.entry_id))return;me(`/maintenance-supporter?entry_id=${encodeURIComponent(e.entry_id)}`);return}if(t==="deep-link"&&typeof e.path=="string"){me(e.path);return}if(t==="edit-history"&&typeof e.entry_id=="string"&&typeof e.task_id=="string"&&typeof e.original_timestamp=="string"){let r=document.querySelector("home-assistant")?.hass;if(!r)return;(async()=>{try{let u=(await r.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:e.entry_id})).tasks?.find(g=>g.id===e.task_id)?.history?.find(g=>g.timestamp===e.original_timestamp);if(!u)return;Ge({entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.original_timestamp,type:u.type||"completed",timestamp:u.timestamp||e.original_timestamp,notes:u.notes??null,cost:u.cost??null,duration:u.duration??null,completed_by:u.completed_by??null})}catch{me("/maintenance-supporter")}})();return}}))}Sn();var Se=window;Se.customStrategies=Se.customStrategies||[];function he(i){Se.customStrategies.some(e=>e.type===i.type&&e.strategyType===i.strategyType)||Se.customStrategies.push(i)}he({type:ua,strategyType:"dashboard",name:"Maintenance Supporter",description:"Auto-generated dashboard. Group views by area, status, floor, or due date \u2014 picked from the strategy editor or YAML.",documentationURL:"https://github.com/iluebbe/maintenance_supporter#dashboard-strategy"});he({type:pa,strategyType:"section",name:"Maintenance Supporter \u2014 Section",description:"Embed maintenance tasks (filterable by area, status, due date) as a section in any dashboard view.",documentationURL:"https://github.com/iluebbe/maintenance_supporter#section-strategy"});he({type:"maintenance-supporter-vacation",strategyType:"section",name:"Maintenance Supporter \u2014 Vacation Status",description:"Compact vacation-mode status banner. Tap to open settings in the panel."});he({type:"maintenance-supporter-budget",strategyType:"section",name:"Maintenance Supporter \u2014 Budget Status",description:"Monthly + yearly maintenance budget overview. Tap for details."});he({type:"maintenance-supporter-groups",strategyType:"section",name:"Maintenance Supporter \u2014 Groups",description:"List of configured task groups with member counts."});
