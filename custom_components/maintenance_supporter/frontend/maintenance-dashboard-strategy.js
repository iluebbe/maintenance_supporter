...
`).map(s=>s.trim()).filter(Boolean).slice(0,100);e.checklist=l.length?l:null}if(this.completionActionsEnabled){let l=this._actionService.trim();if(l&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(l)){let f={service:l},h=this._actionTargetEntity.trim();h&&(f.target={entity_id:h});let E=this._buildActionData();Object.keys(E).length>0&&(f.data=E),e.on_complete_action=f}else e.on_complete_action=null;let s={};this._qcNotes.trim()&&(s.notes=this._qcNotes.trim());let c=parseFloat(this._qcCost);!isNaN(c)&&c>=0&&(s.cost=c);let m=parseInt(this._qcDuration,10);!isNaN(m)&&m>=0&&(s.duration=m),this._qcFeedback&&(s.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(s).length?s:null}let t=await this.hass.connection.sendMessagePromise(e),n=this._taskId||t?.task_id,o=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(n&&this._scheduleType==="sensor_based"&&o)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=j(e,this._lang,r("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return p;let e=this._lang;return u`
      ...
      <div class="select-row">
        ...
        >
          ${fa.map(t=>u`<option value=${t} ?selected=${t===this._triggerType}>${r(t,e)}</option>`)}
        </select>
      </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${ma.map(n=>u`<option value=${n} ?selected=${n===this._type}>${r(n,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${ha.map(n=>u`<option value=${n} ?selected=${n===this._scheduleType}>${r(n,e)}</option>`)}
            </select>
          </div>
  ...
  `,_([b({attribute:!1})],g.prototype,"hass",2),_([b({type:Boolean,attribute:"checklists-enabled"})],g.prototype,"checklistsEnabled",2),_([b({type:Boolean,attribute:"schedule-time-enabled"})],g.prototype,"scheduleTimeEnabled",2),_([b({type:Boolean,attribute:"completion-actions-enabled"})],g.prototype,"completionActionsEnabled",2),_([b({type:Number,attribute:"default-warning-days"})],g.prototype,"defaultWarningDays",2),_([d()],g.prototype,"_open",2),_([d()],g.prototype,"_loading",2),_([d()],g.prototype,"_error",2),_([d()],g.prototype,"_entryId",2),_([d()],g.prototype,"_taskId",2),_([d()],g.prototype,"_objectChoices",2),_([d()],g.prototype,"_name",2),_([d()],g.prototype,"_type",2),_([d()],g.prototype,"_scheduleType",2),_([d()],g.prototype,"_intervalDays",2),_([d()],g.prototype,"_warningDays",2),_([d()],g.prototype,"_intervalAnchor",2),_([d()],g.prototype,"_notes",2),_([d()],g.prototype,"_documentationUrl",2),_([d()],g.prototype,"_customIcon",2),_([d()],g.prototype,"_enabled",2),_([d()],g.prototype,"_triggerEntityId",2),_([d()],g.prototype,"_triggerEntityIds",2),_([d()],g.prototype,"_triggerEntityLogic",2),_([d()],g.prototype,"_triggerAttribute",2),_([d()],g.prototype,"_triggerType",2),_([d()],g.prototype,"_triggerAbove",2),_([d()],g.prototype,"_triggerBelow",2),_([d()],g.prototype,"_triggerForMinutes",2),_([d()],g.prototype,"_triggerTargetValue",2),_([d()],g.prototype,"_triggerDeltaMode",2),_([d()],g.prototype,"_triggerFromState",2),_([d()],g.prototype,"_triggerToState",2),_([d()],g.prototype,"_triggerTargetChanges",2),_([d()],g.prototype,"_triggerRuntimeHours",2),_([d()],g.prototype,"_suggestedAttributes",2),_([d()],g.prototype,"_availableAttributes",2),_([d()],g.prototype,"_entityDomain",2),_([d()],g.prototype,"_lastPerformed",2),_([d()],g.prototype,"_nfcTagId",2),_([d()],g.prototype,"_availableTags",2),_([d()],g.prototype,"_responsibleUserId",2),_([d()],g.prototype,"_availableUsers",2),_([d()],g.prototype,"_checklistText",2),_([d()],g.prototype,"_scheduleTime",2),_([d()],g.prototype,"_actionService",2),_([d()],g.prototype,"_actionTargetEntity",2),_([d()],g.prototype,"_actionData",2),_([d()],g.prototype,"_actionDataJsonFallback",2),_([d()],g.prototype,"_actionTesting",2),_([d()],g.prototype,"_actionTestResult",2),_([d()],g.prototype,"_qcNotes",2),_([d()],g.prototype,"_qcCost",2),_([d()],g.prototype,"_qcDuration",2),_([d()],g.prototype,"_qcFeedback",2),_([d()],g.prototype,"_environmentalEntity",2),_([d()],g.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",g)});var k,kt=v(()=>{"use strict";N();F();C();V();k=class extends y{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed"}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed")}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=j(e,this.lang,r("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return u``;let e=this.lang||this.hass?.language||"en";return u`
      <ha-dialog open @closed=${this._close}>
  ...
  `,_([b({attribute:!1})],k.prototype,"hass",2),_([b()],k.prototype,"entryId",2),_([b()],k.prototype,"taskId",2),_([b()],k.prototype,"taskName",2),_([b()],k.prototype,"lang",2),_([b({type:Array})],k.prototype,"checklist",2),_([b({type:Boolean})],k.prototype,"adaptiveEnabled",2),_([d()],k.prototype,"_open",2),_([d()],k.prototype,"_notes",2),_([d()],k.prototype,"_cost",2),_([d()],k.prototype,"_duration",2),_([d()],k.prototype,"_loading",2),_([d()],k.prototype,"_error",2),_([d()],k.prototype,"_checklistState",2),_([d()],k.prototype,"_feedback",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",k)});var T,wt=v(()=>{"use strict";N();F();C();V();T=class extends y{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null}get _lang(){return this.hass?.language||"en"}openEdit(e){this._draft={...e},this._originalSnapshot={...e},this._error="",this._open=!0}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null}_set(e,t){this._draft&&(this._draft={...this._draft,[e]:t})}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{let e={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(e.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(e.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(e.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(e.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(e.completed_by=this._draft.completed_by),Object.keys(e).filter(n=>!["type","entry_id","task_id","original_timestamp"].includes(n)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(e),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=j(e,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return p;let e=this._lang,t=this._draft;return u`
...
<div class="qr-row">
  <div class="qr-col">
    <img src="${xt(this._viewResult.svg_data_uri)}" alt="QR Info" />
    <div class="qr-label">${f}</div>
  </div>
  ${m?`<div class="qr-col">
    <img src="${xt(this._completeResult.svg_data_uri)}" alt="QR Complete" />
    <div class="qr-label">${h}</div>
  </div>`:""}
</div>
<div class="url">${K(this._viewResult.url)}</div>
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),o.document.close()}_downloadSvg(e,t){let n=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),o=new Blob([n],{type:"image/svg+xml"}),l=URL.createObjectURL(o),s=document.createElement("a");s.href=l;let c=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;s.download=`qr-${va(c)}-${t}.svg`,s.click(),URL.revokeObjectURL(l)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return u``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${r("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${r("qr_code",e)}: ${this._objectName}`,n=!!this._viewResult;return u`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
      ...
      <div class="details">
        ...
        ${n.length===0?u`<div class="history-empty">${r("history_empty",t)||"No history yet."}</div>`:u`
              <div class="history-list">
                ${[...n].reverse().slice(0,20).map(c=>{let m=["completed","reset","skipped"].includes(c.type);return u`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${c.type}">${r(c.type,t)}</span>
                        <span class="history-date">${ft(c.timestamp,t)}</span>
                        ${m?u`<button class="history-edit"
                                   title="${r("history_edit_button",t)||"Edit"}"
                                   @click=${()=>this._onEditHistoryEntry(c)}>
                              <ha-icon icon="mdi:pencil"></ha-icon>
                            </button>`:p}
                      </div>
                      ${c.notes?u`<div class="history-notes">${c.notes}</div>`:p}
                      ${c.cost!=null||c.duration!=null?u`<div class="history-meta">
                            ${c.cost!=null?u`<span>💰 ${c.cost.toFixed(2)}</span>`:p}
                            ${c.duration!=null?u`<span>⏱️ ${c.duration}m</span>`:p}
                          </div>`:p}
                    </div>
                  `})}
    ...
    `}render(){if(!this._open)return p;let e=this._lang,t=this._task,n=this.hass?.user?.is_admin??!0;return u`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?u`
              <div class="header">
                <div class="title">
                  <span class="status-dot" style="background: ${pe[t.status]||"#ccc"}"></span>
                ...
                <div class="quick-info">
                  ${t.next_due?u`<span><strong>${r("next_due",e)||"Next due"}:</strong> ${Ne(t.next_due,e)}</span>`:p}
                  ${t.last_performed?u`<span><strong>${r("last_performed",e)||"Last"}:</strong> ${Ne(t.last_performed,e)}</span>`:p}
                      ...
                      <div class="task-list">
                        ${o.map(s=>u`
                          <div class="task-row" @click=${()=>this._onTaskClick(s.id)}>
                            <span class="status-dot" style="background: ${pe[s.status]||"#ccc"}"></span>
  ...
  `,_([b({attribute:!1})],q.prototype,"hass",2),_([d()],q.prototype,"_open",2),_([d()],q.prototype,"_entryId",2),_([d()],q.prototype,"_data",2),_([d()],q.prototype,"_busy",2),_([d()],q.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",q)});var I={};Mt(I,{openCompleteDialog:()=>ja,openCreateObjectDialog:()=>Ce,openCreateTaskDialog:()=>Ea,openEditObjectDialog:()=>za,openEditTaskDialog:()=>Te,openHistoryEditDialog:()=>Ie,openObjectQuickActions:()=>De,openQrDialog:()=>Aa,openTaskQuickActions:()=>Re});function qt(){return document.querySelector("home-assistant")?.hass}function R(i){let a=document.body.querySelector(i);return a||(a=document.createElement(i),document.body.appendChild(a)),a}function D(i){let a=qt();return a?(i.hass=a,!0):!1}function Ce(){let i=R(At);return D(i)?(i.openCreate(),!0):!1}function za(i,a){let e=R(At);return D(e)?(e.openEdit(i,a),!0):!1}function Ea(){let i=R(St);return D(i)?(i.openCreate(),!0):!1}function Te(i,a){let e=R(St);return D(e)?(e.openEdit(i,{id:a}),!0):!1}function Ie(i){let a=R(ba);return D(a)?(a.openEdit(i),!0):!1}function ja(i){let a=R(ya);return D(a)?(a.entryId=i.entry_id,a.taskId=i.task_id,a.taskName=i.task_name,a.checklist=i.checklist??[],a.adaptiveEnabled=!!i.adaptive_enabled,a.lang=qt()?.language||"en",a.open(),!0):!1}function Aa(i){let a=R(ka);return D(a)?(a.openForTask(i.entry_id,i.task_id,i.object_name,i.task_name),!0):!1}function Re(i,a){let e=R(wa);return D(e)?(e.openFor(i,a),!0):!1}function De(i){let a=R(xa);return D(a)?(a.openFor(i),!0):!1}var At,St,ba,ya,ka,wa,xa,S=v(()=>{"use strict";vt();yt();kt();wt();zt();Et();jt();At="maintenance-object-dialog",St="maintenance-task-dialog",ba="maintenance-history-edit-dialog",ya="maintenance-complete-dialog",ka="maintenance-qr-dialog",wa="maintenance-task-quick-actions-dialog",xa="maintenance-object-quick-actions-dialog"});S();var It="maintenance-supporter",$t=`ll-strategy-dashboard-${It}`,Pe="hui-maintenance-supporter-strategy-editor",Sa="NOT_RUNNING",qa=[{status:"overdue",title:"Overdue",icon:"mdi:alert-circle",path:"overdue"},{status:"triggered",title:"Triggered",icon:"mdi:flash",path:"triggered"},{status:"due_soon",title:"Due Soon",icon:"mdi:clock-alert-outline",path:"due-soon"},{status:"ok",title:"OK",icon:"mdi:check-circle-outline",path:"ok"}],Nt=[{title:"Overdue",icon:"mdi:alert-circle",path:"overdue",filter:{filter_due_max_days:-1},matches:i=>i<=-1},{title:"Today",icon:"mdi:calendar-today",path:"today",filter:{filter_due_min_days:0,filter_due_max_days:0},matches:i=>i===0},{title:"This Week",icon:"mdi:calendar-week",path:"this-week",filter:{filter_due_min_days:1,filter_due_max_days:7},matches:i=>i>=1&&i<=7},{title:"This Month",icon:"mdi:calendar-month",path:"this-month",filter:{filter_due_min_days:8,filter_due_max_days:30},matches:i=>i>=8&&i<=30},{title:"Later",icon:"mdi:calendar-clock",path:"later",filter:{filter_due_min_days:31},matches:i=>i>=31}];function B(i){return{type:"grid",cards:[i]}}var $a={condition:"view_columns",min:2};function Na(i){let a={overdue:0,triggered:0,due_soon:0,ok:0,total:0};for(let e of i)for(let t of e.tasks||[])a.total++,t.status==="overdue"?a.overdue++:t.status==="triggered"?a.triggered++:t.status==="due_soon"?a.due_soon++:t.status==="ok"&&a.ok++;return a}function Ca(i){let a=[];return i.overdue&&a.push(`\u{1F534} **${i.overdue}** overdue`),i.triggered&&a.push(`\u26A1 **${i.triggered}** triggered`),i.due_soon&&a.push(`\u{1F7E1} **${i.due_soon}** due soon`),a.push(`\u{1F7E2} **${i.ok}** ok`),{type:"markdown",text_only:!0,content:a.join(" \xB7 ")}}function Ta(){return{title:"Maintenance",type:"panel",cards:[{type:"empty-state",icon:"mdi:wrench-clock",icon_color:"primary",content_only:!0,title:"No maintenance objects yet",content:"Open the Maintenance panel to add your first object \u2014 pool pump, HVAC filter, vehicle, anything that needs scheduled care.",buttons:[{icon:"mdi:wrench",text:"Open Maintenance panel",appearance:"filled",variant:"brand",tap_action:{action:"navigate",navigation_path:"/maintenance-supporter"}},{icon:"mdi:plus",text:"Add object",appearance:"outlined",variant:"brand",tap_action:{action:"fire-dom-event",ll_custom:{type:"maintenance-supporter:add-object"}}}]}]}}function Ia(i){let a=Ca(i);return{title:"Overview",icon:"mdi:wrench-clock",path:"overview",type:"sections",header:{layout:"responsive",card:a},sidebar:{sections:[{type:"grid",cards:[{type:"heading",heading:"Status",heading_style:"title"},a]}],visibility:[$a],content_label:"Tasks",sidebar_label:"Status"},sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,filter_status:["overdue","triggered","due_soon"]})]}}function Ra(i,a){let e=new Map;for(let l of i){let s=l.object.area_id||null;e.has(s)||e.set(s,[]),e.get(s).push(l)}let t=Array.from(e.keys()).filter(l=>l!==null);t.sort((l,s)=>{let c=a[l]?.name||l,m=a[s]?.name||s;return c.localeCompare(m)});let n=[];for(let l of t){let s=e.get(l);if(s.length===0)continue;let c=a[l];n.push({title:c?.name||l,icon:c?.icon||"mdi:floor-plan",path:`area-${l}`,type:"sections",sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:s.map(m=>m.object.name)})]})}let o=e.get(null);return o&&o.length>0&&n.push({title:"Unassigned",icon:"mdi:help-circle-outline",path:"unassigned",type:"sections",sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:o.map(l=>l.object.name)})]}),n}function Da(i){let a=new Set;for(let t of i)for(let n of t.tasks||[])n.status&&a.add(n.status);let e=[];for(let t of qa)a.has(t.status)&&e.push({title:t.title,icon:t.icon,path:t.path,type:"sections",sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,filter_status:[t.status]})]});return e}function Pa(i,a,e){let t=new Map;for(let s of i){let c=s.object.area_id,m=c&&a[c]?.floor_id||null;t.has(m)||t.set(m,[]),t.get(m).push(s)}let n=Array.from(t.keys()).filter(s=>s!==null);n.sort((s,c)=>{let m=e[s],f=e[c],h=m?.level??0,E=f?.level??0;return h!==E?h-E:(m?.name||s).localeCompare(f?.name||c)});let o=[];for(let s of n){let c=t.get(s);if(c.length===0)continue;let m=e[s];o.push({title:m?.name||s,icon:m?.icon||"mdi:home-floor-1",path:`floor-${s}`,type:"sections",sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:c.map(f=>f.object.name)})]})}let l=t.get(null);return l&&l.length>0&&o.push({title:"Other",icon:"mdi:help-circle-outline",path:"other",type:"sections",sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:l.map(s=>s.object.name)})]}),o}function Ma(i){return[{title:"Week",icon:"mdi:calendar-week",path:"cal-7",window_days:7},{title:"Fortnight",icon:"mdi:calendar-week-begin",path:"cal-14",window_days:14},{title:"Month",icon:"mdi:calendar-month",path:"cal-30",window_days:30},{title:"Year",icon:"mdi:calendar-clock",path:"cal-365",window_days:365}].map(e=>({title:e.title,icon:e.icon,path:e.path,type:"panel",cards:[{type:"custom:maintenance-supporter-calendar-card",window_days:e.window_days,show_window_chips:!1,show_user_filter:!0}]}))}function Fa(i){let a=new Set;for(let t of i)for(let n of t.tasks||[]){let o=n.days_until_due;o!=null&&Nt.forEach((l,s)=>{l.matches(o)&&a.add(s)})}let e=[];return Nt.forEach((t,n)=>{a.has(n)&&e.push({title:t.title,icon:t.icon,path:t.path,type:"sections",sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,...t.filter})]})}),e}var Me=class extends HTMLElement{static getCreateSuggestions(a){return{title:"Maintenance Supporter",icon:"mdi:wrench-clock"}}static async getConfigElement(){return document.createElement(Pe)}static async generate(a,e){if(e.config?.state===Sa)return{views:[{type:"sections",sections:[{cards:[{type:"starting"}]}]}]};if(e.config?.recovery_mode)return{views:[{type:"sections",sections:[{cards:[{type:"recovery-mode"}]}]}]};let t;try{t=await e.connection.sendMessagePromise({type:"maintenance_supporter/objects"})}catch{return{title:"Maintenance",views:[{title:"Maintenance",cards:[{type:"markdown",content:"**Maintenance Supporter** is not loaded. Install/enable the integration first."}]}]}}let n=t.objects||[];if(n.length===0)return{title:"Maintenance",views:[Ta()]};let o=Na(n),l=a?.group_by??"area",s={area:()=>Ra(n,e.areas||{}),status:()=>Da(n),floor:()=>Pa(n,e.areas||{},e.floors||{}),due_date:()=>Fa(n),calendar:()=>Ma(n)};return{title:"Maintenance",views:[Ia(o),...(s[l]??s.area)()]}}},Oa=[{value:"area",label:"By area (default)"},{value:"status",label:"By status (Overdue / Triggered / Due Soon / OK)"},{value:"floor",label:"By floor (uses HA floors)"},{value:"due_date",label:"By due date (Overdue / Today / Week / Month / Later)"},{value:"calendar",label:"Rolling calendar (Week / Fortnight / Month / Year)"}],Fe=class extends HTMLElement{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter"}}set hass(e){this._hass=e}setConfig(e){this._config=e,this._render()}connectedCallback(){this._render()}_render(){let e=this._config.group_by??"area",t=Oa.map(o=>`<option value="${o.value}"${o.value===e?" selected":""}>${o.label}</option>`).join("");this.innerHTML=`
      <style>
    ...
    `;let n=this.querySelector("#group-by");n?.addEventListener("change",()=>{let o={...this._config,group_by:n.value};this._config=o,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0}))})}},Rt="maintenance-supporter-section",Ct=`ll-strategy-section-${Rt}`,Oe=class extends HTMLElement{static async generate(a,e){let t={type:"custom:maintenance-supporter-card",show_header:!1};a?.filter_status?.length&&(t.filter_status=a.filter_status),a?.max_items&&(t.max_items=a.max_items),a?.filter_due_min_days!==void 0&&(t.filter_due_min_days=a.filter_due_min_days),a?.filter_due_max_days!==void 0&&(t.filter_due_max_days=a.filter_due_max_days);let n=a?.filter_objects;if(a?.area_id&&!n)try{n=((await e.connection.sendMessagePromise({type:"maintenance_supporter/objects"})).objects||[]).filter(s=>s.object.area_id===a.area_id).map(s=>s.object.name)}catch{}n&&n.length>0&&(t.filter_objects=n);let o=[];return a?.title&&o.push({type:"heading",heading:a.title,heading_style:"title"}),o.push(t),{type:"grid",cards:o}}};customElements.get($t)||customElements.define($t,Me);customElements.get(Pe)||customElements.define(Pe,Fe);customElements.get(Ct)||customElements.define(Ct,Oe);var Tt="_msSupporterLlCustomBound";function me(i){history.pushState(null,"",i),window.dispatchEvent(new CustomEvent("location-changed"))}function La(){let i=window;i[Tt]||(i[Tt]=!0,document.addEventListener("ll-custom",a=>{let e=a.detail;if(!e||typeof e.type!="string"||!e.type.startsWith("maintenance-supporter:"))return;let t=e.type.slice(22);if(t==="add-object"){if(Ce())return;me("/maintenance-supporter?ms_action=add_object");return}if(t==="open-task"&&typeof e.entry_id=="string"&&typeof e.task_id=="string"){if(Re(e.entry_id,e.task_id)||Te(e.entry_id,e.task_id))return;me(`/maintenance-supporter?entry_id=${encodeURIComponent(e.entry_id)}&task_id=${encodeURIComponent(e.task_id)}`);return}if(t==="open-object"&&typeof e.entry_id=="string"){if(De(e.entry_id))return;me(`/maintenance-supporter?entry_id=${encodeURIComponent(e.entry_id)}`);return}if(t==="edit-history"&&typeof e.entry_id=="string"&&typeof e.task_id=="string"&&typeof e.original_timestamp=="string"){let o=document.querySelector("home-assistant")?.hass;if(!o)return;(async()=>{try{let c=(await o.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:e.entry_id})).tasks?.find(m=>m.id===e.task_id)?.history?.find(m=>m.timestamp===e.original_timestamp);if(!c)return;Ie({entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.original_timestamp,type:c.type||"completed",timestamp:c.timestamp||e.original_timestamp,notes:c.notes??null,cost:c.cost??null,duration:c.duration??null,completed_by:c.completed_by??null})}catch{me("/maintenance-supporter")}})();return}}))}La();var he=window;he.customStrategies=he.customStrategies||[];function Dt(i){he.customStrategies.some(e=>e.type===i.type&&e.strategyType===i.strategyType)||he.customStrategies.push(i)}Dt({type:It,strategyType:"dashboard",name:"Maintenance Supporter",description:"Auto-generated dashboard. Group views by area, status, floor, or due date \u2014 picked from the strategy editor or YAML.",documentationURL:"https://github.com/iluebbe/maintenance_supporter#dashboard-strategy"});Dt({type:Rt,strategyType:"section",name:"Maintenance Supporter \u2014 Section",description:"Embed maintenance tasks (filterable by area, status, due date) as a section in any dashboard view.",documentationURL:"https://github.com/iluebbe/maintenance_supporter#section-strategy"});
