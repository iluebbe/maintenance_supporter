...
`});function tn(i,a){let e=en[i];if(!e)return i;let t=o(e,a);return t&&t!==e?t:i}function an(i){let e=i.match(/data\['([^']+)'\]/)?.[1],t;return(t=i.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=i.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=i.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=i.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(i)?{field:e,rule:"required"}:(t=i.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(i)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(i)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function k(i,a,e){if(typeof i=="string")return i;if(typeof i!="object"||i===null)return e;let t=i,n=t.message||t.error?.message||"";if(!n)return e;let r=an(n),c=r.field?tn(r.field,a):"",s=u=>o(u,a).replace("{field}",c).replace("{n}",r.param??"");switch(r.rule){case"too_long":return s("err_too_long");case"too_short":return s("err_too_short");case"value_too_high":return s("err_value_too_high");case"value_too_low":return s("err_value_too_low");case"required":return s("err_required");case"wrong_type":return s("err_wrong_type").replace("{type}",r.param??"");case"invalid_choice":return s("err_invalid_choice");case"invalid_value":return s("err_invalid_value");default:return n||e}}var en,M=b(()=>{"use strict";S();en={name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_for_minutes:"trigger_for_minutes"}});var q,Qe=b(()=>{"use strict";A();I();q=class extends y{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return d`
      <label class="field">
        ${this.label?d`<span class="label">${this.label}${this.required?d`<span class="req">*</span>`:p}</span>`:p}
        <input
          .value=${this.value??""}
          .type=${this.type}
        ...
        />
        ${this.helper?d`<span class="helper">${this.helper}</span>`:p}
      </label>
    `}};q.styles=w`
    :host { display: block; }
    .field {
  ...
  `,l([h()],q.prototype,"label",2),l([h()],q.prototype,"value",2),l([h()],q.prototype,"placeholder",2),l([h()],q.prototype,"type",2),l([h({type:Boolean})],q.prototype,"required",2),l([h({type:Boolean})],q.prototype,"disabled",2),l([h()],q.prototype,"step",2),l([h()],q.prototype,"min",2),l([h()],q.prototype,"max",2),l([h()],q.prototype,"pattern",2),l([h()],q.prototype,"helper",2);customElements.get("ms-textfield")||customElements.define("ms-textfield",q)});var j,Ot=b(()=>{"use strict";A();I();S();M();Qe();j=class extends y{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._error="";this._name="";this._manufacturer="";this._model="";this._serialNumber="";this._areaId="";this._installationDate="";this._documentationUrl="";this._notes="";this._entryId=null}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}openCreate(){this._entryId=null,this._name="",this._manufacturer="",this._model="",this._serialNumber="",this._areaId="",this._installationDate="",this._documentationUrl="",this._notes="",this._error="",this._open=!0}openEdit(e,t){this._entryId=e,this._name=t.name||"",this._manufacturer=t.manufacturer||"",this._model=t.model||"",this._serialNumber=t.serial_number||"",this._areaId=t.area_id||"",this._installationDate=t.installation_date||"",this._documentationUrl=t.documentation_url||"",this._notes=t.notes||"",this._error="",this._open=!0}async _save(){if(this._name.trim()){this._loading=!0,this._error="";try{this._entryId?await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/update",entry_id:this._entryId,name:this._name,manufacturer:this._manufacturer||null,model:this._model||null,serial_number:this._serialNumber||null,area_id:this._areaId||null,installation_date:this._installationDate||null,documentation_url:this._documentationUrl.trim()||null,notes:this._notes.trim()||null}):await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/create",name:this._name,manufacturer:this._manufacturer||null,model:this._model||null,serial_number:this._serialNumber||null,area_id:this._areaId||null,installation_date:this._installationDate||null,documentation_url:this._documentationUrl.trim()||null,notes:this._notes.trim()||null}),this._open=!1,this.dispatchEvent(new CustomEvent("object-saved"))}catch(e){this._error=k(e,this._lang,o("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}render(){if(!this._open)return d``;let e=this._lang,t=this._entryId?o("edit_object",e):o("new_object",e);return d`
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="dialog-actions">
          ...
          >
            ${this._loading?o("saving",this._lang):o("save",this._lang)}
          </ha-button>
        </div>
      </ha-dialog>
    `}};j.styles=w`
...
`),this._scheduleTime=t.schedule_time||"";let n=t.on_complete_action;if(n&&n.service){this._actionService=n.service;let s=n.target?.entity_id;this._actionTargetEntity=Array.isArray(s)?s[0]||"":s||"",this._actionData=n.data&&typeof n.data=="object"?{...n.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let r=t.quick_complete_defaults;this._qcNotes=r?.notes||"",this._qcCost=r?.cost!=null?String(r.cost):"",this._qcDuration=r?.duration!=null?String(r.duration):"",this._qcFeedback=r?.feedback||"";let c=t.adaptive_config||{};if(this._environmentalEntity=c.environmental_entity||"",this._environmentalAttribute=c.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,t.trigger_config){let s=t.trigger_config;this._triggerEntityId=s.entity_id||"",this._triggerEntityIds=s.entity_ids||(s.entity_id?[s.entity_id]:[]),this._triggerEntityLogic=s.entity_logic||"any",this._triggerAttribute=s.attribute||"",this._triggerType=s.type||"threshold",this._triggerAbove=s.trigger_above?.toString()||"",this._triggerBelow=s.trigger_below?.toString()||"",this._triggerForMinutes=s.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=s.trigger_target_value?.toString()||"",this._triggerDeltaMode=s.trigger_delta_mode||!1,this._triggerFromState=s.trigger_from_state||"",this._triggerToState=s.trigger_to_state||"",this._triggerTargetChanges=s.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=s.trigger_runtime_hours?.toString()||""}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._warningDays=String(this.defaultWarningDays),this._intervalAnchor="completion",this._notes="",this._documentationUrl="",this._customIcon="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._responsibleUserId=null,this._checklistText="",this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours=""}async _loadUsers(){this._userService||(this._userService=new qe(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format";return}let[t,n]=e.split("."),r=this._buildActionData(),c=this._actionTargetEntity.trim();if(c){let s=c.split(".")[0];if(s!==t&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(t)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${t}.* entities; entity "${c}" is in ${s}.* \u2014 pick a service that matches the entity domain (e.g. ${s}.${n})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTesting=!0,this._actionTestResult="",this._actionTestError="";try{let s=c?{entity_id:c}:void 0;await this.hass.callService(t,n,r,s),this._actionTestResult="ok"}catch(s){this._actionTestResult="error",this._actionTestError=String(s?.message??s).slice(0,240)}finally{this._actionTesting=!1,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,n]=e.split("."),r=this.hass?.services?.[t]?.[n]?.fields;return!r||Object.keys(r).length===0?null:Object.entries(r).map(([c,s])=>({name:c,required:!!s.required,selector:s.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return p;let t=this._serviceSchema();return d`
      <details class="ca-section">
        ...
        ${t?d`
            ...
            `:d`
              <ms-textfield
                label="${o("on_complete_action_data",e)}"
                placeholder="{}"
        ...
        <div class="ca-test-row">
          <button type="button" ?disabled=${this._actionTesting||!this._actionService}
            ...
            ${this._actionTesting?"\u2026":o("on_complete_action_test",e)}
          </button>
          ${this._actionTestResult==="ok"?d`<span class="ca-test-ok">${o("on_complete_action_test_success",e)}</span>`:p}
          ${this._actionTestResult==="error"?d`<div class="ca-test-error-block">
                <span class="ca-test-error">${o("on_complete_action_test_failed",e)}</span>
                ${this._actionTestError?d`<div class="ca-test-error-detail">${this._actionTestError}</div>`:p}
              </div>`:p}
        </div>
      </details>

      <details class="ca-section">
        <summary>${o("quick_complete_defaults_title",e)}</summary>
        <p class="field-help">${o("quick_complete_defaults_desc",e)}</p>
        <ms-textfield
          label="${o("quick_complete_defaults_notes",e)}"
          .value=${this._qcNotes}
          @input=${n=>{this._qcNotes=n.target.value}}
        ></ms-textfield>
        <ms-textfield
          label="${o("quick_complete_defaults_cost",e)}"
          type="number" min="0" step="0.01"
          .value=${this._qcCost}
          @input=${n=>{this._qcCost=n.target.value}}
        ></ms-textfield>
        <ms-textfield
          label="${o("quick_complete_defaults_duration",e)}"
        ...
        <select class="qc-feedback"
          ...
          <option value="">${o("quick_complete_defaults_feedback_none",e)}</option>
          <option value="needed">${o("quick_complete_defaults_feedback_needed",e)}</option>
          <option value="not_needed">${o("quick_complete_defaults_feedback_not_needed",e)}</option>
        </select>
      </details>
    `}async _loadTags(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tags/list"});this._availableTags=e.tags||[]}catch{this._availableTags=[]}}async _fetchEntityAttributes(e){if(!e||!this.hass){this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="";return}try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/entity/attributes",entity_id:e});this._entityDomain=t.domain||"",this._suggestedAttributes=t.suggested_attributes||[],this._availableAttributes=t.available_attributes||[]}catch{this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain=""}}async _save(){if(this._name.trim()){this._loading=!0,this._error="";try{let e={type:this._taskId?"maintenance_supporter/task/update":"maintenance_supporter/task/create",entry_id:this._entryId,name:this._name,task_type:this._type,schedule_type:this._scheduleType,warning_days:parseInt(this._warningDays,10)||7};if(this._taskId&&(e.task_id=this._taskId),this._scheduleType!=="manual"?this._intervalDays?(e.interval_days=parseInt(this._intervalDays,10),e.interval_anchor=this._intervalAnchor):this._taskId&&(e.interval_days=null,e.interval_anchor="completion"):this._taskId&&(e.interval_days=null,e.interval_anchor="completion"),e.notes=this._notes||null,e.documentation_url=this._documentationUrl||null,e.custom_icon=this._customIcon||null,e.enabled=this._enabled,e.last_performed=this._lastPerformed||null,e.nfc_tag_id=this._nfcTagId||null,e.responsible_user_id=this._responsibleUserId,this._scheduleType==="sensor_based"&&this._triggerEntityId){let c=this._triggerEntityIds.length>0?this._triggerEntityIds:[this._triggerEntityId],s={entity_id:c[0],entity_ids:c,type:this._triggerType};if(this._triggerAttribute&&(s.attribute=this._triggerAttribute),c.length>1&&(s.entity_logic=this._triggerEntityLogic),this._triggerType==="threshold"){if(this._triggerAbove){let u=parseFloat(this._triggerAbove);isNaN(u)||(s.trigger_above=u)}if(this._triggerBelow){let u=parseFloat(this._triggerBelow);isNaN(u)||(s.trigger_below=u)}if(this._triggerForMinutes){let u=parseInt(this._triggerForMinutes,10);isNaN(u)||(s.trigger_for_minutes=u)}}else if(this._triggerType==="counter"){if(this._triggerTargetValue){let u=parseFloat(this._triggerTargetValue);isNaN(u)||(s.trigger_target_value=u)}s.trigger_delta_mode=this._triggerDeltaMode}else if(this._triggerType==="state_change"){if(this._triggerFromState&&(s.trigger_from_state=this._triggerFromState),this._triggerToState&&(s.trigger_to_state=this._triggerToState),this._triggerTargetChanges){let u=parseInt(this._triggerTargetChanges,10);isNaN(u)||(s.trigger_target_changes=u)}}else if(this._triggerType==="runtime"&&this._triggerRuntimeHours){let u=parseFloat(this._triggerRuntimeHours);isNaN(u)||(s.trigger_runtime_hours=u)}e.trigger_config=s}else this._taskId&&(e.trigger_config=null);if(this.scheduleTimeEnabled&&this._scheduleType==="time_based"){let c=this._scheduleTime.trim();e.schedule_time=/^([01]\d|2[0-3]):[0-5]\d$/.test(c)?c:null}if(this.checklistsEnabled){let c=this._checklistText.split(`
`).map(s=>s.trim()).filter(Boolean).slice(0,100);e.checklist=c.length?c:null}if(this.completionActionsEnabled){let c=this._actionService.trim();if(c&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(c)){let v={service:c},f=this._actionTargetEntity.trim();f&&(v.target={entity_id:f});let x=this._buildActionData();Object.keys(x).length>0&&(v.data=x),e.on_complete_action=v}else e.on_complete_action=null;let s={};this._qcNotes.trim()&&(s.notes=this._qcNotes.trim());let u=parseFloat(this._qcCost);!isNaN(u)&&u>=0&&(s.cost=u);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(s.duration=g),this._qcFeedback&&(s.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(s).length?s:null}let t=await this.hass.connection.sendMessagePromise(e),n=this._taskId||t?.task_id,r=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(n&&this._scheduleType==="sensor_based"&&r)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=k(e,this._lang,o("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return p;let e=this._lang;return d`
      <h3>${o("trigger_configuration",e)}</h3>
      <ms-textfield
        label="${o("entity_id",e)} (${o("comma_separated",e)})"
        .value=${this._triggerEntityIds.length>0?this._triggerEntityIds.join(", "):this._triggerEntityId}
        @input=${t=>{let r=t.target.value.split(",").map(c=>c.trim()).filter(Boolean);this._triggerEntityId=r[0]||"",this._triggerEntityIds=r,r[0]&&this._fetchEntityAttributes(r[0])}}
      ></ms-textfield>
      ${this._triggerEntityIds.length>1?d`
        <div class="select-row">
          <label>${o("entity_logic",e)}</label>
          <select
            .value=${this._triggerEntityLogic}
            @change=${t=>this._triggerEntityLogic=t.target.value}
          >
            <option value="any" ?selected=${this._triggerEntityLogic==="any"}>${o("entity_logic_any",e)}</option>
            <option value="all" ?selected=${this._triggerEntityLogic==="all"}>${o("entity_logic_all",e)}</option>
          </select>
        </div>
      `:p}
      ${this._availableAttributes.length>0?d`
          <div class="select-row">
            <label>${o("attribute_optional",e)}</label>
            <select
              .value=${this._triggerAttribute}
              @change=${t=>this._triggerAttribute=t.target.value}
            >
              <option value="" ?selected=${!this._triggerAttribute}>${o("use_entity_state",e)}</option>
              ${this._suggestedAttributes.map(t=>d`<option value=${t} ?selected=${t===this._triggerAttribute}>${t} ★</option>`)}
              ${this._availableAttributes.filter(t=>!this._suggestedAttributes.includes(t.name)).map(t=>d`<option value=${t.name} ?selected=${t.name===this._triggerAttribute}>${t.name}${t.numeric?"":" (non-numeric)"}</option>`)}
            </select>
          </div>
        `:d`
          <ms-textfield
            label="${o("attribute_optional",e)}"
            .value=${this._triggerAttribute}
            @input=${t=>this._triggerAttribute=t.target.value}
          ></ms-textfield>
        `}
      <div class="select-row">
        <label>${o("trigger_type",e)}</label>
        <select
          .value=${this._triggerType}
          @change=${t=>this._triggerType=t.target.value}
        >
          ${rn.map(t=>d`<option value=${t} ?selected=${t===this._triggerType}>${o(t,e)}</option>`)}
        </select>
      </div>
      ${this._renderTriggerTypeFields()}
      <ms-textfield
        label="${o("safety_interval_days",e)}"
        type="number"
        .value=${this._intervalDays}
        @input=${t=>this._intervalDays=t.target.value}
      ></ms-textfield>
    `}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?d`
        <ms-textfield
          label="${o("trigger_above",e)}"
          type="number"
          step="any"
        ...
        ></ms-textfield>
        <ms-textfield
          label="${o("for_at_least_minutes",e)}"
          type="number"
          .value=${this._triggerForMinutes}
          @input=${t=>this._triggerForMinutes=t.target.value}
        ></ms-textfield>
      `:this._triggerType==="counter"?d`
        <ms-textfield
          label="${o("target_value",e)}"
          type="number"
          step="any"
      ...
      `:this._triggerType==="state_change"?d`
        <ms-textfield
          label="${o("from_state_optional",e)}"
          .value=${this._triggerFromState}
          @input=${t=>this._triggerFromState=t.target.value}
        ></ms-textfield>
        <div class="field-help">${o("state_value_help",e)}</div>
        <ms-textfield
          label="${o("to_state_optional",e)}"
          .value=${this._triggerToState}
          @input=${t=>this._triggerToState=t.target.value}
        ></ms-textfield>
        <ms-textfield
          label="${o("target_changes",e)}"
          type="number"
          min="1"
          .value=${this._triggerTargetChanges}
          @input=${t=>this._triggerTargetChanges=t.target.value}
        ></ms-textfield>
        <div class="field-help">${o("target_changes_help",e)}</div>
      `:this._triggerType==="runtime"?d`
        <ms-textfield
          label="${o("runtime_hours",e)}"
          type="number"
          step="1"
          .value=${this._triggerRuntimeHours}
          @input=${t=>this._triggerRuntimeHours=t.target.value}
        ></ms-textfield>
      `:p}render(){if(!this._open)return d``;let e=this._lang,t=this._taskId?o("edit_task",e):o("new_task",e);return d`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._error?d`<div class="error">${this._error}</div>`:p}
          ${this._objectChoices.length>0?d`
            <div class="select-row">
              <label>${o("object",e)}</label>
              <select
                .value=${this._entryId}
                @change=${n=>this._entryId=n.target.value}
              >
                ${this._objectChoices.map(n=>d`<option value=${n.entry_id} ?selected=${n.entry_id===this._entryId}>${n.name}</option>`)}
              </select>
            </div>
          `:p}
          <ms-textfield
          ...
          ></ms-textfield>
          <div class="select-row">
            <label>${o("maintenance_type",e)}</label>
            <select
              .value=${this._type}
              @change=${n=>this._type=n.target.value}
            >
              ${nn.map(n=>d`<option value=${n} ?selected=${n===this._type}>${o(n,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            <label>${o("schedule_type",e)}</label>
            <select
              .value=${this._scheduleType}
              @change=${n=>this._scheduleType=n.target.value}
            >
              ${on.map(n=>d`<option value=${n} ?selected=${n===this._scheduleType}>${o(n,e)}</option>`)}
            </select>
          </div>
          ${this._scheduleType==="time_based"?d`
                <ms-textfield
                  label="${o("interval_days",e)}"
                  type="number"
                  .value=${this._intervalDays}
                  @input=${n=>this._intervalDays=n.target.value}
                ></ms-textfield>
                <div class="select-row">
                  <label>${o("interval_anchor",e)}</label>
                  <select
                    .value=${this._intervalAnchor}
                    @change=${n=>this._intervalAnchor=n.target.value}
                  >
                    <option value="completion" ?selected=${this._intervalAnchor==="completion"}>${o("anchor_completion",e)}</option>
                    <option value="planned" ?selected=${this._intervalAnchor==="planned"}>${o("anchor_planned",e)}</option>
                  </select>
                </div>
                ${this.scheduleTimeEnabled?d`
                  <ms-textfield
                    label="${o("schedule_time_optional",e)}"
                    type="time"
                    .value=${this._scheduleTime}
                    helper="${o("schedule_time_help",e)}"
                    @input=${n=>this._scheduleTime=n.target.value}
                  ></ms-textfield>
                `:p}
              `:p}
          <ms-textfield
            label="${o("warning_days",e)}"
            type="number"
            .value=${this._warningDays}
            @input=${n=>this._warningDays=n.target.value}
          ></ms-textfield>
          ${this.checklistsEnabled?d`
            <h3>${o("checklist_steps_optional",e)}</h3>
            <textarea
              id="checklist-textarea"
              class="checklist-textarea"
              rows="5"
              placeholder="${o("checklist_placeholder",e)}"
              .value=${this._checklistText}
              @input=${n=>this._checklistText=n.target.value}
            ></textarea>
            <div class="field-help">${o("checklist_help",e)}</div>
          `:p}
          <ms-textfield
            label="${o("last_performed_optional",e)}"
            type="date"
            .value=${this._lastPerformed}
            @input=${n=>this._lastPerformed=n.target.value}
          ></ms-textfield>
          <div class="select-row">
            <label>${o("responsible_user",e)}</label>
            <select
              .value=${this._responsibleUserId||""}
              @change=${n=>{let r=n.target.value;this._responsibleUserId=r||null}}
            >
              <option value="" ?selected=${!this._responsibleUserId}>${o("no_user_assigned",e)}</option>
              ${this._availableUsers.map(n=>d`<option value=${n.id} ?selected=${n.id===this._responsibleUserId}>${n.name}</option>`)}
            </select>
          </div>
          ${this._renderTriggerFields()}
          ${this._scheduleType==="sensor_based"?d`
            <ms-textfield
              label="${o("environmental_entity_optional",e)}"
              helper="${o("environmental_entity_helper",e)}"
              .value=${this._environmentalEntity}
              @input=${n=>this._environmentalEntity=n.target.value.trim()}
            ></ms-textfield>
            ${this._environmentalEntity?d`
              <ms-textfield
                label="${o("environmental_attribute_optional",e)}"
          ...
          <ha-icon-picker
            .hass=${this.hass}
            label="${o("custom_icon_optional",e)}"
            .value=${this._customIcon}
            @value-changed=${n=>this._customIcon=n.detail.value||""}
          ></ha-icon-picker>
          ${this._availableTags.length>0?d`
              <div class="select-row">
                <label>${o("nfc_tag_id_optional",e)}</label>
                <select
                  .value=${this._nfcTagId}
                  @change=${n=>this._nfcTagId=n.target.value}
                >
                  <option value="" ?selected=${!this._nfcTagId}>${o("no_nfc_tag",e)}</option>
                  ${this._availableTags.map(n=>d`<option value=${n.id} ?selected=${n.id===this._nfcTagId}>${n.name}</option>`)}
                </select>
                <button type="button" class="link-button" @click=${this._loadTags}
                  title="${o("nfc_tags_refresh",e)}">↻</button>
              </div>
            `:d`
              <ms-textfield
                label="${o("nfc_tag_id_optional",e)}"
                .value=${this._nfcTagId}
                @input=${n=>this._nfcTagId=n.target.value}
              ></ms-textfield>
              <div class="field-help">
                ${o("nfc_tags_empty_help",e)}
                <a href="/config/tags">${o("nfc_tags_open_settings",e)}</a>
                ·
                <button type="button" class="link-button" @click=${this._loadTags}>
                  ${o("nfc_tags_refresh",e)}
                </button>
              </div>
            `}
        ...
        <div class="dialog-actions">
          <ha-button appearance="plain" @click=${this._close}>${o("cancel",e)}</ha-button>
          <ha-button
            @click=${this._save}
            .disabled=${this._loading||!this._name.trim()}
          >
            ${this._loading?o("saving",e):o("save",e)}
          </ha-button>
        </div>
      </ha-dialog>
    `}};m.styles=w`
  ...
  `,l([h({attribute:!1})],m.prototype,"hass",2),l([h({type:Boolean,attribute:"checklists-enabled"})],m.prototype,"checklistsEnabled",2),l([h({type:Boolean,attribute:"schedule-time-enabled"})],m.prototype,"scheduleTimeEnabled",2),l([h({type:Boolean,attribute:"completion-actions-enabled"})],m.prototype,"completionActionsEnabled",2),l([h({type:Number,attribute:"default-warning-days"})],m.prototype,"defaultWarningDays",2),l([_()],m.prototype,"_open",2),l([_()],m.prototype,"_loading",2),l([_()],m.prototype,"_error",2),l([_()],m.prototype,"_entryId",2),l([_()],m.prototype,"_taskId",2),l([_()],m.prototype,"_objectChoices",2),l([_()],m.prototype,"_name",2),l([_()],m.prototype,"_type",2),l([_()],m.prototype,"_scheduleType",2),l([_()],m.prototype,"_intervalDays",2),l([_()],m.prototype,"_warningDays",2),l([_()],m.prototype,"_intervalAnchor",2),l([_()],m.prototype,"_notes",2),l([_()],m.prototype,"_documentationUrl",2),l([_()],m.prototype,"_customIcon",2),l([_()],m.prototype,"_enabled",2),l([_()],m.prototype,"_triggerEntityId",2),l([_()],m.prototype,"_triggerEntityIds",2),l([_()],m.prototype,"_triggerEntityLogic",2),l([_()],m.prototype,"_triggerAttribute",2),l([_()],m.prototype,"_triggerType",2),l([_()],m.prototype,"_triggerAbove",2),l([_()],m.prototype,"_triggerBelow",2),l([_()],m.prototype,"_triggerForMinutes",2),l([_()],m.prototype,"_triggerTargetValue",2),l([_()],m.prototype,"_triggerDeltaMode",2),l([_()],m.prototype,"_triggerFromState",2),l([_()],m.prototype,"_triggerToState",2),l([_()],m.prototype,"_triggerTargetChanges",2),l([_()],m.prototype,"_triggerRuntimeHours",2),l([_()],m.prototype,"_suggestedAttributes",2),l([_()],m.prototype,"_availableAttributes",2),l([_()],m.prototype,"_entityDomain",2),l([_()],m.prototype,"_lastPerformed",2),l([_()],m.prototype,"_nfcTagId",2),l([_()],m.prototype,"_availableTags",2),l([_()],m.prototype,"_responsibleUserId",2),l([_()],m.prototype,"_availableUsers",2),l([_()],m.prototype,"_checklistText",2),l([_()],m.prototype,"_scheduleTime",2),l([_()],m.prototype,"_actionService",2),l([_()],m.prototype,"_actionTargetEntity",2),l([_()],m.prototype,"_actionData",2),l([_()],m.prototype,"_actionDataJsonFallback",2),l([_()],m.prototype,"_actionTesting",2),l([_()],m.prototype,"_actionTestResult",2),l([_()],m.prototype,"_actionTestError",2),l([_()],m.prototype,"_qcNotes",2),l([_()],m.prototype,"_qcCost",2),l([_()],m.prototype,"_qcDuration",2),l([_()],m.prototype,"_qcFeedback",2),l([_()],m.prototype,"_environmentalEntity",2),l([_()],m.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",m)});var E,Bt=b(()=>{"use strict";A();I();S();M();E=class extends y{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed"}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed")}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=k(e,this.lang,o("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return d``;let e=this.lang||this.hass?.language||"en";return d`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${o("complete_title",e)}${this.taskName}</div>
        <div class="content">
          ${this._error?d`<div class="error">${this._error}</div>`:p}
          ${this.checklist.length>0?d`
            <div class="checklist-section">
              <label class="checklist-label">${o("checklist",e)}</label>
              ${this.checklist.map((t,n)=>d`
  ...
  `,l([h({attribute:!1})],E.prototype,"hass",2),l([h()],E.prototype,"entryId",2),l([h()],E.prototype,"taskId",2),l([h()],E.prototype,"taskName",2),l([h()],E.prototype,"lang",2),l([h({type:Array})],E.prototype,"checklist",2),l([h({type:Boolean})],E.prototype,"adaptiveEnabled",2),l([_()],E.prototype,"_open",2),l([_()],E.prototype,"_notes",2),l([_()],E.prototype,"_cost",2),l([_()],E.prototype,"_duration",2),l([_()],E.prototype,"_loading",2),l([_()],E.prototype,"_error",2),l([_()],E.prototype,"_checklistState",2),l([_()],E.prototype,"_feedback",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",E)});var V,Wt=b(()=>{"use strict";A();I();S();M();V=class extends y{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null}get _lang(){return this.hass?.language||"en"}openEdit(e){this._draft={...e},this._originalSnapshot={...e},this._error="",this._open=!0}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null}_set(e,t){this._draft&&(this._draft={...this._draft,[e]:t})}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{let e={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(e.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(e.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(e.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(e.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(e.completed_by=this._draft.completed_by),Object.keys(e).filter(n=>!["type","entry_id","task_id","original_timestamp"].includes(n)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(e),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=k(e,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return p;let e=this._lang,t=this._draft;return d`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        <h2>${o("history_edit_title",e)||"Edit history entry"}</h2>
        <div class="entry-type">
          <ha-icon icon="mdi:tag-outline"></ha-icon>
          <span>${o(t.type,e)||t.type}</span>
        </div>
        <label>
          <span>${o("history_edit_timestamp",e)||"Timestamp"}</span>
        ...
        <div class="actions">
          ...
          <button class="save" @click=${this._save} ?disabled=${this._saving}>
            ${this._saving?o("saving",e)||"Saving\u2026":o("save",e)||"Save"}
          </button>
        </div>
      </div>
    `}};V.styles=w`
...
<div class="qr-row">
  <div class="qr-col">
    <img src="${Gt(this._viewResult.svg_data_uri)}" alt="QR Info" />
    <div class="qr-label">${v}</div>
  </div>
  ${g?`<div class="qr-col">
    <img src="${Gt(this._completeResult.svg_data_uri)}" alt="QR Complete" />
    <div class="qr-label">${f}</div>
  </div>`:""}
</div>
<div class="url">${re(this._viewResult.url)}</div>
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),r.document.close()}_downloadSvg(e,t){let n=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),r=new Blob([n],{type:"image/svg+xml"}),c=URL.createObjectURL(r),s=document.createElement("a");s.href=c;let u=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;s.download=`qr-${sn(u)}-${t}.svg`,s.click(),URL.revokeObjectURL(c)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return d``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${o("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${o("qr_code",e)}: ${this._objectName}`,n=!!this._viewResult;return d`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._loading?d`<div class="loading">${o("qr_generating",e)}</div>`:this._error?d`<div class="error">${this._error}</div>`:n?d`
                    <div class="qr-pair">
                      <div class="qr-item">
                        <img
                          ...
                          alt="QR Info"
                        />
                        <div class="qr-item-label">${o("qr_action_view",e)}</div>
                        <button class="dl-btn"
                      ...
                      ${this._completeResult?d`
                            <div class="qr-item">
                              <img
                                ...
                                alt="QR Complete"
                              />
                              <div class="qr-item-label">${o("qr_action_complete",e)}</div>
                              <button class="dl-btn"
          ...
          <div class="action-row">
            <label>${o("qr_url_mode",e)}</label>
            <div class="action-toggle">
              <button class="toggle-btn ${this._urlMode==="companion"?"active":""}"
                @click=${()=>this._setUrlMode("companion")}>${o("qr_mode_companion",e)}</button>
              <button class="toggle-btn ${this._urlMode==="local"?"active":""}"
                @click=${()=>this._setUrlMode("local")}>${o("qr_mode_local",e)}</button>
              <button class="toggle-btn ${this._urlMode==="server"?"active":""}"
                @click=${()=>this._setUrlMode("server")}>${o("qr_mode_server",e)}</button>
            </div>
          </div>
        </div>
        <div class="dialog-actions">
  ...
  `,l([h({attribute:!1})],D.prototype,"hass",2),l([h()],D.prototype,"lang",2),l([_()],D.prototype,"_open",2),l([_()],D.prototype,"_loading",2),l([_()],D.prototype,"_error",2),l([_()],D.prototype,"_viewResult",2),l([_()],D.prototype,"_completeResult",2),l([_()],D.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",D)});function Qt(i,a){let e=i.interval_analysis,t=e?.weibull_beta,n=e?.weibull_eta;if(t==null||n==null||n<=0)return p;let r=i.interval_days??0,c=i.suggested_interval??r;return d`
    <div class="weibull-section">
      <div class="weibull-title">
        <ha-svg-icon aria-hidden="true" path="M3,14L3.5,14.07L8.07,9.5C7.89,8.85 8.06,8.11 8.59,7.59C9.37,6.8 10.63,6.8 11.41,7.59C11.94,8.11 12.11,8.85 11.93,9.5L14.5,12.07L15,12C15.18,12 15.35,12 15.5,12.07L19.07,8.5C19,8.35 19,8.18 19,8A2,2 0 0,1 21,6A2,2 0 0,1 23,8A2,2 0 0,1 21,10C20.82,10 20.65,10 20.5,9.93L16.93,13.5C17,13.65 17,13.82 17,14A2,2 0 0,1 15,16A2,2 0 0,1 13,14L13.07,13.5L10.5,10.93C10.18,11 9.82,11 9.5,10.93L4.93,15.5L5,16A2,2 0 0,1 3,18A2,2 0 0,1 1,16A2,2 0 0,1 3,14Z"></ha-svg-icon>
        ${o("weibull_reliability_curve",a)}
        ${ln(t,a)}
      </div>
      ${cn(t,n,r,c,a)}
      ${dn(e,a)}
      ${e?.confidence_interval_low!=null?_n(e,i,a):p}
    </div>
  `}function ln(i,a){let e,t,n;return i<.8?(e="early_failures",t="M13,14H11V10H13M13,18H11V16H13M1,21H23L12,2L1,21Z",n="beta_early_failures"):i<=1.2?(e="random_failures",t="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M13,17H11V15H13V17M13,13H11V7H13V13Z",n="beta_random_failures"):i<=3.5?(e="wear_out",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M12,6A6,6 0 0,1 18,12H12V6Z",n="beta_wear_out"):(e="highly_predictable",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M11,16.5L18,9.5L16.59,8.09L11,13.67L7.91,10.59L6.5,12L11,16.5Z",n="beta_highly_predictable"),d`
    <span class="beta-badge ${e}">
      <ha-svg-icon path="${t}"></ha-svg-icon>
      ${o(n,a)} (\u03B2=${i.toFixed(2)})
    </span>
  `}function cn(i,a,e,t,n){let z=Math.max(e,t,a,1)*1.3,C=50,O=[];for(let P=0;P<=C;P++){let L=P/C*z,wa=1-Math.exp(-Math.pow(L/a,i)),xa=32+L/z*260,za=136-wa*128;O.push([xa,za])}let be=O.map(([P,L])=>`${P.toFixed(1)},${L.toFixed(1)}`).join(" "),Ie="M32,136 "+O.map(([P,L])=>`L${P.toFixed(1)},${L.toFixed(1)}`).join(" ")+` L${O[C][0].toFixed(1)},136 Z`,ee=32+e/z*260,ye=1-Math.exp(-Math.pow(e/a,i)),ke=136-ye*128,ya=((1-ye)*100).toFixed(0),lt=32+t/z*260,ka=[0,.25,.5,.75,1];return d`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${o("chart_weibull",n)}">
        ${ka.map(P=>{let L=136-P*128;return ne`
            <line x1="${32}" y1="${L.toFixed(1)}" x2="${292}" y2="${L.toFixed(1)}"
              stroke="var(--divider-color)" stroke-width="0.5" stroke-dasharray="${P===.5?"4,3":p}" />
        ...
        <text x="${324/2}" y="${156}" fill="var(--secondary-text-color)" font-size="8" text-anchor="middle">${Math.round(z/2)}</text>
        <text x="${292}" y="${156}" fill="var(--secondary-text-color)" font-size="8" text-anchor="middle">${Math.round(z)}</text>

        <path d="${Ie}" fill="var(--primary-color, #03a9f4)" opacity="0.08" />
        <polyline points="${be}" fill="none"
          stroke="var(--primary-color, #03a9f4)" stroke-width="2" />

        ${e>0?ne`
          <line x1="${ee.toFixed(1)}" y1="${8}" x2="${ee.toFixed(1)}" y2="${136 .toFixed(1)}"
            stroke="var(--primary-color, #03a9f4)" stroke-width="1.5" stroke-dasharray="4,3" />
          <circle cx="${ee.toFixed(1)}" cy="${ke.toFixed(1)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${(ee+4).toFixed(1)}" y="${(ke-6).toFixed(1)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${ya}%</text>
        `:p}

        ${t>0&&t!==e?ne`
          <line x1="${lt.toFixed(1)}" y1="${8}" x2="${lt.toFixed(1)}" y2="${136 .toFixed(1)}"
    ...
    <div class="chart-legend">
      <span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4)"></span> ${o("weibull_failure_probability",n)}</span>
      ${e>0?d`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4); opacity:0.5"></span> ${o("current_interval_marker",n)}</span>`:p}
      ${t>0&&t!==e?d`<span class="legend-item"><span class="legend-swatch" style="background:var(--success-color, #4caf50)"></span> ${o("recommended_marker",n)}</span>`:p}
    </div>
  `}function dn(i,a){return d`
    <div class="weibull-info-row">
      <div class="weibull-info-item">
        <span>${o("characteristic_life",a)}</span>
        <span class="weibull-info-value">${Math.round(i.weibull_eta)} ${o("days",a)}</span>
      </div>
      ${i.weibull_r_squared!=null?d`
        <div class="weibull-info-item">
          <span>${o("weibull_r_squared",a)}</span>
          <span class="weibull-info-value">${i.weibull_r_squared.toFixed(3)}</span>
        </div>
      `:p}
    </div>
  `}function _n(i,a,e){let t=i.confidence_interval_low,n=i.confidence_interval_high,r=a.suggested_interval??a.interval_days??0,c=a.interval_days??0,s=Math.max(0,t-5),g=n+5-s,v=(t-s)/g*100,f=(n-t)/g*100,x=(r-s)/g*100,z=c>0?(c-s)/g*100:-1;return d`
    <div class="confidence-range">
      <div class="confidence-range-title">
        ${o("confidence_interval",e)}: ${r} ${o("days",e)} (${t}\u2013${n})
      </div>
      <div class="confidence-bar">
        <div class="confidence-fill" style="left:${v.toFixed(1)}%;width:${f.toFixed(1)}%"></div>
        ${z>=0?d`<div class="confidence-marker current" style="left:${z.toFixed(1)}%"></div>`:p}
        <div class="confidence-marker recommended" style="left:${x.toFixed(1)}%"></div>
      </div>
      <div class="confidence-labels">
        <span class="confidence-text low">${o("confidence_conservative",e)} (${t}${o("days",e).charAt(0)})</span>
        <span class="confidence-text high">${o("confidence_aggressive",e)} (${n}${o("days",e).charAt(0)})</span>
      </div>
    </div>
  `}var Zt=b(()=>{"use strict";A();S()});function Jt(i,a,e){let t=i.degradation_trend!=null&&i.degradation_trend!=="insufficient_data",n=i.days_until_threshold!=null,r=i.environmental_factor!=null&&i.environmental_factor!==1;if(!t&&!n&&!r)return p;let c=i.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":i.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return d`
    <div class="prediction-section">
      ${i.sensor_prediction_urgency?d`
        <div class="prediction-urgency-banner">
          <ha-svg-icon path="M1,21H23L12,2L1,21M12,18A1,1 0 0,1 11,17A1,1 0 0,1 12,16A1,1 0 0,1 13,17A1,1 0 0,1 12,18M13,15H11V10H13V15Z"></ha-svg-icon>
          ${o("sensor_prediction_urgency",a).replace("{days}",String(Math.round(i.days_until_threshold||0)))}
        </div>
      `:p}
      <div class="prediction-title">
        <ha-svg-icon path="M2,2V4H7V2H2M22,2V4H13V2H22M7,7V9H2V7H7M22,7V9H13V7H22M7,12V14H2V12H7M22,12V14H13V12H22M7,17V19H2V17H7M22,17V19H13V17H22M9,2V19L12,22L15,19V2H9M11,4H13V17.17L12,18.17L11,17.17V4Z"></ha-svg-icon>
        ${o("sensor_prediction",a)}
      </div>
      <div class="prediction-grid">
        ${t?d`
          <div class="prediction-item">
            <ha-svg-icon path="${c}"></ha-svg-icon>
            <span class="prediction-label">${o("degradation_trend",a)}</span>
            <span class="prediction-value ${i.degradation_trend}">${o("trend_"+i.degradation_trend,a)}</span>
            ${i.degradation_rate!=null?d`<span class="prediction-rate">${i.degradation_rate>0?"+":""}${Math.abs(i.degradation_rate)>=10?Math.round(i.degradation_rate).toLocaleString():i.degradation_rate.toFixed(1)} ${i.trigger_entity_info?.unit_of_measurement||""}/${o("day_short",a)}</span>`:p}
          </div>
        `:p}
        ${n?d`
          <div class="prediction-item">
            <ha-svg-icon path="M12,20A7,7 0 0,1 5,13A7,7 0 0,1 12,6A7,7 0 0,1 19,13A7,7 0 0,1 12,20M12,4A9,9 0 0,0 3,13A9,9 0 0,0 12,22A9,9 0 0,0 21,13A9,9 0 0,0 12,4M12.5,8H11V14L15.75,16.85L16.5,15.62L12.5,13.25V8M7.88,3.39L6.6,1.86L2,5.71L3.29,7.24L7.88,3.39M22,5.72L17.4,1.86L16.11,3.39L20.71,7.25L22,5.72Z"></ha-svg-icon>
            <span class="prediction-label">${o("days_until_threshold",a)}</span>
            <span class="prediction-value prediction-days${i.days_until_threshold===0?" exceeded":i.sensor_prediction_urgency?" urgent":""}">${i.days_until_threshold===0?o("threshold_exceeded",a):"~"+Math.round(i.days_until_threshold)+" "+o("days",a)}</span>
            ${i.threshold_prediction_date?d`<span class="prediction-date">${he(i.threshold_prediction_date,a)}</span>`:p}
            ${i.threshold_prediction_confidence?d`<span class="confidence-dot ${i.threshold_prediction_confidence}"></span>`:p}
          </div>
        `:p}
        ${r&&e.environmental?d`
          <div class="prediction-item">
            <ha-svg-icon path="M15,13V5A3,3 0 0,0 12,2A3,3 0 0,0 9,5V13A5,5 0 0,0 7,17A5,5 0 0,0 12,22A5,5 0 0,0 17,17A5,5 0 0,0 15,13M12,4A1,1 0 0,1 13,5V8H11V5A1,1 0 0,1 12,4Z"></ha-svg-icon>
            <span class="prediction-label">${o("environmental_adjustment",a)}</span>
            <span class="prediction-value">${i.environmental_factor.toFixed(2)}x</span>
            ${i.environmental_entity?d`<span class="prediction-entity entity-link" @click=${s=>Ft(s,i.environmental_entity)}>${i.environmental_entity}</span>`:p}
          </div>
        `:p}
      </div>
    </div>
  `}var Yt=b(()=>{"use strict";A();S()});function Xt(i,a,e,t){let n=Math.max(i||1,a);return d`
    <div class="interval-comparison">
      <div class="interval-bar">
        <div class="interval-label">
          ${o("current",t)}: ${i??"\u2014"} ${i!=null?o("days",t):""}
        </div>
        <div class="interval-visual current"
          style="width: ${i!=null?Math.min(i/n*100,100):0}%"></div>
      </div>
      <div class="interval-bar">
        <div class="interval-label">
          ${o("recommended",t)}: ${a} ${o("days",t)}
          <span class="confidence-badge ${e}">${o(`confidence_${e}`,t)}</span>
        </div>
        <div class="interval-visual suggested"
          style="width: ${Math.min(a/n*100,100)}%"></div>
      </div>
    </div>
  `}var ea=b(()=>{"use strict";A();S()});function aa(i,a,e){if(!e.seasonal||!i.seasonal_factor||i.seasonal_factor===1)return p;let t=ta.map(s=>o(s,a)),n=new Date().getMonth(),r=i.seasonal_factors||i.interval_analysis?.seasonal_factors||null,c=r&&r.length===12?r:t.map((s,u)=>{let g=i.seasonal_factor||1,v=Math.sin((u-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,g+v))});return d`
    <div class="seasonal-card-compact">
      <h4>${o("seasonal_awareness",a)}</h4>
      <div class="seasonal-mini-chart">
        ${c.map((s,u)=>{let g=s*40,v=s<.9?"low":s>1.1?"high":"normal";return d`
            <div class="seasonal-bar ${v} ${u===n?"current":""}"
                 style="height: ${g}px"
                 title="${t[u]}: ${s.toFixed(2)}x">
            </div>
          `})}
      </div>
      <div class="seasonal-legend">
        <span class="legend-item"><span class="dot low"></span> ${o("shorter",a)||"K\xFCrzer"}</span>
        <span class="legend-item"><span class="dot normal"></span> ${o("normal",a)||"Normal"}</span>
        <span class="legend-item"><span class="dot high"></span> ${o("longer",a)||"L\xE4nger"}</span>
      </div>
    </div>
  `}function na(i,a){return un(i,a)}function un(i,a){let e=i.seasonal_factors??i.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return p;let t=i.interval_analysis?.seasonal_reason,n=new Date().getMonth(),r=300,c=100,s=8,g=c-s-4,v=Math.max(...e,1.5),f=r/12,x=f*.65,z=s+g-1/v*g;return d`
    <div class="seasonal-chart">
      <div class="seasonal-chart-title">
        <ha-svg-icon aria-hidden="true" path="M17.75 4.09L15.22 6.03L16.13 9.09L13.5 7.28L10.87 9.09L11.78 6.03L9.25 4.09L12.44 4L13.5 1L14.56 4L17.75 4.09M21.25 11L19.61 12.25L20.2 14.23L18.5 13.06L16.8 14.23L17.39 12.25L15.75 11L17.81 10.95L18.5 9L19.19 10.95L21.25 11M18.97 15.95C19.8 15.87 20.69 17.05 20.16 17.8C19.84 18.25 19.5 18.67 19.08 19.07C15.17 23 8.84 23 4.94 19.07C1.03 15.17 1.03 8.83 4.94 4.93C5.34 4.53 5.76 4.17 6.21 3.85C6.96 3.32 8.14 4.21 8.06 5.04C7.79 7.9 8.75 10.87 10.95 13.06C13.14 15.26 16.1 16.22 18.97 15.95Z"></ha-svg-icon>
        ${o("seasonal_chart_title",a)}
        ${t?d`<span class="source-tag">${t==="learned"?o("seasonal_learned",a):o("seasonal_manual",a)}</span>`:p}
      </div>
      <svg viewBox="0 0 ${r} ${c}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${o("chart_seasonal",a)}">
        <line x1="0" y1="${z.toFixed(1)}" x2="${r}" y2="${z.toFixed(1)}"
          stroke="var(--divider-color)" stroke-width="1" stroke-dasharray="4,3" />
        ${e.map((C,O)=>{let be=C/v*g,Ie=O*f+(f-x)/2,ee=s+g-be,ye=O===n,ke=C<1?"var(--success-color, #4caf50)":C>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return ne`
            <rect x="${Ie.toFixed(1)}" y="${ee.toFixed(1)}"
              width="${x.toFixed(1)}" height="${be.toFixed(1)}"
              fill="${ke}" opacity="${ye?1:.5}" rx="2" />
          `})}
      </svg>
      <div class="seasonal-labels">
        ${ta.map((C,O)=>d`<span class="seasonal-label ${O===n?"active-month":""}">${o(C,a)}</span>`)}
      </div>
    </div>
  `}var ta,ia=b(()=>{"use strict";A();S();ta=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var $,oa=b(()=>{"use strict";A();I();S();M();Zt();Yt();ea();ia();$=class extends y{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1}get _lang(){return this.hass?.language||"en"}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(n=>n.id===this._taskId);this._task=t??null}catch(e){this._error=k(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=k(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(F(),B)).then(({openCompleteDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(F(),B)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(F(),B)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=o("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=o("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${o("reanalyze_result",this._lang)||"Recomputed"}: ${e.recommended_interval}d (${e.data_points} pts)`:o("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=k(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){!this._entryId||!this._taskId||Promise.resolve().then(()=>(F(),B)).then(({openHistoryEditDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null})})}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return p;let t=this._lang;return d`
      <div class="recommendation-card">
        <h4>${o("suggested_interval",t)}</h4>
        ${Xt(e.interval_days,e.suggested_interval,e.interval_confidence||"medium",t)}
        <div class="recommendation-actions">
          <button class="btn primary"
            @click=${this._applySuggestion} ?disabled=${this._busy}>
            <ha-icon icon="mdi:check"></ha-icon>
            ${o("apply_suggestion",t)}
          </button>
          <button class="btn"
    ...
    `}_renderAdaptive(e){let t=this._lang,n=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,r=e.degradation_trend!=null&&e.degradation_trend!=="insufficient_data"||e.days_until_threshold!=null||e.environmental_factor!=null&&e.environmental_factor!==1,c=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,s=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1;return!n&&!r&&!c&&!s?d`<div class="adaptive-empty">
        ${o("adaptive_no_data",t)||"Not enough completion history yet for adaptive analysis."}
      </div>`:d`
      <div class="adaptive-stack">
        ${this._toast?d`<div class="toast">${this._toast}</div>`:p}
        ${n?this._renderRecommendation(e):p}
        ${r?Jt(e,t,this._features):p}
        ${c?Qt(e,t):p}
        ${s?d`
          ${aa(e,t,this._features)}
          ${e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12?na(e,t):p}
        `:p}
      </div>
    `}_renderDetails(e){let t=this._lang,n=e.history||[],r=n.filter(u=>u.type==="completed"),c=r.reduce((u,g)=>u+(typeof g.cost=="number"?g.cost:0),0),s=(()=>{let u=r.map(g=>typeof g.duration=="number"?g.duration:null).filter(g=>g!=null);return u.length?Math.round(u.reduce((g,v)=>g+v,0)/u.length):null})();return d`
      <div class="details">
        <div class="stats-grid">
          <div class="stat">
            <span class="stat-label">${o("times_performed",t)||"Performed"}</span>
            <span class="stat-value">${r.length}</span>
          </div>
          <div class="stat">
            <span class="stat-label">${o("total_cost",t)||"Total cost"}</span>
            <span class="stat-value">${c.toFixed(2)}</span>
          </div>
          <div class="stat">
            <span class="stat-label">${o("avg_duration",t)||"Avg duration"}</span>
            <span class="stat-value">${s!=null?`${s}m`:"\u2014"}</span>
          </div>
        </div>
        <div class="history-header">
          <strong>${o("history",t)||"History"}</strong>
          <span class="history-count">${n.length}</span>
        </div>
        ${n.length===0?d`<div class="history-empty">${o("history_empty",t)||"No history yet."}</div>`:d`
              <div class="history-list">
                ${[...n].reverse().slice(0,20).map(u=>{let g=["completed","reset","skipped"].includes(u.type);return d`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${u.type}">${o(u.type,t)}</span>
                        <span class="history-date">${Mt(u.timestamp,t)}</span>
                        ${g?d`<button class="history-edit"
                                   title="${o("history_edit_button",t)||"Edit"}"
                                   @click=${()=>this._onEditHistoryEntry(u)}>
                              <ha-icon icon="mdi:pencil"></ha-icon>
                            </button>`:p}
                      </div>
                      ${u.notes?d`<div class="history-notes">${u.notes}</div>`:p}
                      ${u.cost!=null||u.duration!=null?d`<div class="history-meta">
                            ${u.cost!=null?d`<span>💰 ${u.cost.toFixed(2)}</span>`:p}
                            ${u.duration!=null?d`<span>⏱️ ${u.duration}m</span>`:p}
                          </div>`:p}
                    </div>
                  `})}
                ${n.length>20?d`<div class="history-more">… +${n.length-20} ${o("older_entries",t)||"older"}</div>`:p}
              </div>
            `}
      </div>
    `}render(){if(!this._open)return p;let e=this._lang,t=this._task,n=this.hass?.user?.is_admin??!0;return d`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?d`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&Promise.resolve().then(()=>(F(),B)).then(({openObjectQuickActions:r})=>{r(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${t.next_due?d`<span><strong>${o("next_due",e)||"Next due"}:</strong> ${he(t.next_due,e)}</span>`:p}
                  ${t.last_performed?d`<span><strong>${o("last_performed",e)||"Last"}:</strong> ${he(t.last_performed,e)}</span>`:p}
                  ${t.interval_days!=null?d`<span><strong>${o("interval",e)||"Interval"}:</strong> ${t.interval_days}d</span>`:p}
                </div>
              </div>
              ...
              ${this._showSkip?d`
                    <div class="inline-form">
                      <label>${o("skip_reason",e)||"Skip reason (optional)"}</label>
                  ...
                  `:this._showReset?d`
                    <div class="inline-form">
                      <label>${o("reset_to_date",e)||"Reset last_performed to"}</label>
                  ...
                  `:d`
                    ...
                    <div class="details-toggle">
                      <button class="link" @click=${()=>{this._showDetails=!this._showDetails}}>
                        ...
                        ${this._showDetails?o("hide_details",e)||"Hide details":o("show_details",e)||"Show history + stats"}
                      </button>
                      ${this._features.adaptive||this._features.seasonal||this._features.environmental?d`<button class="link" @click=${()=>{this._showAdaptive=!this._showAdaptive}}>
                            <ha-icon icon="${this._showAdaptive?"mdi:chart-line":"mdi:chart-line-variant"}"></ha-icon>
                            ${this._showAdaptive?o("hide_stats",e)||"Hide stats":o("show_stats",e)||"Show stats + graphs"}
                          </button>`:p}
                    </div>
                    ...
                    <div class="footer">
                      <button class="link" @click=${this._onOpenInPanel}>
                        ...
                        ${o("open_in_panel",e)||"Open in Maintenance panel"}
                      </button>
                    </div>
                  `}
            `:d`<div class="loading">${o("loading",e)||"Loading\u2026"}</div>`}
      </div>
    `}};$.styles=[Ht,w`
    :host { display: contents; }
    .backdrop {
  ...
  `],l([h({attribute:!1})],$.prototype,"hass",2),l([_()],$.prototype,"_open",2),l([_()],$.prototype,"_entryId",2),l([_()],$.prototype,"_taskId",2),l([_()],$.prototype,"_task",2),l([_()],$.prototype,"_objectName",2),l([_()],$.prototype,"_busy",2),l([_()],$.prototype,"_error",2),l([_()],$.prototype,"_showSkip",2),l([_()],$.prototype,"_showReset",2),l([_()],$.prototype,"_showDetails",2),l([_()],$.prototype,"_showAdaptive",2),l([_()],$.prototype,"_skipReason",2),l([_()],$.prototype,"_resetDate",2),l([_()],$.prototype,"_features",2),l([_()],$.prototype,"_toast",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",$)});var H,ra=b(()=>{"use strict";A();I();S();M();H=class extends y{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return this.hass?.language||"en"}async openFor(e){this._entryId=e,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=e}catch(e){this._error=k(e,this._lang)}}_onEditObject(){!this._entryId||!this._data||Promise.resolve().then(()=>(F(),B)).then(({openEditObjectDialog:e})=>{e(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&Promise.resolve().then(()=>(F(),B)).then(({openCreateTaskDialog:e})=>{e(),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let e=o("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(e)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=k(t,this._lang)}finally{this._busy=!1}}}_onTaskClick(e){this._entryId&&Promise.resolve().then(()=>(F(),B)).then(({openTaskQuickActions:t})=>{t(this._entryId,e)})}render(){if(!this._open)return p;let e=this._lang,t=this._data,n=t?.object,r=t?.tasks||[],c=this.hass?.user?.is_admin??!0;return d`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${t&&n?d`
              <div class="header">
              ...
              <div class="tasks-section">
                <div class="section-header">
                  <strong>${o("tasks",e)||"Tasks"}</strong>
                  <span class="count">${r.length}</span>
                </div>
                ${r.length===0?d`<div class="empty">${o("no_tasks",e)||"No tasks yet."}</div>`:d`
                      <div class="task-list">
                        ${r.map(s=>d`
                          <div class="task-row" @click=${()=>this._onTaskClick(s.id)}>
                            <span class="status-dot" style="background: ${Se[s.status]||"#ccc"}"></span>
                            <span class="task-name">${s.name}</span>
                            <span class="task-status">${o(s.status||"ok",e)}</span>
                          </div>
                        `)}
                      </div>
                    `}
    ...
    `}_renderMetaRow(e){let t=this._lang,n=[];return e.area_id&&n.push([o("area",t)||"Area",e.area_id]),e.manufacturer&&n.push([o("manufacturer",t)||"Manufacturer",e.manufacturer]),e.model&&n.push([o("model",t)||"Model",e.model]),e.serial_number&&n.push([o("serial_number",t)||"Serial",e.serial_number]),e.installation_date&&n.push([o("installation_date",t)||"Installed",e.installation_date]),e.documentation_url&&n.push([o("documentation_url",t)||"Docs",e.documentation_url]),n.length===0?p:d`
      <div class="meta">
        ${n.map(([r,c])=>d`
            <div class="meta-item">
              <span class="meta-label">${r}</span>
              <span class="meta-value">${r.toLowerCase().includes("doc")||r.toLowerCase().includes("url")?d`<a href="${c}" target="_blank" rel="noopener">${c}</a>`:c}</span>
            </div>
          `)}
      </div>
    `}};H.styles=w`
  ...
  `,l([h({attribute:!1})],H.prototype,"hass",2),l([_()],H.prototype,"_open",2),l([_()],H.prototype,"_entryId",2),l([_()],H.prototype,"_data",2),l([_()],H.prototype,"_busy",2),l([_()],H.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",H)});var B={};Ea(B,{openCompleteDialog:()=>yn,openCreateObjectDialog:()=>Ze,openCreateTaskDialog:()=>bn,openEditObjectDialog:()=>vn,openEditTaskDialog:()=>Je,openHistoryEditDialog:()=>Ye,openObjectQuickActions:()=>et,openQrDialog:()=>kn,openTaskQuickActions:()=>Xe});function Te(){return document.querySelector("home-assistant")?.hass}function W(i){let a=document.body.querySelector(i);return a||(a=document.createElement(i),document.body.appendChild(a)),a}function G(i){let a=Te();return a?(i.hass=a,!0):!1}function da(i){return Ce||(Ce=i.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(a=>({features:a.features??sa.features,defaultWarningDays:a.general?.default_warning_days??7})).catch(()=>sa),Ce)}function Ze(){let i=W(la);return G(i)?(i.openCreate(),!0):!1}function vn(i,a){let e=W(la);return G(e)?(e.openEdit(i,a),!0):!1}function bn(){let i=W(ca);if(!G(i))return!1;let a=Te();return a?((async()=>{let e=await da(a),t=i;t.checklistsEnabled=e.features.checklists,t.scheduleTimeEnabled=e.features.schedule_time,t.completionActionsEnabled=e.features.completion_actions,t.defaultWarningDays=e.defaultWarningDays,t.openCreate()})(),!0):!1}function Je(i,a){let e=W(ca);if(!G(e))return!1;let t=Te();return t?((async()=>{try{let[n,r]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:i}),da(t)]),c=(n.tasks||[]).find(u=>u.id===a);if(!c){console.warn(`openEditTaskDialog: task ${a} not found in entry ${i}`);return}let s=e;s.checklistsEnabled=r.features.checklists,s.scheduleTimeEnabled=r.features.schedule_time,s.completionActionsEnabled=r.features.completion_actions,s.defaultWarningDays=r.defaultWarningDays,await s.openEdit(i,c)}catch(n){console.warn("openEditTaskDialog: failed to load task/features",n)}})(),!0):!1}function Ye(i){let a=W(pn);return G(a)?(a.openEdit(i),!0):!1}function yn(i){let a=W(gn);return G(a)?(a.entryId=i.entry_id,a.taskId=i.task_id,a.taskName=i.task_name,a.checklist=i.checklist??[],a.adaptiveEnabled=!!i.adaptive_enabled,a.lang=Te()?.language||"en",a.open(),!0):!1}function kn(i){let a=W(mn);return G(a)?(a.openForTask(i.entry_id,i.task_id,i.object_name,i.task_name),!0):!1}function Xe(i,a){let e=W(hn);return G(e)?(e.openFor(i,a),!0):!1}function et(i){let a=W(fn);return G(a)?(a.openFor(i),!0):!1}var la,ca,pn,gn,mn,hn,fn,sa,Ce,F=b(()=>{"use strict";Ot();Vt();Bt();Wt();Kt();oa();ra();la="maintenance-object-dialog",ca="maintenance-task-dialog",pn="maintenance-history-edit-dialog",gn="maintenance-complete-dialog",mn="maintenance-qr-dialog",hn="maintenance-task-quick-actions-dialog",fn="maintenance-object-quick-actions-dialog";sa={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7},Ce=null});A();I();S();M();A();var oe=w`
...
`;var T=class extends y{constructor(){super(...arguments);this._config={type:""};this._state=null;this._busy=!1;this._error="";this._localStart="";this._localEnd="";this._localBuffer=7;this._dirty=!1;this._loaded=!1}setConfig(e){this._config=e}getCardSize(){return 2}get _lang(){return this.hass?.language||"en"}get _isAdmin(){return this.hass?.user?.is_admin??!0}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded&&(this._loaded=!0,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/vacation/state"});this._state=e,this._localStart=e.start||"",this._localEnd=e.end||"",this._localBuffer=e.buffer_days??7,this._dirty=!1}catch(e){this._error=k(e,this._lang)}}async _toggleEnabled(e){this._busy=!0,this._error="";try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/vacation/update",enabled:e});this._state=t}catch(t){this._error=k(t,this._lang)}finally{this._busy=!1}}async _save(){if(this._isAdmin){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/vacation/update",start:this._localStart||null,end:this._localEnd||null,buffer_days:this._localBuffer});this._state=e,this._dirty=!1}catch(e){this._error=k(e,this._lang)}finally{this._busy=!1}}}async _endNow(){if(this._isAdmin&&window.confirm(o("vacation_end_now_confirm",this._lang)||"End vacation immediately?")){this._busy=!0;try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/vacation/end_now"});this._state=e,this._localStart=e.start||"",this._localEnd=e.end||""}catch(e){this._error=k(e,this._lang)}finally{this._busy=!1}}}_onDeepLink(){history.pushState(null,"","/maintenance-supporter?ms_action=open_vacation"),window.dispatchEvent(new CustomEvent("location-changed"))}render(){let e=this._lang,t=this._state;if(!t)return d`<ha-card><div class="loading">${o("loading",e)||"Loading\u2026"}</div></ha-card>`;let n=t.is_active===!0,r=t.enabled===!0,c=t.exempt_task_ids?.length??0,s=n?o("vacation_status_active",e)||"Active now":r?o("vacation_status_scheduled",e)||"Scheduled":o("vacation_status_inactive",e)||"Inactive",u=n?"active":r?"scheduled":"inactive";return d`
      <ha-card>
        <div class="card-content">
          <div class="header">
            <div class="title">
              <span class="emoji">🏖️</span>
              <span>${this._config.title||o("vacation_mode",e)||"Vacation mode"}</span>
            </div>
            <span class="status-pill ${u}">${s}</span>
          </div>
          ...
          ${this._isAdmin?d`
                <div class="row toggle-row">
                  <label>${o("enable",e)||"Enable"}</label>
                  <ha-switch
                    .checked=${r}
                    .disabled=${this._busy}
                    @change=${g=>this._toggleEnabled(g.target.checked)}
                  ></ha-switch>
                </div>

                <div class="dates-row">
                  <div class="date-field">
                    <label>${o("vacation_start",e)||"Start"}</label>
                    <input type="date" .value=${this._localStart}
                      ?disabled=${this._busy}
                      @input=${g=>{this._localStart=g.target.value,this._dirty=!0}} />
                  </div>
                  <div class="date-field">
                    <label>${o("vacation_end",e)||"End"}</label>
                    <input type="date" .value=${this._localEnd}
                      ?disabled=${this._busy}
                      @input=${g=>{this._localEnd=g.target.value,this._dirty=!0}} />
                  </div>
                  <div class="date-field buffer">
                    <label>${o("vacation_buffer",e)||"Buffer days"}</label>
                    <input type="number" min="0" max="14"
                      .value=${String(this._localBuffer)}
                      ?disabled=${this._busy}
                      @input=${g=>{this._localBuffer=parseInt(g.target.value,10)||0,this._dirty=!0}} />
                  </div>
                </div>
                ...
                <div class="actions">
                  <button class="btn ${this._dirty?"primary":"muted"}"
                    ...
                    ${this._dirty?o("save",e)||"Save":o("saved",e)||"Saved"}
                  </button>
                  ${n?d`<button class="btn"
                        @click=${this._endNow}
                        ?disabled=${this._busy}>
                        ${o("vacation_end_now",e)||"End now"}
                      </button>`:p}
                  ${c>0?d`<button class="btn link"
                        @click=${this._onDeepLink}>
                        ${c} ${o("vacation_exempt_count",e)||"exempt"}…
                      </button>`:d`<button class="btn link"
                        @click=${this._onDeepLink}>
                        ${o("vacation_advanced",e)||"Advanced\u2026"}
                      </button>`}
                </div>
              `:d`
                <div class="readonly">
                  ${r&&t.start&&t.end?d`<div>${t.start} → ${t.end}</div>`:p}
                  <button class="btn link" @click=${this._onDeepLink}>
                    ${o("vacation_open_panel",e)||"Open in panel"}
                  </button>
                </div>
              `}
        </div>
  ...
  `],l([h({attribute:!1})],T.prototype,"hass",2),l([_()],T.prototype,"_config",2),l([_()],T.prototype,"_state",2),l([_()],T.prototype,"_busy",2),l([_()],T.prototype,"_error",2),l([_()],T.prototype,"_localStart",2),l([_()],T.prototype,"_localEnd",2),l([_()],T.prototype,"_localBuffer",2),l([_()],T.prototype,"_dirty",2);customElements.get("maintenance-vacation-section-card")||customElements.define("maintenance-vacation-section-card",T);window.customCards=window.customCards||[];window.customCards.push({type:"maintenance-vacation-section-card",name:"Maintenance Supporter \u2014 Vacation",description:"Inline vacation mode toggle + dates",preview:!1});A();I();S();M();var R=class extends y{constructor(){super(...arguments);this._config={type:""};this._status=null;this._busy=!1;this._error="";this._localMonthly="";this._localYearly="";this._dirty=!1;this._loaded=!1}setConfig(e){this._config=e}getCardSize(){return 2}get _lang(){return this.hass?.language||"en"}get _isAdmin(){return this.hass?.user?.is_admin??!0}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._loaded&&(this._loaded=!0,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"});this._status=e,this._localMonthly=e.monthly_budget?String(e.monthly_budget):"",this._localYearly=e.yearly_budget?String(e.yearly_budget):"",this._dirty=!1}catch(e){this._error=k(e,this._lang)}}async _save(){if(this._isAdmin){this._busy=!0,this._error="";try{let e=parseFloat(this._localMonthly),t=parseFloat(this._localYearly),n={};!isNaN(e)&&e>=0&&(n.budget_monthly=e),!isNaN(t)&&t>=0&&(n.budget_yearly=t),await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/global/update",settings:n}),await this._load()}catch(e){this._error=k(e,this._lang)}finally{this._busy=!1}}}_onDeepLink(){history.pushState(null,"","/maintenance-supporter?ms_action=open_budget"),window.dispatchEvent(new CustomEvent("location-changed"))}render(){let e=this._lang,t=this._status;if(!t)return d`<ha-card><div class="loading">${o("loading",e)||"Loading\u2026"}</div></ha-card>`;let n=t.currency_symbol||"\u20AC",r=t.monthly_budget?Math.min(100,(t.monthly_spent||0)/t.monthly_budget*100):0,c=t.yearly_budget?Math.min(100,(t.yearly_spent||0)/t.yearly_budget*100):0,s=r>=100?"danger":r>=80?"warning":"ok",u=c>=100?"danger":c>=80?"warning":"ok";return d`
      <ha-card>
        <div class="card-content">
          <div class="header">
            <div class="title">
              <span class="emoji">💰</span>
              <span>${this._config.title||o("settings_budget",e)||"Budget"}</span>
            </div>
          ...
          <div class="track">
            <div class="track-label-row">
              <label>${o("budget_monthly",e)||"Monthly"}</label>
              <span class="track-numbers ${s}">
                ${(t.monthly_spent||0).toFixed(0)} / ${(t.monthly_budget||0).toFixed(0)} ${n}
              </span>
            </div>
            <div class="bar"><div class="bar-fill ${s}" style="width:${r}%"></div></div>
          </div>

          <div class="track">
            <div class="track-label-row">
              <label>${o("budget_yearly",e)||"Yearly"}</label>
              <span class="track-numbers ${u}">
                ${(t.yearly_spent||0).toFixed(0)} / ${(t.yearly_budget||0).toFixed(0)} ${n}
              </span>
            </div>
          ...
          ${this._isAdmin?d`
                <div class="inputs-row">
                  <div class="input-field">
                    <label>${o("budget_monthly_set",e)||"Set monthly"}</label>
                    <div class="input-wrap">
                      <input type="number" min="0" step="1"
                        .value=${this._localMonthly}
                        ?disabled=${this._busy}
                        @input=${g=>{this._localMonthly=g.target.value,this._dirty=!0}} />
                      <span class="input-suffix">${n}</span>
                    </div>
                  </div>
                  <div class="input-field">
                    <label>${o("budget_yearly_set",e)||"Set yearly"}</label>
                    <div class="input-wrap">
                      <input type="number" min="0" step="1"
                        .value=${this._localYearly}
                        ?disabled=${this._busy}
                        @input=${g=>{this._localYearly=g.target.value,this._dirty=!0}} />
                      <span class="input-suffix">${n}</span>
                    </div>
                  </div>
                </div>
                <div class="actions">
                  ...
                  <button class="btn link" @click=${this._onDeepLink}>
                    ${o("budget_advanced",e)||"Currency, alerts\u2026"}
                  </button>
                </div>
              `:d`
                <button class="btn link" @click=${this._onDeepLink}>
                  ${o("budget_open_panel",e)||"Open in panel"}
                </button>
              `}
        </div>
      </ha-card>
  ...
  `],l([h({attribute:!1})],R.prototype,"hass",2),l([_()],R.prototype,"_config",2),l([_()],R.prototype,"_status",2),l([_()],R.prototype,"_busy",2),l([_()],R.prototype,"_error",2),l([_()],R.prototype,"_localMonthly",2),l([_()],R.prototype,"_localYearly",2),l([_()],R.prototype,"_dirty",2);customElements.get("maintenance-budget-section-card")||customElements.define("maintenance-budget-section-card",R);window.customCards=window.customCards||[];window.customCards.push({type:"maintenance-budget-section-card",name:"Maintenance Supporter \u2014 Budget",description:"Inline monthly + yearly budget editor",preview:!1});A();I();S();M();var N=class extends y{constructor(){super(...arguments);this._config={type:""};this._groups={};this._loaded=!1;this._busy=!1;this._error="";this._newName="";this._editingId=null;this._editingName="";this._hasInitiallyLoaded=!1}setConfig(e){this._config=e}getCardSize(){return 2}get _lang(){return this.hass?.language||"en"}get _isAdmin(){return this.hass?.user?.is_admin??!0}updated(e){super.updated(e),e.has("hass")&&this.hass&&!this._hasInitiallyLoaded&&(this._hasInitiallyLoaded=!0,this._load())}async _load(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/groups"});this._groups=e.groups||{},this._loaded=!0}catch(e){this._error=k(e,this._lang)}}async _addGroup(){if(!this._isAdmin)return;let e=this._newName.trim();if(e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/group/create",name:e}),this._newName="",await this._load()}catch(t){this._error=k(t,this._lang)}finally{this._busy=!1}}}_startEdit(e){this._editingId=e,this._editingName=this._groups[e]?.name||""}async _saveEdit(){if(!this._isAdmin||!this._editingId)return;let e=this._editingName.trim();if(e){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/group/update",group_id:this._editingId,name:e}),this._editingId=null,this._editingName="",await this._load()}catch(t){this._error=k(t,this._lang)}finally{this._busy=!1}}}async _deleteGroup(e,t){if(!this._isAdmin)return;let n=(o("group_delete_confirm",this._lang)||'Delete group "{name}"?').replace("{name}",t);if(window.confirm(n)){this._busy=!0;try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/group/delete",group_id:e}),await this._load()}catch(r){this._error=k(r,this._lang)}finally{this._busy=!1}}}_onDeepLink(){history.pushState(null,"","/maintenance-supporter?ms_action=open_groups"),window.dispatchEvent(new CustomEvent("location-changed"))}_onKeyDown(e,t){e.key==="Enter"?(e.preventDefault(),t()):e.key==="Escape"&&(e.preventDefault(),this._editingId=null,this._editingName="")}render(){let e=this._lang;if(!this._loaded)return d`<ha-card><div class="loading">${o("loading",e)||"Loading\u2026"}</div></ha-card>`;let t=Object.keys(this._groups);return d`
      <ha-card>
        <div class="card-content">
          <div class="header">
            <div class="title">
              <span class="emoji">🏷️</span>
              <span>${this._config.title||o("groups",e)||"Groups"}</span>
          ...
          ${t.length===0?d`<div class="empty">${o("groups_empty",e)||"No groups yet."}</div>`:d`
                <div class="group-list">
                  ${t.map(n=>{let r=this._groups[n],c=r.task_refs?.length??0,s=this._editingId===n;return d`
                      <div class="group-row">
                        ${s?d`
                              <input class="edit-input" type="text"
                                .value=${this._editingName}
                                ?disabled=${this._busy}
                                @input=${u=>{this._editingName=u.target.value}}
                                @keydown=${u=>this._onKeyDown(u,this._saveEdit.bind(this))} />
                            ...
                            `:d`
                              <span class="group-name">${r.name||"Unnamed"}</span>
                              <span class="task-count">${c}</span>
                              ${this._isAdmin?d`
                                    ...
                                    <button class="icon-btn danger"
                                      title="${o("delete",e)||"Delete"}"
                                      @click=${()=>this._deleteGroup(n,r.name||"Unnamed")}
                                      ?disabled=${this._busy}>
                                      <ha-icon icon="mdi:delete"></ha-icon>
                                    </button>
                                  `:p}
          ...
          ${this._isAdmin?d`
                <div class="add-row">
                  <input type="text"
                    placeholder="${o("group_new_placeholder",e)||"Add group\u2026"}"
                    .value=${this._newName}
                    ?disabled=${this._busy}
                ...
                <button class="btn link" @click=${this._onDeepLink}>
                  ${o("groups_manage_tasks",e)||"Manage task assignments\u2026"}
                </button>
              `:d`
                <button class="btn link" @click=${this._onDeepLink}>
                  ${o("groups_open_panel",e)||"Open in panel"}
                </button>
              `}
        </div>
      </ha-card>
    ...
    .btn ha-icon { --mdc-icon-size: 16px; }
  `],l([h({attribute:!1})],N.prototype,"hass",2),l([_()],N.prototype,"_config",2),l([_()],N.prototype,"_groups",2),l([_()],N.prototype,"_loaded",2),l([_()],N.prototype,"_busy",2),l([_()],N.prototype,"_error",2),l([_()],N.prototype,"_newName",2),l([_()],N.prototype,"_editingId",2),l([_()],N.prototype,"_editingName",2);customElements.get("maintenance-groups-section-card")||customElements.define("maintenance-groups-section-card",N);window.customCards=window.customCards||[];window.customCards.push({type:"maintenance-groups-section-card",name:"Maintenance Supporter \u2014 Groups",description:"Inline group CRUD",preview:!1});F();var va="maintenance-supporter",_a=`ll-strategy-dashboard-${va}`,tt="hui-maintenance-supporter-strategy-editor",wn="NOT_RUNNING",xn=[{status:"overdue",title:"Overdue",icon:"mdi:alert-circle",path:"overdue"},{status:"triggered",title:"Triggered",icon:"mdi:flash",path:"triggered"},{status:"due_soon",title:"Due Soon",icon:"mdi:clock-alert-outline",path:"due-soon"},{status:"ok",title:"OK",icon:"mdi:check-circle-outline",path:"ok"}],ua=[{title:"Overdue",icon:"mdi:alert-circle",path:"overdue",filter:{filter_due_max_days:-1},matches:i=>i<=-1},{title:"Today",icon:"mdi:calendar-today",path:"today",filter:{filter_due_min_days:0,filter_due_max_days:0},matches:i=>i===0},{title:"This Week",icon:"mdi:calendar-week",path:"this-week",filter:{filter_due_min_days:1,filter_due_max_days:7},matches:i=>i>=1&&i<=7},{title:"This Month",icon:"mdi:calendar-month",path:"this-month",filter:{filter_due_min_days:8,filter_due_max_days:30},matches:i=>i>=8&&i<=30},{title:"Later",icon:"mdi:calendar-clock",path:"later",filter:{filter_due_min_days:31},matches:i=>i>=31}];function X(i){return{type:"grid",cards:[i]}}var zn={condition:"view_columns",min:2};function $n(i){let a={overdue:0,triggered:0,due_soon:0,ok:0,total:0};for(let e of i)for(let t of e.tasks||[])a.total++,t.status==="overdue"?a.overdue++:t.status==="triggered"?a.triggered++:t.status==="due_soon"?a.due_soon++:t.status==="ok"&&a.ok++;return a}function En(i){let a=[];return i.overdue&&a.push(`\u{1F534} **${i.overdue}** overdue`),i.triggered&&a.push(`\u26A1 **${i.triggered}** triggered`),i.due_soon&&a.push(`\u{1F7E1} **${i.due_soon}** due soon`),a.push(`\u{1F7E2} **${i.ok}** ok`),{type:"markdown",text_only:!0,content:a.join(" \xB7 ")}}function An(){return{title:"Maintenance",type:"panel",cards:[{type:"empty-state",icon:"mdi:wrench-clock",icon_color:"primary",content_only:!0,title:"No maintenance objects yet",content:"Open the Maintenance panel to add your first object \u2014 pool pump, HVAC filter, vehicle, anything that needs scheduled care.",buttons:[{icon:"mdi:wrench",text:"Open Maintenance panel",appearance:"filled",variant:"brand",tap_action:{action:"navigate",navigation_path:"/maintenance-supporter"}},{icon:"mdi:plus",text:"Add object",appearance:"outlined",variant:"brand",tap_action:{action:"fire-dom-event",ll_custom:{type:"maintenance-supporter:add-object"}}}]}]}}function jn(i){let a=En(i);return{title:"Overview",icon:"mdi:wrench-clock",path:"overview",type:"sections",header:{layout:"responsive",card:a},sidebar:{sections:[{type:"grid",cards:[{type:"heading",heading:"Status",heading_style:"title"},a]}],visibility:[zn],content_label:"Tasks",sidebar_label:"Status"},sections:[X({type:"custom:maintenance-supporter-card",show_header:!1,filter_status:["overdue","triggered","due_soon"]})]}}function Sn(i,a){let e=new Map;for(let c of i){let s=c.object.area_id||null;e.has(s)||e.set(s,[]),e.get(s).push(c)}let t=Array.from(e.keys()).filter(c=>c!==null);t.sort((c,s)=>{let u=a[c]?.name||c,g=a[s]?.name||s;return u.localeCompare(g)});let n=[];for(let c of t){let s=e.get(c);if(s.length===0)continue;let u=a[c];n.push({title:u?.name||c,icon:u?.icon||"mdi:floor-plan",path:`area-${c}`,type:"sections",sections:[X({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:s.map(g=>g.object.name)})]})}let r=e.get(null);return r&&r.length>0&&n.push({title:"Unassigned",icon:"mdi:help-circle-outline",path:"unassigned",type:"sections",sections:[X({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:r.map(c=>c.object.name)})]}),n}function qn(i){let a=new Set;for(let t of i)for(let n of t.tasks||[])n.status&&a.add(n.status);let e=[];for(let t of xn)a.has(t.status)&&e.push({title:t.title,icon:t.icon,path:t.path,type:"sections",sections:[X({type:"custom:maintenance-supporter-card",show_header:!1,filter_status:[t.status]})]});return e}function Cn(i,a,e){let t=new Map;for(let s of i){let u=s.object.area_id,g=u&&a[u]?.floor_id||null;t.has(g)||t.set(g,[]),t.get(g).push(s)}let n=Array.from(t.keys()).filter(s=>s!==null);n.sort((s,u)=>{let g=e[s],v=e[u],f=g?.level??0,x=v?.level??0;return f!==x?f-x:(g?.name||s).localeCompare(v?.name||u)});let r=[];for(let s of n){let u=t.get(s);if(u.length===0)continue;let g=e[s];r.push({title:g?.name||s,icon:g?.icon||"mdi:home-floor-1",path:`floor-${s}`,type:"sections",sections:[X({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:u.map(v=>v.object.name)})]})}let c=t.get(null);return c&&c.length>0&&r.push({title:"Other",icon:"mdi:help-circle-outline",path:"other",type:"sections",sections:[X({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:c.map(s=>s.object.name)})]}),r}function Tn(i){return[{title:"Week",icon:"mdi:calendar-week",path:"cal-7",window_days:7},{title:"Fortnight",icon:"mdi:calendar-week-begin",path:"cal-14",window_days:14},{title:"Month",icon:"mdi:calendar-month",path:"cal-30",window_days:30},{title:"Year",icon:"mdi:calendar-clock",path:"cal-365",window_days:365}].map(e=>({title:e.title,icon:e.icon,path:e.path,type:"panel",cards:[{type:"custom:maintenance-supporter-calendar-card",window_days:e.window_days,show_window_chips:!1,show_user_filter:!0}]}))}function Nn(i){let a=new Set;for(let t of i)for(let n of t.tasks||[]){let r=n.days_until_due;r!=null&&ua.forEach((c,s)=>{c.matches(r)&&a.add(s)})}let e=[];return ua.forEach((t,n)=>{a.has(n)&&e.push({title:t.title,icon:t.icon,path:t.path,type:"sections",sections:[X({type:"custom:maintenance-supporter-card",show_header:!1,...t.filter})]})}),e}var at=class extends HTMLElement{static getCreateSuggestions(a){return{title:"Maintenance Supporter",icon:"mdi:wrench-clock"}}static async getConfigElement(){return document.createElement(tt)}static async generate(a,e){if(e.config?.state===wn)return{views:[{type:"sections",sections:[{cards:[{type:"starting"}]}]}]};if(e.config?.recovery_mode)return{views:[{type:"sections",sections:[{cards:[{type:"recovery-mode"}]}]}]};let t;try{t=await e.connection.sendMessagePromise({type:"maintenance_supporter/objects"})}catch{return{title:"Maintenance",views:[{title:"Maintenance",cards:[{type:"markdown",content:"**Maintenance Supporter** is not loaded. Install/enable the integration first."}]}]}}let n=t.objects||[];if(n.length===0)return{title:"Maintenance",views:[An()]};let r=$n(n),c=a?.group_by??"area",s={area:()=>Sn(n,e.areas||{}),status:()=>qn(n),floor:()=>Cn(n,e.areas||{},e.floors||{}),due_date:()=>Nn(n),calendar:()=>Tn(n)};return{title:"Maintenance",views:[jn(r),...(s[c]??s.area)()]}}},In=[{value:"area",label:"By area (default)"},{value:"status",label:"By status (Overdue / Triggered / Due Soon / OK)"},{value:"floor",label:"By floor (uses HA floors)"},{value:"due_date",label:"By due date (Overdue / Today / Week / Month / Later)"},{value:"calendar",label:"Rolling calendar (Week / Fortnight / Month / Year)"}],nt=class extends HTMLElement{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter"}}set hass(e){this._hass=e}setConfig(e){this._config=e,this._render()}connectedCallback(){this._render()}_render(){let e=this._config.group_by??"area",t=In.map(r=>`<option value="${r.value}"${r.value===e?" selected":""}>${r.label}</option>`).join("");this.innerHTML=`
      <style>
      ...
      <div class="editor">
        ...
        <select id="group-by">${t}</select>
        <div class="help">
          The "Overview" view is always first. Empty groups are skipped.
        </div>
      </div>
    `;let n=this.querySelector("#group-by");n?.addEventListener("change",()=>{let r={...this._config,group_by:n.value};this._config=r,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:r},bubbles:!0,composed:!0}))})}},ba="maintenance-supporter-section",pa=`ll-strategy-section-${ba}`,it=class extends HTMLElement{static async generate(a,e){let t={type:"custom:maintenance-supporter-card",show_header:!1};a?.filter_status?.length&&(t.filter_status=a.filter_status),a?.max_items&&(t.max_items=a.max_items),a?.filter_due_min_days!==void 0&&(t.filter_due_min_days=a.filter_due_min_days),a?.filter_due_max_days!==void 0&&(t.filter_due_max_days=a.filter_due_max_days);let n=a?.filter_objects;if(a?.area_id&&!n)try{n=((await e.connection.sendMessagePromise({type:"maintenance_supporter/objects"})).objects||[]).filter(s=>s.object.area_id===a.area_id).map(s=>s.object.name)}catch{}n&&n.length>0&&(t.filter_objects=n);let r=[];return a?.title&&r.push({type:"heading",heading:a.title,heading_style:"title"}),r.push(t),{type:"grid",cards:r}}};customElements.get(_a)||customElements.define(_a,at);customElements.get(tt)||customElements.define(tt,nt);customElements.get(pa)||customElements.define(pa,it);var ot=class extends HTMLElement{static async generate(a,e){return{type:"grid",cards:[{type:"custom:maintenance-vacation-section-card",title:a?.title}]}}},rt=class extends HTMLElement{static async generate(a,e){return{type:"grid",cards:[{type:"custom:maintenance-budget-section-card",title:a?.title}]}}},st=class extends HTMLElement{static async generate(a,e){return{type:"grid",cards:[{type:"custom:maintenance-groups-section-card",title:a?.title}]}}},ga="ll-strategy-section-maintenance-supporter-vacation",ma="ll-strategy-section-maintenance-supporter-budget",ha="ll-strategy-section-maintenance-supporter-groups";customElements.get(ga)||customElements.define(ga,ot);customElements.get(ma)||customElements.define(ma,rt);customElements.get(ha)||customElements.define(ha,st);var fa="_msSupporterLlCustomBound";function fe(i){history.pushState(null,"",i),window.dispatchEvent(new CustomEvent("location-changed"))}function Rn(){let i=window;i[fa]||(i[fa]=!0,document.addEventListener("ll-custom",a=>{let e=a.detail;if(!e||typeof e.type!="string"||!e.type.startsWith("maintenance-supporter:"))return;let t=e.type.slice(22);if(t==="add-object"){if(Ze())return;fe("/maintenance-supporter?ms_action=add_object");return}if(t==="open-task"&&typeof e.entry_id=="string"&&typeof e.task_id=="string"){if(Xe(e.entry_id,e.task_id)||Je(e.entry_id,e.task_id))return;fe(`/maintenance-supporter?entry_id=${encodeURIComponent(e.entry_id)}&task_id=${encodeURIComponent(e.task_id)}`);return}if(t==="open-object"&&typeof e.entry_id=="string"){if(et(e.entry_id))return;fe(`/maintenance-supporter?entry_id=${encodeURIComponent(e.entry_id)}`);return}if(t==="deep-link"&&typeof e.path=="string"){fe(e.path);return}if(t==="edit-history"&&typeof e.entry_id=="string"&&typeof e.task_id=="string"&&typeof e.original_timestamp=="string"){let r=document.querySelector("home-assistant")?.hass;if(!r)return;(async()=>{try{let u=(await r.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:e.entry_id})).tasks?.find(g=>g.id===e.task_id)?.history?.find(g=>g.timestamp===e.original_timestamp);if(!u)return;Ye({entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.original_timestamp,type:u.type||"completed",timestamp:u.timestamp||e.original_timestamp,notes:u.notes??null,cost:u.cost??null,duration:u.duration??null,completed_by:u.completed_by??null})}catch{fe("/maintenance-supporter")}})();return}}))}Rn();var Ne=window;Ne.customStrategies=Ne.customStrategies||[];function ve(i){Ne.customStrategies.some(e=>e.type===i.type&&e.strategyType===i.strategyType)||Ne.customStrategies.push(i)}ve({type:va,strategyType:"dashboard",name:"Maintenance Supporter",description:"Auto-generated dashboard. Group views by area, status, floor, or due date \u2014 picked from the strategy editor or YAML.",documentationURL:"https://github.com/iluebbe/maintenance_supporter#dashboard-strategy"});ve({type:ba,strategyType:"section",name:"Maintenance Supporter \u2014 Section",description:"Embed maintenance tasks (filterable by area, status, due date) as a section in any dashboard view.",documentationURL:"https://github.com/iluebbe/maintenance_supporter#section-strategy"});ve({type:"maintenance-supporter-vacation",strategyType:"section",name:"Maintenance Supporter \u2014 Vacation Status",description:"Compact vacation-mode status banner. Tap to open settings in the panel."});ve({type:"maintenance-supporter-budget",strategyType:"section",name:"Maintenance Supporter \u2014 Budget Status",description:"Monthly + yearly maintenance budget overview. Tap for details."});ve({type:"maintenance-supporter-groups",strategyType:"section",name:"Maintenance Supporter \u2014 Groups",description:"List of configured task groups with member counts."});
