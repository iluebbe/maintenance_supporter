...
`});function ya(i,a){let e=ba[i];if(!e)return i;let t=r(e,a);return t&&t!==e?t:i}function ka(i){let e=i.match(/data\['([^']+)'\]/)?.[1],t;return(t=i.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=i.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=i.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=i.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(i)?{field:e,rule:"required"}:(t=i.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(i)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(i)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function j(i,a,e){if(typeof i=="string")return i;if(typeof i!="object"||i===null)return e;let t=i,n=t.message||t.error?.message||"";if(!n)return e;let o=ka(n),l=o.field?ya(o.field,a):"",s=_=>r(_,a).replace("{field}",l).replace("{n}",o.param??"");switch(o.rule){case"too_long":return s("err_too_long");case"too_short":return s("err_too_short");case"value_too_high":return s("err_value_too_high");case"value_too_low":return s("err_value_too_low");case"required":return s("err_required");case"wrong_type":return s("err_wrong_type").replace("{type}",o.param??"");case"invalid_choice":return s("err_invalid_choice");case"invalid_value":return s("err_invalid_value");default:return n||e}}var ba,V=v(()=>{"use strict";N();ba={name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_for_minutes:"trigger_for_minutes"}});var x,xt=v(()=>{"use strict";C();F();N();V();x=class extends y{constructor(){super(...arguments);this._open=!1;this._loading=!1;this._error="";this._name="";this._manufacturer="";this._model="";this._serialNumber="";this._areaId="";this._installationDate="";this._documentationUrl="";this._notes="";this._entryId=null}get _lang(){return this.hass?.language??navigator.language.split("-")[0]??"en"}openCreate(){this._entryId=null,this._name="",this._manufacturer="",this._model="",this._serialNumber="",this._areaId="",this._installationDate="",this._documentationUrl="",this._notes="",this._error="",this._open=!0}openEdit(e,t){this._entryId=e,this._name=t.name||"",this._manufacturer=t.manufacturer||"",this._model=t.model||"",this._serialNumber=t.serial_number||"",this._areaId=t.area_id||"",this._installationDate=t.installation_date||"",this._documentationUrl=t.documentation_url||"",this._notes=t.notes||"",this._error="",this._open=!0}async _save(){if(this._name.trim()){this._loading=!0,this._error="";try{this._entryId?await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/update",entry_id:this._entryId,name:this._name,manufacturer:this._manufacturer||null,model:this._model||null,serial_number:this._serialNumber||null,area_id:this._areaId||null,installation_date:this._installationDate||null,documentation_url:this._documentationUrl.trim()||null,notes:this._notes.trim()||null}):await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/create",name:this._name,manufacturer:this._manufacturer||null,model:this._model||null,serial_number:this._serialNumber||null,area_id:this._areaId||null,installation_date:this._installationDate||null,documentation_url:this._documentationUrl.trim()||null,notes:this._notes.trim()||null}),this._open=!1,this.dispatchEvent(new CustomEvent("object-saved"))}catch(e){this._error=j(e,this._lang,r("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}render(){if(!this._open)return u``;let e=this._lang,t=this._entryId?r("edit_object",e):r("new_object",e);return u`
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ></ha-textfield>
          <ha-textarea
            label="${r("object_notes_optional",e)}"
            autogrow
            rows="3"
            .value=${this._notes}
...
`),this._scheduleTime=t.schedule_time||"";let n=t.on_complete_action;if(n&&n.service){this._actionService=n.service;let s=n.target?.entity_id;this._actionTargetEntity=Array.isArray(s)?s[0]||"":s||"",this._actionData=n.data&&typeof n.data=="object"?{...n.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let o=t.quick_complete_defaults;this._qcNotes=o?.notes||"",this._qcCost=o?.cost!=null?String(o.cost):"",this._qcDuration=o?.duration!=null?String(o.duration):"",this._qcFeedback=o?.feedback||"";let l=t.adaptive_config||{};if(this._environmentalEntity=l.environmental_entity||"",this._environmentalAttribute=l.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,t.trigger_config){let s=t.trigger_config;this._triggerEntityId=s.entity_id||"",this._triggerEntityIds=s.entity_ids||(s.entity_id?[s.entity_id]:[]),this._triggerEntityLogic=s.entity_logic||"any",this._triggerAttribute=s.attribute||"",this._triggerType=s.type||"threshold",this._triggerAbove=s.trigger_above?.toString()||"",this._triggerBelow=s.trigger_below?.toString()||"",this._triggerForMinutes=s.trigger_for_minutes?.toString()||"0",this._triggerTargetValue=s.trigger_target_value?.toString()||"",this._triggerDeltaMode=s.trigger_delta_mode||!1,this._triggerFromState=s.trigger_from_state||"",this._triggerToState=s.trigger_to_state||"",this._triggerTargetChanges=s.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=s.trigger_runtime_hours?.toString()||""}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._warningDays=String(this.defaultWarningDays),this._intervalAnchor="completion",this._notes="",this._documentationUrl="",this._customIcon="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._responsibleUserId=null,this._checklistText="",this._scheduleTime="",this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerForMinutes="0",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours=""}async _loadUsers(){this._userService||(this._userService=new he(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error";return}let[t,n]=e.split("."),o={...this._buildActionData()},l=this._actionTargetEntity.trim();l&&(o.entity_id=l),this._actionTesting=!0,this._actionTestResult="";try{await this.hass.callService(t,n,o),this._actionTestResult="ok"}catch{this._actionTestResult="error"}finally{this._actionTesting=!1,setTimeout(()=>{this._actionTestResult=""},3e3)}}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,n]=e.split("."),o=this.hass?.services?.[t]?.[n]?.fields;return!o||Object.keys(o).length===0?null:Object.entries(o).map(([l,s])=>({name:l,required:!!s.required,selector:s.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return p;let t=this._serviceSchema();return u`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${n=>{this._actionService=n.detail.value||"";let o=this._serviceSchema();if(o){let l=new Set(o.map(s=>s.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([s])=>l.has(s)))}}}
        ></ha-service-picker>
        <ha-entity-picker
          .hass=${this.hass}
          .value=${this._actionTargetEntity}
          .label=${r("on_complete_action_target",e)}
        ...
        <div class="ca-test-row">
          ...
          ${this._actionTestResult==="ok"?u`<span class="ca-test-ok">${r("on_complete_action_test_success",e)}</span>`:p}
          ${this._actionTestResult==="error"?u`<span class="ca-test-error">${r("on_complete_action_test_failed",e)}</span>`:p}
        </div>
      </details>
...
`).map(s=>s.trim()).filter(Boolean).slice(0,100);e.checklist=l.length?l:null}if(this.completionActionsEnabled){let l=this._actionService.trim();if(l&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(l)){let f={service:l},h=this._actionTargetEntity.trim();h&&(f.target={entity_id:h});let E=this._buildActionData();Object.keys(E).length>0&&(f.data=E),e.on_complete_action=f}else e.on_complete_action=null;let s={};this._qcNotes.trim()&&(s.notes=this._qcNotes.trim());let _=parseFloat(this._qcCost);!isNaN(_)&&_>=0&&(s.cost=_);let g=parseInt(this._qcDuration,10);!isNaN(g)&&g>=0&&(s.duration=g),this._qcFeedback&&(s.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(s).length?s:null}let t=await this.hass.connection.sendMessagePromise(e),n=this._taskId||t?.task_id,o=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(n&&this._scheduleType==="sensor_based"&&o)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:n,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=j(e,this._lang,r("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return p;let e=this._lang;return u`
      ...
      <ha-textfield
        ...
        @input=${t=>{let o=t.target.value.split(",").map(l=>l.trim()).filter(Boolean);this._triggerEntityId=o[0]||"",this._triggerEntityIds=o,o[0]&&this._fetchEntityAttributes(o[0])}}
      ></ha-textfield>
      ...
      <div class="select-row">
        ...
        >
          ${za.map(t=>u`<option value=${t} ?selected=${t===this._triggerType}>${r(t,e)}</option>`)}
        </select>
      </div>
      ${this._renderTriggerTypeFields()}
      <ha-textfield
        label="${r("safety_interval_days",e)}"
        type="number"
    ...
    `}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?u`
      ...
      `:this._triggerType==="runtime"?u`
        ...
        ></ha-textfield>
      `:p}render(){if(!this._open)return u``;let e=this._lang,t=this._taskId?r("edit_task",e):r("new_task",e);return u`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._error?u`<div class="error">${this._error}</div>`:p}
          ...
          <div class="select-row">
            ...
            >
              ${wa.map(n=>u`<option value=${n} ?selected=${n===this._type}>${r(n,e)}</option>`)}
            </select>
          </div>
          <div class="select-row">
            ...
            >
              ${xa.map(n=>u`<option value=${n} ?selected=${n===this._scheduleType}>${r(n,e)}</option>`)}
            </select>
          </div>
          ${this._scheduleType==="time_based"?u`
                <ha-textfield
                  label="${r("interval_days",e)}"
                  type="number"
                  .value=${this._intervalDays}
          ...
          <div class="select-row">
            ...
            <select
              ...
              @change=${n=>{let o=n.target.value;this._responsibleUserId=o||null}}
            >
  ...
  `,c([b({attribute:!1})],m.prototype,"hass",2),c([b({type:Boolean,attribute:"checklists-enabled"})],m.prototype,"checklistsEnabled",2),c([b({type:Boolean,attribute:"schedule-time-enabled"})],m.prototype,"scheduleTimeEnabled",2),c([b({type:Boolean,attribute:"completion-actions-enabled"})],m.prototype,"completionActionsEnabled",2),c([b({type:Number,attribute:"default-warning-days"})],m.prototype,"defaultWarningDays",2),c([d()],m.prototype,"_open",2),c([d()],m.prototype,"_loading",2),c([d()],m.prototype,"_error",2),c([d()],m.prototype,"_entryId",2),c([d()],m.prototype,"_taskId",2),c([d()],m.prototype,"_objectChoices",2),c([d()],m.prototype,"_name",2),c([d()],m.prototype,"_type",2),c([d()],m.prototype,"_scheduleType",2),c([d()],m.prototype,"_intervalDays",2),c([d()],m.prototype,"_warningDays",2),c([d()],m.prototype,"_intervalAnchor",2),c([d()],m.prototype,"_notes",2),c([d()],m.prototype,"_documentationUrl",2),c([d()],m.prototype,"_customIcon",2),c([d()],m.prototype,"_enabled",2),c([d()],m.prototype,"_triggerEntityId",2),c([d()],m.prototype,"_triggerEntityIds",2),c([d()],m.prototype,"_triggerEntityLogic",2),c([d()],m.prototype,"_triggerAttribute",2),c([d()],m.prototype,"_triggerType",2),c([d()],m.prototype,"_triggerAbove",2),c([d()],m.prototype,"_triggerBelow",2),c([d()],m.prototype,"_triggerForMinutes",2),c([d()],m.prototype,"_triggerTargetValue",2),c([d()],m.prototype,"_triggerDeltaMode",2),c([d()],m.prototype,"_triggerFromState",2),c([d()],m.prototype,"_triggerToState",2),c([d()],m.prototype,"_triggerTargetChanges",2),c([d()],m.prototype,"_triggerRuntimeHours",2),c([d()],m.prototype,"_suggestedAttributes",2),c([d()],m.prototype,"_availableAttributes",2),c([d()],m.prototype,"_entityDomain",2),c([d()],m.prototype,"_lastPerformed",2),c([d()],m.prototype,"_nfcTagId",2),c([d()],m.prototype,"_availableTags",2),c([d()],m.prototype,"_responsibleUserId",2),c([d()],m.prototype,"_availableUsers",2),c([d()],m.prototype,"_checklistText",2),c([d()],m.prototype,"_scheduleTime",2),c([d()],m.prototype,"_actionService",2),c([d()],m.prototype,"_actionTargetEntity",2),c([d()],m.prototype,"_actionData",2),c([d()],m.prototype,"_actionDataJsonFallback",2),c([d()],m.prototype,"_actionTesting",2),c([d()],m.prototype,"_actionTestResult",2),c([d()],m.prototype,"_qcNotes",2),c([d()],m.prototype,"_qcCost",2),c([d()],m.prototype,"_qcDuration",2),c([d()],m.prototype,"_qcFeedback",2),c([d()],m.prototype,"_environmentalEntity",2),c([d()],m.prototype,"_environmentalAttribute",2);customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",m)});var k,jt=v(()=>{"use strict";C();F();N();V();k=class extends y{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed"}open(){this._open||(this._open=!0,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState={},this._feedback="needed")}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),await this.hass.connection.sendMessagePromise(e),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=j(e,this.lang,r("save_error",this.lang))}finally{this._loading=!1}}_close(){this._open=!1}render(){if(!this._open)return u``;let e=this.lang||this.hass?.language||"en";return u`
      <ha-dialog open @closed=${this._close}>
  ...
  `,c([b({attribute:!1})],k.prototype,"hass",2),c([b()],k.prototype,"entryId",2),c([b()],k.prototype,"taskId",2),c([b()],k.prototype,"taskName",2),c([b()],k.prototype,"lang",2),c([b({type:Array})],k.prototype,"checklist",2),c([b({type:Boolean})],k.prototype,"adaptiveEnabled",2),c([d()],k.prototype,"_open",2),c([d()],k.prototype,"_notes",2),c([d()],k.prototype,"_cost",2),c([d()],k.prototype,"_duration",2),c([d()],k.prototype,"_loading",2),c([d()],k.prototype,"_error",2),c([d()],k.prototype,"_checklistState",2),c([d()],k.prototype,"_feedback",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",k)});var T,At=v(()=>{"use strict";C();F();N();V();T=class extends y{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null}get _lang(){return this.hass?.language||"en"}openEdit(e){this._draft={...e},this._originalSnapshot={...e},this._error="",this._open=!0}close(){this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null}_set(e,t){this._draft&&(this._draft={...this._draft,[e]:t})}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{let e={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(e.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(e.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(e.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(e.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(e.completed_by=this._draft.completed_by),Object.keys(e).filter(n=>!["type","entry_id","task_id","original_timestamp"].includes(n)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(e),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=j(e,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return p;let e=this._lang,t=this._draft;return u`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ...
        <label>
          ...
          <input type="datetime-local"
            ...
            @change=${n=>{let o=n.target.value;this._set("timestamp",o.length===16?`${o}:00`:o)}} />
        </label>
        <label>
          <span>${r("notes",e)||"Notes"}</span>
          <textarea
            rows="3"
        ...
        <div class="row">
          ...
          <label>
            ...
            <input type="number" min="0"
              ...
              @input=${n=>{let o=n.target.value;this._set("duration",o?Number(o):null)}} />
          </label>
        </div>
        ${this._error?u`<div class="error">${this._error}</div>`:p}
        <div class="actions">
  ...
  `,c([b({attribute:!1})],T.prototype,"hass",2),c([d()],T.prototype,"_open",2),c([d()],T.prototype,"_saving",2),c([d()],T.prototype,"_error",2),c([d()],T.prototype,"_draft",2);customElements.get("maintenance-history-edit-dialog")||customElements.define("maintenance-history-edit-dialog",T)});function K(i){return i.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function St(i){return!i.startsWith("data:image/svg+xml,")&&!i.startsWith("data:image/png;base64,")?"":K(i)}function Ea(i){return i.replace(/[/\\:*?"<>|#%]+/g,"").replace(/\s+/g,"-").toLowerCase().substring(0,100)}var A,qt=v(()=>{"use strict";C();F();N();A=class extends y{constructor(){super(...arguments);this.lang="en";this._open=!1;this._loading=!1;this._error="";this._viewResult=null;this._completeResult=null;this._urlMode="companion";this._entryId="";this._taskId=null;this._objectName="";this._taskName="";this._generateSeq=0}openForObject(e,t){this._entryId=e,this._taskId=null,this._objectName=t,this._taskName="",this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}openForTask(e,t,n,o){this._entryId=e,this._taskId=t,this._objectName=n,this._taskName=o,this._urlMode="companion",this._error="",this._viewResult=null,this._completeResult=null,this._open=!0,this._generate()}async _generate(){let e=++this._generateSeq;this._loading=!0,this._error="",this._viewResult=null,this._completeResult=null;try{let t={type:"maintenance_supporter/qr/generate",entry_id:this._entryId,url_mode:this._urlMode};this._taskId&&(t.task_id=this._taskId);let n=[this.hass.connection.sendMessagePromise({...t,action:"view"})];this._taskId&&n.push(this.hass.connection.sendMessagePromise({...t,action:"complete"}));let o=await Promise.all(n);if(e!==this._generateSeq)return;this._viewResult=o[0],o.length>1&&(this._completeResult=o[1])}catch(t){if(e!==this._generateSeq)return;let n=t?.code,o=t?.message;this._error=n==="no_url"||typeof o=="string"&&o.includes("No Home Assistant URL")?r("qr_error_no_url",this.lang):r("qr_error",this.lang)}finally{e===this._generateSeq&&(this._loading=!1)}}_setUrlMode(e){this._urlMode!==e&&(this._urlMode=e,this._generate())}_print(){if(!this._viewResult)return;let e=this._viewResult,t=e.label.task_name?`${e.label.object_name} \u2014 ${e.label.task_name}`:e.label.object_name,n=[e.label.manufacturer,e.label.model].filter(Boolean).join(" "),o=window.open("","_blank","width=600,height=500");if(!o)return;let l=this.lang||"en",s=K(t),_=K(n),g=!!this._completeResult,f=K(r("qr_action_view",l)),h=K(r("qr_action_complete",l));o.document.write(`<!DOCTYPE html><html><head><meta charset="utf-8">
<title>${s}</title>
<style>
...
<div class="qr-row">
  <div class="qr-col">
    <img src="${St(this._viewResult.svg_data_uri)}" alt="QR Info" />
    <div class="qr-label">${f}</div>
  </div>
  ${g?`<div class="qr-col">
    <img src="${St(this._completeResult.svg_data_uri)}" alt="QR Complete" />
    <div class="qr-label">${h}</div>
  </div>`:""}
</div>
<div class="url">${K(this._viewResult.url)}</div>
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),o.document.close()}_downloadSvg(e,t){let n=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),o=new Blob([n],{type:"image/svg+xml"}),l=URL.createObjectURL(o),s=document.createElement("a");s.href=l;let _=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;s.download=`qr-${Ea(_)}-${t}.svg`,s.click(),URL.revokeObjectURL(l)}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return u``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${r("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${r("qr_code",e)}: ${this._objectName}`,n=!!this._viewResult;return u`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._loading?u`<div class="loading">${r("qr_generating",e)}</div>`:this._error?u`<div class="error">${this._error}</div>`:n?u`
                    <div class="qr-pair">
                      <div class="qr-item">
                        <img
  ...
  `,c([b({attribute:!1})],A.prototype,"hass",2),c([b()],A.prototype,"lang",2),c([d()],A.prototype,"_open",2),c([d()],A.prototype,"_loading",2),c([d()],A.prototype,"_error",2),c([d()],A.prototype,"_viewResult",2),c([d()],A.prototype,"_completeResult",2),c([d()],A.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",A)});var z,$t=v(()=>{"use strict";C();F();N();V();z=class extends y{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._skipReason="";this._resetDate=""}get _lang(){return this.hass?.language||"en"}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._skipReason="",this._resetDate=new Date().toISOString().slice(0,10),this._open=!0,await this._loadTask()}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(n=>n.id===this._taskId);this._task=t??null}catch(e){this._error=j(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=j(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(S(),I)).then(({openCompleteDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,checklist:this._task.checklist||[],adaptive_enabled:!!this._task.adaptive_config?.enabled})&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(S(),I)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(S(),I)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=r("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}_onEditHistoryEntry(e){!this._entryId||!this._taskId||Promise.resolve().then(()=>(S(),I)).then(({openHistoryEditDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null})})}_renderDetails(e){let t=this._lang,n=e.history||[],o=n.filter(_=>_.type==="completed"),l=o.reduce((_,g)=>_+(typeof g.cost=="number"?g.cost:0),0),s=(()=>{let _=o.map(g=>typeof g.duration=="number"?g.duration:null).filter(g=>g!=null);return _.length?Math.round(_.reduce((g,f)=>g+f,0)/_.length):null})();return u`
      <div class="details">
        ...
        ${n.length===0?u`<div class="history-empty">${r("history_empty",t)||"No history yet."}</div>`:u`
              <div class="history-list">
                ${[...n].reverse().slice(0,20).map(_=>{let g=["completed","reset","skipped"].includes(_.type);return u`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${_.type}">${r(_.type,t)}</span>
                        <span class="history-date">${wt(_.timestamp,t)}</span>
                  ...
                  `})}
                ${n.length>20?u`<div class="history-more">… +${n.length-20} ${r("older_entries",t)||"older"}</div>`:p}
              </div>
            `}
      </div>
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?u`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&Promise.resolve().then(()=>(S(),I)).then(({openObjectQuickActions:o})=>{o(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${t.next_due?u`<span><strong>${r("next_due",e)||"Next due"}:</strong> ${Te(t.next_due,e)}</span>`:p}
                  ${t.last_performed?u`<span><strong>${r("last_performed",e)||"Last"}:</strong> ${Te(t.last_performed,e)}</span>`:p}
                  ${t.interval_days!=null?u`<span><strong>${r("interval",e)||"Interval"}:</strong> ${t.interval_days}d</span>`:p}
                </div>
              </div>
              ...
              ${this._showSkip?u`
                  ...
                  `}
            `:u`<div class="loading">${r("loading",e)||"Loading\u2026"}</div>`}
      </div>
    `}};z.styles=w`
    :host { display: contents; }
    .backdrop {
  ...
  `,c([b({attribute:!1})],z.prototype,"hass",2),c([d()],z.prototype,"_open",2),c([d()],z.prototype,"_entryId",2),c([d()],z.prototype,"_taskId",2),c([d()],z.prototype,"_task",2),c([d()],z.prototype,"_objectName",2),c([d()],z.prototype,"_busy",2),c([d()],z.prototype,"_error",2),c([d()],z.prototype,"_showSkip",2),c([d()],z.prototype,"_showReset",2),c([d()],z.prototype,"_showDetails",2),c([d()],z.prototype,"_skipReason",2),c([d()],z.prototype,"_resetDate",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",z)});var q,Ct=v(()=>{"use strict";C();F();N();V();q=class extends y{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error=""}get _lang(){return this.hass?.language||"en"}async openFor(e){this._entryId=e,this._error="",this._open=!0,await this._load()}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=e}catch(e){this._error=j(e,this._lang)}}_onEditObject(){!this._entryId||!this._data||Promise.resolve().then(()=>(S(),I)).then(({openEditObjectDialog:e})=>{e(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&Promise.resolve().then(()=>(S(),I)).then(({openCreateTaskDialog:e})=>{e(),this.close()})}async _onDelete(){if(!this._entryId||!this._data)return;let e=r("delete_object_confirm",this._lang)||`Delete "${this._data.object.name}" and all its tasks?`;if(window.confirm(e)){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=j(t,this._lang)}finally{this._busy=!1}}}_onTaskClick(e){this._entryId&&Promise.resolve().then(()=>(S(),I)).then(({openTaskQuickActions:t})=>{t(this._entryId,e)})}render(){if(!this._open)return p;let e=this._lang,t=this._data,n=t?.object,o=t?.tasks||[],l=this.hass?.user?.is_admin??!0;return u`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${t&&n?u`
              <div class="header">
              ...
              <div class="tasks-section">
                ...
                ${o.length===0?u`<div class="empty">${r("no_tasks",e)||"No tasks yet."}</div>`:u`
                      <div class="task-list">
                        ${o.map(s=>u`
                          <div class="task-row" @click=${()=>this._onTaskClick(s.id)}>
                            <span class="status-dot" style="background: ${me[s.status]||"#ccc"}"></span>
                            <span class="task-name">${s.name}</span>
                            <span class="task-status">${r(s.status||"ok",e)}</span>
                          </div>
                        `)}
                      </div>
                    `}
    ...
    `}_renderMetaRow(e){let t=this._lang,n=[];return e.area_id&&n.push([r("area",t)||"Area",e.area_id]),e.manufacturer&&n.push([r("manufacturer",t)||"Manufacturer",e.manufacturer]),e.model&&n.push([r("model",t)||"Model",e.model]),e.serial_number&&n.push([r("serial_number",t)||"Serial",e.serial_number]),e.installation_date&&n.push([r("installation_date",t)||"Installed",e.installation_date]),e.documentation_url&&n.push([r("documentation_url",t)||"Docs",e.documentation_url]),n.length===0?p:u`
      <div class="meta">
        ${n.map(([o,l])=>u`
            <div class="meta-item">
              <span class="meta-label">${o}</span>
              <span class="meta-value">${o.toLowerCase().includes("doc")||o.toLowerCase().includes("url")?u`<a href="${l}" target="_blank" rel="noopener">${l}</a>`:l}</span>
            </div>
          `)}
      </div>
    `}};q.styles=w`
  ...
  `,c([b({attribute:!1})],q.prototype,"hass",2),c([d()],q.prototype,"_open",2),c([d()],q.prototype,"_entryId",2),c([d()],q.prototype,"_data",2),c([d()],q.prototype,"_busy",2),c([d()],q.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",q)});var I={};Bt(I,{openCompleteDialog:()=>Ta,openCreateObjectDialog:()=>Ie,openCreateTaskDialog:()=>Na,openEditObjectDialog:()=>Ca,openEditTaskDialog:()=>Re,openHistoryEditDialog:()=>De,openObjectQuickActions:()=>Me,openQrDialog:()=>Ia,openTaskQuickActions:()=>Pe});function It(){return document.querySelector("home-assistant")?.hass}function R(i){let a=document.body.querySelector(i);return a||(a=document.createElement(i),document.body.appendChild(a)),a}function D(i){let a=It();return a?(i.hass=a,!0):!1}function Ie(){let i=R(Nt);return D(i)?(i.openCreate(),!0):!1}function Ca(i,a){let e=R(Nt);return D(e)?(e.openEdit(i,a),!0):!1}function Na(){let i=R(Tt);return D(i)?(i.openCreate(),!0):!1}function Re(i,a){let e=R(Tt);return D(e)?(e.openEdit(i,{id:a}),!0):!1}function De(i){let a=R(ja);return D(a)?(a.openEdit(i),!0):!1}function Ta(i){let a=R(Aa);return D(a)?(a.entryId=i.entry_id,a.taskId=i.task_id,a.taskName=i.task_name,a.checklist=i.checklist??[],a.adaptiveEnabled=!!i.adaptive_enabled,a.lang=It()?.language||"en",a.open(),!0):!1}function Ia(i){let a=R(Sa);return D(a)?(a.openForTask(i.entry_id,i.task_id,i.object_name,i.task_name),!0):!1}function Pe(i,a){let e=R(qa);return D(e)?(e.openFor(i,a),!0):!1}function Me(i){let a=R($a);return D(a)?(a.openFor(i),!0):!1}var Nt,Tt,ja,Aa,Sa,qa,$a,S=v(()=>{"use strict";xt();Et();jt();At();qt();$t();Ct();Nt="maintenance-object-dialog",Tt="maintenance-task-dialog",ja="maintenance-history-edit-dialog",Aa="maintenance-complete-dialog",Sa="maintenance-qr-dialog",qa="maintenance-task-quick-actions-dialog",$a="maintenance-object-quick-actions-dialog"});S();var Ht="maintenance-supporter",Rt=`ll-strategy-dashboard-${Ht}`,Fe="hui-maintenance-supporter-strategy-editor",Ra="NOT_RUNNING",Da=[{status:"overdue",title:"Overdue",icon:"mdi:alert-circle",path:"overdue"},{status:"triggered",title:"Triggered",icon:"mdi:flash",path:"triggered"},{status:"due_soon",title:"Due Soon",icon:"mdi:clock-alert-outline",path:"due-soon"},{status:"ok",title:"OK",icon:"mdi:check-circle-outline",path:"ok"}],Dt=[{title:"Overdue",icon:"mdi:alert-circle",path:"overdue",filter:{filter_due_max_days:-1},matches:i=>i<=-1},{title:"Today",icon:"mdi:calendar-today",path:"today",filter:{filter_due_min_days:0,filter_due_max_days:0},matches:i=>i===0},{title:"This Week",icon:"mdi:calendar-week",path:"this-week",filter:{filter_due_min_days:1,filter_due_max_days:7},matches:i=>i>=1&&i<=7},{title:"This Month",icon:"mdi:calendar-month",path:"this-month",filter:{filter_due_min_days:8,filter_due_max_days:30},matches:i=>i>=8&&i<=30},{title:"Later",icon:"mdi:calendar-clock",path:"later",filter:{filter_due_min_days:31},matches:i=>i>=31}];function B(i){return{type:"grid",cards:[i]}}var Pa={condition:"view_columns",min:2};function Ma(i){let a={overdue:0,triggered:0,due_soon:0,ok:0,total:0};for(let e of i)for(let t of e.tasks||[])a.total++,t.status==="overdue"?a.overdue++:t.status==="triggered"?a.triggered++:t.status==="due_soon"?a.due_soon++:t.status==="ok"&&a.ok++;return a}function Fa(i){let a=[];return i.overdue&&a.push(`\u{1F534} **${i.overdue}** overdue`),i.triggered&&a.push(`\u26A1 **${i.triggered}** triggered`),i.due_soon&&a.push(`\u{1F7E1} **${i.due_soon}** due soon`),a.push(`\u{1F7E2} **${i.ok}** ok`),{type:"markdown",text_only:!0,content:a.join(" \xB7 ")}}function Oa(){return{title:"Maintenance",type:"panel",cards:[{type:"empty-state",icon:"mdi:wrench-clock",icon_color:"primary",content_only:!0,title:"No maintenance objects yet",content:"Open the Maintenance panel to add your first object \u2014 pool pump, HVAC filter, vehicle, anything that needs scheduled care.",buttons:[{icon:"mdi:wrench",text:"Open Maintenance panel",appearance:"filled",variant:"brand",tap_action:{action:"navigate",navigation_path:"/maintenance-supporter"}},{icon:"mdi:plus",text:"Add object",appearance:"outlined",variant:"brand",tap_action:{action:"fire-dom-event",ll_custom:{type:"maintenance-supporter:add-object"}}}]}]}}function La(i){let a=Fa(i);return{title:"Overview",icon:"mdi:wrench-clock",path:"overview",type:"sections",header:{layout:"responsive",card:a},sidebar:{sections:[{type:"grid",cards:[{type:"heading",heading:"Status",heading_style:"title"},a]}],visibility:[Pa],content_label:"Tasks",sidebar_label:"Status"},sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,filter_status:["overdue","triggered","due_soon"]})]}}function Ha(i,a){let e=new Map;for(let l of i){let s=l.object.area_id||null;e.has(s)||e.set(s,[]),e.get(s).push(l)}let t=Array.from(e.keys()).filter(l=>l!==null);t.sort((l,s)=>{let _=a[l]?.name||l,g=a[s]?.name||s;return _.localeCompare(g)});let n=[];for(let l of t){let s=e.get(l);if(s.length===0)continue;let _=a[l];n.push({title:_?.name||l,icon:_?.icon||"mdi:floor-plan",path:`area-${l}`,type:"sections",sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:s.map(g=>g.object.name)})]})}let o=e.get(null);return o&&o.length>0&&n.push({title:"Unassigned",icon:"mdi:help-circle-outline",path:"unassigned",type:"sections",sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:o.map(l=>l.object.name)})]}),n}function Ua(i){let a=new Set;for(let t of i)for(let n of t.tasks||[])n.status&&a.add(n.status);let e=[];for(let t of Da)a.has(t.status)&&e.push({title:t.title,icon:t.icon,path:t.path,type:"sections",sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,filter_status:[t.status]})]});return e}function Va(i,a,e){let t=new Map;for(let s of i){let _=s.object.area_id,g=_&&a[_]?.floor_id||null;t.has(g)||t.set(g,[]),t.get(g).push(s)}let n=Array.from(t.keys()).filter(s=>s!==null);n.sort((s,_)=>{let g=e[s],f=e[_],h=g?.level??0,E=f?.level??0;return h!==E?h-E:(g?.name||s).localeCompare(f?.name||_)});let o=[];for(let s of n){let _=t.get(s);if(_.length===0)continue;let g=e[s];o.push({title:g?.name||s,icon:g?.icon||"mdi:home-floor-1",path:`floor-${s}`,type:"sections",sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:_.map(f=>f.object.name)})]})}let l=t.get(null);return l&&l.length>0&&o.push({title:"Other",icon:"mdi:help-circle-outline",path:"other",type:"sections",sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,filter_objects:l.map(s=>s.object.name)})]}),o}function Ba(i){return[{title:"Week",icon:"mdi:calendar-week",path:"cal-7",window_days:7},{title:"Fortnight",icon:"mdi:calendar-week-begin",path:"cal-14",window_days:14},{title:"Month",icon:"mdi:calendar-month",path:"cal-30",window_days:30},{title:"Year",icon:"mdi:calendar-clock",path:"cal-365",window_days:365}].map(e=>({title:e.title,icon:e.icon,path:e.path,type:"panel",cards:[{type:"custom:maintenance-supporter-calendar-card",window_days:e.window_days,show_window_chips:!1,show_user_filter:!0}]}))}function Ga(i){let a=new Set;for(let t of i)for(let n of t.tasks||[]){let o=n.days_until_due;o!=null&&Dt.forEach((l,s)=>{l.matches(o)&&a.add(s)})}let e=[];return Dt.forEach((t,n)=>{a.has(n)&&e.push({title:t.title,icon:t.icon,path:t.path,type:"sections",sections:[B({type:"custom:maintenance-supporter-card",show_header:!1,...t.filter})]})}),e}var Oe=class extends HTMLElement{static getCreateSuggestions(a){return{title:"Maintenance Supporter",icon:"mdi:wrench-clock"}}static async getConfigElement(){return document.createElement(Fe)}static async generate(a,e){if(e.config?.state===Ra)return{views:[{type:"sections",sections:[{cards:[{type:"starting"}]}]}]};if(e.config?.recovery_mode)return{views:[{type:"sections",sections:[{cards:[{type:"recovery-mode"}]}]}]};let t;try{t=await e.connection.sendMessagePromise({type:"maintenance_supporter/objects"})}catch{return{title:"Maintenance",views:[{title:"Maintenance",cards:[{type:"markdown",content:"**Maintenance Supporter** is not loaded. Install/enable the integration first."}]}]}}let n=t.objects||[];if(n.length===0)return{title:"Maintenance",views:[Oa()]};let o=Ma(n),l=a?.group_by??"area",s={area:()=>Ha(n,e.areas||{}),status:()=>Ua(n),floor:()=>Va(n,e.areas||{},e.floors||{}),due_date:()=>Ga(n),calendar:()=>Ba(n)};return{title:"Maintenance",views:[La(o),...(s[l]??s.area)()]}}},Wa=[{value:"area",label:"By area (default)"},{value:"status",label:"By status (Overdue / Triggered / Due Soon / OK)"},{value:"floor",label:"By floor (uses HA floors)"},{value:"due_date",label:"By due date (Overdue / Today / Week / Month / Later)"},{value:"calendar",label:"Rolling calendar (Week / Fortnight / Month / Year)"}],Le=class extends HTMLElement{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter"}}set hass(e){this._hass=e}setConfig(e){this._config=e,this._render()}connectedCallback(){this._render()}_render(){let e=this._config.group_by??"area",t=Wa.map(o=>`<option value="${o.value}"${o.value===e?" selected":""}>${o.label}</option>`).join("");this.innerHTML=`
      <style>
    ...
    `;let n=this.querySelector("#group-by");n?.addEventListener("change",()=>{let o={...this._config,group_by:n.value};this._config=o,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0}))})}},Ut="maintenance-supporter-section",Pt=`ll-strategy-section-${Ut}`,He=class extends HTMLElement{static async generate(a,e){let t={type:"custom:maintenance-supporter-card",show_header:!1};a?.filter_status?.length&&(t.filter_status=a.filter_status),a?.max_items&&(t.max_items=a.max_items),a?.filter_due_min_days!==void 0&&(t.filter_due_min_days=a.filter_due_min_days),a?.filter_due_max_days!==void 0&&(t.filter_due_max_days=a.filter_due_max_days);let n=a?.filter_objects;if(a?.area_id&&!n)try{n=((await e.connection.sendMessagePromise({type:"maintenance_supporter/objects"})).objects||[]).filter(s=>s.object.area_id===a.area_id).map(s=>s.object.name)}catch{}n&&n.length>0&&(t.filter_objects=n);let o=[];return a?.title&&o.push({type:"heading",heading:a.title,heading_style:"title"}),o.push(t),{type:"grid",cards:o}}};customElements.get(Rt)||customElements.define(Rt,Oe);customElements.get(Fe)||customElements.define(Fe,Le);customElements.get(Pt)||customElements.define(Pt,He);function fe(i){return{action:"fire-dom-event",ll_custom:{type:"maintenance-supporter:deep-link",path:i}}}var Ue=class extends HTMLElement{static async generate(a,e){let t={};try{t=await e.connection.sendMessagePromise({type:"maintenance_supporter/vacation/state"})}catch{}let n=t.is_active===!0,o=t.enabled===!0,l=(o||n)&&t.start&&t.end?` (${t.start} \u2192 ${t.end})`:"",s=t.exempt_task_ids?.length??0,_=(n||o)&&s?`
${s} task(s) exempt \u2014 still notified`:"",g;return n?g=`\u{1F3D6}\uFE0F **Vacation mode active**${l}${_}`:o?g=`\u{1F3D6}\uFE0F Vacation mode: scheduled${l}${_}`:g="\u{1F3D6}\uFE0F Vacation mode: inactive",{type:"grid",cards:[{type:"markdown",content:g,tap_action:fe("/maintenance-supporter?ms_action=open_vacation")}]}}},Ve=class extends HTMLElement{static async generate(a,e){let t={};try{t=await e.connection.sendMessagePromise({type:"maintenance_supporter/budget_status"})}catch{}let n=t.currency_symbol||"\u20AC",o=(t.monthly_budget??0)>0?`**Monthly:** ${(t.monthly_spent??0).toFixed(0)}/${t.monthly_budget.toFixed(0)} ${n}`:null,l=(t.yearly_budget??0)>0?`**Yearly:** ${(t.yearly_spent??0).toFixed(0)}/${t.yearly_budget.toFixed(0)} ${n}`:null,s=[o,l].filter(Boolean);return{type:"grid",cards:[{type:"markdown",content:s.length>0?`\u{1F4B0} ${s.join(" \xB7 ")}`:"\u{1F4B0} Budget tracking: not configured",tap_action:fe("/maintenance-supporter?ms_action=open_budget")}]}}},Be=class extends HTMLElement{static async generate(a,e){let t={};try{t=await e.connection.sendMessagePromise({type:"maintenance_supporter/groups"})}catch{}let n=t.groups||{},o=Object.keys(n).length;if(o===0)return{type:"grid",cards:[{type:"markdown",content:"\u{1F3F7}\uFE0F Groups: none configured",tap_action:fe("/maintenance-supporter?ms_action=open_groups")}]};let l=Object.entries(n).slice(0,8).map(([_,g])=>{let f=g.name||"Unnamed",h=g.task_refs?.length??0;return`**${f}** (${h})`}),s=o>8?`
+ ${o-8} more\u2026`:"";return{type:"grid",cards:[{type:"markdown",content:`\u{1F3F7}\uFE0F **Groups (${o})**
${l.join(" \xB7 ")}${s}`,tap_action:fe("/maintenance-supporter?ms_action=open_groups")}]}}},Mt="ll-strategy-section-maintenance-supporter-vacation",Ft="ll-strategy-section-maintenance-supporter-budget",Ot="ll-strategy-section-maintenance-supporter-groups";customElements.get(Mt)||customElements.define(Mt,Ue);customElements.get(Ft)||customElements.define(Ft,Ve);customElements.get(Ot)||customElements.define(Ot,Be);var Lt="_msSupporterLlCustomBound";function oe(i){history.pushState(null,"",i),window.dispatchEvent(new CustomEvent("location-changed"))}function Qa(){let i=window;i[Lt]||(i[Lt]=!0,document.addEventListener("ll-custom",a=>{let e=a.detail;if(!e||typeof e.type!="string"||!e.type.startsWith("maintenance-supporter:"))return;let t=e.type.slice(22);if(t==="add-object"){if(Ie())return;oe("/maintenance-supporter?ms_action=add_object");return}if(t==="open-task"&&typeof e.entry_id=="string"&&typeof e.task_id=="string"){if(Pe(e.entry_id,e.task_id)||Re(e.entry_id,e.task_id))return;oe(`/maintenance-supporter?entry_id=${encodeURIComponent(e.entry_id)}&task_id=${encodeURIComponent(e.task_id)}`);return}if(t==="open-object"&&typeof e.entry_id=="string"){if(Me(e.entry_id))return;oe(`/maintenance-supporter?entry_id=${encodeURIComponent(e.entry_id)}`);return}if(t==="deep-link"&&typeof e.path=="string"){oe(e.path);return}if(t==="edit-history"&&typeof e.entry_id=="string"&&typeof e.task_id=="string"&&typeof e.original_timestamp=="string"){let o=document.querySelector("home-assistant")?.hass;if(!o)return;(async()=>{try{let _=(await o.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:e.entry_id})).tasks?.find(g=>g.id===e.task_id)?.history?.find(g=>g.timestamp===e.original_timestamp);if(!_)return;De({entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.original_timestamp,type:_.type||"completed",timestamp:_.timestamp||e.original_timestamp,notes:_.notes??null,cost:_.cost??null,duration:_.duration??null,completed_by:_.completed_by??null})}catch{oe("/maintenance-supporter")}})();return}}))}Qa();var ve=window;ve.customStrategies=ve.customStrategies||[];function re(i){ve.customStrategies.some(e=>e.type===i.type&&e.strategyType===i.strategyType)||ve.customStrategies.push(i)}re({type:Ht,strategyType:"dashboard",name:"Maintenance Supporter",description:"Auto-generated dashboard. Group views by area, status, floor, or due date \u2014 picked from the strategy editor or YAML.",documentationURL:"https://github.com/iluebbe/maintenance_supporter#dashboard-strategy"});re({type:Ut,strategyType:"section",name:"Maintenance Supporter \u2014 Section",description:"Embed maintenance tasks (filterable by area, status, due date) as a section in any dashboard view.",documentationURL:"https://github.com/iluebbe/maintenance_supporter#section-strategy"});re({type:"maintenance-supporter-vacation",strategyType:"section",name:"Maintenance Supporter \u2014 Vacation Status",description:"Compact vacation-mode status banner. Tap to open settings in the panel."});re({type:"maintenance-supporter-budget",strategyType:"section",name:"Maintenance Supporter \u2014 Budget Status",description:"Monthly + yearly maintenance budget overview. Tap for details."});re({type:"maintenance-supporter-groups",strategyType:"section",name:"Maintenance Supporter \u2014 Groups",description:"List of configured task groups with member counts."});
