...
`});function pt(s){if(!s)return[];let r=[],e=s.photo_doc_id;typeof e=="string"&&r.push(e);let t=s.photo_doc_ids;Array.isArray(t)&&r.push(...t);let i=[];for(let a of r){if(typeof a!="string")continue;let o=a.trim();if(!(!o||i.includes(o))&&(i.push(o),i.length>=10))break}return i}var ut=x(()=>{"use strict"});function dr(){let s=new Uint8Array(4);return(globalThis.crypto??{getRandomValues:r=>r.map(()=>Math.floor(Math.random()*256))}).getRandomValues(s),Array.from(s,r=>r.toString(16).padStart(2,"0")).join("")}function ce(s){let r=s?.reading_values;if(!Array.isArray(r))return[];let e=[],t=new Set;for(let i of r){if(!i||typeof i!="object")continue;let a=i;typeof a.id!="string"||!a.id||t.has(a.id)||typeof a.value!="number"||!Number.isFinite(a.value)||(t.add(a.id),e.push({id:a.id,name:typeof a.name=="string"?a.name:a.id,unit:typeof a.unit=="string"?a.unit:null,value:a.value}))}return e}function cr(s){return s.filter(r=>r.type==="completed"&&(r.reading_value!=null||ce(r).length>0)).sort((r,e)=>r.timestamp.localeCompare(e.timestamp))}function pr(s){return cr(s??[]).map(r=>({timestamp:r.timestamp,values:ce(r)})).filter(r=>r.values.length>0)}function ur(s,r,e){let t;for(let i of s){if(e!==void 0){let o=new Date(i.timestamp).getTime();if(!isNaN(o)&&o>=e)break}let a=i.values.find(o=>o.id===r);a&&(t=a)}return t}function hr(s,r,e){let t=ce(r).find(a=>a.id===e);if(!t)return null;let i=null;for(let a of cr(s)){if(a.timestamp>=r.timestamp)break;let o=ce(a).find(_=>_.id===e);o&&(i=o.value)}return i==null?null:t.value-i}function _r(s){let r=new Set,e=new Set;for(let t of s){let i=(t.name||"").trim().toLowerCase();i&&(r.has(i)?e.add(t.id):r.add(i))}return e}function mr(s){let r=[],e=new Set,t=new Set;for(let i of s){let a=(i.name||"").trim();if(!(!a||e.has(i.id)||t.has(a.toLowerCase()))&&(e.add(i.id),t.add(a.toLowerCase()),r.push({id:i.id,name:a,unit:(i.unit||"").trim()||null}),r.length>=20))break}return r}var xe=x(()=>{"use strict"});function Ot(s,r,e,t){let i=e,a=c=>typeof c=="string"?c:null,o=c=>typeof c=="number"?c:null,_=a(i.timestamp)??"";return{entry_id:s,task_id:r,original_timestamp:_,type:a(i.type)||"completed",timestamp:_,notes:a(i.notes),cost:o(i.cost),duration:o(i.duration),completed_by:a(i.completed_by),used_parts:Array.isArray(i.used_parts)?i.used_parts:null,photo_doc_ids:pt(i),reading_value:o(i.reading_value),reading_values:ce(i),readings:t?.readings??[],task_type:t?.type??null,reading_unit:t?.reading_unit??null}}async function gr(s,r,e,t){let a=(await s.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:r})).tasks?.find(_=>_.id===e),o=a?.history?.find(_=>_.timestamp===t);return!a||!o?null:Ot(r,e,o,a)}var Mt=x(()=>{"use strict";ut();xe()});function ln(s){let r=s.replace(/_ids?$/,"").split("_").filter(Boolean);if(r.length===0)return s;let e=r.join(" ");return e.charAt(0).toUpperCase()+e.slice(1)}function dn(s,r){let e=on[s];if(e){let t=n(e,r);if(t&&t!==e)return t}return ln(s)}function cn(s){let r=[...s.matchAll(/\['([^']+)'\]/g)].map(i=>i[1]),e=r.length?r[r.length-1]:void 0,t;return(t=s.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=s.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=s.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=s.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(s)?{field:e,rule:"required"}:(t=s.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(s)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(s)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function pn(s,r){let e=new Set(fr(r));return fr(s).every(t=>e.has(t))}function N(s,r,e){if(e=e??n("action_error",r),typeof s=="string")return s;if(typeof s!="object"||s===null)return e;let t=s,i=t.message||t.error?.message||"",a=t.code||t.error?.code||"",o=a?an[a]:void 0;if(!i&&!o)return e;let _=cn(i),c=_.field?dn(_.field,r):"",p=m=>n(m,r).replace("{field}",c).replace("{n}",_.param??"");switch(_.rule){case"too_long":return p("err_too_long");case"too_short":return p("err_too_short");case"value_too_high":return p("err_value_too_high");case"value_too_low":return p("err_value_too_low");case"required":return p("err_required");case"wrong_type":return p("err_wrong_type").replace("{type}",_.param??"");case"invalid_choice":return p("err_invalid_choice");case"invalid_value":return p("err_invalid_value");default:if(o){let m=n(o,r);return i&&!pn(i,a)?`${m} (${i})`:m}return i||e}}var an,on,fr,pe=x(()=>{"use strict";C();an={already_archived:"ws_err_already_archived",already_paused:"ws_err_already_paused",archived:"ws_err_archived",create_failed:"ws_err_create_failed",duplicate_failed:"ws_err_duplicate_failed",empty:"ws_err_empty",empty_csv:"ws_err_empty_csv",invalid_cursor:"ws_err_invalid_cursor",invalid_date:"ws_err_invalid_date",invalid_device:"ws_err_invalid_device",invalid_entity_slug:"ws_err_invalid_entity_slug",invalid_format:"ws_err_invalid_format",invalid_input:"ws_err_invalid_input",invalid_mirror_todo:"ws_err_invalid_mirror_todo",invalid_parent:"ws_err_invalid_parent",invalid_range:"ws_err_invalid_range",invalid_search_template:"ws_err_invalid_search_template",invalid_target:"ws_err_invalid_target",invalid_trigger_config:"ws_err_invalid_trigger_config",invalid_url:"ws_err_invalid_url",invalid_user:"ws_err_invalid_user",invalid_view:"ws_err_invalid_view",limit_reached:"ws_err_limit_reached",no_defaults:"ws_err_no_defaults",no_phases:"ws_err_no_phases",no_url:"ws_err_no_url",not_archived:"ws_err_not_archived",not_available:"ws_err_not_available",not_configured:"ws_err_not_configured",not_found:"ws_err_not_found",not_loaded:"ws_err_not_loaded",not_paused:"ws_err_not_paused",replace_failed:"ws_err_replace_failed",self_link_device:"ws_err_self_link_device",storage_unavailable:"ws_err_storage_unavailable",too_early:"ws_err_too_early",too_large:"ws_err_too_large",too_many:"ws_err_too_many",too_many_views:"ws_err_too_many_views",unauthorized:"ws_err_unauthorized",unavailable:"ws_err_unavailable"},on={entry_id:"object",name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",warranty_expiry:"warranty_expiry_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_equals:"trigger_equals",trigger_not_equals:"trigger_not_equals",trigger_for_minutes:"trigger_for_minutes"};fr=s=>s.toLowerCase().split(/[^a-z0-9]+/).filter(r=>r.length>1)});var j,zt=x(()=>{"use strict";I();F();j=class extends S{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return l`
  ...
  `,d([v()],j.prototype,"label",2),d([v()],j.prototype,"value",2),d([v()],j.prototype,"placeholder",2),d([v()],j.prototype,"type",2),d([v({type:Boolean})],j.prototype,"required",2),d([v({type:Boolean})],j.prototype,"disabled",2),d([v()],j.prototype,"step",2),d([v()],j.prototype,"min",2),d([v()],j.prototype,"max",2),d([v()],j.prototype,"pattern",2),d([v()],j.prototype,"helper",2),d([v({type:Boolean})],j.prototype,"multiline",2),d([v({type:Number})],j.prototype,"rows",2);customElements.get("ms-textfield")||customElements.define("ms-textfield",j)});function un(s){let e=B("2001-02-03",s).match(/\d+/g)||[],t=_=>e.findIndex(c=>Number(c)===_),i=t(2001),a=t(2),o=t(3);return i===0?"YMD":a>=0&&o>=0&&a<o?"MDY":"DMY"}function Ce(s,r,e){if(s<1e3||s>9999||r<1||r>12||e<1||e>31)return null;let t=new Date(s,r-1,e);return t.getFullYear()!==s||t.getMonth()!==r-1||t.getDate()!==e?null:`${s}-${String(r).padStart(2,"0")}-${String(e).padStart(2,"0")}`}function vr(s,r){let e=s.trim(),t;if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})$/))return Ce(+t[1],+t[2],+t[3]);if(t=e.match(/^(\d{4})$/))return Ce(+t[1],1,1);if(t=e.match(/^(\d{1,2})[./](\d{4})$/))return Ce(+t[2],+t[1],1);if(t=e.match(/^(\d{1,2})\.(\d{1,2})\.(\d{4})$/))return Ce(+t[3],+t[2],+t[1]);if(t=e.match(/^(\d{1,2})[/-](\d{1,2})[/-](\d{4})$/)){let i=+t[1],a=+t[2],o=+t[3];return un(r)==="MDY"?Ce(o,i,a):Ce(o,a,i)}return null}var yr=x(()=>{"use strict";C()});function hn(s,r){if(r)switch(s){case"date":return r.split("T")[0];case"time":return r.length===5?`${r}:00`:r;case"datetime":{let[e,t="00:00:00"]=r.split("T");return`${e} ${t.length===5?`${t}:00`:t}`}}}function _n(s,r){if(typeof r!="string"||!r)return"";switch(s){case"date":return r.slice(0,10);case"time":return r.slice(0,5);case"datetime":{let[e,t="00:00:00"]=r.split(" ");return`${e}T${t.length===5?`${t}:00`:t}`}}}var M,Ie=x(()=>{"use strict";I();F();C();yr();M=class extends S{constructor(){super(...arguments);this.kind="date";this.label="";this.value="";this.clearable=!1;this.disabled=!1;this.required=!1;this.lang="en";this._typing=!1;this._typed="";this._typedInvalid=!1}_startTyping(){this._typed=this.value,this._typedInvalid=!1,this._typing=!0,this.updateComplete.then(()=>this.shadowRoot?.querySelector("input.typed")?.focus())}_commitTyped(){if(!this._typed.trim()){this._typing=!1;return}let e=vr(this._typed,this.lang);if(!e){this._typedInvalid=!0;return}this._typing=!1,this._typedInvalid=!1,this._emit(e)}_onTypedKey(e){e.key==="Enter"?(e.preventDefault(),this._commitTyped()):e.key==="Escape"&&(e.preventDefault(),this._typing=!1,this._typedInvalid=!1)}_selector(){switch(this.kind){case"date":return{date:{}};case"time":return{time:{no_second:!0}};case"datetime":return{datetime:{}}}}_onSelectorChange(e){e.stopPropagation(),this._emit(_n(this.kind,e.detail?.value))}_clear(){this._emit("")}_emit(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{bubbles:!0,composed:!0,detail:{value:e}})))}render(){return l`
      <div class="field">
        ${this.label?l`<span class="label">${this.label}${this.required?l`<span class="req">*</span>`:u}</span>`:u}
        <div class="row">
      ...
      <div class="consumes-row">
        <label class="consumes-check">
          <input
            type="checkbox"
            .checked=${a!==void 0}
            @change=${_=>{let c={...this._consumesParts};_.target.checked?c[i]=c[i]||o:delete c[i],this._consumesParts=c}}
          />
        ...
        ${a!==void 0?l`<input
              ...
              @input=${_=>{let c=parseFloat(_.target.value);this._consumesParts={...this._consumesParts,[i]:{...o,quantity:Number.isFinite(c)&&c>=.01?c:1}}}}
            />`:u}
      </div>
    `}_toggleRequired(e,t){let i=new Set(this._requiredCompletion);t?i.add(e):i.delete(e),this._requiredCompletion=[...i]}_patchReading(e,t){this._readings=this._readings.map(i=>i.id===e?{...i,...t}:i)}_renderReadingsEditor(e){let t=_r(this._readings);return l`
              ...
              ${Bt.map(a=>l`
                <label class="req-option">
                  <input
                    ...
                    @change=${o=>{let _=o.target.checked,c=new Set(i.reqFields);_?c.add(a):c.delete(a),this._patchPhaseDef(i.id,{reqFields:[...c]})}}
                  />
                  <span>${n(Je[a],e)}</span>
                </label>
              `)}
...
`).map(p=>p.trim()).filter(Boolean).slice(0,100);e.checklist=c.length?c:null}if(this.completionActionsEnabled){let c=this._actionService.trim();if(c&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(c)){let w={service:c},y=this._actionTargetEntity.trim();y&&(w.target={entity_id:y});let $=this._buildActionData();Object.keys($).length>0&&(w.data=$),e.on_complete_action=w}else e.on_complete_action=null;let p={};this._qcNotes.trim()&&(p.notes=this._qcNotes.trim());let m=parseFloat(this._qcCost);!isNaN(m)&&m>=0&&(p.cost=m);let f=parseInt(this._qcDuration,10);!isNaN(f)&&f>=0&&(p.duration=f),this._qcFeedback&&(p.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(p).length?p:null}let i=await this.hass.connection.sendMessagePromise(e),a=this._taskId||i?.task_id,o=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;this._warning="";let _=c=>{this._warning=n("subsave_warning",this._lang).replace("{detail}",c)};if(a&&this._scheduleType==="sensor_based"&&o&&await Ut(this,{type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null},{onError:_})!==void 0&&(this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute),a&&this._adaptiveSnapshot()!==this._adaptiveInitial){let c=parseFloat(this._adaptiveAlpha),p=parseInt(this._adaptiveMin,10),m=parseInt(this._adaptiveMax,10);await Ut(this,{type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:a,enabled:this._adaptiveEnabled,...c>=.1&&c<=.9?{ewa_alpha:c}:{},...!isNaN(p)&&p>=1?{min_interval_days:p}:{},...!isNaN(m)&&m>=1?{max_interval_days:m}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction},{onError:_})!==void 0&&(this._adaptiveInitial=this._adaptiveSnapshot())}this._warning?a&&(this._taskId=a):this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=N(e,this._lang,n("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._warning="",this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return u;let e=this._lang,t=this._triggerType==="compound";return l`
      ...
      <div class="select-row">
        ...
        >
          ${xn.map(i=>l`<option value=${i} ?selected=${i===this._triggerType}>${n(i,e)}</option>`)}
        </select>
      </div>
      ...
      ${this._intervalDays?l`
          ...
          `:u}
    `}_patchCondition(e,t){this._compoundConditions=this._compoundConditions.map((i,a)=>a===e?{...i,...t}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,wn()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((t,i)=>i!==e)}_renderCompoundEditor(){let e=this._lang;return l`
      <div class="select-row">
    ...
    `}_renderCondition(e,t){let i=this._lang,a=t+1;return l`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${Lr.map(o=>l`<option value=${o} ?selected=${o===e.type}>${n(o,i)}</option>`)}
          </select>
        </div>
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${yn.map(i=>l`<option value=${i} ?selected=${i===this._priority}>${n("priority_"+i,e)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${bn.map(i=>l`<option value=${i} ?selected=${i===this._scheduleType}>${n(i,e)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="one_time"?l`
                ...
                ></ms-date-field>
              `:u}
          ${this.scheduleTimeEnabled&&Rr.includes(this._scheduleType)?l`
          ...
          ${this._scheduleType==="sensor_based"?l`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:Ar,device_class:Cr}}}]}
  ...
  `,d([v({type:String})],re.prototype,"lang",2),d([h()],re.prototype,"_open",2),d([h()],re.prototype,"_busy",2),d([h()],re.prototype,"_devices",2),d([h()],re.prototype,"_deviceIndex",2);customElements.get("ms-camera-capture")||customElements.define("ms-camera-capture",re)});var ft,K,Ze=x(()=>{"use strict";I();F();C();Gt();Jt();Jt();ft=E`
...
`,K=class extends S{constructor(){super(...arguments);this.lang="en";this.disabled=!1;this.busy=!1;this.accept="image/*";this.showCamera=!0;this.showGallery=!0;this.compact=!1;this.remaining=1/0;this._singlePick=gt();this._inAppCamera=zr()}createRenderRoot(){return this}get _locked(){return this.disabled||this.busy}_emit(e){e.length!==0&&this.dispatchEvent(new CustomEvent("files-picked",{detail:{files:e},bubbles:!0,composed:!0}))}_onInput(e){let t=e.target,i=Array.from(t.files??[]);t.value="",this._emit(i)}_onCameraClick(e){!this._inAppCamera||this._locked||(e.preventDefault(),this.querySelector("ms-camera-capture")?.open())}_onCameraUnavailable(){this._inAppCamera=!1,this.querySelector(".photo-pick-camera input")?.click()}_onKeydown(e){e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),!this._locked&&e.currentTarget.click())}render(){if(this.remaining<=0||!this.showCamera&&!this.showGallery)return u;let e=this.lang,t=this._locked?"disabled":"",i=this.busy?n("uploading",e):n("doc_camera",e),a=n(this._singlePick?"choose_photo":"choose_photos",e);return l`
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?l`<div class="used-parts">
                ...
                ${this.parts.map(i=>{let a=J({part_id:i.id,entry_id:i.entry_id}),o=this._usedParts[a],_=o!==void 0,c=i.entry_id?{part_id:i.id,quantity:1,entry_id:i.entry_id}:{part_id:i.id,quantity:1};return l`<div class="used-part-row">
                    <label class="used-part-check">
                      <input type="checkbox" .checked=${_}
                        @change=${p=>{let m={...this._usedParts};p.target.checked?m[a]=m[a]||c:delete m[a],this._usedParts=m}} />
                      <span
                    ...
                    ${_?l`<input class="used-part-qty" type="number" min="0.01" max="999" step="0.01"
                          ...
                          @input=${p=>{let m=parseFloat(p.target.value);this._usedParts={...this._usedParts,[a]:{...c,quantity:Number.isFinite(m)&&m>=.01?m:1}}}} />`:u}
                  </div>`})}
  ...
  `],d([v({attribute:!1})],k.prototype,"hass",2),d([v()],k.prototype,"entryId",2),d([v()],k.prototype,"taskId",2),d([v()],k.prototype,"taskName",2),d([v()],k.prototype,"lang",2),d([v({type:Array})],k.prototype,"checklist",2),d([v({type:Boolean})],k.prototype,"adaptiveEnabled",2),d([v()],k.prototype,"taskType",2),d([v()],k.prototype,"readingUnit",2),d([v({attribute:!1})],k.prototype,"readings",2),d([v({attribute:!1})],k.prototype,"readingHistory",2),d([v({attribute:!1})],k.prototype,"restockDefault",2),d([v({attribute:!1})],k.prototype,"restockUnitCost",2),d([v()],k.prototype,"currencySymbol",2),d([v({attribute:!1})],k.prototype,"parts",2),d([v({attribute:!1})],k.prototype,"consumesParts",2),d([v({type:Array})],k.prototype,"consumesInfo",2),d([v({type:Array})],k.prototype,"requiredFields",2),d([v()],k.prototype,"phaseLabel",2),d([v({type:Boolean})],k.prototype,"requireTagScan",2),d([v({type:Boolean})],k.prototype,"viaTagScan",2),d([h()],k.prototype,"_open",2),d([h()],k.prototype,"_notes",2),d([h()],k.prototype,"_cost",2),d([h()],k.prototype,"_duration",2),d([h()],k.prototype,"_loading",2),d([h()],k.prototype,"_error",2),d([h()],k.prototype,"_checklistState",2),d([h()],k.prototype,"_feedback",2),d([h()],k.prototype,"_readingValue",2),d([h()],k.prototype,"_readingValues",2),d([h()],k.prototype,"_restockQty",2),d([h()],k.prototype,"_completedAt",2),d([h()],k.prototype,"_usedParts",2),d([v({attribute:!1})],k.prototype,"checklistPrefill",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",k)});function Ur(s,r,e){let t=new Blob([s],{type:e}),i=URL.createObjectURL(t),a=document.createElement("a");a.href=i,a.download=r,a.target="_blank",a.rel="noopener",a.style.display="none",document.body.appendChild(a),a.dispatchEvent(new MouseEvent("click")),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(i),6e4)}var Zt=x(()=>{"use strict"});async function Pn(s,r,e=300){return(await s.connection.sendMessagePromise({type:"auth/sign_path",path:r,expires:e})).path}async function Br(s,r,e=300){return Pn(s,`/api/maintenance_supporter/document/${r}`,e)}var Vr=x(()=>{"use strict";Zt()});var ue,Xt=x(()=>{"use strict";I();F();Vr();ue=class extends S{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{this._url=await Br(this.hass,this.docId)}catch{this._failed=!0}}render(){return this._failed||!this.docId?u:this._url?l`
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),a.document.close()}_downloadSvg(e,t){let i=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),a=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;Ur(i,`qr-${Rn(a)}-${t}.svg`,"image/svg+xml")}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return l``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${n("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${n("qr_code",e)}: ${this._objectName}`,i=!!this._viewResult;return l`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
  ...
  `,d([v({attribute:!1})],Y.prototype,"hass",2),d([v()],Y.prototype,"lang",2),d([h()],Y.prototype,"_open",2),d([h()],Y.prototype,"_loading",2),d([h()],Y.prototype,"_error",2),d([h()],Y.prototype,"_viewResult",2),d([h()],Y.prototype,"_completeResult",2),d([h()],Y.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",Y)});function Ln(s,r){if(r<=0)return 0;let e=typeof s=="number"&&Number.isFinite(s)?Math.trunc(s):0;return e<0?0:e%r}function Nn(s){return!!(s?.phases&&s.phase_sequence&&s.phase_sequence.length>0)}function ei(s){if(!s||!Nn(s))return null;let r=s.phase_sequence,e=Ln(s.phase_cursor,r.length),t=r[e],i=s.phases?.[t];return i?{id:t,name:i.name,index:e,count:r.length,notes:i.notes,checklist:i.checklist!==void 0?i.checklist:s.checklist??[],consumesParts:i.consumes_parts!==void 0?i.consumes_parts:s.consumes_parts??[],requiredFields:i.required_completion_fields!==void 0?i.required_completion_fields:s.required_completion_fields??[]}:null}function Xe(s){let r=ei(s);return r?`${r.index+1}/${r.count} \xB7 ${r.name}`:""}var ti=x(()=>{"use strict"});function Gr(s){let r=s.task??null,e=r?ei(r):null,t=e?e.consumesParts:r?.consumes_parts||[],i=!!r?.part_ref,a=s.objects.find(c=>c.entry_id===s.entryId)?.parts||[],o=i?a.find(c=>c.id===r.part_ref.part_id):void 0,_=s.checklistsEnabled??!0;return{entry_id:s.entryId,task_id:s.taskId,task_name:s.taskName,checklist:e?_?e.checklist:[]:s.checklist??[],adaptive_enabled:!!s.adaptiveEnabled,required_completion_fields:e?e.requiredFields:r?.required_completion_fields||[],task_type:r?.type||"",reading_unit:r?.reading_unit||"",readings:r?.readings||[],reading_history:pr(r?.history),parts:i?[]:Tr({consumes_parts:t},s.entryId,s.objects,s.lang),consumes_parts:i?[]:t,phase_label:e?Xe(r):"",require_tag_scan:!!r?.require_tag_scan,restock_default:i?o?.restock_quantity??1:null,restock_unit_cost:i?o?.cost??null:null,currency_symbol:be({currency_symbol:s.currencySymbol}),consumes_info:t.map(c=>Sr(c,s.entryId,s.objects,s.lang)),checklist_prefill:r?.checklist_progress||{},via_tag_scan:!!s.viaTagScan}}function Qr(s,r,e){s.entryId=r.entry_id,s.taskId=r.task_id,s.taskName=r.task_name,s.lang=e,s.checklist=r.checklist??[],s.adaptiveEnabled=!!r.adaptive_enabled,s.requiredFields=r.required_completion_fields??[],s.taskType=r.task_type??"",s.readingUnit=r.reading_unit??"",s.readings=r.readings??[],s.readingHistory=r.reading_history??[],s.parts=r.parts??[],s.consumesParts=r.consumes_parts??[],s.phaseLabel=r.phase_label??"",s.requireTagScan=!!r.require_tag_scan,s.restockDefault=r.restock_default??null,s.restockUnitCost=r.restock_unit_cost??null,s.currencySymbol=be(r),s.consumesInfo=r.consumes_info??[],s.checklistPrefill=r.checklist_prefill??{},s.viaTagScan=!!r.via_tag_scan,s.open({viaTagScan:!!r.via_tag_scan})}var ii=x(()=>{"use strict";xe();_t();ti();C()});function qn(s){return s&&Jr(s.ref_no)?String(s.ref_no):null}function Zr(s,r){let e=qn(s);return e&&r&&Jr(r.ref_no)?`${e}.${r.ref_no}`:null}function Xr(s,r){return s?l`<span class="ref-chip" title=${r??""}>#${s}</span>`:u}var Jr,ri=x(()=>{"use strict";I();Jr=s=>typeof s=="number"&&Number.isInteger(s)&&s>0});var es=x(()=>{"use strict"});function jn(s,r){return s.taskRef&&r.ref_no?`${s.taskRef}-${r.ref_no}`:null}function Dn(s,r){let e=pt(r);return e.length>0?l`<div class="history-photos">
        ${e.map(t=>l`<maintenance-history-photo .hass=${s} .docId=${t}></maintenance-history-photo>`)}
      </div>`:u}function On(s,r){let e=r.lang,t=o=>L(o,e,{maximumFractionDigits:3}),i=o=>o==null?"":` (${o>=0?"+":""}${t(o)})`,a=ce(s);return a.length>0?l`<div class="history-readings">
    ...
    </span></div>`:u}function ts(s,r,e={}){let t=r.lang,{compact:i=!1,showRef:a=!0,showBadges:o=!0,showEdit:_=!0}=e,c=_&&Hn.includes(s.type);return l`
    <div class="history-entry${i?" compact":""}">
      ...
      <div class="history-content">
        ...
        <div class="history-date">${tr(s.timestamp,t)}</div>
        ${s.notes?l`<div>${s.notes}</div>`:u}
        ${Dn(r.hass,s)}
        ${On(s,r)}
        ${s.cost!=null||s.duration!=null||s.trigger_value!=null?l`<div class="history-details">
              ${s.cost!=null?l`<span>${n("cost",t)}: ${de(s.cost,r.currencySymbol,t)}</span>`:u}
  ...
  `}var Hn,is=x(()=>{"use strict";I();C();Xt();ut();ri();xe();es();Hn=["completed","reset","skipped"]});function T(s){return s.toFixed(1)}var si=x(()=>{"use strict";C()});function rs(s,r){let e=s.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return u;let a=s.interval_days??0,o=s.suggested_interval??a;return l`
  ...
  `}function Un(s,r,e){let t=s.confidence_interval_low,i=s.confidence_interval_high,a=r.suggested_interval??r.interval_days??0,o=r.interval_days??0,_=Math.max(0,t-5),p=i+5-_,m=(t-_)/p*100,f=(i-t)/p*100,w=(a-_)/p*100,y=o>0?(o-_)/p*100:-1;return l`
      ...
      <div class="prediction-grid">
        ...
        ${a&&e.environmental?l`
          <div class="prediction-item">
            ...
            ${s.environmental_entity?l`<span class="prediction-entity entity-link" @click=${_=>ar(_,s.environmental_entity)}>${s.environmental_entity}</span>`:u}
          </div>
        `:u}
      </div>
    </div>
  `}var as=x(()=>{"use strict";I();C()});function os(s,r,e,t){let i=Math.max(s||1,r);return l`
  ...
  `}var ls=x(()=>{"use strict";I();C()});function cs(s,r,e){if(!e.seasonal||!s.seasonal_factor||s.seasonal_factor===1)return u;let t=ds.map(_=>n(_,r)),i=new Date().getMonth(),a=s.seasonal_factors||s.interval_analysis?.seasonal_factors||null,o=a&&a.length===12?a:t.map((_,c)=>{let p=s.seasonal_factor||1,m=Math.sin((c-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,p+m))});return l`
    <div class="seasonal-card-compact">
      <h4>${n("seasonal_awareness",r)}</h4>
      <div class="seasonal-mini-chart">
        ${o.map((_,c)=>{let p=_*40,m=_<.9?"low":_>1.1?"high":"normal";return l`
  ...
  `}function ps(s,r){return Bn(s,r)}function Bn(s,r){let e=s.seasonal_factors??s.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return u;let t=s.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,o=100,_=8,p=o-_-4,m=Math.max(...e,1.5),f=a/12,w=f*.65,y=_+p-1/m*p;return l`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${a} ${o}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_seasonal",r)}">
        ...
        ${e.map(($,A)=>{let z=$/m*p,U=A*f+(f-w)/2,D=_+p-z,G=A===i,oe=$<1?"var(--success-color, #4caf50)":$>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return Ee`
            <rect x="${T(U)}" y="${T(D)}"
  ...
  `}var ds,us=x(()=>{"use strict";I();C();si();ds=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var R,hs=x(()=>{"use strict";I();F();C();pe();Nt();ii();ti();Mt();xe();ri();is();ss();as();ls();Ie();us();R=class extends S{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._taskRef=null;this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return H(this.hass)}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=ve(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._currencySymbol=be(e?.budget),lt(e?.budget),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(i=>i.id===this._taskId);this._task=t??null,this._taskRef=Zr(e.object,t)}catch(e){this._error=N(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=N(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(Z(),se)).then(async({openCompleteDialog:e})=>{let t=this._task,i=[];try{i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}e(Gr({entryId:this._entryId,taskId:this._taskId,taskName:t.name,task:t,objects:i,lang:this._lang,checklist:t.checklist||[],adaptiveEnabled:!!t.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(Z(),se)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(Z(),se)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=n("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=n("suggestion_applied",this._lang),this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${n("reanalyze_result",this._lang)}: ${Ke(e.recommended_interval,"days",this._lang)} (${e.data_points} pts)`:n("reanalyze_insufficient_data",this._lang),await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=N(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){if(!this._entryId||!this._taskId)return;let t=Ot(this._entryId,this._taskId,e,this._task);Promise.resolve().then(()=>(Z(),se)).then(({openHistoryEditDialog:i})=>i(t))}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return u;let t=this._lang;return l`
    ...
    `}_renderAdaptive(e){let t=this._lang,i=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,a=e.degradation_trend!=null&&e.degradation_trend!=="insufficient_data"||e.days_until_threshold!=null||e.environmental_factor!=null&&e.environmental_factor!==1,o=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,_=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1;return!i&&!a&&!o&&!_?l`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${a?ns(e,t,this._features):u}
        ${o?rs(e,t):u}
        ${_?l`
          ${cs(e,t,this._features)}
          ${e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12?ps(e,t):u}
        `:u}
      </div>
    `}_renderDetails(e){let t=this._lang,i=e.history||[],a=i.filter(c=>c.type==="completed"),o=a.reduce((c,p)=>c+(typeof p.cost=="number"?p.cost:0),0),_=(()=>{let c=a.map(p=>typeof p.duration=="number"?p.duration:null).filter(p=>p!=null);return c.length?Math.round(c.reduce((p,m)=>p+m,0)/c.length):null})();return l`
      <div class="details">
        ...
        ${i.length===0?l`<div class="history-empty">${n("history_empty",t)}</div>`:l`
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(c=>ts(c,{lang:t,hass:this.hass,currencySymbol:this._currencySymbol,openEdit:p=>this._onEditHistoryEntry(p),readingUnit:e.reading_unit,readingSlotDelta:(p,m)=>hr(i,p,m),taskRef:this._taskRef},{compact:!0}))}
        ...
        ${t?l`
              <div class="header">
                ...
                <div class="quick-info">
                  ...
                  ${t.schedule?.kind&&!["manual","one_time"].includes(t.schedule.kind)||t.interval_days!=null?l`<span><strong>${n("interval",e)}:</strong> ${nr(t,e)}</span>`:u}
        ...
        ${t&&i?l`
              ...
              ${i.notes?l`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${gs(i.notes)}</div>
                    </div>
                  `:u}
      ...
      <div class="meta">
        ${i.map(([a,o])=>l`
            <div class="meta-item">
              ...
              <span class="meta-value">${_s(o)?l`<a href="${o}" target="_blank" rel="noopener noreferrer">${o}</a>`:o}</span>
            </div>
          `)}
      </div>
    `}};X.styles=E`
  ...
  `,d([v({attribute:!1})],X.prototype,"hass",2),d([h()],X.prototype,"_open",2),d([h()],X.prototype,"_entryId",2),d([h()],X.prototype,"_data",2),d([h()],X.prototype,"_busy",2),d([h()],X.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",X)});function ys(){let s=window;return s.__msSettingsCache??={promise:null}}function vt(s){let r=ys();if(r.promise)return r.promise;let e=s.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(t=>({features:t.features??ni.features,defaultWarningDays:t.general?.default_warning_days??7,rowActionStyle:t.general?.row_action_style??ni.rowActionStyle})).catch(()=>(r.promise===e&&(r.promise=null),ni));return r.promise=e,e}function bs(){ys().promise=null}var ni,xs=x(()=>{"use strict";ni={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"}});var se={};Ts(se,{__resetSettingsCacheForTests:()=>Zn,getRowActionStyle:()=>Jn,openCompleteDialog:()=>ra,openCreateObjectDialog:()=>Xn,openCreateTaskDialog:()=>ta,openEditObjectDialog:()=>ea,openEditTaskDialog:()=>ia,openHistoryEditDialog:()=>ai,openObjectQuickActions:()=>na,openQrDialog:()=>sa,openTaskQuickActions:()=>oi});function yt(){return document.querySelector("home-assistant")?.hass}function Qn(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function ne(s){let r=Qn(),e=r.querySelector(s)??document.body.querySelector(s);return e?e.parentNode!==r&&r.appendChild(e):(e=document.createElement(s),r.appendChild(e)),e}function ae(s){let r=yt();if(!r)return!1;s.hass=r;let e=H(r);return Ge(e)||Qe(e).then(()=>{s.requestUpdate?.()}),jt(r.locale,r.config?.country),!0}function Jn(s){return vt(s).then(r=>r.rowActionStyle)}function Zn(){bs()}function Xn(){let s=ne(ws);return ae(s)?(s.openCreate(),!0):!1}function ea(s,r){let e=ne(ws);return ae(e)?(e.openEdit(s,r),!0):!1}function ta(s="",r){let e=ne($s);if(!ae(e))return!1;let t=yt();return t?((async()=>{let i=await vt(t),a=e;a.checklistsEnabled=i.features.checklists,a.scheduleTimeEnabled=i.features.schedule_time,a.completionActionsEnabled=i.features.completion_actions,a.defaultWarningDays=i.defaultWarningDays,a.openCreate(s,r)})(),!0):!1}function ia(s,r){let e=ne($s);if(!ae(e))return!1;let t=yt();return t?((async()=>{try{let[i,a]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:s}),vt(t)]),o=(i.tasks||[]).find(c=>c.id===r);if(!o){console.warn(`openEditTaskDialog: task ${r} not found in entry ${s}`);return}let _=e;_.checklistsEnabled=a.features.checklists,_.scheduleTimeEnabled=a.features.schedule_time,_.completionActionsEnabled=a.features.completion_actions,_.defaultWarningDays=a.defaultWarningDays,await _.openEdit(s,o)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function ai(s){let r=ne(Vn);return ae(r)?(r.openEdit(s),!0):!1}function ra(s){let r=ne(Wn);return ae(r)?(Qr(r,s,H(yt())),!0):!1}function sa(s){let r=ne(Kn);return ae(r)?(r.openForTask(s.entry_id,s.task_id,s.object_name,s.task_name),!0):!1}function oi(s,r){let e=ne(Yn);return ae(e)?(e.openFor(s,r),!0):!1}function na(s){let r=ne(Gn);return ae(r)?(r.openFor(s),!0):!1}var ws,$s,Vn,Wn,Kn,Yn,Gn,Z=x(()=>{"use strict";br();Nr();Fr();Wr();Yr();hs();vs();C();ii();xs();ws="maintenance-object-dialog",$s="maintenance-task-dialog",Vn="maintenance-history-edit-dialog",Wn="maintenance-complete-dialog",Kn="maintenance-qr-dialog",Yn="maintenance-task-quick-actions-dialog",Gn="maintenance-object-quick-actions-dialog"});I();F();Nt();I();var Fi=E`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;C();function lr(s){let r=window;r.customCards=r.customCards||[],r.customCards.some(e=>e.type===s.type)||r.customCards.push(s)}Mt();Z();var W=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){if(this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter),typeof e.object_filter=="string")this._objectFilter=e.object_filter,this._configuredObjects=[];else if(Array.isArray(e.object_filter)){let t=e.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=t.length===1?t[0]:"",this._configuredObjects=t.length>1?t:[]}}getCardSize(){return 6}get _lang(){return H(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){if(super.updated(e),Gi(this,e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t,lt(this._stats.budget)}catch{}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}_onEventClick(e){if(e.history_timestamp){this._openHistoryEntry(e);return}oi(e.entry_id,e.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(e){try{let t=await gr(this.hass,e.entry_id,e.task_id,e.history_timestamp);if(!t||ai(t))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return u;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,o=null;this._userFilter&&(o=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let _=b=>{let Q=b.toLowerCase();return this._objects.find(q=>q.entry_id===b||q.object.name.toLowerCase()===Q)?.entry_id??null},c=new Set(this._configuredObjects.map(_).filter(b=>b!==null)),p=c.size?this._objects.filter(b=>c.has(b.entry_id)):this._objects,m=this._config.show_object_filter!==!1&&p.length>1,f=this._objectFilter?_(this._objectFilter):null,w=f&&p.some(b=>b.entry_id===f)?p.filter(b=>b.entry_id===f):p,y=new Date;y.setHours(0,0,0,0);let $=this._pastDays>0,A=$?zi(w,y,this._pastDays,o):Mi(w,y,this._windowDays,o),z=ve(y),U=this._windowDays===365||$,D=U?A.filter(b=>b.events.length>0):A,G=b=>{let Q=`cal-status-${b.status}`,we=b.projected?"cal-event-projected":"",q=b.status==="overdue"&&b.days_until_due!=null?` (${ir(b.days_until_due,e)})`:"",O=b.projected&&b.interval_days?l`<span class="cal-event-recur">${b.interval_unit&&b.interval_unit!=="days"?`${b.interval_days} ${n("unit_"+b.interval_unit,e)}`:n("cal_every_n_days",e).replace("{n}",String(b.interval_days))}</span>`:u,he=b.schedule_type==="sensor_based",Ne=he?l`<ha-icon class="cal-event-icon cal-source-sensor"
          ...
          </span>`:u,ks=be(this._stats?.budget),Es=b.history_type?n(b.history_type,e):n(b.status,e);return l`
        <div class="cal-event ${we}"
          @click=${()=>this._onEventClick(b)}>
          ${Ne}
          <span class="cal-status-pill ${Q}">${Es}</span>
          <div class="cal-event-body">
            <div class="cal-event-title">${b.object_name} · ${b.task_name}${q}</div>
            ${qe}
            ${O}
          </div>
          ${b.avg_cost!=null&&b.avg_cost>0?l`<span class="cal-event-cost">${de(b.avg_cost,ks,e)}</span>`:u}
        </div>
      `},oe=b=>{let[Q,we,q]=b.date.split("-").map(Number),O=new Date(Q,we-1,q),he=b.date===z,Ne=rr(O,e,"short"),qe=sr(O,e,"long");return l`
    ...
    `],d([v({attribute:!1})],W.prototype,"hass",2),d([h()],W.prototype,"_config",2),d([h()],W.prototype,"_objects",2),d([h()],W.prototype,"_stats",2),d([h()],W.prototype,"_windowDays",2),d([h()],W.prototype,"_pastDays",2),d([h()],W.prototype,"_userFilter",2),d([h()],W.prototype,"_objectFilter",2),d([h()],W.prototype,"_unsub",2);var aa=[{value:7,key:"cal_editor_window_week"},{value:14,key:"cal_editor_window_fortnight"},{value:30,key:"cal_editor_window_month"},{value:365,key:"cal_editor_window_year"}],Le=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}get _lang(){return H(this.hass)}setConfig(e){this._config={...e}}updated(){let e=this._lang;e&&!Ge(e)&&Qe(e).then(()=>this.requestUpdate())}_valueChanged(e,t){let i={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete i.show_window_chips,e==="show_user_filter"&&t===!0&&delete i.show_user_filter,e==="show_object_filter"&&t===!0&&delete i.show_object_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete i.title,e==="user_filter"&&t===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let e=this._lang,t=this._config.window_days??30,i=this._config.show_window_chips!==!1,a=this._config.show_user_filter!==!1,o=this._config.user_filter??"",_=this._config.title??"";return l`
      <div class="editor">
        ...
        <div class="row">
          ...
          >
            ${aa.map(c=>l`<option value="${c.value}" ?selected=${c.value===t}>${n(c.key,e)}</option>`)}
          </select>
        </div>
  ...
  `,d([v({attribute:!1})],Le.prototype,"hass",2),d([h()],Le.prototype,"_config",2);customElements.get("maintenance-supporter-calendar-card")||customElements.define("maintenance-supporter-calendar-card",W);customElements.get("maintenance-supporter-calendar-card-editor")||customElements.define("maintenance-supporter-calendar-card-editor",Le);lr({type:"maintenance-supporter-calendar-card",name:"Maintenance Supporter \u2014 Calendar",description:"Rolling calendar of maintenance tasks with 7/14/30/365 day windows, source icons, and prediction-confidence pills.",preview:!0});export{W as MaintenanceCalendarCard};
