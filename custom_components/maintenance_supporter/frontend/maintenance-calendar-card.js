var et=Object.defineProperty;var tt=Object.getOwnPropertyDescriptor;var v=(n,e,t,o)=>{for(var r=o>1?void 0:o?tt(e,t):e,a=n.length-1,s;a>=0;a--)(s=n[a])&&(r=(o?s(e,t,r):s(r))||r);return o&&r&&et(e,t,r),r};var Q=globalThis,J=Q.ShadowRoot&&(Q.ShadyCSS===void 0||Q.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,se=Symbol(),ve=new WeakMap,U=class{constructor(e,t,o){if(this._$cssResult$=!0,o!==se)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(J&&e===void 0){let o=t!==void 0&&t.length===1;o&&(e=ve.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),o&&ve.set(t,e))}return e}toString(){return this.cssText}},xe=n=>new U(typeof n=="string"?n:n+"",void 0,se),x=(n,...e)=>{let t=n.length===1?n[0]:e.reduce((o,r,a)=>o+(s=>{if(s._$cssResult$===!0)return s.cssText;if(typeof s=="number")return s;throw Error("Value passed to 'css' function must be a 'css' function result: "+s+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+n[a+1],n[0]);return new U(t,n,se)},we=(n,e)=>{if(J)n.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let o=document.createElement("style"),r=Q.litNonce;r!==void 0&&o.setAttribute("nonce",r),o.textContent=t.cssText,n.appendChild(o)}},ie=J?n=>n:n=>n instanceof CSSStyleSheet?(e=>{let t="";for(let o of e.cssRules)t+=o.cssText;return xe(t)})(n):n;var{is:ot,defineProperty:rt,getOwnPropertyDescriptor:nt,getOwnPropertyNames:at,getOwnPropertySymbols:st,getPrototypeOf:it}=Object,Z=globalThis,ke=Z.trustedTypes,lt=ke?ke.emptyScript:"",ct=Z.reactiveElementPolyfillSupport,q=(n,e)=>n,H={toAttribute(n,e){switch(e){case Boolean:n=n?lt:null;break;case Object:case Array:n=n==null?n:JSON.stringify(n)}return n},fromAttribute(n,e){let t=n;switch(e){case Boolean:t=n!==null;break;case Number:t=n===null?null:Number(n);break;case Object:case Array:try{t=JSON.parse(n)}catch{t=null}}return t}},X=(n,e)=>!ot(n,e),Se={attribute:!0,type:String,converter:H,reflect:!1,useDefault:!1,hasChanged:X};Symbol.metadata??=Symbol("metadata"),Z.litPropertyMetadata??=new WeakMap;var w=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=Se){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let o=Symbol(),r=this.getPropertyDescriptor(e,o,t);r!==void 0&&rt(this.prototype,e,r)}}static getPropertyDescriptor(e,t,o){let{get:r,set:a}=nt(this.prototype,e)??{get(){return this[t]},set(s){this[t]=s}};return{get:r,set(s){let i=r?.call(this);a?.call(this,s),this.requestUpdate(e,i,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Se}static _$Ei(){if(this.hasOwnProperty(q("elementProperties")))return;let e=it(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(q("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(q("properties"))){let t=this.properties,o=[...at(t),...st(t)];for(let r of o)this.createProperty(r,t[r])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[o,r]of t)this.elementProperties.set(o,r)}this._$Eh=new Map;for(let[t,o]of this.elementProperties){let r=this._$Eu(t,o);r!==void 0&&this._$Eh.set(r,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let o=new Set(e.flat(1/0).reverse());for(let r of o)t.unshift(ie(r))}else e!==void 0&&t.push(ie(e));return t}static _$Eu(e,t){let o=t.attribute;return o===!1?void 0:typeof o=="string"?o:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let o of t.keys())this.hasOwnProperty(o)&&(e.set(o,this[o]),delete this[o]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return we(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,o){this._$AK(e,o)}_$ET(e,t){let o=this.constructor.elementProperties.get(e),r=this.constructor._$Eu(e,o);if(r!==void 0&&o.reflect===!0){let a=(o.converter?.toAttribute!==void 0?o.converter:H).toAttribute(t,o.type);this._$Em=e,a==null?this.removeAttribute(r):this.setAttribute(r,a),this._$Em=null}}_$AK(e,t){let o=this.constructor,r=o._$Eh.get(e);if(r!==void 0&&this._$Em!==r){let a=o.getPropertyOptions(r),s=typeof a.converter=="function"?{fromAttribute:a.converter}:a.converter?.fromAttribute!==void 0?a.converter:H;this._$Em=r;let i=s.fromAttribute(t,a.type);this[r]=i??this._$Ej?.get(r)??i,this._$Em=null}}requestUpdate(e,t,o,r=!1,a){if(e!==void 0){let s=this.constructor;if(r===!1&&(a=this[e]),o??=s.getPropertyOptions(e),!((o.hasChanged??X)(a,t)||o.useDefault&&o.reflect&&a===this._$Ej?.get(e)&&!this.hasAttribute(s._$Eu(e,o))))return;this.C(e,t,o)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:o,reflect:r,wrapped:a},s){o&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,s??t??this[e]),a!==!0||s!==void 0)||(this._$AL.has(e)||(this.hasUpdated||o||(t=void 0),this._$AL.set(e,t)),r===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[r,a]of this._$Ep)this[r]=a;this._$Ep=void 0}let o=this.constructor.elementProperties;if(o.size>0)for(let[r,a]of o){let{wrapped:s}=a,i=this[r];s!==!0||this._$AL.has(r)||i===void 0||this.C(r,void 0,a,i)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(o=>o.hostUpdate?.()),this.update(t)):this._$EM()}catch(o){throw e=!1,this._$EM(),o}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};w.elementStyles=[],w.shadowRootOptions={mode:"open"},w[q("elementProperties")]=new Map,w[q("finalized")]=new Map,ct?.({ReactiveElement:w}),(Z.reactiveElementVersions??=[]).push("2.1.2");var he=globalThis,$e=n=>n,ee=he.trustedTypes,Ae=ee?ee.createPolicy("lit-html",{createHTML:n=>n}):void 0,Ne="$lit$",A=`lit$${Math.random().toFixed(9).slice(2)}$`,Re="?"+A,dt=`<${Re}>`,j=document,F=()=>j.createComment(""),B=n=>n===null||typeof n!="object"&&typeof n!="function",ge=Array.isArray,pt=n=>ge(n)||typeof n?.[Symbol.iterator]=="function",le=`[ 	
\f\r]`,I=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ce=/-->/g,Ee=/>/g,C=RegExp(`>|${le}(?:([^\\s"'>=/]+)(${le}*=${le}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),je=/'/g,De=/"/g,Pe=/^(?:script|style|textarea|title)$/i,me=n=>(e,...t)=>({_$litType$:n,strings:e,values:t}),m=me(1),Pt=me(2),zt=me(3),D=Symbol.for("lit-noChange"),g=Symbol.for("lit-nothing"),Te=new WeakMap,E=j.createTreeWalker(j,129);function ze(n,e){if(!ge(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ae!==void 0?Ae.createHTML(e):e}var ut=(n,e)=>{let t=n.length-1,o=[],r,a=e===2?"<svg>":e===3?"<math>":"",s=I;for(let i=0;i<t;i++){let c=n[i],p,u,d=-1,_=0;for(;_<c.length&&(s.lastIndex=_,u=s.exec(c),u!==null);)_=s.lastIndex,s===I?u[1]==="!--"?s=Ce:u[1]!==void 0?s=Ee:u[2]!==void 0?(Pe.test(u[2])&&(r=RegExp("</"+u[2],"g")),s=C):u[3]!==void 0&&(s=C):s===C?u[0]===">"?(s=r??I,d=-1):u[1]===void 0?d=-2:(d=s.lastIndex-u[2].length,p=u[1],s=u[3]===void 0?C:u[3]==='"'?De:je):s===De||s===je?s=C:s===Ce||s===Ee?s=I:(s=C,r=void 0);let h=s===C&&n[i+1].startsWith("/>")?" ":"";a+=s===I?c+dt:d>=0?(o.push(p),c.slice(0,d)+Ne+c.slice(d)+A+h):c+A+(d===-2?i:h)}return[ze(n,a+(n[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),o]},W=class n{constructor({strings:e,_$litType$:t},o){let r;this.parts=[];let a=0,s=0,i=e.length-1,c=this.parts,[p,u]=ut(e,t);if(this.el=n.createElement(p,o),E.currentNode=this.el.content,t===2||t===3){let d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(r=E.nextNode())!==null&&c.length<i;){if(r.nodeType===1){if(r.hasAttributes())for(let d of r.getAttributeNames())if(d.endsWith(Ne)){let _=u[s++],h=r.getAttribute(d).split(A),b=/([.?@])?(.*)/.exec(_);c.push({type:1,index:a,name:b[2],strings:h,ctor:b[1]==="."?de:b[1]==="?"?pe:b[1]==="@"?ue:z}),r.removeAttribute(d)}else d.startsWith(A)&&(c.push({type:6,index:a}),r.removeAttribute(d));if(Pe.test(r.tagName)){let d=r.textContent.split(A),_=d.length-1;if(_>0){r.textContent=ee?ee.emptyScript:"";for(let h=0;h<_;h++)r.append(d[h],F()),E.nextNode(),c.push({type:2,index:++a});r.append(d[_],F())}}}else if(r.nodeType===8)if(r.data===Re)c.push({type:2,index:a});else{let d=-1;for(;(d=r.data.indexOf(A,d+1))!==-1;)c.push({type:7,index:a}),d+=A.length-1}a++}}static createElement(e,t){let o=j.createElement("template");return o.innerHTML=e,o}};function P(n,e,t=n,o){if(e===D)return e;let r=o!==void 0?t._$Co?.[o]:t._$Cl,a=B(e)?void 0:e._$litDirective$;return r?.constructor!==a&&(r?._$AO?.(!1),a===void 0?r=void 0:(r=new a(n),r._$AT(n,t,o)),o!==void 0?(t._$Co??=[])[o]=r:t._$Cl=r),r!==void 0&&(e=P(n,r._$AS(n,e.values),r,o)),e}var ce=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:o}=this._$AD,r=(e?.creationScope??j).importNode(t,!0);E.currentNode=r;let a=E.nextNode(),s=0,i=0,c=o[0];for(;c!==void 0;){if(s===c.index){let p;c.type===2?p=new Y(a,a.nextSibling,this,e):c.type===1?p=new c.ctor(a,c.name,c.strings,this,e):c.type===6&&(p=new _e(a,this,e)),this._$AV.push(p),c=o[++i]}s!==c?.index&&(a=E.nextNode(),s++)}return E.currentNode=j,r}p(e){let t=0;for(let o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(e,o,t),t+=o.strings.length-2):o._$AI(e[t])),t++}},Y=class n{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,o,r){this.type=2,this._$AH=g,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=o,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=P(this,e,t),B(e)?e===g||e==null||e===""?(this._$AH!==g&&this._$AR(),this._$AH=g):e!==this._$AH&&e!==D&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):pt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==g&&B(this._$AH)?this._$AA.nextSibling.data=e:this.T(j.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:o}=e,r=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=W.createElement(ze(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===r)this._$AH.p(t);else{let a=new ce(r,this),s=a.u(this.options);a.p(t),this.T(s),this._$AH=a}}_$AC(e){let t=Te.get(e.strings);return t===void 0&&Te.set(e.strings,t=new W(e)),t}k(e){ge(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,o,r=0;for(let a of e)r===t.length?t.push(o=new n(this.O(F()),this.O(F()),this,this.options)):o=t[r],o._$AI(a),r++;r<t.length&&(this._$AR(o&&o._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let o=$e(e).nextSibling;$e(e).remove(),e=o}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},z=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,o,r,a){this.type=1,this._$AH=g,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=a,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=g}_$AI(e,t=this,o,r){let a=this.strings,s=!1;if(a===void 0)e=P(this,e,t,0),s=!B(e)||e!==this._$AH&&e!==D,s&&(this._$AH=e);else{let i=e,c,p;for(e=a[0],c=0;c<a.length-1;c++)p=P(this,i[o+c],t,c),p===D&&(p=this._$AH[c]),s||=!B(p)||p!==this._$AH[c],p===g?e=g:e!==g&&(e+=(p??"")+a[c+1]),this._$AH[c]=p}s&&!r&&this.j(e)}j(e){e===g?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},de=class extends z{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===g?void 0:e}},pe=class extends z{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==g)}},ue=class extends z{constructor(e,t,o,r,a){super(e,t,o,r,a),this.type=5}_$AI(e,t=this){if((e=P(this,e,t,0)??g)===D)return;let o=this._$AH,r=e===g&&o!==g||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,a=e!==g&&(o===g||r);r&&this.element.removeEventListener(this.name,this,o),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},_e=class{constructor(e,t,o){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(e){P(this,e)}};var _t=he.litHtmlPolyfillSupport;_t?.(W,Y),(he.litHtmlVersions??=[]).push("3.3.2");var Le=(n,e,t)=>{let o=t?.renderBefore??e,r=o._$litPart$;if(r===void 0){let a=t?.renderBefore??null;o._$litPart$=r=new Y(e.insertBefore(F(),a),a,void 0,t??{})}return r._$AI(n),r};var fe=globalThis,k=class extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Le(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return D}};k._$litElement$=!0,k.finalized=!0,fe.litElementHydrateSupport?.({LitElement:k});var ht=fe.litElementPolyfillSupport;ht?.({LitElement:k});(fe.litElementVersions??=[]).push("4.2.2");var gt={attribute:!0,type:String,converter:H,reflect:!1,hasChanged:X},mt=(n=gt,e,t)=>{let{kind:o,metadata:r}=t,a=globalThis.litPropertyMetadata.get(r);if(a===void 0&&globalThis.litPropertyMetadata.set(r,a=new Map),o==="setter"&&((n=Object.create(n)).wrapped=!0),a.set(t.name,n),o==="accessor"){let{name:s}=t;return{set(i){let c=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,c,n,!0,i)},init(i){return i!==void 0&&this.C(s,void 0,n,i),i}}}if(o==="setter"){let{name:s}=t;return function(i){let c=this[s];e.call(this,i),this.requestUpdate(s,c,n,!0,i)}}throw Error("Unsupported decorator location: "+o)};function G(n){return(e,t)=>typeof t=="object"?mt(n,e,t):((o,r,a)=>{let s=r.hasOwnProperty(a);return r.constructor.createProperty(a,o),s?Object.getOwnPropertyDescriptor(r,a):void 0})(n,e,t)}function S(n){return G({...n,state:!0,attribute:!1})}var ft={days:1,weeks:7,months:30.4368,years:365.25};function Oe(n,e){return!n||n<=0?0:n*(ft[e||"days"]??1)}var Me=5;function V(n){let e=n.getFullYear(),t=String(n.getMonth()+1).padStart(2,"0"),o=String(n.getDate()).padStart(2,"0");return`${e}-${t}-${o}`}function bt(n,e){let t=[];for(let o=0;o<e;o++){let r=new Date(n);r.setDate(r.getDate()+o),r.setHours(0,0,0,0),t.push(V(r))}return t}function oe(n,e){let[t,o,r]=n.split("-").map(Number),a=new Date(t,o-1,r);return a.setDate(a.getDate()+e),V(a)}function yt(n){if(!n||n.length===0)return null;let e=n.map(t=>t.cost).filter(t=>typeof t=="number");return e.length===0?null:e.reduce((t,o)=>t+o,0)/e.length}function vt(n){let{windowStart:e,windowEnd:t,task:o,entryId:r,objectName:a}=n,s=[],i=(d,_)=>({date:d,entry_id:r,task_id:o.id,task_name:o.name,object_name:a,status:_&&(o.status==="overdue"||o.status==="triggered")?"ok":o.status,days_until_due:_?null:o.days_until_due??null,projected:_,schedule_type:o.schedule_type,interval_days:o.interval_days??null,interval_unit:o.interval_unit??null,responsible_user_id:o.responsible_user_id??null,avg_cost:yt(o.history),adaptive_enabled:!!o.adaptive_config?.enabled,prediction_confidence:o.threshold_prediction_confidence??null}),c=Math.max(1,Math.round(Oe(o.interval_days,o.interval_unit)));if(o.status==="overdue"||o.status==="triggered"){if(s.push(i(e,!1)),o.schedule_type==="time_based"&&o.interval_days&&o.interval_days>0){let d=oe(e,c),_=1;for(;d<=t&&_<Me;)s.push(i(d,!0)),_++,d=oe(d,c)}return s}let p=o.next_due;if(typeof p!="string"||!p)return s;let u=p.slice(0,10);if(u>=e&&u<=t)s.push(i(u,!1));else if(u>t)return s;if(o.schedule_type==="time_based"&&o.interval_days&&o.interval_days>0){let d=oe(u,c),_=s.length;for(;d<=t&&_<Me;)d>=e&&(s.push(i(d,!0)),_++),d=oe(d,c)}return s}var Ue={overdue:0,triggered:1,due_soon:2,ok:3};function qe(n,e,t,o=null){let r=bt(e,t),a=r[0],s=r[r.length-1],i=[];for(let p of n){let u=p.object?.name||"",d=p.entry_id,_=p.tasks||[];for(let h of _){if(o&&h.responsible_user_id!==o||h.enabled===!1)continue;let b=vt({windowStart:a,windowEnd:s,task:h,entryId:d,objectName:u});i.push(...b)}}let c=new Map;for(let p of r)c.set(p,[]);for(let p of i){let u=c.get(p.date);u&&u.push(p)}for(let[,p]of c)p.sort((u,d)=>{let _=Ue[u.status]??99,h=Ue[d.status]??99;if(_!==h)return _-h;if(u.projected!==d.projected)return u.projected?1:-1;let b=u.object_name.localeCompare(d.object_name);return b!==0?b:u.task_name.localeCompare(d.task_name)});return r.map(p=>({date:p,events:c.get(p)??[]}))}var xt={completed:"ok",reset:"ok",skipped:"due_soon",triggered:"triggered",trigger_replaced:"triggered",trigger_removed:"ok"};function wt(n,e){let t=[];for(let o=e-1;o>=0;o--){let r=new Date(n);r.setDate(r.getDate()-o),r.setHours(0,0,0,0),t.push(V(r))}return t}function He(n,e,t,o=null){let r=wt(e,t),a=r[0],s=r[r.length-1],i=new Map;for(let p of r)i.set(p,[]);for(let p of n){let u=p.object?.name||"",d=p.entry_id,_=p.tasks||[];for(let h of _){if(o&&h.responsible_user_id!==o)continue;let b=h.history||[];for(let l of b){if(typeof l?.timestamp!="string")continue;let $=l.timestamp.slice(0,10);if($<a||$>s)continue;let N=i.get($);if(!N)continue;let R=l.type??"completed";N.push({date:$,entry_id:d,task_id:h.id,task_name:h.name,object_name:u,status:xt[R]??"ok",days_until_due:null,projected:!1,schedule_type:h.schedule_type,interval_days:h.interval_days??null,responsible_user_id:h.responsible_user_id??null,avg_cost:typeof l.cost=="number"?l.cost:null,adaptive_enabled:!!h.adaptive_config?.enabled,prediction_confidence:null,history_timestamp:l.timestamp,history_type:R,history_cost:typeof l.cost=="number"?l.cost:null,history_notes:typeof l.notes=="string"?l.notes:null,history_duration:typeof l.duration=="number"?l.duration:null})}}}let c={completed:0,reset:1,skipped:2,triggered:3,trigger_replaced:4};for(let[,p]of i)p.sort((u,d)=>{let _=c[u.history_type??""]??99,h=c[d.history_type??""]??99;if(_!==h)return _-h;let b=u.object_name.localeCompare(d.object_name);return b!==0?b:u.task_name.localeCompare(d.task_name)});return r.map(p=>({date:p,events:i.get(p)??[]}))}var Ie=x`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;var y=class extends k{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(t){this._config={...t},t.past_days&&[30,90].includes(t.past_days)?this._pastDays=t.past_days:t.window_days&&[7,14,30,365].includes(t.window_days)&&(this._windowDays=t.window_days,this._pastDays=0),typeof t.user_filter=="string"&&(this._userFilter=t.user_filter)}getCardSize(){return 6}get _lang(){return this.hass?.language||"en"}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(t){super.updated(t),t.has("hass")&&Ke(this.hass?.locale);let o=this.hass?.language;if(o&&!Ge(o)&&Ve(o).then(()=>this.requestUpdate()),t.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[t,o]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=t.objects,this._stats=o}catch{}}async _subscribe(){try{let t=await this.hass.connection.subscribeMessage(o=>{let r=o;this._objects=r.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){t();return}this._unsub=t}catch{}}_onEventClick(t){if(t.history_timestamp){this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:t.entry_id,task_id:t.task_id,original_timestamp:t.history_timestamp},bubbles:!0,composed:!0}));return}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:t.entry_id,task_id:t.task_id},bubbles:!0,composed:!0}))}render(){if(!this.hass)return g;let t=this._lang,o=this._config.show_window_chips!==!1,r=this._config.show_user_filter!==!1,a=this._config.title,s=null;this._userFilter&&(s=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let i=new Date;i.setHours(0,0,0,0);let c=this._pastDays>0,p=c?He(this._objects,i,this._pastDays,s):qe(this._objects,i,this._windowDays,s),u=V(i),d=this._windowDays===365||c,_=d?p.filter(l=>l.events.length>0):p,h=l=>{let $=`cal-status-${l.status}`,N=l.projected?"cal-event-projected":"",R=l.status==="overdue"&&l.days_until_due!=null?` (${Math.abs(l.days_until_due)}d ${f("overdue",t).toLowerCase()})`:"",O=l.projected&&l.interval_days?m`<span class="cal-event-recur">${l.interval_unit&&l.interval_unit!=="days"?`${l.interval_days} ${f("unit_"+l.interval_unit,t)}`:f("cal_every_n_days",t).replace("{n}",String(l.interval_days))}</span>`:g,M=l.schedule_type==="sensor_based",ne=M?m`<ha-icon class="cal-event-icon cal-source-sensor"
          ...
          </span>`:g,Ze=this._stats?.budget?.currency_symbol||We,Xe=l.history_type?f(l.history_type,t):f(l.status,t);return m`
        <div class="cal-event ${N}"
          @click=${()=>this._onEventClick(l)}>
          ${ne}
          <span class="cal-status-pill ${$}">${Xe}</span>
          <div class="cal-event-body">
            <div class="cal-event-title">${l.object_name} · ${l.task_name}${R}</div>
            ${ae}
            ${O}
          </div>
          ${l.avg_cost!=null&&l.avg_cost>0?m`<span class="cal-event-cost">${l.avg_cost.toFixed(0)} ${Ze}</span>`:g}
        </div>
      `},b=l=>{let[$,N,R]=l.date.split("-").map(Number),O=new Date($,N-1,R),M=l.date===u,ne=O.toLocaleDateString(t,{weekday:"short"}),ae=O.toLocaleDateString(t,{month:"long"});return m`
      ...
      <ha-card .header=${a}>
        ...
        <div class="cal-rolling">
          ${_.length===0&&d?m`<div class="cal-empty">${f("cal_no_events",t)}</div>`:_.map(b)}
        </div>
      </ha-card>
    `}};y.styles=[Qe,Ie,x`
      :host { display: block; }
      ha-card { padding: 0; overflow: hidden; }
    `],v([G({attribute:!1})],y.prototype,"hass",2),v([S()],y.prototype,"_config",2),v([S()],y.prototype,"_objects",2),v([S()],y.prototype,"_stats",2),v([S()],y.prototype,"_windowDays",2),v([S()],y.prototype,"_pastDays",2),v([S()],y.prototype,"_userFilter",2),v([S()],y.prototype,"_unsub",2);var Ct=[{value:7,label:"Week (7 days)"},{value:14,label:"Fortnight (14 days)"},{value:30,label:"Month (30 days, default)"},{value:365,label:"Year (365 days, empty days collapsed)"}],L=class extends k{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}setConfig(t){this._config={...t}}_valueChanged(t,o){let r={...this._config,[t]:o};t==="show_window_chips"&&o===!0&&delete r.show_window_chips,t==="show_user_filter"&&o===!0&&delete r.show_user_filter,t==="title"&&(!o||typeof o=="string"&&o.trim()==="")&&delete r.title,t==="user_filter"&&o===""&&delete r.user_filter,this._config=r,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:r},bubbles:!0,composed:!0}))}render(){let t=this._config.window_days??30,o=this._config.show_window_chips!==!1,r=this._config.show_user_filter!==!1,a=this._config.user_filter??"",s=this._config.title??"";return m`
      <div class="editor">
        <div class="row">
          ...
          <input
            ...
            type="text"
            .value=${s}
            @input=${i=>this._valueChanged("title",i.target.value)}
          />
        </div>
        <div class="row">
          ...
          <select
            id="window"
            @change=${i=>this._valueChanged("window_days",Number(i.target.value))}
          >
            ${Ct.map(i=>m`<option value="${i.value}" ?selected=${i.value===t}>${i.label}</option>`)}
          </select>
        </div>
        <div class="row toggle">
          ...
          <input
            ...
            type="checkbox"
            .checked=${o}
            @change=${i=>this._valueChanged("show_window_chips",i.target.checked)}
          />
        </div>
        <div class="hint">
        ...
        <div class="row toggle">
          ...
          <input
            ...
            type="checkbox"
            .checked=${r}
            @change=${i=>this._valueChanged("show_user_filter",i.target.checked)}
          />
        </div>
        <div class="row">
          ...
          <select
            id="userv"
            @change=${i=>this._valueChanged("user_filter",i.target.value)}
          >
  ...
  `,v([G({attribute:!1})],L.prototype,"hass",2),v([S()],L.prototype,"_config",2);customElements.get("maintenance-supporter-calendar-card")||customElements.define("maintenance-supporter-calendar-card",y);customElements.get("maintenance-supporter-calendar-card-editor")||customElements.define("maintenance-supporter-calendar-card-editor",L);var re=window;re.customCards=re.customCards||[];var Je="maintenance-supporter-calendar-card",Et=re.customCards.some(n=>n.type===Je);Et||re.customCards.push({type:Je,name:"Maintenance Supporter \u2014 Calendar",description:"Rolling calendar of maintenance tasks with 7/14/30/365 day windows, source icons, and prediction-confidence pills.",preview:!0});export{y as MaintenanceCalendarCard};
