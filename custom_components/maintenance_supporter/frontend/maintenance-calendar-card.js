...
`).map(c=>c.trim()).filter(Boolean).slice(0,100);e.checklist=p.length?p:null}if(this.completionActionsEnabled){let p=this._actionService.trim();if(p&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(p)){let w={service:p},y=this._actionTargetEntity.trim();y&&(w.target={entity_id:y});let $=this._buildActionData();Object.keys($).length>0&&(w.data=$),e.on_complete_action=w}else e.on_complete_action=null;let c={};this._qcNotes.trim()&&(c.notes=this._qcNotes.trim());let m=parseFloat(this._qcCost);!isNaN(m)&&m>=0&&(c.cost=m);let f=parseInt(this._qcDuration,10);!isNaN(f)&&f>=0&&(c.duration=f),this._qcFeedback&&(c.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(c).length?c:null}let i=await this.hass.connection.sendMessagePromise(e),a=this._taskId||i?.task_id,o=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;this._warning="";let _=p=>{this._warning=n("subsave_warning",this._lang).replace("{detail}",p)};if(a&&this._scheduleType==="sensor_based"&&o&&await Ut(this,{type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null},{onError:_})!==void 0&&(this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute),a&&this._adaptiveSnapshot()!==this._adaptiveInitial){let p=parseFloat(this._adaptiveAlpha),c=parseInt(this._adaptiveMin,10),m=parseInt(this._adaptiveMax,10);await Ut(this,{type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:a,enabled:this._adaptiveEnabled,...p>=.1&&p<=.9?{ewa_alpha:p}:{},...!isNaN(c)&&c>=1?{min_interval_days:c}:{},...!isNaN(m)&&m>=1?{max_interval_days:m}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction},{onError:_})!==void 0&&(this._adaptiveInitial=this._adaptiveSnapshot())}this._warning?a&&(this._taskId=a):this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=N(e,this._lang,n("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._warning="",this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return h;let e=this._lang,t=this._triggerType==="compound";return l`
  ...
  `,d([v({type:String})],Z.prototype,"lang",2),d([u()],Z.prototype,"_open",2),d([u()],Z.prototype,"_busy",2),d([u()],Z.prototype,"_devices",2),d([u()],Z.prototype,"_deviceIndex",2),d([u()],Z.prototype,"_switchFailed",2);customElements.get("ms-camera-capture")||customElements.define("ms-camera-capture",Z)});var ft,K,Ze=x(()=>{"use strict";I();F();C();Qt();Zt();Zt();ft=E`
...
`,K=class extends S{constructor(){super(...arguments);this.lang="en";this.disabled=!1;this.busy=!1;this.accept="image/*";this.showCamera=!0;this.showGallery=!0;this.compact=!1;this.remaining=1/0;this._singlePick=gt();this._inAppCamera=Ur()}createRenderRoot(){return this}get _locked(){return this.disabled||this.busy}_emit(e){e.length!==0&&this.dispatchEvent(new CustomEvent("files-picked",{detail:{files:e},bubbles:!0,composed:!0}))}_onInput(e){let t=e.target,i=Array.from(t.files??[]);t.value="",this._emit(i)}_onCameraClick(e){!this._inAppCamera||this._locked||(e.preventDefault(),this.querySelector("ms-camera-capture")?.open())}_onCameraUnavailable(){this._inAppCamera=!1,this.querySelector(".photo-pick-camera input")?.click()}_onKeydown(e){e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),!this._locked&&e.currentTarget.click())}render(){if(this.remaining<=0||!this.showCamera&&!this.showGallery)return h;let e=this.lang,t=this._locked?"disabled":"",i=this.busy?n("uploading",e):n("doc_camera",e),a=n(this._singlePick?"choose_photo":"choose_photos",e);return l`
                ...
                ${this.parts.map(i=>{let a=J({part_id:i.id,entry_id:i.entry_id}),o=this._usedParts[a],_=o!==void 0,p=i.entry_id?{part_id:i.id,quantity:1,entry_id:i.entry_id}:{part_id:i.id,quantity:1};return l`<div class="used-part-row">
                    <label class="used-part-check">
                      <input type="checkbox" .checked=${_}
                        @change=${c=>{let m={...this._usedParts};c.target.checked?m[a]=m[a]||p:delete m[a],this._usedParts=m}} />
                      <span
                    ...
                    ${_?l`<input class="used-part-qty" type="number" min="0.01" max="999" step="0.01"
                          ...
                          @input=${c=>{let m=parseFloat(c.target.value);this._usedParts={...this._usedParts,[a]:{...p,quantity:Number.isFinite(m)&&m>=.01?m:1}}}} />`:h}
                  </div>`})}
  ...
  `],d([v({attribute:!1})],k.prototype,"hass",2),d([v()],k.prototype,"entryId",2),d([v()],k.prototype,"taskId",2),d([v()],k.prototype,"taskName",2),d([v()],k.prototype,"lang",2),d([v({type:Array})],k.prototype,"checklist",2),d([v({type:Boolean})],k.prototype,"adaptiveEnabled",2),d([v()],k.prototype,"taskType",2),d([v()],k.prototype,"readingUnit",2),d([v({attribute:!1})],k.prototype,"readings",2),d([v({attribute:!1})],k.prototype,"readingHistory",2),d([v({attribute:!1})],k.prototype,"restockDefault",2),d([v({attribute:!1})],k.prototype,"restockUnitCost",2),d([v()],k.prototype,"currencySymbol",2),d([v({attribute:!1})],k.prototype,"parts",2),d([v({attribute:!1})],k.prototype,"consumesParts",2),d([v({type:Array})],k.prototype,"consumesInfo",2),d([v({type:Array})],k.prototype,"requiredFields",2),d([v()],k.prototype,"phaseLabel",2),d([v({type:Boolean})],k.prototype,"requireTagScan",2),d([v({type:Boolean})],k.prototype,"viaTagScan",2),d([u()],k.prototype,"_open",2),d([u()],k.prototype,"_notes",2),d([u()],k.prototype,"_cost",2),d([u()],k.prototype,"_duration",2),d([u()],k.prototype,"_loading",2),d([u()],k.prototype,"_error",2),d([u()],k.prototype,"_checklistState",2),d([u()],k.prototype,"_feedback",2),d([u()],k.prototype,"_readingValue",2),d([u()],k.prototype,"_readingValues",2),d([u()],k.prototype,"_restockQty",2),d([u()],k.prototype,"_completedAt",2),d([u()],k.prototype,"_usedParts",2),d([v({attribute:!1})],k.prototype,"checklistPrefill",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",k)});function Vr(s,r,e){let t=new Blob([s],{type:e}),i=URL.createObjectURL(t),a=document.createElement("a");a.href=i,a.download=r,a.target="_blank",a.rel="noopener",a.style.display="none",document.body.appendChild(a),a.dispatchEvent(new MouseEvent("click")),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(i),6e4)}var Xt=x(()=>{"use strict"});async function Hn(s,r,e=300){return(await s.connection.sendMessagePromise({type:"auth/sign_path",path:r,expires:e})).path}async function Wr(s,r,e=300){return Hn(s,`/api/maintenance_supporter/document/${r}`,e)}var Kr=x(()=>{"use strict";Xt()});var he,ei=x(()=>{"use strict";I();F();Kr();he=class extends S{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{this._url=await Wr(this.hass,this.docId)}catch{this._failed=!0}}render(){return this._failed||!this.docId?h:this._url?l`
            ...
            ${this._partOptions.map(a=>{let o=`${a.entry_id}:${a.part_id}`,_=this._partQty[o]||0;return l`
                <label class="part-row-edit">
                  <input type="checkbox" .checked=${_>0}
                    @change=${p=>{let c=p.target.checked;this._partQty={...this._partQty,[o]:c?1:0}}} />
                  ...
                  ${_>0?l`
                    <input class="part-qty" type="number" min="0.01" max="999" step="0.01"
                      .value=${String(_)}
                      @input=${p=>{let c=parseFloat(p.target.value);!isNaN(c)&&c>0&&(this._partQty={...this._partQty,[o]:c})}} />
                  `:h}
                </label>
              `})}
          </div>
...
<style>
  ...
  .qr-col img{width:${c?"200px":"280px"}}
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),a.document.close()}_downloadSvg(e,t){let i=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),a=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;Vr(i,`qr-${jn(a)}-${t}.svg`,"image/svg+xml")}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return l``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${n("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${n("qr_code",e)}: ${this._objectName}`,i=!!this._viewResult;return l`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
  ...
  `,d([v({attribute:!1})],Y.prototype,"hass",2),d([v()],Y.prototype,"lang",2),d([u()],Y.prototype,"_open",2),d([u()],Y.prototype,"_loading",2),d([u()],Y.prototype,"_error",2),d([u()],Y.prototype,"_viewResult",2),d([u()],Y.prototype,"_completeResult",2),d([u()],Y.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",Y)});function Dn(s,r){if(r<=0)return 0;let e=typeof s=="number"&&Number.isFinite(s)?Math.trunc(s):0;return e<0?0:e%r}function On(s){return!!(s?.phases&&s.phase_sequence&&s.phase_sequence.length>0)}function ti(s){if(!s||!On(s))return null;let r=s.phase_sequence,e=Dn(s.phase_cursor,r.length),t=r[e],i=s.phases?.[t];return i?{id:t,name:i.name,index:e,count:r.length,notes:i.notes,checklist:i.checklist!==void 0?i.checklist:s.checklist??[],consumesParts:i.consumes_parts!==void 0?i.consumes_parts:s.consumes_parts??[],requiredFields:i.required_completion_fields!==void 0?i.required_completion_fields:s.required_completion_fields??[]}:null}function Xe(s){let r=ti(s);return r?`${r.index+1}/${r.count} \xB7 ${r.name}`:""}var ii=x(()=>{"use strict"});function Jr(s){let r=s.task??null,e=r?ti(r):null,t=e?e.consumesParts:r?.consumes_parts||[],i=!!r?.part_ref,a=s.objects.find(p=>p.entry_id===s.entryId)?.parts||[],o=i?a.find(p=>p.id===r.part_ref.part_id):void 0,_=s.checklistsEnabled??!0;return{entry_id:s.entryId,task_id:s.taskId,task_name:s.taskName,checklist:e?_?e.checklist:[]:s.checklist??[],adaptive_enabled:!!s.adaptiveEnabled,required_completion_fields:e?e.requiredFields:r?.required_completion_fields||[],task_type:r?.type||"",reading_unit:r?.reading_unit||"",readings:r?.readings||[],reading_history:hr(r?.history),parts:i?[]:Ar({consumes_parts:t},s.entryId,s.objects,s.lang),consumes_parts:i?[]:t,phase_label:e?Xe(r):"",require_tag_scan:!!r?.require_tag_scan,restock_default:i?o?.restock_quantity??1:null,restock_unit_cost:i?o?.cost??null:null,currency_symbol:be({currency_symbol:s.currencySymbol}),consumes_info:t.map(p=>Tr(p,s.entryId,s.objects,s.lang)),checklist_prefill:r?.checklist_progress||{},via_tag_scan:!!s.viaTagScan}}function Zr(s,r,e){s.entryId=r.entry_id,s.taskId=r.task_id,s.taskName=r.task_name,s.lang=e,s.checklist=r.checklist??[],s.adaptiveEnabled=!!r.adaptive_enabled,s.requiredFields=r.required_completion_fields??[],s.taskType=r.task_type??"",s.readingUnit=r.reading_unit??"",s.readings=r.readings??[],s.readingHistory=r.reading_history??[],s.parts=r.parts??[],s.consumesParts=r.consumes_parts??[],s.phaseLabel=r.phase_label??"",s.requireTagScan=!!r.require_tag_scan,s.restockDefault=r.restock_default??null,s.restockUnitCost=r.restock_unit_cost??null,s.currencySymbol=be(r),s.consumesInfo=r.consumes_info??[],s.checklistPrefill=r.checklist_prefill??{},s.viaTagScan=!!r.via_tag_scan,s.open({viaTagScan:!!r.via_tag_scan})}var ri=x(()=>{"use strict";xe();_t();ii();C()});function Mn(s){return s&&Xr(s.ref_no)?String(s.ref_no):null}function es(s,r){let e=Mn(s);return e&&r&&Xr(r.ref_no)?`${e}.${r.ref_no}`:null}function ts(s,r){return s?l`<span class="ref-chip" title=${r??""}>#${s}</span>`:h}var Xr,si=x(()=>{"use strict";I();Xr=s=>typeof s=="number"&&Number.isInteger(s)&&s>0});var is=x(()=>{"use strict"});function Fn(s,r){return s.taskRef&&r.ref_no?`${s.taskRef}-${r.ref_no}`:null}function Un(s,r){let e=pt(r);return e.length>0?l`<div class="history-photos">
    ...
    </span></div>`:h}function rs(s,r,e={}){let t=r.lang,{compact:i=!1,showRef:a=!0,showBadges:o=!0,showEdit:_=!0}=e,p=_&&zn.includes(s.type);return l`
    <div class="history-entry${i?" compact":""}">
      ...
      <div class="history-content">
        ...
        ${s.cost!=null||s.duration!=null||s.trigger_value!=null?l`<div class="history-details">
              ${s.cost!=null?l`<span>${n("cost",t)}: ${de(s.cost,r.currencySymbol,t)}</span>`:h}
              ${s.duration!=null?l`<span>${n("duration",t)}: ${dt(s.duration,t)}</span>`:h}
              ${s.trigger_value!=null?l`<span>${n("trigger_val",t)}: ${s.trigger_value}</span>`:h}
            </div>`:h}
      </div>
    </div>
  `}var zn,ss=x(()=>{"use strict";I();C();ei();ht();si();xe();is();zn=["completed","reset","skipped"]});function T(s){return s.toFixed(1)}var ni=x(()=>{"use strict";C()});function ns(s,r){let e=s.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return h;let a=s.interval_days??0,o=s.suggested_interval??a;return l`
    <div class="weibull-section">
      ...
      ${Wn(t,i,a,o,r)}
      ${Kn(e,r)}
      ${e?.confidence_interval_low!=null?Yn(e,s,r):h}
    </div>
  ...
  `}function Yn(s,r,e){let t=s.confidence_interval_low,i=s.confidence_interval_high,a=r.suggested_interval??r.interval_days??0,o=r.interval_days??0,_=Math.max(0,t-5),c=i+5-_,m=(t-_)/c*100,f=(i-t)/c*100,w=(a-_)/c*100,y=o>0?(o-_)/c*100:-1;return l`
  ...
  `}var ls=x(()=>{"use strict";I();C()});function ds(s,r,e,t){let i=Math.max(s||1,r);return l`
  ...
  `}var cs=x(()=>{"use strict";I();C()});function hs(s,r,e){if(!e.seasonal||!s.seasonal_factor||s.seasonal_factor===1)return h;let t=ps.map(_=>n(_,r)),i=new Date().getMonth(),a=s.seasonal_factors||s.interval_analysis?.seasonal_factors||null,o=a&&a.length===12?a:t.map((_,p)=>{let c=s.seasonal_factor||1,m=Math.sin((p-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,c+m))});return l`
    <div class="seasonal-card-compact">
      <h4>${n("seasonal_awareness",r)}</h4>
      <div class="seasonal-mini-chart">
        ${o.map((_,p)=>{let c=_*40,m=_<.9?"low":_>1.1?"high":"normal";return l`
  ...
  `}function us(s,r){return Gn(s,r)}function Gn(s,r){let e=s.seasonal_factors??s.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return h;let t=s.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,o=100,_=8,c=o-_-4,m=Math.max(...e,1.5),f=a/12,w=f*.65,y=_+c-1/m*c;return l`
    <div class="seasonal-chart">
      ...
      <svg viewBox="0 0 ${a} ${o}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_seasonal",r)}">
        ...
        ${e.map(($,A)=>{let z=$/m*c,U=A*f+(f-w)/2,D=_+c-z,G=A===i,oe=$<1?"var(--success-color, #4caf50)":$>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return Ee`
            <rect x="${T(U)}" y="${T(D)}"
  ...
  `}var ps,_s=x(()=>{"use strict";I();C();ni();ps=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var R,ms=x(()=>{"use strict";I();F();C();pe();Nt();ri();ii();Mt();xe();si();ss();as();ls();cs();Ie();_s();R=class extends S{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._taskRef=null;this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return H(this.hass)}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=ve(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._currencySymbol=be(e?.budget),lt(e?.budget),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(i=>i.id===this._taskId);this._task=t??null,this._taskRef=es(e.object,t)}catch(e){this._error=N(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=N(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(X(),se)).then(async({openCompleteDialog:e})=>{let t=this._task,i=[];try{i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}e(Jr({entryId:this._entryId,taskId:this._taskId,taskName:t.name,task:t,objects:i,lang:this._lang,checklist:t.checklist||[],adaptiveEnabled:!!t.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(X(),se)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(X(),se)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=n("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=n("suggestion_applied",this._lang),this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${n("reanalyze_result",this._lang)}: ${Ke(e.recommended_interval,"days",this._lang)} (${e.data_points} pts)`:n("reanalyze_insufficient_data",this._lang),await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=N(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){if(!this._entryId||!this._taskId)return;let t=Ot(this._entryId,this._taskId,e,this._task);Promise.resolve().then(()=>(X(),se)).then(({openHistoryEditDialog:i})=>i(t))}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return h;let t=this._lang;return l`
    ...
    `}_renderDetails(e){let t=this._lang,i=e.history||[],a=i.filter(p=>p.type==="completed"),o=a.reduce((p,c)=>p+(typeof c.cost=="number"?c.cost:0),0),_=(()=>{let p=a.map(c=>typeof c.duration=="number"?c.duration:null).filter(c=>c!=null);return p.length?Math.round(p.reduce((c,m)=>c+m,0)/p.length):null})();return l`
      <div class="details">
        <div class="stats-grid">
          ...
          <div class="stat">
            ...
            <span class="stat-value">${de(o,this._currencySymbol,t)}</span>
          </div>
          <div class="stat">
            <span class="stat-label">${n("avg_duration",t)}</span>
            <span class="stat-value">${dt(_,t)}</span>
          </div>
        </div>
        ...
        ${i.length===0?l`<div class="history-empty">${n("history_empty",t)}</div>`:l`
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(p=>rs(p,{lang:t,hass:this.hass,currencySymbol:this._currencySymbol,openEdit:c=>this._onEditHistoryEntry(c),readingUnit:e.reading_unit,readingSlotDelta:(c,m)=>_r(i,c,m),taskRef:this._taskRef},{compact:!0}))}
  ...
  `,d([v({attribute:!1})],ee.prototype,"hass",2),d([u()],ee.prototype,"_open",2),d([u()],ee.prototype,"_entryId",2),d([u()],ee.prototype,"_data",2),d([u()],ee.prototype,"_busy",2),d([u()],ee.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",ee)});function xs(){let s=window;return s.__msSettingsCache??={promise:null}}function vt(s){let r=xs();if(r.promise)return r.promise;let e=s.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(t=>({features:t.features??ai.features,defaultWarningDays:t.general?.default_warning_days??7,rowActionStyle:t.general?.row_action_style??ai.rowActionStyle})).catch(()=>(r.promise===e&&(r.promise=null),ai));return r.promise=e,e}function ws(){xs().promise=null}var ai,$s=x(()=>{"use strict";ai={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"}});var se={};Cs(se,{__resetSettingsCacheForTests:()=>ra,getRowActionStyle:()=>ia,openCompleteDialog:()=>la,openCreateObjectDialog:()=>sa,openCreateTaskDialog:()=>aa,openEditObjectDialog:()=>na,openEditTaskDialog:()=>oa,openHistoryEditDialog:()=>oi,openObjectQuickActions:()=>ca,openQrDialog:()=>da,openTaskQuickActions:()=>li});function yt(){return document.querySelector("home-assistant")?.hass}function ta(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function ne(s){let r=ta(),e=r.querySelector(s)??document.body.querySelector(s);return e?e.parentNode!==r&&r.appendChild(e):(e=document.createElement(s),r.appendChild(e)),e}function ae(s){let r=yt();if(!r)return!1;s.hass=r;let e=H(r);return Ge(e)||Qe(e).then(()=>{s.requestUpdate?.()}),jt(r.locale,r.config?.country),!0}function ia(s){return vt(s).then(r=>r.rowActionStyle)}function ra(){ws()}function sa(){let s=ne(ks);return ae(s)?(s.openCreate(),!0):!1}function na(s,r){let e=ne(ks);return ae(e)?(e.openEdit(s,r),!0):!1}function aa(s="",r){let e=ne(Es);if(!ae(e))return!1;let t=yt();return t?((async()=>{let i=await vt(t),a=e;a.checklistsEnabled=i.features.checklists,a.scheduleTimeEnabled=i.features.schedule_time,a.completionActionsEnabled=i.features.completion_actions,a.defaultWarningDays=i.defaultWarningDays,a.openCreate(s,r)})(),!0):!1}function oa(s,r){let e=ne(Es);if(!ae(e))return!1;let t=yt();return t?((async()=>{try{let[i,a]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:s}),vt(t)]),o=(i.tasks||[]).find(p=>p.id===r);if(!o){console.warn(`openEditTaskDialog: task ${r} not found in entry ${s}`);return}let _=e;_.checklistsEnabled=a.features.checklists,_.scheduleTimeEnabled=a.features.schedule_time,_.completionActionsEnabled=a.features.completion_actions,_.defaultWarningDays=a.defaultWarningDays,await _.openEdit(s,o)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function oi(s){let r=ne(Qn);return ae(r)?(r.openEdit(s),!0):!1}function la(s){let r=ne(Jn);return ae(r)?(Zr(r,s,H(yt())),!0):!1}function da(s){let r=ne(Zn);return ae(r)?(r.openForTask(s.entry_id,s.task_id,s.object_name,s.task_name),!0):!1}function li(s,r){let e=ne(Xn);return ae(e)?(e.openFor(s,r),!0):!1}function ca(s){let r=ne(ea);return ae(r)?(r.openFor(s),!0):!1}var ks,Es,Qn,Jn,Zn,Xn,ea,X=x(()=>{"use strict";xr();Hr();Br();Yr();Qr();ms();bs();C();ri();$s();ks="maintenance-object-dialog",Es="maintenance-task-dialog",Qn="maintenance-history-edit-dialog",Jn="maintenance-complete-dialog",Zn="maintenance-qr-dialog",Xn="maintenance-task-quick-actions-dialog",ea="maintenance-object-quick-actions-dialog"});I();F();Nt();I();var Ui=E`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;C();function dr(s){let r=window;r.customCards=r.customCards||[],r.customCards.some(e=>e.type===s.type)||r.customCards.push(s)}Mt();X();var W=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){if(this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter),typeof e.object_filter=="string")this._objectFilter=e.object_filter,this._configuredObjects=[];else if(Array.isArray(e.object_filter)){let t=e.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=t.length===1?t[0]:"",this._configuredObjects=t.length>1?t:[]}}getCardSize(){return 6}get _lang(){return H(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){if(super.updated(e),Qi(this,e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t,lt(this._stats.budget)}catch{}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}_onEventClick(e){if(e.history_timestamp){this._openHistoryEntry(e);return}li(e.entry_id,e.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(e){try{let t=await fr(this.hass,e.entry_id,e.task_id,e.history_timestamp);if(!t||oi(t))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,o=null;this._userFilter&&(o=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let _=b=>{let Q=b.toLowerCase();return this._objects.find(q=>q.entry_id===b||q.object.name.toLowerCase()===Q)?.entry_id??null},p=new Set(this._configuredObjects.map(_).filter(b=>b!==null)),c=p.size?this._objects.filter(b=>p.has(b.entry_id)):this._objects,m=this._config.show_object_filter!==!1&&c.length>1,f=this._objectFilter?_(this._objectFilter):null,w=f&&c.some(b=>b.entry_id===f)?c.filter(b=>b.entry_id===f):c,y=new Date;y.setHours(0,0,0,0);let $=this._pastDays>0,A=$?Fi(w,y,this._pastDays,o):zi(w,y,this._windowDays,o),z=ve(y),U=this._windowDays===365||$,D=U?A.filter(b=>b.events.length>0):A,G=b=>{let Q=`cal-status-${b.status}`,we=b.projected?"cal-event-projected":"",q=b.status==="overdue"&&b.days_until_due!=null?` (${rr(b.days_until_due,e)})`:"",O=b.projected&&b.interval_days?l`<span class="cal-event-recur">${b.interval_unit&&b.interval_unit!=="days"?`${b.interval_days} ${n("unit_"+b.interval_unit,e)}`:n("cal_every_n_days",e).replace("{n}",String(b.interval_days))}</span>`:h,ue=b.schedule_type==="sensor_based",Ne=ue?l`<ha-icon class="cal-event-icon cal-source-sensor"
        ...
        <div class="cal-event ${we}"
          ...
          ${b.avg_cost!=null&&b.avg_cost>0?l`<span class="cal-event-cost">${de(b.avg_cost,Ss,e)}</span>`:h}
        </div>
              ...
              <div class="cal-controls">
                ...
                ${m?l`
                      <select class="cal-user-filter"
                        ...
                        ${[...c].sort((b,Q)=>b.object.name.localeCompare(Q.object.name)).map(b=>l`<option value=${b.entry_id} ?selected=${b.entry_id===f}>${b.object.name}</option>`)}
                      </select>
                    `:h}
              </div>
            `:h}
    ...
    `],d([v({attribute:!1})],W.prototype,"hass",2),d([u()],W.prototype,"_config",2),d([u()],W.prototype,"_objects",2),d([u()],W.prototype,"_stats",2),d([u()],W.prototype,"_windowDays",2),d([u()],W.prototype,"_pastDays",2),d([u()],W.prototype,"_userFilter",2),d([u()],W.prototype,"_objectFilter",2),d([u()],W.prototype,"_unsub",2);var pa=[{value:7,key:"cal_editor_window_week"},{value:14,key:"cal_editor_window_fortnight"},{value:30,key:"cal_editor_window_month"},{value:365,key:"cal_editor_window_year"}],Le=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}get _lang(){return H(this.hass)}setConfig(e){this._config={...e}}updated(){let e=this._lang;e&&!Ge(e)&&Qe(e).then(()=>this.requestUpdate())}_valueChanged(e,t){let i={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete i.show_window_chips,e==="show_user_filter"&&t===!0&&delete i.show_user_filter,e==="show_object_filter"&&t===!0&&delete i.show_object_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete i.title,e==="user_filter"&&t===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let e=this._lang,t=this._config.window_days??30,i=this._config.show_window_chips!==!1,a=this._config.show_user_filter!==!1,o=this._config.user_filter??"",_=this._config.title??"";return l`
      <div class="editor">
        ...
        <div class="row">
          ...
          >
            ${pa.map(p=>l`<option value="${p.value}" ?selected=${p.value===t}>${n(p.key,e)}</option>`)}
          </select>
        </div>
  ...
  `,d([v({attribute:!1})],Le.prototype,"hass",2),d([u()],Le.prototype,"_config",2);customElements.get("maintenance-supporter-calendar-card")||customElements.define("maintenance-supporter-calendar-card",W);customElements.get("maintenance-supporter-calendar-card-editor")||customElements.define("maintenance-supporter-calendar-card-editor",Le);dr({type:"maintenance-supporter-calendar-card",name:"Maintenance Supporter \u2014 Calendar",description:"Rolling calendar of maintenance tasks with 7/14/30/365 day windows, source icons, and prediction-confidence pills.",preview:!0});export{W as MaintenanceCalendarCard};
