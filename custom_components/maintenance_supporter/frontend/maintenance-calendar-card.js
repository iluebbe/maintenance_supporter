...
`});function Je(s){if(!s)return[];let r=[],e=s.photo_doc_id;typeof e=="string"&&r.push(e);let t=s.photo_doc_ids;Array.isArray(t)&&r.push(...t);let i=[];for(let a of r){if(typeof a!="string")continue;let o=a.trim();if(!(!o||i.includes(o))&&(i.push(o),i.length>=10))break}return i}var pt=w(()=>{"use strict"});function ir(){let s=new Uint8Array(4);return(globalThis.crypto??{getRandomValues:r=>r.map(()=>Math.floor(Math.random()*256))}).getRandomValues(s),Array.from(s,r=>r.toString(16).padStart(2,"0")).join("")}function ie(s){let r=s?.reading_values;if(!Array.isArray(r))return[];let e=[],t=new Set;for(let i of r){if(!i||typeof i!="object")continue;let a=i;typeof a.id!="string"||!a.id||t.has(a.id)||typeof a.value!="number"||!Number.isFinite(a.value)||(t.add(a.id),e.push({id:a.id,name:typeof a.name=="string"?a.name:a.id,unit:typeof a.unit=="string"?a.unit:null,value:a.value}))}return e}function rr(s){return s.filter(r=>r.type==="completed"&&(r.reading_value!=null||ie(r).length>0)).sort((r,e)=>r.timestamp.localeCompare(e.timestamp))}function sr(s){return rr(s??[]).map(r=>({timestamp:r.timestamp,values:ie(r)})).filter(r=>r.values.length>0)}function nr(s,r,e){let t;for(let i of s){if(e!==void 0){let o=new Date(i.timestamp).getTime();if(!isNaN(o)&&o>=e)break}let a=i.values.find(o=>o.id===r);a&&(t=a)}return t}function ar(s,r,e){let t=ie(r).find(a=>a.id===e);if(!t)return null;let i=null;for(let a of rr(s)){if(a.timestamp>=r.timestamp)break;let o=ie(a).find(c=>c.id===e);o&&(i=o.value)}return i==null?null:t.value-i}function or(s){let r=new Set,e=new Set;for(let t of s){let i=(t.name||"").trim().toLowerCase();i&&(r.has(i)?e.add(t.id):r.add(i))}return e}function lr(s){let r=[],e=new Set,t=new Set;for(let i of s){let a=(i.name||"").trim();if(!(!a||e.has(i.id)||t.has(a.toLowerCase()))&&(e.add(i.id),t.add(a.toLowerCase()),r.push({id:i.id,name:a,unit:(i.unit||"").trim()||null}),r.length>=20))break}return r}var Te=w(()=>{"use strict"});function zs(s,r){let e=Ms[s];if(!e)return s;let t=n(e,r);return t&&t!==e?t:s}function Fs(s){let e=s.match(/data\['([^']+)'\]/)?.[1],t;return(t=s.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=s.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=s.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=s.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(s)?{field:e,rule:"required"}:(t=s.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(s)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(s)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function N(s,r,e){if(e=e??n("action_error",r),typeof s=="string")return s;if(typeof s!="object"||s===null)return e;let t=s,i=t.message||t.error?.message||"";if(!i)return e;let a=Fs(i),o=a.field?zs(a.field,r):"",c=p=>n(p,r).replace("{field}",o).replace("{n}",a.param??"");switch(a.rule){case"too_long":return c("err_too_long");case"too_short":return c("err_too_short");case"value_too_high":return c("err_value_too_high");case"value_too_low":return c("err_value_too_low");case"required":return c("err_required");case"wrong_type":return c("err_wrong_type").replace("{type}",a.param??"");case"invalid_choice":return c("err_invalid_choice");case"invalid_value":return c("err_invalid_value");default:return i||e}}var Ms,ye=w(()=>{"use strict";C();Ms={entry_id:"object",name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",warranty_expiry:"warranty_expiry_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_equals:"trigger_equals",trigger_not_equals:"trigger_not_equals",trigger_for_minutes:"trigger_for_minutes"}});var j,Ht=w(()=>{"use strict";I();F();j=class extends S{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return l`
      <label class="field">
  ...
  `,d([v()],j.prototype,"label",2),d([v()],j.prototype,"value",2),d([v()],j.prototype,"placeholder",2),d([v()],j.prototype,"type",2),d([v({type:Boolean})],j.prototype,"required",2),d([v({type:Boolean})],j.prototype,"disabled",2),d([v()],j.prototype,"step",2),d([v()],j.prototype,"min",2),d([v()],j.prototype,"max",2),d([v()],j.prototype,"pattern",2),d([v()],j.prototype,"helper",2),d([v({type:Boolean})],j.prototype,"multiline",2),d([v({type:Number})],j.prototype,"rows",2);customElements.get("ms-textfield")||customElements.define("ms-textfield",j)});function Us(s){let e=B("2001-02-03",s).match(/\d+/g)||[],t=c=>e.findIndex(p=>Number(p)===c),i=t(2001),a=t(2),o=t(3);return i===0?"YMD":a>=0&&o>=0&&a<o?"MDY":"DMY"}function Ce(s,r,e){if(s<1e3||s>9999||r<1||r>12||e<1||e>31)return null;let t=new Date(s,r-1,e);return t.getFullYear()!==s||t.getMonth()!==r-1||t.getDate()!==e?null:`${s}-${String(r).padStart(2,"0")}-${String(e).padStart(2,"0")}`}function dr(s,r){let e=s.trim(),t;if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})$/))return Ce(+t[1],+t[2],+t[3]);if(t=e.match(/^(\d{4})$/))return Ce(+t[1],1,1);if(t=e.match(/^(\d{1,2})[./](\d{4})$/))return Ce(+t[2],+t[1],1);if(t=e.match(/^(\d{1,2})\.(\d{1,2})\.(\d{4})$/))return Ce(+t[3],+t[2],+t[1]);if(t=e.match(/^(\d{1,2})[/-](\d{1,2})[/-](\d{4})$/)){let i=+t[1],a=+t[2],o=+t[3];return Us(r)==="MDY"?Ce(o,i,a):Ce(o,a,i)}return null}var cr=w(()=>{"use strict";C()});function Bs(s,r){if(r)switch(s){case"date":return r.split("T")[0];case"time":return r.length===5?`${r}:00`:r;case"datetime":{let[e,t="00:00:00"]=r.split("T");return`${e} ${t.length===5?`${t}:00`:t}`}}}function Vs(s,r){if(typeof r!="string"||!r)return"";switch(s){case"date":return r.slice(0,10);case"time":return r.slice(0,5);case"datetime":{let[e,t="00:00:00"]=r.split(" ");return`${e}T${t.length===5?`${t}:00`:t}`}}}var M,Ie=w(()=>{"use strict";I();F();C();cr();M=class extends S{constructor(){super(...arguments);this.kind="date";this.label="";this.value="";this.clearable=!1;this.disabled=!1;this.required=!1;this.lang="en";this._typing=!1;this._typed="";this._typedInvalid=!1}_startTyping(){this._typed=this.value,this._typedInvalid=!1,this._typing=!0,this.updateComplete.then(()=>this.shadowRoot?.querySelector("input.typed")?.focus())}_commitTyped(){if(!this._typed.trim()){this._typing=!1;return}let e=dr(this._typed,this.lang);if(!e){this._typedInvalid=!0;return}this._typing=!1,this._typedInvalid=!1,this._emit(e)}_onTypedKey(e){e.key==="Enter"?(e.preventDefault(),this._commitTyped()):e.key==="Escape"&&(e.preventDefault(),this._typing=!1,this._typedInvalid=!1)}_selector(){switch(this.kind){case"date":return{date:{}};case"time":return{time:{no_second:!0}};case"datetime":return{datetime:{}}}}_onSelectorChange(e){e.stopPropagation(),this._emit(Vs(this.kind,e.detail?.value))}_clear(){this._emit("")}_emit(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{bubbles:!0,composed:!0,detail:{value:e}})))}render(){return l`
      <div class="field">
        ${this.label?l`<span class="label">${this.label}${this.required?l`<span class="req">*</span>`:h}</span>`:h}
        <div class="row">
...
`),partId:H?.part_id||"",partQty:H?.quantity!=null?String(H.quantity):"",reqOverride:m.required_completion_fields!==void 0,reqFields:[...m.required_completion_fields||[]],extraParts:z.filter((G,oe)=>oe!==U).map(G=>({...G})),carry:T}}),this._phaseSeq=[...t.phase_sequence||[]],this._requiredCompletion=[...t.required_completion_fields||[]],this._scheduleTime=t.schedule_time||"",this._scheduleTimeOn=!!t.schedule_time;let o=t.on_complete_action;if(o&&o.service){this._actionService=o.service;let u=o.target?.entity_id;this._actionTargetEntity=Array.isArray(u)?u[0]||"":u||"",this._actionData=o.data&&typeof o.data=="object"?{...o.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let c=t.quick_complete_defaults;this._qcNotes=c?.notes||"",this._qcCost=c?.cost!=null?String(c.cost):"",this._qcDuration=c?.duration!=null?String(c.duration):"",this._qcFeedback=c?.feedback||"";let p=t.adaptive_config||{};if(this._environmentalEntity=p.environmental_entity||"",this._environmentalAttribute=p.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,this._adaptiveEnabled=!!p.enabled,this._adaptiveAlpha=p.ewa_alpha?.toString()??re.alpha,this._adaptiveMin=p.min_interval_days?.toString()??re.min,this._adaptiveMax=p.max_interval_days?.toString()??re.max,this._adaptiveSeasonal=p.seasonal_enabled!==!1,this._adaptivePrediction=p.sensor_prediction_enabled!==!1,this._adaptiveInitial=this._adaptiveSnapshot(),t.trigger_config){let u=t.trigger_config;this._triggerEntityId=u.entity_id||u.entity_ids&&u.entity_ids[0]||"",this._triggerEntityIds=u.entity_ids||(u.entity_id?[u.entity_id]:[]),this._triggerEntityLogic=u.entity_logic||"any",this._triggerAttribute=u.attribute||"",this._triggerType=u.type||"threshold",this._triggerAbove=u.trigger_above?.toString()||"",this._triggerBelow=u.trigger_below?.toString()||"",this._triggerEquals=u.trigger_equals?.toString()||"",this._triggerNotEquals=u.trigger_not_equals?.toString()||"",this._triggerForMinutes=u.trigger_for_minutes?.toString()||"0",this._triggerCombinator=u.trigger_combinator==="all"?"all":"any",this._triggerTargetValue=u.trigger_target_value?.toString()||"",this._triggerDeltaMode=u.trigger_delta_mode||!1,this._triggerBaselineValue=u.trigger_baseline_value?.toString()||"",this._liveBaselineValue=t.trigger_baseline_value??null,this._autoCompleteOnRecovery=u.auto_complete_on_recovery||!1,this._triggerFromState=u.trigger_from_state||"",this._triggerToState=u.trigger_to_state||"",this._triggerTargetChanges=u.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=u.trigger_runtime_hours?.toString()||"",this._triggerRuntimeMaxSession=u.trigger_runtime_max_session_seconds?.toString()||"",this._triggerOnStates=(u.trigger_on_states||[]).join(", "),u.type==="compound"?(this._compoundLogic=u.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(u.conditions||[]).map(tn)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._requireTagScan=!1,this._allowSkip=!0,this._readingUnit="",this._readings=[],this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._phaseDefs=[],this._phaseSeq=[],this._requiredCompletion=[],this._scheduleTime="",this._scheduleTimeOn=!1,this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._adaptiveEnabled=!1,this._adaptiveAlpha=re.alpha,this._adaptiveMin=re.min,this._adaptiveMax=re.max,this._adaptiveSeasonal=!0,this._adaptivePrediction=!0,this._adaptiveInitial=this._adaptiveSnapshot(),this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerEquals="",this._triggerNotEquals="",this._triggerForMinutes="0",this._triggerCombinator="any",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerRuntimeMaxSession="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new ut(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}_toggleAssignee(e){this._assigneePool=this._assigneePool.includes(e)?this._assigneePool.filter(t=>t!==e):[...this._assigneePool,e]}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[t,i]=e.split(".");if(!this.hass?.services?.[t]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let a=this._actionTargetEntity.trim();if(a){let o=a.split(".")[0];if(o!==t&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(t)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${t}.* entities; entity "${a}" is in ${o}.* \u2014 pick a service that matches the entity domain (e.g. ${o}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[a]){this._actionTestResult="error",this._actionTestError=`Target entity "${a}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,i]=e.split("."),a=this.hass?.services?.[t]?.[i]?.fields;return!a||Object.keys(a).length===0?null:Object.entries(a).map(([o,c])=>({name:o,required:!!c.required,selector:c.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return h;let t=this._serviceSchema();return l`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${i=>{this._actionService=i.detail.value||"";let a=this._serviceSchema();if(a){let o=new Set(a.map(c=>c.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([c])=>o.has(c)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
      ...
      <div class="consumes-row">
        <label class="consumes-check">
          <input
            type="checkbox"
            .checked=${a!==void 0}
            @change=${c=>{let p={...this._consumesParts};c.target.checked?p[i]=p[i]||o:delete p[i],this._consumesParts=p}}
          />
        ...
        ${a!==void 0?l`<input
              ...
              @input=${c=>{let p=parseFloat(c.target.value);this._consumesParts={...this._consumesParts,[i]:{...o,quantity:Number.isFinite(p)&&p>=.01?p:1}}}}
            />`:h}
      </div>
    `}_toggleRequired(e,t){let i=new Set(this._requiredCompletion);t?i.add(e):i.delete(e),this._requiredCompletion=[...i]}_patchReading(e,t){this._readings=this._readings.map(i=>i.id===e?{...i,...t}:i)}_renderReadingsEditor(e){let t=or(this._readings);return l`
      <div class="readings-editor">
        ...
        ${this._readings.length<20?l`
          <ha-button appearance="plain" class="reading-add"
            @click=${()=>this._readings=[...this._readings,{id:ir(),name:"",unit:this._readings.length?this._readings[this._readings.length-1].unit:this._readingUnit}]}>
              ...
              ${Dt.map(a=>l`
                <label class="req-option">
                  <input
                    ...
                    @change=${o=>{let c=o.target.checked,p=new Set(i.reqFields);c?p.add(a):p.delete(a),this._patchPhaseDef(i.id,{reqFields:[...p]})}}
                  />
                  <span>${n(Ze[a],e)}</span>
                </label>
              `)}
        ...
        <div class="phase-seq">
          ${this._phaseSeq.map((i,a)=>l`
            <span class="phase-chip">
              ${a+1}. ${t(i)}
              <button class="phase-chip-x" @click=${()=>{this._phaseSeq=this._phaseSeq.filter((o,c)=>c!==a)}}>✕</button>
            </span>
          `)}
          <select
            class="phase-seq-add"
...
`).map(p=>p.trim()).filter(Boolean).slice(0,100);e.checklist=c.length?c:null}if(this.completionActionsEnabled){let c=this._actionService.trim();if(c&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(c)){let f={service:c},x=this._actionTargetEntity.trim();x&&(f.target={entity_id:x});let y=this._buildActionData();Object.keys(y).length>0&&(f.data=y),e.on_complete_action=f}else e.on_complete_action=null;let p={};this._qcNotes.trim()&&(p.notes=this._qcNotes.trim());let u=parseFloat(this._qcCost);!isNaN(u)&&u>=0&&(p.cost=u);let m=parseInt(this._qcDuration,10);!isNaN(m)&&m>=0&&(p.duration=m),this._qcFeedback&&(p.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(p).length?p:null}let i=await this.hass.connection.sendMessagePromise(e),a=this._taskId||i?.task_id,o=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(a&&this._scheduleType==="sensor_based"&&o)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(a&&this._adaptiveSnapshot()!==this._adaptiveInitial){let c=parseFloat(this._adaptiveAlpha),p=parseInt(this._adaptiveMin,10),u=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:a,enabled:this._adaptiveEnabled,...c>=.1&&c<=.9?{ewa_alpha:c}:{},...!isNaN(p)&&p>=1?{min_interval_days:p}:{},...!isNaN(u)&&u>=1?{max_interval_days:u}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=N(e,this._lang,n("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return h;let e=this._lang,t=this._triggerType==="compound";return l`
      ...
      <div class="select-row">
        ...
        >
          ${Zs.map(i=>l`<option value=${i} ?selected=${i===this._triggerType}>${n(i,e)}</option>`)}
        </select>
      </div>
      ...
      ${this._intervalDays?l`
          ...
          `:h}
    `}_patchCondition(e,t){this._compoundConditions=this._compoundConditions.map((i,a)=>a===e?{...i,...t}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Xs()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((t,i)=>i!==e)}_renderCompoundEditor(){let e=this._lang;return l`
      <div class="select-row">
    ...
    `}_renderCondition(e,t){let i=this._lang,a=t+1;return l`
      <div class="compound-condition">
        ...
        <div class="select-row">
          ...
          >
            ${$r.map(o=>l`<option value=${o} ?selected=${o===e.type}>${n(o,i)}</option>`)}
          </select>
        </div>
    ...
    `}_buildSchedule(){let e=i=>{let a=parseInt(this._calOffset,10)||0;return a&&(i.offset=Math.max(-15,Math.min(a,15))),i};if(this._scheduleType==="weekdays")return e({kind:"weekdays",weekdays:[...this._weekdays].sort((i,a)=>i-a)});if(this._scheduleType==="nth_weekday")return e({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let t={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(t.business=!0),e(t)}_recurrenceExtras(){let e={};if(this._seasonMonths.length&&(e.season_months=[...this._seasonMonths].sort((t,i)=>t-i)),this._endsMode==="count"){let t=parseInt(this._endsCount,10);t>=1&&(e.ends={count:t})}else this._endsMode==="until"&&this._endsUntil&&(e.ends={until:this._endsUntil});return e}_toggleSeasonMonth(e){this._seasonMonths=this._seasonMonths.includes(e)?this._seasonMonths.filter(t=>t!==e):[...this._seasonMonths,e]}_renderRecurrenceExtras(){let e=this._lang;if(!(this._scheduleType==="time_based"||_t.includes(this._scheduleType)))return h;let i=nn(e);return l`
      ...
      ${this._endsMode==="until"?l`
        ...
        ></ms-date-field>`:h}
    `}_renderCalendarFields(){let e=this._lang,t=sn(e);if(this._scheduleType==="weekdays")return l`
      ...
      ></ms-textfield>`}_thresholdLimitsOverlap(){let e=parseFloat(this._triggerAbove),t=parseFloat(this._triggerBelow);return!isNaN(e)&&!isNaN(t)&&t>e}_renderTriggerLiveHint(){if(this._triggerType==="compound")return h;let e=this._triggerType==="threshold"&&this._thresholdLimitsOverlap()?l`<div class="trigger-live-hint warn">${n("trigger_hint_overlap",this._lang)}</div>`:h,t=this._triggerEntityId||this._triggerEntityIds[0];if(!t||!this.hass?.states)return e;let i=this.hass.states[t];if(!i)return e;let a=this._lang,o=i.attributes?.unit_of_measurement,c=typeof o=="string"&&o?` ${o}`:"",p=this._triggerAttribute?i.attributes?.[this._triggerAttribute]:i.state,u=typeof p=="number"?p:parseFloat(String(p)),m=p!=="unknown"&&p!=="unavailable"&&p!=null&&!isNaN(u),f=y=>q(y,a,{maximumFractionDigits:1}),x=[];if(this._triggerType==="threshold"){let y=parseFloat(this._triggerAbove),k=parseFloat(this._triggerBelow);if(isNaN(y)&&isNaN(k))return h;m&&x.push(n("trigger_hint_now",a).replace("{value}",f(u)+c)),isNaN(y)||x.push(n("trigger_hint_above",a).replace("{target}",f(y)+c)),isNaN(k)||x.push(n("trigger_hint_below",a).replace("{target}",f(k)+c))}else if(this._triggerType==="counter"){let y=parseFloat(this._triggerTargetValue);if(isNaN(y))return h;this._triggerDeltaMode?this._taskId?x.push(n("trigger_hint_counter_delta_edit",a).replace("{target}",f(y)+c)):m?x.push(n("trigger_hint_counter_delta",a).replace("{value}",f(u)+c).replace("{due}",f(u+y)+c).replace("{target}",f(y)+c)):x.push(n("trigger_hint_counter_delta_edit",a).replace("{target}",f(y)+c)):(m&&x.push(n("trigger_hint_now",a).replace("{value}",f(u)+c)),x.push(n("trigger_hint_counter_abs",a).replace("{target}",f(y)+c)))}else if(this._triggerType==="runtime"){let y=parseFloat(this._triggerRuntimeHours);if(isNaN(y))return h;x.push(n("trigger_hint_runtime",a).replace("{hours}",f(y))),x.push(n("trigger_hint_state_now",a).replace("{value}",String(i.state)))}else if(this._triggerType==="state_change"){let y=parseInt(this._triggerTargetChanges,10)||1,k=this._triggerToState.trim();x.push((k?n("trigger_hint_state_change_to",a).replace("{state}",k):n("trigger_hint_state_change",a)).replace("{count}",String(y))),x.push(n("trigger_hint_state_now",a).replace("{value}",String(i.state)))}return x.length?l`<div class="trigger-live-hint">${x.join(" ")}</div>${e}`:e}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?l`
        <ms-textfield
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Gs.map(i=>l`<option value=${i} ?selected=${i===this._type}>${n(i,e)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${Qs.map(i=>l`<option value=${i} ?selected=${i===this._priority}>${n("priority_"+i,e)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${Js.map(i=>l`<option value=${i} ?selected=${i===this._scheduleType}>${n(i,e)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="one_time"?l`
                ...
                ></ms-date-field>
              `:h}
          ${this.scheduleTimeEnabled&&wr.includes(this._scheduleType)?l`
          ...
          ${this._scheduleType==="sensor_based"?l`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:yr,device_class:br}}}]}
  ...
  `,d([v({attribute:!1})],g.prototype,"hass",2),d([v({type:Boolean,attribute:"checklists-enabled"})],g.prototype,"checklistsEnabled",2),d([v({type:Boolean,attribute:"schedule-time-enabled"})],g.prototype,"scheduleTimeEnabled",2),d([v({type:Boolean,attribute:"completion-actions-enabled"})],g.prototype,"completionActionsEnabled",2),d([v({type:Number,attribute:"default-warning-days"})],g.prototype,"defaultWarningDays",2),d([_()],g.prototype,"parts",2),d([_()],g.prototype,"_foreignOwners",2),d([_()],g.prototype,"_open",2),d([_()],g.prototype,"_entityPickerFallback",2),d([_()],g.prototype,"_loading",2),d([_()],g.prototype,"_error",2),d([_()],g.prototype,"_entryId",2),d([_()],g.prototype,"_taskId",2),d([_()],g.prototype,"_objectChoices",2),d([_()],g.prototype,"_name",2),d([_()],g.prototype,"_type",2),d([_()],g.prototype,"_scheduleType",2),d([_()],g.prototype,"_intervalDays",2),d([_()],g.prototype,"_intervalUnit",2),d([_()],g.prototype,"_dueDate",2),d([_()],g.prototype,"_warningDays",2),d([_()],g.prototype,"_earliestCompletionDays",2),d([_()],g.prototype,"_intervalAnchor",2),d([_()],g.prototype,"_weekdays",2),d([_()],g.prototype,"_nth",2),d([_()],g.prototype,"_nthWeekday",2),d([_()],g.prototype,"_domDay",2),d([_()],g.prototype,"_domLastDay",2),d([_()],g.prototype,"_domBusiness",2),d([_()],g.prototype,"_calOffset",2),d([_()],g.prototype,"_seasonMonths",2),d([_()],g.prototype,"_endsMode",2),d([_()],g.prototype,"_endsCount",2),d([_()],g.prototype,"_endsUntil",2),d([_()],g.prototype,"_schedulePreview",2),d([_()],g.prototype,"_schedulePreviewEnded",2),d([_()],g.prototype,"_notes",2),d([_()],g.prototype,"_documentationUrl",2),d([_()],g.prototype,"_customIcon",2),d([_()],g.prototype,"_priority",2),d([_()],g.prototype,"_labels",2),d([_()],g.prototype,"_enabled",2),d([_()],g.prototype,"_triggerEntityId",2),d([_()],g.prototype,"_triggerEntityIds",2),d([_()],g.prototype,"_triggerEntityLogic",2),d([_()],g.prototype,"_triggerAttribute",2),d([_()],g.prototype,"_triggerType",2),d([_()],g.prototype,"_triggerAbove",2),d([_()],g.prototype,"_triggerBelow",2),d([_()],g.prototype,"_triggerEquals",2),d([_()],g.prototype,"_triggerNotEquals",2),d([_()],g.prototype,"_triggerForMinutes",2),d([_()],g.prototype,"_triggerCombinator",2),d([_()],g.prototype,"_triggerTargetValue",2),d([_()],g.prototype,"_triggerDeltaMode",2),d([_()],g.prototype,"_triggerBaselineValue",2),d([_()],g.prototype,"_liveBaselineValue",2),d([_()],g.prototype,"_autoCompleteOnRecovery",2),d([_()],g.prototype,"_triggerFromState",2),d([_()],g.prototype,"_triggerToState",2),d([_()],g.prototype,"_triggerTargetChanges",2),d([_()],g.prototype,"_triggerRuntimeHours",2),d([_()],g.prototype,"_triggerRuntimeMaxSession",2),d([_()],g.prototype,"_triggerOnStates",2),d([_()],g.prototype,"_compoundLogic",2),d([_()],g.prototype,"_compoundConditions",2),d([_()],g.prototype,"_suggestedAttributes",2),d([_()],g.prototype,"_availableAttributes",2),d([_()],g.prototype,"_entityDomain",2),d([_()],g.prototype,"_lastPerformed",2),d([_()],g.prototype,"_nfcTagId",2),d([_()],g.prototype,"_requireTagScan",2),d([_()],g.prototype,"_allowSkip",2),d([_()],g.prototype,"_notifyEnabled",2),d([_()],g.prototype,"_readingUnit",2),d([_()],g.prototype,"_readings",2),d([_()],g.prototype,"_consumesParts",2),d([_()],g.prototype,"_partsLoadFailed",2),d([_()],g.prototype,"_availableTags",2),d([_()],g.prototype,"_responsibleUserId",2),d([_()],g.prototype,"_assigneePool",2),d([_()],g.prototype,"_rotationStrategy",2),d([_()],g.prototype,"_availableUsers",2),d([_()],g.prototype,"_checklistText",2),d([_()],g.prototype,"_phaseDefs",2),d([_()],g.prototype,"_phaseSeq",2),d([_()],g.prototype,"_requiredCompletion",2),d([_()],g.prototype,"_scheduleTime",2),d([_()],g.prototype,"_scheduleTimeOn",2),d([_()],g.prototype,"_actionService",2),d([_()],g.prototype,"_actionTargetEntity",2),d([_()],g.prototype,"_actionData",2),d([_()],g.prototype,"_actionDataJsonFallback",2),d([_()],g.prototype,"_actionTesting",2),d([_()],g.prototype,"_actionTestResult",2),d([_()],g.prototype,"_actionTestError",2),d([_()],g.prototype,"_qcNotes",2),d([_()],g.prototype,"_qcCost",2),d([_()],g.prototype,"_qcDuration",2),d([_()],g.prototype,"_qcFeedback",2),d([_()],g.prototype,"_environmentalEntity",2),d([_()],g.prototype,"_environmentalAttribute",2),d([_()],g.prototype,"_adaptiveEnabled",2),d([_()],g.prototype,"_adaptiveAlpha",2),d([_()],g.prototype,"_adaptiveMin",2),d([_()],g.prototype,"_adaptiveMax",2),d([_()],g.prototype,"_adaptiveSeasonal",2),d([_()],g.prototype,"_adaptivePrediction",2),d([_()],g.prototype,"_conditionAttrOptions",2);zt=g;customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",zt)});async function an(s,r,e,t){let i=new FormData;i.append("entry_id",r);for(let c of t)i.append("tags",c);i.append("file",e,e.name);let a=await fetch("/api/maintenance_supporter/document/upload",{method:"POST",headers:{Authorization:`Bearer ${s.auth?.data?.access_token??""}`},body:i});if(a.status===413)throw new Error("doc_too_large");if(!a.ok)throw new Error("doc_upload_failed");let o=await a.json();if(!o.id)throw new Error("doc_upload_failed");return{id:o.id,deduped:!!o.deduped,duplicate_in_object:o.duplicate_in_object??null}}async function Sr(s,r,e){return(await an(s,r,e,["photo"])).id}async function Ft(s,r){await Promise.all(r.map(e=>s.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:e}).catch(()=>{})))}var Ar=w(()=>{"use strict";pt()});var Pe,Ut=w(()=>{"use strict";C();Ar();Pe=class{constructor(r,e){this.host=r;this.opts=e;this.photos=[];this.uploadedIds=[];this.uploading=!1;this.errorKey="";this.max=e.max??10,r.addController(this)}hostConnected(){}get ids(){return this.photos.map(r=>r.id)}get remaining(){return Math.max(this.max-this.photos.length,0)}get full(){return this.remaining===0}errorText(r){return this.errorKey?n(this.errorKey,r).replace("{max}",String(this.max)):""}clearError(){this.errorKey=""}reset(r=[]){this._revokeAll(),this.photos=r.map(e=>({id:e,preview:""})),this.uploadedIds=[],this.uploading=!1,this.errorKey="",this.host.requestUpdate()}async addFiles(r){if(r.length===0)return;let e=r.slice(0,this.remaining);this.uploading=!0,this.errorKey="",this.host.requestUpdate();try{for(let t of e){let i=await Sr(this.opts.hass(),this.opts.entryId(),t);this.uploadedIds=[...this.uploadedIds,i],this.photos=[...this.photos,{id:i,preview:URL.createObjectURL(t)}],this.host.requestUpdate()}r.length>e.length&&(this.errorKey="photos_limit")}catch(t){this.errorKey=t instanceof Error&&t.message==="doc_too_large"?"doc_too_large":"doc_upload_failed"}finally{this.uploading=!1,this.host.requestUpdate()}}remove(r){let e=this.photos.find(t=>t.id===r);e?.preview&&URL.revokeObjectURL(e.preview),this.photos=this.photos.filter(t=>t.id!==r),this.uploadedIds.includes(r)&&(this.uploadedIds=this.uploadedIds.filter(t=>t!==r),Ft(this.opts.hass(),[r])),this.host.requestUpdate()}discardOrphans(){if(this.uploadedIds.length===0)return;let r=this.uploadedIds;this.uploadedIds=[],Ft(this.opts.hass(),r)}markAttached(){this.uploadedIds=[]}_revokeAll(){for(let r of this.photos)r.preview&&URL.revokeObjectURL(r.preview)}}});function gt(){if(window.externalApp!==void 0)return!0;let r=typeof navigator<"u"&&navigator.userAgent||"";return/Home Assistant\//.test(r)&&/Android/.test(r)}var Bt=w(()=>{"use strict"});function Tr(){if(!gt())return!1;let s=typeof navigator<"u"?navigator.mediaDevices:void 0;return!!s&&typeof s.getUserMedia=="function"}var on,ln,be,Vt=w(()=>{"use strict";I();F();C();Bt();on=1920,ln=.88,be=class extends S{constructor(){super(...arguments);this.lang="en";this._open=!1;this._busy=!1;this._stream=null}async open(){if(this._open)return;let e=typeof navigator<"u"?navigator.mediaDevices:void 0;if(!e||typeof e.getUserMedia!="function"){this._unavailable("no_media_devices");return}try{this._stream=await e.getUserMedia({video:{facingMode:{ideal:"environment"}},audio:!1})}catch(i){this._unavailable(i instanceof Error?i.name||i.message:String(i));return}this._open=!0,await this.updateComplete;let t=this._video;if(t&&this._stream){t.srcObject=this._stream;try{await t.play()}catch{}}}close(){this._stopStream(),this._open=!1,this._busy=!1}disconnectedCallback(){super.disconnectedCallback(),this._stopStream()}get _video(){return this.shadowRoot?.querySelector("video")??null}_stopStream(){for(let t of this._stream?.getTracks()??[])t.stop();this._stream=null;let e=this._video;e&&(e.srcObject=null)}_unavailable(e){this._stopStream(),this._open=!1,this.dispatchEvent(new CustomEvent("capture-unavailable",{detail:{reason:e},bubbles:!0,composed:!0}))}async _shoot(){let e=this._video;if(!(!e||this._busy)){this._busy=!0;try{let t=e.videoWidth||640,i=e.videoHeight||480,a=Math.min(1,on/Math.max(t,i)),o=document.createElement("canvas");o.width=Math.round(t*a),o.height=Math.round(i*a);let c=o.getContext("2d");if(!c)throw new Error("no_canvas");c.drawImage(e,0,0,o.width,o.height);let p=await new Promise(f=>o.toBlob(f,"image/jpeg",ln));if(!p)throw new Error("no_blob");let u=new Date().toISOString().replace(/[-:]/g,"").slice(0,15),m=new File([p],`photo-${u}.jpg`,{type:"image/jpeg"});this.close(),this.dispatchEvent(new CustomEvent("photo-captured",{detail:{file:m},bubbles:!0,composed:!0}))}catch(t){this._unavailable(t instanceof Error?t.message:String(t))}finally{this._busy=!1}}}render(){if(!this._open)return h;let e=this.lang;return l`
  ...
  `,d([v({type:String})],be.prototype,"lang",2),d([_()],be.prototype,"_open",2),d([_()],be.prototype,"_busy",2);customElements.get("ms-camera-capture")||customElements.define("ms-camera-capture",be)});var mt,K,Xe=w(()=>{"use strict";I();F();C();Bt();Vt();Vt();mt=E`
...
`,K=class extends S{constructor(){super(...arguments);this.lang="en";this.disabled=!1;this.busy=!1;this.accept="image/*";this.showCamera=!0;this.showGallery=!0;this.compact=!1;this.remaining=1/0;this._singlePick=gt();this._inAppCamera=Tr()}createRenderRoot(){return this}get _locked(){return this.disabled||this.busy}_emit(e){e.length!==0&&this.dispatchEvent(new CustomEvent("files-picked",{detail:{files:e},bubbles:!0,composed:!0}))}_onInput(e){let t=e.target,i=Array.from(t.files??[]);t.value="",this._emit(i)}_onCameraClick(e){!this._inAppCamera||this._locked||(e.preventDefault(),this.querySelector("ms-camera-capture")?.open())}_onCameraUnavailable(){this._inAppCamera=!1,this.querySelector(".photo-pick-camera input")?.click()}_onKeydown(e){e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),!this._locked&&e.currentTarget.click())}render(){if(this.remaining<=0||!this.showCamera&&!this.showGallery)return h;let e=this.lang,t=this._locked?"disabled":"",i=this.busy?n("uploading",e):n("doc_camera",e),a=n(this._singlePick?"choose_photo":"choose_photos",e);return l`
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?l`<div class="used-parts">
                ...
                ${this.parts.map(i=>{let a=J({part_id:i.id,entry_id:i.entry_id}),o=this._usedParts[a],c=o!==void 0,p=i.entry_id?{part_id:i.id,quantity:1,entry_id:i.entry_id}:{part_id:i.id,quantity:1};return l`<div class="used-part-row">
                    <label class="used-part-check">
                      <input type="checkbox" .checked=${c}
                        @change=${u=>{let m={...this._usedParts};u.target.checked?m[a]=m[a]||p:delete m[a],this._usedParts=m}} />
                      <span
                    ...
                    ${c?l`<input class="used-part-qty" type="number" min="0.01" max="999" step="0.01"
                          .value=${String(o.quantity)}
                          @input=${u=>{let m=parseFloat(u.target.value);this._usedParts={...this._usedParts,[a]:{...p,quantity:Number.isFinite(m)&&m>=.01?m:1}}}} />`:h}
                  </div>`})}
        ...
        <div class="dialog-actions">
          ...
          <ha-button
            ...
            title=${this._missingRequired.length?this._missingRequired.map(i=>n("err_required",e).replace("{field}",n(Ze[i]??i,e))).join(" \xB7 "):""}
          >
  ...
  `],d([v({attribute:!1})],$.prototype,"hass",2),d([v()],$.prototype,"entryId",2),d([v()],$.prototype,"taskId",2),d([v()],$.prototype,"taskName",2),d([v()],$.prototype,"lang",2),d([v({type:Array})],$.prototype,"checklist",2),d([v({type:Boolean})],$.prototype,"adaptiveEnabled",2),d([v()],$.prototype,"taskType",2),d([v()],$.prototype,"readingUnit",2),d([v({attribute:!1})],$.prototype,"readings",2),d([v({attribute:!1})],$.prototype,"readingHistory",2),d([v({attribute:!1})],$.prototype,"restockDefault",2),d([v({attribute:!1})],$.prototype,"restockUnitCost",2),d([v()],$.prototype,"currencySymbol",2),d([v({attribute:!1})],$.prototype,"parts",2),d([v({attribute:!1})],$.prototype,"consumesParts",2),d([v({type:Array})],$.prototype,"consumesInfo",2),d([v({type:Array})],$.prototype,"requiredFields",2),d([v()],$.prototype,"phaseLabel",2),d([v({type:Boolean})],$.prototype,"requireTagScan",2),d([v({type:Boolean})],$.prototype,"viaTagScan",2),d([_()],$.prototype,"_open",2),d([_()],$.prototype,"_notes",2),d([_()],$.prototype,"_cost",2),d([_()],$.prototype,"_duration",2),d([_()],$.prototype,"_loading",2),d([_()],$.prototype,"_error",2),d([_()],$.prototype,"_checklistState",2),d([_()],$.prototype,"_feedback",2),d([_()],$.prototype,"_readingValue",2),d([_()],$.prototype,"_readingValues",2),d([_()],$.prototype,"_restockQty",2),d([_()],$.prototype,"_completedAt",2),d([_()],$.prototype,"_usedParts",2),d([v({attribute:!1})],$.prototype,"checklistPrefill",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",$)});function Ir(s,r,e){let t=new Blob([s],{type:e}),i=URL.createObjectURL(t),a=document.createElement("a");a.href=i,a.download=r,a.target="_blank",a.rel="noopener",a.style.display="none",document.body.appendChild(a),a.dispatchEvent(new MouseEvent("click")),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(i),6e4)}var Wt=w(()=>{"use strict"});async function dn(s,r,e=300){return(await s.connection.sendMessagePromise({type:"auth/sign_path",path:r,expires:e})).path}async function Pr(s,r,e=300){return dn(s,`/api/maintenance_supporter/document/${r}`,e)}var Lr=w(()=>{"use strict";Wt()});var de,Kt=w(()=>{"use strict";I();F();Lr();de=class extends S{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{this._url=await Pr(this.hass,this.docId)}catch{this._failed=!0}}render(){return this._failed||!this.docId?h:this._url?l`
            ...
            ${this._partOptions.map(a=>{let o=`${a.entry_id}:${a.part_id}`,c=this._partQty[o]||0;return l`
                <label class="part-row-edit">
                  <input type="checkbox" .checked=${c>0}
                    @change=${p=>{let u=p.target.checked;this._partQty={...this._partQty,[o]:u?1:0}}} />
                  ...
                  ${c>0?l`
                    <input class="part-qty" type="number" min="0.01" max="999" step="0.01"
                      .value=${String(c)}
                      @input=${p=>{let u=parseFloat(p.target.value);!isNaN(u)&&u>0&&(this._partQty={...this._partQty,[o]:u})}} />
                  `:h}
                </label>
              `})}
          </div>
...
<div class="url">${Le(this._viewResult.url)}</div>
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),a.document.close()}_downloadSvg(e,t){let i=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),a=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;Ir(i,`qr-${cn(a)}-${t}.svg`,"image/svg+xml")}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return l``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${n("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${n("qr_code",e)}: ${this._objectName}`,i=!!this._viewResult;return l`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
  ...
  `,d([v({attribute:!1})],Y.prototype,"hass",2),d([v()],Y.prototype,"lang",2),d([_()],Y.prototype,"_open",2),d([_()],Y.prototype,"_loading",2),d([_()],Y.prototype,"_error",2),d([_()],Y.prototype,"_viewResult",2),d([_()],Y.prototype,"_completeResult",2),d([_()],Y.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",Y)});function pn(s,r){if(r<=0)return 0;let e=typeof s=="number"&&Number.isFinite(s)?Math.trunc(s):0;return e<0?0:e%r}function un(s){return!!(s?.phases&&s.phase_sequence&&s.phase_sequence.length>0)}function Yt(s){if(!s||!un(s))return null;let r=s.phase_sequence,e=pn(s.phase_cursor,r.length),t=r[e],i=s.phases?.[t];return i?{id:t,name:i.name,index:e,count:r.length,notes:i.notes,checklist:i.checklist!==void 0?i.checklist:s.checklist??[],consumesParts:i.consumes_parts!==void 0?i.consumes_parts:s.consumes_parts??[],requiredFields:i.required_completion_fields!==void 0?i.required_completion_fields:s.required_completion_fields??[]}:null}function et(s){let r=Yt(s);return r?`${r.index+1}/${r.count} \xB7 ${r.name}`:""}var Gt=w(()=>{"use strict"});function jr(s){let r=s.task??null,e=r?Yt(r):null,t=e?e.consumesParts:r?.consumes_parts||[],i=!!r?.part_ref,a=s.objects.find(p=>p.entry_id===s.entryId)?.parts||[],o=i?a.find(p=>p.id===r.part_ref.part_id):void 0,c=s.checklistsEnabled??!0;return{entry_id:s.entryId,task_id:s.taskId,task_name:s.taskName,checklist:e?c?e.checklist:[]:s.checklist??[],adaptive_enabled:!!s.adaptiveEnabled,required_completion_fields:e?e.requiredFields:r?.required_completion_fields||[],task_type:r?.type||"",reading_unit:r?.reading_unit||"",readings:r?.readings||[],reading_history:sr(r?.history),parts:i?[]:vr({consumes_parts:t},s.entryId,s.objects,s.lang),consumes_parts:i?[]:t,phase_label:e?et(r):"",require_tag_scan:!!r?.require_tag_scan,restock_default:i?o?.restock_quantity??1:null,restock_unit_cost:i?o?.cost??null:null,currency_symbol:fe({currency_symbol:s.currencySymbol}),consumes_info:t.map(p=>fr(p,s.entryId,s.objects,s.lang)),checklist_prefill:r?.checklist_progress||{},via_tag_scan:!!s.viaTagScan}}function Hr(s,r,e){s.entryId=r.entry_id,s.taskId=r.task_id,s.taskName=r.task_name,s.lang=e,s.checklist=r.checklist??[],s.adaptiveEnabled=!!r.adaptive_enabled,s.requiredFields=r.required_completion_fields??[],s.taskType=r.task_type??"",s.readingUnit=r.reading_unit??"",s.readings=r.readings??[],s.readingHistory=r.reading_history??[],s.parts=r.parts??[],s.consumesParts=r.consumes_parts??[],s.phaseLabel=r.phase_label??"",s.requireTagScan=!!r.require_tag_scan,s.restockDefault=r.restock_default??null,s.restockUnitCost=r.restock_unit_cost??null,s.currencySymbol=fe(r),s.consumesInfo=r.consumes_info??[],s.checklistPrefill=r.checklist_prefill??{},s.viaTagScan=!!r.via_tag_scan,s.open({viaTagScan:!!r.via_tag_scan})}var Qt=w(()=>{"use strict";Te();ht();Gt();C()});function A(s){return s.toFixed(1)}var Jt=w(()=>{"use strict";C()});function Or(s,r){let e=s.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return h;let a=s.interval_days??0,o=s.suggested_interval??a;return l`
    <div class="weibull-section">
      ...
      ${_n(t,i,a,o,r)}
      ${gn(e,r)}
      ${e?.confidence_interval_low!=null?mn(e,s,r):h}
    </div>
  ...
  `}function _n(s,r,e,t,i){let y=Math.max(e,t,r,1)*1.3,k=50,T=[];for(let R=0;R<=k;R++){let O=R/k*y,ce=1-Math.exp(-Math.pow(O/r,s)),qe=32+O/y*260,Ne=136-ce*128;T.push([qe,Ne])}let z=T.map(([R,O])=>`${A(R)},${A(O)}`).join(" "),U="M32,136 "+T.map(([R,O])=>`L${A(R)},${A(O)}`).join(" ")+` L${A(T[k][0])},136 Z`,H=32+e/y*260,G=1-Math.exp(-Math.pow(e/r,s)),oe=136-G*128,b=q((1-G)*100,i,0),Q=32+t/y*260,xe=[0,.25,.5,.75,1];return l`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_weibull",i)}">
        ${xe.map(R=>{let O=136-R*128;return ke`
            <line x1="${32}" y1="${A(O)}" x2="${292}" y2="${A(O)}"
              stroke="var(--divider-color)" stroke-width="0.5" stroke-dasharray="${R===.5?"4,3":h}" />
            <text x="${28}" y="${A(O+3)}" fill="var(--secondary-text-color)"
              font-size="8" text-anchor="end">${q(R*100,i,0)}%</text>
          `})}
        ...
        ${t>0&&t!==e?ke`
          <line x1="${A(Q)}" y1="${8}" x2="${A(Q)}" y2="${A(136)}"
  ...
  `}function mn(s,r,e){let t=s.confidence_interval_low,i=s.confidence_interval_high,a=r.suggested_interval??r.interval_days??0,o=r.interval_days??0,c=Math.max(0,t-5),u=i+5-c,m=(t-c)/u*100,f=(i-t)/u*100,x=(a-c)/u*100,y=o>0?(o-c)/u*100:-1;return l`
    <div class="confidence-range">
      ...
      <div class="confidence-bar">
        ...
        ${y>=0?l`<div class="confidence-marker current" style="left:${A(y)}%"></div>`:h}
      ...
      <div class="prediction-grid">
        ${t?l`
          <div class="prediction-item">
            ...
            ${s.degradation_rate!=null?l`<span class="prediction-rate">${s.degradation_rate>0?"+":""}${q(s.degradation_rate,r,Math.abs(s.degradation_rate)>=10?0:1)} ${s.trigger_entity_info?.unit_of_measurement||""}/${n("day_short",r)}</span>`:h}
          </div>
        `:h}
        ${i?l`
          <div class="prediction-item">
        ...
        ${a&&e.environmental?l`
          <div class="prediction-item">
            ...
            ${s.environmental_entity?l`<span class="prediction-entity entity-link" @click=${c=>Xi(c,s.environmental_entity)}>${s.environmental_entity}</span>`:h}
          </div>
        `:h}
      </div>
    </div>
  `}var zr=w(()=>{"use strict";I();C()});function Fr(s,r,e,t){let i=Math.max(s||1,r);return l`
  ...
  `}var Ur=w(()=>{"use strict";I();C()});function Vr(s,r,e){if(!e.seasonal||!s.seasonal_factor||s.seasonal_factor===1)return h;let t=Br.map(c=>n(c,r)),i=new Date().getMonth(),a=s.seasonal_factors||s.interval_analysis?.seasonal_factors||null,o=a&&a.length===12?a:t.map((c,p)=>{let u=s.seasonal_factor||1,m=Math.sin((p-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,u+m))});return l`
    <div class="seasonal-card-compact">
      <h4>${n("seasonal_awareness",r)}</h4>
      <div class="seasonal-mini-chart">
        ${o.map((c,p)=>{let u=c*40,m=c<.9?"low":c>1.1?"high":"normal";return l`
  ...
  `}function Wr(s,r){return fn(s,r)}function fn(s,r){let e=s.seasonal_factors??s.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return h;let t=s.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,o=100,c=8,u=o-c-4,m=Math.max(...e,1.5),f=a/12,x=f*.65,y=c+u-1/m*u;return l`
  ...
  `}var Br,Kr=w(()=>{"use strict";I();C();Jt();Br=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var L,Yr=w(()=>{"use strict";I();F();C();ye();Rt();Qt();Gt();pt();Te();Kt();Dr();zr();Ur();Ie();Kr();L=class extends S{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return D(this.hass)}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=ge(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._currencySymbol=fe(e?.budget),dt(e?.budget),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(i=>i.id===this._taskId);this._task=t??null}catch(e){this._error=N(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=N(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(Z(),se)).then(async({openCompleteDialog:e})=>{let t=this._task,i=[];try{i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}e(jr({entryId:this._entryId,taskId:this._taskId,taskName:t.name,task:t,objects:i,lang:this._lang,checklist:t.checklist||[],adaptiveEnabled:!!t.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(Z(),se)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(Z(),se)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=n("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=n("suggestion_applied",this._lang),this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${n("reanalyze_result",this._lang)}: ${Ke(e.recommended_interval,"days",this._lang)} (${e.data_points} pts)`:n("reanalyze_insufficient_data",this._lang),await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=N(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){!this._entryId||!this._taskId||Promise.resolve().then(()=>(Z(),se)).then(({openHistoryEditDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null,used_parts:e.used_parts??null,photo_doc_ids:Je(e),reading_value:e.reading_value??null,reading_values:ie(e),readings:this._task?.readings??[],task_type:this._task?.type??null,reading_unit:this._task?.reading_unit??null})})}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return h;let t=this._lang;return l`
    ...
    `}_renderAdaptive(e){let t=this._lang,i=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,a=e.degradation_trend!=null&&e.degradation_trend!=="insufficient_data"||e.days_until_threshold!=null||e.environmental_factor!=null&&e.environmental_factor!==1,o=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,c=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1;return!i&&!a&&!o&&!c?l`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${a?Mr(e,t,this._features):h}
        ${o?Or(e,t):h}
        ${c?l`
          ${Vr(e,t,this._features)}
          ${e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12?Wr(e,t):h}
        `:h}
      </div>
    `}_renderHistoryReadings(e,t,i){let a=ie(e),o=c=>q(c,i,{maximumFractionDigits:3});if(a.length>0)return l`<div class="history-readings">
        ${a.map(c=>{let p=ar(t,e,c.id);return l`<span class="history-reading"><span class="history-reading-name">${c.name}</span>
            <span class="history-reading-value">${o(c.value)}${c.unit?` ${c.unit}`:""}${p==null?"":` (${p>=0?"+":""}${o(p)})`}</span></span>`})}
      </div>`;if(e.reading_value!=null){let c=this._task?.reading_unit?` ${this._task.reading_unit}`:"";return l`<div class="history-readings"><span class="history-reading">
        <span class="history-reading-name">${n("reading_label",i)}</span>
        <span class="history-reading-value">${o(e.reading_value)}${c}</span></span></div>`}return h}_renderDetails(e){let t=this._lang,i=e.history||[],a=i.filter(p=>p.type==="completed"),o=a.reduce((p,u)=>p+(typeof u.cost=="number"?u.cost:0),0),c=(()=>{let p=a.map(u=>typeof u.duration=="number"?u.duration:null).filter(u=>u!=null);return p.length?Math.round(p.reduce((u,m)=>u+m,0)/p.length):null})();return l`
      <div class="details">
        <div class="stats-grid">
          ...
          <div class="stat">
            ...
            <span class="stat-value">${ve(o,this._currencySymbol,t)}</span>
          </div>
          <div class="stat">
        ...
        ${i.length===0?l`<div class="history-empty">${n("history_empty",t)}</div>`:l`
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(p=>{let u=["completed","reset","skipped"].includes(p.type);return l`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${p.type}">${n(p.type,t)}</span>
                        <span class="history-date">${Yi(p.timestamp,t)}</span>
                      ...
                      ${p.notes?l`<div class="history-notes">${p.notes}</div>`:h}
                      ${this._renderHistoryReadings(p,i,t)}
                      ${(()=>{let m=Je(p);return m.length?l`<div class="history-photos">
                      ...
                      ${p.cost!=null||p.duration!=null?l`<div class="history-meta">
                            ${p.cost!=null?l`<span>💰 ${ve(p.cost,this._currencySymbol,t)}</span>`:h}
                            ${p.duration!=null?l`<span>⏱️ ${p.duration}m</span>`:h}
                          </div>`:h}
                    </div>
                  `})}
        ...
        ${t?l`
              <div class="header">
                ...
                <div class="quick-info">
                  ...
                  ${t.schedule?.kind&&!["manual","one_time"].includes(t.schedule.kind)||t.interval_days!=null?l`<span><strong>${n("interval",e)}:</strong> ${Zi(t,e)}</span>`:h}
                  ${et(t)?l`<span><strong>${n("phase_current",e)}:</strong> ${et(t)}</span>`:h}
                </div>
              </div>
        ...
        ${t&&i?l`
                      ...
                      <div class="task-list">
                        ${a.map(c=>l`
                          <div class="task-row" @click=${()=>this._onTaskClick(c.id)}>
                            <span class="status-dot" style="background: ${Ve[c.status]||"#ccc"}"></span>
              ...
              ${i.notes?l`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${Jr(i.notes)}</div>
                    </div>
                  `:h}
      ...
      <div class="meta">
        ${i.map(([a,o])=>l`
            <div class="meta-item">
              ...
              <span class="meta-value">${Gr(o)?l`<a href="${o}" target="_blank" rel="noopener noreferrer">${o}</a>`:o}</span>
            </div>
          `)}
      </div>
    `}};X.styles=E`
  ...
  `,d([v({attribute:!1})],X.prototype,"hass",2),d([_()],X.prototype,"_open",2),d([_()],X.prototype,"_entryId",2),d([_()],X.prototype,"_data",2),d([_()],X.prototype,"_busy",2),d([_()],X.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",X)});function es(){let s=window;return s.__msSettingsCache??={promise:null}}function ft(s){let r=es();if(r.promise)return r.promise;let e=s.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(t=>({features:t.features??Zt.features,defaultWarningDays:t.general?.default_warning_days??7,rowActionStyle:t.general?.row_action_style??Zt.rowActionStyle})).catch(()=>(r.promise===e&&(r.promise=null),Zt));return r.promise=e,e}function ts(){es().promise=null}var Zt,is=w(()=>{"use strict";Zt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"}});var se={};ls(se,{__resetSettingsCacheForTests:()=>En,getRowActionStyle:()=>kn,openCompleteDialog:()=>In,openCreateObjectDialog:()=>Sn,openCreateTaskDialog:()=>Tn,openEditObjectDialog:()=>An,openEditTaskDialog:()=>Cn,openHistoryEditDialog:()=>Xt,openObjectQuickActions:()=>Ln,openQrDialog:()=>Pn,openTaskQuickActions:()=>ei});function vt(){return document.querySelector("home-assistant")?.hass}function $n(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function ne(s){let r=$n(),e=r.querySelector(s)??document.body.querySelector(s);return e?e.parentNode!==r&&r.appendChild(e):(e=document.createElement(s),r.appendChild(e)),e}function ae(s){let r=vt();if(!r)return!1;s.hass=r;let e=D(r);return Ge(e)||Qe(e).then(()=>{s.requestUpdate?.()}),Nt(r.locale,r.config?.country),!0}function kn(s){return ft(s).then(r=>r.rowActionStyle)}function En(){ts()}function Sn(){let s=ne(rs);return ae(s)?(s.openCreate(),!0):!1}function An(s,r){let e=ne(rs);return ae(e)?(e.openEdit(s,r),!0):!1}function Tn(s="",r){let e=ne(ss);if(!ae(e))return!1;let t=vt();return t?((async()=>{let i=await ft(t),a=e;a.checklistsEnabled=i.features.checklists,a.scheduleTimeEnabled=i.features.schedule_time,a.completionActionsEnabled=i.features.completion_actions,a.defaultWarningDays=i.defaultWarningDays,a.openCreate(s,r)})(),!0):!1}function Cn(s,r){let e=ne(ss);if(!ae(e))return!1;let t=vt();return t?((async()=>{try{let[i,a]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:s}),ft(t)]),o=(i.tasks||[]).find(p=>p.id===r);if(!o){console.warn(`openEditTaskDialog: task ${r} not found in entry ${s}`);return}let c=e;c.checklistsEnabled=a.features.checklists,c.scheduleTimeEnabled=a.features.schedule_time,c.completionActionsEnabled=a.features.completion_actions,c.defaultWarningDays=a.defaultWarningDays,await c.openEdit(s,o)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function Xt(s){let r=ne(vn);return ae(r)?(r.openEdit(s),!0):!1}function In(s){let r=ne(yn);return ae(r)?(Hr(r,s,D(vt())),!0):!1}function Pn(s){let r=ne(bn);return ae(r)?(r.openForTask(s.entry_id,s.task_id,s.object_name,s.task_name),!0):!1}function ei(s,r){let e=ne(xn);return ae(e)?(e.openFor(s,r),!0):!1}function Ln(s){let r=ne(wn);return ae(r)?(r.openFor(s),!0):!1}var rs,ss,vn,yn,bn,xn,wn,Z=w(()=>{"use strict";pr();kr();Cr();Rr();Nr();Yr();Xr();C();Qt();is();rs="maintenance-object-dialog",ss="maintenance-task-dialog",vn="maintenance-history-edit-dialog",yn="maintenance-complete-dialog",bn="maintenance-qr-dialog",xn="maintenance-task-quick-actions-dialog",wn="maintenance-object-quick-actions-dialog"});I();F();Rt();I();var Ni=E`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;C();function tr(s){let r=window;r.customCards=r.customCards||[],r.customCards.some(e=>e.type===s.type)||r.customCards.push(s)}pt();Te();Z();var W=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){if(this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter),typeof e.object_filter=="string")this._objectFilter=e.object_filter,this._configuredObjects=[];else if(Array.isArray(e.object_filter)){let t=e.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=t.length===1?t[0]:"",this._configuredObjects=t.length>1?t:[]}}getCardSize(){return 6}get _lang(){return D(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){if(super.updated(e),Fi(this,e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t,dt(this._stats.budget)}catch{}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}_onEventClick(e){if(e.history_timestamp){this._openHistoryEntry(e);return}ei(e.entry_id,e.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(e){try{let i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:e.entry_id})).tasks?.find(c=>c.id===e.task_id),a=i?.history?.find(c=>c.timestamp===e.history_timestamp);if(!a||Xt({entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp,type:a.type||"completed",timestamp:a.timestamp||e.history_timestamp,notes:a.notes??null,cost:a.cost??null,duration:a.duration??null,completed_by:a.completed_by??null,used_parts:a.used_parts??null,photo_doc_ids:Je(a),reading_value:a.reading_value??null,reading_values:ie(a),readings:i?.readings??[],task_type:i?.type??null,reading_unit:i?.reading_unit??null}))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return h;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,o=null;this._userFilter&&(o=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let c=b=>{let Q=b.toLowerCase();return this._objects.find(R=>R.entry_id===b||R.object.name.toLowerCase()===Q)?.entry_id??null},p=new Set(this._configuredObjects.map(c).filter(b=>b!==null)),u=p.size?this._objects.filter(b=>p.has(b.entry_id)):this._objects,m=this._config.show_object_filter!==!1&&u.length>1,f=this._objectFilter?c(this._objectFilter):null,x=f&&u.some(b=>b.entry_id===f)?u.filter(b=>b.entry_id===f):u,y=new Date;y.setHours(0,0,0,0);let k=this._pastDays>0,T=k?qi(x,y,this._pastDays,o):Ri(x,y,this._windowDays,o),z=ge(y),U=this._windowDays===365||k,H=U?T.filter(b=>b.events.length>0):T,G=b=>{let Q=`cal-status-${b.status}`,xe=b.projected?"cal-event-projected":"",R=b.status==="overdue"&&b.days_until_due!=null?` (${Gi(b.days_until_due,e)})`:"",O=b.projected&&b.interval_days?l`<span class="cal-event-recur">${b.interval_unit&&b.interval_unit!=="days"?`${b.interval_days} ${n("unit_"+b.interval_unit,e)}`:n("cal_every_n_days",e).replace("{n}",String(b.interval_days))}</span>`:h,ce=b.schedule_type==="sensor_based",qe=ce?l`<ha-icon class="cal-event-icon cal-source-sensor"
                ...
                icon="${b.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,Ne=ce&&b.prediction_confidence&&b.status!=="triggered"&&!b.projected?l`<span class="cal-event-prediction cal-conf-${b.prediction_confidence}">
            ${n("cal_predicted",e)} · ${n(`cal_confidence_${b.prediction_confidence}`,e)}
          </span>`:h,ns=fe(this._stats?.budget),as=b.history_type?n(b.history_type,e):n(b.status,e);return l`
        <div class="cal-event ${xe}"
          @click=${()=>this._onEventClick(b)}>
          ${qe}
          <span class="cal-status-pill ${Q}">${as}</span>
          <div class="cal-event-body">
            <div class="cal-event-title">${b.object_name} · ${b.task_name}${R}</div>
            ${Ne}
            ${O}
          </div>
          ${b.avg_cost!=null&&b.avg_cost>0?l`<span class="cal-event-cost">${ve(b.avg_cost,ns,e)}</span>`:h}
        </div>
      `},oe=b=>{let[Q,xe,R]=b.date.split("-").map(Number),O=new Date(Q,xe-1,R),ce=b.date===z,qe=Qi(O,e,"short"),Ne=Ji(O,e,"long");return l`
        <div class="cal-day-row">
          <div class="cal-day-pill ${ce?"cal-today":""}">
            <span class="cal-pill-weekday">${qe}</span>
            <span class="cal-pill-day">${O.getDate()}</span>
          </div>
          <div class="cal-day-content">
            <div class="cal-day-header">
              <span class="cal-day-month">${Ne}</span>
              ${ce?l`<span class="cal-day-today-badge">${n("today",e)}</span>`:h}
            </div>
              ...
              <div class="cal-controls">
                ...
                ${m?l`
                      <select class="cal-user-filter"
                        ...
                        ${[...u].sort((b,Q)=>b.object.name.localeCompare(Q.object.name)).map(b=>l`<option value=${b.entry_id} ?selected=${b.entry_id===f}>${b.object.name}</option>`)}
                      </select>
                    `:h}
              </div>
            `:h}
        <div class="cal-rolling">
          ${H.length===0&&U?l`<div class="cal-empty">${n("cal_no_events",e)}</div>`:H.map(oe)}
        </div>
      </ha-card>
    `}};W.styles=[ct,Ni,E`
      :host { display: block; }
      ha-card { padding: 0; overflow: hidden; }
    `],d([v({attribute:!1})],W.prototype,"hass",2),d([_()],W.prototype,"_config",2),d([_()],W.prototype,"_objects",2),d([_()],W.prototype,"_stats",2),d([_()],W.prototype,"_windowDays",2),d([_()],W.prototype,"_pastDays",2),d([_()],W.prototype,"_userFilter",2),d([_()],W.prototype,"_objectFilter",2),d([_()],W.prototype,"_unsub",2);var Rn=[{value:7,key:"cal_editor_window_week"},{value:14,key:"cal_editor_window_fortnight"},{value:30,key:"cal_editor_window_month"},{value:365,key:"cal_editor_window_year"}],Re=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}get _lang(){return D(this.hass)}setConfig(e){this._config={...e}}updated(){let e=this._lang;e&&!Ge(e)&&Qe(e).then(()=>this.requestUpdate())}_valueChanged(e,t){let i={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete i.show_window_chips,e==="show_user_filter"&&t===!0&&delete i.show_user_filter,e==="show_object_filter"&&t===!0&&delete i.show_object_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete i.title,e==="user_filter"&&t===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let e=this._lang,t=this._config.window_days??30,i=this._config.show_window_chips!==!1,a=this._config.show_user_filter!==!1,o=this._config.user_filter??"",c=this._config.title??"";return l`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${Rn.map(p=>l`<option value="${p.value}" ?selected=${p.value===t}>${n(p.key,e)}</option>`)}
          </select>
        </div>
  ...
  `,d([v({attribute:!1})],Re.prototype,"hass",2),d([_()],Re.prototype,"_config",2);customElements.get("maintenance-supporter-calendar-card")||customElements.define("maintenance-supporter-calendar-card",W);customElements.get("maintenance-supporter-calendar-card-editor")||customElements.define("maintenance-supporter-calendar-card-editor",Re);tr({type:"maintenance-supporter-calendar-card",name:"Maintenance Supporter \u2014 Calendar",description:"Rolling calendar of maintenance tasks with 7/14/30/365 day windows, source icons, and prediction-confidence pills.",preview:!0});export{W as MaintenanceCalendarCard};
