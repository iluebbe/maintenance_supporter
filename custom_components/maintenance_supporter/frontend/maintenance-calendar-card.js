...
`});function bt(s){if(!s)return[];let r=[],e=s.photo_doc_id;typeof e=="string"&&r.push(e);let t=s.photo_doc_ids;Array.isArray(t)&&r.push(...t);let i=[];for(let a of r){if(typeof a!="string")continue;let o=a.trim();if(!(!o||i.includes(o))&&(i.push(o),i.length>=10))break}return i}var xt=y(()=>{"use strict"});function Cr(){let s=new Uint8Array(4);return(globalThis.crypto??{getRandomValues:r=>r.map(()=>Math.floor(Math.random()*256))}).getRandomValues(s),Array.from(s,r=>r.toString(16).padStart(2,"0")).join("")}function pe(s){let r=s?.reading_values;if(!Array.isArray(r))return[];let e=[],t=new Set;for(let i of r){if(!i||typeof i!="object")continue;let a=i;typeof a.id!="string"||!a.id||t.has(a.id)||typeof a.value!="number"||!Number.isFinite(a.value)||(t.add(a.id),e.push({id:a.id,name:typeof a.name=="string"?a.name:a.id,unit:typeof a.unit=="string"?a.unit:null,value:a.value}))}return e}function Ir(s){return s.filter(r=>r.type==="completed"&&(r.reading_value!=null||pe(r).length>0)).sort((r,e)=>r.timestamp.localeCompare(e.timestamp))}function Rr(s){return Ir(s??[]).map(r=>({timestamp:r.timestamp,values:pe(r)})).filter(r=>r.values.length>0)}function Pr(s,r,e){let t;for(let i of s){if(e!==void 0){let o=new Date(i.timestamp).getTime();if(!isNaN(o)&&o>=e)break}let a=i.values.find(o=>o.id===r);a&&(t=a)}return t}function Lr(s,r,e){let t=pe(r).find(a=>a.id===e);if(!t)return null;let i=null;for(let a of Ir(s)){if(a.timestamp>=r.timestamp)break;let o=pe(a).find(h=>h.id===e);o&&(i=o.value)}return i==null?null:t.value-i}function Nr(s){let r=new Set,e=new Set;for(let t of s){let i=(t.name||"").trim().toLowerCase();i&&(r.has(i)?e.add(t.id):r.add(i))}return e}function Hr(s){let r=[],e=new Set,t=new Set;for(let i of s){let a=(i.name||"").trim();if(!(!a||e.has(i.id)||t.has(a.toLowerCase()))&&(e.add(i.id),t.add(a.toLowerCase()),r.push({id:i.id,name:a,unit:(i.unit||"").trim()||null}),r.length>=20))break}return r}var $e=y(()=>{"use strict"});function ii(s,r,e,t){let i=e,a=d=>typeof d=="string"?d:null,o=d=>typeof d=="number"?d:null,h=a(i.timestamp)??"";return{entry_id:s,task_id:r,original_timestamp:h,type:a(i.type)||"completed",timestamp:h,notes:a(i.notes),cost:o(i.cost),duration:o(i.duration),completed_by:a(i.completed_by),used_parts:Array.isArray(i.used_parts)?i.used_parts:null,photo_doc_ids:bt(i),reading_value:o(i.reading_value),reading_values:pe(i),readings:t?.readings??[],task_type:t?.type??null,reading_unit:t?.reading_unit??null}}async function qr(s,r,e,t){let a=(await s.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:r})).tasks?.find(h=>h.id===e),o=a?.history?.find(h=>h.timestamp===t);return!a||!o?null:ii(r,e,o,a)}var ri=y(()=>{"use strict";xt();$e()});function Ln(s){let r=s.replace(/_ids?$/,"").split("_").filter(Boolean);if(r.length===0)return s;let e=r.join(" ");return e.charAt(0).toUpperCase()+e.slice(1)}function Nn(s,r){let e=Pn[s];if(e){let t=n(e,r);if(t&&t!==e)return t}return Ln(s)}function Hn(s){let r=[...s.matchAll(/\['([^']+)'\]/g)].map(i=>i[1]),e=r.length?r[r.length-1]:void 0,t;return(t=s.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=s.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=s.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=s.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(s)?{field:e,rule:"required"}:(t=s.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(s)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(s)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function qn(s,r){let e=new Set(jr(r));return jr(s).every(t=>e.has(t))}function q(s,r,e){if(e=e??n("action_error",r),typeof s=="string")return s;if(typeof s!="object"||s===null)return e;let t=s,i=t.message||t.error?.message||"",a=t.code||t.error?.code||"",o=a?Rn[a]:void 0;if(!i&&!o)return e;let h=Hn(i),d=h.field?Nn(h.field,r):"",p=m=>n(m,r).replace("{field}",d).replace("{n}",h.param??"");switch(h.rule){case"too_long":return p("err_too_long");case"too_short":return p("err_too_short");case"value_too_high":return p("err_value_too_high");case"value_too_low":return p("err_value_too_low");case"required":return p("err_required");case"wrong_type":return p("err_wrong_type").replace("{type}",h.param??"");case"invalid_choice":return p("err_invalid_choice");case"invalid_value":return p("err_invalid_value");default:if(o){let m=n(o,r);return i&&!qn(i,a)?`${m} (${i})`:m}return i||e}}var Rn,Pn,jr,ue=y(()=>{"use strict";A();Rn={already_archived:"ws_err_already_archived",already_paused:"ws_err_already_paused",archived:"ws_err_archived",create_failed:"ws_err_create_failed",duplicate_failed:"ws_err_duplicate_failed",empty:"ws_err_empty",empty_csv:"ws_err_empty_csv",invalid_cursor:"ws_err_invalid_cursor",invalid_date:"ws_err_invalid_date",invalid_device:"ws_err_invalid_device",invalid_entity_slug:"ws_err_invalid_entity_slug",invalid_format:"ws_err_invalid_format",invalid_input:"ws_err_invalid_input",invalid_mirror_todo:"ws_err_invalid_mirror_todo",invalid_parent:"ws_err_invalid_parent",invalid_icon:"ws_err_invalid_icon",invalid_range:"ws_err_invalid_range",invalid_search_template:"ws_err_invalid_search_template",invalid_target:"ws_err_invalid_target",invalid_trigger_config:"ws_err_invalid_trigger_config",invalid_url:"ws_err_invalid_url",invalid_user:"ws_err_invalid_user",invalid_view:"ws_err_invalid_view",limit_reached:"ws_err_limit_reached",no_defaults:"ws_err_no_defaults",no_phases:"ws_err_no_phases",no_url:"ws_err_no_url",not_archived:"ws_err_not_archived",not_available:"ws_err_not_available",not_configured:"ws_err_not_configured",not_found:"ws_err_not_found",not_loaded:"ws_err_not_loaded",not_paused:"ws_err_not_paused",replace_failed:"ws_err_replace_failed",self_link_device:"ws_err_self_link_device",storage_unavailable:"ws_err_storage_unavailable",too_early:"ws_err_too_early",too_large:"ws_err_too_large",too_many:"ws_err_too_many",too_many_views:"ws_err_too_many_views",unauthorized:"ws_err_unauthorized",unavailable:"ws_err_unavailable"},Pn={entry_id:"object",name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",warranty_expiry:"warranty_expiry_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_equals:"trigger_equals",trigger_not_equals:"trigger_not_equals",trigger_for_minutes:"trigger_for_minutes"};jr=s=>s.toLowerCase().split(/[^a-z0-9]+/).filter(r=>r.length>1)});var O,si=y(()=>{"use strict";C();U();O=class extends S{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return l`
      <label class="field">
  ...
  `,c([v()],O.prototype,"label",2),c([v()],O.prototype,"value",2),c([v()],O.prototype,"placeholder",2),c([v()],O.prototype,"type",2),c([v({type:Boolean})],O.prototype,"required",2),c([v({type:Boolean})],O.prototype,"disabled",2),c([v()],O.prototype,"step",2),c([v()],O.prototype,"min",2),c([v()],O.prototype,"max",2),c([v()],O.prototype,"pattern",2),c([v()],O.prototype,"helper",2),c([v({type:Boolean})],O.prototype,"multiline",2),c([v({type:Number})],O.prototype,"rows",2);customElements.get("ms-textfield")||customElements.define("ms-textfield",O)});function jn(s){let e=K("2001-02-03",s).match(/\d+/g)||[],t=h=>e.findIndex(d=>Number(d)===h),i=t(2001),a=t(2),o=t(3);return i===0?"YMD":a>=0&&o>=0&&a<o?"MDY":"DMY"}function Le(s,r,e){if(s<1e3||s>9999||r<1||r>12||e<1||e>31)return null;let t=new Date(s,r-1,e);return t.getFullYear()!==s||t.getMonth()!==r-1||t.getDate()!==e?null:`${s}-${String(r).padStart(2,"0")}-${String(e).padStart(2,"0")}`}function Or(s,r){let e=s.trim(),t;if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})$/))return Le(+t[1],+t[2],+t[3]);if(t=e.match(/^(\d{4})$/))return Le(+t[1],1,1);if(t=e.match(/^(\d{1,2})[./](\d{4})$/))return Le(+t[2],+t[1],1);if(t=e.match(/^(\d{1,2})\.(\d{1,2})\.(\d{4})$/))return Le(+t[3],+t[2],+t[1]);if(t=e.match(/^(\d{1,2})[/-](\d{1,2})[/-](\d{4})$/)){let i=+t[1],a=+t[2],o=+t[3];return jn(r)==="MDY"?Le(o,i,a):Le(o,a,i)}return null}var Dr=y(()=>{"use strict";A()});function On(s,r){if(r)switch(s){case"date":return r.split("T")[0];case"time":return r.length===5?`${r}:00`:r;case"datetime":{let[e,t="00:00:00"]=r.split("T");return`${e} ${t.length===5?`${t}:00`:t}`}}}function Dn(s,r){if(typeof r!="string"||!r)return"";switch(s){case"date":return r.slice(0,10);case"time":return r.slice(0,5);case"datetime":{let[e,t="00:00:00"]=r.split(" ");return`${e}T${t.length===5?`${t}:00`:t}`}}}var z,Ne=y(()=>{"use strict";C();U();A();Dr();z=class extends S{constructor(){super(...arguments);this.kind="date";this.label="";this.value="";this.clearable=!1;this.disabled=!1;this.required=!1;this.lang="en";this._typing=!1;this._typed="";this._typedInvalid=!1}_startTyping(){this._typed=this.value,this._typedInvalid=!1,this._typing=!0,this.updateComplete.then(()=>this.shadowRoot?.querySelector("input.typed")?.focus())}_commitTyped(){if(!this._typed.trim()){this._typing=!1;return}let e=Or(this._typed,this.lang);if(!e){this._typedInvalid=!0;return}this._typing=!1,this._typedInvalid=!1,this._emit(e)}_onTypedKey(e){e.key==="Enter"?(e.preventDefault(),this._commitTyped()):e.key==="Escape"&&(e.preventDefault(),this._typing=!1,this._typedInvalid=!1)}_selector(){switch(this.kind){case"date":return{date:{}};case"time":return{time:{no_second:!0}};case"datetime":return{datetime:{}}}}_onSelectorChange(e){e.stopPropagation(),this._emit(Dn(this.kind,e.detail?.value))}_clear(){this._emit("")}_emit(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{bubbles:!0,composed:!0,detail:{value:e}})))}render(){return l`
      <div class="field">
        ${this.label?l`<span class="label">${this.label}${this.required?l`<span class="req">*</span>`:_}</span>`:_}
        <div class="row">
          ${this._typing?l`<input class="typed" type="text" inputmode="numeric" autocomplete="off"
                .value=${this._typed}
                placeholder=${K("1978-03-15",this.lang)}
        ...
        ${this._typedInvalid?l`<span class="helper invalid">${n("date_type_invalid",this.lang)}</span>`:this.helper?l`<span class="helper">${this.helper}</span>`:_}
      </div>
    `}};z.styles=E`
    :host { display: block; }
    .field {
...
`),partId:D?.part_id||"",partQty:D?.quantity!=null?String(D.quantity):"",reqOverride:m.required_completion_fields!==void 0,reqFields:[...m.required_completion_fields||[]],extraParts:I.filter((B,le)=>le!==F).map(B=>({...B})),carry:H}}),this._phaseSeq=[...t.phase_sequence||[]],this._requiredCompletion=[...t.required_completion_fields||[]],this._scheduleTime=t.schedule_time||"",this._scheduleTimeOn=!!t.schedule_time;let o=t.on_complete_action;if(o&&o.service){this._actionService=o.service;let p=o.target?.entity_id;this._actionTargetEntity=Array.isArray(p)?p[0]||"":p||"",this._actionData=o.data&&typeof o.data=="object"?{...o.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let h=t.quick_complete_defaults;this._qcNotes=h?.notes||"",this._qcCost=h?.cost!=null?String(h.cost):"",this._qcDuration=h?.duration!=null?String(h.duration):"",this._qcFeedback=h?.feedback||"";let d=t.adaptive_config||{};if(this._environmentalEntity=d.environmental_entity||"",this._environmentalAttribute=d.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,this._adaptiveEnabled=!!d.enabled,this._adaptiveAlpha=d.ewa_alpha?.toString()??se.alpha,this._adaptiveMin=d.min_interval_days?.toString()??se.min,this._adaptiveMax=d.max_interval_days?.toString()??se.max,this._adaptiveSeasonal=d.seasonal_enabled!==!1,this._adaptivePrediction=d.sensor_prediction_enabled!==!1,this._adaptiveInitial=this._adaptiveSnapshot(),t.trigger_config){let p=t.trigger_config;this._triggerEntityId=p.entity_id||p.entity_ids&&p.entity_ids[0]||"",this._triggerEntityIds=p.entity_ids||(p.entity_id?[p.entity_id]:[]),this._triggerEntityLogic=p.entity_logic||"any",this._triggerAttribute=p.attribute||"",this._triggerType=p.type||"threshold",this._triggerAbove=p.trigger_above?.toString()||"",this._triggerBelow=p.trigger_below?.toString()||"",this._triggerEquals=p.trigger_equals?.toString()||"",this._triggerNotEquals=p.trigger_not_equals?.toString()||"",this._triggerForMinutes=p.trigger_for_minutes?.toString()||"0",this._triggerCombinator=p.trigger_combinator==="all"?"all":"any",this._triggerTargetValue=p.trigger_target_value?.toString()||"",this._triggerDeltaMode=p.trigger_delta_mode||!1,this._triggerBaselineValue=p.trigger_baseline_value?.toString()||"",this._liveBaselineValue=t.trigger_baseline_value??null,this._autoCompleteOnRecovery=p.auto_complete_on_recovery||!1,this._triggerFromState=p.trigger_from_state||"",this._triggerToState=p.trigger_to_state||"",this._triggerTargetChanges=p.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=p.trigger_runtime_hours?.toString()||"",this._triggerRuntimeMaxSession=p.trigger_runtime_max_session_seconds?.toString()||"",this._triggerOnStates=(p.trigger_on_states||[]).join(", "),p.type==="compound"?(this._compoundLogic=p.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(p.conditions||[]).map(Jn)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._notifyIcon="",this._priority="normal",this._labels="",this._mirrorTodoEntities=[],this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._requireTagScan=!1,this._allowSkip=!0,this._readingUnit="",this._readings=[],this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._phaseDefs=[],this._phaseSeq=[],this._requiredCompletion=[],this._scheduleTime="",this._scheduleTimeOn=!1,this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._adaptiveEnabled=!1,this._adaptiveAlpha=se.alpha,this._adaptiveMin=se.min,this._adaptiveMax=se.max,this._adaptiveSeasonal=!0,this._adaptivePrediction=!0,this._adaptiveInitial=this._adaptiveSnapshot(),this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerEquals="",this._triggerNotEquals="",this._triggerForMinutes="0",this._triggerCombinator="any",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerRuntimeMaxSession="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new wt(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}_toggleAssignee(e){this._assigneePool=this._assigneePool.includes(e)?this._assigneePool.filter(t=>t!==e):[...this._assigneePool,e]}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[t,i]=e.split(".");if(!this.hass?.services?.[t]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let a=this._actionTargetEntity.trim();if(a){let o=a.split(".")[0];if(o!==t&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(t)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${t}.* entities; entity "${a}" is in ${o}.* \u2014 pick a service that matches the entity domain (e.g. ${o}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[a]){this._actionTestResult="error",this._actionTestError=`Target entity "${a}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,i]=e.split("."),a=this.hass?.services?.[t]?.[i]?.fields;return!a||Object.keys(a).length===0?null:Object.entries(a).map(([o,h])=>({name:o,required:!!h.required,selector:h.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return _;let t=this._serviceSchema();return l`
      <details class="ca-section">
        ...
        <div class="ca-test-row">
          ...
          ${this._actionTestResult==="ok"?l`<span class="ca-test-ok">${n("on_complete_action_test_success",e)}</span>`:_}
    ...
    `}async _loadParts(){if(this.parts=[],!!this._entryId)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this.parts=e.parts||[],this._partsLoadFailed=!1}catch{this.parts=[],this._partsLoadFailed=!0}}async _loadForeignPools(){if(this._foreignOwners=[],!!this._entryId)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"});this._foreignOwners=(e.objects||[]).filter(t=>t.entry_id!==this._entryId&&(t.parts||[]).length>0).map(t=>({entry_id:t.entry_id,name:t.object?.name||t.entry_id,parts:t.parts||[]})).sort((t,i)=>t.name.localeCompare(i.name))}catch{this._foreignOwners=[]}}async _loadTags(){try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/tags/list"});this._availableTags=e.tags||[]}catch{this._availableTags=[]}}_fetchConditionAttributes(e){!e||!this.hass||this._conditionAttrOptions[e]||this._conditionAttrPending.has(e)||(this._conditionAttrPending.add(e),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/entity/attributes",entity_id:e}).then(t=>{let i=t;this._conditionAttrOptions={...this._conditionAttrOptions,[e]:{suggested:i.suggested_attributes||[],available:i.available_attributes||[]}}}).catch(()=>{this._conditionAttrOptions={...this._conditionAttrOptions,[e]:{suggested:[],available:[]}}}))}async _fetchEntityAttributes(e){if(!e||!this.hass){this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="";return}try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/entity/attributes",entity_id:e});this._entityDomain=t.domain||"",this._suggestedAttributes=t.suggested_attributes||[],this._availableAttributes=t.available_attributes||[]}catch{this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain=""}}get _hasForeignPick(){return Object.values(this._consumesParts).some(e=>!!e.entry_id)}_renderConsumesRow(e,t){let i=X({part_id:e.id,entry_id:t}),a=this._consumesParts[i],o=t?{part_id:e.id,quantity:1,entry_id:t}:{part_id:e.id,quantity:1};return l`
      <div class="consumes-row">
        ...
        ${a!==void 0?l`<input
              ...
              @input=${h=>{let d=parseFloat(h.target.value);this._consumesParts={...this._consumesParts,[i]:{...o,quantity:Number.isFinite(d)&&d>=.01?d:1}}}}
            />`:_}
      </div>
    `}_toggleRequired(e,t){let i=new Set(this._requiredCompletion);t?i.add(e):i.delete(e),this._requiredCompletion=[...i]}_patchReading(e,t){this._readings=this._readings.map(i=>i.id===e?{...i,...t}:i)}_renderReadingsEditor(e){let t=Nr(this._readings);return l`
      <div class="readings-editor">
        ...
        ${this._readings.map(i=>l`
          ${t.has(i.id)?l`<div class="field-help reading-dup">${n("reading_duplicate_name",e)}</div>`:_}
        ...
        ${this._readings.length<20?l`
          <ha-button appearance="plain" class="reading-add"
            @click=${()=>this._readings=[...this._readings,{id:Cr(),name:"",unit:this._readings.length?this._readings[this._readings.length-1].unit:this._readingUnit}]}>
    ...
    `}_phaseSlug(e){let t=e.toLowerCase().replace(/[^a-z0-9_-]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24)||"phase",i=t,a=2;for(;this._phaseDefs.some(o=>o.id===i);)i=`${t}-${a++}`;return i}_addPhaseDef(){let e=this._phaseSlug(`phase-${this._phaseDefs.length+1}`);this._phaseDefs=[...this._phaseDefs,{id:e,name:"",checklistText:"",partId:"",partQty:"",reqOverride:!1,reqFields:[],extraParts:[],carry:{}}]}_removePhaseDef(e){this._phaseDefs=this._phaseDefs.filter(t=>t.id!==e),this._phaseSeq=this._phaseSeq.filter(t=>t!==e)}_patchPhaseDef(e,t){this._phaseDefs=this._phaseDefs.map(i=>i.id===e?{...i,...t}:i)}_renderPhasesEditor(e){let t=i=>this._phaseDefs.find(a=>a.id===i)?.name||i;return l`
              ...
              ${oi.map(a=>l`
                <label class="req-option">
                  <input
                    ...
                    @change=${o=>{let h=o.target.checked,d=new Set(i.reqFields);h?d.add(a):d.delete(a),this._patchPhaseDef(i.id,{reqFields:[...d]})}}
                  />
                  <span>${n(rt[a],e)}</span>
                </label>
              `)}
      ...
      `:_}
    `}async _save(){if(!this._loading&&this._name.trim()){if(this._adaptiveSnapshot()!==this._adaptiveInitial){let e=parseInt(this._adaptiveMin,10),t=parseInt(this._adaptiveMax,10);if(!isNaN(e)&&!isNaN(t)&&e>t){this._error=`${n("adaptive_min_interval",this._lang)} > ${n("adaptive_max_interval",this._lang)}`;return}}if(this._triggerType==="threshold"&&this._thresholdLimitsOverlap()){this._error=n("trigger_hint_overlap",this._lang);return}if(this._scheduleType==="calendar"&&!this._calendarEntity.trim().startsWith("calendar.")){this._error=n("calendar_entity_required",this._lang);return}this._loading=!0,this._error="";try{let e={type:this._taskId?"maintenance_supporter/task/update":"maintenance_supporter/task/create",entry_id:this._entryId,name:this._name,task_type:this._type,schedule_type:this._scheduleType,warning_days:Number.isNaN(parseInt(this._warningDays,10))?this.defaultWarningDays:Math.max(0,parseInt(this._warningDays,10))},t=this._earliestCompletionDays.trim();e.earliest_completion_days=t===""?null:Math.max(0,parseInt(t,10)||0),this._taskId&&(e.task_id=this._taskId),this._scheduleType==="one_time"?(e.due_date=this._dueDate||null,e.interval_days=null):Et.includes(this._scheduleType)?(e.schedule={...this._buildSchedule(),...this._recurrenceExtras()},e.interval_days=null,this._taskId&&(e.due_date=null)):(this._taskId&&(e.due_date=null),this._scheduleType!=="manual"&&this._intervalDays?(e.interval_days=parseInt(this._intervalDays,10),e.interval_unit=this._intervalUnit,e.interval_anchor=this._intervalAnchor,this._scheduleType==="time_based"&&(e.schedule={kind:"interval",...this._recurrenceExtras()})):this._taskId&&(e.interval_days=null,e.interval_anchor="completion")),e.notes=this._notes||null,e.documentation_url=this._documentationUrl||null,e.custom_icon=this._customIcon||null,e.notify_icon=this._notifyIcon.trim()||null,e.priority=this._priority,e.labels=this._labels.split(",").map(d=>d.trim()).filter(Boolean),e.mirror_todo_entities=this._mirrorTodoEntities.filter(Boolean),e.enabled=this._enabled,(!this._taskId||this._lastPerformed!==this._loadedLastPerformed)&&(e.last_performed=this._lastPerformed||null),e.nfc_tag_id=this._nfcTagId||null,e.require_tag_scan=this._requireTagScan,e.allow_skip=this._allowSkip,e.notify_enabled=this._notifyEnabled,e.reading_unit=this._readingUnit.trim()||null,e.readings=Hr(this._readings);{let d={};for(let m of this._phaseDefs){if(!m.name.trim())continue;let f={...m.carry,name:m.name.trim()},b=m.checklistText.split(`
`).map($=>$.trim()).filter(Boolean);b.length&&(f.checklist=b);let w=[];if(m.partId){let $=parseFloat(m.partQty);w.push({part_id:m.partId,quantity:Number.isFinite($)&&$>0?$:1})}for(let $ of m.extraParts)w.push($.entry_id?{part_id:$.part_id,quantity:$.quantity,entry_id:$.entry_id}:{part_id:$.part_id,quantity:$.quantity});w.length&&(f.consumes_parts=w),m.reqOverride&&(f.required_completion_fields=[...m.reqFields]),d[m.id]=f}let p=this._phaseSeq.filter(m=>m in d);e.phases=Object.keys(d).length&&p.length?d:null,e.phase_sequence=e.phases?p:null}if((this.parts.length||this._foreignOwners.length)&&(e.consumes_parts=Object.values(this._consumesParts).map(d=>d.entry_id?{part_id:d.part_id,quantity:d.quantity,entry_id:d.entry_id}:{part_id:d.part_id,quantity:d.quantity})),(!this._taskId||this._responsibleUserId!==this._loadedResponsibleUserId)&&(e.responsible_user_id=this._responsibleUserId),e.assignee_pool=this._assigneePool,e.required_completion_fields=this._requiredCompletion,e.rotation_strategy=this._assigneePool.length>=2&&this._rotationStrategy?this._rotationStrategy:null,this._scheduleType==="sensor_based"&&this._triggerType==="compound"){let d=this._compoundConditions.map(Zn).filter(p=>p!==null);if(d.length>0){let p={type:"compound",compound_logic:this._compoundLogic,conditions:d};this._autoCompleteOnRecovery&&(p.auto_complete_on_recovery=!0),this._triggerCombinator==="all"&&(p.trigger_combinator="all"),e.trigger_config=p}else this._taskId&&(e.trigger_config=null)}else if(this._scheduleType==="sensor_based"&&this._triggerEntityId){let d=this._triggerEntityIds.length>0?this._triggerEntityIds:[this._triggerEntityId],p={entity_id:d[0],entity_ids:d,type:this._triggerType};if(this._triggerAttribute&&(p.attribute=this._triggerAttribute),this._autoCompleteOnRecovery&&(p.auto_complete_on_recovery=!0),this._triggerCombinator==="all"&&(p.trigger_combinator="all"),d.length>1&&(p.entity_logic=this._triggerEntityLogic),this._triggerType==="threshold"){if(this._triggerAbove){let m=parseFloat(this._triggerAbove);isNaN(m)||(p.trigger_above=m)}if(this._triggerBelow){let m=parseFloat(this._triggerBelow);isNaN(m)||(p.trigger_below=m)}if(this._triggerEquals){let m=parseFloat(this._triggerEquals);isNaN(m)||(p.trigger_equals=m)}if(this._triggerNotEquals){let m=parseFloat(this._triggerNotEquals);isNaN(m)||(p.trigger_not_equals=m)}if(this._triggerForMinutes){let m=parseInt(this._triggerForMinutes,10);isNaN(m)||(p.trigger_for_minutes=m)}}else if(this._triggerType==="counter"){if(this._triggerTargetValue){let m=parseFloat(this._triggerTargetValue);isNaN(m)||(p.trigger_target_value=m)}if(p.trigger_delta_mode=this._triggerDeltaMode,this._triggerDeltaMode&&this._triggerBaselineValue){let m=parseFloat(this._triggerBaselineValue);!isNaN(m)&&m>=0&&(p.trigger_baseline_value=m)}}else if(this._triggerType==="state_change"){if(this._triggerFromState&&(p.trigger_from_state=this._triggerFromState),this._triggerToState&&(p.trigger_to_state=this._triggerToState),this._triggerTargetChanges){let m=parseInt(this._triggerTargetChanges,10);isNaN(m)||(p.trigger_target_changes=m)}if(this._triggerForMinutes){let m=parseInt(this._triggerForMinutes,10);isNaN(m)||(p.trigger_for_minutes=m)}}else if(this._triggerType==="runtime"){if(this._triggerRuntimeHours){let f=parseFloat(this._triggerRuntimeHours);isNaN(f)||(p.trigger_runtime_hours=f)}if(this._triggerRuntimeMaxSession){let f=parseInt(this._triggerRuntimeMaxSession,10);!isNaN(f)&&f>0&&(p.trigger_runtime_max_session_seconds=f)}let m=this._triggerOnStates.split(",").map(f=>f.trim()).filter(Boolean);m.length>0&&(p.trigger_on_states=m)}e.trigger_config=p}else this._taskId&&(e.trigger_config=null);if(this.scheduleTimeEnabled&&Xr.includes(this._scheduleType)){let d=this._scheduleTimeOn?this._scheduleTime.trim():"";e.schedule_time=/^([01]\d|2[0-3]):[0-5]\d$/.test(d)?d:null}if(this.checklistsEnabled){let d=this._checklistText.split(`
`).map(p=>p.trim()).filter(Boolean).slice(0,100);e.checklist=d.length?d:null}if(this.completionActionsEnabled){let d=this._actionService.trim();if(d&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(d)){let b={service:d},w=this._actionTargetEntity.trim();w&&(b.target={entity_id:w});let $=this._buildActionData();Object.keys($).length>0&&(b.data=$),e.on_complete_action=b}else e.on_complete_action=null;let p={};this._qcNotes.trim()&&(p.notes=this._qcNotes.trim());let m=parseFloat(this._qcCost);!isNaN(m)&&m>=0&&(p.cost=m);let f=He(this._qcDuration);f!==null&&(p.duration=f),this._qcFeedback&&(p.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(p).length?p:null}let i=await this.hass.connection.sendMessagePromise(e),a=this._taskId||i?.task_id,o=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;this._warning="";let h=d=>{this._warning=n("subsave_warning",this._lang).replace("{detail}",d)};if(a&&this._scheduleType==="sensor_based"&&o&&await ai(this,{type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null},{onError:h})!==void 0&&(this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute),a&&this._adaptiveSnapshot()!==this._adaptiveInitial){let d=parseFloat(this._adaptiveAlpha),p=parseInt(this._adaptiveMin,10),m=parseInt(this._adaptiveMax,10);await ai(this,{type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:a,enabled:this._adaptiveEnabled,...d>=.1&&d<=.9?{ewa_alpha:d}:{},...!isNaN(p)&&p>=1?{min_interval_days:p}:{},...!isNaN(m)&&m>=1?{max_interval_days:m}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction},{onError:h})!==void 0&&(this._adaptiveInitial=this._adaptiveSnapshot())}this._warning?a&&(this._taskId=a):this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=q(e,this._lang,n("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._warning="",this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return _;let e=this._lang,t=this._triggerType==="compound";return l`
      ...
      <div class="select-row">
        ...
        >
          ${Yn.map(i=>l`<option value=${i} ?selected=${i===this._triggerType}>${n(i,e)}</option>`)}
        </select>
      </div>
      ${t?this._renderCompoundEditor():l`
        ...
        <ha-form
          ...
          .hass=${this.hass}
          .schema=${[{name:"trigger_entities",selector:{entity:{multiple:!0,domain:ni}}}]}
      ...
      ${this._intervalDays?l`
          ...
          `:_}
    `}_patchCondition(e,t){this._compoundConditions=this._compoundConditions.map((i,a)=>a===e?{...i,...t}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Gn()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((t,i)=>i!==e)}_renderCompoundEditor(){let e=this._lang;return l`
      <div class="select-row">
    ...
    `}_renderCondition(e,t){let i=this._lang,a=t+1;return l`
      <div class="compound-condition">
        ...
        <ha-form
          class="entity-picker-form"
          .hass=${this.hass}
          .schema=${[{name:"condition_entities",selector:{entity:{multiple:!0,domain:ni}}}]}
        ...
        <div class="select-row">
          ...
          >
            ${es.map(o=>l`<option value=${o} ?selected=${o===e.type}>${n(o,i)}</option>`)}
          </select>
        </div>
    ...
    `}_buildSchedule(){let e=i=>{let a=parseInt(this._calOffset,10)||0;return a&&(i.offset=Math.max(-15,Math.min(a,15))),i};if(this._scheduleType==="weekdays")return e({kind:"weekdays",weekdays:[...this._weekdays].sort((i,a)=>i-a)});if(this._scheduleType==="nth_weekday")return e({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});if(this._scheduleType==="calendar")return e({kind:"calendar",entity_id:this._calendarEntity.trim()});let t={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(t.business=!0),e(t)}_recurrenceExtras(){let e={};if(this._seasonMonths.length&&(e.season_months=[...this._seasonMonths].sort((t,i)=>t-i)),this._endsMode==="count"){let t=parseInt(this._endsCount,10);t>=1&&(e.ends={count:t})}else this._endsMode==="until"&&this._endsUntil&&(e.ends={until:this._endsUntil});return e}_toggleSeasonMonth(e){this._seasonMonths=this._seasonMonths.includes(e)?this._seasonMonths.filter(t=>t!==e):[...this._seasonMonths,e]}_renderRecurrenceExtras(){let e=this._lang;if(!(this._scheduleType==="time_based"||Et.includes(this._scheduleType)))return _;let i=ea(e);return l`
      ...
      ${this._endsMode==="until"?l`
        ...
        ></ms-date-field>`:_}
    `}_renderCalendarFields(){let e=this._lang,t=Xn(e);if(this._scheduleType==="weekdays")return l`
      ...
      ></ms-textfield>`}_thresholdLimitsOverlap(){let e=parseFloat(this._triggerAbove),t=parseFloat(this._triggerBelow);return!isNaN(e)&&!isNaN(t)&&t>e}_renderTriggerLiveHint(){if(this._triggerType==="compound")return _;let e=this._triggerType==="threshold"&&this._thresholdLimitsOverlap()?l`<div class="trigger-live-hint warn">${n("trigger_hint_overlap",this._lang)}</div>`:_,t=this._triggerEntityId||this._triggerEntityIds[0];if(!t||!this.hass?.states)return e;let i=this.hass.states[t];if(!i)return e;let a=this._lang,o=i.attributes?.unit_of_measurement,h=typeof o=="string"&&o?` ${o}`:"",d=this._triggerAttribute?i.attributes?.[this._triggerAttribute]:i.state,p=typeof d=="number"?d:parseFloat(String(d)),m=d!=="unknown"&&d!=="unavailable"&&d!=null&&!isNaN(p),f=w=>P(w,a,{maximumFractionDigits:1}),b=[];if(this._triggerType==="threshold"){let w=parseFloat(this._triggerAbove),$=parseFloat(this._triggerBelow);if(isNaN(w)&&isNaN($))return _;m&&b.push(n("trigger_hint_now",a).replace("{value}",f(p)+h)),isNaN(w)||b.push(n("trigger_hint_above",a).replace("{target}",f(w)+h)),isNaN($)||b.push(n("trigger_hint_below",a).replace("{target}",f($)+h))}else if(this._triggerType==="counter"){let w=parseFloat(this._triggerTargetValue);if(isNaN(w))return _;this._triggerDeltaMode?this._taskId?b.push(n("trigger_hint_counter_delta_edit",a).replace("{target}",f(w)+h)):m?b.push(n("trigger_hint_counter_delta",a).replace("{value}",f(p)+h).replace("{due}",f(p+w)+h).replace("{target}",f(w)+h)):b.push(n("trigger_hint_counter_delta_edit",a).replace("{target}",f(w)+h)):(m&&b.push(n("trigger_hint_now",a).replace("{value}",f(p)+h)),b.push(n("trigger_hint_counter_abs",a).replace("{target}",f(w)+h)))}else if(this._triggerType==="runtime"){let w=parseFloat(this._triggerRuntimeHours);if(isNaN(w))return _;b.push(n("trigger_hint_runtime",a).replace("{hours}",f(w))),b.push(n("trigger_hint_state_now",a).replace("{value}",String(i.state)))}else if(this._triggerType==="state_change"){let w=parseInt(this._triggerTargetChanges,10)||1,$=this._triggerToState.trim();b.push(($?n("trigger_hint_state_change_to",a).replace("{state}",$):n("trigger_hint_state_change",a)).replace("{count}",String(w))),b.push(n("trigger_hint_state_now",a).replace("{value}",String(i.state)))}return b.length?l`<div class="trigger-live-hint">${b.join(" ")}</div>${e}`:e}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?l`
        <ms-textfield
      ...
      `:this._triggerType==="state_change"?l`
        ...
        ${(this._triggerTargetChanges||"1")==="1"&&(this._triggerFromState||this._triggerToState)?l`<div class="field-help">${n("state_latch_help",e)}</div>`:_}
        <ms-textfield
          label="${n("for_at_least_minutes",e)}"
          type="number"
          min="0"
      ...
      `:_}render(){if(!this._open)return l``;let e=this._lang,t=this._taskId?n("edit_task",e):n("new_task",e);return l`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
          ${this._error?l`<div class="error">${this._error}</div>`:_}
          ...
          <div class="select-row">
            ...
            >
              ${Vn.map(i=>l`<option value=${i} ?selected=${i===this._type}>${n(i,e)}</option>`)}
            </select>
          </div>
          ${this._type==="reading"?l`
              ...
              `:_}
          ${this._partsLoadFailed?l`<div class="field-help parts-load-failed">${n("parts_load_failed",e)}</div>`:_}
          ...
          <div class="select-row">
            ...
            >
              ${Wn.map(i=>l`<option value=${i} ?selected=${i===this._priority}>${n("priority_"+i,e)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${Kn.map(i=>l`<option value=${i} ?selected=${i===this._scheduleType}>${n(i,e)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="one_time"?l`
                ...
                ></ms-date-field>
              `:_}
          ${this.scheduleTimeEnabled&&Xr.includes(this._scheduleType)?l`
          ...
          ${this._scheduleType==="sensor_based"?l`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:Yr,device_class:Gr}}}]}
          ...
          <div class="field-help notify-icon-help">
            <ha-icon icon=${this._notifyIcon.trim()||ci(this._type)}></ha-icon>
            ${n("notify_icon_hint",e).replace("{default}",ci(this._type))}
          </div>
          ...
          ${this._requireTagScan?l`<div class="field-help">${n("require_tag_scan_help",e)}</div>`:_}
          <label class="req-option">
            <input
              type="checkbox"
          ...
          ${this._allowSkip?_:l`<div class="field-help">${n("disallow_skip_help",e)}</div>`}
          <label class="req-option">
            <input
              type="checkbox"
          ...
          ${this._notifyEnabled?_:l`<div class="field-help">${n("no_notifications_help",e)}</div>`}
  ...
  `,c([v({attribute:!1})],g.prototype,"hass",2),c([v({type:Boolean,attribute:"checklists-enabled"})],g.prototype,"checklistsEnabled",2),c([v({type:Boolean,attribute:"schedule-time-enabled"})],g.prototype,"scheduleTimeEnabled",2),c([v({type:Boolean,attribute:"completion-actions-enabled"})],g.prototype,"completionActionsEnabled",2),c([v({type:Number,attribute:"default-warning-days"})],g.prototype,"defaultWarningDays",2),c([u()],g.prototype,"parts",2),c([u()],g.prototype,"_foreignOwners",2),c([u()],g.prototype,"_open",2),c([u()],g.prototype,"_entityPickerFallback",2),c([u()],g.prototype,"_loading",2),c([u()],g.prototype,"_error",2),c([u()],g.prototype,"_warning",2),c([u()],g.prototype,"_entryId",2),c([u()],g.prototype,"_taskId",2),c([u()],g.prototype,"_isFleetTask",2),c([u()],g.prototype,"_objectChoices",2),c([u()],g.prototype,"_name",2),c([u()],g.prototype,"_type",2),c([u()],g.prototype,"_scheduleType",2),c([u()],g.prototype,"_intervalDays",2),c([u()],g.prototype,"_intervalUnit",2),c([u()],g.prototype,"_dueDate",2),c([u()],g.prototype,"_warningDays",2),c([u()],g.prototype,"_earliestCompletionDays",2),c([u()],g.prototype,"_intervalAnchor",2),c([u()],g.prototype,"_weekdays",2),c([u()],g.prototype,"_nth",2),c([u()],g.prototype,"_nthWeekday",2),c([u()],g.prototype,"_domDay",2),c([u()],g.prototype,"_domLastDay",2),c([u()],g.prototype,"_domBusiness",2),c([u()],g.prototype,"_calOffset",2),c([u()],g.prototype,"_calendarEntity",2),c([u()],g.prototype,"_seasonMonths",2),c([u()],g.prototype,"_endsMode",2),c([u()],g.prototype,"_endsCount",2),c([u()],g.prototype,"_endsUntil",2),c([u()],g.prototype,"_schedulePreview",2),c([u()],g.prototype,"_schedulePreviewEnded",2),c([u()],g.prototype,"_notes",2),c([u()],g.prototype,"_documentationUrl",2),c([u()],g.prototype,"_customIcon",2),c([u()],g.prototype,"_notifyIcon",2),c([u()],g.prototype,"_priority",2),c([u()],g.prototype,"_labels",2),c([u()],g.prototype,"_mirrorTodoEntities",2),c([u()],g.prototype,"_enabled",2),c([u()],g.prototype,"_triggerEntityId",2),c([u()],g.prototype,"_triggerEntityIds",2),c([u()],g.prototype,"_triggerEntityLogic",2),c([u()],g.prototype,"_triggerAttribute",2),c([u()],g.prototype,"_triggerType",2),c([u()],g.prototype,"_triggerAbove",2),c([u()],g.prototype,"_triggerBelow",2),c([u()],g.prototype,"_triggerEquals",2),c([u()],g.prototype,"_triggerNotEquals",2),c([u()],g.prototype,"_triggerForMinutes",2),c([u()],g.prototype,"_triggerCombinator",2),c([u()],g.prototype,"_triggerTargetValue",2),c([u()],g.prototype,"_triggerDeltaMode",2),c([u()],g.prototype,"_triggerBaselineValue",2),c([u()],g.prototype,"_liveBaselineValue",2),c([u()],g.prototype,"_autoCompleteOnRecovery",2),c([u()],g.prototype,"_triggerFromState",2),c([u()],g.prototype,"_triggerToState",2),c([u()],g.prototype,"_triggerTargetChanges",2),c([u()],g.prototype,"_triggerRuntimeHours",2),c([u()],g.prototype,"_triggerRuntimeMaxSession",2),c([u()],g.prototype,"_triggerOnStates",2),c([u()],g.prototype,"_compoundLogic",2),c([u()],g.prototype,"_compoundConditions",2),c([u()],g.prototype,"_suggestedAttributes",2),c([u()],g.prototype,"_availableAttributes",2),c([u()],g.prototype,"_entityDomain",2),c([u()],g.prototype,"_lastPerformed",2),c([u()],g.prototype,"_nfcTagId",2),c([u()],g.prototype,"_requireTagScan",2),c([u()],g.prototype,"_allowSkip",2),c([u()],g.prototype,"_notifyEnabled",2),c([u()],g.prototype,"_readingUnit",2),c([u()],g.prototype,"_readings",2),c([u()],g.prototype,"_consumesParts",2),c([u()],g.prototype,"_partsLoadFailed",2),c([u()],g.prototype,"_availableTags",2),c([u()],g.prototype,"_responsibleUserId",2),c([u()],g.prototype,"_assigneePool",2),c([u()],g.prototype,"_rotationStrategy",2),c([u()],g.prototype,"_availableUsers",2),c([u()],g.prototype,"_checklistText",2),c([u()],g.prototype,"_phaseDefs",2),c([u()],g.prototype,"_phaseSeq",2),c([u()],g.prototype,"_requiredCompletion",2),c([u()],g.prototype,"_scheduleTime",2),c([u()],g.prototype,"_scheduleTimeOn",2),c([u()],g.prototype,"_actionService",2),c([u()],g.prototype,"_actionTargetEntity",2),c([u()],g.prototype,"_actionData",2),c([u()],g.prototype,"_actionDataJsonFallback",2),c([u()],g.prototype,"_actionTesting",2),c([u()],g.prototype,"_actionTestResult",2),c([u()],g.prototype,"_actionTestError",2),c([u()],g.prototype,"_qcNotes",2),c([u()],g.prototype,"_qcCost",2),c([u()],g.prototype,"_qcDuration",2),c([u()],g.prototype,"_qcFeedback",2),c([u()],g.prototype,"_environmentalEntity",2),c([u()],g.prototype,"_environmentalAttribute",2),c([u()],g.prototype,"_adaptiveEnabled",2),c([u()],g.prototype,"_adaptiveAlpha",2),c([u()],g.prototype,"_adaptiveMin",2),c([u()],g.prototype,"_adaptiveMax",2),c([u()],g.prototype,"_adaptiveSeasonal",2),c([u()],g.prototype,"_adaptivePrediction",2),c([u()],g.prototype,"_conditionAttrOptions",2);di=g;customElements.get("maintenance-task-dialog")||customElements.define("maintenance-task-dialog",di)});async function ta(s,r,e){let t=s.auth;if(t?.expired&&t.refreshAccessToken)try{await t.refreshAccessToken()}catch{}return fetch(r,{...e,headers:{...e.headers??{},Authorization:`Bearer ${t?.data?.access_token??""}`}})}async function ia(s,r,e,t){let i=new FormData;i.append("entry_id",r);for(let h of t)i.append("tags",h);i.append("file",e,e.name);let a=await ta(s,"/api/maintenance_supporter/document/upload",{method:"POST",body:i});if(a.status===413)throw new Error("doc_too_large");if(!a.ok)throw new Error("doc_upload_failed");let o=await a.json();if(!o.id)throw new Error("doc_upload_failed");return{id:o.id,deduped:!!o.deduped,duplicate_in_object:o.duplicate_in_object??null}}async function rs(s,r,e){return(await ia(s,r,e,["photo"])).id}async function pi(s,r){await Promise.all(r.map(e=>s.connection.sendMessagePromise({type:"maintenance_supporter/documents/delete",doc_id:e}).catch(()=>{})))}var ss=y(()=>{"use strict";xt()});var qe,ui=y(()=>{"use strict";A();ss();qe=class{constructor(r,e){this.host=r;this.opts=e;this.photos=[];this.uploadedIds=[];this.uploading=!1;this.errorKey="";this.max=e.max??10,r.addController(this)}hostConnected(){}get ids(){return this.photos.map(r=>r.id)}get remaining(){return Math.max(this.max-this.photos.length,0)}get full(){return this.remaining===0}errorText(r){return this.errorKey?n(this.errorKey,r).replace("{max}",String(this.max)):""}clearError(){this.errorKey=""}reset(r=[]){this._revokeAll(),this.photos=r.map(e=>({id:e,preview:""})),this.uploadedIds=[],this.uploading=!1,this.errorKey="",this.host.requestUpdate()}async addFiles(r){if(r.length===0)return;let e=r.slice(0,this.remaining);this.uploading=!0,this.errorKey="",this.host.requestUpdate();try{for(let t of e){let i=await rs(this.opts.hass(),this.opts.entryId(),t);this.uploadedIds=[...this.uploadedIds,i],this.photos=[...this.photos,{id:i,preview:URL.createObjectURL(t)}],this.host.requestUpdate()}r.length>e.length&&(this.errorKey="photos_limit")}catch(t){this.errorKey=t instanceof Error&&t.message==="doc_too_large"?"doc_too_large":"doc_upload_failed"}finally{this.uploading=!1,this.host.requestUpdate()}}remove(r){let e=this.photos.find(t=>t.id===r);e?.preview&&URL.revokeObjectURL(e.preview),this.photos=this.photos.filter(t=>t.id!==r),this.uploadedIds.includes(r)&&(this.uploadedIds=this.uploadedIds.filter(t=>t!==r),pi(this.opts.hass(),[r])),this.host.requestUpdate()}discardOrphans(){if(this.uploadedIds.length===0)return;let r=this.uploadedIds;this.uploadedIds=[],pi(this.opts.hass(),r)}markAttached(){this.uploadedIds=[]}_revokeAll(){for(let r of this.photos)r.preview&&URL.revokeObjectURL(r.preview)}}});function St(){if(window.externalApp!==void 0)return!0;let r=typeof navigator<"u"&&navigator.userAgent||"";return/Home Assistant\//.test(r)&&/Android/.test(r)}var hi=y(()=>{"use strict"});function ns(s){try{return localStorage.getItem(s)}catch{return null}}function as(s,r){try{localStorage.setItem(s,r)}catch{}}var _i,os=y(()=>{"use strict";_i={objectSections:"msp-object-sections",printOptions:"msp-print-options",batteryRosterOpen:"msp-bf-roster-open",docSort:"msp-doc-sort",cameraDevice:"msp-camera-device",overviewTab:"msp-overview-tab",collapsedSections:"msp-collapsed-sections",chartRange:"msp-chart-range",chartHideOutliers:"msp-chart-hide-outliers",taskSort:"maintenance_supporter_sort",objectSort:"maintenance_supporter_object_sort",groupBy:"maintenance_supporter_groupby",objectView:"maintenance_supporter_object_view",objectsCache:"msp-objects-cache",gettingStartedDismissed:"msp-gs-dismissed",batteryRosterSort:"ms_bf_roster_sort"}});function ls(){if(!St())return!1;let s=typeof navigator<"u"?navigator.mediaDevices:void 0;return!!s&&typeof s.getUserMedia=="function"}var ra,sa,ee,mi=y(()=>{"use strict";C();U();A();hi();os();ra=1920,sa=.88,ee=class extends S{constructor(){super(...arguments);this.lang="en";this._open=!1;this._busy=!1;this._devices=[];this._deviceIndex=-1;this._switchFailed=!1;this._facing="environment";this._stream=null;this._opening=!1}async open(){if(!(this._open||this._opening)){this._opening=!0;try{await this._acquireAndShow()}finally{this._opening=!1}}}async _acquireAndShow(){let e=typeof navigator<"u"?navigator.mediaDevices:void 0;if(!e||typeof e.getUserMedia!="function"){this._unavailable("no_media_devices");return}let t=ns(_i.cameraDevice),i=!1;if(t)try{this._stream=await e.getUserMedia({video:{deviceId:{exact:t}},audio:!1}),i=!0}catch{}if(!i){try{this._stream=await e.getUserMedia({video:{facingMode:{ideal:"environment"},zoom:1,advanced:[{zoom:1}]},audio:!1})}catch(o){this._unavailable(o instanceof Error?o.name||o.message:String(o));return}if(await this._preferMainBackCamera(e),!this._stream)return}await this._applyZoomOne(),await this._listDevices(e),this._deviceIndex=this._indexOfCurrent(t&&i?t:null),this._switchFailed=!1,this._facing=this._stream?.getVideoTracks()[0]?.getSettings().facingMode??"environment",this._open=!0,await this.updateComplete;let a=this._video;if(a&&this._stream){a.srcObject=this._stream;try{await a.play()}catch{}}}async _preferMainBackCamera(e){if(typeof e.enumerateDevices!="function")return;let t=[];try{t=await e.enumerateDevices()}catch{return}let i=d=>{let p=/camera2?\s*(\d+)/i.exec(d.label);return p?Number(p[1]):Number.MAX_SAFE_INTEGER},a=t.filter(d=>d.kind==="videoinput"&&d.deviceId&&/back|rear|environment|rück|hinten/i.test(d.label)).sort((d,p)=>i(d)-i(p)),h=this._stream?.getVideoTracks()[0]?.getSettings().deviceId;if(a.length>1&&a[0].deviceId!==h){let d=h?[{deviceId:{exact:h}}]:[];d.push({facingMode:{ideal:"environment"}}),await this._swapCamera(e,[{deviceId:{exact:a[0].deviceId}}],d)===null&&this._unavailable("camera_lost")}}async _swapCamera(e,t,i){this._stopTracks();for(let[a,o]of t.entries())try{return this._stream=await e.getUserMedia({video:o,audio:!1}),a}catch{}for(let a of i)try{return this._stream=await e.getUserMedia({video:a,audio:!1}),-1}catch{}return null}async _attach(){let e=this._video;if(!(!e||!this._stream)){e.srcObject=this._stream;try{await e.play()}catch{}}}async _applyZoomOne(){let e=this._stream?.getVideoTracks()[0],t=e&&typeof e.getCapabilities=="function"?e.getCapabilities():void 0;if(!(!t?.zoom||typeof t.zoom.min!="number"||t.zoom.min>=1||(t.zoom.max??1)<1))for(let i of[{zoom:1},{advanced:[{zoom:1}]}])try{await e.applyConstraints(i);return}catch{}}_indexOfCurrent(e){let t=this._devices.map(a=>a.deviceId),i=this._currentDeviceId;for(let a of[e,i])if(a){let o=t.indexOf(a);if(o>=0)return o}return-1}async _listDevices(e){if(typeof e.enumerateDevices=="function")try{this._devices=(await e.enumerateDevices()).filter(t=>t.kind==="videoinput"&&!!t.deviceId)}catch{this._devices=[]}}get _currentDeviceId(){return this._stream?.getVideoTracks()[0]?.getSettings().deviceId}async _switchCamera(){let e=typeof navigator<"u"?navigator.mediaDevices:void 0;if(!e||this._devices.length<2||this._busy)return;let t=this._devices.map(p=>p.deviceId),i=this._currentDeviceId||(this._deviceIndex>=0?t[this._deviceIndex]:void 0),a=this._facing==="user"?"environment":"user",o=[];for(let p=1;p<t.length;p++){let m=(this._deviceIndex+p)%t.length;t[m]===i&&this._deviceIndex<0||o.push(m)}let h=[...o.map(p=>({deviceId:{exact:t[p]}})),{facingMode:{exact:a}},{facingMode:{ideal:a}}],d=i?[{deviceId:{exact:i}}]:[];d.push({facingMode:{ideal:this._facing}}),this._busy=!0;try{let p=await this._swapCamera(e,h,d);if(p===null){this._unavailable("camera_lost");return}p>=0&&p<o.length?(this._deviceIndex=o[p],this._switchFailed=!1,as(_i.cameraDevice,t[o[p]])):p>=o.length&&!this._isCamera(i,this._facing)?(this._facing=a,this._deviceIndex=this._indexOfCurrent(null),this._switchFailed=!1):this._switchFailed=!0,await this._applyZoomOne(),await this._attach()}finally{this._busy=!1}}_isCamera(e,t){let i=this._stream?.getVideoTracks()[0]?.getSettings();return e&&i?.deviceId?i.deviceId===e:!!i?.facingMode&&i.facingMode===t}close(){this._stopStream(),this._open=!1,this._busy=!1}disconnectedCallback(){super.disconnectedCallback(),this._stopStream()}get _video(){return this.shadowRoot?.querySelector("video")??null}_stopStream(){this._stopTracks();let e=this._video;e&&(e.srcObject=null)}_stopTracks(){for(let e of this._stream?.getTracks()??[])e.stop();this._stream=null}_unavailable(e){this._stopStream(),this._open=!1,this.dispatchEvent(new CustomEvent("capture-unavailable",{detail:{reason:e},bubbles:!0,composed:!0}))}async _shoot(){let e=this._video;if(!(!e||this._busy)){this._busy=!0;try{let t=e.videoWidth||640,i=e.videoHeight||480,a=Math.min(1,ra/Math.max(t,i)),o=document.createElement("canvas");o.width=Math.round(t*a),o.height=Math.round(i*a);let h=o.getContext("2d");if(!h)throw new Error("no_canvas");h.drawImage(e,0,0,o.width,o.height);let d=await new Promise(f=>o.toBlob(f,"image/jpeg",sa));if(!d)throw new Error("no_blob");let p=new Date().toISOString().replace(/[-:]/g,"").slice(0,15),m=new File([d],`photo-${p}.jpg`,{type:"image/jpeg"});this.close(),this.dispatchEvent(new CustomEvent("photo-captured",{detail:{file:m},bubbles:!0,composed:!0}))}catch(t){this._unavailable(t instanceof Error?t.message:String(t))}finally{this._busy=!1}}}render(){if(!this._open)return _;let e=this.lang;return l`
      <div class="overlay" role="dialog" aria-modal="true" aria-label=${n("doc_camera",e)}>
        <video autoplay playsinline muted></video>
        ${this._switchFailed?l`<div class="switch-note" role="status">${n("camera_switch_failed",e)}</div>`:_}
        <div class="bar">
          <button type="button" class="cancel" @click=${this.close}>${n("cancel",e)}</button>
          ${this._devices.length>1?l`<button type="button" class="switch" ?disabled=${this._busy} title=${n("camera_switch_lens",e)} aria-label=${n("camera_switch_lens",e)} @click=${this._switchCamera}>
  ...
  `,c([v({type:String})],ee.prototype,"lang",2),c([u()],ee.prototype,"_open",2),c([u()],ee.prototype,"_busy",2),c([u()],ee.prototype,"_devices",2),c([u()],ee.prototype,"_deviceIndex",2),c([u()],ee.prototype,"_switchFailed",2);customElements.get("ms-camera-capture")||customElements.define("ms-camera-capture",ee)});var Tt,G,st=y(()=>{"use strict";C();U();A();hi();mi();mi();Tt=E`
...
`,G=class extends S{constructor(){super(...arguments);this.lang="en";this.disabled=!1;this.busy=!1;this.accept="image/*";this.showCamera=!0;this.showGallery=!0;this.compact=!1;this.remaining=1/0;this._singlePick=St();this._inAppCamera=ls()}createRenderRoot(){return this}get _locked(){return this.disabled||this.busy}_emit(e){e.length!==0&&this.dispatchEvent(new CustomEvent("files-picked",{detail:{files:e},bubbles:!0,composed:!0}))}_onInput(e){let t=e.target,i=Array.from(t.files??[]);t.value="",this._emit(i)}_onCameraClick(e){!this._inAppCamera||this._locked||(e.preventDefault(),this.querySelector("ms-camera-capture")?.open())}_onCameraUnavailable(){this._inAppCamera=!1,this.querySelector(".photo-pick-camera input")?.click()}_onKeydown(e){e.key!=="Enter"&&e.key!==" "||(e.preventDefault(),!this._locked&&e.currentTarget.click())}render(){if(this.remaining<=0||!this.showCamera&&!this.showGallery)return _;let e=this.lang,t=this._locked?"disabled":"",i=this.busy?n("uploading",e):n("doc_camera",e),a=n(this._singlePick?"choose_photo":"choose_photos",e);return l`
      <div class="photo-pickers">
        ${this.showCamera?l`<label class="photo-pick photo-pick-camera ${t}" role="button" tabindex="0"
              aria-label=${i} title=${this.compact?i:_}
              @click=${this._onCameraClick} @keydown=${this._onKeydown}>
              <ha-icon icon="mdi:camera"></ha-icon>
              ${this.compact?_:l`<span>${i}</span>`}
        ...
        ${this.showGallery?l`<label class="photo-pick photo-pick-gallery ${t}" role="button" tabindex="0"
              aria-label=${a} title=${this.compact?a:_}
              @keydown=${this._onKeydown}>
              <ha-icon icon="mdi:image-multiple"></ha-icon>
              ${this.compact?_:l`<span>${a}</span>`}
              <input type="file" accept=${this.accept} ?multiple=${!this._singlePick}
                ?disabled=${this._locked} @change=${this._onInput} />
            </label>`:_}
      </div>
      ${this.showGallery&&this._singlePick?l`<div class="photo-android-hint">${n("photos_android_hint",e)}</div>`:_}
      ${this.showCamera&&this._inAppCamera?l`<ms-camera-capture .lang=${e}
            @photo-captured=${o=>this._emit([o.detail.file])}
            @capture-unavailable=${this._onCameraUnavailable}></ms-camera-capture>`:_}
    `}};c([v({type:String})],G.prototype,"lang",2),c([v({type:Boolean})],G.prototype,"disabled",2),c([v({type:Boolean})],G.prototype,"busy",2),c([v({type:String})],G.prototype,"accept",2),c([v({type:Boolean})],G.prototype,"showCamera",2),c([v({type:Boolean})],G.prototype,"showGallery",2),c([v({type:Boolean})],G.prototype,"compact",2),c([v({type:Number})],G.prototype,"remaining",2),c([u()],G.prototype,"_inAppCamera",2);customElements.get("ms-photo-picker")||customElements.define("ms-photo-picker",G)});var je,nt,k,cs=y(()=>{"use strict";C();U();$e();A();ue();$t();li();ui();kt();Ne();st();st();je=[.01,999],nt=[.01,9999],k=class extends S{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this.taskType="";this.readingUnit="";this.readings=[];this.readingHistory=[];this.restockDefault=null;this.restockUnitCost=null;this.currencySymbol="";this.parts=[];this.consumesParts=[];this.consumesInfo=[];this.requiredFields=[];this.phaseLabel="";this.requireTagScan=!1;this.viaTagScan=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed";this._photos=new qe(this,{entryId:()=>this.entryId,hass:()=>this.hass});this._readingValue="";this._readingValues={};this._restockQty="";this._completedAt="";this._usedParts={};this._usedQtyText={};this.checklistPrefill={}}open(e={}){this._open||(this._open=!0,this.viaTagScan=!!e.viaTagScan,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState=Object.fromEntries(this.checklist.map((t,i)=>[String(i),!!this.checklistPrefill[t]]).filter(([,t])=>t)),this._feedback="needed",this._photos.reset(),this._readingValue="",this._readingValues={},this._restockQty=this.restockDefault!==null?String(this.restockDefault):"",this._completedAt="",this._usedParts=Object.fromEntries(this.consumesParts.map(t=>[X(t),{...t}])),this._usedQtyText={})}_rangeError(e,t){let i=this.lang;return n("settings_value_out_of_range",i).replace("{min}",P(e,i,{maximumFractionDigits:2})).replace("{max}",P(t,i,{maximumFractionDigits:2}))}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}async _complete(){this._loading=!0,this._error="",this._photos.clearError();try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let i=parseFloat(this._cost);!isNaN(i)&&i>=0&&(e.cost=i)}let t=He(this._duration);if(t!==null&&(e.duration=t),this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),this._photos.photos.length>0&&(e.photo_doc_ids=this._photos.ids),this.viaTagScan&&(e.via_tag_scan=!0),this._completedAt){if(new Date(this._completedAt).getTime()>Date.now()){this._error=n("completed_at_future_error",this.lang),this._loading=!1;return}e.completed_at=this._completedAt.length===16?`${this._completedAt}:00`:this._completedAt}if(this.readings.length>0){let i={};for(let a of this.readings){let o=(this._readingValues[a.id]??"").trim();if(o==="")continue;let h=parseFloat(o.replace(",","."));isNaN(h)||(i[a.id]=h)}Object.keys(i).length>0&&(e.reading_values=i)}else if(this._readingValue!==""){let i=parseFloat(this._readingValue);isNaN(i)||(e.reading_value=i)}if(this.restockDefault!==null&&this._restockQty.trim()!==""){let i=parseFloat(this._restockQty.replace(",","."));if(!Number.isFinite(i)||i<nt[0]||i>nt[1]){this._error=this._rangeError(...nt),this._loading=!1;return}e.restock_quantity=i}if(this.parts.length>0){let i=[];for(let[a,o]of Object.entries(this._usedParts)){let h=this._usedQtyText[a],d=h===void 0?o.quantity:parseFloat(h.replace(",","."));if(!Number.isFinite(d)||d<je[0]||d>je[1]){this._error=this._rangeError(...je),this._loading=!1;return}i.push({...o,quantity:d})}e.used_parts=i.map(a=>a.entry_id?{part_id:a.part_id,quantity:a.quantity,entry_id:a.entry_id}:{part_id:a.part_id,quantity:a.quantity})}await this.hass.connection.sendMessagePromise(e),this._photos.markAttached(),this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=q(e,this.lang,n("save_error",this.lang))}finally{this._loading=!1}}_renderReadingField(e,t){let i=this._completedAt?new Date(this._completedAt).getTime():NaN,a=Pr(this.readingHistory,e.id,isNaN(i)?void 0:i),o=e.unit||this.readingUnit,h=(this._readingValues[e.id]??"").trim(),d=h===""?NaN:parseFloat(h.replace(",",".")),p=a!==void 0&&!isNaN(d)&&d<a.value,m=a!==void 0?P(a.value,t,{maximumFractionDigits:3}):"";return l`
    ...
    >${n("cost_from_parts",e).replace("{amount}",i)}</button>`}_close(){this._open=!1,this._photos.discardOrphans()}_pickCompletedAt(){let e=new Date,t=i=>String(i).padStart(2,"0");this._completedAt=`${e.getFullYear()}-${t(e.getMonth()+1)}-${t(e.getDate())}T${t(e.getHours())}:${t(e.getMinutes())}:00`}render(){if(!this._open)return l``;let e=this.lang||this.hass?.language||"en",t=this._error||this._photos.errorText(e);return l`
      <ha-dialog open @closed=${this._close}>
        ...
        ${this.phaseLabel?l`<div class="phase-line">${n("phase_current",e)}: ${this.phaseLabel}</div>`:_}
        ${this.requireTagScan&&!this.viaTagScan?l`<div class="scan-required-note">${n("require_tag_scan_hint",e)}</div>`:_}
        <div class="content">
          ${t?l`<div class="error">${t}</div>`:_}
          ...
          ${this.parts.length?l`<div class="used-parts">
                ...
                ${this.parts.map(i=>{let a=X({part_id:i.id,entry_id:i.entry_id}),o=this._usedParts[a],h=o!==void 0,d=i.entry_id?{part_id:i.id,quantity:1,entry_id:i.entry_id}:{part_id:i.id,quantity:1};return l`<div class="used-part-row">
                    <label class="used-part-check">
                      <input type="checkbox" .checked=${h}
                        @change=${p=>{let m={...this._usedParts};if(p.target.checked)m[a]=m[a]||d;else{delete m[a];let f={...this._usedQtyText};delete f[a],this._usedQtyText=f}this._usedParts=m}} />
                      <span
                        >${i.name}${i.owner_name?l`<span class="used-part-owner"> (${i.owner_name})</span>`:_}${i.stock!==null&&i.stock!==void 0?` (${i.stock}${i.unit?" "+i.unit:""})`:""}</span
                      >
                    </label>
                    ${h?l`<input class="used-part-qty" type="number" min=${je[0]} max=${je[1]} step="0.01"
                          .value=${this._usedQtyText[a]??String(o.quantity)}
                          @input=${p=>{let m=p.target.value;this._usedQtyText={...this._usedQtyText,[a]:m};let f=parseFloat(m.replace(",","."));Number.isFinite(f)&&f>=je[0]&&(this._usedParts={...this._usedParts,[a]:{...d,quantity:f}})}} />`:_}
                  </div>`})}
          ...
          ${this.restockDefault!==null?l`
              <label class="field">
                ...
                <input type="number" step="0.01" min=${nt[0]} max=${nt[1]} class="field-input"
        ...
        <div class="dialog-actions">
          ...
          <ha-button
            ...
            title=${this._missingRequired.length?this._missingRequired.map(i=>n("err_required",e).replace("{field}",n(rt[i]??i,e))).join(" \xB7 "):""}
          >
  ...
  `],c([v({attribute:!1})],k.prototype,"hass",2),c([v()],k.prototype,"entryId",2),c([v()],k.prototype,"taskId",2),c([v()],k.prototype,"taskName",2),c([v()],k.prototype,"lang",2),c([v({type:Array})],k.prototype,"checklist",2),c([v({type:Boolean})],k.prototype,"adaptiveEnabled",2),c([v()],k.prototype,"taskType",2),c([v()],k.prototype,"readingUnit",2),c([v({attribute:!1})],k.prototype,"readings",2),c([v({attribute:!1})],k.prototype,"readingHistory",2),c([v({attribute:!1})],k.prototype,"restockDefault",2),c([v({attribute:!1})],k.prototype,"restockUnitCost",2),c([v()],k.prototype,"currencySymbol",2),c([v({attribute:!1})],k.prototype,"parts",2),c([v({attribute:!1})],k.prototype,"consumesParts",2),c([v({type:Array})],k.prototype,"consumesInfo",2),c([v({type:Array})],k.prototype,"requiredFields",2),c([v()],k.prototype,"phaseLabel",2),c([v({type:Boolean})],k.prototype,"requireTagScan",2),c([v({type:Boolean})],k.prototype,"viaTagScan",2),c([u()],k.prototype,"_open",2),c([u()],k.prototype,"_notes",2),c([u()],k.prototype,"_cost",2),c([u()],k.prototype,"_duration",2),c([u()],k.prototype,"_loading",2),c([u()],k.prototype,"_error",2),c([u()],k.prototype,"_checklistState",2),c([u()],k.prototype,"_feedback",2),c([u()],k.prototype,"_readingValue",2),c([u()],k.prototype,"_readingValues",2),c([u()],k.prototype,"_restockQty",2),c([u()],k.prototype,"_completedAt",2),c([u()],k.prototype,"_usedParts",2),c([u()],k.prototype,"_usedQtyText",2),c([v({attribute:!1})],k.prototype,"checklistPrefill",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",k)});var V,ds=y(()=>{"use strict";C();U();A();V=class extends S{constructor(){super(...arguments);this._open=!1;this._title="";this._message="";this._confirmText="";this._danger=!1;this._inputLabel="";this._inputType="";this._options=null;this._inputValue="";this._resolve=null;this._promptResolve=null}confirm(e){return this._title=e.title,this._message=e.message,this._confirmText=e.confirmText||"OK",this._danger=e.danger||!1,this._inputLabel="",this._inputType="",this._options=null,this._inputValue="",this._open=!0,new Promise(t=>{this._resolve=t,this._promptResolve=null})}prompt(e){return this._title=e.title,this._message=e.message,this._confirmText=e.confirmText||"OK",this._danger=e.danger||!1,this._inputLabel=e.inputLabel||"",this._inputType=e.inputType||"text",this._options=e.options&&e.options.length?e.options:null,this._inputValue=e.inputValue||"",this._open=!0,new Promise(t=>{this._promptResolve=t,this._resolve=null})}_cancel(){this._open=!1,this._promptResolve&&(this._promptResolve({confirmed:!1,value:""}),this._promptResolve=null),this._resolve?.(!1),this._resolve=null}_confirmAction(){this._open=!1,this._promptResolve&&(this._promptResolve({confirmed:!0,value:this._inputValue}),this._promptResolve=null),this._resolve?.(!0),this._resolve=null}render(){if(!this._open)return _;let e=N(this.hass);return l`
  ...
  `],c([v({attribute:!1})],V.prototype,"hass",2),c([u()],V.prototype,"_open",2),c([u()],V.prototype,"_title",2),c([u()],V.prototype,"_message",2),c([u()],V.prototype,"_confirmText",2),c([u()],V.prototype,"_danger",2),c([u()],V.prototype,"_inputLabel",2),c([u()],V.prototype,"_inputType",2),c([u()],V.prototype,"_options",2),c([u()],V.prototype,"_inputValue",2);customElements.get("maintenance-confirm-dialog")||customElements.define("maintenance-confirm-dialog",V)});function na(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function ke(s,r){let e=na(),t=e.querySelector(`${ps}[${us}]`);return t||(t=document.createElement(ps),t.setAttribute(us,""),e.appendChild(t)),t.hass=s,t.confirm(r)}var ps,us,At=y(()=>{"use strict";ds();ps="maintenance-confirm-dialog",us="data-ms-lovelace-confirm"});function hs(s,r,e){let t=new Blob([s],{type:e}),i=URL.createObjectURL(t),a=document.createElement("a");a.href=i,a.download=r,a.target="_blank",a.rel="noopener",a.style.display="none",document.body.appendChild(a),a.dispatchEvent(new MouseEvent("click")),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(i),6e4)}var gi=y(()=>{"use strict"});async function aa(s,r,e=300){return(await s.connection.sendMessagePromise({type:"auth/sign_path",path:r,expires:e})).path}async function _s(s,r,e=300){return aa(s,`/api/maintenance_supporter/document/${r}`,e)}var ms=y(()=>{"use strict";gi()});var he,fi=y(()=>{"use strict";C();U();ms();he=class extends S{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{this._url=await _s(this.hass,this.docId)}catch{this._failed=!0}}render(){return this._failed||!this.docId?_:this._url?l`
      <a href=${this._url} target="_blank" rel="noopener" class="wrap">
        <img src=${this._url} alt="" loading="lazy"
          @error=${()=>this._failed=!0} />
      </a>`:l`<div class="ph"></div>`}};he.styles=E`
        ...
        <div class="row">
          ...
          <label>
            ...
            <input type="number" min="0" step="1" inputmode="numeric"
              ...
              @input=${a=>{this._set("duration",He(a.target.value))}} />
          </label>
        </div>
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),a.document.close()}_downloadSvg(e,t){let i=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),a=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;hs(i,`qr-${oa(a)}-${t}.svg`,"image/svg+xml")}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return l``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${n("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${n("qr_code",e)}: ${this._objectName}`,i=!!this._viewResult;return l`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
  ...
  `,c([v({attribute:!1})],Q.prototype,"hass",2),c([v()],Q.prototype,"lang",2),c([u()],Q.prototype,"_open",2),c([u()],Q.prototype,"_loading",2),c([u()],Q.prototype,"_error",2),c([u()],Q.prototype,"_viewResult",2),c([u()],Q.prototype,"_completeResult",2),c([u()],Q.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",Q)});function la(s,r){if(r<=0)return 0;let e=typeof s=="number"&&Number.isFinite(s)?Math.trunc(s):0;return e<0?0:e%r}function ca(s){return!!(s?.phases&&s.phase_sequence&&s.phase_sequence.length>0)}function vi(s){if(!s||!ca(s))return null;let r=s.phase_sequence,e=la(s.phase_cursor,r.length),t=r[e],i=s.phases?.[t];return i?{id:t,name:i.name,index:e,count:r.length,notes:i.notes,checklist:i.checklist!==void 0?i.checklist:s.checklist??[],consumesParts:i.consumes_parts!==void 0?i.consumes_parts:s.consumes_parts??[],requiredFields:i.required_completion_fields!==void 0?i.required_completion_fields:s.required_completion_fields??[]}:null}function at(s){let r=vi(s);return r?`${r.index+1}/${r.count} \xB7 ${r.name}`:""}var yi=y(()=>{"use strict"});function ys(s){let r=s.task??null,e=r?vi(r):null,t=e?e.consumesParts:r?.consumes_parts||[],i=!!r?.part_ref,a=s.objects.find(m=>m.entry_id===s.entryId)?.parts||[],o=i?a.find(m=>m.id===r.part_ref.part_id):void 0,h=s.features?s.features.checklists:s.checklistsEnabled??!0,d=s.features?s.features.checklists?s.checklist??r?.checklist??[]:[]:s.checklist??[],p=s.features?s.features.adaptive&&(s.adaptiveEnabled??!!r?.adaptive_config?.enabled):!!s.adaptiveEnabled;return{entry_id:s.entryId,task_id:s.taskId,task_name:s.taskName,checklist:e?h?e.checklist:[]:d,adaptive_enabled:p,required_completion_fields:e?e.requiredFields:r?.required_completion_fields||[],task_type:r?.type||"",reading_unit:r?.reading_unit||"",readings:r?.readings||[],reading_history:Rr(r?.history),parts:i?[]:Kr({consumes_parts:t},s.entryId,s.objects,s.lang),consumes_parts:i?[]:t,phase_label:e?at(r):"",require_tag_scan:!!r?.require_tag_scan,restock_default:i?o?.restock_quantity??1:null,restock_unit_cost:i?o?.cost??null:null,currency_symbol:we({currency_symbol:s.currencySymbol}),consumes_info:t.map(m=>Wr(m,s.entryId,s.objects,s.lang)),checklist_prefill:r?.checklist_progress||{},via_tag_scan:!!s.viaTagScan}}function bs(s,r,e){s.entryId=r.entry_id,s.taskId=r.task_id,s.taskName=r.task_name,s.lang=e,s.checklist=r.checklist??[],s.adaptiveEnabled=!!r.adaptive_enabled,s.requiredFields=r.required_completion_fields??[],s.taskType=r.task_type??"",s.readingUnit=r.reading_unit??"",s.readings=r.readings??[],s.readingHistory=r.reading_history??[],s.parts=r.parts??[],s.consumesParts=r.consumes_parts??[],s.phaseLabel=r.phase_label??"",s.requireTagScan=!!r.require_tag_scan,s.restockDefault=r.restock_default??null,s.restockUnitCost=r.restock_unit_cost??null,s.currencySymbol=we(r),s.consumesInfo=r.consumes_info??[],s.checklistPrefill=r.checklist_prefill??{},s.viaTagScan=!!r.via_tag_scan,s.open({viaTagScan:!!r.via_tag_scan})}var bi=y(()=>{"use strict";$e();$t();yi();A()});function da(s){return s&&xs(s.ref_no)?String(s.ref_no):null}function ws(s,r){let e=da(s);return e&&r&&xs(r.ref_no)?`${e}.${r.ref_no}`:null}function $s(s,r){return s?l`<span class="ref-chip" title=${r??""}>#${s}</span>`:_}var xs,xi=y(()=>{"use strict";C();xs=s=>typeof s=="number"&&Number.isInteger(s)&&s>0});var ks=y(()=>{"use strict"});function Es(s){let r=e=>{let t=e.timestamp??"",i=Date.parse(t.length===10?`${t}T00:00:00`:t);return Number.isNaN(i)?-1/0:i};return(s??[]).map((e,t)=>({entry:e,index:t,at:r(e)})).sort((e,t)=>t.at-e.at||t.index-e.index).map(e=>e.entry)}function ua(s,r){return s.taskRef&&r.ref_no?`${s.taskRef}-${r.ref_no}`:null}function ha(s,r){let e=bt(r);return e.length>0?l`<div class="history-photos">
        ${e.map(t=>l`<maintenance-history-photo .hass=${s} .docId=${t}></maintenance-history-photo>`)}
      </div>`:_}function _a(s,r){let e=r.lang,t=o=>P(o,e,{maximumFractionDigits:3}),i=o=>o==null?"":` (${o>=0?"+":""}${t(o)})`,a=pe(s);return a.length>0?l`<div class="history-readings">
    ...
    </span></div>`:_}function Ss(s,r,e={}){let t=r.lang,{compact:i=!1,showRef:a=!0,showBadges:o=!0,showEdit:h=!0}=e,d=h&&pa.includes(s.type);return l`
    <div class="history-entry${i?" compact":""}">
      ${i?_:l`<div class="history-icon ${s.type}">
            <ha-icon .icon=${Je[s.type]||"mdi:circle"}></ha-icon>
          </div>`}
      <div class="history-content">
        <div class="history-row">
          <strong>${n(s.type,t)}</strong>
          ${a?$s(ua(r,s),n("ref_number",t)):_}
          ${o&&s.phase_id?l`<span class="history-phase-badge">${r.phaseNames?.[s.phase_id]||s.phase_id}</span>`:_}
          ${o&&s.auto?l`<span class="history-auto-badge">${n("history_auto",t)}</span>`:_}
          ${d?l`<button class="history-edit-btn"
                     title=${n("history_edit_button",t)}
                     @click=${()=>r.openEdit(s)}>
                <ha-icon icon="mdi:pencil"></ha-icon>
              </button>`:_}
        </div>
        <div class="history-date">${wr(s.timestamp,t)}</div>
        ${s.notes?l`<div>${s.notes}</div>`:_}
        ${ha(r.hass,s)}
        ${_a(s,r)}
        ${s.cost!=null||s.duration!=null||s.trigger_value!=null?l`<div class="history-details">
              ${s.cost!=null?l`<span>${n("cost",t)}: ${de(s.cost,r.currencySymbol,t)}</span>`:_}
              ${s.duration!=null?l`<span>${n("duration",t)}: ${ft(s.duration,t)}</span>`:_}
              ${s.trigger_value!=null?l`<span>${n("trigger_val",t)}: ${s.trigger_value}</span>`:_}
            </div>`:_}
      </div>
    </div>
  `}var pa,Ts=y(()=>{"use strict";C();A();fi();xt();xi();$e();ks();pa=["completed","reset","skipped"]});function ot(s){return s.archived?"archived":s.is_done?"done":s.status||"ok"}function wi(s,r){return n(s==="done"?"completed":s,r)}function Ct(s){let r=ot(s);return r==="done"?ma:Jt[r]||"var(--disabled-color, #9e9e9e)"}function ga(s){return Je[s==="done"?"completed":s]||"mdi:circle-medium"}function As(s,r,e="pill"){let t=ot(s),i=wi(t,r);return e==="chip"?l`<span class="status-chip ${t}">${i}</span>`:l`<span class="status-badge ${t}" role="img" title="${i}" aria-label="${i}"><ha-icon icon="${ga(t)}"></ha-icon><span class="status-label">${i}</span></span>`}var ma,$i=y(()=>{"use strict";C();A();Zt();ma="var(--maint-done-color, #78909c)"});function It(s,r=Ee){return s?s.is_admin?!0:r.operatorWriteEnabled&&r.operatorIds.includes(s.id):!1}var Ee,Rt=y(()=>{"use strict";Ee={operatorWriteEnabled:!1,operatorIds:[]}});function fa(s){return{features:{...Pt.features,...s?.features??{}},defaultWarningDays:s?.general?.default_warning_days??Pt.defaultWarningDays,rowActionStyle:s?.general?.row_action_style??Pt.rowActionStyle,access:{operatorWriteEnabled:s?.operator_write_enabled===!0,operatorIds:Array.isArray(s?.admin_panel_user_ids)?s.admin_panel_user_ids.filter(r=>typeof r=="string"):[]},budget:s?.budget??null}}function Cs(){let s=window;return s.__msSettingsCache??={promise:null}}function _e(s){let r=Cs();if(r.promise)return r.promise;let e=s.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(t=>fa(t)).catch(()=>(r.promise===e&&(r.promise=null),Pt));return r.promise=e,e}function Is(){Cs().promise=null}var Pt,Lt=y(()=>{"use strict";Rt();Pt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact",access:Ee,budget:null}});var Nt,Rs=y(()=>{"use strict";Nt=class{constructor(){this._handle=null}schedule(r,e=4e3){this.clear(),this._handle=setTimeout(()=>{this._handle=null,r()},e)}clear(){this._handle!==null&&(clearTimeout(this._handle),this._handle=null)}get pending(){return this._handle!==null}}});function T(s){return s.toFixed(1)}var ki=y(()=>{"use strict";A()});function Ps(s,r){let e=s.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return _;let a=s.interval_days??0,o=s.suggested_interval??a;return l`
    <div class="weibull-section">
      ...
      ${ya(t,i,a,o,r)}
      ${ba(e,r)}
      ${e?.confidence_interval_low!=null?xa(e,s,r):_}
    </div>
  `}function va(s,r){let e,t,i;return s<.8?(e="early_failures",t="M13,14H11V10H13M13,18H11V16H13M1,21H23L12,2L1,21Z",i="beta_early_failures"):s<=1.2?(e="random_failures",t="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M13,17H11V15H13V17M13,13H11V7H13V13Z",i="beta_random_failures"):s<=3.5?(e="wear_out",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M12,6A6,6 0 0,1 18,12H12V6Z",i="beta_wear_out"):(e="highly_predictable",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M11,16.5L18,9.5L16.59,8.09L11,13.67L7.91,10.59L6.5,12L11,16.5Z",i="beta_highly_predictable"),l`
    <span class="beta-badge ${e}">
      <ha-svg-icon path="${t}"></ha-svg-icon>
      ${n(i,r)} (\u03B2=${P(s,r,2)})
    </span>
  `}function ya(s,r,e,t,i){let w=Math.max(e,t,r,1)*1.3,$=50,H=[];for(let j=0;j<=$;j++){let M=j/$*w,me=1-Math.exp(-Math.pow(M/r,s)),Me=32+M/w*260,ze=136-me*128;H.push([Me,ze])}let I=H.map(([j,M])=>`${T(j)},${T(M)}`).join(" "),F="M32,136 "+H.map(([j,M])=>`L${T(j)},${T(M)}`).join(" ")+` L${T(H[$][0])},136 Z`,D=32+e/w*260,B=1-Math.exp(-Math.pow(e/r,s)),le=136-B*128,x=P((1-B)*100,i,0),Z=32+t/w*260,Se=[0,.25,.5,.75,1];return l`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_weibull",i)}">
        ${Se.map(j=>{let M=136-j*128;return Ce`
            <line x1="${32}" y1="${T(M)}" x2="${292}" y2="${T(M)}"
              stroke="var(--divider-color)" stroke-width="0.5" stroke-dasharray="${j===.5?"4,3":_}" />
            <text x="${28}" y="${T(M+3)}" fill="var(--secondary-text-color)"
              font-size="8" text-anchor="end">${P(j*100,i,0)}%</text>
          `})}
        ...
        <polyline points="${I}" fill="none"
          stroke="var(--primary-color, #03a9f4)" stroke-width="2" />

        ${e>0?Ce`
          <line x1="${T(D)}" y1="${8}" x2="${T(D)}" y2="${T(136)}"
            stroke="var(--primary-color, #03a9f4)" stroke-width="1.5" stroke-dasharray="4,3" />
          <circle cx="${T(D)}" cy="${T(le)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${T(D+4)}" y="${T(le-6)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${x}%</text>
        `:_}

        ${t>0&&t!==e?Ce`
          <line x1="${T(Z)}" y1="${8}" x2="${T(Z)}" y2="${T(136)}"
    ...
    <div class="chart-legend">
      ...
      ${e>0?l`<span class="legend-item"><span class="legend-swatch" style="background:var(--primary-color, #03a9f4); opacity:0.5"></span> ${n("current_interval_marker",i)}</span>`:_}
      ${t>0&&t!==e?l`<span class="legend-item"><span class="legend-swatch" style="background:var(--success-color, #4caf50)"></span> ${n("recommended_marker",i)}</span>`:_}
    </div>
  `}function ba(s,r){return l`
  ...
  `}function xa(s,r,e){let t=s.confidence_interval_low,i=s.confidence_interval_high,a=r.suggested_interval??r.interval_days??0,o=r.interval_days??0,h=Math.max(0,t-5),p=i+5-h,m=(t-h)/p*100,f=(i-t)/p*100,b=(a-h)/p*100,w=o>0?(o-h)/p*100:-1;return l`
    <div class="confidence-range">
      ...
      <div class="confidence-bar">
        ...
        ${w>=0?l`<div class="confidence-marker current" style="left:${T(w)}%"></div>`:_}
      ...
      <div class="prediction-grid">
        ${t?l`
          <div class="prediction-item">
            ...
            ${s.degradation_rate!=null?l`<span class="prediction-rate">${s.degradation_rate>0?"+":""}${P(s.degradation_rate,r,Math.abs(s.degradation_rate)>=10?0:1)} ${s.trigger_entity_info?.unit_of_measurement||""}/${n("day_short",r)}</span>`:_}
          </div>
        `:_}
        ${i?l`
          <div class="prediction-item">
            ...
            ${s.threshold_prediction_date?l`<span class="prediction-date">${K(s.threshold_prediction_date,r)}</span>`:_}
            ${s.threshold_prediction_confidence?l`<span class="confidence-dot ${s.threshold_prediction_confidence}"></span>`:_}
            ${(s.prediction_cycles??0)>0?l`<span class="prediction-cycles">${n("prediction_cycles",r)}: ${s.prediction_cycles}</span>`:_}
          </div>
        `:_}
        ${a&&e.environmental?l`
          <div class="prediction-item">
            ...
            ${s.environmental_entity?l`<span class="prediction-entity entity-link" @click=${h=>Tr(h,s.environmental_entity)}>${s.environmental_entity}</span>`:_}
          </div>
        `:_}
      </div>
    </div>
  `}var Hs=y(()=>{"use strict";C();A()});function qs(s,r,e,t){let i=Math.max(s||1,r);return l`
  ...
  `}var js=y(()=>{"use strict";C();A()});function Ds(s,r,e){if(!e.seasonal||!s.seasonal_factor||s.seasonal_factor===1)return _;let t=Os.map(h=>n(h,r)),i=new Date().getMonth(),a=s.seasonal_factors||s.interval_analysis?.seasonal_factors||null,o=a&&a.length===12?a:t.map((h,d)=>{let p=s.seasonal_factor||1,m=Math.sin((d-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,p+m))});return l`
    <div class="seasonal-card-compact">
      <h4>${n("seasonal_awareness",r)}</h4>
      <div class="seasonal-mini-chart">
        ${o.map((h,d)=>{let p=h*40,m=h<.9?"low":h>1.1?"high":"normal";return l`
  ...
  `}function Ms(s,r){return wa(s,r)}function wa(s,r){let e=s.seasonal_factors??s.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return _;let t=s.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,o=100,h=8,p=o-h-4,m=Math.max(...e,1.5),f=a/12,b=f*.65,w=h+p-1/m*p;return l`
    <div class="seasonal-chart">
      <div class="seasonal-chart-title">
        ...
        ${t?l`<span class="source-tag">${t==="learned"?n("seasonal_learned",r):n("seasonal_manual",r)}</span>`:_}
      </div>
      <svg viewBox="0 0 ${a} ${o}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_seasonal",r)}">
        <line x1="0" y1="${T(w)}" x2="${a}" y2="${T(w)}"
          stroke="var(--divider-color)" stroke-width="1" stroke-dasharray="4,3" />
        ${e.map(($,H)=>{let I=$/m*p,F=H*f+(f-b)/2,D=h+p-I,B=H===i,le=$<1?"var(--success-color, #4caf50)":$>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return Ce`
            <rect x="${T(F)}" y="${T(D)}"
              width="${T(b)}" height="${T(I)}"
              fill="${le}" opacity="${B?1:.5}" rx="2" />
          `})}
      </svg>
      <div class="seasonal-labels">
        ${Os.map(($,H)=>l`<span class="seasonal-label ${H===i?"active-month":""}">${n($,r)}</span>`)}
      </div>
    </div>
  `}var Os,zs=y(()=>{"use strict";C();A();ki();Os=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var R,Fs=y(()=>{"use strict";C();U();A();ue();Qt();bi();yi();ri();$e();xi();Ts();$i();Lt();Rt();At();Rs();Ls();Hs();js();Ne();zs();R=class extends S{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._taskRef=null;this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._toastTimer=new Nt;this._access=Ee;this._currencySymbol=""}get _lang(){return N(this.hass)}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=be(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){let e=await _e(this.hass);this._features={...this._features,...e.features},this._access=e.access,this._currencySymbol=we(e.budget??void 0),gt(e.budget??void 0)}close(){this._open=!1,this._task=null,this._error="",this._toastTimer.clear(),this._toast=""}_showToast(e,t){this._toast=e,this._toastTimer.schedule(()=>{this._toast=""},t)}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(i=>i.id===this._taskId);this._task=t??null,this._taskRef=ws(e.object,t)}catch(e){this._error=q(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=q(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(te(),ne)).then(async({openCompleteDialog:e})=>{let t=this._task,i=[];try{i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}e(ys({entryId:this._entryId,taskId:this._taskId,taskName:t.name,task:t,objects:i,lang:this._lang,features:this._features,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(te(),ne)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(te(),ne)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId||!await ke(this.hass,{title:n("delete",this._lang),message:n("delete_task_confirm",this._lang),confirmText:n("delete",this._lang),danger:!0}))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._showToast(n("suggestion_applied",this._lang)),this._notifyChanged("apply_suggestion"),await this._loadTask())}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._showToast(e.recommended_interval?`${n("reanalyze_result",this._lang)}: ${Xe(e.recommended_interval,"days",this._lang)} (${e.data_points} pts)`:n("reanalyze_insufficient_data",this._lang)),await this._loadTask()}catch(e){this._error=q(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){if(!this._entryId||!this._taskId)return;let t=ii(this._entryId,this._taskId,e,this._task);Promise.resolve().then(()=>(te(),ne)).then(({openHistoryEditDialog:i})=>i(t))}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return _;let t=this._lang;return l`
      <div class="recommendation-card">
        <h4>${n("suggested_interval",t)}</h4>
        ${qs(e.interval_days,e.suggested_interval,e.interval_confidence||"medium",t)}
    ...
    `}_renderAdaptive(e){let t=this._lang,i=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,a=e.degradation_trend!=null&&e.degradation_trend!=="insufficient_data"||e.days_until_threshold!=null||e.environmental_factor!=null&&e.environmental_factor!==1,o=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,h=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1;return!i&&!a&&!o&&!h?l`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${a?Ns(e,t,this._features):_}
        ${o?Ps(e,t):_}
        ${h?l`
          ${Ds(e,t,this._features)}
          ${e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12?Ms(e,t):_}
        `:_}
      </div>
    `}_renderDetails(e){let t=this._lang,i=e.history||[],a=e.history_count??i.length,o=Es(i).slice(0,20);return l`
      <div class="details">
        <div class="stats-grid">
          ...
          <div class="stat">
            ...
            <span class="stat-value">${de(e.total_cost??0,this._currencySymbol,t)}</span>
          </div>
          <div class="stat">
            <span class="stat-label">${n("avg_duration",t)}</span>
            <span class="stat-value">${ft(e.average_duration!=null?Math.round(e.average_duration):null,t)}</span>
          </div>
        </div>
        ...
        ${i.length===0?l`<div class="history-empty">${n("history_empty",t)}</div>`:l`
              <div class="history-list">
                ${o.map(h=>Ss(h,{lang:t,hass:this.hass,currencySymbol:this._currencySymbol,openEdit:d=>this._onEditHistoryEntry(d),readingUnit:e.reading_unit,readingSlotDelta:(d,p)=>Lr(i,d,p),taskRef:this._taskRef},{compact:!0}))}
                ${a>o.length?l`<div class="history-more">… +${a-o.length} ${n("older_entries",t)}</div>`:_}
              </div>
            `}
      </div>
    `}render(){if(!this._open)return _;let e=this._lang,t=this._task,i=It(this.hass?.user,this._access);return l`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?l`
              <div class="header">
                <div class="title">
                  <span class="status-dot" style="background: ${Ct(t)}"></span>
                  <span class="task-name">${t.name}</span>
                  ${As(t,e)}
                </div>
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&Promise.resolve().then(()=>(te(),ne)).then(({openObjectQuickActions:a})=>{a(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${t.next_due?l`<span><strong>${n("next_due",e)}:</strong> ${K(t.next_due,e)}</span>`:_}
                  ${t.last_performed?l`<span><strong>${n("last_performed",e)}:</strong> ${K(t.last_performed,e)}</span>`:_}
                  ${t.schedule?.kind&&!["manual","one_time"].includes(t.schedule.kind)||t.interval_days!=null?l`<span><strong>${n("interval",e)}:</strong> ${Sr(t,e)}</span>`:_}
                  ${at(t)?l`<span><strong>${n("phase_current",e)}:</strong> ${at(t)}</span>`:_}
                </div>
              </div>
  ...
  `],c([v({attribute:!1})],R.prototype,"hass",2),c([u()],R.prototype,"_open",2),c([u()],R.prototype,"_entryId",2),c([u()],R.prototype,"_taskId",2),c([u()],R.prototype,"_task",2),c([u()],R.prototype,"_objectName",2),c([u()],R.prototype,"_taskRef",2),c([u()],R.prototype,"_busy",2),c([u()],R.prototype,"_error",2),c([u()],R.prototype,"_showSkip",2),c([u()],R.prototype,"_showReset",2),c([u()],R.prototype,"_showDetails",2),c([u()],R.prototype,"_showAdaptive",2),c([u()],R.prototype,"_skipReason",2),c([u()],R.prototype,"_resetDate",2),c([u()],R.prototype,"_features",2),c([u()],R.prototype,"_toast",2),c([u()],R.prototype,"_access",2);customElements.get("maintenance-task-quick-actions-dialog")||customElements.define("maintenance-task-quick-actions-dialog",R)});function Us(s){return!!s&&/^https?:\/\//i.test(s)}var Bs=y(()=>{"use strict"});function Vs(s){return s?customElements.get("ha-markdown")?l`<ha-markdown class="notes-md" .content=${s} breaks></ha-markdown>`:l`${s}`:_}var Ws=y(()=>{"use strict";C()});var J,Ks=y(()=>{"use strict";C();Bs();Ws();U();A();ue();$i();Lt();Rt();At();J=class extends S{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._data=null;this._busy=!1;this._error="";this._access=Ee}get _lang(){return N(this.hass)}async openFor(e){this._entryId=e,this._error="",this._open=!0,await Promise.all([this._load(),_e(this.hass).then(t=>{this._access=t.access})])}close(){this._open=!1,this._data=null,this._error=""}async _load(){if(this._entryId)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._data=e}catch(e){this._error=q(e,this._lang)}}_onEditObject(){!this._entryId||!this._data||Promise.resolve().then(()=>(te(),ne)).then(({openEditObjectDialog:e})=>{e(this._entryId,this._data.object),this.close()})}_onAddTask(){this._entryId&&Promise.resolve().then(()=>(te(),ne)).then(({openCreateTaskDialog:e})=>{e(this._entryId),this.close()})}async _onDelete(){if(!(!this._entryId||!this._data||!await ke(this.hass,{title:n("delete",this._lang),message:n("delete_object_confirm",this._lang),confirmText:n("delete",this._lang),danger:!0}))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object/delete",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-deleted",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=q(t,this._lang)}finally{this._busy=!1}}}async _onArchiveObject(){if(!this._entryId||!this._data)return;let e=!!this._data.object.archived;if(!(!e&&!await ke(this.hass,{title:n("archive_object",this._lang),message:n("confirm_archive_object",this._lang),confirmText:n("archive_object",this._lang)}))){this._busy=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:e?"maintenance_supporter/object/unarchive":"maintenance_supporter/object/archive",entry_id:this._entryId}),this.dispatchEvent(new CustomEvent("object-changed",{detail:{entry_id:this._entryId},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=q(t,this._lang)}finally{this._busy=!1}}}_onTaskClick(e){this._entryId&&Promise.resolve().then(()=>(te(),ne)).then(({openTaskQuickActions:t})=>{t(this._entryId,e)})}render(){if(!this._open)return _;let e=this._lang,t=this._data,i=t?.object,a=t?.tasks||[],o=It(this.hass?.user,this._access);return l`
      <div class="backdrop" @click=${this.close}></div>
      <div class="dialog" role="dialog" aria-modal="true">
        ${t&&i?l`
              <div class="header">
                      ...
                      <div class="task-list">
                        ${a.map(h=>l`
                          <div class="task-row" @click=${()=>this._onTaskClick(h.id)}>
                            <span class="status-dot" style="background: ${Ct(h)}"></span>
                            <span class="task-name">${h.name}</span>
                            <span class="task-status ${ot(h)}">${wi(ot(h),e)}</span>
                          </div>
                        `)}
                      </div>
                    `}
              ...
              ${i.notes?l`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${Vs(i.notes)}</div>
                    </div>
                  `:_}
  ...
  `,c([v({attribute:!1})],J.prototype,"hass",2),c([u()],J.prototype,"_open",2),c([u()],J.prototype,"_entryId",2),c([u()],J.prototype,"_data",2),c([u()],J.prototype,"_busy",2),c([u()],J.prototype,"_error",2),c([u()],J.prototype,"_access",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",J)});var ne={};Xs(ne,{__resetSettingsCacheForTests:()=>Ia,getRowActionStyle:()=>Ca,openCompleteDialog:()=>Ha,openCreateObjectDialog:()=>Ra,openCreateTaskDialog:()=>La,openEditObjectDialog:()=>Pa,openEditTaskDialog:()=>Na,openHistoryEditDialog:()=>Ei,openObjectQuickActions:()=>ja,openQrDialog:()=>qa,openTaskQuickActions:()=>Si});function Ht(){return document.querySelector("home-assistant")?.hass}function Aa(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function ae(s){let r=Aa(),e=r.querySelector(s)??document.body.querySelector(s);return e?e.parentNode!==r&&r.appendChild(e):(e=document.createElement(s),r.appendChild(e)),e}function oe(s){let r=Ht();if(!r)return!1;s.hass=r;let e=N(r);return tt(e)||it(e).then(()=>{s.requestUpdate?.()}),ei(r.locale,r.config?.country),!0}function Ca(s){return _e(s).then(r=>r.rowActionStyle)}function Ia(){Is()}function Ra(){let s=ae(Ys);return oe(s)?(s.openCreate(),!0):!1}function Pa(s,r){let e=ae(Ys);return oe(e)?(e.openEdit(s,r),!0):!1}function La(s="",r){let e=ae(Gs);if(!oe(e))return!1;let t=Ht();return t?((async()=>{let i=await _e(t),a=e;a.checklistsEnabled=i.features.checklists,a.scheduleTimeEnabled=i.features.schedule_time,a.completionActionsEnabled=i.features.completion_actions,a.defaultWarningDays=i.defaultWarningDays,a.openCreate(s,r)})(),!0):!1}function Na(s,r){let e=ae(Gs);if(!oe(e))return!1;let t=Ht();return t?((async()=>{try{let[i,a]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:s}),_e(t)]),o=(i.tasks||[]).find(d=>d.id===r);if(!o){console.warn(`openEditTaskDialog: task ${r} not found in entry ${s}`);return}let h=e;h.checklistsEnabled=a.features.checklists,h.scheduleTimeEnabled=a.features.schedule_time,h.completionActionsEnabled=a.features.completion_actions,h.defaultWarningDays=a.defaultWarningDays,await h.openEdit(s,o)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function Ei(s){let r=ae($a);return oe(r)?(r.openEdit(s),!0):!1}function Ha(s){let r=ae(ka);return oe(r)?(bs(r,s,N(Ht())),!0):!1}function qa(s){let r=ae(Ea);return oe(r)?(r.openForTask(s.entry_id,s.task_id,s.object_name,s.task_name),!0):!1}function Si(s,r){let e=ae(Sa);return oe(e)?(e.openFor(s,r),!0):!1}function ja(s){let r=ae(Ta);return oe(r)?(r.openFor(s),!0):!1}var Ys,Gs,$a,ka,Ea,Sa,Ta,te=y(()=>{"use strict";Mr();ts();cs();gs();vs();Fs();Ks();A();bi();Lt();Ys="maintenance-object-dialog",Gs="maintenance-task-dialog",$a="maintenance-history-edit-dialog",ka="maintenance-complete-dialog",Ea="maintenance-qr-dialog",Sa="maintenance-task-quick-actions-dialog",Ta="maintenance-object-quick-actions-dialog"});C();U();Qt();C();var dr=E`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;A();function Ar(s){let r=window;r.customCards=r.customCards||[],r.customCards.some(e=>e.type===s.type)||r.customCards.push(s)}ri();te();var W=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._pastHistory={};this._pastHistorySig="";this._pastSeq=0;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){if(this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter),typeof e.object_filter=="string")this._objectFilter=e.object_filter,this._configuredObjects=[];else if(Array.isArray(e.object_filter)){let t=e.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=t.length===1?t[0]:"",this._configuredObjects=t.length>1?t:[]}}getCardSize(){return 6}get _lang(){return N(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){if(super.updated(e),gr(this,e),this.hass&&this._pastDays>0&&(e.has("_objects")||e.has("_pastDays"))&&this._loadPastHistories(),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t,gt(this._stats.budget)}catch{}}async _loadPastHistories(){let e=new Date;e.setHours(0,0,0,0);let t=or(this._objects,e,this._pastDays||30),i=t.map(h=>h.sig).join("|");if(i===this._pastHistorySig)return;this._pastHistorySig=i;let a=++this._pastSeq,o=await Promise.all(t.map(async h=>{try{let d=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/history",entry_id:h.entryId,task_id:h.taskId});return[h.key,d.history??[]]}catch{return null}}));a===this._pastSeq&&(this._pastHistory=Object.fromEntries(o.filter(h=>h!==null)))}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}_onEventClick(e){if(e.history_timestamp){this._openHistoryEntry(e);return}Si(e.entry_id,e.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(e){try{let t=await qr(this.hass,e.entry_id,e.task_id,e.history_timestamp);if(!t||Ei(t))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return _;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,o=null;this._userFilter&&(o=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let h=x=>{let Z=x.toLowerCase();return this._objects.find(j=>j.entry_id===x||j.object.name.toLowerCase()===Z)?.entry_id??null},d=new Set(this._configuredObjects.map(h).filter(x=>x!==null)),p=d.size?this._objects.filter(x=>d.has(x.entry_id)):this._objects,m=this._config.show_object_filter!==!1&&p.length>1,f=this._objectFilter?h(this._objectFilter):null,b=f&&p.some(x=>x.entry_id===f)?p.filter(x=>x.entry_id===f):p,w=new Date;w.setHours(0,0,0,0);let $=this._pastDays>0,H=$?cr(b,w,this._pastDays,o,this._pastHistory):nr(b,w,this._windowDays,o),I=be(w),F=this._windowDays===365||$,D=F?H.filter(x=>x.events.length>0):H,B=x=>{let Z=`cal-status-${x.status}`,Se=x.projected?"cal-event-projected":"",j=x.status==="overdue"&&x.days_until_due!=null?` (${$r(x.days_until_due,e)})`:"",M=x.projected&&x.interval_days?l`<span class="cal-event-recur">${x.interval_unit&&x.interval_unit!=="days"?`${x.interval_days} ${n("unit_"+x.interval_unit,e)}`:x.interval_days===1?n("cal_every_day",e):n("cal_every_n_days",e).replace("{n}",String(x.interval_days))}</span>`:_,me=x.schedule_type==="sensor_based",Me=me?l`<ha-icon class="cal-event-icon cal-source-sensor"
                title="${n("cal_source_sensor",e)}" icon="mdi:trending-up"></ha-icon>`:l`<ha-icon class="cal-event-icon cal-source-time"
                title="${x.adaptive_enabled?n("cal_source_time_adaptive",e):n("cal_source_time",e)}"
                icon="${x.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,ze=me&&x.prediction_confidence&&x.status!=="triggered"&&!x.projected?l`<span class="cal-event-prediction cal-conf-${x.prediction_confidence}">
            ${n("cal_predicted",e)} · ${n(`cal_confidence_${x.prediction_confidence}`,e)}
          </span>`:_,Qs=we(this._stats?.budget),Js=x.history_type?n(x.history_type,e):n(x.status,e);return l`
        <div class="cal-event ${Se}"
          @click=${()=>this._onEventClick(x)}>
          ${Me}
          <span class="cal-status-pill ${Z}">${Js}</span>
          <div class="cal-event-body">
            <div class="cal-event-title">${x.object_name} · ${x.task_name}${j}</div>
            ${ze}
            ${M}
          </div>
          ${x.avg_cost!=null&&x.avg_cost>0?l`<span class="cal-event-cost">${de(x.avg_cost,Qs,e)}</span>`:_}
        </div>
      `},le=x=>{let[Z,Se,j]=x.date.split("-").map(Number),M=new Date(Z,Se-1,j),me=x.date===I,Me=kr(M,e,"short"),ze=Er(M,e,"long");return l`
        <div class="cal-day-row">
          <div class="cal-day-pill ${me?"cal-today":""}">
            <span class="cal-pill-weekday">${Me}</span>
            <span class="cal-pill-day">${M.getDate()}</span>
          </div>
          <div class="cal-day-content">
            <div class="cal-day-header">
              <span class="cal-day-month">${ze}</span>
              ${me?l`<span class="cal-day-today-badge">${n("today",e)}</span>`:_}
            </div>
            ${x.events.length===0?l`<div class="cal-empty">${n("cal_no_events",e)}</div>`:x.events.map(B)}
          </div>
        </div>
      `};return l`
      <ha-card .header=${a}>
              ...
              <div class="cal-controls">
                ...
                ${m?l`
                      <select class="cal-user-filter"
                        ...
                        ${[...p].sort((x,Z)=>x.object.name.localeCompare(Z.object.name)).map(x=>l`<option value=${x.entry_id} ?selected=${x.entry_id===f}>${x.object.name}</option>`)}
                      </select>
                    `:_}
              </div>
            `:_}
        <div class="cal-rolling">
          ${D.length===0&&F?l`<div class="cal-empty">${n("cal_no_events",e)}</div>`:D.map(le)}
        </div>
      </ha-card>
    `}};W.styles=[yt,dr,E`
      :host { display: block; }
      ha-card { padding: 0; overflow: hidden; }
    `],c([v({attribute:!1})],W.prototype,"hass",2),c([u()],W.prototype,"_config",2),c([u()],W.prototype,"_objects",2),c([u()],W.prototype,"_stats",2),c([u()],W.prototype,"_windowDays",2),c([u()],W.prototype,"_pastDays",2),c([u()],W.prototype,"_userFilter",2),c([u()],W.prototype,"_objectFilter",2),c([u()],W.prototype,"_unsub",2),c([u()],W.prototype,"_pastHistory",2);var Oa=[{value:7,key:"cal_editor_window_week"},{value:14,key:"cal_editor_window_fortnight"},{value:30,key:"cal_editor_window_month"},{value:365,key:"cal_editor_window_year"}],De=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}get _lang(){return N(this.hass)}setConfig(e){this._config={...e}}updated(){let e=this._lang;e&&!tt(e)&&it(e).then(()=>this.requestUpdate())}_valueChanged(e,t){let i={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete i.show_window_chips,e==="show_user_filter"&&t===!0&&delete i.show_user_filter,e==="show_object_filter"&&t===!0&&delete i.show_object_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete i.title,e==="user_filter"&&t===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let e=this._lang,t=this._config.window_days??30,i=this._config.show_window_chips!==!1,a=this._config.show_user_filter!==!1,o=this._config.user_filter??"",h=this._config.title??"";return l`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${Oa.map(d=>l`<option value="${d.value}" ?selected=${d.value===t}>${n(d.key,e)}</option>`)}
          </select>
        </div>
  ...
  `,c([v({attribute:!1})],De.prototype,"hass",2),c([u()],De.prototype,"_config",2);customElements.get("maintenance-supporter-calendar-card")||customElements.define("maintenance-supporter-calendar-card",W);customElements.get("maintenance-supporter-calendar-card-editor")||customElements.define("maintenance-supporter-calendar-card-editor",De);Ar({type:"maintenance-supporter-calendar-card",name:"Maintenance Supporter \u2014 Calendar",description:"Rolling calendar of maintenance tasks with 7/14/30/365 day windows, source icons, and prediction-confidence pills.",preview:!0});export{W as MaintenanceCalendarCard};
