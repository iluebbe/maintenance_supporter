...
<script>setTimeout(()=>window.print(),300)<\/script>
  ...
  `}function Hr(a,r,e){let t=a.confidence_interval_low,i=a.confidence_interval_high,n=r.suggested_interval??r.interval_days??0,o=r.interval_days??0,p=Math.max(0,t-5),_=i+5-p,f=(t-p)/_*100,m=(i-t)/_*100,y=(n-p)/_*100,b=o>0?(o-p)/_*100:-1;return l`
  ...
  `}function Ri(a,r){return qr(a,r)}function qr(a,r){let e=a.seasonal_factors??a.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return h;let t=a.interval_analysis?.seasonal_reason,i=new Date().getMonth(),n=300,o=100,p=8,_=o-p-4,f=Math.max(...e,1.5),m=n/12,y=m*.65,b=p+_-1/f*_;return l`
