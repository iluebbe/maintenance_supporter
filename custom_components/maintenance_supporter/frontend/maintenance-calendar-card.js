        ...
        <div class="cal-day-row">
          ...
          <div class="cal-day-content">
            <div class="cal-day-header">
              ...
              ${U?f`<span class="cal-day-today-badge">${m("today",t)}</span>`:g}
            </div>
            ${i.events.length===0?f`<div class="cal-empty">${m("cal_no_events",t)}</div>`:i.events.map(N)}
          </div>
        </div>
      `};return f`
      <ha-card .header=${n}>
              ...
              <div class="cal-controls">
                ...
                ${l?f`
                      <select class="cal-user-filter"
                        ...
                        <option value="">${m("all_objects",t)}</option>
                        ${[...this._objects].sort((i,R)=>i.object.name.localeCompare(R.object.name)).map(i=>f`<option value=${i.entry_id} ?selected=${i.entry_id===c}>${i.object.name}</option>`)}
                      </select>
                    `:g}
              </div>
            `:g}
        <div class="cal-rolling">
          ${y.length===0&&b?f`<div class="cal-empty">${m("cal_no_events",t)}</div>`:y.map(J)}
        </div>
      </ha-card>
    `}};v.styles=[et,We,k`
      :host { display: block; }
      ha-card { padding: 0; overflow: hidden; }
    `],x([V({attribute:!1})],v.prototype,"hass",2),x([w()],v.prototype,"_config",2),x([w()],v.prototype,"_objects",2),x([w()],v.prototype,"_stats",2),x([w()],v.prototype,"_windowDays",2),x([w()],v.prototype,"_pastDays",2),x([w()],v.prototype,"_userFilter",2),x([w()],v.prototype,"_objectFilter",2),x([w()],v.prototype,"_unsub",2);var Dt=[{value:7,label:"Week (7 days)"},{value:14,label:"Fortnight (14 days)"},{value:30,label:"Month (30 days, default)"},{value:365,label:"Year (365 days, empty days collapsed)"}],O=class extends ${constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}setConfig(t){this._config={...t}}_valueChanged(t,o){let r={...this._config,[t]:o};t==="show_window_chips"&&o===!0&&delete r.show_window_chips,t==="show_user_filter"&&o===!0&&delete r.show_user_filter,t==="show_object_filter"&&o===!0&&delete r.show_object_filter,t==="title"&&(!o||typeof o=="string"&&o.trim()==="")&&delete r.title,t==="user_filter"&&o===""&&delete r.user_filter,this._config=r,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:r},bubbles:!0,composed:!0}))}render(){let t=this._config.window_days??30,o=this._config.show_window_chips!==!1,r=this._config.show_user_filter!==!1,n=this._config.user_filter??"",s=this._config.title??"";return f`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${Dt.map(l=>f`<option value="${l.value}" ?selected=${l.value===t}>${l.label}</option>`)}
          </select>
        </div>
