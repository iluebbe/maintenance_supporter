...
`});function Ge(s){if(!s)return[];let r=[],e=s.photo_doc_id;typeof e=="string"&&r.push(e);let t=s.photo_doc_ids;Array.isArray(t)&&r.push(...t);let i=[];for(let a of r){if(typeof a!="string")continue;let o=a.trim();if(!(!o||i.includes(o))&&(i.push(o),i.length>=10))break}return i}var dt=w(()=>{"use strict"});function er(){let s=new Uint8Array(4);return(globalThis.crypto??{getRandomValues:r=>r.map(()=>Math.floor(Math.random()*256))}).getRandomValues(s),Array.from(s,r=>r.toString(16).padStart(2,"0")).join("")}function ie(s){let r=s?.reading_values;if(!Array.isArray(r))return[];let e=[],t=new Set;for(let i of r){if(!i||typeof i!="object")continue;let a=i;typeof a.id!="string"||!a.id||t.has(a.id)||typeof a.value!="number"||!Number.isFinite(a.value)||(t.add(a.id),e.push({id:a.id,name:typeof a.name=="string"?a.name:a.id,unit:typeof a.unit=="string"?a.unit:null,value:a.value}))}return e}function tr(s){return s.filter(r=>r.type==="completed"&&(r.reading_value!=null||ie(r).length>0)).sort((r,e)=>r.timestamp.localeCompare(e.timestamp))}function ir(s){return tr(s??[]).map(r=>({timestamp:r.timestamp,values:ie(r)})).filter(r=>r.values.length>0)}function rr(s,r,e){let t;for(let i of s){if(e!==void 0){let o=new Date(i.timestamp).getTime();if(!isNaN(o)&&o>=e)break}let a=i.values.find(o=>o.id===r);a&&(t=a)}return t}function sr(s,r,e){let t=ie(r).find(a=>a.id===e);if(!t)return null;let i=null;for(let a of tr(s)){if(a.timestamp>=r.timestamp)break;let o=ie(a).find(p=>p.id===e);o&&(i=o.value)}return i==null?null:t.value-i}function nr(s){let r=new Set,e=new Set;for(let t of s){let i=(t.name||"").trim().toLowerCase();i&&(r.has(i)?e.add(t.id):r.add(i))}return e}function ar(s){let r=[],e=new Set,t=new Set;for(let i of s){let a=(i.name||"").trim();if(!(!a||e.has(i.id)||t.has(a.toLowerCase()))&&(e.add(i.id),t.add(a.toLowerCase()),r.push({id:i.id,name:a,unit:(i.unit||"").trim()||null}),r.length>=20))break}return r}var Se=w(()=>{"use strict"});function qs(s,r){let e=Ns[s];if(!e)return s;let t=n(e,r);return t&&t!==e?t:s}function js(s){let e=s.match(/data\['([^']+)'\]/)?.[1],t;return(t=s.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=s.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=s.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=s.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(s)?{field:e,rule:"required"}:(t=s.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(s)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(s)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function q(s,r,e){if(e=e??n("action_error",r),typeof s=="string")return s;if(typeof s!="object"||s===null)return e;let t=s,i=t.message||t.error?.message||"";if(!i)return e;let a=js(i),o=a.field?qs(a.field,r):"",p=c=>n(c,r).replace("{field}",o).replace("{n}",a.param??"");switch(a.rule){case"too_long":return p("err_too_long");case"too_short":return p("err_too_short");case"value_too_high":return p("err_value_too_high");case"value_too_low":return p("err_value_too_low");case"required":return p("err_required");case"wrong_type":return p("err_wrong_type").replace("{type}",a.param??"");case"invalid_choice":return p("err_invalid_choice");case"invalid_value":return p("err_invalid_value");default:return i||e}}var Ns,fe=w(()=>{"use strict";L();Ns={entry_id:"object",name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",warranty_expiry:"warranty_expiry_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_equals:"trigger_equals",trigger_not_equals:"trigger_not_equals",trigger_for_minutes:"trigger_for_minutes"}});var j,qt=w(()=>{"use strict";C();B();j=class extends S{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return l`
      <label class="field">
  ...
  `,d([y()],j.prototype,"label",2),d([y()],j.prototype,"value",2),d([y()],j.prototype,"placeholder",2),d([y()],j.prototype,"type",2),d([y({type:Boolean})],j.prototype,"required",2),d([y({type:Boolean})],j.prototype,"disabled",2),d([y()],j.prototype,"step",2),d([y()],j.prototype,"min",2),d([y()],j.prototype,"max",2),d([y()],j.prototype,"pattern",2),d([y()],j.prototype,"helper",2),d([y({type:Boolean})],j.prototype,"multiline",2),d([y({type:Number})],j.prototype,"rows",2);customElements.get("ms-textfield")||customElements.define("ms-textfield",j)});function Hs(s){let e=V("2001-02-03",s).match(/\d+/g)||[],t=p=>e.findIndex(c=>Number(c)===p),i=t(2001),a=t(2),o=t(3);return i===0?"YMD":a>=0&&o>=0&&a<o?"MDY":"DMY"}function Ae(s,r,e){if(s<1e3||s>9999||r<1||r>12||e<1||e>31)return null;let t=new Date(s,r-1,e);return t.getFullYear()!==s||t.getMonth()!==r-1||t.getDate()!==e?null:`${s}-${String(r).padStart(2,"0")}-${String(e).padStart(2,"0")}`}function or(s,r){let e=s.trim(),t;if(t=e.match(/^(\d{4})-(\d{1,2})-(\d{1,2})$/))return Ae(+t[1],+t[2],+t[3]);if(t=e.match(/^(\d{4})$/))return Ae(+t[1],1,1);if(t=e.match(/^(\d{1,2})[./](\d{4})$/))return Ae(+t[2],+t[1],1);if(t=e.match(/^(\d{1,2})\.(\d{1,2})\.(\d{4})$/))return Ae(+t[3],+t[2],+t[1]);if(t=e.match(/^(\d{1,2})[/-](\d{1,2})[/-](\d{4})$/)){let i=+t[1],a=+t[2],o=+t[3];return Hs(r)==="MDY"?Ae(o,i,a):Ae(o,a,i)}return null}var lr=w(()=>{"use strict";L()});function Os(s,r){if(r)switch(s){case"date":return r.split("T")[0];case"time":return r.length===5?`${r}:00`:r;case"datetime":{let[e,t="00:00:00"]=r.split("T");return`${e} ${t.length===5?`${t}:00`:t}`}}}function Ds(s,r){if(typeof r!="string"||!r)return"";switch(s){case"date":return r.slice(0,10);case"time":return r.slice(0,5);case"datetime":{let[e,t="00:00:00"]=r.split(" ");return`${e}T${t.length===5?`${t}:00`:t}`}}}var D,Te=w(()=>{"use strict";C();B();L();lr();D=class extends S{constructor(){super(...arguments);this.kind="date";this.label="";this.value="";this.clearable=!1;this.disabled=!1;this.required=!1;this.lang="en";this._typing=!1;this._typed="";this._typedInvalid=!1}_startTyping(){this._typed=this.value,this._typedInvalid=!1,this._typing=!0,this.updateComplete.then(()=>this.shadowRoot?.querySelector("input.typed")?.focus())}_commitTyped(){if(!this._typed.trim()){this._typing=!1;return}let e=or(this._typed,this.lang);if(!e){this._typedInvalid=!0;return}this._typing=!1,this._typedInvalid=!1,this._emit(e)}_onTypedKey(e){e.key==="Enter"?(e.preventDefault(),this._commitTyped()):e.key==="Escape"&&(e.preventDefault(),this._typing=!1,this._typedInvalid=!1)}_selector(){switch(this.kind){case"date":return{date:{}};case"time":return{time:{no_second:!0}};case"datetime":return{datetime:{}}}}_onSelectorChange(e){e.stopPropagation(),this._emit(Ds(this.kind,e.detail?.value))}_clear(){this._emit("")}_emit(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{bubbles:!0,composed:!0,detail:{value:e}})))}render(){return l`
      <div class="field">
        ${this.label?l`<span class="label">${this.label}${this.required?l`<span class="req">*</span>`:_}</span>`:_}
        <div class="row">
          ${this._typing?l`<input class="typed" type="text" inputmode="numeric" autocomplete="off"
                .value=${this._typed}
                placeholder=${V("1978-03-15",this.lang)}
...
`),partId:H?.part_id||"",partQty:H?.quantity!=null?String(H.quantity):"",reqOverride:m.required_completion_fields!==void 0,reqFields:[...m.required_completion_fields||[]],extraParts:M.filter((Y,oe)=>oe!==F).map(Y=>({...Y})),carry:T}}),this._phaseSeq=[...t.phase_sequence||[]],this._requiredCompletion=[...t.required_completion_fields||[]],this._scheduleTime=t.schedule_time||"",this._scheduleTimeOn=!!t.schedule_time;let o=t.on_complete_action;if(o&&o.service){this._actionService=o.service;let h=o.target?.entity_id;this._actionTargetEntity=Array.isArray(h)?h[0]||"":h||"",this._actionData=o.data&&typeof o.data=="object"?{...o.data}:{},this._actionDataJsonFallback=""}else this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="";let p=t.quick_complete_defaults;this._qcNotes=p?.notes||"",this._qcCost=p?.cost!=null?String(p.cost):"",this._qcDuration=p?.duration!=null?String(p.duration):"",this._qcFeedback=p?.feedback||"";let c=t.adaptive_config||{};if(this._environmentalEntity=c.environmental_entity||"",this._environmentalAttribute=c.environmental_attribute||"",this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute,this._adaptiveEnabled=!!c.enabled,this._adaptiveAlpha=c.ewa_alpha?.toString()??re.alpha,this._adaptiveMin=c.min_interval_days?.toString()??re.min,this._adaptiveMax=c.max_interval_days?.toString()??re.max,this._adaptiveSeasonal=c.seasonal_enabled!==!1,this._adaptivePrediction=c.sensor_prediction_enabled!==!1,this._adaptiveInitial=this._adaptiveSnapshot(),t.trigger_config){let h=t.trigger_config;this._triggerEntityId=h.entity_id||h.entity_ids&&h.entity_ids[0]||"",this._triggerEntityIds=h.entity_ids||(h.entity_id?[h.entity_id]:[]),this._triggerEntityLogic=h.entity_logic||"any",this._triggerAttribute=h.attribute||"",this._triggerType=h.type||"threshold",this._triggerAbove=h.trigger_above?.toString()||"",this._triggerBelow=h.trigger_below?.toString()||"",this._triggerEquals=h.trigger_equals?.toString()||"",this._triggerNotEquals=h.trigger_not_equals?.toString()||"",this._triggerForMinutes=h.trigger_for_minutes?.toString()||"0",this._triggerCombinator=h.trigger_combinator==="all"?"all":"any",this._triggerTargetValue=h.trigger_target_value?.toString()||"",this._triggerDeltaMode=h.trigger_delta_mode||!1,this._triggerBaselineValue=h.trigger_baseline_value?.toString()||"",this._liveBaselineValue=t.trigger_baseline_value??null,this._autoCompleteOnRecovery=h.auto_complete_on_recovery||!1,this._triggerFromState=h.trigger_from_state||"",this._triggerToState=h.trigger_to_state||"",this._triggerTargetChanges=h.trigger_target_changes?.toString()||"",this._triggerRuntimeHours=h.trigger_runtime_hours?.toString()||"",this._triggerRuntimeMaxSession=h.trigger_runtime_max_session_seconds?.toString()||"",this._triggerOnStates=(h.trigger_on_states||[]).join(", "),h.type==="compound"?(this._compoundLogic=h.compound_logic==="OR"?"OR":"AND",this._compoundConditions=(h.conditions||[]).map(Gs)):(this._compoundLogic="AND",this._compoundConditions=[])}else this._resetTriggerFields();this._triggerEntityId&&this._fetchEntityAttributes(this._triggerEntityId),await Promise.all([this._loadUsers(),this._loadTags(),this._loadParts(),this._loadForeignPools()]),this._open=!0}_resetFields(){this._name="",this._type="custom",this._scheduleType="time_based",this._intervalDays="30",this._intervalUnit="days",this._dueDate="",this._warningDays=String(this.defaultWarningDays),this._earliestCompletionDays="",this._intervalAnchor="completion",this._weekdays=[],this._nth="1",this._nthWeekday="5",this._domDay="1",this._domLastDay=!1,this._domBusiness=!1,this._calOffset="0",this._seasonMonths=[],this._endsMode="never",this._endsCount="",this._endsUntil="",this._notes="",this._documentationUrl="",this._customIcon="",this._priority="normal",this._labels="",this._enabled=!0,this._lastPerformed="",this._nfcTagId="",this._requireTagScan=!1,this._allowSkip=!0,this._readingUnit="",this._readings=[],this._consumesParts={},this._responsibleUserId=null,this._assigneePool=[],this._rotationStrategy="",this._checklistText="",this._phaseDefs=[],this._phaseSeq=[],this._requiredCompletion=[],this._scheduleTime="",this._scheduleTimeOn=!1,this._environmentalEntity="",this._environmentalAttribute="",this._environmentalInitial="",this._environmentalAttributeInitial="",this._adaptiveEnabled=!1,this._adaptiveAlpha=re.alpha,this._adaptiveMin=re.min,this._adaptiveMax=re.max,this._adaptiveSeasonal=!0,this._adaptivePrediction=!0,this._adaptiveInitial=this._adaptiveSnapshot(),this._actionService="",this._actionTargetEntity="",this._actionData={},this._actionDataJsonFallback="",this._actionTesting=!1,this._actionTestResult="",this._qcNotes="",this._qcCost="",this._qcDuration="",this._qcFeedback="",this._resetTriggerFields()}_resetTriggerFields(){this._triggerEntityId="",this._triggerEntityIds=[],this._triggerEntityLogic="any",this._triggerAttribute="",this._suggestedAttributes=[],this._availableAttributes=[],this._entityDomain="",this._triggerType="threshold",this._triggerAbove="",this._triggerBelow="",this._triggerEquals="",this._triggerNotEquals="",this._triggerForMinutes="0",this._triggerCombinator="any",this._triggerTargetValue="",this._triggerDeltaMode=!1,this._triggerBaselineValue="",this._liveBaselineValue=null,this._autoCompleteOnRecovery=!1,this._triggerFromState="",this._triggerToState="",this._triggerTargetChanges="",this._triggerRuntimeHours="",this._triggerRuntimeMaxSession="",this._triggerOnStates="",this._compoundLogic="AND",this._compoundConditions=[]}async _loadUsers(){this._userService||(this._userService=new ct(this.hass));try{this._availableUsers=await this._userService.getUsers()}catch(e){console.error("Failed to load users:",e),this._availableUsers=[]}}_toggleAssignee(e){this._assigneePool=this._assigneePool.includes(e)?this._assigneePool.filter(t=>t!==e):[...this._assigneePool,e]}async _testAction(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e)){this._actionTestResult="error",this._actionTestError="Invalid service format (expected 'domain.service')",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3);return}let[t,i]=e.split(".");if(!this.hass?.services?.[t]?.[i]){this._actionTestResult="error",this._actionTestError=`Service "${e}" is not registered in Home Assistant. Check spelling and that the integration providing it is loaded.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}let a=this._actionTargetEntity.trim();if(a){let o=a.split(".")[0];if(o!==t&&!new Set(["homeassistant","scene","notify","persistent_notification"]).has(t)){this._actionTestResult="error",this._actionTestError=`Service "${e}" only works on ${t}.* entities; entity "${a}" is in ${o}.* \u2014 pick a service that matches the entity domain (e.g. ${o}.${i})`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}if(!this.hass.states?.[a]){this._actionTestResult="error",this._actionTestError=`Target entity "${a}" not found in Home Assistant \u2014 the entity may have been renamed or its integration removed.`,setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},8e3);return}}this._actionTestResult="ok",setTimeout(()=>{this._actionTestResult="",this._actionTestError=""},5e3)}_buildActionData(){if(this._actionDataJsonFallback.trim())try{let e=JSON.parse(this._actionDataJsonFallback);if(e&&typeof e=="object"&&!Array.isArray(e))return e}catch{}return{...this._actionData}}_serviceSchema(){let e=this._actionService.trim();if(!e||!/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(e))return null;let[t,i]=e.split("."),a=this.hass?.services?.[t]?.[i]?.fields;return!a||Object.keys(a).length===0?null:Object.entries(a).map(([o,p])=>({name:o,required:!!p.required,selector:p.selector||{text:{}}}))}_renderCompletionActionsSection(e){if(!this.completionActionsEnabled)return _;let t=this._serviceSchema();return l`
      <details class="ca-section">
        ...
        <ha-service-picker
          ...
          @value-changed=${i=>{this._actionService=i.detail.value||"";let a=this._serviceSchema();if(a){let o=new Set(a.map(p=>p.name));this._actionData=Object.fromEntries(Object.entries(this._actionData).filter(([p])=>o.has(p)))}}}
        ></ha-service-picker>
        <ha-form
          .hass=${this.hass}
      ...
      <div class="readings-editor">
        ...
        ${this._readings.length<20?l`
          <ha-button appearance="plain" class="reading-add"
            @click=${()=>this._readings=[...this._readings,{id:er(),name:"",unit:this._readings.length?this._readings[this._readings.length-1].unit:this._readingUnit}]}>
    ...
    `}_phaseSlug(e){let t=e.toLowerCase().replace(/[^a-z0-9_-]+/g,"-").replace(/^-+|-+$/g,"").slice(0,24)||"phase",i=t,a=2;for(;this._phaseDefs.some(o=>o.id===i);)i=`${t}-${a++}`;return i}_addPhaseDef(){let e=this._phaseSlug(`phase-${this._phaseDefs.length+1}`);this._phaseDefs=[...this._phaseDefs,{id:e,name:"",checklistText:"",partId:"",partQty:"",reqOverride:!1,reqFields:[],extraParts:[],carry:{}}]}_removePhaseDef(e){this._phaseDefs=this._phaseDefs.filter(t=>t.id!==e),this._phaseSeq=this._phaseSeq.filter(t=>t!==e)}_patchPhaseDef(e,t){this._phaseDefs=this._phaseDefs.map(i=>i.id===e?{...i,...t}:i)}_renderPhasesEditor(e){let t=i=>this._phaseDefs.find(a=>a.id===i)?.name||i;return l`
              ...
              ${Ht.map(a=>l`
                <label class="req-option">
                  <input
                    ...
                    @change=${o=>{let p=o.target.checked,c=new Set(i.reqFields);p?c.add(a):c.delete(a),this._patchPhaseDef(i.id,{reqFields:[...c]})}}
                  />
                  <span>${n(Qe[a],e)}</span>
                </label>
              `)}
        ...
        <div class="phase-seq">
          ${this._phaseSeq.map((i,a)=>l`
            <span class="phase-chip">
              ${a+1}. ${t(i)}
              <button class="phase-chip-x" @click=${()=>{this._phaseSeq=this._phaseSeq.filter((o,p)=>p!==a)}}>✕</button>
            </span>
          `)}
          <select
            class="phase-seq-add"
      ...
      `:_}
    `}async _save(){if(!this._loading&&this._name.trim()){if(this._adaptiveSnapshot()!==this._adaptiveInitial){let e=parseInt(this._adaptiveMin,10),t=parseInt(this._adaptiveMax,10);if(!isNaN(e)&&!isNaN(t)&&e>t){this._error=`${n("adaptive_min_interval",this._lang)} > ${n("adaptive_max_interval",this._lang)}`;return}}if(this._triggerType==="threshold"&&this._thresholdLimitsOverlap()){this._error=n("trigger_hint_overlap",this._lang);return}this._loading=!0,this._error="";try{let e={type:this._taskId?"maintenance_supporter/task/update":"maintenance_supporter/task/create",entry_id:this._entryId,name:this._name,task_type:this._type,schedule_type:this._scheduleType,warning_days:Number.isNaN(parseInt(this._warningDays,10))?this.defaultWarningDays:Math.max(0,parseInt(this._warningDays,10))},t=this._earliestCompletionDays.trim();e.earliest_completion_days=t===""?null:Math.max(0,parseInt(t,10)||0),this._taskId&&(e.task_id=this._taskId),this._scheduleType==="one_time"?(e.due_date=this._dueDate||null,e.interval_days=null):ht.includes(this._scheduleType)?(e.schedule={...this._buildSchedule(),...this._recurrenceExtras()},e.interval_days=null,this._taskId&&(e.due_date=null)):(this._taskId&&(e.due_date=null),this._scheduleType!=="manual"&&this._intervalDays?(e.interval_days=parseInt(this._intervalDays,10),e.interval_unit=this._intervalUnit,e.interval_anchor=this._intervalAnchor,this._scheduleType==="time_based"&&(e.schedule={kind:"interval",...this._recurrenceExtras()})):this._taskId&&(e.interval_days=null,e.interval_anchor="completion")),e.notes=this._notes||null,e.documentation_url=this._documentationUrl||null,e.custom_icon=this._customIcon||null,e.priority=this._priority,e.labels=this._labels.split(",").map(p=>p.trim()).filter(Boolean),e.enabled=this._enabled,e.last_performed=this._lastPerformed||null,e.nfc_tag_id=this._nfcTagId||null,e.require_tag_scan=this._requireTagScan,e.allow_skip=this._allowSkip,e.notify_enabled=this._notifyEnabled,e.reading_unit=this._readingUnit.trim()||null,e.readings=ar(this._readings);{let p={};for(let h of this._phaseDefs){if(!h.name.trim())continue;let m={...h.carry,name:h.name.trim()},f=h.checklistText.split(`
`).map(v=>v.trim()).filter(Boolean);f.length&&(m.checklist=f);let x=[];if(h.partId){let v=parseFloat(h.partQty);x.push({part_id:h.partId,quantity:Number.isFinite(v)&&v>0?v:1})}for(let v of h.extraParts)x.push(v.entry_id?{part_id:v.part_id,quantity:v.quantity,entry_id:v.entry_id}:{part_id:v.part_id,quantity:v.quantity});x.length&&(m.consumes_parts=x),h.reqOverride&&(m.required_completion_fields=[...h.reqFields]),p[h.id]=m}let c=this._phaseSeq.filter(h=>h in p);e.phases=Object.keys(p).length&&c.length?p:null,e.phase_sequence=e.phases?c:null}if((this.parts.length||this._foreignOwners.length)&&(e.consumes_parts=Object.values(this._consumesParts).map(p=>p.entry_id?{part_id:p.part_id,quantity:p.quantity,entry_id:p.entry_id}:{part_id:p.part_id,quantity:p.quantity})),e.responsible_user_id=this._responsibleUserId,e.assignee_pool=this._assigneePool,e.required_completion_fields=this._requiredCompletion,e.rotation_strategy=this._assigneePool.length>=2&&this._rotationStrategy?this._rotationStrategy:null,this._scheduleType==="sensor_based"&&this._triggerType==="compound"){let p=this._compoundConditions.map(Qs).filter(c=>c!==null);if(p.length>0){let c={type:"compound",compound_logic:this._compoundLogic,conditions:p};this._autoCompleteOnRecovery&&(c.auto_complete_on_recovery=!0),this._triggerCombinator==="all"&&(c.trigger_combinator="all"),e.trigger_config=c}else this._taskId&&(e.trigger_config=null)}else if(this._scheduleType==="sensor_based"&&this._triggerEntityId){let p=this._triggerEntityIds.length>0?this._triggerEntityIds:[this._triggerEntityId],c={entity_id:p[0],entity_ids:p,type:this._triggerType};if(this._triggerAttribute&&(c.attribute=this._triggerAttribute),this._autoCompleteOnRecovery&&(c.auto_complete_on_recovery=!0),this._triggerCombinator==="all"&&(c.trigger_combinator="all"),p.length>1&&(c.entity_logic=this._triggerEntityLogic),this._triggerType==="threshold"){if(this._triggerAbove){let h=parseFloat(this._triggerAbove);isNaN(h)||(c.trigger_above=h)}if(this._triggerBelow){let h=parseFloat(this._triggerBelow);isNaN(h)||(c.trigger_below=h)}if(this._triggerEquals){let h=parseFloat(this._triggerEquals);isNaN(h)||(c.trigger_equals=h)}if(this._triggerNotEquals){let h=parseFloat(this._triggerNotEquals);isNaN(h)||(c.trigger_not_equals=h)}if(this._triggerForMinutes){let h=parseInt(this._triggerForMinutes,10);isNaN(h)||(c.trigger_for_minutes=h)}}else if(this._triggerType==="counter"){if(this._triggerTargetValue){let h=parseFloat(this._triggerTargetValue);isNaN(h)||(c.trigger_target_value=h)}if(c.trigger_delta_mode=this._triggerDeltaMode,this._triggerDeltaMode&&this._triggerBaselineValue){let h=parseFloat(this._triggerBaselineValue);!isNaN(h)&&h>=0&&(c.trigger_baseline_value=h)}}else if(this._triggerType==="state_change"){if(this._triggerFromState&&(c.trigger_from_state=this._triggerFromState),this._triggerToState&&(c.trigger_to_state=this._triggerToState),this._triggerTargetChanges){let h=parseInt(this._triggerTargetChanges,10);isNaN(h)||(c.trigger_target_changes=h)}if(this._triggerForMinutes){let h=parseInt(this._triggerForMinutes,10);isNaN(h)||(c.trigger_for_minutes=h)}}else if(this._triggerType==="runtime"){if(this._triggerRuntimeHours){let m=parseFloat(this._triggerRuntimeHours);isNaN(m)||(c.trigger_runtime_hours=m)}if(this._triggerRuntimeMaxSession){let m=parseInt(this._triggerRuntimeMaxSession,10);!isNaN(m)&&m>0&&(c.trigger_runtime_max_session_seconds=m)}let h=this._triggerOnStates.split(",").map(m=>m.trim()).filter(Boolean);h.length>0&&(c.trigger_on_states=h)}e.trigger_config=c}else this._taskId&&(e.trigger_config=null);if(this.scheduleTimeEnabled&&br.includes(this._scheduleType)){let p=this._scheduleTimeOn?this._scheduleTime.trim():"";e.schedule_time=/^([01]\d|2[0-3]):[0-5]\d$/.test(p)?p:null}if(this.checklistsEnabled){let p=this._checklistText.split(`
`).map(c=>c.trim()).filter(Boolean).slice(0,100);e.checklist=p.length?p:null}if(this.completionActionsEnabled){let p=this._actionService.trim();if(p&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(p)){let f={service:p},x=this._actionTargetEntity.trim();x&&(f.target={entity_id:x});let v=this._buildActionData();Object.keys(v).length>0&&(f.data=v),e.on_complete_action=f}else e.on_complete_action=null;let c={};this._qcNotes.trim()&&(c.notes=this._qcNotes.trim());let h=parseFloat(this._qcCost);!isNaN(h)&&h>=0&&(c.cost=h);let m=parseInt(this._qcDuration,10);!isNaN(m)&&m>=0&&(c.duration=m),this._qcFeedback&&(c.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(c).length?c:null}let i=await this.hass.connection.sendMessagePromise(e),a=this._taskId||i?.task_id,o=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(a&&this._scheduleType==="sensor_based"&&o)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(a&&this._adaptiveSnapshot()!==this._adaptiveInitial){let p=parseFloat(this._adaptiveAlpha),c=parseInt(this._adaptiveMin,10),h=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:a,enabled:this._adaptiveEnabled,...p>=.1&&p<=.9?{ewa_alpha:p}:{},...!isNaN(c)&&c>=1?{min_interval_days:c}:{},...!isNaN(h)&&h>=1?{max_interval_days:h}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=q(e,this._lang,n("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return _;let e=this._lang,t=this._triggerType==="compound";return l`
      ...
      <div class="select-row">
        ...
        >
          ${Ws.map(i=>l`<option value=${i} ?selected=${i===this._triggerType}>${n(i,e)}</option>`)}
        </select>
      </div>
      ${t?this._renderCompoundEditor():l`
        ...
        <ha-form
          ...
          .hass=${this.hass}
          .schema=${[{name:"trigger_entities",selector:{entity:{multiple:!0,domain:jt}}}]}
      ...
      ${this._intervalDays?l`
          ...
          `:_}
    `}_patchCondition(e,t){this._compoundConditions=this._compoundConditions.map((i,a)=>a===e?{...i,...t}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,Ks()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((t,i)=>i!==e)}_renderCompoundEditor(){let e=this._lang;return l`
      <div class="select-row">
    ...
    `}_renderCondition(e,t){let i=this._lang,a=t+1;return l`
      <div class="compound-condition">
        ...
        <ha-form
          class="entity-picker-form"
          .hass=${this.hass}
          .schema=${[{name:"condition_entities",selector:{entity:{multiple:!0,domain:jt}}}]}
        ...
        <div class="select-row">
          ...
          >
            ${xr.map(o=>l`<option value=${o} ?selected=${o===e.type}>${n(o,i)}</option>`)}
          </select>
        </div>
    ...
    `}_renderCalendarFields(){let e=this._lang,t=Js(e);if(this._scheduleType==="weekdays")return l`
      ...
      ></ms-textfield>`}_thresholdLimitsOverlap(){let e=parseFloat(this._triggerAbove),t=parseFloat(this._triggerBelow);return!isNaN(e)&&!isNaN(t)&&t>e}_renderTriggerLiveHint(){if(this._triggerType==="compound")return _;let e=this._triggerType==="threshold"&&this._thresholdLimitsOverlap()?l`<div class="trigger-live-hint warn">${n("trigger_hint_overlap",this._lang)}</div>`:_,t=this._triggerEntityId||this._triggerEntityIds[0];if(!t||!this.hass?.states)return e;let i=this.hass.states[t];if(!i)return e;let a=this._lang,o=i.attributes?.unit_of_measurement,p=typeof o=="string"&&o?` ${o}`:"",c=this._triggerAttribute?i.attributes?.[this._triggerAttribute]:i.state,h=typeof c=="number"?c:parseFloat(String(c)),m=c!=="unknown"&&c!=="unavailable"&&c!=null&&!isNaN(h),f=v=>P(v,a,{maximumFractionDigits:1}),x=[];if(this._triggerType==="threshold"){let v=parseFloat(this._triggerAbove),k=parseFloat(this._triggerBelow);if(isNaN(v)&&isNaN(k))return _;m&&x.push(n("trigger_hint_now",a).replace("{value}",f(h)+p)),isNaN(v)||x.push(n("trigger_hint_above",a).replace("{target}",f(v)+p)),isNaN(k)||x.push(n("trigger_hint_below",a).replace("{target}",f(k)+p))}else if(this._triggerType==="counter"){let v=parseFloat(this._triggerTargetValue);if(isNaN(v))return _;this._triggerDeltaMode?this._taskId?x.push(n("trigger_hint_counter_delta_edit",a).replace("{target}",f(v)+p)):m?x.push(n("trigger_hint_counter_delta",a).replace("{value}",f(h)+p).replace("{due}",f(h+v)+p).replace("{target}",f(v)+p)):x.push(n("trigger_hint_counter_delta_edit",a).replace("{target}",f(v)+p)):(m&&x.push(n("trigger_hint_now",a).replace("{value}",f(h)+p)),x.push(n("trigger_hint_counter_abs",a).replace("{target}",f(v)+p)))}else if(this._triggerType==="runtime"){let v=parseFloat(this._triggerRuntimeHours);if(isNaN(v))return _;x.push(n("trigger_hint_runtime",a).replace("{hours}",f(v))),x.push(n("trigger_hint_state_now",a).replace("{value}",String(i.state)))}else if(this._triggerType==="state_change"){let v=parseInt(this._triggerTargetChanges,10)||1,k=this._triggerToState.trim();x.push((k?n("trigger_hint_state_change_to",a).replace("{state}",k):n("trigger_hint_state_change",a)).replace("{count}",String(v))),x.push(n("trigger_hint_state_now",a).replace("{value}",String(i.state)))}return x.length?l`<div class="trigger-live-hint">${x.join(" ")}</div>${e}`:e}_renderTriggerTypeFields(){let e=this._lang;return this._triggerType==="threshold"?l`
        <ms-textfield
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Fs.map(i=>l`<option value=${i} ?selected=${i===this._type}>${n(i,e)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${Bs.map(i=>l`<option value=${i} ?selected=${i===this._priority}>${n("priority_"+i,e)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${Vs.map(i=>l`<option value=${i} ?selected=${i===this._scheduleType}>${n(i,e)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="one_time"?l`
                ...
                ></ms-date-field>
              `:_}
          ${this.scheduleTimeEnabled&&br.includes(this._scheduleType)?l`
          ...
          ${this._scheduleType==="sensor_based"?l`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:fr,device_class:vr}}}]}
  ...
  `,d([y({type:String})],ve.prototype,"lang",2),d([u()],ve.prototype,"_open",2),d([u()],ve.prototype,"_busy",2);customElements.get("ms-camera-capture")||customElements.define("ms-camera-capture",ve)});var $,kr=w(()=>{"use strict";C();B();Se();L();fe();pt();Mt();Ot();zt();Te();Ut();Ut();$=class extends S{constructor(){super(...arguments);this.entryId="";this.taskId="";this.taskName="";this.lang="en";this.checklist=[];this.adaptiveEnabled=!1;this.taskType="";this.readingUnit="";this.readings=[];this.readingHistory=[];this.restockDefault=null;this.restockUnitCost=null;this.currencySymbol="";this.parts=[];this.consumesParts=[];this.consumesInfo=[];this.requiredFields=[];this.phaseLabel="";this.requireTagScan=!1;this.viaTagScan=!1;this._open=!1;this._notes="";this._cost="";this._duration="";this._loading=!1;this._error="";this._checklistState={};this._feedback="needed";this._photos=[];this._uploadedIds=[];this._photoUploading=!1;this._readingValue="";this._readingValues={};this._restockQty="";this._completedAt="";this._usedParts={};this.checklistPrefill={};this._singlePick=ut();this._inAppCamera=$r()}open(e={}){this._open||(this._open=!0,this.viaTagScan=!!e.viaTagScan,this._notes="",this._cost="",this._duration="",this._error="",this._checklistState=Object.fromEntries(this.checklist.map((t,i)=>[String(i),!!this.checklistPrefill[t]]).filter(([,t])=>t)),this._feedback="needed",this._photos.forEach(t=>URL.revokeObjectURL(t.preview)),this._photos=[],this._uploadedIds=[],this._photoUploading=!1,this._readingValue="",this._readingValues={},this._restockQty=this.restockDefault!==null?String(this.restockDefault):"",this._completedAt="",this._usedParts=Object.fromEntries(this.consumesParts.map(t=>[Q(t),{...t}])))}_toggleCheck(e){let t=String(e);this._checklistState={...this._checklistState,[t]:!this._checklistState[t]}}_setFeedback(e){this._feedback=e}_onCameraClick(e){!this._inAppCamera||this._photoUploading||(e.preventDefault(),this.shadowRoot?.querySelector("ms-camera-capture")?.open())}_onCameraUnavailable(){this._inAppCamera=!1,this.shadowRoot?.querySelector(".photo-pick-camera input")?.click()}async _onPhotoInput(e){let t=e.target,i=Array.from(t.files??[]);t.value="",await this._addPhotoFiles(i)}async _addPhotoFiles(e){if(e.length===0)return;let t=10-this._photos.length,i=e.slice(0,Math.max(t,0));this._photoUploading=!0,this._error="";try{for(let a of i){let o=await _t(this.hass,this.entryId,a);this._uploadedIds=[...this._uploadedIds,o],this._photos=[...this._photos,{id:o,preview:URL.createObjectURL(a)}]}e.length>i.length&&(this._error=n("photos_limit",this.lang).replace("{max}",String(10)))}catch(a){let o=a instanceof Error&&a.message==="doc_too_large"?"doc_too_large":"doc_upload_failed";this._error=n(o,this.lang)}finally{this._photoUploading=!1}}_removePhoto(e){let t=this._photos.find(i=>i.id===e);t&&URL.revokeObjectURL(t.preview),this._photos=this._photos.filter(i=>i.id!==e),this._uploadedIds.includes(e)&&(this._uploadedIds=this._uploadedIds.filter(i=>i!==e),Ce(this.hass,[e]))}async _complete(){this._loading=!0,this._error="";try{let e={type:"maintenance_supporter/task/complete",entry_id:this.entryId,task_id:this.taskId};if(this._notes&&(e.notes=this._notes),this._cost){let t=parseFloat(this._cost);!isNaN(t)&&t>=0&&(e.cost=t)}if(this._duration){let t=parseInt(this._duration,10);!isNaN(t)&&t>=0&&(e.duration=t)}if(this.checklist.length>0&&(e.checklist_state=this._checklistState),this.adaptiveEnabled&&(e.feedback=this._feedback),this._photos.length>0&&(e.photo_doc_ids=this._photos.map(t=>t.id)),this.viaTagScan&&(e.via_tag_scan=!0),this._completedAt){if(new Date(this._completedAt).getTime()>Date.now()){this._error=n("completed_at_future_error",this.lang),this._loading=!1;return}e.completed_at=this._completedAt.length===16?`${this._completedAt}:00`:this._completedAt}if(this.readings.length>0){let t={};for(let i of this.readings){let a=(this._readingValues[i.id]??"").trim();if(a==="")continue;let o=parseFloat(a.replace(",","."));isNaN(o)||(t[i.id]=o)}Object.keys(t).length>0&&(e.reading_values=t)}else if(this._readingValue!==""){let t=parseFloat(this._readingValue);isNaN(t)||(e.reading_value=t)}if(this.restockDefault!==null&&this._restockQty!==""){let t=parseFloat(this._restockQty);!isNaN(t)&&t>=1&&(e.restock_quantity=t)}this.parts.length>0&&(e.used_parts=Object.values(this._usedParts).filter(t=>Number.isFinite(t.quantity)&&t.quantity>0).map(t=>t.entry_id?{part_id:t.part_id,quantity:t.quantity,entry_id:t.entry_id}:{part_id:t.part_id,quantity:t.quantity})),await this.hass.connection.sendMessagePromise(e),this._uploadedIds=[],this._open=!1,this.dispatchEvent(new CustomEvent("task-completed"))}catch(e){this._error=q(e,this.lang,n("save_error",this.lang))}finally{this._loading=!1}}_renderReadingField(e,t){let i=this._completedAt?new Date(this._completedAt).getTime():NaN,a=rr(this.readingHistory,e.id,isNaN(i)?void 0:i),o=e.unit||this.readingUnit,p=(this._readingValues[e.id]??"").trim(),c=p===""?NaN:parseFloat(p.replace(",",".")),h=a!==void 0&&!isNaN(c)&&c<a.value,m=a!==void 0?P(a.value,t,{maximumFractionDigits:3}):"";return l`
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?l`<div class="used-parts">
                ...
                ${this.parts.map(t=>{let i=Q({part_id:t.id,entry_id:t.entry_id}),a=this._usedParts[i],o=a!==void 0,p=t.entry_id?{part_id:t.id,quantity:1,entry_id:t.entry_id}:{part_id:t.id,quantity:1};return l`<div class="used-part-row">
                    <label class="used-part-check">
                      <input type="checkbox" .checked=${o}
                        @change=${c=>{let h={...this._usedParts};c.target.checked?h[i]=h[i]||p:delete h[i],this._usedParts=h}} />
                      <span
                    ...
                    ${o?l`<input class="used-part-qty" type="number" min="0.01" max="999" step="0.01"
                          .value=${String(a.quantity)}
                          @input=${c=>{let h=parseFloat(c.target.value);this._usedParts={...this._usedParts,[i]:{...p,quantity:Number.isFinite(h)&&h>=.01?h:1}}}} />`:_}
                  </div>`})}
          ...
          <div class="field">
            ...
            ${this._photos.length<10?l`<div class="photo-pickers">
                ...
                ${this._singlePick?l`<div class="photo-limit photo-android-hint">${n("photos_android_hint",e)}</div>`:_}
                ${this._inAppCamera?l`<ms-camera-capture .lang=${e}
                  @photo-captured=${t=>this._addPhotoFiles([t.detail.file])}
                  @capture-unavailable=${this._onCameraUnavailable}></ms-camera-capture>`:_}`:l`<div class="photo-limit">${n("photos_limit",e).replace("{max}",String(10))}</div>`}
          </div>
  ...
  `],d([y({attribute:!1})],$.prototype,"hass",2),d([y()],$.prototype,"entryId",2),d([y()],$.prototype,"taskId",2),d([y()],$.prototype,"taskName",2),d([y()],$.prototype,"lang",2),d([y({type:Array})],$.prototype,"checklist",2),d([y({type:Boolean})],$.prototype,"adaptiveEnabled",2),d([y()],$.prototype,"taskType",2),d([y()],$.prototype,"readingUnit",2),d([y({attribute:!1})],$.prototype,"readings",2),d([y({attribute:!1})],$.prototype,"readingHistory",2),d([y({attribute:!1})],$.prototype,"restockDefault",2),d([y({attribute:!1})],$.prototype,"restockUnitCost",2),d([y()],$.prototype,"currencySymbol",2),d([y({attribute:!1})],$.prototype,"parts",2),d([y({attribute:!1})],$.prototype,"consumesParts",2),d([y({type:Array})],$.prototype,"consumesInfo",2),d([y({type:Array})],$.prototype,"requiredFields",2),d([y()],$.prototype,"phaseLabel",2),d([y({type:Boolean})],$.prototype,"requireTagScan",2),d([y({type:Boolean})],$.prototype,"viaTagScan",2),d([u()],$.prototype,"_open",2),d([u()],$.prototype,"_notes",2),d([u()],$.prototype,"_cost",2),d([u()],$.prototype,"_duration",2),d([u()],$.prototype,"_loading",2),d([u()],$.prototype,"_error",2),d([u()],$.prototype,"_checklistState",2),d([u()],$.prototype,"_feedback",2),d([u()],$.prototype,"_photos",2),d([u()],$.prototype,"_photoUploading",2),d([u()],$.prototype,"_readingValue",2),d([u()],$.prototype,"_readingValues",2),d([u()],$.prototype,"_restockQty",2),d([u()],$.prototype,"_completedAt",2),d([u()],$.prototype,"_usedParts",2),d([y({attribute:!1})],$.prototype,"checklistPrefill",2),d([u()],$.prototype,"_inAppCamera",2);customElements.get("maintenance-complete-dialog")||customElements.define("maintenance-complete-dialog",$)});function Er(s,r,e){let t=new Blob([s],{type:e}),i=URL.createObjectURL(t),a=document.createElement("a");a.href=i,a.download=r,a.target="_blank",a.rel="noopener",a.style.display="none",document.body.appendChild(a),a.dispatchEvent(new MouseEvent("click")),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(i),6e4)}var Ft=w(()=>{"use strict"});async function tn(s,r,e=300){return(await s.connection.sendMessagePromise({type:"auth/sign_path",path:r,expires:e})).path}async function Sr(s,r,e=300){return tn(s,`/api/maintenance_supporter/document/${r}`,e)}var Ar=w(()=>{"use strict";Ft()});var de,Bt=w(()=>{"use strict";C();B();Ar();de=class extends S{constructor(){super(...arguments);this.docId="";this._url="";this._failed=!1;this._signedFor=""}updated(){this.hass&&this.docId&&this._signedFor!==this.docId&&(this._signedFor=this.docId,this._url="",this._failed=!1,this._sign())}async _sign(){try{this._url=await Sr(this.hass,this.docId)}catch{this._failed=!0}}render(){return this._failed||!this.docId?_:this._url?l`
  ...
  `,d([y({attribute:!1})],de.prototype,"hass",2),d([y()],de.prototype,"docId",2),d([u()],de.prototype,"_url",2),d([u()],de.prototype,"_failed",2);customElements.get("maintenance-history-photo")||customElements.define("maintenance-history-photo",de)});var U,Tr=w(()=>{"use strict";C();B();L();fe();zt();Te();Bt();U=class extends S{constructor(){super(...arguments);this._open=!1;this._saving=!1;this._error="";this._draft=null;this._originalSnapshot=null;this._partOptions=null;this._partQty={};this._partQtyOriginal="";this._photos=[];this._photosOriginal="";this._readingRows=[];this._readingText={};this._readingsOriginal="";this._uploadedIds=[];this._photoUploading=!1}get _lang(){return z(this.hass)}openEdit(e){this._draft={...e},this._originalSnapshot={...e},this._error="",this._open=!0,this._partOptions=null,this._partQty={},this._partQtyOriginal="",this._photos=[...e.photo_doc_ids??[]],this._photosOriginal=JSON.stringify(this._photos),this._uploadedIds=[],this._photoUploading=!1,this._seedReadings(e),this._loadPartOptions()}_seedReadings(e){let t=[],i=new Set;for(let o of e.readings??[])i.has(o.id)||(i.add(o.id),t.push({id:o.id,name:o.name,unit:o.unit??null}));for(let o of e.reading_values??[])i.has(o.id)||(i.add(o.id),t.push({id:o.id,name:o.name,unit:o.unit??null}));this._readingRows=t;let a={};for(let o of e.reading_values??[])a[o.id]=String(o.value);this._readingText=a,this._readingsOriginal=JSON.stringify(this._readingNumbers())}_readingNumbers(){let e={};for(let t of this._readingRows){let i=(this._readingText[t.id]??"").trim();if(i==="")continue;let a=parseFloat(i.replace(",","."));isNaN(a)||(e[t.id]=a)}return e}async _onPhotoInput(e){let t=e.target,i=Array.from(t.files??[]);t.value="";let a=this._draft;if(i.length===0||!a)return;let o=10-this._photos.length,p=i.slice(0,Math.max(o,0));this._photoUploading=!0,this._error="";try{for(let c of p){let h=await _t(this.hass,a.entry_id,c);this._uploadedIds=[...this._uploadedIds,h],this._photos=[...this._photos,h]}i.length>p.length&&(this._error=n("photos_limit",this._lang).replace("{max}",String(10)))}catch(c){let h=c instanceof Error&&c.message==="doc_too_large"?"doc_too_large":"doc_upload_failed";this._error=n(h,this._lang)}finally{this._photoUploading=!1}}_removePhoto(e){this._photos=this._photos.filter(t=>t!==e),this._uploadedIds.includes(e)&&(this._uploadedIds=this._uploadedIds.filter(t=>t!==e),Ce(this.hass,[e]))}async _loadPartOptions(){let e=this._draft;if(e)try{let t=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/parts/overview"}),i=[];for(let o of t.parts||[]){let p=o.entry_id===e.entry_id,c=o.consumers.some(h=>h.entry_id===e.entry_id&&h.task_id===e.task_id);!p&&!c||i.push({part_id:o.part_id,name:o.name,entry_id:o.entry_id,foreign:!p,object_name:o.object_name})}for(let o of e.used_parts||[]){let p=o.entry_id||e.entry_id;i.some(c=>c.part_id===o.part_id&&c.entry_id===p)||i.push({part_id:o.part_id,name:o.name||o.part_id,entry_id:p,foreign:p!==e.entry_id,object_name:null})}let a={};for(let o of e.used_parts||[])a[`${o.entry_id||e.entry_id}:${o.part_id}`]=o.quantity??1;this._partOptions=i,this._partQty=a,this._partQtyOriginal=this._partSelectionKey()}catch{this._partOptions=[]}}_partSelectionKey(){return JSON.stringify(Object.entries(this._partQty).filter(([,e])=>e>0).sort(([e],[t])=>e.localeCompare(t)))}close(){if(this._open=!1,this._error="",this._draft=null,this._originalSnapshot=null,this._uploadedIds.length>0){let e=this._uploadedIds;this._uploadedIds=[],Ce(this.hass,e)}}_set(e,t){this._draft&&(this._draft={...this._draft,[e]:t})}async _delete(){if(!this._draft||!this._originalSnapshot)return;let e=this._lang;if(window.confirm(n("history_delete_confirm",e))){this._saving=!0,this._error="";try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/history/delete",entry_id:this._draft.entry_id,task_id:this._draft.task_id,timestamp:this._originalSnapshot.original_timestamp}),this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,deleted:!0},bubbles:!0,composed:!0})),this.close()}catch(t){this._error=q(t,e)}finally{this._saving=!1}}}async _save(){if(!(!this._draft||!this._originalSnapshot)){this._saving=!0,this._error="";try{let e={type:"maintenance_supporter/task/history/update",entry_id:this._draft.entry_id,task_id:this._draft.task_id,original_timestamp:this._originalSnapshot.original_timestamp};if(this._draft.timestamp!==this._originalSnapshot.timestamp&&(e.timestamp=this._draft.timestamp),this._draft.notes!==this._originalSnapshot.notes&&(e.notes=this._draft.notes),this._draft.cost!==this._originalSnapshot.cost&&(e.cost=this._draft.cost),this._draft.duration!==this._originalSnapshot.duration&&(e.duration=this._draft.duration),this._draft.completed_by!==this._originalSnapshot.completed_by&&(e.completed_by=this._draft.completed_by),this._partOptions!==null&&this._partSelectionKey()!==this._partQtyOriginal&&(e.used_parts=(this._partOptions||[]).filter(i=>(this._partQty[`${i.entry_id}:${i.part_id}`]||0)>0).map(i=>({part_id:i.part_id,quantity:this._partQty[`${i.entry_id}:${i.part_id}`],...i.foreign?{entry_id:i.entry_id}:{}}))),this._draft.reading_value!==this._originalSnapshot.reading_value&&(e.reading_value=this._draft.reading_value??null),this._readingRows.length>0&&JSON.stringify(this._readingNumbers())!==this._readingsOriginal){let i=this._readingNumbers(),a={};for(let o of this._readingRows)a[o.id]=i[o.id]??null;e.reading_values=a}if(JSON.stringify(this._photos)!==this._photosOriginal&&(e.photo_doc_ids=[...this._photos]),Object.keys(e).filter(i=>!["type","entry_id","task_id","original_timestamp"].includes(i)).length===0){this.close();return}await this.hass.connection.sendMessagePromise(e),this._uploadedIds=[],this.dispatchEvent(new CustomEvent("history-entry-saved",{detail:{entry_id:this._draft.entry_id,task_id:this._draft.task_id,new_timestamp:this._draft.timestamp},bubbles:!0,composed:!0})),this.close()}catch(e){this._error=q(e,this._lang)}finally{this._saving=!1}}}render(){if(!this._open||!this._draft)return _;let e=this._lang,t=this._draft;return l`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ...
        ${this._partOptions&&this._partOptions.length>0?l`
          <div class="parts-block">
            ...
            ${this._partOptions.map(i=>{let a=`${i.entry_id}:${i.part_id}`,o=this._partQty[a]||0;return l`
          ...
          ${this._photos.length<10?l`
            <label class="photo-add">
              ...
              <input type="file" accept="image/*" multiple
                ?disabled=${this._photoUploading}
                @change=${this._onPhotoInput} />
            </label>`:l`<span class="photos-hint">${n("photos_limit",e).replace("{max}",String(10))}</span>`}
...
<div class="qr-row">
  <div class="qr-col">
    <img src="${Cr(this._viewResult.svg_data_uri)}" alt="QR Info" />
    <div class="qr-label">${m}</div>
  </div>
  ${h?`<div class="qr-col">
    <img src="${Cr(this._completeResult.svg_data_uri)}" alt="QR Complete" />
    <div class="qr-label">${f}</div>
  </div>`:""}
</div>
<div class="url">${Ie(this._viewResult.url)}</div>
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),a.document.close()}_downloadSvg(e,t){let i=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),a=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;Er(i,`qr-${rn(a)}-${t}.svg`,"image/svg+xml")}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return l``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${n("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${n("qr_code",e)}: ${this._objectName}`,i=!!this._viewResult;return l`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
  ...
  `,d([y({attribute:!1})],K.prototype,"hass",2),d([y()],K.prototype,"lang",2),d([u()],K.prototype,"_open",2),d([u()],K.prototype,"_loading",2),d([u()],K.prototype,"_error",2),d([u()],K.prototype,"_viewResult",2),d([u()],K.prototype,"_completeResult",2),d([u()],K.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",K)});function sn(s,r){if(r<=0)return 0;let e=typeof s=="number"&&Number.isFinite(s)?Math.trunc(s):0;return e<0?0:e%r}function nn(s){return!!(s?.phases&&s.phase_sequence&&s.phase_sequence.length>0)}function Vt(s){if(!s||!nn(s))return null;let r=s.phase_sequence,e=sn(s.phase_cursor,r.length),t=r[e],i=s.phases?.[t];return i?{id:t,name:i.name,index:e,count:r.length,notes:i.notes,checklist:i.checklist!==void 0?i.checklist:s.checklist??[],consumesParts:i.consumes_parts!==void 0?i.consumes_parts:s.consumes_parts??[],requiredFields:i.required_completion_fields!==void 0?i.required_completion_fields:s.required_completion_fields??[]}:null}function Je(s){let r=Vt(s);return r?`${r.index+1}/${r.count} \xB7 ${r.name}`:""}var Wt=w(()=>{"use strict"});function Pr(s){let r=s.task??null,e=r?Vt(r):null,t=e?e.consumesParts:r?.consumes_parts||[],i=!!r?.part_ref,a=s.objects.find(c=>c.entry_id===s.entryId)?.parts||[],o=i?a.find(c=>c.id===r.part_ref.part_id):void 0,p=s.checklistsEnabled??!0;return{entry_id:s.entryId,task_id:s.taskId,task_name:s.taskName,checklist:e?p?e.checklist:[]:s.checklist??[],adaptive_enabled:!!s.adaptiveEnabled,required_completion_fields:e?e.requiredFields:r?.required_completion_fields||[],task_type:r?.type||"",reading_unit:r?.reading_unit||"",readings:r?.readings||[],reading_history:ir(r?.history),parts:i?[]:mr({consumes_parts:t},s.entryId,s.objects,s.lang),consumes_parts:i?[]:t,phase_label:e?Je(r):"",require_tag_scan:!!r?.require_tag_scan,restock_default:i?o?.restock_quantity??1:null,restock_unit_cost:i?o?.cost??null:null,currency_symbol:s.currencySymbol??"",consumes_info:t.map(c=>gr(c,s.entryId,s.objects,s.lang)),checklist_prefill:r?.checklist_progress||{},via_tag_scan:!!s.viaTagScan}}function Lr(s,r,e){s.entryId=r.entry_id,s.taskId=r.task_id,s.taskName=r.task_name,s.lang=e,s.checklist=r.checklist??[],s.adaptiveEnabled=!!r.adaptive_enabled,s.requiredFields=r.required_completion_fields??[],s.taskType=r.task_type??"",s.readingUnit=r.reading_unit??"",s.readings=r.readings??[],s.readingHistory=r.reading_history??[],s.parts=r.parts??[],s.consumesParts=r.consumes_parts??[],s.phaseLabel=r.phase_label??"",s.requireTagScan=!!r.require_tag_scan,s.restockDefault=r.restock_default??null,s.restockUnitCost=r.restock_unit_cost??null,s.currencySymbol=r.currency_symbol??"",s.consumesInfo=r.consumes_info??[],s.checklistPrefill=r.checklist_prefill??{},s.viaTagScan=!!r.via_tag_scan,s.open({viaTagScan:!!r.via_tag_scan})}var Kt=w(()=>{"use strict";Se();pt();Wt()});function A(s){return s.toFixed(1)}var Yt=w(()=>{"use strict";L()});function Rr(s,r){let e=s.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return _;let a=s.interval_days??0,o=s.suggested_interval??a;return l`
    <div class="weibull-section">
      ...
      ${on(t,i,a,o,r)}
      ${ln(e,r)}
      ${e?.confidence_interval_low!=null?dn(e,s,r):_}
    </div>
  `}function an(s,r){let e,t,i;return s<.8?(e="early_failures",t="M13,14H11V10H13M13,18H11V16H13M1,21H23L12,2L1,21Z",i="beta_early_failures"):s<=1.2?(e="random_failures",t="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M13,17H11V15H13V17M13,13H11V7H13V13Z",i="beta_random_failures"):s<=3.5?(e="wear_out",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M12,4A8,8 0 0,0 4,12A8,8 0 0,0 12,20A8,8 0 0,0 20,12A8,8 0 0,0 12,4M12,6A6,6 0 0,1 18,12H12V6Z",i="beta_wear_out"):(e="highly_predictable",t="M12,2A10,10 0 0,1 22,12A10,10 0 0,1 12,22A10,10 0 0,1 2,12A10,10 0 0,1 12,2M11,16.5L18,9.5L16.59,8.09L11,13.67L7.91,10.59L6.5,12L11,16.5Z",i="beta_highly_predictable"),l`
    <span class="beta-badge ${e}">
      <ha-svg-icon path="${t}"></ha-svg-icon>
      ${n(i,r)} (\u03B2=${P(s,r,2)})
    </span>
  `}function on(s,r,e,t,i){let v=Math.max(e,t,r,1)*1.3,k=50,T=[];for(let N=0;N<=k;N++){let O=N/k*v,ce=1-Math.exp(-Math.pow(O/r,s)),Le=32+O/v*260,Re=136-ce*128;T.push([Le,Re])}let M=T.map(([N,O])=>`${A(N)},${A(O)}`).join(" "),F="M32,136 "+T.map(([N,O])=>`L${A(N)},${A(O)}`).join(" ")+` L${A(T[k][0])},136 Z`,H=32+e/v*260,Y=1-Math.exp(-Math.pow(e/r,s)),oe=136-Y*128,b=P((1-Y)*100,i,0),G=32+t/v*260,ye=[0,.25,.5,.75,1];return l`
    <div class="weibull-chart">
      <svg viewBox="0 0 ${300} ${160}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_weibull",i)}">
        ${ye.map(N=>{let O=136-N*128;return we`
            <line x1="${32}" y1="${A(O)}" x2="${292}" y2="${A(O)}"
              stroke="var(--divider-color)" stroke-width="0.5" stroke-dasharray="${N===.5?"4,3":_}" />
            <text x="${28}" y="${A(O+3)}" fill="var(--secondary-text-color)"
              font-size="8" text-anchor="end">${P(N*100,i,0)}%</text>
          `})}
        ...
        ${e>0?we`
          <line x1="${A(H)}" y1="${8}" x2="${A(H)}" y2="${A(136)}"
            stroke="var(--primary-color, #03a9f4)" stroke-width="1.5" stroke-dasharray="4,3" />
          <circle cx="${A(H)}" cy="${A(oe)}" r="3"
            fill="var(--primary-color, #03a9f4)" />
          <text x="${A(H+4)}" y="${A(oe-6)}" fill="var(--primary-color, #03a9f4)"
            font-size="9" font-weight="600">R=${b}%</text>
        `:_}

        ${t>0&&t!==e?we`
          <line x1="${A(G)}" y1="${8}" x2="${A(G)}" y2="${A(136)}"
  ...
  `}function dn(s,r,e){let t=s.confidence_interval_low,i=s.confidence_interval_high,a=r.suggested_interval??r.interval_days??0,o=r.interval_days??0,p=Math.max(0,t-5),h=i+5-p,m=(t-p)/h*100,f=(i-t)/h*100,x=(a-p)/h*100,v=o>0?(o-p)/h*100:-1;return l`
    <div class="confidence-range">
      <div class="confidence-range-title">
        ${n("confidence_interval",e)}: ${a} ${n("days",e)} (${t}\u2013${i})
      </div>
      <div class="confidence-bar">
        <div class="confidence-fill" style="left:${A(m)}%;width:${A(f)}%"></div>
        ${v>=0?l`<div class="confidence-marker current" style="left:${A(v)}%"></div>`:_}
        <div class="confidence-marker recommended" style="left:${A(x)}%"></div>
      </div>
      ...
      <div class="prediction-grid">
        ...
        ${i?l`
          <div class="prediction-item">
            ...
            ${s.threshold_prediction_date?l`<span class="prediction-date">${V(s.threshold_prediction_date,r)}</span>`:_}
        ...
        ${a&&e.environmental?l`
          <div class="prediction-item">
            ...
            ${s.environmental_entity?l`<span class="prediction-entity entity-link" @click=${p=>Ji(p,s.environmental_entity)}>${s.environmental_entity}</span>`:_}
          </div>
        `:_}
      </div>
    </div>
  `}var jr=w(()=>{"use strict";C();L()});function Hr(s,r,e,t){let i=Math.max(s||1,r);return l`
  ...
  `}var Or=w(()=>{"use strict";C();L()});function Mr(s,r,e){if(!e.seasonal||!s.seasonal_factor||s.seasonal_factor===1)return _;let t=Dr.map(p=>n(p,r)),i=new Date().getMonth(),a=s.seasonal_factors||s.interval_analysis?.seasonal_factors||null,o=a&&a.length===12?a:t.map((p,c)=>{let h=s.seasonal_factor||1,m=Math.sin((c-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,h+m))});return l`
    <div class="seasonal-card-compact">
      <h4>${n("seasonal_awareness",r)}</h4>
      <div class="seasonal-mini-chart">
        ${o.map((p,c)=>{let h=p*40,m=p<.9?"low":p>1.1?"high":"normal";return l`
      ...
      <div class="seasonal-legend">
        <span class="legend-item"><span class="dot low"></span> ${n("shorter",r)||"K\xFCrzer"}</span>
        <span class="legend-item"><span class="dot normal"></span> ${n("normal",r)||"Normal"}</span>
        <span class="legend-item"><span class="dot high"></span> ${n("longer",r)||"L\xE4nger"}</span>
      </div>
    </div>
  `}function zr(s,r){return cn(s,r)}function cn(s,r){let e=s.seasonal_factors??s.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return _;let t=s.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,o=100,p=8,h=o-p-4,m=Math.max(...e,1.5),f=a/12,x=f*.65,v=p+h-1/m*h;return l`
  ...
  `}var Dr,Ur=w(()=>{"use strict";C();L();Yt();Dr=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var R,Fr=w(()=>{"use strict";C();B();L();fe();Pt();Kt();Wt();dt();Se();Bt();Nr();jr();Or();Te();Ur();R=class extends S{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return z(this.hass)}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=ge(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._currencySymbol=e?.budget?.currency_symbol||"",at(e?.budget),this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(i=>i.id===this._taskId);this._task=t??null}catch(e){this._error=q(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=q(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(Z(),se)).then(async({openCompleteDialog:e})=>{let t=this._task,i=[];try{i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}e(Pr({entryId:this._entryId,taskId:this._taskId,taskName:t.name,task:t,objects:i,lang:this._lang,checklist:t.checklist||[],adaptiveEnabled:!!t.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(Z(),se)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(Z(),se)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=n("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=n("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${n("reanalyze_result",this._lang)||"Recomputed"}: ${Ve(e.recommended_interval,"days",this._lang)} (${e.data_points} pts)`:n("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=q(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){!this._entryId||!this._taskId||Promise.resolve().then(()=>(Z(),se)).then(({openHistoryEditDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null,used_parts:e.used_parts??null,photo_doc_ids:Ge(e),reading_value:e.reading_value??null,reading_values:ie(e),readings:this._task?.readings??[],task_type:this._task?.type??null,reading_unit:this._task?.reading_unit??null})})}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return _;let t=this._lang;return l`
    ...
    `}_renderAdaptive(e){let t=this._lang,i=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,a=e.degradation_trend!=null&&e.degradation_trend!=="insufficient_data"||e.days_until_threshold!=null||e.environmental_factor!=null&&e.environmental_factor!==1,o=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,p=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1;return!i&&!a&&!o&&!p?l`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${a?qr(e,t,this._features):_}
        ${o?Rr(e,t):_}
        ${p?l`
          ${Mr(e,t,this._features)}
          ${e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12?zr(e,t):_}
        `:_}
      </div>
    `}_renderHistoryReadings(e,t,i){let a=ie(e),o=p=>P(p,i,{maximumFractionDigits:3});if(a.length>0)return l`<div class="history-readings">
        ${a.map(p=>{let c=sr(t,e,p.id);return l`<span class="history-reading"><span class="history-reading-name">${p.name}</span>
        ...
        <span class="history-reading-value">${o(e.reading_value)}${p}</span></span></div>`}return _}_renderDetails(e){let t=this._lang,i=e.history||[],a=i.filter(c=>c.type==="completed"),o=a.reduce((c,h)=>c+(typeof h.cost=="number"?h.cost:0),0),p=(()=>{let c=a.map(h=>typeof h.duration=="number"?h.duration:null).filter(h=>h!=null);return c.length?Math.round(c.reduce((h,m)=>h+m,0)/c.length):null})();return l`
      <div class="details">
        ...
        ${i.length===0?l`<div class="history-empty">${n("history_empty",t)||"No history yet."}</div>`:l`
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(c=>{let h=["completed","reset","skipped"].includes(c.type);return l`
                    <div class="history-entry">
                      <div class="history-line">
                        <span class="history-type type-${c.type}">${n(c.type,t)}</span>
                        <span class="history-date">${Wi(c.timestamp,t)}</span>
                        ${h?l`<button class="history-edit"
                      ...
                      ${(()=>{let m=Ge(c);return m.length?l`<div class="history-photos">
                  ...
                  `})}
                ${i.length>20?l`<div class="history-more">… +${i.length-20} ${n("older_entries",t)||"older"}</div>`:_}
              </div>
            `}
      </div>
    `}render(){if(!this._open)return _;let e=this._lang,t=this._task,i=this.hass?.user?.is_admin??!0;return l`
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?l`
              <div class="header">
                <div class="title">
                  <span class="status-dot" style="background: ${Fe[t.status]||"#ccc"}"></span>
                ...
                <div class="quick-info">
                  ${t.next_due?l`<span><strong>${n("next_due",e)||"Next due"}:</strong> ${V(t.next_due,e)}</span>`:_}
                  ${t.last_performed?l`<span><strong>${n("last_performed",e)||"Last"}:</strong> ${V(t.last_performed,e)}</span>`:_}
                  ${t.schedule?.kind&&!["manual","one_time"].includes(t.schedule.kind)||t.interval_days!=null?l`<span><strong>${n("interval",e)||"Interval"}:</strong> ${Qi(t,e)}</span>`:_}
                  ${Je(t)?l`<span><strong>${n("phase_current",e)}:</strong> ${Je(t)}</span>`:_}
                </div>
              </div>
              ...
              ${this._showSkip?l`
                  ...
                  `}
            `:l`<div class="loading">${n("loading",e)||"Loading\u2026"}</div>`}
      </div>
    `}};R.styles=[lt,E`
    :host { display: contents; }
    .backdrop {
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${t&&i?l`
              ...
              <div class="tasks-section">
                ...
                ${a.length===0?l`<div class="empty">${n("no_tasks",e)||"No tasks yet."}</div>`:l`
                      <div class="task-list">
                        ${a.map(p=>l`
                          <div class="task-row" @click=${()=>this._onTaskClick(p.id)}>
                            <span class="status-dot" style="background: ${Fe[p.status]||"#ccc"}"></span>
                            <span class="task-name">${p.name}</span>
                            <span class="task-status">${n(p.status||"ok",e)}</span>
                          </div>
                        `)}
                      </div>
                    `}
              ...
              ${i.notes?l`
                    <div class="notes-section">
                      ...
                      <div class="notes-body">${Wr(i.notes)}</div>
                    </div>
                  `:_}
      ...
      <div class="meta">
        ${i.map(([a,o])=>l`
            <div class="meta-item">
              ...
              <span class="meta-value">${Br(o)?l`<a href="${o}" target="_blank" rel="noopener noreferrer">${o}</a>`:o}</span>
            </div>
          `)}
      </div>
    `}};X.styles=E`
  ...
  `,d([y({attribute:!1})],X.prototype,"hass",2),d([u()],X.prototype,"_open",2),d([u()],X.prototype,"_entryId",2),d([u()],X.prototype,"_data",2),d([u()],X.prototype,"_busy",2),d([u()],X.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",X)});function Gr(){let s=window;return s.__msSettingsCache??={promise:null}}function gt(s){let r=Gr();if(r.promise)return r.promise;let e=s.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(t=>({features:t.features??Gt.features,defaultWarningDays:t.general?.default_warning_days??7,rowActionStyle:t.general?.row_action_style??Gt.rowActionStyle})).catch(()=>(r.promise===e&&(r.promise=null),Gt));return r.promise=e,e}function Qr(){Gr().promise=null}var Gt,Jr=w(()=>{"use strict";Gt={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"}});var se={};rs(se,{__resetSettingsCacheForTests:()=>vn,getRowActionStyle:()=>fn,openCompleteDialog:()=>$n,openCreateObjectDialog:()=>yn,openCreateTaskDialog:()=>xn,openEditObjectDialog:()=>bn,openEditTaskDialog:()=>wn,openHistoryEditDialog:()=>Qt,openObjectQuickActions:()=>En,openQrDialog:()=>kn,openTaskQuickActions:()=>Jt});function mt(){return document.querySelector("home-assistant")?.hass}function mn(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function ne(s){let r=mn(),e=r.querySelector(s)??document.body.querySelector(s);return e?e.parentNode!==r&&r.appendChild(e):(e=document.createElement(s),r.appendChild(e)),e}function ae(s){let r=mt();if(!r)return!1;s.hass=r;let e=z(r);return Ke(e)||Ye(e).then(()=>{s.requestUpdate?.()}),Rt(r.locale,r.config?.country),!0}function fn(s){return gt(s).then(r=>r.rowActionStyle)}function vn(){Qr()}function yn(){let s=ne(Zr);return ae(s)?(s.openCreate(),!0):!1}function bn(s,r){let e=ne(Zr);return ae(e)?(e.openEdit(s,r),!0):!1}function xn(s="",r){let e=ne(Xr);if(!ae(e))return!1;let t=mt();return t?((async()=>{let i=await gt(t),a=e;a.checklistsEnabled=i.features.checklists,a.scheduleTimeEnabled=i.features.schedule_time,a.completionActionsEnabled=i.features.completion_actions,a.defaultWarningDays=i.defaultWarningDays,a.openCreate(s,r)})(),!0):!1}function wn(s,r){let e=ne(Xr);if(!ae(e))return!1;let t=mt();return t?((async()=>{try{let[i,a]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:s}),gt(t)]),o=(i.tasks||[]).find(c=>c.id===r);if(!o){console.warn(`openEditTaskDialog: task ${r} not found in entry ${s}`);return}let p=e;p.checklistsEnabled=a.features.checklists,p.scheduleTimeEnabled=a.features.schedule_time,p.completionActionsEnabled=a.features.completion_actions,p.defaultWarningDays=a.defaultWarningDays,await p.openEdit(s,o)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function Qt(s){let r=ne(pn);return ae(r)?(r.openEdit(s),!0):!1}function $n(s){let r=ne(hn);return ae(r)?(Lr(r,s,mt()?.language||"en"),!0):!1}function kn(s){let r=ne(un);return ae(r)?(r.openForTask(s.entry_id,s.task_id,s.object_name,s.task_name),!0):!1}function Jt(s,r){let e=ne(_n);return ae(e)?(e.openFor(s,r),!0):!1}function En(s){let r=ne(gn);return ae(r)?(r.openFor(s),!0):!1}var Zr,Xr,pn,hn,un,_n,gn,Z=w(()=>{"use strict";dr();wr();kr();Tr();Ir();Fr();Yr();L();Kt();Jr();Zr="maintenance-object-dialog",Xr="maintenance-task-dialog",pn="maintenance-history-edit-dialog",hn="maintenance-complete-dialog",un="maintenance-qr-dialog",_n="maintenance-task-quick-actions-dialog",gn="maintenance-object-quick-actions-dialog"});C();B();Pt();C();var Li=E`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;L();function Xi(s){let r=window;r.customCards=r.customCards||[],r.customCards.some(e=>e.type===s.type)||r.customCards.push(s)}dt();Se();Z();var W=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){if(this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter),typeof e.object_filter=="string")this._objectFilter=e.object_filter,this._configuredObjects=[];else if(Array.isArray(e.object_filter)){let t=e.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=t.length===1?t[0]:"",this._configuredObjects=t.length>1?t:[]}}getCardSize(){return 6}get _lang(){return z(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){if(super.updated(e),Mi(this,e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t,at(this._stats.budget)}catch{}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}_onEventClick(e){if(e.history_timestamp){this._openHistoryEntry(e);return}Jt(e.entry_id,e.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(e){try{let i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:e.entry_id})).tasks?.find(p=>p.id===e.task_id),a=i?.history?.find(p=>p.timestamp===e.history_timestamp);if(!a||Qt({entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp,type:a.type||"completed",timestamp:a.timestamp||e.history_timestamp,notes:a.notes??null,cost:a.cost??null,duration:a.duration??null,completed_by:a.completed_by??null,used_parts:a.used_parts??null,photo_doc_ids:Ge(a),reading_value:a.reading_value??null,reading_values:ie(a),readings:i?.readings??[],task_type:i?.type??null,reading_unit:i?.reading_unit??null}))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return _;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,o=null;this._userFilter&&(o=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let p=b=>{let G=b.toLowerCase();return this._objects.find(N=>N.entry_id===b||N.object.name.toLowerCase()===G)?.entry_id??null},c=new Set(this._configuredObjects.map(p).filter(b=>b!==null)),h=c.size?this._objects.filter(b=>c.has(b.entry_id)):this._objects,m=this._config.show_object_filter!==!1&&h.length>1,f=this._objectFilter?p(this._objectFilter):null,x=f&&h.some(b=>b.entry_id===f)?h.filter(b=>b.entry_id===f):h,v=new Date;v.setHours(0,0,0,0);let k=this._pastDays>0,T=k?Pi(x,v,this._pastDays,o):Ii(x,v,this._windowDays,o),M=ge(v),F=this._windowDays===365||k,H=F?T.filter(b=>b.events.length>0):T,Y=b=>{let G=`cal-status-${b.status}`,ye=b.projected?"cal-event-projected":"",N=b.status==="overdue"&&b.days_until_due!=null?` (${Ki(b.days_until_due,e)})`:"",O=b.projected&&b.interval_days?l`<span class="cal-event-recur">${b.interval_unit&&b.interval_unit!=="days"?`${b.interval_days} ${n("unit_"+b.interval_unit,e)}`:n("cal_every_n_days",e).replace("{n}",String(b.interval_days))}</span>`:_,ce=b.schedule_type==="sensor_based",Le=ce?l`<ha-icon class="cal-event-icon cal-source-sensor"
                ...
                icon="${b.adaptive_enabled?"mdi:clock-time-four-outline":"mdi:clock-outline"}"></ha-icon>`,Re=ce&&b.prediction_confidence&&b.status!=="triggered"&&!b.projected?l`<span class="cal-event-prediction cal-conf-${b.prediction_confidence}">
            ${n("cal_predicted",e)} · ${n(`cal_confidence_${b.prediction_confidence}`,e)}
          </span>`:_,es=this._stats?.budget?.currency_symbol||Oi,ts=b.history_type?n(b.history_type,e):n(b.status,e);return l`
        <div class="cal-event ${ye}"
          @click=${()=>this._onEventClick(b)}>
          ${Le}
          <span class="cal-status-pill ${G}">${ts}</span>
          <div class="cal-event-body">
            <div class="cal-event-title">${b.object_name} · ${b.task_name}${N}</div>
            ${Re}
            ${O}
          </div>
          ${b.avg_cost!=null&&b.avg_cost>0?l`<span class="cal-event-cost">${ot(b.avg_cost,es,e)}</span>`:_}
        </div>
      `},oe=b=>{let[G,ye,N]=b.date.split("-").map(Number),O=new Date(G,ye-1,N),ce=b.date===M,Le=Yi(O,e,"short"),Re=Gi(O,e,"long");return l`
        <div class="cal-day-row">
          ...
          <div class="cal-day-content">
            <div class="cal-day-header">
              <span class="cal-day-month">${Re}</span>
              ${ce?l`<span class="cal-day-today-badge">${n("today",e)}</span>`:_}
            </div>
            ${b.events.length===0?l`<div class="cal-empty">${n("cal_no_events",e)}</div>`:b.events.map(Y)}
          </div>
        </div>
      `};return l`
      <ha-card .header=${a}>
              ...
              <div class="cal-controls">
                ...
                ${m?l`
                      <select class="cal-user-filter"
                        ...
                        ${[...h].sort((b,G)=>b.object.name.localeCompare(G.object.name)).map(b=>l`<option value=${b.entry_id} ?selected=${b.entry_id===f}>${b.object.name}</option>`)}
                      </select>
                    `:_}
              </div>
            `:_}
        <div class="cal-rolling">
          ${H.length===0&&F?l`<div class="cal-empty">${n("cal_no_events",e)}</div>`:H.map(oe)}
        </div>
      </ha-card>
    `}};W.styles=[lt,Li,E`
      :host { display: block; }
      ha-card { padding: 0; overflow: hidden; }
    `],d([y({attribute:!1})],W.prototype,"hass",2),d([u()],W.prototype,"_config",2),d([u()],W.prototype,"_objects",2),d([u()],W.prototype,"_stats",2),d([u()],W.prototype,"_windowDays",2),d([u()],W.prototype,"_pastDays",2),d([u()],W.prototype,"_userFilter",2),d([u()],W.prototype,"_objectFilter",2),d([u()],W.prototype,"_unsub",2);var Sn=[{value:7,key:"cal_editor_window_week"},{value:14,key:"cal_editor_window_fortnight"},{value:30,key:"cal_editor_window_month"},{value:365,key:"cal_editor_window_year"}],Pe=class extends S{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}get _lang(){return z(this.hass)}setConfig(e){this._config={...e}}updated(){let e=this._lang;e&&!Ke(e)&&Ye(e).then(()=>this.requestUpdate())}_valueChanged(e,t){let i={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete i.show_window_chips,e==="show_user_filter"&&t===!0&&delete i.show_user_filter,e==="show_object_filter"&&t===!0&&delete i.show_object_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete i.title,e==="user_filter"&&t===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let e=this._lang,t=this._config.window_days??30,i=this._config.show_window_chips!==!1,a=this._config.show_user_filter!==!1,o=this._config.user_filter??"",p=this._config.title??"";return l`
      <div class="editor">
        <div class="row">
        ...
        <div class="row">
          ...
          >
            ${Sn.map(c=>l`<option value="${c.value}" ?selected=${c.value===t}>${n(c.key,e)}</option>`)}
          </select>
        </div>
  ...
  `,d([y({attribute:!1})],Pe.prototype,"hass",2),d([u()],Pe.prototype,"_config",2);customElements.get("maintenance-supporter-calendar-card")||customElements.define("maintenance-supporter-calendar-card",W);customElements.get("maintenance-supporter-calendar-card-editor")||customElements.define("maintenance-supporter-calendar-card-editor",Pe);Xi({type:"maintenance-supporter-calendar-card",name:"Maintenance Supporter \u2014 Calendar",description:"Rolling calendar of maintenance tasks with 7/14/30/365 day windows, source icons, and prediction-confidence pills.",preview:!0});export{W as MaintenanceCalendarCard};
