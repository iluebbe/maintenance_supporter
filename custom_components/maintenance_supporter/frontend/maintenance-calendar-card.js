...
`});function We(r){if(!r)return[];let s=[],e=r.photo_doc_id;typeof e=="string"&&s.push(e);let t=r.photo_doc_ids;Array.isArray(t)&&s.push(...t);let i=[];for(let a of s){if(typeof a!="string")continue;let o=a.trim();if(!(!o||i.includes(o))&&(i.push(o),i.length>=10))break}return i}var at=w(()=>{"use strict"});function Wi(){let r=new Uint8Array(4);return(globalThis.crypto??{getRandomValues:s=>s.map(()=>Math.floor(Math.random()*256))}).getRandomValues(r),Array.from(r,s=>s.toString(16).padStart(2,"0")).join("")}function ie(r){let s=r?.reading_values;if(!Array.isArray(s))return[];let e=[],t=new Set;for(let i of s){if(!i||typeof i!="object")continue;let a=i;typeof a.id!="string"||!a.id||t.has(a.id)||typeof a.value!="number"||!Number.isFinite(a.value)||(t.add(a.id),e.push({id:a.id,name:typeof a.name=="string"?a.name:a.id,unit:typeof a.unit=="string"?a.unit:null,value:a.value}))}return e}function Ki(r){return r.filter(s=>s.type==="completed"&&(s.reading_value!=null||ie(s).length>0)).sort((s,e)=>s.timestamp.localeCompare(e.timestamp))}function Yi(r){return Ki(r??[]).map(s=>({timestamp:s.timestamp,values:ie(s)})).filter(s=>s.values.length>0)}function Gi(r,s,e){let t;for(let i of r){if(e!==void 0){let o=new Date(i.timestamp).getTime();if(!isNaN(o)&&o>=e)break}let a=i.values.find(o=>o.id===s);a&&(t=a)}return t}function Qi(r,s,e){let t=ie(s).find(a=>a.id===e);if(!t)return null;let i=null;for(let a of Ki(r)){if(a.timestamp>=s.timestamp)break;let o=ie(a).find(p=>p.id===e);o&&(i=o.value)}return i==null?null:t.value-i}function Ji(r){let s=new Set,e=new Set;for(let t of r){let i=(t.name||"").trim().toLowerCase();i&&(s.has(i)?e.add(t.id):s.add(i))}return e}function Zi(r){let s=[],e=new Set,t=new Set;for(let i of r){let a=(i.name||"").trim();if(!(!a||e.has(i.id)||t.has(a.toLowerCase()))&&(e.add(i.id),t.add(a.toLowerCase()),s.push({id:i.id,name:a,unit:(i.unit||"").trim()||null}),s.length>=20))break}return s}var Ee=w(()=>{"use strict"});function Er(r,s){let e=kr[r];if(!e)return r;let t=n(e,s);return t&&t!==e?t:r}function Sr(r){let e=r.match(/data\['([^']+)'\]/)?.[1],t;return(t=r.match(/length of value must be at most (\d+)/))?{field:e,rule:"too_long",param:t[1]}:(t=r.match(/length of value must be at least (\d+)/))?{field:e,rule:"too_short",param:t[1]}:(t=r.match(/value must be at most (\S+)/))?{field:e,rule:"value_too_high",param:t[1]}:(t=r.match(/value must be at least (\S+)/))?{field:e,rule:"value_too_low",param:t[1]}:/required key not provided/.test(r)?{field:e,rule:"required"}:(t=r.match(/expected (\w+)/))?{field:e,rule:"wrong_type",param:t[1]}:/value must be one of/.test(r)?{field:e,rule:"invalid_choice"}:/not a valid value/.test(r)?{field:e,rule:"invalid_value"}:{field:e,rule:"unknown"}}function O(r,s,e){if(e=e??n("action_error",s),typeof r=="string")return r;if(typeof r!="object"||r===null)return e;let t=r,i=t.message||t.error?.message||"";if(!i)return e;let a=Sr(i),o=a.field?Er(a.field,s):"",p=c=>n(c,s).replace("{field}",o).replace("{n}",a.param??"");switch(a.rule){case"too_long":return p("err_too_long");case"too_short":return p("err_too_short");case"value_too_high":return p("err_value_too_high");case"value_too_low":return p("err_value_too_low");case"required":return p("err_required");case"wrong_type":return p("err_wrong_type").replace("{type}",a.param??"");case"invalid_choice":return p("err_invalid_choice");case"invalid_value":return p("err_invalid_value");default:return i||e}}var kr,fe=w(()=>{"use strict";q();kr={entry_id:"object",name:"name",task_type:"maintenance_type",schedule_type:"schedule_type",interval_days:"interval_days",interval_anchor:"interval_anchor",warning_days:"warning_days",last_performed:"last_performed_optional",notes:"notes_optional",documentation_url:"documentation_url_optional",custom_icon:"custom_icon_optional",nfc_tag_id:"nfc_tag_id_optional",responsible_user_id:"responsible_user",entity_slug:"entity_slug",entity_id:"entity_id",area_id:"area_id_optional",manufacturer:"manufacturer_optional",model:"model_optional",serial_number:"serial_number_optional",installation_date:"installation_date_optional",warranty_expiry:"warranty_expiry_optional",checklist:"checklist_steps_optional",reason:"reason",feedback:"feedback",cost:"cost",duration:"duration",description:"description_optional",group_name:"name",group_description:"description_optional",environmental_entity:"environmental_entity_optional",environmental_attribute:"environmental_attribute_optional",trigger_above:"trigger_above",trigger_below:"trigger_below",trigger_equals:"trigger_equals",trigger_not_equals:"trigger_not_equals",trigger_for_minutes:"trigger_for_minutes"}});var N,Pt=w(()=>{"use strict";I();V();N=class extends A{constructor(){super(...arguments);this.label="";this.value="";this.placeholder="";this.type="text";this.required=!1;this.disabled=!1;this.multiline=!1;this.rows=3}_onInput(e){let t=e.target.value;this.value=t,this.dispatchEvent(new CustomEvent("input",{bubbles:!0,composed:!0,detail:{value:t}}))}render(){return l`
      <label class="field">
  ...
  `,d([y()],N.prototype,"label",2),d([y()],N.prototype,"value",2),d([y()],N.prototype,"placeholder",2),d([y()],N.prototype,"type",2),d([y({type:Boolean})],N.prototype,"required",2),d([y({type:Boolean})],N.prototype,"disabled",2),d([y()],N.prototype,"step",2),d([y()],N.prototype,"min",2),d([y()],N.prototype,"max",2),d([y()],N.prototype,"pattern",2),d([y()],N.prototype,"helper",2),d([y({type:Boolean})],N.prototype,"multiline",2),d([y({type:Number})],N.prototype,"rows",2);customElements.get("ms-textfield")||customElements.define("ms-textfield",N)});function Ar(r,s){if(s)switch(r){case"date":return s.split("T")[0];case"time":return s.length===5?`${s}:00`:s;case"datetime":{let[e,t="00:00:00"]=s.split("T");return`${e} ${t.length===5?`${t}:00`:t}`}}}function Tr(r,s){if(typeof s!="string"||!s)return"";switch(r){case"date":return s.slice(0,10);case"time":return s.slice(0,5);case"datetime":{let[e,t="00:00:00"]=s.split(" ");return`${e}T${t.length===5?`${t}:00`:t}`}}}var U,Se=w(()=>{"use strict";I();V();q();U=class extends A{constructor(){super(...arguments);this.kind="date";this.label="";this.value="";this.clearable=!1;this.disabled=!1;this.required=!1;this.lang="en"}_selector(){switch(this.kind){case"date":return{date:{}};case"time":return{time:{no_second:!0}};case"datetime":return{datetime:{}}}}_onSelectorChange(e){e.stopPropagation(),this._emit(Tr(this.kind,e.detail?.value))}_clear(){this._emit("")}_emit(e){e!==this.value&&(this.value=e,this.dispatchEvent(new CustomEvent("value-changed",{bubbles:!0,composed:!0,detail:{value:e}})))}render(){return l`
      <div class="field">
        ${this.label?l`<span class="label">${this.label}${this.required?l`<span class="req">*</span>`:_}</span>`:_}
        <div class="row">
          <ha-selector
            ...
            .value=${Ar(this.kind,this.value)}
            .required=${this.required}
            .disabled=${this.disabled}
            @value-changed=${this._onSelectorChange}
          ></ha-selector>
          ${this.clearable&&this.value&&!this.disabled?l`<button type="button" class="clear" title=${n("clear",this.lang)} aria-label=${n("clear",this.lang)} @click=${this._clear}>
...
`).map(c=>c.trim()).filter(Boolean).slice(0,100);e.checklist=p.length?p:null}if(this.completionActionsEnabled){let p=this._actionService.trim();if(p&&/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/.test(p)){let f={service:p},x=this._actionTargetEntity.trim();x&&(f.target={entity_id:x});let v=this._buildActionData();Object.keys(v).length>0&&(f.data=v),e.on_complete_action=f}else e.on_complete_action=null;let c={};this._qcNotes.trim()&&(c.notes=this._qcNotes.trim());let h=parseFloat(this._qcCost);!isNaN(h)&&h>=0&&(c.cost=h);let m=parseInt(this._qcDuration,10);!isNaN(m)&&m>=0&&(c.duration=m),this._qcFeedback&&(c.feedback=this._qcFeedback),e.quick_complete_defaults=Object.keys(c).length?c:null}let i=await this.hass.connection.sendMessagePromise(e),a=this._taskId||i?.task_id,o=this._environmentalEntity!==this._environmentalInitial||this._environmentalAttribute!==this._environmentalAttributeInitial;if(a&&this._scheduleType==="sensor_based"&&o)try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_environmental_entity",entry_id:this._entryId,task_id:a,environmental_entity:this._environmentalEntity||null,environmental_attribute:this._environmentalAttribute||null}),this._environmentalInitial=this._environmentalEntity,this._environmentalAttributeInitial=this._environmentalAttribute}catch{}if(a&&this._adaptiveSnapshot()!==this._adaptiveInitial){let p=parseFloat(this._adaptiveAlpha),c=parseInt(this._adaptiveMin,10),h=parseInt(this._adaptiveMax,10);try{await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/set_adaptive",entry_id:this._entryId,task_id:a,enabled:this._adaptiveEnabled,...p>=.1&&p<=.9?{ewa_alpha:p}:{},...!isNaN(c)&&c>=1?{min_interval_days:c}:{},...!isNaN(h)&&h>=1?{max_interval_days:h}:{},seasonal_enabled:this._adaptiveSeasonal,sensor_prediction_enabled:this._adaptivePrediction}),this._adaptiveInitial=this._adaptiveSnapshot()}catch{}}this._open=!1,this.dispatchEvent(new CustomEvent("task-saved"))}catch(e){this._error=O(e,this._lang,n("save_error",this._lang))}finally{this._loading=!1}}}_close(){this._open=!1,this._pickerProbeTimer!==void 0&&(clearTimeout(this._pickerProbeTimer),this._pickerProbeTimer=void 0),this._pickerProbeStrikes=0}_renderTriggerFields(){if(this._scheduleType!=="sensor_based")return _;let e=this._lang,t=this._triggerType==="compound";return l`
      ...
      <div class="select-row">
        ...
        >
          ${Nr.map(i=>l`<option value=${i} ?selected=${i===this._triggerType}>${n(i,e)}</option>`)}
        </select>
      </div>
      ${t?this._renderCompoundEditor():l`
        ...
        <ha-form
          ...
          .hass=${this.hass}
          .schema=${[{name:"trigger_entities",selector:{entity:{multiple:!0,domain:Lt}}}]}
      ...
      ${this._intervalDays?l`
          ...
          `:_}
    `}_patchCondition(e,t){this._compoundConditions=this._compoundConditions.map((i,a)=>a===e?{...i,...t}:i)}_addCondition(){this._compoundConditions=[...this._compoundConditions,jr()]}_removeCondition(e){this._compoundConditions=this._compoundConditions.filter((t,i)=>i!==e)}_renderCompoundEditor(){let e=this._lang;return l`
      <div class="select-row">
    ...
    `}_renderCondition(e,t){let i=this._lang,a=t+1;return l`
      <div class="compound-condition">
        ...
        <ha-form
          class="entity-picker-form"
          .hass=${this.hass}
          .schema=${[{name:"condition_entities",selector:{entity:{multiple:!0,domain:Lt}}}]}
        ...
        <div class="select-row">
          ...
          >
            ${ps.map(o=>l`<option value=${o} ?selected=${o===e.type}>${n(o,i)}</option>`)}
          </select>
        </div>
    ...
    `}_buildSchedule(){let e=i=>{let a=parseInt(this._calOffset,10)||0;return a&&(i.offset=Math.max(-15,Math.min(a,15))),i};if(this._scheduleType==="weekdays")return e({kind:"weekdays",weekdays:[...this._weekdays].sort((i,a)=>i-a)});if(this._scheduleType==="nth_weekday")return e({kind:"nth_weekday",nth:parseInt(this._nth,10),weekday:parseInt(this._nthWeekday,10)});let t={kind:"day_of_month",day:this._domLastDay?-1:parseInt(this._domDay,10)||1};return this._domBusiness&&(t.business=!0),e(t)}_recurrenceExtras(){let e={};if(this._seasonMonths.length&&(e.season_months=[...this._seasonMonths].sort((t,i)=>t-i)),this._endsMode==="count"){let t=parseInt(this._endsCount,10);t>=1&&(e.ends={count:t})}else this._endsMode==="until"&&this._endsUntil&&(e.ends={until:this._endsUntil});return e}_toggleSeasonMonth(e){this._seasonMonths=this._seasonMonths.includes(e)?this._seasonMonths.filter(t=>t!==e):[...this._seasonMonths,e]}_renderRecurrenceExtras(){let e=this._lang;if(!(this._scheduleType==="time_based"||dt.includes(this._scheduleType)))return _;let i=zr(e);return l`
      ...
      ${this._endsMode==="until"?l`
        ...
        ></ms-date-field>`:_}
    `}_renderCalendarFields(){let e=this._lang,t=Mr(e);if(this._scheduleType==="weekdays")return l`
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          <div class="select-row">
            ...
            >
              ${Lr.map(i=>l`<option value=${i} ?selected=${i===this._type}>${n(i,e)}</option>`)}
            </select>
          </div>
          ...
          <div class="select-row">
            ...
            >
              ${Rr.map(i=>l`<option value=${i} ?selected=${i===this._priority}>${n("priority_"+i,e)}</option>`)}
            </select>
          </div>
          <div class="field">
          ...
          <div class="select-row">
            ...
            >
              ${qr.map(i=>l`<option value=${i} ?selected=${i===this._scheduleType}>${n(i,e)}</option>`)}
            </select>
          </div>
          ...
          ${this._scheduleType==="one_time"?l`
                ...
                ></ms-date-field>
              `:_}
          ${this.scheduleTimeEnabled&&cs.includes(this._scheduleType)?l`
          ...
          ${this._scheduleType==="sensor_based"?l`
            ...
            <ha-form
              class="entity-picker-form"
              .hass=${this.hass}
              .schema=${[{name:"environmental_entity",selector:{entity:{domain:os,device_class:ls}}}]}
      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="content">
          ...
          ${this.parts.length?l`<div class="used-parts">
                ...
                ${this.parts.map(t=>{let i=G({part_id:t.id,entry_id:t.entry_id}),a=this._usedParts[i],o=a!==void 0,p=t.entry_id?{part_id:t.id,quantity:1,entry_id:t.entry_id}:{part_id:t.id,quantity:1};return l`<div class="used-part-row">
...
<script>setTimeout(()=>window.print(),300)<\/script>
</body></html>`),a.document.close()}_downloadSvg(e,t){let i=decodeURIComponent(e.svg_data_uri.replace("data:image/svg+xml,","")),a=this._taskName?`${this._objectName}-${this._taskName}`:this._objectName;ms(i,`qr-${Ur(a)}-${t}.svg`,"image/svg+xml")}_close(){this._open=!1,this._viewResult=null,this._completeResult=null,this._error="",this._loading=!1}render(){if(!this._open)return l``;let e=this.lang||this.hass?.language||"en",t=this._taskName?`${n("qr_code",e)}: ${this._objectName} \u2014 ${this._taskName}`:`${n("qr_code",e)}: ${this._objectName}`,i=!!this._viewResult;return l`
      <ha-dialog open @closed=${this._close}>
        <div class="dialog-title">${t}</div>
        <div class="content">
  ...
  `,d([y({attribute:!1})],W.prototype,"hass",2),d([y()],W.prototype,"lang",2),d([u()],W.prototype,"_open",2),d([u()],W.prototype,"_loading",2),d([u()],W.prototype,"_error",2),d([u()],W.prototype,"_viewResult",2),d([u()],W.prototype,"_completeResult",2),d([u()],W.prototype,"_urlMode",2);customElements.get("maintenance-qr-dialog")||customElements.define("maintenance-qr-dialog",W)});function Br(r,s){if(s<=0)return 0;let e=typeof r=="number"&&Number.isFinite(r)?Math.trunc(r):0;return e<0?0:e%s}function Vr(r){return!!(r?.phases&&r.phase_sequence&&r.phase_sequence.length>0)}function Dt(r){if(!r||!Vr(r))return null;let s=r.phase_sequence,e=Br(r.phase_cursor,s.length),t=s[e],i=r.phases?.[t];return i?{id:t,name:i.name,index:e,count:s.length,notes:i.notes,checklist:i.checklist!==void 0?i.checklist:r.checklist??[],consumesParts:i.consumes_parts!==void 0?i.consumes_parts:r.consumes_parts??[],requiredFields:i.required_completion_fields!==void 0?i.required_completion_fields:r.required_completion_fields??[]}:null}function Ye(r){let s=Dt(r);return s?`${s.index+1}/${s.count} \xB7 ${s.name}`:""}var Mt=w(()=>{"use strict"});function ws(r){let s=r.task??null,e=s?Dt(s):null,t=e?e.consumesParts:s?.consumes_parts||[],i=!!s?.part_ref,a=r.objects.find(c=>c.entry_id===r.entryId)?.parts||[],o=i?a.find(c=>c.id===s.part_ref.part_id):void 0,p=r.checklistsEnabled??!0;return{entry_id:r.entryId,task_id:r.taskId,task_name:r.taskName,checklist:e?p?e.checklist:[]:r.checklist??[],adaptive_enabled:!!r.adaptiveEnabled,required_completion_fields:e?e.requiredFields:s?.required_completion_fields||[],task_type:s?.type||"",reading_unit:s?.reading_unit||"",readings:s?.readings||[],reading_history:Yi(s?.history),parts:i?[]:as({consumes_parts:t},r.entryId,r.objects,r.lang),consumes_parts:i?[]:t,phase_label:e?Ye(s):"",require_tag_scan:!!s?.require_tag_scan,restock_default:i?o?.restock_quantity??1:null,restock_unit_cost:i?o?.cost??null:null,currency_symbol:r.currencySymbol??"",consumes_info:t.map(c=>ns(c,r.entryId,r.objects,r.lang)),checklist_prefill:s?.checklist_progress||{},via_tag_scan:!!r.viaTagScan}}function $s(r,s,e){r.entryId=s.entry_id,r.taskId=s.task_id,r.taskName=s.task_name,r.lang=e,r.checklist=s.checklist??[],r.adaptiveEnabled=!!s.adaptive_enabled,r.requiredFields=s.required_completion_fields??[],r.taskType=s.task_type??"",r.readingUnit=s.reading_unit??"",r.readings=s.readings??[],r.readingHistory=s.reading_history??[],r.parts=s.parts??[],r.consumesParts=s.consumes_parts??[],r.phaseLabel=s.phase_label??"",r.requireTagScan=!!s.require_tag_scan,r.restockDefault=s.restock_default??null,r.restockUnitCost=s.restock_unit_cost??null,r.currencySymbol=s.currency_symbol??"",r.consumesInfo=s.consumes_info??[],r.checklistPrefill=s.checklist_prefill??{},r.viaTagScan=!!s.via_tag_scan,r.open({viaTagScan:!!s.via_tag_scan})}var zt=w(()=>{"use strict";Ee();lt();Mt()});function S(r){return r.toFixed(1)}var Ft=w(()=>{"use strict";q()});function ks(r,s){let e=r.interval_analysis,t=e?.weibull_beta,i=e?.weibull_eta;if(t==null||i==null||i<=0)return _;let a=r.interval_days??0,o=r.suggested_interval??a;return l`
    ...
    <div class="weibull-info-row">
      ...
      ${r.weibull_r_squared!=null?l`
        <div class="weibull-info-item">
          ...
          <span class="weibull-info-value">${P(r.weibull_r_squared,s,3)}</span>
        </div>
      `:_}
    </div>
  `}function Gr(r,s,e){let t=r.confidence_interval_low,i=r.confidence_interval_high,a=s.suggested_interval??s.interval_days??0,o=s.interval_days??0,p=Math.max(0,t-5),h=i+5-p,m=(t-p)/h*100,f=(i-t)/h*100,x=(a-p)/h*100,v=o>0?(o-p)/h*100:-1;return l`
  ...
  `}var Es=w(()=>{"use strict";I();q();Ft()});function Ss(r,s,e){let t=r.degradation_trend!=null&&r.degradation_trend!=="insufficient_data",i=r.days_until_threshold!=null,a=r.environmental_factor!=null&&r.environmental_factor!==1;if(!t&&!i&&!a)return _;let o=r.degradation_trend==="rising"?"M16,6L18.29,8.29L13.41,13.17L9.41,9.17L2,16.59L3.41,18L9.41,12L13.41,16L19.71,9.71L22,12V6H16Z":r.degradation_trend==="falling"?"M16,18L18.29,15.71L13.41,10.83L9.41,14.83L2,7.41L3.41,6L9.41,12L13.41,8L19.71,14.29L22,12V18H16Z":"M22,12L18,8V11H3V13H18V16L22,12Z";return l`
      ...
      <div class="prediction-grid">
        ${t?l`
          <div class="prediction-item">
            ...
            ${r.degradation_rate!=null?l`<span class="prediction-rate">${r.degradation_rate>0?"+":""}${P(r.degradation_rate,s,Math.abs(r.degradation_rate)>=10?0:1)} ${r.trigger_entity_info?.unit_of_measurement||""}/${n("day_short",s)}</span>`:_}
          </div>
        `:_}
        ${i?l`
          <div class="prediction-item">
            ...
            ${r.threshold_prediction_date?l`<span class="prediction-date">${te(r.threshold_prediction_date,s)}</span>`:_}
            ${r.threshold_prediction_confidence?l`<span class="confidence-dot ${r.threshold_prediction_confidence}"></span>`:_}
            ${(r.prediction_cycles??0)>0?l`<span class="prediction-cycles">${n("prediction_cycles",s)}: ${r.prediction_cycles}</span>`:_}
          </div>
        `:_}
        ${a&&e.environmental?l`
          <div class="prediction-item">
            ...
            <span class="prediction-value">${P(r.environmental_factor,s,2)}x</span>
            ${r.environmental_entity?l`<span class="prediction-entity entity-link" @click=${p=>Ui(p,r.environmental_entity)}>${r.environmental_entity}</span>`:_}
          </div>
        `:_}
      </div>
    </div>
  `}var As=w(()=>{"use strict";I();q()});function Ts(r,s,e,t){let i=Math.max(r||1,s);return l`
  ...
  `}var Cs=w(()=>{"use strict";I();q()});function Ps(r,s,e){if(!e.seasonal||!r.seasonal_factor||r.seasonal_factor===1)return _;let t=Is.map(p=>n(p,s)),i=new Date().getMonth(),a=r.seasonal_factors||r.interval_analysis?.seasonal_factors||null,o=a&&a.length===12?a:t.map((p,c)=>{let h=r.seasonal_factor||1,m=Math.sin((c-6)*Math.PI/6)*.3;return Math.max(.7,Math.min(1.3,h+m))});return l`
  ...
  `}function Ls(r,s){return Qr(r,s)}function Qr(r,s){let e=r.seasonal_factors??r.interval_analysis?.seasonal_factors;if(!e||e.length!==12)return _;let t=r.interval_analysis?.seasonal_reason,i=new Date().getMonth(),a=300,o=100,p=8,h=o-p-4,m=Math.max(...e,1.5),f=a/12,x=f*.65,v=p+h-1/m*h;return l`
    <div class="seasonal-chart">
      <div class="seasonal-chart-title">
        ...
        ${t?l`<span class="source-tag">${t==="learned"?n("seasonal_learned",s):n("seasonal_manual",s)}</span>`:_}
      </div>
      <svg viewBox="0 0 ${a} ${o}" preserveAspectRatio="xMidYMid meet" role="img" aria-label="${n("chart_seasonal",s)}">
        ...
        ${e.map((k,T)=>{let D=k/m*h,F=T*f+(f-x)/2,j=p+h-D,K=T===i,oe=k<1?"var(--success-color, #4caf50)":k>1?"var(--warning-color, #ff9800)":"var(--secondary-text-color)";return xe`
            <rect x="${S(F)}" y="${S(j)}"
  ...
  `}var Is,Rs=w(()=>{"use strict";I();q();Ft();Is=["month_jan","month_feb","month_mar","month_apr","month_may","month_jun","month_jul","month_aug","month_sep","month_oct","month_nov","month_dec"]});var L,qs=w(()=>{"use strict";I();V();q();fe();At();zt();Mt();at();Ee();Ot();Es();As();Cs();Se();Rs();L=class extends A{constructor(){super(...arguments);this._open=!1;this._entryId=null;this._taskId=null;this._task=null;this._objectName="";this._busy=!1;this._error="";this._showSkip=!1;this._showReset=!1;this._showDetails=!1;this._showAdaptive=!1;this._skipReason="";this._resetDate="";this._features={adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1};this._toast="";this._featuresLoaded=!1;this._currencySymbol=""}get _lang(){return M(this.hass)}async openFor(e,t){this._entryId=e,this._taskId=t,this._error="",this._showSkip=!1,this._showReset=!1,this._showAdaptive=!1,this._skipReason="",this._resetDate=ge(new Date),this._open=!0,await Promise.all([this._loadTask(),this._loadFeatures()])}async _loadFeatures(){if(!this._featuresLoaded)try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/settings"});e?.features&&(this._features={...this._features,...e.features}),this._currencySymbol=e?.budget?.currency_symbol||"",this._featuresLoaded=!0}catch{}}close(){this._open=!1,this._task=null,this._error=""}async _loadTask(){if(!(!this._entryId||!this._taskId))try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:this._entryId});this._objectName=e.object?.name||"";let t=(e.tasks||[]).find(i=>i.id===this._taskId);this._task=t??null}catch(e){this._error=O(e,this._lang)}}async _runWs(e){this._busy=!0,this._error="";try{return await this.hass.connection.sendMessagePromise(e),this._busy=!1,!0}catch(t){return this._error=O(t,this._lang),this._busy=!1,!1}}_notifyChanged(e){this.dispatchEvent(new CustomEvent("task-action-fired",{detail:{entry_id:this._entryId,task_id:this._taskId,action:e},bubbles:!0,composed:!0}))}_onComplete(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(J(),re)).then(async({openCompleteDialog:e})=>{let t=this._task,i=[];try{i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects",compact:!0})).objects||[]}catch{}e(ws({entryId:this._entryId,taskId:this._taskId,taskName:t.name,task:t,objects:i,lang:this._lang,checklist:t.checklist||[],adaptiveEnabled:!!t.adaptive_config?.enabled,currencySymbol:this._currencySymbol}))&&(this._notifyChanged("complete"),this.close())})}async _onSkipConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/skip",entry_id:this._entryId,task_id:this._taskId,reason:this._skipReason.trim()||null})&&(this._notifyChanged("skip"),this.close())}async _onResetConfirm(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/reset",entry_id:this._entryId,task_id:this._taskId,date:this._resetDate||void 0})&&(this._notifyChanged("reset"),this.close())}_onEdit(){!this._entryId||!this._taskId||Promise.resolve().then(()=>(J(),re)).then(({openEditTaskDialog:e})=>{e(this._entryId,this._taskId),this.close()})}_onQr(){!this._entryId||!this._taskId||!this._task||Promise.resolve().then(()=>(J(),re)).then(({openQrDialog:e})=>{e({entry_id:this._entryId,task_id:this._taskId,task_name:this._task.name,object_name:this._objectName}),this.close()})}async _onDelete(){if(!this._entryId||!this._taskId)return;let e=n("delete_task_confirm",this._lang)||`Delete "${this._task?.name}"?`;if(!window.confirm(e))return;await this._runWs({type:"maintenance_supporter/task/delete",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("delete"),this.close())}async _onArchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/archive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("archive"),this.close())}async _onUnarchive(){if(!this._entryId||!this._taskId)return;await this._runWs({type:"maintenance_supporter/task/unarchive",entry_id:this._entryId,task_id:this._taskId})&&(this._notifyChanged("unarchive"),this.close())}_onOpenInPanel(){if(!this._entryId||!this._taskId)return;let e=`/maintenance-supporter?entry_id=${encodeURIComponent(this._entryId)}&task_id=${encodeURIComponent(this._taskId)}`;history.pushState(null,"",e),window.dispatchEvent(new CustomEvent("location-changed")),this.close()}async _applySuggestion(){if(!this._entryId||!this._taskId||!this._task?.suggested_interval)return;await this._runWs({type:"maintenance_supporter/task/apply_suggestion",entry_id:this._entryId,task_id:this._taskId,interval:this._task.suggested_interval})&&(this._toast=n("suggestion_applied",this._lang)||"Applied",this._notifyChanged("apply_suggestion"),await this._loadTask(),setTimeout(()=>{this._toast=""},2500))}async _reanalyzeInterval(){if(!(!this._entryId||!this._taskId)){this._busy=!0,this._error="";try{let e=await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/task/analyze_interval",entry_id:this._entryId,task_id:this._taskId});this._toast=e.recommended_interval?`${n("reanalyze_result",this._lang)||"Recomputed"}: ${st(e.recommended_interval,"days",this._lang)} (${e.data_points} pts)`:n("reanalyze_insufficient_data",this._lang)||"Not enough data",await this._loadTask(),setTimeout(()=>{this._toast=""},3500)}catch(e){this._error=O(e,this._lang)}finally{this._busy=!1}}}_onEditHistoryEntry(e){!this._entryId||!this._taskId||Promise.resolve().then(()=>(J(),re)).then(({openHistoryEditDialog:t})=>{t({entry_id:this._entryId,task_id:this._taskId,original_timestamp:e.timestamp,type:e.type,timestamp:e.timestamp,notes:e.notes??null,cost:e.cost??null,duration:e.duration??null,completed_by:e.completed_by??null,used_parts:e.used_parts??null,photo_doc_ids:We(e),reading_value:e.reading_value??null,reading_values:ie(e),readings:this._task?.readings??[],task_type:this._task?.type??null,reading_unit:this._task?.reading_unit??null})})}_renderRecommendation(e){if(!this._features.adaptive||!e.suggested_interval||e.suggested_interval===e.interval_days)return _;let t=this._lang;return l`
    ...
    `}_renderAdaptive(e){let t=this._lang,i=this._features.adaptive&&e.suggested_interval&&e.suggested_interval!==e.interval_days,a=e.degradation_trend!=null&&e.degradation_trend!=="insufficient_data"||e.days_until_threshold!=null||e.environmental_factor!=null&&e.environmental_factor!==1,o=this._features.adaptive&&e.interval_analysis?.weibull_beta!=null&&e.interval_analysis?.weibull_eta!=null,p=this._features.seasonal&&e.seasonal_factor&&e.seasonal_factor!==1;return!i&&!a&&!o&&!p?l`<div class="adaptive-empty">
      ...
      <div class="adaptive-stack">
        ...
        ${a?Ss(e,t,this._features):_}
        ${o?ks(e,t):_}
        ${p?l`
          ${Ps(e,t,this._features)}
          ${e.seasonal_factors?.length===12||e.interval_analysis?.seasonal_factors?.length===12?Ls(e,t):_}
        `:_}
      </div>
    `}_renderHistoryReadings(e,t,i){let a=ie(e),o=p=>P(p,i,{maximumFractionDigits:3});if(a.length>0)return l`<div class="history-readings">
        ${a.map(p=>{let c=Qi(t,e,p.id);return l`<span class="history-reading"><span class="history-reading-name">${p.name}</span>
      ...
      <div class="dialog" role="dialog" aria-modal="true">
        ${t?l`
              <div class="header">
                ...
                <div class="object">
                  <button class="link-inline" @click=${()=>{this._entryId&&Promise.resolve().then(()=>(J(),re)).then(({openObjectQuickActions:a})=>{a(this._entryId),this.close()})}}>${this._objectName}</button>
                </div>
                <div class="quick-info">
                  ${t.next_due?l`<span><strong>${n("next_due",e)||"Next due"}:</strong> ${te(t.next_due,e)}</span>`:_}
                  ${t.last_performed?l`<span><strong>${n("last_performed",e)||"Last"}:</strong> ${te(t.last_performed,e)}</span>`:_}
                  ...
                  ${Ye(t)?l`<span><strong>${n("phase_current",e)}:</strong> ${Ye(t)}</span>`:_}
                </div>
              </div>
      ...
      <div class="meta">
        ${i.map(([a,o])=>l`
            <div class="meta-item">
              ...
              <span class="meta-value">${Ns(o)?l`<a href="${o}" target="_blank" rel="noopener noreferrer">${o}</a>`:o}</span>
            </div>
          `)}
      </div>
    `}};Z.styles=E`
  ...
  `,d([y({attribute:!1})],Z.prototype,"hass",2),d([u()],Z.prototype,"_open",2),d([u()],Z.prototype,"_entryId",2),d([u()],Z.prototype,"_data",2),d([u()],Z.prototype,"_busy",2),d([u()],Z.prototype,"_error",2);customElements.get("maintenance-object-quick-actions-dialog")||customElements.define("maintenance-object-quick-actions-dialog",Z)});function Ms(){let r=window;return r.__msSettingsCache??={promise:null}}function pt(r){let s=Ms();if(s.promise)return s.promise;let e=r.connection.sendMessagePromise({type:"maintenance_supporter/settings"}).then(t=>({features:t.features??Ut.features,defaultWarningDays:t.general?.default_warning_days??7,rowActionStyle:t.general?.row_action_style??Ut.rowActionStyle})).catch(()=>(s.promise===e&&(s.promise=null),Ut));return s.promise=e,e}function zs(){Ms().promise=null}var Ut,Fs=w(()=>{"use strict";Ut={features:{adaptive:!1,predictions:!1,seasonal:!1,environmental:!1,budget:!1,groups:!1,checklists:!1,schedule_time:!1,completion_actions:!1},defaultWarningDays:7,rowActionStyle:"buttons_compact"}});var re={};Ys(re,{__resetSettingsCacheForTests:()=>nn,getRowActionStyle:()=>rn,openCompleteDialog:()=>cn,openCreateObjectDialog:()=>an,openCreateTaskDialog:()=>ln,openEditObjectDialog:()=>on,openEditTaskDialog:()=>dn,openHistoryEditDialog:()=>Bt,openObjectQuickActions:()=>hn,openQrDialog:()=>pn,openTaskQuickActions:()=>Vt});function ht(){return document.querySelector("home-assistant")?.hass}function sn(){return document.querySelector("home-assistant")?.shadowRoot??document.body}function ne(r){let s=sn(),e=s.querySelector(r)??document.body.querySelector(r);return e?e.parentNode!==s&&s.appendChild(e):(e=document.createElement(r),s.appendChild(e)),e}function ae(r){let s=ht();if(!s)return!1;r.hass=s;let e=M(s);return Be(e)||Ve(e).then(()=>{r.requestUpdate?.()}),Ct(s.locale,s.config?.country),!0}function rn(r){return pt(r).then(s=>s.rowActionStyle)}function nn(){zs()}function an(){let r=ne(Us);return ae(r)?(r.openCreate(),!0):!1}function on(r,s){let e=ne(Us);return ae(e)?(e.openEdit(r,s),!0):!1}function ln(r="",s){let e=ne(Bs);if(!ae(e))return!1;let t=ht();return t?((async()=>{let i=await pt(t),a=e;a.checklistsEnabled=i.features.checklists,a.scheduleTimeEnabled=i.features.schedule_time,a.completionActionsEnabled=i.features.completion_actions,a.defaultWarningDays=i.defaultWarningDays,a.openCreate(r,s)})(),!0):!1}function dn(r,s){let e=ne(Bs);if(!ae(e))return!1;let t=ht();return t?((async()=>{try{let[i,a]=await Promise.all([t.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:r}),pt(t)]),o=(i.tasks||[]).find(c=>c.id===s);if(!o){console.warn(`openEditTaskDialog: task ${s} not found in entry ${r}`);return}let p=e;p.checklistsEnabled=a.features.checklists,p.scheduleTimeEnabled=a.features.schedule_time,p.completionActionsEnabled=a.features.completion_actions,p.defaultWarningDays=a.defaultWarningDays,await p.openEdit(r,o)}catch(i){console.warn("openEditTaskDialog: failed to load task/features",i)}})(),!0):!1}function Bt(r){let s=ne(Jr);return ae(s)?(s.openEdit(r),!0):!1}function cn(r){let s=ne(Zr);return ae(s)?($s(s,r,ht()?.language||"en"),!0):!1}function pn(r){let s=ne(Xr);return ae(s)?(s.openForTask(r.entry_id,r.task_id,r.object_name,r.task_name),!0):!1}function Vt(r,s){let e=ne(en);return ae(e)?(e.openFor(r,s),!0):!1}function hn(r){let s=ne(tn);return ae(s)?(s.openFor(r),!0):!1}var Us,Bs,Jr,Zr,Xr,en,tn,J=w(()=>{"use strict";Xi();hs();gs();ys();xs();qs();Ds();q();zt();Fs();Us="maintenance-object-dialog",Bs="maintenance-task-dialog",Jr="maintenance-history-edit-dialog",Zr="maintenance-complete-dialog",Xr="maintenance-qr-dialog",en="maintenance-task-quick-actions-dialog",tn="maintenance-object-quick-actions-dialog"});I();V();At();I();var Si=E`
  .cal-controls {
    display: flex;
    gap: 12px;
    align-items: center;
...
`;q();function Vi(r){let s=window;s.customCards=s.customCards||[],s.customCards.some(e=>e.type===r.type)||s.customCards.push(r)}at();Ee();J();var B=class extends A{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"};this._objects=[];this._stats=null;this._windowDays=30;this._pastDays=0;this._userFilter="";this._objectFilter="";this._configuredObjects=[];this._unsub=null;this._dataLoaded=!1;this._lastConnection=null}static getConfigElement(){return document.createElement("maintenance-supporter-calendar-card-editor")}static getStubConfig(){return{type:"custom:maintenance-supporter-calendar-card",window_days:30,show_window_chips:!0,show_user_filter:!0}}setConfig(e){if(this._config={...e},e.past_days&&[30,90].includes(e.past_days)?this._pastDays=e.past_days:e.window_days&&[7,14,30,365].includes(e.window_days)&&(this._windowDays=e.window_days,this._pastDays=0),typeof e.user_filter=="string"&&(this._userFilter=e.user_filter),typeof e.object_filter=="string")this._objectFilter=e.object_filter,this._configuredObjects=[];else if(Array.isArray(e.object_filter)){let t=e.object_filter.filter(i=>typeof i=="string"&&i!=="");this._objectFilter=t.length===1?t[0]:"",this._configuredObjects=t.length>1?t:[]}}getCardSize(){return 6}get _lang(){return M(this.hass)}disconnectedCallback(){if(super.disconnectedCallback(),this._unsub){try{this._unsub()}catch{}this._unsub=null}this._dataLoaded=!1,this._lastConnection=null}updated(e){if(super.updated(e),qi(this,e),e.has("hass")&&this.hass){if(!this._dataLoaded)this._dataLoaded=!0,this._lastConnection=this.hass.connection,this._loadData(),this._subscribe();else if(this.hass.connection!==this._lastConnection){if(this._lastConnection=this.hass.connection,this._unsub){try{this._unsub()}catch{}this._unsub=null}this._subscribe(),this._loadData()}}}async _loadData(){try{let[e,t]=await Promise.all([this.hass.connection.sendMessagePromise({type:"maintenance_supporter/objects"}),this.hass.connection.sendMessagePromise({type:"maintenance_supporter/statistics"})]);this._objects=e.objects,this._stats=t}catch{}}async _subscribe(){try{let e=await this.hass.connection.subscribeMessage(t=>{let i=t;this._objects=i.objects},{type:"maintenance_supporter/subscribe"});if(!this.isConnected){e();return}this._unsub=e}catch{}}_onEventClick(e){if(e.history_timestamp){this._openHistoryEntry(e);return}Vt(e.entry_id,e.task_id)||this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:open-task",entry_id:e.entry_id,task_id:e.task_id},bubbles:!0,composed:!0}))}async _openHistoryEntry(e){try{let i=(await this.hass.connection.sendMessagePromise({type:"maintenance_supporter/object",entry_id:e.entry_id})).tasks?.find(p=>p.id===e.task_id),a=i?.history?.find(p=>p.timestamp===e.history_timestamp);if(!a||Bt({entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp,type:a.type||"completed",timestamp:a.timestamp||e.history_timestamp,notes:a.notes??null,cost:a.cost??null,duration:a.duration??null,completed_by:a.completed_by??null,used_parts:a.used_parts??null,photo_doc_ids:We(a),reading_value:a.reading_value??null,reading_values:ie(a),readings:i?.readings??[],task_type:i?.type??null,reading_unit:i?.reading_unit??null}))return}catch{}this.dispatchEvent(new CustomEvent("ll-custom",{detail:{type:"maintenance-supporter:edit-history",entry_id:e.entry_id,task_id:e.task_id,original_timestamp:e.history_timestamp},bubbles:!0,composed:!0}))}render(){if(!this.hass)return _;let e=this._lang,t=this._config.show_window_chips!==!1,i=this._config.show_user_filter!==!1,a=this._config.title,o=null;this._userFilter&&(o=this._userFilter==="current_user"?this.hass?.user?.id??null:this._userFilter);let p=b=>{let Y=b.toLowerCase();return this._objects.find(R=>R.entry_id===b||R.object.name.toLowerCase()===Y)?.entry_id??null},c=new Set(this._configuredObjects.map(p).filter(b=>b!==null)),h=c.size?this._objects.filter(b=>c.has(b.entry_id)):this._objects,m=this._config.show_object_filter!==!1&&h.length>1,f=this._objectFilter?p(this._objectFilter):null,x=f&&h.some(b=>b.entry_id===f)?h.filter(b=>b.entry_id===f):h,v=new Date;v.setHours(0,0,0,0);let k=this._pastDays>0,T=k?Ei(x,v,this._pastDays,o):ki(x,v,this._windowDays,o),D=ge(v),F=this._windowDays===365||k,j=F?T.filter(b=>b.events.length>0):T,K=b=>{let Y=`cal-status-${b.status}`,ve=b.projected?"cal-event-projected":"",R=b.status==="overdue"&&b.days_until_due!=null?` (${Di(b.days_until_due,e)})`:"",H=b.projected&&b.interval_days?l`<span class="cal-event-recur">${b.interval_unit&&b.interval_unit!=="days"?`${b.interval_days} ${n("unit_"+b.interval_unit,e)}`:n("cal_every_n_days",e).replace("{n}",String(b.interval_days))}</span>`:_,ce=b.schedule_type==="sensor_based",Ie=ce?l`<ha-icon class="cal-event-icon cal-source-sensor"
          ...
          </span>`:_,Vs=this._stats?.budget?.currency_symbol||Li,Ws=b.history_type?n(b.history_type,e):n(b.status,e);return l`
        <div class="cal-event ${ve}"
          @click=${()=>this._onEventClick(b)}>
          ${Ie}
          <span class="cal-status-pill ${Y}">${Ws}</span>
          <div class="cal-event-body">
            <div class="cal-event-title">${b.object_name} · ${b.task_name}${R}</div>
            ${Pe}
            ${H}
          </div>
          ${b.avg_cost!=null&&b.avg_cost>0?l`<span class="cal-event-cost">${rt(b.avg_cost,Vs,e,0)}</span>`:_}
        </div>
      `},oe=b=>{let[Y,ve,R]=b.date.split("-").map(Number),H=new Date(Y,ve-1,R),ce=b.date===D,Ie=Mi(H,e,"short"),Pe=zi(H,e,"long");return l`
        <div class="cal-day-row">
          ...
          <div class="cal-day-content">
            ...
            ${b.events.length===0?l`<div class="cal-empty">${n("cal_no_events",e)}</div>`:b.events.map(K)}
          </div>
        </div>
      `};return l`
      <ha-card .header=${a}>
              ...
              <div class="cal-controls">
                ...
                ${m?l`
                      <select class="cal-user-filter"
                        ...
                        ${[...h].sort((b,Y)=>b.object.name.localeCompare(Y.object.name)).map(b=>l`<option value=${b.entry_id} ?selected=${b.entry_id===f}>${b.object.name}</option>`)}
                      </select>
                    `:_}
              </div>
            `:_}
    ...
    `],d([y({attribute:!1})],B.prototype,"hass",2),d([u()],B.prototype,"_config",2),d([u()],B.prototype,"_objects",2),d([u()],B.prototype,"_stats",2),d([u()],B.prototype,"_windowDays",2),d([u()],B.prototype,"_pastDays",2),d([u()],B.prototype,"_userFilter",2),d([u()],B.prototype,"_objectFilter",2),d([u()],B.prototype,"_unsub",2);var un=[{value:7,key:"cal_editor_window_week"},{value:14,key:"cal_editor_window_fortnight"},{value:30,key:"cal_editor_window_month"},{value:365,key:"cal_editor_window_year"}],Ce=class extends A{constructor(){super(...arguments);this._config={type:"custom:maintenance-supporter-calendar-card"}}get _lang(){return M(this.hass)}setConfig(e){this._config={...e}}updated(){let e=this._lang;e&&!Be(e)&&Ve(e).then(()=>this.requestUpdate())}_valueChanged(e,t){let i={...this._config,[e]:t};e==="show_window_chips"&&t===!0&&delete i.show_window_chips,e==="show_user_filter"&&t===!0&&delete i.show_user_filter,e==="show_object_filter"&&t===!0&&delete i.show_object_filter,e==="title"&&(!t||typeof t=="string"&&t.trim()==="")&&delete i.title,e==="user_filter"&&t===""&&delete i.user_filter,this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0}))}render(){let e=this._lang,t=this._config.window_days??30,i=this._config.show_window_chips!==!1,a=this._config.show_user_filter!==!1,o=this._config.user_filter??"",p=this._config.title??"";return l`
      <div class="editor">
        ...
        <div class="row">
          ...
          >
            ${un.map(c=>l`<option value="${c.value}" ?selected=${c.value===t}>${n(c.key,e)}</option>`)}
          </select>
        </div>
