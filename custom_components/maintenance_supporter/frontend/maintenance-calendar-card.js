      ...
      <ha-dialog open @closed=${this._close}>
        ...
        <div class="dialog-actions">
          ...
          <ha-button
            ...
            title=${this._missingRequired.length?this._missingRequired.map(t=>n("err_required",e).replace("{field}",n(Ye[t]??t,e))).join(" \xB7 "):""}
          >
              ...
              <div class="history-list">
                ${[...i].reverse().slice(0,20).map(c=>{let h=["completed","reset","skipped"].includes(c.type);return l`
                    <div class="history-entry">
                      ...
                      ${(()=>{let m=Ke(c);return m.length?l`<div class="history-photos">
        ...
        ${t?l`
              <div class="header">
                ...
                <div class="quick-info">
                  ...
                  ${Ge(t)?l`<span><strong>${n("phase_current",e)}:</strong> ${Ge(t)}</span>`:_}
                </div>
              </div>
