...
| **Battery fleet** | With [Battery Notes](https://github.com/andrew-codechimp/HA-Battery-Notes): one task for all 30–70+ batteries — grouped shopping list, forecast, mark-all-replaced, spare-part stock | [Features → Battery Fleet](docs/FEATURES.md#battery-fleet-battery-notes) |
