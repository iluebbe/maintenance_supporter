...
- 29 object templates in 6 groups — Vehicle, Home & HVAC, Household & Routines, Garden & Outdoor, Pool, Appliances (car, e-bike, HVAC, smoke detectors, bathroom/bedroom/kitchen routines, robot vacuums, espresso machine, RO water filter, irrigation, …) — fully localized, curatable via Settings → Template gallery
