...
- **Template-gallery curation** (2.21+): hide individual built-in templates from the "From template" pickers via Settings → Template gallery — a growing catalog never clutters your picker; re-enable any time
...
- 23 object templates (car, HVAC, pool, washing machine, robot vacuum, espresso machine, RO water filter, irrigation system, etc.) — fully localized, curatable via Settings → Template gallery
