...
│
├── websocket/                               58 WS commands, split by domain
...
58 commands organized by function:

| Category | Commands |
|----------|----------|
| **Read** | `objects`, `object`, `statistics`, `subscribe`, `templates`, `budget_status`, `groups`, `settings`, `tasks/by_user` |
| **Object CRUD** | `object/create`, `object/update`, `object/delete`, `object/duplicate`, `object/from_template`, `object/archive`, `object/unarchive` |
...
The backend exposes 58 WS commands; most are consumed by the Lit panel. A couple (`task/list`, `templates`) are genuinely obsolete for the panel but kept as public API.
