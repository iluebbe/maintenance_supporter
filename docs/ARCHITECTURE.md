...
**Version:** 2.70.0 | 218 source files (134 Python + 84 TypeScript) | **98% test coverage** (3,632 backend tests + 567 frontend tests)
...
| test-coverage (>95%) | Silver | Yes (98%, 3,632 tests) |
...
**3,632 tests** across **212 test files** with **98% code coverage** (plus a 567-test frontend suite in real Chromium across 100 spec files, the 29-scenario journey suite, and the live e2e scripts under `e2e/`).
